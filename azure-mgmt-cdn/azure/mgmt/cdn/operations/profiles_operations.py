...
class ProfilesOperations(object):
    ...
    def create(
        ...
        # Construct body
        body_content = self._serialize.body(profile_properties, 'ProfileCreateParameters')
    ...
    def update(
        ...
        :param profile_name: Name of the CDN profile within the resource
         group.
        :type profile_name: str
        :param profile_properties: Profile properties needed for update.
        :type profile_properties: :class:`ProfileUpdateParameters
         <cdnmanagementclient.models.ProfileUpdateParameters>`
        :param resource_group_name: Name of the resource group within the
         Azure subscription.
        :type resource_group_name: str
        :param dict custom_headers: headers that will be added to the request
        ...
        # Construct body
        body_content = self._serialize.body(profile_properties, 'ProfileUpdateParameters')
