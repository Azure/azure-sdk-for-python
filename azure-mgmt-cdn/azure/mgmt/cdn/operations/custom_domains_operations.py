...
class CustomDomainsOperations(object):
    ...
    def create(
            self, custom_domain_name, custom_domain_properties, endpoint_name, profile_name, resource_group_name, custom_headers={}, raw=False, **operation_config):
        """
        ...
        :param custom_domain_name: Name of the custom domain within an
         endpoint.
        :type custom_domain_name: str
        :param custom_domain_properties: Custom domain properties required
         for creation.
        :type custom_domain_properties: :class:`CustomDomainParameters
         <cdnmanagementclient.models.CustomDomainParameters>`
        :param endpoint_name: Name of the endpoint within the CDN profile.
        :type endpoint_name: str
        :param profile_name: Name of the CDN profile within the resource
         group.
    ...
    def update(
        ...
        :param custom_domain_name: Name of the custom domain within an
         endpoint.
        :type custom_domain_name: str
        :param custom_domain_properties: Custom domain properties to update.
        :type custom_domain_properties: :class:`CustomDomainParameters
         <cdnmanagementclient.models.CustomDomainParameters>`
        :param endpoint_name: Name of the endpoint within the CDN profile.
        :type endpoint_name: str
