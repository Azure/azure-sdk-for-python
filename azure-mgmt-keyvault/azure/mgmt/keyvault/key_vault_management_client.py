...
class KeyVaultManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, subscription_id, api_version='2015-06-01', base_url=None):
...
class KeyVaultManagementClient(object):
    ...
    def __init__(
        ...
        self.config = KeyVaultManagementClientConfiguration(credentials, subscription_id, api_version, base_url)
