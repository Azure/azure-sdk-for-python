...
class OpenShiftManagedClusterMasterPoolProfile(OpenShiftManagedClusterProfileSpec):
    ...
    def __init__(self, *, name: str, vm_size, count: int=1, vnet_subnet_id: str=None, os_type="Linux", **kwargs) -> None:
        super(OpenShiftManagedClusterMasterPoolProfile, self).__init__(name=name, count=count, vm_size=vm_size, vnet_subnet_id=vnet_subnet_id, os_type=os_type, **kwargs)
