...
class ContainerServiceProperties(Model):
    ...
    _attribute_map = {
        ...
        'orchestrator_profile': {'key': 'orchestratorProfile', 'type': 'ContainerServiceOrchestratorProfile'},
        'custom_profile': {'key': 'customProfile', 'type': 'ContainerServiceCustomProfile'},
        'service_principal_profile': {'key': 'servicePrincipalProfile', 'type': 'ContainerServiceServicePrincipalProfile'},
        'master_profile': {'key': 'masterProfile', 'type': 'ContainerServiceMasterProfile'},
        'agent_pool_profiles': {'key': 'agentPoolProfiles', 'type': '[ContainerServiceAgentPoolProfile]'},
        'windows_profile': {'key': 'windowsProfile', 'type': 'ContainerServiceWindowsProfile'},
        'linux_profile': {'key': 'linuxProfile', 'type': 'ContainerServiceLinuxProfile'},
        'diagnostics_profile': {'key': 'diagnosticsProfile', 'type': 'ContainerServiceDiagnosticsProfile'},
    }

    def __init__(self, orchestrator_profile, master_profile, linux_profile, custom_profile=None, service_principal_profile=None, agent_pool_profiles=None, windows_profile=None, diagnostics_profile=None):
