...
class ManagedClusterUpgradeProfile(Model):
    ...
    :type control_plane_profile:
     ~azure.mgmt.containerservice.v2019_02_01_preview.models.ManagedClusterPoolUpgradeProfile
    :param agent_pool_profiles: Required. The list of available upgrade
     versions for agent pools.
    :type agent_pool_profiles:
     list[~azure.mgmt.containerservice.v2019_02_01_preview.models.ManagedClusterPoolUpgradeProfile]
    """
