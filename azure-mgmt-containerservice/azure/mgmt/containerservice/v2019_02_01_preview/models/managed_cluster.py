...
class ManagedCluster(Resource):
    ...
    :type agent_pool_profiles:
     list[~azure.mgmt.containerservice.v2019_02_01_preview.models.ManagedClusterAgentPoolProfile]
    :param linux_profile: Profile for Linux VMs in the container service
     cluster.
    :type linux_profile:
     ~azure.mgmt.containerservice.v2019_02_01_preview.models.ContainerServiceLinuxProfile
    ...
    :type service_principal_profile:
     ~azure.mgmt.containerservice.v2019_02_01_preview.models.ManagedClusterServicePrincipalProfile
    :param addon_profiles: Profile of managed cluster add-on.
    :type addon_profiles: dict[str,
     ~azure.mgmt.containerservice.v2019_02_01_preview.models.ManagedClusterAddonProfile]
