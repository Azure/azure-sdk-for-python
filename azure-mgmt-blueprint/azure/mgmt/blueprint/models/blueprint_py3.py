...
class Blueprint(AzureResourceBase):
    ...
    def __init__(self, *, display_name: str=None, description: str=None, target_scope=None, parameters=None, resource_groups=None, versions=None, layout=None, **kwargs) -> None:
