...
class VirtualNetworkLinksOperations(object):
    ...
    def _create_or_update_initial(
            self, resource_group_name, private_zone_name, virtual_network_link_name, parameters, if_match=None, if_none_match=None, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def create_or_update(
            self, resource_group_name, private_zone_name, virtual_network_link_name, parameters, if_match=None, if_none_match=None, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :param virtual_network_link_name: The name of the virtual network
         link.
        ...
        :return: An instance of LROPoller that returns VirtualNetworkLink or
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/virtualNetworkLinks/{virtualNetworkLinkName}'}


    def _update_initial(
            self, resource_group_name, private_zone_name, virtual_network_link_name, parameters, if_match=None, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def update(
            self, resource_group_name, private_zone_name, virtual_network_link_name, parameters, if_match=None, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/virtualNetworkLinks/{virtualNetworkLinkName}'}


    def _delete_initial(
            self, resource_group_name, private_zone_name, virtual_network_link_name, if_match=None, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def delete(
            self, resource_group_name, private_zone_name, virtual_network_link_name, if_match=None, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/virtualNetworkLinks/{virtualNetworkLinkName}'}

    def get(
            self, resource_group_name, private_zone_name, virtual_network_link_name, custom_headers=None, raw=False, **operation_config):
        ...
        :return: VirtualNetworkLink or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.privatedns.models.VirtualNetworkLink or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/virtualNetworkLinks/{virtualNetworkLinkName}'}

    def list(
            self, resource_group_name, private_zone_name, top=None, custom_headers=None, raw=False, **operation_config):
