...
class AdaptiveNetworkControlsEffectiveNetworkSecurityGroups(Model):
    ...
    def __init__(self, *, network_interface: str=None, network_security_groups=None, **kwargs) -> None:
        super(AdaptiveNetworkControlsEffectiveNetworkSecurityGroups, self).__init__(**kwargs)
