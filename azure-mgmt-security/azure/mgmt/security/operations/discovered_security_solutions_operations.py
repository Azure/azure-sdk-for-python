...
class DiscoveredSecuritySolutionsOperations(object):
    ...
    def list(
        ...
        deserialized = models.DiscoveredSecuritySolutionPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.DiscoveredSecuritySolutionPaged(internal_paging, self._deserialize.dependencies, header_dict)
