...
class LocationsOperations(object):
    ...
    def list(
        ...
        deserialized = models.AscLocationPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.AscLocationPaged(internal_paging, self._deserialize.dependencies, header_dict)
