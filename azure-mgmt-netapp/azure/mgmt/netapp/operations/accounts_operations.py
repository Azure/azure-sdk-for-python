...
class AccountsOperations(object):
    ...
    def list(
        ...
        :return: NetAppAccountList or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.netapp.models.NetAppAccountList or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('NetAppAccountList', response)
