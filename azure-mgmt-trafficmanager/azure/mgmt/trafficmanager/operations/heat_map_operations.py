...
class HeatMapOperations(object):
    ...
    def get(
        ...
        :type top_left: list of float
        :param bot_right: The bottom right latitude,longitude pair of the
         rectangular viewport to query for.
        :type bot_right: list of float
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: :class:`HeatMapModel
         <azure.mgmt.trafficmanager.models.HeatMapModel>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype: :class:`HeatMapModel
         <azure.mgmt.trafficmanager.models.HeatMapModel>` or
