...
class TrafficManagerManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
        ...
        super(TrafficManagerManagementClientConfiguration, self).__init__(base_url, filepath)
...
class TrafficManagerManagementClient(object):
    ...
    def __init__(
        ...
        self.config = TrafficManagerManagementClientConfiguration(credentials, subscription_id, api_version, accept_language, long_running_operation_retry_timeout, generate_client_request_id, base_url, filepath)
