...
class TrafficManagerManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, subscription_id, api_version='2015-11-01', base_url=None):
...
class TrafficManagerManagementClient(object):
    ...
    def __init__(
        ...
        self.config = TrafficManagerManagementClientConfiguration(credentials, subscription_id, api_version, base_url)
