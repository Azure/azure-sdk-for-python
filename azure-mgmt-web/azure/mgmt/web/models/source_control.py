...
class SourceControl(Resource):
    ...
    def __init__(self, location, kind=None, tags=None, source_control_name=None, token=None, token_secret=None, refresh_token=None, expiration_time=None):
        super(SourceControl, self).__init__(kind=kind, location=location, tags=tags)
