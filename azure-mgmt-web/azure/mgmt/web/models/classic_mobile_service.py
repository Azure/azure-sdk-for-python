...
class ClassicMobileService(Resource):
    ...
    def __init__(self, location, id=None, name=None, kind=None, type=None, tags=None, classic_mobile_service_name=None):
        super(ClassicMobileService, self).__init__(id=id, name=name, kind=kind, location=location, type=type, tags=tags)
