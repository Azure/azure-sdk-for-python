...
class RecommendationRule(ProxyOnlyResource):
    ...
    def __init__(self, kind=None, recommendation_name=None, display_name=None, message=None, recommendation_id=None, description=None, action_name=None, level=None, channels=None, is_dynamic=None, extension_name=None, blade_name=None, forward_link=None):
