...
class SiteSourceControl(Resource):
    ...
    def __init__(self, location, kind=None, tags=None, repo_url=None, branch=None, is_manual_integration=None, deployment_rollback_enabled=None, is_mercurial=None):
        super(SiteSourceControl, self).__init__(kind=kind, location=location, tags=tags)
