...
class FunctionEnvelope(ProxyOnlyResource):
    ...
    def __init__(self, kind=None, function_app_id=None, script_root_path_href=None, script_href=None, config_href=None, secrets_file_href=None, href=None, config=None, files=None, test_data=None):
