...
class User(Resource):
    ...
    def __init__(self, location, kind=None, tags=None, user_name=None, publishing_user_name=None, publishing_password=None, publishing_password_hash=None, publishing_password_hash_salt=None):
        super(User, self).__init__(kind=kind, location=location, tags=tags)
