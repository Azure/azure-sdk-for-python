...
class SnapshotRestoreRequest(ProxyOnlyResource):
    ...
    :param overwrite: If <code>true</code> the restore operation can overwrite
    ...
    def __init__(self, overwrite, kind=None, snapshot_time=None, recovery_source=None, recover_configuration=None, ignore_conflicting_host_names=None):
        super(SnapshotRestoreRequest, self).__init__(kind=kind)
