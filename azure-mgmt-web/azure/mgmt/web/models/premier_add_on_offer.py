...
class PremierAddOnOffer(Resource):
    ...
    def __init__(self, location, kind=None, tags=None, sku=None, product=None, vendor=None, premier_add_on_offer_name=None, promo_code_required=None, quota=None, web_hosting_plan_restrictions=None, privacy_policy_url=None, legal_terms_url=None, marketplace_publisher=None, marketplace_offer=None):
        super(PremierAddOnOffer, self).__init__(kind=kind, location=location, tags=tags)
        self.sku = sku
