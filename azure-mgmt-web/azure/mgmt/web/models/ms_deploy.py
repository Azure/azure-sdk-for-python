...
class MSDeploy(Model):
    ...
    :param add_on_packages: List of Add-On packages. Add-On packages
     implicitly enable the Do Not Delete MSDeploy rule.
    :type add_on_packages: list of :class:`MSDeployCore
     <azure.mgmt.web.models.MSDeployCore>`
    ...
    _attribute_map = {
        'add_on_packages': {'key': 'addOnPackages', 'type': '[MSDeployCore]'},
    ...
    def __init__(self, add_on_packages=None, package_uri=None, connection_string=None, db_type=None, set_parameters_xml_file_uri=None, set_parameters=None, skip_app_data=None, app_offline=None):
        self.add_on_packages = add_on_packages
