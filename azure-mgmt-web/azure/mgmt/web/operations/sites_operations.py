...
class SitesOperations(object):
    ...
    def swap_slot_with_production(
            self, resource_group_name, name, slot_swap_entity, custom_headers={}, raw=False, **operation_config):
        """
        Swaps web app slots
        ...
        :param name: Name of web app
        :type name: str
        :param slot_swap_entity: Request body that contains the target slot
         name
        :type slot_swap_entity: :class:`CsmSlotEntity
         <websitemanagementclient.models.CsmSlotEntity>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
    ...
    def swap_slots_slot(
            self, resource_group_name, name, slot_swap_entity, slot, custom_headers={}, raw=False, **operation_config):
        """
        Swaps web app slots
    ...
    def list_site_publishing_profile_xml(
            self, resource_group_name, name, options, custom_headers={}, raw=False, callback=None, **operation_config):
        """
        ...
        :param name: Name of web app
        :type name: str
        :param options: Specifies options for publishing profile. Pass
         CsmPublishingProfileOptions.Format=FileZilla3 for FileZilla FTP
         format.
        :type options: :class:`CsmPublishingProfileOptions
         <websitemanagementclient.models.CsmPublishingProfileOptions>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
    ...
    def list_site_publishing_profile_xml_slot(
            self, resource_group_name, name, options, slot, custom_headers={}, raw=False, callback=None, **operation_config):
        """
        Gets the publishing profile for web app
