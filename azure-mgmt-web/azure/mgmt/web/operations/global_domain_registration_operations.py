...
class GlobalDomainRegistrationOperations(object):
    ...
    def check_domain_availability(
            self, identifier, custom_headers={}, raw=False, **operation_config):
        """
        Checks if a domain is available for registration

        :param identifier: Name of the domain
        :type identifier: :class:`NameIdentifier
    ...
    def list_domain_recommendations(
        ...
        :type parameters: :class:`DomainRecommendationSearchParameters
         <websitemanagementclient.models.DomainRecommendationSearchParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
