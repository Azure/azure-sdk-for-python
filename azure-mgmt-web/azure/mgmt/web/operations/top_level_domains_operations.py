...
class TopLevelDomainsOperations(object):
    ...
    def list_top_level_domain_agreements(
            self, name, agreement_option, custom_headers={}, raw=False, **operation_config):
        """
        ...
        :type agreement_option: :class:`TopLevelDomainAgreementOption
         <websitemanagementclient.models.TopLevelDomainAgreementOption>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
