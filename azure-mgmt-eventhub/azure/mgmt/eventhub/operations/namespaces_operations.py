...
class NamespacesOperations(object):
    ...
    def check_name_availability_method(
        ...
        :rtype: :class:`CheckNameAvailabilityResult
         <azure.mgmt.eventhub.models.CheckNameAvailabilityResult>`
    ...
    def list(
        ...
        :rtype: :class:`NamespacePaged
         <azure.mgmt.eventhub.models.NamespacePaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def create_or_update(
        ...
        :type parameters: :class:`Namespace
         <azure.mgmt.eventhub.models.Namespace>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :rtype: :class:`Namespace <azure.mgmt.eventhub.models.Namespace>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def update(
        ...
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        parameters = models.NamespaceUpdateParameter(tags=tags, sku=sku)
