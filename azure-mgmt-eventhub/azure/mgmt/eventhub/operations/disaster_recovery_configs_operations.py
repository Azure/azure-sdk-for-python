...
class DisasterRecoveryConfigsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.eventhub.models.ArmDisasterRecoveryPaged[~azure.mgmt.eventhub.models.ArmDisasterRecovery]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.eventhub.models.ErrorResponseException>`
        """
    ...
    def create_or_update(
        ...
        :rtype: ~azure.mgmt.eventhub.models.ArmDisasterRecovery or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.mgmt.eventhub.models.ErrorResponseException>`
        """
