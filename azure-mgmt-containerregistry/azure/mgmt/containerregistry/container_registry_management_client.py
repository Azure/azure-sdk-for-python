...
class ContainerRegistryManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, subscription_id, api_version='2016-06-27-preview', base_url=None):
...
class ContainerRegistryManagementClient(object):
    ...
    def __init__(
        ...
        self.config = ContainerRegistryManagementClientConfiguration(credentials, subscription_id, api_version, base_url)
