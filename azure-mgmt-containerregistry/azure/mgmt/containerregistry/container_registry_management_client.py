...
############ Generated from here ############
    ...
    def runs(self):
        """Instance depends on the API version:
           ...
           * 2019-05-01-preview: :class:`RunsOperations<azure.mgmt.containerregistry.v2019_05_01_preview.operations.RunsOperations>`
        """
        ...
        if api_version == '2018-09-01':
            ...
            from .v2019_05_01_preview.operations import RunsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def tasks(self):
        """Instance depends on the API version:
           ...
           * 2019-05-01-preview: :class:`TasksOperations<azure.mgmt.containerregistry.v2019_05_01_preview.operations.TasksOperations>`
        """
        api_version = self._get_api_version('tasks')
        if api_version == '2018-09-01':
            from .v2018_09_01.operations import TasksOperations as OperationClass
        elif api_version == '2019-05-01-preview':
            from .v2019_05_01_preview.operations import TasksOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
