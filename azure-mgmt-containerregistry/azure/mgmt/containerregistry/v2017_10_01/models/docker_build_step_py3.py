...
class DockerBuildStep(BuildStepProperties):
    ...
    :vartype base_image_dependencies:
     list[~azure.mgmt.containerregistry.v2017_10_01.models.BaseImageDependency]
    ...
    def __init__(self, *, branch: str=None, image_names=None, is_push_enabled: bool=False, no_cache: bool=False, docker_file_path: str=None, context_path: str=None, build_arguments=None, base_image_trigger=None, **kwargs) -> None:
