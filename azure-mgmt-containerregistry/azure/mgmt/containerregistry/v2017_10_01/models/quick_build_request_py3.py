...
class QuickBuildRequest(QueueBuildRequest):
    ...
    def __init__(self, *, source_location: str, platform, docker_file_path: str, image_names=None, build_arguments=None, is_push_enabled: bool=False, no_cache: bool=False, timeout: int=3600, **kwargs) -> None:
