...
class BuildTaskRequest(RunRequest):
    ...
    :type type: str
    :param definition_file_path: Required. The template/definition file path
    ...
    def __init__(self, *, definition_file_path: str, source_location: str, platform, is_archive_enabled: bool=False, values_file_path: str=None, values=None, timeout: int=3600, agent_configuration=None, **kwargs) -> None:
        super(BuildTaskRequest, self).__init__(is_archive_enabled=is_archive_enabled, **kwargs)
