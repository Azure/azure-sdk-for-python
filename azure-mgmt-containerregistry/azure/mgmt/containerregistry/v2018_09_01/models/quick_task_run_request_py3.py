...
class QuickTaskRunRequest(RunRequest):
    ...
    def __init__(self, *, task_definition_content: str, platform, is_archive_enabled: bool=False, values_content: str=None, values=None, timeout: int=3600, agent_configuration=None, **kwargs) -> None:
        super(QuickTaskRunRequest, self).__init__(is_archive_enabled=is_archive_enabled, **kwargs)
