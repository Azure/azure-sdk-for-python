...
class TriggerUpdateParameters(Model):
    ...
    :type source_triggers:
     list[~azure.mgmt.containerregistry.v2019_05_01_preview.models.SourceTriggerUpdateParameters]
    :param base_image_trigger: The trigger based on base image dependencies.
    :type base_image_trigger:
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.BaseImageTriggerUpdateParameters
    """
