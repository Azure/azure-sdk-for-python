...
class Run(ProxyResource):
    ...
    :param status: The current status of the run. Possible values include:
     ...
     'Error', 'Timeout'
    :type status: str or
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.RunStatus
    ...
    :type run_type: str or
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.RunType
    ...
    :type output_images:
     list[~azure.mgmt.containerregistry.v2019_05_01_preview.models.ImageDescriptor]
    ...
    :type image_update_trigger:
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.ImageUpdateTrigger
    :param source_trigger: The source trigger that caused the run.
    :type source_trigger:
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.SourceTriggerDescriptor
