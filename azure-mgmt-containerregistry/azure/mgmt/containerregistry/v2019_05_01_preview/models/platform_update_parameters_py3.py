...
class PlatformUpdateParameters(Model):
    ...
    :type os: str or
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.OS
    :param architecture: The OS architecture. Possible values include:
     'amd64', 'x86', 'arm'
    :type architecture: str or
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.Architecture
    :param variant: Variant of the CPU. Possible values include: 'v6', 'v7',
     'v8'
    :type variant: str or
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.Variant
    """
