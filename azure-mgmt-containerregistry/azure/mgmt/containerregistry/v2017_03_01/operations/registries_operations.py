...
class RegistriesOperations(object):
    ...
    def create(
            self, resource_group_name, registry_name, registry_create_parameters, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :rtype:
         ...
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.containerregistry.v2017_03_01.models.Registry]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
