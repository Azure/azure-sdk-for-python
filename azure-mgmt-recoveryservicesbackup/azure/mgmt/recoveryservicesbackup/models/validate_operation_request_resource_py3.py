...
class ValidateOperationRequestResource(Resource):
    ...
    :type e_tag: str
    :param properties: ValidateOperationRequestResource properties
    :type properties:
    ...
    def __init__(self, *, location: str=None, tags=None, e_tag: str=None, properties=None, **kwargs) -> None:
        super(ValidateOperationRequestResource, self).__init__(location=location, tags=tags, e_tag=e_tag, **kwargs)
