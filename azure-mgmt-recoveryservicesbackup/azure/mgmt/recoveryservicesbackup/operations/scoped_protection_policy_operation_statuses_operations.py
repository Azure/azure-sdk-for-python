...
class ScopedProtectionPolicyOperationStatusesOperations(object):
    """ScopedProtectionPolicyOperationStatusesOperations operations.
    ...
    def get(
            self, vault_name, resource_group_name, fabric_name, policy_name, operation_id, custom_headers=None, raw=False, **operation_config):
        """Provides the status of the asynchronous operations like backup,
        restore. The status can
        be in progress, completed or failed. You can refer to the Operation
        Status enum for all
        ...
        return deserialized
    get.metadata = {'url': '/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/policies/{policyName}/operations/{operationId}'}
