...
class SecurityPINsOperations(object):
    ...
    def get(
        ...
        :return: TokenInformation or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.recoveryservicesbackup.models.TokenInformation or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('TokenInformation', response)
