...
class ScopedBackupPoliciesOperations(object):
    """ScopedBackupPoliciesOperations operations.
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/policies'}
