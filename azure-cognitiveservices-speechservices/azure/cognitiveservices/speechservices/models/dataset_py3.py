...
class Dataset(Model):
    ...
    def __init__(self, *, id: str, data_import_kind, name: str, created_date_time, last_action_date_time, status, description: str=None, properties=None, locale: str=None, **kwargs) -> None:
