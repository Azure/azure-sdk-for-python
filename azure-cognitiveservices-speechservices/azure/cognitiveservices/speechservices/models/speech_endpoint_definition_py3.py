...
class SpeechEndpointDefinition(Model):
    ...
    def __init__(self, *, models_property, name: str, concurrent_recognitions: int=None, content_logging_enabled: bool=None, description: str=None, properties=None, locale: str=None, **kwargs) -> None:
