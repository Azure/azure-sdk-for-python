...
class GetSupportedLocalesForModelsOKResponse(Model):
    ...
    def __init__(self, *, none=None, acoustic=None, language=None, acoustic_and_language=None, custom_voice=None, language_generation=None, sentiment=None, language_identification=None, **kwargs) -> None:
