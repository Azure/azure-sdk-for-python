...
class EndpointOperations(object):
    ...
    def create(
        ...
        return deserialized
    create.metadata = {'url': '/api/speechtotext/v2.0/endpoints'}
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/api/speechtotext/v2.0/endpoints/{id}'}
    ...
    def delete(
        ...
        return deserialized
    delete.metadata = {'url': '/api/speechtotext/v2.0/endpoints/{id}'}
    ...
    def update(
        ...
        return deserialized
    update.metadata = {'url': '/api/speechtotext/v2.0/endpoints/{id}'}
