...
class DatasetOperations(object):
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/api/speechtotext/v2.0/datasets/{id}'}
    ...
    def delete(
        ...
        return deserialized
    delete.metadata = {'url': '/api/speechtotext/v2.0/datasets/{id}'}
    ...
    def update(
        ...
        return deserialized
    update.metadata = {'url': '/api/speechtotext/v2.0/datasets/{id}'}
    ...
    def upload(
        ...
        return deserialized
    upload.metadata = {'url': '/api/speechtotext/v2.0/datasets/upload'}
