...
class SupportedLocalesForVoiceModelsOperations(object):
    """SupportedLocalesForVoiceModelsOperations operations.
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/api/texttospeech/v2.0/models/locales'}
