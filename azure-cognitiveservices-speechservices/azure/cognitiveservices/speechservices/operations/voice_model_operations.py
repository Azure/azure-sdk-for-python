...
class VoiceModelOperations(object):
    """VoiceModelOperations operations.
    ...
    def create(
        ...
        return deserialized
    create.metadata = {'url': '/api/texttospeech/v2.0/models'}
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/api/texttospeech/v2.0/models/{id}'}
    ...
    def delete(
        ...
        return deserialized
    delete.metadata = {'url': '/api/texttospeech/v2.0/models/{id}'}
    ...
    def update(
        ...
        return deserialized
    update.metadata = {'url': '/api/texttospeech/v2.0/models/{id}'}
