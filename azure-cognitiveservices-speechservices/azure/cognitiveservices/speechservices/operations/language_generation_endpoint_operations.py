...
class LanguageGenerationEndpointOperations(object):
    """LanguageGenerationEndpointOperations operations.
    ...
    def create(
        ...
        return deserialized
    create.metadata = {'url': '/api/languagegeneration/v2.0/Endpoints'}
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/api/languagegeneration/v2.0/Endpoints/{id}'}
    ...
    def delete(
        ...
        return deserialized
    delete.metadata = {'url': '/api/languagegeneration/v2.0/Endpoints/{id}'}
    ...
    def update(
        ...
        return deserialized
    update.metadata = {'url': '/api/languagegeneration/v2.0/Endpoints/{id}'}
