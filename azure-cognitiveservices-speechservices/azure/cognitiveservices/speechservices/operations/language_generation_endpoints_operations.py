...
class LanguageGenerationEndpointsOperations(object):
    """LanguageGenerationEndpointsOperations operations.
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/api/languagegeneration/v2.0/Endpoints'}
