...
class SupportedLocalesForTranscriptionsOperations(object):
    """SupportedLocalesForTranscriptionsOperations operations.
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/api/speechtotext/v2.0/transcriptions/locales'}
