...
class SupportedLocalesForVoiceEndpointsOperations(object):
    """SupportedLocalesForVoiceEndpointsOperations operations.
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/api/texttospeech/v2.0/endpoints/locales'}
