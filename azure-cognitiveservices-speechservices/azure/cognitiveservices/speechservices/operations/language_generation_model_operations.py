...
class LanguageGenerationModelOperations(object):
    """LanguageGenerationModelOperations operations.
    ...
    def create(
        ...
        return deserialized
    create.metadata = {'url': '/api/languagegeneration/v2.0/Models'}
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/api/languagegeneration/v2.0/Models/{id}'}
    ...
    def delete(
        ...
        return deserialized
    delete.metadata = {'url': '/api/languagegeneration/v2.0/Models/{id}'}
    ...
    def update(
        ...
        return deserialized
    update.metadata = {'url': '/api/languagegeneration/v2.0/Models/{id}'}
