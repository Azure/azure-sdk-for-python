...
class SupportedLocalesForVoiceDatasetsOperations(object):
    """SupportedLocalesForVoiceDatasetsOperations operations.
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/api/texttospeech/v2.0/datasets/locales'}
