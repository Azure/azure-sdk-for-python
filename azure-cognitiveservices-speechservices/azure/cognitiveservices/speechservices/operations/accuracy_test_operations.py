...
class AccuracyTestOperations(object):
    """AccuracyTestOperations operations.
    ...
    def create(
        ...
        return deserialized
    create.metadata = {'url': '/api/speechtotext/v2.0/accuracytests'}
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/api/speechtotext/v2.0/accuracytests/{id}'}
    ...
    def delete(
        ...
        return deserialized
    delete.metadata = {'url': '/api/speechtotext/v2.0/accuracytests/{id}'}
    ...
    def update(
        ...
        return deserialized
    update.metadata = {'url': '/api/speechtotext/v2.0/accuracytests/{id}'}
