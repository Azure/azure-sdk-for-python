...
class VoiceTestOperations(object):
    """VoiceTestOperations operations.
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/api/texttospeech/v2.0/tests/{id}'}
    ...
    def delete(
        ...
        return deserialized
    delete.metadata = {'url': '/api/texttospeech/v2.0/tests/{id}'}
    ...
    def create(
        ...
        return deserialized
    create.metadata = {'url': '/api/texttospeech/v2.0/tests'}
