...
class SupportedLocalesForEndpointsOperations(object):
    """SupportedLocalesForEndpointsOperations operations.
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/api/speechtotext/v2.0/endpoints/locales'}
