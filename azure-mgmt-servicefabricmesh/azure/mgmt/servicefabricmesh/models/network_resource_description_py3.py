...
class NetworkResourceDescription(TrackedResource):
    ...
    def __init__(self, *, address_prefix: str, location: str=None, tags=None, description: str=None, ingress_config=None, **kwargs) -> None:
        super(NetworkResourceDescription, self).__init__(location=location, tags=tags, **kwargs)
