...
class ContainerHostMappingsOperations(object):
    ...
    def get_container_host_mapping(
            self, location, container_host_resource_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    get_container_host_mapping.metadata = {'url': '/providers/Microsoft.DevSpaces/locations/{location}/checkContainerHostMapping'}
