...
class MigrateMySqlSqlTaskInput(NonSqlMigrationTaskInput):
    ...
    def __init__(self, *, target_connection_info, target_database_name: str, project_name: str, project_location: str, selected_tables, source_connection_info, **kwargs) -> None:
        super(MigrateMySqlSqlTaskInput, self).__init__(target_connection_info=target_connection_info, target_database_name=target_database_name, project_name=project_name, project_location=project_location, selected_tables=selected_tables, **kwargs)
