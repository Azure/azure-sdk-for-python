...
class SubscriptionOperations(object):
    ...
    def get_entity_tag(
        ...
        :param service_name: The name of the API Management service.
        :type service_name: str
        :param sid: Subscription entity Identifier. The entity represents the
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.apimanagement.models.SubscriptionCreateParameters
    ...
    def update(
        ...
        :type parameters:
         ~azure.mgmt.apimanagement.models.SubscriptionUpdateParameters
    ...
    def delete(
            self, resource_group_name, service_name, sid, if_match, custom_headers=None, raw=False, **operation_config):
