...
class ApiSchemaOperations(object):
    ...
    def list_by_api(
        ...
        deserialized = models.SchemaContractPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.SchemaContractPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def delete(
            self, resource_group_name, service_name, api_id, schema_id, if_match, custom_headers=None, raw=False, **operation_config):
