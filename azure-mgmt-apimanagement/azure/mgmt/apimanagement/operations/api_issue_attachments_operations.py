...
class ApiIssueAttachmentsOperations(object):
    """ApiIssueAttachmentsOperations operations.
    ...
    def list_by_service(
        ...
        :rtype:
         ~azure.mgmt.apimanagement.models.IssueAttachmentContractPaged[~azure.mgmt.apimanagement.models.IssueAttachmentContract]
        :raises:
        ...
        deserialized = models.IssueAttachmentContractPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.IssueAttachmentContractPaged(internal_paging, self._deserialize.dependencies, header_dict)
