...
class ProductPolicyOperations(object):
    ...
    def create_or_update(
            self, resource_group_name, service_name, product_id, policy_content, if_match=None, content_format="xml", custom_headers=None, raw=False, **operation_config):
    ...
    def delete(
            self, resource_group_name, service_name, product_id, if_match, custom_headers=None, raw=False, **operation_config):
