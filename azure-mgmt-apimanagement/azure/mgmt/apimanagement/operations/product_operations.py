...
class ProductOperations(object):
    ...
    def list_by_service(
            self, resource_group_name, service_name, filter=None, top=None, skip=None, expand_groups=None, tags=None, custom_headers=None, raw=False, **operation_config):
        ...
        :type skip: int
        :param expand_groups: When set to true, the response contains an array
        ...
        :rtype:
         ~azure.mgmt.apimanagement.models.ProductContractPaged[~azure.mgmt.apimanagement.models.ProductContract]
        :raises:
        ...
        deserialized = models.ProductContractPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ProductContractPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: ProductContract or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.apimanagement.models.ProductContract or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ProductContract', response)
            header_dict = {
                'ETag': 'str',
            }
    ...
    def create_or_update(
            self, resource_group_name, service_name, product_id, parameters, if_match=None, custom_headers=None, raw=False, **operation_config):
    ...
    def update(
            self, resource_group_name, service_name, product_id, parameters, if_match, custom_headers=None, raw=False, **operation_config):
        ...
        :type parameters:
         ~azure.mgmt.apimanagement.models.ProductUpdateParameters
    ...
    def delete(
            self, resource_group_name, service_name, product_id, if_match, delete_subscriptions=None, custom_headers=None, raw=False, **operation_config):
        """Delete product.
        ...
        :param if_match: ETag of the Entity. ETag should match the current
         ...
         be * for unconditional update.
        :type if_match: str
        :param delete_subscriptions: Delete existing subscriptions associated
    ...
    def list_by_tags(
            self, resource_group_name, service_name, filter=None, top=None, skip=None, include_not_tagged_products=None, custom_headers=None, raw=False, **operation_config):
