...
class ApiReleaseOperations(object):
    ...
    def list(
        ...
        deserialized = models.ApiReleaseContractPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ApiReleaseContractPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def create(
        ...
        :raises:
         :class:`ErrorResponseException<azure.mgmt.apimanagement.models.ErrorResponseException>`
        """
        parameters = models.ApiReleaseContract(notes=notes)
