...
from .operations.check_resource_name_availability_operations import CheckResourceNameAvailabilityOperations
...
class RecoveryServicesClient(SDKClient):
    ...
    :ivar check_resource_name_availability: CheckResourceNameAvailability operations
    :vartype check_resource_name_availability: azure.mgmt.recoveryservices.operations.CheckResourceNameAvailabilityOperations
    ...
    def __init__(
        ...
        self.replication_usages = ReplicationUsagesOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.check_resource_name_availability = CheckResourceNameAvailabilityOperations(
            self._client, self.config, self._serialize, self._deserialize)
