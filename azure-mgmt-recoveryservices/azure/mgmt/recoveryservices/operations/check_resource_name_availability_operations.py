...
class CheckResourceNameAvailabilityOperations(object):
    """CheckResourceNameAvailabilityOperations operations.
    ...
    def post(
        ...
        """
        input = models.ResourceNameAvailabilityInput(type=type, name=name)
        ...
        # Construct body
        body_content = self._serialize.body(input, 'ResourceNameAvailabilityInput')
        ...
        return deserialized
    post.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.RecoveryServices/locations/{location}/checkNameAvailability'}
