...
try:
    ...
    from .resource_name_availability_input_py3 import ResourceNameAvailabilityInput
    ...
    from .resource_name_availability_input import ResourceNameAvailabilityInput
