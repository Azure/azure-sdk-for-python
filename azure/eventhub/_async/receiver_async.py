...
class AsyncReceiver(Receiver):
    ...
    def __init__(self, client, source, offset=None, prefetch=300, epoch=None, keep_alive=None, auto_reconnect=True, loop=None):  # pylint: disable=super-init-not-called
        """
