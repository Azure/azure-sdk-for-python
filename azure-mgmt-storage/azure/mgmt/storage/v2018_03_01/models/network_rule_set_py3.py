...
class NetworkRuleSet(Model):
    ...
    :type bypass: str or ~azure.mgmt.storage.v2018_03_01.models.Bypass
    :param virtual_network_rules: Sets the virtual network rules
    :type virtual_network_rules:
     list[~azure.mgmt.storage.v2018_03_01.models.VirtualNetworkRule]
    :param ip_rules: Sets the IP ACL rules
    :type ip_rules: list[~azure.mgmt.storage.v2018_03_01.models.IPRule]
    ...
    :type default_action: str or
     ~azure.mgmt.storage.v2018_03_01.models.DefaultAction
    """
