...
class AccountSasParameters(Model):
    ...
    :type services: str or :class:`enum <azure.mgmt.storage.models.enum>`
    ...
    :type resource_types: str or :class:`enum
     <azure.mgmt.storage.models.enum>`
    :param permissions: The signed permissions for the account SAS. Possible
     ...
     'l', 'a', 'c', 'u', 'p'
    :type permissions: str or :class:`enum <azure.mgmt.storage.models.enum>`
    ...
    :type protocols: str or :class:`HttpProtocol
     <azure.mgmt.storage.models.HttpProtocol>`
