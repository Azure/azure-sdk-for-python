...
| Streaming via `QueueStreamHandler` | [`samples/durable_streaming/durable_streaming.py`](https://github.com/Azure/azure-sdk-for-python/blob/refs/heads/feature/agentserver-durable-tasks/sdk/agentserver/azure-ai-agentserver-core/samples/durable_streaming/durable_streaming.py) |
