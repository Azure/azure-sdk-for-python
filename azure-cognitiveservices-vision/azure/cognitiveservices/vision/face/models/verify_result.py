...
class VerifyResult(Model):
    ...
    :param confidence: "A number indicates the similarity confidence of
     whether two faces belong to the same person, or whether the face belongs
     ...
     users to override "isIdentical" and fine-tune the result on their own
     data"
