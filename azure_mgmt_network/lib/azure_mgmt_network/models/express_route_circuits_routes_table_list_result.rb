...
module Azure::ARM::Network
  module Models
    ...
    class ExpressRouteCircuitsRoutesTableListResult
      ...
      def self.serialize_object(object)
        ...
        unless serialized_property.nil?
          ...
          serialized_property.each do |element|
            unless element.nil?
              element = ExpressRouteCircuitRoutesTable.serialize_object(element)
            end
      ...
      # @return [ExpressRouteCircuitsRoutesTableListResult] Deserialized
      # object.
      #
      def self.deserialize_object(object)
        return if object.nil?
        output_object = ExpressRouteCircuitsRoutesTableListResult.new
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element1|
            unless element1.nil?
              element1 = ExpressRouteCircuitRoutesTable.deserialize_object(element1)
            end
