...
module Azure::ARM::Network
  module Models
    ...
    class ExpressRouteServiceProviderListResult
      ...
      def self.serialize_object(object)
        ...
        unless serialized_property.nil?
          ...
          serialized_property.each do |element|
            unless element.nil?
              element = ExpressRouteServiceProvider.serialize_object(element)
            end
      ...
      # @return [ExpressRouteServiceProviderListResult] Deserialized object.
      #
      def self.deserialize_object(object)
        return if object.nil?
        output_object = ExpressRouteServiceProviderListResult.new
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element1|
            unless element1.nil?
              element1 = ExpressRouteServiceProvider.deserialize_object(element1)
            end
