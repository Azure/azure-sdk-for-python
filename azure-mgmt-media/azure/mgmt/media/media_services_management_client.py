...
class MediaServicesManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, subscription_id, api_version='2015-10-01', base_url=None):
...
class MediaServicesManagementClient(object):
    ...
    def __init__(
        ...
        self.config = MediaServicesManagementClientConfiguration(credentials, subscription_id, api_version, base_url)
