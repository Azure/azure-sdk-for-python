...
class ServiceKeys(Model):
    ...
    def __init__(self, *, primary_auth_endpoint: str=None, secondary_auth_endpoint: str=None, primary_key: str=None, secondary_key: str=None, scope: str=None, **kwargs) -> None:
