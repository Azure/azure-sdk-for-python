...
class ApplicationOperations(object):
    ...
    def activate_application_package(
            self, resource_group_name, account_name, id, version, parameters, custom_headers={}, raw=False, **operation_config):
        """
        ...
        :type parameters: :class:`ActivateApplicationPackageParameters
         <batchmanagementclient.models.ActivateApplicationPackageParameters>`
    ...
    def add_application(
            self, resource_group_name, account_name, application_id, parameters=None, custom_headers={}, raw=False, **operation_config):
        """
        ...
        :param parameters: The parameters for the request.
        :type parameters: :class:`AddApplicationParameters
         <batchmanagementclient.models.AddApplicationParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
