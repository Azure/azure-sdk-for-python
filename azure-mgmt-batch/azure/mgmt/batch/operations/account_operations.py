...
class AccountOperations(object):
    ...
    def update(
        ...
        :type parameters: :class:`BatchAccountUpdateParameters
         <batchmanagementclient.models.BatchAccountUpdateParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
    ...
    def regenerate_key(
        ...
        :type parameters: :class:`BatchAccountRegenerateKeyParameters
         <batchmanagementclient.models.BatchAccountRegenerateKeyParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
