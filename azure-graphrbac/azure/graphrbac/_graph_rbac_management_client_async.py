...
from .operations_async import OAuth2Operations
from . import models


class GraphRbacManagementClientAsync(SDKClientAsync):
    ...
    def __init__(
        ...
        super(GraphRbacManagementClientAsync, self).__init__(self.config)
