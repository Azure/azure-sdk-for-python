...
class GroupOperations(object):
    ...
    def add_member(
            self, group_object_id, parameters, custom_headers={}, raw=False, **operation_config):
        """
        Add a memeber to a group.

        :param group_object_id: Group object id
        :type group_object_id: str
        :param parameters: Member Object Url as
         https://graph.windows.net/contoso.onmicrosoft.com/directoryObjects/f260bbc4-c254-447b-94cf-293b5ec434dd
        :type parameters: :class:`GroupAddMemberParameters
         <graphrbacmanagementclient.models.GroupAddMemberParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def get_member_groups(
            self, object_id, parameters, custom_headers={}, raw=False, **operation_config):
        """
        ...
        :type parameters: :class:`GroupGetMemberGroupsParameters
         <graphrbacmanagementclient.models.GroupGetMemberGroupsParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
