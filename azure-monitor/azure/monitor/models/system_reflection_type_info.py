...
class SystemReflectionTypeInfo(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.generic_type_parameters = kwargs.get('generic_type_parameters', None)
        self.declared_constructors = kwargs.get('declared_constructors', None)
        self.declared_events = kwargs.get('declared_events', None)
        self.declared_fields = kwargs.get('declared_fields', None)
        self.declared_members = kwargs.get('declared_members', None)
        self.declared_methods = kwargs.get('declared_methods', None)
        self.declared_nested_types = kwargs.get('declared_nested_types', None)
        self.declared_properties = kwargs.get('declared_properties', None)
        self.implemented_interfaces = kwargs.get('implemented_interfaces', None)
