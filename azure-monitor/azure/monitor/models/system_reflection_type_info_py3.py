...
class SystemReflectionTypeInfo(Model):
    """SystemReflectionTypeInfo.

    :param generic_type_parameters:
    :type generic_type_parameters: list[~azure.monitor.models.SystemType]
    :param declared_constructors:
    :type declared_constructors:
     list[~azure.monitor.models.SystemReflectionConstructorInfo]
    :param declared_events:
    :type declared_events:
     list[~azure.monitor.models.SystemReflectionEventInfo]
    :param declared_fields:
    :type declared_fields:
     list[~azure.monitor.models.SystemReflectionFieldInfo]
    :param declared_members:
    :type declared_members:
     list[~azure.monitor.models.SystemReflectionMemberInfo]
    :param declared_methods:
    :type declared_methods:
     list[~azure.monitor.models.SystemReflectionMethodInfo]
    :param declared_nested_types:
    :type declared_nested_types:
     list[~azure.monitor.models.SystemReflectionTypeInfo]
    :param declared_properties:
    :type declared_properties:
     list[~azure.monitor.models.SystemReflectionPropertyInfo]
    :param implemented_interfaces:
    :type implemented_interfaces: list[~azure.monitor.models.SystemType]
    ...
    _attribute_map = {
        'generic_type_parameters': {'key': 'GenericTypeParameters', 'type': '[SystemType]'},
        'declared_constructors': {'key': 'DeclaredConstructors', 'type': '[SystemReflectionConstructorInfo]'},
        'declared_events': {'key': 'DeclaredEvents', 'type': '[SystemReflectionEventInfo]'},
        'declared_fields': {'key': 'DeclaredFields', 'type': '[SystemReflectionFieldInfo]'},
        'declared_members': {'key': 'DeclaredMembers', 'type': '[SystemReflectionMemberInfo]'},
        'declared_methods': {'key': 'DeclaredMethods', 'type': '[SystemReflectionMethodInfo]'},
        'declared_nested_types': {'key': 'DeclaredNestedTypes', 'type': '[SystemReflectionTypeInfo]'},
        'declared_properties': {'key': 'DeclaredProperties', 'type': '[SystemReflectionPropertyInfo]'},
        'implemented_interfaces': {'key': 'ImplementedInterfaces', 'type': '[SystemType]'},
