...
class SchedulerManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, subscription_id, api_version='2016-03-01', base_url=None):
...
class SchedulerManagementClient(object):
    ...
    def __init__(
        ...
        self.config = SchedulerManagementClientConfiguration(credentials, subscription_id, api_version, base_url)
