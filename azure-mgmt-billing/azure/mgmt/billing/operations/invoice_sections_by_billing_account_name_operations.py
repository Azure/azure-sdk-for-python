...
class InvoiceSectionsByBillingAccountNameOperations(object):
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/invoiceSections'}
