...
class InvoiceSectionsByBillingProfileNameOperations(object):
    """InvoiceSectionsByBillingProfileNameOperations operations.
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/invoiceSections'}
