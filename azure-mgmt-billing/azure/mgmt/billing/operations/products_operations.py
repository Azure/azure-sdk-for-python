...
class ProductsOperations(object):
    ...
    def get(
            self, billing_account_id, invoice_section_id, product_name, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    get.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/invoiceSections/{invoiceSectionId}/products/{productName}'}
