...
from .operations.invoice_pricesheets_operations import InvoicePricesheetsOperations
...
class BillingManagementClient(SDKClient):
    ...
    :ivar invoice_pricesheets: InvoicePricesheets operations
    :vartype invoice_pricesheets: azure.mgmt.billing.operations.InvoicePricesheetsOperations
    ...
    def __init__(
        ...
        self.invoices = InvoicesOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.invoice_pricesheets = InvoicePricesheetsOperations(
            self._client, self.config, self._serialize, self._deserialize)
