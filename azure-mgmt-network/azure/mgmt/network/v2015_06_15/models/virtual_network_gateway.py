...
class VirtualNetworkGateway(Resource):
    ...
    :type ip_configurations: list of
     ...
     <azure.mgmt.network.v20150615.models.VirtualNetworkGatewayIPConfiguration>`
    ...
    :type gateway_type: str or :class:`VirtualNetworkGatewayType
     <azure.mgmt.network.v20150615.models.VirtualNetworkGatewayType>`
    ...
    :type vpn_type: str or :class:`VpnType
     <azure.mgmt.network.v20150615.models.VpnType>`
    ...
    :type sku: :class:`VirtualNetworkGatewaySku
     <azure.mgmt.network.v20150615.models.VirtualNetworkGatewaySku>`
    ...
    :type vpn_client_configuration: :class:`VpnClientConfiguration
     <azure.mgmt.network.v20150615.models.VpnClientConfiguration>`
