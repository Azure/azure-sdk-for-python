...
class ExpressRouteCircuitsOperations:
    ...
    async def create_or_update(
        ...
        :rtype: ~~azure.mgmt.network.v2015_06_15.models.ExpressRouteCircuit or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2015_06_15.models.ExpressRouteCircuit]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_arp_table(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ExpressRouteCircuitArpTablePaged(
    ...
    def list_routes_table(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ExpressRouteCircuitRoutesTablePaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    def list_stats(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ExpressRouteCircuitStatsPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
