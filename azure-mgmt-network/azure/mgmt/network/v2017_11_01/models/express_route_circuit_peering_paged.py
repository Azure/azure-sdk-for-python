...
class ExpressRouteCircuitPeeringPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ExpressRouteCircuitPeering <azure.mgmt.network.v2017_11_01.models.ExpressRouteCircuitPeering>` object
    """
