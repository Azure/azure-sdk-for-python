...
class NetworkInterfacesOperations(object):
    ...
    def get_effective_route_table(
        ...
        :rtype:
         ...
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_11_01.models.EffectiveRouteListResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_effective_network_security_groups(
        ...
        :rtype:
         ...
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_11_01.models.EffectiveNetworkSecurityGroupListResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
