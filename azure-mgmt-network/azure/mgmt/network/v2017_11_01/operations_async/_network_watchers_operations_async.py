...
class NetworkWatchersOperations:
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.NetworkWatcherPaged(
    ...
    async def get_topology(
        ...
        :param parameters: Parameters that define the representation of
         topology.
        :type parameters:
         ~azure.mgmt.network.v2017_11_01.models.TopologyParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~azure.mgmt.network.v2017_11_01.models.Topology or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    async def verify_ip_flow(
        ...
        :type parameters:
         ~azure.mgmt.network.v2017_11_01.models.VerificationIPFlowParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of VerificationIPFlowResult or
         ClientRawResponse<VerificationIPFlowResult> if raw==True
        :rtype:
         ~~azure.mgmt.network.v2017_11_01.models.VerificationIPFlowResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_11_01.models.VerificationIPFlowResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def get_next_hop(
        ...
        :param parameters: Parameters that define the source and destination
         endpoint.
        :type parameters:
         ~azure.mgmt.network.v2017_11_01.models.NextHopParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of NextHopResult or
         ClientRawResponse<NextHopResult> if raw==True
        :rtype: ~~azure.mgmt.network.v2017_11_01.models.NextHopResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_11_01.models.NextHopResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def get_vm_security_rules(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of SecurityGroupViewResult or
         ClientRawResponse<SecurityGroupViewResult> if raw==True
        :rtype:
         ~~azure.mgmt.network.v2017_11_01.models.SecurityGroupViewResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_11_01.models.SecurityGroupViewResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def get_troubleshooting(
        ...
        :param parameters: Parameters that define the resource to
         troubleshoot.
        :type parameters:
         ~azure.mgmt.network.v2017_11_01.models.TroubleshootingParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of TroubleshootingResult or
         ClientRawResponse<TroubleshootingResult> if raw==True
        :rtype: ~~azure.mgmt.network.v2017_11_01.models.TroubleshootingResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_11_01.models.TroubleshootingResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def set_flow_log_configuration(
        ...
        :param parameters: Parameters that define the configuration of flow
         log.
        :type parameters:
         ~azure.mgmt.network.v2017_11_01.models.FlowLogInformation
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of FlowLogInformation or
         ClientRawResponse<FlowLogInformation> if raw==True
        :rtype: ~~azure.mgmt.network.v2017_11_01.models.FlowLogInformation or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_11_01.models.FlowLogInformation]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def check_connectivity(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of ConnectivityInformation or
         ClientRawResponse<ConnectivityInformation> if raw==True
        :rtype:
         ~~azure.mgmt.network.v2017_11_01.models.ConnectivityInformation or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_11_01.models.ConnectivityInformation]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def get_azure_reachability_report(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of AzureReachabilityReport or
         ClientRawResponse<AzureReachabilityReport> if raw==True
        :rtype:
         ~~azure.mgmt.network.v2017_11_01.models.AzureReachabilityReport or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_11_01.models.AzureReachabilityReport]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def list_available_providers(
        ...
        :param parameters: Parameters that scope the list of available
         providers.
        :type parameters:
         ~azure.mgmt.network.v2017_11_01.models.AvailableProvidersListParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of AvailableProvidersList or
         ClientRawResponse<AvailableProvidersList> if raw==True
        :rtype: ~~azure.mgmt.network.v2017_11_01.models.AvailableProvidersList
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_11_01.models.AvailableProvidersList]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
