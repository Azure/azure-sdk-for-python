...
class ApplicationSecurityGroupsOperations:
    ...
    async def create_or_update(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of ApplicationSecurityGroup or
         ClientRawResponse<ApplicationSecurityGroup> if raw==True
        :rtype:
         ~~azure.mgmt.network.v2017_11_01.models.ApplicationSecurityGroup or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_11_01.models.ApplicationSecurityGroup]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_all(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ApplicationSecurityGroupPaged(
