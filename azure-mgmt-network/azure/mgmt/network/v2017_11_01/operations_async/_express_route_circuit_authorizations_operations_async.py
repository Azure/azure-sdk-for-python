...
class ExpressRouteCircuitAuthorizationsOperations:
    ...
    async def create_or_update(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of ExpressRouteCircuitAuthorization or
         ClientRawResponse<ExpressRouteCircuitAuthorization> if raw==True
        :rtype:
         ~~azure.mgmt.network.v2017_11_01.models.ExpressRouteCircuitAuthorization
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_11_01.models.ExpressRouteCircuitAuthorization]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ExpressRouteCircuitAuthorizationPaged(
