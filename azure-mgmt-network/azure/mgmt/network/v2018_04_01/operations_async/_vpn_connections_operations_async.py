...
class VpnConnectionsOperations:
    ...
    async def create_or_update(
        ...
        :return: An instance of VpnConnection or
         ClientRawResponse<VpnConnection> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_04_01.models.VpnConnection or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_04_01.models.VpnConnection]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2018_04_01.models.ErrorException>`
        """
    ...
    def list_by_vpn_gateway(
        ...
        if raw:
            header_dict = {}
        deserialized = models.VpnConnectionPaged(
