...
class NetworkInterfacesOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_04_01.models.NetworkInterface or
    ...
    async def create_or_update(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of NetworkInterface or
         ClientRawResponse<NetworkInterface> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_04_01.models.NetworkInterface or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_04_01.models.NetworkInterface]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_all(
        ...
        if raw:
            header_dict = {}
        deserialized = models.NetworkInterfacePaged(
    ...
    async def get_effective_route_table(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of EffectiveRouteListResult or
         ClientRawResponse<EffectiveRouteListResult> if raw==True
        :rtype:
         ~~azure.mgmt.network.v2018_04_01.models.EffectiveRouteListResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_04_01.models.EffectiveRouteListResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def list_effective_network_security_groups(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of EffectiveNetworkSecurityGroupListResult or
         ClientRawResponse<EffectiveNetworkSecurityGroupListResult> if
         raw==True
        :rtype:
         ~~azure.mgmt.network.v2018_04_01.models.EffectiveNetworkSecurityGroupListResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_04_01.models.EffectiveNetworkSecurityGroupListResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_virtual_machine_scale_set_ip_configurations(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_04_01.models.NetworkInterfaceIPConfigurationPaged[~azure.mgmt.network.v2018_04_01.models.NetworkInterfaceIPConfiguration]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-03-30"
        ...
        if raw:
            header_dict = {}
        deserialized = models.NetworkInterfaceIPConfigurationPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
