...
class VirtualNetworkGatewaysOperations:
    ...
    async def create_or_update(
        ...
        :rtype: ~~azure.mgmt.network.v2018_04_01.models.VirtualNetworkGateway
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_04_01.models.VirtualNetworkGateway]
    ...
    async def generatevpnclientpackage(
        ...
        :type parameters:
         ~azure.mgmt.network.v2018_04_01.models.VpnClientParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
    ...
    async def get_bgp_peer_status(
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_04_01.models.BgpPeerStatusListResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_04_01.models.BgpPeerStatusListResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def get_learned_routes(
        ...
        :rtype: ~~azure.mgmt.network.v2018_04_01.models.GatewayRouteListResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_04_01.models.GatewayRouteListResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def set_vpnclient_ipsec_parameters(
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_04_01.models.VpnClientIPsecParameters or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_04_01.models.VpnClientIPsecParameters]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def vpn_device_configuration_script(
        ...
        :param parameters: Parameters supplied to the generate vpn device
         script operation.
        :type parameters:
         ~azure.mgmt.network.v2018_04_01.models.VpnDeviceScriptParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
