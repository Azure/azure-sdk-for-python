...
class VirtualNetworksOperations:
    ...
    async def create_or_update(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of VirtualNetwork or
         ClientRawResponse<VirtualNetwork> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_04_01.models.VirtualNetwork or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_04_01.models.VirtualNetwork]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_all(
        ...
        if raw:
            header_dict = {}
        deserialized = models.VirtualNetworkPaged(
    ...
    def list_usage(
        ...
        if raw:
            header_dict = {}
        deserialized = models.VirtualNetworkUsagePaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
