...
class ExpressRouteCrossConnectionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ExpressRouteCrossConnection <azure.mgmt.network.v2018_04_01.models.ExpressRouteCrossConnection>` object
    """
