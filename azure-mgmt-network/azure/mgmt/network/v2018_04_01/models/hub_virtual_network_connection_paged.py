...
class HubVirtualNetworkConnectionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`HubVirtualNetworkConnection <azure.mgmt.network.v2018_04_01.models.HubVirtualNetworkConnection>` object
    """
