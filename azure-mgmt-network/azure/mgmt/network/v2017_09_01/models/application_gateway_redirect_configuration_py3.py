...
class ApplicationGatewayRedirectConfiguration(SubResource):
    ...
    :type redirect_type: str or
     ~azure.mgmt.network.v2017_09_01.models.ApplicationGatewayRedirectType
    :param target_listener: Reference to a listener to redirect the request
     to.
    :type target_listener: ~azure.mgmt.network.v2017_09_01.models.SubResource
    ...
    :type path_rules: list[~azure.mgmt.network.v2017_09_01.models.SubResource]
