...
class VirtualNetworkGatewaysOperations(object):
    ...
    def create_or_update(
        ...
        :return:
         ...
         <azure.mgmt.network.v2017_09_01.models.VirtualNetworkGateway>` or
    ...
    def list(
        ...
        :rtype: :class:`VirtualNetworkGatewayPaged
         <azure.mgmt.network.v2017_09_01.models.VirtualNetworkGatewayPaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_connections(
        ...
        :return: An iterator like instance of
         ...
         <azure.mgmt.network.v2017_09_01.models.VirtualNetworkGatewayConnectionListEntity>`
        :rtype: :class:`VirtualNetworkGatewayConnectionListEntityPaged
         <azure.mgmt.network.v2017_09_01.models.VirtualNetworkGatewayConnectionListEntityPaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def internal_paging(next_link=None, raw=False):
    ...
    def get_bgp_peer_status(
        ...
        :return:
         ...
         <azure.mgmt.network.v2017_09_01.models.BgpPeerStatusListResult>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype:
         :class:`AzureOperationPoller<msrestazure.azure_operation.AzureOperationPoller>`
    ...
    def get_learned_routes(
        ...
        :return:
         ...
         <azure.mgmt.network.v2017_09_01.models.GatewayRouteListResult>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype:
         :class:`AzureOperationPoller<msrestazure.azure_operation.AzureOperationPoller>`
    ...
    def vpn_device_configuration_script(
        ...
        :param parameters: Parameters supplied to the generate vpn device
         script operation.
        :type parameters: :class:`VpnDeviceScriptParameters
