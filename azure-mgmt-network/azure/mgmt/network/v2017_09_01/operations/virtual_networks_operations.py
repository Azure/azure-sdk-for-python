...
class VirtualNetworksOperations(object):
    ...
    def get(
        ...
        :return: :class:`VirtualNetwork
         <azure.mgmt.network.v2017_09_01.models.VirtualNetwork>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
    ...
    def list_all(
        ...
        :rtype: :class:`VirtualNetworkPaged
         <azure.mgmt.network.v2017_09_01.models.VirtualNetworkPaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def check_ip_address_availability(
        ...
        :return: :class:`IPAddressAvailabilityResult
         <azure.mgmt.network.v2017_09_01.models.IPAddressAvailabilityResult>`
    ...
    def list_usage(
        ...
        :return: An iterator like instance of :class:`VirtualNetworkUsage
         <azure.mgmt.network.v2017_09_01.models.VirtualNetworkUsage>`
        :rtype: :class:`VirtualNetworkUsagePaged
         <azure.mgmt.network.v2017_09_01.models.VirtualNetworkUsagePaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def internal_paging(next_link=None, raw=False):
