...
class VpnSitesOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_10_01.models.VpnSite or
    ...
    async def create_or_update(
        ...
        :type vpn_site_parameters:
         ~azure.mgmt.network.v2018_10_01.models.VpnSite
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of VpnSite or ClientRawResponse<VpnSite> if
         raw==True
        :rtype: ~~azure.mgmt.network.v2018_10_01.models.VpnSite or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_10_01.models.VpnSite]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2018_10_01.models.ErrorException>`
        """
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_10_01.models.VpnSitePaged[~azure.mgmt.network.v2018_10_01.models.VpnSite]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2018_10_01.models.ErrorException>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.VpnSitePaged(
