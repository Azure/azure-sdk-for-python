...
class PublicIPPrefixesOperations:
    ...
    async def create_or_update(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of PublicIPPrefix or
         ClientRawResponse<PublicIPPrefix> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_10_01.models.PublicIPPrefix or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_10_01.models.PublicIPPrefix]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_all(
        ...
        if raw:
            header_dict = {}
        deserialized = models.PublicIPPrefixPaged(
