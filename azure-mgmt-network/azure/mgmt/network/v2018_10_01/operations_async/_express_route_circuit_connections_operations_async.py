...
class ExpressRouteCircuitConnectionsOperations:
    ...
    async def create_or_update(
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_10_01.models.ExpressRouteCircuitConnection
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_10_01.models.ExpressRouteCircuitConnection]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ExpressRouteCircuitConnectionPaged(
