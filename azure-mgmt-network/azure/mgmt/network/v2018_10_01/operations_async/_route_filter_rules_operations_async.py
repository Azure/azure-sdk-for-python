...
class RouteFilterRulesOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_10_01.models.RouteFilterRule or
    ...
    async def create_or_update(
        ...
        :type route_filter_rule_parameters:
         ~azure.mgmt.network.v2018_10_01.models.RouteFilterRule
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
        ...
        :rtype: ~~azure.mgmt.network.v2018_10_01.models.RouteFilterRule or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_10_01.models.RouteFilterRule]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def update(
        ...
        :type route_filter_rule_parameters:
         ~azure.mgmt.network.v2018_10_01.models.PatchRouteFilterRule
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
    ...
    def list_by_route_filter(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_10_01.models.RouteFilterRulePaged[~azure.mgmt.network.v2018_10_01.models.RouteFilterRule]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
