...
class AzureFirewallFqdnTagsOperations:
    ...
    def list_all(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_10_01.models.AzureFirewallFqdnTagPaged[~azure.mgmt.network.v2018_10_01.models.AzureFirewallFqdnTag]
        ...
        if raw:
            header_dict = {}
        deserialized = models.AzureFirewallFqdnTagPaged(
