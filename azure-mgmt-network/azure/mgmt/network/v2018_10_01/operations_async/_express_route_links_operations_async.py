...
class ExpressRouteLinksOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_10_01.models.ExpressRouteLink or
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_10_01.models.ExpressRouteLinkPaged[~azure.mgmt.network.v2018_10_01.models.ExpressRouteLink]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.ExpressRouteLinkPaged(
