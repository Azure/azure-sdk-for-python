...
class LoadBalancerOutboundRulesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_10_01.models.OutboundRulePaged[~azure.mgmt.network.v2018_10_01.models.OutboundRule]
        ...
        if raw:
            header_dict = {}
        deserialized = models.OutboundRulePaged(
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_10_01.models.OutboundRule or
