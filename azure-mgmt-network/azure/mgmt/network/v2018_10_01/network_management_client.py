...
class NetworkManagementClient(SDKClient):
    ...
    :vartype p2s_vpn_server_configurations: azure.mgmt.network.v2018_10_01.operations.P2sVpnServerConfigurationsOperations
    :ivar p2s_vpn_gateways: P2sVpnGateways operations
    :vartype p2s_vpn_gateways: azure.mgmt.network.v2018_10_01.operations.P2sVpnGatewaysOperations
    ...
    def supported_security_providers(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_10_01.models.VirtualWanSecurityProviders or
         ~msrest.pipeline.ClientRawResponse
        :raises:
