...
class VirtualNetworkTapsOperations(object):
    ...
    def _delete_initial(
            self, resource_group_name, tap_name, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def delete(
            self, resource_group_name, tap_name, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_10_01.models.VirtualNetworkTap or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('VirtualNetworkTap', response)
    ...
    def _create_or_update_initial(
            self, resource_group_name, tap_name, parameters, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def create_or_update(
            self, resource_group_name, tap_name, parameters, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :param parameters: Parameters supplied to the create or update virtual
         network tap operation.
        :type parameters:
         ~azure.mgmt.network.v2018_10_01.models.VirtualNetworkTap
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_10_01.models.VirtualNetworkTap]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_10_01.models.VirtualNetworkTap]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def _update_tags_initial(
            self, resource_group_name, tap_name, tags=None, custom_headers=None, raw=False, **operation_config):
        tap_parameters = models.TagsObject(tags=tags)
    ...
    def update_tags(
            self, resource_group_name, tap_name, tags=None, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    def list_all(
        ...
        deserialized = models.VirtualNetworkTapPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.VirtualNetworkTapPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
