...
class ExpressRouteCircuitsOperations(object):
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.network.v2018_10_01.models.ExpressRouteCircuit
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_10_01.models.ExpressRouteCircuit]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_10_01.models.ExpressRouteCircuit]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get_stats(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_10_01.models.ExpressRouteCircuitStats or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
