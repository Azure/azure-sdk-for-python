...
class Subnet(SubResource):
    ...
    :type resource_navigation_links:
     list[~azure.mgmt.network.v2018_10_01.models.ResourceNavigationLink]
    ...
    :type service_association_links:
     list[~azure.mgmt.network.v2018_10_01.models.ServiceAssociationLink]
    :param delegations: Gets an array of references to the delegations on the
     subnet.
    :type delegations: list[~azure.mgmt.network.v2018_10_01.models.Delegation]
