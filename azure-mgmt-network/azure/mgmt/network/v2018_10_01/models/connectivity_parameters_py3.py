...
class ConnectivityParameters(Model):
    ...
    :type source: ~azure.mgmt.network.v2018_10_01.models.ConnectivitySource
    :param destination: Required.
    :type destination:
     ~azure.mgmt.network.v2018_10_01.models.ConnectivityDestination
    :param protocol: Network protocol. Possible values include: 'Tcp', 'Http',
     'Https', 'Icmp'
    :type protocol: str or ~azure.mgmt.network.v2018_10_01.models.Protocol
    :param protocol_configuration:
    :type protocol_configuration:
     ~azure.mgmt.network.v2018_10_01.models.ProtocolConfiguration
    """
