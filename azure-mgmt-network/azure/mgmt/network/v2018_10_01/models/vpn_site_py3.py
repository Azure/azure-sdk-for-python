...
class VpnSite(Resource):
    ...
    :type device_properties:
     ~azure.mgmt.network.v2018_10_01.models.DeviceProperties
    ...
    :param address_space: The AddressSpace that contains an array of IP
     address ranges.
    :type address_space: ~azure.mgmt.network.v2018_10_01.models.AddressSpace
    :param bgp_properties: The set of bgp properties.
    :type bgp_properties: ~azure.mgmt.network.v2018_10_01.models.BgpSettings
