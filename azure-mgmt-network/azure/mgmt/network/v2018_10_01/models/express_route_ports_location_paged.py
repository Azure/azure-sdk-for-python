...
class ExpressRoutePortsLocationPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ExpressRoutePortsLocation <azure.mgmt.network.v2018_10_01.models.ExpressRoutePortsLocation>` object
    """
