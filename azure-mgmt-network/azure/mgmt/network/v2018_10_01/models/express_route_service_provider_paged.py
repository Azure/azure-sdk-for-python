...
class ExpressRouteServiceProviderPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ExpressRouteServiceProvider <azure.mgmt.network.v2018_10_01.models.ExpressRouteServiceProvider>` object
    """
