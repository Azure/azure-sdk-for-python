...
class LoadBalancer(Resource):
    ...
    :type sku: ~azure.mgmt.network.v2018_10_01.models.LoadBalancerSku
    ...
    :type frontend_ip_configurations:
     list[~azure.mgmt.network.v2018_10_01.models.FrontendIPConfiguration]
    :param backend_address_pools: Collection of backend address pools used by
     a load balancer
    :type backend_address_pools:
     list[~azure.mgmt.network.v2018_10_01.models.BackendAddressPool]
    ...
    :type load_balancing_rules:
     list[~azure.mgmt.network.v2018_10_01.models.LoadBalancingRule]
    :param probes: Collection of probe objects used in the load balancer
    :type probes: list[~azure.mgmt.network.v2018_10_01.models.Probe]
    ...
    :type inbound_nat_rules:
     list[~azure.mgmt.network.v2018_10_01.models.InboundNatRule]
    ...
    :type inbound_nat_pools:
     list[~azure.mgmt.network.v2018_10_01.models.InboundNatPool]
    :param outbound_rules: The outbound rules.
    :type outbound_rules:
     list[~azure.mgmt.network.v2018_10_01.models.OutboundRule]
