...
class NetworkInterface(Resource):
    ...
    :type ip_configurations:
     list[~azure.mgmt.network.v2018_10_01.models.NetworkInterfaceIPConfiguration]
    :param tap_configurations: A list of TapConfigurations of the network
     interface.
    :type tap_configurations:
     list[~azure.mgmt.network.v2018_10_01.models.NetworkInterfaceTapConfiguration]
    :param dns_settings: The DNS settings in network interface.
    :type dns_settings:
     ~azure.mgmt.network.v2018_10_01.models.NetworkInterfaceDnsSettings
