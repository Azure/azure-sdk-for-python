...
class ExpressRouteCrossConnectionsOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_02_01.models.ExpressRouteCrossConnectionPaged[~azure.mgmt.network.v2018_02_01.models.ExpressRouteCrossConnection]
        ...
        if raw:
            header_dict = {}
        deserialized = models.ExpressRouteCrossConnectionPaged(
    ...
    async def get(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_02_01.models.ExpressRouteCrossConnection or
    ...
    async def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.network.v2018_02_01.models.ExpressRouteCrossConnection
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of ExpressRouteCrossConnection or
         ClientRawResponse<ExpressRouteCrossConnection> if raw==True
        :rtype:
         ~~azure.mgmt.network.v2018_02_01.models.ExpressRouteCrossConnection or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_02_01.models.ExpressRouteCrossConnection]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def list_arp_table(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of ExpressRouteCircuitsArpTableListResult or
         ClientRawResponse<ExpressRouteCircuitsArpTableListResult> if raw==True
        :rtype:
         ~~azure.mgmt.network.v2018_02_01.models.ExpressRouteCircuitsArpTableListResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_02_01.models.ExpressRouteCircuitsArpTableListResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def list_routes_table_summary(
        ...
        :return: An instance of
         ...
         if raw==True
        :rtype:
         ~~azure.mgmt.network.v2018_02_01.models.ExpressRouteCrossConnectionsRoutesTableSummaryListResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_02_01.models.ExpressRouteCrossConnectionsRoutesTableSummaryListResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def list_routes_table(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of ExpressRouteCircuitsRoutesTableListResult or
         ClientRawResponse<ExpressRouteCircuitsRoutesTableListResult> if
         raw==True
        :rtype:
         ~~azure.mgmt.network.v2018_02_01.models.ExpressRouteCircuitsRoutesTableListResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_02_01.models.ExpressRouteCircuitsRoutesTableListResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
