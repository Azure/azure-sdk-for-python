...
class VirtualNetworkGatewayConnectionsOperations:
    ...
    async def create_or_update(
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_02_01.models.VirtualNetworkGatewayConnection
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_02_01.models.VirtualNetworkGatewayConnection]
    ...
    async def update_tags(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of VirtualNetworkGatewayConnectionListEntity or
         ClientRawResponse<VirtualNetworkGatewayConnectionListEntity> if
         raw==True
        :rtype:
         ~~azure.mgmt.network.v2018_02_01.models.VirtualNetworkGatewayConnectionListEntity
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_02_01.models.VirtualNetworkGatewayConnectionListEntity]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def set_shared_key(
        ...
        :rtype: ~~azure.mgmt.network.v2018_02_01.models.ConnectionSharedKey or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_02_01.models.ConnectionSharedKey]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def reset_shared_key(
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_02_01.models.ConnectionResetSharedKey or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_02_01.models.ConnectionResetSharedKey]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
