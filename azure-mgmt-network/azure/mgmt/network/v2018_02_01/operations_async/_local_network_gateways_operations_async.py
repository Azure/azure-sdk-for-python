...
class LocalNetworkGatewaysOperations:
    ...
    async def create_or_update(
        ...
        :return: An instance of LocalNetworkGateway or
         ClientRawResponse<LocalNetworkGateway> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_02_01.models.LocalNetworkGateway or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_02_01.models.LocalNetworkGateway]
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.LocalNetworkGatewayPaged(
