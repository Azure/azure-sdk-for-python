...
class PacketCaptureResult(Model):
    ...
    :type storage_location:
     ~azure.mgmt.network.v2018_02_01.models.PacketCaptureStorageLocation
    :param filters:
    :type filters:
     list[~azure.mgmt.network.v2018_02_01.models.PacketCaptureFilter]
    ...
    :type provisioning_state: str or
     ~azure.mgmt.network.v2018_02_01.models.ProvisioningState
    """
