...
class ApplicationGateway(Resource):
    ...
    :type sku: ~azure.mgmt.network.v2018_02_01.models.ApplicationGatewaySku
    :param ssl_policy: SSL policy of the application gateway resource.
    :type ssl_policy:
     ~azure.mgmt.network.v2018_02_01.models.ApplicationGatewaySslPolicy
