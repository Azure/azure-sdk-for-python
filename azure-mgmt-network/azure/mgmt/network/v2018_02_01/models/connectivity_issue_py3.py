...
class ConnectivityIssue(Model):
    ...
    :ivar origin: The origin of the issue. Possible values include: 'Local',
     'Inbound', 'Outbound'
    :vartype origin: str or ~azure.mgmt.network.v2018_02_01.models.Origin
    :ivar severity: The severity of the issue. Possible values include:
     'Error', 'Warning'
    :vartype severity: str or ~azure.mgmt.network.v2018_02_01.models.Severity
    ...
    :vartype type: str or ~azure.mgmt.network.v2018_02_01.models.IssueType
