...
class SecurityRule(SubResource):
    ...
    :type protocol: str or
     ~azure.mgmt.network.v2018_02_01.models.SecurityRuleProtocol
    ...
    :type source_application_security_groups:
     list[~azure.mgmt.network.v2018_02_01.models.ApplicationSecurityGroup]
    ...
    :param access: Required. The network traffic is allowed or denied.
     ...
     'Deny'
    :type access: str or
     ~azure.mgmt.network.v2018_02_01.models.SecurityRuleAccess
    ...
    :type direction: str or
     ~azure.mgmt.network.v2018_02_01.models.SecurityRuleDirection
