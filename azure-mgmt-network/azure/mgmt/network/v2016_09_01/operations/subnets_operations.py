...
class SubnetsOperations(object):
    ...
    def get(
        ...
        :return: :class:`Subnet
         <azure.mgmt.network.v2016_09_01.models.Subnet>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype: :class:`Subnet <azure.mgmt.network.v2016_09_01.models.Subnet>`
         or :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list(
        ...
        :rtype: :class:`SubnetPaged
         <azure.mgmt.network.v2016_09_01.models.SubnetPaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
