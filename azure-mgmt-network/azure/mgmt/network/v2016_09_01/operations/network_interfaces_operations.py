...
class NetworkInterfacesOperations(object):
    ...
    def list_all(
        ...
        :rtype: :class:`NetworkInterfacePaged
         <azure.mgmt.network.v20160901.models.NetworkInterfacePaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get_effective_route_table(
        ...
        :rtype:
         ...
         <azure.mgmt.network.v20160901.models.EffectiveRouteListResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_effective_network_security_groups(
        ...
        :rtype:
         ...
         <azure.mgmt.network.v20160901.models.EffectiveNetworkSecurityGroupListResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
