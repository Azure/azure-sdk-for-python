...
class ExpressRouteServiceProvidersOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2016_09_01.models.ExpressRouteServiceProviderPaged[~azure.mgmt.network.v2016_09_01.models.ExpressRouteServiceProvider]
        ...
        if raw:
            header_dict = {}
        deserialized = models.ExpressRouteServiceProviderPaged(
