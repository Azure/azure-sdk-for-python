...
class PacketCapturesOperations:
    ...
    async def create(
        ...
        :rtype: ~~azure.mgmt.network.v2016_09_01.models.PacketCaptureResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2016_09_01.models.PacketCaptureResult]
    ...
    async def get_status(
        ...
        :rtype:
         ...
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2016_09_01.models.PacketCaptureQueryStatusResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
