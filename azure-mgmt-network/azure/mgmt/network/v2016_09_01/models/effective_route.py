...
class EffectiveRoute(Model):
    ...
    :type source: str or :class:`EffectiveRouteSource
     <azure.mgmt.network.v20160901.models.EffectiveRouteSource>`
    ...
    :type state: str or :class:`EffectiveRouteState
     <azure.mgmt.network.v20160901.models.EffectiveRouteState>`
    ...
    :type next_hop_type: str or :class:`RouteNextHopType
     <azure.mgmt.network.v20160901.models.RouteNextHopType>`
    """
