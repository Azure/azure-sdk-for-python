...
class LocalNetworkGateway(Resource):
    ...
    def __init__(self, *, local_network_address_space, id: str=None, location: str=None, tags=None, gateway_ip_address: str=None, bgp_settings=None, resource_guid: str=None, etag: str=None, **kwargs) -> None:
...
class PublicIPAddress(Resource):
    ...
    def __init__(self, *, id: str=None, location: str=None, tags=None, public_ip_allocation_method=None, public_ip_address_version=None, dns_settings=None, ip_address: str=None, idle_timeout_in_minutes: int=None, resource_guid: str=None, provisioning_state: str=None, etag: str=None, **kwargs) -> None:
...
class VirtualNetworkGateway(Resource):
    ...
    :param tags: Resource tags.
    :type tags: dict[str, str]
    :param ip_configurations: Required. IP configurations for virtual network
     gateway.
    :type ip_configurations:
     list[~azure.mgmt.network.v2016_09_01.models.VirtualNetworkGatewayIPConfiguration]
    :param gateway_type: Required. The type of this virtual network gateway.
    ...
    :param vpn_type: Required. The type of this virtual network gateway.
    ...
    def __init__(self, *, ip_configurations, gateway_type, vpn_type, id: str=None, location: str=None, tags=None, enable_bgp: bool=None, active_active: bool=None, gateway_default_site=None, sku=None, vpn_client_configuration=None, bgp_settings=None, resource_guid: str=None, etag: str=None, **kwargs) -> None:
...
class VirtualNetworkGatewayIPConfiguration(SubResource):
    ...
    def __init__(self, *, subnet, public_ip_address, id: str=None, private_ip_allocation_method=None, name: str=None, etag: str=None, **kwargs) -> None:
...
class VpnClientParameters(Model):
    ...
    def __init__(self, *, processor_architecture, **kwargs) -> None:
