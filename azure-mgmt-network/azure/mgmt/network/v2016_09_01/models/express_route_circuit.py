...
class ExpressRouteCircuit(Resource):
    ...
    :type sku: :class:`ExpressRouteCircuitSku
     <azure.mgmt.network.v20160901.models.ExpressRouteCircuitSku>`
    ...
    :type service_provider_provisioning_state: str or
     ...
     <azure.mgmt.network.v20160901.models.ServiceProviderProvisioningState>`
    ...
    :type service_provider_properties:
     ...
     <azure.mgmt.network.v20160901.models.ExpressRouteCircuitServiceProviderProperties>`
