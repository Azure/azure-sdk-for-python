...
class ApplicationSecurityGroupsOperations:
    ...
    async def get(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_08_01.models.ApplicationSecurityGroup or
    ...
    async def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.network.v2018_08_01.models.ApplicationSecurityGroup
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_08_01.models.ApplicationSecurityGroup or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_08_01.models.ApplicationSecurityGroup]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_all(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_08_01.models.ApplicationSecurityGroupPaged[~azure.mgmt.network.v2018_08_01.models.ApplicationSecurityGroup]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
