...
class PublicIPAddressesOperations(object):
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_08_01.models.PublicIPAddress]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_08_01.models.PublicIPAddress]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
