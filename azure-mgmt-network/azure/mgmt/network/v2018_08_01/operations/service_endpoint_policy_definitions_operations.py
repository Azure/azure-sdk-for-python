...
class ServiceEndpointPolicyDefinitionsOperations(object):
    ...
    def delete(
            self, resource_group_name, service_endpoint_policy_name, service_endpoint_policy_definition_name, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    def get(
        ...
        :return: ServiceEndpointPolicyDefinition or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.network.v2018_08_01.models.ServiceEndpointPolicyDefinition
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ServiceEndpointPolicyDefinition', response)
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_08_01.models.ServiceEndpointPolicyDefinition]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_08_01.models.ServiceEndpointPolicyDefinition]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_by_resource_group(
        ...
        deserialized = models.ServiceEndpointPolicyDefinitionPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ServiceEndpointPolicyDefinitionPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
