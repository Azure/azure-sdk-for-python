...
class AvailableResourceGroupDelegationsOperations(object):
    ...
    def list(
        ...
        :return: AvailableDelegationsResult or ClientRawResponse if raw=true
        :rtype:
         ~azure.mgmt.network.v2018_08_01.models.AvailableDelegationsResult or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('AvailableDelegationsResult', response)
