...
class VirtualNetworkGatewayConnectionListEntityPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualNetworkGatewayConnectionListEntity <azure.mgmt.network.v2018_08_01.models.VirtualNetworkGatewayConnectionListEntity>` object
    """
