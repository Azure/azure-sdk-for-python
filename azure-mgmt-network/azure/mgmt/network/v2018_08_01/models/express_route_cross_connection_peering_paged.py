...
class ExpressRouteCrossConnectionPeeringPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ExpressRouteCrossConnectionPeering <azure.mgmt.network.v2018_08_01.models.ExpressRouteCrossConnectionPeering>` object
    """
