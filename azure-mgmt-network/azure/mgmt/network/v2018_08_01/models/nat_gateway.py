...
class NatGateway(Resource):
    ...
    :type sku: ~azure.mgmt.network.v2018_08_01.models.NatGatewaySku
    ...
    _attribute_map = {
        ...
        'public_ip_addresses': {'key': 'properties.publicIpAddresses', 'type': '[PublicIPAddress]'},
        'public_ip_prefixes': {'key': 'properties.publicIpPrefixes', 'type': '[PublicIPPrefix]'},
