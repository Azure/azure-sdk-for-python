...
class ApplicationGatewaySslPredefinedPolicyPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ApplicationGatewaySslPredefinedPolicy <azure.mgmt.network.v2018_08_01.models.ApplicationGatewaySslPredefinedPolicy>` object
    """
