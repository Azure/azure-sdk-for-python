...
class HubVirtualNetworkConnectionsOperations(object):
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_12_01.models.HubVirtualNetworkConnection or
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_12_01.models.HubVirtualNetworkConnectionPaged[~azure.mgmt.network.v2018_12_01.models.HubVirtualNetworkConnection]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2018_12_01.models.ErrorException>`
        """
        ...
        deserialized = models.HubVirtualNetworkConnectionPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.HubVirtualNetworkConnectionPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
