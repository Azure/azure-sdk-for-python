...
class VpnSitesOperations(object):
    ...
    def create_or_update(
        ...
        :type vpn_site_parameters:
         ~azure.mgmt.network.v2018_12_01.models.VpnSite
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_12_01.models.VpnSite]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_12_01.models.VpnSite]]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2018_12_01.models.ErrorException>`
        """
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_12_01.models.VpnSitePaged[~azure.mgmt.network.v2018_12_01.models.VpnSite]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2018_12_01.models.ErrorException>`
        """
        ...
        deserialized = models.VpnSitePaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.VpnSitePaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
