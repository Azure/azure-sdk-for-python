...
class ServiceEndpointPoliciesOperations:
    ...
    async def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.network.v2018_07_01.models.ServiceEndpointPolicy
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of ServiceEndpointPolicy or
         ClientRawResponse<ServiceEndpointPolicy> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_07_01.models.ServiceEndpointPolicy
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_07_01.models.ServiceEndpointPolicy]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ServiceEndpointPolicyPaged(
