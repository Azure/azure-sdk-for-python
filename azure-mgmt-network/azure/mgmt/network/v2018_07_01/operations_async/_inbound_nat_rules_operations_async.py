...
class InboundNatRulesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_07_01.models.InboundNatRulePaged[~azure.mgmt.network.v2018_07_01.models.InboundNatRule]
        ...
        if raw:
            header_dict = {}
        deserialized = models.InboundNatRulePaged(
    ...
    async def create_or_update(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of InboundNatRule or
         ClientRawResponse<InboundNatRule> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_07_01.models.InboundNatRule or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_07_01.models.InboundNatRule]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
