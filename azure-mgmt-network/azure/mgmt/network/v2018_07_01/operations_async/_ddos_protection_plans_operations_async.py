...
class DdosProtectionPlansOperations:
    ...
    async def create_or_update(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of DdosProtectionPlan or
         ClientRawResponse<DdosProtectionPlan> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_07_01.models.DdosProtectionPlan or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_07_01.models.DdosProtectionPlan]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_07_01.models.DdosProtectionPlanPaged[~azure.mgmt.network.v2018_07_01.models.DdosProtectionPlan]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.DdosProtectionPlanPaged(
