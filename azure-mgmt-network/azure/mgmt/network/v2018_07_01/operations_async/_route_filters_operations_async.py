...
class RouteFiltersOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_07_01.models.RouteFilter or
    ...
    async def create_or_update(
        ...
        :type route_filter_parameters:
         ~azure.mgmt.network.v2018_07_01.models.RouteFilter
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of RouteFilter or ClientRawResponse<RouteFilter>
         if raw==True
        :rtype: ~~azure.mgmt.network.v2018_07_01.models.RouteFilter or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_07_01.models.RouteFilter]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def update(
        ...
        :type route_filter_parameters:
         ~azure.mgmt.network.v2018_07_01.models.PatchRouteFilter
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_07_01.models.RouteFilterPaged[~azure.mgmt.network.v2018_07_01.models.RouteFilter]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.RouteFilterPaged(
