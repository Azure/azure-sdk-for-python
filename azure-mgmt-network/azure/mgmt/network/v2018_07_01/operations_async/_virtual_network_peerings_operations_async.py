...
class VirtualNetworkPeeringsOperations:
    ...
    async def create_or_update(
        ...
        :type virtual_network_peering_parameters:
         ~azure.mgmt.network.v2018_07_01.models.VirtualNetworkPeering
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
        ...
        :rtype: ~~azure.mgmt.network.v2018_07_01.models.VirtualNetworkPeering
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_07_01.models.VirtualNetworkPeering]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_07_01.models.VirtualNetworkPeeringPaged[~azure.mgmt.network.v2018_07_01.models.VirtualNetworkPeering]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
