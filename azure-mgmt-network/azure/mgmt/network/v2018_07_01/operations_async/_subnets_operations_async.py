...
class SubnetsOperations:
    ...
    async def create_or_update(
        ...
        :param subnet_parameters: Parameters supplied to the create or update
         subnet operation.
        :type subnet_parameters: ~azure.mgmt.network.v2018_07_01.models.Subnet
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of Subnet or ClientRawResponse<Subnet> if
         raw==True
        :rtype: ~~azure.mgmt.network.v2018_07_01.models.Subnet or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_07_01.models.Subnet]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_07_01.models.SubnetPaged[~azure.mgmt.network.v2018_07_01.models.Subnet]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.SubnetPaged(
