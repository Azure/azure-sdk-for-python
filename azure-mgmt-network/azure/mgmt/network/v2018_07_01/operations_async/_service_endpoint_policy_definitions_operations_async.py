...
class ServiceEndpointPolicyDefinitionsOperations:
    ...
    async def create_or_update(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of ServiceEndpointPolicyDefinition or
         ClientRawResponse<ServiceEndpointPolicyDefinition> if raw==True
        :rtype:
         ~~azure.mgmt.network.v2018_07_01.models.ServiceEndpointPolicyDefinition
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_07_01.models.ServiceEndpointPolicyDefinition]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_07_01.models.ServiceEndpointPolicyDefinitionPaged[~azure.mgmt.network.v2018_07_01.models.ServiceEndpointPolicyDefinition]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.ServiceEndpointPolicyDefinitionPaged(
