...
class NetworkWatchersOperations(object):
    ...
    def query_connection_monitors(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_07_01.models.QueryConnectionMonitorsResponse]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_07_01.models.QueryConnectionMonitorsResponse]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_07_01.models.ErrorResponseException>`
        """
