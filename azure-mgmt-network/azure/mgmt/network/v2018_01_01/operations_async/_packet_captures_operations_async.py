...
class PacketCapturesOperations:
    ...
    async def create(
        ...
        :return: An instance of PacketCaptureResult or
         ClientRawResponse<PacketCaptureResult> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_01_01.models.PacketCaptureResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_01_01.models.PacketCaptureResult]
    ...
    async def get_status(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of PacketCaptureQueryStatusResult or
         ClientRawResponse<PacketCaptureQueryStatusResult> if raw==True
        :rtype:
         ~~azure.mgmt.network.v2018_01_01.models.PacketCaptureQueryStatusResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_01_01.models.PacketCaptureQueryStatusResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.PacketCaptureResultPaged(
