...
class RouteTablesOperations:
    ...
    async def create_or_update(
        ...
        :param parameters: Parameters supplied to the create or update route
         table operation.
        :type parameters: ~azure.mgmt.network.v2018_01_01.models.RouteTable
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of RouteTable or ClientRawResponse<RouteTable> if
         raw==True
        :rtype: ~~azure.mgmt.network.v2018_01_01.models.RouteTable or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_01_01.models.RouteTable]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_01_01.models.RouteTablePaged[~azure.mgmt.network.v2018_01_01.models.RouteTable]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.RouteTablePaged(
