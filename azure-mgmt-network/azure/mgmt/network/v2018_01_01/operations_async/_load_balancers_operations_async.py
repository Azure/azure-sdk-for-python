...
class LoadBalancersOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_01_01.models.LoadBalancer or
    ...
    async def create_or_update(
        ...
        :param parameters: Parameters supplied to the create or update load
         balancer operation.
        :type parameters: ~azure.mgmt.network.v2018_01_01.models.LoadBalancer
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of LoadBalancer or
         ClientRawResponse<LoadBalancer> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_01_01.models.LoadBalancer or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_01_01.models.LoadBalancer]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_all(
        ...
        if raw:
            header_dict = {}
        deserialized = models.LoadBalancerPaged(
