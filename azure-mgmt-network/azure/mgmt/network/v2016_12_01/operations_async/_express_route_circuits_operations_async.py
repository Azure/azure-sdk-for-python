...
class ExpressRouteCircuitsOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2016_12_01.models.ExpressRouteCircuit or
    ...
    async def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.network.v2016_12_01.models.ExpressRouteCircuit
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of ExpressRouteCircuit or
         ClientRawResponse<ExpressRouteCircuit> if raw==True
        :rtype: ~~azure.mgmt.network.v2016_12_01.models.ExpressRouteCircuit or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2016_12_01.models.ExpressRouteCircuit]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def list_arp_table(
        ...
        :rtype:
         ~~azure.mgmt.network.v2016_12_01.models.ExpressRouteCircuitsArpTableListResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2016_12_01.models.ExpressRouteCircuitsArpTableListResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def list_routes_table(
        ...
        :return: An instance of ExpressRouteCircuitsRoutesTableListResult or
         ...
         raw==True
        :rtype:
         ~~azure.mgmt.network.v2016_12_01.models.ExpressRouteCircuitsRoutesTableListResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2016_12_01.models.ExpressRouteCircuitsRoutesTableListResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def list_routes_table_summary(
        ...
        :return: An instance of
         ...
         raw==True
        :rtype:
         ~~azure.mgmt.network.v2016_12_01.models.ExpressRouteCircuitsRoutesTableSummaryListResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2016_12_01.models.ExpressRouteCircuitsRoutesTableSummaryListResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def get_stats(
        ...
        :rtype:
         ~azure.mgmt.network.v2016_12_01.models.ExpressRouteCircuitStats or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ExpressRouteCircuitPaged(
