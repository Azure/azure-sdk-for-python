...
class ApplicationGatewaySslCertificate(SubResource):
    ...
    _attribute_map = {
        ...
        'data': {'key': 'properties.data', 'type': 'str', 'flatten': True},
    ...
    def __init__(self, id=None, name=None, etag=None, data=None, password=None, public_cert_data=None, provisioning_state=None):
