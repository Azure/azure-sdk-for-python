...
class PacketCaptureQueryStatusResult(Model):
    ...
    :type packet_capture_status: str or :class:`PcStatus
     <azure.mgmt.network.models.PcStatus>`
    ...
    :type packet_capture_error: list of :class:`CaptureError
     <azure.mgmt.network.models.CaptureError>`
    """
    ...
    _attribute_map = {
        ...
        'packet_capture_error': {'key': 'packetCaptureError', 'type': '[CaptureError]'},
    }
