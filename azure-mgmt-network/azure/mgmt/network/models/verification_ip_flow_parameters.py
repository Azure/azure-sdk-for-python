...
class VerificationIPFlowParameters(Model):
    ...
    :type direction: str or :class:`Direction
     <azure.mgmt.network.models.Direction>`
    :param protocol: Protocol to be verified on. Possible values include:
     'TCP', 'UDP'
    :type protocol: str or :class:`Protocol
     <azure.mgmt.network.models.Protocol>`
    :param local_port: The local port. Acceptable values are single integer
     (0-65535) or range.
    :type local_port: str
    :param remote_port: The remote port. Acceptable values are single integer
     (0-65535) or range.
