...
class SecurityRulesOperations:
    ...
    async def create_or_update(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of SecurityRule or
         ClientRawResponse<SecurityRule> if raw==True
        :rtype: ~~azure.mgmt.network.v2017_03_01.models.SecurityRule or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_03_01.models.SecurityRule]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SecurityRulePaged(
