...
class VirtualNetworkPeeringsOperations:
    ...
    async def create_or_update(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of VirtualNetworkPeering or
         ClientRawResponse<VirtualNetworkPeering> if raw==True
        :rtype: ~~azure.mgmt.network.v2017_03_01.models.VirtualNetworkPeering
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_03_01.models.VirtualNetworkPeering]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2017_03_01.models.VirtualNetworkPeeringPaged[~azure.mgmt.network.v2017_03_01.models.VirtualNetworkPeering]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.VirtualNetworkPeeringPaged(
