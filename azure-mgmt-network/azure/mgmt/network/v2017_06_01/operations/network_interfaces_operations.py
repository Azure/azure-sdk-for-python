...
class NetworkInterfacesOperations(object):
    ...
    def get(
        ...
        :return: :class:`NetworkInterface
         <azure.mgmt.network.v2017_06_01.models.NetworkInterface>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
    ...
    def get_effective_route_table(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of :class:`EffectiveRoute
         <azure.mgmt.network.v2017_06_01.models.EffectiveRoute>`
        :rtype: :class:`EffectiveRoutePaged
         <azure.mgmt.network.v2017_06_01.models.EffectiveRoutePaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-06-01"
        ...
        # Deserialize response
        deserialized = models.EffectiveRoutePaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.EffectiveRoutePaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
    ...
    def list_effective_network_security_groups(
        ...
        :rtype: :class:`EffectiveNetworkSecurityGroupPaged
         <azure.mgmt.network.v2017_06_01.models.EffectiveNetworkSecurityGroupPaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-06-01"
        ...
        # Deserialize response
        deserialized = models.EffectiveNetworkSecurityGroupPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.EffectiveNetworkSecurityGroupPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
