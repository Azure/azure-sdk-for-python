...
class EffectiveNetworkSecurityGroupPaged(Paged):
    """
    A paging container for iterating over a list of :class:`EffectiveNetworkSecurityGroup <azure.mgmt.network.v2017_06_01.models.EffectiveNetworkSecurityGroup>` object
    """
