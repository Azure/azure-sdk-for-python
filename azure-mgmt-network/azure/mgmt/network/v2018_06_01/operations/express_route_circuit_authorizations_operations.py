...
class ExpressRouteCircuitAuthorizationsOperations(object):
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_06_01.models.ExpressRouteCircuitAuthorization]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_06_01.models.ExpressRouteCircuitAuthorization]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
