...
class VpnGatewaysOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_06_01.models.VpnGateway or
    ...
    async def create_or_update(
        ...
        :type vpn_gateway_parameters:
         ~azure.mgmt.network.v2018_06_01.models.VpnGateway
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of VpnGateway or ClientRawResponse<VpnGateway> if
         raw==True
        :rtype: ~~azure.mgmt.network.v2018_06_01.models.VpnGateway or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_06_01.models.VpnGateway]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2018_06_01.models.ErrorException>`
        """
    ...
    def list_by_resource_group(
        ...
        if raw:
            header_dict = {}
        deserialized = models.VpnGatewayPaged(
