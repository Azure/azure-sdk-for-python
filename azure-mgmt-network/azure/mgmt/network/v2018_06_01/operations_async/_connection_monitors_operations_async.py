...
class ConnectionMonitorsOperations:
    ...
    async def create_or_update(
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_06_01.models.ConnectionMonitorResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_06_01.models.ConnectionMonitorResult]
        :raises:
    ...
    async def query(
        ...
        :rtype:
         ...
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_06_01.models.ConnectionMonitorQueryResult]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_06_01.models.ErrorResponseException>`
        """
