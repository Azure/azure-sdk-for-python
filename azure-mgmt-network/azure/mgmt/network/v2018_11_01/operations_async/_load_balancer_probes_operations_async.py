...
class LoadBalancerProbesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_11_01.models.ProbePaged[~azure.mgmt.network.v2018_11_01.models.Probe]
        ...
        if raw:
            header_dict = {}
        deserialized = models.ProbePaged(
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_11_01.models.Probe or
