...
class ExpressRouteConnectionsOperations:
    ...
    async def create_or_update(
        ...
        :return: An instance of ExpressRouteConnection or
         ClientRawResponse<ExpressRouteConnection> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.ExpressRouteConnection
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.ExpressRouteConnection]
