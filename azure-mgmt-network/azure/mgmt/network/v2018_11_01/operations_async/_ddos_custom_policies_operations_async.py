...
class DdosCustomPoliciesOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_11_01.models.DdosCustomPolicy or
    ...
    async def create_or_update(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of DdosCustomPolicy or
         ClientRawResponse<DdosCustomPolicy> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.DdosCustomPolicy or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.DdosCustomPolicy]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
