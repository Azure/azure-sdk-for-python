...
class ApplicationGatewaysOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_11_01.models.ApplicationGateway or
    ...
    async def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.network.v2018_11_01.models.ApplicationGateway
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
        ...
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.ApplicationGateway or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.ApplicationGateway]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def backend_health(
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_11_01.models.ApplicationGatewayBackendHealth
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.ApplicationGatewayBackendHealth]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def list_available_ssl_options(
        ...
        :return: ApplicationGatewayAvailableSslOptions or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.network.v2018_11_01.models.ApplicationGatewayAvailableSslOptions
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list_available_ssl_predefined_policies(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_11_01.models.ApplicationGatewaySslPredefinedPolicyPaged[~azure.mgmt.network.v2018_11_01.models.ApplicationGatewaySslPredefinedPolicy]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
