...
class NetworkWatchersOperations:
    ...
    async def create_or_update(
        ...
        :param parameters: Parameters that define the network watcher
         resource.
        :type parameters:
         ~azure.mgmt.network.v2018_11_01.models.NetworkWatcher
        ...
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_11_01.models.ErrorResponseException>`
        """
        # Construct URL
    ...
    async def get_topology(
        ...
        :param parameters: Parameters that define the representation of
         topology.
        :type parameters:
         ~azure.mgmt.network.v2018_11_01.models.TopologyParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~azure.mgmt.network.v2018_11_01.models.Topology or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_11_01.models.ErrorResponseException>`
        """
    ...
    async def verify_ip_flow(
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_11_01.models.VerificationIPFlowResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.VerificationIPFlowResult]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_11_01.models.ErrorResponseException>`
        """
    ...
    async def get_next_hop(
        ...
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.NextHopResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.NextHopResult]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_11_01.models.ErrorResponseException>`
        """
    ...
    async def get_vm_security_rules(
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_11_01.models.SecurityGroupViewResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.SecurityGroupViewResult]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_11_01.models.ErrorResponseException>`
        """
    ...
    async def get_troubleshooting(
        ...
        :param parameters: Parameters that define the resource to
         troubleshoot.
        :type parameters:
         ~azure.mgmt.network.v2018_11_01.models.TroubleshootingParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
        ...
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.TroubleshootingResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.TroubleshootingResult]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_11_01.models.ErrorResponseException>`
        """
    ...
    async def set_flow_log_configuration(
        ...
        :param parameters: Parameters that define the configuration of flow
         log.
        :type parameters:
         ~azure.mgmt.network.v2018_11_01.models.FlowLogInformation
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
        ...
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.FlowLogInformation or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.FlowLogInformation]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_11_01.models.ErrorResponseException>`
        """
    ...
    async def check_connectivity(
        ...
        :type parameters:
         ~azure.mgmt.network.v2018_11_01.models.ConnectivityParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_11_01.models.ConnectivityInformation or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.ConnectivityInformation]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_11_01.models.ErrorResponseException>`
        """
    ...
    async def get_azure_reachability_report(
        ...
        :param parameters: Parameters that determine Azure reachability report
         configuration.
        :type parameters:
         ~azure.mgmt.network.v2018_11_01.models.AzureReachabilityReportParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_11_01.models.AzureReachabilityReport or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.AzureReachabilityReport]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_11_01.models.ErrorResponseException>`
        """
    ...
    async def list_available_providers(
        ...
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.AvailableProvidersList
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.AvailableProvidersList]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_11_01.models.ErrorResponseException>`
        """
    ...
    async def get_network_configuration_diagnostic(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of NetworkConfigurationDiagnosticResponse or
         ClientRawResponse<NetworkConfigurationDiagnosticResponse> if raw==True
        :rtype:
         ~~azure.mgmt.network.v2018_11_01.models.NetworkConfigurationDiagnosticResponse
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.NetworkConfigurationDiagnosticResponse]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_11_01.models.ErrorResponseException>`
        """
