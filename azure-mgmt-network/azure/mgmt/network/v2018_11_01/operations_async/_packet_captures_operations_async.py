...
class PacketCapturesOperations:
    ...
    async def create(
        ...
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.PacketCaptureResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.PacketCaptureResult]
        :raises:
    ...
    async def get_status(
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_11_01.models.PacketCaptureQueryStatusResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.PacketCaptureQueryStatusResult]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_11_01.models.ErrorResponseException>`
        """
