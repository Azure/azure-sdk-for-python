...
class VirtualHubsOperations:
    ...
    async def create_or_update(
        ...
        :return: An instance of VirtualHub or ClientRawResponse<VirtualHub> if
         raw==True
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.VirtualHub or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.VirtualHub]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2018_11_01.models.ErrorException>`
        """
    ...
    def list_by_resource_group(
        ...
        if raw:
            header_dict = {}
        deserialized = models.VirtualHubPaged(
