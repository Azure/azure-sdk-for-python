...
class RoutesOperations:
    ...
    async def create_or_update(
        ...
        :param route_parameters: Parameters supplied to the create or update
         route operation.
        :type route_parameters: ~azure.mgmt.network.v2018_11_01.models.Route
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of Route or ClientRawResponse<Route> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.Route or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.Route]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_11_01.models.RoutePaged[~azure.mgmt.network.v2018_11_01.models.Route]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.RoutePaged(
