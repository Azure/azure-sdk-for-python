...
class InterfaceEndpointsOperations:
    ...
    async def create_or_update(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of InterfaceEndpoint or
         ClientRawResponse<InterfaceEndpoint> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.InterfaceEndpoint or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.InterfaceEndpoint]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.InterfaceEndpointPaged(
