...
class VirtualNetworkGatewaysOperations:
    ...
    async def create_or_update(
        ...
        :return: An instance of VirtualNetworkGateway or
         ClientRawResponse<VirtualNetworkGateway> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.VirtualNetworkGateway
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.VirtualNetworkGateway]
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.VirtualNetworkGatewayPaged(
    ...
    def list_connections(
        ...
        if raw:
            header_dict = {}
        deserialized = models.VirtualNetworkGatewayConnectionListEntityPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def generatevpnclientpackage(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of str or ClientRawResponse<str> if raw==True
        :rtype: ~str or ~msrest.pipeline.ClientRawResponse[str]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def get_bgp_peer_status(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of BgpPeerStatusListResult or
         ClientRawResponse<BgpPeerStatusListResult> if raw==True
        :rtype:
         ~~azure.mgmt.network.v2018_11_01.models.BgpPeerStatusListResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.BgpPeerStatusListResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def get_learned_routes(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of GatewayRouteListResult or
         ClientRawResponse<GatewayRouteListResult> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.GatewayRouteListResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.GatewayRouteListResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def set_vpnclient_ipsec_parameters(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of VpnClientIPsecParameters or
         ClientRawResponse<VpnClientIPsecParameters> if raw==True
        :rtype:
         ~~azure.mgmt.network.v2018_11_01.models.VpnClientIPsecParameters or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.VpnClientIPsecParameters]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
