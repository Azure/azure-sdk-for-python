...
class P2sVpnServerConfigurationsOperations:
    ...
    async def create_or_update(
        ...
        :return: An instance of P2SVpnServerConfiguration or
         ClientRawResponse<P2SVpnServerConfiguration> if raw==True
        :rtype:
         ~~azure.mgmt.network.v2018_11_01.models.P2SVpnServerConfiguration or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.P2SVpnServerConfiguration]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2018_11_01.models.ErrorException>`
        """
    ...
    def list_by_virtual_wan(
        ...
        if raw:
            header_dict = {}
        deserialized = models.P2SVpnServerConfigurationPaged(
