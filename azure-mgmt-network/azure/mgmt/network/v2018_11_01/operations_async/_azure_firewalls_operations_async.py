...
class AzureFirewallsOperations:
    ...
    async def create_or_update(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of AzureFirewall or
         ClientRawResponse<AzureFirewall> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.AzureFirewall or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.AzureFirewall]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.AzureFirewallPaged(
