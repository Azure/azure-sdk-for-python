...
class VirtualWansOperations:
    ...
    async def create_or_update(
        ...
        :return: An instance of VirtualWAN or ClientRawResponse<VirtualWAN> if
         raw==True
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.VirtualWAN or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.VirtualWAN]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2018_11_01.models.ErrorException>`
        """
    ...
    def list_by_resource_group(
        ...
        if raw:
            header_dict = {}
        deserialized = models.VirtualWANPaged(
