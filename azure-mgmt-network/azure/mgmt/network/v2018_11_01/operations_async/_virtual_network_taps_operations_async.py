...
class VirtualNetworkTapsOperations:
    ...
    async def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.network.v2018_11_01.models.VirtualNetworkTap
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of VirtualNetworkTap or
         ClientRawResponse<VirtualNetworkTap> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.VirtualNetworkTap or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.VirtualNetworkTap]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_all(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_11_01.models.VirtualNetworkTapPaged[~azure.mgmt.network.v2018_11_01.models.VirtualNetworkTap]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.VirtualNetworkTapPaged(
