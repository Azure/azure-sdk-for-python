...
class P2sVpnGatewaysOperations:
    ...
    async def create_or_update(
        ...
        :return: An instance of P2SVpnGateway or
         ClientRawResponse<P2SVpnGateway> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.P2SVpnGateway or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.P2SVpnGateway]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2018_11_01.models.ErrorException>`
        """
    ...
    def list_by_resource_group(
        ...
        if raw:
            header_dict = {}
        deserialized = models.P2SVpnGatewayPaged(
    ...
    async def generate_vpn_profile(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of VpnProfileResponse or
         ClientRawResponse<VpnProfileResponse> if raw==True
        :rtype: ~~azure.mgmt.network.v2018_11_01.models.VpnProfileResponse or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.VpnProfileResponse]
