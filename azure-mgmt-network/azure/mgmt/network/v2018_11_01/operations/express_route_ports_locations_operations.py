...
class ExpressRoutePortsLocationsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_11_01.models.ExpressRoutePortsLocationPaged[~azure.mgmt.network.v2018_11_01.models.ExpressRoutePortsLocation]
        ...
        deserialized = models.ExpressRoutePortsLocationPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ExpressRoutePortsLocationPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        """Retrieves a single ExpressRoutePort peering location, including the
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ExpressRoutePortsLocation', response)
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Network/ExpressRoutePortsLocations/{locationName}'}
