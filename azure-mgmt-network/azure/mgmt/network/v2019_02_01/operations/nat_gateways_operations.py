...
class NatGatewaysOperations(object):
    ...
    def list_all(
        ...
        deserialized = models.NatGatewayPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.NatGatewayPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
