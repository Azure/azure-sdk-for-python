...
class VirtualNetworksOperations(object):
    ...
    def create_or_update(
        ...
        :param parameters: Parameters supplied to the create or update virtual
         network operation
        :type parameters:
         ~azure.mgmt.network.v2019_02_01.models.VirtualNetwork
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2019_02_01.models.VirtualNetwork]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2019_02_01.models.VirtualNetwork]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def check_ip_address_availability(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_02_01.models.IPAddressAvailabilityResult or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list_usage(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_02_01.models.VirtualNetworkUsagePaged[~azure.mgmt.network.v2019_02_01.models.VirtualNetworkUsage]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def internal_paging(next_link=None, raw=False):
