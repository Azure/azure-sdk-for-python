...
class ServiceEndpointPolicyDefinitionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ServiceEndpointPolicyDefinition <azure.mgmt.network.v2019_02_01.models.ServiceEndpointPolicyDefinition>` object
    """
