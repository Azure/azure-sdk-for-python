...
class ExpressRouteCircuitConnectionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ExpressRouteCircuitConnection <azure.mgmt.network.v2019_02_01.models.ExpressRouteCircuitConnection>` object
    """
