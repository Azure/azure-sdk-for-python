...
class ApplicationGatewaysOperations:
    ...
    async def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.network.v2017_08_01.models.ApplicationGateway
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
        ...
        :rtype: ~~azure.mgmt.network.v2017_08_01.models.ApplicationGateway or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_08_01.models.ApplicationGateway]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2017_08_01.models.ApplicationGatewayPaged[~azure.mgmt.network.v2017_08_01.models.ApplicationGateway]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def backend_health(
        ...
        :rtype:
         ~~azure.mgmt.network.v2017_08_01.models.ApplicationGatewayBackendHealth
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_08_01.models.ApplicationGatewayBackendHealth]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_available_ssl_predefined_policies(
        ...
        :rtype:
         ~azure.mgmt.network.v2017_08_01.models.ApplicationGatewaySslPredefinedPolicyPaged[~azure.mgmt.network.v2017_08_01.models.ApplicationGatewaySslPredefinedPolicy]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
        ...
        if raw:
            header_dict = {}
        deserialized = models.ApplicationGatewaySslPredefinedPolicyPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def get_ssl_predefined_policy(
        ...
        :return: ApplicationGatewaySslPredefinedPolicy or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.network.v2017_08_01.models.ApplicationGatewaySslPredefinedPolicy
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
