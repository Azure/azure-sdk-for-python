...
class VirtualNetworkGatewayConnectionsOperations(object):
    ...
    def set_shared_key(
        ...
        :return:
         ...
         <azure.mgmt.network.v2017_06_01.models.ConnectionSharedKey>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype:
         :class:`AzureOperationPoller<msrestazure.azure_operation.AzureOperationPoller>`
    ...
    def list(
        ...
        :rtype: :class:`VirtualNetworkGatewayConnectionPaged
         <azure.mgmt.network.v2017_06_01.models.VirtualNetworkGatewayConnectionPaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def reset_shared_key(
        ...
        :return:
         ...
         <azure.mgmt.network.v2017_06_01.models.ConnectionResetSharedKey>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype:
         :class:`AzureOperationPoller<msrestazure.azure_operation.AzureOperationPoller>`
