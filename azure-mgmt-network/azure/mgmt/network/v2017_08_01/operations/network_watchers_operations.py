...
class NetworkWatchersOperations(object):
    ...
    def create_or_update(
        ...
        :return: :class:`NetworkWatcher
         <azure.mgmt.network.v2017_06_01.models.NetworkWatcher>` or
    ...
    def get_topology(
        ...
        :return: :class:`Topology
         <azure.mgmt.network.v2017_06_01.models.Topology>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
    ...
    def get_next_hop(
        ...
        :return:
         ...
         <azure.mgmt.network.v2017_06_01.models.NextHopResult>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype:
         :class:`AzureOperationPoller<msrestazure.azure_operation.AzureOperationPoller>`
    ...
    def get_troubleshooting(
        ...
        :return:
         ...
         <azure.mgmt.network.v2017_06_01.models.TroubleshootingResult>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype:
         :class:`AzureOperationPoller<msrestazure.azure_operation.AzureOperationPoller>`
    ...
    def set_flow_log_configuration(
        ...
        :return:
         ...
         <azure.mgmt.network.v2017_06_01.models.FlowLogInformation>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype:
         :class:`AzureOperationPoller<msrestazure.azure_operation.AzureOperationPoller>`
