...
class NetworkWatchersOperations(object):
    ...
    def create_or_update(
        ...
        :type parameters: :class:`NetworkWatcher
         <azure.mgmt.network.models.NetworkWatcher>`
    ...
    def list(
        ...
        :rtype: :class:`NetworkWatcherPaged
         <azure.mgmt.network.models.NetworkWatcherPaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get_topology(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :rtype: :class:`Topology <azure.mgmt.network.models.Topology>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def verify_ip_flow(
        ...
        :type parameters: :class:`VerificationIPFlowParameters
         <azure.mgmt.network.models.VerificationIPFlowParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
         ...
         <azure.mgmt.network.models.VerificationIPFlowResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get_next_hop(
        ...
        :type parameters: :class:`NextHopParameters
         <azure.mgmt.network.models.NextHopParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
         ...
         <azure.mgmt.network.models.NextHopResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get_vm_security_rules(
        ...
        :rtype:
         ...
         <azure.mgmt.network.models.SecurityGroupViewResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get_troubleshooting(
        ...
        :type parameters: :class:`TroubleshootingParameters
         <azure.mgmt.network.models.TroubleshootingParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
         ...
         <azure.mgmt.network.models.TroubleshootingResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def set_flow_log_configuration(
        ...
        :type parameters: :class:`FlowLogInformation
         <azure.mgmt.network.models.FlowLogInformation>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
    ...
    def get_flow_log_status(
        ...
        :param network_watcher_name: The name of the network watcher resource.
        :type network_watcher_name: str
        :param target_resource_id: The target resource to capture flow log.
        :type target_resource_id: str
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
