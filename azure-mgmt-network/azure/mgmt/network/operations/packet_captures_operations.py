...
class PacketCapturesOperations(object):
    ...
    def create(
        ...
        :type parameters: :class:`PacketCapture
         <azure.mgmt.network.models.PacketCapture>`
        ...
        :rtype:
         ...
         <azure.mgmt.network.models.PacketCaptureResult>`
    ...
    def get_status(
        ...
        :rtype:
         ...
         <azure.mgmt.network.models.PacketCaptureQueryStatusResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype: :class:`PacketCaptureResultPaged
         <azure.mgmt.network.models.PacketCaptureResultPaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
