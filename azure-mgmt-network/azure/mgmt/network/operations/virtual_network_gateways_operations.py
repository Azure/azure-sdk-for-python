...
class VirtualNetworkGatewaysOperations(object):
    ...
    def generatevpnclientpackage(
        ...
        :param virtual_network_gateway_name: The name of the virtual network
         gateway.
        :type virtual_network_gateway_name: str
        :param parameters: Parameters supplied to the Begin Generating
         Virtual Network Gateway Vpn client package operation through
         Network resource provider.
        :type parameters: :class:`VpnClientParameters
         <networkmanagementclient.models.VpnClientParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
