...
class VirtualNetworkGatewayConnectionsOperations(object):
    ...
    def reset_shared_key(
        ...
        :param parameters: Parameters supplied to the Begin Reset Virtual
         ...
         resource provider.
        :type parameters: :class:`ConnectionResetSharedKey
    ...
    def set_shared_key(
        ...
        :type virtual_network_gateway_connection_name: str
        :param parameters: Parameters supplied to the Begin Set Virtual
         Network Gateway conection Shared key operation throughNetwork
         resource provider.
        :type parameters: :class:`ConnectionSharedKey
