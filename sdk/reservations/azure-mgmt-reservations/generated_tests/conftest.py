...
def add_sanitizers(test_proxy):
    ...
    add_general_regex_sanitizer(regex=reservationsmgmt_subscription_id, value="00000000-0000-0000-0000-000000000000")
    ...
    add_general_regex_sanitizer(regex=reservationsmgmt_client_secret, value="00000000-0000-0000-0000-000000000000")
