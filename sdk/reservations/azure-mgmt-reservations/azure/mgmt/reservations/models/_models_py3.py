...
class CurrentQuotaLimit(Model):
    ...
    def __init__(self, *, quota_information=None, provisioning_state=None, **kwargs) -> None:
        super(CurrentQuotaLimit, self).__init__(**kwargs)
        self.quota_information = quota_information
...
class QuotaRequestOneResourceSubmitResponse(Model):
    ...
    def __init__(self, *, limit: int=None, current_value: int=None, name1=None, resource_type=None, unit: str=None, quota_period: str=None, properties=None, **kwargs) -> None:
