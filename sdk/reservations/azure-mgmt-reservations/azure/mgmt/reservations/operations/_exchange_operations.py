...
class ExchangeOperations:
    ...
    def _post_initial(
        self, body: Union[_models.ExchangeRequest, IO], **kwargs: Any
    ...
    _post_initial.metadata = {"url": "/providers/Microsoft.Capacity/exchange"}
    ...
    def begin_post(
        ...
        :param body: Request containing the refunds and purchases that need to be executed. Required.
    ...
    begin_post.metadata = {"url": "/providers/Microsoft.Capacity/exchange"}
