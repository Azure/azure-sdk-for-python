...
class ExchangeOperations(object):
    ...
    def _post_initial(
        ...
        body = models.ExchangeRequest(properties=properties)
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ExchangeOperationResultResponse', response)
            header_dict = {
    ...
    def post(
        ...
        :return: An instance of LROPoller that returns
         ExchangeOperationResultResponse or
         ClientRawResponse<ExchangeOperationResultResponse> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.reservations.models.ExchangeOperationResultResponse]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.reservations.models.ExchangeOperationResultResponse]]
        :raises:
    ...
    post.metadata = {'url': '/providers/Microsoft.Capacity/exchange'}
