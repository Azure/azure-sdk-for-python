...
class ExchangeOperations(object):
    ...
    def _post_initial(
        self,
        body,  # type: "_models.ExchangeRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.ExchangeOperationResultResponse"]
    ...
    def begin_post(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.ExchangeOperationResultResponse"]
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.reservations.models.ExchangeOperationResultResponse]
