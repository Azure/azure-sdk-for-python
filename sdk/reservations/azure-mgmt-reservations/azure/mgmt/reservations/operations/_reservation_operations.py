...
class ReservationOperations:
    ...
    def begin_available_scopes(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._available_scopes_initial(  # type: ignore
                reservation_order_id=reservation_order_id,
                reservation_id=reservation_id,
                body=body,
                api_version=api_version,
    ...
    def begin_split(
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._split_initial(  # type: ignore
                reservation_order_id=reservation_order_id,
                body=body,
                api_version=api_version,
                content_type=content_type,
    ...
    def begin_merge(
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._merge_initial(  # type: ignore
                reservation_order_id=reservation_order_id,
                body=body,
                api_version=api_version,
                content_type=content_type,
    ...
    archive.metadata = {"url": "/providers/Microsoft.Capacity/reservationOrders/{reservationOrderId}/reservations/{reservationId}/archive"}  # type: ignore
    ...
    unarchive.metadata = {"url": "/providers/Microsoft.Capacity/reservationOrders/{reservationOrderId}/reservations/{reservationId}/unarchive"}  # type: ignore
