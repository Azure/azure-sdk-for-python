...
class CalculateExchangeOperations(object):
    ...
    def _post_initial(
        self,
        body,  # type: "_models.CalculateExchangeRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.CalculateExchangeOperationResultResponse"]
    ...
    def begin_post(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.CalculateExchangeOperationResultResponse"]
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.reservations.models.CalculateExchangeOperationResultResponse]
