...
class ReservationOperations:
    ...
    async def begin_available_scopes(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._available_scopes_initial(  # type: ignore
                reservation_order_id=reservation_order_id,
                reservation_id=reservation_id,
                body=body,
                api_version=api_version,
    ...
    async def begin_split(
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._split_initial(  # type: ignore
                reservation_order_id=reservation_order_id,
                body=body,
                api_version=api_version,
                content_type=content_type,
    ...
    async def begin_merge(
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._merge_initial(  # type: ignore
                reservation_order_id=reservation_order_id,
                body=body,
                api_version=api_version,
                content_type=content_type,
