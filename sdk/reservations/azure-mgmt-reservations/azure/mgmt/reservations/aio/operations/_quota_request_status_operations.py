...
class QuotaRequestStatusOperations:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.Capacity/resourceProviders/{providerId}/locations/{location}/serviceLimitsRequests/{id}"
    }
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :param skiptoken: Skiptoken is only used if a previous operation returned a partial result. If
         ...
         skiptoken parameter that specifies a starting point to use for subsequent calls. Default value
         is None.
        :type skiptoken: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        api_version: Literal["2020-10-25"] = kwargs.pop("api_version", _params.pop("api-version", "2020-10-25"))
        cls: ClsType[_models.QuotaRequestDetailsList] = kwargs.pop("cls", None)
