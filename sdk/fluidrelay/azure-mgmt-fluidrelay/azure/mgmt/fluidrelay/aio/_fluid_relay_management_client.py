...
class FluidRelayManagementClient(object):
    ...
    :vartype fluid_relay_operations: fluid_relay_management_client.aio.operations.FluidRelayOperationsOperations
    :ivar fluid_relay_servers: FluidRelayServersOperations operations
    :vartype fluid_relay_servers: fluid_relay_management_client.aio.operations.FluidRelayServersOperations
