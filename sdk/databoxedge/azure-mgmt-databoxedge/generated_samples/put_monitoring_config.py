...
def main():
    ...
    response = client.monitoring_config.begin_create_or_update(
...
# x-ms-original-file: specification/databoxedge/resource-manager/Microsoft.DataBoxEdge/DataBoxEdge/stable/2023-12-01/examples/PutMonitoringConfig.json
