...
def main():
    ...
    response = client.storage_accounts.begin_create_or_update(
...
# x-ms-original-file: specification/databoxedge/resource-manager/Microsoft.DataBoxEdge/preview/2021-02-01-preview/examples/StorageAccountPut.json
