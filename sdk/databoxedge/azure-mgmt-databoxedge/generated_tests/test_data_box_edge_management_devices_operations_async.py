...
class TestDataBoxEdgeManagementDevicesOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_devices_get_network_settings(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_devices_create_or_update(self, resource_group):
        response = await self.client.devices.create_or_update(
            resource_group_name=resource_group.name,
            device_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_devices_update(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_devices_begin_download_updates(self, resource_group):
        response = await (
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_devices_get_extended_information(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_devices_begin_install_updates(self, resource_group):
        response = await (
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_devices_begin_scan_for_updates(self, resource_group):
        response = await (
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_devices_begin_create_or_update_security_settings(self, resource_group):
        response = await (
            await self.client.devices.begin_create_or_update_security_settings(
                device_name="str",
                resource_group_name=resource_group.name,
                security_settings={
                    "properties": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_devices_upload_certificate(self, resource_group):
        response = await self.client.devices.upload_certificate(
            device_name="str",
            resource_group_name=resource_group.name,
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_devices_get_update_summary(self, resource_group):
