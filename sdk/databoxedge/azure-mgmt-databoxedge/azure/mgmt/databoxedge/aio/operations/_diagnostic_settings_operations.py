...
class DiagnosticSettingsOperations:
    ...
    async def get_diagnostic_proactive_log_collection_settings(  # pylint: disable=name-too-long
        ...
        deserialized = self._deserialize("DiagnosticProactiveLogCollectionSettings", pipeline_response.http_response)
    ...
    async def begin_update_diagnostic_proactive_log_collection_settings(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either
         DiagnosticProactiveLogCollectionSettings or the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.models.DiagnosticProactiveLogCollectionSettings]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update_diagnostic_proactive_log_collection_settings(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :type proactive_log_collection_settings:
         ~azure.mgmt.databoxedge.models.DiagnosticProactiveLogCollectionSettings or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either
         DiagnosticProactiveLogCollectionSettings or the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.models.DiagnosticProactiveLogCollectionSettings]
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize(
                "DiagnosticProactiveLogCollectionSettings", pipeline_response.http_response
            )
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if cont_token:
            return AsyncLROPoller[_models.DiagnosticProactiveLogCollectionSettings].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.DiagnosticProactiveLogCollectionSettings](
    ...
    async def get_diagnostic_remote_support_settings(
        ...
        deserialized = self._deserialize("DiagnosticRemoteSupportSettings", pipeline_response.http_response)
    ...
    async def begin_update_diagnostic_remote_support_settings(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either DiagnosticRemoteSupportSettings or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.models.DiagnosticRemoteSupportSettings]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update_diagnostic_remote_support_settings(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :type diagnostic_remote_support_settings:
         ~azure.mgmt.databoxedge.models.DiagnosticRemoteSupportSettings or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either DiagnosticRemoteSupportSettings or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.models.DiagnosticRemoteSupportSettings]
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.DiagnosticRemoteSupportSettings].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.DiagnosticRemoteSupportSettings](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
