...
class MonitoringConfigOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("MonitoringMetricConfiguration", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        monitoring_metric_configuration: Union[_models.MonitoringMetricConfiguration, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.models.MonitoringMetricConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type monitoring_metric_configuration:
         ~azure.mgmt.databoxedge.models.MonitoringMetricConfiguration or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either MonitoringMetricConfiguration or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.models.MonitoringMetricConfiguration]
        ...
        if cont_token:
            return AsyncLROPoller[_models.MonitoringMetricConfiguration].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.MonitoringMetricConfiguration](
