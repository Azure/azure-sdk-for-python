...
from ...operations._storage_account_credentials_operations import (
...
class StorageAccountCredentialsOperations:
    ...
    def list_by_data_box_edge_device(
    ...
    ) -> AsyncIterable["_models.StorageAccountCredential"]:
        ...
        :return: An iterator like instance of either StorageAccountCredential or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databoxedge.v2019_08_01.models.StorageAccountCredential]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_data_box_edge_device_request(
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.databoxedge.v2019_08_01.models.StorageAccountCredential
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("StorageAccountCredential", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        storage_account_credential: Union[_models.StorageAccountCredential, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type storage_account_credential:
         ~azure.mgmt.databoxedge.v2019_08_01.models.StorageAccountCredential
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either StorageAccountCredential or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2019_08_01.models.StorageAccountCredential]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type storage_account_credential:
         ~azure.mgmt.databoxedge.v2019_08_01.models.StorageAccountCredential or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either StorageAccountCredential or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2019_08_01.models.StorageAccountCredential]
        ...
        if cont_token:
            return AsyncLROPoller[_models.StorageAccountCredential].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.StorageAccountCredential](
