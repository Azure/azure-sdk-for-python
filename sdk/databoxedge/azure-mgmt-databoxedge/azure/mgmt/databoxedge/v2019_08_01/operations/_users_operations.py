...
class UsersOperations(object):
    ...
    def list_by_data_box_edge_device(
        ...
        :rtype:
         ~azure.mgmt.databoxedge.models.UserPaged[~azure.mgmt.databoxedge.models.User]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.databoxedge.models.User or
    ...
    def _create_or_update_initial(
            self, device_name, name, user, resource_group_name, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.databoxedge.models.User]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.databoxedge.models.User]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
