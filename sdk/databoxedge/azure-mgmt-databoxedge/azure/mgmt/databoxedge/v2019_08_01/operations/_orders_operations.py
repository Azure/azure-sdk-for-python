...
class OrdersOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.databoxedge.v2019_08_01.models.Order]
    ...
    def get(self, device_name: str, resource_group_name: str, **kwargs: Any) -> _models.Order:
        ...
        deserialized = self._deserialize("Order", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        self, device_name: str, resource_group_name: str, order: Union[_models.Order, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_create_or_update(
        ...
        :param order: The order to be created or updated. Is either a Order type or a IO[bytes] type.
         Required.
        :type order: ~azure.mgmt.databoxedge.v2019_08_01.models.Order or IO[bytes]
        :return: An instance of LROPoller that returns either Order or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.databoxedge.v2019_08_01.models.Order]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
