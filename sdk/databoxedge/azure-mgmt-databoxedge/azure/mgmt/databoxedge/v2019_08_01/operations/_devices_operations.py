...
class DevicesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type data_box_edge_device: ~azure.mgmt.databoxedge.v2019_08_01.models.DataBoxEdgeDevice or
         IO[bytes]
        :return: An instance of LROPoller that returns either DataBoxEdgeDevice or the result of
         cls(response)
        :rtype:
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param parameters: The resource parameters. Is either a DataBoxEdgeDevicePatch type or a
         IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.databoxedge.v2019_08_01.models.DataBoxEdgeDevicePatch or
         IO[bytes]
        :return: DataBoxEdgeDevice or the result of cls(response)
        :rtype: ~azure.mgmt.databoxedge.v2019_08_01.models.DataBoxEdgeDevice
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_create_or_update_security_settings(
        ...
        **kwargs: Any
        ...
        :param security_settings: The security settings. Is either a SecuritySettings type or a
         IO[bytes] type. Required.
        :type security_settings: ~azure.mgmt.databoxedge.v2019_08_01.models.SecuritySettings or
         IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def upload_certificate(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.databoxedge.v2019_08_01.models.UploadCertificateRequest or
         IO[bytes]
        :return: UploadCertificateResponse or the result of cls(response)
        :rtype: ~azure.mgmt.databoxedge.v2019_08_01.models.UploadCertificateResponse
        :raises ~azure.core.exceptions.HttpResponseError:
