...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.DataBoxEdge/skus')
...
class SkusOperations(object):
    ...
    def list(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.SkuInformationList"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.databoxedge.v2019_08_01.models.SkuInformationList]
