...
class StorageAccountCredentialsOperations(object):
    ...
    def list_by_data_box_edge_device(
        ...
        :rtype:
         ~azure.mgmt.databoxedge.models.StorageAccountCredentialPaged[~azure.mgmt.databoxedge.models.StorageAccountCredential]
        ...
        if raw:
            header_dict = {}
        deserialized = models.StorageAccountCredentialPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: StorageAccountCredential or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.databoxedge.models.StorageAccountCredential or
    ...
    def create_or_update(
        ...
        :type storage_account_credential:
         ~azure.mgmt.databoxedge.models.StorageAccountCredential
        :param resource_group_name: The resource group name.
        :type resource_group_name: str
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.databoxedge.models.StorageAccountCredential]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.databoxedge.models.StorageAccountCredential]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
