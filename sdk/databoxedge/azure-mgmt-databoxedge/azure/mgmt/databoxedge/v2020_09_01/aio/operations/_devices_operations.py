...
class DevicesOperations:
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DataBoxEdgeDeviceList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databoxedge.v2020_09_01.models.DataBoxEdgeDeviceList]
    ...
    async def _create_or_update_security_settings_initial(
        self,
        device_name: str,
        resource_group_name: str,
