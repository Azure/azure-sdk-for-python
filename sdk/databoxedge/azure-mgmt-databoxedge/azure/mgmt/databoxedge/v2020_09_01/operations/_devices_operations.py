...
class DevicesOperations(object):
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.databoxedge.v2020_09_01.models.DataBoxEdgeDeviceList]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.databoxedge.v2020_09_01.models.DataBoxEdgeDevice]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def generate_certificate(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.GenerateCertResponse"
        ...
        # Construct URL
        url = self.generate_certificate.metadata['url']  # type: ignore
        path_format_arguments = {
            'deviceName': self._serialize.url("device_name", device_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
    ...
    def update_extended_information(
        ...
        device_name,  # type: str
        resource_group_name,  # type: str
        parameters,  # type: "_models.DataBoxEdgeDeviceExtendedInfoPatch"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.DataBoxEdgeDeviceExtendedInfo"
        ...
        # Construct URL
        url = self.update_extended_information.metadata['url']  # type: ignore
        path_format_arguments = {
            'deviceName': self._serialize.url("device_name", device_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'DataBoxEdgeDeviceExtendedInfoPatch')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
