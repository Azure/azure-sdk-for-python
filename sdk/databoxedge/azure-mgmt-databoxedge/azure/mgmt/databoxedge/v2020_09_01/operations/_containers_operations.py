...
def build_list_by_storage_account_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts/{storageAccountName}/containers')
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts/{storageAccountName}/containers/{containerName}')
    path_format_arguments = {
        "deviceName": _SERIALIZER.url("device_name", device_name, 'str'),
        "storageAccountName": _SERIALIZER.url("storage_account_name", storage_account_name, 'str'),
...
def build_refresh_request_initial(
    device_name: str,
    storage_account_name: str,
    container_name: str,
    subscription_id: str,
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts/{storageAccountName}/containers/{containerName}/refresh')
    path_format_arguments = {
        "deviceName": _SERIALIZER.url("device_name", device_name, 'str'),
        "storageAccountName": _SERIALIZER.url("storage_account_name", storage_account_name, 'str'),
        "containerName": _SERIALIZER.url("container_name", container_name, 'str'),
...
class ContainersOperations(object):
    ...
    def list_by_storage_account(
        ...
        resource_group_name: str,
        **kwargs: Any
    ) -> Iterable["_models.ContainerList"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.databoxedge.v2020_09_01.models.ContainerList]
