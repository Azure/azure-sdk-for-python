...
def build_list_by_data_box_edge_device_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts')
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts/{storageAccountName}')
    path_format_arguments = {
        "deviceName": _SERIALIZER.url("device_name", device_name, 'str'),
...
class StorageAccountsOperations(object):
    ...
    def list_by_data_box_edge_device(
        ...
        resource_group_name: str,
        **kwargs: Any
    ) -> Iterable["_models.StorageAccountList"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.databoxedge.v2020_09_01.models.StorageAccountList]
