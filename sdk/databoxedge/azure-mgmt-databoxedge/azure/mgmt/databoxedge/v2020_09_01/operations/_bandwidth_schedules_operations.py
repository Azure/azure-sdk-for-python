    ...
    def list_by_data_box_edge_device(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either BandwidthSchedulesList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.databoxedge.v2020_09_01.models.BandwidthSchedulesList]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either BandwidthSchedule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.databoxedge.v2020_09_01.models.BandwidthSchedule]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
