...
class IoTRole(Role):
    ...
    def __init__(self, *, host_platform, io_tdevice_details, io_tedge_device_details, role_status, share_mappings=None, io_tedge_agent_info=None, **kwargs) -> None:
...
class StorageAccount(ARMBaseModel):
    ...
    def __init__(self, *, description: str=None, storage_account_status=None, data_policy=None, storage_account_credential_id: str=None, **kwargs) -> None:
...
class User(ARMBaseModel):
    ...
    def __init__(self, *, user_type, encrypted_password=None, **kwargs) -> None:
