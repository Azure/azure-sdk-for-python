...
class DevicesOperations(object):
    ...
    def list_by_subscription(
        ...
        :rtype:
         ~azure.mgmt.databoxedge.models.DataBoxEdgeDevicePaged[~azure.mgmt.databoxedge.models.DataBoxEdgeDevice]
        ...
        if raw:
            header_dict = {}
        deserialized = models.DataBoxEdgeDevicePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.databoxedge.models.DataBoxEdgeDevice or
    ...
    def create_or_update(
        ...
        :type data_box_edge_device:
         ~azure.mgmt.databoxedge.models.DataBoxEdgeDevice
        :param resource_group_name: The resource group name.
        :type resource_group_name: str
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.databoxedge.models.DataBoxEdgeDevice]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.databoxedge.models.DataBoxEdgeDevice]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def update(
        ...
        :type parameters:
         ~azure.mgmt.databoxedge.models.DataBoxEdgeDevicePatch
        :param resource_group_name: The resource group name.
        :type resource_group_name: str
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
    ...
    def get_network_settings(
        ...
        :rtype: ~azure.mgmt.databoxedge.models.NetworkSettings or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def _create_or_update_security_settings_initial(
            self, device_name, security_settings, resource_group_name, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def create_or_update_security_settings(
        ...
        :type security_settings:
         ~azure.mgmt.databoxedge.models.SecuritySettings
        :param resource_group_name: The resource group name.
        :type resource_group_name: str
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
    ...
    def get_update_summary(
        ...
        :rtype: ~azure.mgmt.databoxedge.models.UpdateSummary or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def upload_certificate(
        ...
        :type parameters:
         ~azure.mgmt.databoxedge.models.UploadCertificateRequest
        :param resource_group_name: The resource group name.
        :type resource_group_name: str
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
        ...
        :rtype: ~azure.mgmt.databoxedge.models.UploadCertificateResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
