...
from ...operations._orders_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_data_box_edge_device_request
T = TypeVar('T')
...
class OrdersOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databoxedge.v2019_03_01.models.OrderList]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2019_03_01.models.Order]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
