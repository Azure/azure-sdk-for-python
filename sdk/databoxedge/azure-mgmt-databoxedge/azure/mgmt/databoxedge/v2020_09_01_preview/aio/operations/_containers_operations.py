...
from ...operations._containers_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_storage_account_request, build_refresh_request_initial
T = TypeVar('T')
...
class ContainersOperations:
    ...
    def list_by_storage_account(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databoxedge.v2020_09_01_preview.models.ContainerList]
