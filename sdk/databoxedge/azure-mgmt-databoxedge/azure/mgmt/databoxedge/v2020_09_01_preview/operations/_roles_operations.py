...
class RolesOperations(object):
    ...
    :ivar api_version: The API version. Constant value: "2020-09-01".
    """
    ...
    def list_by_data_box_edge_device(
        ...
        :rtype:
         ~azure.mgmt.databoxedge.models.RolePaged[~azure.mgmt.databoxedge.models.Role]
        ...
        if raw:
            header_dict = {}
        deserialized = models.RolePaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list_by_data_box_edge_device.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/roles'}
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.databoxedge.models.Role or
    ...
    def _create_or_update_initial(
            self, device_name, name, role, resource_group_name, custom_headers=None, raw=False, **operation_config):
        # Construct URL
