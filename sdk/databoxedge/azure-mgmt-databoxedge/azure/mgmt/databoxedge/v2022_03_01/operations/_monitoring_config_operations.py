...
def build_list_request(
    device_name: str, role_name: str, resource_group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class MonitoringConfigOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.databoxedge.v2022_03_01.DataBoxEdgeManagementClient`'s
    ...
    def list(
    ...
    ) -> Iterable["_models.MonitoringMetricConfiguration"]:
        ...
        :return: An iterator like instance of either MonitoringMetricConfiguration or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.databoxedge.v2022_03_01.models.MonitoringMetricConfiguration]
        ...
        api_version: Literal["2022-03-01"] = kwargs.pop("api_version", _params.pop("api-version", "2022-03-01"))
        cls: ClsType[_models.MonitoringMetricConfigurationList] = kwargs.pop("cls", None)
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.databoxedge.v2022_03_01.models.MonitoringMetricConfiguration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/roles/{roleName}/monitoringConfig/default"
    }
    ...
    def _create_or_update_initial(
        ...
        monitoring_metric_configuration: Union[_models.MonitoringMetricConfiguration, IO],
        **kwargs: Any
        ...
        api_version: Literal["2022-03-01"] = kwargs.pop("api_version", _params.pop("api-version", "2022-03-01"))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.MonitoringMetricConfiguration]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json"
        _json = None
        _content = None
        if isinstance(monitoring_metric_configuration, (IO, bytes)):
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type monitoring_metric_configuration:
         ~azure.mgmt.databoxedge.v2022_03_01.models.MonitoringMetricConfiguration
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.databoxedge.v2022_03_01.models.MonitoringMetricConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        role_name: str,
        resource_group_name: str,
        monitoring_metric_configuration: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.MonitoringMetricConfiguration]:
        ...
        :type resource_group_name: str
        :param monitoring_metric_configuration: The metric configuration. Required.
        :type monitoring_metric_configuration: IO
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type monitoring_metric_configuration:
         ~azure.mgmt.databoxedge.v2022_03_01.models.MonitoringMetricConfiguration or IO
