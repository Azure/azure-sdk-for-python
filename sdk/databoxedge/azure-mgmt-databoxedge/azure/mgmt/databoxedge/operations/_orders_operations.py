...
class OrdersOperations:
    ...
    def begin_create_or_update(
        ...
        :param order: The order to be created or updated. Is either a Order type or a IO[bytes] type.
         Required.
        :type order: ~azure.mgmt.databoxedge.models.Order or IO[bytes]
        :return: An instance of LROPoller that returns either Order or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.databoxedge.models.Order]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_dc_access_code(self, device_name: str, resource_group_name: str, **kwargs: Any) -> _models.DCAccessCode:
        ...
        _request = build_list_dc_access_code_request(
            device_name=device_name,
            resource_group_name=resource_group_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
        ...
        deserialized = self._deserialize("DCAccessCode", pipeline_response.http_response)
