    ...
    def list_by_resource_group(
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(
                List[_models.DataBoxEdgeDevice],
...
class BandwidthSchedulesOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.BandwidthSchedule],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
...
class StorageAccountCredentialsOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.StorageAccountCredential],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
...
class MonitoringConfigOperations:
    ...
    def list(
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.MonitoringMetricConfiguration],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
