...
class AddonPaged(Paged):
    """
    A paging container for iterating over a list of :class:`Addon <azure.mgmt.databoxedge.models.Addon>` object
    """
...
class MonitoringMetricConfigurationPaged(Paged):
    """
    A paging container for iterating over a list of :class:`MonitoringMetricConfiguration <azure.mgmt.databoxedge.models.MonitoringMetricConfiguration>` object
    """

    _attribute_map = {
        'next_link': {'key': 'nextLink', 'type': 'str'},
        'current_page': {'key': 'value', 'type': '[MonitoringMetricConfiguration]'}
    }

    def __init__(self, *args, **kwargs):

        super(MonitoringMetricConfigurationPaged, self).__init__(*args, **kwargs)
