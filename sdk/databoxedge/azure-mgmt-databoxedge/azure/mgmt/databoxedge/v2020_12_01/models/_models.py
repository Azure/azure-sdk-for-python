...
class ComputeResource(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.processor_count = kwargs.get('processor_count', None)
...
class MetricConfiguration(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.counter_sets = kwargs.get('counter_sets', None)
...
class MonitoringMetricConfiguration(ARMBaseModel):
    ...
    def __init__(self, **kwargs):
        ...
        self.metric_configurations = kwargs.get('metric_configurations', None)
