...
class DataBoxEdgeDeviceExtendedInfo(ARMBaseModel):
    ...
    :param key_vault_sync_status: Key vault sync status. Possible values
     include: 'KeyVaultSynced', 'KeyVaultSyncFailed', 'KeyVaultNotConfigured',
     'KeyVaultSyncPending', 'KeyVaultSyncing'
    :type key_vault_sync_status: str or
     ~azure.mgmt.databoxedge.models.KeyVaultSyncStatus
    :ivar device_secrets: Device secrets, will be returned only with
     ODataFilter $expand=deviceSecrets
    :vartype device_secrets: ~azure.mgmt.databoxedge.models.DeviceSecrets
    """
    ...
    def __init__(self, *, encryption_key_thumbprint: str=None, encryption_key: str=None, client_secret_store_id: str=None, client_secret_store_url: str=None, channel_integrity_key_name: str=None, channel_integrity_key_version: str=None, key_vault_sync_status=None, **kwargs) -> None:
...
class DataBoxEdgeDeviceExtendedInfoPatch(Model):
    ...
    :param channel_integrity_key_version: The version of Channel Integrity Key
     stored in the Client Key Vault
    :type channel_integrity_key_version: str
    :param sync_status: For changing or to initiate the resync to key-vault
     set the status to KeyVaultSyncPending, rest of the status will not be
     applicable. Possible values include: 'KeyVaultSynced',
     'KeyVaultSyncFailed', 'KeyVaultNotConfigured', 'KeyVaultSyncPending',
     'KeyVaultSyncing'
    :type sync_status: str or
     ~azure.mgmt.databoxedge.models.KeyVaultSyncStatus
    """
    ...
    def __init__(self, *, client_secret_store_id: str=None, client_secret_store_url: str=None, channel_integrity_key_name: str=None, channel_integrity_key_version: str=None, sync_status=None, **kwargs) -> None:
...
class DeviceSecrets(Model):
    ...
    :type hcs_data_volume_bit_locker_external_key:
     ~azure.mgmt.databoxedge.models.Secret
    ...
    :type hcs_internal_volume_bit_locker_external_key:
     ~azure.mgmt.databoxedge.models.Secret
    :param system_volume_bit_locker_recovery_key: Keyvault Id of
     SystemVolumeBitLockerRecoveryKey
    :type system_volume_bit_locker_recovery_key:
     ~azure.mgmt.databoxedge.models.Secret
    :param sed_encryption_external_key_id: Keyvault Id of
     SEDEncryptionExternalKeyId
    :type sed_encryption_external_key_id:
     ~azure.mgmt.databoxedge.models.Secret
    :param sed_encryption_external_key: Keyvault Id of
     SEDEncryptionExternalKey
    :type sed_encryption_external_key: ~azure.mgmt.databoxedge.models.Secret
    :param bmc_default_user_password: Keyvault Id of BMCDefaultUserPassword
    :type bmc_default_user_password: ~azure.mgmt.databoxedge.models.Secret
    :param rotate_key_for_data_volume_bitlocker: Keyvault Id of
     RotateKeyForDataVolumeBitlocker
    :type rotate_key_for_data_volume_bitlocker:
     ~azure.mgmt.databoxedge.models.Secret
    :param rotate_keys_for_sed_drives_serialized: Keyvault Id of
     RotateKeysForSedDrivesSerialized
    :type rotate_keys_for_sed_drives_serialized:
     ~azure.mgmt.databoxedge.models.Secret
    """
...
class ImageRepositoryCredential(Model):
    ...
    :param image_repository_url: Required. Image repository url (e.g.:
     mcr.microsoft.com).
    :type image_repository_url: str
    :param user_name: Required. Repository user name.
    :type user_name: str
    :param password: Repository user password.
    :type password: ~azure.mgmt.databoxedge.models.AsymmetricEncryptedSecret
    """
...
class IoTDeviceInfo(Model):
    ...
    :param authentication: Encrypted IoT device/IoT edge device connection
     string.
...
class IoTEdgeAgentInfo(Model):
    ...
    :type image_repository:
     ~azure.mgmt.databoxedge.models.ImageRepositoryCredential
    """
...
class IoTRole(Role):
    ...
    :param io_tedge_agent_info: Iot edge agent details to download the agent
     and bootstrap iot runtime.
    :type io_tedge_agent_info: ~azure.mgmt.databoxedge.models.IoTEdgeAgentInfo
    :ivar host_platform_type: Platform where the Iot runtime is hosted.
...
class MountPointMap(Model):
    ...
    :ivar mount_type: Mounting type. Possible values include: 'Volume',
     'HostPath'
...
class Secret(Model):
    ...
    def __init__(self, *, encrypted_secret=None, key_vault_id: str=None, **kwargs) -> None:
...
class SkuInformation(Model):
    ...
    :vartype location_info:
     list[~azure.mgmt.databoxedge.models.SkuLocationInfo]
    :ivar required_quota_ids: The required quotaIds for the sku to be
     available.
...
class User(ARMBaseModel):
    ...
    :type encrypted_password:
     ~azure.mgmt.databoxedge.models.AsymmetricEncryptedSecret
    :ivar share_access_rights: List of shares that the user has rights on.
    ...
    def __init__(self, *, user_type, system_data=None, encrypted_password=None, **kwargs) -> None:
