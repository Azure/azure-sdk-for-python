...
try:
    ...
    from ._models import DataResidency  # type: ignore
    ...
    from ._models import RemoteSupportSettings  # type: ignore
    ...
    from ._models import TriggerSupportPackageRequest  # type: ignore
    from ._models import UpdateDetails  # type: ignore
