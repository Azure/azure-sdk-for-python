...
class DataResidencyType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class InstallationImpact(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ProactiveDiagnosticsConsent(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class RemoteApplicationType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
