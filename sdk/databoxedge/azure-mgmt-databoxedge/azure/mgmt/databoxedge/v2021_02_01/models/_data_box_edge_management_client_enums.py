...
class DataResidencyType(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class InstallationImpact(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class ProactiveDiagnosticsConsent(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
