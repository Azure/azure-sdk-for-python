...
from ...operations._support_packages_operations import build_trigger_support_package_request
...
class SupportPackagesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.databoxedge.v2021_02_01.aio.DataBoxEdgeManagementClient`'s
    ...
    async def _trigger_support_package_initial(  # pylint: disable=inconsistent-return-statements
        self,
        device_name: str,
        resource_group_name: str,
        trigger_support_package_request: Union[_models.TriggerSupportPackageRequest, IO],
        **kwargs: Any
    ) -> None:
        error_map = {
    ...
    _trigger_support_package_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/triggerSupportPackage"
    }
    ...
    async def begin_trigger_support_package(
        ...
        device_name: str,
        resource_group_name: str,
        trigger_support_package_request: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[None]:
    ...
    async def begin_trigger_support_package(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._trigger_support_package_initial(  # type: ignore
                device_name=device_name,
                resource_group_name=resource_group_name,
    ...
    begin_trigger_support_package.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/triggerSupportPackage"
    }
