    ...
    def list_by_data_box_edge_device(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either StorageAccountCredentialList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.databoxedge.v2021_02_01.models.StorageAccountCredentialList]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either StorageAccountCredential or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.databoxedge.v2021_02_01.models.StorageAccountCredential]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
