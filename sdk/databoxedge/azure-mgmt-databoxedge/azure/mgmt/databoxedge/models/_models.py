...
class Role(ProxyResource):
    ...
    __mapping__: dict[str, _Model] = {}
    kind: str = rest_discriminator(name="kind", visibility=["read", "create"])
    """Role type. Required. Known values are: \"IOT\", \"ASA\", \"Functions\", \"Cognitive\", \"MEC\",
...
class GenerateCertResponse(_Model):
    ...
    """Gets or sets base64 encoded certificate raw data, this is the public part needed to be uploaded
     to cert vault."""
...
class MetricDimensionV1(_Model):
    """Metric Dimension v1.
...
class MetricSpecificationV1(_Model):
    ...
    dimensions: Optional[list["_models.MetricDimensionV1"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
...
class ServiceSpecification(_Model):
    ...
    metric_specifications: Optional[list["_models.MetricSpecificationV1"]] = rest_field(
    ...
    def __init__(
        self,
        *,
        metric_specifications: Optional[list["_models.MetricSpecificationV1"]] = None,
    ) -> None: ...
