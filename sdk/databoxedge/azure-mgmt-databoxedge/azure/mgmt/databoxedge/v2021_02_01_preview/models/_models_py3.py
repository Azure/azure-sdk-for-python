...
class DataBoxEdgeSku(Model):
    ...
    :ivar name: The Sku name. Possible values include: 'Gateway', 'Edge',
     ...
     'EdgePR_Base_UPS', 'EP2_64_1VPU_W', 'EP2_128_1T4_Mx1_W', 'EP2_256_2T4_W',
     'EdgeMR_Mini', 'RCA_Small', 'RCA_Large', 'RDC', 'Management'
...
class MECRole(Role):
    ...
    def __init__(self, *, role_status, system_data=None, connection_string=None, controller_endpoint: str=None, resource_unique_id: str=None, **kwargs) -> None:
...
class MonitoringMetricConfiguration(ARMBaseModel):
    ...
    :ivar type: The hierarchical type of the object.
    :vartype type: str
    :param system_data: MonitoringConfiguration on ASE device
    :type system_data: ~azure.mgmt.databoxedge.models.SystemData
    ...
    def __init__(self, *, metric_configurations, system_data=None, **kwargs) -> None:
...
class NetworkSettings(ARMBaseModel):
    ...
    :ivar type: The hierarchical type of the object.
    :vartype type: str
    :param system_data: NetworkSettings on ASE device
    :type system_data: ~azure.mgmt.databoxedge.models.SystemData
...
class Order(ARMBaseModel):
    ...
    :ivar type: The hierarchical type of the object.
    :vartype type: str
    :param system_data: Order configured on ASE resource
    :type system_data: ~azure.mgmt.databoxedge.models.SystemData
    ...
    def __init__(self, *, contact_information, system_data=None, shipping_address=None, shipment_type=None, **kwargs) -> None:
...
class UpdateDetails(Model):
    ...
    :param update_type: Type of the Update. Possible values include:
     'Software', 'Kubernetes', 'Firmware'
    :type update_type: str or ~azure.mgmt.databoxedge.models.UpdateType
    :param target_version: Target Version number
    :type target_version: str
    :param estimated_install_time_in_mins: Estimated Install Time for the
     update
    :type estimated_install_time_in_mins: int
    :param reboot_behavior: Indicates if updates are available and at least
     one of the updates needs a reboot. Possible values include:
     'NeverReboots', 'RequiresReboot', 'RequestReboot'
    :type reboot_behavior: str or
     ~azure.mgmt.databoxedge.models.InstallRebootBehavior
    :param status: Status of the update. Possible values include:
     'DownloadPending', 'DownloadStarted', 'DownloadCompleted',
     'InstallStarted', 'InstallCompleted'
    :type status: str or ~azure.mgmt.databoxedge.models.UpdateStatus
    """
    ...
    def __init__(self, *, update_title: str=None, update_size: float=None, update_type=None, target_version: str=None, estimated_install_time_in_mins: int=None, reboot_behavior=None, status=None, **kwargs) -> None:
...
class UpdateSummary(ARMBaseModel):
    ...
    :ivar type: The hierarchical type of the object.
    :vartype type: str
    :param system_data: UpdateSummary Result
    :type system_data: ~azure.mgmt.databoxedge.models.SystemData
    ...
    :ivar last_completed_download_job_id: JobId of the last ran download
     job.(Can be success/cancelled/failed)
    :vartype last_completed_download_job_id: str
    :ivar last_download_job_status: JobStatus of the last ran download job.
     Possible values include: 'Invalid', 'Running', 'Succeeded', 'Failed',
     'Canceled', 'Paused', 'Scheduled'
    :vartype last_download_job_status: str or
     ~azure.mgmt.databoxedge.models.JobStatus
    ...
    :ivar last_completed_install_job_id: JobId of the last ran install
     job.(Can be success/cancelled/failed)
    :vartype last_completed_install_job_id: str
    :ivar last_install_job_status: JobStatus of the last ran install job.
     Possible values include: 'Invalid', 'Running', 'Succeeded', 'Failed',
     'Canceled', 'Paused', 'Scheduled'
    ...
    def __init__(self, *, system_data=None, device_version_number: str=None, friendly_device_version_name: str=None, device_last_scanned_date_time=None, last_completed_scan_job_date_time=None, **kwargs) -> None:
