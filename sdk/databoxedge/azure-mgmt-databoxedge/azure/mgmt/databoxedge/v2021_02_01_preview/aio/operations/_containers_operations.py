...
class ContainersOperations:
    ...
    def list_by_storage_account(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databoxedge.v2021_02_01_preview.models.Container]
    ...
    async def get(
        ...
        deserialized = self._deserialize("Container", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        container: Union[_models.Container, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Container or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2021_02_01_preview.models.Container]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param container: The container properties. Is either a Container type or a IO[bytes] type.
         Required.
        :type container: ~azure.mgmt.databoxedge.v2021_02_01_preview.models.Container or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Container or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2021_02_01_preview.models.Container]
        ...
        if cont_token:
            return AsyncLROPoller[_models.Container].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.Container](
