...
class RolesOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databoxedge.v2021_02_01_preview.models.Role]
    ...
    async def get(self, device_name: str, name: str, resource_group_name: str, **kwargs: Any) -> _models.Role:
        ...
        deserialized = self._deserialize("Role", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        self, device_name: str, name: str, resource_group_name: str, role: Union[_models.Role, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_create_or_update(
        ...
        :type role: ~azure.mgmt.databoxedge.v2021_02_01_preview.models.Role or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Role or the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2021_02_01_preview.models.Role]
        :raises ~azure.core.exceptions.HttpResponseError:
