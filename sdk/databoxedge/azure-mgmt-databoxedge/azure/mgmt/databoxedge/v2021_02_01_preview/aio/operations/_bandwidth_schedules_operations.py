...
class BandwidthSchedulesOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databoxedge.v2021_02_01_preview.models.BandwidthSchedule]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.databoxedge.v2021_02_01_preview.models.BandwidthSchedule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("BandwidthSchedule", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        parameters: Union[_models.BandwidthSchedule, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.databoxedge.v2021_02_01_preview.models.BandwidthSchedule
        ...
        :return: An instance of AsyncLROPoller that returns either BandwidthSchedule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2021_02_01_preview.models.BandwidthSchedule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.databoxedge.v2021_02_01_preview.models.BandwidthSchedule or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either BandwidthSchedule or the result of
         cls(response)
        :rtype:
        ...
        if cont_token:
            return AsyncLROPoller[_models.BandwidthSchedule].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.BandwidthSchedule](
