...
from ...operations._storage_accounts_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_data_box_edge_device_request
T = TypeVar('T')
...
class StorageAccountsOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databoxedge.v2021_02_01_preview.models.StorageAccountList]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.databoxedge.v2021_02_01_preview.models.StorageAccount
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type storage_account: ~azure.mgmt.databoxedge.v2021_02_01_preview.models.StorageAccount
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either StorageAccount or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2021_02_01_preview.models.StorageAccount]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
