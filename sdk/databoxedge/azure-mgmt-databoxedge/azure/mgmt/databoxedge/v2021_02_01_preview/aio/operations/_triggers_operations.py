...
class TriggersOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databoxedge.v2021_02_01_preview.models.Trigger]
    ...
    async def get(self, device_name: str, name: str, resource_group_name: str, **kwargs: Any) -> _models.Trigger:
        ...
        :rtype: ~azure.mgmt.databoxedge.v2021_02_01_preview.models.Trigger
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type trigger: ~azure.mgmt.databoxedge.v2021_02_01_preview.models.Trigger
        ...
        :return: An instance of AsyncLROPoller that returns either Trigger or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2021_02_01_preview.models.Trigger]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type trigger: ~azure.mgmt.databoxedge.v2021_02_01_preview.models.Trigger or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Trigger or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.databoxedge.v2021_02_01_preview.models.Trigger]
