...
def build_get_request(
    device_name: str, role_name: str, addon_name: str, resource_group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class AddonsOperations:
    ...
    def list_by_role(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.databoxedge.v2021_02_01_preview.models.Addon]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_role_request(
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type addon: ~azure.mgmt.databoxedge.v2021_02_01_preview.models.Addon or IO[bytes]
        :return: An instance of LROPoller that returns either Addon or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.databoxedge.v2021_02_01_preview.models.Addon]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
