...
class CarbonOptimizationMgmtClient:
    ...
    :vartype operations: azure.mgmt.carbonoptimization.aio.operations.Operations
    :ivar carbon_service: CarbonServiceOperations operations
    :vartype carbon_service: azure.mgmt.carbonoptimization.aio.operations.CarbonServiceOperations
    ...
    def __init__(
        ...
        _endpoint = "{endpoint}"
        self._config = CarbonOptimizationMgmtClientConfiguration(credential=credential, base_url=base_url, **kwargs)
        ...
        self.carbon_service = CarbonServiceOperations(self._client, self._config, self._serialize, self._deserialize)
