...
class CarbonOptimizationMgmtClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    """Configuration for CarbonOptimizationMgmtClient.
    ...
    def __init__(
        ...
        kwargs.setdefault("sdk_moniker", "mgmt-carbonoptimization/{}".format(VERSION))
