...
class TestPolicyInsightsRemediationsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(PolicyInsightsClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_list_deployments_at_management_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_cancel_at_management_group(self, resource_group):
        response = await self.client.remediations.cancel_at_management_group(
            management_group_id="str",
            remediation_name="str",
            management_groups_namespace="Microsoft.Management",
            api_version="2024-10-01",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_list_for_management_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_create_or_update_at_management_group(self, resource_group):
        response = await self.client.remediations.create_or_update_at_management_group(
            management_group_id="str",
            remediation_name="str",
            parameters={
                "correlationId": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_get_at_management_group(self, resource_group):
        response = await self.client.remediations.get_at_management_group(
            management_group_id="str",
            remediation_name="str",
            management_groups_namespace="Microsoft.Management",
            api_version="2024-10-01",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_delete_at_management_group(self, resource_group):
        response = await self.client.remediations.delete_at_management_group(
            management_group_id="str",
            remediation_name="str",
            management_groups_namespace="Microsoft.Management",
            api_version="2024-10-01",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_create_or_update_at_subscription(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_list_deployments_at_resource_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_cancel_at_resource_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_create_or_update_at_resource_group(self, resource_group):
        response = await self.client.remediations.create_or_update_at_resource_group(
            resource_group_name=resource_group.name,
            remediation_name="str",
            parameters={
                "correlationId": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_get_at_resource_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_delete_at_resource_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_list_deployments_at_resource(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_cancel_at_resource(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_create_or_update_at_resource(self, resource_group):
        response = await self.client.remediations.create_or_update_at_resource(
            resource_id="str",
            remediation_name="str",
            parameters={
                "correlationId": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_get_at_resource(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_remediations_delete_at_resource(self, resource_group):
