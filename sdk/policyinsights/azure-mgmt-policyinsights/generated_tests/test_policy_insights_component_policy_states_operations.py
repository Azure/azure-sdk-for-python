...
class TestPolicyInsightsComponentPolicyStatesOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_component_policy_states_list_query_results_for_resource(self, resource_group):
        response = self.client.component_policy_states.list_query_results_for_resource(
            resource_id="str",
            component_policy_states_resource="str",
            api_version="2024-10-01",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_component_policy_states_list_query_results_for_resource_group_level_policy_assignment(
        self, resource_group
    ):
