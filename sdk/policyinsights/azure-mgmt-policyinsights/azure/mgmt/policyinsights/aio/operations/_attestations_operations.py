...
class AttestationsOperations:
    ...
    ) -> AsyncItemPaged["_models.Attestation"]:
    ...
    @distributed_trace_async
    async def delete_at_subscription(self, attestation_name: str, **kwargs: Any) -> None:
    ...
    @distributed_trace_async
    async def delete_at_resource_group(self, resource_group_name: str, attestation_name: str, **kwargs: Any) -> None:
    ...
    @distributed_trace_async
    async def delete_at_resource(self, resource_id: str, attestation_name: str, **kwargs: Any) -> None:
