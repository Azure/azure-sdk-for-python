...
def build_list_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.PolicyInsights/operations")
...
class Operations:
    ...
    def list(self, **kwargs: Any) -> _models.OperationsListResults:
        ...
        deserialized = self._deserialize("OperationsListResults", pipeline_response.http_response)
