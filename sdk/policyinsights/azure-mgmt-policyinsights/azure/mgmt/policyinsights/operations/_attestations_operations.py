...
def build_create_or_update_at_resource_request(resource_id: str, attestation_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class AttestationsOperations:
    ...
    def begin_create_or_update_at_subscription(
        ...
        if cont_token is None:
            raw_result = self._create_or_update_at_subscription_initial(  # type: ignore
                attestation_name=attestation_name,
    ...
    def begin_create_or_update_at_resource_group(
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._create_or_update_at_resource_group_initial(  # type: ignore
                resource_group_name=resource_group_name,
                attestation_name=attestation_name,
                parameters=parameters,
                api_version=api_version,
    ...
    def begin_create_or_update_at_resource(
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._create_or_update_at_resource_initial(  # type: ignore
                resource_id=resource_id,
                attestation_name=attestation_name,
                parameters=parameters,
                api_version=api_version,
