...
# USAGE
    python remediations_create_resource_scope.py
...
def main():
    ...
    response = client.remediations.create_or_update_at_resource(
...
# x-ms-original-file: specification/policyinsights/resource-manager/Microsoft.PolicyInsights/PolicyInsights/stable/2024-10-01/examples/Remediations_CreateResourceScope.json
