...
### Features Added
  ...
  - Model `AttributeNamespace` added property `system_data`
...
### Breaking Changes
  ...
  - Deleted or renamed client `AuthorizationManagementClient`
  ...
  - Deleted or renamed enum value `UserType.SERVICE_PRINCIPAL`
  - Deleted or renamed model `DenyAssignmentFilter`
  - Deleted or renamed model `DenyAssignmentPrincipalType`
