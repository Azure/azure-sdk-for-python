...
class TestAuthorizationManagementAccessReviewScheduleDefinitionsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_access_review_schedule_definitions_get_by_id(self, resource_group):
        response = await self.client.access_review_schedule_definitions.get_by_id(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_access_review_schedule_definitions_delete_by_id(self, resource_group):
        response = await self.client.access_review_schedule_definitions.delete_by_id(
            schedule_definition_id="str",
            api_version="2021-12-01-preview",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_access_review_schedule_definitions_create_or_update_by_id(self, resource_group):
        response = await self.client.access_review_schedule_definitions.create_or_update_by_id(
            schedule_definition_id="str",
            properties={
                "assignmentState": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_access_review_schedule_definitions_stop(self, resource_group):
        response = await self.client.access_review_schedule_definitions.stop(
            schedule_definition_id="str",
            api_version="2021-12-01-preview",
        )
