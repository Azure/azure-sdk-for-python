...
class TestCombineAccessReviewHistoryDefinitionOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(CombineClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_access_review_history_definition_create(self, resource_group):
        response = self.client.access_review_history_definition.create(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_access_review_history_definition_delete_by_id(self, resource_group):
        response = self.client.access_review_history_definition.delete_by_id(
            history_definition_id="str",
            api_version="2021-12-01-preview",
        )
