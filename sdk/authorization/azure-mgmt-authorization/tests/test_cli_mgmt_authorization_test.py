...
class TestMgmtAuthorization(AzureMgmtRecordedTestCase):
    ...
    def setup_method(self, method):
        ...
        self.mgmt_client = self.create_mgmt_client(
            azure.mgmt.authorization.AuthorizationManagementClient, api_version="2018-01-01-preview"
        )
        self.mgmt_client_180701 = self.create_mgmt_client(
            azure.mgmt.authorization.AuthorizationManagementClient, api_version="2018-07-01-preview"
        )
    ...
    def test_list_by_resource(self, resource_group):
        ...
        if self.is_live:
            create_result = self.resource_client.resources.begin_create_or_update_by_id(
                RESOURCE_ID, parameters={"location": AZURE_LOCATION}, api_version="2019-07-01"
            )
    ...
    def test_role_assignment(self, resource_group):
        ...
        result = self.mgmt_client.role_assignments.create(
            scope=SCOPE, role_assignment_name=ROLE_ASSIGNMENT_NAME, parameters=BODY
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.provider_operations_metadata.get(
    ...
    def test_role_definition(self):
        ...
        BODY = {
            ...
            "permissions": [
                {
                    "not_data_actions": ["Microsoft.Storage/storageAccounts/blobServices/containers/blobs/write"],
                    "actions": [
        ...
        # /RoleDefinitions/get/GetConfigurations[get]
        # --------------------------------------------------------------------------
        ROLE_DEFINITION_ID_URL = SCOPE + "/providers/Microsoft.Authorization/roleDefinitions/{roleDefinitionId}".format(
