...
# USAGE
    python put_access_review_instance.py
...
def main():
    ...
    response = client.scope_access_review_instances.create(
...
# x-ms-original-file: specification/authorization/resource-manager/Microsoft.Authorization/Authorization/preview/2021-12-01-preview/examples/PutAccessReviewInstance.json
