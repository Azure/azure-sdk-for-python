...
def build_validate_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.Authorization/roleAssignmentScheduleRequests/{roleAssignmentScheduleRequestName}/validate")  # pylint: disable=line-too-long
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, 'str', skip_quote=True),
        "roleAssignmentScheduleRequestName": _SERIALIZER.url("role_assignment_schedule_request_name", role_assignment_schedule_request_name, 'str'),
    }
...
class RoleAssignmentScheduleRequestsOperations(object):
    ...
    def list_for_scope(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.authorization.v2020_10_01.models.RoleAssignmentScheduleRequestListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-10-01")  # type: str
    ...
    validate.metadata = {'url': "/{scope}/providers/Microsoft.Authorization/roleAssignmentScheduleRequests/{roleAssignmentScheduleRequestName}/validate"}  # type: ignore
