...
class ClassicAdministratorsOperations(object):
    ...
    :type models: ~azure.mgmt.authorization.v2015_06_01.models
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/classicAdministrators'}  # type: ignore
