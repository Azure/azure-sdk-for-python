...
class AccessReviewInstancesOperations(object):
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either AccessReviewInstanceListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.authorization.v2021_07_01_preview.models.AccessReviewInstanceListResult]
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :type properties:
         ~azure.mgmt.authorization.v2021_07_01_preview.models.AccessReviewInstanceProperties
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AccessReviewInstance, or the result of cls(response)
        :rtype: ~azure.mgmt.authorization.v2021_07_01_preview.models.AccessReviewInstance
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    create.metadata = {'url': "/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances/{id}"}  # type: ignore
