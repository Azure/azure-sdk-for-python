...
class AccessReviewContactedReviewer(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(AccessReviewContactedReviewer, self).__init__(**kwargs)
        self.id = None
        self.name = None
        self.type = None
...
class AccessReviewContactedReviewerListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["AccessReviewContactedReviewer"]] = None,
        ...
        **kwargs
        ...
        """
        super(AccessReviewContactedReviewerListResult, self).__init__(**kwargs)
        self.value = value
...
class AccessReviewInstanceProperties(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype backup_reviewers:
         list[~azure.mgmt.authorization.v2021_07_01_preview.models.AccessReviewReviewer]
        """
        super(AccessReviewInstanceProperties, self).__init__(**kwargs)
        self.status = None
        self.start_date_time = start_date_time
        self.end_date_time = end_date_time
        self.reviewers = reviewers
...
class AccessReviewScheduleDefinition(msrest.serialization.Model):
    ...
    :ivar principal_type_properties_scope_principal_type: The identity type user/servicePrincipal
     to review. Possible values include: "user", "guestUser", "servicePrincipal", "user,group",
     "redeemedGuestUser".
    ...
    _attribute_map = {
        ...
        'recommendation_look_back_duration': {'key': 'properties.settings.recommendationLookBackDuration', 'type': 'duration'},
...
class AccessReviewScheduleDefinitionProperties(msrest.serialization.Model):
    ...
    :ivar principal_type_scope_principal_type: The identity type user/servicePrincipal to review.
     Possible values include: "user", "guestUser", "servicePrincipal", "user,group",
     "redeemedGuestUser".
