...
class TenantLevelAccessReviewInstanceContactedReviewersOperations:
    """TenantLevelAccessReviewInstanceContactedReviewersOperations async operations.
    ...
    def list(
        ...
        id: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.AccessReviewContactedReviewerListResult"]:
        ...
        :return: An iterator like instance of either AccessReviewContactedReviewerListResult or the
         result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.authorization.v2021_07_01_preview.models.AccessReviewContactedReviewerListResult]
