...
from ...operations._role_eligibility_schedule_instances_operations import build_get_request, build_list_for_scope_request
T = TypeVar('T')
...
class RoleEligibilityScheduleInstancesOperations:
    ...
    def list_for_scope(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.authorization.v2020_10_01_preview.models.RoleEligibilityScheduleInstanceListResult]
