...
from ...operations._role_eligibility_schedule_requests_operations import build_cancel_request, build_create_request, build_get_request, build_list_for_scope_request
T = TypeVar('T')
...
class RoleEligibilityScheduleRequestsOperations:
    ...
    def list_for_scope(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.authorization.v2020_10_01_preview.models.RoleEligibilityScheduleRequestListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-10-01-preview")  # type: str
