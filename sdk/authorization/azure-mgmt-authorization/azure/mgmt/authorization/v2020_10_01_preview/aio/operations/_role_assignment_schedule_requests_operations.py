...
from ...operations._role_assignment_schedule_requests_operations import build_cancel_request, build_create_request, build_get_request, build_list_for_scope_request
T = TypeVar('T')
...
class RoleAssignmentScheduleRequestsOperations:
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :param role_assignment_schedule_request_name: A GUID for the role assignment to create. The
         name must be unique and different for each role assignment.
    ...
    def list_for_scope(
        ...
        **kwargs: Any
        ...
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either RoleAssignmentScheduleRequestListResult or the
         result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.authorization.v2020_10_01_preview.models.RoleAssignmentScheduleRequestListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-10-01-preview")  # type: str
