...
class EligibleChildResourcesOperations(object):
    ...
    def get(
        ...
        :param filter: The filter to apply on the operation. Use
         $filter=resourceType+eq+'Subscription' to filter on only resource of
         type = 'Subscription'. Use
        ...
        :rtype:
         ~azure.mgmt.authorization.v2020_10_01_preview.models.EligibleChildResourcePaged[~azure.mgmt.authorization.v2020_10_01_preview.models.EligibleChildResource]
        ...
        if raw:
            header_dict = {}
        deserialized = models.EligibleChildResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)
