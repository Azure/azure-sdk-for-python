...
def build_create_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/{scope}/providers/Microsoft.Authorization/roleAssignmentScheduleRequests/{roleAssignmentScheduleRequestName}')
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, 'str', skip_quote=True),
        "roleAssignmentScheduleRequestName": _SERIALIZER.url("role_assignment_schedule_request_name", role_assignment_schedule_request_name, 'str'),
    }
...
def build_list_for_scope_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/{scope}/providers/Microsoft.Authorization/roleAssignmentScheduleRequests')
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, 'str', skip_quote=True),
    }
...
def build_cancel_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/{scope}/providers/Microsoft.Authorization/roleAssignmentScheduleRequests/{roleAssignmentScheduleRequestName}/cancel')
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, 'str', skip_quote=True),
        "roleAssignmentScheduleRequestName": _SERIALIZER.url("role_assignment_schedule_request_name", role_assignment_schedule_request_name, 'str'),
    }
...
class RoleAssignmentScheduleRequestsOperations(object):
    ...
    def list_for_scope(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.RoleAssignmentScheduleRequestListResult"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.authorization.v2020_10_01_preview.models.RoleAssignmentScheduleRequestListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
