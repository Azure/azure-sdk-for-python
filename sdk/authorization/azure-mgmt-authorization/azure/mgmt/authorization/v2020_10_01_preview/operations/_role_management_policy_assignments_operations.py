...
class RoleManagementPolicyAssignmentsOperations(object):
    ...
    def get(
            self, scope, role_management_policy_assignment_name, custom_headers=None, raw=False, **operation_config):
        """Get the specified role management policy assignment for a resource
        scope.

        :param scope: The scope of the role management policy.
        :type scope: str
        :param role_management_policy_assignment_name: The name of format
         {guid_guid} the role management policy assignment to get.
        ...
        :return: RoleManagementPolicyAssignment or ClientRawResponse if
         raw=true
        :rtype:
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('RoleManagementPolicyAssignment', response)
    ...
    def create(
            self, scope, role_management_policy_assignment_name, parameters, custom_headers=None, raw=False, **operation_config):
        """Create a role management policy assignment.

        :param scope: The scope of the role management policy assignment to
         upsert.
        :type scope: str
        :param role_management_policy_assignment_name: The name of format
         {guid_guid} the role management policy assignment to upsert.
        :type role_management_policy_assignment_name: str
    ...
    def delete(
        ...
        :type scope: str
        :param role_management_policy_assignment_name: The name of format
         {guid_guid} the role management policy assignment to delete.
        :type role_management_policy_assignment_name: str
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
    ...
    def list_for_scope(
        ...
        :rtype:
         ~azure.mgmt.authorization.v2020_10_01_preview.models.RoleManagementPolicyAssignmentPaged[~azure.mgmt.authorization.v2020_10_01_preview.models.RoleManagementPolicyAssignment]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.RoleManagementPolicyAssignmentPaged(internal_paging, self._deserialize.dependencies, header_dict)
