...
class RoleEligibilitySchedulesOperations(object):
    ...
    def get(
        self,
        scope,  # type: str
        role_eligibility_schedule_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.RoleEligibilitySchedule"
    ...
    def list_for_scope(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.RoleEligibilityScheduleListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.authorization.v2020_10_01_preview.models.RoleEligibilityScheduleListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
