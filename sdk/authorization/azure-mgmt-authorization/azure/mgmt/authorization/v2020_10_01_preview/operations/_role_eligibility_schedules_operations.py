...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/{scope}/providers/Microsoft.Authorization/roleEligibilitySchedules/{roleEligibilityScheduleName}')
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, 'str', skip_quote=True),
        "roleEligibilityScheduleName": _SERIALIZER.url("role_eligibility_schedule_name", role_eligibility_schedule_name, 'str'),
    }
...
def build_list_for_scope_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/{scope}/providers/Microsoft.Authorization/roleEligibilitySchedules')
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, 'str', skip_quote=True),
    }
...
class RoleEligibilitySchedulesOperations(object):
    ...
    def list_for_scope(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.RoleEligibilityScheduleListResult"]:
        ...
        :return: An iterator like instance of either RoleEligibilityScheduleListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.authorization.v2020_10_01_preview.models.RoleEligibilityScheduleListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
