...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/{scope}/providers/Microsoft.Authorization/roleAssignmentSchedules/{roleAssignmentScheduleName}')
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, 'str', skip_quote=True),
        "roleAssignmentScheduleName": _SERIALIZER.url("role_assignment_schedule_name", role_assignment_schedule_name, 'str'),
    }
...
def build_list_for_scope_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/{scope}/providers/Microsoft.Authorization/roleAssignmentSchedules')
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, 'str', skip_quote=True),
    }
...
class RoleAssignmentSchedulesOperations(object):
    ...
    def get(
        ...
        **kwargs: Any
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.RoleAssignmentSchedule"]
        error_map = {
    ...
    def list_for_scope(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.RoleAssignmentScheduleListResult"]:
        ...
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either RoleAssignmentScheduleListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.authorization.v2020_10_01_preview.models.RoleAssignmentScheduleListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.RoleAssignmentScheduleListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
