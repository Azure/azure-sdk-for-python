...
class RoleAssignmentSchedulesOperations(object):
    ...
    def get(
        self,
        scope,  # type: str
        role_assignment_schedule_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.RoleAssignmentSchedule"
    ...
    def list_for_scope(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.RoleAssignmentScheduleListResult"]
        ...
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either RoleAssignmentScheduleListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.authorization.v2020_10_01_preview.models.RoleAssignmentScheduleListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
