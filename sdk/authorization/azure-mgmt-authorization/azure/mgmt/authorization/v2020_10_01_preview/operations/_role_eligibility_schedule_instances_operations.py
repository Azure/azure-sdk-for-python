...
class RoleEligibilityScheduleInstancesOperations(object):
    ...
    def list_for_scope(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.RoleEligibilityScheduleInstanceListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.authorization.v2020_10_01_preview.models.RoleEligibilityScheduleInstanceListResult]
    ...
    def get(
        self,
        scope,  # type: str
        role_eligibility_schedule_instance_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.RoleEligibilityScheduleInstance"
