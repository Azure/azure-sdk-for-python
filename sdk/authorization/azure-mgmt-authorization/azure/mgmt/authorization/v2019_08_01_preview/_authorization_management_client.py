...
class AuthorizationManagementClient:
    ...
    :ivar role_assignment_metrics: RoleAssignmentMetricsOperations operations
    :vartype role_assignment_metrics:
     azure.mgmt.authorization.v2019_08_01_preview.operations.RoleAssignmentMetricsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.role_assignment_metrics = RoleAssignmentMetricsOperations(self._client, self._config, self._serialize, self._deserialize)
