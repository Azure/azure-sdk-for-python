...
class RoleAssignmentMetricsOperations:
    """RoleAssignmentMetricsOperations async operations.

    You should not instantiate this class directly. Instead, you should create a Client instance that
    instantiates it for you and attaches it as an attribute.

    :ivar models: Alias to model classes used in this operation group.
    :type models: ~azure.mgmt.authorization.v2019_08_01_preview.models
    ...
    async def get_metrics_for_subscription(
        self,
        **kwargs: Any
    ) -> "_models.RoleAssignmentMetricsResult":
        ...
        # Construct URL
        url = self.get_metrics_for_subscription.metadata['url']  # type: ignore
