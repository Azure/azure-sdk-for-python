...
class AccessReviewScheduleDefinitionsOperations(object):
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions'}
    ...
    def get_by_id(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: AccessReviewScheduleDefinition or ClientRawResponse if
         raw=true
        :rtype:
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('AccessReviewScheduleDefinition', response)
        ...
        return deserialized
    get_by_id.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}'}
    ...
    def delete_by_id(
        ...
        if raw:
            ...
            return client_raw_response
    delete_by_id.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}'}

    def create_or_update_by_id(
            self, schedule_definition_id, properties, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    create_or_update_by_id.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}'}
    ...
    def stop(
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    stop.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/stop'}
