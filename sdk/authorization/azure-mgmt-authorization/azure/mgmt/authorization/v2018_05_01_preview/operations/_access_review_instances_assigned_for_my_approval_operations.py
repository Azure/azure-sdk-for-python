...
class AccessReviewInstancesAssignedForMyApprovalOperations(object):
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances'}
    ...
    def get_by_id(
        ...
        return deserialized
    get_by_id.metadata = {'url': '/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances/{id}'}
