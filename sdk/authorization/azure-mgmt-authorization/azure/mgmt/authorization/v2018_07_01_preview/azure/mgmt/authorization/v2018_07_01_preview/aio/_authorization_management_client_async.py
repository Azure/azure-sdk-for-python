...
from .operations_async import DenyAssignmentsOperations
from .. import models
...
class AuthorizationManagementClient(object):
    ...
    :vartype deny_assignments: azure.mgmt.authorization.v2018_07_01_preview.aio.operations_async.DenyAssignmentsOperations
