...
class AuthorizationManagementClient:
    ...
    :vartype deny_assignments:
     azure.mgmt.authorization.v2018_07_01_preview.operations.DenyAssignmentsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.deny_assignments = DenyAssignmentsOperations(self._client, self._config, self._serialize, self._deserialize)
