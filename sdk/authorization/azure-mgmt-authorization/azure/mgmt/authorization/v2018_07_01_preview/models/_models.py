...
class DenyAssignmentProperties(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'permissions': {'key': 'permissions', 'type': '[DenyAssignmentPermission]'},
        'scope': {'key': 'scope', 'type': 'str'},
        'do_not_apply_to_child_scopes': {'key': 'doNotApplyToChildScopes', 'type': 'bool'},
        'principals': {'key': 'principals', 'type': '[Principal]'},
        'exclude_principals': {'key': 'excludePrincipals', 'type': '[Principal]'},
        'is_system_protected': {'key': 'isSystemProtected', 'type': 'bool'},
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(DenyAssignmentProperties, self).__init__(**kwargs)
        self.deny_assignment_name = kwargs.get('deny_assignment_name', None)
        self.description = kwargs.get('description', None)
        self.permissions = kwargs.get('permissions', None)
        self.scope = kwargs.get('scope', None)
