...
class DenyAssignmentsOperations:
    ...
    def list_for_resource(
        ...
        **kwargs
    ) -> "models.DenyAssignmentListResult":
     ...
     assignment name and description properties are returned.
        ...
        :return: DenyAssignmentListResult or the result of cls(response)
        :rtype: ~azure.mgmt.authorization.v2018_07_01_preview.models.DenyAssignmentListResult
