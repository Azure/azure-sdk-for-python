...
class RoleAssignmentCreateParameters(Model):
    ...
    def __init__(self, *, role_definition_id: str, principal_id: str, principal_type="User", can_delegate: bool=None, description: str=None, condition: str=None, condition_version: str=None, delegated_managed_identity_resource_id: str=None, **kwargs) -> None:
