...
class AccessReviewDecision(Model):
    """Access Review.
    ...
    :vartype type: str
    :ivar id1: The id of principal whose access was reviewed.
    :vartype id1: str
    :ivar display_name: The display name of the user whose access was
     reviewed.
    :vartype display_name: str
    :ivar id2: The id of resource associated with a decision record.
    :vartype id2: str
    :ivar display_name1: The display name of resource associated with a
     decision record.
    :vartype display_name1: str
    :ivar recommendation: The feature- generated recommendation shown to the
     reviewer. Possible values include: 'Approve', 'Deny', 'NoInfoAvailable'
    ...
    :param decision: The decision on the approval step. This value is
     initially set to NotReviewed. Approvers can take action of Approve/Deny.
     Possible values include: 'Approve', 'Deny', 'NotReviewed', 'DontKnow',
     'NotNotified'
    ...
    :vartype reviewed_date_time: datetime
    :ivar principal_id: The identity id
    :vartype principal_id: str
    :ivar principal_type: The identity type : user/servicePrincipal. Possible
     values include: 'user', 'servicePrincipal'
    ...
    :ivar apply_result: The outcome of applying the decision. Possible values
     include: 'New', 'Applying', 'AppliedSuccessfully',
     'AppliedWithUnknownFailure', 'AppliedSuccessfullyButObjectNotFound',
     'ApplyNotSupported'
    :vartype apply_result: str or
     ~azure.mgmt.authorization.v2021_03_01_preview.models.AccessReviewApplyResult
    :ivar applied_date_time: The date and time when the review decision was
     applied.
    :vartype applied_date_time: datetime
    :ivar principal_id1: The identity id
    :vartype principal_id1: str
    :ivar principal_type1: The identity type : user/servicePrincipal. Possible
     values include: 'user', 'servicePrincipal'
    :vartype principal_type1: str or
     ~azure.mgmt.authorization.v2021_03_01_preview.models.AccessReviewActorIdentityType
    :ivar principal_name1: The identity display name
    :vartype principal_name1: str
    :ivar user_principal_name1: The user principal name(if valid)
    :vartype user_principal_name1: str
    """
    ...
    _validation = {
        ...
        'principal_id1': {'readonly': True},
        'principal_type1': {'readonly': True},
        'principal_name1': {'readonly': True},
        'user_principal_name1': {'readonly': True},
    }
    ...
    _attribute_map = {
        ...
        'id1': {'key': 'properties.principal.id', 'type': 'str'},
        'display_name': {'key': 'properties.principal.displayName', 'type': 'str'},
        'id2': {'key': 'properties.resource.id', 'type': 'str'},
        'display_name1': {'key': 'properties.resource.displayName', 'type': 'str'},
        ...
        'principal_id1': {'key': 'properties.appliedBy.principalId', 'type': 'str'},
        'principal_type1': {'key': 'properties.appliedBy.principalType', 'type': 'str'},
        'principal_name1': {'key': 'properties.appliedBy.principalName', 'type': 'str'},
        'user_principal_name1': {'key': 'properties.appliedBy.userPrincipalName', 'type': 'str'},
    }

    def __init__(self, *, decision=None, justification: str=None, **kwargs) -> None:
        ...
        self.principal_id1 = None
        self.principal_type1 = None
        self.principal_name1 = None
        self.user_principal_name1 = None


class AccessReviewDecisionIdentity(Model):
    """Target of the decision.

    You probably want to use the sub-classes and not this class directly. Known
    sub-classes are: AccessReviewDecisionUserIdentity,
    ...
    _subtype_map = {
        'type': {'user': 'AccessReviewDecisionUserIdentity', 'servicePrincipal': 'AccessReviewDecisionServicePrincipalIdentity'}
    }
...
class AccessReviewDecisionProperties(Model):
    """Approval Step.
    ...
    :ivar display_name: The display name of the user whose access was
     reviewed.
    :vartype display_name: str
    :ivar id1: The id of resource associated with a decision record.
    :vartype id1: str
    :ivar display_name1: The display name of resource associated with a
     decision record.
    :vartype display_name1: str
    ...
    _attribute_map = {
        'id': {'key': 'principal.id', 'type': 'str'},
        'display_name': {'key': 'principal.displayName', 'type': 'str'},
        'id1': {'key': 'resource.id', 'type': 'str'},
        'display_name1': {'key': 'resource.displayName', 'type': 'str'},
        ...
        'principal_id1': {'key': 'appliedBy.principalId', 'type': 'str'},
        'principal_type1': {'key': 'appliedBy.principalType', 'type': 'str'},
        'principal_name1': {'key': 'appliedBy.principalName', 'type': 'str'},
        'user_principal_name1': {'key': 'appliedBy.userPrincipalName', 'type': 'str'},
    }
...
class AccessReviewDecisionUserIdentity(AccessReviewDecisionIdentity):
    ...
    :param type: Required. Constant filled by server.
    :type type: str
    :ivar user_principal_name: The user principal name of the user whose
     access was reviewed.
    :vartype user_principal_name: str
    """
...
class AccessReviewDefaultSettings(Model):
    """Access Review Default Settings.

    Variables are only populated by the server, and will be ignored when
    sending a request.

    :ivar id: The access review default settings id. This is only going to be
     default
    :vartype id: str
    :ivar name: The access review default settings name. This is always going
     to be Access Review Default Settings
    :vartype name: str
    :ivar type: The resource type.
    :vartype type: str
    :param mail_notifications_enabled: Flag to indicate whether sending mails
     to reviewers and the review creator is enabled.
    :type mail_notifications_enabled: bool
    :param reminder_notifications_enabled: Flag to indicate whether sending
     reminder emails to reviewers are enabled.
    :type reminder_notifications_enabled: bool
    :param default_decision_enabled: Flag to indicate whether reviewers are
     required to provide a justification when reviewing access.
    :type default_decision_enabled: bool
    :param justification_required_on_approval: Flag to indicate whether the
     reviewer is required to pass justification when recording a decision.
    :type justification_required_on_approval: bool
    :param default_decision: This specifies the behavior for the autoReview
     feature when an access review completes. Possible values include:
    ...
    :param auto_apply_decisions_enabled: Flag to indicate whether auto-apply
     capability, to automatically change the target object access resource, is
     enabled. If not enabled, a user must, after the review completes, apply
     the access review.
    :type auto_apply_decisions_enabled: bool
    :param recommendations_enabled: Flag to indicate whether showing
     recommendations to reviewers is enabled.
    ...
    :param type1: The recurrence type : weekly, monthly, etc. Possible values
     include: 'weekly', 'absoluteMonthly'
    :type type1: str or
     ~azure.mgmt.authorization.v2021_03_01_preview.models.AccessReviewRecurrencePatternType
    :param interval: The interval for recurrence. For a quarterly review, the
     interval is 3 for type : absoluteMonthly.
    :type interval: int
    :param type2: The recurrence range type. The possible values are: endDate,
    ...
    :param number_of_occurrences: The number of times to repeat the access
     review. Required and must be positive if type is numbered.
    :type number_of_occurrences: int
    :param start_date: The DateTime when the review is scheduled to be start.
     This could be a date in the future. Required on create.
    :type start_date: datetime
    :param end_date: The DateTime when the review is scheduled to end.
    ...
    _attribute_map = {
        ...
        'type1': {'key': 'properties.recurrence.pattern.type', 'type': 'str'},
        'interval': {'key': 'properties.recurrence.pattern.interval', 'type': 'int'},
        'type2': {'key': 'properties.recurrence.range.type', 'type': 'str'},
...
class AccessReviewInstance(Model):
    ...
    :ivar type: The resource type.
    :vartype type: str
    :ivar status: This read-only field specifies the status of an access
     review instance. Possible values include: 'NotStarted', 'InProgress',
    ...
    :param start_date_time: The DateTime when the review instance is scheduled
     to be start.
    :type start_date_time: datetime
    :param end_date_time: The DateTime when the review instance is scheduled
     to end.
    ...
    def __init__(self, *, start_date_time=None, end_date_time=None, **kwargs) -> None:
...
class AccessReviewReviewer(Model):
...
class AccessReviewScheduleDefinition(Model):
    ...
    :ivar status: This read-only field specifies the status of an
     accessReview. Possible values include: 'NotStarted', 'InProgress',
     'Completed', 'Applied', 'Initializing', 'Applying', 'Completing',
     'Scheduled', 'AutoReviewing', 'AutoReviewed', 'Starting'
    :vartype status: str or
     ~azure.mgmt.authorization.v2021_03_01_preview.models.AccessReviewScheduleDefinitionStatus
    :param description_for_admins: The description provided by the access
     review creator and visible to admins.
    :type description_for_admins: str
    :param description_for_reviewers: The description provided by the access
     review creator to be shown to reviewers.
    ...
    :ivar principal_type1: The identity type user/servicePrincipal to review.
    ...
    :type backup_reviewers:
     list[~azure.mgmt.authorization.v2021_03_01_preview.models.AccessReviewReviewer]
    :ivar reviewers_type: This field specifies the type of reviewers for a
     review. Usually for a review, reviewers are explicitly assigned. However,
     in some cases, the reviewers may not be assigned and instead be chosen
     dynamically. For example managers review or self review. Possible values
     include: 'Assigned', 'Self', 'Managers'
    ...
    :param instances: This is the collection of instances returned when one
    ...
    _attribute_map = {
        ...
        'type1': {'key': 'properties.settings.recurrence.pattern.type', 'type': 'str'},
        'interval': {'key': 'properties.settings.recurrence.pattern.interval', 'type': 'int'},
        'type2': {'key': 'properties.settings.recurrence.range.type', 'type': 'str'},
        ...
        'principal_type1': {'key': 'properties.scope.principalType', 'type': 'str'},
    ...
    def __init__(self, *, display_name: str=None, description_for_admins: str=None, description_for_reviewers: str=None, mail_notifications_enabled: bool=None, reminder_notifications_enabled: bool=None, default_decision_enabled: bool=None, justification_required_on_approval: bool=None, default_decision=None, auto_apply_decisions_enabled: bool=None, recommendations_enabled: bool=None, instance_duration_in_days: int=None, type1=None, interval: int=None, type2=None, number_of_occurrences: int=None, start_date=None, end_date=None, reviewers=None, backup_reviewers=None, instances=None, **kwargs) -> None:
...
class AccessReviewScheduleDefinitionProperties(Model):
    """Access Review.
    ...
    :param instance_duration_in_days: The duration in days for an instance.
    :type instance_duration_in_days: int
    :param type: The recurrence type : weekly, monthly, etc. Possible values
     include: 'weekly', 'absoluteMonthly'
    :type type: str or
     ~azure.mgmt.authorization.v2021_03_01_preview.models.AccessReviewRecurrencePatternType
    :param interval: The interval for recurrence. For a quarterly review, the
     interval is 3 for type : absoluteMonthly.
    :type interval: int
    :param type1: The recurrence range type. The possible values are: endDate,
     noEnd, numbered. Possible values include: 'endDate', 'noEnd', 'numbered'
    :type type1: str or
     ~azure.mgmt.authorization.v2021_03_01_preview.models.AccessReviewRecurrenceRangeType
    :param number_of_occurrences: The number of times to repeat the access
    ...
    _attribute_map = {
        ...
        'type': {'key': 'settings.recurrence.pattern.type', 'type': 'str'},
        'interval': {'key': 'settings.recurrence.pattern.interval', 'type': 'int'},
        'type1': {'key': 'settings.recurrence.range.type', 'type': 'str'},
        ...
        'principal_type1': {'key': 'scope.principalType', 'type': 'str'},
...
class AccessReviewScheduleSettings(Model):
    ...
    :param instance_duration_in_days: The duration in days for an instance.
    :type instance_duration_in_days: int
    :param recurrence: Access Review Settings.
    :type recurrence:
     ~azure.mgmt.authorization.v2021_03_01_preview.models.AccessReviewRecurrenceSettings
    """
    ...
    _attribute_map = {
        ...
        'recurrence': {'key': 'recurrence', 'type': 'AccessReviewRecurrenceSettings'},
    }
...
class ErrorDefinitionException(HttpOperationError):
    ...
    def __init__(self, deserialize, response, *args):
        ...
        super(ErrorDefinitionException, self).__init__(deserialize, response, 'ErrorDefinition', *args)


class ErrorDefinitionProperties(Model):
    """Error.
...
class Operation(Model):
    ...
    :type display:
     ~azure.mgmt.authorization.v2021_03_01_preview.models.OperationDisplay
