...
try:
    ...
    from ._models import AccessReviewDecisionIdentity
    from ._models import AccessReviewDecisionProperties
    from ._models import AccessReviewDecisionServicePrincipalIdentity
    from ._models import AccessReviewDecisionUserIdentity
