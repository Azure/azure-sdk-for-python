...
class RoleDefinitionsOperations:
    ...
    def list(
        ...
        **kwargs
    ) -> "models.RoleDefinitionListResult":
     ...
     the given scope as well.
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: RoleDefinitionListResult or the result of cls(response)
        :rtype: ~azure.mgmt.authorization.v2018_01_01_preview.models.RoleDefinitionListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
