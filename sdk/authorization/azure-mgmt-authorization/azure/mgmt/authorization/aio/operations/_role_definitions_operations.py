...
class RoleDefinitionsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type role_definition: ~azure.mgmt.authorization.models.RoleDefinition or IO[bytes]
        :return: RoleDefinition or the result of cls(response)
        :rtype: ~azure.mgmt.authorization.models.RoleDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def list(self, scope: str, filter: Optional[str] = None, **kwargs: Any) -> AsyncItemPaged["_models.RoleDefinition"]:
