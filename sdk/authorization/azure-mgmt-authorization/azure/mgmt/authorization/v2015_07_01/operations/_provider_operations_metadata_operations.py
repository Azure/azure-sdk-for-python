...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Authorization/providerOperations/{resourceProviderNamespace}')
...
def build_list_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Authorization/providerOperations')
...
class ProviderOperationsMetadataOperations(object):
    ...
    def list(
        ...
        expand: Optional[str] = "resourceTypes",
        **kwargs: Any
    ) -> Iterable["_models.ProviderOperationsMetadataListResult"]:
        """Gets provider operations metadata for all resource providers.

        :param expand: Specifies whether to expand the values.
        :type expand: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ProviderOperationsMetadataListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.authorization.v2015_07_01.models.ProviderOperationsMetadataListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
