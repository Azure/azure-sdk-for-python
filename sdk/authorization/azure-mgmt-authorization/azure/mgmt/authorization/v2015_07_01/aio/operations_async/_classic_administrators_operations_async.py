...
class ClassicAdministratorsOperations:
    ...
    def list(
        self,
        **kwargs
    ) -> "models.ClassicAdministratorListResult":
        """Gets service administrator, account administrator, and co-administrators for the subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ClassicAdministratorListResult or the result of cls(response)
        :rtype: ~azure.mgmt.authorization.v2015_07_01.models.ClassicAdministratorListResult
