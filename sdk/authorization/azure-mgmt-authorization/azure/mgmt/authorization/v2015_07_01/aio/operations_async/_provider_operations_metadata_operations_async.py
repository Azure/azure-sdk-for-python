...
class ProviderOperationsMetadataOperations:
    ...
    def list(
        ...
        expand: Optional[str] = "resourceTypes",
        **kwargs
    ) -> "models.ProviderOperationsMetadataListResult":
        """Gets provider operations metadata for all resource providers.

        :param expand: Specifies whether to expand the values.
        :type expand: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ProviderOperationsMetadataListResult or the result of cls(response)
        :rtype: ~azure.mgmt.authorization.v2015_07_01.models.ProviderOperationsMetadataListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
