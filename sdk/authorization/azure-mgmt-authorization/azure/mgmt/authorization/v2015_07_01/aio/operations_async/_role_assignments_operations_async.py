...
class RoleAssignmentsOperations:
    ...
    def list_for_resource(
     ...
     assignments at, above or below the scope for the specified principal.
        ...
        :rtype: ~azure.mgmt.authorization.v2015_07_01.models.RoleAssignmentListResult
    ...
    async def create(
        ...
        scope: str,
        role_assignment_name: str,
        properties: "models.RoleAssignmentProperties",
        **kwargs
    ) -> "models.RoleAssignment":
        ...
        _parameters = models.RoleAssignmentCreateParameters(properties=properties)
        api_version = "2015-07-01"
        ...
        body_content = self._serialize.body(_parameters, 'RoleAssignmentCreateParameters')
