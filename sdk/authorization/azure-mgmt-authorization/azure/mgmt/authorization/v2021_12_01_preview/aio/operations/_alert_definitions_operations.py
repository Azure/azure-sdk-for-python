...
class AlertDefinitionsOperations:
    ...
    async def get(self, scope: str, alert_definition_id: str, **kwargs: Any) -> _models.AlertDefinition:
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.AlertDefinition]
    ...
    get.metadata = {"url": "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alertDefinitions/{alertDefinitionId}"}  # type: ignore
    ...
    def list_for_scope(self, scope: str, **kwargs: Any) -> AsyncIterable["_models.AlertDefinition"]:
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", "2022-08-01-preview"))  # type: str
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.AlertDefinitionListResult]
    ...
    list_for_scope.metadata = {"url": "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alertDefinitions"}  # type: ignore
