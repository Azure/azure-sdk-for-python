...
def build_get_request(scope: str, operation_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/operations/{operationId}"
...
def build_list_for_scope_request(scope: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/operations")
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
    }
...
class AlertOperationOperations:
    ...
    def get(self, scope: str, operation_id: str, **kwargs: Any) -> _models.AlertOperationResult:
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", "2022-08-01-preview"))  # type: str
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.AlertOperationResult]
    ...
    get.metadata = {"url": "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/operations/{operationId}"}  # type: ignore
    ...
    def list_for_scope(self, scope: str, **kwargs: Any) -> _models.AlertOperationListResult:
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", "2022-08-01-preview"))  # type: str
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.AlertOperationListResult]
    ...
    list_for_scope.metadata = {"url": "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/operations"}  # type: ignore
