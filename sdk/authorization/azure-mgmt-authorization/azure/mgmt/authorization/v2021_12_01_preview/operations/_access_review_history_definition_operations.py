...
class AccessReviewHistoryDefinitionOperations:
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :param history_definition_id: The id of the access review history definition. Required.
        :type history_definition_id: str
        :param properties: Access review history definition properties. Is either a model type or a IO
         type. Required.
        :type properties:
    ...
    create.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}"}  # type: ignore
    ...
    delete_by_id.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}"}  # type: ignore
