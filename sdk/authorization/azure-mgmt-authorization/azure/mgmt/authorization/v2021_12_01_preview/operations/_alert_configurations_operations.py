...
def build_get_request(scope: str, alert_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alertConfigurations/{alertId}"
...
def build_list_for_scope_request(scope: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alertConfigurations"
    )
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
    }
...
class AlertConfigurationsOperations:
    ...
    def get(self, scope: str, alert_id: str, **kwargs: Any) -> _models.AlertConfiguration:
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", "2022-08-01-preview"))  # type: str
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.AlertConfiguration]
    ...
    get.metadata = {"url": "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alertConfigurations/{alertId}"}  # type: ignore
    ...
    def update(
        ...
        :param alert_id: The name of the alert configuration to update. Required.
        :type alert_id: str
        :param parameters: Parameters for the alert configuration. Is either a model type or a IO type.
         Required.
    ...
    update.metadata = {"url": "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alertConfigurations/{alertId}"}  # type: ignore
    ...
    def list_for_scope(self, scope: str, **kwargs: Any) -> Iterable["_models.AlertConfiguration"]:
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", "2022-08-01-preview"))  # type: str
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.AlertConfigurationListResult]
    ...
    list_for_scope.metadata = {"url": "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alertConfigurations"}  # type: ignore
