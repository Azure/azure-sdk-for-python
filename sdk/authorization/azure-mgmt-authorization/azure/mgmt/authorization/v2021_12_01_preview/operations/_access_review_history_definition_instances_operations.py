...
class AccessReviewHistoryDefinitionInstancesOperations:
    ...
    def list(self, history_definition_id: str, **kwargs: Any) -> Iterable["_models.AccessReviewHistoryInstance"]:
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", "2021-12-01-preview"))  # type: str
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.AccessReviewHistoryDefinitionInstanceListResult]
    ...
    list.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}/instances"}  # type: ignore
