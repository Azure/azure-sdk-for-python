...
class Operation(Model):
    ...
    :type display:
     ~azure.mgmt.authorization.v2021_01_01_preview.models.OperationDisplay
    :param origin: Origin of the operation. Values include
...
class RoleAssignmentApproval(Model):
    ...
    :vartype type: str
    :param stages: This is the collection of stages returned when one does an
     expand on it.
    :type stages:
    ...
    def __init__(self, *, stages=None, **kwargs) -> None:
...
class RoleAssignmentApprovalStep(Model):
    ...
    :ivar status: This read-only field specifies the status of an approval.
     Possible values include: 'NotStarted', 'InProgress', 'Completed',
     'Expired', 'Initializing', 'Escalating', 'Completing', 'Escalated'
    :vartype status: str or
     ~azure.mgmt.authorization.v2021_01_01_preview.models.RoleAssignmentApprovalStepStatus
    :ivar assigned_to_me: Indicates whether the stage is assigned to me for
     review
    ...
    :param review_result: The decision on the approval stage. This value is
     initially set to NotReviewed. Approvers can take action of Approve/Deny.
     Possible values include: 'Approve', 'Deny', 'NotReviewed'
    ...
    def __init__(self, *, display_name: str=None, review_result=None, justification: str=None, **kwargs) -> None:
...
class RoleAssignmentApprovalStepListResult(Model):
...
class RoleAssignmentApprovalStepProperties(Model):
    """Approval Step.
