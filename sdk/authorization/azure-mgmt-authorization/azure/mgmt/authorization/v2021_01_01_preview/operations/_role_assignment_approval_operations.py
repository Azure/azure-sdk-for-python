...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Authorization/roleAssignmentApprovals')
...
def build_get_by_id_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Authorization/roleAssignmentApprovals/{approvalId}')
...
class RoleAssignmentApprovalOperations(object):
    ...
    def list(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.RoleAssignmentApprovalListResult"]:
        ...
        :return: An iterator like instance of either RoleAssignmentApprovalListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.authorization.v2021_01_01_preview.models.RoleAssignmentApprovalListResult]
