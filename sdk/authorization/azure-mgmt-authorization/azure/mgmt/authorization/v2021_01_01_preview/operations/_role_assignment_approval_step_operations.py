...
class RoleAssignmentApprovalStepOperations(object):
    ...
    def get_by_id(
            self, approval_id, stage_id, custom_headers=None, raw=False, **operation_config):
    ...
    def patch(
            self, approval_id, stage_id, properties, custom_headers=None, raw=False, **operation_config):
        """Record a decision.
