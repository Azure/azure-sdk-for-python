...
class ScopeRoleAssignmentApprovalStepOperations(object):
    ...
    def get_by_id(
            self, approval_id, stage_id, scope, custom_headers=None, raw=False, **operation_config):
        ...
        :return: RoleAssignmentApprovalStep or ClientRawResponse if raw=true
        :rtype:
         ~azure.mgmt.authorization.v2021_01_01_preview.models.RoleAssignmentApprovalStep
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('RoleAssignmentApprovalStep', response)
    ...
    def patch(
            self, approval_id, stage_id, properties, scope, custom_headers=None, raw=False, **operation_config):
        """Record a decision.
