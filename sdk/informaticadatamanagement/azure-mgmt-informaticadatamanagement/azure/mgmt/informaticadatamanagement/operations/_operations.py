...
def build_operations_list_request(**kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2025-11-27"))
...
class Operations:
    ...
    @distributed_trace
    def _list(self, **kwargs: Any) -> ItemPaged["_models._models.Operation"]:
...
class OrganizationsOperations:
    ...
    ) -> ItemPaged["_models.InformaticaOrganizationResource"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.InformaticaOrganizationResource"]:
...
class ServerlessRuntimesOperations:
    ...
    def list_by_informatica_organization_resource(  # pylint: disable=name-too-long
        self, resource_group_name: str, organization_name: str, **kwargs: Any
    ) -> ItemPaged["_models.InformaticaServerlessRuntimeResource"]:
