...
class Operations:
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: InformaticaDataMgmtClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
        self._serialize: Serializer = input_args.pop(0) if input_args else kwargs.pop("serializer")
        self._deserialize: Deserializer = input_args.pop(0) if input_args else kwargs.pop("deserializer")

    @distributed_trace
    def _list(self, **kwargs: Any) -> AsyncItemPaged["_models._models.Operation"]:
        """List the operations for the provider.

        :return: An iterator like instance of Operation
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.informaticadatamanagement.models._models.Operation]
        ...
        async def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(
                list[_models._models.Operation],
...
class OrganizationsOperations:
    ...
    async def _create_or_update_initial(
        ...
        resource: Union[_models.InformaticaOrganizationResource, _types.InformaticaOrganizationResource, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        resource_group_name: str,
        organization_name: str,
        resource: _types.InformaticaOrganizationResource,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.InformaticaOrganizationResource]:
        ...
        :type organization_name: str
        :param resource: Resource create parameters. Required.
        :type resource: ~azure.mgmt.informaticadatamanagement.types.InformaticaOrganizationResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns InformaticaOrganizationResource. The
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.informaticadatamanagement.models.InformaticaOrganizationResource or
         ~azure.mgmt.informaticadatamanagement.types.InformaticaOrganizationResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns InformaticaOrganizationResource. The
         InformaticaOrganizationResource is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.informaticadatamanagement.models.InformaticaOrganizationResource]
    ...
    async def update(
        ...
        resource_group_name: str,
        organization_name: str,
        properties: _types.InformaticaOrganizationResourceUpdate,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.InformaticaOrganizationResource:
        ...
        :param properties: The resource properties to be updated. Required.
        :type properties:
         ~azure.mgmt.informaticadatamanagement.types.InformaticaOrganizationResourceUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: InformaticaOrganizationResource. The InformaticaOrganizationResource is compatible
    ...
    async def update(
        ...
        organization_name: str,
        properties: Union[
            _models.InformaticaOrganizationResourceUpdate, _types.InformaticaOrganizationResourceUpdate, IO[bytes]
        ],
        **kwargs: Any
    ) -> _models.InformaticaOrganizationResource:
        """Update a InformaticaOrganizationResource.
        ...
        :type properties:
         ~azure.mgmt.informaticadatamanagement.models.InformaticaOrganizationResourceUpdate or
         ~azure.mgmt.informaticadatamanagement.types.InformaticaOrganizationResourceUpdate or IO[bytes]
        :return: InformaticaOrganizationResource. The InformaticaOrganizationResource is compatible
         with MutableMapping
        :rtype: ~azure.mgmt.informaticadatamanagement.models.InformaticaOrganizationResource
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_resource_group(
    ...
    ) -> AsyncItemPaged["_models.InformaticaOrganizationResource"]:
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                list[_models.InformaticaOrganizationResource],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.InformaticaOrganizationResource"]:
...
class ServerlessRuntimesOperations:
    ...
    async def _create_or_update_initial(
        ...
        resource: Union[
            _models.InformaticaServerlessRuntimeResource, _types.InformaticaServerlessRuntimeResource, IO[bytes]
        ],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
    ...
    async def begin_create_or_update(
        ...
        organization_name: str,
        serverless_runtime_name: str,
        resource: _types.InformaticaServerlessRuntimeResource,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.InformaticaServerlessRuntimeResource]:
        ...
        :param resource: Resource create parameters. Required.
        :type resource:
         ~azure.mgmt.informaticadatamanagement.types.InformaticaServerlessRuntimeResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns InformaticaServerlessRuntimeResource. The
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param serverless_runtime_name: Name of the Serverless Runtime resource. Required.
        :type serverless_runtime_name: str
        :param resource: Resource create parameters. Is either a InformaticaServerlessRuntimeResource
         type or a IO[bytes] type. Required.
        :type resource:
         ~azure.mgmt.informaticadatamanagement.models.InformaticaServerlessRuntimeResource or
         ~azure.mgmt.informaticadatamanagement.types.InformaticaServerlessRuntimeResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns InformaticaServerlessRuntimeResource. The
         InformaticaServerlessRuntimeResource is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.informaticadatamanagement.models.InformaticaServerlessRuntimeResource]
    ...
    def list_by_informatica_organization_resource(  # pylint: disable=name-too-long
        self, resource_group_name: str, organization_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.InformaticaServerlessRuntimeResource"]:
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                list[_models.InformaticaServerlessRuntimeResource],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
    ...
    async def update(
        ...
        organization_name: str,
        serverless_runtime_name: str,
        properties: _types.InformaticaServerlessRuntimeResourceUpdate,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.InformaticaServerlessRuntimeResource:
        ...
        :param properties: The resource properties to be updated. Required.
        :type properties:
         ~azure.mgmt.informaticadatamanagement.types.InformaticaServerlessRuntimeResourceUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: InformaticaServerlessRuntimeResource. The InformaticaServerlessRuntimeResource is
    ...
    async def update(
        ...
        serverless_runtime_name: str,
        properties: Union[
            _models.InformaticaServerlessRuntimeResourceUpdate,
            _types.InformaticaServerlessRuntimeResourceUpdate,
            IO[bytes],
        ],
        **kwargs: Any
    ) -> _models.InformaticaServerlessRuntimeResource:
        ...
        :type properties:
         ~azure.mgmt.informaticadatamanagement.models.InformaticaServerlessRuntimeResourceUpdate or
         ~azure.mgmt.informaticadatamanagement.types.InformaticaServerlessRuntimeResourceUpdate or
         IO[bytes]
        :return: InformaticaServerlessRuntimeResource. The InformaticaServerlessRuntimeResource is
         compatible with MutableMapping
        :rtype: ~azure.mgmt.informaticadatamanagement.models.InformaticaServerlessRuntimeResource
