...
class InformaticaDataMgmtClient:
    ...
    :vartype operations: azure.mgmt.informaticadatamanagement.operations.Operations
    :ivar organizations: OrganizationsOperations operations
    :vartype organizations: azure.mgmt.informaticadatamanagement.operations.OrganizationsOperations
    ...
    :keyword api_version: The API version to use for this operation. Known values are "2025-11-27"
