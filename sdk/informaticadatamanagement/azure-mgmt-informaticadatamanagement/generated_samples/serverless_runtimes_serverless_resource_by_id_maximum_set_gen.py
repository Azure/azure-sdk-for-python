...
# USAGE
    python serverless_runtimes_serverless_resource_by_id_maximum_set_gen.py
...
def main():
    ...
    response = client.serverless_runtimes.serverless_resource_by_id(
        resource_group_name="rgopenapi",
        organization_name="_RD_R",
        serverless_runtime_name="serverlessRuntimeName159",
    )
    print(response)
