...
# USAGE
    python serverless_runtimes_start_failed_serverless_runtime_maximum_set_gen.py
...
def main():
    ...
    client.serverless_runtimes.start_failed_serverless_runtime(
        resource_group_name="rgopenapi",
        organization_name="9M4",
        serverless_runtime_name="-25-G_",
    )
