...
class MessageSeverity(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class PreviewType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class QueryState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class SamplingTypeProjection(str, Enum, metaclass=CaseInsensitiveEnumMeta):
