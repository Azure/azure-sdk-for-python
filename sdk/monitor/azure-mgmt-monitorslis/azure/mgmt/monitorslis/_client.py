...
from .operations import SlisOperations, SloViewOperations
...
class MonitorClient:
    ...
    :ivar slo_view: SloViewOperations operations
    :vartype slo_view: azure.mgmt.monitorslis.operations.SloViewOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.slo_view = SloViewOperations(self._client, self._config, self._serialize, self._deserialize)
