...
_APPLICATIONINSIGHTS_CUSTOMMETRICS_KUSTO_ENABLED = "APPLICATIONINSIGHTS_CUSTOMMETRICS_KUSTO_ENABLED"
...
_CUSTOM_METRICS_KUSTO_ENABLED_ARG = "custom_metrics_kusto_enabled"
