...
class MonitorBase(_Model):
    ...
    :ivar base_data: The data payload for the telemetry request. Is one of the following types:
    ...
    :vartype base_data: ~exporter.models.AvailabilityData or ~exporter.models.TelemetryEventData or
     ~exporter.models.TelemetryExceptionData or ~exporter.models.MessageData or
     ~exporter.models.MetricsData or ~exporter.models.PageViewData or
     ~exporter.models.PageViewPerfData or ~exporter.models.RemoteDependencyData or
     ~exporter.models.RequestData
    """
    ...
    """Name of item (B section) if any. If telemetry data is derived straight from this, this should
     be null."""
    base_data: Optional["_types.DomainUnion"] = rest_field(
        name="baseData", visibility=["read", "create", "update", "delete", "query"]
    )
    """The data payload for the telemetry request. Is one of the following types: AvailabilityData,
     TelemetryEventData, TelemetryExceptionData, MessageData, MetricsData, PageViewData,
     PageViewPerfData, RemoteDependencyData, RequestData"""
    ...
    def __init__(
        ...
        *,
        ...
        base_data: Optional["_types.DomainUnion"] = None,
    ) -> None: ...
