...
class RequestData(MonitorDomain, discriminator="RequestData"):
    ...
    kind: Literal[MonitorDomainKind.REQUEST_DATA] = rest_discriminator(name="kind", visibility=["read"])  # type: ignore
    """Discriminator value for RequestData. Required. RequestData type."""
    id: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Identifier of a request call instance. Used for correlation between request and other telemetry
     items. Required."""
    name: Optional[str] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Name of the request. Represents code path taken to process request. Low cardinality value to
     allow better grouping of requests. For HTTP requests it represents the HTTP method and URL path
     template like 'GET /values/{id}'."""
    duration: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Request duration in format: DD.HH:MM:SS.MMMMMM. Must be less than 1000 days. Required."""
    success: bool = rest_field(visibility=["read", "create", "update", "delete", "query"])
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.kind = MonitorDomainKind.REQUEST_DATA  # type: ignore
...
class TelemetryEventData(MonitorDomain, discriminator="EventData"):
    ...
    :ivar version: Schema version. Required.
    :vartype version: int
    :ivar kind: Discriminator value for EventData. Required. EventData type.
    :vartype kind: str or ~exporter.models.EVENT_DATA
    :ivar name: Event name. Keep it low cardinality to allow proper grouping and useful metrics.
     Required.
    :vartype name: str
    :ivar properties: Collection of custom properties.
    ...
    kind: Literal[MonitorDomainKind.EVENT_DATA] = rest_discriminator(name="kind", visibility=["read"])  # type: ignore
    """Discriminator value for EventData. Required. EventData type."""
    name: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Event name. Keep it low cardinality to allow proper grouping and useful metrics. Required."""
    properties: Optional[dict[str, str]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Collection of custom properties."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.kind = MonitorDomainKind.EVENT_DATA  # type: ignore


class TelemetryExceptionData(MonitorDomain, discriminator="ExceptionData"):
    ...
    :ivar version: Schema version. Required.
    :vartype version: int
    :ivar kind: Discriminator value for ExceptionData. Required. ExceptionData type.
    :vartype kind: str or ~exporter.models.EXCEPTION_DATA
    ...
    :ivar severity_level: Severity level. Mostly used to indicate exception severity level when it
     is reported by logging library. Known values are: "Verbose", "Information", "Warning", "Error",
     and "Critical".
    :vartype severity_level: str or ~exporter.models.SeverityLevel
    ...
    kind: Literal[MonitorDomainKind.EXCEPTION_DATA] = rest_discriminator(name="kind", visibility=["read"])  # type: ignore
    """Discriminator value for ExceptionData. Required. ExceptionData type."""
    ...
    """Severity level. Mostly used to indicate exception severity level when it is reported by logging
     library. Known values are: \"Verbose\", \"Information\", \"Warning\", \"Error\", and
     \"Critical\"."""
    problem_id: Optional[str] = rest_field(name="problemId", visibility=["read", "create", "update", "delete", "query"])
    """Identifier of where the exception was thrown in code. Used for exceptions grouping. Typically a
     combination of exception type and a function from the call stack."""
    properties: Optional[dict[str, str]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Collection of custom properties."""
    measurements: Optional[dict[str, float]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Collection of custom measurements."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.kind = MonitorDomainKind.EXCEPTION_DATA  # type: ignore
...
class TelemetryExceptionDetails(_Model):
    ...
    """In case exception is nested (outer exception contains inner one), the id and outerId properties
     are used to represent the nesting."""
    outer_id: Optional[int] = rest_field(name="outerId", visibility=["read", "create", "update", "delete", "query"])
    """The value of outerId is a reference to an element in ExceptionDetails that represents the outer
     exception."""
    ...
    """Indicates if full exception stack is provided in the exception. The stack may be trimmed, such
     as in the case of a StackOverflow exception."""
...
class TelemetryItem(_Model):
    ...
    :vartype name: str
    :ivar time: Event date time when telemetry item was created. This is the wall clock time on the
     client when the event was generated. There is no guarantee that the client's time is accurate.
     ...
     <https://en.wikipedia.org/wiki/ISO_8601#UTC>`_. Note: the number of decimal seconds digits
     provided are variable (and unspecified). Consumers should handle this, i.e. managed code
     consumers should not use format 'O' for parsing as it specifies a fixed length. Example:
     2009-06-15T13:45:30.0000000Z. Required.
    ...
    :ivar tags: Key/value collection of context properties. See ContextTagKeys for information on
    ...
    """Event date time when telemetry item was created. This is the wall clock time on the client when
     the event was generated. There is no guarantee that the client's time is accurate. This field
     must be formatted in UTC ISO 8601 format, with a trailing 'Z' character, as described publicly
     on `https://en.wikipedia.org/wiki/ISO_8601#UTC <https://en.wikipedia.org/wiki/ISO_8601#UTC>`_.
     Note: the number of decimal seconds digits provided are variable (and unspecified). Consumers
     should handle this, i.e. managed code consumers should not use format 'O' for parsing as it
    ...
    """Sampling rate used in application. This telemetry item represents 100 / sampleRate actual
     telemetry items."""
