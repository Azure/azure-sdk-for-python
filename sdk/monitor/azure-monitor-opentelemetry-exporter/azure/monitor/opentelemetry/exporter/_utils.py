...
def categorize_exception_message(exception_message: str) -> str:
    ...
    exception_categories = {
        "timeout_exception": ["timeout", "timed out"],
        "network_exception": ["network", "connection"],
        "auth_exception": ["auth", "authentication", "forbidden"],
        "parse_exception": ["parse", "parsing", "invalid"],
        "storage_exception": ["disk", "storage", "file"],
        "memory_exception": ["memory", "out of memory"],
    }
