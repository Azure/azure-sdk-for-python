...
class TestCustomerSdkStatsManager(unittest.TestCase):
    ...
    @patch("azure.monitor.opentelemetry.exporter.statsbeat.customer._manager.PeriodicExportingMetricReader")
    @patch("azure.monitor.opentelemetry.exporter.statsbeat.customer._manager.MeterProvider")
    def test_initialize_with_credential(self, mock_meter_provider, mock_metric_reader, mock_exporter): # pylint: disable=unused-argument
    ...
    @patch("azure.monitor.opentelemetry.exporter.statsbeat.customer._manager.PeriodicExportingMetricReader")
    @patch("azure.monitor.opentelemetry.exporter.statsbeat.customer._manager.MeterProvider")
    def test_initialize_without_credential(self, mock_meter_provider, mock_metric_reader, mock_exporter): # pylint: disable=unused-argument
