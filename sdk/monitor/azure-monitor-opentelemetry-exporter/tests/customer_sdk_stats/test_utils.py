...
class TestCustomerSdkStatsUtils(unittest.TestCase):
    ...
    def _create_test_envelopes(self):
        ...
        event_monitor_base = MonitorBase(
            base_type="EventData",
        ...
        failed_dependency_monitor_base = MonitorBase(
            base_type="RemoteDependencyData",
            base_data=failed_dependency_data
        )
    ...
    @mock.patch('azure.monitor.opentelemetry.exporter.statsbeat.customer._utils.get_local_storage_setup_state_exception')
    @mock.patch('azure.monitor.opentelemetry.exporter.statsbeat.customer._utils.track_dropped_items')
