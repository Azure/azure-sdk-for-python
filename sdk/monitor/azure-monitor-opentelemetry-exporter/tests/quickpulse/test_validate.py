...
class TestValidate(unittest.TestCase):
    ...
    @mock.patch(
        "azure.monitor.opentelemetry.exporter._quickpulse._validate._validate_filter_predicate_and_comparand"
    )
    @mock.patch(
        "azure.monitor.opentelemetry.exporter._quickpulse._validate._validate_filter_field_name"
    )
