...
class TestProjection(unittest.TestCase):
    @mock.patch(
        "azure.monitor.opentelemetry.exporter._quickpulse._projection._set_quickpulse_projection_map"
    )
    def test_init_derived_metric_projection(self, set_map_mock):
        ...
        set_map_mock.assert_called_once_with(
            "mock_id", AggregationType.MIN, _QUICKPULSE_PROJECTION_MAX_VALUE, 0
        )
    ...
    @mock.patch(
        "azure.monitor.opentelemetry.exporter._quickpulse._projection._calculate_aggregation"
    )
    ...
    @mock.patch(
        "azure.monitor.opentelemetry.exporter._quickpulse._projection._get_quickpulse_projection_map"
    )
