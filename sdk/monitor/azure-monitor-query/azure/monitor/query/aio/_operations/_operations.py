...
from ..._operations._operations import (
    build_monitor_query_logs_batch_request,
    build_monitor_query_logs_execute_request,
    build_monitor_query_logs_execute_with_resource_id_request,
)
...
class _MonitorQueryLogsClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], MonitorQueryLogsClientConfiguration]
):
    ...
    @overload
    async def _execute_with_resource_id(
        self,
        resource_id: str,
        body: _models._models.QueryBody,
        *,
