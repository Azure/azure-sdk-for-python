...
from typing import Any, cast, Tuple, Union, Sequence, Dict, List, Optional, MutableMapping, TYPE_CHECKING
...
if TYPE_CHECKING:
    from azure.core.credentials_async import AsyncTokenCredential  # pylint: disable=unused-import


__all__: List[str] = ["LogsQueryClient"]
...
class LogsQueryClient(GeneratedClient):
    ...
    async def query_workspace(
        ...
        **kwargs: Any,
        ...
        try:
            generated_response = await self._execute(workspace_id=workspace_id, body=body, prefer=prefer, **kwargs)
    ...
    async def query_batch(
        ...
        **NOTE**: The response is returned in the same order as that of the requests sent.
        ...
        generated = await self._batch(batch, **kwargs)
    ...
    async def query_resource(
        ...
        **kwargs: Any,
        ...
        generated_response: JSON = {}
        try:
            generated_response = await self._execute_with_resource_id(
