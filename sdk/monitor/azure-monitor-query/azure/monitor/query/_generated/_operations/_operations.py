...
class _MonitorQueryLogsClientOperationsMixin(
    ...
    def execute(
        ...
        **kwargs: Any
        ...
        :param body: The Analytics query. Learn more about the
         ...
         Required.
        :type body: ~azure.monitor.query._generated.models.QueryBody
        ...
        :rtype: ~azure.monitor.query._generated.models.QueryResults
    ...
    def execute(
        self,
        workspace_id: str,
        body: Union[_models.QueryBody, JSON, IO[bytes]],
        *,
        prefer: Optional[str] = None,
        **kwargs: Any
    ) -> _models.QueryResults:
        ...
        :type body: ~azure.monitor.query._generated.models.QueryBody or JSON or IO[bytes]
        :keyword prefer: Optional. The prefer header to set server timeout, query statistics and
         visualization information. Default value is None.
        :paramtype prefer: str
        :return: QueryResults. The QueryResults is compatible with MutableMapping
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.QueryResults, response.json())
    ...
    @overload
    def batch(
        self, body: _models.BatchRequest, *, content_type: str = "application/json", **kwargs: Any
        ...
        :type body: ~azure.monitor.query._generated.models.BatchRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: BatchResponse. The BatchResponse is compatible with MutableMapping
        :rtype: ~azure.monitor.query._generated.models.BatchResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """

    @overload
    def batch(self, body: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models.BatchResponse:
        """Execute a batch of Analytics queries.
    ...
    @overload
    def batch(self, body: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> _models.BatchResponse:
        """Execute a batch of Analytics queries.
    ...
    @distributed_trace
    def batch(self, body: Union[_models.BatchRequest, JSON, IO[bytes]], **kwargs: Any) -> _models.BatchResponse:
        """Execute a batch of Analytics queries.
        ...
        :param body: The batch request body. Is one of the following types: BatchRequest, JSON,
         IO[bytes] Required.
        :type body: ~azure.monitor.query._generated.models.BatchRequest or JSON or IO[bytes]
        :return: BatchResponse. The BatchResponse is compatible with MutableMapping
        :rtype: ~azure.monitor.query._generated.models.BatchResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("content-type", None))
        cls: ClsType[_models.BatchResponse] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.BatchResponse, response.json())
