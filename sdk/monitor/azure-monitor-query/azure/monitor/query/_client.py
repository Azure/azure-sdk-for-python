...
from ._generated._client import MonitorQueryLogsClient
from ._utils import (
    construct_iso8601,
    order_results,
    process_error,
...
class LogsQueryClient(object):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :keyword str audience: The audience to use when requesting tokens for Microsoft Entra ID. Defaults to the endpoint.
    :keyword str api_version: The service API version. Default value is "v1". Note that overriding this default value may
    ...
    def __init__(self, credential: TokenCredential, **kwargs: Any) -> None:
        ...
        self._client = MonitorQueryLogsClient(
    ...
    def query_workspace(
        ...
        **kwargs: Any,
        ...
        try:
            generated_response = self._client.execute(workspace_id=workspace_id, body=body, prefer=prefer, **kwargs)
    ...
    def query_batch(
        ...
        **NOTE**: The response is returned in the same order as that of the requests sent.
        ...
        generated = self._client.batch(batch, **kwargs)
