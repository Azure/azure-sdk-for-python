"""
Usage: python sample_send_logs_max_concurrency_async.py
"""
...
async def send_logs():
    ...
    response = await client.upload(rule_id=rule_id, stream_name=os.environ['LOGS_DCR_STREAM_NAME'], logs=body, max_concurrency=3)
