...
class _MonitorQueryLogsClientOperationsMixin(
    ...
    async def execute(
        ...
        **kwargs: Any
        ...
        :param body: The Analytics query. Learn more about the `Analytics query
         ...
         Required.
        :type body: ~azure.monitor.querylogs._generated.models.QueryBody
        ...
        :rtype: ~azure.monitor.querylogs._generated.models.QueryResults
    ...
    async def execute(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.monitor.querylogs._generated.models.QueryBody or JSON or IO[bytes]
        :keyword prefer: Optional. The prefer header to set server timeout, query statistics and
         visualization information. Default value is None.
        :paramtype prefer: str
        :return: QueryResults. The QueryResults is compatible with MutableMapping
    ...
    @overload
    async def execute_with_resource_id(
        self,
        resource_id: str,
        body: _models.QueryBody,
        *,
    ...
    async def batch(
        ...
        :type body: ~azure.monitor.querylogs._generated.models.BatchRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: BatchResponse. The BatchResponse is compatible with MutableMapping
        :rtype: ~azure.monitor.querylogs._generated.models.BatchResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def batch(self, body: Union[_models.BatchRequest, JSON, IO[bytes]], **kwargs: Any) -> _models.BatchResponse:
        """Execute a batch of Analytics queries.
        ...
        :param body: The batch request body. Is one of the following types: BatchRequest, JSON,
         IO[bytes] Required.
        :type body: ~azure.monitor.querylogs._generated.models.BatchRequest or JSON or IO[bytes]
        :return: BatchResponse. The BatchResponse is compatible with MutableMapping
        :rtype: ~azure.monitor.querylogs._generated.models.BatchResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
