...
class BatchQueryRequest(_Model):
    ...
    :ivar body: The Analytics query. Learn more about the `Analytics query
     syntax
     <https://azure.microsoft.com/documentation/articles/app-insights-analytics-reference/>`_.
     Required.
    :vartype body: ~azure.monitor.querylogs._generated.models.QueryBody
    :ivar path: The query path of a single request in a batch, defaults to /query. Default value is
     "/query".
    :vartype path: str
    :ivar method: The method of a single request in a batch, defaults to POST. Default value is
     "POST".
    :vartype method: str
    ...
    """Headers of the request. Can use prefer header to set server timeout and to
     query statistics and visualization information."""
    body: "_models.QueryBody" = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The Analytics query. Learn more about the `Analytics query
     syntax
     <https://azure.microsoft.com/documentation/articles/app-insights-analytics-reference/>`_.
     Required."""
    path: Optional[Literal["/query"]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The query path of a single request in a batch, defaults to /query. Default value is \"/query\"."""
    method: Optional[Literal["POST"]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The method of a single request in a batch, defaults to POST. Default value is \"POST\"."""
    ...
    def __init__(
        ...
        *,
        ...
        path: Optional[Literal["/query"]] = None,
        method: Optional[Literal["POST"]] = None,
    ) -> None: ...
...
class BatchQueryResponse(_Model):
    ...
    :vartype body: ~azure.monitor.querylogs._generated.models.BatchQueryResults
    ...
    body: Optional["_models.BatchQueryResults"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    ...
    def __init__(
        ...
        *,
        ...
        body: Optional["_models.BatchQueryResults"] = None,
        headers: Optional[Dict[str, str]] = None,
    ) -> None: ...
...
class BatchQueryResults(_Model):
    ...
    :vartype tables: list[~azure.monitor.querylogs._generated.models.Table]
    ...
    :vartype error: ~azure.monitor.querylogs._generated.models.ErrorInfo
    """

    tables: Optional[List["_models.Table"]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    ...
    def __init__(
        self,
        *,
        tables: Optional[List["_models.Table"]] = None,
...
class BatchRequest(_Model):
    ...
    :vartype requests: list[~azure.monitor.querylogs._generated.models.BatchQueryRequest]
    """

    requests: List["_models.BatchQueryRequest"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    ...
    def __init__(
        self,
        *,
        requests: List["_models.BatchQueryRequest"],
    ) -> None: ...
...
class BatchResponse(_Model):
    ...
    :vartype responses: list[~azure.monitor.querylogs._generated.models.BatchQueryResponse]
    """

    responses: Optional[List["_models.BatchQueryResponse"]] = rest_field(
    ...
    def __init__(
        self,
        *,
        responses: Optional[List["_models.BatchQueryResponse"]] = None,
    ) -> None: ...
...
class Column(_Model):
    ...
    :vartype type: str or ~azure.monitor.querylogs._generated.models.ColumnDataType
    """

    name: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The name of this column. Required."""
    type: Union[str, "_models.ColumnDataType"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    ...
    def __init__(
        ...
        *,
        name: str,
        type: Union[str, "_models.ColumnDataType"],
    ) -> None: ...
...
class ErrorInfo(_Model):
    ...
    :vartype details: list[~azure.monitor.querylogs._generated.models.ErrorDetail]
    :ivar innererror: Inner error details if they exist.
    :vartype innererror: ~azure.monitor.querylogs._generated.models.ErrorInfo
    ...
    """error details."""
    innererror: Optional["_models.ErrorInfo"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    ...
    def __init__(
        ...
        *,
        ...
        innererror: Optional["_models.ErrorInfo"] = None,
        additional_properties: Optional[Dict[str, Any]] = None,
    ) -> None: ...
...
class QueryResults(_Model):
    ...
    tables: List["_models.Table"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class Table(_Model):
    ...
    :vartype columns: list[~azure.monitor.querylogs._generated.models.Column]
    :ivar rows: The resulting rows from this query. Required.
    :vartype rows: list[list[dict[str, any]]]
    """

    name: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The name of the table. Required."""
    columns: List["_models.Column"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The list of columns in this table. Required."""
    rows: List[List[Dict[str, Any]]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
