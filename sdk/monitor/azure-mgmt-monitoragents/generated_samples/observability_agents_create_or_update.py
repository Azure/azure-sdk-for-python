...
# USAGE
    python observability_agents_create_or_update.py
    ...
    response = client.observability_agents.create_or_update(
        ...
        resource={
            ...
            "properties": {
                ...
                "operations": [
                    {"instructions": "use includeAlertsFromGlobalRules", "mode": "Auto", "type": "IssueCreation"},
                    {"instructions": "focus on recent issues", "mode": "Auto", "type": "Investigation"},
                ],
            },
            "tags": {"env": "dev"},
        },
