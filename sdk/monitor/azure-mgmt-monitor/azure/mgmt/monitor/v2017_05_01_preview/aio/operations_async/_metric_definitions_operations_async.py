...
class MetricDefinitionsOperations:
    ...
    def list(
        ...
        resource_uri: str,
        **kwargs
    ) -> AsyncIterable["models.MetricDefinitionCollection"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2017_05_01_preview.models.MetricDefinitionCollection]
