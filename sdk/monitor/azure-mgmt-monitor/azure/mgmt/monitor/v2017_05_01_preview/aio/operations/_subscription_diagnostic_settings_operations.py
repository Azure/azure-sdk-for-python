...
class SubscriptionDiagnosticSettingsOperations:
    ...
    async def get(self, name: str, **kwargs: Any) -> _models.SubscriptionDiagnosticSettingsResource:
        ...
        deserialized = self._deserialize("SubscriptionDiagnosticSettingsResource", pipeline_response.http_response)
    ...
    @overload
    async def create_or_update(
        self, name: str, parameters: IO[bytes], *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.SubscriptionDiagnosticSettingsResource:
        """Creates or updates subscription diagnostic settings for the specified resource.
    ...
    @distributed_trace_async
    async def create_or_update(
        self, name: str, parameters: Union[_models.SubscriptionDiagnosticSettingsResource, IO[bytes]], **kwargs: Any
    ) -> _models.SubscriptionDiagnosticSettingsResource:
        """Creates or updates subscription diagnostic settings for the specified resource.
        ...
        :param parameters: Parameters supplied to the operation. Is either a
         SubscriptionDiagnosticSettingsResource type or a IO[bytes] type. Required.
        :type parameters:
         ~azure.mgmt.monitor.v2017_05_01_preview.models.SubscriptionDiagnosticSettingsResource or
         IO[bytes]
        :return: SubscriptionDiagnosticSettingsResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2017_05_01_preview.models.SubscriptionDiagnosticSettingsResource
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    @distributed_trace_async
    async def list(self, **kwargs: Any) -> _models.SubscriptionDiagnosticSettingsResourceCollection:
        ...
        deserialized = self._deserialize(
            "SubscriptionDiagnosticSettingsResourceCollection", pipeline_response.http_response
        )
