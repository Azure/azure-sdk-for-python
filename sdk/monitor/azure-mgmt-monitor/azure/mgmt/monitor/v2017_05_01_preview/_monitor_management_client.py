...
class MonitorManagementClient:
    ...
    :vartype diagnostic_settings_category:
     $(python-base-namespace).v2017_05_01_preview.operations.DiagnosticSettingsCategoryOperations
    :ivar diagnostic_settings: DiagnosticSettingsOperations operations
    :vartype diagnostic_settings:
     $(python-base-namespace).v2017_05_01_preview.operations.DiagnosticSettingsOperations
    :ivar metric_definitions: MetricDefinitionsOperations operations
    :vartype metric_definitions:
     $(python-base-namespace).v2017_05_01_preview.operations.MetricDefinitionsOperations
    ...
    :vartype subscription_diagnostic_settings:
     $(python-base-namespace).v2017_05_01_preview.operations.SubscriptionDiagnosticSettingsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.diagnostic_settings_category = DiagnosticSettingsCategoryOperations(self._client, self._config, self._serialize, self._deserialize)
        self.diagnostic_settings = DiagnosticSettingsOperations(self._client, self._config, self._serialize, self._deserialize)
        ...
        self.subscription_diagnostic_settings = SubscriptionDiagnosticSettingsOperations(self._client, self._config, self._serialize, self._deserialize)
