...
class AlertRuleIncidentsOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.monitor.v2016_03_01.models.Incident or
    ...
    def list_by_alert_rule(
        ...
        :rtype:
         ~azure.mgmt.monitor.v2016_03_01.models.IncidentPaged[~azure.mgmt.monitor.v2016_03_01.models.Incident]
        ...
        if raw:
            header_dict = {}
        deserialized = models.IncidentPaged(internal_paging, self._deserialize.dependencies, header_dict)
