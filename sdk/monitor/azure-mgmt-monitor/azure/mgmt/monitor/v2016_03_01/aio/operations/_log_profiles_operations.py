...
class LogProfilesOperations:
    ...
    @distributed_trace_async
    async def create_or_update(
        self, log_profile_name: str, parameters: Union[_models.LogProfileResource, IO[bytes]], **kwargs: Any
    ) -> _models.LogProfileResource:
        """Create or update a log profile in Azure Monitoring REST API.
        ...
        :type parameters: ~azure.mgmt.monitor.v2016_03_01.models.LogProfileResource or IO[bytes]
        :return: LogProfileResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2016_03_01.models.LogProfileResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        self,
        log_profile_name: str,
        log_profiles_resource: Union[_models.LogProfileResourcePatch, IO[bytes]],
        **kwargs: Any
    ) -> _models.LogProfileResource:
        """Updates an existing LogProfilesResource. To update other fields use the CreateOrUpdate method.
