...
class AlertRulesOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.monitor.v2016_03_01.models.AlertRuleResource or IO[bytes]
        :return: AlertRuleResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2016_03_01.models.AlertRuleResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type alert_rules_resource: ~azure.mgmt.monitor.v2016_03_01.models.AlertRuleResourcePatch or
         IO[bytes]
        :return: AlertRuleResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2016_03_01.models.AlertRuleResource
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    ) -> AsyncItemPaged["_models.AlertRuleResource"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.AlertRuleResource"]:
