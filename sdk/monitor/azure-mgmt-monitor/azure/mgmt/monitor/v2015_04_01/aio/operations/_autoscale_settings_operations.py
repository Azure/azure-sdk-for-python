...
class AutoscaleSettingsOperations:
    ...
    def list_by_resource_group(
    ...
    ) -> AsyncIterable["_models.AutoscaleSettingResource"]:
        ...
        :return: An iterator like instance of either AutoscaleSettingResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2015_04_01.models.AutoscaleSettingResource]
    ...
    async def create_or_update(
        ...
        resource_group_name: str,
        autoscale_setting_name: str,
        parameters: Union[_models.AutoscaleSettingResource, IO],
        **kwargs: Any
    ) -> _models.AutoscaleSettingResource:
        """Creates or updates an autoscale setting.
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type autoscale_setting_name: str
        :param autoscale_setting_resource: Parameters supplied to the operation. Required.
        :type autoscale_setting_resource: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        resource_group_name: str,
        autoscale_setting_name: str,
        autoscale_setting_resource: Union[_models.AutoscaleSettingResourcePatch, IO],
        **kwargs: Any
    ) -> _models.AutoscaleSettingResource:
        """Updates an existing AutoscaleSettingsResource. To update other fields use the CreateOrUpdate
        method.
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.AutoscaleSettingResource"]:
