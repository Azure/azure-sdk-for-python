...
class EventCategoriesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.LocalizableString"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2015_04_01.models.LocalizableString]
