...
class MetricAlertsOperations:
    ...
    def list_by_subscription(
        self,
        **kwargs
    ) -> AsyncIterable["models.MetricAlertResourceCollection"]:
        """Retrieve alert rule definitions in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either MetricAlertResourceCollection or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2018_03_01.models.MetricAlertResourceCollection]
