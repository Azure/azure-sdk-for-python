...
class DataCollectionRulesOperations:
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either DataCollectionRuleResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.monitor.v2021_04_01.models.DataCollectionRuleResource]
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.monitor.v2021_04_01.models.DataCollectionRuleResource or IO[bytes]
        :return: DataCollectionRuleResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2021_04_01.models.DataCollectionRuleResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param body: The payload. Is either a ResourceForUpdate type or a IO[bytes] type. Default value
         is None.
        :type body: ~azure.mgmt.monitor.v2021_04_01.models.ResourceForUpdate or IO[bytes]
        :return: DataCollectionRuleResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2021_04_01.models.DataCollectionRuleResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, data_collection_rule_name: str, **kwargs: Any) -> None:
