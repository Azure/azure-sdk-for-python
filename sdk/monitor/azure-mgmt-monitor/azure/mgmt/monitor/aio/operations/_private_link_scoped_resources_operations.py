...
class PrivateLinkScopedResourcesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ScopedResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.monitor.models.ScopedResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_private_link_scope(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.monitor.models.ScopedResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
