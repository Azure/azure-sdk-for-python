...
from ...operations._metric_namespaces_operations import build_list_request
...
class MetricNamespacesOperations:
    ...
    def list(
    ...
    ) -> AsyncItemPaged["_models.MetricNamespace"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.monitor.models.MetricNamespace]
