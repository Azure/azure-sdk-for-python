...
class PrivateLinkScopesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.AzureMonitorPrivateLinkScope"]:
        """Gets a list of all Azure Monitor PrivateLinkScopes within a subscription.

        :return: An iterator like instance of either AzureMonitorPrivateLinkScope or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.monitor.models.AzureMonitorPrivateLinkScope]
    ...
    ) -> AsyncItemPaged["_models.AzureMonitorPrivateLinkScope"]:
    ...
    async def get(
        ...
        deserialized = self._deserialize("AzureMonitorPrivateLinkScope", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        resource_group_name: str,
        scope_name: str,
        azure_monitor_private_link_scope_payload: Union[_models.AzureMonitorPrivateLinkScope, IO[bytes]],
        **kwargs: Any
    ) -> _models.AzureMonitorPrivateLinkScope:
        """Creates (or updates) a Azure Monitor PrivateLinkScope. Note: You cannot specify a different
        value for InstrumentationKey nor AppId in the Put operation.
        ...
        :type azure_monitor_private_link_scope_payload:
         ~azure.mgmt.monitor.models.AzureMonitorPrivateLinkScope or IO[bytes]
        :return: AzureMonitorPrivateLinkScope or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.models.AzureMonitorPrivateLinkScope
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :type private_link_scope_tags: ~azure.mgmt.monitor.models.TagsResource or IO[bytes]
        :return: AzureMonitorPrivateLinkScope or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.models.AzureMonitorPrivateLinkScope
        :raises ~azure.core.exceptions.HttpResponseError:
        """
