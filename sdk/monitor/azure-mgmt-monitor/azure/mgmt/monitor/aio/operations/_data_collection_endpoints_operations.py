...
class DataCollectionEndpointsOperations:
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either DataCollectionEndpointResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.monitor.models.DataCollectionEndpointResource]
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.monitor.models.DataCollectionEndpointResource or IO[bytes]
        :return: DataCollectionEndpointResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.models.DataCollectionEndpointResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
