...
class VMInsightsOperations:
    ...
    async def get_onboarding_status(self, resource_uri: str, **kwargs: Any) -> _models.VMInsightsOnboardingStatus:
        ...
        :rtype: ~azure.mgmt.monitor.models.VMInsightsOnboardingStatus
        ...
        if response.status_code not in [200]:
            ...
            error = self._deserialize.failsafe_deserialize(
                _models.ResponseWithError,
                pipeline_response,
            )
            raise HttpResponseError(response=response, model=error, error_format=ARMErrorFormat)

        deserialized = self._deserialize("VMInsightsOnboardingStatus", pipeline_response.http_response)
