...
class MonitorManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :ivar scheduled_query_rule: ScheduledQueryRuleOperations operations
    :vartype scheduled_query_rule: azure.mgmt.monitor.aio.operations.ScheduledQueryRuleOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.scheduled_query_rule = ScheduledQueryRuleOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
