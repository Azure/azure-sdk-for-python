...
from ...operations._metric_definitions_operations import build_list_at_subscription_scope_request, build_list_request
...
class MetricDefinitionsOperations:
    ...
    def list_at_subscription_scope(
    ...
    ) -> AsyncIterable["_models.SubscriptionScopeMetricDefinition"]:
        ...
        :return: An iterator like instance of either SubscriptionScopeMetricDefinition or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2021_05_01.models.SubscriptionScopeMetricDefinition]
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2021_05_01.models.MetricDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
