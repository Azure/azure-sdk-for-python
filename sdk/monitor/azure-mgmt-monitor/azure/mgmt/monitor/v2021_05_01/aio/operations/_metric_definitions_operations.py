...
class MetricDefinitionsOperations:
    ...
    def list_at_subscription_scope(
    ...
    ) -> AsyncItemPaged["_models.SubscriptionScopeMetricDefinition"]:
        ...
        :return: An iterator like instance of either SubscriptionScopeMetricDefinition or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.monitor.v2021_05_01.models.SubscriptionScopeMetricDefinition]
