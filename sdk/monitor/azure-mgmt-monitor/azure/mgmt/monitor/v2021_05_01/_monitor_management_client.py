...
from .operations import MetricDefinitionsOperations, MetricsOperations, Operations
...
class MonitorManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype metrics: $(python-base-namespace).v2021_05_01.operations.MetricsOperations
    :ivar metric_definitions: MetricDefinitionsOperations operations
    :vartype metric_definitions:
     $(python-base-namespace).v2021_05_01.operations.MetricDefinitionsOperations
    :ivar operations: Operations operations
    :vartype operations: $(python-base-namespace).v2021_05_01.operations.Operations
