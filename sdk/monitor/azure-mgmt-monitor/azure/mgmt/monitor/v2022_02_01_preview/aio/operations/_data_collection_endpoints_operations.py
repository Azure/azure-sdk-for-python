...
class DataCollectionEndpointsOperations:
    ...
    def list_by_resource_group(
    ...
    ) -> AsyncItemPaged["_models.DataCollectionEndpointResource"]:
        ...
        :return: An iterator like instance of either DataCollectionEndpointResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.monitor.v2022_02_01_preview.models.DataCollectionEndpointResource]
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.DataCollectionEndpointResource"]:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.monitor.v2022_02_01_preview.models.DataCollectionEndpointResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("DataCollectionEndpointResource", pipeline_response.http_response)
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.monitor.v2022_02_01_preview.models.DataCollectionEndpointResource
    ...
    async def create(
        ...
        resource_group_name: str,
        data_collection_endpoint_name: str,
        body: Optional[Union[_models.DataCollectionEndpointResource, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.DataCollectionEndpointResource:
        """Creates or updates a data collection endpoint.
        ...
        :param data_collection_endpoint_name: The name of the data collection endpoint. The name is
         case insensitive. Required.
        :type data_collection_endpoint_name: str
        :param body: The payload. Is either a DataCollectionEndpointResource type or a IO[bytes] type.
         Default value is None.
        :type body: ~azure.mgmt.monitor.v2022_02_01_preview.models.DataCollectionEndpointResource or
         IO[bytes]
        :return: DataCollectionEndpointResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2022_02_01_preview.models.DataCollectionEndpointResource
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, data_collection_endpoint_name: str, **kwargs: Any) -> None:
