...
from ...operations._data_collection_endpoints_operations import build_create_request, build_delete_request, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_update_request
T = TypeVar('T')
...
class DataCollectionEndpointsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~$(python-base-namespace).v2022_02_01_preview.models.DataCollectionEndpointResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type body: ~$(python-base-namespace).v2022_02_01_preview.models.DataCollectionEndpointResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DataCollectionEndpointResource, or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2022_02_01_preview.models.DataCollectionEndpointResource
        :raises: ~azure.core.exceptions.HttpResponseError
