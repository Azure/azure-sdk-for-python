...
class GuestDiagnosticsSettingsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :type diagnostic_settings: ~$(python-base-namespace).v2018_06_01_preview.models.GuestDiagnosticSettingsResource
    ...
    async def update(
        ...
        **kwargs
        ...
        :type parameters: ~$(python-base-namespace).v2018_06_01_preview.models.GuestDiagnosticSettingsPatchResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: GuestDiagnosticSettingsResource, or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2018_06_01_preview.models.GuestDiagnosticSettingsResource
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list(
        self,
        **kwargs
    ) -> AsyncIterable["models.GuestDiagnosticSettingsList"]:
        """Get a list of all guest diagnostic settings in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either GuestDiagnosticSettingsList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2018_06_01_preview.models.GuestDiagnosticSettingsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
