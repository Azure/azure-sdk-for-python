...
class Actions(_serialization.Model):
    ...
    def __init__(
        self, *, action_groups: Optional[List[str]] = None, custom_properties: Optional[Dict[str, str]] = None, **kwargs
    ):
        """
...
class ErrorContract(_serialization.Model):
    ...
    def __init__(self, *, error: Optional["_models.ErrorResponseDetails"] = None, **kwargs):
        """
...
class RuleResolveConfiguration(_serialization.Model):
    ...
    def __init__(
        self, *, auto_resolved: Optional[bool] = None, time_to_resolve: Optional[datetime.timedelta] = None, **kwargs
    ):
        """
