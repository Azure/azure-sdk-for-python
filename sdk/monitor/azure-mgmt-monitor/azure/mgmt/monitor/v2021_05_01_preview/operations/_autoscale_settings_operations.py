...
class AutoscaleSettingsOperations(object):
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2021_05_01_preview.models.AutoscaleSettingResourceCollection]
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        :type autoscale_setting_resource: ~$(python-base-namespace).v2021_05_01_preview.models.AutoscaleSettingResourcePatch
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AutoscaleSettingResource, or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2021_05_01_preview.models.AutoscaleSettingResource
        :raises: ~azure.core.exceptions.HttpResponseError
