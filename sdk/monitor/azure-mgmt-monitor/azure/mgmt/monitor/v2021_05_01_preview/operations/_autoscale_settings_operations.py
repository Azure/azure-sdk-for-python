...
def build_list_by_resource_group_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Insights/autoscalesettings")  # pylint: disable=line-too-long
...
def build_create_or_update_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.AutoscaleSettingResource] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Insights/autoscalesettings/{autoscaleSettingName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
...
def build_update_request(
    ...
    autoscale_setting_name: str,
    *,
    json: Optional[_models.AutoscaleSettingResourcePatch] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_list_by_subscription_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Insights/autoscalesettings")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
    }
...
class AutoscaleSettingsOperations:
    ...
    def list_by_resource_group(
        ...
        resource_group_name: str,
        **kwargs: Any
    ) -> Iterable[_models.AutoscaleSettingResourceCollection]:
        ...
        :return: An iterator like instance of either AutoscaleSettingResourceCollection or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2021_05_01_preview.models.AutoscaleSettingResourceCollection]
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~$(python-base-namespace).v2021_05_01_preview.models.AutoscaleSettingResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AutoscaleSettingResource, or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2021_05_01_preview.models.AutoscaleSettingResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type autoscale_setting_resource:
         ~$(python-base-namespace).v2021_05_01_preview.models.AutoscaleSettingResourcePatch
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AutoscaleSettingResource, or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2021_05_01_preview.models.AutoscaleSettingResource
        :raises: ~azure.core.exceptions.HttpResponseError
