...
class DiagnosticSettingsOperations:
    ...
    async def get(self, resource_uri: str, name: str, **kwargs: Any) -> _models.DiagnosticSettingsResource:
        ...
        deserialized = self._deserialize("DiagnosticSettingsResource", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        resource_uri: str,
        name: str,
        parameters: Union[_models.DiagnosticSettingsResource, IO[bytes]],
        **kwargs: Any
    ) -> _models.DiagnosticSettingsResource:
        """Creates or updates diagnostic settings for the specified resource.
    ...
    @distributed_trace_async
    async def delete(self, resource_uri: str, name: str, **kwargs: Any) -> None:
    ...
    @distributed_trace
    def list(self, resource_uri: str, **kwargs: Any) -> AsyncItemPaged["_models.DiagnosticSettingsResource"]:
        ...
        :return: An iterator like instance of either DiagnosticSettingsResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.monitor.v2021_05_01_preview.models.DiagnosticSettingsResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
