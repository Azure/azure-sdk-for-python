...
class AzureMonitorWorkspacesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~$(python-base-namespace).v2021_06_03_preview.MonitorManagementClient`'s
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either AzureMonitorWorkspaceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2021_06_03_preview.models.AzureMonitorWorkspaceResource]
