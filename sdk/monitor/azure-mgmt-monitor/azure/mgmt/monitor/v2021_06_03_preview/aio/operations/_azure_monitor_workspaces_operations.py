...
class AzureMonitorWorkspacesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~$(python-base-namespace).v2021_06_03_preview.aio.MonitorManagementClient`'s
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either AzureMonitorWorkspaceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2021_06_03_preview.models.AzureMonitorWorkspaceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

        api_version: Literal["2021-06-03-preview"] = kwargs.pop(
            "api_version", _params.pop("api-version", "2021-06-03-preview")
        )
    ...
    async def get(
        ...
        :rtype: ~$(python-base-namespace).v2021_06_03_preview.models.AzureMonitorWorkspaceResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type azure_monitor_workspace_properties:
         ~$(python-base-namespace).v2021_06_03_preview.models.AzureMonitorWorkspaceResource
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type azure_monitor_workspace_properties:
         ~$(python-base-namespace).v2021_06_03_preview.models.AzureMonitorWorkspaceResource or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type azure_monitor_workspace_properties:
         ~$(python-base-namespace).v2021_06_03_preview.models.AzureMonitorWorkspaceResourceForUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type azure_monitor_workspace_properties:
         ~$(python-base-namespace).v2021_06_03_preview.models.AzureMonitorWorkspaceResourceForUpdate or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
