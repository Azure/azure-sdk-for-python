...
class ServiceDiagnosticSettingsOperations(object):
    ...
    def get(
        ...
        :return: ServiceDiagnosticSettingsResource or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.monitor.v2015_07_01.models.ServiceDiagnosticSettingsResource
         or ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.mgmt.monitor.v2015_07_01.models.ErrorResponseException>`
        """
        # Construct URL
