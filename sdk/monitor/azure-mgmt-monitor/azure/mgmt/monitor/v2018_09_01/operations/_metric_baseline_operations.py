...
class MetricBaselineOperations(object):
    ...
    def get(
            self, resource_uri, metric_name, timespan=None, interval=None, aggregation=None, sensitivities=None, result_type=None, metricnamespace=None, filter=None, custom_headers=None, raw=False, **operation_config):
    ...
    def calculate_baseline(
        ...
        :type time_series_information:
         ~azure.mgmt.monitor.v2018_09_01.models.TimeSeriesInformation
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype:
         ~azure.mgmt.monitor.v2018_09_01.models.CalculateBaselineResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.mgmt.monitor.v2018_09_01.models.ErrorResponseException>`
        """
