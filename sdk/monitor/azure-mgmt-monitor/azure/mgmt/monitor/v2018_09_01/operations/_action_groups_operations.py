...
class ActionGroupsOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type action_group: ~$(python-base-namespace).v2018_09_01.models.ActionGroupResource or IO
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type action_group_patch: ~$(python-base-namespace).v2018_09_01.models.ActionGroupPatchBody or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
    ...
    def list_by_subscription_id(self, **kwargs: Any) -> Iterable["_models.ActionGroupResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2018_09_01.models.ActionGroupResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def enable_receiver(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param enable_request: The receiver to re-enable. Is either a EnableRequest type or a IO type.
         Required.
        :type enable_request: ~$(python-base-namespace).v2018_09_01.models.EnableRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
