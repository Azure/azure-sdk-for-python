...
class ActionGroupsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :type action_group: ~$(python-base-namespace).v2018_09_01.models.ActionGroupResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ActionGroupResource or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2018_09_01.models.ActionGroupResource or ~$(python-base-namespace).v2018_09_01.models.ActionGroupResource
    ...
    async def get(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ActionGroupResource or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2018_09_01.models.ActionGroupResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ActionGroupResource"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    async def update(
        ...
        **kwargs
        ...
        :type action_group_patch: ~$(python-base-namespace).v2018_09_01.models.ActionGroupPatchBody
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ActionGroupResource or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2018_09_01.models.ActionGroupResource
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_by_subscription_id(
        ...
        **kwargs
        ...
        :rtype: ~$(python-base-namespace).v2018_09_01.models.ActionGroupList
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def enable_receiver(
        ...
        **kwargs
        ...
        :type enable_request: ~$(python-base-namespace).v2018_09_01.models.EnableRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
