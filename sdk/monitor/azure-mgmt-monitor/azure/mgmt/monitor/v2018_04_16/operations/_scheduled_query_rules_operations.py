...
def build_create_or_update_request(
    ...
    api_version: Literal["2018-04-16"] = kwargs.pop("api_version", _params.pop("api-version", "2018-04-16"))
...
class ScheduledQueryRulesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~$(python-base-namespace).v2018_04_16.MonitorManagementClient`'s
    ...
    def create_or_update(
        ...
        resource_group_name: str,
        rule_name: str,
        parameters: Union[_models.LogSearchRuleResource, IO],
        **kwargs: Any
    ) -> _models.LogSearchRuleResource:
        """Creates or updates an log search rule.
    ...
    def list_by_subscription(
    ...
    ) -> Iterable["_models.LogSearchRuleResource"]:
        ...
        :return: An iterator like instance of either LogSearchRuleResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2018_04_16.models.LogSearchRuleResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
