...
class ScheduledQueryRulesOperations(object):
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.monitor.v2018_04_16.models.LogSearchRuleResource
    ...
    def list_by_subscription(
        ...
        if raw:
            header_dict = {}
        deserialized = models.LogSearchRuleResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)
