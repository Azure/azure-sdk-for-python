...
class PrivateLinkScopedResourcesOperations:
    ...
    async def create_or_update(
        ...
        :return: An instance of ScopedResource or
         ClientRawResponse<ScopedResource> if raw==True
        :rtype: ~~azure.mgmt.monitor.v2019_10_17.models.ScopedResource or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.monitor.v2019_10_17.models.ScopedResource]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_by_private_link_scope(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ScopedResourcePaged(
