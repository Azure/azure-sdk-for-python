...
class PrivateLinkScopedResourcesOperations(object):
    ...
    def _create_or_update_initial(
        ...
        scope_name,  # type: str
        name,  # type: str
        parameters,  # type: "_models.ScopedResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.ScopedResource"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.ScopedResource"]
    ...
    def list_by_private_link_scope(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ScopedResourceListResult"]
