...
class ActivityLogAlertsOperations:
    ...
    :type models: ~$(python-base-namespace).v2020_10_01.models
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type activity_log_alert_rule: ~$(python-base-namespace).v2020_10_01.models.ActivityLogAlertResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ActivityLogAlertResource, or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2020_10_01.models.ActivityLogAlertResource
        ...
        body_content = self._serialize.body(activity_log_alert_rule, 'ActivityLogAlertResource')
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param activity_log_alert_name: The name of the Activity Log Alert rule.
        :type activity_log_alert_name: str
        :param activity_log_alert_rule_patch: Parameters supplied to the operation.
        :type activity_log_alert_rule_patch: ~$(python-base-namespace).v2020_10_01.models.AlertRulePatchObject
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ActivityLogAlertResource, or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2020_10_01.models.ActivityLogAlertResource
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(activity_log_alert_rule_patch, 'AlertRulePatchObject')
        body_content_kwargs['content'] = body_content
    ...
    def list_by_subscription_id(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.AlertRuleList"]:
        """Get a list of all Activity Log Alert rules in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either AlertRuleList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2020_10_01.models.AlertRuleList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.AlertRuleList"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
