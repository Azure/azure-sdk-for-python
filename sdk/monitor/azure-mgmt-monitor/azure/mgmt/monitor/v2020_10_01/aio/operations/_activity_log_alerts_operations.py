...
class ActivityLogAlertsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~$(python-base-namespace).v2020_10_01.aio.MonitorManagementClient`'s
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param activity_log_alert_rule: The Activity Log Alert rule to create or use for the update.
         Required.
        :type activity_log_alert_rule:
         ~$(python-base-namespace).v2020_10_01.models.ActivityLogAlertResource
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type activity_log_alert_rule:
         ~$(python-base-namespace).v2020_10_01.models.ActivityLogAlertResource or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type activity_log_alert_rule_patch:
         ~$(python-base-namespace).v2020_10_01.models.AlertRulePatchObject
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param activity_log_alert_name: The name of the Activity Log Alert rule. Required.
        :type activity_log_alert_name: str
        :param activity_log_alert_rule_patch: Parameters supplied to the operation. Is either a model
         type or a IO type. Required.
        :type activity_log_alert_rule_patch:
         ~$(python-base-namespace).v2020_10_01.models.AlertRulePatchObject or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_subscription_id(self, **kwargs: Any) -> AsyncIterable["_models.ActivityLogAlertResource"]:
        ...
        :return: An iterator like instance of either ActivityLogAlertResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2020_10_01.models.ActivityLogAlertResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
