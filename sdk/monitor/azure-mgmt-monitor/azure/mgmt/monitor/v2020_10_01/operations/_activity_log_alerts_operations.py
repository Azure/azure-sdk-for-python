...
class ActivityLogAlertsOperations(object):
    ...
    def create_or_update(
            self, resource_group_name, activity_log_alert_name, activity_log_alert_rule, custom_headers=None, raw=False, **operation_config):
        ...
        :param activity_log_alert_rule: The Activity Log Alert rule to create
         or use for the update.
        ...
        :raises:
         :class:`ErrorResponseException<$(python-base-namespace).v2020_10_01.models.ErrorResponseException>`
        """
        # Construct URL
    ...
    def update(
            self, resource_group_name, activity_log_alert_name, activity_log_alert_rule_patch, custom_headers=None, raw=False, **operation_config):
        ...
        :param activity_log_alert_name: The name of the Activity Log Alert
         rule.
        :type activity_log_alert_name: str
        :param activity_log_alert_rule_patch: Parameters supplied to the
         operation.
    ...
    def list_by_subscription_id(
        ...
        :rtype:
         ~$(python-base-namespace).v2020_10_01.models.ActivityLogAlertResourcePaged[~$(python-base-namespace).v2020_10_01.models.ActivityLogAlertResource]
        :raises:
         :class:`ErrorResponseException<$(python-base-namespace).v2020_10_01.models.ErrorResponseException>`
        """
