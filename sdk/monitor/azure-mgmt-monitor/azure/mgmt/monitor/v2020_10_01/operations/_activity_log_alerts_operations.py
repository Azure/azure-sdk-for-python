...
class ActivityLogAlertsOperations(object):
    ...
    def create_or_update(
        ...
        activity_log_alert_rule,  # type: "_models.ActivityLogAlertResource"
        **kwargs  # type: Any
    ):
    ...
    def update(
        ...
        resource_group_name,  # type: str
        activity_log_alert_name,  # type: str
        activity_log_alert_rule_patch,  # type: "_models.AlertRulePatchObject"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ActivityLogAlertResource"
    ...
    def list_by_subscription_id(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.AlertRuleList"]
        """Get a list of all Activity Log Alert rules in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either AlertRuleList or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2020_10_01.models.AlertRuleList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
