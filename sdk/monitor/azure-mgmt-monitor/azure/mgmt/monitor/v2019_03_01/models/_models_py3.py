...
class ActionGroupResource(Resource):
    ...
    :type voice_receivers:
     list[~azure.mgmt.monitor.v2019_03_01.models.VoiceReceiver]
    :param logic_app_receivers: The list of logic app receivers that are part
     of this action group.
    :type logic_app_receivers:
     list[~azure.mgmt.monitor.v2019_03_01.models.LogicAppReceiver]
    ...
    :type arm_role_receivers:
     list[~azure.mgmt.monitor.v2019_03_01.models.ArmRoleReceiver]
    """
...
class SingleBaseline(Model):
    ...
    :type sensitivity: str or
     ~azure.mgmt.monitor.v2019_03_01.models.BaselineSensitivity
...
class TimeSeriesBaseline(Model):
    ...
    :type dimensions:
     list[~azure.mgmt.monitor.v2019_03_01.models.MetricSingleDimension]
