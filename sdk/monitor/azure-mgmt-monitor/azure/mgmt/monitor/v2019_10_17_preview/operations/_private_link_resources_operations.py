...
class PrivateLinkResourcesOperations(object):
    ...
    def list_by_private_link_scope(
        ...
        :rtype:
         ~azure.mgmt.monitor.v2019_10_17_preview.models.PrivateLinkResourcePaged[~azure.mgmt.monitor.v2019_10_17_preview.models.PrivateLinkResource]
    ...
    def get(
            self, resource_group_name, scope_name, group_name, custom_headers=None, raw=False, **operation_config):
        """Gets the private link resources that need to be created for a Azure
        Monitor PrivateLinkScope.
        ...
        :rtype:
         ~azure.mgmt.monitor.v2019_10_17_preview.models.PrivateLinkResource or
