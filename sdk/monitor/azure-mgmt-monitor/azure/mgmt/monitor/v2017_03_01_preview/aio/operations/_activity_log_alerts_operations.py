...
from ...operations._activity_log_alerts_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_id_request, build_update_request
T = TypeVar('T')
...
class ActivityLogAlertsOperations:
    ...
    :type models: ~$(python-base-namespace).v2017_03_01_preview.models
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(activity_log_alert_patch, 'ActivityLogAlertResourcePatch')
    ...
    def list_by_subscription_id(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ActivityLogAlertList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2017_03_01_preview.models.ActivityLogAlertList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2017-03-01-preview")  # type: str
