...
class ActivityLogAlertsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        api_version: Literal["2017-03-01-preview"] = kwargs.pop(
            "api_version", _params.pop("api-version", "2017-03-01-preview")
        )
    ...
    async def update(
        ...
        resource_group_name: str,
        activity_log_alert_name: str,
        activity_log_alert_patch: Union[_models.ActivityLogAlertResourcePatch, IO],
        **kwargs: Any
    ) -> _models.ActivityLogAlertResource:
        """Updates an existing ActivityLogAlertResource's tags. To update other fields use the
        CreateOrUpdate method.
