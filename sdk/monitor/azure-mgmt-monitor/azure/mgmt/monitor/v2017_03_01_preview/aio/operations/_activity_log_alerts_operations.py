...
class ActivityLogAlertsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type activity_log_alert:
         ~azure.mgmt.monitor.v2017_03_01_preview.models.ActivityLogAlertResource or IO[bytes]
        :return: ActivityLogAlertResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2017_03_01_preview.models.ActivityLogAlertResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        resource_group_name: str,
        activity_log_alert_name: str,
        activity_log_alert_patch: Union[_models.ActivityLogAlertResourcePatch, IO[bytes]],
        **kwargs: Any
    ) -> _models.ActivityLogAlertResource:
        """Updates an existing ActivityLogAlertResource's tags. To update other fields use the
        CreateOrUpdate method.
        ...
        :param activity_log_alert_patch: Parameters supplied to the operation. Is either a
         ActivityLogAlertResourcePatch type or a IO[bytes] type. Required.
        :type activity_log_alert_patch:
         ~azure.mgmt.monitor.v2017_03_01_preview.models.ActivityLogAlertResourcePatch or IO[bytes]
        :return: ActivityLogAlertResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2017_03_01_preview.models.ActivityLogAlertResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
