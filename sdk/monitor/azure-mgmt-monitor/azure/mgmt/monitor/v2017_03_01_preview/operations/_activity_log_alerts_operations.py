...
def build_update_request(
    ...
    activity_log_alert_name: str,
    *,
    json: Optional[_models.ActivityLogAlertResourcePatch] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    def list_by_subscription_id(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ActivityLogAlertList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2017_03_01_preview.models.ActivityLogAlertList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
