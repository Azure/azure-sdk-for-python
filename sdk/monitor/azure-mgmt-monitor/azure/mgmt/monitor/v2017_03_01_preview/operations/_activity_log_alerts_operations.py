...
class ActivityLogAlertsOperations(object):
    ...
    def update(
        ...
        resource_group_name,  # type: str
        activity_log_alert_name,  # type: str
        activity_log_alert_patch,  # type: "_models.ActivityLogAlertResourcePatch"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ActivityLogAlertResource"
    ...
    def list_by_subscription_id(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2017_03_01_preview.models.ActivityLogAlertList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
