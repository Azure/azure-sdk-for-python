...
class DataCollectionRulesOperations:
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either DataCollectionRuleResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2019_11_01_preview.models.DataCollectionRuleResource]
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :param body: The payload. Is either a DataCollectionRuleResource type or a IO type. Default
         value is None.
        :type body: ~$(python-base-namespace).v2019_11_01_preview.models.DataCollectionRuleResource or
         IO
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param body: The payload. Is either a ResourceForUpdate type or a IO type. Default value is
         None.
        :type body: ~$(python-base-namespace).v2019_11_01_preview.models.ResourceForUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
