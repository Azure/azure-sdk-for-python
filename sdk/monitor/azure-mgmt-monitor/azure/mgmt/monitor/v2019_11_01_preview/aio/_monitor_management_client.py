...
from .operations import DataCollectionRuleAssociationsOperations, DataCollectionRulesOperations
...
class MonitorManagementClient:
    ...
    :vartype data_collection_rule_associations:
     $(python-base-namespace).v2019_11_01_preview.aio.operations.DataCollectionRuleAssociationsOperations
    :ivar data_collection_rules: DataCollectionRulesOperations operations
    :vartype data_collection_rules:
     $(python-base-namespace).v2019_11_01_preview.aio.operations.DataCollectionRulesOperations
