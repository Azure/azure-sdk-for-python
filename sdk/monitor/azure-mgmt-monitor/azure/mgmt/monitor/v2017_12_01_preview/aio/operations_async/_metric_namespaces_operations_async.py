...
class MetricNamespacesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.monitor.v2017_12_01_preview.models.MetricNamespacePaged[~azure.mgmt.monitor.v2017_12_01_preview.models.MetricNamespace]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.monitor.v2017_12_01_preview.models.ErrorResponseException>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.MetricNamespacePaged(
