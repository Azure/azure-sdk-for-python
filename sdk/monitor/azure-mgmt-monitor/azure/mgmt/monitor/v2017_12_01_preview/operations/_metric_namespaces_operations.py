...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/{resourceUri}/providers/microsoft.insights/metricNamespaces')
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either MetricNamespaceCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2017_12_01_preview.models.MetricNamespaceCollection]
