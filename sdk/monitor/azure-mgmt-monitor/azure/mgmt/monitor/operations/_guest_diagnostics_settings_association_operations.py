...
class GuestDiagnosticsSettingsAssociationOperations:  # pylint: disable=name-too-long
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.GuestDiagnosticSettingsAssociationResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.monitor.models.GuestDiagnosticSettingsAssociationResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    ) -> ItemPaged["_models.GuestDiagnosticSettingsAssociationResource"]:
