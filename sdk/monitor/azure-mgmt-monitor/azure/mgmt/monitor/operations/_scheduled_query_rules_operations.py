...
class ScheduledQueryRulesOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.monitor.models.LogSearchRuleResource
    ...
    def create_or_update(
        ...
        resource_group_name: str,
        rule_name: str,
        parameters: Union[_models.LogSearchRuleResource, IO[bytes]],
        **kwargs: Any
    ) -> _models.LogSearchRuleResource:
        """Creates or updates an log search rule.
        ...
        :type parameters: ~azure.mgmt.monitor.models.LogSearchRuleResource or IO[bytes]
        :return: LogSearchRuleResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.models.LogSearchRuleResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        deserialized = self._deserialize("LogSearchRuleResource", pipeline_response.http_response)
    ...
    @distributed_trace
    def get(self, resource_group_name: str, rule_name: str, **kwargs: Any) -> _models.LogSearchRuleResource:
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.monitor.models.LogSearchRuleResourcePatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: LogSearchRuleResource or the result of cls(response)
    ...
    def update(
        ...
        resource_group_name: str,
        rule_name: str,
        parameters: Union[_models.LogSearchRuleResourcePatch, IO[bytes]],
        **kwargs: Any
    ) -> _models.LogSearchRuleResource:
        """Update log search Rule.
        ...
        :type parameters: ~azure.mgmt.monitor.models.LogSearchRuleResourcePatch or IO[bytes]
        :return: LogSearchRuleResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.models.LogSearchRuleResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_subscription(
    ...
    ) -> ItemPaged["_models.LogSearchRuleResource"]:
        ...
        :return: An iterator like instance of either LogSearchRuleResource or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.monitor.models.LogSearchRuleResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
