...
from ...operations._private_link_scoped_resources_operations import (
...
class PrivateLinkScopedResourcesOperations:
    ...
    async def get(self, resource_group_name: str, scope_name: str, name: str, **kwargs: Any) -> _models.ScopedResource:
        ...
        :rtype: ~azure.mgmt.monitor.v2021_07_01_preview.models.ScopedResource
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.monitor.v2021_07_01_preview.models.ScopedResource
        ...
        :return: An instance of AsyncLROPoller that returns either ScopedResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.monitor.v2021_07_01_preview.models.ScopedResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.monitor.v2021_07_01_preview.models.ScopedResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ScopedResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.monitor.v2021_07_01_preview.models.ScopedResource]
        ...
        if cont_token:
            return AsyncLROPoller[_models.ScopedResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ScopedResource](
    ...
    def list_by_private_link_scope(
    ...
    ) -> AsyncItemPaged["_models.ScopedResource"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.monitor.v2021_07_01_preview.models.ScopedResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
