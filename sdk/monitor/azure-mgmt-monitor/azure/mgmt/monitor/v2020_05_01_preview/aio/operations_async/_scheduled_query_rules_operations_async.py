...
class ScheduledQueryRulesOperations:
    ...
    :ivar api_version: Client Api Version. Constant value: "2020-05-01-preview".
    """
    ...
    def list_by_subscription(
        ...
        :rtype:
         ~azure.mgmt.monitor.v2020_05_01_preview.models.ScheduledQueryRuleResourcePaged[~azure.mgmt.monitor.v2020_05_01_preview.models.ScheduledQueryRuleResource]
        :raises:
         :class:`ErrorContractException<azure.mgmt.monitor.v2020_05_01_preview.models.ErrorContractException>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.ScheduledQueryRuleResourcePaged(
    ...
    async def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: ScheduledQueryRuleResource or ClientRawResponse if raw=true
        :rtype:
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ScheduledQueryRuleResource', response)
