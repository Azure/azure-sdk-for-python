...
class ScheduledQueryRulesOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.ScheduledQueryRuleResource"]:
    ...
    ) -> AsyncIterable["_models.ScheduledQueryRuleResource"]:
    ...
    async def create_or_update(
        ...
        resource_group_name: str,
        rule_name: str,
        parameters: Union[_models.ScheduledQueryRuleResource, IO],
        **kwargs: Any
    ) -> _models.ScheduledQueryRuleResource:
        """Creates or updates a scheduled query rule.
    ...
    async def update(
        ...
        resource_group_name: str,
        rule_name: str,
        parameters: Union[_models.ScheduledQueryRuleResourcePatch, IO],
        **kwargs: Any
    ) -> _models.ScheduledQueryRuleResource:
        """Update a scheduled query rule.
