...
class ActionGroupsOperations:
    ...
    async def _post_test_notifications_initial(
        ...
        **kwargs: Any
        ...
        # Construct URL
        url = self._post_test_notifications_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(notification_request, 'NotificationRequestBody')
        body_content_kwargs['content'] = body_content
    ...
    async def begin_post_test_notifications(
        ...
        **kwargs: Any
        ...
        :type notification_request: ~$(python-base-namespace).v2021_09_01.models.NotificationRequestBody
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either TestNotificationResponse or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~$(python-base-namespace).v2021_09_01.models.TestNotificationResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_test_notifications(
        ...
        **kwargs: Any
        ...
        # Construct URL
        url = self.get_test_notifications.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
            'notificationId': self._serialize.url("notification_id", notification_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    def list_by_subscription_id(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2021_09_01.models.ActionGroupList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
