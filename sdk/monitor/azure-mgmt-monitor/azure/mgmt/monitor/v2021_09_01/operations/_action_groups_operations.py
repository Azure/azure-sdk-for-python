...
def build_post_test_notifications_request_initial(
    subscription_id: str,
    *,
    json: Optional[_models.NotificationRequestBody] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_create_notifications_at_action_group_resource_level_request_initial(
    subscription_id: str,
    resource_group_name: str,
    action_group_name: str,
    *,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/actionGroups/{actionGroupName}/createNotifications")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "actionGroupName": _SERIALIZER.url("action_group_name", action_group_name, 'str'),
...
def build_get_test_notifications_at_action_group_resource_level_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/actionGroups/{actionGroupName}/notificationStatus/{notificationId}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "actionGroupName": _SERIALIZER.url("action_group_name", action_group_name, 'str'),
...
class ActionGroupsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~$(python-base-namespace).v2021_09_01.MonitorManagementClient`'s
    ...
    def begin_post_test_notifications(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~$(python-base-namespace).v2021_09_01.models.TestNotificationDetailsResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def _create_notifications_at_action_group_resource_level_initial(
        self,
        resource_group_name: str,
        action_group_name: str,
        notification_request: _models.NotificationRequestBody,
        **kwargs: Any
        ...
        request = build_create_notifications_at_action_group_resource_level_request_initial(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            action_group_name=action_group_name,
            api_version=api_version,
    ...
    def begin_create_notifications_at_action_group_resource_level(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._create_notifications_at_action_group_resource_level_initial(  # type: ignore
                resource_group_name=resource_group_name,
                action_group_name=action_group_name,
                notification_request=notification_request,
                api_version=api_version,
    ...
    begin_create_notifications_at_action_group_resource_level.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/actionGroups/{actionGroupName}/createNotifications"}  # type: ignore
    ...
    get_test_notifications_at_action_group_resource_level.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/actionGroups/{actionGroupName}/notificationStatus/{notificationId}"}  # type: ignore
    ...
    def list_by_subscription_id(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2021_09_01.models.ActionGroupList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
