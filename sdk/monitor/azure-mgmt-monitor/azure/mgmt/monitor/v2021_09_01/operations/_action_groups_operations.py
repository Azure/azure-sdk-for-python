...
class ActionGroupsOperations:
    ...
    def begin_post_test_notifications(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either TestNotificationResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~$(python-base-namespace).v2021_09_01.models.TestNotificationResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
