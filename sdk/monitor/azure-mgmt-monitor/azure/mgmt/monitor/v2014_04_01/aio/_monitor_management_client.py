...
class MonitorManagementClient:
    ...
    :vartype alert_rules: azure.mgmt.monitor.v2014_04_01.aio.operations.AlertRulesOperations
    :ivar autoscale_settings: AutoscaleSettingsOperations operations
    :vartype autoscale_settings:
     azure.mgmt.monitor.v2014_04_01.aio.operations.AutoscaleSettingsOperations
