...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Insights/alertrules")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
    }
...
class AlertRulesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.monitor.v2014_04_01.MonitorManagementClient`'s
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.monitor.v2014_04_01.models.AlertRuleResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: AlertRuleResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2014_04_01.models.AlertRuleResource
    ...
    def create_or_update(
        ...
        resource_group_name: str,
        rule_name: str,
        parameters: Union[_models.AlertRuleResource, IO[bytes]],
        **kwargs: Any
    ) -> _models.AlertRuleResource:
        """Creates or updates a classic metric alert rule.
        ...
        :param parameters: The parameters of the rule to create or update. Is either a
         AlertRuleResource type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.monitor.v2014_04_01.models.AlertRuleResource or IO[bytes]
        :return: AlertRuleResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2014_04_01.models.AlertRuleResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        deserialized = self._deserialize("AlertRuleResource", pipeline_response.http_response)
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type alert_rules_resource: ~azure.mgmt.monitor.v2014_04_01.models.AlertRuleResourcePatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: AlertRuleResource or the result of cls(response)
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type rule_name: str
        :param alert_rules_resource: Parameters supplied to the operation. Required.
        :type alert_rules_resource: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: AlertRuleResource or the result of cls(response)
    ...
    def update(
        ...
        resource_group_name: str,
        rule_name: str,
        alert_rules_resource: Union[_models.AlertRuleResourcePatch, IO[bytes]],
        **kwargs: Any
    ) -> _models.AlertRuleResource:
        """Updates an existing classic metric AlertRuleResource. To update other fields use the
        CreateOrUpdate method.
        ...
        :param alert_rules_resource: Parameters supplied to the operation. Is either a
         AlertRuleResourcePatch type or a IO[bytes] type. Required.
        :type alert_rules_resource: ~azure.mgmt.monitor.v2014_04_01.models.AlertRuleResourcePatch or
         IO[bytes]
        :return: AlertRuleResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2014_04_01.models.AlertRuleResource
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.AlertRuleResource"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.monitor.v2014_04_01.models.AlertRuleResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.AlertRuleResource"]:
