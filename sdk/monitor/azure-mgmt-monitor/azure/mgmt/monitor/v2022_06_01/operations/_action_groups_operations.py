...
class ActionGroupsOperations(object):
    ...
    def _create_notifications_at_action_group_resource_level_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        action_group_name: str,
        notification_request: "_models.NotificationRequestBody",
    ...
    @distributed_trace
    def begin_create_notifications_at_action_group_resource_level(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        action_group_name: str,
        notification_request: "_models.NotificationRequestBody",
    ...
    def list_by_subscription_id(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2022_06_01.models.ActionGroupList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-06-01")  # type: str
