...
class DataCollectionEndpointsOperations:
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either DataCollectionEndpointResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2022_06_01.models.DataCollectionEndpointResource]
    ...
    async def get(
        ...
        :rtype: ~$(python-base-namespace).v2022_06_01.models.DataCollectionEndpointResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type body: ~$(python-base-namespace).v2022_06_01.models.DataCollectionEndpointResource
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :param body: The payload. Is either a DataCollectionEndpointResource type or a IO type. Default
         value is None.
        :type body: ~$(python-base-namespace).v2022_06_01.models.DataCollectionEndpointResource or IO
