...
class DataCollectionRulesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~$(python-base-namespace).v2022_06_01.aio.MonitorManagementClient`'s
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either DataCollectionRuleResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~$(python-base-namespace).v2022_06_01.models.DataCollectionRuleResource]
