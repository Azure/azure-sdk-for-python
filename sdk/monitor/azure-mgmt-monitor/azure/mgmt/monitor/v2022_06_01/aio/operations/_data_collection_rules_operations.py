...
class DataCollectionRulesOperations:
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.monitor.v2022_06_01.models.DataCollectionRuleResource or IO[bytes]
        :return: DataCollectionRuleResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2022_06_01.models.DataCollectionRuleResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param body: The payload. Is either a ResourceForUpdate type or a IO[bytes] type. Default value
         is None.
        :type body: ~azure.mgmt.monitor.v2022_06_01.models.ResourceForUpdate or IO[bytes]
        :return: DataCollectionRuleResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2022_06_01.models.DataCollectionRuleResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
