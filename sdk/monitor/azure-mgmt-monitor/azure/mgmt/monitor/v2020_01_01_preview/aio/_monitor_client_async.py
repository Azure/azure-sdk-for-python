...
from .operations_async import ManagementGroupDiagnosticSettingsOperations
from .. import models
...
class MonitorClient(object):
    ...
    :vartype management_group_diagnostic_settings: $(python-base-namespace).v2020_01_01_preview.aio.operations_async.ManagementGroupDiagnosticSettingsOperations
