...
class ManagementGroupDiagnosticSettingsOperations:  # pylint: disable=name-too-long
    """
    .. warning::
        **DO NOT** instantiate this class directly.

        Instead, you should access the following operations through
        :class:`~azure.mgmt.monitor.v2020_01_01_preview.aio.MonitorManagementClient`'s
    ...
    async def get(
        ...
        :rtype:
         ~azure.mgmt.monitor.v2020_01_01_preview.models.ManagementGroupDiagnosticSettingsResource
        ...
        deserialized = self._deserialize("ManagementGroupDiagnosticSettingsResource", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        management_group_id: str,
        name: str,
        parameters: Union[_models.ManagementGroupDiagnosticSettingsResource, IO[bytes]],
        **kwargs: Any
    ) -> _models.ManagementGroupDiagnosticSettingsResource:
        """Creates or updates management group diagnostic settings for the specified resource.
        ...
        :param parameters: Parameters supplied to the operation. Is either a
         ManagementGroupDiagnosticSettingsResource type or a IO[bytes] type. Required.
        :type parameters:
         ~azure.mgmt.monitor.v2020_01_01_preview.models.ManagementGroupDiagnosticSettingsResource or
         IO[bytes]
        :return: ManagementGroupDiagnosticSettingsResource or the result of cls(response)
        :rtype:
         ~azure.mgmt.monitor.v2020_01_01_preview.models.ManagementGroupDiagnosticSettingsResource
    ...
    @distributed_trace_async
    async def delete(self, management_group_id: str, name: str, **kwargs: Any) -> None:
    ...
    def list(
    ...
    ) -> AsyncItemPaged["_models.ManagementGroupDiagnosticSettingsResource"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.monitor.v2020_01_01_preview.models.ManagementGroupDiagnosticSettingsResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
