...
class MonitorManagementClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    :keyword api_version: Api Version. Default value is "2018-11-27-preview". Note that overriding
    ...
    def __init__(self, credential: "AsyncTokenCredential", **kwargs: Any) -> None:
        ...
        api_version: Literal["2018-11-27-preview"] = kwargs.pop("api_version", "2018-11-27-preview")
