...
# USAGE
    python create_or_update_log_profile.py
...
def main():
    ...
    response = client.log_profiles.create_or_update(
...
# x-ms-original-file: specification/monitor/resource-manager/Microsoft.Insights/Insights/stable/2016-03-01/examples/createOrUpdateLogProfile.json
