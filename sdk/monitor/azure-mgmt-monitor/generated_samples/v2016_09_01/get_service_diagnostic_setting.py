...
def main():
    ...
    response = client.service_diagnostic_settings.get(
...
# x-ms-original-file: specification/monitor/resource-manager/Microsoft.Insights/stable/2016-09-01/examples/getServiceDiagnosticSetting.json
