...
from azure.mgmt.monitor.v2018_09_01 import MonitorManagementClient
...
def main():
    ...
    response = client.action_groups.create_or_update(
        ...
        action_group={
            "location": "Global",
            "properties": {
                "armRoleReceivers": [{"name": "Sample armRole", "roleId": "8e3af657-a8ff-443c-a75c-2fe8c4bcb635"}],
...
# x-ms-original-file: specification/monitor/resource-manager/Microsoft.Insights/stable/2018-09-01/examples/createOrUpdateActionGroup.json
