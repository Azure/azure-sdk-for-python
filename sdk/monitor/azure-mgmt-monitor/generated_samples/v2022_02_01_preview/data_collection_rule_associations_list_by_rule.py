...
from azure.mgmt.monitor.v2022_02_01_preview import MonitorManagementClient
...
# USAGE
    python data_collection_rule_associations_list_by_rule.py
...
def main():
    ...
    response = client.data_collection_rule_associations.list_by_rule(
