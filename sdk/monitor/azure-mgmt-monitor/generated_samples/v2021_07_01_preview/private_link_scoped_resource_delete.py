...
from azure.mgmt.monitor.v2021_07_01_preview import MonitorManagementClient
...
# USAGE
    python private_link_scoped_resource_delete.py
...
def main():
    ...
    client.private_link_scoped_resources.begin_delete(
