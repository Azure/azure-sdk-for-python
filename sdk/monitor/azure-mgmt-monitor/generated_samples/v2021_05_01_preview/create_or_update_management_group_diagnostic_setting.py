...
# USAGE
    python create_or_update_management_group_diagnostic_setting.py
...
# x-ms-original-file: specification/monitor/resource-manager/Microsoft.Insights/preview/2021-05-01-preview/examples/createOrUpdateManagementGroupDiagnosticSetting.json
