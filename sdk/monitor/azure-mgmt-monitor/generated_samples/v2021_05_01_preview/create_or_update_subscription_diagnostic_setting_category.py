...
# USAGE
    python create_or_update_subscription_diagnostic_setting_category.py
...
# x-ms-original-file: specification/monitor/resource-manager/Microsoft.Insights/preview/2021-05-01-preview/examples/createOrUpdateSubscriptionDiagnosticSettingCategory.json
