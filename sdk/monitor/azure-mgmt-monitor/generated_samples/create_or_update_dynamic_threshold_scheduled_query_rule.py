...
# USAGE
    python create_or_update_dynamic_threshold_scheduled_query_rule.py
...
# x-ms-original-file: specification/monitor/resource-manager/Microsoft.Insights/preview/2025-01-01-preview/examples/createOrUpdateDynamicThresholdScheduledQueryRule.json
