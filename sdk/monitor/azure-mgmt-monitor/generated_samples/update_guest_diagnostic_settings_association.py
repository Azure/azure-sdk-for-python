...
# USAGE
    python update_guest_diagnostic_settings_association.py
...
def main():
    ...
    response = client.guest_diagnostics_settings_association.update(
...
# x-ms-original-file: specification/monitor/resource-manager/Microsoft.Insights/preview/2018-06-01-preview/examples/updateGuestDiagnosticSettingsAssociation.json
