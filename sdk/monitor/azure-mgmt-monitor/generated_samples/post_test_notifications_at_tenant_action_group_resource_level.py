...
# USAGE
    python post_test_notifications_at_tenant_action_group_resource_level.py
...
def main():
    ...
    response = client.begin_create_notifications_at_tenant_action_group_resource_level(
...
# x-ms-original-file: specification/monitor/resource-manager/Microsoft.Insights/Insights/preview/2023-05-01-preview/examples/postTestNotificationsAtTenantActionGroupResourceLevel.json
