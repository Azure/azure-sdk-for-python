...
# USAGE
    python create_or_update_scheduled_query_rule_subscription.py
...
# x-ms-original-file: specification/monitor/resource-manager/Microsoft.Insights/preview/2025-01-01-preview/examples/createOrUpdateScheduledQueryRuleSubscription.json
