...
Code samples for this package can be found at [Monitor](https://docs.microsoft.com/samples/azure-samples/azure-samples-python-management/monitoring?view=azure-python-preview) on docs.microsoft.com.
