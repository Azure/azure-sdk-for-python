...
class TestMonitorManagementDiagnosticSettingsCategoryOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(MonitorManagementClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_diagnostic_settings_category_get(self, resource_group):
