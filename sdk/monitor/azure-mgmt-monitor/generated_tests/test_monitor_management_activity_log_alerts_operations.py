...
class TestMonitorManagementActivityLogAlertsOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_activity_log_alerts_create_or_update(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_activity_log_alerts_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_activity_log_alerts_delete(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_activity_log_alerts_update(self, resource_group):
