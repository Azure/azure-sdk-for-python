...
class TestMonitorManagementAzureMonitorWorkspacesOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_azure_monitor_workspaces_create(self, resource_group):
        response = await self.client.azure_monitor_workspaces.create(
            resource_group_name=resource_group.name,
            azure_monitor_workspace_name="str",
