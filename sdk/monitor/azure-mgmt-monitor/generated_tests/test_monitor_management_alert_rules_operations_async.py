...
class TestMonitorManagementAlertRulesOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_alert_rules_update(self, resource_group):
        response = await self.client.alert_rules.update(
            resource_group_name=resource_group.name,
            rule_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_alert_rules_list_by_resource_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_alert_rules_list_by_subscription(self, resource_group):
