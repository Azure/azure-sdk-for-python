...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.monitor.v2020_01_01_preview.aio import MonitorManagementClient
...
class TestMonitorManagementManagementGroupDiagnosticSettingsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_management_group_diagnostic_settings_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_management_group_diagnostic_settings_create_or_update(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_management_group_diagnostic_settings_delete(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_management_group_diagnostic_settings_list(self, resource_group):
