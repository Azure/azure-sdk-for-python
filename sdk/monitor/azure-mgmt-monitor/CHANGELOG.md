...
### Features Added
  ...
  - Model `ResourceAutoGenerated2` added property `location`
  - Model `ResourceAutoGenerated2` added property `tags`
  - Model `ResourceAutoGenerated4` added property `location`
  - Model `ResourceAutoGenerated4` added property `tags`
  - Model `ResourceAutoGenerated5` added property `location`
  - Model `ResourceAutoGenerated5` added property `tags`
  ...
  - Model `MetricDefinitionsOperations` added method `list_at_subscription_scope`
  - Model `MetricsOperations` added method `list_at_subscription_scope`
  - Model `MetricsOperations` added method `list_at_subscription_scope_post`
...
### Breaking Changes
  ...
  - Model `ResourceAutoGenerated3` deleted or renamed its instance variable `kind`
  - Model `ResourceAutoGenerated3` deleted or renamed its instance variable `etag`
  - Model `ResourceAutoGenerated4` deleted or renamed its instance variable `system_data`
  - Model `ResourceAutoGenerated5` deleted or renamed its instance variable `system_data`
  ...
  - Deleted or renamed method `ActionGroupsOperations.begin_create_notifications_at_resource_group_level`
  - Deleted or renamed method `ActionGroupsOperations.begin_post_test_notifications`
  - Deleted or renamed method `ActionGroupsOperations.get_test_notifications`
  - Deleted or renamed method `ActionGroupsOperations.get_test_notifications_at_resource_group_level`
  - Method `ActivityLogAlertsOperations.create_or_update` inserted a `positional_or_keyword` parameter `activity_log_alert_rule`
  - Method `ActivityLogAlertsOperations.create_or_update` deleted or renamed its parameter `activity_log_alert` of kind `positional_or_keyword`
  - Method `ActivityLogAlertsOperations.update` inserted a `positional_or_keyword` parameter `activity_log_alert_rule_patch`
  - Method `ActivityLogAlertsOperations.update` deleted or renamed its parameter `activity_log_alert_patch` of kind `positional_or_keyword`
  - Method `ScheduledQueryRulesOperations.list_by_resource_group` deleted or renamed its parameter `filter` of kind `positional_or_keyword`
  - Method `ScheduledQueryRulesOperations.list_by_subscription` deleted or renamed its parameter `filter` of kind `positional_or_keyword`
  - Method `ActivityLogAlertsOperations.update` re-ordered its parameters from `['self', 'resource_group_name', 'activity_log_alert_name', 'activity_log_alert_patch', 'kwargs']` to `['self', 'resource_group_name', 'activity_log_alert_name', 'activity_log_alert_rule_patch', 'kwargs']`
  - Method `ActivityLogAlertsOperations.create_or_update` re-ordered its parameters from `['self', 'resource_group_name', 'activity_log_alert_name', 'activity_log_alert', 'kwargs']` to `['self', 'resource_group_name', 'activity_log_alert_name', 'activity_log_alert_rule', 'kwargs']`
