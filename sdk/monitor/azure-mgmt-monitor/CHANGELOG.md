...
### Breaking Changes
  ...
  - Model `ActionGroupResource` moved instance variable `group_short_name`, `enabled`, `email_receivers`, `sms_receivers`, `webhook_receivers`, `itsm_receivers`, `azure_app_push_receivers`, `automation_runbook_receivers`, `voice_receivers`, `logic_app_receivers`, `azure_function_receivers`, `arm_role_receivers` and `event_hub_receivers` under property `properties` whose type is `ActionGroup`
  ...
  - Model `AutoscaleSettingResource` moved instance variable `profiles`, `notifications`, `enabled`, `predictive_autoscale_policy`, `target_resource_uri` and `target_resource_location` under property `properties` whose type is `AutoscaleSetting`
  ...
  - Model `Dimension` renamed its instance variable `values` to `values_property`
  - Model `ErrorResponseAutoGenerated` deleted or renamed its instance variable `code`
  - Model `ErrorResponseAutoGenerated` deleted or renamed its instance variable `message`
  ...
  - Model `MetricDimension` renamed its instance variable `values` to `values_property`
  - Model `Resource` deleted or renamed its instance variable `location`
  - Model `Resource` deleted or renamed its instance variable `tags`
  - Model `ScaleRuleMetricDimension` renamed its instance variable `values` to `values_property`
  ...
  - Renamed model `ErrorResponseCommon` to `CommonErrorResponse`
  ...
  - Deleted or renamed operation group `AzureMonitorWorkspacesOperations`
  - Deleted or renamed operation group `DiagnosticSettingsCategoryOperations`
  - Deleted or renamed operation group `DiagnosticSettingsOperations`
  - Deleted or renamed operation group `GuestDiagnosticsSettingsAssociationOperations`
  - Deleted or renamed operation group `GuestDiagnosticsSettingsOperations`
  - Deleted or renamed operation group `MonitorOperationsOperations`
  - Deleted or renamed operation group `Operations`
  - Deleted or renamed operation group `SubscriptionDiagnosticSettingsOperations`
  - Deleted or renamed operation group `VMInsightsOperations`
...
### Other Changes
  ...
  - Deleted model `ActionGroupList`/`AlertRuleList`/`AutoscaleSettingResourceCollection`/`AzureMonitorWorkspace`/`AzureMonitorWorkspaceDefaultIngestionSettings`/`AzureMonitorWorkspaceMetrics`/`AzureMonitorWorkspaceResource`/`AzureMonitorWorkspaceResourceForUpdate`/`AzureMonitorWorkspaceResourceProperties`/`AzureResource`/`AzureResourceAutoGenerated`/`DataCollectionEndpointResourceSystemData`/`DataCollectionRuleAssociationProxyOnlyResourceSystemData`/`DataCollectionRuleResourceSystemData`/`DataContainer`/`DataSource`/`DataSourceConfiguration`/`DiagnosticSettingsCategoryResource`/`DiagnosticSettingsCategoryResourceCollection`/`DiagnosticSettingsResource`/`DiagnosticSettingsResourceCollection`/`Error`/`ErrorDetailAdditionalInfoItemAutoGenerated`/`ErrorDetailAutoGenerated2`/`ErrorDetailAutoGenerated3`/`ErrorResponseAutoGenerated2`/`ErrorResponseAutoGenerated3`/`ErrorResponseAutoGenerated4`/`ErrorResponseAutoGenerated5`/`ErrorResponseErrorAdditionalInfoItemAutoGenerated`/`ErrorResponseErrorAutoGenerated`/`EtwEventConfiguration`/`EtwProviderConfiguration`/`EventCategoryCollection`/`EventDataCollection`/`EventLogConfiguration`/`GuestDiagnosticSettingsAssociationList`/`GuestDiagnosticSettingsAssociationResource`/`GuestDiagnosticSettingsAssociationResourcePatch`/`GuestDiagnosticSettingsList`/`GuestDiagnosticSettingsPatchResource`/`GuestDiagnosticSettingsResource`/`IdentityAutoGenerated`/`IngestionSettings`/`LocalizableStringAutoGenerated`/`LogProfileCollection`/`LogSettingsAutoGenerated`/`MetricAlertResourceCollection`/`MetricBaselinesResponse`/`MetricDefinitionCollection`/`MetricNamespaceCollection`/`MetricSettingsAutoGenerated`/`Metrics`/`Operation`/`OperationAutoGenerated`/`OperationDisplay`/`OperationDisplayAutoGenerated`/`OperationListResultAutoGenerated`/`PerformanceCounterConfiguration`/`PrivateEndpointConnectionAutoGenerated`/`PrivateEndpointProperty`/`PrivateLinkScopesResource`/`PrivateLinkServiceConnectionStateProperty`/`ProxyOnlyResource`/`ResourceAutoGenerated`/`ResourceAutoGenerated2`/`ResourceAutoGenerated3`/`ResourceAutoGenerated4`/`ResourceAutoGenerated5`/`ResourceAutoGenerated6`/`ResourceAutoGenerated7`/`ResourceAutoGenerated8`/`ResponseWithError`/`ScheduledQueryRuleResourceCollection`/`SinkConfiguration`/`SubscriptionDiagnosticSettingsResource`/`SubscriptionDiagnosticSettingsResourceCollection`/`SubscriptionLogSettings`/`SubscriptionProxyOnlyResource`/`SubscriptionScopeMetricDefinitionCollection`/`UserIdentityPropertiesAutoGenerated`/`VMInsightsOnboardingStatus`/`WorkspaceInfo` which actually were not used by SDK users
