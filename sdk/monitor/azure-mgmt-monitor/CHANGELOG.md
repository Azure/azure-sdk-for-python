...
### Features Added
  ...
  - Model `ServiceDiagnosticSettingsResource` added property `properties`
  - Model `ServiceDiagnosticSettingsResource` added property `system_data`
  - Model `ServiceDiagnosticSettingsResourcePatch` added property `properties`
...
### Breaking Changes
  ...
  - Model `MetricAlertResource` deleted or renamed its instance variable `resolve_configuration`
  ...
  - Model `MetricAlertResource` deleted or renamed its instance variable `custom_properties`
  - Model `MetricAlertResource` deleted or renamed its instance variable `action_properties`
  ...
  - Model `MetricAlertResourcePatch` deleted or renamed its instance variable `resolve_configuration`
  ...
  - Model `MetricAlertResourcePatch` deleted or renamed its instance variable `custom_properties`
  - Model `MetricAlertResourcePatch` deleted or renamed its instance variable `action_properties`
  ...
  - Model `PrivateEndpointConnectionListResult` deleted or renamed its instance variable `next_link`
  ...
  - Model `ServiceDiagnosticSettingsResource` deleted or renamed its instance variable `storage_account_id`
  - Model `ServiceDiagnosticSettingsResource` deleted or renamed its instance variable `service_bus_rule_id`
  - Model `ServiceDiagnosticSettingsResource` deleted or renamed its instance variable `event_hub_authorization_rule_id`
  - Model `ServiceDiagnosticSettingsResource` deleted or renamed its instance variable `metrics`
  - Model `ServiceDiagnosticSettingsResource` deleted or renamed its instance variable `logs`
  - Model `ServiceDiagnosticSettingsResource` deleted or renamed its instance variable `workspace_id`
  - Model `ServiceDiagnosticSettingsResourcePatch` deleted or renamed its instance variable `storage_account_id`
  - Model `ServiceDiagnosticSettingsResourcePatch` deleted or renamed its instance variable `service_bus_rule_id`
  - Model `ServiceDiagnosticSettingsResourcePatch` deleted or renamed its instance variable `event_hub_authorization_rule_id`
  - Model `ServiceDiagnosticSettingsResourcePatch` deleted or renamed its instance variable `metrics`
  - Model `ServiceDiagnosticSettingsResourcePatch` deleted or renamed its instance variable `logs`
  - Model `ServiceDiagnosticSettingsResourcePatch` deleted or renamed its instance variable `workspace_id`
  ...
  - Deleted or renamed model `ErrorDetailAdditionalInfoItemAutoGenerated`
  - Deleted or renamed model `ErrorDetailAutoGenerated2`
  - Deleted or renamed model `ErrorDetailAutoGenerated3`
  ...
  - Deleted or renamed model `ErrorResponseErrorAdditionalInfoItemAutoGenerated`
  - Deleted or renamed model `ErrorResponseErrorAutoGenerated`
  ...
  - Deleted or renamed model `IdentityAutoGenerated`
  ...
  - Deleted or renamed model `UserIdentityPropertiesAutoGenerated`
  ...
  - Method `PrivateEndpointConnectionsOperations.list_by_private_link_scope` changed return type from `AsyncItemPaged[_models.PrivateEndpointConnection]` to `PrivateEndpointConnectionListResult`
  - Method `PrivateLinkResourcesOperations.list_by_private_link_scope` changed return type from `AsyncItemPaged[_models.PrivateLinkResource]` to `PrivateLinkResourceListResult`
  - Method `DiagnosticSettingsOperations.create_or_update` changed return type from `DiagnosticSettingsResource` to `ServiceDiagnosticSettingsResource`
  - Method `DiagnosticSettingsOperations.get` changed return type from `DiagnosticSettingsResource` to `ServiceDiagnosticSettingsResource`
  - Method `PrivateEndpointConnectionsOperations.list_by_private_link_scope` changed return type from `ItemPaged[_models.PrivateEndpointConnection]` to `PrivateEndpointConnectionListResult`
  - Method `PrivateLinkResourcesOperations.list_by_private_link_scope` changed return type from `ItemPaged[_models.PrivateLinkResource]` to `PrivateLinkResourceListResult`
