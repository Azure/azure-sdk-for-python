...
### Features Added
  ...
  - Model `ActionGroupResource` added property `incident_receivers`
  ...
  - Model `AzureResource` added property `identity`
  - Model `ErrorResponseAutoGenerated` added property `code`
  - Model `ErrorResponseAutoGenerated` added property `message`
  - Model `ErrorResponseAutoGenerated` added property `target`
  - Model `ErrorResponseAutoGenerated` added property `details`
  - Model `ErrorResponseAutoGenerated` added property `additional_info`
