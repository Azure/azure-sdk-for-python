...
### Breaking Changes
  ...
  - Parameter `delete_associations` of `DataCollectionRulesOperations.delete` is now optional and keyword-only
  ...
  - Deleted or renamed operation group `ServiceDiagnosticSettingsOperations`
