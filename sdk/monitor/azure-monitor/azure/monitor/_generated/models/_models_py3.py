...
class AvailabilityData(MonitorDomain):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AvailabilityData, self).__init__(test=test, **kwargs)
...
class MessageData(MonitorDomain):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(MessageData, self).__init__(test=test, **kwargs)
        self.version = version
        self.message = message
...
class MetricsData(MonitorDomain):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(MetricsData, self).__init__(test=test, **kwargs)
        self.version = version
...
class PageViewData(MonitorDomain):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PageViewData, self).__init__(test=test, **kwargs)
        self.version = version
        self.id = id
        self.name = name
        self.url = url
...
class PageViewPerfData(MonitorDomain):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PageViewPerfData, self).__init__(test=test, **kwargs)
        self.version = version
        self.id = id
        self.name = name
        self.url = url
...
class RemoteDependencyData(MonitorDomain):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RemoteDependencyData, self).__init__(test=test, **kwargs)
        self.version = version
        self.id = id
        self.name = name
...
class RequestData(MonitorDomain):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RequestData, self).__init__(test=test, **kwargs)
        self.version = version
        self.id = id
        self.name = name
        self.duration = duration
...
class TelemetryEventData(MonitorDomain):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(TelemetryEventData, self).__init__(test=test, **kwargs)
        self.version = version
        self.name = name
        self.properties = properties
        self.measurements = measurements
...
class TelemetryExceptionData(MonitorDomain):
    ...
    def __init__(
        ...
        *,
        version: int = 2,
        test: Optional[str] = None,
        exceptions: Optional[List["TelemetryExceptionDetails"]] = None,
        severity_level: Optional[Union[str, "SeverityLevel"]] = None,
        ...
        **kwargs
        ...
        super(TelemetryExceptionData, self).__init__(test=test, **kwargs)
        self.version = version
