...
from azure.opentelemetry.sdk.azuremonitor.auto_collection._performance_metrics import (
    PerformanceMetrics,
)
from azure.opentelemetry.sdk.azuremonitor.auto_collection._utils import AutoCollectionType
