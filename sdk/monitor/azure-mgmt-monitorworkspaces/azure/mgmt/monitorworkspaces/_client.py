...
class MonitorClient:
    ...
    :vartype azure_monitor_workspaces:
     azure.mgmt.monitorworkspaces.operations.AzureMonitorWorkspacesOperations
    :ivar issue: IssueOperations operations
    :vartype issue: azure.mgmt.monitorworkspaces.operations.IssueOperations
    :ivar metrics_containers: MetricsContainersOperations operations
    :vartype metrics_containers:
     azure.mgmt.monitorworkspaces.operations.MetricsContainersOperations
