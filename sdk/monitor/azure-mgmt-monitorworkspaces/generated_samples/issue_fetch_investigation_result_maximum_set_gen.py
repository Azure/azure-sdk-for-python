...
# USAGE
    python issue_fetch_investigation_result_maximum_set_gen.py
...
def main():
    ...
    response = client.issue.fetch_investigation_result(
        resource_group_name="rg1",
        azure_monitor_workspace_name="myWorkspace",
        issue_name="3f29e1b2b05f8371595dc761fed8e8b3",
        body={"investigationId": "b7341c85-b2c7-46ea-9a7f-784823b71fbc"},
    )
    print(response)
