...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.monitorworkspaces.aio import MonitorWorkspacesMgmtClient
...
class TestMonitorWorkspacesMgmtIssueOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(MonitorWorkspacesMgmtClient, is_async=True)
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_issue_add_investigation_result(self, resource_group):
        response = await self.client.issue.add_investigation_result(
            resource_group_name=resource_group.name,
            azure_monitor_workspace_name="str",
            issue_name="str",
            body={
    ...
    async def test_issue_list_alerts(self, resource_group):
        response = await self.client.issue.list_alerts(
            resource_group_name=resource_group.name,
            azure_monitor_workspace_name="str",
            issue_name="str",
            body={"filter": "str"},
    ...
    async def test_issue_list_resources(self, resource_group):
        response = await self.client.issue.list_resources(
            resource_group_name=resource_group.name,
            azure_monitor_workspace_name="str",
            issue_name="str",
            body={"filter": "str"},
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_issue_fetch_background_visualization(self, resource_group):
        response = await self.client.issue.fetch_background_visualization(
            resource_group_name=resource_group.name,
            azure_monitor_workspace_name="str",
            issue_name="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_issue_set_background_visualization(self, resource_group):
        response = await self.client.issue.set_background_visualization(
            resource_group_name=resource_group.name,
            azure_monitor_workspace_name="str",
            issue_name="str",
