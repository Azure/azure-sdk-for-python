...
class TestMonitorAzureMonitorWorkspacesOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_azure_monitor_workspaces_create_or_update(self, resource_group):
        response = self.client.azure_monitor_workspaces.create_or_update(
            resource_group_name=resource_group.name,
            azure_monitor_workspace_name="str",
            resource={
                "location": "str",
