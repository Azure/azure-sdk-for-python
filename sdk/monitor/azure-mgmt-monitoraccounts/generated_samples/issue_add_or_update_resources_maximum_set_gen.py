...
# USAGE
    python issue_add_or_update_resources_maximum_set_gen.py
...
def main():
    ...
    response = client.issue.add_or_update_resources(
            ...
            "value": [
                {
                    ...
                    "origin": {"addedBy": "171a811c-2a3a-4e6c-b742-f78f5f6ca51c", "addedByType": "Manual"},
                    "relevance": "Relevant",
                }
            ]
        },
