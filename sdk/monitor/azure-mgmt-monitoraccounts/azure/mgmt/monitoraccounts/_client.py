...
class MonitorClient:
    ...
    :vartype operations: azure.mgmt.monitoraccounts.operations.Operations
    :ivar azure_monitor_workspaces: AzureMonitorWorkspacesOperations operations
    :vartype azure_monitor_workspaces:
     azure.mgmt.monitoraccounts.operations.AzureMonitorWorkspacesOperations
    :ivar issue: IssueOperations operations
    :vartype issue: azure.mgmt.monitoraccounts.operations.IssueOperations
    :ivar metrics_containers: MetricsContainersOperations operations
    :vartype metrics_containers: azure.mgmt.monitoraccounts.operations.MetricsContainersOperations
