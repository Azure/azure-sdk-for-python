...
class MonitorClient:
    ...
    :vartype azure_monitor_workspaces:
     azure.mgmt.monitoraccounts.aio.operations.AzureMonitorWorkspacesOperations
    :ivar issue: IssueOperations operations
    :vartype issue: azure.mgmt.monitoraccounts.aio.operations.IssueOperations
    :ivar metrics_containers: MetricsContainersOperations operations
    :vartype metrics_containers:
     azure.mgmt.monitoraccounts.aio.operations.MetricsContainersOperations
