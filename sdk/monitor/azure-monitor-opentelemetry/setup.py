...
setup(
    ...
    install_requires=[
        ...
        "opentelemetry-instrumentation-django>=0.59b0,<0.61b0",
        "opentelemetry-instrumentation-fastapi>=0.59b0,<0.61b0",
        "opentelemetry-instrumentation-flask>=0.59b0,<0.61b0",
        "opentelemetry-instrumentation-psycopg2>=0.59b0,<0.61b0",
        "opentelemetry-instrumentation-requests>=0.59b0,<0.61b0",
        "opentelemetry-instrumentation-urllib>=0.59b0,<0.61b0",
        "opentelemetry-instrumentation-urllib3>=0.59b0,<0.61b0",
