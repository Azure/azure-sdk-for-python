...
setup(
    ...
    install_requires=[
        ...
        "opentelemetry-instrumentation-django>=0.63b0,<0.64.0",
        "opentelemetry-instrumentation-fastapi>=0.63b0,<0.64.0",
        "opentelemetry-instrumentation-flask>=0.63b0,<0.64.0",
        "opentelemetry-instrumentation-psycopg2>=0.63b0,<0.64.0",
        "opentelemetry-instrumentation-requests>=0.63b0,<0.64.0",
        "opentelemetry-instrumentation-urllib>=0.63b0,<0.64.0",
        "opentelemetry-instrumentation-urllib3>=0.63b0,<0.64.0",
        "opentelemetry-instrumentation-logging>=0.63b0,<0.64.0",
