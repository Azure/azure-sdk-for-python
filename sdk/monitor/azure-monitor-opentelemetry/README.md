...
| `log_record_processors` | A list of [log record processors][ot_log_record_processor] that will process log records before they are exported. Useful for filtering/modifying telemetry. | `N/A` |
