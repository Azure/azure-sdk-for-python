...
class TestDistro(TestCase):
    ...
    @patch(
        "azure.monitor.opentelemetry._autoinstrumentation.distro._is_attach_enabled",
        return_value=True,
    )
    ...
    @patch.dict(
        "os.environ",
        {"OTEL_PYTHON_DISABLED_INSTRUMENTATIONS": " flask,azure_sdk , urllib3"},
        clear=True,
    )
    @patch(
        "azure.monitor.opentelemetry._autoinstrumentation.distro._is_attach_enabled",
    ...
    @patch(
        "azure.monitor.opentelemetry._autoinstrumentation.distro._configure_auto_instrumentation"
    )
    @patch(
        "azure.monitor.opentelemetry._autoinstrumentation.distro._is_attach_enabled",
        return_value=True,
