# pylint: disable=line-too-long,useless-suppression,too-many-locals
# coding=utf-8
# --------------------------------------------------------------------------
...
from ..._operations._operations import build_metrics_query_resources_request
...
class _MetricsClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], MetricsClientConfiguration]
):
