...
from .._utils import get_timespan_iso8601_endpoints, get_subscription_id_from_resource
...
class MetricsClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(self, endpoint: str, credential: AsyncTokenCredential, **kwargs: Any) -> None:
        ...
        self._client = MonitorQueryMetricsClient(
            credential=credential, endpoint=self._endpoint, credential_scopes=credential_scopes, **kwargs
        )
    ...
    async def query_resources(
        ...
        **kwargs: Any,
        ...
        generated = await self._client.query_resources(
