...
from ..._operations._operations import build_monitor_query_metrics_query_resources_request
...
class _MonitorQueryMetricsClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], MonitorQueryMetricsClientConfiguration]
):
    ...
    async def query_resources(
        self,
        subscription_id: str,
        batch_request: _models.ResourceIdList,
        *,
        ...
        **kwargs: Any
        ...
        :type batch_request: ~azure.monitor.querymetrics._generated.models.ResourceIdList
        ...
        :rtype: ~azure.monitor.querymetrics._generated.models.MetricResultsResponse
    ...
    async def query_resources(
        self,
        subscription_id: str,
        batch_request: Union[_models.ResourceIdList, JSON, IO[bytes]],
        *,
        metric_namespace: str,
        metric_names: List[str],
        start_time: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        :type batch_request: ~azure.monitor.querymetrics._generated.models.ResourceIdList or JSON or
         IO[bytes]
        :keyword metric_namespace: Metric namespace that contains the requested metric names. Required.
        :paramtype metric_namespace: str
        :keyword metric_names: The names of the metrics (comma separated) to retrieve. Required.
        ...
        cls: ClsType[_models.MetricResultsResponse] = kwargs.pop("cls", None)
        ...
        _request = build_monitor_query_metrics_query_resources_request(
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.MetricResultsResponse, response.json())
