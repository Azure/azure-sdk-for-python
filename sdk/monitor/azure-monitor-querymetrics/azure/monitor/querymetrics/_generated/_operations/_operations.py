...
def build_monitor_query_metrics_query_resources_request(  # pylint: disable=name-too-long
    subscription_id: str,
    *,
...
class _MonitorQueryMetricsClientOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], MonitorQueryMetricsClientConfiguration]
):
