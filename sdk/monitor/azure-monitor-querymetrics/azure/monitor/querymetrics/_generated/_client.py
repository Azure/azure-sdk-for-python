...
from ._operations._operations import _MonitorQueryMetricsClientOperationsMixin
...
class MonitorQueryMetricsClient(_MonitorQueryMetricsClientOperationsMixin):
    """MonitorQueryMetricsClient.
    ...
    def __init__(self, endpoint: str, credential: "TokenCredential", **kwargs: Any) -> None:
        _endpoint = "{endpoint}"
        self._config = MonitorQueryMetricsClientConfiguration(endpoint=endpoint, credential=credential, **kwargs)
