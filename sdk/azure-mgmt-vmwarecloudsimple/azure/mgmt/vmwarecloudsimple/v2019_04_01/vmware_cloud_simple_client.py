...
class VMwareCloudSimpleClient(SDKClient):
    ...
    def get_operation_result_by_region(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.vmwarecloudsimple.v2019_04_01.models.OperationResource]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.vmwarecloudsimple.v2019_04_01.models.OperationResource]]
        :raises:
