...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.lambdatesthyperexecute.aio.LambdaTestHyperExecuteMgmtClient`'s
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.Operation"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.lambdatesthyperexecute.models.Operation]
...
class OrganizationsOperations:
    ...
    async def get(self, resource_group_name: str, organizationname: str, **kwargs: Any) -> _models.OrganizationResource:
        ...
        :rtype: ~azure.mgmt.lambdatesthyperexecute.models.OrganizationResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.lambdatesthyperexecute.models.OrganizationResource
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.lambdatesthyperexecute.models.OrganizationResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.lambdatesthyperexecute.models.OrganizationResource or JSON or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns OrganizationResource. The
         OrganizationResource is compatible with MutableMapping
        :rtype:
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.lambdatesthyperexecute.models.OrganizationResourceUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: OrganizationResource. The OrganizationResource is compatible with MutableMapping
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.lambdatesthyperexecute.models.OrganizationResourceUpdate or JSON
         or IO[bytes]
        :return: OrganizationResource. The OrganizationResource is compatible with MutableMapping
        :rtype: ~azure.mgmt.lambdatesthyperexecute.models.OrganizationResource
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.lambdatesthyperexecute.models.OrganizationResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
