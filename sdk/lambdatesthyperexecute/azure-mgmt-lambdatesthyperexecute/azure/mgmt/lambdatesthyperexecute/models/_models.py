...
class ErrorDetail(_Model):
    ...
    :vartype details: list[~azure.mgmt.lambdatesthyperexecute.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.lambdatesthyperexecute.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_Model):
    ...
    :vartype error: ~azure.mgmt.lambdatesthyperexecute.models.ErrorDetail
    """
...
class ManagedServiceIdentity(_Model):
    ...
    :vartype type: str or ~azure.mgmt.lambdatesthyperexecute.models.ManagedServiceIdentityType
    :ivar user_assigned_identities: The identities assigned to this resource by the user.
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.lambdatesthyperexecute.models.UserAssignedIdentity]
    """
...
class MarketplaceDetails(_Model):
    ...
    :vartype subscription_status: str or
     ~azure.mgmt.lambdatesthyperexecute.models.MarketplaceSubscriptionStatus
    :ivar offer_details: Offer details for the marketplace that is selected by the user. Required.
    :vartype offer_details: ~azure.mgmt.lambdatesthyperexecute.models.OfferDetails
    """
...
class Operation(_Model):
    ...
    :vartype display: ~azure.mgmt.lambdatesthyperexecute.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.lambdatesthyperexecute.models.Origin
    :ivar action_type: Extensible enum. Indicates the action type. "Internal" refers to actions
     that are for internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.lambdatesthyperexecute.models.ActionType
    """
...
class OrganizationProperties(_Model):
    ...
    :vartype marketplace: ~azure.mgmt.lambdatesthyperexecute.models.MarketplaceDetails
    :ivar user: Details of the user. Required.
    :vartype user: ~azure.mgmt.lambdatesthyperexecute.models.UserDetails
    :ivar provisioning_state: Provisioning state of the resource. Known values are: "Succeeded",
     "Failed", and "Canceled".
    :vartype provisioning_state: str or
     ~azure.mgmt.lambdatesthyperexecute.models.ResourceProvisioningState
    :ivar partner_properties: partner properties. Required.
    :vartype partner_properties: ~azure.mgmt.lambdatesthyperexecute.models.PartnerProperties
    :ivar single_sign_on_properties: Single sign-on properties.
    :vartype single_sign_on_properties:
     ~azure.mgmt.lambdatesthyperexecute.models.SingleSignOnPropertiesV2
    """
...
class Resource(_Model):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.lambdatesthyperexecute.models.SystemData
    """
...
class OrganizationResource(TrackedResource):
    ...
    :vartype properties: ~azure.mgmt.lambdatesthyperexecute.models.OrganizationProperties
    :ivar identity: The managed service identities assigned to this resource.
    :vartype identity: ~azure.mgmt.lambdatesthyperexecute.models.ManagedServiceIdentity
    """
...
class PartnerProperties(_Model):
    ...
    :ivar licenses_subscribed: The number of licenses subscribed. Required.
    :vartype licenses_subscribed: int
    """

    licenses_subscribed: int = rest_field(
        name="licensesSubscribed", visibility=["read", "create", "update", "delete", "query"]
    )
    """The number of licenses subscribed. Required."""
...
class SingleSignOnPropertiesV2(_Model):
    ...
    :ivar type: Type of Single Sign-On mechanism being used. Required. Known values are: "Saml" and
     "OpenId".
    :vartype type: str or ~azure.mgmt.lambdatesthyperexecute.models.SingleSignOnType
    :ivar state: State of the Single Sign On for the resource. Known values are: "Initial",
     "Enable", and "Disable".
    :vartype state: str or ~azure.mgmt.lambdatesthyperexecute.models.SingleSignOnStates
...
class SystemData(_Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.lambdatesthyperexecute.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or ~azure.mgmt.lambdatesthyperexecute.models.CreatedByType
