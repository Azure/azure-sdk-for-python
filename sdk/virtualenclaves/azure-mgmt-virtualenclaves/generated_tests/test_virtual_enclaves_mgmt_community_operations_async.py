...
class TestVirtualEnclavesMgmtCommunityOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_community_get(self, resource_group):
        response = await self.client.community.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_community_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.community.begin_create_or_update(
                resource_group_name=resource_group.name,
                community_name="str",
                resource={
                    "location": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_community_begin_update(self, resource_group):
        response = await (
            await self.client.community.begin_update(
                resource_group_name=resource_group.name,
                community_name="str",
                properties={
                    "identity": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_community_begin_delete(self, resource_group):
        response = await (
            await self.client.community.begin_delete(
                resource_group_name=resource_group.name,
                community_name="str",
            )
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_community_check_address_space_availability(self, resource_group):
        response = await self.client.community.check_address_space_availability(
            resource_group_name=resource_group.name,
            community_name="str",
