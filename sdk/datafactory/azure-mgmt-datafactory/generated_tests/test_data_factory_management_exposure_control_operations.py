...
class TestDataFactoryManagementExposureControlOperations(AzureMgmtRecordedTestCase):
    ...
    def test_exposure_control_query_feature_values_by_factory(self, resource_group):
        response = self.client.exposure_control.query_feature_values_by_factory(
            resource_group_name=resource_group.name,
            factory_name="str",
            exposure_control_batch_request={"exposureControlRequests": [{"featureName": "str", "featureType": "str"}]},
            api_version="2018-06-01",
        )
