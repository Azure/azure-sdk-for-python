...
class DataFactoryManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype integration_runtime:
     azure.mgmt.datafactory.aio.operations.IntegrationRuntimeOperations
    ...
    :keyword api_version: The API version to use for this operation. Known values are "2018-06-01"
     and None. Default value is "2018-06-01". Note that overriding this default value may result in
