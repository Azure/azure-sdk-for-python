...
class BlobTrigger(MultiplePipelineTrigger):
    ...
    def __init__(self, folder_path, max_concurrency, linked_service, additional_properties=None, description=None, annotations=None, pipelines=None):
        super(BlobTrigger, self).__init__(additional_properties=additional_properties, description=description, annotations=annotations, pipelines=pipelines)
