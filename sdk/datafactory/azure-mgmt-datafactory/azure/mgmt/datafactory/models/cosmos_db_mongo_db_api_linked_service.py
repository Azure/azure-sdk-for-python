...
class CosmosDbMongoDbApiLinkedService(LinkedService):
    ...
    :type type: str
    :param connection_string: The CosmosDB (MongoDB API) connection string.
     Type: string, SecureString or AzureKeyVaultSecretReference. Type: string,
     SecureString or AzureKeyVaultSecretReference.
    :type connection_string: object
    :param database: The name of the CosmosDB (MongoDB API) database that you
