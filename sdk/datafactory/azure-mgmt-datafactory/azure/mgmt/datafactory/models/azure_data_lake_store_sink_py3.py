...
class AzureDataLakeStoreSink(CopySink):
    ...
    def __init__(self, *, additional_properties=None, write_batch_size=None, write_batch_timeout=None, sink_retry_count=None, sink_retry_wait=None, max_concurrent_connections=None, disable_metrics_collection=None, copy_behavior=None, enable_adls_single_file_parallel=None, **kwargs) -> None:
