...
class CopySource(Model):
    ...
    SqlDWSource, SqlSource, RestSource, SapOpenHubSource, SapHanaSource,
    SapEccSource, SapCloudForCustomerSource, SalesforceSource,
