...
class CopySource(Model):
    ...
    ODataSource, SybaseSource, SapBwSource, PostgreSqlSource, MySqlSource,
    OdbcSource, Db2Source, RelationalSource, CommonDataServiceForAppsSource,
    DynamicsCrmSource, DynamicsSource, DocumentDbCollectionSource, BlobSource,
    AzureTableSource, DelimitedTextSource, ParquetSource
