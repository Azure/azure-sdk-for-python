...
class AzureDataLakeStoreWriteSetting(StoreWriteSetting):
    ...
    def __init__(self, *, type: str, additional_properties=None, max_concurrent_connections=None, copy_behavior=None, **kwargs) -> None:
        super(AzureDataLakeStoreWriteSetting, self).__init__(additional_properties=additional_properties, type=type, max_concurrent_connections=max_concurrent_connections, copy_behavior=copy_behavior, **kwargs)
