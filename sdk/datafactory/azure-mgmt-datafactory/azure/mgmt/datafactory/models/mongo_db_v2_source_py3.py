...
class MongoDbV2Source(CopySource):
    ...
    def __init__(self, *, additional_properties=None, source_retry_count=None, source_retry_wait=None, max_concurrent_connections=None, disable_metrics_collection=None, filter=None, cursor_methods=None, batch_size=None, **kwargs) -> None:
