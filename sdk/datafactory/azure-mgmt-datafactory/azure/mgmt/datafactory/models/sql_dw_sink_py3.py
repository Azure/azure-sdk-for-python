...
class SqlDWSink(CopySink):
    ...
    def __init__(self, *, additional_properties=None, write_batch_size=None, write_batch_timeout=None, sink_retry_count=None, sink_retry_wait=None, max_concurrent_connections=None, disable_metrics_collection=None, pre_copy_script=None, allow_poly_base=None, poly_base_settings=None, **kwargs) -> None:
