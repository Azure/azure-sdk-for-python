...
class Dataset(Model):
    ...
    AzureSqlTableDataset, AzureTableDataset, JsonDataset, AzureBlobDataset,
    BinaryDataset, DelimitedTextDataset, ParquetDataset, AmazonS3Dataset
