...
class Dataset(Model):
    ...
    WebTableDataset, RestResourceDataset, SqlServerTableDataset,
    SapOpenHubTableDataset, SapHanaTableDataset, SapEccResourceDataset,
    ...
    AzureTableDataset, AzureBlobDataset, AmazonS3Dataset
