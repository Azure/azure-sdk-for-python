...
class Dataset(Model):
    ...
    SalesforceObjectDataset, SybaseTableDataset, SapBwCubeDataset,
    PostgreSqlTableDataset, MySqlTableDataset, OdbcTableDataset,
    Db2TableDataset, AmazonRedshiftTableDataset, RelationalTableDataset,
    ...
    CassandraTableDataset, AzureSqlDWTableDataset, AzureSqlTableDataset,
    AzureTableDataset, AzureBlobDataset, DelimitedTextDataset, ParquetDataset,
    AmazonS3Dataset
