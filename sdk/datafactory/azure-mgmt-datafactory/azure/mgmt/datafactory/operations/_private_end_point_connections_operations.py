...
def build_list_by_factory_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/privateEndPointConnections")  # pylint: disable=line-too-long
...
class PrivateEndPointConnectionsOperations(object):
    ...
    def list_by_factory(
        ...
        factory_name: str,
        **kwargs: Any
    ) -> Iterable["_models.PrivateEndpointConnectionListResponse"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.datafactory.models.PrivateEndpointConnectionListResponse]
