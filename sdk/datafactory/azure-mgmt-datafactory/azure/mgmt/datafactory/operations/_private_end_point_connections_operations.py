...
def build_list_by_factory_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/privateEndPointConnections')
...
class PrivateEndPointConnectionsOperations(object):
    ...
    def list_by_factory(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.PrivateEndpointConnectionListResponse"]
