...
class ManagedVirtualNetworksOperations(object):
    ...
    def list_by_factory(
        ...
        :rtype:
         ~azure.mgmt.datafactory.models.ManagedVirtualNetworkResourcePaged[~azure.mgmt.datafactory.models.ManagedVirtualNetworkResource]
        ...
        if raw:
            header_dict = {}
        deserialized = models.ManagedVirtualNetworkResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def create_or_update(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: ManagedVirtualNetworkResource or ClientRawResponse if
         raw=true
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ManagedVirtualNetworkResource', response)
    ...
    def get(
            self, resource_group_name, factory_name, managed_virtual_network_name, if_none_match=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param managed_virtual_network_name: Managed virtual network name
        :type managed_virtual_network_name: str
        :param if_none_match: ETag of the managed Virtual Network entity.
