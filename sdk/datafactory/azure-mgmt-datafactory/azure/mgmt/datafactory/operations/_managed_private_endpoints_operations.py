...
class ManagedPrivateEndpointsOperations(object):
    ...
    def list_by_factory(
            self, resource_group_name, factory_name, managed_virtual_network_name, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype:
         ~azure.mgmt.datafactory.models.ManagedPrivateEndpointResourcePaged[~azure.mgmt.datafactory.models.ManagedPrivateEndpointResource]
        ...
        if raw:
            header_dict = {}
        deserialized = models.ManagedPrivateEndpointResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def create_or_update(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: ManagedPrivateEndpointResource or ClientRawResponse if
         raw=true
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ManagedPrivateEndpointResource', response)
    ...
    def get(
            self, resource_group_name, factory_name, managed_virtual_network_name, managed_private_endpoint_name, if_none_match=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param managed_private_endpoint_name: Managed private endpoint name
        :type managed_private_endpoint_name: str
        :param if_none_match: ETag of the managed private endpoint entity.
    ...
    def delete(
            self, resource_group_name, factory_name, managed_virtual_network_name, managed_private_endpoint_name, custom_headers=None, raw=False, **operation_config):
