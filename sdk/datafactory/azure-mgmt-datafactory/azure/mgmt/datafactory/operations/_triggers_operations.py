...
class TriggersOperations(object):
    ...
    def list_by_factory(
        ...
        if raw:
            header_dict = {}
        deserialized = models.TriggerResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def create_rerun_trigger(
        ...
        """Creates a rerun trigger for TumblingWindowTrigger.
        ...
        """
        # Construct URL
        url = self.create_rerun_trigger.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'factoryName': self._serialize.url("factory_name", factory_name, 'str', max_length=63, min_length=3, pattern=r'^[A-Za-z0-9]+(?:-[A-Za-z0-9]+)*$'),
        ...
        return deserialized
    create_rerun_trigger.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/triggers/{triggerName}/rerun/{rerunTriggerName}'}

    def list_rerun_triggers(
            self, resource_group_name, factory_name, trigger_name, custom_headers=None, raw=False, **operation_config):
        """Lists rerun triggers by an original trigger name for Tumbling Window
        Trigger.
        ...
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.list_rerun_triggers.metadata['url']
                path_format_arguments = {
                    'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
                    'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
                    'factoryName': self._serialize.url("factory_name", factory_name, 'str', max_length=63, min_length=3, pattern=r'^[A-Za-z0-9]+(?:-[A-Za-z0-9]+)*$'),
        ...
        return deserialized
    list_rerun_triggers.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/triggers/{triggerName}/rerunTriggers'}
