...
class FaceServiceClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype face_lists: azure.ai.vision.face.operations.FaceListsOperations
    :ivar large_face_lists: LargeFaceListsOperations operations
    :vartype large_face_lists: azure.ai.vision.face.operations.LargeFaceListsOperations
    :ivar person_groups: PersonGroupsOperations operations
    :vartype person_groups: azure.ai.vision.face.operations.PersonGroupsOperations
    :ivar large_person_groups: LargePersonGroupsOperations operations
    :vartype large_person_groups: azure.ai.vision.face.operations.LargePersonGroupsOperations
