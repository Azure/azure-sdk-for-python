...
class _FaceClientOperationsMixin(ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], FaceClientConfiguration]):
...
class _FaceSessionClientOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], FaceSessionClientConfiguration]
):
    ...
    @api_version_validation(
        ...
        api_versions_list=["v1.2", "v1.3-preview.1"],
    )
    def create_liveness_session(
    ...
    @api_version_validation(
        method_added_on="v1.2",
        params_added_on={"v1.2": ["session_id"]},
        api_versions_list=["v1.2", "v1.3-preview.1"],
    )
    ...
    @api_version_validation(
        ...
        api_versions_list=["v1.2-preview.1", "v1.2", "v1.3-preview.1"],
    )
    def detect_from_session_image(
        self,
        body: Union[JSON, IO[bytes]] = _Unset,
