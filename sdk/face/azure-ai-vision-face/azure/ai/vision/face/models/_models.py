...
class AbuseMonitoringResult(_Model):
    """The abuse monitoring result for the liveness attempt.

    :ivar is_abuse_detected: Denotes if abuse detection triggered during this liveness attempt.
     Required.
    :vartype is_abuse_detected: ~azure.ai.vision.face.models.HttpPart2
    :ivar other_flagged_sessions: Denotes if abuse detection triggered during this liveness
     attempt. Required.
    :vartype other_flagged_sessions: list[~azure.ai.vision.face.models.OtherFlaggedSessions]
    """

    is_abuse_detected: "_models.HttpPart2" = rest_field(
        name="isAbuseDetected", visibility=["read", "create", "update", "delete", "query"]
    )
    """Denotes if abuse detection triggered during this liveness attempt. Required."""
    other_flagged_sessions: list["_models.OtherFlaggedSessions"] = rest_field(
        name="otherFlaggedSessions", visibility=["read", "create", "update", "delete", "query"]
    )
    """Denotes if abuse detection triggered during this liveness attempt. Required."""
    ...
    def __init__(
        self,
        *,
        is_abuse_detected: "_models.HttpPart2",
        other_flagged_sessions: list["_models.OtherFlaggedSessions"],
    ) -> None: ...
...
class ClientInformation(_Model):
    """The client information gathered during the liveness attempt.

    :ivar ip: The client ip address seen during the liveness attempt. Required.
    :vartype ip: str
    """

    ip: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The client ip address seen during the liveness attempt. Required."""
...
class CreateLivenessSessionContent(_Model):
    ...
    :ivar number_of_client_attempts_allowed: The number of times a client can attempt a liveness
     check using the same authToken. Default value is 1. Maximum value is 3.
    :vartype number_of_client_attempts_allowed: ~azure.ai.vision.face.models.HttpPart
    :ivar user_correlation_id: Unique Guid per each end-user. This is to provide rate limiting and
     anti-hammering. If 'userCorrelationIdSetInClient' is true in this request, this
     'userCorrelationId' must be null.
    :vartype user_correlation_id: str
    :ivar user_correlation_id_set_in_client: Whether or not to allow client to set their own
     'userCorrelationId' via the Vision SDK. Default is false, and 'userCorrelationId' must be set
     in this request body.
    :vartype user_correlation_id_set_in_client: bool
    :ivar expected_client_ip_address: Specify the expected IP address or CIDR block of the client
     that runs the liveness check.
    :vartype expected_client_ip_address: str
    """
    ...
    number_of_client_attempts_allowed: Optional["_models.HttpPart"] = rest_field(
        name="numberOfClientAttemptsAllowed", visibility=["read", "create", "update", "delete", "query"]
    )
    """The number of times a client can attempt a liveness check using the same authToken. Default
     value is 1. Maximum value is 3."""
    user_correlation_id: Optional[str] = rest_field(
        name="userCorrelationId", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    user_correlation_id_set_in_client: Optional[bool] = rest_field(
        name="userCorrelationIdSetInClient", visibility=["read", "create", "update", "delete", "query"]
    )
    """Whether or not to allow client to set their own 'userCorrelationId' via the Vision SDK. Default
     is false, and 'userCorrelationId' must be set in this request body."""
    expected_client_ip_address: Optional[str] = rest_field(
        name="expectedClientIpAddress", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        ...
        number_of_client_attempts_allowed: Optional["_models.HttpPart"] = None,
        user_correlation_id: Optional[str] = None,
        user_correlation_id_set_in_client: Optional[bool] = None,
        expected_client_ip_address: Optional[str] = None,
    ) -> None: ...
...
class CreateLivenessWithVerifySessionContent(_Model):
    ...
    :ivar number_of_client_attempts_allowed: The number of times a client can attempt a liveness
     check using the same authToken. Default value is 1. Maximum value is 3.
    :vartype number_of_client_attempts_allowed: int
    """
    ...
    """Seconds the session should last for. Range is 60 to 86400 seconds. Default value is 600."""
    number_of_client_attempts_allowed: Optional[int] = rest_field(
        name="numberOfClientAttemptsAllowed", visibility=["read", "create", "update", "delete", "query"]
    )
    """The number of times a client can attempt a liveness check using the same authToken. Default
     value is 1. Maximum value is 3."""
    ...
    def __init__(
        ...
        *,
        ...
        device_correlation_id: Optional[str] = None,
        auth_token_time_to_live_in_seconds: Optional[int] = None,
        number_of_client_attempts_allowed: Optional[int] = None,
    ) -> None: ...
...
class HttpPart(_Model):
    """HttpPart."""


class HttpPart1(_Model):
    """HttpPart1."""


class HttpPart2(_Model):
    """HttpPart2."""
...
class LivenessSession(_Model):
    ...
    :ivar is_abuse_monitoring_enabled: Denotes if the abuse monitoring feature was enabled during
     this session.
    :vartype is_abuse_monitoring_enabled: ~azure.ai.vision.face.models.HttpPart1
    :ivar expected_client_ip_address: The expected IP address or CIDR block of the client that runs
     the liveness check.
    :vartype expected_client_ip_address: str
    ...
    """The model version used for liveness classification. This is an optional parameter, and if this
     is not specified, then the latest supported model version will be chosen. \"2024-11-15\""""
    is_abuse_monitoring_enabled: Optional["_models.HttpPart1"] = rest_field(
        name="isAbuseMonitoringEnabled", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        ...
        is_abuse_monitoring_enabled: Optional["_models.HttpPart1"] = None,
        expected_client_ip_address: Optional[str] = None,
    ) -> None: ...
...
class LivenessSessionAttempt(_Model):
    ...
    :ivar client_information: The client information gathered during the liveness attempt.
    :vartype client_information: list[~azure.ai.vision.face.models.ClientInformation]
    :ivar abuse_monitoring_result: The abuse monitoring result for the liveness attempt.
    :vartype abuse_monitoring_result: ~azure.ai.vision.face.models.AbuseMonitoringResult
    """
    ...
    client_information: Optional[list["_models.ClientInformation"]] = rest_field(
        name="clientInformation", visibility=["read", "create", "update", "delete", "query"]
    )
    """The client information gathered during the liveness attempt."""
    abuse_monitoring_result: Optional["_models.AbuseMonitoringResult"] = rest_field(
        name="abuseMonitoringResult", visibility=["read", "create", "update", "delete", "query"]
    )
    """The abuse monitoring result for the liveness attempt."""
    ...
    def __init__(
        ...
        *,
        ...
        client_information: Optional[list["_models.ClientInformation"]] = None,
        abuse_monitoring_result: Optional["_models.AbuseMonitoringResult"] = None,
    ) -> None: ...
...
class OtherFlaggedSessions(_Model):
    """The other sessions flagged as abuse based on the information gathered during this attempt.

    :ivar attempt_id: The attempt ID, start from 1. Required.
    :vartype attempt_id: int
    :ivar session_id: The unique session ID of the flagged session. Required.
    :vartype session_id: str
    :ivar session_image_id: The image ID from the flagged session.
    :vartype session_image_id: str
    """
    ...
    """The unique session ID of the flagged session. Required."""
    session_image_id: Optional[str] = rest_field(
        name="sessionImageId", visibility=["read", "create", "update", "delete", "query"]
    )
