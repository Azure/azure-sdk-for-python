...
class CreateLivenessSessionContent(_model_base.Model):
    ...
    liveness_model_version: Optional[Union[str, "_models.LivenessModel"]] = rest_field(name="livenessModelVersion")
...
class CreateLivenessWithVerifySessionContent(_model_base.Model):
    ...
    :ivar verify_confidence_threshold: Threshold for confidence of the face verification. Please
     ...
     https://learn.microsoft.com/legal/cognitive-services/face/characteristics-and-limitations?context=%2Fazure%2Fai-services%2Fcomputer-vision%2Fcontext%2Fcontext#recognition-confidence-score.  # pylint: disable=line-too-long
...
class LivenessError(_model_base.Model):
    ...
    targets: "_models.LivenessDecisionTargets" = rest_field()
...
class LivenessSession(_model_base.Model):
    ...
    model_version: Optional[Union[str, "_models.LivenessModel"]] = rest_field(name="modelVersion")
    """The model version used for liveness classification. This is an optional parameter, and if this
     is not specified, then the latest supported model version will be chosen. \"2024-11-15\""""
    results: "_models.LivenessSessionResults" = rest_field()
...
class LivenessSessionAttempt(_model_base.Model):
    ...
    attempt_id: int = rest_field(name="attemptId")
    ...
    """The status of the attempt. Required. Known values are: \"NotStarted\", \"Running\",
     \"Succeeded\", \"Failed\", and \"Canceled\"."""
    result: Optional["_models.LivenessResult"] = rest_field()
    """The result of the liveness call, will be null if there is error."""
    error: Optional["_models.LivenessError"] = rest_field()
...
class LivenessWithVerifyReference(_model_base.Model):
    ...
    reference_type: Union[str, "_models.FaceImageType"] = rest_field(name="referenceType")
...
class LivenessWithVerifySessionResults(_model_base.Model):
    ...
    verify_references: List["_models.LivenessWithVerifyReference"] = rest_field(name="verifyReferences")
