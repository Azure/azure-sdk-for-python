...
class _FaceClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], FaceClientConfiguration]
):
...
class _FaceSessionClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], FaceSessionClientConfiguration]
):
