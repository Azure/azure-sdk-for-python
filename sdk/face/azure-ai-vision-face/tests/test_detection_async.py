...
class TestDetectionAsync(AzureRecordedTestCase):
    @FacePreparer()
    @AsyncFaceClientPreparer()
    @recorded_by_proxy_async
    async def test_detect_from_image_content(self, client, **kwargs):
    ...
    @AsyncFaceClientPreparer()
    @recorded_by_proxy_async
    async def test_detect_from_url(self, client, **kwargs):
    ...
    @AsyncFaceClientPreparer()
    @recorded_by_proxy_async
    async def test_detect_from_body_with_image_content(self, client, **kwargs):
        sample_file_path = helpers.get_image_path(TestImages.IMAGE_DETECTION_1)
        result = await client.detect(
    ...
    @AsyncFaceClientPreparer()
    @recorded_by_proxy_async
    async def test_detect_from_body_with_image(self, client, **kwargs):
        sample_file_path = helpers.get_image_path(TestImages.IMAGE_DETECTION_1)
    ...
    @AsyncFaceClientPreparer()
    @recorded_by_proxy_async
    async def test_detect_from_body_with_json_dict(self, client, **kwargs):
        sample_url = TestImages.IMAGE_URL
        result = await client.detect(
            {"url": sample_url},
    ...
    @AsyncFaceClientPreparer()
    @recorded_by_proxy_async
    async def test_detect_from_body_with_json_byte(self, client, **kwargs):
        sample_url = TestImages.IMAGE_URL
        result = await client.detect(
    ...
    @AsyncFaceClientPreparer()
    @recorded_by_proxy_async
    async def test_detect_from_body_with_json_byte_io(self, client, **kwargs):
        sample_url = TestImages.IMAGE_URL
        result = await client.detect(
    ...
    @AsyncFaceClientPreparer()
    @recorded_by_proxy_async
    async def test_detect_without_anything(self, client, **kwargs):
    ...
    @AsyncFaceClientPreparer()
    @recorded_by_proxy_async
    async def test_detect_with_both_url_and_image_content(self, client, **kwargs):
        with pytest.raises(TypeError) as ex:
            await client.detect(
    ...
    @AsyncFaceClientPreparer()
    @recorded_by_proxy_async
    async def test_detect_without_content_type(self, client, **kwargs):
        with pytest.raises(TypeError) as ex:
            await client.detect(
                b"fakeimagecontent",
                detection_model=FaceDetectionModel.DETECTION_03,
