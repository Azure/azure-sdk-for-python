...
# USAGE
    python person_group_operations_add_large_person_group_person_face_from_url.py
"""
...
# x-ms-original-file: v1.3-preview.1/PersonGroupOperations_AddLargePersonGroupPersonFaceFromUrl.json
