...
# USAGE
    python face_list_operations_create_large_face_list.py
"""
...
def main():
    ...
    client.large_face_list.create(
        large_face_list_id="your_large_face_list_id",
        body={"name": "your_large_face_list_name", "recognitionModel": "recognition_01", "userData": "your_user_data"},
        name="str",
    )
