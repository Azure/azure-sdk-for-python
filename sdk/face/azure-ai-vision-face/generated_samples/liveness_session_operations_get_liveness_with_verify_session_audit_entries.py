...
# USAGE
    python liveness_session_operations_get_liveness_with_verify_session_audit_entries.py
"""
...
# x-ms-original-file: v1.2-preview.1/LivenessSessionOperations_GetLivenessWithVerifySessionAuditEntries.json
