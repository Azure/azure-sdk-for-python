...
class FindSimilarFaces():
    ...
    async def find_similar_from_large_face_list(self):
        ...
        async with FaceAdministrationClient(
            ...
            await face_admin_client.add_large_face_list_face(
            ...
            poller = await face_admin_client.begin_train_large_face_list(large_face_list_id, polling_interval=30)
            ...
            await face_admin_client.delete_large_face_list(large_face_list_id)
