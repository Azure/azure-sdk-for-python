...
class StatelessFaceVerification:
    ...
    async def verify_face_to_face(self):
        ...
        async with FaceClient(endpoint=self.endpoint, credential=AzureKeyCredential(self.key)) as face_client:
            ...
            verify_result1 = await face_client.verify_face_to_face(face_id1=dad_face_id1, face_id2=dad_face_id2)
            self.logger.info(
            ...
            verify_result2 = await face_client.verify_face_to_face(face_id1=dad_face_id1, face_id2=man_face_id)
            self.logger.info(
