...
def build_purview_workflow_get_workflow_request(  # pylint: disable=name-too-long
...
def build_purview_workflow_create_or_replace_workflow_request(  # pylint: disable=name-too-long
    workflow_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_purview_workflow_delete_workflow_request(  # pylint: disable=name-too-long
    workflow_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_purview_workflow_get_workflow_run_request(  # pylint: disable=name-too-long
    workflow_run_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_purview_workflow_cancel_workflow_run_request(  # pylint: disable=name-too-long
    workflow_run_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_purview_workflow_get_workflow_task_request(  # pylint: disable=name-too-long
...
def build_purview_workflow_approve_approval_task_request(  # pylint: disable=name-too-long
    task_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_purview_workflow_reject_approval_task_request(  # pylint: disable=name-too-long
    task_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_purview_workflow_reassign_workflow_task_request(  # pylint: disable=name-too-long
    task_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_purview_workflow_update_task_status_request(  # pylint: disable=name-too-long
    task_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PurviewWorkflowClientOperationsMixin(PurviewWorkflowClientMixinABC):
    @distributed_trace
    def list_workflows(self, **kwargs: Any) -> Iterable[JSON]:
        """List all workflows.
    ...
    @distributed_trace
    def get_workflow(self, workflow_id: str, **kwargs: Any) -> JSON:
    ...
    @distributed_trace
    def delete_workflow(  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace
    def submit_user_requests(self, user_requests_payload: Union[JSON, IO], **kwargs: Any) -> JSON:
        """Submit a user request for requestor, a user  request describes user ask to do operation(s) on
        Purview. If any workflow's trigger matches with an operation in request, a run of the workflow
        is created.
    ...
    @distributed_trace
    def get_workflow_run(self, workflow_run_id: str, **kwargs: Any) -> JSON:
        """Get a workflow run.
    ...
    @overload
    def cancel_workflow_run(  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace
    def get_workflow_task(self, task_id: str, **kwargs: Any) -> JSON:
        """Get a workflow task.
    ...
    @overload
    def approve_approval_task(  # pylint: disable=inconsistent-return-statements
    ...
    @overload
    def reject_approval_task(  # pylint: disable=inconsistent-return-statements
        self, task_id: str, approval_response_comment: JSON, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
    ...
    @overload
    def reassign_workflow_task(  # pylint: disable=inconsistent-return-statements
    ...
    @overload
    def update_task_status(  # pylint: disable=inconsistent-return-statements
