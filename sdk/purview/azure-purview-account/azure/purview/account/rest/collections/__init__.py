...
try:
    ...
    from ._request_builders_py3 import build_get_child_collection_names_request
    ...
    from ._request_builders import build_get_child_collection_names_request  # type: ignore
...
__all__ = [
    ...
    'build_get_child_collection_names_request',
