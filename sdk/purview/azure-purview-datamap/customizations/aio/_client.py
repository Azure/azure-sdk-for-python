...
class DataMapClient:
    ...
    :vartype entity: customizations.aio.operations.EntityOperations
    :ivar glossary: GlossaryOperations operations
    :vartype glossary: customizations.aio.operations.GlossaryOperations
    :ivar discovery: DiscoveryOperations operations
    :vartype discovery: customizations.aio.operations.DiscoveryOperations
    :ivar lineage: LineageOperations operations
    :vartype lineage: customizations.aio.operations.LineageOperations
    :ivar relationship: RelationshipOperations operations
    :vartype relationship: customizations.aio.operations.RelationshipOperations
    :ivar type_definition: TypeDefinitionOperations operations
    :vartype type_definition: customizations.aio.operations.TypeDefinitionOperations
