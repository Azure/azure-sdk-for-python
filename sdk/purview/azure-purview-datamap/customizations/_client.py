...
class DataMapClient:
    ...
    :vartype entity: customizations.operations.EntityOperations
    :ivar glossary: GlossaryOperations operations
    :vartype glossary: customizations.operations.GlossaryOperations
    :ivar discovery: DiscoveryOperations operations
    :vartype discovery: customizations.operations.DiscoveryOperations
    :ivar lineage: LineageOperations operations
    :vartype lineage: customizations.operations.LineageOperations
    :ivar relationship: RelationshipOperations operations
    :vartype relationship: customizations.operations.RelationshipOperations
    :ivar type_definition: TypeDefinitionOperations operations
    :vartype type_definition: customizations.operations.TypeDefinitionOperations
