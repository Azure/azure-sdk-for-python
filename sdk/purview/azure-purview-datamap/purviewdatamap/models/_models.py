...
from ...customizations._model_base import rest_field
from ...customizations._vendor import FileType
...
class AtlasAttributeDef(_model_base.Model):
    ...
    :ivar cardinality: single-valued attribute or multi-valued attribute. Known values are:
     "SINGLE", "LIST", and "SET".
    :vartype cardinality: str or ~customizations.models.CardinalityValue
    :ivar constraints: An array of constraints.
    :vartype constraints: list[~customizations.models.AtlasConstraintDef]
...
class AtlasBusinessMetadataDef(_model_base.Model):
    ...
    :ivar category: The enum of type category. Known values are: "PRIMITIVE", "OBJECT_ID_TYPE",
     ...
     "TERM_TEMPLATE".
    :vartype category: str or ~customizations.models.TypeCategory
    ...
    :vartype date_formatter: ~customizations.models.DateFormat
    ...
    :vartype attribute_defs: list[~customizations.models.AtlasAttributeDef]
    """
...
class AtlasClassification(_model_base.Model):
    ...
    :vartype entity_status: str or ~customizations.models.EntityStatus
    ...
    :vartype validity_periods: list[~customizations.models.TimeBoundary]
    """
...
class AtlasClassifications(_model_base.Model):
    ...
    :vartype sort_type: str or ~customizations.models.SortType
...
class AtlasEntitiesWithExtInfo(_model_base.Model):
    ...
    :vartype referred_entities: dict[str, ~customizations.models.AtlasEntity]
    :ivar entities: An array of entities.
    :vartype entities: list[~customizations.models.AtlasEntity]
    """
...
class AtlasEntity(_model_base.Model):
    ...
    :vartype classifications: list[~customizations.models.AtlasClassification]
    :ivar create_time: The created time of the record.
    :vartype create_time: int
    :ivar created_by: The user who created the record.
    :vartype created_by: str
    ...
    :vartype meanings: list[~customizations.models.AtlasTermAssignmentHeader]
    ...
    :ivar status: Status of the entity - can be active or deleted. Deleted entities are not
     removed. Known values are: "ACTIVE" and "DELETED".
    :vartype status: str or ~customizations.models.EntityStatus
    :ivar update_time: The update time of the record.
    :vartype update_time: int
    :ivar updated_by: The user who updated the record.
    :vartype updated_by: str
    ...
    :vartype contacts: dict[str, list[~customizations.models.ContactInfo]]
    """
...
class AtlasEntityDef(_model_base.Model):
    ...
    :vartype relationship_attribute_defs:
     list[~customizations.models.AtlasRelationshipAttributeDef]
    """
...
class AtlasEntityHeaders(_model_base.Model):
    ...
    :vartype guid_header_map: dict[str, ~customizations.models.AtlasEntityHeader]
    """
...
class AtlasEntityWithExtInfo(_model_base.Model):
    ...
    :vartype entity: ~customizations.models.AtlasEntity
    """
...
class AtlasEnumDef(_model_base.Model):
    ...
    :vartype element_defs: list[~customizations.models.AtlasEnumElementDef]
    """
...
class AtlasGlossary(_model_base.Model):
    ...
    :vartype categories: list[~customizations.models.AtlasRelatedCategoryHeader]
    :ivar language: The language of the glossary.
    :vartype language: str
    :ivar terms: An array of related term headers.
    :vartype terms: list[~customizations.models.AtlasRelatedTermHeader]
...
class AtlasGlossaryCategory(_model_base.Model):
    ...
    :vartype anchor: ~customizations.models.AtlasGlossaryHeader
    :ivar children_categories: An array of children categories.
    :vartype children_categories: list[~customizations.models.AtlasRelatedCategoryHeader]
    :ivar parent_category: The header of the related category.
    :vartype parent_category: ~customizations.models.AtlasRelatedCategoryHeader
    :ivar terms: An array of related term headers.
    :vartype terms: list[~customizations.models.AtlasRelatedTermHeader]
    """
...
class AtlasGlossaryExtInfo(_model_base.Model):
    ...
    :vartype category_info: dict[str, ~customizations.models.AtlasGlossaryCategory]
    :ivar term_info: The glossary term information.
    :vartype term_info: dict[str, ~customizations.models.AtlasGlossaryTerm]
    """
...
class AtlasGlossaryTerm(_model_base.Model):
    ...
    :vartype assigned_entities: list[~customizations.models.AtlasRelatedObjectId]
    :ivar categories: An array of term categorization headers.
    :vartype categories: list[~customizations.models.AtlasTermCategorizationHeader]
    :ivar classifies: An array of related term headers.
    :vartype classifies: list[~customizations.models.AtlasRelatedTermHeader]
    ...
    :vartype is_a: list[~customizations.models.AtlasRelatedTermHeader]
    :ivar preferred_terms: An array of preferred related term headers.
    :vartype preferred_terms: list[~customizations.models.AtlasRelatedTermHeader]
    :ivar preferred_to_terms: An array of related term headers that are preferred to.
    :vartype preferred_to_terms: list[~customizations.models.AtlasRelatedTermHeader]
    :ivar replaced_by: An array of related term headers that are replaced by.
    :vartype replaced_by: list[~customizations.models.AtlasRelatedTermHeader]
    :ivar replacement_terms: An array of related term headers for replacement.
    :vartype replacement_terms: list[~customizations.models.AtlasRelatedTermHeader]
    :ivar see_also: An array of related term headers for see also.
    :vartype see_also: list[~customizations.models.AtlasRelatedTermHeader]
    :ivar synonyms: An array of related term headers as synonyms.
    :vartype synonyms: list[~customizations.models.AtlasRelatedTermHeader]
    :ivar translated_terms: An array of translated related term headers.
    :vartype translated_terms: list[~customizations.models.AtlasRelatedTermHeader]
    :ivar translation_terms: An array of related term headers for translation.
    :vartype translation_terms: list[~customizations.models.AtlasRelatedTermHeader]
    :ivar usage: The usage of the term.
    :vartype usage: str
    :ivar valid_values: An array of related term headers as valid values.
    :vartype valid_values: list[~customizations.models.AtlasRelatedTermHeader]
    :ivar valid_values_for: An array of related term headers as valid values for other records.
    :vartype valid_values_for: list[~customizations.models.AtlasRelatedTermHeader]
    """
...
class AtlasLineageInfo(_model_base.Model):
    ...
    :vartype guid_entity_map: dict[str, ~customizations.models.AtlasEntityHeader]
    ...
    :ivar lineage_direction: The enum of lineage direction. Known values are: "INPUT", "OUTPUT",
     and "BOTH".
    :vartype lineage_direction: str or ~customizations.models.LineageDirection
    :ivar parent_relations: An array of parentRelations relations.
    :vartype parent_relations: list[~customizations.models.ParentRelation]
    :ivar relations: An array of lineage relations.
    :vartype relations: list[~customizations.models.LineageRelation]
    """
...
class AtlasRelatedObjectId(_model_base.Model):
    ...
    :vartype relationship_attributes: ~customizations.models.AtlasStruct
    ...
    :ivar relationship_status: The enum of relationship status. Known values are: "ACTIVE" and
     "DELETED".
    :vartype relationship_status: str or ~customizations.models.StatusAtlasRelationship
    """
...
class AtlasRelatedTermHeader(_model_base.Model):
    ...
    :vartype status: str or ~customizations.models.AtlasTermRelationshipStatus
...
class AtlasRelationship(_model_base.Model):
    ...
    :vartype end1: ~customizations.models.AtlasObjectId
    :ivar end2: Reference to an object-instance of a type - like entity.
    :vartype end2: ~customizations.models.AtlasObjectId
    ...
    :vartype status: str or ~customizations.models.StatusAtlasRelationship
    :ivar update_time: The update time of the record.
    :vartype update_time: int
    :ivar updated_by: The user who updated the record.
    :vartype updated_by: str
...
class AtlasRelationshipDef(_model_base.Model):
    ...
    :ivar end_def1: The relationshipEndDef represents an end of the relationship. The end of the
     ...
     attribute name, cardinality and whether
     it  is the container end of the relationship.
    :vartype end_def1: ~customizations.models.AtlasRelationshipEndDef
    :ivar end_def2: The relationshipEndDef represents an end of the relationship. The end of the
     relationship is defined by a type, an
     attribute name, cardinality and whether
     it  is the container end of the relationship.
    :vartype end_def2: ~customizations.models.AtlasRelationshipEndDef
    ...
    :vartype relationship_category: str or ~customizations.models.RelationshipCategory
...
class AtlasRelationshipWithExtInfo(_model_base.Model):
    ...
    :vartype referred_entities: dict[str, ~customizations.models.AtlasEntityHeader]
    :ivar relationship: Atlas relationship instance.
    :vartype relationship: ~customizations.models.AtlasRelationship
    """
...
class AtlasTermAssignmentHeader(_model_base.Model):
    ...
    :vartype status: str or ~customizations.models.AtlasTermAssignmentStatus
    :ivar steward: The steward of the term.
    :vartype steward: str
    :ivar term_guid: The GUID of the term.
    :vartype term_guid: str
...
class AtlasTypesDef(_model_base.Model):
    ...
    :vartype business_metadata_defs: list[~customizations.models.AtlasBusinessMetadataDef]
    :ivar classification_defs: An array of classification definitions.
    :vartype classification_defs: list[~customizations.models.AtlasClassificationDef]
    :ivar entity_defs: An array of entity definitions.
    :vartype entity_defs: list[~customizations.models.AtlasEntityDef]
    :ivar enum_defs: An array of enum definitions.
    :vartype enum_defs: list[~customizations.models.AtlasEnumDef]
    :ivar relationship_defs: An array of relationship definitions.
    :vartype relationship_defs: list[~customizations.models.AtlasRelationshipDef]
    :ivar struct_defs: An array of struct definitions.
    :vartype struct_defs: list[~customizations.models.AtlasStructDef]
    :ivar term_template_defs: An array of term template definitions.
    :vartype term_template_defs: list[~customizations.models.TermTemplateDef]
    """
...
class AutoCompleteResult(_model_base.Model):
    ...
    :vartype value: list[~customizations.models.AutoCompleteResultValue]
    """
...
class BulkImportResult(_model_base.Model):
    ...
    :vartype failed_import_info_list: list[~customizations.models.ImportInfo]
    :ivar success_import_info_list: successful importInfoList.
    :vartype success_import_info_list: list[~customizations.models.ImportInfo]
    """
...
class BusinessMetadataOptions(_model_base.Model):
    ...
    :vartype file: ~customizations._vendor.FileType
    """
...
class ClassificationAssociateOptions(_model_base.Model):
    ...
    :ivar classification: An instance of a classification; it doesn't have an identity, this object
     exists only when associated with an entity.
    :vartype classification: ~customizations.models.AtlasClassification
...
class DateFormat(_model_base.Model):
    ...
    :vartype date_instance: ~customizations.models.DateFormat
    :ivar date_time_instance: The date format.
    :vartype date_time_instance: ~customizations.models.DateFormat
    :ivar instance: The date format.
    :vartype instance: ~customizations.models.DateFormat
    :ivar lenient: Determines the leniency of the date format.
    :vartype lenient: bool
    :ivar number_format: The number format.
    :vartype number_format: ~customizations.models.NumberFormat
    :ivar time_instance: The date format.
    :vartype time_instance: ~customizations.models.DateFormat
    :ivar time_zone: The timezone information.
    :vartype time_zone: ~customizations.models.TimeZone
    """
...
class EntityMutationResult(_model_base.Model):
    ...
    :vartype mutated_entities: dict[str, list[~customizations.models.AtlasEntityHeader]]
    :ivar partial_updated_entities: An array of entity headers that partially updated.
    :vartype partial_updated_entities: list[~customizations.models.AtlasEntityHeader]
    """
...
class ImportInfo(_model_base.Model):
    ...
    :vartype import_status: str or ~customizations.models.ImportStatus
...
class NumberFormat(_model_base.Model):
    ...
    :vartype currency_instance: ~customizations.models.NumberFormat
    :ivar grouping_used: Determines if grouping is used.
    :vartype grouping_used: bool
    :ivar instance: The number format.
    :vartype instance: ~customizations.models.NumberFormat
    :ivar integer_instance: The number format.
    :vartype integer_instance: ~customizations.models.NumberFormat
    ...
    :vartype number_instance: ~customizations.models.NumberFormat
    ...
    :vartype percent_instance: ~customizations.models.NumberFormat
    ...
    :vartype rounding_mode: str or ~customizations.models.RoundingMode
    """
...
class QueryOptions(_model_base.Model):
    ...
    :vartype facets: list[~customizations.models.SearchFacetItem]
    :ivar taxonomy_setting: The taxonomy setting for search.
    :vartype taxonomy_setting: ~customizations.models.SearchTaxonomySetting
    """
...
class QueryResult(_model_base.Model):
    ...
    :vartype search_facets: ~customizations.models.SearchFacetResultValue
    :ivar value: Search result value.
    :vartype value: list[~customizations.models.SearchResultValue]
    """
...
class SearchFacetItem(_model_base.Model):
    ...
    :vartype sort: ~customizations.models.SearchFacetSort
    """
...
class SearchFacetResultValue(_model_base.Model):
    ...
    :vartype entity_type: list[~customizations.models.SearchFacetItemValue]
    :ivar asset_type: Asset type.
    :vartype asset_type: list[~customizations.models.SearchFacetItemValue]
    :ivar classification: Classification.
    :vartype classification: list[~customizations.models.SearchFacetItemValue]
    :ivar term: Term.
    :vartype term: list[~customizations.models.SearchFacetItemValue]
    :ivar contact_id: Contact id.
    :vartype contact_id: list[~customizations.models.SearchFacetItemValue]
    :ivar contact_type: Contact type.
    :vartype contact_type: list[~customizations.models.SearchFacetItemValue]
    :ivar label: Label.
    :vartype label: list[~customizations.models.SearchFacetItemValue]
    :ivar glossary_type: Glossary type.
    :vartype glossary_type: list[~customizations.models.SearchFacetItemValue]
    :ivar term_status: Term status.
    :vartype term_status: list[~customizations.models.SearchFacetItemValue]
    :ivar term_template: Term template.
    :vartype term_template: list[~customizations.models.SearchFacetItemValue]
    """
...
class SearchFacetSort(_model_base.Model):
    ...
    :vartype count: str or ~customizations.models.SearchSortOrder
    :ivar value: Order by value. Known values are: "asc" and "desc".
    :vartype value: str or ~customizations.models.SearchSortOrder
    """
...
class SearchResultValue(_model_base.Model):
    ...
    :ivar search_highlights: A highlight list that consists of index fields id ,qualifiedName,
     ...
     the field, attached with emphasis mark, is returned as an element of
     @search.highlights.
    :vartype search_highlights: ~customizations.models.SearchHighlights
    ...
    :vartype term: list[~customizations.models.TermSearchResultValue]
    :ivar contact: The contacts of the asset.
    :vartype contact: list[~customizations.models.ContactSearchResultValue]
...
class SearchTaxonomySetting(_model_base.Model):
    ...
    :vartype facet: ~customizations.models.SearchFacetItem
    """
...
class SuggestResult(_model_base.Model):
    ...
    :ivar value: The result value.
    :vartype value: list[~customizations.models.SuggestResultValue]
    """
...
class TimeZone(_model_base.Model):
    ...
    :vartype default: ~customizations.models.TimeZone
