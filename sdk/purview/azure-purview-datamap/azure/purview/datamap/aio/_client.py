...
class PurviewDataMapClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    sources they need and understand the data sources they find. At the same time, Data Map helps
    organizations get more value from their existing investments. This spec defines REST API of
    Purview Data Map Service.
    ...
    :param endpoint: The datamap endpoint of your Purview account. Example:
     https://{accountName}.purview.azure.com. Required.
    :type endpoint: str
    :param credential: Credential needed for the client to connect to Azure. Required.
    :type credential: ~azure.core.credentials_async.AsyncTokenCredential
    :keyword api_version: Api Version. Known values are "2023-09-01" and None. Default value is
     None. Note that overriding this default value may result in unsupported behavior.
