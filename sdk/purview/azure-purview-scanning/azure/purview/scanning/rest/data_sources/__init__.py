...
try:
    ...
    from ._request_builders_py3 import build_list_children_by_collection_request
    ...
    from ._request_builders import build_list_children_by_collection_request  # type: ignore
...
__all__ = [
    ...
    'build_list_children_by_collection_request',
]
