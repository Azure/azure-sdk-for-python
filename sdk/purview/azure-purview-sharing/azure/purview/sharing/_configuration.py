...
class PurviewSharingClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    ...
    def __init__(self, endpoint: str, credential: "TokenCredential", **kwargs: Any) -> None:
        api_version: str = kwargs.pop("api_version", "2023-05-30-preview")
