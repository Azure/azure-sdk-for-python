...
class TestPurviewSharing(AzureRecordedTestCase):
    ...
    def prepare_sent_share(self):
        artifact = {
            "properties": {
                "paths": [{"containerName": "container1", "receiverPath": "folder1", "senderPath": "folder1"}]
            },
        ...
        sent_share = {
            "properties": {"artifact": artifact, "displayName": "sentShare-Test", "description": "A sample share"},
            "shareKind": "InPlace",
        }
...
PurviewSharingPowerShellPreparer = functools.partial(
    PowerShellPreparer, "purviewsharing", purviewsharing_endpoint="https://fake_account.share.purview.azure.com"
)
