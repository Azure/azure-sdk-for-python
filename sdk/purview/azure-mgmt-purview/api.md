...
namespace azure.mgmt.purview.types

    class azure.mgmt.purview.types.AccessKeys(TypedDict, total=False):
        key "atlasKafkaPrimaryEndpoint": str
        key "atlasKafkaSecondaryEndpoint": str
        atlas_kafka_primary_endpoint: str
        atlas_kafka_secondary_endpoint: str


    class azure.mgmt.purview.types.Account(ProxyResource):
        key "id": str
        key "identity": ForwardRef('Identity', module='types')
        key "location": str
        key "name": str
        key "properties": ForwardRef('AccountProperties', module='types')
        key "sku": ForwardRef('AccountSku', module='types')
    ...
    class azure.mgmt.purview.types.AccountEndpoints(TypedDict, total=False):
        key "catalog": str
        key "scan": str
        catalog: str
        scan: str
    ...
    class azure.mgmt.purview.types.AccountMergeInfo(TypedDict, total=False):
        key "accountLocation": str
        key "accountName": str
        key "accountResourceGroupName": str
        key "accountSubscriptionId": str
        key "deprovisioned": bool
        key "mergeStatus": Union[str, MergeStatus]
        key "typeOfAccount": Union[str, MergeAccountType]
        account_location: str
        account_name: str
        account_resource_group_name: str
        account_subscription_id: str
        deprovisioned: bool
        merge_status: Union[str, MergeStatus]
        type_of_account: Union[str, MergeAccountType]


    class azure.mgmt.purview.types.AccountProperties(TypedDict, total=False):
        key "accountStatus": ForwardRef('AccountPropertiesAccountStatus', module='types')
        key "cloudConnectors": ForwardRef('CloudConnectors', module='types')
        key "createdAt": str
        key "createdBy": str
        key "createdByObjectId": str
        key "defaultDomain": str
        key "endpoints": ForwardRef('AccountPropertiesEndpoints', module='types')
        key "friendlyName": str
        key "ingestionStorage": ForwardRef('IngestionStorage', module='types')
        key "managedEventHubState": Union[str, ManagedEventHubState]
        key "managedResourceGroupName": str
        key "managedResources": ForwardRef('AccountPropertiesManagedResources', module='types')
        key "managedResourcesPublicNetworkAccess": Union[str, PublicNetworkAccess]
        key "mergeInfo": ForwardRef('AccountMergeInfo', module='types')
        key "provisioningState": Union[str, ProvisioningState]
        key "publicNetworkAccess": Union[str, PublicNetworkAccess]
        key "tenantEndpointState": Union[str, TenantEndpointState]
        account_status: AccountPropertiesAccountStatus
        ...
        friendly_name: str
        ingestion_storage: IngestionStorage
        managed_event_hub_state: Union[str, ManagedEventHubState]
        managed_resource_group_name: str
        managed_resources: AccountPropertiesManagedResources
        managed_resources_public_network_access: Union[str, PublicNetworkAccess]
        merge_info: AccountMergeInfo
        privateEndpointConnections: list[PrivateEndpointConnection]
        private_endpoint_connections: list[PrivateEndpointConnection]
        provisioning_state: Union[str, ProvisioningState]
        public_network_access: Union[str, PublicNetworkAccess]
        tenant_endpoint_state: Union[str, TenantEndpointState]


    class azure.mgmt.purview.types.AccountPropertiesAccountStatus(AccountStatus):
        key "accountProvisioningState": Union[str, AccountProvisioningState]
        key "errorDetails": ForwardRef('AccountStatusErrorDetails', module='types')
        account_provisioning_state: Union[str, AccountProvisioningState]
        error_details: AccountStatusErrorDetails


    class azure.mgmt.purview.types.AccountPropertiesEndpoints(AccountEndpoints):
        key "catalog": str
        key "scan": str
        catalog: str
        scan: str
    ...
    class azure.mgmt.purview.types.AccountPropertiesManagedResources(ManagedResources):
        key "eventHubNamespace": str
    ...
    class azure.mgmt.purview.types.AccountSku(TypedDict, total=False):
        key "capacity": int
        key "name": Union[str, AccountSkuName]
        capacity: int
        name: Union[str, AccountSkuName]


    class azure.mgmt.purview.types.AccountStatus(TypedDict, total=False):
        key "accountProvisioningState": Union[str, AccountProvisioningState]
        key "errorDetails": ForwardRef('AccountStatusErrorDetails', module='types')
        account_provisioning_state: Union[str, AccountProvisioningState]
        error_details: AccountStatusErrorDetails
    ...
    class azure.mgmt.purview.types.AccountStatusErrorDetails(ErrorModel):
        key "code": str
        key "message": str
        key "target": str
        code: str
    ...
    class azure.mgmt.purview.types.AccountUpdateParameters(TypedDict, total=False):
        key "identity": ForwardRef('Identity', module='types')
        key "properties": ForwardRef('AccountProperties', module='types')
        identity: Identity
        properties: AccountProperties
    ...
    class azure.mgmt.purview.types.BatchFeatureRequest(TypedDict, total=False):
        features: list[str]


    class azure.mgmt.purview.types.BatchFeatureStatus(TypedDict, total=False):
        features: dict[str, bool]


    class azure.mgmt.purview.types.CheckNameAvailabilityRequest(TypedDict, total=False):
        key "name": str
        key "type": str
        name: str
        type: str
    ...
    class azure.mgmt.purview.types.CheckNameAvailabilityResult(TypedDict, total=False):
        key "message": str
        key "nameAvailable": bool
        key "reason": Union[str, Reason]
        message: str
        name_available: bool
        reason: Union[str, Reason]


    class azure.mgmt.purview.types.CloudConnectors(TypedDict, total=False):
        key "awsExternalId": str
        aws_external_id: str


    class azure.mgmt.purview.types.CollectionAdminUpdate(TypedDict, total=False):
        key "objectId": str
        object_id: str


    class azure.mgmt.purview.types.Credentials(TypedDict, total=False):
        key "identityId": str
        key "type": Union[str, KafkaConfigurationIdentityType]
        identity_id: str
        type: Union[str, KafkaConfigurationIdentityType]


    class azure.mgmt.purview.types.DefaultAccountPayload(TypedDict, total=False):
        key "accountName": str
        key "resourceGroupName": str
        key "scope": str
        key "scopeTenantId": str
    ...
    class azure.mgmt.purview.types.DimensionProperties(TypedDict, total=False):
        key "displayName": str
        key "name": str
        key "toBeExportedForCustomer": bool
        display_name: str
        name: str
        to_be_exported_for_customer: bool


    class azure.mgmt.purview.types.ErrorModel(TypedDict, total=False):
        key "code": str
        key "message": str
        key "target": str
        code: str
    ...
    class azure.mgmt.purview.types.ErrorResponseModel(TypedDict, total=False):
        key "error": ForwardRef('ErrorResponseModelError', module='types')
        error: ErrorResponseModelError


    class azure.mgmt.purview.types.ErrorResponseModelError(ErrorModel):
        key "code": str
        key "message": str
        key "target": str
        code: str
    ...
    class azure.mgmt.purview.types.Identity(TypedDict, total=False):
        key "principalId": str
        key "tenantId": str
    ...
    class azure.mgmt.purview.types.IngestionStorage(TypedDict, total=False):
        key "id": str
        key "primaryEndpoint": str
        key "publicNetworkAccess": Union[str, PublicNetworkAccess]
        id: str
    ...
    class azure.mgmt.purview.types.KafkaConfiguration(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('KafkaConfigurationProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.purview.types.KafkaConfigurationProperties(TypedDict, total=False):
        key "consumerGroup": str
        key "credentials": ForwardRef('Credentials', module='types')
        key "eventHubPartitionId": str
        key "eventHubResourceId": str
        key "eventHubType": Union[str, EventHubType]
        key "eventStreamingState": Union[str, EventStreamingState]
        key "eventStreamingType": Union[str, EventStreamingType]
        consumer_group: str
        credentials: Credentials
        event_hub_partition_id: str
        event_hub_resource_id: str
        event_hub_type: Union[str, EventHubType]
        event_streaming_state: Union[str, EventStreamingState]
        event_streaming_type: Union[str, EventStreamingType]


    class azure.mgmt.purview.types.ManagedResources(TypedDict, total=False):
        key "eventHubNamespace": str
        key "resourceGroup": str
        key "storageAccount": str
        event_hub_namespace: str
    ...
    class azure.mgmt.purview.types.Operation(TypedDict, total=False):
    ...
    class azure.mgmt.purview.types.OperationDisplay(TypedDict, total=False):
        key "description": str
        key "operation": str
        key "provider": str
        key "resource": str
    ...
    class azure.mgmt.purview.types.OperationMetaLogSpecification(TypedDict, total=False):
    ...
    class azure.mgmt.purview.types.OperationMetaMetricSpecification(TypedDict, total=False):
        key "aggregationType": str
        key "displayDescription": str
        key "displayName": str
        key "enableRegionalMdmAccount": str
        key "internalMetricName": str
        key "name": str
        key "resourceIdDimensionNameOverride": str
        key "sourceMdmNamespace": str
        key "unit": str
    ...
    class azure.mgmt.purview.types.OperationMetaServiceSpecification(TypedDict, total=False):
    ...
    class azure.mgmt.purview.types.OperationProperties(TypedDict, total=False):
        key "serviceSpecification": ForwardRef('OperationMetaServiceSpecification', module='types')
        service_specification: OperationMetaServiceSpecification


    class azure.mgmt.purview.types.PrivateEndpoint(TypedDict, total=False):
        key "id": str
        id: str


    class azure.mgmt.purview.types.PrivateEndpointConnection(ProxyResource):
        key "id": str
        key "name": str
    ...
    class azure.mgmt.purview.types.PrivateEndpointConnectionProperties(TypedDict, total=False):
    ...
    class azure.mgmt.purview.types.PrivateEndpointConnectionStatusUpdateRequest(TypedDict, total=False):
    ...
    class azure.mgmt.purview.types.PrivateEndpointConnectionStatusUpdateResponse(TypedDict, total=False):
        key "privateEndpointId": str
        key "status": str
        private_endpoint_id: str
        status: str
    ...
    class azure.mgmt.purview.types.PrivateLinkResource(ProxyResource):
        key "id": str
        key "name": str
    ...
    class azure.mgmt.purview.types.PrivateLinkResourceProperties(TypedDict, total=False):
        key "groupId": str
        group_id: str
    ...
    class azure.mgmt.purview.types.PrivateLinkServiceConnectionState(TypedDict, total=False):
    ...
    class azure.mgmt.purview.types.ProxyResource(Resource):
        key "id": str
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
    ...
    class azure.mgmt.purview.types.QuotaName(TypedDict, total=False):
    ...
    class azure.mgmt.purview.types.Resource(TypedDict, total=False):
        key "id": str
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
    ...
    class azure.mgmt.purview.types.SystemData(TypedDict, total=False):
        key "createdAt": str
        key "createdBy": str
    ...
    class azure.mgmt.purview.types.Usage(TypedDict, total=False):
        key "currentValue": int
        key "id": str
        key "limit": int
        key "name": ForwardRef('UsageName', module='types')
        key "unit": str
        current_value: int
        id: str
        limit: int
    ...
    class azure.mgmt.purview.types.UsageList(TypedDict, total=False):
        key "nextLink": str
        key "value": Required[list[Usage]]
        next_link: str
        value: list[Usage]


    class azure.mgmt.purview.types.UsageName(QuotaName):
        key "localizedValue": str
        key "value": str
        localized_value: str
        value: str
    ...
    class azure.mgmt.purview.types.UserAssignedIdentity(TypedDict, total=False):
        key "clientId": str
        key "principalId": str
        client_id: str
        principal_id: str
