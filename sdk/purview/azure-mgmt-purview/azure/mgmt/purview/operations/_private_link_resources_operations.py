...
class PrivateLinkResourcesOperations(object):
    ...
    def list_by_account(
        ...
        :rtype:
         ~azure.mgmt.purview.models.PrivateLinkResourcePaged[~azure.mgmt.purview.models.PrivateLinkResource]
        :raises:
        ...
        return deserialized
    list_by_account.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Purview/accounts/{accountName}/privateLinkResources'}

    def get_by_group_id(
            self, resource_group_name, account_name, group_id, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~azure.mgmt.purview.models.PrivateLinkResource or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseModelException<azure.mgmt.purview.models.ErrorResponseModelException>`
        """
        # Construct URL
        url = self.get_by_group_id.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'accountName': self._serialize.url("account_name", account_name, 'str'),
        ...
        return deserialized
    get_by_group_id.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Purview/accounts/{accountName}/privateLinkResources/{groupId}'}
