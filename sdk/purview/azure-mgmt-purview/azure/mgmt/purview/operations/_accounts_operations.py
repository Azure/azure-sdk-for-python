...
class AccountsOperations:
    ...
    def begin_create_or_update(
        ...
        :type account: ~azure.mgmt.purview.models.Account or IO[bytes]
        :return: An instance of LROPoller that returns either Account or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.purview.models.Account]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def add_root_collection_admin(  # pylint: disable=inconsistent-return-statements
        ...
        resource_group_name: str,
        account_name: str,
        collection_admin_update: Union[_models.CollectionAdminUpdate, IO[bytes]],
        **kwargs: Any
    ) -> None:
        """Add the administrator for root collection.
        ...
        :type collection_admin_update: ~azure.mgmt.purview.models.CollectionAdminUpdate or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _request = build_add_root_collection_admin_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
