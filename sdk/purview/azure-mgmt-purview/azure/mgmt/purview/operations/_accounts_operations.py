...
class AccountsOperations(object):
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.purview.models.AccountPaged[~azure.mgmt.purview.models.Account]
        :raises:
        ...
        return deserialized
    list_by_resource_group.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Purview/accounts'}
    ...
    def list_by_subscription(
        ...
        return deserialized
    list_by_subscription.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Purview/accounts'}
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.purview.models.Account or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Purview/accounts/{accountName}'}
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.purview.models.Account]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.purview.models.Account]]
        :raises:
         :class:`ErrorResponseModelException<azure.mgmt.purview.models.ErrorResponseModelException>`
        """
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Purview/accounts/{accountName}'}
    ...
    def delete(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Purview/accounts/{accountName}'}

    def update(
            self, resource_group_name, account_name, account_update_parameters, custom_headers=None, raw=False, **operation_config):
        ...
        :type account_update_parameters:
         ~azure.mgmt.purview.models.AccountUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        return deserialized
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Purview/accounts/{accountName}'}
    ...
    def list_keys(
        ...
        :rtype: ~azure.mgmt.purview.models.AccessKeys or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseModelException<azure.mgmt.purview.models.ErrorResponseModelException>`
        """
        ...
        return deserialized
    list_keys.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Purview/accounts/{accountName}/listkeys'}
    ...
    def check_name_availability(
        ...
        :rtype: ~azure.mgmt.purview.models.CheckNameAvailabilityResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseModelException<azure.mgmt.purview.models.ErrorResponseModelException>`
        """
        check_name_availability_request = models.CheckNameAvailabilityRequest(name=name, type=type)
        ...
        return deserialized
    check_name_availability.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Purview/checkNameAvailability'}
