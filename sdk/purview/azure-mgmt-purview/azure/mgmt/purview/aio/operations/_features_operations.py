...
class FeaturesOperations:
    ...
    async def subscription_get(
        self, locations: str, feature_request: Union[_models.BatchFeatureRequest, IO[bytes]], **kwargs: Any
    ) -> _models.BatchFeatureStatus:
        """Gets a list of features and their status for the location and subscription. Status of enabled
        features will be true. Status of disabled features will be false. Features that don't exist
        will be excluded from the results.
        ...
        :type feature_request: ~azure.mgmt.purview.models.BatchFeatureRequest or IO[bytes]
        :return: BatchFeatureStatus or the result of cls(response)
        :rtype: ~azure.mgmt.purview.models.BatchFeatureStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        deserialized = self._deserialize("BatchFeatureStatus", pipeline_response.http_response)
    ...
    async def account_get(
        ...
        resource_group_name: str,
        account_name: str,
        feature_request: Union[_models.BatchFeatureRequest, IO[bytes]],
        **kwargs: Any
    ) -> _models.BatchFeatureStatus:
        """Gets a list of features and their status for the account. Status of enabled features will be
        true. Status of disabled features will be false. Features that don't exist will be excluded
