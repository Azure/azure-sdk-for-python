...
from ...operations._accounts_operations import (
    build_add_root_collection_admin_request,
...
class AccountsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, skip_token: Optional[str] = None, **kwargs: Any) -> AsyncIterable["_models.Account"]:
    ...
    async def begin_create_or_update(
        ...
        :param account_name: The name of the account. Required.
        :type account_name: str
        :param account: The account. Is either a model type or a IO type. Required.
        :type account: ~azure.mgmt.purview.models.Account or IO
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param account_update_parameters: The account update parameters. Is either a model type or a IO
         type. Required.
        :type account_update_parameters: ~azure.mgmt.purview.models.AccountUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @overload
    async def add_root_collection_admin(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
    ...
    async def add_root_collection_admin(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type account_name: str
        :param collection_admin_update: The collection admin update payload. Required.
        :type collection_admin_update: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def add_root_collection_admin(  # pylint: disable=inconsistent-return-statements
        ...
        resource_group_name: str,
        account_name: str,
        collection_admin_update: Union[_models.CollectionAdminUpdate, IO],
        **kwargs: Any
    ) -> None:
        """Add the administrator for root collection.
        ...
        :param account_name: The name of the account. Required.
        :type account_name: str
        :param collection_admin_update: The collection admin update payload. Is either a model type or
         a IO type. Required.
        :type collection_admin_update: ~azure.mgmt.purview.models.CollectionAdminUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        _json = None
        _content = None
        if isinstance(collection_admin_update, (IO, bytes)):
