...
from ...operations._kafka_configurations_operations import (
...
class KafkaConfigurationsOperations:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Purview/accounts/{accountName}/kafkaConfigurations/{kafkaConfigurationName}"
    }
    ...
    async def create_or_update(
        ...
        account_name: str,
        kafka_configuration_name: str,
        kafka_configuration: Union[_models.KafkaConfiguration, IO],
        **kwargs: Any
    ) -> _models.KafkaConfiguration:
        """Create or update the kafka configuration.
        ...
        :param kafka_configuration: The kafka configuration of the account. Is either a
         KafkaConfiguration type or a IO type. Required.
        :type kafka_configuration: ~azure.mgmt.purview.models.KafkaConfiguration or IO
    ...
    ) -> AsyncIterable["_models.KafkaConfiguration"]:
    ...
    list_by_account.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Purview/accounts/{accountName}/kafkaConfigurations"
    }
