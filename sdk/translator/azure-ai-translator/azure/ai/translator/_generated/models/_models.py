...
class BatchRequest(msrest.serialization.Model):
    ...
    :type source: ~azure.ai.translator.models.SourceInput
    :param targets: Required. Location of the destination for the output.
    :type targets: list[~azure.ai.translator.models.TargetInput]
    :param storage_type: Storage type of the input documents source string. Possible values
     include: "Folder", "File".
    :type storage_type: str or ~azure.ai.translator.models.StorageInputType
    """
...
class BatchStatusDetail(msrest.serialization.Model):
    ...
    :param status: Required. List of possible statuses for job or document. Possible values
     ...
     "ValidationFailed".
    :type status: str or ~azure.ai.translator.models.Status
    :param error: This contains an outer error with error code, message, details, target and an
     inner error with more descriptive details.
    :type error: ~azure.ai.translator.models.ErrorV2
    :param summary: Required.
    :type summary: ~azure.ai.translator.models.StatusSummary
    """
...
class BatchStatusResponse(msrest.serialization.Model):
    ...
    :type value: list[~azure.ai.translator.models.BatchStatusDetail]
...
class DocumentStatusResponse(msrest.serialization.Model):
    ...
    :type value: list[~azure.ai.translator.models.DocumentStatusDetail]
    :param next_link: Url for the next page.  Null if no more pages available.
    :type next_link: str
    """
...
class ErrorV2(msrest.serialization.Model):
    ...
    :type code: str or ~azure.ai.translator.models.ErrorCodeV2
    ...
    :type inner_error: ~azure.ai.translator.models.InnerErrorV2
    """
...
class FileFormatListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.ai.translator.models.FileFormat]
    """
...
class Glossary(msrest.serialization.Model):
    ...
    :type storage_source: str or ~azure.ai.translator.models.StorageSource
    """
...
class SourceInput(msrest.serialization.Model):
    ...
    :type source_url: str
    :param filter:
    :type filter: ~azure.ai.translator.models.DocumentFilter
...
class StorageSourceListResult(msrest.serialization.Model):
    ...
    :param value: Required. list of objects.
    :type value: list[str or ~azure.ai.translator.models.StorageSource]
    """
...
class TargetInput(msrest.serialization.Model):
    ...
    :type glossaries: list[~azure.ai.translator.models.Glossary]
    :param storage_source: Storage Source. Possible values include: "AzureBlob".
    :type storage_source: str or ~azure.ai.translator.models.StorageSource
    """
