...
class DocumentTranslationClient(object):
    ...
    async def close(self) -> None:
        """Close the :class:`~azure.ai.translator.aio.DocumentTranslationClient` session."""
    ...
    def list_submitted_jobs(self, **kwargs):
        ...
        :return: ~azure.core.paging.AsyncItemPaged[:class:`~azure.ai.translator.JobStatusResult`]
    ...
    def list_all_document_statuses(self, job_id, **kwargs):
        ...
        :param str job_id: The translation job ID.
        :return: ~azure.core.paging.AsyncItemPaged[:class:`~azure.ai.translator.DocumentStatusResult`]
        :rtype: ~azure.core.paging.AsyncItemPaged
        :raises ~azure.core.exceptions.HttpResponseError:
