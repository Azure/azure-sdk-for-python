...
class DocumentTranslationClient(object):  # pylint: disable=r0205
    ...
    def __init__(self, endpoint, credential, **kwargs):
        ...
        :paramtype api_version: str or ~azure.ai.translator.DocumentTranslationApiVersion
    ...
    def close(self):
        # type: () -> None
        """Close the :class:`~azure.ai.translator.DocumentTranslationClient` session."""
    ...
    def create_translation_job(self, inputs, **kwargs):
        ...
        :type inputs: List[~azure.ai.translator.DocumentTranslationInput]
        :return: A JobStatusResult with information on the status of the translation job.
        :rtype: ~azure.ai.translator.JobStatusResult
    ...
    def list_submitted_jobs(self, **kwargs):
        ...
        :return: ~azure.core.paging.ItemPaged[:class:`~azure.ai.translator.JobStatusResult`]
    ...
    def list_all_document_statuses(self, job_id, **kwargs):
        ...
        :param str job_id: The translation job ID.
        :return: ~azure.core.paging.ItemPaged[:class:`~azure.ai.translator.DocumentStatusResult`]
        :rtype: ~azure.core.paging.ItemPaged
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def get_document_status(self, job_id, document_id, **kwargs):
        ...
        :rtype: ~azure.ai.translator.DocumentStatusResult
        :raises ~azure.core.exceptions.HttpResponseError or ~azure.core.exceptions.ResourceNotFoundError:
        """
