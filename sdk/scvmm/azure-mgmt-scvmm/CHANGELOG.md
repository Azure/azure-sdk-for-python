...
### Features Added
  ...
  - Model CloudCapacity has a new parameter memory_m_b
  - Model HardwareProfile has a new parameter dynamic_memory_max_m_b
  - Model HardwareProfile has a new parameter dynamic_memory_min_m_b
  - Model HardwareProfile has a new parameter memory_m_b
  - Model HardwareProfileUpdate has a new parameter dynamic_memory_max_m_b
  - Model HardwareProfileUpdate has a new parameter dynamic_memory_min_m_b
  - Model HardwareProfileUpdate has a new parameter memory_m_b
  - Model InventoryItem has a new parameter properties
  - Model ProxyResource has a new parameter system_data
  - Model Resource has a new parameter system_data
  - Model VirtualDisk has a new parameter disk_size_g_b
  - Model VirtualDisk has a new parameter max_disk_size_g_b
  - Model VirtualDisk has a new parameter storage_qos_policy
  - Model VirtualDiskUpdate has a new parameter disk_size_g_b
  ...
  - Model VirtualMachineTemplateInventoryItem has a new parameter memory_m_b
...
### Breaking Changes
  ...
  - Model CloudCapacity no longer has parameter memory_mb
  - Model HardwareProfile no longer has parameter dynamic_memory_max_mb
  - Model HardwareProfile no longer has parameter dynamic_memory_min_mb
  - Model HardwareProfile no longer has parameter memory_mb
  - Model HardwareProfileUpdate no longer has parameter dynamic_memory_max_mb
  - Model HardwareProfileUpdate no longer has parameter dynamic_memory_min_mb
  - Model HardwareProfileUpdate no longer has parameter memory_mb
  ...
  - Model VirtualDisk no longer has parameter disk_size_gb
  - Model VirtualDisk no longer has parameter max_disk_size_gb
  - Model VirtualDisk no longer has parameter storage_qo_s_policy
  - Model VirtualDiskUpdate no longer has parameter disk_size_gb
  ...
  - Model VirtualMachineTemplateInventoryItem no longer has parameter memory_mb
