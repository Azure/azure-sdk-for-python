...
def build_delete_request(
    resource_group_name: str, vmm_server_name: str, subscription_id: str, *, force: Optional[bool] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ScVmm/vmmServers")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class VmmServersOperations:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/vmmServers/{vmmServerName}"
    }

    def _create_or_update_initial(
        self, resource_group_name: str, vmm_server_name: str, body: Union[_models.VMMServer, IO], **kwargs: Any
    ) -> _models.VMMServer:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_create_or_update(
        ...
        :type body: ~azure.mgmt.scvmm.models.VMMServer or IO
    ...
    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, vmm_server_name: str, force: Optional[bool] = None, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def _update_initial(
        self, resource_group_name: str, vmm_server_name: str, body: Union[_models.ResourcePatch, IO], **kwargs: Any
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param vmm_server_name: Name of the VMMServer. Required.
        :type vmm_server_name: str
        :param body: VmmServers patch payload. Required.
    ...
    def begin_update(
        ...
        :param vmm_server_name: Name of the VMMServer. Required.
        :type vmm_server_name: str
        :param body: VmmServers patch payload. Is either a model type or a IO type. Required.
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/vmmServers"
    }
    ...
    list_by_subscription.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.ScVmm/vmmServers"}
