...
def build_get_request(resource_group_name: str, cloud_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
...
def build_create_or_update_request(
    resource_group_name: str, cloud_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_request(
    resource_group_name: str, cloud_name: str, subscription_id: str, *, force: Optional[bool] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(resource_group_name: str, cloud_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CloudsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, cloud_name: str, **kwargs: Any) -> _models.Cloud:
        """Gets a Cloud.
        ...
        :param cloud_name: Name of the Cloud. Required.
        :type cloud_name: str
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/clouds/{cloudName}"
    }

    def _create_or_update_initial(
        self, resource_group_name: str, cloud_name: str, body: Union[_models.Cloud, IO], **kwargs: Any
    ) -> _models.Cloud:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_create_or_update(
        ...
        :type body: ~azure.mgmt.scvmm.models.Cloud or IO
    ...
    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, cloud_name: str, force: Optional[bool] = None, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def _update_initial(
        self, resource_group_name: str, cloud_name: str, body: Union[_models.ResourcePatch, IO], **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.Cloud]] = kwargs.pop("cls", None)
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param cloud_name: Name of the Cloud. Required.
        :type cloud_name: str
        :param body: Clouds patch payload. Required.
    ...
    def begin_update(
        ...
        :param cloud_name: Name of the Cloud. Required.
        :type cloud_name: str
        :param body: Clouds patch payload. Is either a model type or a IO type. Required.
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Cloud"]:
        ...
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either Cloud or the result of cls(response)
        ...
        cls: ClsType[_models.CloudListResult] = kwargs.pop("cls", None)
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/clouds"
    }
    ...
    list_by_subscription.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.ScVmm/clouds"}
