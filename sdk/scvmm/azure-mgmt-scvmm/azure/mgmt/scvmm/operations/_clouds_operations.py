...
class CloudsOperations:
    ...
    def _create_or_update_initial(
        ...
        resource_group_name: str,
        cloud_resource_name: str,
        resource: Union[_models.Cloud, IO[bytes]],
        **kwargs: Any
    ) -> _models.Cloud:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "Cloud")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a Cloud type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.scvmm.models.Cloud or IO[bytes]
        :return: An instance of LROPoller that returns either Cloud or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.scvmm.models.Cloud]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        cloud_resource_name: str,
        properties: Union[_models.CloudTagsUpdate, IO[bytes]],
        **kwargs: Any
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "CloudTagsUpdate")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.scvmm.models.CloudTagsUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either Cloud or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.scvmm.models.Cloud]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
