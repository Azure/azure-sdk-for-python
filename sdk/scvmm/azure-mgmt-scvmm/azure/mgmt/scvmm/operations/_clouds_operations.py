...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "cloudResourceName": _SERIALIZER.url(
            "cloud_resource_name", cloud_resource_name, "str", max_length=54, min_length=1, pattern=r"[a-zA-Z0-9-_\.]"
        ),
    }
...
class CloudsOperations:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/clouds/{cloudResourceName}"
    }

    def _create_or_update_initial(
        self, resource_group_name: str, cloud_resource_name: str, body: Union[_models.Cloud, IO], **kwargs: Any
    ) -> _models.Cloud:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_create_or_update(
        ...
        :param cloud_resource_name: Name of the Cloud. Required.
        :type cloud_resource_name: str
        :param body: Request payload. Is either a Cloud type or a IO type. Required.
    ...
    def _update_initial(
        self, resource_group_name: str, cloud_resource_name: str, body: Union[_models.ResourcePatch, IO], **kwargs: Any
    ...
    def begin_update(
        ...
        :param cloud_resource_name: Name of the Cloud. Required.
        :type cloud_resource_name: str
        :param body: Clouds patch payload. Is either a ResourcePatch type or a IO type. Required.
