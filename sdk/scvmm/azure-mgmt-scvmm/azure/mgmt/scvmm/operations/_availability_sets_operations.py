...
class AvailabilitySetsOperations:
    ...
    def _create_or_update_initial(
        ...
        resource_group_name: str,
        availability_set_resource_name: str,
        resource: Union[_models.AvailabilitySet, IO[bytes]],
        **kwargs: Any
    ) -> _models.AvailabilitySet:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a AvailabilitySet type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.scvmm.models.AvailabilitySet or IO[bytes]
        :return: An instance of LROPoller that returns either AvailabilitySet or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.scvmm.models.AvailabilitySet]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        availability_set_resource_name: str,
        properties: Union[_models.AvailabilitySetTagsUpdate, IO[bytes]],
        **kwargs: Any
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.scvmm.models.AvailabilitySetTagsUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either AvailabilitySet or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.scvmm.models.AvailabilitySet]
        :raises ~azure.core.exceptions.HttpResponseError:
