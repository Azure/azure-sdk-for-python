...
class VirtualMachineTemplatesOperations:
    ...
    def _create_or_update_initial(
        ...
        resource_group_name: str,
        virtual_machine_template_name: str,
        resource: Union[_models.VirtualMachineTemplate, IO[bytes]],
        **kwargs: Any
    ) -> _models.VirtualMachineTemplate:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "VirtualMachineTemplate")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.scvmm.models.VirtualMachineTemplate or IO[bytes]
        :return: An instance of LROPoller that returns either VirtualMachineTemplate or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.scvmm.models.VirtualMachineTemplate]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        virtual_machine_template_name: str,
        properties: Union[_models.VirtualMachineTemplateTagsUpdate, IO[bytes]],
        **kwargs: Any
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "VirtualMachineTemplateTagsUpdate")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.scvmm.models.VirtualMachineTemplateTagsUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either VirtualMachineTemplate or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.scvmm.models.VirtualMachineTemplate]
        :raises ~azure.core.exceptions.HttpResponseError:
