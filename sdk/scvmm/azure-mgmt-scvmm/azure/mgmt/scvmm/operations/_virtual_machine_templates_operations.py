...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ScVmm/virtualMachineTemplates"
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class VirtualMachineTemplatesOperations:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/virtualMachineTemplates/{virtualMachineTemplateName}"
    }
    ...
    def _create_or_update_initial(
        ...
        resource_group_name: str,
        virtual_machine_template_name: str,
        body: Union[_models.VirtualMachineTemplate, IO],
        **kwargs: Any
    ) -> _models.VirtualMachineTemplate:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, virtual_machine_template_name: str, force: Optional[bool] = None, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        virtual_machine_template_name: str,
        body: Union[_models.ResourcePatch, IO],
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.VirtualMachineTemplate]] = kwargs.pop("cls", None)
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param virtual_machine_template_name: Name of the VirtualMachineTemplate. Required.
        :type virtual_machine_template_name: str
        :param body: VirtualMachineTemplates patch details. Required.
    ...
    def list_by_resource_group(
        ...
        cls: ClsType[_models.VirtualMachineTemplateListResult] = kwargs.pop("cls", None)
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/virtualMachineTemplates"
    }
    ...
    list_by_subscription.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.ScVmm/virtualMachineTemplates"
    }
