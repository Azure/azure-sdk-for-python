...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/virtualMachineTemplates/{virtualMachineTemplateName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "virtualMachineTemplateName": _SERIALIZER.url("virtual_machine_template_name", virtual_machine_template_name, 'str'),
    }
...
def build_list_by_resource_group_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/virtualMachineTemplates")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
    }
...
def build_list_by_subscription_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ScVmm/virtualMachineTemplates")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
...
class VirtualMachineTemplatesOperations(object):
    ...
    def _create_or_update_initial(
        ...
        resource_group_name: str,
        virtual_machine_template_name: str,
        body: "_models.VirtualMachineTemplate",
        **kwargs: Any
    ) -> "_models.VirtualMachineTemplate":
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.VirtualMachineTemplate"]
        error_map = {
        ...
        _json = self._serialize.body(body, 'VirtualMachineTemplate')
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.scvmm.models.VirtualMachineTemplate
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either VirtualMachineTemplate or the result of
         cls(response)
    ...
    def _update_initial(
        ...
        **kwargs: Any
    ) -> Optional["_models.VirtualMachineTemplate"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.VirtualMachineTemplate"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def list_by_resource_group(
        ...
        resource_group_name: str,
        **kwargs: Any
    ) -> Iterable["_models.VirtualMachineTemplateListResult"]:
        ...
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either VirtualMachineTemplateListResult or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.scvmm.models.VirtualMachineTemplateListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-06-05-preview")  # type: str

        cls = kwargs.pop('cls', None)  # type: ClsType["_models.VirtualMachineTemplateListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("VirtualMachineTemplateListResult", pipeline_response)
