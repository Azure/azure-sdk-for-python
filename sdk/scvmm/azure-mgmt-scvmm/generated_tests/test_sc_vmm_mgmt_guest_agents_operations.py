...
class TestScVmmMgmtGuestAgentsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_guest_agents_delete(self, resource_group):
        response = self.client.guest_agents.delete(
            resource_uri="str",
        )
