...
class TestScVmmMgmtVirtualMachineInstancesOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_virtual_machine_instances_begin_create_checkpoint(self, resource_group):
        response = await (
            await self.client.virtual_machine_instances.begin_create_checkpoint(
                resource_uri="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_virtual_machine_instances_begin_delete_checkpoint(self, resource_group):
        response = await (
            await self.client.virtual_machine_instances.begin_delete_checkpoint(
                resource_uri="str",
                body={"id": "str"},
            )
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_virtual_machine_instances_begin_restore_checkpoint(self, resource_group):
        response = await (
            await self.client.virtual_machine_instances.begin_restore_checkpoint(
                resource_uri="str",
                body={"id": "str"},
            )
        ).result()  # call '.result()' to poll until service return final result
