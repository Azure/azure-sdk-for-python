...
# USAGE
    python virtual_machine_templates_create_or_update_minimum_set_gen.py
...
def main():
    ...
    response = client.virtual_machine_templates.begin_create_or_update(
        resource_group_name="rgscvmm",
        virtual_machine_template_name="P",
        resource={"extendedLocation": {}, "location": "ayxsyduviotylbojh"},
    ).result()
    print(response)
