...
def build_list_by_business_process_request(
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "businessProcessVersion": _SERIALIZER.url("business_process_version", business_process_version, "str"),
    }
...
class BusinessProcessVersionsOperations:
    ...
    def list_by_business_process(
        ...
        orderby: Optional[List[str]] = None,
        **kwargs: Any
    ) -> Iterable["_models.BusinessProcessVersion"]:
        ...
        :return: An iterator like instance of either BusinessProcessVersion or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.azureintegrationspaces.models.BusinessProcessVersion]
