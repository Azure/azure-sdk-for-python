...
# USAGE
    python applications_delete_business_process_development_artifact.py
...
def main():
    ...
    client.applications.delete_business_process_development_artifact(
        resource_group_name="testrg",
        space_name="Space1",
        application_name="Application1",
        body={"name": "BusinessProcess1"},
    )
