...
class Operations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestack.models.OperationList]
    ...
    list.metadata = {'url': '/providers/Microsoft.AzureStack/operations'}  # type: ignore
