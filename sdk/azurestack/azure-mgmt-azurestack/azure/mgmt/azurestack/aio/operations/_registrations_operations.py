...
class RegistrationsOperations:
    ...
    @distributed_trace
    def list(self, resource_group: str, **kwargs: Any) -> AsyncItemPaged["_models.Registration"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.Registration"]:
    ...
    @distributed_trace_async
    async def delete(self, resource_group: str, registration_name: str, **kwargs: Any) -> None:
    ...
    @distributed_trace_async
    async def enable_remote_management(self, resource_group: str, registration_name: str, **kwargs: Any) -> None:
