...
class CustomerSubscriptionsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.CustomerSubscriptionList"]
        ...
        :return: An iterator like instance of either CustomerSubscriptionList or the result of cls(response)
    ...
    def get(
        ...
        resource_group,  # type: str
        registration_name,  # type: str
        customer_subscription_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.CustomerSubscription"
    ...
    def create(
        ...
        registration_name,  # type: str
        customer_subscription_name,  # type: str
        customer_creation_parameters,  # type: "_models.CustomerSubscription"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.CustomerSubscription"
