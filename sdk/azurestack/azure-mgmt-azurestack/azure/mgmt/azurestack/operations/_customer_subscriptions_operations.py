...
def build_list_request(resource_group: str, registration_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2020-06-01-preview"))
...
class CustomerSubscriptionsOperations:
    ...
    ) -> ItemPaged["_models.CustomerSubscription"]:
    ...
    def get(
        ...
        deserialized = self._deserialize("CustomerSubscription", pipeline_response.http_response)
    ...
    def create(
        ...
        registration_name: str,
        customer_subscription_name: str,
        customer_creation_parameters: IO[bytes],
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.CustomerSubscription:
        ...
        :param customer_creation_parameters: Parameters use to create a customer subscription.
         Required.
        :type customer_creation_parameters: IO[bytes]
    ...
    def create(
        ...
        registration_name: str,
        customer_subscription_name: str,
        customer_creation_parameters: Union[_models.CustomerSubscription, IO[bytes]],
        **kwargs: Any
    ) -> _models.CustomerSubscription:
        """Creates a new customer subscription under a registration.
        ...
        :param customer_creation_parameters: Parameters use to create a customer subscription. Is
         either a CustomerSubscription type or a IO[bytes] type. Required.
        :type customer_creation_parameters: ~azure.mgmt.azurestack.models.CustomerSubscription or
         IO[bytes]
        :return: CustomerSubscription or the result of cls(response)
        :rtype: ~azure.mgmt.azurestack.models.CustomerSubscription
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        _json = None
        _content = None
        if isinstance(customer_creation_parameters, (IOBase, bytes)):
