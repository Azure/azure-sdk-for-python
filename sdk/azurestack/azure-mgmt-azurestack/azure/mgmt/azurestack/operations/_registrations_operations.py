...
class RegistrationsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.azurestack.models.RegistrationPaged[~azure.mgmt.azurestack.models.Registration]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.RegistrationPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: Registration or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.azurestack.models.Registration or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('Registration', response)
    ...
    def get_activation_key(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: ActivationKeyResult or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.azurestack.models.ActivationKeyResult or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        url = self.get_activation_key.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroup': self._serialize.url("resource_group", resource_group, 'str'),
            'registrationName': self._serialize.url("registration_name", registration_name, 'str')
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('ActivationKeyResult', response)
