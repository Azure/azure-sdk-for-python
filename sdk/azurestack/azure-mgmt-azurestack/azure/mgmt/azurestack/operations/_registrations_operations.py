...
class RegistrationsOperations:
    ...
    @distributed_trace
    def list(self, resource_group: str, **kwargs: Any) -> ItemPaged["_models.Registration"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.Registration"]:
    ...
    def get(self, resource_group: str, registration_name: str, **kwargs: Any) -> _models.Registration:
        ...
        deserialized = self._deserialize("Registration", pipeline_response.http_response)
    ...
    def create_or_update(
        ...
        resource_group: str,
        registration_name: str,
        token: Union[_models.RegistrationParameter, IO[bytes]],
        **kwargs: Any
    ) -> _models.Registration:
        """Create or update an Azure Stack registration.
        ...
        :param registration_name: Name of the Azure Stack registration. Required.
        :type registration_name: str
        :param token: Registration token. Is either a RegistrationParameter type or a IO[bytes] type.
         Required.
        :type token: ~azure.mgmt.azurestack.models.RegistrationParameter or IO[bytes]
        :return: Registration or the result of cls(response)
        :rtype: ~azure.mgmt.azurestack.models.Registration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_activation_key(
        ...
        _request = build_get_activation_key_request(
            resource_group=resource_group,
            registration_name=registration_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
        ...
        deserialized = self._deserialize("ActivationKeyResult", pipeline_response.http_response)
    ...
    def enable_remote_management(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_enable_remote_management_request(
            resource_group=resource_group,
            registration_name=registration_name,
            subscription_id=self._config.subscription_id,
            headers=_headers,
