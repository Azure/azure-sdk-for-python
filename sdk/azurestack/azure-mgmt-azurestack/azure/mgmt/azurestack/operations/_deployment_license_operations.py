...
class DeploymentLicenseOperations:
    ...
    def create(
        ...
        content_type = kwargs.pop("content_type", _headers.pop("Content-Type", None))  # type: Optional[str]
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.DeploymentLicenseResponse]
    ...
    create.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.AzureStack/generateDeploymentLicense"}  # type: ignore
