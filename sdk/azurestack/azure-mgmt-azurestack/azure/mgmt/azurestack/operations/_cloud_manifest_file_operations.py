...
class CloudManifestFileOperations(object):
    ...
    def list(
        ...
        :return: CloudManifestFileResponse or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.azurestack.models.CloudManifestFileResponse or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('CloudManifestFileResponse', response)
    ...
    def get(
            self, verification_version, version_creation_date=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param version_creation_date: Signing verification key version
         creation date.
