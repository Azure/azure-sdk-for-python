...
def main():
    ...
    response = client.products.get_products(
...
# x-ms-original-file: specification/azurestack/resource-manager/Microsoft.AzureStack/AzureStack/preview/2020-06-01-preview/examples/Product/ListPost.json
