...
class TestHanaOnAzureProviderInstancesOperations(AzureMgmtRecordedTestCase):
    ...
    def test_provider_instances_begin_create(self, resource_group):
        response = self.client.provider_instances.begin_create(
            ...
            provider_instance_parameter={
                "id": "str",
                "name": "str",
                "properties": {"metadata": "str", "properties": "str", "provisioningState": "str", "type": "str"},
                "systemData": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_provider_instances_list(self, resource_group):
