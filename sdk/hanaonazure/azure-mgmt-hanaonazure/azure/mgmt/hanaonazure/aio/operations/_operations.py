...
class Operations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hanaonazure.models.OperationList]
    ...
    list.metadata = {'url': '/providers/Microsoft.HanaOnAzure/operations'}  # type: ignore
