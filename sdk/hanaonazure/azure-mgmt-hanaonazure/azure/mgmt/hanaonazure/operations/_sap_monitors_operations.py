...
class SapMonitorsOperations(object):
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SapMonitorPaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.HanaOnAzure/sapMonitors'}
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: SapMonitor or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.hanaonazure.models.SapMonitor or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HanaOnAzure/sapMonitors/{sapMonitorName}'}
    ...
    def create(
            self, resource_group_name, sap_monitor_name, sap_monitor_parameter, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :return: An instance of LROPoller that returns SapMonitor or
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HanaOnAzure/sapMonitors/{sapMonitorName}'}
    ...
    def delete(
            self, resource_group_name, sap_monitor_name, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HanaOnAzure/sapMonitors/{sapMonitorName}'}

    def update(
            self, resource_group_name, sap_monitor_name, tags=None, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HanaOnAzure/sapMonitors/{sapMonitorName}'}
