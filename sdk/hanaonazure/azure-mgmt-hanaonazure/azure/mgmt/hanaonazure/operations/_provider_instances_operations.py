...
class ProviderInstancesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ProviderInstanceListResult"]
        ...
        :return: An iterator like instance of either ProviderInstanceListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.hanaonazure.models.ProviderInstanceListResult]
    ...
    def get(
        ...
        resource_group_name,  # type: str
        sap_monitor_name,  # type: str
        provider_instance_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ProviderInstance"
    ...
    def _create_initial(
        ...
        sap_monitor_name,  # type: str
        provider_instance_name,  # type: str
        provider_instance_parameter,  # type: "_models.ProviderInstance"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ProviderInstance"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ProviderInstance"]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.ProviderInstance"]
