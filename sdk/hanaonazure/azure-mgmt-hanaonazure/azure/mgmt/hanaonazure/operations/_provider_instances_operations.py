...
class ProviderInstancesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.hanaonazure.models.ProviderInstancePaged[~azure.mgmt.hanaonazure.models.ProviderInstance]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.ProviderInstancePaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HanaOnAzure/sapMonitors/{sapMonitorName}/providerInstances'}
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: ProviderInstance or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.hanaonazure.models.ProviderInstance or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HanaOnAzure/sapMonitors/{sapMonitorName}/providerInstances/{providerInstanceName}'}
    ...
    def create(
            self, resource_group_name, sap_monitor_name, provider_instance_name, provider_instance_parameter, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :param provider_instance_parameter: Request body representing a
         provider instance
        :type provider_instance_parameter:
        ...
        :return: An instance of LROPoller that returns ProviderInstance or
         ClientRawResponse<ProviderInstance> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.hanaonazure.models.ProviderInstance]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.hanaonazure.models.ProviderInstance]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.hanaonazure.models.ErrorResponseException>`
        """
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HanaOnAzure/sapMonitors/{sapMonitorName}/providerInstances/{providerInstanceName}'}
    ...
    def delete(
            self, resource_group_name, sap_monitor_name, provider_instance_name, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HanaOnAzure/sapMonitors/{sapMonitorName}/providerInstances/{providerInstanceName}'}
