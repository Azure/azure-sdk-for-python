...
def build_create_or_update_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        "configurationProfileAssignmentName": _SERIALIZER.url(
            "configuration_profile_assignment_name", configuration_profile_assignment_name, "str"
        ),
...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Automanage/configurationProfileAssignments"
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
    }
...
class ConfigurationProfileAssignmentsOperations:
    ...
    ) -> Iterable["_models.ConfigurationProfileAssignment"]:
