...
class ConfigurationProfilePreferencesOperations(object):
    ...
    def create_or_update(
        ...
        parameters,  # type: "_models.ConfigurationProfilePreference"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ConfigurationProfilePreference"
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ConfigurationProfilePreference"]
        error_map = {
    ...
    def update(
        ...
        configuration_profile_preference_name,  # type: str
        resource_group_name,  # type: str
        parameters,  # type: "_models.ConfigurationProfilePreferenceUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ConfigurationProfilePreference"
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ConfigurationProfilePreferenceList"]
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ConfigurationProfilePreferenceList"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
