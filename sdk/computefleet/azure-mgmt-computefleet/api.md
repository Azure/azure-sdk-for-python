...
namespace azure.mgmt.computefleet.types
    ...
    class azure.mgmt.computefleet.types.ComputeProfile(TypedDict, total=False):
        key "additionalVirtualMachineCapabilities": ForwardRef('AdditionalCapabilities', module='types')
    ...
    class azure.mgmt.computefleet.types.DiskEncryptionSetParameters(TypedDict, total=False):
        key "id": str
        id: str
    ...
    class azure.mgmt.computefleet.types.FleetProperties(TypedDict, total=False):
        key "additionalLocationsProfile": ForwardRef('AdditionalLocationsProfile', module='types')
        key "capacityType": Union[str, CapacityType]
        key "computeProfile": Required[ComputeProfile]
        key "mode": Union[str, FleetMode]
        key "provisioningState": Union[str, ProvisioningState]
        key "regularPriorityProfile": ForwardRef('RegularPriorityProfile', module='types')
        key "spotPriorityProfile": ForwardRef('SpotPriorityProfile', module='types')
        key "timeCreated": str
        key "uniqueId": str
    ...
    class azure.mgmt.computefleet.types.FleetUpdate(TypedDict, total=False):
        ...
        key "plan": ForwardRef('ResourcePlanUpdate', module='types')
        key "properties": ForwardRef('FleetProperties', module='types')
    ...
    class azure.mgmt.computefleet.types.ImageReference(TypedDict, total=False):
    ...
    class azure.mgmt.computefleet.types.LinuxPatchSettings(TypedDict, total=False):
    ...
    class azure.mgmt.computefleet.types.ProxyAgentSettings(TypedDict, total=False):
        key "enabled": bool
    ...
    class azure.mgmt.computefleet.types.PublicIPAddressSku(TypedDict, total=False):
    ...
    class azure.mgmt.computefleet.types.RegularPriorityProfile(TypedDict, total=False):
    ...
    class azure.mgmt.computefleet.types.ResourcePlanUpdate(TypedDict, total=False):
        key "name": str
        key "product": str
        key "promotionCode": str
        key "publisher": str
    ...
    class azure.mgmt.computefleet.types.SpotPriorityProfile(TypedDict, total=False):
        key "allocationStrategy": Union[str, SpotAllocationStrategy]
        key "capacity": int
    ...
    class azure.mgmt.computefleet.types.SubResource(TypedDict, total=False):
        key "id": str
        id: str


    class azure.mgmt.computefleet.types.SystemData(TypedDict, total=False):
        key "createdAt": str
        key "createdBy": str
    ...
    class azure.mgmt.computefleet.types.VMAttributeMinMaxInteger(TypedDict, total=False):
        key "max": int
        key "min": int
        max: int
        min: int
    ...
    class azure.mgmt.computefleet.types.VMAttributes(TypedDict, total=False):
    ...
    class azure.mgmt.computefleet.types.VirtualMachineScaleSetDataDisk(TypedDict, total=False):
    ...
    class azure.mgmt.computefleet.types.VirtualMachineScaleSetIPConfigurationProperties(TypedDict, total=False):
        key "primary": bool
    ...
    class azure.mgmt.computefleet.types.VirtualMachineScaleSetManagedDiskParameters(TypedDict, total=False):
        key "diskEncryptionSet": ForwardRef('DiskEncryptionSetParameters', module='types')
    ...
    class azure.mgmt.computefleet.types.WinRMConfiguration(TypedDict, total=False):
    ...
    class azure.mgmt.computefleet.types.WindowsConfiguration(TypedDict, total=False):
