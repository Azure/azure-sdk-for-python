...
class ListConsoleOperations(object):
    ...
    def disabled(
        ...
        :return: GetDisabledResult or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.serialconsole.models.GetDisabledResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`DeploymentValidateResultException<azure.mgmt.serialconsole.models.DeploymentValidateResultException>`
        """
        # Construct URL
        url = self.disabled.metadata['url']
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('GetDisabledResult', response)
        ...
        return deserialized
    disabled.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.SerialConsole/consoleServices/{default}'}
