...
def build_list_by_subscriptions_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.SerialConsole/serialPorts")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class SerialPortsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("SerialPortListResult", pipeline_response.http_response)
    ...
    def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("SerialPort", pipeline_response.http_response)
    ...
    def create(
        ...
        parent_resource: str,
        serial_port: str,
        parameters: Union[_models.SerialPort, IO[bytes]],
        **kwargs: Any
    ) -> _models.SerialPort:
        """Creates or updates a serial port.
        ...
        :type parameters: ~azure.mgmt.serialconsole.models.SerialPort or IO[bytes]
        :return: SerialPort or the result of cls(response)
        :rtype: ~azure.mgmt.serialconsole.models.SerialPort
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def connect(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("SerialPortConnectResult", pipeline_response.http_response)
