...
class VirtualNetworksOperations:
    ...
    async def _create_or_update_initial(
        ...
        lab_name: str,
        name: str,
        virtual_network: Union[_models.VirtualNetwork, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either VirtualNetwork or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.devtestlabs.models.VirtualNetwork]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param name: The name of the virtual network. Required.
        :type name: str
        :param virtual_network: A virtual network. Is either a VirtualNetwork type or a IO[bytes] type.
         Required.
        :type virtual_network: ~azure.mgmt.devtestlabs.models.VirtualNetwork or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either VirtualNetwork or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.devtestlabs.models.VirtualNetwork]
        :raises ~azure.core.exceptions.HttpResponseError:
