...
class EnvironmentsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("DtlEnvironment", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        user_name: str,
        name: str,
        dtl_environment: Union[_models.DtlEnvironment, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type dtl_environment: ~azure.mgmt.devtestlabs.models.DtlEnvironment or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either DtlEnvironment or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.devtestlabs.models.DtlEnvironment]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return AsyncLROPoller[_models.DtlEnvironment].from_continuation_token(
