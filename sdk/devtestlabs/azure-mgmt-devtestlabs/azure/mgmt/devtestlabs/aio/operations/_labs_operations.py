...
from ...operations._labs_operations import (
    ...
    build_get_request,
    build_import_virtual_machine_request,
    build_list_by_resource_group_request,
    build_list_by_subscription_request,
    build_list_vhds_request,
...
class LabsOperations:
    ...
    @overload
    async def begin_create_or_update(
        self, resource_group_name: str, name: str, lab: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> AsyncLROPoller[_models.Lab]:
        """Create or replace an existing lab. This operation can take a while to complete.
    ...
    async def _claim_any_vm_initial(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_claim_any_vm_request(
            ...
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self._claim_any_vm_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    async def _create_environment_initial(  # pylint: disable=inconsistent-return-statements
        ...
        resource_group_name: str,
        name: str,
        lab_virtual_machine_creation_parameter: Union[_models.LabVirtualMachineCreationParameter, IO],
        **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_create_environment_request(
            resource_group_name=resource_group_name,
            name=name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            ...
            json=_json,
            content=_content,
            template_url=self._create_environment_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    async def begin_create_environment(
        ...
        resource_group_name: str,
        name: str,
        lab_virtual_machine_creation_parameter: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[None]:
        ...
        :param lab_virtual_machine_creation_parameter: Properties for creating a virtual machine.
         Required.
        :type lab_virtual_machine_creation_parameter: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def _export_resource_usage_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_export_resource_usage_request(
            ...
            content_type=content_type,
            json=_json,
            template_url=self._export_resource_usage_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    async def generate_upload_uri(
        ...
        request = build_generate_upload_uri_request(
            resource_group_name=resource_group_name,
            name=name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            content_type=content_type,
            json=_json,
            template_url=self.generate_upload_uri.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    async def _import_virtual_machine_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_import_virtual_machine_request(
            resource_group_name=resource_group_name,
            name=name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            content_type=content_type,
            json=_json,
            template_url=self._import_virtual_machine_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    def list_vhds(self, resource_group_name: str, name: str, **kwargs: Any) -> AsyncIterable["_models.LabVhd"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_vhds_request(
                    resource_group_name=resource_group_name,
                    name=name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
                    template_url=self.list_vhds.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
                request = _convert_request(request)
