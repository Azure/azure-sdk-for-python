...
class GlobalSchedulesOperations:
    """GlobalSchedulesOperations async operations.
    ...
    async def _retarget_initial(
        ...
        **kwargs
        ...
        # Construct URL
        url = self._retarget_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'name': self._serialize.url("name", name, 'str'),
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_retarget_schedule_properties, 'RetargetScheduleProperties')
        body_content_kwargs['content'] = body_content
