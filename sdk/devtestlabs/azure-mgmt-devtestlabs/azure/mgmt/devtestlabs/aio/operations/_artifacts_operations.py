...
from ...operations._artifacts_operations import (
    build_generate_arm_template_request,
    build_get_request,
    build_list_request,
)
...
class ArtifactsOperations:
    ...
    async def generate_arm_template(
        ...
        artifact_source_name: str,
        name: str,
        generate_arm_template_request: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.ArmTemplateInfo:
        ...
        :param generate_arm_template_request: Parameters for generating an ARM template for deploying
         artifacts. Required.
        :type generate_arm_template_request: IO
    ...
    async def generate_arm_template(
        ...
        artifact_source_name: str,
        name: str,
        generate_arm_template_request: Union[_models.GenerateArmTemplateRequest, IO],
        **kwargs: Any
    ) -> _models.ArmTemplateInfo:
        """Generates an ARM template for the given artifact, uploads the required files to a storage
        account, and validates the generated artifact.
        ...
        request = build_generate_arm_template_request(
            resource_group_name=resource_group_name,
            lab_name=lab_name,
            artifact_source_name=artifact_source_name,
            name=name,
            ...
            json=_json,
            content=_content,
            template_url=self.generate_arm_template.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
