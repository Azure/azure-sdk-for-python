...
class FormulasOperations:
    """FormulasOperations async operations.
    ...
    def list(
        ...
        **kwargs
    ) -> AsyncIterable["_models.FormulaList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.devtestlabs.models.FormulaList]
    ...
    async def begin_create_or_update(
        ...
        **kwargs
        ...
        :return: An instance of AsyncLROPoller that returns either Formula or the result of cls(response)
