...
class ArtifactSourcesOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("ArtifactSource", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        lab_name: str,
        name: str,
        artifact_source: Union[_models.ArtifactSource, IO[bytes]],
        **kwargs: Any
    ) -> _models.ArtifactSource:
        """Create or replace an existing artifact source.
        ...
        :type artifact_source: ~azure.mgmt.devtestlabs.models.ArtifactSource or IO[bytes]
        :return: ArtifactSource or the result of cls(response)
        :rtype: ~azure.mgmt.devtestlabs.models.ArtifactSource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
