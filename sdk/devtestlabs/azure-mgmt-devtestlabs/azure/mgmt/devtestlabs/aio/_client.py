...
class DevTestLabClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype schedule_operation_group:
     azure.mgmt.devtestlabs.aio.operations.ScheduleOperationGroupOperations
    ...
    :vartype lab_costs: azure.mgmt.devtestlabs.aio.operations.LabCostsOperations
    ...
    :vartype dtl_environments: azure.mgmt.devtestlabs.aio.operations.DtlEnvironmentsOperations
    ...
    :vartype lab_virtual_machines:
     azure.mgmt.devtestlabs.aio.operations.LabVirtualMachinesOperations
    ...
    :vartype operations_operation_group:
     azure.mgmt.devtestlabs.aio.operations.OperationsOperationGroupOperations
    ...
    def __init__(
        ...
        self._config = DevTestLabClientConfiguration(
