...
class EnvironmentsOperations:
    ...
    def list(
        ...
        orderby: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.DtlEnvironment"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.devtestlabs.models.DtlEnvironment]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either DtlEnvironment or the result of
         cls(response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.DtlEnvironment].from_continuation_token(
