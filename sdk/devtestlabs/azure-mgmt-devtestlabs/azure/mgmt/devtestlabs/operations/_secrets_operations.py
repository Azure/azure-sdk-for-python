...
class SecretsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.SecretList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.devtestlabs.models.SecretList]
