...
class SecretsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.devtestlabs.models.Secret]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either Secret or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.devtestlabs.models.Secret]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param name: The name of the secret. Required.
        :type name: str
        :param secret: A secret. Is either a Secret type or a IO[bytes] type. Required.
        :type secret: ~azure.mgmt.devtestlabs.models.Secret or IO[bytes]
        :return: An instance of LROPoller that returns either Secret or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.devtestlabs.models.Secret]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if cont_token:
            return LROPoller[_models.Secret].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.Secret](
