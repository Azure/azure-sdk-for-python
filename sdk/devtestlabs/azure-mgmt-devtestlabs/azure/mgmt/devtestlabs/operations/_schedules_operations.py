...
def build_list_applicable_request(
    resource_group_name: str, lab_name: str, name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class SchedulesOperations:
    ...
    def _execute_initial(self, resource_group_name: str, lab_name: str, name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def list_applicable(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_applicable_request(
                    resource_group_name=resource_group_name,
                    lab_name=lab_name,
                    name=name,
                    subscription_id=self._config.subscription_id,
