...
class FormulasOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("Formula", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        lab_name: str,
        name: str,
        formula: Union[_models.Formula, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type formula: ~azure.mgmt.devtestlabs.models.Formula or IO[bytes]
        :return: An instance of LROPoller that returns either Formula or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.devtestlabs.models.Formula]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if cont_token:
            return LROPoller[_models.Formula].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.Formula](
