...
class UsersOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.devtestlabs.models.User]
    ...
    def _create_or_update_initial(
        self, resource_group_name: str, lab_name: str, name: str, user: Union[_models.User, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.devtestlabs.models.User]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        :param name: The name of the user profile. Required.
        :type name: str
        :param user: Profile of a lab user. Is either a User type or a IO[bytes] type. Required.
        :type user: ~azure.mgmt.devtestlabs.models.User or IO[bytes]
        :return: An instance of LROPoller that returns either User or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.devtestlabs.models.User]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
