...
class CustomImagesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :type orderby: str
        :return: An iterator like instance of either CustomImage or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.devtestlabs.models.CustomImage]
    ...
    def get(
        ...
        deserialized = self._deserialize("CustomImage", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        lab_name: str,
        name: str,
        custom_image: Union[_models.CustomImage, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either CustomImage or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.devtestlabs.models.CustomImage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param name: The name of the custom image. Required.
        :type name: str
        :param custom_image: A custom image. Is either a CustomImage type or a IO[bytes] type.
         Required.
        :type custom_image: ~azure.mgmt.devtestlabs.models.CustomImage or IO[bytes]
        :return: An instance of LROPoller that returns either CustomImage or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.devtestlabs.models.CustomImage]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.CustomImage].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.CustomImage](
