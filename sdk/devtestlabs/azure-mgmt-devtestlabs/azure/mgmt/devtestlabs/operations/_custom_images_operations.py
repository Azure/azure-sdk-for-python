...
class CustomImagesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CustomImageList"]
        ...
        :return: An iterator like instance of either CustomImageList or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.devtestlabs.models.CustomImageList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CustomImageList"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CustomImage"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def _create_or_update_initial(
        ...
        lab_name,  # type: str
        name,  # type: str
        custom_image,  # type: "models.CustomImage"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.CustomImage"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CustomImage"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.CustomImage"]
        ...
        :return: An instance of LROPoller that returns either CustomImage or the result of cls(response)
    ...
    def update(
        ...
        lab_name,  # type: str
        name,  # type: str
        custom_image,  # type: "models.CustomImageFragment"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.CustomImage"
