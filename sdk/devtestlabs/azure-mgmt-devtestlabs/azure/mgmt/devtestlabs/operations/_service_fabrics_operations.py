...
class ServiceFabricsOperations:
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: DevTestLabsClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def list(
        ...
        orderby: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.ServiceFabric"]:
        ...
        :type orderby: str
        :return: An iterator like instance of either ServiceFabric or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.devtestlabs.models.ServiceFabric]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("ServiceFabric", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        user_name: str,
        name: str,
        service_fabric: Union[_models.ServiceFabric, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ServiceFabric or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.devtestlabs.models.ServiceFabric]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param name: The name of the service fabric. Required.
        :type name: str
        :param service_fabric: A Service Fabric. Is either a ServiceFabric type or a IO[bytes] type.
         Required.
        :type service_fabric: ~azure.mgmt.devtestlabs.models.ServiceFabric or IO[bytes]
        :return: An instance of LROPoller that returns either ServiceFabric or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.devtestlabs.models.ServiceFabric]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.ServiceFabric].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ServiceFabric](
