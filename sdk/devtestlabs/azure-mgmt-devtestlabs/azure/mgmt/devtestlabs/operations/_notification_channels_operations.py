...
class NotificationChannelsOperations:
    ...
    def list(
        ...
        orderby: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.NotificationChannel"]:
    ...
    def get(
        ...
        deserialized = self._deserialize("NotificationChannel", pipeline_response.http_response)
    ...
    def create_or_update(
        ...
        lab_name: str,
        name: str,
        notification_channel: Union[_models.NotificationChannel, IO[bytes]],
        **kwargs: Any
    ) -> _models.NotificationChannel:
        """Create or replace an existing notification channel.
        ...
        :param name: The name of the notification channel. Required.
        :type name: str
        :param notification_channel: A notification. Is either a NotificationChannel type or a
         IO[bytes] type. Required.
        :type notification_channel: ~azure.mgmt.devtestlabs.models.NotificationChannel or IO[bytes]
        :return: NotificationChannel or the result of cls(response)
        :rtype: ~azure.mgmt.devtestlabs.models.NotificationChannel
        :raises ~azure.core.exceptions.HttpResponseError:
        """
