...
class NotificationChannelsOperations(object):
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.NotificationChannelPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def update(
            self, resource_group_name, lab_name, name, notification_channel, custom_headers=None, raw=False, **operation_config):
        """Allows modifying tags of notificationchannels. All other properties
        will be ignored.
