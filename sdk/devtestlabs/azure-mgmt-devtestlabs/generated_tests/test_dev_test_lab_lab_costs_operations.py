...
class TestDevTestLabLabCostsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(DevTestLabClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_lab_costs_get(self, resource_group):
        response = self.client.lab_costs.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_lab_costs_create_or_update(self, resource_group):
        response = self.client.lab_costs.create_or_update(
            resource_group_name=resource_group.name,
            lab_name="str",
            name="str",
            lab_cost={
