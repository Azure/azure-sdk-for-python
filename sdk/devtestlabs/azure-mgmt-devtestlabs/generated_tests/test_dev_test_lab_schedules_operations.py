...
class TestDevTestLabSchedulesOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_schedules_list_by_resource_group(self, resource_group):
        response = self.client.schedules.list_by_resource_group(
            resource_group_name=resource_group.name,
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_schedules_list_by_subscription(self, resource_group):
        response = self.client.schedules.list_by_subscription()
        result = [r for r in response]
        # please add some check logic here by yourself
        # ...
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_schedules_begin_retarget(self, resource_group):
        response = self.client.schedules.begin_retarget(
            resource_group_name=resource_group.name,
            name="str",
