...
class TestDevTestLabsSecretsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_secrets_begin_create_or_update(self, resource_group):
        response = self.client.secrets.begin_create_or_update(
            resource_group_name=resource_group.name,
            lab_name="str",
            user_name="str",
            name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_secrets_delete(self, resource_group):
