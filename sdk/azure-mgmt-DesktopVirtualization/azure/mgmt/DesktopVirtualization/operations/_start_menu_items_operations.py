...
class StartMenuItemsOperations(object):
    ...
    def list(
        ...
        :return: An iterator like instance of StartMenuItem
        :rtype:
         ~azure.mgmt.desktopvirtualization.models.StartMenuItemPaged[~azure.mgmt.desktopvirtualization.models.StartMenuItem]
        ...
        if raw:
            header_dict = {}
        deserialized = models.StartMenuItemPaged(internal_paging, self._deserialize.dependencies, header_dict)
