...
class ApplicationsOperations(object):
    ...
    :ivar api_version: The API version to use for this operation. Constant value: "2019-01-23-preview".
    """
    ...
    def __init__(self, client, config, serializer, deserializer):
        ...
        self.api_version = "2019-01-23-preview"

        self.config = config

    def get(
            self, resource_group_name, application_group_name, application_name, custom_headers=None, raw=False, **operation_config):
        """Get an application.
        ...
        :param application_name: The name of the application within the
        ...
        :rtype: ~azure.mgmt.desktopvirtualization.models.Application or
    ...
    def create_or_update(
            self, resource_group_name, application_group_name, application_name, application, custom_headers=None, raw=False, **operation_config):
        ...
        :type application:
         ~azure.mgmt.desktopvirtualization.models.Application
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def update(
            self, resource_group_name, application_group_name, application_name, application=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param application: Object containing Application definitions.
        :type application:
         ~azure.mgmt.desktopvirtualization.models.ApplicationPatch
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.desktopvirtualization.models.ApplicationPaged[~azure.mgmt.desktopvirtualization.models.Application]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
