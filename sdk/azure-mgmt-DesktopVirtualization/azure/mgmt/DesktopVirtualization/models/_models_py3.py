...
class Application(Resource):
    ...
    def __init__(self, *, description: str=None, friendly_name: str=None, file_path: str=None, command_line_setting=None, command_line_arguments: str=None, show_in_portal: bool=None, icon_path: str=None, icon_index: int=None, **kwargs) -> None:
...
class ApplicationGroup(TrackedResource):
    ...
    def __init__(self, *, tags=None, location: str=None, description: str=None, friendly_name: str=None, host_pool_arm_path: str=None, application_group_type=None, **kwargs) -> None:
...
class HostPool(TrackedResource):
    ...
    def __init__(self, *, tags=None, location: str=None, friendly_name: str=None, description: str=None, host_pool_type=None, personal_desktop_assignment_type=None, custom_rdp_property: str=None, max_session_limit: int=None, load_balancer_type=None, ring: int=None, validation_environment: bool=None, registration_info=None, vm_template: str=None, sso_context: str=None, **kwargs) -> None:
...
class RegistrationInfo(Model):
    ...
    def __init__(self, *, expiration_time=None, token: str=None, reset_token: bool=None, **kwargs) -> None:
...
class RegistrationInfoPatch(Model):
    ...
    def __init__(self, *, reset_token: bool=None, **kwargs) -> None:
...
class Workspace(TrackedResource):
    ...
    def __init__(self, *, tags=None, location: str=None, description: str=None, friendly_name: str=None, application_group_references=None, **kwargs) -> None:
