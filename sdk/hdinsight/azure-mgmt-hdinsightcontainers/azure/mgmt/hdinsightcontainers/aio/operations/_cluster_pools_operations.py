...
class ClusterPoolsOperations:
    ...
    async def _upgrade_initial(
        ...
        resource_group_name: str,
        cluster_pool_name: str,
        cluster_pool_upgrade_request: Union[_models.ClusterPoolUpgrade, IO],
        **kwargs: Any
    ...
    _upgrade_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HDInsight/clusterpools/{clusterPoolName}/upgrade"
    }
    ...
    async def begin_upgrade(
        ...
        resource_group_name: str,
        cluster_pool_name: str,
        cluster_pool_upgrade_request: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.ClusterPool]:
        ...
        :type cluster_pool_name: str
        :param cluster_pool_upgrade_request: Upgrade a cluster pool. Required.
        :type cluster_pool_upgrade_request: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
