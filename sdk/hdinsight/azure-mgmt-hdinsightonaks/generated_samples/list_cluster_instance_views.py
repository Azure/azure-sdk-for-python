...
from azure.mgmt.hdinsightonaks import HDInsightOnAksMgmtClient

"""
# PREREQUISITES
    pip install azure-identity
    pip install azure-mgmt-hdinsightonaks
# USAGE
    python list_cluster_instance_views.py
...
def main():
    client = HDInsightOnAksMgmtClient(
        credential=DefaultAzureCredential(),
        subscription_id="10e32bab-26da-4cc4-a441-52b318f824e6",
    )

    response = client.clusters.list_instance_views(
