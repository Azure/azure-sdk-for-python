...
class HDInsightOnAksMgmtClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    """Configuration for HDInsightOnAksMgmtClient.
    ...
    def __init__(self, credential: "TokenCredential", subscription_id: str, **kwargs: Any) -> None:
        super(HDInsightOnAksMgmtClientConfiguration, self).__init__(**kwargs)
