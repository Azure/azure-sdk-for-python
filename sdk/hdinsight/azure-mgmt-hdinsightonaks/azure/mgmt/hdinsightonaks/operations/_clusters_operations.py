...
class ClustersOperations:
    ...
    def list_by_cluster_pool_name(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.hdinsightonaks.models.Cluster]
    ...
    def begin_resize(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.hdinsightonaks.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_service_configs(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.hdinsightonaks.models.ServiceConfigResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_instance_views(
        ...
        :return: An iterator like instance of either ClusterInstanceViewResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.hdinsightonaks.models.ClusterInstanceViewResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
