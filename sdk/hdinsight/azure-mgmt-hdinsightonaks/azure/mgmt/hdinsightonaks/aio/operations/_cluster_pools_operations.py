...
class ClusterPoolsOperations:
    ...
    async def get(self, resource_group_name: str, cluster_pool_name: str, **kwargs: Any) -> _models.ClusterPool:
        """Gets a cluster pool.
        ...
        :rtype: ~azure.mgmt.hdinsightonaks.models.ClusterPool
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type cluster_pool: ~azure.mgmt.hdinsightonaks.models.ClusterPool
        ...
        :return: An instance of AsyncLROPoller that returns either ClusterPool or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.hdinsightonaks.models.ClusterPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param cluster_pool: The Cluster Pool to create. Is either a ClusterPool type or a IO type.
         Required.
        :type cluster_pool: ~azure.mgmt.hdinsightonaks.models.ClusterPool or IO
    ...
    async def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :type cluster_pool_tags: ~azure.mgmt.hdinsightonaks.models.TagsObject
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :param cluster_pool_tags: Parameters supplied to update tags. Is either a TagsObject type or a
         IO type. Required.
        :type cluster_pool_tags: ~azure.mgmt.hdinsightonaks.models.TagsObject or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        if cont_token is None:
            raw_result = await self._update_tags_initial(
                resource_group_name=resource_group_name,
                cluster_pool_name=cluster_pool_name,
                cluster_pool_tags=cluster_pool_tags,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x, y, z: x,
                headers=_headers,
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.ClusterPool"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hdinsightonaks.models.ClusterPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
