...
class LocationsOperations:
    ...
    async def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type name_availability_parameters:
         ~azure.mgmt.hdinsightonaks.models.NameAvailabilityParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NameAvailabilityResult or the result of cls(response)
        :rtype: ~azure.mgmt.hdinsightonaks.models.NameAvailabilityResult
    ...
    async def check_name_availability(
        ...
        :type name_availability_parameters:
         ~azure.mgmt.hdinsightonaks.models.NameAvailabilityParameters or IO
