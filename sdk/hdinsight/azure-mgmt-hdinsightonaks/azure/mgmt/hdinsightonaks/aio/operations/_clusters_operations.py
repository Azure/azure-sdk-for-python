...
class ClustersOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.hdinsightonaks.aio.HDInsightOnAksMgmtClient`'s
    ...
    def list_by_cluster_pool_name(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hdinsightonaks.models.Cluster]
    ...
    async def begin_resize(
        ...
        cluster_pool_name: str,
        cluster_name: str,
        cluster_resize_request: _models.ClusterResizeData,
        *,
        ...
        **kwargs: Any
        ...
        :type cluster_resize_request: ~azure.mgmt.hdinsightonaks.models.ClusterResizeData
        ...
        :return: An instance of AsyncLROPoller that returns either Cluster or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.hdinsightonaks.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_resize(
        ...
        **kwargs: Any
        ...
        :param cluster_resize_request: Resize a cluster. Is either a ClusterResizeData type or a IO
         type. Required.
        :type cluster_resize_request: ~azure.mgmt.hdinsightonaks.models.ClusterResizeData or IO
        ...
        if cont_token is None:
            raw_result = await self._resize_initial(
                ...
                cluster_pool_name=cluster_pool_name,
                cluster_name=cluster_name,
                cluster_resize_request=cluster_resize_request,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x, y, z: x,
                headers=_headers,
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.hdinsightonaks.models.Cluster
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type hd_insight_cluster: ~azure.mgmt.hdinsightonaks.models.Cluster
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param hd_insight_cluster: The cluster to create. Is either a Cluster type or a IO type.
         Required.
        :type hd_insight_cluster: ~azure.mgmt.hdinsightonaks.models.Cluster or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        if cont_token is None:
            raw_result = await self._create_initial(
                ...
                cluster_pool_name=cluster_pool_name,
                cluster_name=cluster_name,
                hd_insight_cluster=hd_insight_cluster,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x, y, z: x,
                headers=_headers,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type cluster_patch_request: ~azure.mgmt.hdinsightonaks.models.ClusterPatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param cluster_patch_request: Patch a cluster. Is either a ClusterPatch type or a IO type.
         Required.
        :type cluster_patch_request: ~azure.mgmt.hdinsightonaks.models.ClusterPatch or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        if cont_token is None:
            raw_result = await self._update_initial(
                ...
                cluster_pool_name=cluster_pool_name,
                cluster_name=cluster_name,
                cluster_patch_request=cluster_patch_request,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x, y, z: x,
                headers=_headers,
    ...
    def list_service_configs(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hdinsightonaks.models.ServiceConfigResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_instance_views(
        ...
        :return: An iterator like instance of either ClusterInstanceViewResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hdinsightonaks.models.ClusterInstanceViewResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_instance_view(
        ...
        :rtype: ~azure.mgmt.hdinsightonaks.models.ClusterInstanceViewResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
