...
class ClusterJobsOperations:
    ...
    async def begin_run_job(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ClusterJob or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.hdinsightonaks.models.ClusterJob]
    ...
    def list(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hdinsightonaks.models.ClusterJob]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
