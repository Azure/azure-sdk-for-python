...
from ._configuration import HDInsightOnAksMgmtClientConfiguration
...
class HDInsightOnAksMgmtClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    """HDInsight On Aks Management Client.

    :ivar cluster_pools: ClusterPoolsOperations operations
    :vartype cluster_pools: azure.mgmt.hdinsightonaks.aio.operations.ClusterPoolsOperations
    :ivar clusters: ClustersOperations operations
    :vartype clusters: azure.mgmt.hdinsightonaks.aio.operations.ClustersOperations
    :ivar cluster_jobs: ClusterJobsOperations operations
    :vartype cluster_jobs: azure.mgmt.hdinsightonaks.aio.operations.ClusterJobsOperations
    :ivar locations: LocationsOperations operations
    :vartype locations: azure.mgmt.hdinsightonaks.aio.operations.LocationsOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.hdinsightonaks.aio.operations.Operations
    ...
    :vartype available_cluster_pool_versions:
     azure.mgmt.hdinsightonaks.aio.operations.AvailableClusterPoolVersionsOperations
    :ivar available_cluster_versions: AvailableClusterVersionsOperations operations
    :vartype available_cluster_versions:
     azure.mgmt.hdinsightonaks.aio.operations.AvailableClusterVersionsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = HDInsightOnAksMgmtClientConfiguration(
    ...
    async def __aenter__(self) -> "HDInsightOnAksMgmtClient":
