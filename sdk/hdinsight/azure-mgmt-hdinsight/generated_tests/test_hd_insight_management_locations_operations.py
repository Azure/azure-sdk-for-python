...
class TestHDInsightManagementLocationsOperations(AzureMgmtRecordedTestCase):
        ...
        response = self.client.locations.validate_cluster_create_request(
            ...
            parameters={
                ...
                "properties": {
                    ...
                    "clusterVersion": "str",
                    "computeIsolationProperties": {"enableComputeIsolation": bool, "hostSku": "str"},
                    "computeProfile": {
                        "roles": [
                            {
                                "VMGroupName": "str",
                    ...
                    "encryptionInTransitProperties": {"isEncryptionInTransitEnabled": bool},
                    "kafkaRestProperties": {
