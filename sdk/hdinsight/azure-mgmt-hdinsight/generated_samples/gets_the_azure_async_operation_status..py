...
# USAGE
    python gets_the_azure_async_operation_status..py
...
def main():
    ...
    response = client.locations.get_azure_async_operation_status(
        location="East US 2",
        operation_id="8a0348f4-8a85-4ec2-abe0-03b26104a9a0-0",
    )
    print(response)
