...
from ...operations._applications_operations import build_create_request_initial, build_delete_request_initial, build_get_azure_async_operation_status_request, build_get_request, build_list_by_cluster_request
T = TypeVar('T')
    ...
    def list_by_cluster(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ApplicationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hdinsight.models.ApplicationListResult]
