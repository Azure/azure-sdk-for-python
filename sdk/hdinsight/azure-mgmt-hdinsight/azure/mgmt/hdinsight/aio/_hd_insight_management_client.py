...
from .operations import ApplicationsOperations, ClustersOperations, ConfigurationsOperations, ExtensionsOperations, LocationsOperations, Operations, PrivateEndpointConnectionsOperations, PrivateLinkResourcesOperations, ScriptActionsOperations, ScriptExecutionHistoryOperations, VirtualMachinesOperations

if TYPE_CHECKING:
    # pylint: disable=unused-import,ungrouped-imports
    from azure.core.credentials_async import AsyncTokenCredential

class HDInsightManagementClient:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = HDInsightManagementClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
        ...
        self.script_execution_history = ScriptExecutionHistoryOperations(self._client, self._config, self._serialize, self._deserialize)
