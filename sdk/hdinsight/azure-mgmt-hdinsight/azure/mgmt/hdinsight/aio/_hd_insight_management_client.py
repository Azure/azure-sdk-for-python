...
from .operations import ApplicationsOperations, ClustersOperations, ConfigurationsOperations, ExtensionsOperations, LocationsOperations, Operations, ScriptActionsOperations, ScriptExecutionHistoryOperations, VirtualMachinesOperations
