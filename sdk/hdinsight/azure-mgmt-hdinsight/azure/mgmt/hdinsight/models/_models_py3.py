...
class CapabilitiesResult(msrest.serialization.Model):
    ...
    :ivar vmsizes: The virtual machine sizes.
    :vartype vmsizes: dict[str, ~azure.mgmt.hdinsight.models.VmSizesCapability]
    :ivar vmsize_filters: The virtual machine size compatibility filters.
    :vartype vmsize_filters: list[~azure.mgmt.hdinsight.models.VmSizeCompatibilityFilter]
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword vmsizes: The virtual machine sizes.
        :paramtype vmsizes: dict[str, ~azure.mgmt.hdinsight.models.VmSizesCapability]
        :keyword vmsize_filters: The virtual machine size compatibility filters.
        :paramtype vmsize_filters: list[~azure.mgmt.hdinsight.models.VmSizeCompatibilityFilter]
...
class SecurityProfile(msrest.serialization.Model):
    ...
    :ivar directory_type: The directory type. The only acceptable values to pass in are None and
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword directory_type: The directory type. The only acceptable values to pass in are None and
         "ActiveDirectory". The default value is None.
        :paramtype directory_type: str
...
class VmSizeCompatibilityFilter(msrest.serialization.Model):
    ...
    :ivar filter_mode: The mode for the filter.
    :vartype filter_mode: str
    :ivar regions: The list of regions.
    :vartype regions: list[str]
    :ivar cluster_flavors: The list of cluster types available.
    :vartype cluster_flavors: list[str]
    :ivar node_types: The list of node types.
    :vartype node_types: list[str]
    :ivar cluster_versions: The list of cluster versions.
    :vartype cluster_versions: list[str]
    :ivar os_type: The list of OS types.
    :vartype os_type: list[str]
    :ivar vm_sizes: The list of virtual machine sizes.
    :vartype vm_sizes: list[str]
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword filter_mode: The mode for the filter.
        :paramtype filter_mode: str
        :keyword regions: The list of regions.
        :paramtype regions: list[str]
        :keyword cluster_flavors: The list of cluster types available.
        :paramtype cluster_flavors: list[str]
        :keyword node_types: The list of node types.
        :paramtype node_types: list[str]
        :keyword cluster_versions: The list of cluster versions.
        :paramtype cluster_versions: list[str]
        :keyword os_type: The list of OS types.
        :paramtype os_type: list[str]
        :keyword vm_sizes: The list of virtual machine sizes.
        :paramtype vm_sizes: list[str]
...
class VmSizesCapability(msrest.serialization.Model):
    ...
    :ivar available: The list of virtual machine size capabilities.
    :vartype available: list[str]
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword available: The list of virtual machine size capabilities.
        :paramtype available: list[str]
        """
