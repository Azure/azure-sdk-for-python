...
class AzureMonitorRequest(Model):
    ...
    def __init__(self, *, workspace_id: str=None, primary_key: str=None, selected_configurations=None, **kwargs) -> None:
...
class AzureMonitorResponse(Model):
    ...
    def __init__(self, *, cluster_monitoring_enabled: bool=None, workspace_id: str=None, selected_configurations=None, **kwargs) -> None:
...
class AzureMonitorSelectedConfigurations(Model):
    ...
    def __init__(self, *, configuration_version: str=None, global_configurations=None, table_list=None, **kwargs) -> None:
