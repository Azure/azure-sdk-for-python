...
class AzureMonitorRequest(Model):
...
class AzureMonitorResponse(Model):
...
class AzureMonitorSelectedConfigurations(Model):
    ...
    :param global_configurations: The global configurations of selected
     configurations.
    :type global_configurations: dict[str, str]
    :param table_list: The table list.
    :type table_list:
     list[~azure.mgmt.hdinsight.models.AzureMonitorTableConfiguration]
    """
...
class AzureMonitorTableConfiguration(Model):
