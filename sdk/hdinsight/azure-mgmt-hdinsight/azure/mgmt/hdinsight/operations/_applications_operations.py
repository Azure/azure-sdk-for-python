...
class ApplicationsOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param application_name: The constant value for the application name. Required.
        :type application_name: str
        :param parameters: The application create request. Is either a Application type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.hdinsight.models.Application or IO[bytes]
        :return: An instance of LROPoller that returns either Application or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.hdinsight.models.Application]
        :raises ~azure.core.exceptions.HttpResponseError:
