...
class ApplicationsOperations(object):
    ...
    def get_azure_async_operation_status(
            self, resource_group_name, cluster_name, application_name, operation_id, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    get_azure_async_operation_status.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HDInsight/clusters/{clusterName}/applications/{applicationName}/azureasyncoperations/{operationId}'}
