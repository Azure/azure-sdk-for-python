...
def build_get_azure_async_operation_status_request(  # pylint: disable=name-too-long
...
def build_validate_cluster_create_request_request(  # pylint: disable=name-too-long
