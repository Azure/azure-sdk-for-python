...
class ExtensionsOperations(object):
    ...
    def _enable_monitoring_initial(
        ...
        parameters,  # type: "_models.ClusterMonitoringRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
    ...
    def get_monitoring_status(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.ClusterMonitoringResponse"
    ...
    def _enable_azure_monitor_initial(
        ...
        resource_group_name,  # type: str
        cluster_name,  # type: str
        parameters,  # type: "_models.AzureMonitorRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
    ...
    def get_azure_monitor_status(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.AzureMonitorResponse"
    ...
    def _create_initial(
        ...
        parameters,  # type: "_models.Extension"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
