...
class ScriptActionsOperations(object):
    ...
    def get_execution_async_operation_status(
            self, resource_group_name, cluster_name, operation_id, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.get_execution_async_operation_status.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'clusterName': self._serialize.url("cluster_name", cluster_name, 'str'),
        ...
        return deserialized
    get_execution_async_operation_status.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HDInsight/clusters/{clusterName}/executeScriptActions/azureasyncoperations/{operationId}'}
