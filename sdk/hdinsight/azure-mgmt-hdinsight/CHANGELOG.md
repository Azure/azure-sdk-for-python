...
### Breaking Changes
  ...
  - Deleted or renamed model `ClusterListPersistedScriptActionsResult`
  - Renamed model `ErrorResponse` to `ErrorResponseAutoGenerated`
  - Deleted or renamed model `ResourceAutoGenerated`
  - Deleted or renamed model `ScriptActionExecutionHistoryList`
  - Deleted or renamed model `ScriptActionPersistedGetResponseSpec`
  - Deleted or renamed model `ScriptActionsList`
