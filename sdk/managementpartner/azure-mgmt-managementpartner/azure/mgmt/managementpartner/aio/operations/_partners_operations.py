...
from ...operations._partners_operations import build_get_request
...
class PartnersOperations:
    ...
    async def get(self, **kwargs: Any) -> _models.PartnerResponse:
    ...
    get.metadata = {"url": "/providers/Microsoft.ManagementPartner/partners"}  # type: ignore
