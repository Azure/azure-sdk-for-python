...
class TestConnectedCacheMgmtEnterpriseMccCacheNodesOperationsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(ConnectedCacheMgmtClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_enterprise_mcc_cache_nodes_operations_get(self, resource_group):
        response = self.client.enterprise_mcc_cache_nodes_operations.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_enterprise_mcc_cache_nodes_operations_begin_create_or_update(self, resource_group):
        response = self.client.enterprise_mcc_cache_nodes_operations.begin_create_or_update(
            resource_group_name=resource_group.name,
            customer_resource_name="str",
            cache_node_resource_name="str",
            resource={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_enterprise_mcc_cache_nodes_operations_update(self, resource_group):
        response = self.client.enterprise_mcc_cache_nodes_operations.update(
            resource_group_name=resource_group.name,
            customer_resource_name="str",
            cache_node_resource_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_enterprise_mcc_cache_nodes_operations_begin_delete(self, resource_group):
        response = self.client.enterprise_mcc_cache_nodes_operations.begin_delete(
            resource_group_name=resource_group.name,
            customer_resource_name="str",
            cache_node_resource_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_enterprise_mcc_cache_nodes_operations_list_by_enterprise_mcc_customer_resource(self, resource_group):
        response = self.client.enterprise_mcc_cache_nodes_operations.list_by_enterprise_mcc_customer_resource(
            resource_group_name=resource_group.name,
            customer_resource_name="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_enterprise_mcc_cache_nodes_operations_get_cache_node_install_details(self, resource_group):
        response = self.client.enterprise_mcc_cache_nodes_operations.get_cache_node_install_details(
            resource_group_name=resource_group.name,
            customer_resource_name="str",
            cache_node_resource_name="str",
        )
