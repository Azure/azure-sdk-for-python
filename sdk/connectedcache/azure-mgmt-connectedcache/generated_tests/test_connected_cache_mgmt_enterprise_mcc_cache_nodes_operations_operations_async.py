...
class TestConnectedCacheMgmtEnterpriseMccCacheNodesOperationsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_enterprise_mcc_cache_nodes_operations_get_cache_node_auto_update_history(self, resource_group):
        response = await self.client.enterprise_mcc_cache_nodes_operations.get_cache_node_auto_update_history(
            resource_group_name=resource_group.name,
            customer_resource_name="str",
            cache_node_resource_name="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_enterprise_mcc_cache_nodes_operations_get_cache_node_mcc_issue_details_history(self, resource_group):
        response = await self.client.enterprise_mcc_cache_nodes_operations.get_cache_node_mcc_issue_details_history(
            resource_group_name=resource_group.name,
            customer_resource_name="str",
            cache_node_resource_name="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_enterprise_mcc_cache_nodes_operations_get_cache_node_tls_certificate_history(self, resource_group):
        response = await self.client.enterprise_mcc_cache_nodes_operations.get_cache_node_tls_certificate_history(
            resource_group_name=resource_group.name,
            customer_resource_name="str",
            cache_node_resource_name="str",
        )
