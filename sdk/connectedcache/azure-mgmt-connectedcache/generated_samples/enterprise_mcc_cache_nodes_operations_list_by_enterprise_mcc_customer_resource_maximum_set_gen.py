...
# USAGE
    python enterprise_mcc_cache_nodes_operations_list_by_enterprise_mcc_customer_resource_maximum_set_gen.py
...
def main():
    ...
    response = client.enterprise_mcc_cache_nodes_operations.list_by_enterprise_mcc_customer_resource(
        resource_group_name="rgConnectedCache",
        customer_resource_name="syjjjzk",
    )
