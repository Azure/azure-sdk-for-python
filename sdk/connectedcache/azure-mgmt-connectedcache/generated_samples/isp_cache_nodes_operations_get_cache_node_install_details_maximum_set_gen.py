...
# USAGE
    python isp_cache_nodes_operations_get_cache_node_install_details_maximum_set_gen.py
...
def main():
    ...
    response = client.isp_cache_nodes_operations.get_cache_node_install_details(
