...
# USAGE
    python cache_nodes_operations_delete_maximum_set_gen.py
...
def main():
    ...
    client.cache_nodes_operations.delete(
        resource_group_name="rgConnectedCache",
        customer_resource_name="otvtvhmovthjwzjzbsqkbnmpcmmeianpqxmmaspvdczmrenquxigrtuarmlcmvsnaclhcbw",
    )
