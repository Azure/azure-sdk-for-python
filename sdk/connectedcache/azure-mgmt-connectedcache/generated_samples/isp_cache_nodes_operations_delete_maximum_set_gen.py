...
# USAGE
    python isp_cache_nodes_operations_delete_maximum_set_gen.py
...
def main():
    ...
    client.isp_cache_nodes_operations.begin_delete(
        resource_group_name="rgConnectedCache",
        customer_resource_name="lvpcosvbfxtpzscakewx",
        cache_node_resource_name="wsiruvexelltpbouqxvsogqpxdizcwqwfowybncvjunlakjwcpgmqbdbgzjrsmxlkczxnsxfonhnqqa",
    ).result()
