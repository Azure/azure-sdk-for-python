...
# USAGE
    python enterprise_mcc_cache_nodes_operations_delete_maximum_set_gen.py
...
def main():
    ...
    client.enterprise_mcc_cache_nodes_operations.begin_delete(
        resource_group_name="rgConnectedCache",
        customer_resource_name="hsincngmssuzeyispnufqwinpopadvhsbsemisguxgovwdjwviqexocelijvuyr",
        cache_node_resource_name="vwtrhdoxvkrunpliwcao",
    ).result()
