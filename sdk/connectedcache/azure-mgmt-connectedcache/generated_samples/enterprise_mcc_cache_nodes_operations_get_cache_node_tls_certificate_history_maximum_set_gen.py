...
# USAGE
    python enterprise_mcc_cache_nodes_operations_get_cache_node_tls_certificate_history_maximum_set_gen.py
...
def main():
    ...
    response = client.enterprise_mcc_cache_nodes_operations.get_cache_node_tls_certificate_history(
