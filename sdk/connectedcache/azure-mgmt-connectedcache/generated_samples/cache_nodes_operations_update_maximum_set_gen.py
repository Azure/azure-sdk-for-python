...
# USAGE
    python cache_nodes_operations_update_maximum_set_gen.py
...
def main():
    ...
    response = client.cache_nodes_operations.update(
        resource_group_name="rgConnectedCache",
        customer_resource_name="wlrwpdbcv",
        properties={"tags": {"key5032": "esiuyjbpcwkpqriqiqztxuocv"}},
    )
    print(response)
