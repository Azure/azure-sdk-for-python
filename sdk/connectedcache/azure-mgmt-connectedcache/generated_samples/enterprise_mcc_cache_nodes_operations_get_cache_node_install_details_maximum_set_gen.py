...
# USAGE
    python enterprise_mcc_cache_nodes_operations_get_cache_node_install_details_maximum_set_gen.py
...
def main():
    ...
    response = client.enterprise_mcc_cache_nodes_operations.get_cache_node_install_details(
        resource_group_name="rgConnectedCache",
        customer_resource_name="fzwxcjmdpxxzayecabqqlh",
        cache_node_resource_name="ccexmqqttritxvtctivraso",
    )
    print(response)
