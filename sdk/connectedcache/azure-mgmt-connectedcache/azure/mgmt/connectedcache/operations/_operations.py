...
def build_operations_list_request(**kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2024-11-30-preview"))
...
def build_isp_cache_nodes_operations_get_cache_node_auto_update_history_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    customer_resource_name: str,
    cache_node_resource_name: str,
    subscription_id: str,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedCache/ispCustomers/{customerResourceName}/ispCacheNodes/{cacheNodeResourceName}/getCacheNodeAutoUpdateHistory"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "customerResourceName": _SERIALIZER.url("customer_resource_name", customer_resource_name, "str"),
...
def build_isp_cache_nodes_operations_get_cache_node_mcc_issue_details_history_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    customer_resource_name: str,
    cache_node_resource_name: str,
    subscription_id: str,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedCache/ispCustomers/{customerResourceName}/ispCacheNodes/{cacheNodeResourceName}/getCacheNodeMccIssueDetailsHistory"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "customerResourceName": _SERIALIZER.url("customer_resource_name", customer_resource_name, "str"),
...
def build_enterprise_mcc_cache_nodes_operations_get_cache_node_auto_update_history_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    customer_resource_name: str,
    cache_node_resource_name: str,
    subscription_id: str,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedCache/enterpriseMccCustomers/{customerResourceName}/enterpriseMccCacheNodes/{cacheNodeResourceName}/getCacheNodeAutoUpdateHistory"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "customerResourceName": _SERIALIZER.url("customer_resource_name", customer_resource_name, "str"),
...
def build_enterprise_mcc_cache_nodes_operations_get_cache_node_mcc_issue_details_history_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    customer_resource_name: str,
    cache_node_resource_name: str,
    subscription_id: str,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedCache/enterpriseMccCustomers/{customerResourceName}/enterpriseMccCacheNodes/{cacheNodeResourceName}/getCacheNodeMccIssueDetailsHistory"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "customerResourceName": _SERIALIZER.url("customer_resource_name", customer_resource_name, "str"),
...
def build_enterprise_mcc_cache_nodes_operations_get_cache_node_tls_certificate_history_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    customer_resource_name: str,
    cache_node_resource_name: str,
    subscription_id: str,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedCache/enterpriseMccCustomers/{customerResourceName}/enterpriseMccCacheNodes/{cacheNodeResourceName}/getCacheNodeTlsCertificateHistory"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "customerResourceName": _SERIALIZER.url("customer_resource_name", customer_resource_name, "str"),
...
class IspCustomersOperations:
    ...
    ) -> ItemPaged["_models.IspCustomerResource"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.IspCustomerResource"]:
...
class IspCacheNodesOperationsOperations:
    ...
    ) -> ItemPaged["_models.IspCacheNodeResource"]:
    ...
    @api_version_validation(
        method_added_on="2024-11-30-preview",
        params_added_on={
            "2024-11-30-preview": [
                "api_version",
                "subscription_id",
    ...
    def get_cache_node_auto_update_history(
        self, resource_group_name: str, customer_resource_name: str, cache_node_resource_name: str, **kwargs: Any
    ) -> _models.MccCacheNodeAutoUpdateHistory:
        ...
        :param cache_node_resource_name: Name of the ConnectedCache resource. Required.
        :type cache_node_resource_name: str
        :return: MccCacheNodeAutoUpdateHistory. The MccCacheNodeAutoUpdateHistory is compatible with
         MutableMapping
        :rtype: ~azure.mgmt.connectedcache.models.MccCacheNodeAutoUpdateHistory
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.MccCacheNodeAutoUpdateHistory] = kwargs.pop("cls", None)
    ...
    def get_cache_node_mcc_issue_details_history(
        self, resource_group_name: str, customer_resource_name: str, cache_node_resource_name: str, **kwargs: Any
    ) -> _models.MccCacheNodeIssueHistory:
        ...
        :param cache_node_resource_name: Name of the ConnectedCache resource. Required.
        :type cache_node_resource_name: str
        :return: MccCacheNodeIssueHistory. The MccCacheNodeIssueHistory is compatible with
         MutableMapping
        :rtype: ~azure.mgmt.connectedcache.models.MccCacheNodeIssueHistory
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.MccCacheNodeIssueHistory] = kwargs.pop("cls", None)

        _request = build_isp_cache_nodes_operations_get_cache_node_mcc_issue_details_history_request(
            resource_group_name=resource_group_name,
            customer_resource_name=customer_resource_name,
            cache_node_resource_name=cache_node_resource_name,
            subscription_id=self._config.subscription_id,
...
class EnterpriseMccCustomersOperations:
    ...
    def list_by_resource_group(
        self, resource_group_name: str, **kwargs: Any
    ) -> ItemPaged["_models.EnterpriseMccCustomerResource"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.EnterpriseMccCustomerResource"]:
...
class EnterpriseMccCacheNodesOperationsOperations:  # pylint: disable=name-too-long
    ...
    def list_by_enterprise_mcc_customer_resource(
        self, resource_group_name: str, customer_resource_name: str, **kwargs: Any
    ) -> ItemPaged["_models.EnterpriseMccCacheNodeResource"]:
        """This api retrieves information about all ispCacheNode resources under the given subscription
        and resource group.
    ...
    def get_cache_node_auto_update_history(
        ...
        _request = build_enterprise_mcc_cache_nodes_operations_get_cache_node_auto_update_history_request(
            resource_group_name=resource_group_name,
            customer_resource_name=customer_resource_name,
            cache_node_resource_name=cache_node_resource_name,
            subscription_id=self._config.subscription_id,
    ...
    def get_cache_node_mcc_issue_details_history(
        ...
        _request = build_enterprise_mcc_cache_nodes_operations_get_cache_node_mcc_issue_details_history_request(
            resource_group_name=resource_group_name,
            customer_resource_name=customer_resource_name,
            cache_node_resource_name=cache_node_resource_name,
            subscription_id=self._config.subscription_id,
    ...
    def get_cache_node_tls_certificate_history(
        self, resource_group_name: str, customer_resource_name: str, cache_node_resource_name: str, **kwargs: Any
    ) -> _models.MccCacheNodeTlsCertificateHistory:
        ...
        :param cache_node_resource_name: Name of the ConnectedCache resource. Required.
        :type cache_node_resource_name: str
        :return: MccCacheNodeTlsCertificateHistory. The MccCacheNodeTlsCertificateHistory is compatible
         with MutableMapping
        :rtype: ~azure.mgmt.connectedcache.models.MccCacheNodeTlsCertificateHistory
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.MccCacheNodeTlsCertificateHistory] = kwargs.pop("cls", None)

        _request = build_enterprise_mcc_cache_nodes_operations_get_cache_node_tls_certificate_history_request(
            resource_group_name=resource_group_name,
            customer_resource_name=customer_resource_name,
            cache_node_resource_name=cache_node_resource_name,
            subscription_id=self._config.subscription_id,
