...
# USAGE
    python recovery_plans_update_maximum_set_gen.py
...
def main():
    ...
    response = client.recovery_plans.begin_update(
                ...
                "recoveryGroupsSetting": {
                    ...
                    "defaultGroup": {
                        "properties": {
                            ...
                            "orderId": 3,
                            "postActions": [
                                {"name": "sample-group-action", "timeoutInMinutes": 29, "type": "CustomRunbook"},
                                {
                                    "actionResourceId": "/subscriptions/4e88bed3-114f-443d-9975-28f64122ec5e/resourcegroups/resourceGroup1/providers/Microsoft.Automation/automationAccounts/sampleAccount/runbooks/sameplRunbooks1",
                                    "associatedIdentity": {
                                        "type": "UserAssigned",
