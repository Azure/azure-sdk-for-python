...
class AlertPaged(Paged):
    """
    A paging container for iterating over a list of :class:`Alert <azure.mgmt.edgegateway.models.Alert>` object
    """
...
class BandwidthSchedulePaged(Paged):
    """
    A paging container for iterating over a list of :class:`BandwidthSchedule <azure.mgmt.edgegateway.models.BandwidthSchedule>` object
    """
...
class OrderPaged(Paged):
    """
    A paging container for iterating over a list of :class:`Order <azure.mgmt.edgegateway.models.Order>` object
    """
...
class RolePaged(Paged):
    """
    A paging container for iterating over a list of :class:`Role <azure.mgmt.edgegateway.models.Role>` object
    """
