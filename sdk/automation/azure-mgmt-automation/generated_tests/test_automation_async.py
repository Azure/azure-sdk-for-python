...
class TestAutomationAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(AutomationClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_convert_graph_runbook_content(self, resource_group):
        response = await self.client.convert_graph_runbook_content(
