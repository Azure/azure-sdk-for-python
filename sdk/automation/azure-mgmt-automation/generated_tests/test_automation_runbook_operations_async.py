...
class TestAutomationRunbookOperationsAsync(AzureMgmtRecordedTestCase):
            ...
            parameters={
                "properties": {
                    ...
                    "draft": {
                        ...
                        "outputTypes": ["str"],
                        "parameters": {
                            "str": {"defaultValue": "str", "isMandatory": bool, "position": 0, "type": "str"}
                        },
                    },
                    "logActivityTrace": 0,
                    "logProgress": bool,
    ...
    async def test_runbook_update(self, resource_group):
        response = await self.client.runbook.update(
            ...
            parameters={
                "location": "str",
                "name": "str",
                "properties": {"description": "str", "logActivityTrace": 0, "logProgress": bool, "logVerbose": bool},
                "tags": {"str": "str"},
            },
        )
