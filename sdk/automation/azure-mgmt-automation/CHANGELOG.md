...
### Breaking Changes
  ...
  - Model `PackageCreateOrUpdateParameters` moved instance variable `content_link` under property `properties` whose type is `PackageCreateOrUpdateProperties`
  - Model `PackageUpdateParameters` moved instance variable `content_link` under property `properties` whose type is `PackageUpdateProperties`
  ...
  - Model `RunbookCreateOrUpdateParameters` moved instance variable `log_verbose`, `log_progress`, `runtime_environment`, `runbook_type`, `draft`, `publish_content_link`, `description` and `log_activity_trace` under property `properties` whose type is `RunbookCreateOrUpdateProperties`
  ...
  - Model `RuntimeEnvironmentUpdateParameters` moved instance variable `default_packages` under property `properties` whose type is `RuntimeEnvironmentUpdateProperties`
