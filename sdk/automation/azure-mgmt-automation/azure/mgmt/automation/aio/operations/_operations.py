...
class RunbookDraftOperations:
    ...
    async def _replace_content_initial(
        ...
        **kwargs: Any
        ...
        content_type: str = kwargs.pop("content_type", _headers.pop("Content-Type", "text/powershell"))
        cls: ClsType[AsyncIterator[bytes]] = kwargs.pop("cls", None)
    ...
    async def begin_replace_content(
        ...
        runbook_content: bytes,
        **kwargs: Any
    ) -> AsyncLROPoller[_models.ReplaceContentFinalResult]:
        ...
        :return: An instance of AsyncLROPoller that returns ReplaceContentFinalResult. The
         ReplaceContentFinalResult is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.automation.models.ReplaceContentFinalResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = kwargs.pop("params", {}) or {}
        ...
        content_type: str = kwargs.pop("content_type", _headers.pop("Content-Type", "text/powershell"))
        cls: ClsType[_models.ReplaceContentFinalResult] = kwargs.pop("cls", None)
        polling: Union[bool, AsyncPollingMethod] = kwargs.pop("polling", True)
        lro_delay = kwargs.pop("polling_interval", self._config.polling_interval)
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
        ...
        def get_long_running_output(pipeline_response):
            ...
            deserialized = _deserialize(_models.ReplaceContentFinalResult, response.text())
            if cls:
                return cls(pipeline_response, deserialized, response_headers)  # type: ignore
            return deserialized
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.ReplaceContentFinalResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ReplaceContentFinalResult](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
