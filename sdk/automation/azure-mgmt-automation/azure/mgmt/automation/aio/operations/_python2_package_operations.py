...
from ...operations._python2_package_operations import (
...
class Python2PackageOperations:
    ...
    async def create_or_update(
        ...
        automation_account_name: str,
        package_name: str,
        parameters: Union[_models.PythonPackageCreateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.Module:
        """Create or Update the python 2 package identified by package name.
        ...
        :type parameters: ~azure.mgmt.automation.models.PythonPackageCreateParameters or IO[bytes]
        :return: Module or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Module
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        automation_account_name: str,
        package_name: str,
        parameters: Union[_models.PythonPackageUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.Module:
        """Update the python 2 package identified by package name.
        ...
        :type parameters: ~azure.mgmt.automation.models.PythonPackageUpdateParameters or IO[bytes]
        :return: Module or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Module
        :raises ~azure.core.exceptions.HttpResponseError:
        """
