...
class JobOperations:
    ...
    async def create(
        ...
        automation_account_name: str,
        job_name: str,
        parameters: Union[_models.JobCreateParameters, IO],
        client_request_id: Optional[str] = None,
        **kwargs: Any
    ) -> _models.Job:
        """Create a job of the runbook.
        ...
        :param job_name: The job name. Required.
        :type job_name: str
        :param parameters: The parameters supplied to the create job operation. Is either a model type
         or a IO type. Required.
        :type parameters: ~azure.mgmt.automation.models.JobCreateParameters or IO
        :param client_request_id: Identifies this specific client request. Default value is None.
        :type client_request_id: str
