...
from ...operations._module_operations import (
...
class ModuleOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("Module", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        automation_account_name: str,
        module_name: str,
        parameters: Union[_models.ModuleCreateOrUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.Module:
        """Create or Update the module identified by module name.
        ...
        :type parameters: ~azure.mgmt.automation.models.ModuleCreateOrUpdateParameters or IO[bytes]
        :return: Module or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Module
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        automation_account_name: str,
        module_name: str,
        parameters: Union[_models.ModuleUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.Module:
        """Update the module identified by module name.
        ...
        :type parameters: ~azure.mgmt.automation.models.ModuleUpdateParameters or IO[bytes]
        :return: Module or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Module
        :raises ~azure.core.exceptions.HttpResponseError:
        """
