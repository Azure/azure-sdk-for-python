...
class ModuleOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param module_name: The name of module. Required.
        :type module_name: str
        :param parameters: The create or update parameters for module. Is either a model type or a IO
         type. Required.
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param module_name: The name of module. Required.
        :type module_name: str
        :param parameters: The update parameters for module. Is either a model type or a IO type.
         Required.
