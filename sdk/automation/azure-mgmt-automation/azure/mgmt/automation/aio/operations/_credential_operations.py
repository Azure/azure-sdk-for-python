...
class CredentialOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("Credential", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        automation_account_name: str,
        credential_name: str,
        parameters: Union[_models.CredentialCreateOrUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.Credential:
        """Create a credential.
        ...
        :type parameters: ~azure.mgmt.automation.models.CredentialCreateOrUpdateParameters or IO[bytes]
        :return: Credential or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Credential
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        automation_account_name: str,
        credential_name: str,
        parameters: Union[_models.CredentialUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.Credential:
        """Update a credential.
        ...
        :type parameters: ~azure.mgmt.automation.models.CredentialUpdateParameters or IO[bytes]
        :return: Credential or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Credential
        :raises ~azure.core.exceptions.HttpResponseError:
        """
