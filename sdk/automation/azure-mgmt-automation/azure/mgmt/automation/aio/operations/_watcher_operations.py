...
from ...operations._watcher_operations import (
...
class WatcherOperations:
    ...
    async def create_or_update(
        ...
        automation_account_name: str,
        watcher_name: str,
        parameters: Union[_models.Watcher, IO],
        **kwargs: Any
    ) -> _models.Watcher:
        """Create the watcher identified by watcher name.
        ...
        :param watcher_name: The watcher name. Required.
        :type watcher_name: str
        :param parameters: The create or update parameters for watcher. Is either a model type or a IO
         type. Required.
        :type parameters: ~azure.mgmt.automation.models.Watcher or IO
    ...
    async def update(
        ...
        automation_account_name: str,
        watcher_name: str,
        parameters: Union[_models.WatcherUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.Watcher:
        """Update the watcher identified by watcher name.
        ...
        :param watcher_name: The watcher name. Required.
        :type watcher_name: str
        :param parameters: The update parameters for watcher. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.automation.models.WatcherUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    stop.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/watchers/{watcherName}/stop"
    }

    @distributed_trace
    def list_by_automation_account(
        self, resource_group_name: str, automation_account_name: str, filter: Optional[str] = None, **kwargs: Any
    ) -> AsyncIterable["_models.Watcher"]:
