...
from ...operations._source_control_sync_job_operations import (
...
class SourceControlSyncJobOperations:
    ...
    async def create(
        ...
        source_control_name: str,
        source_control_sync_job_id: str,
        parameters: Union[_models.SourceControlSyncJobCreateParameters, IO],
        **kwargs: Any
    ) -> _models.SourceControlSyncJob:
        """Creates the sync job for a source control.
    ...
    def list_by_automation_account(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.SourceControlSyncJob"]:
