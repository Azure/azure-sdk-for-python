...
class AgentRegistrationInformationOperations(object):
    ...
    def get(
        ...
        :return: AgentRegistration or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.automation.models.AgentRegistration or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('AgentRegistration', response)
    ...
    def regenerate_key(
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'AgentRegistrationRegenerateKeyParameter')
        ...
        return deserialized
    regenerate_key.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/agentRegistrationInformation/regenerateKey'}
