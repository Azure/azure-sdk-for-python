...
def build_delete_request(
    resource_group_name: str, automation_account_name: str, webhook_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class WebhookOperations:
    ...
    @distributed_trace
    def generate_uri(self, resource_group_name: str, automation_account_name: str, **kwargs: Any) -> str:
    ...
    def create_or_update(
        ...
        automation_account_name: str,
        webhook_name: str,
        parameters: Union[_models.WebhookCreateOrUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.Webhook:
        """Create the webhook identified by webhook name.
        ...
        :type parameters: ~azure.mgmt.automation.models.WebhookCreateOrUpdateParameters or IO[bytes]
        :return: Webhook or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Webhook
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        automation_account_name: str,
        webhook_name: str,
        parameters: Union[_models.WebhookUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.Webhook:
        """Update the webhook identified by webhook name.
        ...
        :type parameters: ~azure.mgmt.automation.models.WebhookUpdateParameters or IO[bytes]
        :return: Webhook or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Webhook
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_automation_account(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.automation.models.Webhook]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
