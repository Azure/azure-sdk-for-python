...
class WebhookOperations:
    ...
    def create_or_update(
        ...
        automation_account_name: str,
        webhook_name: str,
        parameters: Union[_models.WebhookCreateOrUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.Webhook:
        """Create the webhook identified by webhook name.
    ...
    def update(
        ...
        automation_account_name: str,
        webhook_name: str,
        parameters: Union[_models.WebhookUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.Webhook:
        """Update the webhook identified by webhook name.
    ...
    list_by_automation_account.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/webhooks"
    }
