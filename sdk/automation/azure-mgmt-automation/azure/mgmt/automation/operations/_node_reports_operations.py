...
class NodeReportsOperations(object):
    ...
    def list_by_node(
        ...
        :rtype:
         ~azure.mgmt.automation.models.DscNodeReportPaged[~azure.mgmt.automation.models.DscNodeReport]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.DscNodeReportPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: DscNodeReport or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.automation.models.DscNodeReport or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('DscNodeReport', response)
