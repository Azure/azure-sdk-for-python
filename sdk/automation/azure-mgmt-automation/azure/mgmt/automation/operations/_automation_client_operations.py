...
def build_convert_graph_runbook_content_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/convertGraphRunbookContent")  # pylint: disable=line-too-long
...
class AutomationClientOperationsMixin(object):
