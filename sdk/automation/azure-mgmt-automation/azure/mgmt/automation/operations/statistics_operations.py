...
class StatisticsOperations(object):
    ...
    def list_by_automation_account(
        ...
        :rtype:
         ~azure.mgmt.automation.models.StatisticsPaged[~azure.mgmt.automation.models.Statistics]
        :raises:
        ...
        deserialized = models.StatisticsPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.StatisticsPaged(internal_paging, self._deserialize.dependencies, header_dict)
