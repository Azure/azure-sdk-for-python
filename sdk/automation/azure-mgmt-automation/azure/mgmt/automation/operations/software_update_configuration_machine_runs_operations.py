...
class SoftwareUpdateConfigurationMachineRunsOperations(object):
    ...
    def list(
        ...
        deserialized = models.SoftwareUpdateConfigurationMachineRunPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.SoftwareUpdateConfigurationMachineRunPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
