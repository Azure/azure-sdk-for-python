...
class RunbookOperations:
    ...
    def create_or_update(
        ...
        automation_account_name: str,
        runbook_name: str,
        parameters: Union[_models.RunbookCreateOrUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.Runbook:
        """Create the runbook identified by runbook name.
        ...
        :type runbook_name: str
        :param parameters: The create or update parameters for runbook. Provide either content link for
         a published runbook or draft, not both. Is either a model type or a IO type. Required.
        :type parameters: ~azure.mgmt.automation.models.RunbookCreateOrUpdateParameters or IO
    ...
    def update(
        ...
        automation_account_name: str,
        runbook_name: str,
        parameters: Union[_models.RunbookUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.Runbook:
        """Update the runbook identified by runbook name.
        ...
        :param runbook_name: The runbook name. Required.
        :type runbook_name: str
        :param parameters: The update parameters for runbook. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.automation.models.RunbookUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_automation_account(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.automation.models.Runbook]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
