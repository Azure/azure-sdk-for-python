...
class RunbookOperations(object):
    ...
    publish.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/runbooks/{runbookName}/publish'}
    ...
    def list_by_automation_account(
        ...
        if raw:
            header_dict = {}
        deserialized = models.RunbookPaged(internal_paging, self._deserialize.dependencies, header_dict)
