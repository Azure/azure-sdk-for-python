...
class SourceControlOperations:
    ...
    def create_or_update(
        ...
        automation_account_name: str,
        source_control_name: str,
        parameters: Union[_models.SourceControlCreateOrUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.SourceControl:
        """Create a source control.
    ...
    def update(
        ...
        automation_account_name: str,
        source_control_name: str,
        parameters: Union[_models.SourceControlUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.SourceControl:
        """Update a source control.
        ...
        :type parameters: ~azure.mgmt.automation.models.SourceControlUpdateParameters or IO[bytes]
        :return: SourceControl or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.SourceControl
        :raises ~azure.core.exceptions.HttpResponseError:
        """
