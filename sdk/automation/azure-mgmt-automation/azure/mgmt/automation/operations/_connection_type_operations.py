...
class ConnectionTypeOperations:
    ...
    def create_or_update(
        ...
        automation_account_name: str,
        connection_type_name: str,
        parameters: Union[_models.ConnectionTypeCreateOrUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.ConnectionType:
        """Create a connection type.
        ...
        :type parameters: ~azure.mgmt.automation.models.ConnectionTypeCreateOrUpdateParameters or IO
    ...
    def list_by_automation_account(
    ...
    ) -> Iterable["_models.ConnectionType"]:
        ...
        :type automation_account_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ConnectionType or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.automation.models.ConnectionType]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
