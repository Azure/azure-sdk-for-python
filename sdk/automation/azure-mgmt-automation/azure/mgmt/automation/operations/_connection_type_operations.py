...
class ConnectionTypeOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("ConnectionType", pipeline_response.http_response)
    ...
    def create_or_update(
        ...
        automation_account_name: str,
        connection_type_name: str,
        parameters: Union[_models.ConnectionTypeCreateOrUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.ConnectionType:
        """Create a connection type.
    ...
    ) -> ItemPaged["_models.ConnectionType"]:
