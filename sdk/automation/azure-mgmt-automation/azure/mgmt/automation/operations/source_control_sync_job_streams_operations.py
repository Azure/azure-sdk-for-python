...
class SourceControlSyncJobStreamsOperations(object):
    ...
    def list_by_sync_job(
            self, resource_group_name, automation_account_name, source_control_name, source_control_sync_job_id, filter=None, custom_headers=None, raw=False, **operation_config):
        ...
        deserialized = models.SourceControlSyncJobStreamPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.SourceControlSyncJobStreamPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
            self, resource_group_name, automation_account_name, source_control_name, source_control_sync_job_id, stream_id, custom_headers=None, raw=False, **operation_config):
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: SourceControlSyncJobStreamById or ClientRawResponse if
         raw=true
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SourceControlSyncJobStreamById', response)
