...
def build_list_by_automation_account_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/statistics")  # pylint: disable=line-too-long
...
class StatisticsOperations:
    ...
    def list_by_automation_account(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable[_models.StatisticsListResult]:
