...
def build_create_or_update_request(
    resource_group_name: str, automation_account_name: str, variable_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class VariableOperations:
    ...
    def create_or_update(
        ...
        automation_account_name: str,
        variable_name: str,
        parameters: Union[_models.VariableCreateOrUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.Variable:
        """Create a variable.
        ...
        :type parameters: ~azure.mgmt.automation.models.VariableCreateOrUpdateParameters or IO[bytes]
        :return: Variable or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Variable
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        automation_account_name: str,
        variable_name: str,
        parameters: Union[_models.VariableUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.Variable:
        """Update a variable.
        ...
        :type parameters: ~azure.mgmt.automation.models.VariableUpdateParameters or IO[bytes]
        :return: Variable or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Variable
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_automation_account(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.automation.models.Variable]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
