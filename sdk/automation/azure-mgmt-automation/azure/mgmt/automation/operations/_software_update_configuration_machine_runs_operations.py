...
class SoftwareUpdateConfigurationMachineRunsOperations(object):
    ...
    def get_by_id(
        ...
        :return: SoftwareUpdateConfigurationMachineRun or ClientRawResponse if
         raw=true
        :rtype:
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SoftwareUpdateConfigurationMachineRun', response)
    ...
    def list(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: SoftwareUpdateConfigurationMachineRunListResult or
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('SoftwareUpdateConfigurationMachineRunListResult', response)
