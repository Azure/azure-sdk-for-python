...
class AutomationAccountOperations:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.AutomationAccount"]:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.AutomationAccount"]:
    ...
    def list_deleted_runbooks(
        self, resource_group_name: str, automation_account_name: str, **kwargs: Any
    ) -> ItemPaged["_models.DeletedRunbook"]:
