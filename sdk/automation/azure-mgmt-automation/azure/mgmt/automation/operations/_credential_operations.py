...
def build_delete_request(
    resource_group_name: str, automation_account_name: str, credential_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class CredentialOperations:
    ...
    def list_by_automation_account(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.automation.models.Credential]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
