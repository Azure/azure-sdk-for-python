...
def build_create_or_update_request(
    resource_group_name: str, automation_account_name: str, schedule_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class ScheduleOperations:
    ...
    def create_or_update(
        ...
        automation_account_name: str,
        schedule_name: str,
        parameters: Union[_models.ScheduleCreateOrUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> Optional[_models.Schedule]:
        """Create a schedule.
        ...
        :type parameters: ~azure.mgmt.automation.models.ScheduleCreateOrUpdateParameters or IO[bytes]
        :return: Schedule or None or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Schedule or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        automation_account_name: str,
        schedule_name: str,
        parameters: Union[_models.ScheduleUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.Schedule:
        """Update the schedule identified by schedule name.
        ...
        :type parameters: ~azure.mgmt.automation.models.ScheduleUpdateParameters or IO[bytes]
        :return: Schedule or the result of cls(response)
        :rtype: ~azure.mgmt.automation.models.Schedule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_automation_account(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.automation.models.Schedule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
