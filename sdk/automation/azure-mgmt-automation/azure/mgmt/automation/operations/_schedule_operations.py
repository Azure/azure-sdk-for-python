...
class ScheduleOperations(object):
    ...
    def create_or_update(
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'ScheduleCreateOrUpdateParameters')
    ...
    def update(
        ...
        :param schedule_name: The schedule name.
        :type schedule_name: str
        :param parameters: The parameters supplied to the update schedule
         operation.
        :type parameters:
         ~azure.mgmt.automation.models.ScheduleUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'ScheduleUpdateParameters')
    ...
    def list_by_automation_account(
        ...
        :rtype:
         ~azure.mgmt.automation.models.SchedulePaged[~azure.mgmt.automation.models.Schedule]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.automation.models.ErrorResponseException>`
        """
        ...
        return deserialized
    list_by_automation_account.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/schedules'}
