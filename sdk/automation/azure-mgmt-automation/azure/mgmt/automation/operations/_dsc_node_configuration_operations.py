...
class DscNodeConfigurationOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.DscNodeConfiguration].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.DscNodeConfiguration](
    ...
    def list_by_automation_account(
        ...
        inlinecount: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.DscNodeConfiguration"]:
