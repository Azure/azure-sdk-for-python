...
class SqlVirtualMachinesOperations:
    ...
    ) -> Iterable["_models.SqlVirtualMachine"]:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.SqlVirtualMachine"]:
    ...
    @distributed_trace
    def begin_redeploy(self, resource_group_name: str, sql_virtual_machine_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, sql_virtual_machine_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.SqlVirtualMachine"]:
