...
class SqlVirtualMachineGroupsOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SqlVirtualMachineGroup"
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        sql_virtual_machine_group_name,  # type: str
        parameters,  # type: "_models.SqlVirtualMachineGroup"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.SqlVirtualMachineGroup"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SqlVirtualMachineGroup"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.SqlVirtualMachineGroup"]
        ...
        :return: An instance of LROPoller that returns either SqlVirtualMachineGroup or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sqlvirtualmachine.models.SqlVirtualMachineGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        sql_virtual_machine_group_name,  # type: str
        parameters,  # type: "_models.SqlVirtualMachineGroupUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.SqlVirtualMachineGroup"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SqlVirtualMachineGroup"]
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.SqlVirtualMachineGroupListResult"]
        ...
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either SqlVirtualMachineGroupListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sqlvirtualmachine.models.SqlVirtualMachineGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
