...
class AvailabilityGroupListenersOperations(object):
    ...
    def get(
        ...
        availability_group_listener_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.AvailabilityGroupListener"
    ...
    def _create_or_update_initial(
        ...
        sql_virtual_machine_group_name,  # type: str
        availability_group_listener_name,  # type: str
        parameters,  # type: "_models.AvailabilityGroupListener"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.AvailabilityGroupListener"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.AvailabilityGroupListener"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.AvailabilityGroupListener"]
        ...
        :return: An instance of LROPoller that returns either AvailabilityGroupListener or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sqlvirtualmachine.models.AvailabilityGroupListener]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.AvailabilityGroupListenerListResult"]
        ...
        :type sql_virtual_machine_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either AvailabilityGroupListenerListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sqlvirtualmachine.models.AvailabilityGroupListenerListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
