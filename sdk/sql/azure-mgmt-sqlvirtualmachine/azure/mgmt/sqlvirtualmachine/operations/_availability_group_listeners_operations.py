...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/{sqlVirtualMachineGroupName}/availabilityGroupListeners/{availabilityGroupListenerName}')
    path_format_arguments = {
        ...
        "availabilityGroupListenerName": _SERIALIZER.url("availability_group_listener_name", availability_group_listener_name, 'str'),
...
def build_list_by_group_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/{sqlVirtualMachineGroupName}/availabilityGroupListeners')
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "sqlVirtualMachineGroupName": _SERIALIZER.url("sql_virtual_machine_group_name", sql_virtual_machine_group_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
class AvailabilityGroupListenersOperations(object):
    ...
    def list_by_group(
        ...
        sql_virtual_machine_group_name: str,
        **kwargs: Any
    ) -> Iterable["_models.AvailabilityGroupListenerListResult"]:
        ...
        :return: An iterator like instance of either AvailabilityGroupListenerListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.sqlvirtualmachine.models.AvailabilityGroupListenerListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
