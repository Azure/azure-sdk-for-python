...
class AvailabilityGroupListenersOperations(object):
    ...
    def get(
            self, resource_group_name, sql_virtual_machine_group_name, availability_group_listener_name, custom_headers=None, raw=False, **operation_config):
        ...
        path_format_arguments = {
            ...
            'availabilityGroupListenerName': self._serialize.url("availability_group_listener_name", availability_group_listener_name, 'str'),
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('AvailabilityGroupListener', response)
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/{sqlVirtualMachineGroupName}/availabilityGroupListeners/{availabilityGroupListenerName}'}


    def _create_or_update_initial(
            self, resource_group_name, sql_virtual_machine_group_name, availability_group_listener_name, parameters, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'AvailabilityGroupListener')
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/{sqlVirtualMachineGroupName}/availabilityGroupListeners/{availabilityGroupListenerName}'}
    ...
    def delete(
            self, resource_group_name, sql_virtual_machine_group_name, availability_group_listener_name, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/{sqlVirtualMachineGroupName}/availabilityGroupListeners/{availabilityGroupListenerName}'}
    ...
    def list_by_group(
        ...
        :rtype:
         ~azure.mgmt.sqlvirtualmachine.models.AvailabilityGroupListenerPaged[~azure.mgmt.sqlvirtualmachine.models.AvailabilityGroupListener]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.AvailabilityGroupListenerPaged(internal_paging, self._deserialize.dependencies, header_dict)
