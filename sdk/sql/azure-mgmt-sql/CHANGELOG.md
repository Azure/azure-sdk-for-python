...
### Other Changes
  ...
  - Deleted or renamed list wrapper models `OutboundEnvironmentEndpointCollection`, `SecurityEventCollection` and `ManagedInstanceQueryStatistics` that only contained `next_link` and `value`.
