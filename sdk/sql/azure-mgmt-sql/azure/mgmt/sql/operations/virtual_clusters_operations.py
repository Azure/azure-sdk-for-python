...
class VirtualClustersOperations(object):
    ...
    def list(
        ...
        deserialized = models.VirtualClusterPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.VirtualClusterPaged(internal_paging, self._deserialize.dependencies, header_dict)
