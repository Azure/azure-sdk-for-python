...
class ServerBlobAuditingPoliciesOperations(object):
    ...
    def list_by_server(
        ...
        deserialized = models.ServerBlobAuditingPolicyPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ServerBlobAuditingPolicyPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
