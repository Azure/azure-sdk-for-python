...
def build_get_request(
    resource_group_name: str, server_name: str, dns_alias_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ServerDnsAliasesOperations:
    ...
    def list_by_server(
    ...
    ) -> ItemPaged["_models.ServerDnsAlias"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ServerDnsAlias]
    ...
    def get(
        ...
        deserialized = self._deserialize("ServerDnsAlias", pipeline_response.http_response)
    ...
    def begin_create_or_update(
        ...
        if cont_token:
            return LROPoller[_models.ServerDnsAlias].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ServerDnsAlias](
