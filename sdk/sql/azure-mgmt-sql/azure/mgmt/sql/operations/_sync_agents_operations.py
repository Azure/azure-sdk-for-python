...
class SyncAgentsOperations(object):
    ...
    def list_by_server(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SyncAgentPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_linked_databases(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SyncAgentLinkedDatabasePaged(internal_paging, self._deserialize.dependencies, header_dict)
