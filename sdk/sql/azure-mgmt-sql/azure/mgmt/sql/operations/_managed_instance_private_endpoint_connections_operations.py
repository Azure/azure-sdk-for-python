...
class ManagedInstancePrivateEndpointConnectionsOperations:  # pylint: disable=name-too-long
    ...
    def list_by_managed_instance(
    ...
    ) -> ItemPaged["_models.ManagedInstancePrivateEndpointConnection"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ManagedInstancePrivateEndpointConnection]
    ...
    def get(
        ...
        deserialized = self._deserialize("ManagedInstancePrivateEndpointConnection", pipeline_response.http_response)
        ...
        **kwargs: Any
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize(
                "ManagedInstancePrivateEndpointConnection", pipeline_response.http_response
            )
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if cont_token:
            return LROPoller[_models.ManagedInstancePrivateEndpointConnection].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ManagedInstancePrivateEndpointConnection](
