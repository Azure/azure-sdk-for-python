...
class ServersOperations(object):
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        server_name,  # type: str
        parameters,  # type: "_models.ServerUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.Server"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.Server"]]
    ...
    def _import_database_initial(
        ...
        resource_group_name,  # type: str
        server_name,  # type: str
        parameters,  # type: "_models.ImportNewDatabaseDefinition"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.ImportExportOperationResult"]
        ...
        # Construct URL
        url = self._import_database_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'serverName': self._serialize.url("server_name", server_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
    ...
    def begin_import_database(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.ImportExportOperationResult"]
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns either ImportExportOperationResult or the result of cls(response)
    ...
    def check_name_availability(
        self,
        parameters,  # type: "_models.CheckNameAvailabilityRequest"
        **kwargs  # type: Any
    ):
