...
class SyncMembersOperations(object):
    ...
    def create_or_update(
            self, resource_group_name, server_name, database_name, sync_group_name, sync_member_name, parameters, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    def delete(
            self, resource_group_name, server_name, database_name, sync_group_name, sync_member_name, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    def list_by_sync_group(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SyncMemberPaged(internal_paging, self._deserialize.dependencies, header_dict)
