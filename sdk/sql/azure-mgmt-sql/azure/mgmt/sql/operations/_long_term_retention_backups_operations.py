...
class LongTermRetentionBackupsOperations(object):
    ...
    def get_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.LongTermRetentionBackup"
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.LongTermRetentionBackup"]
        error_map = {
    ...
    def list_by_resource_group_database(
        ...
        database_state=None,  # type: Optional[Union[str, "models.LongTermRetentionDatabaseState"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.LongTermRetentionBackupListResult"]
        ...
        :param database_state: Whether to query against just live databases, just deleted databases, or
         all databases.
        :type database_state: str or ~azure.mgmt.sql.models.LongTermRetentionDatabaseState
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.LongTermRetentionBackupListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
