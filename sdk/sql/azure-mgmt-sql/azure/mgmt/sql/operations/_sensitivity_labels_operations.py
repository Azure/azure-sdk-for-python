...
class SensitivityLabelsOperations(object):
    ...
    def update(
            self, resource_group_name, server_name, database_name, operations=None, custom_headers=None, raw=False, **operation_config):
    ...
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/currentSensitivityLabels'}
