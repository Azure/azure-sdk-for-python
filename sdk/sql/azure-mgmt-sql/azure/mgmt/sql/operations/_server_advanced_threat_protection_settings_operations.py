...
class ServerAdvancedThreatProtectionSettingsOperations:
    ...
    def list_by_server(
    ...
    ) -> Iterable["_models.ServerAdvancedThreatProtection"]:
        ...
        :return: An iterator like instance of either ServerAdvancedThreatProtection or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ServerAdvancedThreatProtection]
    ...
    list_by_server.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/advancedThreatProtectionSettings"
    }
    ...
    def get(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.ServerAdvancedThreatProtection] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/advancedThreatProtectionSettings/{advancedThreatProtectionName}"
    }
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.ServerAdvancedThreatProtection]] = kwargs.pop("cls", None)
