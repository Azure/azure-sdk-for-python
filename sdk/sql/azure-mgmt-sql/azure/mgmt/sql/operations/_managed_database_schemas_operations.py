...
class ManagedDatabaseSchemasOperations(object):
    ...
    def list_by_database(
        ...
        return deserialized
    list_by_database.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/schemas'}

    def get(
            self, resource_group_name, managed_instance_name, database_name, schema_name, custom_headers=None, raw=False, **operation_config):
