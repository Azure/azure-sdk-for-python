...
class ServerConnectionPoliciesOperations(object):
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.ServerConnectionPolicy"]
        ...
        :return: An instance of LROPoller that returns either ServerConnectionPolicy or the result of cls(response)
    ...
    def list_by_server(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ServerConnectionPolicyListResult"]
        ...
        :type server_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ServerConnectionPolicyListResult or the result of cls(response)
