...
class BackupShortTermRetentionPoliciesOperations:  # pylint: disable=name-too-long
    ...
    ) -> ItemPaged["_models.BackupShortTermRetentionPolicy"]:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.BackupShortTermRetentionPolicy].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.BackupShortTermRetentionPolicy](
