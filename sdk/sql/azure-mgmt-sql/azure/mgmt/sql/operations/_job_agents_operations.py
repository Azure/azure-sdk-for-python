...
class JobAgentsOperations:
    ...
    def list_by_server(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.JobAgent]
    ...
    @distributed_trace
    def get(self, resource_group_name: str, server_name: str, job_agent_name: str, **kwargs: Any) -> _models.JobAgent:
        """Gets a job agent.
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.JobAgent].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.JobAgent](
