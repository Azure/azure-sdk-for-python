...
def build_list_metrics_request(
    resource_group_name: str, server_name: str, database_name: str, subscription_id: str, *, filter: str, **kwargs: Any
) -> HttpRequest:
...
def build_upgrade_data_warehouse_request(
    resource_group_name: str, server_name: str, database_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_inaccessible_by_server_request(  # pylint: disable=name-too-long
...
class DatabasesOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_metrics(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.Metric]
    ...
    def list_metric_definitions(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.MetricDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.Database or IO[bytes]
        :return: An instance of LROPoller that returns either Database or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sql.models.Database]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The requested database resource state. Is either a DatabaseUpdate type or a
         IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.sql.models.DatabaseUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either Database or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sql.models.Database]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_export(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.ExportDatabaseDefinition or IO[bytes]
        :return: An instance of LROPoller that returns either ImportExportOperationResult or the result
         of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sql.models.ImportExportOperationResult]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_import_method(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.ImportExistingDatabaseDefinition or IO[bytes]
        :return: An instance of LROPoller that returns either ImportExportOperationResult or the result
         of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sql.models.ImportExportOperationResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._import_initial(
                resource_group_name=resource_group_name,
                server_name=server_name,
                database_name=database_name,
                parameters=parameters,
    ...
    def rename(  # pylint: disable=inconsistent-return-statements
        ...
        server_name: str,
        database_name: str,
        parameters: Union[_models.ResourceMoveDefinition, IO[bytes]],
        **kwargs: Any
    ) -> None:
        """Renames a database.
        ...
        :type parameters: ~azure.mgmt.sql.models.ResourceMoveDefinition or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _upgrade_data_warehouse_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, server_name: str, database_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _request = build_upgrade_data_warehouse_request(
            resource_group_name=resource_group_name,
            server_name=server_name,
            database_name=database_name,
            subscription_id=self._config.subscription_id,
    ...
    def begin_upgrade_data_warehouse(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._upgrade_data_warehouse_initial(  # type: ignore
                resource_group_name=resource_group_name,
                server_name=server_name,
                database_name=database_name,
                api_version=api_version,
    ...
    def list_inaccessible_by_server(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_inaccessible_by_server_request(
                    resource_group_name=resource_group_name,
                    server_name=server_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
