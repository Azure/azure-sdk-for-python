...
class DatabasesOperations(object):
    ...
    def _import_method_initial(
        ...
        parameters,  # type: "models.ImportRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.ImportExportResponse"]
    ...
    def begin_import_method(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.ImportExportResponse"]
        ...
        :return: An instance of LROPoller that returns either ImportExportResponse or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sql.models.ImportExportResponse]
    ...
    def _create_import_operation_initial(
        ...
        extension_name,  # type: Union[str, "models.ExtensionName"]
        parameters,  # type: "models.ImportExtensionRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.ImportExportResponse"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.ImportExportResponse"]]
    ...
    def begin_create_import_operation(
        self,
        resource_group_name,  # type: str
        server_name,  # type: str
        database_name,  # type: str
    ...
    def _export_initial(
        ...
        server_name,  # type: str
        database_name,  # type: str
        parameters,  # type: "models.ExportRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.ImportExportResponse"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.ImportExportResponse"]]
    ...
    def list_metric_definitions(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.MetricDefinitionListResult"]
