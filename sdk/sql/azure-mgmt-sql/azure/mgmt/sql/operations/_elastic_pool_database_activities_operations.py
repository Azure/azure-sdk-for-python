...
def build_list_by_elastic_pool_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/elasticPools/{elasticPoolName}/elasticPoolDatabaseActivity")  # pylint: disable=line-too-long
...
class ElasticPoolDatabaseActivitiesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`elastic_pool_database_activities` attribute.
    """
    ...
    def list_by_elastic_pool(
        ...
        elastic_pool_name: str,
        **kwargs: Any
    ) -> Iterable[_models.ElasticPoolDatabaseActivityListResult]:
        ...
        :return: An iterator like instance of either ElasticPoolDatabaseActivityListResult or the
         result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ElasticPoolDatabaseActivityListResult]
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', "2014-04-01"))  # type: str
        cls = kwargs.pop('cls', None)  # type: ClsType[_models.ElasticPoolDatabaseActivityListResult]
