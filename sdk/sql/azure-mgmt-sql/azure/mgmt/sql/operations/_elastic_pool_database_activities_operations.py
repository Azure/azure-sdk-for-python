...
class ElasticPoolDatabaseActivitiesOperations(object):
    ...
    def list_by_elastic_pool(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ElasticPoolDatabaseActivityListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ElasticPoolDatabaseActivityListResult]
