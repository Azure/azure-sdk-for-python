...
class ElasticPoolDatabaseActivitiesOperations:
    ...
    def list_by_elastic_pool(
    ...
    ) -> ItemPaged["_models.ElasticPoolDatabaseActivity"]:
        ...
        :return: An iterator like instance of either ElasticPoolDatabaseActivity or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ElasticPoolDatabaseActivity]
