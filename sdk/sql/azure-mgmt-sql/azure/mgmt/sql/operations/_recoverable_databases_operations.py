...
class RecoverableDatabasesOperations:
    ...
    def list_by_server(
    ...
    ) -> ItemPaged["_models.RecoverableDatabase"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.RecoverableDatabase]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("RecoverableDatabase", pipeline_response.http_response)
