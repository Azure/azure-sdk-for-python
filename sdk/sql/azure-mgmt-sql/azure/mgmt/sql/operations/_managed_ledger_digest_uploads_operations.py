...
class ManagedLedgerDigestUploadsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`managed_ledger_digest_uploads` attribute.
    """
    ...
    def list_by_database(
    ...
    ) -> Iterable["_models.ManagedLedgerDigestUploads"]:
        ...
        :return: An iterator like instance of either ManagedLedgerDigestUploads or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ManagedLedgerDigestUploads]
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ManagedLedgerDigestUploadsListResult", pipeline_response)
    ...
    list_by_database.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/ledgerDigestUploads"
    }
    ...
    def get(
        ...
        ledger_digest_uploads: Union[str, _models.ManagedLedgerDigestUploadsName],
        **kwargs: Any
    ) -> _models.ManagedLedgerDigestUploads:
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ManagedLedgerDigestUploads or the result of cls(response)
        ...
        cls: ClsType[_models.ManagedLedgerDigestUploads] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("ManagedLedgerDigestUploads", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/ledgerDigestUploads/{ledgerDigestUploads}"
    }
    ...
    def _create_or_update_initial(
        ...
        database_name: str,
        ledger_digest_uploads: Union[str, _models.ManagedLedgerDigestUploadsName],
        parameters: Union[_models.ManagedLedgerDigestUploads, IO],
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.ManagedLedgerDigestUploads]] = kwargs.pop("cls", None)
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "ManagedLedgerDigestUploads")
    ...
    def begin_create_or_update(
        ...
        database_name: str,
        ledger_digest_uploads: Union[str, _models.ManagedLedgerDigestUploadsName],
        parameters: _models.ManagedLedgerDigestUploads,
        *,
        ...
        **kwargs: Any
        ...
        :param database_name: The name of the database. Required.
        :type database_name: str
        :param ledger_digest_uploads: The name of the Ledger Digest Upload Configurations. "current"
         Required.
        :type ledger_digest_uploads: str or ~azure.mgmt.sql.models.ManagedLedgerDigestUploadsName
        :param parameters: The Ledger Digest Storage Endpoint. Required.
        :type parameters: ~azure.mgmt.sql.models.ManagedLedgerDigestUploads
        ...
        :return: An instance of LROPoller that returns either ManagedLedgerDigestUploads or the result
         of cls(response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.ManagedLedgerDigestUploads or IO
    ...
    _disable_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/ledgerDigestUploads/{ledgerDigestUploads}/disable"
    }
