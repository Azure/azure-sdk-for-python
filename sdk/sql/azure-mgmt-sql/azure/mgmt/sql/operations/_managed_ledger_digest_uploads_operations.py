...
class ManagedLedgerDigestUploadsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.ManagedLedgerDigestUploads or IO[bytes]
        :return: An instance of LROPoller that returns either ManagedLedgerDigestUploads or the result
         of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sql.models.ManagedLedgerDigestUploads]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.ManagedLedgerDigestUploads].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ManagedLedgerDigestUploads](
