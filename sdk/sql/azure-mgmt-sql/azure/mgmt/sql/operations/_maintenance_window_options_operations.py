...
class MaintenanceWindowOptionsOperations(object):
    ...
    def get(
            self, resource_group_name, server_name, database_name, maintenance_window_options_name, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~azure.mgmt.sql.models.MaintenanceWindowOptions or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/maintenanceWindowOptions/current'}
