...
def build_get_request(
    resource_group_name: str, managed_instance_name: str, certificate_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ServerTrustCertificatesOperations:
    ...
    def list_by_instance(
    ...
    ) -> ItemPaged["_models.ServerTrustCertificate"]:
        ...
        :return: An iterator like instance of either ServerTrustCertificate or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ServerTrustCertificate]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.ServerTrustCertificate].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ServerTrustCertificate](
