...
class ManagedDatabasesOperations(object):
    ...
    def list_by_instance(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.ManagedDatabaseListResult"]
        ...
        :return: An iterator like instance of either ManagedDatabaseListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ManagedDatabaseListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ManagedDatabaseListResult"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ManagedDatabase"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def _create_or_update_initial(
        ...
        managed_instance_name,  # type: str
        database_name,  # type: str
        parameters,  # type: "models.ManagedDatabase"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.ManagedDatabase"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.ManagedDatabase"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.ManagedDatabase"]
        ...
        :return: An instance of LROPoller that returns either ManagedDatabase or the result of cls(response)
    ...
    def _update_initial(
        ...
        managed_instance_name,  # type: str
        database_name,  # type: str
        parameters,  # type: "models.ManagedDatabaseUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.ManagedDatabase"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.ManagedDatabase"]]
    ...
    def list_inaccessible_by_instance(
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_inaccessible_by_instance.metadata['url']  # type: ignore
                path_format_arguments = {
                    'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
                    'managedInstanceName': self._serialize.url("managed_instance_name", managed_instance_name, 'str'),
                    'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
    ...
    def _complete_restore_initial(
        ...
        managed_instance_name,  # type: str
        database_name,  # type: str
        parameters,  # type: "models.CompleteDatabaseRestoreDefinition"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
        ...
        # Construct URL
        url = self._complete_restore_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'managedInstanceName': self._serialize.url("managed_instance_name", managed_instance_name, 'str'),
            'databaseName': self._serialize.url("database_name", database_name, 'str'),
