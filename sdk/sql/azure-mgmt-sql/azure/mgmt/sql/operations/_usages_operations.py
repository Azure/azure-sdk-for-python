...
def build_list_by_instance_pool_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/instancePools/{instancePoolName}/usages')
    ...
    if expand_children is not None:
        query_parameters['expandChildren'] = _SERIALIZER.query("expand_children", expand_children, 'bool')
