...
class ManagedDatabaseSecurityAlertPoliciesOperations(object):
    ...
    def list_by_database(
        ...
        deserialized = models.ManagedDatabaseSecurityAlertPolicyPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ManagedDatabaseSecurityAlertPolicyPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
