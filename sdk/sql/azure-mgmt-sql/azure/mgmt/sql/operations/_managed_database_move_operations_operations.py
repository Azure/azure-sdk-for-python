...
def build_get_request(
    resource_group_name: str, location_name: str, operation_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ManagedDatabaseMoveOperationsOperations:
    ...
    def list_by_location(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.ManagedDatabaseMoveOperationResult"]:
        ...
        :return: An iterator like instance of either ManagedDatabaseMoveOperationResult or the result
         of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ManagedDatabaseMoveOperationResult]
