...
class ServerSecurityAlertPoliciesOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ServerSecurityAlertPolicy"
    ...
    def _create_or_update_initial(
        ...
        server_name,  # type: str
        security_alert_policy_name,  # type: Union[str, "models.SecurityAlertPolicyNameAutoGenerated"]
        parameters,  # type: "models.ServerSecurityAlertPolicy"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.ServerSecurityAlertPolicy"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.ServerSecurityAlertPolicy"]
    ...
    def list_by_server(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.LogicalServerSecurityAlertPolicyListResult"]
        ...
        :type server_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either LogicalServerSecurityAlertPolicyListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.LogicalServerSecurityAlertPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.LogicalServerSecurityAlertPolicyListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
