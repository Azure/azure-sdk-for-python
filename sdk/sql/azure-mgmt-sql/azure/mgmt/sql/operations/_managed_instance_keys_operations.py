...
def build_get_request(
    resource_group_name: str, managed_instance_name: str, key_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ManagedInstanceKeysOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`managed_instance_keys` attribute.
    """
    ...
    def list_by_instance(
        self, resource_group_name: str, managed_instance_name: str, filter: Optional[str] = None, **kwargs: Any
    ) -> ItemPaged["_models.ManagedInstanceKey"]:
        ...
        :param filter: An OData filter expression that filters elements in the collection. Default
         value is None.
        :type filter: str
        :return: An iterator like instance of either ManagedInstanceKey or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ManagedInstanceKey]
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ManagedInstanceKeyListResult", pipeline_response)
    ...
    def get(
        ...
        :type key_name: str
        :return: ManagedInstanceKey or the result of cls(response)
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.ManagedInstanceKey] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("ManagedInstanceKey", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "ManagedInstanceKey")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ManagedInstanceKey or the result of
         cls(response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.ManagedInstanceKey or IO[bytes]
        :return: An instance of LROPoller that returns either ManagedInstanceKey or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sql.models.ManagedInstanceKey]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.ManagedInstanceKey].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ManagedInstanceKey](
