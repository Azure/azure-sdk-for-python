...
class ManagedInstanceKeysOperations:
    ...
    ) -> Iterable["_models.ManagedInstanceKey"]:
    ...
    def get(
        ...
        deserialized = self._deserialize("ManagedInstanceKey", pipeline_response)
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2020-11-01-preview"))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.ManagedInstanceKey]] = kwargs.pop("cls", None)
