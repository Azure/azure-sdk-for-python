...
class ManagedDatabaseAdvancedThreatProtectionSettingsOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`managed_database_advanced_threat_protection_settings` attribute.
    """
    ...
    def list_by_database(
    ...
    ) -> Iterable["_models.ManagedDatabaseAdvancedThreatProtection"]:
        ...
        :return: An iterator like instance of either ManagedDatabaseAdvancedThreatProtection or the
         result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ManagedDatabaseAdvancedThreatProtection]
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", "2022-02-01-preview"))  # type: str
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.ManagedDatabaseAdvancedThreatProtectionListResult]
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ManagedDatabaseAdvancedThreatProtectionListResult", pipeline_response)
    ...
    list_by_database.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/advancedThreatProtectionSettings"}  # type: ignore
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ManagedDatabaseAdvancedThreatProtection or the result of cls(response)
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", "2022-02-01-preview"))  # type: str
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.ManagedDatabaseAdvancedThreatProtection]
        ...
        deserialized = self._deserialize("ManagedDatabaseAdvancedThreatProtection", pipeline_response)
    ...
    get.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/advancedThreatProtectionSettings/{advancedThreatProtectionName}"}  # type: ignore
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.ManagedDatabaseAdvancedThreatProtection
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "ManagedDatabaseAdvancedThreatProtection")
    ...
    create_or_update.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/advancedThreatProtectionSettings/{advancedThreatProtectionName}"}  # type: ignore
