...
class ManagedDatabaseAdvancedThreatProtectionSettingsOperations:  # pylint: disable=name-too-long
    ...
    ) -> ItemPaged["_models.ManagedDatabaseAdvancedThreatProtection"]:
    ...
    def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("ManagedDatabaseAdvancedThreatProtection", pipeline_response.http_response)
    ...
    def create_or_update(
        ...
        database_name: str,
        advanced_threat_protection_name: Union[str, _models.AdvancedThreatProtectionName],
        parameters: Union[_models.ManagedDatabaseAdvancedThreatProtection, IO[bytes]],
        **kwargs: Any
    ) -> _models.ManagedDatabaseAdvancedThreatProtection:
        """Creates or updates a managed database's Advanced Threat Protection state.
        ...
        :type parameters: ~azure.mgmt.sql.models.ManagedDatabaseAdvancedThreatProtection or IO[bytes]
        :return: ManagedDatabaseAdvancedThreatProtection or the result of cls(response)
        :rtype: ~azure.mgmt.sql.models.ManagedDatabaseAdvancedThreatProtection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
