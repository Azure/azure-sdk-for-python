...
class SyncGroupsOperations(object):
    ...
    def list_sync_database_ids(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.SyncDatabaseIdListResult"]
        """Gets a collection of sync database ids.

        :param location_name: The name of the region where the resource is located.
        :type location_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either SyncDatabaseIdListResult or the result of cls(response)
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_sync_database_ids.metadata['url']  # type: ignore
    ...
    def list_hub_schemas(
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_hub_schemas.metadata['url']  # type: ignore
                path_format_arguments = {
                    'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
                    'serverName': self._serialize.url("server_name", server_name, 'str'),
                    'databaseName': self._serialize.url("database_name", database_name, 'str'),
    ...
    def list_logs(
        ...
        start_time,  # type: str
        end_time,  # type: str
        type,  # type: Union[str, "_models.Enum60"]
        continuation_token_parameter=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["_models.SyncGroupLogListResult"]
        ...
        :type type: str or ~azure.mgmt.sql.models.Enum60
        :param continuation_token_parameter: The continuation token for this operation.
        :type continuation_token_parameter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either SyncGroupLogListResult or the result of cls(response)
    ...
    def _create_or_update_initial(
        ...
        database_name,  # type: str
        sync_group_name,  # type: str
        parameters,  # type: "_models.SyncGroup"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.SyncGroup"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.SyncGroup"]
    ...
    def list_by_database(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.SyncGroupListResult"]
