...
class SyncGroupsOperations(object):
    ...
    def list_sync_database_ids(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SyncDatabaseIdPropertiesPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_hub_schemas(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SyncFullSchemaPropertiesPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_logs(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SyncGroupLogPropertiesPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_by_database(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SyncGroupPaged(internal_paging, self._deserialize.dependencies, header_dict)
