...
class DataWarehouseUserActivitiesOperations(object):
    ...
    def list_by_database(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of DataWarehouseUserActivities
        :rtype:
         ~azure.mgmt.sql.models.DataWarehouseUserActivitiesPaged[~azure.mgmt.sql.models.DataWarehouseUserActivities]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.DataWarehouseUserActivitiesPaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list_by_database.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/dataWarehouseUserActivities'}
