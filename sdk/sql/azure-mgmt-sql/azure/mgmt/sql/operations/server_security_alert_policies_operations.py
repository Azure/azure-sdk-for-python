...
class ServerSecurityAlertPoliciesOperations(object):
    ...
    def list_by_server(
        ...
        deserialized = models.ServerSecurityAlertPolicyPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ServerSecurityAlertPolicyPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
