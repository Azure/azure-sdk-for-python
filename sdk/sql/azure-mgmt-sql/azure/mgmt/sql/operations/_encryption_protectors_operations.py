...
class EncryptionProtectorsOperations:
    ...
    def list_by_server(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.EncryptionProtector]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.EncryptionProtector or IO
    ...
    _revalidate_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/encryptionProtector/{encryptionProtectorName}/revalidate"
    }
