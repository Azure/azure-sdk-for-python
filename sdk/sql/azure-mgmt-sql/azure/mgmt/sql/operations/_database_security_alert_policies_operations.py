...
class DatabaseSecurityAlertPoliciesOperations(object):
    ...
    def get(
        ...
        :param database_name: The name of the  database for which the security
    ...
    def list_by_database(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of DatabaseSecurityAlertPolicy
        :rtype:
         ~azure.mgmt.sql.models.DatabaseSecurityAlertPolicyPaged[~azure.mgmt.sql.models.DatabaseSecurityAlertPolicy]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.DatabaseSecurityAlertPolicyPaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list_by_database.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/securityAlertPolicies'}
