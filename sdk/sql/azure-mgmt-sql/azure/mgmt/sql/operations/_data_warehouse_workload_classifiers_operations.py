...
class DataWarehouseWorkloadClassifiersOperations(object):
    """DataWarehouseWorkloadClassifiersOperations operations.
    ...
    def get(
        ...
        :return: DataWarehouseWorkloadClassifier or ClientRawResponse if
         raw=true
        :rtype: ~azure.mgmt.sql.models.DataWarehouseWorkloadClassifier or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('DataWarehouseWorkloadClassifier', response)
    ...
    def _create_or_update_initial(
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'DataWarehouseWorkloadClassifier')
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.sql.models.DataWarehouseWorkloadClassifier
        :param dict custom_headers: headers that will be added to the request
        ...
        :return: An instance of LROPoller that returns
         DataWarehouseWorkloadClassifier or
         ClientRawResponse<DataWarehouseWorkloadClassifier> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.sql.models.DataWarehouseWorkloadClassifier]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.sql.models.DataWarehouseWorkloadClassifier]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_by_workload_group(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of DataWarehouseWorkloadClassifier
        :rtype:
         ~azure.mgmt.sql.models.DataWarehouseWorkloadClassifierPaged[~azure.mgmt.sql.models.DataWarehouseWorkloadClassifier]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.DataWarehouseWorkloadClassifierPaged(internal_paging, self._deserialize.dependencies, header_dict)
