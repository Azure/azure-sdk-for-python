...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "managedInstanceName": _SERIALIZER.url("managed_instance_name", managed_instance_name, "str"),
        "startStopScheduleName": _SERIALIZER.url("start_stop_schedule_name", start_stop_schedule_name, "str"),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class StartStopManagedInstanceSchedulesOperations:  # pylint: disable=name-too-long
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`start_stop_managed_instance_schedules` attribute.
    """
    ...
    ) -> ItemPaged["_models.StartStopManagedInstanceSchedule"]:
    ...
    def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("StartStopManagedInstanceSchedule", pipeline_response.http_response)
    ...
    def create_or_update(
        ...
        managed_instance_name: str,
        start_stop_schedule_name: Union[str, _models.StartStopScheduleName],
        parameters: _models.StartStopManagedInstanceSchedule,
        *,
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.StartStopManagedInstanceSchedule
