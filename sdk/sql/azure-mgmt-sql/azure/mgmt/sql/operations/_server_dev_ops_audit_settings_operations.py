...
class ServerDevOpsAuditSettingsOperations(object):
    ...
    def get(
        ...
        dev_ops_auditing_settings_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ServerDevOpsAuditingSettings"
    ...
    def _create_or_update_initial(
        ...
        server_name,  # type: str
        dev_ops_auditing_settings_name,  # type: str
        parameters,  # type: "_models.ServerDevOpsAuditingSettings"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.ServerDevOpsAuditingSettings"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.ServerDevOpsAuditingSettings"]
        ...
        :return: An instance of LROPoller that returns either ServerDevOpsAuditingSettings or the result of cls(response)
    ...
    def list_by_server(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ServerDevOpsAuditSettingsListResult"]
        ...
        :type server_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ServerDevOpsAuditSettingsListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ServerDevOpsAuditSettingsListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_by_server.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/devOpsAuditingSettings'}  # type: ignore
