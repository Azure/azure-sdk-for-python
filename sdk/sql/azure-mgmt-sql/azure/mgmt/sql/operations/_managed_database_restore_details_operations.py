...
class ManagedDatabaseRestoreDetailsOperations(object):
    ...
    def get(
        ...
        :return: ManagedDatabaseRestoreDetailsResult or ClientRawResponse if
         raw=true
        :rtype: ~azure.mgmt.sql.models.ManagedDatabaseRestoreDetailsResult or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ManagedDatabaseRestoreDetailsResult', response)
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/restoreDetails/{restoreDetailsName}'}
