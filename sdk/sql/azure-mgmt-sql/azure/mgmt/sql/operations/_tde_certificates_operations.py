...
def build_create_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.TdeCertificate] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/tdeCertificates")  # pylint: disable=line-too-long
