...
class ServerAzureADAdministratorsOperations(object):
    ...
    def _disable_azure_ad_only_authentication_initial(
            self, resource_group_name, server_name, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.disable_azure_ad_only_authentication.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'serverName': self._serialize.url("server_name", server_name, 'str')
    ...
    def disable_azure_ad_only_authentication(
            self, resource_group_name, server_name, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        raw_result = self._disable_azure_ad_only_authentication_initial(
            resource_group_name=resource_group_name,
            server_name=server_name,
            custom_headers=custom_headers,
            raw=True,
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    disable_azure_ad_only_authentication.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/disableAzureADOnlyAuthentication'}
