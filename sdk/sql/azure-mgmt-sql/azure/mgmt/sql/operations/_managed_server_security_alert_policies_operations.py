...
class ManagedServerSecurityAlertPoliciesOperations:  # pylint: disable=name-too-long
    ...
    ) -> ItemPaged["_models.ManagedServerSecurityAlertPolicy"]:
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :type security_alert_policy_name: str or
         ~azure.mgmt.sql.models.SecurityAlertPolicyNameAutoGenerated
        ...
        deserialized = self._deserialize("ManagedServerSecurityAlertPolicy", pipeline_response.http_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.ManagedServerSecurityAlertPolicy or IO[bytes]
        :return: An instance of LROPoller that returns either ManagedServerSecurityAlertPolicy or the
         result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sql.models.ManagedServerSecurityAlertPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.ManagedServerSecurityAlertPolicy].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ManagedServerSecurityAlertPolicy](
