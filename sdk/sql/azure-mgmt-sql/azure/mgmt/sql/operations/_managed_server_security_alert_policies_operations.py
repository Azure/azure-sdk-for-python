...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/securityAlertPolicies/{securityAlertPolicyName}")  # pylint: disable=line-too-long
...
def build_create_or_update_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ManagedServerSecurityAlertPolicy] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_list_by_instance_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/securityAlertPolicies")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "managedInstanceName": _SERIALIZER.url("managed_instance_name", managed_instance_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
class ManagedServerSecurityAlertPoliciesOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`managed_server_security_alert_policies` attribute.
    """
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :return: ManagedServerSecurityAlertPolicy, or the result of cls(response)
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', "2020-11-01-preview"))  # type: str
        cls = kwargs.pop('cls', None)  # type: ClsType[_models.ManagedServerSecurityAlertPolicy]
        ...
        deserialized = self._deserialize('ManagedServerSecurityAlertPolicy', pipeline_response)
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional[_models.ManagedServerSecurityAlertPolicy]]

        _json = self._serialize.body(parameters, 'ManagedServerSecurityAlertPolicy')
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.ManagedServerSecurityAlertPolicy
        :keyword api_version: Api Version. Default value is "2020-11-01-preview". Note that overriding
         this default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either ManagedServerSecurityAlertPolicy or the
    ...
    def list_by_instance(
        ...
        managed_instance_name: str,
        **kwargs: Any
    ) -> Iterable[_models.ManagedServerSecurityAlertPolicyListResult]:
        ...
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ManagedServerSecurityAlertPolicyListResult or the
         result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ManagedServerSecurityAlertPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', "2020-11-01-preview"))  # type: str
        cls = kwargs.pop('cls', None)  # type: ClsType[_models.ManagedServerSecurityAlertPolicyListResult]
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ManagedServerSecurityAlertPolicyListResult", pipeline_response)
