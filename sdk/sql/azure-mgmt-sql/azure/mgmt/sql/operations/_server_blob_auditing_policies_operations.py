...
class ServerBlobAuditingPoliciesOperations:
    ...
    def list_by_server(
    ...
    ) -> ItemPaged["_models.ServerBlobAuditingPolicy"]:
        ...
        :return: An iterator like instance of either ServerBlobAuditingPolicy or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ServerBlobAuditingPolicy]
    ...
    @distributed_trace
    def get(self, resource_group_name: str, server_name: str, **kwargs: Any) -> _models.ServerBlobAuditingPolicy:
        ...
        deserialized = self._deserialize("ServerBlobAuditingPolicy", pipeline_response.http_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.ServerBlobAuditingPolicy or IO[bytes]
        :return: An instance of LROPoller that returns either ServerBlobAuditingPolicy or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sql.models.ServerBlobAuditingPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.ServerBlobAuditingPolicy].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ServerBlobAuditingPolicy](
