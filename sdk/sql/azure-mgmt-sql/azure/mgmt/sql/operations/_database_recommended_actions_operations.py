...
class DatabaseRecommendedActionsOperations:
    ...
    def list_by_database_advisor(
    ...
    ) -> List[_models.RecommendedActionAutoGenerated]:
        ...
        :return: list of RecommendedActionAutoGenerated or the result of cls(response)
        :rtype: list[~azure.mgmt.sql.models.RecommendedActionAutoGenerated]
        ...
        cls: ClsType[List[_models.RecommendedActionAutoGenerated]] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("[RecommendedActionAutoGenerated]", pipeline_response.http_response)
    ...
    def get(
        ...
        recommended_action_name: str,
        **kwargs: Any
    ) -> _models.RecommendedActionAutoGenerated:
        ...
        :return: RecommendedActionAutoGenerated or the result of cls(response)
        :rtype: ~azure.mgmt.sql.models.RecommendedActionAutoGenerated
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.RecommendedActionAutoGenerated] = kwargs.pop("cls", None)
    ...
    def update(
        ...
        advisor_name: str,
        recommended_action_name: str,
        parameters: _models.RecommendedActionAutoGenerated,
        *,
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.RecommendedActionAutoGenerated
    ...
    def update(
        ...
        advisor_name: str,
        recommended_action_name: str,
        parameters: Union[_models.RecommendedActionAutoGenerated, IO[bytes]],
        **kwargs: Any
    ) -> _models.RecommendedActionAutoGenerated:
        """Updates a database recommended action.
        ...
        :param parameters: The requested recommended action resource state. Is either a
         RecommendedActionAutoGenerated type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.sql.models.RecommendedActionAutoGenerated or IO[bytes]
        :return: RecommendedActionAutoGenerated or the result of cls(response)
        :rtype: ~azure.mgmt.sql.models.RecommendedActionAutoGenerated
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "RecommendedActionAutoGenerated")
