...
class VirtualClustersOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.VirtualClusterListResult"]
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        virtual_cluster_name,  # type: str
        parameters,  # type: "models.VirtualClusterUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.VirtualCluster"]
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.VirtualCluster"]
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns either VirtualCluster or the result of cls(response)
