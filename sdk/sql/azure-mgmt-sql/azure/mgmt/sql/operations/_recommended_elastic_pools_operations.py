...
class RecommendedElasticPoolsOperations(object):
    ...
    def list_by_server(
        ...
        if raw:
            header_dict = {}
        deserialized = models.RecommendedElasticPoolPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_metrics(
        ...
        if raw:
            header_dict = {}
        deserialized = models.RecommendedElasticPoolMetricPaged(internal_paging, self._deserialize.dependencies, header_dict)
