...
class DatabaseSchemasOperations:
    ...
    def list_by_database(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.DatabaseSchema"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.DatabaseSchema]
    ...
    list_by_database.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/schemas"
    }

    @distributed_trace
    def get(
        self, resource_group_name: str, server_name: str, database_name: str, schema_name: str, **kwargs: Any
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/schemas/{schemaName}"
    }
