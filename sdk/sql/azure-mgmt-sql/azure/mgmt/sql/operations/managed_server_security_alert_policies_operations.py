...
class ManagedServerSecurityAlertPoliciesOperations(object):
    ...
    def list_by_instance(
        ...
        deserialized = models.ManagedServerSecurityAlertPolicyPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ManagedServerSecurityAlertPolicyPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
