...
class ServerOperationsOperations:
    ...
    def list_by_server(
    ...
    ) -> Iterable["_models.ServerOperation"]:
        ...
        :return: An iterator like instance of either ServerOperation or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ServerOperation]
