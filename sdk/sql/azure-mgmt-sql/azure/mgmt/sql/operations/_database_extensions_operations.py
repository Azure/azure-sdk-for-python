...
class DatabaseExtensionsOperations:
    ...
    def list_by_database(
    ...
    ) -> ItemPaged["_models.ImportExportExtensionsOperationResult"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.ImportExportExtensionsOperationResult]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.ImportExportExtensionsOperationResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ImportExportExtensionsOperationResult](
