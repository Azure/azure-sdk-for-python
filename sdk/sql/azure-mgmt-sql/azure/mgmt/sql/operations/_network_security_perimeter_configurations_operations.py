...
def build_get_request(
    resource_group_name: str, server_name: str, nsp_config_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class NetworkSecurityPerimeterConfigurationsOperations:  # pylint: disable=name-too-long
    ...
    def list_by_server(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.sql.models.NetworkSecurityPerimeterConfiguration]
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, server_name: str, nsp_config_name: str, **kwargs: Any
    ...
    def begin_reconcile(
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.sql.models.NetworkSecurityPerimeterConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
