...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "managedInstanceName": _SERIALIZER.url("managed_instance_name", managed_instance_name, "str"),
        "distributedAvailabilityGroupName": _SERIALIZER.url(
            "distributed_availability_group_name", distributed_availability_group_name, "str"
        ),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
def build_failover_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "managedInstanceName": _SERIALIZER.url(
...
class DistributedAvailabilityGroupsOperations:
    ...
    ) -> ItemPaged["_models.DistributedAvailabilityGroup"]:
    ...
    def begin_set_role(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._set_role_initial(
                resource_group_name=resource_group_name,
                managed_instance_name=managed_instance_name,
                distributed_availability_group_name=distributed_availability_group_name,
                parameters=parameters,
