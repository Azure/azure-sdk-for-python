...
class WorkloadClassifiersOperations:
    ...
    def list_by_workload_group(
    ...
    ) -> ItemPaged["_models.WorkloadClassifier"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_workload_group_request(
    ...
    def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("WorkloadClassifier", pipeline_response.http_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.WorkloadClassifier or IO[bytes]
        :return: An instance of LROPoller that returns either WorkloadClassifier or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sql.models.WorkloadClassifier]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.WorkloadClassifier].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.WorkloadClassifier](
