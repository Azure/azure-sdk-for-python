...
class ManagedDatabaseRecommendedSensitivityLabelsOperations(object):
    ...
    def update(
        ...
        """Update recommended sensitivity labels states of a given database using
        an operations batch.
    ...
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/recommendedSensitivityLabels'}
