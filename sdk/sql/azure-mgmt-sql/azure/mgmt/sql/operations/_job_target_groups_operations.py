...
class JobTargetGroupsOperations(object):
    ...
    def list_by_agent(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.JobTargetGroupListResult"]
        ...
        :return: An iterator like instance of either JobTargetGroupListResult or the result of cls(response)
    ...
    def get(
        ...
        server_name,  # type: str
        job_agent_name,  # type: str
        target_group_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.JobTargetGroup"
        """Gets a target group.
    ...
    def create_or_update(
        ...
        job_agent_name,  # type: str
        target_group_name,  # type: str
        parameters,  # type: "_models.JobTargetGroup"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.JobTargetGroup"
