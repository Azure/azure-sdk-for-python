...
class DatabaseBlobAuditingPoliciesOperations(object):
    ...
    def list_by_database(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of DatabaseBlobAuditingPolicy
        :rtype:
         ~azure.mgmt.sql.models.DatabaseBlobAuditingPolicyPaged[~azure.mgmt.sql.models.DatabaseBlobAuditingPolicy]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        deserialized = models.DatabaseBlobAuditingPolicyPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.DatabaseBlobAuditingPolicyPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response

        return deserialized
    list_by_database.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/auditingSettings'}
