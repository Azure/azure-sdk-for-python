...
from ...operations._managed_database_columns_operations import build_get_request, build_list_by_database_request, build_list_by_table_request
T = TypeVar('T')
    ...
    def list_by_database(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DatabaseColumnListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.DatabaseColumnListResult]
