...
class ExtendedDatabaseBlobAuditingPoliciesOperations:  # pylint: disable=name-too-long
    ...
    ) -> AsyncItemPaged["_models.ExtendedDatabaseBlobAuditingPolicy"]:
    ...
    async def get(
        ...
        deserialized = self._deserialize("ExtendedDatabaseBlobAuditingPolicy", pipeline_response.http_response)
