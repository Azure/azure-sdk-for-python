...
class ManagedInstanceDtcsOperations:
    ...
    def list_by_managed_instance(
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.ManagedInstanceDtcListResult]
    ...
    list_by_managed_instance.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/dtc"}  # type: ignore
    ...
    async def get(
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.ManagedInstanceDtc]
    ...
    get.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/dtc/{dtcName}"}  # type: ignore
    ...
    _create_or_update_initial.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/dtc/{dtcName}"}  # type: ignore
