...
from ...operations._server_azure_ad_administrators_operations import (
...
class ServerAzureADAdministratorsOperations:
    ...
    def list_by_server(
    ...
    ) -> AsyncItemPaged["_models.ServerAzureADAdministrator"]:
        ...
        :return: An iterator like instance of either ServerAzureADAdministrator or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ServerAzureADAdministrator]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.ServerAzureADAdministrator].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ServerAzureADAdministrator](
