...
from ...operations._managed_server_security_alert_policies_operations import build_create_or_update_request_initial, build_get_request, build_list_by_instance_request
T = TypeVar('T')
...
class ManagedServerSecurityAlertPoliciesOperations:
    ...
    def list_by_instance(
        ...
        managed_instance_name: str,
        **kwargs: Any
    ) -> AsyncIterable[_models.ManagedServerSecurityAlertPolicyListResult]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedServerSecurityAlertPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
