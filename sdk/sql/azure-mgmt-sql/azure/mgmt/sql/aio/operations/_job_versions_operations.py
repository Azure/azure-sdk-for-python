...
from ...operations._job_versions_operations import build_get_request, build_list_by_job_request
...
class JobVersionsOperations:
    ...
    def list_by_job(
    ...
    ) -> AsyncItemPaged["_models.JobVersion"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.JobVersion]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.JobVersion] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("JobVersion", pipeline_response.http_response)
