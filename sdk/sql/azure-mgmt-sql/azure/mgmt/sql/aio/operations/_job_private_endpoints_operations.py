...
from ...operations._job_private_endpoints_operations import (
...
class JobPrivateEndpointsOperations:
    ...
    def list_by_agent(
    ...
    ) -> AsyncItemPaged["_models.JobPrivateEndpoint"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.JobPrivateEndpoint]
    ...
    async def get(
        ...
        deserialized = self._deserialize("JobPrivateEndpoint", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either JobPrivateEndpoint or the result of
         cls(response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.JobPrivateEndpoint].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.JobPrivateEndpoint](
