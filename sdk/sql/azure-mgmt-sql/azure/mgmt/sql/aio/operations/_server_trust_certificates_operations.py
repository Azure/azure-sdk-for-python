...
from ...operations._server_trust_certificates_operations import (
...
class ServerTrustCertificatesOperations:
    ...
    def list_by_instance(
    ...
    ) -> AsyncItemPaged["_models.ServerTrustCertificate"]:
        """Gets a list of the server trust certificates used to secure communication between SQL Server
        ...
        :return: An iterator like instance of either ServerTrustCertificate or the result of
         cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ServerTrustCertificate]
    ...
    async def get(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.ServerTrustCertificate] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("ServerTrustCertificate", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.ServerTrustCertificate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ServerTrustCertificate or the result
         of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.ServerTrustCertificate]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return AsyncLROPoller[_models.ServerTrustCertificate].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ServerTrustCertificate](
    ...
    async def begin_delete(
        ...
        :param managed_instance_name: The name of the managed instance. Required.
        :type managed_instance_name: str
        :param certificate_name: Name of of the certificate to delete. Required.
        :type certificate_name: str
