...
class ManagedServerDnsAliasesOperations:
    ...
    ) -> AsyncItemPaged["_models.ManagedServerDnsAlias"]:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Is either a ManagedServerDnsAliasCreation type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.sql.models.ManagedServerDnsAliasCreation or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ManagedServerDnsAlias or the result
         of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.ManagedServerDnsAlias]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return AsyncLROPoller[_models.ManagedServerDnsAlias].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ManagedServerDnsAlias](
    ...
    async def begin_acquire(
        ...
        **kwargs: Any
        ...
        :param parameters: Is either a ManagedServerDnsAliasAcquisition type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.sql.models.ManagedServerDnsAliasAcquisition or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ManagedServerDnsAlias or the result
         of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.ManagedServerDnsAlias]
        :raises ~azure.core.exceptions.HttpResponseError:
