...
from ...operations._managed_server_dns_aliases_operations import (
...
class ManagedServerDnsAliasesOperations:
    ...
    def list_by_managed_instance(
    ...
    ) -> AsyncIterable["_models.ManagedServerDnsAlias"]:
        ...
        :return: An iterator like instance of either ManagedServerDnsAlias or the result of
         cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedServerDnsAlias]
    ...
    list_by_managed_instance.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/dnsAliases"
    }
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/dnsAliases/{dnsAliasName}"
    }
    ...
    async def _create_or_update_initial(
        ...
        dns_alias_name: str,
        parameters: Union[_models.ManagedServerDnsAliasCreation, IO],
        **kwargs: Any
        ...
        cls: ClsType[Optional[_models.ManagedServerDnsAlias]] = kwargs.pop("cls", None)
    ...
    async def _acquire_initial(
        ...
        managed_instance_name: str,
        dns_alias_name: str,
        parameters: Union[_models.ManagedServerDnsAliasAcquisition, IO],
        **kwargs: Any
    ) -> Optional[_models.ManagedServerDnsAlias]:
        error_map = {
            401: ClientAuthenticationError,
    ...
    _acquire_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/dnsAliases/{dnsAliasName}/acquire"
    }
