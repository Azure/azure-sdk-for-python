...
class JobAgentsOperations:
    ...
    async def get(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2020-11-01-preview"))
        cls: ClsType[_models.JobAgent] = kwargs.pop("cls", None)
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        cls: ClsType[Optional[_models.JobAgent]] = kwargs.pop("cls", None)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.JobAgent or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either JobAgent or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.JobAgent]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return AsyncLROPoller[_models.JobAgent].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.JobAgent](
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The update to the job agent. Is either a JobAgentUpdate type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.sql.models.JobAgentUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either JobAgent or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.JobAgent]
        :raises ~azure.core.exceptions.HttpResponseError:
