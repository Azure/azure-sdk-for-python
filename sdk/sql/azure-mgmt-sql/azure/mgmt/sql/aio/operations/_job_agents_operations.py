...
from ...operations._job_agents_operations import (
...
class JobAgentsOperations:
    ...
    def list_by_server(
    ...
    ) -> AsyncIterable["_models.JobAgent"]:
        ...
        :return: An iterator like instance of either JobAgent or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.JobAgent]
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.JobAgentListResult]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("JobAgentListResult", pipeline_response)
    ...
    list_by_server.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/jobAgents"}  # type: ignore
    ...
    async def get(
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: JobAgent or the result of cls(response)
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", "2020-11-01-preview"))  # type: str
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.JobAgent]
        ...
        deserialized = self._deserialize("JobAgent", pipeline_response)
    ...
    async def _create_or_update_initial(
        ...
        server_name: str,
        job_agent_name: str,
        parameters: Union[_models.JobAgent, IO],
        **kwargs: Any
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "JobAgent")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either JobAgent or the result of
         cls(response)
    ...
    async def begin_delete(
        ...
        :param server_name: The name of the server. Required.
        :type server_name: str
        :param job_agent_name: The name of the job agent to be deleted. Required.
        :type job_agent_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
    ...
    async def _update_initial(
        ...
        server_name: str,
        job_agent_name: str,
        parameters: Union[_models.JobAgentUpdate, IO],
        **kwargs: Any
    ) -> Optional[_models.JobAgent]:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "JobAgentUpdate")
