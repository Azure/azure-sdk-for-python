...
from ...operations._sql_agent_operations import build_create_or_update_request, build_get_request
...
class SqlAgentOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("SqlAgentConfiguration", pipeline_response.http_response)
