...
from ...operations._long_term_retention_backups_operations import build_copy_by_resource_group_request_initial, build_copy_request_initial, build_delete_by_resource_group_request_initial, build_delete_request_initial, build_get_by_resource_group_request, build_get_request, build_list_by_database_request, build_list_by_location_request, build_list_by_resource_group_database_request, build_list_by_resource_group_location_request, build_list_by_resource_group_server_request, build_list_by_server_request, build_update_by_resource_group_request_initial, build_update_request_initial
T = TypeVar('T')
...
class LongTermRetentionBackupsOperations:
    ...
    async def begin_copy(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._copy_initial(  # type: ignore
                location_name=location_name,
                long_term_retention_server_name=long_term_retention_server_name,
                long_term_retention_database_name=long_term_retention_database_name,
                backup_name=backup_name,
    ...
    def list_by_database(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either LongTermRetentionBackupListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.LongTermRetentionBackupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_copy_by_resource_group(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._copy_by_resource_group_initial(  # type: ignore
                resource_group_name=resource_group_name,
                location_name=location_name,
                long_term_retention_server_name=long_term_retention_server_name,
                long_term_retention_database_name=long_term_retention_database_name,
    ...
    async def begin_update_by_resource_group(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._update_by_resource_group_initial(  # type: ignore
                resource_group_name=resource_group_name,
                location_name=location_name,
                long_term_retention_server_name=long_term_retention_server_name,
                long_term_retention_database_name=long_term_retention_database_name,
