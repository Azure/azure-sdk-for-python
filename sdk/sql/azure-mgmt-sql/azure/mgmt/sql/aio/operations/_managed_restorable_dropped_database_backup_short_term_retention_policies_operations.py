...
from ...operations._managed_restorable_dropped_database_backup_short_term_retention_policies_operations import (
...
class ManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesOperations:  # pylint: disable=name-too-long
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`managed_restorable_dropped_database_backup_short_term_retention_policies` attribute.
    """
    ...
    def list_by_restorable_dropped_database(
        self, resource_group_name: str, managed_instance_name: str, restorable_dropped_database_id: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.ManagedBackupShortTermRetentionPolicy"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedBackupShortTermRetentionPolicy]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("ManagedBackupShortTermRetentionPolicy", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.ManagedBackupShortTermRetentionPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.ManagedBackupShortTermRetentionPolicy].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ManagedBackupShortTermRetentionPolicy](
