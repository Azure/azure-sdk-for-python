...
from ...operations._managed_restorable_dropped_database_backup_short_term_retention_policies_operations import build_create_or_update_request_initial, build_get_request, build_list_by_restorable_dropped_database_request, build_update_request_initial
T = TypeVar('T')
...
class ManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesOperations:
    ...
    def list_by_restorable_dropped_database(
        ...
        **kwargs: Any
        ...
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ManagedBackupShortTermRetentionPolicyListResult or
         the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedBackupShortTermRetentionPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
