...
class ManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesOperations:
    ...
    async def get(
        ...
        policy_name: Union[str, "models.ManagedShortTermRetentionPolicyName"],
        **kwargs
    ) -> "models.ManagedBackupShortTermRetentionPolicy":
        ...
        path_format_arguments = {
            ...
            'restorableDroppedDatabaseId': self._serialize.url("restorable_dropped_database_id", restorable_dropped_database_id, 'str'),
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
    ) -> Optional["models.ManagedBackupShortTermRetentionPolicy"]:
        ...
        body_content = self._serialize.body(parameters, 'ManagedBackupShortTermRetentionPolicy')
    ...
    async def begin_create_or_update(
        ...
        parameters: "models.ManagedBackupShortTermRetentionPolicy",
        **kwargs
    ) -> AsyncLROPoller["models.ManagedBackupShortTermRetentionPolicy"]:
        ...
        :return: An instance of AsyncLROPoller that returns either ManagedBackupShortTermRetentionPolicy or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.ManagedBackupShortTermRetentionPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_restorable_dropped_database(
        ...
        restorable_dropped_database_id: str,
        **kwargs
    ) -> AsyncIterable["models.ManagedBackupShortTermRetentionPolicyListResult"]:
        ...
        :type restorable_dropped_database_id: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ManagedBackupShortTermRetentionPolicyListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedBackupShortTermRetentionPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_by_restorable_dropped_database.metadata['url']  # type: ignore
                path_format_arguments = {
                    'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
                    'managedInstanceName': self._serialize.url("managed_instance_name", managed_instance_name, 'str'),
                    'restorableDroppedDatabaseId': self._serialize.url("restorable_dropped_database_id", restorable_dropped_database_id, 'str'),
