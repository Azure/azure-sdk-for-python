...
class VirtualNetworkRulesOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
    ) -> Optional["models.VirtualNetworkRule"]:
    ...
    async def begin_create_or_update(
        ...
        parameters: "models.VirtualNetworkRule",
        **kwargs
    ) -> AsyncLROPoller["models.VirtualNetworkRule"]:
    ...
    def list_by_server(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.VirtualNetworkRuleListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
