...
class ManagedInstanceLongTermRetentionPoliciesOperations:  # pylint: disable=name-too-long
    ...
    ) -> AsyncItemPaged["_models.ManagedInstanceLongTermRetentionPolicy"]:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("ManagedInstanceLongTermRetentionPolicy", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.ManagedInstanceLongTermRetentionPolicy].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ManagedInstanceLongTermRetentionPolicy](
