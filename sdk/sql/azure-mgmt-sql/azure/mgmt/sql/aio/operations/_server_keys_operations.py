...
from ...operations._server_keys_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_server_request
T = TypeVar('T')
...
class ServerKeysOperations:
    ...
    def list_by_server(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ServerKeyListResult or the result of cls(response)
    ...
    list_by_server.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/keys"}  # type: ignore
