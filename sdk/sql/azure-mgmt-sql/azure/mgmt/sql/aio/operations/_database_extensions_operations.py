...
class DatabaseExtensionsOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        body_content = self._serialize.body(parameters, 'DatabaseExtensions')
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.ImportExportExtensionsOperationResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_database(
        ...
        **kwargs: Any
        ...
        :type database_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ImportExportExtensionsOperationListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ImportExportExtensionsOperationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
