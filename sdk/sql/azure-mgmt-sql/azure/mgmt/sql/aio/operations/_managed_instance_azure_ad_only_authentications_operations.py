...
from ...operations._managed_instance_azure_ad_only_authentications_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_instance_request
T = TypeVar('T')
...
class ManagedInstanceAzureADOnlyAuthenticationsOperations:
    ...
    def list_by_instance(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedInstanceAzureADOnlyAuthListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
