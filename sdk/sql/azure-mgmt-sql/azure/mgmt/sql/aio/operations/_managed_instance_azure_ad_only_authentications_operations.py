...
class ManagedInstanceAzureADOnlyAuthenticationsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.ManagedInstanceAzureADOnlyAuthentication]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_instance(
        ...
        **kwargs: Any
        ...
        :type managed_instance_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ManagedInstanceAzureADOnlyAuthListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedInstanceAzureADOnlyAuthListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
