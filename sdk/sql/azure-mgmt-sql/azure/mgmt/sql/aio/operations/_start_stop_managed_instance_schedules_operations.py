...
from ...operations._start_stop_managed_instance_schedules_operations import (
...
class StartStopManagedInstanceSchedulesOperations:  # pylint: disable=name-too-long
    ...
    def list_by_instance(
    ...
    ) -> AsyncItemPaged["_models.StartStopManagedInstanceSchedule"]:
        ...
        :return: An iterator like instance of either StartStopManagedInstanceSchedule or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.StartStopManagedInstanceSchedule]
