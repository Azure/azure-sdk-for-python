...
class SyncAgentsOperations:
    ...
    ) -> AsyncItemPaged["_models.SyncAgent"]:
    ...
    async def get(
        ...
        deserialized = self._deserialize("SyncAgent", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.SyncAgent].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.SyncAgent](
    ...
    async def generate_key(
        ...
        deserialized = self._deserialize("SyncAgentKeyProperties", pipeline_response.http_response)
    ...
    def list_linked_databases(
        self, resource_group_name: str, server_name: str, sync_agent_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.SyncAgentLinkedDatabase"]:
