...
from ...operations._extended_server_blob_auditing_policies_operations import (
...
class ExtendedServerBlobAuditingPoliciesOperations:  # pylint: disable=name-too-long
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`extended_server_blob_auditing_policies` attribute.
    """
    ...
    def list_by_server(
    ...
    ) -> AsyncItemPaged["_models.ExtendedServerBlobAuditingPolicy"]:
        ...
        :return: An iterator like instance of either ExtendedServerBlobAuditingPolicy or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ExtendedServerBlobAuditingPolicy]
    ...
    async def get(
        ...
        deserialized = self._deserialize("ExtendedServerBlobAuditingPolicy", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.ExtendedServerBlobAuditingPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.ExtendedServerBlobAuditingPolicy].from_continuation_token(
