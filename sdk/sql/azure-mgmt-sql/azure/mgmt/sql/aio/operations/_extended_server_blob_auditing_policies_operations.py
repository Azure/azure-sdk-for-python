...
from ...operations._extended_server_blob_auditing_policies_operations import build_create_or_update_request_initial, build_get_request, build_list_by_server_request
T = TypeVar('T')
...
class ExtendedServerBlobAuditingPoliciesOperations:
    ...
    def list_by_server(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ExtendedServerBlobAuditingPolicyListResult]
