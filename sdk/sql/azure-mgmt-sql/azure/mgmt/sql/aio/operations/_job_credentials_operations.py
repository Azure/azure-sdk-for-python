...
from ...operations._job_credentials_operations import (
...
class JobCredentialsOperations:
    ...
    def list_by_agent(
    ...
    ) -> AsyncItemPaged["_models.JobCredential"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.JobCredential]
    ...
    async def get(
        ...
        deserialized = self._deserialize("JobCredential", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        job_agent_name: str,
        credential_name: str,
        parameters: Union[_models.JobCredential, IO[bytes]],
        **kwargs: Any
    ) -> _models.JobCredential:
        """Creates or updates a job credential.
        ...
        :type parameters: ~azure.mgmt.sql.models.JobCredential or IO[bytes]
        :return: JobCredential or the result of cls(response)
        :rtype: ~azure.mgmt.sql.models.JobCredential
        :raises ~azure.core.exceptions.HttpResponseError:
        """
