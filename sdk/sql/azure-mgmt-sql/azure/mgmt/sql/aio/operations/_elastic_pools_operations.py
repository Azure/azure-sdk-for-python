...
from ...operations._elastic_pools_operations import build_create_or_update_request_initial, build_delete_request_initial, build_failover_request_initial, build_get_request, build_list_by_server_request, build_list_metric_definitions_request, build_list_metrics_request, build_update_request_initial
T = TypeVar('T')
...
class ElasticPoolsOperations:
    ...
    def list_metric_definitions(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either MetricDefinitionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.MetricDefinitionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_by_server(
        ...
        **kwargs: Any
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', "2021-08-01-preview"))  # type: str
