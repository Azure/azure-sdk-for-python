...
from ...operations._workload_groups_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_database_request
T = TypeVar('T')
    ...
    def list_by_database(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either WorkloadGroupListResult or the result of
         cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.WorkloadGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
