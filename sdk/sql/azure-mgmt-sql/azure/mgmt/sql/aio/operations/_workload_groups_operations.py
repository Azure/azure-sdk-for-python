...
from ...operations._workload_groups_operations import (
...
class WorkloadGroupsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`workload_groups` attribute.
    """
    ...
    async def get(
        ...
        cls: ClsType[_models.WorkloadGroup] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/workloadGroups/{workloadGroupName}"
    }
    ...
    async def _create_or_update_initial(
        ...
        parameters: Union[_models.WorkloadGroup, IO],
        **kwargs: Any
        ...
        cls: ClsType[Optional[_models.WorkloadGroup]] = kwargs.pop("cls", None)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either WorkloadGroup or the result of
         cls(response)
    ...
    async def begin_delete(
        ...
        :param database_name: The name of the database. Required.
        :type database_name: str
        :param workload_group_name: The name of the workload group to delete. Required.
        :type workload_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
    ...
    def list_by_database(
    ...
    ) -> AsyncIterable["_models.WorkloadGroup"]:
        ...
        :type database_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either WorkloadGroup or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.WorkloadGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    list_by_database.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/workloadGroups"
    }
