...
class WorkloadGroupsOperations:
    ...
    async def begin_create_or_update(
        ...
        parameters: "models.WorkloadGroup",
        **kwargs
    ) -> AsyncLROPoller["models.WorkloadGroup"]:
    ...
    def list_by_database(
        ...
        database_name: str,
        **kwargs
    ) -> AsyncIterable["models.WorkloadGroupListResult"]:
        ...
        :type database_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either WorkloadGroupListResult or the result of cls(response)
