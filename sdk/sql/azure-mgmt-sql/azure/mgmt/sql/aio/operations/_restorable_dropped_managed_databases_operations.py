...
from ...operations._restorable_dropped_managed_databases_operations import (
    build_get_request,
...
class RestorableDroppedManagedDatabasesOperations:
    ...
    def list_by_instance(
    ...
    ) -> AsyncIterable["_models.RestorableDroppedManagedDatabase"]:
        ...
        :return: An iterator like instance of either RestorableDroppedManagedDatabase or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.RestorableDroppedManagedDatabase]
    ...
    list_by_instance.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/restorableDroppedDatabases"
    }
    ...
    async def get(
        ...
        cls: ClsType[_models.RestorableDroppedManagedDatabase] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/restorableDroppedDatabases/{restorableDroppedDatabaseId}"
    }
