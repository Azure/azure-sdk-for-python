...
class RestorableDroppedManagedDatabasesOperations:  # pylint: disable=name-too-long
    ...
    ) -> AsyncItemPaged["_models.RestorableDroppedManagedDatabase"]:
    ...
    async def get(
        ...
        deserialized = self._deserialize("RestorableDroppedManagedDatabase", pipeline_response.http_response)
