...
from ...operations._server_advanced_threat_protection_settings_operations import build_create_or_update_request_initial, build_get_request, build_list_by_server_request
T = TypeVar('T')
...
class ServerAdvancedThreatProtectionSettingsOperations:
    ...
    def list_by_server(
        ...
        server_name: str,
        **kwargs: Any
    ) -> AsyncIterable[_models.LogicalServerAdvancedThreatProtectionListResult]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.LogicalServerAdvancedThreatProtectionListResult]
