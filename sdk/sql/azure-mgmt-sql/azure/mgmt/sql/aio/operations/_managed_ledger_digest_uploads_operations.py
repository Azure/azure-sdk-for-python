...
from ...operations._managed_ledger_digest_uploads_operations import (
...
class ManagedLedgerDigestUploadsOperations:
    ...
    def list_by_database(
    ...
    ) -> AsyncItemPaged["_models.ManagedLedgerDigestUploads"]:
        ...
        :return: An iterator like instance of either ManagedLedgerDigestUploads or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedLedgerDigestUploads]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ManagedLedgerDigestUploads or the
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.ManagedLedgerDigestUploads].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ManagedLedgerDigestUploads](
