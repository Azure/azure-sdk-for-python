...
class ServerConnectionPoliciesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ServerConnectionPolicy or the result of cls(response)
    ...
    def list_by_server(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ServerConnectionPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
