...
from ...operations._server_connection_policies_operations import build_create_or_update_request_initial, build_get_request, build_list_by_server_request
T = TypeVar('T')
...
class ServerConnectionPoliciesOperations:
    ...
    def list_by_server(
        ...
        server_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.ServerConnectionPolicyListResult"]:
        ...
        :return: An iterator like instance of either ServerConnectionPolicyListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ServerConnectionPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
