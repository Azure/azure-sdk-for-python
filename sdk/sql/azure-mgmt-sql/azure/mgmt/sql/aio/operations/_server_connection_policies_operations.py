...
from ...operations._server_connection_policies_operations import (
...
class ServerConnectionPoliciesOperations:
    ...
    def list_by_server(
    ...
    ) -> AsyncItemPaged["_models.ServerConnectionPolicy"]:
        ...
        :return: An iterator like instance of either ServerConnectionPolicy or the result of
         cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ServerConnectionPolicy]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ServerConnectionPolicy or the result
         of cls(response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.ServerConnectionPolicy].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ServerConnectionPolicy](
