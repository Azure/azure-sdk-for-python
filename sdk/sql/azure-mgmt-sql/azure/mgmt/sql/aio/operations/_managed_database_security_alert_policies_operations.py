...
class ManagedDatabaseSecurityAlertPoliciesOperations:
    ...
    async def get(
        ...
        **kwargs
    ) -> "models.ManagedDatabaseSecurityAlertPolicy":
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        body_content = self._serialize.body(parameters, 'ManagedDatabaseSecurityAlertPolicy')
    ...
    def list_by_database(
        ...
        database_name: str,
        **kwargs
    ) -> AsyncIterable["models.ManagedDatabaseSecurityAlertPolicyListResult"]:
        ...
        :type database_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ManagedDatabaseSecurityAlertPolicyListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedDatabaseSecurityAlertPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
