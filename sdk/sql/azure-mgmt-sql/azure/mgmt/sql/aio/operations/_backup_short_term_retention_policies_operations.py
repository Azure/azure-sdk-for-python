...
class BackupShortTermRetentionPoliciesOperations:
    ...
    async def get(
        ...
        **kwargs
    ) -> "models.BackupShortTermRetentionPolicy":
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.BackupShortTermRetentionPolicy"]
        error_map = {
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
    ) -> Optional["models.BackupShortTermRetentionPolicy"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.BackupShortTermRetentionPolicy"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def list_by_database(
        ...
        database_name: str,
        **kwargs
    ) -> AsyncIterable["models.BackupShortTermRetentionPolicyListResult"]:
        """Gets a database's short term retention policy.
        ...
        :type database_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either BackupShortTermRetentionPolicyListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.BackupShortTermRetentionPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.BackupShortTermRetentionPolicyListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
