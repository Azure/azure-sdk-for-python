...
from ...operations._encryption_protectors_operations import build_create_or_update_request_initial, build_get_request, build_list_by_server_request, build_revalidate_request_initial
T = TypeVar('T')
...
class EncryptionProtectorsOperations:
    ...
    def list_by_server(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either EncryptionProtectorListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.EncryptionProtectorListResult]
    ...
    @distributed_trace_async
    async def begin_revalidate(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        server_name: str,
        encryption_protector_name: Union[str, "_models.EncryptionProtectorName"],
