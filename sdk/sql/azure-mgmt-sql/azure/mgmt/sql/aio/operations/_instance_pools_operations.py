...
class InstancePoolsOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        body_content = self._serialize.body(parameters, 'InstancePool')
    ...
    async def _update_initial(
        ...
        **kwargs
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'InstancePoolUpdate')
        body_content_kwargs['content'] = body_content
    ...
    def list_by_resource_group(
        ...
        **kwargs
        ...
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either InstancePoolListResult or the result of cls(response)
