...
from ...operations._ipv6_firewall_rules_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_server_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class IPv6FirewallRulesOperations:
    """IPv6FirewallRulesOperations async operations.
    ...
    def list_by_server(
        ...
        server_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.IPv6FirewallRuleListResult"]:
        ...
        :return: An iterator like instance of either IPv6FirewallRuleListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.IPv6FirewallRuleListResult]
