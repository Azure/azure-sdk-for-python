...
class FailoverGroupsOperations:
    ...
    ) -> AsyncItemPaged["_models.FailoverGroup"]:
    ...
    async def get(
        ...
        deserialized = self._deserialize("FailoverGroup", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The failover group parameters. Is either a FailoverGroup type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.sql.models.FailoverGroup or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either FailoverGroup or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.FailoverGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return AsyncLROPoller[_models.FailoverGroup].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.FailoverGroup](
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.FailoverGroupUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either FailoverGroup or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.FailoverGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _try_planned_before_forced_failover_initial(  # pylint: disable=name-too-long
        ...
        _request = build_try_planned_before_forced_failover_request(
            resource_group_name=resource_group_name,
            server_name=server_name,
            failover_group_name=failover_group_name,
            subscription_id=self._config.subscription_id,
