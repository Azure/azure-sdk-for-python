...
from ...operations._failover_groups_operations import build_create_or_update_request_initial, build_delete_request_initial, build_failover_request_initial, build_force_failover_allow_data_loss_request_initial, build_get_request, build_list_by_server_request, build_update_request_initial
T = TypeVar('T')
...
class FailoverGroupsOperations:
    ...
    async def _force_failover_allow_data_loss_initial(
        ...
        **kwargs: Any
        ...
        request = build_force_failover_allow_data_loss_request_initial(
            resource_group_name=resource_group_name,
            server_name=server_name,
            failover_group_name=failover_group_name,
            subscription_id=self._config.subscription_id,
