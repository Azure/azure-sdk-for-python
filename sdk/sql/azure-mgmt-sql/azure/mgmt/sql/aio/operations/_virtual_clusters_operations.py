...
class VirtualClustersOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.VirtualCluster"]:
    ...
    ) -> AsyncItemPaged["_models.VirtualCluster"]:
    ...
    async def _create_or_update_initial(
        ...
        parameters: Union[_models.VirtualCluster, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "VirtualCluster")
    ...
    async def begin_create_or_update(
        ...
        resource_group_name: str,
        virtual_cluster_name: str,
        parameters: _models.VirtualCluster,
        *,
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.VirtualCluster
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.sql.models.VirtualCluster or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either VirtualCluster or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.VirtualCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return AsyncLROPoller[_models.VirtualCluster].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.VirtualCluster](
    ...
    async def begin_update_dns_servers(
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.UpdateVirtualClusterDnsServersOperation].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.UpdateVirtualClusterDnsServersOperation](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
