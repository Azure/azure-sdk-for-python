...
class ServiceObjectivesOperations:
    ...
    def list_by_server(
        ...
        server_name: str,
        **kwargs
    ) -> AsyncIterable["models.ServiceObjectiveListResult"]:
        ...
        :type server_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ServiceObjectiveListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ServiceObjectiveListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
