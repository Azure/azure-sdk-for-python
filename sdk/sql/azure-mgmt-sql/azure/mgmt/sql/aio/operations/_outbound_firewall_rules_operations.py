...
class OutboundFirewallRulesOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        path_format_arguments = {
            ...
            'outboundRuleFqdn': self._serialize.url("outbound_rule_fqdn", outbound_rule_fqdn, 'str'),
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        body_content = self._serialize.body(parameters, 'OutboundFirewallRule')
    ...
    def list_by_server(
        ...
        **kwargs: Any
        ...
        :type server_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either OutboundFirewallRuleListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.OutboundFirewallRuleListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
