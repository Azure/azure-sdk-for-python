...
from ...operations._outbound_firewall_rules_operations import (
...
class OutboundFirewallRulesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`outbound_firewall_rules` attribute.
    """
    ...
    async def get(
        ...
        :return: OutboundFirewallRule or the result of cls(response)
        ...
        cls: ClsType[_models.OutboundFirewallRule] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("OutboundFirewallRule", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/outboundFirewallRules/{outboundRuleFqdn}"
    }
    ...
    async def _create_or_update_initial(
        ...
        parameters: Union[_models.OutboundFirewallRule, IO],
        **kwargs: Any
        ...
        cls: ClsType[Optional[_models.OutboundFirewallRule]] = kwargs.pop("cls", None)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either OutboundFirewallRule or the result
         of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.OutboundFirewallRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_server(
    ...
    ) -> AsyncIterable["_models.OutboundFirewallRule"]:
        ...
        :type server_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either OutboundFirewallRule or the result of
         cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.OutboundFirewallRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("OutboundFirewallRuleListResult", pipeline_response)
    ...
    list_by_server.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/outboundFirewallRules"
    }
