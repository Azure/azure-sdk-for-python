...
from ...operations._outbound_firewall_rules_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_server_request
T = TypeVar('T')
...
class OutboundFirewallRulesOperations:
    ...
    def list_by_server(
        ...
        **kwargs: Any
        ...
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either OutboundFirewallRuleListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.OutboundFirewallRuleListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', "2021-02-01-preview"))  # type: str
        cls = kwargs.pop('cls', None)  # type: ClsType[_models.OutboundFirewallRuleListResult]
    ...
    list_by_server.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/outboundFirewallRules"}  # type: ignore
