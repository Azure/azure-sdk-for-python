...
from ...operations._server_azure_ad_only_authentications_operations import (
...
class ServerAzureADOnlyAuthenticationsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.ServerAzureADOnlyAuthentication] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/azureADOnlyAuthentications/{authenticationName}"
    }
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        cls: ClsType[Optional[_models.ServerAzureADOnlyAuthentication]] = kwargs.pop("cls", None)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type authentication_name: str or ~azure.mgmt.sql.models.AuthenticationName
        :param parameters: The required parameters for creating or updating an Active Directory only
         authentication property. Is either a ServerAzureADOnlyAuthentication type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.sql.models.ServerAzureADOnlyAuthentication or IO
    ...
    def list_by_server(
    ...
    ) -> AsyncIterable["_models.ServerAzureADOnlyAuthentication"]:
        ...
        :type server_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ServerAzureADOnlyAuthentication or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ServerAzureADOnlyAuthentication]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    list_by_server.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/azureADOnlyAuthentications"
    }
