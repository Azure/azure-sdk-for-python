...
class ServerAzureADOnlyAuthenticationsOperations:  # pylint: disable=name-too-long
    ...
    ) -> AsyncItemPaged["_models.ServerAzureADOnlyAuthentication"]:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("ServerAzureADOnlyAuthentication", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The required parameters for creating or updating an Active Directory only
         ...
         Required.
        :type parameters: ~azure.mgmt.sql.models.ServerAzureADOnlyAuthentication or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ServerAzureADOnlyAuthentication or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.ServerAzureADOnlyAuthentication]
        ...
        if cont_token:
            return AsyncLROPoller[_models.ServerAzureADOnlyAuthentication].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ServerAzureADOnlyAuthentication](
