...
from ...operations._ledger_digest_uploads_operations import build_create_or_update_request_initial, build_disable_request_initial, build_get_request, build_list_by_database_request
T = TypeVar('T')
    ...
    def list_by_database(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either LedgerDigestUploadsListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.LedgerDigestUploadsListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
