...
class LedgerDigestUploadsOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        body_content = self._serialize.body(parameters, 'LedgerDigestUploads')
    ...
    def list_by_database(
        ...
        **kwargs: Any
        ...
        :type database_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either LedgerDigestUploadsListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.LedgerDigestUploadsListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
