...
class RestorableDroppedDatabasesOperations:
    ...
    def list_by_server(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either RestorableDroppedDatabaseListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.RestorableDroppedDatabaseListResult]
