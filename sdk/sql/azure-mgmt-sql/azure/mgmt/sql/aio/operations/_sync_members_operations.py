...
class SyncMembersOperations:
    ...
    ) -> AsyncItemPaged["_models.SyncMember"]:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("SyncMember", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.SyncMember].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.SyncMember](
    ...
    async def _refresh_member_schema_initial(
        self,
        resource_group_name: str,
        server_name: str,
        database_name: str,
    ...
    def list_member_schemas(
        ...
        sync_member_name: str,
        **kwargs: Any
    ) -> AsyncItemPaged["_models.SyncFullSchemaProperties"]:
