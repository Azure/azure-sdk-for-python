...
from ...operations._sync_members_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_sync_group_request, build_list_member_schemas_request, build_refresh_member_schema_request_initial, build_update_request_initial
T = TypeVar('T')
...
class SyncMembersOperations:
    ...
    def list_by_sync_group(
        ...
        **kwargs: Any
        ...
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either SyncMemberListResult or the result of
         cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.SyncMemberListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def _refresh_member_schema_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_refresh_member_schema_request_initial(
            resource_group_name=resource_group_name,
            server_name=server_name,
            database_name=database_name,
            sync_group_name=sync_group_name,
    ...
    @distributed_trace_async
    async def begin_refresh_member_schema(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        server_name: str,
        database_name: str,
