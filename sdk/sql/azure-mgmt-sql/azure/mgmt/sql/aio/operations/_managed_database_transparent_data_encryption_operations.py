...
from ...operations._managed_database_transparent_data_encryption_operations import (
...
class ManagedDatabaseTransparentDataEncryptionOperations:  # pylint: disable=name-too-long
    ...
    def list_by_database(
    ...
    ) -> AsyncItemPaged["_models.ManagedTransparentDataEncryption"]:
        ...
        :return: An iterator like instance of either ManagedTransparentDataEncryption or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedTransparentDataEncryption]
