...
from ...operations._managed_database_transparent_data_encryption_operations import build_create_or_update_request, build_get_request, build_list_by_database_request
T = TypeVar('T')
...
class ManagedDatabaseTransparentDataEncryptionOperations:
    ...
    def list_by_database(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedTransparentDataEncryptionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
