...
class ServerTrustGroupsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        path_format_arguments = {
            ...
            'serverTrustGroupName': self._serialize.url("server_trust_group_name", server_trust_group_name, 'str'),
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        body_content = self._serialize.body(parameters, 'ServerTrustGroup')
    ...
    def list_by_location(
        ...
        **kwargs: Any
        ...
        :type location_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ServerTrustGroupListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ServerTrustGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
