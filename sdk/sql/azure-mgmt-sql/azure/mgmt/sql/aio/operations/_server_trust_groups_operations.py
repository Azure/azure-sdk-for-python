...
from ...operations._server_trust_groups_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_instance_request, build_list_by_location_request
T = TypeVar('T')
...
class ServerTrustGroupsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :param server_trust_group_name: The name of the server trust group.
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType[_models.ServerTrustGroup]
    ...
    def list_by_location(
        ...
        **kwargs: Any
        ...
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ServerTrustGroupListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ServerTrustGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', "2020-11-01-preview"))  # type: str
        cls = kwargs.pop('cls', None)  # type: ClsType[_models.ServerTrustGroupListResult]
    ...
    list_by_instance.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/serverTrustGroups"}  # type: ignore
