...
from ...operations._transparent_data_encryptions_operations import (
...
class TransparentDataEncryptionsOperations:
    ...
    ) -> AsyncItemPaged["_models.LogicalDatabaseTransparentDataEncryption"]:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.LogicalDatabaseTransparentDataEncryption]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.LogicalDatabaseTransparentDataEncryption].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.LogicalDatabaseTransparentDataEncryption](
