...
class ManagedInstanceOperationsOperations:
    ...
    def list_by_managed_instance(
        ...
        managed_instance_name: str,
        **kwargs
    ) -> AsyncIterable["models.ManagedInstanceOperationListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedInstanceOperationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get(
        ...
        operation_id: str,
        **kwargs
    ) -> "models.ManagedInstanceOperation":
