...
from ...operations._managed_instance_operations_operations import (
...
class ManagedInstanceOperationsOperations:
    ...
    def list_by_managed_instance(
    ...
    ) -> AsyncItemPaged["_models.ManagedInstanceOperation"]:
        ...
        :return: An iterator like instance of either ManagedInstanceOperation or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ManagedInstanceOperation]
    ...
    async def get(
        ...
        deserialized = self._deserialize("ManagedInstanceOperation", pipeline_response.http_response)
