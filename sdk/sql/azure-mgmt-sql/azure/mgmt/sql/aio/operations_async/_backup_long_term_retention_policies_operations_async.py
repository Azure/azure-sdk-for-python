...
class BackupLongTermRetentionPoliciesOperations:
    """BackupLongTermRetentionPoliciesOperations async operations.
    ...
    async def get(
        ...
        server_name: str,
        database_name: str,
        policy_name: Union[str, "models.LongTermRetentionPolicyName"],
        **kwargs
    ) -> "models.BackupLongTermRetentionPolicy":
        ...
        :return: BackupLongTermRetentionPolicy, or the result of cls(response)
        :rtype: ~azure.mgmt.sql.models.BackupLongTermRetentionPolicy
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.BackupLongTermRetentionPolicy"]
        ...
        deserialized = self._deserialize('BackupLongTermRetentionPolicy', pipeline_response)
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
    ) -> Optional["models.BackupLongTermRetentionPolicy"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.BackupLongTermRetentionPolicy"]]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2017-03-01-preview"
    ...
    async def begin_create_or_update(
        ...
        parameters: "models.BackupLongTermRetentionPolicy",
        **kwargs
    ) -> AsyncLROPoller["models.BackupLongTermRetentionPolicy"]:
        ...
        :return: An instance of AsyncLROPoller that returns either BackupLongTermRetentionPolicy or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sql.models.BackupLongTermRetentionPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
