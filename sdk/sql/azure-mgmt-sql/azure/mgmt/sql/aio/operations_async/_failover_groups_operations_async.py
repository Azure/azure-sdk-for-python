...
class FailoverGroupsOperations:
    ...
    async def get(
        ...
        **kwargs
        ...
        :return: FailoverGroup, or the result of cls(response)
        :rtype: ~azure.mgmt.sql.models.FailoverGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FailoverGroup"]
        ...
        deserialized = self._deserialize('FailoverGroup', pipeline_response)
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
    ) -> Optional["models.FailoverGroup"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.FailoverGroup"]]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2015-05-01-preview"
    ...
    async def begin_create_or_update(
        ...
        parameters: "models.FailoverGroup",
        **kwargs
    ) -> AsyncLROPoller["models.FailoverGroup"]:
    ...
    async def _update_initial(
        ...
        **kwargs
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'FailoverGroupUpdate')
        body_content_kwargs['content'] = body_content
    ...
    def list_by_server(
        ...
        server_name: str,
        **kwargs
    ) -> AsyncIterable["models.FailoverGroupListResult"]:
        ...
        :type server_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either FailoverGroupListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.FailoverGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FailoverGroupListResult"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2015-05-01-preview"
    ...
    list_by_server.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/failoverGroups'}  # type: ignore
    ...
    async def _force_failover_allow_data_loss_initial(
        ...
        **kwargs
        ...
        # Construct URL
        url = self._force_failover_allow_data_loss_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'serverName': self._serialize.url("server_name", server_name, 'str'),
            'failoverGroupName': self._serialize.url("failover_group_name", failover_group_name, 'str'),
        ...
        return deserialized
    _force_failover_allow_data_loss_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/failoverGroups/{failoverGroupName}/forceFailoverAllowDataLoss'}  # type: ignore
    ...
    async def begin_force_failover_allow_data_loss(
        ...
        **kwargs
        ...
        if cont_token:
            ...
            return AsyncLROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_force_failover_allow_data_loss.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/failoverGroups/{failoverGroupName}/forceFailoverAllowDataLoss'}  # type: ignore
