...
class LongTermRetentionBackupsOperations:
    ...
    async def get_by_resource_group(
        ...
        backup_name: str,
        **kwargs
    ) -> "models.LongTermRetentionBackup":
    ...
    def list_by_resource_group_database(
        ...
        database_state: Optional[Union[str, "models.LongTermRetentionDatabaseState"]] = None,
        **kwargs
    ) -> AsyncIterable["models.LongTermRetentionBackupListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.LongTermRetentionBackupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
