...
class ElasticPoolActivitiesOperations:
    ...
    def list_by_elastic_pool(
        ...
        **kwargs
    ) -> AsyncIterable["models.ElasticPoolActivityListResult"]:
        ...
        :return: An iterator like instance of either ElasticPoolActivityListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sql.models.ElasticPoolActivityListResult]
