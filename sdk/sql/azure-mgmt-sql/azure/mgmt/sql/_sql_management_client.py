...
class SqlManagementClient(SDKClient):
    ...
    :ivar database_advisors: DatabaseAdvisors operations
    ...
    :ivar database_columns: DatabaseColumns operations
    ...
    :vartype database_recommended_actions: azure.mgmt.sql.operations.DatabaseRecommendedActionsOperations
    :ivar database_schemas: DatabaseSchemas operations
    :vartype database_schemas: azure.mgmt.sql.operations.DatabaseSchemasOperations
    :ivar database_security_alert_policies: DatabaseSecurityAlertPolicies operations
    :vartype database_security_alert_policies: azure.mgmt.sql.operations.DatabaseSecurityAlertPoliciesOperations
    :ivar database_tables: DatabaseTables operations
    ...
    :ivar deleted_servers: DeletedServers operations
    ...
    :ivar maintenance_window_options: MaintenanceWindowOptions operations
    :vartype maintenance_window_options: azure.mgmt.sql.operations.MaintenanceWindowOptionsOperations
    ...
    :ivar managed_database_columns: ManagedDatabaseColumns operations
    :vartype managed_database_columns: azure.mgmt.sql.operations.ManagedDatabaseColumnsOperations
    :ivar managed_database_queries: ManagedDatabaseQueries operations
    ...
    :ivar managed_database_schemas: ManagedDatabaseSchemas operations
    ...
    :ivar managed_database_security_events: ManagedDatabaseSecurityEvents operations
    :vartype managed_database_security_events: azure.mgmt.sql.operations.ManagedDatabaseSecurityEventsOperations
    ...
    :ivar managed_database_recommended_sensitivity_labels: ManagedDatabaseRecommendedSensitivityLabels operations
    :vartype managed_database_recommended_sensitivity_labels: azure.mgmt.sql.operations.ManagedDatabaseRecommendedSensitivityLabelsOperations
    :ivar managed_database_tables: ManagedDatabaseTables operations
    :vartype managed_database_tables: azure.mgmt.sql.operations.ManagedDatabaseTablesOperations
    :ivar managed_database_transparent_data_encryption: ManagedDatabaseTransparentDataEncryption operations
    :vartype managed_database_transparent_data_encryption: azure.mgmt.sql.operations.ManagedDatabaseTransparentDataEncryptionOperations
    ...
    :ivar managed_instance_private_endpoint_connections: ManagedInstancePrivateEndpointConnections operations
    ...
    :ivar managed_instance_private_link_resources: ManagedInstancePrivateLinkResources operations
    ...
    :ivar operations_health: OperationsHealth operations
    :vartype operations_health: azure.mgmt.sql.operations.OperationsHealthOperations
    ...
    :ivar recommended_sensitivity_labels: RecommendedSensitivityLabels operations
    :vartype recommended_sensitivity_labels: azure.mgmt.sql.operations.RecommendedSensitivityLabelsOperations
    :ivar server_advisors: ServerAdvisors operations
    ...
    :ivar time_zones: TimeZones operations
    ...
    :ivar ledger_digest_uploads: LedgerDigestUploads operations
    :vartype ledger_digest_uploads: azure.mgmt.sql.operations.LedgerDigestUploadsOperations
    :ivar outbound_firewall_rules: OutboundFirewallRules operations
