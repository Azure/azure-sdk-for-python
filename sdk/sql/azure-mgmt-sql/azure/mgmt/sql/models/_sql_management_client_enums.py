...
class DatabaseIdentityType(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    """The identity type
    """
...
class ServicePrincipalType(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
