...
class TestSqlManagementNetworkSecurityPerimeterConfigurationsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(SqlManagementClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_network_security_perimeter_configurations_list_by_server(self, resource_group):
        response = self.client.network_security_perimeter_configurations.list_by_server(
