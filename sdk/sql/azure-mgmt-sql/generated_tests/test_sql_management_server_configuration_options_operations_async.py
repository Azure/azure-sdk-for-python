...
class TestSqlManagementServerConfigurationOptionsOperationsAsync(AzureMgmtRecordedTestCase):
        ...
        response = await (
            await self.client.server_configuration_options.begin_create_or_update(
                ...
                parameters={
                    "id": "str",
                    "name": "str",
                    "properties": {"serverConfigurationOptionValue": 0, "provisioningState": "str"},
                    "systemData": {
