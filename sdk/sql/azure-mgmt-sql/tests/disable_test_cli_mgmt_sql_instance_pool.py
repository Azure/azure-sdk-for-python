...
class MgmtSqlTest(AzureMgmtTestCase):
    ...
    def test_instance_pool(self, resource_group):
        ...
        result = self.mgmt_client.instance_pools.begin_create_or_update(
            resource_group_name=RESOURCE_GROUP, instance_pool_name=INSTANCE_POOL_NAME, parameters=BODY
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.instance_pools.get(
        ...
        # --------------------------------------------------------------------------
        BODY = {"tags": {"x": "y"}}
        result = self.mgmt_client.instance_pools.begin_update(
            resource_group_name=RESOURCE_GROUP, instance_pool_name=INSTANCE_POOL_NAME, parameters=BODY
        )
        result = result.result()
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.instance_pools.begin_delete(
            resource_group_name=RESOURCE_GROUP, instance_pool_name=INSTANCE_POOL_NAME
        )
        result = result.result()
