...
# USAGE
    python gets_the_current_sensitivity_labels_of_a_given_database_in_a_managed_database.py
...
def main():
    ...
    response = client.managed_database_sensitivity_labels.list_current_by_database(
