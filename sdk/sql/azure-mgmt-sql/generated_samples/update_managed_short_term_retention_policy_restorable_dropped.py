...
# USAGE
    python update_managed_short_term_retention_policy_restorable_dropped.py
...
# x-ms-original-file: specification/sql/resource-manager/Microsoft.Sql/preview/2024-11-01-preview/examples/UpdateManagedShortTermRetentionPolicyRestorableDropped.json
