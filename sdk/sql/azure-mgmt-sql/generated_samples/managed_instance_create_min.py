...
# USAGE
    python managed_instance_create_min.py
...
# x-ms-original-file: specification/sql/resource-manager/Microsoft.Sql/preview/2024-05-01-preview/examples/ManagedInstanceCreateMin.json
