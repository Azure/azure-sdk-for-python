...
# USAGE
    python long_term_retention_backup_copy.py
...
# x-ms-original-file: specification/sql/resource-manager/Microsoft.Sql/preview/2024-05-01-preview/examples/LongTermRetentionBackupCopy.json
