...
# USAGE
    python create_or_update_the_ltr_policy_for_the_managed_database..py
...
def main():
    ...
    response = client.managed_instance_long_term_retention_policies.begin_create_or_update(
