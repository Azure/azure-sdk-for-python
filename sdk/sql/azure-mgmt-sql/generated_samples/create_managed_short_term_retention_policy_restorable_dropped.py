...
# USAGE
    python create_managed_short_term_retention_policy_restorable_dropped.py
...
# x-ms-original-file: 2025-01-01/CreateManagedShortTermRetentionPolicyRestorableDropped.json
