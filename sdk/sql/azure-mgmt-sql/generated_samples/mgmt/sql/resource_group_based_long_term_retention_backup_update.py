...
# USAGE
    python resource_group_based_long_term_retention_backup_update.py
...
def main():
    ...
    response = client.long_term_retention_backups.begin_update_by_resource_group(
        ...
        parameters={"properties": {"requestedBackupStorageRedundancy": "Geo"}},
    ).result()
    print(response)
