...
# USAGE
    python managed_instance_advanced_threat_protection_settings_list_by_instance.py
...
def main():
    ...
    response = client.managed_instance_advanced_threat_protection_settings.list_by_instance(
