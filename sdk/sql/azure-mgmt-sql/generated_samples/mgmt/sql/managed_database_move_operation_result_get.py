...
# USAGE
    python managed_database_move_operation_result_get.py
...
def main():
    ...
    response = client.managed_database_move_operations.get(
        resource_group_name="rg1",
        location_name="westeurope",
        operation_id="15961324-d809-46ed-86b9-d786953140e2",
    )
    print(response)
