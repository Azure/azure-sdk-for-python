...
# USAGE
    python sync_member_patch_add_and_remove_identity.py
...
def main():
    ...
    response = client.sync_members.begin_update(
        ...
        parameters={
            "identity": {
                ...
                "userAssignedIdentities": {
                    "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/group1/providers/Microsoft.ManagedIdentity/userAssignedIdentities/test-umi": None,
