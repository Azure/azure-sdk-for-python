...
# USAGE
    python update_a_managed_database's_advanced_threat_protection_settings_with_minimal_parameters.py
...
def main():
    ...
    response = client.managed_database_advanced_threat_protection_settings.create_or_update(
