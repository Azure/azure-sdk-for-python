...
# USAGE
    python update_a_managed_server's_threat_detection_policy_with_minimal_parameters.py
...
def main():
    ...
    response = client.managed_server_security_alert_policies.begin_create_or_update(
