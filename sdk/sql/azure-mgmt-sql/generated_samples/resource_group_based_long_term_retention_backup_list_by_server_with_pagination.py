...
# USAGE
    python resource_group_based_long_term_retention_backup_list_by_server_with_pagination.py
...
def main():
    ...
    response = client.long_term_retention_backups.list_by_resource_group_server(
