...
# USAGE
    python update_a_server's_extended_blob_auditing_policy_with_all_parameters.py
...
def main():
    ...
    response = client.extended_server_blob_auditing_policies.begin_create_or_update(
