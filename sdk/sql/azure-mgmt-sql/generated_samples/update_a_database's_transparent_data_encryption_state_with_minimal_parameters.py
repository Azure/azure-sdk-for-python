...
# USAGE
    python update_a_database's_transparent_data_encryption_state_with_minimal_parameters.py
...
def main():
    ...
    response = client.managed_database_transparent_data_encryption.create_or_update(
        resource_group_name="securitytde-42-rg",
        managed_instance_name="securitytde-42",
