...
# USAGE
    python instance_failover_group_create_or_update.py
...
def main():
    ...
    response = client.instance_failover_groups.begin_create_or_update(
...
# x-ms-original-file: specification/sql/resource-manager/Microsoft.Sql/preview/2024-05-01-preview/examples/InstanceFailoverGroupCreateOrUpdate.json
