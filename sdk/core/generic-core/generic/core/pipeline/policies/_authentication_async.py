...
class AsyncBearerTokenCredentialPolicy(AsyncHTTPPolicy[HTTPRequestType, AsyncHTTPResponseType]):
    ...
    :type credential: ~generic.core.credentials.TokenCredential
    ...
    async def on_request(self, request: PipelineRequest[HTTPRequestType]) -> None:
        ...
        :raises: :class:`~generic.core.exceptions.ServiceRequestError`
        """
    ...
    async def authorize_request(self, request: PipelineRequest[HTTPRequestType], *scopes: str, **kwargs: Any) -> None:
        ...
        :param ~generic.core.pipeline.PipelineRequest request: the request
    ...
    async def on_challenge(
        ...
        :param ~generic.core.pipeline.PipelineRequest request: the request which elicited an authentication challenge
        :param ~generic.core.pipeline.PipelineResponse response: the resource provider's response
    ...
    def on_response(
        ...
        :type response: ~generic.core.pipeline.PipelineResponse
        """
