...
class TestHttpXTransport:
    ...
    def test_compress_compressed_no_header_offline(self, port, http_request):
        ...
        pipeline_client = PipelineClient(PLACEHOLDER_ENDPOINT, transport=HttpXTransport())
        response = pipeline_client.send_request(request, stream=True)
