...
from corehttp.instrumentation.tracing._tracer import TracerProvider, default_tracer_provider
from corehttp.instrumentation.tracing._models import SpanKind, Link, StatusCode
...
def test_nest_span_with_thread_pool_executor(tracing_helper):
    ...
    for span in finished_spans:
        ...
        assert span.instrumentation_scope.name == "mylibrary"
