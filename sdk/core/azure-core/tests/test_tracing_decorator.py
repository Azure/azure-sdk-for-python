...
class MockClient:
    @distributed_trace
    def __init__(self, request_type, add_supported_format_rest_to_mock, policies=None, assert_current_span=False):
        time.sleep(0.001)
        ...
        add_supported_format_rest_to_mock(self.transport)
...
def test_get_function_and_class_name(request_type, add_supported_format_rest_to_mock):
    client = MockClient(request_type, add_supported_format_rest_to_mock)
...
class TestDecorator(object):
    ...
    @pytest.mark.parametrize("request_type", [PipelineTransportHttpRequest, RestHttpRequest])
    def test_decorator_tracing_attr(self, request_type ,add_supported_format_rest_to_mock):
    ...
    @pytest.mark.parametrize("request_type", [PipelineTransportHttpRequest, RestHttpRequest])
    def test_decorator_has_different_name(self, request_type, add_supported_format_rest_to_mock):
        with FakeSpan(name="parent") as parent:
            client = MockClient(request_type, add_supported_format_rest_to_mock)
    ...
    @pytest.mark.parametrize("request_type", [PipelineTransportHttpRequest, RestHttpRequest])
    def test_used(self, request_type, add_supported_format_rest_to_mock):
        with FakeSpan(name="parent") as parent:
            client = MockClient(request_type, add_supported_format_rest_to_mock, policies=[])
    ...
    @pytest.mark.parametrize("request_type", [PipelineTransportHttpRequest, RestHttpRequest])
    def test_span_merge_span(self, request_type, add_supported_format_rest_to_mock):
        with FakeSpan(name="parent") as parent:
            client = MockClient(request_type, add_supported_format_rest_to_mock)
    ...
    @pytest.mark.parametrize("request_type", [PipelineTransportHttpRequest, RestHttpRequest])
    def test_span_complicated(self, request_type, add_supported_format_rest_to_mock):
        with FakeSpan(name="parent") as parent:
            client = MockClient(request_type, add_supported_format_rest_to_mock)
    ...
    @pytest.mark.parametrize("request_type", [PipelineTransportHttpRequest, RestHttpRequest])
    def test_span_with_exception(self, request_type, add_supported_format_rest_to_mock):
