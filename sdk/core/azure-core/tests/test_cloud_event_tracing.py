...
from azure.core.pipeline.policies import CloudEventDistributedTracingPolicy
from _mocks import (
    cloud_storage_dict
)
...
def test_cloud_event_policy_copies():
...
def test_cloud_event_policy_no_copy_if_trace_exists():
    policy = CloudEventDistributedTracingPolicy()
