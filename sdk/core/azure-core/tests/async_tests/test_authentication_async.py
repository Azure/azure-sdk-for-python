...
from azure.core.credentials_async import AsyncTokenCredential, AsyncTokenInfoCredential
...
async def test_bearer_policy_access_token_info_caching(http_request):
    ...
    credential = create_autospec(AsyncTokenInfoCredential, instance=True, spec_set=True)
    credential.get_token = AsyncMock(return_value=Mock())
