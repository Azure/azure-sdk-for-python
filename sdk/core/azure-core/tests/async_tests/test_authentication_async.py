...
@pytest.mark.asyncio
@pytest.mark.parametrize("http_request", HTTP_REQUESTS)
async def test_async_bearer_policy_challenge_response_passed_to_get_token_info(http_request):
...
@pytest.mark.asyncio
@pytest.mark.parametrize("http_request", HTTP_REQUESTS)
async def test_async_bearer_policy_challenge_response_not_passed_to_legacy_get_token(http_request):
