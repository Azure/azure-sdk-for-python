...
from utils import create_http_response, pipeline_transport_and_rest_product, HTTP_RESPONSES, HTTP_REQUESTS
...
full_combination = list(product(retry_after_input, pipeline_transport_and_rest_product(HTTP_REQUESTS, HTTP_RESPONSES)))
...
@pytest.mark.parametrize("retry_after_input,request_and_response", full_combination)
...
@pytest.mark.parametrize(
    ...
    product(transport_expected_timeout_error, HTTP_REQUESTS),
)
