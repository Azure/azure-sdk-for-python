...
|  |  | allowed_query_params | x |  | Additional URL query parameters to allow in logs. Applies to `DistributedTracingPolicy` as well. |
...
|  |  | allowed_query_params | x | | Additional URL query parameters to allow in span attributes. Applies to `HttpLoggingPolicy` as well. |
| --- | --- | --- | --- | --- | --- |
