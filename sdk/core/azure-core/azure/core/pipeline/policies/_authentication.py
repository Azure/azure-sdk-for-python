...
from azure.core.credentials import TokenInfoCredential, TokenRequestOptions
...
class BearerTokenCredentialPolicy(_BearerTokenCredentialPolicyBase, HTTPPolicy[HTTPRequestType, HTTPResponseType]):
    ...
    def on_request(self, request: PipelineRequest[HTTPRequestType]) -> None:
        ...
        if self._token is None or self._need_new_token:
            if hasattr(self._credential, "get_token_info"):
                ...
                self._token = cast(TokenInfoCredential, self._credential).get_token_info(*self._scopes, options=options)
            else:
    ...
    def authorize_request(self, request: PipelineRequest[HTTPRequestType], *scopes: str, **kwargs: Any) -> None:
        ...
        if hasattr(self._credential, "get_token_info"):
            ...
            self._token = cast(TokenInfoCredential, self._credential).get_token_info(
                *scopes,
                options=options,
            )
        else:
