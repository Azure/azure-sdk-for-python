...
class StorageTaskAssignmentOperations:
    ...
    @distributed_trace
    def list(
        self, resource_group_name: str, storage_task_name: str, maxpagesize: Optional[str] = None, **kwargs: Any
        ...
        cls: ClsType[_models.StorageTaskAssignmentsListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("StorageTaskAssignmentsListResult", pipeline_response)
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageActions/storageTasks/{storageTaskName}/storageTaskAssignments"
    }
