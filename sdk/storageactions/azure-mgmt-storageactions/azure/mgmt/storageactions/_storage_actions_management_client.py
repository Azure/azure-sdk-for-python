...
from ._configuration import StorageActionsManagementClientConfiguration
...
class StorageActionsManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = StorageActionsManagementClientConfiguration(
    ...
    def __enter__(self) -> "StorageActionsManagementClient":
