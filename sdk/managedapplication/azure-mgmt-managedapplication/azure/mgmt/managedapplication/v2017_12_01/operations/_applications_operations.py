...
class ApplicationsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2017_12_01.models.Application or IO[bytes]
        :return: An instance of LROPoller that returns either Application or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managedapplication.v2017_12_01.models.Application]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationPatchable or
         IO[bytes]
        :return: An instance of LROPoller that returns either Application or the result of
         cls(response)
        :rtype:
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.Application"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.managedapplication.v2017_12_01.models.Application]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
