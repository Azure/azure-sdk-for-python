...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "applicationDefinitionName": _SERIALIZER.url(
            "application_definition_name", application_definition_name, "str", max_length=64, min_length=3
        ),
...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Solutions/applicationDefinitions"
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class ApplicationDefinitionsOperations:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationDefinition or None
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the create or update an managed application
         definition. Required.
        :type parameters: ~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationDefinition
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApplicationDefinition or the result of cls(response)
        :rtype: ~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationDefinition or
         IO[bytes]
        :return: ApplicationDefinition or the result of cls(response)
        :rtype: ~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the update a managed application definition.
         Required.
        :type parameters:
         ~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationDefinitionPatchable
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApplicationDefinition or the result of cls(response)
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationDefinitionPatchable or IO[bytes]
        :return: ApplicationDefinition or the result of cls(response)
        :rtype: ~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either ApplicationDefinition or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.ApplicationDefinition"]:
        """Lists the managed application definitions in a subscription.
