...
class GenericResource(Resource):
    ...
    :vartype sku: ~azure.mgmt.managedapplication.v2017_12_01.models.Sku
    :ivar identity: The identity of the resource.
    :vartype identity: ~azure.mgmt.managedapplication.v2017_12_01.models.Identity
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype sku: ~azure.mgmt.managedapplication.v2017_12_01.models.Sku
        :keyword identity: The identity of the resource.
        :paramtype identity: ~azure.mgmt.managedapplication.v2017_12_01.models.Identity
        """
...
class Application(GenericResource):
    ...
    :vartype plan: ~azure.mgmt.managedapplication.v2017_12_01.models.Plan
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.managedapplication.v2017_12_01.models.ProvisioningState
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype plan: ~azure.mgmt.managedapplication.v2017_12_01.models.Plan
...
class ApplicationArtifact(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationArtifactType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype type: str or
         ~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationArtifactType
        """
        super().__init__(**kwargs)
        self.name = name
        self.uri = uri
...
class ApplicationDefinition(GenericResource):
    ...
    :vartype lock_level: str or
     ~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationLockLevel
    ...
    :vartype authorizations:
     list[~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationProviderAuthorization]
    ...
    :vartype artifacts: list[~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationArtifact]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype artifacts:
         list[~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationArtifact]
...
class ApplicationDefinitionListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationDefinition]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.managedapplication.v2017_12_01.models.ApplicationDefinition]
...
class ApplicationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.managedapplication.v2017_12_01.models.Application]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.managedapplication.v2017_12_01.models.Application]
        :keyword next_link: The URL to use for getting the next set of results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ApplicationPatchable(GenericResource):
    ...
    :vartype identity: ~azure.mgmt.managedapplication.v2017_12_01.models.Identity
    :ivar plan: The plan information.
    :vartype plan: ~azure.mgmt.managedapplication.v2017_12_01.models.PlanPatchable
    :ivar kind: The kind of the managed application. Allowed values are MarketPlace and
     ServiceCatalog.
    :vartype kind: str
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype identity: ~azure.mgmt.managedapplication.v2017_12_01.models.Identity
        :keyword plan: The plan information.
        :paramtype plan: ~azure.mgmt.managedapplication.v2017_12_01.models.PlanPatchable
        :keyword kind: The kind of the managed application. Allowed values are MarketPlace and
         ServiceCatalog.
        :paramtype kind: str
...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.managedapplication.v2017_12_01.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.managedapplication.v2017_12_01.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.managedapplication.v2017_12_01.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.managedapplication.v2017_12_01.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.managedapplication.v2017_12_01.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.managedapplication.v2017_12_01.models.Origin
    :ivar action_type: Enum. Indicates the action type. "Internal" refers to actions that are for
     internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.managedapplication.v2017_12_01.models.ActionType
    """
    ...
    def __init__(self, *, display: Optional["_models.OperationDisplay"] = None, **kwargs: Any) -> None:
        ...
        :paramtype display: ~azure.mgmt.managedapplication.v2017_12_01.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name: Optional[str] = None
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.managedapplication.v2017_12_01.models.Operation]
