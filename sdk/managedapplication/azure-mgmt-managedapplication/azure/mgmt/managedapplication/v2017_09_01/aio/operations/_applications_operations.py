...
class ApplicationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.managedapplication.v2017_09_01.aio.ApplicationClient`'s
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.managedapplication.v2017_09_01.models.Application or None
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2017_09_01.models.Application
        ...
        :return: An instance of AsyncLROPoller that returns either Application or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managedapplication.v2017_09_01.models.Application]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2017_09_01.models.Application or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Application or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managedapplication.v2017_09_01.models.Application]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to update an existing managed application. Default value
         is None.
        :type parameters: ~azure.mgmt.managedapplication.v2017_09_01.models.ApplicationPatchable
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either Application or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2017_09_01.models.ApplicationPatchable or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Application or the result of
         cls(response)
        :rtype:
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncItemPaged["_models.Application"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.managedapplication.v2017_09_01.models.Application]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
