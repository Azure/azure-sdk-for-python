...
from .operations import ApplicationDefinitionsOperations, ApplicationsOperations, _ApplicationClientOperationsMixin
...
class ApplicationClient(_ApplicationClientOperationsMixin):
    ...
    :vartype applications:
     azure.mgmt.managedapplication.v2017_09_01.aio.operations.ApplicationsOperations
    :ivar application_definitions: ApplicationDefinitionsOperations operations
    :vartype application_definitions:
     azure.mgmt.managedapplication.v2017_09_01.aio.operations.ApplicationDefinitionsOperations
    ...
    :keyword api_version: Api Version. Default value is "2017-09-01". Note that overriding this
