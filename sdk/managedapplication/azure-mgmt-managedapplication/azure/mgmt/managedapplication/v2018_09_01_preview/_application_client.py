...
class ApplicationClient(_ApplicationClientOperationsMixin):
    ...
    :vartype applications:
     azure.mgmt.managedapplication.v2018_09_01_preview.operations.ApplicationsOperations
    :ivar application_definitions: ApplicationDefinitionsOperations operations
    :vartype application_definitions:
     azure.mgmt.managedapplication.v2018_09_01_preview.operations.ApplicationDefinitionsOperations
    :ivar jit_requests: JitRequestsOperations operations
    :vartype jit_requests:
     azure.mgmt.managedapplication.v2018_09_01_preview.operations.JitRequestsOperations
