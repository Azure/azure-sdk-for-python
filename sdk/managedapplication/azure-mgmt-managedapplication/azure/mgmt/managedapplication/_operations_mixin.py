...
class ApplicationClientOperationsMixin(object):
    ...
    def list_operations(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.managedapplication.v2021_07_01.models.OperationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = self._get_api_version('list_operations')
        if api_version == '2021-07-01':
            from .v2021_07_01.operations import ApplicationClientOperationsMixin as OperationClass
        else:
