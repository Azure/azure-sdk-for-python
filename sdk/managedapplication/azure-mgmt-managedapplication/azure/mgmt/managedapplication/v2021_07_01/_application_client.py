...
from .operations import ApplicationClientOperationsMixin, ApplicationDefinitionsOperations, ApplicationsOperations, JitRequestsOperations
...
class ApplicationClient(ApplicationClientOperationsMixin):
    ...
    :vartype applications:
     azure.mgmt.managedapplication.v2021_07_01.operations.ApplicationsOperations
    :ivar application_definitions: ApplicationDefinitionsOperations operations
    :vartype application_definitions:
     azure.mgmt.managedapplication.v2021_07_01.operations.ApplicationDefinitionsOperations
    :ivar jit_requests: JitRequestsOperations operations
    :vartype jit_requests:
     azure.mgmt.managedapplication.v2021_07_01.operations.JitRequestsOperations
