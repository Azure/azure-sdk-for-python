...
class AllowedUpgradePlansResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.managedapplication.v2021_07_01.models.Plan]
    """
    ...
    def __init__(self, *, value: Optional[list["_models.Plan"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.managedapplication.v2021_07_01.models.Plan]
        """
...
class ManagedIdentityTokenResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.managedapplication.v2021_07_01.models.ManagedIdentityToken]
    """
    ...
    def __init__(self, *, value: Optional[list["_models.ManagedIdentityToken"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.managedapplication.v2021_07_01.models.ManagedIdentityToken]
        """
        super().__init__(**kwargs)
        self.value = value
...
class UpdateAccessDefinition(_serialization.Model):
    ...
    :vartype metadata: ~azure.mgmt.managedapplication.v2021_07_01.models.JitRequestMetadata
    :ivar status: The JIT status. Required. Known values are: "NotSpecified", "Elevate", and
     "Remove".
    :vartype status: str or ~azure.mgmt.managedapplication.v2021_07_01.models.Status
    :ivar sub_status: The JIT status. Required. Known values are: "NotSpecified", "Approved",
     "Denied", "Failed", "Expired", and "Timeout".
    :vartype sub_status: str or ~azure.mgmt.managedapplication.v2021_07_01.models.Substatus
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype metadata: ~azure.mgmt.managedapplication.v2021_07_01.models.JitRequestMetadata
        :keyword status: The JIT status. Required. Known values are: "NotSpecified", "Elevate", and
         "Remove".
        :paramtype status: str or ~azure.mgmt.managedapplication.v2021_07_01.models.Status
        :keyword sub_status: The JIT status. Required. Known values are: "NotSpecified", "Approved",
         "Denied", "Failed", "Expired", and "Timeout".
        :paramtype sub_status: str or ~azure.mgmt.managedapplication.v2021_07_01.models.Substatus
        """
        super().__init__(**kwargs)
