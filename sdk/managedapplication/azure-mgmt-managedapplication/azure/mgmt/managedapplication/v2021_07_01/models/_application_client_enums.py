...
class ApplicationArtifactName(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ApplicationDefinitionArtifactName(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """The managed application artifact name.
    """
...
class ApplicationManagementMode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """The management mode.
    """
...
class JitApprovalMode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class JitApproverType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """The approver type.
    """
...
class JitRequestState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class JitSchedulingType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
