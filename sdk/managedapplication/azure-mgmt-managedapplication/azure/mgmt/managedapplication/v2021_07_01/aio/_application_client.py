...
class ApplicationClient(ApplicationClientOperationsMixin):
    ...
    :vartype applications: azure.mgmt.managedapplication.v2021_07_01.aio.operations.ApplicationsOperations
    :ivar application_definitions: ApplicationDefinitionsOperations operations
    :vartype application_definitions: azure.mgmt.managedapplication.v2021_07_01.aio.operations.ApplicationDefinitionsOperations
    :ivar jit_requests: JitRequestsOperations operations
    :vartype jit_requests: azure.mgmt.managedapplication.v2021_07_01.aio.operations.JitRequestsOperations
