...
class ApplicationDefinitionsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managedapplication.v2021_07_01.models.ApplicationDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ApplicationDefinition"]
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2021_07_01.models.ApplicationDefinitionPatchable
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ApplicationDefinition, or the result of cls(response)
        :rtype: ~azure.mgmt.managedapplication.v2021_07_01.models.ApplicationDefinition
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'ApplicationDefinitionPatchable')
        body_content_kwargs['content'] = body_content
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.managedapplication.v2021_07_01.models.ApplicationDefinitionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
