...
def build_refresh_permissions_request_initial(
    subscription_id: str,
    resource_group_name: str,
    application_name: str,
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Solutions/applications/{applicationName}/refreshPermissions')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "applicationName": _SERIALIZER.url("application_name", application_name, 'str', max_length=64, min_length=3),
...
def build_list_allowed_upgrade_plans_request(
    subscription_id: str,
    resource_group_name: str,
    application_name: str,
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Solutions/applications/{applicationName}/listAllowedUpgradePlans')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "applicationName": _SERIALIZER.url("application_name", application_name, 'str', max_length=64, min_length=3),
...
class ApplicationsOperations(object):
    ...
    :type models: ~azure.mgmt.managedapplication.v2021_07_01.models
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.managedapplication.v2021_07_01.models.Application
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2021_07_01.models.Application
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
        ...
        :return: An instance of LROPoller that returns either Application or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managedapplication.v2021_07_01.models.Application]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
        polling = kwargs.pop('polling', True)  # type: Union[bool, azure.core.polling.PollingMethod]
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2021_07_01.models.ApplicationPatchable
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Application, or the result of cls(response)
        :rtype: ~azure.mgmt.managedapplication.v2021_07_01.models.Application or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ApplicationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.managedapplication.v2021_07_01.models.ApplicationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _refresh_permissions_initial(
        ...
        **kwargs: Any
        ...
        request = build_refresh_permissions_request_initial(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            application_name=application_name,
    ...
    _refresh_permissions_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Solutions/applications/{applicationName}/refreshPermissions'}  # type: ignore
    ...
    begin_refresh_permissions.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Solutions/applications/{applicationName}/refreshPermissions'}  # type: ignore
    ...
    list_allowed_upgrade_plans.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Solutions/applications/{applicationName}/listAllowedUpgradePlans'}  # type: ignore
