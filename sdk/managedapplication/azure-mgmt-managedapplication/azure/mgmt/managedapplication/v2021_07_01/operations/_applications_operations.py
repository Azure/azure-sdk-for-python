...
def build_update_access_request(
    resource_group_name: str, application_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ApplicationsOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.managedapplication.v2021_07_01.ApplicationClient`'s
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2021_07_01.models.Application or IO[bytes]
        :return: An instance of LROPoller that returns either Application or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managedapplication.v2021_07_01.models.Application]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2021_07_01.models.ApplicationPatchable or
         IO[bytes]
        :return: An instance of LROPoller that returns either Application or the result of
         cls(response)
        :rtype:
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.Application"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.managedapplication.v2021_07_01.models.Application]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_allowed_upgrade_plans(
        ...
        :rtype: ~azure.mgmt.managedapplication.v2021_07_01.models.AllowedUpgradePlansResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_update_access(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2021_07_01.models.UpdateAccessDefinition
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either UpdateAccessDefinition or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managedapplication.v2021_07_01.models.UpdateAccessDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update_access(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2021_07_01.models.UpdateAccessDefinition or
         IO[bytes]
        :return: An instance of LROPoller that returns either UpdateAccessDefinition or the result of
         cls(response)
        :rtype:
    ...
    def list_tokens(
        ...
        **kwargs: Any
        ...
        :type application_name: str
        :param parameters: Request body parameters to list tokens. Required.
        :type parameters: ~azure.mgmt.managedapplication.v2021_07_01.models.ListTokenRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ManagedIdentityTokenResult or the result of cls(response)
        :rtype: ~azure.mgmt.managedapplication.v2021_07_01.models.ManagedIdentityTokenResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_tokens(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2021_07_01.models.ListTokenRequest or
         IO[bytes]
        :return: ManagedIdentityTokenResult or the result of cls(response)
        :rtype: ~azure.mgmt.managedapplication.v2021_07_01.models.ManagedIdentityTokenResult
        :raises ~azure.core.exceptions.HttpResponseError:
