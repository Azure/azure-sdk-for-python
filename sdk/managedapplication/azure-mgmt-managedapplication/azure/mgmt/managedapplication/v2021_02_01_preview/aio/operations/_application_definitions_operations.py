...
class ApplicationDefinitionsOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.managedapplication.v2021_02_01_preview.models.ApplicationDefinition or None
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the create or update an managed application
         definition. Required.
        :type parameters:
         ~azure.mgmt.managedapplication.v2021_02_01_preview.models.ApplicationDefinition
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApplicationDefinition or the result of cls(response)
        :rtype: ~azure.mgmt.managedapplication.v2021_02_01_preview.models.ApplicationDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.managedapplication.v2021_02_01_preview.models.ApplicationDefinition or IO[bytes]
        :return: ApplicationDefinition or the result of cls(response)
        :rtype: ~azure.mgmt.managedapplication.v2021_02_01_preview.models.ApplicationDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the update a managed application definition.
         Required.
        :type parameters:
         ~azure.mgmt.managedapplication.v2021_02_01_preview.models.ApplicationDefinitionPatchable
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApplicationDefinition or the result of cls(response)
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.managedapplication.v2021_02_01_preview.models.ApplicationDefinitionPatchable or
         IO[bytes]
        :return: ApplicationDefinition or the result of cls(response)
        :rtype: ~azure.mgmt.managedapplication.v2021_02_01_preview.models.ApplicationDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either ApplicationDefinition or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.managedapplication.v2021_02_01_preview.models.ApplicationDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def create_or_update_by_id(
        ...
        **kwargs: Any
        ...
        """Creates or updates managed application definition.
