...
from ...operations._applications_operations import (
    ...
    build_get_request,
    build_list_allowed_upgrade_plans_request,
    build_list_by_resource_group_request,
    build_list_by_subscription_request,
    build_list_tokens_request,
    build_refresh_permissions_request,
    build_update_access_request,
    build_update_by_id_request,
...
class ApplicationsOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.managedapplication.v2021_02_01_preview.aio.ApplicationClient`'s
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.managedapplication.v2021_02_01_preview.models.Application or None
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        """Creates or update managed application.
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2021_02_01_preview.models.Application
        ...
        :return: An instance of AsyncLROPoller that returns either Application or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managedapplication.v2021_02_01_preview.models.Application]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2021_02_01_preview.models.Application or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Application or the result of
         cls(response)
        :rtype:
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to update an existing managed application. Default value
         is None.
        :type parameters:
         ~azure.mgmt.managedapplication.v2021_02_01_preview.models.ApplicationPatchable
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either Application or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.managedapplication.v2021_02_01_preview.models.ApplicationPatchable or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Application or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managedapplication.v2021_02_01_preview.models.Application]
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncItemPaged["_models.Application"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.managedapplication.v2021_02_01_preview.models.Application]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.Application"]:
    ...
    async def list_allowed_upgrade_plans(
        self, resource_group_name: str, application_name: str, **kwargs: Any
    ) -> _models.AllowedUpgradePlansResult:
        ...
        :rtype: ~azure.mgmt.managedapplication.v2021_02_01_preview.models.AllowedUpgradePlansResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("AllowedUpgradePlansResult", pipeline_response.http_response)
    ...
    async def _update_access_initial(
        self,
        resource_group_name: str,
        application_name: str,
    ...
    async def begin_update_access(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.UpdateAccessDefinition]:
        ...
        :type parameters:
         ~azure.mgmt.managedapplication.v2021_02_01_preview.models.UpdateAccessDefinition
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either UpdateAccessDefinition or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managedapplication.v2021_02_01_preview.models.UpdateAccessDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update_access(
        ...
        **kwargs: Any
        ...
        :param application_name: The name of the managed application. Required.
        :type application_name: str
        :param parameters: Request body parameters to update access. Is either a UpdateAccessDefinition
         type or a IO[bytes] type. Required.
        :type parameters:
         ~azure.mgmt.managedapplication.v2021_02_01_preview.models.UpdateAccessDefinition or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either UpdateAccessDefinition or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managedapplication.v2021_02_01_preview.models.UpdateAccessDefinition]
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._update_access_initial(
                resource_group_name=resource_group_name,
                application_name=application_name,
                parameters=parameters,
                api_version=api_version,
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("UpdateAccessDefinition", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.UpdateAccessDefinition].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.UpdateAccessDefinition](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    async def list_tokens(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2021_02_01_preview.models.ListTokenRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ManagedIdentityTokenResult or the result of cls(response)
        :rtype: ~azure.mgmt.managedapplication.v2021_02_01_preview.models.ManagedIdentityTokenResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def list_tokens(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.managedapplication.v2021_02_01_preview.models.ListTokenRequest or
         IO[bytes]
        :return: ManagedIdentityTokenResult or the result of cls(response)
        :rtype: ~azure.mgmt.managedapplication.v2021_02_01_preview.models.ManagedIdentityTokenResult
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.ManagedIdentityTokenResult] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("ManagedIdentityTokenResult", pipeline_response.http_response)
