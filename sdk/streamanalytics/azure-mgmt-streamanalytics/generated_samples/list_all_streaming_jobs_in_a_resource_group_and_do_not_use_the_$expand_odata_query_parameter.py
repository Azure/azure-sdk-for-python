...
# USAGE
    python list_all_streaming_jobs_in_a_resource_group_and_do_not_use_the_$expand_odata_query_parameter.py
...
def main():
    ...
    response = client.streaming_jobs.list_by_resource_group(
