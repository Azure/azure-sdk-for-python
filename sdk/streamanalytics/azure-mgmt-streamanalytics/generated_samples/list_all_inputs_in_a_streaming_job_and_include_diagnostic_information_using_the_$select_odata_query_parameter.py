...
# USAGE
    python list_all_inputs_in_a_streaming_job_and_include_diagnostic_information_using_the_$select_odata_query_parameter.py
...
def main():
    ...
    response = client.inputs.list_by_streaming_job(
