...
# USAGE
    python output_update_delta_lake.py
...
def main():
    ...
    response = client.outputs.update(
        ...
        output={
            "properties": {
                "datasource": {"properties": {"container": "deltaoutput2"}, "type": "Microsoft.Storage/Blob"},
                "serialization": {
                    "properties": {"deltaTablePath": "/folder1/table2", "partitionColumns": ["column2"]},
                    "type": "Delta",
                },
            }
        },
