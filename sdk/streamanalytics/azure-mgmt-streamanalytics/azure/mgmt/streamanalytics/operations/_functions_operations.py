...
def build_create_or_replace_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StreamAnalytics/streamingjobs/{jobName}/functions/{functionName}')
...
def build_list_by_streaming_job_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StreamAnalytics/streamingjobs/{jobName}/functions')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        "jobName": _SERIALIZER.url("job_name", job_name, 'str'),
...
def build_test_request_initial(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StreamAnalytics/streamingjobs/{jobName}/functions/{functionName}/test')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        "jobName": _SERIALIZER.url("job_name", job_name, 'str'),
...
def build_retrieve_default_definition_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StreamAnalytics/streamingjobs/{jobName}/functions/{functionName}/retrieveDefaultDefinition')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        "jobName": _SERIALIZER.url("job_name", job_name, 'str'),
...
class FunctionsOperations(object):
    ...
    def create_or_replace(
        ...
        job_name,  # type: str
        function_name,  # type: str
        function,  # type: "_models.Function"
        if_match=None,  # type: Optional[str]
        if_none_match=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Function"
    ...
    def list_by_streaming_job(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.FunctionListResult"]
    ...
    def _test_initial(
        ...
        job_name,  # type: str
        function_name,  # type: str
        function=None,  # type: Optional["_models.Function"]
        **kwargs  # type: Any
    ):
    ...
    def retrieve_default_definition(
        ...
        job_name,  # type: str
        function_name,  # type: str
        function_retrieve_default_definition_parameters=None,  # type: Optional["_models.FunctionRetrieveDefaultDefinitionParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Function"
