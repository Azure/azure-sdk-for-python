...
def build_get_request(
    resource_group_name: str, cluster_name: str, private_endpoint_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PrivateEndpointsOperations:
    ...
    def list_by_cluster(
    ...
    ) -> Iterable["_models.PrivateEndpoint"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.streamanalytics.models.PrivateEndpoint]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
