...
class SubscriptionsOperations:
    ...
    async def begin_test_query(
        ...
        if cont_token is None:
            raw_result = await self._test_query_initial(  # type: ignore
                location=location,
    ...
    async def begin_sample_input(
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._sample_input_initial(  # type: ignore
                location=location,
    ...
    async def begin_test_input(
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._test_input_initial(  # type: ignore
                location=location,
    ...
    async def begin_test_output(
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._test_output_initial(  # type: ignore
                location=location,
