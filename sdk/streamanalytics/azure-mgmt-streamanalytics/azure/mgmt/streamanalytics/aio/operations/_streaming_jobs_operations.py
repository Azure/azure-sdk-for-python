...
class StreamingJobsOperations:
    ...
    async def begin_create_or_replace(
        ...
        **kwargs
        ...
        :return: An instance of AsyncLROPoller that returns either StreamingJob or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~stream_analytics_management_client.models.StreamingJob]
