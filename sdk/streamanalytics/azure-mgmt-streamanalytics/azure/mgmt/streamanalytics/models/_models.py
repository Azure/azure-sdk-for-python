...
class StreamingJob(TrackedResource):
    ...
    :ivar compatibility_level: Controls certain runtime behaviors of the streaming job. Default
     value: "1.0".
    ...
    _validation = {
        ...
        'compatibility_level': {'constant': True},
        'created_date': {'readonly': True},
        'etag': {'readonly': True},
...
class StreamingJobSku(msrest.serialization.Model):
    ...
    :ivar name: The name of the SKU. Required on PUT (CreateOrReplace) requests. Default value:
     "Standard".
    :vartype name: str
    """
