...
# USAGE
    python drills_validate_for_execution_maximum_set_gen.py
...
def main():
    ...
    client.drills.begin_validate_for_execution(
        service_group_name="sampleServiceGroupName",
        drill_name="drill1",
        body={"validateForExecutionProperties": {"sourceLocations": ["eastus2-az1"]}},
        operation_id="qmn",
    ).result()
