...
# USAGE
    python recovery_plan_actions_reprotect_maximum_set_gen.py
...
def main():
    ...
    response = client.recovery_plan_actions.begin_reprotect(
...
# x-ms-original-file: 2026-09-30-preview/RecoveryPlanActions_Reprotect_MaximumSet_Gen.json
