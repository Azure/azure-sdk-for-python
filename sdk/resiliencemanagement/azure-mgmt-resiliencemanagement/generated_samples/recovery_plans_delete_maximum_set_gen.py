...
# USAGE
    python recovery_plans_delete_maximum_set_gen.py
...
def main():
    ...
    client.recovery_plans.begin_delete(
        service_group_name="sampleServiceGroupName",
        recovery_plan_name="samplePlanName",
    ).result()


# x-ms-original-file: 2026-09-30-preview/RecoveryPlans_Delete_MaximumSet_Gen.json
