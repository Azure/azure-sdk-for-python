...
# USAGE
    python goal_assignments_delete_maximum_set_gen.py
...
def main():
    ...
    client.goal_assignments.begin_delete(
        service_group_name="sg1",
        goal_assignment_name="ga1",
    ).result()


# x-ms-original-file: 2026-09-30-preview/GoalAssignments_Delete_MaximumSet_Gen.json
