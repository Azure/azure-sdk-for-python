...
# USAGE
    python usage_plans_create_or_update_maximum_set_gen.py
...
def main():
    ...
    response = client.usage_plans.begin_create_or_update(
        resource_group_name="MyResourceGroup",
        usage_plan_name="myUsagePlan",
        resource={"location": "global", "properties": {"planType": "Standard"}, "tags": {"environment": "production"}},
    ).result()
    print(response)
