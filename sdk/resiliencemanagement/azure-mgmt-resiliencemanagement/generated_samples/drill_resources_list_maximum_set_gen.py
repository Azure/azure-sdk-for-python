...
# USAGE
    python drill_resources_list_maximum_set_gen.py
...
def main():
    ...
    response = client.drill_resources.list(
...
# x-ms-original-file: 2026-09-30-preview/DrillResources_List_MaximumSet_Gen.json
