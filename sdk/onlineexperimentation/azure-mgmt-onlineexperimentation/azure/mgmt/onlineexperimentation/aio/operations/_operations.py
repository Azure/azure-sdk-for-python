...
class PrivateEndpointConnectionsOperations:
    ...
    async def get(
        ...
        :param workspace_name: The name of the OnlineExperimentationWorkspace. Required.
        :type workspace_name: str
        :param private_endpoint_connection_name: The name of the PrivateEndpointConnection. Required.
        :type private_endpoint_connection_name: str
        :return: PrivateEndpointConnection. The PrivateEndpointConnection is compatible with
         MutableMapping
        :rtype: ~azure.mgmt.onlineexperimentation.models.PrivateEndpointConnection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        """Updates private endpoint connection status (Approval/Rejected) for an online experimentation
        workspace resource. This gets invoked by resource admin.
        ...
        :type private_endpoint_connection_name: str
        :param resource: Resource create parameters. Required.
        :type resource: ~azure.mgmt.onlineexperimentation.models.PrivateEndpointConnection
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: PrivateEndpointConnection. The PrivateEndpointConnection is compatible with
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.onlineexperimentation.models.PrivateEndpointConnection or JSON or
         IO[bytes]
        :return: PrivateEndpointConnection. The PrivateEndpointConnection is compatible with
         MutableMapping
        :rtype: ~azure.mgmt.onlineexperimentation.models.PrivateEndpointConnection
    ...
    @api_version_validation(
        method_added_on="2025-08-01-preview",
        params_added_on={
            "2025-08-01-preview": ["api_version", "subscription_id", "resource_group_name", "workspace_name", "accept"]
        },
    )
    def list(
        self, resource_group_name: str, workspace_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.PrivateEndpointConnection"]:
        """Gets all the private endpoint connections configured on an online experimentation workspace
        resource.
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.onlineexperimentation.models.PrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class PrivateLinkResourcesOperations:
    ...
    async def get(
        ...
        :param workspace_name: The name of the OnlineExperimentationWorkspace. Required.
        :type workspace_name: str
        :param private_link_resource_name: The name of the PrivateLinkResource. Required.
        :type private_link_resource_name: str
        :return: PrivateLinkResource. The PrivateLinkResource is compatible with MutableMapping
        :rtype: ~azure.mgmt.onlineexperimentation.models.PrivateLinkResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.onlineexperimentation.models.PrivateLinkResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
