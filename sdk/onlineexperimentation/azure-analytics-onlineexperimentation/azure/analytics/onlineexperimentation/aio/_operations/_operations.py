...
class OnlineExperimentationClientOperationsMixin(OnlineExperimentationClientMixinABC):  # pylint: disable=name-too-long
    ...
    async def get_metric(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.analytics.onlineexperimentation.models.ExperimentMetric
    ...
    async def create_or_update_metric(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.analytics.onlineexperimentation.models.ExperimentMetric
    ...
    async def create_or_update_metric(
        ...
        **kwargs: Any
        ...
        :param resource: The resource instance. Is one of the following types: ExperimentMetric, JSON,
         IO[bytes] Required.
        :type resource: ~azure.analytics.onlineexperimentation.models.ExperimentMetric or JSON or
         IO[bytes]
        :keyword if_unmodified_since: The request should only proceed if the entity was not modified
         after this time. Default value is None.
        :paramtype if_unmodified_since: ~datetime.datetime
    ...
    async def validate_metric(
        ...
        :type body: ~azure.analytics.onlineexperimentation.models.ExperimentMetric
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ExperimentMetricValidationResult. The ExperimentMetricValidationResult is compatible
         with MutableMapping
        :rtype: ~azure.analytics.onlineexperimentation.models.ExperimentMetricValidationResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def validate_metric(
        ...
        :type body: ~azure.analytics.onlineexperimentation.models.ExperimentMetric or JSON or IO[bytes]
        :return: ExperimentMetricValidationResult. The ExperimentMetricValidationResult is compatible
         with MutableMapping
        :rtype: ~azure.analytics.onlineexperimentation.models.ExperimentMetricValidationResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_metrics(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.analytics.onlineexperimentation.models.ExperimentMetric]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
