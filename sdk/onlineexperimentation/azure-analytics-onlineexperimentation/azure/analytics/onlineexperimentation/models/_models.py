...
class ExperimentMetricDefinition(_model_base.Model):
    ...
    :vartype type: str or ~azure.analytics.onlineexperimentation.models.ExperimentMetricType
    """
...
class ExperimentMetricValidationResult(_model_base.Model):
    ...
    :vartype diagnostics: list[~azure.analytics.onlineexperimentation.models.DiagnosticDetail]
    :ivar result: Indicates whether the experiment metric is valid. Required. Known values are:
     "Valid" and "Invalid".
    :vartype result: str or ~azure.analytics.onlineexperimentation.models.ValidationResult
    """
    ...
    result: Union[str, "_models.ValidationResult"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """Indicates whether the experiment metric is valid. Required. Known values are: \"Valid\" and
     \"Invalid\"."""
    ...
    def __init__(
        self,
        *,
        result: Union[str, "_models.ValidationResult"],
    ) -> None: ...
