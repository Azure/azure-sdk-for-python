...
def validate_metric():
    endpoint = os.environ["AZURE_ONLINE_EXPERIMENTATION_ENDPOINT"]
    ...
    try:
        ...
        validation_result = client.validate_metric("test_metric_id", metric_to_validate)
        ...
        if validation_result.result == "Valid":
            ...
            for error in validation_result.diagnostics:
