...
from azure.analytics.onlineexperimentation.aio import OnlineExperimentationClient
from azure.analytics.onlineexperimentation.models import *
...
class TestOnlineExperimentationAsync(OnlineExperimentationClientTestBaseAsync):
    ...
    async def test_create_or_update_metric(self, azure_online_experimentation_endpoint):
        """Test creating a new experiment metric"""
        client = self.create_async_client(endpoint=azure_online_experimentation_endpoint)
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy_async
    async def test_create_if_not_exists(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy_async
    async def test_reject_invalid_metric_definition(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy_async
    async def test_update_existing_metric(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy_async
    async def test_conditional_update_with_etag(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy_async
    async def test_conditional_update_etag_mismatch(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy_async
    async def test_list_metrics(self, azure_online_experimentation_endpoint):
        """Test listing all experiment metrics"""
        client = self.create_async_client(endpoint=azure_online_experimentation_endpoint)

        # Create a test metric first to ensure we have at least one
        await self._create_test_metric(client)

        # Get metrics
        metrics = []
        async for metric in client.list_metrics():
            metrics.append(metric)

        # Assert we have at least one metric
        assert len(metrics) >= 1

    @OnlineExperimentationPreparer()
    @recorded_by_proxy_async
    async def test_list_metrics_with_top(self, azure_online_experimentation_endpoint):
        ...
        max_results = 2
        metrics = []
        async for metric in client.list_metrics(top=max_results):
            metrics.append(metric)
            if len(metrics) > max_results * 2:
                break

        # Assert we don't exceed the max_results
        assert len(metrics) <= max_results

    @OnlineExperimentationPreparer()
    @recorded_by_proxy_async
    async def test_get_metric(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy_async
    async def test_get_non_existent_metric(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy_async
    async def test_validate_metric(self, azure_online_experimentation_endpoint):
        """Test validating a valid experiment metric"""
        client = self.create_async_client(endpoint=azure_online_experimentation_endpoint)

        metric_id = "test_validate_fixed_id"
        ...
        # Validate the metric
        response = await client.validate_metric(experiment_metric_id=metric_id, body=valid_metric)
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy_async
    async def test_validate_invalid_metric(self, azure_online_experimentation_endpoint):
        """Test validating an invalid experiment metric"""
        client = self.create_async_client(endpoint=azure_online_experimentation_endpoint)

        metric_id = "test_validate_invalid_fixed_id"
        invalid_metric = ExperimentMetric(
            lifecycle=LifecycleStage.ACTIVE,
            display_name="Invalid Test Metric",
        ...
        response = await client.validate_metric(experiment_metric_id=metric_id, body=invalid_metric)
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy_async
    async def test_delete_metric(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy_async
    async def test_conditional_delete_with_etag(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy_async
    async def test_conditional_delete_etag_mismatch(self, azure_online_experimentation_endpoint):
