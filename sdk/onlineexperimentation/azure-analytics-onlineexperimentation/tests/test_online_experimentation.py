...
class TestOnlineExperimentation(OnlineExperimentationClientTestBase):
    ...
    @recorded_by_proxy
    def test_create_or_update_metric(self, azure_online_experimentation_endpoint):
        """Test creating a new experiment metric"""
        client = self.create_client(endpoint=azure_online_experimentation_endpoint)
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy
    def test_create_if_not_exists(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy
    def test_reject_invalid_metric_definition(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy
    def test_update_existing_metric(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy
    def test_conditional_update_with_etag(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy
    def test_conditional_update_etag_mismatch(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy
    def test_list_metrics(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy
    def test_list_metrics_with_top(self, azure_online_experimentation_endpoint):
        ...
        max_results = 2
        metrics = list(client.list_metrics(top=max_results))[: max_results * 2]
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy
    def test_get_metric(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy
    def test_get_non_existent_metric(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy
    def test_validate_metric(self, azure_online_experimentation_endpoint):
        ...
        # Validate the metric
        response = client.validate_metric(experiment_metric_id=metric_id, body=valid_metric)
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy
    def test_validate_invalid_metric(self, azure_online_experimentation_endpoint):
        ...
        response = client.validate_metric(experiment_metric_id=metric_id, body=invalid_metric)
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy
    def test_delete_metric(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy
    def test_conditional_delete_with_etag(self, azure_online_experimentation_endpoint):
    ...
    @OnlineExperimentationPreparer()
    @recorded_by_proxy
    def test_conditional_delete_etag_mismatch(self, azure_online_experimentation_endpoint):
