...
class TestPowerPlatformMgmtPrivateEndpointConnectionsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_private_endpoint_connections_list_by_enterprise_policy(self, resource_group):
        response = self.client.private_endpoint_connections.list_by_enterprise_policy(
            resource_group_name=resource_group.name,
            enterprise_policy_name="str",
        )
