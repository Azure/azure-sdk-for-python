...
class KeyVaultClientOperationsMixin(object):
    ...
    def get_key_versions(
        ...
        if raw:
            header_dict = {}
        deserialized = models.KeyItemPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get_deleted_keys(
        ...
        if raw:
            header_dict = {}
        deserialized = models.DeletedKeyItemPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get_secrets(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SecretItemPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get_deleted_secrets(
        ...
        if raw:
            header_dict = {}
        deserialized = models.DeletedSecretItemPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get_certificates(
        ...
        if raw:
            header_dict = {}
        deserialized = models.CertificateItemPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get_certificate_issuers(
        ...
        if raw:
            header_dict = {}
        deserialized = models.CertificateIssuerItemPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get_deleted_certificates(
        ...
        if raw:
            header_dict = {}
        deserialized = models.DeletedCertificateItemPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get_storage_accounts(
        ...
        if raw:
            header_dict = {}
        deserialized = models.StorageAccountItemPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get_deleted_storage_accounts(
        ...
        if raw:
            header_dict = {}
        deserialized = models.DeletedStorageAccountItemPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get_sas_definitions(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SasDefinitionItemPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get_deleted_sas_definitions(
        ...
        if raw:
            header_dict = {}
        deserialized = models.DeletedSasDefinitionItemPaged(internal_paging, self._deserialize.dependencies, header_dict)
