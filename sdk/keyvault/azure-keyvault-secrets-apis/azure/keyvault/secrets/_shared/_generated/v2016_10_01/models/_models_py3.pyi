# Stubs for azure.keyvault.secrets._shared._generated.v2016_10_01.models._models_py3 (Python 3)
#
...
class IssuerParameters(Model):
    ...
    def __init__(self, *, name: str=..., certificate_type: str=..., **kwargs: Any) -> None: ...
...
class KeyProperties(Model):
    ...
    key_size: Any = ...
    reuse_key: Any = ...
    def __init__(self, *, exportable: bool=..., key_type: str=..., key_size: int=..., reuse_key: bool=..., **kwargs: Any) -> None: ...
...
class SasDefinitionCreateParameters(Model):
    ...
    tags: Any = ...
    def __init__(self, parameters: Any, *, sas_definition_attributes: Any=..., tags: Any=..., **kwargs: Any) -> None: ...
