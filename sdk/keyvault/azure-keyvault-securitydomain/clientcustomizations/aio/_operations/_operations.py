...
from ....keyvault import models as _keyvault_models4
...
class _SecurityDomainClientOperationsMixin(
    ...
    async def get_download_status(self, **kwargs: Any) -> _keyvault_models4.SecurityDomainOperationStatus:
        ...
        cls: ClsType[_keyvault_models4.SecurityDomainOperationStatus] = kwargs.pop("cls", None)
        ...
        if response.status_code not in [200]:
            ...
            error = _failsafe_deserialize(_models2.KeyVaultError, response.json())
            raise HttpResponseError(response=response, model=error)

        if _stream:
            deserialized = response.iter_bytes()
        else:
            deserialized = _deserialize(_keyvault_models4.SecurityDomainOperationStatus, response.json())
    ...
    async def _download_initial(
        self, certificate_info_object: Union[_keyvault_models4.CertificateInfo, JSON, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def _begin_download(
        self,
        certificate_info_object: _keyvault_models4.CertificateInfo,
        *,
    ...
    @distributed_trace_async
    async def get_upload_status(self, **kwargs: Any) -> _keyvault_models4.SecurityDomainOperationStatus:
    ...
    async def _upload_initial(
        self, security_domain: Union[_keyvault_models4.SecurityDomain, JSON, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def _begin_upload(
        self,
        security_domain: _keyvault_models4.SecurityDomain,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_keyvault_models4.SecurityDomainOperationStatus]: ...
    @overload
    async def _begin_upload(
    ...
    async def _begin_upload(
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~keyvault.models.SecurityDomainOperationStatus]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = kwargs.pop("params", {}) or {}
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_keyvault_models2.SecurityDomainOperationStatus].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_keyvault_models2.SecurityDomainOperationStatus](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    @distributed_trace_async
    async def get_transfer_key(self, **kwargs: Any) -> _keyvault_models4.TransferKey:
        ...
        cls: ClsType[_keyvault_models4.TransferKey] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_keyvault_models4.TransferKey, response.json())
