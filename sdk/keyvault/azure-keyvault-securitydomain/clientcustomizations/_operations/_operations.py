...
from ...keyvault import models as _keyvault_models3
...
class _SecurityDomainClientOperationsMixin(
    ...
    @distributed_trace
    def get_download_status(self, **kwargs: Any) -> _keyvault_models3.SecurityDomainOperationStatus:
        ...
        :return: SecurityDomainOperationStatus. The SecurityDomainOperationStatus is compatible with
         MutableMapping
        :rtype: ~keyvault.models.SecurityDomainOperationStatus
        ...
        cls: ClsType[_keyvault_models3.SecurityDomainOperationStatus] = kwargs.pop("cls", None)
        ...
        if response.status_code not in [200]:
            ...
            error = _failsafe_deserialize(_models1.KeyVaultError, response.json())
            raise HttpResponseError(response=response, model=error)

        if _stream:
            deserialized = response.iter_bytes()
        else:
            deserialized = _deserialize(_keyvault_models3.SecurityDomainOperationStatus, response.json())
    ...
    def _download_initial(
        self, certificate_info_object: Union[_keyvault_models3.CertificateInfo, JSON, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def _begin_download(
        self,
        certificate_info_object: _keyvault_models3.CertificateInfo,
        *,
    ...
    def _begin_download(
        ...
        :type certificate_info_object: ~keyvault.models.CertificateInfo or JSON or IO[bytes]
    ...
    @distributed_trace
    def get_upload_status(self, **kwargs: Any) -> _keyvault_models3.SecurityDomainOperationStatus:
    ...
    def _upload_initial(
        self, security_domain: Union[_keyvault_models3.SecurityDomain, JSON, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def _begin_upload(
        self,
        security_domain: _keyvault_models3.SecurityDomain,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_keyvault_models3.SecurityDomainOperationStatus]: ...
    @overload
    def _begin_upload(
    ...
    def _begin_upload(
        ...
        :type security_domain: ~keyvault.models.SecurityDomain or JSON or IO[bytes]
        ...
        :rtype: ~azure.core.polling.LROPoller[~keyvault.models.SecurityDomainOperationStatus]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = kwargs.pop("params", {}) or {}
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_keyvault_models2.SecurityDomainOperationStatus].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_keyvault_models2.SecurityDomainOperationStatus](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    @distributed_trace
    def get_transfer_key(self, **kwargs: Any) -> _keyvault_models3.TransferKey:
        """Retrieve Security Domain transfer key.

        :return: TransferKey. The TransferKey is compatible with MutableMapping
        :rtype: ~keyvault.models.TransferKey
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_keyvault_models3.TransferKey] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_keyvault_models3.TransferKey, response.json())
