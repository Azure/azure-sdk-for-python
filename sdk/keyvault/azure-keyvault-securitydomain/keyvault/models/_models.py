...
from ...clientcustomizations._utils.model_base import Model as _Model, rest_field
...
class CertificateInfo(_Model):
    ...
    :vartype certificates: list[~keyvault.models.SecurityDomainJsonWebKey]
...
class SecurityDomainOperationStatus(_Model):
    ...
    :vartype status: str or ~keyvault.models.OperationStatus
...
class TransferKey(_Model):
    ...
    :vartype transfer_key: ~keyvault.models.SecurityDomainJsonWebKey
    """
