...
class CertificateClientTests(KeyVaultTestCase):
    ...
    @KeyVaultPreparer()
    async def test_import_certificate_not_password_encoded_no_policy(self, azure_keyvault_url):
        client = self.create_client(azure_keyvault_url)
    ...
    @KeyVaultPreparer()
    async def test_import_certificate_password_encoded_no_policy(self, azure_keyvault_url):
        client = self.create_client(azure_keyvault_url)
