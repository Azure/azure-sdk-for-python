...
class CertificateClientTests(KeyVaultTestCase):
    ...
    def _import_common_certificate(self, client, cert_name):
        ...
        return client.import_certificate(
            certificate_name=cert_name, certificate_bytes=CertificateClientTests.CERT_CONTENT, policy=cert_policy, password=cert_password
        )
    ...
    @KeyVaultPreparer()
    @KeyVaultClientPreparer()
    def test_import_certificate_no_policy(self, client):
