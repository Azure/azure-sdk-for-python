...
class CertificateClientTests(KeyVaultTestCase):
    ...
    def _validate_certificate_list(self, original_certificates, returned_certificates):
        for cert in returned_certificates:
    ...
    def test_list(self, vault_client, **kwargs):
        ...
        self._validate_certificate_list(original_certificates=expected, returned_certificates=returned_certificates)
    ...
    def test_policy(self, vault_client, **kwargs):
        ...
        returned_policy = client.get_policy(certificate_name=cert_name)
        ...
        returned_policy = client.update_policy(certificate_name=cert_name, policy=cert_policy)
    ...
    def test_backup_restore(self, vault_client, **kwargs):
        ...
        self._validate_certificate_bundle(cert=restored_certificate, cert_name=cert_name, cert_policy=CertificatePolicy.get_default())
