...
async def run_sample():
    ...
    try:
        ...
        deleted_bank_certificate = await client.delete_certificate(certificate_name=bank_cert_name)
        ...
        await client.purge_deleted_certificate(certificate_name=storage_cert_name)
