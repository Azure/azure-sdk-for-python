...
namespace azure.keyvault.certificates
    ...
    class azure.keyvault.certificates.CertificatePolicy:
        ...
        property platform_managed: Optional[PlatformManaged]    # Read-only
        ...
        def __init__(
                ...
                *, 
                ...
                platform_managed: Union[PlatformManaged, None] = ..., 
    ...
    class azure.keyvault.certificates.PlatformManaged(_Model):
