...
class Action(_serialization.Model):
    ...
    :vartype action_type: str or ~azure.keyvault.certificates._generated_models.ActionType
    """
    ...
    def __init__(self, *, action_type: Optional[Union[str, "ActionType"]] = None, **kwargs: Any) -> None:
        """
        :keyword action_type: The type of the action. Known values are: "EmailContacts" and
         "AutoRenew".
        :paramtype action_type: str or ~azure.keyvault.certificates._generated_models.ActionType
        """
...
class CertificateAttributes(Attributes):
    ...
    :vartype recovery_level: str or ~azure.keyvault.certificates._generated_models.DeletionRecoveryLevel
    """
...
class CertificateBundle(_serialization.Model):
    ...
    :vartype policy: ~azure.keyvault.certificates._generated_models.CertificatePolicy
    ...
    :vartype attributes: ~azure.keyvault.certificates._generated_models.CertificateAttributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype attributes: ~azure.keyvault.certificates._generated_models.CertificateAttributes
...
class CertificateCreateParameters(_serialization.Model):
    ...
    :vartype certificate_policy: ~azure.keyvault.certificates._generated_models.CertificatePolicy
    :ivar certificate_attributes: The attributes of the certificate (optional).
    :vartype certificate_attributes: ~azure.keyvault.certificates._generated_models.CertificateAttributes
    :ivar tags: Application specific metadata in the form of key-value pairs.
    :vartype tags: dict[str, str]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype certificate_policy: ~azure.keyvault.certificates._generated_models.CertificatePolicy
        :keyword certificate_attributes: The attributes of the certificate (optional).
        :paramtype certificate_attributes: ~azure.keyvault.certificates._generated_models.CertificateAttributes
        :keyword tags: Application specific metadata in the form of key-value pairs.
        :paramtype tags: dict[str, str]
        """
        super().__init__(**kwargs)
...
class CertificateIssuerListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.keyvault.certificates._generated_models.CertificateIssuerItem]
...
class CertificateIssuerSetParameters(_serialization.Model):
    ...
    :vartype credentials: ~azure.keyvault.certificates._generated_models.IssuerCredentials
    :ivar organization_details: Details of the organization as provided to the issuer.
    :vartype organization_details: ~azure.keyvault.certificates._generated_models.OrganizationDetails
    :ivar attributes: Attributes of the issuer object.
    :vartype attributes: ~azure.keyvault.certificates._generated_models.IssuerAttributes
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype credentials: ~azure.keyvault.certificates._generated_models.IssuerCredentials
        :keyword organization_details: Details of the organization as provided to the issuer.
        :paramtype organization_details: ~azure.keyvault.certificates._generated_models.OrganizationDetails
        :keyword attributes: Attributes of the issuer object.
        :paramtype attributes: ~azure.keyvault.certificates._generated_models.IssuerAttributes
        """
        super().__init__(**kwargs)
        self.provider = provider
...
class CertificateListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.keyvault.certificates._generated_models.CertificateItem]
...
class CertificateOperation(_serialization.Model):
    ...
    :vartype issuer_parameters: ~azure.keyvault.certificates._generated_models.IssuerParameters
    ...
    :vartype error: ~azure.keyvault.certificates._generated_models.Error
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype issuer_parameters: ~azure.keyvault.certificates._generated_models.IssuerParameters
        ...
        :paramtype error: ~azure.keyvault.certificates._generated_models.Error
...
class CertificatePolicy(_serialization.Model):
    ...
    :vartype key_properties: ~azure.keyvault.certificates._generated_models.KeyProperties
    :ivar secret_properties: Properties of the secret backing a certificate.
    :vartype secret_properties: ~azure.keyvault.certificates._generated_models.SecretProperties
    :ivar x509_certificate_properties: Properties of the X509 component of a certificate.
    :vartype x509_certificate_properties: ~azure.keyvault.certificates._generated_models.X509CertificateProperties
    :ivar lifetime_actions: Actions that will be performed by Key Vault over the lifetime of a
     certificate.
    :vartype lifetime_actions: list[~azure.keyvault.certificates._generated_models.LifetimeAction]
    :ivar issuer_parameters: Parameters for the issuer of the X509 component of a certificate.
    :vartype issuer_parameters: ~azure.keyvault.certificates._generated_models.IssuerParameters
    :ivar attributes: The certificate attributes.
    :vartype attributes: ~azure.keyvault.certificates._generated_models.CertificateAttributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype key_properties: ~azure.keyvault.certificates._generated_models.KeyProperties
        :keyword secret_properties: Properties of the secret backing a certificate.
        :paramtype secret_properties: ~azure.keyvault.certificates._generated_models.SecretProperties
        :keyword x509_certificate_properties: Properties of the X509 component of a certificate.
        :paramtype x509_certificate_properties: ~azure.keyvault.certificates._generated_models.X509CertificateProperties
        :keyword lifetime_actions: Actions that will be performed by Key Vault over the lifetime of a
         certificate.
        :paramtype lifetime_actions: list[~azure.keyvault.certificates._generated_models.LifetimeAction]
        :keyword issuer_parameters: Parameters for the issuer of the X509 component of a certificate.
        :paramtype issuer_parameters: ~azure.keyvault.certificates._generated_models.IssuerParameters
        :keyword attributes: The certificate attributes.
        :paramtype attributes: ~azure.keyvault.certificates._generated_models.CertificateAttributes
...
class Contacts(_serialization.Model):
    ...
    :vartype contact_list: list[~azure.keyvault.certificates._generated_models.Contact]
    """
    ...
    def __init__(self, *, contact_list: Optional[List["Contact"]] = None, **kwargs: Any) -> None:
        """
        :keyword contact_list: The contact list for the vault certificates.
        :paramtype contact_list: list[~azure.keyvault.certificates._generated_models.Contact]
        """
        super().__init__(**kwargs)
        self.id = None
...
class DeletedCertificateListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.keyvault.certificates._generated_models.DeletedCertificateItem]
...
class Error(_serialization.Model):
    ...
    :vartype inner_error: ~azure.keyvault.certificates._generated_models.Error
    """
...
class KeyProperties(_serialization.Model):
    ...
    :vartype key_type: str or ~azure.keyvault.certificates._generated_models.JsonWebKeyType
    ...
    :vartype curve: str or ~azure.keyvault.certificates._generated_models.JsonWebKeyCurveName
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword key_type: The type of key pair to be used for the certificate. Known values are: "EC",
         "EC-HSM", "RSA", "RSA-HSM", "oct", and "oct-HSM".
        :paramtype key_type: str or ~azure.keyvault.certificates._generated_models.JsonWebKeyType
        ...
        :paramtype curve: str or ~azure.keyvault.certificates._generated_models.JsonWebKeyCurveName
        """
        super().__init__(**kwargs)
...
class LifetimeAction(_serialization.Model):
    ...
    :vartype trigger: ~azure.keyvault.certificates._generated_models.Trigger
    :ivar action: The action that will be executed.
    :vartype action: ~azure.keyvault.certificates._generated_models.Action
    """
    ...
    def __init__(
        self, *, trigger: Optional["Trigger"] = None, action: Optional["Action"] = None, **kwargs: Any
    ) -> None:
        """
        :keyword trigger: The condition that will execute the action.
        :paramtype trigger: ~azure.keyvault.certificates._generated_models.Trigger
        :keyword action: The action that will be executed.
        :paramtype action: ~azure.keyvault.certificates._generated_models.Action
        """
        super().__init__(**kwargs)
...
class OrganizationDetails(_serialization.Model):
    ...
    :vartype admin_details: list[~azure.keyvault.certificates._generated_models.AdministratorDetails]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype admin_details: list[~azure.keyvault.certificates._generated_models.AdministratorDetails]
        """
        super().__init__(**kwargs)
        self.id = id
...
class X509CertificateProperties(_serialization.Model):
    ...
    :vartype subject_alternative_names: ~azure.keyvault.certificates._generated_models.SubjectAlternativeNames
    :ivar key_usage: Defines how the certificate's key may be used.
    :vartype key_usage: list[str or ~azure.keyvault.certificates._generated_models.KeyUsageType]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype subject_alternative_names: ~azure.keyvault.certificates._generated_models.SubjectAlternativeNames
        :keyword key_usage: Defines how the certificate's key may be used.
        :paramtype key_usage: list[str or ~azure.keyvault.certificates._generated_models.KeyUsageType]
