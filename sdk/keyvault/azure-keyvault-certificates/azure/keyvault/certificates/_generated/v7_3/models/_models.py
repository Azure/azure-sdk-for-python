...
class Action(msrest.serialization.Model):
    ...
    :ivar action_type: The type of the action. Possible values include: "EmailContacts",
     "AutoRenew".
    :vartype action_type: str or ~azure.keyvault.v7_3.models.ActionType
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword action_type: The type of the action. Possible values include: "EmailContacts",
         "AutoRenew".
        :paramtype action_type: str or ~azure.keyvault.v7_3.models.ActionType
        """
...
class CertificateBundle(msrest.serialization.Model):
    ...
    :vartype policy: ~azure.keyvault.v7_3.models.CertificatePolicy
    ...
    :vartype attributes: ~azure.keyvault.v7_3.models.CertificateAttributes
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype attributes: ~azure.keyvault.v7_3.models.CertificateAttributes
...
class CertificateCreateParameters(msrest.serialization.Model):
    ...
    :vartype certificate_policy: ~azure.keyvault.v7_3.models.CertificatePolicy
    :ivar certificate_attributes: The attributes of the certificate (optional).
    :vartype certificate_attributes: ~azure.keyvault.v7_3.models.CertificateAttributes
    :ivar tags: A set of tags. Application specific metadata in the form of key-value pairs.
    :vartype tags: dict[str, str]
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype certificate_policy: ~azure.keyvault.v7_3.models.CertificatePolicy
        :keyword certificate_attributes: The attributes of the certificate (optional).
        :paramtype certificate_attributes: ~azure.keyvault.v7_3.models.CertificateAttributes
        :keyword tags: A set of tags. Application specific metadata in the form of key-value pairs.
        :paramtype tags: dict[str, str]
        """
...
class CertificateIssuerListResult(msrest.serialization.Model):
    ...
    :vartype value: list[~azure.keyvault.v7_3.models.CertificateIssuerItem]
...
class CertificateIssuerSetParameters(msrest.serialization.Model):
    ...
    :vartype credentials: ~azure.keyvault.v7_3.models.IssuerCredentials
    :ivar organization_details: Details of the organization as provided to the issuer.
    :vartype organization_details: ~azure.keyvault.v7_3.models.OrganizationDetails
    :ivar attributes: Attributes of the issuer object.
    :vartype attributes: ~azure.keyvault.v7_3.models.IssuerAttributes
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype credentials: ~azure.keyvault.v7_3.models.IssuerCredentials
        :keyword organization_details: Details of the organization as provided to the issuer.
        :paramtype organization_details: ~azure.keyvault.v7_3.models.OrganizationDetails
        :keyword attributes: Attributes of the issuer object.
        :paramtype attributes: ~azure.keyvault.v7_3.models.IssuerAttributes
        """
...
class CertificateListResult(msrest.serialization.Model):
    ...
    :vartype value: list[~azure.keyvault.v7_3.models.CertificateItem]
...
class CertificateOperation(msrest.serialization.Model):
    ...
    :vartype issuer_parameters: ~azure.keyvault.v7_3.models.IssuerParameters
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype issuer_parameters: ~azure.keyvault.v7_3.models.IssuerParameters
...
class CertificatePolicy(msrest.serialization.Model):
    ...
    :vartype key_properties: ~azure.keyvault.v7_3.models.KeyProperties
    :ivar secret_properties: Properties of the secret backing a certificate.
    :vartype secret_properties: ~azure.keyvault.v7_3.models.SecretProperties
    :ivar x509_certificate_properties: Properties of the X509 component of a certificate.
    :vartype x509_certificate_properties: ~azure.keyvault.v7_3.models.X509CertificateProperties
    :ivar lifetime_actions: Actions that will be performed by Key Vault over the lifetime of a
     certificate.
    :vartype lifetime_actions: list[~azure.keyvault.v7_3.models.LifetimeAction]
    :ivar issuer_parameters: Parameters for the issuer of the X509 component of a certificate.
    :vartype issuer_parameters: ~azure.keyvault.v7_3.models.IssuerParameters
    :ivar attributes: The certificate attributes.
    :vartype attributes: ~azure.keyvault.v7_3.models.CertificateAttributes
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype key_properties: ~azure.keyvault.v7_3.models.KeyProperties
        :keyword secret_properties: Properties of the secret backing a certificate.
        :paramtype secret_properties: ~azure.keyvault.v7_3.models.SecretProperties
        :keyword x509_certificate_properties: Properties of the X509 component of a certificate.
        :paramtype x509_certificate_properties: ~azure.keyvault.v7_3.models.X509CertificateProperties
        :keyword lifetime_actions: Actions that will be performed by Key Vault over the lifetime of a
         certificate.
        :paramtype lifetime_actions: list[~azure.keyvault.v7_3.models.LifetimeAction]
        :keyword issuer_parameters: Parameters for the issuer of the X509 component of a certificate.
        :paramtype issuer_parameters: ~azure.keyvault.v7_3.models.IssuerParameters
        :keyword attributes: The certificate attributes.
        :paramtype attributes: ~azure.keyvault.v7_3.models.CertificateAttributes
...
class Contacts(msrest.serialization.Model):
    ...
    :vartype contact_list: list[~azure.keyvault.v7_3.models.Contact]
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype contact_list: list[~azure.keyvault.v7_3.models.Contact]
        """
...
class DeletedCertificateListResult(msrest.serialization.Model):
    ...
    :vartype value: list[~azure.keyvault.v7_3.models.DeletedCertificateItem]
...
class LifetimeAction(msrest.serialization.Model):
    ...
    :vartype trigger: ~azure.keyvault.v7_3.models.Trigger
    :ivar action: The action that will be executed.
    :vartype action: ~azure.keyvault.v7_3.models.Action
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype trigger: ~azure.keyvault.v7_3.models.Trigger
        :keyword action: The action that will be executed.
        :paramtype action: ~azure.keyvault.v7_3.models.Action
        """
...
class OrganizationDetails(msrest.serialization.Model):
    ...
    :vartype admin_details: list[~azure.keyvault.v7_3.models.AdministratorDetails]
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype admin_details: list[~azure.keyvault.v7_3.models.AdministratorDetails]
        """
...
class X509CertificateProperties(msrest.serialization.Model):
    ...
    :vartype subject_alternative_names: ~azure.keyvault.v7_3.models.SubjectAlternativeNames
    :ivar key_usage: List of key usages.
    :vartype key_usage: list[str or ~azure.keyvault.v7_3.models.KeyUsageType]
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype subject_alternative_names: ~azure.keyvault.v7_3.models.SubjectAlternativeNames
        :keyword key_usage: List of key usages.
        :paramtype key_usage: list[str or ~azure.keyvault.v7_3.models.KeyUsageType]
