...
class Action(_serialization.Model):
    ...
    :vartype action_type: str or ~azure.keyvault.v7_4.models.ActionType
    """
    ...
    def __init__(self, *, action_type: Optional[Union[str, "_models.ActionType"]] = None, **kwargs: Any) -> None:
        ...
        :keyword action_type: The type of the action. Known values are: "EmailContacts" and
         "AutoRenew".
        :paramtype action_type: str or ~azure.keyvault.v7_4.models.ActionType
        """
...
class CertificateBundle(_serialization.Model):
    ...
    :vartype policy: ~azure.keyvault.v7_4.models.CertificatePolicy
    ...
    :vartype attributes: ~azure.keyvault.v7_4.models.CertificateAttributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype attributes: ~azure.keyvault.v7_4.models.CertificateAttributes
...
class CertificateCreateParameters(_serialization.Model):
    ...
    :vartype certificate_policy: ~azure.keyvault.v7_4.models.CertificatePolicy
    :ivar certificate_attributes: The attributes of the certificate (optional).
    :vartype certificate_attributes: ~azure.keyvault.v7_4.models.CertificateAttributes
    :ivar tags: Application specific metadata in the form of key-value pairs.
    :vartype tags: dict[str, str]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype certificate_policy: ~azure.keyvault.v7_4.models.CertificatePolicy
        :keyword certificate_attributes: The attributes of the certificate (optional).
        :paramtype certificate_attributes: ~azure.keyvault.v7_4.models.CertificateAttributes
        :keyword tags: Application specific metadata in the form of key-value pairs.
        :paramtype tags: dict[str, str]
        """
        super().__init__(**kwargs)
...
class CertificateIssuerListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.keyvault.v7_4.models.CertificateIssuerItem]
...
class CertificateIssuerSetParameters(_serialization.Model):
    ...
    :vartype credentials: ~azure.keyvault.v7_4.models.IssuerCredentials
    :ivar organization_details: Details of the organization as provided to the issuer.
    :vartype organization_details: ~azure.keyvault.v7_4.models.OrganizationDetails
    :ivar attributes: Attributes of the issuer object.
    :vartype attributes: ~azure.keyvault.v7_4.models.IssuerAttributes
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype credentials: ~azure.keyvault.v7_4.models.IssuerCredentials
        :keyword organization_details: Details of the organization as provided to the issuer.
        :paramtype organization_details: ~azure.keyvault.v7_4.models.OrganizationDetails
        :keyword attributes: Attributes of the issuer object.
        :paramtype attributes: ~azure.keyvault.v7_4.models.IssuerAttributes
        """
        super().__init__(**kwargs)
        self.provider = provider
...
class CertificateListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.keyvault.v7_4.models.CertificateItem]
...
class CertificateOperation(_serialization.Model):
    ...
    :vartype issuer_parameters: ~azure.keyvault.v7_4.models.IssuerParameters
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype issuer_parameters: ~azure.keyvault.v7_4.models.IssuerParameters
...
class CertificatePolicy(_serialization.Model):
    ...
    :vartype key_properties: ~azure.keyvault.v7_4.models.KeyProperties
    :ivar secret_properties: Properties of the secret backing a certificate.
    :vartype secret_properties: ~azure.keyvault.v7_4.models.SecretProperties
    :ivar x509_certificate_properties: Properties of the X509 component of a certificate.
    :vartype x509_certificate_properties: ~azure.keyvault.v7_4.models.X509CertificateProperties
    :ivar lifetime_actions: Actions that will be performed by Key Vault over the lifetime of a
     certificate.
    :vartype lifetime_actions: list[~azure.keyvault.v7_4.models.LifetimeAction]
    :ivar issuer_parameters: Parameters for the issuer of the X509 component of a certificate.
    :vartype issuer_parameters: ~azure.keyvault.v7_4.models.IssuerParameters
    :ivar attributes: The certificate attributes.
    :vartype attributes: ~azure.keyvault.v7_4.models.CertificateAttributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype key_properties: ~azure.keyvault.v7_4.models.KeyProperties
        :keyword secret_properties: Properties of the secret backing a certificate.
        :paramtype secret_properties: ~azure.keyvault.v7_4.models.SecretProperties
        :keyword x509_certificate_properties: Properties of the X509 component of a certificate.
        :paramtype x509_certificate_properties: ~azure.keyvault.v7_4.models.X509CertificateProperties
        :keyword lifetime_actions: Actions that will be performed by Key Vault over the lifetime of a
         certificate.
        :paramtype lifetime_actions: list[~azure.keyvault.v7_4.models.LifetimeAction]
        :keyword issuer_parameters: Parameters for the issuer of the X509 component of a certificate.
        :paramtype issuer_parameters: ~azure.keyvault.v7_4.models.IssuerParameters
        :keyword attributes: The certificate attributes.
        :paramtype attributes: ~azure.keyvault.v7_4.models.CertificateAttributes
...
class Contacts(_serialization.Model):
    ...
    :vartype contact_list: list[~azure.keyvault.v7_4.models.Contact]
    """
    ...
    def __init__(self, *, contact_list: Optional[List["_models.Contact"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype contact_list: list[~azure.keyvault.v7_4.models.Contact]
        """
        super().__init__(**kwargs)
        self.id = None
...
class DeletedCertificateListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.keyvault.v7_4.models.DeletedCertificateItem]
...
class LifetimeAction(_serialization.Model):
    ...
    :vartype trigger: ~azure.keyvault.v7_4.models.Trigger
    :ivar action: The action that will be executed.
    :vartype action: ~azure.keyvault.v7_4.models.Action
    """
    ...
    def __init__(
        ...
        :paramtype trigger: ~azure.keyvault.v7_4.models.Trigger
        :keyword action: The action that will be executed.
        :paramtype action: ~azure.keyvault.v7_4.models.Action
        """
        super().__init__(**kwargs)
...
class OrganizationDetails(_serialization.Model):
    ...
    :vartype admin_details: list[~azure.keyvault.v7_4.models.AdministratorDetails]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype admin_details: list[~azure.keyvault.v7_4.models.AdministratorDetails]
        """
        super().__init__(**kwargs)
        self.id = id
...
class X509CertificateProperties(_serialization.Model):
    ...
    :vartype subject_alternative_names: ~azure.keyvault.v7_4.models.SubjectAlternativeNames
    :ivar key_usage: Defines how the certificate's key may be used.
    :vartype key_usage: list[str or ~azure.keyvault.v7_4.models.KeyUsageType]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype subject_alternative_names: ~azure.keyvault.v7_4.models.SubjectAlternativeNames
        :keyword key_usage: Defines how the certificate's key may be used.
        :paramtype key_usage: list[str or ~azure.keyvault.v7_4.models.KeyUsageType]
