...
class Action(_serialization.Model):
    ...
    :vartype action_type: str or ~key_vault_client.models.ActionType
    """
    ...
    def __init__(self, *, action_type: Optional[Union[str, "_models.ActionType"]] = None, **kwargs: Any) -> None:
        ...
        :keyword action_type: The type of the action. Known values are: "EmailContacts" and
         "AutoRenew".
        :paramtype action_type: str or ~key_vault_client.models.ActionType
        """
...
class CertificateBundle(_serialization.Model):
    ...
    :vartype policy: ~key_vault_client.models.CertificatePolicy
    ...
    :vartype attributes: ~key_vault_client.models.CertificateAttributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype attributes: ~key_vault_client.models.CertificateAttributes
...
class CertificateCreateParameters(_serialization.Model):
    ...
    :vartype certificate_policy: ~key_vault_client.models.CertificatePolicy
    :ivar certificate_attributes: The attributes of the certificate (optional).
    :vartype certificate_attributes: ~key_vault_client.models.CertificateAttributes
    :ivar tags: Application specific metadata in the form of key-value pairs.
    :vartype tags: dict[str, str]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype certificate_policy: ~key_vault_client.models.CertificatePolicy
        :keyword certificate_attributes: The attributes of the certificate (optional).
        :paramtype certificate_attributes: ~key_vault_client.models.CertificateAttributes
        :keyword tags: Application specific metadata in the form of key-value pairs.
        :paramtype tags: dict[str, str]
        """
        super().__init__(**kwargs)
...
class CertificateIssuerListResult(_serialization.Model):
    ...
    :vartype value: list[~key_vault_client.models.CertificateIssuerItem]
...
class CertificateIssuerSetParameters(_serialization.Model):
    ...
    :vartype credentials: ~key_vault_client.models.IssuerCredentials
    :ivar organization_details: Details of the organization as provided to the issuer.
    :vartype organization_details: ~key_vault_client.models.OrganizationDetails
    :ivar attributes: Attributes of the issuer object.
    :vartype attributes: ~key_vault_client.models.IssuerAttributes
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype credentials: ~key_vault_client.models.IssuerCredentials
        :keyword organization_details: Details of the organization as provided to the issuer.
        :paramtype organization_details: ~key_vault_client.models.OrganizationDetails
        :keyword attributes: Attributes of the issuer object.
        :paramtype attributes: ~key_vault_client.models.IssuerAttributes
        """
        super().__init__(**kwargs)
        self.provider = provider
...
class CertificateListResult(_serialization.Model):
    ...
    :vartype value: list[~key_vault_client.models.CertificateItem]
...
class CertificateOperation(_serialization.Model):
    ...
    :vartype issuer_parameters: ~key_vault_client.models.IssuerParameters
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype issuer_parameters: ~key_vault_client.models.IssuerParameters
...
class CertificatePolicy(_serialization.Model):
    ...
    :vartype key_properties: ~key_vault_client.models.KeyProperties
    :ivar secret_properties: Properties of the secret backing a certificate.
    :vartype secret_properties: ~key_vault_client.models.SecretProperties
    :ivar x509_certificate_properties: Properties of the X509 component of a certificate.
    :vartype x509_certificate_properties: ~key_vault_client.models.X509CertificateProperties
    :ivar lifetime_actions: Actions that will be performed by Key Vault over the lifetime of a
     certificate.
    :vartype lifetime_actions: list[~key_vault_client.models.LifetimeAction]
    :ivar issuer_parameters: Parameters for the issuer of the X509 component of a certificate.
    :vartype issuer_parameters: ~key_vault_client.models.IssuerParameters
    :ivar attributes: The certificate attributes.
    :vartype attributes: ~key_vault_client.models.CertificateAttributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype key_properties: ~key_vault_client.models.KeyProperties
        :keyword secret_properties: Properties of the secret backing a certificate.
        :paramtype secret_properties: ~key_vault_client.models.SecretProperties
        :keyword x509_certificate_properties: Properties of the X509 component of a certificate.
        :paramtype x509_certificate_properties: ~key_vault_client.models.X509CertificateProperties
        :keyword lifetime_actions: Actions that will be performed by Key Vault over the lifetime of a
         certificate.
        :paramtype lifetime_actions: list[~key_vault_client.models.LifetimeAction]
        :keyword issuer_parameters: Parameters for the issuer of the X509 component of a certificate.
        :paramtype issuer_parameters: ~key_vault_client.models.IssuerParameters
        :keyword attributes: The certificate attributes.
        :paramtype attributes: ~key_vault_client.models.CertificateAttributes
...
class Contacts(_serialization.Model):
    ...
    :vartype contact_list: list[~key_vault_client.models.Contact]
    """
    ...
    def __init__(self, *, contact_list: Optional[List["_models.Contact"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype contact_list: list[~key_vault_client.models.Contact]
        """
        super().__init__(**kwargs)
        self.id = None
...
class DeletedCertificateListResult(_serialization.Model):
    ...
    :vartype value: list[~key_vault_client.models.DeletedCertificateItem]
...
class KeyProperties(_serialization.Model):
    ...
    :vartype key_type: str or ~key_vault_client.models.JsonWebKeyType
    ...
    :vartype curve: str or ~key_vault_client.models.JsonWebKeyCurveName
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword key_type: The type of key pair to be used for the certificate. Known values are: "EC",
         "EC-HSM", "RSA", "RSA-HSM", "oct", and "oct-HSM".
        :paramtype key_type: str or ~key_vault_client.models.JsonWebKeyType
        ...
        :paramtype curve: str or ~key_vault_client.models.JsonWebKeyCurveName
        """
        super().__init__(**kwargs)
...
class LifetimeAction(_serialization.Model):
    ...
    :vartype trigger: ~key_vault_client.models.Trigger
    :ivar action: The action that will be executed.
    :vartype action: ~key_vault_client.models.Action
    """
    ...
    def __init__(
        ...
        :paramtype trigger: ~key_vault_client.models.Trigger
        :keyword action: The action that will be executed.
        :paramtype action: ~key_vault_client.models.Action
        """
        super().__init__(**kwargs)
...
class OrganizationDetails(_serialization.Model):
    ...
    :vartype admin_details: list[~key_vault_client.models.AdministratorDetails]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype admin_details: list[~key_vault_client.models.AdministratorDetails]
        """
        super().__init__(**kwargs)
        self.id = id
...
class X509CertificateProperties(_serialization.Model):
    ...
    :vartype subject_alternative_names: ~key_vault_client.models.SubjectAlternativeNames
    :ivar key_usage: Defines how the certificate's key may be used.
    :vartype key_usage: list[str or ~key_vault_client.models.KeyUsageType]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype subject_alternative_names: ~key_vault_client.models.SubjectAlternativeNames
        :keyword key_usage: Defines how the certificate's key may be used.
        :paramtype key_usage: list[str or ~key_vault_client.models.KeyUsageType]
