...
async def run_sample():
    ...
    try:
        ...
        print("\n.. Delete a Secret")
        secret = await client.delete_secret(bank_secret.properties.name)
        ...
        recovered_secret = await client.recover_deleted_secret(bank_secret.properties.name)
        print("Recovered Secret with name '{0}'.".format(recovered_secret.name))

        # Let's delete storage account now.
        # If the keyvault is soft-delete enabled, then for permanent deletion deleted secret needs to be purged.
        await client.delete_secret(storage_secret.properties.name)
        ...
        await client.purge_deleted_secret(storage_secret.properties.name)
