...
from azure.keyvault.secrets._shared import AsyncChallengeAuthPolicy, HttpChallengeCache
...
async def test_rejected_challenge_is_not_cached():
    url = "https://example.net/secrets/canary"
    challenge = Mock(
        status_code=401,
...
@empty_challenge_cache
@pytest.mark.parametrize("token_type", TOKEN_TYPES)
async def test_tenant_dstsv2(token_type):
