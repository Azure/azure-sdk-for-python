...
class KeyVaultClientOperationsMixin(KeyVaultClientMixinABC):
    ...
    def get_secrets(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~key_vault_client.models.SecretItem]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get_deleted_secrets(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~key_vault_client.models.DeletedSecretItem]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
