...
class KeyVaultClientOperationsMixin(KeyVaultClientMixinABC):
    ...
    def get_deleted_secrets(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.keyvault.secrets._generated.models.DeletedSecretItem]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def roll_secret(
        ...
        **kwargs: Any,
        ...
        if enabled is not None or not_before is not None or expires_on is not None:
            attributes = _models.SecretAttributes(
                enabled=enabled, not_before=not_before, expires=expires_on
            )
        else:
            attributes = None

        parameters = _models.RollSecretParametersObject(
            tags=tags,
            content_type=content_type,
