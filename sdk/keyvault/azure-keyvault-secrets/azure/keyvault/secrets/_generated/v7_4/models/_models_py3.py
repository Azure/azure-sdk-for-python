...
class SecretBundle(_serialization.Model):
    ...
    :vartype attributes: ~azure.keyvault.v7_4.models.SecretAttributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype attributes: ~azure.keyvault.v7_4.models.SecretAttributes
...
class DeletedSecretListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.keyvault.v7_4.models.DeletedSecretItem]
...
class SecretListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.keyvault.v7_4.models.SecretItem]
...
class SecretSetParameters(_serialization.Model):
    ...
    :vartype secret_attributes: ~azure.keyvault.v7_4.models.SecretAttributes
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype secret_attributes: ~azure.keyvault.v7_4.models.SecretAttributes
        """
        super().__init__(**kwargs)
        self.value = value
        self.tags = tags
