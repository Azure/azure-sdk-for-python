...
async def run_sample():
    ...
    try:
        ...
        print("\n2. Delete a Secret")
        secret = await client.delete_secret("bankSecretName")
        ...
        recovered_secret = await client.recover_deleted_secret("bankSecretName")
        ...
        await client.purge_deleted_secret("storageSecretName")
