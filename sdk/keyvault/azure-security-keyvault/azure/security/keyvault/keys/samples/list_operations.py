...
def run_sample():
    ...
    try:
        ...
        print("\n1. Create Key")
        rsa_key = client.create_rsa_key("rsaKeyName2", hsm=False)
        ec_key = client.create_ec_key("ecKeyName2", hsm=True)
        ...
        updated_key = client.create_rsa_key(rsa_key.name, hsm=True)
        print(
