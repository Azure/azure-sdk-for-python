# Stubs for azure.keyvault.keys._shared._generated.v7_0.operations._key_vault_client_operations (Python 3)
#
...
class KeyVaultClientOperationsMixin:
    ...
    def backup_certificate(self, vault_base_url: Any, certificate_name: Any, cls: Optional[Any] = ..., **kwargs: Any): ...
    def restore_certificate(self, vault_base_url: Any, certificate_bundle_backup: Any, cls: Optional[Any] = ..., **kwargs: Any): ...
    ...
    def get_deleted_storage_account(self, vault_base_url: Any, storage_account_name: Any, cls: Optional[Any] = ..., **kwargs: Any): ...
    def purge_deleted_storage_account(self, vault_base_url: Any, storage_account_name: Any, cls: Optional[Any] = ..., **kwargs: Any): ...
    def recover_deleted_storage_account(self, vault_base_url: Any, storage_account_name: Any, cls: Optional[Any] = ..., **kwargs: Any): ...
    def backup_storage_account(self, vault_base_url: Any, storage_account_name: Any, cls: Optional[Any] = ..., **kwargs: Any): ...
    def restore_storage_account(self, vault_base_url: Any, storage_bundle_backup: Any, cls: Optional[Any] = ..., **kwargs: Any): ...
    ...
    def get_deleted_sas_definition(self, vault_base_url: Any, storage_account_name: Any, sas_definition_name: Any, cls: Optional[Any] = ..., **kwargs: Any): ...
    def recover_deleted_sas_definition(self, vault_base_url: Any, storage_account_name: Any, sas_definition_name: Any, cls: Optional[Any] = ..., **kwargs: Any): ...
    ...
    def set_sas_definition(self, vault_base_url: Any, storage_account_name: Any, sas_definition_name: Any, template_uri: Any, sas_type: Any, validity_period: Any, sas_definition_attributes: Optional[Any] = ..., tags: Optional[Any] = ..., cls: Optional[Any] = ..., **kwargs: Any): ...
    def update_sas_definition(self, vault_base_url: Any, storage_account_name: Any, sas_definition_name: Any, template_uri: Optional[Any] = ..., sas_type: Optional[Any] = ..., validity_period: Optional[Any] = ..., sas_definition_attributes: Optional[Any] = ..., tags: Optional[Any] = ..., cls: Optional[Any] = ..., **kwargs: Any): ...
