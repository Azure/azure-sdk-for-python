...
class KeyClientTests(KeysTestCase, KeyVaultTestCase):
    ...
    def test_key_crud_operations(self, **kwargs):
        ...
        client = self.create_key_client(endpoint_url, **kwargs)
    ...
    def test_logging_enabled(self, **kwargs):
        ...
        client = self.create_key_client(endpoint_url, logging_enable=True, **kwargs)
    ...
    def test_logging_disabled(self, **kwargs):
        ...
        client = self.create_key_client(endpoint_url, logging_enable=False, **kwargs)
        mock_handler = MockHandler()
