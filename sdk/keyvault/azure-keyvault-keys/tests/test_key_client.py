...
class TestKeyClient(KeyVaultTestCase, KeysTestCase):
    ...
    def test_key_size(self, client, is_hsm, **kwargs):
        ...
        ec_key = self._create_ec_key(client, ec_key_name, hardware_protected=is_hsm)
        ...
        oct_key_128 = self._create_oct_key(client, oct_key_128_name, size=128, hardware_protected=True)
