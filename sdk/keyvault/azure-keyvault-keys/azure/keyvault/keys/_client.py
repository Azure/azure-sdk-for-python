...
from ._models import DeletedKey, KeyVaultKey, KeyProperties, KeyReleaseResult
...
class KeyClient(KeyVaultClientBase):
    ...
    @distributed_trace
    def release_key(self, name, target, version, **kwargs):
        # type: (str, str, str, **Any) -> KeyReleaseResult
        """Releases a key.
