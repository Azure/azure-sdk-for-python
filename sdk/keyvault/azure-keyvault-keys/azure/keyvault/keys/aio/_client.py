...
from .._models import DeletedKey, Key, KeyProperties
...
class KeyClient(AsyncKeyVaultClientBase):
    ...
    def get_cryptography_client(self, key: Union[KeyVaultKey, str], **kwargs: Any) -> CryptographyClient:
        """
    ...
    @distributed_trace_async
    async def restore_key(self, backup: bytes, **kwargs: "**Any") -> KeyVaultKey:
