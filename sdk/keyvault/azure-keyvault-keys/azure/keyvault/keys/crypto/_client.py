...
from . import DecryptResult, EncryptionAlgorithmConfiguration, EncryptResult, SignResult, VerifyResult, UnwrapResult, WrapResult
...
class CryptographyClient(KeyVaultClientBase):
    ...
    def decrypt(self, algorithm, ciphertext, **kwargs):
        # type: (Union[EncryptionAlgorithm, EncryptionAlgorithmConfiguration], bytes, **Any) -> DecryptResult
