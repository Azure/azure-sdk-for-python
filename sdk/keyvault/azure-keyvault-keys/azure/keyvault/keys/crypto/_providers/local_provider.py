...
class LocalCryptographyProvider(ABC):
    ...
    def encrypt(self, algorithm, plaintext, iv=None):
        ...
        return EncryptResult(key_id=self._key.kid, algorithm=algorithm, ciphertext=ciphertext, iv=iv)  # type: ignore[attr-defined]
    ...
    def decrypt(self, algorithm, ciphertext, iv=None):
        ...
        return DecryptResult(key_id=self._key.kid, algorithm=algorithm, plaintext=plaintext)  # type: ignore[attr-defined]
    ...
    def wrap_key(self, algorithm, key):
        ...
        return WrapResult(key_id=self._key.kid, algorithm=algorithm, encrypted_key=encrypted_key)  # type: ignore[attr-defined]
