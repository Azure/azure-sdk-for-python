...
class KeyVaultClientOperationsMixin(KeyVaultClientMixinABC):  # pylint: disable=too-many-public-methods
        ...
        Example:
            .. code-block:: python
                ...
                response == {
                    ...
                    "key": {
                        "crv": "str",
                        "d": bytes("bytes", encoding="utf-8"),
                        "dp": bytes("bytes", encoding="utf-8"),
                        "dq": bytes("bytes", encoding="utf-8"),
                        "e": bytes("bytes", encoding="utf-8"),
                        "k": bytes("bytes", encoding="utf-8"),
                        "key_hsm": bytes("bytes", encoding="utf-8"),
                        "key_ops": [
                            "str"
                        ],
                        "kid": "str",
                        "kty": "str",
                        "n": bytes("bytes", encoding="utf-8"),
                        "p": bytes("bytes", encoding="utf-8"),
                        "q": bytes("bytes", encoding="utf-8"),
                        "qi": bytes("bytes", encoding="utf-8"),
                        "x": bytes("bytes", encoding="utf-8"),
                        "y": bytes("bytes", encoding="utf-8")
                    },
                    "managed": bool,
                    "release_policy": {
                        "contentType": "str",
    ...
    async def create_key(
        ...
        if response.status_code not in [200]:
            ...
            error = _deserialize(_models.KeyVaultError, response.json())
        ...
        Example:
            .. code-block:: python
                ...
                response == {
                    ...
                    "deletedDate": "2020-02-20 00:00:00",
                    "key": {
                        "crv": "str",
                        "d": bytes("bytes", encoding="utf-8"),
                        "dp": bytes("bytes", encoding="utf-8"),
        ...
        Example:
            .. code-block:: python
                ...
                parameters = {
                    "alg": "str",
                    "value": bytes("bytes", encoding="utf-8"),
                    "aad": bytes("bytes", encoding="utf-8"),
                    "iv": bytes("bytes", encoding="utf-8"),
                    "tag": bytes("bytes", encoding="utf-8")
                }
    ...
    def get_deleted_keys(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.keyvault.keys._generated.models.DeletedKeyItem]
        :raises ~azure.core.exceptions.HttpResponseError:
