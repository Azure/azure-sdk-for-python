...
class KeyBundle(msrest.serialization.Model):
    ...
    :type key: ~azure.keyvault.v7_3.models.JsonWebKey
    :param attributes: The key management attributes.
    :type attributes: ~azure.keyvault.v7_3.models.KeyAttributes
    ...
    :type release_policy: ~azure.keyvault.v7_3.models.KeyReleasePolicy
    """
...
class JsonWebKey(msrest.serialization.Model):
    ...
    :type crv: str or ~azure.keyvault.v7_3.models.JsonWebKeyCurveName
...
class KeyCreateParameters(msrest.serialization.Model):
    ...
    :param key_ops:
    :type key_ops: list[str or ~azure.keyvault.v7_3.models.JsonWebKeyOperation]
    :param key_attributes: The attributes of a key managed by the key vault service.
    :type key_attributes: ~azure.keyvault.v7_3.models.KeyAttributes
    :param tags: A set of tags. Application specific metadata in the form of key-value pairs.
    :type tags: dict[str, str]
    :param curve: Elliptic curve name. For valid values, see JsonWebKeyCurveName. Possible values
     include: "P-256", "P-384", "P-521", "P-256K".
    :type curve: str or ~azure.keyvault.v7_3.models.JsonWebKeyCurveName
    :param release_policy: The policy rules under which the key can be exported.
    :type release_policy: ~azure.keyvault.v7_3.models.KeyReleasePolicy
    """
...
class KeyProperties(msrest.serialization.Model):
    ...
    :type key_type: str or ~azure.keyvault.v7_3.models.JsonWebKeyType
    :param key_size: The key size in bits. For example: 2048, 3072, or 4096 for RSA.
    :type key_size: int
...
class KeyReleasePolicy(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        content_type: Optional[str] = "application/json; charset=utf-8; version=1.0",
...
class KeySignParameters(msrest.serialization.Model):
    ...
    :param algorithm: Required. The signing/verification algorithm identifier. For more information
     ...
     "ES256K".
    :type algorithm: str or ~azure.keyvault.v7_3.models.JsonWebKeySignatureAlgorithm
    :param value: Required.
    :type value: bytes
    """
