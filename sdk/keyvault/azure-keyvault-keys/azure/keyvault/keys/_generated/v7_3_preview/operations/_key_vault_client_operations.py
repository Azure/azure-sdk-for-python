...
def build_rotate_key_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/keys/{key-name}/rotate')
    path_format_arguments = {
        "key-name": _SERIALIZER.url("key_name", key_name, 'str', pattern=r'^[0-9a-zA-Z-]+$'),
    }
...
def build_release_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/keys/{key-name}/{key-version}/release')
    path_format_arguments = {
        "key-name": _SERIALIZER.url("key_name", key_name, 'str'),
        "key-version": _SERIALIZER.url("key_version", key_version, 'str'),
    }
...
def build_get_key_rotation_policy_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/keys/{key-name}/rotationpolicy')
    path_format_arguments = {
        "key-name": _SERIALIZER.url("key_name", key_name, 'str'),
    }
...
def build_get_random_bytes_request(
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/rng')
