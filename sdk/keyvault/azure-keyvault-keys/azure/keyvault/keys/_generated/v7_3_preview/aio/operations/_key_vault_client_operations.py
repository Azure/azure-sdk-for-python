...
from ...operations._key_vault_client_operations import build_backup_key_request, build_create_key_request, build_decrypt_request, build_delete_key_request, build_encrypt_request, build_get_deleted_key_request, build_get_deleted_keys_request, build_get_key_request, build_get_key_rotation_policy_request, build_get_key_versions_request, build_get_keys_request, build_get_random_bytes_request, build_import_key_request, build_purge_deleted_key_request, build_recover_deleted_key_request, build_release_request, build_restore_key_request, build_rotate_key_request, build_sign_request, build_unwrap_key_request, build_update_key_request, build_update_key_rotation_policy_request, build_verify_request, build_wrap_key_request
T = TypeVar('T')
...
class KeyVaultClientOperationsMixin:
    ...
    def get_key_versions(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.keyvault.v7_3_preview.models.KeyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "7.3-preview")  # type: str
    ...
    def get_deleted_keys(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DeletedKeyListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.keyvault.v7_3_preview.models.DeletedKeyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "7.3-preview")  # type: str
