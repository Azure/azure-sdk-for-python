...
from ...operations._key_vault_client_operations import (
    ...
    build_backup_storage_account_request,
    ...
    build_purge_deleted_storage_account_request,
    build_recover_deleted_certificate_request,
    build_recover_deleted_key_request,
    build_recover_deleted_sas_definition_request,
    build_recover_deleted_secret_request,
    build_recover_deleted_storage_account_request,
    ...
    build_restore_storage_account_request,
...
class KeyVaultClientOperationsMixin(MixinABC):  # pylint: disable=too-many-public-methods
    @overload
    ...
    @distributed_trace_async
    async def restore_storage_account(
        self, vault_base_url: str, parameters: Union[_models.StorageRestoreParameters, IO], **kwargs: Any
    ) -> _models.StorageBundle:
        """Restores a backed up storage account to a vault.
