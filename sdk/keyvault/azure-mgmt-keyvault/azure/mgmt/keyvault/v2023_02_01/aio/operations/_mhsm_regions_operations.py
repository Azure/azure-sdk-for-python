...
from ...operations._mhsm_regions_operations import build_list_by_resource_request
...
class MHSMRegionsOperations:
    ...
    def list_by_resource(
    ...
    ) -> AsyncIterable["_models.MHSMGeoReplicatedRegion"]:
        ...
        :return: An iterator like instance of either MHSMGeoReplicatedRegion or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2023_02_01.models.MHSMGeoReplicatedRegion]
    ...
    list_by_resource.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.KeyVault/managedHSMs/{name}/regions"
    }
