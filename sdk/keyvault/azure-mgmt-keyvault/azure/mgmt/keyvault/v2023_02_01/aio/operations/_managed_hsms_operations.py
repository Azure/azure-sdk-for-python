...
from ...operations._managed_hsms_operations import (
    build_check_mhsm_name_availability_request,
...
class ManagedHsmsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.keyvault.v2023_02_01.models.ManagedHsm
        ...
        :return: An instance of AsyncLROPoller that returns either ManagedHsm or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.keyvault.v2023_02_01.models.ManagedHsm]
    ...
    async def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.keyvault.v2023_02_01.models.ManagedHsm or IO
    ...
    def list_by_resource_group(
    ...
    ) -> AsyncIterable["_models.ManagedHsm"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2023_02_01.models.ManagedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_deleted(self, **kwargs: Any) -> AsyncIterable["_models.DeletedManagedHsm"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2023_02_01.models.DeletedManagedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def check_mhsm_name_availability(
        ...
        **kwargs: Any
        ...
        :type mhsm_name: ~azure.mgmt.keyvault.v2023_02_01.models.CheckMhsmNameAvailabilityParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def check_mhsm_name_availability(
        ...
        :param mhsm_name: The name of the managed hsm. Is either a CheckMhsmNameAvailabilityParameters
         type or a IO type. Required.
        :type mhsm_name: ~azure.mgmt.keyvault.v2023_02_01.models.CheckMhsmNameAvailabilityParameters or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        ...
        _json = None
        _content = None
        if isinstance(mhsm_name, (IO, bytes)):
            _content = mhsm_name
        else:
