...
class SecretsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.keyvault.v2023_02_01.models.SecretCreateOrUpdateParameters
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.keyvault.v2023_02_01.models.SecretPatchParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Secret or the result of cls(response)
