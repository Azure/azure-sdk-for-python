...
class ManagedHsmKeysOperations:
    ...
    def create_if_not_exist(
        ...
        name: str,
        key_name: str,
        parameters: Union[_models.ManagedHsmKeyCreateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.ManagedHsmKey:
        """Creates the first version of a new key if it does not exist. If it already exists, then the
        existing key is returned without any write operations being performed. This API does not create
        ...
        :type parameters: ~azure.mgmt.keyvault.v2023_02_01.models.ManagedHsmKeyCreateParameters or
         IO[bytes]
        :return: ManagedHsmKey or the result of cls(response)
        :rtype: ~azure.mgmt.keyvault.v2023_02_01.models.ManagedHsmKey
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        deserialized = self._deserialize("ManagedHsmKey", pipeline_response.http_response)
