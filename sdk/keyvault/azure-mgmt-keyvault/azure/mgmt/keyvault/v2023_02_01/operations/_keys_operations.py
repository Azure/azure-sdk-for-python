...
class KeysOperations:
    ...
    def create_if_not_exist(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.keyvault.v2023_02_01.models.KeyCreateParameters or IO
    ...
    def list(self, resource_group_name: str, vault_name: str, **kwargs: Any) -> Iterable["_models.Key"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2023_02_01.models.Key]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
