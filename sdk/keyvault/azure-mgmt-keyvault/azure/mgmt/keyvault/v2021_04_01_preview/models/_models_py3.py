...
class DeletedManagedHsm(msrest.serialization.Model):
    ...
    :type properties: ~azure.mgmt.keyvault.models.DeletedManagedHsmProperties
    """
...
class DeletedManagedHsmListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.keyvault.models.DeletedManagedHsm]
...
class ManagedHsmProperties(msrest.serialization.Model):
    ...
    :param network_acls: Rules governing the accessibility of the key vault from specific network
     locations.
    :type network_acls: ~azure.mgmt.keyvault.models.MHSMNetworkRuleSet
    ...
    :type public_network_access: str or ~azure.mgmt.keyvault.models.PublicNetworkAccess
...
class MHSMNetworkRuleSet(msrest.serialization.Model):
    ...
    :type ip_rules: list[~azure.mgmt.keyvault.models.MHSMIPRule]
    :param virtual_network_rules: The list of virtual network rules.
    :type virtual_network_rules: list[~azure.mgmt.keyvault.models.MHSMVirtualNetworkRule]
    """
...
class MHSMPrivateEndpointConnection(ManagedHsmResource):
    ...
    :type private_endpoint: ~azure.mgmt.keyvault.models.MHSMPrivateEndpoint
...
class MHSMPrivateEndpointConnectionsListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.keyvault.models.MHSMPrivateEndpointConnection]
    :param next_link: The URL to get the next set of managed HSM Pools.
    :type next_link: str
    """
...
class MHSMPrivateLinkResourceListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.keyvault.models.MHSMPrivateLinkResource]
    """
...
class PrivateEndpointConnectionListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.keyvault.models.PrivateEndpointConnection]
