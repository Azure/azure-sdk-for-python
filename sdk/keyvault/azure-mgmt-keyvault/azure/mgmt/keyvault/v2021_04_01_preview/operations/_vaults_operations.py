...
def build_list_request(
    subscription_id: str,
    *,
    filter: Union[str, _models.Enum12],
    api_version: Union[str, _models.Enum13],
...
class VaultsOperations:
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters to patch the vault. Is either a VaultPatchParameters type or a IO
         type. Required.
        :type parameters: ~azure.mgmt.keyvault.v2021_04_01_preview.models.VaultPatchParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update_access_policy(
        ...
        **kwargs: Any
        ...
        :type operation_kind: str or
         ~azure.mgmt.keyvault.v2021_04_01_preview.models.AccessPolicyUpdateKind
    ...
    def list_by_resource_group(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2021_04_01_preview.models.Vault]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_deleted(self, **kwargs: Any) -> Iterable["_models.DeletedVault"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2021_04_01_preview.models.DeletedVault]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list(
        ...
        top: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable["_models.Resource"]:
        """The List operation gets information about the vaults associated with the subscription.

        :param filter: The filter to apply on the operation. "resourceType eq
         'Microsoft.KeyVault/vaults'" Required.
        :type filter: str or ~azure.mgmt.keyvault.v2021_04_01_preview.models.Enum12
        :param api_version: Azure Resource Manager Api Version. "2015-11-01" Required.
        :type api_version: str or ~azure.mgmt.keyvault.v2021_04_01_preview.models.Enum13
        :param top: Maximum number of results to return. Default value is None.
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either Resource or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2021_04_01_preview.models.Resource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
    ...
    def check_name_availability(
        ...
        **kwargs: Any
        ...
        :param vault_name: The name of the vault. Required.
        :type vault_name:
         ~azure.mgmt.keyvault.v2021_04_01_preview.models.VaultCheckNameAvailabilityParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def check_name_availability(
        ...
        :type vault_name:
         ~azure.mgmt.keyvault.v2021_04_01_preview.models.VaultCheckNameAvailabilityParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
