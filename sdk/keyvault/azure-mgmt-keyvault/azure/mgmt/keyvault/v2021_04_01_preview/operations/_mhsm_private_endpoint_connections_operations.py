...
class MHSMPrivateEndpointConnectionsOperations:
    ...
    def put(
        ...
        name: str,
        private_endpoint_connection_name: str,
        properties: Union[_models.MHSMPrivateEndpointConnection, IO[bytes]],
        **kwargs: Any
    ) -> _models.MHSMPrivateEndpointConnection:
        """Updates the specified private endpoint connection associated with the managed hsm pool.
    ...
    def begin_delete(
        ...
        if cont_token:
            return LROPoller[_models.MHSMPrivateEndpointConnection].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.MHSMPrivateEndpointConnection](
