...
def build_list_by_resource_request(
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2021-04-01-preview"))
...
class MHSMPrivateEndpointConnectionsOperations:
    ...
    def list_by_resource(
    ...
    ) -> Iterable["_models.MHSMPrivateEndpointConnection"]:
        ...
        :return: An iterator like instance of either MHSMPrivateEndpointConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2021_04_01_preview.models.MHSMPrivateEndpointConnection]
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2021-04-01-preview")
        )
    ...
    def begin_delete(
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.keyvault.v2021_04_01_preview.models.MHSMPrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
