...
class MHSMPrivateEndpointConnectionsOperations(object):
    ...
    def list_by_resource(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.models.MHSMPrivateEndpointConnectionsListResult]
    ...
    def begin_delete(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.keyvault.models.MHSMPrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
