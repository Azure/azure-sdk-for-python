...
class KeyVaultManagementClient(object):
    ...
    :vartype mhsm_private_endpoint_connections: azure.mgmt.keyvault.operations.MHSMPrivateEndpointConnectionsOperations
    :ivar mhsm_private_link_resources: MHSMPrivateLinkResourcesOperations operations
    :vartype mhsm_private_link_resources: azure.mgmt.keyvault.operations.MHSMPrivateLinkResourcesOperations
