...
class ManagedHsmsOperations:
    ...
    async def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.keyvault.v2022_07_01.models.ManagedHsm or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ManagedHsm or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.keyvault.v2022_07_01.models.ManagedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2022_07_01.models.ManagedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_deleted(self, **kwargs: Any) -> AsyncIterable["_models.DeletedManagedHsm"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2022_07_01.models.DeletedManagedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def check_mhsm_name_availability(
        ...
        :param mhsm_name: The name of the managed hsm. Is either a CheckMhsmNameAvailabilityParameters
         type or a IO[bytes] type. Required.
        :type mhsm_name: ~azure.mgmt.keyvault.v2022_07_01.models.CheckMhsmNameAvailabilityParameters or
         IO[bytes]
        :return: CheckMhsmNameAvailabilityResult or the result of cls(response)
        :rtype: ~azure.mgmt.keyvault.v2022_07_01.models.CheckMhsmNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
