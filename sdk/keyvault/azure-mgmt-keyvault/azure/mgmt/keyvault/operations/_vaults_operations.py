...
class VaultsOperations:
    ...
    def list_by_resource_group(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.models.Vault]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_by_subscription(self, top: Optional[int] = None, **kwargs: Any) -> ItemPaged["_models.Vault"]:
    ...
    @distributed_trace
    def list_deleted(self, **kwargs: Any) -> ItemPaged["_models.DeletedVault"]:
        """Gets information about the deleted vaults in a subscription.

        :return: An iterator like instance of either DeletedVault or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.models.DeletedVault]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list(self, top: Optional[int] = None, **kwargs: Any) -> ItemPaged["_models.Resource"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.models.Resource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
