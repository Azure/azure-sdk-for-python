...
class ManagedHsmKeysOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, name: str, **kwargs: Any) -> ItemPaged["_models.ManagedHsmKey"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.models.ManagedHsmKey]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    ) -> ItemPaged["_models.ManagedHsmKey"]:
