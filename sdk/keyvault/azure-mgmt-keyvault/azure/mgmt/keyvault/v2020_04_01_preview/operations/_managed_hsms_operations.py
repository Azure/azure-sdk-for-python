...
class ManagedHsmsOperations:
    ...
    def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.keyvault.v2020_04_01_preview.models.ManagedHsm or IO[bytes]
        :return: An instance of LROPoller that returns either ManagedHsm or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.keyvault.v2020_04_01_preview.models.ManagedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2020_04_01_preview.models.ManagedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
