...
class KeysOperations:
    ...
    async def create_if_not_exist(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.keyvault.v2020_04_01_preview.models.KeyCreateParameters or IO
    ...
    def list(self, resource_group_name: str, vault_name: str, **kwargs: Any) -> AsyncIterable["_models.Key"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2020_04_01_preview.models.Key]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
