...
class KeyVaultManagementClient:
    ...
    :vartype vaults: azure.mgmt.keyvault.v2016_10_01.aio.operations.VaultsOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.keyvault.v2016_10_01.aio.operations.Operations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.vaults = VaultsOperations(self._client, self._config, self._serialize, self._deserialize, "2016-10-01")
        self.operations = Operations(self._client, self._config, self._serialize, self._deserialize, "2016-10-01")
