...
def build_list_by_subscription_request(
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.KeyVault/managedHSMs")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
def build_list_deleted_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.KeyVault/deletedManagedHSMs")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
def build_get_deleted_request(name: str, location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_purge_deleted_request(name: str, location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_check_mhsm_name_availability_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.KeyVault/checkMhsmNameAvailability"
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class ManagedHsmsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.keyvault.v2023_07_01.KeyVaultManagementClient`'s
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.keyvault.v2023_07_01.models.ManagedHsm
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either ManagedHsm or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.keyvault.v2023_07_01.models.ManagedHsm]
    ...
    def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.keyvault.v2023_07_01.models.ManagedHsm or IO[bytes]
        :return: An instance of LROPoller that returns either ManagedHsm or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.keyvault.v2023_07_01.models.ManagedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("ManagedHsm", pipeline_response.http_response)
            if cls:
        ...
        if cont_token:
            return LROPoller[_models.ManagedHsm].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ManagedHsm](
    ...
    @distributed_trace
    def get(self, resource_group_name: str, name: str, **kwargs: Any) -> Optional[_models.ManagedHsm]:
    ...
    def list_by_resource_group(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2023_07_01.models.ManagedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_by_subscription(self, top: Optional[int] = None, **kwargs: Any) -> Iterable["_models.ManagedHsm"]:
        """The List operation gets information about the managed HSM Pools associated with the
        subscription.
    ...
    @distributed_trace
    def list_deleted(self, **kwargs: Any) -> Iterable["_models.DeletedManagedHsm"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2023_07_01.models.DeletedManagedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def get_deleted(self, name: str, location: str, **kwargs: Any) -> _models.DeletedManagedHsm:
        ...
        deserialized = self._deserialize("DeletedManagedHsm", pipeline_response.http_response)
    ...
    @distributed_trace
    def begin_purge_deleted(self, name: str, location: str, **kwargs: Any) -> LROPoller[None]:
        """Permanently deletes the specified managed HSM.

        :param name: The name of the soft-deleted managed HSM. Required.
        :type name: str
    ...
    def check_mhsm_name_availability(
        ...
        **kwargs: Any
        ...
        :param mhsm_name: The name of the managed hsm. Required.
        :type mhsm_name: ~azure.mgmt.keyvault.v2023_07_01.models.CheckMhsmNameAvailabilityParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: CheckMhsmNameAvailabilityResult or the result of cls(response)
    ...
    @distributed_trace
    def check_mhsm_name_availability(
        self, mhsm_name: Union[_models.CheckMhsmNameAvailabilityParameters, IO[bytes]], **kwargs: Any
    ) -> _models.CheckMhsmNameAvailabilityResult:
        """Checks that the managed hsm name is valid and is not already in use.

        :param mhsm_name: The name of the managed hsm. Is either a CheckMhsmNameAvailabilityParameters
         type or a IO[bytes] type. Required.
        :type mhsm_name: ~azure.mgmt.keyvault.v2023_07_01.models.CheckMhsmNameAvailabilityParameters or
         IO[bytes]
        :return: CheckMhsmNameAvailabilityResult or the result of cls(response)
        :rtype: ~azure.mgmt.keyvault.v2023_07_01.models.CheckMhsmNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if isinstance(mhsm_name, (IOBase, bytes)):
            ...
            _json = self._serialize.body(mhsm_name, "CheckMhsmNameAvailabilityParameters")

        _request = build_check_mhsm_name_availability_request(
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            content_type=content_type,
            json=_json,
        ...
        deserialized = self._deserialize("CheckMhsmNameAvailabilityResult", pipeline_response.http_response)
