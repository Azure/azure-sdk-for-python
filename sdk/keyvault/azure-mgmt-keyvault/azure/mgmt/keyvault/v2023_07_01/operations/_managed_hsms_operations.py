...
class ManagedHsmsOperations:
    ...
    def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.keyvault.v2023_07_01.models.ManagedHsm or IO
    ...
    @overload
    def check_mhsm_name_availability(
        self, mhsm_name: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.CheckMhsmNameAvailabilityResult:
        """Checks that the managed hsm name is valid and is not already in use.
    ...
    @distributed_trace
    def check_mhsm_name_availability(
        self, mhsm_name: Union[_models.CheckMhsmNameAvailabilityParameters, IO], **kwargs: Any
    ) -> _models.CheckMhsmNameAvailabilityResult:
        """Checks that the managed hsm name is valid and is not already in use.
        ...
        request = build_check_mhsm_name_availability_request(
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            content_type=content_type,
            json=_json,
            content=_content,
            template_url=self.check_mhsm_name_availability.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
        ...
        deserialized = self._deserialize("CheckMhsmNameAvailabilityResult", pipeline_response)
    ...
    check_mhsm_name_availability.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.KeyVault/checkMhsmNameAvailability"
    }
