...
class SecretsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.keyvault.v2023_07_01.models.SecretCreateOrUpdateParameters or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters to patch the secret. Is either a SecretPatchParameters type or a
         IO type. Required.
        :type parameters: ~azure.mgmt.keyvault.v2023_07_01.models.SecretPatchParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
