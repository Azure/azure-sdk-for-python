    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword permissions: Permissions the identity has for keys, secrets and certificates.
         Required.
        :paramtype permissions: ~azure.mgmt.keyvault.models.Permissions
        """
...
class Action(_serialization.Model):
    ...
    def __init__(
        ...
        :paramtype type: str or ~azure.mgmt.keyvault.models.KeyRotationPolicyActionType
        """
        super().__init__(**kwargs)
        self.type = type
...
class DeletedManagedHsm(_serialization.Model):
    ...
    def __init__(self, *, properties: Optional["_models.DeletedManagedHsmProperties"] = None, **kwargs: Any) -> None:
        ...
        :paramtype properties: ~azure.mgmt.keyvault.models.DeletedManagedHsmProperties
        """
        super().__init__(**kwargs)
...
class DeletedManagedHsmListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.keyvault.models.DeletedManagedHsm]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.keyvault.models.DeletedManagedHsm]
...
class DeletedVault(_serialization.Model):
    ...
    def __init__(self, *, properties: Optional["_models.DeletedVaultProperties"] = None, **kwargs: Any) -> None:
        ...
        :paramtype properties: ~azure.mgmt.keyvault.models.DeletedVaultProperties
        """
        super().__init__(**kwargs)
        self.id: Optional[str] = None
        self.name: Optional[str] = None
...
class DeletedVaultListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.keyvault.models.DeletedVault]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.keyvault.models.DeletedVault]
...
class Key(Resource):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype attributes: ~azure.mgmt.keyvault.models.KeyAttributes
        :keyword kty: The type of the key. For valid values, see JsonWebKeyType. Known values are:
         "EC", "EC-HSM", "RSA", and "RSA-HSM".
        :paramtype kty: str or ~azure.mgmt.keyvault.models.JsonWebKeyType
        :keyword key_ops:
        :paramtype key_ops: list[str or ~azure.mgmt.keyvault.models.JsonWebKeyOperation]
        :keyword key_size: The key size in bits. For example: 2048, 3072, or 4096 for RSA. Default for
         RSA and RSA-HSM keys is 2048. Exception made for bring your own key (BYOK), key exchange keys
         default to 4096.
        :paramtype key_size: int
        :keyword curve_name: The elliptic curve name. For valid values, see JsonWebKeyCurveName.
         Default for EC and EC-HSM keys is P-256. Known values are: "P-256", "P-384", "P-521", and
         "P-256K".
        :paramtype curve_name: str or ~azure.mgmt.keyvault.models.JsonWebKeyCurveName
        :keyword rotation_policy: Key rotation policy in response. It will be used for both output and
         input. Omitted if empty.
        :paramtype rotation_policy: ~azure.mgmt.keyvault.models.RotationPolicy
        :keyword release_policy: Key release policy in response. It will be used for both output and
         input. Omitted if empty.
        :paramtype release_policy: ~azure.mgmt.keyvault.models.KeyReleasePolicy
        """
        super().__init__(**kwargs)
...
class KeyCreateParameters(_serialization.Model):
    ...
    def __init__(
        ...
        :paramtype properties: ~azure.mgmt.keyvault.models.KeyProperties
        """
        super().__init__(**kwargs)
        self.tags = tags
        self.properties = properties
...
class KeyListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.keyvault.models.Key]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.keyvault.models.Key]
...
class LifetimeAction(_serialization.Model):
    ...
    def __init__(
        ...
        :paramtype trigger: ~azure.mgmt.keyvault.models.Trigger
        :keyword action: The action of key rotation policy lifetimeAction.
        :paramtype action: ~azure.mgmt.keyvault.models.Action
        """
        super().__init__(**kwargs)
...
class ManagedHsmResource(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype sku: ~azure.mgmt.keyvault.models.ManagedHsmSku
        :keyword tags: Resource tags.
        :paramtype tags: dict[str, str]
        :keyword identity: Managed service identity (system assigned and/or user assigned identities).
        :paramtype identity: ~azure.mgmt.keyvault.models.ManagedServiceIdentity
        """
        super().__init__(**kwargs)
        self.id: Optional[str] = None
        self.name: Optional[str] = None
...
class ManagedHsm(ManagedHsmResource):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties: ~azure.mgmt.keyvault.models.ManagedHsmProperties
        """
...
class ManagedHsmKey(ProxyResourceWithoutSystemData):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype tags: dict[str, str]
        :keyword attributes: The attributes of the key.
        :paramtype attributes: ~azure.mgmt.keyvault.models.ManagedHsmKeyAttributes
        :keyword kty: The type of the key. For valid values, see JsonWebKeyType. Known values are:
         "EC", "EC-HSM", "RSA", and "RSA-HSM".
        :paramtype kty: str or ~azure.mgmt.keyvault.models.JsonWebKeyType
        :keyword key_ops:
        ...
        :keyword rotation_policy: Key rotation policy in response. It will be used for both output and
         input. Omitted if empty.
        :paramtype rotation_policy: ~azure.mgmt.keyvault.models.ManagedHsmRotationPolicy
        :keyword release_policy: Key release policy in response. It will be used for both output and
         input. Omitted if empty.
        :paramtype release_policy: ~azure.mgmt.keyvault.models.ManagedHsmKeyReleasePolicy
        """
...
class ManagedHsmKeyAttributes(_serialization.Model):
    """The object attributes managed by the Azure Key Vault service.
...
class ManagedHsmKeyCreateParameters(_serialization.Model):
    """The parameters used to create a key.
    ...
    def __init__(
        ...
        :paramtype tags: dict[str, str]
        :keyword properties: The properties of the key to be created. Required.
        :paramtype properties: ~azure.mgmt.keyvault.models.ManagedHsmKeyProperties
        """
        super().__init__(**kwargs)
        self.tags = tags
        self.properties = properties
...
class ManagedHsmKeyListResult(_serialization.Model):
    """The page of keys.

    :ivar value: The key resources.
    :vartype value: list[~azure.mgmt.keyvault.models.ManagedHsmKey]
    :ivar next_link: The URL to get the next page of keys.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        """
        :keyword value: The key resources.
        :paramtype value: list[~azure.mgmt.keyvault.models.ManagedHsmKey]
        :keyword next_link: The URL to get the next page of keys.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ManagedHsmKeyProperties(_serialization.Model):
    """The properties of the key.
...
class ManagedHsmKeyReleasePolicy(_serialization.Model):
...
class ManagedHsmKeyRotationPolicyAttributes(_serialization.Model):
...
class ManagedHsmLifetimeAction(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword trigger: The trigger of key rotation policy lifetimeAction.
        :paramtype trigger: ~azure.mgmt.keyvault.models.ManagedHsmTrigger
        :keyword action: The action of key rotation policy lifetimeAction.
        :paramtype action: ~azure.mgmt.keyvault.models.ManagedHsmAction
        """
        super().__init__(**kwargs)
        self.trigger = trigger
        self.action = action
...
class ManagedHsmListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.keyvault.models.ManagedHsm]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.keyvault.models.ManagedHsm]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword create_mode: The create mode to indicate whether the resource is being created or is
         being recovered from a deleted resource. Known values are: "recover" and "default".
        :paramtype create_mode: str or ~azure.mgmt.keyvault.models.CreateMode
        :keyword network_acls: Rules governing the accessibility of the key vault from specific network
         locations.
        :paramtype network_acls: ~azure.mgmt.keyvault.models.MHSMNetworkRuleSet
        :keyword regions: List of all regions associated with the managed hsm pool.
        :paramtype regions: list[~azure.mgmt.keyvault.models.MHSMGeoReplicatedRegion]
        :keyword public_network_access: Control permission to the managed HSM from public networks.
         Known values are: "Enabled" and "Disabled".
        :paramtype public_network_access: str or ~azure.mgmt.keyvault.models.PublicNetworkAccess
        """
        super().__init__(**kwargs)
        self.tenant_id = tenant_id
...
class ManagedHsmRotationPolicy(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype attributes: ~azure.mgmt.keyvault.models.ManagedHsmKeyRotationPolicyAttributes
        :keyword lifetime_actions: The lifetimeActions for key rotation action.
        :paramtype lifetime_actions: list[~azure.mgmt.keyvault.models.ManagedHsmLifetimeAction]
        """
        super().__init__(**kwargs)
        self.attributes = attributes
...
class ManagedHsmSku(_serialization.Model):
    ...
    :ivar family: SKU Family of the managed HSM Pool. Known values are: "B" and "C".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword family: SKU Family of the managed HSM Pool. Known values are: "B" and "C".
        :paramtype family: str or ~azure.mgmt.keyvault.models.ManagedHsmSkuFamily
        :keyword name: SKU of the managed HSM Pool. Required. Known values are: "Standard_B1",
         "Custom_B32", "Custom_B6", "Custom_C42", and "Custom_C10".
        :paramtype name: str or ~azure.mgmt.keyvault.models.ManagedHsmSkuName
        """
        super().__init__(**kwargs)
        self.family = family
        self.name = name
...
class ManagedHsmTrigger(_serialization.Model):
    """ManagedHsmTrigger.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: Type of managed service identity (where both SystemAssigned and UserAssigned
         ...
         "SystemAssigned,UserAssigned".
        :paramtype type: str or ~azure.mgmt.keyvault.models.ManagedServiceIdentityType
        :keyword user_assigned_identities: The set of user assigned identities associated with the
         resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form:
         '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}.
         The dictionary values can be empty objects ({}) in requests.
        :paramtype user_assigned_identities: dict[str,
         ~azure.mgmt.keyvault.models.UserAssignedIdentity]
        """
        super().__init__(**kwargs)
...
class MetricSpecification(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype dimensions: list[~azure.mgmt.keyvault.models.DimensionProperties]
...
class MHSMGeoReplicatedRegion(_serialization.Model):
    ...
    def __init__(self, *, name: Optional[str] = None, is_primary: Optional[bool] = None, **kwargs: Any) -> None:
        """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword bypass: Tells what traffic can bypass network rules. This can be 'AzureServices' or
         'None'.  If not specified the default is 'AzureServices'. Known values are: "AzureServices" and
         "None".
        :paramtype bypass: str or ~azure.mgmt.keyvault.models.NetworkRuleBypassOptions
...
class MHSMPrivateEndpointConnection(ManagedHsmResource):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype private_endpoint: ~azure.mgmt.keyvault.models.MHSMPrivateEndpoint
...
class MHSMPrivateEndpointConnectionsListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.keyvault.models.MHSMPrivateEndpointConnection]
    :ivar next_link: The URL to get the next set of managed HSM Pools.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.keyvault.models.MHSMPrivateEndpointConnection]
        :keyword next_link: The URL to get the next set of managed HSM Pools.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword status: Indicates whether the connection has been approved, rejected or removed by the
         key vault owner. Known values are: "Pending", "Approved", "Rejected", and "Disconnected".
        :paramtype status: str or ~azure.mgmt.keyvault.models.PrivateEndpointServiceConnectionStatus
        :keyword description: The reason for approval or rejection.
        :paramtype description: str
        :keyword actions_required: A message indicating if changes on the service provider require any
         updates on the consumer. "None"
        :paramtype actions_required: str or ~azure.mgmt.keyvault.models.ActionsRequired
        """
        super().__init__(**kwargs)
        self.status = status
...
class MHSMRegionsListResult(_serialization.Model):
    """List of regions associated with a managed HSM Pools.

    :ivar value: The region associated with a managed HSM Pools.
    :vartype value: list[~azure.mgmt.keyvault.models.MHSMGeoReplicatedRegion]
    :ivar next_link: The URL to get the next set of managed HSM Pools.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.keyvault.models.MHSMGeoReplicatedRegion]
        :keyword next_link: The URL to get the next set of managed HSM Pools.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class NetworkRuleSet(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype default_action: str or ~azure.mgmt.keyvault.models.NetworkRuleAction
        :keyword ip_rules: The list of IP address rules.
        :paramtype ip_rules: list[~azure.mgmt.keyvault.models.IPRule]
        :keyword virtual_network_rules: The list of virtual network rules.
        :paramtype virtual_network_rules: list[~azure.mgmt.keyvault.models.VirtualNetworkRule]
        """
        super().__init__(**kwargs)
        self.bypass = bypass
        self.default_action = default_action
...
class Operation(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype display: ~azure.mgmt.keyvault.models.OperationDisplay
        ...
        :paramtype service_specification: ~azure.mgmt.keyvault.models.ServiceSpecification
        """
        super().__init__(**kwargs)
        self.name = name
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.keyvault.models.Operation]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.keyvault.models.Operation]
...
class Permissions(_serialization.Model):
    ...
    :vartype keys: list[str or ~azure.mgmt.keyvault.models.KeyPermissions]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype keys: list[str or ~azure.mgmt.keyvault.models.KeyPermissions]
        :keyword secrets: Permissions to secrets.
        :paramtype secrets: list[str or ~azure.mgmt.keyvault.models.SecretPermissions]
        :keyword certificates: Permissions to certificates.
        :paramtype certificates: list[str or ~azure.mgmt.keyvault.models.CertificatePermissions]
        :keyword storage: Permissions to storage accounts.
        :paramtype storage: list[str or ~azure.mgmt.keyvault.models.StoragePermissions]
        """
        super().__init__(**kwargs)
        self.keys = keys
...
class PrivateEndpointConnection(Resource):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype etag: str
        :keyword private_endpoint: Properties of the private endpoint object.
        :paramtype private_endpoint: ~azure.mgmt.keyvault.models.PrivateEndpoint
        :keyword private_link_service_connection_state: Approval state of the private link connection.
        :paramtype private_link_service_connection_state:
         ~azure.mgmt.keyvault.models.PrivateLinkServiceConnectionState
        :keyword provisioning_state: Provisioning state of the private endpoint connection. Known
...
class PrivateEndpointConnectionListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.keyvault.models.PrivateEndpointConnection]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.keyvault.models.PrivateEndpointConnection]
...
class ResourceListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.keyvault.models.Resource]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.keyvault.models.Resource]
...
class RotationPolicy(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword attributes: The attributes of key rotation policy.
        :paramtype attributes: ~azure.mgmt.keyvault.models.KeyRotationPolicyAttributes
        :keyword lifetime_actions: The lifetimeActions for key rotation action.
        :paramtype lifetime_actions: list[~azure.mgmt.keyvault.models.LifetimeAction]
        """
        super().__init__(**kwargs)
        self.attributes = attributes
        self.lifetime_actions = lifetime_actions
...
class Secret(Resource):
    ...
    def __init__(self, *, properties: "_models.SecretProperties", **kwargs: Any) -> None:
        ...
        :paramtype properties: ~azure.mgmt.keyvault.models.SecretProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
...
class SecretListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.keyvault.models.Secret]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.keyvault.models.Secret]
...
class SecretPatchParameters(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties: ~azure.mgmt.keyvault.models.SecretPatchProperties
        """
        super().__init__(**kwargs)
        self.tags = tags
        self.properties = properties
...
class SecretPatchProperties(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype attributes: ~azure.mgmt.keyvault.models.SecretAttributes
        """
        super().__init__(**kwargs)
        self.value = value
        self.content_type = content_type
...
class ServiceSpecification(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype log_specifications: list[~azure.mgmt.keyvault.models.LogSpecification]
        :keyword metric_specifications: Metric specifications of operation.
        :paramtype metric_specifications: list[~azure.mgmt.keyvault.models.MetricSpecification]
        """
        super().__init__(**kwargs)
...
class Sku(_serialization.Model):
    ...
    def __init__(
        ...
        :paramtype family: str or ~azure.mgmt.keyvault.models.SkuFamily
        ...
        :paramtype name: str or ~azure.mgmt.keyvault.models.SkuName
        """
        super().__init__(**kwargs)
        self.family = family
        self.name = name
...
class SystemData(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype created_by_type: str or ~azure.mgmt.keyvault.models.IdentityType
        ...
        :keyword last_modified_by_type: The type of identity that last modified the key vault resource.
         Known values are: "User", "Application", "ManagedIdentity", and "Key".
        :paramtype last_modified_by_type: str or ~azure.mgmt.keyvault.models.IdentityType
...
class Vault(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties: ~azure.mgmt.keyvault.models.VaultProperties
        """
        super().__init__(**kwargs)
        self.id: Optional[str] = None
        self.name: Optional[str] = None
...
class VaultAccessPolicyParameters(_serialization.Model):
    ...
    def __init__(self, *, properties: "_models.VaultAccessPolicyProperties", **kwargs: Any) -> None:
        ...
        :paramtype properties: ~azure.mgmt.keyvault.models.VaultAccessPolicyProperties
        """
        super().__init__(**kwargs)
        self.id: Optional[str] = None
        self.name: Optional[str] = None
...
class VaultAccessPolicyProperties(_serialization.Model):
    ...
    def __init__(self, *, access_policies: list["_models.AccessPolicyEntry"], **kwargs: Any) -> None:
        ...
        :keyword access_policies: An array of 0 to 16 identities that have access to the key vault. All
         identities in the array must use the same tenant ID as the key vault's tenant ID. Required.
        :paramtype access_policies: list[~azure.mgmt.keyvault.models.AccessPolicyEntry]
        """
        super().__init__(**kwargs)
...
class VaultListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.keyvault.models.Vault]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.keyvault.models.Vault]
...
class VaultPatchParameters(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype tags: dict[str, str]
        :keyword properties: Properties of the vault.
        :paramtype properties: ~azure.mgmt.keyvault.models.VaultPatchProperties
        """
        super().__init__(**kwargs)
        self.tags = tags
        self.properties = properties
...
class VaultPatchProperties(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype tenant_id: str
        :keyword sku: SKU details.
        :paramtype sku: ~azure.mgmt.keyvault.models.Sku
        :keyword access_policies: An array of 0 to 16 identities that have access to the key vault. All
         identities in the array must use the same tenant ID as the key vault's tenant ID.
        :paramtype access_policies: list[~azure.mgmt.keyvault.models.AccessPolicyEntry]
        ...
        :keyword network_acls: A collection of rules governing the accessibility of the vault from
         specific network locations.
        :paramtype network_acls: ~azure.mgmt.keyvault.models.NetworkRuleSet
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword provisioning_state: Provisioning state of the vault. Known values are: "Succeeded" and
         "RegisteringDns".
        :paramtype provisioning_state: str or ~azure.mgmt.keyvault.models.VaultProvisioningState
        :keyword public_network_access: Property to specify whether the vault will accept traffic from
         public internet. If set to 'disabled' all traffic except private endpoint traffic and that that
         originates from trusted services will be blocked. This will override the set firewall rules,
         meaning that even if the firewall rules are present we will not honor the rules.
