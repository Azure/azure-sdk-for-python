...
class MHSMPrivateEndpointConnectionsOperations:
    ...
    def list_by_resource(
        ...
        :return: An iterator like instance of either MHSMPrivateEndpointConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2024_11_01.models.MHSMPrivateEndpointConnection]
    ...
    def begin_delete(
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.keyvault.v2024_11_01.models.MHSMPrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
