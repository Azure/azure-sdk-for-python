...
class ManagedHsmsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.keyvault.v2024_11_01.models.ManagedHsm
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either ManagedHsm or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.keyvault.v2024_11_01.models.ManagedHsm]
    ...
    async def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.keyvault.v2024_11_01.models.ManagedHsm or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ManagedHsm or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.keyvault.v2024_11_01.models.ManagedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def get(self, resource_group_name: str, name: str, **kwargs: Any) -> Optional[_models.ManagedHsm]:
        ...
        :rtype: ~azure.mgmt.keyvault.v2024_11_01.models.ManagedHsm or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2024_11_01.models.ManagedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_deleted(self, **kwargs: Any) -> AsyncIterable["_models.DeletedManagedHsm"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2024_11_01.models.DeletedManagedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_deleted(self, name: str, location: str, **kwargs: Any) -> _models.DeletedManagedHsm:
        ...
        :rtype: ~azure.mgmt.keyvault.v2024_11_01.models.DeletedManagedHsm
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def check_mhsm_name_availability(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.keyvault.v2024_11_01.models.CheckMhsmNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def check_mhsm_name_availability(
        ...
        :param mhsm_name: The name of the managed hsm. Is either a CheckMhsmNameAvailabilityParameters
         type or a IO[bytes] type. Required.
        :type mhsm_name: ~azure.mgmt.keyvault.v2024_11_01.models.CheckMhsmNameAvailabilityParameters or
         IO[bytes]
        :return: CheckMhsmNameAvailabilityResult or the result of cls(response)
        :rtype: ~azure.mgmt.keyvault.v2024_11_01.models.CheckMhsmNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
