...
class KeyVaultManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype keys: azure.mgmt.keyvault.v2024_11_01.aio.operations.KeysOperations
    :ivar managed_hsm_keys: ManagedHsmKeysOperations operations
    :vartype managed_hsm_keys:
     azure.mgmt.keyvault.v2024_11_01.aio.operations.ManagedHsmKeysOperations
    :ivar vaults: VaultsOperations operations
    :vartype vaults: azure.mgmt.keyvault.v2024_11_01.aio.operations.VaultsOperations
    :ivar private_endpoint_connections: PrivateEndpointConnectionsOperations operations
    :vartype private_endpoint_connections:
     azure.mgmt.keyvault.v2024_11_01.aio.operations.PrivateEndpointConnectionsOperations
    :ivar private_link_resources: PrivateLinkResourcesOperations operations
    :vartype private_link_resources:
     azure.mgmt.keyvault.v2024_11_01.aio.operations.PrivateLinkResourcesOperations
    :ivar managed_hsms: ManagedHsmsOperations operations
    :vartype managed_hsms: azure.mgmt.keyvault.v2024_11_01.aio.operations.ManagedHsmsOperations
    ...
    :vartype mhsm_private_endpoint_connections:
     azure.mgmt.keyvault.v2024_11_01.aio.operations.MHSMPrivateEndpointConnectionsOperations
    :ivar mhsm_private_link_resources: MHSMPrivateLinkResourcesOperations operations
    :vartype mhsm_private_link_resources:
     azure.mgmt.keyvault.v2024_11_01.aio.operations.MHSMPrivateLinkResourcesOperations
    :ivar mhsm_regions: MHSMRegionsOperations operations
    :vartype mhsm_regions: azure.mgmt.keyvault.v2024_11_01.aio.operations.MHSMRegionsOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.keyvault.v2024_11_01.aio.operations.Operations
    :ivar secrets: SecretsOperations operations
    :vartype secrets: azure.mgmt.keyvault.v2024_11_01.aio.operations.SecretsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.keys = KeysOperations(self._client, self._config, self._serialize, self._deserialize, "2024-11-01")
        self.managed_hsm_keys = ManagedHsmKeysOperations(
            self._client, self._config, self._serialize, self._deserialize, "2024-11-01"
        )
        self.vaults = VaultsOperations(self._client, self._config, self._serialize, self._deserialize, "2024-11-01")
        ...
        self.secrets = SecretsOperations(self._client, self._config, self._serialize, self._deserialize, "2024-11-01")
