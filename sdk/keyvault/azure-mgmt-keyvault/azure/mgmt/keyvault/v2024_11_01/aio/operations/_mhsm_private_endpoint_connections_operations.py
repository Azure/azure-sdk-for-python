...
class MHSMPrivateEndpointConnectionsOperations:
    ...
    def list_by_resource(
        ...
        :return: An iterator like instance of either MHSMPrivateEndpointConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2024_11_01.models.MHSMPrivateEndpointConnection]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.keyvault.v2024_11_01.models.MHSMPrivateEndpointConnection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def put(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.keyvault.v2024_11_01.models.MHSMPrivateEndpointConnection
    ...
    async def put(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.keyvault.v2024_11_01.models.MHSMPrivateEndpointConnection or
         IO[bytes]
        :return: MHSMPrivateEndpointConnection or the result of cls(response)
        :rtype: ~azure.mgmt.keyvault.v2024_11_01.models.MHSMPrivateEndpointConnection
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_delete(
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.keyvault.v2024_11_01.models.MHSMPrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
