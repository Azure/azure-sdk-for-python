...
class ManagedHsmKeysOperations:
    ...
    async def create_if_not_exist(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.keyvault.v2024_11_01.models.ManagedHsmKeyCreateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ManagedHsmKey or the result of cls(response)
        :rtype: ~azure.mgmt.keyvault.v2024_11_01.models.ManagedHsmKey
    ...
    async def create_if_not_exist(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.keyvault.v2024_11_01.models.ManagedHsmKeyCreateParameters or
         IO[bytes]
        :return: ManagedHsmKey or the result of cls(response)
        :rtype: ~azure.mgmt.keyvault.v2024_11_01.models.ManagedHsmKey
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list(self, resource_group_name: str, name: str, **kwargs: Any) -> AsyncIterable["_models.ManagedHsmKey"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.v2024_11_01.models.ManagedHsmKey]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
