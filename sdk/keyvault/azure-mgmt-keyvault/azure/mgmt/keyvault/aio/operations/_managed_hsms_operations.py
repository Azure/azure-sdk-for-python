...
class ManagedHsmsOperations:
    ...
    async def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.keyvault.models.ManagedHsm or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ManagedHsm or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.keyvault.models.ManagedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def check_mhsm_name_availability(
        ...
        :param mhsm_name: The name of the managed hsm. Is either a CheckMhsmNameAvailabilityParameters
         type or a IO[bytes] type. Required.
        :type mhsm_name: ~azure.mgmt.keyvault.models.CheckMhsmNameAvailabilityParameters or IO[bytes]
        :return: CheckMhsmNameAvailabilityResult or the result of cls(response)
        :rtype: ~azure.mgmt.keyvault.models.CheckMhsmNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
