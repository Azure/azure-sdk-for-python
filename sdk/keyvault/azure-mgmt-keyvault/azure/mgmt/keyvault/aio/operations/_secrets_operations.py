...
class SecretsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.keyvault.models.SecretCreateOrUpdateParameters or IO[bytes]
        :return: Secret or the result of cls(response)
        :rtype: ~azure.mgmt.keyvault.models.Secret
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.keyvault.models.SecretPatchParameters or IO[bytes]
        :return: Secret or the result of cls(response)
        :rtype: ~azure.mgmt.keyvault.models.Secret
        :raises ~azure.core.exceptions.HttpResponseError:
        """
