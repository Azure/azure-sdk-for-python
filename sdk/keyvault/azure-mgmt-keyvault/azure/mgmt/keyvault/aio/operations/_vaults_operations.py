...
class VaultsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.keyvault.models.VaultCreateOrUpdateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Vault or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.keyvault.models.Vault]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.keyvault.models.VaultPatchParameters or IO[bytes]
        :return: Vault or the result of cls(response)
        :rtype: ~azure.mgmt.keyvault.models.Vault
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update_access_policy(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.keyvault.models.VaultAccessPolicyParameters or IO[bytes]
        :return: VaultAccessPolicyParameters or the result of cls(response)
        :rtype: ~azure.mgmt.keyvault.models.VaultAccessPolicyParameters
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(self, top: Optional[int] = None, **kwargs: Any) -> AsyncItemPaged["_models.Resource"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.keyvault.models.Resource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def check_name_availability(
        ...
        :type vault_name: ~azure.mgmt.keyvault.models.VaultCheckNameAvailabilityParameters or IO[bytes]
        :return: CheckNameAvailabilityResult or the result of cls(response)
        :rtype: ~azure.mgmt.keyvault.models.CheckNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
