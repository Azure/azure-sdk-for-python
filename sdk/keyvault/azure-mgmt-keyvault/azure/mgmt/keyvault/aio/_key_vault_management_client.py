...
class KeyVaultManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def keys(self):
        """Instance depends on the API version:
           ...
           * 2024-11-01: :class:`KeysOperations<azure.mgmt.keyvault.v2024_11_01.aio.operations.KeysOperations>`
        """
        ...
        if api_version == '2023-02-01':
            ...
            from ..v2024_11_01.aio.operations import KeysOperations as OperationClass
        else:
    ...
    def managed_hsm_keys(self):
        """Instance depends on the API version:
           ...
           * 2024-11-01: :class:`ManagedHsmKeysOperations<azure.mgmt.keyvault.v2024_11_01.aio.operations.ManagedHsmKeysOperations>`
        """
        ...
        if api_version == '2023-02-01':
            ...
            from ..v2024_11_01.aio.operations import ManagedHsmKeysOperations as OperationClass
        else:
    ...
    def managed_hsms(self):
        """Instance depends on the API version:
           ...
           * 2024-11-01: :class:`ManagedHsmsOperations<azure.mgmt.keyvault.v2024_11_01.aio.operations.ManagedHsmsOperations>`
        """
        ...
        if api_version == '2023-02-01':
            ...
            from ..v2024_11_01.aio.operations import ManagedHsmsOperations as OperationClass
        else:
    ...
    def mhsm_private_endpoint_connections(self):
        """Instance depends on the API version:
           ...
           * 2024-11-01: :class:`MHSMPrivateEndpointConnectionsOperations<azure.mgmt.keyvault.v2024_11_01.aio.operations.MHSMPrivateEndpointConnectionsOperations>`
        """
        ...
        if api_version == '2023-02-01':
            ...
            from ..v2024_11_01.aio.operations import MHSMPrivateEndpointConnectionsOperations as OperationClass
        else:
    ...
    def mhsm_private_link_resources(self):
        """Instance depends on the API version:
           ...
           * 2024-11-01: :class:`MHSMPrivateLinkResourcesOperations<azure.mgmt.keyvault.v2024_11_01.aio.operations.MHSMPrivateLinkResourcesOperations>`
        """
        ...
        if api_version == '2023-02-01':
            ...
            from ..v2024_11_01.aio.operations import MHSMPrivateLinkResourcesOperations as OperationClass
        else:
    ...
    def mhsm_regions(self):
        """Instance depends on the API version:
           ...
           * 2024-11-01: :class:`MHSMRegionsOperations<azure.mgmt.keyvault.v2024_11_01.aio.operations.MHSMRegionsOperations>`
        """
        ...
        if api_version == '2023-02-01':
            ...
            from ..v2024_11_01.aio.operations import MHSMRegionsOperations as OperationClass
        else:
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2024-11-01: :class:`Operations<azure.mgmt.keyvault.v2024_11_01.aio.operations.Operations>`
        """
    ...
    def private_endpoint_connections(self):
        """Instance depends on the API version:
           ...
           * 2024-11-01: :class:`PrivateEndpointConnectionsOperations<azure.mgmt.keyvault.v2024_11_01.aio.operations.PrivateEndpointConnectionsOperations>`
        """
        api_version = self._get_api_version('private_endpoint_connections')
        if api_version == '2023-02-01':
            from ..v2023_02_01.aio.operations import PrivateEndpointConnectionsOperations as OperationClass
        elif api_version == '2024-11-01':
            from ..v2024_11_01.aio.operations import PrivateEndpointConnectionsOperations as OperationClass
        else:
    ...
    def private_link_resources(self):
        """Instance depends on the API version:
           ...
           * 2024-11-01: :class:`PrivateLinkResourcesOperations<azure.mgmt.keyvault.v2024_11_01.aio.operations.PrivateLinkResourcesOperations>`
        """
        api_version = self._get_api_version('private_link_resources')
        if api_version == '2023-02-01':
            from ..v2023_02_01.aio.operations import PrivateLinkResourcesOperations as OperationClass
        elif api_version == '2024-11-01':
            from ..v2024_11_01.aio.operations import PrivateLinkResourcesOperations as OperationClass
        else:
    ...
    def secrets(self):
        """Instance depends on the API version:
           ...
           * 2024-11-01: :class:`SecretsOperations<azure.mgmt.keyvault.v2024_11_01.aio.operations.SecretsOperations>`
        """
        api_version = self._get_api_version('secrets')
        if api_version == '2023-02-01':
            from ..v2023_02_01.aio.operations import SecretsOperations as OperationClass
        elif api_version == '2024-11-01':
            from ..v2024_11_01.aio.operations import SecretsOperations as OperationClass
        else:
    ...
    def vaults(self):
        """Instance depends on the API version:
           ...
           * 2024-11-01: :class:`VaultsOperations<azure.mgmt.keyvault.v2024_11_01.aio.operations.VaultsOperations>`
        """
        ...
        if api_version == '2016-10-01':
            ...
            from ..v2024_11_01.aio.operations import VaultsOperations as OperationClass
        else:
