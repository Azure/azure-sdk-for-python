...
class VaultsOperations(object):
    ...
    def list_deleted(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DeletedVaultListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2018_02_14.models.DeletedVaultListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-02-14")  # type: str
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.keyvault.v2018_02_14.models.ResourceListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        filter = kwargs.pop('filter', "resourceType eq 'Microsoft.KeyVault/vaults'")  # type: str
        api_version = kwargs.pop('api_version', "2015-11-01")  # type: str
