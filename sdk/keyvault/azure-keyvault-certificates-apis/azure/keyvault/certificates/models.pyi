...
from .enums import ActionType, KeyCurveName, KeyType, KeyUsageType, SecretContentType
...
class Issuer:
    def __init__(self, properties: Optional[IssuerProperties]=..., attributes: Optional[models.IssuerAttributes]=..., account_id: Optional[str]=..., password: Optional[str]=..., organization_id: Optional[str]=..., admin_details: Optional[List[AdministratorDetails]]=...) -> None: ...
    @property
    def id(self) -> str: ...
    @property
    def name(self) -> str: ...
    ...
    @property
    def admin_details(self) -> List[AdministratorDetails]: ...

class LifetimeAction:
    def __init__(self, action_type: ActionType, lifetime_percentage: Optional[int]=..., days_before_expiry: Optional[int]=...) -> None: ...
    @property
