...
class RestoreOperationParameters(msrest.serialization.Model):
    ...
    :type sas_token_parameters: ~key_vault_client.models.SASTokenParameter
...
class RoleAssignmentListResult(msrest.serialization.Model):
    ...
    :type value: list[~key_vault_client.models.RoleAssignment]
...
class RoleDefinitionCreateParameters(msrest.serialization.Model):
    ...
    :type properties: ~key_vault_client.models.RoleDefinitionProperties
    """
...
class RoleDefinitionListResult(msrest.serialization.Model):
    ...
    :type value: list[~key_vault_client.models.RoleDefinition]
    :param next_link: The URL to use for getting the next set of results.
    :type next_link: str
    """
