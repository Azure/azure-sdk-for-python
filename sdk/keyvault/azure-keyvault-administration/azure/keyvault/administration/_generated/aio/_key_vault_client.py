...
class KeyVaultClient(KeyVaultClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype role_definitions: key_vault_client.aio.operations.RoleDefinitionsOperations
    :ivar role_assignments: RoleAssignmentsOperations operations
    :vartype role_assignments: key_vault_client.aio.operations.RoleAssignmentsOperations
