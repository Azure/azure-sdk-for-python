...
class RoleDefinitionsOperations:
    ...
    @distributed_trace
    def list(
        self, scope: str, *, _filter: Optional[str] = None, **kwargs: Any
    ) -> AsyncIterable["_models.RoleDefinition"]:
        """Get all role definitions that are applicable at scope and above.

        :param scope: The scope of the role definition. Required.
        :type scope: str
        :keyword _filter: The filter to apply on the operation. Use atScopeAndBelow filter to search
...
class RoleAssignmentsOperations:
    ...
    def list_for_scope(
        ...
        :type scope: str
        :keyword _filter: The filter to apply on the operation. Use $filter=atScope() to return all
         role
         assignments at or above the scope. Use $filter=principalId eq {id} to return
         all role assignments at, above or below the scope for the specified principal. Default value
         is None.
        :paramtype _filter: str
...
class KeyVaultClientOperationsMixin(KeyVaultClientMixinABC):
    ...
    async def full_backup_status(self, job_id: str, **kwargs: Any) -> _models.FullBackupOperation:
        ...
        Example:
            .. code-block:: python
                ...
                # response body for status code(s): 200
                response == {
                    "azureStorageBlobContainerUri": "str",
    ...
    async def _full_backup_initial(
        self,
        azure_storage_blob_container_uri: Optional[Union[_models.SASTokenParameter, JSON, IO[bytes]]] = None,
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_full_backup(
        ...
        **kwargs: Any
        ...
        :param azure_storage_blob_container_uri: Azure blob shared access signature token pointing to a
         ...
         stored. This token needs to be valid for at least next 24 hours from the time of making this
    ...
    async def begin_full_backup(
        ...
        **kwargs: Any
        ...
        :param azure_storage_blob_container_uri: Azure blob shared access signature token pointing to a
         valid Azure blob container where full backup needs to be
         stored. This token needs to be valid for at least next 24 hours from the time of making this
         call. Is one of the following types: SASTokenParameter, JSON, IO[bytes] Default value is None.
        :type azure_storage_blob_container_uri: ~azure.keyvault.administration.models.SASTokenParameter
         or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns FullBackupOperation. The
         FullBackupOperation is compatible with MutableMapping
        ...
        **kwargs: Any
        ...
        Example:
            .. code-block:: python
                ...
                # JSON input template you can fill out and use as your body input.
                pre_backup_operation_parameters = {
                    "storageResourceUri": "str",
                    "token": "str",
                    "useManagedIdentity": bool
                }
    ...
    async def pre_full_backup(
        self,
        pre_backup_operation_parameters: Optional[JSON] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.FullBackupOperation:
    ...
    async def pre_full_backup(
        self,
        pre_backup_operation_parameters: Optional[Union[_models.PreBackupOperationParameters, JSON, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.FullBackupOperation:
        """Pre-backup operation for checking whether the customer can perform a full
        backup operation.
    ...
    @overload
    async def pre_full_restore_operation(
        self,
        ...
        **kwargs: Any
        ...
        Example:
            .. code-block:: python
                ...
                # JSON input template you can fill out and use as your body input.
                pre_restore_operation_parameters = {
                    "folderToRestore": "str",
                    "sasTokenParameters": {
                        "storageResourceUri": "str",
                        "token": "str",
    ...
    async def _selective_key_restore_operation_initial(
        self,
        key_name: str,
        restore_blob_details: Optional[Union[_models.SelectiveKeyRestoreOperationParameters, JSON, IO[bytes]]] = None,
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_selective_key_restore_operation(
        ...
        **kwargs: Any
        ...
        :param restore_blob_details: The Azure blob SAS token pointing to a folder where the previous
         successful
         full backup was stored. Default value is None.
    ...
    async def begin_selective_key_restore_operation(
        ...
        **kwargs: Any
        ...
        :param restore_blob_details: The Azure blob SAS token pointing to a folder where the previous
         successful
         full backup was stored. Is one of the following types: SelectiveKeyRestoreOperationParameters,
