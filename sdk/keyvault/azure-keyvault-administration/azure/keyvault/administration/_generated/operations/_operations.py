...
def build_role_definitions_list_request(scope: str, *, _filter: Optional[str] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_role_assignments_list_for_scope_request(  # pylint: disable=name-too-long
    scope: str, *, _filter: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class RoleDefinitionsOperations:
    ...
    @distributed_trace
    def list(self, scope: str, *, _filter: Optional[str] = None, **kwargs: Any) -> Iterable["_models.RoleDefinition"]:
...
class KeyVaultClientOperationsMixin(KeyVaultClientMixinABC):
    ...
    @overload
    def pre_full_restore_operation(
        self,
