...
class KeyVaultClient(KeyVaultClientOperationsMixin):
    ...
    :vartype role_definitions: azure.keyvault.v7_3_preview.operations.RoleDefinitionsOperations
    :ivar role_assignments: RoleAssignmentsOperations operations
    :vartype role_assignments: azure.keyvault.v7_3_preview.operations.RoleAssignmentsOperations
