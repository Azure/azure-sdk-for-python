...
class CreateDedicatedCloudNodeRequest(BaseDedicatedCloudNode):
    ...
    def __init__(self, **kwargs):
        super(CreateDedicatedCloudNodeRequest, self).__init__(**kwargs)
        ...
        self.create_dedicated_cloud_node_request_id = kwargs.get('create_dedicated_cloud_node_request_id', None)
        self.create_dedicated_cloud_node_request_name = kwargs.get('create_dedicated_cloud_node_request_name', None)
        self.status = None
...
class DedicatedCloudNode(BaseDedicatedCloudNode):
    ...
    def __init__(self, **kwargs):
        ...
        self.provisioning_state = None
        self.purchase_id = kwargs.get('purchase_id', None)
        self.dedicated_cloud_node_id = kwargs.get('dedicated_cloud_node_id', None)
        self.dedicated_cloud_node_name = kwargs.get('dedicated_cloud_node_name', None)
        self.status = None
        self.vmware_cluster_name = None
