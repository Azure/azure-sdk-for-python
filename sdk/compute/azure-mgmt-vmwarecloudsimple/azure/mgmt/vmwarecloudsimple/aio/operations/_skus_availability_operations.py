...
class SkusAvailabilityOperations:
    """SkusAvailabilityOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.SkuAvailabilityListResponse"]:
        ...
        :return: An iterator like instance of either SkuAvailabilityListResponse or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.vmwarecloudsimple.models.SkuAvailabilityListResponse]
