...
class CustomizationPoliciesOperations:
    ...
    @distributed_trace
    def list(
        self, region_id: str, pc_name: str, filter: Optional[str] = None, **kwargs: Any
    ) -> AsyncIterable["_models.CustomizationPolicy"]:
    ...
    async def get(
        self, region_id: str, pc_name: str, customization_policy_name: str, **kwargs: Any
        ...
        request = build_get_request(
            region_id=region_id,
            pc_name=pc_name,
            customization_policy_name=customization_policy_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
