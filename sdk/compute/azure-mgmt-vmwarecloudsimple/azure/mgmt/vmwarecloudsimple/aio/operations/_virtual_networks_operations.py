...
class VirtualNetworksOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.VirtualNetworkListResponse"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.vmwarecloudsimple.models.VirtualNetworkListResponse]
