...
class ResourcePoolsOperations:
    ...
    def list(
        ...
        pc_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.ResourcePoolsListResponse"]:
        ...
        :return: An iterator like instance of either ResourcePoolsListResponse or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.vmwarecloudsimple.models.ResourcePoolsListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ResourcePoolsListResponse"]
        error_map = {
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.VMwareCloudSimple/locations/{regionId}/privateClouds/{pcName}/resourcePools'}  # type: ignore
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.VMwareCloudSimple/locations/{regionId}/privateClouds/{pcName}/resourcePools/{resourcePoolName}'}  # type: ignore
