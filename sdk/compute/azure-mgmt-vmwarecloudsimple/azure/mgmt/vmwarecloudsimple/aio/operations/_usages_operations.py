...
class UsagesOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.UsageListResponse"]:
        ...
        :return: An iterator like instance of either UsageListResponse or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.vmwarecloudsimple.models.UsageListResponse]
