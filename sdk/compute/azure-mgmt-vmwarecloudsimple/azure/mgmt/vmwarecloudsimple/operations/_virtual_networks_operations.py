...
def build_list_request(
    region_id: str, pc_name: str, subscription_id: str, *, resource_pool_name: str, **kwargs: Any
) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "pcName": _SERIALIZER.url("pc_name", pc_name, "str"),
    }
    ...
    _params["resourcePoolName"] = _SERIALIZER.query("resource_pool_name", resource_pool_name, "str")
...
def build_get_request(
    region_id: str, pc_name: str, virtual_network_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class VirtualNetworksOperations:
    ...
    @distributed_trace
    def list(
        self, region_id: str, pc_name: str, resource_pool_name: str, **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.vmwarecloudsimple.models.VirtualNetwork]
    ...
    @distributed_trace
    def get(self, region_id: str, pc_name: str, virtual_network_name: str, **kwargs: Any) -> _models.VirtualNetwork:
        ...
        :param pc_name: The private cloud name. Required.
        :type pc_name: str
        :param virtual_network_name: virtual network id (vsphereId). Required.
