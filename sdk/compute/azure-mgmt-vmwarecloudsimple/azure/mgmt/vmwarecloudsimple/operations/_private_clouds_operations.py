...
def build_list_request(region_id: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
...
def build_get_request(pc_name: str, region_id: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PrivateCloudsOperations:
    ...
    @distributed_trace
    def list(self, region_id: str, **kwargs: Any) -> Iterable["_models.PrivateCloud"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.vmwarecloudsimple.models.PrivateCloud]
    ...
    @distributed_trace
    def get(self, pc_name: str, region_id: str, **kwargs: Any) -> _models.PrivateCloud:
