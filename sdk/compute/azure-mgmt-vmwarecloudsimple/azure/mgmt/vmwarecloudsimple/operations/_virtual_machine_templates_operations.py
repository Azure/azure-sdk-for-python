...
def build_list_request(
    pc_name: str, region_id: str, subscription_id: str, *, resource_pool_name: str, **kwargs: Any
) -> HttpRequest:
...
def build_get_request(
    region_id: str, pc_name: str, virtual_machine_template_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class VirtualMachineTemplatesOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either VirtualMachineTemplate or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.vmwarecloudsimple.models.VirtualMachineTemplate]
