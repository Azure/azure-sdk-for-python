...
class VirtualMachineTemplatesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.VirtualMachineTemplateListResponse"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.vmwarecloudsimple.models.VirtualMachineTemplateListResponse]
