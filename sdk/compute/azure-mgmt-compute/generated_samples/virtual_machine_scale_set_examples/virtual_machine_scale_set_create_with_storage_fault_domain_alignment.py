...
# USAGE
    python virtual_machine_scale_set_create_with_storage_fault_domain_alignment.py
...
# x-ms-original-file: specification/compute/resource-manager/Microsoft.Compute/ComputeRP/stable/2025-11-01/examples/virtualMachineScaleSetExamples/VirtualMachineScaleSet_Create_WithStorageFaultDomainAlignment.json
