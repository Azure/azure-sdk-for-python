...
# USAGE
    python virtual_machine_scale_set_vm_diagnostic_run_command_create_or_update.py
...
def main():
    ...
    client.virtual_machine_scale_set_vm_diagnostic_run_commands.begin_create_or_update(
