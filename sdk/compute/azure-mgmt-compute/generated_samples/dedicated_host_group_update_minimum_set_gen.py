...
# USAGE
    python dedicated_host_group_update_minimum_set_gen.py
...
# x-ms-original-file: 2026-04-01/dedicatedHostExamples/DedicatedHostGroup_Update_MinimumSet_Gen.json
