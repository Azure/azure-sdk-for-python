...
# USAGE
    python virtual_machine_scale_set_create_with_max_instance_percent_per_zone_policy.py
    ...
    response = client.virtual_machine_scale_sets.begin_create_or_update(
        ...
        parameters={
            ...
            "properties": {
                "overprovision": False,
                "resiliencyPolicy": {
                    "zoneAllocationPolicy": {"maxInstancePercentPerZonePolicy": {"enabled": True, "value": 50}}
                },
