...
# USAGE
    python gallery_in_vm_access_control_profile_version_create.py
...
def main():
    ...
    response = client.gallery_in_vm_access_control_profile_versions.begin_create_or_update(
        ...
        gallery_in_vm_access_control_profile_version={
            ...
            "properties": {
                ...
                "rules": {
                    ...
                    "privileges": [{"name": "GoalState", "path": "/machine", "queryParameters": {"comp": "goalstate"}}],
...
# x-ms-original-file: 2025-12-03/galleryResourceProfileExamples/GalleryInVMAccessControlProfileVersion_Create.json
