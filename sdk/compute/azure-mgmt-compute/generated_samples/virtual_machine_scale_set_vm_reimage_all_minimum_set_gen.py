...
def main():
    ...
    client.virtual_machine_scale_set_vms.begin_reimage_all(
        ...
        instance_id="aaaaaaaaaaaaaaaaaaaaaaaaaaaa",
    ).result()


# x-ms-original-file: 2026-04-01/virtualMachineScaleSetExamples/VirtualMachineScaleSetVM_ReimageAll_MinimumSet_Gen.json
