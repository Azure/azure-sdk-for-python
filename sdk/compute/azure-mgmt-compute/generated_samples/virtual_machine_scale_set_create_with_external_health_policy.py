...
# USAGE
    python virtual_machine_scale_set_create_with_external_health_policy.py
...
# x-ms-original-file: 2025-11-01/virtualMachineScaleSetExamples/VirtualMachineScaleSet_Create_WithExternalHealthPolicy.json
