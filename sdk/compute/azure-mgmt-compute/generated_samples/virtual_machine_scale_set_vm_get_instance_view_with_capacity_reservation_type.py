...
# USAGE
    python virtual_machine_scale_set_vm_get_instance_view_with_capacity_reservation_type.py
...
def main():
    ...
    response = client.virtual_machine_scale_set_vms.get_instance_view(
