...
### Features Added
  ...
  - Model `GalleryScriptUpdate` added property `properties`
  - Model `GalleryScriptVersionUpdate` added property `properties`
  ...
  - Model `VirtualMachinesOperations` added parameter `force_deallocate` in method `begin_deallocate`
  ...
  - Added model `VirtualMachineScaleSetLifeCycleHookEventsOperations`
...
### Breaking Changes
  ...
  - Model `GalleryScriptUpdate` deleted or renamed its instance variable `description`
  - Model `GalleryScriptUpdate` deleted or renamed its instance variable `eula`
  - Model `GalleryScriptUpdate` deleted or renamed its instance variable `privacy_statement_uri`
  - Model `GalleryScriptUpdate` deleted or renamed its instance variable `release_note_uri`
  - Model `GalleryScriptUpdate` deleted or renamed its instance variable `end_of_life_date`
  - Model `GalleryScriptUpdate` deleted or renamed its instance variable `supported_os_type`
  - Model `GalleryScriptUpdate` deleted or renamed its instance variable `provisioning_state`
  - Model `GalleryScriptVersionUpdate` deleted or renamed its instance variable `publishing_profile`
  - Model `GalleryScriptVersionUpdate` deleted or renamed its instance variable `safety_profile`
  - Model `GalleryScriptVersionUpdate` deleted or renamed its instance variable `provisioning_state`
  - Model `GalleryScriptVersionUpdate` deleted or renamed its instance variable `replication_status`
  ...
  - Deleted or renamed model `GalleryScriptList`
  - Deleted or renamed model `GalleryScriptVersionList`
