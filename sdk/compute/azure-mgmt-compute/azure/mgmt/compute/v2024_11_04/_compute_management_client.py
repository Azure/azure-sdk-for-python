...
class ComputeManagementClient:
    ...
    :vartype cloud_service_role_instances:
     azure.mgmt.compute.v2024_11_04.operations.CloudServiceRoleInstancesOperations
    :ivar cloud_service_roles: CloudServiceRolesOperations operations
    :vartype cloud_service_roles:
     azure.mgmt.compute.v2024_11_04.operations.CloudServiceRolesOperations
    :ivar cloud_services: CloudServicesOperations operations
    :vartype cloud_services: azure.mgmt.compute.v2024_11_04.operations.CloudServicesOperations
    :ivar cloud_services_update_domain: CloudServicesUpdateDomainOperations operations
    :vartype cloud_services_update_domain:
     azure.mgmt.compute.v2024_11_04.operations.CloudServicesUpdateDomainOperations
    ...
    :vartype cloud_service_operating_systems:
     azure.mgmt.compute.v2024_11_04.operations.CloudServiceOperatingSystemsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.cloud_service_role_instances = CloudServiceRoleInstancesOperations(
            self._client, self._config, self._serialize, self._deserialize, "2024-11-04"
        )
