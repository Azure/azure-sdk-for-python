...
class AvailabilitySetsOperations:
    ...
    async def create_or_update(
        self, resource_group_name: str, name: str, parameters: "_models.AvailabilitySet", **kwargs: Any
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.AvailabilitySetListResult"]:
