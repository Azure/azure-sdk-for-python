...
class ComputeManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype disks: azure.mgmt.compute.v2021_08_01.aio.operations.DisksOperations
    :ivar snapshots: SnapshotsOperations operations
    :vartype snapshots: azure.mgmt.compute.v2021_08_01.aio.operations.SnapshotsOperations
    :ivar disk_encryption_sets: DiskEncryptionSetsOperations operations
    :vartype disk_encryption_sets:
     azure.mgmt.compute.v2021_08_01.aio.operations.DiskEncryptionSetsOperations
    :ivar disk_accesses: DiskAccessesOperations operations
    :vartype disk_accesses: azure.mgmt.compute.v2021_08_01.aio.operations.DiskAccessesOperations
    :ivar disk_restore_point: DiskRestorePointOperations operations
    :vartype disk_restore_point:
     azure.mgmt.compute.v2021_08_01.aio.operations.DiskRestorePointOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.disks = DisksOperations(self._client, self._config, self._serialize, self._deserialize, "2021-08-01")
