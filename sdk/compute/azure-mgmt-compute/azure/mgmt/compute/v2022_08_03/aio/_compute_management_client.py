...
class ComputeManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype community_gallery_image_versions:
     azure.mgmt.compute.v2022_08_03.aio.operations.CommunityGalleryImageVersionsOperations
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2022-08-03". Note that overriding this
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.galleries = GalleriesOperations(
            self._client, self._config, self._serialize, self._deserialize, "2022-08-03"
        )
