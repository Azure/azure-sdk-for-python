...
class ComputeManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype gallery_in_vm_access_control_profiles:
     azure.mgmt.compute.v2024_03_03.aio.operations.GalleryInVMAccessControlProfilesOperations
    ...
    :vartype community_gallery_image_versions:
     azure.mgmt.compute.v2024_03_03.aio.operations.CommunityGalleryImageVersionsOperations
