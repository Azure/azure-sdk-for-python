...
class ComputeManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype galleries: azure.mgmt.compute.v2024_03_03.operations.GalleriesOperations
    :ivar gallery_images: GalleryImagesOperations operations
    :vartype gallery_images: azure.mgmt.compute.v2024_03_03.operations.GalleryImagesOperations
    :ivar gallery_image_versions: GalleryImageVersionsOperations operations
    :vartype gallery_image_versions:
     azure.mgmt.compute.v2024_03_03.operations.GalleryImageVersionsOperations
    :ivar gallery_applications: GalleryApplicationsOperations operations
    :vartype gallery_applications:
     azure.mgmt.compute.v2024_03_03.operations.GalleryApplicationsOperations
    :ivar gallery_application_versions: GalleryApplicationVersionsOperations operations
    :vartype gallery_application_versions:
     azure.mgmt.compute.v2024_03_03.operations.GalleryApplicationVersionsOperations
    :ivar soft_deleted_resource: SoftDeletedResourceOperations operations
    :vartype soft_deleted_resource:
     azure.mgmt.compute.v2024_03_03.operations.SoftDeletedResourceOperations
    :ivar gallery_sharing_profile: GallerySharingProfileOperations operations
    :vartype gallery_sharing_profile:
     azure.mgmt.compute.v2024_03_03.operations.GallerySharingProfileOperations
    ...
    :vartype gallery_in_vm_access_control_profiles:
     azure.mgmt.compute.v2024_03_03.operations.GalleryInVMAccessControlProfilesOperations
    ...
    :vartype gallery_in_vm_access_control_profile_versions:
     azure.mgmt.compute.v2024_03_03.operations.GalleryInVMAccessControlProfileVersionsOperations
    :ivar shared_galleries: SharedGalleriesOperations operations
    :vartype shared_galleries: azure.mgmt.compute.v2024_03_03.operations.SharedGalleriesOperations
    :ivar shared_gallery_images: SharedGalleryImagesOperations operations
    :vartype shared_gallery_images:
     azure.mgmt.compute.v2024_03_03.operations.SharedGalleryImagesOperations
    :ivar shared_gallery_image_versions: SharedGalleryImageVersionsOperations operations
    :vartype shared_gallery_image_versions:
     azure.mgmt.compute.v2024_03_03.operations.SharedGalleryImageVersionsOperations
    :ivar community_galleries: CommunityGalleriesOperations operations
    :vartype community_galleries:
     azure.mgmt.compute.v2024_03_03.operations.CommunityGalleriesOperations
    :ivar community_gallery_images: CommunityGalleryImagesOperations operations
    :vartype community_gallery_images:
     azure.mgmt.compute.v2024_03_03.operations.CommunityGalleryImagesOperations
    ...
    :vartype community_gallery_image_versions:
     azure.mgmt.compute.v2024_03_03.operations.CommunityGalleryImageVersionsOperations
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2024-03-03". Note that overriding this
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.galleries = GalleriesOperations(
            self._client, self._config, self._serialize, self._deserialize, "2024-03-03"
        )
