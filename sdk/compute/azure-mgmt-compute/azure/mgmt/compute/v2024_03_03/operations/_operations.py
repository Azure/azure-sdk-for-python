...
def build_soft_deleted_resource_list_by_artifact_name_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    gallery_name: str,
    artifact_type: str,
    artifact_name: str,
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "galleryName": _SERIALIZER.url(
            "gallery_name", gallery_name, "str", pattern=r"^[a-zA-Z0-9]+([_]?[a-zA-Z0-9]+)*$"
        ),
        "artifactType": _SERIALIZER.url(
            "artifact_type", artifact_type, "str", pattern=r"^[a-zA-Z0-9]+([_]?[a-zA-Z0-9]+)*$"
        ),
        "artifactName": _SERIALIZER.url(
            "artifact_name", artifact_name, "str", pattern=r"^[a-zA-Z0-9]+([_]?[a-zA-Z0-9]+)*$"
        ),
    }
...
def build_gallery_in_vm_access_control_profiles_create_or_update_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    gallery_name: str,
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "inVMAccessControlProfileName": _SERIALIZER.url(
...
def build_gallery_in_vm_access_control_profiles_update_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    gallery_name: str,
    in_vm_access_control_profile_name: str,
    subscription_id: str,
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "galleryName": _SERIALIZER.url("gallery_name", gallery_name, "str"),
        "inVMAccessControlProfileName": _SERIALIZER.url(
            "in_vm_access_control_profile_name", in_vm_access_control_profile_name, "str"
        ),
    }
...
def build_gallery_in_vm_access_control_profiles_get_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    gallery_name: str,
    in_vm_access_control_profile_name: str,
    subscription_id: str,
...
def build_gallery_in_vm_access_control_profiles_delete_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    gallery_name: str,
    in_vm_access_control_profile_name: str,
    subscription_id: str,
...
def build_gallery_in_vm_access_control_profiles_list_by_gallery_request(  # pylint: disable=name-too-long
    resource_group_name: str, gallery_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_gallery_in_vm_access_control_profile_versions_create_or_update_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    gallery_name: str,
    in_vm_access_control_profile_name: str,
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "inVMAccessControlProfileVersionName": _SERIALIZER.url(
...
def build_gallery_in_vm_access_control_profile_versions_update_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    gallery_name: str,
    in_vm_access_control_profile_name: str,
    in_vm_access_control_profile_version_name: str,
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "inVMAccessControlProfileVersionName": _SERIALIZER.url(
            "in_vm_access_control_profile_version_name", in_vm_access_control_profile_version_name, "str"
        ),
    }
...
def build_gallery_in_vm_access_control_profile_versions_get_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    gallery_name: str,
    in_vm_access_control_profile_name: str,
    in_vm_access_control_profile_version_name: str,
...
def build_gallery_in_vm_access_control_profile_versions_delete_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    gallery_name: str,
    in_vm_access_control_profile_name: str,
    in_vm_access_control_profile_version_name: str,
...
def build_gallery_in_vm_access_control_profile_versions_list_by_gallery_in_vm_access_control_profile_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    gallery_name: str,
    in_vm_access_control_profile_name: str,
    subscription_id: str,
...
class GalleriesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.compute.v2024_03_03.ComputeManagementClient`'s
    ...
    def _create_or_update_initial(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._api_version or "2024-03-03"))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param gallery: Parameters supplied to the create or update Shared Image Gallery operation.
         Required.
        :type gallery: ~azure.mgmt.compute.v2024_03_03.models.Gallery
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Gallery or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.Gallery]
    ...
    def begin_create_or_update(
        ...
        :type gallery: ~azure.mgmt.compute.v2024_03_03.models.Gallery or IO[bytes]
        :return: An instance of LROPoller that returns either Gallery or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.Gallery]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery: ~azure.mgmt.compute.v2024_03_03.models.GalleryUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Gallery or the result of cls(response)
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery: ~azure.mgmt.compute.v2024_03_03.models.GalleryUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either Gallery or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.Gallery]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :keyword select: The select expression to apply on the operation. "Permissions" Default value
         is None.
        :paramtype select: str or ~azure.mgmt.compute.v2024_03_03.models.SelectPermissions
        :keyword expand: The expand query option to apply on the operation. "SharingProfile/Groups"
         Default value is None.
        :paramtype expand: str or ~azure.mgmt.compute.v2024_03_03.models.GalleryExpandParams
        :return: Gallery or the result of cls(response)
        :rtype: ~azure.mgmt.compute.v2024_03_03.models.Gallery
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Gallery"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2024_03_03.models.Gallery]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class GalleryImagesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param gallery_image: Parameters supplied to the create or update gallery image operation.
         Required.
        :type gallery_image: ~azure.mgmt.compute.v2024_03_03.models.GalleryImage
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GalleryImage or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.GalleryImage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gallery_image: ~azure.mgmt.compute.v2024_03_03.models.GalleryImage or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryImage or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.GalleryImage]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery_image: ~azure.mgmt.compute.v2024_03_03.models.GalleryImageUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GalleryImage or the result of
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery_image: ~azure.mgmt.compute.v2024_03_03.models.GalleryImageUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryImage or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.GalleryImage]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.compute.v2024_03_03.models.GalleryImage
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_by_gallery(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2024_03_03.models.GalleryImage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class GalleryImageVersionsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param gallery_image_version: Parameters supplied to the create or update gallery image version
         operation. Required.
        :type gallery_image_version: ~azure.mgmt.compute.v2024_03_03.models.GalleryImageVersion
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GalleryImageVersion or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.GalleryImageVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gallery_image_version: ~azure.mgmt.compute.v2024_03_03.models.GalleryImageVersion or
         IO[bytes]
        :return: An instance of LROPoller that returns either GalleryImageVersion or the result of
         cls(response)
        :rtype:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param gallery_image_version: Parameters supplied to the update gallery image version
         operation. Required.
        :type gallery_image_version: ~azure.mgmt.compute.v2024_03_03.models.GalleryImageVersionUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GalleryImageVersion or the result of
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :paramtype expand: str or ~azure.mgmt.compute.v2024_03_03.models.ReplicationStatusTypes
        :return: GalleryImageVersion or the result of cls(response)
        :rtype: ~azure.mgmt.compute.v2024_03_03.models.GalleryImageVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_by_gallery_image(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2024_03_03.models.GalleryImageVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class GalleryApplicationsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param gallery_application: Parameters supplied to the create or update gallery Application
         operation. Required.
        :type gallery_application: ~azure.mgmt.compute.v2024_03_03.models.GalleryApplication
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GalleryApplication or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.GalleryApplication]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gallery_application: ~azure.mgmt.compute.v2024_03_03.models.GalleryApplication or
         IO[bytes]
        :return: An instance of LROPoller that returns either GalleryApplication or the result of
         cls(response)
        :rtype:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param gallery_application: Parameters supplied to the update gallery Application operation.
         Required.
        :type gallery_application: ~azure.mgmt.compute.v2024_03_03.models.GalleryApplicationUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GalleryApplication or the result of
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery_application: ~azure.mgmt.compute.v2024_03_03.models.GalleryApplicationUpdate or
         IO[bytes]
        :return: An instance of LROPoller that returns either GalleryApplication or the result of
         cls(response)
        :rtype:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.compute.v2024_03_03.models.GalleryApplication
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_by_gallery(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2024_03_03.models.GalleryApplication]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class GalleryApplicationVersionsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gallery_application_version:
         ~azure.mgmt.compute.v2024_03_03.models.GalleryApplicationVersion
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GalleryApplicationVersion or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.GalleryApplicationVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param gallery_application_version: Parameters supplied to the create or update gallery
         ...
         Required.
        :type gallery_application_version:
         ~azure.mgmt.compute.v2024_03_03.models.GalleryApplicationVersion or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryApplicationVersion or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.GalleryApplicationVersion]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery_application_version:
         ~azure.mgmt.compute.v2024_03_03.models.GalleryApplicationVersionUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GalleryApplicationVersion or the result
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param gallery_application_version: Parameters supplied to the update gallery Application
         ...
         Required.
        :type gallery_application_version:
         ~azure.mgmt.compute.v2024_03_03.models.GalleryApplicationVersionUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryApplicationVersion or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.GalleryApplicationVersion]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.compute.v2024_03_03.models.GalleryApplicationVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_by_gallery_application(
        ...
        :return: An iterator like instance of either GalleryApplicationVersion or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2024_03_03.models.GalleryApplicationVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class SoftDeletedResourceOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~azure.mgmt.compute.v2024_03_03.ComputeManagementClient`'s
        :attr:`soft_deleted_resource` attribute.
    """
    ...
    def list_by_artifact_name(
        self, resource_group_name: str, gallery_name: str, artifact_type: str, artifact_name: str, **kwargs: Any
    ) -> Iterable["_models.GallerySoftDeletedResource"]:
        """List soft-deleted resources of an artifact in the gallery, such as soft-deleted gallery image
        version of an image.

        :param resource_group_name: The name of the resource group. Required.
        :type resource_group_name: str
        :param gallery_name: The name of the Gallery in which the soft-deleted resources resides.
         Required.
        :type gallery_name: str
        :param artifact_type: The type of the artifact to be listed, such as gallery image version.
         Required.
        :type artifact_type: str
        :param artifact_name: The artifact name to be listed. If artifact type is Images, then the
         artifact name should be the gallery image name. Required.
        :type artifact_name: str
        :return: An iterator like instance of either GallerySoftDeletedResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2024_03_03.models.GallerySoftDeletedResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_soft_deleted_resource_list_by_artifact_name_request(
                    resource_group_name=resource_group_name,
                    gallery_name=gallery_name,
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("GallerySoftDeletedResourceList", pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.next_link or None, iter(list_of_elem)
...
class GallerySharingProfileOperations:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type sharing_update: ~azure.mgmt.compute.v2024_03_03.models.SharingUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either SharingUpdate or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.SharingUpdate]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type sharing_update: ~azure.mgmt.compute.v2024_03_03.models.SharingUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either SharingUpdate or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.SharingUpdate]
        :raises ~azure.core.exceptions.HttpResponseError:
...
class GalleryInVMAccessControlProfilesOperations:  # pylint: disable=name-too-long
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~azure.mgmt.compute.v2024_03_03.ComputeManagementClient`'s
        :attr:`gallery_in_vm_access_control_profiles` attribute.
    """
    ...
    def _create_or_update_initial(
        ...
        gallery_name: str,
        in_vm_access_control_profile_name: str,
        gallery_in_vm_access_control_profile: Union[_models.GalleryInVMAccessControlProfile, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(gallery_in_vm_access_control_profile, (IOBase, bytes)):
            ...
            _json = self._serialize.body(gallery_in_vm_access_control_profile, "GalleryInVMAccessControlProfile")
    ...
    def begin_create_or_update(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.GalleryInVMAccessControlProfile]:
        """Create or update a gallery inVMAccessControlProfile.

        :param resource_group_name: The name of the resource group. Required.
        :type resource_group_name: str
        :param gallery_name: The name of the Shared Image Gallery in which the InVMAccessControlProfile
         is to be created. Required.
        :type gallery_name: str
        :param in_vm_access_control_profile_name: The name of the gallery inVMAccessControlProfile to
         be created or updated. The allowed characters are alphabets and numbers with dots, dashes, and
         periods allowed in the middle. The maximum length is 80 characters. Required.
        ...
        :type gallery_in_vm_access_control_profile:
         ~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfile
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GalleryInVMAccessControlProfile or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gallery_in_vm_access_control_profile:
         ~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfile or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryInVMAccessControlProfile or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfile]
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("GalleryInVMAccessControlProfile", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.GalleryInVMAccessControlProfile].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.GalleryInVMAccessControlProfile](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    def _update_initial(
        ...
        gallery_name: str,
        in_vm_access_control_profile_name: str,
        gallery_in_vm_access_control_profile: Union[_models.GalleryInVMAccessControlProfileUpdate, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(gallery_in_vm_access_control_profile, (IOBase, bytes)):
            ...
            _json = self._serialize.body(gallery_in_vm_access_control_profile, "GalleryInVMAccessControlProfileUpdate")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery_name: str
        :param in_vm_access_control_profile_name: The name of the gallery inVMAccessControlProfile to
         be updated. The allowed characters are alphabets and numbers with dots, dashes, and periods
         allowed in the middle. The maximum length is 80 characters. Required.
        :type in_vm_access_control_profile_name: str
        ...
        :type gallery_in_vm_access_control_profile:
         ~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfileUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GalleryInVMAccessControlProfile or the
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery_in_vm_access_control_profile:
         ~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfileUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryInVMAccessControlProfile or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfile]
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, gallery_name: str, in_vm_access_control_profile_name: str, **kwargs: Any
    ) -> _models.GalleryInVMAccessControlProfile:
        """Retrieves information about a gallery inVMAccessControlProfile.

        :param resource_group_name: The name of the resource group. Required.
        :type resource_group_name: str
        :param gallery_name: The name of the Shared Image Gallery from which the
         InVMAccessControlProfiles are to be retrieved. Required.
        :type gallery_name: str
        :param in_vm_access_control_profile_name: The name of the gallery inVMAccessControlProfile to
         be retrieved. Required.
        :type in_vm_access_control_profile_name: str
        :return: GalleryInVMAccessControlProfile or the result of cls(response)
        :rtype: ~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_delete(
        ...
        :param resource_group_name: The name of the resource group. Required.
        :type resource_group_name: str
        :param gallery_name: he name of the Shared Image Gallery in which the InVMAccessControlProfile
         resides. Required.
        :type gallery_name: str
        :param in_vm_access_control_profile_name: The name of the gallery inVMAccessControlProfile to
         be deleted. Required.
    ...
    def list_by_gallery(
        self, resource_group_name: str, gallery_name: str, **kwargs: Any
    ) -> Iterable["_models.GalleryInVMAccessControlProfile"]:
        """List gallery inVMAccessControlProfiles in a gallery.

        :param resource_group_name: The name of the resource group. Required.
        :type resource_group_name: str
        :param gallery_name: The name of the Shared Image Gallery from which the
         InVMAccessControlProfiles are to be listed. Required.
        :type gallery_name: str
        :return: An iterator like instance of either GalleryInVMAccessControlProfile or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._api_version or "2024-03-03"))
        cls: ClsType[_models.GalleryInVMAccessControlProfileList] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_gallery_in_vm_access_control_profiles_list_by_gallery_request(
                    resource_group_name=resource_group_name,
                    gallery_name=gallery_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("GalleryInVMAccessControlProfileList", pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.next_link or None, iter(list_of_elem)
...
class GalleryInVMAccessControlProfileVersionsOperations:  # pylint: disable=name-too-long
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~azure.mgmt.compute.v2024_03_03.ComputeManagementClient`'s
        :attr:`gallery_in_vm_access_control_profile_versions` attribute.
    """
    ...
    def _create_or_update_initial(
        ...
        in_vm_access_control_profile_name: str,
        in_vm_access_control_profile_version_name: str,
        gallery_in_vm_access_control_profile_version: Union[_models.GalleryInVMAccessControlProfileVersion, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param gallery_name: The name of the Shared Image Gallery in which the inVMAccessControlProfile
         resides. Required.
        :type gallery_name: str
        :param in_vm_access_control_profile_name: The name of the gallery inVMAccessControlProfile in
         which the inVMAccessControlProfile version is to be created. Required.
        :type in_vm_access_control_profile_name: str
        ...
        :type gallery_in_vm_access_control_profile_version:
         ~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfileVersion
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GalleryInVMAccessControlProfileVersion or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfileVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gallery_in_vm_access_control_profile_version:
         ~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfileVersion or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryInVMAccessControlProfileVersion or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfileVersion]
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("GalleryInVMAccessControlProfileVersion", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.GalleryInVMAccessControlProfileVersion].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
    ...
    def _update_initial(
        ...
        gallery_in_vm_access_control_profile_version: Union[
            _models.GalleryInVMAccessControlProfileVersionUpdate, IO[bytes]
        ],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery_name: str
        :param in_vm_access_control_profile_name: The name of the gallery inVMAccessControlProfile in
         which the inVMAccessControlProfile version is to be updated. Required.
        :type in_vm_access_control_profile_name: str
        :param in_vm_access_control_profile_version_name: The name of the gallery
        ...
        :type gallery_in_vm_access_control_profile_version:
         ~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfileVersionUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GalleryInVMAccessControlProfileVersion or
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery_in_vm_access_control_profile_version:
         ~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfileVersionUpdate or
         IO[bytes]
        :return: An instance of LROPoller that returns either GalleryInVMAccessControlProfileVersion or
         the result of cls(response)
        :rtype:
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :type gallery_name: str
        :param in_vm_access_control_profile_name: The name of the gallery inVMAccessControlProfile in
         which the inVMAccessControlProfile version resides. Required.
        :type in_vm_access_control_profile_name: str
        :param in_vm_access_control_profile_version_name: The name of the gallery
         inVMAccessControlProfile version to be retrieved. Required.
        :type in_vm_access_control_profile_version_name: str
        :return: GalleryInVMAccessControlProfileVersion or the result of cls(response)
        :rtype: ~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfileVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_delete(
        ...
        **kwargs: Any
        ...
        :type in_vm_access_control_profile_name: str
        :param in_vm_access_control_profile_version_name: The name of the gallery
         inVMAccessControlProfile version to be deleted. Required.
        :type in_vm_access_control_profile_version_name: str
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    @distributed_trace
    def list_by_gallery_in_vm_access_control_profile(  # pylint: disable=name-too-long
        self, resource_group_name: str, gallery_name: str, in_vm_access_control_profile_name: str, **kwargs: Any
    ) -> Iterable["_models.GalleryInVMAccessControlProfileVersion"]:
        ...
        :param gallery_name: The name of the Shared Image Gallery in which the inVMAccessControlProfile
         resides. Required.
        :type gallery_name: str
        :param in_vm_access_control_profile_name: The name of the gallery inVMAccessControlProfile from
         which the inVMAccessControlProfile versions are to be listed. Required.
        :type in_vm_access_control_profile_name: str
        :return: An iterator like instance of either GalleryInVMAccessControlProfileVersion or the
         result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2024_03_03.models.GalleryInVMAccessControlProfileVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._api_version or "2024-03-03"))
        cls: ClsType[_models.GalleryInVMAccessControlProfileVersionList] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_gallery_in_vm_access_control_profile_versions_list_by_gallery_in_vm_access_control_profile_request(
                    resource_group_name=resource_group_name,
                    gallery_name=gallery_name,
                    in_vm_access_control_profile_name=in_vm_access_control_profile_name,
                    subscription_id=self._config.subscription_id,
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("GalleryInVMAccessControlProfileVersionList", pipeline_response)
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.next_link or None, iter(list_of_elem)
...
class SharedGalleriesOperations:
    ...
    def list(
        ...
        :paramtype shared_to: str or ~azure.mgmt.compute.v2024_03_03.models.SharedToValues
        :return: An iterator like instance of either SharedGallery or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2024_03_03.models.SharedGallery]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get(self, location: str, gallery_unique_name: str, **kwargs: Any) -> _models.SharedGallery:
        ...
        :rtype: ~azure.mgmt.compute.v2024_03_03.models.SharedGallery
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class SharedGalleryImagesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2024_03_03.models.SharedGalleryImage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.compute.v2024_03_03.models.SharedGalleryImage
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either SharedGalleryImageVersion or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2024_03_03.models.SharedGalleryImageVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CommunityGalleriesOperations:
    ...
    def get(self, location: str, public_gallery_name: str, **kwargs: Any) -> _models.CommunityGallery:
        ...
        :rtype: ~azure.mgmt.compute.v2024_03_03.models.CommunityGallery
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class CommunityGalleryImagesOperations:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.compute.v2024_03_03.models.CommunityGalleryImage
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list(self, location: str, public_gallery_name: str, **kwargs: Any) -> Iterable["_models.CommunityGalleryImage"]:
        ...
        :return: An iterator like instance of either CommunityGalleryImage or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2024_03_03.models.CommunityGalleryImage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CommunityGalleryImageVersionsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either CommunityGalleryImageVersion or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2024_03_03.models.CommunityGalleryImageVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
