...
class ResourceSkusOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ResourceSkusResult"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2017_03_30.models.ResourceSkusResult]
