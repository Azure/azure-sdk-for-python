...
from ...operations._virtual_machine_scale_set_rolling_upgrades_operations import build_cancel_request_initial, build_get_latest_request, build_start_os_upgrade_request_initial
T = TypeVar('T')
