...
from ...operations._virtual_machines_operations import (
    build_capture_request_initial,
    build_convert_to_managed_disks_request_initial,
...
class VirtualMachinesOperations:
    ...
    def list_by_location(self, location: str, **kwargs: Any) -> AsyncIterable["_models.VirtualMachineListResult"]:
        ...
        :return: An iterator like instance of either VirtualMachineListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2017_03_30.models.VirtualMachineListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, vm_name: str, parameters: "_models.VirtualMachine", **kwargs: Any
    ...
    async def get(
        self, resource_group_name: str, vm_name: str, expand: Optional[str] = "instanceView", **kwargs: Any
    ) -> "_models.VirtualMachine":
    ...
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.VirtualMachineListResult"]:
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.VirtualMachineListResult"]:
    ...
    def list_available_sizes(
        ...
        :return: An iterator like instance of either VirtualMachineSizeListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2017_03_30.models.VirtualMachineSizeListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _run_command_initial(
        self, resource_group_name: str, vm_name: str, parameters: "_models.RunCommandInput", **kwargs: Any
