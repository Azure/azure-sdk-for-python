...
class VirtualMachineInstanceView(Model):
    ...
    def __init__(self, *, platform_update_domain: int=None, platform_fault_domain: int=None, rdp_thumb_print: str=None, vm_agent=None, maintenance_redeploy_status=None, disks=None, extensions=None, boot_diagnostics=None, statuses=None, **kwargs) -> None:
...
class VirtualMachineScaleSetNetworkConfiguration(SubResource):
    ...
    def __init__(self, *, name: str, ip_configurations, id: str=None, primary: bool=None, enable_accelerated_networking: bool=None, network_security_group=None, dns_settings=None, **kwargs) -> None:
...
class VirtualMachineScaleSetUpdateNetworkConfiguration(SubResource):
    ...
    def __init__(self, *, id: str=None, name: str=None, primary: bool=None, enable_accelerated_networking: bool=None, network_security_group=None, dns_settings=None, ip_configurations=None, **kwargs) -> None:
