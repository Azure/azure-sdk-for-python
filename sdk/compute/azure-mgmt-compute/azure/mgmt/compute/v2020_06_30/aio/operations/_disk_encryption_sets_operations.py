...
class DiskEncryptionSetsOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(disk_encryption_set, "DiskEncryptionSet")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either DiskEncryptionSet or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2020_06_30.models.DiskEncryptionSet]
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(disk_encryption_set, "DiskEncryptionSetUpdate")
    ...
    async def _delete_initial(self, resource_group_name: str, disk_encryption_set_name: str, **kwargs: Any) -> None:
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either DiskEncryptionSetList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2020_06_30.models.DiskEncryptionSetList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.DiskEncryptionSetList"]:
    ...
    def list_associated_resources(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2020_06_30.models.ResourceUriList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
