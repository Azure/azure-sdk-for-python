...
class DiskEncryptionSetsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type disk_encryption_set: ~azure.mgmt.compute.v2020_06_30.models.DiskEncryptionSet or IO
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param disk_encryption_set: disk encryption set object supplied in the body of the Patch disk
         encryption set operation. Is either a model type or a IO type. Required.
        :type disk_encryption_set: ~azure.mgmt.compute.v2020_06_30.models.DiskEncryptionSetUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2020_06_30.models.DiskEncryptionSet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
