...
class DisksOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2020_06_30.models.Disk]
    ...
    async def begin_create_or_update(
        ...
        :type disk: ~azure.mgmt.compute.v2020_06_30.models.Disk or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Disk or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2020_06_30.models.Disk]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update(
        ...
        :type disk: ~azure.mgmt.compute.v2020_06_30.models.DiskUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Disk or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2020_06_30.models.Disk]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.Disk"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2020_06_30.models.Disk]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_grant_access(
        ...
        **kwargs: Any
        ...
        :type grant_access_data: ~azure.mgmt.compute.v2020_06_30.models.GrantAccessData or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either AccessUri or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2020_06_30.models.AccessUri]
        :raises ~azure.core.exceptions.HttpResponseError:
...
class SnapshotsOperations:
    ...
    async def begin_create_or_update(
        ...
        :type snapshot: ~azure.mgmt.compute.v2020_06_30.models.Snapshot or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Snapshot or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2020_06_30.models.Snapshot]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type snapshot: ~azure.mgmt.compute.v2020_06_30.models.SnapshotUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Snapshot or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2020_06_30.models.Snapshot]
        :raises ~azure.core.exceptions.HttpResponseError:
...
class DiskEncryptionSetsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type disk_encryption_set: ~azure.mgmt.compute.v2020_06_30.models.DiskEncryptionSet or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either DiskEncryptionSet or the result of
         cls(response)
        :rtype:
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param disk_encryption_set: disk encryption set object supplied in the body of the Patch disk
         ...
         Required.
        :type disk_encryption_set: ~azure.mgmt.compute.v2020_06_30.models.DiskEncryptionSetUpdate or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either DiskEncryptionSet or the result of
         cls(response)
        :rtype:
...
class DiskAccessesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param disk_access: disk access object supplied in the body of the Put disk access operation.
         Required.
        :type disk_access: ~azure.mgmt.compute.v2020_06_30.models.DiskAccess
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either DiskAccess or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2020_06_30.models.DiskAccess]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type disk_access: ~azure.mgmt.compute.v2020_06_30.models.DiskAccess or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either DiskAccess or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2020_06_30.models.DiskAccess]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type disk_access: ~azure.mgmt.compute.v2020_06_30.models.DiskAccessUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either DiskAccess or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2020_06_30.models.DiskAccess]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.DiskAccess"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2020_06_30.models.DiskAccess]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
