...
class DiskAccessesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs
        ...
        :type disk_access: ~azure.mgmt.compute.v2021_03_01.models.DiskAccess
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2021_03_01.models.DiskAccess]
    ...
    async def begin_update(
        ...
        **kwargs
        ...
        :type disk_access: ~azure.mgmt.compute.v2021_03_01.models.DiskAccessUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.compute.v2021_03_01.models.DiskAccess
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.DiskAccess"]
        error_map = {
    ...
    def list_by_resource_group(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2021_03_01.models.DiskAccessList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_private_link_resources(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.compute.v2021_03_01.models.PrivateLinkResourceListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_update_a_private_endpoint_connection(
        ...
        **kwargs
        ...
        :type private_endpoint_connection: ~azure.mgmt.compute.v2021_03_01.models.PrivateEndpointConnection
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2021_03_01.models.PrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PrivateEndpointConnection"]
    ...
    async def get_a_private_endpoint_connection(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.compute.v2021_03_01.models.PrivateEndpointConnection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PrivateEndpointConnection"]
        error_map = {
    ...
    def list_private_endpoint_connections(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2021_03_01.models.PrivateEndpointConnectionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
