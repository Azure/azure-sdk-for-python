...
from ...operations._dedicated_hosts_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_host_group_request, build_update_request_initial
T = TypeVar('T')
    ...
    def list_by_host_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DedicatedHostListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2021_03_01.models.DedicatedHostListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
