...
from ...operations._cloud_service_operating_systems_operations import build_get_os_family_request, build_get_os_version_request, build_list_os_families_request, build_list_os_versions_request
T = TypeVar('T')
