...
class VirtualMachineRunCommandsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2021_03_01.models.RunCommandListResult]
    ...
    async def get_by_virtual_machine(
        ...
        **kwargs: Any
        ...
        # Construct URL
        url = self.get_by_virtual_machine.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'vmName': self._serialize.url("vm_name", vm_name, 'str'),
            'runCommandName': self._serialize.url("run_command_name", run_command_name, 'str'),
