...
class SshPublicKeysOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.SshPublicKeysGroupListResult"]:
        ...
        :return: An iterator like instance of either SshPublicKeysGroupListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2021_03_01.models.SshPublicKeysGroupListResult]
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(parameters, "SshPublicKeyResource")
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(parameters, "SshPublicKeyUpdateResource")
