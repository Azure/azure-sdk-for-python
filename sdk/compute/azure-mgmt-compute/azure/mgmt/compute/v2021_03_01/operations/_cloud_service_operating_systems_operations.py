...
def build_get_os_version_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/cloudServiceOsVersions/{osVersionName}')
...
def build_list_os_versions_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/cloudServiceOsVersions')
    path_format_arguments = {
        'location': _SERIALIZER.url("location", location, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
...
def build_get_os_family_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/cloudServiceOsFamilies/{osFamilyName}')
    path_format_arguments = {
        'location': _SERIALIZER.url("location", location, 'str'),
...
def build_list_os_families_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/cloudServiceOsFamilies')
    path_format_arguments = {
        'location': _SERIALIZER.url("location", location, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
...
class CloudServiceOperatingSystemsOperations(object):
    ...
    def list_os_versions(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.OSVersionListResult"]
    ...
    def list_os_families(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.OSFamilyListResult"]
