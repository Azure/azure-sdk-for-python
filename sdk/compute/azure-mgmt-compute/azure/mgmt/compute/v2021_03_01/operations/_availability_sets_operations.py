...
class AvailabilitySetsOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.v2021_03_01.models.AvailabilitySet or IO
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the Update Availability Set operation. Is either a
         model type or a IO type. Required.
        :type parameters: ~azure.mgmt.compute.v2021_03_01.models.AvailabilitySetUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_available_sizes(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2021_03_01.models.VirtualMachineSize]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
