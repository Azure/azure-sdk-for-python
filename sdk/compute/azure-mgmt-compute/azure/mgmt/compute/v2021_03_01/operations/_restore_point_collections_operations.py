...
def build_create_or_update_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/restorePointCollections/{restorePointCollectionName}')
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    expand = kwargs.pop('expand', None)  # type: Optional[Union[str, "_models.RestorePointCollectionExpandOptions"]]
...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/restorePointCollections')
    path_format_arguments = {
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
    }
...
def build_list_all_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Compute/restorePointCollections')
    path_format_arguments = {
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
    url = _format_url_section(url, **path_format_arguments)
...
# fmt: on
class RestorePointCollectionsOperations(object):
    ...
    def create_or_update(
        ...
        resource_group_name,  # type: str
        restore_point_collection_name,  # type: str
        parameters,  # type: "_models.RestorePointCollection"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.RestorePointCollection"
    ...
    def update(
        ...
        resource_group_name,  # type: str
        restore_point_collection_name,  # type: str
        parameters,  # type: "_models.RestorePointCollectionUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.RestorePointCollection"
    ...
    def get(
        ...
        resource_group_name,  # type: str
        restore_point_collection_name,  # type: str
        expand=None,  # type: Optional[Union[str, "_models.RestorePointCollectionExpandOptions"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.RestorePointCollection"
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.RestorePointCollectionListResult"]
        ...
        :return: An iterator like instance of either RestorePointCollectionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2021_03_01.models.RestorePointCollectionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
