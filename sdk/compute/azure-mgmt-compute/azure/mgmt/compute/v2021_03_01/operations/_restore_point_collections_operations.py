...
class RestorePointCollectionsOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        body_content = self._serialize.body(parameters, 'RestorePointCollection')
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'RestorePointCollectionUpdate')
        body_content_kwargs['content'] = body_content
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either RestorePointCollectionListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2021_03_01.models.RestorePointCollectionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
