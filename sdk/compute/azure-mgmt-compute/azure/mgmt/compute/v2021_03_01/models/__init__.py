...
try:
    ...
    from ._models import VirtualMachineNetworkInterfaceDnsSettingsConfiguration  # type: ignore
    from ._models import VirtualMachineNetworkInterfaceIPConfiguration  # type: ignore
