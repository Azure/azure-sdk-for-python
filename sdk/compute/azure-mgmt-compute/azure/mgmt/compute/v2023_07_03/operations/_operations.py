...
class GalleryApplicationsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gallery_application: ~azure.mgmt.compute.v2023_07_03.models.GalleryApplication or
         IO[bytes]
        :return: An instance of LROPoller that returns either GalleryApplication or the result of
         cls(response)
        :rtype:
...
class GallerySharingProfileOperations:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type sharing_update: ~azure.mgmt.compute.v2023_07_03.models.SharingUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either SharingUpdate or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2023_07_03.models.SharingUpdate]
        :raises ~azure.core.exceptions.HttpResponseError:
