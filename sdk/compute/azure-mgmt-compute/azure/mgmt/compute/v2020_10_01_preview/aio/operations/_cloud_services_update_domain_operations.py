...
class CloudServicesUpdateDomainOperations:
    ...
    async def _walk_update_domain_initial(
        ...
        **kwargs: Any
        ...
        if parameters is not None:
            json = self._serialize.body(parameters, "UpdateDomain")
        else:
            json = None
    ...
    def list_update_domains(
        ...
        :return: An iterator like instance of either UpdateDomainListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2020_10_01_preview.models.UpdateDomainListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
