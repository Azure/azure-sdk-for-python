...
class ComputeManagementClient(object):
    ...
    :vartype disks: azure.mgmt.compute.v2020_05_01.aio.operations_async.DisksOperations
    :ivar snapshots: SnapshotsOperations operations
    :vartype snapshots: azure.mgmt.compute.v2020_05_01.aio.operations_async.SnapshotsOperations
    :ivar disk_encryption_sets: DiskEncryptionSetsOperations operations
    :vartype disk_encryption_sets: azure.mgmt.compute.v2020_05_01.aio.operations_async.DiskEncryptionSetsOperations
    :ivar disk_accesses: DiskAccessesOperations operations
    :vartype disk_accesses: azure.mgmt.compute.v2020_05_01.aio.operations_async.DiskAccessesOperations
