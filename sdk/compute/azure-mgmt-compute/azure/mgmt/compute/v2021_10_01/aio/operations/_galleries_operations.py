...
from ...operations._galleries_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_resource_group_request, build_list_request, build_update_request_initial
T = TypeVar('T')
...
class GalleriesOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :type gallery_name: str
        :param select: The select expression to apply on the operation. Default value is None.
        :type select: str or ~azure.mgmt.compute.v2021_10_01.models.SelectPermissions
        :param expand: The expand query option to apply on the operation. Default value is None.
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2021_10_01.models.GalleryList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
