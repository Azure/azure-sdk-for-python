...
class DiskInstanceView(msrest.serialization.Model):
    ...
    def __init__(self, *, name: Optional[str] = None, statuses: Optional[List["InstanceViewStatus"]] = None, **kwargs):
...
class UpgradePolicy(msrest.serialization.Model):
    ...
    def __init__(self, *, mode: Optional[Union[str, "UpgradeMode"]] = None, **kwargs):
...
class VirtualMachineListResult(msrest.serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["VirtualMachine"]] = None, next_link: Optional[str] = None, **kwargs):
...
class VirtualMachineScaleSetListResult(msrest.serialization.Model):
    ...
    def __init__(
        self, *, value: Optional[List["VirtualMachineScaleSet"]] = None, next_link: Optional[str] = None, **kwargs
    ):
...
class VirtualMachineScaleSetVMListResult(msrest.serialization.Model):
    ...
    def __init__(
        self, *, value: Optional[List["VirtualMachineScaleSetVM"]] = None, next_link: Optional[str] = None, **kwargs
    ):
