...
class VirtualMachineScaleSetVMExtensionsOperations(object):
    ...
    def _create_or_update_initial(
        ...
        extension_parameters,  # type: "_models.VirtualMachineScaleSetVMExtension"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.VirtualMachineScaleSetVMExtension"
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.VirtualMachineScaleSetVMExtension"]
        ...
        :param extension_parameters: Parameters supplied to the Create Virtual Machine Extension
         operation.
        :type extension_parameters: ~azure.mgmt.compute.v2020_12_01.models.VirtualMachineScaleSetVMExtension
        ...
        :return: An instance of LROPoller that returns either VirtualMachineScaleSetVMExtension or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2020_12_01.models.VirtualMachineScaleSetVMExtension]
    ...
    def _update_initial(
        ...
        instance_id,  # type: str
        vm_extension_name,  # type: str
        extension_parameters,  # type: "_models.VirtualMachineScaleSetVMExtensionUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.VirtualMachineScaleSetVMExtension"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.VirtualMachineScaleSetVMExtension"]
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        :param extension_parameters: Parameters supplied to the Update Virtual Machine Extension
         operation.
        :type extension_parameters: ~azure.mgmt.compute.v2020_12_01.models.VirtualMachineScaleSetVMExtensionUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.VirtualMachineScaleSetVMExtensionsListResult"
