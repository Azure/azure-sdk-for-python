...
class SnapshotsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2020_12_01.models.Snapshot]
    ...
    def begin_create_or_update(
        ...
        :type snapshot: ~azure.mgmt.compute.v2020_12_01.models.Snapshot or IO
    ...
    def begin_update(
        ...
        :type snapshot: ~azure.mgmt.compute.v2020_12_01.models.SnapshotUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Snapshot"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2020_12_01.models.Snapshot]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
