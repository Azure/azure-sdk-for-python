...
def build_create_or_update_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.DedicatedHostGroup] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_update_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.DedicatedHostGroupUpdate] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DedicatedHostGroupListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2020_12_01.models.DedicatedHostGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
