...
from ...operations._disk_accesses_operations import (
    ...
    build_list_request,
    build_update_a_private_endpoint_connection_request_initial,
...
class DiskAccessesOperations:
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, disk_access_name: str, disk_access: "_models.DiskAccess", **kwargs: Any
    ) -> "_models.DiskAccess":
        ...
        json = self._serialize.body(disk_access, "DiskAccess")
    ...
    async def begin_create_or_update(
        ...
        :return: An instance of AsyncLROPoller that returns either DiskAccess or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2020_12_01.models.DiskAccess]
    ...
    async def _update_initial(
        self, resource_group_name: str, disk_access_name: str, disk_access: "_models.DiskAccessUpdate", **kwargs: Any
    ) -> "_models.DiskAccess":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.DiskAccess"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        ...
        json = self._serialize.body(disk_access, "DiskAccessUpdate")
    ...
    async def _delete_initial(self, resource_group_name: str, disk_access_name: str, **kwargs: Any) -> None:
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2020_12_01.models.DiskAccessList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.DiskAccessList"]:
    ...
    async def _update_a_private_endpoint_connection_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(private_endpoint_connection, "PrivateEndpointConnection")
    ...
    async def begin_update_a_private_endpoint_connection(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2020_12_01.models.PrivateEndpointConnection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def _delete_a_private_endpoint_connection_initial(
        self, resource_group_name: str, disk_access_name: str, private_endpoint_connection_name: str, **kwargs: Any
    ) -> None:
        cls = kwargs.pop("cls", None)  # type: ClsType[None]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
    ...
    def list_private_endpoint_connections(
        ...
        :return: An iterator like instance of either PrivateEndpointConnectionListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2020_12_01.models.PrivateEndpointConnectionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
