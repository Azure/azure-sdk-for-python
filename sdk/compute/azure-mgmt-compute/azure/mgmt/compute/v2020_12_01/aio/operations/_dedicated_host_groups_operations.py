...
class DedicatedHostGroupsOperations:
    ...
    async def get(
        self, resource_group_name: str, host_group_name: str, expand: Optional[str] = "instanceView", **kwargs: Any
    ) -> "_models.DedicatedHostGroup":
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either DedicatedHostGroupListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2020_12_01.models.DedicatedHostGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
