...
class GalleriesOperations:
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, gallery_name: str, gallery: "_models.Gallery", **kwargs: Any
    ) -> "_models.Gallery":
        ...
        json = self._serialize.body(gallery, "Gallery")
    ...
    async def _delete_initial(self, resource_group_name: str, gallery_name: str, **kwargs: Any) -> None:
    ...
    async def begin_delete(self, resource_group_name: str, gallery_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
        ...
        if cont_token is None:
            raw_result = await self._delete_initial(
                resource_group_name=resource_group_name, gallery_name=gallery_name, cls=lambda x, y, z: x, **kwargs
            )
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.GalleryList"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2019_03_01.models.GalleryList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.GalleryList"]:
