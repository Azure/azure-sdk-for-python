...
class AvailabilitySetPaged(Paged):
    """
    A paging container for iterating over a list of :class:`AvailabilitySet <azure.mgmt.compute.v2019_03_01.models.AvailabilitySet>` object
    """
...
class VirtualMachineSizePaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachineSize <azure.mgmt.compute.v2019_03_01.models.VirtualMachineSize>` object
    """
...
class VirtualMachinePaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachine <azure.mgmt.compute.v2019_03_01.models.VirtualMachine>` object
    """
...
class VirtualMachineScaleSetSkuPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachineScaleSetSku <azure.mgmt.compute.v2019_03_01.models.VirtualMachineScaleSetSku>` object
    """
...
class VirtualMachineScaleSetVMPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachineScaleSetVM <azure.mgmt.compute.v2019_03_01.models.VirtualMachineScaleSetVM>` object
    """
...
class RunCommandDocumentBasePaged(Paged):
    """
    A paging container for iterating over a list of :class:`RunCommandDocumentBase <azure.mgmt.compute.v2019_03_01.models.RunCommandDocumentBase>` object
    """
...
class GalleryPaged(Paged):
    """
    A paging container for iterating over a list of :class:`Gallery <azure.mgmt.compute.v2019_03_01.models.Gallery>` object
    """
