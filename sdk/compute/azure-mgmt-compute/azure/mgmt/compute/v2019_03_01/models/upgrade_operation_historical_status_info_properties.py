...
class UpgradeOperationHistoricalStatusInfoProperties(Model):
    ...
    :vartype running_status:
     ~azure.mgmt.compute.v2019_03_01.models.UpgradeOperationHistoryStatus
    :ivar progress: Counts of the VMs in each state.
    :vartype progress:
     ~azure.mgmt.compute.v2019_03_01.models.RollingUpgradeProgressInfo
    ...
    :vartype started_by: str or
     ~azure.mgmt.compute.v2019_03_01.models.UpgradeOperationInvoker
    ...
    :vartype rollback_info:
     ~azure.mgmt.compute.v2019_03_01.models.RollbackStatusInfo
    """
