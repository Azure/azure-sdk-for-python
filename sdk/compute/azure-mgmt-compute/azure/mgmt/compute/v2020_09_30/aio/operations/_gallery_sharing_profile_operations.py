...
class GallerySharingProfileOperations:
    ...
    async def _update_initial(
        ...
        **kwargs
    ) -> "models.SharingUpdate":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SharingUpdate"]
        error_map = {
        ...
        body_content = self._serialize.body(sharing_update, 'SharingUpdate')
    ...
    async def begin_update(
        ...
        sharing_update: "models.SharingUpdate",
        **kwargs
    ) -> AsyncLROPoller["models.SharingUpdate"]:
        ...
        :return: An instance of AsyncLROPoller that returns either SharingUpdate or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2020_09_30.models.SharingUpdate]
