...
class SharedGalleryImageVersionsOperations:
    ...
    def list(
        ...
        shared_to: Optional[Union[str, "models.SharedToValues"]] = None,
        **kwargs
    ) -> AsyncIterable["models.SharedGalleryImageVersionList"]:
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SharedGalleryImageVersionList"]
        error_map = {
    ...
    async def get(
        ...
        **kwargs
    ) -> "models.SharedGalleryImageVersion":
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SharedGalleryImageVersion"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
