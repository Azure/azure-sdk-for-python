...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    select = kwargs.pop('select', None)  # type: Optional[Union[str, "_models.SelectPermissions"]]
...
class GalleriesOperations(object):
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        gallery_name,  # type: str
        gallery,  # type: "_models.GalleryUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Gallery"
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.Gallery"]
        ...
        json = self._serialize.body(gallery, "GalleryUpdate")
    ...
    def get(
        ...
        resource_group_name,  # type: str
        gallery_name,  # type: str
        select=None,  # type: Optional[Union[str, "_models.SelectPermissions"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Gallery"
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2020_09_30.models.GalleryList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
