...
class GalleriesOperations(object):
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        gallery_name,  # type: str
        gallery,  # type: "models.GalleryUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Gallery"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Gallery"]
    ...
    def get(
        ...
        resource_group_name,  # type: str
        gallery_name,  # type: str
        select=None,  # type: Optional[Union[str, "models.Permissions"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Gallery"
        ...
        :type select: str or ~azure.mgmt.compute.v2020_09_30.models.Permissions
        :keyword callable cls: A custom type or function that will be passed the direct response
