...
class GalleryApplicationsOperations(object):
    ...
    def _create_or_update_initial(
        ...
        gallery_application,  # type: "_models.GalleryApplication"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.GalleryApplication"
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.GalleryApplication"]
        ...
        :return: An instance of LROPoller that returns either GalleryApplication or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2020_09_30.models.GalleryApplication]
    ...
    def _update_initial(
        ...
        gallery_name,  # type: str
        gallery_application_name,  # type: str
        gallery_application,  # type: "_models.GalleryApplicationUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.GalleryApplication"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.GalleryApplication"]
    ...
    def list_by_gallery(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.GalleryApplicationList"]
        ...
        :type gallery_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either GalleryApplicationList or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2020_09_30.models.GalleryApplicationList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
