...
def build_update_request_initial(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/share')
...
class GallerySharingProfileOperations(object):
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        gallery_name,  # type: str
        sharing_update,  # type: "_models.SharingUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.SharingUpdate"
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.SharingUpdate"]
