...
class SharedGalleryImagesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.SharedGalleryImageList"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SharedGalleryImageList"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.SharedGalleryImage"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SharedGalleryImage"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
