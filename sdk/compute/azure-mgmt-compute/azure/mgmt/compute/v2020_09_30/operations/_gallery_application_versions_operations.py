...
def build_create_or_update_request_initial(
    ...
    *,
    json: Optional[_models.GalleryApplicationVersion] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_update_request_initial(
    ...
    gallery_application_version_name: str,
    *,
    json: Optional[_models.GalleryApplicationVersionUpdate] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    def list_by_gallery_application(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either GalleryApplicationVersionList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2020_09_30.models.GalleryApplicationVersionList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
