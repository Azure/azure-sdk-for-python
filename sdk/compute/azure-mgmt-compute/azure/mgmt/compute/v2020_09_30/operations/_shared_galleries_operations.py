...
class SharedGalleriesOperations(object):
    ...
    def list(
        self,
        location,  # type: str
        shared_to=None,  # type: Optional[Union[str, "models.SharedToValues"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.SharedGalleryList"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SharedGalleryList"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.PirSharedGalleryResource"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PirSharedGalleryResource"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
