...
class DisksOperations:
    ...
    def begin_create_or_update(
        ...
        :type disk: ~azure.mgmt.compute.v2018_09_30.models.Disk or IO[bytes]
        :return: An instance of LROPoller that returns either Disk or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2018_09_30.models.Disk]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        :type disk: ~azure.mgmt.compute.v2018_09_30.models.DiskUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either Disk or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2018_09_30.models.Disk]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_grant_access(
        ...
        **kwargs: Any
        ...
        :type grant_access_data: ~azure.mgmt.compute.v2018_09_30.models.GrantAccessData or IO[bytes]
        :return: An instance of LROPoller that returns either AccessUri or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2018_09_30.models.AccessUri]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class SnapshotsOperations:
    ...
    def begin_create_or_update(
        ...
        :type snapshot: ~azure.mgmt.compute.v2018_09_30.models.Snapshot or IO[bytes]
        :return: An instance of LROPoller that returns either Snapshot or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2018_09_30.models.Snapshot]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type snapshot: ~azure.mgmt.compute.v2018_09_30.models.SnapshotUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either Snapshot or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2018_09_30.models.Snapshot]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Snapshot"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2018_09_30.models.Snapshot]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
