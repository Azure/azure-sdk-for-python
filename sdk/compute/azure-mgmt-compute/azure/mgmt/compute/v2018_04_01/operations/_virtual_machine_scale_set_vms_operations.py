...
def build_reimage_all_request_initial(
    ...
    **kwargs  # type: Any
    ...
    api_version = "2018-04-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/virtualmachines/{instanceId}/reimageall')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'instanceId': _SERIALIZER.url("instance_id", instance_id, 'str'),
...
def build_redeploy_request_initial(
    ...
    **kwargs  # type: Any
    ...
    api_version = "2018-04-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/virtualmachines/{instanceId}/redeploy')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'instanceId': _SERIALIZER.url("instance_id", instance_id, 'str'),
...
def build_perform_maintenance_request_initial(
    ...
    **kwargs  # type: Any
    ...
    api_version = "2018-04-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/virtualmachines/{instanceId}/performMaintenance')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'instanceId': _SERIALIZER.url("instance_id", instance_id, 'str'),
...
def build_run_command_request_initial(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/virtualmachines/{instanceId}/runCommand')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'instanceId': _SERIALIZER.url("instance_id", instance_id, 'str'),
...
class VirtualMachineScaleSetVMsOperations(object):
    ...
    def _update_initial(
        ...
        **kwargs  # type: Any
        ...
        json = self._serialize.body(parameters, "VirtualMachineScaleSetVM")
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either VirtualMachineScaleSetVMListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2018_04_01.models.VirtualMachineScaleSetVMListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
