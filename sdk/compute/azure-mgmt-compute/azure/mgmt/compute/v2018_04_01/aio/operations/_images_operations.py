...
class ImagesOperations:
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, image_name: str, parameters: "_models.Image", **kwargs: Any
    ) -> "_models.Image":
        ...
        json = self._serialize.body(parameters, "Image")
    ...
    async def _update_initial(
        self, resource_group_name: str, image_name: str, parameters: "_models.ImageUpdate", **kwargs: Any
    ) -> "_models.Image":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.Image"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        ...
        json = self._serialize.body(parameters, "ImageUpdate")
    ...
    async def _delete_initial(self, resource_group_name: str, image_name: str, **kwargs: Any) -> None:
    ...
    async def begin_delete(self, resource_group_name: str, image_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
        ...
        if cont_token is None:
            raw_result = await self._delete_initial(
                resource_group_name=resource_group_name, image_name=image_name, cls=lambda x, y, z: x, **kwargs
            )
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2018_04_01.models.ImageListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
