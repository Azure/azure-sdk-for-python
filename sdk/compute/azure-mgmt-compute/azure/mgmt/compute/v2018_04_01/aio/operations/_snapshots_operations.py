...
from ...operations._snapshots_operations import (
    ...
    build_get_request,
    build_grant_access_request_initial,
    build_list_by_resource_group_request,
    build_list_request,
    build_revoke_access_request_initial,
...
class SnapshotsOperations:
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, snapshot_name: str, snapshot: "_models.Snapshot", **kwargs: Any
    ) -> "_models.Snapshot":
        ...
        json = self._serialize.body(snapshot, "Snapshot")
    ...
    async def _update_initial(
        self, resource_group_name: str, snapshot_name: str, snapshot: "_models.SnapshotUpdate", **kwargs: Any
    ) -> "_models.Snapshot":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.Snapshot"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        ...
        json = self._serialize.body(snapshot, "SnapshotUpdate")
    ...
    async def _delete_initial(self, resource_group_name: str, snapshot_name: str, **kwargs: Any) -> None:
    ...
    async def begin_delete(self, resource_group_name: str, snapshot_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
        ...
        if cont_token is None:
            raw_result = await self._delete_initial(
                resource_group_name=resource_group_name, snapshot_name=snapshot_name, cls=lambda x, y, z: x, **kwargs
            )
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.SnapshotList"]:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.SnapshotList"]:
    ...
    async def _grant_access_initial(
        self, resource_group_name: str, snapshot_name: str, grant_access_data: "_models.GrantAccessData", **kwargs: Any
        ...
        json = self._serialize.body(grant_access_data, "GrantAccessData")
    ...
    async def _revoke_access_initial(self, resource_group_name: str, snapshot_name: str, **kwargs: Any) -> None:
        cls = kwargs.pop("cls", None)  # type: ClsType[None]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
