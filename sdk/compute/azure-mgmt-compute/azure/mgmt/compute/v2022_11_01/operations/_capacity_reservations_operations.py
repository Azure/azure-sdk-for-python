...
class CapacityReservationsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either CapacityReservation or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2022_11_01.models.CapacityReservation]
    ...
    def list_by_capacity_reservation_group(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2022_11_01.models.CapacityReservation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
