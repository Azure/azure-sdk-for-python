...
class OSImageNotificationProfile(_serialization.Model):
    ...
    :ivar not_before_timeout: Length of time a Virtual Machine being reimaged or having its OS
     ...
     approved (timed out). The configuration is specified in ISO 8601 format, with the value set to
     15 minutes (PT15M).
...
class PriorityMixPolicy(_serialization.Model):
    """Specifies the target splits for Spot and Regular priority VMs within a scale set with flexible orchestration mode. :code:`<br>`:code:`<br>`With this property the customer is able to specify the base number of regular priority VMs created as the VMSS flex instance scales out and the split between Spot and Regular priority VMs after this base target has been reached.
...
class ProximityPlacementGroupPropertiesIntent(_serialization.Model):
    ...
    def __init__(self, *, vm_sizes: Optional[List[str]] = None, **kwargs):
        """
...
class StorageProfile(_serialization.Model):
    ...
    :ivar disk_controller_type: Specifies the disk controller type configured for the VM.
     :code:`<br>`:code:`<br>`NOTE: This property will be set to the default disk controller type if
     not specified provided virtual machine is being created as a hyperVGeneration: V2 based on the
     ...
     reallocates the VM. :code:`<br>`:code:`<br>` Minimum api-version: 2022-08-01. Known values are:
     "SCSI" and "NVMe".
