...
class ComputeManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.compute.v2022_11_01.aio.operations.Operations
    :ivar usage: UsageOperations operations
    :vartype usage: azure.mgmt.compute.v2022_11_01.aio.operations.UsageOperations
    :ivar virtual_machine_sizes: VirtualMachineSizesOperations operations
    :vartype virtual_machine_sizes:
     azure.mgmt.compute.v2022_11_01.aio.operations.VirtualMachineSizesOperations
    :ivar virtual_machine_scale_sets: VirtualMachineScaleSetsOperations operations
    :vartype virtual_machine_scale_sets:
     azure.mgmt.compute.v2022_11_01.aio.operations.VirtualMachineScaleSetsOperations
    ...
    :vartype virtual_machine_scale_set_extensions:
     azure.mgmt.compute.v2022_11_01.aio.operations.VirtualMachineScaleSetExtensionsOperations
    ...
    :vartype virtual_machine_scale_set_rolling_upgrades:
     azure.mgmt.compute.v2022_11_01.aio.operations.VirtualMachineScaleSetRollingUpgradesOperations
    ...
    :vartype virtual_machine_scale_set_vm_extensions:
     azure.mgmt.compute.v2022_11_01.aio.operations.VirtualMachineScaleSetVMExtensionsOperations
    :ivar virtual_machine_scale_set_vms: VirtualMachineScaleSetVMsOperations operations
    :vartype virtual_machine_scale_set_vms:
     azure.mgmt.compute.v2022_11_01.aio.operations.VirtualMachineScaleSetVMsOperations
    :ivar virtual_machine_extensions: VirtualMachineExtensionsOperations operations
    :vartype virtual_machine_extensions:
     azure.mgmt.compute.v2022_11_01.aio.operations.VirtualMachineExtensionsOperations
    :ivar virtual_machines: VirtualMachinesOperations operations
    :vartype virtual_machines:
     azure.mgmt.compute.v2022_11_01.aio.operations.VirtualMachinesOperations
    :ivar virtual_machine_images: VirtualMachineImagesOperations operations
    :vartype virtual_machine_images:
     azure.mgmt.compute.v2022_11_01.aio.operations.VirtualMachineImagesOperations
    ...
    :vartype virtual_machine_images_edge_zone:
     azure.mgmt.compute.v2022_11_01.aio.operations.VirtualMachineImagesEdgeZoneOperations
    ...
    :vartype virtual_machine_extension_images:
     azure.mgmt.compute.v2022_11_01.aio.operations.VirtualMachineExtensionImagesOperations
    :ivar availability_sets: AvailabilitySetsOperations operations
    :vartype availability_sets:
     azure.mgmt.compute.v2022_11_01.aio.operations.AvailabilitySetsOperations
    :ivar proximity_placement_groups: ProximityPlacementGroupsOperations operations
    :vartype proximity_placement_groups:
     azure.mgmt.compute.v2022_11_01.aio.operations.ProximityPlacementGroupsOperations
    :ivar dedicated_host_groups: DedicatedHostGroupsOperations operations
    :vartype dedicated_host_groups:
     azure.mgmt.compute.v2022_11_01.aio.operations.DedicatedHostGroupsOperations
    :ivar dedicated_hosts: DedicatedHostsOperations operations
    :vartype dedicated_hosts:
     azure.mgmt.compute.v2022_11_01.aio.operations.DedicatedHostsOperations
    :ivar ssh_public_keys: SshPublicKeysOperations operations
    :vartype ssh_public_keys: azure.mgmt.compute.v2022_11_01.aio.operations.SshPublicKeysOperations
    :ivar images: ImagesOperations operations
    :vartype images: azure.mgmt.compute.v2022_11_01.aio.operations.ImagesOperations
    :ivar restore_point_collections: RestorePointCollectionsOperations operations
    :vartype restore_point_collections:
     azure.mgmt.compute.v2022_11_01.aio.operations.RestorePointCollectionsOperations
    :ivar restore_points: RestorePointsOperations operations
    :vartype restore_points: azure.mgmt.compute.v2022_11_01.aio.operations.RestorePointsOperations
    :ivar capacity_reservation_groups: CapacityReservationGroupsOperations operations
    :vartype capacity_reservation_groups:
     azure.mgmt.compute.v2022_11_01.aio.operations.CapacityReservationGroupsOperations
    :ivar capacity_reservations: CapacityReservationsOperations operations
    :vartype capacity_reservations:
     azure.mgmt.compute.v2022_11_01.aio.operations.CapacityReservationsOperations
    :ivar log_analytics: LogAnalyticsOperations operations
    :vartype log_analytics: azure.mgmt.compute.v2022_11_01.aio.operations.LogAnalyticsOperations
    :ivar virtual_machine_run_commands: VirtualMachineRunCommandsOperations operations
    :vartype virtual_machine_run_commands:
     azure.mgmt.compute.v2022_11_01.aio.operations.VirtualMachineRunCommandsOperations
    ...
    :vartype virtual_machine_scale_set_vm_run_commands:
     azure.mgmt.compute.v2022_11_01.aio.operations.VirtualMachineScaleSetVMRunCommandsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.usage = UsageOperations(self._client, self._config, self._serialize, self._deserialize, "2022-11-01")
        ...
        self.images = ImagesOperations(self._client, self._config, self._serialize, self._deserialize, "2022-11-01")
