...
class ComputeManagementClient:
    ...
    :vartype disk_accesses: azure.mgmt.compute.v2025_01_02.aio.operations.DiskAccessesOperations
    :ivar disk_encryption_sets: DiskEncryptionSetsOperations operations
    :vartype disk_encryption_sets:
     azure.mgmt.compute.v2025_01_02.aio.operations.DiskEncryptionSetsOperations
    :ivar disks: DisksOperations operations
    :vartype disks: azure.mgmt.compute.v2025_01_02.aio.operations.DisksOperations
    :ivar snapshots: SnapshotsOperations operations
    :vartype snapshots: azure.mgmt.compute.v2025_01_02.aio.operations.SnapshotsOperations
    :ivar disk_restore_point: DiskRestorePointOperations operations
    :vartype disk_restore_point:
     azure.mgmt.compute.v2025_01_02.aio.operations.DiskRestorePointOperations
    ...
    def __init__(
        ...
        self.disk_accesses = DiskAccessesOperations(
            self._client, self._config, self._serialize, self._deserialize, "2025-01-02"
        )
        self.disk_encryption_sets = DiskEncryptionSetsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2025-01-02"
        )
        self.disks = DisksOperations(self._client, self._config, self._serialize, self._deserialize, "2025-01-02")
