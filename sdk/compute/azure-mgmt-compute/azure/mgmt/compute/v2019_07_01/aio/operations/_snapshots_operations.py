...
class SnapshotsOperations:
    ...
    async def begin_create_or_update(
        ...
        :type snapshot: ~azure.mgmt.compute.v2019_07_01.models.Snapshot or IO
    ...
    async def begin_update(
        ...
        :type snapshot: ~azure.mgmt.compute.v2019_07_01.models.SnapshotUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_grant_access(
        ...
        **kwargs: Any
        ...
        :type grant_access_data: ~azure.mgmt.compute.v2019_07_01.models.GrantAccessData or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
