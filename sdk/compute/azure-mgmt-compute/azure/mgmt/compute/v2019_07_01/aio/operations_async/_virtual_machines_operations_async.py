...
class VirtualMachinesOperations:
    ...
    async def capture(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.compute.v2019_07_01.models.VirtualMachineCaptureResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def reapply(
        ...
        **kwargs
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    reapply.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/reapply'}  # type: ignore
    ...
    async def reimage(
        ...
        **kwargs
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    reimage.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/reimage'}  # type: ignore
