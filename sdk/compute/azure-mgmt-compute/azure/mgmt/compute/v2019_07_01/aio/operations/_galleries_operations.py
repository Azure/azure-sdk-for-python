...
class GalleriesOperations:
    ...
    async def _update_initial(
        self, resource_group_name: str, gallery_name: str, gallery: "_models.GalleryUpdate", **kwargs: Any
    ) -> "_models.Gallery":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.Gallery"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.GalleryList"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2019_07_01.models.GalleryList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
