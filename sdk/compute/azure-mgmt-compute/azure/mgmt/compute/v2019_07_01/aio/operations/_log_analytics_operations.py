...
class LogAnalyticsOperations:
    ...
    async def begin_export_request_rate_by_interval(
        ...
        :type parameters: ~azure.mgmt.compute.v2019_07_01.models.RequestRateByIntervalInput or IO
    ...
    async def begin_export_throttled_requests(
        ...
        :type parameters: ~azure.mgmt.compute.v2019_07_01.models.ThrottledRequestsInput or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
