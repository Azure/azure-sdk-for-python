...
from ...operations._log_analytics_operations import (
    build_export_request_rate_by_interval_request_initial,
    build_export_throttled_requests_request_initial,
)
...
class LogAnalyticsOperations:
    ...
    async def _export_request_rate_by_interval_initial(
        self, location: str, parameters: "_models.RequestRateByIntervalInput", **kwargs: Any
        ...
        json = self._serialize.body(parameters, "RequestRateByIntervalInput")
    ...
    async def _export_throttled_requests_initial(
        self, location: str, parameters: "_models.ThrottledRequestsInput", **kwargs: Any
    ) -> Optional["_models.LogAnalyticsOperationResult"]:
        cls = kwargs.pop("cls", None)  # type: ClsType[Optional["_models.LogAnalyticsOperationResult"]]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        ...
        json = self._serialize.body(parameters, "ThrottledRequestsInput")
