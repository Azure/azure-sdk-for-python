...
class VirtualMachineScaleSetVMsOperations:
    ...
    async def _reimage_initial(
        ...
        instance_id: str,
        vm_scale_set_vm_reimage_input: Optional["models.VirtualMachineScaleSetVMReimageParameters"] = None,
        **kwargs
    ) -> None:
    ...
    async def reimage(
        ...
        **kwargs
        ...
        :type vm_scale_set_vm_reimage_input: ~azure.mgmt.compute.v2019_07_01.models.VirtualMachineScaleSetVMReimageParameters
