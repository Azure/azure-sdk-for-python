...
class ComputeManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.compute.v2019_07_01.operations.Operations
    :ivar availability_sets: AvailabilitySetsOperations operations
    :vartype availability_sets:
     azure.mgmt.compute.v2019_07_01.operations.AvailabilitySetsOperations
    :ivar proximity_placement_groups: ProximityPlacementGroupsOperations operations
    :vartype proximity_placement_groups:
     azure.mgmt.compute.v2019_07_01.operations.ProximityPlacementGroupsOperations
    :ivar dedicated_host_groups: DedicatedHostGroupsOperations operations
    :vartype dedicated_host_groups:
     azure.mgmt.compute.v2019_07_01.operations.DedicatedHostGroupsOperations
    :ivar dedicated_hosts: DedicatedHostsOperations operations
    :vartype dedicated_hosts: azure.mgmt.compute.v2019_07_01.operations.DedicatedHostsOperations
    ...
    :vartype virtual_machine_extension_images:
     azure.mgmt.compute.v2019_07_01.operations.VirtualMachineExtensionImagesOperations
    :ivar virtual_machine_extensions: VirtualMachineExtensionsOperations operations
    :vartype virtual_machine_extensions:
     azure.mgmt.compute.v2019_07_01.operations.VirtualMachineExtensionsOperations
    :ivar virtual_machine_images: VirtualMachineImagesOperations operations
    :vartype virtual_machine_images:
     azure.mgmt.compute.v2019_07_01.operations.VirtualMachineImagesOperations
    ...
    :vartype virtual_machine_sizes:
     azure.mgmt.compute.v2019_07_01.operations.VirtualMachineSizesOperations
    ...
    :vartype virtual_machine_scale_set_extensions:
     azure.mgmt.compute.v2019_07_01.operations.VirtualMachineScaleSetExtensionsOperations
    ...
    :vartype virtual_machine_scale_set_rolling_upgrades:
     azure.mgmt.compute.v2019_07_01.operations.VirtualMachineScaleSetRollingUpgradesOperations
    ...
    :vartype virtual_machine_scale_set_vm_extensions:
     azure.mgmt.compute.v2019_07_01.operations.VirtualMachineScaleSetVMExtensionsOperations
    :ivar virtual_machine_scale_set_vms: VirtualMachineScaleSetVMsOperations operations
    :vartype virtual_machine_scale_set_vms:
     azure.mgmt.compute.v2019_07_01.operations.VirtualMachineScaleSetVMsOperations
    :ivar log_analytics: LogAnalyticsOperations operations
    :vartype log_analytics: azure.mgmt.compute.v2019_07_01.operations.LogAnalyticsOperations
    :ivar disks: DisksOperations operations
    :vartype disks: azure.mgmt.compute.v2019_07_01.operations.DisksOperations
    :ivar snapshots: SnapshotsOperations operations
    :vartype snapshots: azure.mgmt.compute.v2019_07_01.operations.SnapshotsOperations
    :ivar disk_encryption_sets: DiskEncryptionSetsOperations operations
    :vartype disk_encryption_sets:
     azure.mgmt.compute.v2019_07_01.operations.DiskEncryptionSetsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.usage = UsageOperations(self._client, self._config, self._serialize, self._deserialize, "2019-07-01")
        ...
        self.images = ImagesOperations(self._client, self._config, self._serialize, self._deserialize, "2019-07-01")
        ...
        self.disks = DisksOperations(self._client, self._config, self._serialize, self._deserialize, "2019-07-01")
