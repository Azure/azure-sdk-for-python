...
class VirtualMachineExtensionsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type extension_parameters: ~azure.mgmt.compute.v2021_07_01.models.VirtualMachineExtension or
         IO
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param extension_parameters: Parameters supplied to the Update Virtual Machine Extension
         operation. Is either a model type or a IO type. Required.
        :type extension_parameters:
         ~azure.mgmt.compute.v2021_07_01.models.VirtualMachineExtensionUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
