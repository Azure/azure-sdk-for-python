...
from ...operations._gallery_image_versions_operations import (
...
class GalleryImageVersionsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gallery_image_version: ~azure.mgmt.compute.v2021_07_01.models.GalleryImageVersion or IO
    ...
    def list_by_gallery_image(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2021_07_01.models.GalleryImageVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
