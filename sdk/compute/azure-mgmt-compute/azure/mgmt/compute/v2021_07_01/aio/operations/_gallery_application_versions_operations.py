...
class GalleryApplicationVersionsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2021_07_01.models.GalleryApplicationVersion]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gallery_application_version:
         ~azure.mgmt.compute.v2021_07_01.models.GalleryApplicationVersion or IO
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery_application_version:
         ~azure.mgmt.compute.v2021_07_01.models.GalleryApplicationVersionUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_gallery_application(
        ...
        :return: An iterator like instance of either GalleryApplicationVersion or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2021_07_01.models.GalleryApplicationVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
