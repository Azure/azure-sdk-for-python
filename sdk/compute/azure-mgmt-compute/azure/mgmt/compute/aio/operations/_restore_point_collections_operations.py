...
class RestorePointCollectionsOperations:
    ...
    @distributed_trace
    def list_all(self, **kwargs: Any) -> AsyncItemPaged["_models.RestorePointCollection"]:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncItemPaged["_models.RestorePointCollection"]:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :param expand: The expand expression to apply on the operation. If expand=restorePoints, server
         ...
         value is None.
        :type expand: str or ~azure.mgmt.compute.models.RestorePointCollectionExpandOptions
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.models.RestorePointCollection or IO[bytes]
        :return: RestorePointCollection or the result of cls(response)
        :rtype: ~azure.mgmt.compute.models.RestorePointCollection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.models.RestorePointCollectionUpdate or IO[bytes]
        :return: RestorePointCollection or the result of cls(response)
        :rtype: ~azure.mgmt.compute.models.RestorePointCollection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
