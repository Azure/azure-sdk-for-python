...
class GalleriesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.Gallery"]:
        """List galleries under a subscription.

        :return: An iterator like instance of either Gallery or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.models.Gallery]
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncItemPaged["_models.Gallery"]:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :param select: The select expression to apply on the operation. "Permissions" Default value is
         None.
        :type select: str or ~azure.mgmt.compute.models.SelectPermissions
        :param expand: The expand query option to apply on the operation. "SharingProfile/Groups"
         Default value is None.
        :type expand: str or ~azure.mgmt.compute.models.GalleryExpandParams
        :return: Gallery or the result of cls(response)
        :rtype: ~azure.mgmt.compute.models.Gallery
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        :type gallery: ~azure.mgmt.compute.models.Gallery or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Gallery or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.models.Gallery]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery: ~azure.mgmt.compute.models.GalleryUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Gallery or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.models.Gallery]
        :raises ~azure.core.exceptions.HttpResponseError:
