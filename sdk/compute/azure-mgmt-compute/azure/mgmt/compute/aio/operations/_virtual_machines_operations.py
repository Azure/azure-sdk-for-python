...
from ...operations._virtual_machines_operations import (
    ...
    build_list_request,
    build_migrate_to_vm_scale_set_request,
...
class VirtualMachinesOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either VirtualMachine or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.models.VirtualMachine]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _migrate_to_vm_scale_set_initial(
        self,
        resource_group_name: str,
        vm_name: str,
