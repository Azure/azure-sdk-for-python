...
from ...operations._gallery_in_vm_access_control_profiles_operations import (
...
class GalleryInVMAccessControlProfilesOperations:  # pylint: disable=name-too-long
    ...
    def list_by_gallery(
    ...
    ) -> AsyncItemPaged["_models.GalleryInVMAccessControlProfile"]:
        ...
        :return: An iterator like instance of either GalleryInVMAccessControlProfile or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.models.GalleryInVMAccessControlProfile]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.models.GalleryInVMAccessControlProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
