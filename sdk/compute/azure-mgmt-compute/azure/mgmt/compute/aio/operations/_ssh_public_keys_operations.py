...
class SshPublicKeysOperations:
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.models.SshPublicKeyResource or IO[bytes]
        :return: SshPublicKeyResource or the result of cls(response)
        :rtype: ~azure.mgmt.compute.models.SshPublicKeyResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.models.SshPublicKeyUpdateResource or IO[bytes]
        :return: SshPublicKeyResource or the result of cls(response)
        :rtype: ~azure.mgmt.compute.models.SshPublicKeyResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def generate_key_pair(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.models.SshGenerateKeyPairInputParameters or IO[bytes]
        :return: SshPublicKeyGenerateKeyPairResult or the result of cls(response)
        :rtype: ~azure.mgmt.compute.models.SshPublicKeyGenerateKeyPairResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _request = build_generate_key_pair_request(
            resource_group_name=resource_group_name,
            ssh_public_key_name=ssh_public_key_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
