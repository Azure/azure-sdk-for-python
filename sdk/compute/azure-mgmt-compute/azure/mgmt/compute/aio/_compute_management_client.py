...
class ComputeManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def disk_accesses(self):
        """Instance depends on the API version:
           ...
           * 2021-03-01: :class:`DiskAccessesOperations<azure.mgmt.compute.v2021_03_01.aio.operations.DiskAccessesOperations>`
        """
        ...
        if api_version == '2020-05-01':
            ...
            from ..v2021_03_01.aio.operations import DiskAccessesOperations as OperationClass
        else:
    ...
    def disk_encryption_sets(self):
        """Instance depends on the API version:
           ...
           * 2021-03-01: :class:`DiskEncryptionSetsOperations<azure.mgmt.compute.v2021_03_01.aio.operations.DiskEncryptionSetsOperations>`
        """
        ...
        if api_version == '2019-07-01':
            ...
            from ..v2021_03_01.aio.operations import DiskEncryptionSetsOperations as OperationClass
        else:
    ...
    def disk_restore_point(self):
        """Instance depends on the API version:
           ...
           * 2021-03-01: :class:`DiskRestorePointOperations<azure.mgmt.compute.v2021_03_01.aio.operations.DiskRestorePointOperations>`
        """
        ...
        if api_version == '2020-09-30':
            ...
            from ..v2021_03_01.aio.operations import DiskRestorePointOperations as OperationClass
        else:
    ...
    def disks(self):
        """Instance depends on the API version:
           ...
           * 2021-03-01: :class:`DisksOperations<azure.mgmt.compute.v2021_03_01.aio.operations.DisksOperations>`
        """
        ...
        if api_version == '2016-04-30-preview':
            ...
            from ..v2021_03_01.aio.operations import DisksOperations as OperationClass
        else:
    ...
    def galleries(self):
        """Instance depends on the API version:
           ...
           * 2021-03-01: :class:`GalleriesOperations<azure.mgmt.compute.v2021_03_01.aio.operations.GalleriesOperations>`
        """
        ...
        if api_version == '2018-06-01':
            ...
            from ..v2021_03_01.aio.operations import GalleriesOperations as OperationClass
        else:
    ...
    def gallery_application_versions(self):
        """Instance depends on the API version:
           ...
           * 2021-03-01: :class:`GalleryApplicationVersionsOperations<azure.mgmt.compute.v2021_03_01.aio.operations.GalleryApplicationVersionsOperations>`
        """
        ...
        if api_version == '2019-03-01':
            ...
            from ..v2021_03_01.aio.operations import GalleryApplicationVersionsOperations as OperationClass
        else:
    ...
    def gallery_applications(self):
        """Instance depends on the API version:
           ...
           * 2021-03-01: :class:`GalleryApplicationsOperations<azure.mgmt.compute.v2021_03_01.aio.operations.GalleryApplicationsOperations>`
        """
        ...
        if api_version == '2019-03-01':
            ...
            from ..v2021_03_01.aio.operations import GalleryApplicationsOperations as OperationClass
        else:
    ...
    def gallery_image_versions(self):
        """Instance depends on the API version:
           ...
           * 2021-03-01: :class:`GalleryImageVersionsOperations<azure.mgmt.compute.v2021_03_01.aio.operations.GalleryImageVersionsOperations>`
        """
        ...
        if api_version == '2018-06-01':
            ...
            from ..v2021_03_01.aio.operations import GalleryImageVersionsOperations as OperationClass
        else:
    ...
    def gallery_images(self):
        """Instance depends on the API version:
           ...
           * 2021-03-01: :class:`GalleryImagesOperations<azure.mgmt.compute.v2021_03_01.aio.operations.GalleryImagesOperations>`
        """
        ...
        if api_version == '2018-06-01':
            ...
            from ..v2021_03_01.aio.operations import GalleryImagesOperations as OperationClass
        else:
    ...
    def resource_skus(self):
        """Instance depends on the API version:
           ...
           * 2021-03-01: :class:`ResourceSkusOperations<azure.mgmt.compute.v2021_03_01.aio.operations.ResourceSkusOperations>`
        """
        ...
        if api_version == '2017-03-30':
            ...
            from ..v2021_03_01.aio.operations import ResourceSkusOperations as OperationClass
        else:
    ...
    def snapshots(self):
        """Instance depends on the API version:
           ...
           * 2021-03-01: :class:`SnapshotsOperations<azure.mgmt.compute.v2021_03_01.aio.operations.SnapshotsOperations>`
        """
        ...
        if api_version == '2016-04-30-preview':
            ...
            from ..v2021_03_01.aio.operations import SnapshotsOperations as OperationClass
        else:
