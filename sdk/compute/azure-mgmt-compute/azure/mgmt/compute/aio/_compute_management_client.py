...
class ComputeManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def disk_accesses(self):
        """Instance depends on the API version:
           ...
           * 2025-01-02: :class:`DiskAccessesOperations<azure.mgmt.compute.v2025_01_02.aio.operations.DiskAccessesOperations>`
        """
        ...
        if api_version == '2020-05-01':
            ...
            from ..v2025_01_02.aio.operations import DiskAccessesOperations as OperationClass
        else:
    ...
    def disk_encryption_sets(self):
        """Instance depends on the API version:
           ...
           * 2025-01-02: :class:`DiskEncryptionSetsOperations<azure.mgmt.compute.v2025_01_02.aio.operations.DiskEncryptionSetsOperations>`
        """
        ...
        if api_version == '2019-07-01':
            ...
            from ..v2025_01_02.aio.operations import DiskEncryptionSetsOperations as OperationClass
        else:
    ...
    def disk_restore_point(self):
        """Instance depends on the API version:
           ...
           * 2025-01-02: :class:`DiskRestorePointOperations<azure.mgmt.compute.v2025_01_02.aio.operations.DiskRestorePointOperations>`
        """
        ...
        if api_version == '2022-03-02':
            ...
            from ..v2025_01_02.aio.operations import DiskRestorePointOperations as OperationClass
        else:
    ...
    def disks(self):
        """Instance depends on the API version:
           ...
           * 2025-01-02: :class:`DisksOperations<azure.mgmt.compute.v2025_01_02.aio.operations.DisksOperations>`
        """
        ...
        if api_version == '2017-03-30':
            ...
            from ..v2025_01_02.aio.operations import DisksOperations as OperationClass
        else:
    ...
    def snapshots(self):
        """Instance depends on the API version:
           ...
           * 2025-01-02: :class:`SnapshotsOperations<azure.mgmt.compute.v2025_01_02.aio.operations.SnapshotsOperations>`
        """
        ...
        if api_version == '2017-03-30':
            ...
            from ..v2025_01_02.aio.operations import SnapshotsOperations as OperationClass
        else:
