...
class ComputeManagementClient:
    ...
    :vartype disk_encryption_sets:
         azure.mgmt.compute.v2019_11_01.aio.operations.DiskEncryptionSetsOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `azure.mgmt.compute.v2019_11_01.rest`.
