...
class VirtualMachineScaleSetsOperations(object):
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.compute.v2020_06_01.models.VirtualMachineScaleSet
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineScaleSet]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineScaleSet]]
    ...
    def update(
        ...
        :param parameters: The scale set object.
        :type parameters:
         ~azure.mgmt.compute.v2020_06_01.models.VirtualMachineScaleSetUpdate
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
    ...
    def get_instance_view(
        ...
        :return: VirtualMachineScaleSetInstanceView or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.compute.v2020_06_01.models.VirtualMachineScaleSetInstanceView
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.compute.v2020_06_01.models.VirtualMachineScaleSetPaged[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineScaleSet]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_skus(
        ...
        :rtype:
         ~azure.mgmt.compute.v2020_06_01.models.VirtualMachineScaleSetSkuPaged[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineScaleSetSku]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
    ...
    def get_os_upgrade_history(
        ...
        :rtype:
         ~azure.mgmt.compute.v2020_06_01.models.UpgradeOperationHistoricalStatusInfoPaged[~azure.mgmt.compute.v2020_06_01.models.UpgradeOperationHistoricalStatusInfo]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
    ...
    def _power_off_initial(
            self, resource_group_name, vm_scale_set_name, skip_shutdown=False, instance_ids=None, custom_headers=None, raw=False, **operation_config):
        vm_instance_ids = None
        if instance_ids is not None:
            vm_instance_ids = models.VirtualMachineScaleSetVMInstanceIDs(instance_ids=instance_ids)
    ...
    def power_off(
            self, resource_group_name, vm_scale_set_name, skip_shutdown=False, instance_ids=None, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    def force_recovery_service_fabric_platform_update_domain_walk(
        ...
        :rtype: ~azure.mgmt.compute.v2020_06_01.models.RecoveryWalkResponse or
    ...
    def set_orchestration_service_state(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    set_orchestration_service_state.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/setOrchestrationServiceState'}
