...
class VirtualMachineScaleSetVMsOperations(object):
    ...
    def update(
        ...
        :type parameters:
         ~azure.mgmt.compute.v2020_06_01.models.VirtualMachineScaleSetVM
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineScaleSetVM]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineScaleSetVM]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.compute.v2020_06_01.models.VirtualMachineScaleSetVM or
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.compute.v2020_06_01.models.VirtualMachineScaleSetVMPaged[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineScaleSetVM]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def _retrieve_boot_diagnostics_data_initial(
            self, resource_group_name, vm_scale_set_name, instance_id, sas_uri_expiration_time_in_minutes=None, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def retrieve_boot_diagnostics_data(
            self, resource_group_name, vm_scale_set_name, instance_id, sas_uri_expiration_time_in_minutes=None, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    retrieve_boot_diagnostics_data.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/virtualmachines/{instanceId}/retrieveBootDiagnosticsData'}
