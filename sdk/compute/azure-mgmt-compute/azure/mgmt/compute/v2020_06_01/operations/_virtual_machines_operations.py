...
class VirtualMachinesOperations(object):
    ...
    def list_by_location(
        ...
        :rtype:
         ~azure.mgmt.compute.v2020_06_01.models.VirtualMachinePaged[~azure.mgmt.compute.v2020_06_01.models.VirtualMachine]
    ...
    def capture(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineCaptureResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineCaptureResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2020_06_01.models.VirtualMachine]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2020_06_01.models.VirtualMachine]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get(
        ...
        :type expand: str or
         ~azure.mgmt.compute.v2020_06_01.models.InstanceViewTypes
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~azure.mgmt.compute.v2020_06_01.models.VirtualMachine or
    ...
    def instance_view(
        ...
        :rtype:
         ~azure.mgmt.compute.v2020_06_01.models.VirtualMachineInstanceView or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list_available_sizes(
        ...
        :rtype:
         ~azure.mgmt.compute.v2020_06_01.models.VirtualMachineSizePaged[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineSize]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
    ...
    def _retrieve_boot_diagnostics_data_initial(
            self, resource_group_name, vm_name, sas_uri_expiration_time_in_minutes=None, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.retrieve_boot_diagnostics_data.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'vmName': self._serialize.url("vm_name", vm_name, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('RetrieveBootDiagnosticsDataResult', response)
    ...
    def retrieve_boot_diagnostics_data(
            self, resource_group_name, vm_name, sas_uri_expiration_time_in_minutes=None, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :param vm_name: The name of the virtual machine.
        :type vm_name: str
        :param sas_uri_expiration_time_in_minutes: Expiration duration in
         minutes for the SAS URIs with a value between 1 to 1440 minutes.
         <br><br>NOTE: If not specified, SAS URIs will be generated with a
        ...
        :param polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of LROPoller that returns
         RetrieveBootDiagnosticsDataResult or
         ClientRawResponse<RetrieveBootDiagnosticsDataResult> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2020_06_01.models.RetrieveBootDiagnosticsDataResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2020_06_01.models.RetrieveBootDiagnosticsDataResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        raw_result = self._retrieve_boot_diagnostics_data_initial(
            resource_group_name=resource_group_name,
            vm_name=vm_name,
    ...
    def _assess_patches_initial(
            self, resource_group_name, vm_name, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.assess_patches.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'vmName': self._serialize.url("vm_name", vm_name, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('VirtualMachineAssessPatchesResult', response)
    ...
    def assess_patches(
        ...
        :param polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of LROPoller that returns
         VirtualMachineAssessPatchesResult or
         ClientRawResponse<VirtualMachineAssessPatchesResult> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineAssessPatchesResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineAssessPatchesResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    assess_patches.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/assessPatches'}
    ...
    def run_command(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2020_06_01.models.RunCommandResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2020_06_01.models.RunCommandResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
