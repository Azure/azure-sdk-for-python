...
class VirtualMachinesOperations(object):
    ...
    def list_by_location(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineListResult]
    ...
    def _capture_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["models.VirtualMachineCaptureResult"]
    ...
    def begin_capture(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.VirtualMachineCaptureResult"]
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineCaptureResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_available_sizes(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineSizeListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _reimage_initial(
        ...
        resource_group_name,  # type: str
        vm_name,  # type: str
        parameters=None,  # type: Optional["models.VirtualMachineReimageParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
    ...
    def retrieve_boot_diagnostics_data(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.RetrieveBootDiagnosticsDataResult"
    ...
    def _assess_patches_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["models.VirtualMachineAssessPatchesResult"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.VirtualMachineAssessPatchesResult"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def begin_assess_patches(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.VirtualMachineAssessPatchesResult"]
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2020_06_01.models.VirtualMachineAssessPatchesResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VirtualMachineAssessPatchesResult"]
        lro_delay = kwargs.pop(
            'polling_interval',
            self._config.polling_interval
        )
