...
class VirtualMachineScaleSetVMExtensionsOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
    ) -> "models.VirtualMachineScaleSetVMExtension":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VirtualMachineScaleSetVMExtension"]
        error_map = {
    ...
    async def begin_create_or_update(
        ...
        extension_parameters: "models.VirtualMachineScaleSetVMExtension",
        **kwargs
    ) -> AsyncLROPoller["models.VirtualMachineScaleSetVMExtension"]:
    ...
    async def list(
        ...
        expand: Optional[str] = None,
        **kwargs
    ) -> "models.VirtualMachineScaleSetVMExtensionsListResult":
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VirtualMachineScaleSetVMExtensionsListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
