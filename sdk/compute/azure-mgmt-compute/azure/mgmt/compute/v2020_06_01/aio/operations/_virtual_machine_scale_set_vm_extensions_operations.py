...
class VirtualMachineScaleSetVMExtensionsOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(extension_parameters, "VirtualMachineScaleSetVMExtension")
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(extension_parameters, "VirtualMachineScaleSetVMExtensionUpdate")
