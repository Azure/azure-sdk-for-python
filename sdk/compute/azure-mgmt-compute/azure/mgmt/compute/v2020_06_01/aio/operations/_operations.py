...
class Operations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ComputeOperationListResult"]:
        ...
        :return: An iterator like instance of either ComputeOperationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2020_06_01.models.ComputeOperationListResult]
