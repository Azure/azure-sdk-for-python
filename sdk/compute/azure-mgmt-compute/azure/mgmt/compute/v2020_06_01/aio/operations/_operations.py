...
class Operations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.ComputeOperationValue"]:
...
class ProximityPlacementGroupsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.ProximityPlacementGroup"]:
    ...
    ) -> AsyncItemPaged["_models.ProximityPlacementGroup"]:
...
class DedicatedHostsOperations:
    ...
    ) -> AsyncItemPaged["_models.DedicatedHost"]:
...
class SshPublicKeysOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.SshPublicKeyResource"]:
    ...
    def list_by_resource_group(
        self, resource_group_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.SshPublicKeyResource"]:
...
class VirtualMachinesOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncItemPaged["_models.VirtualMachine"]:
    ...
    @distributed_trace
    def list_all(self, *, status_only: Optional[str] = None, **kwargs: Any) -> AsyncItemPaged["_models.VirtualMachine"]:
...
class VirtualMachineSizesOperations:
    ...
    @distributed_trace
    def list(self, location: str, **kwargs: Any) -> AsyncItemPaged["_models.VirtualMachineSize"]:
...
class ImagesOperations:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncItemPaged["_models.Image"]:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.Image"]:
...
class VirtualMachineScaleSetExtensionsOperations:  # pylint: disable=name-too-long
    ...
    def list(
        self, resource_group_name: str, vm_scale_set_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.VirtualMachineScaleSetExtension"]:
