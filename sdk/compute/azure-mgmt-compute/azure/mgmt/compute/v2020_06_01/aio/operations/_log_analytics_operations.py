...
class LogAnalyticsOperations:
    ...
    async def begin_export_request_rate_by_interval(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2020_06_01.models.LogAnalyticsOperationResult]
    ...
    async def begin_export_throttled_requests(
        ...
        **kwargs
        ...
        :type parameters: ~azure.mgmt.compute.v2020_06_01.models.LogAnalyticsInputBase
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
