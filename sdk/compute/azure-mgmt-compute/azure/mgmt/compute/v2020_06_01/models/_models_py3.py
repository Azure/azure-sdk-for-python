...
class LastPatchInstallationSummary(msrest.serialization.Model):
    ...
    :ivar reboot_status: The reboot status of the machine after the patch operation. It will be in
     ...
     successfully. Known values are: "NotNeeded", "Required", "Started", "Failed", "Completed".
...
class PatchSettings(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        patch_mode: Optional[Union[str, "_models.InGuestPatchMode"]] = None,
        **kwargs
    ):
        """
...
class VirtualMachineSoftwarePatchProperties(msrest.serialization.Model):
    ...
    :ivar assessment_state: Describes the outcome of an install operation for a given patch. Known
     values are: "Installed", "Failed", "Excluded", "NotSelected", "Pending", "Available".
