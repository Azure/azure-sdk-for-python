...
def build_create_or_update_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ProximityPlacementGroup] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_update_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ProximityPlacementGroupUpdate] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    if include_colocation_status is not None:
        _params['includeColocationStatus'] = _SERIALIZER.query("include_colocation_status", include_colocation_status, 'str')
    _params['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
...
class ProximityPlacementGroupsOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.v2021_11_01.models.ProximityPlacementGroup
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.v2021_11_01.models.ProximityPlacementGroupUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ProximityPlacementGroup, or the result of cls(response)
        :rtype: ~azure.mgmt.compute.v2021_11_01.models.ProximityPlacementGroup
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ProximityPlacementGroupListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2021_11_01.models.ProximityPlacementGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
