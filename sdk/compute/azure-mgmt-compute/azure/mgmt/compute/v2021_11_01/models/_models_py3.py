...
class DiskRestorePointInstanceView(msrest.serialization.Model):
    ...
    :vartype replication_status: any
    """
    ...
    def __init__(
        ...
        *,
        id: Optional[str] = None,
        replication_status: Optional[Any] = None,
        **kwargs
    ):
        """
        ...
        :paramtype replication_status: any
        """
...
class SecurityProfile(msrest.serialization.Model):
    ...
    :ivar security_type: Specifies the SecurityType of the virtual machine. It has to be set to any
     ...
     be enabled unless this property is set. Known values are: "TrustedLaunch", "ConfidentialVM".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword security_type: Specifies the SecurityType of the virtual machine. It has to be set to
         ...
         not be enabled unless this property is set. Known values are: "TrustedLaunch",
         "ConfidentialVM".
...
class VirtualMachineImage(VirtualMachineImageResource):
    ...
    :ivar architecture: Specifies the Architecture Type. Known values are: "x64", "Arm64".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword architecture: Specifies the Architecture Type. Known values are: "x64", "Arm64".
