...
class VirtualMachineScaleSetExtensionsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param extension_parameters: Parameters supplied to the Create VM scale set Extension
         operation.
        :type extension_parameters: ~azure.mgmt.compute.v2021_04_01.models.VirtualMachineScaleSetExtension
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2021_04_01.models.VirtualMachineScaleSetExtension]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param extension_parameters: Parameters supplied to the Update VM scale set Extension
         operation.
        :type extension_parameters: ~azure.mgmt.compute.v2021_04_01.models.VirtualMachineScaleSetExtensionUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2021_04_01.models.VirtualMachineScaleSetExtensionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
