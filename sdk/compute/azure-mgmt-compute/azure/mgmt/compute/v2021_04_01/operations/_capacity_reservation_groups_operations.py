...
def build_create_or_update_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/capacityReservationGroups/{capacityReservationGroupName}')
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    expand = kwargs.pop('expand', None)  # type: Optional[Union[str, "_models.CapacityReservationGroupInstanceViewTypes"]]
...
def build_list_by_resource_group_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    expand = kwargs.pop('expand', None)  # type: Optional[Union[str, "_models.ExpandTypesForGetCapacityReservationGroups"]]

    api_version = "2021-04-01"
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/capacityReservationGroups')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
...
def build_list_by_subscription_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Compute/capacityReservationGroups')
    path_format_arguments = {
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
    url = _format_url_section(url, **path_format_arguments)
...
class CapacityReservationGroupsOperations(object):
    ...
    def create_or_update(
        ...
        resource_group_name,  # type: str
        capacity_reservation_group_name,  # type: str
        parameters,  # type: "_models.CapacityReservationGroup"
        **kwargs  # type: Any
    ):
        ...
        json = self._serialize.body(parameters, "CapacityReservationGroup")
    ...
    def update(
        ...
        resource_group_name,  # type: str
        capacity_reservation_group_name,  # type: str
        parameters,  # type: "_models.CapacityReservationGroupUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.CapacityReservationGroup"
        ...
        json = self._serialize.body(parameters, "CapacityReservationGroupUpdate")
    ...
    def get(
        ...
        resource_group_name,  # type: str
        capacity_reservation_group_name,  # type: str
        expand=None,  # type: Optional[Union[str, "_models.CapacityReservationGroupInstanceViewTypes"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.CapacityReservationGroup"
    ...
    def list_by_resource_group(
        self,
        resource_group_name,  # type: str
        expand=None,  # type: Optional[Union[str, "_models.ExpandTypesForGetCapacityReservationGroups"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["_models.CapacityReservationGroupListResult"]
        ...
        :return: An iterator like instance of either CapacityReservationGroupListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2021_04_01.models.CapacityReservationGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
