...
def build_list_by_location_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/virtualMachineScaleSets')
...
def build_create_or_update_request_initial(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}')
    path_format_arguments = {
...
def build_delete_request_initial(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    force_deletion = kwargs.pop('force_deletion', None)  # type: Optional[bool]
    ...
    if force_deletion is not None:
        query_parameters['forceDeletion'] = _SERIALIZER.query("force_deletion", force_deletion, 'bool')
    query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    expand = kwargs.pop('expand', None)  # type: Optional[Union[str, "_models.ExpandTypesForGetVMScaleSets"]]
...
def build_deallocate_request_initial(
    ...
    **kwargs  # type: Any
    ...
    api_version = "2021-04-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/deallocate')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_delete_instances_request_initial(
    ...
    **kwargs  # type: Any
    ...
    api_version = "2021-04-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/delete')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_get_instance_view_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/instanceView')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
...
def build_list_all_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Compute/virtualMachineScaleSets')
    path_format_arguments = {
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
    url = _format_url_section(url, **path_format_arguments)
...
def build_list_skus_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/skus')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_get_os_upgrade_history_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/osUpgradeHistory')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_power_off_request_initial(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    content_type = kwargs.pop('content_type', None)  # type: Optional[str]
    skip_shutdown = kwargs.pop('skip_shutdown', False)  # type: Optional[bool]

    api_version = "2021-04-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/poweroff')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    ...
    if skip_shutdown is not None:
        query_parameters['skipShutdown'] = _SERIALIZER.query("skip_shutdown", skip_shutdown, 'bool')
    query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
...
def build_restart_request_initial(
    ...
    **kwargs  # type: Any
    ...
    api_version = "2021-04-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/restart')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_start_request_initial(
    ...
    **kwargs  # type: Any
    ...
    api_version = "2021-04-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/start')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_redeploy_request_initial(
    ...
    **kwargs  # type: Any
    ...
    api_version = "2021-04-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/redeploy')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_perform_maintenance_request_initial(
    ...
    **kwargs  # type: Any
    ...
    api_version = "2021-04-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/performMaintenance')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_update_instances_request_initial(
    ...
    **kwargs  # type: Any
    ...
    api_version = "2021-04-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/manualupgrade')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_reimage_request_initial(
    ...
    **kwargs  # type: Any
    ...
    api_version = "2021-04-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/reimage')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_reimage_all_request_initial(
    ...
    **kwargs  # type: Any
    ...
    api_version = "2021-04-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/reimageall')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_force_recovery_service_fabric_platform_update_domain_walk_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    platform_update_domain = kwargs.pop('platform_update_domain')  # type: int

    api_version = "2021-04-01"
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/forceRecoveryServiceFabricPlatformUpdateDomainWalk')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    ...
    query_parameters = kwargs.pop("params", {})  # type: Dict[str, Any]
    query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
    query_parameters['platformUpdateDomain'] = _SERIALIZER.query("platform_update_domain", platform_update_domain, 'int')
...
def build_convert_to_single_placement_group_request(
    ...
    **kwargs  # type: Any
    ...
    api_version = "2021-04-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/convertToSinglePlacementGroup')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_set_orchestration_service_state_request_initial(
    ...
    **kwargs  # type: Any
    ...
    api_version = "2021-04-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/setOrchestrationServiceState')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'vmScaleSetName': _SERIALIZER.url("vm_scale_set_name", vm_scale_set_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
class VirtualMachineScaleSetsOperations(object):
    ...
    def list_by_location(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.VirtualMachineScaleSetListResult"]
        ...
        :return: An iterator like instance of either VirtualMachineScaleSetListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2021_04_01.models.VirtualMachineScaleSetListResult]
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        vm_scale_set_name,  # type: str
        parameters,  # type: "_models.VirtualMachineScaleSet"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.VirtualMachineScaleSet"
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.VirtualMachineScaleSet"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]

        json = self._serialize.body(parameters, "VirtualMachineScaleSet")
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.VirtualMachineScaleSet"]
        ...
        :type parameters: ~azure.mgmt.compute.v2021_04_01.models.VirtualMachineScaleSet
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either VirtualMachineScaleSet or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2021_04_01.models.VirtualMachineScaleSet]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        vm_scale_set_name,  # type: str
        parameters,  # type: "_models.VirtualMachineScaleSetUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.VirtualMachineScaleSet"
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.VirtualMachineScaleSet"]
        ...
        json = self._serialize.body(parameters, "VirtualMachineScaleSetUpdate")
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        :type vm_scale_set_name: str
        :param parameters: The scale set object.
        :type parameters: ~azure.mgmt.compute.v2021_04_01.models.VirtualMachineScaleSetUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
    ...
    def get(
        ...
        resource_group_name,  # type: str
        vm_scale_set_name,  # type: str
        expand=None,  # type: Optional[Union[str, "_models.ExpandTypesForGetVMScaleSets"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.VirtualMachineScaleSet"
    ...
    def _deallocate_initial(
        ...
        resource_group_name,  # type: str
        vm_scale_set_name,  # type: str
        vm_instance_i_ds=None,  # type: Optional["_models.VirtualMachineScaleSetVMInstanceIDs"]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop("cls", None)  # type: ClsType[None]
        ...
        if vm_instance_i_ds is not None:
            json = self._serialize.body(vm_instance_i_ds, "VirtualMachineScaleSetVMInstanceIDs")
        else:
            json = None
    ...
    def _delete_instances_initial(
        ...
        resource_group_name,  # type: str
        vm_scale_set_name,  # type: str
        vm_instance_i_ds,  # type: "_models.VirtualMachineScaleSetVMInstanceRequiredIDs"
        force_deletion=None,  # type: Optional[bool]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        json = self._serialize.body(vm_instance_i_ds, "VirtualMachineScaleSetVMInstanceRequiredIDs")
    ...
    def get_instance_view(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.VirtualMachineScaleSetInstanceView"
    ...
    def list_all(
        ...
        # type: (...) -> Iterable["_models.VirtualMachineScaleSetListWithLinkResult"]
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2021_04_01.models.VirtualMachineScaleSetListWithLinkResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_skus(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.VirtualMachineScaleSetListSkusResult"]
        ...
        :return: An iterator like instance of either VirtualMachineScaleSetListSkusResult or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2021_04_01.models.VirtualMachineScaleSetListSkusResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_os_upgrade_history(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.VirtualMachineScaleSetListOSUpgradeHistory"]
        ...
        :return: An iterator like instance of either VirtualMachineScaleSetListOSUpgradeHistory or the
         result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2021_04_01.models.VirtualMachineScaleSetListOSUpgradeHistory]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _reimage_initial(
        ...
        resource_group_name,  # type: str
        vm_scale_set_name,  # type: str
        vm_scale_set_reimage_input=None,  # type: Optional["_models.VirtualMachineScaleSetReimageParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop("cls", None)  # type: ClsType[None]
        ...
        if vm_scale_set_reimage_input is not None:
            json = self._serialize.body(vm_scale_set_reimage_input, "VirtualMachineScaleSetReimageParameters")
        else:
            json = None
    ...
    def begin_reimage(
        ...
        **kwargs  # type: Any
        ...
        :type vm_scale_set_reimage_input:
         ~azure.mgmt.compute.v2021_04_01.models.VirtualMachineScaleSetReimageParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
    ...
    def force_recovery_service_fabric_platform_update_domain_walk(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.RecoveryWalkResponse"
    ...
    def convert_to_single_placement_group(
        ...
        resource_group_name,  # type: str
        vm_scale_set_name,  # type: str
        parameters,  # type: "_models.VMScaleSetConvertToSinglePlacementGroupInput"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        :type parameters:
         ~azure.mgmt.compute.v2021_04_01.models.VMScaleSetConvertToSinglePlacementGroupInput
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        json = self._serialize.body(parameters, "VMScaleSetConvertToSinglePlacementGroupInput")
    ...
    def _set_orchestration_service_state_initial(
        ...
        resource_group_name,  # type: str
        vm_scale_set_name,  # type: str
        parameters,  # type: "_models.OrchestrationServiceStateInput"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop("cls", None)  # type: ClsType[None]
        ...
        json = self._serialize.body(parameters, "OrchestrationServiceStateInput")
    ...
    def begin_set_orchestration_service_state(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.compute.v2021_04_01.models.OrchestrationServiceStateInput
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
