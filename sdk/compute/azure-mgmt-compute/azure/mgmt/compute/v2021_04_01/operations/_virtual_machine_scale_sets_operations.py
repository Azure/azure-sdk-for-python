...
def build_list_by_location_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/virtualMachineScaleSets")  # pylint: disable=line-too-long
...
def build_create_or_update_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.VirtualMachineScaleSet] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_update_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.VirtualMachineScaleSetUpdate] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_deallocate_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.VirtualMachineScaleSetVMInstanceIDs] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_delete_instances_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.VirtualMachineScaleSetVMInstanceRequiredIDs] = None,
    content: Any = None,
    force_deletion: Optional[bool] = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_reimage_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.VirtualMachineScaleSetReimageParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_convert_to_single_placement_group_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.VMScaleSetConvertToSinglePlacementGroupInput] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_set_orchestration_service_state_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.OrchestrationServiceStateInput] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :param expand: The expand expression to apply on the operation. 'UserData' retrieves the
         ...
         Create/Update operation. Default value is None.
