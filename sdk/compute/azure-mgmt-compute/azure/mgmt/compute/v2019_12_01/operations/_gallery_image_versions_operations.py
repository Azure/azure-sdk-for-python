...
def build_create_or_update_request_initial(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/images/{galleryImageName}/versions/{galleryImageVersionName}')
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    expand = kwargs.pop('expand', None)  # type: Optional[Union[str, "_models.ReplicationStatusTypes"]]
...
def build_list_by_gallery_image_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/images/{galleryImageName}/versions')
    path_format_arguments = {
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'galleryName': _SERIALIZER.url("gallery_name", gallery_name, 'str'),
...
class GalleryImageVersionsOperations(object):
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        json = self._serialize.body(gallery_image_version, "GalleryImageVersion")
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.GalleryImageVersion"]
        ...
        :param gallery_image_version: Parameters supplied to the create or update gallery Image Version
         operation.
        :type gallery_image_version: ~azure.mgmt.compute.v2019_12_01.models.GalleryImageVersion
    ...
    def _update_initial(
        ...
        gallery_image_name,  # type: str
        gallery_image_version_name,  # type: str
        gallery_image_version,  # type: "_models.GalleryImageVersionUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.GalleryImageVersion"
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.GalleryImageVersion"]
        ...
        json = self._serialize.body(gallery_image_version, "GalleryImageVersionUpdate")
    ...
    def list_by_gallery_image(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.GalleryImageVersionList"]
        ...
        :return: An iterator like instance of either GalleryImageVersionList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2019_12_01.models.GalleryImageVersionList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
