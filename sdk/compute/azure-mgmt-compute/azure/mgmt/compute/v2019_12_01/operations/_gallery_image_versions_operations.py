...
class GalleryImageVersionsOperations(object):
    ...
    def begin_create_or_update(
     ...
     operation.
        ...
        :return: An instance of LROPoller that returns GalleryImageVersion
    ...
    def list_by_gallery_image(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.GalleryImageVersionList"
     ...
     Image Versions are to be listed.
        :type gallery_image_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: GalleryImageVersionList or the result of cls(response)
        :rtype: ~azure.mgmt.compute.v2019_12_01.models.GalleryImageVersionList
        :raises: ~azure.core.exceptions.HttpResponseError
        """
