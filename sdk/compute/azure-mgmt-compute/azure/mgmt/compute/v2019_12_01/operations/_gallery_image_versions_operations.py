...
class GalleryImageVersionsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gallery_image_version: ~azure.mgmt.compute.v2019_12_01.models.GalleryImageVersion or IO
    ...
    def list_by_gallery_image(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2019_12_01.models.GalleryImageVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
