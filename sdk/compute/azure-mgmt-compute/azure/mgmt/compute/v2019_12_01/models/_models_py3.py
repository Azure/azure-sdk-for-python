...
class AdditionalUnattendContent(Model):
    ...
    :type pass_name: str or ~azure.mgmt.compute.v2019_12_01.models.PassNames
    ...
    :type component_name: str or
     ~azure.mgmt.compute.v2019_12_01.models.ComponentNames
    ...
    :type setting_name: str or
     ~azure.mgmt.compute.v2019_12_01.models.SettingNames
...
class AvailabilitySet(Resource):
    ...
    :vartype statuses:
     list[~azure.mgmt.compute.v2019_12_01.models.InstanceViewStatus]
...
class DataDisk(Model):
    ...
    :ivar disk_iops_read_write: Specifies the Read-Write IOPS for the managed
    ...
    :ivar disk_mbps_read_write: Specifies the bandwidth in MB per second for
    ...
    :vartype disk_mbps_read_write: long
    """
    ...
    _validation = {
        ...
        'disk_mbps_read_write': {'readonly': True},
    }
...
class DedicatedHost(Resource):
    ...
    :vartype virtual_machines:
     list[~azure.mgmt.compute.v2019_12_01.models.SubResourceReadOnly]
    ...
    :vartype instance_view:
     ~azure.mgmt.compute.v2019_12_01.models.DedicatedHostInstanceView
...
class DiagnosticsProfile(Model):
    ...
    :type boot_diagnostics:
     ~azure.mgmt.compute.v2019_12_01.models.BootDiagnostics
    """
...
class DiskEncryptionSetParameters(SubResource):
    ...
    that can be specified for disk. <br><br> NOTE: The disk encryption set
...
class DiskEncryptionSettings(Model):
    ...
    :type disk_encryption_key:
     ~azure.mgmt.compute.v2019_12_01.models.KeyVaultSecretReference
...
class HardwareProfile(Model):
    ...
    :type vm_size: str or
     ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineSizeTypes
    """
...
class Image(Resource):
    ...
    :param storage_profile: Specifies the storage settings for the virtual
     machine disks.
    :type storage_profile:
     ~azure.mgmt.compute.v2019_12_01.models.ImageStorageProfile
...
class ImageStorageProfile(Model):
    ...
    :param data_disks: Specifies the parameters that are used to add a data
     ...
     machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
    :type data_disks:
     list[~azure.mgmt.compute.v2019_12_01.models.ImageDataDisk]
...
class InstanceViewStatus(Model):
    ...
    :param level: The level code. Possible values include: 'Info', 'Warning',
     'Error'
    :type level: str or
     ~azure.mgmt.compute.v2019_12_01.models.StatusLevelTypes
...
class LogAnalyticsOperationResult(Model):
    ...
    :vartype properties:
     ~azure.mgmt.compute.v2019_12_01.models.LogAnalyticsOutput
    """
...
class OSDisk(Model):
    ...
    :param encryption_settings: Specifies the encryption settings for the OS
     Disk. <br><br> Minimum api-version: 2015-06-15
    :type encryption_settings:
     ~azure.mgmt.compute.v2019_12_01.models.DiskEncryptionSettings
    :param name: The disk name.
    :type name: str
    :param vhd: The virtual hard disk.
    :type vhd: ~azure.mgmt.compute.v2019_12_01.models.VirtualHardDisk
    ...
    :type diff_disk_settings:
     ~azure.mgmt.compute.v2019_12_01.models.DiffDiskSettings
    :param create_option: Required. Specifies how the virtual machine should
     be created.<br><br> Possible values are:<br><br> **Attach** \\u2013 This
     value is used when you are using a specialized disk to create the virtual
     machine.<br><br> **FromImage** \\u2013 This value is used when you are
...
class OSProfile(Model):
    ...
    :type windows_configuration:
     ~azure.mgmt.compute.v2019_12_01.models.WindowsConfiguration
    ...
    :type linux_configuration:
     ~azure.mgmt.compute.v2019_12_01.models.LinuxConfiguration
    :param secrets: Specifies set of certificates that should be installed
     onto the virtual machine.
    :type secrets:
     list[~azure.mgmt.compute.v2019_12_01.models.VaultSecretGroup]
    ...
    :param require_guest_provision_signal: Specifies whether the guest
     provision signal is required to infer provision success of the virtual
     machine.
...
class ProximityPlacementGroup(Resource):
    ...
    :type colocation_status:
     ~azure.mgmt.compute.v2019_12_01.models.InstanceViewStatus
    """
...
class RequestRateByIntervalInput(LogAnalyticsInputBase):
    ...
    :type interval_length: str or
     ~azure.mgmt.compute.v2019_12_01.models.IntervalInMins
    """
...
class RollingUpgradeRunningStatus(Model):
    ...
    :vartype code: str or
     ~azure.mgmt.compute.v2019_12_01.models.RollingUpgradeStatusCode
    ...
    :vartype last_action: str or
     ~azure.mgmt.compute.v2019_12_01.models.RollingUpgradeActionType
...
class RollingUpgradeStatusInfo(Resource):
    ...
    :vartype policy:
     ~azure.mgmt.compute.v2019_12_01.models.RollingUpgradePolicy
    :ivar running_status: Information about the current running state of the
     overall upgrade.
    :vartype running_status:
     ~azure.mgmt.compute.v2019_12_01.models.RollingUpgradeRunningStatus
    :ivar progress: Information about the number of virtual machine instances
     in each upgrade state.
    :vartype progress:
     ~azure.mgmt.compute.v2019_12_01.models.RollingUpgradeProgressInfo
...
class RunCommandInput(Model):
    ...
    :type parameters:
     list[~azure.mgmt.compute.v2019_12_01.models.RunCommandInputParameter]
    """
...
class SshConfiguration(Model):
    ...
    :param public_keys: The list of SSH public keys used to authenticate with
     linux based VMs.
    :type public_keys:
     list[~azure.mgmt.compute.v2019_12_01.models.SshPublicKey]
    """
...
class StorageProfile(Model):
    ...
    :type image_reference:
     ~azure.mgmt.compute.v2019_12_01.models.ImageReference
    :param os_disk: Specifies information about the operating system disk used
     by the virtual machine. <br><br> For more information about disks, see
     [About disks and VHDs for Azure virtual
     machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
...
class UpgradeOperationHistoricalStatusInfoProperties(Model):
    ...
    :ivar running_status: Information about the overall status of the upgrade
     operation.
    :vartype running_status:
     ~azure.mgmt.compute.v2019_12_01.models.UpgradeOperationHistoryStatus
    ...
    :vartype started_by: str or
     ~azure.mgmt.compute.v2019_12_01.models.UpgradeOperationInvoker
    ...
    :vartype rollback_info:
     ~azure.mgmt.compute.v2019_12_01.models.RollbackStatusInfo
    """
...
class VaultSecretGroup(Model):
    ...
    :type vault_certificates:
     list[~azure.mgmt.compute.v2019_12_01.models.VaultCertificate]
    """
...
class VirtualMachineIdentity(Model):
    ...
    :type type: str or
     ~azure.mgmt.compute.v2019_12_01.models.ResourceIdentityType
    ...
    :type user_assigned_identities: dict[str,
     ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineIdentityUserAssignedIdentitiesValue]
    """
...
class VirtualMachineImage(VirtualMachineImageResource):
    ...
    :type data_disk_images:
     list[~azure.mgmt.compute.v2019_12_01.models.DataDiskImage]
...
class VirtualMachineInstanceView(Model):
    ...
    :type vm_agent:
     ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineAgentInstanceView
    ...
    :param boot_diagnostics: Boot Diagnostics is a debugging feature which
     ...
     Azure also enables you to see a screenshot of the VM from the hypervisor.
    :type boot_diagnostics:
     ~azure.mgmt.compute.v2019_12_01.models.BootDiagnosticsInstanceView
    :param statuses: The resource status information.
    :type statuses:
     list[~azure.mgmt.compute.v2019_12_01.models.InstanceViewStatus]
    """
...
class VirtualMachineScaleSetDataDisk(Model):
    ...
    :param disk_mbps_read_write: Specifies the bandwidth in MB per second for
...
class VirtualMachineScaleSetNetworkProfile(Model):
    ...
    :type health_probe:
     ~azure.mgmt.compute.v2019_12_01.models.ApiEntityReference
...
class VirtualMachineScaleSetPublicIPAddressConfiguration(Model):
    ...
    :type ip_tags:
     list[~azure.mgmt.compute.v2019_12_01.models.VirtualMachineScaleSetIpTag]
...
class VirtualMachineScaleSetSku(Model):
    ...
    :vartype capacity:
     ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineScaleSetSkuCapacity
    """
...
class VirtualMachineScaleSetStorageProfile(Model):
    ...
    :param os_disk: Specifies information about the operating system disk used
     ...
     machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
    :type os_disk:
     ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineScaleSetOSDisk
...
class VirtualMachineScaleSetUpdateStorageProfile(Model):
    ...
    :type os_disk:
     ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineScaleSetUpdateOSDisk
...
class VirtualMachineScaleSetVM(Resource):
    ...
    :ivar model_definition_applied: Specifies whether the model applied to the
     virtual machine is the model of the virtual machine scale set or the
    ...
    def __init__(self, *, location: str, tags=None, hardware_profile=None, storage_profile=None, additional_capabilities=None, os_profile=None, network_profile=None, network_profile_configuration=None, diagnostics_profile=None, availability_set=None, license_type: str=None, protection_policy=None, plan=None, **kwargs) -> None:
...
class VirtualMachineScaleSetVMProfile(Model):
    ...
    :type os_profile:
     ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineScaleSetOSProfile
    :param storage_profile: Specifies the storage settings for the virtual
     machine disks.
    :type storage_profile:
