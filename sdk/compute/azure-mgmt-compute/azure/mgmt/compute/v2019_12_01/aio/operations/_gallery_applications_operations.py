...
class GalleryApplicationsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either GalleryApplication or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2019_12_01.models.GalleryApplication]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gallery_application: ~azure.mgmt.compute.v2019_12_01.models.GalleryApplication or IO
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery_application: ~azure.mgmt.compute.v2019_12_01.models.GalleryApplicationUpdate or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
    ...
    def list_by_gallery(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2019_12_01.models.GalleryApplication]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
