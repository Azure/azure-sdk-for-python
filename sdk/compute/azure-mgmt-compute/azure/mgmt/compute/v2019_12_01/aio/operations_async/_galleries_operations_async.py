...
class GalleriesOperations:
    ...
    async def create_or_update(
     ...
     and numbers with dots and periods allowed in the middle. The maximum length is 80 characters.
        ...
        :return: An instance of LROPoller that returns Gallery
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2019_12_01.models.Gallery]
    ...
    async def update(
     ...
     and numbers with dots and periods allowed in the middle. The maximum length is 80 characters.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}'}
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}'}
    ...
    def list_by_resource_group(
        ...
        **kwargs
        ...
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: GalleryList or the result of cls(response)
        :rtype: ~azure.mgmt.compute.v2019_12_01.models.GalleryList
        :raises: ~azure.core.exceptions.HttpResponseError
        """
