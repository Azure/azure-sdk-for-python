...
class GalleryImagesOperations:
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(gallery_image, "GalleryImageUpdate")
    ...
    def list_by_gallery(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2019_12_01.models.GalleryImageList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
