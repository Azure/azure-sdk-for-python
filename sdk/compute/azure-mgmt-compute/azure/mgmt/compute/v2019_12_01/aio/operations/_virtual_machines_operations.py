...
class VirtualMachinesOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_by_location(self, location: str, **kwargs: Any) -> AsyncIterable["_models.VirtualMachine"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2019_12_01.models.VirtualMachine]
    ...
    async def begin_capture(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineCaptureParameters or IO
    ...
    async def begin_create_or_update(
        ...
        :param parameters: Parameters supplied to the Create Virtual Machine operation. Is either a
         model type or a IO type. Required.
        :type parameters: ~azure.mgmt.compute.v2019_12_01.models.VirtualMachine or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        :param parameters: Parameters supplied to the Update Virtual Machine operation. Is either a
         model type or a IO type. Required.
        :type parameters: ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_reimage(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineReimageParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
