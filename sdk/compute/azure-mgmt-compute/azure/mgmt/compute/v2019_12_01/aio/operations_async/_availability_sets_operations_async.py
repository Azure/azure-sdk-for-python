...
class AvailabilitySetsOperations:
    ...
    def list_by_subscription(
        ...
        **kwargs
    ) -> "models.AvailabilitySetListResult":
        """Lists all availability sets in a subscription.

        :param expand: The expand expression to apply to the operation.
        :type expand: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AvailabilitySetListResult or the result of cls(response)
        :rtype: ~azure.mgmt.compute.v2019_12_01.models.AvailabilitySetListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_available_sizes(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineSizeListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
