...
class LinuxVMGuestPatchAutomaticByPlatformRebootSetting(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class WindowsVMGuestPatchAutomaticByPlatformRebootSetting(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """Specifies the reboot setting for all AutomaticByPlatform patch installation operations.
    """
