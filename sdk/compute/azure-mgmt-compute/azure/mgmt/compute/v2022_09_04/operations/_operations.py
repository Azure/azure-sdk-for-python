...
class CloudServiceRolesOperations:
    ...
    ) -> ItemPaged["_models.CloudServiceRole"]:
...
class CloudServicesOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def list_all(self, **kwargs: Any) -> ItemPaged["_models.CloudService"]:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.CloudService"]:
