...
from ...operations._disk_restore_point_operations import build_get_request, build_grant_access_request_initial, build_list_by_restore_point_request, build_revoke_access_request_initial
T = TypeVar('T')
    ...
    def list_by_restore_point(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DiskRestorePointList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2022_03_02.models.DiskRestorePointList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_grant_access(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either AccessUri or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.compute.v2022_03_02.models.AccessUri]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
