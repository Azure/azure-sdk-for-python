...
class DisksOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type disk: ~azure.mgmt.compute.v2022_03_02.models.Disk
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2022_03_02.models.Disk]
    ...
    def begin_create_or_update(
        ...
        :type disk: ~azure.mgmt.compute.v2022_03_02.models.Disk or IO
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type disk: ~azure.mgmt.compute.v2022_03_02.models.DiskUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        :type disk: ~azure.mgmt.compute.v2022_03_02.models.DiskUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get(self, resource_group_name: str, disk_name: str, **kwargs: Any) -> _models.Disk:
        ...
        :rtype: ~azure.mgmt.compute.v2022_03_02.models.Disk
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Disk"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2022_03_02.models.Disk]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
