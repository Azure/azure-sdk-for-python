...
def build_list_by_gallery_application_request(  # pylint: disable=name-too-long
...
class GalleryApplicationVersionsOperations:
    ...
    def list_by_gallery_application(
        ...
        :return: An iterator like instance of either GalleryApplicationVersion or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.models.GalleryApplicationVersion]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_gallery_application_request(
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :param expand: The expand expression to apply on the operation. Known values are:
         "ReplicationStatus" and "UefiSettings". Default value is None.
        :type expand: str or ~azure.mgmt.compute.models.ReplicationStatusTypes
        :return: GalleryApplicationVersion or the result of cls(response)
        :rtype: ~azure.mgmt.compute.models.GalleryApplicationVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either GalleryApplicationVersion or the result
         of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.GalleryApplicationVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
