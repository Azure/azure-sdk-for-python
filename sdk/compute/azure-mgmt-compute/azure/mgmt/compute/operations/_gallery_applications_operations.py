...
class GalleryApplicationsOperations:
    ...
    def list_by_gallery(
    ...
    ) -> ItemPaged["_models.GalleryApplication"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.models.GalleryApplication]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.compute.models.GalleryApplication
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either GalleryApplication or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.GalleryApplication]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gallery_application: ~azure.mgmt.compute.models.GalleryApplication or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryApplication or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.GalleryApplication]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery_application: ~azure.mgmt.compute.models.GalleryApplicationUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryApplication or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.GalleryApplication]
        :raises ~azure.core.exceptions.HttpResponseError:
