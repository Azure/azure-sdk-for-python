...
class DiskEncryptionSetsOperations:
    ...
    def list(self, **kwargs: Any) -> ItemPaged["_models.DiskEncryptionSet"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.models.DiskEncryptionSet]
    ...
    def get(self, resource_group_name: str, disk_encryption_set_name: str, **kwargs: Any) -> _models.DiskEncryptionSet:
        ...
        :rtype: ~azure.mgmt.compute.models.DiskEncryptionSet
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either DiskEncryptionSet or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.DiskEncryptionSet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type disk_encryption_set: ~azure.mgmt.compute.models.DiskEncryptionSet or IO[bytes]
        :return: An instance of LROPoller that returns either DiskEncryptionSet or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.DiskEncryptionSet]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param disk_encryption_set: disk encryption set object supplied in the body of the Patch disk
         ...
         Required.
        :type disk_encryption_set: ~azure.mgmt.compute.models.DiskEncryptionSetUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either DiskEncryptionSet or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.DiskEncryptionSet]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_associated_resources(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_associated_resources_request(
                    resource_group_name=resource_group_name,
                    disk_encryption_set_name=disk_encryption_set_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
