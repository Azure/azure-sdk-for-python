...
class GalleryImageVersionsOperations:
    ...
    def list_by_gallery_image(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.models.GalleryImageVersion]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_gallery_image_request(
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either GalleryImageVersion or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.GalleryImageVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gallery_image_version: ~azure.mgmt.compute.models.GalleryImageVersion or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryImageVersion or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.GalleryImageVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery_image_version: ~azure.mgmt.compute.models.GalleryImageVersionUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryImageVersion or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.GalleryImageVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
