...
class CloudServicesUpdateDomainOperations:
    ...
    def _walk_update_domain_initial(
        ...
        **kwargs: Any
        ...
        _request = build_walk_update_domain_request(
    ...
    def begin_walk_update_domain(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.models.UpdateDomain
    ...
    def begin_walk_update_domain(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.models.UpdateDomain or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_update_domain(
        ...
        :rtype: ~azure.mgmt.compute.models.UpdateDomain
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _request = build_get_update_domain_request(
            resource_group_name=resource_group_name,
            cloud_service_name=cloud_service_name,
            update_domain=update_domain,
            subscription_id=self._config.subscription_id,
    ...
    def list_update_domains(
    ...
    ) -> ItemPaged["_models.UpdateDomain"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.models.UpdateDomain]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_update_domains_request(
                    resource_group_name=resource_group_name,
                    cloud_service_name=cloud_service_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
