...
def build_list_by_artifact_name_request(
...
class SoftDeletedResourceOperations:
    ...
    def list_by_artifact_name(
    ...
    ) -> ItemPaged["_models.GallerySoftDeletedResource"]:
        ...
        :return: An iterator like instance of either GallerySoftDeletedResource or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.models.GallerySoftDeletedResource]
