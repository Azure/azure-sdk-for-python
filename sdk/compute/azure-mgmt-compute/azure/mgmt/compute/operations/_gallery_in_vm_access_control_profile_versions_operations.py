...
def build_list_by_gallery_in_vm_access_control_profile_request(  # pylint: disable=name-too-long
...
class GalleryInVMAccessControlProfileVersionsOperations:  # pylint: disable=name-too-long
    ...
    def list_by_gallery_in_vm_access_control_profile(  # pylint: disable=name-too-long
    ...
    ) -> ItemPaged["_models.GalleryInVMAccessControlProfileVersion"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.models.GalleryInVMAccessControlProfileVersion]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_gallery_in_vm_access_control_profile_request(
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.compute.models.GalleryInVMAccessControlProfileVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.GalleryInVMAccessControlProfileVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gallery_in_vm_access_control_profile_version:
         ~azure.mgmt.compute.models.GalleryInVMAccessControlProfileVersion or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryInVMAccessControlProfileVersion or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.GalleryInVMAccessControlProfileVersion]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery_in_vm_access_control_profile_version:
         ~azure.mgmt.compute.models.GalleryInVMAccessControlProfileVersionUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryInVMAccessControlProfileVersion or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.GalleryInVMAccessControlProfileVersion]
