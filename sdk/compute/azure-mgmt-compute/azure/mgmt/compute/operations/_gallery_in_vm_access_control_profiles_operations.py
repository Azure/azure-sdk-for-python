...
class GalleryInVMAccessControlProfilesOperations:  # pylint: disable=name-too-long
    ...
    def list_by_gallery(
    ...
    ) -> ItemPaged["_models.GalleryInVMAccessControlProfile"]:
        ...
        :return: An iterator like instance of either GalleryInVMAccessControlProfile or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.models.GalleryInVMAccessControlProfile]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.compute.models.GalleryInVMAccessControlProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.GalleryInVMAccessControlProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gallery_in_vm_access_control_profile:
         ~azure.mgmt.compute.models.GalleryInVMAccessControlProfile or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryInVMAccessControlProfile or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.GalleryInVMAccessControlProfile]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type gallery_in_vm_access_control_profile:
         ~azure.mgmt.compute.models.GalleryInVMAccessControlProfileUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either GalleryInVMAccessControlProfile or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.GalleryInVMAccessControlProfile]
