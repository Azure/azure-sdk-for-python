...
def build_list_by_capacity_reservation_group_request(  # pylint: disable=name-too-long
...
class CapacityReservationsOperations:
    ...
    def list_by_capacity_reservation_group(
    ...
    ) -> ItemPaged["_models.CapacityReservation"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.models.CapacityReservation]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_capacity_reservation_group_request(
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :type expand: str or ~azure.mgmt.compute.models.CapacityReservationInstanceViewTypes
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either CapacityReservation or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.CapacityReservation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.models.CapacityReservation or IO[bytes]
        :return: An instance of LROPoller that returns either CapacityReservation or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.CapacityReservation]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.models.CapacityReservationUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either CapacityReservation or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.CapacityReservation]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_delete(
        ...
        **kwargs: Any
        ...
        https://aka.ms/CapacityReservation for more details. Note: Block capacity reservations cannot
        be deleted after it has been successfully allocated until the schedule end time.
