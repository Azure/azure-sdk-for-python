...
def build_attach_detach_data_disks_request(
    resource_group_name: str, vm_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_deallocate_request(
    ...
    **kwargs: Any
    ...
    if force_deallocate is not None:
        _params["forceDeallocate"] = _SERIALIZER.query("force_deallocate", force_deallocate, "bool")
...
def build_migrate_to_vm_scale_set_request(
    resource_group_name: str, vm_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_power_off_request(
    resource_group_name: str, vm_name: str, subscription_id: str, *, skip_shutdown: Optional[bool] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_retrieve_boot_diagnostics_data_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    vm_name: str,
    subscription_id: str,
    *,
...
class VirtualMachinesOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def list_by_location(self, location: str, **kwargs: Any) -> ItemPaged["_models.VirtualMachine"]:
        """Gets all the virtual machines under the specified subscription for the specified location.

        :param location: The name of Azure region. Required.
        :type location: str
        :return: An iterator like instance of either VirtualMachine or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.models.VirtualMachine]
    ...
    def list_all(
        ...
        **kwargs: Any
        ...
        :type filter: str
        :param expand: The expand expression to apply on operation. 'instanceView' enables fetching run
         time status of all Virtual Machines, this can only be specified if a valid $filter option is
         specified. "instanceView" Default value is None.
        :type expand: str or ~azure.mgmt.compute.models.ExpandTypesForListVMs
        :return: An iterator like instance of either VirtualMachine or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.models.VirtualMachine]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :param expand: The expand expression to apply on operation. 'instanceView' enables fetching run
         time status of all Virtual Machines, this can only be specified if a valid $filter option is
         specified. "instanceView" Default value is None.
        :type expand: str or ~azure.mgmt.compute.models.ExpandTypeForListVMs
        :return: An iterator like instance of either VirtualMachine or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.compute.models.VirtualMachine]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either VirtualMachine or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.VirtualMachine]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.models.VirtualMachine or IO[bytes]
        :param if_match: The ETag of the transformation. Omit this value to always overwrite the
         current resource. Specify the last-seen ETag value to prevent accidentally overwriting
         concurrent changes. Default value is None.
        :type if_match: str
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.models.VirtualMachineUpdate or IO[bytes]
        :param if_match: The ETag of the transformation. Omit this value to always overwrite the
         current resource. Specify the last-seen ETag value to prevent accidentally overwriting
         concurrent changes. Default value is None.
        :type if_match: str
    ...
    def begin_assess_patches(
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.VirtualMachineAssessPatchesResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_attach_detach_data_disks(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either StorageProfile or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.StorageProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _capture_initial(
        ...
        **kwargs: Any
        ...
        _request = build_capture_request(
            resource_group_name=resource_group_name,
            vm_name=vm_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_capture(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either VirtualMachineCaptureResult or the result
         of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.VirtualMachineCaptureResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_capture(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.models.VirtualMachineCaptureParameters or IO[bytes]
        :return: An instance of LROPoller that returns either VirtualMachineCaptureResult or the result
         of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.VirtualMachineCaptureResult]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_install_patches(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either VirtualMachineInstallPatchesResult or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.VirtualMachineInstallPatchesResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _migrate_to_vm_scale_set_initial(
        ...
        **kwargs: Any
        ...
        _request = build_migrate_to_vm_scale_set_request(
            resource_group_name=resource_group_name,
            vm_name=vm_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_migrate_to_vm_scale_set(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the Migrate Virtual Machine operation. Default value
         is None.
        :type parameters: ~azure.mgmt.compute.models.MigrateVMToVirtualMachineScaleSetInput
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either None or the result of cls(response)
    ...
    def begin_reimage(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.models.VirtualMachineReimageParameters or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_run_command(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either RunCommandResult or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.models.RunCommandResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
