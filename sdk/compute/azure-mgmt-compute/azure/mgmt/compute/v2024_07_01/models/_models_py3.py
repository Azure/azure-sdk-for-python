...
class EventGridAndResourceGraph(_serialization.Model):
    ...
    def __init__(self, *, enable: Optional[bool] = None, **kwargs: Any) -> None:
        """
...
class VirtualMachineImage(VirtualMachineImageResource):
    ...
    _attribute_map = {
        ...
        "image_deprecation_status": {"key": "properties.imageDeprecationStatus", "type": "ImageDeprecationStatus"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.image_deprecation_status = image_deprecation_status
...
class VirtualMachineInstanceView(_serialization.Model):
    ...
    _validation = {
        ...
        "is_vm_in_standby_pool": {"readonly": True},
    }
    ...
    _attribute_map = {
        ...
        "is_vm_in_standby_pool": {"key": "isVMInStandbyPool", "type": "bool"},
    }
...
class VirtualMachinePublicIPAddressDnsSettingsConfiguration(_serialization.Model):  # pylint: disable=name-too-long
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword domain_name_label_scope: The Domain name label scope of the PublicIPAddress resources
         that will be created. The generated name label is the concatenation of the hashed domain name
         label with policy according to the domain name label scope and vm network profile unique ID.
         Known values are: "TenantReuse", "SubscriptionReuse", "ResourceGroupReuse", and "NoReuse".
...
class VirtualMachineReimageParameters(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "exact_version": {"key": "exactVersion", "type": "str"},
        "os_profile": {"key": "osProfile", "type": "OSProfileProvisioningData"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword exact_version: Specifies in decimal number, the version the OS disk should be reimaged
         to. If exact version is not provided, the OS disk is reimaged to the existing version of OS
         Disk.
...
class VirtualMachineScaleSet(Resource):
    ...
    _attribute_map = {
        ...
        "time_created": {"key": "properties.timeCreated", "type": "iso-8601"},
        "constrained_maximum_capacity": {"key": "properties.constrainedMaximumCapacity", "type": "bool"},
        "resiliency_policy": {"key": "properties.resiliencyPolicy", "type": "ResiliencyPolicy"},
        "zonal_platform_fault_domain_align_mode": {
            "key": "properties.zonalPlatformFaultDomainAlignMode",
            "type": "str",
        },
        "sku_profile": {"key": "properties.skuProfile", "type": "SkuProfile"},
    }
...
class VirtualMachineScaleSetVMReimageParameters(VirtualMachineReimageParameters):  # pylint: disable=name-too-long
    ...
    _attribute_map = {
        ...
        "exact_version": {"key": "exactVersion", "type": "str"},
        "os_profile": {"key": "osProfile", "type": "OSProfileProvisioningData"},
        "force_update_os_disk_for_ephemeral": {"key": "forceUpdateOSDiskForEphemeral", "type": "bool"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        super().__init__(temp_disk=temp_disk, exact_version=exact_version, os_profile=os_profile, **kwargs)
        self.force_update_os_disk_for_ephemeral = force_update_os_disk_for_ephemeral
...
class VirtualMachineScaleSetUpdateIPConfiguration(_serialization.Model):  # pylint: disable=name-too-long
...
class VirtualMachineScaleSetVMExtension(SubResourceReadOnly):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword location: The location of the extension.
        :paramtype location: str
        :keyword force_update_tag: How the extension handler should be forced to update even if the
         extension configuration has not changed.
        :paramtype force_update_tag: str
...
class VirtualMachineScaleSetVMInstanceView(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype os_name: str
        :keyword os_version: The version of Operating System running on the hybrid machine.
        :paramtype os_version: str
