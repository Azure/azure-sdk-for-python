...
from ._models_py3 import SkuProfile
from ._models_py3 import SkuProfileVMSize
...
from ._compute_management_client_enums import AllocationStrategy
...
from ._compute_management_client_enums import ZonalPlatformFaultDomainAlignMode
