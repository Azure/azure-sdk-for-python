...
class LogAnalyticsOperations(object):
    ...
    def begin_export_request_rate_by_interval(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2018_06_01.models.LogAnalyticsOperationResult]
    ...
    def begin_export_throttled_requests(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.compute.v2018_06_01.models.LogAnalyticsInputBase
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
