...
class GalleryImageVersionsOperations:
    ...
    async def create_or_update(
     ...
     operation.
        :type gallery_image_version: ~azure.mgmt.compute.v2018_06_01.models.GalleryImageVersion
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/images/{galleryImageName}/versions/{galleryImageVersionName}'}  # type: ignore
    ...
    async def delete(
     ...
     resides.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/images/{galleryImageName}/versions/{galleryImageVersionName}'}  # type: ignore
    ...
    def list_by_gallery_image(
     ...
     Image Versions are to be listed.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.compute.v2018_06_01.models.GalleryImageVersionList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
