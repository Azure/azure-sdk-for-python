...
class DisksOperations:
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, disk_name: str, disk: "_models.Disk", **kwargs: Any
    ) -> "_models.Disk":
        ...
        json = self._serialize.body(disk, "Disk")
    ...
    async def _update_initial(
        self, resource_group_name: str, disk_name: str, disk: "_models.DiskUpdate", **kwargs: Any
    ) -> "_models.Disk":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.Disk"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        ...
        json = self._serialize.body(disk, "DiskUpdate")
    ...
    async def _delete_initial(self, resource_group_name: str, disk_name: str, **kwargs: Any) -> None:
    ...
    async def begin_delete(self, resource_group_name: str, disk_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
        ...
        if cont_token is None:
            raw_result = await self._delete_initial(
                resource_group_name=resource_group_name, disk_name=disk_name, cls=lambda x, y, z: x, **kwargs
            )
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.DiskList"]:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.DiskList"]:
    ...
    async def _grant_access_initial(
        self, resource_group_name: str, disk_name: str, grant_access_data: "_models.GrantAccessData", **kwargs: Any
    ...
    async def _revoke_access_initial(self, resource_group_name: str, disk_name: str, **kwargs: Any) -> None:
        cls = kwargs.pop("cls", None)  # type: ClsType[None]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
