...
class ComputeManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype availability_sets:
     azure.mgmt.compute.v2018_06_01.operations.AvailabilitySetsOperations
    :ivar proximity_placement_groups: ProximityPlacementGroupsOperations operations
    :vartype proximity_placement_groups:
     azure.mgmt.compute.v2018_06_01.operations.ProximityPlacementGroupsOperations
    ...
    :vartype virtual_machine_extension_images:
     azure.mgmt.compute.v2018_06_01.operations.VirtualMachineExtensionImagesOperations
    :ivar virtual_machine_extensions: VirtualMachineExtensionsOperations operations
    :vartype virtual_machine_extensions:
     azure.mgmt.compute.v2018_06_01.operations.VirtualMachineExtensionsOperations
    :ivar virtual_machine_images: VirtualMachineImagesOperations operations
    :vartype virtual_machine_images:
     azure.mgmt.compute.v2018_06_01.operations.VirtualMachineImagesOperations
    ...
    :vartype virtual_machine_sizes:
     azure.mgmt.compute.v2018_06_01.operations.VirtualMachineSizesOperations
    ...
    :vartype virtual_machine_scale_set_extensions:
     azure.mgmt.compute.v2018_06_01.operations.VirtualMachineScaleSetExtensionsOperations
    ...
    :vartype virtual_machine_scale_set_rolling_upgrades:
     azure.mgmt.compute.v2018_06_01.operations.VirtualMachineScaleSetRollingUpgradesOperations
    :ivar virtual_machine_scale_set_vms: VirtualMachineScaleSetVMsOperations operations
    :vartype virtual_machine_scale_set_vms:
     azure.mgmt.compute.v2018_06_01.operations.VirtualMachineScaleSetVMsOperations
    ...
    :vartype virtual_machine_run_commands:
     azure.mgmt.compute.v2018_06_01.operations.VirtualMachineRunCommandsOperations
    ...
    :vartype gallery_image_versions:
     azure.mgmt.compute.v2018_06_01.operations.GalleryImageVersionsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.usage = UsageOperations(self._client, self._config, self._serialize, self._deserialize, "2018-06-01")
        ...
        self.images = ImagesOperations(self._client, self._config, self._serialize, self._deserialize, "2018-06-01")
        ...
        self.disks = DisksOperations(self._client, self._config, self._serialize, self._deserialize, "2018-06-01")
