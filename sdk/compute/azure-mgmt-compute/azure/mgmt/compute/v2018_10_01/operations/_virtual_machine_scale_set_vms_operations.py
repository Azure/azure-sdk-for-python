...
class VirtualMachineScaleSetVMsOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_reimage(
        ...
        **kwargs: Any
        ...
        :type vm_scale_set_vm_reimage_input:
         ~azure.mgmt.compute.v2018_10_01.models.VirtualMachineScaleSetVMReimageParameters
    ...
    def begin_reimage(
        ...
        **kwargs: Any
        ...
        :type vm_scale_set_vm_reimage_input:
         ~azure.mgmt.compute.v2018_10_01.models.VirtualMachineScaleSetVMReimageParameters or IO
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either VirtualMachineScaleSetVM or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2018_10_01.models.VirtualMachineScaleSetVM]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.compute.v2018_10_01.models.VirtualMachineScaleSetVM or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either VirtualMachineScaleSetVM or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.compute.v2018_10_01.models.VirtualMachineScaleSetVM]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_run_command(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the Run command operation. Is either a model type or
         a IO type. Required.
        :type parameters: ~azure.mgmt.compute.v2018_10_01.models.RunCommandInput or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json',
