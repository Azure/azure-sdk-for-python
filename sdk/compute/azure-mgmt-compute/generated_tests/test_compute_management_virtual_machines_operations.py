...
class TestComputeManagementVirtualMachinesOperations(AzureMgmtRecordedTestCase):
            ...
            parameters={
                ...
                "properties": {
                    ...
                    "networkProfile": {
                        ...
                        "networkInterfaces": [{"id": "str", "properties": {"deleteOption": "str", "primary": bool}}],
                    },
                    "osProfile": {
                        "adminPassword": "str",
                        "adminUsername": "str",
                    ...
                    "resiliencyProfile": {"zoneMovement": {"isEnabled": bool}},
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_virtual_machines_begin_migrate_to_vm_scale_set(self, resource_group):
