...
class TestComputeManagementInterconnectBlocksOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(ComputeManagementClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_interconnect_blocks_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_interconnect_blocks_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.interconnect_blocks.begin_create_or_update(
                resource_group_name=resource_group.name,
                interconnect_block_name="str",
                resource={
                    "location": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_interconnect_blocks_begin_update(self, resource_group):
        response = await (
            await self.client.interconnect_blocks.begin_update(
                resource_group_name=resource_group.name,
                interconnect_block_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_interconnect_blocks_begin_delete(self, resource_group):
        response = await (
