...
class TestComputeVirtualMachineScaleSetsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_virtual_machine_scale_sets_begin_start_extension_upgrade(self, resource_group):
        response = self.client.virtual_machine_scale_sets.begin_start_extension_upgrade(
            resource_group_name=resource_group.name,
            vm_scale_set_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_virtual_machine_scale_sets_begin_start_os_upgrade(self, resource_group):
        response = self.client.virtual_machine_scale_sets.begin_start_os_upgrade(
            resource_group_name=resource_group.name,
            vm_scale_set_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_virtual_machine_scale_sets_begin_cancel(self, resource_group):
        response = self.client.virtual_machine_scale_sets.begin_cancel(
            resource_group_name=resource_group.name,
            vm_scale_set_name="str",
        ).result()  # call '.result()' to poll until service return final result
