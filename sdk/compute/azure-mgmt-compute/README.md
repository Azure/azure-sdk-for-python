...
Code samples for this package can be found at [Compute Management](https://docs.microsoft.com/samples/azure-samples/azure-samples-python-management/virtualmachines?view=azure-python-preview) on docs.microsoft.com.
