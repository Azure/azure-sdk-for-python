...
class TestComputeBulkActionsMgmtBulkCreateCustomOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(ComputeBulkActionsMgmtClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_bulk_create_custom_get(self, resource_group):
        response = self.client.bulk_create_custom.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_bulk_create_custom_get_async_operation_status(self, resource_group):
        response = self.client.bulk_create_custom.get_async_operation_status(
            location="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_bulk_create_custom_begin_create_or_update(self, resource_group):
        response = self.client.bulk_create_custom.begin_create_or_update(
            resource_group_name=resource_group.name,
            location="str",
            name="str",
            resource={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_bulk_create_custom_begin_delete(self, resource_group):
        response = self.client.bulk_create_custom.begin_delete(
            resource_group_name=resource_group.name,
            location="str",
            name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_bulk_create_custom_begin_cancel(self, resource_group):
        response = self.client.bulk_create_custom.begin_cancel(
            resource_group_name=resource_group.name,
            location="str",
            name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_bulk_create_custom_list_by_resource_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_bulk_create_custom_list_by_subscription(self, resource_group):
