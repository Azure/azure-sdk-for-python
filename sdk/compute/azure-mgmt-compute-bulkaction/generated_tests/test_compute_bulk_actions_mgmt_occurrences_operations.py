...
class TestComputeBulkActionsMgmtOccurrencesOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_occurrences_begin_cancel(self, resource_group):
        response = self.client.occurrences.begin_cancel(
            resource_group_name=resource_group.name,
            scheduled_action_name="str",
            occurrence_id="str",
