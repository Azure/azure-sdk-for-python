...
class TestComputeBulkActionsMgmtScheduledActionsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_scheduled_actions_begin_update(self, resource_group):
        response = await (
            await self.client.scheduled_actions.begin_update(
                resource_group_name=resource_group.name,
                scheduled_action_name="str",
                properties={
                    "properties": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_scheduled_actions_begin_attach_resources(self, resource_group):
        response = await (
            await self.client.scheduled_actions.begin_attach_resources(
                resource_group_name=resource_group.name,
                scheduled_action_name="str",
                body={
                    "resources": [
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_scheduled_actions_begin_detach_resources(self, resource_group):
        response = await (
            await self.client.scheduled_actions.begin_detach_resources(
                resource_group_name=resource_group.name,
                scheduled_action_name="str",
                body={"resources": ["str"]},
            )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_scheduled_actions_begin_disable(self, resource_group):
        response = await (
            await self.client.scheduled_actions.begin_disable(
                resource_group_name=resource_group.name,
                scheduled_action_name="str",
            )
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_scheduled_actions_begin_enable(self, resource_group):
        response = await (
            await self.client.scheduled_actions.begin_enable(
                resource_group_name=resource_group.name,
                scheduled_action_name="str",
            )
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_scheduled_actions_begin_cancel_next_occurrence(self, resource_group):
        response = await (
            await self.client.scheduled_actions.begin_cancel_next_occurrence(
                resource_group_name=resource_group.name,
                scheduled_action_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_scheduled_actions_begin_trigger_manual_occurrence(self, resource_group):
        response = await (
            await self.client.scheduled_actions.begin_trigger_manual_occurrence(
                resource_group_name=resource_group.name,
                scheduled_action_name="str",
            )
        ).result()  # call '.result()' to poll until service return final result
