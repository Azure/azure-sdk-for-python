...
class DistributionStrategy(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    BEST_EFFORT_SINGLE_ZONE = "BestEffortSingleZone"
    """Bulk Actions attempts to place as many virtual machines as possible in one availability zone
    and uses additional zones when needed."""
    PRIORITIZED = "Prioritized"
    ...
    """Bulk Actions distributes virtual machines evenly across zones and rejects the request when an
