...
# USAGE
    python virtual_machine_bulk_operations_bulk_reimage_comprehensive_success.py
    ...
    response = client.virtual_machine_bulk_operations.bulk_reimage_operation(
        ...
        request_body={
            ...
            "reimageParameters": {
                ...
                "resourceOverrides": [
                    {
                        "profile": {"exactVersion": "1.1.0", "tempDisk": False},
                        "resourceId": "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/example-rg/providers/Microsoft.Compute/virtualMachines/bulk-vm-02",
                    }
                ],
            },
            "resources": {
