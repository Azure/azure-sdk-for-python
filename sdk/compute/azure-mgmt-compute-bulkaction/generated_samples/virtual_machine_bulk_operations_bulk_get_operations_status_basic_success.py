...
# USAGE
    python virtual_machine_bulk_operations_bulk_get_operations_status_basic_success.py
...
def main():
    ...
    response = client.virtual_machine_bulk_operations.bulk_get_operations_status(
        ...
        location="eastus",
        request_body={"operationIds": ["aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa", "bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"]},
    )
    print(response)
