...
# USAGE
    python virtual_machine_bulk_operations_bulk_hibernate_with_fallback.py
...
def main():
    ...
    response = client.virtual_machine_bulk_operations.bulk_hibernate_operation(
        ...
        location="eastus",
        request_body={
            "executionParameters": {"retryPolicy": {"onFailureAction": "Deallocate", "retryWindowInMinutes": 30}},
            "resources": {
                "ids": [
