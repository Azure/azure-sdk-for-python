...
# USAGE
    python occurrence_extension_list_occurrence_by_vms_basic_success.py
...
def main():
    ...
    response = client.occurrence_extension.list_occurrence_by_vms(
        resource_uri="subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/example-rg/providers/Microsoft.Compute/virtualMachines/web-vm-01",
    )
