...
# USAGE
    python virtual_machine_bulk_operations_bulk_get_operations_status_deallocate_fallback_failed_after_hibernate_fail.py
...
def main():
    ...
    response = client.virtual_machine_bulk_operations.bulk_get_operations_status(
        ...
        location="eastus",
        request_body={"operationIds": ["7f3c98a4-64b8-4d6a-b215-890c16d27643"]},
    )
    print(response)
