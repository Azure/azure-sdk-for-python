...
# USAGE
    python virtual_machine_bulk_operations_bulk_get_operations_status_deallocate_fallback_after_hibernate_fail.py
...
def main():
    ...
    response = client.virtual_machine_bulk_operations.bulk_get_operations_status(
        ...
        location="eastus",
        request_body={"operationIds": ["ffffffff-ffff-ffff-ffff-ffffffffffff"]},
    )
    print(response)
