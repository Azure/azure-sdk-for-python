...
def main():
    ...
    response = client.workload_networks.begin_create_segments(
...
# x-ms-original-file: specification/vmware/resource-manager/Microsoft.AVS/stable/2024-09-01/examples/WorkloadNetworks_CreateSegments.json
