...
namespace azure.mgmt.avs.aio.operations
    ...
    class azure.mgmt.avs.aio.operations.HostsOperations:
        ...
        @distributed_trace_async
        @api_version_validation(method_added_on='2024-09-01', params_added_on={'2024-09-01': ['api_version', 'subscription_id', 'resource_group_name', 'private_cloud_name', 'cluster_name', 'host_id', 'accept']}, api_versions_list=['2024-09-01', '2025-09-01', '2026-03-01'])
        async def get(
                self, 
                resource_group_name: str, 
                private_cloud_name: str, 
        ...
        @distributed_trace
        @api_version_validation(method_added_on='2024-09-01', params_added_on={'2024-09-01': ['api_version', 'subscription_id', 'resource_group_name', 'private_cloud_name', 'cluster_name', 'accept']}, api_versions_list=['2024-09-01', '2025-09-01', '2026-03-01'])
        def list(
                self, 
                resource_group_name: str, 
                private_cloud_name: str, 
    ...
    class azure.mgmt.avs.aio.operations.LicensesOperations:
        ...
        @distributed_trace_async
        @api_version_validation(method_added_on='2025-09-01', params_added_on={'2025-09-01': ['api_version', 'subscription_id', 'resource_group_name', 'private_cloud_name', 'license_name']}, api_versions_list=['2025-09-01', '2026-03-01'])
        async def begin_delete(
                self, 
                resource_group_name: str, 
                private_cloud_name: str, 
        ...
        @distributed_trace_async
        @api_version_validation(method_added_on='2025-09-01', params_added_on={'2025-09-01': ['api_version', 'subscription_id', 'resource_group_name', 'private_cloud_name', 'license_name', 'accept']}, api_versions_list=['2025-09-01', '2026-03-01'])
        async def get(
                self, 
                resource_group_name: str, 
                private_cloud_name: str, 
        ...
        @distributed_trace
        @api_version_validation(method_added_on='2025-09-01', params_added_on={'2025-09-01': ['api_version', 'subscription_id', 'resource_group_name', 'private_cloud_name', 'accept']}, api_versions_list=['2025-09-01', '2026-03-01'])
        def list(
                self, 
                resource_group_name: str, 
                private_cloud_name: str, 
    ...
    class azure.mgmt.avs.aio.operations.MaintenancesOperations:
        ...
        @distributed_trace_async
        @api_version_validation(method_added_on='2025-09-01', params_added_on={'2025-09-01': ['api_version', 'subscription_id', 'resource_group_name', 'private_cloud_name', 'maintenance_name', 'accept']}, api_versions_list=['2025-09-01', '2026-03-01'])
        async def get(
                self, 
                resource_group_name: str, 
                private_cloud_name: str, 
        ...
        @distributed_trace
        @api_version_validation(method_added_on='2025-09-01', params_added_on={'2025-09-01': ['api_version', 'subscription_id', 'resource_group_name', 'private_cloud_name', 'state_name', 'status', 'from_parameter', 'to', 'accept']}, api_versions_list=['2025-09-01', '2026-03-01'])
        def list(
                self, 
                resource_group_name: str, 
                private_cloud_name: str, 
    ...
    class azure.mgmt.avs.aio.operations.ProvisionedNetworksOperations:
        ...
        @distributed_trace_async
        @api_version_validation(method_added_on='2024-09-01', params_added_on={'2024-09-01': ['api_version', 'subscription_id', 'resource_group_name', 'private_cloud_name', 'provisioned_network_name', 'accept']}, api_versions_list=['2024-09-01', '2025-09-01', '2026-03-01'])
        async def get(
                self, 
                resource_group_name: str, 
                private_cloud_name: str, 
        ...
        @distributed_trace
        @api_version_validation(method_added_on='2024-09-01', params_added_on={'2024-09-01': ['api_version', 'subscription_id', 'resource_group_name', 'private_cloud_name', 'accept']}, api_versions_list=['2024-09-01', '2025-09-01', '2026-03-01'])
        def list(
                self, 
                resource_group_name: str, 
                private_cloud_name: str, 
    ...
    class azure.mgmt.avs.aio.operations.PureStoragePoliciesOperations:
        ...
        @distributed_trace_async
        @api_version_validation(method_added_on='2024-09-01', params_added_on={'2024-09-01': ['api_version', 'subscription_id', 'resource_group_name', 'private_cloud_name', 'storage_policy_name']}, api_versions_list=['2024-09-01', '2025-09-01', '2026-03-01'])
        async def begin_delete(
                self, 
                resource_group_name: str, 
                private_cloud_name: str, 
        ...
        @distributed_trace_async
        @api_version_validation(method_added_on='2024-09-01', params_added_on={'2024-09-01': ['api_version', 'subscription_id', 'resource_group_name', 'private_cloud_name', 'storage_policy_name', 'accept']}, api_versions_list=['2024-09-01', '2025-09-01', '2026-03-01'])
        async def get(
                self, 
                resource_group_name: str, 
                private_cloud_name: str, 
    ...
    class azure.mgmt.avs.aio.operations.SkusOperations:
        ...
        @distributed_trace
        @api_version_validation(method_added_on='2024-09-01', params_added_on={'2024-09-01': ['api_version', 'subscription_id', 'accept']}, api_versions_list=['2024-09-01', '2025-09-01', '2026-03-01'])
...
namespace azure.mgmt.avs.models
    ...
    class azure.mgmt.avs.models.GeneralHostProperties(HostProperties, discriminator='General'):
        ...
        def __init__(
                ...
                *, 
                ...
                licenses: Optional[list[HostLicense]] = ..., 
    ...
    class azure.mgmt.avs.models.HostLicense(_Model):
        kind: str
    ...
    class azure.mgmt.avs.models.HostLicenseKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    class azure.mgmt.avs.models.HostUpdate(_Model):
        properties: Optional[HostUpdateProperties]
    ...
    class azure.mgmt.avs.models.HostUpdateProperties(_Model):
        licenses: Optional[list[HostLicense]]
    ...
    class azure.mgmt.avs.models.MaintenanceActivity(_Model):
        component: str
        impact: Optional[str]
        info_link: Optional[str]
        kind: Union[str, MaintenanceActivityKind]
        version: str


    class azure.mgmt.avs.models.MaintenanceActivityKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        BACKUP = "Backup"
    ...
    class azure.mgmt.avs.models.MaintenanceGroup(_Model):
        id: str
        kind: Union[str, MaintenanceGroupKind]
        name: str


    class azure.mgmt.avs.models.MaintenanceGroupKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    class azure.mgmt.avs.models.MaintenanceProperties(_Model):
        ...
        relationships: Optional[MaintenanceRelationships]
    ...
    class azure.mgmt.avs.models.MaintenanceRecommendation(_Model):
        maintenance_windows: Optional[list[MaintenanceWindowRecommendation]]


    class azure.mgmt.avs.models.MaintenanceRelationships(_Model):
    ...
    class azure.mgmt.avs.models.MaintenanceWindowRecommendation(_Model):
        reason: Optional[str]
        start_time: datetime
    ...
    class azure.mgmt.avs.models.RescheduleOperation(MaintenanceManagementOperation, discriminator='Reschedule'):
        ...
        recommendation: Optional[MaintenanceRecommendation]
    ...
    class azure.mgmt.avs.models.ReschedulingWindowConstraint(RescheduleOperationConstraint, discriminator='ReschedulingWindow'):
        ends_at: datetime
        kind: Literal[RescheduleOperationConstraintKind.RESCHEDULING_WINDOW]
        starts_at: datetime
    ...
    class azure.mgmt.avs.models.WeekendReschedulingConstraint(RescheduleOperationConstraint, discriminator='WeekendRescheduling'):
        disabled_reason: Optional[str]
        is_disabled: Optional[bool]
        kind: Literal[RescheduleOperationConstraintKind.WEEKEND_RESCHEDULING]
    ...
    class azure.mgmt.avs.models.WeekendSchedulingConstraint(ScheduleOperationConstraint, discriminator='WeekendScheduling'):
        disabled_reason: Optional[str]
        is_disabled: Optional[bool]
        kind: Literal[ScheduleOperationConstraintKind.WEEKEND_SCHEDULING]
    ...
    class azure.mgmt.avs.models.WindowsServerLicense(HostLicense, discriminator='WindowsServer'):
        kind: Literal[HostLicenseKind.WINDOWS_SERVER]
...
namespace azure.mgmt.avs.types

    class azure.mgmt.avs.types.Addon(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('AddonProperties', module='types')
    ...
    class azure.mgmt.avs.types.AddonArcProperties(TypedDict, total=False):
        key "addonType": Required[Literal[AddonType.ARC]]
        key "provisioningState": Union[str, AddonProvisioningState]
        key "vCenter": str
        addonType: Literal[AddonType.ARC]
        provisioningState: Union[str, AddonProvisioningState]
        vCenter: str


    class azure.mgmt.avs.types.AddonHcxProperties(TypedDict, total=False):
        key "addonType": Required[Literal[AddonType.HCX]]
        key "managementNetwork": str
        key "offer": Required[str]
        key "provisioningState": Union[str, AddonProvisioningState]
        key "uplinkNetwork": str
        addonType: Literal[AddonType.HCX]
    ...
    class azure.mgmt.avs.types.AddonSrmProperties(TypedDict, total=False):
        key "addonType": Required[Literal[AddonType.SRM]]
        key "licenseKey": str
        key "provisioningState": Union[str, AddonProvisioningState]
        addonType: Literal[AddonType.SRM]
        licenseKey: str
        provisioningState: Union[str, AddonProvisioningState]


    class azure.mgmt.avs.types.AddonType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        ARC = "Arc"
        HCX = "HCX"
        SRM = "SRM"
        VR = "VR"
    ...
    class azure.mgmt.avs.types.AddonVrProperties(TypedDict, total=False):
        key "addonType": Required[Literal[AddonType.VR]]
        key "provisioningState": Union[str, AddonProvisioningState]
        key "vrsCount": Required[int]
        addonType: Literal[AddonType.VR]
        provisioningState: Union[str, AddonProvisioningState]
        vrsCount: int


    class azure.mgmt.avs.types.AvailabilityProperties(TypedDict, total=False):
        key "secondaryZone": int
        key "strategy": Union[str, AvailabilityStrategy]
        key "zone": int
        secondaryZone: int
    ...
    class azure.mgmt.avs.types.Circuit(TypedDict, total=False):
        key "expressRouteID": str
        key "expressRoutePrivatePeeringID": str
        key "primarySubnet": str
        key "secondarySubnet": str
        expressRouteID: str
    ...
    class azure.mgmt.avs.types.CloudLink(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('CloudLinkProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.CloudLinkProperties(TypedDict, total=False):
        key "linkedCloud": str
        key "provisioningState": Union[str, CloudLinkProvisioningState]
        key "status": Union[str, CloudLinkStatus]
        linkedCloud: str
        provisioningState: Union[str, CloudLinkProvisioningState]
        status: Union[str, CloudLinkStatus]


    class azure.mgmt.avs.types.Cluster(ProxyResource):
        key "id": str
        key "name": str
    ...
    class azure.mgmt.avs.types.ClusterProperties(TypedDict, total=False):
        key "clusterId": int
        key "clusterSize": int
        key "provisioningState": Union[str, ClusterProvisioningState]
        key "vsanDatastoreName": str
        clusterId: int
        clusterSize: int
        hosts: list[str]
    ...
    class azure.mgmt.avs.types.ClusterUpdate(TypedDict, total=False):
        key "properties": ForwardRef('ClusterUpdateProperties', module='types')
        key "sku": ForwardRef('Sku', module='types')
        properties: ClusterUpdateProperties
        sku: Sku


    class azure.mgmt.avs.types.ClusterUpdateProperties(TypedDict, total=False):
        key "clusterSize": int
        clusterSize: int
        hosts: list[str]


    class azure.mgmt.avs.types.Datastore(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('DatastoreProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.DatastoreProperties(TypedDict, total=False):
        key "diskPoolVolume": ForwardRef('DiskPoolVolume', module='types')
        key "elasticSanVolume": ForwardRef('ElasticSanVolume', module='types')
        key "netAppVolume": ForwardRef('NetAppVolume', module='types')
        key "provisioningState": Union[str, DatastoreProvisioningState]
        key "pureStorageVolume": ForwardRef('PureStorageVolume', module='types')
        key "status": Union[str, DatastoreStatus]
    ...
    class azure.mgmt.avs.types.DhcpTypeEnum(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        RELAY = "RELAY"
        SERVER = "SERVER"


    class azure.mgmt.avs.types.DiskPoolVolume(TypedDict, total=False):
        key "lunName": Required[str]
        key "mountOption": Union[str, MountOptionEnum]
        key "path": str
    ...
    class azure.mgmt.avs.types.ElasticSanVolume(TypedDict, total=False):
        key "targetId": Required[str]
        targetId: str


    class azure.mgmt.avs.types.Encryption(TypedDict, total=False):
        key "keyVaultProperties": ForwardRef('EncryptionKeyVaultProperties', module='types')
        key "status": Union[str, EncryptionState]
        keyVaultProperties: EncryptionKeyVaultProperties
        status: Union[str, EncryptionState]


    class azure.mgmt.avs.types.EncryptionKeyVaultProperties(TypedDict, total=False):
        key "autoDetectedKeyVersion": str
        key "keyName": str
        key "keyState": Union[str, EncryptionKeyStatus]
        key "keyVaultUrl": str
        key "keyVersion": str
        key "versionType": Union[str, EncryptionVersionType]
    ...
    class azure.mgmt.avs.types.Endpoints(TypedDict, total=False):
        key "hcxCloudManager": str
        key "hcxCloudManagerIp": str
        key "nsxtManager": str
        key "nsxtManagerIp": str
        key "vcenterIp": str
        key "vcsa": str
        hcxCloudManager: str
    ...
    class azure.mgmt.avs.types.ExpressRouteAuthorization(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('ExpressRouteAuthorizationProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.ExpressRouteAuthorizationProperties(TypedDict, total=False):
        key "expressRouteAuthorizationId": str
        key "expressRouteAuthorizationKey": str
        key "expressRouteId": str
        key "provisioningState": Union[str, ExpressRouteAuthorizationProvisioningState]
    ...
    class azure.mgmt.avs.types.GlobalReachConnection(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('GlobalReachConnectionProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.GlobalReachConnectionProperties(TypedDict, total=False):
        key "addressPrefix": str
        key "authorizationKey": str
        key "circuitConnectionStatus": Union[str, GlobalReachConnectionStatus]
        key "expressRouteId": str
        key "peerExpressRouteCircuit": str
        key "provisioningState": Union[str, GlobalReachConnectionProvisioningState]
        addressPrefix: str
    ...
    class azure.mgmt.avs.types.HcxEnterpriseSite(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('HcxEnterpriseSiteProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.HcxEnterpriseSiteProperties(TypedDict, total=False):
        key "activationKey": str
        key "provisioningState": Union[str, HcxEnterpriseSiteProvisioningState]
        key "status": Union[str, HcxEnterpriseSiteStatus]
        activationKey: str
        provisioningState: Union[str, HcxEnterpriseSiteProvisioningState]
        status: Union[str, HcxEnterpriseSiteStatus]


    class azure.mgmt.avs.types.HostLicense(TypedDict, total=False):
        key "kind": Required[Literal[HostLicenseKind.WINDOWS_SERVER]]
        kind: Literal[HostLicenseKind.WINDOWS_SERVER]


    class azure.mgmt.avs.types.HostLicenseKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        WINDOWS_SERVER = "WindowsServer"


    class azure.mgmt.avs.types.HostUpdate(TypedDict, total=False):
        key "properties": ForwardRef('HostUpdateProperties', module='types')
        properties: HostUpdateProperties


    class azure.mgmt.avs.types.HostUpdateProperties(TypedDict, total=False):
        licenses: list[HostLicense]


    class azure.mgmt.avs.types.IdentitySource(TypedDict, total=False):
        key "alias": str
        key "baseGroupDN": str
        key "baseUserDN": str
        key "domain": str
        key "name": str
        key "password": str
        key "primaryServer": str
        key "secondaryServer": str
        key "ssl": Union[str, SslEnum]
        key "username": str
        alias: str
        baseGroupDN: str
        baseUserDN: str
    ...
    class azure.mgmt.avs.types.IscsiPath(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('IscsiPathProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.IscsiPathProperties(TypedDict, total=False):
        key "networkBlock": Required[str]
        key "provisioningState": Union[str, IscsiPathProvisioningState]
        networkBlock: str
        provisioningState: Union[str, IscsiPathProvisioningState]


    class azure.mgmt.avs.types.Label(TypedDict, total=False):
    ...
    class azure.mgmt.avs.types.License(ProxyResource):
        key "id": str
        key "name": str
    ...
    class azure.mgmt.avs.types.LicenseKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        VMWARE_FIREWALL = "VmwareFirewall"


    class azure.mgmt.avs.types.LicenseProperties(TypedDict, total=False):
        key "broadcomContractNumber": str
        key "broadcomSiteId": str
        key "cores": Required[int]
        key "endDate": Required[str]
        key "kind": Required[Literal[LicenseKind.VMWARE_FIREWALL]]
        key "licenseKey": str
        key "provisioningState": Union[str, LicenseProvisioningState]
    ...
    class azure.mgmt.avs.types.MaintenanceReschedule(TypedDict, total=False):
        key "message": str
        key "rescheduleTime": str
        message: str
        rescheduleTime: str


    class azure.mgmt.avs.types.MaintenanceSchedule(TypedDict, total=False):
        key "message": str
        key "scheduleTime": str
        message: str
        scheduleTime: str


    class azure.mgmt.avs.types.ManagementCluster(TypedDict, total=False):
        key "clusterId": int
        key "clusterSize": int
        key "provisioningState": Union[str, ClusterProvisioningState]
        key "vsanDatastoreName": str
    ...
    class azure.mgmt.avs.types.NetAppVolume(TypedDict, total=False):
        key "id": Required[str]
        id: str


    class azure.mgmt.avs.types.PSCredentialExecutionParameter(TypedDict, total=False):
        key "name": Required[str]
        key "password": str
        key "type": Required[Literal[ScriptExecutionParameterType.CREDENTIAL]]
        key "username": str
        name: str
        password: str
        type: Literal[ScriptExecutionParameterType.CREDENTIAL]
    ...
    class azure.mgmt.avs.types.PlacementPolicy(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('PlacementPolicyProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.PlacementPolicyType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        VM_HOST = "VmHost"
        VM_VM = "VmVm"


    class azure.mgmt.avs.types.PlacementPolicyUpdate(TypedDict, total=False):
        key "properties": ForwardRef('PlacementPolicyUpdateProperties', module='types')
        properties: PlacementPolicyUpdateProperties


    class azure.mgmt.avs.types.PlacementPolicyUpdateProperties(TypedDict, total=False):
        key "affinityStrength": Union[str, AffinityStrength]
        key "azureHybridBenefitType": Union[str, AzureHybridBenefitType]
        key "state": Union[str, PlacementPolicyState]
    ...
    class azure.mgmt.avs.types.PrivateCloud(TrackedResource):
        key "id": str
        key "identity": ForwardRef('PrivateCloudIdentity', module='types')
        key "location": Required[str]
        key "name": str
        key "properties": ForwardRef('PrivateCloudProperties', module='types')
        key "sku": Required[Sku]
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
    ...
    class azure.mgmt.avs.types.PrivateCloudIdentity(TypedDict, total=False):
        key "principalId": str
        key "tenantId": str
    ...
    class azure.mgmt.avs.types.PrivateCloudProperties(TypedDict, total=False):
        key "availability": ForwardRef('AvailabilityProperties', module='types')
        key "circuit": ForwardRef('Circuit', module='types')
        key "dnsZoneType": Union[str, DnsZoneType]
        key "encryption": ForwardRef('Encryption', module='types')
        key "endpoints": ForwardRef('Endpoints', module='types')
        key "internet": Union[str, InternetEnum]
        key "managementCluster": Required[ManagementCluster]
        key "managementNetwork": str
        key "networkBlock": Required[str]
        key "nsxPublicIpQuotaRaised": Union[str, NsxPublicIpQuotaRaisedEnum]
        key "nsxtCertificateThumbprint": str
        key "nsxtPassword": str
        key "provisioningNetwork": str
        key "provisioningState": Union[str, PrivateCloudProvisioningState]
        key "secondaryCircuit": ForwardRef('Circuit', module='types')
        key "vcenterCertificateThumbprint": str
        key "vcenterPassword": str
        key "vcfLicense": ForwardRef('VcfLicense', module='types')
        key "virtualNetworkId": str
        key "vmotionNetwork": str
    ...
    class azure.mgmt.avs.types.PrivateCloudUpdate(TypedDict, total=False):
        key "identity": ForwardRef('PrivateCloudIdentity', module='types')
        key "properties": ForwardRef('PrivateCloudUpdateProperties', module='types')
        key "sku": ForwardRef('Sku', module='types')
        identity: PrivateCloudIdentity
    ...
    class azure.mgmt.avs.types.PrivateCloudUpdateProperties(TypedDict, total=False):
        key "availability": ForwardRef('AvailabilityProperties', module='types')
        key "dnsZoneType": Union[str, DnsZoneType]
        key "encryption": ForwardRef('Encryption', module='types')
        key "internet": Union[str, InternetEnum]
        key "managementCluster": ForwardRef('ManagementCluster', module='types')
        availability: AvailabilityProperties
        dnsZoneType: Union[str, DnsZoneType]
        encryption: Encryption
        extendedNetworkBlocks: list[str]
    ...
    class azure.mgmt.avs.types.ProxyResource(Resource):
        key "id": str
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
    ...
    class azure.mgmt.avs.types.PureStoragePolicy(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('PureStoragePolicyProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.PureStoragePolicyProperties(TypedDict, total=False):
        key "provisioningState": Union[str, PureStoragePolicyProvisioningState]
        key "storagePolicyDefinition": Required[str]
        key "storagePoolId": Required[str]
        provisioningState: Union[str, PureStoragePolicyProvisioningState]
        storagePolicyDefinition: str
        storagePoolId: str


    class azure.mgmt.avs.types.PureStorageVolume(TypedDict, total=False):
        key "sizeGb": Required[int]
        key "storagePoolId": Required[str]
        sizeGb: int
        storagePoolId: str


    class azure.mgmt.avs.types.Resource(TypedDict, total=False):
        key "id": str
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
    ...
    class azure.mgmt.avs.types.ScriptExecution(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('ScriptExecutionProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.ScriptExecutionParameterType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        CREDENTIAL = "Credential"
        SECURE_VALUE = "SecureValue"
        VALUE = "Value"


    class azure.mgmt.avs.types.ScriptExecutionProperties(TypedDict, total=False):
        key "failureReason": str
        key "finishedAt": str
        key "provisioningState": Union[str, ScriptExecutionProvisioningState]
        key "retention": str
        key "scriptCmdletId": str
        key "startedAt": str
        key "submittedAt": str
    ...
    class azure.mgmt.avs.types.ScriptSecureStringExecutionParameter(TypedDict, total=False):
        key "name": Required[str]
        key "secureValue": str
        key "type": Required[Literal[ScriptExecutionParameterType.SECURE_VALUE]]
        name: str
        secureValue: str
        type: Literal[ScriptExecutionParameterType.SECURE_VALUE]


    class azure.mgmt.avs.types.ScriptStringExecutionParameter(TypedDict, total=False):
        key "name": Required[str]
        key "type": Required[Literal[ScriptExecutionParameterType.VALUE]]
        key "value": str
        name: str
        type: Literal[ScriptExecutionParameterType.VALUE]
        value: str
    ...
    class azure.mgmt.avs.types.Sku(TypedDict, total=False):
        key "capacity": int
        key "family": str
        key "name": Required[str]
        key "size": str
    ...
    class azure.mgmt.avs.types.SystemData(TypedDict, total=False):
        key "createdAt": str
        key "createdBy": str
    ...
    class azure.mgmt.avs.types.TrackedResource(Resource):
        key "id": str
        key "location": Required[str]
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
    ...
    class azure.mgmt.avs.types.Vcf5License(TypedDict, total=False):
        key "broadcomContractNumber": str
        key "broadcomSiteId": str
        key "cores": Required[int]
        key "endDate": Required[str]
        key "kind": Required[Literal[VcfLicenseKind.VCF5]]
        key "licenseKey": str
        key "provisioningState": Union[str, LicenseProvisioningState]
        broadcomContractNumber: str
        broadcomSiteId: str
    ...
    class azure.mgmt.avs.types.VcfLicense(TypedDict, total=False):
        key "broadcomContractNumber": str
        key "broadcomSiteId": str
        key "cores": Required[int]
        key "endDate": Required[str]
    ...
    class azure.mgmt.avs.types.VcfLicenseKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        VCF5 = "vcf5"


    class azure.mgmt.avs.types.VirtualMachineRestrictMovement(TypedDict, total=False):
        key "restrictMovement": Union[str, VirtualMachineRestrictMovementState]
        restrictMovement: Union[str, VirtualMachineRestrictMovementState]


    class azure.mgmt.avs.types.VmHostPlacementPolicyProperties(TypedDict, total=False):
        key "affinityStrength": Union[str, AffinityStrength]
        key "affinityType": Required[Union[str, AffinityType]]
        key "azureHybridBenefitType": Union[str, AzureHybridBenefitType]
        key "displayName": str
        key "hostMembers": Required[list[str]]
        key "provisioningState": Union[str, PlacementPolicyProvisioningState]
        key "state": Union[str, PlacementPolicyState]
        key "type": Required[Literal[PlacementPolicyType.VM_HOST]]
        key "vmMembers": Required[list[str]]
        affinityStrength: Union[str, AffinityStrength]
        affinityType: Union[str, AffinityType]
        azureHybridBenefitType: Union[str, AzureHybridBenefitType]
        displayName: str
        hostMembers: list[str]
    ...
    class azure.mgmt.avs.types.VmPlacementPolicyProperties(TypedDict, total=False):
        key "affinityType": Required[Union[str, AffinityType]]
        key "displayName": str
        key "provisioningState": Union[str, PlacementPolicyProvisioningState]
        key "state": Union[str, PlacementPolicyState]
        key "type": Required[Literal[PlacementPolicyType.VM_VM]]
        key "vmMembers": Required[list[str]]
        affinityType: Union[str, AffinityType]
        displayName: str
        provisioningState: Union[str, PlacementPolicyProvisioningState]
    ...
    class azure.mgmt.avs.types.VmwareFirewallLicenseProperties(TypedDict, total=False):
        key "broadcomContractNumber": str
        key "broadcomSiteId": str
        key "cores": Required[int]
        key "endDate": Required[str]
    ...
    class azure.mgmt.avs.types.WindowsServerLicense(TypedDict, total=False):
        key "kind": Required[Literal[HostLicenseKind.WINDOWS_SERVER]]
        kind: Literal[HostLicenseKind.WINDOWS_SERVER]


    class azure.mgmt.avs.types.WorkloadNetworkDhcp(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('WorkloadNetworkDhcpEntity', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.WorkloadNetworkDhcpRelay(TypedDict, total=False):
        key "dhcpType": Required[Literal[DhcpTypeEnum.RELAY]]
        key "displayName": str
        key "provisioningState": Union[str, WorkloadNetworkDhcpProvisioningState]
        key "revision": int
        dhcpType: Literal[DhcpTypeEnum.RELAY]
        displayName: str
    ...
    class azure.mgmt.avs.types.WorkloadNetworkDhcpServer(TypedDict, total=False):
        key "dhcpType": Required[Literal[DhcpTypeEnum.SERVER]]
        key "displayName": str
        key "leaseTime": int
        key "provisioningState": Union[str, WorkloadNetworkDhcpProvisioningState]
        key "revision": int
        key "serverAddress": str
        dhcpType: Literal[DhcpTypeEnum.SERVER]
        displayName: str
        leaseTime: int
        provisioningState: Union[str, WorkloadNetworkDhcpProvisioningState]
        revision: int
    ...
    class azure.mgmt.avs.types.WorkloadNetworkDnsService(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('WorkloadNetworkDnsServiceProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.WorkloadNetworkDnsServiceProperties(TypedDict, total=False):
        key "defaultDnsZone": str
        key "displayName": str
        key "dnsServiceIp": str
        key "logLevel": Union[str, DnsServiceLogLevelEnum]
        key "provisioningState": Union[str, WorkloadNetworkDnsServiceProvisioningState]
        key "revision": int
        key "status": Union[str, DnsServiceStatusEnum]
        defaultDnsZone: str
        displayName: str
        dnsServiceIp: str
        fqdnZones: list[str]
    ...
    class azure.mgmt.avs.types.WorkloadNetworkDnsZone(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('WorkloadNetworkDnsZoneProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.WorkloadNetworkDnsZoneProperties(TypedDict, total=False):
        key "displayName": str
        key "dnsServices": int
        key "provisioningState": Union[str, WorkloadNetworkDnsZoneProvisioningState]
        key "revision": int
        key "sourceIp": str
        displayName: str
    ...
    class azure.mgmt.avs.types.WorkloadNetworkPortMirroring(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('WorkloadNetworkPortMirroringProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.WorkloadNetworkPortMirroringProperties(TypedDict, total=False):
        key "destination": str
        key "direction": Union[str, PortMirroringDirectionEnum]
        key "displayName": str
        key "provisioningState": Union[str, WorkloadNetworkPortMirroringProvisioningState]
        key "revision": int
        key "source": str
        key "status": Union[str, PortMirroringStatusEnum]
        destination: str
    ...
    class azure.mgmt.avs.types.WorkloadNetworkPublicIP(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('WorkloadNetworkPublicIPProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.WorkloadNetworkPublicIPProperties(TypedDict, total=False):
        key "displayName": str
        key "numberOfPublicIPs": int
        key "provisioningState": Union[str, WorkloadNetworkPublicIPProvisioningState]
        key "publicIPBlock": str
        displayName: str
    ...
    class azure.mgmt.avs.types.WorkloadNetworkSegment(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('WorkloadNetworkSegmentProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.WorkloadNetworkSegmentPortVif(TypedDict, total=False):
        key "portName": str
        portName: str


    class azure.mgmt.avs.types.WorkloadNetworkSegmentProperties(TypedDict, total=False):
        key "connectedGateway": str
        key "displayName": str
        key "provisioningState": Union[str, WorkloadNetworkSegmentProvisioningState]
        key "revision": int
        key "status": Union[str, SegmentStatusEnum]
        key "subnet": ForwardRef('WorkloadNetworkSegmentSubnet', module='types')
    ...
    class azure.mgmt.avs.types.WorkloadNetworkSegmentSubnet(TypedDict, total=False):
        key "gatewayAddress": str
        dhcpRanges: list[str]
        gatewayAddress: str


    class azure.mgmt.avs.types.WorkloadNetworkVMGroup(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('WorkloadNetworkVMGroupProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.avs.types.WorkloadNetworkVMGroupProperties(TypedDict, total=False):
        key "displayName": str
        key "provisioningState": Union[str, WorkloadNetworkVMGroupProvisioningState]
        key "revision": int
        key "status": Union[str, VMGroupStatusEnum]
        displayName: str
        members: list[str]
