...
class AuthorizationsOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("ExpressRouteAuthorization", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        authorization: Union[_models.ExpressRouteAuthorization, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type authorization: ~azure.mgmt.avs.models.ExpressRouteAuthorization or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ExpressRouteAuthorization or the
         result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.avs.models.ExpressRouteAuthorization]
        :raises ~azure.core.exceptions.HttpResponseError:
