...
class ScriptExecutionsOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(script_execution, (IO, bytes)):
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param script_execution_name: Name of the user-invoked script execution resource. Required.
        :type script_execution_name: str
        :param script_execution: A script running in the private cloud. Is either a model type or a IO
         type. Required.
    ...
    async def get_execution_logs(
        ...
        **kwargs: Any
        ...
        :type script_execution_name: str
        :param script_output_stream_type: Name of the desired output stream to return. If not provided,
         will return all. An empty array will return nothing. Is either a list type or a IO type.
         Default value is None.
        ...
        _json = None
        _content = None
        if isinstance(script_output_stream_type, (IO, bytes)):
