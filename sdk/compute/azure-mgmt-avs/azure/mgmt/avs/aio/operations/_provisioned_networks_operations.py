...
from ...operations._provisioned_networks_operations import build_get_request, build_list_request
...
class ProvisionedNetworksOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.ProvisionedNetwork"]:
        ...
        :return: An iterator like instance of either ProvisionedNetwork or the result of cls(response)
        ...
        cls: ClsType[_models.ProvisionedNetworkListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("ProvisionedNetworkListResult", pipeline_response)
    ...
    async def get(
        ...
        :return: ProvisionedNetwork or the result of cls(response)
        ...
        deserialized = self._deserialize("ProvisionedNetwork", pipeline_response.http_response)
