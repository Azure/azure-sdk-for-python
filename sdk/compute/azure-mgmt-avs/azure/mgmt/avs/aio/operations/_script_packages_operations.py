...
class ScriptPackagesOperations:
    """ScriptPackagesOperations async operations.
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/scriptPackages'}  # type: ignore
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :param private_cloud_name: Name of the private cloud.
        :type private_cloud_name: str
        :param script_package_name: Name of the script package in the private cloud.
