...
class CloudLinksOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("CloudLink", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        cloud_link_name: str,
        cloud_link: Union[_models.CloudLink, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param cloud_link: Resource create parameters. Is either a CloudLink type or a IO[bytes] type.
         Required.
        :type cloud_link: ~azure.mgmt.avs.models.CloudLink or IO[bytes]
        :return: An instance of LROPoller that returns either CloudLink or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.avs.models.CloudLink]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
