...
class PlacementPoliciesOperations:
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(placement_policy, (IO, bytes)):
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param placement_policy_name: Name of the VMware vSphere Distributed Resource Scheduler (DRS)
         placement policy. Required.
        :type placement_policy_name: str
        :param placement_policy: A placement policy in the private cloud cluster. Is either a model
    ...
    def _update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(placement_policy_update, (IO, bytes)):
