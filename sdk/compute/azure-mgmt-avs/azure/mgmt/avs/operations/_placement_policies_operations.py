...
class PlacementPoliciesOperations:
    ...
    def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("PlacementPolicy", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        cluster_name: str,
        placement_policy_name: str,
        placement_policy: Union[_models.PlacementPolicy, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type placement_policy: ~azure.mgmt.avs.models.PlacementPolicy or IO[bytes]
        :return: An instance of LROPoller that returns either PlacementPolicy or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.avs.models.PlacementPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        cluster_name: str,
        placement_policy_name: str,
        placement_policy_update: Union[_models.PlacementPolicyUpdate, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type placement_policy_update: ~azure.mgmt.avs.models.PlacementPolicyUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either PlacementPolicy or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.avs.models.PlacementPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
