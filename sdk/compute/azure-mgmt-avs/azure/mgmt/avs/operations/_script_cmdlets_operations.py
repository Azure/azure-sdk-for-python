...
class ScriptCmdletsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.avs.models.ScriptCmdletsList]
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/scriptPackages/{scriptPackageName}/scriptCmdlets'}  # type: ignore
    ...
    def get(
        ...
        private_cloud_name,  # type: str
        script_package_name,  # type: str
        script_cmdlet_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ScriptCmdlet"
        ...
        path_format_arguments = {
            ...
            'privateCloudName': self._serialize.url("private_cloud_name", private_cloud_name, 'str'),
            'scriptPackageName': self._serialize.url("script_package_name", script_package_name, 'str'),
            'scriptCmdletName': self._serialize.url("script_cmdlet_name", script_cmdlet_name, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
