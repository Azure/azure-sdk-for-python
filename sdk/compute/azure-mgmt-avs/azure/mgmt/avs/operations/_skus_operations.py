...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.AVS/skus")
...
class SkusOperations:
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.ResourceSku"]:
        ...
        cls: ClsType[_models.PagedResourceSku] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("PagedResourceSku", pipeline_response)
