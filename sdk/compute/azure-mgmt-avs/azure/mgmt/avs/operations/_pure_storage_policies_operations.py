...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "privateCloudName": _SERIALIZER.url("private_cloud_name", private_cloud_name, "str", pattern=r"^[-\w\._]+$"),
        "storagePolicyName": _SERIALIZER.url("storage_policy_name", storage_policy_name, "str", pattern=r"^[-\w\._]+$"),
    }
...
class PureStoragePoliciesOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either PureStoragePolicy or the result of cls(response)
        ...
        cls: ClsType[_models.PureStoragePolicyListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("PureStoragePolicyListResult", pipeline_response)
    ...
    def get(
        ...
        :return: PureStoragePolicy or the result of cls(response)
        ...
        deserialized = self._deserialize("PureStoragePolicy", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        resource: Union[_models.PureStoragePolicy, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "PureStoragePolicy")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either PureStoragePolicy or the result of
         cls(response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a PureStoragePolicy type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.avs.models.PureStoragePolicy or IO[bytes]
        :return: An instance of LROPoller that returns either PureStoragePolicy or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.avs.models.PureStoragePolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
