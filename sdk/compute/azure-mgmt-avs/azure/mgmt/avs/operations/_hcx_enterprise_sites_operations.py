...
class HcxEnterpriseSitesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.avs.models.HcxEnterpriseSitePaged[~azure.mgmt.avs.models.HcxEnterpriseSite]
        ...
        if raw:
            header_dict = {}
        deserialized = models.HcxEnterpriseSitePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.avs.models.HcxEnterpriseSite or
