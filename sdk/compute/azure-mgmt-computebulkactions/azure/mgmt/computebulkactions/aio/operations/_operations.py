...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.computebulkactions.aio.ComputeClient`'s
...
class VirtualMachineBulkOperationsOperations:
    ...
    async def bulk_deallocate_operation(
        ...
        **kwargs: Any
        ...
        :type request_body: ~azure.mgmt.computebulkactions.models.ExecuteDeallocateContent
    ...
    async def bulk_deallocate_operation(
        ...
        **kwargs: Any
        ...
        :type request_body: ~azure.mgmt.computebulkactions.models.ExecuteDeallocateContent or JSON or
         IO[bytes]
        :return: DeallocateResourceOperationResponse. The DeallocateResourceOperationResponse is
         compatible with MutableMapping
        :rtype: ~azure.mgmt.computebulkactions.models.DeallocateResourceOperationResponse
    ...
    async def bulk_hibernate_operation(
        ...
        **kwargs: Any
        ...
        :type location: str
        :param request_body: The request body. Required.
        :type request_body: ~azure.mgmt.computebulkactions.models.ExecuteHibernateContent
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    async def bulk_hibernate_operation(
        ...
        **kwargs: Any
        ...
        :param request_body: The request body. Is one of the following types: ExecuteHibernateContent,
         JSON, IO[bytes] Required.
        :type request_body: ~azure.mgmt.computebulkactions.models.ExecuteHibernateContent or JSON or
         IO[bytes]
        :return: HibernateResourceOperationResponse. The HibernateResourceOperationResponse is
         compatible with MutableMapping
        :rtype: ~azure.mgmt.computebulkactions.models.HibernateResourceOperationResponse
    ...
    async def bulk_start_operation(
        ...
        **kwargs: Any
        ...
        :type location: str
        :param request_body: The request body. Required.
        :type request_body: ~azure.mgmt.computebulkactions.models.ExecuteStartContent
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    async def bulk_start_operation(
        ...
        resource_group_name: str,
        location: str,
        request_body: Union[_models.ExecuteStartContent, JSON, IO[bytes]],
        **kwargs: Any
    ) -> _models.StartResourceOperationResponse:
        """BulkStart: Execute start operation for a batch of virtual machines, this operation is triggered
        as soon as Computeschedule receives it.
        ...
        :param request_body: The request body. Is one of the following types: ExecuteStartContent,
         JSON, IO[bytes] Required.
        :type request_body: ~azure.mgmt.computebulkactions.models.ExecuteStartContent or JSON or
         IO[bytes]
        :return: StartResourceOperationResponse. The StartResourceOperationResponse is compatible with
         MutableMapping
        :rtype: ~azure.mgmt.computebulkactions.models.StartResourceOperationResponse
    ...
    async def bulk_delete_operation(
        ...
        **kwargs: Any
        ...
        :type location: str
        :param request_body: The request body. Required.
        :type request_body: ~azure.mgmt.computebulkactions.models.ExecuteDeleteContent
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    async def bulk_delete_operation(
        ...
        resource_group_name: str,
        location: str,
        request_body: Union[_models.ExecuteDeleteContent, JSON, IO[bytes]],
        **kwargs: Any
    ) -> _models.DeleteResourceOperationResponse:
        """BulkDelete: Execute delete operation for a batch of virtual machines, this operation is
        triggered as soon as Computeschedule receives it.
        ...
        :param request_body: The request body. Is one of the following types: ExecuteDeleteContent,
         JSON, IO[bytes] Required.
        :type request_body: ~azure.mgmt.computebulkactions.models.ExecuteDeleteContent or JSON or
         IO[bytes]
        :return: DeleteResourceOperationResponse. The DeleteResourceOperationResponse is compatible
         with MutableMapping
        :rtype: ~azure.mgmt.computebulkactions.models.DeleteResourceOperationResponse
    ...
    async def bulk_get_operations_status(
        ...
        **kwargs: Any
        ...
        :type location: str
        :param request_body: The request body. Required.
        :type request_body: ~azure.mgmt.computebulkactions.models.GetOperationStatusContent
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    async def bulk_get_operations_status(
        ...
        **kwargs: Any
        ...
        :type request_body: ~azure.mgmt.computebulkactions.models.GetOperationStatusContent or JSON or
         IO[bytes]
        :return: GetOperationStatusResponse. The GetOperationStatusResponse is compatible with
         MutableMapping
        :rtype: ~azure.mgmt.computebulkactions.models.GetOperationStatusResponse
    ...
    async def bulk_cancel_operations(
        ...
        **kwargs: Any
        ...
        :type location: str
        :param request_body: The request body. Required.
        :type request_body: ~azure.mgmt.computebulkactions.models.CancelOperationsContent
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    async def bulk_cancel_operations(
        ...
        **kwargs: Any
        ...
        :param request_body: The request body. Is one of the following types: CancelOperationsContent,
         JSON, IO[bytes] Required.
        :type request_body: ~azure.mgmt.computebulkactions.models.CancelOperationsContent or JSON or
         IO[bytes]
        :return: CancelOperationsResponse. The CancelOperationsResponse is compatible with
         MutableMapping
        :rtype: ~azure.mgmt.computebulkactions.models.CancelOperationsResponse
