...
class FallbackOperationInfo(_Model):
    ...
    :vartype last_op_type: str or ~azure.mgmt.computebulkactions.models.ResourceOperationType
    :ivar status: The status of the fallback operation. Required.
    :vartype status: str
    :ivar error: The error code if the fallback operation failed.
    :vartype error: ~azure.mgmt.computebulkactions.models.ResourceOperationError
    """
...
class ResourceOperationDetails(_Model):
    ...
    :vartype fallback_operation_info: ~azure.mgmt.computebulkactions.models.FallbackOperationInfo
...
class RetryPolicy(_Model):
    ...
    :ivar on_failure_action: Action to take on failure. Known values are: "Unknown", "Start",
     "Deallocate", "Hibernate", "Create", and "Delete".
    :vartype on_failure_action: str or ~azure.mgmt.computebulkactions.models.ResourceOperationType
    """
