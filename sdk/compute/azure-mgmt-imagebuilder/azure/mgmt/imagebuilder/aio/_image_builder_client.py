...
class ImageBuilderClient(object):
    ...
    :vartype virtual_machine_image_templates: azure.mgmt.imagebuilder.aio.operations.VirtualMachineImageTemplatesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = ImageBuilderClientConfiguration(credential, subscription_id, **kwargs)
