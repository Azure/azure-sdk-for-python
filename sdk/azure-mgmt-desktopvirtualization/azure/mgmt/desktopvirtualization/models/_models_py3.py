...
class HostPool(TrackedResource):
    ...
    def __init__(self, *, location: str, host_pool_type, personal_desktop_assignment_type, load_balancer_type, preferred_app_group_type, tags=None, friendly_name: str=None, description: str=None, custom_rdp_property: str=None, max_session_limit: int=None, ring: int=None, validation_environment: bool=None, registration_info=None, vm_template: str=None, sso_context: str=None, **kwargs) -> None:
