...
class MSIXPackagesOperations(object):
    ...
    def get(
            self, resource_group_name, host_pool_name, msix_package_full_name, custom_headers=None, raw=False, **operation_config):
        """Get a msixpackage.
        ...
        :param msix_package_full_name: The version specific package full name
         of the MSIX package within specified hostpool
        ...
        :return: MSIXPackage or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.desktopvirtualization.models.MSIXPackage or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('MSIXPackage', response)
    ...
    def create_or_update(
            self, resource_group_name, host_pool_name, msix_package_full_name, msix_package, custom_headers=None, raw=False, **operation_config):
        ...
        :type msix_package:
         ~azure.mgmt.desktopvirtualization.models.MSIXPackage
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def update(
            self, resource_group_name, host_pool_name, msix_package_full_name, msix_package=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param msix_package: Object containing MSIX Package definitions.
        :type msix_package:
         ~azure.mgmt.desktopvirtualization.models.MSIXPackagePatch
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of MSIXPackage
        :rtype:
         ~azure.mgmt.desktopvirtualization.models.MSIXPackagePaged[~azure.mgmt.desktopvirtualization.models.MSIXPackage]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.MSIXPackagePaged(internal_paging, self._deserialize.dependencies, header_dict)
