...
class SparkBatchJob(Model):
    ...
    def __init__(self, *, id: int=None, app_id: str=None, app_info=None, state=None, log_lines=None, **kwargs) -> None:
...
class SparkJobState(Model):
    ...
    def __init__(self, *, id: int=None, state=None, **kwargs) -> None:
...
class SparkSessionJob(Model):
    ...
    def __init__(self, *, id: int=None, app_id: str=None, owner: str=None, proxy_user: str=None, kind=None, log_lines=None, state=None, app_info=None, **kwargs) -> None:
...
class SparkStatement(Model):
    ...
    def __init__(self, *, id: int=None, code: str=None, state=None, output=None, progress: float=None, **kwargs) -> None:
...
class SparkStatementOutput(Model):
    ...
    def __init__(self, *, status=None, execution_count: int=None, data=None, **kwargs) -> None:
...
class SparkStatementRequest(Model):
    ...
    def __init__(self, *, code: str=None, kind=None, **kwargs) -> None:
