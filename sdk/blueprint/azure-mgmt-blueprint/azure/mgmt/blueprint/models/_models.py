...
class Assignment(TrackedResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.resource_groups = kwargs['resource_groups']
        self.status = None
...
class AssignmentProperties(BlueprintResourcePropertiesBase):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AssignmentProperties, self).__init__(**kwargs)
        self.blueprint_id = kwargs.get('blueprint_id', None)
        self.scope = kwargs.get('scope', None)
        self.parameters = kwargs['parameters']
        self.resource_groups = kwargs['resource_groups']
...
class BlueprintProperties(SharedBlueprintProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(BlueprintProperties, self).__init__(**kwargs)
        self.versions = kwargs.get('versions', None)
        self.layout = None
...
class PolicyAssignmentArtifactProperties(BlueprintResourcePropertiesBase, ArtifactPropertiesBase):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PolicyAssignmentArtifactProperties, self).__init__(**kwargs)
        self.depends_on = kwargs.get('depends_on', None)
        self.policy_definition_id = kwargs['policy_definition_id']
        self.parameters = kwargs['parameters']
        self.resource_group = kwargs.get('resource_group', None)
...
class PublishedBlueprintProperties(SharedBlueprintProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PublishedBlueprintProperties, self).__init__(**kwargs)
        self.blueprint_name = kwargs.get('blueprint_name', None)
        self.change_notes = kwargs.get('change_notes', None)
...
class RoleAssignmentArtifact(Artifact):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.principal_ids = kwargs['principal_ids']
        self.resource_group = kwargs.get('resource_group', None)
...
class RoleAssignmentArtifactProperties(BlueprintResourcePropertiesBase, ArtifactPropertiesBase):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RoleAssignmentArtifactProperties, self).__init__(**kwargs)
        self.depends_on = kwargs.get('depends_on', None)
        self.role_definition_id = kwargs['role_definition_id']
        self.principal_ids = kwargs['principal_ids']
        self.resource_group = kwargs.get('resource_group', None)
...
class TemplateArtifactProperties(BlueprintResourcePropertiesBase, ArtifactPropertiesBase):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(TemplateArtifactProperties, self).__init__(**kwargs)
        self.depends_on = kwargs.get('depends_on', None)
        self.template = kwargs['template']
        self.resource_group = kwargs.get('resource_group', None)
        self.parameters = kwargs['parameters']
