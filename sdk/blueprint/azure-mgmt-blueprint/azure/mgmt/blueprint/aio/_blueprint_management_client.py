...
class BlueprintManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    """Blueprint Client.

    :ivar blueprints: BlueprintsOperations operations
    :vartype blueprints: azure.mgmt.blueprint.aio.operations.BlueprintsOperations
    :ivar artifacts: ArtifactsOperations operations
    :vartype artifacts: azure.mgmt.blueprint.aio.operations.ArtifactsOperations
    :ivar published_blueprints: PublishedBlueprintsOperations operations
    :vartype published_blueprints:
     azure.mgmt.blueprint.aio.operations.PublishedBlueprintsOperations
    :ivar published_artifacts: PublishedArtifactsOperations operations
    :vartype published_artifacts: azure.mgmt.blueprint.aio.operations.PublishedArtifactsOperations
    :ivar assignments: AssignmentsOperations operations
    :vartype assignments: azure.mgmt.blueprint.aio.operations.AssignmentsOperations
    :ivar assignment_operations: AssignmentOperationsOperations operations
    :vartype assignment_operations:
     azure.mgmt.blueprint.aio.operations.AssignmentOperationsOperations
    :param credential: Credential needed for the client to connect to Azure. Required.
    :type credential: ~azure.core.credentials_async.AsyncTokenCredential
    :param base_url: Service URL. Default value is "https://management.azure.com".
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2018-11-01-preview". Note that overriding
    ...
    def __init__(
        ...
        self._config = BlueprintManagementClientConfiguration(credential=credential, **kwargs)
        ...
        self.blueprints = BlueprintsOperations(self._client, self._config, self._serialize, self._deserialize)
