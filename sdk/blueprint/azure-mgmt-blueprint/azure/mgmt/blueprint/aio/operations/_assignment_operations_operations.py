...
class AssignmentOperationsOperations:
    """AssignmentOperationsOperations async operations.
    ...
    def list(
        ...
        assignment_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.AssignmentOperationList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~blueprint_management_client.models.AssignmentOperationList]
