...
class AssignmentsOperations(object):
    ...
    def create_or_update(
        ...
        assignment,  # type: "_models.Assignment"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Assignment"
    ...
    def delete(
        ...
        resource_scope,  # type: str
        assignment_name,  # type: str
        delete_behavior=None,  # type: Optional[Union[str, "_models.AssignmentDeleteBehavior"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.Assignment"]
    ...
    def who_is_blueprint(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.WhoIsBlueprintContract"
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.AssignmentList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~blueprint_management_client.models.AssignmentList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
