...
class PowerBIDedicatedClient:
    ...
    :vartype auto_scale_vcores:
     azure.mgmt.powerbidedicated.aio.operations.AutoScaleVCoresOperations
    ...
    :keyword api_version: The API version to use for this operation. Known values are "2021-01-01"
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = PowerBIDedicatedClientConfiguration(
