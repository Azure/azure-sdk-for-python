...
class TestMicrosoftDependencyMapManagementServiceMapsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_maps_begin_get_dependency_view_for_all_machines(self, resource_group):
        response = self.client.maps.begin_get_dependency_view_for_all_machines(
            resource_group_name=resource_group.name,
            map_name="str",
