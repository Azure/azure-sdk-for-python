...
from ...operations._alias_operations import build_create_request_initial, build_delete_request, build_get_request, build_list_request
T = TypeVar('T')
...
class AliasOperations:
    ...
    async def _create_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(body, 'PutAliasRequest')
