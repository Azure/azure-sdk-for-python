...
def build_create_request(alias_name: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Subscription/aliases/{aliasName}")
...
def build_get_request(alias_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_request(alias_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Subscription/aliases")
...
class AliasOperations:
    ...
    _create_initial.metadata = {"url": "/providers/Microsoft.Subscription/aliases/{aliasName}"}
    ...
    begin_create.metadata = {"url": "/providers/Microsoft.Subscription/aliases/{aliasName}"}
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> _models.SubscriptionAliasListResult:
        ...
        api_version: Literal["2021-10-01"] = kwargs.pop("api_version", _params.pop("api-version", "2021-10-01"))
        cls: ClsType[_models.SubscriptionAliasListResult] = kwargs.pop("cls", None)
