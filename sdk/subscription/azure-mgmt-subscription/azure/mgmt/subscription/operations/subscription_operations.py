...
class SubscriptionOperations(object):
    ...
    def rename(
            self, subscription_id, body, custom_headers=None, raw=False, **operation_config):
    ...
    def _accept_ownership_initial(
            self, subscription_id, body, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.accept_ownership.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    def accept_ownership(
            self, subscription_id, body, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    accept_ownership.metadata = {'url': '/providers/Microsoft.Subscription/subscriptions/{subscriptionId}/acceptOwnership'}
    ...
    def accept_ownership_status(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: AcceptOwnershipStatusResponse or ClientRawResponse if
         raw=true
        ...
        """
        # Construct URL
        url = self.accept_ownership_status.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('AcceptOwnershipStatusResponse', response)
        ...
        return deserialized
    accept_ownership_status.metadata = {'url': '/providers/Microsoft.Subscription/subscriptions/{subscriptionId}/acceptOwnershipStatus'}
