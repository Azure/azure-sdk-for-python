...
class BillingAccountOperations(object):
    ...
    def get_policy(
        ...
        :return: BillingAccountPoliciesResponse or ClientRawResponse if
         raw=true
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('BillingAccountPoliciesResponse', response)
        ...
        return deserialized
    get_policy.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/providers/Microsoft.Subscription/policies/default'}
