...
class SubscriptionAliasResponseProperties(Model):
    ...
    def __init__(self, *, display_name: str=None, provisioning_state=None, accept_ownership_state=None, billing_scope: str=None, workload=None, reseller_id: str=None, subscription_owner_id: str=None, management_group_id: str=None, created_time: str=None, tags=None, **kwargs) -> None:
