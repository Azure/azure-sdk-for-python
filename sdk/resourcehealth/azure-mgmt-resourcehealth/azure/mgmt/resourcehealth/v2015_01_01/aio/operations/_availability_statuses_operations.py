...
from ...operations._availability_statuses_operations import build_get_by_resource_request, build_list_by_resource_group_request, build_list_by_subscription_id_request, build_list_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class AvailabilityStatusesOperations:
    """AvailabilityStatusesOperations async operations.
    ...
    def list_by_subscription_id(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either AvailabilityStatusListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resourcehealth.v2015_01_01.models.AvailabilityStatusListResult]
