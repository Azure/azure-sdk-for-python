...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/{resourceUri}/providers/Microsoft.ResourceHealth/childResources')
...
class ChildResourcesOperations(object):
    """ChildResourcesOperations operations.
