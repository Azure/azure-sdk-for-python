...
class EmergingIssuesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.EmergingIssuesGetResult"]:
        """Lists Azure services' emerging issues.

        :return: An iterator like instance of either EmergingIssuesGetResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resourcehealth.models.EmergingIssuesGetResult]
    ...
    async def get(
        ...
        deserialized = self._deserialize("EmergingIssuesGetResult", pipeline_response.http_response)
