...
from ...operations._security_advisory_impacted_resources_operations import (
...
class SecurityAdvisoryImpactedResourcesOperations:  # pylint: disable=name-too-long
    ...
    def list_by_subscription_id_and_event_id(
    ...
    ) -> AsyncItemPaged["_models.EventImpactedResource"]:
        ...
        :return: An iterator like instance of either EventImpactedResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resourcehealth.models.EventImpactedResource]
