...
def build_list_by_tenant_id_and_event_id_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.ResourceHealth/events/{eventTrackingId}/impactedResources")
    path_format_arguments = {
        "eventTrackingId": _SERIALIZER.url("event_tracking_id", event_tracking_id, "str"),
    }
...
def build_get_by_tenant_id_request(event_tracking_id: str, impacted_resource_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
