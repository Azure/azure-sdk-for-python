...
class EmergingIssuesOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.EmergingIssuesGetResult"]:
        ...
        :return: An iterator like instance of either EmergingIssuesGetResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resourcehealth.v2023_10_01_preview.models.EmergingIssuesGetResult]
    ...
    async def get(
        self, issue_name: Union[str, _models.IssueNameParameter], **kwargs: Any
    ) -> _models.EmergingIssuesGetResult:
        """Gets Azure services' emerging issues.

        :param issue_name: The name of the emerging issue. "default" Required.
        :type issue_name: str or
         ~azure.mgmt.resourcehealth.v2023_10_01_preview.models.IssueNameParameter
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: EmergingIssuesGetResult or the result of cls(response)
        :rtype: ~azure.mgmt.resourcehealth.v2023_10_01_preview.models.EmergingIssuesGetResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
