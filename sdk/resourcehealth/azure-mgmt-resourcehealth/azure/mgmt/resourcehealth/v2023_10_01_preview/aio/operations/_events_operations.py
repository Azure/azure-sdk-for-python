...
from ...operations._events_operations import (
    ...
    build_list_by_tenant_id_request,
)
...
class EventsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resourcehealth.v2023_10_01_preview.aio.ResourceHealthMgmtClient`'s
    ...
    def list_by_subscription_id(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resourcehealth.v2023_10_01_preview.models.Event]
    ...
    def list_by_tenant_id(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_tenant_id_request(
                    filter=filter,
                    query_start_time=query_start_time,
                    api_version=api_version,
                    template_url=self.list_by_tenant_id.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
                request = _convert_request(request)
    ...
    list_by_tenant_id.metadata = {"url": "/providers/Microsoft.ResourceHealth/events"}
