...
from ...operations._deployment_scripts_operations import (
    build_create_request,
    build_delete_request,
    build_get_logs_default_request,
...
class DeploymentScriptsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.deploymentscripts.aio.DeploymentScriptsClient`'s
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: DeploymentScriptsClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type deployment_script: ~azure.mgmt.resource.deploymentscripts.models.DeploymentScript
        ...
        :return: An instance of AsyncLROPoller that returns either DeploymentScript or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.resource.deploymentscripts.models.DeploymentScript]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type deployment_script: ~azure.mgmt.resource.deploymentscripts.models.DeploymentScript or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either DeploymentScript or the result of
         cls(response)
        :rtype:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("DeploymentScript", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type deployment_script:
         ~azure.mgmt.resource.deploymentscripts.models.DeploymentScriptUpdateParameter
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: DeploymentScript or the result of cls(response)
        :rtype: ~azure.mgmt.resource.deploymentscripts.models.DeploymentScript
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type deployment_script:
         ~azure.mgmt.resource.deploymentscripts.models.DeploymentScriptUpdateParameter or IO[bytes]
        :return: DeploymentScript or the result of cls(response)
        :rtype: ~azure.mgmt.resource.deploymentscripts.models.DeploymentScript
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.DeploymentScript"]:
        """Lists all deployment scripts for a given subscription.

        :return: An iterator like instance of either DeploymentScript or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.deploymentscripts.models.DeploymentScript]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_logs(self, resource_group_name: str, script_name: str, **kwargs: Any) -> _models.ScriptLogsList:
        ...
        :rtype: ~azure.mgmt.resource.deploymentscripts.models.ScriptLogsList
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("ScriptLogsList", pipeline_response.http_response)
    ...
    async def get_logs_default(
        ...
        :rtype: ~azure.mgmt.resource.deploymentscripts.models.ScriptLog
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _request = build_get_logs_default_request(
            resource_group_name=resource_group_name,
            script_name=script_name,
            subscription_id=self._config.subscription_id,
            tail=tail,
        ...
        deserialized = self._deserialize("ScriptLog", pipeline_response.http_response)
    ...
    ) -> AsyncItemPaged["_models.DeploymentScript"]:
