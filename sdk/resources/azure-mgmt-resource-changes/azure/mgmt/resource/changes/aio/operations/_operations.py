...
class ChangesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.changes.aio.ChangesClient`'s
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: ChangesClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.ChangeResourceResult"]:
        ...
        :return: An iterator like instance of either ChangeResourceResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.changes.models.ChangeResourceResult]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.resource.changes.models.ChangeResourceResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
