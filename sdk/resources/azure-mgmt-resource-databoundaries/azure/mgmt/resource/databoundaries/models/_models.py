...
class DataBoundaryDefinition(ProxyResource):
    ...
    properties: Optional["_models.DataBoundaryProperties"] = rest_field(
    ...
    def __init__(
        self,
        *,
        properties: Optional["_models.DataBoundaryProperties"] = None,
    ) -> None: ...
...
class DataBoundaryProperties(_Model):
    """Data boundary properties.
    ...
    data_boundary: Optional[Union[str, "_models.DataBoundary"]] = rest_field(
        name="dataBoundary", visibility=["read", "create"]
    )
...
class Operation(_Model):
    ...
    :vartype display: ~azure.mgmt.resource.databoundaries.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.resource.databoundaries.models.Origin
    :ivar action_type: Extensible enum. Indicates the action type. "Internal" refers to actions
     that are for internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.resource.databoundaries.models.ActionType
    """
