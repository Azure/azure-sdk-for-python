...
if TYPE_CHECKING:
    from .models import CreatedByType, DataBoundary, ProvisioningState
...
class DataBoundaryDefinition(ProxyResource):
    ...
    :vartype properties: "DataBoundaryProperties"
    """
...
class DataBoundaryProperties(TypedDict, total=False):
    """Data boundary properties.
    ...
    """The data boundary definition. Known values are: \"NotDefined\", \"Global\", and \"EU\"."""
    provisioningState: Union[str, "ProvisioningState"]
    """Denotes the state of provisioning. Known values are: \"Accepted\", \"Running\", \"Creating\",
