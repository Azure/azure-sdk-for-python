...
# USAGE
    python deployment_stack_what_if_results_resource_group_create.py
...
def main():
    ...
    response = client.deployment_stacks_what_if_results_at_resource_group.begin_create_or_update(
