...
# USAGE
    python deployment_stack_resource_group_create.py
...
def main():
    ...
    response = client.deployment_stacks.begin_create_or_update_at_resource_group(
...
# x-ms-original-file: specification/resources/resource-manager/Microsoft.Resources/deploymentStacks/stable/2024-03-01/examples/DeploymentStackResourceGroupCreate.json
