...
class ManagedServiceIdentityClient:
    ...
    :vartype system_assigned_identities:
     azure.mgmt.msi.v2018_11_30.aio.operations.SystemAssignedIdentitiesOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.msi.v2018_11_30.aio.operations.Operations
    ...
    def __init__(
        ...
        self.system_assigned_identities = SystemAssignedIdentitiesOperations(
            self._client, self._config, self._serialize, self._deserialize, "2018-11-30"
        )
        self.operations = Operations(self._client, self._config, self._serialize, self._deserialize, "2018-11-30")
