...
class SystemAssignedIdentityResult(Model):
    """Values returned by the display operation.

    :param value: The systemAssignedIdentity returned by the operation.
    :type value: str
    """
    ...
    def __init__(self, **kwargs):
        super(SystemAssignedIdentityResult, self).__init__(**kwargs)
