...
class FederatedIdentityCredential(ProxyResource):
    ...
    __flattened_items = ["issuer", "subject", "audiences"]
...
class FederatedIdentityCredentialProperties(_Model):
    ...
    :vartype issuer: str
    :ivar subject: The identifier of the external identity. Required.
    :vartype subject: str
...
class IdentityUpdate(Resource):
    ...
    __flattened_items = ["tenant_id", "principal_id", "client_id", "isolation_scope"]
