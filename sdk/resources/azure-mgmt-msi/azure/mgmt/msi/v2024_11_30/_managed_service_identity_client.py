...
class ManagedServiceIdentityClient:
    ...
    :vartype system_assigned_identities:
     azure.mgmt.msi.v2024_11_30.operations.SystemAssignedIdentitiesOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.msi.v2024_11_30.operations.Operations
    :ivar user_assigned_identities: UserAssignedIdentitiesOperations operations
    :vartype user_assigned_identities:
     azure.mgmt.msi.v2024_11_30.operations.UserAssignedIdentitiesOperations
    ...
    :vartype federated_identity_credentials:
     azure.mgmt.msi.v2024_11_30.operations.FederatedIdentityCredentialsOperations
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2024-11-30". Note that overriding this
    ...
    def __init__(
        ...
        self.system_assigned_identities = SystemAssignedIdentitiesOperations(
            self._client, self._config, self._serialize, self._deserialize, "2024-11-30"
        )
        self.operations = Operations(self._client, self._config, self._serialize, self._deserialize, "2024-11-30")
