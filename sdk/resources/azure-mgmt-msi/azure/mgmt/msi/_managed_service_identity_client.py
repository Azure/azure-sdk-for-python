...
class ManagedServiceIdentityClient(MultiApiClientMixin, _SDKClient):
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2021-09-30-preview: :class:`Operations<azure.mgmt.msi.v2021_09_01_preview.operations.Operations>`
        """
    ...
    def system_assigned_identities(self):
        """Instance depends on the API version:
           ...
           * 2021-09-30-preview: :class:`SystemAssignedIdentitiesOperations<azure.mgmt.msi.v2021_09_01_preview.operations.SystemAssignedIdentitiesOperations>`
        """
        ...
        if api_version == '2018-11-30':
            ...
            from .v2021_09_01_preview.operations import SystemAssignedIdentitiesOperations as OperationClass
        else:
    ...
    def user_assigned_identities(self):
        """Instance depends on the API version:
           ...
           * 2021-09-30-preview: :class:`UserAssignedIdentitiesOperations<azure.mgmt.msi.v2021_09_01_preview.operations.UserAssignedIdentitiesOperations>`
        """
        ...
        if api_version == '2018-11-30':
            ...
            from .v2021_09_01_preview.operations import UserAssignedIdentitiesOperations as OperationClass
        else:
