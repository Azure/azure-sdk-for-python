...
class UserAssignedIdentitiesOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.Identity"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.msi.v2022_01_31_preview.models.Identity]
    ...
    def list_associated_resources(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.msi.v2022_01_31_preview.models.AzureResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
