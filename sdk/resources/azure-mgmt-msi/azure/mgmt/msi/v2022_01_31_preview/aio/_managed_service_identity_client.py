...
class ManagedServiceIdentityClient:
    ...
    :vartype system_assigned_identities:
     azure.mgmt.msi.v2022_01_31_preview.aio.operations.SystemAssignedIdentitiesOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.msi.v2022_01_31_preview.aio.operations.Operations
    :ivar user_assigned_identities: UserAssignedIdentitiesOperations operations
    :vartype user_assigned_identities:
     azure.mgmt.msi.v2022_01_31_preview.aio.operations.UserAssignedIdentitiesOperations
    ...
    :vartype federated_identity_credentials:
     azure.mgmt.msi.v2022_01_31_preview.aio.operations.FederatedIdentityCredentialsOperations
    ...
    def __init__(
        ...
        self.system_assigned_identities = SystemAssignedIdentitiesOperations(
            self._client, self._config, self._serialize, self._deserialize, "2022-01-31-preview"
        )
