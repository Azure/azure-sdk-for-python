...
class FederatedIdentityCredentialsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either FederatedIdentityCredential or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.msi.v2022_01_31_preview.models.FederatedIdentityCredential]
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.msi.v2022_01_31_preview.models.FederatedIdentityCredential or
         IO[bytes]
        :return: FederatedIdentityCredential or the result of cls(response)
        :rtype: ~azure.mgmt.msi.v2022_01_31_preview.models.FederatedIdentityCredential
        :raises ~azure.core.exceptions.HttpResponseError:
