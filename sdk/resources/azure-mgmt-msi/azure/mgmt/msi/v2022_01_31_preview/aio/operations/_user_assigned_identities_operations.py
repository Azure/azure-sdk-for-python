...
class UserAssignedIdentitiesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.msi.v2022_01_31_preview.aio.ManagedServiceIdentityClient`'s
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.Identity"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.msi.v2022_01_31_preview.models.Identity]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

        api_version: Literal["2022-01-31-preview"] = kwargs.pop(
            "api_version", _params.pop("api-version", "2022-01-31-preview")
        )
    ...
    def list_associated_resources(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.AzureResource"]:
        ...
        :type skiptoken: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either AzureResource or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.msi.v2022_01_31_preview.models.AzureResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        cls: ClsType[_models.AssociatedResourcesListResult] = kwargs.pop("cls", None)
    ...
    list_associated_resources.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{resourceName}/listAssociatedResources"
    }
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.msi.v2022_01_31_preview.models.Identity
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Identity or the result of cls(response)
        :rtype: ~azure.mgmt.msi.v2022_01_31_preview.models.Identity
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.msi.v2022_01_31_preview.models.IdentityUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
