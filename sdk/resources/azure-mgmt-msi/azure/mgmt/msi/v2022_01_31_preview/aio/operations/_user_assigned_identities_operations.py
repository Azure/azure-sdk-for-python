...
class UserAssignedIdentitiesOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.Identity"]:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2022-01-31-preview")
        )
    ...
    def list_associated_resources(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.AzureResource"]:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.msi.v2022_01_31_preview.models.Identity or IO[bytes]
        :return: Identity or the result of cls(response)
        :rtype: ~azure.mgmt.msi.v2022_01_31_preview.models.Identity
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters to update the identity. Is either a IdentityUpdate type or a
         IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.msi.v2022_01_31_preview.models.IdentityUpdate or IO[bytes]
        :return: Identity or the result of cls(response)
        :rtype: ~azure.mgmt.msi.v2022_01_31_preview.models.Identity
        :raises ~azure.core.exceptions.HttpResponseError:
        """
