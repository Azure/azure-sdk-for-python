    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either UserAssignedIdentitiesListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.msi.v2021_09_01_preview.models.UserAssignedIdentitiesListResult]
    ...
    def list_associated_resources(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either AssociatedResourcesListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.msi.v2021_09_01_preview.models.AssociatedResourcesListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-09-30-preview")  # type: str
