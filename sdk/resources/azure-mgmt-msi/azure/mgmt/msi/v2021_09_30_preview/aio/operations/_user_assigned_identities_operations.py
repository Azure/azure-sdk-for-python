...
class UserAssignedIdentitiesOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.Identity"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.msi.v2021_09_30_preview.models.Identity]
    ...
    def list_associated_resources(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.msi.v2021_09_30_preview.models.AzureResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.msi.v2021_09_30_preview.models.Identity or IO[bytes]
        :return: Identity or the result of cls(response)
        :rtype: ~azure.mgmt.msi.v2021_09_30_preview.models.Identity
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters to update the identity. Is either a IdentityUpdate type or a
         IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.msi.v2021_09_30_preview.models.IdentityUpdate or IO[bytes]
        :return: Identity or the result of cls(response)
        :rtype: ~azure.mgmt.msi.v2021_09_30_preview.models.Identity
        :raises ~azure.core.exceptions.HttpResponseError:
        """
