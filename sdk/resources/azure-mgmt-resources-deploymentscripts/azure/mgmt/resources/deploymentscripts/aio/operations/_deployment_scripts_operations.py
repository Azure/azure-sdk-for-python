...
class DeploymentScriptsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resources.deploymentscripts.aio.DeploymentScriptsClient`'s
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type deployment_script: ~azure.mgmt.resources.deploymentscripts.models.DeploymentScript
        ...
        :return: An instance of AsyncLROPoller that returns either DeploymentScript or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.resources.deploymentscripts.models.DeploymentScript]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type deployment_script: ~azure.mgmt.resources.deploymentscripts.models.DeploymentScript or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either DeploymentScript or the result of
         cls(response)
        :rtype:
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type deployment_script:
         ~azure.mgmt.resources.deploymentscripts.models.DeploymentScriptUpdateParameter
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: DeploymentScript or the result of cls(response)
        :rtype: ~azure.mgmt.resources.deploymentscripts.models.DeploymentScript
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type deployment_script:
         ~azure.mgmt.resources.deploymentscripts.models.DeploymentScriptUpdateParameter or IO[bytes]
        :return: DeploymentScript or the result of cls(response)
        :rtype: ~azure.mgmt.resources.deploymentscripts.models.DeploymentScript
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.DeploymentScript"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resources.deploymentscripts.models.DeploymentScript]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_logs(self, resource_group_name: str, script_name: str, **kwargs: Any) -> _models.ScriptLogsList:
        ...
        :rtype: ~azure.mgmt.resources.deploymentscripts.models.ScriptLogsList
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_logs_default(
        ...
        :rtype: ~azure.mgmt.resources.deploymentscripts.models.ScriptLog
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
