...
from ...operations._operations import (
    ...
    build_subscription_feature_registrations_list_all_by_subscription_request,
...
class _FeatureClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], FeatureClientConfiguration]
):
    ...
    def list_operations(self, **kwargs: Any) -> AsyncItemPaged["_models.Operation"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.features.models.Operation]
...
class FeaturesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.features.aio.FeatureClient`'s
    ...
    @distributed_trace
    def list_all(self, **kwargs: Any) -> AsyncItemPaged["_models.FeatureResult"]:
        """Gets all the preview features that are available through AFEC for the subscription.

        :return: An iterator like instance of either FeatureResult or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.features.models.FeatureResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list(self, resource_provider_namespace: str, **kwargs: Any) -> AsyncItemPaged["_models.FeatureResult"]:
...
class SubscriptionFeatureRegistrationsOperations:  # pylint: disable=name-too-long
    ...
    def list_by_subscription(
    ...
    ) -> AsyncItemPaged["_models.SubscriptionFeatureRegistration"]:
        ...
        :return: An iterator like instance of either SubscriptionFeatureRegistration or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.features.models.SubscriptionFeatureRegistration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_all_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.SubscriptionFeatureRegistration"]:
