...
### Breaking Changes
  ...
  - Method `DataBoundaryMgmtClient.__init__` deleted or renamed its parameter `api_version` of kind `positional_or_keyword`
  - Method `DataBoundaryMgmtClient.__init__` deleted or renamed its parameter `profile` of kind `positional_or_keyword`
  - Deleted or renamed client method `DataBoundaryMgmtClient.models`
