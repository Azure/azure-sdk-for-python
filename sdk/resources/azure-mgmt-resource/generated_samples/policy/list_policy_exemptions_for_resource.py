...
# USAGE
    python list_policy_exemptions_for_resource.py
...
def main():
    ...
    response = client.policy_exemptions.list_for_resource(
        resource_group_name="TestResourceGroup",
        resource_provider_namespace="Microsoft.Compute",
        parent_resource_path="virtualMachines/MyTestVm",
        resource_type="domainNames",
        resource_name="MyTestComputer.cloudapp.net",
    )
