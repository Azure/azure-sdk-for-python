...
# USAGE
    python get_policy_assignment_by_id.py
...
# x-ms-original-file: specification/resources/resource-manager/Microsoft.Authorization/stable/2023-04-01/examples/getPolicyAssignmentById.json
