...
class Operations:
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: ManagementLinkClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
...
class ResourceLinksOperations:
    ...
    async def create_or_update(
        ...
        deserialized = self._deserialize("ResourceLink", pipeline_response.http_response)
    ...
    ) -> AsyncItemPaged["_models.ResourceLink"]:
