...
class ResourceLinksOperations(object):
    ...
    def create_or_update(
        self,
        link_id,  # type: str
        properties=None,  # type: Optional["models.ResourceLinkProperties"]
        **kwargs  # type: Any
    ):
        ...
        :rtype: ~azure.mgmt.resource.links.v2016_09_01.models.ResourceLink or ~azure.mgmt.resource.links.v2016_09_01.models.ResourceLink
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ResourceLink"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})

        _parameters = models.ResourceLink(properties=properties)
        api_version = "2016-09-01"
        ...
        body_content = self._serialize.body(_parameters, 'ResourceLink')
    ...
    def list_at_subscription(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ResourceLinkResult"
     ...
     for list resource links is targetId. For example, $filter=targetId eq {value}.
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ResourceLinkResult or the result of cls(response)
        :rtype: ~azure.mgmt.resource.links.v2016_09_01.models.ResourceLinkResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
