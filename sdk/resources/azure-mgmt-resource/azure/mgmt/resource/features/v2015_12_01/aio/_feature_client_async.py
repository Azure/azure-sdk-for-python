...
from .operations_async import FeatureClientOperationsMixin
from .operations_async import FeaturesOperations
from .. import models
...
class FeatureClient(FeatureClientOperationsMixin):
    ...
    :vartype features: azure.mgmt.resource.features.v2015_12_01.aio.operations_async.FeaturesOperations
