...
class FeatureClient(_FeatureClientOperationsMixin):
    ...
    :vartype features: azure.mgmt.resource.features.aio.operations.FeaturesOperations
    ...
    :vartype subscription_feature_registrations:
     azure.mgmt.resource.features.aio.operations.SubscriptionFeatureRegistrationsOperations
