...
class _FeatureClientOperationsMixin(
    ...
    def list_operations(self, **kwargs: Any) -> ItemPaged["_models.Operation"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.resource.features.models.Operation]
...
class FeaturesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.features.FeatureClient`'s
    ...
    def list_all(self, **kwargs: Any) -> ItemPaged["_models.FeatureResult"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.resource.features.models.FeatureResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get(self, resource_provider_namespace: str, feature_name: str, **kwargs: Any) -> _models.FeatureResult:
        ...
        :rtype: ~azure.mgmt.resource.features.models.FeatureResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class SubscriptionFeatureRegistrationsOperations:  # pylint: disable=name-too-long
    ...
    def get(self, provider_namespace: str, feature_name: str, **kwargs: Any) -> _models.SubscriptionFeatureRegistration:
        ...
        :rtype: ~azure.mgmt.resource.features.models.SubscriptionFeatureRegistration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type subscription_feature_registration_type:
         ~azure.mgmt.resource.features.models.SubscriptionFeatureRegistration
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type subscription_feature_registration_type:
         ~azure.mgmt.resource.features.models.SubscriptionFeatureRegistration or IO[bytes]
        :return: SubscriptionFeatureRegistration or the result of cls(response)
        :rtype: ~azure.mgmt.resource.features.models.SubscriptionFeatureRegistration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if subscription_feature_registration_type else None
        cls: ClsType[_models.SubscriptionFeatureRegistration] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if subscription_feature_registration_type else None
        _json = None
        _content = None
    ...
    def list_by_subscription(
        ...
        :return: An iterator like instance of either SubscriptionFeatureRegistration or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.features.models.SubscriptionFeatureRegistration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
