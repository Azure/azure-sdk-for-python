...
class SubscriptionFeatureRegistrationsOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type subscription_feature_registration_type: ~azure.mgmt.resource.features.v2021_07_01.models.SubscriptionFeatureRegistration
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SubscriptionFeatureRegistration, or the result of cls(response)
        :rtype: ~azure.mgmt.resource.features.v2021_07_01.models.SubscriptionFeatureRegistration
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        if subscription_feature_registration_type is not None:
            body_content = self._serialize.body(subscription_feature_registration_type, 'SubscriptionFeatureRegistration')
        else:
            body_content = None
    ...
    def list_all_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_all_by_subscription.metadata['url']  # type: ignore
                path_format_arguments = {
                    'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
