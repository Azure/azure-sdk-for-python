...
class FeatureClientOperationsMixin(ClientMixinABC[AsyncPipelineClient, FeatureClientConfiguration]):
...
class FeaturesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.features.v2021_07_01.aio.FeatureClient`'s
...
class SubscriptionFeatureRegistrationsOperations:  # pylint: disable=name-too-long
    ...
    def list_by_subscription(
        ...
        :return: An iterator like instance of either SubscriptionFeatureRegistration or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.features.v2021_07_01.models.SubscriptionFeatureRegistration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
