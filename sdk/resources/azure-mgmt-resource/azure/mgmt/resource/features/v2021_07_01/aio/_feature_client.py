...
from .operations import SubscriptionFeatureRegistrationsOperations
from .. import models
...
class FeatureClient(FeatureClientOperationsMixin):
    ...
    :vartype subscription_feature_registrations: azure.mgmt.resource.features.v2021_07_01.aio.operations.SubscriptionFeatureRegistrationsOperations
