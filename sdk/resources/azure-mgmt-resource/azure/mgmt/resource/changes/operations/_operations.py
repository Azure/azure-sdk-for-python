...
class ChangesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.changes.ChangesClient`'s
    ...
    def list(
        ...
        skip_token: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.ChangeResourceResult"]:
        ...
        :return: An iterator like instance of either ChangeResourceResult or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.resource.changes.models.ChangeResourceResult]
