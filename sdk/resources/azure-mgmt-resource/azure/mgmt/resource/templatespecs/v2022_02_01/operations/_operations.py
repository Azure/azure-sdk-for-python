...
def build_template_specs_create_or_update_request(
    ...
    *,
    json: Optional[_models.TemplateSpec] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_template_specs_update_request(
    ...
    template_spec_name: str,
    *,
    json: Optional[_models.TemplateSpecUpdateModel] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_template_specs_get_built_in_request(
    template_spec_name: str,
    *,
    expand: Optional[Union[str, "_models.TemplateSpecExpandKind"]] = None,
    **kwargs: Any
...
def build_template_spec_versions_create_or_update_request(
    ...
    *,
    json: Optional[_models.TemplateSpecVersion] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_template_spec_versions_update_request(
    ...
    template_spec_version: str,
    *,
    json: Optional[_models.TemplateSpecVersionUpdateModel] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_template_spec_versions_list_built_ins_request(
    template_spec_name: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_template_spec_versions_get_built_in_request(
    template_spec_name: str,
    template_spec_version: str,
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Resources/builtInTemplateSpecs/{templateSpecName}/versions/{templateSpecVersion}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "templateSpecName": _SERIALIZER.url("template_spec_name", template_spec_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        "templateSpecVersion": _SERIALIZER.url("template_spec_version", template_spec_version, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
    }
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either TemplateSpecsListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.templatespecs.v2022_02_01.models.TemplateSpecsListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either TemplateSpecVersionsListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.templatespecs.v2022_02_01.models.TemplateSpecVersionsListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
