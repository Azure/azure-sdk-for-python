...
class TemplateSpecsClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype template_specs:
     azure.mgmt.resource.templatespecs.v2021_03_01_preview.operations.TemplateSpecsOperations
    :ivar template_spec_versions: TemplateSpecVersionsOperations operations
    :vartype template_spec_versions:
     azure.mgmt.resource.templatespecs.v2021_03_01_preview.operations.TemplateSpecVersionsOperations
    ...
    def __enter__(self) -> "TemplateSpecsClient":
