...
class TemplateSpecsClient(MultiApiClientMixin, SDKClient):
    ...
    DEFAULT_API_VERSION = '2020-10-01-preview'
    ...
    def models(cls, api_version=DEFAULT_API_VERSION):
        """Module depends on the API version:
           ...
           * 2020-10-01-preview: :mod:`v2020_10_01_preview.models<azure.mgmt.resource.templatespecs.v2020_10_01_preview.models>`
        """
    ...
    def template_spec_versions(self):
        """Instance depends on the API version:
           ...
           * 2020-10-01-preview: :class:`TemplateSpecVersionsOperations<azure.mgmt.resource.templatespecs.v2020_10_01_preview.operations.TemplateSpecVersionsOperations>`
        """
        ...
        if api_version == '2019-06-01-preview':
            ...
            from .v2020_10_01_preview.operations import TemplateSpecVersionsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
    ...
    def template_specs(self):
        """Instance depends on the API version:
           ...
           * 2020-10-01-preview: :class:`TemplateSpecsOperations<azure.mgmt.resource.templatespecs.v2020_10_01_preview.operations.TemplateSpecsOperations>`
        """
        ...
        if api_version == '2019-06-01-preview':
            ...
            from .v2020_10_01_preview.operations import TemplateSpecsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
