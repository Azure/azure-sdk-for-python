...
from .operations_async import TemplateSpecsOperations
from .operations_async import TemplateSpecVersionsOperations
from .. import models
...
class TemplateSpecsClient(object):
    ...
    :vartype template_specs: azure.mgmt.resource.templatespecs.v2019_06_preview.aio.operations_async.TemplateSpecsOperations
    :ivar template_spec_versions: TemplateSpecVersionsOperations operations
    :vartype template_spec_versions: azure.mgmt.resource.templatespecs.v2019_06_preview.aio.operations_async.TemplateSpecVersionsOperations
