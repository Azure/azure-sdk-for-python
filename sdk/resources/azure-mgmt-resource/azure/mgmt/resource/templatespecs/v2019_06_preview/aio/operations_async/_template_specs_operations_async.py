...
class TemplateSpecsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :type template_spec: ~azure.mgmt.resource.templatespecs.v2019_06_preview.models.TemplateSpec
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: TemplateSpec, or the result of cls(response)
        :rtype: ~azure.mgmt.resource.templatespecs.v2019_06_preview.models.TemplateSpec
