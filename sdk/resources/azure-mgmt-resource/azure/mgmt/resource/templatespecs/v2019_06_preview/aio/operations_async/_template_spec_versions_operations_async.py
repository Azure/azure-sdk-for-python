...
class TemplateSpecVersionsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :type template_spec_version_model: ~azure.mgmt.resource.templatespecs.v2019_06_preview.models.TemplateSpecVersion
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: TemplateSpecVersion, or the result of cls(response)
        :rtype: ~azure.mgmt.resource.templatespecs.v2019_06_preview.models.TemplateSpecVersion
