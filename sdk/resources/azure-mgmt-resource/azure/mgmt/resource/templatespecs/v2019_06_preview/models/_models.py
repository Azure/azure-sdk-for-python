...
class TemplateSpecsListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.templatespecs.v2019_06_preview.models.TemplateSpec]
...
class TemplateSpecVersionsListResult(msrest.serialization.Model):
    ...
    :type value:
     list[~azure.mgmt.resource.templatespecs.v2019_06_preview.models.TemplateSpecVersion]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
