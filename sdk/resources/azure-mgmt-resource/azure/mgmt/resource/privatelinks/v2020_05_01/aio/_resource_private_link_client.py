...
class ResourcePrivateLinkClient:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = ResourcePrivateLinkClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
    ...
    async def __aenter__(self) -> "ResourcePrivateLinkClient":
