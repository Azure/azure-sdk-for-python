...
class PrivateLinkAssociationOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.privatelinks.ResourcePrivateLinkClient`'s
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: ResourcePrivateLinkClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def put(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.privatelinks.models.PrivateLinkAssociationObject
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: PrivateLinkAssociation or the result of cls(response)
        :rtype: ~azure.mgmt.resource.privatelinks.models.PrivateLinkAssociation
    ...
    def put(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.privatelinks.models.PrivateLinkAssociationObject or
         IO[bytes]
        :return: PrivateLinkAssociation or the result of cls(response)
        :rtype: ~azure.mgmt.resource.privatelinks.models.PrivateLinkAssociation
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list(self, group_id: str, **kwargs: Any) -> _models.PrivateLinkAssociationGetResult:
        ...
        :rtype: ~azure.mgmt.resource.privatelinks.models.PrivateLinkAssociationGetResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class ResourceManagementPrivateLinkOperations:
    ...
    def put(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.resource.privatelinks.models.ResourceManagementPrivateLinkLocation
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ResourceManagementPrivateLink or the result of cls(response)
        :rtype: ~azure.mgmt.resource.privatelinks.models.ResourceManagementPrivateLink
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def put(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.resource.privatelinks.models.ResourceManagementPrivateLinkLocation or IO[bytes]
        :return: ResourceManagementPrivateLink or the result of cls(response)
        :rtype: ~azure.mgmt.resource.privatelinks.models.ResourceManagementPrivateLink
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(self, **kwargs: Any) -> _models.ResourceManagementPrivateLinkListResult:
        ...
        :rtype: ~azure.mgmt.resource.privatelinks.models.ResourceManagementPrivateLinkListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
