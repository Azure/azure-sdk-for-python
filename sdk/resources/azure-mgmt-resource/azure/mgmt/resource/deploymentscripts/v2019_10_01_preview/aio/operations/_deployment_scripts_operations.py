...
class DeploymentScriptsOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.resource.deploymentscripts.v2019_10_01_preview.models.DeploymentScript]
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type deployment_script: ~azure.mgmt.resource.deploymentscripts.v2019_10_01_preview.models.DeploymentScriptUpdateParameter
        :keyword callable cls: A custom type or function that will be passed the direct response
