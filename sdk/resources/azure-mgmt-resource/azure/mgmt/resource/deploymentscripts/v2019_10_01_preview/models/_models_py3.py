...
class DeploymentScript(AzureResourceBase):
    ...
    :ivar type: Type of this resource.
    :vartype type: str
    :ivar identity: Required. Managed identity to be used for this deployment script. Currently,
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword identity: Required. Managed identity to be used for this deployment script. Currently,
         only user-assigned MSI is supported.
        :paramtype identity:
         ~azure.mgmt.resource.deploymentscripts.v2019_10_01_preview.models.ManagedServiceIdentity
