...
class DeploymentScript(AzureResourceBase):
    ...
    :ivar type: Type of this resource.
    :vartype type: str
    :param identity: Optional property. Managed identity to be used for this
    ...
    :vartype system_data:
     ~azure.mgmt.resource.deploymentscripts.v2020_10_01.models.SystemData
    ...
    def __init__(self, *, location: str, identity=None, tags=None, **kwargs) -> None:
...
class AzureCliScript(DeploymentScript):
    ...
    :vartype status:
     ~azure.mgmt.resource.deploymentscripts.v2020_10_01.models.ScriptStatus
...
class DeploymentScriptsError(Model):
    ...
    :param error:
    :type error:
     ~azure.mgmt.resource.deploymentscripts.v2020_10_01.models.ErrorResponse
    """
...
class ErrorResponse(Model):
    ...
    :vartype details:
     list[~azure.mgmt.resource.deploymentscripts.v2020_10_01.models.ErrorResponse]
...
class ScriptLogsList(Model):
    ...
    :type value:
     list[~azure.mgmt.resource.deploymentscripts.v2020_10_01.models.ScriptLog]
    """
