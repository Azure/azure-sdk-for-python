...
from ...operations._deployment_scripts_operations import build_create_request_initial, build_delete_request, build_get_logs_default_request, build_get_logs_request, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_update_request
T = TypeVar('T')
...
class DeploymentScriptsOperations:
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DeploymentScriptListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.deploymentscripts.v2020_10_01.models.DeploymentScriptListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_logs_default(
        ...
        **kwargs: Any
        ...
        request = build_get_logs_default_request(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            script_name=script_name,
            tail=tail,
