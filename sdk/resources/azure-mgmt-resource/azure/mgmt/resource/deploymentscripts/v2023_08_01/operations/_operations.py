...
class DeploymentScriptsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.deploymentscripts.v2023_08_01.DeploymentScriptsClient`'s
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type deployment_script:
         ~azure.mgmt.resource.deploymentscripts.v2023_08_01.models.DeploymentScript
        ...
        :return: An instance of LROPoller that returns either DeploymentScript or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.resource.deploymentscripts.v2023_08_01.models.DeploymentScript]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type deployment_script:
         ~azure.mgmt.resource.deploymentscripts.v2023_08_01.models.DeploymentScript or IO[bytes]
        :return: An instance of LROPoller that returns either DeploymentScript or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.resource.deploymentscripts.v2023_08_01.models.DeploymentScript]
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param deployment_script: Deployment script resource with the tags to be updated. Default value
         is None.
        :type deployment_script:
         ~azure.mgmt.resource.deploymentscripts.v2023_08_01.models.DeploymentScriptUpdateParameter
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type deployment_script:
         ~azure.mgmt.resource.deploymentscripts.v2023_08_01.models.DeploymentScriptUpdateParameter or
         IO[bytes]
        :return: DeploymentScript or the result of cls(response)
        :rtype: ~azure.mgmt.resource.deploymentscripts.v2023_08_01.models.DeploymentScript
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.DeploymentScript"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.deploymentscripts.v2023_08_01.models.DeploymentScript]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
