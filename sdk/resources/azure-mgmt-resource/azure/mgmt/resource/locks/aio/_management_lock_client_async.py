...
class ManagementLockClient(MultiApiClientMixin, _SDKClient):
    ...
    def authorization_operations(self):
        """Instance depends on the API version:
           ...
           * 2016-09-01: :class:`AuthorizationOperationsOperations<azure.mgmt.resource.v2016_09_01.aio.operations_async.AuthorizationOperationsOperations>`
        """
        api_version = self._get_api_version('authorization_operations')
        if api_version == '2016-09-01':
            from ..v2016_09_01.aio.operations_async import AuthorizationOperationsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
    ...
    def management_locks(self):
        """Instance depends on the API version:
           ...
           * 2015-01-01: :class:`ManagementLocksOperations<azure.mgmt.resource.v2015_01_01.aio.operations_async.ManagementLocksOperations>`
           * 2016-09-01: :class:`ManagementLocksOperations<azure.mgmt.resource.v2016_09_01.aio.operations_async.ManagementLocksOperations>`
        """
        api_version = self._get_api_version('management_locks')
        if api_version == '2015-01-01':
            from ..v2015_01_01.aio.operations_async import ManagementLocksOperations as OperationClass
        elif api_version == '2016-09-01':
            from ..v2016_09_01.aio.operations_async import ManagementLocksOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self._config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
