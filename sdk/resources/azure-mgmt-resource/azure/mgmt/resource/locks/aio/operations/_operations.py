...
class AuthorizationOperationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.locks.aio.ManagementLockClient`'s
    ...
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.Operation"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.locks.models.Operation]
...
class ManagementLocksOperations:
    ...
    def list_at_resource_group_level(
        ...
        :return: An iterator like instance of either ManagementLockObject or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.locks.models.ManagementLockObject]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
