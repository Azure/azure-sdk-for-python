...
class ManagementLockClient:
    ...
    :vartype authorization_operations:
     azure.mgmt.resource.locks.aio.operations.AuthorizationOperationsOperations
    :ivar management_locks: ManagementLocksOperations operations
    :vartype management_locks: azure.mgmt.resource.locks.aio.operations.ManagementLocksOperations
