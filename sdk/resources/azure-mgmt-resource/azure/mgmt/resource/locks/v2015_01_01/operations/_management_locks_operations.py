...
def build_create_or_update_at_resource_group_level_request(
...
def build_delete_at_resource_group_level_request(
    resource_group_name: str,
    lock_name: str,
    subscription_id: str,
    **kwargs: Any
...
def build_get_at_resource_group_level_request(
    resource_group_name: str,
    lock_name: str,
    subscription_id: str,
    **kwargs: Any
...
def build_create_or_update_at_resource_level_request(
    resource_group_name: str,
...
def build_delete_at_resource_level_request(
    resource_group_name: str,
    resource_provider_namespace: str,
    parent_resource_path: str,
    resource_type: str,
...
def build_create_or_update_at_subscription_level_request(
    lock_name: str,
    subscription_id: str,
    *,
    json: JSONType = None,
...
def build_delete_at_subscription_level_request(
    lock_name: str,
    subscription_id: str,
    **kwargs: Any
) -> HttpRequest:
...
def build_list_at_resource_group_level_request(
    resource_group_name: str,
    subscription_id: str,
    *,
...
def build_list_at_resource_level_request(
    resource_group_name: str,
    resource_provider_namespace: str,
    parent_resource_path: str,
    resource_type: str,
...
def build_list_at_subscription_level_request(
    subscription_id: str,
    *,
    filter: Optional[str] = None,
    **kwargs: Any
    ...
    def list_at_resource_group_level(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ManagementLockListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.locks.v2015_01_01.models.ManagementLockListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2015-01-01")  # type: str
