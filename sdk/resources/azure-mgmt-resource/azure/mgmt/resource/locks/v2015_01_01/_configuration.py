...
class ManagementLockClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super(ManagementLockClientConfiguration, self).__init__(**kwargs)
