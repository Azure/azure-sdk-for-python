...
class PolicyAssignmentsOperations:
    ...
    def delete(self, scope: str, policy_assignment_name: str, **kwargs: Any) -> _models.PolicyAssignment:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2015-10-01-preview")
        )
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.policy.v2015_10_01_preview.models.PolicyAssignment or
         IO[bytes]
        :return: PolicyAssignment or the result of cls(response)
        :rtype: ~azure.mgmt.resource.policy.v2015_10_01_preview.models.PolicyAssignment
        :raises ~azure.core.exceptions.HttpResponseError:
...
class PolicyDefinitionsOperations:
    ...
    def create_or_update(
        ...
        :param parameters: The policy definition properties. Is either a PolicyDefinition type or a
         IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.resource.policy.v2015_10_01_preview.models.PolicyDefinition or
         IO[bytes]
        :return: PolicyDefinition or the result of cls(response)
        :rtype: ~azure.mgmt.resource.policy.v2015_10_01_preview.models.PolicyDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
