...
class PolicyAssignmentListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.policy.v2015_10_01_preview.models.PolicyAssignment]
...
class PolicyDefinitionListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.policy.v2015_10_01_preview.models.PolicyDefinition]
    :param next_link: The URL to use for getting the next set of results.
    :type next_link: str
    """
