...
class PolicyExemptionsOperations(object):
    ...
    def delete(
        self,
        scope,  # type: str
        policy_exemption_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> None
    ...
    def create_or_update(
        ...
        scope,  # type: str
        policy_exemption_name,  # type: str
        parameters,  # type: "_models.PolicyExemption"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.PolicyExemption"
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.PolicyExemptionListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.resource.policy.v2020_09_01.models.PolicyExemptionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
