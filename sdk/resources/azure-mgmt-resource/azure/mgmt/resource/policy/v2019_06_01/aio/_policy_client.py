...
class PolicyClient:
    ...
    :vartype policy_assignments:
     azure.mgmt.resource.policy.v2019_06_01.aio.operations.PolicyAssignmentsOperations
    :ivar policy_definitions: PolicyDefinitionsOperations operations
    :vartype policy_definitions:
     azure.mgmt.resource.policy.v2019_06_01.aio.operations.PolicyDefinitionsOperations
    :ivar policy_set_definitions: PolicySetDefinitionsOperations operations
    :vartype policy_set_definitions:
     azure.mgmt.resource.policy.v2019_06_01.aio.operations.PolicySetDefinitionsOperations
