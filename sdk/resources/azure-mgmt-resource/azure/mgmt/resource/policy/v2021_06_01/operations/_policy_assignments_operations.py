...
class PolicyAssignmentsOperations(object):
    ...
    def update(
        ...
        scope,  # type: str
        policy_assignment_name,  # type: str
        parameters,  # type: "_models.PolicyAssignmentUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.PolicyAssignment"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'PolicyAssignmentUpdate')
        body_content_kwargs['content'] = body_content
    ...
    def list_for_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.resource.policy.v2021_06_01.models.PolicyAssignmentListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
