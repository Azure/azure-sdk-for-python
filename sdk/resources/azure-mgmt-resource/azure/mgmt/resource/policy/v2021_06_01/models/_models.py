...
class Identity(msrest.serialization.Model):
    ...
    :param type: The identity type. This is the only required field when adding a system or user
     assigned identity to a resource. Possible values include: "SystemAssigned", "UserAssigned",
     "None".
    :type type: str or ~azure.mgmt.resource.policy.v2021_06_01.models.ResourceIdentityType
    :param user_assigned_identities: The user identity associated with the policy. The user
...
class ParameterDefinitionsValue(msrest.serialization.Model):
    ...
    :type type: str or ~azure.mgmt.resource.policy.v2021_06_01.models.ParameterType
...
class PolicyAssignment(msrest.serialization.Model):
    ...
    :type identity: ~azure.mgmt.resource.policy.v2021_06_01.models.Identity
    ...
    :type enforcement_mode: str or ~azure.mgmt.resource.policy.v2021_06_01.models.EnforcementMode
...
class PolicyAssignmentListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.policy.v2021_06_01.models.PolicyAssignment]
    :param next_link: The URL to use for getting the next set of results.
    :type next_link: str
    """
...
class PolicyDefinition(msrest.serialization.Model):
    ...
    :type policy_type: str or ~azure.mgmt.resource.policy.v2021_06_01.models.PolicyType
...
class PolicyDefinitionListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.policy.v2021_06_01.models.PolicyDefinition]
    :param next_link: The URL to use for getting the next set of results.
    :type next_link: str
    """
...
class PolicyExemptionListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.policy.v2021_06_01.models.PolicyExemption]
...
class PolicySetDefinitionListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.policy.v2021_06_01.models.PolicySetDefinition]
    :param next_link: The URL to use for getting the next set of results.
    :type next_link: str
    """
...
class ResourceTypeAliases(msrest.serialization.Model):
    ...
    :type aliases: list[~azure.mgmt.resource.policy.v2021_06_01.models.Alias]
    """
...
class SystemData(msrest.serialization.Model):
    ...
    :type created_by_type: str or ~azure.mgmt.resource.policy.v2021_06_01.models.CreatedByType
