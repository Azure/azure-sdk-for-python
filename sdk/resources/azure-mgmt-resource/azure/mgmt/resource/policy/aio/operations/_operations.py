...
class PolicyTokensOperations:
    ...
    async def begin_acquire(
    ...
    ) -> AsyncLROPoller[_models.PolicyTokenResponse]:
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either PolicyTokenResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.resource.policy.models.PolicyTokenResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_acquire(
        ...
        if cont_token:
            return AsyncLROPoller[_models.PolicyTokenResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.PolicyTokenResponse](
