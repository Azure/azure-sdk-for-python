...
class PolicyClient(MultiApiClientMixin, _SDKClient):
    ...
    def data_policy_manifests(self):
        """Instance depends on the API version:
           ...
           * 2022-06-01: :class:`DataPolicyManifestsOperations<azure.mgmt.resource.policy.v2022_06_01.aio.operations.DataPolicyManifestsOperations>`
        """
        ...
        if api_version == '2020-09-01':
            ...
            from ..v2022_06_01.aio.operations import DataPolicyManifestsOperations as OperationClass
        else:
    ...
    def policy_definitions(self):
        """Instance depends on the API version:
           ...
           * 2022-06-01: :class:`PolicyDefinitionsOperations<azure.mgmt.resource.policy.v2022_06_01.aio.operations.PolicyDefinitionsOperations>`
        """
        ...
        if api_version == '2015-10-01-preview':
            ...
            from ..v2022_06_01.aio.operations import PolicyDefinitionsOperations as OperationClass
        else:
    ...
    def policy_exemptions(self):
        """Instance depends on the API version:
           ...
           * 2022-06-01: :class:`PolicyExemptionsOperations<azure.mgmt.resource.policy.v2022_06_01.aio.operations.PolicyExemptionsOperations>`
        """
        ...
        if api_version == '2020-09-01':
            ...
            from ..v2022_06_01.aio.operations import PolicyExemptionsOperations as OperationClass
        else:
    ...
    def policy_set_definitions(self):
        """Instance depends on the API version:
           ...
           * 2022-06-01: :class:`PolicySetDefinitionsOperations<azure.mgmt.resource.policy.v2022_06_01.aio.operations.PolicySetDefinitionsOperations>`
        """
        ...
        if api_version == '2017-06-01-preview':
            ...
            from ..v2022_06_01.aio.operations import PolicySetDefinitionsOperations as OperationClass
        else:
    ...
    def variable_values(self):
        """Instance depends on the API version:
           ...
           * 2022-06-01: :class:`VariableValuesOperations<azure.mgmt.resource.policy.v2022_06_01.aio.operations.VariableValuesOperations>`
        """
        ...
        if api_version == '2021-06-01':
            ...
            from ..v2022_06_01.aio.operations import VariableValuesOperations as OperationClass
        else:
    ...
    def variables(self):
        """Instance depends on the API version:
           ...
           * 2022-06-01: :class:`VariablesOperations<azure.mgmt.resource.policy.v2022_06_01.aio.operations.VariablesOperations>`
        """
        api_version = self._get_api_version('variables')
        if api_version == '2021-06-01':
            from ..v2021_06_01.aio.operations import VariablesOperations as OperationClass
        elif api_version == '2022-06-01':
            from ..v2022_06_01.aio.operations import VariablesOperations as OperationClass
        else:
