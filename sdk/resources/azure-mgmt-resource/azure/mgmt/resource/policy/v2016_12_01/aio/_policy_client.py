...
class PolicyClient:
    ...
    :vartype policy_definitions:
     azure.mgmt.resource.policy.v2016_12_01.aio.operations.PolicyDefinitionsOperations
    :ivar policy_assignments: PolicyAssignmentsOperations operations
    :vartype policy_assignments:
     azure.mgmt.resource.policy.v2016_12_01.aio.operations.PolicyAssignmentsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.policy_definitions = PolicyDefinitionsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2016-12-01"
        )
