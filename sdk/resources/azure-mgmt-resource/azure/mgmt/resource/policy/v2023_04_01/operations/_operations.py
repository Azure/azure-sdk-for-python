...
def build_policy_definition_versions_create_or_update_request(  # pylint: disable=name-too-long
    subscription_id: str, policy_definition_name: str, policy_definition_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_policy_definition_versions_list_request(  # pylint: disable=name-too-long
    subscription_id: str, policy_definition_name: str, *, top: Optional[int] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_policy_set_definition_versions_create_or_update_request(  # pylint: disable=name-too-long
    subscription_id: str, policy_set_definition_name: str, policy_definition_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_policy_set_definition_versions_list_request(  # pylint: disable=name-too-long
    subscription_id: str, policy_set_definition_name: str, *, top: Optional[int] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PolicyDefinitionVersionsOperations:
    ...
    @overload
    def create_or_update(
        self, parameters: _models.PolicyDefinitionVersion, *, content_type: str = "application/json", **kwargs: Any
    ...
    @distributed_trace
    def create_or_update(
        self, parameters: Union[_models.PolicyDefinitionVersion, IO[bytes]], **kwargs: Any
    ) -> _models.PolicyDefinitionVersion:
        """Creates or updates a policy definition in a subscription.
        ...
        _request = build_policy_definition_versions_create_or_update_request(
            subscription_id=self._config.subscription_id,
            policy_definition_name=self._config.policy_definition_name,
            policy_definition_version=self._config.policy_definition_version,
            api_version=api_version,
            content_type=content_type,
            json=_json,
            content=_content,
        ...
        if response.status_code == 200:
            deserialized = self._deserialize("PolicyDefinitionVersion", pipeline_response)
    ...
    @distributed_trace
    def get(self, **kwargs: Any) -> _models.PolicyDefinitionVersion:
    ...
    @distributed_trace
    def get_built_in(self, **kwargs: Any) -> _models.PolicyDefinitionVersion:
    ...
    @distributed_trace
    def create_or_update_at_management_group(
        self, management_group_name: str, parameters: Union[_models.PolicyDefinitionVersion, IO[bytes]], **kwargs: Any
    ) -> _models.PolicyDefinitionVersion:
        """Creates or updates a policy definition version in a management group.
    ...
    @distributed_trace
    def get_at_management_group(self, management_group_name: str, **kwargs: Any) -> _models.PolicyDefinitionVersion:
    ...
    @distributed_trace
    def list(self, top: Optional[int] = None, **kwargs: Any) -> Iterable["_models.PolicyDefinitionVersion"]:
    ...
    @distributed_trace
    def list_built_in(self, top: Optional[int] = None, **kwargs: Any) -> Iterable["_models.PolicyDefinitionVersion"]:
    ...
    @distributed_trace
    def list_by_management_group(
        self, management_group_name: str, top: Optional[int] = None, **kwargs: Any
    ) -> Iterable["_models.PolicyDefinitionVersion"]:
...
class PolicySetDefinitionVersionsOperations:
    ...
    @overload
    def create_or_update(
        self, parameters: _models.PolicySetDefinitionVersion, *, content_type: str = "application/json", **kwargs: Any
    ...
    @distributed_trace
    def create_or_update(
        self, parameters: Union[_models.PolicySetDefinitionVersion, IO[bytes]], **kwargs: Any
    ) -> _models.PolicySetDefinitionVersion:
        """Creates or updates a policy set definition version.
        ...
        _request = build_policy_set_definition_versions_create_or_update_request(
            subscription_id=self._config.subscription_id,
            policy_set_definition_name=self._config.policy_set_definition_name,
            policy_definition_version=self._config.policy_definition_version,
            api_version=api_version,
            content_type=content_type,
            json=_json,
        ...
        if response.status_code == 200:
            deserialized = self._deserialize("PolicySetDefinitionVersion", pipeline_response)
    ...
    @distributed_trace
    def get(self, **kwargs: Any) -> _models.PolicySetDefinitionVersion:
    ...
    @distributed_trace
    def get_built_in(self, **kwargs: Any) -> _models.PolicySetDefinitionVersion:
    ...
    @distributed_trace
    def list(self, top: Optional[int] = None, **kwargs: Any) -> Iterable["_models.PolicySetDefinitionVersion"]:
    ...
    @distributed_trace
    def list_built_in(self, top: Optional[int] = None, **kwargs: Any) -> Iterable["_models.PolicySetDefinitionVersion"]:
    ...
    @distributed_trace
    def get_at_management_group(self, management_group_name: str, **kwargs: Any) -> _models.PolicySetDefinitionVersion:
        """Retrieves a policy set definition version.
