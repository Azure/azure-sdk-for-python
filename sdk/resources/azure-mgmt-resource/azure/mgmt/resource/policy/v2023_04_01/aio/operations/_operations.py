...
class PolicyDefinitionsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.policy.v2023_04_01.aio.PolicyClient`'s
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.policy.v2023_04_01.models.PolicyDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PolicyDefinitionVersionsOperations:
    ...
    @distributed_trace_async
    async def get(self, **kwargs: Any) -> _models.PolicyDefinitionVersion:
    ...
    @distributed_trace_async
    async def get_built_in(self, **kwargs: Any) -> _models.PolicyDefinitionVersion:
    ...
    @distributed_trace
    def list(self, top: Optional[int] = None, **kwargs: Any) -> AsyncIterable["_models.PolicyDefinitionVersion"]:
        ...
        :return: An iterator like instance of either PolicyDefinitionVersion or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.policy.v2023_04_01.models.PolicyDefinitionVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    ) -> AsyncIterable["_models.PolicyDefinitionVersion"]:
...
class PolicySetDefinitionsOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.policy.v2023_04_01.models.PolicySetDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PolicySetDefinitionVersionsOperations:
    ...
    @distributed_trace_async
    async def get(self, **kwargs: Any) -> _models.PolicySetDefinitionVersion:
    ...
    @distributed_trace_async
    async def get_built_in(self, **kwargs: Any) -> _models.PolicySetDefinitionVersion:
    ...
    @distributed_trace
    def list(self, top: Optional[int] = None, **kwargs: Any) -> AsyncIterable["_models.PolicySetDefinitionVersion"]:
        ...
        :return: An iterator like instance of either PolicySetDefinitionVersion or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.policy.v2023_04_01.models.PolicySetDefinitionVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PolicyAssignmentsOperations:
    ...
    def list_for_resource_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.policy.v2023_04_01.models.PolicyAssignment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
