...
def build_policy_assignments_delete_request(scope: str, policy_assignment_name: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version = kwargs.pop("api_version", _params.pop("api-version", "2018-05-01"))  # type: str
...
class PolicyAssignmentsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.policy.v2018_05_01.PolicyClient`'s
    ...
    def create(
        ...
        :param parameters: Parameters for the policy assignment. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.resource.policy.v2018_05_01.models.PolicyAssignment or IO
    ...
    def list_for_resource_group(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.policy.v2018_05_01.models.PolicyAssignment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PolicyDefinitionsOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.policy.v2018_05_01.models.PolicyDefinition
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def create_or_update(
        ...
        :param parameters: The policy definition properties. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.resource.policy.v2018_05_01.models.PolicyDefinition or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.PolicyDefinition"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.policy.v2018_05_01.models.PolicyDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PolicySetDefinitionsOperations:
    ...
    def create_or_update(
        ...
        :param parameters: The policy set definition properties. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.resource.policy.v2018_05_01.models.PolicySetDefinition or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.PolicySetDefinition"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.policy.v2018_05_01.models.PolicySetDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
