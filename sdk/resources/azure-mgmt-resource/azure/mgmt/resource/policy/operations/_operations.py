...
class PolicyTokensOperations:
    ...
    def begin_acquire(
    ...
    ) -> LROPoller[_models.PolicyTokenResponse]:
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either PolicyTokenResponse or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.resource.policy.models.PolicyTokenResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_acquire(
        ...
        if cont_token:
            return LROPoller[_models.PolicyTokenResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.PolicyTokenResponse](
