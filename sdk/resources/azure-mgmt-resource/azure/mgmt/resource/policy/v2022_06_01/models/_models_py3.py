...
class Alias(_serialization.Model):
    ...
    :vartype paths: list[~azure.mgmt.resource.policy.v2022_06_01.models.AliasPath]
    :ivar type: The type of the alias. Known values are: "NotSpecified", "PlainText", and "Mask".
    :vartype type: str or ~azure.mgmt.resource.policy.v2022_06_01.models.AliasType
    ...
    :vartype default_pattern: ~azure.mgmt.resource.policy.v2022_06_01.models.AliasPattern
    ...
    :vartype default_metadata: ~azure.mgmt.resource.policy.v2022_06_01.models.AliasPathMetadata
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype paths: list[~azure.mgmt.resource.policy.v2022_06_01.models.AliasPath]
        :keyword type: The type of the alias. Known values are: "NotSpecified", "PlainText", and
         "Mask".
        :paramtype type: str or ~azure.mgmt.resource.policy.v2022_06_01.models.AliasType
        ...
        :paramtype default_pattern: ~azure.mgmt.resource.policy.v2022_06_01.models.AliasPattern
        """
...
class AliasPath(_serialization.Model):
    ...
    :vartype pattern: ~azure.mgmt.resource.policy.v2022_06_01.models.AliasPattern
    :ivar metadata: The metadata of the alias path. If missing, fall back to the default metadata
     of the alias.
    :vartype metadata: ~azure.mgmt.resource.policy.v2022_06_01.models.AliasPathMetadata
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype pattern: ~azure.mgmt.resource.policy.v2022_06_01.models.AliasPattern
        """
        super().__init__(**kwargs)
        self.path = path
...
class AliasPathMetadata(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.resource.policy.v2022_06_01.models.AliasPathTokenType
    :ivar attributes: The attributes of the token that the alias path is referring to. Known values
     are: "None" and "Modifiable".
    :vartype attributes: str or ~azure.mgmt.resource.policy.v2022_06_01.models.AliasPathAttributes
    """
...
class AliasPattern(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.resource.policy.v2022_06_01.models.AliasPatternType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype type: str or ~azure.mgmt.resource.policy.v2022_06_01.models.AliasPatternType
        """
        super().__init__(**kwargs)
        self.phrase = phrase
...
class DataPolicyManifest(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype resource_type_aliases:
     list[~azure.mgmt.resource.policy.v2022_06_01.models.ResourceTypeAliases]
    :ivar effects: The effect definition.
    :vartype effects: list[~azure.mgmt.resource.policy.v2022_06_01.models.DataEffect]
    ...
    :vartype custom:
     list[~azure.mgmt.resource.policy.v2022_06_01.models.DataManifestCustomResourceFunctionDefinition]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype effects: list[~azure.mgmt.resource.policy.v2022_06_01.models.DataEffect]
...
class DataPolicyManifestListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.resource.policy.v2022_06_01.models.DataPolicyManifest]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.resource.policy.v2022_06_01.models.DataPolicyManifest]
...
class ParameterDefinitionsValue(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.resource.policy.v2022_06_01.models.ParameterType
    ...
    :vartype metadata:
     ~azure.mgmt.resource.policy.v2022_06_01.models.ParameterDefinitionsValueMetadata
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The data type of the parameter. Known values are: "String", "Array", "Object",
         "Boolean", "Integer", "Float", and "DateTime".
        :paramtype type: str or ~azure.mgmt.resource.policy.v2022_06_01.models.ParameterType
...
class PolicyDefinition(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype policy_type: str or ~azure.mgmt.resource.policy.v2022_06_01.models.PolicyType
    ...
    :vartype parameters: dict[str,
     ~azure.mgmt.resource.policy.v2022_06_01.models.ParameterDefinitionsValue]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword policy_type: The type of policy definition. Possible values are NotSpecified, BuiltIn,
         Custom, and Static. Known values are: "NotSpecified", "BuiltIn", "Custom", and "Static".
        :paramtype policy_type: str or ~azure.mgmt.resource.policy.v2022_06_01.models.PolicyType
...
class PolicyDefinitionListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.resource.policy.v2022_06_01.models.PolicyDefinition]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.resource.policy.v2022_06_01.models.PolicyDefinition]
        :keyword next_link: The URL to use for getting the next set of results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class PolicyExemption(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype exemption_category: str or
     ~azure.mgmt.resource.policy.v2022_06_01.models.ExemptionCategory
    ...
    :vartype assignment_scope_validation: str or
     ~azure.mgmt.resource.policy.v2022_06_01.models.AssignmentScopeValidation
    """
...
class PolicyExemptionListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.resource.policy.v2022_06_01.models.PolicyExemption]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: Optional[List["_models.PolicyExemption"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.resource.policy.v2022_06_01.models.PolicyExemption]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class PolicySetDefinition(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype policy_definitions:
     list[~azure.mgmt.resource.policy.v2022_06_01.models.PolicyDefinitionReference]
    ...
    :vartype policy_definition_groups:
     list[~azure.mgmt.resource.policy.v2022_06_01.models.PolicyDefinitionGroup]
    """
...
class PolicySetDefinitionListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.resource.policy.v2022_06_01.models.PolicySetDefinition]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.resource.policy.v2022_06_01.models.PolicySetDefinition]
        :keyword next_link: The URL to use for getting the next set of results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ResourceTypeAliases(_serialization.Model):
    ...
    :vartype aliases: list[~azure.mgmt.resource.policy.v2022_06_01.models.Alias]
    """
    ...
    def __init__(
        ...
        :paramtype aliases: list[~azure.mgmt.resource.policy.v2022_06_01.models.Alias]
        """
        super().__init__(**kwargs)
...
class Variable(_serialization.Model):
    ...
    :vartype columns: list[~azure.mgmt.resource.policy.v2022_06_01.models.PolicyVariableColumn]
    """
    ...
    def __init__(self, *, columns: List["_models.PolicyVariableColumn"], **kwargs: Any) -> None:
        ...
        :paramtype columns: list[~azure.mgmt.resource.policy.v2022_06_01.models.PolicyVariableColumn]
        """
        super().__init__(**kwargs)
        self.system_data = None
        self.id = None
...
class VariableListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.resource.policy.v2022_06_01.models.Variable]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: Optional[List["_models.Variable"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.resource.policy.v2022_06_01.models.Variable]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class VariableValue(_serialization.Model):
    ...
    :vartype values:
     list[~azure.mgmt.resource.policy.v2022_06_01.models.PolicyVariableValueColumnValue]
    """
...
class VariableValueListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.resource.policy.v2022_06_01.models.VariableValue]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: Optional[List["_models.VariableValue"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.resource.policy.v2022_06_01.models.VariableValue]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
