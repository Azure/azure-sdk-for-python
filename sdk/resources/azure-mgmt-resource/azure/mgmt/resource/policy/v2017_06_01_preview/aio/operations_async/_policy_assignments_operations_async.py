...
class PolicyAssignmentsOperations:
    ...
    def list_for_resource_group(
        ...
        **kwargs
    ) -> "models.PolicyAssignmentListResult":
        ...
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PolicyAssignmentListResult or the result of cls(response)
        :rtype: ~azure.mgmt.resource.policy.v2017_06_01_preview.models.PolicyAssignmentListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
