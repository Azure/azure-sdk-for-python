...
class PolicyAssignmentsOperations:
    ...
    @distributed_trace
    def list(self, filter: Optional[str] = None, **kwargs: Any) -> ItemPaged["_models.PolicyAssignment"]:
...
class PolicySetDefinitionsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.PolicySetDefinition"]:
    ...
    @distributed_trace
    def list_built_in(self, **kwargs: Any) -> ItemPaged["_models.PolicySetDefinition"]:
