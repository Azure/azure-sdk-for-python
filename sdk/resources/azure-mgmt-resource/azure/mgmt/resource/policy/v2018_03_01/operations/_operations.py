...
def build_policy_assignments_delete_request(
    ...
    **kwargs: Any
    ...
    api_version = kwargs.pop('api_version', "2018-03-01")  # type: str
...
class PolicyAssignmentsOperations(object):
    ...
    :type models: ~azure.mgmt.resource.policy.v2018_03_01.models
    ...
    def list_for_resource_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PolicyAssignmentListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.policy.v2018_03_01.models.PolicyAssignmentListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-03-01")  # type: str
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PolicyDefinitionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.policy.v2018_03_01.models.PolicyDefinitionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-03-01")  # type: str
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PolicySetDefinitionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.policy.v2018_03_01.models.PolicySetDefinitionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-03-01")  # type: str
