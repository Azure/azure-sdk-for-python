...
def build_policy_definitions_list_built_in_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_policy_set_definitions_list_built_in_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PolicyAssignmentsOperations:
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.policy.v2018_03_01.models.PolicyAssignment or IO[bytes]
        :return: PolicyAssignment or the result of cls(response)
        :rtype: ~azure.mgmt.resource.policy.v2018_03_01.models.PolicyAssignment
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class PolicyDefinitionsOperations:
    ...
    def create_or_update(
        ...
        :param parameters: The policy definition properties. Is either a PolicyDefinition type or a
         IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.resource.policy.v2018_03_01.models.PolicyDefinition or IO[bytes]
        :return: PolicyDefinition or the result of cls(response)
        :rtype: ~azure.mgmt.resource.policy.v2018_03_01.models.PolicyDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class PolicySetDefinitionsOperations:
    ...
    def create_or_update(
        ...
        :type parameters: ~azure.mgmt.resource.policy.v2018_03_01.models.PolicySetDefinition or
         IO[bytes]
        :return: PolicySetDefinition or the result of cls(response)
        :rtype: ~azure.mgmt.resource.policy.v2018_03_01.models.PolicySetDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
