...
class PolicyAssignmentsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.policy.v2018_03_01.aio.PolicyClient`'s
...
class PolicyDefinitionsOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.PolicyDefinition"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.policy.v2018_03_01.models.PolicyDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PolicySetDefinitionsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.PolicySetDefinition"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.policy.v2018_03_01.models.PolicySetDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_built_in(self, **kwargs: Any) -> AsyncItemPaged["_models.PolicySetDefinition"]:
