...
class DeploymentsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_create_or_update_at_scope(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either DeploymentExtended or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.resource.resources.models.DeploymentExtended]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_validate_at_scope(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either DeploymentValidateResult or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.resource.resources.models.DeploymentValidateResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_at_scope(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.resources.models.DeploymentExtended]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_what_if_at_tenant_scope(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either WhatIfOperationResult or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.resource.resources.models.WhatIfOperationResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class DeploymentOperationsOperations:
    ...
    def list_at_scope(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.resources.models.DeploymentOperation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
