...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.resources.v2025_04_01.ResourceManagementClient`'s
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: ResourceManagementClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def list(self, **kwargs: Any) -> ItemPaged["_models.Operation"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.resources.v2025_04_01.models.Operation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._api_version or "2025-04-01"))
...
class ProvidersOperations:
    ...
    def unregister(self, resource_provider_namespace: str, **kwargs: Any) -> _models.Provider:
        ...
        :rtype: ~azure.mgmt.resource.resources.v2025_04_01.models.Provider
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def provider_permissions(
        ...
        :rtype: ~azure.mgmt.resource.resources.v2025_04_01.models.ProviderPermissionListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def register(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.resource.resources.v2025_04_01.models.ProviderRegistrationRequest
    ...
    @distributed_trace
    def list(self, expand: Optional[str] = None, **kwargs: Any) -> ItemPaged["_models.Provider"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.resources.v2025_04_01.models.Provider]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_at_tenant_scope(self, expand: Optional[str] = None, **kwargs: Any) -> ItemPaged["_models.Provider"]:
...
class ProviderResourceTypesOperations:
    ...
    def list(
        ...
        :rtype: ~azure.mgmt.resource.resources.v2025_04_01.models.ProviderResourceTypeListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class ResourcesOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_by_resource_group(
        ...
        top: Optional[int] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.GenericResourceExpanded"]:
        ...
        :return: An iterator like instance of either GenericResourceExpanded or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.resources.v2025_04_01.models.GenericResourceExpanded]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_move_resources(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.ResourcesMoveInfo
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    def begin_move_resources(
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.ResourcesMoveInfo or
         IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list(
        ...
        :param filter: The filter to apply on the operation.\\ :code:`<br>`\\ :code:`<br>`Filter
         comparison operators include ``eq`` (equals) and ``ne`` (not equals) and may be used with the
         ...
         :code:`<br>`\\ :code:`<br>`For example, to filter by a resource type, use
         ``$filter=resourceType eq 'Microsoft.Network/virtualNetworks'``\\ :code:`<br>`\\ :code:`<br>`\\
         :code:`<br>`\\ ``substringof(value, property)`` can  be used to filter for substrings of the
         following currently-supported properties: ``name`` and ``resourceGroup``\\ :code:`<br>`\\
         :code:`<br>`For example, to get all resources with 'demo' anywhere in the resource name, use
         ``$filter=substringof('demo', name)``\\ :code:`<br>`\\ :code:`<br>`Multiple substring
         operations can also be combined using ``and``\\ /\\ ``or`` operators.\\ :code:`<br>`\\
         :code:`<br>`Note that any truncated number of results queried via ``$top`` may also not be
         compatible when using a filter.\\ :code:`<br>`\\ :code:`<br>`\\ :code:`<br>`Resources can be
         filtered by tag names and values. For example, to filter for a tag name and value, use
         ``$filter=tagName eq 'tag1' and tagValue eq 'Value1'``. Note that when resources are filtered
         by tag name and value, :code:`<b>the original tags for each resource will not be returned in
         the results.</b>` Any list of additional properties queried via ``$expand`` may also not be
         compatible when filtering by tag names/values. :code:`<br>`\\ :code:`<br>`For tag names only,
         resources can be filtered by prefix using the following syntax: ``$filter=startswith(tagName,
         'depart')``. This query will return all resources with a tag name prefixed by the phrase
         ``depart`` (i.e.\\ ``department``\\ , ``departureDate``\\ , ``departureTime``\\ , etc.)\\
         :code:`<br>`\\ :code:`<br>`\\ :code:`<br>`Note that some properties can be combined when
         filtering resources, which include the following: ``substringof() and/or resourceType``\\ ,
         ``plan and plan/publisher and plan/name``\\ , and ``identity and identity/principalId``.
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.GenericResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GenericResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.resource.resources.v2025_04_01.models.GenericResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.GenericResource or
         IO[bytes]
        :return: An instance of LROPoller that returns either GenericResource or the result of
         cls(response)
        :rtype:
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.resource.resources.v2025_04_01.models.GenericResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class ResourceGroupsOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.ResourceGroup
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ResourceGroup or the result of cls(response)
        :rtype: ~azure.mgmt.resource.resources.v2025_04_01.models.ResourceGroup
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def create_or_update(
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.ResourceGroup or IO[bytes]
        :return: ResourceGroup or the result of cls(response)
        :rtype: ~azure.mgmt.resource.resources.v2025_04_01.models.ResourceGroup
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.ResourceGroupPatchable
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ResourceGroup or the result of cls(response)
    ...
    def update(
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.ResourceGroupPatchable or
         IO[bytes]
        :return: ResourceGroup or the result of cls(response)
        :rtype: ~azure.mgmt.resource.resources.v2025_04_01.models.ResourceGroup
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_export_template(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.ExportTemplateRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either ResourceGroupExportResult or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.resource.resources.v2025_04_01.models.ResourceGroupExportResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_export_template(
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.ExportTemplateRequest or
         IO[bytes]
        :return: An instance of LROPoller that returns either ResourceGroupExportResult or the result
         of cls(response)
        :rtype:
    ...
    def list(
    ...
    ) -> ItemPaged["_models.ResourceGroup"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.resources.v2025_04_01.models.ResourceGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class TagsOperations:
    ...
    def create_or_update_value(self, tag_name: str, tag_value: str, **kwargs: Any) -> _models.TagValue:
        ...
        :rtype: ~azure.mgmt.resource.resources.v2025_04_01.models.TagValue
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create_or_update(self, tag_name: str, **kwargs: Any) -> _models.TagDetails:
        ...
        :rtype: ~azure.mgmt.resource.resources.v2025_04_01.models.TagDetails
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.TagDetails"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.resources.v2025_04_01.models.TagDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_create_or_update_at_scope(
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.TagsResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either TagsResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.resource.resources.v2025_04_01.models.TagsResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update_at_scope(
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.TagsResource or IO[bytes]
        :return: An instance of LROPoller that returns either TagsResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.resource.resources.v2025_04_01.models.TagsResource]
    ...
    def begin_update_at_scope(
        ...
        **kwargs: Any
        ...
        :type scope: str
        :param parameters: Required.
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.TagsPatchResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either TagsResource or the result of
    ...
    def begin_update_at_scope(
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.TagsPatchResource or
         IO[bytes]
        :return: An instance of LROPoller that returns either TagsResource or the result of
         cls(response)
        :rtype:
    ...
    def get_at_scope(self, scope: str, **kwargs: Any) -> _models.TagsResource:
        ...
        :rtype: ~azure.mgmt.resource.resources.v2025_04_01.models.TagsResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class DeploymentsOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_create_or_update_at_scope(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.Deployment
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either DeploymentExtended or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.resource.resources.v2025_04_01.models.DeploymentExtended]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update_at_scope(
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.Deployment or IO[bytes]
        :return: An instance of LROPoller that returns either DeploymentExtended or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.resource.resources.v2025_04_01.models.DeploymentExtended]
    ...
    def get_at_scope(self, scope: str, deployment_name: str, **kwargs: Any) -> _models.DeploymentExtended:
        ...
        :rtype: ~azure.mgmt.resource.resources.v2025_04_01.models.DeploymentExtended
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_validate_at_scope(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either DeploymentValidateResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.resource.resources.v2025_04_01.models.DeploymentValidateResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def export_template_at_scope(
        ...
        :rtype: ~azure.mgmt.resource.resources.v2025_04_01.models.DeploymentExportResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_at_scope(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.resources.v2025_04_01.models.DeploymentExtended]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_create_or_update_at_tenant_scope(
        ...
        **kwargs: Any
        ...
        :type deployment_name: str
        :param parameters: Additional parameters supplied to the operation. Required.
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.ScopedDeployment
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either DeploymentExtended or the result of
    ...
    def begin_create_or_update_at_tenant_scope(
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.ScopedDeployment or
         IO[bytes]
        :return: An instance of LROPoller that returns either DeploymentExtended or the result of
         cls(response)
        :rtype:
    ...
    def begin_what_if_at_tenant_scope(
        ...
        **kwargs: Any
        ...
        :type deployment_name: str
        :param parameters: Parameters to validate. Required.
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.ScopedDeploymentWhatIf
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either WhatIfOperationResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.resource.resources.v2025_04_01.models.WhatIfOperationResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_what_if_at_tenant_scope(
        ...
        :param parameters: Parameters to validate. Is either a ScopedDeploymentWhatIf type or a
         IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.ScopedDeploymentWhatIf or
         IO[bytes]
        :return: An instance of LROPoller that returns either WhatIfOperationResult or the result of
         cls(response)
        :rtype:
    ...
    def begin_what_if_at_subscription_scope(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.DeploymentWhatIf
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either WhatIfOperationResult or the result of
    ...
    def begin_what_if_at_subscription_scope(
        ...
        :param parameters: Parameters to What If. Is either a DeploymentWhatIf type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.resource.resources.v2025_04_01.models.DeploymentWhatIf or
         IO[bytes]
        :return: An instance of LROPoller that returns either WhatIfOperationResult or the result of
         cls(response)
        :rtype:
    ...
    def calculate_template_hash(self, template: JSON, **kwargs: Any) -> _models.TemplateHashResult:
        ...
        :rtype: ~azure.mgmt.resource.resources.v2025_04_01.models.TemplateHashResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class DeploymentOperationsOperations:
    ...
    def get_at_scope(
        ...
        :rtype: ~azure.mgmt.resource.resources.v2025_04_01.models.DeploymentOperation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_at_scope(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.resources.v2025_04_01.models.DeploymentOperation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
