...
class DeploymentsOperations(object):  # pylint: disable=too-many-public-methods
...
class ProviderResourceTypesOperations(object):
...
class ResourcesOperations(object):  # pylint: disable=too-many-public-methods
