...
class DeploymentsOperations(object):
    ...
    def _delete_at_scope_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._delete_at_scope_initial.metadata['url']
    ...
    def _create_or_update_at_scope_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._create_or_update_at_scope_initial.metadata['url']
        path_format_arguments = {
            'scope': self._serialize.url("scope", scope, 'str'),
            'deploymentName': self._serialize.url("deployment_name", deployment_name, 'str', max_length=64, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        }
    ...
    def begin_create_or_update_at_scope(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.resource.resources.v2019_10_01.models.DeploymentExtended]
    ...
    def _validate_at_scope_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._validate_at_scope_initial.metadata['url']
        path_format_arguments = {
            'scope': self._serialize.url("scope", scope, 'str'),
            'deploymentName': self._serialize.url("deployment_name", deployment_name, 'str', max_length=64, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        }
        ...
        return deserialized
    _validate_at_scope_initial.metadata = {'url': '/{scope}/providers/Microsoft.Resources/deployments/{deploymentName}/validate'}
    ...
    def begin_validate_at_scope(
        ...
        **kwargs  # type: Any
        ...
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :return: An instance of LROPoller that returns DeploymentValidateResult
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.resource.resources.v2019_10_01.models.DeploymentValidateResult]
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_validate_at_scope.metadata = {'url': '/{scope}/providers/Microsoft.Resources/deployments/{deploymentName}/validate'}
    ...
    def list_at_scope(
     ...
     $filter=provisioningState eq '{state}'.
        ...
        :rtype: ~azure.mgmt.resource.resources.v2019_10_01.models.DeploymentListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _delete_at_tenant_scope_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._delete_at_tenant_scope_initial.metadata['url']
        path_format_arguments = {
            'deploymentName': self._serialize.url("deployment_name", deployment_name, 'str', max_length=64, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    def _create_or_update_at_tenant_scope_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._create_or_update_at_tenant_scope_initial.metadata['url']
        path_format_arguments = {
            'deploymentName': self._serialize.url("deployment_name", deployment_name, 'str', max_length=64, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    def _validate_at_tenant_scope_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._validate_at_tenant_scope_initial.metadata['url']
        path_format_arguments = {
            'deploymentName': self._serialize.url("deployment_name", deployment_name, 'str', max_length=64, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    _validate_at_tenant_scope_initial.metadata = {'url': '/providers/Microsoft.Resources/deployments/{deploymentName}/validate'}
    ...
    def begin_validate_at_tenant_scope(
        ...
        **kwargs  # type: Any
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_validate_at_tenant_scope.metadata = {'url': '/providers/Microsoft.Resources/deployments/{deploymentName}/validate'}
    ...
    def _validate_at_management_group_scope_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._validate_at_management_group_scope_initial.metadata['url']
        path_format_arguments = {
            'groupId': self._serialize.url("group_id", group_id, 'str', max_length=90, min_length=1),
            'deploymentName': self._serialize.url("deployment_name", deployment_name, 'str', max_length=64, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        }
        ...
        return deserialized
    _validate_at_management_group_scope_initial.metadata = {'url': '/providers/Microsoft.Management/managementGroups/{groupId}/providers/Microsoft.Resources/deployments/{deploymentName}/validate'}
    ...
    def begin_validate_at_management_group_scope(
        ...
        **kwargs  # type: Any
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_validate_at_management_group_scope.metadata = {'url': '/providers/Microsoft.Management/managementGroups/{groupId}/providers/Microsoft.Resources/deployments/{deploymentName}/validate'}
    ...
    def _validate_at_subscription_scope_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._validate_at_subscription_scope_initial.metadata['url']
        path_format_arguments = {
            'deploymentName': self._serialize.url("deployment_name", deployment_name, 'str', max_length=64, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
        }
        ...
        return deserialized
    _validate_at_subscription_scope_initial.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Resources/deployments/{deploymentName}/validate'}
    ...
    def begin_validate_at_subscription_scope(
        ...
        **kwargs  # type: Any
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_validate_at_subscription_scope.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Resources/deployments/{deploymentName}/validate'}
    ...
    def _what_if_at_subscription_scope_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._what_if_at_subscription_scope_initial.metadata['url']
        path_format_arguments = {
            'deploymentName': self._serialize.url("deployment_name", deployment_name, 'str', max_length=64, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
        }
    ...
    def _validate_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._validate_initial.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'deploymentName': self._serialize.url("deployment_name", deployment_name, 'str', max_length=64, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
        ...
        return deserialized
    _validate_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Resources/deployments/{deploymentName}/validate'}
    ...
    def begin_validate(
     ...
     The name is case insensitive.
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_validate.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Resources/deployments/{deploymentName}/validate'}
    ...
    def _what_if_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._what_if_initial.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'deploymentName': self._serialize.url("deployment_name", deployment_name, 'str', max_length=64, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
