...
class DeploymentsOperations:
    ...
    async def validate_at_scope(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.resource.resources.v2019_10_01.models.DeploymentValidateResult or ~azure.mgmt.resource.resources.v2019_10_01.models.DeploymentValidateResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _what_if_at_subscription_scope_initial(
        self,
        deployment_name: str,
        properties: "models.DeploymentWhatIfProperties",
        ...
        **kwargs
        ...
        _parameters = models.DeploymentWhatIf(location=location, properties=properties)
        api_version = "2019-10-01"
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'DeploymentWhatIf')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
