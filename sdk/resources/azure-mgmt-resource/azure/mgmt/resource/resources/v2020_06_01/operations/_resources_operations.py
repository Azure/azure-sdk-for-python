...
class ResourcesOperations(object):
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.resource.resources.v2020_06_01.models.GenericResourceExpandedPaged[~azure.mgmt.resource.resources.v2020_06_01.models.GenericResourceExpanded]
    ...
    def _move_resources_initial(
        ...
        path_format_arguments = {
            'sourceResourceGroupName': self._serialize.url("source_resource_group_name", source_resource_group_name, 'str', max_length=90, min_length=1),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.resource.resources.v2020_06_01.models.GenericResource
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.resource.resources.v2020_06_01.models.GenericResource]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.resource.resources.v2020_06_01.models.GenericResource]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.resource.resources.v2020_06_01.models.GenericResource or
