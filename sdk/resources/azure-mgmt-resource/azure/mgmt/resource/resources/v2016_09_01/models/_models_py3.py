...
class DeploymentValidateResult(_serialization.Model):
    ...
    :vartype error:
     ~azure.mgmt.resource.resources.v2016_09_01.models.ResourceManagementErrorWithDetailsAutoGenerated
...
class ResourceManagementErrorWithDetailsAutoGenerated(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :ivar details: Validation error.
    :vartype details:
     list[~azure.mgmt.resource.resources.v2016_09_01.models.ResourceManagementErrorWithDetailsAutoGenerated]
    """
