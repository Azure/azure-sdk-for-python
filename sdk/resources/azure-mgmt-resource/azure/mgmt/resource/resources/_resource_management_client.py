...
class ResourceManagementClient(MultiApiClientMixin, SDKClient):
    ...
    def deployment_operations(self):
        """Instance depends on the API version:
           ...
           * 2021-04-01: :class:`DeploymentOperations<azure.mgmt.resource.resources.v2021_04_01.operations.DeploymentOperations>`
        """
        ...
        if api_version == '2016-02-01':
            ...
            from .v2021_04_01.operations import DeploymentOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
