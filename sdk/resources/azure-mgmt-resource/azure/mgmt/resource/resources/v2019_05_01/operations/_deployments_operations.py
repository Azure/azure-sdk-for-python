...
class DeploymentsOperations(object):
    ...
    def _delete_at_management_group_scope_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._delete_at_management_group_scope_initial.metadata['url']
    ...
    def _create_or_update_at_management_group_scope_initial(
        ...
        group_id,  # type: str
        deployment_name,  # type: str
        properties,  # type: "models.DeploymentProperties"
        ...
        **kwargs  # type: Any
        ...
        _parameters = models.Deployment(location=location, properties=properties)
        api_version = "2019-05-01"

        # Construct URL
        url = self._create_or_update_at_management_group_scope_initial.metadata['url']
        path_format_arguments = {
            'groupId': self._serialize.url("group_id", group_id, 'str', max_length=90, min_length=1),
            'deploymentName': self._serialize.url("deployment_name", deployment_name, 'str', max_length=64, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        }
    ...
    def begin_create_or_update_at_management_group_scope(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.resource.resources.v2019_05_01.models.DeploymentExtended]
    ...
    def validate_at_management_group_scope(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.resource.resources.v2019_05_01.models.DeploymentValidateResult or ~azure.mgmt.resource.resources.v2019_05_01.models.DeploymentValidateResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_at_management_group_scope(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.DeploymentListResult"
     ...
     $filter=provisioningState eq '{state}'.
        ...
        :rtype: ~azure.mgmt.resource.resources.v2019_05_01.models.DeploymentListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _delete_at_subscription_scope_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._delete_at_subscription_scope_initial.metadata['url']
        path_format_arguments = {
            'deploymentName': self._serialize.url("deployment_name", deployment_name, 'str', max_length=64, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
    ...
    def _create_or_update_at_subscription_scope_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._create_or_update_at_subscription_scope_initial.metadata['url']
        path_format_arguments = {
            'deploymentName': self._serialize.url("deployment_name", deployment_name, 'str', max_length=64, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
        }
