...
def build_validate_at_scope_request(
    scope: str,
    deployment_name: str,
    *,
    json: JSONType = None,
...
def build_validate_at_tenant_scope_request(
    deployment_name: str,
    *,
    json: JSONType = None,
    content: Any = None,
...
class DeploymentsOperations(object):
    ...
    def begin_create_or_update_at_scope(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either DeploymentExtended or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.resource.resources.v2019_07_01.models.DeploymentExtended]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
        polling = kwargs.pop('polling', True)  # type: Union[bool, azure.core.polling.PollingMethod]
    ...
    def validate_at_scope(
        ...
        **kwargs: Any
        ...
        request = build_validate_at_scope_request(
            scope=scope,
            deployment_name=deployment_name,
            content_type=content_type,
            json=_json,
    ...
    def list_at_scope(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DeploymentListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.resources.v2019_07_01.models.DeploymentListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def validate_at_tenant_scope(
        ...
        **kwargs: Any
        ...
        request = build_validate_at_tenant_scope_request(
            deployment_name=deployment_name,
            content_type=content_type,
            json=_json,
    ...
    def begin_what_if_at_subscription_scope(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either WhatIfOperationResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.resource.resources.v2019_07_01.models.WhatIfOperationResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
        polling = kwargs.pop('polling', True)  # type: Union[bool, azure.core.polling.PollingMethod]
