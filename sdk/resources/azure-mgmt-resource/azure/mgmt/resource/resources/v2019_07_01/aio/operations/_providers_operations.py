...
from ...operations._providers_operations import build_get_at_tenant_scope_request, build_get_request, build_list_at_tenant_scope_request, build_list_request, build_register_request, build_unregister_request
T = TypeVar('T')
...
class ProvidersOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.resources.v2019_07_01.models.ProviderListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
