...
class TemplateSpecsClient(SDKClient):
    ...
    :vartype template_specs: templatespecs.operations.TemplateSpecsOperations
    :ivar template_spec_versions: TemplateSpecVersions operations
    :vartype template_spec_versions: templatespecs.operations.TemplateSpecVersionsOperations
