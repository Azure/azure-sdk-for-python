...
class Alias(Model):
    ...
    :type paths:
     list[~azure.mgmt.resource.resources.v2021_01_01.models.AliasPath]
    :param type: The type of the alias. Possible values include:
     'NotSpecified', 'PlainText', 'Mask'
    :type type: str or
     ~azure.mgmt.resource.resources.v2021_01_01.models.AliasType
    ...
    :type default_pattern:
     ~azure.mgmt.resource.resources.v2021_01_01.models.AliasPattern
    ...
    :vartype default_metadata:
     ~azure.mgmt.resource.resources.v2021_01_01.models.AliasPathMetadata
    """
...
class AliasPathMetadata(Model):
    ...
    :vartype type: str or
     ~azure.mgmt.resource.resources.v2021_01_01.models.AliasPathTokenType
...
class AliasPattern(Model):
    ...
    :type type: str or
     ~azure.mgmt.resource.resources.v2021_01_01.models.AliasPatternType
    """
...
class CloudError(Model):
    ...
    :param error:
    :type error:
     ~azure.mgmt.resource.resources.v2021_01_01.models.ErrorResponse
    """
...
class Dependency(Model):
    ...
    :type depends_on:
     list[~azure.mgmt.resource.resources.v2021_01_01.models.BasicDependency]
    :param id: The ID of the dependency.
    :type id: str
    :param resource_type: The dependency resource type.
    :type resource_type: str
...
class Deployment(Model):
    ...
    :type properties:
     ~azure.mgmt.resource.resources.v2021_01_01.models.DeploymentProperties
...
class DeploymentOperationProperties(Model):
    ...
    :vartype status_message:
     ~azure.mgmt.resource.resources.v2021_01_01.models.StatusMessage
    :ivar target_resource: The target resource.
    :vartype target_resource:
     ~azure.mgmt.resource.resources.v2021_01_01.models.TargetResource
    :ivar request: The HTTP request message.
    :vartype request:
     ~azure.mgmt.resource.resources.v2021_01_01.models.HttpMessage
...
class DeploymentProperties(Model):
    ...
    :type template_link:
     ~azure.mgmt.resource.resources.v2021_01_01.models.TemplateLink
    ...
    :type parameters_link:
     ~azure.mgmt.resource.resources.v2021_01_01.models.ParametersLink
    :param mode: Required. The mode that is used to deploy resources. This
     ...
     'Complete'
    :type mode: str or
     ~azure.mgmt.resource.resources.v2021_01_01.models.DeploymentMode
    :param debug_setting: The debug setting of the deployment.
    :type debug_setting:
     ~azure.mgmt.resource.resources.v2021_01_01.models.DebugSetting
    :param on_error_deployment: The deployment on error behavior.
    :type on_error_deployment:
     ~azure.mgmt.resource.resources.v2021_01_01.models.OnErrorDeployment
...
class DeploymentPropertiesExtended(Model):
    ...
    :vartype providers:
     list[~azure.mgmt.resource.resources.v2021_01_01.models.Provider]
    :ivar dependencies: The list of deployment dependencies.
    :vartype dependencies:
     list[~azure.mgmt.resource.resources.v2021_01_01.models.Dependency]
...
class DeploymentWhatIf(Model):
    ...
    :param properties: Required. The deployment properties.
    :type properties:
     ~azure.mgmt.resource.resources.v2021_01_01.models.DeploymentWhatIfProperties
    """
...
class ErrorResponse(Model):
    ...
    :vartype details:
     list[~azure.mgmt.resource.resources.v2021_01_01.models.ErrorResponse]
...
class ExtendedLocation(Model):
    ...
    :param type: The extended location type. Possible values include:
     'EdgeZone'
    :type type: str or
     ~azure.mgmt.resource.resources.v2021_01_01.models.ExtendedLocationType
...
class Resource(Model):
    ...
    :type extended_location:
     ~azure.mgmt.resource.resources.v2021_01_01.models.ExtendedLocation
...
class Identity(Model):
    ...
    :type type: str or
     ~azure.mgmt.resource.resources.v2021_01_01.models.ResourceIdentityType
...
class OnErrorDeployment(Model):
    ...
    :type type: str or
     ~azure.mgmt.resource.resources.v2021_01_01.models.OnErrorDeploymentType
...
class Operation(Model):
    ...
    :type display:
     ~azure.mgmt.resource.resources.v2021_01_01.models.OperationDisplay
    """
...
class ProviderExtendedLocation(Model):
...
class ProviderResourceType(Model):
    ...
    :param location_mappings: The location mappings that are supported by this
     resource type.
    ...
    :type aliases:
     list[~azure.mgmt.resource.resources.v2021_01_01.models.Alias]
    ...
    :vartype api_profiles:
     list[~azure.mgmt.resource.resources.v2021_01_01.models.ApiProfile]
...
class ProviderResourceTypeListResult(Model):
...
class ResourceGroup(Model):
    ...
    :type properties:
     ~azure.mgmt.resource.resources.v2021_01_01.models.ResourceGroupProperties
...
class TagDetails(Model):
    ...
    :type values:
     list[~azure.mgmt.resource.resources.v2021_01_01.models.TagValue]
    """
...
class TagsPatchResource(Model):
    ...
    :type operation: str or
     ~azure.mgmt.resource.resources.v2021_01_01.models.TagsPatchOperation
...
class TemplateLink(Model):
    ...
    :param id: The resource id of a Template Spec. Use either the id or uri
     property, but not both.
    :type id: str
    :param relative_path: The relativePath property can be used to deploy a
     linked template at a location relative to the parent. If the parent
     template was linked with a TemplateSpec, this will reference an artifact
     in the TemplateSpec.  If the parent was linked with a URI, the child
     deployment will be a combination of the parent and relativePath URIs
    :type relative_path: str
    :param content_version: If included, must match the ContentVersion in the
     template.
    :type content_version: str
    :param query_string: The query string (for example, a SAS token) to be
     used with the templateLink URI.
...
class WhatIfChange(Model):
    ...
    :type change_type: str or
     ~azure.mgmt.resource.resources.v2021_01_01.models.ChangeType
    :param unsupported_reason: The explanation about why the resource is
     unsupported by What-If.
    ...
    :type delta:
     list[~azure.mgmt.resource.resources.v2021_01_01.models.WhatIfPropertyChange]
    """
...
class WhatIfOperationResult(Model):
    ...
    :type changes:
     list[~azure.mgmt.resource.resources.v2021_01_01.models.WhatIfChange]
