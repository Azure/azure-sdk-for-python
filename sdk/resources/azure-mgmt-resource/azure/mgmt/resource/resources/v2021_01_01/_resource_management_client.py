...
class ResourceManagementClient(SDKClient):
    ...
    :ivar provider_resource_types: ProviderResourceTypes operations
    ...
    :vartype deployment_operations: azure.mgmt.resource.resources.v2021_01_01.operations.DeploymentOperations
