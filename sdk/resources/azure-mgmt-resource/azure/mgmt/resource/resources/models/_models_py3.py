...
class Dependency(_serialization.Model):
    ...
    :vartype depends_on: list[~azure.mgmt.resource.resources.models.BasicDependency]
    :ivar id: The ID of the dependency.
    :vartype id: str
    :ivar resource_type: The dependency resource type.
    :vartype resource_type: str
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype depends_on: list[~azure.mgmt.resource.resources.models.BasicDependency]
        :keyword id: The ID of the dependency.
        :paramtype id: str
        :keyword resource_type: The dependency resource type.
        :paramtype resource_type: str
...
class Deployment(_serialization.Model):
    ...
    :vartype properties: ~azure.mgmt.resource.resources.models.DeploymentProperties
    :ivar tags: Deployment tags.
    :vartype tags: dict[str, str]
    :ivar identity: The Managed Identity configuration for a deployment.
    :vartype identity: ~azure.mgmt.resource.resources.models.DeploymentIdentity
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties: ~azure.mgmt.resource.resources.models.DeploymentProperties
        :keyword tags: Deployment tags.
        :paramtype tags: dict[str, str]
        :keyword identity: The Managed Identity configuration for a deployment.
        :paramtype identity: ~azure.mgmt.resource.resources.models.DeploymentIdentity
        """
        super().__init__(**kwargs)
...
class DeploymentDiagnosticsDefinition(_serialization.Model):
    ...
    :ivar level: Denotes the additional response level. Required. Known values are: "Warning",
     "Info", and "Error".
    :vartype level: str or ~azure.mgmt.resource.resources.models.Level
...
class DeploymentExtended(_serialization.Model):
    ...
    :vartype properties: ~azure.mgmt.resource.resources.models.DeploymentPropertiesExtended
    :ivar tags: Deployment tags.
    :vartype tags: dict[str, str]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties: ~azure.mgmt.resource.resources.models.DeploymentPropertiesExtended
        :keyword tags: Deployment tags.
        :paramtype tags: dict[str, str]
        """
        super().__init__(**kwargs)
...
class DeploymentExtensionConfigItem(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.resource.resources.models.ExtensionConfigPropertyType
    ...
    :vartype key_vault_reference: ~azure.mgmt.resource.resources.models.KeyVaultParameterReference
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype key_vault_reference:
         ~azure.mgmt.resource.resources.models.KeyVaultParameterReference
        """
        super().__init__(**kwargs)
...
class DeploymentExtensionDefinition(_serialization.Model):
    ...
    :vartype config: dict[str, ~azure.mgmt.resource.resources.models.DeploymentExtensionConfigItem]
    """
...
class DeploymentIdentity(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.resource.resources.models.DeploymentIdentityType
    :ivar user_assigned_identities: The set of user assigned identities associated with the
     resource.
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.resource.resources.models.UserAssignedIdentity]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype type: str or ~azure.mgmt.resource.resources.models.DeploymentIdentityType
...
class DeploymentListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.resource.resources.models.DeploymentExtended]
    ...
    def __init__(self, *, value: Optional[List["_models.DeploymentExtended"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.resource.resources.models.DeploymentExtended]
        """
        super().__init__(**kwargs)
        self.value = value
...
class DeploymentOperation(_serialization.Model):
    ...
    :ivar properties: Deployment properties.
    :vartype properties: ~azure.mgmt.resource.resources.models.DeploymentOperationProperties
    """
    ...
    def __init__(self, *, properties: Optional["_models.DeploymentOperationProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: Deployment properties.
        :paramtype properties: ~azure.mgmt.resource.resources.models.DeploymentOperationProperties
        """
        super().__init__(**kwargs)
        self.id: Optional[str] = None
...
class DeploymentOperationProperties(_serialization.Model):
    ...
    :vartype provisioning_operation: str or
     ~azure.mgmt.resource.resources.models.ProvisioningOperation
    ...
    :vartype status_message: ~azure.mgmt.resource.resources.models.StatusMessage
    :ivar target_resource: The target resource.
    :vartype target_resource: ~azure.mgmt.resource.resources.models.TargetResource
    :ivar request: The HTTP request message.
    :vartype request: ~azure.mgmt.resource.resources.models.HttpMessage
    :ivar response: The HTTP response message.
    :vartype response: ~azure.mgmt.resource.resources.models.HttpMessage
    """
...
class DeploymentOperationsListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.resource.resources.models.DeploymentOperation]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: Optional[List["_models.DeploymentOperation"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.resource.resources.models.DeploymentOperation]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link: Optional[str] = None
...
class DeploymentParameter(_serialization.Model):
    ...
    :vartype reference: ~azure.mgmt.resource.resources.models.KeyVaultParameterReference
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype reference: ~azure.mgmt.resource.resources.models.KeyVaultParameterReference
...
class DeploymentProperties(_serialization.Model):
    ...
    :vartype template_link: ~azure.mgmt.resource.resources.models.TemplateLink
    ...
    :vartype parameters: dict[str, ~azure.mgmt.resource.resources.models.DeploymentParameter]
    :ivar external_inputs: External input values, used by external tooling for parameter
     evaluation.
    :vartype external_inputs: dict[str,
     ~azure.mgmt.resource.resources.models.DeploymentExternalInput]
    ...
    :vartype external_input_definitions: dict[str,
     ~azure.mgmt.resource.resources.models.DeploymentExternalInputDefinition]
    :ivar parameters_link: The URI of parameters file. You use this element to link to an existing
     ...
     both.
    :vartype parameters_link: ~azure.mgmt.resource.resources.models.ParametersLink
    ...
    :vartype extension_configs: dict[str, dict[str,
     ~azure.mgmt.resource.resources.models.DeploymentExtensionConfigItem]]
    ...
    :vartype mode: str or ~azure.mgmt.resource.resources.models.DeploymentMode
    :ivar debug_setting: The debug setting of the deployment.
    :vartype debug_setting: ~azure.mgmt.resource.resources.models.DebugSetting
    :ivar on_error_deployment: The deployment on error behavior.
    :vartype on_error_deployment: ~azure.mgmt.resource.resources.models.OnErrorDeployment
    ...
    :vartype expression_evaluation_options:
     ~azure.mgmt.resource.resources.models.ExpressionEvaluationOptions
    :ivar validation_level: The validation level of the deployment. Known values are: "Template",
     "Provider", and "ProviderNoRbac".
    :vartype validation_level: str or ~azure.mgmt.resource.resources.models.ValidationLevel
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword template_link: The URI of the template. Use either the templateLink property or the
         template property, but not both.
        :paramtype template_link: ~azure.mgmt.resource.resources.models.TemplateLink
        ...
        :paramtype parameters: dict[str, ~azure.mgmt.resource.resources.models.DeploymentParameter]
        ...
        :keyword parameters_link: The URI of parameters file. You use this element to link to an
         ...
         but not both.
        :paramtype parameters_link: ~azure.mgmt.resource.resources.models.ParametersLink
        ...
        :keyword mode: The mode that is used to deploy resources. This value can be either Incremental
         ...
         when using Complete mode as you may unintentionally delete resources. Required. Known values
         are: "Incremental" and "Complete".
        :paramtype mode: str or ~azure.mgmt.resource.resources.models.DeploymentMode
        :keyword debug_setting: The debug setting of the deployment.
        :paramtype debug_setting: ~azure.mgmt.resource.resources.models.DebugSetting
        :keyword on_error_deployment: The deployment on error behavior.
        :paramtype on_error_deployment: ~azure.mgmt.resource.resources.models.OnErrorDeployment
        ...
        :paramtype validation_level: str or ~azure.mgmt.resource.resources.models.ValidationLevel
        """
        super().__init__(**kwargs)
        self.template = template
...
class DeploymentPropertiesExtended(_serialization.Model):
    ...
    :vartype provisioning_state: str or ~azure.mgmt.resource.resources.models.ProvisioningState
    ...
    :vartype providers: list[~azure.mgmt.resource.resources.models.Provider]
    :ivar dependencies: The list of deployment dependencies.
    :vartype dependencies: list[~azure.mgmt.resource.resources.models.Dependency]
    ...
    :vartype extensions: list[~azure.mgmt.resource.resources.models.DeploymentExtensionDefinition]
    ...
    :vartype debug_setting: ~azure.mgmt.resource.resources.models.DebugSetting
    :ivar on_error_deployment: The deployment on error behavior.
    :vartype on_error_deployment: ~azure.mgmt.resource.resources.models.OnErrorDeploymentExtended
    ...
    :vartype output_resources: list[~azure.mgmt.resource.resources.models.ResourceReference]
    :ivar validated_resources: Array of validated resources.
    :vartype validated_resources: list[~azure.mgmt.resource.resources.models.ResourceReference]
    ...
    :vartype diagnostics:
     list[~azure.mgmt.resource.resources.models.DeploymentDiagnosticsDefinition]
    :ivar validation_level: The validation level of the deployment. Known values are: "Template",
     "Provider", and "ProviderNoRbac".
    :vartype validation_level: str or ~azure.mgmt.resource.resources.models.ValidationLevel
    """
...
class DeploymentWhatIf(_serialization.Model):
    ...
    :vartype location: str
    :ivar properties: The deployment properties. Required.
    :vartype properties: ~azure.mgmt.resource.resources.models.DeploymentWhatIfProperties
    """
    ...
    def __init__(
        ...
        :paramtype location: str
        :keyword properties: The deployment properties. Required.
        :paramtype properties: ~azure.mgmt.resource.resources.models.DeploymentWhatIfProperties
        """
        super().__init__(**kwargs)
        self.location = location
        self.properties = properties
...
class DeploymentWhatIfProperties(DeploymentProperties):
    ...
    :vartype what_if_settings: ~azure.mgmt.resource.resources.models.DeploymentWhatIfSettings
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype what_if_settings: ~azure.mgmt.resource.resources.models.DeploymentWhatIfSettings
        """
        super().__init__(
            template=template,
...
class DeploymentWhatIfSettings(_serialization.Model):
    ...
    :vartype result_format: str or ~azure.mgmt.resource.resources.models.WhatIfResultFormat
    """
    ...
    def __init__(
        ...
        :paramtype result_format: str or ~azure.mgmt.resource.resources.models.WhatIfResultFormat
        """
        super().__init__(**kwargs)
...
class ExpressionEvaluationOptions(_serialization.Model):
    ...
    :vartype scope: str or
     ~azure.mgmt.resource.resources.models.ExpressionEvaluationOptionsScopeType
    """
...
class KeyVaultParameterReference(_serialization.Model):
    ...
    :vartype key_vault: ~azure.mgmt.resource.resources.models.KeyVaultReference
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype key_vault: ~azure.mgmt.resource.resources.models.KeyVaultReference
...
class OnErrorDeployment(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.resource.resources.models.OnErrorDeploymentType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The deployment on error behavior type. Possible values are LastSuccessful and
         SpecificDeployment. Known values are: "LastSuccessful" and "SpecificDeployment".
        :paramtype type: str or ~azure.mgmt.resource.resources.models.OnErrorDeploymentType
...
class ResourceReference(_serialization.Model):
    ...
    :vartype extension: ~azure.mgmt.resource.resources.models.DeploymentExtensionDefinition
    :ivar resource_type: The resource type.
    :vartype resource_type: str
...
class TargetResource(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype extension: ~azure.mgmt.resource.resources.models.DeploymentExtensionDefinition
...
class WhatIfChange(_serialization.Model):
    ...
    :vartype change_type: str or ~azure.mgmt.resource.resources.models.ChangeType
    ...
    :vartype delta: list[~azure.mgmt.resource.resources.models.WhatIfPropertyChange]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword change_type: Type of change that will be made to the resource when the deployment is
         executed. Required. Known values are: "Create", "Delete", "Ignore", "Deploy", "NoChange",
         "Modify", and "Unsupported".
        :paramtype change_type: str or ~azure.mgmt.resource.resources.models.ChangeType
        ...
        :paramtype delta: list[~azure.mgmt.resource.resources.models.WhatIfPropertyChange]
        """
        super().__init__(**kwargs)
...
class WhatIfOperationResult(_serialization.Model):
    ...
    :vartype changes: list[~azure.mgmt.resource.resources.models.WhatIfChange]
    :ivar potential_changes: List of resource changes predicted by What-If operation.
    :vartype potential_changes: list[~azure.mgmt.resource.resources.models.WhatIfChange]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype changes: list[~azure.mgmt.resource.resources.models.WhatIfChange]
        :keyword potential_changes: List of resource changes predicted by What-If operation.
        :paramtype potential_changes: list[~azure.mgmt.resource.resources.models.WhatIfChange]
        """
        super().__init__(**kwargs)
        self.status = status
        self.error = error
...
class WhatIfPropertyChange(_serialization.Model):
    ...
    :vartype property_change_type: str or ~azure.mgmt.resource.resources.models.PropertyChangeType
    ...
    :vartype children: list[~azure.mgmt.resource.resources.models.WhatIfPropertyChange]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype property_change_type: str or
         ~azure.mgmt.resource.resources.models.PropertyChangeType
        ...
        :paramtype children: list[~azure.mgmt.resource.resources.models.WhatIfPropertyChange]
        """
        super().__init__(**kwargs)
        self.path = path
