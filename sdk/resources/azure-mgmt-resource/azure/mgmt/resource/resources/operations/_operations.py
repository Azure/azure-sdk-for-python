...
class ResourcesOperations:  # pylint: disable=too-many-public-methods
    ...
    def _create_or_update_by_id_initial(
        self, resource_id: str, parameters: Union[_models.GenericResource, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_create_or_update_by_id(
        ...
        :param resource_id: Required.
        :type resource_id: str
        :param parameters: Resource create parameters. Is either a GenericResource type or a IO[bytes]
         type. Required.
...
class ProvidersOperations:
    ...
    def list_at_tenant_scope(self, expand: Optional[str] = None, **kwargs: Any) -> ItemPaged["_models.Provider"]:
        ...
        :param expand: The properties to include in the results. Default value is None.
        :type expand: str
