...
class AliasType(msrest.serialization.Model):
    ...
    :type paths: list[~azure.mgmt.resource.resources.v2018_02_01.models.AliasPathType]
    """
...
class Dependency(msrest.serialization.Model):
    ...
    :type depends_on: list[~azure.mgmt.resource.resources.v2018_02_01.models.BasicDependency]
    :param id: The ID of the dependency.
    :type id: str
    :param resource_type: The dependency resource type.
    :type resource_type: str
...
class DeploymentListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.resources.v2018_02_01.models.DeploymentExtended]
...
class DeploymentOperationsListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.resources.v2018_02_01.models.DeploymentOperation]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
...
class DeploymentProperties(msrest.serialization.Model):
    ...
    :type template_link: ~azure.mgmt.resource.resources.v2018_02_01.models.TemplateLink
    ...
    :type on_error_deployment: ~azure.mgmt.resource.resources.v2018_02_01.models.OnErrorDeployment
    """
...
class DeploymentPropertiesExtended(msrest.serialization.Model):
    ...
    :type providers: list[~azure.mgmt.resource.resources.v2018_02_01.models.Provider]
    :param dependencies: The list of deployment dependencies.
    :type dependencies: list[~azure.mgmt.resource.resources.v2018_02_01.models.Dependency]
...
class ProviderListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.resources.v2018_02_01.models.Provider]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
...
class ResourceGroup(msrest.serialization.Model):
    ...
    :type properties: ~azure.mgmt.resource.resources.v2018_02_01.models.ResourceGroupProperties
...
class ResourceGroupListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.resources.v2018_02_01.models.ResourceGroup]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
...
class ResourceListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.resources.v2018_02_01.models.GenericResourceExpanded]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
...
class TagDetails(msrest.serialization.Model):
    ...
    :type values: list[~azure.mgmt.resource.resources.v2018_02_01.models.TagValue]
    """
...
class TagsListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.resources.v2018_02_01.models.TagDetails]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
