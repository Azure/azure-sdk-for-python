...
class ProvidersOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ProviderListResult"
     ...
     response, use $expand=resourceTypes/aliases.
        :type expand: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ProviderListResult or the result of cls(response)
        :rtype: ~azure.mgmt.resource.resources.v2019_05_10.models.ProviderListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
