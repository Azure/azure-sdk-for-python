...
class ResourceGroupsOperations:
    ...
    async def check_existence(
        ...
        **kwargs: Any
        ...
        api_version = kwargs.pop('api_version', "2019-05-10")  # type: str
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ResourceGroupListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.resources.v2019_05_10.models.ResourceGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2019-05-10")  # type: str
