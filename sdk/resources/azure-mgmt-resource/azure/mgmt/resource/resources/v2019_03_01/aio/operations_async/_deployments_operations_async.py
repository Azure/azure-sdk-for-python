...
class DeploymentsOperations:
    ...
    async def begin_create_or_update_at_subscription_scope(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.resource.resources.v2019_03_01.models.DeploymentExtended]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DeploymentExtended"]
    ...
    def list_at_subscription_scope(
     ...
     $filter=provisioningState eq '{state}'.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.resources.v2019_03_01.models.DeploymentListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
