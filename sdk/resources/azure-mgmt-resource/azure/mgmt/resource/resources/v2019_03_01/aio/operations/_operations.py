...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.resources.v2019_03_01.aio.ResourceManagementClient`'s
    ...
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.Operation"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.resources.v2019_03_01.models.Operation]
...
class ProvidersOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.resources.v2019_03_01.models.Provider]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ResourcesOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :param filter: The filter to apply on the operation.\\ :code:`<br>`\\ :code:`<br>`The
         ...
         'tag1' and tagValue eq 'Value1'\\ :code:`<br>`\\ :code:`<br>`You can use some properties
        ...
        :return: An iterator like instance of either GenericResourceExpanded or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.resources.v2019_03_01.models.GenericResourceExpanded]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_move_resources(
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2019_03_01.models.ResourcesMoveInfo or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either GenericResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.resource.resources.v2019_03_01.models.GenericResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2019_03_01.models.GenericResource or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either GenericResource or the result of
         cls(response)
        :rtype:
...
class ResourceGroupsOperations:
    ...
    async def create_or_update(
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2019_03_01.models.ResourceGroup or IO[bytes]
        :return: ResourceGroup or the result of cls(response)
        :rtype: ~azure.mgmt.resource.resources.v2019_03_01.models.ResourceGroup
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2019_03_01.models.ResourceGroupPatchable or
         IO[bytes]
        :return: ResourceGroup or the result of cls(response)
        :rtype: ~azure.mgmt.resource.resources.v2019_03_01.models.ResourceGroup
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def export_template(
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2019_03_01.models.ExportTemplateRequest or
         IO[bytes]
        :return: ResourceGroupExportResult or the result of cls(response)
        :rtype: ~azure.mgmt.resource.resources.v2019_03_01.models.ResourceGroupExportResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.resources.v2019_03_01.models.ResourceGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class TagsOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.TagDetails"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.resources.v2019_03_01.models.TagDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DeploymentsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_create_or_update_at_subscription_scope(  # pylint: disable=name-too-long
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2019_03_01.models.Deployment or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either DeploymentExtended or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.resource.resources.v2019_03_01.models.DeploymentExtended]
    ...
    def list_at_subscription_scope(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.resources.v2019_03_01.models.DeploymentExtended]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DeploymentOperationsOperations:
    ...
    def list_at_subscription_scope(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.resources.v2019_03_01.models.DeploymentOperation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
