...
class DeploymentsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_create_or_update_at_subscription_scope(
        ...
        :param parameters: Additional parameters supplied to the operation. Is either a model type or a
         IO type. Required.
        :type parameters: ~azure.mgmt.resource.resources.v2019_03_01.models.Deployment or IO
...
class ResourcesOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_move_resources(
        ...
        :param parameters: Parameters for moving resources. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.resource.resources.v2019_03_01.models.ResourcesMoveInfo or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters for creating or updating the resource. Is either a model type or
         a IO type. Required.
        :type parameters: ~azure.mgmt.resource.resources.v2019_03_01.models.GenericResource or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
...
class ResourceGroupsOperations:
    ...
    async def create_or_update(
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2019_03_01.models.ResourceGroup or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def export_template(
        ...
        :param parameters: Parameters for exporting the template. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.resource.resources.v2019_03_01.models.ExportTemplateRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
