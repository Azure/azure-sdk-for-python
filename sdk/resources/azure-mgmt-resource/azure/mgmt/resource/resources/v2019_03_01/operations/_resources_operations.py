...
def build_list_by_resource_group_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/resources')
...
def build_validate_move_resources_request_initial(
    source_resource_group_name: str,
    subscription_id: str,
    *,
    json: JSONType = None,
    ...
    **kwargs: Any
    ...
    api_version = "2019-03-01"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{sourceResourceGroupName}/validateMoveResources')
    path_format_arguments = {
        "sourceResourceGroupName": _SERIALIZER.url("source_resource_group_name", source_resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
...
def build_check_existence_by_id_request(
    resource_id: str,
    *,
    api_version: str,
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/{resourceId}')
    path_format_arguments = {
...
class ResourcesOperations(object):
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.resources.v2019_03_01.models.ResourceListResult]
    ...
    def begin_move_resources(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2019_03_01.models.ResourcesMoveInfo
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def _validate_move_resources_initial(
        ...
        **kwargs: Any
        ...
        request = build_validate_move_resources_request_initial(
            source_resource_group_name=source_resource_group_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
            json=_json,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.resources.v2019_03_01.models.GenericResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
        ...
        :return: An instance of LROPoller that returns either GenericResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.resource.resources.v2019_03_01.models.GenericResource]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
        polling = kwargs.pop('polling', True)  # type: Union[bool, azure.core.polling.PollingMethod]
    ...
    def check_existence_by_id(
        ...
        **kwargs: Any
        ...
        request = build_check_existence_by_id_request(
