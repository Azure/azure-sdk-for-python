...
class ProviderResourceTypesOperations(object):
    ...
    def list(
        ...
        :return: ProviderResourceTypeListResult or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.resource.resources.v2021_04_01.models.ProviderResourceTypeListResult
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ProviderResourceTypeListResult', response)
