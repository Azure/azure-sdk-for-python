...
class ProviderAuthorizationConsentState(str, Enum):
...
class PropertyChangeType(str, Enum):
    ...
    no_effect = "NoEffect"  #: The property will not be set or updated.
...
class ChangeType(str, Enum):
    ...
    unsupported = "Unsupported"  #: The resource is not supported by What-If.
