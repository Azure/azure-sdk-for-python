...
class Resource(Model):
    ...
    def __init__(self, *, location: str=None, extended_location=None, tags=None, **kwargs) -> None:
...
class GenericResource(Resource):
    ...
    def __init__(self, *, location: str=None, extended_location=None, tags=None, plan=None, properties=None, kind: str=None, managed_by: str=None, sku=None, identity=None, **kwargs) -> None:
...
class Provider(Model):
    ...
    def __init__(self, *, namespace: str=None, provider_authorization_consent_state=None, **kwargs) -> None:
...
class ProviderConsentDefinition(Model):
    ...
    def __init__(self, *, consent_to_authorization: bool=None, **kwargs) -> None:
...
class ProviderExtendedLocation(Model):
    ...
    def __init__(self, *, location: str=None, type: str=None, extended_locations=None, **kwargs) -> None:
...
class ProviderPermission(Model):
    ...
    def __init__(self, *, application_id: str=None, role_definition=None, managed_by_role_definition=None, provider_authorization_consent_state=None, **kwargs) -> None:
...
class ProviderRegistrationRequest(Model):
    ...
    def __init__(self, *, third_party_provider_consent=None, **kwargs) -> None:
...
class ProviderResourceType(Model):
    ...
    def __init__(self, *, resource_type: str=None, locations=None, location_mappings=None, aliases=None, api_versions=None, capabilities: str=None, properties=None, **kwargs) -> None:
...
class RoleDefinition(Model):
    ...
    def __init__(self, *, id: str=None, name: str=None, is_service_role: bool=None, permissions=None, scopes=None, **kwargs) -> None:
...
class TemplateLink(Model):
    ...
    def __init__(self, *, uri: str=None, id: str=None, relative_path: str=None, content_version: str=None, query_string: str=None, **kwargs) -> None:
...
class WhatIfChange(Model):
    ...
    def __init__(self, *, resource_id: str, change_type, unsupported_reason: str=None, before=None, after=None, delta=None, **kwargs) -> None:
