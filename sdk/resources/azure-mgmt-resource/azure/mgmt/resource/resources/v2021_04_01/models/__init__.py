...
try:
    ...
    from ._models import ProviderConsentDefinition
    from ._models import ProviderExtendedLocation
    from ._models import ProviderPermission
    from ._models import ProviderPermissionListResult
    from ._models import ProviderRegistrationRequest
    from ._models import ProviderResourceType
    from ._models import ProviderResourceTypeListResult
