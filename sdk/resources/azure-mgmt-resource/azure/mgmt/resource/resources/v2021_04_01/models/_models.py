...
class Alias(msrest.serialization.Model):
    ...
    :type paths: list[~azure.mgmt.resource.resources.v2021_04_01.models.AliasPath]
    :param type: The type of the alias. Possible values include: "NotSpecified", "PlainText",
     "Mask".
    :type type: str or ~azure.mgmt.resource.resources.v2021_04_01.models.AliasType
    :param default_path: The default path for an alias.
    :type default_path: str
    :param default_pattern: The default pattern for an alias.
    :type default_pattern: ~azure.mgmt.resource.resources.v2021_04_01.models.AliasPattern
...
class AliasPath(msrest.serialization.Model):
    ...
    :type pattern: ~azure.mgmt.resource.resources.v2021_04_01.models.AliasPattern
...
class AliasPattern(msrest.serialization.Model):
    ...
    :type type: str or ~azure.mgmt.resource.resources.v2021_04_01.models.AliasPatternType
    """
...
class Dependency(msrest.serialization.Model):
    ...
    :type depends_on: list[~azure.mgmt.resource.resources.v2021_04_01.models.BasicDependency]
    :param id: The ID of the dependency.
    :type id: str
    :param resource_type: The dependency resource type.
    :type resource_type: str
...
class Deployment(msrest.serialization.Model):
    ...
    :type properties: ~azure.mgmt.resource.resources.v2021_04_01.models.DeploymentProperties
...
class DeploymentListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.resources.v2021_04_01.models.DeploymentExtended]
...
class DeploymentOperationsListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.resources.v2021_04_01.models.DeploymentOperation]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
...
class DeploymentProperties(msrest.serialization.Model):
    ...
    :type template_link: ~azure.mgmt.resource.resources.v2021_04_01.models.TemplateLink
    ...
    :param parameters_link: The URI of parameters file. You use this element to link to an existing
     ...
     both.
    :type parameters_link: ~azure.mgmt.resource.resources.v2021_04_01.models.ParametersLink
    ...
    :type mode: str or ~azure.mgmt.resource.resources.v2021_04_01.models.DeploymentMode
    :param debug_setting: The debug setting of the deployment.
    :type debug_setting: ~azure.mgmt.resource.resources.v2021_04_01.models.DebugSetting
    :param on_error_deployment: The deployment on error behavior.
    :type on_error_deployment: ~azure.mgmt.resource.resources.v2021_04_01.models.OnErrorDeployment
...
class DeploymentWhatIf(msrest.serialization.Model):
    ...
    :type location: str
    :param properties: Required. The deployment properties.
    :type properties: ~azure.mgmt.resource.resources.v2021_04_01.models.DeploymentWhatIfProperties
    """
...
class ExtendedLocation(msrest.serialization.Model):
    ...
    :type type: str or ~azure.mgmt.resource.resources.v2021_04_01.models.ExtendedLocationType
...
class Resource(msrest.serialization.Model):
    ...
    :type extended_location: ~azure.mgmt.resource.resources.v2021_04_01.models.ExtendedLocation
...
class GenericResource(Resource):
    ...
    :type plan: ~azure.mgmt.resource.resources.v2021_04_01.models.Plan
    ...
    :type sku: ~azure.mgmt.resource.resources.v2021_04_01.models.Sku
    :param identity: The identity of the resource.
    :type identity: ~azure.mgmt.resource.resources.v2021_04_01.models.Identity
    """
...
class Identity(msrest.serialization.Model):
    ...
    :type type: str or ~azure.mgmt.resource.resources.v2021_04_01.models.ResourceIdentityType
...
class OnErrorDeployment(msrest.serialization.Model):
    ...
    :type type: str or ~azure.mgmt.resource.resources.v2021_04_01.models.OnErrorDeploymentType
...
class Operation(msrest.serialization.Model):
    ...
    :type display: ~azure.mgmt.resource.resources.v2021_04_01.models.OperationDisplay
    """
...
class OperationListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.resources.v2021_04_01.models.Operation]
...
class Provider(msrest.serialization.Model):
    ...
    :param provider_authorization_consent_state: The provider authorization consent state. Possible
     values include: "NotSpecified", "Required", "NotRequired", "Consented".
    :type provider_authorization_consent_state: str or
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.provider_authorization_consent_state = kwargs.get('provider_authorization_consent_state', None)


class ProviderConsentDefinition(msrest.serialization.Model):
    """The provider consent.

    :param consent_to_authorization: A value indicating whether authorization is consented or not.
    :type consent_to_authorization: bool
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.consent_to_authorization = kwargs.get('consent_to_authorization', None)
...
class ProviderListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.resources.v2021_04_01.models.Provider]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
...
class ProviderPermission(msrest.serialization.Model):
    ...
    :param role_definition: Role definition properties.
    :type role_definition: ~azure.mgmt.resource.resources.v2021_04_01.models.RoleDefinition
    :param managed_by_role_definition: Role definition properties.
    :type managed_by_role_definition:
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.managed_by_role_definition = kwargs.get('managed_by_role_definition', None)
        self.provider_authorization_consent_state = kwargs.get('provider_authorization_consent_state', None)
...
class ProviderPermissionListResult(msrest.serialization.Model):
    ...
    :param value: An array of provider permissions.
    :type value: list[~azure.mgmt.resource.resources.v2021_04_01.models.ProviderPermission]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
...
class ProviderRegistrationRequest(msrest.serialization.Model):
    ...
    :param third_party_provider_consent: The provider consent.
    :type third_party_provider_consent:
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.third_party_provider_consent = kwargs.get('third_party_provider_consent', None)
...
class ProviderResourceType(msrest.serialization.Model):
    ...
    :type aliases: list[~azure.mgmt.resource.resources.v2021_04_01.models.Alias]
...
class ProviderResourceTypeListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.resources.v2021_04_01.models.ProviderResourceType]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
...
class ResourceGroup(msrest.serialization.Model):
    ...
    :type properties: ~azure.mgmt.resource.resources.v2021_04_01.models.ResourceGroupProperties
...
class ResourceGroupExportResult(msrest.serialization.Model):
    ...
    :type error: ~azure.mgmt.resource.resources.v2021_04_01.models.ErrorResponse
    """
...
class ResourceGroupListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.resources.v2021_04_01.models.ResourceGroup]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
...
class ResourceListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.resources.v2021_04_01.models.GenericResourceExpanded]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
...
class RoleDefinition(msrest.serialization.Model):
    ...
    :type name: str
    :param is_service_role: If this is a service role.
    :type is_service_role: bool
    :param permissions: Role definition permissions.
    :type permissions: list[~azure.mgmt.resource.resources.v2021_04_01.models.Permission]
    :param scopes: Role definition assignable scopes.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.id = kwargs.get('id', None)
        self.name = kwargs.get('name', None)
        self.is_service_role = kwargs.get('is_service_role', None)
...
class TagDetails(msrest.serialization.Model):
    ...
    :type count: ~azure.mgmt.resource.resources.v2021_04_01.models.TagCount
    :param values: The list of tag values.
    :type values: list[~azure.mgmt.resource.resources.v2021_04_01.models.TagValue]
    """
...
class TagsListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.resource.resources.v2021_04_01.models.TagDetails]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
...
class TagsPatchResource(msrest.serialization.Model):
    ...
    :param operation: The operation type for the patch API. Possible values include: "Replace",
     "Merge", "Delete".
    :type operation: str or ~azure.mgmt.resource.resources.v2021_04_01.models.TagsPatchOperation
    :param properties: The set of tags.
    :type properties: ~azure.mgmt.resource.resources.v2021_04_01.models.Tags
    """
...
class WhatIfChange(msrest.serialization.Model):
    ...
    :type change_type: str or ~azure.mgmt.resource.resources.v2021_04_01.models.ChangeType
    ...
    :type delta: list[~azure.mgmt.resource.resources.v2021_04_01.models.WhatIfPropertyChange]
    """
...
class WhatIfOperationResult(msrest.serialization.Model):
    ...
    :type changes: list[~azure.mgmt.resource.resources.v2021_04_01.models.WhatIfChange]
    """
...
class WhatIfPropertyChange(msrest.serialization.Model):
    ...
    :type children: list[~azure.mgmt.resource.resources.v2021_04_01.models.WhatIfPropertyChange]
    """
