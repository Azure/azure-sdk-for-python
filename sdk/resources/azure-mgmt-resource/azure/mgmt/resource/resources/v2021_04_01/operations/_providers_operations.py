...
class ProvidersOperations(object):
    ...
    def provider_permissions(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.ProviderPermissionListResult"
        ...
        # Construct URL
        url = self.provider_permissions.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceProviderNamespace': self._serialize.url("resource_provider_namespace", resource_provider_namespace, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
        }
    ...
    def register(
        self,
        resource_provider_namespace,  # type: str
        properties=None,  # type: Optional["_models.ProviderRegistrationRequest"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Provider"
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.resource.resources.v2021_04_01.models.ProviderListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
