...
class ProvidersOperations(object):
    ...
    :ivar api_version: The API version to use for this operation. Constant value: "2021-04-01".
    """
    ...
    def unregister(
        ...
        :rtype: ~azure.mgmt.resource.resources.v2021_04_01.models.Provider or
    ...
    def register_at_management_group_scope(
            self, resource_provider_namespace, group_id, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.register_at_management_group_scope.metadata['url']
        path_format_arguments = {
            'resourceProviderNamespace': self._serialize.url("resource_provider_namespace", resource_provider_namespace, 'str'),
        ...
        if raw:
            ...
            return client_raw_response
    register_at_management_group_scope.metadata = {'url': '/providers/Microsoft.Management/managementGroups/{groupId}/providers/{resourceProviderNamespace}/register'}
    ...
    def provider_permissions(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: ProviderPermissionListResult or ClientRawResponse if raw=true
        :rtype:
         ~azure.mgmt.resource.resources.v2021_04_01.models.ProviderPermissionListResult
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        url = self.provider_permissions.metadata['url']
        path_format_arguments = {
            'resourceProviderNamespace': self._serialize.url("resource_provider_namespace", resource_provider_namespace, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
        }
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('ProviderPermissionListResult', response)
        ...
        return deserialized
    provider_permissions.metadata = {'url': '/subscriptions/{subscriptionId}/providers/{resourceProviderNamespace}/providerPermissions'}

    def register(
            self, resource_provider_namespace, third_party_provider_consent=None, custom_headers=None, raw=False, **operation_config):
        ...
        """
        properties = None
        if third_party_provider_consent is not None:
            properties = models.ProviderRegistrationRequest(third_party_provider_consent=third_party_provider_consent)
        ...
        if properties is not None:
            body_content = self._serialize.body(properties, 'ProviderRegistrationRequest')
        else:
            body_content = None
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.resource.resources.v2021_04_01.models.ProviderPaged[~azure.mgmt.resource.resources.v2021_04_01.models.Provider]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
