...
class SubscriptionClient(_SubscriptionClientOperationsMixin):
    ...
    :vartype subscriptions: azure.mgmt.resource.subscriptions.operations.SubscriptionsOperations
    :ivar tenants: TenantsOperations operations
    :vartype tenants: azure.mgmt.resource.subscriptions.operations.TenantsOperations
