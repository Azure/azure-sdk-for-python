...
class Location(msrest.serialization.Model):
    ...
    :vartype name: str
    :ivar type: The location type. Known values are: "Region", "EdgeZone".
...
class LocationMetadata(msrest.serialization.Model):
    ...
    :ivar region_type: The type of the region. Known values are: "Physical", "Logical".
...
class TenantIdDescription(msrest.serialization.Model):
    ...
    :vartype tenant_id: str
    :ivar tenant_category: Category of the tenant. Known values are: "Home", "ProjectedBy",
     "ManagedBy".
