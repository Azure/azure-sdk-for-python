...
class SubscriptionClient(SubscriptionClientOperationsMixin):
    ...
    :vartype subscriptions: azure.mgmt.resource.subscriptions.v2016_06_01.aio.operations.SubscriptionsOperations
    :ivar tenants: TenantsOperations operations
    :vartype tenants: azure.mgmt.resource.subscriptions.v2016_06_01.aio.operations.TenantsOperations
