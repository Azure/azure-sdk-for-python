...
class SubscriptionClient(SubscriptionClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype operations: azure.mgmt.resource.subscriptions.v2022_12_01.operations.Operations
    :ivar subscriptions: SubscriptionsOperations operations
    :vartype subscriptions:
     azure.mgmt.resource.subscriptions.v2022_12_01.operations.SubscriptionsOperations
    :ivar tenants: TenantsOperations operations
    :vartype tenants: azure.mgmt.resource.subscriptions.v2022_12_01.operations.TenantsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = SubscriptionClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
