...
class SubscriptionsOperations:
    ...
    @distributed_trace
    def list_locations(
        self, include_extended_locations: Optional[bool] = None, **kwargs: Any
    ...
    async def get(self, **kwargs: Any) -> _models.Subscription:
    ...
    async def check_zone_peers(
        self, parameters: _models.CheckZonePeersRequest, *, content_type: str = "application/json", **kwargs: Any
    ...
    @distributed_trace_async
    async def check_zone_peers(
        self, parameters: Union[_models.CheckZonePeersRequest, IO], **kwargs: Any
    ) -> _models.CheckZonePeersResult:
        """Compares a subscriptions logical zone mapping.
