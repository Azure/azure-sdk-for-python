...
class TenantsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.TenantListResult"
        """Gets the tenants for your account.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: TenantListResult or the result of cls(response)
        :rtype: ~azure.mgmt.resource.subscriptions.v2018_06_01.models.TenantListResult
