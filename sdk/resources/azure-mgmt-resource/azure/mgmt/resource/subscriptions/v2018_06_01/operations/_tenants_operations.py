...
class TenantsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of TenantListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.resource.subscriptions.v2018_06_01.models.TenantListResult]
