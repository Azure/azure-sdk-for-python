...
class CheckResourceNameResult(Model):
    ...
    def __init__(self, *, name: str=None, type: str=None, status=None, **kwargs) -> None:
...
class ErrorResponse(Model):
    ...
    :type error:
     ~azure.mgmt.resource.subscriptions.v2019_06_01.models.ErrorDefinition
    """
...
class Operation(Model):
    ...
    :type display:
     ~azure.mgmt.resource.subscriptions.v2019_06_01.models.OperationDisplay
    """
...
class Subscription(Model):
    ...
    :vartype state: str or
     ~azure.mgmt.resource.subscriptions.v2019_06_01.models.SubscriptionState
    ...
    def __init__(self, *, subscription_policies=None, authorization_source: str=None, managed_by_tenants=None, **kwargs) -> None:
