...
class TenantsOperations(object):
    ...
    :ivar api_version: The API version to use for the operation. Constant value: "2019-11-01".
    """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.resource.subscriptions.v2019_11_01.models.TenantIdDescriptionPaged[~azure.mgmt.resource.subscriptions.v2019_11_01.models.TenantIdDescription]
