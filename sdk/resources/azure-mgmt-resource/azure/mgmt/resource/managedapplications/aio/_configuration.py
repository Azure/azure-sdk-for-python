...
class ApplicationClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super(ApplicationClientConfiguration, self).__init__(**kwargs)
