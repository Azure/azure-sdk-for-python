...
class ApplicationClient(object):
    ...
    :vartype applications: azure.mgmt.resource.managedapplications.aio.operations_async.ApplicationsOperations
    :ivar application_definitions: ApplicationDefinitionsOperations operations
    :vartype application_definitions: azure.mgmt.resource.managedapplications.aio.operations_async.ApplicationDefinitionsOperations
    ...
    async def __aenter__(self) -> "ApplicationClient":
