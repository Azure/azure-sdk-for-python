...
class _ApplicationClientOperationsMixin(
    ...
    def list_operations(self, **kwargs: Any) -> ItemPaged["_models.Operation"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.resource.managedapplications.models.Operation]
...
class ApplicationsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, application_name: str, **kwargs: Any) -> _models.Application:
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.Application"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.managedapplications.models.Application]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def get_by_id(self, application_id: str, **kwargs: Any) -> _models.Application:
        """Gets the managed application.
...
class ApplicationDefinitionsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.ApplicationDefinition].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ApplicationDefinition](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either ApplicationDefinition or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resource.managedapplications.models.ApplicationDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class JitRequestsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, jit_request_name: str, **kwargs: Any) -> _models.JitRequestDefinition:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either JitRequestDefinition or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.resource.managedapplications.models.JitRequestDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
