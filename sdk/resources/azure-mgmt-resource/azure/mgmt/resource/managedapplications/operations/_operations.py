...
def build_applications_delete_request_initial(
    resource_group_name: str,
    application_name: str,
    subscription_id: str,
    **kwargs: Any
...
def build_applications_create_or_update_request_initial(
    resource_group_name: str,
    application_name: str,
    subscription_id: str,
    *,
...
def build_applications_delete_by_id_request_initial(
    application_id: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_applications_create_or_update_by_id_request_initial(
    application_id: str,
    *,
    json: Optional[_models.Application] = None,
    content: Any = None,
...
def build_application_definitions_delete_request_initial(
    resource_group_name: str,
    application_definition_name: str,
    subscription_id: str,
    **kwargs: Any
...
def build_application_definitions_create_or_update_request_initial(
    resource_group_name: str,
    application_definition_name: str,
    subscription_id: str,
    *,
    json: Optional[_models.ApplicationDefinition] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_application_definitions_delete_by_id_request_initial(
    resource_group_name: str,
    application_definition_name: str,
    subscription_id: str,
    **kwargs: Any
...
def build_application_definitions_create_or_update_by_id_request_initial(
    resource_group_name: str,
    application_definition_name: str,
    subscription_id: str,
    *,
...
class ApplicationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.managedapplications.ApplicationClient`'s
    ...
    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_applications_delete_request_initial(
            resource_group_name=resource_group_name,
            application_name=application_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        request = build_applications_create_or_update_request_initial(
            resource_group_name=resource_group_name,
            application_name=application_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def _delete_by_id_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_applications_delete_by_id_request_initial(
            application_id=application_id,
            api_version=api_version,
    ...
    def _create_or_update_by_id_initial(
        ...
        **kwargs: Any
        ...
        request = build_applications_create_or_update_by_id_request_initial(
            application_id=application_id,
            api_version=api_version,
            content_type=content_type,
            json=_json,
...
class ApplicationDefinitionsOperations:
    ...
    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_application_definitions_delete_request_initial(
            resource_group_name=resource_group_name,
            application_definition_name=application_definition_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        request = build_application_definitions_create_or_update_request_initial(
            resource_group_name=resource_group_name,
            application_definition_name=application_definition_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def _delete_by_id_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_application_definitions_delete_by_id_request_initial(
            resource_group_name=resource_group_name,
            application_definition_name=application_definition_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def _create_or_update_by_id_initial(
        ...
        **kwargs: Any
        ...
        request = build_application_definitions_create_or_update_by_id_request_initial(
            resource_group_name=resource_group_name,
            application_definition_name=application_definition_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
