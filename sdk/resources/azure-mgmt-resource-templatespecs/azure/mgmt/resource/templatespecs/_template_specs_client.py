...
class TemplateSpecsClient:
    ...
    :vartype template_specs: azure.mgmt.resource.templatespecs.operations.TemplateSpecsOperations
    :ivar template_spec_versions: TemplateSpecVersionsOperations operations
    :vartype template_spec_versions:
     azure.mgmt.resource.templatespecs.operations.TemplateSpecVersionsOperations
