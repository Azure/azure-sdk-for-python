...
class Alias(_serialization.Model):
    ...
    :vartype paths: list[~azure.mgmt.resources.deployments.models.AliasPath]
    :ivar type: The type of the alias. Known values are: "NotSpecified", "PlainText", and "Mask".
    :vartype type: str or ~azure.mgmt.resources.deployments.models.AliasType
    ...
    :vartype default_pattern: ~azure.mgmt.resources.deployments.models.AliasPattern
    ...
    :vartype default_metadata: ~azure.mgmt.resources.deployments.models.AliasPathMetadata
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype paths: list[~azure.mgmt.resources.deployments.models.AliasPath]
        :keyword type: The type of the alias. Known values are: "NotSpecified", "PlainText", and
         "Mask".
        :paramtype type: str or ~azure.mgmt.resources.deployments.models.AliasType
        ...
        :paramtype default_pattern: ~azure.mgmt.resources.deployments.models.AliasPattern
        """
...
class AliasPath(_serialization.Model):
    ...
    :vartype pattern: ~azure.mgmt.resources.deployments.models.AliasPattern
    :ivar metadata: The metadata of the alias path. If missing, fall back to the default metadata
     of the alias.
    :vartype metadata: ~azure.mgmt.resources.deployments.models.AliasPathMetadata
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype pattern: ~azure.mgmt.resources.deployments.models.AliasPattern
        """
        super().__init__(**kwargs)
        self.path = path
...
class AliasPathMetadata(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.resources.deployments.models.AliasPathTokenType
    :ivar attributes: The attributes of the token that the alias path is referring to. Known values
     are: "None" and "Modifiable".
    :vartype attributes: str or ~azure.mgmt.resources.deployments.models.AliasPathAttributes
    """
...
class AliasPattern(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.resources.deployments.models.AliasPatternType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype type: str or ~azure.mgmt.resources.deployments.models.AliasPatternType
        """
        super().__init__(**kwargs)
        self.phrase = phrase
...
class Dependency(_serialization.Model):
    ...
    :vartype depends_on: list[~azure.mgmt.resources.deployments.models.BasicDependency]
    :ivar id: The ID of the dependency.
    :vartype id: str
    :ivar resource_type: The dependency resource type.
    :vartype resource_type: str
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype depends_on: list[~azure.mgmt.resources.deployments.models.BasicDependency]
        :keyword id: The ID of the dependency.
        :paramtype id: str
        :keyword resource_type: The dependency resource type.
        :paramtype resource_type: str
...
class Deployment(_serialization.Model):
    ...
    :vartype properties: ~azure.mgmt.resources.deployments.models.DeploymentProperties
    :ivar tags: Deployment tags.
    :vartype tags: dict[str, str]
    :ivar identity: The Managed Identity configuration for a deployment.
    :vartype identity: ~azure.mgmt.resources.deployments.models.DeploymentIdentity
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties: ~azure.mgmt.resources.deployments.models.DeploymentProperties
        :keyword tags: Deployment tags.
        :paramtype tags: dict[str, str]
        :keyword identity: The Managed Identity configuration for a deployment.
        :paramtype identity: ~azure.mgmt.resources.deployments.models.DeploymentIdentity
        """
        super().__init__(**kwargs)
...
class DeploymentDiagnosticsDefinition(_serialization.Model):
    ...
    :ivar level: Denotes the additional response level. Required. Known values are: "Warning",
     "Info", and "Error".
    :vartype level: str or ~azure.mgmt.resources.deployments.models.Level
    ...
    :vartype additional_info: list[~azure.mgmt.resources.deployments.models.ErrorAdditionalInfo]
    """
...
class DeploymentExtended(_serialization.Model):
    ...
    :vartype properties: ~azure.mgmt.resources.deployments.models.DeploymentPropertiesExtended
    :ivar tags: Deployment tags.
    :vartype tags: dict[str, str]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties: ~azure.mgmt.resources.deployments.models.DeploymentPropertiesExtended
        :keyword tags: Deployment tags.
        :paramtype tags: dict[str, str]
        """
        super().__init__(**kwargs)
...
class DeploymentExtensionConfigItem(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.resources.deployments.models.ExtensionConfigPropertyType
    ...
    :vartype key_vault_reference:
     ~azure.mgmt.resources.deployments.models.KeyVaultParameterReference
    """
...
class DeploymentExtensionDefinition(_serialization.Model):
    ...
    :vartype config: dict[str,
     ~azure.mgmt.resources.deployments.models.DeploymentExtensionConfigItem]
    """
...
class DeploymentIdentity(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.resources.deployments.models.DeploymentIdentityType
    :ivar user_assigned_identities: The set of user assigned identities associated with the
     resource.
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.resources.deployments.models.UserAssignedIdentity]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype type: str or ~azure.mgmt.resources.deployments.models.DeploymentIdentityType
...
class DeploymentListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.resources.deployments.models.DeploymentExtended]
    ...
    def __init__(self, *, value: Optional[list["_models.DeploymentExtended"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.resources.deployments.models.DeploymentExtended]
        """
        super().__init__(**kwargs)
        self.value = value
...
class DeploymentOperation(_serialization.Model):
    ...
    :ivar properties: Deployment properties.
    :vartype properties: ~azure.mgmt.resources.deployments.models.DeploymentOperationProperties
    """
    ...
    def __init__(self, *, properties: Optional["_models.DeploymentOperationProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: Deployment properties.
        :paramtype properties: ~azure.mgmt.resources.deployments.models.DeploymentOperationProperties
        """
        super().__init__(**kwargs)
        self.id: Optional[str] = None
...
class DeploymentOperationProperties(_serialization.Model):
    ...
    :vartype provisioning_operation: str or
     ~azure.mgmt.resources.deployments.models.ProvisioningOperation
    ...
    :vartype status_message: ~azure.mgmt.resources.deployments.models.StatusMessage
    :ivar target_resource: The target resource.
    :vartype target_resource: ~azure.mgmt.resources.deployments.models.TargetResource
    :ivar request: The HTTP request message.
    :vartype request: ~azure.mgmt.resources.deployments.models.HttpMessage
    :ivar response: The HTTP response message.
    :vartype response: ~azure.mgmt.resources.deployments.models.HttpMessage
    """
...
class DeploymentOperationsListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.resources.deployments.models.DeploymentOperation]
    :ivar next_link: The URL to use for getting the next set of results.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: Optional[list["_models.DeploymentOperation"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.resources.deployments.models.DeploymentOperation]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link: Optional[str] = None
...
class DeploymentParameter(_serialization.Model):
    ...
    :vartype reference: ~azure.mgmt.resources.deployments.models.KeyVaultParameterReference
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype reference: ~azure.mgmt.resources.deployments.models.KeyVaultParameterReference
...
class DeploymentProperties(_serialization.Model):
    ...
    :vartype template_link: ~azure.mgmt.resources.deployments.models.TemplateLink
    ...
    :vartype parameters: dict[str, ~azure.mgmt.resources.deployments.models.DeploymentParameter]
    :ivar external_inputs: External input values, used by external tooling for parameter
     evaluation.
    :vartype external_inputs: dict[str,
     ~azure.mgmt.resources.deployments.models.DeploymentExternalInput]
    ...
    :vartype external_input_definitions: dict[str,
     ~azure.mgmt.resources.deployments.models.DeploymentExternalInputDefinition]
    :ivar parameters_link: The URI of parameters file. You use this element to link to an existing
     ...
     both.
    :vartype parameters_link: ~azure.mgmt.resources.deployments.models.ParametersLink
    ...
    :vartype mode: str or ~azure.mgmt.resources.deployments.models.DeploymentMode
    :ivar debug_setting: The debug setting of the deployment.
    :vartype debug_setting: ~azure.mgmt.resources.deployments.models.DebugSetting
    :ivar on_error_deployment: The deployment on error behavior.
    :vartype on_error_deployment: ~azure.mgmt.resources.deployments.models.OnErrorDeployment
    ...
    :vartype expression_evaluation_options:
     ~azure.mgmt.resources.deployments.models.ExpressionEvaluationOptions
    :ivar validation_level: The validation level of the deployment. Known values are: "Template",
     "Provider", and "ProviderNoRbac".
    :vartype validation_level: str or ~azure.mgmt.resources.deployments.models.ValidationLevel
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword template_link: The URI of the template. Use either the templateLink property or the
         template property, but not both.
        :paramtype template_link: ~azure.mgmt.resources.deployments.models.TemplateLink
        ...
        :paramtype parameters: dict[str, ~azure.mgmt.resources.deployments.models.DeploymentParameter]
        ...
        :keyword parameters_link: The URI of parameters file. You use this element to link to an
         ...
         but not both.
        :paramtype parameters_link: ~azure.mgmt.resources.deployments.models.ParametersLink
        ...
        :keyword mode: The mode that is used to deploy resources. This value can be either Incremental
         ...
         when using Complete mode as you may unintentionally delete resources. Required. Known values
         are: "Incremental" and "Complete".
        :paramtype mode: str or ~azure.mgmt.resources.deployments.models.DeploymentMode
        :keyword debug_setting: The debug setting of the deployment.
        :paramtype debug_setting: ~azure.mgmt.resources.deployments.models.DebugSetting
        :keyword on_error_deployment: The deployment on error behavior.
        :paramtype on_error_deployment: ~azure.mgmt.resources.deployments.models.OnErrorDeployment
        ...
        :paramtype validation_level: str or ~azure.mgmt.resources.deployments.models.ValidationLevel
        """
        super().__init__(**kwargs)
        self.template = template
...
class DeploymentPropertiesExtended(_serialization.Model):
    ...
    :vartype provisioning_state: str or ~azure.mgmt.resources.deployments.models.ProvisioningState
    ...
    :vartype providers: list[~azure.mgmt.resources.deployments.models.Provider]
    :ivar dependencies: The list of deployment dependencies.
    :vartype dependencies: list[~azure.mgmt.resources.deployments.models.Dependency]
    ...
    :vartype extensions:
     list[~azure.mgmt.resources.deployments.models.DeploymentExtensionDefinition]
    ...
    :vartype on_error_deployment:
     ~azure.mgmt.resources.deployments.models.OnErrorDeploymentExtended
    ...
    :vartype output_resources: list[~azure.mgmt.resources.deployments.models.ResourceReference]
    :ivar validated_resources: Array of validated resources.
    :vartype validated_resources: list[~azure.mgmt.resources.deployments.models.ResourceReference]
    :ivar error: The deployment error.
    :vartype error: ~azure.mgmt.resources.deployments.models.ErrorResponse
    :ivar diagnostics: Contains diagnostic information collected during validation process.
    :vartype diagnostics:
     list[~azure.mgmt.resources.deployments.models.DeploymentDiagnosticsDefinition]
    :ivar validation_level: The validation level of the deployment. Known values are: "Template",
     "Provider", and "ProviderNoRbac".
    :vartype validation_level: str or ~azure.mgmt.resources.deployments.models.ValidationLevel
    """
...
class DeploymentWhatIf(_serialization.Model):
    ...
    :vartype location: str
    :ivar properties: The deployment properties. Required.
    :vartype properties: ~azure.mgmt.resources.deployments.models.DeploymentWhatIfProperties
    """
    ...
    def __init__(
        ...
        :paramtype location: str
        :keyword properties: The deployment properties. Required.
        :paramtype properties: ~azure.mgmt.resources.deployments.models.DeploymentWhatIfProperties
        """
        super().__init__(**kwargs)
        self.location = location
        self.properties = properties
...
class DeploymentWhatIfProperties(DeploymentProperties):
    ...
    :vartype what_if_settings: ~azure.mgmt.resources.deployments.models.DeploymentWhatIfSettings
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype what_if_settings: ~azure.mgmt.resources.deployments.models.DeploymentWhatIfSettings
        """
        super().__init__(
            template=template,
...
class DeploymentWhatIfSettings(_serialization.Model):
    ...
    :vartype result_format: str or ~azure.mgmt.resources.deployments.models.WhatIfResultFormat
    """
    ...
    def __init__(
        ...
        :paramtype result_format: str or ~azure.mgmt.resources.deployments.models.WhatIfResultFormat
        """
        super().__init__(**kwargs)
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.resources.deployments.models.ErrorResponse]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.resources.deployments.models.ErrorAdditionalInfo]
    """
...
class ExpressionEvaluationOptions(_serialization.Model):
    ...
    :vartype scope: str or
     ~azure.mgmt.resources.deployments.models.ExpressionEvaluationOptionsScopeType
    """
...
class KeyVaultParameterReference(_serialization.Model):
    ...
    :vartype key_vault: ~azure.mgmt.resources.deployments.models.KeyVaultReference
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype key_vault: ~azure.mgmt.resources.deployments.models.KeyVaultReference
...
class OnErrorDeployment(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.resources.deployments.models.OnErrorDeploymentType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The deployment on error behavior type. Possible values are LastSuccessful and
         SpecificDeployment. Known values are: "LastSuccessful" and "SpecificDeployment".
        :paramtype type: str or ~azure.mgmt.resources.deployments.models.OnErrorDeploymentType
...
class Provider(_serialization.Model):
    ...
    :vartype resource_types: list[~azure.mgmt.resources.deployments.models.ProviderResourceType]
    ...
    :vartype provider_authorization_consent_state: str or
     ~azure.mgmt.resources.deployments.models.ProviderAuthorizationConsentState
    """
...
class ProviderResourceType(_serialization.Model):
    ...
    :vartype location_mappings:
     list[~azure.mgmt.resources.deployments.models.ProviderExtendedLocation]
    :ivar aliases: The aliases that are supported by this resource type.
    :vartype aliases: list[~azure.mgmt.resources.deployments.models.Alias]
    :ivar api_versions: The API version.
    :vartype api_versions: list[str]
    :ivar default_api_version: The default API version.
    :vartype default_api_version: str
    :ivar zone_mappings:
    :vartype zone_mappings: list[~azure.mgmt.resources.deployments.models.ZoneMapping]
    :ivar api_profiles: The API profiles for the resource provider.
    :vartype api_profiles: list[~azure.mgmt.resources.deployments.models.ApiProfile]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype aliases: list[~azure.mgmt.resources.deployments.models.Alias]
        :keyword api_versions: The API version.
        :paramtype api_versions: list[str]
        :keyword zone_mappings:
        :paramtype zone_mappings: list[~azure.mgmt.resources.deployments.models.ZoneMapping]
...
class ResourceReference(_serialization.Model):
    ...
    :vartype extension: ~azure.mgmt.resources.deployments.models.DeploymentExtensionDefinition
    :ivar resource_type: The resource type.
    :vartype resource_type: str
...
class StatusMessage(_serialization.Model):
    ...
    def __init__(
        ...
        :paramtype error: ~azure.mgmt.resources.deployments.models.ErrorResponse
        """
        super().__init__(**kwargs)
        self.status = status
        self.error = error
...
class TargetResource(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype extension: ~azure.mgmt.resources.deployments.models.DeploymentExtensionDefinition
...
class WhatIfChange(_serialization.Model):
    ...
    :vartype change_type: str or ~azure.mgmt.resources.deployments.models.ChangeType
    ...
    :vartype delta: list[~azure.mgmt.resources.deployments.models.WhatIfPropertyChange]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword change_type: Type of change that will be made to the resource when the deployment is
         executed. Required. Known values are: "Create", "Delete", "Ignore", "Deploy", "NoChange",
         "Modify", and "Unsupported".
        :paramtype change_type: str or ~azure.mgmt.resources.deployments.models.ChangeType
        ...
        :paramtype delta: list[~azure.mgmt.resources.deployments.models.WhatIfPropertyChange]
        """
        super().__init__(**kwargs)
...
class WhatIfOperationResult(_serialization.Model):
    ...
    :vartype changes: list[~azure.mgmt.resources.deployments.models.WhatIfChange]
    :ivar potential_changes: List of resource changes predicted by What-If operation.
    :vartype potential_changes: list[~azure.mgmt.resources.deployments.models.WhatIfChange]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype changes: list[~azure.mgmt.resources.deployments.models.WhatIfChange]
        :keyword potential_changes: List of resource changes predicted by What-If operation.
        :paramtype potential_changes: list[~azure.mgmt.resources.deployments.models.WhatIfChange]
        """
        super().__init__(**kwargs)
        self.status = status
        self.error = error
...
class WhatIfPropertyChange(_serialization.Model):
    ...
    :vartype property_change_type: str or
     ~azure.mgmt.resources.deployments.models.PropertyChangeType
    ...
    :vartype children: list[~azure.mgmt.resources.deployments.models.WhatIfPropertyChange]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype children: list[~azure.mgmt.resources.deployments.models.WhatIfPropertyChange]
        """
        super().__init__(**kwargs)
        self.path = path
