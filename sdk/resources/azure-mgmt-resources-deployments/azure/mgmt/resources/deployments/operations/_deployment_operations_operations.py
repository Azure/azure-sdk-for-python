...
from .._configuration import DeploymentsClientConfiguration
...
def build_get_at_scope_request(scope: str, deployment_name: str, operation_id: str, **kwargs: Any) -> HttpRequest:
...
def build_get_at_tenant_scope_request(deployment_name: str, operation_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_at_management_group_scope_request(  # pylint: disable=name-too-long
...
def build_list_at_management_group_scope_request(  # pylint: disable=name-too-long
...
class DeploymentOperationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resources.deployments.DeploymentsClient`'s
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: DeploymentsClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def get_at_scope(
        ...
        :rtype: ~azure.mgmt.resources.deployments.models.DeploymentOperation
        ...
        _request = build_get_at_scope_request(
            scope=scope,
    ...
    def list_at_scope(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.resources.deployments.models.DeploymentOperation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_at_scope_request(
                    scope=scope,
                    deployment_name=deployment_name,
                    top=top,
                    api_version=api_version,
    ...
    def get_at_tenant_scope(
        ...
        _request = build_get_at_tenant_scope_request(
            deployment_name=deployment_name,
            operation_id=operation_id,
            api_version=api_version,
            headers=_headers,
    ...
    def list_at_tenant_scope(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_at_tenant_scope_request(
                    deployment_name=deployment_name,
                    top=top,
                    api_version=api_version,
                    headers=_headers,
    ...
    def get_at_management_group_scope(
        ...
        _request = build_get_at_management_group_scope_request(
            group_id=group_id,
            deployment_name=deployment_name,
            operation_id=operation_id,
            api_version=api_version,
    ...
    def list_at_management_group_scope(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_at_management_group_scope_request(
                    group_id=group_id,
                    deployment_name=deployment_name,
                    top=top,
                    api_version=api_version,
    ...
    def get_at_subscription_scope(
        ...
        _request = build_get_at_subscription_scope_request(
            deployment_name=deployment_name,
            operation_id=operation_id,
