...
class DeploymentsClient:
    ...
    :vartype deployments: azure.mgmt.resources.deployments.aio.operations.DeploymentsOperations
    :ivar deployment_operations: DeploymentOperationsOperations operations
    :vartype deployment_operations:
     azure.mgmt.resources.deployments.aio.operations.DeploymentOperationsOperations
