...
class DeploymentsClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for DeploymentsClient.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        kwargs.setdefault("sdk_moniker", "mgmt-resources-deployments/{}".format(VERSION))
