...
class TemplateSpecsClient:
    ...
    :vartype template_specs:
     azure.mgmt.resources.templatespecs.aio.operations.TemplateSpecsOperations
    :ivar template_spec_versions: TemplateSpecVersionsOperations operations
    :vartype template_spec_versions:
     azure.mgmt.resources.templatespecs.aio.operations.TemplateSpecVersionsOperations
