...
def build_list_at_resource_group_request(resource_group_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
...
def build_list_at_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_at_management_group_request(management_group_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_at_subscription_request(deployment_stack_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_create_or_update_at_management_group_request(  # pylint: disable=name-too-long
...
def build_export_template_at_resource_group_request(  # pylint: disable=name-too-long
    resource_group_name: str, deployment_stack_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_export_template_at_subscription_request(  # pylint: disable=name-too-long
    deployment_stack_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_export_template_at_management_group_request(  # pylint: disable=name-too-long
    management_group_id: str, deployment_stack_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_validate_stack_at_resource_group_request(  # pylint: disable=name-too-long
    resource_group_name: str, deployment_stack_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_validate_stack_at_subscription_request(  # pylint: disable=name-too-long
    deployment_stack_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_validate_stack_at_management_group_request(  # pylint: disable=name-too-long
    management_group_id: str, deployment_stack_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DeploymentStacksOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_create_or_update_at_resource_group(
        ...
        **kwargs: Any
        ...
        :type deployment_stack: ~azure.mgmt.resources.deploymentstacks.models.DeploymentStack or
         IO[bytes]
        :return: An instance of LROPoller that returns either DeploymentStack or the result of
         cls(response)
        :rtype:
    ...
    def begin_delete_at_resource_group(
        ...
        **kwargs: Any
        ...
        :type unmanage_action_resources: str or
         ~azure.mgmt.resources.deploymentstacks.models.UnmanageActionResourceMode
        ...
        :type unmanage_action_resource_groups: str or
         ~azure.mgmt.resources.deploymentstacks.models.UnmanageActionResourceGroupMode
        ...
        :type unmanage_action_management_groups: str or
         ~azure.mgmt.resources.deploymentstacks.models.UnmanageActionManagementGroupMode
