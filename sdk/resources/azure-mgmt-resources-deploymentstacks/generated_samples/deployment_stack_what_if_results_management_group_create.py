...
# USAGE
    python deployment_stack_what_if_results_management_group_create.py
...
def main():
    ...
    response = client.deployment_stacks_what_if_results_at_management_group.begin_create_or_update(
