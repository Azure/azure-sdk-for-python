...
def build_resources_move_resources_request(
    ...
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "sourceResourceGroupName": _SERIALIZER.url("source_resource_group_name", source_resource_group_name, "str"),
    }
...
def build_resources_get_by_id_request(resource_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_resources_update_by_id_request(resource_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_resources_delete_by_id_request(resource_id: str, **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_resources_check_existence_request(
    ...
    **kwargs: Any
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2025-04-01"))
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{parentResourcePath}/{resourceType}/{resourceName}"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resources.ResourcesClient`'s
    ...
    def list(self, **kwargs: Any) -> ItemPaged["_models.Operation"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.resources.models.Operation]
...
class ResourceGroupsOperations:
    ...
    def get(self, resource_group_name: str, **kwargs: Any) -> _models.ResourceGroup:
        ...
        :return: ResourceGroup. The ResourceGroup is compatible with MutableMapping
        :rtype: ~azure.mgmt.resources.models.ResourceGroup
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.ResourceGroup, response.json())
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resources.models.ResourceGroup
    ...
    @distributed_trace
    def create_or_update(
        self, resource_group_name: str, parameters: Union[_models.ResourceGroup, JSON, IO[bytes]], **kwargs: Any
    ) -> _models.ResourceGroup:
        """Creates or updates a resource group.
        ...
        :param resource_group_name: The name of the resource group to get. The name is case
         insensitive. Required.
        :type resource_group_name: str
        :param parameters: Parameters supplied to the create or update a resource group. Is one of the
         following types: ResourceGroup, JSON, IO[bytes] Required.
        :type parameters: ~azure.mgmt.resources.models.ResourceGroup or JSON or IO[bytes]
        :return: ResourceGroup. The ResourceGroup is compatible with MutableMapping
        :rtype: ~azure.mgmt.resources.models.ResourceGroup
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resources.models.ResourceGroupPatchable
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ResourceGroup. The ResourceGroup is compatible with MutableMapping
    ...
    def update(
        self,
        resource_group_name: str,
        parameters: Union[_models.ResourceGroupPatchable, JSON, IO[bytes]],
        **kwargs: Any
    ) -> _models.ResourceGroup:
        """Updates a resource group.
        ...
        :param resource_group_name: The name of the resource group to get. The name is case
         insensitive. Required.
        :type resource_group_name: str
        :param parameters: Parameters supplied to update a resource group. Is one of the following
         types: ResourceGroupPatchable, JSON, IO[bytes] Required.
        :type parameters: ~azure.mgmt.resources.models.ResourceGroupPatchable or JSON or IO[bytes]
        :return: ResourceGroup. The ResourceGroup is compatible with MutableMapping
        :rtype: ~azure.mgmt.resources.models.ResourceGroup
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        :keyword filter: The filter to apply on the operation.<br><br>You can filter by tag names and
         values. For example, to filter for a tag name and value, use $filter=tagName eq 'tag1' and
         tagValue eq 'Value1'. Default value is None.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.resources.models.ResourceGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[List[_models.ResourceGroup]] = kwargs.pop("cls", None)
    ...
    def _export_template_initial(
        self, resource_group_name: str, parameters: Union[_models.ExportTemplateRequest, JSON, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_export_template(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resources.models.ExportTemplateRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns ResourceGroupExportResult. The
         ResourceGroupExportResult is compatible with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.resources.models.ResourceGroupExportResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_export_template(
        ...
        :param resource_group_name: The name of the resource group to get. The name is case
         insensitive. Required.
        :type resource_group_name: str
        :param parameters: Parameters for exporting the template. Is one of the following types:
         ExportTemplateRequest, JSON, IO[bytes] Required.
        :type parameters: ~azure.mgmt.resources.models.ExportTemplateRequest or JSON or IO[bytes]
        :return: An instance of LROPoller that returns ResourceGroupExportResult. The
         ResourceGroupExportResult is compatible with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.resources.models.ResourceGroupExportResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        def get_long_running_output(pipeline_response):
            ...
            deserialized = _deserialize(_models.ResourceGroupExportResult, response.json())
            if cls:
                return cls(pipeline_response, deserialized, response_headers)  # type: ignore
            return deserialized
...
class ResourcesOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :param resource_group_name: The name of the resource group to get. The name is case
         insensitive. Required.
        :type resource_group_name: str
        :keyword filter: The filter to apply on the operation.<br><br>The properties you can use for eq
         (equals) or ne (not equals) are: location, resourceType, name, resourceGroup, identity,
         identity/principalId, plan, plan/publisher, plan/product, plan/name, plan/version, and
         plan/promotionCode.<br><br>For example, to filter by a resource type, use: $filter=resourceType
         eq 'Microsoft.Network/virtualNetworks'<br><br>You can use substringof(value, property) in the
         filter. The properties you can use for substring are: name and resourceGroup.<br><br>For
         example, to get all resources with 'demo' anywhere in the name, use:
         $filter=substringof('demo', name)<br><br>You can link more than one substringof together by
         adding and/or operators.<br><br>You can filter by tag names and values. For example, to filter
         for a tag name and value, use $filter=tagName eq 'tag1' and tagValue eq 'Value1'. When you
         filter by a tag name and value, the tags for each resource are not returned in the
         ...
         identity/principalId. Default value is None.
        :paramtype filter: str
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.resources.models.GenericResourceExpanded]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[List[_models.GenericResourceExpanded]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.GenericResourceExpanded],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
    ...
    def _move_resources_initial(
        ...
        parameters: Union[_models.ResourcesMoveInfo, JSON, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_move_resources(
        ...
        **kwargs: Any
        ...
        :param source_resource_group_name: The name of the resource group to get. The name is case
         insensitive. Required.
        :type source_resource_group_name: str
        :param parameters: Parameters for moving resources. Required.
        :type parameters: ~azure.mgmt.resources.models.ResourcesMoveInfo
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns None
    ...
    def begin_move_resources(
        ...
        **kwargs: Any
        ...
        :param source_resource_group_name: The name of the resource group to get. The name is case
         insensitive. Required.
        :type source_resource_group_name: str
        :param parameters: Parameters for moving resources. Is one of the following types:
         ResourcesMoveInfo, JSON, IO[bytes] Required.
        :type parameters: ~azure.mgmt.resources.models.ResourcesMoveInfo or JSON or IO[bytes]
        :return: An instance of LROPoller that returns None
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def check_existence_by_id(self, resource_id: str, **kwargs: Any) -> bool:
    ...
    @distributed_trace
    def get_by_id(self, resource_id: str, **kwargs: Any) -> _models.GenericResource:
        """Gets a resource by ID.

        :param resource_id: Required.
        :type resource_id: str
        :return: GenericResource. The GenericResource is compatible with MutableMapping
        :rtype: ~azure.mgmt.resources.models.GenericResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.GenericResource, response.json())
    ...
    def _create_or_update_by_id_initial(
        self, resource_id: str, parameters: Union[_models.GenericResource, JSON, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_create_or_update_by_id(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resources.models.GenericResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns GenericResource. The GenericResource is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.resources.models.GenericResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

    @overload
    def begin_create_or_update_by_id(
        self, resource_id: str, parameters: JSON, *, content_type: str = "application/json", **kwargs: Any
    ) -> LROPoller[_models.GenericResource]:
        """Create a resource by ID.
    ...
    @overload
    def begin_create_or_update_by_id(
        self, resource_id: str, parameters: IO[bytes], *, content_type: str = "application/json", **kwargs: Any
    ) -> LROPoller[_models.GenericResource]:
        """Create a resource by ID.
    ...
    def begin_create_or_update_by_id(
        ...
        :param resource_id: Required.
        :type resource_id: str
        :param parameters: Resource create parameters. Is one of the following types: GenericResource,
         JSON, IO[bytes] Required.
        :type parameters: ~azure.mgmt.resources.models.GenericResource or JSON or IO[bytes]
        :return: An instance of LROPoller that returns GenericResource. The GenericResource is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.resources.models.GenericResource]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _delete_by_id_initial(self, resource_id: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def begin_delete_by_id(self, resource_id: str, **kwargs: Any) -> LROPoller[None]:
        ...
        if cont_token is None:
            raw_result = self._delete_by_id_initial(
                resource_id=resource_id, cls=lambda x, y, z: x, headers=_headers, params=_params, **kwargs
            )
            raw_result.http_response.read()  # type: ignore
        kwargs.pop("error_map", None)
    ...
    def _create_or_update_initial(
        ...
        resource_type: str,
        resource_name: str,
        parameters: Union[_models.GenericResource, JSON, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list(
        ...
        :keyword filter: The filter to apply on the operation.<br><br>Filter comparison operators
         include ``eq`` (equals) and ``ne`` (not equals) and may be used with the following properties:
         ``location``, ``resourceType``, ``name``, ``resourceGroup``, ``identity``,
         ``identity/principalId``, ``plan``, ``plan/publisher``, ``plan/product``, ``plan/name``,
         ``plan/version``, and ``plan/promotionCode``.<br><br>For example, to filter by a resource type,
         ...
         name, use ``$filter=substringof('demo', name)``<br><br>Multiple substring operations can also
         be combined using ``and``/``or`` operators.<br><br>Note that any truncated number of results
         queried via ``$top`` may also not be compatible when using a filter.<br><br><br>Resources can
         be filtered by tag names and values. For example, to filter for a tag name and value, use
         ``$filter=tagName eq 'tag1' and tagValue eq 'Value1'``. Note that when resources are filtered
         by tag name and value, <b>the original tags for each resource will not be returned in the
         results.</b> Any list of additional properties queried via ``$expand`` may also not be
         compatible when filtering by tag names/values. <br><br>For tag names only, resources can be
         filtered by prefix using the following syntax: ``$filter=startswith(tagName, 'depart')``. This
         query will return all resources with a tag name prefixed by the phrase ``depart``
         (i.e.``department``, ``departureDate``, ``departureTime``, etc.)<br><br><br>Note that some
         properties can be combined when filtering resources, which include the following:
...
class TagsOperations:
    ...
    def get_at_scope(self, scope: str, **kwargs: Any) -> _models.TagsResource:
        ...
        :type scope: str
        :return: TagsResource. The TagsResource is compatible with MutableMapping
        :rtype: ~azure.mgmt.resources.models.TagsResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.TagsResource, response.json())
    ...
    def _create_or_update_at_scope_initial(
        self, scope: str, parameters: Union[_models.TagsResource, JSON, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_create_or_update_at_scope(
        ...
        :type parameters: ~azure.mgmt.resources.models.TagsResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns None
    ...
    def begin_create_or_update_at_scope(
        ...
        :param scope: The fully qualified Azure Resource manager identifier of the resource. Required.
        :type scope: str
        :param parameters: Is one of the following types: TagsResource, JSON, IO[bytes] Required.
        :type parameters: ~azure.mgmt.resources.models.TagsResource or JSON or IO[bytes]
        :return: An instance of LROPoller that returns None
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_at_scope_initial(
        self, scope: str, parameters: Union[_models.TagsPatchResource, JSON, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_update_at_scope(
        ...
        **kwargs: Any
        ...
        :type scope: str
        :param parameters: Required.
        :type parameters: ~azure.mgmt.resources.models.TagsPatchResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns TagsResource. The TagsResource is compatible
         with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.resources.models.TagsResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update_at_scope(
        ...
        :param scope: The fully qualified Azure Resource manager identifier of the resource. Required.
        :type scope: str
        :param parameters: Is one of the following types: TagsPatchResource, JSON, IO[bytes] Required.
        :type parameters: ~azure.mgmt.resources.models.TagsPatchResource or JSON or IO[bytes]
        :return: An instance of LROPoller that returns TagsResource. The TagsResource is compatible
         with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.resources.models.TagsResource]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def create_or_update_value(self, tag_name: str, tag_value: str, **kwargs: Any) -> _models.TagValue:
        ...
        :type tag_value: str
        :return: TagValue. The TagValue is compatible with MutableMapping
        :rtype: ~azure.mgmt.resources.models.TagValue
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.TagValue, response.json())
    ...
    def create_or_update(self, tag_name: str, **kwargs: Any) -> _models.TagDetails:
        ...
        :type tag_name: str
        :return: TagDetails. The TagDetails is compatible with MutableMapping
        :rtype: ~azure.mgmt.resources.models.TagDetails
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.TagDetails, response.json())
    ...
    def list(self, **kwargs: Any) -> ItemPaged["_models.TagDetails"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.resources.models.TagDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[List[_models.TagDetails]] = kwargs.pop("cls", None)
...
class ProvidersOperations:
    ...
    def list_at_tenant_scope(self, *, expand: Optional[str] = None, **kwargs: Any) -> ItemPaged["_models.Provider"]:
        ...
        :keyword expand: The properties to include in the results. Default value is None.
        :paramtype expand: str
        :return: An iterator like instance of Provider
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.resources.models.Provider]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[List[_models.Provider]] = kwargs.pop("cls", None)
    ...
    def unregister(self, resource_provider_namespace: str, **kwargs: Any) -> _models.Provider:
        ...
        :param resource_provider_namespace: The namespace of the resource provider to unregister.
         Required.
        :type resource_provider_namespace: str
        :return: Provider. The Provider is compatible with MutableMapping
        :rtype: ~azure.mgmt.resources.models.Provider
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.Provider, response.json())
    ...
    def register_at_management_group_scope(  # pylint: disable=inconsistent-return-statements
        ...
        :param resource_provider_namespace: The management group ID.The namespace of the resource
         provider to register. Required.
        :type resource_provider_namespace: str
    ...
    def provider_permissions(
        ...
        :type resource_provider_namespace: str
        :return: ProviderPermissionListResult. The ProviderPermissionListResult is compatible with
         MutableMapping
        :rtype: ~azure.mgmt.resources.models.ProviderPermissionListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.ProviderPermissionListResult, response.json())
    ...
    def register(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.resources.models.ProviderRegistrationRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Provider. The Provider is compatible with MutableMapping
    ...
    def register(
        self,
        resource_provider_namespace: str,
        properties: Optional[Union[_models.ProviderRegistrationRequest, JSON, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.Provider:
        """Registers a subscription with a resource provider.
        ...
        :param resource_provider_namespace: The namespace of the resource provider to register.
         Required.
        :type resource_provider_namespace: str
        :param properties: The third party consent for S2S. Is one of the following types:
         ProviderRegistrationRequest, JSON, IO[bytes] Default value is None.
        :type properties: ~azure.mgmt.resources.models.ProviderRegistrationRequest or JSON or IO[bytes]
        :return: Provider. The Provider is compatible with MutableMapping
        :rtype: ~azure.mgmt.resources.models.Provider
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class ProviderResourceTypesOperations:
    ...
    def list(
        ...
        :paramtype expand: str
        :return: ProviderResourceTypeListResult. The ProviderResourceTypeListResult is compatible with
         MutableMapping
        :rtype: ~azure.mgmt.resources.models.ProviderResourceTypeListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.ProviderResourceTypeListResult, response.json())
