...
class _ApplicationClientOperationsMixin(
    ...
    def list_operations(self, **kwargs: Any) -> AsyncItemPaged["_models.Operation"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.managedapplications.models.Operation]
...
class ApplicationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.managedapplications.aio.ApplicationClient`'s
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Application or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.resource.managedapplications.models.Application]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.managedapplications.models.Application or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Application or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.resource.managedapplications.models.Application]
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.managedapplications.models.ApplicationPatchable or
         IO[bytes]
        :return: Application or None or the result of cls(response)
        :rtype: ~azure.mgmt.resource.managedapplications.models.Application or None
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncItemPaged["_models.Application"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.managedapplications.models.Application]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ApplicationDefinitionsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ApplicationDefinition or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.resource.managedapplications.models.ApplicationDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.managedapplications.models.ApplicationDefinition or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ApplicationDefinition or the result
         of cls(response)
        :rtype:
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either ApplicationDefinition or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.managedapplications.models.ApplicationDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class JitRequestsOperations:
    ...
    async def get(self, resource_group_name: str, jit_request_name: str, **kwargs: Any) -> _models.JitRequestDefinition:
        ...
        :rtype: ~azure.mgmt.resource.managedapplications.models.JitRequestDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.managedapplications.models.JitRequestDefinition
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either JitRequestDefinition or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.resource.managedapplications.models.JitRequestDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.managedapplications.models.JitRequestDefinition or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either JitRequestDefinition or the result
         of cls(response)
        :rtype:
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type jit_request_name: str
        :param parameters: Parameters supplied to the update JIT request. Required.
        :type parameters: ~azure.mgmt.resource.managedapplications.models.JitRequestPatchable
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: JitRequestDefinition or the result of cls(response)
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.resource.managedapplications.models.JitRequestPatchable or
         IO[bytes]
        :return: JitRequestDefinition or the result of cls(response)
        :rtype: ~azure.mgmt.resource.managedapplications.models.JitRequestDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def list_by_subscription(self, **kwargs: Any) -> _models.JitRequestDefinitionListResult:
        ...
        :rtype: ~azure.mgmt.resource.managedapplications.models.JitRequestDefinitionListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
