...
class Alias(_Model):
    ...
    default_metadata: Optional["_models.AliasPathMetadata"] = rest_field(
        name="defaultMetadata", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        ...
        default_metadata: Optional["_models.AliasPathMetadata"] = None,
    ) -> None: ...
...
class AliasPathMetadata(_Model):
    ...
    type: Optional[Union[str, "_models.AliasPathTokenType"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    attributes: Optional[Union[str, "_models.AliasPathAttributes"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        type: Optional[Union[str, "_models.AliasPathTokenType"]] = None,
        attributes: Optional[Union[str, "_models.AliasPathAttributes"]] = None,
    ) -> None: ...
...
class AliasPattern(_Model):
    ...
    :ivar type: The pattern for an alias path. Known values are: "NotSpecified" and "Extract".
...
class DataEffect(_Model):
    ...
    details_schema: Optional[Any] = rest_field(
        name="detailsSchema", visibility=["read", "create", "update", "delete", "query"]
    )
...
class DataManifestCustomResourceFunctionDefinition(_Model):  # pylint: disable=name-too-long
    ...
    fully_qualified_resource_type: Optional[str] = rest_field(
        name="fullyQualifiedResourceType", visibility=["read", "create", "update", "delete", "query"]
    )
    """The fully qualified control plane resource type that this function represents. eg -
     'Microsoft.KeyVault/vaults'."""
    default_properties: Optional[list[str]] = rest_field(
        name="defaultProperties", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    allow_custom_properties: Optional[bool] = rest_field(
        name="allowCustomProperties", visibility=["read", "create", "update", "delete", "query"]
    )
...
class DataManifestResourceFunctionsDefinition(_Model):
    ...
    :ivar custom: An array of data manifest custom resource definitions.
    :vartype custom:
     list[~azure.mgmt.resource.policy.models.DataManifestCustomResourceFunctionDefinition]
    """

    standard: Optional[list[str]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The standard resource functions (subscription and/or resourceGroup)."""
    custom: Optional[list["_models.DataManifestCustomResourceFunctionDefinition"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
...
class DataPolicyManifest(ProxyResource):
    ...
    :vartype properties: ~azure.mgmt.resource.policy.models.DataPolicyManifestProperties
    """

    properties: Optional["_models.DataPolicyManifestProperties"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        properties: Optional["_models.DataPolicyManifestProperties"] = None,
    ) -> None: ...
...
class DataPolicyManifestProperties(_Model):
    ...
    :ivar resource_functions: The resource functions definition specified in the data manifest.
    :vartype resource_functions:
     ~azure.mgmt.resource.policy.models.DataManifestResourceFunctionsDefinition
    """

    namespaces: Optional[list[str]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The list of namespaces for the data policy manifest."""
    policy_mode: Optional[str] = rest_field(
        name="policyMode", visibility=["read", "create", "update", "delete", "query"]
    )
    """The policy mode of the data policy manifest."""
    is_built_in_only: Optional[bool] = rest_field(
        name="isBuiltInOnly", visibility=["read", "create", "update", "delete", "query"]
    )
    """A value indicating whether policy mode is allowed only in built-in definitions."""
    resource_type_aliases: Optional[list["_models.ResourceTypeAliases"]] = rest_field(
        name="resourceTypeAliases", visibility=["read", "create", "update", "delete", "query"]
    )
    """An array of resource type aliases."""
    effects: Optional[list["_models.DataEffect"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    resource_functions: Optional["_models.DataManifestResourceFunctionsDefinition"] = rest_field(
        name="resourceFunctions", visibility=["read", "create", "update", "delete", "query"]
    )
    """The resource functions definition specified in the data manifest."""

    __flattened_items = ["standard", "custom"]
    ...
    def __init__(
        ...
        *,
        ...
        resource_functions: Optional["_models.DataManifestResourceFunctionsDefinition"] = None,
    ) -> None: ...
    ...
    def __getattr__(self, name: str) -> Any:
        if name in self.__flattened_items:
            if self.resource_functions is None:
                return None
            return getattr(self.resource_functions, name)
        raise AttributeError(f"'{self.__class__.__name__}' object has no attribute '{name}'")

    def __setattr__(self, key: str, value: Any) -> None:
        if key in self.__flattened_items:
            if self.resource_functions is None:
                self.resource_functions = self._attr_to_rest_field["resource_functions"]._class_type()
            setattr(self.resource_functions, key, value)
        else:
...
class ExternalEvaluationEndpointInvocationResult(_Model):  # pylint: disable=name-too-long
    ...
    :ivar policy_action: The effective outcome of the policy evaluation based on both the policy
     ...
     values are: "Unknown", "Allow", "Audit", "Deny", and "Error".
