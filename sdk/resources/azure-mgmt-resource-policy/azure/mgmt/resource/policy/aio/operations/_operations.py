...
class DataPolicyManifestsOperations:  # pylint: disable=docstring-missing-param
    ...
    @api_version_validation(
        ...
        api_versions_list=["2025-11-01", "2025-12-01-preview", "2026-01-01-preview", "2026-06-01"],
    )
    async def get_by_policy_mode(self, policy_mode: str, **kwargs: Any) -> _models.DataPolicyManifest:
        ...
        :return: DataPolicyManifest. The DataPolicyManifest is compatible with MutableMapping
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.DataPolicyManifest, response.json())
    ...
    def list(self, *, filter: Optional[str] = None, **kwargs: Any) -> AsyncItemPaged["_models.DataPolicyManifest"]:
        ...
        :keyword filter: The filter to apply on the operation. Valid values for $filter are:
         \\"namespace eq '{value}'\\". If $filter is not provided, no filtering is performed. If
         $filter=namespace eq '{value}' is provided, the returned list only includes all data policy
         manifests that have a namespace matching the provided value. Default value is None.
        :paramtype filter: str
        ...
        cls: ClsType[List[_models.DataPolicyManifest]] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.DataPolicyManifest],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
...
class PolicyDefinitionVersionsOperations:  # pylint: disable=docstring-missing-param
    ...
    def list(
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.PolicyDefinitionVersion],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
...
class PolicySetDefinitionsOperations:  # pylint: disable=docstring-missing-param
    ...
    def list(
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.PolicySetDefinition],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
...
class PolicySetDefinitionVersionsOperations:  # pylint: disable=docstring-missing-param
    ...
    def list(
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.PolicySetDefinitionVersion],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
