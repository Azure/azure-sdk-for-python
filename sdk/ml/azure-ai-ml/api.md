...
namespace azure.ai.ml.entities
    ...
    @experimental
    class azure.ai.ml.entities.AcceleratorMap:
    ...
    class azure.ai.ml.entities.DeploymentTemplate(Resource, RestTranslatableMixin):
        ...
        def __init__(
                ...
                version: str, 
                *, 
                accelerator_maps: Optional[List[AcceleratorMap]] = ..., 
    ...
    @experimental
    class azure.ai.ml.entities.DeploymentTemplateReference:
    ...
    class azure.ai.ml.entities.Model(Artifact):
        ...
        def __init__(
                self, 
                *, 
                allowed_deployment_templates: Optional[List[DeploymentTemplateReference]] = ..., 
                default_deployment_template: Optional[DeploymentTemplateReference] = ..., 
                description: Optional[str] = ..., 
