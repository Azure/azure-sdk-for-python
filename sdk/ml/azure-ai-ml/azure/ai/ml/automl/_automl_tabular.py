...
def classification(
    *,
    ...
    primary_metric: Union[str, None],
    enable_model_explainability: Union[bool, None],
    weight_column_name: Union[str, None],
    validation_data: Union[Input, None],
    validation_data_size: Union[float,None],
    n_cross_validations: Union[str, int, None],
    cv_split_column_names: Union[List[str],None],
    test_data: Union[Input, None],
    test_data_size: Union[float,None],
    **kwargs,
) -> ClassificationJob:
...
def forecasting(
    *,
    ...
    test_data: Union[Input, None],
    test_data_size: Union[float, None],
    forecasting_settings: Union[ForecastingSettings, None],
    **kwargs,
) -> ForecastingJob:
