...
class ResourceGroupsOperations(object):
    ...
    def _export_template_initial(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[Optional["models.ResourceGroupExportResult"]]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        if response.status_code == 200:
            deserialized = self._deserialize(
                "ResourceGroupExportResult", pipeline_response
            )
    ...
    def begin_export_template(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["models.ResourceGroupExportResult"]
        lro_delay = kwargs.pop("polling_interval", self._config.polling_interval)
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize(
                "ResourceGroupListResult", pipeline_response
            )
