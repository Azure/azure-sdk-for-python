...
from azure.ai.ml._restclient.v2023_04_01_preview.models import PendingUploadRequestDto
...
def get_storage_info_for_non_registry_asset(service_client, workspace_name, name, version, resource_group) -> str:
