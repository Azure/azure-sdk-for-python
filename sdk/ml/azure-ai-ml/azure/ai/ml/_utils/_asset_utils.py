    ...
    for dirpath, _, filenames in os.walk(root, followlinks=True):
        for name in filenames:
            ...
            if not os.path.islink(full_path):
                ...
                path_size = os.path.getsize(os.readlink(full_path))  # ensure we're counting the size of the linked file
...
def upload_directory(
    ...
    for path, _ in upload_paths:
        if os.path.islink(path):
            path_size = os.path.getsize(os.readlink(path))  # ensure we're counting the size of the linked file
        else:
