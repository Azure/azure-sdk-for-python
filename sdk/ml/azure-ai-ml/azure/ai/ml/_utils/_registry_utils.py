...
def begin_package_registry_model(
    service_client, name, version, resource_group, registry_name, body, *, polling_interval=None
) -> dict:
    """Byte-identical registry model ``begin_package`` LRO (POST ``.../models/{name}/versions/{version}/package``).
