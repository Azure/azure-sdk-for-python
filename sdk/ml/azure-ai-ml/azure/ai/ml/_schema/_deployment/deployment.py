...
from azure.ai.ml._schema.assets.environment import (
...
class DeploymentSchema(PathAwareSchema):
    ...
    description = fields.Str(
        metadata={"description": "Description of the endpoint deployment."}
    )
    id = fields.Str()
    tags = fields.Dict()
    ...
    model = UnionField(
        [
            ...
            ArmVersionedStr(
                azureml_type=AzureMLResourceType.MODEL, allow_default_version=True
            ),
