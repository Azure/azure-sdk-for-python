...
class DataSchema(ArtifactSchema):
    path = fields.Str(
        metadata={"description": "URI pointing to a file or folder."}, required=True
    )
    properties = fields.Dict(dump_only=True)
    type = fields.Str(
        metadata={
            "description": "the type of data. Valid values are uri_file, uri_folder, or mltable."
        },
        ...
        error_messages={
            "validator_failed": "value must be uri_file, uri_folder, or mltable."
        },
    )
