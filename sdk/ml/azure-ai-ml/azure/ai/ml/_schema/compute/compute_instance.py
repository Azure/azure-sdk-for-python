...
class ComputeInstanceSchema(ComputeSchema):
    ...
    release_quota_on_stop = fields.Bool(metadata={"description": "Release quota on stop of the compute instance."})
    enable_os_patching = fields.Bool(
        metadata={"description": "Enable or disable OS patching for the compute instance."}
    )
