...
from azure.ai.ml._restclient.arm_ml_service.models import ComputePowerAction, RecurrenceFrequency
from azure.ai.ml._restclient.arm_ml_service.models import ScheduleStatus as ScheduleState
from azure.ai.ml._restclient.arm_ml_service.models import TriggerType, WeekDay
