...
from azure.ai.ml._schema._feature_store_entity.data_column_schema import (
    DataColumnSchema,
)
...
from .feature_transformation_code_metadata_schema import (
    FeatureTransformationCodeMetadataSchema,
)
...
class FeaturesetSpecMetadataSchema(YamlFileSchema):
    ...
    feature_transformation_code = fields.Nested(
        FeatureTransformationCodeMetadataSchema, required=False
    )
