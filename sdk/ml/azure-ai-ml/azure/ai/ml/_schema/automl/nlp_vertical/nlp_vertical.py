...
from azure.ai.ml._schema.automl.featurization_settings import (
    NlpFeaturizationSettingsSchema,
)
from azure.ai.ml._schema.automl.nlp_vertical.nlp_fixed_parameters import (
    NlpFixedParametersSchema,
)
from azure.ai.ml._schema.automl.nlp_vertical.nlp_parameter_subspace import (
    NlpParameterSubspaceSchema,
)
from azure.ai.ml._schema.automl.nlp_vertical.nlp_sweep_settings import (
    NlpSweepSettingsSchema,
)
from azure.ai.ml._schema.automl.nlp_vertical.nlp_vertical_limit_settings import (
    NlpLimitsSchema,
)
...
class NlpVerticalSchema(AutoMLVerticalSchema):
    ...
    featurization = NestedField(
        NlpFeaturizationSettingsSchema(), data_key=AutoMLConstants.FEATURIZATION_YAML
    )
