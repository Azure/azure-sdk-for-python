...
from azure.ai.ml._restclient.arm_ml_service.models import FeatureLags as FeatureLagsMode
...
from azure.ai.ml._restclient.arm_ml_service.models import UseStl as STLMode
