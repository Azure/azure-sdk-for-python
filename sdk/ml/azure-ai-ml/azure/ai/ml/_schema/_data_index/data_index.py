...
class CitationRegexSchema(metaclass=PatchedSchemaMeta):
    ...
    def make(self, data, **kwargs):
        from azure.ai.ml.entities._data_index.data_index import CitationRegex
...
class EmbeddingSchema(metaclass=PatchedSchemaMeta):
    ...
    @post_load
    def make(self, data, **kwargs):
        from azure.ai.ml.entities._data_index.data_index import Embedding
...
class IndexStoreSchema(metaclass=PatchedSchemaMeta):
    ...
    @post_load
    def make(self, data, **kwargs):
        from azure.ai.ml.entities._data_index.data_index import IndexStore
