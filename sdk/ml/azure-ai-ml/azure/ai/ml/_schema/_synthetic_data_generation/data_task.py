...
@experimental
class SyntheticDataGenerationDataTaskSchema(SyntheticDataGenerationSchema):
    data_generation_type = StringTransformedEnum(allowed_values=[JobType.DATA_GENERATION], required=True)
