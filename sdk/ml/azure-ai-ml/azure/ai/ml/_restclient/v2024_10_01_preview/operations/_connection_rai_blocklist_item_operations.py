...
def build_add_bulk_request_initial(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/connections/{connectionName}/raiBlocklists/{raiBlocklistName}/addRaiBlocklistItems")  # pylint: disable=line-too-long
...
def build_delete_bulk_request_initial(
    subscription_id,  # type: str
    resource_group_name,  # type: str
    workspace_name,  # type: str
    connection_name,  # type: str
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/connections/{connectionName}/raiBlocklists/{raiBlocklistName}/deleteRaiBlocklistItems")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str', pattern=r'^[a-zA-Z0-9][a-zA-Z0-9_-]{2,32}$'),
...
# fmt: on
class ConnectionRaiBlocklistItemOperations(object):
    """ConnectionRaiBlocklistItemOperations operations.
    ...
    def _add_bulk_initial(
        ...
        connection_name,  # type: str
        rai_blocklist_name,  # type: str
        body,  # type: List["_models.RaiBlocklistItemBulkRequest"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[List["_models.RaiBlocklistItemPropertiesBasicResource"]]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional[List["_models.RaiBlocklistItemPropertiesBasicResource"]]]
        error_map = {
        ...
        request = build_add_bulk_request_initial(
            ...
            json=_json,
            template_url=self._add_bulk_initial.metadata['url'],
        )
    ...
    _add_bulk_initial.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/connections/{connectionName}/raiBlocklists/{raiBlocklistName}/addRaiBlocklistItems"}  # type: ignore
    ...
    def begin_add_bulk(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller[List["_models.RaiBlocklistItemPropertiesBasicResource"]]
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType[List["_models.RaiBlocklistItemPropertiesBasicResource"]]
    ...
    begin_add_bulk.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/connections/{connectionName}/raiBlocklists/{raiBlocklistName}/addRaiBlocklistItems"}  # type: ignore

    def _delete_bulk_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name,  # type: str
        workspace_name,  # type: str
        connection_name,  # type: str
        ...
        **kwargs  # type: Any
        ...
        request = build_delete_bulk_request_initial(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            connection_name=connection_name,
            ...
            content_type=content_type,
            json=_json,
            template_url=self._delete_bulk_initial.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    _delete_bulk_initial.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/connections/{connectionName}/raiBlocklists/{raiBlocklistName}/deleteRaiBlocklistItems"}  # type: ignore


    @distributed_trace
    def begin_delete_bulk(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name,  # type: str
        workspace_name,  # type: str
        connection_name,  # type: str
    ...
    begin_delete_bulk.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/connections/{connectionName}/raiBlocklists/{raiBlocklistName}/deleteRaiBlocklistItems"}  # type: ignore
    ...
    _delete_initial.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/connections/{connectionName}/raiBlocklists/{raiBlocklistName}/raiBlocklistItems/{raiBlocklistItemName}"}  # type: ignore
    ...
    begin_delete.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/connections/{connectionName}/raiBlocklists/{raiBlocklistName}/raiBlocklistItems/{raiBlocklistItemName}"}  # type: ignore
    ...
    def _create_initial(
        ...
        rai_blocklist_name,  # type: str
        rai_blocklist_item_name,  # type: str
        body,  # type: "_models.RaiBlocklistItemPropertiesBasicResource"
        proxy_api_version=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.RaiBlocklistItemPropertiesBasicResource"
    ...
    _create_initial.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/connections/{connectionName}/raiBlocklists/{raiBlocklistName}/raiBlocklistItems/{raiBlocklistItemName}"}  # type: ignore
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.RaiBlocklistItemPropertiesBasicResource"]
    ...
    begin_create.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/connections/{connectionName}/raiBlocklists/{raiBlocklistName}/raiBlocklistItems/{raiBlocklistItemName}"}  # type: ignore
