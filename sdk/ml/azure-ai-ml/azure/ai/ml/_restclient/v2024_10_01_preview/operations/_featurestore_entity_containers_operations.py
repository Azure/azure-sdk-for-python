...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/featurestoreEntities")  # pylint: disable=line-too-long
...
def build_delete_request_initial(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/featurestoreEntities/{name}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str', pattern=r'^[a-zA-Z0-9][a-zA-Z0-9_-]{2,32}$'),
...
# fmt: on
class FeaturestoreEntityContainersOperations(object):
    """FeaturestoreEntityContainersOperations operations.
    ...
    def get_entity(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.FeaturestoreEntityContainer"
        """Get container.
    ...
    def _create_or_update_initial(
        ...
        workspace_name,  # type: str
        name,  # type: str
        body,  # type: "_models.FeaturestoreEntityContainer"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.FeaturestoreEntityContainer"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.FeaturestoreEntityContainer"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.FeaturestoreEntityContainer"]
