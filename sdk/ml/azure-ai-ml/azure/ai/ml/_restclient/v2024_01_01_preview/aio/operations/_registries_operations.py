...
from ...operations._registries_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_subscription_request, build_list_request, build_remove_regions_request_initial, build_update_request
T = TypeVar('T')
...
class RegistriesOperations:
    ...
    def list_by_subscription(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.RegistryTrackedResourceArmPaginatedResult"]:
