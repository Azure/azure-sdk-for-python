...
class AzureMachineLearningWorkspaces(object):    # pylint: disable=too-many-instance-attributes
    ...
    :type base_url: str
    :keyword api_version: Api Version. The default value is "2024-01-01-preview". Note that
