...
from ...operations._features_operations import build_get_entity_request, build_list_request
T = TypeVar('T')
...
class FeaturesOperations:
    ...
    list.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/featuresets/{name}/versions/{version}/features"}  # type: ignore
    ...
    get_entity.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/featuresets/{name}/versions/{version}/features/{featureName}"}  # type: ignore
