...
class FeaturesetContainersOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        "_models.FeaturesetContainerResourceArmPaginatedResult"
    ]:
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.FeaturesetContainerResourceArmPaginatedResult"]
        error_map = {
    ...
    async def get_entity(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.FeaturesetContainer"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        deserialized = self._deserialize(
            "FeaturesetContainer", pipeline_response
        )
