...
def build_list_by_subscription_request(
    ...
    **kwargs  # type: Any
    ...
    ai_capabilities = kwargs.pop('ai_capabilities', None)  # type: Optional[str]
    ...
    if ai_capabilities is not None:
        _query_parameters['aiCapabilities'] = _SERIALIZER.query("ai_capabilities", ai_capabilities, 'str')
...
def build_delete_request_initial(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    api_version = kwargs.pop('api_version', "2024-04-01-preview")  # type: str
    force_to_purge = kwargs.pop('force_to_purge', False)  # type: Optional[bool]
    ...
    if force_to_purge is not None:
        _query_parameters['forceToPurge'] = _SERIALIZER.query("force_to_purge", force_to_purge, 'bool')
...
def build_list_connection_models_request(
    subscription_id,  # type: str
    resource_group_name,  # type: str
    workspace_name,  # type: str
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/listConnectionModels")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str', pattern=r'^[a-zA-Z0-9][a-zA-Z0-9_-]{2,32}$'),
...
class WorkspacesOperations(object):  # pylint: disable=too-many-public-methods
    ...
    def list_by_subscription(
        ...
        ai_capabilities=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
    ...
    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        ...
        resource_group_name,  # type: str
        workspace_name,  # type: str
        force_to_purge=False,  # type: Optional[bool]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        workspace_name,  # type: str
        body,  # type: "_models.WorkspaceUpdateParameters"
        **kwargs  # type: Any
    ):
    ...
    def _diagnose_initial(
        ...
        resource_group_name,  # type: str
        workspace_name,  # type: str
        body=None,  # type: Optional["_models.DiagnoseWorkspaceParameters"]
        **kwargs  # type: Any
    ):
    ...
    def list_connection_models(
        ...
        **kwargs  # type: Any
        ...
        request = build_list_connection_models_request(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            api_version=api_version,
            template_url=self.list_connection_models.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    list_connection_models.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/listConnectionModels"}  # type: ignore
