...
from ...operations._marketplace_subscriptions_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class MarketplaceSubscriptionsOperations:
    """MarketplaceSubscriptionsOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.MarketplaceSubscriptionResourceArmPaginatedResult"]:
        """List containers.
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.MarketplaceSubscriptionResourceArmPaginatedResult]
