...
class ModelContainersOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.ModelContainerData"]:
        ...
        :return: An iterator like instance of either ModelContainerData or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.ModelContainerData]
    ...
    async def create_or_update(
        ...
        workspace_name: str,
        name: str,
        body: Union[_models.ModelContainerData, IO],
        **kwargs: Any
    ) -> _models.ModelContainerData:
        """Create or update container.
        ...
        :param name: Container name. This is case-sensitive. Required.
        :type name: str
        :param body: Container entity to create or update. Is either a ModelContainerData type or a IO
         type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.ModelContainerData or IO
