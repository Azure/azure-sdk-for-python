...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    if scheduled is not None:
        query_parameters['scheduled'] = _SERIALIZER.query("scheduled", scheduled, 'bool')
    if schedule_id is not None:
        query_parameters['scheduleId'] = _SERIALIZER.query("schedule_id", schedule_id, 'str')
...
class JobsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.JobBaseResourceArmPaginatedResult"]
        error_map = {
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize(
                "JobBaseResourceArmPaginatedResult", pipeline_response
            )
