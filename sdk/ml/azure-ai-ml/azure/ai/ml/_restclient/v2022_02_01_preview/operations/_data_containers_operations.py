...
class DataContainersOperations:
    ...
    def list(
        ...
        list_view_type: Optional[Union[str, _models.ListViewType]] = None,
        **kwargs: Any
    ) -> Iterable["_models.DataContainerData"]:
        ...
        :return: An iterator like instance of either DataContainerData or the result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.machinelearningservices.models.DataContainerData]
    ...
    def create_or_update(
        ...
        workspace_name: str,
        name: str,
        body: Union[_models.DataContainerData, IO],
        **kwargs: Any
    ) -> _models.DataContainerData:
        """Create or update container.
        ...
        :param name: Container name. Required.
        :type name: str
        :param body: Container entity to create or update. Is either a DataContainerData type or a IO
         type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.DataContainerData or IO
