...
class ComponentContainersOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.ComponentContainerData"]:
        ...
        :return: An iterator like instance of either ComponentContainerData or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.ComponentContainerData]
    ...
    async def create_or_update(
        ...
        workspace_name: str,
        name: str,
        body: Union[_models.ComponentContainerData, IO],
        **kwargs: Any
    ) -> _models.ComponentContainerData:
        """Create or update container.
        ...
        :param name: Container name. Required.
        :type name: str
        :param body: Container entity to create or update. Is either a ComponentContainerData type or a
         IO type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.ComponentContainerData or IO
