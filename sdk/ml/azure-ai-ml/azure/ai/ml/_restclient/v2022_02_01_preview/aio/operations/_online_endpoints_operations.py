...
class OnlineEndpointsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.OnlineEndpointData"]:
        ...
        :return: An iterator like instance of either OnlineEndpointData or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.OnlineEndpointData]
    ...
    async def _update_initial(
        ...
        workspace_name: str,
        endpoint_name: str,
        body: Union[_models.PartialOnlineEndpointPartialTrackedResource, IO],
        **kwargs: Any
        ...
        cls: ClsType[Optional[_models.OnlineEndpointData]] = kwargs.pop("cls", None)
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param body: Online Endpoint entity to apply during operation. Is either a
         PartialOnlineEndpointPartialTrackedResource type or a IO type. Required.
        :type body:
         ~azure.mgmt.machinelearningservices.models.PartialOnlineEndpointPartialTrackedResource or IO
    ...
    async def _create_or_update_initial(
        ...
        workspace_name: str,
        endpoint_name: str,
        body: Union[_models.OnlineEndpointData, IO],
        **kwargs: Any
    ) -> _models.OnlineEndpointData:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param endpoint_name: Online Endpoint name. Required.
        :type endpoint_name: str
        :param body: Online Endpoint entity to apply during operation. Is either a OnlineEndpointData
         type or a IO type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.OnlineEndpointData or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
