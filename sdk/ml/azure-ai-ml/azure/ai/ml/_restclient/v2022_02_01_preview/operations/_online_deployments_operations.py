    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "deploymentName": _SERIALIZER.url(
            "deployment_name", deployment_name, "str", pattern=r"^[a-zA-Z0-9][a-zA-Z0-9\-_]{0,254}$"
        ),
    }
...
class OnlineDeploymentsOperations:
    ...
    def list(
        ...
        skip: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.OnlineDeploymentData"]:
        ...
        :return: An iterator like instance of either OnlineDeploymentData or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.machinelearningservices.models.OnlineDeploymentData]
    ...
    def _update_initial(
        ...
        endpoint_name: str,
        deployment_name: str,
        body: Union[_models.PartialOnlineDeploymentPartialTrackedResource, IO],
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.OnlineDeploymentData]] = kwargs.pop("cls", None)
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param body: Online Endpoint entity to apply during operation. Is either a
         PartialOnlineDeploymentPartialTrackedResource type or a IO type. Required.
        :type body:
         ~azure.mgmt.machinelearningservices.models.PartialOnlineDeploymentPartialTrackedResource or IO
    ...
    def _create_or_update_initial(
        ...
        endpoint_name: str,
        deployment_name: str,
        body: Union[_models.OnlineDeploymentData, IO],
        **kwargs: Any
    ) -> _models.OnlineDeploymentData:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param deployment_name: Inference Endpoint Deployment name. Required.
        :type deployment_name: str
        :param body: Inference Endpoint entity to apply during operation. Is either a
         OnlineDeploymentData type or a IO type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.OnlineDeploymentData or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
