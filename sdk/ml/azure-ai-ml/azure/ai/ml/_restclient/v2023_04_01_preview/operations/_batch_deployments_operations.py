...
class BatchDeploymentsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.BatchDeploymentTrackedResourceArmPaginatedResult"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.BatchDeployment"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def _update_initial(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[Optional["_models.BatchDeployment"]]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        if response.status_code == 200:
            deserialized = self._deserialize(
                "BatchDeployment", pipeline_response
            )
