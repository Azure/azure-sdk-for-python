...
class FeaturesetVersionsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :type created_by: str
        :param stage: stage. Default value is None.
        :type stage: str
    ...
    def _backfill_initial(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.FeaturesetJob]] = kwargs.pop("cls", None)
    ...
    def begin_backfill(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.FeaturesetJob]:
        """Backfill.
    ...
    def begin_backfill(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.FeaturesetJob] = kwargs.pop("cls", None)
        polling: Union[bool, PollingMethod] = kwargs.pop("polling", True)
        lro_delay = kwargs.pop("polling_interval", self._config.polling_interval)
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
    ...
    def list_features(
        ...
        **kwargs: Any
        ...
        :param description: description. Default value is None.
        :type description: str
        :keyword callable cls: A custom type or function that will be passed the direct response
