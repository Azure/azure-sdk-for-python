...
class FeaturestoreEntityVersionsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.FeaturestoreEntityVersionResourceArmPaginatedResult"]
        error_map = {
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize(
                "FeaturestoreEntityVersionResourceArmPaginatedResult", pipeline_response
            )
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.FeaturestoreEntityVersion"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        if response.status_code == 200:
            deserialized = self._deserialize(
                "FeaturestoreEntityVersion", pipeline_response
            )
