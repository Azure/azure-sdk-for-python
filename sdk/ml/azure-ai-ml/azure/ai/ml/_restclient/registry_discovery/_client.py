...
class RegistryDiscoveryClient:
    ...
    :vartype async_operations: registry_discovery.operations.AsyncOperationsOperations
    ...
    :vartype registry_management_non_workspace:
     registry_discovery.operations.RegistryManagementNonWorkspaceOperations
