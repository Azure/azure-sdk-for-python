...
class RegistryDiscoveryClient:
    ...
    :vartype async_operations: registry_discovery.aio.operations.AsyncOperationsOperations
    ...
    :vartype registry_management_non_workspace:
     registry_discovery.aio.operations.RegistryManagementNonWorkspaceOperations
    ...
    def __init__(self, endpoint: str, credential: "AsyncTokenCredential", **kwargs: Any) -> None:
        _endpoint = "{endpoint}"
        self._config = RegistryDiscoveryClientConfiguration(endpoint=endpoint, credential=credential, **kwargs)
