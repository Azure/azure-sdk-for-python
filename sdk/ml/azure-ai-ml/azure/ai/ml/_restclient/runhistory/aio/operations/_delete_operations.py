...
class DeleteOperations:
    ...
    async def patch_configuration(
        ...
        resource_group_name: str,
        workspace_name: str,
        body: Optional[Union[_models.DeleteConfiguration, IO]] = None,
        **kwargs: Any
    ) -> _models.DeleteConfiguration:
        """patch_configuration.
        ...
        :param workspace_name: The name of the workspace. Required.
        :type workspace_name: str
        :param body: Is either a DeleteConfiguration type or a IO type. Default value is None.
        :type body: ~azure.mgmt.machinelearningservices.models.DeleteConfiguration or IO
    ...
    patch_configuration.metadata = {
        "url": "/history/v1.0/private/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/deleteConfiguration"
    }
