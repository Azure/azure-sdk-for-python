...
class RunArtifactsOperations(object):
    ...
    def list_in_container_by_experiment_name(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.PaginatedArtifactList"]
        error_map = {
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize(
                "PaginatedArtifactList", pipeline_response
            )
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_in_path_by_experiment_name_request(
                    ...
                    path=path,
                    continuation_token_parameter=continuation_token_parameter,
                    template_url=self.list_in_path_by_experiment_name.metadata[
                        "url"
                    ],
                )
                request = _convert_request(request)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_in_path_by_experiment_id_request(
                    ...
                    path=path,
                    continuation_token_parameter=continuation_token_parameter,
                    template_url=self.list_in_path_by_experiment_id.metadata[
                        "url"
                    ],
                )
                request = _convert_request(request)
    ...
    def get_content_information_by_experiment_id(
        ...
        **kwargs  # type: Any
        ...
        request = build_get_content_information_by_experiment_id_request(
            ...
            experiment_id=experiment_id,
            path=path,
            template_url=self.get_content_information_by_experiment_id.metadata[
                "url"
            ],
        )
        request = _convert_request(request)
