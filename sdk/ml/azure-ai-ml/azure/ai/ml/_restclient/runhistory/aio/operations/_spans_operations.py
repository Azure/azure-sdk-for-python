...
from ...operations._spans_operations import (
    build_get_active_request,
    build_list_request,
    build_post_request,
)
...
class SpansOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.PaginatedSpanDefinition1List"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize(
                "PaginatedSpanDefinition1List", pipeline_response
            )
