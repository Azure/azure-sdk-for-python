...
class ExperimentsOperations:
    ...
    def get_by_query(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.PaginatedExperimentList"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize(
                "PaginatedExperimentList", pipeline_response
            )
    ...
    async def delete_tags(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.DeleteExperimentTagsResult"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        deserialized = self._deserialize(
            "DeleteExperimentTagsResult", pipeline_response
        )
