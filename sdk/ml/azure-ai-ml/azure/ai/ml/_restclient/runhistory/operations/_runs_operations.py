...
class RunsOperations(object):  # pylint: disable=too-many-public-methods
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_get_child_by_experiment_name_request(
                    ...
                    top=top,
                    count=count,
                    template_url=self.get_child_by_experiment_name.metadata[
                        "url"
                    ],
                )
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_get_child_by_experiment_id_request(
                    ...
                    top=top,
                    count=count,
                    template_url=self.get_child_by_experiment_id.metadata[
                        "url"
                    ],
                )
                request = _convert_request(request)
    ...
    def get_run_data(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.GetRunDataResult"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def batch_add_or_modify_by_experiment_id(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.BatchRunResult"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        request = build_batch_add_or_modify_by_experiment_id_request(
            ...
            content_type=content_type,
            json=_json,
            template_url=self.batch_add_or_modify_by_experiment_id.metadata[
                "url"
            ],
        )
        request = _convert_request(request)
    ...
    def batch_add_or_modify_by_experiment_name(
        ...
        **kwargs  # type: Any
        ...
        request = build_batch_add_or_modify_by_experiment_name_request(
            ...
            content_type=content_type,
            json=_json,
            template_url=self.batch_add_or_modify_by_experiment_name.metadata[
                "url"
            ],
        )
        request = _convert_request(request)
    ...
    def modify_or_delete_tags_by_experiment_id(
        ...
        **kwargs  # type: Any
        ...
        request = build_modify_or_delete_tags_by_experiment_id_request(
            ...
            content_type=content_type,
            json=_json,
            template_url=self.modify_or_delete_tags_by_experiment_id.metadata[
                "url"
            ],
        )
        request = _convert_request(request)
    ...
    def modify_or_delete_tags_by_experiment_name(
        ...
        **kwargs  # type: Any
        ...
        request = build_modify_or_delete_tags_by_experiment_name_request(
            ...
            content_type=content_type,
            json=_json,
            template_url=self.modify_or_delete_tags_by_experiment_name.metadata[
                "url"
            ],
        )
        request = _convert_request(request)
    ...
    def delete_run_services_by_experiment_id(
        ...
        **kwargs  # type: Any
        ...
        request = build_delete_run_services_by_experiment_id_request(
            ...
            content_type=content_type,
            json=_json,
            template_url=self.delete_run_services_by_experiment_id.metadata[
                "url"
            ],
        )
        request = _convert_request(request)
    ...
    def delete_run_services_by_experiment_name(
        ...
        **kwargs  # type: Any
        ...
        request = build_delete_run_services_by_experiment_name_request(
            ...
            content_type=content_type,
            json=_json,
            template_url=self.delete_run_services_by_experiment_name.metadata[
                "url"
            ],
        )
        request = _convert_request(request)
    ...
    def add_or_modify_run_service_instances(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.RunServiceInstances"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        if body is not None:
            _json = self._serialize.body(
                body, "AddOrModifyRunServiceInstancesRequest"
            )
        else:
            _json = None
        ...
        request = build_add_or_modify_run_service_instances_request(
            ...
            content_type=content_type,
            json=_json,
            template_url=self.add_or_modify_run_service_instances.metadata[
                "url"
            ],
        )
        request = _convert_request(request)
        ...
        deserialized = self._deserialize(
            "RunServiceInstances", pipeline_response
        )
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_get_by_query_by_experiment_name_request(
                    ...
                    content_type=content_type,
                    json=_json,
                    template_url=self.get_by_query_by_experiment_name.metadata[
                        "url"
                    ],
                )
                request = _convert_request(request)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_get_by_query_by_experiment_id_request(
                    ...
                    content_type=content_type,
                    json=_json,
                    template_url=self.get_by_query_by_experiment_id.metadata[
                        "url"
                    ],
                )
                request = _convert_request(request)
    ...
    def cancel_run_with_uri_by_experiment_id(
        ...
        **kwargs  # type: Any
        ...
        request = build_cancel_run_with_uri_by_experiment_id_request(
            ...
            template_url=self.cancel_run_with_uri_by_experiment_id.metadata[
                "url"
            ],
        )
        request = _convert_request(request)
    ...
    def cancel_run_with_uri_by_experiment_name(
        ...
        **kwargs  # type: Any
        ...
        request = build_cancel_run_with_uri_by_experiment_name_request(
            ...
            experiment_name=experiment_name,
            cancelation_reason=cancelation_reason,
            template_url=self.cancel_run_with_uri_by_experiment_name.metadata[
                "url"
            ],
        )
        request = _convert_request(request)
