...
from ...operations._metric_operations import (
    build_delete_metrics_by_data_container_id_request_initial,
    build_delete_metrics_by_run_id_request_initial,
    ...
    async def begin_delete_metrics_by_data_container_id(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = (
                await self._delete_metrics_by_data_container_id_initial(
                    subscription_id=subscription_id,
                    resource_group_name=resource_group_name,
                    workspace_name=workspace_name,
                    experiment_id=experiment_id,
