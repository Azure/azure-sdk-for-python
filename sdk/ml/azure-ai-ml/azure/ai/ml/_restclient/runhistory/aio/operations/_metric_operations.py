...
from ...operations._metric_operations import (
    build_delete_metrics_by_data_container_id_request,
    build_delete_metrics_by_run_id_request,
    build_get_full_fidelity_metric_request,
    ...
    build_list_generic_resource_metrics_request,
    build_list_metric_request,
    build_post_run_metrics_request,
)
...
class MetricOperations:
    ...
    def list_metric(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.MetricDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
