...
class MetricOperations(object):
        ...
        **kwargs  # type: Any
        ...
        if body is not None:
            _json = self._serialize.body(
                body, "RetrieveFullFidelityMetricRequest"
            )
        else:
            _json = None
    ...
    def list_metric(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.PaginatedMetricDefinitionList"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize(
                "PaginatedMetricDefinitionList", pipeline_response
            )
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                if body is not None:
                    _json = self._serialize.body(
                        body, "ListGenericResourceMetrics"
                    )
                else:
                    _json = None
                ...
                request = build_list_generic_resource_metrics_request(
                    ...
                    content_type=content_type,
                    json=_json,
                    template_url=self.list_generic_resource_metrics.metadata[
                        "url"
                    ],
                )
                request = _convert_request(request)
    ...
    def post_run_metrics(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.PostRunMetricsResult"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        if response.status_code == 200:
            deserialized = self._deserialize(
                "PostRunMetricsResult", pipeline_response
            )
    ...
    def _delete_metrics_by_data_container_id_initial(
        ...
        **kwargs  # type: Any
        ...
        request = build_delete_metrics_by_data_container_id_request_initial(
            ...
            template_url=self._delete_metrics_by_data_container_id_initial.metadata[
                "url"
            ],
        )
        request = _convert_request(request)
    ...
    def _delete_metrics_by_run_id_initial(
        ...
        **kwargs  # type: Any
        ...
        request = build_delete_metrics_by_run_id_request_initial(
            ...
            workspace_name=workspace_name,
            run_id=run_id,
            template_url=self._delete_metrics_by_run_id_initial.metadata[
                "url"
            ],
        )
        request = _convert_request(request)
    ...
    def get_metric_details_by_experiment_name(
        ...
        **kwargs  # type: Any
        ...
        request = build_get_metric_details_by_experiment_name_request(
            ...
            template_url=self.get_metric_details_by_experiment_name.metadata[
                "url"
            ],
        )
        request = _convert_request(request)
    ...
    def get_metric_details_by_experiment_id(
        ...
        **kwargs  # type: Any
        ...
        request = build_get_metric_details_by_experiment_id_request(
            ...
            metric_id=metric_id,
            experiment_id=experiment_id,
            template_url=self.get_metric_details_by_experiment_id.metadata[
                "url"
            ],
        )
        request = _convert_request(request)
