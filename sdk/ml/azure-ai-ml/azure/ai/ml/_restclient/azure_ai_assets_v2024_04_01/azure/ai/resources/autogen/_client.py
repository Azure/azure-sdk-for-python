...
class MachineLearningServicesClient:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        _endpoint = "{endpoint}/genericasset/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}"
    ...
    def send_request(self, request: HttpRequest, *, stream: bool = False, **kwargs: Any) -> HttpResponse:
        ...
        path_format_arguments = {
            ...
            "workspaceName": self._serialize.url(
                "self._config.workspace_name", self._config.workspace_name, "str", skip_quote=True
            ),
        }
