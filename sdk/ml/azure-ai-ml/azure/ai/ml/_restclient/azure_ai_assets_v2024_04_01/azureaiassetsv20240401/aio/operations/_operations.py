...
from ...operations._operations import (
    build_deployment_templates_create_request,
    build_deployment_templates_delete_request,
    build_deployment_templates_get_request,
    build_deployment_templates_list_request,
...
class DeploymentTemplatesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.ai.ml._restclient.azure_ai_assets_v2024_04_01.azureaiassetsv20240401.aio.MachineLearningServicesClient`'s
    ...
    async def begin_create(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.PutAssetLROResponse]:
        ...
        :return: An instance of AsyncLROPoller that returns PutAssetLROResponse. The
         PutAssetLROResponse is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.ai.ml._restclient.azure_ai_assets_v2024_04_01.azureaiassetsv20240401.models.PutAssetLROResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.PutAssetLROResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.PutAssetLROResponse](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    @distributed_trace_async
    async def delete(self, registry_name: str, name: str, version: str, **kwargs: Any) -> None:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.DeploymentTemplate"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.ml._restclient.azure_ai_assets_v2024_04_01.azureaiassetsv20240401.models.DeploymentTemplate]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        async def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(
                List[_models.DeploymentTemplate],
...
class IndexesOperations:
    ...
    @distributed_trace_async
    async def get(self, workspace_name: str, name: str, version: str, **kwargs: Any) -> _models.Index:
    ...
    @api_version_validation(
        ...
        api_versions_list=["2024-04-01-preview", "2024-05-01-preview", "2026-05-01-preview"],
    )
    def list(
        self,
        workspace_name: str,
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.ml._restclient.azure_ai_assets_v2024_04_01.azureaiassetsv20240401.models.Index]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace_async
    async def get_latest(self, workspace_name: str, name: str, **kwargs: Any) -> _models.Index:
    ...
    @distributed_trace_async
    async def get_next_version(self, workspace_name: str, name: str, **kwargs: Any) -> _models.VersionInfo:
...
class PromptsOperations:
    ...
    @api_version_validation(
        ...
        api_versions_list=["2024-05-01-preview", "2026-05-01-preview"],
    )
    async def get(self, workspace_name: str, name: str, version: str, **kwargs: Any) -> _models.Prompt:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.ml._restclient.azure_ai_assets_v2024_04_01.azureaiassetsv20240401.models.Prompt]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get_latest(self, workspace_name: str, name: str, **kwargs: Any) -> _models.Prompt:
