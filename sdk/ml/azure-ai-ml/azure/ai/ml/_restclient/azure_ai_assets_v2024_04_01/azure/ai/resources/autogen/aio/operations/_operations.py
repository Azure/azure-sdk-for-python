...
class PromptsOperations:
    ...
    @api_version_validation(
        ...
        params_added_on={"2024-05-01-preview": ["api_version", "name", "version", "accept"]},
    )
    ...
    @api_version_validation(
        method_added_on="2024-05-01-preview",
        params_added_on={"2024-05-01-preview": ["api_version", "name", "version", "content_type", "accept"]},
    )
    async def create_or_update(
    ...
    @api_version_validation(
        method_added_on="2024-05-01-preview",
        params_added_on={"2024-05-01-preview": ["api_version", "name", "accept"]},
    )
    ...
    @api_version_validation(
        method_added_on="2024-05-01-preview",
        params_added_on={"2024-05-01-preview": ["api_version", "top", "skip", "maxpagesize", "accept"]},
    )
    def list_latest(
        self, *, top: Optional[int] = None, skip: Optional[int] = None, **kwargs: Any
    ) -> AsyncIterable["_models.Prompt"]:
