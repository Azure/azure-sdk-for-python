...
class AcceleratorMap(_Model):
    """Accelerator configuration for a model instance.

    :ivar accelerator_type: The type of accelerator (e.g. A100_80GB, H100_80GB). Required.
    :vartype accelerator_type: str
    :ivar number_of_accelerators_per_model_instance: Number of accelerators allocated per model
     instance. Required.
    :vartype number_of_accelerators_per_model_instance: int
    """

    accelerator_type: str = rest_field(
        name="acceleratorType", visibility=["read", "create", "update", "delete", "query"]
    )
    """The type of accelerator (e.g. A100_80GB, H100_80GB). Required."""
    number_of_accelerators_per_model_instance: int = rest_field(
        name="numberOfAcceleratorsPerModelInstance", visibility=["read", "create", "update", "delete", "query"]
    )
    """Number of accelerators allocated per model instance. Required."""
...
class DeploymentTemplate(_Model):
    ...
    :ivar display_name: The display name of the deployment template.
    ...
    :ivar accelerator_maps: Accelerator configurations for the deployment template.
    :vartype accelerator_maps:
     list[~azure.ai.ml._restclient.azure_ai_assets_v2024_04_01.azureaiassetsv20240401.models.AcceleratorMap]
    ...
    """The display name of the deployment template."""
    ...
    accelerator_maps: Optional[list["_models.AcceleratorMap"]] = rest_field(
        name="acceleratorMaps", visibility=["read", "create", "update", "delete", "query"]
    )
    """Accelerator configurations for the deployment template."""
    ...
    def __init__(
        ...
        *,
        ...
        accelerator_maps: Optional[list["_models.AcceleratorMap"]] = None,
