...
class AKS(Compute):  # pylint: disable=too-many-instance-attributes
...
class AmlCompute(Compute):  # pylint: disable=too-many-instance-attributes
...
class Components1D3SwueSchemasComputeresourceAllof1(_serialization.Model):
...
class ComputeInstance(Compute):  # pylint: disable=too-many-instance-attributes
...
class ComputeStartStopSchedule(_serialization.Model):
    ...
    :ivar status: The schedule status. Known values are: "Enabled" and "Disabled".
    :vartype status: str or ~azure.mgmt.machinelearningservices.models.ScheduleStatus
    :ivar trigger_type: The schedule trigger type. Known values are: "Recurrence" and "Cron".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword status: The schedule status. Known values are: "Enabled" and "Disabled".
        :paramtype status: str or ~azure.mgmt.machinelearningservices.models.ScheduleStatus
        :keyword trigger_type: The schedule trigger type. Known values are: "Recurrence" and "Cron".
...
class Databricks(Compute):  # pylint: disable=too-many-instance-attributes
...
class DataLakeAnalytics(Compute):  # pylint: disable=too-many-instance-attributes
...
class HDInsight(Compute):  # pylint: disable=too-many-instance-attributes
    """A HDInsight compute.
...
class Identity(_serialization.Model):
    ...
    :vartype tenant_id: str
    :ivar type: The identity type. Known values are: "SystemAssigned",
...
class WorkspaceConnectionPropertiesV2(_serialization.Model):
    ...
    :ivar auth_type: Authentication type of the connection target. Required. Known values are:
     "PAT", "ManagedIdentity", "UsernamePassword", "None", "SAS", and "ServicePrincipal".
    ...
    :ivar category: Category of the connection. Known values are: "PythonFeed",
     "ContainerRegistry", "Git", and "FeatureStore".
...
class ManagedIdentityAuthTypeWorkspaceConnectionProperties(WorkspaceConnectionPropertiesV2):
    ...
    def __init__(
        ...
        *,
        ...
        value_format: Optional[Union[str, "_models.ValueFormat"]] = None,
        metadata: Optional[Dict[str, Any]] = None,
        credentials: Optional["_models.ManagedIdentity"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword category: Category of the connection. Known values are: "PythonFeed",
        ...
        """
        super().__init__(
            category=category, target=target, value=value, value_format=value_format, metadata=metadata, **kwargs
        )
...
class PATAuthTypeWorkspaceConnectionProperties(WorkspaceConnectionPropertiesV2):
    ...
    def __init__(
        ...
        *,
        ...
        value_format: Optional[Union[str, "_models.ValueFormat"]] = None,
        metadata: Optional[Dict[str, Any]] = None,
        credentials: Optional["_models.PersonalAccessToken"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword category: Category of the connection. Known values are: "PythonFeed",
...
class PersonalAccessToken(_serialization.Model):
    """PersonalAccessToken.
...
class Recurrence(_serialization.Model):
    ...
    :ivar frequency: The recurrence frequency. Known values are: "NotSpecified", "Second",
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword frequency: The recurrence frequency. Known values are: "NotSpecified", "Second",
         "Minute", "Hour", "Day", "Week", "Month", and "Year".
...
class SASAuthTypeWorkspaceConnectionProperties(WorkspaceConnectionPropertiesV2):
    ...
    def __init__(
        ...
        *,
        ...
        value_format: Optional[Union[str, "_models.ValueFormat"]] = None,
        metadata: Optional[Dict[str, Any]] = None,
        credentials: Optional["_models.SharedAccessSignature"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword category: Category of the connection. Known values are: "PythonFeed",
...
class ServicePrincipalAuthTypeWorkspaceConnectionProperties(WorkspaceConnectionPropertiesV2):
    ...
    def __init__(
        ...
        *,
        ...
        value_format: Optional[Union[str, "_models.ValueFormat"]] = None,
        metadata: Optional[Dict[str, Any]] = None,
        credentials: Optional["_models.ServicePrincipal"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword category: Category of the connection. Known values are: "PythonFeed",
...
class SharedAccessSignature(_serialization.Model):
...
class UsernamePassword(_serialization.Model):
    """UsernamePassword.
...
class UsernamePasswordAuthTypeWorkspaceConnectionProperties(WorkspaceConnectionPropertiesV2):
    ...
    def __init__(
        ...
        *,
        ...
        value_format: Optional[Union[str, "_models.ValueFormat"]] = None,
        metadata: Optional[Dict[str, Any]] = None,
        credentials: Optional["_models.UsernamePassword"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword category: Category of the connection. Known values are: "PythonFeed",
...
class VirtualMachine(Compute):  # pylint: disable=too-many-instance-attributes
...
class Workspace(Resource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar soft_delete_enabled: create a workspace with soft delete capability. Known values are:
     "True" and "False".
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        soft_delete_enabled: Optional[Union[str, "_models.SoftDeleteEnabled"]] = None,
        allow_recover_soft_deleted_workspace: Optional[Union[str, "_models.AllowRecoverSoftDeletedWorkspace"]] = None,
        ...
        **kwargs: Any
        ...
        :keyword soft_delete_enabled: create a workspace with soft delete capability. Known values are:
         "True" and "False".
