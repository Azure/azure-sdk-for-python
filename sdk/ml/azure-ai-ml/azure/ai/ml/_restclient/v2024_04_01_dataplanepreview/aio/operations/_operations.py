...
class DeploymentTemplatesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.aio.MachineLearningServicesClient`'s
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.DeploymentTemplate
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.DeploymentTemplate
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.PutAssetLROResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.DeploymentTemplate or
         JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns PutAssetLROResponse. The
         PutAssetLROResponse is compatible with MutableMapping
        :rtype:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.DeploymentTemplate]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class IndexesOperations:
    ...
    async def get(self, workspace_name: str, name: str, version: str, **kwargs: Any) -> _models.Index:
        ...
        :rtype: ~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.Index
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.Index
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Index. The Index is compatible with MutableMapping
    ...
    async def create_or_update(
        ...
        :param body: Properties of an Index Version. Is one of the following types: Index, JSON,
         IO[bytes] Required.
        :type body: ~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.Index or JSON or
         IO[bytes]
        :return: Index. The Index is compatible with MutableMapping
        :rtype: ~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.Index
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.Index]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get_next_version(self, workspace_name: str, name: str, **kwargs: Any) -> _models.VersionInfo:
        ...
        :rtype: ~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.VersionInfo
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class PromptsOperations:
    ...
    async def get(self, workspace_name: str, name: str, version: str, **kwargs: Any) -> _models.Prompt:
        ...
        :rtype: ~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.Prompt
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.Prompt
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Prompt. The Prompt is compatible with MutableMapping
    ...
    async def create_or_update(
        ...
        :param body: Properties of a Prompt Version. Is one of the following types: Prompt, JSON,
         IO[bytes] Required.
        :type body: ~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.Prompt or JSON or
         IO[bytes]
        :return: Prompt. The Prompt is compatible with MutableMapping
        :rtype: ~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.Prompt
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.ml._restclient.v2024_04_01_dataplanepreview.models.Prompt]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
