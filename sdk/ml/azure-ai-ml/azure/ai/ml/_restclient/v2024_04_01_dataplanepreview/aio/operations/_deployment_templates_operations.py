...
from ...operations._deployment_templates_operations import build_create_request, build_delete_deployment_template_request, build_get_request, build_list_deployment_templates_request
T = TypeVar('T')
...
class DeploymentTemplatesOperations:
    ...
    @distributed_trace_async
    async def delete_deployment_template(  # pylint: disable=inconsistent-return-statements
        self,
        endpoint: str,
        subscription_id: str,
        resource_group_name: str,
