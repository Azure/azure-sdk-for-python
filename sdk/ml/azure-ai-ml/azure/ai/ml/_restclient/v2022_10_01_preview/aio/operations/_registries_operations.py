...
from ...operations._registries_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_subscription_request, build_list_request, build_update_request
T = TypeVar('T')
...
class RegistriesOperations:
    ...
    async def _create_or_update_initial(
        ...
        resource_group_name: str,
        registry_name: str,
        body: Union[_models.Registry, IO],
        **kwargs: Any
    ) -> _models.Registry:
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
