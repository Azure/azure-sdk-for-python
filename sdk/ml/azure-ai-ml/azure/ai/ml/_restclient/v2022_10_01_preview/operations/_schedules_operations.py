...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    list_view_type = kwargs.pop('list_view_type', _params.pop('listViewType', None))  # type: Optional[Union[str, "_models.ScheduleListViewType"]]
...
class SchedulesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.Schedule"]
    ...
    def _create_or_update_initial(
        ...
        workspace_name,  # type: str
        name,  # type: str
        body,  # type: Union[_models.Schedule, IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> _models.Schedule
        error_map = {
