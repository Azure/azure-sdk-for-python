...
from ...operations._workspaces_operations import build_create_or_update_request, build_delete_request, build_diagnose_request, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_list_keys_request, build_list_notebook_access_token_request, build_list_notebook_keys_request, build_list_outbound_network_dependencies_endpoints_request, build_list_storage_account_keys_request, build_prepare_notebook_request, build_resync_keys_request, build_update_request
T = TypeVar('T')
...
class WorkspacesOperations:
    ...
    async def _create_or_update_initial(
        ...
        resource_group_name: str,
        workspace_name: str,
        parameters: Union[_models.Workspace, IO],
        **kwargs: Any
