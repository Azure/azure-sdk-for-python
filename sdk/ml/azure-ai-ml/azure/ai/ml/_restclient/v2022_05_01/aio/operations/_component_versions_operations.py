...
class ComponentVersionsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.ComponentVersionData"]:
        ...
        :param name: Component name. Required.
        :type name: str
        ...
        :return: An iterator like instance of either ComponentVersionData or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.ComponentVersionData]
    ...
    async def create_or_update(
        ...
        name: str,
        version: str,
        body: Union[_models.ComponentVersionData, IO],
        **kwargs: Any
    ) -> _models.ComponentVersionData:
        """Create or update version.
        ...
        :param version: Version identifier. Required.
        :type version: str
        :param body: Version entity to create or update. Is either a ComponentVersionData type or a IO
         type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.ComponentVersionData or IO
