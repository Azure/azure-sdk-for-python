...
class CodeVersionsOperations:
    ...
    def list(
        ...
        skip: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.CodeVersionData"]:
        """List versions.
        ...
        :return: An iterator like instance of either CodeVersionData or the result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.machinelearningservices.models.CodeVersionData]
    ...
    def create_or_update(
        ...
        name: str,
        version: str,
        body: Union[_models.CodeVersionData, IO],
        **kwargs: Any
    ) -> _models.CodeVersionData:
        """Create or update version.
        ...
        :param version: Version identifier. This is case-sensitive. Required.
        :type version: str
        :param body: Version entity to create or update. Is either a CodeVersionData type or a IO type.
         Required.
        :type body: ~azure.mgmt.machinelearningservices.models.CodeVersionData or IO
