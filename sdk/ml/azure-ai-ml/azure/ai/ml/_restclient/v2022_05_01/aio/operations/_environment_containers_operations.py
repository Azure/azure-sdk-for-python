...
class EnvironmentContainersOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.EnvironmentContainerData"]:
        ...
        :return: An iterator like instance of either EnvironmentContainerData or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.EnvironmentContainerData]
    ...
    async def create_or_update(
        ...
        workspace_name: str,
        name: str,
        body: Union[_models.EnvironmentContainerData, IO],
        **kwargs: Any
    ) -> _models.EnvironmentContainerData:
        """Create or update container.
        ...
        :param name: Container name. This is case-sensitive. Required.
        :type name: str
        :param body: Container entity to create or update. Is either a EnvironmentContainerData type or
         a IO type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.EnvironmentContainerData or IO
