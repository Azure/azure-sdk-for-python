...
class EnvironmentVersionsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.EnvironmentVersionData"]:
        """List versions.
        ...
        :return: An iterator like instance of either EnvironmentVersionData or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.EnvironmentVersionData]
    ...
    async def create_or_update(
        ...
        name: str,
        version: str,
        body: Union[_models.EnvironmentVersionData, IO],
        **kwargs: Any
    ) -> _models.EnvironmentVersionData:
        """Creates or updates an EnvironmentVersion.
        ...
        :param version: Version of EnvironmentVersion. Required.
        :type version: str
        :param body: Definition of EnvironmentVersion. Is either a EnvironmentVersionData type or a IO
         type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.EnvironmentVersionData or IO
