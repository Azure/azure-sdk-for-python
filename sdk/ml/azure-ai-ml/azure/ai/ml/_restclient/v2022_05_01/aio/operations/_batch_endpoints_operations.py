...
class BatchEndpointsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.BatchEndpointData"]:
        ...
        :return: An iterator like instance of either BatchEndpointData or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.BatchEndpointData]
    ...
    async def _update_initial(
        ...
        workspace_name: str,
        endpoint_name: str,
        body: Union[_models.PartialBatchEndpointPartialTrackedResource, IO],
        **kwargs: Any
        ...
        cls: ClsType[Optional[_models.BatchEndpointData]] = kwargs.pop("cls", None)
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param body: Mutable batch inference endpoint definition object. Is either a
         PartialBatchEndpointPartialTrackedResource type or a IO type. Required.
        :type body:
         ~azure.mgmt.machinelearningservices.models.PartialBatchEndpointPartialTrackedResource or IO
    ...
    async def _create_or_update_initial(
        ...
        workspace_name: str,
        endpoint_name: str,
        body: Union[_models.BatchEndpointData, IO],
        **kwargs: Any
    ) -> _models.BatchEndpointData:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param endpoint_name: Name for the Batch inference endpoint. Required.
        :type endpoint_name: str
        :param body: Batch inference endpoint definition object. Is either a BatchEndpointData type or
         a IO type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.BatchEndpointData or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
