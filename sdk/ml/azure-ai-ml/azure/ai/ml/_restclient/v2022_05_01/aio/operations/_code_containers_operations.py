...
class CodeContainersOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.CodeContainerData"]:
        """List containers.
        ...
        :return: An iterator like instance of either CodeContainerData or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.CodeContainerData]
    ...
    async def create_or_update(
        ...
        workspace_name: str,
        name: str,
        body: Union[_models.CodeContainerData, IO],
        **kwargs: Any
    ) -> _models.CodeContainerData:
        """Create or update container.
        ...
        :param name: Container name. This is case-sensitive. Required.
        :type name: str
        :param body: Container entity to create or update. Is either a CodeContainerData type or a IO
         type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.CodeContainerData or IO
