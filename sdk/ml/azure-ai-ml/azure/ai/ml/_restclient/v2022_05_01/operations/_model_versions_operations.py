...
class ModelVersionsOperations:
    ...
    def list(
        ...
        list_view_type: Optional[Union[str, _models.ListViewType]] = None,
        **kwargs: Any
    ) -> Iterable["_models.ModelVersionData"]:
        """List model versions.
        ...
        :return: An iterator like instance of either ModelVersionData or the result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.machinelearningservices.models.ModelVersionData]
    ...
    def create_or_update(
        ...
        name: str,
        version: str,
        body: Union[_models.ModelVersionData, IO],
        **kwargs: Any
    ) -> _models.ModelVersionData:
        """Create or update version.
        ...
        :param version: Version identifier. This is case-sensitive. Required.
        :type version: str
        :param body: Version entity to create or update. Is either a ModelVersionData type or a IO
         type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.ModelVersionData or IO
