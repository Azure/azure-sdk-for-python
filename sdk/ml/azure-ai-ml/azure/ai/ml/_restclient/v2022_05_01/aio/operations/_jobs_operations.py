...
class JobsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.JobBaseData"]:
        ...
        :return: An iterator like instance of either JobBaseData or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.JobBaseData]
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, workspace_name: str, id: str, **kwargs: Any) -> _models.JobBaseData:
    ...
    async def create_or_update(
        ...
        workspace_name: str,
        id: str,
        body: Union[_models.JobBaseData, IO],
        **kwargs: Any
    ) -> _models.JobBaseData:
        """Creates and executes a Job.
        ...
        :param id: The name and identifier for the Job. This is case-sensitive. Required.
        :type id: str
        :param body: Job definition object. Is either a JobBaseData type or a IO type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.JobBaseData or IO
