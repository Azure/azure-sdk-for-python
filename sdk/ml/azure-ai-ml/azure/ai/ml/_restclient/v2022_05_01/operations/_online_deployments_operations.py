...
class OnlineDeploymentsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.OnlineDeploymentTrackedResourceArmPaginatedResult"]
        error_map = {
    ...
    def begin_delete(
        ...
        **kwargs  # type: Any
        ...
        polling = kwargs.pop(
            "polling", True
        )  # type: Union[bool, azure.core.polling.PollingMethod]
        cls = kwargs.pop("cls", None)  # type: ClsType[None]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.OnlineDeploymentData"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        deserialized = self._deserialize(
            "OnlineDeploymentData", pipeline_response
        )
    ...
    def _update_initial(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[Optional["_models.OnlineDeploymentData"]]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def get_logs(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.DeploymentLogs"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def list_skus(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.SkuResourceArmPaginatedResult"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize(
                "SkuResourceArmPaginatedResult", pipeline_response
            )
            list_of_elem = deserialized.value
            if cls:
                list_of_elem = cls(list_of_elem)
