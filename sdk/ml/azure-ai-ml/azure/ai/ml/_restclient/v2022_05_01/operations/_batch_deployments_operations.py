...
class BatchDeploymentsOperations:
    ...
    def list(
        ...
        skip: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.BatchDeploymentData"]:
        ...
        :return: An iterator like instance of either BatchDeploymentData or the result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.machinelearningservices.models.BatchDeploymentData]
    ...
    def _update_initial(
        ...
        endpoint_name: str,
        deployment_name: str,
        body: Union[_models.PartialBatchDeploymentPartialTrackedResource, IO],
        **kwargs: Any
        ...
        api_version: Literal["2022-05-01"] = kwargs.pop("api_version", _params.pop("api-version", "2022-05-01"))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.BatchDeploymentData]] = kwargs.pop("cls", None)
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param body: Batch inference deployment definition object. Is either a
         PartialBatchDeploymentPartialTrackedResource type or a IO type. Required.
        :type body:
         ~azure.mgmt.machinelearningservices.models.PartialBatchDeploymentPartialTrackedResource or IO
    ...
    def _create_or_update_initial(
        ...
        endpoint_name: str,
        deployment_name: str,
        body: Union[_models.BatchDeploymentData, IO],
        **kwargs: Any
    ) -> _models.BatchDeploymentData:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param deployment_name: The identifier for the Batch inference deployment. Required.
        :type deployment_name: str
        :param body: Batch inference deployment definition object. Is either a BatchDeploymentData type
         or a IO type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.BatchDeploymentData or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
