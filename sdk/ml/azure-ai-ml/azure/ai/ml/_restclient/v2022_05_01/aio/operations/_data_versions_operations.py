...
class DataVersionsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.DataVersionBaseData"]:
        ...
        :return: An iterator like instance of either DataVersionBaseData or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.DataVersionBaseData]
    ...
    async def create_or_update(
        ...
        name: str,
        version: str,
        body: Union[_models.DataVersionBaseData, IO],
        **kwargs: Any
    ) -> _models.DataVersionBaseData:
        """Create or update version.
        ...
        :param version: Version identifier. Required.
        :type version: str
        :param body: Version entity to create or update. Is either a DataVersionBaseData type or a IO
         type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.DataVersionBaseData or IO
