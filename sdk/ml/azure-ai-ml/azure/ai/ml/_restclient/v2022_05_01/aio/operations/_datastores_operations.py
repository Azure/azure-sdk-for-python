...
class DatastoresOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.DatastoreData"]:
        """List datastores.
        ...
        :return: An iterator like instance of either DatastoreData or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.DatastoreData]
    ...
    async def create_or_update(
        ...
        workspace_name: str,
        name: str,
        body: Union[_models.DatastoreData, IO],
        skip_validation: bool = False,
        **kwargs: Any
    ) -> _models.DatastoreData:
        """Create or update datastore.
        ...
        :param name: Datastore name. Required.
        :type name: str
        :param body: Datastore entity to create or update. Is either a DatastoreData type or a IO type.
         Required.
        :type body: ~azure.mgmt.machinelearningservices.models.DatastoreData or IO
        :param skip_validation: Flag to skip validation. Default value is False.
        :type skip_validation: bool
