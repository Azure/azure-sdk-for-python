...
class RegistryModelContainersOperations:
    """RegistryModelContainersOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.ModelContainerResourceArmPaginatedResult"]
        error_map = {
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize(
                "ModelContainerResourceArmPaginatedResult", pipeline_response
            )
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.ModelContainer"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        if response.status_code == 200:
            deserialized = self._deserialize(
                "ModelContainer", pipeline_response
            )
