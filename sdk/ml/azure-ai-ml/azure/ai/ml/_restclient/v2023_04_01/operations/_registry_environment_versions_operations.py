...
class RegistryEnvironmentVersionsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.EnvironmentVersionResourceArmPaginatedResult"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.EnvironmentVersion"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        deserialized = self._deserialize(
            "EnvironmentVersion", pipeline_response
        )
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.EnvironmentVersion"]
