...
from ...operations._registries_operations import (
    ...
    build_list_request,
    build_remove_regions_request_initial,
...
class RegistriesOperations:
    ...
    def list_by_subscription(
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.RegistryTrackedResourceArmPaginatedResult"]
        error_map = {
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize(
                "RegistryTrackedResourceArmPaginatedResult", pipeline_response
            )
    ...
    async def _remove_regions_initial(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[Optional["_models.Registry"]]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
