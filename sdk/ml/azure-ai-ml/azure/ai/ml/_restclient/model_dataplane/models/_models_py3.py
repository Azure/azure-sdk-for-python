...
class Artifact(msrest.serialization.Model):
    ...
    def __init__(
        self, *, id: Optional[str] = None, prefix: Optional[str] = None, **kwargs
    ):
        """
        :keyword id:
        :paramtype id: str
...
class BatchModelPathResponseDto(msrest.serialization.Model):
    ...
    def __init__(
        self, *, values: Optional[Dict[str, "ModelPathResponseDto"]] = None, **kwargs
    ):
        """
...
class DependencyMapDto(msrest.serialization.Model):
    ...
    def __init__(
        self, *, dependencies: Optional[List["DependencyMapItemDto"]] = None, **kwargs
    ):
        """
        :keyword dependencies:
...
class ModelPathResponseDto(msrest.serialization.Model):
    ...
    def __init__(
        self, *, path: Optional[str] = None, type: Optional[str] = None, **kwargs
    ):
        """
        :keyword path:
        :paramtype path: str
