...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    if include_job_instructions is not None:
        _query_parameters['includeJobInstructions'] = _SERIALIZER.query("include_job_instructions", include_job_instructions, 'bool')
    if include_label_categories is not None:
        _query_parameters['includeLabelCategories'] = _SERIALIZER.query("include_label_categories", include_label_categories, 'bool')
