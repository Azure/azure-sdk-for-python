...
from ...operations._managed_network_provisions_operations import (
    build_provision_managed_network_request_initial,
)
...
class ManagedNetworkProvisionsOperations:
    """ManagedNetworkProvisionsOperations async operations.
    ...
    async def _provision_managed_network_initial(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[Optional["_models.ManagedNetworkProvisionStatus"]]
        error_map = {
        ...
        request = build_provision_managed_network_request_initial(
            ...
            json=_json,
            template_url=self._provision_managed_network_initial.metadata[
                "url"
            ],
        )
        ...
        if response.status_code == 200:
            deserialized = self._deserialize(
                "ManagedNetworkProvisionStatus", pipeline_response
            )
    ...
    async def begin_provision_managed_network(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.ManagedNetworkProvisionStatus"]
