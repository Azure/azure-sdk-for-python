...
class ManagedNetworkSettingsRuleOperations:
    ...
    def list(
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.OutboundRuleListResult"]
        error_map = {
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize(
                "OutboundRuleListResult", pipeline_response
            )
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.OutboundRuleBasicResource"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        deserialized = self._deserialize(
            "OutboundRuleBasicResource", pipeline_response
        )
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[Optional["_models.OutboundRuleBasicResource"]]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
