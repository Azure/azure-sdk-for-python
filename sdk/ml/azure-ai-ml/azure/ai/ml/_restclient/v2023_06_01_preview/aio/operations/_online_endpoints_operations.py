...
class OnlineEndpointsOperations:
    ...
    def list(
        ...
        compute_type: Optional[
            Union[str, "_models.EndpointComputeType"]
        ] = None,
        ...
        **kwargs: Any
        ...
        "_models.OnlineEndpointTrackedResourceArmPaginatedResult"
    ]:
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.OnlineEndpointTrackedResourceArmPaginatedResult"]
        error_map = {
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.OnlineEndpoint"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[Optional["_models.OnlineEndpoint"]]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        if response.status_code == 200:
            deserialized = self._deserialize(
                "OnlineEndpoint", pipeline_response
            )
    ...
    async def list_keys(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.EndpointAuthKeys"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def get_token(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.EndpointAuthToken"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        deserialized = self._deserialize(
            "EndpointAuthToken", pipeline_response
        )
