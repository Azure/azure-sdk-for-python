...
def build_create_data_container_request(
    ...
    _url = kwargs.pop(
        "template_url",
        "/data/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/datacontainer",
...
class DataContainerOperations:
    ...
    def list_data_container(
    ...
    ) -> Iterable["_models.DataContainerEntity"]:
        """list_data_container.
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.machinelearningservices.models.DataContainerEntity]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
