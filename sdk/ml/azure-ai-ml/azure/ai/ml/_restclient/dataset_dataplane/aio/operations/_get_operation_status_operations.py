...
from ...operations._get_operation_status_operations import (
    build_get_dataset_operation_status_request_initial,
)
...
class GetOperationStatusOperations:
    ...
    async def _get_dataset_operation_status_initial(
        ...
        **kwargs: Any
        ...
        "_models.LongRunningOperationResponse1LongRunningOperationResponseObject"
    ]:
        cls = kwargs.pop(
            "cls", None
        ...
        request = build_get_dataset_operation_status_request_initial(
            ...
            template_url=self._get_dataset_operation_status_initial.metadata[
                "url"
            ],
        )
