...
class DataCallOperations(object):
    ...
    def get_schema_for_ml_table(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[List["_models.ColumnDefinition"]]
        error_map = {
        ...
        deserialized = self._deserialize(
            "[ColumnDefinition]", pipeline_response
        )
    ...
    def get_preview_for_ml_table(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.DataViewSetResult"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        deserialized = self._deserialize(
            "DataViewSetResult", pipeline_response
        )
    ...
    def get_quick_profile_for_ml_table(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[List["_models.ProfileResult"]]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
