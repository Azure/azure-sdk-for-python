...
class CreateUnregisteredInputData(msrest.serialization.Model):
    ...
    def __init__(
        self, *, run_id: str, input_name: str, uri: str, type: str, **kwargs
    ):
        """
...
class CreateUnregisteredOutputData(msrest.serialization.Model):
    ...
    def __init__(
        self, *, run_id: str, output_name: str, uri: str, type: str, **kwargs
    ):
        """
        :keyword run_id: Required.
        :paramtype run_id: str
...
class DatasetDefinition(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        "partition_format_in_path": {
            "key": "partitionFormatInPath",
            "type": "str",
        },
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.use_description_tags_from_definition = (
            use_description_tags_from_definition
        )
        self.description = description
        self.tags = tags
