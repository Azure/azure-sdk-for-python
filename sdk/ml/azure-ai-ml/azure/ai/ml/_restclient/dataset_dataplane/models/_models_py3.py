...
class BatchDataUriResponse(msrest.serialization.Model):
    ...
    def __init__(self, *, values: Optional[Dict[str, "DataUriV2Response"]] = None, **kwargs):
        """
...
class ColumnDefinition(msrest.serialization.Model):
    ...
    def __init__(self, *, id: Optional[str] = None, type: Optional[Union[str, "FieldType"]] = None, **kwargs):
        """
        :keyword id:
        :paramtype id: str
...
class DataField(msrest.serialization.Model):
    ...
    def __init__(self, *, type: Optional[Union[str, "FieldType"]] = None, value: Optional[Any] = None, **kwargs):
        """
        :keyword type: Possible values include: "String", "Boolean", "Integer", "Decimal", "Date",
         "Unknown", "Error", "Null", "DataRow", "List", "Stream".
        :paramtype type: str or ~azure.mgmt.machinelearningservices.models.FieldType
...
class DataUriV2Response(msrest.serialization.Model):
    ...
    def __init__(self, *, uri: Optional[str] = None, type: Optional[str] = None, **kwargs):
        """
        :keyword uri:
        :paramtype uri: str
        :keyword type:
...
class STypeCount(msrest.serialization.Model):
    ...
    def __init__(self, *, s_type: Optional[Union[str, "SType"]] = None, count: Optional[int] = None, **kwargs):
        """
...
class TypeCount(msrest.serialization.Model):
    ...
    def __init__(self, *, type: Optional[Union[str, "FieldType"]] = None, count: Optional[int] = None, **kwargs):
        """
        :keyword type: Possible values include: "String", "Boolean", "Integer", "Decimal", "Date",
         "Unknown", "Error", "Null", "DataRow", "List", "Stream".
        :paramtype type: str or ~azure.mgmt.machinelearningservices.models.FieldType
...
class ValueCount(msrest.serialization.Model):
    ...
    def __init__(self, *, value: Optional["DataField"] = None, count: Optional[int] = None, **kwargs):
        """
        :keyword value:
