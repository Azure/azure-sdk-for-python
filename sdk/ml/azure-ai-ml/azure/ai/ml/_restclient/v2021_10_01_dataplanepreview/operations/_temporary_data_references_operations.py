...
class TemporaryDataReferencesOperations(object):
    ...
    def create_or_get_temporary_data_reference(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.TemporaryDataReferenceResponseDto"]
        error_map = {
        ...
        request = build_create_or_get_temporary_data_reference_request(
            ...
            json=_json,
            template_url=self.create_or_get_temporary_data_reference.metadata[
                "url"
            ],
        )
        ...
        deserialized = self._deserialize(
            "TemporaryDataReferenceResponseDto", pipeline_response
        )
