...
def build_delete_request(
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/models/{name}",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
...
class ModelContainersOperations:
    ...
    @distributed_trace
    def get(self, name: str, resource_group_name: str, registry_name: str, **kwargs: Any) -> _models.ModelContainerData:
        """Get container.
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.ModelContainerData]:
