...
def build_delete_request(
    name: str, resource_group_name: str, registry_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/codes/{name}",
    )  # pylint: disable=line-too-long
    path_format_arguments = {
...
class CodeContainersOperations:
    ...
    delete.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/codes/{name}"
    }

    @distributed_trace
    def get(self, name: str, resource_group_name: str, registry_name: str, **kwargs: Any) -> _models.CodeContainerData:
        """Get container.
