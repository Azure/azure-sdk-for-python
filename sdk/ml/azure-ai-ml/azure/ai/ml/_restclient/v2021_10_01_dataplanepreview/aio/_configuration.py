...
class AzureMachineLearningWorkspacesConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    :keyword api_version: Api Version. Default value is "2021-10-01-dataplanepreview". Note that
    ...
    def __init__(self, credential: "AsyncTokenCredential", subscription_id: str, **kwargs: Any) -> None:
        ...
        api_version: Literal["2021-10-01-dataplanepreview"] = kwargs.pop("api_version", "2021-10-01-dataplanepreview")
