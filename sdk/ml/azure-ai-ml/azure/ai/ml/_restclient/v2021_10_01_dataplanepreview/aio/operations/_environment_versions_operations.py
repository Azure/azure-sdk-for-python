...
class EnvironmentVersionsOperations:
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/environments/{name}/versions"
    }
    ...
    delete.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/environments/{name}/versions/{version}"
    }
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param registry_name: Name of Azure Machine Learning registry. Required.
        :type registry_name: str
        :param body: Version entity to create or update. Is either a EnvironmentVersionData type or a
         IO type. Required.
