...
from ...operations._resource_management_asset_reference_operations import build_import_request
...
class ResourceManagementAssetReferenceOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`resource_management_asset_reference` attribute.
    """
    ...
    async def _import_initial(  # pylint: disable=inconsistent-return-statements
        ...
        registry_name: str,
        body: Union[_models.ResourceManagementAssetReferenceData, IO],
        **kwargs: Any
    ) -> None:
        error_map = {
        ...
        api_version: Literal["2021-10-01-dataplanepreview"] = kwargs.pop(
            "api_version", _params.pop("api-version", "2021-10-01-dataplanepreview")
        )
    ...
    _import_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/import"
    }
    ...
    async def begin_import_method(
        ...
        **kwargs: Any
        ...
        :type registry_name: str
        :param body: Import request contains the source asset reference value and destination version
         value. Is either a ResourceManagementAssetReferenceData type or a IO type. Required.
        :type body: ~azure.mgmt.machinelearningservices.models.ResourceManagementAssetReferenceData or
         IO
