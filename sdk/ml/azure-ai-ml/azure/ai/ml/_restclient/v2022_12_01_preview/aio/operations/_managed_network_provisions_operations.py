...
from ...operations._managed_network_provisions_operations import build_post_request_initial
T = TypeVar('T')
...
class ManagedNetworkProvisionsOperations:
    ...
    async def _post_initial(  # pylint: disable=inconsistent-return-statements
        ...
        workspace_name: str,
        body: "_models.ManagedNetworkProvisionOptions",
        **kwargs: Any
    ) -> None:
    ...
    async def begin_post(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        workspace_name: str,
        body: "_models.ManagedNetworkProvisionOptions",
