...
class ManagedNetworkProvisionsOperations:
    ...
    async def _provision_managed_network_initial(
        ...
        workspace_name: str,
        parameters: Optional[Union[_models.ManagedNetworkProvisionOptions, IO]] = None,
        **kwargs: Any
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            if parameters is not None:
                _json = self._serialize.body(parameters, "ManagedNetworkProvisionOptions")
            else:
                _json = None
    ...
    async def begin_provision_managed_network(
        ...
        resource_group_name: str,
        workspace_name: str,
        parameters: Optional[_models.ManagedNetworkProvisionOptions] = None,
        *,
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.machinelearningservices.models.ManagedNetworkProvisionOptions
    ...
    async def begin_provision_managed_network(
        ...
        **kwargs: Any
        ...
        :param workspace_name: Name of Azure Machine Learning workspace. Required.
        :type workspace_name: str
        :param parameters: Managed Network Provisioning Options for a machine learning workspace. Is
         either a ManagedNetworkProvisionOptions type or a IO type. Default value is None.
        :type parameters: ~azure.mgmt.machinelearningservices.models.ManagedNetworkProvisionOptions or
         IO
