...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/batchEndpoints/{endpointName}/jobs")  # pylint: disable=line-too-long
    ...
    if deployment is not None:
        _query_parameters['deployment'] = _SERIALIZER.query("deployment", deployment, 'str')
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/batchEndpoints/{endpointName}/jobs/{id}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "endpointName": _SERIALIZER.url("endpoint_name", endpoint_name, 'str'),
