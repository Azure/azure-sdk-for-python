...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/batchEndpoints/{endpointName}/deployments/{deploymentName}/jobs")  # pylint: disable=line-too-long
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/batchEndpoints/{endpointName}/deployments/{deploymentName}/jobs/{id}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "endpointName": _SERIALIZER.url("endpoint_name", endpoint_name, 'str'),
        "deploymentName": _SERIALIZER.url("deployment_name", deployment_name, 'str'),
...
class BatchJobDeploymentOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.BatchJobResourceArmPaginatedResult"]
        error_map = {
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize(
                "BatchJobResourceArmPaginatedResult", pipeline_response
            )
    ...
    def create(
        ...
        **kwargs  # type: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType["_models.BatchJobResource"]
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        if response.status_code == 200:
            deserialized = self._deserialize(
                "BatchJobResource", pipeline_response
            )
