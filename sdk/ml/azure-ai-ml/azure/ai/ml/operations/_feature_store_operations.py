...
class FeatureStoreOperations():
        ...
        if scope == Scope.SUBSCRIPTION:
            return self._operation.list_by_subscription(
                cls=lambda objs: filter(
                    lambda ws: ws.kind == "FeatureStore",
    ...
    def get(self, name: Optional[str] = None, **kwargs: Dict) -> FeatureStore:
        ...
        obj = self._operation.get(resource_group, feature_store_name)
    ...
    def begin_create(
        ...
        **kwargs: Dict,
        ...
        :param featurestore: FeatureStore definition.
    ...
    def begin_update(
        ...
        **kwargs: Dict,
        ...
        """Update friendly name, description, managed identities or tags of a featurestore.

        :param featurestore: FeatureStore resource.
        :param update_dependent_resources: gives your consent to update the feature storedependent resources.
            Note that updating the featurestore-attached Azure Container Registry resource may break lineage
            of previous jobs or your ability to rerun earlier jobs in this featurestore.
            Also, updating the featurestore-attached Azure Application Insights resource may break lineage of
            deployed inference endpoints this featurestore. Only set this argument if you are sure that you want
        ...
        :param application_insights: Application insights resource for featurestore.
        :param container_registry: Container registry resource for featurestore.
        :type featurestore: FeatureStore
        :return: An instance of LROPoller that returns a FeatureStore.
        :rtype: ~azure.core.polling.LROPoller[~azure.ai.ml.entities.FeatureStore]
        """
    ...
    def begin_delete(self, feature_store: str, *, delete_dependent_resources: bool, **kwargs: Dict) -> LROPoller:
        ...
        :type name: str
        :param delete_dependent_resources: Whether to delete resources associated with the featurestore,
