...
def stream_logs_until_completion(
    ...
    *,
    ...
    if job_resource.properties.properties["FeatureStoreJobType"]:
        url_format = "https://ml.azure.com/featureStore/{fs_name}/featureSets/{fset_name}/{fset_version}/matJobs?wsid=/subscriptions/{fs_sub_id}/resourceGroups/{fs_rg_name}/providers/Microsoft.MachineLearningServices/workspaces/{fs_name}&flight=featurestoresprpr"
