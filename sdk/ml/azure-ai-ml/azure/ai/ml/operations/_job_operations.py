...
class JobOperations(_ScopeDependentOperations):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # Store the tenant id decoded from the credential; token acquisition is not cached by
                ...
                if studio_endpoint is not None:
                    ...
                    if studio_url is not None:
                        if self._tenant_id is None:
                            ...
                            self._tenant_id = decode["tid"]
                        formatted_tid = TID_FMT.format(self._tenant_id)
