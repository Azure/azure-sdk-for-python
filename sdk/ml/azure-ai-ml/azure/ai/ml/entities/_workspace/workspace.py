...
class Workspace(Resource):
    ...
    :keyword name: Name of the workspace.
    :paramtype name: str
    :keyword description: Description of the workspace.
    :paramtype description: str
    :keyword tags: Tags of the workspace.
    :paramtype tags: dict
    :keyword display_name: Display name for the workspace. This is non-unique within the resource group.
    :paramtype display_name: str
    :keyword location: The location to create the workspace in.
        If not specified, the same location as the resource group will be used.
    :paramtype location: str
    :keyword resource_group: Name of resource group to create the workspace in.
    :paramtype resource_group: str
    :keyword hbi_workspace: Whether the customer data is of high business impact (HBI),
    ...
    :keyword identity: workspace's Managed Identity (user assigned, or system assigned)
    :paramtype identity: ~azure.ai.ml.entities.IdentityConfiguration
    :keyword primary_user_assigned_identity: The workspace's primary user assigned identity
    :paramtype primary_user_assigned_identity: str
    :keyword managed_network: workspace's Managed Network configuration
    :paramtype managed_network: ~azure.ai.ml.entities.ManagedNetwork
    :keyword provision_network_now: Set to trigger the provisioning of the managed vnet with the default options when
        creating a workspace with the managed vnet enable, or else it does nothing
    :paramtype provision_network_now: Optional[bool]
    :keyword system_datastores_auth_mode: The authentication mode for system datastores.
    ...
    :paramtype allow_roleassignment_on_rg: Optional[bool]
    :keyword serverless_compute: The serverless compute settings for the workspace.
    :type: ~azure.ai.ml.entities.ServerlessComputeSettings
    :keyword workspace_hub: Deprecated resource ID of an existing workspace hub to help create project workspace.
        Use the Project class instead now.
    :paramtype workspace_hub: Optional[str]
