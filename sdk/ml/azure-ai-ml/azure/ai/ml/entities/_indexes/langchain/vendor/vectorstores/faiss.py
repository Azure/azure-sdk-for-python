...
from azure.ai.ml.entities._indexes.langchain.vendor.docstore.base import AddableMixin, Docstore
from azure.ai.ml.entities._indexes.langchain.vendor.schema.document import Document
from azure.ai.ml.entities._indexes.langchain.vendor.embeddings.base import Embeddings
from azure.ai.ml.entities._indexes.langchain.vendor.vectorstores.base import VectorStore
from azure.ai.ml.entities._indexes.langchain.vendor.vectorstores.utils import maximal_marginal_relevance
    ...
    def similarity_search_with_score_by_vector(
        ...
        **kwargs: Any,
        ...
        for j, i in enumerate(indices[0]):
            ...
            # No idea why we would such a validation?
            if doc is None:
