...
from azure.ai.ml.entities._indexes._index.embeddings import WrappedLangChainDocument
...
class FileBasedDocStore(Docstore, AddableMixin):
    ...
    def __init__(self, docstore: FileBasedDocstore):
        """Initialize with azure.ai.ml.entities._indexes._index.docstore.FileBasedDocstore."""
