...
from .connection_subtypes import AzureOpenAIConnection, AzureAISearchConnection
...
class Index:
    ...
    def query(self, text: str) -> List[Document]:
        ...
        :rtype: List[azure.ai.ml.entities._indexes.langchain.vendor.schema.document.Document]
    ...
    def override_connections(self, aoai_connection: Optional[AzureOpenAIConnection] = None, acs_connection: Optional[AzureAISearchConnection] = None) -> None:
        ...
        :type aoai_connection: Optional[~azure.ai.ml.entities._indexes.entities.AzureOpenAIConnection]
        :param acs_connection: The AzureAISearchConnection to override the index's connection with.
        :type acs_connection: Optional[~azure.ai.ml.entities._indexes.entities.AzureAISearchConnection]
        """
