...
class CitationRegexSchema(metaclass=PatchedSchemaMeta):
    ...
    def make(self, data, **kwargs):
        from azure.ai.ml.entities._indexes.dataindex.entities.data_index import CitationRegex
...
class IndexSourceSchema(metaclass=PatchedSchemaMeta):
    ...
    @post_load
    def make(self, data, **kwargs):
        from azure.ai.ml.entities._indexes.dataindex.entities.data_index import IndexSource
...
class EmbeddingSchema(metaclass=PatchedSchemaMeta):
    ...
    @post_load
    def make(self, data, **kwargs):
        from azure.ai.ml.entities._indexes.dataindex.entities.data_index import Embedding
...
class IndexStoreSchema(metaclass=PatchedSchemaMeta):
    ...
    @post_load
    def make(self, data, **kwargs):
        from azure.ai.ml.entities._indexes.dataindex.entities.data_index import IndexStore
...
class DataIndexSchema(DataSchema):
    ...
    @post_load
    def make(self, data, **kwargs):
        from azure.ai.ml.entities._indexes.dataindex.entities.data_index import DataIndex
