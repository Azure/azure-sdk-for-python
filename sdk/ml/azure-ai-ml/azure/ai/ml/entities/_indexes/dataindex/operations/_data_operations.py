...
from azure.ai.ml.operations._data_operations import DataOperations

# TODO: Don't take dependencies on private members. This will probably break again in the future.
try:
    from azure.ai.ml.operations._data_operations import logger
except ImportError:
    from azure.ai.ml.operations._data_operations import ops_logger
