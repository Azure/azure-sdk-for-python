...
from azure.ai.ml.entities._indexes.documents.chunking import ChunkedDocument, split_documents
from azure.ai.ml.entities._indexes.documents.cracking import (
...
from azure.ai.ml.entities._indexes.documents.document import Document, StaticDocument
