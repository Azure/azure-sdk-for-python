...
from azure.ai.ml._restclient.arm_ml_service.models import OnlineRequestSettings as RestOnlineRequestSettings
from azure.ai.ml._restclient.arm_ml_service.models import ProbeSettings as RestProbeSettings
