...
def rest_field(
    *,
    ...
    return _RestField(name=name, type=type, visibility=visibility, default=default, format=format, is_multipart_file_input=is_multipart_file_input, is_required=is_required)
