...
from azure.ai.ml.constants import NodeType, BASE_PATH_CONTEXT_KEY
...
class Sweep(ParameterizedSweep, BaseNode):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        BaseNode.__init__(
            self, type=NodeType.SWEEP, component=trial, inputs=inputs, outputs=outputs, compute=compute, **kwargs
        )
