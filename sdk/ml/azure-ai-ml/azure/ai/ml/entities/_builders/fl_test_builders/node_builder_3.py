...
class NodeBuilder3(BaseNode, NodeIOMixin): 
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.comp_run2 = component2(float=3.33, folder=self.comp_run.outputs["component_out_path"])
        #@pipeline
        ...
        super(NodeBuilder3, self).__init__(
