...
class WorkspaceHubConfig:
    ...
    def _to_rest_object(self) -> RestWorkspaceHubConfig:
        return RestWorkspaceHubConfig(additional_workspace_storage_accounts=self.additional_workspace_storage_accounts, default_workspace_resource_group=self.default_workspace_resource_group)
