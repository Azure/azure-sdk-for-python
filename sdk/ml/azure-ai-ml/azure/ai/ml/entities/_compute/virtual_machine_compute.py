...
from azure.ai.ml._restclient.v2022_10_01_preview.models import VirtualMachineSchemaProperties, VirtualMachineSshCredentials
...
class VirtualMachineCompute(Compute):
    ...
    def _to_rest_object(self) -> ComputeResource:
        ...
        properties = VirtualMachineSchemaProperties(ssh_port=self.ssh_settings.ssh_port, administrator_account=credentials)
