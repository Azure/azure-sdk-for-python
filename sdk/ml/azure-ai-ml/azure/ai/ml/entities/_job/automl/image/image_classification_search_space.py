...
from azure.ai.ml._restclient.arm_ml_service.models import ImageModelDistributionSettingsClassification
...
class ImageClassificationSearchSpace(RestTranslatableMixin):
    ...
    :paramtype ams_gradient: bool or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword beta1: Value of 'beta1' when optimizer is 'adam' or 'adamw'. Must be a float in the
        range [0, 1].
    :paramtype beta1: float or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword beta2: Value of 'beta2' when optimizer is 'adam' or 'adamw'. Must be a float in the
        range [0, 1].
    :paramtype beta2: float or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword distributed: Whether to use distributer training.
    :paramtype distributed: bool or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword early_stopping: Enable early stopping logic during training.
    :paramtype early_stopping: bool or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    ...
    :paramtype early_stopping_delay: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword early_stopping_patience: Minimum number of epochs or validation evaluations with no
        primary metric improvement before
        the run is stopped. Must be a positive integer.
    :paramtype early_stopping_patience: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword enable_onnx_normalization: Enable normalization when exporting ONNX model.
    :paramtype enable_onnx_normalization: bool or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword evaluation_frequency: Frequency to evaluate validation dataset to get metric scores.
        Must be a positive integer.
    :paramtype evaluation_frequency: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    ...
    :paramtype gradient_accumulation_step: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    ...
    :paramtype layers_to_freeze: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword learning_rate: Initial learning rate. Must be a float in the range [0, 1].
    :paramtype learning_rate: float or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword learning_rate_scheduler: Type of learning rate scheduler. Must be 'warmup_cosine' or
        'step'.
    :paramtype learning_rate_scheduler: str or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    ...
    :paramtype model_name: str or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword momentum: Value of momentum when optimizer is 'sgd'. Must be a float in the range [0,
        1].
    :paramtype momentum: float or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword nesterov: Enable nesterov when optimizer is 'sgd'.
    :paramtype nesterov: bool or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword number_of_epochs: Number of training epochs. Must be a positive integer.
    :paramtype number_of_epochs: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword number_of_workers: Number of data loader workers. Must be a non-negative integer.
    :paramtype number_of_workers: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword optimizer: Type of optimizer. Must be either 'sgd', 'adam', or 'adamw'.
    :paramtype optimizer: str or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword random_seed: Random seed to be used when using deterministic training.
    :paramtype random_seed: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword step_lr_gamma: Value of gamma when learning rate scheduler is 'step'. Must be a float
        in the range [0, 1].
    :paramtype step_lr_gamma: float or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword step_lr_step_size: Value of step size when learning rate scheduler is 'step'. Must be
        a positive integer.
    :paramtype step_lr_step_size: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword training_batch_size: Training batch size. Must be a positive integer.
    :paramtype training_batch_size: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword validation_batch_size: Validation batch size. Must be a positive integer.
    :paramtype validation_batch_size: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword warmup_cosine_lr_cycles: Value of cosine cycle when learning rate scheduler is
        'warmup_cosine'. Must be a float in the range [0, 1].
    :paramtype warmup_cosine_lr_cycles: float or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword warmup_cosine_lr_warmup_epochs: Value of warmup epochs when learning rate scheduler is
        'warmup_cosine'. Must be a positive integer.
    :paramtype warmup_cosine_lr_warmup_epochs: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword weight_decay: Value of weight decay when optimizer is 'sgd', 'adam', or 'adamw'. Must
        be a float in the range[0, 1].
    :paramtype weight_decay: float or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    ...
    :paramtype training_crop_size: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    ...
    :paramtype validation_crop_size: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword validation_resize_size: Image size to which to resize before cropping for validation
        dataset. Must be a positive integer.
    :paramtype validation_resize_size: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
    :keyword weighted_loss: Weighted loss. The accepted values are 0 for no weighted loss.
        ...
        0 or 1 or 2.
    :paramtype weighted_loss: int or ~azure.ai.ml.entities._job.sweep.search_space.SweepDistribution
