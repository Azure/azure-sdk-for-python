...
class ImageClassificationJob(AutoMLImageClassificationBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.primary_metric = (
            primary_metric or ImageClassificationJob._DEFAULT_PRIMARY_METRIC
        )
    ...
    def _load_from_dict(
        ...
        **kwargs,
        ...
        if inside_pipeline:
            ...
            loaded_data = load_from_dict(
                ImageClassificationSchema, data, context, additional_message, **kwargs
            )
    ...
    def _to_dict(
        ...
        if inside_pipeline:
            ...
            schema_dict = ImageClassificationSchema(
