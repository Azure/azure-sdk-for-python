...
from azure.ai.ml._restclient.arm_ml_service.models import ImageObjectDetection as RestImageObjectDetection
from azure.ai.ml._restclient.arm_ml_service.models import JobBase, ObjectDetectionPrimaryMetrics, TaskType
