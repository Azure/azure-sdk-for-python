...
from azure.ai.ml._restclient.arm_ml_service.models import ImageModelDistributionSettingsObjectDetection
...
class ImageObjectDetectionSearchSpace(RestTranslatableMixin):
    ...
    :paramtype ams_gradient: bool or ~azure.ai.ml.entities.SweepDistribution
    :keyword beta1: Value of 'beta1' when optimizer is 'adam' or 'adamw'. Must be a float in the
        range [0, 1].
    :paramtype beta1: float or ~azure.ai.ml.entities.SweepDistribution
    :keyword beta2: Value of 'beta2' when optimizer is 'adam' or 'adamw'. Must be a float in the
        range [0, 1].
    :paramtype beta2: float or ~azure.ai.ml.entities.SweepDistribution
    :keyword distributed: Whether to use distributer training.
    :paramtype distributed: bool or ~azure.ai.ml.entities.SweepDistribution
    :keyword early_stopping: Enable early stopping logic during training.
    :paramtype early_stopping: bool or ~azure.ai.ml.entities.SweepDistribution
    ...
    :paramtype early_stopping_delay: int or ~azure.ai.ml.entities.SweepDistribution
    ...
    :paramtype early_stopping_patience: int or ~azure.ai.ml.entities.SweepDistribution
    :keyword enable_onnx_normalization: Enable normalization when exporting ONNX model.
    :paramtype enable_onnx_normalization: bool or ~azure.ai.ml.entities.SweepDistribution
    :keyword evaluation_frequency: Frequency to evaluate validation dataset to get metric scores.
        Must be a positive integer.
    :paramtype evaluation_frequency: int or ~azure.ai.ml.entities.SweepDistribution
    ...
    :paramtype gradient_accumulation_step: int or ~azure.ai.ml.entities.SweepDistribution
    ...
    :paramtype layers_to_freeze: int or ~azure.ai.ml.entities.SweepDistribution
    :keyword learning_rate: Initial learning rate. Must be a float in the range [0, 1].
        :paramtype learning_rate: float or ~azure.ai.ml.entities.SweepDistribution
    :keyword learning_rate_scheduler: Type of learning rate scheduler. Must be 'warmup_cosine' or
        'step'.
    :paramtype learning_rate_scheduler: str or ~azure.ai.ml.entities.SweepDistribution
    ...
    :paramtype box_detections_per_image: int or ~azure.ai.ml.entities.SweepDistribution
    ...
    :paramtype tile_grid_size: str or ~azure.ai.ml.entities.SweepDistribution
    :keyword tile_overlap_ratio: Overlap ratio between adjacent tiles in each dimension. Must be
        float in the range [0, 1).
    :paramtype tile_overlap_ratio: float or ~azure.ai.ml.entities.SweepDistribution
    ...
    :paramtype tile_predictions_nms_threshold: float or ~azure.ai.ml.entities.SweepDistribution
    :keyword validation_iou_threshold: IOU threshold to use when computing validation metric. Must
        be float in the range [0, 1].
    :paramtype validation_iou_threshold: float or ~azure.ai.ml.entities.SweepDistribution
    :keyword validation_metric_type: Metric computation method to use for validation metrics. Must
        be 'none', 'coco', 'voc', or 'coco_voc'.
    :paramtype validation_metric_type: str or ~azure.ai.ml.entities.SweepDistribution
