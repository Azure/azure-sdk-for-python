...
class ImageObjectDetectionSearchSpace(RestTranslatableMixin):
    ...
    def __init__(
        ...
        *,
        ...
        box_detections_per_image: Optional[Union[int, SweepDistribution]] = None,
        box_score_threshold: Optional[Union[float, SweepDistribution]] = None,
        image_size: Optional[Union[int, SweepDistribution]] = None,
        max_size: Optional[Union[int, SweepDistribution]] = None,
        min_size: Optional[Union[int, SweepDistribution]] = None,
        model_size: Optional[Union[str, SweepDistribution]] = None,
        multi_scale: Optional[Union[bool, SweepDistribution]] = None,
        nms_iou_threshold: Optional[Union[float, SweepDistribution]] = None,
        tile_grid_size: Optional[Union[str, SweepDistribution]] = None,
        tile_overlap_ratio: Optional[Union[float, SweepDistribution]] = None,
        tile_predictions_nms_threshold: Optional[Union[float, SweepDistribution]] = None,
        validation_iou_threshold: Optional[Union[float, SweepDistribution]] = None,
        validation_metric_type: Optional[Union[str, SweepDistribution]] = None,
    ) -> None:
