...
@experimental
class SyntheticDataGenerationDataTaskJob(SyntheticDataGeneration):
    def __init__(
        self,
    ...
    def training_data(self, data: Optional[Input]) -> None:
    ...
    def _load_from_dict(
        ...
        :return: SyntheticDataGenerationDataTaskJob object.
