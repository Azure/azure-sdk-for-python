...
class TextClassificationJob(AutoMLNLPJob):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
            ...
            or TextClassificationJob._DEFAULT_PRIMARY_METRIC,
    ...
    def _load_from_dict(
        ...
        if kwargs.pop("inside_pipeline", False):
            ...
            loaded_data = load_from_dict(
                TextClassificationSchema, data, context, additional_message, **kwargs
            )
    ...
    def _to_dict(
        ...
        if inside_pipeline:
            return AutoMLTextClassificationNode(
                context={BASE_PATH_CONTEXT_KEY: "./"}
            ).dump(self)

        return TextClassificationSchema(context={BASE_PATH_CONTEXT_KEY: "./"}).dump(
            self
        )
