...
class NlpSearchSpace(RestTranslatableMixin):
    ...
    :type gradient_accumulation_steps: Optional[Union[int, SweepDistribution]], optional
    :param learning_rate: initial learning rate. Must be a float in (0, 1)., defaults to None
    :type learning_rate: Optional[Union[float, SweepDistribution]], optional
    ...
    :type learning_rate_scheduler: Optional[Union[str, SweepDistribution]], optional
    ...
    :type warmup_ratio: Optional[Union[float, SweepDistribution]], optional
    ...
    :type weight_decay: Optional[Union[float, SweepDistribution]], optional
    """
