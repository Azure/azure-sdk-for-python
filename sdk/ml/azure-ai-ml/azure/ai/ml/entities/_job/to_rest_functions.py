...
from azure.ai.ml._restclient.v2023_08_01_preview.models import JobBase as JobBaseData_2308
...
def generate_defaults(job: Job, rest_job: Union[JobBaseData, JobBaseData_2308]) -> None:
