...
class InternalCode(Code):
    ...
    def _upload_hash(self) -> Optional[str]:
        ...
        # update self.name and lock it on that point so that it will be aligned with
        # the uploaded content and will be used in code creation request

        # self.path will be transformed to an absolute path in Artifact.path.setter
