...
class TestJobOperations:
    def test_list(self, mock_job_operation: JobOperations) -> None:
        ...
        assert expected in mock_job_operation._service_client_operation.list.call_args
    ...
    def test_submit_command_job(self, mock_method, mock_job_operation: JobOperations) -> None:
        ...
        mock_job_operation._service_client_operation.create_or_update.assert_called_once()
