...
from azure.ai.ml._operations.dataset_operations import DatasetOperations, DatastoreOperations
...
class TestDatasetOperations:
    ...
    def test_create_with_spec_file(
        ...
        with patch(
            ...
            "azure.ai.ml._operations.dataset_operations.Dataset._from_rest_object",
    ...
    def test_create_autoincrement(
        ...
        with patch(
            "azure.ai.ml._operations.dataset_operations._check_and_upload_path",
            return_value=(dataset, "indicatorfile.txt"),
        ), patch("azure.ai.ml._operations.dataset_operations.Dataset._from_rest_object", return_value=dataset), patch(
            "azure.ai.ml._operations.dataset_operations._get_default_datastore_info", return_value=None
        ), patch(
            "azure.ai.ml._operations.dataset_operations._update_metadata", return_value=None
        ) as mock_update:
