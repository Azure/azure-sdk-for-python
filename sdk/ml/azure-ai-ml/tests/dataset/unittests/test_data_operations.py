...
class TestDataOperations:
    ...
    def test_promote_data_from_workspace(
            self, mock_data_operations_in_registry: DataOperations,
            mock_data_operations: DataOperations, tmp_path: Path) -> None:
    ...
    version: 3""")
        ...
        with patch(
            ...
            data_to_promote = mock_data_operations._prepare_to_copy(
                data, "new_name", "new_version")
