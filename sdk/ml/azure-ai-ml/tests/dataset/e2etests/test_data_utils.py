...
from azure.ai.ml._utils._data_utils import validate_mltable_metadata, download_mltable_metadata_schema
from azure.ai.ml.constants import MLTABLE_METADATA_SCHEMA_URL_FALLBACK
