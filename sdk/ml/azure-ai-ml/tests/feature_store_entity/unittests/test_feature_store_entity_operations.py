...
class TestFeatureStoreEntityOperations:
    ...
    def test_get_no_version(self, mock_feature_store_entity_operations: FeatureStoreEntityOperations) -> None:
        name = "random_name"
    ...
    def test_archive_container(self, mock_feature_store_entity_operations: FeatureStoreEntityOperations):
        name = "random_name"
    ...
    def test_restore_container(self, mock_feature_store_entity_operations: FeatureStoreEntityOperations):
        name = "random_name"
        FeatureStoreEntity_container = Mock(
