...
class TestCapabilityHostEntity:
    ...
    def test_capability_host_project_schema(self) -> None:
        ...
        assert capability_host.capability_host_kind == "Agents"
        assert capability_host.ai_services_connections is not None and len(capability_host.ai_services_connections) == 1 and capability_host.ai_services_connections[0] == "aiservice_connection_1"
        assert capability_host.storage_connections is not None and len(capability_host.storage_connections) == 1 and capability_host.storage_connections[0] == "storage_connection_1"
        assert capability_host.vector_store_connections is not None and len(capability_host.vector_store_connections) == 1 and capability_host.vector_store_connections[0] == "vector_store_connection_1"
    ...
    def test_to_rest_object_for_project(self) -> None:
        ...
        assert rest_capability_host.properties.capability_host_kind == "Agents"
        assert rest_capability_host.properties.ai_services_connections is not None and len(rest_capability_host.properties.ai_services_connections) == 1 and rest_capability_host.properties.ai_services_connections[0] == "aiservice_connection_1"
        assert rest_capability_host.properties.storage_connections is not None and len(rest_capability_host.properties.storage_connections) == 1 and rest_capability_host.properties.storage_connections[0] == "storage_connection_1"
