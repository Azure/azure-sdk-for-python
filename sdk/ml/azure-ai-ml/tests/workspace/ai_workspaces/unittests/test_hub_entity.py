...
class TestProjectEntity:
    def test_project_schema_manipulation(self) -> None:
        hub = load_hub(source="./tests/test_configs/workspace/ai_workspaces/aihub_min.yml")
        assert hub.name == "hub_name"
        assert hub.location == "WestCentralUS"
        assert hub.additional_workspace_storage_accounts == [
            "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/testRG/providers/Microsoft.Storage/storageAccounts/extra-storage-account"
        ]
        assert (
