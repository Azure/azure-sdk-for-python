...
from azure.ai.ml._restclient.arm_ml_service.models import EnvironmentVersion as EnvironmentVersionData, EnvironmentVersionProperties as EnvironmentVersionDetails
