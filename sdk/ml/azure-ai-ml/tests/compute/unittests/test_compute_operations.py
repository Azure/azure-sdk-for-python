...
def mock_compute_operation(
    mock_workspace_scope: OperationScope, mock_operation_config: OperationConfig, mock_aml_services_2022_12_01_preview: Mock
) -> ComputeOperations:
...
class TestComputeOperation:
    ...
    def test_create_compute_instance(
        ...
        mocker.patch(
            "azure.ai.ml._restclient.v2022_12_01_preview.workspaces.get",
            return_value=funny(),
        )
        mocker.patch(
    ...
    def test_create_aml_compute(
        ...
        mocker.patch("azure.ai.ml._restclient.v2022_12_01_preview.workspaces.get", return_value=funny())
