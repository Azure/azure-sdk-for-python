...
class TestReferenceComponent:
    def test_reference_local_component(self, hello_world_component_reference):
        ...
        hello_world_load_component = load_component(source=test_path)
    ...
    def test_reference_parallel_component(self, batch_inference_component_reference):
        ...
        batch_inference_load_component = load_component(source=test_path)
    ...
    def test_reference_local_component_illegal(self, hello_world_component_reference):
        ...
        with pytest.raises(UnexpectedKeywordError) as e:
    ...
    def test_reference_1p_component(self, hello_world_command_1p_reference):
        ...
        node1 = hello_world_command_1p_reference(
            training_data=Input(path="/a/path/on/ds"), learning_rate=0.1, max_epochs=10
        )
        node2 = hello_world_load_component(training_data=Input(path="/a/path/on/ds"), learning_rate=0.1, max_epochs=10)
