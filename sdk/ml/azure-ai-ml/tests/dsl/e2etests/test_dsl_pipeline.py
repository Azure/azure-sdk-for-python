...
from azure.ai.ml.constants import AssetTypes, InputOutputModes, PipelineConstants
...
from azure.ai.ml.entities import Component as ComponentEntity, Data
from azure.ai.ml import TensorFlowDistribution, MpiDistribution, PyTorchDistribution, load_component
from pipeline_job.e2etests.test_pipeline_job import (
    assert_job_input_output_types,
)
...
class TestDSLPipeline:
    ...
    def test_spark_components(self, client: MLClient, randstr: Callable[[], str]) -> None:
        ...
        spark_component_func = load_component(path=str(components_dir / "component.yml"))
        ...
        def spark_pipeline_from_yaml(iris_data):
            ...
            spark_job.driver_cores = 1
            spark_job.driver_memory = "2g"
            spark_job.executor_cores = 2
            spark_job.executor_memory = "2g"
            spark_job.executor_instances = 4
            return {"output1": spark_job.outputs.output}
        ...
        pipeline.outputs.output1.mode = "Direct"
        pipeline.outputs.output1.type = "uri_file"
