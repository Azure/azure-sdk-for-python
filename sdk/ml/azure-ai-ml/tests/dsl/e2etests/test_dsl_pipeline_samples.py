...
from azure.ai.ml.entities import Component as ComponentEntity, Job, PipelineJob
import sys
...
class TestDSLPipelineSamples:
    ...
    def test_e2e_registered_components(
        ...
        from dsl_pipeline.e2e_registered_components.pipeline import (
    ...
    @pytest.mark.e2etest
    def test_pipeline_with_hyperparameter_sweep(self, client: MLClient) -> None:
        from dsl_pipeline.pipeline_with_hyperparameter_sweep.pipeline import generate_dsl_pipeline_with_sweep_node
