...
@pytest.fixture()
def hello_world_component_upper_inputs_reference():
    test_path = "./tests/test_configs/components/helloworld_component_upper_inputs.yml"

    @reference_component(path=test_path)
    def hello_world(
        component_in_number: float = None,
        COMPONENT_IN_NUMBER_UPPER: float = None,
    ) -> Command:
        ...
...
@pytest.fixture
def hello_world_command_1p_reference():
    ...
    return microsoft_com_azureml_samples_train
