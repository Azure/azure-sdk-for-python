...
class TestScheduleOperationsInitGaps(AzureRecordedTestCase):
...
# Additional generated tests (kept separate to avoid duplicating existing tests)
@pytest.mark.e2etest
@pytest.mark.usefixtures("recorded_test")
class TestScheduleOperationsGapsGenerated(AzureRecordedTestCase):
...
@pytest.mark.e2etest
@pytest.mark.usefixtures("recorded_test")
class TestScheduleOperationsGapsAdditional(AzureRecordedTestCase):
...
@pytest.mark.e2etest
@pytest.mark.usefixtures("recorded_test")
class TestScheduleOperationsGapsExtra(AzureRecordedTestCase):
