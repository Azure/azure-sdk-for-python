...
class TestCloudEnvironments:
    ...
    def test_set_valid_cloud_details_china(self):
        ...
        cloud_details = _get_cloud_environment_info_from_metadata(cloud_environment)
    ...
    def test_all_endpointurls_used(self, mock_get):
        cloud_details = _get_cloud_environment_info("TEST_ENV")
    ...
    def test_metadata_registry_endpoint(self, mock_get):
        cloud_details = _get_cloud_environment_info("TEST_ENV2")
        assert (
