...
class TestPackageInstallation:
    ...
    @pytest.mark.skipif(
        not (IS_CPYTHON and sys.version_info < (3, 13)) or IS_MACOS_ARM64,
        reason="Skipping because environment is not below cpython 3.13, or is macOS arm64 (no rslex wheels)",
    )
