...
class TestDeploymentTemplateSchema:
    ...
    def test_schema_fields(self, schema):
        ...
        expected_fields = {
            'name', 'version', 'description', 'tags', 'environment_variables',
            'request_settings', 'liveness_probe', 'readiness_probe', 
            'instance_count', 'model_mount_path', 'allowed_instance_types',
            'default_instance_type', 'environment', 'type', 'deployment_template_type'
        }
