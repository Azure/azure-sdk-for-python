...
PARAMETERS_TO_TEST = [
    ...
    (
        ...
        {
            "input_path": Input(type=AssetTypes.MLTABLE, path="imdb_reviews_train@latest"),
        },
        {
            "compute": "cpu-cluster",  # runsettings.target
            "environment": None,  # runsettings.environment
    ...
    (
        ...
        {
            "model_path": Input(type=AssetTypes.MLTABLE, path="mnist_model@latest"),
            "images_to_score": Input(type=AssetTypes.MLTABLE, path="mnist@latest"),
        },
        {
    ...
    (
        ...
        {
            "source_data": Input(type=AssetTypes.MLTABLE, path="aml_component_datatransfer_folder@latest"),
        },
        {
            "compute": ADF_NAME,
        },
    ...
    (
        ...
        {
            "FileList": Input(type=AssetTypes.MLTABLE, path="starlite_sample_output@latest"),
    ...
    (
        "./tests/test_configs/internal/ae365exepool-component/component_spec.yaml",
        {
            ...
            "DataToLookAt": Input(type=AssetTypes.MLTABLE, path="reghits@latest"),
