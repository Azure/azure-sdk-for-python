...
class TestDeploymentTemplateOperationsGaps(AzureRecordedTestCase):
    ...
    def test_archive_and_restore_on_nonexistent_raise_resource_not_found(
        self, client: MLClient, randstr: Callable[[], str]
    ) -> None:
    ...
    def test_get_nonexistent_without_version_raises_resource_not_found(
        self, client: MLClient, randstr: Callable[[], str]
    ) -> None:
        name = randstr("dt_name")
    ...
    def test_delete_nonexistent_without_version_raises_resource_not_found(
        self, client: MLClient, randstr: Callable[[], str]
    ) -> None:
        name = randstr("dt_name")
    ...
    def test_archive_nonexistent_propagates_resource_not_found(
        self, client: MLClient, randstr: Callable[[], str]
    ) -> None:
        name = randstr("dt_name")
    ...
    def test_restore_nonexistent_propagates_resource_not_found(
        self, client: MLClient, randstr: Callable[[], str]
    ) -> None:
        name = randstr("dt_name")
