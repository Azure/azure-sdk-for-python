...
@pytest.mark.e2etest
@pytest.mark.usefixtures("recorded_test", "mock_code_hash", "mock_asset_name", "mock_component_hash", "mock_snapshot_hash", "mock_anon_component_version", "storage_account_guid_sanitizer")
