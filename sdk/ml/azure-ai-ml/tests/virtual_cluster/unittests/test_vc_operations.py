...
class TestVCOperations:
    ...
    def test_get(self, mock_function, mock_vc_operation: VirtualClusterOperations, mock_workspace_scope: OperationScope, mock_credential: Mock) -> None:
        ...
        mock_function.assert_called_once_with(name="name1", resource_group=mock_workspace_scope.resource_group_name, subscription_id=mock_workspace_scope.subscription_id, credential=mock_credential)
