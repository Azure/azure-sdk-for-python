    ...
    def test_resources_instance_type(self):
        with pytest.raises(ValidationException) as ve:
            node = spark(
                code="./tests/test_configs/spark_job/basic_spark_job/src",
                entry={"file": "./main.py"},
                resources=SparkResourceConfiguration(instance_type="Standard_E128S_V3", runtime_version="3.3.0"),
                driver_cores=1,
                driver_memory="2g",
                executor_cores=2,
                executor_memory="2g",
    ...
    def test_resources_runtime_version_with_char(self):
        with pytest.raises(ValueError) as ve:
            node = spark(
                code="./tests/test_configs/spark_job/basic_spark_job/src",
                entry={"file": "./main.py"},
                resources=SparkResourceConfiguration(instance_type="Standard_E8S_V3", runtime_version="3.3.abc"),
                driver_cores=1,
                driver_memory="2g",
                executor_cores=2,
                executor_memory="2g",
