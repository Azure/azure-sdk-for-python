...
class TestComponentOperationsGaps:
    ...
    def test_refine_component_requires_type_annotations_for_parameters(
    ...
    def test_refine_component_rejects_non_dsl_non_mldesigner_function(
        self, client: MLClient
    ) -> None:
...
class TestComponentOperationsRefine:
    ...
    def test_refine_component_raises_on_unknown_type_keys(
        self, client: MLClient
    ) -> None:
...
class TestComponentOperationsValidation:
    def test_component_function_with_variable_args_raises(
        self, client: MLClient
    ) -> None:
        ...
        assert "Function must be a dsl or mldesigner component function" in str(
            exinfo.value
        )

    def test_pipeline_function_with_non_pipeline_inputs_raises(
        self, client: MLClient
    ) -> None:
    ...
    def test_plain_function_not_dsl_or_mldesigner_raises(
        self, client: MLClient
    ) -> None:
...
class TestComponentOperationsValidationErrors:
    def test_create_or_update_with_plain_function_raises_validation(
        self, client: MLClient
    ) -> None:
...
class TestComponentOperationsGeneratedBatch1:
    def test_create_or_update_with_untyped_function_raises_validation(
        self, client: MLClient
    ) -> None:
        """
    ...
    def test_validate_pipeline_function_with_varargs_raises(
        self, client: MLClient
    ) -> None:
        """
