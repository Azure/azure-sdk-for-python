...
def primitive_component_with_normal_input_output_v2(
    input_data: Input, parambool: bool, paramint: int, paramfloat: float, paramstr: str,
    output_data: Output,
    ...
    print(f"output params are: bool_param_output: {bool_param_output}, int_param_output: {int_param_output}, float_param_output: {float_param_output}, str_param_output: {str_param_output}")
    control_output_content = '{"int_param_output": "%s", "bool_param_output": "%s", "float_param_output": "%s", "str_param_output": "%s"}' % (
