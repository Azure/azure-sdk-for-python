...
def generate_dsl_pipeline_from_builder() -> PipelineJob:
    ...
    outputs = {"sink": Output(type=AssetTypes.MLTABLE, path="azureml://datastores/workspaceblobstore_sas/paths/importjob/${{name}}/output_dir/snowflake/")}
    source = {'type': 'database', 'connection': connection_target_azuresql,
