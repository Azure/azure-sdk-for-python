...
def generate_dsl_pipeline_from_yaml() -> PipelineJob:
    ...
    def spark_pipeline_from_yaml(iris_data):
        ...
        add_greeting_column.resources = {"instance_type": "standard_e4s_v3", "runtime_version": "3.3.0"}
        count_by_row = count_by_row_func(file_input=iris_data)
        count_by_row.resources = {"instance_type": "standard_e4s_v3", "runtime_version": "3.3.0"}
