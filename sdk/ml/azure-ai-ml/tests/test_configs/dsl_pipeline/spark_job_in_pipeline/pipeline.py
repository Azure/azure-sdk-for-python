from azure.ai.ml import dsl, Input, load_component, spark, ManagedIdentity, Output
...
def generate_dsl_pipeline_from_yaml() -> PipelineJob:
    ...
    def spark_pipeline_from_yaml(iris_data):
        ...
        # conf = {"spark.driver.cores": 2, "spark.driver.memory": "1g", "spark.executor.cores": 1, "spark.executor.memory": "1g", "spark.executor.instances":1}
        # spark_job.conf = conf
        spark_job.driver_cores = 2
        spark_job.driver_memory = "1g"
        spark_job.executor_cores = 1
        spark_job.executor_memory = "1g"
        spark_job.executor_instances = 1
