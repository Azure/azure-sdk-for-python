...
class DataSetMappingsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.DataSetMapping] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("DataSetMapping", pipeline_response.http_response)
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type data_set_mapping_name: str
        :param data_set_mapping: Destination data set configuration details. Required.
        :type data_set_mapping: IO[bytes]
    ...
    async def create(
        ...
        share_subscription_name: str,
        data_set_mapping_name: str,
        data_set_mapping: Union[_models.DataSetMapping, IO[bytes]],
        **kwargs: Any
    ) -> _models.DataSetMapping:
        """Maps a source data set in the source share to a sink data set in the share subscription.
        Enables copying the data set from source to destination.
        ...
        :param data_set_mapping_name: The name of the data set mapping to be created. Required.
        :type data_set_mapping_name: str
        :param data_set_mapping: Destination data set configuration details. Is either a DataSetMapping
         type or a IO[bytes] type. Required.
        :type data_set_mapping: ~azure.mgmt.datashare.models.DataSetMapping or IO[bytes]
        :return: DataSetMapping or the result of cls(response)
        :rtype: ~azure.mgmt.datashare.models.DataSetMapping
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _json = None
        _content = None
        if isinstance(data_set_mapping, (IOBase, bytes)):
    ...
    def list_by_share_subscription(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.DataSetMapping"]:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.DataSetMappingList] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_share_subscription_request(
                    resource_group_name=resource_group_name,
                    account_name=account_name,
                    share_subscription_name=share_subscription_name,
                    subscription_id=self._config.subscription_id,
