...
class DataSetsOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("DataSet", pipeline_response.http_response)
    ...
    async def create(
        ...
        share_name: str,
        data_set_name: str,
        data_set: Union[_models.DataSet, IO[bytes]],
        **kwargs: Any
    ) -> _models.DataSet:
        """Adds a new data set to an existing share.
        ...
        :param data_set_name: The name of the dataSet. Required.
        :type data_set_name: str
        :param data_set: The new data set information. Is either a DataSet type or a IO[bytes] type.
         Required.
        :type data_set: ~azure.mgmt.datashare.models.DataSet or IO[bytes]
        :return: DataSet or the result of cls(response)
        :rtype: ~azure.mgmt.datashare.models.DataSet
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _json = None
        _content = None
        if isinstance(data_set, (IOBase, bytes)):
            _content = data_set
        else:
    ...
    def list_by_share(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.DataSetList] = kwargs.pop("cls", None)
