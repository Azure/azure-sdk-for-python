...
class TriggersOperations:
    ...
    def _create_initial(
        ...
        share_subscription_name: str,
        trigger_name: str,
        trigger: Union[_models.Trigger, IO],
        **kwargs: Any
    ) -> _models.Trigger:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param trigger_name: The name of the trigger. Required.
        :type trigger_name: str
        :param trigger: Trigger details. Is either a model type or a IO type. Required.
        :type trigger: ~azure.mgmt.datashare.models.Trigger or IO
