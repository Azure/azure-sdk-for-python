...
def build_list_by_share_subscription_request(
    resource_group_name: str,
    account_name: str,
    share_subscription_name: str,
    subscription_id: str,
...
class TriggersOperations:
    ...
    def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("Trigger", pipeline_response.http_response)
    ...
    def _create_initial(
        ...
        share_subscription_name: str,
        trigger_name: str,
        trigger: Union[_models.Trigger, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param trigger_name: The name of the trigger. Required.
        :type trigger_name: str
        :param trigger: Trigger details. Is either a Trigger type or a IO[bytes] type. Required.
        :type trigger: ~azure.mgmt.datashare.models.Trigger or IO[bytes]
        :return: An instance of LROPoller that returns either Trigger or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.datashare.models.Trigger]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_share_subscription(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.datashare.models.Trigger]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
