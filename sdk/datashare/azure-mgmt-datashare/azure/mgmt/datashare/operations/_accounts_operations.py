...
class AccountsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, skip_token: Optional[str] = None, **kwargs: Any) -> Iterable["_models.Account"]:
    ...
    def begin_create(
        ...
        :param account_name: The name of the share account. Required.
        :type account_name: str
        :param account: The account payload. Is either a model type or a IO type. Required.
        :type account: ~azure.mgmt.datashare.models.Account or IO
    ...
    def update(
        ...
        resource_group_name: str,
        account_name: str,
        account_update_parameters: Union[_models.AccountUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.Account:
        """Patch a given account.
        ...
        :param account_name: The name of the share account. Required.
        :type account_name: str
        :param account_update_parameters: The account update parameters. Is either a model type or a IO
         type. Required.
        :type account_update_parameters: ~azure.mgmt.datashare.models.AccountUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
