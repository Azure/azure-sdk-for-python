...
def build_list_by_subscription_request(
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DataShare/accounts")
...
class AccountsOperations:
    ...
    def list_by_subscription(self, skip_token: Optional[str] = None, **kwargs: Any) -> ItemPaged["_models.Account"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.datashare.models.Account]
    ...
    def get(self, resource_group_name: str, account_name: str, **kwargs: Any) -> _models.Account:
        ...
        :rtype: ~azure.mgmt.datashare.models.Account
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def _create_initial(
        self, resource_group_name: str, account_name: str, account: Union[_models.Account, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.datashare.models.Account]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        :param account_name: The name of the share account. Required.
        :type account_name: str
        :param account: The account payload. Is either a Account type or a IO[bytes] type. Required.
        :type account: ~azure.mgmt.datashare.models.Account or IO[bytes]
        :return: An instance of LROPoller that returns either Account or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.datashare.models.Account]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type account_update_parameters: ~azure.mgmt.datashare.models.AccountUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Account or the result of cls(response)
    ...
    def update(
        ...
        resource_group_name: str,
        account_name: str,
        account_update_parameters: Union[_models.AccountUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.Account:
        """Patch a given account.
        ...
        :type account_update_parameters: ~azure.mgmt.datashare.models.AccountUpdateParameters or
         IO[bytes]
        :return: Account or the result of cls(response)
        :rtype: ~azure.mgmt.datashare.models.Account
        :raises ~azure.core.exceptions.HttpResponseError:
