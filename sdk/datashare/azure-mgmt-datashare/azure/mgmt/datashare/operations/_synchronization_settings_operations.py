...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "synchronizationSettingName": _SERIALIZER.url(
            "synchronization_setting_name", synchronization_setting_name, "str"
        ),
    }
...
class SynchronizationSettingsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`synchronization_settings` attribute.
    """
    ...
    def get(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.SynchronizationSetting] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("SynchronizationSetting", pipeline_response.http_response)
    ...
    def create(
        ...
        share_name: str,
        synchronization_setting_name: str,
        synchronization_setting: IO[bytes],
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.SynchronizationSetting:
        ...
        :type synchronization_setting_name: str
        :param synchronization_setting: The new synchronization setting information. Required.
        :type synchronization_setting: IO[bytes]
    ...
    def create(
        ...
        share_name: str,
        synchronization_setting_name: str,
        synchronization_setting: Union[_models.SynchronizationSetting, IO[bytes]],
        **kwargs: Any
    ) -> _models.SynchronizationSetting:
        """Adds a new synchronization setting to an existing share.
        ...
        :param synchronization_setting_name: The name of the synchronizationSetting. Required.
        :type synchronization_setting_name: str
        :param synchronization_setting: The new synchronization setting information. Is either a
         SynchronizationSetting type or a IO[bytes] type. Required.
        :type synchronization_setting: ~azure.mgmt.datashare.models.SynchronizationSetting or IO[bytes]
        :return: SynchronizationSetting or the result of cls(response)
        :rtype: ~azure.mgmt.datashare.models.SynchronizationSetting
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _json = None
        _content = None
        if isinstance(synchronization_setting, (IOBase, bytes)):
            _content = synchronization_setting
        else:
    ...
    def begin_delete(
        ...
        **kwargs: Any
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("OperationResponse", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if cont_token:
            return LROPoller[_models.OperationResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.OperationResponse](
    ...
    def list_by_share(
        ...
        skip_token: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.SynchronizationSetting"]:
        ...
        :type skip_token: str
        :return: An iterator like instance of either SynchronizationSetting or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.datashare.models.SynchronizationSetting]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.SynchronizationSettingList] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_share_request(
                    resource_group_name=resource_group_name,
                    account_name=account_name,
                    share_name=share_name,
                    subscription_id=self._config.subscription_id,
