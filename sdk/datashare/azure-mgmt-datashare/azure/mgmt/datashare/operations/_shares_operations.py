...
class SharesOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.datashare.models.Share or
    ...
    def create(
            self, resource_group_name, account_name, share_name, share, custom_headers=None, raw=False, **operation_config):
    ...
    def delete(
            self, resource_group_name, account_name, share_name, custom_headers=None, raw=False, polling=True, **operation_config):
        """Deletes a share.
    ...
    def list_by_account(
        ...
        :rtype:
         ~azure.mgmt.datashare.models.SharePaged[~azure.mgmt.datashare.models.Share]
        :raises:
         :class:`DataShareErrorException<azure.mgmt.datashare.models.DataShareErrorException>`
        """
