...
def build_list_source_share_synchronization_settings_request(  # pylint: disable=name-too-long
...
class ShareSubscriptionsOperations:
    ...
    def _cancel_synchronization_initial(
        ...
        account_name: str,
        share_subscription_name: str,
        share_subscription_synchronization: Union[_models.ShareSubscriptionSynchronization, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        ...
        _json = None
        _content = None
        if isinstance(share_subscription_synchronization, (IOBase, bytes)):
        ...
        _request = build_cancel_synchronization_request(
    ...
    def begin_cancel_synchronization(
        ...
        account_name: str,
        share_subscription_name: str,
        share_subscription_synchronization: IO[bytes],
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.ShareSubscriptionSynchronization]:
        ...
        :param share_subscription_synchronization: Share Subscription Synchronization payload.
         Required.
        :type share_subscription_synchronization: IO[bytes]
    ...
    def begin_cancel_synchronization(
        ...
        **kwargs: Any
        ...
        :param share_subscription_synchronization: Share Subscription Synchronization payload. Is
         either a ShareSubscriptionSynchronization type or a IO[bytes] type. Required.
        :type share_subscription_synchronization:
         ~azure.mgmt.datashare.models.ShareSubscriptionSynchronization or IO[bytes]
        :return: An instance of LROPoller that returns either ShareSubscriptionSynchronization or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.datashare.models.ShareSubscriptionSynchronization]
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("ShareSubscriptionSynchronization", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if cont_token:
            return LROPoller[_models.ShareSubscriptionSynchronization].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ShareSubscriptionSynchronization](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    @distributed_trace
    def list_source_share_synchronization_settings(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        account_name: str,
        share_subscription_name: str,
        skip_token: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.SourceShareSynchronizationSetting"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_source_share_synchronization_settings_request(
                    resource_group_name=resource_group_name,
                    account_name=account_name,
                    share_subscription_name=share_subscription_name,
                    subscription_id=self._config.subscription_id,
    ...
    def list_synchronizations(
        ...
        orderby: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.ShareSubscriptionSynchronization"]:
    ...
    def _synchronize_initial(
        ...
        account_name: str,
        share_subscription_name: str,
        synchronize: Union[_models.Synchronize, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(synchronize, (IOBase, bytes)):
            _content = synchronize
        else:
            _json = self._serialize.body(synchronize, "Synchronize")

        _request = build_synchronize_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
            share_subscription_name=share_subscription_name,
            subscription_id=self._config.subscription_id,
    ...
    def begin_synchronize(
        ...
        **kwargs: Any
        ...
        :param share_subscription_name: The name of share subscription. Required.
        :type share_subscription_name: str
        :param synchronize: Synchronize payload. Is either a Synchronize type or a IO[bytes] type.
         Required.
        :type synchronize: ~azure.mgmt.datashare.models.Synchronize or IO[bytes]
        :return: An instance of LROPoller that returns either ShareSubscriptionSynchronization or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.datashare.models.ShareSubscriptionSynchronization]
    ...
    def get(
        ...
        deserialized = self._deserialize("ShareSubscription", pipeline_response.http_response)
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :type share_subscription_name: str
        :param share_subscription: create parameters for shareSubscription. Required.
        :type share_subscription: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ShareSubscription or the result of cls(response)
    ...
    def create(
        ...
        account_name: str,
        share_subscription_name: str,
        share_subscription: Union[_models.ShareSubscription, IO[bytes]],
        **kwargs: Any
    ) -> _models.ShareSubscription:
        """Create shareSubscription in an account.
        ...
        :param share_subscription_name: The name of the shareSubscription. Required.
        :type share_subscription_name: str
        :param share_subscription: create parameters for shareSubscription. Is either a
         ShareSubscription type or a IO[bytes] type. Required.
        :type share_subscription: ~azure.mgmt.datashare.models.ShareSubscription or IO[bytes]
        :return: ShareSubscription or the result of cls(response)
        :rtype: ~azure.mgmt.datashare.models.ShareSubscription
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _json = None
        _content = None
        if isinstance(share_subscription, (IOBase, bytes)):
    ...
    def list_by_account(
        ...
        orderby: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.ShareSubscription"]:
