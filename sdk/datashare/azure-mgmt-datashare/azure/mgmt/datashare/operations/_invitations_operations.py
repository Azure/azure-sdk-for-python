...
class InvitationsOperations(object):
    ...
    def get(
            self, resource_group_name, account_name, share_name, invitation_name, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~azure.mgmt.datashare.models.Invitation or
    ...
    def create(
            self, resource_group_name, account_name, share_name, invitation_name, invitation, custom_headers=None, raw=False, **operation_config):
    ...
    def list_by_share(
        ...
        :rtype:
         ~azure.mgmt.datashare.models.InvitationPaged[~azure.mgmt.datashare.models.Invitation]
        :raises:
         :class:`DataShareErrorException<azure.mgmt.datashare.models.DataShareErrorException>`
        """
