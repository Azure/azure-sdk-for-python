...
class InvitationsOperations:
    ...
    def get(
        ...
        cls: ClsType[_models.Invitation] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("Invitation", pipeline_response.http_response)
    ...
    def create(
        ...
        share_name: str,
        invitation_name: str,
        invitation: Union[_models.Invitation, IO[bytes]],
        **kwargs: Any
    ) -> _models.Invitation:
        """Sends a new invitation to a recipient to access a share.
        ...
        :param invitation_name: The name of the invitation. Required.
        :type invitation_name: str
        :param invitation: Invitation details. Is either a Invitation type or a IO[bytes] type.
         Required.
        :type invitation: ~azure.mgmt.datashare.models.Invitation or IO[bytes]
        :return: Invitation or the result of cls(response)
        :rtype: ~azure.mgmt.datashare.models.Invitation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_share(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.InvitationList] = kwargs.pop("cls", None)
