...
def build_adjust_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "providerShareSubscriptionId": _SERIALIZER.url(
            "provider_share_subscription_id", provider_share_subscription_id, "str"
        ),
    }
...
class ProviderShareSubscriptionsOperations:
    ...
    def adjust(
        ...
        share_name: str,
        provider_share_subscription_id: str,
        provider_share_subscription: IO[bytes],
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.ProviderShareSubscription:
        ...
        :type provider_share_subscription_id: str
        :param provider_share_subscription: The provider share subscription. Required.
        :type provider_share_subscription: IO[bytes]
    ...
    def adjust(
        ...
        share_name: str,
        provider_share_subscription_id: str,
        provider_share_subscription: Union[_models.ProviderShareSubscription, IO[bytes]],
        **kwargs: Any
    ) -> _models.ProviderShareSubscription:
        """Adjust the expiration date of a share subscription in a provider share.
        ...
        :param provider_share_subscription_id: To locate shareSubscription. Required.
        :type provider_share_subscription_id: str
        :param provider_share_subscription: The provider share subscription. Is either a
         ProviderShareSubscription type or a IO[bytes] type. Required.
        :type provider_share_subscription: ~azure.mgmt.datashare.models.ProviderShareSubscription or
         IO[bytes]
        :return: ProviderShareSubscription or the result of cls(response)
        :rtype: ~azure.mgmt.datashare.models.ProviderShareSubscription
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.ProviderShareSubscription] = kwargs.pop("cls", None)

        content_type = content_type or "application/json"
        _json = None
        _content = None
        if isinstance(provider_share_subscription, (IOBase, bytes)):
            _content = provider_share_subscription
        else:
            _json = self._serialize.body(provider_share_subscription, "ProviderShareSubscription")

        _request = build_adjust_request(
        ...
        deserialized = self._deserialize("ProviderShareSubscription", pipeline_response.http_response)
    ...
    def reinstate(
        ...
        **kwargs: Any
        ...
        _request = build_reinstate_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
            share_name=share_name,
            provider_share_subscription_id=provider_share_subscription_id,
    ...
    def begin_revoke(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.ProviderShareSubscription].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ProviderShareSubscription](
    ...
    def get_by_share(
        ...
        **kwargs: Any
        ...
        _request = build_get_by_share_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
            share_name=share_name,
            provider_share_subscription_id=provider_share_subscription_id,
    ...
    def list_by_share(
        ...
        skip_token: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.ProviderShareSubscription"]:
        ...
        :return: An iterator like instance of either ProviderShareSubscription or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.datashare.models.ProviderShareSubscription]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.ProviderShareSubscriptionList] = kwargs.pop("cls", None)
