...
class ConsumerSourceDataSetsOperations:
    ...
    def list_by_share_subscription(
        ...
        skip_token: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.ConsumerSourceDataSet"]:
        ...
        :return: An iterator like instance of either ConsumerSourceDataSet or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.datashare.models.ConsumerSourceDataSet]
        ...
        cls: ClsType[_models.ConsumerSourceDataSetList] = kwargs.pop("cls", None)
