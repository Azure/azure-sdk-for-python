...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "dataSetMappingName": _SERIALIZER.url("data_set_mapping_name", data_set_mapping_name, "str"),
    }
...
class DataSetMappingsOperations:
    ...
    def list_by_share_subscription(
        ...
        orderby: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.DataSetMapping"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.datashare.models.DataSetMapping]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
