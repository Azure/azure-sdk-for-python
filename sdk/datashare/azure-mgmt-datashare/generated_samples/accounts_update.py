...
def main():
    ...
    response = client.accounts.update(
        ...
        account_update_parameters={"tags": {"tag1": "Red", "tag2": "White"}},
    )
    print(response)


# x-ms-original-file: specification/datashare/resource-manager/Microsoft.DataShare/DataShare/stable/2020-09-01/examples/Accounts_Update.json
