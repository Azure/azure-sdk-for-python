...
# USAGE
    python data_set_mappings_get.py
...
def main():
    ...
    response = client.data_set_mappings.get(
...
# x-ms-original-file: specification/datashare/resource-manager/Microsoft.DataShare/DataShare/stable/2020-09-01/examples/DataSetMappings_Get.json
