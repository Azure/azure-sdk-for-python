...
def main():
    ...
    response = client.invitations.get(
...
# x-ms-original-file: specification/datashare/resource-manager/Microsoft.DataShare/DataShare/stable/2020-09-01/examples/Invitations_Get.json
