...
def main():
    ...
    response = client.share_subscriptions.create(
...
# x-ms-original-file: specification/datashare/resource-manager/Microsoft.DataShare/DataShare/stable/2020-09-01/examples/ShareSubscriptions_Create.json
