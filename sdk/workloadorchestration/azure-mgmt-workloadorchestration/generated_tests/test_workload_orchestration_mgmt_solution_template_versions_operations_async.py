...
class TestWorkloadOrchestrationMgmtSolutionTemplateVersionsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_solution_template_versions_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.solution_template_versions.begin_create_or_update(
                resource_group_name=resource_group.name,
                solution_template_name="str",
                solution_template_version_name="str",
                resource={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_solution_template_versions_update(self, resource_group):
        response = await self.client.solution_template_versions.update(
            resource_group_name=resource_group.name,
            solution_template_name="str",
            solution_template_version_name="str",
            properties={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_solution_template_versions_begin_delete(self, resource_group):
        response = await (
            await self.client.solution_template_versions.begin_delete(
                resource_group_name=resource_group.name,
                solution_template_name="str",
                solution_template_version_name="str",
            )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_solution_template_versions_begin_bulk_review_solution(self, resource_group):
        response = await (
            await self.client.solution_template_versions.begin_bulk_review_solution(
                resource_group_name=resource_group.name,
                solution_template_name="str",
                solution_template_version_name="str",
                body={
