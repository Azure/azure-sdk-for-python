...
class TestWorkloadOrchestrationMgmtSchemaReferencesOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(WorkloadOrchestrationMgmtClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_schema_references_get(self, resource_group):
        response = self.client.schema_references.get(
            resource_uri="str",
