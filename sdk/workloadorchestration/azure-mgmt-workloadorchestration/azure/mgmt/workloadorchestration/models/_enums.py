...
class CMStages(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class ConfigTemplateConfigurationState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class InternalState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class StateCategory(str, Enum, metaclass=CaseInsensitiveEnumMeta):
