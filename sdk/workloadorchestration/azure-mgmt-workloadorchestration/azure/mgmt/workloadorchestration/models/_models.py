...
class ConfigTemplateUpdate(_Model):
...
class ConfigTemplateUpdateProperties(_Model):
...
class ContextUpdateProperties(_Model):
...
class SolutionTemplateUpdate(_Model):
...
class SolutionTemplateUpdateProperties(_Model):
...
class TargetUpdateProperties(_Model):
