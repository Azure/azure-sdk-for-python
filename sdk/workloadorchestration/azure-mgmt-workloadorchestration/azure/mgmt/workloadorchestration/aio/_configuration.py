...
class WorkloadOrchestrationMgmtClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long,docstring-keyword-should-match-keyword-only
    """Configuration for WorkloadOrchestrationMgmtClient.
