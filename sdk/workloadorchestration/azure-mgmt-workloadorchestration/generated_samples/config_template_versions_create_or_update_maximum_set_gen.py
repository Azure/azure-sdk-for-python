...
# USAGE
    python config_template_versions_create_or_update_maximum_set_gen.py
...
def main():
    ...
    response = client.config_template_versions.begin_create_or_update(
        resource_group_name="rgconfigurationmanager",
        config_template_name="testname",
        config_template_version_name="1.0.0",
        resource={"properties": {"configurations": "zsapegdehodzmwjmwl"}},
    ).result()
    print(response)
