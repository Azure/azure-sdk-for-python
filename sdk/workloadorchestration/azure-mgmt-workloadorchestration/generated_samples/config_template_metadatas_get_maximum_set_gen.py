...
# USAGE
    python config_template_metadatas_get_maximum_set_gen.py
...
def main():
    ...
    response = client.config_template_metadatas.get(
        resource_group_name="rgconfigurationmanager",
        config_template_name="abcde",
        config_template_metadata_name="abcde",
    )
    print(response)
