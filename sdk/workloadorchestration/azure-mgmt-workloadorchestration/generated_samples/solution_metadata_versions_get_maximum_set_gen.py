...
# USAGE
    python solution_metadata_versions_get_maximum_set_gen.py
...
def main():
    ...
    response = client.solution_metadata_versions.get(
        ...
        solution_metadata_name="metadataSampleName",
        solution_metadata_version_name="1.0.0",
    )
    print(response)
