...
# USAGE
    python config_templates_un_link_from_hierarchies_maximum_set_gen.py
...
def main():
    ...
    client.config_templates.begin_un_link_from_hierarchies(
        resource_group_name="rgconfigurationmanager",
        config_template_name="testname",
        body={
            "contextId": "/subscriptions/612CB927-8AC8-42DD-B74E-C676C3960BA5/resourceGroups/rgconfigurationmanager/providers/Microsoft.Edge/context/test",
            "hierarchyIds": [
