...
# USAGE
    python solution_template_versions_update_maximum_set_gen.py
...
def main():
    ...
    response = client.solution_template_versions.update(
        resource_group_name="rgconfigurationmanager",
        solution_template_name="testname",
        solution_template_version_name="1.0.0",
        properties={
            "properties": {"configurations": "pwehvxzltujmytianbjsqgmcj", "orchestratorType": "TO", "specification": {}}
        },
    )
    print(response)
