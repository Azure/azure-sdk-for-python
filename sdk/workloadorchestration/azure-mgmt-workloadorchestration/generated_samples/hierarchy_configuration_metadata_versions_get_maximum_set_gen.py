...
# USAGE
    python hierarchy_configuration_metadata_versions_get_maximum_set_gen.py
...
def main():
    ...
    response = client.hierarchy_configuration_metadata_versions.get(
        ...
        hierarchy_configuration_metadata_version_name="1.0.0",
    )
    print(response)
