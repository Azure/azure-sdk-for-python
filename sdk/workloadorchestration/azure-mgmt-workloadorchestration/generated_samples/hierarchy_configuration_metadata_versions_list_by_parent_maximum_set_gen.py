...
# USAGE
    python hierarchy_configuration_metadata_versions_list_by_parent_maximum_set_gen.py
...
def main():
    ...
    response = client.hierarchy_configuration_metadata_versions.list_by_parent(
        ...
        hierarchy_configuration_metadata_name="ct101",
    )
