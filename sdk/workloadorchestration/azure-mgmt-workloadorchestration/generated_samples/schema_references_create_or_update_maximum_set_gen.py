...
# USAGE
    python schema_references_create_or_update_maximum_set_gen.py
...
def main():
    ...
    response = client.schema_references.begin_create_or_update(
        resource_uri="gt",
        schema_reference_name="default",
        resource={"properties": {"schemaId": "vxgxfkfws"}},
    ).result()
    print(response)
