...
class CropRegion(_model_base.Model):
    ...
    aspect_ratio: float = rest_field(name="aspectRatio", visibility=["read", "create", "update", "delete", "query"])
    """The aspect ratio of the crop region.
     ...
     during the analyze call.
     Otherwise, it will be in the range 0.5 to 2.0 (inclusive). Required."""
    bounding_box: "_models.ImageBoundingBox" = rest_field(
...
class DenseCaptionsResult(_model_base.Model):
    ...
    list: List["_models.DenseCaption"] = rest_field(
...
class DetectedObject(_model_base.Model):
    ...
    tags: List["_models.DetectedTag"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class DetectedTextBlock(_model_base.Model):
    ...
    lines: List["_models.DetectedTextLine"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class DetectedTextLine(_model_base.Model):
    ...
    bounding_polygon: List["_models.ImagePoint"] = rest_field(
        name="boundingPolygon", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    words: List["_models.DetectedTextWord"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class ImageAnalysisResult(_model_base.Model):
    ...
    caption: Optional["_models.CaptionResult"] = rest_field(
        name="captionResult", visibility=["read", "create", "update", "delete", "query"]
    )
    """The generated phrase that describes the content of the analyzed image."""
    dense_captions: Optional["_models.DenseCaptionsResult"] = rest_field(
        name="denseCaptionsResult", visibility=["read", "create", "update", "delete", "query"]
    )
    """The up to 10 generated phrases, the first describing the content of the whole image,
     and the others describing the content of different regions of the image."""
    metadata: "_models.ImageMetadata" = rest_field(visibility=["read", "create", "update", "delete", "query"])
    ...
    objects: Optional["_models.ObjectsResult"] = rest_field(
        name="objectsResult", visibility=["read", "create", "update", "delete", "query"]
    )
    """A list of detected physical objects in the analyzed image, and their location."""
    people: Optional["_models.PeopleResult"] = rest_field(
        name="peopleResult", visibility=["read", "create", "update", "delete", "query"]
    )
    """A list of detected people in the analyzed image, and their location."""
    read: Optional["_models.ReadResult"] = rest_field(
        name="readResult", visibility=["read", "create", "update", "delete", "query"]
    )
    """The extracted printed and hand-written text in the analyze image. Also knows as OCR."""
    smart_crops: Optional["_models.SmartCropsResult"] = rest_field(
        name="smartCropsResult", visibility=["read", "create", "update", "delete", "query"]
    )
    """A list of crop regions at the desired as aspect ratios (if provided) that can be used as image
     thumbnails.
     These regions preserve as much content as possible from the analyzed image, with priority given
     to detected faces."""
    tags: Optional["_models.TagsResult"] = rest_field(
        name="tagsResult", visibility=["read", "create", "update", "delete", "query"]
    )
...
class ImageBoundingBox(_model_base.Model):
    ...
    width: int = rest_field(name="w", visibility=["read", "create", "update", "delete", "query"])
    """Width of the area, in pixels. Required."""
    height: int = rest_field(name="h", visibility=["read", "create", "update", "delete", "query"])
...
class ObjectsResult(_model_base.Model):
    ...
    list: List["_models.DetectedObject"] = rest_field(
        name="values", visibility=["read", "create", "update", "delete", "query"]
    )
...
class PeopleResult(_model_base.Model):
    ...
    list: List["_models.DetectedPerson"] = rest_field(
        name="values", visibility=["read", "create", "update", "delete", "query"]
    )
...
class ReadResult(_model_base.Model):
    ...
    blocks: List["_models.DetectedTextBlock"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class SmartCropsResult(_model_base.Model):
    ...
    list: List["_models.CropRegion"] = rest_field(
        name="values", visibility=["read", "create", "update", "delete", "query"]
    )
...
class TagsResult(_model_base.Model):
    ...
    list: List["_models.DetectedTag"] = rest_field(
        name="values", visibility=["read", "create", "update", "delete", "query"]
    )
