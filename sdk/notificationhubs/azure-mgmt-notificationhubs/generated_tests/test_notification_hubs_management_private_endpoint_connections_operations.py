...
class TestNotificationHubsManagementPrivateEndpointConnectionsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_private_endpoint_connections_get_group_id(self, resource_group):
        response = self.client.private_endpoint_connections.get_group_id(
            resource_group_name=resource_group.name,
            namespace_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_private_endpoint_connections_list_group_ids(self, resource_group):
