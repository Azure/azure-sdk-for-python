...
class ApnsCredential(Model):
    ...
    :param apns_certificate: The APNS certificate. Specify if using
    ...
    :param endpoint: The APNS endpoint of this credential. If using
     Certificate Authentication Mode and Sandbox specify
     'gateway.sandbox.push.apple.com'. If using Certificate Authentication Mode
     and Production specify 'gateway.push.apple.com'. If using Token
    ...
    :type endpoint: str
    :param thumbprint: The APNS certificate thumbprint. Specify if using
     Certificate Authentication Mode.
    :type thumbprint: str
    ...
    :type key_id: str
    :param app_name: The name of the application or BundleId. Specify if using
     Token Authentication Mode.
    :type app_name: str
    :param app_id: The issuer (iss) registered claim key. The value is a
     10-character TeamId, obtained from your developer account. Specify if
