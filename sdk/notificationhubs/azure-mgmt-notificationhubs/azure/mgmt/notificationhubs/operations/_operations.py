...
def build_namespaces_list_request(
...
def build_namespaces_list_all_request(
...
def build_namespaces_get_pns_credentials_request(  # pylint: disable=name-too-long
    resource_group_name: str, namespace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_namespaces_check_availability_request(  # pylint: disable=name-too-long
...
def build_notification_hubs_get_request(
...
def build_notification_hubs_create_or_update_request(  # pylint: disable=name-too-long
    resource_group_name: str, namespace_name: str, notification_hub_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_notification_hubs_update_request(
    resource_group_name: str, namespace_name: str, notification_hub_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_notification_hubs_delete_request(
    resource_group_name: str, namespace_name: str, notification_hub_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_notification_hubs_list_request(
    resource_group_name: str,
    namespace_name: str,
    subscription_id: str,
    *,
...
def build_notification_hubs_debug_send_request(  # pylint: disable=name-too-long
    resource_group_name: str, namespace_name: str, notification_hub_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_notification_hubs_get_pns_credentials_request(  # pylint: disable=name-too-long
    resource_group_name: str, namespace_name: str, notification_hub_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_notification_hubs_check_notification_hub_availability_request(  # pylint: disable=name-too-long
    resource_group_name: str, namespace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_notification_hubs_get_authorization_rule_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    namespace_name: str,
...
def build_notification_hubs_create_or_update_authorization_rule_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    namespace_name: str,
    notification_hub_name: str,
    authorization_rule_name: str,
...
def build_notification_hubs_delete_authorization_rule_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    namespace_name: str,
    notification_hub_name: str,
    authorization_rule_name: str,
...
def build_notification_hubs_list_authorization_rules_request(  # pylint: disable=name-too-long
    resource_group_name: str, namespace_name: str, notification_hub_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_notification_hubs_list_keys_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    namespace_name: str,
    notification_hub_name: str,
    authorization_rule_name: str,
...
def build_notification_hubs_regenerate_keys_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    namespace_name: str,
    notification_hub_name: str,
    authorization_rule_name: str,
...
def build_private_endpoint_connections_get_group_id_request(  # pylint: disable=name-too-long
...
def build_private_endpoint_connections_list_group_ids_request(  # pylint: disable=name-too-long
    resource_group_name: str, namespace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class NamespacesOperations:
    ...
    ) -> ItemPaged["_models.SharedAccessAuthorizationRuleResource"]:
    ...
    ) -> ItemPaged["_models.NamespaceResource"]:
...
class NotificationHubsOperations:
    ...
    def list(
        ...
        *,
        ...
        top: Optional[int] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.NotificationHubResource"]:
