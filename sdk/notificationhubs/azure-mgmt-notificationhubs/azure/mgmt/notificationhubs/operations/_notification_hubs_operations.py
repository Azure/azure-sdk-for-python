...
class NotificationHubsOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("NotificationHubResource", pipeline_response.http_response)
    ...
    def debug_send(
        ...
        deserialized = self._deserialize("DebugSendResponse", pipeline_response.http_response)
