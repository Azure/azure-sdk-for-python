...
def build_get_group_id_request(
    ...
    path_format_arguments = {
        ...
        "subResourceName": _SERIALIZER.url("sub_resource_name", sub_resource_name, "str", pattern=r"^namespace$"),
    }
...
def build_list_group_ids_request(
    resource_group_name: str, namespace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PrivateEndpointConnectionsOperations:
    ...
    _update_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/privateEndpointConnections/{privateEndpointConnectionName}"
    }
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Description of the Private Endpoint Connection resource. Is either a
         PrivateEndpointConnectionResource type or a IO type. Required.
        :type parameters: ~azure.mgmt.notificationhubs.models.PrivateEndpointConnectionResource or IO
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/privateEndpointConnections"
    }
    ...
    def get_group_id(
        ...
        request = build_get_group_id_request(
            resource_group_name=resource_group_name,
            namespace_name=namespace_name,
            sub_resource_name=sub_resource_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.get_group_id.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    get_group_id.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/privateLinkResources/{subResourceName}"
    }
    ...
    def list_group_ids(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_group_ids_request(
                    resource_group_name=resource_group_name,
                    namespace_name=namespace_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
                    template_url=self.list_group_ids.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
                request = _convert_request(request)
    ...
    list_group_ids.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/privateLinkResources"
    }
