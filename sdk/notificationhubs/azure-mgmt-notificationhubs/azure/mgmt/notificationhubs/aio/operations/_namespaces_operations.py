...
class NamespacesOperations:
    ...
    async def check_availability(
        ...
        :param parameters: The namespace name. Is either a model type or a IO type. Required.
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.notificationhubs.models.NamespaceCreateOrUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def patch(
        ...
        **kwargs: Any
        ...
        :param namespace_name: The namespace name. Required.
        :type namespace_name: str
        :param parameters: Parameters supplied to patch a Namespace Resource. Is either a model type or
         a IO type. Required.
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.NamespaceResource"]:
    ...
    @distributed_trace
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.NamespaceResource"]:
    ...
    async def regenerate_keys(
        ...
        **kwargs: Any
        ...
        :param authorization_rule_name: The connection string of the namespace for the specified
         authorizationRule. Required.
        :type authorization_rule_name: str
        :param parameters: Parameters supplied to regenerate the Namespace Authorization Rule Key. Is
