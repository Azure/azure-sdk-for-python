...
def main():
    ...
    response = client.log_analytics.get_waf_log_analytics_rankings(
...
# x-ms-original-file: specification/cdn/resource-manager/Microsoft.Cdn/stable/2025-06-01/examples/LogAnalytics_GetWafLogAnalyticsRankings.json
