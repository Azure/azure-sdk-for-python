...
def main():
    ...
    response = client.profiles.begin_can_migrate(
...
# x-ms-original-file: specification/cdn/resource-manager/Microsoft.Cdn/stable/2025-06-01/examples/Profiles_CanMigrate.json
