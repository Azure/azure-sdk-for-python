...
class CustomDomainsOperations:
    ...
    def begin_disable_custom_https(
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._disable_custom_https_initial(  # type: ignore
                resource_group_name=resource_group_name,
                profile_name=profile_name,
                endpoint_name=endpoint_name,
                custom_domain_name=custom_domain_name,
    ...
    def _enable_custom_https_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(custom_domain_https_parameters, (IO, bytes)):
    ...
    def begin_enable_custom_https(
        ...
        **kwargs: Any
        ...
        :param custom_domain_https_parameters: The configuration specifying how to enable HTTPS for the
         custom domain - using CDN managed certificate or user's own certificate. If not specified,
         enabling ssl uses CDN managed certificate by default. Is either a model type or a IO type.
         Default value is None.
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._enable_custom_https_initial(  # type: ignore
                resource_group_name=resource_group_name,
                profile_name=profile_name,
                endpoint_name=endpoint_name,
                custom_domain_name=custom_domain_name,
