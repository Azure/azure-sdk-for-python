...
class CustomDomainsOperations(object):
    ...
    def list_by_endpoint(
        ...
        **kwargs  # type: Any
        ...
        :return: CustomDomainListResult or the result of cls(response)
        :rtype: ~azure.mgmt.cdn.models.CustomDomainListResult
    ...
    def disable_custom_https(
        ...
        **kwargs  # type: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CustomDomain or the result of cls(response)
        :rtype: None or ~azure.mgmt.cdn.models.CustomDomain
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CustomDomain"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
