...
class OriginsOperations(object):
    ...
    def list_by_endpoint(
        ...
        if raw:
            header_dict = {}
        deserialized = models.OriginPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def _create_initial(
            self, resource_group_name, profile_name, endpoint_name, origin_name, origin, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def create(
            self, resource_group_name, profile_name, endpoint_name, origin_name, origin, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :param endpoint_name: Name of the endpoint under the profile which is
         unique globally.
        :type endpoint_name: str
        :param origin_name: Name of the origin that is unique within the
         endpoint.
        :type origin_name: str
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/endpoints/{endpointName}/origins/{originName}'}
    ...
    def delete(
            self, resource_group_name, profile_name, endpoint_name, origin_name, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/endpoints/{endpointName}/origins/{originName}'}
