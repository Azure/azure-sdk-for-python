...
class OriginsOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("Origin", pipeline_response.http_response)
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.Origin].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.Origin](
