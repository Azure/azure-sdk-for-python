...
class RoutesOperations:
    ...
    def list_by_endpoint(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.cdn.models.Route]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param route_name: Name of the routing rule. Required.
        :type route_name: str
        :param route: Route properties. Is either a model type or a IO type. Required.
    ...
    def _update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(route_update_properties, (IO, bytes)):
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param route_name: Name of the routing rule. Required.
        :type route_name: str
        :param route_update_properties: Route update properties. Is either a model type or a IO type.
         Required.
