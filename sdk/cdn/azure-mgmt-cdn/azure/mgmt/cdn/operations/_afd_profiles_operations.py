...
class AFDProfilesOperations(object):
    ...
    def check_host_name_availability(
        ...
        resource_group_name,  # type: str
        profile_name,  # type: str
        check_host_name_availability_input,  # type: "_models.ValidateCustomDomainInput"
        **kwargs  # type: Any
    ):
        ...
        :type check_host_name_availability_input: ~azure.mgmt.cdn.models.ValidateCustomDomainInput
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        # Construct URL
        url = self.check_host_name_availability.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'profileName': self._serialize.url("profile_name", profile_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
