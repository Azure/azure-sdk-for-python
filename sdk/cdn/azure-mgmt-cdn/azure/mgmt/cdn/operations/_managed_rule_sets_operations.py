...
class ManagedRuleSetsOperations(object):
    ...
    :ivar api_version: Version of the API to be used with the client request. Current version is 2019-09-01. Constant value: "2020-09-01".
    """
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ManagedRuleSetDefinitionPaged(internal_paging, self._deserialize.dependencies, header_dict)
