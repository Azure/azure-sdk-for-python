...
class ProfilesOperations:
    ...
    def _create_initial(
        ...
        _json = None
        _content = None
        if isinstance(profile, (IO, bytes)):
            _content = profile
        else:
    ...
    def begin_create(
        ...
        :param profile_name: Name of the Azure Front Door Standard or Azure Front Door Premium or CDN
         profile which is unique within the resource group. Required.
        :type profile_name: str
        :param profile: Profile properties needed to create a new profile. Is either a model type or a
         IO type. Required.
    ...
    def _update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(profile_update_parameters, (IO, bytes)):
