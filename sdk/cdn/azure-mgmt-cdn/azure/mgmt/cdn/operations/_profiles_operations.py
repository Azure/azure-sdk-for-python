...
class ProfilesOperations(object):
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.Profile"]
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        profile_name,  # type: str
        profile_update_parameters,  # type: "_models.ProfileUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Profile"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.Profile"]
    ...
    def list_supported_optimization_types(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SupportedOptimizationTypesListResult"
