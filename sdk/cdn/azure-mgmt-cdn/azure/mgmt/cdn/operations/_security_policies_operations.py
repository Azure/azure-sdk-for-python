...
class SecurityPoliciesOperations(object):
    ...
    def list_by_profile(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.SecurityPolicyListResult"]
    ...
    def get(
        ...
        resource_group_name,  # type: str
        profile_name,  # type: str
        security_policy_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.SecurityPolicy"
    ...
    def _create_initial(
        ...
        profile_name,  # type: str
        security_policy_name,  # type: str
        security_policy,  # type: "_models.SecurityPolicy"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.SecurityPolicy"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SecurityPolicy"]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.SecurityPolicy"]
        ...
        :return: An instance of LROPoller that returns either SecurityPolicy or the result of cls(response)
    ...
    def _patch_initial(
        ...
        profile_name,  # type: str
        security_policy_name,  # type: str
        security_policy_parameters,  # type: "_models.SecurityPolicyWebApplicationFirewallParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.SecurityPolicy"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SecurityPolicy"]
