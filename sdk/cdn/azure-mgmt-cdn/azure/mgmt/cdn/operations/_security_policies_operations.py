...
def build_get_request(
    resource_group_name: str, profile_name: str, security_policy_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class SecurityPoliciesOperations:
    ...
    def _create_initial(
        ...
        security_policy: Union[_models.SecurityPolicy, IO],
        **kwargs: Any
    ) -> _models.SecurityPolicy:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(security_policy, (IO, bytes)):
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param security_policy_name: Name of the security policy under the profile. Required.
        :type security_policy_name: str
        :param security_policy: The security policy properties. Is either a model type or a IO type.
         Required.
    ...
    def _patch_initial(
        ...
        profile_name: str,
        security_policy_name: str,
        security_policy_update_properties: Union[_models.SecurityPolicyUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.SecurityPolicy:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(security_policy_update_properties, (IO, bytes)):
    ...
    def begin_patch(
        ...
        profile_name: str,
        security_policy_name: str,
        security_policy_update_properties: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.SecurityPolicy]:
    ...
    def begin_patch(
        ...
        **kwargs: Any
        ...
        :param security_policy_name: Name of the security policy under the profile. Required.
        :type security_policy_name: str
        :param security_policy_update_properties: Security policy update properties. Is either a model
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._patch_initial(  # type: ignore
                resource_group_name=resource_group_name,
                profile_name=profile_name,
                security_policy_name=security_policy_name,
