...
class AFDCustomDomainsOperations(object):
    ...
    def list_by_profile(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.AFDDomainListResult"]
    ...
    def _create_initial(
        ...
        profile_name,  # type: str
        custom_domain_name,  # type: str
        custom_domain,  # type: "_models.AFDDomain"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.AFDDomain"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.AFDDomain"]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.AFDDomain"]
    ...
    def _update_initial(
        ...
        profile_name,  # type: str
        custom_domain_name,  # type: str
        custom_domain_update_properties,  # type: "_models.AFDDomainUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.AFDDomain"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.AFDDomain"]
    ...
    def begin_refresh_validation_token(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.ValidationToken"]
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns either ValidationToken or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.cdn.models.ValidationToken]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ValidationToken"]
