...
def build_get_request(
    resource_group_name: str, profile_name: str, secret_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class SecretsOperations:
    ...
    @distributed_trace
    def list_by_profile(self, resource_group_name: str, profile_name: str, **kwargs: Any) -> Iterable["_models.Secret"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.cdn.models.Secret]
    ...
    @distributed_trace
    def get(self, resource_group_name: str, profile_name: str, secret_name: str, **kwargs: Any) -> _models.Secret:
