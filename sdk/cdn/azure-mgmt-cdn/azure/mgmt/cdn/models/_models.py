...
class CacheExpirationActionParameters(msrest.serialization.Model):
    ...
    :ivar cache_type: Required. The level at which the content needs to be cached. Default value:
     "All".
...
class CdnCertificateSourceParameters(msrest.serialization.Model):
    ...
    :vartype odata_type: str
    :param certificate_type: Required. Type of certificate used. Possible values include:
     '"Shared"', '"Dedicated"'.
...
class CookiesMatchConditionParameters(msrest.serialization.Model):
    ...
    :param match_values: Required. The match value for the condition of the delivery rule.
...
class CustomDomain(ProxyResource):
    ...
    :param custom_https_parameters: Certificate parameters for securing custom HTTPS.
    :type custom_https_parameters: ~azure.mgmt.cdn.models.CustomDomainHttpsParameters
...
class DeliveryRuleAction(msrest.serialization.Model):
    ...
    You probably want to use the sub-classes and not this class directly. Known
    sub-classes are: DeliveryRuleCacheExpirationAction, DeliveryRuleCacheKeyQueryStringAction, DeliveryRuleRequestHeaderAction, DeliveryRuleResponseHeaderAction, UrlRedirectAction, UrlRewriteAction.
    ...
    :param name: Required. The name of the action for the delivery rule.Constant filled by server.
     ...
     '"ModifyResponseHeader"', '"UrlRedirect"', '"UrlRewrite"'.
    ...
    _subtype_map = {
        'name': {'CacheExpiration': 'DeliveryRuleCacheExpirationAction', 'CacheKeyQueryString': 'DeliveryRuleCacheKeyQueryStringAction', 'ModifyRequestHeader': 'DeliveryRuleRequestHeaderAction', 'ModifyResponseHeader': 'DeliveryRuleResponseHeaderAction', 'UrlRedirect': 'UrlRedirectAction', 'UrlRewrite': 'UrlRewriteAction'}
    }
...
class DeliveryRuleCondition(msrest.serialization.Model):
    ...
    :param name: Required. The name of the condition for the delivery rule.Constant filled by
     server.  Possible values include: '"RemoteAddress"', '"RequestMethod"', '"QueryString"',
     '"PostArgs"', '"RequestUri"', '"RequestHeader"', '"RequestBody"', '"RequestScheme"',
     '"UrlPath"', '"UrlFileExtension"', '"UrlFileName"', '"HttpVersion"', '"Cookies"', '"IsDevice"',
...
class MatchCondition(msrest.serialization.Model):
    ...
    :param match_variable: Required. Match variable to compare against. Possible values include:
     '"RemoteAddress"', '"RequestMethod"', '"QueryString"', '"PostArgs"', '"RequestUri"',
     '"RequestHeader"', '"RequestBody"', '"RequestScheme"', '"UrlPath"', '"UrlFileExtension"',
...
class PolicySettings(msrest.serialization.Model):
    ...
    :param default_custom_block_response_status_code: If the action type is block, this field
     ...
     '200', '403', '405', '406', '429'.
    :type default_custom_block_response_status_code: str or ~azure.mgmt.cdn.models.Enum14
...
class RemoteAddressMatchConditionParameters(msrest.serialization.Model):
    ...
    :param negate_condition: Describes if this is negate condition or not.
    :type negate_condition: bool
    :param match_values: Required. Match values to match against. The operator will apply to each
...
class UrlPathMatchConditionParameters(msrest.serialization.Model):
    ...
    :param operator: Required. Describes operator to be matched. Possible values include: '"Any"',
     '"Equal"', '"Contains"', '"BeginsWith"', '"EndsWith"', '"LessThan"', '"LessThanOrEqual"',
     '"GreaterThan"', '"GreaterThanOrEqual"', '"Wildcard"'.
...
class UrlRewriteActionParameters(msrest.serialization.Model):
    ...
    :param source_pattern: Required. define a request URI pattern that identifies the type of
     requests that may be rewritten. Currently, source pattern uses a prefix-based match. To match
     all URL paths, use "/" as the source pattern value. To match only the root directory and re-
     write this path, use the origin path field.
    :type source_pattern: str
    :param destination: Required. Define the destination path for be used in the rewrite. This will
     overwrite the source pattern.
    :type destination: str
    :param preserve_unmatched_path: If True, the remaining path after the source pattern will be
     appended to the new destination path.
