...
class EndpointProperties(EndpointPropertiesUpdateParameters):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(EndpointProperties, self).__init__(origin_host_header=origin_host_header, origin_path=origin_path, content_types_to_compress=content_types_to_compress, is_compression_enabled=is_compression_enabled, is_http_allowed=is_http_allowed, is_https_allowed=is_https_allowed, query_string_caching_behavior=query_string_caching_behavior, optimization_type=optimization_type, probe_path=probe_path, geo_filters=geo_filters, delivery_policy=delivery_policy, web_application_firewall_policy_link=web_application_firewall_policy_link, **kwargs)
        self.host_name = None
        self.origins = origins
        self.resource_state = None
        self.provisioning_state = None
...
class PolicySettings(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        default_custom_block_response_status_code: Optional[Union[int, "Enum14"]] = None,
