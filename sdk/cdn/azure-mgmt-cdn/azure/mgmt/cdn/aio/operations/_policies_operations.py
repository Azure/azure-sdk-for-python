...
class PoliciesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs
        ...
        :return: An instance of AsyncLROPoller that returns either CdnWebApplicationFirewallPolicy or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cdn.models.CdnWebApplicationFirewallPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
