...
from ...operations._afd_origin_groups_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_profile_request, build_list_resource_usage_request, build_update_request_initial
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class AFDOriginGroupsOperations:
    """AFDOriginGroupsOperations async operations.
    ...
    def list_by_profile(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either AFDOriginGroupListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cdn.models.AFDOriginGroupListResult]
