...
class AFDOriginGroupsOperations:
    ...
    def list_by_profile(
        ...
        **kwargs
        ...
        :return: An iterator like instance of either AFDOriginGroupListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cdn.models.AFDOriginGroupListResult]
    ...
    async def _create_initial(
        ...
        **kwargs
        ...
        body_content = self._serialize.body(origin_group, 'AFDOriginGroup')
    ...
    async def _update_initial(
        ...
        **kwargs
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(origin_group_update_properties, 'AFDOriginGroupUpdateParameters')
        body_content_kwargs['content'] = body_content
