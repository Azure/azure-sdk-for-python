...
from ...operations._cdn_management_client_operations import build_check_name_availability_request, build_check_name_availability_with_subscription_request, build_validate_probe_request
T = TypeVar('T')
