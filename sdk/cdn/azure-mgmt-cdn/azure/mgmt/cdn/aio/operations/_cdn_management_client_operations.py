...
class _CdnManagementClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], CdnManagementClientConfiguration]
):
    ...
    async def check_endpoint_name_availability(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("CheckEndpointNameAvailabilityOutput", pipeline_response.http_response)
    ...
    async def validate_probe(
        ...
        deserialized = self._deserialize("ValidateProbeOutput", pipeline_response.http_response)
