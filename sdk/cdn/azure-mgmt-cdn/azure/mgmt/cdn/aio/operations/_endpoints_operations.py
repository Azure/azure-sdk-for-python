...
from ...operations._endpoints_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_profile_request, build_list_resource_usage_request, build_load_content_request_initial, build_purge_content_request_initial, build_start_request_initial, build_stop_request_initial, build_update_request_initial, build_validate_custom_domain_request
T = TypeVar('T')
...
class EndpointsOperations:
    ...
    def list_by_profile(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cdn.models.EndpointListResult]
    ...
    async def _load_content_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_load_content_request_initial(
            resource_group_name=resource_group_name,
            profile_name=profile_name,
            endpoint_name=endpoint_name,
            subscription_id=self._config.subscription_id,
    ...
    @distributed_trace_async
    async def begin_load_content(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        profile_name: str,
        endpoint_name: str,
