...
class SecretsOperations:
    ...
    list_by_profile.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/secrets"
    }
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/secrets/{secretName}"
    }
    ...
    async def _create_initial(
        ...
        profile_name: str,
        secret_name: str,
        secret: Union[_models.Secret, IO],
        **kwargs: Any
    ) -> _models.Secret:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Secret or the result of
         cls(response)
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param secret_name: Name of the Secret under the profile. Required.
        :type secret_name: str
        :param secret: The Secret properties. Is either a Secret type or a IO type. Required.
        :type secret: ~azure.mgmt.cdn.models.Secret or IO
