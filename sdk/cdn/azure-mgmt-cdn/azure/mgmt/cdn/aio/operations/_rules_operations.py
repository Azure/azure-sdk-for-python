...
class RulesOperations:
    ...
    def list_by_rule_set(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_rule_set_request(
    ...
    async def _create_initial(
        ...
        rule_set_name: str,
        rule_name: str,
        rule: Union[_models.Rule, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type rule: ~azure.mgmt.cdn.models.Rule or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Rule or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cdn.models.Rule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _update_initial(
        ...
        rule_set_name: str,
        rule_name: str,
        rule_update_properties: Union[_models.RuleUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type rule_update_properties: ~azure.mgmt.cdn.models.RuleUpdateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Rule or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cdn.models.Rule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
