...
from ...operations._rules_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_rule_set_request, build_update_request_initial
T = TypeVar('T')
...
class RulesOperations:
    ...
    def list_by_rule_set(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cdn.models.RuleListResult]
