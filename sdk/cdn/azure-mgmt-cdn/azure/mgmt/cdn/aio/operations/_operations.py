...
from ...operations._operations import (
    ...
    build_cdn_management_check_endpoint_name_availability_request,
    build_cdn_management_check_name_availability_request,
    build_cdn_management_check_name_availability_with_subscription_request,
    build_cdn_management_validate_probe_request,
...
class RuleSetsOperations:
    ...
    async def begin_create(
        ...
        profile_name: str,
        rule_set_name: str,
        resource: Optional[_models.RuleSet] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.cdn.models.RuleSet
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.RuleSet].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.RuleSet](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
