...
from ...operations._afd_custom_domains_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_profile_request, build_refresh_validation_token_request_initial, build_update_request_initial
T = TypeVar('T')
...
class AFDCustomDomainsOperations:
    ...
    async def _refresh_validation_token_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_refresh_validation_token_request_initial(
            resource_group_name=resource_group_name,
            profile_name=profile_name,
            custom_domain_name=custom_domain_name,
            subscription_id=self._config.subscription_id,
    ...
    @distributed_trace_async
    async def begin_refresh_validation_token(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        profile_name: str,
        custom_domain_name: str,
