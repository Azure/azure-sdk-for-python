...
### Other Changes
  ...
  - Deleted model `AfdErrorResponse`/`AzureFirstPartyManagedCertificate`/`Certificate`/`CustomerCertificate`/`ManagedCertificate`/`ValidationToken` which actually were not used by SDK users
