...
class PhoneNumbersOperations:
    ...
    async def _search_available_phone_numbers_initial(
        ...
        **kwargs
        ...
        _search = _models.PhoneNumberSearchRequest(phone_number_type=phone_number_type, assignment_type=assignment_type, capabilities=capabilities, area_code=area_code, quantity=quantity)
        ...
        body_content = self._serialize.body(_search, 'PhoneNumberSearchRequest')
    ...
    async def get_search_result(
        ...
        **kwargs
        ...
        :rtype: ~azure.communication.administration.models.PhoneNumberSearchResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _purchase_phone_numbers_initial(
        ...
        **kwargs
        ...
        _purchase = _models.PhoneNumberPurchaseRequest(search_id=search_id)
        api_version = "2020-11-01-preview3"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_purchase, 'PhoneNumberPurchaseRequest')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    async def get_operation(
        ...
        **kwargs
        ...
        :rtype: ~azure.communication.administration.models.PhoneNumberOperation
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def update_phone_number(
        ...
        **kwargs
        ...
        _update = _models.AcquiredPhoneNumberUpdate(callback_uri=callback_uri, application_id=application_id)
        api_version = "2020-11-01-preview3"
        content_type = kwargs.pop("content_type", "application/merge-patch+json")
        accept = "application/json"

        # Construct URL
        url = self.update_phone_number.metadata['url']  # type: ignore
        path_format_arguments = {
            'endpoint': self._serialize.url("self._config.endpoint", self._config.endpoint, 'str', skip_quote=True),
            'phoneNumber': self._serialize.url("phone_number", phone_number, 'str'),
        }
        ...
        return deserialized
    update_phone_number.metadata = {'url': '/phoneNumbers/{phoneNumber}'}  # type: ignore
    ...
    async def _update_phone_number_capabilities_initial(
        self,
        phone_number: str,
        ...
        **kwargs
        ...
        _update = _models.PhoneNumberCapabilitiesRequest(sms=sms, calling=calling)
        api_version = "2020-11-01-preview3"
        content_type = kwargs.pop("content_type", "application/merge-patch+json")
        accept = "application/json"

        # Construct URL
        url = self._update_phone_number_capabilities_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'endpoint': self._serialize.url("self._config.endpoint", self._config.endpoint, 'str', skip_quote=True),
            'phoneNumber': self._serialize.url("phone_number", phone_number, 'str'),
        }
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_update, 'PhoneNumberCapabilitiesRequest')
        body_content_kwargs['content'] = body_content
        request = self._client.patch(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
        ...
        return deserialized
    _update_phone_number_capabilities_initial.metadata = {'url': '/phoneNumbers/{phoneNumber}/capabilities'}  # type: ignore
    ...
    async def begin_update_phone_number_capabilities(
        ...
        **kwargs
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._update_phone_number_capabilities_initial(
                phone_number=phone_number,
                sms=sms,
                calling=calling,
                cls=lambda x,y,z: x,
        ...
        if cont_token:
            ...
            return AsyncLROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_update_phone_number_capabilities.metadata = {'url': '/phoneNumbers/{phoneNumber}/capabilities'}  # type: ignore
