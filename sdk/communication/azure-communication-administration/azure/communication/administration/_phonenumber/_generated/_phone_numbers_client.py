...
class PhoneNumbersClient(object):
    """The phone numbers client uses the Communication Services to acquire and manage phone numbers.

    :ivar phone_numbers: PhoneNumbersOperations operations
    :vartype phone_numbers: azure.communication.administration.operations.PhoneNumbersOperations
