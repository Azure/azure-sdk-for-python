...
class MmsAttachment(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        content_type: Union[str, "MmsContentType"],
        content_in_base64: bytearray,
        **kwargs
    ):
        """
        ...
        self.content_in_base64 = content_in_base64
...
class MmsSendMessageRequest(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        from_property: str,
        recipients: List["MmsRecipient"],
        attachments: List["MmsAttachment"],
        message: Optional[str] = None,
        send_options: Optional["MmsSendOptions"] = None,
        **kwargs
    ):
        """
...
class MmsSendResponse(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: List["MmsSendResponseItem"],
        **kwargs
    ):
        """
...
class MmsSendResponseItem(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        repeatability_result: Optional[Union[str, "MmsSendResponseItemRepeatabilityResult"]] = None,
        **kwargs
    ):
        """
        :keyword to: Required. The recipient's phone number in E.164 format.
