...
class SmsOperations:
    ...
    def send(
        ...
        repeatability_result: Optional[str] = None,
        **kwargs
    ) -> AsyncIterable["_models.SendSmsResponse"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.communication.sms.models.SendSmsResponse]
