...
from .operations import MmsOperations, SmsOperations

class AzureCommunicationSMSService:
    """Azure Communication SMS/MMS Service.

    :ivar mms: MmsOperations operations
    :vartype mms: azure.communication.sms.aio.operations.MmsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.mms = MmsOperations(self._client, self._config, self._serialize, self._deserialize)
