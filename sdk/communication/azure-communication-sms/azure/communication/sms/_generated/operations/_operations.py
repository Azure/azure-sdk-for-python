...
def build_sms_send_request(**kwargs: Any) -> HttpRequest:
    ...
    api_version = kwargs.pop("api_version", _params.pop("api-version", "2026-01-23"))  # type: str
...
class SmsOperations:
    ...
    @overload
    def send(self, send_message_request: JSON, *, content_type: str = "application/json", **kwargs: Any) -> JSON:
    ...
    @overload
    def send(self, send_message_request: IO, *, content_type: str = "application/json", **kwargs: Any) -> JSON:
        """Sends a SMS message from a phone number that belongs to the authenticated account.
    ...
    @distributed_trace
    def send(self, send_message_request: Union[JSON, IO], **kwargs: Any) -> JSON:
        """Sends a SMS message from a phone number that belongs to the authenticated account.
...
class OptOutsOperations:
    ...
    @overload
    def add(self, body: JSON, *, content_type: str = "application/json", **kwargs: Any) -> JSON:
    ...
    @overload
    def add(self, body: IO, *, content_type: str = "application/json", **kwargs: Any) -> JSON:
        """Add phone numbers to the optouts list which shall stop receiving messages from a sender number.
    ...
    @distributed_trace
    def add(self, body: Union[JSON, IO], **kwargs: Any) -> JSON:
        """Add phone numbers to the optouts list which shall stop receiving messages from a sender number.
    ...
    @overload
    def remove(self, body: JSON, *, content_type: str = "application/json", **kwargs: Any) -> JSON:
    ...
    @overload
    def remove(self, body: IO, *, content_type: str = "application/json", **kwargs: Any) -> JSON:
        """Remove phone numbers from the optouts list.
    ...
    @distributed_trace
    def remove(self, body: Union[JSON, IO], **kwargs: Any) -> JSON:
        """Remove phone numbers from the optouts list.
    ...
    @overload
    def check(self, body: JSON, *, content_type: str = "application/json", **kwargs: Any) -> JSON:
    ...
    @overload
    def check(self, body: IO, *, content_type: str = "application/json", **kwargs: Any) -> JSON:
        """Check the opt out status for a recipient phone number with a sender phone number.
    ...
    @distributed_trace
    def check(self, body: Union[JSON, IO], **kwargs: Any) -> JSON:
        """Check the opt out status for a recipient phone number with a sender phone number.
...
class DeliveryReportsOperations:
    ...
    @distributed_trace
    def get(self, outgoing_message_id: str, **kwargs: Any) -> JSON:
