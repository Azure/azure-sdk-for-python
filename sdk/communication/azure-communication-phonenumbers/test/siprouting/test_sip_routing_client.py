...
from azure.communication.phonenumbers.siprouting._generated.models import SipConfiguration, Trunk, TrunkRoute
...
class TestSipRoutingClient(unittest.TestCase):
    ...
    def test_update_sip_trunks(self):
        ...
        test_client.update_sip_configuration({"trunks" : self.test_trunks})
    ...
    def test_update_sip_routes(self):
        ...
        test_client.update_sip_configuration({"routes" : self.test_routes})

        captured_request = mock.send.call_args[0][0]
        self.assertEqual(
            json.loads(captured_request.body), expected_request_body)

    def test_update_sip_configuration_no_sip_configuration_raises_value_error(self):
