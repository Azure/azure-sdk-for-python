...
class PhoneNumberAdministrationOperations:
    ...
    async def get_all_area_codes(
        ...
        country_code: str,
        phone_plan_id: str,
        location_options: Optional[List["_models.LocationOptionsQuery"]] = None,
        **kwargs
    ) -> "_models.AreaCodes":
        ...
        :rtype: ~azure.communication.phonenumbers.models.AreaCodes
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.AreaCodes"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

        _body = _models.LocationOptionsQueries(location_options=location_options)
        api_version = "2020-07-20-preview1"
    ...
    async def get_capabilities_update(
        ...
        **kwargs
    ) -> "_models.UpdatePhoneNumberCapabilitiesResponse":
        ...
        :rtype: ~azure.communication.phonenumbers.models.UpdatePhoneNumberCapabilitiesResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.UpdatePhoneNumberCapabilitiesResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def update_capabilities(
        self,
        phone_number_capabilities_update: Dict[str, "_models.NumberUpdateCapabilities"],
        **kwargs
    ) -> "_models.UpdateNumberCapabilitiesResponse":
        ...
        :type phone_number_capabilities_update: dict[str, ~azure.communication.phonenumbers.models.NumberUpdateCapabilities]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: UpdateNumberCapabilitiesResponse, or the result of cls(response)
        :rtype: ~azure.communication.phonenumbers.models.UpdateNumberCapabilitiesResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.UpdateNumberCapabilitiesResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

        _body = _models.UpdateNumberCapabilitiesRequest(phone_number_capabilities_update=phone_number_capabilities_update)
        api_version = "2020-07-20-preview1"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def get_all_supported_countries(
        ...
        take: Optional[int] = 100,
        **kwargs
    ) -> AsyncIterable["_models.PhoneNumberCountries"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.communication.phonenumbers.models.PhoneNumberCountries]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PhoneNumberCountries"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def get_number_configuration(
        ...
        phone_number: str,
        **kwargs
    ) -> "_models.NumberConfigurationResponse":
        ...
        :rtype: ~azure.communication.phonenumbers.models.NumberConfigurationResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.NumberConfigurationResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

        _body = _models.NumberConfigurationPhoneNumber(phone_number=phone_number)
        api_version = "2020-07-20-preview1"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    async def configure_number(
        self,
        pstn_configuration: "_models.PstnConfiguration",
        phone_number: str,
        **kwargs
    ) -> None:
        ...
        _body = _models.NumberConfiguration(pstn_configuration=pstn_configuration, phone_number=phone_number)
        api_version = "2020-07-20-preview1"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def get_phone_plan_groups(
        ...
        take: Optional[int] = 100,
        **kwargs
    ) -> AsyncIterable["_models.PhonePlanGroups"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.communication.phonenumbers.models.PhonePlanGroups]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PhonePlanGroups"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def get_phone_plans(
        ...
        take: Optional[int] = 100,
        **kwargs
    ) -> AsyncIterable["_models.PhonePlansResponse"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.communication.phonenumbers.models.PhonePlansResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PhonePlansResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def get_phone_plan_location_options(
        ...
        locale: Optional[str] = "en-US",
        **kwargs
    ) -> "_models.LocationOptionsResponse":
        ...
        :rtype: ~azure.communication.phonenumbers.models.LocationOptionsResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.LocationOptionsResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def get_release_by_id(
        ...
        **kwargs
        ...
        :rtype: ~azure.communication.phonenumbers.models.PhoneNumberRelease
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PhoneNumberRelease"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def release_phone_numbers(
        ...
        **kwargs
        ...
        :rtype: ~azure.communication.phonenumbers.models.ReleaseResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ReleaseResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

        _body = _models.ReleaseRequest(phone_numbers=phone_numbers)
        api_version = "2020-07-20-preview1"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
    ...
    def get_all_releases(
        ...
        take: Optional[int] = 100,
        **kwargs
    ) -> AsyncIterable["_models.PhoneNumberEntities"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.communication.phonenumbers.models.PhoneNumberEntities]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PhoneNumberEntities"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def get_search_by_id(
        ...
        search_id: str,
        **kwargs
    ) -> "_models.PhoneNumberReservation":
        ...
        :rtype: ~azure.communication.phonenumbers.models.PhoneNumberReservation
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PhoneNumberReservation"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def create_search(
        self,
        body: Optional["_models.CreateSearchOptions"] = None,
        **kwargs
    ) -> "_models.CreateSearchResponse":
        """Creates a phone number search.

        Creates a phone number search.

        :param body: Defines the search options.
        :type body: ~azure.communication.phonenumbers.models.CreateSearchOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CreateSearchResponse, or the result of cls(response)
        :rtype: ~azure.communication.phonenumbers.models.CreateSearchResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.CreateSearchResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
