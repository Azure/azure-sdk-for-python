...
class PauseCallRecordingResult(msrest.serialization.Model):
    """The response payload of pause call recording operation.

    :param server_call_id: The server call id of the call.
    :type server_call_id: str
    ...
    _attribute_map = {
        'server_call_id': {'key': 'server_call_id', 'type': 'str'},
        'recording_id': {'key': 'recordingId', 'type': 'str'},
    }
    ...
    def __init__(
        ...
        super(PauseCallRecordingResult, self).__init__(**kwargs)
        self.server_call_id = kwargs.get('server_call_id', None)
        self.recording_id = kwargs.get('recordingId', None)

    @classmethod
    def _from_generated(cls, pause_call_recording_result):
        if pause_call_recording_result is None:
            return None
...
class ResumeCallRecordingResult(msrest.serialization.Model):
    """The response payload of resume call recording operation.
    ...
    def __init__(
        ...
        super(ResumeCallRecordingResult, self).__init__(**kwargs)
        self.server_call_id = kwargs.get('server_call_id', None)
        self.recording_id = kwargs.get('recordingId', None)

    @classmethod
    def _from_generated(cls, resume_call_recording_result):
        if resume_call_recording_result is None:
            return None
...
class StopCallRecordingResult(msrest.serialization.Model):
    """The response payload of stop call recording operation.
    ...
    def __init__(
        ...
        super(StopCallRecordingResult, self).__init__(**kwargs)
        self.server_call_id = kwargs.get('server_call_id', None)
        self.recording_id = kwargs.get('recordingId', None)

    @classmethod
    def _from_generated(cls, stop_call_recording_result):
        if stop_call_recording_result is None:
            return None
...
class CallRecordingStatusResult(msrest.serialization.Model):
    """The response payload of recording status result operation.

    :param recording_state: The server call recording state.
    :type recording_state: str
    """

    _attribute_map = {
        'recording_state': {'key': 'recording_state', 'type': 'str'},
    }
    ...
    def __init__(
        ...
        super(CallRecordingStatusResult, self).__init__(**kwargs)
        self.recording_state = kwargs.get('recording_state', None)

    @classmethod
    def _from_generated(cls, call_recording_status_result):
        if call_recording_status_result is None:
            return None

        return cls(
            recording_state=call_recording_status_result.recording_state
        )


class DownloadContentResult(msrest.serialization.Model):
    """The response payload of content downloading operation.

    :param location_url: The url of content.
    :type server_call_id: str
    """

    _attribute_map = {
        'stream_data': {'key': 'content_stream', 'type': 'bytearray'},
    }
    ...
    def __init__(
        ...
        super(DownloadContentResult, self).__init__(**kwargs)

    @classmethod
    def _from_generated(cls, download_content_result):
        if download_content_result is None:
            return None

        return cls(
            content_stream=download_content_result.content_stream
        )
