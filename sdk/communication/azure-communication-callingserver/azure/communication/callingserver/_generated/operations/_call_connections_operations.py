...
def build_get_audio_routing_groups_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/calling/callConnections/{callConnectionId}/audioRoutingGroups/{audioRoutingMode}')
    path_format_arguments = {
        "callConnectionId": _SERIALIZER.url("call_connection_id", call_connection_id, 'str'),
        "audioRoutingMode": _SERIALIZER.url("audio_routing_mode", audio_routing_mode, 'str'),
    }
