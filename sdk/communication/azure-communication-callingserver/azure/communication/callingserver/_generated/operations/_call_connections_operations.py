...
def build_answer_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/calling/callConnections/{callConnectionId}/:answer')
    path_format_arguments = {
        "callConnectionId": _SERIALIZER.url("call_connection_id", call_connection_id, 'str'),
    }
...
def build_reject_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/calling/callConnections/{callConnectionId}/:reject')
    path_format_arguments = {
        "callConnectionId": _SERIALIZER.url("call_connection_id", call_connection_id, 'str'),
    }
...
def build_redirect_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/calling/callConnections/{callConnectionId}/:redirect')
    path_format_arguments = {
        "callConnectionId": _SERIALIZER.url("call_connection_id", call_connection_id, 'str'),
    }
...
def build_start_hold_music_request(
    call_connection_id,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/calling/callConnections/{callConnectionId}/participants/:startHoldMusic')
    path_format_arguments = {
        "callConnectionId": _SERIALIZER.url("call_connection_id", call_connection_id, 'str'),
    }
...
def build_stop_hold_music_request(
    call_connection_id,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/calling/callConnections/{callConnectionId}/participants/:stopHoldMusic')
    path_format_arguments = {
        "callConnectionId": _SERIALIZER.url("call_connection_id", call_connection_id, 'str'),
    }
