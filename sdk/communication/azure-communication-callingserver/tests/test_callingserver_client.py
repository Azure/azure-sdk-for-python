...
class TestCallingServerClient(unittest.TestCase):
    ...
    def test_start_recording_relative_uri_fails():
        ...
        with self.assertRaises(ValueError):
            _mock_utils.create_calling_server_client_async().start_recording(ServerCallLocator(server_call_id), "/not/absolute/uri")