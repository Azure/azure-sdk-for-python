...
async def test_create_connection_failed(
    ...
    calling_server_client = _test_utils.create_mock_calling_server_client(status_code=400, payload=_test_constants.ErrorPayload, is_async=True, use_managed_identity = use_managed_identity)
    raised = False
    try:
