...
class CommunicationError(msrest.serialization.Model):
    ...
    :vartype details: list[~azure.communication.network.traversal.models.CommunicationError]
    :ivar inner_error: The inner error if any.
    :vartype inner_error: ~azure.communication.network.traversal.models.CommunicationError
    """
...
class CommunicationErrorResponse(msrest.serialization.Model):
    ...
    :type error: ~azure.communication.network.traversal.models.CommunicationError
    """
...
class CommunicationRelayConfiguration(msrest.serialization.Model):
    ...
    :type ice_servers: list[~azure.communication.network.traversal.models.CommunicationIceServer]
    """
