...
class ChatThreadOperations:
    ...
    ) -> AsyncItemPaged["_models.ChatMessageReadReceipt"]:
    ...
    async def send_chat_message(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("SendChatMessageResult", pipeline_response.http_response)
    ...
    def list_chat_messages(
        ...
        **kwargs: Any
        ...
        :param max_page_size: The maximum number of messages to be returned per page. Default value is
         None.
        :type max_page_size: int
        :param start_time: The earliest point in time to get messages after. The timestamp should be in
    ...
    async def get_chat_message(self, chat_thread_id: str, chat_message_id: str, **kwargs: Any) -> _models.ChatMessage:
        ...
        deserialized = self._deserialize("ChatMessage", pipeline_response.http_response)
    ...
    def list_chat_participants(
        self, chat_thread_id: str, max_page_size: Optional[int] = None, skip: Optional[int] = None, **kwargs: Any
    ) -> AsyncItemPaged["_models.ChatParticipant"]:
    ...
    async def add_chat_participants(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("AddChatParticipantsResult", pipeline_response.http_response)
    ...
    async def get_chat_thread_properties(self, chat_thread_id: str, **kwargs: Any) -> _models.ChatThreadProperties:
        ...
        deserialized = self._deserialize("ChatThreadProperties", pipeline_response.http_response)
