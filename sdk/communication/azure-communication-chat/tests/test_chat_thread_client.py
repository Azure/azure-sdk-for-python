...
class TestChatThreadClient(unittest.TestCase):
    ...
    def test_list_participants(self):
        ...
        for chat_thread_participant_page in chat_thread_participants.by_page():
            ...
            assert len(l) == 1
            l[0].user.properties['identifier'] = participant_id
    ...
    def test_add_participants_w_failed_participants_returns_nonempty_list(self):
        ...
        self.assertEqual(new_participant.user.properties['identifier'], failed_participant.user.properties['identifier'])
