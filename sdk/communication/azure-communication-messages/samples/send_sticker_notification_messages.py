...
"""
FILE: send_sticker_notification_messages.py
...
USAGE:
    python send_sticker_notification_messages.py
...
class SendWhatsAppMessageSample(object):
    ...
    def send_sticker_message(self):
        ...
        video_options = StickerNotificationContent(
            ...
            media_uri="https://www.luckyshrub.com/assets/animated-smiling-plant.webp",
        )
