...
def main():
    ...
    response = client.sender_usernames.get(
...
# x-ms-original-file: specification/communication/resource-manager/Microsoft.Communication/stable/2025-09-01/examples/senderUsernames/get.json
