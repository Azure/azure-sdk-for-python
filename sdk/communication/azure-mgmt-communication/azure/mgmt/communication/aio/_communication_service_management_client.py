...
from .operations import CommunicationServiceOperations, Operations
...
class CommunicationServiceManagementClient:
    ...
    :vartype communication_service:
     azure.mgmt.communication.aio.operations.CommunicationServiceOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.communication_service = CommunicationServiceOperations(self._client, self._config, self._serialize, self._deserialize)
