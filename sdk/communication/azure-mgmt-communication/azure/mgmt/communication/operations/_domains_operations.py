...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Communication/emailServices/{emailServiceName}/domains/{domainName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "emailServiceName": _SERIALIZER.url("email_service_name", email_service_name, 'str', max_length=63, min_length=1, pattern=r'^[a-zA-Z0-9-]+$'),
...
def build_list_by_email_service_resource_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Communication/emailServices/{emailServiceName}/domains")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "emailServiceName": _SERIALIZER.url("email_service_name", email_service_name, 'str', max_length=63, min_length=1, pattern=r'^[a-zA-Z0-9-]+$'),
...
def build_initiate_verification_request_initial(
    subscription_id: str,
    resource_group_name: str,
    email_service_name: str,
    domain_name: str,
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Communication/emailServices/{emailServiceName}/domains/{domainName}/initiateVerification")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "emailServiceName": _SERIALIZER.url("email_service_name", email_service_name, 'str', max_length=63, min_length=1, pattern=r'^[a-zA-Z0-9-]+$'),
...
def build_cancel_verification_request_initial(
    subscription_id: str,
    resource_group_name: str,
    email_service_name: str,
    domain_name: str,
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Communication/emailServices/{emailServiceName}/domains/{domainName}/cancelVerification")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "emailServiceName": _SERIALIZER.url("email_service_name", email_service_name, 'str', max_length=63, min_length=1, pattern=r'^[a-zA-Z0-9-]+$'),
...
class DomainsOperations(object):
    ...
    def list_by_email_service_resource(
        ...
        email_service_name: str,
        **kwargs: Any
    ) -> Iterable["_models.DomainResourceList"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.communication.models.DomainResourceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-10-01-preview")  # type: str
    ...
    @distributed_trace
    def begin_initiate_verification(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        email_service_name: str,
        domain_name: str,
    ...
    @distributed_trace
    def begin_cancel_verification(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        email_service_name: str,
        domain_name: str,
