...
class RoomsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.CommunicationRoom"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.communication.rooms.models.CommunicationRoom]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def get(self, room_id: str, **kwargs: Any) -> _models.CommunicationRoom:
