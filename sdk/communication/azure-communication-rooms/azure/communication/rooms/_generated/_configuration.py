# coding=utf-8
# --------------------------------------------------------------------------
# Code generated by Microsoft (R) AutoRest Code Generator (autorest: 3.9.3, generator: @autorest/python@6.5.0)
...
class AzureCommunicationRoomsServiceConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    :type endpoint: str
    :keyword api_version: Api Version. Default value is "2023-06-14". Note that overriding this
    ...
    def __init__(self, endpoint: str, **kwargs: Any) -> None:
        ...
        api_version: str = kwargs.pop("api_version", "2023-06-14")
