...
from .operations import AzureCommunicationCallAutomationServiceOperationsMixin, CallConnectionOperations, CallDialogOperations, CallMediaOperations, CallRecordingOperations
...
class AzureCommunicationCallAutomationService(AzureCommunicationCallAutomationServiceOperationsMixin):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        _base_url = '{endpoint}'
        self._config = AzureCommunicationCallAutomationServiceConfiguration(endpoint, **kwargs)
