...
def build_terminate_call_request(
    call_connection_id,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/calling/callConnections/{callConnectionId}:terminate')
    path_format_arguments = {
        "callConnectionId": _SERIALIZER.url("call_connection_id", call_connection_id, 'str'),
    }
...
def build_add_participant_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/calling/callConnections/{callConnectionId}/participants:add')
    path_format_arguments = {
        "callConnectionId": _SERIALIZER.url("call_connection_id", call_connection_id, 'str'),
    }
...
def build_cancel_add_participant_request(
    call_connection_id,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/calling/callConnections/{callConnectionId}/participants:cancelAddParticipant')
    path_format_arguments = {
        "callConnectionId": _SERIALIZER.url("call_connection_id", call_connection_id, 'str'),
    }
...
def build_move_participants_request(
    call_connection_id,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/calling/callConnections/{callConnectionId}/participants:moveHere')
    path_format_arguments = {
        "callConnectionId": _SERIALIZER.url("call_connection_id", call_connection_id, 'str'),
    }
...
def build_get_participant_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/calling/callConnections/{callConnectionId}/participants/{participantRawId}')
    path_format_arguments = {
        "callConnectionId": _SERIALIZER.url("call_connection_id", call_connection_id, 'str'),
...
# fmt: on
class CallConnectionOperations(object):
    """CallConnectionOperations operations.
    ...
    def transfer_to_participant(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.TransferCallResponse"
    ...
    def get_participants(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.GetParticipantsResponse"]
        ...
        :return: An iterator like instance of either GetParticipantsResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.communication.callautomation.models.GetParticipantsResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def add_participant(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.AddParticipantResponse"
    ...
    def remove_participant(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.RemoveParticipantResponse"
    ...
    def mute(
        self,
        call_connection_id,  # type: str
        mute_participants_request,  # type: "_models.MuteParticipantsRequest"
        repeatability_request_id=None,  # type: Optional[str]
        repeatability_first_sent=None,  # type: Optional[datetime.datetime]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.MuteParticipantsResult"
    ...
    def unmute(
        self,
        call_connection_id,  # type: str
        unmute_participants_request,  # type: "_models.UnmuteParticipantsRequest"
        repeatability_request_id=None,  # type: Optional[str]
        repeatability_first_sent=None,  # type: Optional[datetime.datetime]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.UnmuteParticipantsResponse"
    ...
    def cancel_add_participant(
        self,
        call_connection_id,  # type: str
        cancel_add_participant_request,  # type: "_models.CancelAddParticipantRequest"
        repeatability_request_id=None,  # type: Optional[str]
        repeatability_first_sent=None,  # type: Optional[datetime.datetime]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.CancelAddParticipantResponse"
    ...
    def move_participants(
        self,
        call_connection_id,  # type: str
        move_participant_request,  # type: "_models.MoveParticipantsRequest"
        repeatability_request_id=None,  # type: Optional[str]
        repeatability_first_sent=None,  # type: Optional[datetime.datetime]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.MoveParticipantsResponse"
        """Add a participant to the call.
