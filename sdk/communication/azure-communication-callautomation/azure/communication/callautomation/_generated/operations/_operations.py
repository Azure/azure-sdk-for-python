...
def build_call_media_transcription_state_request(  # pylint: disable=name-too-long
    call_connection_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/calling/callConnections/{callConnectionId}:transcriptionState"
    path_format_arguments = {
        "callConnectionId": _SERIALIZER.url("call_connection_id", call_connection_id, "str"),
    }
...
class CallMediaOperations:
    ...
    @distributed_trace
    def transcription_state(self, call_connection_id: str, **kwargs: Any) -> _models.TranscriptionStateResponse:
