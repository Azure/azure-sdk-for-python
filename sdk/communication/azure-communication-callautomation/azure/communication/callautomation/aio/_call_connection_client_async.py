...
class CallConnectionClient:  # pylint: disable=too-many-public-methods
    ...
    def from_connection_string(cls, conn_str: str, call_connection_id: str, **kwargs) -> "CallConnectionClient":
        ...
        return cls(endpoint, access_key, call_connection_id, **kwargs)  # type: ignore[arg-type]

    @classmethod
    def _from_callautomation_client(
        cls, callautomation_client: "CallAutomationClient", call_connection_id: str, **kwargs
        ...
        return cls(endpoint="", credential=None, call_connection_id=call_connection_id, _callautomation_client=callautomation_client, **kwargs)  # type: ignore[arg-type]
    ...
    async def _play_media(
        ...
        **kwargs,
        ...
        play_request = PlayRequest(
            ...
            play_to=audience,  # type: ignore[arg-type]
    ...
    async def start_recognizing_media(
        ...
        **kwargs,
        ...
        if input_type == RecognizeInputType.DTMF:
            ...
            options.choices = [choice._to_generated() for choice in choices] if choices else None  # pylint:disable=protected-access
        else:
