...
class CallConnectionClient(object): # pylint: disable=client-accepts-api-version-keyword
    ...
    async def transfer_call_to_participant(self, target_participant: CallInvite, **kwargs: Any) -> TransferCallResult:
        """
    ...
    async def add_participant(self, target_participant: CallInvite, **kwargs: Any) -> AddParticipantResult:
        """
    ...
    async def remove_participant(
            ...
            **kwargs: Any) -> RemoveParticipantResult:
        """
    ...
    async def play_media_to_all(
        ...
        **kwargs
        ...
        await self.play_media(play_source=play_source, play_to=[], **kwargs)
    ...
    async def stop_continuous_dtmf_recognition(
        ...
        **kwargs
        ...
        :param target: Target participant of continuous DTMF tone recognition. Required.
        :type target: ~azure.communication.callautomation.models.CommunicationIdentifier
        :keyword operation_context: The value to identify context of the operation. Optional.
