    ...
    async def test_create_VOIP_call_and_answer_then_hangup(self):
        ...
        try:
            ...
            if caller_connection_id is None:
                raise ValueError("Caller connection ID cannot be None")
            ...
            if incoming_call_context is None:
                raise ValueError("Incoming call context cannot be None")
            ...
            if caller_connected_event is None or caller_participant_updated_event is None:
                raise ValueError("Caller events cannot be None")
            ...
            if receiver_connected_event is None or receiver_participant_updated_event is None:
                raise ValueError("Receiver events cannot be None")
            ...
            if receiver_call_disconnected_event is None:
                raise ValueError("Receiver call disconnected event cannot be None")
