...
namespace azure.communication.callautomation
    ...
    class azure.communication.callautomation.CallConnectionClient:
        ...
        def add_participant(
                ...
                *, 
                ...
                source_caller_id_number: Optional[PhoneNumberIdentifier] = ..., 
                source_display_name: Optional[str] = ..., 
                teams_phone_call_details: Optional[TeamsPhoneCallDetails] = ..., 
    ...
    class azure.communication.callautomation.MoveParticipantsResult:
    ...
    class azure.communication.callautomation.TeamsPhoneCallDetails:
    ...
    class azure.communication.callautomation.TeamsPhoneCallerDetails:
        additional_caller_information: Optional[Dict[str, str]]
        caller: CommunicationIdentifier
        is_authenticated: Optional[bool]
        name: str
        phone_number: str
        record_id: Optional[str]
        screen_pop_url: Optional[str]
    ...
    class azure.communication.callautomation.TeamsPhoneSourceDetails:

        def __init__(
                self, 
                *, 
                intended_targets: Optional[Mapping[str, CommunicationIdentifier]] = ..., 
                language: str, 
