...
class JobRouterAdministrationClientMixinABC(ABC):
    """DO NOT use this class. It is for internal typing use only."""

    _client: "AsyncPipelineClient"
    _config: JobRouterAdministrationClientConfiguration
    _serialize: "Serializer"
    _deserialize: "Deserializer"


class JobRouterClientMixinABC(ABC):
    """DO NOT use this class. It is for internal typing use only."""

    _client: "AsyncPipelineClient"
    _config: JobRouterClientConfiguration
    _serialize: "Serializer"
    _deserialize: "Deserializer"
