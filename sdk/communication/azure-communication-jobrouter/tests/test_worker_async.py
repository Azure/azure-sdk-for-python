...
class TestRouterWorkerAsync(AsyncRouterRecordedTestCase):
    ...
    async def test_create_worker(self):
        ...
        async with router_client:
            ...
            router_worker = await router_client.create_worker(worker_id=w_identifier, router_worker=router_worker)
    ...
    async def test_get_worker(self):
        ...
        async with router_client:
            ...
            queried_router_worker = await router_client.get_worker(worker_id=w_identifier)
    ...
    async def test_list_workers(self):
        ...
        async with router_client:
            for identifier in w_identifiers:
                ...
                worker = await router_client.create_worker(worker_id=identifier, router_worker=router_worker)
