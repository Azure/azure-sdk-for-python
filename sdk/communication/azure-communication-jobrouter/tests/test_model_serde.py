...
class TestModelSerializationDeserialization(unittest.TestCase):
    def test_static_queue_selector_attachment_is_serialized_correctly(self):
        ...
        self.assertEqual(
            _serialize_to_json(static_attachment, "StaticQueueSelectorAttachment"),
            _serialize_to_json(deserialized_json, "StaticQueueSelectorAttachment"),
        )
    ...
    def test_classification_policy_is_serialized_correctly(self):
        ...
        self.assertEqual(
            ...
            _serialize_to_json(deserialized_json, "ClassificationPolicy"),
        )
    ...
    def test_distribution_policy_is_serialized_correctly(self):
        ...
        for mode in distribution_modes:
            ...
            self.assertEqual(
                _serialize_to_json(deserialized_json, "DistributionPolicy"),
    ...
    def test_job_matching_mode_overloads(self):
        ...
        for m in [queue_and_match, schedule_and_suspend, suspend_mode]:
            ...
            self.assertEqual(
                _serialize_to_json(m, "JobMatchingMode"), _serialize_to_json(deserialized_json, "JobMatchingMode")
            )
