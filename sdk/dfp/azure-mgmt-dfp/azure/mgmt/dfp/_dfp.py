...
from .operations import DFPOperationsMixin, InstancesOperations
...
class DFP(DFPOperationsMixin):
    ...
    :vartype instances: azure.mgmt.dfp.operations.InstancesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = DFPConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
