...
# USAGE
    python create_or_update_application_definition1.py
...
def main():
    ...
    response = client.application_definitions.create_or_update_by_id(
...
# x-ms-original-file: 2023-12-01-preview/createOrUpdateApplicationDefinition1.json
