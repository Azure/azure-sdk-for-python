...
# USAGE
    python update_application_definition1.py
...
def main():
    ...
    response = client.application_definitions.update_by_id(
...
# x-ms-original-file: 2023-12-01-preview/updateApplicationDefinition1.json
