...
class TestSolutionsApplicationsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_applications_list_allowed_upgrade_plans(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_applications_begin_update_access(self, resource_group):
        response = self.client.applications.begin_update_access(
            resource_group_name=resource_group.name,
            application_name="str",
            parameters={
                "Metadata": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_applications_list_tokens(self, resource_group):
