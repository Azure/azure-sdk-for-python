...
class TestManagedApplicationsMgmtApplicationsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_applications_list_allowed_upgrade_plans(self, resource_group):
        response = await self.client.applications.list_allowed_upgrade_plans(
            resource_group_name=resource_group.name,
            application_name="str",
        )
    ...
    async def test_applications_list_tokens(self, resource_group):
        response = await self.client.applications.list_tokens(
            resource_group_name=resource_group.name,
            application_name="str",
