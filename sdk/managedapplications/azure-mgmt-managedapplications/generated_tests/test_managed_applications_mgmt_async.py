...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.managedapplications.aio import ManagedApplicationsMgmtClient
...
class TestManagedApplicationsMgmtAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(ManagedApplicationsMgmtClient, is_async=True)
