    ...
    async def begin_update_access(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns UpdateAccessDefinition. The
         UpdateAccessDefinition is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managedapplications.models.UpdateAccessDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class ApplicationDefinitionsOperations:
    ...
    @distributed_trace_async
    async def delete_by_id(self, resource_group_name: str, application_definition_name: str, **kwargs: Any) -> None:
        """Deletes the managed application definition.
