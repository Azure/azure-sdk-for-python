...
from .._vendor import ManagedApplicationsMgmtClientMixinABC
...
class ApplicationsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.ApplicationPatchable] = kwargs.pop("cls", None)
    ...
    async def begin_update(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.ApplicationPatchable]:
        ...
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no
         Retry-After header is present.
        :return: An instance of AsyncLROPoller that returns either ApplicationPatchable or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managedapplications.models.ApplicationPatchable]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _update_access_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.UpdateAccessDefinition]] = kwargs.pop("cls", None)
