...
### Breaking Changes
  ...
  - Deleted or renamed client `ManagedApplicationsMgmtClient`
...
### Other Changes
  ...
  - Deleted model `ApplicationDefinitionListResult`/`ApplicationListResult`/`OperationListResult`/`ManagedApplicationsMgmtClientOperationsMixin` which actually were not used by SDK users
