...
### Breaking Changes
  ...
  - Deleted or renamed client `ApplicationClient`
  ...
  - Deleted or renamed method `JitRequestsOperations.begin_create_or_update`
  - Deleted or renamed method `JitRequestsOperations.delete`
  - Deleted or renamed method `JitRequestsOperations.list_by_resource_group`
  - Deleted or renamed method `JitRequestsOperations.list_by_subscription`
