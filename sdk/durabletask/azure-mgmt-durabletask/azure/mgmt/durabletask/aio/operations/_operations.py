...
from ...operations._operations import (
    ...
    build_task_hubs_get_request,
    build_task_hubs_list_by_scheduler_request,
)
...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.durabletask.aio.DurableTaskMgmtClient`'s
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.Operation"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.durabletask.models.Operation]
...
class SchedulersOperations:
    ...
    async def get(self, resource_group_name: str, scheduler_name: str, **kwargs: Any) -> _models.Scheduler:
        """Get a Scheduler.
...
class TaskHubsOperations:
    ...
    async def begin_create_or_update(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.TaskHub]:
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns TaskHub. The TaskHub is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.durabletask.models.TaskHub]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.TaskHub].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.TaskHub](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    def list_by_scheduler(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.durabletask.models.TaskHub]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
