...
# USAGE
    python retention_policies_update_maximum_set_gen.py
...
def main():
    ...
    response = client.retention_policies.begin_update(
        ...
        properties={
            "properties": {
                "retentionPolicies": [
                    ...
                    {"orchestrationState": "Completed", "retentionPeriodInDays": 24},
                ]
            }
        },
    ).result()
