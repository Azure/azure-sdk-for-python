...
class TestProviderHubMgmtCustomRolloutsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(ProviderHubMgmtClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_custom_rollouts_get(self, resource_group):
        response = await self.client.custom_rollouts.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_custom_rollouts_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.custom_rollouts.begin_create_or_update(
                provider_namespace="str",
                rollout_name="str",
                properties={
                    "properties": {
                                    ...
                                    "providerAuthorizations": [
                                        {
                                            ...
                                            "managedByAuthorization": {
                                                "additionalAuthorizations": [
                                                    {"applicationId": "str", "roleDefinitionId": "str"}
                                                ],
                                    ...
                                    "properties": {
                                        ...
                                        "legacyPolicy": {
                                            "disallowedConditions": [
                                                {"disallowedLegacyOperations": ["str"], "feature": "str"}
                                            ],
                                        ...
                                        "management": {
                                            ...
                                            "resourceAccessPolicy": "str",
                                            "resourceAccessRoles": [
                                                {"actions": ["str"], "allowedGroupClaims": ["str"]}
                                            ],
                                            "schemaOwners": ["str"],
                                            "serviceTreeInfos": [
                                                {"componentId": "str", "readiness": "str", "serviceId": "str"}
                                        ...
                                        "resourceManagementOptions": {
                                            "batchProvisioningSupport": {
                                                "actionConfigurations": [
                                                    {"authorizationAction": "str", "maxBatchSize": 0}
                                                ],
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_custom_rollouts_delete(self, resource_group):
        response = await self.client.custom_rollouts.delete(
            provider_namespace="str",
            rollout_name="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_custom_rollouts_list_by_provider_registration(self, resource_group):
        response = self.client.custom_rollouts.list_by_provider_registration(
            provider_namespace="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_custom_rollouts_stop(self, resource_group):
        response = await self.client.custom_rollouts.stop(
            provider_namespace="str",
            rollout_name="str",
        )
