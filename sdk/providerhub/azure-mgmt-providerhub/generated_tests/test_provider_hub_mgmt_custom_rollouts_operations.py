...
class TestProviderHubMgmtCustomRolloutsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(ProviderHubMgmtClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_custom_rollouts_get(self, resource_group):
        response = self.client.custom_rollouts.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_custom_rollouts_begin_create_or_update(self, resource_group):
        response = self.client.custom_rollouts.begin_create_or_update(
            provider_namespace="str",
            rollout_name="str",
            properties={
                "properties": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_custom_rollouts_delete(self, resource_group):
        response = self.client.custom_rollouts.delete(
            provider_namespace="str",
            rollout_name="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_custom_rollouts_list_by_provider_registration(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_custom_rollouts_stop(self, resource_group):
        response = self.client.custom_rollouts.stop(
            provider_namespace="str",
            rollout_name="str",
        )
