...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ProviderHub/providerRegistrations/{providerNamespace}/resourcetypeRegistrations/{resourceType}")  # pylint: disable=line-too-long
...
def build_list_by_provider_registration_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ProviderHub/providerRegistrations/{providerNamespace}/resourcetypeRegistrations")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "providerNamespace": _SERIALIZER.url("provider_namespace", provider_namespace, 'str'),
    }
...
class ResourceTypeRegistrationsOperations(object):
    ...
    def list_by_provider_registration(
        ...
        provider_namespace: str,
        **kwargs: Any
    ) -> Iterable["_models.ResourceTypeRegistrationArrayResponseWithContinuation"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.providerhub.models.ResourceTypeRegistrationArrayResponseWithContinuation]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-20")  # type: str
