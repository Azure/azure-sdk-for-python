...
from ...operations._notification_registrations_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_provider_registration_request
T = TypeVar('T')
...
class NotificationRegistrationsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.NotificationRegistration"]
        error_map = {
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(properties, 'NotificationRegistration')
    ...
    def list_by_provider_registration(
        ...
        provider_namespace: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.NotificationRegistrationArrayResponseWithContinuation"]:
        ...
        :return: An iterator like instance of either
         NotificationRegistrationArrayResponseWithContinuation or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.providerhub.models.NotificationRegistrationArrayResponseWithContinuation]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-20")  # type: str

        cls = kwargs.pop('cls', None)  # type: ClsType["_models.NotificationRegistrationArrayResponseWithContinuation"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
