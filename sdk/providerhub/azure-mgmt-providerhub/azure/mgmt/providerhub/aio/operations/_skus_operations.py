...
class SkusOperations:
    ...
    def list_by_resource_type_registrations(
        ...
        resource_type: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.SkuResourceArrayResponseWithContinuation"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.providerhub.models.SkuResourceArrayResponseWithContinuation]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-20")  # type: str
