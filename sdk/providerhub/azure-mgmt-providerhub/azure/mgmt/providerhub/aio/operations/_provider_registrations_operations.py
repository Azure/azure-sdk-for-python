...
from ...operations._provider_registrations_operations import build_create_or_update_request_initial, build_delete_request, build_generate_operations_request, build_get_request, build_list_request
T = TypeVar('T')
...
class ProviderRegistrationsOperations:
    ...
    def list(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.ProviderRegistrationArrayResponseWithContinuation"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.providerhub.models.ProviderRegistrationArrayResponseWithContinuation]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-20")  # type: str
