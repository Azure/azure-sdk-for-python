...
from ...operations._custom_rollouts_operations import build_create_or_update_request, build_get_request, build_list_by_provider_registration_request
T = TypeVar('T')
...
class CustomRolloutsOperations:
    ...
    def list_by_provider_registration(
        ...
        provider_namespace: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.CustomRolloutArrayResponseWithContinuation"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.providerhub.models.CustomRolloutArrayResponseWithContinuation]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-20")  # type: str
