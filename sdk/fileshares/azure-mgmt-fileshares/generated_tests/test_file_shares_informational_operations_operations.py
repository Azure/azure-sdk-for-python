...
class TestFileSharesInformationalOperationsOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_informational_operations_get_usage_data(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_informational_operations_get_limits(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_informational_operations_get_provisioning_recommendation(self, resource_group):
