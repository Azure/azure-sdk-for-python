...
class TestFileSharesMgmtPrivateEndpointConnectionsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_private_endpoint_connections_list_by_file_share(self, resource_group):
        response = self.client.private_endpoint_connections.list_by_file_share(
            resource_group_name=resource_group.name,
            resource_name="str",
        )
