...
RESOURCE_GROUP = os.environ.get(
    "FILESHARES_TEST_RG", "mfstest-prod-eastus2euap-crud-2026-06-01-rg"
)
...
def build_share_payload(
    *,
    ...
    nfs_props = (
        fs_models.NfsProtocolProperties(root_squash=nfs_root_squash)
...
def safe_delete_share(
    client: FileSharesClient, resource_group_name: str, resource_name: str
) -> None:
...
def make_client(test_case) -> FileSharesClient:
    """Construct a ``FileSharesClient`` against the canary ARM endpoint, mirroring
