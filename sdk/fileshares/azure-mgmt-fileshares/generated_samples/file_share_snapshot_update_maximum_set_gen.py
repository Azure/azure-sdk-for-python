...
# USAGE
    python file_share_snapshot_update_maximum_set_gen.py
...
def main():
    ...
    response = client.file_share_snapshots.begin_update_file_share_snapshot(
        resource_group_name="rgfileshares",
        resource_name="fileshare",
        name="testfilesharesnapshot",
        properties={"properties": {"metadata": {"key491": "dalhvhxqhjszelfuueetvxmgkbukwa"}}},
    ).result()
    print(response)
