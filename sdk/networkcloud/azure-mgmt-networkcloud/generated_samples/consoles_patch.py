...
def main():
    ...
    response = client.consoles.begin_update(
...
# x-ms-original-file: specification/networkcloud/resource-manager/Microsoft.NetworkCloud/preview/2024-10-01-preview/examples/Consoles_Patch.json
