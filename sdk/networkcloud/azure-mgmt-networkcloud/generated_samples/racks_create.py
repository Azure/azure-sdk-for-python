...
def main():
    ...
    response = client.racks.begin_create_or_update(
...
# x-ms-original-file: specification/networkcloud/resource-manager/Microsoft.NetworkCloud/preview/2025-07-01-preview/examples/Racks_Create.json
