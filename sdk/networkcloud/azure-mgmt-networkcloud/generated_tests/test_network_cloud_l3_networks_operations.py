...
class TestNetworkCloudL3NetworksOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(NetworkCloudClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_l3_networks_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_l3_networks_begin_create_or_update(self, resource_group):
        response = self.client.l3_networks.begin_create_or_update(
            ...
            l3_network_parameters={
                ...
                "properties": {
                    ...
                    "hybridAksIpamEnabled": "str",
                    "hybridAksPluginType": "str",
                    "interfaceName": "str",
                    "ipAllocationType": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_l3_networks_update(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_l3_networks_begin_delete(self, resource_group):
