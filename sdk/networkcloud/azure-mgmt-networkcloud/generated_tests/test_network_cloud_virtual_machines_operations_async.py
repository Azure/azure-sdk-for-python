...
class TestNetworkCloudVirtualMachinesOperationsAsync(AzureMgmtRecordedTestCase):
            ...
            await self.client.virtual_machines.begin_create_or_update(
                ...
                virtual_machine_parameters={
                    ...
                    "properties": {
                        ...
                        "memorySizeGB": 0,
                        "storageProfile": {
                            "osDisk": {"diskSizeGB": 0, "createOption": "str", "deleteOption": "str"},
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_virtual_machines_begin_assign_relay(self, resource_group):
        response = await (
