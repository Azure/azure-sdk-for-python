...
class TestNetworkCloudMgmtTrunkedNetworksOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_trunked_networks_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_trunked_networks_begin_create_or_update(self, resource_group):
        response = self.client.trunked_networks.begin_create_or_update(
            resource_group_name=resource_group.name,
            trunked_network_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_trunked_networks_begin_delete(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_trunked_networks_update(self, resource_group):
