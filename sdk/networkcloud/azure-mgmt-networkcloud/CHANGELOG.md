...
### Features Added
  ...
  - Model `AccessBridgePatchParameters` added property `properties`
  ...
  - Model `AccessBridgesOperations` added parameter `etag` in method `begin_delete`
  - Model `AccessBridgesOperations` added parameter `match_condition` in method `begin_delete`
  - Model `AccessBridgesOperations` added parameter `etag` in method `begin_update`
  - Model `AccessBridgesOperations` added parameter `match_condition` in method `begin_update`
  ...
  - Model `KubernetesVersionsOperations` added parameter `etag` in method `begin_create_or_update`
  - Model `KubernetesVersionsOperations` added parameter `match_condition` in method `begin_create_or_update`
  - Model `KubernetesVersionsOperations` added parameter `etag` in method `begin_delete`
  - Model `KubernetesVersionsOperations` added parameter `match_condition` in method `begin_delete`
  - Model `KubernetesVersionsOperations` added parameter `etag` in method `begin_update`
  - Model `KubernetesVersionsOperations` added parameter `match_condition` in method `begin_update`
...
### Breaking Changes
  ...
  - Model `AccessBridgePatchParameters` deleted or renamed its instance variable `security_rules`
  ...
  - Deleted or renamed model `AccessBridgeList`
  ...
  - Deleted or renamed model `KubernetesVersionList`
  ...
  - Method `AccessBridgesOperations.begin_create_or_update` removed default value `None` from its parameter `access_bridge`
  - Method `AccessBridgesOperations.begin_delete` deleted or renamed its parameter `if_match` of kind `positional_or_keyword`
  - Method `AccessBridgesOperations.begin_delete` deleted or renamed its parameter `if_none_match` of kind `positional_or_keyword`
  - Method `AccessBridgesOperations.begin_update` deleted or renamed its parameter `if_match` of kind `positional_or_keyword`
  - Method `AccessBridgesOperations.begin_update` deleted or renamed its parameter `if_none_match` of kind `positional_or_keyword`
  - Method `AccessBridgesOperations.list_by_resource_group` changed its parameter `skip_token` from `positional_or_keyword` to `keyword_only`
  - Method `AccessBridgesOperations.list_by_subscription` changed its parameter `skip_token` from `positional_or_keyword` to `keyword_only`
  ...
  - Method `KubernetesVersionsOperations.begin_create_or_update` deleted or renamed its parameter `if_match` of kind `positional_or_keyword`
  - Method `KubernetesVersionsOperations.begin_create_or_update` deleted or renamed its parameter `if_none_match` of kind `positional_or_keyword`
  - Method `KubernetesVersionsOperations.begin_delete` deleted or renamed its parameter `if_match` of kind `positional_or_keyword`
  - Method `KubernetesVersionsOperations.begin_delete` deleted or renamed its parameter `if_none_match` of kind `positional_or_keyword`
  - Method `KubernetesVersionsOperations.begin_update` deleted or renamed its parameter `if_match` of kind `positional_or_keyword`
  - Method `KubernetesVersionsOperations.begin_update` deleted or renamed its parameter `if_none_match` of kind `positional_or_keyword`
  - Method `KubernetesVersionsOperations.list_by_resource_group` changed its parameter `skip_token` from `positional_or_keyword` to `keyword_only`
  - Method `KubernetesVersionsOperations.list_by_subscription` changed its parameter `skip_token` from `positional_or_keyword` to `keyword_only`
  ...
  - Method `KubernetesVersionsOperations.begin_delete` re-ordered its parameters from `['self', 'resource_group_name', 'kubernetes_version_name', 'if_match', 'if_none_match', 'kwargs']` to `['self', 'resource_group_name', 'kubernetes_version_name', 'etag', 'match_condition', 'kwargs']`
  - Method `KubernetesVersionsOperations.begin_create_or_update` re-ordered its parameters from `['self', 'resource_group_name', 'kubernetes_version_name', 'kubernetes_version_parameters', 'if_match', 'if_none_match', 'kwargs']` to `['self', 'resource_group_name', 'kubernetes_version_name', 'kubernetes_version_parameters', 'etag', 'match_condition', 'kwargs']`
  - Method `KubernetesVersionsOperations.begin_update` re-ordered its parameters from `['self', 'resource_group_name', 'kubernetes_version_name', 'if_match', 'if_none_match', 'kubernetes_version_patch_parameters', 'kwargs']` to `['self', 'resource_group_name', 'kubernetes_version_name', 'kubernetes_version_patch_parameters', 'etag', 'match_condition', 'kwargs']`
  ...
  - Method `AccessBridgesOperations.begin_delete` re-ordered its parameters from `['self', 'resource_group_name', 'access_bridge_name', 'if_match', 'if_none_match', 'kwargs']` to `['self', 'resource_group_name', 'access_bridge_name', 'etag', 'match_condition', 'kwargs']`
  - Method `AccessBridgesOperations.begin_update` re-ordered its parameters from `['self', 'resource_group_name', 'access_bridge_name', 'if_match', 'if_none_match', 'access_bridge_update_parameters', 'kwargs']` to `['self', 'resource_group_name', 'access_bridge_name', 'access_bridge_update_parameters', 'etag', 'match_condition', 'kwargs']`
