...
### Features Added
  ...
  - Enum `HugepagesSize` added member `ENUM_1G`
  - Enum `HugepagesSize` added member `ENUM_2M`
...
### Breaking Changes
  ...
  - Deleted or renamed client `NetworkCloudMgmtClient`
  ...
  - Deleted or renamed enum value `HugepagesSize.ONE_G`
  - Deleted or renamed enum value `HugepagesSize.TWO_M`
