...
from ...operations._clusters_operations import (
    build_continue_update_version_request,
...
class ClustersOperations:
    ...
    def list_by_subscription(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.networkcloud.models.Cluster]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Cluster or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.networkcloud.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if cluster_update_parameters else None
        cls: ClsType[AsyncIterator[bytes]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if cluster_update_parameters else None
        _json = None
        _content = None
    ...
    async def _continue_update_version_initial(
        self,
        resource_group_name: str,
        cluster_name: str,
    ...
    async def begin_continue_update_version(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._continue_update_version_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
    ...
    async def _deploy_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if cluster_deploy_parameters else None
        cls: ClsType[AsyncIterator[bytes]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if cluster_deploy_parameters else None
        _json = None
        _content = None
    ...
    async def _inspect_initial(
        ...
        resource_group_name: str,
        cluster_name: str,
        cluster_inspect_parameters: Optional[Union[_models.ClusterInspectParameters, IO[bytes]]] = None,
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if cluster_inspect_parameters else None
        cls: ClsType[AsyncIterator[bytes]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if cluster_inspect_parameters else None
        _json = None
        _content = None
        if isinstance(cluster_inspect_parameters, (IOBase, bytes)):
            _content = cluster_inspect_parameters
        else:
            if cluster_inspect_parameters is not None:
                _json = self._serialize.body(cluster_inspect_parameters, "ClusterInspectParameters")
            else:
                _json = None

        _request = build_inspect_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    async def begin_inspect(
        ...
        resource_group_name: str,
        cluster_name: str,
        cluster_inspect_parameters: Optional[_models.ClusterInspectParameters] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.OperationStatusResult]:
        ...
        based on the supplied additional actions and filters.
        ...
        :type cluster_inspect_parameters: ~azure.mgmt.networkcloud.models.ClusterInspectParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either OperationStatusResult or the result
    ...
    async def begin_inspect(
        ...
        **kwargs: Any
        ...
        :type cluster_name: str
        :param cluster_inspect_parameters: The request body. Default value is None.
        :type cluster_inspect_parameters: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either OperationStatusResult or the result
    ...
    async def begin_inspect(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._inspect_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                cluster_inspect_parameters=cluster_inspect_parameters,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x, y, z: x,
                headers=_headers,
    ...
    async def _scan_runtime_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if cluster_scan_runtime_parameters else None
        cls: ClsType[AsyncIterator[bytes]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if cluster_scan_runtime_parameters else None
        _json = None
        _content = None
    ...
    async def begin_update_version(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._update_version_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
