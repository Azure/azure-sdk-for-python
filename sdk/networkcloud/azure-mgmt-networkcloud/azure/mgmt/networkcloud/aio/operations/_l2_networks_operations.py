...
class L2NetworksOperations:
    ...
    ) -> AsyncItemPaged["_models.L2Network"]:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.L2Network].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.L2Network](
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if l2_network_update_parameters else None
        cls: ClsType[_models.L2Network] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if l2_network_update_parameters else None
        _json = None
        _content = None
