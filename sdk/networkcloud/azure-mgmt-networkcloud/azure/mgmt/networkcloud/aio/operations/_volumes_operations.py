...
class VolumesOperations:
    ...
    async def _create_or_update_initial(
        ...
        volume_name: str,
        volume_parameters: Union[_models.Volume, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type volume_name: str
        :param volume_parameters: The request body. Required.
        :type volume_parameters: IO[bytes]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param volume_parameters: The request body. Is either a Volume type or a IO[bytes] type.
         Required.
        :type volume_parameters: ~azure.mgmt.networkcloud.models.Volume or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Volume or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.networkcloud.models.Volume]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _delete_initial(self, resource_group_name: str, volume_name: str, **kwargs: Any) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type volume_name: str
        :param volume_update_parameters: The request body. Default value is None.
        :type volume_update_parameters: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Volume or the result of cls(response)
    ...
    async def update(
        ...
        resource_group_name: str,
        volume_name: str,
        volume_update_parameters: Optional[Union[_models.VolumePatchParameters, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.Volume:
        """Patch the volume.
