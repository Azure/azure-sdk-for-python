...
from ...operations._cloud_services_networks_operations import (
...
class CloudServicesNetworksOperations:
    ...
    def list_by_subscription(
    ...
    ) -> AsyncItemPaged["_models.CloudServicesNetwork"]:
        ...
        :return: An iterator like instance of either CloudServicesNetwork or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.networkcloud.models.CloudServicesNetwork]
    ...
    async def get(
        ...
        deserialized = self._deserialize("CloudServicesNetwork", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        cloud_services_network_parameters: Union[_models.CloudServicesNetwork, IO[bytes]],
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.CloudServicesNetwork]:
        ...
        :return: An instance of AsyncLROPoller that returns either CloudServicesNetwork or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.networkcloud.models.CloudServicesNetwork]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type cloud_services_network_name: str
        :param cloud_services_network_parameters: The request body. Required.
        :type cloud_services_network_parameters: IO[bytes]
        :param if_match: The ETag of the transformation. Omit this value to always overwrite the
         current resource. Specify the last-seen ETag value to prevent accidentally overwriting
         concurrent changes. Default value is None.
        :type if_match: str
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.CloudServicesNetwork].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.CloudServicesNetwork](
    ...
    async def _update_initial(
        ...
        cloud_services_network_update_parameters: Optional[
            Union[_models.CloudServicesNetworkPatchParameters, IO[bytes]]
        ] = None,
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if cloud_services_network_update_parameters else None
        cls: ClsType[AsyncIterator[bytes]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if cloud_services_network_update_parameters else None
        _json = None
        _content = None
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type if_none_match: str
        :param cloud_services_network_update_parameters: The request body. Default value is None.
        :type cloud_services_network_update_parameters: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either CloudServicesNetwork or the result
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type cloud_services_network_update_parameters:
         ~azure.mgmt.networkcloud.models.CloudServicesNetworkPatchParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either CloudServicesNetwork or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.networkcloud.models.CloudServicesNetwork]
