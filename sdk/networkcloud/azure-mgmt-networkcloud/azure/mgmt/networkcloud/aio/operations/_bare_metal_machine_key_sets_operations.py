...
class BareMetalMachineKeySetsOperations:
    ...
    def list_by_cluster(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.BareMetalMachineKeySet"]:
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if bare_metal_machine_key_set_update_parameters else None
        cls: ClsType[AsyncIterator[bytes]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if bare_metal_machine_key_set_update_parameters else None
        _json = None
        _content = None
