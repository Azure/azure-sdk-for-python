...
class BmcKeySetsOperations:
    ...
    def list_by_cluster(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.BmcKeySet"]:
    ...
    async def get(
        ...
        deserialized = self._deserialize("BmcKeySet", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        bmc_key_set_parameters: Union[_models.BmcKeySet, IO[bytes]],
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type bmc_key_set_name: str
        :param bmc_key_set_parameters: The request body. Required.
        :type bmc_key_set_parameters: IO[bytes]
        :param if_match: The ETag of the transformation. Omit this value to always overwrite the
         current resource. Specify the last-seen ETag value to prevent accidentally overwriting
         concurrent changes. Default value is None.
        :type if_match: str
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param bmc_key_set_parameters: The request body. Is either a BmcKeySet type or a IO[bytes]
         type. Required.
        :type bmc_key_set_parameters: ~azure.mgmt.networkcloud.models.BmcKeySet or IO[bytes]
        :param if_match: The ETag of the transformation. Omit this value to always overwrite the
         current resource. Specify the last-seen ETag value to prevent accidentally overwriting
         concurrent changes. Default value is None.
        :type if_match: str
        ...
        if cont_token:
            return AsyncLROPoller[_models.BmcKeySet].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.BmcKeySet](
    ...
    async def _update_initial(
        ...
        if_match: Optional[str] = None,
        if_none_match: Optional[str] = None,
        bmc_key_set_update_parameters: Optional[Union[_models.BmcKeySetPatchParameters, IO[bytes]]] = None,
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if bmc_key_set_update_parameters else None
        cls: ClsType[AsyncIterator[bytes]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if bmc_key_set_update_parameters else None
        _json = None
        _content = None
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type if_none_match: str
        :param bmc_key_set_update_parameters: The request body. Default value is None.
        :type bmc_key_set_update_parameters: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either BmcKeySet or the result of
