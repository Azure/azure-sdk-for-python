...
from ...operations._trunked_networks_operations import (
...
class TrunkedNetworksOperations:
    ...
    def list_by_subscription(
    ...
    ) -> AsyncItemPaged["_models.TrunkedNetwork"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.networkcloud.models.TrunkedNetwork]
    ...
    async def get(self, resource_group_name: str, trunked_network_name: str, **kwargs: Any) -> _models.TrunkedNetwork:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.TrunkedNetwork]:
        ...
        :return: An instance of AsyncLROPoller that returns either TrunkedNetwork or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.networkcloud.models.TrunkedNetwork]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.TrunkedNetwork].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.TrunkedNetwork](
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if trunked_network_update_parameters else None
        cls: ClsType[_models.TrunkedNetwork] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if trunked_network_update_parameters else None
        _json = None
        _content = None
