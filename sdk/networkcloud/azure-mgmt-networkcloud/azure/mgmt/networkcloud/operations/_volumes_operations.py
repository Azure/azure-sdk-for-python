...
def build_get_request(resource_group_name: str, volume_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "volumeName": _SERIALIZER.url(
            "volume_name", volume_name, "str", pattern=r"^([a-zA-Z0-9][a-zA-Z0-9-_]{0,62}[a-zA-Z0-9])$"
        ),
    }
...
class VolumesOperations:
    ...
    def _delete_initial(self, resource_group_name: str, volume_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
