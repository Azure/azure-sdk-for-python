...
def build_attach_volume_request(
    resource_group_name: str, virtual_machine_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_detach_volume_request(
    resource_group_name: str, virtual_machine_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class VirtualMachinesOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, virtual_machine_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    def _attach_volume_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        virtual_machine_name: str,
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(virtual_machine_attach_volume_parameters, (IOBase, bytes)):
    ...
    def begin_attach_volume(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._attach_volume_initial(  # type: ignore
                resource_group_name=resource_group_name,
                virtual_machine_name=virtual_machine_name,
    ...
    def _detach_volume_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        virtual_machine_name: str,
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(virtual_machine_detach_volume_parameters, (IOBase, bytes)):
    ...
    def begin_detach_volume(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._detach_volume_initial(  # type: ignore
                resource_group_name=resource_group_name,
                virtual_machine_name=virtual_machine_name,
    ...
    @distributed_trace
    def begin_reimage(self, resource_group_name: str, virtual_machine_name: str, **kwargs: Any) -> LROPoller[None]:
