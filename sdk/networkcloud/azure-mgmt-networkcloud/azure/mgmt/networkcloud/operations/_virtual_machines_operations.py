...
def build_list_by_subscription_request(
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.NetworkCloud/virtualMachines"
    )
...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "virtualMachineName": _SERIALIZER.url(
            "virtual_machine_name", virtual_machine_name, "str", pattern=r"^([a-zA-Z0-9][a-zA-Z0-9]{0,62}[a-zA-Z0-9])$"
        ),
    }
...
def build_assign_relay_request(
    resource_group_name: str, virtual_machine_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class VirtualMachinesOperations:
    ...
    def list_by_subscription(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.networkcloud.models.VirtualMachine]
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(virtual_machine_parameters, (IOBase, bytes)):
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either VirtualMachine or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.networkcloud.models.VirtualMachine]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if virtual_machine_update_parameters else None
        cls: ClsType[Iterator[bytes]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if virtual_machine_update_parameters else None
        _json = None
        _content = None
        if isinstance(virtual_machine_update_parameters, (IOBase, bytes)):
    ...
    def _assign_relay_initial(
        self,
        resource_group_name: str,
        virtual_machine_name: str,
        virtual_machine_assign_relay_parameters: Optional[
            Union[_models.VirtualMachineAssignRelayParameters, IO[bytes]]
        ] = None,
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if virtual_machine_assign_relay_parameters else None
        cls: ClsType[Iterator[bytes]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if virtual_machine_assign_relay_parameters else None
        _json = None
        _content = None
        if isinstance(virtual_machine_assign_relay_parameters, (IOBase, bytes)):
            _content = virtual_machine_assign_relay_parameters
        else:
            if virtual_machine_assign_relay_parameters is not None:
                _json = self._serialize.body(
                    virtual_machine_assign_relay_parameters, "VirtualMachineAssignRelayParameters"
                )
            else:
                _json = None

        _request = build_assign_relay_request(
            resource_group_name=resource_group_name,
            virtual_machine_name=virtual_machine_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_assign_relay(
        ...
        resource_group_name: str,
        virtual_machine_name: str,
        virtual_machine_assign_relay_parameters: Optional[_models.VirtualMachineAssignRelayParameters] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.OperationStatusResult]:
        ...
        :type virtual_machine_assign_relay_parameters:
         ~azure.mgmt.networkcloud.models.VirtualMachineAssignRelayParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either OperationStatusResult or the result of
    ...
    def begin_assign_relay(
        ...
        **kwargs: Any
        ...
        :type virtual_machine_name: str
        :param virtual_machine_assign_relay_parameters: The request body. Default value is None.
        :type virtual_machine_assign_relay_parameters: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either OperationStatusResult or the result of
    ...
    def begin_assign_relay(
        ...
        **kwargs: Any
        ...
        :type virtual_machine_assign_relay_parameters:
         ~azure.mgmt.networkcloud.models.VirtualMachineAssignRelayParameters or IO[bytes]
        :return: An instance of LROPoller that returns either OperationStatusResult or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.networkcloud.models.OperationStatusResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._assign_relay_initial(
                resource_group_name=resource_group_name,
                virtual_machine_name=virtual_machine_name,
                virtual_machine_assign_relay_parameters=virtual_machine_assign_relay_parameters,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x, y, z: x,
                headers=_headers,
    ...
    def _power_off_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if virtual_machine_power_off_parameters else None
        cls: ClsType[Iterator[bytes]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if virtual_machine_power_off_parameters else None
        _json = None
        _content = None
        if isinstance(virtual_machine_power_off_parameters, (IOBase, bytes)):
    ...
    def _reimage_initial(self, resource_group_name: str, virtual_machine_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def _restart_initial(self, resource_group_name: str, virtual_machine_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def _start_initial(self, resource_group_name: str, virtual_machine_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
