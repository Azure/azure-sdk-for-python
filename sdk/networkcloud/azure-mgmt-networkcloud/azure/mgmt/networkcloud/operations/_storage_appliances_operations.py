...
class StorageAppliancesOperations:
    ...
    ) -> ItemPaged["_models.StorageAppliance"]:
    ...
    def _create_or_update_initial(
        ...
        resource_group_name: str,
        storage_appliance_name: str,
        storage_appliance_parameters: Union[_models.StorageAppliance, IO[bytes]],
        if_match: Optional[str] = None,
        if_none_match: Optional[str] = None,
        **kwargs: Any
    ) -> Iterator[bytes]:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type storage_appliance_name: str
        :param storage_appliance_parameters: The request body. Required.
        :type storage_appliance_parameters: IO[bytes]
        :param if_match: The ETag of the transformation. Omit this value to always overwrite the
         current resource. Specify the last-seen ETag value to prevent accidentally overwriting
         concurrent changes. Default value is None.
        :type if_match: str
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.StorageAppliance].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.StorageAppliance](
    ...
    def _update_initial(
        ...
        if_match: Optional[str] = None,
        if_none_match: Optional[str] = None,
        storage_appliance_update_parameters: Optional[Union[_models.StorageAppliancePatchParameters, IO[bytes]]] = None,
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if storage_appliance_update_parameters else None
        cls: ClsType[Iterator[bytes]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if storage_appliance_update_parameters else None
        _json = None
        _content = None
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type if_none_match: str
        :param storage_appliance_update_parameters: The request body. Default value is None.
        :type storage_appliance_update_parameters: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either StorageAppliance or the result of
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type storage_appliance_update_parameters:
         ~azure.mgmt.networkcloud.models.StorageAppliancePatchParameters or IO[bytes]
        :return: An instance of LROPoller that returns either StorageAppliance or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.networkcloud.models.StorageAppliance]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _disable_remote_vendor_management_initial(  # pylint: disable=name-too-long
        ...
        _request = build_disable_remote_vendor_management_request(
            resource_group_name=resource_group_name,
            storage_appliance_name=storage_appliance_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def _enable_remote_vendor_management_initial(
        ...
        storage_appliance_enable_remote_vendor_management_parameters: Optional[
            Union[_models.StorageApplianceEnableRemoteVendorManagementParameters, IO[bytes]]
        ] = None,
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if storage_appliance_enable_remote_vendor_management_parameters else None
        cls: ClsType[Iterator[bytes]] = kwargs.pop("cls", None)

        content_type = (
            content_type or "application/json" if storage_appliance_enable_remote_vendor_management_parameters else None
        )
        _json = None
        _content = None
        ...
        _request = build_enable_remote_vendor_management_request(
            resource_group_name=resource_group_name,
            storage_appliance_name=storage_appliance_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_enable_remote_vendor_management(
        ...
        **kwargs: Any
        ...
        :param storage_appliance_enable_remote_vendor_management_parameters: The request body. Default
         value is None.
        :type storage_appliance_enable_remote_vendor_management_parameters: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either OperationStatusResult or the result of
    ...
    def _run_read_commands_initial(
        ...
        storage_appliance_run_read_commands_parameters: Union[
            _models.StorageApplianceRunReadCommandsParameters, IO[bytes]
        ],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
    ...
    def begin_run_read_commands(
        ...
        **kwargs: Any
        ...
        :type storage_appliance_name: str
        :param storage_appliance_run_read_commands_parameters: The request body. Required.
        :type storage_appliance_run_read_commands_parameters: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either OperationStatusResult or the result of
    ...
    def begin_run_read_commands(
        ...
        **kwargs: Any
        ...
        :type storage_appliance_run_read_commands_parameters:
         ~azure.mgmt.networkcloud.models.StorageApplianceRunReadCommandsParameters or IO[bytes]
        :return: An instance of LROPoller that returns either OperationStatusResult or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.networkcloud.models.OperationStatusResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._run_read_commands_initial(
                resource_group_name=resource_group_name,
                storage_appliance_name=storage_appliance_name,
