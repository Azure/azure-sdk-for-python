...
class ClusterManagersOperations:
    ...
    ) -> ItemPaged["_models.ClusterManager"]:
    ...
    def update(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if cluster_manager_update_parameters else None
        cls: ClsType[_models.ClusterManager] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if cluster_manager_update_parameters else None
        _json = None
        _content = None
