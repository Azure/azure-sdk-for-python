...
from .operations import AccountsOperations, BackupPoliciesOperations, BackupsOperations, NetAppResourceOperations, NetAppResourceQuotaLimitsOperations, Operations, PoolsOperations, SnapshotPoliciesOperations, SnapshotsOperations, SubvolumesOperations, VolumeGroupsOperations, VolumeQuotaRulesOperations, VolumesOperations
...
class NetAppManagementClient:    # pylint: disable=too-many-instance-attributes
    ...
    :type base_url: str
    :keyword api_version: Api Version. The default value is "2023-05-01". Note that overriding this
