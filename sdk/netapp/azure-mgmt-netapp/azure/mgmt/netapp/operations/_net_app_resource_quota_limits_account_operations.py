...
def build_get_request(
    resource_group_name: str, account_name: str, quota_limit_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "quotaLimitName": _SERIALIZER.url(
            "quota_limit_name", quota_limit_name, "str", pattern=r"^[a-zA-Z][a-zA-Z0-9\-]{0,62}$"
        ),
    }
...
class NetAppResourceQuotaLimitsAccountOperations:  # pylint: disable=name-too-long
    ...
    @distributed_trace
    def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> Iterable["_models.QuotaItem"]:
