...
class BackupsUnderVolumeOperations:
    ...
    def _migrate_backups_initial(  # pylint: disable=inconsistent-return-statements
        ...
        pool_name: str,
        volume_name: str,
        body: Union[_models.BackupsMigrationRequest, IO],
        **kwargs: Any
    ) -> None:
        error_map = {
        ...
        request = build_migrate_backups_request(
            ...
            json=_json,
            content=_content,
            template_url=self._migrate_backups_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
    ...
    _migrate_backups_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/migrateBackups"
    }
    ...
    def begin_migrate_backups(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.netapp.models.BackupsMigrationRequest or IO
    ...
    begin_migrate_backups.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/migrateBackups"
    }
