...
def build_populate_availability_zone_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    pool_name: str,
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/populateAvailabilityZone")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "accountName": _SERIALIZER.url("account_name", account_name, 'str', pattern=r'^[a-zA-Z0-9][a-zA-Z0-9\-_]{0,127}$'),
...
def build_revert_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    pool_name: str,
...
def build_reset_cifs_password_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    pool_name: str,
...
def build_break_file_locks_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    pool_name: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/breakFileLocks")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "accountName": _SERIALIZER.url("account_name", account_name, 'str', pattern=r'^[a-zA-Z0-9][a-zA-Z0-9\-_]{0,127}$'),
...
def build_list_get_group_id_list_for_ldap_user_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    pool_name: str,
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/getGroupIdListForLdapUser")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "accountName": _SERIALIZER.url("account_name", account_name, 'str', pattern=r'^[a-zA-Z0-9][a-zA-Z0-9\-_]{0,127}$'),
...
def build_break_replication_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    pool_name: str,
...
def build_resync_replication_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    pool_name: str,
...
def build_delete_replication_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    pool_name: str,
...
def build_authorize_replication_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    pool_name: str,
...
def build_re_initialize_replication_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    pool_name: str,
...
def build_pool_change_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    pool_name: str,
...
def build_relocate_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    pool_name: str,
...
def build_finalize_relocation_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    pool_name: str,
...
def build_revert_relocation_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    pool_name: str,
...
class VolumesOperations(object):  # pylint: disable=too-many-public-methods
    ...
    def _populate_availability_zone_initial(
        ...
        **kwargs: Any
        ...
        request = build_populate_availability_zone_request_initial(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            account_name=account_name,
            pool_name=pool_name,
    ...
    _populate_availability_zone_initial.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/populateAvailabilityZone"}  # type: ignore
    ...
    begin_populate_availability_zone.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/populateAvailabilityZone"}  # type: ignore
    ...
    @distributed_trace
    def begin_revert(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        pool_name: str,
    ...
    @distributed_trace
    def begin_reset_cifs_password(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        pool_name: str,
    ...
    def _break_file_locks_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_break_file_locks_request_initial(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            account_name=account_name,
            pool_name=pool_name,
    ...
    _break_file_locks_initial.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/breakFileLocks"}  # type: ignore


    @distributed_trace
    def begin_break_file_locks(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        pool_name: str,
    ...
    begin_break_file_locks.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/breakFileLocks"}  # type: ignore
    ...
    def _list_get_group_id_list_for_ldap_user_initial(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.GetGroupIdListForLDAPUserResponse"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        request = build_list_get_group_id_list_for_ldap_user_request_initial(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            account_name=account_name,
            pool_name=pool_name,
    ...
    _list_get_group_id_list_for_ldap_user_initial.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/getGroupIdListForLdapUser"}  # type: ignore
    ...
    def begin_list_get_group_id_list_for_ldap_user(
        ...
        **kwargs: Any
        ...
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.GetGroupIdListForLDAPUserResponse"]
        lro_delay = kwargs.pop(
            'polling_interval',
            self._config.polling_interval
        )
    ...
    begin_list_get_group_id_list_for_ldap_user.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/getGroupIdListForLdapUser"}  # type: ignore
    ...
    @distributed_trace
    def begin_break_replication(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        pool_name: str,
    ...
    @distributed_trace
    def begin_resync_replication(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        pool_name: str,
    ...
    @distributed_trace
    def begin_delete_replication(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        pool_name: str,
    ...
    @distributed_trace
    def begin_authorize_replication(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        pool_name: str,
    ...
    @distributed_trace
    def begin_re_initialize_replication(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        pool_name: str,
    ...
    @distributed_trace
    def begin_pool_change(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        pool_name: str,
    ...
    @distributed_trace
    def begin_relocate(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        pool_name: str,
    ...
    @distributed_trace
    def begin_finalize_relocation(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        pool_name: str,
    ...
    @distributed_trace
    def begin_revert_relocation(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        pool_name: str,
