...
class BackupPoliciesOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> Iterable["_models.BackupPolicy"]:
    ...
    def get(
        ...
        deserialized = self._deserialize("BackupPolicy", pipeline_response.http_response)
