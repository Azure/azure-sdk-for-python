...
class PoolsOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> Iterable["_models.CapacityPool"]:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param pool_name: The name of the capacity pool. Required.
        :type pool_name: str
        :param body: Capacity pool object supplied in the body of the operation. Is either a model type
    ...
    def _update_initial(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.CapacityPool]] = kwargs.pop("cls", None)
