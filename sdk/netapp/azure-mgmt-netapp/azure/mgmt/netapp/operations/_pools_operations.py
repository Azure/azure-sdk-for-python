...
class PoolsOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> ItemPaged["_models.CapacityPool"]:
    ...
    def get(self, resource_group_name: str, account_name: str, pool_name: str, **kwargs: Any) -> _models.CapacityPool:
        ...
        deserialized = self._deserialize("CapacityPool", pipeline_response.http_response)
