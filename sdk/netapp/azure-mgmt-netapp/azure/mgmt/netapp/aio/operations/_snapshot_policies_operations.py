...
from ...operations._snapshot_policies_operations import (
...
class SnapshotPoliciesOperations:
    ...
    ) -> AsyncItemPaged["_models.SnapshotPolicy"]:
    ...
    async def get(
        ...
        deserialized = self._deserialize("SnapshotPolicy", pipeline_response.http_response)
    ...
    async def list_volumes(
        ...
        deserialized = self._deserialize("SnapshotPolicyVolumeList", pipeline_response.http_response)
