...
class SubvolumesOperations:
    ...
    async def _create_initial(
        ...
        **kwargs: Any
        ...
        cls: ClsType[Optional[_models.SubvolumeInfo]] = kwargs.pop("cls", None)
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param subvolume_name: The name of the subvolume. Required.
        :type subvolume_name: str
        :param body: Subvolume object supplied in the body of the operation. Is either a model type or
         a IO type. Required.
