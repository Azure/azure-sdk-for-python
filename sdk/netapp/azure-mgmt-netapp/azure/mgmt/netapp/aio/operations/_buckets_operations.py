...
from ...operations._buckets_operations import (
...
class BucketsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either Bucket or the result of cls(response)
        ...
        cls: ClsType[_models.BucketList] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("BucketList", pipeline_response)
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :return: Bucket or the result of cls(response)
        ...
        deserialized = self._deserialize("Bucket", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        volume_name: str,
        bucket_name: str,
        body: Union[_models.Bucket, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "Bucket")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.netapp.models.Bucket or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Bucket or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.netapp.models.Bucket]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def generate_credentials(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: BucketGenerateCredentials or the result of cls(response)
    ...
    async def generate_credentials(
        ...
        volume_name: str,
        bucket_name: str,
        body: Union[_models.BucketCredentialsExpiry, IO[bytes]],
        **kwargs: Any
    ) -> _models.BucketGenerateCredentials:
        """Generate bucket access credentials.
        ...
        :type body: ~azure.mgmt.netapp.models.BucketCredentialsExpiry or IO[bytes]
        :return: BucketGenerateCredentials or the result of cls(response)
        :rtype: ~azure.mgmt.netapp.models.BucketGenerateCredentials
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "BucketCredentialsExpiry")
        ...
        deserialized = self._deserialize("BucketGenerateCredentials", pipeline_response.http_response)
