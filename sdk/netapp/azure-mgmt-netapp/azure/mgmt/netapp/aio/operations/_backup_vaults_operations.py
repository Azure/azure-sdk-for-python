...
class BackupVaultsOperations:
    ...
    list_by_net_app_account.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/backupVaults"
    }
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/backupVaults/{backupVaultName}"
    }
    ...
    async def _create_or_update_initial(
        ...
        body: Union[_models.BackupVault, IO],
        **kwargs: Any
    ) -> _models.BackupVault:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.netapp.models.BackupVault or IO
    ...
    async def _update_initial(
        ...
        account_name: str,
        backup_vault_name: str,
        body: Union[_models.BackupVaultPatch, IO],
        **kwargs: Any
    ) -> _models.BackupVault:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param body: Backup Vault object supplied in the body of the operation. Is either a
         BackupVaultPatch type or a IO type. Required.
        :type body: ~azure.mgmt.netapp.models.BackupVaultPatch or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
