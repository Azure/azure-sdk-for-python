...
class AccountsOperations:
    ...
    async def _migrate_encryption_key_initial(  # pylint: disable=inconsistent-return-statements
        ...
        resource_group_name: str,
        account_name: str,
        body: Optional[Union[_models.EncryptionMigrationRequest, IO]] = None,
        **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_migrate_encryption_key_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            ...
            json=_json,
            content=_content,
            template_url=self._migrate_encryption_key_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _migrate_encryption_key_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/migrateEncryption"
    }
    ...
    async def begin_migrate_encryption_key(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.netapp.models.EncryptionMigrationRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    begin_migrate_encryption_key.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/migrateEncryption"
    }
