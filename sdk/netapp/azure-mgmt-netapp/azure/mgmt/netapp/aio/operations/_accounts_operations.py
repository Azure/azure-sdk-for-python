...
class AccountsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.NetAppAccount"]:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncItemPaged["_models.NetAppAccount"]:
    ...
    async def get(self, resource_group_name: str, account_name: str, **kwargs: Any) -> _models.NetAppAccount:
        ...
        deserialized = self._deserialize("NetAppAccount", pipeline_response.http_response)
    ...
    async def _renew_credentials_initial(
    ...
    async def begin_renew_credentials(
        ...
        encryption. If encryption.identity.principalId does not match identity.principalId, running
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._renew_credentials_initial(
                resource_group_name=resource_group_name,
                account_name=account_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
    ...
    async def begin_get_change_key_vault_information(
        self, resource_group_name: str, account_name: str, **kwargs: Any
    ) -> AsyncLROPoller[_models.GetKeyVaultStatusResponse]:
        ...
        :param account_name: The name of the NetApp account. Required.
        :type account_name: str
        :return: An instance of AsyncLROPoller that returns either GetKeyVaultStatusResponse or the
         result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.netapp.models.GetKeyVaultStatusResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.GetKeyVaultStatusResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.GetKeyVaultStatusResponse](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
