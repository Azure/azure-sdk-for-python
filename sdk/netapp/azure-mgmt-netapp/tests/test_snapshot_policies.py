...
def create_snapshot_policy(client, snapshot_policy_name, rg=setup.TEST_RG, account_name=setup.TEST_ACC_1, location=setup.LOCATION, snapshot_policy_only=False):
...
class TestNetAppSnapshotPolicy(AzureMgmtRecordedTestCase):
    ...
    def test_list_snapshot_policies(self):
        ...
        ACCOUNT1 = self.get_resource_name(setup.TEST_ACC_1+"-")
        create_snapshot_policy(self.client, setup.TEST_SNAPSHOT_POLICY_1, account_name=ACCOUNT1)
        create_snapshot_policy(self.client, setup.TEST_SNAPSHOT_POLICY_2, account_name=ACCOUNT1, snapshot_policy_only=True)
    ...
    def test_update_snapshot_policies(self):
        ...
        snapshot_policy = self.client.snapshot_policies.begin_update(setup.TEST_RG, ACCOUNT1, setup.TEST_SNAPSHOT_POLICY_1, snapshot_policy_body).result()
    ...
    def test_assign_snapshot_policy_to_volume(self):
        ...
        volume = self.client.volumes.begin_update(setup.TEST_RG, ACCOUNT1, setup.TEST_POOL_1, volumeName1, volume_patch).result()
