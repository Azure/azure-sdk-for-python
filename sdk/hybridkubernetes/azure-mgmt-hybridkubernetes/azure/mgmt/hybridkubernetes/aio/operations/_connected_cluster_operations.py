...
class ConnectedClusterOperations:
    ...
    async def _create_or_replace_initial(
        ...
        cluster_name: str,
        connected_cluster: Union[_models.ConnectedCluster, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
    ...
    async def begin_create_or_replace(
        ...
        **kwargs: Any
        ...
        :type connected_cluster: ~azure.mgmt.hybridkubernetes.models.ConnectedCluster or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ConnectedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.hybridkubernetes.models.ConnectedCluster]
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("ConnectedCluster", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if cont_token:
            return AsyncLROPoller[_models.ConnectedCluster].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ConnectedCluster](
    ...
    async def update(
        ...
        resource_group_name: str,
        cluster_name: str,
        connected_cluster_patch: Union[_models.ConnectedClusterPatch, IO[bytes]],
        **kwargs: Any
    ) -> _models.ConnectedCluster:
        """Updates a connected cluster.
    ...
    async def list_cluster_user_credential(
        ...
        resource_group_name: str,
        cluster_name: str,
        properties: Union[_models.ListClusterUserCredentialProperties, IO[bytes]],
        **kwargs: Any
    ) -> _models.CredentialResults:
        """Gets cluster user credentials of a connected cluster.
    ...
    def list_by_resource_group(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.ConnectedClusterList] = kwargs.pop("cls", None)
