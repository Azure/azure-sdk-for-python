...
class ConnectedClusterOperations:
    ...
    :type models: ~connected_kubernetes_client.models
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~connected_kubernetes_client.models.ConnectedCluster]
    ...
    async def _update_initial(
        ...
        **kwargs: Any
    ) -> Optional["_models.ConnectedCluster"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.ConnectedCluster"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        return deserialized
    _update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Kubernetes/connectedClusters/{clusterName}'}  # type: ignore
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type connected_cluster_patch: ~connected_kubernetes_client.models.ConnectedClusterPatch
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
        ...
        if cont_token:
            ...
            return AsyncLROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Kubernetes/connectedClusters/{clusterName}'}  # type: ignore
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~connected_kubernetes_client.models.ConnectedCluster
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ConnectedCluster"]
        error_map = {
    ...
    async def list_cluster_user_credentials(
        ...
        resource_group_name: str,
        cluster_name: str,
        properties: "_models.ListClusterUserCredentialsProperties",
        **kwargs: Any
        ...
        :type properties: ~connected_kubernetes_client.models.ListClusterUserCredentialsProperties
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(properties, 'ListClusterUserCredentialsProperties')
        body_content_kwargs['content'] = body_content
        ...
        return deserialized
    list_cluster_user_credentials.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Kubernetes/connectedClusters/{clusterName}/listClusterUserCredentials'}  # type: ignore
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ConnectedClusterList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~connected_kubernetes_client.models.ConnectedClusterList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
