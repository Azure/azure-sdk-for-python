...
class ConnectedClusterOperations:
    ...
    async def begin_create(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.hybridkubernetes.models.ConnectedCluster]
    ...
    async def list_cluster_user_credentials(
        ...
        client_authentication_details: Optional["_models.AuthenticationDetails"] = None,
        **kwargs
        ...
        :param cluster_name: The name of the Kubernetes cluster on which get is called.
        :type cluster_name: str
        :param client_proxy: Parameter to indicate whether the request is for client side proxy or not.
        :type client_proxy: bool
        :param client_authentication_details: Authentication parameters supplied by the user to fetch
         credentials for accessing the cluster.
        :type client_authentication_details: ~azure.mgmt.hybridkubernetes.models.AuthenticationDetails
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_resource_group(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hybridkubernetes.models.ConnectedClusterList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
