...
class ConnectedClusterOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.hybridkubernetes.aio.ConnectedKubernetesClient`'s
    ...
    async def _create_initial(
        ...
        cluster_name: str,
        connected_cluster: Union[_models.ConnectedCluster, IO],
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(connected_cluster, (IO, bytes)):
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ConnectedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.hybridkubernetes.models.ConnectedCluster]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param cluster_name: The name of the Kubernetes cluster on which get is called. Required.
        :type cluster_name: str
        :param connected_cluster: Parameters supplied to Create a Connected Cluster. Is either a model
         type or a IO type. Required.
        :type connected_cluster: ~azure.mgmt.hybridkubernetes.models.ConnectedCluster or IO
    ...
    async def update(
        ...
        resource_group_name: str,
        cluster_name: str,
        connected_cluster_patch: Union[_models.ConnectedClusterPatch, IO],
        **kwargs: Any
    ) -> _models.ConnectedCluster:
        """Updates a connected cluster.
        ...
        :type connected_cluster_patch: ~azure.mgmt.hybridkubernetes.models.ConnectedClusterPatch or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        _json = None
        _content = None
        if isinstance(connected_cluster_patch, (IO, bytes)):
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, cluster_name: str, **kwargs: Any) -> _models.ConnectedCluster:
    ...
    async def list_cluster_user_credential(
        ...
        resource_group_name: str,
        cluster_name: str,
        properties: Union[_models.ListClusterUserCredentialProperties, IO],
        **kwargs: Any
    ) -> _models.CredentialResults:
        """Gets cluster user credentials of a connected cluster.
        ...
        :param cluster_name: The name of the Kubernetes cluster on which get is called. Required.
        :type cluster_name: str
        :param properties: ListClusterUserCredential properties. Is either a model type or a IO type.
         Required.
        :type properties: ~azure.mgmt.hybridkubernetes.models.ListClusterUserCredentialProperties or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_resource_group(
    ...
    ) -> AsyncIterable["_models.ConnectedCluster"]:
        ...
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ConnectedCluster or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hybridkubernetes.models.ConnectedCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.ConnectedCluster"]:
        """Lists all connected clusters.
