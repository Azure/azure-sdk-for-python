...
from ...operations._operations import (
    build_connected_cluster_create_or_replace_request,
    build_connected_cluster_delete_request,
    build_connected_cluster_get_request,
    build_connected_cluster_list_by_resource_group_request,
    build_connected_cluster_list_by_subscription_request,
    build_connected_cluster_list_cluster_user_credential_request,
    build_connected_cluster_update_async_request,
...
class Operations:
    ...
    @distributed_trace
    def get(self, **kwargs: Any) -> AsyncItemPaged["_models.Operation"]:
        """List the operations for the provider.

        :return: An iterator like instance of Operation
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hybridkubernetes.models.Operation]
...
class ConnectedClusterOperations:
    ...
    async def _update_async_initial(
        self,
        resource_group_name: str,
        cluster_name: str,
    ...
    async def begin_update_async(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._update_async_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
