...
class ConnectedCluster(TrackedResource):
    ...
    :ivar kind: The kind of connected cluster. Known values are: "ProvisionedCluster", "AWS", and
     "GCP".
    ...
    """The kind of connected cluster. Known values are: \"ProvisionedCluster\", \"AWS\", and \"GCP\"."""
...
class ConnectedClusterPatch(_Model):
    ...
    __flattened_items = ["distribution", "distribution_version", "azure_hybrid_benefit", "gateway"]
...
class ConnectedClusterProperties(_Model):
    ...
    :ivar inbound_connectivity_state: Represents the health status inbound connectivity (relay
     connection and Kubernetes API). Known values are: "Connected", "Disconnected", and "Unknown".
    :vartype inbound_connectivity_state: str or
     ~azure.mgmt.hybridkubernetes.models.InboundConnectivityState
    ...
    inbound_connectivity_state: Optional[Union[str, "_models.InboundConnectivityState"]] = rest_field(
        name="inboundConnectivityState", visibility=["read"]
    )
    """Represents the health status inbound connectivity (relay connection and Kubernetes API). Known
     values are: \"Connected\", \"Disconnected\", and \"Unknown\"."""
