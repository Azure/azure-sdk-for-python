...
def build_connected_cluster_update_async_request(  # pylint: disable=name-too-long
    resource_group_name: str, cluster_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ConnectedClusterOperations:
    ...
    @api_version_validation(
        ...
        api_versions_list=["2025-12-01-preview", "2026-02-01-preview", "2026-05-01"],
    )
    def _update_async_initial(
        self,
        resource_group_name: str,
        cluster_name: str,
        ...
        **kwargs: Any
        ...
        _request = build_connected_cluster_update_async_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
    ...
    def begin_update_async(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._update_async_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
