...
from .operations import BotsOperations, Operations
...
class HealthbotClient:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = HealthbotClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
