...
class ErrorError(Model):
    ...
    :vartype additional_info:
     list[~azure.mgmt.healthbot.models.ErrorAdditionalInfo]
    """
...
class HealthBotProperties(Model):
    """HealthBotProperties.
    ...
    their compliant, AI-powered virtual health assistants and health bots, that
    help them improve processes and reduce costs.

    Variables are only populated by the server, and will be ignored when
    sending a request.

    :ivar provisioning_state: The provisioning state of the Healthbot
     resource.
...
class HealthBotUpdateParameters(Model):
...
class Sku(Model):
    ...
    :param name: Required. The name of the HealthBot SKU. Possible values
     include: 'F0', 'S1', 'C0'
...
class SystemData(Model):
    ...
    :type last_modified_by_type: str or
     ~azure.mgmt.healthbot.models.IdentityType
