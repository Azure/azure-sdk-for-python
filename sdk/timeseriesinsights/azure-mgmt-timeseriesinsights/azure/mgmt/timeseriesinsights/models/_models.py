...
class EnvironmentCreateOrUpdateParameters(CreateOrUpdateTrackedResourceProperties):
    ...
    sub-classes are: LongTermEnvironmentCreateOrUpdateParameters, StandardEnvironmentCreateOrUpdateParameters.
    ...
    :param kind: Required. The kind of the environment.Constant filled by server.  Possible values
     include: "Standard", "LongTerm", "Microsoft.EventHub", "Microsoft.IoTHub".
    :type kind: str or ~azure.mgmt.timeseriesinsights.models.Kind
    :param sku: Required. The sku determines the type of environment, either standard (S1 or S2) or
     long-term (L1). For standard environments the sku determines the capacity of the environment,
    ...
    _subtype_map = {
        'kind': {'LongTerm': 'LongTermEnvironmentCreateOrUpdateParameters', 'Standard': 'StandardEnvironmentCreateOrUpdateParameters'}
    }
...
class EnvironmentResource(TrackedResource):
    ...
    You probably want to use the sub-classes and not this class directly. Known
    sub-classes are: LongTermEnvironmentResource, StandardEnvironmentResource.
    ...
    _subtype_map = {
        'kind': {'LongTerm': 'LongTermEnvironmentResource', 'Standard': 'StandardEnvironmentResource'}
    }
...
class EventHubEventSourceCreateOrUpdateParameters(EventSourceCreateOrUpdateParameters):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.consumer_group_name = kwargs['consumer_group_name']
        self.key_name = kwargs['key_name']
        self.shared_access_key = kwargs['shared_access_key']
...
class EventHubEventSourceCreationProperties(EventHubEventSourceCommonProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(EventHubEventSourceCreationProperties, self).__init__(**kwargs)
        self.shared_access_key = kwargs['shared_access_key']
...
class EventHubEventSourceMutableProperties(EventSourceMutableProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(EventHubEventSourceMutableProperties, self).__init__(**kwargs)
...
class EventHubEventSourceResourceProperties(EventHubEventSourceCommonProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(EventHubEventSourceResourceProperties, self).__init__(**kwargs)
...
class IoTHubEventSourceCreationProperties(IoTHubEventSourceCommonProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(IoTHubEventSourceCreationProperties, self).__init__(**kwargs)
        self.shared_access_key = kwargs['shared_access_key']
...
class IoTHubEventSourceMutableProperties(EventSourceMutableProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(IoTHubEventSourceMutableProperties, self).__init__(**kwargs)
        self.shared_access_key = kwargs.get('shared_access_key', None)
...
class IoTHubEventSourceResourceProperties(IoTHubEventSourceCommonProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(IoTHubEventSourceResourceProperties, self).__init__(**kwargs)
...
class LocalTimestamp(msrest.serialization.Model):
    ...
    :param format: An enum that represents the format of the local timestamp property that needs to
     be set. Possible values include: "Embedded", "Iana", "TimeSpan".
...
class LongTermEnvironmentCreateOrUpdateParameters(EnvironmentCreateOrUpdateParameters):
    ...
    :param data_retention: ISO8601 timespan specifying the number of days the environment's events
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.kind = 'LongTerm'
        self.time_series_id_properties = kwargs['time_series_id_properties']
        self.storage_configuration = kwargs['storage_configuration']
...
class LongTermEnvironmentResource(EnvironmentResource):
    ...
    :param kind: Required. The kind of the environment.Constant filled by server.  Possible values
     include: "Standard", "LongTerm".
    :type kind: str or ~azure.mgmt.timeseriesinsights.models.EnvironmentResourceKind
    :ivar provisioning_state_properties_provisioning_state: Provisioning state of the resource.
     Possible values include: "Accepted", "Creating", "Updating", "Succeeded", "Failed", "Deleting".
    :vartype provisioning_state_properties_provisioning_state: str or
     ~azure.mgmt.timeseriesinsights.models.ProvisioningState
    :ivar creation_time_properties_creation_time: The time the resource was created.
    :vartype creation_time_properties_creation_time: ~datetime.datetime
    :ivar data_access_id: An id used to access the environment data, e.g. to query the
     environment's events or upload reference data for the environment.
    :vartype data_access_id: str
    :ivar data_access_fqdn: The fully qualified domain name used to access the environment data,
    ...
    _validation = {
        ...
        'creation_time_properties_creation_time': {'readonly': True},
        'data_access_id': {'readonly': True},
        'data_access_fqdn': {'readonly': True},
        'status': {'readonly': True},
        'provisioning_state': {'readonly': True},
    ...
    _attribute_map = {
        ...
        'creation_time_properties_creation_time': {'key': 'properties.creationTime', 'type': 'iso-8601'},
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.creation_time_properties_creation_time = None
        self.data_access_id = None
        self.data_access_fqdn = None
        self.status = None
        self.provisioning_state = None
...
class LongTermEnvironmentResourceProperties(ResourceProperties, EnvironmentResourceProperties):
    ...
    _attribute_map = {
        ...
        'storage_configuration': {'key': 'storageConfiguration', 'type': 'LongTermStorageConfigurationOutput'},
        'data_retention': {'key': 'warmStoreConfiguration.dataRetention', 'type': 'duration'},
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LongTermEnvironmentResourceProperties, self).__init__(**kwargs)
        self.data_access_id = None
        self.data_access_fqdn = None
        self.status = None
        self.time_series_id_properties = kwargs['time_series_id_properties']
...
class LongTermStorageConfigurationInput(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.management_key = kwargs['management_key']


class LongTermStorageConfigurationMutableProperties(msrest.serialization.Model):
    """The storage configuration provides the connection details that allows the Time Series Insights service to connect to the customer storage account that is used to store the environment's data.
...
class LongTermStorageConfigurationOutput(msrest.serialization.Model):
...
class ReferenceDataSetCreateOrUpdateParameters(CreateOrUpdateTrackedResourceProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.key_properties = kwargs['key_properties']
...
class ReferenceDataSetResourceProperties(ReferenceDataSetCreationProperties, ResourceProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ReferenceDataSetResourceProperties, self).__init__(**kwargs)
        self.provisioning_state = None
        self.creation_time = None
        self.key_properties = kwargs['key_properties']
        self.data_string_comparison_behavior = kwargs.get('data_string_comparison_behavior', None)
...
class Sku(msrest.serialization.Model):
    ...
    :param capacity: Required. The capacity of the sku. For standard environments, this value can
     be changed to support scale out of environments after they have been created.
    :type capacity: int
    """
...
class StandardEnvironmentCreateOrUpdateParameters(EnvironmentCreateOrUpdateParameters):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.kind = 'Standard'
        self.data_retention_time = kwargs['data_retention_time']
...
class StandardEnvironmentCreationProperties(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(StandardEnvironmentCreationProperties, self).__init__(**kwargs)
        self.data_retention_time = kwargs['data_retention_time']
        self.storage_limit_exceeded_behavior = kwargs.get('storage_limit_exceeded_behavior', None)
        self.partition_key_properties = kwargs.get('partition_key_properties', None)
...
class StandardEnvironmentResourceProperties(ResourceProperties, StandardEnvironmentCreationProperties, EnvironmentResourceProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(StandardEnvironmentResourceProperties, self).__init__(**kwargs)
        self.data_access_id = None
        self.data_access_fqdn = None
        self.status = None
        self.data_retention_time = kwargs['data_retention_time']
...
class TimeSeriesIdProperty(msrest.serialization.Model):
    ...
    :type name: str
    :ivar type: The type of the property. Default value: "String".
    :vartype type: str
    """
