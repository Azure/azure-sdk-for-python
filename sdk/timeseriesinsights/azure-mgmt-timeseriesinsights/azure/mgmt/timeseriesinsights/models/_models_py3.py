...
class IoTHubEventSourceCreationProperties(IoTHubEventSourceCommonProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(IoTHubEventSourceCreationProperties, self).__init__(timestamp_property_name=timestamp_property_name, timestamp_property_name=timestamp_property_name, event_source_resource_id=event_source_resource_id, iot_hub_name=iot_hub_name, consumer_group_name=consumer_group_name, key_name=key_name, **kwargs)
        self.shared_access_key = shared_access_key
...
class IoTHubEventSourceResourceProperties(IoTHubEventSourceCommonProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(IoTHubEventSourceResourceProperties, self).__init__(timestamp_property_name=timestamp_property_name, timestamp_property_name=timestamp_property_name, event_source_resource_id=event_source_resource_id, iot_hub_name=iot_hub_name, consumer_group_name=consumer_group_name, key_name=key_name, **kwargs)
...
class LongTermEnvironmentCreateOrUpdateParameters(EnvironmentCreateOrUpdateParameters):
    ...
    def __init__(
        ...
        *,
        ...
        tags: Optional[Dict[str, str]] = None,
        data_retention: Optional[datetime.timedelta] = None,
        **kwargs
    ):
...
class LongTermEnvironmentUpdateParameters(EnvironmentUpdateParameters):
    ...
    def __init__(
        ...
        *,
        tags: Optional[Dict[str, str]] = None,
        storage_configuration: Optional["LongTermStorageConfigurationMutableProperties"] = None,
        data_retention: Optional[datetime.timedelta] = None,
        **kwargs
    ):
...
class StandardEnvironmentResourceProperties(ResourceProperties, StandardEnvironmentCreationProperties, EnvironmentResourceProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(StandardEnvironmentResourceProperties, self).__init__(data_retention_time=data_retention_time, storage_limit_exceeded_behavior=storage_limit_exceeded_behavior, partition_key_properties=partition_key_properties, **kwargs)
        self.data_access_id = None
        self.data_access_fqdn = None
        self.status = None
        self.data_retention_time = data_retention_time
