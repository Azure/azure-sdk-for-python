...
from ...operations._private_link_resources_operations import build_list_supported_request
T = TypeVar('T')
    ...
    def list_supported(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PrivateLinkResourceListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.timeseriesinsights.models.PrivateLinkResourceListResult]
