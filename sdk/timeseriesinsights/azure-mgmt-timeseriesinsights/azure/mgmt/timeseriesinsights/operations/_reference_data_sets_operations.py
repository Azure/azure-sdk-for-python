...
class ReferenceDataSetsOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.timeseriesinsights.models.ReferenceDataSetResource or ~azure.mgmt.timeseriesinsights.models.ReferenceDataSetResource
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        _reference_data_set_update_parameters = models.ReferenceDataSetUpdateParameters(tags=tags)
        api_version = "2018-08-15-preview"
        content_type = kwargs.pop("content_type", "application/json")
