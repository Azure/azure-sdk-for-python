...
class AccessPoliciesOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.timeseriesinsights.models.AccessPolicyResource or ~azure.mgmt.timeseriesinsights.models.AccessPolicyResource
    ...
    def update(
        ...
        roles=None,  # type: Optional[List[Union[str, "AccessPolicyRole"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.AccessPolicyResource"
        ...
        _access_policy_update_parameters = models.AccessPolicyUpdateParameters(description=description, roles=roles)
        api_version = "2018-08-15-preview"
        content_type = kwargs.pop("content_type", "application/json")
