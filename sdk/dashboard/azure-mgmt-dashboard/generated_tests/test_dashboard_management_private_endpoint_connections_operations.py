...
class TestDashboardManagementPrivateEndpointConnectionsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_private_endpoint_connections_begin_approve(self, resource_group):
        response = self.client.private_endpoint_connections.begin_approve(
            resource_group_name=resource_group.name,
            workspace_name="str",
            private_endpoint_connection_name="str",
