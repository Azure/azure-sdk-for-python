...
class TestDashboardManagementPrivateEndpointConnectionsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_private_endpoint_connections_begin_approve(self, resource_group):
        response = await (
            await self.client.private_endpoint_connections.begin_approve(
                resource_group_name=resource_group.name,
                workspace_name="str",
                private_endpoint_connection_name="str",
                api_version="2024-11-01-preview",
