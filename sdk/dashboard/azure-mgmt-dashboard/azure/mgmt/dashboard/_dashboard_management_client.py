...
class DashboardManagementClient:
    ...
    :vartype operations: dashboard_management_client.operations.Operations
    :ivar grafana: GrafanaOperations operations
    :vartype grafana: dashboard_management_client.operations.GrafanaOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = DashboardManagementClientConfiguration(credential=credential, **kwargs)
    ...
    def __enter__(self):
        # type: () -> DashboardManagementClient
