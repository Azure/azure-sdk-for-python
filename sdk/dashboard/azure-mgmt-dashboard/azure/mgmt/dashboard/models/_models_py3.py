...
class ErrorDetail(msrest.serialization.Model):
    ...
    :vartype details: list[~dashboard_management_client.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~dashboard_management_client.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(msrest.serialization.Model):
    ...
    :vartype error: ~dashboard_management_client.models.ErrorDetail
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype error: ~dashboard_management_client.models.ErrorDetail
        """
        super(ErrorResponse, self).__init__(**kwargs)
        self.error = error


class GrafanaResource(msrest.serialization.Model):
    ...
    :vartype sku: ~dashboard_management_client.models.ResourceSku
    :ivar properties: Properties specific to the grafana resource.
    :vartype properties: ~dashboard_management_client.models.GrafanaResourceProperties
    :ivar identity: The managed identity of the grafana resource.
    :vartype identity: ~dashboard_management_client.models.ManagedIdentity
    :ivar system_data: The system meta data relating to this grafana resource.
    :vartype system_data: ~dashboard_management_client.models.SystemData
    ...
    _attribute_map = {
        ...
        'properties': {'key': 'properties', 'type': 'GrafanaResourceProperties'},
    ...
    def __init__(
        ...
        *,
        ...
        properties: Optional["GrafanaResourceProperties"] = None,
        ...
        **kwargs
        ...
        :paramtype sku: ~dashboard_management_client.models.ResourceSku
        :keyword properties: Properties specific to the grafana resource.
        :paramtype properties: ~dashboard_management_client.models.GrafanaResourceProperties
        :keyword identity: The managed identity of the grafana resource.
        :paramtype identity: ~dashboard_management_client.models.ManagedIdentity
        ...
        """
        super(GrafanaResource, self).__init__(**kwargs)
        self.id = None
        self.name = None
        self.type = None
        self.sku = sku
...
class GrafanaResourceListResponse(msrest.serialization.Model):
    """GrafanaResourceListResponse.

    :ivar value:
    :vartype value: list[~dashboard_management_client.models.GrafanaResource]
    :ivar next_link:
    :vartype next_link: str
    """

    _attribute_map = {
        'value': {'key': 'value', 'type': '[GrafanaResource]'},
    ...
    def __init__(
        self,
        *,
        value: Optional[List["GrafanaResource"]] = None,
        next_link: Optional[str] = None,
        **kwargs
    ):
        """
        :keyword value:
        :paramtype value: list[~dashboard_management_client.models.GrafanaResource]
        :keyword next_link:
        :paramtype next_link: str
        """
        super(GrafanaResourceListResponse, self).__init__(**kwargs)
        self.value = value
        self.next_link = next_link


class GrafanaResourceProperties(msrest.serialization.Model):
    ...
    :ivar provisioning_state: Provisioning state of the resource. Possible values include:
     ...
     "NotSpecified".
    :vartype provisioning_state: str or ~dashboard_management_client.models.ProvisioningState
    ...
    :ivar zone_redundancy: Possible values include: "Disabled", "Enabled". Default value:
     "Disabled".
    :vartype zone_redundancy: str or ~dashboard_management_client.models.ZoneRedundancy
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword provisioning_state: Provisioning state of the resource. Possible values include:
         "Accepted", "Creating", "Updating", "Deleting", "Succeeded", "Failed", "Canceled", "Deleted",
         "NotSpecified".
        :paramtype provisioning_state: str or ~dashboard_management_client.models.ProvisioningState
        :keyword zone_redundancy: Possible values include: "Disabled", "Enabled". Default value:
         "Disabled".
        :paramtype zone_redundancy: str or ~dashboard_management_client.models.ZoneRedundancy
        """
        super(GrafanaResourceProperties, self).__init__(**kwargs)
...
class GrafanaResourceUpdateParameters(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype tags: dict[str, str]
        """
        super(GrafanaResourceUpdateParameters, self).__init__(**kwargs)
        self.identity = identity
        self.tags = tags
...
class ManagedIdentity(msrest.serialization.Model):
    ...
    :vartype type: str or ~dashboard_management_client.models.IdentityType
    ...
    :vartype user_assigned_identities: dict[str,
     ~dashboard_management_client.models.UserAssignedIdentity]
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword type: The type 'SystemAssigned, UserAssigned' includes both an implicitly created
         identity and a set of user assigned identities. The type 'None' will remove any identities from
         the resource. Possible values include: "None", "SystemAssigned".
        :paramtype type: str or ~dashboard_management_client.models.IdentityType
...
class OperationListResult(msrest.serialization.Model):
    ...
    :vartype value: list[~dashboard_management_client.models.OperationResult]
...
class OperationResult(msrest.serialization.Model):
    ...
    :vartype display: ~dashboard_management_client.models.OperationDisplay
    :ivar origin: The intended executor of the operation. Possible values include: "user",
     "system", "user,system".
    :vartype origin: str or ~dashboard_management_client.models.Origin
    :ivar action_type: Indicates the action type. "Internal" refers to actions that are for
     internal only APIs. Possible values include: "Internal".
    :vartype action_type: str or ~dashboard_management_client.models.ActionType
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype display: ~dashboard_management_client.models.OperationDisplay
        """
...
class SystemData(msrest.serialization.Model):
    ...
    :vartype created_by_type: str or ~dashboard_management_client.models.CreatedByType
    :ivar created_at:
    ...
    :ivar last_modified_by_type: Possible values include: "User", "Application", "ManagedIdentity",
     "Key".
    :vartype last_modified_by_type: str or ~dashboard_management_client.models.LastModifiedByType
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype created_by_type: str or ~dashboard_management_client.models.CreatedByType
        :keyword created_at:
        ...
        :keyword last_modified_by_type: Possible values include: "User", "Application",
         "ManagedIdentity", "Key".
        :paramtype last_modified_by_type: str or ~dashboard_management_client.models.LastModifiedByType
