...
class PrivateEndpointConnectionsOperations:
    ...
    async def _approve_initial(
        ...
        body: Optional[Union[_models.PrivateEndpointConnection, IO[bytes]]] = None,
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _request = build_approve_request(
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            private_endpoint_connection_name=private_endpoint_connection_name,
            subscription_id=self._config.subscription_id,
    ...
    async def begin_approve(
        ...
        **kwargs: Any
        ...
        :param private_endpoint_connection_name: The private endpoint connection name of Azure Managed
         Grafana. Required.
        :type private_endpoint_connection_name: str
        :param body: Is either a PrivateEndpointConnection type or a IO[bytes] type. Default value is
         None.
        :type body: ~azure.mgmt.dashboard.models.PrivateEndpointConnection or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either PrivateEndpointConnection or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.dashboard.models.PrivateEndpointConnection]
