...
def main():
    ...
    response = client.private_link_resources.get(
        ...
        private_link_resource_name="grafana",
    )
    print(response)


# x-ms-original-file: specification/dashboard/resource-manager/Microsoft.Dashboard/preview/2024-11-01-preview/examples/PrivateLinkResources_Get.json
