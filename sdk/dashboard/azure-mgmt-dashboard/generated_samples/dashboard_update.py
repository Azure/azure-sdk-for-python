...
def main():
    ...
    response = client.managed_dashboards.update(
...
# x-ms-original-file: specification/dashboard/resource-manager/Microsoft.Dashboard/preview/2024-11-01-preview/examples/Dashboard_Update.json
