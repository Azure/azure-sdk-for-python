...
from ...operations._managed_network_peering_policies_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_managed_network_request
T = TypeVar('T')
...
class ManagedNetworkPeeringPoliciesOperations:
    ...
    def list_by_managed_network(
        ...
        **kwargs: Any
        ...
        :type skiptoken: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ManagedNetworkPeeringPolicyListResult or the
         result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.managednetwork.models.ManagedNetworkPeeringPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2019-06-01-preview")  # type: str
