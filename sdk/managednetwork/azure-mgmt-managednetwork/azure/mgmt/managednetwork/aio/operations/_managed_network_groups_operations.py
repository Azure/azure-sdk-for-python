...
from ...operations._managed_network_groups_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_managed_network_request
T = TypeVar('T')
    ...
    def list_by_managed_network(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ManagedNetworkGroupListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.managednetwork.models.ManagedNetworkGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2019-06-01-preview")  # type: str
