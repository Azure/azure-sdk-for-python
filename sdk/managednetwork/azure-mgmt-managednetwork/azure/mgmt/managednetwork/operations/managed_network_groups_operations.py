...
class ManagedNetworkGroupsOperations(object):
    ...
    def list_by_managed_network(
        ...
        deserialized = models.ManagedNetworkGroupPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ManagedNetworkGroupPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
