...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetwork/managedNetworks/{managedNetworkName}/managedNetworkPeeringPolicies/{managedNetworkPeeringPolicyName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "managedNetworkName": _SERIALIZER.url("managed_network_name", managed_network_name, 'str'),
        "managedNetworkPeeringPolicyName": _SERIALIZER.url("managed_network_peering_policy_name", managed_network_peering_policy_name, 'str'),
    }
...
def build_list_by_managed_network_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetwork/managedNetworks/{managedNetworkName}/managedNetworkPeeringPolicies")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "managedNetworkName": _SERIALIZER.url("managed_network_name", managed_network_name, 'str'),
...
class ManagedNetworkPeeringPoliciesOperations(object):
    ...
    def list_by_managed_network(
        ...
        skiptoken: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.ManagedNetworkPeeringPolicyListResult"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.managednetwork.models.ManagedNetworkPeeringPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2019-06-01-preview")  # type: str
