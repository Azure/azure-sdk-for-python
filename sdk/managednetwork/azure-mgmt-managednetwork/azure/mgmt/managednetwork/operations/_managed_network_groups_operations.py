...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetwork/managedNetworks/{managedNetworkName}/managedNetworkGroups/{managedNetworkGroupName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "managedNetworkName": _SERIALIZER.url("managed_network_name", managed_network_name, 'str'),
        "managedNetworkGroupName": _SERIALIZER.url("managed_network_group_name", managed_network_group_name, 'str'),
    }
...
def build_list_by_managed_network_request(
    subscription_id: str,
    resource_group_name: str,
    managed_network_name: str,
    *,
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetwork/managedNetworks/{managedNetworkName}/managedNetworkGroups")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "managedNetworkName": _SERIALIZER.url("managed_network_name", managed_network_name, 'str'),
...
class ManagedNetworkGroupsOperations(object):
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.managednetwork.models.ManagedNetworkGroup
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(managed_network_group, 'ManagedNetworkGroup')
    ...
    def begin_create_or_update(
        ...
        managed_network_group: "_models.ManagedNetworkGroup",
        **kwargs: Any
    ) -> LROPoller["_models.ManagedNetworkGroup"]:
        ...
        :param managed_network_group: Parameters supplied to the create/update a Managed Network Group
         resource.
        :type managed_network_group: ~azure.mgmt.managednetwork.models.ManagedNetworkGroup
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either ManagedNetworkGroup or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managednetwork.models.ManagedNetworkGroup]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2019-06-01-preview")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_by_managed_network(
        ...
        skiptoken: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.ManagedNetworkGroupListResult"]:
        ...
        :param managed_network_name: The name of the Managed Network.
        :type managed_network_name: str
        :param top: May be used to limit the number of results in a page for list queries. Default
         value is None.
        :type top: int
        ...
        :type skiptoken: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ManagedNetworkGroupListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.managednetwork.models.ManagedNetworkGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2019-06-01-preview")  # type: str
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_managed_network_request(
                    ...
                    top=top,
                    skiptoken=skiptoken,
                    template_url=self.list_by_managed_network.metadata['url'],
                )
                request = _convert_request(request)
                request.url = self._client.format_url(request.url)
