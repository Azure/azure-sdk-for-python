...
class DiscoverySolutionOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.selfhelp.aio.HelpRP`'s
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.SolutionMetadata"]:
        ...
        <https://learn.microsoft.com/en-us/rest/api/support/problem-classifications/list?tabs=HTTP>`_.:code:`<br/>`:code:`<br/>`
        ...
        :return: An iterator like instance of either SolutionMetadata or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.selfhelp.models.SolutionMetadata]
