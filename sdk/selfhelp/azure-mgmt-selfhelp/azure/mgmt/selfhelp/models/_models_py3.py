...
class DiscoveryResponse(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.selfhelp.models.SolutionMetadata]
    :ivar next_link: The link used to get the next page of solution metadata.
    :vartype next_link: str
    """

    _attribute_map = {
        "value": {"key": "value", "type": "[SolutionMetadata]"},
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.SolutionMetadata"]] = None,
        next_link: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword value: The list of solution metadata.
        :paramtype value: list[~azure.mgmt.selfhelp.models.SolutionMetadata]
...
class SolutionMetadata(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "description": {"key": "description", "type": "str"},
        "required_parameter_sets": {"key": "requiredParameterSets", "type": "[[str]]"},
    }
