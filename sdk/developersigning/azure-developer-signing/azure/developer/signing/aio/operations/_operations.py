...
class CertificateProfileOperationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.developer.signing.aio.SigningClient`'s
    ...
    async def get_signing_status(  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace_async
    async def get_sign_root_certificate(self, account_name: str, certificate_profile: str, **kwargs: Any) -> bytes:
    ...
    def list_extended_key_usages(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.developer.signing.models.ExtendedKeyUsage]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_sign(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns SignResult. The SignResult is compatible
         with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.developer.signing.models.SignResult]
        :raises ~azure.core.exceptions.HttpResponseError:
