...
# USAGE
    python kusto_data_connections_event_hub_with_managed_identity_create_or_update.py
...
def main():
    ...
    response = client.data_connections.begin_create_or_update(
...
# x-ms-original-file: specification/azure-kusto/resource-manager/Microsoft.Kusto/Kusto/stable/2025-02-14/examples/KustoDataConnectionsEventHubWithManagedIdentityCreateOrUpdate.json
