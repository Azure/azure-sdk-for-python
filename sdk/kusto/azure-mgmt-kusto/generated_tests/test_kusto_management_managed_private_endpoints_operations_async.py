...
class TestKustoManagementManagedPrivateEndpointsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_managed_private_endpoints_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.managed_private_endpoints.begin_create_or_update(
                resource_group_name=resource_group.name,
                cluster_name="str",
                managed_private_endpoint_name="str",
                parameters={
