...
class ScriptsOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("Script", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        database_name: str,
        script_name: str,
        parameters: Union[_models.Script, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.kusto.models.Script or IO[bytes]
        :return: An instance of LROPoller that returns either Script or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.kusto.models.Script]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def check_name_availability(
        ...
        cluster_name: str,
        database_name: str,
        script_name: Union[_models.ScriptCheckNameRequest, IO[bytes]],
        **kwargs: Any
    ) -> _models.CheckNameResult:
        """Checks that the script name is valid and is not already in use.
        ...
        :param database_name: The name of the database in the Kusto cluster. Required.
        :type database_name: str
        :param script_name: The name of the script. Is either a ScriptCheckNameRequest type or a
         IO[bytes] type. Required.
        :type script_name: ~azure.mgmt.kusto.models.ScriptCheckNameRequest or IO[bytes]
        :return: CheckNameResult or the result of cls(response)
        :rtype: ~azure.mgmt.kusto.models.CheckNameResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
