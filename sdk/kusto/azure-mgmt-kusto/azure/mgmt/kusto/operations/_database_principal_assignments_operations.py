...
class DatabasePrincipalAssignmentsOperations(object):
    ...
    def check_name_availability(
        ...
        """
        principal_assignment_name = models.DatabasePrincipalAssignmentCheckNameRequest(name=name)
    ...
    def get(
            self, resource_group_name, cluster_name, database_name, principal_assignment_name, custom_headers=None, raw=False, **operation_config):
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: DatabasePrincipalAssignment or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.kusto.models.DatabasePrincipalAssignment or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('DatabasePrincipalAssignment', response)
    ...
    def _create_or_update_initial(
            self, resource_group_name, cluster_name, database_name, principal_assignment_name, parameters, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def create_or_update(
            self, resource_group_name, cluster_name, database_name, principal_assignment_name, parameters, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :param principal_assignment_name: The name of the Kusto
         principalAssignment.
        :type principal_assignment_name: str
        :param parameters: The Kusto principalAssignments parameters supplied
         for the operation.
    ...
    def delete(
            self, resource_group_name, cluster_name, database_name, principal_assignment_name, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.DatabasePrincipalAssignmentPaged(internal_paging, self._deserialize.dependencies, header_dict)
