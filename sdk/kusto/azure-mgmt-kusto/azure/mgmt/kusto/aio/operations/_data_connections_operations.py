...
class DataConnectionsOperations:
    ...
    def list_by_database(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DataConnectionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~kusto_management_client.models.DataConnectionListResult]
    ...
    async def begin_data_connection_validation(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~kusto_management_client.models.DataConnectionValidationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
