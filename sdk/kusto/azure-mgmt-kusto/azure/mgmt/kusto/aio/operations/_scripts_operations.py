...
from ...operations._scripts_operations import build_check_name_availability_request, build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_database_request, build_update_request_initial
T = TypeVar('T')
...
class ScriptsOperations:
    ...
    def list_by_database(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~kusto_management_client.models.ScriptListResult]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Script or the result of
         cls(response)
