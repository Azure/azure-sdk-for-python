...
def build_operations_list_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/providers/MongoDB.Atlas/operations"
...
def build_organizations_list_by_resource_group_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/MongoDB.Atlas/organizations"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
    }
...
def build_organizations_list_by_subscription_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/providers/MongoDB.Atlas/organizations"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
def build_projects_get_request(
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/MongoDB.Atlas/organizations/{organizationName}/projects/{projectName}"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "organizationName": _SERIALIZER.url("organization_name", organization_name, "str"),
...
def build_projects_list_request(
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/MongoDB.Atlas/organizations/{organizationName}/projects"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "organizationName": _SERIALIZER.url("organization_name", organization_name, "str"),
...
def build_projects_tier_limit_reached_request(  # pylint: disable=name-too-long
    resource_group_name: str, organization_name: str, project_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/MongoDB.Atlas/organizations/{organizationName}/projects/{projectName}/tierLimitReached"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "organizationName": _SERIALIZER.url("organization_name", organization_name, "str"),
...
def build_projects_list_cluster_tier_regions_request(  # pylint: disable=name-too-long
    resource_group_name: str, organization_name: str, project_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/MongoDB.Atlas/organizations/{organizationName}/projects/{projectName}/clusterTierRegions"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "organizationName": _SERIALIZER.url("organization_name", organization_name, "str"),
...
def build_clusters_create_or_update_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/MongoDB.Atlas/organizations/{organizationName}/projects/{projectName}/clusters/{clusterName}"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "organizationName": _SERIALIZER.url("organization_name", organization_name, "str"),
...
def build_clusters_list_request(
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/MongoDB.Atlas/organizations/{organizationName}/projects/{projectName}/clusters"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "organizationName": _SERIALIZER.url("organization_name", organization_name, "str"),
...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.mongodbatlas.MongoDBAtlasMgmtClient`'s
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: MongoDBAtlasMgmtClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def list(self, **kwargs: Any) -> ItemPaged["_models.Operation"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.mongodbatlas.models.Operation]
...
class OrganizationsOperations:
    ...
    def get(self, resource_group_name: str, organization_name: str, **kwargs: Any) -> _models.OrganizationResource:
        ...
        :rtype: ~azure.mgmt.mongodbatlas.models.OrganizationResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.mongodbatlas.models.OrganizationResource
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.mongodbatlas.models.OrganizationResource or JSON or IO[bytes]
        :return: An instance of LROPoller that returns OrganizationResource. The OrganizationResource
         is compatible with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mongodbatlas.models.OrganizationResource]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_resource_group(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.mongodbatlas.models.OrganizationResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class ProjectsOperations:
    ...
    def get(
        ...
        :param organization_name: Name of the Organization resource. Required.
        :type organization_name: str
        :param project_name: Name of the MongoDB Atlas Project resource. Required.
        :type project_name: str
        :return: Project. The Project is compatible with MutableMapping
        :rtype: ~azure.mgmt.mongodbatlas.models.Project
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type project_name: str
        :param resource: Resource create parameters. Required.
        :type resource: ~azure.mgmt.mongodbatlas.models.Project
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns Project. The Project is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mongodbatlas.models.Project]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is one of the following types: Project, JSON,
         IO[bytes] Required.
        :type resource: ~azure.mgmt.mongodbatlas.models.Project or JSON or IO[bytes]
        :return: An instance of LROPoller that returns Project. The Project is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mongodbatlas.models.Project]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list(self, resource_group_name: str, organization_name: str, **kwargs: Any) -> ItemPaged["_models.Project"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.mongodbatlas.models.Project]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def tier_limit_reached(
        self, resource_group_name: str, organization_name: str, project_name: str, **kwargs: Any
    ) -> _models.TierLimitReachedResponse:
        ...
        :param project_name: Name of the MongoDB Atlas Project resource. Required.
        :type project_name: str
        :return: TierLimitReachedResponse. The TierLimitReachedResponse is compatible with
         MutableMapping
        :rtype: ~azure.mgmt.mongodbatlas.models.TierLimitReachedResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.TierLimitReachedResponse] = kwargs.pop("cls", None)

        _request = build_projects_tier_limit_reached_request(
            resource_group_name=resource_group_name,
            organization_name=organization_name,
            project_name=project_name,
            subscription_id=self._config.subscription_id,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.TierLimitReachedResponse, response.json())
    ...
    def list_cluster_tier_regions(
        ...
        :param project_name: Name of the MongoDB Atlas Project resource. Required.
        :type project_name: str
        :return: RegionsByTierResponse. The RegionsByTierResponse is compatible with MutableMapping
        :rtype: ~azure.mgmt.mongodbatlas.models.RegionsByTierResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.RegionsByTierResponse] = kwargs.pop("cls", None)

        _request = build_projects_list_cluster_tier_regions_request(
            resource_group_name=resource_group_name,
            organization_name=organization_name,
            project_name=project_name,
            subscription_id=self._config.subscription_id,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.RegionsByTierResponse, response.json())
...
class ClustersOperations:
    ...
    def _create_or_update_initial(
        ...
        project_name: str,
        cluster_name: str,
        resource: Union[_models.Cluster, JSON, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param project_name: Name of the MongoDB Atlas Project resource. Required.
        :type project_name: str
        :param cluster_name: Name of the MongoDB Atlas Cluster resource. Required.
        :type cluster_name: str
        :param resource: Resource create parameters. Required.
        :type resource: ~azure.mgmt.mongodbatlas.models.Cluster
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns Cluster. The Cluster is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mongodbatlas.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param cluster_name: Name of the MongoDB Atlas Cluster resource. Required.
        :type cluster_name: str
        :param resource: Resource create parameters. Is one of the following types: Cluster, JSON,
         IO[bytes] Required.
        :type resource: ~azure.mgmt.mongodbatlas.models.Cluster or JSON or IO[bytes]
        :return: An instance of LROPoller that returns Cluster. The Cluster is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mongodbatlas.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _delete_initial(
        self, resource_group_name: str, organization_name: str, project_name: str, cluster_name: str, **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def list(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.mongodbatlas.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.mongodbatlas.models.Cluster
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
