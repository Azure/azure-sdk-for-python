...
class TestMongoDBAtlasMgmtOrganizationsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_organizations_begin_update(self, resource_group):
        response = self.client.organizations.begin_update(
            resource_group_name=resource_group.name,
            organization_name="str",
            properties={
                "location": "str",
