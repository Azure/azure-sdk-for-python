...
class ServiceLevelAgreement(Model):
    ...
    def __init__(self, *, start_time=None, expiration_time=None, sla_minutes: int=None, **kwargs) -> None:
...
class SupportTicketDetails(Model):
    ...
    def __init__(self, *, support_ticket_id: str=None, description: str=None, problem_classification_details=None, severity=None, enrollment_id: str=None, production_outage: bool=None, is24_x7_response: bool=None, contact_details=None, service_level_agreement=None, support_engineer=None, support_plan_type: str=None, title: str=None, service_details=None, status: str=None, created_date=None, modified_date=None, technical_ticket_details=None, quota_ticket_details=None, **kwargs) -> None:
        ...
        self.description = description
        self.problem_classification_details = problem_classification_details
        self.severity = severity
        self.enrollment_id = enrollment_id
        self.production_outage = production_outage
        self.is24_x7_response = is24_x7_response
        self.contact_details = contact_details
        self.service_level_agreement = service_level_agreement
        self.support_engineer = support_engineer
        self.support_plan_type = support_plan_type
        self.title = title
