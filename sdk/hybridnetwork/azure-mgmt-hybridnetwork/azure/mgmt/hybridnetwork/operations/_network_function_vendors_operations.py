...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/networkFunctionVendors")  # pylint: disable=line-too-long
...
class NetworkFunctionVendorsOperations:
    ...
    def list(
        self,
        **kwargs: Any
    ) -> Iterable[_models.NetworkFunctionVendorListResult]:
        """Lists all the available vendor and sku information.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either NetworkFunctionVendorListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.hybridnetwork.models.NetworkFunctionVendorListResult]
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', "2022-01-01-preview"))  # type: str
        cls = kwargs.pop('cls', None)  # type: ClsType[_models.NetworkFunctionVendorListResult]
