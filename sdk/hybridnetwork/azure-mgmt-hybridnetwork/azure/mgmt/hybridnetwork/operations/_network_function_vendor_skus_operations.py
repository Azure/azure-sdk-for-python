...
def build_list_by_vendor_request(
    vendor_name: str,
    subscription_id: str,
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/networkFunctionVendors/{vendorName}/vendorSkus")  # pylint: disable=line-too-long
...
def build_list_by_sku_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/networkFunctionVendors/{vendorName}/vendorSkus/{vendorSkuName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "vendorName": _SERIALIZER.url("vendor_name", vendor_name, 'str'),
...
class NetworkFunctionVendorSkusOperations:
    ...
    def list_by_vendor(
        ...
        vendor_name: str,
        **kwargs: Any
    ) -> Iterable[_models.NetworkFunctionSkuListResult]:
        ...
        :return: An iterator like instance of either NetworkFunctionSkuListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.hybridnetwork.models.NetworkFunctionSkuListResult]
    ...
    def list_by_sku(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either NetworkFunctionSkuDetails or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.hybridnetwork.models.NetworkFunctionSkuDetails]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
