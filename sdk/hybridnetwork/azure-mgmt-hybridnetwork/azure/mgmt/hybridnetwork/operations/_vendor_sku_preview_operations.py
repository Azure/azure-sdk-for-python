...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/vendors/{vendorName}/vendorSkus/{skuName}/previewSubscriptions")  # pylint: disable=line-too-long
...
def build_create_or_update_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.PreviewSubscription] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/vendors/{vendorName}/vendorSkus/{skuName}/previewSubscriptions/{previewSubscription}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "vendorName": _SERIALIZER.url("vendor_name", vendor_name, 'str'),
        "skuName": _SERIALIZER.url("sku_name", sku_name, 'str'),
...
class VendorSkuPreviewOperations:
    ...
    def list(
        ...
        sku_name: str,
        **kwargs: Any
    ) -> Iterable[_models.PreviewSubscriptionsList]:
        ...
        :return: An iterator like instance of either PreviewSubscriptionsList or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.hybridnetwork.models.PreviewSubscriptionsList]
