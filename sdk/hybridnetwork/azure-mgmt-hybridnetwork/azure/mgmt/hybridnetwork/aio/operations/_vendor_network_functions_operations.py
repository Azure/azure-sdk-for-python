...
from ...operations._vendor_network_functions_operations import build_create_or_update_request_initial, build_get_request, build_list_request
T = TypeVar('T')
...
class VendorNetworkFunctionsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either VendorNetworkFunctionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hybridnetwork.models.VendorNetworkFunctionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
