...
from ...operations._vendors_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_subscription_request
T = TypeVar('T')
...
class VendorsOperations:
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hybridnetwork.models.VendorListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
