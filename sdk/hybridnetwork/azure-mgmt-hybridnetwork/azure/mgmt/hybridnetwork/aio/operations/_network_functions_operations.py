...
from ...operations._network_functions_operations import build_create_or_update_request_initial, build_delete_request_initial, build_execute_request_request_initial, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_update_tags_request
T = TypeVar('T')
...
class NetworkFunctionsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no
         Retry-After header is present.
        :return: An instance of AsyncLROPoller that returns either NetworkFunction or the result of
         cls(response)
    ...
    def list_by_subscription(
        self,
        **kwargs: Any
    ) -> AsyncIterable[_models.NetworkFunctionListResult]:
        ...
        :return: An iterator like instance of either NetworkFunctionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hybridnetwork.models.NetworkFunctionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace_async
    async def begin_execute_request(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        network_function_name: str,
        parameters: _models.ExecuteRequestParameters,
