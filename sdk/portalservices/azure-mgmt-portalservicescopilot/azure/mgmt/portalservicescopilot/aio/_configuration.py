...
class PortalServicesCopilotMgmtClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    """Configuration for PortalServicesCopilotMgmtClient.
    ...
    def __init__(
        ...
        kwargs.setdefault("sdk_moniker", "mgmt-portalservicescopilot/{}".format(VERSION))
