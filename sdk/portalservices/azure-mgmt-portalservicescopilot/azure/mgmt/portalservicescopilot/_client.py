...
from .operations import CopilotSettingsOperations, Operations

if TYPE_CHECKING:
    from azure.core.credentials import TokenCredential


class PortalServicesCopilotMgmtClient:
    """Azure Portal Services API Reference.

    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.portalservicescopilot.operations.Operations
    :ivar copilot_settings: CopilotSettingsOperations operations
    :vartype copilot_settings:
    ...
    def __init__(
        ...
        self.copilot_settings = CopilotSettingsOperations(
