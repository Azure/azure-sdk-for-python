...
class CheckNameAvailabilityResult(Model):
    ...
    :param name_available: Required. True indicates name is valid and
     available. False indicates the name is invalid, unavailable, or both.
    :type name_available: bool
    :param reason: Required if nameAvailable == false. Invalid indicates the
    ...
    :type reason: str
    :param message: Required if nameAvailable == false, indicating why name is
     not available.
    :type message: str
    """
