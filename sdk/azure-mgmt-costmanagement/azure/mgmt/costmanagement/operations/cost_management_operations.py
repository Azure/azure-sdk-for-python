...
class CostManagementOperations(object):
    ...
    def check_name_availability(
            self, type=None, name=None, custom_headers=None, raw=False, **operation_config):
    ...
    def check_name_availability_by_scope(
        ...
        # Construct URL
        url = self.check_name_availability_by_scope.metadata['url']
        ...
        return deserialized
    check_name_availability_by_scope.metadata = {'url': '/{scope}/providers/Microsoft.CostManagement/checkNameAvailability'}
