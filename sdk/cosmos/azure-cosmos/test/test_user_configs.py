...
class TestUserConfigs(unittest.TestCase):
    ...
    def test_default_account_consistency(self):
        ...
        session_token = create_response.response_headers[http_constants.CookieHeaders.SessionToken]
        item2 = get_test_item()
        create_response = container.create_item(body=item2)
        session_token2 = create_response.response_headers[http_constants.CookieHeaders.SessionToken]
        ...
        read_session_token = read_response.response_headers[http_constants.CookieHeaders.SessionToken]
