...
def create_split_ranges():
    return [        # split with two children
                   ...
                   ([(("AA", "BB"), "0:1#54#3=52"), (("AA", "BB"),"0:2#57#3=53")],
                    ("AA", "BB"), "0:2#57#3=53"),
                    # mixed scenarios
                   ([(("AA", "DD"), "0:1#60#3=53"), (("AA", "BB"), "1:1#54#3=52"), (("AA", "BB"), "1:1#52#3=53"),
                     (("BB", "CC"),"1:1#53#3=52"), (("BB", "CC"),"1:1#70#3=55,3:1#90#3=52"),
                     (("CC", "DD"),"1:1#55#3=52")], ("AA", "DD"), "0:1#60#3=53,1:1#70#3=55,3:1#90#3=52")
                  ]
