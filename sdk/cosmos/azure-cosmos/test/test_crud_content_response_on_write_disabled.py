...
class TestCRUDOperationsContentResponseOnWriteDisabled(unittest.TestCase):
    ...
    def etag_Capturer(headers, response):
        etag = headers['etag']
    ...
    def test_document_crud(self):
        ...
        self.logger.info("headers: " + str(len(headerEnvelope.headers)))
        self.logger.info("etag: " + headerEnvelope.headers["etag"])
        self.fail("HelloWorld")
