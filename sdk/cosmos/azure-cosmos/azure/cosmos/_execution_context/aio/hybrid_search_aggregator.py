        ...
        if self._aggregated_global_statistics:
            ...
            for query_info in component_query_infos:
                ...
                for order_by_expression in query_info['orderByExpressions']:
                    rewritten_order_by_expression = self._format_component_query_workaround(order_by_expression,
                ...
                rewritten_query = self._format_component_query_workaround(query_info['rewrittenQuery'],
