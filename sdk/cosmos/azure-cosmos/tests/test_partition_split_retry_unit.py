...
class TestPartitionSplitRetryUnit(unittest.TestCase):
    ...
    def test_execution_context_state_reset_on_partition_split(self):
        ...
        assert loop_condition_with_reset, "With state reset, loop condition should be True"
    ...
    def test_pk_range_query_skips_410_retry_to_prevent_recursion(self, mock_execute):
        ...
        assert mock_execute.call_count == 1, "Execute should only be called once - no retry for PK range queries"
    ...
    def test_410_retry_behavior_with_and_without_pk_range_flag(self, mock_execute):
        ...
        assert mock_execute.call_count == 4, f"Expected 4 Execute calls, got {mock_execute.call_count}"
        ...
        assert mock_execute.call_count == 1, f"With flag, expected 1 Execute call, got {mock_execute.call_count}"
