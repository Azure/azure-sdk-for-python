...
class TestComputedPropertiesQuery(unittest.TestCase):
    ...
    def computedPropertiesTestCases(self, created_collection):
        ...
        queried_items = list(
            created_collection.query_items(query='Select * from c Where c.cp_upper = "GROUP2"', partition_key="test")
        )
    ...
    def test_replace_without_computed_properties(self):
        created_collection = self.created_db.create_container(
            id="computed_properties_query_test_" + str(uuid.uuid4()), partition_key=PartitionKey(path="/pk")
        )
    ...
    def test_replace_with_new_computed_properties(self):
        ...
        # Test 1: Test first computed property
        queried_items = list(
            replaced_collection.query_items(query='Select * from c Where c.cp_upper = "GROUP2"', partition_key="test")
        )
