...
class TestCrossPartitionQuery(unittest.TestCase):
    ...
    def test_populate_index_metrics(self):
        ...
        query = "SELECT * from c"
        query_iterable = self.created_container.query_items(
            query=query, partition_key="pk", populate_index_metrics=True
        )
    ...
    def test_offset_limit(self):
        ...
        self.config._validate_offset_limit(
            created_collection=self.created_container,
    ...
    def test_cross_partition_query_response_hook(self):
        ...
        item_list = [
            item
            for item in created_collection.query_items(
                "select * from c", enable_cross_partition_query=True, response_hook=response_hook
            )
        ]
    ...
    def test_cross_partition_query_pagination_with_max_item_count(self):
        ...
        query_iterable = created_collection.query_items(
            query=query, enable_cross_partition_query=True, max_item_count=max_items_per_page
        )
