    ...
    async def test_incremental_change_feed_only_affects_target_collection_async(self):
        ...
        try:
            ...
            while time.time() < split_convergence_deadline:
                physical_ranges = [r async for r in container_a.client_connection._ReadPartitionKeyRanges(
            ...
            # Run queries on container B to verify cache wasn't invalidated.
            await run_queries(container_b, 1)
