...
def setup():
    if TestSessionTokenHelpers.masterKey == "[YOUR_KEY_HERE]" or TestSessionTokenHelpers.host == "[YOUR_ENDPOINT_HERE]":
        raise Exception(
...
def create_split_ranges():
    return [  # split with two children
        (
            ...
            ("AA", "DD"),
            "1:1#55#3=52,2:1#54#3=52",
        ),
        # same range different partition key range ids
        ([(("AA", "DD"), "1:1#51#3=52"), (("AA", "DD"), "0:1#55#3=52")], ("AA", "DD"), "0:1#55#3=52"),
        # split with one child
        ([(("AA", "DD"), "0:1#51#3=52"), (("AA", "BB"), "1:1#55#3=52")], ("AA", "DD"), "0:1#51#3=52,1:1#55#3=52"),
        ...
        (
            ...
            ("AA", "DD"),
            "0:1#60#3=52,1:1#66#3=52",
        ),
        # merge with one child
        ([(("AA", "DD"), "3:1#55#3=52"), (("AA", "BB"), "1:1#51#3=52")], ("AA", "DD"), "3:1#55#3=52"),
        ...
        (
            ...
            ("AA", "BB"),
            "2:1#54#3=52,1:1#55#3=52,0:1#51#3=52",
        ),
        # several compound session token with one range
        (
            [(("AA", "DD"), "2:1#57#3=52,1:1#57#3=52"), (("AA", "DD"), "2:1#56#3=52,1:1#58#3=52")],
            ("AA", "DD"),
            "2:1#57#3=52,1:1#58#3=52",
        ),
        # overlapping ranges
        ([(("AA", "CC"), "0:1#54#3=52"), (("BB", "FF"), "2:1#51#3=52")], ("AA", "EE"), "0:1#54#3=52,2:1#51#3=52"),
        # different version numbers
        ([(("AA", "BB"), "0:1#54#3=52"), (("AA", "BB"), "0:2#57#3=53")], ("AA", "BB"), "0:2#57#3=53"),
        # mixed scenarios
        (
            [
                (("AA", "DD"), "3:1#60#3=53"),
                ...
                (("AA", "BB"), "1:1#52#3=53"),
                (("BB", "CC"), "1:1#53#3=52"),
                (("BB", "CC"), "6:1#70#3=55,4:1#90#3=52"),
                (("CC", "DD"), "1:1#55#3=52"),
            ],
            ("AA", "DD"),
            "3:1#60#3=53,6:1#70#3=55,4:1#90#3=52",
        ),
    ]
...
class TestSessionTokenHelpers:
    ...
    def test_get_session_token_update(self, setup):
        feed_range = FeedRangeInternalEpk(Range("AA", "BB", True, False)).to_dict()
    ...
    def test_many_session_tokens_update_same_range(self, setup):
        ...
        feed_ranges_and_session_tokens.append((feed_range, session_token))
        updated_session_token = setup["created_collection"].get_latest_session_token(
            feed_ranges_and_session_tokens, feed_range
        )
    ...
    def test_many_session_tokens_update(self, setup):
        ...
        feed_range1 = FeedRangeInternalEpk(Range("CC", "FF", True, False)).to_dict()
        feed_range2 = FeedRangeInternalEpk(Range("00", "55", True, False)).to_dict()
        for i in range(1000):
            session_token = "0:1#" + str(random.randint(1, 100)) + "#3=" + str(random.randint(1, 100))
            if i % 2 == 0:
    ...
    def test_simulated_splits_merges(self, setup, split_ranges, target_feed_range, expected_session_token):
        ...
        for feed_range, session_token in split_ranges:
            actual_split_ranges.append(
                (FeedRangeInternalEpk(Range(feed_range[0], feed_range[1], True, False)).to_dict(), session_token)
            )
        target_feed_range = FeedRangeInternalEpk(
            Range(target_feed_range[0], target_feed_range[1][1], True, False)
        ).to_dict()
    ...
    def test_invalid_feed_range(self, setup):
        ...
        with pytest.raises(ValueError, match="There were no overlapping feed ranges with the target."):
            setup["created_collection"].get_latest_session_token(
                feed_ranges_and_session_tokens, FeedRangeInternalEpk(Range("CC", "FF", True, False)).to_dict()
            )
