...
class TestComputedPropertiesQueryAsync(AsyncReplacementCase):
    ...
    async def test_replace_with_same_computed_properties_async(self):
        # Source: tests/test_computed_properties_async.py::TestComputedPropertiesQueryAsync.test_replace_with_same_computed_properties_async
    ...
    async def test_replace_without_computed_properties_async(self):
        # Source: tests/test_computed_properties_async.py::TestComputedPropertiesQueryAsync.test_replace_without_computed_properties_async
        # create_container/replace_container are control-plane and use key_db (key-auth).
        created_collection_ref = await self.key_db.create_container(
            "computed_properties_query_test_" + str(uuid.uuid4()),
            PartitionKey(path="/pk"))
    ...
    async def test_replace_with_new_computed_properties_async(self):
        # Source: tests/test_computed_properties_async.py::TestComputedPropertiesQueryAsync.test_replace_with_new_computed_properties_async
        # create_container/replace_container are control-plane and use key_db (key-auth).
        created_collection_ref = await self.key_db.create_container(
            "computed_properties_query_test_" + str(uuid.uuid4()),
            PartitionKey(path="/pk"),
    ...
    async def test_replace_with_incorrect_computed_properties_async(self):
        # Source: tests/test_computed_properties_async.py::TestComputedPropertiesQueryAsync.test_replace_with_incorrect_computed_properties_async
        # create_container/replace_container are control-plane and use key_db (key-auth).
        created_collection_ref = await self.key_db.create_container(
            "computed_properties_query_test_" + str(uuid.uuid4()),
            PartitionKey(path="/pk"),
    ...
    async def test_replace_with_remove_computed_properties_async(self):
        # Source: tests/test_computed_properties_async.py::TestComputedPropertiesQueryAsync.test_replace_with_remove_computed_properties_async
        # create_container/replace_container are control-plane and use key_db (key-auth).
        created_collection_ref = await self.key_db.create_container(
            "computed_properties_query_test_" + str(uuid.uuid4()),
            PartitionKey(path="/pk"),
