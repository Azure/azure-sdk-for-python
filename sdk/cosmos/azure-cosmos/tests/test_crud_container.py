...
class TestCRUDContainerOperations(unittest.TestCase):
    ...
    def test_trigger_functionality(self):
        ...
        document_1_1 = collection1.create_item(body={"id": "doc1", "key": "value"}, pre_trigger_include="t1")
        ...
        document_1_3 = collection1.create_item(body={"id": "responseheaders", "key": "value"}, pre_trigger_include="t1")
        ...
        document_2_1 = collection2.create_item(body={"id": "doc2", "key": "value2"}, pre_trigger_include="t2")
        self.assertEqual(document_2_1["id"], "doc2", "id shouldn't change")
        document_2_2 = collection2.create_item(
            body={"id": "Doc3", "prop": "empty", "key": "value2"}, pre_trigger_include="t3"
        )
        ...
        with self.assertRaises(Exception):
            collection3.create_item(body={"id": "Docoptype", "key": "value2"}, post_trigger_include="triggerOpType")
    ...
    def test_negative_replace_throughput_with_all_configs_set(self):
        ...
        new_throughput = ThroughputProperties(
            offer_throughput=2500, auto_scale_max_throughput=4000, auto_scale_increment_percent=5
        )
