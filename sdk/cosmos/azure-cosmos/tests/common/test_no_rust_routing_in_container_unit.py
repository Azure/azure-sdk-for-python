...
``azure.cosmos._helpers._container_throughput`` / ``azure.cosmos._helpers._feed_range_operations``
...
class _NoRustRoutingInContainerBase:
    ...
    def test_module_source_has_no_forbidden_backend_inspection_or_rust_naming(self):
        ...
        self.assertEqual(
            ...
            "azure.cosmos._helpers._container_throughput / "
            "azure.cosmos._helpers._feed_range_operations, not in the public "
