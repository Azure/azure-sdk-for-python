...
This is the async half of layer 3 of a three-layer defense (unit -> emulator parity ->
legacy snapshot). The parity suite only proves the two backends agree with each other; if
