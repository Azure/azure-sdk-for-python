...
class TestFaultInjectionTransport:
    ...
    def test_swr_mrr_succeeds(self: "TestFaultInjectionTransport"):
        ...
        is_write_operation_in_read_region_predicate: Callable[[HttpRequest], bool] = (
            lambda r: FaultInjectionTransport.predicate_is_write_operation(r, expected_read_region_uri)
        )
    ...
    def test_swr_mrr_region_down_read_succeeds(self: "TestFaultInjectionTransport"):
        ...
        is_request_to_read_region: Callable[[HttpRequest], bool] = (
            lambda r: FaultInjectionTransport.predicate_targets_region(r, expected_read_region_uri)
        )

        custom_transport.add_fault(is_request_to_read_region, lambda r: FaultInjectionTransport.error_region_down())
    ...
    def test_mwr_region_down_succeeds(self: "TestFaultInjectionTransport"):
        ...
        custom_transport.add_fault(is_request_to_first_region, lambda r: FaultInjectionTransport.error_region_down())
    ...
    def test_swr_mrr_all_regions_down_for_read(self: "TestFaultInjectionTransport"):
        ...
        is_request_to_first_region: Callable[[HttpRequest], bool] = lambda r: (
            FaultInjectionTransport.predicate_targets_region(r, expected_write_region_uri)
            and FaultInjectionTransport.predicate_is_document_operation(r)
            and not FaultInjectionTransport.predicate_is_write_operation(r, expected_write_region_uri)
        )

        # Inject rule to simulate regional outage in "Second Region"
        is_request_to_second_region: Callable[[HttpRequest], bool] = lambda r: (
            FaultInjectionTransport.predicate_targets_region(r, expected_read_region_uri)
            and FaultInjectionTransport.predicate_is_document_operation(r)
            and not FaultInjectionTransport.predicate_is_write_operation(r, expected_write_region_uri)
        )

        custom_transport.add_fault(is_request_to_first_region, lambda r: FaultInjectionTransport.error_region_down())
        custom_transport.add_fault(is_request_to_second_region, lambda r: FaultInjectionTransport.error_region_down())
    ...
    def test_mwr_all_regions_down(self: "TestFaultInjectionTransport"):
        ...
        is_request_to_second_region: Callable[[HttpRequest], bool] = (
            lambda r: FaultInjectionTransport.predicate_targets_region(r, second_region_uri)
            and FaultInjectionTransport.predicate_is_document_operation(r)
        )
