...
class TestQuery(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.client = cosmos_client.CosmosClient(cls.fabric_host, credential=cls.fabric_credential)
        cls.created_db = cls.client.get_database_client(cls.config.TEST_DATABASE_ID)
