...
@pytest.mark.skip(
    reason="accepted-vnext-change: RUST_MIGRATION_STATUS.md list_databases rejects session_token; covered offline"
)
class TestBackwardsCompatibility(unittest.TestCase):
    ...
    def test_session_token_compatibility(self):
        ...
        The same legacy test is also copied into ``query_databases``, which
        pins the query call in this sweep.
        """
