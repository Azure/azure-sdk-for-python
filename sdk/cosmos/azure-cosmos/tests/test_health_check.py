...
class TestHealthCheck:
    ...
    def test_health_check_success(self, setup):
        ...
        read_regional_routing_contexts = (
            client.client_connection._global_endpoint_manager.location_cache.read_regional_routing_contexts
        )
    ...
    def test_health_check_failure(self, setup):
        ...
        unavailable_endpoint_info = (
            client.client_connection._global_endpoint_manager.location_cache.location_unavailability_info_by_endpoint
        )
    ...
    def test_force_refresh_on_startup_with_valid_account_uses_provided_account(self, setup):
        ...
        try:
            ...
            assert (
                call_counter["count"] == initial_call_count
