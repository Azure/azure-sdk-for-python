...
class TestFeedRangeAsync(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_partition_key_to_feed_range_async(self):
        created_container = await self.database_for_test.create_container(
            id="container_" + str(uuid.uuid4()), partition_key=PartitionKey(path="/id")
        )
        ...
        assert feed_range_epk.get_normalized_range() == Range(
            "3C80B1B7310BB39F29CC4EA05BDD461E", "3c80b1b7310bb39f29cc4ea05bdd461f", True, False
        )
