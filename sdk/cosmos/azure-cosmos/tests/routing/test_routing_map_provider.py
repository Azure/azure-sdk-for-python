...
class TestRoutingMapProvider(unittest.TestCase):
    ...
    def test_full_range(self):
        ...
        self.assertEqual(overlapping_partition_key_ranges, self.partition_key_ranges)
        self.assertEqual(
            self.cached_collection_routing_map.get_overlapping_ranges([pkRange]), self.partition_key_ranges
        )
    ...
    def validate_against_cached_collection_results(self, queryRanges):
        ...
        self.assertEqual(
            overlapping_partition_key_ranges, self.cached_collection_routing_map.get_overlapping_ranges(queryRanges)
        )
