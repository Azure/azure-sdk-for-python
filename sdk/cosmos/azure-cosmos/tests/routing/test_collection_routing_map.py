...
class TestCollectionRoutingMap(unittest.TestCase):
    ...
    def test_partition_key_ranges_parent_filter(self):
        ...
        partitionKeyRanges = [
            {Id: "2", MinInclusive: "0000000050", MaxExclusive: "0000000070", Parents: []},
            {Id: "0", MinInclusive: "", MaxExclusive: "0000000030"},
            {Id: "1", MinInclusive: "0000000030", MaxExclusive: "0000000050"},
            {Id: "3", MinInclusive: "0000000070", MaxExclusive: "FF", Parents: []},
        ]
        ...
        partitionKeyRanges.append(
            {Id: "7", MinInclusive: "0000000010", MaxExclusive: "0000000020", Parents: ["0", "4"]}
        )
    ...
    def test_point_range_mapping(self):
        partition_key_ranges = [
            ...
            {"id": "1", "minInclusive": "1FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF", "maxExclusive": "FF"},
        ]
        partitionRangeWithInfo = [(r, True) for r in partition_key_ranges]
        expected_partition_key_range = routing_range.Range("", "1FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF", True, False)
        pk_range = routing_range.Range(
            "1EC0C2CBE45DBC919CF2B65D399C2673", "1EC0C2CBE45DBC919CF2B65D399C2673", True, True
        )
        ...
        self.assertEqual(
            expected_partition_key_range,
            routing_range.Range.PartitionKeyRangeToRange(overlapping_partition_key_ranges[0]),
        )
    ...
    def test_collection_routing_map(self):
        ...
        fullRangeMinToMaxRange = routing_range.Range(
            ...
            CollectionRoutingMap.MaximumExclusiveEffectivePartitionKey,
            True,
            False,
        )
