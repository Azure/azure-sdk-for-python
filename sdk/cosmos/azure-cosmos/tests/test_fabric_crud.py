...
class TestCRUDOperations(unittest.TestCase):
    ...
    # Doesn't apply to Managed Identity test
    @unittest.skip
    ...
    def test_client_request_timeout_when_connection_retry_configuration_specified(self):
        ...
        # client does a getDatabaseAccount on initialization, which will not time out because
        # there is a forced timeout for those calls
        with cosmos_client.CosmosClient(self.fabric_host, self.fabric_credential, connection_policy=connection_policy) as client:
    ...
    # Crud on user is not supported on fabric integration
    @unittest.skip
    ...
    # Skipping for fabric integration
    @unittest.skip
