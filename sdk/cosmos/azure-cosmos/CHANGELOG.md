...
#### Bugs Fixed
* Small fix to the `offer_throughput` option in the async client's `create_database_if_not_exists` method. See [PR 32076](https://github.com/Azure/azure-sdk-for-python/pull/32076).
