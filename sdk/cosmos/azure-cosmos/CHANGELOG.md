...
* Added ability to use Filters from Logging module on Diagnostics Logging based on same filtering options as the Cosmos Diagnogstics Handler. See [PR ]()

#### Other Changes
* Un-marked `computed_properties` keyword as **provisional**. See [PR 39543](https://github.com/Azure/azure-sdk-for-python/pull/39543)
* Optimized Diagnostics Logging by reducing time spent on logging. Logged Errors are more readable and formatted. See [PR ]()
