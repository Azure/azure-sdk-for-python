...
#### Features Added
* Added `max_degree_of_parallelism` kwarg to async `query_items` to enable concurrent cross-partition query execution. See [PR 45488](https://github.com/Azure/azure-sdk-for-python/pull/45488)
