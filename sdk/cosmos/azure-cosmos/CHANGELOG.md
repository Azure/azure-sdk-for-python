...
#### Features Added
- Added the ability to create containers and databases with autoscale properties for the sync and async clients. - [See PR 24838](https://github.com/Azure/azure-sdk-for-python/pull/24838)
#### Breaking Changes
