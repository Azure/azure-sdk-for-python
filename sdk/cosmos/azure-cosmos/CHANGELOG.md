...
* Added ability to use `excluded_locations` on client level and document API request level. [PR 40298](https://github.com/Azure/azure-sdk-for-python/pull/40298) 
