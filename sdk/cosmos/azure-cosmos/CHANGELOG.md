...
* Consolidated Container Properties Cache to be in the Client to cache partition key definition and container rid to avoid uncessary container reads. See [PR35293](https://github.com/Azure/azure-sdk-for-python/pull/35293/files)
