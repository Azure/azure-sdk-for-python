...
Currently, bulk is not implemented in the Python SDK. You can use the [Concurrency Sample][concurrency_sample] as a reference for the workaround. 
>[WARNING]
> This sample will consume a lot of RUs. It is best to test on the emulator first.
