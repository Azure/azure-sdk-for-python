...
### Features Added
  ...
  - Model `ClusterResourceProperties` added property `subnet_id`
  - Model `ClusterResourceProperties` added property `end_points`
  - Model `ClusterResourceProperties` added property `replication_factor`
  - Model `ClusterResourceProperties` added property `node_count`
  - Model `ClusterResourceProperties` added property `node_sku`
  - Model `ClusterResourceProperties` added property `availability_zone`
  - Model `ClusterResourceProperties` added property `allocation_state`
  ...
  - Model `DatabaseAccountGetResults` added property `throughput_pool_dedicated_r_us`
  - Model `DatabaseAccountGetResults` added property `throughput_pool_max_consumable_r_us`
  - Model `DatabaseAccountUpdateParameters` added property `enable_all_versions_and_deletes_change_feed`
  - Model `ErrorResponseAutoGenerated` added property `error`
  - Model `IndexingPolicy` added property `full_text_indexes`
  - Model `ListClusters` added property `next_link`
  ...
  - Added model `ClusterResourceAutoGenerated`
  - Added model `ClusterResourcePatch`
  - Added model `ClusterResourcePatchProperties`
  - Added model `ClusterResourcePropertiesAutoGenerated`
  - Added model `ClusterResourcePropertiesEndPointsItem`
  ...
  - Added model `ListClustersAutoGenerated`
...
### Breaking Changes
  ...
  - Model `ClusterResource` deleted or renamed its instance variable `identity`
  - Method `ClusterResource.__init__` removed default value `None` from its parameter `location`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `restore_from_backup_id`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `delegated_management_subnet_id`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `cassandra_version`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `cluster_name_override`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `authentication_method`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `initial_cassandra_admin_password`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `prometheus_endpoint`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `repair_enabled`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `auto_replicate`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `client_certificates`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `external_gossip_certificates`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `gossip_certificates`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `external_seed_nodes`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `seed_nodes`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `external_data_centers`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `hours_between_backups`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `deallocated`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `cassandra_audit_logging_enabled`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `backup_schedules`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `scheduled_event_strategy`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `azure_connection_method`
  - Model `ClusterResourceProperties` deleted or renamed its instance variable `private_link_resource_id`
  ...
  - Model `PermissionAutoGenerated` deleted or renamed its instance variable `id`
