...
### Breaking Changes
  ...
  - Method `DatabaseAccountCreateUpdateParameters.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `DatabaseAccountGetResults.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `GremlinDatabaseGetPropertiesResource.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `GremlinDatabaseResource.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `GremlinGraphGetPropertiesResource.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `GremlinGraphResource.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `MongoDBCollectionGetPropertiesResource.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `MongoDBCollectionResource.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `MongoDBDatabaseGetPropertiesResource.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `MongoDBDatabaseResource.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `RestorableSqlContainerPropertiesResourceContainer.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `RestorableSqlDatabasePropertiesResourceDatabase.__init__` parameter `create_mode` changed default value from `None` to `str`
  ...
  - Method `SqlContainerGetPropertiesResource.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `SqlContainerResource.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `SqlDatabaseGetPropertiesResource.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `SqlDatabaseResource.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `TableGetPropertiesResource.__init__` parameter `create_mode` changed default value from `None` to `str`
  - Method `TableResource.__init__` parameter `create_mode` changed default value from `None` to `str`
  ...
  - Deleted or renamed model `MongoClusterListResult`
