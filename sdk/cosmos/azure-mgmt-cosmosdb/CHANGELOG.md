...
### Features Added
  ...
  - Model DatabaseAccountCreateUpdateParameters has a new parameter capacity_mode
  - Model DatabaseAccountGetResults has a new parameter capacity_mode
  - Model DatabaseAccountGetResults has a new parameter capacity_mode_change_transition_state
  - Model DatabaseAccountUpdateParameters has a new parameter capacity_mode
  - Model ErrorResponse has a new parameter error
  - Model ErrorResponseAutoGenerated has a new parameter code
  - Model ErrorResponseAutoGenerated has a new parameter message
...
### Breaking Changes
  ...
  - Model ErrorResponseAutoGenerated no longer has parameter error
  - Removed operation group MongoClustersOperations
