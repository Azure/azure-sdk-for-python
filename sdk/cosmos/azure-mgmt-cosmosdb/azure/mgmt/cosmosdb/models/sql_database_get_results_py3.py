...
class SqlDatabaseGetResults(ARMResourceProperties):
    ...
    def __init__(self, *, sql_database_get_results_id: str, location: str=None, tags=None, _rid: str=None, _ts=None, _etag: str=None, _colls: str=None, _users: str=None, **kwargs) -> None:
