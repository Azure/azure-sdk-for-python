...
class GremlinResourcesOperations:
    ...
    def list_gremlin_databases(
        ...
        if raw:
            header_dict = {}
        deserialized = models.GremlinDatabaseGetResultsPaged(
    ...
    async def create_update_gremlin_database(
        ...
        :return: An instance of GremlinDatabaseGetResults or
         ClientRawResponse<GremlinDatabaseGetResults> if raw==True
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01_preview.models.GremlinDatabaseGetResults
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.GremlinDatabaseGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_gremlin_graphs(
        ...
        if raw:
            header_dict = {}
        deserialized = models.GremlinGraphGetResultsPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def create_update_gremlin_graph(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of GremlinGraphGetResults or
         ClientRawResponse<GremlinGraphGetResults> if raw==True
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01_preview.models.GremlinGraphGetResults
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.GremlinGraphGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
