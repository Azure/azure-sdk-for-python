...
class SqlResourcesOperations:
    ...
    def list_sql_databases(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlDatabaseGetResultsPaged[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlDatabaseGetResults]
        ...
        if raw:
            header_dict = {}
        deserialized = models.SqlDatabaseGetResultsPaged(
    ...
    async def get_sql_database(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlDatabaseGetResults
    ...
    async def create_update_sql_database(
        ...
        :type create_update_sql_database_parameters:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlDatabaseCreateUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of SqlDatabaseGetResults or
         ClientRawResponse<SqlDatabaseGetResults> if raw==True
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlDatabaseGetResults
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlDatabaseGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def update_sql_database_throughput(
        ...
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01_preview.models.ThroughputSettingsGetResults
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.ThroughputSettingsGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_sql_containers(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlContainerGetResultsPaged[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlContainerGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
        ...
        if raw:
            header_dict = {}
        deserialized = models.SqlContainerGetResultsPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def get_sql_container(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlContainerGetResults
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    async def create_update_sql_container(
        ...
        :type create_update_sql_container_parameters:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlContainerCreateUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of SqlContainerGetResults or
         ClientRawResponse<SqlContainerGetResults> if raw==True
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlContainerGetResults
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlContainerGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def delete_sql_container(
    ...
    async def update_sql_container_throughput(
    ...
    def list_sql_stored_procedures(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlStoredProcedureGetResultsPaged[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlStoredProcedureGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
        ...
        if raw:
            header_dict = {}
        deserialized = models.SqlStoredProcedureGetResultsPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def get_sql_stored_procedure(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlStoredProcedureGetResults
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    async def create_update_sql_stored_procedure(
        ...
        :type create_update_sql_stored_procedure_parameters:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlStoredProcedureCreateUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of SqlStoredProcedureGetResults or
         ClientRawResponse<SqlStoredProcedureGetResults> if raw==True
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlStoredProcedureGetResults
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlStoredProcedureGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def delete_sql_stored_procedure(
    ...
    def list_sql_user_defined_functions(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlUserDefinedFunctionGetResultsPaged[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlUserDefinedFunctionGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
        ...
        if raw:
            header_dict = {}
        deserialized = models.SqlUserDefinedFunctionGetResultsPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def get_sql_user_defined_function(
        ...
        :return: SqlUserDefinedFunctionGetResults or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlUserDefinedFunctionGetResults
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    async def create_update_sql_user_defined_function(
        ...
        :type create_update_sql_user_defined_function_parameters:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlUserDefinedFunctionCreateUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of SqlUserDefinedFunctionGetResults or
         ClientRawResponse<SqlUserDefinedFunctionGetResults> if raw==True
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlUserDefinedFunctionGetResults
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlUserDefinedFunctionGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def delete_sql_user_defined_function(
    ...
    def list_sql_triggers(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlTriggerGetResultsPaged[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlTriggerGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
        ...
        if raw:
            header_dict = {}
        deserialized = models.SqlTriggerGetResultsPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def get_sql_trigger(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlTriggerGetResults
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    async def create_update_sql_trigger(
        ...
        :type create_update_sql_trigger_parameters:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlTriggerCreateUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of SqlTriggerGetResults or
         ClientRawResponse<SqlTriggerGetResults> if raw==True
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlTriggerGetResults
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.SqlTriggerGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
