...
class TableResourcesOperations:
    ...
    def list_tables(
        ...
        if raw:
            header_dict = {}
        deserialized = models.TableGetResultsPaged(
    ...
    async def create_update_table(
        ...
        :return: An instance of TableGetResults or
         ClientRawResponse<TableGetResults> if raw==True
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01_preview.models.TableGetResults or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.TableGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
