...
class PrivateEndpointConnectionsOperations:
    ...
    def list_by_database_account(
        ...
        if raw:
            header_dict = {}
        deserialized = models.PrivateEndpointConnectionPaged(
    ...
    async def create_or_update(
        ...
        :return: An instance of PrivateEndpointConnection or
         ClientRawResponse<PrivateEndpointConnection> if raw==True
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01_preview.models.PrivateEndpointConnection
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.PrivateEndpointConnection]
        :raises:
