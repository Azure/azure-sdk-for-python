...
class DatabaseAccountRegionOperations:
    ...
    def list_metrics(
            self, resource_group_name, account_name, region, filter, *, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    list_metrics.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/region/{region}/metrics'}
