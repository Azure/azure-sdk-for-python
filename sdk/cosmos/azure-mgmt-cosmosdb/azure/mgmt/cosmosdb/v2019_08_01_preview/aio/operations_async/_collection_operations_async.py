...
class CollectionOperations:
    ...
    def list_metrics(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.MetricPaged[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.Metric]
        ...
        if raw:
            header_dict = {}
        deserialized = models.MetricPaged(
    ...
    def list_usages(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.UsagePaged[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.Usage]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
    ...
    def list_metric_definitions(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01_preview.models.MetricDefinitionPaged[~azure.mgmt.cosmosdb.v2019_08_01_preview.models.MetricDefinition]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
        ...
        if raw:
            header_dict = {}
        deserialized = models.MetricDefinitionPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
