...
class CollectionPartitionOperations:
    ...
    def list_metrics(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2015_04_01.models.PartitionMetricPaged[~azure.mgmt.cosmosdb.v2015_04_01.models.PartitionMetric]
    ...
    def list_usages(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2015_04_01.models.PartitionUsagePaged[~azure.mgmt.cosmosdb.v2015_04_01.models.PartitionUsage]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
        ...
        if raw:
            header_dict = {}
        deserialized = models.PartitionUsagePaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
