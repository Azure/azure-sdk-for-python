...
class DatabaseAccountsOperations:
    ...
    async def patch(
        ...
        :return: An instance of DatabaseAccount or
         ClientRawResponse<DatabaseAccount> if raw==True
        :rtype: ~~azure.mgmt.cosmosdb.v2015_04_01.models.DatabaseAccount or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2015_04_01.models.DatabaseAccount]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.DatabaseAccountPaged(
    ...
    def list_sql_databases(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SqlDatabasePaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def create_update_sql_database(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of SqlDatabase or ClientRawResponse<SqlDatabase>
         if raw==True
        :rtype: ~~azure.mgmt.cosmosdb.v2015_04_01.models.SqlDatabase or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2015_04_01.models.SqlDatabase]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def update_sql_database_throughput(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of Throughput or ClientRawResponse<Throughput> if
         raw==True
        :rtype: ~~azure.mgmt.cosmosdb.v2015_04_01.models.Throughput or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2015_04_01.models.Throughput]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_sql_containers(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SqlContainerPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def create_update_sql_container(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of SqlContainer or
         ClientRawResponse<SqlContainer> if raw==True
        :rtype: ~~azure.mgmt.cosmosdb.v2015_04_01.models.SqlContainer or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2015_04_01.models.SqlContainer]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_mongo_db_databases(
        ...
        if raw:
            header_dict = {}
        deserialized = models.MongoDBDatabasePaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def create_update_mongo_db_database(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of MongoDBDatabase or
         ClientRawResponse<MongoDBDatabase> if raw==True
        :rtype: ~~azure.mgmt.cosmosdb.v2015_04_01.models.MongoDBDatabase or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2015_04_01.models.MongoDBDatabase]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_mongo_db_collections(
        ...
        if raw:
            header_dict = {}
        deserialized = models.MongoDBCollectionPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def create_update_mongo_db_collection(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of MongoDBCollection or
         ClientRawResponse<MongoDBCollection> if raw==True
        :rtype: ~~azure.mgmt.cosmosdb.v2015_04_01.models.MongoDBCollection or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2015_04_01.models.MongoDBCollection]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_tables(
        ...
        if raw:
            header_dict = {}
        deserialized = models.TablePaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def create_update_table(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of Table or ClientRawResponse<Table> if raw==True
        :rtype: ~~azure.mgmt.cosmosdb.v2015_04_01.models.Table or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2015_04_01.models.Table]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def update_table_throughput(
    ...
    def list_cassandra_keyspaces(
        ...
        if raw:
            header_dict = {}
        deserialized = models.CassandraKeyspacePaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def create_update_cassandra_keyspace(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of CassandraKeyspace or
         ClientRawResponse<CassandraKeyspace> if raw==True
        :rtype: ~~azure.mgmt.cosmosdb.v2015_04_01.models.CassandraKeyspace or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2015_04_01.models.CassandraKeyspace]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_cassandra_tables(
        ...
        if raw:
            header_dict = {}
        deserialized = models.CassandraTablePaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def create_update_cassandra_table(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of CassandraTable or
         ClientRawResponse<CassandraTable> if raw==True
        :rtype: ~~azure.mgmt.cosmosdb.v2015_04_01.models.CassandraTable or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2015_04_01.models.CassandraTable]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_gremlin_databases(
        ...
        if raw:
            header_dict = {}
        deserialized = models.GremlinDatabasePaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def create_update_gremlin_database(
            self, resource_group_name, account_name, database_name, resource, options, *, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of GremlinDatabase or
         ClientRawResponse<GremlinDatabase> if raw==True
        :rtype: ~~azure.mgmt.cosmosdb.v2015_04_01.models.GremlinDatabase or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2015_04_01.models.GremlinDatabase]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def delete_gremlin_database(
            self, resource_group_name, account_name, database_name, *, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    async def update_gremlin_database_throughput(
            self, resource_group_name, account_name, database_name, resource, *, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    def list_gremlin_graphs(
        ...
        if raw:
            header_dict = {}
        deserialized = models.GremlinGraphPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def create_update_gremlin_graph(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of GremlinGraph or
         ClientRawResponse<GremlinGraph> if raw==True
        :rtype: ~~azure.mgmt.cosmosdb.v2015_04_01.models.GremlinGraph or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2015_04_01.models.GremlinGraph]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def delete_gremlin_graph(
    ...
    async def update_gremlin_graph_throughput(
