...
class CassandraResourcesOperations(object):
    ...
    def list_cassandra_keyspaces(
        ...
        if raw:
            header_dict = {}
        deserialized = models.CassandraKeyspaceGetResultsPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def create_update_cassandra_keyspace(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraKeyspaceGetResults]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraKeyspaceGetResults]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_cassandra_tables(
        ...
        if raw:
            header_dict = {}
        deserialized = models.CassandraTableGetResultsPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def create_update_cassandra_table(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraTableGetResults]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraTableGetResults]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
