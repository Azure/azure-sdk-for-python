...
class MongoDBResourcesOperations:
    ...
    def list_mongo_db_databases(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.MongoDBDatabaseGetResultsPaged[~azure.mgmt.cosmosdb.v2019_08_01.models.MongoDBDatabaseGetResults]
        ...
        if raw:
            header_dict = {}
        deserialized = models.MongoDBDatabaseGetResultsPaged(
    ...
    async def get_mongo_db_database(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.MongoDBDatabaseGetResults or
    ...
    async def create_update_mongo_db_database(
        ...
        :type create_update_mongo_db_database_parameters:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.MongoDBDatabaseCreateUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of MongoDBDatabaseGetResults or
         ClientRawResponse<MongoDBDatabaseGetResults> if raw==True
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01.models.MongoDBDatabaseGetResults or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01.models.MongoDBDatabaseGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def _delete_mongo_db_database_initial(
            self, resource_group_name, account_name, database_name, *, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    async def delete_mongo_db_database(
    ...
    async def update_mongo_db_database_throughput(
    ...
    def list_mongo_db_collections(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.MongoDBCollectionGetResultsPaged[~azure.mgmt.cosmosdb.v2019_08_01.models.MongoDBCollectionGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
        ...
        if raw:
            header_dict = {}
        deserialized = models.MongoDBCollectionGetResultsPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def get_mongo_db_collection(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.MongoDBCollectionGetResults or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    async def create_update_mongo_db_collection(
        ...
        :type create_update_mongo_db_collection_parameters:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.MongoDBCollectionCreateUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of MongoDBCollectionGetResults or
         ClientRawResponse<MongoDBCollectionGetResults> if raw==True
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01.models.MongoDBCollectionGetResults
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01.models.MongoDBCollectionGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def _delete_mongo_db_collection_initial(
            self, resource_group_name, account_name, database_name, collection_name, *, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    async def delete_mongo_db_collection(
    ...
    async def update_mongo_db_collection_throughput(
