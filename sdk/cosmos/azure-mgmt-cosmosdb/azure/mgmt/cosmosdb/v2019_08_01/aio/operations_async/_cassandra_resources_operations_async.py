...
class CassandraResourcesOperations:
    ...
    def list_cassandra_keyspaces(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraKeyspaceGetResultsPaged[~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraKeyspaceGetResults]
        ...
        if raw:
            header_dict = {}
        deserialized = models.CassandraKeyspaceGetResultsPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)

        return deserialized
    list_cassandra_keyspaces.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/cassandraKeyspaces'}
    ...
    async def get_cassandra_keyspace(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraKeyspaceGetResults or
        ...
        return deserialized
    get_cassandra_keyspace.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/cassandraKeyspaces/{keyspaceName}'}


    async def _create_update_cassandra_keyspace_initial(
            self, resource_group_name, account_name, keyspace_name, create_update_cassandra_keyspace_parameters, *, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    async def create_update_cassandra_keyspace(
            self, resource_group_name, account_name, keyspace_name, create_update_cassandra_keyspace_parameters, *, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :param keyspace_name: Cosmos DB keyspace name.
        :type keyspace_name: str
        :param create_update_cassandra_keyspace_parameters: The parameters to
         provide for the current Cassandra keyspace.
        :type create_update_cassandra_keyspace_parameters:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraKeyspaceCreateUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of CassandraKeyspaceGetResults or
         ClientRawResponse<CassandraKeyspaceGetResults> if raw==True
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraKeyspaceGetResults
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraKeyspaceGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    create_update_cassandra_keyspace.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/cassandraKeyspaces/{keyspaceName}'}
    ...
    async def delete_cassandra_keyspace(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete_cassandra_keyspace.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/cassandraKeyspaces/{keyspaceName}'}
    ...
    async def _update_cassandra_keyspace_throughput_initial(
            self, resource_group_name, account_name, keyspace_name, update_throughput_parameters, *, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    async def update_cassandra_keyspace_throughput(
            self, resource_group_name, account_name, keyspace_name, update_throughput_parameters, *, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of ThroughputSettingsGetResults or
         ClientRawResponse<ThroughputSettingsGetResults> if raw==True
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01.models.ThroughputSettingsGetResults
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01.models.ThroughputSettingsGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_cassandra_tables(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraTableGetResultsPaged[~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraTableGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
        ...
        if raw:
            header_dict = {}
        deserialized = models.CassandraTableGetResultsPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)

        return deserialized
    list_cassandra_tables.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/cassandraKeyspaces/{keyspaceName}/tables'}
    ...
    async def get_cassandra_table(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraTableGetResults or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        ...
        return deserialized
    get_cassandra_table.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/cassandraKeyspaces/{keyspaceName}/tables/{tableName}'}


    async def _create_update_cassandra_table_initial(
            self, resource_group_name, account_name, keyspace_name, table_name, create_update_cassandra_table_parameters, *, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    async def create_update_cassandra_table(
            self, resource_group_name, account_name, keyspace_name, table_name, create_update_cassandra_table_parameters, *, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :param table_name: Cosmos DB table name.
        :type table_name: str
        :param create_update_cassandra_table_parameters: The parameters to
         provide for the current Cassandra Table.
        :type create_update_cassandra_table_parameters:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraTableCreateUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of CassandraTableGetResults or
         ClientRawResponse<CassandraTableGetResults> if raw==True
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraTableGetResults or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01.models.CassandraTableGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    create_update_cassandra_table.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/cassandraKeyspaces/{keyspaceName}/tables/{tableName}'}
    ...
    async def delete_cassandra_table(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete_cassandra_table.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/cassandraKeyspaces/{keyspaceName}/tables/{tableName}'}
    ...
    async def get_cassandra_table_throughput(
        ...
        return deserialized
    get_cassandra_table_throughput.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/cassandraKeyspaces/{keyspaceName}/tables/{tableName}/throughputSettings/default'}


    async def _update_cassandra_table_throughput_initial(
            self, resource_group_name, account_name, keyspace_name, table_name, update_throughput_parameters, *, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    async def update_cassandra_table_throughput(
            self, resource_group_name, account_name, keyspace_name, table_name, update_throughput_parameters, *, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update_cassandra_table_throughput.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/cassandraKeyspaces/{keyspaceName}/tables/{tableName}/throughputSettings/default'}
