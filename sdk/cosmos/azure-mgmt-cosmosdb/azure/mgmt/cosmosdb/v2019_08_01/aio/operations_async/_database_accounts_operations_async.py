...
class DatabaseAccountsOperations:
    ...
    async def get(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.DatabaseAccountGetResults or
    ...
    async def update(
        ...
        :type update_parameters:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.DatabaseAccountUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of DatabaseAccountGetResults or
         ClientRawResponse<DatabaseAccountGetResults> if raw==True
        :rtype:
         ~~azure.mgmt.cosmosdb.v2019_08_01.models.DatabaseAccountGetResults or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.cosmosdb.v2019_08_01.models.DatabaseAccountGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def create_or_update(
        ...
        :type create_update_parameters:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.DatabaseAccountCreateUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
    ...
    async def failover_priority_change(
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.DatabaseAccountGetResultsPaged[~azure.mgmt.cosmosdb.v2019_08_01.models.DatabaseAccountGetResults]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.DatabaseAccountGetResultsPaged(
    ...
    async def list_keys(
        ...
        :return: DatabaseAccountListKeysResult or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.DatabaseAccountListKeysResult
    ...
    async def list_connection_strings(
        ...
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.DatabaseAccountListConnectionStringsResult
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    async def offline_region(
        ...
        :rtype: ~None or ~msrest.pipeline.ClientRawResponse[None]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.cosmosdb.v2019_08_01.models.ErrorResponseException>`
        """
    ...
    async def get_read_only_keys(
        ...
        :return: DatabaseAccountListReadOnlyKeysResult or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.cosmosdb.v2019_08_01.models.DatabaseAccountListReadOnlyKeysResult
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
