...
class PrivateEndpointConnectionsOperations:
    ...
    def list_by_database_account(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdb.models.PrivateEndpointConnectionListResult]
    ...
    async def get(
        ...
        **kwargs
    ) -> "models.PrivateEndpointConnectionAutoGenerated":
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PrivateEndpointConnectionAutoGenerated, or the result of cls(response)
        :rtype: ~azure.mgmt.cosmosdb.models.PrivateEndpointConnectionAutoGenerated
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PrivateEndpointConnectionAutoGenerated"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        deserialized = self._deserialize('PrivateEndpointConnectionAutoGenerated', pipeline_response)
    ...
    async def _create_or_update_initial(
        ...
        account_name: str,
        private_endpoint_connection_name: str,
        parameters: "models.PrivateEndpointConnectionAutoGenerated",
        **kwargs
    ) -> Optional["models.PrivateEndpointConnectionAutoGenerated"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.PrivateEndpointConnectionAutoGenerated"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        body_content = self._serialize.body(parameters, 'PrivateEndpointConnectionAutoGenerated')
    ...
    async def begin_create_or_update(
        ...
        parameters: "models.PrivateEndpointConnectionAutoGenerated",
        **kwargs
    ) -> AsyncLROPoller["models.PrivateEndpointConnectionAutoGenerated"]:
        ...
        :type private_endpoint_connection_name: str
        :param parameters:
        :type parameters: ~azure.mgmt.cosmosdb.models.PrivateEndpointConnectionAutoGenerated
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either PrivateEndpointConnectionAutoGenerated or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cosmosdb.models.PrivateEndpointConnectionAutoGenerated]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
