...
class RestorableTablesOperations:
    """RestorableTablesOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :param start_time: Restorable Tables event feed start time.
        :type start_time: str
        :param end_time: Restorable Tables event feed end time.
        :type end_time: str
