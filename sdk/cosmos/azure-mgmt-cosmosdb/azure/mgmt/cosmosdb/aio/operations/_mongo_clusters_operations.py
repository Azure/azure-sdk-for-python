...
from ...operations._mongo_clusters_operations import (
    build_check_name_availability_request,
    build_create_or_update_firewall_rule_request,
    build_create_or_update_request,
    build_delete_firewall_rule_request,
    build_delete_request,
    build_get_firewall_rule_request,
    build_get_request,
    build_list_by_resource_group_request,
    build_list_connection_strings_request,
    build_list_firewall_rules_request,
    build_list_request,
...
class MongoClustersOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.MongoCluster"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdb.models.MongoCluster]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either MongoCluster or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cosmosdb.models.MongoCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _create_or_update_firewall_rule_initial(
        self,
        resource_group_name: str,
        mongo_cluster_name: str,
    ...
    @overload
    async def begin_create_or_update_firewall_rule(
        self,
        resource_group_name: str,
        mongo_cluster_name: str,
        firewall_rule_name: str,
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either FirewallRule or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cosmosdb.models.FirewallRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update_firewall_rule(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._create_or_update_firewall_rule_initial(
                resource_group_name=resource_group_name,
                mongo_cluster_name=mongo_cluster_name,
                firewall_rule_name=firewall_rule_name,
                parameters=parameters,
    ...
    async def _delete_firewall_rule_initial(  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace_async
    async def begin_delete_firewall_rule(
        self, resource_group_name: str, mongo_cluster_name: str, firewall_rule_name: str, **kwargs: Any
    ) -> AsyncLROPoller[None]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._delete_firewall_rule_initial(  # type: ignore
                resource_group_name=resource_group_name,
                mongo_cluster_name=mongo_cluster_name,
                firewall_rule_name=firewall_rule_name,
                api_version=api_version,
    ...
    def list_firewall_rules(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdb.models.FirewallRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
