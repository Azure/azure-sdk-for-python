...
def build_create_update_cassandra_keyspace_request_initial(
    ...
    keyspace_name: str,
    *,
    json: Optional[_models.CassandraKeyspaceCreateUpdateParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_create_update_cassandra_table_request_initial(
    ...
    table_name: str,
    *,
    json: Optional[_models.CassandraTableCreateUpdateParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_create_update_cassandra_view_request_initial(
    ...
    view_name: str,
    *,
    json: Optional[_models.CassandraViewCreateUpdateParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class CassandraResourcesOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_create_update_cassandra_keyspace(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._create_update_cassandra_keyspace_initial(  # type: ignore
                resource_group_name=resource_group_name,
                account_name=account_name,
                keyspace_name=keyspace_name,
    ...
    def begin_update_cassandra_keyspace_throughput(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._update_cassandra_keyspace_throughput_initial(  # type: ignore
                resource_group_name=resource_group_name,
                account_name=account_name,
                keyspace_name=keyspace_name,
    ...
    def begin_migrate_cassandra_keyspace_to_autoscale(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._migrate_cassandra_keyspace_to_autoscale_initial(  # type: ignore
                resource_group_name=resource_group_name,
                account_name=account_name,
                keyspace_name=keyspace_name,
                api_version=api_version,
    ...
    def begin_migrate_cassandra_keyspace_to_manual_throughput(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._migrate_cassandra_keyspace_to_manual_throughput_initial(  # type: ignore
                resource_group_name=resource_group_name,
                account_name=account_name,
                keyspace_name=keyspace_name,
                api_version=api_version,
    ...
    def begin_migrate_cassandra_table_to_manual_throughput(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._migrate_cassandra_table_to_manual_throughput_initial(  # type: ignore
                resource_group_name=resource_group_name,
                account_name=account_name,
                keyspace_name=keyspace_name,
                table_name=table_name,
    ...
    def begin_create_update_cassandra_view(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._create_update_cassandra_view_initial(  # type: ignore
                resource_group_name=resource_group_name,
                account_name=account_name,
                keyspace_name=keyspace_name,
                view_name=view_name,
    ...
    def begin_migrate_cassandra_view_to_manual_throughput(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._migrate_cassandra_view_to_manual_throughput_initial(  # type: ignore
                resource_group_name=resource_group_name,
                account_name=account_name,
                keyspace_name=keyspace_name,
                view_name=view_name,
