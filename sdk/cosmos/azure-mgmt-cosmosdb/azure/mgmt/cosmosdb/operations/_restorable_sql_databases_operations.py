...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableSqlDatabases")  # pylint: disable=line-too-long
...
class RestorableSqlDatabasesOperations(object):
    ...
    def list(
        ...
        instance_id: str,
        **kwargs: Any
    ) -> Iterable["_models.RestorableSqlDatabasesListResult"]:
        ...
        :return: An iterator like instance of either RestorableSqlDatabasesListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.cosmosdb.models.RestorableSqlDatabasesListResult]
