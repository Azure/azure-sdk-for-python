...
def build_list_request(
    ...
    **kwargs: Any
    ...
    if restorable_sql_database_rid is not None:
        _params["restorableSqlDatabaseRid"] = _SERIALIZER.query(
            "restorable_sql_database_rid", restorable_sql_database_rid, "str"
        )
...
class RestorableSqlContainersOperations:
    ...
    def list(
        ...
        end_time: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.RestorableSqlContainerGetResult"]:
