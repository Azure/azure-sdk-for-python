...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableSqlContainers')
    ...
    if restorable_sql_database_rid is not None:
        query_parameters['restorableSqlDatabaseRid'] = _SERIALIZER.query("restorable_sql_database_rid", restorable_sql_database_rid, 'str')
...
class RestorableSqlContainersOperations(object):
    ...
    def list(
        ...
        end_time: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.RestorableSqlContainersListResult"]:
        ...
        :param start_time: Restorable Sql containers event feed start time.
        :type start_time: str
        :param end_time: Restorable Sql containers event feed end time.
        :type end_time: str
