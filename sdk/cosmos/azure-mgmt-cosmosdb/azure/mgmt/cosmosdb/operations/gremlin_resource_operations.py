...
class GremlinResourceOperations(object):
    """GremlinResourceOperations operations.
    ...
    def get_gremlin_database_throughput(
        ...
        return deserialized
    get_gremlin_database_throughput.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/gremlinDatabases/{databaseName}/settings/throughput'}
    ...
    def update_gremlin_database_throughput(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    update_gremlin_database_throughput.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/gremlinDatabases/{databaseName}/settings/throughput'}
