...
def build_get_gremlin_role_assignment_request(  # pylint: disable=name-too-long
...
def build_create_update_gremlin_role_assignment_request(  # pylint: disable=name-too-long
    resource_group_name: str, account_name: str, role_assignment_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_gremlin_role_assignment_request(  # pylint: disable=name-too-long
    resource_group_name: str, account_name: str, role_assignment_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class GremlinResourcesOperations:  # pylint: disable=too-many-public-methods
    ...
    def get_gremlin_role_assignment(
        ...
        """Retrieves the properties of an existing Azure Cosmos DB Gremlin Role Assignment with the given
        Id.
        ...
        :return: GremlinRoleAssignmentResource or the result of cls(response)
        :rtype: ~azure.mgmt.cosmosdb.models.GremlinRoleAssignmentResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.GremlinRoleAssignmentResource] = kwargs.pop("cls", None)

        _request = build_get_gremlin_role_assignment_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
    ...
    def _create_update_gremlin_role_assignment_initial(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        account_name: str,
        role_assignment_id: str,
        create_update_gremlin_role_assignment_parameters: Union[_models.GremlinRoleAssignmentResource, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(create_update_gremlin_role_assignment_parameters, (IOBase, bytes)):
            _content = create_update_gremlin_role_assignment_parameters
        else:
            _json = self._serialize.body(
                create_update_gremlin_role_assignment_parameters, "GremlinRoleAssignmentResource"
            )

        _request = build_create_update_gremlin_role_assignment_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
            role_assignment_id=role_assignment_id,
            subscription_id=self._config.subscription_id,
    ...
    @overload
    def begin_create_update_gremlin_role_assignment(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        account_name: str,
        role_assignment_id: str,
        create_update_gremlin_role_assignment_parameters: _models.GremlinRoleAssignmentResource,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.GremlinRoleAssignmentResource]:
        ...
        :param role_assignment_id: The GUID for the Role Assignment. Required.
        :type role_assignment_id: str
        :param create_update_gremlin_role_assignment_parameters: The properties required to create or
         update a Role Assignment. Required.
        :type create_update_gremlin_role_assignment_parameters:
         ~azure.mgmt.cosmosdb.models.GremlinRoleAssignmentResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GremlinRoleAssignmentResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.cosmosdb.models.GremlinRoleAssignmentResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_update_gremlin_role_assignment(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :param create_update_gremlin_role_assignment_parameters: The properties required to create or
         update a Role Assignment. Required.
        :type create_update_gremlin_role_assignment_parameters: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GremlinRoleAssignmentResource or the
    ...
    def begin_create_update_gremlin_role_assignment(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :type role_assignment_id: str
        :param create_update_gremlin_role_assignment_parameters: The properties required to create or
         update a Role Assignment. Is either a GremlinRoleAssignmentResource type or a IO[bytes] type.
         Required.
        :type create_update_gremlin_role_assignment_parameters:
         ~azure.mgmt.cosmosdb.models.GremlinRoleAssignmentResource or IO[bytes]
        :return: An instance of LROPoller that returns either GremlinRoleAssignmentResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.cosmosdb.models.GremlinRoleAssignmentResource]
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._create_update_gremlin_role_assignment_initial(
                resource_group_name=resource_group_name,
                account_name=account_name,
                role_assignment_id=role_assignment_id,
                create_update_gremlin_role_assignment_parameters=create_update_gremlin_role_assignment_parameters,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x, y, z: x,
                headers=_headers,
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.GremlinRoleAssignmentResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
    ...
    def _delete_gremlin_role_assignment_initial(
        self, resource_group_name: str, account_name: str, role_assignment_id: str, **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_delete_gremlin_role_assignment(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._delete_gremlin_role_assignment_initial(
                resource_group_name=resource_group_name,
                account_name=account_name,
                role_assignment_id=role_assignment_id,
                api_version=api_version,
