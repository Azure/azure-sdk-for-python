...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableGraphs")  # pylint: disable=line-too-long
    ...
    if restorable_gremlin_database_rid is not None:
        _query_parameters['restorableGremlinDatabaseRid'] = _SERIALIZER.query("restorable_gremlin_database_rid", restorable_gremlin_database_rid, 'str')
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either RestorableGremlinGraphsListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.cosmosdb.models.RestorableGremlinGraphsListResult]
