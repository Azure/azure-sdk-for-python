...
class PrivateLinkResourcesOperations(object):
    ...
    def list_by_account(
        ...
        :return: PrivateLinkResourceListResult or ClientRawResponse if
         raw=true
        :rtype: ~azure.mgmt.cosmosdb.models.PrivateLinkResourceListResult or
        ...
        return deserialized
    list_by_account.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/privateLinkResources'}
