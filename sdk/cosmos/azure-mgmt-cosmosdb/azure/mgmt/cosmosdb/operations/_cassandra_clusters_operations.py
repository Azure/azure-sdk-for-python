...
def build_create_update_request_initial(
    ...
    cluster_name: str,
    *,
    json: Optional[_models.ClusterResource] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_invoke_command_request_initial(
    ...
    cluster_name: str,
    *,
    json: Optional[_models.CommandPostBody] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class CassandraClustersOperations:
    ...
    def begin_create_update(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._create_update_initial(  # type: ignore
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                body=body,
                api_version=api_version,
    ...
    def begin_invoke_command(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._invoke_command_initial(  # type: ignore
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                body=body,
                api_version=api_version,
