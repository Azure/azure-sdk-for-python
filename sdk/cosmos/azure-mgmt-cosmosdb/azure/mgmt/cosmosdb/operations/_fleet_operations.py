...
def build_create_request(resource_group_name: str, fleet_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(resource_group_name: str, fleet_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_request(resource_group_name: str, fleet_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class FleetOperations:
    ...
    def list(self, **kwargs: Any) -> ItemPaged["_models.FleetResource"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.cosmosdb.models.FleetResource]
    ...
    @distributed_trace
    def get(self, resource_group_name: str, fleet_name: str, **kwargs: Any) -> _models.FleetResource:
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.cosmosdb.models.FleetResource
    ...
    @distributed_trace
    def create(
        self, resource_group_name: str, fleet_name: str, body: Union[_models.FleetResource, IO[bytes]], **kwargs: Any
    ) -> _models.FleetResource:
        """Creates an Azure Cosmos DB fleet under a subscription.
        ...
        :param fleet_name: Cosmos DB fleet name. Needs to be unique under a subscription. Required.
        :type fleet_name: str
        :param body: The parameters to provide for the current fleet. Is either a FleetResource type or
         a IO[bytes] type. Required.
        :type body: ~azure.mgmt.cosmosdb.models.FleetResource or IO[bytes]
        :return: FleetResource or the result of cls(response)
        :rtype: ~azure.mgmt.cosmosdb.models.FleetResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "FleetResource")
