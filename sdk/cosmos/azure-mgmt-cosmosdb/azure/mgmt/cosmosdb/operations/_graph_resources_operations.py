...
def build_list_graphs_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/graphs")  # pylint: disable=line-too-long
...
def build_get_graph_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/graphs/{graphName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "accountName": _SERIALIZER.url("account_name", account_name, 'str', max_length=50, min_length=3, pattern=r'^[a-z0-9]+(-[a-z0-9]+)*'),
...
def build_create_update_graph_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    graph_name: str,
...
def build_delete_graph_resource_request_initial(
    subscription_id: str,
    resource_group_name: str,
    account_name: str,
    graph_name: str,
...
class GraphResourcesOperations(object):
    ...
    def list_graphs(
        ...
        account_name: str,
        **kwargs: Any
    ) -> Iterable["_models.GraphResourcesListResult"]:
        ...
        :return: An iterator like instance of either GraphResourcesListResult or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.cosmosdb.models.GraphResourcesListResult]
    ...
    def _create_update_graph_initial(
        ...
        **kwargs: Any
        ...
        request = build_create_update_graph_request_initial(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            account_name=account_name,
            graph_name=graph_name,
    ...
    def _delete_graph_resource_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_delete_graph_resource_request_initial(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            account_name=account_name,
            graph_name=graph_name,
    ...
    @distributed_trace
    def begin_delete_graph_resource(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        graph_name: str,
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._delete_graph_resource_initial(
                resource_group_name=resource_group_name,
                account_name=account_name,
                graph_name=graph_name,
                api_version=api_version,
