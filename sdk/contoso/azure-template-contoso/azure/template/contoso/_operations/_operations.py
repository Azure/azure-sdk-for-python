...
from .._vendor import ContosoClientMixinABC, _format_url_section
...
def build_contoso_get_widget_request(widget_name: str, **kwargs: Any) -> HttpRequest:
...
def build_contoso_get_widget_operation_status_request(
...
def build_contoso_create_or_update_widget_request(widget_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_contoso_delete_widget_request(widget_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_contoso_list_widgets_request(
...
class ContosoClientOperationsMixin(ContosoClientMixinABC):
    ...
    def begin_create_or_update_widget(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns Widget. The Widget is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.template.contoso.models.Widget]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _delete_widget_initial(self, widget_name: str, **kwargs: Any) -> _models.OperationStatusError:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def begin_delete_widget(self, widget_name: str, **kwargs: Any) -> LROPoller[_models.OperationStatusError]:
        ...
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no
         Retry-After header is present.
        :return: An instance of LROPoller that returns OperationStatusError. The OperationStatusError
         is compatible with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.template.contoso.models.OperationStatusError]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_widgets(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.template.contoso.models.Widget]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
