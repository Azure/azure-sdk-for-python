...
def build_create_schema_request(
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
...
def build_purge_schema_request(
    kind,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
...
class SchemaOperations(object):
    ...
    @distributed_trace
    def create_schema(  # pylint: disable=inconsistent-return-statements
        self,
    ...
    @distributed_trace
    def purge_schema(  # pylint: disable=inconsistent-return-statements
        self,
        data_partition_id,  # type: str
        frame_of_reference,  # type: str
        kind,  # type: str
