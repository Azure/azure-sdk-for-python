...
from ...operations._pub_sub_operations import build_change_legal_tag_request
T = TypeVar('T')
...
class PubSubOperations:
    ...
    async def change_legal_tag(
        ...
        **kwargs: Any
        ...
        request = build_change_legal_tag_request(
            data_partition_id=data_partition_id,
            frame_of_reference=frame_of_reference,
            template_url=self.change_legal_tag.metadata['url'],
            headers=_headers,
            params=_params,
        )
    ...
    change_legal_tag.metadata = {'url': "/api/storage/v2/push-handlers/legaltag-changed"}  # type: ignore
