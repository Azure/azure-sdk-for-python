...
from ...operations._info_operations import build_get_storage_details_request
T = TypeVar('T')
...
class InfoOperations:
    ...
    async def get_storage_details(
        ...
        **kwargs: Any
        ...
        request = build_get_storage_details_request(
            data_partition_id=data_partition_id,
            frame_of_reference=frame_of_reference,
            template_url=self.get_storage_details.metadata['url'],
            headers=_headers,
            params=_params,
        )
    ...
    get_storage_details.metadata = {'url': "/api/storage/v2/info"}  # type: ignore
