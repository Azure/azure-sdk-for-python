...
def sample_hello_world():
    ...
    #     "query": "*"
    # }, data_partition_id='bvtstglf7zn1c-testdata', account_id='none')
    #
    #
    client.query_with_cursor(body={
        "kind": "osdu:wks:master-data--Well:*",
        "query": "*"
    }, data_partition_id='bvtstglf7zn1c-testdata', account_id='none')
    ...
    # client.liveness_check_using_get(data_partition_id='bvtstglf7zn1c-testdata')
    # client.get_legal_tag_using_get(name='bvtstglf7zn1c-testdata-R3FullManifest-Legal-Tag-Test7116545', data_partition_id='bvtstglf7zn1c-testdata')
    # client.create_legal_tag_using_post(body={
    #     "name": "bvtstglf7zn1c-testdata-R3FullManifest-Legal-Tag-Test7116545",
    ...
    #     }
    # },data_partition_id='bvtstglf7zn1c-testdata' )
    # client.liveness_check_using_get(data_partition_id='bvtstglf7zn1c-testdata')
    # client.get_workflow_by_name_using_get(workflow_name='Osdu_ingest', data_partition_id='bvtstglf7zn1c-testdata')
    # client.get_all_workflows_for_tenant_using_get(data_partition_id='bvtstglf7zn1c-testdata')
