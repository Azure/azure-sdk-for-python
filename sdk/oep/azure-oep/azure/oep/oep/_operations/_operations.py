...
def build_liveness_check_using_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/api/search/v2/health/liveness_check"
...
def build_readiness_check_using_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/api/search/v2/health/readiness_check"
...
def build_ccs_query_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/api/search/v2/ccs/query"

    # Construct headers
    _headers['account-id'] = _SERIALIZER.header("account_id", account_id, 'str')
    _headers['data-partition-id'] = _SERIALIZER.header("data_partition_id", data_partition_id, 'str')
    if on_behalf_of is not None:
        _headers['on-behalf-of'] = _SERIALIZER.header("on_behalf_of", on_behalf_of, 'str')
...
def build_query_with_cursor_request(
    *,
    account_id: str,
    data_partition_id: str,
    json: Optional[JSON] = None,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/api/search/v2/query_with_cursor"
