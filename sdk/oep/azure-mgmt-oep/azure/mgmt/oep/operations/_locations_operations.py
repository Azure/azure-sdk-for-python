...
def build_check_name_availability_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.OpenEnergyPlatform/checkNameAvailability')
...
class LocationsOperations(object):
    ...
    def check_name_availability(
        self,
        body,  # type: "_models.CheckNameAvailabilityRequest"
        **kwargs  # type: Any
    ):
        ...
        :type body: ~open_energy_platform_management_service_apis.models.CheckNameAvailabilityRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CheckNameAvailabilityResponse, or the result of cls(response)
        :rtype: ~open_energy_platform_management_service_apis.models.CheckNameAvailabilityResponse
