...
def build_list_request(
    **kwargs: Any
    ...
    api_version = kwargs.pop('api_version', "2022-04-04-preview")  # type: str

    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.OpenEnergyPlatform/operations")
...
class Operations(object):
    ...
    :type models: ~azure.mgmt.oep.models
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.oep.models.OperationListResult
