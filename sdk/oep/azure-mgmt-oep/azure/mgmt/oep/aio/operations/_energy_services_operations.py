...
from ...operations._energy_services_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_update_request
T = TypeVar('T')
...
class EnergyServicesOperations:
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~open_energy_platform_management_service_apis.models.EnergyServiceList]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either EnergyService or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~open_energy_platform_management_service_apis.models.EnergyService]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
