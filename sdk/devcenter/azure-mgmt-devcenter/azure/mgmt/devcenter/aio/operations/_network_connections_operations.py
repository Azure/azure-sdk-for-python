...
from ...operations._network_connections_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_health_details_request, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_list_health_details_request, build_run_health_checks_request, build_update_request_initial
T = TypeVar('T')
...
class NetworkConnectionsOperations:
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
    ) -> AsyncIterable[_models.NetworkConnectionListResult]:
        ...
        :return: An iterator like instance of either NetworkConnectionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.devcenter.models.NetworkConnectionListResult]
    ...
    def list_health_details(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either HealthCheckStatusDetailsListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.devcenter.models.HealthCheckStatusDetailsListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
