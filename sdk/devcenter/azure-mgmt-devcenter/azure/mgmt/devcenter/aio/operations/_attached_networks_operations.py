...
from ...operations._attached_networks_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_by_dev_center_request, build_get_by_project_request, build_list_by_dev_center_request, build_list_by_project_request
T = TypeVar('T')
...
class AttachedNetworksOperations:
    ...
    def list_by_project(
        ...
        **kwargs: Any
    ) -> AsyncIterable[_models.AttachedNetworkListResult]:
        ...
        :return: An iterator like instance of either AttachedNetworkListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.devcenter.models.AttachedNetworkListResult]
