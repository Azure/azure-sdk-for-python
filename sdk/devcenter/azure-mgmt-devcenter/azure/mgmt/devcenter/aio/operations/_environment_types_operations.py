...
from ...operations._environment_types_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_dev_center_request, build_update_request
T = TypeVar('T')
    ...
    def list_by_dev_center(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either EnvironmentTypeListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.devcenter.models.EnvironmentTypeListResult]
