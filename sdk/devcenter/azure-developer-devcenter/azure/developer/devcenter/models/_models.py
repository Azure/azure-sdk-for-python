...
class CloudError(_model_base.Model):
    ...
    :ivar error: Error body. Required.
    :vartype error: ~azure.developer.devcenter.models.CloudErrorBody
    """

    error: "_models.CloudErrorBody" = rest_field()
    """Error body. Required."""
...
class CloudErrorBody(_model_base.Model):
    """An error response from the service.
    ...
    :vartype details: list[~azure.developer.devcenter.models.CloudErrorBody]
    """
...
class DevBox(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    """A unique identifier for the Dev Box. This is a GUID-formatted string (e.g.
     00000000-0000-0000-0000-000000000000)."""
    error: Optional["_models.CloudErrorBody"] = rest_field(visibility=["read"])
...
class DevBoxActionDelayResult(_model_base.Model):
    ...
    """The delayed action."""
    error: Optional["_models.CloudErrorBody"] = rest_field()
