...
class DevBoxesClientOperationsMixin(DevBoxesClientMixinABC):  # pylint: disable=too-many-public-methods
    ...
    async def begin_create_dev_box(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.ErrorResponseDevBox]:
        ...
        :return: An instance of AsyncLROPoller that returns ErrorResponseDevBox. The
         ErrorResponseDevBox is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.developer.devcenter.models.ErrorResponseDevBox]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_dev_box(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.ErrorResponseDevBox].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ErrorResponseDevBox](
...
class DeploymentEnvironmentsClientOperationsMixin(  # pylint: disable=name-too-long
    ...
    async def begin_create_or_update_environment(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.ErrorResponseEnvironment]:
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns ErrorResponseEnvironment. The
         ErrorResponseEnvironment is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.developer.devcenter.models.ErrorResponseEnvironment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update_environment(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.ErrorResponseEnvironment].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
