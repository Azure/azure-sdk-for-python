...
def patch_sdk():
    ...
    async def legacy_get_update(self, provider, name, version, *, if_none_match=None, **kwargs):
        return await get_update(self, provider, name, version, **_conditional_kwargs(if_none_match, kwargs))

    async def legacy_get_file(self, provider, name, version, file_id, *, if_none_match=None, **kwargs):
        return await get_file(self, provider, name, version, file_id, **_conditional_kwargs(if_none_match, kwargs))

    async def legacy_get_update_operation(self, operation_id, *, if_none_match=None, **kwargs):
        return await get_update_operation(self, operation_id, **_conditional_kwargs(if_none_match, kwargs))
    ...
    async def legacy_get_management_operation(self, operation_id, *, if_none_match=None, **kwargs):
        return await get_management_operation(self, operation_id, **_conditional_kwargs(if_none_match, kwargs))

    setattr(management_operations, "get_operation", legacy_get_management_operation)

    async def legacy_collect_logs(self, operation_id, log_collection_request, **kwargs):
        return await collect_logs(self, operation_id, log_collection_request, **kwargs)

    async def legacy_get_log_collection(self, operation_id, **kwargs):
        return await get_log_collection(self, operation_id, **kwargs)

    async def legacy_get_log_collection_status(self, operation_id, **kwargs):
        return await get_log_collection_status(self, operation_id, **kwargs)
    ...
    list_device_class_subgroups = management_operations.list_device_class_subgroups_for_group
    ...
    management_operations.list_device_class_subgroups_for_group = legacy_list_device_class_subgroups

    async def legacy_list_device_health(self, *, filter, **kwargs):
