...
class InstancesOperations:
    ...
    def list_by_account(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~deviceupdate.models.Instance]
    ...
    async def get(
        ...
        :rtype: ~deviceupdate.models.Instance
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type instance: ~deviceupdate.models.Instance
        ...
        :return: An instance of AsyncLROPoller that returns either Instance or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~deviceupdate.models.Instance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type instance: ~deviceupdate.models.Instance or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type tag_update_payload: ~deviceupdate.models.TagUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type tag_update_payload: ~deviceupdate.models.TagUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
