...
class AccountsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~deviceupdate.aio.DeviceUpdate`'s
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.Account"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~deviceupdate.models.Account]
    ...
    @distributed_trace_async
    async def head(self, resource_group_name: str, account_name: str, **kwargs: Any) -> bool:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Account or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~deviceupdate.models.Account]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
