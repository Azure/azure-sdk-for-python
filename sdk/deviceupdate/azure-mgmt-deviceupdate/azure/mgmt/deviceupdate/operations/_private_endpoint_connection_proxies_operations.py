...
class PrivateEndpointConnectionProxiesOperations:
    ...
    def list_by_account(
        ...
        :return: An iterator like instance of either PrivateEndpointConnectionProxy or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~deviceupdate.models.PrivateEndpointConnectionProxy]
    ...
    def validate(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type private_endpoint_connection_proxy: ~deviceupdate.models.PrivateEndpointConnectionProxy
    ...
    def validate(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type private_endpoint_connection_proxy: ~deviceupdate.models.PrivateEndpointConnectionProxy or
         IO
        ...
        _json = None
        _content = None
        if isinstance(private_endpoint_connection_proxy, (IO, bytes)):
    ...
    def update_private_endpoint_properties(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param private_endpoint_update: The parameters for updating a private endpoint connection
         proxy. Required.
        :type private_endpoint_update: ~deviceupdate.models.PrivateEndpointUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update_private_endpoint_properties(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type private_endpoint_update: ~deviceupdate.models.PrivateEndpointUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        _json = None
        _content = None
        if isinstance(private_endpoint_update, (IO, bytes)):
    ...
    def get(
        ...
        :rtype: ~deviceupdate.models.PrivateEndpointConnectionProxy
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~deviceupdate.models.PrivateEndpointConnectionProxy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
