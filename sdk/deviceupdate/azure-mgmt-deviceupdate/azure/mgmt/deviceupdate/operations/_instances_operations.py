...
def build_get_request(
    resource_group_name: str, account_name: str, instance_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class InstancesOperations:
    ...
    def list_by_account(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~deviceupdate.models.Instance]
    ...
    @distributed_trace
    def get(self, resource_group_name: str, account_name: str, instance_name: str, **kwargs: Any) -> _models.Instance:
    ...
    @distributed_trace
    def head(self, resource_group_name: str, account_name: str, instance_name: str, **kwargs: Any) -> bool:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~deviceupdate.models.Instance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
