...
class AccountsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.Account"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~deviceupdate.models.Account]
    ...
    def get(self, resource_group_name: str, account_name: str, **kwargs: Any) -> _models.Account:
        ...
        :rtype: ~deviceupdate.models.Account
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type account: ~deviceupdate.models.Account
        ...
        :rtype: ~azure.core.polling.LROPoller[~deviceupdate.models.Account]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        :type account: ~deviceupdate.models.Account or IO
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type account_update_payload: ~deviceupdate.models.AccountUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type account_update_payload: ~deviceupdate.models.AccountUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
