...
from azure.mgmt.workloads.sapvirtualinstance import WorkloadsSapVirtualInstanceMgmtClient
...
# USAGE
    python sap_application_server_instances_stop_instance_with_infra_operations.py
