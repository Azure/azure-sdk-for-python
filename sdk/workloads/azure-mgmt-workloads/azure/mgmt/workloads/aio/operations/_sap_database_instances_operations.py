...
class SAPDatabaseInstancesOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :param database_instance_name: Database Instance string modeled as parameter for auto
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        """Puts the SAP Database Instance. :code:`<br>`:code:`<br>`This will be used by service only. PUT
        ...
        :param database_instance_name: Database Instance string modeled as parameter for auto
         generation to work correctly.
        :type database_instance_name: str
        :param body: The SAP Database Server instance request body. Default value is None.
        :type body: ~azure.mgmt.workloads.models.SAPDatabaseInstance
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type database_instance_name: str
        :param body: The SAP Database Server instance request body. Default value is None.
        :type body: ~azure.mgmt.workloads.models.UpdateSAPDatabaseInstanceRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
    ...
    async def begin_delete(
        ...
        **kwargs: Any
        ...
        """Deletes the SAP Database Instance. :code:`<br>`:code:`<br>`This will be used by service only.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :type sap_virtual_instance_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either SAPDatabaseInstanceList or the result of
         cls(response)
        :rtype:
