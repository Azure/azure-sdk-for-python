...
class SAPDatabaseInstancesOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :code:`<br>`:code:`<br>`This will be used by service only. PUT by end user will return a Bad
        Request error.
    ...
    async def begin_delete(
        ...
        :code:`<br>`:code:`<br>`This will be used by service only. Delete by end user will return a Bad
        Request error.
