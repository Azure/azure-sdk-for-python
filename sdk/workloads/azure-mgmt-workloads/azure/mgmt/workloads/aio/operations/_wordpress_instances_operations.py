...
class WordpressInstancesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either WordpressInstanceResourceList or the result of
         cls(response)
        :rtype:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param php_workload_name: Php workload name.
        :type php_workload_name: str
        :param wordpress_instance_resource: Resource create or update request payload.
    ...
    delete.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/phpWorkloads/{phpWorkloadName}/wordpressInstances/default"}  # type: ignore
