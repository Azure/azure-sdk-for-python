...
class WordpressInstancesOperations:
    ...
    def list(
    ...
    ) -> Iterable["_models.WordpressInstanceResource"]:
        ...
        :return: An iterator like instance of either WordpressInstanceResource or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.workloads.models.WordpressInstanceResource]
    ...
    @distributed_trace
    def get(self, resource_group_name: str, php_workload_name: str, **kwargs: Any) -> _models.WordpressInstanceResource:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either WordpressInstanceResource or the result
         of cls(response)
