...
def build_get_request(
    resource_group_name: str, php_workload_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "phpWorkloadName": _SERIALIZER.url("php_workload_name", php_workload_name, "str"),
    }
...
class PhpWorkloadsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.PhpWorkloadResource"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.workloads.models.PhpWorkloadResource]
    ...
    ) -> Iterable["_models.PhpWorkloadResource"]:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, php_workload_name: str, **kwargs: Any) -> _models.PhpWorkloadResource:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either PhpWorkloadResource or the result of
         cls(response)
