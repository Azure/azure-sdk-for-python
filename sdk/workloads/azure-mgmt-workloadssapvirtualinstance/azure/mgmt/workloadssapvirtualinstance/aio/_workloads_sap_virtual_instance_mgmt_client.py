...
class WorkloadsSapVirtualInstanceMgmtClient(
    ...
    :vartype sap_virtual_instances:
     azure.mgmt.workloads.sapvirtualinstance.aio.operations.SAPVirtualInstancesOperations
    :ivar sap_central_instances: SAPCentralInstancesOperations operations
    :vartype sap_central_instances:
     azure.mgmt.workloads.sapvirtualinstance.aio.operations.SAPCentralInstancesOperations
    :ivar sap_database_instances: SAPDatabaseInstancesOperations operations
    :vartype sap_database_instances:
     azure.mgmt.workloads.sapvirtualinstance.aio.operations.SAPDatabaseInstancesOperations
    ...
    :vartype sap_application_server_instances:
     azure.mgmt.workloads.sapvirtualinstance.aio.operations.SAPApplicationServerInstancesOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.workloads.sapvirtualinstance.aio.operations.Operations
    ...
    async def __aenter__(self) -> "WorkloadsSapVirtualInstanceMgmtClient":
