...
class SAPVirtualInstancesOperations:
    ...
    def list_by_resource_group(
    ...
    ) -> AsyncItemPaged["_models.SAPVirtualInstance"]:
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.SAPVirtualInstance],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.SAPVirtualInstance"]:
...
class SAPCentralServerInstancesOperations:
    ...
    def list(
        self, resource_group_name: str, sap_virtual_instance_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.SAPCentralServerInstance"]:
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.SAPCentralServerInstance],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
...
class SAPDatabaseInstancesOperations:
    ...
    def list(
        self, resource_group_name: str, sap_virtual_instance_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.SAPDatabaseInstance"]:
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.SAPDatabaseInstance],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
...
class SAPApplicationServerInstancesOperations:
    ...
    def list(
        self, resource_group_name: str, sap_virtual_instance_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.SAPApplicationServerInstance"]:
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.SAPApplicationServerInstance],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
