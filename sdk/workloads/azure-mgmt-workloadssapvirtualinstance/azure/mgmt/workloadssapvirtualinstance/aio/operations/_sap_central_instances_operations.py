...
class SAPCentralInstancesOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.workloads.sapvirtualinstance.models.SAPCentralServerInstance
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.SAPCentralServerInstance
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.workloads.sapvirtualinstance.models.SAPCentralServerInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.SAPCentralServerInstance or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.UpdateSAPCentralInstanceRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.UpdateSAPCentralInstanceRequest or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
    ...
    def list(
        ...
        :return: An iterator like instance of either SAPCentralServerInstance or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.workloads.sapvirtualinstance.models.SAPCentralServerInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_start_instance(
        ...
        **kwargs: Any
        ...
        :param central_instance_name: Central Services Instance resource name string modeled as
         parameter for auto generation to work correctly. Required.
        :type central_instance_name: str
        :param body: SAP Central Services instance start request body. Is either a StartRequest type or
