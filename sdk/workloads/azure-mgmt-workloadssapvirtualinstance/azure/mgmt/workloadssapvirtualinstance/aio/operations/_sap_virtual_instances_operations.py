...
class SAPVirtualInstancesOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.SAPVirtualInstance
        ...
        :return: An instance of AsyncLROPoller that returns either SAPVirtualInstance or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.workloads.sapvirtualinstance.models.SAPVirtualInstance]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.SAPVirtualInstance or IO
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.workloads.sapvirtualinstance.models.SAPVirtualInstance
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param body: Request body to update a Virtual Instance for SAP solutions resource. Default
         value is None.
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.UpdateSAPVirtualInstanceRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.UpdateSAPVirtualInstanceRequest or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.workloads.sapvirtualinstance.models.SAPVirtualInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_start(
        ...
        **kwargs: Any
        ...
        :param sap_virtual_instance_name: The name of the Virtual Instances for SAP solutions resource.
         Required.
        :type sap_virtual_instance_name: str
        :param body: The Virtual Instance for SAP solutions resource start request body. Is either a
         StartRequest type or a IO type. Default value is None.
