...
class SAPVirtualInstancesOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloadssapvirtualinstance.models.SAPVirtualInstance
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloadssapvirtualinstance.models.SAPVirtualInstance or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either SAPVirtualInstance or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.workloadssapvirtualinstance.models.SAPVirtualInstance]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param body: Request body to update a Virtual Instance for SAP solutions resource. Default
         value is None.
        :type body: ~azure.mgmt.workloadssapvirtualinstance.models.UpdateSAPVirtualInstanceRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either SAPVirtualInstance or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloadssapvirtualinstance.models.UpdateSAPVirtualInstanceRequest or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either SAPVirtualInstance or the result of
         cls(response)
        :rtype:
    ...
    async def begin_start(
        ...
        **kwargs: Any
        ...
        :param body: The Virtual Instance for SAP solutions resource start request body. Is either a
         StartRequest type or a IO[bytes] type. Default value is None.
