...
class SAPApplicationServerInstancesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.workloads.sapvirtualinstance.aio.WorkloadsSapVirtualInstanceMgmtClient`'s
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.workloads.sapvirtualinstance.models.SAPApplicationServerInstance
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        """Puts the SAP Application Server Instance resource. :code:`<br>`:code:`<br>`This will be used by
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.SAPApplicationServerInstance
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.workloads.sapvirtualinstance.models.SAPApplicationServerInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.SAPApplicationServerInstance or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type application_instance_name: str
        :param body: The SAP Application Server Instance resource request body. Default value is None.
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.UpdateSAPApplicationInstanceRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_delete(
        ...
        """Deletes the SAP Application Server Instance resource. :code:`<br>`:code:`<br>`This operation
    ...
    def list(
        ...
        :return: An iterator like instance of either SAPApplicationServerInstance or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.workloads.sapvirtualinstance.models.SAPApplicationServerInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def _start_instance_initial(
        ...
        sap_virtual_instance_name: str,
        application_instance_name: str,
        body: Optional[Union[_models.StartRequest, IO]] = None,
        **kwargs: Any
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            if body is not None:
                _json = self._serialize.body(body, "StartRequest")
            else:
                _json = None
    ...
    async def begin_start_instance(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.StartRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either OperationStatusResult or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.workloads.sapvirtualinstance.models.OperationStatusResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_start_instance(
        ...
        **kwargs: Any
        ...
        :param application_instance_name: The name of SAP Application Server instance resource.
         Required.
        :type application_instance_name: str
        :param body: SAP Application server instance start request body. Is either a StartRequest type
         or a IO type. Default value is None.
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.StartRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_stop_instance(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.StopRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_stop_instance(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.StopRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
