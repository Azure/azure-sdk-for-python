...
class SAPApplicationServerInstancesOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloadssapvirtualinstance.models.SAPApplicationServerInstance
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloadssapvirtualinstance.models.SAPApplicationServerInstance or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either SAPApplicationServerInstance or the
         result of cls(response)
        :rtype:
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type application_instance_name: str
        :param body: The SAP Application Server Instance resource request body. Default value is None.
        :type body: ~azure.mgmt.workloadssapvirtualinstance.models.UpdateSAPApplicationInstanceRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: SAPApplicationServerInstance or the result of cls(response)
    ...
    async def _start_instance_initial(
        ...
        sap_virtual_instance_name: str,
        application_instance_name: str,
        body: Optional[Union[_models.StartRequest, IO[bytes]]] = None,
        **kwargs: Any
    ...
    async def begin_start_instance(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloadssapvirtualinstance.models.StartRequest or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either OperationStatusResult or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.workloadssapvirtualinstance.models.OperationStatusResult]
    ...
    async def begin_stop_instance(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloadssapvirtualinstance.models.StopRequest or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either OperationStatusResult or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.workloadssapvirtualinstance.models.OperationStatusResult]
