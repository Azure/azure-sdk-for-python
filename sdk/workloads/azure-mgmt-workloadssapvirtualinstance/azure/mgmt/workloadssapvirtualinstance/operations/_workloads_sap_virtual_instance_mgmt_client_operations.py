...
class WorkloadsSapVirtualInstanceMgmtClientOperationsMixin(  # pylint: disable=name-too-long
    WorkloadsSapVirtualInstanceMgmtClientMixinABC
):
    @overload
    ...
    def sap_sizing_recommendations(
        ...
        **kwargs: Any
        ...
        :type sap_sizing_recommendation:
         ~azure.mgmt.workloadssapvirtualinstance.models.SAPSizingRecommendationRequest or IO[bytes]
        :return: SAPSizingRecommendationResult or the result of cls(response)
        :rtype: ~azure.mgmt.workloadssapvirtualinstance.models.SAPSizingRecommendationResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def sap_supported_sku(
        ...
        **kwargs: Any
        ...
        :type sap_supported_sku: ~azure.mgmt.workloadssapvirtualinstance.models.SAPSupportedSkusRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    def sap_disk_configurations(
        ...
        **kwargs: Any
        ...
        :type sap_disk_configurations:
         ~azure.mgmt.workloadssapvirtualinstance.models.SAPDiskConfigurationsRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    def sap_disk_configurations(
        ...
        **kwargs: Any
        ...
        :type sap_disk_configurations:
         ~azure.mgmt.workloadssapvirtualinstance.models.SAPDiskConfigurationsRequest or IO[bytes]
        :return: SAPDiskConfigurationsResult or the result of cls(response)
        :rtype: ~azure.mgmt.workloadssapvirtualinstance.models.SAPDiskConfigurationsResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def sap_availability_zone_details(
        ...
        **kwargs: Any
        ...
        :type sap_availability_zone_details:
         ~azure.mgmt.workloadssapvirtualinstance.models.SAPAvailabilityZoneDetailsRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    def sap_availability_zone_details(
        ...
        **kwargs: Any
        ...
        :type sap_availability_zone_details:
         ~azure.mgmt.workloadssapvirtualinstance.models.SAPAvailabilityZoneDetailsRequest or IO[bytes]
        :return: SAPAvailabilityZoneDetailsResult or the result of cls(response)
        :rtype: ~azure.mgmt.workloadssapvirtualinstance.models.SAPAvailabilityZoneDetailsResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
