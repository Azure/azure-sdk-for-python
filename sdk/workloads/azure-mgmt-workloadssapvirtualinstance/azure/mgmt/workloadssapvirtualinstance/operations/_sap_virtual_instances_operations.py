...
class SAPVirtualInstancesOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either SAPVirtualInstance or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.workloads.sapvirtualinstance.models.SAPVirtualInstance]
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.SAPVirtualInstance"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.workloads.sapvirtualinstance.models.SAPVirtualInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
