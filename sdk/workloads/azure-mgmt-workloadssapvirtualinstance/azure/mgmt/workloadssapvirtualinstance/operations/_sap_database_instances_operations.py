...
from .._vendor import WorkloadsSapVirtualInstanceMgmtClientMixinABC, _convert_request
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "sapVirtualInstanceName": _SERIALIZER.url(
            "sap_virtual_instance_name", sap_virtual_instance_name, "str", pattern=r"^[a-zA-Z][a-zA-Z0-9]{2}$"
        ),
        "databaseInstanceName": _SERIALIZER.url(
            "database_instance_name", database_instance_name, "str", pattern=r"^.*"
        ),
    }
...
class SAPDatabaseInstancesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.workloads.sapvirtualinstance.WorkloadsSapVirtualInstanceMgmtClient`'s
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.workloads.sapvirtualinstance.models.SAPDatabaseInstance
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.SAPDatabaseInstance
        ...
        :return: An instance of LROPoller that returns either SAPDatabaseInstance or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.workloads.sapvirtualinstance.models.SAPDatabaseInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.SAPDatabaseInstance or IO
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.UpdateSAPDatabaseInstanceRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.workloads.sapvirtualinstance.models.UpdateSAPDatabaseInstanceRequest or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.workloads.sapvirtualinstance.models.SAPDatabaseInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_start_instance(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either OperationStatusResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.workloads.sapvirtualinstance.models.OperationStatusResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_start_instance(
        ...
        **kwargs: Any
        ...
        :param database_instance_name: Database resource name string modeled as parameter for auto
         generation to work correctly. Required.
        :type database_instance_name: str
        :param body: SAP Database server instance start request body. Is either a StartRequest type or
