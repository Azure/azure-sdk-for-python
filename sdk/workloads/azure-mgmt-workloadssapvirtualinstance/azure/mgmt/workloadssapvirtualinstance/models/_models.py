...
class ApplicationServerConfiguration(_model_base.Model):
    ...
    instance_count: int = rest_field(name="instanceCount")
...
class ApplicationServerFullResourceNames(_model_base.Model):
    ...
    virtual_machines: Optional[List["_models.VirtualMachineResourceNames"]] = rest_field(name="virtualMachines")
...
class CentralServerFullResourceNames(_model_base.Model):
    ...
    """The full name for availability set. In case name is not provided, it will be defaulted to
     {SID}-ASCS-AvSet."""
    load_balancer: Optional["_models.LoadBalancerResourceNames"] = rest_field(name="loadBalancer")
...
class FileShareConfiguration(_model_base.Model):
    ...
    configuration_type: str = rest_discriminator(name="configurationType")
...
class CreateAndMountFileShareConfiguration(FileShareConfiguration, discriminator="CreateAndMount"):
    ...
    storage_account_name: Optional[str] = rest_field(name="storageAccountName")
    """The name of file share storage account name . A custom name is used in case of missing input."""
    configuration_type: Literal[FileShareConfigurationType.CREATE_AND_MOUNT] = rest_discriminator(name="configurationType")  # type: ignore
...
class DatabaseConfiguration(_model_base.Model):
    ...
    database_type: Optional[Union[str, "_models.SAPDatabaseType"]] = rest_field(name="databaseType")
    ...
    disk_configuration: Optional["_models.DiskConfiguration"] = rest_field(name="diskConfiguration")
...
class DeploymentConfiguration(SAPConfiguration, discriminator="Deployment"):
    ...
    software_configuration: Optional["_models.SoftwareConfiguration"] = rest_field(name="softwareConfiguration")
    """The software configuration."""
    configuration_type: Literal[SAPConfigurationType.DEPLOYMENT] = rest_discriminator(name="configurationType")  # type: ignore # pylint: disable=line-too-long
...
class DeploymentWithOSConfiguration(SAPConfiguration, discriminator="DeploymentWithOSConfig"):
    ...
    software_configuration: Optional["_models.SoftwareConfiguration"] = rest_field(name="softwareConfiguration")
    """The software configuration."""
    os_sap_configuration: Optional["_models.OsSapConfiguration"] = rest_field(name="osSapConfiguration")
    """The OS and SAP configuration."""
    configuration_type: Literal[SAPConfigurationType.DEPLOYMENT_WITH_OS_CONFIG] = rest_discriminator(name="configurationType")  # type: ignore
...
class DiscoveryConfiguration(SAPConfiguration, discriminator="Discovery"):
    ...
    :ivar managed_rg_storage_account_name: The custom storage account name for the storage account
     created by the service in the managed resource group created as part of VIS deployment.\\
     :code:`<br>`\\ :code:`<br>`Refer to the storage account naming rules `here
     <https://learn.microsoft.com/azure/azure-resource-manager/management/resource-name-rules#microsoftstorage>`_.\\
     :code:`<br>`\\ :code:`<br>`If not provided, the service will create the storage account with a
     random name.
    ...
    central_server_vm_id: Optional[str] = rest_field(name="centralServerVmId")
    """The virtual machine ID of the Central Server."""
    managed_rg_storage_account_name: Optional[str] = rest_field(name="managedRgStorageAccountName")
    """The custom storage account name for the storage account created by the service in the managed
     resource group created as part of VIS deployment.\ :code:`<br>`\ :code:`<br>`Refer to the
     storage account naming rules `here
     <https://learn.microsoft.com/azure/azure-resource-manager/management/resource-name-rules#microsoftstorage>`_.\
     :code:`<br>`\ :code:`<br>`If not provided, the service will create the storage account with a
     random name."""
    app_location: Optional[str] = rest_field(name="appLocation", visibility=["read"])
    """The geo-location where the SAP system exists."""
    configuration_type: Literal[SAPConfigurationType.DISCOVERY] = rest_discriminator(name="configurationType")  # type: ignore # pylint: disable=line-too-long
...
class DiskDetails(_model_base.Model):
    ...
    sku: Optional["_models.DiskSku"] = rest_field()
    """The type of disk sku. For example, Standard_LRS, Standard_ZRS, Premium_LRS, Premium_ZRS."""
    size_gb: Optional[int] = rest_field(name="sizeGB")
    """The disk size in GB."""
    minimum_supported_disk_count: Optional[int] = rest_field(name="minimumSupportedDiskCount")
    """The minimum supported disk count."""
    maximum_supported_disk_count: Optional[int] = rest_field(name="maximumSupportedDiskCount")
    """The maximum supported disk count."""
    iops_read_write: Optional[int] = rest_field(name="iopsReadWrite")
    """The disk Iops."""
    mbps_read_write: Optional[int] = rest_field(name="mbpsReadWrite")
    """The disk provisioned throughput in MBps."""
    disk_tier: Optional[str] = rest_field(name="diskTier")
...
class SoftwareConfiguration(_model_base.Model):
    ...
    __mapping__: Dict[str, _model_base.Model] = {}
    software_installation_type: str = rest_discriminator(name="softwareInstallationType")
...
class ExternalInstallationSoftwareConfiguration(
    ...
    software_installation_type: Literal[SAPSoftwareInstallationType.EXTERNAL] = rest_discriminator(name="softwareInstallationType")  # type: ignore
...
class HighAvailabilityConfiguration(_model_base.Model):
    ...
    high_availability_type: Union[str, "_models.SAPHighAvailabilityType"] = rest_field(name="highAvailabilityType")
...
class HighAvailabilitySoftwareConfiguration(_model_base.Model):
    ...
    fencing_client_id: str = rest_field(name="fencingClientId")
    """The fencing client id. Required."""
    fencing_client_password: str = rest_field(name="fencingClientPassword")
...
class InfrastructureConfiguration(_model_base.Model):
    ...
    __mapping__: Dict[str, _model_base.Model] = {}
    app_resource_group: str = rest_field(name="appResourceGroup")
    """The application resource group where SAP system resources will be deployed. Required."""
    deployment_type: str = rest_discriminator(name="deploymentType")
...
class OSConfiguration(_model_base.Model):
    ...
    __mapping__: Dict[str, _model_base.Model] = {}
    os_type: str = rest_discriminator(name="osType")
...
class LinuxConfiguration(OSConfiguration, discriminator="Linux"):
    ...
    """Specifies the ssh key configuration for a Linux OS. (This property is deprecated, please use
     'sshKeyPair' instead)."""
    ssh_key_pair: Optional["_models.SshKeyPair"] = rest_field(name="sshKeyPair")
    """The SSH Key-pair used to authenticate with the VM's."""
    os_type: Literal[OSType.LINUX] = rest_discriminator(name="osType")  # type: ignore
...
class LoadBalancerResourceNames(_model_base.Model):
    ...
    load_balancer_name: Optional[str] = rest_field(name="loadBalancerName")
    """The full resource name for load balancer. If this value is not provided, load balancer will be
     name as {ASCS/DB}-loadBalancer."""
    frontend_ip_configuration_names: Optional[List[str]] = rest_field(name="frontendIpConfigurationNames")
    ...
    backend_pool_names: Optional[List[str]] = rest_field(name="backendPoolNames")
    """The list of backend pool names. Currently, ACSS deploys only one backend pool and hence, size
     of this list should be 1."""
    health_probe_names: Optional[List[str]] = rest_field(name="healthProbeNames")
...
class MountFileShareConfiguration(FileShareConfiguration, discriminator="Mount"):
    ...
    private_endpoint_id: str = rest_field(name="privateEndpointId")
    """The private endpoint resource ID. Required."""
    configuration_type: Literal[FileShareConfigurationType.MOUNT] = rest_discriminator(name="configurationType")  # type: ignore # pylint: disable=line-too-long
...
class NetworkConfiguration(_model_base.Model):
    ...
    is_secondary_ip_enabled: Optional[bool] = rest_field(name="isSecondaryIpEnabled")
...
class NetworkInterfaceResourceNames(_model_base.Model):
    ...
    network_interface_name: Optional[str] = rest_field(name="networkInterfaceName")
...
class OSProfile(_model_base.Model):
     ...
     **Disallowed values:** "abc@123", "P@$$w0rd", "P@ssw0rd", "P@ssword123", "Pa$$word",
     ...
     in a Windows VM <https://learn.microsoft.com/troubleshoot/azure/virtual-machines/reset-rdp>`_
    ...
    """Specifies the name of the administrator account. :code:`<br>`\ :code:`<br>` This property
     cannot be updated after the VM is created. :code:`<br>`\ :code:`<br>` **Windows-only
    ...
    """Specifies the password of the administrator account. :code:`<br>`\ :code:`<br>`
     **Minimum-length (Windows):** 8 characters :code:`<br>`\ :code:`<br>` **Minimum-length
     (Linux):** 6 characters :code:`<br>`\ :code:`<br>` **Max-length (Windows):** 123 characters
     :code:`<br>`\ :code:`<br>` **Max-length (Linux):** 72 characters :code:`<br>`\ :code:`<br>`
     **Complexity requirements:** 3 out of 4 conditions below need to be fulfilled :code:`<br>` Has
     lower characters :code:`<br>`Has upper characters :code:`<br>` Has a digit :code:`<br>` Has a
     special character (Regex match [\W_]) :code:`<br>`\ :code:`<br>` **Disallowed values:**
     \"abc@123\", \"P@$$w0rd\", \"P@ssw0rd\", \"P@ssword123\", \"Pa$$word\", \"pass@word1\",
     \"Password!\", \"Password1\", \"Password22\", \"iloveyou!\" :code:`<br>`\ :code:`<br>` For
     ...
     repair disks on Azure Linux VMs using the VMAccess Extension
     <https://learn.microsoft.com/troubleshoot/azure/virtual-machines/troubleshoot-ssh-connection>`_."""
    os_configuration: Optional["_models.OSConfiguration"] = rest_field(name="osConfiguration")
...
class OsSapConfiguration(_model_base.Model):
    ...
    deployer_vm_packages: Optional["_models.DeployerVmPackages"] = rest_field(name="deployerVmPackages")
    """The url and storage account ID where deployer VM packages are uploaded."""
    sap_fqdn: Optional[str] = rest_field(name="sapFqdn")
...
class SAPAvailabilityZoneDetailsRequest(_model_base.Model):
    ...
    app_location: str = rest_field(name="appLocation")
    """The geo-location where the SAP resources will be created. Required."""
    sap_product: Union[str, "_models.SAPProductType"] = rest_field(name="sapProduct")
    """Defines the SAP Product type. Required. Known values are: \"ECC\", \"S4HANA\", and \"Other\"."""
    database_type: Union[str, "_models.SAPDatabaseType"] = rest_field(name="databaseType")
...
class SAPAvailabilityZonePair(_model_base.Model):
    ...
    zone_a: Optional[int] = rest_field(name="zoneA")
    """The zone A."""
    zone_b: Optional[int] = rest_field(name="zoneB")
    """The zone B."""
...
class SAPCentralServerProperties(_model_base.Model):
    ...
    message_server_properties: Optional["_models.MessageServerProperties"] = rest_field(name="messageServerProperties")
    """Defines the SAP message server properties."""
    enqueue_server_properties: Optional["_models.EnqueueServerProperties"] = rest_field(name="enqueueServerProperties")
    """Defines the SAP Enqueue Server properties."""
    gateway_server_properties: Optional["_models.GatewayServerProperties"] = rest_field(name="gatewayServerProperties")
    """Defines the SAP Gateway Server properties."""
...
class SAPDiskConfiguration(_model_base.Model):
    ...
    recommended_configuration: Optional["_models.DiskVolumeConfiguration"] = rest_field(name="recommendedConfiguration")
    """The recommended disk details for a given VM Sku."""
    supported_configurations: Optional[List["_models.DiskDetails"]] = rest_field(name="supportedConfigurations")
...
class SAPDiskConfigurationsRequest(_model_base.Model):
    ...
    database_type: Union[str, "_models.SAPDatabaseType"] = rest_field(name="databaseType")
    """The database type. Eg: HANA, DB2, etc. Required. Known values are: \"HANA\" and \"DB2\"."""
    deployment_type: Union[str, "_models.SAPDeploymentType"] = rest_field(name="deploymentType")
    """The deployment type. Eg: SingleServer/ThreeTier. Required. Known values are: \"SingleServer\"
     and \"ThreeTier\"."""
    db_vm_sku: str = rest_field(name="dbVmSku")
...
class SAPDiskConfigurationsResult(_model_base.Model):
    ...
    volume_configurations: Optional[Dict[str, "_models.SAPDiskConfiguration"]] = rest_field(name="volumeConfigurations")
    """The disk configuration for the db volume. For HANA, Required volumes are: ['hana/data',
     'hana/log', hana/shared', 'usr/sap', 'os'], Optional volume : ['backup']."""
...
class SAPInstallWithoutOSConfigSoftwareConfiguration(
    ...
    bom_url: str = rest_field(name="bomUrl")
    """The URL to the SAP Build of Materials(BOM) file. Required."""
    sap_bits_storage_account_id: str = rest_field(name="sapBitsStorageAccountId")
    """The SAP bits storage account id. Required."""
    software_version: str = rest_field(name="softwareVersion")
    ...
    """Gets or sets the HA software configuration."""
    software_installation_type: Literal[SAPSoftwareInstallationType.SAP_INSTALL_WITHOUT_OS_CONFIG] = rest_discriminator(name="softwareInstallationType")  # type: ignore
...
class SAPSizingRecommendationRequest(_model_base.Model):
    ...
    db_memory: int = rest_field(name="dbMemory")
    """The database memory configuration. Required."""
    database_type: Union[str, "_models.SAPDatabaseType"] = rest_field(name="databaseType")
    """The database type. Required. Known values are: \"HANA\" and \"DB2\"."""
    db_scale_method: Optional[Union[str, "_models.SAPDatabaseScaleMethod"]] = rest_field(name="dbScaleMethod")
...
class SAPSupportedResourceSkusResult(_model_base.Model):
    ...
    supported_skus: Optional[List["_models.SAPSupportedSku"]] = rest_field(name="supportedSkus")
...
class SAPSupportedSku(_model_base.Model):
    ...
    vm_sku: Optional[str] = rest_field(name="vmSku")
    """The VM Sku."""
    is_app_server_certified: Optional[bool] = rest_field(name="isAppServerCertified")
    """True if the Sku is certified for App server in the SAP system."""
    is_database_certified: Optional[bool] = rest_field(name="isDatabaseCertified")
...
class SAPVirtualInstanceProperties(_model_base.Model):
    ...
    managed_resources_network_access_type: Optional[Union[str, "_models.ManagedResourcesNetworkAccessType"]] = (
        rest_field(name="managedResourcesNetworkAccessType")
    )
    """Specifies the network access configuration for the resources that will be deployed in the
     ...
     Learn more here https://go.microsoft.com/fwlink/?linkid=2247228. Known values are: \"Public\"
     and \"Private\"."""
    configuration: "_models.SAPConfiguration" = rest_field()
...
class ServiceInitiatedSoftwareConfiguration(SoftwareConfiguration, discriminator="ServiceInitiated"):
    ...
    sap_bits_storage_account_id: str = rest_field(name="sapBitsStorageAccountId")
    """The SAP bits storage account id. Required."""
    sap_fqdn: str = rest_field(name="sapFqdn")
    """The FQDN to set for the SAP system during install. Required."""
    ssh_private_key: str = rest_field(name="sshPrivateKey")
    """The SSH private key. Required."""
    high_availability_software_configuration: Optional["_models.HighAvailabilitySoftwareConfiguration"] = rest_field(
        name="highAvailabilitySoftwareConfiguration"
    )
    """Gets or sets the HA software configuration."""
    software_installation_type: Literal[SAPSoftwareInstallationType.SERVICE_INITIATED] = rest_discriminator(name="softwareInstallationType")  # type: ignore
...
class SharedStorageResourceNames(_model_base.Model):
    ...
    shared_storage_account_name: Optional[str] = rest_field(name="sharedStorageAccountName")
    ...
    shared_storage_account_private_end_point_name: Optional[str] = rest_field(
        name="sharedStorageAccountPrivateEndPointName"
    )
...
class SingleServerConfiguration(InfrastructureConfiguration, discriminator="SingleServer"):
    ...
    """Gets or sets the virtual machine configuration. Required."""
    db_disk_configuration: Optional["_models.DiskConfiguration"] = rest_field(name="dbDiskConfiguration")
    """Gets or sets the disk configuration."""
    custom_resource_names: Optional["_models.SingleServerCustomResourceNames"] = rest_field(name="customResourceNames")
    """The set of custom names to be used for underlying azure resources that are part of the SAP
     system."""
    deployment_type: Literal[SAPDeploymentType.SINGLE_SERVER] = rest_discriminator(name="deploymentType")  # type: ignore # pylint: disable=line-too-long
...
class SingleServerCustomResourceNames(_model_base.Model):
    ...
    __mapping__: Dict[str, _model_base.Model] = {}
    naming_pattern_type: str = rest_discriminator(name="namingPatternType")
...
class SingleServerFullResourceNames(SingleServerCustomResourceNames, discriminator="FullResourceName"):
    ...
    virtual_machine: Optional["_models.VirtualMachineResourceNames"] = rest_field(name="virtualMachine")
    """The resource names object for virtual machine and related resources."""
    naming_pattern_type: Literal[NamingPatternType.FULL_RESOURCE_NAME] = rest_discriminator(name="namingPatternType")  # type: ignore # pylint: disable=line-too-long
...
class SkipFileShareConfiguration(FileShareConfiguration, discriminator="Skip"):
    ...
    configuration_type: Literal[FileShareConfigurationType.SKIP] = rest_discriminator(name="configurationType")  # type: ignore # pylint: disable=line-too-long
...
class SshKeyPair(_model_base.Model):
    ...
    """SSH public key."""
    private_key: Optional[str] = rest_field(name="privateKey")
    """SSH private key."""
...
class SshPublicKey(_model_base.Model):
    ...
    """SSH public key certificate used to authenticate with the VM through ssh. The key needs to be at
     least 2048-bit and in ssh-rsa format. :code:`<br>`\ :code:`<br>` For creating ssh keys, see
...
class StartRequest(_model_base.Model):
    ...
    start_vm: Optional[bool] = rest_field(name="startVm")
...
class StopRequest(_model_base.Model):
    ...
    soft_stop_timeout_seconds: Optional[int] = rest_field(name="softStopTimeoutSeconds")
    ...
    deallocate_vm: Optional[bool] = rest_field(name="deallocateVm")
...
class StorageConfiguration(_model_base.Model):
    ...
    transport_file_share_configuration: Optional["_models.FileShareConfiguration"] = rest_field(
        name="transportFileShareConfiguration"
    )
...
class ThreeTierConfiguration(InfrastructureConfiguration, discriminator="ThreeTier"):
    ...
    central_server: "_models.CentralServerConfiguration" = rest_field(name="centralServer")
    """The central server configuration. Required."""
    application_server: "_models.ApplicationServerConfiguration" = rest_field(name="applicationServer")
    """The application server configuration. Required."""
    database_server: "_models.DatabaseConfiguration" = rest_field(name="databaseServer")
    ...
    storage_configuration: Optional["_models.StorageConfiguration"] = rest_field(name="storageConfiguration")
    """The storage configuration."""
    custom_resource_names: Optional["_models.ThreeTierCustomResourceNames"] = rest_field(name="customResourceNames")
    """The set of custom names to be used for underlying azure resources that are part of the SAP
     system."""
    deployment_type: Literal[SAPDeploymentType.THREE_TIER] = rest_discriminator(name="deploymentType")  # type: ignore
...
class ThreeTierFullResourceNames(ThreeTierCustomResourceNames, discriminator="FullResourceName"):
    ...
    central_server: Optional["_models.CentralServerFullResourceNames"] = rest_field(name="centralServer")
    """The full resource names object for central server layer resources."""
    application_server: Optional["_models.ApplicationServerFullResourceNames"] = rest_field(name="applicationServer")
    """The full resource names object for application layer resources. The number of entries in this
     list should be equal to the number VMs to be created for application layer."""
    database_server: Optional["_models.DatabaseServerFullResourceNames"] = rest_field(name="databaseServer")
    """The full resource names object for database layer resources. The number of entries in this list
     should be equal to the number VMs to be created for database layer."""
    shared_storage: Optional["_models.SharedStorageResourceNames"] = rest_field(name="sharedStorage")
    """The resource names object for shared storage."""
    naming_pattern_type: Literal[NamingPatternType.FULL_RESOURCE_NAME] = rest_discriminator(name="namingPatternType")  # type: ignore # pylint: disable=line-too-long
...
class ThreeTierRecommendationResult(SAPSizingRecommendationResult, discriminator="ThreeTier"):
    ...
    db_vm_sku: Optional[str] = rest_field(name="dbVmSku")
    """The database VM SKU."""
    database_instance_count: Optional[int] = rest_field(name="databaseInstanceCount")
    """The database server instance count."""
    central_server_vm_sku: Optional[str] = rest_field(name="centralServerVmSku")
    """The central server VM SKU."""
    central_server_instance_count: Optional[int] = rest_field(name="centralServerInstanceCount")
    """The central server instance count."""
    application_server_vm_sku: Optional[str] = rest_field(name="applicationServerVmSku")
    """The application server VM SKU."""
    application_server_instance_count: Optional[int] = rest_field(name="applicationServerInstanceCount")
...
class VirtualMachineConfiguration(_model_base.Model):
    ...
    os_profile: "_models.OSProfile" = rest_field(name="osProfile")
...
class VirtualMachineResourceNames(_model_base.Model):
    ...
    vm_name: Optional[str] = rest_field(name="vmName")
    """The full name for virtual machine. The length of this field can be upto 64 characters. If name
     ...
     For distributed and HA-AvSet systems, default name will be {SID}{app/ascs/db}vm with an
     incrementor at the end in case of more than 1 vm per layer."""
    host_name: Optional[str] = rest_field(name="hostName")
    ...
    network_interfaces: Optional[List["_models.NetworkInterfaceResourceNames"]] = rest_field(name="networkInterfaces")
    ...
    os_disk_name: Optional[str] = rest_field(name="osDiskName")
    ...
    data_disk_names: Optional[Dict[str, List[str]]] = rest_field(name="dataDiskNames")
...
class WindowsConfiguration(OSConfiguration, discriminator="Windows"):
    ...
    os_type: Literal[OSType.WINDOWS] = rest_discriminator(name="osType")  # type: ignore
