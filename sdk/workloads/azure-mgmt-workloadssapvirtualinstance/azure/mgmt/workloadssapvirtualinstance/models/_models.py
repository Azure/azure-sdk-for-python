...
class DiscoveryConfiguration(SAPConfiguration, discriminator="Discovery"):
    ...
    """The custom storage account name for the storage account created by the service in the managed
     resource group created as part of VIS deployment.:code:`<br>`:code:`<br>`Refer to the storage
     account naming rules `here
     <https://learn.microsoft.com/azure/azure-resource-manager/management/resource-name-rules#microsoftstorage>`_.:code:`<br>`:code:`<br>`If  # pylint: disable=line-too-long
     not provided, the service will create the storage account with a random name."""
...
class SAPApplicationServerProperties(_model_base.Model):  # pylint: disable=too-many-instance-attributes
...
class SAPCentralServerProperties(_model_base.Model):  # pylint: disable=too-many-instance-attributes
...
class SAPVirtualInstance(TrackedResource):
    ...
    :vartype identity: ~azure.mgmt.workloadssapvirtualinstance.models.ManagedServiceIdentity
    """
