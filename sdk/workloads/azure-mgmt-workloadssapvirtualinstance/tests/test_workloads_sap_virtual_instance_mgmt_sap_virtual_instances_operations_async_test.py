...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.workloadssapvirtualinstance.aio import WorkloadsSapVirtualInstanceMgmtClient
...
class TestWorkloadsSapVirtualInstanceMgmtSAPVirtualInstancesOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_sap_virtual_instances_list_by_subscription(self, resource_group):
