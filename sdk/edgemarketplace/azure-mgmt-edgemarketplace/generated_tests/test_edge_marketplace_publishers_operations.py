...
class TestEdgeMarketplacePublishersOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_publishers_list(self, resource_group):
        response = self.client.publishers.list(
            resource_uri="str",
        )
