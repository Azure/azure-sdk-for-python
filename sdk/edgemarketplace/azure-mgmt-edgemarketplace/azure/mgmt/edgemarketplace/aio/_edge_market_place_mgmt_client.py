...
class EdgeMarketPlaceMgmtClient:  # pylint: disable=client-accepts-api-version-keyword
    """Edge marketplace extensions.

    :ivar publishers: PublishersOperations operations
    :vartype publishers: azure.mgmt.edgemarketplace.aio.operations.PublishersOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.edgemarketplace.aio.operations.Operations
    :ivar offers: OffersOperations operations
    :vartype offers: azure.mgmt.edgemarketplace.aio.operations.OffersOperations
    ...
    async def __aenter__(self) -> "EdgeMarketPlaceMgmtClient":
