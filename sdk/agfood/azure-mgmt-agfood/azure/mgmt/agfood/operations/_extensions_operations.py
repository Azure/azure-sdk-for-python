...
class ExtensionsOperations(object):
    ...
    def list_by_farm_beats(
        ...
        resource_group_name,  # type: str
        farm_beats_resource_name,  # type: str
        extension_id=None,  # type: Optional[str]
        extension_category=None,  # type: Optional[str]
        ...
        **kwargs  # type: Any
        ...
        :param extension_id: Id of extension resource.
        :type extension_id: str
        :param extension_category: Category of extension (weather/sensor/satellite etc.).
        :type extension_category: str
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure_ag_food_platform_rp_service.models.ExtensionListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                ...
                if extension_category is not None:
                    query_parameters['extensionCategory'] = self._serialize.query("extension_category", extension_category, 'str', max_length=50, min_length=0)
