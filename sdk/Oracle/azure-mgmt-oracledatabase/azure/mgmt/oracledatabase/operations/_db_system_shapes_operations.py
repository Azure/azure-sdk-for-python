...
def build_list_by_location_request(location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Oracle.Database/locations/{location}/dbSystemShapes"
...
def build_get_request(location: str, dbsystemshapename: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DbSystemShapesOperations:
    ...
    @distributed_trace
    def list_by_location(self, location: str, **kwargs: Any) -> Iterable["_models.DbSystemShape"]:
        """List DbSystemShape resources by Location.

        :param location: The name of the Azure region. Required.
        :type location: str
        :return: An iterator like instance of either DbSystemShape or the result of cls(response)
        ...
        cls: ClsType[_models.DbSystemShapeListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("DbSystemShapeListResult", pipeline_response)
    ...
    def get(self, location: str, dbsystemshapename: str, **kwargs: Any) -> _models.DbSystemShape:
        ...
        :return: DbSystemShape or the result of cls(response)
        ...
        deserialized = self._deserialize("DbSystemShape", pipeline_response)
