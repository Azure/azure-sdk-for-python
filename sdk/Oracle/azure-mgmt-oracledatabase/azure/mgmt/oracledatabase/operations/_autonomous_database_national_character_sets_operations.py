...
def build_get_request(location: str, adbsncharsetname: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class AutonomousDatabaseNationalCharacterSetsOperations:  # pylint: disable=name-too-long
    ...
    def list_by_location(
    ...
    ) -> Iterable["_models.AutonomousDatabaseNationalCharacterSet"]:
        """List AutonomousDatabaseNationalCharacterSet resources by Location.

        :param location: The name of the Azure region. Required.
        :type location: str
        :return: An iterator like instance of either AutonomousDatabaseNationalCharacterSet or the
        ...
        cls: ClsType[_models.AutonomousDatabaseNationalCharacterSetListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("AutonomousDatabaseNationalCharacterSetListResult", pipeline_response)
    ...
    def get(
        ...
        :return: AutonomousDatabaseNationalCharacterSet or the result of cls(response)
        ...
        deserialized = self._deserialize("AutonomousDatabaseNationalCharacterSet", pipeline_response)
