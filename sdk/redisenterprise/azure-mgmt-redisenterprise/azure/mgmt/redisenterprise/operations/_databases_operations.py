...
class DatabasesOperations(object):
    ...
    def list_by_cluster(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.DatabaseList"]
    ...
    def _update_initial(
        ...
        cluster_name,  # type: str
        database_name,  # type: str
        parameters,  # type: "_models.DatabaseUpdate"
        **kwargs  # type: Any
    ):
    ...
    def _regenerate_key_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["_models.AccessKeys"]
    ...
    def begin_regenerate_key(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.AccessKeys"]
    ...
    def _import_method_initial(
        ...
        cluster_name,  # type: str
        database_name,  # type: str
        parameters,  # type: "_models.ImportClusterParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
    ...
    def _export_initial(
        ...
        cluster_name,  # type: str
        database_name,  # type: str
        parameters,  # type: "_models.ExportClusterParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
