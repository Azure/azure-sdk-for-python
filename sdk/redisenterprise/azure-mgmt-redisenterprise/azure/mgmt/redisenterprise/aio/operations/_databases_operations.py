...
from ...operations._databases_operations import build_create_request_initial, build_delete_request_initial, build_export_request_initial, build_force_unlink_request_initial, build_get_request, build_import_method_request_initial, build_list_by_cluster_request, build_list_keys_request, build_regenerate_key_request_initial, build_update_request_initial
T = TypeVar('T')
...
class DatabasesOperations:
    ...
    def list_by_cluster(
        ...
        cluster_name: str,
        **kwargs: Any
    ) -> AsyncIterable[_models.DatabaseList]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.redisenterprise.models.DatabaseList]
    ...
    @distributed_trace_async
    async def begin_export(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        cluster_name: str,
        database_name: str,
    ...
    @distributed_trace_async
    async def begin_force_unlink(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        cluster_name: str,
        database_name: str,
