...
class RedisEnterpriseManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype migrations: azure.mgmt.redisenterprise.aio.operations.MigrationsOperations
    ...
    :keyword api_version: The API version to use for this operation. Known values are
     "2026-02-01-preview" and None. Default value is "2026-02-01-preview". Note that overriding
