...
def build_list_request(
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.MixedReality/operations")
...
class Operations(object):
    ...
    def list(
        self,
        **kwargs: Any
    ) -> Iterable["_models.OperationPage"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.mixedreality.models.OperationPage]
