...
# USAGE
    python private_link_scopes_get_validation.py
...
def main():
    ...
    response = client.private_link_scopes.get_validation_details(
        location="wus2",
        private_link_scope_id="f5dc51d3-92ed-4d7e-947a-775ea79b4919",
    )
    print(response)
