...
class TestHybridComputeManagementMachineRunCommandsOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_machine_run_commands_begin_create_or_update(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_machine_run_commands_begin_delete(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_machine_run_commands_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_machine_run_commands_list(self, resource_group):
