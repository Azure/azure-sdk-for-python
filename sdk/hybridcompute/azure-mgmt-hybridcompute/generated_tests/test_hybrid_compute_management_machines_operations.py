...
class TestHybridComputeManagementMachinesOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_machines_create_or_update(self, resource_group):
        response = self.client.machines.create_or_update(
            resource_group_name=resource_group.name,
            machine_name="str",
            parameters={
                "location": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_machines_update(self, resource_group):
        response = self.client.machines.update(
            resource_group_name=resource_group.name,
            machine_name="str",
            parameters={
                "identity": {"principalId": "str", "tenantId": "str", "type": "str"},
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_machines_begin_delete(self, resource_group):
        response = self.client.machines.begin_delete(
            resource_group_name=resource_group.name,
            machine_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_machines_list_by_resource_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_machines_list_by_subscription(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_machines_begin_assess_patches(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_machines_begin_install_patches(self, resource_group):
