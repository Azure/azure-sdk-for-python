...
def build_get_by_private_link_scope_request(
...
def build_reconcile_for_private_link_scope_request(
    resource_group_name: str, scope_name: str, perimeter_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class NetworkSecurityPerimeterConfigurationsOperations:
    ...
    def get_by_private_link_scope(
        ...
        request = build_get_by_private_link_scope_request(
            resource_group_name=resource_group_name,
            scope_name=scope_name,
            perimeter_name=perimeter_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.get_by_private_link_scope.metadata["url"],
            headers=_headers,
            params=_params,
        )
    ...
    get_by_private_link_scope.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridCompute/privateLinkScopes/{scopeName}/networkSecurityPerimeterConfigurations/{perimeterName}"
    }
    ...
    list_by_private_link_scope.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridCompute/privateLinkScopes/{scopeName}/networkSecurityPerimeterConfigurations"
    }

    def _reconcile_for_private_link_scope_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, scope_name: str, perimeter_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_reconcile_for_private_link_scope_request(
            resource_group_name=resource_group_name,
            scope_name=scope_name,
            perimeter_name=perimeter_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self._reconcile_for_private_link_scope_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _reconcile_for_private_link_scope_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridCompute/privateLinkScopes/{scopeName}/networkSecurityPerimeterConfigurations/{perimeterName}/reconcile"
    }
    ...
    def begin_reconcile_for_private_link_scope(
        ...
        if cont_token is None:
            raw_result = self._reconcile_for_private_link_scope_initial(  # type: ignore
                resource_group_name=resource_group_name,
                scope_name=scope_name,
                perimeter_name=perimeter_name,
                api_version=api_version,
    ...
    begin_reconcile_for_private_link_scope.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridCompute/privateLinkScopes/{scopeName}/networkSecurityPerimeterConfigurations/{perimeterName}/reconcile"
    }
