...
def build_reconcile_for_private_link_scope_request(  # pylint: disable=name-too-long
    resource_group_name: str, scope_name: str, perimeter_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class NetworkSecurityPerimeterConfigurationsOperations:  # pylint: disable=name-too-long
    ...
    def get_by_private_link_scope(
        ...
        _request = build_get_by_private_link_scope_request(
    ...
    def _reconcile_for_private_link_scope_initial(  # pylint: disable=name-too-long
        ...
        _request = build_reconcile_for_private_link_scope_request(
            resource_group_name=resource_group_name,
            scope_name=scope_name,
            perimeter_name=perimeter_name,
            subscription_id=self._config.subscription_id,
