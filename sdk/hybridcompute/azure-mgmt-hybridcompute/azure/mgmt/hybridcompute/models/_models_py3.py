...
class HybridComputePrivateLinkScopeProperties(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "service_extensions": {"key": "serviceExtensions", "type": "[ServiceExtension]"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword service_extensions: Enable private link validation for an Azure Arc Extension.
        :paramtype service_extensions: list[~azure.mgmt.hybridcompute.models.ServiceExtension]
        """
        super().__init__(**kwargs)
...
class ServiceExtension(_serialization.Model):
    """Enable private link validation for an Azure Arc Extension.

    :ivar service_extension_type: The name of the Azure Arc Extension.
    :vartype service_extension_type: str or ~azure.mgmt.hybridcompute.models.ServiceExtensionType
    ...
    _attribute_map = {
        "service_extension_type": {"key": "serviceExtensionType", "type": "str"},
        "service_extension_public_network_access": {"key": "serviceExtensionPublicNetworkAccess", "type": "str"},
    }

    def __init__(
        self,
        *,
        service_extension_type: Optional[Union[str, "_models.ServiceExtensionType"]] = None,
        ...
        **kwargs: Any
        ...
        """
        :keyword service_extension_type: The name of the Azure Arc Extension.
        :paramtype service_extension_type: str or ~azure.mgmt.hybridcompute.models.ServiceExtensionType
        :keyword service_extension_public_network_access: The network access policy to determine if the
         specified Azure Arc Extension can use public Azure Arc Extension service endpoints. Known
         values are: "enabled" and "disabled".
        :paramtype service_extension_public_network_access: str or
         ~azure.mgmt.hybridcompute.models.ServiceExtensionPublicNetworkAccess
        """
        super().__init__(**kwargs)
        self.service_extension_type = service_extension_type
        self.service_extension_public_network_access = service_extension_public_network_access
