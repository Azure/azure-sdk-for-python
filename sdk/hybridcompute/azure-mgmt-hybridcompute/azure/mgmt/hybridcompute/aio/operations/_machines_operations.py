...
class MachinesOperations:
    ...
    async def delete(self, resource_group_name: str, machine_name: str, **kwargs: Any) -> None:
    ...
    async def begin_assess_patches(
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("MachineAssessPatchesResult", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
    ...
    async def begin_install_patches(
        ...
        **kwargs: Any
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("MachineInstallPatchesResult", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
