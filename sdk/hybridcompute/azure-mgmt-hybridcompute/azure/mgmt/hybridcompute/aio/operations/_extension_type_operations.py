...
from ...operations._extension_type_operations import build_list_request
...
class ExtensionTypeOperations:
    ...
    @distributed_trace
    def list(self, location: str, publisher: str, **kwargs: Any) -> AsyncIterable["_models.ExtensionType"]:
