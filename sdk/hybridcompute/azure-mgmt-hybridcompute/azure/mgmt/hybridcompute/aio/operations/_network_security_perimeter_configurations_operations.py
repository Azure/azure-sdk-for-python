...
from ...operations._network_security_perimeter_configurations_operations import (
    build_get_by_private_link_scope_request,
    build_list_by_private_link_scope_request,
    build_reconcile_for_private_link_scope_request,
)
...
class NetworkSecurityPerimeterConfigurationsOperations:
    ...
    async def _reconcile_for_private_link_scope_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, scope_name: str, perimeter_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_reconcile_for_private_link_scope(
        ...
        if cont_token is None:
            raw_result = await self._reconcile_for_private_link_scope_initial(  # type: ignore
                resource_group_name=resource_group_name,
                scope_name=scope_name,
                perimeter_name=perimeter_name,
                api_version=api_version,
