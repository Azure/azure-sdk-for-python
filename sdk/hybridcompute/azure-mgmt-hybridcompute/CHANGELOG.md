...
### Features Added
  ...
  - Added model `GatewaysOperations`
  - Added model `MachineRunCommandsOperations`
  - Added model `SettingsOperations`
  - Method `GatewaysOperations.begin_create_or_update` has a new overload `def begin_create_or_update(self: None, resource_group_name: str, gateway_name: str, parameters: Gateway, content_type: str)`
  - Method `GatewaysOperations.begin_create_or_update` has a new overload `def begin_create_or_update(self: None, resource_group_name: str, gateway_name: str, parameters: IO[bytes], content_type: str)`
  - Method `GatewaysOperations.update` has a new overload `def update(self: None, resource_group_name: str, gateway_name: str, parameters: GatewayUpdate, content_type: str)`
  - Method `GatewaysOperations.update` has a new overload `def update(self: None, resource_group_name: str, gateway_name: str, parameters: IO[bytes], content_type: str)`
  - Method `MachineRunCommandsOperations.begin_create_or_update` has a new overload `def begin_create_or_update(self: None, resource_group_name: str, machine_name: str, run_command_name: str, run_command_properties: MachineRunCommand, content_type: str)`
  - Method `MachineRunCommandsOperations.begin_create_or_update` has a new overload `def begin_create_or_update(self: None, resource_group_name: str, machine_name: str, run_command_name: str, run_command_properties: IO[bytes], content_type: str)`
  - Method `SettingsOperations.patch` has a new overload `def patch(self: None, resource_group_name: str, base_provider: str, base_resource_type: str, base_resource_name: str, settings_resource_name: str, parameters: Settings, content_type: str)`
  - Method `SettingsOperations.patch` has a new overload `def patch(self: None, resource_group_name: str, base_provider: str, base_resource_type: str, base_resource_name: str, settings_resource_name: str, parameters: IO[bytes], content_type: str)`
  - Method `SettingsOperations.update` has a new overload `def update(self: None, resource_group_name: str, base_provider: str, base_resource_type: str, base_resource_name: str, settings_resource_name: str, parameters: Settings, content_type: str)`
  - Method `SettingsOperations.update` has a new overload `def update(self: None, resource_group_name: str, base_provider: str, base_resource_type: str, base_resource_name: str, settings_resource_name: str, parameters: IO[bytes], content_type: str)`
