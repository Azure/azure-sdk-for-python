...
def build_delete_request_initial(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/mobileNetworks/{mobileNetworkName}/slices/{sliceName}')
    path_format_arguments = {
        ...
        "sliceName": _SERIALIZER.url("slice_name", slice_name, 'str', max_length=64, min_length=0, pattern=r'^[a-zA-Z0-9][a-zA-Z0-9_-]*$'),
    }
...
def build_list_by_mobile_network_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/mobileNetworks/{mobileNetworkName}/slices')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "mobileNetworkName": _SERIALIZER.url("mobile_network_name", mobile_network_name, 'str', max_length=64, min_length=0, pattern=r'^[a-zA-Z0-9][a-zA-Z0-9_-]*$'),
...
class SlicesOperations(object):
    """SlicesOperations operations.
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~mobile_network_management_client.models.Slice]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
        polling = kwargs.pop('polling', True)  # type: Union[bool, azure.core.polling.PollingMethod]
    ...
    def list_by_mobile_network(
        ...
        mobile_network_name: str,
        **kwargs: Any
    ) -> Iterable["_models.SliceListResult"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~mobile_network_management_client.models.SliceListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
