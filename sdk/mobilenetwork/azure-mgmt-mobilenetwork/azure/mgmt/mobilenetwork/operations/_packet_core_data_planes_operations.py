...
def build_list_by_packet_core_control_plane_request(  # pylint: disable=name-too-long
...
class PacketCoreDataPlanesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.PacketCoreDataPlane].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.PacketCoreDataPlane](
    ...
    ) -> Iterable["_models.PacketCoreDataPlane"]:
