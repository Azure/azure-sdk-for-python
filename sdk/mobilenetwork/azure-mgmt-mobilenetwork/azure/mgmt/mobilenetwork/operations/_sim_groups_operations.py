...
class SimGroupsOperations:
    ...
    def _create_or_update_initial(
        ...
        sim_group_name: str,
        parameters: Union[_models.SimGroup, IO[bytes]],
        **kwargs: Any
    ) -> _models.SimGroup:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.mobilenetwork.models.SimGroup or IO[bytes]
        :return: An instance of LROPoller that returns either SimGroup or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mobilenetwork.models.SimGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.SimGroup].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.SimGroup](
