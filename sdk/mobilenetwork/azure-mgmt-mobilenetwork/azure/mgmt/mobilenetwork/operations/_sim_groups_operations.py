...
class SimGroupsOperations:
    ...
    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, sim_group_name: str, **kwargs: Any
    ) -> None:
        error_map = {
    ...
    _delete_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/simGroups/{simGroupName}"
    }

    @distributed_trace
    def begin_delete(self, resource_group_name: str, sim_group_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, sim_group_name: str, **kwargs: Any) -> _models.SimGroup:
    ...
    def _create_or_update_initial(
        self, resource_group_name: str, sim_group_name: str, parameters: Union[_models.SimGroup, IO], **kwargs: Any
    ) -> _models.SimGroup:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param sim_group_name: The name of the SIM Group. Required.
        :type sim_group_name: str
        :param parameters: Parameters supplied to the create or update SIM group operation. Required.
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.SimGroup"]:
    ...
    list_by_subscription.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.MobileNetwork/simGroups"
    }

    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.SimGroup"]:
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/simGroups"
    }
