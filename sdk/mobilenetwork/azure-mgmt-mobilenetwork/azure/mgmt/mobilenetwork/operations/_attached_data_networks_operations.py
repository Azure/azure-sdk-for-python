...
def build_delete_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "attachedDataNetworkName": _SERIALIZER.url(
...
def build_list_by_packet_core_data_plane_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    packet_core_control_plane_name: str,
    packet_core_data_plane_name: str,
    subscription_id: str,
...
class AttachedDataNetworksOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.AttachedDataNetwork].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.AttachedDataNetwork](
    ...
    def list_by_packet_core_data_plane(
        ...
        packet_core_data_plane_name: str,
        **kwargs: Any
    ) -> Iterable["_models.AttachedDataNetwork"]:
