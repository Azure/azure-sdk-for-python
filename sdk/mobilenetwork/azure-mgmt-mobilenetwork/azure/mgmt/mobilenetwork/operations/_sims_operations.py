...
def build_delete_request_initial(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/simGroups/{simGroupName}/sims/{simName}")  # pylint: disable=line-too-long
...
def build_create_or_update_request_initial(
    ...
    sim_name: str,
    *,
    json: Optional[_models.Sim] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_list_by_sim_group_request(
    resource_group_name: str,
    subscription_id: str,
    sim_group_name: str,
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/simGroups/{simGroupName}/sims")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "simGroupName": _SERIALIZER.url("sim_group_name", sim_group_name, 'str', max_length=64, min_length=0, pattern=r'^[a-zA-Z0-9][a-zA-Z0-9_-]*$'),
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_sim_group_request(
                    resource_group_name=resource_group_name,
                    subscription_id=self._config.subscription_id,
                    sim_group_name=sim_group_name,
                    api_version=api_version,
                    template_url=self.list_by_sim_group.metadata['url'],
                    headers=_headers,
                    params=_params,
                )
                request = _convert_request(request)
