...
def build_delete_request_initial(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/mobileNetworks/{mobileNetworkName}/dataNetworks/{dataNetworkName}')
    path_format_arguments = {
        ...
        "dataNetworkName": _SERIALIZER.url("data_network_name", data_network_name, 'str', max_length=64, min_length=0, pattern=r'^[a-zA-Z0-9]([a-zA-Z0-9-]*[a-zA-Z0-9])*(\.[a-zA-Z0-9]([a-zA-Z0-9-]*[a-zA-Z0-9])*)*$'),
    }
...
def build_list_by_mobile_network_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/mobileNetworks/{mobileNetworkName}/dataNetworks')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "mobileNetworkName": _SERIALIZER.url("mobile_network_name", mobile_network_name, 'str', max_length=64, min_length=0, pattern=r'^[a-zA-Z0-9][a-zA-Z0-9_-]*$'),
...
class DataNetworksOperations(object):
    """DataNetworksOperations operations.
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no
         Retry-After header is present.
        :return: An instance of LROPoller that returns either DataNetwork or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~mobile_network_management_client.models.DataNetwork]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
        polling = kwargs.pop('polling', True)  # type: Union[bool, azure.core.polling.PollingMethod]
    ...
    def list_by_mobile_network(
        ...
        mobile_network_name: str,
        **kwargs: Any
    ) -> Iterable["_models.DataNetworkListResult"]:
        ...
        :return: An iterator like instance of either DataNetworkListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~mobile_network_management_client.models.DataNetworkListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
