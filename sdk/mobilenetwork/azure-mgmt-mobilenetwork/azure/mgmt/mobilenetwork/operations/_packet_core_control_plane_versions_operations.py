...
def build_get_by_subscription_request(version_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PacketCoreControlPlaneVersionsOperations:
    ...
    @distributed_trace
    def get_by_subscription(self, version_name: str, **kwargs: Any) -> _models.PacketCoreControlPlaneVersion:
        """Gets information about the specified packet core control plane version.
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.PacketCoreControlPlaneVersion"]:
        """Lists all supported packet core control planes versions.
