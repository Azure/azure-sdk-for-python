...
def build_list_sim_groups_request(
    resource_group_name: str, mobile_network_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class MobileNetworksOperations:
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, mobile_network_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, mobile_network_name: str, **kwargs: Any) -> _models.MobileNetwork:
    ...
    def _create_or_update_initial(
        ...
        parameters: Union[_models.MobileNetwork, IO[bytes]],
        **kwargs: Any
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.mobilenetwork.models.MobileNetwork or IO[bytes]
        :return: An instance of LROPoller that returns either MobileNetwork or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mobilenetwork.models.MobileNetwork]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.MobileNetwork].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.MobileNetwork](
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.MobileNetwork"]:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.MobileNetwork"]:
    ...
    def list_sim_groups(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_sim_groups_request(
                    resource_group_name=resource_group_name,
                    mobile_network_name=mobile_network_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
