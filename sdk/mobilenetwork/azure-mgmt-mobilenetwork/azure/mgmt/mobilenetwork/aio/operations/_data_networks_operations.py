...
from ...operations._data_networks_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_mobile_network_request, build_update_tags_request
T = TypeVar('T')
...
class DataNetworksOperations:
    ...
    async def begin_delete(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param data_network_name: The name of the data network.
    ...
    def list_by_mobile_network(
        ...
        mobile_network_name: str,
        **kwargs: Any
    ) -> AsyncIterable[_models.DataNetworkListResult]:
