...
from ...operations._services_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_mobile_network_request, build_update_tags_request
T = TypeVar('T')
...
class ServicesOperations:
    ...
    async def begin_create_or_update(
        ...
        parameters: _models.Service,
        **kwargs: Any
    ) -> AsyncLROPoller[_models.Service]:
    ...
    def list_by_mobile_network(
        ...
        mobile_network_name: str,
        **kwargs: Any
    ) -> AsyncIterable[_models.ServiceListResult]:
