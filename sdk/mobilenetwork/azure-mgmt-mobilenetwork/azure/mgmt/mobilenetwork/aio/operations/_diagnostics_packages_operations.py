...
from ...operations._diagnostics_packages_operations import (
...
class DiagnosticsPackagesOperations:
    ...
    async def begin_create_or_update(
        ...
        diagnostics_package_name: str,
        **kwargs: Any
    ) -> AsyncLROPoller[_models.DiagnosticsPackage]:
        ...
        :return: An instance of AsyncLROPoller that returns either DiagnosticsPackage or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.mobilenetwork.models.DiagnosticsPackage]
        ...
        if cont_token:
            return AsyncLROPoller[_models.DiagnosticsPackage].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.DiagnosticsPackage](
    ...
    def list_by_packet_core_control_plane(
    ...
    ) -> AsyncIterable["_models.DiagnosticsPackage"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.mobilenetwork.models.DiagnosticsPackage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
