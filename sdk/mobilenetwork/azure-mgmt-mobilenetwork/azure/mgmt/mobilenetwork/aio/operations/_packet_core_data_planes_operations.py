...
from ...operations._packet_core_data_planes_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_packet_core_control_plane_request, build_update_tags_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class PacketCoreDataPlanesOperations:
    """PacketCoreDataPlanesOperations async operations.
    ...
    def list_by_packet_core_control_plane(
        ...
        packet_core_control_plane_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.PacketCoreDataPlaneListResult"]:
