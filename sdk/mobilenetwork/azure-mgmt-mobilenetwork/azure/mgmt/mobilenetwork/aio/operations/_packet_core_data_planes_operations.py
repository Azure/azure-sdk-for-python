...
class PacketCoreDataPlanesOperations:
    ...
    async def _create_or_update_initial(
        ...
        packet_core_control_plane_name: str,
        packet_core_data_plane_name: str,
        parameters: Union[_models.PacketCoreDataPlane, IO[bytes]],
        **kwargs: Any
    ) -> _models.PacketCoreDataPlane:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.mobilenetwork.models.PacketCoreDataPlane or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either PacketCoreDataPlane or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.mobilenetwork.models.PacketCoreDataPlane]
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.PacketCoreDataPlane].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.PacketCoreDataPlane](
