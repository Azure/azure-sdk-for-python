...
class MobileNetworksOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.MobileNetwork].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.MobileNetwork](
    ...
    def list_sim_groups(
        self, resource_group_name: str, mobile_network_name: str, **kwargs: Any
    ) -> AsyncIterable["_models.SimGroup"]:
