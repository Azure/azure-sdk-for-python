...
from ...operations._mobile_networks_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_list_sim_ids_request_initial, build_update_tags_request
T = TypeVar('T')
...
class MobileNetworksOperations:
    ...
    def list_by_subscription(
        self,
        **kwargs: Any
    ) -> AsyncIterable[_models.MobileNetworkListResult]:
    ...
    async def _list_sim_ids_initial(
        self,
        resource_group_name: str,
        mobile_network_name: str,
        **kwargs: Any
    ...
    @distributed_trace_async
    async def begin_list_sim_ids(
        self,
        resource_group_name: str,
        mobile_network_name: str,
        **kwargs: Any
    ) -> AsyncLROPoller[_models.SimIdListResult]:
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._list_sim_ids_initial(  # type: ignore
                resource_group_name=resource_group_name,
                mobile_network_name=mobile_network_name,
                api_version=api_version,
                cls=lambda x,y,z: x,
