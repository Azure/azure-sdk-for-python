...
from ...operations._slices_operations import (
...
class SlicesOperations:
    ...
    async def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, mobile_network_name: str, slice_name: str, **kwargs: Any
    ) -> None:
        error_map = {
    ...
    _delete_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/mobileNetworks/{mobileNetworkName}/slices/{sliceName}"
    }
    ...
    async def _create_or_update_initial(
        ...
        slice_name: str,
        parameters: Union[_models.Slice, IO],
        **kwargs: Any
    ) -> _models.Slice:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :param slice_name: The name of the network slice. Required.
        :type slice_name: str
        :param parameters: Parameters supplied to update network slice tags. Required.
    ...
    list_by_mobile_network.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/mobileNetworks/{mobileNetworkName}/slices"
    }
