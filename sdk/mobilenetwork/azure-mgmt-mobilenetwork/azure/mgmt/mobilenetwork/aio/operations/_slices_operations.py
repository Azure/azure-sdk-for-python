...
class SlicesOperations:
    ...
    async def _create_or_update_initial(
        ...
        slice_name: str,
        parameters: Union[_models.Slice, IO[bytes]],
        **kwargs: Any
    ) -> _models.Slice:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.mobilenetwork.models.Slice or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Slice or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.mobilenetwork.models.Slice]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.Slice].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.Slice](
