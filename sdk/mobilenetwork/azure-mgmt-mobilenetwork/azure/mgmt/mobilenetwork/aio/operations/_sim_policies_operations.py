...
from ...operations._sim_policies_operations import (
...
class SimPoliciesOperations:
    ...
    async def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, mobile_network_name: str, sim_policy_name: str, **kwargs: Any
    ) -> None:
        error_map = {
    ...
    _delete_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/mobileNetworks/{mobileNetworkName}/simPolicies/{simPolicyName}"
    }
    ...
    async def get(
        ...
        deserialized = self._deserialize("SimPolicy", pipeline_response)
    ...
    async def _create_or_update_initial(
        ...
        sim_policy_name: str,
        parameters: Union[_models.SimPolicy, IO],
        **kwargs: Any
    ) -> _models.SimPolicy:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        mobile_network_name: str,
        sim_policy_name: str,
        parameters: _models.SimPolicy,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.SimPolicy]:
        """Creates or updates a SIM policy. Must be created in the same location as its parent mobile
        network.
        ...
        :param sim_policy_name: The name of the SIM policy. Required.
        :type sim_policy_name: str
        :param parameters: Parameters supplied to the create or update SIM policy operation. Required.
        ...
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no
         Retry-After header is present.
        :return: An instance of AsyncLROPoller that returns either SimPolicy or the result of
         cls(response)
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :param sim_policy_name: The name of the SIM policy. Required.
        :type sim_policy_name: str
        :param parameters: Parameters supplied to update SIM policy tags. Required.
    ...
    def list_by_mobile_network(
    ...
    ) -> AsyncIterable["_models.SimPolicy"]:
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("SimPolicyListResult", pipeline_response)
    ...
    list_by_mobile_network.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/mobileNetworks/{mobileNetworkName}/simPolicies"
    }
