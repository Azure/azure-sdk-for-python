...
class SimPoliciesOperations:
    ...
    async def _create_or_update_initial(
        ...
        sim_policy_name: str,
        parameters: Union[_models.SimPolicy, IO[bytes]],
        **kwargs: Any
    ) -> _models.SimPolicy:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.mobilenetwork.models.SimPolicy or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either SimPolicy or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.mobilenetwork.models.SimPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.SimPolicy].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.SimPolicy](
