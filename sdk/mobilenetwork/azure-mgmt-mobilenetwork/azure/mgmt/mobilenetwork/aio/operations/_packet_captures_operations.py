...
from ...operations._packet_captures_operations import (
...
class PacketCapturesOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.PacketCapture] = kwargs.pop("cls", None)
        ...
        if response.status_code == 200:
            deserialized = self._deserialize("PacketCapture", pipeline_response)
    ...
    _create_or_update_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/packetCoreControlPlanes/{packetCoreControlPlaneName}/packetCaptures/{packetCaptureName}"
    }
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.PacketCapture]:
        ...
        :param parameters: Parameters supplied to the create or update packet capture operation.
         Required.
        :type parameters: ~azure.mgmt.mobilenetwork.models.PacketCapture
        ...
        :return: An instance of AsyncLROPoller that returns either PacketCapture or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.mobilenetwork.models.PacketCapture]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param packet_capture_name: The name of the packet capture session. Required.
        :type packet_capture_name: str
        :param parameters: Parameters supplied to the create or update packet capture operation. Is
         either a PacketCapture type or a IO type. Required.
        :type parameters: ~azure.mgmt.mobilenetwork.models.PacketCapture or IO
    ...
    @distributed_trace_async
    async def get(
        self, resource_group_name: str, packet_core_control_plane_name: str, packet_capture_name: str, **kwargs: Any
    ) -> _models.PacketCapture:
        ...
        :type packet_capture_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PacketCapture or the result of cls(response)
        :rtype: ~azure.mgmt.mobilenetwork.models.PacketCapture
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    _stop_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/packetCoreControlPlanes/{packetCoreControlPlaneName}/packetCaptures/{packetCaptureName}/stop"
    }
    ...
    def list_by_packet_core_control_plane(
    ...
    ) -> AsyncIterable["_models.PacketCapture"]:
        ...
        :type packet_core_control_plane_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either PacketCapture or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.mobilenetwork.models.PacketCapture]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    list_by_packet_core_control_plane.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/packetCoreControlPlanes/{packetCoreControlPlaneName}/packetCaptures"
    }
