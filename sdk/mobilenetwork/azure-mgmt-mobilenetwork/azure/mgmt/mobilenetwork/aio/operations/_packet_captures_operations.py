    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the create or update packet capture operation. Is
         either a PacketCapture type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.mobilenetwork.models.PacketCapture or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either PacketCapture or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.mobilenetwork.models.PacketCapture]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return AsyncLROPoller[_models.PacketCapture].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.PacketCapture](
    ...
    def list_by_packet_core_control_plane(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_packet_core_control_plane_request(
                    resource_group_name=resource_group_name,
                    packet_core_control_plane_name=packet_core_control_plane_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
