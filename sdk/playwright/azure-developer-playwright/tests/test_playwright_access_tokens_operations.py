...
class TestPlaywrightAccessTokensOperations(PlaywrightClientTestBase):
    @PlaywrightPreparer()
    @recorded_by_proxy
    def test_access_tokens_create_or_replace(self, playwright_endpoint, playwright_workspace_id):
    ...
    @PlaywrightPreparer()
    @recorded_by_proxy
    def test_access_tokens_get(self, playwright_endpoint, playwright_workspace_id):
        client = self.create_client(endpoint=playwright_endpoint)
    ...
    @PlaywrightPreparer()
    @recorded_by_proxy
    def test_access_tokens_delete(self, playwright_endpoint, playwright_workspace_id):
        client = self.create_client(endpoint=playwright_endpoint)
        client.access_tokens.create_or_replace(
            workspace_id=playwright_workspace_id,
