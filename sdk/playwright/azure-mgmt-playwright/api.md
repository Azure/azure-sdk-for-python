...
namespace azure.mgmt.playwright.types

    class azure.mgmt.playwright.types.CheckNameAvailabilityRequest(TypedDict, total=False):
        key "name": str
        key "type": str
        name: str
        type: str
    ...
    class azure.mgmt.playwright.types.ManagedServiceIdentity(TypedDict, total=False):
        key "principalId": str
        key "tenantId": str
    ...
    class azure.mgmt.playwright.types.PlaywrightWorkspace(TrackedResource):
        key "id": str
        key "identity": ForwardRef('ManagedServiceIdentity', module='types')
        key "location": Required[str]
        key "name": str
        key "properties": ForwardRef('PlaywrightWorkspaceProperties', module='types')
    ...
    class azure.mgmt.playwright.types.PlaywrightWorkspaceProperties(TypedDict, total=False):
        key "dataplaneUri": str
        key "localAuth": Union[str, EnablementStatus]
        key "provisioningState": Union[str, ProvisioningState]
        key "regionalAffinity": Union[str, EnablementStatus]
        key "reporting": Union[str, EnablementStatus]
        key "storageUri": str
        key "subnetId": str
        key "workspaceId": str
        dataplaneUri: str
    ...
    class azure.mgmt.playwright.types.PlaywrightWorkspaceUpdate(TypedDict, total=False):
        key "identity": ForwardRef('ManagedServiceIdentity', module='types')
        key "properties": ForwardRef('PlaywrightWorkspaceUpdateProperties', module='types')
        identity: ManagedServiceIdentity
        properties: PlaywrightWorkspaceUpdateProperties
        tags: dict[str, str]


    class azure.mgmt.playwright.types.PlaywrightWorkspaceUpdateProperties(TypedDict, total=False):
        key "localAuth": Union[str, EnablementStatus]
        key "regionalAffinity": Union[str, EnablementStatus]
        key "reporting": Union[str, EnablementStatus]
        key "storageUri": str
    ...
    class azure.mgmt.playwright.types.Resource(TypedDict, total=False):
        key "id": str
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
    ...
    class azure.mgmt.playwright.types.SystemData(TypedDict, total=False):
        key "createdAt": str
        key "createdBy": str
    ...
    class azure.mgmt.playwright.types.TrackedResource(Resource):
        key "id": str
        key "location": Required[str]
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
    ...
    class azure.mgmt.playwright.types.UserAssignedIdentity(TypedDict, total=False):
        key "clientId": str
        key "principalId": str
        clientId: str
        principalId: str
