...
def build_list_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Search/offerings")
...
class OfferingsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.OfferingsByRegion"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.search.models.OfferingsByRegion]
