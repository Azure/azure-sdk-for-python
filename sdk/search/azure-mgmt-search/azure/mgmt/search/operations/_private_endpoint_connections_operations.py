...
class PrivateEndpointConnectionsOperations(object):
    ...
    def update(
            self, resource_group_name, search_service_name, private_endpoint_connection_name, properties=None, search_management_request_options=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param private_endpoint_connection_name: The name of the private
         endpoint connection to the Azure Cognitive Search service with the
        ...
        :rtype: ~azure.mgmt.search.models.PrivateEndpointConnection or
    ...
    def get(
            self, resource_group_name, search_service_name, private_endpoint_connection_name, search_management_request_options=None, custom_headers=None, raw=False, **operation_config):
    ...
    def delete(
        ...
        return deserialized
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{searchServiceName}/privateEndpointConnections/{privateEndpointConnectionName}'}
    ...
    def list_by_service(
        ...
        :rtype:
         ~azure.mgmt.search.models.PrivateEndpointConnectionPaged[~azure.mgmt.search.models.PrivateEndpointConnection]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        client_request_id = None
        if search_management_request_options is not None:
        ...
        return deserialized
    list_by_service.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{searchServiceName}/privateEndpointConnections'}
