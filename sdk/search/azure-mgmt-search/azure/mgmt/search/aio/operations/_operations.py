...
from ...operations._operations import (
    build_admin_keys_get_request,
    build_admin_keys_regenerate_request,
    ...
    build_private_link_resources_list_supported_request,
    build_query_keys_create_request,
    build_query_keys_delete_request,
    build_query_keys_list_by_search_service_request,
    build_search_management_usage_by_subscription_sku_request,
    ...
    build_services_list_by_subscription_request,
    build_services_update_request,
    build_services_upgrade_request,
    build_shared_private_link_resources_create_or_update_request,
    build_shared_private_link_resources_delete_request,
    build_shared_private_link_resources_get_request,
    build_shared_private_link_resources_list_by_service_request,
    build_usages_list_by_subscription_request,
)
...
class Operations:
    ...
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.Operation"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.search.models.Operation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class PrivateEndpointConnectionsOperations:
    ...
    def list_by_service(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.search.models.PrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class SharedPrivateLinkResourcesOperations:
    ...
    def list_by_service(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.search.models.SharedPrivateLinkResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class NetworkSecurityPerimeterConfigurationsOperations:  # pylint: disable=name-too-long
    ...
    def list_by_service(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.search.models.NetworkSecurityPerimeterConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class ServicesOperations:
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, search_service_name: str, **kwargs: Any) -> _models.SearchService:
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, search_service_name: str, **kwargs: Any) -> None:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.SearchService"]:
...
class UsagesOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, location: str, **kwargs: Any) -> AsyncItemPaged["_models.QuotaUsageResult"]:
...
class AdminKeysOperations:
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, search_service_name: str, **kwargs: Any) -> _models.AdminKeyResult:
...
class QueryKeysOperations:
    ...
    @distributed_trace_async
    async def create(
        self, resource_group_name: str, search_service_name: str, name: str, **kwargs: Any
    ) -> _models.QueryKey:
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, search_service_name: str, key: str, **kwargs: Any) -> None:
...
class _SearchManagementClientOperationsMixin(
    ...
    @distributed_trace_async
    async def usage_by_subscription_sku(self, location: str, sku_name: str, **kwargs: Any) -> _models.QuotaUsageResult:
