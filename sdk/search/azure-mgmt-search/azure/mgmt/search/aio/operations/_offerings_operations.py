...
class OfferingsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.OfferingsByRegion"]:
        """Lists all of the features and SKUs offered by the Azure AI Search service in each region.

        :return: An iterator like instance of either OfferingsByRegion or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.search.models.OfferingsByRegion]
