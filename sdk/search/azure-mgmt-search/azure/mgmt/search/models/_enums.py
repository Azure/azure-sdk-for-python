...
class AutoGeneratedDomainNameLabelScope(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    NO_REUSE = "NoReuse"
    """Service name will always have a unique auto-generated hash (regardless of tenant or
    subscription)."""
...
class KnowledgeRetrieval(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    FREE = "free"
    """Enables knowledge retrieval on a search service and indicates that it is to be used within the
    limits of the free plan. The free plan would cap the volume of knowledge retrieval requests and
    is offered at no extra charge."""
    STANDARD = "standard"
    """Enables knowledge retrieval on a search service as a billable feature after the free quota is
    exhausted, with higher throughput and volume of knowledge retrieval requests."""
...
class ProvisioningState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    """The search service is being provisioned or scaled up or down. For dedicated search services
    only."""
    FAILED = "failed"
...
class SearchSemanticSearch(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    offered at no extra charge. This is the default for newly provisioned search services. This is
    the default."""
    STANDARD = "standard"
    """Enables semantic reranker on a search service as a billable feature after the free quota is
    exhausted, with higher throughput and volume of semantically reranked queries."""
...
class SkuName(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    """Serverless tier, offering low-touch, consumption-based, and pay-as-you-go experience, with
