...
class SearchService(TrackedResource):
    ...
    def __init__(self, *, location: str, tags=None, replica_count: int=1, partition_count: int=1, hosting_mode="default", public_network_access="enabled", network_rule_set=None, sku=None, identity=None, **kwargs) -> None:
...
class SearchServiceUpdate(Resource):
    ...
    def __init__(self, *, replica_count: int=1, partition_count: int=1, hosting_mode="default", public_network_access="enabled", network_rule_set=None, sku=None, location: str=None, tags=None, identity=None, **kwargs) -> None:
...
class SharedPrivateLinkResourceProperties(Model):
    ...
    def __init__(self, *, private_link_resource_id: str=None, group_id: str=None, request_message: str=None, resource_region: str=None, status=None, provisioning_state=None, **kwargs) -> None:
