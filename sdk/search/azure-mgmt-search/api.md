...
namespace azure.mgmt.search.aio.operations
    ...
    class azure.mgmt.search.aio.operations.OfferingsOperations:
        ...
        @distributed_trace_async
        @api_version_validation(method_added_on='2026-09-01-preview', params_added_on={'2026-09-01-preview': ['api_version', 'accept']}, api_versions_list=['2026-09-01-preview'])
        async def fetch(self, **kwargs: Any) -> OfferingsResult: ...
...
namespace azure.mgmt.search.models
    ...
    class azure.mgmt.search.models.AutoGeneratedDomainNameLabelScope(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        NO_REUSE = "NoReuse"
    ...
    class azure.mgmt.search.models.OfferingsResult(_Model):
        default_region: Optional[str]
        regions: Optional[list[OfferingsByRegion]]
...
namespace azure.mgmt.search.operations
    ...
    class azure.mgmt.search.operations.OfferingsOperations:
        ...
        @distributed_trace
        @api_version_validation(method_added_on='2026-09-01-preview', params_added_on={'2026-09-01-preview': ['api_version', 'accept']}, api_versions_list=['2026-09-01-preview'])
        def fetch(self, **kwargs: Any) -> OfferingsResult: ...
...
namespace azure.mgmt.search.types
    ...
    class azure.mgmt.search.types.CheckNameAvailabilityInput(TypedDict, total=False):
        ...
        key "type": Required[Literal["searchServices"]]
        name: str
        type: Literal[searchServices]
    ...
    class azure.mgmt.search.types.NetworkRuleSet(TypedDict, total=False):
    ...
    class azure.mgmt.search.types.PrivateEndpointConnectionProperties(TypedDict, total=False):
        key "groupId": str
    ...
    class azure.mgmt.search.types.PrivateEndpointConnectionPropertiesPrivateLinkServiceConnectionState(TypedDict, total=False):
    ...
    class azure.mgmt.search.types.ProxyResource(Resource):
        key "id": str
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
    ...
    class azure.mgmt.search.types.Resource(TypedDict, total=False):
        key "id": str
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
    ...
    class azure.mgmt.search.types.SearchResourceEncryptionKey(TypedDict, total=False):
        key "accessCredentials": ForwardRef('AzureActiveDirectoryApplicationCredentials', module='types')
        key "identity": Optional[DataIdentity]
    ...
    class azure.mgmt.search.types.SearchServiceProperties(TypedDict, total=False):
        key "authOptions": ForwardRef('DataPlaneAuthOptions', module='types')
        key "autoGeneratedDomainNameLabelScope": Optional[Union[str, AutoGeneratedDomainNameLabelScope]]
        key "computeType": Union[str, ComputeType]
        key "disableLocalAuth": Optional[bool]
        key "eTag": str
        key "encryptionWithCmk": ForwardRef('EncryptionWithCmk', module='types')
        key "endpoint": str
        key "hostingMode": Union[str, HostingMode]
        key "knowledgeRetrieval": Optional[Union[str, KnowledgeRetrieval]]
        ...
        key "semanticSearch": Optional[Union[str, SearchSemanticSearch]]
        key "serviceUpgradedAt": str
    ...
    class azure.mgmt.search.types.SharedPrivateLinkResource(ProxyResource):
        key "id": str
        key "name": str
    ...
    class azure.mgmt.search.types.SharedPrivateLinkResourceProperties(TypedDict, total=False):
        key "groupId": str
        key "privateLinkResourceId": str
        key "provisioningState": Union[str, SharedPrivateLinkResourceProvisioningState]
    ...
    class azure.mgmt.search.types.Sku(TypedDict, total=False):
        key "name": Union[str, SkuName]
        name: Union[str, SkuName]


    class azure.mgmt.search.types.SystemData(TypedDict, total=False):
        key "createdAt": str
        key "createdBy": str
