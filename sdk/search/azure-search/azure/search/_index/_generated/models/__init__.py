...
try:
    ...
    from ._models_py3 import ComponentsSchemasFacetresultAdditionalproperties
    ...
    from ._models import ComponentsSchemasFacetresultAdditionalproperties  # type: ignore
