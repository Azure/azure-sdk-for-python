...
class AutocompleteItem(msrest.serialization.Model):
    ...
    :ivar text: The completed term.
    :vartype text: str
    :ivar query_plus_text: The query along with the completed term.
    :vartype query_plus_text: str
    """

    _validation = {
        'text': {'readonly': True},
        'query_plus_text': {'readonly': True},
    }
...
class AutocompleteRequest(msrest.serialization.Model):
    ...
    :param search_text: The search text on which to base autocomplete results.
    :type search_text: str
    :param autocomplete_mode:  Possible values include: 'oneTerm', 'twoTerms',
     'oneTermWithContext'.
    :type autocomplete_mode: str or ~search_index_client.models.AutocompleteMode
    :param filter: An OData expression that filters the documents used to produce completed terms
     for the Autocomplete result.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.minimum_coverage = kwargs.get('minimum_coverage', None)
        self.search_fields = kwargs.get('search_fields', None)
        self.suggester_name = kwargs.get('suggester_name', None)
        self.top = kwargs.get('top', None)
...
class AutocompleteResult(msrest.serialization.Model):
    ...
    :ivar results: The list of returned Autocompleted items.
...
class ComponentsSchemasFacetresultAdditionalproperties(msrest.serialization.Model):
    """ComponentsSchemasFacetresultAdditionalproperties.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ComponentsSchemasFacetresultAdditionalproperties, self).__init__(**kwargs)
...
class IndexingResult(msrest.serialization.Model):
    ...
    :ivar key: The key of a document that was in the indexing request.
    :vartype key: str
...
class SearchDocumentsResult(msrest.serialization.Model):
    ...
    :ivar next_page_parameters: Parameters for filtering, sorting, faceting, paging, and other
     search query behaviors.
    :vartype next_page_parameters: ~search_index_client.models.SearchRequest
    :ivar results: The sequence of results returned by the query.
...
class SearchRequest(msrest.serialization.Model):
    ...
    :param order_by: The comma-separated list of OData $orderby expressions by which to sort the
     ...
     document match score. There can be at most 32 $orderby clauses.
    :type order_by: str
    :param query_type:  Possible values include: 'simple', 'full'.
    :type query_type: str or ~search_index_client.models.QueryType
    :param scoring_parameters: The list of parameter values to be used in scoring functions (for
     example, referencePointParameter) using the format name-values. For example, if the scoring
     profile defines a function with a parameter called 'mylocation' the parameter string would be
    ...
    :param search_fields: The comma-separated list of field names to which to scope the full-text
     ...
     this parameter.
    :type search_fields: str
    :param search_mode:  Possible values include: 'any', 'all'.
    :type search_mode: str or ~search_index_client.models.SearchMode
...
class SuggestResult(msrest.serialization.Model):
    ...
    :param additional_properties: Unmatched properties from the message are deserialized to this
     collection.
    :type additional_properties: dict[str, object]
    :ivar text: The text of the suggestion result.
    :vartype text: str
    """
