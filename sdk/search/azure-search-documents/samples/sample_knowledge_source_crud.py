...
def list_knowledge_sources():
    ...
    index_client.create_or_update_knowledge_source(companion)
    try:
        sources = list(
            index_client.list_knowledge_sources(
        ...
        index_client.delete_knowledge_source(companion_name)
    # [END list_knowledge_sources]


def create_private_blob_knowledge_source():  # pylint: disable=too-many-locals
    ...
    # [START create_private_blob_knowledge_source]
    from azure.core.credentials import AzureKeyCredential
    ...
    try:
        created = index_client.create_or_update_knowledge_source(private_source)
        ...
        index_client.delete_knowledge_source(private_blob_source_name)
        indexer_client.close()
        index_client.close()
    # [END create_private_blob_knowledge_source]
...
if __name__ == "__main__":
    ...
    create_private_blob_knowledge_source()
