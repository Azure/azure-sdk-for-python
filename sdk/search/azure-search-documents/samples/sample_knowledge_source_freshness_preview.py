...
"""
DESCRIPTION:
    Demonstrates persisted retrieve defaults and freshness-aware retrieval.
...
def main():
    ...
    try:
        # [START sample_knowledge_source_freshness_preview]
        ...
        try:
            request = KnowledgeBaseRetrievalRequest(
                ...
                intents=[
                    KnowledgeRetrievalSemanticIntent(search="Which hotels were renovated recently and include parking?")
                ],
        ...
        # [END sample_knowledge_source_freshness_preview]
    finally:
        if index_client:
            cleanup_resources(
                index_client,
