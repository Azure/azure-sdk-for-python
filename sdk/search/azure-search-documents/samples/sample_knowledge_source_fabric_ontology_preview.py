...
"""
DESCRIPTION:
    Demonstrates preview Fabric Ontology knowledge source setup and retrieval.
...
def main():
    # [START sample_knowledge_source_fabric_ontology_preview]
    ...
    try:
        ...
        # [END sample_knowledge_source_fabric_ontology_preview]
    finally:
        cleanup_resources(
            index_client,
