...
"""
DESCRIPTION:
    Demonstrates preview Fabric Data Agent knowledge source setup and retrieval using async clients.
...
async def main():
    # [START sample_knowledge_source_fabric_data_agent_preview_async]
    ...
    async with index_client:
        try:
            ...
            # [END sample_knowledge_source_fabric_data_agent_preview_async]
        finally:
