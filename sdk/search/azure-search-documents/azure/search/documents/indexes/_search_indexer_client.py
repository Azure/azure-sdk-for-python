...
class SearchIndexerClient(HeadersMixin):  # pylint: disable=R0904
    ...
    def create_indexer(self, indexer: SearchIndexer, **kwargs: Any) -> SearchIndexer:
        ...
        result = self._client.indexers_operations.create(indexer, **kwargs)
        return result
    ...
    def delete_data_source_connection(
        ...
        **kwargs: Any
        ...
        self._client.data_sources_operations.delete(data_source_name=name, etag=etag, match_condition=match_condition, **kwargs)
