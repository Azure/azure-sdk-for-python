...
class CharFilterName(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    <https://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/charfilter/HTMLStripCharFilter.html>`_"""
...
class ChatCompletionResponseFormatType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class IndexProjectionMode(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    """The source document will be written into the indexer's target index. This is the default
    pattern."""
...
class LexicalAnalyzerName(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    <https://learn.microsoft.com/rest/api/searchservice/Custom-analyzers-in-Azure-Search#Analyzers>`_"""
    KEYWORD = "keyword"
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/core/KeywordAnalyzer.html>`_"""
    PATTERN = "pattern"
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/PatternAnalyzer.html>`_"""
    SIMPLE = "simple"
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/core/SimpleAnalyzer.html>`_"""
    STOP = "stop"
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/core/StopAnalyzer.html>`_"""
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/core/WhitespaceAnalyzer.html>`_"""
...
class LexicalNormalizerName(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/ASCIIFoldingFilter.html>`_"""
    ELISION = "elision"
    """Removes elisions. For example, "l'avion" (the plane) will be converted to "avion" (plane). See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/util/ElisionFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/util/ElisionFilter.html>`_"""
    LOWERCASE = "lowercase"
    ...
    <https://lucene.apache.org/core/6_6_1/analyzers-common/org/apache/lucene/analysis/core/LowerCaseFilter.html>`_"""
    STANDARD = "standard"
    """Standard normalizer, which consists of lowercase and asciifolding. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/reverse/ReverseStringFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/reverse/ReverseStringFilter.html>`_"""
    UPPERCASE = "uppercase"
    ...
    <https://lucene.apache.org/core/6_6_1/analyzers-common/org/apache/lucene/analysis/core/UpperCaseFilter.html>`_"""
...
class LexicalTokenizerName(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/standard/ClassicTokenizer.html>`_"""
    EDGE_N_GRAM = "edgeNGram"
    """Tokenizes the input from an edge into n-grams of the given size(s). See
    `https://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/ngram/EdgeNGramTokenizer.html
    <https://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/ngram/EdgeNGramTokenizer.html>`_"""
    KEYWORD = "keyword_v2"
    """Emits the entire input as a single token. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/core/KeywordTokenizer.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/core/KeywordTokenizer.html>`_"""
    LETTER = "letter"
    """Divides text at non-letters. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/core/LetterTokenizer.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/core/LetterTokenizer.html>`_"""
    LOWERCASE = "lowercase"
    """Divides text at non-letters and converts them to lower case. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/core/LowerCaseTokenizer.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/core/LowerCaseTokenizer.html>`_"""
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/ngram/NGramTokenizer.html>`_"""
    PATH_HIERARCHY = "path_hierarchy_v2"
    """Tokenizer for path-like hierarchies. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/path/PathHierarchyTokenizer.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/path/PathHierarchyTokenizer.html>`_"""
    PATTERN = "pattern"
    """Tokenizer that uses regex pattern matching to construct distinct tokens. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/pattern/PatternTokenizer.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/pattern/PatternTokenizer.html>`_"""
    STANDARD = "standard_v2"
    """Standard Lucene analyzer; Composed of the standard tokenizer, lowercase filter and stop filter.
    See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/standard/StandardTokenizer.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/standard/StandardTokenizer.html>`_"""
    UAX_URL_EMAIL = "uax_url_email"
    """Tokenizes urls and emails as one token. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/standard/UAX29URLEmailTokenizer.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/standard/UAX29URLEmailTokenizer.html>`_"""
    WHITESPACE = "whitespace"
...
class MarkdownParsingSubmode(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    ONE_TO_MANY = "oneToMany"
    """Indicates that each section of the markdown file (up to a specified depth) will be parsed into
    individual search documents. This can result in a single markdown file producing multiple
...
class OcrLineEnding(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class RankingOrder(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class RegexFlags(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Defines a regular expression flag that can be used in the pattern analyzer and pattern
    tokenizer.
    """
...
class SearchFieldDataType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    HALF = "Edm.Half"
    """Indicates that a field contains a half-precision floating point number. This is only valid when
...
class TokenFilterName(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/ar/ArabicNormalizationFilter.html>`_"""
    APOSTROPHE = "apostrophe"
    """Strips all characters after an apostrophe (including the apostrophe itself). See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/tr/ApostropheFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/tr/ApostropheFilter.html>`_"""
    ASCII_FOLDING = "asciifolding"
    """Converts alphabetic, numeric, and symbolic Unicode characters which are not in the first 127
    ASCII characters (the "Basic Latin" Unicode block) into their ASCII equivalents, if such
    equivalents exist. See
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/cjk/CJKBigramFilter.html>`_"""
    CJK_WIDTH = "cjk_width"
    """Normalizes CJK width differences. Folds full-width ASCII variants into the equivalent basic
    Latin, and half-width Katakana variants into the equivalent Kana. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/cjk/CJKWidthFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/cjk/CJKWidthFilter.html>`_"""
    CLASSIC = "classic"
    """Removes English possessives, and dots from acronyms. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/standard/ClassicFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/standard/ClassicFilter.html>`_"""
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/commongrams/CommonGramsFilter.html>`_"""
    EDGE_N_GRAM = "edgeNGram_v2"
    """Generates n-grams of the given size(s) starting from the front or the back of an input token.
    See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/ngram/EdgeNGramTokenFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/ngram/EdgeNGramTokenFilter.html>`_"""
    ELISION = "elision"
    """Removes elisions. For example, "l'avion" (the plane) will be converted to "avion" (plane). See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/util/ElisionFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/util/ElisionFilter.html>`_"""
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/de/GermanNormalizationFilter.html>`_"""
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/hi/HindiNormalizationFilter.html>`_"""
    INDIC_NORMALIZATION = "indic_normalization"
    """Normalizes the Unicode representation of text in Indian languages. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/in/IndicNormalizationFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/in/IndicNormalizationFilter.html>`_"""
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/KeywordRepeatFilter.html>`_"""
    K_STEM = "kstem"
    """A high-performance kstem filter for English. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/en/KStemFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/en/KStemFilter.html>`_"""
    LENGTH = "length"
    """Removes words that are too long or too short. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/LengthFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/LengthFilter.html>`_"""
    LIMIT = "limit"
    """Limits the number of tokens while indexing. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/LimitTokenCountFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/LimitTokenCountFilter.html>`_"""
    LOWERCASE = "lowercase"
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/ngram/NGramTokenFilter.html>`_"""
    PERSIAN_NORMALIZATION = "persian_normalization"
    """Applies normalization for Persian. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/fa/PersianNormalizationFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/fa/PersianNormalizationFilter.html>`_"""
    PHONETIC = "phonetic"
    """Create tokens for phonetic matches. See
    `https://lucene.apache.org/core/4_10_3/analyzers-phonetic/org/apache/lucene/analysis/phonetic/package-tree.html
    <https://lucene.apache.org/core/4_10_3/analyzers-phonetic/org/apache/lucene/analysis/phonetic/package-tree.html>`_"""
    PORTER_STEM = "porter_stem"
    """Uses the Porter stemming algorithm to transform the token stream. See
    `http://tartarus.org/~martin/PorterStemmer <http://tartarus.org/~martin/PorterStemmer>`_"""
    REVERSE = "reverse"
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/ScandinavianNormalizationFilter.html>`_"""
    SCANDINAVIAN_FOLDING_NORMALIZATION = "scandinavian_folding"
    """Folds Scandinavian characters Ã¥Ã…Ã¤Ã¦Ã„Ã†-&gt;a and Ã¶Ã–Ã¸Ã˜-&gt;o. It also discriminates
    against use of double vowels aa, ae, ao, oe and oo, leaving just the first one. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/ScandinavianFoldingFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/ScandinavianFoldingFilter.html>`_"""
    SHINGLE = "shingle"
    """Creates combinations of tokens as a single token. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/shingle/ShingleFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/shingle/ShingleFilter.html>`_"""
    SNOWBALL = "snowball"
    """A filter that stems words using a Snowball-generated stemmer. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/snowball/SnowballFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/snowball/SnowballFilter.html>`_"""
    SORANI_NORMALIZATION = "sorani_normalization"
    """Normalizes the Unicode representation of Sorani text. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/ckb/SoraniNormalizationFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/ckb/SoraniNormalizationFilter.html>`_"""
    STEMMER = "stemmer"
    ...
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/TrimFilter.html>`_"""
    TRUNCATE = "truncate"
    """Truncates the terms to a specific length. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/TruncateTokenFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/TruncateTokenFilter.html>`_"""
    UNIQUE = "unique"
    """Filters out tokens with same text as the previous token. See
    `http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/RemoveDuplicatesTokenFilter.html
    <http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/RemoveDuplicatesTokenFilter.html>`_"""
    UPPERCASE = "uppercase"
...
class VectorSearchCompressionKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    values are compressed to a narrower type by discretizing and representing each component of a
    vector using a reduced set of quantized values, thereby reducing the overall data size."""
    BINARY_QUANTIZATION = "binaryQuantization"
    """Binary Quantization, a type of compression method. In binary quantization, the original vectors
    values are compressed to the narrower binary type by discretizing and representing each
...
class VectorSearchCompressionRescoreStorageMethod(  # pylint: disable=name-too-long
    ...
    """This option preserves the original full-precision vectors. Choose this option for maximum
    flexibility and highest quality of compressed search results. This consumes more storage but
    allows for rescoring and oversampling."""
    DISCARD_ORIGINALS = "discardOriginals"
    """This option discards the original full-precision vectors. Choose this option for maximum
    storage savings. Since this option does not allow for rescoring and oversampling, it will often
    cause slight to moderate reductions in quality."""
...
class VectorSearchVectorizerKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    Vectorize API."""
    AML = "aml"
    """Generate embeddings using an Azure Machine Learning endpoint deployed via the Azure AI Foundry
