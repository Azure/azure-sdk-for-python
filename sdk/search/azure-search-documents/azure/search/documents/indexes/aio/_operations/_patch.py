...
class _SearchIndexClientOperationsMixin(
    ...
    async def create_or_update_synonym_map(
        ...
        **kwargs: Any,
        ...
        :type synonym_map: ~azure.search.documents.indexes.models.SynonymMap or JSON
        :keyword match_condition: The match condition to use upon the etag. Default value is None.
        :paramtype match_condition: ~azure.core.MatchConditions
        :return: SynonymMap
    ...
    async def delete_knowledge_source_file(
        ...
        **kwargs: Any,
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        await self._delete_knowledge_source_file(name=name, file_id=file_id, **kwargs)

    @distributed_trace_async
    # pylint: disable-next=arguments-renamed
    async def update_knowledge_source_file(  # type: ignore[override]
        self,
        name: str,
        file_id: str,
        ...
        **kwargs: Any,
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return await super().update_knowledge_source_file(name=name, file_id=file_id, body=body, **kwargs)
