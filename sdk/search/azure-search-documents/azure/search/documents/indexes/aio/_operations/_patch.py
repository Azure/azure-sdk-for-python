...
class _SearchIndexClientOperationsMixin(_SearchIndexClientOperationsMixinGenerated):
    ...
    async def upload_knowledge_source_file(
        ...
        **kwargs: Any,
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return await self._upload_knowledge_source_file(name=name, file=cast(bytes, file), **kwargs)
    ...
    async def delete_knowledge_source_file(
        ...
        **kwargs: Any,
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return await self._delete_knowledge_source_file(name=name, file_id=file_id, **kwargs)
