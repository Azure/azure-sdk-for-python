...
from ._client import SearchIndexClient as _SearchIndexClient
from ._client import SearchIndexerClient as _SearchIndexerClient


class SearchIndexClient(_SearchIndexClient):
    """SearchIndexClient.
...
class SearchIndexerClient(_SearchIndexerClient):
    """SearchIndexerClient.
