...
class SearchIndexerClient(HeadersMixin):  # pylint: disable=R0904
    ...
    async def create_indexer(self, indexer: SearchIndexer, **kwargs: Any) -> SearchIndexer:
        ...
        result = await self._client.indexers_operations.create(indexer, **kwargs)
        return result
    ...
    async def create_or_update_indexer(
        ...
        **kwargs: Any
        ...
        result = await self._client.indexers_operations.create_or_update(
            indexer_name=name, indexer=indexer, prefer="return=representation", etag=indexer.e_tag, match_condition=match_condition, **kwargs
        )
        return result
    ...
    async def delete_data_source_connection(
        ...
        **kwargs: Any
        ...
        await self._client.data_sources_operations.delete(data_source_name=name, etag=etag, match_condition=match_condition, **kwargs)
