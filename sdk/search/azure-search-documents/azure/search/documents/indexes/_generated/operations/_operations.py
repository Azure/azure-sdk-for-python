...
def build_search_get_service_statistics_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DataSourcesOperationsOperations:
    ...
    @distributed_trace
    def get(self, data_source_name: str, **kwargs: Any) -> _models.SearchIndexerDataSource:
        # pylint: disable=line-too-long
...
class IndexersOperationsOperations:
    ...
    @distributed_trace
    def get(self, indexer_name: str, **kwargs: Any) -> _models.SearchIndexer:
        # pylint: disable=line-too-long
    ...
    @overload
    def create(self, indexer: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models.SearchIndexer:
        # pylint: disable=line-too-long
        """Creates a new indexer.
    ...
    @distributed_trace
    def create(self, indexer: Union[_models.SearchIndexer, JSON, IO[bytes]], **kwargs: Any) -> _models.SearchIndexer:
        # pylint: disable=line-too-long
        """Creates a new indexer.
    ...
    @distributed_trace
    def get_status(self, indexer_name: str, **kwargs: Any) -> _models.SearchIndexerStatus:
        # pylint: disable=line-too-long
...
class SkillsetsOperationsOperations:
    ...
    @distributed_trace
    def get(self, skillset_name: str, **kwargs: Any) -> _models.SearchIndexerSkillset:
        # pylint: disable=line-too-long
...
class SynonymMapsOperationsOperations:
    ...
    @distributed_trace
    def get(self, synonym_map_name: str, **kwargs: Any) -> _models.SynonymMap:
        # pylint: disable=line-too-long
    ...
    @overload
    def create(self, synonym_map: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models.SynonymMap:
        # pylint: disable=line-too-long
        """Creates a new synonym map.
    ...
    @distributed_trace
    def create(self, synonym_map: Union[_models.SynonymMap, JSON, IO[bytes]], **kwargs: Any) -> _models.SynonymMap:
        # pylint: disable=line-too-long
        """Creates a new synonym map.
...
class IndexesOperationsOperations:
    ...
    @overload
    def create(self, index: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models.SearchIndex:
        # pylint: disable=line-too-long
        """Creates a new search index.
    ...
    @overload
    def create(self, index: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> _models.SearchIndex:
        # pylint: disable=line-too-long
        """Creates a new search index.
    ...
    @distributed_trace
    def create(self, index: Union[_models.SearchIndex, JSON, IO[bytes]], **kwargs: Any) -> _models.SearchIndex:
        # pylint: disable=line-too-long
        """Creates a new search index.
    ...
    @distributed_trace
    def get(self, index_name: str, **kwargs: Any) -> _models.SearchIndex:
        # pylint: disable=line-too-long
    ...
    @distributed_trace
    def get_statistics(self, index_name: str, **kwargs: Any) -> _models.GetIndexStatisticsResult:
...
class SearchClientOperationsMixin(SearchClientMixinABC):
    ...
    @distributed_trace
    def get_service_statistics(self, **kwargs: Any) -> _models.SearchServiceStatistics:
        # pylint: disable=line-too-long
