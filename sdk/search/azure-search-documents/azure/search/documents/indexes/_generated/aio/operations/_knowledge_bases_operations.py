...
from ...operations._knowledge_bases_operations import (
...
class KnowledgeBasesOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param knowledge_base_name: The name of the knowledge base to create or update. Required.
        ...
        :param knowledge_base: The definition of the knowledge base to create or update. Required.
        ...
        :return: KnowledgeBase or the result of cls(response)
    ...
    async def create_or_update(
        ...
        knowledge_base_name: str,
        prefer: Union[str, _models.Enum0],
        knowledge_base: Union[_models.KnowledgeBase, IO[bytes]],
        if_match: Optional[str] = None,
        if_none_match: Optional[str] = None,
        request_options: Optional[_models.RequestOptions] = None,
        **kwargs: Any
        ...
        :type knowledge_base: ~azure.search.documents.indexes.models.KnowledgeBase or IO[bytes]
        :param if_match: Defines the If-Match condition. The operation will be performed only if the
         ETag on the server matches this value. Default value is None.
        :type if_match: str
        :param if_none_match: Defines the If-None-Match condition. The operation will be performed only
        ...
        cls: ClsType[_models.KnowledgeBase] = kwargs.pop("cls", None)
        ...
        if isinstance(knowledge_base, (IOBase, bytes)):
            ...
            _json = self._serialize.body(knowledge_base, "KnowledgeBase")
    ...
    async def delete(
        ...
        **kwargs: Any
        ...
        :param knowledge_base_name: The name of the knowledge base to delete. Required.
        :type knowledge_base_name: str
        :param if_match: Defines the If-Match condition. The operation will be performed only if the
         ETag on the server matches this value. Default value is None.
        :type if_match: str
    ...
    @distributed_trace_async
    async def get(
        self, knowledge_base_name: str, request_options: Optional[_models.RequestOptions] = None, **kwargs: Any
    ) -> _models.KnowledgeBase:
        """Retrieves an knowledge base definition.

        :param knowledge_base_name: The name of the knowledge base to retrieve. Required.
        :type knowledge_base_name: str
        :param request_options: Parameter group. Default value is None.
        :type request_options: ~azure.search.documents.indexes.models.RequestOptions
        :return: KnowledgeBase or the result of cls(response)
    ...
    def list(
    ...
    ) -> AsyncItemPaged["_models.KnowledgeBase"]:
        """Lists all knowledge bases available for a search service.

        :param request_options: Parameter group. Default value is None.
        :type request_options: ~azure.search.documents.indexes.models.RequestOptions
        :return: An iterator like instance of either KnowledgeBase or the result of cls(response)
        :rtype:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.ListKnowledgeBasesResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("ListKnowledgeBasesResult", pipeline_response)
            list_of_elem = deserialized.knowledge_bases
            if cls:
