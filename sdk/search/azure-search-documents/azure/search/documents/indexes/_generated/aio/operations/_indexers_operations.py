...
class IndexersOperations:
    ...
    async def resync(
        self,
        indexer_name: str,
        indexer_resync: Union[_models.IndexerResyncBody, IO[bytes]],
        request_options: Optional[_models.RequestOptions] = None,
        **kwargs: Any
    ) -> None:
        """Resync selective options from the datasource to be re-ingested by the indexer.
        ...
        :param indexer_name: The name of the indexer to resync for. Required.
        :type indexer_name: str
        :param indexer_resync: Is either a IndexerResyncBody type or a IO[bytes] type. Required.
        :type indexer_resync: ~azure.search.documents.indexes.models.IndexerResyncBody or IO[bytes]
        :param request_options: Parameter group. Default value is None.
        :type request_options: ~azure.search.documents.indexes.models.RequestOptions
        :return: None or the result of cls(response)
        :rtype: None
        ...
        if isinstance(indexer_resync, (IOBase, bytes)):
            ...
            _json = self._serialize.body(indexer_resync, "IndexerResyncBody")
