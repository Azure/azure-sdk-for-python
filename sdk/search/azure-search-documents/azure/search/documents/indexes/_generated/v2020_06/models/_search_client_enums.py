...
class CharFilterName(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    ...
    #: https://lucene.apache.org/core/4_10_3/analyzers-
...
class LexicalAnalyzerName(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    ...
    #: ids, and some product names. See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/core/KeywordAnalyzer.html.
    KEYWORD = "keyword"
    #: Flexibly separates text into terms via a regular expression pattern. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/miscellaneous/PatternAnalyzer.html.
    PATTERN = "pattern"
    #: Divides text at non-letters and converts them to lower case. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/core/SimpleAnalyzer.html.
    SIMPLE = "simple"
    #: Divides text at non-letters; Applies the lowercase and stopword token filters. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/core/StopAnalyzer.html.
    STOP = "stop"
    #: An analyzer that uses the whitespace tokenizer. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/core/WhitespaceAnalyzer.html.
...
class LexicalTokenizerName(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    ...
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/standard/ClassicTokenizer.html.
    CLASSIC = "classic"
    ...
    #: Emits the entire input as a single token. See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/core/KeywordTokenizer.html.
    KEYWORD = "keyword_v2"
    #: Divides text at non-letters. See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/core/LetterTokenizer.html.
    LETTER = "letter"
    #: Divides text at non-letters and converts them to lower case. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/core/LowerCaseTokenizer.html.
    LOWERCASE = "lowercase"
    ...
    N_GRAM = "nGram"
    #: Tokenizer for path-like hierarchies. See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/path/PathHierarchyTokenizer.html.
    PATH_HIERARCHY = "path_hierarchy_v2"
    #: Tokenizer that uses regex pattern matching to construct distinct tokens. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/pattern/PatternTokenizer.html.
    PATTERN = "pattern"
    #: Standard Lucene analyzer; Composed of the standard tokenizer, lowercase filter and stop filter.
    #: See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/standard/StandardTokenizer.html.
    STANDARD = "standard_v2"
    #: Tokenizes urls and emails as one token. See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/standard/UAX29URLEmailTokenizer.html.
    UAX_URL_EMAIL = "uax_url_email"
    #: Divides text at whitespace. See http://lucene.apache.org/core/4_10_3/analyzers-
...
class TokenFilterName(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    ...
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/ar/ArabicNormalizationFilter.html.
    ARABIC_NORMALIZATION = "arabic_normalization"
    #: Strips all characters after an apostrophe (including the apostrophe itself). See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/tr/ApostropheFilter.html.
    ...
    #: equivalents exist. See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/miscellaneous/ASCIIFoldingFilter.html.
    ASCII_FOLDING = "asciifolding"
    #: Forms bigrams of CJK terms that are generated from the standard tokenizer. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/cjk/CJKBigramFilter.html.
    ...
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/cjk/CJKWidthFilter.html.
    CJK_WIDTH = "cjk_width"
    #: Removes English possessives, and dots from acronyms. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/standard/ClassicFilter.html.
    CLASSIC = "classic"
    #: Construct bigrams for frequently occurring terms while indexing. Single terms are still indexed
    #: too, with bigrams overlaid. See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/commongrams/CommonGramsFilter.html.
    COMMON_GRAM = "common_grams"
    #: Generates n-grams of the given size(s) starting from the front or the back of an input token.
    #: See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/ngram/EdgeNGramTokenFilter.html.
    EDGE_N_GRAM = "edgeNGram_v2"
    #: Removes elisions. For example, "l'avion" (the plane) will be converted to "avion" (plane). See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/util/ElisionFilter.html.
    ELISION = "elision"
    ...
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/hi/HindiNormalizationFilter.html.
    HINDI_NORMALIZATION = "hindi_normalization"
    #: Normalizes the Unicode representation of text in Indian languages. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/in/IndicNormalizationFilter.html.
    INDIC_NORMALIZATION = "indic_normalization"
    #: Emits each incoming token twice, once as keyword and once as non-keyword. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/miscellaneous/KeywordRepeatFilter.html.
    KEYWORD_REPEAT = "keyword_repeat"
    #: A high-performance kstem filter for English. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/en/KStemFilter.html.
    K_STEM = "kstem"
    #: Removes words that are too long or too short. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/miscellaneous/LengthFilter.html.
    LENGTH = "length"
    #: Limits the number of tokens while indexing. See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/miscellaneous/LimitTokenCountFilter.html.
    LIMIT = "limit"
    #: Normalizes token text to lower case. See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/core/LowerCaseFilter.htm.
    LOWERCASE = "lowercase"
    #: Generates n-grams of the given size(s). See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/ngram/NGramTokenFilter.html.
    N_GRAM = "nGram_v2"
    #: Applies normalization for Persian. See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/fa/PersianNormalizationFilter.html.
    PERSIAN_NORMALIZATION = "persian_normalization"
    #: Create tokens for phonetic matches. See https://lucene.apache.org/core/4_10_3/analyzers-
    #: phonetic/org/apache/lucene/analysis/phonetic/package-tree.html.
    PHONETIC = "phonetic"
    #: Uses the Porter stemming algorithm to transform the token stream. See
    #: http://tartarus.org/~martin/PorterStemmer.
    PORTER_STEM = "porter_stem"
    #: Reverses the token string. See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/reverse/ReverseStringFilter.html.
    REVERSE = "reverse"
    #: Normalizes use of the interchangeable Scandinavian characters. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/miscellaneous/ScandinavianNormalizationFilter.html.
    ...
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/shingle/ShingleFilter.html.
    SHINGLE = "shingle"
    #: A filter that stems words using a Snowball-generated stemmer. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/snowball/SnowballFilter.html.
    SNOWBALL = "snowball"
    #: Normalizes the Unicode representation of Sorani text. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/ckb/SoraniNormalizationFilter.html.
    SORANI_NORMALIZATION = "sorani_normalization"
    #: Language specific stemming filter. See
    #: https://docs.microsoft.com/rest/api/searchservice/Custom-analyzers-in-Azure-
    #: Search#TokenFilters.
    STEMMER = "stemmer"
    #: Removes stop words from a token stream. See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/core/StopFilter.html.
    STOPWORDS = "stopwords"
    #: Trims leading and trailing whitespace from tokens. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/miscellaneous/TrimFilter.html.
    TRIM = "trim"
    #: Truncates the terms to a specific length. See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/miscellaneous/TruncateTokenFilter.html.
    TRUNCATE = "truncate"
    #: Filters out tokens with same text as the previous token. See
    #: http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/miscellaneous/RemoveDuplicatesTokenFilter.html.
    UNIQUE = "unique"
    #: Normalizes token text to upper case. See http://lucene.apache.org/core/4_10_3/analyzers-
    #: common/org/apache/lucene/analysis/core/UpperCaseFilter.html.
    UPPERCASE = "uppercase"
