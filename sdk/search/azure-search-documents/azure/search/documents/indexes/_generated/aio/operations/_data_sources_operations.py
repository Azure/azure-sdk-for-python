...
class DataSourcesOperations:
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: SearchServiceClientConfiguration = (
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize(
            "SearchIndexerDataSource", pipeline_response.http_response
        )
    ...
    async def list(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize(
            "ListDataSourcesResult", pipeline_response.http_response
        )
