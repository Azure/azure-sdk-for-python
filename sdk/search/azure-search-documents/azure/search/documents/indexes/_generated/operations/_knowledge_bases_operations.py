...
def build_create_or_update_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/knowledgebases('{knowledgeBaseName}')")
...
def build_get_request(
    knowledge_base_name: str, *, x_ms_client_request_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_request(*, x_ms_client_request_id: Optional[str] = None, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/knowledgebases")
...
class KnowledgeBasesOperations:
    ...
    ) -> ItemPaged["_models.KnowledgeBase"]:
