...
from .operations import (
    ...
    IndexersOperations,
    IndexesOperations,
    KnowledgeAgentsOperations,
    KnowledgeSourcesOperations,
    SkillsetsOperations,
    SynonymMapsOperations,
    _SearchServiceClientOperationsMixin,
)


class SearchServiceClient(_SearchServiceClientOperationsMixin):  # pylint: disable=too-many-instance-attributes
    """Client that can be used to manage and query indexes and documents, as well as manage other
    resources, on a search service.

    :ivar knowledge_agents: KnowledgeAgentsOperations operations
    :vartype knowledge_agents: azure.search.documents.indexes.operations.KnowledgeAgentsOperations
    :ivar knowledge_sources: KnowledgeSourcesOperations operations
    :vartype knowledge_sources:
     azure.search.documents.indexes.operations.KnowledgeSourcesOperations
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        self.knowledge_agents = KnowledgeAgentsOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
        self.knowledge_sources = KnowledgeSourcesOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
