...
class SearchServiceClient(_SearchServiceClientOperationsMixin):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype knowledge_bases: azure.search.documents.indexes.operations.KnowledgeBasesOperations
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        self.knowledge_bases = KnowledgeBasesOperations(self._client, self._config, self._serialize, self._deserialize)
