...
class IndexerCurrentState(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.all_docs_initial_change_tracking_state: Optional[str] = None
        self.all_docs_final_change_tracking_state: Optional[str] = None
        self.reset_docs_initial_change_tracking_state: Optional[str] = None
        self.reset_docs_final_change_tracking_state: Optional[str] = None
