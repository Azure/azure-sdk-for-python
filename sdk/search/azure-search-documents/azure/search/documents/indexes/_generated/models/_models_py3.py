...
class AzureOpenAIEmbeddingSkill(SearchIndexerSkill):
    """Allows you to generate a vector embedding for a given text input using the Azure Open AI
    service.
    ...
    :ivar outputs: The output of a skill is either a field in a search index, or a value that can
     be consumed as an input by another skill. Required.
    :vartype outputs: list[~search_service_client.models.OutputFieldMappingEntry]
    :ivar resource_uri: The resource uri for your Azure Open AI resource.
    :vartype resource_uri: str
    :ivar deployment_id: ID of your Azure Open AI model deployment on the designated resource.
    :vartype deployment_id: str
    :ivar api_key: API key for the designated Azure Open AI resource.
    :vartype api_key: str
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword outputs: The output of a skill is either a field in a search index, or a value that
         can be consumed as an input by another skill. Required.
        :paramtype outputs: list[~search_service_client.models.OutputFieldMappingEntry]
        :keyword resource_uri: The resource uri for your Azure Open AI resource.
        :paramtype resource_uri: str
        :keyword deployment_id: ID of your Azure Open AI model deployment on the designated resource.
        :paramtype deployment_id: str
        :keyword api_key: API key for the designated Azure Open AI resource.
...
class AzureOpenAIVectorizer(VectorSearchVectorizer):
    ...
    :ivar kind: The name of the kind of vectorization method being configured for use with vector
     search. Required. Known values are: "azureOpenAI" and "customWebApi".
    :vartype kind: str or ~search_service_client.models.VectorSearchVectorizerKind
    :ivar azure_open_ai_parameters: Contains the parameters specific to Azure Open AI embedding
     vectorization.
    ...
    def __init__(
        ...
        :keyword name: The name to associate with this particular vectorization method. Required.
        :paramtype name: str
        :keyword azure_open_ai_parameters: Contains the parameters specific to Azure Open AI embedding
         vectorization.
...
class CustomVectorizer(VectorSearchVectorizer):
    ...
    :ivar kind: The name of the kind of vectorization method being configured for use with vector
     search. Required. Known values are: "azureOpenAI" and "customWebApi".
    :vartype kind: str or ~search_service_client.models.VectorSearchVectorizerKind
    :ivar custom_vectorizer_parameters: Contains the parameters specific to generating vector
     embeddings via a custom endpoint.
    :vartype custom_vectorizer_parameters: ~search_service_client.models.CustomVectorizerParameters
    """
    ...
    _attribute_map = {
        "name": {"key": "name", "type": "str"},
        "kind": {"key": "kind", "type": "str"},
        "custom_vectorizer_parameters": {"key": "customVectorizerParameters", "type": "CustomVectorizerParameters"},
    }
    ...
    def __init__(
        ...
        *,
        name: str,
        custom_vectorizer_parameters: Optional["_models.CustomVectorizerParameters"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword name: The name to associate with this particular vectorization method. Required.
        :paramtype name: str
        :keyword custom_vectorizer_parameters: Contains the parameters specific to generating vector
         embeddings via a custom endpoint.
        :paramtype custom_vectorizer_parameters:
         ~search_service_client.models.CustomVectorizerParameters
        """
        super().__init__(name=name, **kwargs)
        self.kind: str = "customWebApi"
        self.custom_vectorizer_parameters = custom_vectorizer_parameters


class CustomVectorizerParameters(_serialization.Model):
    """Contains the parameters specific to generating vector embeddings via a custom endpoint.

    :ivar uri: The uri for the Web API.
    :vartype uri: str
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword uri: The uri for the Web API.
        :paramtype uri: str
...
class VectorSearchAlgorithmConfiguration(_serialization.Model):
    ...
    You probably want to use the sub-classes and not this class directly. Known sub-classes are:
    ExhaustiveKnnVectorSearchAlgorithmConfiguration, HnswVectorSearchAlgorithmConfiguration
...
class ExhaustiveKnnVectorSearchAlgorithmConfiguration(VectorSearchAlgorithmConfiguration):
...
class VectorSearchProfile(_serialization.Model):
    ...
    def __init__(self, *, name: str, algorithm: str, vectorizer: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword name: The name to associate with this particular vector search profile. Required.
        :paramtype name: str
        :keyword algorithm: The name of the vector search algorithm configuration that specifies the
         algorithm and optional parameters. Required.
