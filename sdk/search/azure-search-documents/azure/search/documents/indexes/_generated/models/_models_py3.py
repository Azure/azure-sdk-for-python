...
class AnalyzeRequest(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype char_filters: list[str] or list[~azure.search.documents.indexes.models.CharFilterName]
        """
        super().__init__(**kwargs)
        self.text = text
...
class CjkBigramTokenFilter(TokenFilter):
    ...
    :vartype ignore_scripts: list[str] or
     list[~azure.search.documents.indexes.models.CjkBigramTokenFilterScripts]
...
class EdgeNGramTokenizer(LexicalTokenizer):
    ...
    :vartype token_chars: list[str] or list[~azure.search.documents.indexes.models.TokenCharacterKind]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype token_chars: list[str] or list[~azure.search.documents.indexes.models.TokenCharacterKind]
        """
        super().__init__(name=name, **kwargs)
...
class EntityRecognitionSkill(SearchIndexerSkill):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype categories: list[str] or list[~azure.search.documents.indexes.models.EntityCategory]
        :keyword default_language_code: A value indicating which language code to use. Default is
...
class ImageAnalysisSkill(SearchIndexerSkill):
    ...
    :vartype visual_features: list[str] or list[~azure.search.documents.indexes.models.VisualFeature]
    :ivar details: A string indicating which domain-specific details to return.
    :vartype details: list[str] or list[~azure.search.documents.indexes.models.ImageDetail]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype visual_features: list[str] or list[~azure.search.documents.indexes.models.VisualFeature]
        :keyword details: A string indicating which domain-specific details to return.
        :paramtype details: list[str] or list[~azure.search.documents.indexes.models.ImageDetail]
        """
        super().__init__(name=name, description=description, context=context, inputs=inputs, outputs=outputs, **kwargs)
