...
class ExhaustiveKnnAlgorithmConfiguration(VectorSearchAlgorithmConfiguration):
    ...
    :vartype parameters: ~search_service_client.models.ExhaustiveKnnParameters
    """
    ...
    def __init__(
        ...
        :paramtype parameters: ~search_service_client.models.ExhaustiveKnnParameters
        """
        super().__init__(name=name, **kwargs)
...
class SearchIndex(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar semanic_search: Defines parameters for a search index that influence semantic
     capabilities.
    :vartype semanic_search: ~search_service_client.models.SemanticSearch
    ...
    def __init__(
        ...
        *,
        ...
        semanic_search: Optional["_models.SemanticSearch"] = None,
        ...
        **kwargs: Any
        ...
        :keyword semanic_search: Defines parameters for a search index that influence semantic
         capabilities.
        :paramtype semanic_search: ~search_service_client.models.SemanticSearch
        ...
        self.semanic_search = semanic_search
...
class SemanticConfiguration(_serialization.Model):
    ...
    :vartype name: str
    :ivar semantic_prioritized_fields: Describes the title, content, and keyword fields to be used
     ...
     Required.
    :vartype semantic_prioritized_fields: ~search_service_client.models.SemanticPrioritizedFields
    """

    _validation = {
        "name": {"required": True},
        "semantic_prioritized_fields": {"required": True},
    }

    _attribute_map = {
        "name": {"key": "name", "type": "str"},
        "semantic_prioritized_fields": {"key": "prioritizedFields", "type": "SemanticPrioritizedFields"},
    }

    def __init__(
        self, *, name: str, semantic_prioritized_fields: "_models.SemanticPrioritizedFields", **kwargs: Any
    ) -> None:
        """
        :keyword name: The name of the semantic configuration. Required.
        :paramtype name: str
        :keyword semantic_prioritized_fields: Describes the title, content, and keyword fields to be
         used for semantic ranking, captions, highlights, and answers. At least one of the three sub
         properties (titleField, prioritizedKeywordsFields and prioritizedContentFields) need to be set.
         Required.
        :paramtype semantic_prioritized_fields: ~search_service_client.models.SemanticPrioritizedFields
        """
        super().__init__(**kwargs)
        self.name = name
        self.semantic_prioritized_fields = semantic_prioritized_fields
...
class SemanticPrioritizedFields(_serialization.Model):
    ...
    :vartype content_fields: list[~search_service_client.models.SemanticField]
    ...
    :vartype keywords_fields: list[~search_service_client.models.SemanticField]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword content_fields: Defines the content fields to be used for semantic ranking, captions,
         ...
         natural language form. The order of the fields in the array represents their priority. Fields
         with lower priority may get truncated if the content is long.
        :paramtype content_fields: list[~search_service_client.models.SemanticField]
        :keyword keywords_fields: Defines the keyword fields to be used for semantic ranking, captions,
         highlights, and answers. For the best result, the selected fields should contain a list of
         keywords. The order of the fields in the array represents their priority. Fields with lower
         priority may get truncated if the content is long.
        :paramtype keywords_fields: list[~search_service_client.models.SemanticField]
        """
        super().__init__(**kwargs)
