...
class VectorSearchVectorizer(_serialization.Model):
    ...
    AIServicesVisionVectorizer, AMLVectorizer, AzureOpenAIVectorizer, CustomVectorizer
...
class VectorSearchCompressionConfiguration(_serialization.Model):
    ...
    _subtype_map = {"kind": {"scalarQuantization": "ScalarQuantizationCompressionConfiguration"}}
