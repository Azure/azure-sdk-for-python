...
class AzureOpenAIVectorizer(VectorSearchVectorizer):
    ...
    :vartype parameters: ~azure.search.documents.indexes.models.AzureOpenAIParameters
    """
    ...
    _attribute_map = {
        "vectorizer_name": {"key": "name", "type": "str"},
        "kind": {"key": "kind", "type": "str"},
        "parameters": {"key": "azureOpenAIParameters", "type": "AzureOpenAIParameters"},
    }

    def __init__(
        self, *, vectorizer_name: str, parameters: Optional["_models.AzureOpenAIParameters"] = None, **kwargs: Any
    ) -> None:
        """
        :keyword vectorizer_name: The name to associate with this particular vectorization method.
         Required.
        ...
        :paramtype parameters: ~azure.search.documents.indexes.models.AzureOpenAIParameters
        """
        super().__init__(vectorizer_name=vectorizer_name, **kwargs)
...
class CustomVectorizer(VectorSearchVectorizer):
    ...
    def __init__(
        ...
        *,
        vectorizer_name: str,
        custom_web_api_parameters: Optional["_models.CustomWebApiParameters"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword vectorizer_name: The name to associate with this particular vectorization method.
        ...
        :paramtype custom_web_api_parameters:
         ~azure.search.documents.indexes.models.CustomWebApiParameters
        """
        super().__init__(vectorizer_name=vectorizer_name, **kwargs)
...
class VectorSearchCompressionConfiguration(_serialization.Model):
    ...
    _subtype_map = {"kind": {"scalarQuantization": "ScalarQuantizationCompression"}}
...
class ScalarQuantizationCompression(VectorSearchCompressionConfiguration):
...
class SearchIndexerSkillset(_serialization.Model):
    ...
    :vartype index_projection: ~azure.search.documents.indexes.models.SearchIndexerIndexProjections
    ...
    _attribute_map = {
        ...
        "index_projection": {"key": "indexProjections", "type": "SearchIndexerIndexProjections"},
        "e_tag": {"key": "@odata\\.etag", "type": "str"},
        "encryption_key": {"key": "encryptionKey", "type": "SearchResourceEncryptionKey"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        index_projection: Optional["_models.SearchIndexerIndexProjections"] = None,
        e_tag: Optional[str] = None,
        encryption_key: Optional["_models.SearchResourceEncryptionKey"] = None,
        **kwargs: Any
    ) -> None:
