...
class AzureOpenAIEmbeddingSkill(SearchIndexerSkill, AzureOpenAIVectorizerParameters):
...
class KnowledgeBaseAzureOpenAIModel(KnowledgeBaseModel):
    ...
    _attribute_map = {
        "kind": {"key": "kind", "type": "str"},
        "azure_open_ai_parameters": {"key": "azureOpenAIParameters", "type": "AzureOpenAIVectorizerParameters"},
    }

    def __init__(self, *, azure_open_ai_parameters: "_models.AzureOpenAIVectorizerParameters", **kwargs: Any) -> None:
        """
...
class KnowledgeSourceAzureOpenAIVectorizer(KnowledgeSourceVectorizer):
    ...
    def __init__(
        self, *, azure_open_ai_parameters: Optional["_models.AzureOpenAIVectorizerParameters"] = None, **kwargs: Any
    ) -> None:
        """
...
class RemoteSharePointKnowledgeSource(KnowledgeSource):
    ...
    :ivar encryption_key: A description of an encryption key that you create in Azure Key Vault.
     ...
     and is only available for paid services created on or after January 1, 2019.
    :vartype encryption_key: ~azure.search.documents.indexes.models.SearchResourceEncryptionKey
    :ivar remote_share_point_parameters: The parameters for the knowledge source.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword encryption_key: A description of an encryption key that you create in Azure Key Vault.
         ...
         and is only available for paid services created on or after January 1, 2019.
        :paramtype encryption_key: ~azure.search.documents.indexes.models.SearchResourceEncryptionKey
        :keyword remote_share_point_parameters: The parameters for the knowledge source.
...
class SplitSkill(SearchIndexerSkill):
    ...
    :ivar parameters: Only applies if the unit is set to azureOpenAITokens. If specified, the
     splitSkill will use these parameters when performing the tokenization. The parameters are a
     valid 'encoderModelName' and an optional 'allowedSpecialTokens' property.
    :vartype parameters: ~azure.search.documents.indexes.models.AzureOpenAITokenizerParameters
    """
    ...
    _attribute_map = {
        ...
        "unit": {"key": "unit", "type": "str"},
        "parameters": {"key": "azureOpenAITokenizerParameters", "type": "AzureOpenAITokenizerParameters"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        parameters: Optional["_models.AzureOpenAITokenizerParameters"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword name: The name of the skill which uniquely identifies it within the skillset. A skill
        ...
        :keyword parameters: Only applies if the unit is set to azureOpenAITokens. If specified, the
         splitSkill will use these parameters when performing the tokenization. The parameters are a
         valid 'encoderModelName' and an optional 'allowedSpecialTokens' property.
        :paramtype parameters: ~azure.search.documents.indexes.models.AzureOpenAITokenizerParameters
        """
        super().__init__(name=name, description=description, context=context, inputs=inputs, outputs=outputs, **kwargs)
