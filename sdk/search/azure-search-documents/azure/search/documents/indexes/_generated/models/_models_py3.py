...
class IndexingParametersConfiguration(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        *,
        ...
        allow_skillset_to_read_file_data: Optional[str] = None,
...
class SearchIndex(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar semantic_search: Defines parameters for a search index that influence semantic
     capabilities.
    :vartype semantic_search: ~search_service_client.models.SemanticSearch
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword semantic_search: Defines parameters for a search index that influence semantic
         capabilities.
        :paramtype semantic_search: ~search_service_client.models.SemanticSearch
...
class SemanticConfiguration(_serialization.Model):
    ...
    :vartype prioritized_fields: ~search_service_client.models.SemanticPrioritizedFields
    """
    ...
    def __init__(self, *, name: str, prioritized_fields: "_models.SemanticPrioritizedFields", **kwargs: Any) -> None:
        ...
        :keyword prioritized_fields: Describes the title, content, and keyword fields to be used for
         semantic ranking, captions, highlights, and answers. At least one of the three sub properties
         (titleField, prioritizedKeywordsFields and prioritizedContentFields) need to be set. Required.
        :paramtype prioritized_fields: ~search_service_client.models.SemanticPrioritizedFields
        """
        super().__init__(**kwargs)
        self.name = name
