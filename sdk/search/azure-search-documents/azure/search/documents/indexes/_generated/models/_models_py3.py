...
class ChatCompletionSchema(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.additional_properties = additional_properties  # type: ignore
...
class KnowledgeAgent(_serialization.Model):
    ...
    :ivar target_indexes: Required.
    :vartype target_indexes: list[~azure.search.documents.indexes.models.KnowledgeAgentTargetIndex]
    ...
    _validation = {
        ...
        "target_indexes": {"required": True},
    }

    _attribute_map = {
        "name": {"key": "name", "type": "str"},
        "models": {"key": "models", "type": "[KnowledgeAgentModel]"},
        "target_indexes": {"key": "targetIndexes", "type": "[KnowledgeAgentTargetIndex]"},
    ...
    def __init__(
        ...
        *,
        ...
        target_indexes: List["_models.KnowledgeAgentTargetIndex"],
        ...
        **kwargs: Any
        ...
        :keyword target_indexes: Required.
        :paramtype target_indexes:
         list[~azure.search.documents.indexes.models.KnowledgeAgentTargetIndex]
...
class KnowledgeAgentTargetIndex(_serialization.Model):
    """KnowledgeAgentTargetIndex.

    All required parameters must be populated in order to send to server.

    :ivar index_name: The name of the target index. Required.
    :vartype index_name: str
    :ivar default_reranker_threshold: A threshold for reranking results (range: 0-4).
    :vartype default_reranker_threshold: float
    :ivar default_include_reference_source_data: Indicates whether reference source data should be
     included.
    :vartype default_include_reference_source_data: bool
    :ivar default_max_docs_for_reranker: Limits the number of documents considered for ranking.
    :vartype default_max_docs_for_reranker: int
    """

    _validation = {
        "index_name": {"required": True},
        "default_reranker_threshold": {"maximum": 4, "minimum": 0},
    }

    _attribute_map = {
        "index_name": {"key": "indexName", "type": "str"},
        "default_reranker_threshold": {"key": "defaultRerankerThreshold", "type": "float"},
        "default_include_reference_source_data": {"key": "defaultIncludeReferenceSourceData", "type": "bool"},
        "default_max_docs_for_reranker": {"key": "defaultMaxDocsForReranker", "type": "int"},
    }
    ...
    def __init__(
        ...
        *,
        index_name: str,
        default_reranker_threshold: Optional[float] = None,
        default_include_reference_source_data: Optional[bool] = None,
        default_max_docs_for_reranker: Optional[int] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword index_name: The name of the target index. Required.
        :paramtype index_name: str
        :keyword default_reranker_threshold: A threshold for reranking results (range: 0-4).
        :paramtype default_reranker_threshold: float
        :keyword default_include_reference_source_data: Indicates whether reference source data should
         be included.
        :paramtype default_include_reference_source_data: bool
        :keyword default_max_docs_for_reranker: Limits the number of documents considered for ranking.
        :paramtype default_max_docs_for_reranker: int
        """
        super().__init__(**kwargs)
        self.index_name = index_name
        self.default_reranker_threshold = default_reranker_threshold
        self.default_include_reference_source_data = default_include_reference_source_data
        self.default_max_docs_for_reranker = default_max_docs_for_reranker
