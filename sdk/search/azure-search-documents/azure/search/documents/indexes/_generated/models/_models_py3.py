...
class AzureOpenAIVectorizer(VectorSearchVectorizer):
    ...
    def __init__(
        ...
        *,
        name: str,
        azure_open_ai_parameters: Optional["_models.AzureOpenAIVectorizerParameters"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword name: The name to associate with this particular vectorization method. Required.
...
class WebApiVectorizer(VectorSearchVectorizer):
    ...
    def __init__(
        self, *, name: str, web_api_parameters: Optional["_models.WebApiVectorizerParameters"] = None, **kwargs: Any
    ) -> None:
        """
        :keyword name: The name to associate with this particular vectorization method. Required.
        :paramtype name: str
