...
class KnowledgeSource(_serialization.Model):
    ...
    You probably want to use the sub-classes and not this class directly. Known sub-classes are:
    AzureBlobKnowledgeSource, SearchIndexKnowledgeSource, WebKnowledgeSource
    ...
    :ivar encryption_key: A description of an encryption key that you create in Azure Key Vault.
     This key is used to provide an additional level of encryption-at-rest for your agent definition
     when you want full assurance that no one, not even Microsoft, can decrypt them. Once you have
     encrypted your agent definition, it will always remain encrypted. The search service will
     ignore attempts to set this property to null. You can change this property as needed if you
     want to rotate your encryption key; Your agent definition will be unaffected. Encryption with
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype description: str
        :keyword e_tag: The ETag of the agent.
        :paramtype e_tag: str
...
class AzureBlobKnowledgeSourceParameters(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "embedding_model": {"key": "embeddingModel", "type": "VectorSearchVectorizer"},
        "chat_completion_model": {"key": "chatCompletionModel", "type": "KnowledgeAgentModel"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype embedding_model: ~azure.search.documents.indexes.models.VectorSearchVectorizer
        :keyword chat_completion_model: Optional chat completion model for image verbalization or
         context extraction.
        :paramtype chat_completion_model: ~azure.search.documents.indexes.models.KnowledgeAgentModel
...
class KnowledgeAgent(_serialization.Model):
    """KnowledgeAgent.
    ...
    :ivar output_configuration:
    :vartype output_configuration:
     ~azure.search.documents.indexes.models.KnowledgeAgentOutputConfiguration
    :ivar request_limits: Guardrails to limit how much resources are utilized for a single agent
     retrieval request.
    ...
    _attribute_map = {
        "name": {"key": "name", "type": "str"},
        "models": {"key": "models", "type": "[KnowledgeAgentModel]"},
        "knowledge_sources": {"key": "knowledgeSources", "type": "[KnowledgeSourceReference]"},
        "output_configuration": {"key": "outputConfiguration", "type": "KnowledgeAgentOutputConfiguration"},
        "request_limits": {"key": "requestLimits", "type": "KnowledgeAgentRequestLimits"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword name: The name of the knowledge agent. Required.
        :paramtype name: str
        :keyword models: Contains configuration options on how to connect to AI models. Required.
        :paramtype models: list[~azure.search.documents.indexes.models.KnowledgeAgentModel]
        :keyword knowledge_sources: Required.
        :paramtype knowledge_sources:
         list[~azure.search.documents.indexes.models.KnowledgeSourceReference]
        :keyword output_configuration:
        :paramtype output_configuration:
         ~azure.search.documents.indexes.models.KnowledgeAgentOutputConfiguration
        :keyword request_limits: Guardrails to limit how much resources are utilized for a single agent
         retrieval request.
        :paramtype request_limits: ~azure.search.documents.indexes.models.KnowledgeAgentRequestLimits
        :keyword retrieval_instructions: Instructions considered by the knowledge agent when developing
         query plan.
        ...
        :keyword encryption_key: A description of an encryption key that you create in Azure Key Vault.
         ...
         services created on or after January 1, 2019.
        :paramtype encryption_key: ~azure.search.documents.indexes.models.SearchResourceEncryptionKey
        :keyword description: The description of the agent.
        :paramtype description: str
        """
        super().__init__(**kwargs)
        self.name = name
...
class KnowledgeAgentModel(_serialization.Model):
    ...
    _subtype_map = {"kind": {"azureOpenAI": "KnowledgeAgentAzureOpenAIModel"}}
...
class KnowledgeAgentAzureOpenAIModel(KnowledgeAgentModel):
...
class KnowledgeAgentOutputConfiguration(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "attempt_fast_path": {"key": "attemptFastPath", "type": "bool"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword modality: The output configuration for the agent. Known values are: "answerSynthesis"
         and "extractiveData".
        :paramtype modality: str or
         ~azure.search.documents.indexes.models.KnowledgeAgentOutputConfigurationModality
        :keyword answer_instructions: Instructions considered by the knowledge agent when generating
         answers.
        :paramtype answer_instructions: str
        :keyword attempt_fast_path: Indicates whether the agent should attempt to issue the most recent
         chat message as a direct query to the knowledge sources, bypassing the model calls.
        :paramtype attempt_fast_path: bool
        ...
        self.attempt_fast_path = attempt_fast_path
        self.include_activity = include_activity


class KnowledgeAgentRequestLimits(_serialization.Model):
    ...
    def __init__(
        self, *, max_runtime_in_seconds: Optional[int] = None, max_output_size: Optional[int] = None, **kwargs: Any
    ) -> None:
        """
...
class KnowledgeSourceReference(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "max_sub_queries": {"key": "maxSubQueries", "type": "int"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword max_sub_queries: The maximum number of queries that can be issued at a time when
         retrieving data from this source.
        :paramtype max_sub_queries: int
...
class ListKnowledgeAgentsResult(_serialization.Model):
    """ListKnowledgeAgentsResult.

    All required parameters must be populated in order to send to server.

    :ivar knowledge_agents: Required.
    :vartype knowledge_agents: list[~azure.search.documents.indexes.models.KnowledgeAgent]
    """

    _validation = {
        "knowledge_agents": {"required": True},
    }

    _attribute_map = {
        "knowledge_agents": {"key": "value", "type": "[KnowledgeAgent]"},
    }

    def __init__(self, *, knowledge_agents: List["_models.KnowledgeAgent"], **kwargs: Any) -> None:
        """
        :keyword knowledge_agents: Required.
        :paramtype knowledge_agents: list[~azure.search.documents.indexes.models.KnowledgeAgent]
        """
        super().__init__(**kwargs)
        self.knowledge_agents = knowledge_agents
...
class SearchIndexKnowledgeSourceParameters(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "source_data_select": {"key": "sourceDataSelect", "type": "str"},
    }

    def __init__(self, *, search_index_name: str, source_data_select: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword search_index_name: The name of the Search index. Required.
        :paramtype search_index_name: str
        :keyword source_data_select: Used to request additional fields for referenced source data.
        :paramtype source_data_select: str
        """
        super().__init__(**kwargs)
        self.search_index_name = search_index_name
        self.source_data_select = source_data_select
...
class WebKnowledgeSource(KnowledgeSource):
    ...
    :ivar encryption_key: A description of an encryption key that you create in Azure Key Vault.
     ...
     services created on or after January 1, 2019.
    :vartype encryption_key: ~azure.search.documents.indexes.models.SearchResourceEncryptionKey
    :ivar web_parameters: The parameters for the knowledge source. Required.
    ...
    def __init__(
        ...
        *,
        name: str,
        web_parameters: "_models.WebKnowledgeSourceParameters",
        description: Optional[str] = None,
        e_tag: Optional[str] = None,
        encryption_key: Optional["_models.SearchResourceEncryptionKey"] = None,
        **kwargs: Any
        ...
        :keyword encryption_key: A description of an encryption key that you create in Azure Key Vault.
         ...
         services created on or after January 1, 2019.
        :paramtype encryption_key: ~azure.search.documents.indexes.models.SearchResourceEncryptionKey
        :keyword web_parameters: The parameters for the knowledge source. Required.
...
class WebKnowledgeSourceAllowedDomain(_serialization.Model):
    ...
    :ivar ranking_adjustment: The ranking adjustment to perform on the web results. Known values
     are: "boost", "superBoost", and "demote".
    :vartype ranking_adjustment: str or
     ~azure.search.documents.indexes.models.WebKnowledgeSourceRankingAdjustment
    """
    ...
    _attribute_map = {
        ...
        "ranking_adjustment": {"key": "rankingAdjustment", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        ranking_adjustment: Optional[Union[str, "_models.WebKnowledgeSourceRankingAdjustment"]] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :keyword ranking_adjustment: The ranking adjustment to perform on the web results. Known values
         are: "boost", "superBoost", and "demote".
        :paramtype ranking_adjustment: str or
         ~azure.search.documents.indexes.models.WebKnowledgeSourceRankingAdjustment
        """
        super().__init__(**kwargs)
        self.address = address
        self.include_subpages = include_subpages
        self.ranking_adjustment = ranking_adjustment


class WebKnowledgeSourceBlockedDomain(_serialization.Model):
    """Configuration for web knowledge source domain.
...
class WebKnowledgeSourceParameters(_serialization.Model):
    ...
    :ivar identity: An explicit identity to use for this knowledge source.
    :vartype identity: ~azure.search.documents.indexes.models.SearchIndexerDataIdentity
    :ivar bing_resource_id: The ResourceId of the Bing Search resource to use for web results.
    :vartype bing_resource_id: str
    ...
    :vartype allowed_domains:
     list[~azure.search.documents.indexes.models.WebKnowledgeSourceAllowedDomain]
    :ivar blocked_domains: Domains that are blocked from web results.
    :vartype blocked_domains:
     list[~azure.search.documents.indexes.models.WebKnowledgeSourceBlockedDomain]
    """

    _attribute_map = {
        "identity": {"key": "identity", "type": "SearchIndexerDataIdentity"},
        "bing_resource_id": {"key": "bingResourceId", "type": "str"},
        "language": {"key": "language", "type": "str"},
        "market": {"key": "market", "type": "str"},
        "freshness": {"key": "freshness", "type": "str"},
        "allowed_domains": {"key": "allowedDomains", "type": "[WebKnowledgeSourceAllowedDomain]"},
        "blocked_domains": {"key": "blockedDomains", "type": "[WebKnowledgeSourceBlockedDomain]"},
    }
    ...
    def __init__(
        ...
        *,
        identity: Optional["_models.SearchIndexerDataIdentity"] = None,
        bing_resource_id: Optional[str] = None,
        language: Optional[str] = None,
        market: Optional[str] = None,
        freshness: Optional[str] = None,
        allowed_domains: Optional[List["_models.WebKnowledgeSourceAllowedDomain"]] = None,
        blocked_domains: Optional[List["_models.WebKnowledgeSourceBlockedDomain"]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword identity: An explicit identity to use for this knowledge source.
        :paramtype identity: ~azure.search.documents.indexes.models.SearchIndexerDataIdentity
        :keyword bing_resource_id: The ResourceId of the Bing Search resource to use for web results.
        :paramtype bing_resource_id: str
        ...
        super().__init__(**kwargs)
        self.identity = identity
        self.bing_resource_id = bing_resource_id
        self.language = language
        self.market = market
