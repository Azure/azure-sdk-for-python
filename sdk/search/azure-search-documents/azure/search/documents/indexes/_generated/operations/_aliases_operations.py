...
def build_create_request(
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/aliases')
...
def build_create_or_update_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/aliases(\'{aliasName}\')')
...
# fmt: on
class AliasesOperations(object):
    """AliasesOperations operations.
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ListAliasesResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.search.documents.indexes.models.ListAliasesResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-04-30-Preview")  # type: str
