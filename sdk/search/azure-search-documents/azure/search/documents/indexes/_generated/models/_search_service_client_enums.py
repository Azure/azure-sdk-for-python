...
class ChatCompletionResponseFormatType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Specifies how the LLM should format the response. Possible values: 'text' (plain string),
...
class KnowledgeAgentOutputOptimization(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Procedural optimizations the agent should perform during retrieval."""

    ATTEMPT_BYPASS_MODEL = "attemptBypassModel"
...
class WebKnowledgeSourceRankingAdjustment(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    """Applies a stronger positive weight than Boost, pushing the selected domain or subpage towards
    the very top of the results."""
    DEMOTE = "demote"
    """Lowers the ranking of the specified domain or subpage so it shows up further down the results
    list."""
