...
class _SearchIndexClientOperationsMixin(_SearchIndexClientOperationsMixinGenerated):
    ...
    @distributed_trace
    def create_or_update_synonym_map(self, *args: Union[str, _models.SynonymMap], **kwargs: Any) -> _models.SynonymMap:
        """Creates a new synonym map or updates a synonym map if it already exists.
        ...
        if args and isinstance(args[0], _models.SynonymMap):
            synonym_map = args[0]
            kwargs.setdefault("etag", synonym_map.e_tag)
            return self._create_or_update_synonym_map(synonym_map.name, synonym_map, prefer="return=representation", **kwargs)
        else:
            return self._create_or_update_synonym_map(*args, prefer="return=representation", **kwargs)
    ...
    @distributed_trace
    def create_or_update_index(self, *args: Union[str, _models.SearchIndex], **kwargs: Any) -> _models.SearchIndex:
        """Creates a new search index or updates an index if it already exists.
        ...
        if args and isinstance(args[0], _models.SearchIndex):
            index = args[0]
            kwargs.setdefault("etag", index.e_tag)
            return self._create_or_update_index(index.name, index, prefer="return=representation", **kwargs)
        else:
            return self._create_or_update_index(*args, prefer="return=representation", **kwargs)
    ...
    @distributed_trace
    def create_or_update_alias(self, *args: Union[str, _models.SearchAlias], **kwargs: Any) -> _models.SearchAlias:
        """Creates a new search alias or updates an alias if it already exists.
        ...
        if args and isinstance(args[0], _models.SearchAlias):
            ...
            return self._create_or_update_alias(alias.name, alias, prefer="return=representation", **kwargs)
        else:
            return self._create_or_update_alias(*args, prefer="return=representation", **kwargs)
    ...
    def create_or_update_agent(
        ...
        if args and isinstance(args[0], _models.KnowledgeAgent):
            agent = args[0]
            kwargs.setdefault("etag", agent.e_tag)
            return self._create_or_update_agent(agent.name, agent, prefer="return=representation", **kwargs)
        else:
            return self._create_or_update_agent(*args, prefer="return=representation", **kwargs)
    ...
    def create_or_update_knowledge_source(
        ...
        if args and isinstance(args[0], _models.KnowledgeSource):
            ...
            return self._create_or_update_knowledge_source(knowledge_source.name, knowledge_source, prefer="return=representation", **kwargs)
        else:
            return self._create_or_update_knowledge_source(*args, prefer="return=representation", **kwargs)
...
class _SearchIndexerClientOperationsMixin(_SearchIndexerClientOperationsMixinGenerated):
    ...
    def create_or_update_data_source_connection(
        ...
        if args and isinstance(args[0], _models.SearchIndexerDataSourceConnection):
            data_source = args[0]
            kwargs.setdefault("etag", data_source.e_tag)
            return self._create_or_update_data_source_connection(data_source.name, data_source, prefer="return=representation", **kwargs)
        else:
            return self._create_or_update_data_source_connection(*args, prefer="return=representation", **kwargs)
    ...
    @distributed_trace
    def create_or_update_indexer(self, *args: Union[str, _models.SearchIndexer], **kwargs: Any) -> _models.SearchIndexer:
        """Creates a new indexer or updates an indexer if it already exists.
        ...
        if args and isinstance(args[0], _models.SearchIndexer):
            indexer = args[0]
            kwargs.setdefault("etag", indexer.e_tag)
            return self._create_or_update_indexer(indexer.name, indexer, prefer="return=representation", **kwargs)
        else:
            return self._create_or_update_indexer(*args, prefer="return=representation", **kwargs)
    ...
    def create_or_update_skillset(
        ...
        if args and isinstance(args[0], _models.SearchIndexerSkillset):
            skillset = args[0]
            kwargs.setdefault("etag", skillset.e_tag)
            return self._create_or_update_skillset(skillset.name, skillset, prefer="return=representation", **kwargs)
        else:
            return self._create_or_update_skillset(*args, prefer="return=representation", **kwargs)
