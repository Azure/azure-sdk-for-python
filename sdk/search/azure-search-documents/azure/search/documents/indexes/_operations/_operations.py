...
class _SearchIndexClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def get_synonym_maps(self, *, select: Optional[str] = None, **kwargs: Any) -> _models1.ListSynonymMapsResult:
    ...
    @distributed_trace
    def list_agents(self, **kwargs: Any) -> _models1.ListKnowledgeAgentsResult:
    ...
    @distributed_trace
    def list_knowledge_sources(self, **kwargs: Any) -> _models1.ListKnowledgeSourcesResult:
...
class _SearchIndexerClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ...
    ) -> _models1.ListDataSourcesResult:
    ...
    @distributed_trace
    def get_indexers(self, *, select: Optional[str] = None, **kwargs: Any) -> _models1.ListIndexersResult:
    ...
    @distributed_trace
    def get_skillsets(self, *, select: Optional[str] = None, **kwargs: Any) -> _models1.ListSkillsetsResult:
