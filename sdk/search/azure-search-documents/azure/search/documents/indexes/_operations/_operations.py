...
def build_search_index_create_or_update_agent_request(  # pylint: disable=name-too-long
...
def build_search_index_delete_agent_request(
    agent_name: str, *, etag: Optional[str] = None, match_condition: Optional[MatchConditions] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_search_index_get_agent_request(agent_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_search_index_list_agents_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_search_index_create_agent_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_search_indexer_create_or_update_request(  # pylint: disable=name-too-long
    indexer_name: str,
    *,
    skip_indexer_reset_requirement_for_cache: Optional[bool] = None,
...
class _SearchIndexClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def get_synonym_maps(self, *, select: Optional[str] = None, **kwargs: Any) -> ItemPaged["_models1.SynonymMap"]:
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(list[_models1.SynonymMap], deserialized.get("value", []))
            if cls:
    ...
    @distributed_trace
    def get_agent(self, agent_name: str, **kwargs: Any) -> _models1.KnowledgeAgent:
    ...
    @distributed_trace
    def list_agents(self, **kwargs: Any) -> ItemPaged["_models1.KnowledgeAgent"]:
        ...
        cls: ClsType[list[_models1.KnowledgeAgent]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(list[_models1.KnowledgeAgent], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return None, iter(list_of_elem)
...
class _SearchIndexerClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ...
    def get_data_source_connections(
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(list[_models1.SearchIndexerDataSourceConnection], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return None, iter(list_of_elem)
    ...
    @distributed_trace
    def get_indexers(self, *, select: Optional[str] = None, **kwargs: Any) -> ItemPaged["_models1.SearchIndexer"]:
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(list[_models1.SearchIndexer], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return None, iter(list_of_elem)
    ...
    def get_skillsets(
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(list[_models1.SearchIndexerSkillset], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return None, iter(list_of_elem)
