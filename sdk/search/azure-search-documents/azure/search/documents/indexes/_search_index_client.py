...
class SearchIndexClient(HeadersMixin):  # pylint:disable=too-many-public-methods
    ...
    def list_indexes(self, *, select: Optional[List[str]] = None, **kwargs: Any) -> ItemPaged[SearchIndex]:
        ...
        indexes = self._client.indexes_operations.list(cls=lambda objs: [SearchIndex._from_generated(x) for x in objs], **kwargs)
    ...
    def delete_index(
        ...
        **kwargs: Any
        ...
        try:
            ...
            index_name = index
        self._client.indexes_operations.delete(index_name=index_name, etag=etag, match_condition=match_condition, **kwargs)
    ...
    def delete_synonym_map(
        ...
        **kwargs: Any
        ...
        try:
            ...
            name = synonym_map
        self._client.synonym_maps_operations.delete(synonym_map_name=name, etag=etag, match_condition=match_condition, **kwargs)
