...
class KnowledgeBaseModelWebSummarizationActivityRecord(
    ...
    :vartype type: str or
     ~azure.search.documents.knowledgebases.models.KnowledgeBaseActivityRecordType
    :ivar input_tokens: The number of input tokens for the LLM web summarization activity.
    :vartype input_tokens: int
    :ivar output_tokens: The number of output tokens for the LLM web summarization activity.
