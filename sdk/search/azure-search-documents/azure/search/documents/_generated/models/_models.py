...
class ScoringFunction(_model_base.Model):
    ...
    :ivar type: Discriminator property for ScoringFunction. Required. Default value is None.
    :vartype type: str
    ...
    """Discriminator property for ScoringFunction. Required. Default value is None."""
