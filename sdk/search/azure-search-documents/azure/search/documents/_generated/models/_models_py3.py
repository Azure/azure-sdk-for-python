...
class SearchDocumentsResult(_serialization.Model):
    ...
    :vartype semantic_partial_response_reason: str or
     ~search_index_client.models.SemanticErrorReason
...
class SearchRequest(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype captions: str or ~search_index_client.models.QueryCaptionType
    :ivar vectorizable_queries: The query parameters for vector and hybrid search queries.
    :vartype vectorizable_queries: list[~search_index_client.models.VectorizableQuery]
    ...
    _attribute_map = {
        ...
        "answers": {"key": "answers", "type": "str"},
        "captions": {"key": "captions", "type": "str"},
        "vectorizable_queries": {"key": "vectorQueries", "type": "[VectorizableQuery]"},
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        answers: Optional[Union[str, "_models.QueryAnswerType"]] = None,
        captions: Optional[Union[str, "_models.QueryCaptionType"]] = None,
        vectorizable_queries: Optional[List["_models.VectorizableQuery"]] = None,
        ...
        **kwargs: Any
        ...
        :paramtype vectorizable_queries: list[~search_index_client.models.VectorizableQuery]
        ...
        self.answers = answers
        self.captions = captions
        self.vectorizable_queries = vectorizable_queries
...
class VectorizableQuery(_serialization.Model):
