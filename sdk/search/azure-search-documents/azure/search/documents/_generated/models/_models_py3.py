...
class DocumentDebugInfo(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.inner_hits: Optional[Dict[str, List["_models.QueryResultDocumentInnerHit"]]] = None
...
class QueryResultDocumentInnerHit(_serialization.Model):
...
class SearchOptions(_serialization.Model):
    ...
    :ivar debug: Enables a debugging tool that can be used to further explore your search results.
     Known values are: "disabled", "semantic", "vector", "queryRewrites", "innerHits", and "all".
...
class SearchResult(_serialization.Model):
    ...
    _validation = {
        ...
        "reranker_boosted_score": {"readonly": True},
        "highlights": {"readonly": True},
    ...
    def __init__(self, *, additional_properties: Optional[Dict[str, Any]] = None, **kwargs: Any) -> None:
        ...
        self.reranker_boosted_score: Optional[float] = None
...
class VectorQuery(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "per_document_vector_limit": {"key": "perDocumentVectorLimit", "type": "int"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword per_document_vector_limit: Controls how many vectors can be matched from each document
         in a vector search query. Setting it to 1 ensures at most one vector per document is matched,
         guaranteeing results come from distinct documents. Setting it to 0 (unlimited) allows multiple
         relevant vectors from the same document to be matched. Default is 0.
        :paramtype per_document_vector_limit: int
        """
        super().__init__(**kwargs)
        self.kind: Optional[str] = None
        ...
        self.per_document_vector_limit = per_document_vector_limit
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super().__init__(
            ...
            per_document_vector_limit=per_document_vector_limit,
            **kwargs
        )
