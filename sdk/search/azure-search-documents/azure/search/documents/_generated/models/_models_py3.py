...
class AutocompleteOptions(_serialization.Model):
    ...
    :vartype autocomplete_mode: str or ~search_index_client.models.AutocompleteMode
...
class IndexAction(_serialization.Model):
    ...
    :vartype action_type: str or ~search_index_client.models.IndexActionType
    """
...
class IndexBatch(_serialization.Model):
    ...
    :vartype actions: list[~search_index_client.models.IndexAction]
    """
...
class Vector(_serialization.Model):
    ...
    VectorizableTextQuery, RawVector

    All required parameters must be populated in order to send to Azure.

    :ivar kind: The name of the kind of vector query being performed. Required.
    :vartype kind: str
    ...
    _subtype_map = {"kind": {"text": "VectorizableTextQuery", "vector": "RawVector"}}
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :keyword captions: This parameter is only valid if the query type is 'semantic'. If set, the
         ...
         'extractive|highlight-true'. Defaults to 'None'. Known values are: "none" and "extractive".
        :paramtype captions: str or ~search_index_client.models.Captions
...
class SearchRequest(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar vectors: The query parameters for vector and hybrid search queries.
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :keyword vectors: The query parameters for vector and hybrid search queries.
...
class VectorizableTextQuery(Vector):
    ...
    :ivar exhaustive: When true, triggers an exhaustive k-nearest neighbor search across all
     ...
     determining ground truth values.
    :vartype exhaustive: bool
    :ivar text: The text to be vectorized to perform a vector search query.
    :vartype text: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword exhaustive: When true, triggers an exhaustive k-nearest neighbor search across all
         ...
         determining ground truth values.
        :paramtype exhaustive: bool
        :keyword text: The text to be vectorized to perform a vector search query.
        :paramtype text: str
        """
        super().__init__(k=k, fields=fields, exhaustive=exhaustive, **kwargs)
        self.kind: str = "text"
