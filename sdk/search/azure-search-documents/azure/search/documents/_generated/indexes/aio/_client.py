...
class SearchServiceClient(_SearchServiceClientOperationsMixin):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype agents: azure.search.documents.aio.operations.AgentsOperations
    :ivar sources: SourcesOperations operations
    :vartype sources: azure.search.documents.aio.operations.SourcesOperations
    ...
    def __init__(
        ...
        _endpoint = "{endpoint}"
        self._config = SearchServiceClientConfiguration(endpoint=endpoint, credential=credential, **kwargs)
