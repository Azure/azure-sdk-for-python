...
class SearchClient(MultiApiClientMixin, _SDKClient):
    ...
    def documents(self):
        """Instance depends on the API version:
           ...
           * 2020-06-30: :class:`DocumentsOperations<azure.search.documents.v2020_06.aio.operations.DocumentsOperations>`
           * 2020-06-30-Preview: :class:`DocumentsOperations<azure.search.documents.v2020_06_preview.aio.operations.DocumentsOperations>`
        """
        api_version = self._get_api_version('documents')
        if api_version == '2020-06-30':
            from ..v2020_06.aio.operations import DocumentsOperations as OperationClass
        elif api_version == '2020-06-30-Preview':
            from ..v2020_06_preview.aio.operations import DocumentsOperations as OperationClass
        else:
