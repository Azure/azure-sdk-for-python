...
class DocumentsOperations:
    ...
    async def count(self, *, query_source_authorization: Optional[str] = None, **kwargs: Any) -> int:
    ...
    async def index(
        self,
        batch: _models2.IndexBatch,
        *,
        query_source_authorization: Optional[str] = None,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models2.IndexDocumentsResult:
    ...
    async def index(
        self,
        batch: Union[_models2.IndexBatch, JSON, IO[bytes]],
        *,
        query_source_authorization: Optional[str] = None,
        **kwargs: Any
    ) -> _models2.IndexDocumentsResult:
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models2.IndexDocumentsResult] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models2.IndexDocumentsResult, response.json())
