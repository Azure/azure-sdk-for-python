...
def build_search_get_request(
    ...
    **kwargs: Any
    ...
    if x_ms_enable_elevated_read is not None:
        _headers["x-ms-enable-elevated-read"] = _SERIALIZER.header(
            "x_ms_enable_elevated_read", x_ms_enable_elevated_read, "bool"
        )
    _headers["Accept"] = _SERIALIZER.header("accept", accept, "str")
...
class DocumentsOperations:
    ...
    def search_get(
        ...
        **kwargs: Any
        ...
        :param x_ms_enable_elevated_read: A value that enables elevated read that bypass document level
         permission checks for the query operation. Default value is None.
        :type x_ms_enable_elevated_read: bool
        ...
        if search_options is not None:
            ...
            _query_rewrites = search_options.query_rewrites
        ...
        _request = build_search_get_request(
            ...
            query_rewrites=_query_rewrites,
            debug=_debug,
            ...
            x_ms_enable_elevated_read=x_ms_enable_elevated_read,
            api_version=api_version,
            headers=_headers,
            params=_params,
        )
