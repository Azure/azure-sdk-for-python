...
class SearchClientOperationsMixin(SearchClientMixinABC):
    ...
    def get_index_stats_summary(self, **kwargs: Any) -> Iterable["_models.IndexStatisticsSummary"]:
        """Retrieves a summary of statistics for all indexes in the search service.

        :return: An iterator like instance of IndexStatisticsSummary
        :rtype: ~azure.core.paging.ItemPaged[~azure.search.documents.models.IndexStatisticsSummary]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
