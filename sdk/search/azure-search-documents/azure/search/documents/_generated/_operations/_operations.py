...
from .._vendor import SearchIndexClientMixinABC, SearchServiceClientMixinABC, prep_if_match, prep_if_none_match
...
def build_search_index_data_sources_operations_create_or_update_request(  # pylint: disable=name-too-long
...
def build_search_service_data_sources_operations_delete_request(  # pylint: disable=name-too-long
    data_source_name: str,
    *,
    etag: Optional[str] = None,
    match_condition: Optional[MatchConditions] = None,
...
class SearchServiceClientOperationsMixin(SearchServiceClientMixinABC):
    ...
    @distributed_trace
    def data_sources_operations_delete(  # pylint: disable=inconsistent-return-statements
        self,
        data_source_name: str,
        *,
        etag: Optional[str] = None,
