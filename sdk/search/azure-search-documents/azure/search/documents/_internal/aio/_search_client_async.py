...
class SearchClient(HeadersMixin):
    ...
    async def queue_upload_documents_actions(self, documents):
        # type: (List[dict]) -> None
    ...
    async def queue_delete_documents_actions(self, documents):
        # type: (List[dict]) -> None
    ...
    async def queue_merge_documents_actions(self, documents):
        # type: (List[dict]) -> None
    ...
    async def queue_merge_or_upload_documents_actions(self, documents):
        # type: (List[dict]) -> None
