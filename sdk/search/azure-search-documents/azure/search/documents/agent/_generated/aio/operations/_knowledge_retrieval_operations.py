...
class KnowledgeRetrievalOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.search.documents.agent.aio.KnowledgeBaseRetrievalClient`'s
    ...
    async def retrieve(
        ...
        **kwargs: Any
        ...
        :type retrieval_request: ~azure.search.documents.agent.models.KnowledgeBaseRetrievalRequest
        ...
        :rtype: ~azure.search.documents.agent.models.KnowledgeBaseRetrievalResponse
    ...
    async def retrieve(
        ...
        **kwargs: Any
        ...
        :type retrieval_request: ~azure.search.documents.agent.models.KnowledgeBaseRetrievalRequest or
         IO[bytes]
        :param x_ms_query_source_authorization: Token identifying the user for which the query is being
         executed. This token is used to enforce security restrictions on documents. Default value is
         None.
