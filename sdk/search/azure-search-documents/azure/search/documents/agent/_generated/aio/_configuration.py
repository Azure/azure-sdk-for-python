...
class KnowledgeAgentRetrievalClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    """Configuration for KnowledgeAgentRetrievalClient.
    ...
    def __init__(self, endpoint: str, agent_name: str, **kwargs: Any) -> None:
        api_version: str = kwargs.pop("api_version", "2025-05-01-preview")

        if endpoint is None:
            raise ValueError("Parameter 'endpoint' must not be None.")
        if agent_name is None:
            raise ValueError("Parameter 'agent_name' must not be None.")

        self.endpoint = endpoint
        self.agent_name = agent_name
        self.api_version = api_version
        kwargs.setdefault("sdk_moniker", "knowledgeagentretrievalclient/{}".format(VERSION))
