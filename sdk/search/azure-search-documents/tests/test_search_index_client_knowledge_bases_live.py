...
class TestSearchIndexClientKnowledgeBases(AzureRecordedTestCase):
    ...
    def test_create_or_update_knowledge_base_uses_model_name_and_etag(self, endpoint: str) -> None:
        require_capability(
            *_KNOWLEDGE_BASE_RESOURCE_CAPABILITIES,
            "azure.search.documents.indexes.SearchIndexClient.create_or_update_knowledge_base",
        )
    ...
    def test_get_knowledge_base_returns_named_resource(self, endpoint: str) -> None:
        require_capability(
            *_KNOWLEDGE_BASE_RESOURCE_CAPABILITIES,
            "azure.search.documents.indexes.SearchIndexClient.get_knowledge_base",
        )
    ...
    def test_list_knowledge_bases_includes_created_resource(self, endpoint: str) -> None:
        require_capability(
            *_KNOWLEDGE_BASE_RESOURCE_CAPABILITIES,
            "azure.search.documents.indexes.SearchIndexClient.list_knowledge_bases",
        )
