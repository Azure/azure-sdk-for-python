...
from azure.search.documents import AutocompleteQuery, SearchQuery, SuggestQuery
...
class TestAutocompleteQuery(object):
    ...
    @mock.patch("azure.search.documents.AutocompleteQuery._request_type")
...
class TestSearchQuery(object):
    ...
    @mock.patch("azure.search.documents.SearchQuery._request_type")
    def test_kwargs_forwarded(self, mock_request):
        mock_request.return_value = None
...
class TestSuggestQuery(object):
    ...
    @mock.patch("azure.search.documents.SuggestQuery._request_type")
    def test_kwargs_forwarded(self, mock_request):
        mock_request.return_value = None
