...
# ------------------------------------
"""Live tests for ``SearchIndexerClient`` skillset operations."""
...
class TestSearchIndexerClientSkillset(AzureRecordedTestCase):
    ...
    def test_create_skillset_returns_created_resource(self, endpoint):
        ...
        try:
            ...
            safe_delete(client.delete_skillset, skillset_name)
            client.close()
    ...
    def test_get_skillset_returns_created_resource(self, endpoint):
        ...
        try:
            client.create_skillset(_build_skillset(skillset_name))

            result = client.get_skillset(skillset_name)
    ...
    def test_get_skillsets_and_names_return_created_resources(self, endpoint):
        ...
        try:
            client.create_skillset(_build_skillset(first_skillset_name))
            client.create_skillset(_build_skillset(second_skillset_name))

            skillsets = client.get_skillsets()
            skillset_names = client.get_skillset_names()
            ...
            safe_delete(client.delete_skillset, first_skillset_name)
            safe_delete(client.delete_skillset, second_skillset_name)
            client.close()
    ...
    def test_create_or_update_skillset_replaces_existing_resource(self, endpoint):
        ...
        try:
            client.create_or_update_skillset(_build_skillset(skillset_name))
            result = client.create_or_update_skillset(
            ...
            assert client.get_skillset(skillset_name).description == REPLACEMENT_SKILLSET_DESCRIPTION
        finally:
            safe_delete(client.delete_skillset, skillset_name)
            client.close()
    ...
    def test_create_or_update_skillset_accepts_returned_model(self, endpoint):
        ...
        try:
            skillset = client.create_or_update_skillset(_build_skillset(skillset_name))
    ...
    def test_create_or_update_skillset_if_unchanged_uses_model_etag(self, endpoint):
        ...
        try:
            ...
            with pytest.raises(HttpResponseError):
                client.create_or_update_skillset(skillset, match_condition=MatchConditions.IfNotModified)
        finally:
            safe_delete(client.delete_skillset, skillset_name)
            client.close()
    ...
    def test_delete_skillset_accepts_name(self, endpoint):
        ...
        try:
            ...
            assert skillset_name not in client.get_skillset_names()
        finally:
            safe_delete(client.delete_skillset, skillset_name)
            client.close()
    ...
    def test_delete_skillset_if_unchanged_uses_model_etag(self, endpoint):
        ...
        try:
            skillset = client.create_skillset(_build_skillset(skillset_name))
            skillset.e_tag = STALE_SKILLSET_ETAG

            with pytest.raises(HttpResponseError):
                client.delete_skillset(skillset, match_condition=MatchConditions.IfNotModified)

            assert skillset_name in client.get_skillset_names()
        finally:
            safe_delete(client.delete_skillset, skillset_name)
            client.close()
