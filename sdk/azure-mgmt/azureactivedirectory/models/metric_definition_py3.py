...
class MetricDefinition(Model):
    ...
    :type primary_aggregation_type: str or
     ~microsoft.aadiam.models.AggregationType
    ...
    :type metric_availabilities:
     list[~microsoft.aadiam.models.MetricAvailability]
    ...
    :type dimensions: list[~microsoft.aadiam.models.LocalizableString]
    """
    ...
    def __init__(self, *, is_dimension_required: bool=None, namespace: str=None, name=None, unit=None, primary_aggregation_type=None, supported_aggregation_types=None, metric_availabilities=None, id: str=None, dimensions=None, **kwargs) -> None:
