...
class MetricDefinitionsOperations(object):
    ...
    def list(
            self, metricnamespace=None, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype:
         ~microsoft.aadiam.models.MetricDefinitionPaged[~microsoft.aadiam.models.MetricDefinition]
        :raises:
         :class:`MetricErrorResponseException<microsoft.aadiam.models.MetricErrorResponseException>`
        """
        def internal_paging(next_link=None, raw=False):
            ...
            if response.status_code not in [200]:
                raise models.MetricErrorResponseException(self._deserialize, response)
        ...
        return deserialized
    list.metadata = {'url': '/providers/microsoft.aadiam/metricDefinitions'}
