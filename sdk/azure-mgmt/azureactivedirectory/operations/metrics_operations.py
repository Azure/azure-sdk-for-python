...
class MetricsOperations(object):
    ...
    def list(
            self, timespan=None, interval=None, metricnames=None, aggregation=None, top=None, orderby=None, filter=None, result_type=None, metricnamespace=None, custom_headers=None, raw=False, **operation_config):
        ...
        :type result_type: str or ~microsoft.aadiam.models.ResultType
        ...
        :rtype: ~microsoft.aadiam.models.Response or
        ...
        return deserialized
    list.metadata = {'url': '/providers/microsoft.aadiam/metrics'}
