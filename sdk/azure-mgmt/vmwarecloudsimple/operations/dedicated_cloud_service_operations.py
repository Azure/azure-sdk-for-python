...
class DedicatedCloudServiceOperations(object):
    ...
    def list_by_subscription(
        ...
        :rtype:
         ~microsoft.vmwarecloudsimple.models.DedicatedCloudServicePaged[~microsoft.vmwarecloudsimple.models.DedicatedCloudService]
        :raises:
    ...
    def get(
        ...
        :rtype: ~microsoft.vmwarecloudsimple.models.DedicatedCloudService or
    ...
    def create_or_update(
        ...
        :type dedicated_cloud_service_request:
         ~microsoft.vmwarecloudsimple.models.DedicatedCloudService
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
