...
class DevOpsClient(SDKClient):
    ...
    :vartype operations: microsoft.devops.operations.Operations
    :ivar pipeline_template_definitions: PipelineTemplateDefinitions operations
    :vartype pipeline_template_definitions: microsoft.devops.operations.PipelineTemplateDefinitionsOperations
    :ivar pipelines: Pipelines operations
    :vartype pipelines: microsoft.devops.operations.PipelinesOperations
