...
class MultipleActivationKey(Model):
    ...
    def __init__(self, *, location: str, tags=None, os_type=None, support_type="SupplementalServicing", installed_server_number: int=None, agreement_number: str=None, is_eligible: bool=None, **kwargs) -> None:
        ...
        self.installed_server_number = installed_server_number
