...
class DashboardsOperations(object):
    ...
    :ivar api_version: The API version to be used with the HTTP request. Constant value: "2015-11-01-preview".
    """
    ...
    def create_or_update(
            self, resource_group_name, dashboard_name, dashboard, custom_headers=None, raw=False, **operation_config):
        ...
        :param dashboard: The parameters required to create or update a
         dashboard.
        :type dashboard: ~microsoft.portal.models.Dashboard
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: Dashboard or ClientRawResponse if raw=true
        :rtype: ~microsoft.portal.models.Dashboard or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<microsoft.portal.models.ErrorResponseException>`
        """
        # Construct URL
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('Dashboard', response)
    ...
    def delete(
            self, resource_group_name, dashboard_name, custom_headers=None, raw=False, **operation_config):
    ...
    def update(
        ...
        :type dashboard: ~microsoft.portal.models.PatchableDashboard
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~microsoft.portal.models.DashboardPaged[~microsoft.portal.models.Dashboard]
        :raises:
         :class:`ErrorResponseException<microsoft.portal.models.ErrorResponseException>`
        """
        ...
        deserialized = models.DashboardPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.DashboardPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
