...
class SqlServer(ProxyResource):
    ...
    def __init__(self, *, cores: int=None, version: str=None, edition: str=None, registration_id: str=None, property_bag: str=None, **kwargs) -> None:
...
class SqlServerRegistration(TrackedResource):
    ...
    def __init__(self, *, location: str, tags=None, subscription_id: str=None, resource_group: str=None, property_bag: str=None, **kwargs) -> None:
        super(SqlServerRegistration, self).__init__(location=location, tags=tags, **kwargs)
