...
class VirtualNetworkGatewayConnectionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualNetworkGatewayConnection <azure.mgmt.network.v2017_06_01.models.VirtualNetworkGatewayConnection>` object
    """
