...
class CopyLogDetails(msrest.serialization.Model):
    ...
    _subtype_map = {
        'copy_log_details_type': {'DataBox': 'DataBoxAccountCopyLogDetails', 'DataBoxCustomerDisk': 'DataBoxCustomerDiskCopyLogDetails', 'DataBoxDisk': 'DataBoxDiskCopyLogDetails', 'DataBoxHeavy': 'DataBoxHeavyAccountCopyLogDetails'}
    }
...
class JobSecrets(msrest.serialization.Model):
    ...
    You probably want to use the sub-classes and not this class directly. Known
    sub-classes are: DataboxJobSecrets, CustomerDiskJobSecrets, DataBoxDiskJobSecrets, DataBoxHeavyJobSecrets.
    ...
    _subtype_map = {
        'job_secrets_type': {'DataBox': 'DataboxJobSecrets', 'DataBoxCustomerDisk': 'CustomerDiskJobSecrets', 'DataBoxDisk': 'DataBoxDiskJobSecrets', 'DataBoxHeavy': 'DataBoxHeavyJobSecrets'}
    }
...
class CustomerDiskJobSecrets(JobSecrets):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(CustomerDiskJobSecrets, self).__init__(**kwargs)
        self.job_secrets_type = 'DataBoxCustomerDisk'  # type: str
...
class DataBoxCustomerDiskCopyLogDetails(CopyLogDetails):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(DataBoxCustomerDiskCopyLogDetails, self).__init__(**kwargs)
        self.copy_log_details_type = 'DataBoxCustomerDisk'  # type: str
...
class DataBoxCustomerDiskCopyProgress(CopyProgress):
    ...
    :ivar serial_number: Disk Serial Number.
    :vartype serial_number: str
    :ivar copy_status: The Status of the copy. Possible values include: "NotStarted", "InProgress",
     ...
     "DriveNotDetected", "DriveCorrupted", "MetadataFilesModifiedOrRemoved".
...
class JobDetails(msrest.serialization.Model):
    ...
    You probably want to use the sub-classes and not this class directly. Known
    sub-classes are: DataBoxJobDetails, DataBoxCustomerDiskJobDetails, DataBoxDiskJobDetails, DataBoxHeavyJobDetails.
    ...
    :ivar job_details_type: Required. Indicates the type of job details.Constant filled by server.
     Possible values include: "DataBox", "DataBoxDisk", "DataBoxHeavy", "DataBoxCustomerDisk".
    ...
    :ivar data_center_code: DataCenter code. Possible values include: "Invalid", "BY2", "BY1",
     "ORK70", "AM2", "AMS20", "BY21", "BY24", "MWH01", "AMS06", "SSE90", "SYD03", "SYD23", "CBR20",
     "YTO20", "CWL20", "LON24", "BOM01", "BL20", "BL7", "SEL20", "TYO01", "BN1", "SN5", "CYS04",
     "TYO22", "YTO21", "YQB20", "FRA22", "MAA01", "CPQ02", "CPQ20", "SIN20", "HKG20", "SG2",
     "MEL23", "SEL21", "OSA20", "SHA03", "BJB", "JNB22", "JNB21", "MNZ21", "SN8", "AUH20", "ZRH20",
     "PUS20", "AdHoc", "CH1", "DSM05", "DUB07", "PNQ01", "SVG20", "OSA02", "OSA22", "PAR22", "BN7",
     "SN6", "BJS20".
    ...
    _subtype_map = {
        'job_details_type': {'DataBox': 'DataBoxJobDetails', 'DataBoxCustomerDisk': 'DataBoxCustomerDiskJobDetails', 'DataBoxDisk': 'DataBoxDiskJobDetails', 'DataBoxHeavy': 'DataBoxHeavyJobDetails'}
    }
...
class DataBoxCustomerDiskJobDetails(JobDetails):
    ...
    :ivar return_to_customer_package_details: Required. Return package shipping details.
    ...
    _attribute_map = {
        ...
        'return_to_customer_package_details': {'key': 'returnToCustomerPackageDetails', 'type': 'PackageCarrierDetails'},
    ...
    def __init__(
        ...
        *,
        ...
        key_encryption_key: Optional["KeyEncryptionKey"] = None,
        expected_data_size_in_tera_bytes: Optional[int] = None,
        import_disk_details_collection: Optional[Dict[str, "ImportDiskDetails"]] = None,
        enable_manifest_backup: Optional[bool] = False,
        **kwargs
    ):
        """
        :keyword contact_details: Required. Contact details for notification and shipping.
        ...
        :paramtype import_disk_details_collection: dict[str,
         ~azure.mgmt.databox.v2022_02_01.models.ImportDiskDetails]
        :keyword return_to_customer_package_details: Required. Return package shipping details.
...
class GranularCopyLogDetails(msrest.serialization.Model):
    """Granular Details for log generated during copy.

    You probably want to use the sub-classes and not this class directly. Known
    sub-classes are: DataBoxDiskGranularCopyLogDetails.
    ...
    _subtype_map = {
        'copy_log_details_type': {'DataBoxCustomerDisk': 'DataBoxDiskGranularCopyLogDetails'}
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(GranularCopyLogDetails, self).__init__(**kwargs)
        self.copy_log_details_type = None  # type: Optional[str]
...
class DataBoxDiskGranularCopyLogDetails(GranularCopyLogDetails):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(DataBoxDiskGranularCopyLogDetails, self).__init__(**kwargs)
        self.copy_log_details_type = 'DataBoxCustomerDisk'  # type: str
        self.serial_number = None
        self.account_name = None
        self.error_log_link = None
...
class GranularCopyProgress(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(GranularCopyProgress, self).__init__(**kwargs)
        self.storage_account_name = None
        self.transfer_type = None
        self.data_account_type = None
        self.account_id = None
...
class DataBoxDiskGranularCopyProgress(GranularCopyProgress):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(DataBoxDiskGranularCopyProgress, self).__init__(**kwargs)
        self.serial_number = None
        self.copy_status = None
...
class DatacenterAddressResponse(msrest.serialization.Model):
    """Datacenter address for given storage location.

    You probably want to use the sub-classes and not this class directly. Known
    sub-classes are: DatacenterAddressInstructionResponse, DatacenterAddressLocationResponse.

    Variables are only populated by the server, and will be ignored when sending a request.

    All required parameters must be populated in order to send to Azure.

    :ivar datacenter_address_type: Required. Data center address type.Constant filled by server.
     Possible values include: "DatacenterAddressLocation", "DatacenterAddressInstruction".
    ...
    _subtype_map = {
        'datacenter_address_type': {'DatacenterAddressInstruction': 'DatacenterAddressInstructionResponse', 'DatacenterAddressLocation': 'DatacenterAddressLocationResponse'}
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(DatacenterAddressResponse, self).__init__(**kwargs)
        self.datacenter_address_type = None  # type: Optional[str]
...
class DatacenterAddressInstructionResponse(DatacenterAddressResponse):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.datacenter_address_type = 'DatacenterAddressInstruction'  # type: str
...
class DatacenterAddressLocationResponse(DatacenterAddressResponse):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(DatacenterAddressLocationResponse, self).__init__(**kwargs)
        self.datacenter_address_type = 'DatacenterAddressLocation'  # type: str
...
class DatacenterAddressRequest(msrest.serialization.Model):
    """Request body to get the datacenter address.

    All required parameters must be populated in order to send to Azure.

    :ivar storage_location: Required. Storage location. For locations check:
     https://management.azure.com/subscriptions/SUBSCRIPTIONID/locations?api-version=2018-01-01.
    :vartype storage_location: str
    :ivar sku_name: Required. Sku Name for which the data center address requested. Possible values
     include: "DataBox", "DataBoxDisk", "DataBoxHeavy", "DataBoxCustomerDisk".
    :vartype sku_name: str or ~azure.mgmt.databox.v2022_02_01.models.SkuName
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword storage_location: Required. Storage location. For locations check:
         https://management.azure.com/subscriptions/SUBSCRIPTIONID/locations?api-version=2018-01-01.
        :paramtype storage_location: str
        :keyword sku_name: Required. Sku Name for which the data center address requested. Possible
         values include: "DataBox", "DataBoxDisk", "DataBoxHeavy", "DataBoxCustomerDisk".
        :paramtype sku_name: str or ~azure.mgmt.databox.v2022_02_01.models.SkuName
        """
        super(DatacenterAddressRequest, self).__init__(**kwargs)
        self.storage_location = storage_location
...
class DataTransferDetailsValidationRequest(ValidationInputRequest):
    ...
    :ivar device_type: Required. Device type. Possible values include: "DataBox", "DataBoxDisk",
     "DataBoxHeavy", "DataBoxCustomerDisk".
    :vartype device_type: str or ~azure.mgmt.databox.v2022_02_01.models.SkuName
    :ivar transfer_type: Required. Type of the transfer. Possible values include: "ImportToAzure",
     "ExportFromAzure".
    :vartype transfer_type: str or ~azure.mgmt.databox.v2022_02_01.models.TransferType
...
class DeviceErasureDetails(msrest.serialization.Model):
    """Device erasure details with erasure completion status and erasureordestructionlog sas key.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar device_erasure_status: Holds the device erasure completion status. Possible values
     include: "None", "InProgress", "Succeeded", "Failed", "Cancelled", "Cancelling",
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(DeviceErasureDetails, self).__init__(**kwargs)
...
class ExportDiskDetails(msrest.serialization.Model):
    """Export disk details.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(ExportDiskDetails, self).__init__(**kwargs)
...
class ImportDiskDetails(msrest.serialization.Model):
    """Import disk details.
    ...
    :ivar manifest_file: Required. The relative path of the manifest file on the disk.
    :vartype manifest_file: str
    :ivar manifest_hash: Required. The Base16-encoded MD5 hash of the manifest file on the disk.
    :vartype manifest_hash: str
    :ivar bit_locker_key: Required. BitLocker key used to encrypt the disk.
    :vartype bit_locker_key: str
    :ivar backup_manifest_cloud_path: Path to backed up manifest, only returned if
     enableManifestBackup is true.
    :vartype backup_manifest_cloud_path: str
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword manifest_file: Required. The relative path of the manifest file on the disk.
        :paramtype manifest_file: str
        :keyword manifest_hash: Required. The Base16-encoded MD5 hash of the manifest file on the disk.
        :paramtype manifest_hash: str
        :keyword bit_locker_key: Required. BitLocker key used to encrypt the disk.
        :paramtype bit_locker_key: str
        """
        super(ImportDiskDetails, self).__init__(**kwargs)
...
class JobResource(Resource):
    ...
    :ivar status: Name of the stage which is in progress. Possible values include: "DeviceOrdered",
     ...
     "AwaitingShipmentDetails", "PreparingToShipFromAzureDC", "ShippedToCustomer".
...
class MarkDevicesShippedRequest(msrest.serialization.Model):
    """The request body to provide the delivery package details of job.

    All required parameters must be populated in order to send to Azure.

    :ivar deliver_to_dc_package_details: Required. Delivery package details.
    :vartype deliver_to_dc_package_details:
     ~azure.mgmt.databox.v2022_02_01.models.PackageCarrierInfo
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword deliver_to_dc_package_details: Required. Delivery package details.
        :paramtype deliver_to_dc_package_details:
         ~azure.mgmt.databox.v2022_02_01.models.PackageCarrierInfo
        """
        super(MarkDevicesShippedRequest, self).__init__(**kwargs)
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword customer_resolution_code: Required. Resolution code for the job. Possible values
         include: "None", "MoveToCleanUpDevice", "Resume", "Restart", "ReachOutToOperation".
...
class NotificationPreference(msrest.serialization.Model):
    ...
    :ivar stage_name: Required. Name of the stage. Possible values include: "DevicePrepared",
     "Dispatched", "Delivered", "PickedUp", "AtAzureDC", "DataCopy", "Created", "ShippedToCustomer".
...
class PackageCarrierDetails(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super(PackageCarrierDetails, self).__init__(**kwargs)
        self.carrier_account_number = carrier_account_number
        self.carrier_name = carrier_name
        self.tracking_id = tracking_id


class PackageCarrierInfo(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype tracking_id: str
        """
        super(PackageCarrierInfo, self).__init__(**kwargs)
        self.carrier_name = carrier_name
        self.tracking_id = tracking_id
...
class Preferences(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        storage_account_access_tier_preferences: Optional[List[str]] = None,
        **kwargs
    ):
        """
...
class RegionConfigurationRequest(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        datacenter_address_request: Optional["DatacenterAddressRequest"] = None,
        **kwargs
    ):
        """
...
class UpdateJobDetails(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        shipping_address: Optional["ShippingAddress"] = None,
        key_encryption_key: Optional["KeyEncryptionKey"] = None,
        return_to_customer_package_details: Optional["PackageCarrierDetails"] = None,
        **kwargs
    ):
        """
