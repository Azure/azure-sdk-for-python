...
class ServiceOperations:
    ...
    def list_available_skus_by_resource_group(
        ...
        **kwargs: Any
        ...
        :type available_sku_request: ~azure.mgmt.databox.v2021_08_01_preview.models.AvailableSkuRequest
    ...
    def validate_address(
        ...
        **kwargs: Any
        ...
        :type validate_address: ~azure.mgmt.databox.v2021_08_01_preview.models.ValidateAddress
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AddressValidationOutput or the result of cls(response)
        :rtype: ~azure.mgmt.databox.v2021_08_01_preview.models.AddressValidationOutput
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def validate_address(
        ...
        :param validate_address: Shipping address of the customer. Is either a ValidateAddress type or
         a IO type. Required.
        :type validate_address: ~azure.mgmt.databox.v2021_08_01_preview.models.ValidateAddress or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def validate_inputs_by_resource_group(
        ...
        **kwargs: Any
        ...
        :type validation_request: ~azure.mgmt.databox.v2021_08_01_preview.models.ValidationRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ValidationResponse or the result of cls(response)
        :rtype: ~azure.mgmt.databox.v2021_08_01_preview.models.ValidationResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def validate_inputs_by_resource_group(
        ...
        **kwargs: Any
        ...
        :param validation_request: Inputs of the customer. Is either a ValidationRequest type or a IO
         type. Required.
        :type validation_request: ~azure.mgmt.databox.v2021_08_01_preview.models.ValidationRequest or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
    ...
    def region_configuration(
        ...
        **kwargs: Any
        ...
        :type region_configuration_request:
         ~azure.mgmt.databox.v2021_08_01_preview.models.RegionConfigurationRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: RegionConfigurationResponse or the result of cls(response)
        :rtype: ~azure.mgmt.databox.v2021_08_01_preview.models.RegionConfigurationResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def region_configuration(
        ...
        :type region_configuration_request:
         ~azure.mgmt.databox.v2021_08_01_preview.models.RegionConfigurationRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
