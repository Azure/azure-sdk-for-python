...
class DataBoxManagementClient(DataBoxManagementClientOperationsMixin):
    ...
    :vartype operations: azure.mgmt.databox.v2021_08_01_preview.aio.operations.Operations
    :ivar jobs: JobsOperations operations
    :vartype jobs: azure.mgmt.databox.v2021_08_01_preview.aio.operations.JobsOperations
    :ivar service: ServiceOperations operations
    :vartype service: azure.mgmt.databox.v2021_08_01_preview.aio.operations.ServiceOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = DataBoxManagementClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
