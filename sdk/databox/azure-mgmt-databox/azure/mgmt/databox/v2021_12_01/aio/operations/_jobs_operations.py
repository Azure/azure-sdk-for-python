...
from ...operations._jobs_operations import build_book_shipment_pick_up_request, build_cancel_request, build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_resource_group_request, build_list_credentials_request, build_list_request, build_mark_devices_shipped_request, build_update_request_initial
T = TypeVar('T')
...
class JobsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databox.v2021_12_01.models.JobResourceList]
    ...
    async def mark_devices_shipped(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param mark_devices_shipped_request: Mark Devices Shipped Request.
    ...
    mark_devices_shipped.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBox/jobs/{jobName}/markDevicesShipped"}  # type: ignore
    ...
    def list_credentials(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either UnencryptedCredentialsList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databox.v2021_12_01.models.UnencryptedCredentialsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-12-01")  # type: str
