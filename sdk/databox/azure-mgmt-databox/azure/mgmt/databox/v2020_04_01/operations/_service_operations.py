...
class ServiceOperations(object):
    ...
    def region_configuration_by_resource_group(
            self, resource_group_name, location, schedule_availability_request=None, transport_availability_request=None, custom_headers=None, raw=False, **operation_config):
        """This API provides configuration details specific to given
