...
def build_list_available_skus_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DataBox/locations/{location}/availableSkus")  # pylint: disable=line-too-long
...
class ServiceOperations(object):
    ...
    def list_available_skus(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.databox.v2019_09_01.models.AvailableSkusResult]
