...
from ._configuration import SpringAppDiscoveryMgmtClientConfiguration
...
class SpringAppDiscoveryMgmtClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = SpringAppDiscoveryMgmtClientConfiguration(
    ...
    async def __aenter__(self) -> "SpringAppDiscoveryMgmtClient":
