...
# USAGE
    python certificates_create_or_update_maximum_set_gen.py
...
# x-ms-original-file: specification/nginx/resource-manager/NGINX.NGINXPLUS/preview/2025-03-01-preview/examples/Certificates_CreateOrUpdate_MaximumSet_Gen.json
