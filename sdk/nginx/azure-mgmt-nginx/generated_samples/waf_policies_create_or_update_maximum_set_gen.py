...
# USAGE
    python waf_policies_create_or_update_maximum_set_gen.py
...
def main():
    ...
    response = client.waf_policies.begin_create_or_update(
        resource_group_name="rgopenapi",
        nginx_deployment_name="myDeployment",
        waf_policy_name="myPolicy",
        resource={
            "properties": {
                "applyingState": {
                    "code": "pvmrdpdwrubbgk",
...
# x-ms-original-file: specification/nginx/resource-manager/NGINX.NGINXPLUS/preview/2025-03-01-preview/examples/WafPolicies_CreateOrUpdate_MaximumSet_Gen.json
