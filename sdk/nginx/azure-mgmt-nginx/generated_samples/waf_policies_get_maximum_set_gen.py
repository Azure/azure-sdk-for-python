...
# USAGE
    python waf_policies_get_maximum_set_gen.py
...
def main():
    ...
    response = client.waf_policies.get(
...
# x-ms-original-file: specification/nginx/resource-manager/NGINX.NGINXPLUS/preview/2025-03-01-preview/examples/WafPolicies_Get_MaximumSet_Gen.json
