...
# USAGE
    python configurations_get_maximum_set_gen.py
...
# x-ms-original-file: specification/nginx/resource-manager/NGINX.NGINXPLUS/preview/2025-03-01-preview/examples/Configurations_Get_MaximumSet_Gen.json
