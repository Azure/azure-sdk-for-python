...
# USAGE
    python certificates_delete_maximum_set_gen.py
...
# x-ms-original-file: specification/nginx/resource-manager/NGINX.NGINXPLUS/preview/2025-03-01-preview/examples/Certificates_Delete_MaximumSet_Gen.json
