...
class TestNginxManagementNginxDeploymentsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(NginxManagementClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_nginx_deployments_list_by_subscription(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_nginx_deployments_list_by_resource_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_nginx_deployments_get(self, resource_group):
        response = await self.client.nginx_deployments.get(
            resource_group_name=resource_group.name,
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_nginx_deployments_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.nginx_deployments.begin_create_or_update(
                resource_group_name=resource_group.name,
                nginx_deployment_name="str",
                resource={
                    "location": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_nginx_deployments_update(self, resource_group):
        response = await self.client.nginx_deployments.update(
            resource_group_name=resource_group.name,
            nginx_deployment_name="str",
            properties={
                "identity": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_nginx_deployments_begin_delete(self, resource_group):
        response = await (
            await self.client.nginx_deployments.begin_delete(
                resource_group_name=resource_group.name,
                nginx_deployment_name="str",
                api_version="2025-03-01-preview",
            )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_nginx_deployments_list_default_waf_policies(self, resource_group):
        response = await self.client.nginx_deployments.list_default_waf_policies(
            resource_group_name=resource_group.name,
            nginx_deployment_name="str",
            api_version="2025-03-01-preview",
        )
