...
def build_get_request(
    resource_group_name: str, nginx_deployment_name: str, configuration_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "configurationName": _SERIALIZER.url(
            "configuration_name", configuration_name, "str", pattern=r"^[a-zA-Z0-9-]{3,24}$"
        ),
    }
...
def build_analyze_request(
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/NGINX.NGINXPLUS/nginxDeployments/{nginxDeploymentName}/configurations/{configurationName}/analyze",
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url(
...
class ConfigurationsOperations:
    ...
    def list_by_deployment(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.nginx.models.Configuration]
