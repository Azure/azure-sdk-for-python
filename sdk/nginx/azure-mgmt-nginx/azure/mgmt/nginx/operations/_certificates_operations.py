...
def build_get_request(
    resource_group_name: str, nginx_deployment_name: str, certificate_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "certificateName": _SERIALIZER.url(
            "certificate_name", certificate_name, "str", pattern=r"^[a-zA-Z0-9-]{3,24}$"
        ),
    }
...
class CertificatesOperations:
    ...
    def list_by_deployment(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.nginx.models.Certificate]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either Certificate or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.nginx.models.Certificate]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
