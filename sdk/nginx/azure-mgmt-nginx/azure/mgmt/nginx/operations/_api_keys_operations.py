...
def build_list_by_deployment_request(
...
def build_get_request(
    resource_group_name: str, nginx_deployment_name: str, api_key_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ApiKeysOperations:
    ...
    def list_by_deployment(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.nginx.models.ApiKey]
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, nginx_deployment_name: str, api_key_name: str, **kwargs: Any
    ) -> _models.ApiKey:
        ...
        :param nginx_deployment_name: The name of the Nginx deployment resource. Required.
        :type nginx_deployment_name: str
        :param api_key_name: The name of the API Key resource. Required.
        :type api_key_name: str
        :return: ApiKey or the result of cls(response)
        :rtype: ~azure.mgmt.nginx.models.ApiKey
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create_or_update(
        ...
        api_key_name: str,
        resource: _models.ApiKeyRequest,
        *,
        ...
        **kwargs: Any
        ...
        :param api_key_name: The name of the API Key resource. Required.
        :type api_key_name: str
        :param resource: The API key resource to create or update. Required.
        :type resource: ~azure.mgmt.nginx.models.ApiKeyRequest
    ...
    def create_or_update(
        ...
        nginx_deployment_name: str,
        api_key_name: str,
        resource: Union[_models.ApiKeyRequest, IO[bytes]],
        **kwargs: Any
    ) -> _models.ApiKey:
        """Creates a new API key or replaces an existing one.
        ...
        :param api_key_name: The name of the API Key resource. Required.
        :type api_key_name: str
        :param resource: The API key resource to create or update. Is either a ApiKeyRequest type or a
         IO[bytes] type. Required.
        :type resource: ~azure.mgmt.nginx.models.ApiKeyRequest or IO[bytes]
        :return: ApiKey or the result of cls(response)
        :rtype: ~azure.mgmt.nginx.models.ApiKey
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "ApiKeyRequest")
