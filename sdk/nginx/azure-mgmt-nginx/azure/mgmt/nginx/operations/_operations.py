...
def build_list_request(
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Nginx.NginxPlus/operations")
...
class Operations(object):
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.nginx.models.OperationListResult]
    ...
    list.metadata = {'url': "/providers/Nginx.NginxPlus/operations"}  # type: ignore
