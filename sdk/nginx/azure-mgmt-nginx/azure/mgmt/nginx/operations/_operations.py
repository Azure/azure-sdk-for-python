...
def build_nginx_deployment_waf_policies_analysis_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Nginx.NginxPlus/nginxDeployments/{deploymentName}/wafPolicies/{wafPolicyName}/analyzeWafPolicy"
...
class NginxDeploymentWafPoliciesOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~azure.mgmt.nginx.NginxManagementClient`'s
        :attr:`nginx_deployment_waf_policies` attribute.
    """
    ...
    def analysis(
        ...
        deployment_name: str,
        waf_policy_name: str,
        body: Optional[_models.NginxDeploymentWafPolicyAnalysisCreateRequest] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.NginxDeploymentWafPolicyAnalysisResponse:
        ...
        :type body: ~azure.mgmt.nginx.models.NginxDeploymentWafPolicyAnalysisCreateRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: NginxDeploymentWafPolicyAnalysisResponse. The NginxDeploymentWafPolicyAnalysisResponse
         is compatible with MutableMapping
        :rtype: ~azure.mgmt.nginx.models.NginxDeploymentWafPolicyAnalysisResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def analysis(
        ...
        deployment_name: str,
        waf_policy_name: str,
        body: Optional[Union[_models.NginxDeploymentWafPolicyAnalysisCreateRequest, JSON, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.NginxDeploymentWafPolicyAnalysisResponse:
        """Analyze an Nginx Waf Policy.
        ...
        :param body: The content of the action request. Is one of the following types:
         NginxDeploymentWafPolicyAnalysisCreateRequest, JSON, IO[bytes] Default value is None.
        :type body: ~azure.mgmt.nginx.models.NginxDeploymentWafPolicyAnalysisCreateRequest or JSON or
         IO[bytes]
        :return: NginxDeploymentWafPolicyAnalysisResponse. The NginxDeploymentWafPolicyAnalysisResponse
         is compatible with MutableMapping
        :rtype: ~azure.mgmt.nginx.models.NginxDeploymentWafPolicyAnalysisResponse
        ...
        cls: ClsType[_models.NginxDeploymentWafPolicyAnalysisResponse] = kwargs.pop("cls", None)
        ...
        _request = build_nginx_deployment_waf_policies_analysis_request(
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.NginxDeploymentWafPolicyAnalysisResponse, response.json())
...
class ApiKeysOperations:
    ...
    def list(
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.NginxDeploymentApiKeyResponse],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
...
class WafPolicyOperations:
    ...
    def list(
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.NginxDeploymentWafPolicyMetadata],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
...
class ConfigurationsOperations:
    ...
    def list(
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.NginxConfigurationResponse],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
