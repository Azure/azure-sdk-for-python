...
class DeploymentsOperations:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Nginx.NginxPlus/nginxDeployments/{deploymentName}"
    }
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.NginxDeployment"]:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.NginxDeploymentListResponse] = kwargs.pop("cls", None)
    ...
    list.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Nginx.NginxPlus/nginxDeployments"}
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Nginx.NginxPlus/nginxDeployments"
    }
