...
class DeploymentsOperations:
    ...
    def _create_or_update_initial(
        ...
        deployment_name: str,
        body: Optional[Union[_models.NginxDeployment, IO[bytes]]] = None,
        **kwargs: Any
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param deployment_name: The name of targeted NGINX deployment. Required.
        :type deployment_name: str
        :param body: Is either a NginxDeployment type or a IO[bytes] type. Default value is None.
        :type body: ~azure.mgmt.nginx.models.NginxDeployment or IO[bytes]
        :return: An instance of LROPoller that returns either NginxDeployment or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.nginx.models.NginxDeployment]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        deployment_name: str,
        body: Optional[Union[_models.NginxDeploymentUpdateParameters, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.NginxDeployment:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param deployment_name: The name of targeted NGINX deployment. Required.
        :type deployment_name: str
        :param body: Is either a NginxDeploymentUpdateParameters type or a IO[bytes] type. Default
         value is None.
        :type body: ~azure.mgmt.nginx.models.NginxDeploymentUpdateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either NginxDeployment or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.nginx.models.NginxDeployment]
        :raises ~azure.core.exceptions.HttpResponseError:
