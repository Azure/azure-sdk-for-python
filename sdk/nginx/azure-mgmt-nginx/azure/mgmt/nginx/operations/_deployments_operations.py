...
class DeploymentsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param deployment_name: The name of targeted NGINX deployment. Required.
        :type deployment_name: str
        :param body: The Nginx deployment. Is either a NginxDeployment type or a IO[bytes] type.
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param deployment_name: The name of targeted NGINX deployment. Required.
        :type deployment_name: str
        :param body: The Nginx deployment update parameters. Is either a
         NginxDeploymentUpdateParameters type or a IO[bytes] type. Default value is None.
