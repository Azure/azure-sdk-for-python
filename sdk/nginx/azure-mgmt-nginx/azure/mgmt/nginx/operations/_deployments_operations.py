...
class DeploymentsOperations:
    ...
    def _create_initial(
        ...
        deployment_name: str,
        body: Optional[Union[_models.NginxDeployment, IO]] = None,
        **kwargs: Any
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        deployment_name: str,
        body: Optional[Union[_models.NginxDeploymentUpdateParameters, IO]] = None,
        **kwargs: Any
    ) -> _models.NginxDeployment:
        error_map = {
            401: ClientAuthenticationError,
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.NginxDeployment"]:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.NginxDeployment"]:
