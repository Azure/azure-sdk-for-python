...
class NginxManagementClient:
    ...
    :vartype nginx_deployments: azure.mgmt.nginx.aio.operations.NginxDeploymentsOperations
    ...
    :vartype waf_policies: azure.mgmt.nginx.aio.operations.WafPoliciesOperations
