...
from ...operations._configurations_operations import (
    ...
    build_get_request,
    build_list_by_deployment_request,
...
class ConfigurationsOperations:
    ...
    def list_by_deployment(
        self, resource_group_name: str, nginx_deployment_name: str, **kwargs: Any
        ...
        :param nginx_deployment_name: The name of the Nginx deployment resource. Required.
        :type nginx_deployment_name: str
        :return: An iterator like instance of either Configuration or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.nginx.models.Configuration]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_deployment_request(
    ...
    async def get(
        self, resource_group_name: str, nginx_deployment_name: str, configuration_name: str, **kwargs: Any
        ...
        :rtype: ~azure.mgmt.nginx.models.Configuration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        resource: _models.NginxConfigurationRequest,
        *,
        ...
        **kwargs: Any
        ...
        :param configuration_name: The name of the Configuration. Required.
        :type configuration_name: str
        :param resource: The configuration resource to create or update. Required.
        :type resource: ~azure.mgmt.nginx.models.NginxConfigurationRequest
    ...
    async def create_or_update(
        ...
        nginx_deployment_name: str,
        configuration_name: str,
        resource: Union[_models.NginxConfigurationRequest, IO[bytes]],
        **kwargs: Any
    ) -> _models.Configuration:
        """Creates or updates a configuration.
        ...
        :param configuration_name: The name of the Configuration. Required.
        :type configuration_name: str
        :param resource: The configuration resource to create or update. Is either a
         NginxConfigurationRequest type or a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.nginx.models.NginxConfigurationRequest or IO[bytes]
        :return: Configuration or the result of cls(response)
        :rtype: ~azure.mgmt.nginx.models.Configuration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "NginxConfigurationRequest")
    ...
    async def update(
        ...
        nginx_deployment_name: str,
        configuration_name: str,
        properties: _models.ConfigurationUpdate,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.Configuration:
        ...
        :type properties: ~azure.mgmt.nginx.models.ConfigurationUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Configuration or the result of cls(response)
    ...
    async def update(
        ...
        nginx_deployment_name: str,
        configuration_name: str,
        properties: Union[_models.ConfigurationUpdate, IO[bytes]],
        **kwargs: Any
    ) -> _models.Configuration:
        """Patches an existing configuration.
        ...
        :param configuration_name: The name of the Configuration. Required.
        :type configuration_name: str
        :param properties: The resource properties to be updated. Is either a ConfigurationUpdate type
         or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.nginx.models.ConfigurationUpdate or IO[bytes]
        :return: Configuration or the result of cls(response)
        :rtype: ~azure.mgmt.nginx.models.Configuration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "ConfigurationUpdate")
    ...
    async def analyze(
        ...
        nginx_deployment_name: str,
        configuration_name: str,
        body: Union[_models.AnalysisCreate, IO[bytes]],
        **kwargs: Any
    ) -> _models.AnalysisResult:
        """Analyzes a configuration for potential issues or optimizations.
        ...
        :param configuration_name: The name of the Configuration. Required.
        :type configuration_name: str
        :param body: The content of the action request. Is either a AnalysisCreate type or a IO[bytes]
         type. Required.
