...
class ConfigurationsOperations:
    ...
    async def _create_or_update_initial(
        ...
        body: Optional[Union[_models.NginxConfiguration, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.NginxConfiguration:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param configuration_name: The name of configuration, only 'default' is supported value due to
         the singleton of NGINX conf. Required.
        :type configuration_name: str
        :param body: The NGINX configuration. Is either a NginxConfiguration type or a IO[bytes] type.
         Default value is None.
        :type body: ~azure.mgmt.nginx.models.NginxConfiguration or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NginxConfiguration or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.nginx.models.NginxConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return AsyncLROPoller[_models.NginxConfiguration].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.NginxConfiguration](
