...
from ...operations._certificates_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_request
T = TypeVar('T')
...
class CertificatesOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize('NginxCertificate', pipeline_response)
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either NginxCertificate or the result of
         cls(response)
    ...
    _delete_initial.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Nginx.NginxPlus/nginxDeployments/{deploymentName}/certificates/{certificateName}"}  # type: ignore
    ...
    begin_delete.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Nginx.NginxPlus/nginxDeployments/{deploymentName}/certificates/{certificateName}"}  # type: ignore
    ...
    def list(
        ...
        deployment_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.NginxCertificateListResponse"]:
        ...
        :type deployment_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either NginxCertificateListResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.nginx.models.NginxCertificateListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Nginx.NginxPlus/nginxDeployments/{deploymentName}/certificates"}  # type: ignore
