...
class CertificatesOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param certificate_name: The name of certificate. Required.
        :type certificate_name: str
        :param body: The certificate. Is either a model type or a IO type. Default value is None.
        :type body: ~azure.mgmt.nginx.models.NginxCertificate or IO
    ...
    ) -> AsyncIterable["_models.NginxCertificate"]:
