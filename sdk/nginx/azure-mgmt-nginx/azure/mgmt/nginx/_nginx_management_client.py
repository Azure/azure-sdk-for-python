...
class NginxManagementClient:
    ...
    :ivar nginx_deployments: NginxDeploymentsOperations operations
    :vartype nginx_deployments: azure.mgmt.nginx.operations.NginxDeploymentsOperations
    ...
    :ivar waf_policies: WafPoliciesOperations operations
    :vartype waf_policies: azure.mgmt.nginx.operations.WafPoliciesOperations
    ...
    def __init__(
        ...
        self.nginx_deployments = NginxDeploymentsOperations(
        ...
        self.waf_policies = WafPoliciesOperations(self._client, self._config, self._serialize, self._deserialize)
