...
class NginxDeploymentWafPolicyAnalysisCreateRequest(_Model):  # pylint: disable=name-too-long
    """Nginx Deployment Waf Policy Analysis Create Request.

    :ivar content: The byte content of the policy.
    :vartype content: bytes
    :ivar filepath: The absolute file path of the policy as in the virtual machine.
    :vartype filepath: str
    """
...
class NginxDeploymentWafPolicyAnalysisData(_Model):
    """Nginx Deployment Waf Policy Analysis Data.

    :ivar errors: List of errors found during analysis.
    :vartype errors: list[~azure.mgmt.nginx.models.NginxDeploymentWafPolicyError]
    """

    errors: Optional[list["_models.NginxDeploymentWafPolicyError"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        errors: Optional[list["_models.NginxDeploymentWafPolicyError"]] = None,
    ) -> None: ...
...
class NginxDeploymentWafPolicyAnalysisResponse(_Model):
    """Nginx Deployment Waf Policy Analysis Response.

    :ivar status: The status of the analysis. The possible values can be arbitrary.
    :vartype status: str
    :ivar data: The analysis data containing errors.
    :vartype data: ~azure.mgmt.nginx.models.NginxDeploymentWafPolicyAnalysisData
    """
    ...
    data: Optional["_models.NginxDeploymentWafPolicyAnalysisData"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        ...
        data: Optional["_models.NginxDeploymentWafPolicyAnalysisData"] = None,
    ) -> None: ...
...
class NginxDeploymentWafPolicyError(_Model):
    """Nginx Deployment Waf Policy Error.

    :ivar code: Error code.
    :vartype code: str
    :ivar field: Field that caused the error.
    :vartype field: str
