...
class AzureContainerStorageRPConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    """Configuration for AzureContainerStorageRP.
    ...
    def __init__(self, credential: "AsyncTokenCredential", subscription_id: str, **kwargs: Any) -> None:
        super(AzureContainerStorageRPConfiguration, self).__init__(**kwargs)
