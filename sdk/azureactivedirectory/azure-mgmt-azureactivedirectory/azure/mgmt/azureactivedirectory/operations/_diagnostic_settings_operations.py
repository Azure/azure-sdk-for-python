...
class DiagnosticSettingsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.DiagnosticSettingsResourceCollection"
        ...
        :rtype: ~azureactivedirectory.models.DiagnosticSettingsResourceCollection
        ...
        return deserialized
    list.metadata = {'url': '/providers/microsoft.aadiam/diagnosticSettings'}  # type: ignore
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azureactivedirectory.models.DiagnosticSettingsResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        return deserialized
    get.metadata = {'url': '/providers/microsoft.aadiam/diagnosticSettings/{name}'}  # type: ignore
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azureactivedirectory.models.DiagnosticSettingsResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DiagnosticSettingsResource, or the result of cls(response)
        :rtype: ~azureactivedirectory.models.DiagnosticSettingsResource
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        return deserialized
    create_or_update.metadata = {'url': '/providers/microsoft.aadiam/diagnosticSettings/{name}'}  # type: ignore
    ...
    delete.metadata = {'url': '/providers/microsoft.aadiam/diagnosticSettings/{name}'}  # type: ignore
