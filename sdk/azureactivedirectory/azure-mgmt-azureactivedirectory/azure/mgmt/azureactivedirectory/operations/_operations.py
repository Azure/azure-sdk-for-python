...
class Operations(object):
    ...
    :type models: ~azureactivedirectory.models
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azureactivedirectory.models.OperationsDiscoveryCollection
        ...
        return deserialized
    list.metadata = {'url': '/providers/microsoft.aadiam/operations'}  # type: ignore
