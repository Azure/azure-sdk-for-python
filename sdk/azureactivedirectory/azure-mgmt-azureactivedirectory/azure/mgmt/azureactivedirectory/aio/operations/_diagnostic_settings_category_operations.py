...
class DiagnosticSettingsCategoryOperations:
    ...
    async def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azureactivedirectory.models.DiagnosticSettingsCategoryResourceCollection
        ...
        return deserialized
    list.metadata = {'url': '/providers/microsoft.aadiam/diagnosticSettingsCategories'}  # type: ignore
