...
class AzureactivedirectoryConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super(AzureactivedirectoryConfiguration, self).__init__(**kwargs)
