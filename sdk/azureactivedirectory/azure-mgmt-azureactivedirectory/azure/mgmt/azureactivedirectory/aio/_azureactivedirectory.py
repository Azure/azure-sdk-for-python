...
class Azureactivedirectory(object):
    ...
    :vartype operations: azureactivedirectory.aio.operations.Operations
    :ivar diagnostic_settings: DiagnosticSettingsOperations operations
    :vartype diagnostic_settings: azureactivedirectory.aio.operations.DiagnosticSettingsOperations
    :ivar diagnostic_settings_category: DiagnosticSettingsCategoryOperations operations
    :vartype diagnostic_settings_category: azureactivedirectory.aio.operations.DiagnosticSettingsCategoryOperations
    ...
    async def __aenter__(self) -> "Azureactivedirectory":
