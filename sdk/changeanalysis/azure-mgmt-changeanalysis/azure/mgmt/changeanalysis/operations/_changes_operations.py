...
def build_list_changes_by_resource_group_request(  # pylint: disable=name-too-long
...
def build_list_changes_by_subscription_request(  # pylint: disable=name-too-long
    subscription_id: str,
    *,
    start_time: datetime.datetime,
    end_time: datetime.datetime,
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_changes_by_resource_group_request(
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_changes_by_subscription_request(
                    subscription_id=self._config.subscription_id,
                    start_time=start_time,
                    end_time=end_time,
                    skip_token=skip_token,
