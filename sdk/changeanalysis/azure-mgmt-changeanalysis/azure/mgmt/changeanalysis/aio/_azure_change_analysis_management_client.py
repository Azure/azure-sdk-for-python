...
class AzureChangeAnalysisManagementClient(object):
    ...
    :vartype operations: Microsoft.ChangeAnalysis.aio.operations.Operations
    :ivar resource_changes: ResourceChangesOperations operations
    :vartype resource_changes: Microsoft.ChangeAnalysis.aio.operations.ResourceChangesOperations
    :ivar changes: ChangesOperations operations
    :vartype changes: Microsoft.ChangeAnalysis.aio.operations.ChangesOperations
    ...
    async def __aenter__(self) -> "AzureChangeAnalysisManagementClient":
