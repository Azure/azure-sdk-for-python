...
class Operations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~Microsoft.ChangeAnalysis.models.ResourceProviderOperationList]
    ...
    list.metadata = {'url': '/providers/Microsoft.ChangeAnalysis/operations'}  # type: ignore
