...
from ...operations._operations import (
    ...
    build_branches_preflight_request,
...
class OrganizationsOperations:
    ...
    @api_version_validation(
        ...
        api_versions_list=["2025-03-01-preview", "2025-03-01", "2025-06-23-preview"],
    )
    async def get_postgres_versions(
        self,
        resource_group_name: str,
...
class BranchesOperations:
    ...
    async def preflight(
        ...
        project_name: str,
        branch_name: str,
        parameters: _models.PreflightCheckParameters,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.PreflightCheckResult:
        ...
        :param branch_name: The name of the Branch. Required.
        :type branch_name: str
        :param parameters: Parameters for preflight checks. Required.
        :type parameters: ~azure.mgmt.neonpostgres.models.PreflightCheckParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: PreflightCheckResult. The PreflightCheckResult is compatible with MutableMapping
        :rtype: ~azure.mgmt.neonpostgres.models.PreflightCheckResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    @api_version_validation(
        method_added_on="2025-06-23-preview",
        params_added_on={
            "2025-06-23-preview": [
                "api_version",
                "subscription_id",
        ...
        api_versions_list=["2025-06-23-preview"],
    )
    async def preflight(
        self,
        resource_group_name: str,
        ...
        project_name: str,
        branch_name: str,
        parameters: Union[_models.PreflightCheckParameters, JSON, IO[bytes]],
        **kwargs: Any
    ) -> _models.PreflightCheckResult:
        """Action to validate preflight checks.
        ...
        :param branch_name: The name of the Branch. Required.
        :type branch_name: str
        :param parameters: Parameters for preflight checks. Is one of the following types:
         PreflightCheckParameters, JSON, IO[bytes] Required.
        :type parameters: ~azure.mgmt.neonpostgres.models.PreflightCheckParameters or JSON or IO[bytes]
        :return: PreflightCheckResult. The PreflightCheckResult is compatible with MutableMapping
        :rtype: ~azure.mgmt.neonpostgres.models.PreflightCheckResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.PreflightCheckResult] = kwargs.pop("cls", None)
        ...
        _request = build_branches_preflight_request(
            resource_group_name=resource_group_name,
            organization_name=organization_name,
            project_name=project_name,
            branch_name=branch_name,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.PreflightCheckResult, response.json())
...
class ComputesOperations:
    ...
    def list(
        self, resource_group_name: str, organization_name: str, project_name: str, branch_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.Compute"]:
...
class NeonDatabasesOperations:
    ...
    def list(
        self, resource_group_name: str, organization_name: str, project_name: str, branch_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.NeonDatabase"]:
...
class NeonRolesOperations:
    ...
    def list(
        self, resource_group_name: str, organization_name: str, project_name: str, branch_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.NeonRole"]:
