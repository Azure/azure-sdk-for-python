...
class TestNeonPostgresMgmtProjectsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_projects_get_connection_uri(self, resource_group):
        response = self.client.projects.get_connection_uri(
            resource_group_name=resource_group.name,
            organization_name="str",
            project_name="str",
