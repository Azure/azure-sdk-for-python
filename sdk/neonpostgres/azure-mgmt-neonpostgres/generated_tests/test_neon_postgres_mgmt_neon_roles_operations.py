...
class TestNeonPostgresMgmtNeonRolesOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_neon_roles_begin_create_or_update(self, resource_group):
        response = self.client.neon_roles.begin_create_or_update(
            resource_group_name=resource_group.name,
            organization_name="str",
            project_name="str",
            branch_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_neon_roles_delete(self, resource_group):
        response = self.client.neon_roles.delete(
            resource_group_name=resource_group.name,
            organization_name="str",
            project_name="str",
            branch_name="str",
