...
### Features Added
  ...
  - Added enum `Version`
  - Model `DataControllersOperations` added method `begin_patch_data_controller`
  ...
  - Added model `ActiveDirectoryConnectorsOperations`
  - Added model `FailoverGroupsOperations`
  - Added model `PostgresInstancesOperations`
