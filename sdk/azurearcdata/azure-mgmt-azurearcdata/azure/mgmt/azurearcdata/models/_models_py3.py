...
class SqlServerInstanceProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype provisioning_state: str
    :ivar host_type: Type of host for Azure Arc SQL Server. Known values are: "Virtual Machine",
     "Physical Server", "AWS Virtual Machine", "GCP Virtual Machine", and "Other".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword host_type: Type of host for Azure Arc SQL Server. Known values are: "Virtual Machine",
         "Physical Server", "AWS Virtual Machine", "GCP Virtual Machine", and "Other".
