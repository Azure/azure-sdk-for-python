...
class PostgresInstance(TrackedResource):
    ...
    :type properties: ~azure_arc_data_management_client.models.PostgresInstanceProperties
    :param sku: Resource sku.
    :type sku: ~azure_arc_data_management_client.models.PostgresInstanceSku
    """
...
class PostgresInstanceListResult(msrest.serialization.Model):
    ...
    :ivar value: Array of results.
    :vartype value: list[~azure_arc_data_management_client.models.PostgresInstance]
    :ivar next_link: Link to retrieve next page of results.
    :vartype next_link: str
    """
...
class PostgresInstanceProperties(msrest.serialization.Model):
    ...
    :param data_controller_id: The data controller id.
...
class PostgresInstanceSku(CommonSku):
    ...
    :ivar tier: This field is required to be implemented by the Resource Provider if the service
     has more than one tier. Default value: "Hyperscale".
    :vartype tier: str
    """
...
class SqlManagedInstanceSku(CommonSku):
    ...
    :param tier: This field is required to be implemented by the Resource Provider if the service
     has more than one tier. Possible values include: "GeneralPurpose", "BusinessCritical". Default
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SqlManagedInstanceSku, self).__init__(name=name, dev=dev, size=size, family=family, capacity=capacity, **kwargs)
        self.tier = tier
...
class SqlServerInstanceProperties(msrest.serialization.Model):
    ...
    :type v_core: str
    :param status: Required. The cloud connectivity status.
    :type status: str
    ...
    :type product_id: str
    :param license_type: SQL Server license type.
