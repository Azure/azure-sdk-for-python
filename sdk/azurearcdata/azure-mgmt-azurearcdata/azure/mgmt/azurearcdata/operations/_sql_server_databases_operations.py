...
def build_create_request(
    resource_group_name: str, sql_server_instance_name: str, database_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class SqlServerDatabasesOperations:
    ...
    def create(
        ...
        sql_server_instance_name: str,
        database_name: str,
        sql_server_database_resource: Union[_models.SqlServerDatabaseResource, IO[bytes]],
        **kwargs: Any
    ) -> _models.SqlServerDatabaseResource:
        """Creates or replaces an Arc Sql Server Database.
        ...
        :param database_name: Name of the database. Required.
        :type database_name: str
        :param sql_server_database_resource: The request body for database resource. Is either a
         SqlServerDatabaseResource type or a IO[bytes] type. Required.
        :type sql_server_database_resource: ~azure.mgmt.azurearcdata.models.SqlServerDatabaseResource
         or IO[bytes]
        :return: SqlServerDatabaseResource or the result of cls(response)
        :rtype: ~azure.mgmt.azurearcdata.models.SqlServerDatabaseResource
        ...
        if isinstance(sql_server_database_resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(sql_server_database_resource, "SqlServerDatabaseResource")
        ...
        deserialized = self._deserialize("SqlServerDatabaseResource", pipeline_response.http_response)
    ...
    def _update_initial(
        ...
        sql_server_instance_name: str,
        database_name: str,
        sql_server_database_update: Union[_models.SqlServerDatabaseUpdate, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(sql_server_database_update, (IOBase, bytes)):
            ...
            _json = self._serialize.body(sql_server_database_update, "SqlServerDatabaseUpdate")
    ...
    def begin_update(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.SqlServerDatabaseResource]:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param database_name: Name of the database. Required.
        :type database_name: str
        :param sql_server_database_update: The requested database resource state. Is either a
         SqlServerDatabaseUpdate type or a IO[bytes] type. Required.
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.SqlServerDatabaseResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.SqlServerDatabaseResource](
    ...
    def list(
    ...
    ) -> ItemPaged["_models.SqlServerDatabaseResource"]:
        ...
        :param sql_server_instance_name: Name of SQL Server Instance. Required.
        :type sql_server_instance_name: str
        :return: An iterator like instance of either SqlServerDatabaseResource or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.azurearcdata.models.SqlServerDatabaseResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.ArcSqlServerDatabaseListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ArcSqlServerDatabaseListResult", pipeline_response)
