...
class PostgresInstancesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.PostgresInstance"]:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.PostgresInstance"]:
    ...
    def get(self, resource_group_name: str, postgres_instance_name: str, **kwargs: Any) -> _models.PostgresInstance:
        ...
        deserialized = self._deserialize("PostgresInstance", pipeline_response.http_response)
    ...
    def _create_initial(
        ...
        resource: Union[_models.PostgresInstance, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param postgres_instance_name: Name of Postgres Instance. Required.
        :type postgres_instance_name: str
        :param resource: The postgres instance. Is either a PostgresInstance type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.azurearcdata.models.PostgresInstance or IO[bytes]
        :return: An instance of LROPoller that returns either PostgresInstance or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.azurearcdata.models.PostgresInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.PostgresInstance].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.PostgresInstance](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    def _delete_initial(self, resource_group_name: str, postgres_instance_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def update(
        ...
        resource_group_name: str,
        postgres_instance_name: str,
        parameters: Union[_models.PostgresInstanceUpdate, IO[bytes]],
        **kwargs: Any
    ) -> _models.PostgresInstance:
        """Updates a postgres Instance resource.
        ...
        :param postgres_instance_name: Name of Postgres Instance. Required.
        :type postgres_instance_name: str
        :param parameters: The Postgres Instance. Is either a PostgresInstanceUpdate type or a
         IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.azurearcdata.models.PostgresInstanceUpdate or IO[bytes]
        :return: PostgresInstance or the result of cls(response)
        :rtype: ~azure.mgmt.azurearcdata.models.PostgresInstance
        :raises ~azure.core.exceptions.HttpResponseError:
        """
