...
class PostgresInstancesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either PostgresInstanceListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure_arc_data_management_client.models.PostgresInstanceListResult]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'postgresInstanceName': self._serialize.url("postgres_instance_name", postgres_instance_name, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    def _create_initial(
        ...
        **kwargs  # type: Any
        ...
        body_content = self._serialize.body(resource, 'PostgresInstance')
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :param resource_group_name: The name of the Azure resource group.
        :type resource_group_name: str
        :param postgres_instance_name: Name of PostgresInstance.
        :type postgres_instance_name: str
        ...
        :return: An instance of LROPoller that returns either PostgresInstance or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure_arc_data_management_client.models.PostgresInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/postgresInstances/{postgresInstanceName}'}  # type: ignore
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'PostgresInstanceUpdate')
        body_content_kwargs['content'] = body_content
