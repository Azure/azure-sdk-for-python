...
class DataControllersOperations:
    ...
    @distributed_trace
    def list_in_subscription(self, **kwargs: Any) -> ItemPaged["_models.DataControllerResource"]:
    ...
    @distributed_trace
    def list_in_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.DataControllerResource"]:
    ...
    def begin_put_data_controller(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.DataControllerResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.DataControllerResource](
