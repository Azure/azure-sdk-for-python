...
from .operations import PostgresInstancesOperations
...
class AzureArcDataManagementClient(object):
    ...
    :vartype postgres_instances: azure_arc_data_management_client.aio.operations.PostgresInstancesOperations
