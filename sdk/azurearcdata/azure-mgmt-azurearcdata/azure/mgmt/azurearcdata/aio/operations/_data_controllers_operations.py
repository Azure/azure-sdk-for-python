...
class DataControllersOperations:
    ...
    async def delete_data_controller(
        ...
        **kwargs: Any
        ...
        # Construct URL
        url = self.delete_data_controller.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'dataControllerName': self._serialize.url("data_controller_name", data_controller_name, 'str'),
    ...
    delete_data_controller.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/dataControllers/{dataControllerName}'}  # type: ignore
