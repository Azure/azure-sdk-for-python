...
class PostgresInstancesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure_arc_data_management_client.models.PostgresInstanceListResult]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either PostgresInstance or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure_arc_data_management_client.models.PostgresInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
