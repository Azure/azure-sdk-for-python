...
class SqlManagedInstancesOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("SqlManagedInstance", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        sql_managed_instance: Union[_models.SqlManagedInstance, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param resource_group_name: The name of the Azure resource group. Required.
        :type resource_group_name: str
        :param sql_managed_instance_name: The name of SQL Managed Instances. Required.
        :type sql_managed_instance_name: str
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param sql_managed_instance: The SQL Managed Instance to be created or updated. Is either a
         SqlManagedInstance type or a IO[bytes] type. Required.
        :type sql_managed_instance: ~azure.mgmt.azurearcdata.models.SqlManagedInstance or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either SqlManagedInstance or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurearcdata.models.SqlManagedInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param resource_group_name: The name of the Azure resource group. Required.
        :type resource_group_name: str
        :param sql_managed_instance_name: Name of sqlManagedInstance. Required.
        :type sql_managed_instance_name: str
    ...
    async def update(
        ...
        resource_group_name: str,
        sql_managed_instance_name: str,
        parameters: Union[_models.SqlManagedInstanceUpdate, IO[bytes]],
        **kwargs: Any
    ) -> _models.SqlManagedInstance:
        """Updates a SQL Managed Instance resource.
        ...
        :param sql_managed_instance_name: Name of sqlManagedInstance. Required.
        :type sql_managed_instance_name: str
        :param parameters: The SQL Managed Instance. Is either a SqlManagedInstanceUpdate type or a
         IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.azurearcdata.models.SqlManagedInstanceUpdate or IO[bytes]
        :return: SqlManagedInstance or the result of cls(response)
        :rtype: ~azure.mgmt.azurearcdata.models.SqlManagedInstance
        :raises ~azure.core.exceptions.HttpResponseError:
        """
