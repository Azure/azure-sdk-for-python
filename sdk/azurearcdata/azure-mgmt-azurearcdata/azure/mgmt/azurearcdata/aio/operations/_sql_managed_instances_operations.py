...
class SqlManagedInstancesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either SqlManagedInstanceListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure_arc_data_management_client.models.SqlManagedInstanceListResult]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'sqlManagedInstanceName': self._serialize.url("sql_managed_instance_name", sql_managed_instance_name, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    async def _create_initial(
        ...
        **kwargs: Any
        ...
        body_content = self._serialize.body(sql_managed_instance, 'SqlManagedInstance')
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param resource_group_name: The name of the Azure resource group.
        :type resource_group_name: str
        :param sql_managed_instance_name: The name of SQL Managed Instances.
        :type sql_managed_instance_name: str
        ...
        :return: An instance of AsyncLROPoller that returns either SqlManagedInstance or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure_arc_data_management_client.models.SqlManagedInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlManagedInstances/{sqlManagedInstanceName}'}  # type: ignore
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param resource_group_name: The name of the Azure resource group.
        :type resource_group_name: str
        :param sql_managed_instance_name: Name of sqlManagedInstance.
        :type sql_managed_instance_name: str
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'SqlManagedInstanceUpdate')
        body_content_kwargs['content'] = body_content
