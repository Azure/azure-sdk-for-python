...
class SqlServerInstancesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either SqlServerInstanceListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure_arc_data_management_client.models.SqlServerInstanceListResult]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'sqlServerInstanceName': self._serialize.url("sql_server_instance_name", sql_server_instance_name, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    async def _create_initial(
        ...
        **kwargs: Any
        ...
        body_content = self._serialize.body(sql_server_instance, 'SqlServerInstance')
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param resource_group_name: The name of the Azure resource group.
        :type resource_group_name: str
        :param sql_server_instance_name: The name of SQL Server Instance.
        :type sql_server_instance_name: str
        ...
        :return: An instance of AsyncLROPoller that returns either SqlServerInstance or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure_arc_data_management_client.models.SqlServerInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureArcData/sqlServerInstances/{sqlServerInstanceName}'}  # type: ignore
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param resource_group_name: The name of the Azure resource group.
        :type resource_group_name: str
        :param sql_server_instance_name: Name of sqlServerInstance.
        :type sql_server_instance_name: str
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'SqlServerInstanceUpdate')
        body_content_kwargs['content'] = body_content
