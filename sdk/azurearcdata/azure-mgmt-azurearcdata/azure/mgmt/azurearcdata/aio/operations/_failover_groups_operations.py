...
class FailoverGroupsOperations:
    ...
    async def _create_initial(
        ...
        failover_group_resource: Union[_models.FailoverGroupResource, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param failover_group_name: The name of the Failover Group. Required.
        :type failover_group_name: str
        :param failover_group_resource: desc. Is either a FailoverGroupResource type or a IO[bytes]
         type. Required.
        :type failover_group_resource: ~azure.mgmt.azurearcdata.models.FailoverGroupResource or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either FailoverGroupResource or the result
         of cls(response)
        :rtype:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("FailoverGroupResource", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
