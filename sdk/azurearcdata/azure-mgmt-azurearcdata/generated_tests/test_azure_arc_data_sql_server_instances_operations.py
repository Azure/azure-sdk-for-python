...
class TestAzureArcDataSqlServerInstancesOperations(AzureMgmtRecordedTestCase):
                    ...
                    "migration": {
                        "assessment": {
                            ...
                            "impactedObjectsSummary": {
                                "azureSqlDatabase": [{"featureId": "str", "issueCategory": "str", "numberImpacted": 0}],
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_sql_server_instances_begin_get_best_practices_assessment(self, resource_group):
        response = self.client.sql_server_instances.begin_get_best_practices_assessment(
            resource_group_name=resource_group.name,
            sql_server_instance_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_sql_server_instances_begin_run_target_recommendation_job(self, resource_group):
        response = self.client.sql_server_instances.begin_run_target_recommendation_job(
            resource_group_name=resource_group.name,
            sql_server_instance_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_sql_server_instances_begin_get_target_recommendation_reports(self, resource_group):
        response = self.client.sql_server_instances.begin_get_target_recommendation_reports(
            resource_group_name=resource_group.name,
            sql_server_instance_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_sql_server_instances_begin_get_migration_readiness_report(self, resource_group):
        response = self.client.sql_server_instances.begin_get_migration_readiness_report(
            resource_group_name=resource_group.name,
            sql_server_instance_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_sql_server_instances_run_best_practices_assessment(self, resource_group):
        response = self.client.sql_server_instances.run_best_practices_assessment(
            resource_group_name=resource_group.name,
            sql_server_instance_name="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_sql_server_instances_begin_run_best_practice_assessment(self, resource_group):
        response = self.client.sql_server_instances.begin_run_best_practice_assessment(
            resource_group_name=resource_group.name,
            sql_server_instance_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_sql_server_instances_begin_run_migration_readiness_assessment(self, resource_group):
        response = self.client.sql_server_instances.begin_run_migration_readiness_assessment(
            resource_group_name=resource_group.name,
            sql_server_instance_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_sql_server_instances_begin_get_jobs(self, resource_group):
        response = self.client.sql_server_instances.begin_get_jobs(
            resource_group_name=resource_group.name,
            sql_server_instance_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_sql_server_instances_get_all_availability_groups(self, resource_group):
