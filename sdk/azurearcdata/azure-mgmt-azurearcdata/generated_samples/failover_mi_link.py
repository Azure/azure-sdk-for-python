...
def main():
    ...
    response = client.sql_server_availability_groups.begin_failover_mi_link(
        resource_group_name="testrg",
        sql_server_instance_name="testSqlServer_INST1",
        availability_group_name="testDAG",
...
# x-ms-original-file: specification/azurearcdata/resource-manager/Microsoft.AzureArcData/preview/2026-03-01-preview/examples/failoverMiLink.json
