...
# USAGE
    python update_sql_server_esu_license.py
...
def main():
    ...
    response = client.sql_server_esu_licenses.update(
...
# x-ms-original-file: specification/azurearcdata/resource-manager/Microsoft.AzureArcData/preview/2026-03-01-preview/examples/UpdateSqlServerEsuLicense.json
