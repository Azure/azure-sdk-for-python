...
def main():
    ...
    response = client.sql_server_databases.begin_update(
...
# x-ms-original-file: specification/azurearcdata/resource-manager/Microsoft.AzureArcData/preview/2026-03-01-preview/examples/UpdateSqlServerDatabase.json
