...
class LoadTestMgmtClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype operations: azure.mgmt.loadtestservice.aio.operations.Operations
    :ivar quotas: QuotasOperations operations
    :vartype quotas: azure.mgmt.loadtestservice.aio.operations.QuotasOperations
    :ivar load_tests: LoadTestsOperations operations
    :vartype load_tests: azure.mgmt.loadtestservice.aio.operations.LoadTestsOperations
