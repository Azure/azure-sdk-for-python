...
from .operations import LoadTestsOperations, Operations
...
class LoadTestClient:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = LoadTestClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
