...
class LoadTestClientConfiguration(
    Configuration
    ...
    def __init__(
        ...
        self.credential_scopes = kwargs.pop(
            "credential_scopes", ["https://loadtest.azure-dev.com/.default"]
        )
        kwargs.setdefault("sdk_moniker", "developer-loadtestservice/{}".format(VERSION))
