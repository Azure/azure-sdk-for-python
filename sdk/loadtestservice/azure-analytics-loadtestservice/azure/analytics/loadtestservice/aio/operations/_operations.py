...
class AppComponentOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.analytics.loadtestservice.aio.LoadTestClient`'s
...
class ServerMetricsOperations:
    ...
    @distributed_trace_async
    async def get_server_metrics_by_name(
        self,
        name: str,
        **kwargs: Any
    ) -> JSON:
    ...
    @distributed_trace_async
    async def get_server_default_metrics(
        self,
        **kwargs: Any
    ) -> JSON:
    ...
    @distributed_trace_async
    async def list_supported_resource_type(
        self,
        **kwargs: Any
    ) -> JSON:
