...
def build_app_component_delete_app_component_request(
    name: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_server_metrics_get_server_metrics_by_name_request(
    name: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_server_metrics_delete_server_metrics_request(
    name: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_server_metrics_get_server_metrics_request(
    *,
    test_run_id: Optional[str] = None,
    test_id: Optional[str] = None,
    **kwargs: Any
...
def build_server_metrics_get_server_default_metrics_request(
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_server_metrics_list_supported_resource_type_request(
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_test_upload_test_file_request(
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "You need to write a custom operation for 'build_test_upload_test_file_request'. "
...
def build_test_get_all_test_files_request(
    test_id: str,
    *,
    continuation_token_parameter: Optional[str] = None,
    **kwargs: Any
...
def build_test_run_create_and_update_test_request(
    test_run_id: str,
    *,
    json: Optional[JSON] = None,
    content: Any = None,
...
def build_test_run_list_test_runs_search_request(
    *,
    order_by: Optional[str] = None,
    continuation_token_parameter: Optional[str] = None,
    search: Optional[str] = None,
...
class AppComponentOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.analytics.loadtestservice.LoadTestClient`'s
    ...
    @distributed_trace
    def delete_app_component(  # pylint: disable=inconsistent-return-statements
        self,
        name: str,
        **kwargs: Any
    ) -> None:
...
class ServerMetricsOperations:
    ...
    @distributed_trace
    def get_server_metrics_by_name(
        self,
        name: str,
        **kwargs: Any
    ) -> JSON:
    ...
    @distributed_trace
    def delete_server_metrics(  # pylint: disable=inconsistent-return-statements
        self,
        name: str,
        **kwargs: Any
    ) -> None:
    ...
    @distributed_trace
    def get_server_default_metrics(
        self,
        **kwargs: Any
    ) -> JSON:
    ...
    @distributed_trace
    def list_supported_resource_type(
        self,
        **kwargs: Any
    ) -> JSON:
                                ...
                                "passFailMetrics": {
                                    "str": {
                                        ...
                                        "aggregate": "str",  # Optional. The
                                          ...
                                          , "u2018avg"u2019 - for response_time_ms and latency metric.
                                        "clientmetric": "str",  # Optional.
                                          The client metric on which the criteria should be applied.
                                          Allowed values - "u2018response_time_ms"u2019 ,
                                          "u2018latency"u2019, "u2018error"u2019.
