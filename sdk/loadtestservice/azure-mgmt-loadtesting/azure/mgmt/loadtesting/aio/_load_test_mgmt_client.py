...
class LoadTestMgmtClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype operations: azure.mgmt.loadtesting.aio.operations.Operations
    :ivar quotas: QuotasOperations operations
    :vartype quotas: azure.mgmt.loadtesting.aio.operations.QuotasOperations
    :ivar load_tests: LoadTestsOperations operations
    :vartype load_tests: azure.mgmt.loadtesting.aio.operations.LoadTestsOperations
    ...
    async def __aenter__(self) -> "LoadTestMgmtClient":
