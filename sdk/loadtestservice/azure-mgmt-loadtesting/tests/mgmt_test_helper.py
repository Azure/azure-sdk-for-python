...
def create_key_vault(kv_client : KeyVaultManagementClient, akv_name, rg_name, location, msi, tenant_id, object_id):
    ...
    while resource_poller.done()==False:
        resource_poller.wait(2)
