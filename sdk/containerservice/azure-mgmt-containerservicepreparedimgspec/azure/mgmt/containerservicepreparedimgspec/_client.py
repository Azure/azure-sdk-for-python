...
class ContainerServicePreparedImgSpecMgmtClient:  # pylint: disable=name-too-long
    ...
    :vartype operations: azure.mgmt.containerservicepreparedimgspec.operations.Operations
    :ivar prepared_image_specifications: PreparedImageSpecificationsOperations operations
    :vartype prepared_image_specifications:
     azure.mgmt.containerservicepreparedimgspec.operations.PreparedImageSpecificationsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.prepared_image_specifications = PreparedImageSpecificationsOperations(
