...
# USAGE
    python fleet_managed_namespaces_list_by_fleet.py
...
def main():
    ...
    response = client.fleet_managed_namespaces.list_by_fleet(
...
# x-ms-original-file: 2026-03-02-preview/FleetManagedNamespaces_ListByFleet.json
