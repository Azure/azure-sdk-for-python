...
def build_fleet_managed_namespaces_get_request(  # pylint: disable=name-too-long
...
def build_fleet_managed_namespaces_create_or_update_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    fleet_name: str,
...
def build_fleet_managed_namespaces_delete_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    fleet_name: str,
    managed_namespace_name: str,
    subscription_id: str,
...
def build_fleet_managed_namespaces_list_by_fleet_request(  # pylint: disable=name-too-long
    resource_group_name: str, fleet_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/fleets/{fleetName}/managedNamespaces"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "fleetName": _SERIALIZER.url("fleet_name", fleet_name, "str"),
...
def build_fleet_managed_namespaces_update_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    fleet_name: str,
    managed_namespace_name: str,
    subscription_id: str,
...
class FleetManagedNamespacesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :keyword match_condition: The match condition to use upon the etag. Default value is None.
        :paramtype match_condition: ~azure.core.MatchConditions
        :return: An instance of LROPoller that returns FleetManagedNamespace. The FleetManagedNamespace
