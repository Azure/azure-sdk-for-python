...
class ContainerServiceFleetMgmtClient(MultiApiClientMixin, _SDKClient):
    ...
    def auto_upgrade_profiles(self):
        """Instance depends on the API version:
           ...
           * 2024-05-02-preview: :class:`AutoUpgradeProfilesOperations<azure.mgmt.containerservicefleet.v2024_05_02_preview.aio.operations.AutoUpgradeProfilesOperations>`
        """
        api_version = self._get_api_version('auto_upgrade_profiles')
        if api_version == '2024-05-02-preview':
            from ..v2024_05_02_preview.aio.operations import AutoUpgradeProfilesOperations as OperationClass
        else:
    ...
    def fleet_members(self):
        """Instance depends on the API version:
           ...
           * 2024-05-02-preview: :class:`FleetMembersOperations<azure.mgmt.containerservicefleet.v2024_05_02_preview.aio.operations.FleetMembersOperations>`
        """
        ...
        if api_version == '2022-09-02-preview':
            ...
            from ..v2024_05_02_preview.aio.operations import FleetMembersOperations as OperationClass
        else:
    ...
    def fleet_update_strategies(self):
        """Instance depends on the API version:
           ...
           * 2024-05-02-preview: :class:`FleetUpdateStrategiesOperations<azure.mgmt.containerservicefleet.v2024_05_02_preview.aio.operations.FleetUpdateStrategiesOperations>`
        """
        ...
        if api_version == '2023-08-15-preview':
            ...
            from ..v2024_05_02_preview.aio.operations import FleetUpdateStrategiesOperations as OperationClass
        else:
    ...
    def fleets(self):
        """Instance depends on the API version:
           ...
           * 2024-05-02-preview: :class:`FleetsOperations<azure.mgmt.containerservicefleet.v2024_05_02_preview.aio.operations.FleetsOperations>`
        """
        ...
        if api_version == '2022-09-02-preview':
            ...
            from ..v2024_05_02_preview.aio.operations import FleetsOperations as OperationClass
        else:
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2024-05-02-preview: :class:`Operations<azure.mgmt.containerservicefleet.v2024_05_02_preview.aio.operations.Operations>`
        """
    ...
    def update_runs(self):
        """Instance depends on the API version:
           ...
           * 2024-05-02-preview: :class:`UpdateRunsOperations<azure.mgmt.containerservicefleet.v2024_05_02_preview.aio.operations.UpdateRunsOperations>`
        """
        ...
        if api_version == '2023-03-15-preview':
            ...
            from ..v2024_05_02_preview.aio.operations import UpdateRunsOperations as OperationClass
        else:
