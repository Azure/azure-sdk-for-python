...
class FleetMembersOperations:
    ...
    def list_by_fleet(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetMember]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetMember
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetMember
        ...
        :return: An instance of AsyncLROPoller that returns either FleetMember or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetMember]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a FleetMember type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetMember or IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :param if_none_match: The request should only proceed if no entity matches this string. Default
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetMemberUpdate
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetMemberUpdate or
         IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
