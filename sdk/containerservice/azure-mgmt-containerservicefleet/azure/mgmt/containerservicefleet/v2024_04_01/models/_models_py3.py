...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.containerservicefleet.v2024_04_01.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.containerservicefleet.v2024_04_01.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.containerservicefleet.v2024_04_01.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class Resource(_serialization.Model):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.containerservicefleet.v2024_04_01.models.SystemData
    """
...
class Fleet(TrackedResource):
    ...
    :vartype identity: ~azure.mgmt.containerservicefleet.v2024_04_01.models.ManagedServiceIdentity
    :ivar provisioning_state: The status of the last operation. Known values are: "Succeeded",
     "Failed", "Canceled", "Creating", "Updating", and "Deleting".
    :vartype provisioning_state: str or
     ~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetProvisioningState
    :ivar hub_profile: The FleetHubProfile configures the Fleet's hub.
    :vartype hub_profile: ~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetHubProfile
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype identity:
         ~azure.mgmt.containerservicefleet.v2024_04_01.models.ManagedServiceIdentity
        :keyword hub_profile: The FleetHubProfile configures the Fleet's hub.
        :paramtype hub_profile: ~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetHubProfile
        """
...
class FleetCredentialResults(_serialization.Model):
    ...
    :vartype kubeconfigs:
     list[~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetCredentialResult]
    """
...
class FleetHubProfile(_serialization.Model):
    ...
    :vartype agent_profile: ~azure.mgmt.containerservicefleet.v2024_04_01.models.AgentProfile
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype agent_profile: ~azure.mgmt.containerservicefleet.v2024_04_01.models.AgentProfile
        """
        super().__init__(**kwargs)
...
class FleetListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.Fleet]
    ...
    def __init__(self, *, value: List["_models.Fleet"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.Fleet]
...
class FleetMember(ProxyResource):
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetMemberProvisioningState
    """
...
class FleetMemberListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetMember]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.FleetMember"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetMember]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class FleetUpdateStrategy(ProxyResource):
    ...
    :vartype strategy: ~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateRunStrategy
    """
    ...
    def __init__(self, *, strategy: Optional["_models.UpdateRunStrategy"] = None, **kwargs: Any) -> None:
        ...
        :paramtype strategy: ~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateRunStrategy
        """
        super().__init__(**kwargs)
        self.e_tag = None
        self.provisioning_state = None
...
class FleetUpdateStrategyListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetUpdateStrategy]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value:
         list[~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetUpdateStrategy]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ManagedClusterUpdate(_serialization.Model):
    ...
    :vartype upgrade:
     ~azure.mgmt.containerservicefleet.v2024_04_01.models.ManagedClusterUpgradeSpec
    :ivar node_image_selection: The node image upgrade to be applied to the target nodes in update
     run.
    :vartype node_image_selection:
     ~azure.mgmt.containerservicefleet.v2024_04_01.models.NodeImageSelection
    """
...
class ManagedClusterUpgradeSpec(_serialization.Model):
    ...
    :vartype type: str or
     ~azure.mgmt.containerservicefleet.v2024_04_01.models.ManagedClusterUpgradeType
...
class ManagedServiceIdentity(_serialization.Model):
    ...
    :vartype type: str or
     ~azure.mgmt.containerservicefleet.v2024_04_01.models.ManagedServiceIdentityType
    :ivar user_assigned_identities: The set of user assigned identities associated with the
     resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form:
     '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}.  # pylint: disable=line-too-long
     The dictionary values can be empty objects ({}) in requests.
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.containerservicefleet.v2024_04_01.models.UserAssignedIdentity]
    """
...
class MemberUpdateStatus(_serialization.Model):
    ...
    :vartype status: ~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateStatus
...
class NodeImageSelection(_serialization.Model):
    ...
    :vartype type: str or
     ~azure.mgmt.containerservicefleet.v2024_04_01.models.NodeImageSelectionType
    """
...
class NodeImageSelectionStatus(_serialization.Model):
    ...
    :vartype selected_node_image_versions:
     list[~azure.mgmt.containerservicefleet.v2024_04_01.models.NodeImageVersion]
    """
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.containerservicefleet.v2024_04_01.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.containerservicefleet.v2024_04_01.models.Origin
    :ivar action_type: Enum. Indicates the action type. "Internal" refers to actions that are for
     internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.containerservicefleet.v2024_04_01.models.ActionType
    """
    ...
    def __init__(self, *, display: Optional["_models.OperationDisplay"] = None, **kwargs: Any) -> None:
        ...
        :paramtype display: ~azure.mgmt.containerservicefleet.v2024_04_01.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name = None
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.Operation]
...
class SkipProperties(_serialization.Model):
    ...
    :vartype targets: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.SkipTarget]
    """
    ...
    def __init__(self, *, targets: List["_models.SkipTarget"], **kwargs: Any) -> None:
        ...
        :paramtype targets: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.SkipTarget]
        """
        super().__init__(**kwargs)
...
class SkipTarget(_serialization.Model):
    ...
    :ivar type: The skip target type. Required. Known values are: "Member", "Group", "Stage", and
     "AfterStageWait".
    :vartype type: str or ~azure.mgmt.containerservicefleet.v2024_04_01.models.TargetType
    ...
    def __init__(self, *, type: Union[str, "_models.TargetType"], name: str, **kwargs: Any) -> None:
        ...
        :keyword type: The skip target type. Required. Known values are: "Member", "Group", "Stage",
         and "AfterStageWait".
        :paramtype type: str or ~azure.mgmt.containerservicefleet.v2024_04_01.models.TargetType
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or
     ~azure.mgmt.containerservicefleet.v2024_04_01.models.CreatedByType
...
class UpdateGroupStatus(_serialization.Model):
    ...
    :vartype members: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.MemberUpdateStatus]
    """
...
class UpdateRun(ProxyResource):
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateRunProvisioningState
    ...
    :vartype managed_cluster_update:
     ~azure.mgmt.containerservicefleet.v2024_04_01.models.ManagedClusterUpdate
    :ivar status: The status of the UpdateRun.
    :vartype status: ~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateRunStatus
    """
...
class UpdateRunListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateRun]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.UpdateRun"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateRun]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class UpdateRunStatus(_serialization.Model):
    ...
    :ivar stages: The stages composing an update run. Stages are run sequentially withing an
     UpdateRun.
    :vartype stages: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateStageStatus]
    ...
    :vartype node_image_selection:
     ~azure.mgmt.containerservicefleet.v2024_04_01.models.NodeImageSelectionStatus
    """
...
class UpdateRunStrategy(_serialization.Model):
    ...
    :vartype stages: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateStage]
    """
    ...
    def __init__(self, *, stages: List["_models.UpdateStage"], **kwargs: Any) -> None:
        ...
        :paramtype stages: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateStage]
        """
        super().__init__(**kwargs)
        self.stages = stages
...
class UpdateStage(_serialization.Model):
    ...
    :vartype groups: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateGroup]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype groups: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateGroup]
...
class UpdateStageStatus(_serialization.Model):
    ...
    :vartype groups: list[~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateGroupStatus]
    :ivar after_stage_wait_status: The status of the wait period configured on the UpdateStage.
    :vartype after_stage_wait_status:
     ~azure.mgmt.containerservicefleet.v2024_04_01.models.WaitStatus
    """
...
class UpdateStatus(_serialization.Model):
    ...
    :vartype state: str or ~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateState
