...
class FleetMembersOperations:
    ...
    def list_by_fleet(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetMember]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either FleetMember or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservicefleet.v2024_04_01.models.FleetMember]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
