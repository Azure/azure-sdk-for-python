...
class UpdateRunsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerservicefleet.v2024_04_01.ContainerServiceFleetMgmtClient`'s
    ...
    def list_by_fleet(self, resource_group_name: str, fleet_name: str, **kwargs: Any) -> Iterable["_models.UpdateRun"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateRun]
    ...
    def get(self, resource_group_name: str, fleet_name: str, update_run_name: str, **kwargs: Any) -> _models.UpdateRun:
        ...
        :rtype: ~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateRun
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateRun
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateRun]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a UpdateRun type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.containerservicefleet.v2024_04_01.models.UpdateRun or IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :param if_none_match: The request should only proceed if no entity matches this string. Default
    ...
    def begin_skip(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.containerservicefleet.v2024_04_01.models.SkipProperties
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
    ...
    def begin_skip(
        ...
        **kwargs: Any
        ...
        :param body: The content of the action request. Is either a SkipProperties type or a IO[bytes]
         type. Required.
        :type body: ~azure.mgmt.containerservicefleet.v2024_04_01.models.SkipProperties or IO[bytes]
        :param if_match: The request should only proceed if an entity matches this string. Default
         value is None.
        :type if_match: str
        :return: An instance of LROPoller that returns either UpdateRun or the result of cls(response)
