...
class TestContainerServiceTrustedAccessRoleBindingsOperationsAsync(AzureMgmtRecordedTestCase):
        ...
        response = await (
            await self.client.trusted_access_role_bindings.begin_create_or_update(
                ...
                trusted_access_role_binding={
                    "properties": {"roles": ["str"], "sourceResourceId": "str", "provisioningState": "str"},
                    "id": "str",
                    "name": "str",
                    "systemData": {
