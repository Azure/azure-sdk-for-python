...
class TestContainerServiceFleetsOperations(AzureMgmtRecordedTestCase):
    ...
    def test_begin_create_or_update(self, resource_group):
        response = self.client.fleets.begin_create_or_update(
            ...
            parameters={
                "location": "str",
                "etag": "str",
                "hubProfile": {"dnsPrefix": "str", "fqdn": "str", "kubernetesVersion": "str"},
                "id": "str",
                "name": "str",
    ...
    def test_update(self, resource_group):
        response = self.client.fleets.update(
            resource_group_name=resource_group.name,
            fleet_name="str",
            api_version="2022-06-02-preview",
        )
    ...
    def test_list(self, resource_group):
        response = self.client.fleets.list(
            api_version="2022-06-02-preview",
        )
        result = [r for r in response]
        # please add some check logic here by yourself
