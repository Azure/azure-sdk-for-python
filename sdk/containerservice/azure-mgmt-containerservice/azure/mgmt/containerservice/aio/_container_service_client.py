...
class ContainerServiceClient(MultiApiClientMixin, _SDKClient):
    ...
    def agent_pools(self):
        """Instance depends on the API version:
           ...
           * 2024-10-01: :class:`AgentPoolsOperations<azure.mgmt.containerservice.v2024_10_01.aio.operations.AgentPoolsOperations>`
        """
        ...
        if api_version == '2020-03-01':
            ...
            from ..v2024_10_01.aio.operations import AgentPoolsOperations as OperationClass
        else:
    ...
    def machines(self):
        """Instance depends on the API version:
           ...
           * 2024-10-01: :class:`MachinesOperations<azure.mgmt.containerservice.v2024_10_01.aio.operations.MachinesOperations>`
        """
        ...
        if api_version == '2024-09-01':
            ...
            from ..v2024_10_01.aio.operations import MachinesOperations as OperationClass
        else:
    ...
    def maintenance_configurations(self):
        """Instance depends on the API version:
           ...
           * 2024-10-01: :class:`MaintenanceConfigurationsOperations<azure.mgmt.containerservice.v2024_10_01.aio.operations.MaintenanceConfigurationsOperations>`
        """
        ...
        if api_version == '2024-09-01':
            ...
            from ..v2024_10_01.aio.operations import MaintenanceConfigurationsOperations as OperationClass
        else:
    ...
    def managed_clusters(self):
        """Instance depends on the API version:
           ...
           * 2024-10-01: :class:`ManagedClustersOperations<azure.mgmt.containerservice.v2024_10_01.aio.operations.ManagedClustersOperations>`
        """
        ...
        if api_version == '2020-03-01':
            ...
            from ..v2024_10_01.aio.operations import ManagedClustersOperations as OperationClass
        else:
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2024-10-01: :class:`Operations<azure.mgmt.containerservice.v2024_10_01.aio.operations.Operations>`
        """
        ...
        if api_version == '2020-03-01':
            ...
            from ..v2024_10_01.aio.operations import Operations as OperationClass
        else:
    ...
    def private_endpoint_connections(self):
        """Instance depends on the API version:
           ...
           * 2024-10-01: :class:`PrivateEndpointConnectionsOperations<azure.mgmt.containerservice.v2024_10_01.aio.operations.PrivateEndpointConnectionsOperations>`
        """
        ...
        if api_version == '2020-11-01':
            ...
            from ..v2024_10_01.aio.operations import PrivateEndpointConnectionsOperations as OperationClass
        else:
    ...
    def private_link_resources(self):
        """Instance depends on the API version:
           ...
           * 2024-10-01: :class:`PrivateLinkResourcesOperations<azure.mgmt.containerservice.v2024_10_01.aio.operations.PrivateLinkResourcesOperations>`
        """
        ...
        if api_version == '2020-11-01':
            ...
            from ..v2024_10_01.aio.operations import PrivateLinkResourcesOperations as OperationClass
        else:
    ...
    def resolve_private_link_service_id(self):
        """Instance depends on the API version:
           ...
           * 2024-10-01: :class:`ResolvePrivateLinkServiceIdOperations<azure.mgmt.containerservice.v2024_10_01.aio.operations.ResolvePrivateLinkServiceIdOperations>`
        """
        ...
        if api_version == '2020-11-01':
            ...
            from ..v2024_10_01.aio.operations import ResolvePrivateLinkServiceIdOperations as OperationClass
        else:
    ...
    def snapshots(self):
        """Instance depends on the API version:
           ...
           * 2024-10-01: :class:`SnapshotsOperations<azure.mgmt.containerservice.v2024_10_01.aio.operations.SnapshotsOperations>`
        """
        api_version = self._get_api_version('snapshots')
        if api_version == '2024-09-01':
            from ..v2024_09_01.aio.operations import SnapshotsOperations as OperationClass
        elif api_version == '2024-10-01':
            from ..v2024_10_01.aio.operations import SnapshotsOperations as OperationClass
        else:
    ...
    def trusted_access_role_bindings(self):
        """Instance depends on the API version:
           ...
           * 2024-10-01: :class:`TrustedAccessRoleBindingsOperations<azure.mgmt.containerservice.v2024_10_01.aio.operations.TrustedAccessRoleBindingsOperations>`
        """
        ...
        if api_version == '2024-09-01':
            ...
            from ..v2024_10_01.aio.operations import TrustedAccessRoleBindingsOperations as OperationClass
        else:
    ...
    def trusted_access_roles(self):
        """Instance depends on the API version:
           ...
           * 2024-10-01: :class:`TrustedAccessRolesOperations<azure.mgmt.containerservice.v2024_10_01.aio.operations.TrustedAccessRolesOperations>`
        """
        ...
        if api_version == '2024-09-01':
            ...
            from ..v2024_10_01.aio.operations import TrustedAccessRolesOperations as OperationClass
        else:
