...
class ContainerServiceClient(MultiApiClientMixin, _SDKClient):
    ...
    def agent_pools(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`AgentPoolsOperations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.AgentPoolsOperations>`
           * 2025-03-01: :class:`AgentPoolsOperations<azure.mgmt.containerservice.v2025_03_01.aio.operations.AgentPoolsOperations>`
        """
        ...
        if api_version == '2020-03-01':
            ...
            from ..v2025_02_02_preview.aio.operations import AgentPoolsOperations as OperationClass
        elif api_version == '2025-03-01':
            from ..v2025_03_01.aio.operations import AgentPoolsOperations as OperationClass
        else:
    ...
    def container_service(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`ContainerServiceOperations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.ContainerServiceOperations>`
        """
        api_version = self._get_api_version('container_service')
        if api_version == '2025-02-02-preview':
            from ..v2025_02_02_preview.aio.operations import ContainerServiceOperations as OperationClass
        else:
    ...
    def load_balancers(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`LoadBalancersOperations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.LoadBalancersOperations>`
        """
        api_version = self._get_api_version('load_balancers')
        if api_version == '2025-02-02-preview':
            from ..v2025_02_02_preview.aio.operations import LoadBalancersOperations as OperationClass
        else:
    ...
    def machines(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`MachinesOperations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.MachinesOperations>`
           * 2025-03-01: :class:`MachinesOperations<azure.mgmt.containerservice.v2025_03_01.aio.operations.MachinesOperations>`
        """
        api_version = self._get_api_version('machines')
        if api_version == '2025-02-02-preview':
            from ..v2025_02_02_preview.aio.operations import MachinesOperations as OperationClass
        elif api_version == '2025-03-01':
            from ..v2025_03_01.aio.operations import MachinesOperations as OperationClass
        else:
    ...
    def maintenance_configurations(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`MaintenanceConfigurationsOperations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.MaintenanceConfigurationsOperations>`
           * 2025-03-01: :class:`MaintenanceConfigurationsOperations<azure.mgmt.containerservice.v2025_03_01.aio.operations.MaintenanceConfigurationsOperations>`
        """
        api_version = self._get_api_version('maintenance_configurations')
        if api_version == '2025-02-02-preview':
            from ..v2025_02_02_preview.aio.operations import MaintenanceConfigurationsOperations as OperationClass
        elif api_version == '2025-03-01':
            from ..v2025_03_01.aio.operations import MaintenanceConfigurationsOperations as OperationClass
        else:
    ...
    def managed_cluster_snapshots(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`ManagedClusterSnapshotsOperations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.ManagedClusterSnapshotsOperations>`
        """
        api_version = self._get_api_version('managed_cluster_snapshots')
        if api_version == '2025-02-02-preview':
            from ..v2025_02_02_preview.aio.operations import ManagedClusterSnapshotsOperations as OperationClass
        else:
    ...
    def managed_clusters(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`ManagedClustersOperations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.ManagedClustersOperations>`
           * 2025-03-01: :class:`ManagedClustersOperations<azure.mgmt.containerservice.v2025_03_01.aio.operations.ManagedClustersOperations>`
        """
        ...
        if api_version == '2020-03-01':
            ...
            from ..v2025_02_02_preview.aio.operations import ManagedClustersOperations as OperationClass
        elif api_version == '2025-03-01':
            from ..v2025_03_01.aio.operations import ManagedClustersOperations as OperationClass
        else:
    ...
    def namespaces(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`NamespacesOperations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.NamespacesOperations>`
        """
        api_version = self._get_api_version('namespaces')
        if api_version == '2025-02-02-preview':
            from ..v2025_02_02_preview.aio.operations import NamespacesOperations as OperationClass
        else:
    ...
    def operation_status_result(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`OperationStatusResultOperations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.OperationStatusResultOperations>`
        """
        api_version = self._get_api_version('operation_status_result')
        if api_version == '2025-02-02-preview':
            from ..v2025_02_02_preview.aio.operations import OperationStatusResultOperations as OperationClass
        else:
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`Operations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.Operations>`
           * 2025-03-01: :class:`Operations<azure.mgmt.containerservice.v2025_03_01.aio.operations.Operations>`
        """
        ...
        if api_version == '2020-03-01':
            ...
            from ..v2025_02_02_preview.aio.operations import Operations as OperationClass
        elif api_version == '2025-03-01':
    ...
    def private_endpoint_connections(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`PrivateEndpointConnectionsOperations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.PrivateEndpointConnectionsOperations>`
           * 2025-03-01: :class:`PrivateEndpointConnectionsOperations<azure.mgmt.containerservice.v2025_03_01.aio.operations.PrivateEndpointConnectionsOperations>`
        """
        ...
        if api_version == '2020-11-01':
            ...
            from ..v2025_02_02_preview.aio.operations import PrivateEndpointConnectionsOperations as OperationClass
        elif api_version == '2025-03-01':
            from ..v2025_03_01.aio.operations import PrivateEndpointConnectionsOperations as OperationClass
        else:
    ...
    def private_link_resources(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`PrivateLinkResourcesOperations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.PrivateLinkResourcesOperations>`
           * 2025-03-01: :class:`PrivateLinkResourcesOperations<azure.mgmt.containerservice.v2025_03_01.aio.operations.PrivateLinkResourcesOperations>`
        """
        api_version = self._get_api_version('private_link_resources')
        if api_version == '2020-11-01':
            from ..v2020_11_01.aio.operations import PrivateLinkResourcesOperations as OperationClass
        elif api_version == '2025-02-02-preview':
            from ..v2025_02_02_preview.aio.operations import PrivateLinkResourcesOperations as OperationClass
        elif api_version == '2025-03-01':
            from ..v2025_03_01.aio.operations import PrivateLinkResourcesOperations as OperationClass
        else:
    ...
    def resolve_private_link_service_id(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`ResolvePrivateLinkServiceIdOperations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.ResolvePrivateLinkServiceIdOperations>`
           * 2025-03-01: :class:`ResolvePrivateLinkServiceIdOperations<azure.mgmt.containerservice.v2025_03_01.aio.operations.ResolvePrivateLinkServiceIdOperations>`
        """
        ...
        if api_version == '2020-11-01':
            ...
            from ..v2025_02_02_preview.aio.operations import ResolvePrivateLinkServiceIdOperations as OperationClass
        elif api_version == '2025-03-01':
            from ..v2025_03_01.aio.operations import ResolvePrivateLinkServiceIdOperations as OperationClass
        else:
    ...
    def snapshots(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`SnapshotsOperations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.SnapshotsOperations>`
           * 2025-03-01: :class:`SnapshotsOperations<azure.mgmt.containerservice.v2025_03_01.aio.operations.SnapshotsOperations>`
        """
        api_version = self._get_api_version('snapshots')
        if api_version == '2025-02-02-preview':
            from ..v2025_02_02_preview.aio.operations import SnapshotsOperations as OperationClass
        elif api_version == '2025-03-01':
            from ..v2025_03_01.aio.operations import SnapshotsOperations as OperationClass
        else:
    ...
    def trusted_access_role_bindings(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`TrustedAccessRoleBindingsOperations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.TrustedAccessRoleBindingsOperations>`
           * 2025-03-01: :class:`TrustedAccessRoleBindingsOperations<azure.mgmt.containerservice.v2025_03_01.aio.operations.TrustedAccessRoleBindingsOperations>`
        """
        api_version = self._get_api_version('trusted_access_role_bindings')
        if api_version == '2025-02-02-preview':
            from ..v2025_02_02_preview.aio.operations import TrustedAccessRoleBindingsOperations as OperationClass
        elif api_version == '2025-03-01':
            from ..v2025_03_01.aio.operations import TrustedAccessRoleBindingsOperations as OperationClass
        else:
    ...
    def trusted_access_roles(self):
        """Instance depends on the API version:
           ...
           * 2025-02-02-preview: :class:`TrustedAccessRolesOperations<azure.mgmt.containerservice.v2025_02_02_preview.aio.operations.TrustedAccessRolesOperations>`
           * 2025-03-01: :class:`TrustedAccessRolesOperations<azure.mgmt.containerservice.v2025_03_01.aio.operations.TrustedAccessRolesOperations>`
        """
        api_version = self._get_api_version('trusted_access_roles')
        if api_version == '2025-02-02-preview':
            from ..v2025_02_02_preview.aio.operations import TrustedAccessRolesOperations as OperationClass
        elif api_version == '2025-03-01':
            from ..v2025_03_01.aio.operations import TrustedAccessRolesOperations as OperationClass
        else:
