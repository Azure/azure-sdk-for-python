...
class MaintenanceConfigurationsOperations:
    ...
    def list_by_managed_cluster(
        ...
        :return: An iterator like instance of either MaintenanceConfiguration or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2021_02_01.models.MaintenanceConfiguration]
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type config_name: str
        :param parameters: Parameters supplied to the Create or Update a default maintenance
         configuration. Is either a MaintenanceConfiguration type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.containerservice.v2021_02_01.models.MaintenanceConfiguration or
         IO[bytes]
        :return: MaintenanceConfiguration or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2021_02_01.models.MaintenanceConfiguration
        :raises ~azure.core.exceptions.HttpResponseError:
