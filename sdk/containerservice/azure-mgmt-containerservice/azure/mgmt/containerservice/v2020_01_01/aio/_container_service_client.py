...
class ContainerServiceClient:
    ...
    :vartype managed_clusters:
     azure.mgmt.containerservice.v2020_01_01.aio.operations.ManagedClustersOperations
    :ivar agent_pools: AgentPoolsOperations operations
    :vartype agent_pools:
     azure.mgmt.containerservice.v2020_01_01.aio.operations.AgentPoolsOperations
