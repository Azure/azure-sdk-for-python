...
class ContainerServiceClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    :keyword api_version: Api Version. Default value is "2023-02-02-preview". Note that overriding
    ...
    def __init__(self, credential: "AsyncTokenCredential", subscription_id: str, **kwargs: Any) -> None:
        ...
        api_version: Literal["2023-02-02-preview"] = kwargs.pop("api_version", "2023-02-02-preview")
