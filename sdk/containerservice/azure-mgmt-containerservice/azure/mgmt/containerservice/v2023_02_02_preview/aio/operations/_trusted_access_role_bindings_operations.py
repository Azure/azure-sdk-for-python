...
class TrustedAccessRoleBindingsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either TrustedAccessRoleBinding or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2023_02_02_preview.models.TrustedAccessRoleBinding]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_02_02_preview.models.TrustedAccessRoleBinding
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type trusted_access_role_binding:
         ~azure.mgmt.containerservice.v2023_02_02_preview.models.TrustedAccessRoleBinding or IO[bytes]
        :return: TrustedAccessRoleBinding or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2023_02_02_preview.models.TrustedAccessRoleBinding
        :raises ~azure.core.exceptions.HttpResponseError:
        """
