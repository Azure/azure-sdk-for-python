...
class ManagedClusterSnapshotsOperations:
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.ManagedClusterSnapshot"]:
        ...
        :return: An iterator like instance of either ManagedClusterSnapshot or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2023_02_02_preview.models.ManagedClusterSnapshot]
    ...
    def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.ManagedClusterSnapshot:
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_02_02_preview.models.ManagedClusterSnapshot
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2023_02_02_preview.models.ManagedClusterSnapshot
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2023_02_02_preview.models.ManagedClusterSnapshot or IO[bytes]
        :return: ManagedClusterSnapshot or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2023_02_02_preview.models.ManagedClusterSnapshot
        :raises ~azure.core.exceptions.HttpResponseError:
        """
