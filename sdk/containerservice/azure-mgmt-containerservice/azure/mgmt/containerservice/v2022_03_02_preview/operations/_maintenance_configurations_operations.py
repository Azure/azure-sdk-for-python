...
def build_list_by_managed_cluster_request(
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2022-03-02-preview"))
...
class MaintenanceConfigurationsOperations:
    ...
    def list_by_managed_cluster(
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2022-03-02-preview")
        )
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2022_03_02_preview.models.MaintenanceConfiguration or IO[bytes]
        :return: MaintenanceConfiguration or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2022_03_02_preview.models.MaintenanceConfiguration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
