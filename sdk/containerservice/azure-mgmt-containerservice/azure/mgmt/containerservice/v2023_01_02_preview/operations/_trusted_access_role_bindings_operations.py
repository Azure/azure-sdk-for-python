...
class TrustedAccessRoleBindingsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either TrustedAccessRoleBinding or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2023_01_02_preview.models.TrustedAccessRoleBinding]
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type trusted_access_role_binding:
         ~azure.mgmt.containerservice.v2023_01_02_preview.models.TrustedAccessRoleBinding or IO
