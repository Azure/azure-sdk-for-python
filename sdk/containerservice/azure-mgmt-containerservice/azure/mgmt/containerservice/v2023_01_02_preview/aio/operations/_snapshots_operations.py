...
class SnapshotsOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.Snapshot"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2023_01_02_preview.models.Snapshot]
    ...
    async def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.Snapshot:
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_01_02_preview.models.Snapshot
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2023_01_02_preview.models.Snapshot
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The snapshot to create or update. Is either a Snapshot type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.containerservice.v2023_01_02_preview.models.Snapshot or IO[bytes]
        :return: Snapshot or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2023_01_02_preview.models.Snapshot
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2023_01_02_preview.models.TagsObject or
         IO[bytes]
        :return: Snapshot or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2023_01_02_preview.models.Snapshot
        :raises ~azure.core.exceptions.HttpResponseError:
