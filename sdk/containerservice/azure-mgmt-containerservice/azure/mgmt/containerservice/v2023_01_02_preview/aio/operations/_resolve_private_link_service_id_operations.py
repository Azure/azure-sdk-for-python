...
class ResolvePrivateLinkServiceIdOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerservice.v2023_01_02_preview.aio.ContainerServiceClient`'s
    ...
    async def post(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2023_01_02_preview.models.PrivateLinkResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PrivateLinkResource or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2023_01_02_preview.models.PrivateLinkResource
    ...
    async def post(
        ...
        **kwargs: Any
        ...
        api_version: Literal["2023-01-02-preview"] = kwargs.pop(
            "api_version", _params.pop("api-version", "2023-01-02-preview")
        )
