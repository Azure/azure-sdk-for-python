...
class OperationStatusResultOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either OperationStatusResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2024_10_02_preview.models.OperationStatusResult]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2024_10_02_preview.models.OperationStatusResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
