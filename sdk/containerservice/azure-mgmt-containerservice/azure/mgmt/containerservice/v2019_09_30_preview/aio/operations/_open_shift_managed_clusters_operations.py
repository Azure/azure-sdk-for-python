...
class OpenShiftManagedClustersOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.OpenShiftManagedCluster"]:
        ...
        :return: An iterator like instance of either OpenShiftManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2019_09_30_preview.models.OpenShiftManagedCluster]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2019_09_30_preview.models.OpenShiftManagedCluster or IO
    ...
    async def begin_update_tags(
        ...
        :type parameters: ~azure.mgmt.containerservice.v2019_09_30_preview.models.TagsObject or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
