...
class OpenShiftManagedClustersOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.OpenShiftManagedCluster"]:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2019-09-30-preview")
        )
    ...
    ) -> AsyncItemPaged["_models.OpenShiftManagedCluster"]:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2019_09_30_preview.models.OpenShiftManagedCluster or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either OpenShiftManagedCluster or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2019_09_30_preview.models.OpenShiftManagedCluster]
    ...
    async def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2019_09_30_preview.models.TagsObject or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either OpenShiftManagedCluster or the
         result of cls(response)
        :rtype:
