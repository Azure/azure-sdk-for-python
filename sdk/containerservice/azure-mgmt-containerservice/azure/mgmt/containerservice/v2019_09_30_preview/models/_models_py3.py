...
class OpenShiftManagedCluster(Resource):
    ...
    def __init__(self, *, location: str, open_shift_version: str, tags=None, plan=None, network_profile=None, router_profiles=None, master_pool_profile=None, agent_pool_profiles=None, auth_profile=None, monitor_profile=None, **kwargs) -> None:
