...
class PrivateEndpointConnectionsOperations(object):
    ...
    def list(
        ...
        :return: PrivateEndpointConnectionListResult or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.containerservice.v2020_12_01.models.PrivateEndpointConnectionListResult
    ...
    def get(
        ...
        Gets the details of the private endpoint connection by managed cluster
        and resource group.
        ...
        :rtype:
         ~azure.mgmt.containerservice.v2020_12_01.models.PrivateEndpointConnection
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def update(
            self, resource_group_name, resource_name, private_endpoint_connection_name, private_link_service_connection_state, private_endpoint=None, custom_headers=None, raw=False, **operation_config):
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/privateEndpointConnections/{privateEndpointConnectionName}'}
