...
def build_create_or_update_request_initial(
    ...
    resource_name: str,
    *,
    json: Optional[_models.ManagedCluster] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_reset_service_principal_profile_request_initial(
    ...
    resource_name: str,
    *,
    json: Optional[_models.ManagedClusterServicePrincipalProfile] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_reset_aad_profile_request_initial(
    ...
    resource_name: str,
    *,
    json: Optional[_models.ManagedClusterAADProfile] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ManagedClusterListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2020_12_01.models.ManagedClusterListResult]
