...
class ManagedClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    def get_os_options(
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_09_02_preview.models.OSOptionProfile
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.ManagedCluster"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2022_09_02_preview.models.ManagedCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get_upgrade_profile(
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_09_02_preview.models.ManagedClusterUpgradeProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def get_access_profile(
        ...
        **WARNING**\\ : This API will be deprecated. Instead use `ListClusterUserCredentials
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_09_02_preview.models.ManagedClusterAccessProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def list_cluster_admin_credentials(
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_09_02_preview.models.CredentialResults
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def list_cluster_user_credentials(
        ...
        **kwargs: Any
        ...
        :type format: str or ~azure.mgmt.containerservice.v2022_09_02_preview.models.Format
        :return: CredentialResults or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2022_09_02_preview.models.CredentialResults
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.ManagedCluster:
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_09_02_preview.models.ManagedCluster
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_09_02_preview.models.ManagedCluster
        ...
        :return: An instance of LROPoller that returns either ManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2022_09_02_preview.models.ManagedCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_09_02_preview.models.ManagedCluster or
         IO[bytes]
        :return: An instance of LROPoller that returns either ManagedCluster or the result of
         cls(response)
        :rtype:
    ...
    def begin_reset_aad_profile(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2022_09_02_preview.models.ManagedClusterAADProfile or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_run_command(
        ...
        **kwargs: Any
        ...
        :type request_payload:
         ~azure.mgmt.containerservice.v2022_09_02_preview.models.RunCommandRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either RunCommandResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2022_09_02_preview.models.RunCommandResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_run_command(
        ...
        **kwargs: Any
        ...
        :type request_payload:
         ~azure.mgmt.containerservice.v2022_09_02_preview.models.RunCommandRequest or IO[bytes]
        :return: An instance of LROPoller that returns either RunCommandResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2022_09_02_preview.models.RunCommandResult]
    ...
    def get_command_result(
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_09_02_preview.models.RunCommandResult or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def list_outbound_network_dependencies_endpoints(  # pylint: disable=name-too-long
        ...
        :return: An iterator like instance of either OutboundEnvironmentEndpoint or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2022_09_02_preview.models.OutboundEnvironmentEndpoint]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
