...
class ManagedClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_07_01.models.ManagedCluster or IO[bytes]
        :return: An instance of LROPoller that returns either ManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2022_07_01.models.ManagedCluster]
    ...
    def begin_reset_service_principal_profile(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2022_07_01.models.ManagedClusterServicePrincipalProfile or
         IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_run_command(
        ...
        **kwargs: Any
        ...
        :type request_payload: ~azure.mgmt.containerservice.v2022_07_01.models.RunCommandRequest or
         IO[bytes]
        :return: An instance of LROPoller that returns either RunCommandResult or the result of
         cls(response)
        :rtype:
