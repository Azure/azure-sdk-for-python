...
class ManagedClusterSnapshotsOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2023_10_02_preview.models.ManagedClusterSnapshot or IO
    ...
    def update_tags(
        ...
        :type parameters: ~azure.mgmt.containerservice.v2023_10_02_preview.models.TagsObject or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
