...
def build_abort_latest_operation_request(
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2023-10-02-preview"))
...
class AgentPoolsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerservice.v2023_10_02_preview.ContainerServiceClient`'s
    ...
    def _abort_latest_operation_initial(  # pylint: disable=inconsistent-return-statements
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2023-10-02-preview")
        )
    ...
    _abort_latest_operation_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedclusters/{resourceName}/agentPools/{agentPoolName}/abort"
    }
    ...
    def list(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> Iterable["_models.AgentPool"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2023_10_02_preview.models.AgentPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_10_02_preview.models.AgentPool
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2023_10_02_preview.models.AgentPool
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2023_10_02_preview.models.AgentPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The agent pool to create or update. Is either a AgentPool type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.containerservice.v2023_10_02_preview.models.AgentPool or IO
    ...
    def get_upgrade_profile(
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_10_02_preview.models.AgentPoolUpgradeProfile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def _delete_machines_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        resource_name: str,
        agent_pool_name: str,
        machines: Union[_models.AgentPoolDeleteMachinesParameter, IO],
        **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_delete_machines_request(
            ...
            json=_json,
            content=_content,
            template_url=self._delete_machines_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _delete_machines_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/agentPools/{agentPoolName}/deleteMachines"
    }
    ...
    def begin_delete_machines(
        ...
        **kwargs: Any
        ...
        :type machines:
         ~azure.mgmt.containerservice.v2023_10_02_preview.models.AgentPoolDeleteMachinesParameter
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_delete_machines(
        ...
        **kwargs: Any
        ...
        :param machines: A list of machines from the agent pool to be deleted. Is either a
         AgentPoolDeleteMachinesParameter type or a IO type. Required.
        :type machines:
         ~azure.mgmt.containerservice.v2023_10_02_preview.models.AgentPoolDeleteMachinesParameter or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._delete_machines_initial(  # type: ignore
                resource_group_name=resource_group_name,
                resource_name=resource_name,
                agent_pool_name=agent_pool_name,
                machines=machines,
    ...
    begin_delete_machines.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/agentPools/{agentPoolName}/deleteMachines"
    }
    ...
    def get_available_agent_pool_versions(
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_10_02_preview.models.AgentPoolAvailableVersions
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
