...
class SnapshotsOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.Snapshot"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2023_10_02_preview.models.Snapshot]
    ...
    async def create_or_update(
        ...
        :param parameters: The snapshot to create or update. Is either a Snapshot type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.containerservice.v2023_10_02_preview.models.Snapshot or IO
