...
class MachinesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2023_10_02_preview.models.Machine]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_10_02_preview.models.Machine
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
