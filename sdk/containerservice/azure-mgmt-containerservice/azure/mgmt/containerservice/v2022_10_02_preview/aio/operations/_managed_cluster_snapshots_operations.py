...
class ManagedClusterSnapshotsOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ManagedClusterSnapshot"]:
        ...
        :return: An iterator like instance of either ManagedClusterSnapshot or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_10_02_preview.models.ManagedClusterSnapshot]
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2022_10_02_preview.models.ManagedClusterSnapshot or IO[bytes]
        :return: ManagedClusterSnapshot or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2022_10_02_preview.models.ManagedClusterSnapshot
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_10_02_preview.models.TagsObject or
         IO[bytes]
        :return: ManagedClusterSnapshot or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2022_10_02_preview.models.ManagedClusterSnapshot
        :raises ~azure.core.exceptions.HttpResponseError:
