...
def build_list_request(location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2023-07-02-preview"))
...
class TrustedAccessRolesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerservice.v2023_07_02_preview.ContainerServiceClient`'s
    ...
    def list(self, location: str, **kwargs: Any) -> Iterable["_models.TrustedAccessRole"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2023_07_02_preview.models.TrustedAccessRole]
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2023-07-02-preview")
        )
