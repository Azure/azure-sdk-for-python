...
class ManagedClustersOperations(object):
    ...
    :type models: ~azure.mgmt.containerservice.v2018_03_31.models
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.ManagedClusterListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2018_03_31.models.ManagedClusterListResult]
    ...
    def get_upgrade_profile(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ManagedClusterUpgradeProfile"
    ...
    def get_access_profile(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ManagedClusterAccessProfile"
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        resource_name,  # type: str
        parameters,  # type: "models.ManagedCluster"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.ManagedCluster"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ManagedCluster"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.ManagedCluster"]
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2018_03_31.models.ManagedCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _reset_service_principal_profile_initial(
        ...
        resource_group_name,  # type: str
        resource_name,  # type: str
        parameters,  # type: "models.ManagedClusterServicePrincipalProfile"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
    ...
    def _reset_aad_profile_initial(
        ...
        resource_group_name,  # type: str
        resource_name,  # type: str
        parameters,  # type: "models.ManagedClusterAADProfile"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
