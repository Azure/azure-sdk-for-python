...
class ResolvePrivateLinkServiceIdOperations:
    ...
    async def post(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2023_09_02_preview.models.PrivateLinkResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: PrivateLinkResource or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2023_09_02_preview.models.PrivateLinkResource
