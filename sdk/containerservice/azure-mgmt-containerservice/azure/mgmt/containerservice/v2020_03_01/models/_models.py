...
class AgentPool(SubResource):
    ...
    :type os_type: str or ~azure.mgmt.containerservice.v2020_03_01.models.OSType
    ...
    :param mode: AgentPoolMode represents mode of an agent pool. Possible values include: "System",
     "User".
    :type mode: str or ~azure.mgmt.containerservice.v2020_03_01.models.AgentPoolMode
    ...
    :param scale_set_priority: ScaleSetPriority to be used to specify virtual machine scale set
     priority. Default to regular. Possible values include: "Spot", "Low", "Regular". Default value:
     "Regular".
    ...
    :param scale_set_eviction_policy: ScaleSetEvictionPolicy to be used to specify eviction policy
     for Spot or low priority virtual machine scale set. Default to Delete. Possible values include:
...
class AgentPoolListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.containerservice.v2020_03_01.models.AgentPool]
...
class CloudErrorBody(msrest.serialization.Model):
    ...
    :type details: list[~azure.mgmt.containerservice.v2020_03_01.models.CloudErrorBody]
    """
...
class Components1Q1Og48SchemasManagedclusterAllof1(msrest.serialization.Model):
    ...
    :type identity: ~azure.mgmt.containerservice.v2020_03_01.models.ManagedClusterIdentity
    :ivar provisioning_state: The current deployment or provisioning state, which only appears in
     the response.
    :vartype provisioning_state: str
    ...
    :type aad_profile: ~azure.mgmt.containerservice.v2020_03_01.models.ManagedClusterAADProfile
...
class ContainerServiceLinuxProfile(msrest.serialization.Model):
    ...
    :type ssh: ~azure.mgmt.containerservice.v2020_03_01.models.ContainerServiceSshConfiguration
    """
...
class ContainerServiceMasterProfile(msrest.serialization.Model):
    ...
    :type count: str or ~azure.mgmt.containerservice.v2020_03_01.models.Count
...
class ContainerServiceNetworkProfile(msrest.serialization.Model):
    ...
    :type network_plugin: str or ~azure.mgmt.containerservice.v2020_03_01.models.NetworkPlugin
    :param network_policy: Network policy used for building Kubernetes network. Possible values
     include: "calico", "azure".
    :type network_policy: str or ~azure.mgmt.containerservice.v2020_03_01.models.NetworkPolicy
    :param network_mode: Network mode used for building Kubernetes network. Possible values
     include: "transparent", "bridge".
    :type network_mode: str or ~azure.mgmt.containerservice.v2020_03_01.models.NetworkMode
    ...
    :type outbound_type: str or ~azure.mgmt.containerservice.v2020_03_01.models.OutboundType
    :param load_balancer_sku: The load balancer sku for the managed cluster. Possible values
     include: "standard", "basic".
    :type load_balancer_sku: str or ~azure.mgmt.containerservice.v2020_03_01.models.LoadBalancerSku
...
class CredentialResults(msrest.serialization.Model):
    ...
    :vartype kubeconfigs: list[~azure.mgmt.containerservice.v2020_03_01.models.CredentialResult]
    """
...
class ManagedCluster(Resource, Components1Q1Og48SchemasManagedclusterAllof1):
    ...
    :type sku: ~azure.mgmt.containerservice.v2020_03_01.models.ManagedClusterSKU
    """
...
class ManagedClusterAgentPoolProfileProperties(msrest.serialization.Model):
    ...
    :type type: str or ~azure.mgmt.containerservice.v2020_03_01.models.AgentPoolType
    :param mode: AgentPoolMode represents mode of an agent pool. Possible values include: "System",
     "User".
    :type mode: str or ~azure.mgmt.containerservice.v2020_03_01.models.AgentPoolMode
    :param orchestrator_version: Version of orchestrator specified when creating the managed
...
class ManagedClusterIdentity(msrest.serialization.Model):
    ...
    :type type: str or ~azure.mgmt.containerservice.v2020_03_01.models.ResourceIdentityType
    """
...
class ManagedClusterListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.containerservice.v2020_03_01.models.ManagedCluster]
...
class ManagedClusterLoadBalancerProfileOutboundIPs(msrest.serialization.Model):
    ...
    :type public_i_ps: list[~azure.mgmt.containerservice.v2020_03_01.models.ResourceReference]
    """
...
class ManagedClusterSKU(msrest.serialization.Model):
    ...
    :type tier: str or ~azure.mgmt.containerservice.v2020_03_01.models.ManagedClusterSKUTier
    """
...
class OperationListResult(msrest.serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.containerservice.v2020_03_01.models.OperationValue]
    """
