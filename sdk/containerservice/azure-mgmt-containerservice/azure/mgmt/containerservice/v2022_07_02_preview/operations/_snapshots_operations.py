...
class SnapshotsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2022_07_02_preview.models.Snapshot]
    ...
    def create_or_update(
        ...
        resource_group_name: str,
        resource_name: str,
        parameters: Union[_models.Snapshot, IO],
        **kwargs: Any
    ) -> _models.Snapshot:
        """Creates or updates a snapshot.
        ...
        :param parameters: The snapshot to create or update. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.containerservice.v2022_07_02_preview.models.Snapshot or IO
