...
class TrustedAccessRolesOperations:
    ...
    def list(
        ...
        location: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.TrustedAccessRole"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_07_02_preview.models.TrustedAccessRole]
