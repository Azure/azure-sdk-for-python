...
class ManagedClustersOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ManagedCluster"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2020_07_01.models.ManagedCluster]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2020_07_01.models.ManagedCluster or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2020_07_01.models.ManagedCluster]
    ...
    async def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2020_07_01.models.TagsObject or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2020_07_01.models.ManagedCluster]
    ...
    async def begin_reset_service_principal_profile(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the Reset Service Principal Profile operation for a
         ...
         Required.
        :type parameters:
         ~azure.mgmt.containerservice.v2020_07_01.models.ManagedClusterServicePrincipalProfile or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_reset_aad_profile(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2020_07_01.models.ManagedClusterAADProfile or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
