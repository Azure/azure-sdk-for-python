...
class OpenShiftManagedClustersOperations(object):
    ...
    :ivar api_version: Client Api Version. Constant value: "2019-04-30".
    """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.containerservice.v2019_04_30.models.OpenShiftManagedClusterPaged[~azure.mgmt.containerservice.v2019_04_30.models.OpenShiftManagedCluster]
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.containerservice.v2019_04_30.models.OpenShiftManagedCluster
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('OpenShiftManagedCluster', response)
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/openShiftManagedClusters/{resourceName}'}
    ...
    def _create_or_update_initial(
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'OpenShiftManagedCluster')
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.containerservice.v2019_04_30.models.OpenShiftManagedCluster]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.containerservice.v2019_04_30.models.OpenShiftManagedCluster]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/openShiftManagedClusters/{resourceName}'}
    ...
    def update_tags(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    update_tags.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/openShiftManagedClusters/{resourceName}'}
    ...
    def delete(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/openShiftManagedClusters/{resourceName}'}
