...
class OpenShiftManagedClustersOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2019_04_30.models.OpenShiftManagedCluster or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either OpenShiftManagedCluster or the
         result of cls(response)
        :rtype:
    ...
    async def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2019_04_30.models.TagsObject or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either OpenShiftManagedCluster or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2019_04_30.models.OpenShiftManagedCluster]
