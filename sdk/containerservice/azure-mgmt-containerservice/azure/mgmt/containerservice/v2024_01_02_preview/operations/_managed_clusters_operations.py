...
class ManagedClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2024_01_02_preview.models.ManagedCluster or
         IO[bytes]
        :return: An instance of LROPoller that returns either ManagedCluster or the result of
         cls(response)
        :rtype:
    ...
    def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2024_01_02_preview.models.TagsObject or
         IO[bytes]
        :return: An instance of LROPoller that returns either ManagedCluster or the result of
         cls(response)
        :rtype:
    ...
    def begin_reset_aad_profile(
        ...
        **WARNING**\\ : This API will be deprecated. Please see `AKS-managed Azure Active Directory
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2024_01_02_preview.models.ManagedClusterAADProfile or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_run_command(
        ...
        **kwargs: Any
        ...
        :type request_payload:
         ~azure.mgmt.containerservice.v2024_01_02_preview.models.RunCommandRequest or IO[bytes]
        :return: An instance of LROPoller that returns either RunCommandResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2024_01_02_preview.models.RunCommandResult]
