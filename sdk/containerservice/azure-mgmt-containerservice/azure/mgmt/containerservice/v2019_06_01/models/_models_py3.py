...
class AgentPool(SubResource):
    ...
    :vartype os_type: str or ~azure.mgmt.containerservice.v2019_06_01.models.OSType
    ...
    :ivar availability_zones: (PREVIEW) Availability zones for nodes. Must use
    ...
    :ivar scale_set_priority: ScaleSetPriority to be used to specify virtual machine scale set
     priority. Default to regular. Known values are: "Low", "Regular". Default value: "Regular".
    ...
    :ivar scale_set_eviction_policy: ScaleSetEvictionPolicy to be used to specify eviction policy
     for low priority virtual machine scale set. Default to Delete. Known values are: "Delete",
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype os_type: str or ~azure.mgmt.containerservice.v2019_06_01.models.OSType
        ...
        :keyword availability_zones: (PREVIEW) Availability zones for nodes. Must use
         VirtualMachineScaleSets AgentPoolType.
...
class AgentPoolListResult(msrest.serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.containerservice.v2019_06_01.models.AgentPool]
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype value: list[~azure.mgmt.containerservice.v2019_06_01.models.AgentPool]
        """
...
class CloudErrorBody(msrest.serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.containerservice.v2019_06_01.models.CloudErrorBody]
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype details: list[~azure.mgmt.containerservice.v2019_06_01.models.CloudErrorBody]
        """
...
class ContainerServiceLinuxProfile(msrest.serialization.Model):
    ...
    :vartype ssh: ~azure.mgmt.containerservice.v2019_06_01.models.ContainerServiceSshConfiguration
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype ssh:
         ~azure.mgmt.containerservice.v2019_06_01.models.ContainerServiceSshConfiguration
        """
...
class ContainerServiceMasterProfile(msrest.serialization.Model):
    ...
    :vartype count: int or ~azure.mgmt.containerservice.v2019_06_01.models.Count
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype count: int or ~azure.mgmt.containerservice.v2019_06_01.models.Count
...
class ContainerServiceNetworkProfile(msrest.serialization.Model):
    ...
    :vartype network_plugin: str or ~azure.mgmt.containerservice.v2019_06_01.models.NetworkPlugin
    :ivar network_policy: Network policy used for building Kubernetes network. Known values are:
     "calico", "azure".
    :vartype network_policy: str or ~azure.mgmt.containerservice.v2019_06_01.models.NetworkPolicy
    ...
    :vartype load_balancer_sku: str or
     ~azure.mgmt.containerservice.v2019_06_01.models.LoadBalancerSku
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword network_plugin: Network plugin used for building Kubernetes network. Known values are:
         "azure", "kubenet". Default value: "kubenet".
        :paramtype network_plugin: str or ~azure.mgmt.containerservice.v2019_06_01.models.NetworkPlugin
        :keyword network_policy: Network policy used for building Kubernetes network. Known values are:
         "calico", "azure".
        :paramtype network_policy: str or ~azure.mgmt.containerservice.v2019_06_01.models.NetworkPolicy
...
class ManagedCluster(Resource):
    ...
    :vartype identity: ~azure.mgmt.containerservice.v2019_06_01.models.ManagedClusterIdentity
    :ivar provisioning_state: The current deployment or provisioning state, which only appears in
     the response.
    :vartype provisioning_state: str
    ...
    :vartype aad_profile: ~azure.mgmt.containerservice.v2019_06_01.models.ManagedClusterAADProfile
    :ivar api_server_authorized_ip_ranges: (PREVIEW) Authorized IP Ranges to kubernetes API server.
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype identity: ~azure.mgmt.containerservice.v2019_06_01.models.ManagedClusterIdentity
        ...
        :paramtype aad_profile:
         ~azure.mgmt.containerservice.v2019_06_01.models.ManagedClusterAADProfile
        :keyword api_server_authorized_ip_ranges: (PREVIEW) Authorized IP Ranges to kubernetes API
         server.
...
class ManagedClusterAgentPoolProfileProperties(msrest.serialization.Model):
    ...
    :ivar type: AgentPoolType represents types of an agent pool. Known values are:
     "VirtualMachineScaleSets", "AvailabilitySet".
    :vartype type: str or ~azure.mgmt.containerservice.v2019_06_01.models.AgentPoolType
    :ivar orchestrator_version: Version of orchestrator specified when creating the managed
     cluster.
    :vartype orchestrator_version: str
    :ivar provisioning_state: The current deployment or provisioning state, which only appears in
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword type: AgentPoolType represents types of an agent pool. Known values are:
         "VirtualMachineScaleSets", "AvailabilitySet".
        :paramtype type: str or ~azure.mgmt.containerservice.v2019_06_01.models.AgentPoolType
        :keyword orchestrator_version: Version of orchestrator specified when creating the managed
         cluster.
        :paramtype orchestrator_version: str
        :keyword availability_zones: (PREVIEW) Availability zones for nodes. Must use
...
class ManagedClusterIdentity(msrest.serialization.Model):
    ...
    :ivar type: The type of identity used for the managed cluster. Type 'SystemAssigned' will use
     ...
     service principal will be used instead. Known values are: "SystemAssigned", "None".
    :vartype type: str or ~azure.mgmt.containerservice.v2019_06_01.models.ResourceIdentityType
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword type: The type of identity used for the managed cluster. Type 'SystemAssigned' will
         ...
         cluster, service principal will be used instead. Known values are: "SystemAssigned", "None".
        :paramtype type: str or ~azure.mgmt.containerservice.v2019_06_01.models.ResourceIdentityType
        """
...
class ManagedClusterListResult(msrest.serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.containerservice.v2019_06_01.models.ManagedCluster]
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype value: list[~azure.mgmt.containerservice.v2019_06_01.models.ManagedCluster]
        """
