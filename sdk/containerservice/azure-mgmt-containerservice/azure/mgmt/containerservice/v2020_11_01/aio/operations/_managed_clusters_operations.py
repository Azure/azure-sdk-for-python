...
class ManagedClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    :type models: ~azure.mgmt.containerservice.v2020_11_01.models
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ManagedClusterListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2020_11_01.models.ManagedClusterListResult]
