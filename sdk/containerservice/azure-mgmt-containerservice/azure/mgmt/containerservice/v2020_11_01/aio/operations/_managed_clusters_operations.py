...
class ManagedClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ManagedCluster"]:
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", "2020-11-01"))  # type: Literal["2020-11-01"]
    ...
    async def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.containerservice.v2020_11_01.models.ManagedCluster or IO
    ...
    async def begin_update_tags(
        ...
        :type parameters: ~azure.mgmt.containerservice.v2020_11_01.models.TagsObject or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_reset_service_principal_profile(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2020_11_01.models.ManagedClusterServicePrincipalProfile or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
