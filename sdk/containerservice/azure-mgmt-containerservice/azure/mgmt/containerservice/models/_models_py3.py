...
class ManagedClusterAPIServerAccessProfile(_serialization.Model):
    ...
    :ivar subnet_id: It is required when creating a new cluster with BYO Vnet, or when updating an
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword subnet_id: It is required when creating a new cluster with BYO Vnet, or when updating
