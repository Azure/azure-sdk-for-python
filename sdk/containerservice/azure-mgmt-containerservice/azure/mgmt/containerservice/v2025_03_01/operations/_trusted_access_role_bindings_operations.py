...
class TrustedAccessRoleBindingsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either TrustedAccessRoleBinding or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2025_03_01.models.TrustedAccessRoleBinding]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type trusted_access_role_binding:
         ~azure.mgmt.containerservice.v2025_03_01.models.TrustedAccessRoleBinding or IO[bytes]
        :return: An instance of LROPoller that returns either TrustedAccessRoleBinding or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2025_03_01.models.TrustedAccessRoleBinding]
