...
class ContainerServiceClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype operations: azure.mgmt.containerservice.v2020_02_01.aio.operations.Operations
    :ivar managed_clusters: ManagedClustersOperations operations
    :vartype managed_clusters:
     azure.mgmt.containerservice.v2020_02_01.aio.operations.ManagedClustersOperations
    :ivar agent_pools: AgentPoolsOperations operations
    :vartype agent_pools:
     azure.mgmt.containerservice.v2020_02_01.aio.operations.AgentPoolsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.operations = Operations(self._client, self._config, self._serialize, self._deserialize, "2020-02-01")
        self.managed_clusters = ManagedClustersOperations(
            self._client, self._config, self._serialize, self._deserialize, "2020-02-01"
        )
