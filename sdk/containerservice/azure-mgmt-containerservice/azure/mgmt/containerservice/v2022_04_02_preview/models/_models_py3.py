...
class AgentPoolAvailableVersions(_serialization.Model):
    ...
    :vartype agent_pool_versions:
     list[~azure.mgmt.containerservice.v2022_04_02_preview.models.AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem]  # pylint: disable=line-too-long
    """
...
class AzureKeyVaultKms(_serialization.Model):
    ...
    def __init__(self, *, enabled: Optional[bool] = None, key_id: Optional[str] = None, **kwargs: Any) -> None:
        """
