...
class TrustedAccessRoleBindingsOperations:
    """TrustedAccessRoleBindingsOperations async operations.
    ...
    def list(
        ...
        resource_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.TrustedAccessRoleBindingListResult"]:
        ...
        :return: An iterator like instance of either TrustedAccessRoleBindingListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_04_02_preview.models.TrustedAccessRoleBindingListResult]
