...
class SnapshotsOperations:
    ...
    def create_or_update(
        ...
        :param parameters: The snapshot to create or update. Is either a Snapshot type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.containerservice.v2023_07_01.models.Snapshot or IO
    ...
    def update_tags(
        ...
        :type parameters: ~azure.mgmt.containerservice.v2023_07_01.models.TagsObject or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
