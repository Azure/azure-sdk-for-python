...
class AgentPool(SubResource):
    ...
    :type os_type: str or ~azure.mgmt.containerservice.v2019_11_01.models.OSType
...
class AgentPoolListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.containerservice.v2019_11_01.models.AgentPool]
...
class CloudErrorBody(msrest.serialization.Model):
    ...
    :type details: list[~azure.mgmt.containerservice.v2019_11_01.models.CloudErrorBody]
    """
...
class ContainerServiceLinuxProfile(msrest.serialization.Model):
    ...
    :type ssh: ~azure.mgmt.containerservice.v2019_11_01.models.ContainerServiceSshConfiguration
    """
...
class ContainerServiceMasterProfile(msrest.serialization.Model):
    ...
    :type count: str or ~azure.mgmt.containerservice.v2019_11_01.models.Count
...
class ContainerServiceNetworkProfile(msrest.serialization.Model):
    ...
    :type network_plugin: str or ~azure.mgmt.containerservice.v2019_11_01.models.NetworkPlugin
    :param network_policy: Network policy used for building Kubernetes network. Possible values
     include: "calico", "azure".
    :type network_policy: str or ~azure.mgmt.containerservice.v2019_11_01.models.NetworkPolicy
    ...
    :type outbound_type: str or ~azure.mgmt.containerservice.v2019_11_01.models.OutboundType
    :param load_balancer_sku: The load balancer sku for the managed cluster. Possible values
     include: "standard", "basic".
    :type load_balancer_sku: str or ~azure.mgmt.containerservice.v2019_11_01.models.LoadBalancerSku
...
class ManagedCluster(Resource):
    ...
    :type identity: ~azure.mgmt.containerservice.v2019_11_01.models.ManagedClusterIdentity
    :ivar provisioning_state: The current deployment or provisioning state, which only appears in
     the response.
    :vartype provisioning_state: str
    ...
    :type aad_profile: ~azure.mgmt.containerservice.v2019_11_01.models.ManagedClusterAADProfile
...
class ManagedClusterAgentPoolProfileProperties(msrest.serialization.Model):
    ...
    :type type: str or ~azure.mgmt.containerservice.v2019_11_01.models.AgentPoolType
    :param orchestrator_version: Version of orchestrator specified when creating the managed
     cluster.
    :type orchestrator_version: str
    :ivar provisioning_state: The current deployment or provisioning state, which only appears in
...
class ManagedClusterIdentity(msrest.serialization.Model):
    ...
    :type type: str or ~azure.mgmt.containerservice.v2019_11_01.models.ResourceIdentityType
    """
...
class ManagedClusterListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.containerservice.v2019_11_01.models.ManagedCluster]
...
class ManagedClusterLoadBalancerProfileOutboundIPs(msrest.serialization.Model):
    ...
    :type public_i_ps: list[~azure.mgmt.containerservice.v2019_11_01.models.ResourceReference]
    """
