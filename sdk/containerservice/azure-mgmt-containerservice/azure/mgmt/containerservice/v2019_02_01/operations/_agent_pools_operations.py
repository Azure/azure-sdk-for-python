...
def build_list_request(
    resource_group_name: str, managed_cluster_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
def build_get_request(
    resource_group_name: str, managed_cluster_name: str, agent_pool_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class AgentPoolsOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, managed_cluster_name: str, **kwargs: Any) -> Iterable["_models.AgentPool"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2019_02_01.models.AgentPool]
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{managedClusterName}/agentPools"
    }

    @distributed_trace
    def get(
        self, resource_group_name: str, managed_cluster_name: str, agent_pool_name: str, **kwargs: Any
    ) -> _models.AgentPool:
        """Gets the agent pool.
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{managedClusterName}/agentPools/{agentPoolName}"
    }
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2019_02_01.models.AgentPool or IO
