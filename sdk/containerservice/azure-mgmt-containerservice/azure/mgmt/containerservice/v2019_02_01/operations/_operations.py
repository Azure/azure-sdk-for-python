...
def build_list_request(**kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2019-02-01"))
...
class Operations:
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.OperationValue"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2019_02_01.models.OperationValue]
