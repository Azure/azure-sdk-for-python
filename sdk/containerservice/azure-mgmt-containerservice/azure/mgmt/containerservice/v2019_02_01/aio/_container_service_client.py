...
class ContainerServiceClient:
    ...
    :vartype managed_clusters:
     azure.mgmt.containerservice.v2019_02_01.aio.operations.ManagedClustersOperations
    :ivar agent_pools: AgentPoolsOperations operations
    :vartype agent_pools:
     azure.mgmt.containerservice.v2019_02_01.aio.operations.AgentPoolsOperations
