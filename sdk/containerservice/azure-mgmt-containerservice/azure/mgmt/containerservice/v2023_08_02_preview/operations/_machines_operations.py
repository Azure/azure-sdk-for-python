...
class MachinesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2023_08_02_preview.models.Machine]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_08_02_preview.models.Machine
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
