...
def build_list_by_fleet_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/fleets/{fleetName}/members")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "fleetName": _SERIALIZER.url("fleet_name", fleet_name, 'str', max_length=63, min_length=1, pattern=r'^[a-z0-9]([-a-z0-9]*[a-z0-9])?$'),
...
class FleetMembersOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type fleet_name: str
        :param fleet_member_name: The name of the Fleet member resource.
        :type fleet_member_name: str
        :param parameters: The Fleet member to create or update.
        :type parameters: ~azure.mgmt.containerservice.v2022_06_02_preview.models.FleetMember
        ...
        :return: An instance of LROPoller that returns either FleetMember or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2022_06_02_preview.models.FleetMember]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.containerservice.v2022_06_02_preview.models.FleetMember
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
    ...
    def list_by_fleet(
        ...
        fleet_name: str,
        **kwargs: Any
    ) -> Iterable[_models.FleetMembersListResult]:
        ...
        :type fleet_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either FleetMembersListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2022_06_02_preview.models.FleetMembersListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
