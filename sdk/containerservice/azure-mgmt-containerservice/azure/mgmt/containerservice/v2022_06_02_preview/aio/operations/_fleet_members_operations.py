...
from ...operations._fleet_members_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_fleet_request
T = TypeVar('T')
...
class FleetMembersOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either FleetMember or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2022_06_02_preview.models.FleetMember]
    ...
    def list_by_fleet(
        ...
        fleet_name: str,
        **kwargs: Any
    ) -> AsyncIterable[_models.FleetMembersListResult]:
        ...
        :return: An iterator like instance of either FleetMembersListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_06_02_preview.models.FleetMembersListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
