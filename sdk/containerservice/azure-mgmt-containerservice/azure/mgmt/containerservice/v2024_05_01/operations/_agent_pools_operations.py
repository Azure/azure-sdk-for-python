...
class AgentPoolsOperations:
    ...
    def list(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> Iterable["_models.AgentPool"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2024_05_01.models.AgentPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2024_05_01.models.AgentPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
