...
class SnapshotsOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.Snapshot"]:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2022-01-02-preview")
        )
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The snapshot to create or update. Is either a Snapshot type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.containerservice.v2022_01_02_preview.models.Snapshot or IO[bytes]
        :return: Snapshot or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2022_01_02_preview.models.Snapshot
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2022_01_02_preview.models.TagsObject or
         IO[bytes]
        :return: Snapshot or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2022_01_02_preview.models.Snapshot
        :raises ~azure.core.exceptions.HttpResponseError:
