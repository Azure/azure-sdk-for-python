...
class SnapshotsOperations:
    ...
    def list(self, **kwargs: Any) -> ItemPaged["_models.Snapshot"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2025_05_02_preview.models.Snapshot]
    ...
    def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.Snapshot:
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_05_02_preview.models.Snapshot
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2025_05_02_preview.models.Snapshot
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The snapshot to create or update. Is either a Snapshot type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.containerservice.v2025_05_02_preview.models.Snapshot or IO[bytes]
        :return: Snapshot or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2025_05_02_preview.models.Snapshot
        :raises ~azure.core.exceptions.HttpResponseError:
        """
