...
from ...operations._open_shift_managed_clusters_operations import (
...
class OpenShiftManagedClustersOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerservice.v2018_09_30_preview.aio.ContainerServiceClient`'s
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.OpenShiftManagedCluster"]:
        ...
        :return: An iterator like instance of either OpenShiftManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2018_09_30_preview.models.OpenShiftManagedCluster]
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2018-09-30-preview")
        )
    ...
    async def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.OpenShiftManagedCluster:
        ...
        deserialized = self._deserialize("OpenShiftManagedCluster", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2018_09_30_preview.models.OpenShiftManagedCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2018_09_30_preview.models.OpenShiftManagedCluster or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either OpenShiftManagedCluster or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2018_09_30_preview.models.OpenShiftManagedCluster]
        ...
        if cont_token:
            return AsyncLROPoller[_models.OpenShiftManagedCluster].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.OpenShiftManagedCluster](
    ...
    async def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2018_09_30_preview.models.TagsObject or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either OpenShiftManagedCluster or the
         result of cls(response)
        :rtype:
