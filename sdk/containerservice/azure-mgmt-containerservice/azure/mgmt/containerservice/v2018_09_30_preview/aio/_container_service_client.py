...
class ContainerServiceClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype open_shift_managed_clusters:
     azure.mgmt.containerservice.v2018_09_30_preview.aio.operations.OpenShiftManagedClustersOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.open_shift_managed_clusters = OpenShiftManagedClustersOperations(
            self._client, self._config, self._serialize, self._deserialize, "2018-09-30-preview"
        )
