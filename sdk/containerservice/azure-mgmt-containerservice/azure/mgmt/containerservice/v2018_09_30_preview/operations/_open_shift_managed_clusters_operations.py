...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2018-09-30-preview"))
...
class OpenShiftManagedClustersOperations:
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.OpenShiftManagedCluster"]:
        ...
        :return: An iterator like instance of either OpenShiftManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2018_09_30_preview.models.OpenShiftManagedCluster]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.OpenShiftManagedCluster].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.OpenShiftManagedCluster](
