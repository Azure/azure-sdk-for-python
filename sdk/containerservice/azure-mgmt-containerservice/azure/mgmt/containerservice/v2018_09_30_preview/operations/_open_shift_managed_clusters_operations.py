...
class OpenShiftManagedClustersOperations(object):
    ...
    :ivar api_version: Client Api Version. Constant value: "2018-09-30-preview".
    """
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.OpenShiftManagedClusterPaged(internal_paging, self._deserialize.dependencies, header_dict)
