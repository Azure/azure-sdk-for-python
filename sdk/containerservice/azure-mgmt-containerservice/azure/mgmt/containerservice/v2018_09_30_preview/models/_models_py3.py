...
class NetworkProfile(_serialization.Model):
    ...
    def __init__(self, *, vnet_cidr: str = "10.0.0.0/8", peer_vnet_id: Optional[str] = None, **kwargs: Any) -> None:
        """
...
class OpenShiftRouterProfile(_serialization.Model):
    ...
    def __init__(self, *, name: Optional[str] = None, public_subdomain: Optional[str] = None, **kwargs: Any) -> None:
        """
