...
class ManagedClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_create_or_update(
        ...
        :param parameters: The managed cluster to create or update. Is either a ManagedCluster type or
         a IO type. Required.
        :type parameters: ~azure.mgmt.containerservice.v2023_10_01.models.ManagedCluster or IO
    ...
    async def begin_reset_service_principal_profile(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2023_10_01.models.ManagedClusterServicePrincipalProfile or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_run_command(
        ...
        **kwargs: Any
        ...
        :param request_payload: The run command request. Is either a RunCommandRequest type or a IO
         type. Required.
        :type request_payload: ~azure.mgmt.containerservice.v2023_10_01.models.RunCommandRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
