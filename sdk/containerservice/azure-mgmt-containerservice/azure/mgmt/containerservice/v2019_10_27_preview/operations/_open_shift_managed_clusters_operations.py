...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2019-10-27-preview"))
...
class OpenShiftManagedClustersOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerservice.v2019_10_27_preview.ContainerServiceClient`'s
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.OpenShiftManagedCluster"]:
        ...
        :return: An iterator like instance of either OpenShiftManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2019_10_27_preview.models.OpenShiftManagedCluster]
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2019-10-27-preview")
        )
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the Create or Update an OpenShift Managed Cluster
         operation. Required.
        :type parameters:
         ~azure.mgmt.containerservice.v2019_10_27_preview.models.OpenShiftManagedCluster
        ...
        :return: An instance of LROPoller that returns either OpenShiftManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2019_10_27_preview.models.OpenShiftManagedCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2019_10_27_preview.models.OpenShiftManagedCluster or IO[bytes]
        :return: An instance of LROPoller that returns either OpenShiftManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2019_10_27_preview.models.OpenShiftManagedCluster]
    ...
    def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2019_10_27_preview.models.TagsObject or
         IO[bytes]
        :return: An instance of LROPoller that returns either OpenShiftManagedCluster or the result of
         cls(response)
        :rtype:
