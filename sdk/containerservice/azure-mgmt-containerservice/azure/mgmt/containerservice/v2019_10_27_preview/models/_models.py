...
class CloudError(Model):
    ...
    :type error:
     ~azure.mgmt.containerservice.v2019_10_27_preview.models.CloudErrorBody
    """
...
class NetworkProfile(Model):
    ...
    :param vnet_cidr: CIDR for the OpenShift Vnet. Default value: "10.0.0.0/8"
     .
    :type vnet_cidr: str
    :param management_subnet_cidr: CIDR of subnet used to create PLS needed
    ...
    def __init__(self, **kwargs):
        ...
        self.management_subnet_cidr = kwargs.get('management_subnet_cidr', None)
        self.vnet_id = kwargs.get('vnet_id', None)


class OpenShiftAPIProperties(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.private_api_server = kwargs.get('private_api_server', None)
...
class OpenShiftManagedCluster(Resource):
    ...
    :param plan: Define the resource plan as required by ARM for billing
     purposes
    :type plan:
     ~azure.mgmt.containerservice.v2019_10_27_preview.models.PurchasePlan
    ...
    :ivar public_hostname: Service generated FQDN or private IP for OpenShift
     API server.
    ...
    def __init__(self, **kwargs):
        ...
        self.refresh_cluster = kwargs.get('refresh_cluster', None)
...
class OpenShiftManagedClusterAgentPoolProfile(Model):
    ...
    :type os_type: str or
     ~azure.mgmt.containerservice.v2019_10_27_preview.models.OSType
