...
class ContainerServiceClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    :keyword api_version: Api Version. Default value is "2019-10-27-preview". Note that overriding
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        api_version = kwargs.pop('api_version', "2019-10-27-preview")  # type: str
