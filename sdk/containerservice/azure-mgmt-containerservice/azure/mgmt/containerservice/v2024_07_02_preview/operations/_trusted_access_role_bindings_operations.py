...
class TrustedAccessRoleBindingsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either TrustedAccessRoleBinding or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2024_07_02_preview.models.TrustedAccessRoleBinding]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either TrustedAccessRoleBinding or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.v2024_07_02_preview.models.TrustedAccessRoleBinding]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
