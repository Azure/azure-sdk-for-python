...
class LoadBalancersOperations:
    ...
    def list_by_managed_cluster(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2024_07_02_preview.models.LoadBalancer]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2024_07_02_preview.models.LoadBalancer
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type service_label_selector:
         ~azure.mgmt.containerservice.v2024_07_02_preview.models.LabelSelector
        ...
        :type node_selector: ~azure.mgmt.containerservice.v2024_07_02_preview.models.LabelSelector
        :return: LoadBalancer or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2024_07_02_preview.models.LoadBalancer
        :raises ~azure.core.exceptions.HttpResponseError:
        """
