...
class ContainerServiceClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.containerservice.v2024_07_02_preview.operations.Operations
    :ivar managed_clusters: ManagedClustersOperations operations
    :vartype managed_clusters:
     azure.mgmt.containerservice.v2024_07_02_preview.operations.ManagedClustersOperations
    :ivar maintenance_configurations: MaintenanceConfigurationsOperations operations
    :vartype maintenance_configurations:
     azure.mgmt.containerservice.v2024_07_02_preview.operations.MaintenanceConfigurationsOperations
    :ivar agent_pools: AgentPoolsOperations operations
    :vartype agent_pools:
     azure.mgmt.containerservice.v2024_07_02_preview.operations.AgentPoolsOperations
    :ivar machines: MachinesOperations operations
    :vartype machines:
     azure.mgmt.containerservice.v2024_07_02_preview.operations.MachinesOperations
    :ivar private_endpoint_connections: PrivateEndpointConnectionsOperations operations
    :vartype private_endpoint_connections:
     azure.mgmt.containerservice.v2024_07_02_preview.operations.PrivateEndpointConnectionsOperations
    :ivar private_link_resources: PrivateLinkResourcesOperations operations
    :vartype private_link_resources:
     azure.mgmt.containerservice.v2024_07_02_preview.operations.PrivateLinkResourcesOperations
    ...
    :vartype resolve_private_link_service_id:
     azure.mgmt.containerservice.v2024_07_02_preview.operations.ResolvePrivateLinkServiceIdOperations
    :ivar operation_status_result: OperationStatusResultOperations operations
    :vartype operation_status_result:
     azure.mgmt.containerservice.v2024_07_02_preview.operations.OperationStatusResultOperations
    :ivar snapshots: SnapshotsOperations operations
    :vartype snapshots:
     azure.mgmt.containerservice.v2024_07_02_preview.operations.SnapshotsOperations
    :ivar managed_cluster_snapshots: ManagedClusterSnapshotsOperations operations
    :vartype managed_cluster_snapshots:
     azure.mgmt.containerservice.v2024_07_02_preview.operations.ManagedClusterSnapshotsOperations
    :ivar trusted_access_roles: TrustedAccessRolesOperations operations
    :vartype trusted_access_roles:
     azure.mgmt.containerservice.v2024_07_02_preview.operations.TrustedAccessRolesOperations
    :ivar trusted_access_role_bindings: TrustedAccessRoleBindingsOperations operations
    :vartype trusted_access_role_bindings:
     azure.mgmt.containerservice.v2024_07_02_preview.operations.TrustedAccessRoleBindingsOperations
    :ivar load_balancers: LoadBalancersOperations operations
    :vartype load_balancers:
     azure.mgmt.containerservice.v2024_07_02_preview.operations.LoadBalancersOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.operations = Operations(
            self._client, self._config, self._serialize, self._deserialize, "2024-07-02-preview"
        )
