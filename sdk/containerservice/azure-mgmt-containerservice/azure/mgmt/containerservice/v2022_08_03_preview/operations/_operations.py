...
class Operations:
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.OperationValue"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2022_08_03_preview.models.OperationValue]
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2022-08-03-preview")
        )
