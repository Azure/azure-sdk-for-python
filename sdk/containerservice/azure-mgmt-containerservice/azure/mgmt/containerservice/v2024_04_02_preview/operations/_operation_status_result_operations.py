...
def build_list_request(
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2024-04-02-preview"))
...
def build_get_by_agent_pool_request(
...
class OperationStatusResultOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerservice.v2024_04_02_preview.ContainerServiceClient`'s
    ...
    def list(
        ...
        :return: An iterator like instance of either OperationStatusResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2024_04_02_preview.models.OperationStatusResult]
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version or "2024-04-02-preview")
        )
        cls: ClsType[_models.OperationStatusResultList] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("OperationStatusResultList", pipeline_response)
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2024_04_02_preview.models.OperationStatusResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def get_by_agent_pool(
        ...
        _request = build_get_by_agent_pool_request(
            resource_group_name=resource_group_name,
            resource_name=resource_name,
