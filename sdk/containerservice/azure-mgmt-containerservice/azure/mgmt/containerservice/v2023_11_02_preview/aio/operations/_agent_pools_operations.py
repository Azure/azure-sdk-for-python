...
class AgentPoolsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2023_11_02_preview.models.AgentPool or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either AgentPool or the result of
         cls(response)
        :rtype:
    ...
    async def begin_delete_machines(
        ...
        **kwargs: Any
        ...
        :type machines:
         ~azure.mgmt.containerservice.v2023_11_02_preview.models.AgentPoolDeleteMachinesParameter or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
