...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "identityBindingName": _SERIALIZER.url(
...
class IdentityBindingsOperations:
    ...
    def list_by_managed_cluster(
        ...
        :return: An iterator like instance of either IdentityBinding or the result of cls(response)
        ...
        cls: ClsType[_models.IdentityBindingListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("IdentityBindingListResult", pipeline_response)
    ...
    def get(
        ...
        :return: IdentityBinding or the result of cls(response)
    ...
    def _create_or_update_initial(
        ...
        parameters: Union[_models.IdentityBinding, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "IdentityBinding")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either IdentityBinding or the result of
         cls(response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.models.IdentityBinding or IO[bytes]
        :return: An instance of LROPoller that returns either IdentityBinding or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerservice.models.IdentityBinding]
        :raises ~azure.core.exceptions.HttpResponseError:
