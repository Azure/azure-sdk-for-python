...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ContainerService/locations/{location}/trustedAccessRoles")  # pylint: disable=line-too-long
...
class TrustedAccessRolesOperations(object):
    ...
    def list(
        ...
        location: str,
        **kwargs: Any
    ) -> Iterable["_models.TrustedAccessRoleListResult"]:
        ...
        :return: An iterator like instance of either TrustedAccessRoleListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerservice.v2022_05_02_preview.models.TrustedAccessRoleListResult]
