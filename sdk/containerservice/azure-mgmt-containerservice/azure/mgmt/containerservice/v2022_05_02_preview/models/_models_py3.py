...
class AzureKeyVaultKms(msrest.serialization.Model):
    ...
    :ivar key_vault_network_access: Network access of key vault. The possible values are ``Public``
     ...
     value is ``Public``. Known values are: "Public", "Private". Default value: "Public".
    ...
    def __init__(
        ...
        *,
        ...
        key_vault_network_access: Optional[Union[str, "_models.KeyVaultNetworkAccessTypes"]] = "Public",
        ...
        **kwargs
        ...
        :keyword key_vault_network_access: Network access of key vault. The possible values are
         ...
         default value is ``Public``. Known values are: "Public", "Private". Default value: "Public".
...
class ContainerServiceNetworkProfile(msrest.serialization.Model):
    ...
    :ivar network_plugin_mode: Network plugin mode used for building the Kubernetes network. Known
     values are: "Overlay".
...
class NetworkProfileForSnapshot(msrest.serialization.Model):
    ...
    :vartype network_plugin: str or
     ~azure.mgmt.containerservice.v2022_05_02_preview.models.NetworkPlugin
    :ivar network_plugin_mode: NetworkPluginMode for managed cluster snapshot. Known values are:
     "Overlay".
    :vartype network_plugin_mode: str or
     ~azure.mgmt.containerservice.v2022_05_02_preview.models.NetworkPluginMode
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype network_plugin: str or
         ~azure.mgmt.containerservice.v2022_05_02_preview.models.NetworkPlugin
        :keyword network_plugin_mode: NetworkPluginMode for managed cluster snapshot. Known values are:
         "Overlay".
        :paramtype network_plugin_mode: str or
         ~azure.mgmt.containerservice.v2022_05_02_preview.models.NetworkPluginMode
...
class TrustedAccessRoleBinding(Resource):
    ...
    :ivar provisioning_state: The current provisioning state of trusted access role binding. Known
     values are: "Succeeded", "Failed", "Updating", "Deleting".
    :vartype provisioning_state: str or
