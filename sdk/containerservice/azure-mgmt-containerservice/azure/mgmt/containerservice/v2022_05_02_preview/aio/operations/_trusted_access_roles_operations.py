...
class TrustedAccessRolesOperations:
    """TrustedAccessRolesOperations async operations.
    ...
    def list(
        ...
        location: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.TrustedAccessRoleListResult"]:
        ...
        :return: An iterator like instance of either TrustedAccessRoleListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2022_05_02_preview.models.TrustedAccessRoleListResult]
