...
class MachinesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2025_04_01.models.Machine]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2025_04_01.models.Machine
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
