...
class TrustedAccessRoleBindingsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either TrustedAccessRoleBinding or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2024_07_01.models.TrustedAccessRoleBinding]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerservice.v2024_07_01.models.TrustedAccessRoleBinding
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2024_07_01.models.TrustedAccessRoleBinding]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type trusted_access_role_binding:
         ~azure.mgmt.containerservice.v2024_07_01.models.TrustedAccessRoleBinding or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either TrustedAccessRoleBinding or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerservice.v2024_07_01.models.TrustedAccessRoleBinding]
