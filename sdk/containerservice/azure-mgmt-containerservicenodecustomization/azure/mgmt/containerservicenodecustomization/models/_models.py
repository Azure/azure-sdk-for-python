...
class NodeCustomization(TrackedResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class NodeCustomizationProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :ivar identity_profile: The identity used to execute node customization tasks during image
     build time and provisioning time. If not specified the default agentpool identity will be used.
...
class NodeCustomizationScript(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class NodeCustomizationUpdate(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class NodeCustomizationVersion(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
