...
# USAGE
    python api_management_create_api_tool.py
...
def main():
    ...
    response = client.api_tool.create_or_update(
...
# x-ms-original-file: specification/apimanagement/resource-manager/Microsoft.ApiManagement/ApiManagement/preview/2025-03-01-preview/examples/ApiManagementCreateApiTool.json
