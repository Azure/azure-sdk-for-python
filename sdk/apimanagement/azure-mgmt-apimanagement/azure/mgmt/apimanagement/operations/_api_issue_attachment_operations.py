...
class ApiIssueAttachmentOperations:
    ...
    def list_by_service(
        ...
        skip: Optional[int] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.IssueAttachmentContract"]:
    ...
    def create_or_update(
        ...
        issue_id: str,
        attachment_id: str,
        parameters: Union[_models.IssueAttachmentContract, IO[bytes]],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.IssueAttachmentContract:
        """Creates a new Attachment for the Issue in an API or updates an existing one.
        ...
        :param parameters: Create parameters. Is either a IssueAttachmentContract type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.apimanagement.models.IssueAttachmentContract or IO[bytes]
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        :return: IssueAttachmentContract or the result of cls(response)
