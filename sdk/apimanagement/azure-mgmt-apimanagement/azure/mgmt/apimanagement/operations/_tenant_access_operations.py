...
class TenantAccessOperations(object):
    ...
    def list_by_service(
        ...
        :rtype:
         ~azure.mgmt.apimanagement.models.AccessInformationContractPaged[~azure.mgmt.apimanagement.models.AccessInformationContract]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.AccessInformationContractPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def create(
            self, resource_group_name, service_name, parameters, access_name, if_match, custom_headers=None, raw=False, **operation_config):
        ...
        :param service_name: The name of the API Management service.
        :type service_name: str
        :param parameters: Parameters supplied to retrieve the Tenant Access
         Information.
        :type parameters:
         ~azure.mgmt.apimanagement.models.AccessInformationCreateParameters
        :param access_name: The identifier of the Access configuration.
         Possible values include: 'access', 'gitAccess'
        :type access_name: str or
         ~azure.mgmt.apimanagement.models.AccessIdName
    ...
    def update(
            self, resource_group_name, service_name, access_name, if_match, enabled=None, custom_headers=None, raw=False, **operation_config):
        """Update tenant access information details.
    ...
    def list_secrets(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: AccessInformationSecretsContract or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.apimanagement.models.AccessInformationSecretsContract or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.mgmt.apimanagement.models.ErrorResponseException>`
        """
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('AccessInformationSecretsContract', response)
            header_dict = {
                'ETag': 'str',
            }
