...
class NamedValueOperations(object):
    ...
    def list_by_service(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either NamedValueCollection or the result of cls(response)
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        body_content = self._serialize.body(parameters, 'NamedValueCreateContract')
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns either NamedValueContract or the result of cls(response)
    ...
    def list_value(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.list_value.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'serviceName': self._serialize.url("service_name", service_name, 'str', max_length=50, min_length=1, pattern=r'^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$'),
            'namedValueId': self._serialize.url("named_value_id", named_value_id, 'str', max_length=256, min_length=0, pattern=r'^[^*#&+:<>?]+$'),
    ...
    def _refresh_secret_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._refresh_secret_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'serviceName': self._serialize.url("service_name", service_name, 'str', max_length=50, min_length=1, pattern=r'^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$'),
            'namedValueId': self._serialize.url("named_value_id", named_value_id, 'str', max_length=256, min_length=0, pattern=r'^[^*#&+:<>?]+$'),
