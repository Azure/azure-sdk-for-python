...
def build_list_by_service_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users")  # pylint: disable=line-too-long
    ...
    if expand_groups is not None:
        _query_parameters['expandGroups'] = _SERIALIZER.query("expand_groups", expand_groups, 'bool')
...
def build_get_entity_tag_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serviceName": _SERIALIZER.url("service_name", service_name, 'str', max_length=50, min_length=1, pattern=r'^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$'),
...
def build_create_or_update_request(
    ...
    **kwargs: Any
    ...
    if notify is not None:
        _query_parameters['notify'] = _SERIALIZER.query("notify", notify, 'bool')
    _query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
...
def build_delete_request(
    ...
    **kwargs: Any
    ...
    if delete_subscriptions is not None:
        _query_parameters['deleteSubscriptions'] = _SERIALIZER.query("delete_subscriptions", delete_subscriptions, 'bool')
    if notify is not None:
        _query_parameters['notify'] = _SERIALIZER.query("notify", notify, 'bool')
    _query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
    if app_type is not None:
        _query_parameters['appType'] = _SERIALIZER.query("app_type", app_type, 'str')
...
def build_generate_sso_url_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}/generateSsoUrl")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serviceName": _SERIALIZER.url("service_name", service_name, 'str', max_length=50, min_length=1, pattern=r'^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$'),
        "userId": _SERIALIZER.url("user_id", user_id, 'str', max_length=80, min_length=1),
...
def build_get_shared_access_token_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}/token")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serviceName": _SERIALIZER.url("service_name", service_name, 'str', max_length=50, min_length=1, pattern=r'^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$'),
        "userId": _SERIALIZER.url("user_id", user_id, 'str', max_length=80, min_length=1),
