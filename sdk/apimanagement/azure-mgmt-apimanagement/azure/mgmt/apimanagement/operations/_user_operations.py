...
class UserOperations:
    ...
    def create_or_update(
        ...
        service_name: str,
        user_id: str,
        parameters: Union[_models.UserCreateParameters, IO[bytes]],
        notify: Optional[bool] = None,
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.UserContract:
        ...
        :type parameters: ~azure.mgmt.apimanagement.models.UserCreateParameters or IO[bytes]
        :param notify: Send an Email notification to the User. Default value is None.
        :type notify: bool
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
    ...
    def update(
        ...
        user_id: str,
        if_match: str,
        parameters: Union[_models.UserUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.UserContract:
        """Updates the details of the user specified by its identifier.
        ...
        :param parameters: Update parameters. Is either a UserUpdateParameters type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.apimanagement.models.UserUpdateParameters or IO[bytes]
        :return: UserContract or the result of cls(response)
        :rtype: ~azure.mgmt.apimanagement.models.UserContract
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def generate_sso_url(
        ...
        _request = build_generate_sso_url_request(
            resource_group_name=resource_group_name,
            service_name=service_name,
            user_id=user_id,
            subscription_id=self._config.subscription_id,
    ...
    def get_shared_access_token(
        ...
        service_name: str,
        user_id: str,
        parameters: Union[_models.UserTokenParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.UserTokenResult:
        """Gets the Shared Access Authorization Token for the User.
        ...
        :type parameters: ~azure.mgmt.apimanagement.models.UserTokenParameters or IO[bytes]
        :return: UserTokenResult or the result of cls(response)
        :rtype: ~azure.mgmt.apimanagement.models.UserTokenResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _request = build_get_shared_access_token_request(
            resource_group_name=resource_group_name,
            service_name=service_name,
            user_id=user_id,
            subscription_id=self._config.subscription_id,
