...
def build_list_by_service_request(
    ...
    **kwargs  # type: Any
    ...
    expand_groups = kwargs.pop('expand_groups', None)  # type: Optional[bool]

    api_version = "2021-08-01"
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users')
    ...
    if expand_groups is not None:
        query_parameters['expandGroups'] = _SERIALIZER.query("expand_groups", expand_groups, 'bool')
...
def build_get_entity_tag_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}')
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serviceName": _SERIALIZER.url("service_name", service_name, 'str', max_length=50, min_length=1, pattern=r'^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$'),
...
def build_create_or_update_request(
    ...
    **kwargs  # type: Any
    ...
    notify = kwargs.pop('notify', None)  # type: Optional[bool]
    ...
    if notify is not None:
        query_parameters['notify'] = _SERIALIZER.query("notify", notify, 'bool')
    query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
...
def build_delete_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    if_match = kwargs.pop('if_match')  # type: str
    delete_subscriptions = kwargs.pop('delete_subscriptions', None)  # type: Optional[bool]
    notify = kwargs.pop('notify', None)  # type: Optional[bool]
    app_type = kwargs.pop('app_type', None)  # type: Optional[Union[str, "_models.AppType"]]
    ...
    if delete_subscriptions is not None:
        query_parameters['deleteSubscriptions'] = _SERIALIZER.query("delete_subscriptions", delete_subscriptions, 'bool')
    if notify is not None:
        query_parameters['notify'] = _SERIALIZER.query("notify", notify, 'bool')
    query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
...
def build_generate_sso_url_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}/generateSsoUrl')
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serviceName": _SERIALIZER.url("service_name", service_name, 'str', max_length=50, min_length=1, pattern=r'^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$'),
        "userId": _SERIALIZER.url("user_id", user_id, 'str', max_length=80, min_length=1),
...
def build_get_shared_access_token_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}/token')
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serviceName": _SERIALIZER.url("service_name", service_name, 'str', max_length=50, min_length=1, pattern=r'^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$'),
        "userId": _SERIALIZER.url("user_id", user_id, 'str', max_length=80, min_length=1),
