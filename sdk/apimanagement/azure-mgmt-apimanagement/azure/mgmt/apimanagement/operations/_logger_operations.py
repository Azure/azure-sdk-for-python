...
class LoggerOperations(object):
    ...
    def list_by_service(
        ...
        if raw:
            header_dict = {}
        deserialized = models.LoggerContractPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def delete(
            self, resource_group_name, service_name, logger_id, if_match, custom_headers=None, raw=False, **operation_config):
