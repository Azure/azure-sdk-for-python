...
def build_list_by_tags_request(
    ...
    **kwargs: Any
    ...
    if include_not_tagged_products is not None:
        _params["includeNotTaggedProducts"] = _SERIALIZER.query(
            "include_not_tagged_products", include_not_tagged_products, "bool"
        )
    _params["api-version"] = _SERIALIZER.query("api_version", api_version, "str")
...
class ProductOperations:
    ...
    list_by_service.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products"
    }
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "ProductContract", is_xml=True)
