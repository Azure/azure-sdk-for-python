...
class GraphQLApiResolverOperations:
    ...
    def list_by_api(
        ...
        skip: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable["_models.ResolverContract"]:
        ...
        :return: An iterator like instance of either ResolverContract or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.ResolverContract]
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ResolverCollection", pipeline_response)
    ...
    list_by_api.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/resolvers"
    }
    ...
    get_entity_tag.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/resolvers/{resolverId}"
    }
    ...
    def get(
        ...
        :type resolver_id: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ResolverContract or the result of cls(response)
    ...
    def create_or_update(
        ...
        api_id: str,
        resolver_id: str,
        parameters: Union[_models.ResolverContract, IO],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.ResolverContract:
        """Creates a new resolver in the GraphQL API or updates an existing one.
        ...
        :param resolver_id: Resolver identifier within a GraphQL API. Must be unique in the current API
         Management service instance. Required.
        :type resolver_id: str
        :param parameters: Create parameters. Is either a ResolverContract type or a IO type. Required.
        :type parameters: ~azure.mgmt.apimanagement.models.ResolverContract or IO
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "ResolverContract", is_xml=True)
    ...
    def update(
        ...
        resolver_id: str,
        if_match: str,
        parameters: Union[_models.ResolverUpdateContract, IO],
        **kwargs: Any
    ) -> _models.ResolverContract:
        """Updates the details of the resolver in the GraphQL API specified by its identifier.
        ...
        :type parameters: ~azure.mgmt.apimanagement.models.ResolverUpdateContract or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
