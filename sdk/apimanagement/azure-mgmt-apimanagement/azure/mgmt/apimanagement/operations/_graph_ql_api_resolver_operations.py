...
class GraphQLApiResolverOperations:
    ...
    def list_by_api(
        ...
        skip: Optional[int] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.ResolverContract"]:
    ...
    def create_or_update(
        ...
        api_id: str,
        resolver_id: str,
        parameters: Union[_models.ResolverContract, IO[bytes]],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.ResolverContract:
        """Creates a new resolver in the GraphQL API or updates an existing one.
        ...
        :param parameters: Create parameters. Is either a ResolverContract type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.apimanagement.models.ResolverContract or IO[bytes]
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        :return: ResolverContract or the result of cls(response)
    ...
    def update(
        ...
        resolver_id: str,
        if_match: str,
        parameters: Union[_models.ResolverUpdateContract, IO[bytes]],
        **kwargs: Any
    ) -> _models.ResolverContract:
        """Updates the details of the resolver in the GraphQL API specified by its identifier.
        ...
        :type parameters: ~azure.mgmt.apimanagement.models.ResolverUpdateContract or IO[bytes]
        :return: ResolverContract or the result of cls(response)
        :rtype: ~azure.mgmt.apimanagement.models.ResolverContract
        :raises ~azure.core.exceptions.HttpResponseError:
        """
