...
class ApiManagementClientOperationsMixin(object):
    ...
    def _perform_connectivity_check_async_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._perform_connectivity_check_async_initial.metadata['url']  # type: ignore
        ...
        body_content = self._serialize.body(connectivity_check_request_params, 'ConnectivityCheckRequest')
