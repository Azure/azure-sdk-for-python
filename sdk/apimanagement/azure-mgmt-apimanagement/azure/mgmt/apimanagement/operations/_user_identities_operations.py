...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}/identities")  # pylint: disable=line-too-long
...
class UserIdentitiesOperations(object):
    ...
    def list(
        ...
        user_id: str,
        **kwargs: Any
    ) -> Iterable["_models.UserIdentityCollection"]:
        ...
        :return: An iterator like instance of either UserIdentityCollection or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.UserIdentityCollection]
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("UserIdentityCollection", pipeline_response)
