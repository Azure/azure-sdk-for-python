...
class UserIdentitiesOperations:
    ...
    def list(
    ...
    ) -> ItemPaged["_models.UserIdentityContract"]:
        ...
        :param user_id: User identifier. Must be unique in the current API Management service instance.
         Required.
        :type user_id: str
        :return: An iterator like instance of either UserIdentityContract or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.UserIdentityContract]
