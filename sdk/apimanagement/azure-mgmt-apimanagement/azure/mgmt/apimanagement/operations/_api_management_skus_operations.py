...
class ApiManagementSkusOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ApiManagementSkusResult"]
        """Gets the list of Microsoft.ApiManagement SKUs available for your Subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ApiManagementSkusResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.ApiManagementSkusResult]
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('ApiManagementSkusResult', pipeline_response)
