...
class ApiManagementSkusOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.ApiManagementSku"]:
        """Gets the list of Microsoft.ApiManagement SKUs available for your Subscription.

        :return: An iterator like instance of either ApiManagementSku or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.ApiManagementSku]
