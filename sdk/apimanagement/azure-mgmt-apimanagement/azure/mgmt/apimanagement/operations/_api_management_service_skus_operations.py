...
class ApiManagementServiceSkusOperations:
    ...
    def list_available_service_skus(
    ...
    ) -> Iterable["_models.ResourceSkuResult"]:
        ...
        :return: An iterator like instance of either ResourceSkuResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.ResourceSkuResult]
    ...
    list_available_service_skus.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/skus"
    }
