...
def build_update_request(
    resource_group_name: str, service_name: str, subscription_id: str, *, if_match: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_create_or_update_request(
    resource_group_name: str, service_name: str, subscription_id: str, *, if_match: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DelegationSettingsOperations:
    ...
    @distributed_trace
    def get_entity_tag(self, resource_group_name: str, service_name: str, **kwargs: Any) -> bool:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, service_name: str, **kwargs: Any) -> _models.PortalDelegationSettings:
    ...
    def update(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param if_match: ETag of the Entity. ETag should match the current entity state from the header
         response of the GET request or it should be * for unconditional update. Required.
        :type if_match: str
        :param parameters: Update Delegation settings. Is either a model type or a IO type. Required.
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "PortalDelegationSettings", is_xml=True)
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param service_name: The name of the API Management service. Required.
        :type service_name: str
        :param parameters: Create or update parameters. Is either a model type or a IO type. Required.
        :type parameters: ~azure.mgmt.apimanagement.models.PortalDelegationSettings or IO
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
    ...
    create_or_update.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/portalsettings/delegation"}  # type: ignore
