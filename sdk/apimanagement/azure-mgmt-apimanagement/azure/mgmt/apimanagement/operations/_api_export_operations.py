...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    format = kwargs.pop('format')  # type: Union[str, "_models.ExportFormat"]
    export = kwargs.pop('export')  # type: Union[str, "_models.ExportApi"]

    api_version = "2021-08-01"
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}')
    ...
    query_parameters['export'] = _SERIALIZER.query("export", export, 'str')
