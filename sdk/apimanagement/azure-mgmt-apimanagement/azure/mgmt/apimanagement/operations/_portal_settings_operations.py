...
def build_list_by_service_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/portalsettings')
...
# fmt: on
class PortalSettingsOperations(object):
    ...
    def list_by_service(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.PortalSettingsCollection"
