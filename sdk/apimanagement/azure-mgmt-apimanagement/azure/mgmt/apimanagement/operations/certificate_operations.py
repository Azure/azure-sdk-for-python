...
class CertificateOperations(object):
    ...
    def list_by_service(
        ...
        deserialized = models.CertificateContractPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.CertificateContractPaged(internal_paging, self._deserialize.dependencies, header_dict)
