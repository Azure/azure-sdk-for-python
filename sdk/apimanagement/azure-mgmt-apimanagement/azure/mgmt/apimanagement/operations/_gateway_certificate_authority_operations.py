...
class GatewayCertificateAuthorityOperations:
    ...
    def list_by_service(
        ...
        skip: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable["_models.GatewayCertificateAuthorityContract"]:
        ...
        :return: An iterator like instance of either GatewayCertificateAuthorityContract or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.GatewayCertificateAuthorityContract]
    ...
    list_by_service.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/gateways/{gatewayId}/certificateAuthorities"
    }
    ...
    get_entity_tag.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/gateways/{gatewayId}/certificateAuthorities/{certificateId}"
    }
    ...
    def create_or_update(
        ...
        gateway_id: str,
        certificate_id: str,
        parameters: Union[_models.GatewayCertificateAuthorityContract, IO],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.GatewayCertificateAuthorityContract:
        """Assign Certificate entity to Gateway entity as Certificate Authority.
        ...
        :param certificate_id: Identifier of the certificate entity. Must be unique in the current API
         Management service instance. Required.
        :type certificate_id: str
        :param parameters: Is either a GatewayCertificateAuthorityContract type or a IO type. Required.
        :type parameters: ~azure.mgmt.apimanagement.models.GatewayCertificateAuthorityContract or IO
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "GatewayCertificateAuthorityContract", is_xml=True)
