...
class GatewayOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        body_content = self._serialize.body(_parameters, 'GatewayContract')
    ...
    def regenerate_key(
        ...
        **kwargs  # type: Any
        ...
        :param gateway_id: Gateway entity identifier. Must be unique in the current API Management
         service instance. Must not have value 'managed'.
        :type gateway_id: str
        :param key_type: The Key being regenerated.
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'GatewayKeyRegenerationRequestContract')
        body_content_kwargs['content'] = body_content
    ...
    def generate_token(
        ...
        **kwargs  # type: Any
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'GatewayTokenRequestContract')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
