...
def build_update_request(
    resource_group_name: str, service_name: str, gateway_id: str, subscription_id: str, *, if_match: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class GatewayOperations:
    ...
    def list_by_service(
        ...
        skip: Optional[int] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.GatewayContract"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.GatewayContract]
    ...
    @distributed_trace
    def get_entity_tag(self, resource_group_name: str, service_name: str, gateway_id: str, **kwargs: Any) -> bool:
    ...
    def create_or_update(
        ...
        service_name: str,
        gateway_id: str,
        parameters: Union[_models.GatewayContract, IO[bytes]],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.GatewayContract:
        """Creates or updates a Gateway to be used in Api Management instance.
        ...
        :type parameters: ~azure.mgmt.apimanagement.models.GatewayContract or IO[bytes]
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        :return: GatewayContract or the result of cls(response)
    ...
    def regenerate_key(  # pylint: disable=inconsistent-return-statements
        ...
        service_name: str,
        gateway_id: str,
        parameters: Union[_models.GatewayKeyRegenerationRequestContract, IO[bytes]],
        **kwargs: Any
    ) -> None:
        """Regenerates specified gateway key invalidating any tokens created with it.
    ...
    def generate_token(
        ...
        service_name: str,
        gateway_id: str,
        parameters: Union[_models.GatewayTokenRequestContract, IO[bytes]],
        **kwargs: Any
    ) -> _models.GatewayTokenContract:
        """Gets the Shared Access Authorization Token for the gateway.
        ...
        :type parameters: ~azure.mgmt.apimanagement.models.GatewayTokenRequestContract or IO[bytes]
        :return: GatewayTokenContract or the result of cls(response)
        :rtype: ~azure.mgmt.apimanagement.models.GatewayTokenContract
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _request = build_generate_token_request(
            resource_group_name=resource_group_name,
            service_name=service_name,
            gateway_id=gateway_id,
            subscription_id=self._config.subscription_id,
