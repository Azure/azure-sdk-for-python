...
class AuthorizationServerOperations(object):
    ...
    def list_secrets(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: AuthorizationServerSecretsContract or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.apimanagement.models.AuthorizationServerSecretsContract or
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('AuthorizationServerSecretsContract', response)
            header_dict = {
                'ETag': 'str',
            }
