...
def build_list_by_service_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/regions')
...
class RegionOperations(object):
    ...
    def list_by_service(
        ...
        service_name: str,
        **kwargs: Any
    ) -> Iterable["_models.RegionListResult"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~api_management_client.models.RegionListResult]
