...
def build_get_entity_state_by_api_request(
    resource_group_name: str, service_name: str, api_id: str, tag_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_entity_state_request(
    resource_group_name: str, service_name: str, tag_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(
    resource_group_name: str, service_name: str, tag_id: str, subscription_id: str, *, if_match: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class TagOperations:  # pylint: disable=too-many-public-methods
    ...
    def assign_to_operation(
        ...
        _request = build_assign_to_operation_request(
            resource_group_name=resource_group_name,
            service_name=service_name,
            api_id=api_id,
            operation_id=operation_id,
    ...
    def detach_from_operation(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_detach_from_operation_request(
            resource_group_name=resource_group_name,
            service_name=service_name,
            api_id=api_id,
            operation_id=operation_id,
    ...
    def get_entity_state_by_api(
        ...
        _request = build_get_entity_state_by_api_request(
            resource_group_name=resource_group_name,
            service_name=service_name,
            api_id=api_id,
            tag_id=tag_id,
    ...
    def get_by_api(
        ...
        _request = build_get_by_api_request(
            resource_group_name=resource_group_name,
            service_name=service_name,
            api_id=api_id,
            tag_id=tag_id,
    ...
    def detach_from_api(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_detach_from_api_request(
            resource_group_name=resource_group_name,
            service_name=service_name,
            api_id=api_id,
            tag_id=tag_id,
    ...
    def get_entity_state_by_product(
        ...
        _request = build_get_entity_state_by_product_request(
            resource_group_name=resource_group_name,
            service_name=service_name,
            product_id=product_id,
            tag_id=tag_id,
    ...
    def get_by_product(
        ...
        _request = build_get_by_product_request(
            resource_group_name=resource_group_name,
            service_name=service_name,
            product_id=product_id,
            tag_id=tag_id,
    ...
    def assign_to_product(
        ...
        _request = build_assign_to_product_request(
            resource_group_name=resource_group_name,
            service_name=service_name,
            product_id=product_id,
            tag_id=tag_id,
    ...
    def detach_from_product(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_detach_from_product_request(
            resource_group_name=resource_group_name,
            service_name=service_name,
            product_id=product_id,
            tag_id=tag_id,
    ...
    @distributed_trace
    def get_entity_state(self, resource_group_name: str, service_name: str, tag_id: str, **kwargs: Any) -> bool:
        """Gets the entity state version of the tag specified by its identifier.
    ...
    @distributed_trace
    def get(self, resource_group_name: str, service_name: str, tag_id: str, **kwargs: Any) -> _models.TagContract:
