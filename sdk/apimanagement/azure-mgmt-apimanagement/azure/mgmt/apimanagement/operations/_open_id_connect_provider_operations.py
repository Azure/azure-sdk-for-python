...
def build_get_entity_tag_request(
    resource_group_name: str, service_name: str, opid: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(
    resource_group_name: str, service_name: str, opid: str, subscription_id: str, *, if_match: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class OpenIdConnectProviderOperations:
    ...
    def list_by_service(
        ...
        skip: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable["_models.OpenidConnectProviderContract"]:
        ...
        :return: An iterator like instance of either OpenidConnectProviderContract or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.OpenidConnectProviderContract]
    ...
    list_by_service.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/openidConnectProviders"
    }

    @distributed_trace
    def get_entity_tag(self, resource_group_name: str, service_name: str, opid: str, **kwargs: Any) -> bool:
    ...
    def create_or_update(
        ...
        service_name: str,
        opid: str,
        parameters: Union[_models.OpenidConnectProviderContract, IO],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.OpenidConnectProviderContract:
        """Creates or updates the OpenID Connect Provider.
        ...
        :param opid: Identifier of the OpenID Connect Provider. Required.
        :type opid: str
        :param parameters: Create parameters. Is either a OpenidConnectProviderContract type or a IO
         type. Required.
        :type parameters: ~azure.mgmt.apimanagement.models.OpenidConnectProviderContract or IO
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "OpenidConnectProviderContract", is_xml=True)
    ...
    def update(
        ...
        opid: str,
        if_match: str,
        parameters: Union[_models.OpenidConnectProviderUpdateContract, IO],
        **kwargs: Any
    ) -> _models.OpenidConnectProviderContract:
        """Updates the specific OpenID Connect Provider.
        ...
        :param parameters: Update parameters. Is either a OpenidConnectProviderUpdateContract type or a
         IO type. Required.
        :type parameters: ~azure.mgmt.apimanagement.models.OpenidConnectProviderUpdateContract or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_secrets.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/openidConnectProviders/{opid}/listSecrets"
    }
