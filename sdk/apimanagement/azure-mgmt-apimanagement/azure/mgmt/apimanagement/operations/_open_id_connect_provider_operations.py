...
class OpenIdConnectProviderOperations:
    ...
    def list_by_service(
        ...
        skip: Optional[int] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.OpenidConnectProviderContract"]:
    ...
    def create_or_update(
        ...
        service_name: str,
        opid: str,
        parameters: Union[_models.OpenidConnectProviderContract, IO[bytes]],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.OpenidConnectProviderContract:
        """Creates or updates the OpenID Connect Provider.
        ...
        :type parameters: ~azure.mgmt.apimanagement.models.OpenidConnectProviderContract or IO[bytes]
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        :return: OpenidConnectProviderContract or the result of cls(response)
    ...
    def update(
        ...
        opid: str,
        if_match: str,
        parameters: Union[_models.OpenidConnectProviderUpdateContract, IO[bytes]],
        **kwargs: Any
    ) -> _models.OpenidConnectProviderContract:
        """Updates the specific OpenID Connect Provider.
