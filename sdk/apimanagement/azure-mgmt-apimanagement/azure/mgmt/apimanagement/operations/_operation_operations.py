...
def build_list_by_tags_request(
    ...
    **kwargs  # type: Any
    ...
    include_not_tagged_operations = kwargs.pop('include_not_tagged_operations', None)  # type: Optional[bool]

    api_version = "2021-08-01"
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/operationsByTags')
    ...
    if include_not_tagged_operations is not None:
        query_parameters['includeNotTaggedOperations'] = _SERIALIZER.query("include_not_tagged_operations", include_not_tagged_operations, 'bool')
...
class OperationOperations(object):
    ...
    def list_by_tags(
        ...
        include_not_tagged_operations=None,  # type: Optional[bool]
        **kwargs  # type: Any
    ):
    ...
    list_by_tags.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/operationsByTags'}  # type: ignore
