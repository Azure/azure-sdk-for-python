...
class CertificateOperations(object):
    ...
    def list_by_service(
        ...
        :param is_key_vault_refresh_failed: When set to true, the response
         contains only certificates entities which failed refresh.
    ...
    def create_or_update(
            self, resource_group_name, service_name, certificate_id, parameters, if_match=None, custom_headers=None, raw=False, **operation_config):
        ...
        :type parameters:
         ~azure.mgmt.apimanagement.models.CertificateCreateOrUpdateParameters
    ...
    def refresh_secret(
            self, resource_group_name, service_name, certificate_id, custom_headers=None, raw=False, **operation_config):
        """From KeyVault, Refresh the certificate being used for authentication
        with the backend.
