...
class DeletedServicesOperations(object):
    ...
    def purge(
            self, service_name, location, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :return: An instance of LROPoller that returns DeletedServiceContract
         or ClientRawResponse<DeletedServiceContract> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.apimanagement.models.DeletedServiceContract]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.apimanagement.models.DeletedServiceContract]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.apimanagement.models.ErrorResponseException>`
        """
