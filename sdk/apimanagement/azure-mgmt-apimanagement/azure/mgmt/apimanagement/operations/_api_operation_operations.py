...
class ApiOperationOperations(object):
    ...
    def list_by_api(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.OperationCollection"]
    ...
    def create_or_update(
        ...
        api_id,  # type: str
        operation_id,  # type: str
        parameters,  # type: "models.OperationContract"
    ...
    def update(
        ...
        operation_id,  # type: str
        if_match,  # type: str
        parameters,  # type: "models.OperationUpdateContract"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.OperationContract"
