...
def build_list_by_api_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/operations')
...
def build_get_entity_tag_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/operations/{operationId}')
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serviceName": _SERIALIZER.url("service_name", service_name, 'str', max_length=50, min_length=1, pattern=r'^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$'),
        "apiId": _SERIALIZER.url("api_id", api_id, 'str', max_length=256, min_length=1, pattern=r'^[^*#&+:<>?]+$'),
...
class ApiOperationOperations(object):
    ...
    def list_by_api(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.OperationCollection"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.OperationCollection]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.OperationContract"
    ...
    def create_or_update(
        ...
        api_id,  # type: str
        operation_id,  # type: str
        parameters,  # type: "_models.OperationContract"
    ...
    def update(
        ...
        operation_id,  # type: str
        if_match,  # type: str
        parameters,  # type: "_models.OperationUpdateContract"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.OperationContract"
