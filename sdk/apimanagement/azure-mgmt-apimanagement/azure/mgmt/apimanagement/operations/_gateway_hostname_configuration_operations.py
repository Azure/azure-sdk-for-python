...
def build_get_entity_tag_request(
    resource_group_name: str, service_name: str, gateway_id: str, hc_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class GatewayHostnameConfigurationOperations:
    ...
    def list_by_service(
        ...
        skip: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable["_models.GatewayHostnameConfigurationContract"]:
        ...
        :return: An iterator like instance of either GatewayHostnameConfigurationContract or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.GatewayHostnameConfigurationContract]
    ...
    list_by_service.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/gateways/{gatewayId}/hostnameConfigurations"
    }
    ...
    get_entity_tag.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/gateways/{gatewayId}/hostnameConfigurations/{hcId}"
    }
    ...
    def create_or_update(
        ...
        gateway_id: str,
        hc_id: str,
        parameters: Union[_models.GatewayHostnameConfigurationContract, IO],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.GatewayHostnameConfigurationContract:
        """Creates of updates hostname configuration for a Gateway.
        ...
        :param hc_id: Gateway hostname configuration identifier. Must be unique in the scope of parent
         Gateway entity. Required.
        :type hc_id: str
        :param parameters: Is either a GatewayHostnameConfigurationContract type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.apimanagement.models.GatewayHostnameConfigurationContract or IO
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "GatewayHostnameConfigurationContract", is_xml=True)
