...
def build_list_by_service_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    scope = kwargs.pop('scope', None)  # type: Optional[Union[str, "_models.PolicyScopeContract"]]
...
class PolicyDescriptionOperations(object):
    ...
    def list_by_service(
        ...
        resource_group_name,  # type: str
        service_name,  # type: str
        scope=None,  # type: Optional[Union[str, "_models.PolicyScopeContract"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.PolicyDescriptionCollection"
