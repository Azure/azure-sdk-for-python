...
class TenantAccessGitOperations(object):
    ...
    def regenerate_primary_key(
            self, resource_group_name, service_name, access_name, custom_headers=None, raw=False, **operation_config):
        ...
        :type access_name: str or
         ~azure.mgmt.apimanagement.models.AccessIdName
