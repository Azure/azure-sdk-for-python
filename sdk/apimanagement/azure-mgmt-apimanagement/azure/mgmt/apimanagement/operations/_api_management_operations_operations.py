...
def build_list_request(
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.ApiManagement/operations')
...
# fmt: on
class ApiManagementOperationsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.OperationListResult]
