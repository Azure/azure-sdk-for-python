...
class BackendOperations(object):
    ...
    def list_by_service(
        ...
        :param filter: |     Field     |     Usage     |     Supported
         ...
         substringof, contains, startswith, endswith |</br>| url | filter | ge,
        ...
        :rtype:
         ~azure.mgmt.apimanagement.models.BackendContractPaged[~azure.mgmt.apimanagement.models.BackendContract]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.BackendContractPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: BackendContract or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.apimanagement.models.BackendContract or
    ...
    def reconnect(
        ...
        if after is not None:
            parameters = models.BackendReconnectContract(after=after)
