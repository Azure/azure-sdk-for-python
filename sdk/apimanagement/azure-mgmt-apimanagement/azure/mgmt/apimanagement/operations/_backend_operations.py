...
def build_get_entity_tag_request(
    resource_group_name: str, service_name: str, backend_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(
    resource_group_name: str, service_name: str, backend_id: str, subscription_id: str, *, if_match: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class BackendOperations:
    ...
    def reconnect(  # pylint: disable=inconsistent-return-statements
        ...
        service_name: str,
        backend_id: str,
        parameters: Optional[Union[_models.BackendReconnectContract, IO[bytes]]] = None,
        **kwargs: Any
    ) -> None:
        """Notifies the API Management gateway to create a new connection to the backend after the
        specified timeout. If no timeout was specified, timeout of 2 minutes is used.
        ...
        :type parameters: ~azure.mgmt.apimanagement.models.BackendReconnectContract or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _request = build_reconnect_request(
            resource_group_name=resource_group_name,
            service_name=service_name,
            backend_id=backend_id,
            subscription_id=self._config.subscription_id,
