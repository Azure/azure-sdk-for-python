...
class AuthorizationAccessPolicyOperations:
    ...
    def list_by_authorization(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.AuthorizationAccessPolicyContract"]:
        ...
        :return: An iterator like instance of either AuthorizationAccessPolicyContract or the result of
         cls(response)
        :rtype:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_authorization_request(
                    ...
                    template_url=self.list_by_authorization.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("AuthorizationAccessPolicyCollection", pipeline_response)
    ...
    list_by_authorization.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/authorizationProviders/{authorizationProviderId}/authorizations/{authorizationId}/accessPolicies"
    }
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AuthorizationAccessPolicyContract or the result of cls(response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/authorizationProviders/{authorizationProviderId}/authorizations/{authorizationId}/accessPolicies/{authorizationAccessPolicyId}"
    }
    ...
    async def create_or_update(
        ...
        authorization_id: str,
        authorization_access_policy_id: str,
        parameters: Union[_models.AuthorizationAccessPolicyContract, IO],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.AuthorizationAccessPolicyContract:
        """Creates or updates Authorization Access Policy.
        ...
        :param parameters: Create parameters. Is either a AuthorizationAccessPolicyContract type or a
         IO type. Required.
        :type parameters: ~azure.mgmt.apimanagement.models.AuthorizationAccessPolicyContract or IO
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "AuthorizationAccessPolicyContract", is_xml=True)
