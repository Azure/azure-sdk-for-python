...
from ...operations._client_application_product_link_operations import (
    build_create_request,
    build_delete_request,
    build_get_request,
    build_list_by_client_applications_request,
)
...
class ClientApplicationProductLinkOperations:
    ...
    def list_by_client_applications(
        ...
        **kwargs: Any
        ...
        :type skip: int
        :return: An iterator like instance of either ClientApplicationProductLinkContract or the result
         of cls(response)
        :rtype:
        ...
        cls: ClsType[_models.ClientApplicationProductLinkCollection] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_client_applications_request(
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("ClientApplicationProductLinkCollection", pipeline_response)
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :return: ClientApplicationProductLinkContract or the result of cls(response)
        ...
        deserialized = self._deserialize("ClientApplicationProductLinkContract", pipeline_response.http_response)
    ...
    async def create(
        ...
        client_application_id: str,
        client_application_product_link_id: str,
        parameters: Union[_models.ClientApplicationProductLinkContract, IO[bytes]],
        **kwargs: Any
    ) -> _models.ClientApplicationProductLinkContract:
        """Adds an Product to the specified Client Application via link.
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "ClientApplicationProductLinkContract")
