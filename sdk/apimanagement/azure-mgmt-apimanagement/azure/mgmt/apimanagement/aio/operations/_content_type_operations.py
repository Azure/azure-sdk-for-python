...
class ContentTypeOperations:
    ...
    list_by_service.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/contentTypes"
    }
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/contentTypes/{contentTypeId}"
    }
    ...
    async def create_or_update(
        ...
        service_name: str,
        content_type_id: str,
        parameters: Union[_models.ContentTypeContract, IO],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.ContentTypeContract:
        """Creates or updates the developer portal's content type. Content types describe content items'
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "ContentTypeContract", is_xml=True)
