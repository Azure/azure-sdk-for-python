...
class PortalConfigOperations:
    ...
    get_entity_tag.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/portalconfigs/{portalConfigId}"
    }
    ...
    async def update(
        ...
        portal_config_id: str,
        if_match: str,
        parameters: Union[_models.PortalConfigContract, IO],
        **kwargs: Any
    ) -> _models.PortalConfigContract:
        """Update the developer portal configuration.
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "PortalConfigContract", is_xml=True)
