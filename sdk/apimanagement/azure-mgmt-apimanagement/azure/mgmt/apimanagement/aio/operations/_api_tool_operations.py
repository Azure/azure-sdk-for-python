...
from ...operations._api_tool_operations import (
...
class ApiToolOperations:
    ...
    def list_by_api(
        ...
        **kwargs: Any
        ...
        :type skip: int
        :return: An iterator like instance of either ToolContract or the result of cls(response)
        ...
        cls: ClsType[_models.ToolCollection] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("ToolCollection", pipeline_response)
    ...
    async def get(
        ...
        :param tool_id: Tool identifier within an API. Must be unique in the current API Management
         service instance. Required.
        :type tool_id: str
        :return: ToolContract or the result of cls(response)
        ...
        deserialized = self._deserialize("ToolContract", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        api_id: str,
        tool_id: str,
        parameters: Union[_models.ToolContract, IO[bytes]],
        **kwargs: Any
    ) -> _models.ToolContract:
        """Creates a new tool in the API or updates an existing one.
        ...
        :param parameters: Create parameters. Is either a ToolContract type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.apimanagement.models.ToolContract or IO[bytes]
        :return: ToolContract or the result of cls(response)
        :rtype: ~azure.mgmt.apimanagement.models.ToolContract
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "ToolContract")
