...
class TenantAccessOperations:
    ...
    async def get_entity_tag(
        ...
        service_name: str,
        access_name: Union[str, "models.AccessIdName"],
        **kwargs
    ) -> bool:
    ...
    async def get(
        ...
        access_name: Union[str, "models.AccessIdName"],
        **kwargs
    ) -> "models.AccessInformationContract":
    ...
    async def update(
        ...
        **kwargs
        ...
        body_content = self._serialize.body(_parameters, 'AccessInformationUpdateParameters')
