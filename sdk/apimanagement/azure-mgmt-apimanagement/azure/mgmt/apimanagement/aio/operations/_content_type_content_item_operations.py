...
class ContentTypeContentItemOperations:
    """ContentTypeContentItemOperations async operations.
    ...
    def list_by_service(
        ...
        content_type_id: str,
        **kwargs
    ) -> AsyncIterable["models.ContentItemCollection"]:
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ContentItemCollection"]
        error_map = {
    ...
    async def get(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ContentItemContract"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
