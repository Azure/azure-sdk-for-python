...
class PortalSettingsOperations:
    """PortalSettingsOperations async operations.
    ...
    async def list_by_service(
        ...
        **kwargs: Any
        ...
        :rtype: ~api_management_client.models.PortalSettingsCollection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PortalSettingsCollection"]
        error_map = {
