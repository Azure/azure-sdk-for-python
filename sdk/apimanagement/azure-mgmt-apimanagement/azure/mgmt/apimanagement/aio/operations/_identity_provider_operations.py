...
class IdentityProviderOperations:
    ...
    ) -> AsyncIterable["_models.IdentityProviderContract"]:
    ...
    async def create_or_update(
        ...
        service_name: str,
        identity_provider_name: Union[str, _models.IdentityProviderType],
        parameters: Union[_models.IdentityProviderCreateContract, IO[bytes]],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.IdentityProviderContract:
        """Creates or Updates the IdentityProvider configuration.
        ...
        :type parameters: ~azure.mgmt.apimanagement.models.IdentityProviderCreateContract or IO[bytes]
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        :return: IdentityProviderContract or the result of cls(response)
    ...
    async def update(
        ...
        identity_provider_name: Union[str, _models.IdentityProviderType],
        if_match: str,
        parameters: Union[_models.IdentityProviderUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.IdentityProviderContract:
        """Updates an existing IdentityProvider configuration.
