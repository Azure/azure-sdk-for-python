...
from ...operations._client_application_operations import (
...
class ClientApplicationOperations:
    ...
    def list_by_service(
        ...
        **kwargs: Any
        ...
        :type skip: int
        :return: An iterator like instance of either ClientApplicationContract or the result of
         cls(response)
        :rtype:
        ...
        cls: ClsType[_models.ClientApplicationCollection] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("ClientApplicationCollection", pipeline_response)
    ...
    async def get(
        ...
        :param client_application_id: Client Application identifier. Must be unique in the current API
         Management service instance. Required.
        :type client_application_id: str
        :return: ClientApplicationContract or the result of cls(response)
        ...
        deserialized = self._deserialize("ClientApplicationContract", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        service_name: str,
        client_application_id: str,
        parameters: Union[_models.ClientApplicationContract, IO[bytes]],
        **kwargs: Any
    ) -> _models.ClientApplicationContract:
        """Creates or Updates a client application.
        ...
        :type parameters: ~azure.mgmt.apimanagement.models.ClientApplicationContract or IO[bytes]
        :return: ClientApplicationContract or the result of cls(response)
        :rtype: ~azure.mgmt.apimanagement.models.ClientApplicationContract
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "ClientApplicationContract")
    ...
    async def list_secrets(
        ...
        :param client_application_id: Client Application identifier. Must be unique in the current API
         Management service instance. Required.
        :type client_application_id: str
        :return: ClientApplicationSecretsContract or the result of cls(response)
        ...
        deserialized = self._deserialize("ClientApplicationSecretsContract", pipeline_response.http_response)
