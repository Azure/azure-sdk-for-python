...
class ApiIssueCommentOperations:
    ...
    def list_by_service(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.IssueCommentContract"]:
    ...
    async def create_or_update(
        ...
        issue_id: str,
        comment_id: str,
        parameters: Union[_models.IssueCommentContract, IO[bytes]],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.IssueCommentContract:
        """Creates a new Comment for the Issue in an API or updates an existing one.
        ...
        :param parameters: Create parameters. Is either a IssueCommentContract type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.apimanagement.models.IssueCommentContract or IO[bytes]
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        :return: IssueCommentContract or the result of cls(response)
