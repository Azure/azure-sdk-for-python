...
from ...operations._api_gateway_hostname_binding_operations import (
...
class ApiGatewayHostnameBindingOperations:
    ...
    def list_by_gateway(
        ...
        :return: An iterator like instance of either GatewayHostnameBindingResource or the result of
         cls(response)
        :rtype:
        ...
        cls: ClsType[_models.GatewayHostnameBindingListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("GatewayHostnameBindingListResult", pipeline_response)
    ...
    async def get(
        ...
        :return: GatewayHostnameBindingResource or the result of cls(response)
        ...
        deserialized = self._deserialize("GatewayHostnameBindingResource", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        parameters: Union[_models.GatewayHostnameBindingResource, IO[bytes]],
        ...
        **kwargs: Any
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "GatewayHostnameBindingResource")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either GatewayHostnameBindingResource or
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the CreateOrUpdate API Management gateway hostname
         ...
         Required.
        :type parameters: ~azure.mgmt.apimanagement.models.GatewayHostnameBindingResource or IO[bytes]
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        :return: An instance of AsyncLROPoller that returns either GatewayHostnameBindingResource or
    ...
    async def _delete_initial(
        self, resource_group_name: str, gateway_name: str, hostname_binding_name: str, if_match: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
