...
class ApiTagDescriptionOperations:
    ...
    async def create_or_update(
        ...
        api_id: str,
        tag_description_id: str,
        parameters: Union[_models.TagDescriptionCreateParameters, IO[bytes]],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.TagDescriptionContract:
        """Create/Update tag description in scope of the Api.
        ...
        :type parameters: ~azure.mgmt.apimanagement.models.TagDescriptionCreateParameters or IO[bytes]
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        :return: TagDescriptionContract or the result of cls(response)
