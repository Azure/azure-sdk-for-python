...
class ApiProductOperations:
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_apis_request(
                    ...
                    template_url=self.list_by_apis.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
    ...
    list_by_apis.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/products"
    }
