...
from ...operations._api_issue_attachment_operations import build_create_or_update_request, build_delete_request, build_get_entity_tag_request, build_get_request, build_list_by_service_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class ApiIssueAttachmentOperations:
    """ApiIssueAttachmentOperations async operations.
    ...
    def list_by_service(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either IssueAttachmentCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~api_management_client.models.IssueAttachmentCollection]
