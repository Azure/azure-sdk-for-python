...
class ApiIssueOperations:
    ...
    def list_by_service(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.IssueContract"]:
    ...
    async def create_or_update(
        ...
        api_id: str,
        issue_id: str,
        parameters: Union[_models.IssueContract, IO[bytes]],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.IssueContract:
        """Creates a new Issue for an API or updates an existing one.
        ...
        :param parameters: Create parameters. Is either a IssueContract type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.apimanagement.models.IssueContract or IO[bytes]
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        :return: IssueContract or the result of cls(response)
    ...
    async def update(
        ...
        issue_id: str,
        if_match: str,
        parameters: Union[_models.IssueUpdateContract, IO[bytes]],
        **kwargs: Any
    ) -> _models.IssueContract:
        """Updates an existing issue for an API.
        ...
        :param parameters: Update parameters. Is either a IssueUpdateContract type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.apimanagement.models.IssueUpdateContract or IO[bytes]
        :return: IssueContract or the result of cls(response)
        :rtype: ~azure.mgmt.apimanagement.models.IssueContract
        :raises ~azure.core.exceptions.HttpResponseError:
        """
