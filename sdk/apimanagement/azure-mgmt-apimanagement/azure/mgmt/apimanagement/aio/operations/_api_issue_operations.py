...
class ApiIssueOperations:
    ...
    async def create_or_update(
        ...
        api_id: str,
        issue_id: str,
        parameters: Union[_models.IssueContract, IO],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.IssueContract:
        """Creates a new Issue for an API or updates an existing one.
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "IssueContract", is_xml=True)
    ...
    async def update(
        ...
        issue_id: str,
        if_match: str,
        parameters: Union[_models.IssueUpdateContract, IO],
        **kwargs: Any
    ) -> _models.IssueContract:
        """Updates an existing issue for an API.
