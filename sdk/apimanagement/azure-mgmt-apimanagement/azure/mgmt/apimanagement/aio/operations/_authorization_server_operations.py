    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "AuthorizationServerContract", is_xml=True)
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "AuthorizationServerUpdateContract", is_xml=True)
