...
class ProductWikiOperations:
    ...
    async def create_or_update(
        ...
        service_name: str,
        product_id: str,
        parameters: Union[_models.WikiContract, IO[bytes]],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.WikiContract:
        """Creates a new Wiki for a Product or updates an existing one.
        ...
        :param parameters: Create parameters. Is either a WikiContract type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.apimanagement.models.WikiContract or IO[bytes]
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        :return: WikiContract or the result of cls(response)
    ...
    async def update(
        ...
        product_id: str,
        if_match: str,
        parameters: Union[_models.WikiUpdateContract, IO[bytes]],
        **kwargs: Any
    ) -> _models.WikiContract:
        """Updates the details of the Wiki for a Product specified by its identifier.
        ...
        :param parameters: Wiki Update parameters. Is either a WikiUpdateContract type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.apimanagement.models.WikiUpdateContract or IO[bytes]
        :return: WikiContract or the result of cls(response)
        :rtype: ~azure.mgmt.apimanagement.models.WikiContract
        :raises ~azure.core.exceptions.HttpResponseError:
        """
