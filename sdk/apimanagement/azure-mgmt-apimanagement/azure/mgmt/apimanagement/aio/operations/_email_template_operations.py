...
class EmailTemplateOperations:
    ...
    def list_by_service(
        ...
        **kwargs: Any
        ...
        :type skip: int
        :return: An iterator like instance of either EmailTemplateContract or the result of
         cls(response)
        :rtype:
    ...
    async def create_or_update(
        ...
        service_name: str,
        template_name: Union[str, _models.TemplateName],
        parameters: Union[_models.EmailTemplateUpdateParameters, IO[bytes]],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.EmailTemplateContract:
        """Updates an Email Template.
        ...
        :type parameters: ~azure.mgmt.apimanagement.models.EmailTemplateUpdateParameters or IO[bytes]
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        :return: EmailTemplateContract or the result of cls(response)
