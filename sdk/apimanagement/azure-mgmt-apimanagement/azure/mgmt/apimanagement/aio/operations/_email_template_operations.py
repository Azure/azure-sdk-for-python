...
class EmailTemplateOperations:
    """EmailTemplateOperations async operations.
    ...
    def list_by_service(
        ...
        **kwargs
    ) -> AsyncIterable["models.EmailTemplateCollection"]:
        ...
        :return: An iterator like instance of either EmailTemplateCollection or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.apimanagement.models.EmailTemplateCollection]
    ...
    async def get_entity_tag(
        ...
        resource_group_name: str,
        service_name: str,
        template_name: Union[str, "models.TemplateName"],
        **kwargs
    ) -> bool:
        ...
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'serviceName': self._serialize.url("service_name", service_name, 'str', max_length=50, min_length=1, pattern=r'^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$'),
            'templateName': self._serialize.url("template_name", template_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        body_content = self._serialize.body(parameters, 'EmailTemplateUpdateParameters')
