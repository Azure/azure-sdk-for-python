...
class OpenidConnectProviderCreateContract(Resource):
    """OpenId Connect Provider details.
    ...
    :param client_id: Required. Client ID of developer console which is the
     client application.
    :type client_id: str
    :param client_secret: Required. Client Secret of developer console which
    ...
    def __init__(self, **kwargs):
        super(OpenidConnectProviderCreateContract, self).__init__(**kwargs)
        self.display_name = kwargs.get('display_name', None)
        self.description = kwargs.get('description', None)
        self.metadata_endpoint = kwargs.get('metadata_endpoint', None)
        self.client_id = kwargs.get('client_id', None)
