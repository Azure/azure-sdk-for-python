...
class StorageTasksManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype operations: azure.mgmt.storagetasks.aio.operations.Operations
    :ivar storage_tasks: StorageTasksOperations operations
    :vartype storage_tasks: azure.mgmt.storagetasks.aio.operations.StorageTasksOperations
    :ivar storage_task_assignment: StorageTaskAssignmentOperations operations
    :vartype storage_task_assignment:
     azure.mgmt.storagetasks.aio.operations.StorageTaskAssignmentOperations
    :ivar storage_tasks_report: StorageTasksReportOperations operations
    :vartype storage_tasks_report:
     azure.mgmt.storagetasks.aio.operations.StorageTasksReportOperations
    ...
    async def __aenter__(self) -> "StorageTasksManagementClient":
