...
from ...operations._storage_tasks_report_operations import build_list_request
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either StorageTaskReportInstance or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storagetasks.models.StorageTaskReportInstance]
