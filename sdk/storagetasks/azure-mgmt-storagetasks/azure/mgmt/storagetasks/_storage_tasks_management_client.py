...
from ._configuration import StorageTasksManagementClientConfiguration
...
class StorageTasksManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    """The Azure Storage Tasks Management API.

    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.storagetasks.operations.Operations
    :ivar storage_tasks: StorageTasksOperations operations
    :vartype storage_tasks: azure.mgmt.storagetasks.operations.StorageTasksOperations
    :ivar storage_task_assignment: StorageTaskAssignmentOperations operations
    :vartype storage_task_assignment:
     azure.mgmt.storagetasks.operations.StorageTaskAssignmentOperations
    :ivar storage_tasks_report: StorageTasksReportOperations operations
    :vartype storage_tasks_report: azure.mgmt.storagetasks.operations.StorageTasksReportOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = StorageTasksManagementClientConfiguration(
    ...
    def __enter__(self) -> "StorageTasksManagementClient":
