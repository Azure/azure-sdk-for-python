...
class StorageTaskAssignmentOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either StorageTaskAssignment or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storagetasks.models.StorageTaskAssignment]
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageTasks/storageTasks/{storageTaskName}/storageTaskAssignments"
    }
