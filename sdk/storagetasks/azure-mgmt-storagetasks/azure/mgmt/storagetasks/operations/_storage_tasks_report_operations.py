...
def build_list_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "storageTaskName": _SERIALIZER.url(
            "storage_task_name", storage_task_name, "str", max_length=18, min_length=3, pattern=r"^[a-z0-9]{3,18}$"
        ),
...
class StorageTasksReportOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.storagetasks.StorageTasksManagementClient`'s
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either StorageTaskReportInstance or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storagetasks.models.StorageTaskReportInstance]
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageTasks/storageTasks/{storageTaskName}/reports"
    }
