...
class ElseCondition(_serialization.Model):
    ...
    :vartype operations: list[~azure.mgmt.storagetasks.models.StorageTaskOperation]
    """
    ...
    def __init__(self, *, operations: List["_models.StorageTaskOperation"], **kwargs: Any) -> None:
        ...
        :paramtype operations: list[~azure.mgmt.storagetasks.models.StorageTaskOperation]
        """
...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.storagetasks.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.storagetasks.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.storagetasks.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.storagetasks.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class ManagedServiceIdentity(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.storagetasks.models.ManagedServiceIdentityType
    :ivar user_assigned_identities: The set of user assigned identities associated with the
     resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form:
     '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}.
     The dictionary values can be empty objects ({}) in requests.
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.storagetasks.models.UserAssignedIdentity]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: Type of managed service identity (where both SystemAssigned and UserAssigned
         ...
         "SystemAssigned,UserAssigned".
        :paramtype type: str or ~azure.mgmt.storagetasks.models.ManagedServiceIdentityType
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.storagetasks.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.storagetasks.models.Origin
    :ivar action_type: Enum. Indicates the action type. "Internal" refers to actions that are for
     internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.storagetasks.models.ActionType
    """
    ...
    def __init__(self, *, display: Optional["_models.OperationDisplay"] = None, **kwargs: Any) -> None:
        ...
        :paramtype display: ~azure.mgmt.storagetasks.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name = None
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.storagetasks.models.Operation]
...
class Resource(_serialization.Model):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.storagetasks.models.SystemData
    """
...
class StorageTask(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype identity: ~azure.mgmt.storagetasks.models.ManagedServiceIdentity
    ...
    :vartype action: ~azure.mgmt.storagetasks.models.StorageTaskAction
    ...
    :vartype provisioning_state: str or ~azure.mgmt.storagetasks.models.ProvisioningState
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype identity: ~azure.mgmt.storagetasks.models.ManagedServiceIdentity
        ...
        :paramtype action: ~azure.mgmt.storagetasks.models.StorageTaskAction
        """
...
class StorageTaskAction(_serialization.Model):
    ...
    :vartype if_property: ~azure.mgmt.storagetasks.models.IfCondition
    :ivar else_property: The else block of storage task operation.
    :vartype else_property: ~azure.mgmt.storagetasks.models.ElseCondition
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype if_property: ~azure.mgmt.storagetasks.models.IfCondition
        :keyword else_property: The else block of storage task operation.
        :paramtype else_property: ~azure.mgmt.storagetasks.models.ElseCondition
        """
        super().__init__(**kwargs)
...
class StorageTaskAssignmentsListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.storagetasks.models.StorageTaskAssignment]
...
class StorageTaskOperation(_serialization.Model):
    ...
    :vartype name: str or ~azure.mgmt.storagetasks.models.StorageTaskOperationName
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword name: The operation to be performed on the object. Required. Known values are:
         "SetBlobTier", "SetBlobTags", "SetBlobImmutabilityPolicy", "SetBlobLegalHold", "SetBlobExpiry",
         "DeleteBlob", and "UndeleteBlob".
        :paramtype name: str or ~azure.mgmt.storagetasks.models.StorageTaskOperationName
...
class StorageTaskPreviewAction(_serialization.Model):
    ...
    :ivar container: Preview action container properties to be tested for a match with the provided
     condition. Required.
    :vartype container: ~azure.mgmt.storagetasks.models.StorageTaskPreviewContainerProperties
    :ivar blobs: Preview action container properties to be tested for a match with the provided
     condition. Required.
    :vartype blobs: list[~azure.mgmt.storagetasks.models.StorageTaskPreviewBlobProperties]
    :ivar action: Preview action container properties to be tested for a match with the provided
     condition. Required.
    :vartype action: ~azure.mgmt.storagetasks.models.StorageTaskPreviewActionCondition
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype container: ~azure.mgmt.storagetasks.models.StorageTaskPreviewContainerProperties
        :keyword blobs: Preview action container properties to be tested for a match with the provided
         condition. Required.
        :paramtype blobs: list[~azure.mgmt.storagetasks.models.StorageTaskPreviewBlobProperties]
        :keyword action: Preview action container properties to be tested for a match with the provided
         condition. Required.
        :paramtype action: ~azure.mgmt.storagetasks.models.StorageTaskPreviewActionCondition
        """
        super().__init__(**kwargs)
...
class StorageTaskPreviewActionCondition(_serialization.Model):
    ...
    :ivar if_property: The condition to be tested for a match with container and blob properties.
     Required.
    :vartype if_property: ~azure.mgmt.storagetasks.models.StorageTaskPreviewActionIfCondition
    ...
    def __init__(
        ...
        :keyword if_property: The condition to be tested for a match with container and blob
         properties. Required.
        :paramtype if_property: ~azure.mgmt.storagetasks.models.StorageTaskPreviewActionIfCondition
...
class StorageTaskPreviewBlobProperties(_serialization.Model):
    ...
    :ivar properties: properties key value pairs to be tested for a match against the provided
     condition.
    :vartype properties: list[~azure.mgmt.storagetasks.models.StorageTaskPreviewKeyValueProperties]
    :ivar metadata: metadata key value pairs to be tested for a match against the provided
     condition.
    :vartype metadata: list[~azure.mgmt.storagetasks.models.StorageTaskPreviewKeyValueProperties]
    :ivar tags: tags key value pairs to be tested for a match against the provided condition.
    :vartype tags: list[~azure.mgmt.storagetasks.models.StorageTaskPreviewKeyValueProperties]
    ...
    :vartype matched_block: str or ~azure.mgmt.storagetasks.models.MatchedBlockName
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties:
         list[~azure.mgmt.storagetasks.models.StorageTaskPreviewKeyValueProperties]
        :keyword metadata: metadata key value pairs to be tested for a match against the provided
         condition.
        :paramtype metadata: list[~azure.mgmt.storagetasks.models.StorageTaskPreviewKeyValueProperties]
        :keyword tags: tags key value pairs to be tested for a match against the provided condition.
        :paramtype tags: list[~azure.mgmt.storagetasks.models.StorageTaskPreviewKeyValueProperties]
        """
        super().__init__(**kwargs)
        self.name = name
...
class StorageTaskReportInstance(ProxyResource):
    ...
    :vartype properties: ~azure.mgmt.storagetasks.models.StorageTaskReportProperties
    """
    ...
    def __init__(self, *, properties: Optional["_models.StorageTaskReportProperties"] = None, **kwargs: Any) -> None:
        ...
        :paramtype properties: ~azure.mgmt.storagetasks.models.StorageTaskReportProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
...
class StorageTaskReportProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar run_status_enum: Represents the status of the execution. Known values are: "InProgress"
     and "Finished".
    :vartype run_status_enum: str or ~azure.mgmt.storagetasks.models.RunStatusEnum
    ...
    :vartype run_result: str or ~azure.mgmt.storagetasks.models.RunResult
    """
...
class StorageTaskReportSummary(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.storagetasks.models.StorageTaskReportInstance]
...
class StorageTasksListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.storagetasks.models.StorageTask]
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.storagetasks.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or ~azure.mgmt.storagetasks.models.CreatedByType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~azure.mgmt.storagetasks.models.CreatedByType
        ...
        :paramtype last_modified_by_type: str or ~azure.mgmt.storagetasks.models.CreatedByType
