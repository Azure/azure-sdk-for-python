...
from ...operations._patch_schedules_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_redis_resource_request
T = TypeVar('T')
...
class PatchSchedulesOperations:
    ...
    def list_by_redis_resource(
        ...
        cache_name: str,
        **kwargs: Any
    ) -> AsyncIterable[_models.RedisPatchScheduleListResult]:
