...
class AccessPolicyAssignmentOperations:
    ...
    async def _create_update_initial(
        ...
        parameters: Union[_models.RedisCacheAccessPolicyAssignment, IO],
        **kwargs: Any
    ...
    _create_update_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/redis/{cacheName}/accessPolicyAssignments/{accessPolicyAssignmentName}"
    }
    ...
    async def begin_create_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.redis.models.RedisCacheAccessPolicyAssignment or IO
    ...
    ) -> AsyncIterable["_models.RedisCacheAccessPolicyAssignment"]:
