...
class AccessPolicyAssignmentOperations:
    ...
    async def _create_update_initial(
        ...
        **kwargs: Any
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "RedisCacheAccessPolicyAssignment")
    ...
    async def begin_create_update(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.RedisCacheAccessPolicyAssignment]:
        ...
        :return: An instance of AsyncLROPoller that returns either RedisCacheAccessPolicyAssignment or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.redis.models.RedisCacheAccessPolicyAssignment]
    ...
    async def begin_create_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.redis.models.RedisCacheAccessPolicyAssignment or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either RedisCacheAccessPolicyAssignment or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.redis.models.RedisCacheAccessPolicyAssignment]
        ...
        if cont_token:
            return AsyncLROPoller[_models.RedisCacheAccessPolicyAssignment].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.RedisCacheAccessPolicyAssignment](
    ...
    async def get(
        ...
        :param access_policy_assignment_name: The name of the access policy assignment. Required.
        :type access_policy_assignment_name: str
        :return: RedisCacheAccessPolicyAssignment or the result of cls(response)
    ...
    def list(
    ...
    ) -> AsyncItemPaged["_models.RedisCacheAccessPolicyAssignment"]:
        ...
        :param cache_name: The name of the Redis cache. Required.
        :type cache_name: str
        :return: An iterator like instance of either RedisCacheAccessPolicyAssignment or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.redis.models.RedisCacheAccessPolicyAssignment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
