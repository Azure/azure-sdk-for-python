...
class NotificationListResponse(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.UpgradeNotification"]] = None,
        **kwargs
    ):
        """
...
class OperationStatus(OperationStatusResult):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super(OperationStatus, self).__init__(id=id, name=name, status=status, percent_complete=percent_complete, start_time=start_time, end_time=end_time, operations=operations, error=error, **kwargs)
...
class RedisCommonProperties(msrest.serialization.Model):
    ...
    :ivar minimum_tls_version: Optional: requires clients to use a specified TLS version (or
     higher) to connect (e,g, '1.0', '1.1', '1.2'). Known values are: "1.0", "1.1", "1.2".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword public_network_access: Whether or not public endpoint access is allowed for this
         ...
         are: "Enabled", "Disabled". Default value: "Enabled".
...
class RedisFirewallRuleListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.RedisFirewallRule"]] = None,
        **kwargs
    ):
        """
...
class RedisLinkedServerCreateParameters(msrest.serialization.Model):
    ...
    :ivar server_role: Required. Role of the linked server. Known values are: "Primary",
     "Secondary".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword server_role: Required. Role of the linked server. Known values are: "Primary",
         "Secondary".
...
class RedisLinkedServerWithProperties(ProxyResource):
    ...
    :vartype linked_redis_cache_location: str
    :ivar server_role: Role of the linked server. Known values are: "Primary", "Secondary".
    :vartype server_role: str or ~azure.mgmt.redis.models.ReplicationRole
    :ivar provisioning_state: Terminal state of the link between primary and secondary redis cache.
    :vartype provisioning_state: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype linked_redis_cache_location: str
        :keyword server_role: Role of the linked server. Known values are: "Primary", "Secondary".
        :paramtype server_role: str or ~azure.mgmt.redis.models.ReplicationRole
        """
...
class RedisLinkedServerWithPropertiesList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.RedisLinkedServerWithProperties"]] = None,
        **kwargs
    ):
        """
...
class RedisListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.RedisResource"]] = None,
        **kwargs
    ):
        """
...
class RedisPatchScheduleListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.RedisPatchSchedule"]] = None,
        **kwargs
    ):
        """
...
class RedisRebootParameters(msrest.serialization.Model):
    ...
    :ivar reboot_type: Which Redis node(s) to reboot. Depending on this value data loss is
     possible. Known values are: "PrimaryNode", "SecondaryNode", "AllNodes".
...
class RedisRegenerateKeyParameters(msrest.serialization.Model):
    ...
    :ivar key_type: Required. The Redis access key to regenerate. Known values are: "Primary",
     "Secondary".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword key_type: Required. The Redis access key to regenerate. Known values are: "Primary",
         "Secondary".
...
class ScheduleEntry(msrest.serialization.Model):
    ...
    :ivar day_of_week: Required. Day of the week when a cache can be patched. Known values are:
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword day_of_week: Required. Day of the week when a cache can be patched. Known values are:
         "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday", "Everyday",
         "Weekend".
...
class Sku(msrest.serialization.Model):
    ...
    :ivar name: Required. The type of Redis cache to deploy. Valid values: (Basic, Standard,
     Premium). Known values are: "Basic", "Standard", "Premium".
