...
from ...operations._mediaservices_operations import (
    build_create_or_update_request,
    build_delete_request,
    build_get_request,
    build_list_by_subscription_request,
    build_list_edge_policies_request,
    build_list_request,
    build_sync_storage_keys_request,
...
class MediaservicesOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.MediaService"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.media.models.MediaService]
    ...
    async def get(self, resource_group_name: str, account_name: str, **kwargs: Any) -> _models.MediaService:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.MediaService]:
        ...
        :return: An instance of AsyncLROPoller that returns either MediaService or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.media.models.MediaService]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @overload
    async def sync_storage_keys(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.MediaService"]:
        """List Media Services accounts.
