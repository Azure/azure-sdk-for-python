...
class LiveOutputsOperations:
    """LiveOutputsOperations async operations.
    ...
    def list(
        ...
        **kwargs
        ...
        :return: An iterator like instance of either LiveOutputListResult or the result of cls(response)
    ...
    async def begin_create(
        ...
        **kwargs
        ...
        :return: An instance of AsyncLROPoller that returns either LiveOutput or the result of cls(response)
