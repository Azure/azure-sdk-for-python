...
class LiveEventsOperations:
    """LiveEventsOperations async operations.
    ...
    async def begin_create(
        ...
        **kwargs
        ...
        :return: An instance of AsyncLROPoller that returns either LiveEvent or the result of cls(response)
    ...
    async def _allocate_initial(
        ...
        **kwargs
        ...
        # Construct URL
        url = self._allocate_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'accountName': self._serialize.url("account_name", account_name, 'str'),
    ...
    async def begin_allocate(
        ...
        **kwargs
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._allocate_initial(
                resource_group_name=resource_group_name,
                account_name=account_name,
                live_event_name=live_event_name,
                cls=lambda x,y,z: x,
