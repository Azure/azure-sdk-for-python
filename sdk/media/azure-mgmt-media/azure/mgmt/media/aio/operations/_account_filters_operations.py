...
from ...operations._account_filters_operations import (
...
class AccountFiltersOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.AccountFilter"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.media.models.AccountFilter]
        ...
        cls: ClsType[_models.AccountFilterCollection] = kwargs.pop("cls", None)
    ...
    async def get(
        ...
        api_version: Literal["2022-08-01"] = kwargs.pop("api_version", _params.pop("api-version", "2022-08-01"))
        cls: ClsType[_models.AccountFilter] = kwargs.pop("cls", None)
