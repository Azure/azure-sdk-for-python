...
from ...operations._streaming_locators_operations import build_create_request, build_delete_request, build_get_request, build_list_content_keys_request, build_list_paths_request, build_list_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class StreamingLocatorsOperations:
    """StreamingLocatorsOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.StreamingLocatorCollection"]:
        ...
        :return: An iterator like instance of either StreamingLocatorCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.media.models.StreamingLocatorCollection]
