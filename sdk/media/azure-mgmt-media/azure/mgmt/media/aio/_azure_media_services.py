...
class AzureMediaServices:    # pylint: disable=too-many-instance-attributes
    ...
    :ivar media_service_operation_statuses: MediaServiceOperationStatusesOperations operations
    :vartype media_service_operation_statuses:
     azure.mgmt.media.aio.operations.MediaServiceOperationStatusesOperations
    :ivar media_service_operation_results: MediaServiceOperationResultsOperations operations
    :vartype media_service_operation_results:
     azure.mgmt.media.aio.operations.MediaServiceOperationResultsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.media_service_operation_statuses = MediaServiceOperationStatusesOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
        self.media_service_operation_results = MediaServiceOperationResultsOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
