...
def build_get_request(
    resource_group_name: str, account_name: str, streaming_locator_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class StreamingLocatorsOperations:
    ...
    def list(
        ...
        orderby: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.StreamingLocator"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.media.models.StreamingLocator]
