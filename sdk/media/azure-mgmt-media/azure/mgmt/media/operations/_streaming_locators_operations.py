...
class StreamingLocatorsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.StreamingLocatorCollection"]
        ...
        :return: An iterator like instance of either StreamingLocatorCollection or the result of cls(response)
    ...
    def get(
        ...
        resource_group_name,  # type: str
        account_name,  # type: str
        streaming_locator_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.StreamingLocator"]
        ...
        :rtype: ~azure.mgmt.media.models.StreamingLocator or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.StreamingLocator"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def create(
        ...
        account_name,  # type: str
        streaming_locator_name,  # type: str
        parameters,  # type: "_models.StreamingLocator"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.StreamingLocator"
    ...
    def list_content_keys(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.ListContentKeysResponse"
        """List Content Keys.
        ...
        # Construct URL
        url = self.list_content_keys.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'accountName': self._serialize.url("account_name", account_name, 'str'),
    ...
    def list_paths(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.ListPathsResponse"
        """List Paths.
