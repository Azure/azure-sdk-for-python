...
class StreamingLocatorsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        api_version: Literal["2022-08-01"] = kwargs.pop("api_version", _params.pop("api-version", "2022-08-01"))
        cls: ClsType[_models.StreamingLocatorCollection] = kwargs.pop("cls", None)
    ...
    def get(
        ...
        api_version: Literal["2022-08-01"] = kwargs.pop("api_version", _params.pop("api-version", "2022-08-01"))
        cls: ClsType[_models.StreamingLocator] = kwargs.pop("cls", None)
    ...
    def list_content_keys(
        ...
        api_version: Literal["2022-08-01"] = kwargs.pop("api_version", _params.pop("api-version", "2022-08-01"))
        cls: ClsType[_models.ListContentKeysResponse] = kwargs.pop("cls", None)
    ...
    def list_paths(
        ...
        api_version: Literal["2022-08-01"] = kwargs.pop("api_version", _params.pop("api-version", "2022-08-01"))
        cls: ClsType[_models.ListPathsResponse] = kwargs.pop("cls", None)
