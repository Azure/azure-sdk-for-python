...
class MediaServicesOperationStatusesOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`media_services_operation_statuses` attribute.
    """
    ...
    @distributed_trace
    def get(self, location_name: str, operation_id: str, **kwargs: Any) -> _models.MediaServiceOperationStatus:
        ...
        api_version: Literal["2021-11-01"] = kwargs.pop("api_version", _params.pop("api-version", "2021-11-01"))
        cls: ClsType[_models.MediaServiceOperationStatus] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.Media/locations/{locationName}/mediaServicesOperationStatuses/{operationId}"
    }
