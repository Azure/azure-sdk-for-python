...
class MediaservicesOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.MediaService"]:
        ...
        :return: An iterator like instance of either MediaService or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.media.models.MediaService]
    ...
    @distributed_trace
    def get(self, resource_group_name: str, account_name: str, **kwargs: Any) -> _models.MediaService:
    ...
    def _create_or_update_initial(
        self, resource_group_name: str, account_name: str, parameters: Union[_models.MediaService, IO], **kwargs: Any
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        account_name: str,
        parameters: Union[_models.MediaServiceUpdate, IO],
        **kwargs: Any
    ) -> _models.MediaService:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def sync_storage_keys(  # pylint: disable=inconsistent-return-statements
        ...
        resource_group_name: str,
        account_name: str,
        parameters: Union[_models.SyncStorageKeysInput, IO],
        **kwargs: Any
    ) -> None:
        """Synchronizes Storage Account Keys.
    ...
    def list_edge_policies(
        ...
        resource_group_name: str,
        account_name: str,
        parameters: Union[_models.ListEdgePoliciesInput, IO],
        **kwargs: Any
    ) -> _models.EdgePolicies:
        """List the media edge policies associated with the Media Services account.
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.MediaService"]:
        """List Media Services accounts.
