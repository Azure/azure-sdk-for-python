...
class MediaservicesOperations(object):
    ...
    def list_edge_policies(
            self, resource_group_name, account_name, device_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: EdgePolicies or ClientRawResponse if raw=true
        ...
        # Construct URL
        url = self.list_edge_policies.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'accountName': self._serialize.url("account_name", account_name, 'str')
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'ListEdgePoliciesInput')
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('EdgePolicies', response)
        ...
        return deserialized
    list_edge_policies.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/mediaservices/{accountName}/listEdgePolicies'}
