...
class MediaservicesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.MediaServiceCollection"]
        ...
        :return: An iterator like instance of either MediaServiceCollection or the result of cls(response)
    ...
    def create_or_update(
        ...
        resource_group_name,  # type: str
        account_name,  # type: str
        parameters,  # type: "_models.MediaService"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.MediaService"
    ...
    def sync_storage_keys(
        ...
        resource_group_name,  # type: str
        account_name,  # type: str
        parameters,  # type: "_models.SyncStorageKeysInput"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
    ...
    def list_edge_policies(
        ...
        resource_group_name,  # type: str
        account_name,  # type: str
        parameters,  # type: "_models.ListEdgePoliciesInput"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.EdgePolicies"
        ...
        # Construct URL
        url = self.list_edge_policies.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'accountName': self._serialize.url("account_name", account_name, 'str'),
    ...
    def get_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.get_by_subscription.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'accountName': self._serialize.url("account_name", account_name, 'str'),
        }
        ...
        return deserialized
    get_by_subscription.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Media/mediaservices/{accountName}'}  # type: ignore
