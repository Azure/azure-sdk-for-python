...
class MediaServicesOperationResultsOperations:
    ...
    @distributed_trace
    def get(self, location_name: str, operation_id: str, **kwargs: Any) -> Optional[_models.MediaService]:
        ...
        :return: MediaService or None or the result of cls(response)
        ...
        api_version: Literal["2021-11-01"] = kwargs.pop("api_version", _params.pop("api-version", "2021-11-01"))
        cls: ClsType[Optional[_models.MediaService]] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.Media/locations/{locationName}/mediaServicesOperationResults/{operationId}"
    }
