...
class TestMgmtMedia(AzureMgmtRecordedTestCase):
    ...
    def setUp(self):
        ...
        self.client = self.create_mgmt_client(azure.mgmt.media.AzureMediaServices)
    ...
    def test_media(self, resource_group, location, storage_account):
        ...
        available = self.client.locations.check_name_availability(media_name)
        ...
        media_obj = self.client.mediaservices.get(resource_group.name, media_name)
        ...
        self.client.mediaservices.sync_storage_keys(resource_group.name, media_name, storage_account.id)

        media_obj = self.client.mediaservices.delete(resource_group.name, media_name)
