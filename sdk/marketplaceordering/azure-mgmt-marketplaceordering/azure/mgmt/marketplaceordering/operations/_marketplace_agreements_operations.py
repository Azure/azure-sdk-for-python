...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "offerType": _SERIALIZER.url("offer_type", offer_type, "str"),
        "publisherId": _SERIALIZER.url("publisher_id", publisher_id, "str"),
...
def build_sign_request(
    publisher_id: str, offer_id: str, plan_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_agreement_request(
    publisher_id: str, offer_id: str, plan_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.MarketplaceOrdering/agreements"
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class MarketplaceAgreementsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.marketplaceordering.MarketplaceOrderingAgreements`'s
    ...
    @distributed_trace
    def get(
        self, offer_type: Union[str, _models.OfferType], publisher_id: str, offer_id: str, plan_id: str, **kwargs: Any
