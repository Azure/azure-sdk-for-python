...
class ServicesDescription(Resource):
    ...
    def __init__(self, *, location: str, tags=None, etag: str=None, properties=None, **kwargs) -> None:
        super(ServicesDescription, self).__init__(location=location, tags=tags, etag=etag, **kwargs)
