...
def build_create_or_update_request(
    resource_group_name: str, account_name: str, trusted_id_provider_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "accountName": _SERIALIZER.url("account_name", account_name, "str"),
        "trustedIdProviderName": _SERIALIZER.url("trusted_id_provider_name", trusted_id_provider_name, "str"),
    }
...
class TrustedIdProvidersOperations:
    ...
    ) -> Iterable["_models.TrustedIdProvider"]:
