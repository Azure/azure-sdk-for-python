...
class CreateOrUpdateTrustedIdProviderParameters(_serialization.Model):
    ...
    def __init__(self, *, id_provider: str, **kwargs):
        """
...
class CreateTrustedIdProviderWithAccountParameters(_serialization.Model):
    ...
    def __init__(self, *, name: str, id_provider: str, **kwargs):
        """
...
class KeyVaultMetaInfo(_serialization.Model):
    ...
    def __init__(self, *, key_vault_resource_id: str, encryption_key_name: str, encryption_key_version: str, **kwargs):
        """
...
class UpdateEncryptionConfig(_serialization.Model):
    ...
    def __init__(self, *, key_vault_meta_info: Optional["_models.UpdateKeyVaultMetaInfo"] = None, **kwargs):
        """
...
class UpdateTrustedIdProviderWithAccountParameters(_serialization.Model):
    ...
    def __init__(self, *, name: str, id_provider: Optional[str] = None, **kwargs):
        """
...
class UpdateVirtualNetworkRuleWithAccountParameters(_serialization.Model):
    ...
    def __init__(self, *, name: str, subnet_id: Optional[str] = None, **kwargs):
        """
