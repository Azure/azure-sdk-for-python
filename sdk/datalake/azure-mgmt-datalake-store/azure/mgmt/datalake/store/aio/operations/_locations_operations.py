...
from ...operations._locations_operations import build_get_capability_request, build_get_usage_request
...
class LocationsOperations:
    ...
    @distributed_trace
    def get_usage(self, location: str, **kwargs: Any) -> AsyncIterable["_models.Usage"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datalake.store.models.Usage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
