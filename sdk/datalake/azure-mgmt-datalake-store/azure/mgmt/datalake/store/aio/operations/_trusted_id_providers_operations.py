...
class TrustedIdProvidersOperations:
    """TrustedIdProvidersOperations async operations.
    ...
    def list_by_account(
        ...
        **kwargs
        ...
        :return: An iterator like instance of either TrustedIdProviderListResult or the result of cls(response)
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        _parameters = _models.CreateOrUpdateTrustedIdProviderParameters(id_provider=id_provider)
        api_version = "2016-11-01"
    ...
    async def update(
        ...
        **kwargs
        ...
        _parameters = _models.UpdateTrustedIdProviderParameters(id_provider=id_provider)
        api_version = "2016-11-01"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"
