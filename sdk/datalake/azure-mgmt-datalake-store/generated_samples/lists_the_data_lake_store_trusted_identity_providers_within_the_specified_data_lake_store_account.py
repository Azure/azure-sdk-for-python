...
# USAGE
    python lists_the_data_lake_store_trusted_identity_providers_within_the_specified_data_lake_store_account.py
...
def main():
    ...
    response = client.trusted_id_providers.list_by_account(
