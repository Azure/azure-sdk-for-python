...
# USAGE
    python lists_the_data_lake_store_virtual_network_rules_within_the_specified_data_lake_store_account..py
...
def main():
    ...
    response = client.virtual_network_rules.list_by_account(
