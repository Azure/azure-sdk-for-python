...
class StorageAccountsOperations(object):
    ...
    def list_by_account(
        ...
        if raw:
            header_dict = {}
        deserialized = models.StorageAccountInformationPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_storage_containers(
        ...
        if raw:
            header_dict = {}
        deserialized = models.StorageContainerPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_sas_tokens(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SasTokenInformationPaged(internal_paging, self._deserialize.dependencies, header_dict)
