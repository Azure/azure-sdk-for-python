...
def build_get_capability_request(
    subscription_id: str,
    location: str,
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.DataLakeAnalytics/locations/{location}/capability')
...
class LocationsOperations(object):
    ...
    def get_capability(
        ...
        **kwargs: Any
        ...
        :rtype: ~data_lake_analytics_account_management_client.models.CapabilityInformation or None
