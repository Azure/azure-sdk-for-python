...
class CapabilityInformation(msrest.serialization.Model):
    ...
    :vartype state: str or ~data_lake_analytics_account_management_client.models.SubscriptionState
...
class ComputePolicy(SubResource):
    ...
    :ivar object_type: The type of AAD object the object identifier refers to. Possible values
     include: "User", "Group", "ServicePrincipal".
    :vartype object_type: str or
     ~data_lake_analytics_account_management_client.models.AADObjectType
...
class ComputePolicyListResult(msrest.serialization.Model):
    ...
    :vartype value: list[~data_lake_analytics_account_management_client.models.ComputePolicy]
...
class CreateComputePolicyWithAccountParameters(msrest.serialization.Model):
    ...
    :vartype object_id: str
    :ivar object_type: Required. The type of AAD object the object identifier refers to. Possible
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword object_type: Required. The type of AAD object the object identifier refers to.
         Possible values include: "User", "Group", "ServicePrincipal".
        :paramtype object_type: str or
         ~data_lake_analytics_account_management_client.models.AADObjectType
...
class CreateDataLakeAnalyticsAccountParameters(msrest.serialization.Model):
    ...
    :vartype data_lake_store_accounts:
     list[~data_lake_analytics_account_management_client.models.AddDataLakeStoreWithAccountParameters]
    :ivar storage_accounts: The list of Azure Blob Storage accounts associated with this account.
    :vartype storage_accounts:
     list[~data_lake_analytics_account_management_client.models.AddStorageAccountWithAccountParameters]
    :ivar compute_policies: The list of compute policies associated with this account.
    :vartype compute_policies:
     list[~data_lake_analytics_account_management_client.models.CreateComputePolicyWithAccountParameters]
    :ivar firewall_rules: The list of firewall rules associated with this account.
    :vartype firewall_rules:
     list[~data_lake_analytics_account_management_client.models.CreateFirewallRuleWithAccountParameters]
    :ivar firewall_state: The current state of the IP address firewall for this account. Possible
     values include: "Enabled", "Disabled".
    :vartype firewall_state: str or
     ~data_lake_analytics_account_management_client.models.FirewallState
    ...
    :vartype firewall_allow_azure_ips: str or
     ~data_lake_analytics_account_management_client.models.FirewallAllowAzureIpsState
    :ivar new_tier: The commitment tier for the next month. Possible values include: "Consumption",
    ...
    :vartype new_tier: str or ~data_lake_analytics_account_management_client.models.TierType
    ...
    def __init__(
        ...
        *,
        ...
        storage_accounts: Optional[List["AddStorageAccountWithAccountParameters"]] = None,
        compute_policies: Optional[List["CreateComputePolicyWithAccountParameters"]] = None,
        firewall_rules: Optional[List["CreateFirewallRuleWithAccountParameters"]] = None,
        firewall_state: Optional[Union[str, "FirewallState"]] = None,
        firewall_allow_azure_ips: Optional[Union[str, "FirewallAllowAzureIpsState"]] = None,
        new_tier: Optional[Union[str, "TierType"]] = None,
        ...
        **kwargs
        ...
        :paramtype firewall_state: str or
         ~data_lake_analytics_account_management_client.models.FirewallState
        ...
        :paramtype firewall_allow_azure_ips: str or
         ~data_lake_analytics_account_management_client.models.FirewallAllowAzureIpsState
        :keyword new_tier: The commitment tier for the next month. Possible values include:
         "Consumption", "Commitment_100AUHours", "Commitment_500AUHours", "Commitment_1000AUHours",
         "Commitment_5000AUHours", "Commitment_10000AUHours", "Commitment_50000AUHours",
         "Commitment_100000AUHours", "Commitment_500000AUHours".
        :paramtype new_tier: str or ~data_lake_analytics_account_management_client.models.TierType
...
class DataLakeAnalyticsAccount(Resource):
    ...
    :ivar provisioning_state: The provisioning status of the Data Lake Analytics account. Possible
     values include: "Failed", "Creating", "Running", "Succeeded", "Patching", "Suspending",
     "Resuming", "Deleting", "Deleted", "Undeleting", "Canceled".
    :vartype provisioning_state: str or
     ~data_lake_analytics_account_management_client.models.DataLakeAnalyticsAccountStatus
    :ivar state: The state of the Data Lake Analytics account. Possible values include: "Active",
     "Suspended".
    :vartype state: str or
     ~data_lake_analytics_account_management_client.models.DataLakeAnalyticsAccountState
    ...
    :ivar data_lake_store_accounts: The list of Data Lake Store accounts associated with this
     account.
    :vartype data_lake_store_accounts:
     list[~data_lake_analytics_account_management_client.models.DataLakeStoreAccountInformation]
    ...
    :ivar storage_accounts: The list of Azure Blob Storage accounts associated with this account.
    :vartype storage_accounts:
     list[~data_lake_analytics_account_management_client.models.StorageAccountInformation]
    :ivar compute_policies: The list of compute policies associated with this account.
    :vartype compute_policies:
     list[~data_lake_analytics_account_management_client.models.ComputePolicy]
    :ivar hive_metastores: The list of hiveMetastores associated with this account.
    :vartype hive_metastores:
     list[~data_lake_analytics_account_management_client.models.HiveMetastore]
    :ivar virtual_network_rules: The list of virtualNetwork rules associated with this account.
    :vartype virtual_network_rules:
     list[~data_lake_analytics_account_management_client.models.VirtualNetworkRule]
    :ivar firewall_rules: The list of firewall rules associated with this account.
    :vartype firewall_rules:
     list[~data_lake_analytics_account_management_client.models.FirewallRule]
    :ivar firewall_state: The current state of the IP address firewall for this account. Possible
     values include: "Enabled", "Disabled".
    :vartype firewall_state: str or
     ~data_lake_analytics_account_management_client.models.FirewallState
    ...
    :ivar current_tier: The commitment tier in use for the current month. Possible values include:
     ...
     "Commitment_5000AUHours", "Commitment_10000AUHours", "Commitment_50000AUHours",
     "Commitment_100000AUHours", "Commitment_500000AUHours".
    :vartype current_tier: str or ~data_lake_analytics_account_management_client.models.TierType
    :ivar max_job_count: The maximum supported jobs running under the account at the same time.
    :vartype max_job_count: int
    ...
    :vartype debug_data_access_level: str or
     ~data_lake_analytics_account_management_client.models.DebugDataAccessLevel
    """
    ...
    def __init__(
        self,
        *,
        public_data_lake_store_accounts: Optional[List["DataLakeStoreAccountInformation"]] = None,
        firewall_state: Optional[Union[str, "FirewallState"]] = None,
        firewall_allow_azure_ips: Optional[Union[str, "FirewallAllowAzureIpsState"]] = None,
        new_tier: Optional[Union[str, "TierType"]] = None,
        max_job_count: Optional[int] = 3,
...
class DataLakeAnalyticsAccountListResult(msrest.serialization.Model):
    ...
    :ivar value: The results of the list operation.
    :vartype value:
     list[~data_lake_analytics_account_management_client.models.DataLakeAnalyticsAccountBasic]
...
class ErrorDetail(msrest.serialization.Model):
    ...
    :vartype details: list[~data_lake_analytics_account_management_client.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~data_lake_analytics_account_management_client.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(msrest.serialization.Model):
    ...
    :vartype error: ~data_lake_analytics_account_management_client.models.ErrorDetail
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype error: ~data_lake_analytics_account_management_client.models.ErrorDetail
        """
...
class FirewallRuleListResult(msrest.serialization.Model):
    ...
    :ivar value: The results of the list operation.
    :vartype value: list[~data_lake_analytics_account_management_client.models.FirewallRule]
    :ivar next_link: The link (url) to the next page of results.
    :vartype next_link: str
    """
...
class HiveMetastore(SubResource):
    ...
    :ivar nested_resource_provisioning_state: The current state of the NestedResource. Possible
     values include: "Succeeded", "Canceled", "Failed".
    :vartype nested_resource_provisioning_state: str or
     ~data_lake_analytics_account_management_client.models.NestedResourceProvisioningState
    """
...
class HiveMetastoreListResult(msrest.serialization.Model):
    ...
    :ivar value: The results of the list operation.
    :vartype value: list[~data_lake_analytics_account_management_client.models.HiveMetastore]
    :ivar next_link: The link (url) to the next page of results.
    :vartype next_link: str
    """
...
class Operation(msrest.serialization.Model):
    ...
    :vartype display: ~data_lake_analytics_account_management_client.models.OperationDisplay
    :ivar properties: The OperationMetaPropertyInfo for the operation.
    :vartype properties:
     ~data_lake_analytics_account_management_client.models.OperationMetaPropertyInfo
    :ivar origin: The intended executor of the operation. Possible values include: "user",
     "system", "user,system".
    :vartype origin: str or ~data_lake_analytics_account_management_client.models.OperationOrigin
    """
...
class OperationListResult(msrest.serialization.Model):
    ...
    :ivar value: The results of the list operation.
    :vartype value: list[~data_lake_analytics_account_management_client.models.Operation]
    :ivar next_link: The link (url) to the next page of results.
    :vartype next_link: str
    """
...
class OperationMetaMetricSpecification(msrest.serialization.Model):
    ...
    :vartype availabilities:
     list[~data_lake_analytics_account_management_client.models.OperationMetaMetricAvailabilitiesSpecification]
    """
    ...
    def __init__(
        ...
        *,
        ...
        availabilities: Optional[List["OperationMetaMetricAvailabilitiesSpecification"]] = None,
        **kwargs
    ):
        """
...
class OperationMetaPropertyInfo(msrest.serialization.Model):
    ...
    :vartype service_specification:
     ~data_lake_analytics_account_management_client.models.OperationMetaServiceSpecification
    """
...
class OperationMetaServiceSpecification(msrest.serialization.Model):
    ...
    :vartype metric_specifications:
     list[~data_lake_analytics_account_management_client.models.OperationMetaMetricSpecification]
    :ivar log_specifications: The logSpecifications for OperationMetaServiceSpecification.
    :vartype log_specifications:
     list[~data_lake_analytics_account_management_client.models.OperationMetaLogSpecification]
    """
...
class SasTokenInformationListResult(msrest.serialization.Model):
    ...
    :ivar value: The results of the list operation.
    :vartype value: list[~data_lake_analytics_account_management_client.models.SasTokenInformation]
    :ivar next_link: The link (url) to the next page of results.
    :vartype next_link: str
    """
...
class StorageContainerListResult(msrest.serialization.Model):
    ...
    :ivar value: The results of the list operation.
    :vartype value: list[~data_lake_analytics_account_management_client.models.StorageContainer]
    :ivar next_link: The link (url) to the next page of results.
    :vartype next_link: str
    """
...
class UpdateComputePolicyParameters(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype object_id: str
        :keyword object_type: The type of AAD object the object identifier refers to. Possible values
         include: "User", "Group", "ServicePrincipal".
        :paramtype object_type: str or
         ~data_lake_analytics_account_management_client.models.AADObjectType
        :keyword max_degree_of_parallelism_per_job: The maximum degree of parallelism per job this user
...
class UpdateDataLakeAnalyticsAccountParameters(msrest.serialization.Model):
    ...
    :ivar data_lake_store_accounts: The list of Data Lake Store accounts associated with this
     account.
    :vartype data_lake_store_accounts:
     list[~data_lake_analytics_account_management_client.models.UpdateDataLakeStoreWithAccountParameters]
    :ivar storage_accounts: The list of Azure Blob storage accounts associated with this account.
    :vartype storage_accounts:
     list[~data_lake_analytics_account_management_client.models.UpdateStorageAccountWithAccountParameters]
    :ivar compute_policies: The list of compute policies associated with this account.
    :vartype compute_policies:
     list[~data_lake_analytics_account_management_client.models.UpdateComputePolicyWithAccountParameters]
    :ivar firewall_rules: The list of firewall rules associated with this account.
    :vartype firewall_rules:
     list[~data_lake_analytics_account_management_client.models.UpdateFirewallRuleWithAccountParameters]
    ...
    def __init__(
        ...
        *,
        tags: Optional[Dict[str, str]] = None,
        data_lake_store_accounts: Optional[List["UpdateDataLakeStoreWithAccountParameters"]] = None,
        storage_accounts: Optional[List["UpdateStorageAccountWithAccountParameters"]] = None,
        compute_policies: Optional[List["UpdateComputePolicyWithAccountParameters"]] = None,
        firewall_rules: Optional[List["UpdateFirewallRuleWithAccountParameters"]] = None,
        firewall_state: Optional[Union[str, "FirewallState"]] = None,
        firewall_allow_azure_ips: Optional[Union[str, "FirewallAllowAzureIpsState"]] = None,
        new_tier: Optional[Union[str, "TierType"]] = None,
        ...
        **kwargs
        ...
        :paramtype firewall_allow_azure_ips: str or
         ~data_lake_analytics_account_management_client.models.FirewallAllowAzureIpsState
        :keyword new_tier: The commitment tier to use for next month. Possible values include:
         "Consumption", "Commitment_100AUHours", "Commitment_500AUHours", "Commitment_1000AUHours",
         "Commitment_5000AUHours", "Commitment_10000AUHours", "Commitment_50000AUHours",
         "Commitment_100000AUHours", "Commitment_500000AUHours".
        :paramtype new_tier: str or ~data_lake_analytics_account_management_client.models.TierType
...
class VirtualNetworkRule(SubResource):
    ...
    :ivar virtual_network_rule_state: The current state of the VirtualNetwork Rule. Possible values
     include: "Active", "NetworkSourceDeleted", "Failed".
    :vartype virtual_network_rule_state: str or
     ~data_lake_analytics_account_management_client.models.VirtualNetworkRuleState
    """
...
class VirtualNetworkRuleListResult(msrest.serialization.Model):
    ...
    :ivar value: The results of the list operation.
    :vartype value: list[~data_lake_analytics_account_management_client.models.VirtualNetworkRule]
    :ivar next_link: The link (url) to the next page of results.
    :vartype next_link: str
    """
