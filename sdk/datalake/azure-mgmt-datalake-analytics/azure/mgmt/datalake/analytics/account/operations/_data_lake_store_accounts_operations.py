...
def build_add_request(
    resource_group_name: str, account_name: str, data_lake_store_account_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "accountName": _SERIALIZER.url("account_name", account_name, "str"),
        "dataLakeStoreAccountName": _SERIALIZER.url(
...
class DataLakeStoreAccountsOperations:
    ...
    def list_by_account(
        ...
        count: Optional[bool] = None,
        **kwargs: Any
    ) -> Iterable["_models.DataLakeStoreAccountInformation"]:
