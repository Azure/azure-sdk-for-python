...
class ComputePoliciesOperations:
    """ComputePoliciesOperations async operations.
    ...
    def list_by_account(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ComputePolicyListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~data_lake_analytics_account_management_client.models.ComputePolicyListResult]
