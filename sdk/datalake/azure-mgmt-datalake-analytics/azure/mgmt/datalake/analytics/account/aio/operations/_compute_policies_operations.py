...
from ...operations._compute_policies_operations import (
...
class ComputePoliciesOperations:
    ...
    def list_by_account(
    ...
    ) -> AsyncIterable["_models.ComputePolicy"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datalake.analytics.account.models.ComputePolicy]
