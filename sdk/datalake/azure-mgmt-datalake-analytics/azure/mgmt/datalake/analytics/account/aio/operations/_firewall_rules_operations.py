...
class FirewallRulesOperations:
    ...
    def list_by_account(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datalake.analytics.account.models.FirewallRule]
    ...
    async def create_or_update(
        ...
        account_name: str,
        firewall_rule_name: str,
        parameters: Union[_models.CreateOrUpdateFirewallRuleParameters, IO],
        **kwargs: Any
    ) -> _models.FirewallRule:
        """Creates or updates the specified firewall rule. During update, the firewall rule with the
        specified name will be replaced with this new firewall rule.
        ...
        :param firewall_rule_name: The name of the firewall rule to create or update. Required.
        :type firewall_rule_name: str
        :param parameters: Parameters supplied to create or update the firewall rule. Is either a model
         type or a IO type. Required.
        :type parameters:
         ~azure.mgmt.datalake.analytics.account.models.CreateOrUpdateFirewallRuleParameters or IO
    ...
    @distributed_trace_async
    async def get(
        self, resource_group_name: str, account_name: str, firewall_rule_name: str, **kwargs: Any
    ) -> _models.FirewallRule:
    ...
    async def update(
        ...
        account_name: str,
        firewall_rule_name: str,
        parameters: Optional[Union[_models.UpdateFirewallRuleParameters, IO]] = None,
        **kwargs: Any
    ) -> _models.FirewallRule:
        """Updates the specified firewall rule.
        ...
        :param firewall_rule_name: The name of the firewall rule to update. Required.
        :type firewall_rule_name: str
        :param parameters: Parameters supplied to update the firewall rule. Is either a model type or a
         IO type. Default value is None.
        :type parameters: ~azure.mgmt.datalake.analytics.account.models.UpdateFirewallRuleParameters or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
