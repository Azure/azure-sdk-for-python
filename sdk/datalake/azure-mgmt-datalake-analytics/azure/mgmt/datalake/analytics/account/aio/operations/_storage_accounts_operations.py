    ...
    def list_by_account(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either StorageAccountInformationListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datalake.analytics.account.models.StorageAccountInformationListResult]
    ...
    def list_storage_containers(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either StorageContainerListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datalake.analytics.account.models.StorageContainerListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_sas_tokens(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either SasTokenInformationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datalake.analytics.account.models.SasTokenInformationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
