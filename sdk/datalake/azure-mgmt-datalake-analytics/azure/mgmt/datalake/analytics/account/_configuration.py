...
class DataLakeAnalyticsAccountManagementClientConfiguration(Configuration):
    ...
    :param subscription_id: Get subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
