...
def build_create_or_update_request(
    resource_group_name: str, account_name: str, compute_policy_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ComputePoliciesOperations:
    ...
    ) -> Iterable["_models.ComputePolicy"]:
    ...
    def create_or_update(
        ...
        account_name: str,
        compute_policy_name: str,
        parameters: Union[_models.CreateOrUpdateComputePolicyParameters, IO],
        **kwargs: Any
    ) -> _models.ComputePolicy:
        """Creates or updates the specified compute policy. During update, the compute policy with the
        specified name will be replaced with this new compute policy. An account supports, at most, 50
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, account_name: str, compute_policy_name: str, **kwargs: Any
    ) -> _models.ComputePolicy:
    ...
    def update(
        ...
        account_name: str,
        compute_policy_name: str,
        parameters: Optional[Union[_models.UpdateComputePolicyParameters, IO]] = None,
        **kwargs: Any
    ) -> _models.ComputePolicy:
        """Updates the specified compute policy.
