...
def build_list_by_account_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataLakeAnalytics/accounts/{accountName}/computePolicies')
...
def build_create_or_update_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataLakeAnalytics/accounts/{accountName}/computePolicies/{computePolicyName}')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "accountName": _SERIALIZER.url("account_name", account_name, 'str'),
...
class ComputePoliciesOperations(object):
    ...
    def list_by_account(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ComputePolicyListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~data_lake_analytics_account_management_client.models.ComputePolicyListResult]
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~data_lake_analytics_account_management_client.models.CreateOrUpdateComputePolicyParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ComputePolicy, or the result of cls(response)
        :rtype: ~data_lake_analytics_account_management_client.models.ComputePolicy
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~data_lake_analytics_account_management_client.models.UpdateComputePolicyParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ComputePolicy, or the result of cls(response)
        :rtype: ~data_lake_analytics_account_management_client.models.ComputePolicy
        :raises: ~azure.core.exceptions.HttpResponseError
