...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DataLakeAnalytics/accounts")
...
def build_list_by_resource_group_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataLakeAnalytics/accounts")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_create_request_initial(
    ...
    account_name: str,
    *,
    json: Optional[_models.CreateDataLakeAnalyticsAccountParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataLakeAnalytics/accounts/{accountName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
...
def build_update_request_initial(
    ...
    account_name: str,
    *,
    json: Optional[_models.UpdateDataLakeAnalyticsAccountParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_check_name_availability_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DataLakeAnalytics/locations/{location}/checkNameAvailability")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
class AccountsOperations:
    ...
    def list(
        ...
        count: Optional[bool] = None,
        **kwargs: Any
    ) -> Iterable[_models.DataLakeAnalyticsAccountListResult]:
        ...
        :return: An iterator like instance of either DataLakeAnalyticsAccountListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.datalake.analytics.account.models.DataLakeAnalyticsAccountListResult]
    ...
    def begin_create(
        ...
        parameters: _models.CreateDataLakeAnalyticsAccountParameters,
        **kwargs: Any
    ) -> LROPoller[_models.DataLakeAnalyticsAccount]:
        ...
        :return: An instance of LROPoller that returns either DataLakeAnalyticsAccount or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.datalake.analytics.account.models.DataLakeAnalyticsAccount]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
