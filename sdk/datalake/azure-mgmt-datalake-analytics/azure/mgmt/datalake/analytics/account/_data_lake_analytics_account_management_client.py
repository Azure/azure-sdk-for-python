...
class DataLakeAnalyticsAccountManagementClient:
    """Creates an Azure Data Lake Analytics account management client.

    :ivar accounts: AccountsOperations operations
    :vartype accounts: data_lake_analytics_account_management_client.operations.AccountsOperations
    :ivar data_lake_store_accounts: DataLakeStoreAccountsOperations operations
    :vartype data_lake_store_accounts:
     data_lake_analytics_account_management_client.operations.DataLakeStoreAccountsOperations
    :ivar storage_accounts: StorageAccountsOperations operations
    :vartype storage_accounts:
     data_lake_analytics_account_management_client.operations.StorageAccountsOperations
    :ivar compute_policies: ComputePoliciesOperations operations
    :vartype compute_policies:
     data_lake_analytics_account_management_client.operations.ComputePoliciesOperations
    :ivar firewall_rules: FirewallRulesOperations operations
    :vartype firewall_rules:
     data_lake_analytics_account_management_client.operations.FirewallRulesOperations
    :ivar operations: Operations operations
    :vartype operations: data_lake_analytics_account_management_client.operations.Operations
    :ivar locations: LocationsOperations operations
    :vartype locations:
     data_lake_analytics_account_management_client.operations.LocationsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.data_lake_store_accounts = DataLakeStoreAccountsOperations(self._client, self._config, self._serialize, self._deserialize)
        self.storage_accounts = StorageAccountsOperations(self._client, self._config, self._serialize, self._deserialize)
        self.compute_policies = ComputePoliciesOperations(self._client, self._config, self._serialize, self._deserialize)
