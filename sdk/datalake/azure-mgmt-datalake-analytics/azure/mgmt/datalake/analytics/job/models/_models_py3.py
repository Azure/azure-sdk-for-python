...
class JobStatisticsVertexStage(Model):
    ...
    def __init__(self, *, max_data_read_vertex=None, max_execution_time_vertex=None, max_peak_mem_usage_vertex=None, allocated_container_cpu_core_count=None, allocated_container_mem_size=None, used_vertex_cpu_core_count=None, used_vertex_peak_mem_size=None, **kwargs) -> None:
...
class UpdateJobParameters(Model):
    ...
    def __init__(self, *, degree_of_parallelism: int=None, degree_of_parallelism_percent: float=None, priority: int=None, tags=None, **kwargs) -> None:
