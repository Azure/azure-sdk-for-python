...
class DataLakeAnalyticsCatalogCredentialCreateParameters(Model):
    ...
    def __init__(self, *, password: str, uri: str, user_id: str, **kwargs) -> None:
...
class USqlCredential(CatalogItem):
    ...
    def __init__(self, *, compute_account_name: str=None, version: str=None, name: str=None, **kwargs) -> None:
        super(USqlCredential, self).__init__(compute_account_name=compute_account_name, version=version, **kwargs)
        self.name = name
...
class USqlPackage(CatalogItem):
    ...
    def __init__(self, *, compute_account_name: str=None, version: str=None, database_name: str=None, schema_name: str=None, name: str=None, definition: str=None, **kwargs) -> None:
        super(USqlPackage, self).__init__(compute_account_name=compute_account_name, version=version, **kwargs)
        self.database_name = database_name
...
class USqlTable(CatalogItem):
    ...
    def __init__(self, *, compute_account_name: str=None, version: str=None, database_name: str=None, schema_name: str=None, name: str=None, column_list=None, index_list=None, partition_key_list=None, external_table=None, distribution_info=None, **kwargs) -> None:
        super(USqlTable, self).__init__(compute_account_name=compute_account_name, version=version, **kwargs)
        self.database_name = database_name
        self.schema_name = schema_name
        self.name = name
