...
class CatalogOperations(object):
    ...
    def list_credentials(
        ...
        if raw:
            header_dict = {}
        deserialized = models.USqlCredentialPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_external_data_sources(
        ...
        if raw:
            header_dict = {}
        deserialized = models.USqlExternalDataSourcePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_procedures(
        ...
        if raw:
            header_dict = {}
        deserialized = models.USqlProcedurePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_table_fragments(
        ...
        if raw:
            header_dict = {}
        deserialized = models.USqlTableFragmentPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_tables(
        ...
        if raw:
            header_dict = {}
        deserialized = models.USqlTablePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_table_statistics_by_database_and_schema(
        ...
        if raw:
            header_dict = {}
        deserialized = models.USqlTableStatisticsPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_table_types(
        ...
        if raw:
            header_dict = {}
        deserialized = models.USqlTableTypePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_packages(
        ...
        if raw:
            header_dict = {}
        deserialized = models.USqlPackagePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_views(
        ...
        if raw:
            header_dict = {}
        deserialized = models.USqlViewPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_table_partitions(
        ...
        if raw:
            header_dict = {}
        deserialized = models.USqlTablePartitionPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_types(
        ...
        if raw:
            header_dict = {}
        deserialized = models.USqlTypePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_table_valued_functions(
        ...
        if raw:
            header_dict = {}
        deserialized = models.USqlTableValuedFunctionPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_assemblies(
        ...
        if raw:
            header_dict = {}
        deserialized = models.USqlAssemblyClrPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_schemas(
        ...
        if raw:
            header_dict = {}
        deserialized = models.USqlSchemaPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_acls_by_database(
        ...
        if raw:
            header_dict = {}
        deserialized = models.AclPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_databases(
        ...
        if raw:
            header_dict = {}
        deserialized = models.USqlDatabasePaged(internal_paging, self._deserialize.dependencies, header_dict)
