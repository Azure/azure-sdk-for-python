...
from azure.mgmt.paloaltonetworks import PaloAltoNetworksMgmtClient
...
# USAGE
    python prefix_list_local_rulestack_create_or_update_minimum_set_gen.py
...
def main():
    client = PaloAltoNetworksMgmtClient(
        credential=DefaultAzureCredential(),
        subscription_id="2bf4a339-294d-4c25-b0b2-ef649e9f5c27",
    )

    response = client.prefix_list_local_rulestack.begin_create_or_update(
        resource_group_name="rgopenapi",
        local_rulestack_name="lrs1",
        name="armid1",
        resource={"properties": {"prefixList": ["1.0.0.0/24"]}},
    ).result()
    print(response)
