...
# USAGE
    python certificate_object_local_rulestack_list_by_local_rulestacks_maximum_set_gen.py
...
def main():
    ...
    response = client.certificate_object_local_rulestack.list_by_local_rulestacks(
