...
from ...operations._prefix_list_local_rulestack_operations import (
...
class PrefixListLocalRulestackOperations:
    ...
    def list_by_local_rulestacks(
    ...
    ) -> AsyncIterable["_models.PrefixListResource"]:
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("PrefixListResourceListResult", pipeline_response)
    ...
    list_by_local_rulestacks.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PaloAltoNetworks.Cloudngfw/localRulestacks/{localRulestackName}/prefixlists"
    }
    ...
    async def get(
        ...
        deserialized = self._deserialize("PrefixListResource", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PaloAltoNetworks.Cloudngfw/localRulestacks/{localRulestackName}/prefixlists/{name}"
    }
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        if isinstance(resource, (IO, bytes)):
            ...
            _json = self._serialize.body(resource, "PrefixListResource")
