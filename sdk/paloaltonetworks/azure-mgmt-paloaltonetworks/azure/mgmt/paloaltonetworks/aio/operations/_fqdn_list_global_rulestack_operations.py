...
from ...operations._fqdn_list_global_rulestack_operations import (
...
class FqdnListGlobalRulestackOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.FqdnListGlobalRulestackResource"]:
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("FqdnListGlobalRulestackResourceListResult", pipeline_response)
    ...
    list.metadata = {"url": "/providers/PaloAltoNetworks.Cloudngfw/globalRulestacks/{globalRulestackName}/fqdnlists"}
    ...
    async def get(
        ...
        deserialized = self._deserialize("FqdnListGlobalRulestackResource", pipeline_response)
    ...
    get.metadata = {
        "url": "/providers/PaloAltoNetworks.Cloudngfw/globalRulestacks/{globalRulestackName}/fqdnlists/{name}"
    }
    ...
    async def _create_or_update_initial(
        ...
        name: str,
        resource: Union[_models.FqdnListGlobalRulestackResource, IO],
        **kwargs: Any
    ) -> _models.FqdnListGlobalRulestackResource:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IO, bytes)):
            ...
            _json = self._serialize.body(resource, "FqdnListGlobalRulestackResource")
