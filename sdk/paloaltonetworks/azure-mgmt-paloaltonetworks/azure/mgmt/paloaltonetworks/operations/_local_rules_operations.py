...
def build_list_by_local_rulestacks_request(
    resource_group_name: str, local_rulestack_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

    api_version: Literal["2022-08-29-preview"] = kwargs.pop(
        "api_version", _params.pop("api-version", "2022-08-29-preview")
    )
...
class LocalRulesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.paloaltonetworks.PaloAltoNetworksMgmtClient`'s
    ...
    def list_by_local_rulestacks(
    ...
    ) -> Iterable["_models.LocalRulesResource"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_local_rulestacks_request(
                    resource_group_name=resource_group_name,
                    local_rulestack_name=local_rulestack_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
                    template_url=self.list_by_local_rulestacks.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("LocalRulesResourceListResult", pipeline_response)
    ...
    list_by_local_rulestacks.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PaloAltoNetworks.Cloudngfw/localRulestacks/{localRulestackName}/localRules"
    }
    ...
    def get(
        ...
        deserialized = self._deserialize("LocalRulesResource", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PaloAltoNetworks.Cloudngfw/localRulestacks/{localRulestackName}/localRules/{priority}"
    }
    ...
    def _create_or_update_initial(
        ...
        local_rulestack_name: str,
        priority: str,
        resource: Union[_models.LocalRulesResource, IO],
        **kwargs: Any
    ) -> _models.LocalRulesResource:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IO, bytes)):
            ...
            _json = self._serialize.body(resource, "LocalRulesResource")
    ...
    get_counters.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PaloAltoNetworks.Cloudngfw/localRulestacks/{localRulestackName}/localRules/{priority}/getCounters"
    }
    ...
    refresh_counters.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PaloAltoNetworks.Cloudngfw/localRulestacks/{localRulestackName}/localRules/{priority}/refreshCounters"
    }
    ...
    reset_counters.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PaloAltoNetworks.Cloudngfw/localRulestacks/{localRulestackName}/localRules/{priority}/resetCounters"
    }
