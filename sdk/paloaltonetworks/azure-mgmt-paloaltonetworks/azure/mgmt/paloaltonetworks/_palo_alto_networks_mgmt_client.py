...
from ._configuration import PaloAltoNetworksMgmtClientConfiguration
...
class PaloAltoNetworksMgmtClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = PaloAltoNetworksMgmtClientConfiguration(
    ...
    def __enter__(self) -> "PaloAltoNetworksMgmtClient":
