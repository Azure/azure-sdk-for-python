...
# USAGE
    python palo_alto_networks_cloudngfw_operations_create_product_serial_number_minimum_set_gen.py
...
def main():
    ...
    response = client.palo_alto_networks_cloudngfw_operations.create_product_serial_number()
    print(response)
