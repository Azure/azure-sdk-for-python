...
# USAGE
    python custom_capture_configurations_firewall_resources_list_by_firewall_minimum_set_gen.py
...
def main():
    ...
    response = client.custom_capture_configurations_firewall_resources.list_by_firewall(
