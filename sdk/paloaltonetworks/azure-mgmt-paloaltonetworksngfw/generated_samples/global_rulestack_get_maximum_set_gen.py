...
# USAGE
    python global_rulestack_get_maximum_set_gen.py
...
def main():
    ...
    response = client.global_rulestack.get(
        global_rulestack_name="praval",
    )
    print(response)


# x-ms-original-file: 2026-07-29-preview/GlobalRulestack_Get_MaximumSet_Gen.json
