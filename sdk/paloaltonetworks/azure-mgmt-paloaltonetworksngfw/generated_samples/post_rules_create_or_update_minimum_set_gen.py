...
# USAGE
    python post_rules_create_or_update_minimum_set_gen.py
...
def main():
    ...
    response = client.post_rules.begin_create_or_update(
        ...
        priority="1",
        resource={"properties": {"ruleName": "postRule1"}},
    ).result()
    print(response)


# x-ms-original-file: 2026-07-29-preview/PostRules_CreateOrUpdate_MinimumSet_Gen.json
