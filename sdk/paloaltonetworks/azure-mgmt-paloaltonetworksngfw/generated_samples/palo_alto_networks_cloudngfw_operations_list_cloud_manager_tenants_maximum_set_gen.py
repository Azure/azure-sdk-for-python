...
# USAGE
    python palo_alto_networks_cloudngfw_operations_list_cloud_manager_tenants_maximum_set_gen.py
...
def main():
    ...
    response = client.palo_alto_networks_cloudngfw_operations.list_cloud_manager_tenants()
    print(response)
