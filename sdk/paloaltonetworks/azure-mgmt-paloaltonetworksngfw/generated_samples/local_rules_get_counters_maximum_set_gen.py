...
# USAGE
    python local_rules_get_counters_maximum_set_gen.py
...
def main():
    ...
    response = client.local_rules.get_counters(
...
# x-ms-original-file: 2026-07-29-preview/LocalRules_getCounters_MaximumSet_Gen.json
