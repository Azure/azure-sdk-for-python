...
### Features Added
  ...
  - Model `LocalRulestacksOperations` added method `list_app_ids`
  - Model `LocalRulestacksOperations` added method `list_countries`
  - Model `LocalRulestacksOperations` added method `list_predefined_url_categories`
  - Added model `CustomCaptureConfigurationsFirewallResourcesOperations`
...
### Breaking Changes
  ...
  - Deleted or renamed model `CertificateObjectGlobalRulestackResourceListResult`
  - Deleted or renamed model `CertificateObjectLocalRulestackResourceListResult`
  - Deleted or renamed model `FirewallResourceListResult`
  - Deleted or renamed model `FirewallStatusResourceListResult`
  - Deleted or renamed model `FqdnListGlobalRulestackResourceListResult`
  - Deleted or renamed model `FqdnListLocalRulestackResourceListResult`
  - Deleted or renamed model `GlobalRulestackResourceListResult`
  - Deleted or renamed model `LocalRulesResourceListResult`
  - Deleted or renamed model `LocalRulestackResourceListResult`
  - Deleted or renamed model `OperationListResult`
  - Deleted or renamed model `PostRulesResourceListResult`
  - Deleted or renamed model `PreRulesResourceListResult`
  - Deleted or renamed model `PrefixListGlobalRulestackResourceListResult`
  - Deleted or renamed model `PrefixListResourceListResult`
