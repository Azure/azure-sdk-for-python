...
def build_list_by_firewalls_request(
    ...
    path_format_arguments = {
        ...
        "firewallName": _SERIALIZER.url(
            "firewall_name",
            firewall_name,
            "str",
            pattern=r"^(?![-_])(?!.*[-_]{2})(?!.*[-_]$)[a-zA-Z0-9][a-zA-Z0-9-]{0,127}$",
        ),
    }
...
class FirewallStatusOperations:
    ...
    def list_by_firewalls(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_firewalls_request(
    ...
    def get(self, resource_group_name: str, firewall_name: str, **kwargs: Any) -> _models.FirewallStatusResource:
        ...
        deserialized = self._deserialize("FirewallStatusResource", pipeline_response.http_response)
