...
def build_list_by_firewalls_request(
...
class FirewallStatusOperations:
    ...
    def list_by_firewalls(
    ...
    ) -> Iterable["_models.FirewallStatusResource"]:
        ...
        :return: An iterator like instance of either FirewallStatusResource or the result of
         cls(response)
        :rtype:
        ...
        cls: ClsType[_models.FirewallStatusResourceListResult] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_firewalls_request(
                    resource_group_name=resource_group_name,
                    firewall_name=firewall_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
                    template_url=self.list_by_firewalls.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("FirewallStatusResourceListResult", pipeline_response)
    ...
    list_by_firewalls.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PaloAltoNetworks.Cloudngfw/firewalls/{firewallName}/statuses"
    }
    ...
    def get(self, resource_group_name: str, firewall_name: str, **kwargs: Any) -> _models.FirewallStatusResource:
        ...
        :type firewall_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: FirewallStatusResource or the result of cls(response)
        ...
        deserialized = self._deserialize("FirewallStatusResource", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PaloAltoNetworks.Cloudngfw/firewalls/{firewallName}/statuses/default"
    }
