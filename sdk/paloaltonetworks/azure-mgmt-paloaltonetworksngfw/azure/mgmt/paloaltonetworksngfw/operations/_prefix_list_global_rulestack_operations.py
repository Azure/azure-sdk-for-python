...
class PrefixListGlobalRulestackOperations:
    ...
    def get(self, global_rulestack_name: str, name: str, **kwargs: Any) -> _models.PrefixListGlobalRulestackResource:
        ...
        deserialized = self._deserialize("PrefixListGlobalRulestackResource", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        name: str,
        resource: Union[_models.PrefixListGlobalRulestackResource, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
