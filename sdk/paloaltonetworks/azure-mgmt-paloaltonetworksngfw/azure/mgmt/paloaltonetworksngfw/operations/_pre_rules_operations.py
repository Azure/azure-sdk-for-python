...
class PreRulesOperations:
    ...
    def get(self, global_rulestack_name: str, priority: str, **kwargs: Any) -> _models.PreRulesResource:
        ...
        deserialized = self._deserialize("PreRulesResource", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        priority: str,
        resource: Union[_models.PreRulesResource, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a PreRulesResource type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.paloaltonetworksngfw.models.PreRulesResource or IO[bytes]
        :return: An instance of LROPoller that returns either PreRulesResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.paloaltonetworksngfw.models.PreRulesResource]
        :raises ~azure.core.exceptions.HttpResponseError:
