...
class CertificateObjectGlobalRulestackOperations:  # pylint: disable=name-too-long
    ...
    def get(
        ...
        deserialized = self._deserialize("CertificateObjectGlobalRulestackResource", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        name: str,
        resource: Union[_models.CertificateObjectGlobalRulestackResource, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource:
         ~azure.mgmt.paloaltonetworksngfw.models.CertificateObjectGlobalRulestackResource or IO[bytes]
        :return: An instance of LROPoller that returns either CertificateObjectGlobalRulestackResource
         or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.paloaltonetworksngfw.models.CertificateObjectGlobalRulestackResource]
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize(
                "CertificateObjectGlobalRulestackResource", pipeline_response.http_response
            )
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
