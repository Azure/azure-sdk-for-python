...
def build_custom_capture_configurations_firewall_resources_get_request(  # pylint: disable=name-too-long
...
def build_custom_capture_configurations_firewall_resources_create_or_update_request(  # pylint: disable=name-too-long
    resource_group_name: str, firewall_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_custom_capture_configurations_firewall_resources_delete_request(  # pylint: disable=name-too-long
    resource_group_name: str, firewall_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_custom_capture_configurations_firewall_resources_list_by_firewall_request(  # pylint: disable=name-too-long
    resource_group_name: str, firewall_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/PaloAltoNetworks.Cloudngfw/firewalls/{firewallName}/customCaptureConfigurations"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "firewallName": _SERIALIZER.url("firewall_name", firewall_name, "str"),
...
class CustomCaptureConfigurationsFirewallResourcesOperations:  # pylint: disable=name-too-long
    ...
    def list_by_firewall(
        self, resource_group_name: str, firewall_name: str, **kwargs: Any
    ) -> ItemPaged["_models.CustomCaptureConfigurationsFirewallResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.paloaltonetworksngfw.models.CustomCaptureConfigurationsFirewallResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
