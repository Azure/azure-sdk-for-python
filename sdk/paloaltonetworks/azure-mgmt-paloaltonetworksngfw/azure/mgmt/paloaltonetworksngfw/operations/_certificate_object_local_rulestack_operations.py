...
class CertificateObjectLocalRulestackOperations:  # pylint: disable=name-too-long
    ...
    def get(
        ...
        deserialized = self._deserialize("CertificateObjectLocalRulestackResource", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        name: str,
        resource: Union[_models.CertificateObjectLocalRulestackResource, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
