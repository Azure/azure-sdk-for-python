...
def build_list_request(global_rulestack_name: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/providers/PaloAltoNetworks.Cloudngfw/globalRulestacks/{globalRulestackName}/fqdnlists"
    )
...
def build_get_request(global_rulestack_name: str, name: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/providers/PaloAltoNetworks.Cloudngfw/globalRulestacks/{globalRulestackName}/fqdnlists/{name}"
    )
    path_format_arguments = {
        "globalRulestackName": _SERIALIZER.url("global_rulestack_name", global_rulestack_name, "str"),
...
class FqdnListGlobalRulestackOperations:
    ...
    def get(self, global_rulestack_name: str, name: str, **kwargs: Any) -> _models.FqdnListGlobalRulestackResource:
        ...
        deserialized = self._deserialize("FqdnListGlobalRulestackResource", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        name: str,
        resource: Union[_models.FqdnListGlobalRulestackResource, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
