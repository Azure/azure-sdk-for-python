...
class FirewallsOperations:
    ...
    def get(self, resource_group_name: str, firewall_name: str, **kwargs: Any) -> _models.FirewallResource:
        ...
        deserialized = self._deserialize("FirewallResource", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        firewall_name: str,
        resource: Union[_models.FirewallResource, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a FirewallResource type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.paloaltonetworksngfw.models.FirewallResource or IO[bytes]
        :return: An instance of LROPoller that returns either FirewallResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.paloaltonetworksngfw.models.FirewallResource]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def update(
        ...
        resource_group_name: str,
        firewall_name: str,
        properties: Union[_models.FirewallResourceUpdate, IO[bytes]],
        **kwargs: Any
    ) -> _models.FirewallResource:
        """Update a FirewallResource.
        ...
        :type properties: ~azure.mgmt.paloaltonetworksngfw.models.FirewallResourceUpdate or IO[bytes]
        :return: FirewallResource or the result of cls(response)
        :rtype: ~azure.mgmt.paloaltonetworksngfw.models.FirewallResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_global_rulestack(
        ...
        _request = build_get_global_rulestack_request(
            resource_group_name=resource_group_name,
            firewall_name=firewall_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
        ...
        deserialized = self._deserialize("GlobalRulestackInfo", pipeline_response.http_response)
    ...
    def get_log_profile(self, resource_group_name: str, firewall_name: str, **kwargs: Any) -> _models.LogSettings:
        ...
        _request = build_get_log_profile_request(
            resource_group_name=resource_group_name,
            firewall_name=firewall_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
        ...
        deserialized = self._deserialize("LogSettings", pipeline_response.http_response)
    ...
    def get_support_info(
        ...
        _request = build_get_support_info_request(
            resource_group_name=resource_group_name,
            firewall_name=firewall_name,
            subscription_id=self._config.subscription_id,
            email=email,
        ...
        deserialized = self._deserialize("SupportInfo", pipeline_response.http_response)
    ...
    def save_log_profile(  # pylint: disable=inconsistent-return-statements
        ...
        resource_group_name: str,
        firewall_name: str,
        log_settings: Optional[Union[_models.LogSettings, IO[bytes]]] = None,
        **kwargs: Any
    ) -> None:
        """Log Profile for Firewall.
        ...
        :type log_settings: ~azure.mgmt.paloaltonetworksngfw.models.LogSettings or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _request = build_save_log_profile_request(
            resource_group_name=resource_group_name,
            firewall_name=firewall_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
