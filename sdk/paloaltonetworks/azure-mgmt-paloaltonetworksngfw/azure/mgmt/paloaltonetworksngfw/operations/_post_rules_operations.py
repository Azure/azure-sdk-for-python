...
def build_list_request(global_rulestack_name: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/providers/PaloAltoNetworks.Cloudngfw/globalRulestacks/{globalRulestackName}/postRules"
    )
...
class PostRulesOperations:
    ...
    def get(self, global_rulestack_name: str, priority: str, **kwargs: Any) -> _models.PostRulesResource:
        ...
        deserialized = self._deserialize("PostRulesResource", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        priority: str,
        resource: Union[_models.PostRulesResource, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a PostRulesResource type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.paloaltonetworksngfw.models.PostRulesResource or IO[bytes]
        :return: An instance of LROPoller that returns either PostRulesResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.paloaltonetworksngfw.models.PostRulesResource]
    ...
    def get_counters(
        ...
        _request = build_get_counters_request(
            global_rulestack_name=global_rulestack_name,
            priority=priority,
        ...
        deserialized = self._deserialize("RuleCounter", pipeline_response.http_response)
    ...
    def refresh_counters(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_refresh_counters_request(
            global_rulestack_name=global_rulestack_name,
            priority=priority,
            firewall_name=firewall_name,
            api_version=api_version,
    ...
    def reset_counters(
        ...
        _request = build_reset_counters_request(
            global_rulestack_name=global_rulestack_name,
            priority=priority,
            firewall_name=firewall_name,
            api_version=api_version,
        ...
        deserialized = self._deserialize("RuleCounterReset", pipeline_response.http_response)
