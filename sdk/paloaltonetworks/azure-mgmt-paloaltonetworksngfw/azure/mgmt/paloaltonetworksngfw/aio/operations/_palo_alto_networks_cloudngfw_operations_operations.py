...
from ...operations._palo_alto_networks_cloudngfw_operations_operations import (
    build_create_product_serial_number_request,
    build_list_cloud_manager_tenants_request,
    build_list_product_serial_number_status_request,
