...
from ...operations._local_rulestacks_operations import (
...
class LocalRulestacksOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("LocalRulestackResource", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        resource: Union[_models.LocalRulestackResource, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.paloaltonetworksngfw.models.LocalRulestackResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either LocalRulestackResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.paloaltonetworksngfw.models.LocalRulestackResource]
    ...
    async def update(
        ...
        resource_group_name: str,
        local_rulestack_name: str,
        properties: Union[_models.LocalRulestackResourceUpdate, IO[bytes]],
        **kwargs: Any
    ) -> _models.LocalRulestackResource:
        """Update a LocalRulestackResource.
    ...
    def list_countries(
        ...
        **kwargs: Any
        ...
        :param top: Default value is None.
        :type top: int
        :return: An iterator like instance of either Country or the result of cls(response)
        :rtype:
    ...
    def list_predefined_url_categories(
        ...
        **kwargs: Any
        ...
        :param top: Default value is None.
        :type top: int
        :return: An iterator like instance of either PredefinedUrlCategory or the result of
         cls(response)
        :rtype:
