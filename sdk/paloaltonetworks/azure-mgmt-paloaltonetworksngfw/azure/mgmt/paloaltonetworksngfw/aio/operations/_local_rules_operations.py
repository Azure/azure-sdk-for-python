...
from ...operations._local_rules_operations import (
...
class LocalRulesOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("LocalRulesResource", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        priority: str,
        resource: Union[_models.LocalRulesResource, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a LocalRulesResource type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.paloaltonetworksngfw.models.LocalRulesResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either LocalRulesResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.paloaltonetworksngfw.models.LocalRulesResource]
