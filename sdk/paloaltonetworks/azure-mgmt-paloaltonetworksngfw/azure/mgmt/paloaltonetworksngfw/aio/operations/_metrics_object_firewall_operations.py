...
from ...operations._metrics_object_firewall_operations import (
    build_create_or_update_request,
    build_delete_request,
    build_get_request,
    build_list_by_firewalls_request,
)
...
class MetricsObjectFirewallOperations:
    ...
    def list_by_firewalls(
        ...
        :return: An iterator like instance of either MetricsObjectFirewallResource or the result of
         cls(response)
        :rtype:
        ...
        cls: ClsType[_models.MetricsObjectFirewallResourceListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("MetricsObjectFirewallResourceListResult", pipeline_response)
    ...
    async def get(
        ...
        :param firewall_name: Firewall resource name. Required.
        :type firewall_name: str
        :return: MetricsObjectFirewallResource or the result of cls(response)
        ...
        deserialized = self._deserialize("MetricsObjectFirewallResource", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        firewall_name: str,
        resource: Union[_models.MetricsObjectFirewallResource, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "MetricsObjectFirewallResource")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either MetricsObjectFirewallResource or the
