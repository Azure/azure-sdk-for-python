...
class PrefixListLocalRulestackOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("PrefixListResource", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        name: str,
        resource: Union[_models.PrefixListResource, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a PrefixListResource type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.paloaltonetworksngfw.models.PrefixListResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either PrefixListResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.paloaltonetworksngfw.models.PrefixListResource]
