...
from ...operations._fqdn_list_local_rulestack_operations import (
...
class FqdnListLocalRulestackOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("FqdnListLocalRulestackResource", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        name: str,
        resource: Union[_models.FqdnListLocalRulestackResource, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
