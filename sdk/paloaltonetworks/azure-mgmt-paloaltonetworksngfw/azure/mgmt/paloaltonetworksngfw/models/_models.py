...
class CustomCaptureConfigurationsFilter(_Model):
    ...
    :vartype protocol: str or
     ~azure.mgmt.paloaltonetworksngfw.models.CustomCaptureConfigurationsProtocol
    ...
    protocol: Union[str, "_models.CustomCaptureConfigurationsProtocol"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """Network protocol — TCP or UDP. Required. Known values are: \"TCP\" and \"UDP\"."""
    source_ip_address: str = rest_field(
        name="sourceIpAddress", visibility=["read", "create", "update", "delete", "query"]
    )
    """Source IPv4 address in dotted format (e.g., 10.0.0.5). Required."""
    source_port: Optional[int] = rest_field(
        name="sourcePort", visibility=["read", "create", "update", "delete", "query"]
    )
    """Source port number (1-65535). Optional — omit to match any source port."""
    destination_ip_address: str = rest_field(
        name="destinationIpAddress", visibility=["read", "create", "update", "delete", "query"]
    )
    """Destination IPv4 address in dotted format (e.g., 52.39.204.87). Required."""
    destination_port: int = rest_field(
    ...
    def __init__(
        self,
        *,
        protocol: Union[str, "_models.CustomCaptureConfigurationsProtocol"],
...
class CustomCaptureConfigurationsFirewallResource(ProxyResource):  # pylint: disable=name-too-long
    ...
    :ivar properties: The resource-specific properties for this resource. Required.
    :vartype properties:
     ~azure.mgmt.paloaltonetworksngfw.models.CustomCaptureConfigurationsProperties
    """

    properties: "_models.CustomCaptureConfigurationsProperties" = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """The resource-specific properties for this resource. Required."""
    ...
    def __init__(
        self,
        *,
        properties: "_models.CustomCaptureConfigurationsProperties",
    ) -> None: ...
...
class CustomCaptureConfigurationsProperties(_Model):
    ...
    :vartype pcap_filter:
     list[~azure.mgmt.paloaltonetworksngfw.models.CustomCaptureConfigurationsFilter]
    ...
    :vartype pcap_stages: list[str or
     ~azure.mgmt.paloaltonetworksngfw.models.CustomCaptureConfigurationsStage]
    ...
    :vartype pcap_status: str or
     ~azure.mgmt.paloaltonetworksngfw.models.CustomCaptureConfigurationsStatus
    ...
    pcap_filter: Optional[list["_models.CustomCaptureConfigurationsFilter"]] = rest_field(
        name="pcapFilter", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    pcap_stages: Optional[list[Union[str, "_models.CustomCaptureConfigurationsStage"]]] = rest_field(
        name="pcapStages", visibility=["read", "create", "update", "delete", "query"]
    )
    """List of firewall stages where packets should be captured (1-4 entries). Required on PUT
     (input). May be omitted in GET responses while pcapStatus is InProgress because the backend has
     not finalized echo-back yet; echoed in terminal Success responses."""
    duration_in_sec: Optional[int] = rest_field(
        name="durationInSec", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    """ARM resource ID of the customer's storage account where the capture file will be written.
     Required on PUT (input). May be omitted in GET responses while pcapStatus is InProgress because
     the backend has not finalized echo-back yet; echoed in terminal Success responses."""
    pcap_status: Optional[Union[str, "_models.CustomCaptureConfigurationsStatus"]] = rest_field(
        name="pcapStatus", visibility=["read"]
    )
    ...
    pcap_detail_reason: Optional[str] = rest_field(name="pcapDetailReason", visibility=["read"])
    """Detailed reason for the current status, populated by PAN. Typically set when pcapStatus is
     Failed. Read-only."""
    next_check_in_seconds: Optional[int] = rest_field(name="nextCheckInSeconds", visibility=["read"])
    ...
    def __init__(
        self,
        *,
        pcap_filter: Optional[list["_models.CustomCaptureConfigurationsFilter"]] = None,
        pcap_stages: Optional[list[Union[str, "_models.CustomCaptureConfigurationsStage"]]] = None,
...
class FirewallDeploymentProperties(_Model):
    ...
    """panEtag info."""
    firewall_sku: Optional[str] = rest_field(
