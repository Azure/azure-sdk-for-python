...
class ServiceMembersOperations(object):
    ...
    def list_connectors(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ConnectorPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_global_configuration(
        ...
        if raw:
            header_dict = {}
        deserialized = models.GlobalConfigurationPaged(internal_paging, self._deserialize.dependencies, header_dict)
