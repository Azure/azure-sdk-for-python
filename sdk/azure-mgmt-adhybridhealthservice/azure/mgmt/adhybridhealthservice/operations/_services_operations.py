...
class ServicesOperations(object):
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ServicePropertiesPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_export_errors(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ErrorCountPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_export_errors_v2(
        ...
        if raw:
            header_dict = {}
        deserialized = models.MergedExportErrorPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_export_status(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ExportStatusPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_alert_feedback(
        ...
        if raw:
            header_dict = {}
        deserialized = models.AlertFeedbackPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_metrics_average(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ItemPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_metric_metadata(
        ...
        if raw:
            header_dict = {}
        deserialized = models.MetricMetadataPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_user_bad_password_report(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ErrorReportUsersEntryPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_all_risky_ip_download_report(
        ...
        if raw:
            header_dict = {}
        deserialized = models.RiskyIPBlobUriPaged(internal_paging, self._deserialize.dependencies, header_dict)
