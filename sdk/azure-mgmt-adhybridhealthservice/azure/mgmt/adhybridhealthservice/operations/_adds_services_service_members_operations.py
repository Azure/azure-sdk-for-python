...
class AddsServicesServiceMembersOperations(object):
    """AddsServicesServiceMembersOperations operations.
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ServiceMemberPaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list.metadata = {'url': '/providers/Microsoft.ADHybridHealthService/addsservices/{serviceName}/servicemembers'}
    ...
    def add(
        ...
        return deserialized
    add.metadata = {'url': '/providers/Microsoft.ADHybridHealthService/addsservices/{serviceName}/servicemembers'}
