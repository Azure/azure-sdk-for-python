...
class BatchAccount(Resource):
    ...
    :ivar dedicated_core_quota_per_vm_family_enforced: A value indicating
     whether core quotas per Virtual Machine family are enforced for this
     account. Batch is transitioning its core quota system for dedicated cores
     to be enforced per Virtual Machine family. During this transitional phase,
     the dedicated core quota per Virtual Machine family may not yet be
     enforced. If this flag is false, dedicated core quota is enforced via the
     old dedicatedCoreQuota property on the account and does not consider
     Virtual Machine family. If this flag is true, dedicated core quota is
     enforced via the dedicatedCoreQuotaPerVMFamily property on the account,
     and the old dedicatedCoreQuota does not apply.
...
class BatchAccountIdentity(Model):
    ...
    :param user_assigned_identities: The list of user identities associated
     with the Batch account. The user identity dictionary key references will
     be ARM resource ids in the form:
     '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
    :type user_assigned_identities: dict[str,
     ~azure.mgmt.batch.models.BatchAccountIdentityUserAssignedIdentitiesValue]
    """
    ...
    _attribute_map = {
        ...
        'user_assigned_identities': {'key': 'userAssignedIdentities', 'type': '{BatchAccountIdentityUserAssignedIdentitiesValue}'},
    }
...
class BatchAccountIdentityUserAssignedIdentitiesValue(Model):
    ...
    def __init__(self, **kwargs):
        super(BatchAccountIdentityUserAssignedIdentitiesValue, self).__init__(**kwargs)
        self.principal_id = None
        self.client_id = None
...
class BatchPoolIdentity(Model):
    ...
    :param type: Required. The type of identity used for the Batch Pool.
     Possible values include: 'UserAssigned', 'None'
    :type type: str or ~azure.mgmt.batch.models.PoolIdentityType
    :param user_assigned_identities: The list of user identities associated
     with the Batch pool. The user identity dictionary key references will be
     ARM resource ids in the form:
     '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
    :type user_assigned_identities: dict[str,
     ~azure.mgmt.batch.models.BatchPoolIdentityUserAssignedIdentitiesValue]
    """
    ...
    _attribute_map = {
        ...
        'user_assigned_identities': {'key': 'userAssignedIdentities', 'type': '{BatchPoolIdentityUserAssignedIdentitiesValue}'},
    }
...
class BatchPoolIdentityUserAssignedIdentitiesValue(Model):
    ...
    def __init__(self, **kwargs):
        super(BatchPoolIdentityUserAssignedIdentitiesValue, self).__init__(**kwargs)
        self.principal_id = None
        self.client_id = None
...
class Pool(ProxyResource):
    ...
    :param identity: The type of identity used for the Batch Pool. The type of
     identity used for the Batch Pool.
...
class VirtualMachineConfiguration(Model):
    ...
    :type node_placement_configuration:
     ~azure.mgmt.batch.models.NodePlacementConfiguration
    :param extensions: The virtual machine extension for the pool. If
     specified, the extensions mentioned in this configuration will be
...
class VMExtension(Model):
    ...
    :param provision_after_extensions: The collection of extension names.
