...
class BatchAccountCreateParameters(Model):
    ...
    :param public_network_access: The network access type for accessing Azure
     Batch account. Possible values include: 'Enabled', 'Disabled'. Default
     value: "Enabled" .
...
class PrivateLinkServiceConnectionState(Model):
    ...
    :param status: The status for the private endpoint connection of Batch
     account. Possible values include: 'Approved', 'Pending', 'Rejected',
     'Disconnected'
    :type status: str or
