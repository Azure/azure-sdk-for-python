...
class BatchServiceClient(SDKClient):
    ...
    :vartype application: batchservice.operations.ApplicationOperations
    :ivar pool: Pool operations
    :vartype pool: batchservice.operations.PoolOperations
    :ivar account: Account operations
    :vartype account: batchservice.operations.AccountOperations
    :ivar certificate: Certificate operations
    :vartype certificate: batchservice.operations.CertificateOperations
    :ivar file: File operations
    :vartype file: batchservice.operations.FileOperations
    :ivar job_schedule: JobSchedule operations
    :vartype job_schedule: batchservice.operations.JobScheduleOperations
    :ivar job: Job operations
    :vartype job: batchservice.operations.JobOperations
    :ivar task: Task operations
    :vartype task: batchservice.operations.TaskOperations
    :ivar compute_node: ComputeNode operations
    :vartype compute_node: batchservice.operations.ComputeNodeOperations
    :ivar compute_node_extension: ComputeNodeExtension operations
    :vartype compute_node_extension: batchservice.operations.ComputeNodeExtensionOperations
    ...
    def __init__(
        ...
        self.config = BatchServiceClientConfiguration(batch_url)
        super(BatchServiceClient, self).__init__(None, self.config)
