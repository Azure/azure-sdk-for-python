...
def build_new_create_task_collection(original_create_task_collection):
    def bulk_create_task_collection(
        self,
        job_id: str,
        collection: BatchTaskCollection,
        *,
    ...
    bulk_create_task_collection.metadata = {"url": "/jobs/{jobId}/addtaskcollection"}
    return bulk_create_task_collection
...
def build_new_get_node_file_properties(original_get):
    def new_get_node_file_properties( 
        self,
        pool_id: str,
        node_id: str,
        file_path: str,
        ...
        **kwargs: Any
        ...
        :param file_path: The path to the Compute Node file that you want to get the properties of.
         Required.
        :type file_path: str
        :param file_get_node_file_properties_options: Parameter group. Default value is None.
        :type file_get_node_file_properties_options:
    ...
    new_get_node_file_properties.metadata = {"url": "/pools/{poolId}/nodes/{nodeId}/files/{filePath}"}  # type: ignore
    return new_get_node_file_properties


def build_new_get_task_file_properties(original_get):
    def new_get_task_file_properties( 
        self,
        job_id: str,
        task_id: str,
        file_path: str,
        ...
        **kwargs: Any
        ...
        :type file_path: str
        :param file_get_task_file_properties_options: Parameter group. Default value is None.
        :type file_get_task_file_properties_options:
    ...
    new_get_task_file_properties.metadata = {"url": "/jobs/{jobId}/tasks/{taskId}/files/{filePath}"}  # type: ignore
    return new_get_task_file_properties



def build_new_get_node_file(original_get):
    def new_get_node_file( 
        self,
        job_id: str,
        task_id: str,
        file_path: str,
    ...
    new_get_node_file.metadata = {"url": "/jobs/{jobId}/tasks/{taskId}/files/{filePath}"}  # type: ignore
    return new_get_node_file


def build_new_get_node_remote_desktop_file(original_get):
    def new_get_node_remote_desktop_file( 
        self,
        pool_id: str,
        node_id: str,
        *,
    ...
    new_get_node_remote_desktop_file.metadata = {"url": "/pools/{poolId}/nodes/{nodeId}/rdp"}  # type: ignore
    return new_get_node_remote_desktop_file
...
def patch_sdk():
    ...
    operations_modules.create_task_collection = build_new_create_task_collection(
        operations_modules.create_task_collection
    )

    operations_modules.get_node_file = build_new_get_node_file(operations_modules.FileOperations.get_node_file)
    operations_modules.get_node_file_properties = build_new_get_node_file_properties(operations_modules.FileOperations.get_node_file_properties)
    operations_modules.get_task_file_properties = build_new_get_task_file_properties(operations_modules.FileOperations.get_task_file_properties)

    operations_modules.get_node_remote_desktop_file = build_new_get_node_remote_desktop_file(operations_modules.BatchNodesOperations.get_node_remote_desktop_file)
