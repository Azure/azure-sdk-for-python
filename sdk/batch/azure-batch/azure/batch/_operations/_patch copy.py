...
def patch_sdk():
    ...
    operations_modules = importlib.import_module("azure.batch._operations")
    operations_modules.BatchClientOperationsMixin.create_task_collection = build_new_create_task_collection(
        operations_modules.BatchClientOperationsMixin.create_task_collection
    )

    operations_modules.BatchClientOperationsMixin.get_node_file = build_new_get_node_file(operations_modules.BatchClientOperationsMixin.get_node_file)
    operations_modules.BatchClientOperationsMixin.get_node_file_properties = build_new_get_node_file_properties(operations_modules.BatchClientOperationsMixin.get_node_file_properties)
    operations_modules.BatchClientOperationsMixin.get_task_file_properties = build_new_get_task_file_properties(operations_modules.BatchClientOperationsMixin.get_task_file_properties)

    operations_modules.BatchClientOperationsMixin.get_node_remote_desktop_file = build_new_get_node_remote_desktop_file(operations_modules.BatchClientOperationsMixin.get_node_remote_desktop_file)
