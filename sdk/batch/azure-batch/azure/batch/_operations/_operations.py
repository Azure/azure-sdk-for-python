...
class BatchClientOperationsMixin(BatchClientMixinABC):  # pylint: disable=too-many-public-methods
    ...
    def list_pools(
        ...
        **kwargs: Any
        ...
        :keyword _filter: An OData $filter clause. For more information on constructing this filter,
         see
         https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-pools. Default
         value is None.
        :paramtype _filter: str
    ...
    def list_jobs(
        ...
        **kwargs: Any
        ...
        :keyword _filter: An OData $filter clause. For more information on constructing this filter,
         see
         https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-jobs. Default
         value is None.
        :paramtype _filter: str
        :keyword _select: An OData $select clause. Default value is None.
        :paramtype _select: list[str]
    ...
    def list_tasks(
        ...
        **kwargs: Any
        ...
        :keyword _filter: An OData $filter clause. For more information on constructing this filter,
         see
         https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-tasks. Default
         value is None.
        :paramtype _filter: str
        :keyword _select: An OData $select clause. Default value is None.
        :paramtype _select: list[str]
