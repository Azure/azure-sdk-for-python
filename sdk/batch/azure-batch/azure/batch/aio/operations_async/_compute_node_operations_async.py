...
class ComputeNodeOperations:
    ...
    async def reboot(
        ...
        **kwargs
        ...
        :type node_id: str
        :param node_reboot_option: The default value is requeue.
        ...
        _node_reboot_parameter = models.NodeRebootParameter(node_reboot_option=node_reboot_option)
        api_version = "2020-03-01.11.0"
        content_type = kwargs.pop("content_type", "application/json; odata=minimalmetadata")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        if _node_reboot_parameter is not None:
            body_content = self._serialize.body(_node_reboot_parameter, 'NodeRebootParameter')
        else:
            body_content = None
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    async def reimage(
        ...
        **kwargs
        ...
        :param node_id: The ID of the Compute Node that you want to restart.
        :type node_id: str
        :param node_reimage_option: The default value is requeue.
        ...
        _node_reimage_parameter = models.NodeReimageParameter(node_reimage_option=node_reimage_option)
        api_version = "2020-03-01.11.0"
        content_type = kwargs.pop("content_type", "application/json; odata=minimalmetadata")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        if _node_reimage_parameter is not None:
            body_content = self._serialize.body(_node_reimage_parameter, 'NodeReimageParameter')
        else:
            body_content = None
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    async def disable_scheduling(
        ...
        **kwargs
        ...
        :type node_disable_scheduling_option: str or ~azure.batch.models.DisableComputeNodeSchedulingOption
        :param compute_node_disable_scheduling_options: Parameter group.
        :type compute_node_disable_scheduling_options: ~azure.batch.models.ComputeNodeDisableSchedulingOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        _node_disable_scheduling_parameter = models.NodeDisableSchedulingParameter(node_disable_scheduling_option=node_disable_scheduling_option)
        api_version = "2020-03-01.11.0"
        content_type = kwargs.pop("content_type", "application/json; odata=minimalmetadata")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        if _node_disable_scheduling_parameter is not None:
            body_content = self._serialize.body(_node_disable_scheduling_parameter, 'NodeDisableSchedulingParameter')
        else:
            body_content = None
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    async def enable_scheduling(
        ...
        **kwargs
        ...
        :type compute_node_enable_scheduling_options: ~azure.batch.models.ComputeNodeEnableSchedulingOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def get_remote_login_settings(
        ...
        **kwargs
        ...
        :type compute_node_get_remote_login_settings_options: ~azure.batch.models.ComputeNodeGetRemoteLoginSettingsOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def get_remote_desktop(
        ...
        **kwargs
        ...
        :type compute_node_get_remote_desktop_options: ~azure.batch.models.ComputeNodeGetRemoteDesktopOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def upload_batch_service_logs(
        ...
        **kwargs
        ...
        :param upload_batch_service_logs_configuration: The Azure Batch service log files upload
         configuration.
        :type upload_batch_service_logs_configuration: ~azure.batch.models.UploadBatchServiceLogsConfiguration
        :param compute_node_upload_batch_service_logs_options: Parameter group.
        :type compute_node_upload_batch_service_logs_options: ~azure.batch.models.ComputeNodeUploadBatchServiceLogsOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ComputeNodeListResult or the result of cls(response)
        :rtype: ~azure.batch.models.ComputeNodeListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
