...
class CertificateOperations(object):
    ...
    def add(
        ...
        :type certificate: ~batchservice.models.CertificateAddParameter
        :param certificate_add_options: Additional parameters for the
         operation
        :type certificate_add_options:
         ~batchservice.models.CertificateAddOptions
    ...
    def list(
        ...
        :type certificate_list_options:
         ~batchservice.models.CertificateListOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~batchservice.models.CertificateListResult or
    ...
    def cancel_deletion(
        ...
        :type certificate_cancel_deletion_options:
         ~batchservice.models.CertificateCancelDeletionOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def delete(
        ...
        :type certificate_delete_options:
         ~batchservice.models.CertificateDeleteOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def get(
        ...
        :type certificate_get_options:
         ~batchservice.models.CertificateGetOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~batchservice.models.Certificate or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<batchservice.models.BatchErrorException>`
        """
