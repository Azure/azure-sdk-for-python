...
class FileOperations(object):
    ...
    def delete_from_task(
        ...
        :type file_delete_from_task_options:
         ~batchservice.models.FileDeleteFromTaskOptions
    ...
    def get_from_task(
        ...
        :type file_get_from_task_options:
         ~batchservice.models.FileGetFromTaskOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
    ...
    def get_properties_from_task(
        ...
        :type file_get_properties_from_task_options:
         ~batchservice.models.FileGetPropertiesFromTaskOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def delete_from_compute_node(
        ...
        :type file_delete_from_compute_node_options:
         ~batchservice.models.FileDeleteFromComputeNodeOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def get_from_compute_node(
        ...
        :type file_get_from_compute_node_options:
         ~batchservice.models.FileGetFromComputeNodeOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param callback: When specified, will be called with each chunk of
    ...
    def get_properties_from_compute_node(
        ...
        :type file_get_properties_from_compute_node_options:
         ~batchservice.models.FileGetPropertiesFromComputeNodeOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list_from_task(
        ...
        :type file_list_from_task_options:
         ~batchservice.models.FileListFromTaskOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: NodeFileListResult or ClientRawResponse if raw=true
        :rtype: ~batchservice.models.NodeFileListResult or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('NodeFileListResult', response)
            header_dict = {
                'client-request-id': 'str',
                'request-id': 'str',
                'ETag': 'str',
    ...
    def list_from_compute_node(
        ...
        :type file_list_from_compute_node_options:
         ~batchservice.models.FileListFromComputeNodeOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
