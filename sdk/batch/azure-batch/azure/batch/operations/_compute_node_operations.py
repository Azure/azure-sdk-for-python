...
class ComputeNodeOperations(object):
    ...
    def delete_user(
        ...
        :type compute_node_delete_user_options:
         ~batchservice.models.ComputeNodeDeleteUserOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def get(
        ...
        :type compute_node_get_options:
         ~batchservice.models.ComputeNodeGetOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~batchservice.models.ComputeNode or
    ...
    def reboot(
            self, pool_id, node_id, node_reboot_parameter=None, compute_node_reboot_options=None, custom_headers=None, raw=False, **operation_config):
        ...
        :type node_reboot_parameter: ~batchservice.models.NodeRebootParameter
        :param compute_node_reboot_options: Additional parameters for the
         operation
        :type compute_node_reboot_options:
         ~batchservice.models.ComputeNodeRebootOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def reimage(
            self, pool_id, node_id, node_reimage_parameter=None, compute_node_reimage_options=None, custom_headers=None, raw=False, **operation_config):
        ...
        :type node_reimage_parameter:
         ~batchservice.models.NodeReimageParameter
        :param compute_node_reimage_options: Additional parameters for the
         operation
        :type compute_node_reimage_options:
         ~batchservice.models.ComputeNodeReimageOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def disable_scheduling(
            self, pool_id, node_id, node_disable_scheduling_parameter=None, compute_node_disable_scheduling_options=None, custom_headers=None, raw=False, **operation_config):
        ...
        :type node_id: str
        :param node_disable_scheduling_parameter: The parameters for the
         request.
        :type node_disable_scheduling_parameter:
         ~batchservice.models.NodeDisableSchedulingParameter
        :param compute_node_disable_scheduling_options: Additional parameters
         for the operation
        :type compute_node_disable_scheduling_options:
         ~batchservice.models.ComputeNodeDisableSchedulingOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def enable_scheduling(
        ...
        :type compute_node_enable_scheduling_options:
         ~batchservice.models.ComputeNodeEnableSchedulingOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def get_remote_login_settings(
        ...
        :type compute_node_get_remote_login_settings_options:
         ~batchservice.models.ComputeNodeGetRemoteLoginSettingsOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :return: ComputeNodeGetRemoteLoginSettingsResult or ClientRawResponse
         if raw=true
        :rtype: ~batchservice.models.ComputeNodeGetRemoteLoginSettingsResult
    ...
    def get_remote_desktop(
        ...
        :type compute_node_get_remote_desktop_options:
         ~batchservice.models.ComputeNodeGetRemoteDesktopOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
    ...
    def upload_batch_service_logs(
        ...
        :type upload_batch_service_logs_configuration:
         ~batchservice.models.UploadBatchServiceLogsConfiguration
        :param compute_node_upload_batch_service_logs_options: Additional
         parameters for the operation
        :type compute_node_upload_batch_service_logs_options:
         ~batchservice.models.ComputeNodeUploadBatchServiceLogsOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~batchservice.models.UploadBatchServiceLogsResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<batchservice.models.BatchErrorException>`
        """
    ...
    def list(
        ...
        :type compute_node_list_options:
         ~batchservice.models.ComputeNodeListOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: ComputeNodeListResult or ClientRawResponse if raw=true
        :rtype: ~batchservice.models.ComputeNodeListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<batchservice.models.BatchErrorException>`
        """
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('ComputeNodeListResult', response)
            header_dict = {
                'client-request-id': 'str',
                'request-id': 'str',
                'ETag': 'str',
