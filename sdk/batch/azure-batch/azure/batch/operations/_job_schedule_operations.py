...
class JobScheduleOperations(object):
    ...
    def exists(
        ...
        :type job_schedule_exists_options:
         ~batchservice.models.JobScheduleExistsOptions
    ...
    def delete(
        ...
        :type job_schedule_delete_options:
         ~batchservice.models.JobScheduleDeleteOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def get(
        ...
        :type job_schedule_get_options:
         ~batchservice.models.JobScheduleGetOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~batchservice.models.CloudJobSchedule or
    ...
    def disable(
        ...
        :type job_schedule_disable_options:
         ~batchservice.models.JobScheduleDisableOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def enable(
        ...
        :type job_schedule_enable_options:
         ~batchservice.models.JobScheduleEnableOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def terminate(
        ...
        :type job_schedule_terminate_options:
         ~batchservice.models.JobScheduleTerminateOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def add(
        ...
        :type cloud_job_schedule: ~batchservice.models.JobScheduleAddParameter
        :param job_schedule_add_options: Additional parameters for the
         operation
        :type job_schedule_add_options:
         ~batchservice.models.JobScheduleAddOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list(
        ...
        :type job_schedule_list_options:
         ~batchservice.models.JobScheduleListOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: CloudJobScheduleListResult or ClientRawResponse if raw=true
        :rtype: ~batchservice.models.CloudJobScheduleListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<batchservice.models.BatchErrorException>`
        """
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('CloudJobScheduleListResult', response)
            header_dict = {
                'client-request-id': 'str',
                'request-id': 'str',
                'ETag': 'str',
