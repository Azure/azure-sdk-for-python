...
class TaskOperations(object):
    ...
    def add(
        ...
        :type task: ~batchservice.models.TaskAddParameter
        :param task_add_options: Additional parameters for the operation
        :type task_add_options: ~batchservice.models.TaskAddOptions
    ...
    def list(
        ...
        :type task_list_options: ~batchservice.models.TaskListOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: CloudTaskListResult or ClientRawResponse if raw=true
        :rtype: ~batchservice.models.CloudTaskListResult or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('CloudTaskListResult', response)
            header_dict = {
                'client-request-id': 'str',
                'request-id': 'str',
                'ETag': 'str',
    ...
    def add_collection(
            self, job_id, task_collection, task_add_collection_options=None, custom_headers=None, raw=False, **operation_config):
        ...
        :type task_collection: ~batchservice.models.TaskAddCollectionParameter
        :param task_add_collection_options: Additional parameters for the
         operation
        :type task_add_collection_options:
         ~batchservice.models.TaskAddCollectionOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~batchservice.models.TaskAddCollectionResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<batchservice.models.BatchErrorException>`
        """
    ...
    def delete(
        ...
        :type task_delete_options: ~batchservice.models.TaskDeleteOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def get(
        ...
        :type task_get_options: ~batchservice.models.TaskGetOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~batchservice.models.CloudTask or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<batchservice.models.BatchErrorException>`
        """
    ...
    def update(
            self, job_id, task_id, task_update_parameter, task_update_options=None, custom_headers=None, raw=False, **operation_config):
        ...
        :type task_update_parameter: ~batchservice.models.TaskUpdateParameter
        :param task_update_options: Additional parameters for the operation
        :type task_update_options: ~batchservice.models.TaskUpdateOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list_subtasks(
        ...
        :type task_list_subtasks_options:
         ~batchservice.models.TaskListSubtasksOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~batchservice.models.CloudTaskListSubtasksResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<batchservice.models.BatchErrorException>`
        """
    ...
    def terminate(
        ...
        :type task_terminate_options:
         ~batchservice.models.TaskTerminateOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def reactivate(
        ...
        :type task_reactivate_options:
         ~batchservice.models.TaskReactivateOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
