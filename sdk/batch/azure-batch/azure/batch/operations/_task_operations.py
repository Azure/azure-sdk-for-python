...
class TaskOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models._models.TaskListResult]
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("_models.TaskListResult", pipeline_response)
