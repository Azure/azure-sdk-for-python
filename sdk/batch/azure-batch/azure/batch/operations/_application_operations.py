...
class ApplicationOperations(object):
    ...
    def list(
        ...
        :type application_list_options:
         ~batchservice.models.ApplicationListOptions
        ...
        :rtype: ~batchservice.models.ApplicationListResult or
    ...
    def get(
        ...
        :type application_get_options:
         ~batchservice.models.ApplicationGetOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~batchservice.models.ApplicationSummary or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<batchservice.models.BatchErrorException>`
        """
