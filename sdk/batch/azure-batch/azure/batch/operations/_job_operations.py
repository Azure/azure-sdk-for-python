...
def build_patch_request(
    job_id: str,
    *,
    json: Optional[_models.BatchJobUpdate] = None,
    content: Any = None,
    timeout: Optional[int] = 30,
    client_request_id: Optional[str] = None,
    return_client_request_id: Optional[bool] = False,
...
def build_update_request(
    job_id: str,
    *,
    json: Optional[_models.BatchJob] = None,
    content: Any = None,
    timeout: Optional[int] = 30,
    client_request_id: Optional[str] = None,
    return_client_request_id: Optional[bool] = False,
...
def build_disable_request(
    job_id: str,
    *,
    json: Optional[_models.BatchJobDisableParameters] = None,
    content: Any = None,
    timeout: Optional[int] = 30,
    client_request_id: Optional[str] = None,
    return_client_request_id: Optional[bool] = False,
...
class JobOperations:
    ...
    def patch(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type job_id: str
        :param job_update: The parameters for the request.
        ...
        _content = self._serialize.body(job_update, 'BatchJobUpdate')
    ...
    def update(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        _content = self._serialize.body(job, 'BatchJob')
    ...
    def disable(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        _content = self._serialize.body(parameters, 'BatchJobDisableParameters')
    ...
    def terminate(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        if parameters is not None:
            _content = self._serialize.body(parameters, 'BatchJobTerminateParameters')
        else:
            _content = None
    ...
    def list(
        ...
        *,
        ...
        ocp_date: Optional[datetime.datetime] = None,
        **kwargs: Any
    ) -> Iterable[_models.BatchJobListResult]:
        ...
        :keyword ocp_date: The time the request was issued. Client libraries typically set this to the
         ...
         value is None.
        :paramtype ocp_date: ~datetime.datetime
        :return: An iterator like instance of BatchJobListResult
        :rtype: ~azure.core.paging.ItemPaged[~azure-batch.models.BatchJobListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_preparation_and_release_task_status(
        ...
        *,
        ...
        ocp_date: Optional[datetime.datetime] = None,
        **kwargs: Any
    ) -> Iterable[_models.BatchJobListPreparationAndReleaseTaskStatusResult]:
        ...
        :keyword ocp_date: The time the request was issued. Client libraries typically set this to the
         ...
         value is None.
        :paramtype ocp_date: ~datetime.datetime
        :return: An iterator like instance of BatchJobListPreparationAndReleaseTaskStatusResult
        :rtype:
         ~azure.core.paging.ItemPaged[~azure-batch.models.BatchJobListPreparationAndReleaseTaskStatusResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
