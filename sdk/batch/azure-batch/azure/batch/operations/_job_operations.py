...
from ..models._models import JobListPreparationAndReleaseTaskStatusResult, JobListResult
T = TypeVar('T')
...
class JobOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType[JobListResult]
    ...
    def list_preparation_and_release_task_status(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType[JobListPreparationAndReleaseTaskStatusResult]
