...
class JobOperations(object):
    ...
    def delete(
        ...
        :type job_delete_options: ~batchservice.models.JobDeleteOptions
    ...
    def get(
        ...
        :type job_get_options: ~batchservice.models.JobGetOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~batchservice.models.CloudJob or
    ...
    def patch(
        ...
        :type job_patch_parameter: ~batchservice.models.JobPatchParameter
        :param job_patch_options: Additional parameters for the operation
        :type job_patch_options: ~batchservice.models.JobPatchOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def update(
        ...
        :type job_update_parameter: ~batchservice.models.JobUpdateParameter
        :param job_update_options: Additional parameters for the operation
        :type job_update_options: ~batchservice.models.JobUpdateOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def disable(
            self, job_id, job_disable_parameter, job_disable_options=None, custom_headers=None, raw=False, **operation_config):
        ...
        :type job_disable_parameter: ~batchservice.models.JobDisableParameter
        :param job_disable_options: Additional parameters for the operation
        :type job_disable_options: ~batchservice.models.JobDisableOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def enable(
        ...
        :type job_enable_options: ~batchservice.models.JobEnableOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def terminate(
            self, job_id, job_terminate_parameter=None, job_terminate_options=None, custom_headers=None, raw=False, **operation_config):
        ...
        :type job_terminate_parameter:
         ~batchservice.models.JobTerminateParameter
        :param job_terminate_options: Additional parameters for the operation
        :type job_terminate_options: ~batchservice.models.JobTerminateOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def add(
        ...
        :type job: ~batchservice.models.JobAddParameter
        :param job_add_options: Additional parameters for the operation
        :type job_add_options: ~batchservice.models.JobAddOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list(
        ...
        :type job_list_options: ~batchservice.models.JobListOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: CloudJobListResult or ClientRawResponse if raw=true
        :rtype: ~batchservice.models.CloudJobListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<batchservice.models.BatchErrorException>`
        """
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('CloudJobListResult', response)
            header_dict = {
                'client-request-id': 'str',
                'request-id': 'str',
                'ETag': 'str',
    ...
    def list_from_job_schedule(
        ...
        :type job_list_from_job_schedule_options:
         ~batchservice.models.JobListFromJobScheduleOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list_preparation_and_release_task_status(
        ...
        :type job_list_preparation_and_release_task_status_options:
         ~batchservice.models.JobListPreparationAndReleaseTaskStatusOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: CloudJobListPreparationAndReleaseTaskStatusResult or
         ClientRawResponse if raw=true
        :rtype:
         ~batchservice.models.CloudJobListPreparationAndReleaseTaskStatusResult
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('CloudJobListPreparationAndReleaseTaskStatusResult', response)
            header_dict = {
                'client-request-id': 'str',
                'request-id': 'str',
                'ETag': 'str',
    ...
    def get_task_counts(
        ...
        :type job_get_task_counts_options:
         ~batchservice.models.JobGetTaskCountsOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~batchservice.models.TaskCountsResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<batchservice.models.BatchErrorException>`
        """
