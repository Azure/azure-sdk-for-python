...
class JobOperations(object):
    ...
    def get_all_lifetime_statistics(
        ...
        **kwargs  # type: Any
        ...
        :type job_get_all_lifetime_statistics_options: ~batch_service.models.JobGetAllLifetimeStatisticsOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: JobStatistics, or the result of cls(response)
        :rtype: ~batch_service.models.JobStatistics
    ...
    def delete(
        ...
        **kwargs  # type: Any
        ...
        :type job_delete_options: ~batch_service.models.JobDeleteOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :type job_get_options: ~batch_service.models.JobGetOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CloudJob, or the result of cls(response)
        :rtype: ~batch_service.models.CloudJob
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def patch(
        ...
        **kwargs  # type: Any
        ...
        :type job_patch_parameter: ~batch_service.models.JobPatchParameter
        :param job_patch_options: Parameter group.
        :type job_patch_options: ~batch_service.models.JobPatchOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        :type job_update_parameter: ~batch_service.models.JobUpdateParameter
        :param job_update_options: Parameter group.
        :type job_update_options: ~batch_service.models.JobUpdateOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def disable(
        self,
        job_id,  # type: str
        job_disable_parameter,  # type: "models.JobDisableParameter"
        ...
        **kwargs  # type: Any
        ...
        :type job_disable_parameter: ~batch_service.models.JobDisableParameter
        :param job_disable_options: Parameter group.
        :type job_disable_options: ~batch_service.models.JobDisableOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def enable(
        ...
        **kwargs  # type: Any
        ...
        :type job_enable_options: ~batch_service.models.JobEnableOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def terminate(
        self,
        job_id,  # type: str
        job_terminate_parameter=None,  # type: Optional["models.JobTerminateParameter"]
        ...
        **kwargs  # type: Any
        ...
        :type job_terminate_parameter: ~batch_service.models.JobTerminateParameter
        :param job_terminate_options: Parameter group.
        :type job_terminate_options: ~batch_service.models.JobTerminateOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def add(
        ...
        **kwargs  # type: Any
        ...
        :type job: ~batch_service.models.JobAddParameter
        :param job_add_options: Parameter group.
        :type job_add_options: ~batch_service.models.JobAddOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CloudJobListResult"]
        """Lists all of the Jobs in the specified Account.

        Lists all of the Jobs in the specified Account.

        :param job_list_options: Parameter group.
        :type job_list_options: ~batch_service.models.JobListOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CloudJobListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~batch_service.models.CloudJobListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_from_job_schedule(
        ...
        **kwargs  # type: Any
        ...
        :type job_list_from_job_schedule_options: ~batch_service.models.JobListFromJobScheduleOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CloudJobListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~batch_service.models.CloudJobListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_from_job_schedule.metadata['url']  # type: ignore
                path_format_arguments = {
                    'batchUrl': self._serialize.url("self._config.batch_url", self._config.batch_url, 'str', skip_quote=True),
    ...
    def list_preparation_and_release_task_status(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CloudJobListPreparationAndReleaseTaskStatusResult"]
        ...
        :type job_list_preparation_and_release_task_status_options: ~batch_service.models.JobListPreparationAndReleaseTaskStatusOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CloudJobListPreparationAndReleaseTaskStatusResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~batch_service.models.CloudJobListPreparationAndReleaseTaskStatusResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_preparation_and_release_task_status.metadata['url']  # type: ignore
                path_format_arguments = {
                    'batchUrl': self._serialize.url("self._config.batch_url", self._config.batch_url, 'str', skip_quote=True),
                    'jobId': self._serialize.url("job_id", job_id, 'str'),
                }
    ...
    def get_task_counts(
        ...
        **kwargs  # type: Any
        ...
        :type job_get_task_counts_options: ~batch_service.models.JobGetTaskCountsOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: TaskCountsResult, or the result of cls(response)
        :rtype: ~batch_service.models.TaskCountsResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.TaskCountsResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        # Construct URL
        url = self.get_task_counts.metadata['url']  # type: ignore
        path_format_arguments = {
            'batchUrl': self._serialize.url("self._config.batch_url", self._config.batch_url, 'str', skip_quote=True),
            'jobId': self._serialize.url("job_id", job_id, 'str'),
        }
