...
class ComputeNodeExtensionOperations(object):
    ...
    def get(
        ...
        :type compute_node_extension_get_options:
         ~batchservice.models.ComputeNodeExtensionGetOptions
        ...
        :rtype: ~batchservice.models.NodeVMExtension or
    ...
    def list(
        ...
        :type compute_node_extension_list_options:
         ~batchservice.models.ComputeNodeExtensionListOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: NodeVMExtensionList or ClientRawResponse if raw=true
        :rtype: ~batchservice.models.NodeVMExtensionList or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<batchservice.models.BatchErrorException>`
        """
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('NodeVMExtensionList', response)
            header_dict = {
                'client-request-id': 'str',
                'request-id': 'str',
                'ETag': 'str',
