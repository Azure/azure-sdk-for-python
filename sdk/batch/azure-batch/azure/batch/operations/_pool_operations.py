...
class PoolOperations(object):
    ...
    def list_usage_metrics(
        ...
        :type pool_list_usage_metrics_options:
         ~batchservice.models.PoolListUsageMetricsOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: PoolListUsageMetricsResult or ClientRawResponse if raw=true
        :rtype: ~batchservice.models.PoolListUsageMetricsResult or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('PoolListUsageMetricsResult', response)
            header_dict = {
    ...
    def add(
        ...
        :type pool: ~batchservice.models.PoolAddParameter
        :param pool_add_options: Additional parameters for the operation
        :type pool_add_options: ~batchservice.models.PoolAddOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list(
        ...
        :type pool_list_options: ~batchservice.models.PoolListOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: CloudPoolListResult or ClientRawResponse if raw=true
        :rtype: ~batchservice.models.CloudPoolListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<batchservice.models.BatchErrorException>`
        """
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('CloudPoolListResult', response)
            header_dict = {
                'client-request-id': 'str',
                'request-id': 'str',
                'ETag': 'str',
    ...
    def delete(
        ...
        :type pool_delete_options: ~batchservice.models.PoolDeleteOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def exists(
        ...
        :type pool_exists_options: ~batchservice.models.PoolExistsOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def get(
        ...
        :type pool_get_options: ~batchservice.models.PoolGetOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~batchservice.models.CloudPool or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<batchservice.models.BatchErrorException>`
        """
    ...
    def patch(
        ...
        :type pool_patch_parameter: ~batchservice.models.PoolPatchParameter
        :param pool_patch_options: Additional parameters for the operation
        :type pool_patch_options: ~batchservice.models.PoolPatchOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def disable_auto_scale(
        ...
        :type pool_disable_auto_scale_options:
         ~batchservice.models.PoolDisableAutoScaleOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def evaluate_auto_scale(
            self, pool_id, pool_evaluate_auto_scale_parameter, pool_evaluate_auto_scale_options=None, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~batchservice.models.AutoScaleRun or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<batchservice.models.BatchErrorException>`
        """
    ...
    def resize(
        ...
        :type pool_resize_parameter: ~batchservice.models.PoolResizeParameter
        :param pool_resize_options: Additional parameters for the operation
        :type pool_resize_options: ~batchservice.models.PoolResizeOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def stop_resize(
        ...
        :type pool_stop_resize_options:
         ~batchservice.models.PoolStopResizeOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def remove_nodes(
        ...
        :type node_remove_parameter: ~batchservice.models.NodeRemoveParameter
        :param pool_remove_nodes_options: Additional parameters for the
         operation
        :type pool_remove_nodes_options:
         ~batchservice.models.PoolRemoveNodesOptions
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
