...
from ..models._models import PoolListResult, PoolListUsageMetricsResult
T = TypeVar('T')
...
def build_enable_auto_scale_request(
    pool_id: str,
    *,
    json: _models.PoolEnableAutoScaleParameters,
    timeout: int = 30,
    client_request_id: Optional[str] = None,
    return_client_request_id: bool = False,
    ocp_date: Optional[datetime.datetime] = None,
...
def build_evaluate_auto_scale_request(
    pool_id: str,
    *,
    json: _models.PoolEvaluateAutoScaleParameters,
    timeout: int = 30,
    client_request_id: Optional[str] = None,
    return_client_request_id: bool = False,
    ocp_date: Optional[datetime.datetime] = None,
...
class PoolOperations:
    ...
    def list_usage_metrics(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType[PoolListUsageMetricsResult]
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure-batch.models.Pool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls = kwargs.pop('cls', None)  # type: ClsType[PoolListResult]
