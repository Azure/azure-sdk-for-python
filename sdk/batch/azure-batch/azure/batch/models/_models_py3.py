...
class AccountListPoolNodeCountsOptions(msrest.serialization.Model):
    ...
    :vartype filter: str
    :ivar max_results: The maximum number of items to return in the response.
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword max_results: The maximum number of items to return in the response.
...
class FileGetFromComputeNodeOptions(msrest.serialization.Model):
    ...
    :ivar ocp_date: The time the request was issued. Client libraries typically set this to the
     current system clock time; set it explicitly if you are calling the REST API directly.
    :vartype ocp_date: ~datetime.datetime
    :ivar ocp_range: The byte range to be retrieved. The default is to retrieve the entire file.
     The format is bytes=startRange-endRange.
    :vartype ocp_range: str
    :ivar if_modified_since: A timestamp indicating the last modified time of the resource known to
     the client. The operation will be performed only if the resource on the service has been
     modified since the specified time.
    :vartype if_modified_since: ~datetime.datetime
    :ivar if_unmodified_since: A timestamp indicating the last modified time of the resource known
...
class JobDeleteOptions(msrest.serialization.Model):
    ...
    :ivar ocp_date: The time the request was issued. Client libraries typically set this to the
     current system clock time; set it explicitly if you are calling the REST API directly.
    :vartype ocp_date: ~datetime.datetime
    :ivar if_match: An ETag value associated with the version of the resource known to the client.
    ...
    :ivar if_none_match: An ETag value associated with the version of the resource known to the
...
class JobGetOptions(msrest.serialization.Model):
    ...
    :ivar select: An OData $select clause.
    :vartype select: str
    :ivar expand: An OData $expand clause.
    :vartype expand: str
    :ivar timeout: The maximum time that the server can spend processing the request, in seconds.
     The default is 30 seconds.
    :vartype timeout: int
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword select: An OData $select clause.
        :paramtype select: str
        :keyword expand: An OData $expand clause.
...
class JobScheduleListOptions(msrest.serialization.Model):
    ...
    :ivar expand: An OData $expand clause.
    :vartype expand: str
    :ivar max_results: The maximum number of items to return in the response. A maximum of 1000 Job
...
class PoolListUsageMetricsOptions(msrest.serialization.Model):
    ...
    :vartype start_time: ~datetime.datetime
    :ivar end_time: The latest time from which to include metrics. This must be at least two hours
