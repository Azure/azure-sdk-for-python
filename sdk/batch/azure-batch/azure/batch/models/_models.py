...
class AccountListPoolNodeCountsOptions(msrest.serialization.Model):
    ...
    :param timeout: The maximum time that the server can spend processing the request, in seconds.
     The default is 30 seconds.
    :type timeout: int
    :param client_request_id: The caller-generated request identity, in the form of a GUID with no
     decoration such as curly braces, e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0.
    :type client_request_id: str
    :param return_client_request_id: Whether the server should return the client-request-id in the
     response.
    :type return_client_request_id: bool
    :param ocp_date: The time the request was issued. Client libraries typically set this to the
     current system clock time; set it explicitly if you are calling the REST API directly.
    :type ocp_date: ~datetime.datetime
    """
...
class AccountListSupportedImagesOptions(msrest.serialization.Model):
    ...
    :param filter: An OData $filter clause. For more information on constructing this filter, see
     https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-support-
     images.
    :type filter: str
...
class AccountListSupportedImagesResult(msrest.serialization.Model):
    ...
    :param value: The list of supported Virtual Machine Images.
    :type value: list[~batch_service.models.ImageInformation]
...
class AffinityInformation(msrest.serialization.Model):
    ...
    :param affinity_id: Required. You can pass the affinityId of a Node to indicate that this Task
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.affinity_id = kwargs['affinity_id']
...
class ApplicationListResult(msrest.serialization.Model):
    ...
    :param value: The list of applications available in the Account.
    :type value: list[~batch_service.models.ApplicationSummary]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class ApplicationPackageReference(msrest.serialization.Model):
    ...
    :param version: If this is omitted on a Pool, and no default version is specified for this
...
class ApplicationSummary(msrest.serialization.Model):
    ...
    :param id: Required. A string that uniquely identifies the application within the Account.
    :type id: str
    :param display_name: Required. The display name for the application.
    :type display_name: str
    :param versions: Required. The list of available versions of the application.
...
class AuthenticationTokenSettings(msrest.serialization.Model):
    ...
    :param access: The authentication token grants access to a limited set of Batch service
...
class AutoPoolSpecification(msrest.serialization.Model):
    ...
    :param pool_lifetime_option: Required. The minimum lifetime of created auto Pools, and how
     multiple Jobs on a schedule are assigned to Pools. Possible values include: "jobschedule",
     "job".
    :type pool_lifetime_option: str or ~batch_service.models.PoolLifetimeOption
    :param keep_alive: If false, the Batch service deletes the Pool once its lifetime (as
    ...
    :param pool: Specification for creating a new Pool.
    :type pool: ~batch_service.models.PoolSpecification
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.pool_lifetime_option = kwargs['pool_lifetime_option']
...
class AutoScaleRun(msrest.serialization.Model):
    ...
    :param timestamp: Required. The time at which the autoscale formula was last evaluated.
    :type timestamp: ~datetime.datetime
    :param results: Each variable value is returned in the form $variable=value, and variables are
     separated by semicolons.
    :type results: str
    :param error: An error that occurred when executing or evaluating a Pool autoscale formula.
    :type error: ~batch_service.models.AutoScaleRunError
    """
...
class AutoScaleRunError(msrest.serialization.Model):
    ...
    :param code: An identifier for the autoscale error. Codes are invariant and are intended to be
     consumed programmatically.
    :type code: str
    :param message: A message describing the autoscale error, intended to be suitable for display
     in a user interface.
    :type message: str
    :param values: A list of additional error details related to the autoscale error.
    :type values: list[~batch_service.models.NameValuePair]
    """
...
class AutoUserSpecification(msrest.serialization.Model):
    ...
    :type scope: str or ~batch_service.models.AutoUserScope
    :param elevation_level: The default value is nonAdmin. Possible values include: "nonadmin",
     "admin".
    :type elevation_level: str or ~batch_service.models.ElevationLevel
    """
...
class BatchError(msrest.serialization.Model):
    ...
    :param code: An identifier for the error. Codes are invariant and are intended to be consumed
     programmatically.
    :type code: str
    :param message: An error message received in an Azure Batch error response.
    :type message: ~batch_service.models.ErrorMessage
    :param values: A collection of key-value pairs containing additional details about the error.
    :type values: list[~batch_service.models.BatchErrorDetail]
    """
...
class Certificate(msrest.serialization.Model):
    ...
    :param thumbprint: The X.509 thumbprint of the Certificate. This is a sequence of up to 40 hex
     digits.
    :type thumbprint: str
    ...
    :type url: str
    :param state: The state of the Certificate. Possible values include: "active", "deleting",
     "deletefailed".
    :type state: str or ~batch_service.models.CertificateState
    :param state_transition_time: The time at which the Certificate entered its current state.
    :type state_transition_time: ~datetime.datetime
    :param previous_state: This property is not set if the Certificate is in its initial active
     state. Possible values include: "active", "deleting", "deletefailed".
    :type previous_state: str or ~batch_service.models.CertificateState
    :param previous_state_transition_time: This property is not set if the Certificate is in its
     initial Active state.
    :type previous_state_transition_time: ~datetime.datetime
    :param public_data: The public part of the Certificate as a base-64 encoded .cer file.
    :type public_data: str
    :param delete_certificate_error: This property is set only if the Certificate is in the
     DeleteFailed state.
    :type delete_certificate_error: ~batch_service.models.DeleteCertificateError
    """
...
class CertificateAddParameter(msrest.serialization.Model):
    ...
    :param thumbprint: Required. The X.509 thumbprint of the Certificate. This is a sequence of up
     to 40 hex digits (it may include spaces but these are removed).
    :type thumbprint: str
    :param thumbprint_algorithm: Required. The algorithm used to derive the thumbprint. This must
     be sha1.
    :type thumbprint_algorithm: str
    :param data: Required. The base64-encoded contents of the Certificate. The maximum size is
     10KB.
    :type data: str
    :param certificate_format: The format of the Certificate data. Possible values include: "pfx",
     "cer".
    :type certificate_format: str or ~batch_service.models.CertificateFormat
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.thumbprint_algorithm = kwargs['thumbprint_algorithm']
...
class CertificateListOptions(msrest.serialization.Model):
    ...
    :param filter: An OData $filter clause. For more information on constructing this filter, see
     https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-
     certificates.
    :type filter: str
    :param select: An OData $select clause.
    :type select: str
...
class CertificateListResult(msrest.serialization.Model):
    ...
    :param value: The list of Certificates.
    :type value: list[~batch_service.models.Certificate]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class CertificateReference(msrest.serialization.Model):
    ...
    :type thumbprint: str
    :param thumbprint_algorithm: Required. The algorithm with which the thumbprint is associated.
     This must be sha1.
    :type thumbprint_algorithm: str
    ...
    :type store_location: str or ~batch_service.models.CertificateStoreLocation
    :param store_name: This property is applicable only for Pools configured with Windows Compute
    ...
    :type store_name: str
    :param visibility: You can specify more than one visibility in this collection. The default is
     all Accounts.
    :type visibility: list[str or ~batch_service.models.CertificateVisibility]
    """
...
class CloudJob(msrest.serialization.Model):
    ...
    :param id: The ID is case-preserving and case-insensitive (that is, you may not have two IDs
     within an Account that differ only by case).
    :type id: str
    :param display_name: The display name for the Job.
    :type display_name: str
    :param uses_task_dependencies: Whether Tasks in the Job can define dependencies on each other.
     The default is false.
    :type uses_task_dependencies: bool
    :param url: The URL of the Job.
    :type url: str
    :param e_tag: This is an opaque string. You can use it to detect whether the Job has changed
    ...
    :type e_tag: str
    :param last_modified: This is the last time at which the Job level data, such as the Job state
    ...
    :param state: The state of the Job. Possible values include: "active", "disabling", "disabled",
     "enabling", "terminating", "completed", "deleting".
    :type state: str or ~batch_service.models.JobState
    :param state_transition_time: The time at which the Job entered its current state.
    :type state_transition_time: ~datetime.datetime
    :param previous_state: This property is not set if the Job is in its initial Active state.
     Possible values include: "active", "disabling", "disabled", "enabling", "terminating",
     "completed", "deleting".
    :type previous_state: str or ~batch_service.models.JobState
    :param previous_state_transition_time: This property is not set if the Job is in its initial
     Active state.
    :type previous_state_transition_time: ~datetime.datetime
    :param priority: Priority values can range from -1000 to 1000, with -1000 being the lowest
     priority and 1000 being the highest priority. The default value is 0.
    :type priority: int
    :param constraints: The execution constraints for a Job.
    :type constraints: ~batch_service.models.JobConstraints
    :param job_manager_task: The Job Manager Task is automatically started when the Job is created.
    ...
    :type job_manager_task: ~batch_service.models.JobManagerTask
    :param job_preparation_task: The Job Preparation Task is a special Task run on each Compute
     Node before any other Task of the Job.
    :type job_preparation_task: ~batch_service.models.JobPreparationTask
    :param job_release_task: The Job Release Task is a special Task run at the end of the Job on
     each Compute Node that has run any other Task of the Job.
    :type job_release_task: ~batch_service.models.JobReleaseTask
    :param common_environment_settings: Individual Tasks can override an environment setting
     specified here by specifying the same setting name with a different value.
    :type common_environment_settings: list[~batch_service.models.EnvironmentSetting]
    :param pool_info: Specifies how a Job should be assigned to a Pool.
    :type pool_info: ~batch_service.models.PoolInformation
    :param on_all_tasks_complete: The default is noaction. Possible values include: "noaction",
     "terminatejob".
    :type on_all_tasks_complete: str or ~batch_service.models.OnAllTasksComplete
    :param on_task_failure: A Task is considered to have failed if has a failureInfo. A failureInfo
     ...
     default is noaction. Possible values include: "noaction", "performexitoptionsjobaction".
    :type on_task_failure: str or ~batch_service.models.OnTaskFailure
    :param network_configuration: The network configuration for the Job.
    :type network_configuration: ~batch_service.models.JobNetworkConfiguration
    :param metadata: The Batch service does not assign any meaning to metadata; it is solely for
     the use of user code.
    :type metadata: list[~batch_service.models.MetadataItem]
    :param execution_info: Contains information about the execution of a Job in the Azure Batch
     service.
    :type execution_info: ~batch_service.models.JobExecutionInformation
    :param stats: This property is populated only if the CloudJob was retrieved with an expand
    ...
    :type stats: ~batch_service.models.JobStatistics
    """
...
class CloudJobListPreparationAndReleaseTaskStatusResult(msrest.serialization.Model):
    ...
    :param value: A list of Job Preparation and Job Release Task execution information.
    :type value: list[~batch_service.models.JobPreparationAndReleaseTaskExecutionInformation]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class CloudJobListResult(msrest.serialization.Model):
    ...
    :type value: list[~batch_service.models.CloudJob]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class CloudJobSchedule(msrest.serialization.Model):
    ...
    :param id: A string that uniquely identifies the schedule within the Account.
    :type id: str
    :param display_name: The display name for the schedule.
    :type display_name: str
    :param url: The URL of the Job Schedule.
    :type url: str
    :param e_tag: This is an opaque string. You can use it to detect whether the Job Schedule has
    ...
    :type e_tag: str
    :param last_modified: This is the last time at which the schedule level data, such as the Job
    ...
    :type creation_time: ~datetime.datetime
    :param state: The state of the Job Schedule. Possible values include: "active", "completed",
     "disabled", "terminating", "deleting".
    :type state: str or ~batch_service.models.JobScheduleState
    :param state_transition_time: The time at which the Job Schedule entered the current state.
    :type state_transition_time: ~datetime.datetime
    :param previous_state: This property is not present if the Job Schedule is in its initial
     active state. Possible values include: "active", "completed", "disabled", "terminating",
     "deleting".
    :type previous_state: str or ~batch_service.models.JobScheduleState
    :param previous_state_transition_time: This property is not present if the Job Schedule is in
     its initial active state.
    :type previous_state_transition_time: ~datetime.datetime
    :param schedule: The schedule according to which Jobs will be created.
    :type schedule: ~batch_service.models.Schedule
    :param job_specification: Specifies details of the Jobs to be created on a schedule.
    :type job_specification: ~batch_service.models.JobSpecification
    :param execution_info: Contains information about Jobs that have been and will be run under a
     Job Schedule.
    :type execution_info: ~batch_service.models.JobScheduleExecutionInformation
    :param metadata: The Batch service does not assign any meaning to metadata; it is solely for
     the use of user code.
    :type metadata: list[~batch_service.models.MetadataItem]
    :param stats: Resource usage statistics for a Job Schedule.
    :type stats: ~batch_service.models.JobScheduleStatistics
    """
...
class CloudJobScheduleListResult(msrest.serialization.Model):
    ...
    :param value: The list of Job Schedules.
    :type value: list[~batch_service.models.CloudJobSchedule]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class CloudPool(msrest.serialization.Model):
    ...
    :param id: The ID can contain any combination of alphanumeric characters including hyphens and
     underscores, and cannot contain more than 64 characters. The ID is case-preserving and case-
     insensitive (that is, you may not have two IDs within an Account that differ only by case).
    :type id: str
    ...
    :type url: str
    :param e_tag: This is an opaque string. You can use it to detect whether the Pool has changed
    ...
    :type e_tag: str
    :param last_modified: This is the last time at which the Pool level data, such as the
    ...
    :type creation_time: ~datetime.datetime
    :param state: The current state of the Pool. Possible values include: "active", "deleting".
    :type state: str or ~batch_service.models.PoolState
    :param state_transition_time: The time at which the Pool entered its current state.
    :type state_transition_time: ~datetime.datetime
    :param allocation_state: Whether the Pool is resizing. Possible values include: "steady",
     "resizing", "stopping".
    :type allocation_state: str or ~batch_service.models.AllocationState
    :param allocation_state_transition_time: The time at which the Pool entered its current
     allocation state.
    :type allocation_state_transition_time: ~datetime.datetime
    :param vm_size: For information about available sizes of virtual machines in Pools, see Choose
    ...
    :type cloud_service_configuration: ~batch_service.models.CloudServiceConfiguration
    :param virtual_machine_configuration: This property and cloudServiceConfiguration are mutually
     exclusive and one of the properties must be specified.
    :type virtual_machine_configuration: ~batch_service.models.VirtualMachineConfiguration
    :param resize_timeout: This is the timeout for the most recent resize operation. (The initial
     sizing when the Pool is created counts as a resize.) The default value is 15 minutes.
    :type resize_timeout: ~datetime.timedelta
    :param resize_errors: This property is set only if one or more errors occurred during the last
     Pool resize, and only when the Pool allocationState is Steady.
    :type resize_errors: list[~batch_service.models.ResizeError]
    :param current_dedicated_nodes: The number of dedicated Compute Nodes currently in the Pool.
    :type current_dedicated_nodes: int
    :param current_low_priority_nodes: Low-priority Compute Nodes which have been preempted are
    ...
    :param enable_auto_scale: If false, at least one of targetDedicateNodes and
    ...
    :param auto_scale_formula: This property is set only if the Pool automatically scales, i.e.
     enableAutoScale is true.
    :type auto_scale_formula: str
    :param auto_scale_evaluation_interval: This property is set only if the Pool automatically
     scales, i.e. enableAutoScale is true.
    :type auto_scale_evaluation_interval: ~datetime.timedelta
    :param auto_scale_run: This property is set only if the Pool automatically scales, i.e.
     enableAutoScale is true.
    :type auto_scale_run: ~batch_service.models.AutoScaleRun
    :param enable_inter_node_communication: This imposes restrictions on which Compute Nodes can be
    ...
    :type network_configuration: ~batch_service.models.NetworkConfiguration
    :param start_task: Batch will retry Tasks when a recovery operation is triggered on a Node.
    ...
    :type start_task: ~batch_service.models.StartTask
    :param certificate_references: For Windows Nodes, the Batch service installs the Certificates
    ...
    :type certificate_references: list[~batch_service.models.CertificateReference]
    :param application_package_references: Changes to Package references affect all new Nodes
    ...
    :type application_package_references: list[~batch_service.models.ApplicationPackageReference]
    ...
    :type task_scheduling_policy: ~batch_service.models.TaskSchedulingPolicy
    :param user_accounts: The list of user Accounts to be created on each Compute Node in the Pool.
    :type user_accounts: list[~batch_service.models.UserAccount]
    :param metadata: A list of name-value pairs associated with the Pool as metadata.
    :type metadata: list[~batch_service.models.MetadataItem]
    :param stats: This property is populated only if the CloudPool was retrieved with an expand
     clause including the 'stats' attribute; otherwise it is null. The statistics may not be
     immediately available. The Batch service performs periodic roll-up of statistics. The typical
     delay is about 30 minutes.
    :type stats: ~batch_service.models.PoolStatistics
    :param mount_configuration: This supports Azure Files, NFS, CIFS/SMB, and Blobfuse.
    :type mount_configuration: list[~batch_service.models.MountConfiguration]
    """
...
class CloudPoolListResult(msrest.serialization.Model):
    ...
    :param value: The list of Pools.
    :type value: list[~batch_service.models.CloudPool]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class CloudServiceConfiguration(msrest.serialization.Model):
    ...
    :param os_family: Required. Possible values are:
     ...
     Releases (https://azure.microsoft.com/documentation/articles/cloud-services-guestos-update-
     matrix/#releases).
    :type os_family: str
...
class CloudTask(msrest.serialization.Model):
    ...
    :type url: str
    :param e_tag: This is an opaque string. You can use it to detect whether the Task has changed
    ...
    :type creation_time: ~datetime.datetime
    :param exit_conditions: How the Batch service should respond when the Task completes.
    :type exit_conditions: ~batch_service.models.ExitConditions
    :param state: The state of the Task. Possible values include: "active", "preparing", "running",
     "completed".
    :type state: str or ~batch_service.models.TaskState
    :param state_transition_time: The time at which the Task entered its current state.
    :type state_transition_time: ~datetime.datetime
    :param previous_state: This property is not set if the Task is in its initial Active state.
     Possible values include: "active", "preparing", "running", "completed".
    :type previous_state: str or ~batch_service.models.TaskState
    :param previous_state_transition_time: This property is not set if the Task is in its initial
     Active state.
    :type previous_state_transition_time: ~datetime.datetime
    :param command_line: For multi-instance Tasks, the command line is executed as the primary
     ...
     environment variable (https://docs.microsoft.com/en-us/azure/batch/batch-compute-node-
     environment-variables).
    :type command_line: str
    :param container_settings: If the Pool that will run this Task has containerConfiguration set,
    ...
    :type container_settings: ~batch_service.models.TaskContainerSettings
    :param resource_files: For multi-instance Tasks, the resource files will only be downloaded to
     ...
     Containers.
    :type resource_files: list[~batch_service.models.ResourceFile]
    :param output_files: For multi-instance Tasks, the files will only be uploaded from the Compute
     Node on which the primary Task is executed.
    :type output_files: list[~batch_service.models.OutputFile]
    :param environment_settings: A list of environment variable settings for the Task.
    :type environment_settings: list[~batch_service.models.EnvironmentSetting]
    :param affinity_info: A locality hint that can be used by the Batch service to select a Compute
     Node on which to start a Task.
    :type affinity_info: ~batch_service.models.AffinityInformation
    :param constraints: Execution constraints to apply to a Task.
    :type constraints: ~batch_service.models.TaskConstraints
    :param required_slots: The default is 1. A Task can only be scheduled to run on a compute node
    ...
    :param user_identity: If omitted, the Task runs as a non-administrative user unique to the
     Task.
    :type user_identity: ~batch_service.models.UserIdentity
    :param execution_info: Information about the execution of a Task.
    :type execution_info: ~batch_service.models.TaskExecutionInformation
    :param node_info: Information about the Compute Node on which a Task ran.
    :type node_info: ~batch_service.models.ComputeNodeInformation
    :param multi_instance_settings: Multi-instance Tasks are commonly used to support MPI Tasks. In
    ...
    :type multi_instance_settings: ~batch_service.models.MultiInstanceSettings
    :param stats: Resource usage statistics for a Task.
    :type stats: ~batch_service.models.TaskStatistics
    :param depends_on: This Task will not be scheduled until all Tasks that it depends on have
     completed successfully. If any of those Tasks fail and exhaust their retry counts, this Task
     will never be scheduled.
    :type depends_on: ~batch_service.models.TaskDependencies
    :param application_package_references: Application packages are downloaded and deployed to a
    ...
    :type application_package_references: list[~batch_service.models.ApplicationPackageReference]
    :param authentication_token_settings: If this property is set, the Batch service provides the
     ...
     Job.
    :type authentication_token_settings: ~batch_service.models.AuthenticationTokenSettings
    """
...
class CloudTaskListResult(msrest.serialization.Model):
    ...
    :param value: The list of Tasks.
    :type value: list[~batch_service.models.CloudTask]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class CloudTaskListSubtasksResult(msrest.serialization.Model):
    ...
    :type value: list[~batch_service.models.SubtaskInformation]
    """
...
class ComputeNode(msrest.serialization.Model):
    ...
    :param id: Every Compute Node that is added to a Pool is assigned a unique ID. Whenever a
    ...
    :type url: str
    :param state: The low-priority Compute Node has been preempted. Tasks which were running on the
     ...
     "offline", "preempted".
    :type state: str or ~batch_service.models.ComputeNodeState
    :param scheduling_state: Whether the Compute Node is available for Task scheduling. Possible
     values include: "enabled", "disabled".
    :type scheduling_state: str or ~batch_service.models.SchedulingState
    :param state_transition_time: The time at which the Compute Node entered its current state.
    :type state_transition_time: ~datetime.datetime
    :param last_boot_time: This property may not be present if the Compute Node state is unusable.
    :type last_boot_time: ~datetime.datetime
    :param allocation_time: This is the time when the Compute Node was initially allocated and
     doesn't change once set. It is not updated when the Compute Node is service healed or
     preempted.
    :type allocation_time: ~datetime.datetime
    :param ip_address: Every Compute Node that is added to a Pool is assigned a unique IP address.
    ...
    :type ip_address: str
    :param affinity_id: Note that this is just a soft affinity. If the target Compute Node is busy
    ...
    :param vm_size: For information about available sizes of virtual machines in Pools, see Choose
     ...
     (https://docs.microsoft.com/azure/batch/batch-pool-vm-sizes).
    :type vm_size: str
    :param total_tasks_run: The total number of Job Tasks completed on the Compute Node. This
     includes Job Manager Tasks and normal Tasks, but not Job Preparation, Job Release or Start
     Tasks.
    :type total_tasks_run: int
    :param running_tasks_count: The total number of currently running Job Tasks on the Compute
     Node. This includes Job Manager Tasks and normal Tasks, but not Job Preparation, Job Release or
     Start Tasks.
    :type running_tasks_count: int
    :param running_task_slots_count: The total number of scheduling slots used by currently running
    ...
    :param total_tasks_succeeded: The total number of Job Tasks which completed successfully (with
    ...
    :param recent_tasks: This property is present only if at least one Task has run on this Compute
     Node since it was assigned to the Pool.
    :type recent_tasks: list[~batch_service.models.TaskInformation]
    :param start_task: Batch will retry Tasks when a recovery operation is triggered on a Node.
     Examples of recovery operations include (but are not limited to) when an unhealthy Node is
     rebooted or a Compute Node disappeared due to host failure. Retries due to recovery operations
     are independent of and are not counted against the maxTaskRetryCount. Even if the
     ...
     as this will block Batch from being able to re-run the StartTask.
    :type start_task: ~batch_service.models.StartTask
    :param start_task_info: Information about a StartTask running on a Compute Node.
    :type start_task_info: ~batch_service.models.StartTaskInformation
    :param certificate_references: For Windows Nodes, the Batch service installs the Certificates
     to the specified Certificate store and location. For Linux Compute Nodes, the Certificates are
     stored in a directory inside the Task working directory and an environment variable
     AZ_BATCH_CERTIFICATES_DIR is supplied to the Task to query for this location. For Certificates
     ...
     (e.g., /home/{user-name}/certs) and Certificates are placed in that directory.
    :type certificate_references: list[~batch_service.models.CertificateReference]
    :param errors: The list of errors that are currently being encountered by the Compute Node.
    :type errors: list[~batch_service.models.ComputeNodeError]
    :param is_dedicated: Whether this Compute Node is a dedicated Compute Node. If false, the
     Compute Node is a low-priority Compute Node.
    :type is_dedicated: bool
    :param endpoint_configuration: The endpoint configuration for the Compute Node.
    :type endpoint_configuration: ~batch_service.models.ComputeNodeEndpointConfiguration
    :param node_agent_info: The Batch Compute Node agent is a program that runs on each Compute
     Node in the Pool and provides Batch capability on the Compute Node.
    :type node_agent_info: ~batch_service.models.NodeAgentInformation
    """
...
class ComputeNodeEndpointConfiguration(msrest.serialization.Model):
    ...
    :param inbound_endpoints: Required. The list of inbound endpoints that are accessible on the
     Compute Node.
    :type inbound_endpoints: list[~batch_service.models.InboundEndpoint]
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.inbound_endpoints = kwargs['inbound_endpoints']


class ComputeNodeError(msrest.serialization.Model):
    """An error encountered by a Compute Node.

    :param code: An identifier for the Compute Node error. Codes are invariant and are intended to
     be consumed programmatically.
    :type code: str
    :param message: A message describing the Compute Node error, intended to be suitable for
     display in a user interface.
    :type message: str
    :param error_details: The list of additional error details related to the Compute Node error.
    :type error_details: list[~batch_service.models.NameValuePair]
    """
...
class ComputeNodeGetRemoteLoginSettingsResult(msrest.serialization.Model):
    ...
    :param remote_login_ip_address: Required. The IP address used for remote login to the Compute
     Node.
    :type remote_login_ip_address: str
    :param remote_login_port: Required. The port used for remote login to the Compute Node.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.remote_login_ip_address = kwargs['remote_login_ip_address']
        self.remote_login_port = kwargs['remote_login_port']


class ComputeNodeInformation(msrest.serialization.Model):
    """Information about the Compute Node on which a Task ran.

    :param affinity_id: An identifier for the Node on which the Task ran, which can be passed when
    ...
    :type node_id: str
    :param task_root_directory: The root directory of the Task on the Compute Node.
    :type task_root_directory: str
    :param task_root_directory_url: The URL to the root directory of the Task on the Compute Node.
...
class ComputeNodeListOptions(msrest.serialization.Model):
    ...
    :param filter: An OData $filter clause. For more information on constructing this filter, see
     https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-nodes-in-a-
     pool.
    :type filter: str
    :param select: An OData $select clause.
    :type select: str
...
class ComputeNodeListResult(msrest.serialization.Model):
    ...
    :param value: The list of Compute Nodes.
    :type value: list[~batch_service.models.ComputeNode]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class ComputeNodeUser(msrest.serialization.Model):
    ...
    :type name: str
    :param is_admin: The default value is false.
    :type is_admin: bool
    :param expiry_time: If omitted, the default is 1 day from the current time. For Linux Compute
     Nodes, the expiryTime has a precision up to a day.
    :type expiry_time: ~datetime.datetime
    :param password: The password is required for Windows Compute Nodes (those created with
    ...
    :type password: str
    :param ssh_public_key: The public key should be compatible with OpenSSH encoding and should be
...
class ContainerConfiguration(msrest.serialization.Model):
    ...
    :type container_registries: list[~batch_service.models.ContainerRegistry]
    """
...
class DataDisk(msrest.serialization.Model):
    ...
    :type lun: int
    :param caching: The default value for caching is readwrite. For information about the caching
     options see: https://blogs.msdn.microsoft.com/windowsazurestorage/2012/06/27/exploring-windows-
     azure-drives-disks-and-images/. Possible values include: "none", "readonly", "readwrite".
    :type caching: str or ~batch_service.models.CachingType
    :param disk_size_gb: Required. The initial disk size in gigabytes.
    :type disk_size_gb: int
    :param storage_account_type: If omitted, the default is "standard_lrs". Possible values
     include: "standard_lrs", "premium_lrs".
    :type storage_account_type: str or ~batch_service.models.StorageAccountType
    """
...
class DeleteCertificateError(msrest.serialization.Model):
    ...
    :param code: An identifier for the Certificate deletion error. Codes are invariant and are
     intended to be consumed programmatically.
    :type code: str
    :param message: A message describing the Certificate deletion error, intended to be suitable
     for display in a user interface.
    :type message: str
    :param values: This list includes details such as the active Pools and Compute Nodes
...
class DiskEncryptionConfiguration(msrest.serialization.Model):
    ...
    :param targets: If omitted, no disks on the compute nodes in the pool will be encrypted. On
     Linux pool, only "TemporaryDisk" is supported; on Windows pool, "OsDisk" and "TemporaryDisk"
     must be specified.
    :type targets: list[str or ~batch_service.models.DiskEncryptionTarget]
    """
...
class ExitCodeMapping(msrest.serialization.Model):
    ...
    :type code: int
    :param exit_options: Required. Specifies how the Batch service responds to a particular exit
     condition.
    :type exit_options: ~batch_service.models.ExitOptions
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.exit_options = kwargs['exit_options']
...
class ExitConditions(msrest.serialization.Model):
    ...
    :param exit_codes: A list of individual Task exit codes and how the Batch service should
     respond to them.
    :type exit_codes: list[~batch_service.models.ExitCodeMapping]
    :param exit_code_ranges: A list of Task exit code ranges and how the Batch service should
     respond to them.
    :type exit_code_ranges: list[~batch_service.models.ExitCodeRangeMapping]
    :param pre_processing_error: Specifies how the Batch service responds to a particular exit
     condition.
    :type pre_processing_error: ~batch_service.models.ExitOptions
    :param file_upload_error: If the Task exited with an exit code that was specified via exitCodes
     or exitCodeRanges, and then encountered a file upload error, then the action specified by the
     exit code takes precedence.
    :type file_upload_error: ~batch_service.models.ExitOptions
    :param default: This value is used if the Task exits with any nonzero exit code not listed in
    ...
    :type default: ~batch_service.models.ExitOptions
    """
...
class ExitOptions(msrest.serialization.Model):
    ...
    :param job_action: The default is none for exit code 0 and terminate for all other exit
    ...
    :type job_action: str or ~batch_service.models.JobAction
    :param dependency_action: Possible values are 'satisfy' (allowing dependent tasks to progress)
     and 'block' (dependent tasks continue to wait). Batch does not yet support cancellation of
     dependent tasks. Possible values include: "satisfy", "block".
    :type dependency_action: str or ~batch_service.models.DependencyAction
    """
...
class FileGetFromComputeNodeOptions(msrest.serialization.Model):
    ...
    :param ocp_date: The time the request was issued. Client libraries typically set this to the
     current system clock time; set it explicitly if you are calling the REST API directly.
    :type ocp_date: ~datetime.datetime
    :param ocp_range: The byte range to be retrieved. The default is to retrieve the entire file.
     The format is bytes=startRange-endRange.
    :type ocp_range: str
    :param if_modified_since: A timestamp indicating the last modified time of the resource known
    ...
    :param if_unmodified_since: A timestamp indicating the last modified time of the resource known
     to the client. The operation will be performed only if the resource on the service has not been
     modified since the specified time.
...
class FileListFromComputeNodeOptions(msrest.serialization.Model):
    ...
    :param filter: An OData $filter clause. For more information on constructing this filter, see
     https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-compute-
     node-files.
    :type filter: str
    :param max_results: The maximum number of items to return in the response. A maximum of 1000
...
class FileProperties(msrest.serialization.Model):
    ...
    :param creation_time: The creation time is not returned for files on Linux Compute Nodes.
    :type creation_time: ~datetime.datetime
    :param last_modified: Required. The time at which the file was last modified.
    :type last_modified: ~datetime.datetime
    :param content_length: Required. The length of the file.
    :type content_length: long
    :param content_type: The content type of the file.
    :type content_type: str
    :param file_mode: The file mode is returned only for files on Linux Compute Nodes.
    :type file_mode: str
    """
...
class ImageInformation(msrest.serialization.Model):
    ...
    :param node_agent_sku_id: Required. The ID of the Compute Node agent SKU which the Image
     supports.
    ...
    :type image_reference: ~batch_service.models.ImageReference
    :param os_type: Required. The type of operating system (e.g. Windows or Linux) of the Image.
     Possible values include: "linux", "windows".
    :type os_type: str or ~batch_service.models.OSType
    :param capabilities: Not every capability of the Image is listed. Capabilities in this list are
    ...
    :param batch_support_end_of_life: The time when the Azure Batch service will stop accepting
     create Pool requests for the Image.
    :type batch_support_end_of_life: ~datetime.datetime
    :param verification_type: Required. Whether the Azure Batch service actively verifies that the
     Image is compatible with the associated Compute Node agent SKU. Possible values include:
     "verified", "unverified".
    :type verification_type: str or ~batch_service.models.VerificationType
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.verification_type = kwargs['verification_type']
...
class ImageReference(msrest.serialization.Model):
    ...
    :type version: str
    :param virtual_machine_image_id: This property is mutually exclusive with other ImageReference
...
class InboundEndpoint(msrest.serialization.Model):
    ...
    :type protocol: str or ~batch_service.models.InboundEndpointProtocol
    :param public_ip_address: Required. The public IP address of the Compute Node.
    :type public_ip_address: str
    :param public_fqdn: Required. The public fully qualified domain name for the Compute Node.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.public_fqdn = kwargs['public_fqdn']
...
class InboundNATPool(msrest.serialization.Model):
    ...
    :param network_security_group_rules: The maximum number of rules that can be specified across
     ...
     code 400.
    :type network_security_group_rules: list[~batch_service.models.NetworkSecurityGroupRule]
    """
...
class JobAddParameter(msrest.serialization.Model):
    ...
    :param id: Required. The ID can contain any combination of alphanumeric characters including
    ...
    :type constraints: ~batch_service.models.JobConstraints
    :param job_manager_task: If the Job does not specify a Job Manager Task, the user must
     ...
     contents.
    :type job_manager_task: ~batch_service.models.JobManagerTask
    :param job_preparation_task: If a Job has a Job Preparation Task, the Batch service will run
     the Job Preparation Task on a Node before starting any Tasks of that Job on that Compute Node.
    :type job_preparation_task: ~batch_service.models.JobPreparationTask
    :param job_release_task: A Job Release Task cannot be specified without also specifying a Job
    ...
    :param common_environment_settings: Individual Tasks can override an environment setting
     specified here by specifying the same setting name with a different value.
    :type common_environment_settings: list[~batch_service.models.EnvironmentSetting]
    :param pool_info: Required. Specifies how a Job should be assigned to a Pool.
    :type pool_info: ~batch_service.models.PoolInformation
    :param on_all_tasks_complete: Note that if a Job contains no Tasks, then all Tasks are
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.job_release_task = kwargs.get('job_release_task', None)
        self.common_environment_settings = kwargs.get('common_environment_settings', None)
        self.pool_info = kwargs['pool_info']
        self.on_all_tasks_complete = kwargs.get('on_all_tasks_complete', None)
        self.on_task_failure = kwargs.get('on_task_failure', None)
        self.metadata = kwargs.get('metadata', None)
        self.uses_task_dependencies = kwargs.get('uses_task_dependencies', None)
...
class JobConstraints(msrest.serialization.Model):
    ...
    :param max_wall_clock_time: If the Job does not complete within the time limit, the Batch
    ...
    :param max_task_retry_count: Note that this value specifically controls the number of retries.
...
class JobDeleteOptions(msrest.serialization.Model):
    ...
    :param ocp_date: The time the request was issued. Client libraries typically set this to the
     current system clock time; set it explicitly if you are calling the REST API directly.
    :type ocp_date: ~datetime.datetime
    :param if_match: An ETag value associated with the version of the resource known to the client.
     The operation will be performed only if the resource's current ETag on the service exactly
     matches the value specified by the client.
    :type if_match: str
    :param if_none_match: An ETag value associated with the version of the resource known to the
...
class JobDisableParameter(msrest.serialization.Model):
    ...
    :param disable_tasks: Required. What to do with active Tasks associated with the Job. Possible
     values include: "requeue", "terminate", "wait".
    :type disable_tasks: str or ~batch_service.models.DisableJobOption
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.disable_tasks = kwargs['disable_tasks']
...
class JobExecutionInformation(msrest.serialization.Model):
    ...
    :param start_time: Required. This is the time at which the Job was created.
    :type start_time: ~datetime.datetime
    :param end_time: This property is set only if the Job is in the completed state.
    :type end_time: ~datetime.datetime
    :param pool_id: This element contains the actual Pool where the Job is assigned. When you get
    ...
    :type pool_id: str
    :param scheduling_error: This property is not set if there was no error starting the Job.
    :type scheduling_error: ~batch_service.models.JobSchedulingError
    :param terminate_reason: This property is set only if the Job is in the completed state. If the
     ...
     with an exit condition that specified a jobAction of terminatejob. Any other string is a user-
     defined reason specified in a call to the 'Terminate a Job' operation.
...
class JobListFromJobScheduleOptions(msrest.serialization.Model):
    ...
    :param filter: An OData $filter clause. For more information on constructing this filter, see
     https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-jobs-in-a-
     job-schedule.
    :type filter: str
    :param select: An OData $select clause.
    :type select: str
...
class JobListPreparationAndReleaseTaskStatusOptions(msrest.serialization.Model):
    ...
    :param filter: An OData $filter clause. For more information on constructing this filter, see
     https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-job-
     preparation-and-release-status.
    :type filter: str
    :param select: An OData $select clause.
    :type select: str
    :param max_results: The maximum number of items to return in the response. A maximum of 1000
...
class JobManagerTask(msrest.serialization.Model):
    ...
    :type id: str
    :param display_name: It need not be unique and can contain any Unicode characters up to a
     maximum length of 1024.
    :type display_name: str
    :param command_line: Required. The command line does not run under a shell, and therefore
     ...
     or use the Batch provided environment variable (https://docs.microsoft.com/en-
    ...
    :param container_settings: If the Pool that will run this Task has containerConfiguration set,
     ...
     will not be able to access those files.
    :type container_settings: ~batch_service.models.TaskContainerSettings
    :param resource_files: Files listed under this element are located in the Task's working
    ...
    :param output_files: For multi-instance Tasks, the files will only be uploaded from the Compute
     Node on which the primary Task is executed.
    :type output_files: list[~batch_service.models.OutputFile]
    :param environment_settings: A list of environment variable settings for the Job Manager Task.
    :type environment_settings: list[~batch_service.models.EnvironmentSetting]
    :param constraints: Execution constraints to apply to a Task.
    :type constraints: ~batch_service.models.TaskConstraints
    :param required_slots: The default is 1. A Task can only be scheduled to run on a compute node
     ...
     1.
    :type required_slots: int
    :param kill_job_on_completion: If true, when the Job Manager Task completes, the Batch service
    ...
    :param user_identity: If omitted, the Task runs as a non-administrative user unique to the
     Task.
    :type user_identity: ~batch_service.models.UserIdentity
    :param run_exclusive: If true, no other Tasks will run on the same Node for as long as the Job
    ...
    :param authentication_token_settings: If this property is set, the Batch service provides the
     ...
     Job.
    :type authentication_token_settings: ~batch_service.models.AuthenticationTokenSettings
    :param allow_low_priority_node: The default value is true.
...
class JobNetworkConfiguration(msrest.serialization.Model):
    ...
    :param subnet_id: Required. The virtual network must be in the same region and subscription as
...
class JobPatchParameter(msrest.serialization.Model):
    ...
    :param priority: Priority values can range from -1000 to 1000, with -1000 being the lowest
     ...
     unchanged.
    :type priority: int
    :param on_all_tasks_complete: If omitted, the completion behavior is left unchanged. You may
    ...
    :type on_all_tasks_complete: str or ~batch_service.models.OnAllTasksComplete
    :param constraints: If omitted, the existing execution constraints are left unchanged.
    :type constraints: ~batch_service.models.JobConstraints
    :param pool_info: You may change the Pool for a Job only when the Job is disabled. The Patch
...
class JobPreparationAndReleaseTaskExecutionInformation(msrest.serialization.Model):
    ...
    :param pool_id: The ID of the Pool containing the Compute Node to which this entry refers.
    :type pool_id: str
    ...
    :type node_url: str
    :param job_preparation_task_execution_info: Contains information about the execution of a Job
     Preparation Task on a Compute Node.
    :type job_preparation_task_execution_info:
     ~batch_service.models.JobPreparationTaskExecutionInformation
    :param job_release_task_execution_info: This property is set only if the Job Release Task has
     run on the Compute Node.
    :type job_release_task_execution_info: ~batch_service.models.JobReleaseTaskExecutionInformation
    """
...
class JobPreparationTask(msrest.serialization.Model):
    ...
    :param resource_files: Files listed under this element are located in the Task's working
     ...
     using .zip files, Application Packages, or Docker Containers.
    :type resource_files: list[~batch_service.models.ResourceFile]
    :param environment_settings: A list of environment variable settings for the Job Preparation
     Task.
    :type environment_settings: list[~batch_service.models.EnvironmentSetting]
    :param constraints: Execution constraints to apply to a Task.
    :type constraints: ~batch_service.models.TaskConstraints
    :param wait_for_success: If true and the Job Preparation Task fails on a Node, the Batch
    ...
    :param user_identity: If omitted, the Task runs as a non-administrative user unique to the Task
     on Windows Compute Nodes, or a non-administrative user unique to the Pool on Linux Compute
     Nodes.
    :type user_identity: ~batch_service.models.UserIdentity
    :param rerun_on_node_reboot_after_success: The Job Preparation Task is always rerun if a
...
class JobPreparationTaskExecutionInformation(msrest.serialization.Model):
    ...
    :param start_time: Required. If the Task has been restarted or retried, this is the most recent
     time at which the Task started running.
    :type start_time: ~datetime.datetime
    :param end_time: This property is set only if the Task is in the Completed state.
    :type end_time: ~datetime.datetime
    :param state: Required. The current state of the Job Preparation Task on the Compute Node.
     Possible values include: "running", "completed".
    :type state: str or ~batch_service.models.JobPreparationTaskState
    :param task_root_directory: The root directory of the Job Preparation Task on the Compute Node.
     You can use this path to retrieve files created by the Task, such as log files.
    :type task_root_directory: str
    :param task_root_directory_url: The URL to the root directory of the Job Preparation Task on
     the Compute Node.
    :type task_root_directory_url: str
    :param exit_code: This parameter is returned only if the Task is in the completed state. The
     ...
     forcibly terminated.
    :type exit_code: int
    :param container_info: This property is set only if the Task runs in a container context.
    :type container_info: ~batch_service.models.TaskContainerExecutionInformation
    :param failure_info: This property is set only if the Task is in the completed state and
     encountered a failure.
    :type failure_info: ~batch_service.models.TaskFailureInformation
    :param retry_count: Required. Task application failures (non-zero exit code) are retried, pre-
     processing errors (the Task could not be run) and file upload errors are not retried. The Batch
     service will retry the Task up to the limit specified by the constraints.
    :type retry_count: int
    :param last_retry_time: This property is set only if the Task was retried (i.e. retryCount is
    ...
    :type last_retry_time: ~datetime.datetime
    :param result: If the value is 'failed', then the details of the failure can be found in the
     failureInfo property. Possible values include: "success", "failure".
    :type result: str or ~batch_service.models.TaskExecutionResult
    """
...
class JobReleaseTask(msrest.serialization.Model):
    ...
    :param resource_files: Files listed under this element are located in the Task's working
     directory.
    :type resource_files: list[~batch_service.models.ResourceFile]
    :param environment_settings: A list of environment variable settings for the Job Release Task.
    :type environment_settings: list[~batch_service.models.EnvironmentSetting]
    :param max_wall_clock_time: The maximum elapsed time that the Job Release Task may run on a
    ...
    :type max_wall_clock_time: ~datetime.timedelta
    :param retention_time: The default is 7 days, i.e. the Task directory will be retained for 7
     days unless the Compute Node is removed or the Job is deleted.
    :type retention_time: ~datetime.timedelta
    :param user_identity: If omitted, the Task runs as a non-administrative user unique to the
     Task.
    :type user_identity: ~batch_service.models.UserIdentity
    """
...
class JobReleaseTaskExecutionInformation(msrest.serialization.Model):
    ...
    :param end_time: This property is set only if the Task is in the Completed state.
    :type end_time: ~datetime.datetime
    :param state: Required. The current state of the Job Release Task on the Compute Node. Possible
     values include: "running", "completed".
    :type state: str or ~batch_service.models.JobReleaseTaskState
    :param task_root_directory: The root directory of the Job Release Task on the Compute Node. You
     can use this path to retrieve files created by the Task, such as log files.
    :type task_root_directory: str
    :param task_root_directory_url: The URL to the root directory of the Job Release Task on the
     Compute Node.
    :type task_root_directory_url: str
    :param exit_code: This parameter is returned only if the Task is in the completed state. The
     exit code for a process reflects the specific convention implemented by the application
...
class JobScheduleAddParameter(msrest.serialization.Model):
    ...
    :param display_name: The display name need not be unique and can contain any Unicode characters
     up to a maximum length of 1024.
    :type display_name: str
    :param schedule: Required. The schedule according to which Jobs will be created.
    :type schedule: ~batch_service.models.Schedule
    :param job_specification: Required. Specifies details of the Jobs to be created on a schedule.
    :type job_specification: ~batch_service.models.JobSpecification
    :param metadata: The Batch service does not assign any meaning to metadata; it is solely for
     the use of user code.
    :type metadata: list[~batch_service.models.MetadataItem]
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.job_specification = kwargs['job_specification']
        self.metadata = kwargs.get('metadata', None)
...
class JobScheduleExecutionInformation(msrest.serialization.Model):
    ...
    :param next_run_time: This property is meaningful only if the schedule is in the active state
    ...
    :param recent_job: This property is present only if the at least one Job has run under the
     schedule.
    :type recent_job: ~batch_service.models.RecentJob
    :param end_time: This property is set only if the Job Schedule is in the completed state.
    :type end_time: ~datetime.datetime
    """
...
class JobSchedulePatchParameter(msrest.serialization.Model):
    ...
    :param schedule: If you do not specify this element, the existing schedule is left unchanged.
    :type schedule: ~batch_service.models.Schedule
    :param job_specification: Updates affect only Jobs that are started after the update has taken
     place. Any currently active Job continues with the older specification.
    :type job_specification: ~batch_service.models.JobSpecification
    :param metadata: If you do not specify this element, existing metadata is left unchanged.
    :type metadata: list[~batch_service.models.MetadataItem]
    """
...
class JobScheduleStatistics(msrest.serialization.Model):
    ...
    :type url: str
    :param start_time: Required. The start time of the time range covered by the statistics.
    :type start_time: ~datetime.datetime
    :param last_update_time: Required. The time at which the statistics were last updated. All
     statistics are limited to the range between startTime and lastUpdateTime.
    :type last_update_time: ~datetime.datetime
    :param user_cpu_time: Required. The total user mode CPU time (summed across all cores and all
     Compute Nodes) consumed by all Tasks in all Jobs created under the schedule.
    :type user_cpu_time: ~datetime.timedelta
    :param kernel_cpu_time: Required. The total kernel mode CPU time (summed across all cores and
     all Compute Nodes) consumed by all Tasks in all Jobs created under the schedule.
    :type kernel_cpu_time: ~datetime.timedelta
    :param wall_clock_time: Required. The wall clock time is the elapsed time from when the Task
    ...
    :type wall_clock_time: ~datetime.timedelta
    :param read_i_ops: Required. The total number of disk read operations made by all Tasks in all
     Jobs created under the schedule.
    :type read_i_ops: long
    :param write_i_ops: Required. The total number of disk write operations made by all Tasks in
     all Jobs created under the schedule.
    :type write_i_ops: long
    :param read_io_gi_b: Required. The total gibibytes read from disk by all Tasks in all Jobs
     created under the schedule.
    :type read_io_gi_b: float
    :param write_io_gi_b: Required. The total gibibytes written to disk by all Tasks in all Jobs
     created under the schedule.
    :type write_io_gi_b: float
    :param num_succeeded_tasks: Required. The total number of Tasks successfully completed during
     the given time range in Jobs created under the schedule. A Task completes successfully if it
     returns exit code 0.
    :type num_succeeded_tasks: long
    :param num_failed_tasks: Required. The total number of Tasks that failed during the given time
    ...
    :param num_task_retries: Required. The total number of retries during the given time range on
     all Tasks in all Jobs created under the schedule.
    :type num_task_retries: long
    :param wait_time: Required. This value is only reported in the Account lifetime statistics; it
     is not included in the Job statistics.
    :type wait_time: ~datetime.timedelta
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.user_cpu_time = kwargs['user_cpu_time']
        self.kernel_cpu_time = kwargs['kernel_cpu_time']
        self.wall_clock_time = kwargs['wall_clock_time']
        self.read_i_ops = kwargs['read_i_ops']
        self.write_i_ops = kwargs['write_i_ops']
        self.read_io_gi_b = kwargs['read_io_gi_b']
        self.write_io_gi_b = kwargs['write_io_gi_b']
        self.num_succeeded_tasks = kwargs['num_succeeded_tasks']
        self.num_failed_tasks = kwargs['num_failed_tasks']
        self.num_task_retries = kwargs['num_task_retries']
...
class JobScheduleUpdateParameter(msrest.serialization.Model):
    ...
    :param schedule: Required. If you do not specify this element, it is equivalent to passing the
     default schedule: that is, a single Job scheduled to run immediately.
    :type schedule: ~batch_service.models.Schedule
    :param job_specification: Required. Updates affect only Jobs that are started after the update
     has taken place. Any currently active Job continues with the older specification.
    :type job_specification: ~batch_service.models.JobSpecification
    :param metadata: If you do not specify this element, it takes the default value of an empty
...
class JobSchedulingError(msrest.serialization.Model):
    ...
    :param category: Required. The category of the error. Possible values include: "usererror",
     "servererror".
    :type category: str or ~batch_service.models.ErrorCategory
    :param code: An identifier for the Job scheduling error. Codes are invariant and are intended
     to be consumed programmatically.
    :type code: str
    :param message: A message describing the Job scheduling error, intended to be suitable for
     display in a user interface.
    :type message: str
    :param details: A list of additional error details related to the scheduling error.
    :type details: list[~batch_service.models.NameValuePair]
    """
...
class JobSpecification(msrest.serialization.Model):
    ...
    :type priority: int
    :param display_name: The name need not be unique and can contain any Unicode characters up to a
     maximum length of 1024.
    :type display_name: str
    :param uses_task_dependencies: Whether Tasks in the Job can define dependencies on each other.
     The default is false.
    ...
    :param on_all_tasks_complete: Note that if a Job contains no Tasks, then all Tasks are
     ...
     include: "noaction", "terminatejob".
    :type on_all_tasks_complete: str or ~batch_service.models.OnAllTasksComplete
    :param on_task_failure: The default is noaction. Possible values include: "noaction",
    ...
    :param job_preparation_task: If a Job has a Job Preparation Task, the Batch service will run
     the Job Preparation Task on a Node before starting any Tasks of that Job on that Compute Node.
    :type job_preparation_task: ~batch_service.models.JobPreparationTask
    :param job_release_task: The primary purpose of the Job Release Task is to undo changes to
...
class JobStatistics(msrest.serialization.Model):
    ...
    :param wall_clock_time: Required. The wall clock time is the elapsed time from when the Task
     ...
     clock time of all the Task retries.
    :type wall_clock_time: ~datetime.timedelta
    :param read_i_ops: Required. The total number of disk read operations made by all Tasks in the
     Job.
    :type read_i_ops: long
    :param write_i_ops: Required. The total number of disk write operations made by all Tasks in
     the Job.
    :type write_i_ops: long
    :param read_io_gi_b: Required. The total amount of data in GiB read from disk by all Tasks in
     the Job.
    :type read_io_gi_b: float
    :param write_io_gi_b: Required. The total amount of data in GiB written to disk by all Tasks in
     the Job.
    :type write_io_gi_b: float
    :param num_succeeded_tasks: Required. A Task completes successfully if it returns exit code 0.
    :type num_succeeded_tasks: long
    :param num_failed_tasks: Required. A Task fails if it exhausts its maximum retry count without
     returning exit code 0.
    :type num_failed_tasks: long
    :param num_task_retries: Required. The total number of retries on all the Tasks in the Job
     during the given time range.
    :type num_task_retries: long
    :param wait_time: Required. The wait time for a Task is defined as the elapsed time between the
...
class JobUpdateParameter(msrest.serialization.Model):
    ...
    :type priority: int
    :param constraints: If omitted, the constraints are cleared.
    :type constraints: ~batch_service.models.JobConstraints
    :param pool_info: Required. You may change the Pool for a Job only when the Job is disabled.
    ...
    :type pool_info: ~batch_service.models.PoolInformation
    :param metadata: If omitted, it takes the default value of an empty list; in effect, any
     existing metadata is deleted.
    :type metadata: list[~batch_service.models.MetadataItem]
    :param on_all_tasks_complete: If omitted, the completion behavior is set to noaction. If the
     ...
     terminatejob. Possible values include: "noaction", "terminatejob".
    :type on_all_tasks_complete: str or ~batch_service.models.OnAllTasksComplete
    """
...
class MountConfiguration(msrest.serialization.Model):
    ...
    :type azure_blob_file_system_configuration:
     ~batch_service.models.AzureBlobFileSystemConfiguration
    :param nfs_mount_configuration: This property is mutually exclusive with all other properties.
    :type nfs_mount_configuration: ~batch_service.models.NFSMountConfiguration
    :param cifs_mount_configuration: This property is mutually exclusive with all other properties.
    :type cifs_mount_configuration: ~batch_service.models.CIFSMountConfiguration
    :param azure_file_share_configuration: This property is mutually exclusive with all other
     properties.
    :type azure_file_share_configuration: ~batch_service.models.AzureFileShareConfiguration
    """
...
class MultiInstanceSettings(msrest.serialization.Model):
    ...
    :param number_of_instances: If omitted, the default is 1.
    :type number_of_instances: int
    :param coordination_command_line: Required. A typical coordination command line launches a
    ...
    :param common_resource_files: The difference between common resource files and Task resource
     ...
     Containers.
    :type common_resource_files: list[~batch_service.models.ResourceFile]
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.coordination_command_line = kwargs['coordination_command_line']
...
class NetworkConfiguration(msrest.serialization.Model):
    ...
    :param subnet_id: The virtual network must be in the same region and subscription as the Azure
     ...
     firewall-configuration.
    :type subnet_id: str
    :param dynamic_v_net_assignment_scope: The scope of dynamic vnet assignment. Possible values
     include: "none", "job".
    :type dynamic_v_net_assignment_scope: str or ~batch_service.models.DynamicVNetAssignmentScope
    :param endpoint_configuration: Pool endpoint configuration is only supported on Pools with the
     virtualMachineConfiguration property.
    :type endpoint_configuration: ~batch_service.models.PoolEndpointConfiguration
    :param public_ip_address_configuration: Public IP configuration property is only supported on
     Pools with the virtualMachineConfiguration property.
    :type public_ip_address_configuration: ~batch_service.models.PublicIPAddressConfiguration
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.dynamic_v_net_assignment_scope = kwargs.get('dynamic_v_net_assignment_scope', None)
        self.endpoint_configuration = kwargs.get('endpoint_configuration', None)
...
class NetworkSecurityGroupRule(msrest.serialization.Model):
    ...
    :type access: str or ~batch_service.models.NetworkSecurityGroupRuleAccess
    ...
    :param source_port_ranges: Valid values are '\ *' (for all ports 0 - 65535), a specific port
...
class NodeAgentInformation(msrest.serialization.Model):
    ...
    :param version: Required. This version number can be checked against the Compute Node agent
     release notes located at
     https://github.com/Azure/Batch/blob/master/changelogs/nodeagent/CHANGELOG.md.
    :type version: str
    :param last_update_time: Required. This is the most recent time that the Compute Node agent was
...
class NodeCounts(msrest.serialization.Model):
    ...
    :param creating: Required. The number of Compute Nodes in the creating state.
    :type creating: int
    :param idle: Required. The number of Compute Nodes in the idle state.
    :type idle: int
    :param offline: Required. The number of Compute Nodes in the offline state.
    :type offline: int
    :param preempted: Required. The number of Compute Nodes in the preempted state.
    :type preempted: int
    :param rebooting: Required. The count of Compute Nodes in the rebooting state.
    :type rebooting: int
    :param reimaging: Required. The number of Compute Nodes in the reimaging state.
    :type reimaging: int
    :param running: Required. The number of Compute Nodes in the running state.
    :type running: int
    :param starting: Required. The number of Compute Nodes in the starting state.
    :type starting: int
    :param start_task_failed: Required. The number of Compute Nodes in the startTaskFailed state.
    :type start_task_failed: int
    :param leaving_pool: Required. The number of Compute Nodes in the leavingPool state.
    :type leaving_pool: int
    :param unknown: Required. The number of Compute Nodes in the unknown state.
    :type unknown: int
    :param unusable: Required. The number of Compute Nodes in the unusable state.
    :type unusable: int
    :param waiting_for_start_task: Required. The number of Compute Nodes in the waitingForStartTask
     state.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.preempted = kwargs['preempted']
        self.rebooting = kwargs['rebooting']
        self.reimaging = kwargs['reimaging']
        self.running = kwargs['running']
        self.starting = kwargs['starting']
        self.start_task_failed = kwargs['start_task_failed']
        self.leaving_pool = kwargs['leaving_pool']
        self.unknown = kwargs['unknown']
        self.unusable = kwargs['unusable']
        self.waiting_for_start_task = kwargs['waiting_for_start_task']
...
class NodeDisableSchedulingParameter(msrest.serialization.Model):
    ...
    :param node_disable_scheduling_option: The default value is requeue. Possible values include:
     "requeue", "terminate", "taskcompletion".
    :type node_disable_scheduling_option: str or
     ~batch_service.models.DisableComputeNodeSchedulingOption
    """
...
class NodeFile(msrest.serialization.Model):
    ...
    :param properties: The properties of a file on a Compute Node.
    :type properties: ~batch_service.models.FileProperties
    """
...
class NodeFileListResult(msrest.serialization.Model):
    ...
    :type value: list[~batch_service.models.NodeFile]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class NodeRebootParameter(msrest.serialization.Model):
    ...
    :param node_reboot_option: The default value is requeue. Possible values include: "requeue",
     "terminate", "taskcompletion", "retaineddata".
    :type node_reboot_option: str or ~batch_service.models.ComputeNodeRebootOption
    """
...
class NodeReimageParameter(msrest.serialization.Model):
    ...
    :param node_reimage_option: The default value is requeue. Possible values include: "requeue",
     "terminate", "taskcompletion", "retaineddata".
    :type node_reimage_option: str or ~batch_service.models.ComputeNodeReimageOption
    """
...
class NodeRemoveParameter(msrest.serialization.Model):
    ...
    :param node_list: Required. A list containing the IDs of the Compute Nodes to be removed from
     the specified Pool.
    ...
    :type node_deallocation_option: str or ~batch_service.models.ComputeNodeDeallocationOption
    """
...
class OutputFile(msrest.serialization.Model):
    ...
    :param file_pattern: Required. Both relative and absolute paths are supported. Relative paths
    ...
    :param destination: Required. The destination to which a file should be uploaded.
    :type destination: ~batch_service.models.OutputFileDestination
    :param upload_options: Required. Details about an output file upload operation, including under
     what conditions to perform the upload.
    :type upload_options: ~batch_service.models.OutputFileUploadOptions
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.file_pattern = kwargs['file_pattern']
        self.destination = kwargs['destination']
        self.upload_options = kwargs['upload_options']
...
class OutputFileBlobContainerDestination(msrest.serialization.Model):
    ...
    :param path: If filePattern refers to a specific file (i.e. contains no wildcards), then path
    ...
    :type path: str
    :param container_url: Required. The URL must include a Shared Access Signature (SAS) granting
     write permissions to the container.
...
class OutputFileDestination(msrest.serialization.Model):
    ...
    :param container: Specifies a file upload destination within an Azure blob storage container.
    :type container: ~batch_service.models.OutputFileBlobContainerDestination
    """
...
class OutputFileUploadOptions(msrest.serialization.Model):
    ...
    :param upload_condition: Required. The default is taskcompletion. Possible values include:
     "tasksuccess", "taskfailure", "taskcompletion".
    :type upload_condition: str or ~batch_service.models.OutputFileUploadCondition
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.upload_condition = kwargs['upload_condition']
...
class PoolAddParameter(msrest.serialization.Model):
    ...
    :param display_name: The display name need not be unique and can contain any Unicode characters
     up to a maximum length of 1024.
    :type display_name: str
    :param vm_size: Required. For information about available sizes of virtual machines for Cloud
    ...
    :param virtual_machine_configuration: This property and cloudServiceConfiguration are mutually
     exclusive and one of the properties must be specified.
    :type virtual_machine_configuration: ~batch_service.models.VirtualMachineConfiguration
    :param resize_timeout: This timeout applies only to manual scaling; it has no effect when
    ...
    :type resize_timeout: ~datetime.timedelta
    :param target_dedicated_nodes: This property must not be specified if enableAutoScale is set to
     true. If enableAutoScale is set to false, then you must set either targetDedicatedNodes,
     targetLowPriorityNodes, or both.
    :type target_dedicated_nodes: int
    :param target_low_priority_nodes: This property must not be specified if enableAutoScale is set
    ...
    :param enable_auto_scale: If false, at least one of targetDedicateNodes and
     ...
     and the Pool automatically resizes according to the formula. The default value is false.
    :type enable_auto_scale: bool
    :param auto_scale_formula: This property must not be specified if enableAutoScale is set to
    ...
    :type auto_scale_evaluation_interval: ~datetime.timedelta
    :param enable_inter_node_communication: Enabling inter-node communication limits the maximum
    ...
    :param network_configuration: The network configuration for a Pool.
    :type network_configuration: ~batch_service.models.NetworkConfiguration
    :param start_task: The Task runs when the Compute Node is added to the Pool or when the Compute
     Node is restarted.
    :type start_task: ~batch_service.models.StartTask
    :param certificate_references: For Windows Nodes, the Batch service installs the Certificates
     to the specified Certificate store and location. For Linux Compute Nodes, the Certificates are
    ...
    :param metadata: The Batch service does not assign any meaning to metadata; it is solely for
     the use of user code.
    :type metadata: list[~batch_service.models.MetadataItem]
    :param mount_configuration: Mount the storage using Azure fileshare, NFS, CIFS or Blobfuse
     based file system.
    :type mount_configuration: list[~batch_service.models.MountConfiguration]
    """
...
class PoolEndpointConfiguration(msrest.serialization.Model):
    ...
    :type inbound_nat_pools: list[~batch_service.models.InboundNATPool]
    """
...
class PoolEvaluateAutoScaleParameter(msrest.serialization.Model):
    ...
    :param auto_scale_formula: Required. The formula is validated and its results calculated, but
     ...
     Nodes in an Azure Batch Pool (https://azure.microsoft.com/en-us/documentation/articles/batch-
     automatic-scaling).
    :type auto_scale_formula: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.auto_scale_formula = kwargs['auto_scale_formula']
...
class PoolInformation(msrest.serialization.Model):
    ...
    :param pool_id: You must ensure that the Pool referenced by this property exists. If the Pool
    ...
    :type pool_id: str
    :param auto_pool_specification: If auto Pool creation fails, the Batch service moves the Job to
    ...
    :type auto_pool_specification: ~batch_service.models.AutoPoolSpecification
    """
...
class PoolListUsageMetricsOptions(msrest.serialization.Model):
    ...
    :param start_time: The earliest time from which to include metrics. This must be at least two
     and a half hours before the current time. If not specified this defaults to the start time of
     the last aggregation interval currently available.
    :type start_time: ~datetime.datetime
    :param end_time: The latest time from which to include metrics. This must be at least two hours
     before the current time. If not specified this defaults to the end time of the last aggregation
     interval currently available.
    :type end_time: ~datetime.datetime
    :param filter: An OData $filter clause. For more information on constructing this filter, see
     https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-account-
     usage-metrics.
    :type filter: str
    :param max_results: The maximum number of items to return in the response. A maximum of 1000
     results will be returned.
...
class PoolListUsageMetricsResult(msrest.serialization.Model):
    ...
    :param value: The Pool usage metrics data.
    :type value: list[~batch_service.models.PoolUsageMetrics]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class PoolNodeCounts(msrest.serialization.Model):
    ...
    :type pool_id: str
    :param dedicated: The number of Compute Nodes in each Compute Node state.
    :type dedicated: ~batch_service.models.NodeCounts
    :param low_priority: The number of Compute Nodes in each Compute Node state.
    :type low_priority: ~batch_service.models.NodeCounts
    """
...
class PoolNodeCountsListResult(msrest.serialization.Model):
    ...
    :param value: A list of Compute Node counts by Pool.
    :type value: list[~batch_service.models.PoolNodeCounts]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class PoolPatchParameter(msrest.serialization.Model):
    ...
    :param start_task: If this element is present, it overwrites any existing StartTask. If
     omitted, any existing StartTask is left unchanged.
    :type start_task: ~batch_service.models.StartTask
    :param certificate_references: If this element is present, it replaces any existing Certificate
    ...
    :type application_package_references: list[~batch_service.models.ApplicationPackageReference]
    :param metadata: If this element is present, it replaces any existing metadata configured on
...
class PoolSpecification(msrest.serialization.Model):
    ...
    :param display_name: The display name need not be unique and can contain any Unicode characters
     up to a maximum length of 1024.
    :type display_name: str
    :param vm_size: Required. For information about available sizes of virtual machines in Pools,
     see Choose a VM size for Compute Nodes in an Azure Batch Pool
     (https://docs.microsoft.com/azure/batch/batch-pool-vm-sizes).
    :type vm_size: str
    :param cloud_service_configuration: This property must be specified if the Pool needs to be
    ...
    :type cloud_service_configuration: ~batch_service.models.CloudServiceConfiguration
    :param virtual_machine_configuration: This property must be specified if the Pool needs to be
...
class PoolStatistics(msrest.serialization.Model):
    ...
    :param last_update_time: Required. The time at which the statistics were last updated. All
     statistics are limited to the range between startTime and lastUpdateTime.
    :type last_update_time: ~datetime.datetime
    :param usage_stats: Statistics related to Pool usage information.
    :type usage_stats: ~batch_service.models.UsageStatistics
    :param resource_stats: Statistics related to resource consumption by Compute Nodes in a Pool.
    :type resource_stats: ~batch_service.models.ResourceStatistics
    """
...
class PoolUpdatePropertiesParameter(msrest.serialization.Model):
    ...
    :type start_task: ~batch_service.models.StartTask
    :param certificate_references: Required. This list replaces any existing Certificate references
     ...
     (e.g., /home/{user-name}/certs) and Certificates are placed in that directory.
    :type certificate_references: list[~batch_service.models.CertificateReference]
    :param application_package_references: Required. The list replaces any existing Application
     ...
     given Pool.
    :type application_package_references: list[~batch_service.models.ApplicationPackageReference]
    :param metadata: Required. This list replaces any existing metadata configured on the Pool. If
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.start_task = kwargs.get('start_task', None)
        self.certificate_references = kwargs['certificate_references']
        self.application_package_references = kwargs['application_package_references']
...
class PoolUsageMetrics(msrest.serialization.Model):
    ...
    :param pool_id: Required. The ID of the Pool whose metrics are aggregated in this entry.
    :type pool_id: str
    :param start_time: Required. The start time of the aggregation interval covered by this entry.
    :type start_time: ~datetime.datetime
    :param end_time: Required. The end time of the aggregation interval covered by this entry.
    :type end_time: ~datetime.datetime
    :param vm_size: Required. For information about available sizes of virtual machines in Pools,
     see Choose a VM size for Compute Nodes in an Azure Batch Pool
     (https://docs.microsoft.com/azure/batch/batch-pool-vm-sizes).
    :type vm_size: str
    :param total_core_hours: Required. The total core hours used in the Pool during this
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.vm_size = kwargs['vm_size']
        self.total_core_hours = kwargs['total_core_hours']
...
class PublicIPAddressConfiguration(msrest.serialization.Model):
    ...
    :type provision: str or ~batch_service.models.IPAddressProvisioningType
...
class ResizeError(msrest.serialization.Model):
    ...
    :param code: An identifier for the Pool resize error. Codes are invariant and are intended to
     be consumed programmatically.
    :type code: str
    :param message: A message describing the Pool resize error, intended to be suitable for display
     in a user interface.
    :type message: str
    :param values: A list of additional error details related to the Pool resize error.
    :type values: list[~batch_service.models.NameValuePair]
    """
...
class ResourceFile(msrest.serialization.Model):
    ...
    :param storage_container_url: The autoStorageContainerName, storageContainerUrl and httpUrl
     ...
     credentials when downloading blobs from the container. There are two ways to get such a URL for
     a container in Azure storage: include a Shared Access Signature (SAS) granting read and list
     permissions on the container, or set the ACL for the container to allow public access.
    ...
    :param http_url: The autoStorageContainerName, storageContainerUrl and httpUrl properties are
     ...
     storage: include a Shared Access Signature (SAS) granting read permissions on the blob, or set
...
class ResourceStatistics(msrest.serialization.Model):
    ...
    :param last_update_time: Required. The time at which the statistics were last updated. All
     statistics are limited to the range between startTime and lastUpdateTime.
    :type last_update_time: ~datetime.datetime
    :param avg_cpu_percentage: Required. The average CPU usage across all Compute Nodes in the Pool
     (percentage per node).
    :type avg_cpu_percentage: float
    :param avg_memory_gi_b: Required. The average memory usage in GiB across all Compute Nodes in
     the Pool.
    :type avg_memory_gi_b: float
    :param peak_memory_gi_b: Required. The peak memory usage in GiB across all Compute Nodes in the
     Pool.
    :type peak_memory_gi_b: float
    :param avg_disk_gi_b: Required. The average used disk space in GiB across all Compute Nodes in
     the Pool.
    :type avg_disk_gi_b: float
    :param peak_disk_gi_b: Required. The peak used disk space in GiB across all Compute Nodes in
     the Pool.
    :type peak_disk_gi_b: float
    :param disk_read_i_ops: Required. The total number of disk read operations across all Compute
     Nodes in the Pool.
    :type disk_read_i_ops: long
    :param disk_write_i_ops: Required. The total number of disk write operations across all Compute
     Nodes in the Pool.
    :type disk_write_i_ops: long
    :param disk_read_gi_b: Required. The total amount of data in GiB of disk reads across all
     Compute Nodes in the Pool.
    :type disk_read_gi_b: float
    :param disk_write_gi_b: Required. The total amount of data in GiB of disk writes across all
     Compute Nodes in the Pool.
    :type disk_write_gi_b: float
    :param network_read_gi_b: Required. The total amount of data in GiB of network reads across all
     Compute Nodes in the Pool.
    :type network_read_gi_b: float
    :param network_write_gi_b: Required. The total amount of data in GiB of network writes across
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.start_time = kwargs['start_time']
        self.last_update_time = kwargs['last_update_time']
        self.avg_cpu_percentage = kwargs['avg_cpu_percentage']
        self.avg_memory_gi_b = kwargs['avg_memory_gi_b']
        self.peak_memory_gi_b = kwargs['peak_memory_gi_b']
        self.avg_disk_gi_b = kwargs['avg_disk_gi_b']
        self.peak_disk_gi_b = kwargs['peak_disk_gi_b']
        self.disk_read_i_ops = kwargs['disk_read_i_ops']
        self.disk_write_i_ops = kwargs['disk_write_i_ops']
        self.disk_read_gi_b = kwargs['disk_read_gi_b']
        self.disk_write_gi_b = kwargs['disk_write_gi_b']
        self.network_read_gi_b = kwargs['network_read_gi_b']
        self.network_write_gi_b = kwargs['network_write_gi_b']


class Schedule(msrest.serialization.Model):
    """The schedule according to which Jobs will be created.

    :param do_not_run_until: If you do not specify a doNotRunUntil time, the schedule becomes ready
     to create Jobs immediately.
    :type do_not_run_until: ~datetime.datetime
    :param do_not_run_after: If you do not specify a doNotRunAfter time, and you are creating a
     recurring Job Schedule, the Job Schedule will remain active until you explicitly terminate it.
    :type do_not_run_after: ~datetime.datetime
    :param start_window: If a Job is not created within the startWindow interval, then the
     ...
     error; if you are calling the REST API directly, the HTTP status code is 400 (Bad Request).
    :type start_window: ~datetime.timedelta
    :param recurrence_interval: Because a Job Schedule can have at most one active Job under it at
     ...
     calling the REST API directly, the HTTP status code is 400 (Bad Request).
    :type recurrence_interval: ~datetime.timedelta
    """
...
class StartTask(msrest.serialization.Model):
    ...
    :param resource_files: Files listed under this element are located in the Task's working
     directory.
    :type resource_files: list[~batch_service.models.ResourceFile]
    :param environment_settings: A list of environment variable settings for the StartTask.
    :type environment_settings: list[~batch_service.models.EnvironmentSetting]
    :param user_identity: If omitted, the Task runs as a non-administrative user unique to the
     Task.
    :type user_identity: ~batch_service.models.UserIdentity
    ...
    :type max_task_retry_count: int
    :param wait_for_success: If true and the StartTask fails on a Node, the Batch service retries
...
class StartTaskInformation(msrest.serialization.Model):
    ...
    :param state: Required. The state of the StartTask on the Compute Node. Possible values
     include: "running", "completed".
    :type state: str or ~batch_service.models.StartTaskState
    :param start_time: Required. This value is reset every time the Task is restarted or retried
     (that is, this is the most recent time at which the StartTask started running).
    :type start_time: ~datetime.datetime
    :param end_time: This is the end time of the most recent run of the StartTask, if that run has
    ...
    :type end_time: ~datetime.datetime
    :param exit_code: This property is set only if the StartTask is in the completed state. In
    ...
    :param retry_count: Required. Task application failures (non-zero exit code) are retried, pre-
     ...
     service will retry the Task up to the limit specified by the constraints.
    :type retry_count: int
    :param last_retry_time: This element is present only if the Task was retried (i.e. retryCount
...
class SubtaskInformation(msrest.serialization.Model):
    ...
    :param node_info: Information about the Compute Node on which a Task ran.
    :type node_info: ~batch_service.models.ComputeNodeInformation
    :param start_time: The time at which the subtask started running. If the subtask has been
     restarted or retried, this is the most recent time at which the subtask started running.
    :type start_time: ~datetime.datetime
    :param end_time: This property is set only if the subtask is in the Completed state.
    :type end_time: ~datetime.datetime
    :param exit_code: This property is set only if the subtask is in the completed state. In
     general, the exit code for a process reflects the specific convention implemented by the
     application developer for that process. If you use the exit code value to make decisions in
     your code, be sure that you know the exit code convention used by the application process.
    ...
    :param failure_info: This property is set only if the Task is in the completed state and
     encountered a failure.
    :type failure_info: ~batch_service.models.TaskFailureInformation
    :param state: The state of the subtask. Possible values include: "preparing", "running",
     "completed".
    :type state: str or ~batch_service.models.SubtaskState
    :param state_transition_time: The time at which the subtask entered its current state.
    :type state_transition_time: ~datetime.datetime
    :param previous_state: This property is not set if the subtask is in its initial running state.
     Possible values include: "preparing", "running", "completed".
    :type previous_state: str or ~batch_service.models.SubtaskState
    :param previous_state_transition_time: This property is not set if the subtask is in its
...
class TaskAddCollectionParameter(msrest.serialization.Model):
    ...
    :param value: Required. The total serialized size of this collection must be less than 1MB. If
     ...
     with fewer Tasks.
    :type value: list[~batch_service.models.TaskAddParameter]
    """
...
class TaskAddCollectionResult(msrest.serialization.Model):
    ...
    :type value: list[~batch_service.models.TaskAddResult]
    """
...
class TaskAddParameter(msrest.serialization.Model):
    ...
    :param display_name: The display name need not be unique and can contain any Unicode characters
     up to a maximum length of 1024.
    :type display_name: str
    :param command_line: Required. For multi-instance Tasks, the command line is executed as the
    ...
    :param affinity_info: A locality hint that can be used by the Batch service to select a Compute
     Node on which to start a Task.
    :type affinity_info: ~batch_service.models.AffinityInformation
    :param constraints: If you do not specify constraints, the maxTaskRetryCount is the
...
class TaskAddResult(msrest.serialization.Model):
    ...
    :param status: Required. The status of the add Task request. Possible values include:
     "success", "clienterror", "servererror".
    :type status: str or ~batch_service.models.TaskAddStatus
    :param task_id: Required. The ID of the Task for which this is the result.
    :type task_id: str
    :param e_tag: You can use this to detect whether the Task has changed between requests. In
    ...
    :type location: str
    :param error: An error response received from the Azure Batch service.
    :type error: ~batch_service.models.BatchError
    """
...
class TaskConstraints(msrest.serialization.Model):
    ...
    :param max_wall_clock_time: If this is not specified, there is no time limit on how long the
     Task may run.
    :type max_wall_clock_time: ~datetime.timedelta
    :param retention_time: The default is 7 days, i.e. the Task directory will be retained for 7
     days unless the Compute Node is removed or the Job is deleted.
...
class TaskContainerExecutionInformation(msrest.serialization.Model):
    ...
    :param state: This is the state of the container according to the Docker service. It is
     equivalent to the status field returned by "docker inspect".
    :type state: str
    :param error: This is the detailed error string from the Docker service, if available. It is
...
class TaskContainerSettings(msrest.serialization.Model):
    ...
    :type registry: ~batch_service.models.ContainerRegistry
    :param working_directory: The default is 'taskWorkingDirectory'. Possible values include:
     "taskWorkingDirectory", "containerImageDefault".
    :type working_directory: str or ~batch_service.models.ContainerWorkingDirectory
    """
...
class TaskCounts(msrest.serialization.Model):
    ...
    :type active: int
    :param running: Required. The number of Tasks in the running or preparing state.
    :type running: int
    :param completed: Required. The number of Tasks in the completed state.
    :type completed: int
    :param succeeded: Required. The number of Tasks which succeeded. A Task succeeds if its result
     (found in the executionInfo property) is 'success'.
    :type succeeded: int
    :param failed: Required. The number of Tasks which failed. A Task fails if its result (found in
...
class TaskCountsResult(msrest.serialization.Model):
    ...
    :param task_counts: Required. The Task counts for a Job.
    :type task_counts: ~batch_service.models.TaskCounts
    :param task_slot_counts: Required. The TaskSlot counts for a Job.
    :type task_slot_counts: ~batch_service.models.TaskSlotCounts
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.task_counts = kwargs['task_counts']
        self.task_slot_counts = kwargs['task_slot_counts']
...
class TaskDependencies(msrest.serialization.Model):
    ...
    :param task_ids: The taskIds collection is limited to 64000 characters total (i.e. the combined
    ...
    :param task_id_ranges: The list of Task ID ranges that this Task depends on. All Tasks in all
     ranges must complete successfully before the dependent Task can be scheduled.
    :type task_id_ranges: list[~batch_service.models.TaskIdRange]
    """
...
class TaskExecutionInformation(msrest.serialization.Model):
    ...
    :param start_time: 'Running' corresponds to the running state, so if the Task specifies
    ...
    :param end_time: This property is set only if the Task is in the Completed state.
    :type end_time: ~datetime.datetime
    :param exit_code: This property is set only if the Task is in the completed state. In general,
    ...
    :param last_retry_time: This element is present only if the Task was retried (i.e. retryCount
     ...
     rebooted during a retry, then the startTime is updated but the lastRetryTime is not.
    :type last_retry_time: ~datetime.datetime
    :param requeue_count: Required. When the user removes Compute Nodes from a Pool (by
    ...
    :param last_requeue_time: This property is set only if the requeueCount is nonzero.
    :type last_requeue_time: ~datetime.datetime
    :param result: If the value is 'failed', then the details of the failure can be found in the
     failureInfo property. Possible values include: "success", "failure".
    :type result: str or ~batch_service.models.TaskExecutionResult
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.retry_count = kwargs['retry_count']
        self.last_retry_time = kwargs.get('last_retry_time', None)
        self.requeue_count = kwargs['requeue_count']
...
class TaskFailureInformation(msrest.serialization.Model):
    ...
    :param category: Required. The category of the error. Possible values include: "usererror",
     "servererror".
    :type category: str or ~batch_service.models.ErrorCategory
    :param code: An identifier for the Task error. Codes are invariant and are intended to be
     consumed programmatically.
    :type code: str
    :param message: A message describing the Task error, intended to be suitable for display in a
     user interface.
    :type message: str
...
class TaskInformation(msrest.serialization.Model):
    ...
    :type task_id: str
    :param subtask_id: The ID of the subtask if the Task is a multi-instance Task.
    :type subtask_id: int
    :param task_state: Required. The state of the Task. Possible values include: "active",
     "preparing", "running", "completed".
    :type task_state: str or ~batch_service.models.TaskState
    :param execution_info: Information about the execution of a Task.
    :type execution_info: ~batch_service.models.TaskExecutionInformation
    """
...
class TaskSchedulingPolicy(msrest.serialization.Model):
    ...
    :param node_fill_type: Required. If not specified, the default is spread. Possible values
     include: "spread", "pack".
    :type node_fill_type: str or ~batch_service.models.ComputeNodeFillType
    """
...
class TaskStatistics(msrest.serialization.Model):
    ...
    :param wall_clock_time: Required. The wall clock time is the elapsed time from when the Task
     ...
     clock time of all the Task retries.
    :type wall_clock_time: ~datetime.timedelta
    :param read_i_ops: Required. The total number of disk read operations made by the Task.
    :type read_i_ops: long
    :param write_i_ops: Required. The total number of disk write operations made by the Task.
    :type write_i_ops: long
    :param read_io_gi_b: Required. The total gibibytes read from disk by the Task.
    :type read_io_gi_b: float
    :param write_io_gi_b: Required. The total gibibytes written to disk by the Task.
    :type write_io_gi_b: float
    :param wait_time: Required. The total wait time of the Task. The wait time for a Task is
...
class UploadBatchServiceLogsConfiguration(msrest.serialization.Model):
    ...
    :param container_url: Required. The URL must include a Shared Access Signature (SAS) granting
     write permissions to the container. The SAS duration must allow enough time for the upload to
     finish. The start time for SAS is optional and recommended to not be specified.
    :type container_url: str
    :param start_time: Required. Any log file containing a log message in the time range will be
     ...
     have been requested.
    :type start_time: ~datetime.datetime
    :param end_time: Any log file containing a log message in the time range will be uploaded. This
...
class UploadBatchServiceLogsResult(msrest.serialization.Model):
    ...
    :param virtual_directory_name: Required. The virtual directory name is part of the blob name
     for each log file uploaded, and it is built based poolId, nodeId and a unique identifier.
    :type virtual_directory_name: str
    :param number_of_files_uploaded: Required. The number of log files which will be uploaded.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.virtual_directory_name = kwargs['virtual_directory_name']
        self.number_of_files_uploaded = kwargs['number_of_files_uploaded']
...
class UsageStatistics(msrest.serialization.Model):
    ...
    :param last_update_time: Required. The time at which the statistics were last updated. All
     statistics are limited to the range between startTime and lastUpdateTime.
    :type last_update_time: ~datetime.datetime
    :param dedicated_core_time: Required. The aggregated wall-clock time of the dedicated Compute
     Node cores being part of the Pool.
    :type dedicated_core_time: ~datetime.timedelta
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.start_time = kwargs['start_time']
        self.last_update_time = kwargs['last_update_time']
        self.dedicated_core_time = kwargs['dedicated_core_time']
...
class UserAccount(msrest.serialization.Model):
    ...
    :type linux_user_configuration: ~batch_service.models.LinuxUserConfiguration
    :param windows_user_configuration: This property can only be specified if the user is on a
     ...
     options.
    :type windows_user_configuration: ~batch_service.models.WindowsUserConfiguration
    """
...
class UserIdentity(msrest.serialization.Model):
    ...
    :param auto_user: The userName and autoUser properties are mutually exclusive; you must specify
     one but not both.
    :type auto_user: ~batch_service.models.AutoUserSpecification
    """
...
class VirtualMachineConfiguration(msrest.serialization.Model):
    ...
    :param image_reference: Required. A reference to an Azure Virtual Machines Marketplace Image or
     ...
     verified by Azure Batch, see the 'List Supported Images' operation.
    :type image_reference: ~batch_service.models.ImageReference
    :param node_agent_sku_id: Required. The Batch Compute Node agent is a program that runs on each
    ...
    :type windows_configuration: ~batch_service.models.WindowsConfiguration
    :param data_disks: This property must be specified if the Compute Nodes in the Pool need to
     ...
     use - for more information see https://docs.microsoft.com/en-us/azure/virtual-
     machines/linux/classic/attach-disk#initialize-a-new-data-disk-in-linux and
     https://docs.microsoft.com/en-us/azure/virtual-machines/windows/attach-disk-ps#add-an-empty-
     data-disk-to-a-virtual-machine.
    :type data_disks: list[~batch_service.models.DataDisk]
    ...
    :param container_configuration: If specified, setup is performed on each Compute Node in the
    ...
    :type container_configuration: ~batch_service.models.ContainerConfiguration
    ...
    :type disk_encryption_configuration: ~batch_service.models.DiskEncryptionConfiguration
    """
...
class WindowsUserConfiguration(msrest.serialization.Model):
    ...
    :param login_mode: The default value for VirtualMachineConfiguration Pools is 'batch' and for
     CloudServiceConfiguration Pools is 'interactive'. Possible values include: "batch",
     "interactive".
    :type login_mode: str or ~batch_service.models.LoginMode
    """
