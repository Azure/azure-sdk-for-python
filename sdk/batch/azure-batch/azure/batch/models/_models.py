...
class AccountListSupportedImagesResult(Model):
    ...
    :param value:
    :type value: list[~batchservice.models.ImageInformation]
...
class ApplicationListResult(Model):
    ...
    :param value:
    :type value: list[~batchservice.models.ApplicationSummary]
    :param odatanext_link:
    :type odatanext_link: str
    """
...
class AuthenticationTokenSettings(Model):
    ...
    :type access: list[str or ~batchservice.models.AccessScope]
    """
...
class AutoPoolSpecification(Model):
    ...
    :param pool_lifetime_option: Required. Possible values include:
     'jobSchedule', 'job'
    :type pool_lifetime_option: str or ~batchservice.models.PoolLifetimeOption
    ...
    :type pool: ~batchservice.models.PoolSpecification
    """
...
class AutoScaleRun(Model):
    ...
    :type error: ~batchservice.models.AutoScaleRunError
    """
...
class AutoScaleRunError(Model):
    ...
    :type message: str
    :param values:
    :type values: list[~batchservice.models.NameValuePair]
    """
...
class AutoUserSpecification(Model):
    ...
    :type scope: str or ~batchservice.models.AutoUserScope
    ...
    :type elevation_level: str or ~batchservice.models.ElevationLevel
    """
...
class AzureBlobFileSystemConfiguration(Model):
    ...
    :type identity_reference:
     ~batchservice.models.ComputeNodeIdentityReference
    """
...
class BatchError(Model):
    ...
    :type message: ~batchservice.models.ErrorMessage
    :param values:
    :type values: list[~batchservice.models.BatchErrorDetail]
    """
...
class Certificate(Model):
    ...
    :type state: str or ~batchservice.models.CertificateState
    ...
    :type previous_state: str or ~batchservice.models.CertificateState
    ...
    :type delete_certificate_error:
     ~batchservice.models.DeleteCertificateError
    """
...
class CertificateAddParameter(Model):
    ...
    :type certificate_format: str or ~batchservice.models.CertificateFormat
...
class CertificateListResult(Model):
    ...
    :param value:
    :type value: list[~batchservice.models.Certificate]
    :param odatanext_link:
    :type odatanext_link: str
    """
...
class CertificateReference(Model):
    ...
    :type store_location: str or ~batchservice.models.CertificateStoreLocation
    ...
    :type visibility: list[str or ~batchservice.models.CertificateVisibility]
    """
...
class CloudJob(Model):
    ...
    :param state: The current state of the Job. Possible values include:
     ...
     'deleting'
    :type state: str or ~batchservice.models.JobState
    :param state_transition_time:
    :type state_transition_time: datetime
    :param previous_state: The previous state of the Job. This property is not
     ...
     'active', 'disabling', 'disabled', 'enabling', 'terminating', 'completed',
     'deleting'
    :type previous_state: str or ~batchservice.models.JobState
    ...
    :type constraints: ~batchservice.models.JobConstraints
    :param job_manager_task: Details of a Job Manager Task to be launched when
     the Job is started.
    :type job_manager_task: ~batchservice.models.JobManagerTask
    :param job_preparation_task: The Job Preparation Task. The Job Preparation
     ...
     the Job.
    :type job_preparation_task: ~batchservice.models.JobPreparationTask
    ...
    :type job_release_task: ~batchservice.models.JobReleaseTask
    ...
    :type common_environment_settings:
     list[~batchservice.models.EnvironmentSetting]
    :param pool_info: The Pool settings associated with the Job.
    :type pool_info: ~batchservice.models.PoolInformation
    ...
    :type on_all_tasks_complete: str or
     ~batchservice.models.OnAllTasksComplete
    ...
    :type on_task_failure: str or ~batchservice.models.OnTaskFailure
    :param network_configuration: The network configuration for the Job.
    :type network_configuration: ~batchservice.models.JobNetworkConfiguration
    :param metadata: The Batch service does not assign any meaning to
     metadata; it is solely for the use of user code.
    :type metadata: list[~batchservice.models.MetadataItem]
    :param execution_info: The execution information for the Job.
    :type execution_info: ~batchservice.models.JobExecutionInformation
    ...
    :type stats: ~batchservice.models.JobStatistics
    """
    ...
    def __init__(self, **kwargs):
        ...
        self.allow_task_preemption = kwargs.get('allow_task_preemption', None)
        self.max_parallel_tasks = kwargs.get('max_parallel_tasks', -1)
...
class CloudJobListPreparationAndReleaseTaskStatusResult(Model):
    ...
    :param value:
    :type value:
     list[~batchservice.models.JobPreparationAndReleaseTaskExecutionInformation]
    :param odatanext_link:
    :type odatanext_link: str
    """
...
class CloudJobListResult(Model):
    ...
    :param value:
    :type value: list[~batchservice.models.CloudJob]
    :param odatanext_link:
    :type odatanext_link: str
    """
...
class CloudJobSchedule(Model):
    ...
    :type state: str or ~batchservice.models.JobScheduleState
    :param state_transition_time:
    :type state_transition_time: datetime
    ...
    :type previous_state: str or ~batchservice.models.JobScheduleState
    ...
    :param schedule: The schedule according to which Jobs will be created. All
     ...
     time.
    :type schedule: ~batchservice.models.Schedule
    :param job_specification: The details of the Jobs to be created on this
     schedule.
    :type job_specification: ~batchservice.models.JobSpecification
    :param execution_info: Information about Jobs that have been and will be
     run under this schedule.
    :type execution_info: ~batchservice.models.JobScheduleExecutionInformation
    :param metadata: The Batch service does not assign any meaning to
     metadata; it is solely for the use of user code.
    :type metadata: list[~batchservice.models.MetadataItem]
    :param stats: The lifetime resource usage statistics for the Job Schedule.
     ...
     minutes.
    :type stats: ~batchservice.models.JobScheduleStatistics
    """
...
class CloudJobScheduleListResult(Model):
    ...
    :param value:
    :type value: list[~batchservice.models.CloudJobSchedule]
    :param odatanext_link:
    :type odatanext_link: str
    """
...
class CloudPool(Model):
    ...
    :type state: str or ~batchservice.models.PoolState
    :param state_transition_time:
    :type state_transition_time: datetime
    :param allocation_state: Possible values include: 'steady', 'resizing',
     'stopping'
    :type allocation_state: str or ~batchservice.models.AllocationState
    ...
    :type cloud_service_configuration:
     ~batchservice.models.CloudServiceConfiguration
    ...
    :type virtual_machine_configuration:
     ~batchservice.models.VirtualMachineConfiguration
    ...
    :type resize_errors: list[~batchservice.models.ResizeError]
    ...
    :type auto_scale_run: ~batchservice.models.AutoScaleRun
    ...
    :type network_configuration: ~batchservice.models.NetworkConfiguration
    :param start_task: A Task specified to run on each Compute Node as it
     joins the Pool.
    :type start_task: ~batchservice.models.StartTask
    ...
    :type certificate_references:
     list[~batchservice.models.CertificateReference]
    ...
    :type application_package_references:
     list[~batchservice.models.ApplicationPackageReference]
    ...
    :type task_scheduling_policy: ~batchservice.models.TaskSchedulingPolicy
    :param user_accounts:
    :type user_accounts: list[~batchservice.models.UserAccount]
    :param metadata:
    :type metadata: list[~batchservice.models.MetadataItem]
    :param stats: Utilization and resource usage statistics for the entire
     ...
     about 30 minutes.
    :type stats: ~batchservice.models.PoolStatistics
    :param mount_configuration: This supports Azure Files, NFS, CIFS/SMB, and
     Blobfuse.
    :type mount_configuration: list[~batchservice.models.MountConfiguration]
    :param identity: The identity of the Batch pool, if configured. The list
     ...
     '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
    :type identity: ~batchservice.models.BatchPoolIdentity
    ...
    :type target_node_communication_mode: str or
     ~batchservice.models.NodeCommunicationMode
...
class CloudPoolListResult(Model):
    ...
    :param value:
    :type value: list[~batchservice.models.CloudPool]
    :param odatanext_link:
    :type odatanext_link: str
    """
...
class CloudTask(Model):
    ...
    :param exit_conditions: How the Batch service should respond when the Task
     completes.
    :type exit_conditions: ~batchservice.models.ExitConditions
    :param state: The current state of the Task. Possible values include:
     'active', 'preparing', 'running', 'completed'
    :type state: str or ~batchservice.models.TaskState
    :param state_transition_time:
    :type state_transition_time: datetime
    ...
    :type previous_state: str or ~batchservice.models.TaskState
    :param previous_state_transition_time: This property is not set if the
    ...
    :param container_settings: The settings for the container under which the
     ...
     those files.
    :type container_settings: ~batchservice.models.TaskContainerSettings
    ...
    :type resource_files: list[~batchservice.models.ResourceFile]
    ...
    :type output_files: list[~batchservice.models.OutputFile]
    :param environment_settings:
    :type environment_settings: list[~batchservice.models.EnvironmentSetting]
    ...
    :type affinity_info: ~batchservice.models.AffinityInformation
    :param constraints: The execution constraints that apply to this Task.
    :type constraints: ~batchservice.models.TaskConstraints
    ...
    :type user_identity: ~batchservice.models.UserIdentity
    :param execution_info: Information about the execution of the Task.
    :type execution_info: ~batchservice.models.TaskExecutionInformation
    :param node_info: Information about the Compute Node on which the Task
     ran.
    :type node_info: ~batchservice.models.ComputeNodeInformation
    :param multi_instance_settings: An object that indicates that the Task is
     ...
     multi-instance Task.
    :type multi_instance_settings: ~batchservice.models.MultiInstanceSettings
    :param stats: Resource usage statistics for the Task.
    :type stats: ~batchservice.models.TaskStatistics
    ...
    :type depends_on: ~batchservice.models.TaskDependencies
    ...
    :type authentication_token_settings:
     ~batchservice.models.AuthenticationTokenSettings
    """
...
class CloudTaskListResult(Model):
    ...
    :param value:
    :type value: list[~batchservice.models.CloudTask]
    :param odatanext_link:
    :type odatanext_link: str
    """
...
class CloudTaskListSubtasksResult(Model):
    ...
    :param value:
    :type value: list[~batchservice.models.SubtaskInformation]
    """
...
class ComputeNode(Model):
    ...
    :type state: str or ~batchservice.models.ComputeNodeState
    :param scheduling_state: Possible values include: 'enabled', 'disabled'
    :type scheduling_state: str or ~batchservice.models.SchedulingState
    :param state_transition_time:
    :type state_transition_time: datetime
    ...
    :type recent_tasks: list[~batchservice.models.TaskInformation]
    ...
    :type start_task_info: ~batchservice.models.StartTaskInformation
    :param certificate_references: For Windows Nodes, the Batch service
     installs the Certificates to the specified Certificate store and location.
     For Linux Compute Nodes, the Certificates are stored in a directory inside
     the Task working directory and an environment variable
    ...
    :type certificate_references:
     list[~batchservice.models.CertificateReference]
    :param errors:
    :type errors: list[~batchservice.models.ComputeNodeError]
    ...
    :type endpoint_configuration:
     ~batchservice.models.ComputeNodeEndpointConfiguration
    ...
    :type node_agent_info: ~batchservice.models.NodeAgentInformation
    :param virtual_machine_info: Info about the current state of the virtual
     machine.
    :type virtual_machine_info: ~batchservice.models.VirtualMachineInfo
    """
    ...
    def __init__(self, **kwargs):
        ...
        self.virtual_machine_info = kwargs.get('virtual_machine_info', None)
...
class ComputeNodeEndpointConfiguration(Model):
    ...
    :type inbound_endpoints: list[~batchservice.models.InboundEndpoint]
    """
...
class ComputeNodeError(Model):
    ...
    :type message: str
    :param error_details:
    :type error_details: list[~batchservice.models.NameValuePair]
    """
...
class ComputeNodeListResult(Model):
    ...
    :param value:
    :type value: list[~batchservice.models.ComputeNode]
    :param odatanext_link:
    :type odatanext_link: str
    """
...
class ContainerConfiguration(Model):
    ...
    :param type: Required. Possible values include: 'dockerCompatible',
     'criCompatible'
    :type type: str or ~batchservice.models.ContainerType
    ...
    :param container_registries: If any Images must be downloaded from a
     ...
     be provided here.
    :type container_registries: list[~batchservice.models.ContainerRegistry]
    """
...
class DataDisk(Model):
    ...
    :type caching: str or ~batchservice.models.CachingType
    ...
    :type storage_account_type: str or ~batchservice.models.StorageAccountType
    """
...
class DiffDiskSettings(Model):
    ...
    :type placement: str or ~batchservice.models.DiffDiskPlacement
    """
...
class DiskEncryptionConfiguration(Model):
    ...
    :type targets: list[str or ~batchservice.models.DiskEncryptionTarget]
    """
...
class ExitCodeMapping(Model):
    ...
    :type exit_options: ~batchservice.models.ExitOptions
    """
...
class ExitConditions(Model):
    ...
    :param exit_codes:
    :type exit_codes: list[~batchservice.models.ExitCodeMapping]
    :param exit_code_ranges:
    :type exit_code_ranges: list[~batchservice.models.ExitCodeRangeMapping]
    :param pre_processing_error: How the Batch service should respond if the
     Task fails to start due to an error.
    :type pre_processing_error: ~batchservice.models.ExitOptions
    ...
    :type file_upload_error: ~batchservice.models.ExitOptions
    ...
    :type default: ~batchservice.models.ExitOptions
    """
...
class ExitOptions(Model):
    ...
    :type job_action: str or ~batchservice.models.JobAction
    ...
    :type dependency_action: str or ~batchservice.models.DependencyAction
    """
...
class ImageInformation(Model):
    ...
    :type image_reference: ~batchservice.models.ImageReference
    :param os_type: Required. Possible values include: 'linux', 'windows'
    :type os_type: str or ~batchservice.models.OSType
    ...
    :param verification_type: Required. Possible values include: 'verified',
     'unverified'
    :type verification_type: str or ~batchservice.models.VerificationType
    """
...
class InboundEndpoint(Model):
    ...
    :param protocol: Required. The protocol of the endpoint. Possible values
     include: 'tcp', 'udp'
    :type protocol: str or ~batchservice.models.InboundEndpointProtocol
...
class InboundNATPool(Model):
    ...
    :type network_security_group_rules:
     list[~batchservice.models.NetworkSecurityGroupRule]
    """
...
class InstanceViewStatus(Model):
    ...
    :type level: str or ~batchservice.models.StatusLevelTypes
    :param message:
    :type message: str
...
class JobDisableParameter(Model):
    ...
    :param disable_tasks: Required. Possible values include: 'requeue',
     'terminate', 'wait'
    :type disable_tasks: str or ~batchservice.models.DisableJobOption
    """
...
class JobExecutionInformation(Model):
    ...
    :param scheduling_error: Details of any error encountered by the service
     ...
     starting the Job.
    :type scheduling_error: ~batchservice.models.JobSchedulingError
...
class JobPatchParameter(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.priority = kwargs.get('priority', None)
        self.max_parallel_tasks = kwargs.get('max_parallel_tasks', None)
        self.allow_task_preemption = kwargs.get('allow_task_preemption', None)
        self.on_all_tasks_complete = kwargs.get('on_all_tasks_complete', None)
        self.constraints = kwargs.get('constraints', None)
        self.pool_info = kwargs.get('pool_info', None)
...
class JobPreparationAndReleaseTaskExecutionInformation(Model):
    ...
    :type job_preparation_task_execution_info:
     ~batchservice.models.JobPreparationTaskExecutionInformation
    ...
    :type job_release_task_execution_info:
     ~batchservice.models.JobReleaseTaskExecutionInformation
    """
...
class JobPreparationTaskExecutionInformation(Model):
    ...
    :type state: str or ~batchservice.models.JobPreparationTaskState
    :param task_root_directory:
    :type task_root_directory: str
    :param task_root_directory_url:
    :type task_root_directory_url: str
    ...
    :param container_info: Information about the container under which the
     ...
     container context.
    :type container_info:
     ~batchservice.models.TaskContainerExecutionInformation
    :param failure_info: Information describing the Task failure, if any. This
     ...
     a failure.
    :type failure_info: ~batchservice.models.TaskFailureInformation
    ...
    :type result: str or ~batchservice.models.TaskExecutionResult
    """
...
class JobReleaseTaskExecutionInformation(Model):
    ...
    :type end_time: datetime
    :param state: Required. Possible values include: 'running', 'completed'
    :type state: str or ~batchservice.models.JobReleaseTaskState
    :param task_root_directory:
    :type task_root_directory: str
    :param task_root_directory_url:
    :type task_root_directory_url: str
...
class JobScheduleExecutionInformation(Model):
    ...
    :param recent_job: Information about the most recent Job under the Job
     ...
     under the schedule.
    :type recent_job: ~batchservice.models.RecentJob
...
class JobSchedulingError(Model):
    ...
    :type category: str or ~batchservice.models.ErrorCategory
    :param code:
    :type code: str
    :param message:
    :type message: str
    :param details:
    :type details: list[~batchservice.models.NameValuePair]
    """
...
class MountConfiguration(Model):
    ...
    :type azure_blob_file_system_configuration:
     ~batchservice.models.AzureBlobFileSystemConfiguration
    :param nfs_mount_configuration: The NFS file system to mount on each node.
     This property is mutually exclusive with all other properties.
    :type nfs_mount_configuration: ~batchservice.models.NFSMountConfiguration
    ...
    :type cifs_mount_configuration:
     ~batchservice.models.CIFSMountConfiguration
    ...
    :type azure_file_share_configuration:
     ~batchservice.models.AzureFileShareConfiguration
    """
...
class MultiInstanceSettings(Model):
    ...
    :type common_resource_files: list[~batchservice.models.ResourceFile]
    """
...
class NetworkConfiguration(Model):
    ...
    :type dynamic_vnet_assignment_scope: str or
     ~batchservice.models.DynamicVNetAssignmentScope
    ...
    :type endpoint_configuration:
     ~batchservice.models.PoolEndpointConfiguration
    ...
    :type public_ip_address_configuration:
     ~batchservice.models.PublicIPAddressConfiguration
...
class NetworkSecurityGroupRule(Model):
    ...
    :type access: str or ~batchservice.models.NetworkSecurityGroupRuleAccess
...
class NodeDisableSchedulingParameter(Model):
    ...
    :type node_disable_scheduling_option: str or
     ~batchservice.models.DisableComputeNodeSchedulingOption
    """
...
class NodeFile(Model):
    ...
    :type properties: ~batchservice.models.FileProperties
    """
...
class NodeFileListResult(Model):
    ...
    :param value:
    :type value: list[~batchservice.models.NodeFile]
    :param odatanext_link:
    :type odatanext_link: str
    """
...
class NodePlacementConfiguration(Model):
    ...
    :param policy: Node placement Policy type on Batch Pools. Allocation
     ...
     'zonal'
    :type policy: str or ~batchservice.models.NodePlacementPolicyType
    """
...
class NodeRebootParameter(Model):
    ...
    :type node_reboot_option: str or
     ~batchservice.models.ComputeNodeRebootOption
    """
...
class NodeReimageParameter(Model):
    ...
    :type node_reimage_option: str or
     ~batchservice.models.ComputeNodeReimageOption
    """
...
class NodeRemoveParameter(Model):
    ...
    :type node_deallocation_option: str or
     ~batchservice.models.ComputeNodeDeallocationOption
    """
...
class NodeVMExtension(Model):
    ...
    :type vm_extension: ~batchservice.models.VMExtension
    :param instance_view: The vm extension instance view.
    :type instance_view: ~batchservice.models.VMExtensionInstanceView
    """
    ...
    def __init__(self, **kwargs):
        ...
        self.vm_extension = kwargs.get('vm_extension', None)
        self.instance_view = kwargs.get('instance_view', None)


class NodeVMExtensionList(Model):
    """The result of listing the Compute Node extensions in a Node.

    :param value:
    :type value: list[~batchservice.models.NodeVMExtension]
    :param odatanext_link:
    :type odatanext_link: str
    """
...
class OSDisk(Model):
    ...
    :type ephemeral_os_disk_settings: ~batchservice.models.DiffDiskSettings
    ...
    :type managed_disk: ~batchservice.models.ManagedDisk
...
class OutputFile(Model):
    ...
    :type destination: ~batchservice.models.OutputFileDestination
    ...
    :type upload_options: ~batchservice.models.OutputFileUploadOptions
    """
...
class OutputFileBlobContainerDestination(Model):
    ...
    :type upload_headers: list[~batchservice.models.HttpHeader]
    """
    ...
    def __init__(self, **kwargs):
        ...
        self.identity_reference = kwargs.get('identity_reference', None)
        self.upload_headers = kwargs.get('upload_headers', None)
...
class OutputFileDestination(Model):
    ...
    :param container: A location in Azure blob storage to which files are
     uploaded.
    :type container: ~batchservice.models.OutputFileBlobContainerDestination
    """
...
class OutputFileUploadOptions(Model):
    ...
    :type upload_condition: str or
     ~batchservice.models.OutputFileUploadCondition
    """
...
class PoolEndpointConfiguration(Model):
    ...
    :type inbound_nat_pools: list[~batchservice.models.InboundNATPool]
    """
...
class PoolInformation(Model):
    ...
    :type auto_pool_specification: ~batchservice.models.AutoPoolSpecification
    """
...
class PoolListUsageMetricsResult(Model):
    """The result of a listing the usage metrics for an Account.

    :param value:
    :type value: list[~batchservice.models.PoolUsageMetrics]
    :param odatanext_link:
    :type odatanext_link: str
    """
...
class PoolNodeCounts(Model):
    ...
    :type dedicated: ~batchservice.models.NodeCounts
    :param low_priority: The number of Spot/Low-priority Compute Nodes in each
     state.
    :type low_priority: ~batchservice.models.NodeCounts
    """
...
class PoolNodeCountsListResult(Model):
    ...
    :type value: list[~batchservice.models.PoolNodeCounts]
    :param odatanext_link:
    :type odatanext_link: str
    """
...
class PoolStatistics(Model):
    ...
    :param usage_stats: Statistics related to Pool usage, such as the amount
     of core-time used.
    :type usage_stats: ~batchservice.models.UsageStatistics
    :param resource_stats: Statistics related to resource consumption by
     Compute Nodes in the Pool.
    :type resource_stats: ~batchservice.models.ResourceStatistics
    """
...
class PublicIPAddressConfiguration(Model):
    ...
    :type provision: str or ~batchservice.models.IPAddressProvisioningType
...
class SecurityProfile(Model):
    ...
    :type security_type: str or ~batchservice.models.SecurityTypes
    ...
    :param uefi_settings: Specifies the security settings like secure boot and
     ...
     machine.
    :type uefi_settings: ~batchservice.models.UefiSettings
    """
...
class StartTaskInformation(Model):
    ...
    :param state: Required. Possible values include: 'running', 'completed'
    :type state: str or ~batchservice.models.StartTaskState
...
class SubtaskInformation(Model):
    ...
    :type state: str or ~batchservice.models.SubtaskState
    :param state_transition_time:
    :type state_transition_time: datetime
    ...
    :type previous_state: str or ~batchservice.models.SubtaskState
    :param previous_state_transition_time: This property is not set if the
...
class TaskAddCollectionParameter(Model):
    ...
    :param value: Required. The total serialized size of this collection must
     ...
     Tasks.
    :type value: list[~batchservice.models.TaskAddParameter]
    """
...
class TaskAddCollectionResult(Model):
    ...
    :param value:
    :type value: list[~batchservice.models.TaskAddResult]
    """
...
class TaskAddResult(Model):
    ...
    :type status: str or ~batchservice.models.TaskAddStatus
    ...
    :type error: ~batchservice.models.BatchError
    """
...
class TaskContainerSettings(Model):
    ...
    :type registry: ~batchservice.models.ContainerRegistry
    ...
    :type working_directory: str or
     ~batchservice.models.ContainerWorkingDirectory
    """
...
class TaskCountsResult(Model):
    ...
    :type task_counts: ~batchservice.models.TaskCounts
    :param task_slot_counts: Required. The number of TaskSlots required by
     Tasks per state.
    :type task_slot_counts: ~batchservice.models.TaskSlotCounts
    """
...
class TaskDependencies(Model):
    ...
    :type task_id_ranges: list[~batchservice.models.TaskIdRange]
    """
...
class TaskInformation(Model):
    ...
    :type task_state: str or ~batchservice.models.TaskState
    :param execution_info: Information about the execution of the Task.
    :type execution_info: ~batchservice.models.TaskExecutionInformation
    """
...
class TaskSchedulingPolicy(Model):
    ...
    :type node_fill_type: str or ~batchservice.models.ComputeNodeFillType
    """
...
class UserAccount(Model):
    ...
    :type linux_user_configuration:
     ~batchservice.models.LinuxUserConfiguration
    ...
    :type windows_user_configuration:
     ~batchservice.models.WindowsUserConfiguration
    """
...
class UserIdentity(Model):
    ...
    :param auto_user: The auto user under which the Task is run. The userName
     ...
     not both.
    :type auto_user: ~batchservice.models.AutoUserSpecification
    """
...
class VirtualMachineConfiguration(Model):
    ...
    :type windows_configuration: ~batchservice.models.WindowsConfiguration
    ...
    :type data_disks: list[~batchservice.models.DataDisk]
    ...
    :param container_configuration: The container configuration for the Pool.
     ...
     may specify it.
    :type container_configuration: ~batchservice.models.ContainerConfiguration
    ...
    :type disk_encryption_configuration:
     ~batchservice.models.DiskEncryptionConfiguration
    ...
    :type service_artifact_reference:
     ~batchservice.models.ServiceArtifactReference
    """
...
class VMExtensionInstanceView(Model):
    ...
    :type statuses: list[~batchservice.models.InstanceViewStatus]
    :param sub_statuses: The resource status information.
    :type sub_statuses: list[~batchservice.models.InstanceViewStatus]
    """
    ...
    def __init__(self, **kwargs):
        ...
        self.sub_statuses = kwargs.get('sub_statuses', None)
...
class WindowsUserConfiguration(Model):
    ...
    :type login_mode: str or ~batchservice.models.LoginMode
    """
