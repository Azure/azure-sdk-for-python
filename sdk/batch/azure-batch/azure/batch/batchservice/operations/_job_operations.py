...
class JobOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.batch.batchservice.models.JobListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_preparation_and_release_task_status(
        ...
        *,
        ...
        ocp_date: Optional[datetime.datetime] = None,
        **kwargs: Any
    ) -> Iterable[_models.JobListPreparationAndReleaseTaskStatusResult]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.batch.batchservice.models.JobListPreparationAndReleaseTaskStatusResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
