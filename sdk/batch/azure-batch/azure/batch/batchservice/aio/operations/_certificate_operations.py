...
class CertificateOperations:
    ...
    async def add(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type certificate: ~azure.batch.batchservice.models.CertificateAddParameter
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.batch.batchservice.models.CertificateListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :paramtype ocp_date: ~datetime.datetime
        :return: Certificate
        :rtype: ~azure.batch.batchservice.models.Certificate
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
