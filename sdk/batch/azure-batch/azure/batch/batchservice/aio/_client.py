...
class BatchServiceClient:    # pylint: disable=too-many-instance-attributes
    ...
    :vartype application: azure.batch.batchservice.aio.operations.ApplicationOperations
    :ivar pool: PoolOperations operations
    :vartype pool: azure.batch.batchservice.aio.operations.PoolOperations
    :ivar account: AccountOperations operations
    :vartype account: azure.batch.batchservice.aio.operations.AccountOperations
    :ivar job: JobOperations operations
    :vartype job: azure.batch.batchservice.aio.operations.JobOperations
    :ivar certificate: CertificateOperations operations
    :vartype certificate: azure.batch.batchservice.aio.operations.CertificateOperations
    :ivar file: FileOperations operations
    :vartype file: azure.batch.batchservice.aio.operations.FileOperations
    :ivar job_schedule: JobScheduleOperations operations
    :vartype job_schedule: azure.batch.batchservice.aio.operations.JobScheduleOperations
    :ivar task: TaskOperations operations
    :vartype task: azure.batch.batchservice.aio.operations.TaskOperations
    :ivar compute_node: ComputeNodeOperations operations
    :vartype compute_node: azure.batch.batchservice.aio.operations.ComputeNodeOperations
    :ivar compute_node_extension: ComputeNodeExtensionOperations operations
    :vartype compute_node_extension:
     azure.batch.batchservice.aio.operations.ComputeNodeExtensionOperations
