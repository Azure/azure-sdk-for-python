...
class EdgeActionAttachment(_Model):
    ...
    :ivar id: The edge action attachment id. Required.
    :vartype id: str
    ...
    """The edge action attachment id. Required."""
...
class EdgeActionAttachmentResponse(_Model):
    """Edge action attachment response.

    :ivar edge_action_id: Non changing guid to identity edge action. Required.
    :vartype edge_action_id: str
    """

    edge_action_id: str = rest_field(name="edgeActionId", visibility=["read", "create", "update", "delete", "query"])
    """Non changing guid to identity edge action. Required."""
...
class EdgeActionExecutionFilterProperties(_Model):
    ...
    :ivar last_update_time: The last update time in UTC for the execution filter. Required.
    ...
    last_update_time: datetime.datetime = rest_field(name="lastUpdateTime", visibility=["read"], format="rfc3339")
    """The last update time in UTC for the execution filter. Required."""
...
class EdgeActionVersionProperties(_Model):
    ...
    :ivar validation_status: The validation status. Required. Known values are: "Succeeded" and
     "Failed".
    ...
    :ivar last_package_update_time: The last update time in UTC for package update. Required.
    ...
    validation_status: Union[str, "_models.EdgeActionVersionValidationStatus"] = rest_field(
        name="validationStatus", visibility=["read"]
    )
    """The validation status. Required. Known values are: \"Succeeded\" and \"Failed\"."""
    provisioning_state: Optional[Union[str, "_models.ProvisioningState"]] = rest_field(
        name="provisioningState", visibility=["read"]
    )
    """The provisioning state. Known values are: \"Succeeded\", \"Failed\", \"Canceled\",
    ...
    last_package_update_time: datetime.datetime = rest_field(
        name="lastPackageUpdateTime", visibility=["read"], format="rfc3339"
    )
    """The last update time in UTC for package update. Required."""
