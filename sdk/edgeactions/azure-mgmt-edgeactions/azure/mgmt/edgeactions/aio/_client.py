...
class EdgeActionsMgmtClient:
    ...
    :vartype edge_action_execution_filters:
     azure.mgmt.edgeactions.aio.operations.EdgeActionExecutionFiltersOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.edge_action_execution_filters = EdgeActionExecutionFiltersOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
