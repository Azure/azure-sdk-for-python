...
class TestCdnEdgeActionsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_edge_actions_begin_add_attachment(self, resource_group):
        response = await (
            await self.client.edge_actions.begin_add_attachment(
                resource_group_name=resource_group.name,
                edge_action_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_edge_actions_begin_delete_attachment(self, resource_group):
        response = await (
            await self.client.edge_actions.begin_delete_attachment(
                resource_group_name=resource_group.name,
                edge_action_name="str",
                body={"attachedResourceId": "str", "id": "str"},
            )
