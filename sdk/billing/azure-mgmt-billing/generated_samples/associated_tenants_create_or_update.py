...
# USAGE
    python associated_tenants_create_or_update.py
...
def main():
    ...
    response = client.associated_tenants.begin_create_or_update(
...
# x-ms-original-file: specification/billing/resource-manager/Microsoft.Billing/Billing/stable/2024-04-01/examples/associatedTenantsCreateOrUpdate.json
