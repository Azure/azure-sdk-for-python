...
# USAGE
    python partner_transfers_get.py
...
def main():
    ...
    response = client.partner_transfers.get(
...
# x-ms-original-file: specification/billing/resource-manager/Microsoft.Billing/Billing/stable/2024-04-01/examples/partnerTransfersGet.json
