...
# USAGE
    python billing_role_assignment_create_or_update_by_enrollment_account.py
...
def main():
    ...
    response = client.billing_role_assignments.begin_create_or_update_by_enrollment_account(
...
# x-ms-original-file: specification/billing/resource-manager/Microsoft.Billing/Billing/stable/2024-04-01/examples/billingRoleAssignmentCreateOrUpdateByEnrollmentAccount.json
