...
class InvoiceSectionsOperations(object):
    ...
    def list_by_billing_account_name(
        ...
        return deserialized
    list_by_billing_account_name.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/invoiceSections'}
    ...
    def list_by_billing_profile_name(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of InvoiceSection
        :rtype:
         ~azure.mgmt.billing.models.InvoiceSectionPaged[~azure.mgmt.billing.models.InvoiceSection]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.billing.models.ErrorResponseException>`
        """
        ...
        deserialized = models.InvoiceSectionPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.InvoiceSectionPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
    ...
    def list_by_create_subscription_permission(
        ...
        def internal_paging(next_link=None, raw=False):
            ...
            if not next_link:
                # Construct URL
                url = self.list_by_create_subscription_permission.metadata['url']
                path_format_arguments = {
                    'billingAccountName': self._serialize.url("billing_account_name", billing_account_name, 'str')
                }
                url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    list_by_create_subscription_permission.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/listInvoiceSectionsWithCreateSubscriptionPermission'}
