...
class InvoiceSectionsOperations(object):
    ...
    def list_by_create_subscription_permission(
        ...
        return deserialized
    list_by_create_subscription_permission.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/listInvoiceSectionsWithCreateSubscriptionPermission'}
