...
class RecipientTransfersOperations(object):
    ...
    def validate(
            self, transfer_name, product_details=None, custom_headers=None, raw=False, **operation_config):
        """Validates if a subscription or a reservation can be transferred. Use
        this operation to validate your subscriptions or reservation before
        using the accept transfer operation.
