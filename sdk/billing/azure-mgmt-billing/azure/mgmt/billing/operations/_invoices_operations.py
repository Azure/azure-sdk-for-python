...
def build_list_by_billing_profile_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/invoices")  # pylint: disable=line-too-long
    path_format_arguments = {
        "billingAccountName": _SERIALIZER.url("billing_account_name", billing_account_name, 'str'),
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/invoices/{invoiceName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "billingAccountName": _SERIALIZER.url("billing_account_name", billing_account_name, 'str'),
...
def build_download_invoice_request_initial(
    billing_account_name: str,
    invoice_name: str,
    *,
    download_token: str,
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/invoices/{invoiceName}/download")  # pylint: disable=line-too-long
    path_format_arguments = {
        "billingAccountName": _SERIALIZER.url("billing_account_name", billing_account_name, 'str'),
        "invoiceName": _SERIALIZER.url("invoice_name", invoice_name, 'str'),
    }
...
def build_download_multiple_billing_profile_invoices_request_initial(
    billing_account_name: str,
    *,
...
def build_list_by_billing_subscription_request(
    subscription_id: str,
    *,
    period_start_date: str,
    period_end_date: str,
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Billing/billingAccounts/default/billingSubscriptions/{subscriptionId}/invoices")  # pylint: disable=line-too-long
    path_format_arguments = {
...
def build_get_by_subscription_and_invoice_id_request(
    subscription_id: str,
    invoice_name: str,
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Billing/billingAccounts/default/billingSubscriptions/{subscriptionId}/invoices/{invoiceName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "invoiceName": _SERIALIZER.url("invoice_name", invoice_name, 'str'),
    }
...
def build_download_billing_subscription_invoice_request_initial(
    subscription_id: str,
    invoice_name: str,
    *,
    download_token: str,
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Billing/billingAccounts/default/billingSubscriptions/{subscriptionId}/invoices/{invoiceName}/download")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "invoiceName": _SERIALIZER.url("invoice_name", invoice_name, 'str'),
    }
...
def build_download_multiple_billing_subscription_invoices_request_initial(
    subscription_id: str,
    *,
    json: Optional[List[str]] = None,
    content: Any = None,
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Billing/billingAccounts/default/billingSubscriptions/{subscriptionId}/downloadDocuments")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
...
class InvoicesOperations:
    ...
    def list_by_billing_account(
        ...
        period_end_date: str,
        **kwargs: Any
    ) -> Iterable[_models.InvoiceListResult]:
    ...
    def begin_download_invoice(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._download_invoice_initial(  # type: ignore
                billing_account_name=billing_account_name,
                invoice_name=invoice_name,
                download_token=download_token,
                api_version=api_version,
    ...
    def begin_download_multiple_billing_profile_invoices(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._download_multiple_billing_profile_invoices_initial(  # type: ignore
                billing_account_name=billing_account_name,
    ...
    def begin_download_billing_subscription_invoice(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._download_billing_subscription_invoice_initial(  # type: ignore
                invoice_name=invoice_name,
                download_token=download_token,
                api_version=api_version,
                cls=lambda x,y,z: x,
    ...
    def begin_download_multiple_billing_subscription_invoices(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._download_multiple_billing_subscription_invoices_initial(  # type: ignore
                download_urls=download_urls,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x,y,z: x,
