...
class InvoicesOperations(object):
    ...
    def list_by_billing_account(
        ...
        type Microsoft Partner Agreement, Microsoft Customer Agreement or
    ...
    def get_billing_account_invoice(
        ...
        """
        # Construct URL
        url = self.get_billing_account_invoice.metadata['url']
        path_format_arguments = {
            'billingAccountName': self._serialize.url("billing_account_name", billing_account_name, 'str'),
        ...
        return deserialized
    get_billing_account_invoice.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/invoices/{invoiceName}'}
    ...
    def list_by_billing_subscription(
        ...
        :param billing_account_name: The ID that uniquely identifies a billing
         account.
        :type billing_account_name: str
        :param billing_subscription_name: The ID that uniquely identifies a
         subscription.
