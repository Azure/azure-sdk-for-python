...
def build_list_by_billing_account_request(
    billing_account_name: str, *, period_start_date: str, period_end_date: str, **kwargs: Any
) -> HttpRequest:
...
def build_list_by_billing_profile_request(
    billing_account_name: str, billing_profile_name: str, *, period_start_date: str, period_end_date: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_download_invoice_request(
    billing_account_name: str, invoice_name: str, *, download_token: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_by_billing_subscription_request(
    subscription_id: str, *, period_start_date: str, period_end_date: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_download_billing_subscription_invoice_request(
    invoice_name: str, subscription_id: str, *, download_token: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
