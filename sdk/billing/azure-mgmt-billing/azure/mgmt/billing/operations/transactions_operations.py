...
class TransactionsOperations(object):
    ...
    def list_by_customer_name(
        ...
        return deserialized
    list_by_customer_name.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/customers/{customerName}/transactions'}

    def list_by_invoice_section_name(
            self, billing_account_name, invoice_section_name, start_date, end_date, filter=None, custom_headers=None, raw=False, **operation_config):
        """Lists the transactions by invoice section name for given start date and
        end date.
        ...
        return deserialized
    list_by_invoice_section_name.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/invoiceSections/{invoiceSectionName}/transactions'}
