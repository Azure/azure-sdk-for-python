...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
class BillingPeriodsOperations:
    ...
    def list(
        ...
        top: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable[_models.BillingPeriodsListResult]:
