...
def build_get_request(billing_period_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}"
...
class BillingPeriodsOperations:
    ...
    @distributed_trace
    def list(
        self, filter: Optional[str] = None, skiptoken: Optional[str] = None, top: Optional[int] = None, **kwargs: Any
    ) -> Iterable["_models.BillingPeriod"]:
