...
class BillingAccountsOperations(object):
    ...
    def list(
        ...
        :param expand: May be used to expand the soldTo, invoice sections and
         billing profiles.
        :type expand: str
        ...
        if raw:
            header_dict = {}
        deserialized = models.BillingAccountPaged(internal_paging, self._deserialize.dependencies, header_dict)
