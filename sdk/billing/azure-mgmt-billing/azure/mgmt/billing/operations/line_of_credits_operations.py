...
class LineOfCreditsOperations(object):
    ...
    def _increase_initial(
            self, desired_credit_limit=None, custom_headers=None, raw=False, **operation_config):
        parameters = models.IncreaseLineOfCreditRequestProperties(desired_credit_limit=desired_credit_limit)
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'IncreaseLineOfCreditRequestProperties')
    ...
    def increase(
        ...
        raw_result = self._increase_initial(
            desired_credit_limit=desired_credit_limit,
    ...
    increase.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Billing/billingAccounts/default/lineOfCredit/default/increase'}
