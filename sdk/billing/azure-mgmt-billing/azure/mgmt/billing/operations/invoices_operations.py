...
class InvoicesOperations(object):
    ...
    def list_by_billing_account_name(
        ...
        :return: An iterator like instance of InvoiceSummary
        :rtype:
         ~azure.mgmt.billing.models.InvoiceSummaryPaged[~azure.mgmt.billing.models.InvoiceSummary]
        :raises:
        ...
        deserialized = models.InvoiceSummaryPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.InvoiceSummaryPaged(internal_paging, self._deserialize.dependencies, header_dict)
