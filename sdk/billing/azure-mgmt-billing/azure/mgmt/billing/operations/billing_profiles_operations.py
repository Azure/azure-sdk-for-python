...
class BillingProfilesOperations(object):
    ...
    def list_by_billing_account_name(
        ...
        deserialized = models.BillingProfilePaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.BillingProfilePaged(internal_paging, self._deserialize.dependencies, header_dict)
