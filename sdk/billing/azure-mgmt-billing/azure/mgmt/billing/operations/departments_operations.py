...
class DepartmentsOperations(object):
    ...
    def list_by_billing_account_name(
        ...
        :return: An iterator like instance of Department
        :rtype:
         ~azure.mgmt.billing.models.DepartmentPaged[~azure.mgmt.billing.models.Department]
        :raises:
        ...
        deserialized = models.DepartmentPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.DepartmentPaged(internal_paging, self._deserialize.dependencies, header_dict)
