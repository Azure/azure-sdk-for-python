...
class BillingProfilesOperations(object):
    ...
    def _create_initial(
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'BillingProfileCreationRequest')
    ...
    def create(
        ...
        :param billing_profile_name: The ID that uniquely identifies a billing
         profile.
        :type billing_profile_name: str
        :param parameters: Request parameters that are provided to the create
         billing profile operation.
        :type parameters:
         ~azure.mgmt.billing.models.BillingProfileCreationRequest
        :param dict custom_headers: headers that will be added to the request
    ...
    create.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}'}
