...
def build_validate_delete_eligibility_request(  # pylint: disable=name-too-long
...
def build_delete_request(billing_account_name: str, billing_profile_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_request(billing_account_name: str, billing_profile_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_create_or_update_request(billing_account_name: str, billing_profile_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_by_billing_account_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles"
    )
    path_format_arguments = {
        "billingAccountName": _SERIALIZER.url(
            "billing_account_name",
...
class BillingProfilesOperations:
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: BillingManagementClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def _delete_initial(self, billing_account_name: str, billing_profile_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def begin_delete(self, billing_account_name: str, billing_profile_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def get(self, billing_account_name: str, billing_profile_name: str, **kwargs: Any) -> _models.BillingProfile:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.BillingProfile].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.BillingProfile](
    ...
    def list_by_billing_account(
        ...
        search: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.BillingProfile"]:
