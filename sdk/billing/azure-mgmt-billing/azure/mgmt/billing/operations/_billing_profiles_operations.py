...
def build_list_by_billing_account_request(
    billing_account_name: str, *, expand: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
...
def build_get_request(
    billing_account_name: str, billing_profile_name: str, *, expand: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class BillingProfilesOperations:
    ...
    @distributed_trace
    def get(
        self, billing_account_name: str, billing_profile_name: str, expand: Optional[str] = None, **kwargs: Any
    ...
    def _create_or_update_initial(
        ...
        parameters: Union[_models.BillingProfile, IO],
        **kwargs: Any
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param billing_profile_name: The ID that uniquely identifies a billing profile. Required.
        :type billing_profile_name: str
        :param parameters: The new or updated billing profile. Required.
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param billing_profile_name: The ID that uniquely identifies a billing profile. Required.
        :type billing_profile_name: str
        :param parameters: The new or updated billing profile. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.billing.models.BillingProfile or IO
