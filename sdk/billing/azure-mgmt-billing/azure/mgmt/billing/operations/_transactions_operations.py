...
class TransactionsOperations(object):
    ...
    def list_by_customer(
        ...
        start date and end date. Transactions include purchases, refunds and
        Azure usage charges. Unbilled transactions are listed under pending
        invoice Id and do not include tax. Tax is added to the amount once an
        ...
        :param period_start_date: The start date to fetch the transactions.
         The date should be specified in MM-DD-YYYY format.
        :type period_start_date: str
        :param period_end_date: The end date to fetch the transactions. The
         date should be specified in MM-DD-YYYY format.
        :type period_end_date: str
        :param filter: May be used to filter by transaction type. The filter
    ...
    def list_by_billing_account(
        ...
        given start and end date. Transactions include purchases, refunds and
        Azure usage charges. Unbilled transactions are listed under pending
        invoice ID and do not include tax. Tax is added to the amount once an
        invoice is generated.
    ...
    def list_by_billing_profile(
        ...
        given start date and end date. Transactions include purchases, refunds
        and Azure usage charges. Unbilled transactions are listed under pending
        invoice Id and do not include tax. Tax is added to the amount once an
        invoice is generated.
    ...
    def list_by_invoice(
        ...
        return deserialized
    list_by_invoice.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/invoices/{invoiceName}/transactions'}
    ...
    def get(
        ...
        """Gets a transaction by ID. The operation is supported for billing
        ...
        :param billing_profile_name: The ID that uniquely identifies a billing
         profile.
        :type billing_profile_name: str
        :param transaction_name: The ID that uniquely identifies a
         transaction.
