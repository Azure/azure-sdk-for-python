...
class BillingPropertyOperations(object):
    ...
    def get(
        ...
        :return: BillingProperty or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.billing.models.BillingProperty or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('BillingProperty', response)
