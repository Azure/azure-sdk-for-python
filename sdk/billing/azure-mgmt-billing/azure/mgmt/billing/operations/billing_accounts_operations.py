...
class BillingAccountsOperations(object):
    ...
    def list(
        ...
        :return: An iterator like instance of BillingAccount
        :rtype:
         ~azure.mgmt.billing.models.BillingAccountPaged[~azure.mgmt.billing.models.BillingAccount]
        :raises:
        ...
        deserialized = models.BillingAccountPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.BillingAccountPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: BillingAccount or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.billing.models.BillingAccount or
    ...
    def update(
        ...
        :return: An instance of LROPoller that returns BillingAccount or
         ClientRawResponse<BillingAccount> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.billing.models.BillingAccount]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.billing.models.BillingAccount]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.billing.models.ErrorResponseException>`
        """
