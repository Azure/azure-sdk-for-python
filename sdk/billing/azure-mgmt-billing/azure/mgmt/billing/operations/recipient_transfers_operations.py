...
class RecipientTransfersOperations(object):
    ...
    def list(
        ...
        deserialized = models.RecipientTransferDetailsPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.RecipientTransferDetailsPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
