...
class InvoiceSectionsOperations:
    ...
    def validate_delete_eligibility(
    ...
    ) -> _models.DeleteInvoiceSectionEligibilityResult:
        ...
        :return: DeleteInvoiceSectionEligibilityResult or the result of cls(response)
        :rtype: ~azure.mgmt.billing.models.DeleteInvoiceSectionEligibilityResult
        ...
        cls: ClsType[_models.DeleteInvoiceSectionEligibilityResult] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("DeleteInvoiceSectionEligibilityResult", pipeline_response.http_response)
    ...
    def get(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.InvoiceSection] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("InvoiceSection", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        parameters: Union[_models.InvoiceSection, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.InvoiceSection]:
        ...
        :param invoice_section_name: The ID that uniquely identifies an invoice section. Required.
        :type invoice_section_name: str
        :param parameters: An invoice section. Required.
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param invoice_section_name: The ID that uniquely identifies an invoice section. Required.
        :type invoice_section_name: str
        :param parameters: An invoice section. Is either a InvoiceSection type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.billing.models.InvoiceSection or IO[bytes]
        :return: An instance of LROPoller that returns either InvoiceSection or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.billing.models.InvoiceSection]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.InvoiceSection].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.InvoiceSection](
    ...
    def list_by_billing_profile(
        ...
        search: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.InvoiceSection"]:
        ...
        :param billing_profile_name: The ID that uniquely identifies a billing profile. Required.
        :type billing_profile_name: str
        :param include_deleted: Can be used to get deleted invoice sections. Default value is False.
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.InvoiceSectionListResult] = kwargs.pop("cls", None)
