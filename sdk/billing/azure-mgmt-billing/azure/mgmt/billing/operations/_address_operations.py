...
class AddressOperations:
    ...
    @overload
    def validate(
        self, address: _models.AddressDetails, *, content_type: str = "application/json", **kwargs: Any
    ...
    @overload
    def validate(
        self, address: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.ValidateAddressResponse:
        """Validates an address. Use the operation to validate an address before using it as soldTo or a
        billTo address.
    ...
    def validate(self, address: Union[_models.AddressDetails, IO], **kwargs: Any) -> _models.ValidateAddressResponse:
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", "2020-05-01"))  # type: Literal["2020-05-01"]
        content_type = kwargs.pop("content_type", _headers.pop("Content-Type", None))  # type: Optional[str]
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.ValidateAddressResponse]
