...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/agreements/{agreementName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "billingAccountName": _SERIALIZER.url("billing_account_name", billing_account_name, 'str'),
...
class AgreementsOperations:
    ...
    def list_by_billing_account(
        ...
        expand: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable[_models.AgreementListResult]:
