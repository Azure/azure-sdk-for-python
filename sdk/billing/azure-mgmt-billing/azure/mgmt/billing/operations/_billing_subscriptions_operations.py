...
def build_get_by_billing_profile_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "billingSubscriptionName": _SERIALIZER.url("billing_subscription_name", billing_subscription_name, "str"),
    }
...
def build_list_by_customer_request(
    ...
    **kwargs: Any
    ...
    _url = kwargs.pop(
        "template_url",
        "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/customers/{customerName}/billingSubscriptions",
    )
    path_format_arguments = {
        "billingAccountName": _SERIALIZER.url("billing_account_name", billing_account_name, "str"),
        "billingProfileName": _SERIALIZER.url("billing_profile_name", billing_profile_name, "str"),
...
def build_cancel_request(billing_account_name: str, billing_subscription_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_merge_request(billing_account_name: str, billing_subscription_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_move_request(billing_account_name: str, billing_subscription_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_split_request(billing_account_name: str, billing_subscription_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_validate_move_eligibility_request(
    billing_account_name: str, billing_subscription_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_request(billing_account_name: str, billing_subscription_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_request(
    billing_account_name: str, billing_subscription_name: str, *, expand: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(billing_account_name: str, billing_subscription_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_by_billing_account_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions"
    )
    path_format_arguments = {
        "billingAccountName": _SERIALIZER.url("billing_account_name", billing_account_name, "str"),
    }
    ...
    if include_deleted is not None:
        _params["includeDeleted"] = _SERIALIZER.query("include_deleted", include_deleted, "bool")
    if include_tenant_subscriptions is not None:
        _params["includeTenantSubscriptions"] = _SERIALIZER.query(
            "include_tenant_subscriptions", include_tenant_subscriptions, "bool"
        )
    if include_failed is not None:
        _params["includeFailed"] = _SERIALIZER.query("include_failed", include_failed, "bool")
    _params["api-version"] = _SERIALIZER.query("api_version", api_version, "str")
    if expand is not None:
        _params["expand"] = _SERIALIZER.query("expand", expand, "str")
    if filter is not None:
...
def build_list_by_customer_at_billing_account_request(  # pylint: disable=name-too-long
    billing_account_name: str,
    customer_name: str,
    *,
    include_deleted: bool = False,
...
class BillingSubscriptionsOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_by_billing_profile(
        ...
        search: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.BillingSubscription"]:
    ...
    @distributed_trace
    def list_by_customer(  # pylint: disable=too-many-locals
        self,
        billing_account_name: str,
        billing_profile_name: str,
        customer_name: str,
    ...
    @distributed_trace
    def list_by_invoice_section(  # pylint: disable=too-many-locals
        self,
        billing_account_name: str,
        billing_profile_name: str,
        invoice_section_name: str,
    ...
    def begin_merge(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.BillingSubscription].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.BillingSubscription](
    ...
    @distributed_trace
    def begin_delete(self, billing_account_name: str, billing_subscription_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def list_by_billing_account(  # pylint: disable=too-many-locals
        self,
        billing_account_name: str,
        include_deleted: bool = False,
        include_tenant_subscriptions: bool = False,
