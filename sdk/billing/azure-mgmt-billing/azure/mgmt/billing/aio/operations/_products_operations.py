...
class ProductsOperations:
    ...
    def list_by_billing_account(
        self, billing_account_name: str, filter: Optional[str] = None, **kwargs: Any
    ) -> AsyncIterable["_models.Product"]:
    ...
    def list_by_billing_profile(
        self, billing_account_name: str, billing_profile_name: str, filter: Optional[str] = None, **kwargs: Any
    ) -> AsyncIterable["_models.Product"]:
    ...
    @distributed_trace_async
    async def update(
        self, billing_account_name: str, product_name: str, parameters: Union[_models.Product, IO], **kwargs: Any
    ) -> _models.Product:
        """Updates the properties of a Product. Currently, auto renew can be updated. The operation is
        supported only for billing accounts with agreement type Microsoft Customer Agreement.
        ...
        :param product_name: The ID that uniquely identifies a product. Required.
        :type product_name: str
        :param parameters: Request parameters that are provided to the update product operation. Is
         either a model type or a IO type. Required.
        :type parameters: ~azure.mgmt.billing.models.Product or IO
    ...
    async def move(
        ...
        billing_account_name: str,
        product_name: str,
        parameters: Union[_models.TransferProductRequestProperties, IO],
        **kwargs: Any
    ) -> Optional[_models.Product]:
        """Moves a product's charges to a new invoice section. The new invoice section must belong to the
        same billing profile as the existing invoice section. This operation is supported only for
        ...
        :param product_name: The ID that uniquely identifies a product. Required.
        :type product_name: str
        :param parameters: Request parameters that are provided to the move product operation. Is
         either a model type or a IO type. Required.
        :type parameters: ~azure.mgmt.billing.models.TransferProductRequestProperties or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
