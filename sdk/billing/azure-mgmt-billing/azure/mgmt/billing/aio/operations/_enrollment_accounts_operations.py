...
from ...operations._enrollment_accounts_operations import build_get_request, build_list_request
...
class EnrollmentAccountsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.EnrollmentAccountSummary"]:
        ...
        :return: An iterator like instance of either EnrollmentAccountSummary or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.billing.models.EnrollmentAccountSummary]
    ...
    async def get(self, name: str, **kwargs: Any) -> _models.EnrollmentAccountSummary:
