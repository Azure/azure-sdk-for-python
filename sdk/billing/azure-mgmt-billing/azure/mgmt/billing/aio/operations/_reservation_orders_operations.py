...
from ...operations._reservation_orders_operations import (
...
class ReservationOrdersOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`reservation_orders` attribute.
    """
    ...
    async def get_by_billing_account(
        self, billing_account_name: str, reservation_order_id: str, expand: Optional[str] = None, **kwargs: Any
    ) -> _models.ReservationOrder:
        ...
        :param expand: May be used to expand the detail information of some properties. Default value
         is None.
        :type expand: str
        :return: ReservationOrder or the result of cls(response)
        :rtype: ~azure.mgmt.billing.models.ReservationOrder
        ...
        cls: ClsType[_models.ReservationOrder] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("ReservationOrder", pipeline_response.http_response)
    ...
    def list_by_billing_account(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.ReservationOrder"]:
        ...
        :return: An iterator like instance of either ReservationOrder or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.billing.models.ReservationOrder]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
