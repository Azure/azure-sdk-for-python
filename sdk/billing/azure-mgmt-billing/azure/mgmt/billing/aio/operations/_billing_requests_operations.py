...
from ...operations._billing_requests_operations import (
...
class BillingRequestsOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`billing_requests` attribute.
    """
    ...
    def list_by_billing_profile(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.BillingRequest"]:
        ...
        :param search: The search query option allows clients to request items within a collection
         ...
         value is None.
        :type search: str
        :return: An iterator like instance of either BillingRequest or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.billing.models.BillingRequest]
        ...
        cls: ClsType[_models.BillingRequestListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("BillingRequestListResult", pipeline_response)
    ...
    async def get(self, billing_request_name: str, **kwargs: Any) -> _models.BillingRequest:
        """Gets a billing request by its ID.

        .. seealso::
           - https://docs.microsoft.com/en-us/rest/api/billing/

        :param billing_request_name: The ID that uniquely identifies a billing request. Required.
        :type billing_request_name: str
        :return: BillingRequest or the result of cls(response)
        :rtype: ~azure.mgmt.billing.models.BillingRequest
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.BillingRequest] = kwargs.pop("cls", None)

        _request = build_get_request(
            billing_request_name=billing_request_name,
            api_version=api_version,
            headers=_headers,
            params=_params,
        )
        ...
        deserialized = self._deserialize("BillingRequest", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        self, billing_request_name: str, parameters: Union[_models.BillingRequest, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "BillingRequest")
    ...
    async def begin_create_or_update(
        ...
        parameters: _models.BillingRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.BillingRequest]:
        ...
        :param billing_request_name: The ID that uniquely identifies a billing request. Required.
        :type billing_request_name: str
        :param parameters: A request submitted by a user to manage billing. Users with an owner role on
         the scope can approve or decline these requests. Required.
        :type parameters: ~azure.mgmt.billing.models.BillingRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either BillingRequest or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.billing.models.BillingRequest]
        :raises ~azure.core.exceptions.HttpResponseError:
        """

    @overload
    async def begin_create_or_update(
        self, billing_request_name: str, parameters: IO[bytes], *, content_type: str = "application/json", **kwargs: Any
    ) -> AsyncLROPoller[_models.BillingRequest]:
        """Create or update a billing request.
    ...
    async def begin_create_or_update(
        ...
        :type billing_request_name: str
        :param parameters: A request submitted by a user to manage billing. Users with an owner role on
         the scope can approve or decline these requests. Is either a BillingRequest type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.billing.models.BillingRequest or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either BillingRequest or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.billing.models.BillingRequest]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return AsyncLROPoller[_models.BillingRequest].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.BillingRequest](
