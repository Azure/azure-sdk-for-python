...
from ...operations._reservations_operations import build_list_by_billing_account_request, build_list_by_billing_profile_request
T = TypeVar('T')
    ...
    def list_by_billing_account(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ReservationsListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.billing.models.ReservationsListResult]
