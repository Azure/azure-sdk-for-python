...
from ...operations._billing_subscriptions_operations import build_get_request, build_list_by_billing_account_request, build_list_by_billing_profile_request, build_list_by_customer_request, build_list_by_invoice_section_request, build_move_request_initial, build_update_request, build_validate_move_request
T = TypeVar('T')
    ...
    def list_by_customer(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either BillingSubscriptionsListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.billing.models.BillingSubscriptionsListResult]
