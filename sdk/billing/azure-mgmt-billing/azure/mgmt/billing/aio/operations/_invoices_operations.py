...
from ...operations._invoices_operations import (
    ...
    build_download_by_billing_subscription_request,
    build_download_documents_by_billing_account_request,
    build_download_documents_by_billing_subscription_request,
    build_download_summary_by_billing_account_request,
    build_get_by_billing_account_request,
    build_get_by_billing_subscription_request,
    build_get_request,
...
class InvoicesOperations:
    ...
    def list_by_billing_profile(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.Invoice"]:
    ...
    async def _download_documents_by_billing_account_initial(  # pylint: disable=name-too-long
        self,
        billing_account_name: str,
    ...
    @overload
    async def begin_download_documents_by_billing_account(  # pylint: disable=name-too-long
        self,
        billing_account_name: str,
    ...
    async def begin_download_documents_by_billing_account(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._download_documents_by_billing_account_initial(
                billing_account_name=billing_account_name,
    ...
    async def _amend_initial(self, billing_account_name: str, invoice_name: str, **kwargs: Any) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace_async
    async def begin_amend(self, billing_account_name: str, invoice_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._amend_initial(
                billing_account_name=billing_account_name,
                invoice_name=invoice_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
    ...
    async def _download_summary_by_billing_account_initial(  # pylint: disable=name-too-long
    ...
    @distributed_trace_async
    async def begin_download_summary_by_billing_account(  # pylint: disable=name-too-long
        self, billing_account_name: str, invoice_name: str, **kwargs: Any
    ) -> AsyncLROPoller[_models.DocumentDownloadResult]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._download_summary_by_billing_account_initial(
                billing_account_name=billing_account_name,
                invoice_name=invoice_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
    ...
    async def _download_documents_by_billing_subscription_initial(  # pylint: disable=name-too-long
    ...
    @overload
    async def begin_download_documents_by_billing_subscription(  # pylint: disable=name-too-long
        self,
        parameters: List[_models.DocumentDownloadRequest],
        *,
        content_type: str = "application/json",
    ...
    async def begin_download_documents_by_billing_subscription(  # pylint: disable=name-too-long
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._download_documents_by_billing_subscription_initial(
                parameters=parameters,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x, y, z: x,
    ...
    async def _download_by_billing_subscription_initial(  # pylint: disable=name-too-long
    ...
    async def begin_download_by_billing_subscription(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._download_by_billing_subscription_initial(
                invoice_name=invoice_name,
                document_name=document_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
    ...
    @distributed_trace_async
    async def get_by_billing_subscription(self, invoice_name: str, **kwargs: Any) -> _models.Invoice:
    ...
    @distributed_trace_async
    async def get(self, invoice_name: str, **kwargs: Any) -> _models.Invoice:
