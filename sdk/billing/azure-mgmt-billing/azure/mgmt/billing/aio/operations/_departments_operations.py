...
from ...operations._departments_operations import build_get_request, build_list_by_billing_account_request
...
class DepartmentsOperations:
    ...
    async def get(self, billing_account_name: str, department_name: str, **kwargs: Any) -> _models.Department:
        ...
        :return: Department or the result of cls(response)
        :rtype: ~azure.mgmt.billing.models.Department
        ...
        cls: ClsType[_models.Department] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("Department", pipeline_response.http_response)
    ...
    def list_by_billing_account(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.Department"]:
        ...
        :param search: The search query option allows clients to request items within a collection
         ...
         value is None.
        :type search: str
        :return: An iterator like instance of either Department or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.billing.models.Department]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.DepartmentListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("DepartmentListResult", pipeline_response)
