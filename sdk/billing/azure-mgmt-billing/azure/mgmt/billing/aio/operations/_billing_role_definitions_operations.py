...
from ...operations._billing_role_definitions_operations import build_get_by_billing_account_request, build_get_by_billing_profile_request, build_get_by_invoice_section_request, build_list_by_billing_account_request, build_list_by_billing_profile_request, build_list_by_invoice_section_request
T = TypeVar('T')
    ...
    def list_by_billing_account(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either BillingRoleDefinitionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.billing.models.BillingRoleDefinitionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
