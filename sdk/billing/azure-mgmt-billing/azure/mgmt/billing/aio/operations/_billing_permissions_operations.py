...
from ...operations._billing_permissions_operations import (
    build_check_access_by_billing_account_request,
    build_check_access_by_billing_profile_request,
    build_check_access_by_customer_request,
    build_check_access_by_department_request,
    build_check_access_by_enrollment_account_request,
    build_check_access_by_invoice_section_request,
...
class BillingPermissionsOperations:
    ...
    def list_by_billing_account(
    ...
    ) -> AsyncItemPaged["_models.BillingPermission"]:
        ...
        :return: An iterator like instance of either BillingPermission or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.billing.models.BillingPermission]
        ...
        cls: ClsType[_models.BillingPermissionListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("BillingPermissionListResult", pipeline_response)
    ...
    async def check_access_by_billing_profile(
        ...
        parameters: _models.CheckAccessRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> List[_models.CheckAccessResponse]:
        ...
        :param parameters: The request object against which access of the caller will be checked.
         Required.
        :type parameters: ~azure.mgmt.billing.models.CheckAccessRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: list of CheckAccessResponse or the result of cls(response)
    ...
    async def check_access_by_billing_profile(
        ...
        billing_account_name: str,
        billing_profile_name: str,
        parameters: Union[_models.CheckAccessRequest, IO[bytes]],
        **kwargs: Any
    ) -> List[_models.CheckAccessResponse]:
        """Provides a list of check access response objects for a billing profile.
        ...
        :param billing_profile_name: The ID that uniquely identifies a billing profile. Required.
        :type billing_profile_name: str
        :param parameters: The request object against which access of the caller will be checked. Is
         either a CheckAccessRequest type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.billing.models.CheckAccessRequest or IO[bytes]
        :return: list of CheckAccessResponse or the result of cls(response)
        :rtype: list[~azure.mgmt.billing.models.CheckAccessResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        cls: ClsType[List[_models.CheckAccessResponse]] = kwargs.pop("cls", None)
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "CheckAccessRequest")

        _request = build_check_access_by_billing_profile_request(
            billing_account_name=billing_account_name,
            billing_profile_name=billing_profile_name,
            api_version=api_version,
        ...
        deserialized = self._deserialize("[CheckAccessResponse]", pipeline_response.http_response)
    ...
    async def check_access_by_customer(
        ...
        **kwargs: Any
        ...
        _request = build_check_access_by_customer_request(
            billing_account_name=billing_account_name,
            billing_profile_name=billing_profile_name,
            customer_name=customer_name,
            api_version=api_version,
    ...
    async def check_access_by_invoice_section(
        ...
        **kwargs: Any
        ...
        _request = build_check_access_by_invoice_section_request(
            billing_account_name=billing_account_name,
            billing_profile_name=billing_profile_name,
            invoice_section_name=invoice_section_name,
            api_version=api_version,
    ...
    @distributed_trace_async
    async def check_access_by_billing_account(
        self, billing_account_name: str, parameters: Union[_models.CheckAccessRequest, IO[bytes]], **kwargs: Any
    ) -> List[_models.CheckAccessResponse]:
        """Provides a list of check access response objects for a billing account.
        ...
        _request = build_check_access_by_billing_account_request(
            billing_account_name=billing_account_name,
            api_version=api_version,
            content_type=content_type,
            json=_json,
    ...
    async def check_access_by_department(
        ...
        **kwargs: Any
        ...
        _request = build_check_access_by_department_request(
            billing_account_name=billing_account_name,
            department_name=department_name,
            api_version=api_version,
            content_type=content_type,
    ...
    async def check_access_by_enrollment_account(
        ...
        **kwargs: Any
        ...
        _request = build_check_access_by_enrollment_account_request(
            billing_account_name=billing_account_name,
            enrollment_account_name=enrollment_account_name,
            api_version=api_version,
            content_type=content_type,
