...
from ...operations._billing_permissions_operations import (
    ...
    build_list_by_invoice_sections_request,
)
...
class BillingPermissionsOperations:
    ...
    def list_by_customer(
    ...
    ) -> AsyncIterable["_models.BillingPermissionsProperties"]:
        ...
        :return: An iterator like instance of either BillingPermissionsProperties or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.billing.models.BillingPermissionsProperties]
