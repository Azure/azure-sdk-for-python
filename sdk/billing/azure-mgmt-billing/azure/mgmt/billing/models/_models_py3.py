...
class BillingRoleAssignment(Resource):
    ...
    :ivar principal_id: The principal id of the user to whom the role was
     assigned.
    :vartype principal_id: str
    :ivar role_definition_name: The ID of the role definition.
...
class DetailedTransferStatus(Model):
    ...
    :ivar product_type: Type of product that is transferred. Possible values
...
class Document(Model):
    ...
    :vartype url: str
    :ivar document_numbers: Document numbers for an Enterprise Agreement
     invoice.
...
class InitiateTransferRequest(Model):
    ...
    :param reseller_id: Optional MPN ID of the reseller for transfer requests
...
class Invoice(Resource):
    ...
    :ivar subscription_id: The ID of the subscription for which the invoice is
     generated.
    :vartype subscription_id: str
    :param rebill_document_type: The type of the document generated when an
     Enterprise Agreement invoice is rebilled. Possible values include:
     'Credit', 'Rebill', 'Original'
    :type rebill_document_type: str or
     ~azure.mgmt.billing.models.RebillDocumentType
    :ivar rebilled_invoice_id: The ID of the invoice generated when an
     Enterprise Agreement invoice is rebilled.
    :vartype rebilled_invoice_id: str
    :ivar latest_invoice_id: The ID of the latest invoice generated when an
     Enterprise Agreement invoice is rebilled.
    :vartype latest_invoice_id: str
    """
    ...
    _validation = {
        ...
        'subscription_id': {'readonly': True},
        'rebilled_invoice_id': {'readonly': True},
        'latest_invoice_id': {'readonly': True},
    }
    ...
    _attribute_map = {
        ...
        'subscription_id': {'key': 'properties.subscriptionId', 'type': 'str'},
        'rebill_document_type': {'key': 'properties.rebillDetails.rebillDocumentType', 'type': 'str'},
        'rebilled_invoice_id': {'key': 'properties.rebillDetails.rebilledInvoiceId', 'type': 'str'},
        'latest_invoice_id': {'key': 'properties.rebillDetails.latestInvoiceId', 'type': 'str'},
    }

    def __init__(self, *, rebill_document_type=None, **kwargs) -> None:
        ...
        self.payments = None
        self.subscription_id = None
        self.rebill_document_type = rebill_document_type
        self.rebilled_invoice_id = None
...
class PaymentMethod(Resource):
    ...
    :ivar type: Resource type.
    :vartype type: str
    :param payment_method_type: The type of payment method. Possible values
    ...
    def __init__(self, *, payment_method_type=None, **kwargs) -> None:
...
class ProductDetails(Model):
    ...
    :param product_type: Type of the product that is transferred. Possible
     values include: 'AzureSubscription', 'AzureReservation'
    :type product_type: str or ~azure.mgmt.billing.models.ProductType
    :param product_id: The ID of the product that is transferred.
    :type product_id: str
    """
...
class RecipientTransferDetails(Model):
    ...
    :ivar creation_time: The time at which the transfer request was created.
    ...
    :ivar recipient_email_id: The email ID of the user to whom the transfer
     request was sent.
    :vartype recipient_email_id: str
    :ivar initiator_email_id: The email ID of the user who sent the transfer
     request.
    :vartype initiator_email_id: str
    :ivar reseller_id: Optional MPN ID of the reseller for transfer requests
     that are sent from a Microsoft Partner Agreement billing account.
    :vartype reseller_id: str
    :ivar reseller_name: Optional name of the reseller for transfer requests
     that are sent from Microsoft Partner Agreement billing account.
    :vartype reseller_name: str
    :ivar initiator_customer_type: The type of customer who sent the transfer
     request.
    :vartype initiator_customer_type: str
    :ivar canceled_by: The email ID of the user who canceled the transfer
     request.
    :vartype canceled_by: str
    :ivar last_modified_time: The time at which the transfer request was last
     modified.
...
class TransferDetails(Model):
    ...
    :vartype expiration_time: datetime
    :ivar invoice_section_id: The ID of the invoice section to which the
     product is billed after the transfer request is completed.
    :vartype invoice_section_id: str
    :ivar billing_account_id: The ID of the billing account to which the
     product is billed after the transfer request is completed.
    :vartype billing_account_id: str
    ...
    :vartype initiator_customer_type: str
    :ivar billing_profile_id: The ID of the billing profile to which the
     product will be billed after the transfer.
    :vartype billing_profile_id: str
    :ivar transfer_status: Overall transfer status. Possible values include:
     'Pending', 'InProgress', 'Completed', 'CompletedWithErrors', 'Failed',
     'Canceled', 'Declined'
...
class UpdateAutoRenewOperation(Model):
    ...
    :param end_date: The date at which the product will be canceled.
    :type end_date: datetime
    """
...
class UpdateAutoRenewRequest(Model):
    ...
    :param auto_renew: The flag that determines the auto-renew settings for a
...
class ValidateSubscriptionTransferEligibilityResult(Model):
    ...
    :ivar is_transfer_eligible: Specifies whether the subscription is eligible
     to be transferred.
    :vartype is_transfer_eligible: bool
    :param error_details: Validation error details.
    :type error_details:
