...
class AddressDetails(Model):
    ...
    def __init__(self, *, address_line1: str, country: str, first_name: str=None, last_name: str=None, company_name: str=None, address_line2: str=None, address_line3: str=None, city: str=None, district: str=None, region: str=None, postal_code: str=None, email: str=None, phone_number: str=None, **kwargs) -> None:
...
class BillingAccount(Resource):
    ...
    def __init__(self, *, display_name: str=None, sold_to=None, billing_profiles=None, departments=None, enrollment_accounts=None, **kwargs) -> None:
...
class BillingRoleAssignment(Resource):
    ...
    :ivar principal_tenant_id: The principal tenant id of the user to whom the
     role was assigned.
    ...
    _validation = {
        ...
        'principal_tenant_id': {'readonly': True},
        'role_definition_id': {'readonly': True},
        'scope': {'readonly': True},
        'user_authentication_type': {'readonly': True},
        'user_email_address': {'readonly': True},
    }
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.principal_tenant_id = None
        self.role_definition_id = None
        self.scope = None
        self.user_authentication_type = None
