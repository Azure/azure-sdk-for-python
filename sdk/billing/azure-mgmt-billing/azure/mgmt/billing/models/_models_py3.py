...
class Agreement(Resource):
    ...
    :ivar category: Category of the agreement signed by customer. Possible
     values include: 'MicrosoftCustomerAgreement', 'AffiliatePurchaseTerms',
     'Other'
...
class Invoice(Resource):
    ...
    :ivar billing_profile_display_name: The billing profile display name this
     invoice belongs to.
    :vartype billing_profile_display_name: str
    :ivar purchase_order_number: An optional purchase order number used for
     the invoice.
