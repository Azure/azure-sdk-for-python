...
class AllowedPrincipals(ProxyOnlyResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AllowedPrincipals, self).__init__(kind=kind, **kwargs)
        self.groups = groups
...
class DetectorDefinitionResource(ProxyOnlyResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(DetectorDefinitionResource, self).__init__(kind=kind, **kwargs)
        self.display_name = None
        self.description = None
        self.rank = None
        self.is_enabled = None
...
class DiagnosticDetectorCollection(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: List["DetectorDefinitionResource"],
        **kwargs
    ):
...
class VnetInfoResource(ProxyOnlyResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(VnetInfoResource, self).__init__(kind=kind, **kwargs)
        self.vnet_resource_id = vnet_resource_id
        self.cert_thumbprint = None
        self.cert_blob = cert_blob
        self.routes = None
