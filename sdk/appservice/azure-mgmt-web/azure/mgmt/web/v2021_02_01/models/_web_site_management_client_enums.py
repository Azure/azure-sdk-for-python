...
class FrontEndServiceType(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class KubeEnvironmentProvisioningState(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
