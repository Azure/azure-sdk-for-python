...
class ProviderOperations:
    ...
    def get_available_stacks(
        ...
        **kwargs: Any
        ...
        :type os_type_selected: str or ~azure.mgmt.web.v2021_02_01.models.Enum10
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ApplicationStackCollection or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2021_02_01.models.ApplicationStackCollection]
    ...
    def get_function_app_stacks(
        ...
        **kwargs: Any
        ...
        :type stack_os_type: str or ~azure.mgmt.web.v2021_02_01.models.Enum11
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either FunctionAppStackCollection or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2021_02_01.models.FunctionAppStackCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.get_function_app_stacks.metadata['url']  # type: ignore
                # Construct parameters
                query_parameters = {}  # type: Dict[str, Any]
                if stack_os_type is not None:
                    query_parameters['stackOsType'] = self._serialize.query("stack_os_type", stack_os_type, 'str')
                query_parameters['api-version'] = self._serialize.query("api_version", api_version, 'str')
    ...
    def get_function_app_stacks_for_location(
        ...
        **kwargs: Any
        ...
        :type location: str
        :param stack_os_type: Stack OS Type.
        :type stack_os_type: str or ~azure.mgmt.web.v2021_02_01.models.Enum12
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either FunctionAppStackCollection or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2021_02_01.models.FunctionAppStackCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.get_function_app_stacks_for_location.metadata['url']  # type: ignore
    ...
    def get_web_app_stacks_for_location(
        ...
        **kwargs: Any
        ...
        :type location: str
        :param stack_os_type: Stack OS Type.
        :type stack_os_type: str or ~azure.mgmt.web.v2021_02_01.models.Enum13
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either WebAppStackCollection or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2021_02_01.models.WebAppStackCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.get_web_app_stacks_for_location.metadata['url']  # type: ignore
                path_format_arguments = {
                    'location': self._serialize.url("location", location, 'str'),
                }
                url = self._client.format_url(url, **path_format_arguments)
    ...
    def list_operations(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2021_02_01.models.CsmOperationCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_web_app_stacks(
        ...
        **kwargs: Any
        ...
        :param stack_os_type: Stack OS Type.
        :type stack_os_type: str or ~azure.mgmt.web.v2021_02_01.models.Enum14
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either WebAppStackCollection or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2021_02_01.models.WebAppStackCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.get_web_app_stacks.metadata['url']  # type: ignore
                # Construct parameters
                query_parameters = {}  # type: Dict[str, Any]
                if stack_os_type is not None:
                    query_parameters['stackOsType'] = self._serialize.query("stack_os_type", stack_os_type, 'str')
    ...
    def get_available_stacks_on_prem(
        ...
        **kwargs: Any
        ...
        :param os_type_selected:
        :type os_type_selected: str or ~azure.mgmt.web.v2021_02_01.models.Enum15
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ApplicationStackCollection or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2021_02_01.models.ApplicationStackCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
