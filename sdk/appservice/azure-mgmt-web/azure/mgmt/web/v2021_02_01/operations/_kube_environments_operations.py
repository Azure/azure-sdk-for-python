...
class KubeEnvironmentsOperations(object):
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.KubeEnvironmentCollection"]
        """Get all Kubernetes Environments for a subscription.

        Description for Get all Kubernetes Environments for a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either KubeEnvironmentCollection or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2021_02_01.models.KubeEnvironmentCollection]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.web.v2021_02_01.models.KubeEnvironment
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        name,  # type: str
        kube_environment_envelope,  # type: "_models.KubeEnvironment"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.KubeEnvironment"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.KubeEnvironment"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.KubeEnvironment"]
        ...
        :type kube_environment_envelope: ~azure.mgmt.web.v2021_02_01.models.KubeEnvironment
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either KubeEnvironment or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.v2021_02_01.models.KubeEnvironment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        resource_group_name,  # type: str
        name,  # type: str
        kube_environment_envelope,  # type: "_models.KubeEnvironmentPatchResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.KubeEnvironment"
        """Creates or updates a Kubernetes Environment.
        ...
        :type name: str
        :param kube_environment_envelope: Configuration details of the Kubernetes Environment.
        :type kube_environment_envelope: ~azure.mgmt.web.v2021_02_01.models.KubeEnvironmentPatchResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: KubeEnvironment, or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_02_01.models.KubeEnvironment
        :raises: ~azure.core.exceptions.HttpResponseError
