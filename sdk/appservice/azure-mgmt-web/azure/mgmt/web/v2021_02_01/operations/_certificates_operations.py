...
class CertificatesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.CertificateCollection"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2021_02_01.models.CertificateCollection]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.web.v2021_02_01.models.Certificate
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def create_or_update(
        ...
        resource_group_name,  # type: str
        name,  # type: str
        certificate_envelope,  # type: "_models.Certificate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Certificate"
        ...
        :type certificate_envelope: ~azure.mgmt.web.v2021_02_01.models.Certificate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Certificate, or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_02_01.models.Certificate
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def update(
        ...
        resource_group_name,  # type: str
        name,  # type: str
        certificate_envelope,  # type: "_models.CertificatePatchResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Certificate"
        """Create or update a certificate.
        ...
        :type name: str
        :param certificate_envelope: Details of certificate, if it exists already.
        :type certificate_envelope: ~azure.mgmt.web.v2021_02_01.models.CertificatePatchResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Certificate, or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_02_01.models.Certificate
        :raises: ~azure.core.exceptions.HttpResponseError
