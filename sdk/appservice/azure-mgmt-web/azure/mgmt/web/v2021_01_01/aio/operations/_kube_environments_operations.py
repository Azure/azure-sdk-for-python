...
class KubeEnvironmentsOperations:
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2021_01_01.models.KubeEnvironmentCollection]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either KubeEnvironment or the result of cls(response)
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type name: str
        :param kube_environment_envelope: Configuration details of the Kubernetes Environment.
        :type kube_environment_envelope: ~azure.mgmt.web.v2021_01_01.models.KubeEnvironmentPatchResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: KubeEnvironment, or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_01_01.models.KubeEnvironment
        :raises: ~azure.core.exceptions.HttpResponseError
