...
class ProviderOperations(object):
    ...
    def get_available_stacks(
        ...
        :param os_type_selected: Possible values include: 'Windows', 'Linux',
         'WindowsFunctions', 'LinuxFunctions', 'All'
        ...
        :rtype:
         ~azure.mgmt.web.v2021_01_01.models.ApplicationStackResourcePaged[~azure.mgmt.web.v2021_01_01.models.ApplicationStackResource]
        :raises:
    ...
    def get_function_app_stacks(
            self, stack_os_type=None, custom_headers=None, raw=False, **operation_config):
        """Get available Function app frameworks and their versions.

        Description for Get available Function app frameworks and their
        versions.

        :param stack_os_type: Stack OS Type. Possible values include:
         'Windows', 'Linux', 'All'
        :type stack_os_type: str
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype:
         ~azure.mgmt.web.v2021_01_01.models.FunctionAppStackPaged[~azure.mgmt.web.v2021_01_01.models.FunctionAppStack]
        :raises:
         :class:`DefaultErrorResponseException<azure.mgmt.web.v2021_01_01.models.DefaultErrorResponseException>`
        """
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.get_function_app_stacks.metadata['url']
        ...
        if raw:
            header_dict = {}
        deserialized = models.FunctionAppStackPaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    get_function_app_stacks.metadata = {'url': '/providers/Microsoft.Web/functionAppStacks'}

    def get_function_app_stacks_for_location(
            self, location, stack_os_type=None, custom_headers=None, raw=False, **operation_config):
        ...
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.get_function_app_stacks_for_location.metadata['url']
        ...
        return deserialized
    get_function_app_stacks_for_location.metadata = {'url': '/providers/Microsoft.Web/locations/{location}/functionAppStacks'}
    ...
    def get_web_app_stacks_for_location(
        ...
        :rtype:
         ~azure.mgmt.web.v2021_01_01.models.WebAppStackPaged[~azure.mgmt.web.v2021_01_01.models.WebAppStack]
        :raises:
         :class:`DefaultErrorResponseException<azure.mgmt.web.v2021_01_01.models.DefaultErrorResponseException>`
        """
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.get_web_app_stacks_for_location.metadata['url']
                path_format_arguments = {
                    'location': self._serialize.url("location", location, 'str')
                }
                url = self._client.format_url(url, **path_format_arguments)
        ...
        if raw:
            header_dict = {}
        deserialized = models.WebAppStackPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_operations(
        ...
        :rtype:
         ~azure.mgmt.web.v2021_01_01.models.CsmOperationDescriptionPaged[~azure.mgmt.web.v2021_01_01.models.CsmOperationDescription]
        :raises:
         :class:`DefaultErrorResponseException<azure.mgmt.web.v2021_01_01.models.DefaultErrorResponseException>`
        """
        def prepare_request(next_link=None):
    ...
    def get_web_app_stacks(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.get_web_app_stacks.metadata['url']
