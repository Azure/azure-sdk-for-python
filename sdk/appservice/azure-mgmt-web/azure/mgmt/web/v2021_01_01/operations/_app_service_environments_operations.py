...
class AppServiceEnvironmentsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.AppServiceEnvironmentCollection"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2021_01_01.models.AppServiceEnvironmentCollection]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.AppServiceEnvironmentResource"
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        name,  # type: str
        hosting_environment_envelope,  # type: "_models.AppServiceEnvironmentResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.AppServiceEnvironmentResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.AppServiceEnvironmentResource"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.AppServiceEnvironmentResource"]
        ...
        :type hosting_environment_envelope: ~azure.mgmt.web.v2021_01_01.models.AppServiceEnvironmentResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either AppServiceEnvironmentResource or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.v2021_01_01.models.AppServiceEnvironmentResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        resource_group_name,  # type: str
        name,  # type: str
        hosting_environment_envelope,  # type: "_models.AppServiceEnvironmentPatchResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.AppServiceEnvironmentResource"
        """Create or update an App Service Environment.
        ...
        :type name: str
        :param hosting_environment_envelope: Configuration details of the App Service Environment.
        :type hosting_environment_envelope: ~azure.mgmt.web.v2021_01_01.models.AppServiceEnvironmentPatchResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AppServiceEnvironmentResource, or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_01_01.models.AppServiceEnvironmentResource
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_capacities(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.StampCapacityCollection"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2021_01_01.models.StampCapacityCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _change_vnet_initial(
        ...
        resource_group_name,  # type: str
        name,  # type: str
        vnet_info,  # type: "_models.VirtualNetworkProfile"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.WebAppCollection"
    ...
    def begin_change_vnet(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller[ItemPaged["_models.WebAppCollection"]]
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns an iterator like instance of either WebAppCollection or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.core.paging.ItemPaged[~azure.mgmt.web.v2021_01_01.models.WebAppCollection]]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.WebAppCollection"]
        error_map = {
    ...
    def get_ase_v3_networking_configuration(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.AseV3NetworkingConfiguration"
        ...
        # Construct URL
        url = self.get_ase_v3_networking_configuration.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+[^\.]$'),
            'name': self._serialize.url("name", name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
    ...
    def update_ase_networking_configuration(
        ...
        resource_group_name,  # type: str
        name,  # type: str
        ase_networking_configuration,  # type: "_models.AseV3NetworkingConfiguration"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.AseV3NetworkingConfiguration"
        ...
        :type ase_networking_configuration: ~azure.mgmt.web.v2021_01_01.models.AseV3NetworkingConfiguration
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AseV3NetworkingConfiguration, or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_01_01.models.AseV3NetworkingConfiguration
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        # Construct URL
        url = self.update_ase_networking_configuration.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+[^\.]$'),
            'name': self._serialize.url("name", name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
    ...
    def list_diagnostics(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> List["_models.HostingEnvironmentDiagnostics"]
    ...
    def get_diagnostics_item(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.HostingEnvironmentDiagnostics"
    ...
    def get_inbound_network_dependencies_endpoints(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.InboundEnvironmentEndpointCollection"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2021_01_01.models.InboundEnvironmentEndpointCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_multi_role_pools(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.WorkerPoolCollection"]
    ...
    def get_multi_role_pool(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.WorkerPoolResource"
    ...
    def _create_or_update_multi_role_pool_initial(
        ...
        resource_group_name,  # type: str
        name,  # type: str
        multi_role_pool_envelope,  # type: "_models.WorkerPoolResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.WorkerPoolResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.WorkerPoolResource"]
    ...
    def begin_create_or_update_multi_role_pool(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.WorkerPoolResource"]
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns either WorkerPoolResource or the result of cls(response)
    ...
    def list_multi_role_pool_instance_metric_definitions(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2021_01_01.models.ResourceMetricDefinitionCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_multi_role_pool_skus(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.SkuInfoCollection"]
    ...
    def list_multi_role_usages(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.UsageCollection"]
    ...
    def get_outbound_network_dependencies_endpoints(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2021_01_01.models.OutboundEnvironmentEndpointCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_private_endpoint_connection_list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2021_01_01.models.PrivateEndpointConnectionCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_approve_or_reject_private_endpoint_connection(
        ...
        **kwargs  # type: Any
        ...
        :type private_endpoint_wrapper: ~azure.mgmt.web.v2021_01_01.models.PrivateLinkConnectionApprovalRequestResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.v2021_01_01.models.RemotePrivateEndpointConnectionARMResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.RemotePrivateEndpointConnectionARMResource"]
    ...
    def list_app_service_plans(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2021_01_01.models.AppServicePlanCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_usages(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2021_01_01.models.CsmUsageQuotaCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _create_or_update_worker_pool_initial(
        ...
        name,  # type: str
        worker_pool_name,  # type: str
        worker_pool_envelope,  # type: "_models.WorkerPoolResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.WorkerPoolResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.WorkerPoolResource"]
