...
class DomainsOperations:
    ...
    async def check_availability(
        ...
        :param identifier: Name of the domain. Is either a NameIdentifier type or a IO[bytes] type.
         Required.
        :type identifier: ~azure.mgmt.web.v2020_06_01.models.NameIdentifier or IO[bytes]
        :return: DomainAvailabilityCheckResult or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2020_06_01.models.DomainAvailabilityCheckResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.Domain"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2020_06_01.models.Domain]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_recommendations(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2020_06_01.models.NameIdentifier]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_recommendations(
        ...
        :type parameters: ~azure.mgmt.web.v2020_06_01.models.DomainRecommendationSearchParameters or
         IO[bytes]
        :return: An iterator like instance of either NameIdentifier or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2020_06_01.models.NameIdentifier]
    ...
    async def begin_create_or_update(
        ...
        :param domain: Domain registration information. Is either a Domain type or a IO[bytes] type.
         Required.
        :type domain: ~azure.mgmt.web.v2020_06_01.models.Domain or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Domain or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.web.v2020_06_01.models.Domain]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type domain: ~azure.mgmt.web.v2020_06_01.models.DomainPatchResource or IO[bytes]
        :return: Domain or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2020_06_01.models.Domain
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_ownership_identifiers(
        ...
        :return: An iterator like instance of either DomainOwnershipIdentifier or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2020_06_01.models.DomainOwnershipIdentifier]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
