...
class WebSiteManagementClientOperationsMixin(WebSiteManagementClientMixinABC):
    ...
    async def update_publishing_user(self, user_details: Union[_models.User, IO], **kwargs: Any) -> _models.User:
        ...
        :type user_details: ~azure.mgmt.web.v2020_06_01.models.User or IO
    ...
    async def update_source_control(
        ...
        :param request_message: Source control token information. Is either a SourceControl type or a
         IO type. Required.
        :type request_message: ~azure.mgmt.web.v2020_06_01.models.SourceControl or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def verify_hosting_environment_vnet(
        ...
        :type parameters: ~azure.mgmt.web.v2020_06_01.models.VnetParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def move(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type move_resource_envelope: ~azure.mgmt.web.v2020_06_01.models.CsmMoveResourceEnvelope or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def validate(
        ...
        :type validate_request: ~azure.mgmt.web.v2020_06_01.models.ValidateRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
