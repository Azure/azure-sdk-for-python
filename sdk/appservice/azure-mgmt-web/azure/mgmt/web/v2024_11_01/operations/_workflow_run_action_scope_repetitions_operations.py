...
class WorkflowRunActionScopeRepetitionsOperations:  # pylint: disable=name-too-long
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2024_11_01.models.WorkflowRunActionRepetitionDefinition]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.web.v2024_11_01.models.WorkflowRunActionRepetitionDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
