...
class CertificatesOperations:
    ...
    def list(self, filter: Optional[str] = None, **kwargs: Any) -> ItemPaged["_models.Certificate"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2024_11_01.models.Certificate]
    ...
    def get(self, resource_group_name: str, name: str, **kwargs: Any) -> _models.Certificate:
        ...
        :rtype: ~azure.mgmt.web.v2024_11_01.models.Certificate
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type certificate_envelope: ~azure.mgmt.web.v2024_11_01.models.Certificate
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type certificate_envelope: ~azure.mgmt.web.v2024_11_01.models.Certificate or IO[bytes]
        :return: Certificate or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2024_11_01.models.Certificate
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type name: str
        :param certificate_envelope: Details of certificate, if it exists already. Required.
        :type certificate_envelope: ~azure.mgmt.web.v2024_11_01.models.CertificatePatchResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Certificate or the result of cls(response)
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type certificate_envelope: ~azure.mgmt.web.v2024_11_01.models.CertificatePatchResource or
         IO[bytes]
        :return: Certificate or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2024_11_01.models.Certificate
        :raises ~azure.core.exceptions.HttpResponseError:
