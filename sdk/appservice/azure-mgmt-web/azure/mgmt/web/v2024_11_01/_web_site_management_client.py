...
class WebSiteManagementClient(WebSiteManagementClientOperationsMixin):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype app_service_certificate_orders:
     azure.mgmt.web.v2024_11_01.operations.AppServiceCertificateOrdersOperations
    ...
    :vartype certificate_orders_diagnostics:
     azure.mgmt.web.v2024_11_01.operations.CertificateOrdersDiagnosticsOperations
    ...
    :vartype certificate_registration_provider:
     azure.mgmt.web.v2024_11_01.operations.CertificateRegistrationProviderOperations
    :ivar domain_registration_provider: DomainRegistrationProviderOperations operations
    :vartype domain_registration_provider:
     azure.mgmt.web.v2024_11_01.operations.DomainRegistrationProviderOperations
    :ivar domains: DomainsOperations operations
    :vartype domains: azure.mgmt.web.v2024_11_01.operations.DomainsOperations
    :ivar top_level_domains: TopLevelDomainsOperations operations
    :vartype top_level_domains: azure.mgmt.web.v2024_11_01.operations.TopLevelDomainsOperations
    :ivar app_service_environments: AppServiceEnvironmentsOperations operations
    :vartype app_service_environments:
     azure.mgmt.web.v2024_11_01.operations.AppServiceEnvironmentsOperations
    :ivar app_service_plans: AppServicePlansOperations operations
    :vartype app_service_plans: azure.mgmt.web.v2024_11_01.operations.AppServicePlansOperations
    :ivar certificates: CertificatesOperations operations
    :vartype certificates: azure.mgmt.web.v2024_11_01.operations.CertificatesOperations
    :ivar deleted_web_apps: DeletedWebAppsOperations operations
    :vartype deleted_web_apps: azure.mgmt.web.v2024_11_01.operations.DeletedWebAppsOperations
    :ivar diagnostics: DiagnosticsOperations operations
    :vartype diagnostics: azure.mgmt.web.v2024_11_01.operations.DiagnosticsOperations
    :ivar global_operations: GlobalOperations operations
    :vartype global_operations: azure.mgmt.web.v2024_11_01.operations.GlobalOperations
    :ivar kube_environments: KubeEnvironmentsOperations operations
    :vartype kube_environments: azure.mgmt.web.v2024_11_01.operations.KubeEnvironmentsOperations
    :ivar provider: ProviderOperations operations
    :vartype provider: azure.mgmt.web.v2024_11_01.operations.ProviderOperations
    :ivar recommendations: RecommendationsOperations operations
    :vartype recommendations: azure.mgmt.web.v2024_11_01.operations.RecommendationsOperations
    :ivar resource_health_metadata: ResourceHealthMetadataOperations operations
    :vartype resource_health_metadata:
     azure.mgmt.web.v2024_11_01.operations.ResourceHealthMetadataOperations
    :ivar get_usages_in_location: GetUsagesInLocationOperations operations
    :vartype get_usages_in_location:
     azure.mgmt.web.v2024_11_01.operations.GetUsagesInLocationOperations
    :ivar site_certificates: SiteCertificatesOperations operations
    :vartype site_certificates: azure.mgmt.web.v2024_11_01.operations.SiteCertificatesOperations
    :ivar static_sites: StaticSitesOperations operations
    :vartype static_sites: azure.mgmt.web.v2024_11_01.operations.StaticSitesOperations
    :ivar web_apps: WebAppsOperations operations
    :vartype web_apps: azure.mgmt.web.v2024_11_01.operations.WebAppsOperations
    :ivar workflows: WorkflowsOperations operations
    :vartype workflows: azure.mgmt.web.v2024_11_01.operations.WorkflowsOperations
    :ivar workflow_runs: WorkflowRunsOperations operations
    :vartype workflow_runs: azure.mgmt.web.v2024_11_01.operations.WorkflowRunsOperations
    :ivar workflow_run_actions: WorkflowRunActionsOperations operations
    :vartype workflow_run_actions:
     azure.mgmt.web.v2024_11_01.operations.WorkflowRunActionsOperations
    ...
    :vartype workflow_run_action_repetitions:
     azure.mgmt.web.v2024_11_01.operations.WorkflowRunActionRepetitionsOperations
    ...
    :vartype workflow_run_action_repetitions_request_histories:
     azure.mgmt.web.v2024_11_01.operations.WorkflowRunActionRepetitionsRequestHistoriesOperations
    ...
    :vartype workflow_run_action_scope_repetitions:
     azure.mgmt.web.v2024_11_01.operations.WorkflowRunActionScopeRepetitionsOperations
    :ivar workflow_triggers: WorkflowTriggersOperations operations
    :vartype workflow_triggers: azure.mgmt.web.v2024_11_01.operations.WorkflowTriggersOperations
    :ivar workflow_trigger_histories: WorkflowTriggerHistoriesOperations operations
    :vartype workflow_trigger_histories:
     azure.mgmt.web.v2024_11_01.operations.WorkflowTriggerHistoriesOperations
    :ivar workflow_versions: WorkflowVersionsOperations operations
    :vartype workflow_versions: azure.mgmt.web.v2024_11_01.operations.WorkflowVersionsOperations
