...
class KubeEnvironmentsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.KubeEnvironment"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2024_11_01.models.KubeEnvironment]
    ...
    async def get(self, resource_group_name: str, name: str, **kwargs: Any) -> _models.KubeEnvironment:
        ...
        :rtype: ~azure.mgmt.web.v2024_11_01.models.KubeEnvironment
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param kube_environment_envelope: Configuration details of the Kubernetes Environment.
         Required.
        :type kube_environment_envelope: ~azure.mgmt.web.v2024_11_01.models.KubeEnvironment
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either KubeEnvironment or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.web.v2024_11_01.models.KubeEnvironment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type kube_environment_envelope: ~azure.mgmt.web.v2024_11_01.models.KubeEnvironment or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either KubeEnvironment or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.web.v2024_11_01.models.KubeEnvironment]
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type kube_environment_envelope:
         ~azure.mgmt.web.v2024_11_01.models.KubeEnvironmentPatchResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: KubeEnvironment or the result of cls(response)
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type kube_environment_envelope:
         ~azure.mgmt.web.v2024_11_01.models.KubeEnvironmentPatchResource or IO[bytes]
        :return: KubeEnvironment or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2024_11_01.models.KubeEnvironment
        :raises ~azure.core.exceptions.HttpResponseError:
        """
