...
def build_preview_workflow_request(
    location: str,
    subscription_id: str,
    *,
    json: JSONType = None,
...
def build_create_or_update_static_site_request_initial(
    resource_group_name: str,
    name: str,
    subscription_id: str,
    *,
...
def build_delete_static_site_request_initial(
    resource_group_name: str,
    name: str,
    subscription_id: str,
    **kwargs: Any
...
def build_delete_static_site_build_request_initial(
    resource_group_name: str,
    name: str,
    environment_name: str,
    subscription_id: str,
...
def build_register_user_provided_function_app_with_static_site_build_request_initial(
    resource_group_name: str,
    name: str,
    environment_name: str,
    function_app_name: str,
...
def build_create_zip_deployment_for_static_site_build_request_initial(
    resource_group_name: str,
    name: str,
    environment_name: str,
    subscription_id: str,
...
def build_create_or_update_static_site_custom_domain_request_initial(
    resource_group_name: str,
    name: str,
    domain_name: str,
    subscription_id: str,
...
def build_delete_static_site_custom_domain_request_initial(
    resource_group_name: str,
    name: str,
    domain_name: str,
    subscription_id: str,
...
def build_validate_custom_domain_can_be_added_to_static_site_request_initial(
    resource_group_name: str,
    name: str,
    domain_name: str,
    subscription_id: str,
...
def build_detach_static_site_request_initial(
    resource_group_name: str,
    name: str,
    subscription_id: str,
    **kwargs: Any
...
def build_register_user_provided_function_app_with_static_site_request_initial(
    resource_group_name: str,
    name: str,
    function_app_name: str,
    subscription_id: str,
...
def build_create_zip_deployment_for_static_site_request_initial(
    resource_group_name: str,
    name: str,
    subscription_id: str,
    *,
...
class StaticSitesOperations(object):
    ...
    def list_static_site_users(
        ...
        authprovider: str,
        **kwargs: Any
    ) -> Iterable["_models.StaticSiteUserCollection"]:
    ...
    def get_static_site_builds(
        ...
        name: str,
        **kwargs: Any
    ) -> Iterable["_models.StaticSiteBuildCollection"]:
    ...
    def list_static_site_build_functions(
        ...
        environment_name: str,
        **kwargs: Any
    ) -> Iterable["_models.StaticSiteFunctionOverviewCollection"]:
    ...
    def get_user_provided_function_apps_for_static_site_build(
        ...
        environment_name: str,
        **kwargs: Any
    ) -> Iterable["_models.StaticSiteUserProvidedFunctionAppsCollection"]:
    ...
    def list_static_site_custom_domains(
        ...
        name: str,
        **kwargs: Any
    ) -> Iterable["_models.StaticSiteCustomDomainOverviewCollection"]:
