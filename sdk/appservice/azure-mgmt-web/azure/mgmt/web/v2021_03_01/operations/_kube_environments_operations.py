...
class KubeEnvironmentsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type kube_environment_envelope: ~azure.mgmt.web.v2021_03_01.models.KubeEnvironment or IO
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type kube_environment_envelope:
         ~azure.mgmt.web.v2021_03_01.models.KubeEnvironmentPatchResource or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
