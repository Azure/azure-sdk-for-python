...
class AppServicePlansOperations:  # pylint: disable=too-many-public-methods
    ...
    def list(self, detailed: Optional[bool] = None, **kwargs: Any) -> Iterable["_models.AppServicePlan"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2021_03_01.models.AppServicePlan]
    ...
    def get(self, resource_group_name: str, name: str, **kwargs: Any) -> _models.AppServicePlan:
        ...
        :rtype: ~azure.mgmt.web.v2021_03_01.models.AppServicePlan
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type app_service_plan: ~azure.mgmt.web.v2021_03_01.models.AppServicePlan
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type app_service_plan: ~azure.mgmt.web.v2021_03_01.models.AppServicePlan or IO[bytes]
        :return: An instance of LROPoller that returns either AppServicePlan or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.v2021_03_01.models.AppServicePlan]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type name: str
        :param app_service_plan: Details of the App Service plan. Required.
        :type app_service_plan: ~azure.mgmt.web.v2021_03_01.models.AppServicePlanPatchResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: AppServicePlan or the result of cls(response)
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type app_service_plan: ~azure.mgmt.web.v2021_03_01.models.AppServicePlanPatchResource or
         IO[bytes]
        :return: AppServicePlan or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_03_01.models.AppServicePlan
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_capabilities(self, resource_group_name: str, name: str, **kwargs: Any) -> List[_models.Capability]:
        ...
        :rtype: list[~azure.mgmt.web.v2021_03_01.models.Capability]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def get_hybrid_connection(
        ...
        :rtype: ~azure.mgmt.web.v2021_03_01.models.HybridConnection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def list_hybrid_connection_keys(
        ...
        :rtype: ~azure.mgmt.web.v2021_03_01.models.HybridConnectionKey
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def get_hybrid_connection_plan_limit(
        ...
        :rtype: ~azure.mgmt.web.v2021_03_01.models.HybridConnectionLimits
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def list_hybrid_connections(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2021_03_01.models.HybridConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_web_apps(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2021_03_01.models.Site]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_usages(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2021_03_01.models.CsmUsageQuota]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_vnets(self, resource_group_name: str, name: str, **kwargs: Any) -> List[_models.VnetInfoResource]:
        ...
        :rtype: list[~azure.mgmt.web.v2021_03_01.models.VnetInfoResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def get_vnet_from_server_farm(
        ...
        :rtype: ~azure.mgmt.web.v2021_03_01.models.VnetInfoResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def get_vnet_gateway(
        ...
        :rtype: ~azure.mgmt.web.v2021_03_01.models.VnetGateway
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def update_vnet_gateway(
        ...
        **kwargs: Any
        ...
        :type connection_envelope: ~azure.mgmt.web.v2021_03_01.models.VnetGateway
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: VnetGateway or the result of cls(response)
    ...
    def update_vnet_gateway(
        ...
        **kwargs: Any
        ...
        :param connection_envelope: Definition of the gateway. Is either a VnetGateway type or a
         IO[bytes] type. Required.
        :type connection_envelope: ~azure.mgmt.web.v2021_03_01.models.VnetGateway or IO[bytes]
        :return: VnetGateway or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_03_01.models.VnetGateway
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_routes_for_vnet(
        ...
        :rtype: list[~azure.mgmt.web.v2021_03_01.models.VnetRoute]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def create_or_update_vnet_route(
        ...
        **kwargs: Any
        ...
        :type route: ~azure.mgmt.web.v2021_03_01.models.VnetRoute
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: VnetRoute or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_03_01.models.VnetRoute
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def create_or_update_vnet_route(
        ...
        **kwargs: Any
        ...
        :param route: Definition of the Virtual Network route. Is either a VnetRoute type or a
         IO[bytes] type. Required.
        :type route: ~azure.mgmt.web.v2021_03_01.models.VnetRoute or IO[bytes]
        :return: VnetRoute or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_03_01.models.VnetRoute
        :raises ~azure.core.exceptions.HttpResponseError:
        """
