...
class CertificatesOperations:
    ...
    @distributed_trace
    def list(self, filter: Optional[str] = None, **kwargs: Any) -> AsyncIterable["_models.Certificate"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2021_03_01.models.Certificate]
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.Certificate"]:
    ...
    async def get(self, resource_group_name: str, name: str, **kwargs: Any) -> _models.Certificate:
        ...
        :rtype: ~azure.mgmt.web.v2021_03_01.models.Certificate
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type certificate_envelope: ~azure.mgmt.web.v2021_03_01.models.Certificate
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type certificate_envelope: ~azure.mgmt.web.v2021_03_01.models.Certificate or IO[bytes]
        :return: Certificate or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_03_01.models.Certificate
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type name: str
        :param certificate_envelope: Details of certificate, if it exists already. Required.
        :type certificate_envelope: ~azure.mgmt.web.v2021_03_01.models.CertificatePatchResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Certificate or the result of cls(response)
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type certificate_envelope: ~azure.mgmt.web.v2021_03_01.models.CertificatePatchResource or
         IO[bytes]
        :return: Certificate or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_03_01.models.Certificate
        :raises ~azure.core.exceptions.HttpResponseError:
