...
def build_list_request(location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Web/locations/{location}/usages"
    )
...
class GetUsagesInLocationOperations:
    ...
    @distributed_trace
    def list(self, location: str, **kwargs: Any) -> ItemPaged["_models.CsmUsageQuota"]:
