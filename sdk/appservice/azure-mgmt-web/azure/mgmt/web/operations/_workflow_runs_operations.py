...
class WorkflowRunsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.WorkflowRun]
    ...
    def get(
        ...
        deserialized = self._deserialize("WorkflowRun", pipeline_response.http_response)
