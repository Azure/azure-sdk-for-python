...
class WorkflowRunActionsOperations:
    ...
    def list(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.WorkflowRunAction"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.WorkflowRunAction]
    ...
    def list_expression_traces(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.ExpressionRoot]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
