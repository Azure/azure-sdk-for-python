...
class AppServiceEnvironmentsOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.web.WebSiteManagementClient`'s
    ...
    def list(self, **kwargs: Any) -> ItemPaged["_models.AppServiceEnvironmentResource"]:
        ...
        :return: An iterator like instance of either AppServiceEnvironmentResource or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.AppServiceEnvironmentResource]
    ...
    def list_capacities(self, resource_group_name: str, name: str, **kwargs: Any) -> ItemPaged["_models.StampCapacity"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.StampCapacity]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_change_vnet(
        ...
        **kwargs: Any
        ...
        :type vnet_info: ~azure.mgmt.web.models.VirtualNetworkProfile or IO[bytes]
        :return: An instance of LROPoller that returns an iterator like instance of either
         WebAppCollection or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.core.paging.ItemPaged[~azure.mgmt.web.models.Site]]
    ...
    def get_inbound_network_dependencies_endpoints(  # pylint: disable=name-too-long
        ...
        :return: An iterator like instance of either InboundEnvironmentEndpoint or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.InboundEnvironmentEndpoint]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_multi_role_pools(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.WorkerPoolResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_create_or_update_multi_role_pool(
        ...
        **kwargs: Any
        ...
        :type multi_role_pool_envelope: ~azure.mgmt.web.models.WorkerPoolResource or IO[bytes]
        :return: An instance of LROPoller that returns either WorkerPoolResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.models.WorkerPoolResource]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_multi_role_pool_skus(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.SkuInfo]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_multi_role_usages(self, resource_group_name: str, name: str, **kwargs: Any) -> ItemPaged["_models.Usage"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.Usage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get_outbound_network_dependencies_endpoints(  # pylint: disable=name-too-long
        ...
        :return: An iterator like instance of either OutboundEnvironmentEndpoint or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.OutboundEnvironmentEndpoint]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get_private_endpoint_connection_list(
        ...
        :return: An iterator like instance of either RemotePrivateEndpointConnectionARMResource or the
         result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.RemotePrivateEndpointConnectionARMResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_approve_or_reject_private_endpoint_connection(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.web.models.RemotePrivateEndpointConnectionARMResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_approve_or_reject_private_endpoint_connection(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :type private_endpoint_wrapper:
         ~azure.mgmt.web.models.RemotePrivateEndpointConnectionARMResource or IO[bytes]
        :return: An instance of LROPoller that returns either
         RemotePrivateEndpointConnectionARMResource or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.web.models.RemotePrivateEndpointConnectionARMResource]
    ...
    def list_web_apps(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.Site]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_create_or_update_worker_pool(
        ...
        **kwargs: Any
        ...
        :param worker_pool_envelope: Properties of the worker pool. Is either a WorkerPoolResource type
         or a IO[bytes] type. Required.
        :type worker_pool_envelope: ~azure.mgmt.web.models.WorkerPoolResource or IO[bytes]
        :return: An instance of LROPoller that returns either WorkerPoolResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.models.WorkerPoolResource]
        :raises ~azure.core.exceptions.HttpResponseError:
