...
def build_list_geo_regions_request(
    ...
    **kwargs: Any
    ...
    if custom_mode_workers_enabled is not None:
        _params["customModeWorkersEnabled "] = _SERIALIZER.query(
            "custom_mode_workers_enabled", custom_mode_workers_enabled, "bool"
        )
    _params["api-version"] = _SERIALIZER.query("api_version", api_version, "str")
...
class _WebSiteManagementClientOperationsMixin(
    ...
    def update_publishing_user(self, user_details: Union[_models.User, IO[bytes]], **kwargs: Any) -> _models.User:
        ...
        :param user_details: Details of publishing user. Is either a User type or a IO[bytes] type.
         Required.
        :type user_details: ~azure.mgmt.web.models.User or IO[bytes]
        :return: User or the result of cls(response)
        :rtype: ~azure.mgmt.web.models.User
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_source_controls(self, **kwargs: Any) -> ItemPaged["_models.SourceControl"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.SourceControl]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def update_source_control(
        ...
        :type request_message: ~azure.mgmt.web.models.SourceControl or IO[bytes]
        :return: SourceControl or the result of cls(response)
        :rtype: ~azure.mgmt.web.models.SourceControl
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_billing_meters(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.BillingMeter]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_custom_host_name_sites(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.CustomHostnameSites]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_ase_regions(self, **kwargs: Any) -> ItemPaged["_models.AseRegion"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.AseRegion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_geo_regions(
        ...
        **kwargs: Any
        ...
        :param custom_mode_workers_enabled: Specify :code:`<code>true</code>` if you want to filter to
         only regions that support App Service Plans with :code:`<code>IsCustomMode</code>` set to
         :code:`<code>true</code>`. Default value is None.
        :type custom_mode_workers_enabled: bool
        :return: An iterator like instance of either GeoRegion or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.GeoRegion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_premier_add_on_offers(self, **kwargs: Any) -> ItemPaged["_models.PremierAddOnOffer"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.PremierAddOnOffer]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def move(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type move_resource_envelope: ~azure.mgmt.web.models.CsmMoveResourceEnvelope or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def validate(
        ...
        :type validate_request: ~azure.mgmt.web.models.ValidateRequest or IO[bytes]
        :return: ValidateResponse or the result of cls(response)
        :rtype: ~azure.mgmt.web.models.ValidateResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
