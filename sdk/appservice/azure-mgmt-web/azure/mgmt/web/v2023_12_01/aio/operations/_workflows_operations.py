...
class WorkflowsOperations:
    ...
    async def regenerate_access_key(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type key_type: ~azure.mgmt.web.v2023_12_01.models.RegenerateActionParameter
    ...
    async def regenerate_access_key(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param key_type: The access key type. Is either a RegenerateActionParameter type or a IO[bytes]
         type. Required.
        :type key_type: ~azure.mgmt.web.v2023_12_01.models.RegenerateActionParameter or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def validate(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type validate: ~azure.mgmt.web.v2023_12_01.models.Workflow
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    async def validate(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type validate: ~azure.mgmt.web.v2023_12_01.models.Workflow or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
