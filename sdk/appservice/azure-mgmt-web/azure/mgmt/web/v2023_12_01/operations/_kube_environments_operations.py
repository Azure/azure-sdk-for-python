...
class KubeEnvironmentsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.KubeEnvironment"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2023_12_01.models.KubeEnvironment]
    ...
    def get(self, resource_group_name: str, name: str, **kwargs: Any) -> _models.KubeEnvironment:
        ...
        :rtype: ~azure.mgmt.web.v2023_12_01.models.KubeEnvironment
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param kube_environment_envelope: Configuration details of the Kubernetes Environment.
         Required.
        :type kube_environment_envelope: ~azure.mgmt.web.v2023_12_01.models.KubeEnvironment
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either KubeEnvironment or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.v2023_12_01.models.KubeEnvironment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type kube_environment_envelope: ~azure.mgmt.web.v2023_12_01.models.KubeEnvironment or
         IO[bytes]
        :return: An instance of LROPoller that returns either KubeEnvironment or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.v2023_12_01.models.KubeEnvironment]
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type kube_environment_envelope:
         ~azure.mgmt.web.v2023_12_01.models.KubeEnvironmentPatchResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: KubeEnvironment or the result of cls(response)
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type kube_environment_envelope:
         ~azure.mgmt.web.v2023_12_01.models.KubeEnvironmentPatchResource or IO[bytes]
        :return: KubeEnvironment or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2023_12_01.models.KubeEnvironment
        :raises ~azure.core.exceptions.HttpResponseError:
        """
