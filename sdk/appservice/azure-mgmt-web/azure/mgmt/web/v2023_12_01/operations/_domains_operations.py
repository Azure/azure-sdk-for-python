...
class DomainsOperations:
    ...
    def check_availability(
        ...
        :type identifier: ~azure.mgmt.web.v2023_12_01.models.NameIdentifier
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: DomainAvailabilityCheckResult or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2023_12_01.models.DomainAvailabilityCheckResult
    ...
    def check_availability(
        ...
        :param identifier: Name of the domain. Is either a NameIdentifier type or a IO[bytes] type.
         Required.
        :type identifier: ~azure.mgmt.web.v2023_12_01.models.NameIdentifier or IO[bytes]
        :return: DomainAvailabilityCheckResult or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2023_12_01.models.DomainAvailabilityCheckResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.Domain"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2023_12_01.models.Domain]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_control_center_sso_request(self, **kwargs: Any) -> _models.DomainControlCenterSsoRequest:
        ...
        :rtype: ~azure.mgmt.web.v2023_12_01.models.DomainControlCenterSsoRequest
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def list_recommendations(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.web.v2023_12_01.models.DomainRecommendationSearchParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An iterator like instance of either NameIdentifier or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2023_12_01.models.NameIdentifier]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_recommendations(
        ...
        :type parameters: ~azure.mgmt.web.v2023_12_01.models.DomainRecommendationSearchParameters or
         IO[bytes]
        :return: An iterator like instance of either NameIdentifier or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2023_12_01.models.NameIdentifier]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def get(self, resource_group_name: str, domain_name: str, **kwargs: Any) -> _models.Domain:
        ...
        :rtype: ~azure.mgmt.web.v2023_12_01.models.Domain
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type domain: ~azure.mgmt.web.v2023_12_01.models.Domain
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Domain or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.v2023_12_01.models.Domain]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        :param domain: Domain registration information. Is either a Domain type or a IO[bytes] type.
         Required.
        :type domain: ~azure.mgmt.web.v2023_12_01.models.Domain or IO[bytes]
        :return: An instance of LROPoller that returns either Domain or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.v2023_12_01.models.Domain]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type domain_name: str
        :param domain: Domain registration information. Required.
        :type domain: ~azure.mgmt.web.v2023_12_01.models.DomainPatchResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Domain or the result of cls(response)
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type domain: ~azure.mgmt.web.v2023_12_01.models.DomainPatchResource or IO[bytes]
        :return: Domain or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2023_12_01.models.Domain
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_ownership_identifiers(
        ...
        :return: An iterator like instance of either DomainOwnershipIdentifier or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2023_12_01.models.DomainOwnershipIdentifier]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get_ownership_identifier(
        ...
        :rtype: ~azure.mgmt.web.v2023_12_01.models.DomainOwnershipIdentifier
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def create_or_update_ownership_identifier(
        ...
        **kwargs: Any
        ...
        :param domain_ownership_identifier: A JSON representation of the domain ownership properties.
         Required.
        :type domain_ownership_identifier: ~azure.mgmt.web.v2023_12_01.models.DomainOwnershipIdentifier
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: DomainOwnershipIdentifier or the result of cls(response)
