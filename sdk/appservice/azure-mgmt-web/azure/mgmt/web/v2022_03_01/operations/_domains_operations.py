...
def build_list_recommendations_request(
    subscription_id: str,
    *,
    json: Optional[_models.DomainRecommendationSearchParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_delete_request(
    ...
    **kwargs: Any
    ...
    if force_hard_delete_domain is not None:
        _params['forceHardDeleteDomain'] = _SERIALIZER.query("force_hard_delete_domain", force_hard_delete_domain, 'bool')
    _params['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
...
def build_update_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.DomainPatchResource] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_create_or_update_ownership_identifier_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.DomainOwnershipIdentifier] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class DomainsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2022_03_01.models.DomainCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_recommendations(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either NameIdentifierCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2022_03_01.models.NameIdentifierCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_ownership_identifiers(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DomainOwnershipIdentifierCollection or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2022_03_01.models.DomainOwnershipIdentifierCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
