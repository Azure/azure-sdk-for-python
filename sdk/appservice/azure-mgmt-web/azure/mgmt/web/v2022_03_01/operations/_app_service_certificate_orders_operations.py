...
class AppServiceCertificateOrdersOperations:  # pylint: disable=too-many-public-methods
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.AppServiceCertificateOrder"]:
        ...
        :return: An iterator like instance of either AppServiceCertificateOrder or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2022_03_01.models.AppServiceCertificateOrder]
    ...
    def list_certificates(
        ...
        :return: An iterator like instance of either AppServiceCertificateResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2022_03_01.models.AppServiceCertificateResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
