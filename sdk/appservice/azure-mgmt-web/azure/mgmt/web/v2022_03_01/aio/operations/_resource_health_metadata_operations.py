...
class ResourceHealthMetadataOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ResourceHealthMetadataCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2022_03_01.models.ResourceHealthMetadataCollection]
    ...
    async def get_by_site(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.web.v2022_03_01.models.ResourceHealthMetadata
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
