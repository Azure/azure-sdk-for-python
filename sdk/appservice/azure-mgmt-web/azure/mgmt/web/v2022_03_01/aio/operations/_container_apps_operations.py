...
class ContainerAppsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.ContainerApp"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2022_03_01.models.ContainerApp]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type container_app_envelope: ~azure.mgmt.web.v2022_03_01.models.ContainerApp or IO
