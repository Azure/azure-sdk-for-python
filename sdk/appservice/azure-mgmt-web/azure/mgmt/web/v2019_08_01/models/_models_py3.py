...
class ApiKVReference(msrest.serialization.Model):
    ...
    :ivar identity_type: Type of managed service identity. Possible values include:
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword identity_type: Type of managed service identity. Possible values include:
         "SystemAssigned", "UserAssigned", "SystemAssigned, UserAssigned", "None".
...
class KeyVaultReferenceCollection(ProxyOnlyResource):
    ...
    def __init__(
        ...
        *,
        kind: Optional[str] = None,
        key_to_reference_statuses: Optional[Dict[str, "ApiKVReference"]] = None,
        **kwargs
    ):
        """
        :keyword kind: Kind of resource.
