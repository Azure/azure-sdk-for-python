...
class DomainsOperations:
    ...
    async def check_availability(
        ...
        :type identifier: ~azure.mgmt.web.v2019_08_01.models.NameIdentifier or IO
    ...
    def list_recommendations(
        ...
        :type parameters: ~azure.mgmt.web.v2019_08_01.models.DomainRecommendationSearchParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_create_or_update(
        ...
        :type domain: ~azure.mgmt.web.v2019_08_01.models.Domain or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        :param domain: Domain registration information. Is either a DomainPatchResource type or a IO
         type. Required.
        :type domain: ~azure.mgmt.web.v2019_08_01.models.DomainPatchResource or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
