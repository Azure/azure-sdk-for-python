...
class TopLevelDomainsOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.TopLevelDomain"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2019_08_01.models.TopLevelDomain]
    ...
    def list_agreements(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2019_08_01.models.TldLegalAgreement]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
