...
class AppServicePlansOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_create_or_update(
        ...
        :param app_service_plan: Details of the App Service plan. Is either a AppServicePlan type or a
         IO type. Required.
        :type app_service_plan: ~azure.mgmt.web.v2019_08_01.models.AppServicePlan or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type app_service_plan: ~azure.mgmt.web.v2019_08_01.models.AppServicePlanPatchResource or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update_vnet_gateway(
        ...
        **kwargs: Any
        ...
        :param connection_envelope: Definition of the gateway. Is either a VnetGateway type or a IO
         type. Required.
        :type connection_envelope: ~azure.mgmt.web.v2019_08_01.models.VnetGateway or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def create_or_update_vnet_route(
        ...
        **kwargs: Any
        ...
        :param route: Definition of the Virtual Network route. Is either a VnetRoute type or a IO type.
         Required.
        :type route: ~azure.mgmt.web.v2019_08_01.models.VnetRoute or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
