...
class AppServicePlansOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type app_service_plan: ~azure.mgmt.web.v2019_08_01.models.AppServicePlan or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either AppServicePlan or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.web.v2019_08_01.models.AppServicePlan]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type app_service_plan: ~azure.mgmt.web.v2019_08_01.models.AppServicePlanPatchResource or
         IO[bytes]
        :return: AppServicePlan or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2019_08_01.models.AppServicePlan
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_hybrid_connections(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2019_08_01.models.HybridConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def update_vnet_gateway(
        ...
        **kwargs: Any
        ...
        :param connection_envelope: Definition of the gateway. Is either a VnetGateway type or a
         IO[bytes] type. Required.
        :type connection_envelope: ~azure.mgmt.web.v2019_08_01.models.VnetGateway or IO[bytes]
        :return: VnetGateway or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2019_08_01.models.VnetGateway
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_or_update_vnet_route(
        ...
        **kwargs: Any
        ...
        :param route: Definition of the Virtual Network route. Is either a VnetRoute type or a
         IO[bytes] type. Required.
        :type route: ~azure.mgmt.web.v2019_08_01.models.VnetRoute or IO[bytes]
        :return: VnetRoute or None or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2019_08_01.models.VnetRoute or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
