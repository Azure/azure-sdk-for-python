...
class DiagnosticsOperations:
    ...
    def list_hosting_environment_detector_responses(
        ...
        if raw:
            header_dict = {}
        deserialized = models.DetectorResponsePaged(
    ...
    def list_site_diagnostic_categories(
        ...
        if raw:
            header_dict = {}
        deserialized = models.DiagnosticCategoryPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    def list_site_analyses(
        ...
        if raw:
            header_dict = {}
        deserialized = models.AnalysisDefinitionPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    def list_site_detectors(
        ...
        if raw:
            header_dict = {}
        deserialized = models.DetectorDefinitionPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
