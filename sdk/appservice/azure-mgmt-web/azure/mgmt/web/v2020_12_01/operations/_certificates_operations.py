...
class CertificatesOperations(object):
    ...
    def list(
        ...
        :param filter: Return only information specified in the filter (using
         OData syntax). For example: $filter=KeyVaultId eq 'KeyVaultId'
        :type filter: str
        ...
        :rtype:
         ~azure.mgmt.web.v2020_12_01.models.CertificatePaged[~azure.mgmt.web.v2020_12_01.models.Certificate]
        :raises:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.web.v2020_12_01.models.Certificate or
    ...
    def create_or_update(
        ...
        :type certificate_envelope:
         ~azure.mgmt.web.v2020_12_01.models.Certificate
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def update(
        ...
        :param certificate_envelope: Details of certificate, if it exists
         already.
        :type certificate_envelope:
         ~azure.mgmt.web.v2020_12_01.models.CertificatePatchResource
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
