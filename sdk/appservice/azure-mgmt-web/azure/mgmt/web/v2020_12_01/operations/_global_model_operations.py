...
class GlobalModelOperations(object):
    ...
    def get_deleted_web_app(
            self, deleted_site_id, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.get_deleted_web_app.metadata['url']
    ...
    def get_deleted_web_app_snapshots(
        ...
        :rtype: list[~azure.mgmt.web.v2020_12_01.models.Snapshot] or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`DefaultErrorResponseException<azure.mgmt.web.v2020_12_01.models.DefaultErrorResponseException>`
        """
        # Construct URL
        url = self.get_deleted_web_app_snapshots.metadata['url']
        path_format_arguments = {
            'deletedSiteId': self._serialize.url("deleted_site_id", deleted_site_id, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
        }
    ...
    def get_subscription_operation_with_async_response(
        ...
        """
        # Construct URL
        url = self.get_subscription_operation_with_async_response.metadata['url']
        path_format_arguments = {
