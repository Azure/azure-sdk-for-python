...
class CustomDomainStatus(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class DetectorType(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class InsightStatus(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class StackPreferredOs(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class StagingEnvironmentPolicy(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
