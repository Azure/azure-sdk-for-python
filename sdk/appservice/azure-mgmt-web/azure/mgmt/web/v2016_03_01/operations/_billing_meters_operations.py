...
def build_list_request(subscription_id: str, *, billing_location: Optional[str] = None, **kwargs: Any) -> HttpRequest:
...
class BillingMetersOperations:
    ...
    @distributed_trace
    def list(self, billing_location: Optional[str] = None, **kwargs: Any) -> ItemPaged["_models.BillingMeter"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2016_03_01.models.BillingMeter]
