...
from ...operations._workflow_run_action_repetitions_operations import (
    build_get_request,
    build_list_expression_traces_request,
    build_list_request,
)
...
class WorkflowRunActionRepetitionsOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2022_09_01.models.WorkflowRunActionRepetitionDefinition]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("WorkflowRunActionRepetitionDefinition", pipeline_response.http_response)
    ...
    def list_expression_traces(
        ...
        repetition_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.ExpressionRoot"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2022_09_01.models.ExpressionRoot]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
