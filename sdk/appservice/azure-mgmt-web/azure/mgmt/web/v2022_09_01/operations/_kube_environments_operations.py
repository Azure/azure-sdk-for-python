...
class KubeEnvironmentsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.KubeEnvironment"]:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.KubeEnvironment"]:
    ...
    def get(self, resource_group_name: str, name: str, **kwargs: Any) -> _models.KubeEnvironment:
        ...
        deserialized = self._deserialize("KubeEnvironment", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        name: str,
        kube_environment_envelope: Union[_models.KubeEnvironment, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type kube_environment_envelope: ~azure.mgmt.web.v2022_09_01.models.KubeEnvironment or
         IO[bytes]
        :return: An instance of LROPoller that returns either KubeEnvironment or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.v2022_09_01.models.KubeEnvironment]
        ...
        if cont_token:
            return LROPoller[_models.KubeEnvironment].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.KubeEnvironment](
    ...
    def update(
        ...
        resource_group_name: str,
        name: str,
        kube_environment_envelope: Union[_models.KubeEnvironmentPatchResource, IO[bytes]],
        **kwargs: Any
    ) -> _models.KubeEnvironment:
        """Creates or updates a Kubernetes Environment.
        ...
        :type kube_environment_envelope:
         ~azure.mgmt.web.v2022_09_01.models.KubeEnvironmentPatchResource or IO[bytes]
        :return: KubeEnvironment or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2022_09_01.models.KubeEnvironment
        :raises ~azure.core.exceptions.HttpResponseError:
        """
