...
class KubeEnvironmentsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.KubeEnvironment"]:
        """Get all Kubernetes Environments for a subscription.

        Description for Get all Kubernetes Environments for a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either KubeEnvironment or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2022_09_01.models.KubeEnvironment]
        ...
        api_version: Literal["2022-09-01"] = kwargs.pop("api_version", _params.pop("api-version", "2022-09-01"))
        cls: ClsType[_models.KubeEnvironmentCollection] = kwargs.pop("cls", None)
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.KubeEnvironment"]:
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/kubeEnvironments"
    }

    @distributed_trace
    def get(self, resource_group_name: str, name: str, **kwargs: Any) -> _models.KubeEnvironment:
        ...
        :rtype: ~azure.mgmt.web.v2022_09_01.models.KubeEnvironment
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/kubeEnvironments/{name}"
    }
    ...
    def _create_or_update_initial(
        ...
        name: str,
        kube_environment_envelope: Union[_models.KubeEnvironment, IO],
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(kube_environment_envelope, (IO, bytes)):
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param kube_environment_envelope: Configuration details of the Kubernetes Environment.
         Required.
        :type kube_environment_envelope: ~azure.mgmt.web.v2022_09_01.models.KubeEnvironment
        ...
        :return: An instance of LROPoller that returns either KubeEnvironment or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.v2022_09_01.models.KubeEnvironment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param kube_environment_envelope: Configuration details of the Kubernetes Environment.
         Required.
        :type kube_environment_envelope: IO
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type kube_environment_envelope: ~azure.mgmt.web.v2022_09_01.models.KubeEnvironment or IO
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type kube_environment_envelope:
         ~azure.mgmt.web.v2022_09_01.models.KubeEnvironmentPatchResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update(
        ...
        resource_group_name: str,
        name: str,
        kube_environment_envelope: Union[_models.KubeEnvironmentPatchResource, IO],
        **kwargs: Any
    ) -> _models.KubeEnvironment:
        """Creates or updates a Kubernetes Environment.
        ...
        :type kube_environment_envelope:
         ~azure.mgmt.web.v2022_09_01.models.KubeEnvironmentPatchResource or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
