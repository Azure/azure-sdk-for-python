...
class WorkflowRunActionScopeRepetitionsOperations:
    ...
    def list(
    ...
    ) -> Iterable["_models.WorkflowRunActionRepetitionDefinition"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2022_09_01.models.WorkflowRunActionRepetitionDefinition]
        ...
        api_version: Literal["2022-09-01"] = kwargs.pop("api_version", _params.pop("api-version", "2022-09-01"))
        cls: ClsType[_models.WorkflowRunActionRepetitionDefinitionCollection] = kwargs.pop("cls", None)
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/hostruntime/runtime/webhooks/workflow/api/management/workflows/{workflowName}/runs/{runName}/actions/{actionName}/scopeRepetitions"
    }
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.web.v2022_09_01.models.WorkflowRunActionRepetitionDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/hostruntime/runtime/webhooks/workflow/api/management/workflows/{workflowName}/runs/{runName}/actions/{actionName}/scopeRepetitions/{repetitionName}"
    }
