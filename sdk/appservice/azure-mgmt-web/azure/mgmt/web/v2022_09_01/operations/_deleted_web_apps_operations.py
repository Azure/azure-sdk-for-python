...
class DeletedWebAppsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.DeletedSite"]:
        """Get all deleted apps for a subscription.

        Description for Get all deleted apps for a subscription.

        :return: An iterator like instance of either DeletedSite or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2022_09_01.models.DeletedSite]
    ...
    @distributed_trace
    def list_by_location(self, location: str, **kwargs: Any) -> ItemPaged["_models.DeletedSite"]:
