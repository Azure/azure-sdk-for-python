...
class WebSiteManagementClientOperationsMixin(object):
    ...
    def list_ase_regions(
        self,
        **kwargs: Any
    ) -> AsyncItemPaged["_models.AseRegion"]:
    ...
    def list_premier_add_on_offers(
        self,
        **kwargs: Any
    ) -> AsyncItemPaged["_models.PremierAddOnOffer"]:
    ...
    async def regional_check_name_availability(
        ...
        **kwargs: Any
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.regional_check_name_availability(location, name, type, resource_group_name, auto_generated_domain_name_label_scope, **kwargs)
