...
from ...operations._app_service_plans_operations import (
    ...
    build_get_server_farm_instance_details_request,
    build_get_server_farm_rdp_password_request,
    ...
    build_recycle_managed_instance_worker_request,
...
class AppServicePlansOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type app_service_plan: ~azure.mgmt.web.models.AppServicePlan or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either AppServicePlan or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.web.models.AppServicePlan]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type app_service_plan: ~azure.mgmt.web.models.AppServicePlanPatchResource or IO[bytes]
        :return: AppServicePlan or the result of cls(response)
        :rtype: ~azure.mgmt.web.models.AppServicePlan
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_server_farm_rdp_password(
        ...
        :param name: Name of the App Service plan. Required.
        :type name: str
        :return: ServerFarmRdpDetails or the result of cls(response)
        ...
        deserialized = self._deserialize("ServerFarmRdpDetails", pipeline_response.http_response)
    ...
    async def get_server_farm_instance_details(
        ...
        :param name: Name of the App Service plan. Required.
        :type name: str
        :return: ServerFarmInstanceDetails or the result of cls(response)
        ...
        deserialized = self._deserialize("ServerFarmInstanceDetails", pipeline_response.http_response)
    ...
    async def update_vnet_gateway(
        ...
        **kwargs: Any
        ...
        :param connection_envelope: Definition of the gateway. Is either a VnetGateway type or a
         IO[bytes] type. Required.
        :type connection_envelope: ~azure.mgmt.web.models.VnetGateway or IO[bytes]
        :return: VnetGateway or the result of cls(response)
        :rtype: ~azure.mgmt.web.models.VnetGateway
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_or_update_vnet_route(
        ...
        **kwargs: Any
        ...
        :param route: Definition of the Virtual Network route. Is either a VnetRoute type or a
         IO[bytes] type. Required.
        :type route: ~azure.mgmt.web.models.VnetRoute or IO[bytes]
        :return: VnetRoute or the result of cls(response)
        :rtype: ~azure.mgmt.web.models.VnetRoute
        :raises ~azure.core.exceptions.HttpResponseError:
        """
