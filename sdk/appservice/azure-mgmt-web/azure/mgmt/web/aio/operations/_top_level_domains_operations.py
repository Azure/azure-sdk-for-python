...
class TopLevelDomainsOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.TopLevelDomain"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.models.TopLevelDomain]
    ...
    async def get(self, name: str, **kwargs: Any) -> _models.TopLevelDomain:
        ...
        :rtype: ~azure.mgmt.web.models.TopLevelDomain
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_agreements(
        ...
        **kwargs: Any
        ...
        :type agreement_option: ~azure.mgmt.web.models.TopLevelDomainAgreementOption
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An iterator like instance of either TldLegalAgreement or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.models.TldLegalAgreement]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_agreements(
        ...
        :type agreement_option: ~azure.mgmt.web.models.TopLevelDomainAgreementOption or IO[bytes]
        :return: An iterator like instance of either TldLegalAgreement or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.models.TldLegalAgreement]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
