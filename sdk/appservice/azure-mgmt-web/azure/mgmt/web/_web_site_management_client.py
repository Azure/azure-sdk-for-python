...
class WebSiteManagementClient(WebSiteManagementClientOperationsMixin, MultiApiClientMixin, SDKClient):
    ...
    def global_model(self):
        """Instance depends on the API version:
           ...
           * 2021-01-01: :class:`GlobalModelOperations<azure.mgmt.web.v2021_01_01.operations.GlobalModelOperations>`
        """
        api_version = self._get_api_version('global_model')
        if api_version == '2020-12-01':
            from .v2020_12_01.operations import GlobalModelOperations as OperationClass
        elif api_version == '2021-01-01':
            from .v2021_01_01.operations import GlobalModelOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
