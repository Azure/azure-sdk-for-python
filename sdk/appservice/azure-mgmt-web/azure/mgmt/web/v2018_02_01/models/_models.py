...
class AnalysisData(msrest.serialization.Model):
    ...
    :type source: str
    :param detector_definition: Class representing detector definition.
...
class ApplicationLogsConfig(msrest.serialization.Model):
    ...
    :param azure_blob_storage: Application logs azure blob storage configuration.
...
class AppServiceCertificateOrder(Resource):
    ...
    :ivar signed_certificate: SSL certificate details.
    ...
    :type csr: str
    :ivar intermediate: SSL certificate details.
    :vartype intermediate: ~azure.mgmt.web.v2018_02_01.models.CertificateDetails
    :ivar root: SSL certificate details.
...
class AppServiceEnvironment(msrest.serialization.Model):
    ...
    :param virtual_network: Required. Specification for using a Virtual Network.
...
class AppServiceEnvironmentPatchResource(ProxyOnlyResource):
    ...
    :param vnet_subnet_name: Subnet of the Virtual Network.
    :type vnet_subnet_name: str
    :param virtual_network: Specification for using a Virtual Network.
    :type virtual_network: ~azure.mgmt.web.v2018_02_01.models.VirtualNetworkProfile
    :param internal_load_balancing_mode: Specifies which endpoints to serve internally in the
     Virtual Network for the App Service Environment. Possible values include: 'None', 'Web',
     'Publishing'.
...
class AppServicePlan(Resource):
    ...
    :param hosting_environment_profile: Specification for an App Service Environment to use for
     this resource.
...
class AutoHealActions(msrest.serialization.Model):
    ...
    :param custom_action: Custom action to be executed
...
class AutoHealRules(msrest.serialization.Model):
    ...
    :param triggers: Triggers for auto-heal.
    :type triggers: ~azure.mgmt.web.v2018_02_01.models.AutoHealTriggers
    :param actions: Actions which to take by the auto-heal module when a rule is triggered.
...
class AutoHealTriggers(msrest.serialization.Model):
    ...
    :param requests: Trigger based on total requests.
    ...
    :param slow_requests: Trigger based on request execution time.
...
class BackupRequest(ProxyOnlyResource):
    ...
    :param backup_schedule: Description of a backup schedule. Describes how often should be the
...
class Certificate(Resource):
    ...
    :ivar hosting_environment_profile: Specification for an App Service Environment to use for this
     resource.
...
directories as per ICANN requirements.
    ...
    :param address_mailing: Address information for domain registration.
...
class CustomHostnameAnalysisResult(ProxyOnlyResource):
    ...
    :ivar custom_domain_verification_failure_info: Body of the error response returned from the
     API.
...
class DetectorResponse(ProxyOnlyResource):
    ...
    :ivar type: Resource type.
    :vartype type: str
    :param metadata: Definition of Detector.
...
class DiagnosticData(msrest.serialization.Model):
    ...
    :param table: Data Table which defines columns and raw row values.
    :type table: ~azure.mgmt.web.v2018_02_01.models.DataTableResponseObject
    :param rendering_properties: Instructions for rendering the data.
...
class Domain(Resource):
    ...
    :param tags: A set of tags. Resource tags.
    :type tags: dict[str, str]
    :param contact_admin: Contact information for domain registration. If 'Domain Privacy' option
     is not selected then the contact information is made publicly available through the Whois
     directories as per ICANN requirements.
    :type contact_admin: ~azure.mgmt.web.v2018_02_01.models.Contact
    :param contact_billing: Contact information for domain registration. If 'Domain Privacy' option
     is not selected then the contact information is made publicly available through the Whois
     directories as per ICANN requirements.
    :type contact_billing: ~azure.mgmt.web.v2018_02_01.models.Contact
    :param contact_registrant: Contact information for domain registration. If 'Domain Privacy'
     option is not selected then the contact information is made publicly available through the
     Whois
     directories as per ICANN requirements.
    :type contact_registrant: ~azure.mgmt.web.v2018_02_01.models.Contact
    :param contact_tech: Contact information for domain registration. If 'Domain Privacy' option is
     not selected then the contact information is made publicly available through the Whois
     directories as per ICANN requirements.
    ...
    :param consent: Domain purchase consent object, representing acceptance of applicable legal
     agreements.
    ...
    :param target_dns_type: Current DNS type. Possible values include: 'AzureDns',
     'DefaultDomainRegistrarDns'.
...
class DomainPatchResourceProperties(msrest.serialization.Model):
    ...
    :param contact_admin: Required. Contact information for domain registration. If 'Domain
     Privacy' option is not selected then the contact information is made publicly available through
     the Whois
     directories as per ICANN requirements.
    :type contact_admin: ~azure.mgmt.web.v2018_02_01.models.Contact
    :param contact_billing: Required. Contact information for domain registration. If 'Domain
     Privacy' option is not selected then the contact information is made publicly available through
     the Whois
     directories as per ICANN requirements.
    :type contact_billing: ~azure.mgmt.web.v2018_02_01.models.Contact
    :param contact_registrant: Required. Contact information for domain registration. If 'Domain
     Privacy' option is not selected then the contact information is made publicly available through
     the Whois
     directories as per ICANN requirements.
    :type contact_registrant: ~azure.mgmt.web.v2018_02_01.models.Contact
    :param contact_tech: Required. Contact information for domain registration. If 'Domain Privacy'
     option is not selected then the contact information is made publicly available through the
     Whois
     directories as per ICANN requirements.
    :type contact_tech: ~azure.mgmt.web.v2018_02_01.models.Contact
    ...
    :ivar managed_host_names: All hostnames derived from the domain and assigned to Azure
     resources.
    :vartype managed_host_names: list[~azure.mgmt.web.v2018_02_01.models.HostName]
    :param consent: Required. Domain purchase consent object, representing acceptance of applicable
     legal agreements.
    :type consent: ~azure.mgmt.web.v2018_02_01.models.DomainPurchaseConsent
    :ivar domain_not_renewable_reasons: Reasons why domain is not renewable.
    :vartype domain_not_renewable_reasons: list[str or
...
class GlobalCsmSkuDescription(msrest.serialization.Model):
    ...
    :type family: str
    :param capacity: Description of the App Service plan scale options.
...
class MigrateMySqlStatus(ProxyOnlyResource):
    ...
    :ivar type: Resource type.
    :vartype type: str
    :ivar migration_operation_status: The current status of the operation. Possible values include:
...
class NetworkFeatures(ProxyOnlyResource):
    ...
    :ivar virtual_network_connection: Virtual Network information contract.
...
class ProcessThreadInfoProperties(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'priviledged_processor_time': {'key': 'priviledged_processor_time', 'type': 'str'},
        'state': {'key': 'state', 'type': 'str'},
...
class ResourceMetric(msrest.serialization.Model):
    ...
    :ivar name: Name of a metric for any resource .
...
class ResponseMetaData(msrest.serialization.Model):
    ...
    :param data_source: Class representing data source used by the detectors.
...
class Site(Resource):
    ...
    :param site_config: Configuration of an App Service app.
    ...
    :param cloning_info: Information needed for cloning operation.
    ...
    :ivar slot_swap_status: The status of the last successful slot swap operation.
...
class SiteConfig(msrest.serialization.Model):
    ...
    :ivar machine_key: MachineKey of an app.
    ...
    :param experiments: Routing rules in production experiments.
    :type experiments: ~azure.mgmt.web.v2018_02_01.models.Experiments
    :param limits: Metric limits set on an app.
    ...
    :param auto_heal_rules: Rules that can be defined for auto-heal.
    ...
    :type vnet_name: str
    :param cors: Cross-Origin Resource Sharing (CORS) settings for the app.
    :type cors: ~azure.mgmt.web.v2018_02_01.models.CorsSettings
    :param push: Push settings for the App.
...
class SiteLogsConfig(ProxyOnlyResource):
    ...
    :param failed_requests_tracing: Enabled configuration.
    :type failed_requests_tracing: ~azure.mgmt.web.v2018_02_01.models.EnabledConfig
    :param detailed_error_messages: Enabled configuration.
...
class SitePatchResourceProperties(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'geo_distributions': {'key': 'geoDistributions', 'type': '[GeoDistribution]'},
    }
...
class SkuDescription(msrest.serialization.Model):
    ...
    :type capacity: int
    :param sku_capacity: Description of the App Service plan scale options.
...
class SnapshotRestoreRequest(ProxyOnlyResource):
    ...
    :param snapshot_time: Point in time in which the app restore should be done, formatted as a
     DateTime string.
    :type snapshot_time: str
    :param recovery_source: Specifies the web app that snapshot contents will be retrieved from.
...
class TriggeredWebJob(ProxyOnlyResource):
    ...
    :ivar type: Resource type.
    :vartype type: str
    :param latest_run: Triggered Web Job Run Information.
...
class ValidateResponse(msrest.serialization.Model):
    ...
    :type status: str
    :param error: Error details for when validation fails.
