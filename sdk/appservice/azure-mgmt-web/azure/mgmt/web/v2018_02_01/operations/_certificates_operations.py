...
class CertificatesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.Certificate"]:
        """Get all certificates for a subscription.

        Get all certificates for a subscription.

        :return: An iterator like instance of either Certificate or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2018_02_01.models.Certificate]
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type certificate_envelope: ~azure.mgmt.web.v2018_02_01.models.Certificate
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type certificate_envelope: ~azure.mgmt.web.v2018_02_01.models.Certificate or IO[bytes]
        :return: Certificate or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2018_02_01.models.Certificate
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type name: str
        :param certificate_envelope: Details of certificate, if it exists already. Required.
        :type certificate_envelope: ~azure.mgmt.web.v2018_02_01.models.CertificatePatchResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Certificate or the result of cls(response)
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type certificate_envelope: ~azure.mgmt.web.v2018_02_01.models.CertificatePatchResource or
         IO[bytes]
        :return: Certificate or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2018_02_01.models.Certificate
        :raises ~azure.core.exceptions.HttpResponseError:
