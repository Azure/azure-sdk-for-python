...
def build_get_available_stacks_request(
    *, os_type_selected: Optional[Union[str, _models.Enum3]] = None, **kwargs: Any
) -> HttpRequest:
...
def build_get_available_stacks_on_prem_request(
    subscription_id: str, *, os_type_selected: Optional[Union[str, _models.Enum4]] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ProviderOperations:
    ...
    def get_available_stacks(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2018_02_01.models.ApplicationStack]
