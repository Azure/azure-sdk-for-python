...
def build_validate_container_settings_request(  # pylint: disable=name-too-long
...
class WebSiteManagementClientOperationsMixin(
    ...
    def get_publishing_user(self, **kwargs: Any) -> _models.User:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("get_publishing_user") or "2018-02-01")
        )
    ...
    def update_publishing_user(self, user_details: Union[_models.User, IO[bytes]], **kwargs: Any) -> _models.User:
        ...
        :param user_details: Details of publishing user. Is either a User type or a IO[bytes] type.
         Required.
        :type user_details: ~azure.mgmt.web.v2018_02_01.models.User or IO[bytes]
        :return: User or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2018_02_01.models.User
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("update_publishing_user") or "2018-02-01")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.User] = kwargs.pop("cls", None)
    ...
    def list_source_controls(self, **kwargs: Any) -> ItemPaged["_models.SourceControl"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2018_02_01.models.SourceControl]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_source_controls") or "2018-02-01")
        )
    ...
    def get_source_control(self, source_control_type: str, **kwargs: Any) -> _models.SourceControl:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("get_source_control") or "2018-02-01")
        )
    ...
    def update_source_control(
        ...
        :type request_message: ~azure.mgmt.web.v2018_02_01.models.SourceControl or IO[bytes]
        :return: SourceControl or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2018_02_01.models.SourceControl
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("update_source_control") or "2018-02-01")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.SourceControl] = kwargs.pop("cls", None)
    ...
    def list_billing_meters(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2018_02_01.models.BillingMeter]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_billing_meters") or "2018-02-01")
        )
    ...
    def check_name_availability(
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("check_name_availability") or "2018-02-01")
        )
    ...
    def get_subscription_deployment_locations(self, **kwargs: Any) -> _models.DeploymentLocations:
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("get_subscription_deployment_locations") or "2018-02-01"),
        )
    ...
    def list_geo_regions(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2018_02_01.models.GeoRegion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_geo_regions") or "2018-02-01")
        )
    ...
    def list_site_identifiers_assigned_to_host_name(  # pylint: disable=name-too-long
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop(
                "api-version", self._api_version("list_site_identifiers_assigned_to_host_name") or "2018-02-01"
            ),
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    def list_premier_add_on_offers(self, **kwargs: Any) -> ItemPaged["_models.PremierAddOnOffer"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2018_02_01.models.PremierAddOnOffer]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_premier_add_on_offers") or "2018-02-01")
        )
    ...
    def list_skus(self, **kwargs: Any) -> _models.SkuInfos:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_skus") or "2018-02-01")
        )
    ...
    def verify_hosting_environment_vnet(
        ...
        :param parameters: VNET information. Is either a VnetParameters type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.web.v2018_02_01.models.VnetParameters or IO[bytes]
        :return: VnetValidationFailureDetails or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2018_02_01.models.VnetValidationFailureDetails
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("verify_hosting_environment_vnet") or "2018-02-01"),
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    def move(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type move_resource_envelope: ~azure.mgmt.web.v2018_02_01.models.CsmMoveResourceEnvelope or
         IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("move") or "2018-02-01")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    def validate(
        ...
        :type validate_request: ~azure.mgmt.web.v2018_02_01.models.ValidateRequest or IO[bytes]
        :return: ValidateResponse or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2018_02_01.models.ValidateResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("validate") or "2018-02-01")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    def validate_container_settings(
        self,
        resource_group_name: str,
        validate_container_settings_request: IO[bytes],
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> JSON:
        ...
        :type resource_group_name: str
        :param validate_container_settings_request: Required.
        :type validate_container_settings_request: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: JSON or the result of cls(response)
    ...
    def validate_container_settings(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("validate_container_settings") or "2018-02-01")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        ...
        _json = None
        _content = None
        if isinstance(validate_container_settings_request, (IOBase, bytes)):
        ...
        _request = build_validate_container_settings_request(
            resource_group_name=resource_group_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            content_type=content_type,
    ...
    def validate_move(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("validate_move") or "2018-02-01")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[None] = kwargs.pop("cls", None)
