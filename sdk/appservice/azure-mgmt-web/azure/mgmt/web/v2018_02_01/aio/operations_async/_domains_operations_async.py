...
class DomainsOperations:
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.DomainPaged(
    ...
    def list_recommendations(
        ...
        if raw:
            header_dict = {}
        deserialized = models.NameIdentifierPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def create_or_update(
        ...
        :return: An instance of Domain or ClientRawResponse<Domain> if
         raw==True
        :rtype: ~~azure.mgmt.web.v2018_02_01.models.Domain or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.web.v2018_02_01.models.Domain]
        :raises:
         :class:`DefaultErrorResponseException<azure.mgmt.web.v2018_02_01.models.DefaultErrorResponseException>`
        """
    ...
    def list_ownership_identifiers(
        ...
        if raw:
            header_dict = {}
        deserialized = models.DomainOwnershipIdentifierPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
