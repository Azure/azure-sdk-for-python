...
class ProviderOperations:
    ...
    ) -> AsyncItemPaged["_models.ApplicationStack"]:
        """Get available application frameworks and their versions.

        Get available application frameworks and their versions.

        :param os_type_selected: Known values are: "Windows", "Linux", "WindowsFunctions", and
         "LinuxFunctions". Default value is None.
        :type os_type_selected: str or ~azure.mgmt.web.v2018_02_01.models.Enum3
        :return: An iterator like instance of either ApplicationStack or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2018_02_01.models.ApplicationStack]
    ...
    def list_operations(self, **kwargs: Any) -> AsyncItemPaged["_models.CsmOperationDescription"]:
        ...
        :return: An iterator like instance of either CsmOperationDescription or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2018_02_01.models.CsmOperationDescription]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get_available_stacks_on_prem(
        self, os_type_selected: Optional[Union[str, _models.Enum4]] = None, **kwargs: Any
    ) -> AsyncItemPaged["_models.ApplicationStack"]:
        """Get available application frameworks and their versions.
