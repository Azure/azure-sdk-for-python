...
class AppServiceEnvironmentsOperations:
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.AppServiceEnvironmentResourcePaged(
    ...
    async def create_or_update(
        ...
        :rtype:
         ~~azure.mgmt.web.v2018_02_01.models.AppServiceEnvironmentResource or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.web.v2018_02_01.models.AppServiceEnvironmentResource]
    ...
    def list_capacities(
        ...
        if raw:
            header_dict = {}
        deserialized = models.StampCapacityPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def change_vnet(
        ...
        :rtype: ~~azure.mgmt.web.v2018_02_01.models.WebAppCollection or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.web.v2018_02_01.models.WebAppCollection]
        :raises:
         :class:`DefaultErrorResponseException<azure.mgmt.web.v2018_02_01.models.DefaultErrorResponseException>`
        """
    ...
    def get_inbound_network_dependencies_endpoints(
        ...
        if raw:
            header_dict = {}
        deserialized = models.InboundEnvironmentEndpointPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    def list_multi_role_pools(
        ...
        if raw:
            header_dict = {}
        deserialized = models.WorkerPoolResourcePaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def create_or_update_multi_role_pool(
        ...
        :rtype: ~~azure.mgmt.web.v2018_02_01.models.WorkerPoolResource or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.web.v2018_02_01.models.WorkerPoolResource]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_multi_role_pool_skus(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SkuInfoPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    def get_outbound_network_dependencies_endpoints(
        ...
        if raw:
            header_dict = {}
        deserialized = models.OutboundEnvironmentEndpointPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
