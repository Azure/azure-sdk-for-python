...
class AppServiceEnvironmentsOperations:
    ...
    async def _change_vnet_initial(
        ...
        **kwargs
        ...
        # Construct URL
        url = self._change_vnet_initial.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+[^\.]$'),
            'name': self._serialize.url("name", name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_vnet_info, 'VirtualNetworkProfile')
        body_content_kwargs['content'] = body_content
    ...
    def get_inbound_network_dependencies_endpoints(
        ...
        **kwargs
        ...
        :type name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: InboundEnvironmentEndpointCollection or the result of cls(response)
    ...
    def get_outbound_network_dependencies_endpoints(
        ...
        **kwargs
        ...
        :type name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: OutboundEnvironmentEndpointCollection or the result of cls(response)
