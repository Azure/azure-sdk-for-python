...
from ...operations._app_service_plans_operations import (
    ...
    build_list_metric_defintions_request,
...
class AppServicePlansOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_hybrid_connections(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2018_02_01.models.HybridConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_metrics(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.ResourceMetric"]:
