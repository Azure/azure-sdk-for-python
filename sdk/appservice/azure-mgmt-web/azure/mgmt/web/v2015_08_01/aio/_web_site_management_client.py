...
class WebSiteManagementClient(object):
    ...
    :vartype app_service_certificate_orders: azure.mgmt.web.v2015_08_01.aio.operations.AppServiceCertificateOrdersOperations
    :ivar certificate_registration_provider: CertificateRegistrationProviderOperations operations
    :vartype certificate_registration_provider: azure.mgmt.web.v2015_08_01.aio.operations.CertificateRegistrationProviderOperations
