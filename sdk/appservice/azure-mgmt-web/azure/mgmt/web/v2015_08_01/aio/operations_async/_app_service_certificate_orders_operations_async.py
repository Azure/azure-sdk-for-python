...
class AppServiceCertificateOrdersOperations:
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.AppServiceCertificateOrderPaged(
    ...
    async def create_or_update(
        ...
        :return: An instance of AppServiceCertificateOrder or
         ClientRawResponse<AppServiceCertificateOrder> if raw==True
        :rtype: ~~azure.mgmt.web.v2015_08_01.models.AppServiceCertificateOrder
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.web.v2015_08_01.models.AppServiceCertificateOrder]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_certificates(
        ...
        if raw:
            header_dict = {}
        deserialized = models.AppServiceCertificateResourcePaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def create_or_update_certificate(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of AppServiceCertificateResource or
         ClientRawResponse<AppServiceCertificateResource> if raw==True
        :rtype:
         ~~azure.mgmt.web.v2015_08_01.models.AppServiceCertificateResource or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.web.v2015_08_01.models.AppServiceCertificateResource]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
