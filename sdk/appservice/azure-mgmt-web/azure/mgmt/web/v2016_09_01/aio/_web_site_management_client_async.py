...
class WebSiteManagementClient(object):
    ...
    :vartype app_service_environments: azure.mgmt.web.v2016_09_01.aio.operations_async.AppServiceEnvironmentsOperations
    :ivar app_service_plans: AppServicePlansOperations operations
    :vartype app_service_plans: azure.mgmt.web.v2016_09_01.aio.operations_async.AppServicePlansOperations
