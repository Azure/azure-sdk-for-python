...
from ...operations._app_service_environments_operations import build_create_or_update_multi_role_pool_request_initial, build_create_or_update_request_initial, build_create_or_update_worker_pool_request_initial, build_delete_request_initial, build_get_diagnostics_item_request, build_get_multi_role_pool_request, build_get_request, build_get_worker_pool_request, build_list_app_service_plans_request, build_list_by_resource_group_request, build_list_capacities_request, build_list_diagnostics_request, build_list_metric_definitions_request, build_list_metrics_request, build_list_multi_role_metric_definitions_request, build_list_multi_role_metrics_request, build_list_multi_role_pool_instance_metric_definitions_request, build_list_multi_role_pool_instance_metrics_request, build_list_multi_role_pool_skus_request, build_list_multi_role_pools_request, build_list_multi_role_usages_request, build_list_operations_request, build_list_request, build_list_usages_request, build_list_vips_request, build_list_web_apps_request, build_list_web_worker_metric_definitions_request, build_list_web_worker_metrics_request, build_list_web_worker_usages_request, build_list_worker_pool_instance_metric_definitions_request, build_list_worker_pool_instance_metrics_request, build_list_worker_pool_skus_request, build_list_worker_pools_request, build_reboot_request, build_resume_request_initial, build_suspend_request_initial, build_update_multi_role_pool_request, build_update_request, build_update_worker_pool_request
T = TypeVar('T')
...
class AppServiceEnvironmentsOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.web.v2016_09_01.aio.WebSiteManagementClient`'s
    ...
    async def begin_resume(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2016_09_01.models.WebAppCollection]]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
