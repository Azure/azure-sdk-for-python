...
class AppServiceEnvironmentsOperations:  # pylint: disable=too-many-public-methods
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.AppServiceEnvironmentResource"]:
        ...
        :return: An iterator like instance of either AppServiceEnvironmentResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2016_09_01.models.AppServiceEnvironmentResource]
    ...
    def list_multi_role_pool_instance_metric_definitions(
        ...
        :return: An iterator like instance of either ResourceMetricDefinition or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2016_09_01.models.ResourceMetricDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_resume(
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2016_09_01.models.Site]]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
