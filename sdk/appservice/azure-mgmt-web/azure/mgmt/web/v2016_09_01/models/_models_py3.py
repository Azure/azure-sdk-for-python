...
class MetricDefinitionProperties(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'metric_availabilities': {'key': 'metricAvailabilities', 'type': '[MetricAvailabilily]'},
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(MetricDefinitionProperties, self).__init__(**kwargs)
        self.name = None
        self.unit = None
        self.primary_aggregation_type = None
        self.metric_availabilities = None
