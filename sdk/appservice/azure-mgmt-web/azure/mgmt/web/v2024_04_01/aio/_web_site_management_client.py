...
class WebSiteManagementClient(WebSiteManagementClientOperationsMixin):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype app_service_certificate_orders:
     azure.mgmt.web.v2024_04_01.aio.operations.AppServiceCertificateOrdersOperations
    ...
    :vartype certificate_orders_diagnostics:
     azure.mgmt.web.v2024_04_01.aio.operations.CertificateOrdersDiagnosticsOperations
    ...
    :vartype certificate_registration_provider:
     azure.mgmt.web.v2024_04_01.aio.operations.CertificateRegistrationProviderOperations
    :ivar domain_registration_provider: DomainRegistrationProviderOperations operations
    :vartype domain_registration_provider:
     azure.mgmt.web.v2024_04_01.aio.operations.DomainRegistrationProviderOperations
    :ivar domains: DomainsOperations operations
    :vartype domains: azure.mgmt.web.v2024_04_01.aio.operations.DomainsOperations
    :ivar top_level_domains: TopLevelDomainsOperations operations
    :vartype top_level_domains: azure.mgmt.web.v2024_04_01.aio.operations.TopLevelDomainsOperations
    :ivar app_service_environments: AppServiceEnvironmentsOperations operations
    :vartype app_service_environments:
     azure.mgmt.web.v2024_04_01.aio.operations.AppServiceEnvironmentsOperations
    :ivar app_service_plans: AppServicePlansOperations operations
    :vartype app_service_plans: azure.mgmt.web.v2024_04_01.aio.operations.AppServicePlansOperations
    :ivar certificates: CertificatesOperations operations
    :vartype certificates: azure.mgmt.web.v2024_04_01.aio.operations.CertificatesOperations
    :ivar container_apps: ContainerAppsOperations operations
    :vartype container_apps: azure.mgmt.web.v2024_04_01.aio.operations.ContainerAppsOperations
    :ivar container_apps_revisions: ContainerAppsRevisionsOperations operations
    :vartype container_apps_revisions:
     azure.mgmt.web.v2024_04_01.aio.operations.ContainerAppsRevisionsOperations
    :ivar deleted_web_apps: DeletedWebAppsOperations operations
    :vartype deleted_web_apps: azure.mgmt.web.v2024_04_01.aio.operations.DeletedWebAppsOperations
    :ivar diagnostics: DiagnosticsOperations operations
    :vartype diagnostics: azure.mgmt.web.v2024_04_01.aio.operations.DiagnosticsOperations
    :ivar global_operations: GlobalOperations operations
    :vartype global_operations: azure.mgmt.web.v2024_04_01.aio.operations.GlobalOperations
    :ivar kube_environments: KubeEnvironmentsOperations operations
    :vartype kube_environments:
     azure.mgmt.web.v2024_04_01.aio.operations.KubeEnvironmentsOperations
    :ivar provider: ProviderOperations operations
    :vartype provider: azure.mgmt.web.v2024_04_01.aio.operations.ProviderOperations
    :ivar recommendations: RecommendationsOperations operations
    :vartype recommendations: azure.mgmt.web.v2024_04_01.aio.operations.RecommendationsOperations
    :ivar resource_health_metadata: ResourceHealthMetadataOperations operations
    :vartype resource_health_metadata:
     azure.mgmt.web.v2024_04_01.aio.operations.ResourceHealthMetadataOperations
    :ivar get_usages_in_location: GetUsagesInLocationOperations operations
    :vartype get_usages_in_location:
     azure.mgmt.web.v2024_04_01.aio.operations.GetUsagesInLocationOperations
    :ivar static_sites: StaticSitesOperations operations
    :vartype static_sites: azure.mgmt.web.v2024_04_01.aio.operations.StaticSitesOperations
    :ivar web_apps: WebAppsOperations operations
    :vartype web_apps: azure.mgmt.web.v2024_04_01.aio.operations.WebAppsOperations
    :ivar workflows: WorkflowsOperations operations
    :vartype workflows: azure.mgmt.web.v2024_04_01.aio.operations.WorkflowsOperations
    :ivar workflow_runs: WorkflowRunsOperations operations
    :vartype workflow_runs: azure.mgmt.web.v2024_04_01.aio.operations.WorkflowRunsOperations
    :ivar workflow_run_actions: WorkflowRunActionsOperations operations
    :vartype workflow_run_actions:
     azure.mgmt.web.v2024_04_01.aio.operations.WorkflowRunActionsOperations
    ...
    :vartype workflow_run_action_repetitions:
     azure.mgmt.web.v2024_04_01.aio.operations.WorkflowRunActionRepetitionsOperations
    ...
    :vartype workflow_run_action_repetitions_request_histories:
     azure.mgmt.web.v2024_04_01.aio.operations.WorkflowRunActionRepetitionsRequestHistoriesOperations
    ...
    :vartype workflow_run_action_scope_repetitions:
     azure.mgmt.web.v2024_04_01.aio.operations.WorkflowRunActionScopeRepetitionsOperations
    :ivar workflow_triggers: WorkflowTriggersOperations operations
    :vartype workflow_triggers:
     azure.mgmt.web.v2024_04_01.aio.operations.WorkflowTriggersOperations
    :ivar workflow_trigger_histories: WorkflowTriggerHistoriesOperations operations
    :vartype workflow_trigger_histories:
     azure.mgmt.web.v2024_04_01.aio.operations.WorkflowTriggerHistoriesOperations
    :ivar workflow_versions: WorkflowVersionsOperations operations
    :vartype workflow_versions:
     azure.mgmt.web.v2024_04_01.aio.operations.WorkflowVersionsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.domains = DomainsOperations(self._client, self._config, self._serialize, self._deserialize, "2024-04-01")
        ...
        self.provider = ProviderOperations(self._client, self._config, self._serialize, self._deserialize, "2024-04-01")
        ...
        self.web_apps = WebAppsOperations(self._client, self._config, self._serialize, self._deserialize, "2024-04-01")
