...
class ContainerAppsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.ContainerApp"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2024_04_01.models.ContainerApp]
    ...
    async def get(self, resource_group_name: str, name: str, **kwargs: Any) -> _models.ContainerApp:
        ...
        :rtype: ~azure.mgmt.web.v2024_04_01.models.ContainerApp
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type container_app_envelope: ~azure.mgmt.web.v2024_04_01.models.ContainerApp
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either ContainerApp or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.web.v2024_04_01.models.ContainerApp]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type container_app_envelope: ~azure.mgmt.web.v2024_04_01.models.ContainerApp or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ContainerApp or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.web.v2024_04_01.models.ContainerApp]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def list_secrets(self, name: str, **kwargs: Any) -> _models.SecretsCollection:
        ...
        :rtype: ~azure.mgmt.web.v2024_04_01.models.SecretsCollection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
