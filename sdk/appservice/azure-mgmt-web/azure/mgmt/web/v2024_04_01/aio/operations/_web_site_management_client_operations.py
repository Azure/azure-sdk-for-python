...
class WebSiteManagementClientOperationsMixin(WebSiteManagementClientMixinABC):
    ...
    async def get_publishing_user(self, **kwargs: Any) -> _models.User:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("get_publishing_user") or "2024-04-01")
        )
    ...
    async def update_publishing_user(
        ...
        :type user_details: ~azure.mgmt.web.v2024_04_01.models.User
    ...
    async def update_publishing_user(self, user_details: Union[_models.User, IO[bytes]], **kwargs: Any) -> _models.User:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("update_publishing_user") or "2024-04-01")
        )
    ...
    def list_source_controls(self, **kwargs: Any) -> AsyncIterable["_models.SourceControl"]:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_source_controls") or "2024-04-01")
        )
    ...
    async def get_source_control(self, source_control_type: str, **kwargs: Any) -> _models.SourceControl:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("get_source_control") or "2024-04-01")
        )
    ...
    async def update_source_control(
        ...
        **kwargs: Any
        ...
        :type request_message: ~azure.mgmt.web.v2024_04_01.models.SourceControl
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: SourceControl or the result of cls(response)
    ...
    async def update_source_control(
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("update_source_control") or "2024-04-01")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.SourceControl] = kwargs.pop("cls", None)
    ...
    def list_billing_meters(
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_billing_meters") or "2024-04-01")
        )
    ...
    async def check_name_availability(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("check_name_availability") or "2024-04-01")
        )
    ...
    def list_custom_host_name_sites(
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_custom_host_name_sites") or "2024-04-01")
        )
    ...
    async def get_subscription_deployment_locations(self, **kwargs: Any) -> _models.DeploymentLocations:
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("get_subscription_deployment_locations") or "2024-04-01"),
        )
    ...
    def list_ase_regions(self, **kwargs: Any) -> AsyncIterable["_models.AseRegion"]:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_ase_regions") or "2024-04-01")
        )
    ...
    def list_geo_regions(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_geo_regions") or "2024-04-01")
        )
    ...
    def list_site_identifiers_assigned_to_host_name(  # pylint: disable=name-too-long
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop(
                "api-version", self._api_version("list_site_identifiers_assigned_to_host_name") or "2024-04-01"
            ),
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    def list_premier_add_on_offers(self, **kwargs: Any) -> AsyncIterable["_models.PremierAddOnOffer"]:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_premier_add_on_offers") or "2024-04-01")
        )
    ...
    async def list_skus(self, **kwargs: Any) -> _models.SkuInfos:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_skus") or "2024-04-01")
        )
    ...
    async def verify_hosting_environment_vnet(
        ...
        :type parameters: ~azure.mgmt.web.v2024_04_01.models.VnetParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    async def verify_hosting_environment_vnet(
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("verify_hosting_environment_vnet") or "2024-04-01"),
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    async def move(
        ...
        **kwargs: Any
        ...
        :type move_resource_envelope: ~azure.mgmt.web.v2024_04_01.models.CsmMoveResourceEnvelope
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    async def move(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("move") or "2024-04-01")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    async def validate(
        ...
        **kwargs: Any
        ...
        :type validate_request: ~azure.mgmt.web.v2024_04_01.models.ValidateRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    async def validate(
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("validate") or "2024-04-01")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    async def validate_move(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("validate_move") or "2024-04-01")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[None] = kwargs.pop("cls", None)
