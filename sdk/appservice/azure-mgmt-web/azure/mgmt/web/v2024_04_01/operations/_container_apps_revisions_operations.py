...
def build_get_revision_request(
    resource_group_name: str, container_app_name: str, name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ContainerAppsRevisionsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.web.v2024_04_01.WebSiteManagementClient`'s
    ...
    def list_revisions(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2024_04_01.models.Revision]
    ...
    def get_revision(
        ...
        :rtype: ~azure.mgmt.web.v2024_04_01.models.Revision
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
