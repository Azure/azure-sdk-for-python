...
class AppServiceCertificateOrdersOperations:  # pylint: disable=too-many-public-methods
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.AppServiceCertificateOrder"]:
        ...
        :return: An iterator like instance of either AppServiceCertificateOrder or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2021_01_15.models.AppServiceCertificateOrder]
    ...
    async def validate_purchase_information(  # pylint: disable=inconsistent-return-statements
        ...
        :type app_service_certificate_order:
         ~azure.mgmt.web.v2021_01_15.models.AppServiceCertificateOrder or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type certificate_distinguished_name:
         ~azure.mgmt.web.v2021_01_15.models.AppServiceCertificateOrderPatchResource or IO[bytes]
        :return: AppServiceCertificateOrder or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_01_15.models.AppServiceCertificateOrder
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_certificates(
        ...
        :return: An iterator like instance of either AppServiceCertificateResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2021_01_15.models.AppServiceCertificateResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def update_certificate(
        ...
        **kwargs: Any
        ...
        :type key_vault_certificate:
         ~azure.mgmt.web.v2021_01_15.models.AppServiceCertificatePatchResource or IO[bytes]
        :return: AppServiceCertificateResource or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_01_15.models.AppServiceCertificateResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def reissue(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type reissue_certificate_order_request:
         ~azure.mgmt.web.v2021_01_15.models.ReissueCertificateOrderRequest or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def renew(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type renew_certificate_order_request:
         ~azure.mgmt.web.v2021_01_15.models.RenewCertificateOrderRequest or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def resend_request_emails(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param name_identifier: Email address. Is either a NameIdentifier type or a IO[bytes] type.
         Required.
        :type name_identifier: ~azure.mgmt.web.v2021_01_15.models.NameIdentifier or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def retrieve_site_seal(
        ...
        **kwargs: Any
        ...
        :param site_seal_request: Site seal request. Is either a SiteSealRequest type or a IO[bytes]
         type. Required.
        :type site_seal_request: ~azure.mgmt.web.v2021_01_15.models.SiteSealRequest or IO[bytes]
        :return: SiteSeal or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_01_15.models.SiteSeal
        :raises ~azure.core.exceptions.HttpResponseError:
        """
