...
from ...operations._web_site_management_client_operations import (
    ...
    build_list_ase_regions_request,
...
class WebSiteManagementClientOperationsMixin(WebSiteManagementClientMixinABC):
    ...
    async def get_publishing_user(self, **kwargs: Any) -> _models.User:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("get_publishing_user") or "2023-01-01")
        )
    ...
    async def update_publishing_user(
        ...
        :type user_details: ~azure.mgmt.web.v2023_01_01.models.User
    ...
    async def update_publishing_user(self, user_details: Union[_models.User, IO], **kwargs: Any) -> _models.User:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("update_publishing_user") or "2023-01-01")
        )
    ...
    def list_source_controls(self, **kwargs: Any) -> AsyncIterable["_models.SourceControl"]:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_source_controls") or "2023-01-01")
        )
    ...
    async def get_source_control(self, source_control_type: str, **kwargs: Any) -> _models.SourceControl:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("get_source_control") or "2023-01-01")
        )
    ...
    async def update_source_control(
        ...
        **kwargs: Any
        ...
        :type request_message: ~azure.mgmt.web.v2023_01_01.models.SourceControl
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update_source_control(
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("update_source_control") or "2023-01-01")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.SourceControl] = kwargs.pop("cls", None)
    ...
    def list_billing_meters(
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_billing_meters") or "2023-01-01")
        )
    ...
    async def check_name_availability(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("check_name_availability") or "2023-01-01")
        )
    ...
    def list_custom_host_name_sites(
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_custom_host_name_sites") or "2023-01-01")
        )
    ...
    async def get_subscription_deployment_locations(self, **kwargs: Any) -> _models.DeploymentLocations:
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("get_subscription_deployment_locations") or "2023-01-01"),
        )
    ...
    def list_ase_regions(self, **kwargs: Any) -> AsyncIterable["_models.AseRegion"]:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_ase_regions") or "2023-01-01")
        )
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_ase_regions_request(
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
                    template_url=self.list_ase_regions.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
                request = _convert_request(request)
    ...
    list_ase_regions.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.Web/aseRegions"}
    ...
    def list_geo_regions(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_geo_regions") or "2023-01-01")
        )
    ...
    def list_site_identifiers_assigned_to_host_name(
        ...
        :type name_identifier: ~azure.mgmt.web.v2023_01_01.models.NameIdentifier
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_site_identifiers_assigned_to_host_name(
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop(
                "api-version", self._api_version("list_site_identifiers_assigned_to_host_name") or "2023-01-01"
            ),
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    def list_premier_add_on_offers(self, **kwargs: Any) -> AsyncIterable["_models.PremierAddOnOffer"]:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_premier_add_on_offers") or "2023-01-01")
        )
    ...
    async def list_skus(self, **kwargs: Any) -> _models.SkuInfos:
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("list_skus") or "2023-01-01")
        )
    ...
    async def verify_hosting_environment_vnet(
        ...
        :type parameters: ~azure.mgmt.web.v2023_01_01.models.VnetParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def verify_hosting_environment_vnet(
        ...
        api_version: str = kwargs.pop(
            "api_version",
            _params.pop("api-version", self._api_version("verify_hosting_environment_vnet") or "2023-01-01"),
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    async def move(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type move_resource_envelope: ~azure.mgmt.web.v2023_01_01.models.CsmMoveResourceEnvelope
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def move(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("move") or "2023-01-01")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    async def validate(
        ...
        **kwargs: Any
        ...
        :type validate_request: ~azure.mgmt.web.v2023_01_01.models.ValidateRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def validate(
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("validate") or "2023-01-01")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    async def validate_move(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop(
            "api_version", _params.pop("api-version", self._api_version("validate_move") or "2023-01-01")
        )
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[None] = kwargs.pop("cls", None)
