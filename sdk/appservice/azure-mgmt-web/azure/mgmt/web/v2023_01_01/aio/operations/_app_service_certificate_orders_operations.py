...
class AppServiceCertificateOrdersOperations:  # pylint: disable=too-many-public-methods
    ...
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.AppServiceCertificateOrder"]:
        ...
        :return: An iterator like instance of either AppServiceCertificateOrder or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2023_01_01.models.AppServiceCertificateOrder]
    ...
    async def validate_purchase_information(
        ...
        **kwargs: Any
        ...
        :type app_service_certificate_order:
         ~azure.mgmt.web.v2023_01_01.models.AppServiceCertificateOrder
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.web.v2023_01_01.models.AppServiceCertificateOrder]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param certificate_distinguished_name: Distinguished name to use for the certificate order.
         Required.
        :type certificate_distinguished_name:
         ~azure.mgmt.web.v2023_01_01.models.AppServiceCertificateOrderPatchResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: AppServiceCertificateOrder or the result of cls(response)
    ...
    def list_certificates(
        ...
        :return: An iterator like instance of either AppServiceCertificateResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2023_01_01.models.AppServiceCertificateResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_create_or_update_certificate(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either AppServiceCertificateResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.web.v2023_01_01.models.AppServiceCertificateResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update_certificate(
        ...
        **kwargs: Any
        ...
        :type key_vault_certificate:
         ~azure.mgmt.web.v2023_01_01.models.AppServiceCertificatePatchResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: AppServiceCertificateResource or the result of cls(response)
    ...
    async def reissue(
        ...
        **kwargs: Any
        ...
        :type reissue_certificate_order_request:
         ~azure.mgmt.web.v2023_01_01.models.ReissueCertificateOrderRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    async def renew(
        ...
        **kwargs: Any
        ...
        :type renew_certificate_order_request:
         ~azure.mgmt.web.v2023_01_01.models.RenewCertificateOrderRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    async def retrieve_site_seal(
        ...
        **kwargs: Any
        ...
        :type site_seal_request: ~azure.mgmt.web.v2023_01_01.models.SiteSealRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
