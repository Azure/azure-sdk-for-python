...
from ...operations._get_usages_in_location_operations import build_list_request
...
class GetUsagesInLocationOperations:
    ...
    @distributed_trace
    def list(self, location: str, **kwargs: Any) -> AsyncIterable["_models.CsmUsageQuota"]:
    ...
    list.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.Web/locations/{location}/usages"}
