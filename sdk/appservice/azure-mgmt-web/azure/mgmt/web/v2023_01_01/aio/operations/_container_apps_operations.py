...
class ContainerAppsOperations:
    ...
    async def get(self, resource_group_name: str, name: str, **kwargs: Any) -> _models.ContainerApp:
        ...
        deserialized = self._deserialize("ContainerApp", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param name: Name of the Container App. Required.
        :type name: str
        :param container_app_envelope: Is either a ContainerApp type or a IO[bytes] type. Required.
        :type container_app_envelope: ~azure.mgmt.web.v2023_01_01.models.ContainerApp or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ContainerApp or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.web.v2023_01_01.models.ContainerApp]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def list_secrets(self, name: str, **kwargs: Any) -> _models.SecretsCollection:
        ...
        deserialized = self._deserialize("SecretsCollection", pipeline_response.http_response)
