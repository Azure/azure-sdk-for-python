...
class AppServicePlansOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def list(self, detailed: Optional[bool] = None, **kwargs: Any) -> ItemPaged["_models.AppServicePlan"]:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.AppServicePlan"]:
