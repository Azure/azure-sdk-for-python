...
class DomainsOperations:
    ...
    def check_availability(
        ...
        :param identifier: Name of the domain. Is either a NameIdentifier type or a IO[bytes] type.
         Required.
        :type identifier: ~azure.mgmt.web.v2020_09_01.models.NameIdentifier or IO[bytes]
        :return: DomainAvailabilityCheckResult or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2020_09_01.models.DomainAvailabilityCheckResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.Domain"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2020_09_01.models.Domain]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_recommendations(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2020_09_01.models.NameIdentifier]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_recommendations(
        ...
        :type parameters: ~azure.mgmt.web.v2020_09_01.models.DomainRecommendationSearchParameters or
         IO[bytes]
        :return: An iterator like instance of either NameIdentifier or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2020_09_01.models.NameIdentifier]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_create_or_update(
        ...
        :param domain: Domain registration information. Is either a Domain type or a IO[bytes] type.
         Required.
        :type domain: ~azure.mgmt.web.v2020_09_01.models.Domain or IO[bytes]
        :return: An instance of LROPoller that returns either Domain or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.v2020_09_01.models.Domain]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type domain: ~azure.mgmt.web.v2020_09_01.models.DomainPatchResource or IO[bytes]
        :return: Domain or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2020_09_01.models.Domain
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_ownership_identifiers(
        ...
        :return: An iterator like instance of either DomainOwnershipIdentifier or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2020_09_01.models.DomainOwnershipIdentifier]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
