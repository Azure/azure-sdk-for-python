...
class AppServiceCertificateOrdersOperations:  # pylint: disable=too-many-public-methods
    ...
    def validate_purchase_information(  # pylint: disable=inconsistent-return-statements
        ...
        :type app_service_certificate_order:
         ~azure.mgmt.web.v2020_09_01.models.AppServiceCertificateOrder or IO
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type certificate_distinguished_name:
         ~azure.mgmt.web.v2020_09_01.models.AppServiceCertificateOrderPatchResource or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update_certificate(
        ...
        **kwargs: Any
        ...
        :type key_vault_certificate:
         ~azure.mgmt.web.v2020_09_01.models.AppServiceCertificatePatchResource or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def reissue(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type reissue_certificate_order_request:
         ~azure.mgmt.web.v2020_09_01.models.ReissueCertificateOrderRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def renew(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type renew_certificate_order_request:
         ~azure.mgmt.web.v2020_09_01.models.RenewCertificateOrderRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def retrieve_site_seal(
        ...
        **kwargs: Any
        ...
        :param site_seal_request: Site seal request. Is either a SiteSealRequest type or a IO type.
         Required.
        :type site_seal_request: ~azure.mgmt.web.v2020_09_01.models.SiteSealRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
