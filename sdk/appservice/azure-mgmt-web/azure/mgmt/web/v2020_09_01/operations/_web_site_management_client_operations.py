...
def build_update_publishing_user_request(
    *,
    json: Optional[_models.User] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_list_geo_regions_request(
    ...
    **kwargs: Any
    ...
    if linux_dynamic_workers_enabled is not None:
        _params['linuxDynamicWorkersEnabled'] = _SERIALIZER.query("linux_dynamic_workers_enabled", linux_dynamic_workers_enabled, 'bool')
    _params['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
...
def build_verify_hosting_environment_vnet_request(
    subscription_id: str,
    *,
    json: Optional[_models.VnetParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_move_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.CsmMoveResourceEnvelope] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_validate_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ValidateRequest] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
