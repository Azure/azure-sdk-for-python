...
class WebSiteManagementClientOperationsMixin(object):
    ...
    def generate_github_access_token_for_appservice_cli_async(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.AppserviceGithubToken"
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.AppserviceGithubToken"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))

        _request = _models.AppserviceGithubTokenRequest(code=code, state=state)
        api_version = "2020-09-01"
        content_type = kwargs.pop("content_type", "application/json")
        accept = "application/json"

        # Construct URL
        url = self.generate_github_access_token_for_appservice_cli_async.metadata['url']  # type: ignore
        ...
        body_content = self._serialize.body(_request, 'AppserviceGithubTokenRequest')
        ...
        deserialized = self._deserialize('AppserviceGithubToken', pipeline_response)

        if cls:
            return cls(pipeline_response, deserialized, {})

        return deserialized
    generate_github_access_token_for_appservice_cli_async.metadata = {'url': '/providers/Microsoft.Web/generateGithubAccessTokenForAppserviceCLI'}  # type: ignore
