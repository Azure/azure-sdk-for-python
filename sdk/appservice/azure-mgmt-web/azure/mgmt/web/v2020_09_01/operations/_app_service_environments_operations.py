...
class AppServiceEnvironmentsOperations:  # pylint: disable=too-many-public-methods
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.AppServiceEnvironmentResource"]:
        ...
        :return: An iterator like instance of either AppServiceEnvironmentResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2020_09_01.models.AppServiceEnvironmentResource]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type hosting_environment_envelope:
         ~azure.mgmt.web.v2020_09_01.models.AppServiceEnvironmentResource or IO[bytes]
        :return: An instance of LROPoller that returns either AppServiceEnvironmentResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.web.v2020_09_01.models.AppServiceEnvironmentResource]
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type hosting_environment_envelope:
         ~azure.mgmt.web.v2020_09_01.models.AppServiceEnvironmentPatchResource or IO[bytes]
        :return: AppServiceEnvironmentResource or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2020_09_01.models.AppServiceEnvironmentResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_capacities(self, resource_group_name: str, name: str, **kwargs: Any) -> Iterable["_models.StampCapacity"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2020_09_01.models.StampCapacity]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_change_vnet(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.core.paging.ItemPaged[~azure.mgmt.web.v2020_09_01.models.Site]]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_change_vnet(
        ...
        **kwargs: Any
        ...
        :type vnet_info: ~azure.mgmt.web.v2020_09_01.models.VirtualNetworkProfile or IO[bytes]
        :return: An instance of LROPoller that returns an iterator like instance of either
         WebAppCollection or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.core.paging.ItemPaged[~azure.mgmt.web.v2020_09_01.models.Site]]
    ...
    def get_inbound_network_dependencies_endpoints(  # pylint: disable=name-too-long
        ...
        :return: An iterator like instance of either InboundEnvironmentEndpoint or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2020_09_01.models.InboundEnvironmentEndpoint]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_multi_role_pools(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2020_09_01.models.WorkerPoolResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_create_or_update_multi_role_pool(
        ...
        **kwargs: Any
        ...
        :type multi_role_pool_envelope: ~azure.mgmt.web.v2020_09_01.models.WorkerPoolResource or
         IO[bytes]
        :return: An instance of LROPoller that returns either WorkerPoolResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.v2020_09_01.models.WorkerPoolResource]
    ...
    def list_multi_role_pool_instance_metric_definitions(  # pylint: disable=name-too-long
        ...
        :return: An iterator like instance of either ResourceMetricDefinition or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2020_09_01.models.ResourceMetricDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_multi_role_pool_skus(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2020_09_01.models.SkuInfo]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_multi_role_usages(self, resource_group_name: str, name: str, **kwargs: Any) -> Iterable["_models.Usage"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2020_09_01.models.Usage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get_outbound_network_dependencies_endpoints(  # pylint: disable=name-too-long
        ...
        :return: An iterator like instance of either OutboundEnvironmentEndpoint or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.web.v2020_09_01.models.OutboundEnvironmentEndpoint]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_create_or_update_worker_pool(
        ...
        **kwargs: Any
        ...
        :param worker_pool_envelope: Properties of the worker pool. Is either a WorkerPoolResource type
         or a IO[bytes] type. Required.
        :type worker_pool_envelope: ~azure.mgmt.web.v2020_09_01.models.WorkerPoolResource or IO[bytes]
        :return: An instance of LROPoller that returns either WorkerPoolResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.v2020_09_01.models.WorkerPoolResource]
        :raises ~azure.core.exceptions.HttpResponseError:
