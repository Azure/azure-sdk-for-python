...
class MgmtWebSiteTest(AzureMgmtTestCase):
    ...
    def test_web_app_slot(self, resource_group):
        ...
        result = self.mgmt_client.app_service_plans.begin_create_or_update(
            resource_group_name=RESOURCE_GROUP, name=APP_SERVICE_PLAN_NAME, app_service_plan=BODY
        )
        ...
        BODY = {
            ...
            "site_config": {
                ...
                "app_settings": [{"name": "WEBSITE_NODE_DEFAULT_VERSION", "value": "10.14"}],
        ...
        result = self.mgmt_client.web_apps.begin_create_or_update(
            resource_group_name=RESOURCE_GROUP, name=NAME, site_envelope=BODY
        )
        ...
        BODY = {
            ...
            "properties": {
                ...
                "is_xenon": False,
                "hyper_v": False,
                "site_config": {"net_framework_version": "v4.6", "local_my_sql_enabled": False, "http20_enabled": True},
                "scm_site_also_stopped": False,
            },
        }
        result = self.mgmt_client.web_apps.begin_create_or_update_slot(
            resource_group_name=RESOURCE_GROUP, name=NAME, slot=SLOT_NAME, site_envelope=BODY
        )
        result = result.result()
        ...
        BODY = {
            "properties": {
                ...
                "virtual_applications": [
                    {"virtual_path": "/", "physical_path": "site\\wwwroot", "preload_enabled": True}
                ],
                "load_balancing": "LeastRequests",
                "experiments": {"ramp_up_rules": []},
        ...
        result = self.mgmt_client.web_apps.create_or_update_configuration_slot(
            resource_group_name=RESOURCE_GROUP, name=NAME, slot=SLOT_NAME, site_config=BODY
        )
        ...
        result = self.mgmt_client.web_apps.begin_create_or_update_source_control_slot(
            resource_group_name=RESOURCE_GROUP, name=NAME, slot=SLOT_NAME, site_source_control=BODY
        )
        result = result.result()
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.web_apps.get_configuration_slot(
            resource_group_name=RESOURCE_GROUP, name=NAME, slot=SLOT_NAME
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.web_apps.get_source_control_slot(
            resource_group_name=RESOURCE_GROUP, name=NAME, slot=SLOT_NAME
        )
        ...
        result = self.mgmt_client.web_apps.update_slot(
            resource_group_name=RESOURCE_GROUP, name=NAME, slot=SLOT_NAME, site_envelope=BODY
        )
        ...
        result = self.mgmt_client.web_apps.update_configuration_slot(
            resource_group_name=RESOURCE_GROUP, name=NAME, slot=SLOT_NAME, site_config=BODY
        )
        ...
        result = self.mgmt_client.web_apps.update_source_control_slot(
            resource_group_name=RESOURCE_GROUP, name=NAME, slot=SLOT_NAME, site_source_control=BODY
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.web_apps.delete_source_control_slot(
            resource_group_name=RESOURCE_GROUP, name=NAME, slot=SLOT_NAME
        )
    ...
    def test_web_app(self, resource_group):
        ...
        result = self.mgmt_client.web_apps.create_or_update_configuration(
            resource_group_name=RESOURCE_GROUP, name=NAME, site_config=BODY
        )
        ...
        result = self.mgmt_client.web_apps.begin_create_or_update_source_control(
            resource_group_name=RESOURCE_GROUP, name=NAME, site_source_control=BODY
        )
        result = result.result()
        ...
        result = self.mgmt_client.web_apps.update_configuration(
            resource_group_name=RESOURCE_GROUP, name=NAME, site_config=BODY
        )
        ...
        result = self.mgmt_client.web_apps.update_source_control(
            resource_group_name=RESOURCE_GROUP, name=NAME, site_source_control=BODY
        )
    ...
    def test_web_app_backup(self, resource_group):
        ...
        # --------------------------------------------------------------------------
        BODY = {"allow": True}
        result = self.mgmt_client.web_apps.update_scm_allowed(
            resource_group_name=RESOURCE_GROUP, name=NAME, csm_publishing_access_policies_entity=BODY
        )
        ...
        # --------------------------------------------------------------------------
        BODY = {"allow": True}
        result = self.mgmt_client.web_apps.update_ftp_allowed(
            resource_group_name=RESOURCE_GROUP, name=NAME, csm_publishing_access_policies_entity=BODY
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.web_apps.get_basic_publishing_credentials_policies(
        ...
        result = self.mgmt_client.web_apps.begin_copy_production_slot(
            resource_group_name=RESOURCE_GROUP, name=NAME, copy_slot_entity=BODY
        )
        result = result.result()
