...
class DynatraceObservabilityMgmtClient:
    ...
    :vartype monitored_subscriptions:
     azure.mgmt.dynatrace.operations.MonitoredSubscriptionsOperations
    ...
    :vartype creation_supported: azure.mgmt.dynatrace.operations.CreationSupportedOperations
