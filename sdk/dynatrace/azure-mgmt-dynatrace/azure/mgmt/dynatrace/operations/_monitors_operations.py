...
class MonitorsOperations:
    ...
    def get_account_credentials(
        ...
        cls: ClsType[_models.AccountInfoSecure] = kwargs.pop("cls", None)
    ...
    get_account_credentials.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Dynatrace.Observability/monitors/{monitorName}/getAccountCredentials"
    }
    ...
    def get_sso_details(
        ...
        **kwargs: Any
        ...
        :param monitor_name: Monitor resource name. Required.
        :type monitor_name: str
        :param request: The details of the get sso details request. Is either a model type or a IO
    ...
    def list_linkable_environments(
        ...
        **kwargs: Any
        ...
        :param monitor_name: Monitor resource name. Required.
        :type monitor_name: str
        :param request: The details of the linkable environment request. Is either a model type or a IO
         type. Required.
