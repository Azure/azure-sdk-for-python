...
class DynatraceObservability:  # pylint: disable=client-accepts-api-version-keyword
    """DynatraceObservability.

    :ivar monitors: MonitorsOperations operations
    :vartype monitors: azure.mgmt.dynatrace.aio.operations.MonitorsOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.dynatrace.aio.operations.Operations
    :ivar tag_rules: TagRulesOperations operations
    :vartype tag_rules: azure.mgmt.dynatrace.aio.operations.TagRulesOperations
    :ivar single_sign_on: SingleSignOnOperations operations
    :vartype single_sign_on: azure.mgmt.dynatrace.aio.operations.SingleSignOnOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = DynatraceObservabilityConfiguration(
    ...
    async def __aenter__(self) -> "DynatraceObservability":
