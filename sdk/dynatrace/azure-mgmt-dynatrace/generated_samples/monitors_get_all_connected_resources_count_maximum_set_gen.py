...
# USAGE
    python monitors_get_all_connected_resources_count_maximum_set_gen.py
...
def main():
    ...
    response = client.monitors.get_all_connected_resources_count(
        request={"marketplaceSubscriptionId": "00000000-0000-0000-0000-000005430000"},
    )
    print(response)
