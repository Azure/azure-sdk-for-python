...
class TestDynatraceObservabilityMgmtMonitorsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_monitors_manage_agent_installation(self, resource_group):
        response = await self.client.monitors.manage_agent_installation(
            resource_group_name=resource_group.name,
            monitor_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_monitors_begin_upgrade_plan(self, resource_group):
        response = await (
            await self.client.monitors.begin_upgrade_plan(
                resource_group_name=resource_group.name,
                monitor_name="str",
                request={
                    "planData": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_monitors_get_all_connected_resources_count(self, resource_group):
        response = await self.client.monitors.get_all_connected_resources_count(
