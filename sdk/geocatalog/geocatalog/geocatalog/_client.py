...
class AzureOrbitalPlanetaryComputerClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype source_data_types: geocatalog.operations.SourceDataTypesOperations
    :ivar ingestions: IngestionsOperations operations
    :vartype ingestions: geocatalog.operations.IngestionsOperations
    :ivar items: ItemsOperations operations
    :vartype items: geocatalog.operations.ItemsOperations
    :ivar operations: Operations operations
    :vartype operations: geocatalog.operations.Operations
    :ivar collection_operations: collectionOperationsOperations operations
    :vartype collection_operations: geocatalog.operations.collectionOperationsOperations
    :ivar container_operations: containerOperationsOperations operations
    :vartype container_operations: geocatalog.operations.containerOperationsOperations
    :ivar signed_operations: signedOperationsOperations operations
    :vartype signed_operations: geocatalog.operations.signedOperationsOperations
    :ivar landing_operations: LandingOperationsOperations operations
    :vartype landing_operations: geocatalog.operations.LandingOperationsOperations
    :ivar conformance_operations: ConformanceOperationsOperations operations
    :vartype conformance_operations: geocatalog.operations.ConformanceOperationsOperations
    :ivar get_operations: GetOperationsOperations operations
    :vartype get_operations: geocatalog.operations.GetOperationsOperations
    :ivar update_operations: UpdateOperationsOperations operations
    :vartype update_operations: geocatalog.operations.UpdateOperationsOperations
    :ivar delete_operations: DeleteOperationsOperations operations
    :vartype delete_operations: geocatalog.operations.DeleteOperationsOperations
    :ivar search_operations: SearchOperationsOperations operations
    :vartype search_operations: geocatalog.operations.SearchOperationsOperations
    :ivar create_operations: CreateOperationsOperations operations
    :vartype create_operations: geocatalog.operations.CreateOperationsOperations
    :ivar queryables_operations: QueryablesOperationsOperations operations
    :vartype queryables_operations: geocatalog.operations.QueryablesOperationsOperations
    :ivar collection_operations: CollectionOperationsOperations operations
    :vartype collection_operations: geocatalog.operations.CollectionOperationsOperations
    :ivar bounds_operations: boundsOperationsOperations operations
    :vartype bounds_operations: geocatalog.operations.boundsOperationsOperations
    :ivar info_operations: infoOperationsOperations operations
    :vartype info_operations: geocatalog.operations.infoOperationsOperations
    :ivar available_operations: availableOperationsOperations operations
    :vartype available_operations: geocatalog.operations.availableOperationsOperations
    :ivar asset_operations: assetOperationsOperations operations
    :vartype asset_operations: geocatalog.operations.assetOperationsOperations
    :ivar statistics_operations: statisticsOperationsOperations operations
    :vartype statistics_operations: geocatalog.operations.statisticsOperationsOperations
    :ivar geojson_operations: geojsonOperationsOperations operations
    :vartype geojson_operations: geocatalog.operations.geojsonOperationsOperations
    :ivar tile_operations: tileOperationsOperations operations
    :vartype tile_operations: geocatalog.operations.tileOperationsOperations
    :ivar tilejson_operations: tilejsonOperationsOperations operations
    :vartype tilejson_operations: geocatalog.operations.tilejsonOperationsOperations
    :ivar wmts_operations: wmtsOperationsOperations operations
    :vartype wmts_operations: geocatalog.operations.wmtsOperationsOperations
    :ivar point_operations: pointOperationsOperations operations
    :vartype point_operations: geocatalog.operations.pointOperationsOperations
    :ivar preview_operations: previewOperationsOperations operations
    :vartype preview_operations: geocatalog.operations.previewOperationsOperations
    :ivar part_operations: partOperationsOperations operations
    :vartype part_operations: geocatalog.operations.partOperationsOperations
    :ivar map_operations: mapOperationsOperations operations
    :vartype map_operations: geocatalog.operations.mapOperationsOperations
    :ivar register_operations: registerOperationsOperations operations
    :vartype register_operations: geocatalog.operations.registerOperationsOperations
    :ivar assets_operations: assetsOperationsOperations operations
    :vartype assets_operations: geocatalog.operations.assetsOperationsOperations
    :ivar mosaic_operations: mosaicOperationsOperations operations
    :vartype mosaic_operations: geocatalog.operations.mosaicOperationsOperations
    :ivar get_operations: getOperationsOperations operations
    :vartype get_operations: geocatalog.operations.getOperationsOperations
