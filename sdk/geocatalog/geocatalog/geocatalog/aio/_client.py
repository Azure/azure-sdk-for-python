...
class AzureOrbitalPlanetaryComputerClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype source_data_types: geocatalog.aio.operations.SourceDataTypesOperations
    :ivar ingestions: IngestionsOperations operations
    :vartype ingestions: geocatalog.aio.operations.IngestionsOperations
    :ivar items: ItemsOperations operations
    :vartype items: geocatalog.aio.operations.ItemsOperations
    :ivar operations: Operations operations
    :vartype operations: geocatalog.aio.operations.Operations
    :ivar collection_operations: collectionOperationsOperations operations
    :vartype collection_operations: geocatalog.aio.operations.collectionOperationsOperations
    :ivar container_operations: containerOperationsOperations operations
    :vartype container_operations: geocatalog.aio.operations.containerOperationsOperations
    :ivar signed_operations: signedOperationsOperations operations
    :vartype signed_operations: geocatalog.aio.operations.signedOperationsOperations
    :ivar landing_operations: LandingOperationsOperations operations
    :vartype landing_operations: geocatalog.aio.operations.LandingOperationsOperations
    :ivar conformance_operations: ConformanceOperationsOperations operations
    :vartype conformance_operations: geocatalog.aio.operations.ConformanceOperationsOperations
    :ivar get_operations: GetOperationsOperations operations
    :vartype get_operations: geocatalog.aio.operations.GetOperationsOperations
    :ivar update_operations: UpdateOperationsOperations operations
    :vartype update_operations: geocatalog.aio.operations.UpdateOperationsOperations
    :ivar delete_operations: DeleteOperationsOperations operations
    :vartype delete_operations: geocatalog.aio.operations.DeleteOperationsOperations
    :ivar search_operations: SearchOperationsOperations operations
    :vartype search_operations: geocatalog.aio.operations.SearchOperationsOperations
    :ivar create_operations: CreateOperationsOperations operations
    :vartype create_operations: geocatalog.aio.operations.CreateOperationsOperations
    :ivar queryables_operations: QueryablesOperationsOperations operations
    :vartype queryables_operations: geocatalog.aio.operations.QueryablesOperationsOperations
    :ivar collection_operations: CollectionOperationsOperations operations
    :vartype collection_operations: geocatalog.aio.operations.CollectionOperationsOperations
    :ivar bounds_operations: boundsOperationsOperations operations
    :vartype bounds_operations: geocatalog.aio.operations.boundsOperationsOperations
    :ivar info_operations: infoOperationsOperations operations
    :vartype info_operations: geocatalog.aio.operations.infoOperationsOperations
    :ivar available_operations: availableOperationsOperations operations
    :vartype available_operations: geocatalog.aio.operations.availableOperationsOperations
    :ivar asset_operations: assetOperationsOperations operations
    :vartype asset_operations: geocatalog.aio.operations.assetOperationsOperations
    :ivar statistics_operations: statisticsOperationsOperations operations
    :vartype statistics_operations: geocatalog.aio.operations.statisticsOperationsOperations
    :ivar geojson_operations: geojsonOperationsOperations operations
    :vartype geojson_operations: geocatalog.aio.operations.geojsonOperationsOperations
    :ivar tile_operations: tileOperationsOperations operations
    :vartype tile_operations: geocatalog.aio.operations.tileOperationsOperations
    :ivar tilejson_operations: tilejsonOperationsOperations operations
    :vartype tilejson_operations: geocatalog.aio.operations.tilejsonOperationsOperations
    :ivar wmts_operations: wmtsOperationsOperations operations
    :vartype wmts_operations: geocatalog.aio.operations.wmtsOperationsOperations
    :ivar point_operations: pointOperationsOperations operations
    :vartype point_operations: geocatalog.aio.operations.pointOperationsOperations
    :ivar preview_operations: previewOperationsOperations operations
    :vartype preview_operations: geocatalog.aio.operations.previewOperationsOperations
    :ivar part_operations: partOperationsOperations operations
    :vartype part_operations: geocatalog.aio.operations.partOperationsOperations
    :ivar map_operations: mapOperationsOperations operations
    :vartype map_operations: geocatalog.aio.operations.mapOperationsOperations
    :ivar register_operations: registerOperationsOperations operations
    :vartype register_operations: geocatalog.aio.operations.registerOperationsOperations
    :ivar assets_operations: assetsOperationsOperations operations
    :vartype assets_operations: geocatalog.aio.operations.assetsOperationsOperations
    :ivar mosaic_operations: mosaicOperationsOperations operations
    :vartype mosaic_operations: geocatalog.aio.operations.mosaicOperationsOperations
    :ivar get_operations: getOperationsOperations operations
    :vartype get_operations: geocatalog.aio.operations.getOperationsOperations
    ...
    def __init__(self, endpoint: str, credential: AzureKeyCredential, **kwargs: Any) -> None:
        ...
        self.map_operations = mapOperationsOperations(self._client, self._config, self._serialize, self._deserialize)
        ...
        self.mosaic_operations = mosaicOperationsOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
        self.get_operations = getOperationsOperations(self._client, self._config, self._serialize, self._deserialize)
