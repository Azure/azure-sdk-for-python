...
class DirectoryObject(Model):
    ...
    sub-classes are: Application, AppRoleAssignment, ADGroup, ServicePrincipal,
    User
    ...
    _subtype_map = {
        'object_type': {'Application': 'Application', 'AppRoleAssignment': 'AppRoleAssignment', 'Group': 'ADGroup', 'ServicePrincipal': 'ServicePrincipal', 'User': 'User'}
    }
...
class AppRoleAssignment(DirectoryObject):
    ...
    :param object_type: Required. Constant filled by server.
    :type object_type: str
    :param id: The role id that was assigned to the principal. This role must
     be declared by the target resource application resourceId in its appRoles
     property.
    :type id: str
    :param principal_display_name: The display name of the principal that was
     granted the access.
    :type principal_display_name: str
    :param principal_id: The unique identifier (objectId) for the principal
     being granted the access.
    :type principal_id: str
    :param principal_type: The type of principal. This can either be "User",
     "Group" or "ServicePrincipal".
    :type principal_type: str
    :param resource_display_name: The display name of the resource to which
     the assignment was made.
    :type resource_display_name: str
    :param resource_id: The unique identifier (objectId) for the target
     resource (service principal) for which the assignment was made.
    ...
    def __init__(self, *, additional_properties=None, id: str=None, principal_display_name: str=None, principal_id: str=None, principal_type: str=None, resource_display_name: str=None, resource_id: str=None, **kwargs) -> None:
        super(AppRoleAssignment, self).__init__(additional_properties=additional_properties, **kwargs)
        self.id = id
        ...
        self.object_type = 'AppRoleAssignment'
