...
class ServicePrincipalsOperations(object):
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ServicePrincipalPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_app_role_assigned_to(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of AppRoleAssignment
        :rtype:
         ~azure.graphrbac.models.AppRoleAssignmentPaged[~azure.graphrbac.models.AppRoleAssignment]
        :raises:
         :class:`GraphErrorException<azure.graphrbac.models.GraphErrorException>`
        """
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.list_app_role_assigned_to.metadata['url']
                path_format_arguments = {
                    'objectId': self._serialize.url("object_id", object_id, 'str'),
                    'tenantID': self._serialize.url("self.config.tenant_id", self.config.tenant_id, 'str')
                }
        ...
        if raw:
            header_dict = {}
        deserialized = models.AppRoleAssignmentPaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list_app_role_assigned_to.metadata = {'url': '/{tenantID}/servicePrincipals/{objectId}/appRoleAssignedTo'}
    ...
    def list_app_role_assignments(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.list_app_role_assignments.metadata['url']
                path_format_arguments = {
                    'objectId': self._serialize.url("object_id", object_id, 'str'),
                    'tenantID': self._serialize.url("self.config.tenant_id", self.config.tenant_id, 'str')
                }
        ...
        return deserialized
    list_app_role_assignments.metadata = {'url': '/{tenantID}/servicePrincipals/{objectId}/appRoleAssignments'}
    ...
    def list_owners(
        ...
        if raw:
            header_dict = {}
        deserialized = models.DirectoryObjectPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_key_credentials(
        ...
        if raw:
            header_dict = {}
        deserialized = models.KeyCredentialPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_password_credentials(
        ...
        if raw:
            header_dict = {}
        deserialized = models.PasswordCredentialPaged(internal_paging, self._deserialize.dependencies, header_dict)
