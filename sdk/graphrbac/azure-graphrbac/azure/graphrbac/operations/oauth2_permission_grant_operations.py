...
class OAuth2PermissionGrantOperations(object):
    ...
    def list(
        ...
        :return: An iterator like instance of OAuth2PermissionGrant
        :rtype:
        ...
        deserialized = models.OAuth2PermissionGrantPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.OAuth2PermissionGrantPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def delete(
        ...
        """Delete a OAuth2 permission grant for the relevant resource Ids of an
        app.
