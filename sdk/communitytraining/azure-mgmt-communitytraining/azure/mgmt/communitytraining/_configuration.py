...
class MicrosoftCommunityConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    """Configuration for MicrosoftCommunity.
    ...
    def __init__(self, credential: "TokenCredential", subscription_id: str, **kwargs: Any) -> None:
        super(MicrosoftCommunityConfiguration, self).__init__(**kwargs)
