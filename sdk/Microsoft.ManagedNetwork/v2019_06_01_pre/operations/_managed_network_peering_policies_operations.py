...
class ManagedNetworkPeeringPoliciesOperations(object):
    ...
    def get(
            self, resource_group_name, managed_network_name, managed_network_peering_policy_name, custom_headers=None, raw=False, **operation_config):
        """The Get ManagedNetworkPeeringPolicies operation gets a Managed Network
        Peering Policy resource, specified by the  resource group, Managed
        Network name, and peering policy name.

        :param resource_group_name: The name of the resource group.
        :type resource_group_name: str
        :param managed_network_name: The name of the Managed Network.
        :type managed_network_name: str
        :param managed_network_peering_policy_name: The name of the Managed
        ...
        :rtype:
         ~azure.mgmt.network.v2019_06_01_pre.models.ManagedNetworkPeeringPolicy
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ManagedNetworkPeeringPolicy', response)
    ...
    def _create_or_update_initial(
            self, resource_group_name, managed_network_name, managed_network_peering_policy_name, location=None, properties=None, custom_headers=None, raw=False, **operation_config):
    ...
    def create_or_update(
            self, resource_group_name, managed_network_name, managed_network_peering_policy_name, location=None, properties=None, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2019_06_01_pre.models.ManagedNetworkPeeringPolicy]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2019_06_01_pre.models.ManagedNetworkPeeringPolicy]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2019_06_01_pre.models.ErrorResponseException>`
        """
    ...
    def delete(
            self, resource_group_name, managed_network_name, managed_network_peering_policy_name, custom_headers=None, raw=False, polling=True, **operation_config):
        """The Delete ManagedNetworkPeeringPolicies operation deletes a Managed
        Network Peering Policy, specified by the  resource group, Managed
        Network name, and peering policy name.
    ...
    def list_by_managed_network(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_06_01_pre.models.ManagedNetworkPeeringPolicyPaged[~azure.mgmt.network.v2019_06_01_pre.models.ManagedNetworkPeeringPolicy]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2019_06_01_pre.models.ErrorResponseException>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.ManagedNetworkPeeringPolicyPaged(internal_paging, self._deserialize.dependencies, header_dict)
