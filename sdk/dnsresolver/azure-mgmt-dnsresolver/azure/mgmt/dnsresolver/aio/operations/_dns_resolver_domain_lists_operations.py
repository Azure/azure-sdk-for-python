...
class DnsResolverDomainListsOperations:
    ...
    async def _bulk_initial(
        ...
        resource_group_name: str,
        dns_resolver_domain_list_name: str,
        parameters: Union[_models.DnsResolverDomainListBulk, IO[bytes]],
        if_match: Optional[str] = None,
        if_none_match: Optional[str] = None,
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "DnsResolverDomainListBulk")

        _request = build_bulk_request(
            resource_group_name=resource_group_name,
            dns_resolver_domain_list_name=dns_resolver_domain_list_name,
            subscription_id=self._config.subscription_id,
            if_match=if_match,
    ...
    async def begin_bulk(
        ...
        **kwargs: Any
        ...
        :param dns_resolver_domain_list_name: The name of the DNS resolver domain list. Required.
        :type dns_resolver_domain_list_name: str
        :param parameters: Parameters supplied to the bulk domain list operation. Is either a
         DnsResolverDomainListBulk type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.dnsresolver.models.DnsResolverDomainListBulk or IO[bytes]
        :param if_match: ETag of the resource. Omit this value to always overwrite the current
         resource. Specify the last-seen ETag value to prevent accidentally overwriting any concurrent
         changes. Default value is None.
        :type if_match: str
