...
def build_create_or_update_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "dnsResolverPolicyName": _SERIALIZER.url(
...
def build_get_request(
    resource_group_name: str, dns_resolver_policy_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_request(subscription_id: str, *, top: Optional[int] = None, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Network/dnsResolverPolicies")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
def build_list_by_virtual_network_request(
    ...
    path_format_arguments = {
        ...
        "virtualNetworkName": _SERIALIZER.url(
            "virtual_network_name", virtual_network_name, "str", min_length=1, pattern=r"^.+$"
        ),
    }
...
class DnsResolverPoliciesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either DnsResolverPolicy or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.dnsresolver.models.DnsResolverPolicy]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.DnsResolverPolicy].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.DnsResolverPolicy](
    ...
    @distributed_trace
    def get(self, resource_group_name: str, dns_resolver_policy_name: str, **kwargs: Any) -> _models.DnsResolverPolicy:
    ...
    def list_by_resource_group(
    ...
    ) -> ItemPaged["_models.DnsResolverPolicy"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.dnsresolver.models.DnsResolverPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list(self, top: Optional[int] = None, **kwargs: Any) -> ItemPaged["_models.DnsResolverPolicy"]:
