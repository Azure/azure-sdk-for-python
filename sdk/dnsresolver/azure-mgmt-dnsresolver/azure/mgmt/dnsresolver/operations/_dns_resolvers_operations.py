...
class DnsResolversOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.DnsResolver].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.DnsResolver](
    ...
    @distributed_trace
    def list(self, top: Optional[int] = None, **kwargs: Any) -> ItemPaged["_models.DnsResolver"]:
