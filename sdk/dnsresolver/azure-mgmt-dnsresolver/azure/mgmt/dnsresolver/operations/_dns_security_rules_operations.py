...
def build_create_or_update_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "dnsSecurityRuleName": _SERIALIZER.url(
...
class DnsSecurityRulesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either DnsSecurityRule or the result of
         cls(response)
    ...
    ) -> Iterable["_models.DnsSecurityRule"]:
