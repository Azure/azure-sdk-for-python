...
class TestMaintenanceManagementUpdatesOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(MaintenanceManagementClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_updates_list_parent(self, resource_group):
        response = self.client.updates.list_parent(
