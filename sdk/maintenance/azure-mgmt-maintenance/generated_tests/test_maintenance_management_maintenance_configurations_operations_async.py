...
class TestMaintenanceManagementMaintenanceConfigurationsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_maintenance_configurations_update(self, resource_group):
        response = await self.client.maintenance_configurations.update(
            resource_group_name=resource_group.name,
            resource_name="str",
            configuration={
                "duration": "str",
