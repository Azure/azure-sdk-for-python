...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Maintenance/applyUpdates")  # pylint: disable=line-too-long
...
class ApplyUpdateForResourceGroupOperations:
    ...
    def list(
        ...
        resource_group_name: str,
        **kwargs: Any
    ) -> Iterable[_models.ListApplyUpdate]:
    ...
    list.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Maintenance/applyUpdates"}  # type: ignore
