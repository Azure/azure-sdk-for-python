...
# USAGE
    python configuration_assignments_delete_parent.py
...
def main():
    ...
    response = client.configuration_assignments.delete_parent(
...
# x-ms-original-file: specification/maintenance/resource-manager/Microsoft.Maintenance/preview/2022-07-01-preview/examples/ConfigurationAssignments_DeleteParent.json
