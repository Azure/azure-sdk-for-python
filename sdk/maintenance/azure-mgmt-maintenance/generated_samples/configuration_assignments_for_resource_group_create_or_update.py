...
# USAGE
    python configuration_assignments_for_resource_group_create_or_update.py
...
def main():
    ...
    response = client.configuration_assignments_for_resource_group.create_or_update(
...
# x-ms-original-file: specification/maintenance/resource-manager/Microsoft.Maintenance/preview/2023-09-01-preview/examples/ConfigurationAssignmentsForResourceGroup_CreateOrUpdate.json
