...
Package source code and samples have been removed from the `main` branch and can be found under the release tag for the latest version. See [azure-mypackage_mixedreality-remoterendering_1.0.0b3](https://github.com/Azure/azure-sdk-for-python/releases/tag/azure-mixedreality-remoterendering_1.0.0b3). The latest release can be found on [PyPI](https://pypi.org/project/azure-mixedreality-remoterendering/).
