...
def get_mixedreality_credential(
    account_id: str, account_domain: str, endpoint_url: str, credential: TokenCredential, **kwargs
) -> TokenCredential:
...
class MixedRealityTokenCredential(object):
    ...
    def __init__(
        self, account_id: str, account_domain: str, endpoint_url: str, credential: TokenCredential, **kwargs
    ) -> None:
