...
class ConfigurationNameResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.servicelinker.models.ConfigurationNames]
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[ConfigurationNames]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(self, *, value: Optional[List["_models.ConfigurationNames"]] = None, **kwargs):
        """
        :keyword value: Expected configuration names for each target service.
        :paramtype value: list[~azure.mgmt.servicelinker.models.ConfigurationNames]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class ConfigurationNames(_serialization.Model):
    ...
    _attribute_map = {
        "target_service": {"key": "targetService", "type": "str"},
        "client_type": {"key": "clientType", "type": "str"},
        "auth_type": {"key": "authType", "type": "str"},
        "names": {"key": "names", "type": "[ConfigurationName]"},
    }
