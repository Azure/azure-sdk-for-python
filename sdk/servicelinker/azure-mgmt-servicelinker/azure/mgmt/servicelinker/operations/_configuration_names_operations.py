...
def build_list_request(*, filter: Optional[str] = None, skip_token: Optional[str] = None, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.ServiceLinker/configurationNames")
...
class ConfigurationNamesOperations:
    ...
    def list(
    ...
    ) -> Iterable["_models.ConfigurationNameItem"]:
        ...
        :return: An iterator like instance of either ConfigurationNameItem or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.servicelinker.models.ConfigurationNameItem]
