...
from ...operations._configuration_names_operations import build_list_request
...
class ConfigurationNamesOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`configuration_names` attribute.
    """
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.ConfigurationNames"]:
        ...
        :return: An iterator like instance of either ConfigurationNames or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicelinker.models.ConfigurationNames]
        ...
        cls: ClsType[_models.ConfigurationNameResult] = kwargs.pop("cls", None)
