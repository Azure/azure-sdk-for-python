...
class ConnectorOperations:
    ...
    async def get_dryrun(
        self, resource_group_name: str, location: str, dryrun_name: str, **kwargs: Any
    ...
    @distributed_trace
    def list(self, resource_group_name: str, location: str, **kwargs: Any) -> AsyncIterable["_models.LinkerResource"]:
    ...
    @distributed_trace_async
    async def get(
        self, resource_group_name: str, location: str, connector_name: str, **kwargs: Any
