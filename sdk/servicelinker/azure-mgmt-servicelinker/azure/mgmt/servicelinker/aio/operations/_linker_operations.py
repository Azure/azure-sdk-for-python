...
from ...operations._linker_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_configurations_request, build_list_request, build_update_request_initial, build_validate_request_initial
T = TypeVar('T')
...
class LinkerOperations:
    ...
    def list(
        ...
        resource_uri: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.LinkerList"]:
