...
from ._operations import SpeechClientOperationsMixin
from ._serialization import Deserializer, Serializer


class SpeechClient(SpeechClientOperationsMixin):
    """SpeechClient.
    ...
    def __init__(self, endpoint: str, credential: AzureKeyCredential, **kwargs: Any) -> None:
        ...
        self._config = SpeechClientConfiguration(endpoint=endpoint, credential=credential, **kwargs)
