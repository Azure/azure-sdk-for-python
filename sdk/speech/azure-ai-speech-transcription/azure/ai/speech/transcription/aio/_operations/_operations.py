...
from ..._operations._operations import (
    build_speech_delete_transcription_request,
    build_speech_get_transcription_request,
    build_speech_get_transcriptions_request,
    build_speech_submit_transcription_request,
    build_speech_transcribe_transcription_request,
)
from ..._vendor import FileType, prepare_multipart_form_data
from .._vendor import SpeechClientMixinABC, raise_if_not_implemented
...
class SpeechClientOperationsMixin(SpeechClientMixinABC):  # pylint: disable=abstract-class-instantiated
    ...
    @overload
    async def transcribe_transcription(self, body: JSON, **kwargs: Any) -> _models.TranscribeResult:
    ...
    @overload
    async def transcribe_transcription(
