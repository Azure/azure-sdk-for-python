...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    top_left = kwargs.pop('top_left', None)  # type: Optional[List[float]]
    bot_right = kwargs.pop('bot_right', None)  # type: Optional[List[float]]

    heat_map_type = "default"
    api_version = "2018-08-01"
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/trafficmanagerprofiles/{profileName}/heatMaps/{heatMapType}')
    ...
    if top_left is not None:
        query_parameters['topLeft'] = _SERIALIZER.query("top_left", top_left, '[float]', div=',')
    if bot_right is not None:
        query_parameters['botRight'] = _SERIALIZER.query("bot_right", bot_right, '[float]', div=',')
...
class HeatMapOperations(object):
    ...
    def get(
        ...
        resource_group_name,  # type: str
        profile_name,  # type: str
        top_left=None,  # type: Optional[List[float]]
        bot_right=None,  # type: Optional[List[float]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.HeatMapModel"
