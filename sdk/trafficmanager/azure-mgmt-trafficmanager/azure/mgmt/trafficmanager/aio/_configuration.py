...
class TrafficManagerManagementClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long,docstring-keyword-should-match-keyword-only
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", "2026-09-01")
