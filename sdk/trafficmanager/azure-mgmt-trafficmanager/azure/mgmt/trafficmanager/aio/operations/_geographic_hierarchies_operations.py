...
class GeographicHierarchiesOperations:
    ...
    async def get_default(self, **kwargs: Any) -> _models.TrafficManagerGeographicHierarchy:
        ...
        deserialized = self._deserialize("TrafficManagerGeographicHierarchy", pipeline_response.http_response)
