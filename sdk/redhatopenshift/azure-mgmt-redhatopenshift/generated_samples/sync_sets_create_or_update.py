...
# USAGE
    python sync_sets_create_or_update.py
...
def main():
    ...
    response = client.sync_sets.create_or_update(
...
# x-ms-original-file: specification/redhatopenshift/resource-manager/Microsoft.RedHatOpenShift/stable/2023-09-04/examples/SyncSets_CreateOrUpdate.json
