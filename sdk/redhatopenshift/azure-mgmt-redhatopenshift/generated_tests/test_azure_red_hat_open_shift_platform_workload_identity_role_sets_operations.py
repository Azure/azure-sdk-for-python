...
class TestAzureRedHatOpenShiftPlatformWorkloadIdentityRoleSetsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(AzureRedHatOpenShiftClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_platform_workload_identity_role_sets_list(self, resource_group):
