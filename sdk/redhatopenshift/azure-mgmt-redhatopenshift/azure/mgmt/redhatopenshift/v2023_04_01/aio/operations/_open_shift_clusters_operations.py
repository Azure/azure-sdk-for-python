...
class OpenShiftClustersOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.OpenShiftCluster"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.redhatopenshift.v2022_09_04.models.OpenShiftCluster]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either OpenShiftCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.redhatopenshift.v2022_09_04.models.OpenShiftCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
