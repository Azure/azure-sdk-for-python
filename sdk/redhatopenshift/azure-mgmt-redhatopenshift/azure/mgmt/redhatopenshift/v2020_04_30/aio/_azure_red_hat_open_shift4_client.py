...
class AzureRedHatOpenShift4Client(object):
    ...
    :vartype open_shift_clusters: azure.mgmt.redhatopenshift.v2020_04_30.aio.operations.OpenShiftClustersOperations
    ...
    async def __aenter__(self) -> "AzureRedHatOpenShift4Client":
