...
class AzureRedHatOpenShiftClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.redhatopenshift.v2023_11_22.aio.operations.Operations
    :ivar open_shift_versions: OpenShiftVersionsOperations operations
    :vartype open_shift_versions:
     azure.mgmt.redhatopenshift.v2023_11_22.aio.operations.OpenShiftVersionsOperations
    :ivar open_shift_clusters: OpenShiftClustersOperations operations
    :vartype open_shift_clusters:
     azure.mgmt.redhatopenshift.v2023_11_22.aio.operations.OpenShiftClustersOperations
    :ivar machine_pools: MachinePoolsOperations operations
    :vartype machine_pools:
     azure.mgmt.redhatopenshift.v2023_11_22.aio.operations.MachinePoolsOperations
    :ivar secrets: SecretsOperations operations
    :vartype secrets: azure.mgmt.redhatopenshift.v2023_11_22.aio.operations.SecretsOperations
    :ivar sync_identity_providers: SyncIdentityProvidersOperations operations
    :vartype sync_identity_providers:
     azure.mgmt.redhatopenshift.v2023_11_22.aio.operations.SyncIdentityProvidersOperations
    :ivar sync_sets: SyncSetsOperations operations
    :vartype sync_sets: azure.mgmt.redhatopenshift.v2023_11_22.aio.operations.SyncSetsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.operations = Operations(self._client, self._config, self._serialize, self._deserialize, "2023-11-22")
        self.open_shift_versions = OpenShiftVersionsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2023-11-22"
        )
        ...
        self.secrets = SecretsOperations(self._client, self._config, self._serialize, self._deserialize, "2023-11-22")
