...
class OpenShiftClustersOperations:
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.OpenShiftCluster"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.redhatopenshift.v2022_09_04.models.OpenShiftCluster]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.redhatopenshift.v2022_09_04.models.OpenShiftCluster or IO[bytes]
        :return: An instance of LROPoller that returns either OpenShiftCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.redhatopenshift.v2022_09_04.models.OpenShiftCluster]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The OpenShift cluster resource. Is either a OpenShiftClusterUpdate type or a
         IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.redhatopenshift.v2022_09_04.models.OpenShiftClusterUpdate or
         IO[bytes]
        :return: An instance of LROPoller that returns either OpenShiftCluster or the result of
         cls(response)
        :rtype:
