...
class AzureRedHatOpenShiftClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2023-09-04". Note that overriding this
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.operations = Operations(self._client, self._config, self._serialize, self._deserialize, "2023-09-04")
        self.open_shift_versions = OpenShiftVersionsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2023-09-04"
        )
        ...
        self.secrets = SecretsOperations(self._client, self._config, self._serialize, self._deserialize, "2023-09-04")
