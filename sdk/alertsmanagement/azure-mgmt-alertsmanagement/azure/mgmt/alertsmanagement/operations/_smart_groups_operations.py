...
def build_get_all_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.AlertsManagement/smartGroups")
    ...
    if target_resource is not None:
        _query_parameters['targetResource'] = _SERIALIZER.query("target_resource", target_resource, 'str')
    if target_resource_group is not None:
        _query_parameters['targetResourceGroup'] = _SERIALIZER.query("target_resource_group", target_resource_group, 'str')
    if target_resource_type is not None:
        _query_parameters['targetResourceType'] = _SERIALIZER.query("target_resource_type", target_resource_type, 'str')
    if monitor_service is not None:
        _query_parameters['monitorService'] = _SERIALIZER.query("monitor_service", monitor_service, 'str')
    if monitor_condition is not None:
        _query_parameters['monitorCondition'] = _SERIALIZER.query("monitor_condition", monitor_condition, 'str')
    if severity is not None:
        _query_parameters['severity'] = _SERIALIZER.query("severity", severity, 'str')
    if smart_group_state is not None:
        _query_parameters['smartGroupState'] = _SERIALIZER.query("smart_group_state", smart_group_state, 'str')
    if time_range is not None:
        _query_parameters['timeRange'] = _SERIALIZER.query("time_range", time_range, 'str')
    if page_count is not None:
        _query_parameters['pageCount'] = _SERIALIZER.query("page_count", page_count, 'long')
    if sort_by is not None:
        _query_parameters['sortBy'] = _SERIALIZER.query("sort_by", sort_by, 'str')
    if sort_order is not None:
        _query_parameters['sortOrder'] = _SERIALIZER.query("sort_order", sort_order, 'str')
...
def build_get_by_id_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.AlertsManagement/smartGroups/{smartGroupId}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
...
def build_change_state_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.AlertsManagement/smartGroups/{smartGroupId}/changeState")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "smartGroupId": _SERIALIZER.url("smart_group_id", smart_group_id, 'str'),
    }
    ...
    _query_parameters = kwargs.pop("params", {})  # type: Dict[str, Any]
    _query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
    _query_parameters['newState'] = _SERIALIZER.query("new_state", new_state, 'str')
...
def build_get_history_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.AlertsManagement/smartGroups/{smartGroupId}/history")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "smartGroupId": _SERIALIZER.url("smart_group_id", smart_group_id, 'str'),
    }
...
class SmartGroupsOperations(object):
    ...
    def get_all(
        ...
        sort_order: Optional[Union[str, "_models.SortOrder"]] = None,
        **kwargs: Any
    ) -> Iterable["_models.SmartGroupsList"]:
