...
def build_meta_data_request(
    ...
    **kwargs: Any
    ...
    _query_parameters['identifier'] = _SERIALIZER.query("identifier", identifier, 'str')
...
def build_get_all_request(
    ...
    **kwargs: Any
    ...
    if alert_state is not None:
        _query_parameters['alertState'] = _SERIALIZER.query("alert_state", alert_state, 'str')
    if alert_rule is not None:
        _query_parameters['alertRule'] = _SERIALIZER.query("alert_rule", alert_rule, 'str')
    if smart_group_id is not None:
        _query_parameters['smartGroupId'] = _SERIALIZER.query("smart_group_id", smart_group_id, 'str')
    if include_context is not None:
        _query_parameters['includeContext'] = _SERIALIZER.query("include_context", include_context, 'bool')
    if include_egress_config is not None:
        _query_parameters['includeEgressConfig'] = _SERIALIZER.query("include_egress_config", include_egress_config, 'bool')
    ...
    if custom_time_range is not None:
        _query_parameters['customTimeRange'] = _SERIALIZER.query("custom_time_range", custom_time_range, 'str')
    _query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
...
def build_get_summary_request(
    ...
    **kwargs: Any
    ...
    # Construct parameters
    _query_parameters = kwargs.pop("params", {})  # type: Dict[str, Any]
    _query_parameters['groupby'] = _SERIALIZER.query("groupby", groupby, 'str')
    if include_smart_groups_count is not None:
        _query_parameters['includeSmartGroupsCount'] = _SERIALIZER.query("include_smart_groups_count", include_smart_groups_count, 'bool')
    if target_resource is not None:
        _query_parameters['targetResource'] = _SERIALIZER.query("target_resource", target_resource, 'str')
    if target_resource_type is not None:
        _query_parameters['targetResourceType'] = _SERIALIZER.query("target_resource_type", target_resource_type, 'str')
