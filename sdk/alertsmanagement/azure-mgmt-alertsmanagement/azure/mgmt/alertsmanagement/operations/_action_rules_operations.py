...
def build_list_by_subscription_request(
    ...
    **kwargs: Any
    ...
    if impacted_scope is not None:
        _params["impactedScope"] = _SERIALIZER.query("impacted_scope", impacted_scope, "str")
    if description is not None:
        _params["description"] = _SERIALIZER.query("description", description, "str")
    if alert_rule_id is not None:
        _params["alertRuleId"] = _SERIALIZER.query("alert_rule_id", alert_rule_id, "str")
    if action_group is not None:
        _params["actionGroup"] = _SERIALIZER.query("action_group", action_group, "str")
    if name is not None:
...
def build_get_by_name_request(
    resource_group_name: str, action_rule_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "actionRuleName": _SERIALIZER.url("action_rule_name", action_rule_name, "str"),
    }
...
class ActionRulesOperations:
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.alertsmanagement.models.ActionRule]
    ...
    @distributed_trace
    def get_by_name(self, resource_group_name: str, action_rule_name: str, **kwargs: Any) -> _models.ActionRule:
    ...
    @distributed_trace
    def delete(self, resource_group_name: str, action_rule_name: str, **kwargs: Any) -> bool:
        """Delete action rule.
