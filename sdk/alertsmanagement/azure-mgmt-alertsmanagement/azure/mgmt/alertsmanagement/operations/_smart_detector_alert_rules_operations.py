...
def build_list_request(subscription_id: str, *, expand_detector: Optional[bool] = None, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/microsoft.alertsManagement/smartDetectorAlertRules"
    )
    ...
    if expand_detector is not None:
        _params["expandDetector"] = _SERIALIZER.query("expand_detector", expand_detector, "bool")
...
def build_list_by_resource_group_request(
    resource_group_name: str, subscription_id: str, *, expand_detector: Optional[bool] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "alertRuleName": _SERIALIZER.url("alert_rule_name", alert_rule_name, "str"),
    }
...
def build_create_or_update_request(
    resource_group_name: str, alert_rule_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class SmartDetectorAlertRulesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`smart_detector_alert_rules` attribute.
    """
    ...
    @distributed_trace
    def list(self, expand_detector: Optional[bool] = None, **kwargs: Any) -> ItemPaged["_models.AlertRule"]:
        """List all the existing Smart Detector alert rules within the subscription.

        :param expand_detector: Indicates if Smart Detector should be expanded. Default value is None.
        :type expand_detector: bool
        :return: An iterator like instance of either AlertRule or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.alertsmanagement.models.AlertRule]
        ...
        def get_next(next_link=None):
            ...
            if response.status_code not in [200]:
                ...
                error = self._deserialize.failsafe_deserialize(
                    _models.SmartDetectorErrorResponse,
                    pipeline_response,
                )
    ...
    def list_by_resource_group(
        self, resource_group_name: str, expand_detector: Optional[bool] = None, **kwargs: Any
    ) -> ItemPaged["_models.AlertRule"]:
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, alert_rule_name: str, expand_detector: Optional[bool] = None, **kwargs: Any
    ) -> _models.AlertRule:
    ...
    def create_or_update(
        ...
        resource_group_name: str,
        alert_rule_name: str,
        parameters: Union[_models.AlertRule, IO[bytes]],
        **kwargs: Any
    ) -> _models.AlertRule:
        """Create or update a Smart Detector alert rule.
        ...
        :param alert_rule_name: The name of the alert rule. Required.
        :type alert_rule_name: str
        :param parameters: Parameters supplied to the operation. Is either a AlertRule type or a
         IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.alertsmanagement.models.AlertRule or IO[bytes]
        :return: AlertRule or the result of cls(response)
        :rtype: ~azure.mgmt.alertsmanagement.models.AlertRule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "AlertRule")
    ...
    def patch(
        ...
        resource_group_name: str,
        alert_rule_name: str,
        parameters: Union[_models.AlertRulePatchObject, IO[bytes]],
        **kwargs: Any
    ) -> _models.AlertRule:
        """Patch a specific Smart Detector alert rule.
        ...
        :param alert_rule_name: The name of the alert rule. Required.
        :type alert_rule_name: str
        :param parameters: Parameters supplied to the operation. Is either a AlertRulePatchObject type
         or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.alertsmanagement.models.AlertRulePatchObject or IO[bytes]
        :return: AlertRule or the result of cls(response)
        :rtype: ~azure.mgmt.alertsmanagement.models.AlertRule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "AlertRulePatchObject")
    ...
    def delete(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, alert_rule_name: str, **kwargs: Any
    ) -> None:
