...
from ...operations._smart_detector_alert_rules_operations import (
...
class SmartDetectorAlertRulesOperations:
    ...
    @distributed_trace
    def list(self, expand_detector: Optional[bool] = None, **kwargs: Any) -> AsyncItemPaged["_models.AlertRule"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.alertsmanagement.models.AlertRule]
    ...
    ) -> AsyncItemPaged["_models.AlertRule"]:
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, alert_rule_name: str, **kwargs: Any) -> None:
