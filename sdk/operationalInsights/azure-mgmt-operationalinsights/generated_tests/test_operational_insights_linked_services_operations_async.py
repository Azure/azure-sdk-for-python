...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.operationalinsights.aio import OperationalInsightsClient
...
class TestOperationalInsightsLinkedServicesOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(OperationalInsightsClient, is_async=True)
    ...
    async def test_linked_services_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.linked_services.begin_create_or_update(
                ...
                linked_service_name="str",
                parameters={
                    "properties": {"provisioningState": "str", "resourceId": "str", "writeAccessResourceId": "str"},
                    "id": "str",
                    "name": "str",
                    "systemData": {
