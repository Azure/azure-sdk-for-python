...
from ._configuration import OperationalInsightsClientConfiguration
...
class OperationalInsightsClient:  # pylint: disable=too-many-instance-attributes
    """Provides NSP operations for working with Log Analytics.

    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.operationalinsights.operations.Operations
    :ivar clusters: ClustersOperations operations
    :vartype clusters: azure.mgmt.operationalinsights.operations.ClustersOperations
    :ivar data_exports: DataExportsOperations operations
    :vartype data_exports: azure.mgmt.operationalinsights.operations.DataExportsOperations
    :ivar workspaces: WorkspacesOperations operations
    :vartype workspaces: azure.mgmt.operationalinsights.operations.WorkspacesOperations
    :ivar data_sources: DataSourcesOperations operations
    :vartype data_sources: azure.mgmt.operationalinsights.operations.DataSourcesOperations
    :ivar linked_services: LinkedServicesOperations operations
    :vartype linked_services: azure.mgmt.operationalinsights.operations.LinkedServicesOperations
    :ivar saved_searches: SavedSearchesOperations operations
    :vartype saved_searches: azure.mgmt.operationalinsights.operations.SavedSearchesOperations
    :ivar tables: TablesOperations operations
    :vartype tables: azure.mgmt.operationalinsights.operations.TablesOperations
    :ivar available_service_tiers: AvailableServiceTiersOperations operations
    :vartype available_service_tiers:
     azure.mgmt.operationalinsights.operations.AvailableServiceTiersOperations
    :ivar gateways: GatewaysOperations operations
    :vartype gateways: azure.mgmt.operationalinsights.operations.GatewaysOperations
    :ivar intelligence_packs: IntelligencePacksOperations operations
    :vartype intelligence_packs:
     azure.mgmt.operationalinsights.operations.IntelligencePacksOperations
    :ivar management_groups: ManagementGroupsOperations operations
    :vartype management_groups:
     azure.mgmt.operationalinsights.operations.ManagementGroupsOperations
    :ivar schema: SchemaOperations operations
    :vartype schema: azure.mgmt.operationalinsights.operations.SchemaOperations
    :ivar shared_keys: SharedKeysOperations operations
    :vartype shared_keys: azure.mgmt.operationalinsights.operations.SharedKeysOperations
    :ivar usages: UsagesOperations operations
    :vartype usages: azure.mgmt.operationalinsights.operations.UsagesOperations
    :ivar workspace_purge: WorkspacePurgeOperations operations
    :vartype workspace_purge: azure.mgmt.operationalinsights.operations.WorkspacePurgeOperations
    :ivar linked_storage_accounts: LinkedStorageAccountsOperations operations
    :vartype linked_storage_accounts:
     azure.mgmt.operationalinsights.operations.LinkedStorageAccountsOperations
    :ivar queries: QueriesOperations operations
    :vartype queries: azure.mgmt.operationalinsights.operations.QueriesOperations
    :ivar query_packs: QueryPacksOperations operations
    :vartype query_packs: azure.mgmt.operationalinsights.operations.QueryPacksOperations
    :ivar storage_insight_configs: StorageInsightConfigsOperations operations
    :vartype storage_insight_configs:
     azure.mgmt.operationalinsights.operations.StorageInsightConfigsOperations
    :ivar summary_logs: SummaryLogsOperations operations
    :vartype summary_logs: azure.mgmt.operationalinsights.operations.SummaryLogsOperations
    :ivar operation_statuses: OperationStatusesOperations operations
    :vartype operation_statuses:
     azure.mgmt.operationalinsights.operations.OperationStatusesOperations
    :ivar deleted_workspaces: DeletedWorkspacesOperations operations
    :vartype deleted_workspaces:
     azure.mgmt.operationalinsights.operations.DeletedWorkspacesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = OperationalInsightsClientConfiguration(
