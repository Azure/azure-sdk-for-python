...
class OperationalInsightsClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.operationalinsights.aio.operations.Operations
    :ivar clusters: ClustersOperations operations
    :vartype clusters: azure.mgmt.operationalinsights.aio.operations.ClustersOperations
    :ivar data_exports: DataExportsOperations operations
    :vartype data_exports: azure.mgmt.operationalinsights.aio.operations.DataExportsOperations
    :ivar workspaces: WorkspacesOperations operations
    :vartype workspaces: azure.mgmt.operationalinsights.aio.operations.WorkspacesOperations
    :ivar data_sources: DataSourcesOperations operations
    :vartype data_sources: azure.mgmt.operationalinsights.aio.operations.DataSourcesOperations
    :ivar linked_services: LinkedServicesOperations operations
    :vartype linked_services:
     azure.mgmt.operationalinsights.aio.operations.LinkedServicesOperations
    :ivar saved_searches: SavedSearchesOperations operations
    :vartype saved_searches: azure.mgmt.operationalinsights.aio.operations.SavedSearchesOperations
    :ivar tables: TablesOperations operations
    :vartype tables: azure.mgmt.operationalinsights.aio.operations.TablesOperations
    :ivar available_service_tiers: AvailableServiceTiersOperations operations
    :vartype available_service_tiers:
     azure.mgmt.operationalinsights.aio.operations.AvailableServiceTiersOperations
    :ivar gateways: GatewaysOperations operations
    :vartype gateways: azure.mgmt.operationalinsights.aio.operations.GatewaysOperations
    :ivar intelligence_packs: IntelligencePacksOperations operations
    :vartype intelligence_packs:
     azure.mgmt.operationalinsights.aio.operations.IntelligencePacksOperations
    :ivar management_groups: ManagementGroupsOperations operations
    :vartype management_groups:
     azure.mgmt.operationalinsights.aio.operations.ManagementGroupsOperations
    :ivar schema: SchemaOperations operations
    :vartype schema: azure.mgmt.operationalinsights.aio.operations.SchemaOperations
    :ivar shared_keys: SharedKeysOperations operations
    :vartype shared_keys: azure.mgmt.operationalinsights.aio.operations.SharedKeysOperations
    :ivar usages: UsagesOperations operations
    :vartype usages: azure.mgmt.operationalinsights.aio.operations.UsagesOperations
    :ivar workspace_purge: WorkspacePurgeOperations operations
    :vartype workspace_purge:
     azure.mgmt.operationalinsights.aio.operations.WorkspacePurgeOperations
    :ivar linked_storage_accounts: LinkedStorageAccountsOperations operations
    :vartype linked_storage_accounts:
     azure.mgmt.operationalinsights.aio.operations.LinkedStorageAccountsOperations
    :ivar queries: QueriesOperations operations
    :vartype queries: azure.mgmt.operationalinsights.aio.operations.QueriesOperations
    :ivar query_packs: QueryPacksOperations operations
    :vartype query_packs: azure.mgmt.operationalinsights.aio.operations.QueryPacksOperations
    :ivar storage_insight_configs: StorageInsightConfigsOperations operations
    :vartype storage_insight_configs:
     azure.mgmt.operationalinsights.aio.operations.StorageInsightConfigsOperations
    :ivar summary_logs: SummaryLogsOperations operations
    :vartype summary_logs: azure.mgmt.operationalinsights.aio.operations.SummaryLogsOperations
    :ivar operation_statuses: OperationStatusesOperations operations
    :vartype operation_statuses:
     azure.mgmt.operationalinsights.aio.operations.OperationStatusesOperations
    :ivar deleted_workspaces: DeletedWorkspacesOperations operations
    :vartype deleted_workspaces:
     azure.mgmt.operationalinsights.aio.operations.DeletedWorkspacesOperations
