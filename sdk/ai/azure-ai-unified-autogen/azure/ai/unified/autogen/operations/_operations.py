...
def build_connections_get_with_credentials_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/connections/{connectionName}:getWithCredentials"
    path_format_arguments = {
        "connectionName": _SERIALIZER.url("connection_name", connection_name, "str"),
    }
...
def build_connections_list_request(
    ...
    **kwargs: Any
    ...
    # Construct parameters
    _params["api-version"] = _SERIALIZER.query("api_version", api_version, "str")
    if connection_category is not None:
        _params["$connectionCategory"] = _SERIALIZER.query("connection_category", connection_category, "str")
    if top is not None:
...
def build_models_get_chat_completions_request(  # pylint: disable=name-too-long
    *, extra_params: Optional[Union[str, _models.ExtraParameters]] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_models_get_embeddings_request(
    *, extra_params: Optional[Union[str, _models.ExtraParameters]] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_models_get_image_embeddings_request(  # pylint: disable=name-too-long
    *, extra_params: Optional[Union[str, _models.ExtraParameters]] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class AgentsOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.ai.unified.autogen.UnifiedClient`'s
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._config: UnifiedClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def create_agent(
        ...
        **kwargs: Any
        ...
        :paramtype tools: list[~azure.ai.unified.autogen.models.ToolDefinition]
        ...
        :paramtype tool_resources: ~azure.ai.unified.autogen.models.ToolResources
        ...
        :paramtype response_format: str or str or
         ~azure.ai.unified.autogen.models.AgentsApiResponseFormatMode or
         ~azure.ai.unified.autogen.models.AgentsApiResponseFormat or
         ~azure.ai.unified.autogen.models.ResponseFormatJsonSchemaType
        ...
        :rtype: ~azure.ai.unified.autogen.models.Agent
    ...
    def list_agents(
        ...
        **kwargs: Any
        ...
        :paramtype order: str or ~azure.ai.unified.autogen.models.ListSortOrder
        ...
        :return: OpenAIPageableListOfAgent. The OpenAIPageableListOfAgent is compatible with
         MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.OpenAIPageableListOfAgent
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def delete_agent(self, assistant_id: str, **kwargs: Any) -> _models.AgentDeletionStatus:
        ...
        :rtype: ~azure.ai.unified.autogen.models.AgentDeletionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create_thread(
        ...
        **kwargs: Any
        ...
        :keyword messages: The initial messages to associate with the new thread. Default value is
         None.
        :paramtype messages: list[~azure.ai.unified.autogen.models.ThreadMessageOptions]
        ...
        :rtype: ~azure.ai.unified.autogen.models.AgentThread
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def delete_thread(self, thread_id: str, **kwargs: Any) -> _models.ThreadDeletionStatus:
        ...
        :rtype: ~azure.ai.unified.autogen.models.ThreadDeletionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create_message(
        ...
        **kwargs: Any
        ...
        :paramtype role: str or ~azure.ai.unified.autogen.models.MessageRole
        ...
        :paramtype attachments: list[~azure.ai.unified.autogen.models.MessageAttachment]
        :keyword metadata: A set of up to 16 key/value pairs that can be attached to an object, used
         for storing additional information about that object in a structured format. Keys may be up to
         64 characters in length and values may be up to 512 characters in length. Default value is
         None.
        ...
        :rtype: ~azure.ai.unified.autogen.models.ThreadMessage
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_messages(
        ...
        **kwargs: Any
        ...
        :return: OpenAIPageableListOfThreadMessage. The OpenAIPageableListOfThreadMessage is compatible
         with MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.OpenAIPageableListOfThreadMessage
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create_run(
        ...
        **kwargs: Any
        ...
        :paramtype include: list[str or ~azure.ai.unified.autogen.models.RunAdditionalFieldList]
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        ...
        :paramtype additional_messages: list[~azure.ai.unified.autogen.models.ThreadMessageOptions]
        ...
        :paramtype truncation_strategy: ~azure.ai.unified.autogen.models.TruncationObject
        ...
        :paramtype tool_choice: str or str or
         ~azure.ai.unified.autogen.models.AgentsApiToolChoiceOptionMode or
         ~azure.ai.unified.autogen.models.AgentsNamedToolChoice
        ...
        :rtype: ~azure.ai.unified.autogen.models.ThreadRun
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_runs(
        ...
        **kwargs: Any
        ...
        :return: OpenAIPageableListOfThreadRun. The OpenAIPageableListOfThreadRun is compatible with
         MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.OpenAIPageableListOfThreadRun
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def submit_tool_outputs_to_run(
        ...
        **kwargs: Any
        ...
        :paramtype tool_outputs: list[~azure.ai.unified.autogen.models.ToolOutput]
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    def create_thread_and_run(
        ...
        **kwargs: Any
        ...
        :paramtype thread: ~azure.ai.unified.autogen.models.AgentThreadCreationOptions
        ...
        :paramtype tool_resources: ~azure.ai.unified.autogen.models.UpdateToolResourcesOptions
        :keyword stream_parameter: If ``true``\\ , returns a stream of events that happen during the
         Run as server-sent events,
         terminating when the Run enters a terminal state with a ``data: [DONE]`` message. Default
         value is None.
    ...
    def get_run_step(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.ai.unified.autogen.models.RunStep
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_run_steps(
        ...
        **kwargs: Any
        ...
        :return: OpenAIPageableListOfRunStep. The OpenAIPageableListOfRunStep is compatible with
         MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.OpenAIPageableListOfRunStep
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_files(
        ...
        :keyword purpose: The purpose of the file. Known values are: "fine-tune", "fine-tune-results",
         ...
         None.
        :paramtype purpose: str or ~azure.ai.unified.autogen.models.FilePurpose
        :return: FileListResponse. The FileListResponse is compatible with MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.FileListResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def upload_file(
        ...
        :paramtype file: ~azure.ai.unified.autogen._vendor.FileType
        ...
        :rtype: ~azure.ai.unified.autogen.models.OpenAIFile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def delete_file(self, file_id: str, **kwargs: Any) -> _models.FileDeletionStatus:
        ...
        :rtype: ~azure.ai.unified.autogen.models.FileDeletionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_vector_stores(
        ...
        **kwargs: Any
        ...
        :return: OpenAIPageableListOfVectorStore. The OpenAIPageableListOfVectorStore is compatible
         with MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.OpenAIPageableListOfVectorStore
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create_vector_store(
        ...
        **kwargs: Any
        ...
        :paramtype store_configuration: ~azure.ai.unified.autogen.models.VectorStoreConfiguration
        :keyword expires_after: Details on when this vector store expires. Default value is None.
        :paramtype expires_after: ~azure.ai.unified.autogen.models.VectorStoreExpirationPolicy
        ...
        :paramtype chunking_strategy:
         ~azure.ai.unified.autogen.models.VectorStoreChunkingStrategyRequest
        :keyword metadata: A set of up to 16 key/value pairs that can be attached to an object, used
         for storing additional information about that object in a structured format. Keys may be up to
         64 characters in length and values may be up to 512 characters in length. Default value is
         None.
        ...
        :rtype: ~azure.ai.unified.autogen.models.VectorStore
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def delete_vector_store(self, vector_store_id: str, **kwargs: Any) -> _models.VectorStoreDeletionStatus:
        ...
        :return: VectorStoreDeletionStatus. The VectorStoreDeletionStatus is compatible with
         MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.VectorStoreDeletionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_vector_store_files(
        ...
        **kwargs: Any
        ...
        :paramtype filter: str or ~azure.ai.unified.autogen.models.VectorStoreFileStatusFilter
        :keyword limit: A limit on the number of objects to be returned. Limit can range between 1 and
         100, and the default is 20. Default value is None.
        :paramtype limit: int
        :keyword order: Sort order by the created_at timestamp of the objects. asc for ascending order
        ...
        :rtype: ~azure.ai.unified.autogen.models.OpenAIPageableListOfVectorStoreFile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create_vector_store_file(
        ...
        **kwargs: Any
        ...
        :paramtype data_source: ~azure.ai.unified.autogen.models.VectorStoreDataSource
        :keyword chunking_strategy: The chunking strategy used to chunk the file(s). If not set, will
         use the auto strategy. Default value is None.
        :paramtype chunking_strategy:
         ~azure.ai.unified.autogen.models.VectorStoreChunkingStrategyRequest
        :return: VectorStoreFile. The VectorStoreFile is compatible with MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.VectorStoreFile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def delete_vector_store_file(
        ...
        :return: VectorStoreFileDeletionStatus. The VectorStoreFileDeletionStatus is compatible with
         MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.VectorStoreFileDeletionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create_vector_store_file_batch(
        ...
        **kwargs: Any
        ...
        :paramtype data_sources: list[~azure.ai.unified.autogen.models.VectorStoreDataSource]
        :keyword chunking_strategy: The chunking strategy used to chunk the file(s). If not set, will
         use the auto strategy. Default value is None.
        :paramtype chunking_strategy:
         ~azure.ai.unified.autogen.models.VectorStoreChunkingStrategyRequest
        :return: VectorStoreFileBatch. The VectorStoreFileBatch is compatible with MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.VectorStoreFileBatch
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class ConnectionsOperations:
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.ai.unified.autogen.models.Connection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    @distributed_trace
    def get_with_credentials(self, connection_name: str, **kwargs: Any) -> _models.Connection:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.unified.autogen.models.Connection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class EvaluationsOperations:
    ...
    def get(self, id: str, **kwargs: Any) -> _models.Evaluation:
        ...
        :rtype: ~azure.ai.unified.autogen.models.Evaluation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create(
        ...
        :type body: ~azure.ai.unified.autogen.models.Evaluation
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Evaluation. The Evaluation is compatible with MutableMapping
    ...
    def create(self, body: Union[_models.Evaluation, JSON, IO[bytes]], **kwargs: Any) -> _models.Evaluation:
        ...
        :param body: Properties of Evaluation. Is one of the following types: Evaluation, JSON,
         IO[bytes] Required.
        :type body: ~azure.ai.unified.autogen.models.Evaluation or JSON or IO[bytes]
        :return: Evaluation. The Evaluation is compatible with MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.Evaluation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.unified.autogen.models.Evaluation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class DatasetsOperations:
    ...
    def get_version(self, name: str, version: str, **kwargs: Any) -> _models.DatasetVersion:
        ...
        :rtype: ~azure.ai.unified.autogen.models.DatasetVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type dataset_version: ~azure.ai.unified.autogen.models.DatasetVersion
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: DatasetVersion. The DatasetVersion is compatible with MutableMapping
    ...
    def create_or_update(
        ...
        :type dataset_version: ~azure.ai.unified.autogen.models.DatasetVersion or JSON or IO[bytes]
        :return: DatasetVersion. The DatasetVersion is compatible with MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.DatasetVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def create_or_get_start_pending_upload(
        ...
        **kwargs: Any
        ...
        :type pending_upload_request: ~azure.ai.unified.autogen.models.PendingUploadRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: PendingUploadResponse. The PendingUploadResponse is compatible with MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.PendingUploadResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def create_or_get_start_pending_upload(
        ...
        **kwargs: Any
        ...
        :type pending_upload_request: ~azure.ai.unified.autogen.models.PendingUploadRequest or JSON or
         IO[bytes]
        :return: PendingUploadResponse. The PendingUploadResponse is compatible with MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.PendingUploadResponse
        :raises ~azure.core.exceptions.HttpResponseError:
...
class ModelsOperations:
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.ai.unified.autogen.models.Model
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.unified.autogen.models.Model]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.Model], deserialized["value"])
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
    ...
    def get_chat_completions(
        ...
        *,
        extra_params: Optional[Union[str, _models.ExtraParameters]] = None,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :param body: The parameters of the chat completions request. Required.
        :type body: ~azure.ai.unified.autogen.models.ChatCompletionsOptions
        ...
        :paramtype extra_params: str or ~azure.ai.unified.autogen.models.ExtraParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ChatCompletions. The ChatCompletions is compatible with MutableMapping
        :rtype: ~azure.ai.unified.autogen.models.ChatCompletions
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_chat_completions(
        self,
        body: Union[_models.ChatCompletionsOptions, JSON, IO[bytes]],
        *,
        extra_params: Optional[Union[str, _models.ExtraParameters]] = None,
        **kwargs: Any
    ) -> _models.ChatCompletions:
        ...
        :param body: The parameters of the chat completions request. Is one of the following types:
         ChatCompletionsOptions, JSON, IO[bytes] Required.
        :type body: ~azure.ai.unified.autogen.models.ChatCompletionsOptions or JSON or IO[bytes]
        :keyword extra_params: Controls what happens if extra parameters, undefined by the REST API,
         are passed in the JSON request payload.
         This sets the HTTP request header ``extra-parameters``. Known values are: "error", "drop", and
         "pass-through". Default value is None.
        ...
        _request = build_models_get_chat_completions_request(
    ...
    def get_embeddings(
        ...
        **kwargs: Any
        ...
        :param body: The parameters of the embeddings request. Required.
        :type body: ~azure.ai.unified.autogen.models.EmbeddingsOptions
        :keyword extra_params: Controls what happens if extra parameters, undefined by the REST API,
         are passed in the JSON request payload.
         This sets the HTTP request header ``extra-parameters``. Known values are: "error", "drop", and
         "pass-through". Default value is None.
        ...
        :rtype: ~azure.ai.unified.autogen.models.EmbeddingsResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_embeddings(
        self,
        body: Union[_models.EmbeddingsOptions, JSON, IO[bytes]],
        *,
        extra_params: Optional[Union[str, _models.ExtraParameters]] = None,
        **kwargs: Any
    ) -> _models.EmbeddingsResult:
        ...
        :param body: The parameters of the embeddings request. Is one of the following types:
         EmbeddingsOptions, JSON, IO[bytes] Required.
        :type body: ~azure.ai.unified.autogen.models.EmbeddingsOptions or JSON or IO[bytes]
        :keyword extra_params: Controls what happens if extra parameters, undefined by the REST API,
         are passed in the JSON request payload.
         This sets the HTTP request header ``extra-parameters``. Known values are: "error", "drop", and
         "pass-through". Default value is None.
        ...
        _request = build_models_get_embeddings_request(
            extra_params=extra_params,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
    ...
    def get_image_embeddings(
        self,
        body: _models.ImageEmbeddingsOptions,
        *,
        extra_params: Optional[Union[str, _models.ExtraParameters]] = None,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :param body: The parameters of the image embeddings request. Required.
        :type body: ~azure.ai.unified.autogen.models.ImageEmbeddingsOptions
        :keyword extra_params: Controls what happens if extra parameters, undefined by the REST API,
         are passed in the JSON request payload.
         This sets the HTTP request header ``extra-parameters``. Known values are: "error", "drop", and
         "pass-through". Default value is None.
    ...
    def get_image_embeddings(
        self,
        body: Union[_models.ImageEmbeddingsOptions, JSON, IO[bytes]],
        *,
        extra_params: Optional[Union[str, _models.ExtraParameters]] = None,
        **kwargs: Any
    ) -> _models.EmbeddingsResult:
        ...
        :param body: The parameters of the image embeddings request. Is one of the following types:
         ImageEmbeddingsOptions, JSON, IO[bytes] Required.
        :type body: ~azure.ai.unified.autogen.models.ImageEmbeddingsOptions or JSON or IO[bytes]
        :keyword extra_params: Controls what happens if extra parameters, undefined by the REST API,
         are passed in the JSON request payload.
         This sets the HTTP request header ``extra-parameters``. Known values are: "error", "drop", and
         "pass-through". Default value is None.
        ...
        _request = build_models_get_image_embeddings_request(
            extra_params=extra_params,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
...
class IndexesOperations:
    ...
    def get(self, name: str, version: str, **kwargs: Any) -> _models.Index:
        ...
        :rtype: ~azure.ai.unified.autogen.models.Index
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_index_versions(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.unified.autogen.models.Index]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
