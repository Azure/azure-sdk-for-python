...
class BaseCredential(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.unified.autogen.models.CredentialType
    """
...
class AadCredential(BaseCredential, discriminator="AAD"):
    ...
    :ivar type: Required.
    :vartype type: str or ~azure.ai.unified.autogen.models.AAD
    """

    type: Literal[CredentialType.AAD] = rest_discriminator(name="type", visibility=["read"])  # type: ignore
    """Required."""
...
class Agent(_model_base.Model):
    ...
    :vartype tools: list[~azure.ai.unified.autogen.models.ToolDefinition]
    :ivar tool_resources: A set of resources that are used by the agent's tools. The resources are
     ...
     store IDs. Required.
    :vartype tool_resources: ~azure.ai.unified.autogen.models.ToolResources
...
class AgentsApiResponseFormat(_model_base.Model):
    ...
    :ivar type: Must be one of ``text`` or ``json_object``. Known values are: "text" and
     "json_object".
    :vartype type: str or ~azure.ai.unified.autogen.models.ResponseFormat
    """
...
class AgentsNamedToolChoice(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.unified.autogen.models.AgentsNamedToolChoiceType
    :ivar function: The name of the function to call.
    :vartype function: ~azure.ai.unified.autogen.models.FunctionName
    """
...
class AgentThreadCreationOptions(_model_base.Model):
    ...
    :vartype messages: list[~azure.ai.unified.autogen.models.ThreadMessageOptions]
    :ivar tool_resources: A set of resources that are made available to the agent's tools in this
...
class ApiKeyCredential(BaseCredential, discriminator="ApiKey"):
    ...
    :vartype api_key: str
    :ivar type: Required.
    :vartype type: str or ~azure.ai.unified.autogen.models.API_KEY
    """
...
class AssetBase(_model_base.Model):
...
class AzureAISearchResource(_model_base.Model):
    ...
    :vartype index_list: list[~azure.ai.unified.autogen.models.IndexResource]
    """
...
class AzureFunctionBinding(_model_base.Model):
    ...
    :vartype storage_queue: ~azure.ai.unified.autogen.models.AzureFunctionStorageQueue
    """
...
class AzureFunctionDefinition(_model_base.Model):
    ...
    :vartype function: ~azure.ai.unified.autogen.models.FunctionDefinition
    :ivar input_binding: Input storage queue. The queue storage trigger runs a function as messages
     are added to it. Required.
    :vartype input_binding: ~azure.ai.unified.autogen.models.AzureFunctionBinding
    ...
    :vartype output_binding: ~azure.ai.unified.autogen.models.AzureFunctionBinding
    """
...
class AzureFunctionToolDefinition(ToolDefinition, discriminator="azure_function"):
    ...
    :ivar azure_function: The definition of the concrete function that the function tool should
     call. Required.
    :vartype azure_function: ~azure.ai.unified.autogen.models.AzureFunctionDefinition
    """
...
class BingGroundingToolDefinition(ToolDefinition, discriminator="bing_grounding"):
    ...
    :vartype bing_grounding: ~azure.ai.unified.autogen.models.ToolConnectionList
    """
...
class BlobReferenceForConsumption(_model_base.Model):
    ...
    :ivar blob_uri: Required.
    :vartype blob_uri: str
    :ivar storage_account_arm_id: Required.
    :vartype storage_account_arm_id: str
    :ivar credential: Required.
    :vartype credential: ~azure.ai.unified.autogen.models.SasCredential
    """
...
class ChatChoice(_model_base.Model):
    ...
    :vartype finish_reason: str or ~azure.ai.unified.autogen.models.CompletionsFinishReason
    :ivar message: The chat message for a given chat completions prompt. Required.
    :vartype message: ~azure.ai.unified.autogen.models.ChatResponseMessage
    """
...
class ChatCompletions(_model_base.Model):
    ...
    :vartype id: str
    :ivar object: The response object type, which is always ``chat.completion``. Required. Default
    ...
    :vartype choices: list[~azure.ai.unified.autogen.models.ChatChoice]
    :ivar usage: Usage information for tokens processed and generated as part of this completions
     operation. Required.
    :vartype usage: ~azure.ai.unified.autogen.models.CompletionsUsage
    """

    id: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """A unique identifier associated with this chat completions response. Required."""
    object: Literal["chat.completion"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The response object type, which is always ``chat.completion``. Required. Default value is
     \"chat.completion\"."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.object: Literal["chat.completion"] = "chat.completion"


class ChatCompletionsAudio(_model_base.Model):
    """A representation of the audio generated by the model.


    :ivar id: Unique identifier for the audio response. This value can be used in chat history
     messages instead of passing
       the full audio object. Required.
    :vartype id: str
    :ivar expires_at: The Unix timestamp (in seconds) at which the audio piece expires and can't be
     any longer referenced by its ID in
     multi-turn conversations. Required.
    :vartype expires_at: ~datetime.datetime
    :ivar data: Base64 encoded audio data. Required.
    :vartype data: str
    :ivar format: The format of the audio content. If format is not provided, it will match the
     format used in the
     input audio request. Known values are: "wav" and "mp3".
    :vartype format: str or ~azure.ai.unified.autogen.models.AudioContentFormat
    :ivar transcript: The transcript of the audio file. Required.
    :vartype transcript: str
    """

    id: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Unique identifier for the audio response. This value can be used in chat history messages
     instead of passing
       the full audio object. Required."""
    expires_at: datetime.datetime = rest_field(
        visibility=["read", "create", "update", "delete", "query"], format="unix-timestamp"
    )
    """The Unix timestamp (in seconds) at which the audio piece expires and can't be any longer
     referenced by its ID in
     multi-turn conversations. Required."""
    data: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Base64 encoded audio data. Required."""
    format: Optional[Union[str, "_models.AudioContentFormat"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """The format of the audio content. If format is not provided, it will match the format used in
     the
     input audio request. Known values are: \"wav\" and \"mp3\"."""
    transcript: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The transcript of the audio file. Required."""
    ...
    def __init__(
        ...
        *,
        ...
        data: str,
        transcript: str,
        format: Optional[Union[str, "_models.AudioContentFormat"]] = None,
    ) -> None: ...
...
class ChatCompletionsNamedToolChoice(_model_base.Model):
    ...
    :vartype function: ~azure.ai.unified.autogen.models.ChatCompletionsNamedToolChoiceFunction
    """
...
class ChatCompletionsOptions(_model_base.Model):
    ...
    :vartype messages: list[~azure.ai.unified.autogen.models.ChatRequestMessage]
    ...
    :vartype response_format: ~azure.ai.unified.autogen.models.ChatCompletionsResponseFormat
    ...
    :ivar tools: A list of tools the model may request to call. Currently, only functions are
     ...
     that function.
    :vartype tools: list[~azure.ai.unified.autogen.models.ChatCompletionsToolDefinition]
    ...
    :vartype tool_choice: str or ~azure.ai.unified.autogen.models.ChatCompletionsToolChoicePreset
     or ~azure.ai.unified.autogen.models.ChatCompletionsNamedToolChoice
    ...
    :ivar model: ID of the specific AI model to use, if more than one model is available on the
     endpoint.
    :vartype model: str
    :ivar modalities: The modalities that the model is allowed to use for the chat completions
     response. The default modality
     is ``text``. Indicating an unsupported modality combination results in an 422 error.
    :vartype modalities: list[str or ~azure.ai.unified.autogen.models.ChatCompletionsModality]
    """
    ...
    modalities: Optional[List[Union[str, "_models.ChatCompletionsModality"]]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """The modalities that the model is allowed to use for the chat completions response. The default
     modality
     is ``text``. Indicating an unsupported modality combination results in an 422 error."""
    ...
    def __init__(
        ...
        *,
        ...
        modalities: Optional[List[Union[str, "_models.ChatCompletionsModality"]]] = None,
    ) -> None: ...
...
class ChatCompletionsResponseFormatJsonSchema(ChatCompletionsResponseFormat, discriminator="json_schema"):
    ...
    :ivar json_schema: The definition of the required JSON schema in the response, and associated
     metadata. Required.
    :vartype json_schema:
     ~azure.ai.unified.autogen.models.ChatCompletionsResponseFormatJsonSchemaDefinition
    """
...
class ChatCompletionsToolCall(_model_base.Model):
    ...
    :vartype function: ~azure.ai.unified.autogen.models.FunctionCall
    """
...
class ChatMessageContentItem(_model_base.Model):
    ...
    You probably want to use the sub-classes and not this class directly. Known sub-classes are:
    ChatMessageAudioContentItem, ChatMessageImageContentItem, ChatMessageInputAudioContentItem,
...
class ChatMessageAudioContentItem(ChatMessageContentItem, discriminator="audio_url"):
    ...
    :ivar type: The discriminated object type: always 'image_url' for this type. Required. Default
     value is "audio_url".
    :vartype type: str
    :ivar audio_url: An internet location, which must be accessible to the model, from which the
     audio may be retrieved. Required.
    :vartype audio_url: ~azure.ai.unified.autogen.models.ChatMessageAudioUrl
    """
    ...
    """The discriminated object type: always 'image_url' for this type. Required. Default value is
     \"audio_url\"."""
    audio_url: "_models.ChatMessageAudioUrl" = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """An internet location, which must be accessible to the model, from which the audio may be
     retrieved. Required."""
    ...
    def __init__(
        self,
        *,
        audio_url: "_models.ChatMessageAudioUrl",
    ) -> None: ...
...
class ChatMessageImageContentItem(ChatMessageContentItem, discriminator="image_url"):
    ...
    :vartype image_url: ~azure.ai.unified.autogen.models.ChatMessageImageUrl
    """

    type: Literal["image_url"] = rest_discriminator(name="type", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
    """The discriminated object type: always 'image_url' for this type. Required. Default value is
     \"image_url\"."""
    image_url: "_models.ChatMessageImageUrl" = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class ChatMessageImageUrl(_model_base.Model):
    ...
    :vartype detail: str or ~azure.ai.unified.autogen.models.ChatMessageImageDetailLevel
    """
...
class ChatMessageInputAudioContentItem(ChatMessageContentItem, discriminator="input_audio"):
    ...
    :vartype type: str
    :ivar format: The audio format of the audio reference. Required. Known values are: "wav" and
     "mp3".
    :vartype format: str or ~azure.ai.unified.autogen.models.AudioContentFormat
    """
    ...
    """The audio format of the audio reference. Required. Known values are: \"wav\" and \"mp3\"."""
...
class ChatRequestMessage(_model_base.Model):
    ...
    :vartype role: str or ~azure.ai.unified.autogen.models.ChatRole
    """
...
class ChatRequestAssistantMessage(ChatRequestMessage, discriminator="assistant"):
    ...
    :ivar role: The chat role associated with this message, which is always 'assistant' for
     ...
     user-prompted input.
    :vartype role: str or ~azure.ai.unified.autogen.models.ASSISTANT
    ...
    :vartype tool_calls: list[~azure.ai.unified.autogen.models.ChatCompletionsToolCall]
    :ivar audio: The audio generated by a previous response in a multi-turn conversation.
    :vartype audio: ~azure.ai.unified.autogen.models.ChatRequestAudioReference
    """
    ...
    """The tool calls that must be resolved and have their outputs appended to subsequent input
     ...
     completions request to resolve as configured."""
    audio: Optional["_models.ChatRequestAudioReference"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        ...
        audio: Optional["_models.ChatRequestAudioReference"] = None,
    ) -> None: ...
...
class ChatRequestAudioReference(_model_base.Model):
    """A reference to an audio response generated by the model.

    All required parameters must be populated in order to send to server.

    :ivar id: Unique identifier for the audio response. This value corresponds to the id of a
     previous audio completion. Required.
    :vartype id: str
    """

    id: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Unique identifier for the audio response. This value corresponds to the id of a previous audio
     completion. Required."""
...
class ChatRequestSystemMessage(ChatRequestMessage, discriminator="system"):
    ...
    :vartype role: str or ~azure.ai.unified.autogen.models.SYSTEM
...
class ChatRequestToolMessage(ChatRequestMessage, discriminator="tool"):
    ...
    :ivar role: The chat role associated with this message, which is always 'tool' for tool
     ...
     operation.
    :vartype role: str or ~azure.ai.unified.autogen.models.TOOL
    :ivar content: The content of the message.
    :vartype content: str
...
class ChatRequestUserMessage(ChatRequestMessage, discriminator="user"):
    ...
    :vartype role: str or ~azure.ai.unified.autogen.models.USER
    ...
    :vartype content: str or list[~azure.ai.unified.autogen.models.ChatMessageContentItem]
    """
...
class ChatResponseMessage(_model_base.Model):
    ...
    :ivar tool_calls: The tool calls that must be resolved and have their outputs appended to
     ...
     completions request to resolve as configured.
    :vartype tool_calls: list[~azure.ai.unified.autogen.models.ChatCompletionsToolCall]
    :ivar audio: The audio generated by the model as a response to the messages if the model is
     configured to generate audio.
    :vartype audio: ~azure.ai.unified.autogen.models.ChatCompletionsAudio
    """
    ...
    """The tool calls that must be resolved and have their outputs appended to subsequent input
     messages for the chat
     completions request to resolve as configured."""
    audio: Optional["_models.ChatCompletionsAudio"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """The audio generated by the model as a response to the messages if the model is configured to
     generate audio."""
    ...
    def __init__(
        ...
        *,
        ...
        content: str,
        tool_calls: Optional[List["_models.ChatCompletionsToolCall"]] = None,
        audio: Optional["_models.ChatCompletionsAudio"] = None,
    ) -> None: ...
...
class CodeInterpreterToolResource(_model_base.Model):
    ...
    :ivar data_sources: The data sources to be used. This option is mutually exclusive with the
     ``fileIds`` property.
    :vartype data_sources: list[~azure.ai.unified.autogen.models.VectorStoreDataSource]
    """
...
class CompletionsUsage(_model_base.Model):
    ...
    :vartype completion_tokens_details: ~azure.ai.unified.autogen.models.CompletionsUsageDetails
    :ivar prompt_tokens_details: Breakdown of tokens used in the prompt/chat history.
    :vartype prompt_tokens_details: ~azure.ai.unified.autogen.models.PromptUsageDetails
    """
...
class Connection(_model_base.Model):
    ...
    credentials: "_models.BaseCredential" = rest_field(visibility=["read"])
...
class DatasetVersion(AssetBase):
    """DatasetVersion Definition.

    You probably want to use the sub-classes and not this class directly. Known sub-classes are:
    UriFileDatasetVersion, UriFolderDatasetVersion
    ...
    :ivar dataset_type: Data type. Required. Known values are: "uri_file" and "uri_folder".
    :vartype dataset_type: str or ~azure.ai.unified.autogen.models.DatasetType
    """
    ...
    dataset_type: str = rest_discriminator(
...
class EmbeddingItem(_model_base.Model):
    ...
    :ivar object: The object type of this embeddings item. Will always be ``embedding``. Required.
     Default value is "embedding".
    :vartype object: str
    """

    embedding: List[float] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    ...
    object: Literal["embedding"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The object type of this embeddings item. Will always be ``embedding``. Required. Default value
     is \"embedding\"."""
...
class EmbeddingsOptions(_model_base.Model):
    ...
    :vartype encoding_format: str or ~azure.ai.unified.autogen.models.EmbeddingEncodingFormat
    ...
    :vartype input_type: str or ~azure.ai.unified.autogen.models.EmbeddingInputType
    :ivar model: ID of the specific AI model to use, if more than one model is available on the
     endpoint.
    :vartype model: str
    """
...
class EmbeddingsResult(_model_base.Model):
    ...
    :vartype data: list[~azure.ai.unified.autogen.models.EmbeddingItem]
    :ivar usage: Usage counts for tokens input using the embeddings API. Required.
    :vartype usage: ~azure.ai.unified.autogen.models.EmbeddingsUsage
    ...
    """The object type of the embeddings result. Will always be ``list``. Required. Default value is
     \"list\"."""
    model: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class Evaluation(_model_base.Model):
    ...
    :vartype data: ~azure.ai.unified.autogen.models.InputData
    ...
    :vartype evaluators: dict[str, ~azure.ai.unified.autogen.models.EvaluatorConfiguration]
    """
...
class FileListResponse(_model_base.Model):
    ...
    :vartype data: list[~azure.ai.unified.autogen.models.OpenAIFile]
    """
...
class FileSearchToolDefinition(ToolDefinition, discriminator="file_search"):
    ...
    :vartype file_search: ~azure.ai.unified.autogen.models.FileSearchToolDefinitionDetails
    """
...
class FileSearchToolDefinitionDetails(_model_base.Model):
    ...
    :vartype ranking_options: ~azure.ai.unified.autogen.models.FileSearchRankingOptions
    """
...
class FileSearchToolResource(_model_base.Model):
    ...
    :vartype vector_stores: list[~azure.ai.unified.autogen.models.VectorStoreConfigurations]
    """
...
class ImageEmbeddingsOptions(_model_base.Model):
    ...
    :vartype input: list[~azure.ai.unified.autogen.models.ImageEmbeddingInput]
    :ivar dimensions: Optional. The number of dimensions the resulting output embeddings should
     have.
     Passing null causes the model to use its default value.
     Returns a 422 error if the model doesn't support the value or parameter.
...
class IncompleteRunDetails(_model_base.Model):
    ...
    :ivar reason: The reason why the run is incomplete. This indicates which specific token limit
     ...
     "max_prompt_tokens".
    :vartype reason: str or ~azure.ai.unified.autogen.models.IncompleteDetailsReason
    """
...
class MessageAttachment(_model_base.Model):
    ...
    :vartype data_source: ~azure.ai.unified.autogen.models.VectorStoreDataSource
    :ivar tools: The tools to add to this file. Required.
    :vartype tools: list[~azure.ai.unified.autogen.models.CodeInterpreterToolDefinition or
     ~azure.ai.unified.autogen.models.FileSearchToolDefinition]
    """
...
class MessageImageFileContent(MessageContent, discriminator="image_file"):
    ...
    :vartype image_file: ~azure.ai.unified.autogen.models.MessageImageFileDetails
    """
...
class MessageIncompleteDetails(_model_base.Model):
    ...
    :ivar reason: The provided reason describing why the message was marked as incomplete.
     ...
     "run_expired".
    :vartype reason: str or ~azure.ai.unified.autogen.models.MessageIncompleteDetailsReason
    """
...
class MessageTextContent(MessageContent, discriminator="text"):
    ...
    :vartype text: ~azure.ai.unified.autogen.models.MessageTextDetails
    """
...
class MessageTextDetails(_model_base.Model):
    ...
    :vartype annotations: list[~azure.ai.unified.autogen.models.MessageTextAnnotation]
    """
...
class MessageTextFileCitationAnnotation(MessageTextAnnotation, discriminator="file_citation"):
    ...
    :vartype file_citation: ~azure.ai.unified.autogen.models.MessageTextFileCitationDetails
...
class MessageTextFilePathAnnotation(MessageTextAnnotation, discriminator="file_path"):
    ...
    :vartype file_path: ~azure.ai.unified.autogen.models.MessageTextFilePathDetails
    :ivar start_index: The first text index associated with this text annotation.
    :vartype start_index: int
    :ivar end_index: The last text index associated with this text annotation.
    :vartype end_index: int
...
class MicrosoftFabricToolDefinition(ToolDefinition, discriminator="fabric_aiskill"):
    ...
    :vartype fabric_aiskill: ~azure.ai.unified.autogen.models.ToolConnectionList
    """
...
class Model(_model_base.Model):
    ...
    :vartype sku: ~azure.ai.unified.autogen.models.Sku
...
class OpenAIFile(_model_base.Model):
    ...
    :vartype purpose: str or ~azure.ai.unified.autogen.models.FilePurpose
    ...
    :vartype status: str or ~azure.ai.unified.autogen.models.FileState
...
class OpenAIPageableListOfAgent(_model_base.Model):
    ...
    :vartype data: list[~azure.ai.unified.autogen.models.Agent]
...
class OpenAIPageableListOfRunStep(_model_base.Model):
    ...
    :vartype object: str
    :ivar data: The requested list of items. Required.
    :vartype data: list[~azure.ai.unified.autogen.models.RunStep]
    :ivar first_id: The first ID represented in this list. Required.
    :vartype first_id: str
    :ivar last_id: The last ID represented in this list. Required.
    :vartype last_id: str
...
class OpenAIPageableListOfThreadMessage(_model_base.Model):
    ...
    :vartype object: str
    :ivar data: The requested list of items. Required.
    :vartype data: list[~azure.ai.unified.autogen.models.ThreadMessage]
    :ivar first_id: The first ID represented in this list. Required.
    :vartype first_id: str
    :ivar last_id: The last ID represented in this list. Required.
    :vartype last_id: str
...
class OpenAIPageableListOfThreadRun(_model_base.Model):
    ...
    :vartype object: str
    :ivar data: The requested list of items. Required.
    :vartype data: list[~azure.ai.unified.autogen.models.ThreadRun]
    :ivar first_id: The first ID represented in this list. Required.
    :vartype first_id: str
    :ivar last_id: The last ID represented in this list. Required.
    :vartype last_id: str
...
class OpenAIPageableListOfVectorStore(_model_base.Model):
    ...
    :vartype object: str
    :ivar data: The requested list of items. Required.
    :vartype data: list[~azure.ai.unified.autogen.models.VectorStore]
    :ivar first_id: The first ID represented in this list. Required.
    :vartype first_id: str
    :ivar last_id: The last ID represented in this list. Required.
    :vartype last_id: str
...
class OpenAIPageableListOfVectorStoreFile(_model_base.Model):
    ...
    :vartype object: str
    :ivar data: The requested list of items. Required.
    :vartype data: list[~azure.ai.unified.autogen.models.VectorStoreFile]
    :ivar first_id: The first ID represented in this list. Required.
    :vartype first_id: str
    :ivar last_id: The last ID represented in this list. Required.
    :vartype last_id: str
...
class OpenApiAuthDetails(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.unified.autogen.models.OpenApiAuthType
    """
...
class OpenApiAnonymousAuthDetails(OpenApiAuthDetails, discriminator="anonymous"):
    ...
    :vartype type: str or ~azure.ai.unified.autogen.models.ANONYMOUS
    """
...
class OpenApiConnectionAuthDetails(OpenApiAuthDetails, discriminator="connection"):
    ...
    :vartype type: str or ~azure.ai.unified.autogen.models.CONNECTION
    :ivar security_scheme: Connection auth security details. Required.
    :vartype security_scheme: ~azure.ai.unified.autogen.models.OpenApiConnectionSecurityScheme
    """
...
class OpenApiFunctionDefinition(_model_base.Model):
    ...
    :vartype auth: ~azure.ai.unified.autogen.models.OpenApiAuthDetails
    """
...
class OpenApiManagedAuthDetails(OpenApiAuthDetails, discriminator="managed_identity"):
    ...
    :vartype type: str or ~azure.ai.unified.autogen.models.MANAGED_IDENTITY
    :ivar security_scheme: Connection auth security details. Required.
    :vartype security_scheme: ~azure.ai.unified.autogen.models.OpenApiManagedSecurityScheme
    """
...
class OpenApiToolDefinition(ToolDefinition, discriminator="openapi"):
    ...
    :vartype openapi: ~azure.ai.unified.autogen.models.OpenApiFunctionDefinition
    """
...
class PendingUploadRequest(_model_base.Model):
    ...
    :ivar pending_upload_id:
    :vartype pending_upload_id: str
    :ivar pending_upload_type: Required.
    :vartype pending_upload_type: str or ~azure.ai.unified.autogen.models.TEMPORARY_BLOB_REFERENCE
    """
...
class PendingUploadResponse(_model_base.Model):
    ...
    :ivar blob_reference_for_consumption: Required.
    :vartype blob_reference_for_consumption:
     ~azure.ai.unified.autogen.models.BlobReferenceForConsumption
    :ivar pending_upload_id: Required.
    :vartype pending_upload_id: str
    :ivar pending_upload_type: Required.
    :vartype pending_upload_type: str or ~azure.ai.unified.autogen.models.TEMPORARY_BLOB_REFERENCE
    """
...
class RequiredFunctionToolCall(RequiredToolCall, discriminator="function"):
    ...
    :vartype function: ~azure.ai.unified.autogen.models.RequiredFunctionToolCallDetails
    """
...
class ResponseFormatJsonSchemaType(_model_base.Model):
    ...
    :vartype json_schema: ~azure.ai.unified.autogen.models.ResponseFormatJsonSchema
    """
...
class RunStep(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.unified.autogen.models.RunStepType
    ...
    :vartype status: str or ~azure.ai.unified.autogen.models.RunStepStatus
    :ivar step_details: The details for this run step. Required.
    :vartype step_details: ~azure.ai.unified.autogen.models.RunStepDetails
    :ivar last_error: If applicable, information about the last error encountered by this run step.
     Required.
    :vartype last_error: ~azure.ai.unified.autogen.models.RunStepError
    :ivar created_at: The Unix timestamp, in seconds, representing when this object was created.
     Required.
    :vartype created_at: ~datetime.datetime
    ...
    :vartype usage: ~azure.ai.unified.autogen.models.RunStepCompletionUsage
    :ivar metadata: A set of up to 16 key/value pairs that can be attached to an object, used for
     storing additional information about that object in a structured format. Keys may be up to 64
     characters in length and values may be up to 512 characters in length. Required.
    :vartype metadata: dict[str, str]
...
class RunStepCodeInterpreterImageOutput(RunStepCodeInterpreterToolCallOutput, discriminator="image"):
    ...
    :vartype image: ~azure.ai.unified.autogen.models.RunStepCodeInterpreterImageReference
    """
...
class RunStepCodeInterpreterToolCall(RunStepToolCall, discriminator="code_interpreter"):
    ...
    :vartype code_interpreter:
     ~azure.ai.unified.autogen.models.RunStepCodeInterpreterToolCallDetails
    """
...
class RunStepCodeInterpreterToolCallDetails(_model_base.Model):
    ...
    :vartype outputs: list[~azure.ai.unified.autogen.models.RunStepCodeInterpreterToolCallOutput]
    """
...
class RunStepError(_model_base.Model):
    ...
    :ivar code: The error code for this error. Required. Known values are: "server_error" and
     "rate_limit_exceeded".
    :vartype code: str or ~azure.ai.unified.autogen.models.RunStepErrorCode
...
class RunStepFileSearchToolCall(RunStepToolCall, discriminator="file_search"):
    ...
    :vartype file_search: ~azure.ai.unified.autogen.models.RunStepFileSearchToolCallResults
    """
...
class RunStepFileSearchToolCallResult(_model_base.Model):
    ...
    :vartype content: list[~azure.ai.unified.autogen.models.FileSearchToolCallContent]
    """
...
class RunStepFileSearchToolCallResults(_model_base.Model):
    ...
    :vartype results: list[~azure.ai.unified.autogen.models.RunStepFileSearchToolCallResult]
    """
...
class RunStepFunctionToolCall(RunStepToolCall, discriminator="function"):
    ...
    :vartype function: ~azure.ai.unified.autogen.models.RunStepFunctionToolCallDetails
    """
...
class RunStepMessageCreationDetails(RunStepDetails, discriminator="message_creation"):
    ...
    :vartype type: str or ~azure.ai.unified.autogen.models.MESSAGE_CREATION
    :ivar message_creation: Information about the message creation associated with this run step.
     Required.
    :vartype message_creation: ~azure.ai.unified.autogen.models.RunStepMessageCreationReference
    """
...
class RunStepToolCallDetails(RunStepDetails, discriminator="tool_calls"):
    ...
    :ivar type: The object type, which is always 'tool_calls'. Required. Represents a run step that
     calls tools.
    :vartype type: str or ~azure.ai.unified.autogen.models.TOOL_CALLS
    :ivar tool_calls: A list of tool call details for this run step. Required.
    :vartype tool_calls: list[~azure.ai.unified.autogen.models.RunStepToolCall]
    """
...
class SasCredential(BaseCredential, discriminator="SAS"):
    ...
    :ivar type: Required.
    :vartype type: str or ~azure.ai.unified.autogen.models.SAS
    """
...
class SharepointToolDefinition(ToolDefinition, discriminator="sharepoint_grounding"):
    ...
    :vartype sharepoint_grounding: ~azure.ai.unified.autogen.models.ToolConnectionList
    """
...
class SubmitToolOutputsAction(RequiredAction, discriminator="submit_tool_outputs"):
    ...
    :ivar submit_tool_outputs: The details describing tools that should be called to submit tool
     outputs. Required.
    :vartype submit_tool_outputs: ~azure.ai.unified.autogen.models.SubmitToolOutputsDetails
    """
...
class SubmitToolOutputsDetails(_model_base.Model):
    ...
    :ivar tool_calls: The list of tool calls that must be resolved for the agent thread run to
     continue. Required.
    :vartype tool_calls: list[~azure.ai.unified.autogen.models.RequiredToolCall]
    """
...
class ThreadMessage(_model_base.Model):
    ...
    :vartype status: str or ~azure.ai.unified.autogen.models.MessageStatus
    :ivar incomplete_details: On an incomplete message, details about why the message is
     incomplete. Required.
    :vartype incomplete_details: ~azure.ai.unified.autogen.models.MessageIncompleteDetails
    ...
    :ivar role: The role associated with the agent thread message. Required. Known values are:
     "user" and "assistant".
    :vartype role: str or ~azure.ai.unified.autogen.models.MessageRole
    :ivar content: The list of content items associated with the agent thread message. Required.
    :vartype content: list[~azure.ai.unified.autogen.models.MessageContent]
    ...
    :ivar attachments: A list of files attached to the message, and the tools they were added to.
     Required.
    :vartype attachments: list[~azure.ai.unified.autogen.models.MessageAttachment]
    :ivar metadata: A set of up to 16 key/value pairs that can be attached to an object, used for
     storing additional information about that object in a structured format. Keys may be up to 64
     characters in length and values may be up to 512 characters in length. Required.
    :vartype metadata: dict[str, str]
...
class ThreadRun(_model_base.Model):
    ...
    :ivar status: The status of the agent thread run. Required. Known values are: "queued",
     ...
     "expired".
    :vartype status: str or ~azure.ai.unified.autogen.models.RunStatus
    :ivar required_action: The details of the action required for the agent thread run to continue.
    :vartype required_action: ~azure.ai.unified.autogen.models.RequiredAction
    :ivar last_error: The last error, if any, encountered by this agent thread run. Required.
    :vartype last_error: ~azure.ai.unified.autogen.models.RunError
    :ivar model: The ID of the model to use. Required.
    :vartype model: str
    ...
    :vartype incomplete_details: ~azure.ai.unified.autogen.models.IncompleteRunDetails
    ...
    :vartype usage: ~azure.ai.unified.autogen.models.RunCompletionUsage
    ...
    :vartype truncation_strategy: ~azure.ai.unified.autogen.models.TruncationObject
    ...
    :vartype tool_resources: ~azure.ai.unified.autogen.models.UpdateToolResourcesOptions
...
class ToolConnectionList(_model_base.Model):
    ...
    :vartype connection_list: list[~azure.ai.unified.autogen.models.ToolConnection]
    """
...
class ToolResources(_model_base.Model):
    ...
    :ivar code_interpreter: Resources to be used by the ``code_interpreter`` tool consisting of
     file IDs.
    :vartype code_interpreter: ~azure.ai.unified.autogen.models.CodeInterpreterToolResource
    :ivar file_search: Resources to be used by the ``file_search`` tool consisting of vector store
     IDs.
    :vartype file_search: ~azure.ai.unified.autogen.models.FileSearchToolResource
    :ivar azure_ai_search: Resources to be used by the ``azure_ai_search`` tool consisting of index
     IDs and names.
    :vartype azure_ai_search: ~azure.ai.unified.autogen.models.AzureAISearchResource
    """
...
class TruncationObject(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.unified.autogen.models.TruncationStrategy
...
class UpdateToolResourcesOptions(_model_base.Model):
    ...
    :ivar code_interpreter: Overrides the list of file IDs made available to the
     ...
     associated with the tool.
    :vartype code_interpreter:
     ~azure.ai.unified.autogen.models.UpdateCodeInterpreterToolResourceOptions
    ...
    :vartype file_search: ~azure.ai.unified.autogen.models.UpdateFileSearchToolResourceOptions
...
class UriFileDatasetVersion(DatasetVersion, discriminator="uri_file"):
    """UriFileDatasetVersion Definition.
    ...
    :ivar dataset_uri: [Required] Uri of the data. Example:
     https://go.microsoft.com/fwlink/?linkid=2202330. Required.
    :vartype dataset_uri: str
    :ivar dataset_type: [Required] Specifies the type of data. Required. URI file.
    :vartype dataset_type: str or ~azure.ai.unified.autogen.models.URI_FILE
    """

    dataset_type: Literal[DatasetType.URI_FILE] = rest_discriminator(name="datasetType", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, dataset_type=DatasetType.URI_FILE, **kwargs)


class UriFolderDatasetVersion(DatasetVersion, discriminator="uri_folder"):
    """UriFolderDatasetVersion Definition.
    ...
    :ivar dataset_uri: [Required] Uri of the data. Example:
     https://go.microsoft.com/fwlink/?linkid=2202330. Required.
    :vartype dataset_uri: str
    :ivar dataset_type: [Required] Specifies the type of data. Required. URI folder.
    :vartype dataset_type: str or ~azure.ai.unified.autogen.models.URI_FOLDER
    """

    dataset_type: Literal[DatasetType.URI_FOLDER] = rest_discriminator(name="datasetType", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, dataset_type=DatasetType.URI_FOLDER, **kwargs)
...
class VectorStore(_model_base.Model):
    ...
    :ivar file_counts: Files count grouped by status processed or being processed by this vector
     store. Required.
    :vartype file_counts: ~azure.ai.unified.autogen.models.VectorStoreFileCount
    ...
    :vartype status: str or ~azure.ai.unified.autogen.models.VectorStoreStatus
    :ivar expires_after: Details on when this vector store expires.
    :vartype expires_after: ~azure.ai.unified.autogen.models.VectorStoreExpirationPolicy
...
class VectorStoreChunkingStrategyRequest(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.unified.autogen.models.VectorStoreChunkingStrategyRequestType
    """
...
class VectorStoreAutoChunkingStrategyRequest(VectorStoreChunkingStrategyRequest, discriminator="auto"):
    ...
    :vartype type: str or ~azure.ai.unified.autogen.models.AUTO
    """
...
class VectorStoreChunkingStrategyResponse(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.unified.autogen.models.VectorStoreChunkingStrategyResponseType
    """
...
class VectorStoreAutoChunkingStrategyResponse(VectorStoreChunkingStrategyResponse, discriminator="other"):
    ...
    :vartype type: str or ~azure.ai.unified.autogen.models.OTHER
    """
...
class VectorStoreConfigurations(_model_base.Model):
    ...
    :vartype store_configuration: ~azure.ai.unified.autogen.models.VectorStoreConfiguration
    """
...
class VectorStoreDataSource(_model_base.Model):
    ...
    :vartype asset_type: str or ~azure.ai.unified.autogen.models.VectorStoreDataSourceAssetType
    """
...
class VectorStoreExpirationPolicy(_model_base.Model):
    ...
    :vartype anchor: str or ~azure.ai.unified.autogen.models.VectorStoreExpirationPolicyAnchor
...
class VectorStoreFile(_model_base.Model):
    ...
    :vartype status: str or ~azure.ai.unified.autogen.models.VectorStoreFileStatus
    :ivar last_error: The last error associated with this vector store file. Will be ``null`` if
     there are no errors. Required.
    :vartype last_error: ~azure.ai.unified.autogen.models.VectorStoreFileError
    :ivar chunking_strategy: The strategy used to chunk the file. Required.
    :vartype chunking_strategy:
     ~azure.ai.unified.autogen.models.VectorStoreChunkingStrategyResponse
    """
...
class VectorStoreFileBatch(_model_base.Model):
    ...
    :vartype status: str or ~azure.ai.unified.autogen.models.VectorStoreFileBatchStatus
    :ivar file_counts: Files count grouped by status processed or being processed by this vector
     store. Required.
    :vartype file_counts: ~azure.ai.unified.autogen.models.VectorStoreFileCount
    """
...
class VectorStoreFileError(_model_base.Model):
    ...
    :vartype code: str or ~azure.ai.unified.autogen.models.VectorStoreFileErrorCode
...
class VectorStoreStaticChunkingStrategyRequest(VectorStoreChunkingStrategyRequest, discriminator="static"):
    ...
    :vartype type: str or ~azure.ai.unified.autogen.models.STATIC
    :ivar static: The options for the static chunking strategy. Required.
    :vartype static: ~azure.ai.unified.autogen.models.VectorStoreStaticChunkingStrategyOptions
    """
