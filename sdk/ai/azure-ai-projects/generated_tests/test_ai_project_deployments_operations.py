...
class TestAIProjectDeploymentsOperations(AIProjectClientTestBase):
    @AIProjectPreparer()
    @recorded_by_proxy
    def test_deployments_get(self, aiproject_endpoint):
    ...
    @AIProjectPreparer()
    @recorded_by_proxy
    def test_deployments_list(self, aiproject_endpoint):
        client = self.create_client(endpoint=aiproject_endpoint)
