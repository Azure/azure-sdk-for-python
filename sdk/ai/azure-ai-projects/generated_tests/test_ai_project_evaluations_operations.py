...
class TestAIProjectEvaluationsOperations(AIProjectClientTestBase):
    ...
    @AIProjectPreparer()
    @recorded_by_proxy
    def test_evaluations_cancel(self, aiproject_endpoint):
        client = self.create_client(endpoint=aiproject_endpoint)
        response = client.evaluations.cancel(
            name="str",
        )
    ...
    @AIProjectPreparer()
    @recorded_by_proxy
    def test_evaluations_delete(self, aiproject_endpoint):
        client = self.create_client(endpoint=aiproject_endpoint)
        response = client.evaluations.delete(
            name="str",
        )
