...
class TestAIProjectEvaluationsOperationsAsync(AIProjectClientTestBaseAsync):
    ...
    @AIProjectPreparer()
    @recorded_by_proxy_async
    async def test_evaluations_cancel(self, aiproject_endpoint):
        client = self.create_async_client(endpoint=aiproject_endpoint)
        response = await client.evaluations.cancel(
            name="str",
        )
    ...
    @AIProjectPreparer()
    @recorded_by_proxy_async
    async def test_evaluations_delete(self, aiproject_endpoint):
        client = self.create_async_client(endpoint=aiproject_endpoint)
        response = await client.evaluations.delete(
            name="str",
        )
