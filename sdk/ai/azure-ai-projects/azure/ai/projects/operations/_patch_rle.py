...
import threading
import time
from typing import IO, Any, Dict, List, Literal, Mapping, Optional, Union
...
class OpenEnvClient:
    ...
    :keyword num_instances: Number of instances (leased sandboxes) to reserve in advance. Defaults to
     1 and may not exceed 10.
...
class RLEOperations:
    ...
    def create_environment(
        ...
        """
        return self._environments.create_environment(body, foundry_features=_RLE_FEATURE, **kwargs)
    ...
    def get_environment(self, name: str, **kwargs: Any) -> RLEnvironment:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return self._environments.get_environment(name, foundry_features=_RLE_FEATURE, **kwargs)
    ...
    def get_environment_version(self, name: str, version: str, **kwargs: Any) -> RLEnvironment:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return self._environments.get_environment_version(
    ...
    def list_environment_versions(self, name: str, **kwargs: Any) -> List[RLEnvironmentVersion]:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return self._environments.list_rl_environment_versions(name, foundry_features=_RLE_FEATURE, **kwargs)
    ...
    def delete_environment_version(self, name: str, version: str, **kwargs: Any) -> None:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        self._environments.delete_environment_version(name, version, foundry_features=_RLE_FEATURE, **kwargs)
    ...
    def get_openenv_client(
        ...
        *,
        ...
        :keyword num_instances: Number of instances (leased sandboxes) to reserve in advance, so that
         several episodes can run concurrently. Defaults to 1 and may not exceed 10.
        :paramtype num_instances: int
        :keyword create_timeout_s: Maximum time to wait for each instance to become ready, in seconds.
         Default value is 300.
        :paramtype create_timeout_s: float
