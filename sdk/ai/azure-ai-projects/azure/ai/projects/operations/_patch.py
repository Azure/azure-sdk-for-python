...
class AgentsOperations(AgentsOperationsGenerated):
    ...
    def create_message(
        ...
        thread_id: str,
        *,
        role: Union[str, _models.MessageRole] = _models.MessageRole.USER,
        content: str,
        content_type: str = "application/json",
    ...
    def create_message(
        ...
        **kwargs: Any,
        ...
        if body is not _Unset:  # Handle overload with JSON or IOBytes body.
            response = super().create_message(thread_id, body, content_type=content_type, **kwargs)

        elif content is not _Unset:  # Handle overload with keyword arguments.
            response = super().create_message(
                thread_id,
                role=role,
                content=content,
                metadata=metadata,
