...
def build_agent_optimization_jobs_get_candidate_file_request(  # pylint: disable=name-too-long
...
def build_agent_optimization_jobs_promote_candidate_request(  # pylint: disable=name-too-long
