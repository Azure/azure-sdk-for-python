...
class EvaluationsOperations:
    ...
    @distributed_trace
    def get(self, id: str, **kwargs: Any) -> _models1.Evaluation:
        ...
        cls: ClsType[_models1.Evaluation] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.Evaluation, response.json())
    ...
    @overload
    def create(
        self, evaluation: _models1.Evaluation, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models1.Evaluation:
        """Run the evaluation.
    ...
    @overload
    def create(self, evaluation: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models1.Evaluation:
        """Run the evaluation.
    ...
    @distributed_trace
    def create(self, evaluation: Union[_models1.Evaluation, JSON, IO[bytes]], **kwargs: Any) -> _models1.Evaluation:
        """Run the evaluation.
    ...
    def list(
        ...
        cls: ClsType[List[_models1.Evaluation]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models1.Evaluation], deserialized.get("value", []))
            if cls:
    ...
    @distributed_trace
    def update(
        self, id: str, resource: Union[_models1.Evaluation, JSON, IO[bytes]], **kwargs: Any
    ) -> _models1.Evaluation:
        """Resource update operation template.
    ...
    @distributed_trace
    def get_schedule(self, name: str, **kwargs: Any) -> _models1.EvaluationSchedule:
        """Resource read operation template.
        ...
        cls: ClsType[_models1.EvaluationSchedule] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.EvaluationSchedule, response.json())
    ...
    def create_or_replace_schedule(
        self, name: str, resource: _models1.EvaluationSchedule, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models1.EvaluationSchedule:
    ...
    @distributed_trace
    def create_or_replace_schedule(
        self, name: str, resource: Union[_models1.EvaluationSchedule, JSON, IO[bytes]], **kwargs: Any
    ) -> _models1.EvaluationSchedule:
        """Create or replace operation template.
    ...
    def list_schedule(
        self, *, top: Optional[int] = None, skip: Optional[int] = None, **kwargs: Any
    ) -> Iterable["_models1.EvaluationSchedule"]:
        """Resource list operation template.
        ...
        maxpagesize = kwargs.pop("maxpagesize", None)
        cls: ClsType[List[_models1.EvaluationSchedule]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models1.EvaluationSchedule], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
