...
def build_agents_generate_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_beta_voice_agent_web_socket_connect_request(  # pylint: disable=name-too-long
    agent_name: str,
    *,
    ...
    **kwargs: Any
    ...
    # Construct parameters
    if foundry_features_query is not None:
        _params["foundry_features"] = _SERIALIZER.query("foundry_features_query", foundry_features_query, "str")
...
def build_beta_agent_endpoint_conversations_list_request(  # pylint: disable=name-too-long
    agent_name: str,
    *,
    limit: Optional[int] = None,
    order: Optional[Union[str, _models.PageOrder]] = None,
...
def build_beta_agent_endpoint_conversations_get_request(  # pylint: disable=name-too-long
...
def build_beta_agent_endpoint_conversations_delete_request(  # pylint: disable=name-too-long
    agent_name: str, conversation_id: str, **kwargs: Any
) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_beta_agent_endpoint_conversations_list_responses_request(  # pylint: disable=name-too-long
    agent_name: str,
    conversation_id: str,
    *,
    limit: Optional[int] = None,
...
def build_beta_agent_endpoint_conversations_get_response_request(  # pylint: disable=name-too-long
...
def build_beta_agent_endpoint_conversations_list_response_items_request(  # pylint: disable=name-too-long
    agent_name: str,
    conversation_id: str,
    response_id: str,
    *,
...
def build_beta_agent_endpoint_conversations_list_items_request(  # pylint: disable=name-too-long
    agent_name: str,
    conversation_id: str,
    *,
    limit: Optional[int] = None,
...
def build_beta_agent_endpoint_conversations_get_item_request(  # pylint: disable=name-too-long
...
def build_beta_agent_endpoint_conversations_get_item_recording_request(  # pylint: disable=name-too-long
    agent_name: str, conversation_id: str, item_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_beta_agent_endpoint_conversations_download_item_recording_request(  # pylint: disable=name-too-long
    agent_name: str, conversation_id: str, item_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_beta_agent_endpoint_conversations_get_recording_request(  # pylint: disable=name-too-long
    agent_name: str, conversation_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_beta_agent_endpoint_conversations_download_recording_request(  # pylint: disable=name-too-long
    agent_name: str, conversation_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class AgentsOperations:  # pylint: disable=docstring-missing-param,too-many-public-methods
    ...
    @overload
    def generate(self, body: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models.AgentDetails:
        """Generate an agent.
...
class BetaAgentEndpointConversationsOperations:  # pylint: disable=docstring-missing-param
    ...
    @distributed_trace
    def get_recording(self, agent_name: str, conversation_id: str, **kwargs: Any) -> _models.VoiceRecordingResponse:
    ...
    @distributed_trace
    def download_recording(self, agent_name: str, conversation_id: str, **kwargs: Any) -> Iterator[bytes]:
