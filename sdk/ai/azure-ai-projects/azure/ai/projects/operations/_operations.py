...
def build_evaluators_create_version_request(
    name: str, *, foundry_features: Union[str, Literal[FoundryFeaturesOptInKeys.EVALUATIONS_V1_PREVIEW]], **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_insights_generate_request(
    *, foundry_features: Union[str, Literal[FoundryFeaturesOptInKeys.INSIGHTS_V1_PREVIEW]], **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_memory_stores_create_request(
    *, foundry_features: Union[str, Literal[FoundryFeaturesOptInKeys.MEMORY_STORES_V1_PREVIEW]], **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
