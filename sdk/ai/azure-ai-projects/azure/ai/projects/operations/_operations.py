...
def build_beta_agents_create_or_update_managed_identity_blueprint_request(  # pylint: disable=name-too-long
...
def build_beta_agents_get_managed_identity_blueprint_request(  # pylint: disable=name-too-long
    blueprint_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_beta_agents_delete_managed_identity_blueprint_request(  # pylint: disable=name-too-long
    blueprint_name: str, **kwargs: Any
) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_beta_agents_list_managed_identity_blueprints_request(  # pylint: disable=name-too-long
...
class BetaAgentsOperations:
    ...
    @overload
    def create_or_update_managed_identity_blueprint(  # pylint: disable=name-too-long
    ...
    @distributed_trace
    def get_managed_identity_blueprint(
    ...
    @distributed_trace
    def delete_managed_identity_blueprint(  # pylint: disable=inconsistent-return-statements
        self, blueprint_name: str, **kwargs: Any
    ) -> None:
    ...
    @distributed_trace
    def list_managed_identity_blueprints(
