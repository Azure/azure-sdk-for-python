...
def build_agents_download_agent_version_code_request(  # pylint: disable=name-too-long
...
def build_agents_download_agent_code_request(agent_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
