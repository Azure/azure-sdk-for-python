...
class PendingUploadRequest(_Model):
    ...
    :ivar connection_name: Azure Storage Account connection name to use for generating temporary
     SAS token.
    :vartype connection_name: str
    :ivar pending_upload_type: The type of pending upload. Required. Blob Reference is the only
     supported type.
    ...
    """The type of pending upload. Required. Blob Reference is the only supported type."""
