...
class ThreadMessageOptions(_model_base.Model):
     ...
     * `user`:
     Indicates the message is sent by an actual user and should be used in most
     ...
     * An array of typed content blocks (e.g., text, image_file, image_url, etc.). Required. Is
     either a str type or a [MessageInputContentBlock] type.
