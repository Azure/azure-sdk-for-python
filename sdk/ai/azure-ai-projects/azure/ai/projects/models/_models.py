...
class Item(_Model):
    ...
    You probably want to use the sub-classes and not this class directly. Known sub-classes are:
    ItemApplyPatchToolCallItemParam, ItemApplyPatchToolCallOutputItemParam,
    ItemCodeInterpreterToolCall, ItemCompactionSummaryItemParam, ItemComputerToolCall,
    ItemComputerCallOutputItemParam, ItemCustomToolCall, ItemCustomToolCallOutput,
    ItemFileSearchToolCall, ItemFunctionToolCall, ItemFunctionCallOutputItemParam,
    ItemImageGenToolCall, ItemLocalShellToolCall, ItemLocalShellToolCallOutput,
    ItemMcpApprovalRequest, ItemMcpApprovalResponse, ItemMcpToolCall, ItemMcpListTools,
    MemorySearchToolCallItemParam, InputMessage, ItemOutputMessage, ItemReasoningItem,
    ItemFunctionShellCallItemParam, ItemFunctionShellCallOutputItemParam, ItemWebSearchToolCall
...
class ItemApplyPatchToolCallItemParam(Item, discriminator="apply_patch_call"):
    """Apply patch tool call.
...
class ItemApplyPatchToolCallOutputItemParam(Item, discriminator="apply_patch_call_output"):
    """Apply patch tool call output.
...
class ItemCompactionSummaryItemParam(Item, discriminator="compaction"):
    """Compaction item.
...
class ItemComputerCallOutputItemParam(Item, discriminator="computer_call_output"):
    """Computer tool call output.
...
class ItemFunctionCallOutputItemParam(Item, discriminator="function_call_output"):
    """Function tool call output.
...
class ItemFunctionShellCallItemParam(Item, discriminator="shell_call"):
    """Shell tool call.
...
class ItemFunctionShellCallOutputItemParam(Item, discriminator="shell_call_output"):
    """Shell tool call output.
...
class ItemMcpApprovalResponse(Item, discriminator="mcp_approval_response"):
    """MCP approval response.
