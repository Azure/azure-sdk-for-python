...
class AgentsOperations:  # pylint: disable=too-many-public-methods
    ...
    def create_agent(
        ...
        **kwargs: Any
        ...
        :keyword response_format: The response format of the tool calls used by this agent. Is one of
         the following types: str, Union[str, "_agents_models1.AgentsApiResponseFormatMode"],
    ...
    def list_agents(
        ...
        *,
        ...
        before: Optional[str] = None,
        **kwargs: Any
    ) -> _models1.OpenAIPageableListOfAgent:
        ...
        cls: ClsType[_models1.OpenAIPageableListOfAgent] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.OpenAIPageableListOfAgent, response.json())
    ...
    @distributed_trace
    def delete_agent(self, agent_id: str, **kwargs: Any) -> _models1.AgentDeletionStatus:
        """Deletes an agent.
        ...
        cls: ClsType[_models1.AgentDeletionStatus] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.AgentDeletionStatus, response.json())
    ...
    @distributed_trace
    def get_thread(self, thread_id: str, **kwargs: Any) -> _models1.AgentThread:
    ...
    @distributed_trace
    def delete_thread(self, thread_id: str, **kwargs: Any) -> _models1.ThreadDeletionStatus:
        ...
        cls: ClsType[_models1.ThreadDeletionStatus] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.ThreadDeletionStatus, response.json())
    ...
    def list_messages(
        ...
        *,
        ...
        before: Optional[str] = None,
        **kwargs: Any
    ) -> _models1.OpenAIPageableListOfThreadMessage:
        ...
        cls: ClsType[_models1.OpenAIPageableListOfThreadMessage] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.OpenAIPageableListOfThreadMessage, response.json())
    ...
    @distributed_trace
    def get_message(self, thread_id: str, message_id: str, **kwargs: Any) -> _models1.ThreadMessage:
    ...
    def create_run(
        ...
        **kwargs: Any
        ...
        :keyword tool_choice: Controls whether or not and which tool is called by the model. Is one of
         the following types: str, Union[str, "_agents_models1.AgentsApiToolChoiceOptionMode"],
    ...
    def list_runs(
        ...
        *,
        ...
        before: Optional[str] = None,
        **kwargs: Any
    ) -> _models1.OpenAIPageableListOfThreadRun:
        ...
        cls: ClsType[_models1.OpenAIPageableListOfThreadRun] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.OpenAIPageableListOfThreadRun, response.json())
    ...
    @distributed_trace
    def get_run(self, thread_id: str, run_id: str, **kwargs: Any) -> _models1.ThreadRun:
    ...
    @distributed_trace
    def cancel_run(self, thread_id: str, run_id: str, **kwargs: Any) -> _models1.ThreadRun:
    ...
    def list_run_steps(
        ...
        *,
        ...
        before: Optional[str] = None,
        **kwargs: Any
    ) -> _models1.OpenAIPageableListOfRunStep:
        ...
        cls: ClsType[_models1.OpenAIPageableListOfRunStep] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.OpenAIPageableListOfRunStep, response.json())
    ...
    @overload
    def upload_file(self, body: _models1.UploadFileRequest, **kwargs: Any) -> _models1.OpenAIFile:
    ...
    @overload
    def upload_file(self, body: JSON, **kwargs: Any) -> _models1.OpenAIFile:
        """Uploads a file for use by other operations.
    ...
    @distributed_trace
    def upload_file(self, body: Union[_models1.UploadFileRequest, JSON], **kwargs: Any) -> _models1.OpenAIFile:
        """Uploads a file for use by other operations.
        ...
        cls: ClsType[_models1.OpenAIFile] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.OpenAIFile, response.json())
    ...
    @distributed_trace
    def delete_file(self, file_id: str, **kwargs: Any) -> _models1.FileDeletionStatus:
        ...
        cls: ClsType[_models1.FileDeletionStatus] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.FileDeletionStatus, response.json())
    ...
    @distributed_trace
    def get_file(self, file_id: str, **kwargs: Any) -> _models1.OpenAIFile:
    ...
    def list_vector_stores(
        ...
        *,
        ...
        before: Optional[str] = None,
        **kwargs: Any
    ) -> _models1.OpenAIPageableListOfVectorStore:
        ...
        cls: ClsType[_models1.OpenAIPageableListOfVectorStore] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.OpenAIPageableListOfVectorStore, response.json())
    ...
    @distributed_trace
    def get_vector_store(self, vector_store_id: str, **kwargs: Any) -> _models1.VectorStore:
    ...
    @distributed_trace
    def delete_vector_store(self, vector_store_id: str, **kwargs: Any) -> _models1.VectorStoreDeletionStatus:
        ...
        cls: ClsType[_models1.VectorStoreDeletionStatus] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.VectorStoreDeletionStatus, response.json())
    ...
    def list_vector_store_files(
        ...
        *,
        ...
        before: Optional[str] = None,
        **kwargs: Any
    ) -> _models1.OpenAIPageableListOfVectorStoreFile:
        ...
        cls: ClsType[_models1.OpenAIPageableListOfVectorStoreFile] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.OpenAIPageableListOfVectorStoreFile, response.json())
    ...
    @distributed_trace
    def get_vector_store_file(self, vector_store_id: str, file_id: str, **kwargs: Any) -> _models1.VectorStoreFile:
    ...
    def delete_vector_store_file(
    ...
    ) -> _models1.VectorStoreFileDeletionStatus:
        ...
        cls: ClsType[_models1.VectorStoreFileDeletionStatus] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.VectorStoreFileDeletionStatus, response.json())
