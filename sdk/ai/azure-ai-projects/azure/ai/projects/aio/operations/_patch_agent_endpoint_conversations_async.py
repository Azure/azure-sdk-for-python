...
# conversation reads), regardless of `allow_preview` -- see the matching NOTE in the sync
# `_patch_agent_endpoint_conversations.py` for the full explanation (confirmed empirically against
# the live service).
...
class AgentEndpointConversationsOperations(GeneratedAgentEndpointConversationsOperations):
    ...
    async def get_agent_conversation(  # type: ignore[override]
        ...
        try:
            return await super().get_agent_conversation(agent_name, conversation_id, **kwargs)
    ...
    @distributed_trace_async
    async def delete_agent_conversation(  # pylint: disable=inconsistent-return-statements # type: ignore[override]
        self, agent_name: str, conversation_id: str, **kwargs: Any
    ) -> None:
        ...
        try:
            return await super().delete_agent_conversation(agent_name, conversation_id, **kwargs)
        except HttpResponseError as exc:
            if exc.status_code == 403 and not self._config.allow_preview and exc.model is not None:
                api_error_response = exc.model
                if hasattr(api_error_response, "error") and api_error_response.error is not None:
    ...
    @distributed_trace_async
    async def get_agent_conversation_response(  # type: ignore[override]
        ...
        try:
            return await super().get_agent_conversation_response(agent_name, conversation_id, response_id, **kwargs)
        except HttpResponseError as exc:
            if exc.status_code == 403 and not self._config.allow_preview and exc.model is not None:
                api_error_response = exc.model
                if hasattr(api_error_response, "error") and api_error_response.error is not None:
    ...
    def list_agent_conversation_response_items(  # pylint: disable=name-too-long # type: ignore[override]
        ...
        **kwargs: Any,
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.ai.projects.models.RealtimeConversationItem]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        if getattr(self._config, "allow_preview", False):
            headers = kwargs.get("headers")
    ...
    @distributed_trace_async
    async def get_agent_conversation_item(  # type: ignore[override]
        ...
        try:
            return await super().get_agent_conversation_item(agent_name, conversation_id, item_id, **kwargs)
        except HttpResponseError as exc:
            if exc.status_code == 403 and not self._config.allow_preview and exc.model is not None:
                api_error_response = exc.model
                if hasattr(api_error_response, "error") and api_error_response.error is not None:
    ...
    @distributed_trace_async
    async def get_agent_conversation_item_audio(  # pylint: disable=name-too-long # type: ignore[override]
        self, agent_name: str, conversation_id: str, item_id: str, **kwargs: Any
        ...
        try:
            return await super().get_agent_conversation_item_audio(agent_name, conversation_id, item_id, **kwargs)
        except HttpResponseError as exc:
            if exc.status_code == 403 and not self._config.allow_preview and exc.model is not None:
                api_error_response = exc.model
                if hasattr(api_error_response, "error") and api_error_response.error is not None:
    ...
    @distributed_trace_async
    async def get_agent_conversation_item_audio_content(  # pylint: disable=name-too-long # type: ignore[override]
        self, agent_name: str, conversation_id: str, item_id: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
        ...
        try:
            return await super().get_agent_conversation_item_audio_content(
    ...
    @distributed_trace_async
    async def get_agent_conversation_item_generated_audio(  # pylint: disable=name-too-long # type: ignore[override]
        self, agent_name: str, conversation_id: str, item_id: str, **kwargs: Any
        ...
        try:
            return await super().get_agent_conversation_item_generated_audio(
                agent_name, conversation_id, item_id, **kwargs
            )
        except HttpResponseError as exc:
            if exc.status_code == 403 and not self._config.allow_preview and exc.model is not None:
    ...
    @distributed_trace_async
    async def get_agent_conversation_item_generated_audio_content(  # pylint: disable=name-too-long # type: ignore[override]
        self, agent_name: str, conversation_id: str, item_id: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
        ...
        try:
            return await super().get_agent_conversation_item_generated_audio_content(
                agent_name, conversation_id, item_id, **kwargs
            )
        except HttpResponseError as exc:
            if exc.status_code == 403 and not self._config.allow_preview and exc.model is not None:
    ...
    @distributed_trace_async
    async def get_agent_conversation_audio(  # type: ignore[override]
        self, agent_name: str, conversation_id: str, **kwargs: Any
        ...
        try:
            return await super().get_agent_conversation_audio(agent_name, conversation_id, **kwargs)
        except HttpResponseError as exc:
            if exc.status_code == 403 and not self._config.allow_preview and exc.model is not None:
                api_error_response = exc.model
                if hasattr(api_error_response, "error") and api_error_response.error is not None:
    ...
    @distributed_trace_async
    async def get_agent_conversation_audio_content(  # type: ignore[override]
        self, agent_name: str, conversation_id: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
        ...
        try:
            return await super().get_agent_conversation_audio_content(agent_name, conversation_id, **kwargs)
        except HttpResponseError as exc:
            if exc.status_code == 403 and not self._config.allow_preview and exc.model is not None:
                api_error_response = exc.model
                if hasattr(api_error_response, "error") and api_error_response.error is not None:
