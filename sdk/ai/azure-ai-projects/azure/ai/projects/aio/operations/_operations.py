...
class DatasetsOperations:
    ...
    @distributed_trace_async
    async def list_versions(self, name: str, **kwargs: Any) -> _models.PagedDatasetVersion:
        """List all versions of the given DatasetVersion.

        :param name: The name of the resource. Required.
        :type name: str
        :return: PagedDatasetVersion. The PagedDatasetVersion is compatible with MutableMapping
        :rtype: ~azure.ai.projects.models.PagedDatasetVersion
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.PagedDatasetVersion] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.PagedDatasetVersion, response.json())
...
class IndexesOperations:
    ...
    @distributed_trace_async
    async def list_versions(self, name: str, **kwargs: Any) -> _models.PagedIndex:
        """List all versions of the given Index.

        :param name: The name of the resource. Required.
        :type name: str
        :return: PagedIndex. The PagedIndex is compatible with MutableMapping
        :rtype: ~azure.ai.projects.models.PagedIndex
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.PagedIndex] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.PagedIndex, response.json())
