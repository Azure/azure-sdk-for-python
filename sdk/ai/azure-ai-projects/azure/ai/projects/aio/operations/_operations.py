...
class VoiceAgentWebSocketOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
...
class AgentEndpointConversationsOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
    ...
    def list_agent_conversation_response_items(
        ...
        *,
        ...
        before: Optional[str] = None,
        **kwargs: Any
    ) -> AsyncItemPaged["_unions.VoiceConversationItem"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.projects.models.VoiceSystemMessageItem or
