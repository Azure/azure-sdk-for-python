...
from ...operations._operations import (
    ...
    build_beta_agent_endpoint_conversations_download_item_recording_request,
    build_beta_agent_endpoint_conversations_download_recording_request,
    build_beta_agent_endpoint_conversations_get_item_recording_request,
    build_beta_agent_endpoint_conversations_get_item_request,
    build_beta_agent_endpoint_conversations_get_recording_request,
    ...
    build_beta_voice_agent_web_socket_connect_request,
...
class BetaVoiceAgentWebSocketOperations:  # pylint: disable=docstring-missing-param
    ...
    async def connect(
        ...
        **kwargs: Any
        ...
        _request = build_beta_voice_agent_web_socket_connect_request(
            agent_name=agent_name,
...
class BetaAgentEndpointConversationsOperations:  # pylint: disable=docstring-missing-param
    ...
    async def get_item_recording(
        ...
        _request = build_beta_agent_endpoint_conversations_get_item_recording_request(
            agent_name=agent_name,
            conversation_id=conversation_id,
            item_id=item_id,
            api_version=self._config.api_version,
    ...
    async def download_item_recording(
        ...
        _request = build_beta_agent_endpoint_conversations_download_item_recording_request(
            agent_name=agent_name,
            conversation_id=conversation_id,
            item_id=item_id,
            api_version=self._config.api_version,
    ...
    async def get_recording(
        ...
        _request = build_beta_agent_endpoint_conversations_get_recording_request(
            agent_name=agent_name,
            conversation_id=conversation_id,
            api_version=self._config.api_version,
            headers=_headers,
    ...
    @distributed_trace_async
    async def download_recording(self, agent_name: str, conversation_id: str, **kwargs: Any) -> AsyncIterator[bytes]:
        ...
        _request = build_beta_agent_endpoint_conversations_download_recording_request(
            agent_name=agent_name,
            conversation_id=conversation_id,
            api_version=self._config.api_version,
            headers=_headers,
