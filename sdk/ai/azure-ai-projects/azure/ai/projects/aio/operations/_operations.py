...
from ...operations._operations import (
    build_agent_blueprints_create_or_update_version_request,
    build_agent_blueprints_delete_version_request,
    build_agent_blueprints_get_version_request,
    build_agent_blueprints_list_latest_request,
    build_agent_blueprints_list_versions_request,
    build_agent_blueprints_scaffold_blueprint_request,
...
class AgentBlueprintsOperations:
    ...
    def list_versions(
    ...
    ) -> AsyncItemPaged["_models.AgentBlueprint"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.ai.projects.models.AgentBlueprint]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def get_version(self, name: str, version: str, **kwargs: Any) -> _models.AgentBlueprint:
