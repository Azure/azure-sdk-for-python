...
class AgentsOperations:
    ...
    async def _create_agent(
        ...
        **kwargs: Any
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _foundry_features: Optional[str] = _get_agent_definition_opt_in_keys if self._config._allow_preview else None  # type: ignore
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @overload
    async def _create_agent_from_manifest(
        self,
        *,
        name: str,
        manifest_id: str,
    ...
    @overload
    async def _update_agent_from_manifest(
        self,
        agent_name: str,
        *,
        manifest_id: str,
...
class EvaluationRulesOperations:
    ...
    async def create_or_update(
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _foundry_features: Optional[Literal[FoundryFeaturesOptInKeys.EVALUATIONS_V1_PREVIEW]] = FoundryFeaturesOptInKeys.EVALUATIONS_V1_PREVIEW if self._config._allow_preview else None  # type: ignore
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
...
class BetaEvaluationTaxonomiesOperations:
    ...
    async def get(self, name: str, **kwargs: Any) -> _models.EvaluationTaxonomy:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _foundry_features: Literal[FoundryFeaturesOptInKeys.EVALUATIONS_V1_PREVIEW] = (
...
class BetaInsightsOperations:
    ...
    async def generate(self, insight: Union[_models.Insight, JSON, IO[bytes]], **kwargs: Any) -> _models.Insight:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _foundry_features: Literal[FoundryFeaturesOptInKeys.INSIGHTS_V1_PREVIEW] = (
...
class BetaRedTeamsOperations:
    ...
    async def get(self, name: str, **kwargs: Any) -> _models.RedTeam:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _foundry_features: Literal[FoundryFeaturesOptInKeys.RED_TEAMS_V1_PREVIEW] = (
...
class BetaSchedulesOperations:
    ...
    async def delete(self, schedule_id: str, **kwargs: Any) -> None:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _foundry_features: Literal[FoundryFeaturesOptInKeys.SCHEDULES_V1_PREVIEW] = (
