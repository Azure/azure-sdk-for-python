...
from ...operations._operations import (
    ...
    build_agents_download_agent_code_request,
    build_agents_download_agent_version_code_request,
...
class AgentsOperations:
    ...
    async def download_agent_version_code(
        ...
        _request = build_agents_download_agent_version_code_request(
            agent_name=agent_name,
            agent_version=agent_version,
            api_version=self._config.api_version,
            headers=_headers,
    ...
    async def download_agent_code(self, agent_name: str, **kwargs: Any) -> AsyncIterator[bytes]:
        ...
        _request = build_agents_download_agent_code_request(
            agent_name=agent_name,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
