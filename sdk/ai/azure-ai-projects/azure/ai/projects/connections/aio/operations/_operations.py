...
class ConnectionsOperations:
    ...
    async def _get_workspace(self, **kwargs: Any) -> _models3._models.GetWorkspaceResponse:
        ...
        cls: ClsType[_models3._models.GetWorkspaceResponse] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(
                _models3._models.GetWorkspaceResponse, response.json()  # pylint: disable=protected-access
            )
    ...
    async def _list_connections(
        self,
        *,
        category: Optional[Union[str, _models3.ConnectionType]] = None,
        include_all: Optional[bool] = None,
        target: Optional[str] = None,
        **kwargs: Any
    ) -> _models3._models.ListConnectionsResponse:
        ...
        cls: ClsType[_models3._models.ListConnectionsResponse] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(
                _models3._models.ListConnectionsResponse, response.json()  # pylint: disable=protected-access
            )
    ...
    @distributed_trace_async
    async def _get_connection(self, connection_name: str, **kwargs: Any) -> _models3._models.GetConnectionResponse:
        ...
        cls: ClsType[_models3._models.GetConnectionResponse] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(
                _models3._models.GetConnectionResponse, response.json()  # pylint: disable=protected-access
            )
    ...
    ) -> _models3._models.GetConnectionResponse: ...
    @overload
    async def _get_connection_with_secrets(
