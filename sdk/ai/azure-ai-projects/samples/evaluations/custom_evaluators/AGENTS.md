...
- use these sample entry points when the user wants the provided samples:
  ...
  - `sample_custom_eval_upload_azure_friendly.py`
...
5. If using the provided samples, choose between `sample_custom_eval_upload_simple.py`, `sample_custom_eval_upload_advanced.py`, and `sample_custom_eval_upload_azure_friendly.py`.
