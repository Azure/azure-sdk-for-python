...
USAGE:
    python sample_evaluations_score_model_grader_with_image_agent_target.py
    ...
    3) AGENT_NAME - Required. The name of the Azure AI agent to use as the target.
    4) AGENT_VERSION - Optional. The version of the agent. Defaults to latest if not specified.
"""
