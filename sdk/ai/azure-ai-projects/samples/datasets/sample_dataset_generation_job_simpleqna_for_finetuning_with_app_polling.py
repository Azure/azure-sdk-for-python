...
DESCRIPTION:
    ...
    uploaded as an Azure OpenAI File. The sample:
      ...
      3. Polls the job from application code until it reaches a terminal state,
         then prints every generated file output.
...
USAGE:
    python sample_dataset_generation_job_simpleqna_for_finetuning_with_app_polling.py
