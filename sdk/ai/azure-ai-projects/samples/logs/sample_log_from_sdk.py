...
"""
DESCRIPTION:
    This sample demonstrates how to capture Azure-core HTTP logs from the SDK
    into a file while running a Prompt Agent operation.
    With logging_enable=True, the Azure-core network trace logs include request bodies, response body, and token.

USAGE:
    python samples/logs/sample_log_from_sdk.py
    ...
    This sample writes Azure-core logs to a timestamped temp log file.
"""
...
with (
    ...
    print(f"Azure-core logs written to {LOG_FILE}")
