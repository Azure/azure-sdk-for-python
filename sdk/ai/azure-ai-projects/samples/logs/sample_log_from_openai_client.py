...
"""
DESCRIPTION:
    This sample demonstrates how to capture OpenAI transport logs from the
    SDK-authenticated OpenAI client into a file while suppressing terminal output.
    With logging_enable=True, all logs will include request bodies, response body, and token.

USAGE:
    python samples/logs/sample_log_from_openai_client.py
    ...
    This sample writes OpenAI transport logs to a timestamped temp log file.
"""
...
with (
    ...
    with (
        ...
        print(f"OpenAI transport logs written to {LOG_FILE}")
