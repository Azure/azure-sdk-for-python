...
DESCRIPTION:
    ...
    the synchronous AIProjectClient.
...
USAGE:
    python sample_agent_code_based.py
...
with (
    ...
    agent = project_client.agents.create_agent_from_code(
    ...
    # [START get_agent]
    fetched = project_client.agents.get(agent_name)
    ...
    updated_agent = project_client.agents.update_agent_from_code(
        agent_name=agent_name,
    ...
    # [START delete_agent]
    result = project_client.agents.delete(agent_name)
