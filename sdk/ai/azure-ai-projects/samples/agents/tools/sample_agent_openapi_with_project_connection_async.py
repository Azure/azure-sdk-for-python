...
DESCRIPTION:
    ...
    using the OpenApiTool with project connection authentication in an asynchronous client.
    The agent can call external APIs defined by OpenAPI specifications, using credentials
    stored in an Azure AI Project connection.

USAGE:
    python sample_agent_openapi_with_project_connection_async.py

    Before running the sample:

    pip install "azure-ai-projects>=2.0.0b1" python-dotenv jsonref aiohttp
...
async def main() -> None:
    """Create an agent with OpenAPI tool auth via project connection and make a sample call."""
