...
If the environment variable is not set and no value is provided with the `AIProjectInstrumentor().instrument()` call for the propagation parameter, the trace context propagation defaults to `false`.
