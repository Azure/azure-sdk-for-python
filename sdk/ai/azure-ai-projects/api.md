...
namespace azure.ai.projects.models
    ...
    class azure.ai.projects.models.DimensionChangeKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        AMPLIFIED = "amplified"
    ...
    class azure.ai.projects.models.DimensionMetadata(_Model):
        change_detail: Optional[str]
        change_kind: Union[str, DimensionChangeKind]
    ...
    class azure.ai.projects.models.RubricBasedEvaluatorDefinition(EvaluatorDefinition, discriminator='rubric'):
        ...
        health: Optional[RubricHealth]
        init_parameters: dict[str, any]
        metrics: dict[str, EvaluatorMetric]
        pass_threshold: Optional[float]
        superseded_dimensions: Optional[list[SupersededDimension]]
    ...
    class azure.ai.projects.models.RubricHealth(_Model):
        computation: Optional[RubricHealthComputationMetadata]
        confidence: Optional[Union[str, RubricHealthConfidence]]
        coverage: Optional[float]
        diversity: Optional[float]
        negative_vs_positive: Optional[float]
    ...
    class azure.ai.projects.models.RubricHealthComputationMetadata(_Model):
        algorithm_version: str
        similarity_metric: Union[str, RubricHealthSimilarityMetric]
        vectorizer: str
        vectorizer_version: Optional[str]
    ...
    class azure.ai.projects.models.RubricHealthConfidence(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        HIGH = "high"
        LOW = "low"
        MED = "med"


    class azure.ai.projects.models.RubricHealthSimilarityMetric(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        COSINE = "cosine"
...
namespace azure.ai.projects.types
    ...
    class azure.ai.projects.types.DimensionMetadata(TypedDict, total=False):
        key "change_detail": str
        key "change_kind": Required[Union[str, DimensionChangeKind]]
        key "last_modified_version": Required[str]
        key "origin_version": Required[str]
        change_detail: str
        change_kind: Union[str, DimensionChangeKind]
        last_modified_version: str
        origin_version: str
    ...
    class azure.ai.projects.types.RubricBasedEvaluatorDefinition(TypedDict, total=False):
        ...
        key "health": ForwardRef('RubricHealth', module='types')
    ...
    class azure.ai.projects.types.RubricHealth(TypedDict, total=False):
        key "computation": ForwardRef('RubricHealthComputationMetadata', module='types')
        key "confidence": Union[str, RubricHealthConfidence]
        key "coverage": float
        key "diversity": float
        key "negative_vs_positive": float
        key "overall": float
    ...
    class azure.ai.projects.types.RubricHealthComputationMetadata(TypedDict, total=False):
        key "algorithm_version": Required[str]
        key "similarity_metric": Required[Union[str, RubricHealthSimilarityMetric]]
        key "vectorizer": Required[str]
        key "vectorizer_version": str
        algorithm_version: str
        similarity_metric: Union[str, RubricHealthSimilarityMetric]
        vectorizer: str
