...
make sure your package souces code (files under \sdk\ai\azure-ai-projects\azure) do not have any
mypy errors.

Last updated: 2/11/2026

I would like you to create a Python script named "patch_foundry_features_args.py" that you will
run to do the work described below. Save the the script to the folder \azure-sdk-for-python\sdk\ai\azure-ai-projects.
