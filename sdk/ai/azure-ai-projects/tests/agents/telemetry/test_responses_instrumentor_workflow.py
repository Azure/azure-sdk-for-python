...
"""
    ...
    # ========================================
    # Sync Workflow Agent Tests - Non-Streaming
    # ========================================
    ...
    def test_sync_workflow_non_streaming_with_content_recording(self, **kwargs):
        ...
        with project_client:
            ...
            # Create workflow
            workflow = self._create_student_teacher_workflow(project_client, student_agent, teacher_agent)
            ...
            try:
                ...
                # Check spans for list_conversation_items
                self.exporter.force_flush()

                # Check spans
                self.exporter.force_flush()
                spans = self.exporter.get_spans_by_name(f"responses {workflow.name}")
                assert len(spans) == 1
                span = spans[0]
