...
import pytest
import os
from azure.ai.projects.models import BaseAgentEventHandler, ThreadRun
...
def break_event_stream(indices: List[int], event_stream: str):
    previous_index = 0
...
def mock_callable(thread_run: ThreadRun, handler: BaseAgentEventHandler[str]) -> None:
    pass
