...
class TestAgentCrud(TestBase):
    ...
    def test_agents_crud(self, **kwargs):
        ...
        agent1_version1: AgentVersionObject = project_client.agents.create_version(
        ...
        agent1_version2: AgentVersionObject = project_client.agents.create_version(
        ...
        agent2_version1: AgentVersionObject = project_client.agents.create_version(
        ...
        # agent2_version2: AgentVersionObject = project_client.agents.update(
