...
from azure.ai.projects.models import PromptAgentDefinition, AgentObject, AgentVersionObject
...
class TestAgentCrudAsync(TestBase):
    ...
    async def test_agents_crud_async(self, **kwargs):
        ...
        async with project_client:
            ...
            agent1_version1: AgentVersionObject = await project_client.agents.create_version(
            ...
            agent1_version2: AgentVersionObject = await project_client.agents.create_version(
            ...
            agent2_version1: AgentVersionObject = await project_client.agents.create_version(
            ...
            # agent2_version2: AgentVersionObject = await project_client.agents.update(
