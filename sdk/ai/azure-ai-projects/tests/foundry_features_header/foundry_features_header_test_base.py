...
EXPECTED_FOUNDRY_FEATURES: dict[str, str] = {
    ...
    "toolboxes": "Skills=V1Preview",
    "skills": "Skills=V1Preview",
    "datasets": "DataGenerationJobs=V1Preview",
    "models": "Models=V1Preview",
    "routines": "Routines=V1Preview",
    "agents": "HostedAgents=V1Preview,AgentEndpoints=V1Preview,CodeAgents=V1Preview,ExternalAgents=V1Preview,AgentsOptimization=V1Preview",
}
...
_NON_BETA_OPTIONAL_TEST_CASES = [
    ...
    pytest.param(
        ...
        "HostedAgents=V1Preview,WorkflowAgents=V1Preview,AgentEndpoints=V1Preview,ExternalAgents=V1Preview",
    ),
    pytest.param(
