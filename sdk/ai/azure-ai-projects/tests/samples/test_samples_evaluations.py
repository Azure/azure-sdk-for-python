    ...
    @pytest.mark.parametrize(
        ...
        get_sample_paths(
            ...
            samples_to_skip=[
                ...
                "sample_trace_evaluation_agent_smart_filter.py",  # PR #47217: recording not yet available
                "sample_scheduled_agent_trace_evaluation_smart_filter.py",  # PR #47217: recording not yet available
            ],
        ),
    )
    @SamplePathPasser()
