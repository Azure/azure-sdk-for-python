...
* New `ToolboxSearchPreviewTool` - a tool for searching over the agent's toolbox. When present, deferred tools are hidden from the model and this tool is used to search for them.
* New `ToolType.TOOLBOX_SEARCH_PREVIEW` enum value.
