...
Overview page. The factory method `from_connection_string` was removed. The support of connection strings and hub based projects was dropped. Please create a new Azure AI Foundry resource, which uses endpoints (recommended), or pin the version of `azure-ai-projects` to `1.0.0b10` if it is not possible.
