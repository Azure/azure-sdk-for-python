...
def load_client(
    ...
    :rtype: ~azure.ai.runtime.inference.ChatCompletionsClient or ~azure.ai.runtime.inference.EmbeddingsClient
     or ~azure.ai.runtime.inference.ImageEmbeddingsClient
...
class ChatCompletionsClient(ChatCompletionsClientGenerated):
    ...
    def complete(
        ...
        **kwargs: Any,
        ...
        :paramtype messages: list[~azure.ai.runtime.inference.models.ChatRequestMessage]
        ...
        :paramtype response_format: str or ~azure.ai.runtime.inference.models.ChatCompletionsResponseFormat
        ...
        :paramtype tools: list[~azure.ai.runtime.inference.models.ChatCompletionsToolDefinition]
        :keyword tool_choice: If specified, the model will configure which of the provided tools it can
         ...
         Default value is None.
        :paramtype tool_choice: str or ~azure.ai.runtime.inference.models.ChatCompletionsToolSelectionPreset or
         ~azure.ai.runtime.inference.models.ChatCompletionsNamedToolSelection
        ...
        :rtype: ~azure.ai.runtime.inference.models.ChatCompletions or ~azure.ai.runtime.inference.models.StreamingChatCompletions
        :raises ~azure.core.exceptions.HttpResponseError
        """
    ...
    def complete(
        ...
        **kwargs: Any,
        ...
        back to the client. Iterate over the resulting ~azure.ai.runtime.inference.models.StreamingChatCompletions
    ...
    def get_model_info(self, **kwargs: Any) -> _models.ModelInfo:
        ...
        :rtype: ~azure.ai.runtime.inference.models.ModelInfo
        :raises ~azure.core.exceptions.HttpResponseError
        """
...
class EmbeddingsClient(EmbeddingsClientGenerated):
    ...
    def embed(
        ...
        **kwargs: Any,
        ...
        :paramtype encoding_format: str or ~azure.ai.runtime.inference.models.EmbeddingEncodingFormat
        ...
        :paramtype input_type: str or ~azure.ai.runtime.inference.models.EmbeddingInputType
        :return: EmbeddingsResult. The EmbeddingsResult is compatible with MutableMapping
        :rtype: ~azure.ai.runtime.inference.models.EmbeddingsResult
        :raises ~azure.core.exceptions.HttpResponseError
        """
...
class ImageEmbeddingsClient(ImageEmbeddingsClientGenerated):
    ...
    def embed(
        ...
        **kwargs: Any,
        ...
        :paramtype input: list[~azure.ai.runtime.inference.models.EmbeddingInput]
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword extras: Extra parameters (in the form of string key-value pairs) that are not in the
