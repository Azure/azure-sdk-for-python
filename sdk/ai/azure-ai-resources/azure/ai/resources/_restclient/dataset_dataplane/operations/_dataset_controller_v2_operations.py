...
def build_get_dataset_definition_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/dataset/v1.2/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/datasets/{datasetId}/definitions/{version}")  # pylint: disable=line-too-long
...
def build_get_all_dataset_definitions_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/dataset/v1.2/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/datasets/{datasetId}/definitions")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str'),
...
def build_update_definition_request(
    ...
    **kwargs  # type: Any
    ...
    if register_as_pending is not None:
        _query_parameters['registerAsPending'] = _SERIALIZER.query("register_as_pending", register_as_pending, 'bool')
    if force_update is not None:
        _query_parameters['forceUpdate'] = _SERIALIZER.query("force_update", force_update, 'bool')
    if dataset_type is not None:
        _query_parameters['datasetType'] = _SERIALIZER.query("dataset_type", dataset_type, 'str')
    if user_version_id is not None:
        _query_parameters['userVersionId'] = _SERIALIZER.query("user_version_id", user_version_id, 'str')
...
def build_get_all_dataset_versions_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/dataset/v1.2/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/datasets/{datasetId}/versions")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str'),
...
def build_get_dataset_by_name_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/dataset/v1.2/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/datasets/query/name={datasetName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str'),
    ...
    if include_latest_definition is not None:
        _query_parameters['includeLatestDefinition'] = _SERIALIZER.query("include_latest_definition", include_latest_definition, 'bool')
...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/dataset/v1.2/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/datasets")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str'),
    ...
    if dataset_names is not None:
        _query_parameters['datasetNames'] = _SERIALIZER.query("dataset_names", dataset_names, '[str]')
    if search_text is not None:
        _query_parameters['searchText'] = _SERIALIZER.query("search_text", search_text, 'str')
    if include_invisible is not None:
        _query_parameters['includeInvisible'] = _SERIALIZER.query("include_invisible", include_invisible, 'bool')
    ...
    if dataset_types is not None:
        _query_parameters['datasetTypes'] = _SERIALIZER.query("dataset_types", dataset_types, '[str]')
...
def build_register_request(
    ...
    **kwargs  # type: Any
    ...
    if if_exists_ok is not None:
        _query_parameters['ifExistsOk'] = _SERIALIZER.query("if_exists_ok", if_exists_ok, 'bool')
    if update_definition_if_exists is not None:
        _query_parameters['updateDefinitionIfExists'] = _SERIALIZER.query("update_definition_if_exists", update_definition_if_exists, 'bool')
    if with_data_hash is not None:
        _query_parameters['withDataHash'] = _SERIALIZER.query("with_data_hash", with_data_hash, 'bool')
    if user_version_id is not None:
        _query_parameters['userVersionId'] = _SERIALIZER.query("user_version_id", user_version_id, 'str')
...
def build_update_dataset_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/dataset/v1.2/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/datasets/{datasetId}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str'),
...
def build_unregister_dataset_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/dataset/v1.2/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/datasets/{name}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str'),
