...
from azure.ai.resources._index.data_generation.qa import QADataGenerator, GenerationResult, QAType
...
from azure.ai.resources._index._utils.logging import (enable_appinsights_logging,
