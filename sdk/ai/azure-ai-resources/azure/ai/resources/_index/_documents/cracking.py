...
from azure.ai.resources._index._documents.chunking import ChunkedDocument, DocumentSource
...
from azure.ai.resources._index._utils.logging import get_logger, safe_mlflow_log_metric
