...
from azure.ai.resources._index._documents.document import Document, DocumentSource, StaticDocument
from azure.ai.resources._index._langchain.vendor.text_splitter import TextSplitter
from azure.ai.resources._index._utils import merge_dicts
...
def get_langchain_splitter(file_extension: str, arguments: dict) -> TextSplitter:
    ...
    if use_nltk:
        _init_nltk()
        from azure.ai.resources._indexx._langchain.vendor.text_splitter import NLTKTextSplitter
