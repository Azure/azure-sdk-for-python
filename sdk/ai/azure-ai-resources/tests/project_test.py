...
class TestProjects:
    ...
    def test_create_update_and_delete(self, ai_client: AIClient):
        new_local_project = Project(
            ...
            resource="/subscriptions/b17253fa-f327-42d6-9686-f3e553e24763/resourceGroups/hanchi-test/providers/Microsoft.MachineLearningServices/workspaces/e2e_test_resource_1",
        ...
        assert created_project.resource == new_local_project.resource
