...
from azure.ai.project.models import AgentEventHandler
from azure.identity import DefaultAzureCredential
from azure.ai.project.models import FunctionTool, RequiredFunctionToolCall, SubmitToolOutputsAction
