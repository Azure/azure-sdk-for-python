...
from azure.ai.project.models import CodeInterpreterTool
from azure.ai.project.models import FilePurpose
from azure.ai.project.models import MessageAttachment
