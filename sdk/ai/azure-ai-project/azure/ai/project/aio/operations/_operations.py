...
class AgentsOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.ai.project.aio.AIProjectClient`'s
    ...
    async def create_agent(self, body: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models.Agent:
        ...
        :rtype: ~azure.ai.project.models.Agent
    ...
    async def create_agent(
        ...
        **kwargs: Any
        ...
        :paramtype tools: list[~azure.ai.project.models.ToolDefinition]
        ...
        :paramtype tool_resources: ~azure.ai.project.models.ToolResources
        ...
        :paramtype response_format: str or str or ~azure.ai.project.models.AgentsApiResponseFormatMode
         or ~azure.ai.project.models.AgentsApiResponseFormat
    ...
    async def list_agents(
        ...
        **kwargs: Any
        ...
        :paramtype order: str or ~azure.ai.project.models.ListSortOrder
        ...
        :return: OpenAIPageableListOfAgent. The OpenAIPageableListOfAgent is compatible with
         MutableMapping
        :rtype: ~azure.ai.project.models.OpenAIPageableListOfAgent
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def delete_agent(self, assistant_id: str, **kwargs: Any) -> _models.AgentDeletionStatus:
        ...
        :rtype: ~azure.ai.project.models.AgentDeletionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_thread(
        ...
        :rtype: ~azure.ai.project.models.AgentThread
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_thread(
        ...
        **kwargs: Any
        ...
        :keyword messages: The initial messages to associate with the new thread. Default value is
         None.
        :paramtype messages: list[~azure.ai.project.models.ThreadMessageOptions]
    ...
    async def delete_thread(self, thread_id: str, **kwargs: Any) -> _models.ThreadDeletionStatus:
        ...
        :rtype: ~azure.ai.project.models.ThreadDeletionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_message(
        ...
        :rtype: ~azure.ai.project.models.ThreadMessage
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        **kwargs: Any
         ...
         * ``assistant``\\ : Indicates the message is generated by the agent. Use this value to insert
         messages from the agent into
           the conversation. Known values are: "user" and "assistant". Required.
        :paramtype role: str or ~azure.ai.project.models.MessageRole
        ...
        :paramtype attachments: list[~azure.ai.project.models.MessageAttachment]
        :keyword metadata: A set of up to 16 key/value pairs that can be attached to an object, used
         for storing additional information about that object in a structured format. Keys may be up to
         64 characters in length and values may be up to 512 characters in length. Default value is
         None.
    ...
    async def list_messages(
        ...
        **kwargs: Any
        ...
        :return: OpenAIPageableListOfThreadMessage. The OpenAIPageableListOfThreadMessage is compatible
         with MutableMapping
        :rtype: ~azure.ai.project.models.OpenAIPageableListOfThreadMessage
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_run(
        ...
        :rtype: ~azure.ai.project.models.ThreadRun
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_run(
        ...
        **kwargs: Any
        ...
        :paramtype additional_messages: list[~azure.ai.project.models.ThreadMessage]
        ...
        :paramtype truncation_strategy: ~azure.ai.project.models.TruncationObject
        ...
        :paramtype tool_choice: str or str or ~azure.ai.project.models.AgentsApiToolChoiceOptionMode or
         ~azure.ai.project.models.AgentsNamedToolChoice
    ...
    async def list_runs(
        ...
        **kwargs: Any
        ...
        :return: OpenAIPageableListOfThreadRun. The OpenAIPageableListOfThreadRun is compatible with
         MutableMapping
        :rtype: ~azure.ai.project.models.OpenAIPageableListOfThreadRun
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def submit_tool_outputs_to_run(
        ...
        **kwargs: Any
        ...
        :paramtype tool_outputs: list[~azure.ai.project.models.ToolOutput]
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    async def create_thread_and_run(
        ...
        **kwargs: Any
        ...
        :paramtype thread: ~azure.ai.project.models.AgentThreadCreationOptions
        ...
        :paramtype tool_resources: ~azure.ai.project.models.UpdateToolResourcesOptions
        :keyword stream_parameter: If ``true``\\ , returns a stream of events that happen during the
         Run as server-sent events,
         terminating when the Run enters a terminal state with a ``data: [DONE]`` message. Default
         value is None.
    ...
    async def get_run_step(self, thread_id: str, run_id: str, step_id: str, **kwargs: Any) -> _models.RunStep:
        ...
        :rtype: ~azure.ai.project.models.RunStep
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_run_steps(
        ...
        **kwargs: Any
        ...
        :return: OpenAIPageableListOfRunStep. The OpenAIPageableListOfRunStep is compatible with
         MutableMapping
        :rtype: ~azure.ai.project.models.OpenAIPageableListOfRunStep
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_files(
        ...
        :keyword purpose: The purpose of the file. Known values are: "fine-tune", "fine-tune-results",
         ...
         None.
        :paramtype purpose: str or ~azure.ai.project.models.FilePurpose
        :return: FileListResponse. The FileListResponse is compatible with MutableMapping
        :rtype: ~azure.ai.project.models.FileListResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def upload_file(self, body: JSON, **kwargs: Any) -> _models.OpenAIFile:
        ...
        :rtype: ~azure.ai.project.models.OpenAIFile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def upload_file(
        ...
        :paramtype file: ~azure.ai.project._vendor.FileType
    ...
    async def delete_file(self, file_id: str, **kwargs: Any) -> _models.FileDeletionStatus:
        ...
        :rtype: ~azure.ai.project.models.FileDeletionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_file_content(self, file_id: str, **kwargs: Any) -> _models.FileContentResponse:
        ...
        :rtype: ~azure.ai.project.models.FileContentResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_vector_stores(
        ...
        **kwargs: Any
        ...
        :return: OpenAIPageableListOfVectorStore. The OpenAIPageableListOfVectorStore is compatible
         with MutableMapping
        :rtype: ~azure.ai.project.models.OpenAIPageableListOfVectorStore
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_vector_store(
        ...
        :rtype: ~azure.ai.project.models.VectorStore
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_vector_store(
        ...
        **kwargs: Any
        ...
        :paramtype store_configuration: ~azure.ai.project.models.VectorStorageConfiguration
        :keyword expires_after: Details on when this vector store expires. Default value is None.
        :paramtype expires_after: ~azure.ai.project.models.VectorStoreExpirationPolicy
        ...
        :paramtype chunking_strategy: ~azure.ai.project.models.VectorStoreChunkingStrategyRequest
        :keyword metadata: A set of up to 16 key/value pairs that can be attached to an object, used
         for storing additional information about that object in a structured format. Keys may be up to
         64 characters in length and values may be up to 512 characters in length. Default value is
         None.
    ...
    async def delete_vector_store(self, vector_store_id: str, **kwargs: Any) -> _models.VectorStoreDeletionStatus:
        ...
        :return: VectorStoreDeletionStatus. The VectorStoreDeletionStatus is compatible with
         MutableMapping
        :rtype: ~azure.ai.project.models.VectorStoreDeletionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_vector_store_files(
        ...
        **kwargs: Any
        ...
        :paramtype filter: str or ~azure.ai.project.models.VectorStoreFileStatusFilter
        :keyword limit: A limit on the number of objects to be returned. Limit can range between 1 and
         100, and the default is 20. Default value is None.
        :paramtype limit: int
        :keyword order: Sort order by the created_at timestamp of the objects. asc for ascending order
        ...
        :rtype: ~azure.ai.project.models.OpenAIPageableListOfVectorStoreFile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_vector_store_file(
        ...
        :rtype: ~azure.ai.project.models.VectorStoreFile
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_vector_store_file(
        ...
        **kwargs: Any
        ...
        :paramtype data_sources: list[~azure.ai.project.models.VectorStorageDataSource]
        :keyword chunking_strategy: The chunking strategy used to chunk the file(s). If not set, will
    ...
    async def delete_vector_store_file(
        ...
        :return: VectorStoreFileDeletionStatus. The VectorStoreFileDeletionStatus is compatible with
         MutableMapping
        :rtype: ~azure.ai.project.models.VectorStoreFileDeletionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_vector_store_file_batch(
        ...
        :rtype: ~azure.ai.project.models.VectorStoreFileBatch
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class ConnectionsOperations:
    ...
    async def _list(
        ...
        **kwargs: Any
        ...
        :paramtype category: str or ~azure.ai.project.models.ConnectionType
        ...
        :rtype: ~azure.ai.project.models._models.ConnectionsListResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def _get(self, connection_name: str, **kwargs: Any) -> _models._models.ConnectionsListSecretsResponse:
        ...
        :return: ConnectionsListSecretsResponse. The ConnectionsListSecretsResponse is compatible with
         MutableMapping
        :rtype: ~azure.ai.project.models._models.ConnectionsListSecretsResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class EvaluationsOperations:
    ...
    async def get(self, id: str, **kwargs: Any) -> _models.Evaluation:
        ...
        :rtype: ~azure.ai.project.models.Evaluation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create(
        ...
        :type evaluation: ~azure.ai.project.models.Evaluation
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Evaluation. The Evaluation is compatible with MutableMapping
    ...
    async def create(self, evaluation: Union[_models.Evaluation, JSON, IO[bytes]], **kwargs: Any) -> _models.Evaluation:
        ...
        :param evaluation: Evaluation to run. Is one of the following types: Evaluation, JSON,
         IO[bytes] Required.
        :type evaluation: ~azure.ai.project.models.Evaluation or JSON or IO[bytes]
        :return: Evaluation. The Evaluation is compatible with MutableMapping
        :rtype: ~azure.ai.project.models.Evaluation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.ai.project.models.Evaluation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.ai.project.models.Evaluation
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
    ...
    async def update(
        ...
        :param resource: The resource instance. Is one of the following types: Evaluation, JSON,
         IO[bytes] Required.
        :type resource: ~azure.ai.project.models.Evaluation or JSON or IO[bytes]
        :return: Evaluation. The Evaluation is compatible with MutableMapping
        :rtype: ~azure.ai.project.models.Evaluation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_schedule(self, name: str, **kwargs: Any) -> _models.EvaluationSchedule:
        ...
        :rtype: ~azure.ai.project.models.EvaluationSchedule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_or_replace_schedule(
        ...
        :type name: str
        :param resource: The resource instance. Required.
        :type resource: ~azure.ai.project.models.EvaluationSchedule
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: EvaluationSchedule. The EvaluationSchedule is compatible with MutableMapping
    ...
    async def create_or_replace_schedule(
        ...
        :type resource: ~azure.ai.project.models.EvaluationSchedule or JSON or IO[bytes]
        :return: EvaluationSchedule. The EvaluationSchedule is compatible with MutableMapping
        :rtype: ~azure.ai.project.models.EvaluationSchedule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_schedule(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.ai.project.models.EvaluationSchedule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
