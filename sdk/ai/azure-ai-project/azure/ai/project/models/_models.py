...
class Agent(_model_base.Model):
    ...
    :vartype tools: list[~azure.ai.project.models.ToolDefinition]
    :ivar tool_resources: A set of resources that are used by the agent's tools. The resources are
     ...
     store IDs. Required.
    :vartype tool_resources: ~azure.ai.project.models.ToolResources
    ...
    :vartype response_format: str or str or ~azure.ai.project.models.AgentsApiResponseFormatMode or
...
class AgentsApiResponseFormat(_model_base.Model):
    ...
    :ivar type: Must be one of ``text`` or ``json_object``. Known values are: "text" and
     "json_object".
    :vartype type: str or ~azure.ai.project.models.ApiResponseFormat
    """
...
class AgentsNamedToolChoice(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.project.models.AgentsNamedToolChoiceType
    :ivar function: The name of the function to call.
    :vartype function: ~azure.ai.project.models.FunctionName
    """
...
class AgentThreadCreationOptions(_model_base.Model):
    ...
    :vartype messages: list[~azure.ai.project.models.ThreadMessageOptions]
    :ivar tool_resources: A set of resources that are made available to the agent's tools in this
...
class AzureAISearchResource(_model_base.Model):
    ...
    :vartype index_list: list[~azure.ai.project.models.IndexResource]
    """
...
class CodeInterpreterToolResource(_model_base.Model):
    ...
    :ivar data_sources: The data sources to be used. This option is mutually exclusive with
     fileIds.
    :vartype data_sources: list[~azure.ai.project.models.VectorStorageDataSource]
    """
...
class ConnectionListResource(_model_base.Model):
    ...
    :ivar connection_list: The connections attached to this agent. There can be a maximum of 1
     connection
     resource attached to the agent.
    :vartype connection_list: list[~azure.ai.project.models.ConnectionResource]
    """
...
class ConnectionPropertiesAADAuth(ConnectionProperties, discriminator="AAD"):
    ...
    :ivar auth_type: Authentication type of the connection target. Required. Entra ID
     authentication
    :vartype auth_type: str or ~azure.ai.project.models.AAD
...
class ConnectionPropertiesApiKeyAuth(ConnectionProperties, discriminator="ApiKey"):
    ...
    :vartype auth_type: str or ~azure.ai.project.models.API_KEY
    :ivar category: Category of the connection. Required. Known values are: "AzureOpenAI",
     "Serverless", "AzureBlob", and "AIServices".
    :vartype category: str or ~azure.ai.project.models.ConnectionType
    :ivar credentials: Credentials will only be present for authType=ApiKey. Required.
    :vartype credentials: ~azure.ai.project.models._models.CredentialsApiKeyAuth
    :ivar target: The connection URL to be used for this service. Required.
    :vartype target: str
    """
...
class ConnectionPropertiesSASAuth(ConnectionProperties, discriminator="SAS"):
    ...
    :vartype auth_type: str or ~azure.ai.project.models.SAS
    :ivar category: Category of the connection. Required. Known values are: "AzureOpenAI",
     "Serverless", "AzureBlob", and "AIServices".
    :vartype category: str or ~azure.ai.project.models.ConnectionType
    :ivar credentials: Credentials will only be present for authType=ApiKey. Required.
    :vartype credentials: ~azure.ai.project.models._models.CredentialsSASAuth
    :ivar target: The connection URL to be used for this service. Required.
    :vartype target: str
    """
...
class ConnectionsListResponse(_model_base.Model):
    ...
    :vartype value: list[~azure.ai.project.models._models.ConnectionsListSecretsResponse]
    """
...
class ConnectionsListSecretsResponse(_model_base.Model):
    ...
    :vartype properties: ~azure.ai.project.models._models.ConnectionProperties
    """
...
class Evaluation(_model_base.Model):
    ...
    :vartype data: ~azure.ai.project.models.InputData
    ...
    :vartype system_data: ~azure.ai.project.models.SystemData
    ...
    :vartype evaluators: dict[str, ~azure.ai.project.models.EvaluatorConfiguration]
    """
...
class EvaluationSchedule(_model_base.Model):
    ...
    :vartype name: str
    :ivar data: Data for evaluation. Required.
    :vartype data: ~azure.ai.project.models.ApplicationInsightsConfiguration
    :ivar description: Description of the evaluation. It can be used to store additional
     information about the evaluation and is mutable.
    :vartype description: str
    :ivar system_data: Metadata containing createdBy and modifiedBy information.
    ...
    :vartype trigger: ~azure.ai.project.models.Trigger
    :ivar sampling_strategy: Sampling strategy for the evaluation. Required.
    :vartype sampling_strategy: ~azure.ai.project.models.SamplingStrategy
    """
...
class FileListResponse(_model_base.Model):
    ...
    :vartype data: list[~azure.ai.project.models.OpenAIFile]
    """
...
class FileSearchToolDefinition(ToolDefinition, discriminator="file_search"):
    ...
    :vartype file_search: ~azure.ai.project.models.FileSearchToolDefinitionDetails
    """
...
class FileSearchToolResource(_model_base.Model):
    ...
    :ivar vector_stores:
    :vartype vector_stores: list[~azure.ai.project.models.VectorStoreFromAzure]
    """
...
class FunctionToolDefinition(ToolDefinition, discriminator="function"):
    ...
    :ivar function: The definition of the concrete function that the function tool should call.
     Required.
    :vartype function: ~azure.ai.project.models.FunctionDefinition
    """
...
class MessageAttachment(_model_base.Model):
    ...
    :vartype tools: list[~azure.ai.project.models.CodeInterpreterToolDefinition or
     ~azure.ai.project.models.FileSearchToolDefinition]
    """
...
class MessageDelta(_model_base.Model):
    ...
    :ivar role: The entity that produced the message. Required. Known values are: "user" and
     "assistant".
    :vartype role: str or ~azure.ai.project.models.MessageRole
    :ivar content: The content of the message as an array of text and/or images. Required.
    :vartype content: list[~azure.ai.project.models.MessageDeltaContent]
    """
...
class MessageDeltaChunk(_model_base.Model):
    ...
    :vartype delta: ~azure.ai.project.models.MessageDelta
    """
...
class MessageDeltaImageFileContent(MessageDeltaContent, discriminator="image_file"):
    ...
    :vartype image_file: ~azure.ai.project.models.MessageDeltaImageFileContentObject
    """
...
class MessageDeltaTextContent(MessageDeltaContent, discriminator="text"):
    ...
    :vartype text: ~azure.ai.project.models.MessageDeltaTextContentObject
    """
...
class MessageDeltaTextContentObject(_model_base.Model):
    ...
    :vartype annotations: list[~azure.ai.project.models.MessageDeltaTextAnnotation]
    """
...
class MessageDeltaTextFileCitationAnnotation(MessageDeltaTextAnnotation, discriminator="file_citation"):
    ...
    :vartype file_citation: ~azure.ai.project.models.MessageDeltaTextFileCitationAnnotationObject
...
class MessageDeltaTextFilePathAnnotation(MessageDeltaTextAnnotation, discriminator="file_path"):
    ...
    :vartype file_path: ~azure.ai.project.models.MessageDeltaTextFilePathAnnotationObject
    :ivar start_index: The start index of this annotation in the content text.
    :vartype start_index: int
    :ivar end_index: The end index of this annotation in the content text.
    :vartype end_index: int
...
class MessageImageFileContent(MessageContent, discriminator="image_file"):
    ...
    :vartype image_file: ~azure.ai.project.models.MessageImageFileDetails
    """
...
class MessageIncompleteDetails(_model_base.Model):
    ...
    :ivar reason: The provided reason describing why the message was marked as incomplete.
     ...
     "run_expired".
    :vartype reason: str or ~azure.ai.project.models.MessageIncompleteDetailsReason
    """
...
class MessageTextContent(MessageContent, discriminator="text"):
    ...
    :vartype text: ~azure.ai.project.models.MessageTextDetails
    """
...
class MessageTextDetails(_model_base.Model):
    ...
    :vartype annotations: list[~azure.ai.project.models.MessageTextAnnotation]
    """
...
class MessageTextFileCitationAnnotation(MessageTextAnnotation, discriminator="file_citation"):
    ...
    :vartype file_citation: ~azure.ai.project.models.MessageTextFileCitationDetails
...
class MessageTextFilePathAnnotation(MessageTextAnnotation, discriminator="file_path"):
    ...
    :vartype file_path: ~azure.ai.project.models.MessageTextFilePathDetails
    :ivar start_index: The first text index associated with this text annotation.
    :vartype start_index: int
    :ivar end_index: The last text index associated with this text annotation.
    :vartype end_index: int
...
class OpenAIFile(_model_base.Model):
    ...
    :vartype purpose: str or ~azure.ai.project.models.FilePurpose
    ...
    :vartype status: str or ~azure.ai.project.models.FileState
...
class OpenAIPageableListOfAgent(_model_base.Model):
    ...
    :vartype data: list[~azure.ai.project.models.Agent]
...
class OpenAIPageableListOfRunStep(_model_base.Model):
    ...
    :vartype object: str
    :ivar data: The requested list of items. Required.
    :vartype data: list[~azure.ai.project.models.RunStep]
    :ivar first_id: The first ID represented in this list. Required.
    :vartype first_id: str
    :ivar last_id: The last ID represented in this list. Required.
    :vartype last_id: str
...
class OpenAIPageableListOfThreadMessage(_model_base.Model):
    ...
    :vartype object: str
    :ivar data: The requested list of items. Required.
    :vartype data: list[~azure.ai.project.models.ThreadMessage]
    :ivar first_id: The first ID represented in this list. Required.
    :vartype first_id: str
    :ivar last_id: The last ID represented in this list. Required.
    :vartype last_id: str
...
class OpenAIPageableListOfThreadRun(_model_base.Model):
    ...
    :vartype object: str
    :ivar data: The requested list of items. Required.
    :vartype data: list[~azure.ai.project.models.ThreadRun]
    :ivar first_id: The first ID represented in this list. Required.
    :vartype first_id: str
    :ivar last_id: The last ID represented in this list. Required.
    :vartype last_id: str
...
class OpenAIPageableListOfVectorStore(_model_base.Model):
    ...
    :vartype object: str
    :ivar data: The requested list of items. Required.
    :vartype data: list[~azure.ai.project.models.VectorStore]
    :ivar first_id: The first ID represented in this list. Required.
    :vartype first_id: str
    :ivar last_id: The last ID represented in this list. Required.
    :vartype last_id: str
...
class OpenAIPageableListOfVectorStoreFile(_model_base.Model):
    ...
    :vartype object: str
    :ivar data: The requested list of items. Required.
    :vartype data: list[~azure.ai.project.models.VectorStoreFile]
    :ivar first_id: The first ID represented in this list. Required.
    :vartype first_id: str
    :ivar last_id: The last ID represented in this list. Required.
    :vartype last_id: str
...
class RecurrenceSchedule(_model_base.Model):
    ...
    :vartype week_days: list[str or ~azure.ai.project.models.WeekDays]
...
class RequiredFunctionToolCall(RequiredToolCall, discriminator="function"):
    ...
    :vartype function: ~azure.ai.project.models.RequiredFunctionToolCallDetails
    """
...
class RunStep(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.project.models.RunStepType
    ...
    :vartype status: str or ~azure.ai.project.models.RunStepStatus
    :ivar step_details: The details for this run step. Required.
    :vartype step_details: ~azure.ai.project.models.RunStepDetails
    :ivar last_error: If applicable, information about the last error encountered by this run step.
     Required.
    :vartype last_error: ~azure.ai.project.models.RunStepError
    :ivar created_at: The Unix timestamp, in seconds, representing when this object was created.
     Required.
    :vartype created_at: ~datetime.datetime
    ...
    :vartype usage: ~azure.ai.project.models.RunStepCompletionUsage
    :ivar metadata: A set of up to 16 key/value pairs that can be attached to an object, used for
     storing additional information about that object in a structured format. Keys may be up to 64
     characters in length and values may be up to 512 characters in length. Required.
    :vartype metadata: dict[str, str]
...
class RunStepCodeInterpreterImageOutput(RunStepCodeInterpreterToolCallOutput, discriminator="image"):
    ...
    :vartype image: ~azure.ai.project.models.RunStepCodeInterpreterImageReference
    """
...
class RunStepCodeInterpreterToolCall(RunStepToolCall, discriminator="code_interpreter"):
    ...
    :vartype code_interpreter: ~azure.ai.project.models.RunStepCodeInterpreterToolCallDetails
    """
...
class RunStepCodeInterpreterToolCallDetails(_model_base.Model):
    ...
    :vartype outputs: list[~azure.ai.project.models.RunStepCodeInterpreterToolCallOutput]
    """
...
class RunStepDelta(_model_base.Model):
    ...
    :vartype step_details: ~azure.ai.project.models.RunStepDeltaDetail
    """
...
class RunStepDeltaChunk(_model_base.Model):
    ...
    :vartype delta: ~azure.ai.project.models.RunStepDelta
    """
...
class RunStepDeltaCodeInterpreterDetailItemObject(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype outputs: list[~azure.ai.project.models.RunStepDeltaCodeInterpreterOutput]
    """
...
class RunStepDeltaCodeInterpreterImageOutput(RunStepDeltaCodeInterpreterOutput, discriminator="image"):
    ...
    :vartype image: ~azure.ai.project.models.RunStepDeltaCodeInterpreterImageOutputObject
    """
...
class RunStepDeltaCodeInterpreterToolCall(RunStepDeltaToolCall, discriminator="code_interpreter"):
    ...
    :vartype code_interpreter: ~azure.ai.project.models.RunStepDeltaCodeInterpreterDetailItemObject
    """
...
class RunStepDeltaFunctionToolCall(RunStepDeltaToolCall, discriminator="function"):
    ...
    :vartype function: ~azure.ai.project.models.RunStepDeltaFunction
    """
...
class RunStepDeltaMessageCreation(RunStepDeltaDetail, discriminator="message_creation"):
    ...
    :vartype message_creation: ~azure.ai.project.models.RunStepDeltaMessageCreationObject
    """
...
class RunStepDeltaToolCallObject(RunStepDeltaDetail, discriminator="tool_calls"):
    ...
    :vartype tool_calls: list[~azure.ai.project.models.RunStepDeltaToolCall]
    """
...
class RunStepError(_model_base.Model):
    ...
    :ivar code: The error code for this error. Required. Known values are: "server_error" and
     "rate_limit_exceeded".
    :vartype code: str or ~azure.ai.project.models.RunStepErrorCode
...
class RunStepFunctionToolCall(RunStepToolCall, discriminator="function"):
    ...
    :vartype function: ~azure.ai.project.models.RunStepFunctionToolCallDetails
    """
...
class RunStepMessageCreationDetails(RunStepDetails, discriminator="message_creation"):
    ...
    :vartype type: str or ~azure.ai.project.models.MESSAGE_CREATION
    :ivar message_creation: Information about the message creation associated with this run step.
     Required.
    :vartype message_creation: ~azure.ai.project.models.RunStepMessageCreationReference
    """
...
class RunStepToolCallDetails(RunStepDetails, discriminator="tool_calls"):
    ...
    :ivar type: The object type, which is always 'tool_calls'. Required. Represents a run step that
     calls tools.
    :vartype type: str or ~azure.ai.project.models.TOOL_CALLS
    :ivar tool_calls: A list of tool call details for this run step. Required.
    :vartype tool_calls: list[~azure.ai.project.models.RunStepToolCall]
    """
...
class SubmitToolOutputsAction(RequiredAction, discriminator="submit_tool_outputs"):
    ...
    :ivar submit_tool_outputs: The details describing tools that should be called to submit tool
     outputs. Required.
    :vartype submit_tool_outputs: ~azure.ai.project.models.SubmitToolOutputsDetails
    """
...
class SubmitToolOutputsDetails(_model_base.Model):
    ...
    :ivar tool_calls: The list of tool calls that must be resolved for the agent thread run to
     continue. Required.
    :vartype tool_calls: list[~azure.ai.project.models.RequiredToolCall]
    """
...
class ThreadMessage(_model_base.Model):
    ...
    :vartype status: str or ~azure.ai.project.models.MessageStatus
    :ivar incomplete_details: On an incomplete message, details about why the message is
     incomplete. Required.
    :vartype incomplete_details: ~azure.ai.project.models.MessageIncompleteDetails
    ...
    :vartype content: list[~azure.ai.project.models.MessageContent]
    ...
    :ivar attachments: A list of files attached to the message, and the tools they were added to.
     Required.
    :vartype attachments: list[~azure.ai.project.models.MessageAttachment]
    :ivar metadata: A set of up to 16 key/value pairs that can be attached to an object, used for
     storing additional information about that object in a structured format. Keys may be up to 64
     characters in length and values may be up to 512 characters in length. Required.
    :vartype metadata: dict[str, str]
...
class ThreadRun(_model_base.Model):
    ...
    :vartype incomplete_details: str or ~azure.ai.project.models.IncompleteRunDetails
    ...
    :vartype usage: ~azure.ai.project.models.RunCompletionUsage
    ...
    :vartype truncation_strategy: ~azure.ai.project.models.TruncationObject
    ...
    :vartype tool_choice: str or str or ~azure.ai.project.models.AgentsApiToolChoiceOptionMode or
    ...
    :vartype tool_resources: ~azure.ai.project.models.UpdateToolResourcesOptions
...
class TruncationObject(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.project.models.TruncationStrategy
...
class UpdateToolResourcesOptions(_model_base.Model):
    ...
    :ivar code_interpreter: Overrides the list of file IDs made available to the
     ...
     associated with the tool.
    :vartype code_interpreter: ~azure.ai.project.models.UpdateCodeInterpreterToolResourceOptions
    ...
    :vartype file_search: ~azure.ai.project.models.UpdateFileSearchToolResourceOptions
...
class VectorStorageDataSource(_model_base.Model):
    ...
    :vartype asset_type: str or ~azure.ai.project.models.VectorStorageDataSourceAssetType
    """
...
class VectorStore(_model_base.Model):
    ...
    :ivar file_counts: Files count grouped by status processed or being processed by this vector
     store. Required.
    :vartype file_counts: ~azure.ai.project.models.VectorStoreFileCount
    ...
    :vartype status: str or ~azure.ai.project.models.VectorStoreStatus
    :ivar expires_after: Details on when this vector store expires.
    :vartype expires_after: ~azure.ai.project.models.VectorStoreExpirationPolicy
...
class VectorStoreChunkingStrategyRequest(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.project.models.VectorStoreChunkingStrategyRequestType
    """
...
class VectorStoreAutoChunkingStrategyRequest(VectorStoreChunkingStrategyRequest, discriminator="auto"):
    ...
    :vartype type: str or ~azure.ai.project.models.AUTO
    """
...
class VectorStoreChunkingStrategyResponse(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.project.models.VectorStoreChunkingStrategyResponseType
    """
...
class VectorStoreAutoChunkingStrategyResponse(VectorStoreChunkingStrategyResponse, discriminator="other"):
    ...
    :vartype type: str or ~azure.ai.project.models.OTHER
    """
...
class VectorStoreExpirationPolicy(_model_base.Model):
    ...
    :vartype anchor: str or ~azure.ai.project.models.VectorStoreExpirationPolicyAnchor
...
class VectorStoreFile(_model_base.Model):
    ...
    :vartype status: str or ~azure.ai.project.models.VectorStoreFileStatus
    :ivar last_error: The last error associated with this vector store file. Will be ``null`` if
     there are no errors. Required.
    :vartype last_error: ~azure.ai.project.models.VectorStoreFileError
    :ivar chunking_strategy: The strategy used to chunk the file. Required.
    :vartype chunking_strategy: ~azure.ai.project.models.VectorStoreChunkingStrategyResponse
    """
...
class VectorStoreFileBatch(_model_base.Model):
    ...
    :vartype status: str or ~azure.ai.project.models.VectorStoreFileBatchStatus
    :ivar file_counts: Files count grouped by status processed or being processed by this vector
     store. Required.
    :vartype file_counts: ~azure.ai.project.models.VectorStoreFileCount
    """
...
class VectorStoreFileError(_model_base.Model):
    ...
    :vartype code: str or ~azure.ai.project.models.VectorStoreFileErrorCode
...
class VectorStoreFromAzure(_model_base.Model):
    ...
    :vartype store_configuration: ~azure.ai.project.models.VectorStorageConfiguration
    """
...
class VectorStoreStaticChunkingStrategyRequest(VectorStoreChunkingStrategyRequest, discriminator="static"):
    ...
    :vartype type: str or ~azure.ai.project.models.STATIC
    :ivar static: The options for the static chunking strategy. Required.
    :vartype static: ~azure.ai.project.models.VectorStoreStaticChunkingStrategyOptions
    """
