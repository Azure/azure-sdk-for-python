...
DESCRIPTION:
    ...
    the Azure Assistants service using a synchronous client with tracing to console and adding
    custom attributes to the span.

USAGE:
    python sample_assistants_basics_with_console_tracing_custom_attributes.py
