...
DESCRIPTION:
    ...
    the Azure Assistants service using a synchronous client.   The file is attached to thread.

USAGE:
    python sample_assistants_with_resources_in_thread.py
...
from azure.ai.assistants.models import FileSearchTool
...
with assistants_client:
    ...
    # [START create_assistant_and_thread_for_file_search]
    ...
    # [END create_assistant_and_thread_for_file_search]
