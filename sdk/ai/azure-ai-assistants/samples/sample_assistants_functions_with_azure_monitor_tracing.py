...
"""
DESCRIPTION:
    This sample demonstrates how to use basic assistant operations with function tools from
...
USAGE:
    python sample_assistants_functions_with_azure_monitor_tracing.py

    Before running the sample:

    pip install azure-ai-assistants azure-identity opentelemetry-sdk azure-monitor-opentelemetry
