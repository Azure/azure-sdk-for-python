...
from azure.ai.assistants.aio import AssistantsClient as AsyncAssistantsOperations
...
class TestDeclarator(unittest.TestCase):
    ...
    async def test_assert_errors(self, assistant: AssistantsClient, _: AsyncAssistantsOperations, assertion: OverloadAssertion):
        ...
        assistant.create_agent(model=model, instructions=instructions)
        assistant.create_agent(body=body)
