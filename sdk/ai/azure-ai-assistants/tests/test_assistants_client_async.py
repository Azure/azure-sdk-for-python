...
class TestAssistantClientAsync(AzureRecordedTestCase):
    ...
    async def test_clear_client(self, **kwargs):
        ...
        assistants = await client.assistants.list_assistants().data
        for assistant in assistants:
            await client.assistants.delete_assistant(assistant.id)
        assert client.assistants.list_assistants().data.__len__() == 0
    ...
    async def test_update_assistant(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # create assistant
            assistant = await client.assistants.create_assistant(body=body)
            assert assistant.id
            print("Created assistant, assistant ID", assistant.id)

            # update assistant and confirm changes went through
            assistant = await client.assistants.update_assistant(assistant.id, name="my-assistant2")
    ...
    async def test_update_assistant_with_body(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # update assistant and confirm changes went through
            assistant = await client.assistants.update_assistant(assistant.id, body=body2)
            assert assistant.name
            assert assistant.name == "my-assistant2"
    ...
    async def test_update_assistant_with_iobytes(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # update assistant and confirm changes went through
            assistant = await client.assistants.update_assistant(assistant.id, body=io.BytesIO(binary_body))
            assert assistant.name
            assert assistant.name == "my-assistant2"
    ...
    async def test_assistant_list(self, **kwargs):
        ...
        client = self.create_client(**kwargs)
        list_length = await client.assistants.list_assistants().data.__len__()
       ...
       assistant = await client.assistants.create_assistant(
        ...
        assistant2 = await client.assistants.create_assistant(model="gpt-4o", name="my-assistant2", instructions="You are helpful assistant")
        assert client.assistants.list_assistants().data.__len__() == list_length + 2
        assert client.assistants.list_assistants().data[0].id == assistant.id or client.assistants.list_assistants().data[1].id == assistant.id 
    ...
    async def test_create_thread(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # create thread
            thread = await client.assistants.create_thread()
    ...
    async def test_create_thread_with_metadata(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # create thread
            thread = await client.assistants.create_thread(metadata=metadata)
            assert isinstance(thread, AssistantThread)
            assert thread.id
            print("Created thread, thread ID", thread.id)
    ...
    async def test_create_thread_with_body(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # create thread
            thread = await client.assistants.create_thread(body=body)
            assert isinstance(thread, AssistantThread)
            assert thread.id
            print("Created thread, thread ID", thread.id)
            assert thread.metadata == {"key1": "value1", "key2": "value2"}
    ...
    async def test_create_thread_with_iobytes(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # create thread
            thread = await client.assistants.create_thread(body=io.BytesIO(binary_body))
            assert isinstance(thread, AssistantThread)
            assert thread.id
            print("Created thread, thread ID", thread.id)
            assert thread.metadata == {"key1": "value1", "key2": "value2"}
    ...
    async def test_get_thread(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # get thread
            thread2 = await client.assistants.get_thread(thread.id)
            assert thread2.id
    ...
    async def test_update_thread(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # update thread
            thread = await client.assistants.update_thread(thread.id, metadata={"key1": "value1", "key2": "value2"})
            assert thread.metadata == {"key1": "value1", "key2": "value2"}
    ...
    async def test_update_thread_with_metadata(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # update thread
            thread = await client.assistants.update_thread(thread.id, metadata=metadata2)
    ...
    async def test_update_thread_with_body(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # update thread
            thread = await client.assistants.update_thread(thread.id, body=body)
            assert thread.metadata == {"key1": "value1", "key2": "value2"}
    ...
    async def test_update_thread_with_iobytes(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # update thread
            thread = await client.assistants.update_thread(thread.id, body=io.BytesIO(binary_body))
            assert thread.metadata == {"key1": "value1", "key2": "value2"}
    ...
    async def test_delete_thread(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # delete thread
            deletion_status = await client.assistants.delete_thread(thread.id)
    ...
    async def test_create_message(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # create message
            message = await client.assistants.create_message(
    ...
    async def test_create_message_with_body(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # create message
            message = await client.assistants.create_message(thread_id=thread.id, body=body)
            assert message.id
            print("Created message, message ID", message.id)
    ...
    async def test_create_message_with_iobytes(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # create message
            message = await client.assistants.create_message(thread_id=thread.id, body=io.BytesIO(binary_body))
            assert message.id
            print("Created message, message ID", message.id)
    ...
    async def test_list_messages(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            messages0 = await client.assistants.list_messages(thread_id=thread.id)
            print(messages0.data)
            assert messages0.data.__len__() == 0

            # create messages and check message list for each one
            message1 = await client.assistants.create_message(
                thread_id=thread.id, role="user", content="Hello, tell me a joke"
            )
            assert message1.id
            print("Created message, message ID", message1.id)
            messages1 = await client.assistants.list_messages(thread_id=thread.id)
            ...
            assert message2.id
            print("Created message, message ID", message2.id)
            messages2 = await client.assistants.list_messages(thread_id=thread.id)
            ...
            assert message3.id
            print("Created message, message ID", message3.id)
            messages3 = await client.assistants.list_messages(thread_id=thread.id)
    ...
    async def test_get_message(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # get message
            message2 = await client.assistants.get_message(thread_id=thread.id, message_id=message.id)
            assert message2.id
    ...
    async def test_update_message(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # update message
            message = await client.assistants.update_message(
    ...
    async def test_update_message_with_body(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # update message
            message = await client.assistants.update_message(thread_id=thread.id, message_id=message.id, body=body)
            assert message.metadata == {"key1": "value1", "key2": "value2"}
    ...
    async def test_create_run(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # create run
            run = await client.assistants.create_run(thread_id=thread.id, assistant_id=assistant.id)
            assert run.id
    ...
    async def test_create_run_with_metadata(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # create run
            run = await client.assistants.create_run(
    ...
    async def test_create_run_with_body(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # create run
            run = await client.assistants.create_run(thread_id=thread.id, body=body)
            assert run.id
            assert run.metadata == {"key1": "value1", "key2": "value2"}
            print("Created run, run ID", run.id)
    ...
    async def test_create_run_with_iobytes(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # create run
            run = await client.assistants.create_run(thread_id=thread.id, body=io.BytesIO(binary_body))
            assert run.id
            assert run.metadata == {"key1": "value1", "key2": "value2"}
            print("Created run, run ID", run.id)
    ...
    async def test_get_run(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # get run
            run2 = await client.assistants.get_run(thread_id=thread.id, run_id=run.id)
            assert run2.id
    ...
    async def test_run_status(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            while run.status in ["queued", "in_progress", "requires_action"]:
                # wait for a second
                time.sleep(1)
                run = await client.assistants.get_run(thread_id=thread.id, run_id=run.id)
    ...
    async def test_list_runs(self, **kwargs):
        ...
        runs0 = await client.assistants.list_runs(thread_id=thread.id)
        ...
        assert run.id
        print("Created run, run ID", run.id)
        runs1 = await client.assistants.list_runs(thread_id=thread.id)
        assert runs1.data.__len__() == 1
        assert runs1.data[0].id == run.id

        # create second run
        run2 = await client.assistants.create_run(thread_id=thread.id, assistant_id=assistant.id)
        assert run2.id
        print("Created run, run ID", run2.id)
        runs2 = await client.assistants.list_runs(thread_id=thread.id)
    ...
    async def test_update_run(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            while run.status in ["queued", "in_progress"]:
                time.sleep(5)
                run = await client.assistants.get_run(thread_id=thread.id, run_id=run.id)
            run = await client.assistants.update_run(
    ...
    async def test_update_run_with_body(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            while run.status in ["queued", "in_progress"]:
                time.sleep(5)
                run = await client.assistants.get_run(thread_id=thread.id, run_id=run.id)
            run = await client.assistants.update_run(thread_id=thread.id, run_id=run.id, body=body)
            assert run.metadata == {"key1": "value1", "key2": "newvalue2"}
    ...
    async def test_update_run_with_iobytes(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            while run.status in ["queued", "in_progress"]:
                time.sleep(5)
                run = await client.assistants.get_run(thread_id=thread.id, run_id=run.id)
            run = await client.assistants.update_run(thread_id=thread.id, run_id=run.id, body=io.BytesIO(binary_body))
            assert run.metadata == {"key1": "value1", "key2": "newvalue2"}
    ...
    async def test_submit_tool_outputs_to_run(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            while run.status in ["queued", "in_progress", "requires_action"]:
                ...
                if run.status == "requires_action" and run.required_action.submit_tool_outputs:
                    ...
                    if not tool_calls:
                        ...
                        await client.assistants.cancel_run(thread_id=thread.id, run_id=run.id)
                        break
            ...
            messages = await client.assistants.list_messages(thread_id=thread.id, run_id=run.id)
    ...
    async def test_cancel_run(self, **kwargs):
        ...
        # create message
        message = await client.assistants.create_message(thread_id=thread.id, role="user", content="Hello, what time is it?")
        assert message.id
        print("Created message, message ID", message.id)
    ...
    async def _wait_for_run(self, client, run, timeout=1):
        ...
        while run.status in [RunStatus.QUEUED, RunStatus.IN_PROGRESS, RunStatus.REQUIRES_ACTION]:
            time.sleep(timeout)
            run = await client.assistants.get_run(thread_id=run.thread_id, run_id=run.id)
        return run
    ...
    async def _do_test_create_parallel_thread_runs(self, use_parallel_runs, create_thread_run, **kwargs):
        ...
        if create_thread_run:
            run = await client.assistants.create_thread_and_run(
                assistant_id=assistant.id,
                parallel_tool_calls=use_parallel_runs,
            )
            run = await self._wait_for_run(client, run)
        else:
            thread = await client.assistants.create_thread(messages=[message])
            assert thread.id

            run = await client.assistants.create_and_process_run(
                thread_id=thread.id,
                assistant_id=assistant.id,
                parallel_tool_calls=use_parallel_runs,
            )
        ...
        assert (await client.assistants.delete_assistant(assistant.id)).deleted, "The assistant was not deleted"
        messages = await client.assistants.list_messages(thread_id=run.thread_id)
    ...
    async def test_create_thread_and_run(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            run = await client.assistants.create_thread_and_run(assistant_id=assistant.id)
            assert run.id
            assert run.thread_id
            print("Created run, run ID", run.id)

            # get thread
            thread = await client.assistants.get_thread(run.thread_id)
            assert thread.id
            print("Created thread, thread ID", thread.id)
    ...
    async def test_create_thread_and_run_with_body(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # create thread and run
            run = await client.assistants.create_thread_and_run(body=body)
            assert run.id
            assert run.thread_id
            assert run.metadata == {"key1": "value1", "key2": "value2"}
            print("Created run, run ID", run.id)
    ...
    async def test_create_thread_and_run_with_iobytes(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            # create thread and run
            run = await client.assistants.create_thread_and_run(body=io.BytesIO(binary_body))
            assert run.id
            assert run.thread_id
            assert run.metadata == {"key1": "value1", "key2": "value2"}
            print("Created run, run ID", run.id)
    ...
    async def test_list_run_step(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            steps = await client.assistants.list_run_steps(thread_id=thread.id, run_id=run.id)
            ...
            while run.status in ["queued", "in_progress", "requires_action"]:
                ...
                print("Run status:", run.status)
                steps = await client.assistants.list_run_steps(
    ...
    async def test_get_run_step(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            assert steps["data"].__len__() > 0
            step = steps["data"][0]
            get_step = await client.assistants.get_run_step(thread_id=thread.id, run_id=run.id, step_id=step.id)
    ...
    async def _do_test_create_vector_store(self, streaming, **kwargs):
        ...
        vector_store = await ai_client.assistants.create_vector_store_and_poll(
    ...
    async def _do_test_create_vector_store_add_file(self, streaming, **kwargs):
        ...
        assert vector_store.id
        vector_store_file = await ai_client.assistants.create_vector_store_file(
    ...
    async def _do_test_create_vector_store_batch(self, streaming, **kwargs):
        ...
        vector_store = await ai_client.assistants.create_vector_store_and_poll(file_ids=[], name="sample_vector_store")
        assert vector_store.id
        vector_store_file_batch = await ai_client.assistants.create_vector_store_file_batch_and_poll(
    ...
    async def _test_file_search(
        ...
        assistant = await ai_client.assistants.create_assistant(
            model="gpt-4",
            name="my-assistant",
        ...
        assert assistant.id
        thread = await ai_client.assistants.create_thread()
        assert thread.id
        # create message
        message = await ai_client.assistants.create_message(
        ...
        if streaming:
            ...
            run = await ai_client.assistants.get_run(thread_id=thread_run.thread_id, run_id=thread_run.id)
            assert run is not None
        else:
            run = await ai_client.assistants.create_and_process_run(thread_id=thread.id, assistant_id=assistant.id)
        await ai_client.assistants.delete_vector_store(vector_store.id)
        assert run.status == "completed", f"Error in run: {run.last_error}"
        messages = await ai_client.assistants.list_messages(thread_id=thread.id)
        assert len(messages)
        await self._remove_file_maybe(file_id, ai_client)
        # delete assistant and close client
        await ai_client.assistants.delete_assistant(assistant.id)
        print("Deleted assistant")
        await ai_client.close()
    ...
    async def test_vector_store_threads_file_search_azure(self, **kwargs):
        ...
        thread = await ai_client.assistants.create_thread(tool_resources=ToolResources(file_search=fs))
        assert thread.id
        # create message
        message = await ai_client.assistants.create_message(
            thread_id=thread.id, role="user", content="What does the attachment say?"
        ...
        run = await ai_client.assistants.create_and_process_run(thread_id=thread.id, assistant_id=assistant.id)
        assert run.status == "completed", f"Error in run: {run.last_error}"
        messages = await ai_client.assistants.list_messages(thread.id)
        assert len(messages)
        await ai_client.assistants.delete_assistant(assistant.id)
        await ai_client.close()
    ...
    async def _do_test_create_assistant_with_interpreter(self, **kwargs):
        ...
        if "file_path" in kwargs:
            file = await ai_client.assistants.upload_file_and_poll(
    ...
    async def _do_test_create_thread_with_interpreter(self, **kwargs):
        ...
        thread = await ai_client.assistants.create_thread(tool_resources=tr)
        assert thread.id, "The thread was not created."
    ...
    async def _do_test_create_attachment_in_thread_azure(self, **kwargs):
        ...
        thread = await ai_client.assistants.create_thread(messages=[message])
        assert thread.id
    ...
    async def test_azure_function_call(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            run = await client.assistants.create_and_process_run(thread_id=thread.id, assistant_id=assistant.id)
            assert run.status == RunStatus.COMPLETED, f"The run is in {run.status} state."

            # Get messages from the thread
            messages = await client.assistants.list_messages(thread_id=thread.id)
            ...
            result = await client.assistants.delete_assistant(assistant.id)
    ...
    async def test_client_with_thread_messages(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as client:
            ...
            while run.status in [RunStatus.QUEUED, RunStatus.IN_PROGRESS]:
                # wait for a second
                time.sleep(1)
                run = await client.assistants.get_run(
                    thread_id=thread.id,
                    run_id=run.id,
                )
    ...
    async def _do_test_include_file_search_results(self, use_stream, include_content, **kwargs):
        ...
        async with self.create_client(**kwargs) as ai_client:
            ...
            if use_stream:
                ...
                run = await ai_client.assistants.create_and_process_run(
                    thread_id=thread.id, assistant_id=assistant.id, include=include
                )
                assert run.status == RunStatus.COMPLETED
            assert run is not None
            steps = await ai_client.assistants.list_run_steps(thread_id=thread.id, run_id=run.id, include=include)
            # The 1st (not 0th) step is a tool call.
            step_id = steps.data[1].id
            one_step = await ai_client.assistants.get_run_step(
    ...
    async def test_assistants_with_json_schema(self, **kwargs):
        ...
        async with self.create_client(**kwargs) as ai_client:
            ...
            del_assistant = await ai_client.assistants.delete_assistant(assistant.id)
    ...
    async def _remove_file_maybe(self, file_id: str, ai_client: AssistantsClient) -> None:
        ...
        if file_id:
            await ai_client.assistants.delete_file(file_id)
