...
class TestModelClient(ModelClientTestBase):
    ...
    def test_create_client(self, **kwargs):
        # create client
        client = sdk.AssistantsClient(**kwargs) # TODO replace with **kwargs
    ...
    def test_update_assistant(self, **kwargs):
        ...
        assistant.update(name="my-assistant2", instructions="You are helpful assistant") # TODO figure out how update works lol
