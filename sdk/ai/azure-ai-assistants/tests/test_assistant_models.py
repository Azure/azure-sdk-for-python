...
from azure.ai.assistants.models._patch import _parse_event
from azure.ai.assistants.models import AssistantStreamEvent
from azure.ai.assistants.models import ThreadRun, RunStep, ThreadMessage, MessageDeltaChunk, RunStepDeltaChunk
...
class TestBaseAssistantEventHandler:
    class MyAssistantEventhHandler(BaseAssistantEventHandler[str]):
    ...
    def mock_callable(self, _: ThreadRun, __: BaseAssistantEventHandler[str]) -> None:
        pass
...
class TestAssistantEventHandler:
    ...
    class MyAssistantEventHandler(AssistantEventHandler[None]):
        pass
    ...
    @patch("azure.ai.assistants.models._patch.AssistantEventHandler.on_unhandled_event")
...
class TestParseEvent:
    ...
    def test_parse_event_thread_run_created(self):
        ...
        assert event_type == AssistantStreamEvent.THREAD_RUN_CREATED.value
    ...
    def test_parse_event_thread_run_step_created(self):
        ...
        event_type, event_obj = _parse_event(event_data_str)
        assert event_type == AssistantStreamEvent.THREAD_RUN_STEP_CREATED.value
    ...
    def test_parse_event_thread_message_created(self):
        ...
        event_type, event_obj = _parse_event(event_data_str)
        assert event_type == AssistantStreamEvent.THREAD_MESSAGE_CREATED.value
    ...
    def test_parse_event_thread_message_delta(self):
        ...
        event_type, event_obj = _parse_event(event_data_str)
        assert event_type == AssistantStreamEvent.THREAD_MESSAGE_DELTA.value
    ...
    def test_parse_event_thread_run_step_delta(self):
        ...
        event_type, event_obj = _parse_event(event_data_str)
        assert event_type == AssistantStreamEvent.THREAD_RUN_STEP_DELTA.value
