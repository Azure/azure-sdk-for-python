...
from .._vendor import AssistantsClientMixinABC, FileType, prepare_multipart_form_data
...
def build_assistants_get_message_request(thread_id: str, message_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/openai/threads/{threadId}/messages/{messageId}"
    path_format_arguments = {
        "threadId": _SERIALIZER.url("thread_id", thread_id, "str"),
...
def build_assistants_create_run_request(thread_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_assistants_submit_tool_outputs_to_run_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/openai/threads/{threadId}/runs/{runId}/submit_tool_outputs"
    path_format_arguments = {
        "threadId": _SERIALIZER.url("thread_id", thread_id, "str"),
        "runId": _SERIALIZER.url("run_id", run_id, "str"),
    }
...
def build_assistants_cancel_run_request(thread_id: str, run_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/openai/threads/{threadId}/runs/{runId}/cancel"
    path_format_arguments = {
        "threadId": _SERIALIZER.url("thread_id", thread_id, "str"),
        "runId": _SERIALIZER.url("run_id", run_id, "str"),
    }
