...
from ._enums import RunStepType, VectorStoreChunkingStrategyRequestType, VectorStoreChunkingStrategyResponseType
...
class Assistant(_model_base.Model):  # pylint: disable=too-many-instance-attributes
...
class AssistantsApiResponseFormat(_model_base.Model):
    ...
    :ivar type: Must be one of ``text`` or ``json_object``. Known values are: "text" and
     "json_object".
    :vartype type: str or ~azure.ai.assistants.models.ApiResponseFormat
    """
...
class FunctionToolDefinition(ToolDefinition, discriminator="function"):
    ...
    :ivar function: The definition of the concrete function that the function tool should call.
     Required.
    :vartype function: ~azure.ai.assistants.models._models.FunctionDefinition
    """
    ...
    function: "_models._models.FunctionDefinition" = rest_field()
    ...
    def __init__(
        self,
        *,
        function: "_models._models.FunctionDefinition",
    ): ...
...
class MessageImageFileContent(MessageContent, discriminator="image_file"):
    ...
    :vartype image_file: ~azure.ai.assistants.models._models.MessageImageFileDetails
    """

    type: Literal["image_file"] = rest_discriminator(name="type")  # type: ignore
    """The object type, which is always 'image_file'. Required. Default value is \"image_file\"."""
    image_file: "_models._models.MessageImageFileDetails" = rest_field()
    ...
    def __init__(
        self,
        *,
        image_file: "_models._models.MessageImageFileDetails",
    ): ...
...
class MessageTextContent(MessageContent, discriminator="text"):
    ...
    :vartype text: ~azure.ai.assistants.models._models.MessageTextDetails
    """
    ...
    text: "_models._models.MessageTextDetails" = rest_field()
    ...
    def __init__(
        self,
        *,
        text: "_models._models.MessageTextDetails",
    ): ...
...
class MessageTextFileCitationAnnotation(MessageTextAnnotation, discriminator="file_citation"):
    ...
    :vartype file_citation: ~azure.ai.assistants.models._models.MessageTextFileCitationDetails
    ...
    file_citation: "_models._models.MessageTextFileCitationDetails" = rest_field()
    ...
    def __init__(
        ...
        *,
        text: str,
        file_citation: "_models._models.MessageTextFileCitationDetails",
...
class MessageTextFilePathAnnotation(MessageTextAnnotation, discriminator="file_path"):
    ...
    :vartype file_path: ~azure.ai.assistants.models._models.MessageTextFilePathDetails
    :ivar start_index: The first text index associated with this text annotation.
    :vartype start_index: int
    :ivar end_index: The last text index associated with this text annotation.
    :vartype end_index: int
    ...
    file_path: "_models._models.MessageTextFilePathDetails" = rest_field()
    ...
    def __init__(
        ...
        *,
        text: str,
        file_path: "_models._models.MessageTextFilePathDetails",
        start_index: Optional[int] = None,
        end_index: Optional[int] = None,
    ): ...
...
class RequiredFunctionToolCall(RequiredToolCall, discriminator="function"):
    ...
    :vartype function: ~azure.ai.assistants.models._models.RequiredFunctionToolCallDetails
    """

    type: Literal["function"] = rest_discriminator(name="type")  # type: ignore
    """The object type of the required tool call. Always 'function' for function tools. Required.
     Default value is \"function\"."""
    function: "_models._models.RequiredFunctionToolCallDetails" = rest_field()
    ...
    def __init__(
        ...
        *,
        id: str,  # pylint: disable=redefined-builtin
        function: "_models._models.RequiredFunctionToolCallDetails",
    ): ...
...
class RunStepCodeInterpreterToolCall(RunStepToolCall, discriminator="code_interpreter"):
    ...
    :vartype code_interpreter:
     ~azure.ai.assistants.models._models.RunStepCodeInterpreterToolCallDetails
    """

    type: Literal["code_interpreter"] = rest_discriminator(name="type")  # type: ignore
    """The object type, which is always 'code_interpreter'. Required. Default value is
     \"code_interpreter\"."""
    code_interpreter: "_models._models.RunStepCodeInterpreterToolCallDetails" = rest_field()
    ...
    def __init__(
        ...
        *,
        id: str,  # pylint: disable=redefined-builtin
        code_interpreter: "_models._models.RunStepCodeInterpreterToolCallDetails",
    ): ...
...
class RunStepFunctionToolCall(RunStepToolCall, discriminator="function"):
    ...
    :vartype function: ~azure.ai.assistants.models._models.RunStepFunctionToolCallDetails
    """

    type: Literal["function"] = rest_discriminator(name="type")  # type: ignore
    """The object type, which is always 'function'. Required. Default value is \"function\"."""
    function: "_models._models.RunStepFunctionToolCallDetails" = rest_field()
    ...
    def __init__(
        ...
        *,
        id: str,  # pylint: disable=redefined-builtin
        function: "_models._models.RunStepFunctionToolCallDetails",
    ): ...
...
class SubmitToolOutputsAction(RequiredAction, discriminator="submit_tool_outputs"):
    ...
    :ivar submit_tool_outputs: The details describing tools that should be called to submit tool
     outputs. Required.
    :vartype submit_tool_outputs: ~azure.ai.assistants.models._models.SubmitToolOutputsDetails
    """
    ...
    """The object type, which is always 'submit_tool_outputs'. Required. Default value is
     \"submit_tool_outputs\"."""
    submit_tool_outputs: "_models._models.SubmitToolOutputsDetails" = rest_field()
    ...
    def __init__(
        self,
        *,
        submit_tool_outputs: "_models._models.SubmitToolOutputsDetails",
    ): ...
...
class ThreadRun(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype incomplete_details: str or ~azure.ai.assistants.models.IncompleteRunDetails
