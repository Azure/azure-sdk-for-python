...
3. Add support for with_default() method (all clients)
...
class ChatCompletionsClient(ChatCompletionsClientGenerated):  # pylint: disable=too-many-instance-attributes
    ...
    def with_defaults(
        ...
        *,
        ...
        :paramtype model: str
        :return: A new ChatCompletionsClient object with defaults set.
        ...
        return self.__class__(
            ...
            model_extras=model_extras if model_extras is not None else self._model_extras,
