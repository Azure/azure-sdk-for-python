...
class AIInferenceInstrumentor:
    ...
    :param version: The semantic conventions version to use for traces.
                    If no value is provided, then by default, the latest
                    stable version supported by this library version is used.
                    If there is no stable version known by this version of the
    ...
    def __init__(self, version : SemanticConventionsVersion = SemanticConventionsVersion.PREVIEW):
        ...
        if version == SemanticConventionsVersion.PREVIEW:
            ...
            raise AzureError("Unsupported semantic conventions version")
