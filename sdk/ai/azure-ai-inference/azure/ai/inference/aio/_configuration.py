...
class ModelClientConfiguration:  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, credential: Union[AzureKeyCredential, "AsyncTokenCredential"], **kwargs: Any) -> None:
        ...
        self.credential_scopes = kwargs.pop("credential_scopes", ["https://widget.contoso.com/.default"])
