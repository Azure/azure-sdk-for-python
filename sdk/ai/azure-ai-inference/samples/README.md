...
|[sample_chat_completions_with_client_generator.py](https://github.com/Azure/azure-sdk-for-python/blob/main/sdk/ai/azure-ai-inference/samples/sample_chat_completions_with_client_generator.py) | Shows how do use the `ClientGenerator.from_endpoint()` to create the appropriate client based on the provided endpoint URL. In this example, it creates a `ChatCompletionsClient`. |
