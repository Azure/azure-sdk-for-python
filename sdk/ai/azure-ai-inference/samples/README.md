...
|sample_chat_completions_with_audio_data.py | One chat completion operation using a synchronous client, which includes sending input audio data read from a local file. |
