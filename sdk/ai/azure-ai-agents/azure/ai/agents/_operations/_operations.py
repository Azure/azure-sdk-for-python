...
from .._vendor import AgentsClientMixinABC, prepare_multipart_form_data
...
class AgentsClientOperationsMixin(AgentsClientMixinABC):  # pylint: disable=too-many-public-methods
