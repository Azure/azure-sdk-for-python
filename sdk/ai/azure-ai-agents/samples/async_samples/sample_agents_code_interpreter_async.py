    ...
    async with DefaultAzureCredential() as creds:
        ...
        async with AgentsClient(endpoint=os.environ["PROJECT_ENDPOINT"], credential=creds) as agents_client:
            ...
            for image_content in messages.image_contents:
                ...
                await agents_client.save_file(file_id=image_content.image_file.file_id, file_name=file_name)
            ...
            for file_path_annotation in messages.file_path_annotations:
                ...
                await agents_client.save_file(file_id=file_path_annotation.file_path.file_id, file_name=file_name)
                print(f"Saved image file to: {Path.cwd() / file_name}")
