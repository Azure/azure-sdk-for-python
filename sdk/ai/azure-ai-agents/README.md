...
Also note that if you use the asynchronous client, you use `AsyncToolSet` instead.  Additional information related to `AsyncFunctionTool` will be discussed in later sections.
