...
To enable content recording set the `AZURE_TRACING_GEN_AI_CONTENT_RECORDING_ENABLED` environemnt variable value to `true`. If the environment variable is not found, then the value will default to `false`.
