...
"""
FILE: voice_assistant_w_proactive_greeting_async.py
...
DESCRIPTION:
    ...
    This sample includes two proactive greeting options:
    1) Pre-generated assistant message using response.create with pre_generated_assistant_message
    2) Conversation item create approach that triggers a natural response generated by the model of the assistant
...
class BasicVoiceAssistant:
    ...
    async def _handle_event(self, event):
        ...
        if event.type == ServerEventType.SESSION_UPDATED:
            ...
            # Proactive greeting option 1: pre-generated assistant message
            # if not self.conversation_started:
            #     self.conversation_started = True
            #     # Send proactive greeting using raw response.create event with a pre-generated assistant message.
            ...
            # Proactive greeting option 2: conversation item create
            if not self.conversation_started:
                self.conversation_started = True
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        default=os.environ.get(
            ...
            "Keep your responses concise but engaging. Always start the conversation in English.",
        ),
    )
