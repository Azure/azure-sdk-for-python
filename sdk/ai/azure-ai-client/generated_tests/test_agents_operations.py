...
class TestAgentsOperations(ClientTestBase):
    @Preparer()
    @recorded_by_proxy
    def test_agents_create_agent(self, _endpoint):
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_list_agents(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_get_agent(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_update_agent(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_delete_agent(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_create_thread(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_get_thread(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_update_thread(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_delete_thread(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_create_message(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_list_messages(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_get_message(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_update_message(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_create_run(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_list_runs(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_get_run(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_update_run(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_submit_tool_outputs_to_run(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_cancel_run(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_create_thread_and_run(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_get_run_step(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_list_run_steps(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_list_files(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_upload_file(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_delete_file(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_get_file(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_get_file_content(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_list_vector_stores(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_create_vector_store(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_get_vector_store(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_modify_vector_store(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_delete_vector_store(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_list_vector_store_files(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_create_vector_store_file(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_get_vector_store_file(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_delete_vector_store_file(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_create_vector_store_file_batch(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_get_vector_store_file_batch(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_cancel_vector_store_file_batch(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
    ...
    @Preparer()
    @recorded_by_proxy
    def test_agents_list_vector_store_file_batch_files(self, _endpoint):
        client = self.create_client(endpoint=_endpoint)
