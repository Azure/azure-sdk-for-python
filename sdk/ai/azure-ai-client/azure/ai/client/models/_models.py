...
class Agent(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype tools: list[~azure.ai.client.models.ToolDefinition]
    :ivar tool_resources: A set of resources that are used by the agent's tools. The resources are
     ...
     store IDs. Required.
    :vartype tool_resources: ~azure.ai.client.models.ToolResources
    ...
    :vartype response_format: str or str or ~azure.ai.client.models.AgentsApiResponseFormatMode or
...
class AgentsApiResponseFormat(_model_base.Model):
    ...
    :ivar type: Must be one of ``text`` or ``json_object``. Known values are: "text" and
     "json_object".
    :vartype type: str or ~azure.ai.client.models.ApiResponseFormat
    """
...
class AgentThreadCreationOptions(_model_base.Model):
    ...
    :vartype messages: list[~azure.ai.client.models.ThreadMessageOptions]
    :ivar tool_resources: A set of resources that are made available to the agent's tools in this
...
class CodeInterpreterToolResource(_model_base.Model):
    ...
    :ivar data_sources: The data sources to be used. This option is mutually exclusive with
     fileIds.
    :vartype data_sources: list[~azure.ai.client.models.VectorStorageDataSource]
    """
...
class FileListResponse(_model_base.Model):
    ...
    :vartype data: list[~azure.ai.client.models.OpenAIFile]
    """
...
class FileSearchToolDefinition(ToolDefinition, discriminator="file_search"):
    ...
    :vartype file_search: ~azure.ai.client.models.FileSearchToolDefinitionDetails
    """
...
class FileSearchToolResource(_model_base.Model):
    ...
    :ivar vector_stores:
    :vartype vector_stores: list[~azure.ai.client.models.VectorStoreFromAzure]
    """
...
class FunctionToolDefinition(ToolDefinition, discriminator="function"):
    ...
    :ivar function: The definition of the concrete function that the function tool should call.
     Required.
    :vartype function: ~azure.ai.client.models.FunctionDefinition
    """
...
class MessageAttachment(_model_base.Model):
    ...
    :vartype tools: list[~azure.ai.client.models.CodeInterpreterToolDefinition or
     ~azure.ai.client.models.FileSearchToolDefinition]
    """
...
class MessageDelta(_model_base.Model):
    ...
    :vartype content: list[~azure.ai.client.models.MessageDeltaContent]
    """
...
class MessageDeltaChunk(_model_base.Model):
    ...
    :vartype delta: ~azure.ai.client.models.MessageDelta
    """
...
class MessageDeltaImageFileContent(MessageDeltaContent, discriminator="image_file"):
    ...
    :vartype image_file: ~azure.ai.client.models.MessageDeltaImageFileContentObject
    """
...
class MessageDeltaTextContent(MessageDeltaContent, discriminator="text"):
    ...
    :vartype text: ~azure.ai.client.models.MessageDeltaTextContentObject
    """
...
class MessageDeltaTextContentObject(_model_base.Model):
    ...
    :vartype annotations: list[~azure.ai.client.models.MessageDeltaTextAnnotation]
    """
...
class MessageDeltaTextFileCitationAnnotation(MessageDeltaTextAnnotation, discriminator="file_citation"):
    ...
    :vartype file_citation: ~azure.ai.client.models.MessageDeltaTextFileCitationAnnotationObject
...
class MessageDeltaTextFilePathAnnotation(MessageDeltaTextAnnotation, discriminator="file_path"):
    ...
    :vartype file_path: ~azure.ai.client.models.MessageDeltaTextFilePathAnnotationObject
    :ivar start_index: The start index of this annotation in the content text.
    :vartype start_index: int
    :ivar end_index: The end index of this annotation in the content text.
    :vartype end_index: int
...
class MessageImageFileContent(MessageContent, discriminator="image_file"):
    ...
    :vartype image_file: ~azure.ai.client.models.MessageImageFileDetails
    """
...
class MessageIncompleteDetails(_model_base.Model):
    ...
    :ivar reason: The provided reason describing why the message was marked as incomplete.
     ...
     "run_expired".
    :vartype reason: str or ~azure.ai.client.models.MessageIncompleteDetailsReason
    """
...
class MessageTextContent(MessageContent, discriminator="text"):
    ...
    :vartype text: ~azure.ai.client.models.MessageTextDetails
    """
...
class MessageTextDetails(_model_base.Model):
    ...
    :vartype annotations: list[~azure.ai.client.models.MessageTextAnnotation]
    """
...
class MessageTextFileCitationAnnotation(MessageTextAnnotation, discriminator="file_citation"):
    ...
    :vartype file_citation: ~azure.ai.client.models.MessageTextFileCitationDetails
...
class MessageTextFilePathAnnotation(MessageTextAnnotation, discriminator="file_path"):
    ...
    :vartype file_path: ~azure.ai.client.models.MessageTextFilePathDetails
    :ivar start_index: The first text index associated with this text annotation.
    :vartype start_index: int
    :ivar end_index: The last text index associated with this text annotation.
    :vartype end_index: int
...
class OpenAIFile(_model_base.Model):
    ...
    :vartype purpose: str or ~azure.ai.client.models.FilePurpose
    ...
    :vartype status: str or ~azure.ai.client.models.FileState
...
class OpenAIPageableListOfAgent(_model_base.Model):
    ...
    :vartype data: list[~azure.ai.client.models.Agent]
...
class OpenAIPageableListOfRunStep(_model_base.Model):
    ...
    :vartype object: str
    :ivar data: The requested list of items. Required.
    :vartype data: list[~azure.ai.client.models.RunStep]
    :ivar first_id: The first ID represented in this list. Required.
    :vartype first_id: str
    :ivar last_id: The last ID represented in this list. Required.
    :vartype last_id: str
...
class OpenAIPageableListOfThreadMessage(_model_base.Model):
    ...
    :vartype object: str
    :ivar data: The requested list of items. Required.
    :vartype data: list[~azure.ai.client.models.ThreadMessage]
    :ivar first_id: The first ID represented in this list. Required.
    :vartype first_id: str
    :ivar last_id: The last ID represented in this list. Required.
    :vartype last_id: str
...
class OpenAIPageableListOfThreadRun(_model_base.Model):
    ...
    :vartype object: str
    :ivar data: The requested list of items. Required.
    :vartype data: list[~azure.ai.client.models.ThreadRun]
    :ivar first_id: The first ID represented in this list. Required.
    :vartype first_id: str
    :ivar last_id: The last ID represented in this list. Required.
    :vartype last_id: str
...
class OpenAIPageableListOfVectorStore(_model_base.Model):
    ...
    :vartype object: str
    :ivar data: The requested list of items. Required.
    :vartype data: list[~azure.ai.client.models.VectorStore]
    :ivar first_id: The first ID represented in this list. Required.
    :vartype first_id: str
    :ivar last_id: The last ID represented in this list. Required.
    :vartype last_id: str
...
class OpenAIPageableListOfVectorStoreFile(_model_base.Model):
    ...
    :vartype object: str
    :ivar data: The requested list of items. Required.
    :vartype data: list[~azure.ai.client.models.VectorStoreFile]
    :ivar first_id: The first ID represented in this list. Required.
    :vartype first_id: str
    :ivar last_id: The last ID represented in this list. Required.
    :vartype last_id: str
...
class RequiredFunctionToolCall(RequiredToolCall, discriminator="function"):
    ...
    :vartype function: ~azure.ai.client.models.RequiredFunctionToolCallDetails
    """
...
class RunStep(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype status: str or ~azure.ai.client.models.RunStepStatus
    :ivar step_details: The details for this run step. Required.
    :vartype step_details: ~azure.ai.client.models.RunStepDetails
    :ivar last_error: If applicable, information about the last error encountered by this run step.
     Required.
    :vartype last_error: ~azure.ai.client.models.RunStepError
    :ivar created_at: The Unix timestamp, in seconds, representing when this object was created.
     Required.
    :vartype created_at: ~datetime.datetime
    ...
    :vartype usage: ~azure.ai.client.models.RunStepCompletionUsage
    :ivar metadata: A set of up to 16 key/value pairs that can be attached to an object, used for
     storing additional information about that object in a structured format. Keys may be up to 64
     characters in length and values may be up to 512 characters in length. Required.
    :vartype metadata: dict[str, str]
...
class RunStepCodeInterpreterImageOutput(RunStepCodeInterpreterToolCallOutput, discriminator="image"):
    ...
    :vartype image: ~azure.ai.client.models.RunStepCodeInterpreterImageReference
    """
...
class RunStepCodeInterpreterToolCall(RunStepToolCall, discriminator="code_interpreter"):
    ...
    :vartype code_interpreter: ~azure.ai.client.models.RunStepCodeInterpreterToolCallDetails
    """
...
class RunStepCodeInterpreterToolCallDetails(_model_base.Model):
    ...
    :vartype outputs: list[~azure.ai.client.models.RunStepCodeInterpreterToolCallOutput]
    """
...
class RunStepDelta(_model_base.Model):
    ...
    :vartype step_details: ~azure.ai.client.models.RunStepDeltaDetail
    """
...
class RunStepDeltaChunk(_model_base.Model):
    ...
    :vartype delta: ~azure.ai.client.models.RunStepDelta
    """
...
class RunStepDeltaCodeInterpreterDetailItemObject(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :vartype outputs: list[~azure.ai.client.models.RunStepDeltaCodeInterpreterOutput]
    """
...
class RunStepDeltaCodeInterpreterImageOutput(RunStepDeltaCodeInterpreterOutput, discriminator="image"):
    ...
    :vartype image: ~azure.ai.client.models.RunStepDeltaCodeInterpreterImageOutputObject
    """
...
class RunStepDeltaCodeInterpreterToolCall(RunStepDeltaToolCall, discriminator="code_interpreter"):
    ...
    :vartype code_interpreter: ~azure.ai.client.models.RunStepDeltaCodeInterpreterDetailItemObject
    """
...
class RunStepDeltaFunctionToolCall(RunStepDeltaToolCall, discriminator="function"):
    ...
    :vartype function: ~azure.ai.client.models.RunStepDeltaFunction
    """
...
class RunStepDeltaMessageCreation(RunStepDeltaDetail, discriminator="message_creation"):
    ...
    :vartype message_creation: ~azure.ai.client.models.RunStepDeltaMessageCreationObject
    """
...
class RunStepDeltaToolCallObject(RunStepDeltaDetail, discriminator="tool_calls"):
    ...
    :vartype tool_calls: list[~azure.ai.client.models.RunStepDeltaToolCall]
    """
...
class RunStepError(_model_base.Model):
    ...
    :ivar code: The error code for this error. Required. Known values are: "server_error" and
     "rate_limit_exceeded".
    :vartype code: str or ~azure.ai.client.models.RunStepErrorCode
...
class RunStepFunctionToolCall(RunStepToolCall, discriminator="function"):
    ...
    :vartype function: ~azure.ai.client.models.RunStepFunctionToolCallDetails
    """
...
class RunStepMessageCreationDetails(RunStepDetails, discriminator="message_creation"):
    ...
    :vartype type: str or ~azure.ai.client.models.MESSAGE_CREATION
    :ivar message_creation: Information about the message creation associated with this run step.
     Required.
    :vartype message_creation: ~azure.ai.client.models.RunStepMessageCreationReference
    """
...
class RunStepToolCallDetails(RunStepDetails, discriminator="tool_calls"):
    ...
    :ivar type: The object type, which is always 'tool_calls'. Required. Represents a run step that
     calls tools.
    :vartype type: str or ~azure.ai.client.models.TOOL_CALLS
    :ivar tool_calls: A list of tool call details for this run step. Required.
    :vartype tool_calls: list[~azure.ai.client.models.RunStepToolCall]
    """
...
class SubmitToolOutputsAction(RequiredAction, discriminator="submit_tool_outputs"):
    ...
    :ivar submit_tool_outputs: The details describing tools that should be called to submit tool
     outputs. Required.
    :vartype submit_tool_outputs: ~azure.ai.client.models.SubmitToolOutputsDetails
    """
...
class SubmitToolOutputsDetails(_model_base.Model):
    ...
    :ivar tool_calls: The list of tool calls that must be resolved for the agent thread run to
     continue. Required.
    :vartype tool_calls: list[~azure.ai.client.models.RequiredToolCall]
    """
...
class ThreadMessage(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype status: str or ~azure.ai.client.models.MessageStatus
    :ivar incomplete_details: On an incomplete message, details about why the message is
     incomplete. Required.
    :vartype incomplete_details: ~azure.ai.client.models.MessageIncompleteDetails
    ...
    :ivar attachments: A list of files attached to the message, and the tools they were added to.
     Required.
    :vartype attachments: list[~azure.ai.client.models.MessageAttachment]
    :ivar metadata: A set of up to 16 key/value pairs that can be attached to an object, used for
     storing additional information about that object in a structured format. Keys may be up to 64
     characters in length and values may be up to 512 characters in length. Required.
    :vartype metadata: dict[str, str]
...
class ThreadRun(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype incomplete_details: str or ~azure.ai.client.models.IncompleteRunDetails
    ...
    :vartype usage: ~azure.ai.client.models.RunCompletionUsage
    ...
    :vartype truncation_strategy: ~azure.ai.client.models.TruncationObject
    ...
    :vartype tool_choice: str or str or ~azure.ai.client.models.AgentsApiToolChoiceOptionMode or
...
class ToolResources(_model_base.Model):
    ...
    :ivar code_interpreter: Resources to be used by the ``code_interpreter tool`` consisting of
     file IDs.
    :vartype code_interpreter: ~azure.ai.client.models.CodeInterpreterToolResource
...
class TruncationObject(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.client.models.TruncationStrategy
...
class UpdateToolResourcesOptions(_model_base.Model):
    ...
    :ivar code_interpreter: Overrides the list of file IDs made available to the
     ...
     associated with the tool.
    :vartype code_interpreter: ~azure.ai.client.models.UpdateCodeInterpreterToolResourceOptions
...
class VectorStorageDataSource(_model_base.Model):
    ...
    :vartype asset_type: str or ~azure.ai.client.models.VectorStorageDataSourceAssetType
    """
...
class VectorStore(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar file_counts: Files count grouped by status processed or being processed by this vector
     store. Required.
    :vartype file_counts: ~azure.ai.client.models.VectorStoreFileCount
    ...
    :vartype status: str or ~azure.ai.client.models.VectorStoreStatus
    :ivar expires_after: Details on when this vector store expires.
    :vartype expires_after: ~azure.ai.client.models.VectorStoreExpirationPolicy
...
class VectorStoreChunkingStrategyRequest(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.client.models.VectorStoreChunkingStrategyRequestType
    """
...
class VectorStoreAutoChunkingStrategyRequest(VectorStoreChunkingStrategyRequest, discriminator="auto"):
    ...
    :vartype type: str or ~azure.ai.client.models.AUTO
    """
...
class VectorStoreChunkingStrategyResponse(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.client.models.VectorStoreChunkingStrategyResponseType
    """
...
class VectorStoreAutoChunkingStrategyResponse(VectorStoreChunkingStrategyResponse, discriminator="other"):
    ...
    :vartype type: str or ~azure.ai.client.models.OTHER
    """
...
class VectorStoreExpirationPolicy(_model_base.Model):
    ...
    :vartype anchor: str or ~azure.ai.client.models.VectorStoreExpirationPolicyAnchor
...
class VectorStoreFile(_model_base.Model):
    ...
    :vartype status: str or ~azure.ai.client.models.VectorStoreFileStatus
    :ivar last_error: The last error associated with this vector store file. Will be ``null`` if
     there are no errors. Required.
    :vartype last_error: ~azure.ai.client.models.VectorStoreFileError
    :ivar chunking_strategy: The strategy used to chunk the file. Required.
    :vartype chunking_strategy: ~azure.ai.client.models.VectorStoreChunkingStrategyResponse
    """
...
class VectorStoreFileBatch(_model_base.Model):
    ...
    :vartype status: str or ~azure.ai.client.models.VectorStoreFileBatchStatus
    :ivar file_counts: Files count grouped by status processed or being processed by this vector
     store. Required.
    :vartype file_counts: ~azure.ai.client.models.VectorStoreFileCount
    """
...
class VectorStoreFileError(_model_base.Model):
    ...
    :vartype code: str or ~azure.ai.client.models.VectorStoreFileErrorCode
...
class VectorStoreFromAzure(_model_base.Model):
    ...
    :vartype store_configuration: ~azure.ai.client.models.VectorStorageConfiguration
    """
...
class VectorStoreStaticChunkingStrategyRequest(VectorStoreChunkingStrategyRequest, discriminator="static"):
    ...
    :vartype type: str or ~azure.ai.client.models.STATIC
    :ivar static: The options for the static chunking strategy. Required.
    :vartype static: ~azure.ai.client.models.VectorStoreStaticChunkingStrategyOptions
    """
