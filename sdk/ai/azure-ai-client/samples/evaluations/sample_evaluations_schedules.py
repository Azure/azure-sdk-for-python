...
def main():
    app_insights_config = AppInsightsConfiguration(
        resource_id="sample_id", query="your_connection_string", service_name="sample_service_name"
    )
    ...
    client.evaluations
    evaluation_schedule = client.evaluations.create_or_replace_schedule(
        id="sample_schedule_id", resource=evaluation_schedule
    )
