...
def build_evaluations_evaluations_get_request(name: str, **kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
...
def build_evaluations_evaluations_create_run_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class EvaluationsEvaluationsOperations:
    ...
    def get(self, name: str, **kwargs: Any) -> _models2.Evaluation:
    ...
    def create_run(self, evaluation: Union[_models2.Evaluation, JSON, IO[bytes]], **kwargs: Any) -> _models2.Evaluation:
        """Creates an evaluation run.
