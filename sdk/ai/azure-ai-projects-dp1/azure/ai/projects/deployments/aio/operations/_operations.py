...
from ...operations._operations import (
    build_deployments_deployments_get_request,
    build_deployments_deployments_list_request,
)
...
class DeploymentsDeploymentsOperations:
    ...
    async def get(self, name: str, **kwargs: Any) -> _models3.Deployment:
        ...
        cls: ClsType[_models3.Deployment] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models3.Deployment, response.json())
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models3.Deployment"]:
        ...
        cls: ClsType[List[_models3.Deployment]] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models3.Deployment], deserialized.get("value", []))
            if cls:
