...
from .._vendor import FileType, prep_if_match, prep_if_none_match, prepare_multipart_form_data
...
def build_datasets_list_dataset_versions_request(  # pylint: disable=name-too-long
    name: str,
    *,
...
def build_datasets_create_or_get_start_pending_upload_request(  # pylint: disable=name-too-long
...
def build_deployments_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/deployments/{deploymentName}"
    path_format_arguments = {
...
class DatasetsOperations:
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_datasets_list_latest_datasets_request(
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_datasets_list_dataset_versions_request(
                    name=name,
                    order_by=order_by,
                    top=top,
                    skip=skip,
    ...
    @overload
    def create_or_update(
        self, name: str, version: str, dataset_version: JSON, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.DatasetVersion:
        """Create or update version.
    ...
    def create_or_get_start_pending_upload(
        ...
        **kwargs: Any
        ...
        _request = build_datasets_create_or_get_start_pending_upload_request(
            name=name,
            version=version,
            content_type=content_type,
            content=_content,
...
class DeploymentsOperations:
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :param deployment_name: Name of the deployment for the model. Required.
