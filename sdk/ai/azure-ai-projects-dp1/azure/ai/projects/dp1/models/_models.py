...
from ._enums import AuthorRole, CredentialType, DatasetType, IndexType, PendingUploadType
...
class AgentCompleteParams(_model_base.Model):
    """Parameters for creating a new completion with agent overrides.

    :ivar overrides: The overrides for the agent responsible for generating the completion.
     Required.
    :vartype overrides: ~azure.ai.projects.dp1.models.AgentOptions
    :ivar input: The list of input messages for the completion. Required.
    ...
    :ivar metadata: Optional metadata associated with the completion request.
    :vartype metadata: dict[str, str]
    :ivar options: Optional configuration for completion generation.
    :vartype options: ~azure.ai.projects.dp1.models.CompletionsOptions
    :ivar user_id: Identifier for the user making the request.
    :vartype user_id: str
    :ivar store: Flag indicating whether to store the completion and associated messages.
    :vartype store: bool
    """

    overrides: "_models.AgentOptions" = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The overrides for the agent responsible for generating the completion. Required."""
    input: List["_models.ChatMessage"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The list of input messages for the completion. Required."""
    ...
    options: Optional["_models.CompletionsOptions"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        overrides: "_models.AgentOptions",
...
class AgentCompletion(_model_base.Model):
    """An agent-generated completion record, including messages and status.

    :ivar agent_id: Unique identifier for the agent responsible for the completion. Required.
    :vartype agent_id: str
    :ivar completion_id: Unique identifier for this completion. Required.
    :vartype completion_id: str
    :ivar created_at: Timestamp when the completion was initiated (Unix time). Required.
    :vartype created_at: int
    :ivar completed_at: Timestamp when the completion finished processing (Unix time). Required.
    :vartype completed_at: int
    :ivar status: Final status of the completion request. Required. Is one of the following types:
    ...
    :ivar thread_id: Identifier for the thread associated with the completion. Required.
    :vartype thread_id: str
    :ivar usage: Token usage details for this completion. Required.
    ...
    :ivar incomplete_details: Details about why the response is incomplete, if applicable.
     Required.
    :vartype incomplete_details: ~azure.ai.projects.dp1.models.AgentCompletionIncompleteDetails
    """

    agent_id: str = rest_field(name="agentId", visibility=["read", "create", "update", "delete", "query"])
    """Unique identifier for the agent responsible for the completion. Required."""
    completion_id: str = rest_field(name="completionId", visibility=["read", "create", "update", "delete", "query"])
    """Unique identifier for this completion. Required."""
    created_at: int = rest_field(name="createdAt", visibility=["read", "create", "update", "delete", "query"])
    """Timestamp when the completion was initiated (Unix time). Required."""
    completed_at: int = rest_field(name="completedAt", visibility=["read", "create", "update", "delete", "query"])
    """Timestamp when the completion finished processing (Unix time). Required."""
    status: Union[
    ...
    """Final status of the completion request. Required. Is one of the following types:
     Literal[\"inProgress\"], Literal[\"incomplete\"], Literal[\"cancelled\"], Literal[\"failed\"],
     Literal[\"completed\"], str"""
    ...
    """Identifier for the thread associated with the completion. Required."""
    usage: "_models.CompletionUsage" = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Token usage details for this completion. Required."""
    incomplete_details: "_models.AgentCompletionIncompleteDetails" = rest_field(
    ...
    def __init__(
        ...
        *,
        ...
        incomplete_details: "_models.AgentCompletionIncompleteDetails",
    ) -> None: ...
...
class AgentCompletionIncompleteDetails(_model_base.Model):
...
class ChatMessage(_model_base.Model):
    ...
    :ivar completion_id: A unique completion ID, if this message was generated by a completion
     process.
    :vartype completion_id: str
    ...
    completion_id: Optional[str] = rest_field(
        name="completionId", visibility=["read", "create", "update", "delete", "query"]
    )
...
class CompletionUsage(_model_base.Model):
    ...
    :ivar output_token_details: Breakdown of tokens used in a completion.
