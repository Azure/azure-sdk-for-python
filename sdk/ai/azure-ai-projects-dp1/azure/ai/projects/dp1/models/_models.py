...
class Agent(_model_base.Model):
    ...
    :ivar configuration_options: Configuration options for this agent. Required.
    ...
    """Configuration options for this agent. Required."""
...
class ChatMessage(_model_base.Model):
    ...
    :ivar conversation_id: The conversation to which this message belongs. Required.
    ...
    """The conversation to which this message belongs. Required."""
...
class AgentToolDefinition(_model_base.Model):
    ...
    You probably want to use the sub-classes and not this class directly. Known sub-classes are:
    FunctionToolDefinition, BingGroundingToolDefinition, CodeInterpreterToolDefinition,
    FileSearchToolDefinition, OpenApiToolDefinition
...
class AgentToolOptions(_model_base.Model):
    ...
    :ivar type: Discriminates the various child 'tool options' types. Required.
    :vartype type: str
    """

    type: str = rest_discriminator(name="type", visibility=["read", "create", "update", "delete", "query"])
    """Discriminates the various child 'tool options' types. Required."""
...
class Conversation(_model_base.Model):
    ...
    :ivar conversation_id: A unique identifier for this conversation. Required.
    :vartype conversation_id: str
    :ivar messages: A list of messages in this conversation. Required.
    :vartype messages: list[~azure.ai.projects.dp1.models.ChatMessage]
    """

    conversation_id: str = rest_field(name="conversationId", visibility=["read"])
    """A unique identifier for this conversation. Required."""
    messages: List["_models.ChatMessage"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """A list of messages in this conversation. Required."""
...
class FunctionToolDefinition(AgentToolDefinition, discriminator="Function"):
...
class Run(_model_base.Model):
    ...
    incomplete_details: Optional["_models.RunIncompleteDetails"] = rest_field(
    ...
    def __init__(
        ...
        *,
        ...
        incomplete_details: Optional["_models.RunIncompleteDetails"] = None,
    ) -> None: ...
...
class RunInputs(_model_base.Model):
    ...
    :ivar user_id: Identifier for the user making the request.
    :vartype user_id: str
    :ivar agent_configuration: The agent configuration when not using a previously created agent.
    :vartype agent_configuration: ~azure.ai.projects.dp1.models.AgentConfigurationOptions
    """
    ...
    user_id: Optional[str] = rest_field(name="userId", visibility=["read", "create", "update", "delete", "query"])
    """Identifier for the user making the request."""
    agent_configuration: Optional["_models.AgentConfigurationOptions"] = rest_field(
