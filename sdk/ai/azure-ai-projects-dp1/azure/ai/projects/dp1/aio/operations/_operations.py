...
class RunsOperations:
    ...
    @distributed_trace
    def list_run_inputs(self, **kwargs: Any) -> AsyncIterable["_models.RunInputs"]:
        """Lists run inputs.

        :return: An iterator like instance of RunInputs
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.ai.projects.dp1.models.RunInputs]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
