...
from ...operations._operations import (
    ...
    build_messages_get_message_request,
    build_messages_list_messages_request,
    build_messages_send_message_request,
    build_messages_update_message_request,
    build_runs_create_and_execute_run_request,
    build_runs_create_and_stream_run_request,
    build_runs_create_run_request,
    build_runs_get_run_request,
    build_runs_list_runs_request,
...
class RunsOperations:
    ...
    @overload
    async def create_run(self, body: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models.Run:
        """Creates a new run.
    ...
    @overload
    async def create_and_stream_run(self, body: JSON, *, content_type: str = "application/json", **kwargs: Any) -> None:
        """Create and stream run.
        @route("/run/stream").
    ...
    @distributed_trace
    def list_runs(self, **kwargs: Any) -> AsyncIterable["_models.Run"]:
        """Lists all run records, each containing runInputs and runOutputs.
        @route("/runs").

        :return: An iterator like instance of Run
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.ai.projects.dp1.models.Run]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
