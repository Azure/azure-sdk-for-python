...
from ...operations._operations import (
    ...
    build_datasets_create_or_get_start_pending_upload_request,
    build_datasets_create_or_update_request,
    build_datasets_delete_version_request,
    build_datasets_get_version_request,
    build_datasets_list_dataset_versions_request,
    build_datasets_list_latest_datasets_request,
    ...
    build_indexes_create_index_request,
    build_indexes_delete_version_request,
    build_indexes_get_request,
    build_indexes_list_index_versions_request,
    build_indexes_list_latest_indexes_request,
)
...
class IndexesOperations:
    ...
    @distributed_trace_async
    async def create_index(
        self, name: str, body: Union[_models.Index, JSON, IO[bytes]], **kwargs: Any
    ) -> _models.Index:
        """Creates or updates a IndexVersion.
