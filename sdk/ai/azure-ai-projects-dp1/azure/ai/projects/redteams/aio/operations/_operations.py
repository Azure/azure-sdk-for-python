...
from ...operations._operations import (
    build_red_teams_red_teams_create_run_request,
    build_red_teams_red_teams_get_request,
    build_red_teams_red_teams_list_request,
)
...
class RedTeamsRedTeamsOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models3.RedTeam"]:
        ...
        async def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models3.RedTeam], deserialized.get("value", []))
            if cls:
    ...
    async def create_run(self, red_team: Union[_models3.RedTeam, JSON, IO[bytes]], **kwargs: Any) -> _models3.RedTeam:
        """Creates a redteam run.
