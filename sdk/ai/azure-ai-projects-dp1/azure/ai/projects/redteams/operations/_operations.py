...
def build_red_teams_red_teams_get_request(name: str, **kwargs: Any) -> HttpRequest:
...
def build_red_teams_red_teams_list_request(
...
def build_red_teams_red_teams_create_run_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class RedTeamsOperations:
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.red_teams = RedTeamsRedTeamsOperations(self._client, self._config, self._serialize, self._deserialize)


class RedTeamsRedTeamsOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
    ...
    def get(self, name: str, **kwargs: Any) -> _models2.RedTeam:
        ...
        _request = build_red_teams_red_teams_get_request(
            name=name,
    ...
    def list(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_red_teams_red_teams_list_request(
                    top=top,
                    skip=skip,
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models2.RedTeam], deserialized.get("value", []))
            if cls:
    ...
    @overload
    def create_run(self, red_team: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models2.RedTeam:
        """Creates a redteam run.
    ...
    def create_run(self, red_team: Union[_models2.RedTeam, JSON, IO[bytes]], **kwargs: Any) -> _models2.RedTeam:
        """Creates a redteam run.
        ...
        _request = build_red_teams_red_teams_create_run_request(
