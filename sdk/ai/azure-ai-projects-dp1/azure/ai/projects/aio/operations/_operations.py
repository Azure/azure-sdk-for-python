...
class ConnectionsOperations:
    ...
    async def get(self, name: str, **kwargs: Any) -> _models2.Connection:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models2.Connection"]:
        ...
        async def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models2.Connection], deserialized.get("value", []))
            if cls:
...
class EvaluationsOperations:
    ...
    async def get(self, name: str, **kwargs: Any) -> _models2.Evaluation:
...
class DatasetsOperations:
    ...
    def list_versions(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models2.DatasetVersion"]:
    ...
    @distributed_trace_async
    async def get_version(self, name: str, version: str, **kwargs: Any) -> _models2.DatasetVersion:
...
class IndexesOperations:
    ...
    @distributed_trace_async
    async def get_version(self, name: str, version: str, **kwargs: Any) -> _models2.Index:
    ...
    @distributed_trace_async
    async def create(self, name: str, body: Union[_models2.Index, JSON, IO[bytes]], **kwargs: Any) -> _models2.Index:
        """Create a new Index. The version id will be generated by the service.
...
class DeploymentsOperations:
    ...
    def list(
        ...
        *,
        ...
        skip: Optional[int] = None,
        **kwargs: Any
    ) -> AsyncIterable["_models2.Deployment"]:
...
class EvaluationResultsOperations:
    ...
    def list_versions(
        ...
        *,
        ...
        list_view_type: Optional[Union[str, _models2.ListViewType]] = None,
        **kwargs: Any
    ) -> AsyncIterable["_models2.EvaluationResult"]:
    ...
    async def get_version(self, name: str, version: str, **kwargs: Any) -> _models2.EvaluationResult:
...
class RedTeamsOperations:
    ...
    async def get(self, name: str, **kwargs: Any) -> _models2.RedTeam:
    ...
    def list(
        self, *, top: Optional[int] = None, skip: Optional[int] = None, **kwargs: Any
    ) -> AsyncIterable["_models2.RedTeam"]:
    ...
    async def create_run(self, red_team: Union[_models2.RedTeam, JSON, IO[bytes]], **kwargs: Any) -> _models2.RedTeam:
        """Creates a redteam run.
