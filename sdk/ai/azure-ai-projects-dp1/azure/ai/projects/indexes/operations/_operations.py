...
def build_indexes_indexes_list_versions_request(  # pylint: disable=name-too-long
    name: str,
    *,
...
def build_indexes_indexes_list_latest_request(  # pylint: disable=name-too-long
    *,
    top: Optional[int] = None,
    skip: Optional[str] = None,
    tags: Optional[str] = None,
...
def build_indexes_indexes_get_version_request(  # pylint: disable=name-too-long
...
def build_indexes_indexes_delete_version_request(  # pylint: disable=name-too-long
    name: str, version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_indexes_indexes_create_request(name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_indexes_indexes_create_version_request(  # pylint: disable=name-too-long
    name: str, version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class IndexesIndexesOperations:
    ...
    def list_versions(
        ...
        **kwargs: Any
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models2.Index], deserialized.get("value", []))
            if cls:
    ...
    @distributed_trace
    def get_version(self, name: str, version: str, **kwargs: Any) -> _models2.Index:
    ...
    @overload
    def create(
        self, name: str, body: _models2.Index, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models2.Index:
    ...
    @overload
    def create(self, name: str, body: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models2.Index:
        """Create a new Index. The version id will be generated by the service.
    ...
    @distributed_trace
    def create(self, name: str, body: Union[_models2.Index, JSON, IO[bytes]], **kwargs: Any) -> _models2.Index:
        """Create a new Index. The version id will be generated by the service.
    ...
    @overload
    def create_version(
        self, name: str, version: str, body: _models2.Index, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models2.Index:
    ...
    @distributed_trace
    def create_version(
        self, name: str, version: str, body: Union[_models2.Index, JSON, IO[bytes]], **kwargs: Any
    ) -> _models2.Index:
        """Create a new or replace an existing Index with the given version id.
