...
def build_datasets_datasets_list_versions_request(  # pylint: disable=name-too-long
    name: str,
    *,
...
def build_datasets_datasets_list_latest_request(  # pylint: disable=name-too-long
    *,
    top: Optional[int] = None,
    skip: Optional[str] = None,
    tags: Optional[str] = None,
...
def build_datasets_datasets_get_version_request(  # pylint: disable=name-too-long
...
def build_datasets_datasets_delete_version_request(  # pylint: disable=name-too-long
    name: str, version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_datasets_datasets_create_request(name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_datasets_datasets_create_version_request(  # pylint: disable=name-too-long
    name: str, version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_datasets_datasets_start_pending_upload_version_request(  # pylint: disable=name-too-long
    name: str, version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_datasets_datasets_start_pending_upload_request(  # pylint: disable=name-too-long
    name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DatasetsOperations:
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.datasets = DatasetsDatasetsOperations(self._client, self._config, self._serialize, self._deserialize)


class DatasetsDatasetsOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
    ...
    def list_versions(
        ...
        *,
        ...
        list_view_type: Optional[Union[str, _models2.ListViewType]] = None,
        **kwargs: Any
    ) -> Iterable["_models2.DatasetVersion"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_datasets_datasets_list_versions_request(
                    name=name,
                    top=top,
                    skip=skip,
                    tags=tags,
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models2.DatasetVersion], deserialized.get("value", []))
            if cls:
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_datasets_datasets_list_latest_request(
                    top=top,
                    skip=skip,
                    tags=tags,
                    list_view_type=list_view_type,
    ...
    @distributed_trace
    def get_version(self, name: str, version: str, **kwargs: Any) -> _models2.DatasetVersion:
        ...
        _request = build_datasets_datasets_get_version_request(
            name=name,
            version=version,
            api_version=self._config.api_version,
            headers=_headers,
    ...
    def delete_version(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_datasets_datasets_delete_version_request(
            name=name,
            version=version,
            api_version=self._config.api_version,
            headers=_headers,
    ...
    @overload
    def create(
        self, name: str, body: _models2.DatasetVersion, *, content_type: str = "application/json", **kwargs: Any
    ...
    @distributed_trace
    def create(
        self, name: str, body: Union[_models2.DatasetVersion, JSON, IO[bytes]], **kwargs: Any
    ) -> _models2.DatasetVersion:
        """Create a new DatasetVersion. The version id will be generated by the service.
        ...
        _request = build_datasets_datasets_create_request(
            name=name,
    ...
    @distributed_trace
    def create_version(
        self, name: str, version: str, body: Union[_models2.DatasetVersion, JSON, IO[bytes]], **kwargs: Any
    ) -> _models2.DatasetVersion:
        """Create a new or replace an existing DatasetVersion with the given version id.
        ...
        _request = build_datasets_datasets_create_version_request(
            name=name,
            version=version,
            content_type=content_type,
            api_version=self._config.api_version,
    ...
    def start_pending_upload_version(
        ...
        _request = build_datasets_datasets_start_pending_upload_version_request(
            name=name,
            version=version,
            content_type=content_type,
            api_version=self._config.api_version,
    ...
    def start_pending_upload(
        self, name: str, body: _models2.PendingUploadRequest, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models2.PendingUploadResponse:
    ...
    @distributed_trace
    def start_pending_upload(
        self, name: str, body: Union[_models2.PendingUploadRequest, JSON, IO[bytes]], **kwargs: Any
    ) -> _models2.PendingUploadResponse:
        """Create or start a pending upload of a dataset. The version id will be generated by the service.
        ...
        _request = build_datasets_datasets_start_pending_upload_request(
            name=name,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
