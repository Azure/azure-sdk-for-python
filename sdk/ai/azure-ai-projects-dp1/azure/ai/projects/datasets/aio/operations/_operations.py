...
from ...operations._operations import (
    build_datasets_datasets_create_request,
    build_datasets_datasets_create_version_request,
    build_datasets_datasets_delete_version_request,
    build_datasets_datasets_get_version_request,
    build_datasets_datasets_list_latest_request,
    build_datasets_datasets_list_versions_request,
    build_datasets_datasets_start_pending_upload_request,
    build_datasets_datasets_start_pending_upload_version_request,
)
...
class DatasetsDatasetsOperations:
    ...
    def list_versions(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models3.DatasetVersion"]:
        ...
        cls: ClsType[List[_models3.DatasetVersion]] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models3.DatasetVersion], deserialized.get("value", []))
            if cls:
    ...
    async def get_version(self, name: str, version: str, **kwargs: Any) -> _models3.DatasetVersion:
        ...
        cls: ClsType[_models3.DatasetVersion] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models3.DatasetVersion, response.json())
    ...
    @overload
    async def create(
        self, name: str, body: _models3.DatasetVersion, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models3.DatasetVersion:
    ...
    @distributed_trace_async
    async def create(
        self, name: str, body: Union[_models3.DatasetVersion, JSON, IO[bytes]], **kwargs: Any
    ) -> _models3.DatasetVersion:
        """Create a new DatasetVersion. The version id will be generated by the service.
    ...
    @distributed_trace_async
    async def create_version(
        self, name: str, version: str, body: Union[_models3.DatasetVersion, JSON, IO[bytes]], **kwargs: Any
    ) -> _models3.DatasetVersion:
        """Create a new or replace an existing DatasetVersion with the given version id.
    ...
    async def start_pending_upload(
        self, name: str, body: _models3.PendingUploadRequest, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models3.PendingUploadResponse:
    ...
    @distributed_trace_async
    async def start_pending_upload(
        self, name: str, body: Union[_models3.PendingUploadRequest, JSON, IO[bytes]], **kwargs: Any
    ) -> _models3.PendingUploadResponse:
        """Create or start a pending upload of a dataset. The version id will be generated by the service.
