...
def build_connections_connections_get_request(name: str, **kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
...
def build_connections_connections_list_request(  # pylint: disable=name-too-long
    *,
...
class ConnectionsConnectionsOperations:
    ...
    @distributed_trace
    def get(self, name: str, **kwargs: Any) -> _models2.Connection:
