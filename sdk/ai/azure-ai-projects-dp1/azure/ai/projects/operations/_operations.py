...
def build_datasets_list_versions_request(
    ...
    *,
    ...
    list_view_type: Optional[Union[str, _models1.ListViewType]] = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ConnectionsOperations:
    ...
    @distributed_trace
    def get(self, name: str, **kwargs: Any) -> _models1.Connection:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models1.Connection], deserialized.get("value", []))
            if cls:
...
class EvaluationsOperations:
    ...
    def get(self, name: str, **kwargs: Any) -> _models1.Evaluation:
    ...
    def create_run(self, evaluation: Union[_models1.Evaluation, JSON, IO[bytes]], **kwargs: Any) -> _models1.Evaluation:
        """Creates an evaluation run.
...
class DatasetsOperations:
    ...
    def list_versions(
        ...
        *,
        ...
        list_view_type: Optional[Union[str, _models1.ListViewType]] = None,
        **kwargs: Any
    ) -> Iterable["_models1.DatasetVersion"]:
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models1.DatasetVersion], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
    ...
    @distributed_trace
    def get_version(self, name: str, version: str, **kwargs: Any) -> _models1.DatasetVersion:
    ...
    @overload
    def create(
        self, name: str, body: _models1.DatasetVersion, *, content_type: str = "application/json", **kwargs: Any
    ...
    @distributed_trace
    def create(
        self, name: str, body: Union[_models1.DatasetVersion, JSON, IO[bytes]], **kwargs: Any
    ) -> _models1.DatasetVersion:
        """Create a new DatasetVersion. The version id will be generated by the service.
    ...
    @distributed_trace
    def create_version(
        self, name: str, version: str, body: Union[_models1.DatasetVersion, JSON, IO[bytes]], **kwargs: Any
    ) -> _models1.DatasetVersion:
        """Create a new or replace an existing DatasetVersion with the given version id.
    ...
    def start_pending_upload_version(
        ...
        name: str,
        version: str,
        body: _models1.PendingUploadRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    @distributed_trace
    def start_pending_upload_version(
        self, name: str, version: str, body: Union[_models1.PendingUploadRequest, JSON, IO[bytes]], **kwargs: Any
    ) -> _models1.PendingUploadResponse:
        """Create or start a pending upload of a dataset for a specific version.
    ...
    def start_pending_upload(
        self, name: str, body: _models1.PendingUploadRequest, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models1.PendingUploadResponse:
    ...
    @distributed_trace
    def start_pending_upload(
        self, name: str, body: Union[_models1.PendingUploadRequest, JSON, IO[bytes]], **kwargs: Any
    ) -> _models1.PendingUploadResponse:
        """Create or start a pending upload of a dataset. The version id will be generated by the service.
...
class IndexesOperations:
    ...
    def list_versions(
        ...
        **kwargs: Any
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models1.Index], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
    ...
    @distributed_trace
    def get_version(self, name: str, version: str, **kwargs: Any) -> _models1.Index:
    ...
    @overload
    def create(
        self, name: str, body: _models1.Index, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models1.Index:
    ...
    @overload
    def create(self, name: str, body: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models1.Index:
        """Create a new Index. The version id will be generated by the service.
    ...
    @distributed_trace
    def create(self, name: str, body: Union[_models1.Index, JSON, IO[bytes]], **kwargs: Any) -> _models1.Index:
        """Create a new Index. The version id will be generated by the service.
    ...
    @overload
    def create_version(
        self, name: str, version: str, body: _models1.Index, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models1.Index:
    ...
    @distributed_trace
    def create_version(
        self, name: str, version: str, body: Union[_models1.Index, JSON, IO[bytes]], **kwargs: Any
    ) -> _models1.Index:
        """Create a new or replace an existing Index with the given version id.
...
class DeploymentsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models1.Deployment], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
...
class EvaluationResultsOperations:
    ...
    def list_versions(
        ...
        *,
        ...
        list_view_type: Optional[Union[str, _models1.ListViewType]] = None,
        **kwargs: Any
    ) -> Iterable["_models1.EvaluationResult"]:
        ...
        cls: ClsType[List[_models1.EvaluationResult]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models1.EvaluationResult], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
    ...
    def get_version(self, name: str, version: str, **kwargs: Any) -> _models1.EvaluationResult:
        ...
        cls: ClsType[_models1.EvaluationResult] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.EvaluationResult, response.json())
    ...
    @overload
    def create(
        self, name: str, body: _models1.EvaluationResult, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models1.EvaluationResult:
    ...
    def create(
        self, name: str, body: Union[_models1.EvaluationResult, JSON, IO[bytes]], **kwargs: Any
    ) -> _models1.EvaluationResult:
        """Create a new EvaluationResult. The version id will be generated by the service.
    ...
    def create_version(
        ...
        name: str,
        version: str,
        body: _models1.EvaluationResult,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models1.EvaluationResult:
    ...
    def create_version(
        self, name: str, version: str, body: Union[_models1.EvaluationResult, JSON, IO[bytes]], **kwargs: Any
    ) -> _models1.EvaluationResult:
        """Create a new or replace an existing EvaluationResult with the given version id.
...
class RedTeamsOperations:
    ...
    def get(self, name: str, **kwargs: Any) -> _models1.RedTeam:
        ...
        cls: ClsType[_models1.RedTeam] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.RedTeam, response.json())
    ...
    def list(
        ...
        maxpagesize = kwargs.pop("maxpagesize", None)
        cls: ClsType[List[_models1.RedTeam]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models1.RedTeam], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
    ...
    @overload
    def create_run(
        self, red_team: _models1.RedTeam, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models1.RedTeam:
    ...
    @overload
    def create_run(self, red_team: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models1.RedTeam:
        """Creates a redteam run.
    ...
    def create_run(self, red_team: Union[_models1.RedTeam, JSON, IO[bytes]], **kwargs: Any) -> _models1.RedTeam:
        """Creates a redteam run.
