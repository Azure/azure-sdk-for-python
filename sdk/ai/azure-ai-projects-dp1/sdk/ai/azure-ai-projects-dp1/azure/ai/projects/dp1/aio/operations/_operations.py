...
class RunsOperations:
    ...
    @overload
    async def create_run(self, resource: JSON, *, content_type: str = "application/json", **kwargs: Any) -> None:
        """Creates a run.
    ...
    @overload
    async def create_run(self, resource: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> None:
        """Creates a run.
    ...
    @distributed_trace_async
    async def create_run(self, resource: Union[_models.CreateRunRequest, JSON, IO[bytes]], **kwargs: Any) -> None:
        """Creates a run.
