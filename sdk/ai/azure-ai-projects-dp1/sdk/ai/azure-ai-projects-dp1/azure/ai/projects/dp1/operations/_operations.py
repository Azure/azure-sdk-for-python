...
class RunsOperations:
    ...
    @overload
    def create_run(
        self, resource: _models.CreateRunRequest, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """Creates a run.

        :param resource: The resource instance. Required.
        :type resource: ~azure.ai.projects.dp1.models.CreateRunRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    @overload
    def create_run(self, resource: JSON, *, content_type: str = "application/json", **kwargs: Any) -> None:
        """Creates a run.
    ...
    @overload
    def create_run(self, resource: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> None:
        """Creates a run.
    ...
    @distributed_trace
    def create_run(  # pylint: disable=inconsistent-return-statements
        self, resource: Union[_models.CreateRunRequest, JSON, IO[bytes]], **kwargs: Any
    ) -> None:
        """Creates a run.

        :param resource: The resource instance. Is one of the following types: CreateRunRequest, JSON,
         IO[bytes] Required.
        :type resource: ~azure.ai.projects.dp1.models.CreateRunRequest or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
