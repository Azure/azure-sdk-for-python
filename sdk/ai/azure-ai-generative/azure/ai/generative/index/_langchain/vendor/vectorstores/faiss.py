...
from azure.ai.generative.index._langchain.vendor.docstore.base import AddableMixin, Docstore
...
from azure.ai.generative.index._langchain.vendor.vectorstores.utils import maximal_marginal_relevance
