...
from azure.ai.generative.constants import IndexInputType, IndexType
...
class IndexDataSource:
    ...
    :type input_type: ~azure.ai.generative.constants.IndexInputType
    """
    ...
    def _createComponent(self, index_config: IndexConfig, acs_config: ACSOutputConfig = None) -> Pipeline:
        ...
        :param index_config: An internal helper object containing all I/O-agnostic variables involved in
            index creation.
        :type index_config: ~azure.ai.generative.operations.IndexConfig
        :param acs_config: A config object containing all output-related variable for index creation.
        :type acs_config:~azure.ai.generative.operations.ACSOutputConfig
        """
