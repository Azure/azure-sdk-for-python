...
from azure.ai.generative.entities import AzureOpenAIConnection, CognitiveSearchConnection
...
class MLIndex:
    ...
    def override_connections(self, aoai_connection: AzureOpenAIConnection = None, acs_connection: CognitiveSearchConnection = None) -> None:
