...
We are excited to introduce the GA of Azure AI Generative Python SDK. The Python SDK introduces new SDK capabilities like <>.
...
Install the Azure AI Generative client library for Python with [pip][pip_link]:
...
Azure AI Generative Python SDK offers the following capabilities:
*  

## Examples

- View our [samples][generative_samples].
...
The Azure AI Generative Python SDK includes a telemetry feature that collects usage and failure data about the SDK and sends it to Microsoft when you use the SDK in a Jupyter Notebook only.
