...
class LookUpResourceIdOperations:
    ...
    @overload
    async def post(
        self, look_up_resource_id_request: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.LookUpResourceIdResponse:
        """This operation fetches ARM resource id of support resource type.
        ...
        :param look_up_resource_id_request: Look up resource id request body. Required.
        :type look_up_resource_id_request: IO
    ...
    async def post(
        self, look_up_resource_id_request: Union[_models.LookUpResourceIdRequest, IO], **kwargs: Any
    ) -> _models.LookUpResourceIdResponse:
        """This operation fetches ARM resource id of support resource type.
        ...
        :param look_up_resource_id_request: Look up resource id request body. Is either a
         LookUpResourceIdRequest type or a IO type. Required.
        :type look_up_resource_id_request: ~azure.mgmt.support.models.LookUpResourceIdRequest or IO
    ...
    post.metadata = {"url": "/providers/Microsoft.Support/lookUpResourceId"}
