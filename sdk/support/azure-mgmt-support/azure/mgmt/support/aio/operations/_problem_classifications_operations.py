...
class ProblemClassificationsOperations:
    ...
    async def classify_problems(
        self,
        problem_service_name: str,
        problem_classifications_classification_input: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.ProblemClassificationsClassificationOutput:
        ...
        :type problem_service_name: str
        :param problem_classifications_classification_input: Input to check. Required.
        :type problem_classifications_classification_input: IO
    ...
    async def classify_problems(
        self,
        problem_service_name: str,
        problem_classifications_classification_input: Union[_models.ProblemClassificationsClassificationInput, IO],
        **kwargs: Any
    ) -> _models.ProblemClassificationsClassificationOutput:
        """Classify the right problem classifications (categories) available for a specific Azure service.
        ...
        :param problem_classifications_classification_input: Input to check. Is either a
         ProblemClassificationsClassificationInput type or a IO type. Required.
        :type problem_classifications_classification_input:
         ~azure.mgmt.support.models.ProblemClassificationsClassificationInput or IO
        ...
        request = build_classify_problems_request(
            ...
            json=_json,
            content=_content,
            template_url=self.classify_problems.metadata["url"],
            headers=_headers,
            params=_params,
        )
    ...
    classify_problems.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.Support/services/{problemServiceName}/classifyProblems"
    }
