...
class ProblemClassificationsOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :return: An iterator like instance of either ProblemClassificationsListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.support.models.ProblemClassificationsListResult]
