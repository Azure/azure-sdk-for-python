...
from .operations import CommunicationsOperations, Operations, ProblemClassificationsOperations, ServicesOperations, SupportTicketsOperations

if TYPE_CHECKING:
    # pylint: disable=unused-import,ungrouped-imports
    from azure.core.credentials import TokenCredential

class MicrosoftSupport:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.problem_classifications = ProblemClassificationsOperations(self._client, self._config, self._serialize, self._deserialize)
