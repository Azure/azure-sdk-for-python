...
class SupportMgmtClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype classify_services: azure.mgmt.support.operations.ClassifyServicesOperations
    ...
    :vartype classify_services_no_subscription:
     azure.mgmt.support.operations.ClassifyServicesNoSubscriptionOperations
    :ivar classify_problems: ClassifyProblemsOperations operations
    :vartype classify_problems: azure.mgmt.support.operations.ClassifyProblemsOperations
    ...
    :vartype classify_problems_no_subscription:
     azure.mgmt.support.operations.ClassifyProblemsNoSubscriptionOperations
