...
class CommunicationsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.CommunicationsListResult"]
    ...
    def get(
        self,
        support_ticket_name,  # type: str
        communication_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.CommunicationDetails"
    ...
    def _create_initial(
        ...
        support_ticket_name,  # type: str
        communication_name,  # type: str
        create_communication_parameters,  # type: "_models.CommunicationDetails"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.CommunicationDetails"]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.CommunicationDetails"]
