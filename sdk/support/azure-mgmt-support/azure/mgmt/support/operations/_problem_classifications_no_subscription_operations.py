...
def build_classify_problems_request(problem_service_name: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Support/services/{problemServiceName}/classifyProblems")
    path_format_arguments = {
        "problemServiceName": _SERIALIZER.url(
            "problem_service_name", problem_service_name, "str", pattern=r"^[0-9a-zA-Z_\-. ]+$"
        ),
    }
...
class ProblemClassificationsNoSubscriptionOperations:
    """
    .. warning::
    ...
    classify_problems.metadata = {"url": "/providers/Microsoft.Support/services/{problemServiceName}/classifyProblems"}
