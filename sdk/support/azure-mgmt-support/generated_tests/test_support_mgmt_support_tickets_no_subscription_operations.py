...
class TestSupportMgmtSupportTicketsNoSubscriptionOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(SupportMgmtClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_support_tickets_no_subscription_get(self, resource_group):
        response = self.client.support_tickets_no_subscription.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_support_tickets_no_subscription_begin_create(self, resource_group):
        response = self.client.support_tickets_no_subscription.begin_create(
            support_ticket_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_support_tickets_no_subscription_update(self, resource_group):
        response = self.client.support_tickets_no_subscription.update(
            support_ticket_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_support_tickets_no_subscription_check_name_availability(self, resource_group):
        response = self.client.support_tickets_no_subscription.check_name_availability(
