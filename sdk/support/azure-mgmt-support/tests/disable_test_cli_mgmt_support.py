...
class MgmtMicrosoftSupportTest(AzureMgmtTestCase):
    ...
    def setUp(self):
        ...
        self.mgmt_client = self.create_mgmt_client(azure.mgmt.support.MicrosoftSupport)
    ...
    def test_support(self, resource_group):
        ...
        BODY = {
            ...
            "quota_ticket_details": {
                ...
                "quota_change_requests": [{"region": "EastUS", "payload": '{"NewLimit":200}'}],
            },
        }
        # result = self.mgmt_client.support_tickets.create(support_ticket_name=SUPPORT_TICKET_NAME, create_support_ticket_parameters=BODY)
        # result = result.result()
        ...
        BODY = {
            ...
            "quota_ticket_details": {
                ...
                "quota_change_requests": [
                    {"region": "EastUS", "payload": '{"ServerName":"testserver","NewLimit":54000}'}
                ],
            },
        }
        # result = self.mgmt_client.support_tickets.create(support_ticket_name=SUPPORT_TICKET_NAME, create_support_ticket_parameters=BODY)
        ...
        BODY = {
            ...
            "quota_ticket_details": {
                ...
                "quota_change_request_sub_type": "Account",
                "quota_change_requests": [
                    {"region": "EastUS", "payload": '{"AccountName":"test","NewLimit":200,"Type":"Jobs"}'}
                ],
            },
        }
        # result = self.mgmt_client.support_tickets.create(support_ticket_name=SUPPORT_TICKET_NAME, create_support_ticket_parameters=BODY)
        ...
        BODY = {
            ...
            "quota_ticket_details": {
                ...
                "quota_change_request_sub_type": "Account",
                "quota_change_requests": [
                    {"region": "EastUS", "payload": '{"AccountName":"test","NewLimit":200,"Type":"Pools"}'}
                ],
            },
        }
        # result = self.mgmt_client.support_tickets.create(support_ticket_name=SUPPORT_TICKET_NAME, create_support_ticket_parameters=BODY)
        ...
        BODY = {
            ...
            "quota_ticket_details": {
                "quota_change_request_version": "1.0",
                "quota_change_request_sub_type": "BatchAml",
                "quota_change_requests": [{"region": "EastUS", "payload": '{"NewLimit":200,"Type":"LowPriority"}'}],
            },
        }
        # result = self.mgmt_client.support_tickets.create(support_ticket_name=SUPPORT_TICKET_NAME, create_support_ticket_parameters=BODY)
        # result = result.result()
        ...
        BODY = {
            ...
            "quota_ticket_details": {
                "quota_change_request_version": "1.0",
                "quota_change_requests": [{"region": "EastUS", "payload": '{"SKU":"DSv3 Series","NewLimit":104}'}],
            },
        }
        # result = self.mgmt_client.support_tickets.create(support_ticket_name=SUPPORT_TICKET_NAME, create_support_ticket_parameters=BODY)
        # result = result.result()
        ...
        BODY = {
            ...
            "quota_ticket_details": {
                ...
                "quota_change_requests": [{"region": "EastUS", "payload": '{"NewLimit":200,"Type":"Account"}'}],
            },
        }
        # result = self.mgmt_client.support_tickets.create(support_ticket_name=SUPPORT_TICKET_NAME, create_support_ticket_parameters=BODY)
        # result = result.result()
        ...
        result = self.mgmt_client.problem_classifications.get(
            service_name=SERVICE_NAME, problem_classification_name=PROBLEM_CLASSIFICATION_NAME
        )
        ...
        result = self.mgmt_client.communications.check_name_availability(
            support_ticket_name=SUPPORT_TICKET_NAME, name="sampleName", type="Microsoft.Support/communications"
        )
        ...
        BODY = {
            "contact_details": {
                ...
                "additional_email_addresses": ["tname@contoso.com", "teamtest@contoso.com"],
        ...
        result = self.mgmt_client.support_tickets.check_name_availability(
            name="sampleName", type="Microsoft.Support/supportTickets"
        )
