...
class ClustersOperations:
    ...
    async def _create_initial(
        ...
        workspace_name: str,
        cluster_name: str,
        parameters: "_models.ClusterCreateParameters",
        **kwargs: Any
        ...
        return deserialized
    _create_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces/{workspaceName}/clusters/{clusterName}'}  # type: ignore
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param cluster_name: The name of the cluster within the specified resource group. Cluster names
        ...
        :type parameters: ~batch_ai.models.ClusterCreateParameters
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~batch_ai.models.Cluster]
    ...
    begin_create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces/{workspaceName}/clusters/{clusterName}'}  # type: ignore
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~batch_ai.models.ClusterUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Cluster, or the result of cls(response)
        :rtype: ~batch_ai.models.Cluster
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.Cluster"]
        error_map = {
        ...
        return deserialized
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces/{workspaceName}/clusters/{clusterName}'}  # type: ignore
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces/{workspaceName}/clusters/{clusterName}'}  # type: ignore
    ...
    async def begin_delete(
        ...
        **kwargs: Any
        ...
        if cont_token:
            ...
            return AsyncLROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces/{workspaceName}/clusters/{clusterName}'}  # type: ignore
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces/{workspaceName}/clusters/{clusterName}'}  # type: ignore
    ...
    def list_remote_login_information(
        ...
        cluster_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.RemoteLoginInformationListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~batch_ai.models.RemoteLoginInformationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list_remote_login_information.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces/{workspaceName}/clusters/{clusterName}/listRemoteLoginInformation'}  # type: ignore

    def list_by_workspace(
        self,
        resource_group_name: str,
        workspace_name: str,
        clusters_list_by_workspace_options: Optional["_models.ClustersListByWorkspaceOptions"] = None,
        **kwargs: Any
        ...
        :param workspace_name: The name of the workspace. Workspace names can only contain a
         ...
         from 1 through 64 characters long.
        :type workspace_name: str
        :param clusters_list_by_workspace_options: Parameter group.
        :type clusters_list_by_workspace_options: ~batch_ai.models.ClustersListByWorkspaceOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ClusterListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~batch_ai.models.ClusterListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        if clusters_list_by_workspace_options is not None:
            _max_results = clusters_list_by_workspace_options.max_results
        api_version = "2018-05-01"
        accept = "application/json"
    ...
    list_by_workspace.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces/{workspaceName}/clusters'}  # type: ignore
