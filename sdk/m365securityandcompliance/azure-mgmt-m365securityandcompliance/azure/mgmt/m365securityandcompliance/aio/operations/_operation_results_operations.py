...
class OperationResultsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.m365securityandcompliance.models.OperationResultsDescription
    ...
    get.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.M365SecurityAndCompliance/locations/{locationName}/operationresults/{operationResultId}'}  # type: ignore
