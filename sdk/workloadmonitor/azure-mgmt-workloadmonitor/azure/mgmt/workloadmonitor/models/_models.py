...
class ErrorResponse(Model):
    ...
    :type error: ~azure.mgmt.workloadmonitor.models.ErrorResponseError
    """
...
class HealthMonitor(Resource):
    ...
    :param previous_monitor_state: Previous health state of the monitor.
     Possible values include: 'Healthy', 'Critical', 'Warning', 'Unknown',
     'Disabled', 'None'
    :type previous_monitor_state: str or
     ~azure.mgmt.workloadmonitor.models.HealthState
    :param current_monitor_state: Current health state of the monitor.
     Possible values include: 'Healthy', 'Critical', 'Warning', 'Unknown',
     'Disabled', 'None'
    :type current_monitor_state: str or
     ~azure.mgmt.workloadmonitor.models.HealthState
    :param evaluation_timestamp: Timestamp of the monitor's last health
     evaluation.
    :type evaluation_timestamp: str
    :param current_state_first_observed_timestamp: Timestamp of the monitor's
     last health state change.
    :type current_state_first_observed_timestamp: str
    :param last_reported_timestamp: Timestamp of the monitor's last reported
     health state.
    ...
    :param monitor_configuration: The configuration settings at the time of
     the monitor's health evaluation.
...
class Operation(Model):
    ...
    :param name: Required. The name of the operation being performed on this
     particular object.
    :type name: str
    :param display: Required. The localized display information for this
...
class OperationDisplay(Model):
    ...
    :type resource: str
    :param operation: Required. Human-readable, friendly name for the
     operation.
    :type operation: str
