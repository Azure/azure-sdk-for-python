...
#   # List models
#   modelId = "<MODEL_ID>" # from the samples: dtmi:samples:Room1, dtmi:samples:Wifi1, dtmi:samples:Floor1, dtmi:samples:Building1
#   model = await serviceClient.getModel(modelId)
#   print(`Model:`)
#   print(inspect(model))
# }
