...
#   incomingRelationships = serviceClient.listIncomingRelationships(digitalTwinId)
#   for await (incomingRelationship of incomingRelationships) {
#     print(`Incoming Relationship:`)
#     print(inspect(incomingRelationship))
#   }
# }
