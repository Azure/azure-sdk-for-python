...
#   digitalTwintId = "<DIGITAL_TWIN_ID>" # from the samples: BuildingTwin, FloorTwin, HVACTwin, RoomTwin
#   relationships = serviceClient.listRelationships(digitalTwinId)
#   for await (relationship of relationships) {
#     print(`Relationship:`)
#     print(inspect(relationship))
#   }
# }
