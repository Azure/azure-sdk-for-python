...
class DigitalTwinsClient(object):
    ...
    async def upsert_digital_twin(self, digital_twin_id, digital_twin, **kwargs):
        ...
        :raises :class: `~azure.core.exceptions.HttpResponseError`
        """
        return await self._client.digital_twins.add(digital_twin_id, digital_twin, if_none_match="", **kwargs)

    async def update_digital_twin(self, digital_twin_id, twin_patch, etag=None, **kwargs):
        ...
        :raises :class: `~azure.core.exceptions.HttpResponseError`
        """
        return await self._client.digital_twins.update(digital_twin_id, twin_patch, if_match=etag, **kwargs)

    async def delete_digital_twin(self, digital_twin_id, etag=None, **kwargs):
        ...
        :raises :class: `~azure.core.exceptions.HttpResponseError`
        """
        return await self._client.digital_twins.delete(digital_twin_id, if_match=etag, **kwargs)
    ...
    async def get_component(self, digital_twin_id, component_path, **kwargs):
        ...
        :raises :class: `~azure.core.exceptions.HttpResponseError`
        """
        return await self._client.digital_twins.get_component(digital_twin_id, component_path, **kwargs)
    ...
    async def update_relationship(self, digital_twin_id, relationship_id, relationship_patch=None, etag=None, **kwargs):
        # type: (str, str, List[object], str, **Any) -> object
    ...
    async def delete_relationship(self, digital_twin_id, relationship_id, etag=None, **kwargs):
    ...
    async def publish_component_telemetry(self, digital_twin_id, component_path, payload, message_id=None, **kwargs):
    ...
    async def get_model(self, model_id, include_model_definition=False, **kwargs):
        ...
        :raises :class: `~azure.core.exceptions.HttpResponseError`
        """
        return await self._client.digital_twin_models.get_by_id(model_id, include_model_definition, **kwargs)
    ...
    async def create_models(self, models=None, **kwargs):
        ...
        :raises :class: `~azure.core.exceptions.HttpResponseError`
        """
        return await self._client.digital_twin_models.add(models, **kwargs)
    ...
    async def decommission_model(self, model_id, **kwargs):
        ...
        return await self._client.digital_twin_models.update(model_id, decommission_patch , **kwargs)
    ...
    async def list_event_routes(self, max_item_count=-1, **kwargs):
        ...
        return await self._client.event_routes.list(digital_twin_models_list_options, **kwargs)
    ...
    async def upsert_event_route(self, event_route_id, event_route, **kwargs):
        ...
        :raises :class: `~azure.core.exceptions.HttpResponseError`
        """
        return await self._client.event_routes.add(event_route_id, event_route, **kwargs)
    ...
    async def query_twins(self, query_specification, **kwargs):
        ...
        :raises :class: `~azure.core.exceptions.HttpResponseError`
        """
        return await self._client.query.query_twins(query_specification, **kwargs)
