...
class DigitalTwinModelsOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :type digital_twin_models_list_options: ~azure.digitaltwins.models.DigitalTwinModelsListOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either PagedModelDataCollection or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.digitaltwins.models.PagedModelDataCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
