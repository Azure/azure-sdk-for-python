...
class Error(msrest.serialization.Model):
    ...
    :vartype details: list[~azure.digitaltwins.models.Error]
    :param innererror: An object containing more specific information than the current object about
     the error.
    :type innererror: ~azure.digitaltwins.models.InnerError
    """
...
class ErrorResponse(msrest.serialization.Model):
    ...
    :type error: ~azure.digitaltwins.models.Error
    """
...
class EventRouteCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.digitaltwins.models.EventRoute]
...
class IncomingRelationshipCollection(msrest.serialization.Model):
    ...
    :param value:
    :type value: list[~azure.digitaltwins.models.IncomingRelationship]
...
class PagedModelDataCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.digitaltwins.models.ModelData]
    :param next_link: A URI to retrieve the next page of objects.
    :type next_link: str
    """
