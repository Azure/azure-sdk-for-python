...
def build_get_request(resource_group_name: str, resource_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "resourceGroupName": _SERIALIZER.url(
            "resource_group_name", resource_group_name, "str", max_length=64, min_length=1
        ),
...
class DigitalTwinsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.digitaltwins.v2020_10_31.AzureDigitalTwinsManagementClient`'s
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type digital_twins_patch_description:
         ~azure.mgmt.digitaltwins.v2020_10_31.models.DigitalTwinsPatchDescription or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.DigitalTwinsDescription"]:
        ...
        :return: An iterator like instance of either DigitalTwinsDescription or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.digitaltwins.v2020_10_31.models.DigitalTwinsDescription]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def check_name_availability(
        ...
        :type digital_twins_instance_check_name:
         ~azure.mgmt.digitaltwins.v2020_10_31.models.CheckNameRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
