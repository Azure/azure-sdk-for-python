...
class DigitalTwinsEndpointOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either DigitalTwinsEndpointResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.digitaltwins.v2021_06_30_preview.models.DigitalTwinsEndpointResource]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type endpoint_description:
         ~azure.mgmt.digitaltwins.v2021_06_30_preview.models.DigitalTwinsEndpointResource or IO
