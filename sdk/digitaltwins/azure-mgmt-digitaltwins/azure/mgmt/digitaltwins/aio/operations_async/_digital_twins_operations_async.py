...
class DigitalTwinsOperations:
    ...
    async def begin_create_or_update(
        ...
        digital_twins_create: "models.DigitalTwinsDescription",
        **kwargs
    ) -> AsyncLROPoller["models.DigitalTwinsDescription"]:
    ...
    async def _update_initial(
        ...
        **kwargs
    ) -> Optional["models.DigitalTwinsDescription"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.DigitalTwinsDescription"]]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))

        _digital_twins_patch_description = models.DigitalTwinsPatchDescription(tags=tags)
        api_version = "2020-03-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_digital_twins_patch_description, 'DigitalTwinsPatchDescription')
        body_content_kwargs['content'] = body_content
    ...
    def list(
        self,
        **kwargs
    ) -> AsyncIterable["models.DigitalTwinsDescriptionListResult"]:
    ...
    async def check_name_availability(
        ...
        **kwargs
        ...
        _digital_twins_instance_check_name = models.CheckNameRequest(name=name)
        api_version = "2020-03-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_digital_twins_instance_check_name, 'CheckNameRequest')
        body_content_kwargs['content'] = body_content
