...
class DigitalTwinsEndpointOperations:
    ...
    def list(
        ...
        resource_name: str,
        **kwargs
    ) -> AsyncIterable["models.DigitalTwinsEndpointResourceListResult"]:
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DigitalTwinsEndpointResourceListResult"]
    ...
    async def get(
        ...
        endpoint_name: str,
        **kwargs
    ) -> "models.DigitalTwinsEndpointResource":
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DigitalTwinsEndpointResource"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2020-03-01-preview"
    ...
    async def _create_or_update_initial(
        ...
        resource_name: str,
        endpoint_name: str,
        properties: Optional["models.DigitalTwinsEndpointResourceProperties"] = None,
        **kwargs
    ) -> "models.DigitalTwinsEndpointResource":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DigitalTwinsEndpointResource"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        ...
        _endpoint_description = models.DigitalTwinsEndpointResource(properties=properties)
        api_version = "2020-03-01-preview"
        ...
        body_content = self._serialize.body(_endpoint_description, 'DigitalTwinsEndpointResource')
    ...
    async def begin_create_or_update(
        ...
        properties: Optional["models.DigitalTwinsEndpointResourceProperties"] = None,
        **kwargs
    ) -> AsyncLROPoller["models.DigitalTwinsEndpointResource"]:
    ...
    async def _delete_initial(
        ...
        endpoint_name: str,
        **kwargs
    ) -> Optional["models.DigitalTwinsEndpointResource"]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.DigitalTwinsEndpointResource"]]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2020-03-01-preview"
