...
class AzureDigitalTwinsManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype digital_twins_endpoint:
     azure.mgmt.digitaltwins.aio.operations.DigitalTwinsEndpointOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.digitaltwins.aio.operations.Operations
    :ivar private_link_resources: PrivateLinkResourcesOperations operations
    :vartype private_link_resources:
     azure.mgmt.digitaltwins.aio.operations.PrivateLinkResourcesOperations
    :ivar private_endpoint_connections: PrivateEndpointConnectionsOperations operations
    :vartype private_endpoint_connections:
     azure.mgmt.digitaltwins.aio.operations.PrivateEndpointConnectionsOperations
    ...
    :vartype time_series_database_connections:
     azure.mgmt.digitaltwins.aio.operations.TimeSeriesDatabaseConnectionsOperations
