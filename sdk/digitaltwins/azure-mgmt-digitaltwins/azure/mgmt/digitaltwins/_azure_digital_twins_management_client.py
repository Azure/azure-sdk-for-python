...
from .operations import DigitalTwinsIoTHubsOperations
...
class AzureDigitalTwinsManagementClient(SDKClient):
    ...
    :vartype io_thub: azure.mgmt.digitaltwins.operations.IoTHubOperations
    :ivar digital_twins_io_thubs: DigitalTwinsIoTHubs operations
    :vartype digital_twins_io_thubs: azure.mgmt.digitaltwins.operations.DigitalTwinsIoTHubsOperations
    ...
    def __init__(
        ...
        self.digital_twins_endpoint = DigitalTwinsEndpointOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.io_thub = IoTHubOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.digital_twins_io_thubs = DigitalTwinsIoTHubsOperations(
            self._client, self.config, self._serialize, self._deserialize)
