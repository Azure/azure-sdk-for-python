...
class DigitalTwinsOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.DigitalTwinsDescription"
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DigitalTwinsDescription"]
        error_map = {
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        resource_name,  # type: str
        digital_twins_create,  # type: "models.DigitalTwinsDescription"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.DigitalTwinsDescription"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DigitalTwinsDescription"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.DigitalTwinsDescription"]
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        resource_name,  # type: str
        digital_twins_patch_description,  # type: "models.DigitalTwinsPatchDescription"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.DigitalTwinsDescription"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DigitalTwinsDescription"]
    ...
    def _delete_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["models.DigitalTwinsDescription"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.DigitalTwinsDescription"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.DigitalTwinsDescriptionListResult"]
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DigitalTwinsDescriptionListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def check_name_availability(
        self,
        location,  # type: str
        digital_twins_instance_check_name,  # type: "models.CheckNameRequest"
        **kwargs  # type: Any
    ):
