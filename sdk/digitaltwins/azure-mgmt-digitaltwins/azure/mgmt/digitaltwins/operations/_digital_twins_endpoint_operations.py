...
class DigitalTwinsEndpointOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either DigitalTwinsEndpointResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.digitaltwins.models.DigitalTwinsEndpointResource]
    ...
    def get(
        ...
        deserialized = self._deserialize("DigitalTwinsEndpointResource", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(endpoint_description, (IOBase, bytes)):
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.digitaltwins.models.DigitalTwinsEndpointResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param endpoint_description: The DigitalTwinsInstance endpoint metadata and security metadata.
         Required.
        :type endpoint_description: IO[bytes]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type endpoint_name: str
        :param endpoint_description: The DigitalTwinsInstance endpoint metadata and security metadata.
         Is either a DigitalTwinsEndpointResource type or a IO[bytes] type. Required.
        :type endpoint_description: ~azure.mgmt.digitaltwins.models.DigitalTwinsEndpointResource or
         IO[bytes]
        :return: An instance of LROPoller that returns either DigitalTwinsEndpointResource or the
         result of cls(response)
        :rtype:
        ...
        if cont_token:
            return LROPoller[_models.DigitalTwinsEndpointResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.DigitalTwinsEndpointResource](
