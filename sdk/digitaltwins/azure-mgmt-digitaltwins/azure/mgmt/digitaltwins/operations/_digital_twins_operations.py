...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DigitalTwins/digitalTwinsInstances"
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class DigitalTwinsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.digitaltwins.AzureDigitalTwinsManagementClient`'s
    ...
    @distributed_trace
    def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.DigitalTwinsDescription:
        ...
        deserialized = self._deserialize("DigitalTwinsDescription", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(digital_twins_create, (IOBase, bytes)):
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource_name: str
        :param digital_twins_create: The DigitalTwinsInstance and security metadata. Required.
        :type digital_twins_create: IO[bytes]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type digital_twins_create: ~azure.mgmt.digitaltwins.models.DigitalTwinsDescription or
         IO[bytes]
        :return: An instance of LROPoller that returns either DigitalTwinsDescription or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.digitaltwins.models.DigitalTwinsDescription]
        ...
        if cont_token:
            return LROPoller[_models.DigitalTwinsDescription].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.DigitalTwinsDescription](
    ...
    def _update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(digital_twins_patch_description, (IOBase, bytes)):
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param digital_twins_patch_description: The DigitalTwinsInstance and security metadata.
         Required.
        :type digital_twins_patch_description: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either DigitalTwinsDescription or the result of
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type digital_twins_patch_description:
         ~azure.mgmt.digitaltwins.models.DigitalTwinsPatchDescription or IO[bytes]
        :return: An instance of LROPoller that returns either DigitalTwinsDescription or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.digitaltwins.models.DigitalTwinsDescription]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.DigitalTwinsDescription"]:
        """Get all the DigitalTwinsInstances in a subscription.

        :return: An iterator like instance of either DigitalTwinsDescription or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.digitaltwins.models.DigitalTwinsDescription]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    ) -> Iterable["_models.DigitalTwinsDescription"]:
    ...
    def check_name_availability(
        ...
        **kwargs: Any
        ...
        :param digital_twins_instance_check_name: Set the name parameter in the
         DigitalTwinsInstanceCheckName structure to the name of the DigitalTwinsInstance to check.
         Required.
        :type digital_twins_instance_check_name: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: CheckNameResult or the result of cls(response)
    ...
    def check_name_availability(
        self,
        location: str,
        digital_twins_instance_check_name: Union[_models.CheckNameRequest, IO[bytes]],
        **kwargs: Any
    ) -> _models.CheckNameResult:
        """Check if a DigitalTwinsInstance name is available.
        ...
        :type digital_twins_instance_check_name: ~azure.mgmt.digitaltwins.models.CheckNameRequest or
         IO[bytes]
        :return: CheckNameResult or the result of cls(response)
        :rtype: ~azure.mgmt.digitaltwins.models.CheckNameResult
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        _json = None
        _content = None
        if isinstance(digital_twins_instance_check_name, (IOBase, bytes)):
