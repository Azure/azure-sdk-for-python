...
class DigitalTwinsIoTHubsOperations(object):
    """DigitalTwinsIoTHubsOperations operations.
    ...
    def list(
        ...
        :return: An iterator like instance of IntegrationResource
        :rtype:
         ~azure.mgmt.digitaltwins.models.IntegrationResourcePaged[~azure.mgmt.digitaltwins.models.IntegrationResource]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.IntegrationResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DigitalTwins/digitalTwinsInstances/{resourceName}/integrationResources'}
