...
class TimeSeriesDatabaseConnectionsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either TimeSeriesDatabaseConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.digitaltwins.models.TimeSeriesDatabaseConnection]
    ...
    def get(
        ...
        deserialized = self._deserialize("TimeSeriesDatabaseConnection", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(time_series_database_connection_description, (IOBase, bytes)):
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type time_series_database_connection_description:
         ~azure.mgmt.digitaltwins.models.TimeSeriesDatabaseConnection
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.digitaltwins.models.TimeSeriesDatabaseConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param time_series_database_connection_description: The time series database connection
         description. Required.
        :type time_series_database_connection_description: IO[bytes]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type time_series_database_connection_name: str
        :param time_series_database_connection_description: The time series database connection
         description. Is either a TimeSeriesDatabaseConnection type or a IO[bytes] type. Required.
        :type time_series_database_connection_description:
         ~azure.mgmt.digitaltwins.models.TimeSeriesDatabaseConnection or IO[bytes]
        :return: An instance of LROPoller that returns either TimeSeriesDatabaseConnection or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.digitaltwins.models.TimeSeriesDatabaseConnection]
        ...
        if cont_token:
            return LROPoller[_models.TimeSeriesDatabaseConnection].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.TimeSeriesDatabaseConnection](
    ...
    def begin_delete(
        ...
        **kwargs: Any
        ...
        :type cleanup_connection_artifacts: str or
         ~azure.mgmt.digitaltwins.models.CleanupConnectionArtifacts
        :return: An instance of LROPoller that returns either TimeSeriesDatabaseConnection or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.digitaltwins.models.TimeSeriesDatabaseConnection]
