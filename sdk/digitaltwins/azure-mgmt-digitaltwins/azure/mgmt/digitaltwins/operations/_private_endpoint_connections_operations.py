...
class PrivateEndpointConnectionsOperations:
    ...
    def list(
        ...
        deserialized = self._deserialize("PrivateEndpointConnectionsResponse", pipeline_response.http_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either PrivateEndpointConnection or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.digitaltwins.models.PrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type private_endpoint_connection: ~azure.mgmt.digitaltwins.models.PrivateEndpointConnection or
         IO[bytes]
        :return: An instance of LROPoller that returns either PrivateEndpointConnection or the result
         of cls(response)
        :rtype:
