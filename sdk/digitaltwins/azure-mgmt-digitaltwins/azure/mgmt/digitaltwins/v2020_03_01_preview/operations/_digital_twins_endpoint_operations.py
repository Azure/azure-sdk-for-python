...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=64, min_length=1),
        "resourceName": _SERIALIZER.url("resource_name", resource_name, 'str', max_length=64, min_length=1),
        "endpointName": _SERIALIZER.url("endpoint_name", endpoint_name, 'str', max_length=64, min_length=1, pattern=r'^[A-Za-z0-9-._]{1,64}$'),
    }
...
class DigitalTwinsEndpointOperations(object):
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.digitaltwins.v2020_03_01_preview.models.DigitalTwinsEndpointResourceListResult]
