...
class TimeSeriesDatabaseConnectionsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either TimeSeriesDatabaseConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.digitaltwins.v2022_05_31.models.TimeSeriesDatabaseConnection]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type time_series_database_connection_description:
         ~azure.mgmt.digitaltwins.v2022_05_31.models.TimeSeriesDatabaseConnection or IO
