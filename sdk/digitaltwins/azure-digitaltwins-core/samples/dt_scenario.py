...
try:
        ...
        "contents": [
            {
                ...
                "properties": [{"@type": "Property", "name": "isAccessRestricted", "schema": "boolean"}],
            },
            {"@type": "Relationship", "name": "isEquippedWith", "target": "dtmi:samples:HVAC;1"},
    ...
    floor_model = {
        ...
        "displayName": "Floor",
        "contents": [
            {"@type": "Relationship", "name": "contains", "target": "dtmi:samples:Room;1"},
            {"@type": "Property", "name": "AverageTemperature", "schema": "double"},
        ],
    }
    ...
    hvac_model = {
        ...
        "contents": [
            ...
            {"@type": "Property", "name": "TargetHumidity", "schema": "double"},
            {"@type": "Relationship", "name": "controlsTemperature", "target": "dtmi:samples:Floor;1"},
        ],
    }
    ...
    room_model = {
        ...
        "contents": [
            ...
            {"@type": "Property", "name": "IsOccupied", "schema": "boolean"},
            {"@type": "Property", "name": "EmployeeId", "schema": "string"},
            {"@type": "Component", "name": "wifiAccessPoint", "schema": "dtmi:samples:Wifi;1"},
        ],
    }
    ...
    wifi_model = {
        ...
        "displayName": "Wifi",
        "contents": [
            {"@type": "Property", "name": "RouterName", "schema": "string"},
            {"@type": "Property", "name": "Network", "schema": "string"},
        ],
    }

    building_twin_id = "BuildingTwin-" + str(uuid.uuid4())
    building_twin = {
        "$metadata": {"$model": "dtmi:samples:Building;1"},
    ...
    floor_twin = {"$metadata": {"$model": "dtmi:samples:Floor;1"}, "AverageTemperature": 75}

    hvac_twin_id = "HVACTwin-" + str(uuid.uuid4())
    hvac_twin = {
        "$metadata": {"$model": "dtmi:samples:HVAC;1"},
        "Efficiency": 94,
    ...
    room_twin = {
        "$metadata": {"$model": "dtmi:samples:Room;1"},
        "Temperature": 80,
        "Humidity": 25,
        "IsOccupied": True,
        "EmployeeId": "Employee1",
        "wifiAccessPoint": {"$metadata": {}, "RouterName": "Cisco1", "Network": "Room1"},
    }
    ...
    if event_hub_endpoint_name is None:
        raise ValueError("AZURE_EVENT_HUB_ENDPOINT_NAME environment variable is not set")
    ...
    # Create models
    models = service_client.create_models(
        cast(List[MutableMapping[str, Any]], [building_model, floor_model, hvac_model, room_model, wifi_model])
    )
    ...
    route = DigitalTwinsEventRoute(endpoint_name=event_hub_endpoint_name, filter=event_filter)
