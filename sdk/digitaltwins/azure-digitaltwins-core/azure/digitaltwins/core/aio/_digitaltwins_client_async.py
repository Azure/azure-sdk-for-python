...
from .._utils import prep_if_match, prep_if_none_match
...
if TYPE_CHECKING:
    ...
    from .._generated.models import IncomingRelationship, DigitalTwinsEventRoute
...
class DigitalTwinsClient(object):  # pylint: disable=too-many-public-methods,client-accepts-api-version-keyword
    ...
    def __init__(self, endpoint: str, credential: "AsyncTokenCredential", **kwargs) -> None:
        ...
        self._client = AzureDigitalTwinsAPI(credential=credential, base_url=endpoint, sdk_moniker=SDK_MONIKER, **kwargs)
    ...
    async def get_digital_twin(self, digital_twin_id: str, **kwargs) -> MutableMapping[str, Any]:
        ...
        """
        return await self._client.digital_twins.get_by_id(digital_twin_id, **kwargs)

    # pylint: disable=docstring-keyword-should-match-keyword-only
    @distributed_trace_async
    async def upsert_digital_twin(
        self, digital_twin_id: str, digital_twin: Dict[str, object], **kwargs
        ...
        return await self._client.digital_twins.add(
            digital_twin_id, digital_twin, digital_twins_add_options=options, error_map=error_map, **kwargs
        )

    # pylint: disable=docstring-keyword-should-match-keyword-only
    @distributed_trace_async
    async def update_digital_twin(
        self, digital_twin_id: str, json_patch: Sequence[MutableMapping[str, Any]], **kwargs
    ) -> None:
    ...
    # pylint: disable=docstring-keyword-should-match-keyword-only
    @distributed_trace_async
    async def delete_digital_twin(self, digital_twin_id: str, **kwargs) -> None:
        ...
        return await self._client.digital_twins.delete(
            digital_twin_id, digital_twins_delete_options=options, error_map=error_map, **kwargs
        )
    ...
    async def get_component(self, digital_twin_id: str, component_name: str, **kwargs) -> MutableMapping[str, Any]:
        ...
        """
        return await self._client.digital_twins.get_component(digital_twin_id, component_name, **kwargs)

    @distributed_trace_async
    async def update_component(
        self, digital_twin_id: str, component_name: str, json_patch: Sequence[MutableMapping[str, Any]], **kwargs
    ) -> None:
    ...
    @distributed_trace_async
    async def get_relationship(self, digital_twin_id: str, relationship_id: str, **kwargs) -> MutableMapping[str, Any]:
        ...
        """
        return await self._client.digital_twins.get_relationship_by_id(digital_twin_id, relationship_id, **kwargs)

    @distributed_trace_async
    async def upsert_relationship(
        self, digital_twin_id: str, relationship_id: str, relationship: Dict[str, object], **kwargs
    ) -> MutableMapping[str, Any]:
    ...
    async def update_relationship(
        self, digital_twin_id: str, relationship_id: str, json_patch: Sequence[MutableMapping[str, Any]], **kwargs
    ) -> None:
    ...
    @distributed_trace_async
    async def delete_relationship(self, digital_twin_id: str, relationship_id: str, **kwargs) -> None:
    ...
    def list_relationships(
        self, digital_twin_id: str, relationship_id: Optional[str] = None, **kwargs
    ...
    @distributed_trace
    def list_incoming_relationships(self, digital_twin_id: str, **kwargs) -> AsyncItemPaged["IncomingRelationship"]:
        ...
        :raises ~azure.core.exceptions.ResourceNotFoundError: If there is no
            digital twin with the provided ID.
        """
        return self._client.digital_twins.list_incoming_relationships(digital_twin_id, **kwargs)

    @distributed_trace_async
    async def publish_telemetry(self, digital_twin_id: str, telemetry: MutableMapping[str, Any], **kwargs) -> None:
        ...
        return await self._client.digital_twins.send_telemetry(
            id=digital_twin_id, message_id=message_id, telemetry=telemetry, telemetry_source_time=timestamp, **kwargs
        )

    @distributed_trace_async
    async def publish_component_telemetry(
        self, digital_twin_id: str, component_name: str, telemetry: MutableMapping[str, Any], **kwargs
    ) -> None:
        """Publish telemetry from a digital twin. The result is then
        consumed by one or many destination endpoints (subscribers) defined under
        DigitalTwinsEventRoute. These event routes need to be set before publishing
    ...
    async def create_models(self, dtdl_models: List[MutableMapping[str, Any]], **kwargs) -> List[DigitalTwinsModelData]:
        ...
        """
        return await self._client.digital_twin_models.add(dtdl_models, **kwargs)
    ...
    async def decommission_model(self, model_id: str, **kwargs) -> None:
        ...
        patch_document = BytesIO(json.dumps(json_patch).encode("utf-8"))
        return await self._client.digital_twin_models.update(model_id, update_model=patch_document, **kwargs)
    ...
    async def delete_model(self, model_id: str, **kwargs) -> None:
        ...
        """
        return await self._client.digital_twin_models.delete(model_id, **kwargs)
    ...
    async def get_event_route(self, event_route_id: str, **kwargs) -> "DigitalTwinsEventRoute":
        ...
        """
        return await self._client.event_routes.get_by_id(event_route_id, **kwargs)
    ...
    def list_event_routes(self, **kwargs) -> AsyncItemPaged["DigitalTwinsEventRoute"]:
        ...
        return self._client.event_routes.list(**kwargs)

    @distributed_trace_async
    async def upsert_event_route(self, event_route_id: str, event_route: "DigitalTwinsEventRoute", **kwargs) -> None:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return await self._client.event_routes.add(event_route_id, event_route=event_route, **kwargs)
