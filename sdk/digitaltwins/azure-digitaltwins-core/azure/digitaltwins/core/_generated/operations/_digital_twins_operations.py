...
def build_get_by_id_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/digitaltwins/{id}')
...
def build_get_relationship_by_id_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/digitaltwins/{id}/relationships/{relationshipId}')
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'str'),
...
def build_list_relationships_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/digitaltwins/{id}/relationships')
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'str'),
    }
    ...
    if relationship_name is not None:
        query_parameters['relationshipName'] = _SERIALIZER.query("relationship_name", relationship_name, 'str')
    query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
...
def build_list_incoming_relationships_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/digitaltwins/{id}/incomingrelationships')
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'str'),
    }
...
def build_send_telemetry_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/digitaltwins/{id}/telemetry')
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'str'),
    }
    ...
    if tracestate is not None:
        header_parameters['tracestate'] = _SERIALIZER.header("tracestate", tracestate, 'str')
    header_parameters['Message-Id'] = _SERIALIZER.header("message_id", message_id, 'str')
    if telemetry_source_time is not None:
        header_parameters['Telemetry-Source-Time'] = _SERIALIZER.header("telemetry_source_time", telemetry_source_time, 'str')
    if content_type is not None:
        header_parameters['Content-Type'] = _SERIALIZER.header("content_type", content_type, 'str')
    header_parameters['Accept'] = _SERIALIZER.header("accept", accept, 'str')
...
def build_send_component_telemetry_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/digitaltwins/{id}/components/{componentPath}/telemetry')
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'str'),
...
def build_get_component_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/digitaltwins/{id}/components/{componentPath}')
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'str'),
        "componentPath": _SERIALIZER.url("component_path", component_path, 'str'),
    }
...
class DigitalTwinsOperations(object):
    ...
    def add(
        ...
        * 412 Precondition Failed
        ...
        json = self._serialize.body(twin, 'object')
    ...
    def update(
        ...
        * 412 Precondition Failed
        ...
        json = self._serialize.body(patch_document, '[object]')
    ...
    def add_relationship(
        ...
        * 412 Precondition Failed
        ...
        json = self._serialize.body(relationship, 'object')
    ...
    def send_telemetry(
        ...
        * 404 Not Found
        ...
        json = self._serialize.body(telemetry, 'object')
