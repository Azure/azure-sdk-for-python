...
class EventRoutesOperations:
    ...
    async def add(
        self,
        id: str,
        event_route: Optional[JSON] = None,
        *,
        traceparent: Optional[str] = None,
        tracestate: Optional[str] = None,
        content_type: str = "application/json",
    ...
    async def add(
        self,
        id: str,
        event_route: Optional[Union[JSON, IO[bytes]]] = None,
        *,
        traceparent: Optional[str] = None,
        tracestate: Optional[str] = None,
        **kwargs: Any
        ...
        * 400 Bad Request
        ...
        :param id: The id for an event route. The id is unique within event routes and case sensitive.
         Required.
        :type id: str
        :param event_route: The event route data. Is either a JSON type or a IO[bytes] type. Default
         value is None.
