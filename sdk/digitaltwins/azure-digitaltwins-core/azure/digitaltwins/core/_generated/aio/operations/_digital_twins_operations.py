...
from ...operations._digital_twins_operations import (
    build_add_relationship_request,
    build_add_request,
    build_delete_relationship_request,
    build_delete_request,
    build_get_by_id_request,
    build_get_component_request,
    build_get_relationship_by_id_request,
    build_list_incoming_relationships_request,
    build_list_relationships_request,
    build_send_component_telemetry_request,
    build_send_telemetry_request,
    build_update_component_request,
    build_update_relationship_request,
