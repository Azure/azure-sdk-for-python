...
class PrivateEndpointConnectionsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.attestation.models.PrivateEndpointConnectionPaged[~azure.mgmt.attestation.models.PrivateEndpointConnection]
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Attestation/attestationProvider/{providerName}/privateEndpointConnections'}

    def get(
            self, resource_group_name, provider_name, private_endpoint_connection_name, custom_headers=None, raw=False, **operation_config):
        ...
        :param private_endpoint_connection_name: Name of the private endpoint
         connection associated with the attestation providers.
        ...
        :rtype: ~azure.mgmt.attestation.models.PrivateEndpointConnection or
    ...
    def create(
            self, resource_group_name, provider_name, private_endpoint_connection_name, provisioning_state=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param provisioning_state: Provisioning state of the private endpoint
         connection. Possible values include: 'Succeeded', 'Creating',
         'Deleting', 'Failed'
        ...
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        properties = models.PrivateEndpointConnection(provisioning_state=provisioning_state)
    ...
    def delete(
        ...
        if raw:
            ...
            return client_raw_response
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Attestation/attestationProviders/{providerName}/privateEndpointConnections/{privateEndpointConnectionName}'}
