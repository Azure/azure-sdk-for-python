...
try:
    ...
    from ._models_py3 import PrivateEndpointConnectionsListResult
    from ._models_py3 import PrivateLinkConnectionItemProperties
    from ._models_py3 import PrivateLinkConnectionItemPropertiesPrivateEndpoint
    ...
    from ._models import PrivateEndpointConnectionsListResult  # type: ignore
    from ._models import PrivateLinkConnectionItemProperties  # type: ignore
    from ._models import PrivateLinkConnectionItemPropertiesPrivateEndpoint  # type: ignore
