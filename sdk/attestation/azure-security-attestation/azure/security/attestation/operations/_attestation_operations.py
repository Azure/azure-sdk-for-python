...
class AttestationOperations(object):
    ...
    def attest_open_enclave(
        ...
        **kwargs  # type: Any
        ...
        :type request: ~attestation_client.models.AttestOpenEnclaveRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AttestationResponse, or the result of cls(response)
        :rtype: ~attestation_client.models.AttestationResponse
    ...
    def attest_sgx_enclave(
        ...
        **kwargs  # type: Any
        ...
        :param request: Request object containing the quote.
        :type request: ~attestation_client.models.AttestSgxEnclaveRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AttestationResponse, or the result of cls(response)
        :rtype: ~attestation_client.models.AttestationResponse
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def attest_tpm(
        self,
        request,  # type: "_models.TpmAttestationRequest"
        **kwargs  # type: Any
    ):
        ...
        :type request: ~attestation_client.models.TpmAttestationRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: TpmAttestationResponse, or the result of cls(response)
        :rtype: ~attestation_client.models.TpmAttestationResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
