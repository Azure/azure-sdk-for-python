...
def build_policy_get_request(attestation_type: Union[str, _models.AttestationType], **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/policies/{attestationType}"
    path_format_arguments = {
        "attestationType": _SERIALIZER.url("attestation_type", attestation_type, "str"),
    }
...
def build_policy_set_request(attestation_type: Union[str, _models.AttestationType], **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_policy_reset_request(attestation_type: Union[str, _models.AttestationType], **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/policies/{attestationType}:reset"
    path_format_arguments = {
        "attestationType": _SERIALIZER.url("attestation_type", attestation_type, "str"),
    }
...
def build_policy_certificates_get_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_policy_certificates_add_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_policy_certificates_remove_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_attestation_attest_open_enclave_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_attestation_attest_sgx_enclave_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_attestation_attest_azure_guest_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_attestation_attest_tpm_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_attestation_attest_sev_snp_vm_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_attestation_attest_tdx_vm_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_tcb_baselines_get_request(
    attestation_type: Union[str, _models.AttestationType], **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/tcbbaselines/{attestationType}"
    path_format_arguments = {
        "attestationType": _SERIALIZER.url("attestation_type", attestation_type, "str"),
    }
...
def build_signing_certificates_get_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_metadata_configuration_get_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PolicyOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.security.attestation.AttestationClient`'s
    ...
    @distributed_trace
    def get(self, attestation_type: Union[str, _models.AttestationType], **kwargs: Any) -> _models.PolicyResponse:
...
class PolicyCertificatesOperations:
    ...
    @distributed_trace
    def get(self, **kwargs: Any) -> _models.PolicyCertificatesResponse:
...
class TcbBaselinesOperations:
    ...
    @distributed_trace
    def get(self, attestation_type: Union[str, _models.AttestationType], **kwargs: Any) -> _models.TcbBaselineResult:
...
class SigningCertificatesOperations:
    ...
    @distributed_trace
    def get(self, **kwargs: Any) -> _models.JsonWebKeySet:
...
class MetadataConfigurationOperations:
    ...
    @distributed_trace
    def get(self, **kwargs: Any) -> _models.OpenIDConfigurationResponse:
