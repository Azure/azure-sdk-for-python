...
def build_policy_reset_request(
    attestation_type: Union[str, _models.AttestationType],
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_policy_certificates_get_request(
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_policy_certificates_add_request(
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_policy_certificates_remove_request(
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_attestation_attest_open_enclave_request(  # pylint: disable=name-too-long
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_attestation_attest_sgx_enclave_request(  # pylint: disable=name-too-long
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_attestation_attest_azure_guest_request(  # pylint: disable=name-too-long
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_attestation_attest_tpm_request(
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_attestation_attest_sev_snp_vm_request(  # pylint: disable=name-too-long
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_attestation_attest_tdx_vm_request(
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_signing_certificates_get_request(
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_metadata_configuration_get_request(
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PolicyOperations: 
    ...
    def get(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.PolicyResponse] = kwargs.pop(
            'cls', None
        )
...
class PolicyCertificatesOperations: 
    ...
    def get(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.PolicyCertificatesResponse] = kwargs.pop(
            'cls', None
        )
    ...
    def add(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop('content_type', _headers.pop('Content-Type', None))
        cls: ClsType[_models.PolicyCertificatesModifyResponse] = kwargs.pop(
            'cls', None
        )
...
class AttestationOperations: 
    ...
    def attest_open_enclave(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop('content_type', _headers.pop('Content-Type', None))
        cls: ClsType[_models.AttestationResponse] = kwargs.pop(
            'cls', None
        )

        if body is _Unset:
            body = {"draftPolicyForAttestation": draft_policy_for_attestation, 
    ...
    def attest_azure_guest(
        ...
        *,
        content_type: str = "application/json",
        attestation_info: Optional[str] = None,
        **kwargs: Any
    ...
    def attest_azure_guest(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop('content_type', _headers.pop('Content-Type', None))
        cls: ClsType[_models.SealedAttestationResponse] = kwargs.pop(
            'cls', None
        )
    ...
    def attest_tpm(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop('content_type', _headers.pop('Content-Type', None))
        cls: ClsType[_models.TpmAttestationResponse] = kwargs.pop(
            'cls', None
        )
    ...
    def attest_tdx_vm(
        ...
        **kwargs: Any
        ...
        if body is _Unset:
            body = {"initTimeData": init_time_data, 
        "nonce": nonce, 
        "quote": quote, 
        "runtimeData": runtime_data}
            body =  {
...
class TcbBaselinesOperations: 
    ...
    def get(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.TcbBaselineResult] = kwargs.pop(
            'cls', None
        )
...
class SigningCertificatesOperations: 
    ...
    def get(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.JsonWebKeySet] = kwargs.pop(
            'cls', None
        )
...
class MetadataConfigurationOperations: 
    ...
    def get(
        self,
        **kwargs: Any
    ) -> _models.OpenIDConfigurationResponse:
        ...
        cls: ClsType[_models.OpenIDConfigurationResponse] = kwargs.pop(
            'cls', None
        )
