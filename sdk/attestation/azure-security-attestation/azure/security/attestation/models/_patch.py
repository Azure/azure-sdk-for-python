...
class AttestationToken:
    ...
    def __init__(self, **kwargs):
        ...
        if token is None:
            ...
            if signing_key or signing_certificate:
                if isinstance(signing_key, str) or isinstance(signing_certificate, str):
        ...
        if self._body:
            ...
            if kwargs.get("validate_not_before", True) and hasattr(self, "not_before") and self.not_before is not None:
                if time_now < self.not_before:
                    ...
                    if delta.total_seconds() > kwargs.get("validation_slack", 0.5):
                        raise AttestationTokenValidationException(
                            "Token is not yet valid. Now: {}, Not Before: {}".format(
    ...
    def _create_secured_jwt(body, *, key=None, certificate=None, **kwargs) -> str:  # pylint: disable=unused-argument
        ...
        header = {
            ...
            "jwk": {"x5c": [base64.b64encode(certificate.public_bytes(Encoding.DER)).decode("ascii")]},
        }
...
def patch_sdk():
    ...
    :ivar runtime_data: Runtime data provided by the enclave at the time of report generation.
    ...
    :ivar quote: SGX quote generated by Intel SGX SDK.
    :vartype quote: bytes
    :ivar runtime_data: Runtime data provided by the enclave at the time of report generation.
    :vartype runtime_data: ~azure.security.attestation.models.RuntimeData
    :ivar init_time_data: Base64Url encoded InitTime data.
    ...
    # Fix JsonWebKey docstring
    JsonWebKey.__doc__ = """JsonWebKey.
    ...
    # Fix JsonWebKeySet docstring
    JsonWebKeySet.__doc__ = """JsonWebKeySet.

    :ivar keys_property: Array of JWK values.
    :vartype keys_property: list[~azure.security.attestation.models.JsonWebKey]
    """

    # Fix PolicyCertificatesModificationResult docstring
    PolicyCertificatesModificationResult.__doc__ = """The result of a policy certificate modification.
    ...
    # Fix PolicyResult docstring
    PolicyResult.__doc__ = """The result of a policy certificate modification.
    ...
    # Fix TcbBaseline docstring
    TcbBaseline.__doc__ = """TEE specific Tcb baseline used in attestation.
    ...
    # Fix PolicyCertificatesModifyResponse docstring
    PolicyCertificatesModifyResponse.__doc__ = """The response to an attestation policy management API.

    :ivar token: RFC7519 JSON Web Token with PolicyCertificatesModificationResult body.
    :vartype token: str
    """

    # Fix PolicyCertificatesResponse docstring
    PolicyCertificatesResponse.__doc__ = """The response to an attestation policy management API.

    :ivar token: RFC7519 JSON Web Token containing PolicyCertificatesResults object.
    :vartype token: str
    """

    # Fix SealedAttestationResponse docstring
    SealedAttestationResponse.__doc__ = """The sealed result of an attestation operation.

    :ivar token: Sealed RFC 7519 JSON Web Token with AttestationResult body.
    :vartype token: str
    """

    # Fix TcbBaselineResult docstring
    TcbBaselineResult.__doc__ = """Azure supported baseline details for a TEE type.
