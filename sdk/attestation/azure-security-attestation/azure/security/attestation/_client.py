...
class AttestationClient:
    ...
    :vartype policy_certificates:
     azure.security.attestation.operations.PolicyCertificatesOperations
    ...
    :ivar tcb_baselines: TcbBaselinesOperations operations
    :vartype tcb_baselines: azure.security.attestation.operations.TcbBaselinesOperations
    :ivar signing_certificates: SigningCertificatesOperations operations
    :vartype signing_certificates:
     azure.security.attestation.operations.SigningCertificatesOperations
    :ivar metadata_configuration: MetadataConfigurationOperations operations
    :vartype metadata_configuration:
     azure.security.attestation.operations.MetadataConfigurationOperations
    ...
    def __init__(self, endpoint: str, credential: "TokenCredential", **kwargs: Any) -> None:
        _endpoint = "{endpoint}"
        self._config = AttestationClientConfiguration(endpoint=endpoint, credential=credential, **kwargs)
        ...
        self.tcb_baselines = TcbBaselinesOperations(self._client, self._config, self._serialize, self._deserialize)
