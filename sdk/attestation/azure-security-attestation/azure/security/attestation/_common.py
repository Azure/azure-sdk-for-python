...
def base64url_encode(unencoded: bytes) -> str:
...
def pem_from_base64(base64_value: str, header_type: str) -> str:
...
def validate_signing_keys(
    signing_key_pem: Optional[str], certificate_pem: Optional[str]
    ...
    if not signing_key_pem or not certificate_pem:
        raise ValueError("Both signing_key and signing_certificate must be provided together.")
...
def merge_validation_args(existing_options: Dict[str, Any], kwargs: Dict[str, Any]) -> Dict[str, Any]:
