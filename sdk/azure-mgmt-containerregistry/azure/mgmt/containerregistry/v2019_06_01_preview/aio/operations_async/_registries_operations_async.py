...
class RegistriesOperations:
    ...
    async def create(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of Registry or ClientRawResponse<Registry> if
         raw==True
        :rtype:
         ~~azure.mgmt.containerregistry.v2019_06_01_preview.models.Registry or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.containerregistry.v2019_06_01_preview.models.Registry]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_by_resource_group(
        ...
        if raw:
            header_dict = {}
        deserialized = models.RegistryPaged(
    ...
    async def schedule_run(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of Run or ClientRawResponse<Run> if raw==True
        :rtype: ~~azure.mgmt.containerregistry.v2019_06_01_preview.models.Run
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.containerregistry.v2019_06_01_preview.models.Run]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
