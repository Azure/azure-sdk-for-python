...
class ReplicationsOperations:
    ...
    async def create(
        ...
        :return: An instance of Replication or ClientRawResponse<Replication>
         if raw==True
        :rtype:
         ~~azure.mgmt.containerregistry.v2019_06_01_preview.models.Replication
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.containerregistry.v2019_06_01_preview.models.Replication]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ReplicationPaged(
