...
class WebhooksOperations:
    ...
    async def create(
        ...
        :return: An instance of Webhook or ClientRawResponse<Webhook> if
         raw==True
        :rtype:
         ~~azure.mgmt.containerregistry.v2019_06_01_preview.models.Webhook or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.containerregistry.v2019_06_01_preview.models.Webhook]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.WebhookPaged(
    ...
    def list_events(
        ...
        if raw:
            header_dict = {}
        deserialized = models.EventPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
