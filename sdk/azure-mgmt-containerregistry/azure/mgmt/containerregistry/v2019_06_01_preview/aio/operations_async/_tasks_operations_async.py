...
class TasksOperations:
    ...
    async def create(
        ...
        :return: An instance of Task or ClientRawResponse<Task> if raw==True
        :rtype: ~~azure.mgmt.containerregistry.v2019_06_01_preview.models.Task
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.containerregistry.v2019_06_01_preview.models.Task]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
