...
Features like AmqpOverWebsocket or `custom_endpoint_hostname` on `EventHubProducerClient` and `EventHubConsumerClient` are unavailable for this version which will be added back in future previews as we work towards a stable release.
