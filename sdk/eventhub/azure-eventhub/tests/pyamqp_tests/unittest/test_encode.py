...
@pytest.mark.parametrize(
        ...
        [
            ...
            (Decimal("0.1"), b'\x940\x0a\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01:'),
            (Decimal("33802.4489"), b'\x94\xb0\x8a\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01:'),
        ]
)
