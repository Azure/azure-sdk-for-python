...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_send_to_invalid_partitions_async(auth_credentials_async, uamqp_transport):
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_send_too_large_message_async(auth_credentials_async, uamqp_transport):
    if sys.platform.startswith("darwin"):
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_send_null_body_async(auth_credentials_async, uamqp_transport):
    fully_qualified_namespace, eventhub_name, credential = auth_credentials_async
    client = EventHubProducerClient(
        fully_qualified_namespace=fully_qualified_namespace,
        eventhub_name=eventhub_name,
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_create_batch_with_too_large_size_async(auth_credentials_async, uamqp_transport):
    fully_qualified_namespace, eventhub_name, credential = auth_credentials_async
    client = EventHubProducerClient(
        fully_qualified_namespace=fully_qualified_namespace,
        eventhub_name=eventhub_name,
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_invalid_proxy_server(auth_credentials_async, uamqp_transport):
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_client_send_timeout(auth_credential_receivers_async, uamqp_transport):
