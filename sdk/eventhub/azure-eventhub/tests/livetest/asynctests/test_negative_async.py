...
@pytest.mark.asyncio
async def test_send_with_invalid_hostname_async(invalid_hostname, uamqp_transport, client_args):
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_receive_with_invalid_param_async(live_eventhub, invalid_place, uamqp_transport, client_args):
    ...
    client = EventHubConsumerClient.from_connection_string(
        conn_str, consumer_group="$default", retry_total=0, uamqp_transport=uamqp_transport, **client_args
    )
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_send_with_invalid_key_async(invalid_key, uamqp_transport, client_args):
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_send_with_invalid_policy_async(invalid_policy, uamqp_transport, client_args):
    client = EventHubProducerClient.from_connection_string(
        invalid_policy, uamqp_transport=uamqp_transport, **client_args
    )
    async with client:
        with pytest.raises(ConnectError):
            batch = EventDataBatch()
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_non_existing_entity_sender_async(auth_credentials_async, uamqp_transport, client_args):
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_send_to_invalid_partitions_async(auth_credentials_async, uamqp_transport, client_args):
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_send_too_large_message_async(auth_credentials_async, uamqp_transport, client_args):
    if sys.platform.startswith("darwin"):
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_send_null_body_async(auth_credentials_async, uamqp_transport, client_args):
    fully_qualified_namespace, eventhub_name, credential = auth_credentials_async
    client = EventHubProducerClient(
        fully_qualified_namespace=fully_qualified_namespace,
        eventhub_name=eventhub_name,
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_create_batch_with_invalid_hostname_async(invalid_hostname, uamqp_transport, client_args):
    if sys.platform.startswith("darwin"):
        pytest.skip(
            "Skipping on OSX - it keeps reporting 'Unable to set external certificates' " "and blocking other tests"
        )
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_create_batch_with_too_large_size_async(auth_credentials_async, uamqp_transport, client_args):
    fully_qualified_namespace, eventhub_name, credential = auth_credentials_async
    client = EventHubProducerClient(
        fully_qualified_namespace=fully_qualified_namespace,
        eventhub_name=eventhub_name,
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_invalid_proxy_server(auth_credentials_async, uamqp_transport, client_args):
...
@pytest.mark.liveTest
@pytest.mark.asyncio
async def test_client_send_timeout(auth_credential_receivers_async, uamqp_transport, client_args):
...
async def test_client_invalid_credential_async(live_eventhub, get_credential_async, uamqp_transport, client_args):
