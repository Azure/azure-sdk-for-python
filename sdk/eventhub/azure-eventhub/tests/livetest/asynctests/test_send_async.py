...
#        await on_event.received.append(event)
#
...
#        await task
#
#        assert received_count["normal_msg"] == 2 # receiving 0?
#        assert received_count["recv_data_msg"] == 2     # receiving 3?
#        assert received_count["recv_sequence_msg"] == 2 # receiving 0?
#        assert received_count["recv_value_msg"] == 2 # receiving 0?
