...
if uamqp_installed:
    ...
    class UamqpTransport(AmqpTransport):    # pylint: disable=too-many-public-methods
        ...
        def to_outgoing_amqp_message(annotated_message):
            ...
            """
            message_header = None
            if annotated_message.header and len(set(annotated_message.header.values())) > 1:
            ...
            if annotated_message.properties and len(set(annotated_message.properties.values())) > 1:
