...
class Configuration(object):  # pylint:disable=too-many-instance-attributes
    def __init__(self, **kwargs):
        is_uamqp = kwargs.get("is_uamqp", False)
        ...
        if is_uamqp:
            self.connection_port = uamqp.constants.DEFAULT_AMQPS_PORT
            self.transport_type = (
                uamqp.constants.TransportType.AmqpOverWebsocket
                if self.http_proxy
                else kwargs.get("transport_type", uamqp.constants.TransportType.Amqp)
            )
            if self.http_proxy or self.transport_type == uamqp.constants.TransportType.AmqpOverWebsocket:
                self.transport_type = uamqp.constants.TransportType.AmqpOverWebsocket
                self.connection_port = uamqp.constants.DEFAULT_AMQP_WSS_PORT
            ...
            if self.custom_endpoint_address:
                ...
                self.connection_port = endpoint.port or uamqp.constants.DEFAULT_AMQP_WSS_PORT
