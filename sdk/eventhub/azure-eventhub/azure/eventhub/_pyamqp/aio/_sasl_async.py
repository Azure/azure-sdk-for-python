...
from ._transport_async import AsyncTransport, WebSocketTransportAsync, LegacyWebSocketTransportAsync
...
class SASLWithLegacyWebSocket(LegacyWebSocketTransportAsync, SASLTransportMixinAsync):
    def __init__(
        self,
        host,
        credential,
