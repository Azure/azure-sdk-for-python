    ...
    def _management_request(self, mgmt_msg, op_type):
        ...
        while retried_times <= self._config.max_retries:
            ...
            mgmt_client = AMQPClient(
                self._address.hostname, auth=mgmt_auth, debug=self._config.network_tracing, transport_type=self._config.transport_type, custom_endpoint_address=self._config.custom_endpoint_address,connection_verify=self._config.connection_verify,
            )
            try:
                mgmt_client.open()
