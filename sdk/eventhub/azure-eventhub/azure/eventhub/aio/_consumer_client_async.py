...
class EventHubConsumerClient(ClientBaseAsync):
    ...
    :keyword str or ~azure.eventhub.LoadBalancingStrategy load_balancing_strategy: When load-balancing kicks in,
     ...
     too fewer partitions, this client will steal one partition from other clients for every load-balancing
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._load_balancing_interval = kwargs.pop("load_balancing_interval", None) or 10
        self._partition_ownership_expiration_interval = kwargs.pop(
            "partition_ownership_expiration_interval", None
        ) or 6*self._load_balancing_interval
