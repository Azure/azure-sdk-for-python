...
- Updated uAMQP dependency to 1.2.7.
  ...
  - Fixed bug that caused segmentation fault in network tacking on MacOS when setting `logging_enable` to `True` in `EventHubConsumerClient` and `EventHubProducerClient`.
