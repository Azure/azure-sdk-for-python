...
# USAGE
    python cluster_quota_configuration_patch.py
...
def main():
    ...
    response = client.configuration.patch(
        resource_group_name="ArunMonocle",
        cluster_name="testCluster",
        parameters={"settings": {"eventhub-per-namespace-quota": "20", "namespaces-per-cluster-quota": "200"}},
    )
    print(response)
