...
class SchemaRegistryOperations:
    ...
    def list_by_namespace(
        ...
        **kwargs: Any
        ...
        :type top: int
        :return: An iterator like instance of either SchemaGroup or the result of cls(response)
        ...
        cls: ClsType[_models.SchemaGroupListResult] = kwargs.pop("cls", None)
    ...
    def create_or_update(
        ...
        namespace_name: str,
        schema_group_name: str,
        parameters: Union[_models.SchemaGroup, IO[bytes]],
        **kwargs: Any
    ) -> _models.SchemaGroup:
        """Creates or Updates an EventHub schema group.
        ...
        :type parameters: ~azure.mgmt.eventhub.models.SchemaGroup or IO[bytes]
        :return: SchemaGroup or the result of cls(response)
        :rtype: ~azure.mgmt.eventhub.models.SchemaGroup
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        deserialized = self._deserialize("SchemaGroup", pipeline_response.http_response)
