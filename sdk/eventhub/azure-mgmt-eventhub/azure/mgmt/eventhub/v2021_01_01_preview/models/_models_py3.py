...
class EHNamespace(TrackedResource):
    ...
    def __init__(self, *, location: str=None, tags=None, sku=None, identity=None, cluster_arm_id: str=None, is_auto_inflate_enabled: bool=None, maximum_throughput_units: int=None, kafka_enabled: bool=None, zone_redundant: bool=None, encryption=None, private_endpoint_connections=None, **kwargs) -> None:
...
class Encryption(Model):
    ...
    def __init__(self, *, key_vault_properties=None, key_source="Microsoft.KeyVault", require_infrastructure_encryption: bool=None, **kwargs) -> None:
...
class KeyVaultProperties(Model):
    ...
    def __init__(self, *, key_name: str=None, key_vault_uri: str=None, key_version: str=None, identity=None, **kwargs) -> None:
...
class PrivateLinkResource(Model):
    ...
    def __init__(self, *, group_id: str=None, required_members=None, required_zone_names=None, id: str=None, name: str=None, type: str=None, **kwargs) -> None:
