...
class ClustersOperations:
    ...
    async def list_available_cluster_region(self, **kwargs: Any) -> _models.AvailableClustersList:
        ...
        :rtype: ~azure.mgmt.eventhub.v2021_11_01.models.AvailableClustersList
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.Cluster"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.eventhub.v2021_11_01.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get(self, resource_group_name: str, cluster_name: str, **kwargs: Any) -> _models.Cluster:
        ...
        :rtype: ~azure.mgmt.eventhub.v2021_11_01.models.Cluster
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.eventhub.v2021_11_01.models.Cluster
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either Cluster or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.eventhub.v2021_11_01.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.eventhub.v2021_11_01.models.Cluster or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Cluster or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.eventhub.v2021_11_01.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def list_namespaces(
        ...
        :rtype: ~azure.mgmt.eventhub.v2021_11_01.models.EHNamespaceIdListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
