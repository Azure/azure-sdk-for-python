...
class RegionsOperations(object):
    ...
    def list_by_sku(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.MessagingRegionsListResult"
        """Gets the available Regions for a given sku.

        :param sku: The sku type.
        :type sku: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MessagingRegionsListResult or the result of cls(response)
        :rtype: ~azure.mgmt.eventhub.v2017_04_01.models.MessagingRegionsListResult
