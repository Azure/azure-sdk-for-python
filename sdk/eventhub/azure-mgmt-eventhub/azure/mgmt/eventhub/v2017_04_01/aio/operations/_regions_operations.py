...
class RegionsOperations:
    ...
    def list_by_sku(
        ...
        sku: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.MessagingRegionsListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.eventhub.v2017_04_01.models.MessagingRegionsListResult]
