...
from .operations import ConsumerGroupsOperations, DisasterRecoveryConfigsOperations, EventHubsOperations, NamespacesOperations, Operations, RegionsOperations
...
class EventHubManagementClient:
    ...
    :vartype disaster_recovery_configs:
     azure.mgmt.eventhub.v2017_04_01.operations.DisasterRecoveryConfigsOperations
