...
class ConsumerGroupsOperations:
    ...
    async def create_or_update(
        ...
        event_hub_name: str,
        consumer_group_name: str,
        parameters: Union[_models.ConsumerGroupCreateOrUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.ConsumerGroupResource:
        """Creates or updates an Event Hubs consumer group as a nested resource within a Namespace.
        ...
        cls: ClsType[_models.ConsumerGroupResource] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("ConsumerGroupResource", pipeline_response.http_response)
