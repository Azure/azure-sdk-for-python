...
from ...operations._consumer_groups_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_all_request
T = TypeVar('T')
    ...
    def list_all(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ConsumerGroupListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.eventhub.v2015_08_01.models.ConsumerGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2015-08-01")  # type: str
