...
class NamespacesOperations:
    ...
    async def check_name_availability(
        ...
        :type parameters: ~azure.mgmt.eventhub.v2015_08_01.models.CheckNameAvailabilityParameter or
         IO[bytes]
        :return: CheckNameAvailabilityResult or the result of cls(response)
        :rtype: ~azure.mgmt.eventhub.v2015_08_01.models.CheckNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _create_or_update_initial(
        ...
        namespace_name: str,
        parameters: Union[_models.NamespaceCreateOrUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def update(
        ...
        resource_group_name: str,
        namespace_name: str,
        parameters: Union[_models.NamespaceUpdateParameter, IO[bytes]],
        **kwargs: Any
    ) -> Optional[_models.NamespaceResource]:
        """Creates or updates a namespace. Once created, this namespace's resource manifest is immutable.
        This operation is idempotent.
        ...
        :type parameters: ~azure.mgmt.eventhub.v2015_08_01.models.NamespaceUpdateParameter or IO[bytes]
        :return: NamespaceResource or None or the result of cls(response)
        :rtype: ~azure.mgmt.eventhub.v2015_08_01.models.NamespaceResource or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def regenerate_keys(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.eventhub.v2015_08_01.models.RegenerateKeysParameters or IO[bytes]
        :return: ResourceListKeys or the result of cls(response)
        :rtype: ~azure.mgmt.eventhub.v2015_08_01.models.ResourceListKeys
        :raises ~azure.core.exceptions.HttpResponseError:
        """
