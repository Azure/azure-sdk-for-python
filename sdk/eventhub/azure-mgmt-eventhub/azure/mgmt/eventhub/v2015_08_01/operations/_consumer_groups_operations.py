...
class ConsumerGroupsOperations(object):
    ...
    def create_or_update(
        ...
        :param parameters: Parameters supplied to create or update a consumer
         group resource.
        :type parameters:
         ~azure.mgmt.eventhub.v2015_08_01.models.ConsumerGroupCreateOrUpdateParameters
    ...
    def list_all(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of ConsumerGroupResource
        :rtype:
         ~azure.mgmt.eventhub.v2015_08_01.models.ConsumerGroupResourcePaged[~azure.mgmt.eventhub.v2015_08_01.models.ConsumerGroupResource]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.ConsumerGroupResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)
