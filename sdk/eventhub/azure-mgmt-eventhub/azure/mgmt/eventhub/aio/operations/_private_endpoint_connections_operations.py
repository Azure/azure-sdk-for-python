...
class PrivateEndpointConnectionsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either PrivateEndpointConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.eventhub.models.PrivateEndpointConnection]
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.eventhub.models.PrivateEndpointConnection or IO[bytes]
        :return: PrivateEndpointConnection or the result of cls(response)
        :rtype: ~azure.mgmt.eventhub.models.PrivateEndpointConnection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
