...
class EventHubManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype clusters: azure.mgmt.eventhub.v2024_01_01.aio.operations.ClustersOperations
    :ivar namespaces: NamespacesOperations operations
    :vartype namespaces: azure.mgmt.eventhub.v2024_01_01.aio.operations.NamespacesOperations
    :ivar private_endpoint_connections: PrivateEndpointConnectionsOperations operations
    :vartype private_endpoint_connections:
     azure.mgmt.eventhub.v2024_01_01.aio.operations.PrivateEndpointConnectionsOperations
    :ivar private_link_resources: PrivateLinkResourcesOperations operations
    :vartype private_link_resources:
     azure.mgmt.eventhub.v2024_01_01.aio.operations.PrivateLinkResourcesOperations
    ...
    :vartype network_security_perimeter_configuration:
     azure.mgmt.eventhub.v2024_01_01.aio.operations.NetworkSecurityPerimeterConfigurationOperations
    :ivar network_security_perimeter_configurations:
     NetworkSecurityPerimeterConfigurationsOperations operations
    :vartype network_security_perimeter_configurations:
     azure.mgmt.eventhub.v2024_01_01.aio.operations.NetworkSecurityPerimeterConfigurationsOperations
    :ivar configuration: ConfigurationOperations operations
    :vartype configuration: azure.mgmt.eventhub.v2024_01_01.aio.operations.ConfigurationOperations
    :ivar disaster_recovery_configs: DisasterRecoveryConfigsOperations operations
    :vartype disaster_recovery_configs:
     azure.mgmt.eventhub.v2024_01_01.aio.operations.DisasterRecoveryConfigsOperations
    :ivar event_hubs: EventHubsOperations operations
    :vartype event_hubs: azure.mgmt.eventhub.v2024_01_01.aio.operations.EventHubsOperations
    :ivar consumer_groups: ConsumerGroupsOperations operations
    :vartype consumer_groups:
     azure.mgmt.eventhub.v2024_01_01.aio.operations.ConsumerGroupsOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.eventhub.v2024_01_01.aio.operations.Operations
    :ivar schema_registry: SchemaRegistryOperations operations
    :vartype schema_registry:
     azure.mgmt.eventhub.v2024_01_01.aio.operations.SchemaRegistryOperations
    :ivar application_group: ApplicationGroupOperations operations
    :vartype application_group:
     azure.mgmt.eventhub.v2024_01_01.aio.operations.ApplicationGroupOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.clusters = ClustersOperations(self._client, self._config, self._serialize, self._deserialize, "2024-01-01")
