...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.EventHub/clusters")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class ClustersOperations:
    ...
    def list_available_cluster_region(self, **kwargs: Any) -> _models.AvailableClustersList:
        ...
        :rtype: ~azure.mgmt.eventhub.v2024_05_01_preview.models.AvailableClustersList
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.Cluster"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.eventhub.v2024_05_01_preview.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get(self, resource_group_name: str, cluster_name: str, **kwargs: Any) -> _models.Cluster:
        ...
        :rtype: ~azure.mgmt.eventhub.v2024_05_01_preview.models.Cluster
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.eventhub.v2024_05_01_preview.models.Cluster
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Cluster or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.eventhub.v2024_05_01_preview.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.eventhub.v2024_05_01_preview.models.Cluster or IO[bytes]
        :return: An instance of LROPoller that returns either Cluster or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.eventhub.v2024_05_01_preview.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_namespaces(
        ...
        :rtype: ~azure.mgmt.eventhub.v2024_05_01_preview.models.EHNamespaceIdListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
