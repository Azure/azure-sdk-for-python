...
def build_list_available_cluster_region_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.EventHub/availableClusterRegions"
    )
...
class ClustersOperations:
    ...
    def list_available_cluster_region(self, **kwargs: Any) -> _models.AvailableClustersList:
        ...
        _request = build_list_available_cluster_region_request(
        ...
        deserialized = self._deserialize("AvailableClustersList", pipeline_response.http_response)
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Cluster"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.eventhub.v2018_01_01_preview.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.eventhub.v2018_01_01_preview.models.Cluster or IO[bytes]
        :return: An instance of LROPoller that returns either Cluster or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.eventhub.v2018_01_01_preview.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_namespaces(
        ...
        _request = build_list_namespaces_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
        ...
        deserialized = self._deserialize("EHNamespaceIdListResult", pipeline_response.http_response)
