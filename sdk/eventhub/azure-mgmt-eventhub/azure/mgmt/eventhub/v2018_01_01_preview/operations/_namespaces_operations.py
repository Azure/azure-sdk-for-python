...
class NamespacesOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_ip_filter_rules(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.eventhub.v2018_01_01_preview.models.IpFilterRule]
    ...
    def create_or_update_ip_filter_rule(
        ...
        namespace_name: str,
        ip_filter_rule_name: str,
        parameters: Union[_models.IpFilterRule, IO],
        **kwargs: Any
    ) -> _models.IpFilterRule:
        """Creates or updates an IpFilterRule for a Namespace.
        ...
        :param ip_filter_rule_name: The IP Filter Rule name. Required.
        :type ip_filter_rule_name: str
        :param parameters: The Namespace IpFilterRule. Is either a IpFilterRule type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.eventhub.v2018_01_01_preview.models.IpFilterRule or IO
    ...
    create_or_update_ip_filter_rule.metadata = {
    ...
    delete_ip_filter_rule.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/namespaces/{namespaceName}/ipfilterrules/{ipFilterRuleName}"
    }
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.EHNamespace"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.eventhub.v2018_01_01_preview.models.EHNamespace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.eventhub.v2018_01_01_preview.models.EHNamespace or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_virtual_network_rules(
        self, resource_group_name: str, namespace_name: str, **kwargs: Any
    ) -> Iterable["_models.VirtualNetworkRule"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.eventhub.v2018_01_01_preview.models.VirtualNetworkRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    list_virtual_network_rules.metadata = {
    ...
    def create_or_update_virtual_network_rule(
        ...
        **kwargs: Any
        ...
        :param parameters: The Namespace VirtualNetworkRule. Is either a VirtualNetworkRule type or a
         IO type. Required.
        :type parameters: ~azure.mgmt.eventhub.v2018_01_01_preview.models.VirtualNetworkRule or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    create_or_update_virtual_network_rule.metadata = {
    ...
    delete_virtual_network_rule.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/namespaces/{namespaceName}/virtualnetworkrules/{virtualNetworkRuleName}"
    }
    ...
    get_virtual_network_rule.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/namespaces/{namespaceName}/virtualnetworkrules/{virtualNetworkRuleName}"
    }
    ...
    def create_or_update_network_rule_set(
        ...
        **kwargs: Any
        ...
        :param parameters: The Namespace IpFilterRule. Is either a NetworkRuleSet type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.eventhub.v2018_01_01_preview.models.NetworkRuleSet or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
