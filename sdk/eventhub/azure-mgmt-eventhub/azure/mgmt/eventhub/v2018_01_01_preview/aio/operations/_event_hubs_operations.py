...
class EventHubsOperations:
    ...
    async def create_or_update_authorization_rule(
        ...
        **kwargs: Any
        ...
        :param parameters: The shared access AuthorizationRule. Is either a AuthorizationRule type or a
         IO type. Required.
        :type parameters: ~azure.mgmt.eventhub.v2018_01_01_preview.models.AuthorizationRule or IO
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.eventhub.v2018_01_01_preview.models.Eventhub or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
