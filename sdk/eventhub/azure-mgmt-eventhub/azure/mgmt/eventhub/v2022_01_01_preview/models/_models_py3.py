...
class ApplicationGroupListResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super(ApplicationGroupListResult, self).__init__(**kwargs)
        self.value = value
        self.next_link = None


class ApplicationGroupPolicy(msrest.serialization.Model):
    """Properties of the Application Group policy.

    You probably want to use the sub-classes and not this class directly. Known
    sub-classes are: ThrottlingPolicy.

    All required parameters must be populated in order to send to Azure.

    :ivar name: Required. The Name of this policy.
    :vartype name: str
    :ivar type: Required. Application Group Policy types.Constant filled by server. Possible values
    ...
    _subtype_map = {
        'type': {'ThrottlingPolicy': 'ThrottlingPolicy'}
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword name: Required. The Name of this policy.
        :paramtype name: str
        """
        super(ApplicationGroupPolicy, self).__init__(**kwargs)
        self.name = name
...
class NetworkRuleSet(ProxyResource):
    ...
    :ivar public_network_access: This determines if traffic is allowed over public network. By
     ...
     is controlled by the network security perimeter and profile's access rules. Possible values
     include: "Enabled", "Disabled", "SecuredByPerimeter". Default value: "Enabled".
    :vartype public_network_access: str or
...
class NetworkSecurityPerimeter(msrest.serialization.Model):
...
class NetworkSecurityPerimeterConfiguration(TrackedResource):
    ...
    :ivar provisioning_state: Provisioning state of NetworkSecurityPerimeter configuration
     propagation. Possible values include: "Unknown", "Creating", "Updating", "Accepted",
     "InvalidResponse", "Succeeded", "SucceededWithIssues", "Failed", "Deleting", "Deleted",
     "Canceled".
    :vartype provisioning_state: str or
    ...
    _attribute_map = {
        ...
        'network_security_perimeter': {'key': 'properties.networkSecurityPerimeter', 'type': 'NetworkSecurityPerimeter'},
        'resource_association': {'key': 'properties.resourceAssociation', 'type': 'NetworkSecurityPerimeterConfigurationPropertiesResourceAssociation'},
    ...
    def __init__(
        ...
        *,
        location: Optional[str] = None,
        tags: Optional[Dict[str, str]] = None,
        provisioning_state: Optional[Union[str, "NetworkSecurityPerimeterConfigurationProvisioningState"]] = None,
        provisioning_issues: Optional[List["ProvisioningIssue"]] = None,
        **kwargs
    ):
        """
        :keyword location: Resource location.
        ...
        :paramtype provisioning_issues:
         list[~azure.mgmt.eventhub.v2022_01_01_preview.models.ProvisioningIssue]
        """
        super(NetworkSecurityPerimeterConfiguration, self).__init__(location=location, tags=tags, **kwargs)
...
class NetworkSecurityPerimeterConfigurationList(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        """
        super(NetworkSecurityPerimeterConfigurationList, self).__init__(**kwargs)
        self.value = None


class NetworkSecurityPerimeterConfigurationPropertiesProfile(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        access_rules: Optional[List["NspAccessRule"]] = None,
        **kwargs
    ):
        """
        ...
        """
        super(NetworkSecurityPerimeterConfigurationPropertiesProfile, self).__init__(**kwargs)
        self.name = name
        self.access_rules_version = access_rules_version
        self.access_rules = access_rules


class NetworkSecurityPerimeterConfigurationPropertiesResourceAssociation(msrest.serialization.Model):
    """Information about resource association.

    :ivar name: Name of the resource association.
    :vartype name: str
    :ivar access_mode: Access Mode of the resource association. Possible values include:
    ...
    def __init__(
        ...
        *,
        name: Optional[str] = None,
        access_mode: Optional[Union[str, "ResourceAssociationAccessMode"]] = None,
        **kwargs
    ):
        """
        :keyword name: Name of the resource association.
        :paramtype name: str
        :keyword access_mode: Access Mode of the resource association. Possible values include:
         "NoAssociationMode", "EnforcedMode", "LearningMode", "AuditMode", "UnspecifiedMode".
        :paramtype access_mode: str or
         ~azure.mgmt.eventhub.v2022_01_01_preview.models.ResourceAssociationAccessMode
        """
        super(NetworkSecurityPerimeterConfigurationPropertiesResourceAssociation, self).__init__(**kwargs)
        self.name = name
        self.access_mode = access_mode


class NspAccessRule(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype type: str
        """
        super(NspAccessRule, self).__init__(**kwargs)
        self.id = id
        self.name = name
        self.type = type
...
class NspAccessRuleProperties(msrest.serialization.Model):
    """Properties of Access Rule.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar direction: Direction of Access Rule. Possible values include: "Inbound", "Outbound".
    ...
    def __init__(
        self,
        *,
        direction: Optional[Union[str, "NspAccessRuleDirection"]] = None,
        address_prefixes: Optional[List[str]] = None,
        subscriptions: Optional[List["NspAccessRulePropertiesSubscriptionsItem"]] = None,
        **kwargs
    ):
        """
        :keyword direction: Direction of Access Rule. Possible values include: "Inbound", "Outbound".
        ...
        :paramtype subscriptions:
         list[~azure.mgmt.eventhub.v2022_01_01_preview.models.NspAccessRulePropertiesSubscriptionsItem]
        """
        super(NspAccessRuleProperties, self).__init__(**kwargs)
...
class NspAccessRulePropertiesSubscriptionsItem(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype id: str
        """
        super(NspAccessRulePropertiesSubscriptionsItem, self).__init__(**kwargs)
        self.id = id
...
class ProvisioningIssue(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype name: str
        """
        super(ProvisioningIssue, self).__init__(**kwargs)
        self.name = name
        self.properties = None


class ProvisioningIssueProperties(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype description: str
        """
        super(ProvisioningIssueProperties, self).__init__(**kwargs)
...
class ThrottlingPolicy(ApplicationGroupPolicy):
    ...
    :vartype type: str or
     ~azure.mgmt.eventhub.v2022_01_01_preview.models.ApplicationGroupPolicyType
    :ivar rate_limit_threshold: Required. The Threshold limit above which the application group
     will be throttled.Rate limit is always per second.
    :vartype rate_limit_threshold: long
    :ivar metric_id: Required. Metric Id on which the throttle limit should be set, MetricId can be
    ...
    _attribute_map = {
        'name': {'key': 'name', 'type': 'str'},
        'type': {'key': 'type', 'type': 'str'},
        'rate_limit_threshold': {'key': 'rateLimitThreshold', 'type': 'long'},
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword name: Required. The Name of this policy.
        :paramtype name: str
        :keyword rate_limit_threshold: Required. The Threshold limit above which the application group
         will be throttled.Rate limit is always per second.
        :paramtype rate_limit_threshold: long
        :keyword metric_id: Required. Metric Id on which the throttle limit should be set, MetricId can
         be discovered by hovering over Metric in the Metrics section of Event Hub Namespace inside
         Azure Portal. Possible values include: "IncomingBytes", "OutgoingBytes", "IncomingMessages",
         "OutgoingMessages".
        :paramtype metric_id: str or ~azure.mgmt.eventhub.v2022_01_01_preview.models.MetricId
        """
        super(ThrottlingPolicy, self).__init__(name=name, **kwargs)
        self.type = 'ThrottlingPolicy'  # type: str
