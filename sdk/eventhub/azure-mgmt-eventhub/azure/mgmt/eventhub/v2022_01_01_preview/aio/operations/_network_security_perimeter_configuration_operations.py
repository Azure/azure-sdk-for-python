...
from ...operations._network_security_perimeter_configuration_operations import build_list_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class NetworkSecurityPerimeterConfigurationOperations:
    """NetworkSecurityPerimeterConfigurationOperations async operations.
