...
class ApplicationGroupOperations:
    ...
    def create_or_update_application_group(
        ...
        namespace_name: str,
        application_group_name: str,
        parameters: Union[_models.ApplicationGroup, IO[bytes]],
        **kwargs: Any
    ) -> _models.ApplicationGroup:
        """Creates or updates an ApplicationGroup for a Namespace.
        ...
        :param parameters: The ApplicationGroup. Is either a ApplicationGroup type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.eventhub.v2022_10_01_preview.models.ApplicationGroup or IO[bytes]
        :return: ApplicationGroup or the result of cls(response)
        :rtype: ~azure.mgmt.eventhub.v2022_10_01_preview.models.ApplicationGroup
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _request = build_create_or_update_application_group_request(
            resource_group_name=resource_group_name,
            namespace_name=namespace_name,
