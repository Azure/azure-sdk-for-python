...
class NetworkSecurityPerimeterConfigurationOperations:  # pylint: disable=name-too-long
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.eventhub.v2022_10_01_preview.models.NetworkSecurityPerimeterConfigurationList
        ...
        deserialized = self._deserialize("NetworkSecurityPerimeterConfigurationList", pipeline_response.http_response)
