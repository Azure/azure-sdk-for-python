...
class EventHubManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype fabric_shortcuts: azure.mgmt.eventhub.operations.FabricShortcutsOperations
    ...
    :vartype upgrade_preferences_operations:
     azure.mgmt.eventhub.operations.UpgradePreferencesOperationsOperations
