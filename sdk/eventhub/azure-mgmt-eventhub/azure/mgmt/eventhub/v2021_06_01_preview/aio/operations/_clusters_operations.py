...
from ...operations._clusters_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_available_cluster_region_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_list_namespaces_request, build_update_request_initial
T = TypeVar('T')
...
class ClustersOperations:
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.eventhub.v2021_06_01_preview.models.ClusterListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-06-01-preview")  # type: str
    ...
    list_by_subscription.metadata = {'url': "/subscriptions/{subscriptionId}/providers/Microsoft.EventHub/clusters"}  # type: ignore
