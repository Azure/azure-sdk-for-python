...
def build_get_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.BotService/listQnAMakerEndpointKeys"
...
class QnAMakerEndpointKeysOperations:
    ...
    @distributed_trace
    def get(
        self, parameters: Union[_models.QnAMakerEndpointKeysRequestBody, IO], **kwargs: Any
    ) -> _models.QnAMakerEndpointKeysResponse:
        """Lists the QnA Maker endpoint keys.
