...
class BotsOperations(object):
    ...
    def update(
        ...
        kind=None,  # type: Optional[Union[str, "_models.Kind"]]
        etag=None,  # type: Optional[str]
        properties=None,  # type: Optional["_models.BotProperties"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Bot"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'Bot')
        body_content_kwargs['content'] = body_content
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.BotResponseList"]
    ...
    def get_check_name_availability(
        self,
        parameters,  # type: "_models.CheckNameAvailabilityRequestBody"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.CheckNameAvailabilityResponseBody"
        ...
        # Construct URL
        url = self.get_check_name_availability.metadata['url']  # type: ignore
