...
class ChannelsOperations(object):
    ...
    def create(
        ...
        channel_name,  # type: Union[str, "_models.ChannelName"]
        parameters,  # type: "_models.BotChannel"
        **kwargs  # type: Any
    ):
    ...
    def update(
        ...
        properties=None,  # type: Optional["_models.Channel"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.BotChannel"
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ChannelResponseList"]
