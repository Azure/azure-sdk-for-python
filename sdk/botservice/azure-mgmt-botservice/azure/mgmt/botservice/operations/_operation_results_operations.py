...
def build_get_request_initial(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.BotService/operationresults/{operationResultId}")  # pylint: disable=line-too-long
...
class OperationResultsOperations(object):
    ...
    def begin_get(
        ...
        operation_result_id: str,
        **kwargs: Any
    ) -> LROPoller["_models.OperationResultsDescription"]:
