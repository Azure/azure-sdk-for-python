...
class OperationResultsOperations(object):
    ...
    def _get_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["_models.OperationResultsDescription"]
    ...
    def begin_get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.OperationResultsDescription"]
        ...
        :return: An instance of LROPoller that returns either OperationResultsDescription or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.botservice.models.OperationResultsDescription]
