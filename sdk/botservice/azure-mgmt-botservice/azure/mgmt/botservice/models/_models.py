...
class Channel(Model):
    ...
    sub-classes are: AlexaChannel, FacebookChannel, EmailChannel,
    MsTeamsChannel, SkypeChannel, KikChannel, WebChatChannel,
    DirectLineChannel, TelegramChannel, SmsChannel, SlackChannel, LineChannel,
    ...
    _subtype_map = {
        'channel_name': {'AlexaChannel': 'AlexaChannel', 'FacebookChannel': 'FacebookChannel', 'EmailChannel': 'EmailChannel', 'MsTeamsChannel': 'MsTeamsChannel', 'SkypeChannel': 'SkypeChannel', 'KikChannel': 'KikChannel', 'WebChatChannel': 'WebChatChannel', 'DirectLineChannel': 'DirectLineChannel', 'TelegramChannel': 'TelegramChannel', 'SmsChannel': 'SmsChannel', 'SlackChannel': 'SlackChannel', 'LineChannel': 'LineChannel', 'DirectLineSpeechChannel': 'DirectLineSpeechChannel'}
    }
...
class AlexaChannel(Channel):
    ...
    :param channel_name: Required. Constant filled by server.
    :type channel_name: str
    :param properties: The set of properties specific to Alexa channel
     resource
    ...
    def __init__(self, **kwargs):
        ...
        self.channel_name = 'AlexaChannel'


class AlexaChannelProperties(Model):
    ...
    :ivar url_fragment: Url fragment used in part of the Uri configured in
     Alexa
    ...
    def __init__(self, **kwargs):
        ...
        self.alexa_skill_id = kwargs.get('alexa_skill_id', None)
...
class DirectLineSpeechChannel(Channel):
    ...
    :param channel_name: Required. Constant filled by server.
    :type channel_name: str
    :param properties: The set of properties specific to DirectLine Speech
     channel resource
    :type properties:
     ~azure.mgmt.botservice.models.DirectLineSpeechChannelProperties
    """
    ...
    def __init__(self, **kwargs):
        ...
        self.properties = kwargs.get('properties', None)
        self.channel_name = 'DirectLineSpeechChannel'


class DirectLineSpeechChannelProperties(Model):
    ...
    :param is_default_bot_for_cog_svc_account: Make this a default bot for
     chosen cognitive service account.
...
class LineChannel(Channel):
    ...
    def __init__(self, **kwargs):
        ...
        self.properties = kwargs.get('properties', None)
        self.channel_name = 'LineChannel'


class LineChannelProperties(Model):
    ...
    :param line_registrations: Required. The list of line channel
     registrations
    :type line_registrations:
     list[~azure.mgmt.botservice.models.LineRegistration]
    ...
    def __init__(self, **kwargs):
        ...
        self.line_registrations = kwargs.get('line_registrations', None)
        self.callback_url = None
        self.is_validated = None


class LineRegistration(Model):
    ...
    :param channel_access_token: Access token for the line channel
     registration
...
class SiteInfo(Model):
    """Site information for WebChat or DirectLine Channels to identify which site
    to regenerate keys for.

    All required parameters must be populated in order to send to Azure.

    :param site_name: Required. The site name
    :type site_name: str
    :param key: Required. Determines which key is to be regenerated. Possible
