...
class SlackChannelProperties(Model):
    ...
    def __init__(self, *, client_id: str, client_secret: str, verification_token: str, is_enabled: bool, landing_page_url: str=None, signing_secret: str=None, **kwargs) -> None:
