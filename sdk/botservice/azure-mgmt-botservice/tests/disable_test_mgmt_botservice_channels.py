...
class BotServiceChannelsTestCase(AzureMgmtTestCase):
    ...
    def validateCreateGetAndDeleteChannel(self, channel_name, channel_properties, run_exist_check=True, validate=None):
        ...
        channel = self.client.channels.get(
            resource_group_name=self.resource_group_name, resource_name=self.resource_name, channel_name=channel_name
        )
    ...
    def test_email_channel(self, resource_group):
        ...
        channel = EmailChannel(
            properties=EmailChannelProperties(email_address="swagatm2@outlook.com", password="", is_enabled=True)
        )
    ...
    def test_sms_channel(self, resource_group):
        ...
        channel = SmsChannel(
            properties=SmsChannelProperties(
                phone="+15153258725", account_sid="", auth_token="", is_enabled=True, is_validated=False
            )
        )
    ...
    def test_msteams_channel(self, resource_group):
        ...
        self.validateCreateGetAndDeleteChannel(
            channel_name="MsTeamsChannel", channel_properties=channel, run_exist_check=False
        )
    ...
    def test_skype_channel(self, resource_group):
        ...
        self.validateCreateGetAndDeleteChannel(
            channel_name="SkypeChannel", channel_properties=channel, run_exist_check=False
        )
    ...
    def test_directline_channel(self, resource_group):
        ...
        channel = DirectLineChannel(
            properties=DirectLineChannelProperties(
                sites=[DirectLineSite(site_name="default", is_enabled=True, is_v1_enabled=False, is_v3_enabled=True)]
            )
        )

        self.validateCreateGetAndDeleteChannel(
            channel_name="DirectLineChannel", channel_properties=channel, validate=validate_directline
        )
