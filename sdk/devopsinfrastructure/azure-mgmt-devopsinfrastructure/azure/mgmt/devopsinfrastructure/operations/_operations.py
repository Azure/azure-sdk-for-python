...
def build_pools_delete_resources_request(
    resource_group_name: str, pool_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PoolsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type pool_name: str
        :param resource: Resource create parameters. Required.
        :type resource: ~azure.mgmt.devopsinfrastructure.types.Pool
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns Pool. The Pool is compatible with MutableMapping
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a Pool type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.devopsinfrastructure.models.Pool or
         ~azure.mgmt.devopsinfrastructure.types.Pool or IO[bytes]
        :return: An instance of LROPoller that returns Pool. The Pool is compatible with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.devopsinfrastructure.models.Pool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        pool_name: str,
        properties: Union[_models.PoolUpdate, _types.PoolUpdate, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type pool_name: str
        :param properties: The resource properties to be updated. Required.
        :type properties: ~azure.mgmt.devopsinfrastructure.types.PoolUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns Pool. The Pool is compatible with MutableMapping
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.devopsinfrastructure.models.PoolUpdate or
         ~azure.mgmt.devopsinfrastructure.types.PoolUpdate or IO[bytes]
        :return: An instance of LROPoller that returns Pool. The Pool is compatible with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.devopsinfrastructure.models.Pool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.Pool"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.Pool"]:
    ...
    @overload
    def check_name_availability(
        self, body: _types.CheckNameAvailability, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.CheckNameAvailabilityResult:
        """Checks that the pool name is valid and is not already in use.

        :param body: The CheckAvailability request. Required.
        :type body: ~azure.mgmt.devopsinfrastructure.types.CheckNameAvailability
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: CheckNameAvailabilityResult. The CheckNameAvailabilityResult is compatible with
    ...
    @distributed_trace
    def check_name_availability(
        self, body: Union[_models.CheckNameAvailability, _types.CheckNameAvailability, IO[bytes]], **kwargs: Any
    ) -> _models.CheckNameAvailabilityResult:
        """Checks that the pool name is valid and is not already in use.

        :param body: The CheckAvailability request. Is either a CheckNameAvailability type or a
         IO[bytes] type. Required.
        :type body: ~azure.mgmt.devopsinfrastructure.models.CheckNameAvailability or
         ~azure.mgmt.devopsinfrastructure.types.CheckNameAvailability or IO[bytes]
        :return: CheckNameAvailabilityResult. The CheckNameAvailabilityResult is compatible with
         MutableMapping
        :rtype: ~azure.mgmt.devopsinfrastructure.models.CheckNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def delete_resources(
        ...
        resource_group_name: str,
        pool_name: str,
        body: _models.DeleteResourcesDetails,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> None:
        ...
        :type body: ~azure.mgmt.devopsinfrastructure.models.DeleteResourcesDetails
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    def delete_resources(
        ...
        resource_group_name: str,
        pool_name: str,
        body: _types.DeleteResourcesDetails,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> None:
        ...
        :type pool_name: str
        :param body: The content of the action request. Required.
        :type body: ~azure.mgmt.devopsinfrastructure.types.DeleteResourcesDetails
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    @api_version_validation(
        method_added_on="2025-09-20",
        params_added_on={
            "2025-09-20": ["api_version", "subscription_id", "resource_group_name", "pool_name", "content_type"]
        },
        api_versions_list=["2025-09-20", "2026-04-17-preview", "2026-06-02", "2026-07-03-preview"],
    )
    def delete_resources(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        pool_name: str,
        body: Union[_models.DeleteResourcesDetails, _types.DeleteResourcesDetails, IO[bytes]],
        **kwargs: Any
    ) -> None:
        """A synchronous resource action.
        ...
        :param pool_name: Name of the pool. It needs to be globally unique. Required.
        :type pool_name: str
        :param body: The content of the action request. Is either a DeleteResourcesDetails type or a
         IO[bytes] type. Required.
        :type body: ~azure.mgmt.devopsinfrastructure.models.DeleteResourcesDetails or
         ~azure.mgmt.devopsinfrastructure.types.DeleteResourcesDetails or IO[bytes]
        :return: None
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _request = build_pools_delete_resources_request(
            resource_group_name=resource_group_name,
            pool_name=pool_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
...
class ResourceDetailsOperations:
    ...
    def list_by_pool(
    ...
    ) -> ItemPaged["_models.ResourceDetailsObject"]:
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(
                List[_models.ResourceDetailsObject],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
...
class SubscriptionUsagesOperations:
    ...
    @distributed_trace
    def usages(self, location: str, **kwargs: Any) -> ItemPaged["_models.Quota"]:
