...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DevOpsInfrastructure/pools")
...
def build_get_request(resource_group_name: str, pool_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "poolName": _SERIALIZER.url("pool_name", pool_name, "str", pattern=r"^[a-zA-Z0-9][a-zA-Z0-9-.]*$"),
    }
