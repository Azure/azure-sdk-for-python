...
def build_list_operations_request(
    **kwargs: Any
    ...
    api_version = kwargs.pop('api_version', "2021-08-15")  # type: str
    ...
    def list_operations(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either CustomLocationOperationsList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.extendedlocation.v2021_08_15.models.CustomLocationOperationsList]
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either CustomLocationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.extendedlocation.v2021_08_15.models.CustomLocationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-08-15")  # type: str
    ...
    def list_enabled_resource_types(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either EnabledResourceTypesListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.extendedlocation.v2021_08_15.models.EnabledResourceTypesListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-08-15")  # type: str
