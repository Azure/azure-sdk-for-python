...
class CustomLocationsOperations:
    ...
    def list_operations(self, **kwargs: Any) -> Iterable["_models.CustomLocationOperation"]:
        ...
        :return: An iterator like instance of either CustomLocationOperation or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.extendedlocation.v2021_08_31_preview.models.CustomLocationOperation]
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.CustomLocation"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.extendedlocation.v2021_08_31_preview.models.CustomLocation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.extendedlocation.v2021_08_31_preview.models.CustomLocation or IO
    ...
    def list_enabled_resource_types(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.extendedlocation.v2021_08_31_preview.models.EnabledResourceType]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def find_target_resource_group(
        ...
        resource_group_name: str,
        resource_name: str,
        parameters: Union[_models.CustomLocationFindTargetResourceGroupProperties, IO],
        **kwargs: Any
    ) -> Optional[_models.CustomLocationFindTargetResourceGroupResult]:
        """Gets matching target resource group for resource sync.
    ...
    find_target_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ExtendedLocation/customLocations/{resourceName}/findTargetResourceGroup"
    }
