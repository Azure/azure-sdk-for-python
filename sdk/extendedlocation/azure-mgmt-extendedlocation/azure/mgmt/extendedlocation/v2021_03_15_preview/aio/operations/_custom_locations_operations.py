...
from ...operations._custom_locations_operations import (
    build_create_or_update_request,
    build_delete_request,
    build_get_request,
    build_list_by_resource_group_request,
    build_list_by_subscription_request,
    build_list_enabled_resource_types_request,
...
class CustomLocationsOperations:
    ...
    @distributed_trace
    def list_operations(self, **kwargs: Any) -> AsyncIterable["_models.CustomLocationOperation"]:
        ...
        :return: An iterator like instance of either CustomLocationOperation or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.extendedlocation.v2021_03_15_preview.models.CustomLocationOperation]
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.CustomLocation"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.extendedlocation.v2021_03_15_preview.models.CustomLocation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    ) -> AsyncIterable["_models.CustomLocation"]:
    ...
    def list_enabled_resource_types(
        self, resource_group_name: str, resource_name: str, **kwargs: Any
    ) -> AsyncIterable["_models.EnabledResourceType"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.extendedlocation.v2021_03_15_preview.models.EnabledResourceType]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
