...
class ChildConfigurationType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class FulfillmentType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    EXTERNAL = "External"
    """The fulfillment (the whole journey of the product offering) is handled by external third party
    #: entities."""


class IdentificationType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class OrderMode(str, Enum, metaclass=CaseInsensitiveEnumMeta):
