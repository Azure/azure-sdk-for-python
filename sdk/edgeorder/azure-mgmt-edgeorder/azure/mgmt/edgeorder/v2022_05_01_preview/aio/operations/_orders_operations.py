...
class OrdersOperations:
    ...
    def list_by_subscription(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.edgeorder.v2022_05_01_preview.models.OrderResource]
    ...
    list_by_subscription.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.EdgeOrder/orders"}
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.edgeorder.v2022_05_01_preview.models.OrderResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
