...
from ...operations._addresses_operations import (
...
class AddressesOperations:
    ...
    def list_by_subscription(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.edgeorder.v2022_05_01_preview.models.AddressResource]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either AddressResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.edgeorder.v2022_05_01_preview.models.AddressResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
