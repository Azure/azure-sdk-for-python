...
class TestEdgeOrderManagementOrderItemsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(EdgeOrderManagementClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_items_get(self, resource_group):
        response = self.client.order_items.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_items_begin_create(self, resource_group):
        response = self.client.order_items.begin_create(
            resource_group_name=resource_group.name,
            order_item_name="str",
            order_item_resource={
                "location": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_items_begin_update(self, resource_group):
        response = self.client.order_items.begin_update(
            resource_group_name=resource_group.name,
            order_item_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_items_begin_delete(self, resource_group):
        response = self.client.order_items.begin_delete(
            resource_group_name=resource_group.name,
            order_item_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_items_list_by_resource_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_items_list_by_subscription(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_items_cancel(self, resource_group):
        response = self.client.order_items.cancel(
            resource_group_name=resource_group.name,
            order_item_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_order_items_begin_return_method(self, resource_group):
        response = self.client.order_items.begin_return_method(
            resource_group_name=resource_group.name,
            order_item_name="str",
