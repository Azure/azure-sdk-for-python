...
# USAGE
    python list_product_families.py
...
def main():
    ...
    response = client.products_and_configurations.list_product_families(
        product_families_request={
            "filterableProperties": {"azurestackedge": [{"supportedValues": ["US"], "type": "ShipToCountries"}]}
        },
    )
