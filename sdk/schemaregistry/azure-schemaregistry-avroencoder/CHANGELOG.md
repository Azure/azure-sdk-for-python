...
- `SchemaParseError`, `SchemaEncodeError`, and `SchemaDecodeError` have been replaced with a single `AvroEncodeError` type, which has been moved under the `azure.schemaregistry.encoder.avroencoder` namespace.
