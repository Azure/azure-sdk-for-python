...
class SchemaRegistryClientOperationsMixin(SchemaRegistryClientMixinABC):
    ...
    @distributed_trace
    def list_schema_groups(self, **kwargs: Any) -> AsyncIterable["_models.SchemaGroup"]:
    ...
    @distributed_trace
    def list_schema_versions(self, group_name: str, name: str, **kwargs: Any) -> AsyncIterable["_models.Version"]:
