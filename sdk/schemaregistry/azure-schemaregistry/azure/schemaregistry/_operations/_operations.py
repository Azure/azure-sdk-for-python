...
def build_schema_registry_list_schema_groups_request(**kwargs: Any) -> HttpRequest:
...
def build_schema_registry_get_schema_by_id_request(id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_schema_registry_list_schema_versions_request(group_name: str, name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_schema_registry_get_schema_by_version_request(
    group_name: str, name: str, schema_version: int, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class SchemaRegistryClientOperationsMixin(SchemaRegistryClientMixinABC):
    ...
    @distributed_trace
    def list_schema_groups(self, **kwargs: Any) -> Iterable["_models.SchemaGroup"]:
    ...
    @distributed_trace
    def get_schema_by_id(self, id: str, **kwargs: Any) -> bytes:
    ...
    @distributed_trace
    def list_schema_versions(self, group_name: str, name: str, **kwargs: Any) -> Iterable["_models.Version"]:
        ...
        cls: ClsType[List[_models.Version]] = kwargs.pop("cls", None)
    ...
    @distributed_trace
    def get_schema_by_version(self, group_name: str, name: str, schema_version: int, **kwargs: Any) -> bytes:
