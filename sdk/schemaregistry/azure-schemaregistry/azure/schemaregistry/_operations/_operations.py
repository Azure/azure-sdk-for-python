...
def build_schema_registry_list_schema_groups_request(  # pylint: disable=name-too-long
    **kwargs: Any,
) -> HttpRequest:
...
class SchemaRegistryClientOperationsMixin(  # pylint: disable=abstract-class-instantiated
    ...
    def list_schema_groups(self, **kwargs: Any) -> Iterable["_models.SchemaGroup"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request.url = self._client.format_url(
                    request.url, **path_format_arguments
                )
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(
                List[_models.SchemaGroup], deserialized["value"]
            )
            if cls:
    ...
    def list_schema_versions(
        self, group_name: str, name: str, **kwargs: Any
    ...
    def get_schema_by_version(
        self, group_name: str, name: str, schema_version: int, **kwargs: Any
    ) -> bytes:
