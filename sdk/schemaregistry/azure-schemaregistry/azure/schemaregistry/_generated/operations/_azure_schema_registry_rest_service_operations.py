...
class AzureSchemaRegistryRestServiceOperationsMixin(object):
    ...
    def get_id_by_schema_content(
        self,
        group_name,  # type: str
        schema_name,  # type: str
        x_schema_type,  # type: str
        body,  # type: str
        **kwargs  # type: Any
    ):
