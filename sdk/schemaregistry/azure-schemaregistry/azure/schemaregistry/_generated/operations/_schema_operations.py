...
class SchemaOperations(object):
    ...
    def get_by_id(
        ...
        **kwargs  # type: Any
        ...
        response_headers['Serialization-Type']=self._deserialize('str', response.headers.get('Serialization-Type'))
    ...
    def query_id_by_content(
        ...
        serialization_type,  # type: Union[str, "models.SerializationTypeAutoGenerated"]
        ...
        **kwargs  # type: Any
        ...
        :type serialization_type: str or ~azure.schemaregistry._generated.models.SerializationTypeAutoGenerated
        :param schema_content: String representation (UTF-8) of the registered schema.
    ...
    def register(
        ...
        **kwargs  # type: Any
        ...
        :param serialization_type: Serialization type for the schema being registered.
        :type serialization_type: str or ~azure.schemaregistry._generated.models.SerializationTypeAutoGenerated
        :param schema_content: String representation (UTF-8) of the schema being registered.
        :type schema_content: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SchemaId, or the result of cls(response)
        :rtype: ~azure.schemaregistry._generated.models.SchemaId
