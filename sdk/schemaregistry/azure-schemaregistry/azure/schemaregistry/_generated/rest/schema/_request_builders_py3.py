...
def build_get_versions_request(group_name: str, schema_name: str, **kwargs: Any) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "schemaName": _SERIALIZER.url(
            "schema_name", schema_name, "str", max_length=50, min_length=0, pattern=r"^[A-Za-z0-9][^\\/$:]*$"
        ),
    }
...
def build_query_id_by_content_request(group_name: str, schema_name: str, *, content: Any, **kwargs: Any) -> HttpRequest:
...
def build_register_request(group_name: str, schema_name: str, *, content: Any, **kwargs: Any) -> HttpRequest:
    """Register new schema.
