...
def build_query_id_by_content_request(
    ...
    **kwargs  # type: Any
    ...
    :keyword serialization_type: Serialization type for the schema being registered.
    :paramtype serialization_type: str or
     ~azure.schemaregistry._generated.models.SerializationTypeAutoGenerated
    :return: Returns an :class:`~azure.core.rest.HttpRequest` that you will pass to the client's
     `send_request` method. See https://aka.ms/azsdk/python/protocol/quickstart for how to
     incorporate this response into your code flow.
    :rtype: ~azure.core.rest.HttpRequest
    ...
    serialization_type = kwargs.pop('serialization_type')  # type: Union[str, "_models.SerializationTypeAutoGenerated"]
