...
class Assignment(TrackedResource):
    ...
    def __init__(self, *, location: str, identity, parameters, resource_groups, display_name: str=None, description: str=None, blueprint_id: str=None, scope: str=None, locks=None, **kwargs) -> None:
...
class AssignmentLockSettings(Model):
    ...
    def __init__(self, *, mode=None, excluded_principals=None, excluded_actions=None, **kwargs) -> None:
