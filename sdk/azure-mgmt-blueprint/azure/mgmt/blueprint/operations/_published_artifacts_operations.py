...
class PublishedArtifactsOperations(object):
    ...
    def get(
            self, resource_scope, blueprint_name, version_id, artifact_name, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    get.metadata = {'url': '/{resourceScope}/providers/Microsoft.Blueprint/blueprints/{blueprintName}/versions/{versionId}/artifacts/{artifactName}'}
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/{resourceScope}/providers/Microsoft.Blueprint/blueprints/{blueprintName}/versions/{versionId}/artifacts'}
