...
class AssignmentsOperations(object):
    ...
    def create_or_update(
            self, resource_scope, assignment_name, assignment, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    create_or_update.metadata = {'url': '/{resourceScope}/providers/Microsoft.Blueprint/blueprintAssignments/{assignmentName}'}

    def get(
            self, resource_scope, assignment_name, custom_headers=None, raw=False, **operation_config):
    ...
    def delete(
            self, resource_scope, assignment_name, delete_behavior=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param assignment_name: Name of the blueprint assignment.
        :type assignment_name: str
        :param delete_behavior: When deleteBehavior=all, the resources that
         were created by the blueprint assignment will be deleted. Possible
         values include: 'none', 'all'
        :type delete_behavior: str or
         ~azure.mgmt.blueprint.models.AssignmentDeleteBehavior
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def who_is_blueprint(
        ...
        return deserialized
    who_is_blueprint.metadata = {'url': '/{resourceScope}/providers/Microsoft.Blueprint/blueprintAssignments/{assignmentName}/whoIsBlueprint'}

    def list(
            self, resource_scope, custom_headers=None, raw=False, **operation_config):
