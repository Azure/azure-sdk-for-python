...
class WeightsAndBiasesMgmtClient:
    ...
    :vartype operations: azure.mgmt.weightsandbiases.aio.operations.Operations
    :ivar instances: InstancesOperations operations
    :vartype instances: azure.mgmt.weightsandbiases.aio.operations.InstancesOperations
