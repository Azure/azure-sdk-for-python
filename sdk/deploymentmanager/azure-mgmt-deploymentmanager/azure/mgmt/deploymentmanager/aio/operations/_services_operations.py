...
class ServicesOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param service_info: The service object. Required.
    ...
    async def create_or_update(
        ...
        service_topology_name: str,
        service_name: str,
        service_info: Union[_models.ServiceResource, IO],
        **kwargs: Any
    ) -> _models.ServiceResource:
        """Creates or updates a service in the service topology.
        ...
        :param service_name: The name of the service resource. Required.
        :type service_name: str
        :param service_info: The service object. Is either a model type or a IO type. Required.
        :type service_info: ~azure.mgmt.deploymentmanager.models.ServiceResource or IO
        ...
        _json = None
        _content = None
        if isinstance(service_info, (IO, bytes)):
            _content = service_info
        else:
            _json = self._serialize.body(service_info, "ServiceResource")
