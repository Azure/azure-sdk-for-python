...
class RestRequestAuthentication(Model):
    ...
    :ivar type: Required. The authentication type. ApiKey authentication gives
     a name and a value that can be included in either the request header or
     query parameters. Default value: "ApiKey" .
    :vartype type: str
