...
def build_create_or_update_request(
    resource_group_name: str, artifact_source_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class ArtifactSourcesOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, artifact_source_name: str, **kwargs: Any) -> _models.ArtifactSource:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> List[_models.ArtifactSource]:
