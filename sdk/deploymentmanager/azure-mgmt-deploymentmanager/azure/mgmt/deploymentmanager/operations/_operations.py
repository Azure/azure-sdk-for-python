...
def build_list_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.DeploymentManager/operations")
...
class Operations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> _models.OperationsList:
        """Lists the supported operations.

        Lists the supported operations.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: OperationsList or the result of cls(response)
        :rtype: ~azure.mgmt.deploymentmanager.models.OperationsList
