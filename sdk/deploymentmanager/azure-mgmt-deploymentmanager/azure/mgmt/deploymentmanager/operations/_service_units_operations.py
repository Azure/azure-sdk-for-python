...
def build_list_request(
    resource_group_name: str, service_topology_name: str, service_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ServiceUnitsOperations:
    ...
    def _create_or_update_initial(
        ...
        service_name: str,
        service_unit_name: str,
        service_unit_info: Union[_models.ServiceUnitResource, IO],
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(service_unit_info, (IO, bytes)):
            _content = service_unit_info
        else:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param service_unit_name: The name of the service unit resource. Required.
        :type service_unit_name: str
        :param service_unit_info: The service unit resource object. Required.
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param service_unit_name: The name of the service unit resource. Required.
        :type service_unit_name: str
        :param service_unit_info: The service unit resource object. Is either a model type or a IO
         type. Required.
        :type service_unit_info: ~azure.mgmt.deploymentmanager.models.ServiceUnitResource or IO
    ...
    @distributed_trace
    def list(
        self, resource_group_name: str, service_topology_name: str, service_name: str, **kwargs: Any
