...
class PeeringLocationsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.peering.models.PeeringLocationPaged[~azure.mgmt.peering.models.PeeringLocation]
        :raises:
        ...
        deserialized = models.PeeringLocationPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.PeeringLocationPaged(internal_paging, self._deserialize.dependencies, header_dict)
