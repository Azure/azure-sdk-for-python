...
def build_list_request(location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.StoragePool/locations/{location}/skus"
...
class ResourceSkusOperations:
    ...
    @distributed_trace
    def list(self, location: str, **kwargs: Any) -> Iterable["_models.ResourceSkuInfo"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storagepool.models.ResourceSkuInfo]
