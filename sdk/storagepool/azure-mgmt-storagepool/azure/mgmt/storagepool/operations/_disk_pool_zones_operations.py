...
class DiskPoolZonesOperations:
    ...
    @distributed_trace
    def list(self, location: str, **kwargs: Any) -> Iterable["_models.DiskPoolZoneInfo"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storagepool.models.DiskPoolZoneInfo]
