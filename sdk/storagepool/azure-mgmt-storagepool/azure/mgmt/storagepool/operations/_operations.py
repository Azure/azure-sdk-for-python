...
def build_list_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.StoragePool/operations")
...
class Operations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.StoragePoolRPOperation"]:
        """Gets a list of StoragePool operations.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either StoragePoolRPOperation or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storagepool.models.StoragePoolRPOperation]
