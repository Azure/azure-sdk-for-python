...
def build_list_by_disk_pool_request(
...
def build_create_or_update_request(
    resource_group_name: str, disk_pool_name: str, iscsi_target_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "diskPoolName": _SERIALIZER.url("disk_pool_name", disk_pool_name, "str"),
        "iscsiTargetName": _SERIALIZER.url("iscsi_target_name", iscsi_target_name, "str"),
    }
...
class IscsiTargetsOperations:
    ...
    def list_by_disk_pool(
        ...
        :return: An iterator like instance of either IscsiTarget or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storagepool.models.IscsiTarget]
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.IscsiTargetList]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_disk_pool_request(
                    resource_group_name=resource_group_name,
                    disk_pool_name=disk_pool_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
                    template_url=self.list_by_disk_pool.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
    ...
    def _create_or_update_initial(
        ...
        iscsi_target_create_payload: Union[_models.IscsiTargetCreate, IO],
        **kwargs: Any
    ) -> _models.IscsiTarget:
        error_map = {
            401: ClientAuthenticationError,
        ...
        content_type = kwargs.pop("content_type", _headers.pop("Content-Type", None))  # type: Optional[str]
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.IscsiTarget]

        content_type = content_type or "application/json"
        _json = None
        _content = None
        if isinstance(iscsi_target_create_payload, (IO, bytes)):
            _content = iscsi_target_create_payload
        else:
            _json = self._serialize.body(iscsi_target_create_payload, "IscsiTargetCreate")
    ...
    def begin_create_or_update(
        ...
        disk_pool_name: str,
        iscsi_target_name: str,
        iscsi_target_create_payload: _models.IscsiTargetCreate,
        *,
        ...
        **kwargs: Any
        ...
        :param disk_pool_name: The name of the Disk Pool. Required.
        :type disk_pool_name: str
        :param iscsi_target_name: The name of the iSCSI Target. Required.
        :type iscsi_target_name: str
        :param iscsi_target_create_payload: Request payload for iSCSI Target create operation.
         Required.
        :type iscsi_target_create_payload: ~azure.mgmt.storagepool.models.IscsiTargetCreate
        ...
        :return: An instance of LROPoller that returns either IscsiTarget or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.storagepool.models.IscsiTarget]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param iscsi_target_create_payload: Request payload for iSCSI Target create operation.
         Required.
        :type iscsi_target_create_payload: IO
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param iscsi_target_name: The name of the iSCSI Target. Required.
        :type iscsi_target_name: str
        :param iscsi_target_create_payload: Request payload for iSCSI Target create operation. Is
         either a model type or a IO type. Required.
        :type iscsi_target_create_payload: ~azure.mgmt.storagepool.models.IscsiTargetCreate or IO
    ...
    def _update_initial(
        ...
        disk_pool_name: str,
        iscsi_target_name: str,
        iscsi_target_update_payload: Union[_models.IscsiTargetUpdate, IO],
        **kwargs: Any
    ) -> Optional[_models.IscsiTarget]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        content_type = kwargs.pop("content_type", _headers.pop("Content-Type", None))  # type: Optional[str]
        cls = kwargs.pop("cls", None)  # type: ClsType[Optional[_models.IscsiTarget]]

        content_type = content_type or "application/json"
        _json = None
        _content = None
        if isinstance(iscsi_target_update_payload, (IO, bytes)):
            _content = iscsi_target_update_payload
        else:
            _json = self._serialize.body(iscsi_target_update_payload, "IscsiTargetUpdate")
    ...
    def begin_update(
        ...
        disk_pool_name: str,
        iscsi_target_name: str,
        iscsi_target_update_payload: _models.IscsiTargetUpdate,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.IscsiTarget]:
        ...
        :param iscsi_target_update_payload: Request payload for iSCSI Target update operation.
         Required.
        :type iscsi_target_update_payload: ~azure.mgmt.storagepool.models.IscsiTargetUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param iscsi_target_update_payload: Request payload for iSCSI Target update operation.
         Required.
        :type iscsi_target_update_payload: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param iscsi_target_name: The name of the iSCSI Target. Required.
        :type iscsi_target_name: str
        :param iscsi_target_update_payload: Request payload for iSCSI Target update operation. Is
         either a model type or a IO type. Required.
        :type iscsi_target_update_payload: ~azure.mgmt.storagepool.models.IscsiTargetUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, disk_pool_name: str, iscsi_target_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.storagepool.models.IscsiTarget
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
