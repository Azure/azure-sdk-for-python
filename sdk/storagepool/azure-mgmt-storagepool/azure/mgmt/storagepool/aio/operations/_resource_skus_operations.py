...
class ResourceSkusOperations:
    ...
    @distributed_trace
    def list(self, location: str, **kwargs: Any) -> AsyncIterable["_models.ResourceSkuInfo"]:
        ...
        :return: An iterator like instance of either ResourceSkuInfo or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storagepool.models.ResourceSkuInfo]
