...
# USAGE
    python akri_connector_create_or_update_maximum_set_gen.py
...
def main():
    ...
    response = client.akri_connector.begin_create_or_update(
...
# x-ms-original-file: 2026-03-01/AkriConnector_CreateOrUpdate_MaximumSet_Gen.json
