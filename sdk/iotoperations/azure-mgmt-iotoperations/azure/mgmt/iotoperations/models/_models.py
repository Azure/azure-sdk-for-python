...
class AdrProperties(_model_base.Model):
    """The properties of an ADR instance.


    :ivar state: This determines if the ADR service is enabled. Required. Known values are:
     "Enabled" and "Disabled".
    :vartype state: str or ~azure.mgmt.iotoperations.models.OperationalMode
    """

    state: Union[str, "_models.OperationalMode"] = rest_field(visibility=["read", "create"])
    """This determines if the ADR service is enabled. Required. Known values are: \"Enabled\" and
     \"Disabled\"."""
    ...
    def __init__(
        self,
        *,
        state: Union[str, "_models.OperationalMode"],
    ): ...
...
class AkriInstanceProperties(_model_base.Model):
    """The properties of an AKRI instance.


    :ivar state: This determines if the AKRI service is enabled. Required. Known values are:
     "Enabled" and "Disabled".
    :vartype state: str or ~azure.mgmt.iotoperations.models.OperationalMode
    """

    state: Union[str, "_models.OperationalMode"] = rest_field(visibility=["read", "create"])
    """This determines if the AKRI service is enabled. Required. Known values are: \"Enabled\" and
     \"Disabled\"."""
...
class Components(_model_base.Model):
    """The configuration for components of the AIO Instance.

    :ivar adr: The properties of the ADR instance.
    :vartype adr: ~azure.mgmt.iotoperations.models.AdrProperties
    :ivar akri: The properties of the AKRI instance.
    :vartype akri: ~azure.mgmt.iotoperations.models.AkriInstanceProperties
    :ivar connectors: The properties of the connectors instance.
    :vartype connectors: ~azure.mgmt.iotoperations.models.ConnectorInstanceProperties
    :ivar dataflows: The properties of the dataflows instance.
    :vartype dataflows: ~azure.mgmt.iotoperations.models.DataflowInstanceProperties
    :ivar schema_registry: The properties of the device provisioning instance.
    :vartype schema_registry: ~azure.mgmt.iotoperations.models.SchemaRegistryInstanceProperties
    """

    adr: Optional["_models.AdrProperties"] = rest_field()
    """The properties of the ADR instance."""
    akri: Optional["_models.AkriInstanceProperties"] = rest_field()
    """The properties of the AKRI instance."""
    connectors: Optional["_models.ConnectorInstanceProperties"] = rest_field()
    """The properties of the connectors instance."""
    dataflows: Optional["_models.DataflowInstanceProperties"] = rest_field()
    """The properties of the dataflows instance."""
    schema_registry: Optional["_models.SchemaRegistryInstanceProperties"] = rest_field(name="schemaRegistry")
    ...
    def __init__(
        self,
        *,
        adr: Optional["_models.AdrProperties"] = None,
        akri: Optional["_models.AkriInstanceProperties"] = None,
        connectors: Optional["_models.ConnectorInstanceProperties"] = None,
        dataflows: Optional["_models.DataflowInstanceProperties"] = None,
        schema_registry: Optional["_models.SchemaRegistryInstanceProperties"] = None,
    ): ...
...
class ConnectorInstanceProperties(_model_base.Model):
    """The properties of a  Connector instance.


    :ivar state: This determines if the Connector service is enabled. Required. Known values are:
     "Enabled" and "Disabled".
    :vartype state: str or ~azure.mgmt.iotoperations.models.OperationalMode
    """

    state: Union[str, "_models.OperationalMode"] = rest_field(visibility=["read", "create"])
    """This determines if the Connector service is enabled. Required. Known values are: \"Enabled\"
     and \"Disabled\"."""
...
class DataflowEndpointMqtt(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar authentication: authentication properties. DEFAULT: kubernetes.audience=aio-mq-internal.
    ...
    """authentication properties. DEFAULT: kubernetes.audience=aio-mq-internal. NOTE - Enum field only
...
class DataflowEndpointMqttAuthentication(_model_base.Model):
    ...
    :ivar service_account_token_settings: Kubernetes service account token authentication. Default
     audience if not set is aio-mq-internal.
    :vartype service_account_token_settings:
    ...
    """Kubernetes service account token authentication. Default audience if not set is
     aio-mq-internal."""
    x509_certificate_settings: Optional["_models.DataflowEndpointAuthenticationX509"] = rest_field(
        name="x509CertificateSettings"
    )
...
class DataflowInstanceProperties(_model_base.Model):
    """The properties of an Dataflow instance.


    :ivar state: This determines if the Dataflow service is enabled. Required. Known values are:
     "Enabled" and "Disabled".
    :vartype state: str or ~azure.mgmt.iotoperations.models.OperationalMode
    """

    state: Union[str, "_models.OperationalMode"] = rest_field(visibility=["read", "create"])
    """This determines if the Dataflow service is enabled. Required. Known values are: \"Enabled\" and
     \"Disabled\"."""
...
class DiagnosticsLogs(_model_base.Model):
    ...
    :ivar opentelemetry_export_config: The open telemetry export configuration.
    :vartype opentelemetry_export_config:
     ~azure.mgmt.iotoperations.models.OpenTelemetryLogExportConfig
    :ivar level: The log level. Examples - 'debug', 'info', 'warn', 'error', 'trace'.
    :vartype level: str
    """

    opentelemetry_export_config: Optional["_models.OpenTelemetryLogExportConfig"] = rest_field(
    ...
    def __init__(
        self,
        *,
        opentelemetry_export_config: Optional["_models.OpenTelemetryLogExportConfig"] = None,
...
class InstanceProperties(_model_base.Model):
    ...
    :vartype version: str
    :ivar schema_registry_namespace: The reference to the Schema Registry for this AIO Instance.
     Required.
    :vartype schema_registry_namespace: str
    :ivar components: The configuration for components of the AIO Instance.
    :vartype components: ~azure.mgmt.iotoperations.models.Components
    """
    ...
    schema_registry_namespace: str = rest_field(name="schemaRegistryNamespace")
    """The reference to the Schema Registry for this AIO Instance. Required."""
    components: Optional["_models.Components"] = rest_field()
    """The configuration for components of the AIO Instance."""
    ...
    def __init__(
        ...
        *,
        ...
        description: Optional[str] = None,
        components: Optional["_models.Components"] = None,
    ): ...
...
class Metrics(_model_base.Model):
    ...
    :ivar opentelemetry_export_config: The open telemetry export configuration.
    :vartype opentelemetry_export_config:
     ~azure.mgmt.iotoperations.models.OpenTelemetryExportConfig
    :ivar prometheus_port: The prometheus port to expose the metrics.
    :vartype prometheus_port: int
    """

    opentelemetry_export_config: Optional["_models.OpenTelemetryExportConfig"] = rest_field(
        name="opentelemetryExportConfig"
    )
    """The open telemetry export configuration."""
    ...
    def __init__(
        self,
        *,
        opentelemetry_export_config: Optional["_models.OpenTelemetryExportConfig"] = None,
...
class OpenTelemetryExportConfig(_model_base.Model):
    """OpenTelemetry Export Configuration properties.


    :ivar otlp_grpc_endpoint: The open telemetry collector endpoint to export to. Required.
    :vartype otlp_grpc_endpoint: str
    :ivar interval_seconds: How often to export the metrics to the open telemetry collector.
    :vartype interval_seconds: int
    """

    otlp_grpc_endpoint: str = rest_field(name="otlpGrpcEndpoint")
    """The open telemetry collector endpoint to export to. Required."""
...
class OpenTelemetryLogExportConfig(_model_base.Model):
...
class SchemaRegistryInstanceProperties(_model_base.Model):
    """The properties of a Schema Registry instance.


    :ivar state: This determines if the Schema Registry service is enabled. Required. Known values
     are: "Enabled" and "Disabled".
    :vartype state: str or ~azure.mgmt.iotoperations.models.OperationalMode
    """

    state: Union[str, "_models.OperationalMode"] = rest_field(visibility=["read", "create"])
    """This determines if the Schema Registry service is enabled. Required. Known values are:
     \"Enabled\" and \"Disabled\"."""
