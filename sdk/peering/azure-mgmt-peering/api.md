...
namespace azure.mgmt.peering.types

    class azure.mgmt.peering.types.BgpSession(TypedDict, total=False):
        key "maxPrefixesAdvertisedV4": int
        key "maxPrefixesAdvertisedV6": int
        key "md5AuthenticationKey": str
        key "microsoftSessionIPv4Address": str
        key "microsoftSessionIPv6Address": str
        key "peerSessionIPv4Address": str
        key "peerSessionIPv6Address": str
        key "sessionPrefixV4": str
        key "sessionPrefixV6": str
        key "sessionStateV4": Union[str, SessionStateV4]
        key "sessionStateV6": Union[str, SessionStateV6]
        ...
        session_state_v4: Union[str, SessionStateV4]
        session_state_v6: Union[str, SessionStateV6]


    class azure.mgmt.peering.types.CdnPeeringPrefix(Resource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('CdnPeeringPrefixProperties', module='types')
    ...
    class azure.mgmt.peering.types.CdnPeeringPrefixProperties(TypedDict, total=False):
        key "azureRegion": str
        key "azureService": str
        key "bgpCommunity": str
        key "isPrimaryRegion": bool
        key "prefix": str
        azure_region: str
        azure_service: str
        bgp_community: str
    ...
    class azure.mgmt.peering.types.CheckServiceProviderAvailabilityInput(TypedDict, total=False):
        key "peeringServiceLocation": str
        key "peeringServiceProvider": str
        peering_service_location: str
        peering_service_provider: str


    class azure.mgmt.peering.types.ConnectionMonitorTest(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('ConnectionMonitorTestProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.peering.types.ConnectionMonitorTestProperties(TypedDict, total=False):
        key "destination": str
        key "destinationPort": int
        key "isTestSuccessful": bool
        key "provisioningState": Union[str, ProvisioningState]
        key "sourceAgent": str
        key "testFrequencyInSec": int
        destination: str
    ...
    class azure.mgmt.peering.types.ConnectivityProbe(TypedDict, total=False):
        key "azureRegion": str
        key "endpoint": str
        ...
        prefixes_to_accesslist: list[str]
        protocol: Union[str, Protocol]


    class azure.mgmt.peering.types.ContactDetail(TypedDict, total=False):
        key "email": str
        key "phone": str
    ...
    class azure.mgmt.peering.types.DirectConnection(TypedDict, total=False):
        key "bandwidthInMbps": int
        key "bgpSession": ForwardRef('BgpSession', module='types')
        key "connectionIdentifier": str
        key "connectionState": Union[str, ConnectionState]
        key "errorMessage": str
        key "microsoftTrackingId": str
        key "peeringDBFacilityId": int
        key "provisionedBandwidthInMbps": int
        key "sessionAddressProvider": Union[str, SessionAddressProvider]
        key "useForPeeringService": bool
        ...
        session_address_provider: Union[str, SessionAddressProvider]
        use_for_peering_service: bool


    class azure.mgmt.peering.types.DirectPeeringFacility(TypedDict, total=False):
        key "address": str
        key "directPeeringType": Union[str, DirectPeeringType]
        key "peeringDBFacilityId": int
        key "peeringDBFacilityLink": str
        address: str
        direct_peering_type: Union[str, DirectPeeringType]
        peering_db_facility_id: int
        peering_db_facility_link: str


    class azure.mgmt.peering.types.ErrorAdditionalInfo(TypedDict, total=False):
        key "info": Any
        key "type": str
        info: Any
        type: str
    ...
    class azure.mgmt.peering.types.ErrorDetail(TypedDict, total=False):
        key "code": str
        key "message": str
        key "target": str
    ...
    class azure.mgmt.peering.types.ErrorResponse(TypedDict, total=False):
        key "error": ForwardRef('ErrorDetail', module='types')
        error: ErrorDetail


    class azure.mgmt.peering.types.ExchangeConnection(TypedDict, total=False):
        key "bgpSession": ForwardRef('BgpSession', module='types')
        key "connectionIdentifier": str
        key "connectionState": Union[str, ConnectionState]
        key "errorMessage": str
    ...
    class azure.mgmt.peering.types.ExchangePeeringFacility(TypedDict, total=False):
        key "bandwidthInMbps": int
        key "exchangeName": str
        key "facilityIPv4Prefix": str
        key "facilityIPv6Prefix": str
        key "microsoftIPv4Address": str
        key "microsoftIPv6Address": str
        key "peeringDBFacilityId": int
        key "peeringDBFacilityLink": str
        bandwidth_in_mbps: int
        exchange_name: str
        facility_i_pv4_prefix: str
        facility_i_pv6_prefix: str
        microsoft_i_pv4_address: str
        microsoft_i_pv6_address: str
        peering_db_facility_id: int
        peering_db_facility_link: str


    class azure.mgmt.peering.types.LogAnalyticsWorkspaceProperties(TypedDict, total=False):
        key "key": str
        key "workspaceID": str
    ...
    class azure.mgmt.peering.types.LookingGlassOutput(TypedDict, total=False):
        key "command": Union[str, Command]
        key "output": str
        command: Union[str, Command]
        output: str


    class azure.mgmt.peering.types.MetricDimension(TypedDict, total=False):
        key "displayName": str
        key "name": str
        display_name: str
        name: str
    ...
    class azure.mgmt.peering.types.MetricSpecification(TypedDict, total=False):
    ...
    class azure.mgmt.peering.types.Operation(TypedDict, total=False):
    ...
    class azure.mgmt.peering.types.OperationDisplayInfo(TypedDict, total=False):
        key "description": str
        key "operation": str
        key "provider": str
        key "resource": str
    ...
    class azure.mgmt.peering.types.OperationProperties(TypedDict, total=False):
        key "serviceSpecification": ForwardRef('ServiceSpecification', module='types')
        service_specification: ServiceSpecification


    class azure.mgmt.peering.types.PeerAsn(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('PeerAsnProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.peering.types.PeerAsnProperties(TypedDict, total=False):
        key "errorMessage": str
        key "peerAsn": int
        key "peerName": str
        key "validationState": Union[str, ValidationState]
        error_message: str
        peerContactDetail: list[ContactDetail]
        peer_asn: int
        peer_contact_detail: list[ContactDetail]
        peer_name: str
        validation_state: Union[str, ValidationState]


    class azure.mgmt.peering.types.Peering(TrackedResource):
        key "id": str
        key "kind": Required[Union[str, Kind]]
        key "location": Required[str]
        key "name": str
        key "properties": ForwardRef('PeeringProperties', module='types')
        key "sku": Required[PeeringSku]
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        kind: Union[str, Kind]
    ...
    class azure.mgmt.peering.types.PeeringBandwidthOffer(TypedDict, total=False):
        key "offerName": str
        key "valueInMbps": int
        offer_name: str
        value_in_mbps: int
    ...
    class azure.mgmt.peering.types.PeeringLocation(Resource):
        key "id": str
        key "kind": Union[str, Kind]
        key "name": str
        key "properties": ForwardRef('PeeringLocationProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        kind: Union[str, Kind]
    ...
    class azure.mgmt.peering.types.PeeringLocationProperties(TypedDict, total=False):
        key "azureRegion": str
        key "country": str
        key "direct": ForwardRef('PeeringLocationPropertiesDirect', module='types')
        key "exchange": ForwardRef('PeeringLocationPropertiesExchange', module='types')
    ...
    class azure.mgmt.peering.types.PeeringLocationPropertiesDirect(TypedDict, total=False):
    ...
    class azure.mgmt.peering.types.PeeringLocationPropertiesExchange(TypedDict, total=False):
        peeringFacilities: list[ExchangePeeringFacility]
        peering_facilities: list[ExchangePeeringFacility]


    class azure.mgmt.peering.types.PeeringProperties(TypedDict, total=False):
        key "direct": ForwardRef('PeeringPropertiesDirect', module='types')
        key "exchange": ForwardRef('PeeringPropertiesExchange', module='types')
        key "peeringLocation": str
        key "provisioningState": Union[str, ProvisioningState]
        connectivityProbes: list[ConnectivityProbe]
        connectivity_probes: list[ConnectivityProbe]
    ...
    class azure.mgmt.peering.types.PeeringPropertiesDirect(TypedDict, total=False):
        key "directPeeringType": Union[str, DirectPeeringType]
        key "peerAsn": ForwardRef('SubResource', module='types')
        key "useForPeeringService": bool
    ...
    class azure.mgmt.peering.types.PeeringPropertiesExchange(TypedDict, total=False):
        key "peerAsn": ForwardRef('SubResource', module='types')
        connections: list[ExchangeConnection]
        peer_asn: SubResource


    class azure.mgmt.peering.types.PeeringReceivedRoute(TypedDict, total=False):
        key "asPath": str
        key "nextHop": str
        key "originAsValidationState": str
        key "prefix": str
        key "receivedTimestamp": str
        key "rpkiValidationState": str
        key "trustAnchor": str
        as_path: str
        next_hop: str
        origin_as_validation_state: str
        prefix: str
    ...
    class azure.mgmt.peering.types.PeeringRegisteredAsn(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('PeeringRegisteredAsnProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.peering.types.PeeringRegisteredAsnProperties(TypedDict, total=False):
        key "asn": int
        key "peeringServicePrefixKey": str
        key "provisioningState": Union[str, ProvisioningState]
        asn: int
    ...
    class azure.mgmt.peering.types.PeeringRegisteredPrefix(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('PeeringRegisteredPrefixProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.peering.types.PeeringRegisteredPrefixProperties(TypedDict, total=False):
        key "errorMessage": str
        key "peeringServicePrefixKey": str
        key "prefix": str
        key "prefixValidationState": Union[str, PrefixValidationState]
        key "provisioningState": Union[str, ProvisioningState]
        error_message: str
        peering_service_prefix_key: str
        prefix: str
        prefix_validation_state: Union[str, PrefixValidationState]
        provisioning_state: Union[str, ProvisioningState]


    class azure.mgmt.peering.types.PeeringService(TrackedResource):
        key "id": str
        key "location": Required[str]
        key "name": str
        key "properties": ForwardRef('PeeringServiceProperties', module='types')
        key "sku": ForwardRef('PeeringServiceSku', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        location: str
    ...
    class azure.mgmt.peering.types.PeeringServiceCountry(Resource):
        key "id": str
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
    ...
    class azure.mgmt.peering.types.PeeringServiceLocation(Resource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('PeeringServiceLocationProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.peering.types.PeeringServiceLocationProperties(TypedDict, total=False):
        key "azureRegion": str
        key "country": str
        key "state": str
        azure_region: str
    ...
    class azure.mgmt.peering.types.PeeringServicePrefix(ProxyResource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('PeeringServicePrefixProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.peering.types.PeeringServicePrefixEvent(TypedDict, total=False):
        key "eventDescription": str
        key "eventLevel": str
        key "eventSummary": str
    ...
    class azure.mgmt.peering.types.PeeringServicePrefixProperties(TypedDict, total=False):
        key "errorMessage": str
        key "learnedType": Union[str, LearnedType]
        key "peeringServicePrefixKey": str
        key "prefix": str
        key "prefixValidationState": Union[str, PrefixValidationState]
        key "provisioningState": Union[str, ProvisioningState]
        ...
        learned_type: Union[str, LearnedType]
        peering_service_prefix_key: str
        prefix: str
        prefix_validation_state: Union[str, PrefixValidationState]
        provisioning_state: Union[str, ProvisioningState]
    ...
    class azure.mgmt.peering.types.PeeringServiceProperties(TypedDict, total=False):
        key "logAnalyticsWorkspaceProperties": ForwardRef('LogAnalyticsWorkspaceProperties', module='types')
        key "peeringServiceLocation": str
        key "peeringServiceProvider": str
        key "providerBackupPeeringLocation": str
        key "providerPrimaryPeeringLocation": str
        key "provisioningState": Union[str, ProvisioningState]
        log_analytics_workspace_properties: LogAnalyticsWorkspaceProperties
        peering_service_location: str
        peering_service_provider: str
    ...
    class azure.mgmt.peering.types.PeeringServiceProvider(Resource):
        key "id": str
        key "name": str
        key "properties": ForwardRef('PeeringServiceProviderProperties', module='types')
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
        id: str
        name: str
    ...
    class azure.mgmt.peering.types.PeeringServiceProviderProperties(TypedDict, total=False):
    ...
    class azure.mgmt.peering.types.PeeringServiceSku(TypedDict, total=False):
        key "name": str
        name: str


    class azure.mgmt.peering.types.PeeringSku(TypedDict, total=False):
        key "family": Union[str, Family]
        key "name": str
        key "size": Union[str, Size]
        key "tier": Union[str, Tier]
    ...
    class azure.mgmt.peering.types.ProxyResource(Resource):
        key "id": str
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
    ...
    class azure.mgmt.peering.types.Resource(TypedDict, total=False):
        key "id": str
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
    ...
    class azure.mgmt.peering.types.ResourceTags(TypedDict, total=False):
        tags: dict[str, str]


    class azure.mgmt.peering.types.RpUnbilledPrefix(TypedDict, total=False):
        key "azureRegion": str
        key "peerAsn": int
        key "prefix": str
        azure_region: str
    ...
    class azure.mgmt.peering.types.ServiceSpecification(TypedDict, total=False):
        metricSpecifications: list[MetricSpecification]
        metric_specifications: list[MetricSpecification]


    class azure.mgmt.peering.types.SubResource(TypedDict, total=False):
        key "id": str
        id: str


    class azure.mgmt.peering.types.SystemData(TypedDict, total=False):
        key "createdAt": str
        key "createdBy": str
    ...
    class azure.mgmt.peering.types.TrackedResource(Resource):
        key "id": str
        key "location": Required[str]
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
