...
def build_create_or_update_request(
    ...
    path_format_arguments = {
        ...
        "prefixName": _SERIALIZER.url("prefix_name", prefix_name, "str", pattern=r"[A-Za-z0-9_.-]{1,63}"),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class PrefixesOperations:
    ...
    def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("PeeringServicePrefix", pipeline_response.http_response)
    ...
    def create_or_update(
        ...
        peering_service_name: str,
        prefix_name: str,
        peering_service_prefix: Union[_models.PeeringServicePrefix, IO[bytes]],
        **kwargs: Any
    ) -> _models.PeeringServicePrefix:
        """Creates a new prefix with the specified name under the given subscription, resource group and
        peering service.
        ...
        :type peering_service_prefix: ~azure.mgmt.peering.models.PeeringServicePrefix or IO[bytes]
        :return: PeeringServicePrefix or the result of cls(response)
        :rtype: ~azure.mgmt.peering.models.PeeringServicePrefix
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_peering_service(
    ...
    ) -> ItemPaged["_models.PeeringServicePrefix"]:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.PeeringServicePrefixListResult] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_peering_service_request(
                    resource_group_name=resource_group_name,
                    peering_service_name=peering_service_name,
                    subscription_id=self._config.subscription_id,
                    expand=expand,
