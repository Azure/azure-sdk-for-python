...
def build_check_service_provider_availability_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Peering/CheckServiceProviderAvailability"
    )
...
class _PeeringManagementClientOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], PeeringManagementClientConfiguration]
):
    ...
    def check_service_provider_availability(
        self,
        check_service_provider_availability_input: Union[_models.CheckServiceProviderAvailabilityInput, IO[bytes]],
        **kwargs: Any
    ) -> Union[str, _models.Enum0]:
        """Checks if the peering service provider is present within 1000 miles of customer's location.

        :param check_service_provider_availability_input: The CheckServiceProviderAvailabilityInput
                     indicating customer location and service provider. Is either a
         CheckServiceProviderAvailabilityInput type or a IO[bytes] type. Required.
        :type check_service_provider_availability_input:
         ~azure.mgmt.peering.models.CheckServiceProviderAvailabilityInput or IO[bytes]
        :return: Enum0 or the result of cls(response)
        :rtype: str or ~azure.mgmt.peering.models.Enum0
        :raises ~azure.core.exceptions.HttpResponseError:
        """
