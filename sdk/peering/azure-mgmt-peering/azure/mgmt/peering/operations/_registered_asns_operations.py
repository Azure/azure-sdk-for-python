...
class RegisteredAsnsOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.PeeringRegisteredAsn"
    ...
    def create_or_update(
        ...
        peering_name,  # type: str
        registered_asn_name,  # type: str
        registered_asn,  # type: "_models.PeeringRegisteredAsn"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.PeeringRegisteredAsn"
    ...
    def list_by_peering(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.PeeringRegisteredAsnListResult"]
        ...
        :type peering_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either PeeringRegisteredAsnListResult or the result of cls(response)
