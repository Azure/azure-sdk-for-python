...
class RegisteredAsnsOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("PeeringRegisteredAsn", pipeline_response.http_response)
    ...
    def create_or_update(
        ...
        peering_name: str,
        registered_asn_name: str,
        registered_asn: Union[_models.PeeringRegisteredAsn, IO[bytes]],
        **kwargs: Any
    ) -> _models.PeeringRegisteredAsn:
        """Creates a new registered ASN with the specified name under the given subscription, resource
        group and peering.
        ...
        :type registered_asn: ~azure.mgmt.peering.models.PeeringRegisteredAsn or IO[bytes]
        :return: PeeringRegisteredAsn or the result of cls(response)
        :rtype: ~azure.mgmt.peering.models.PeeringRegisteredAsn
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_peering(
    ...
    ) -> ItemPaged["_models.PeeringRegisteredAsn"]:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.PeeringRegisteredAsnListResult] = kwargs.pop("cls", None)
