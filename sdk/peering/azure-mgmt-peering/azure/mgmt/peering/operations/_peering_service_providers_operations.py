...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Peering/peeringServiceProviders")
...
class PeeringServiceProvidersOperations:
    ...
    def list(
        self,
        **kwargs: Any
    ) -> Iterable[_models.PeeringServiceProviderListResult]:
        ...
        :return: An iterator like instance of either PeeringServiceProviderListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.peering.models.PeeringServiceProviderListResult]
