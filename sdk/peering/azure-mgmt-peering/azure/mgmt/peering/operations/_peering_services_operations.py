...
def build_create_or_update_request(
    ...
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "peeringServiceName": _SERIALIZER.url(
            "peering_service_name", peering_service_name, "str", pattern=r"[A-Za-z0-9_.-]{1,63}"
        ),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
def build_initialize_connection_monitor_request(  # pylint: disable=name-too-long
...
class PeeringServicesOperations:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.PeeringService"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.PeeringService"]:
    ...
    def initialize_connection_monitor(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_initialize_connection_monitor_request(
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            headers=_headers,
            params=_params,
