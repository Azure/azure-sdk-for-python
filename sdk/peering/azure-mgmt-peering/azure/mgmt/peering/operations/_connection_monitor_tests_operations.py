...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Peering/peeringServices/{peeringServiceName}/connectionMonitorTests/{connectionMonitorTestName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "peeringServiceName": _SERIALIZER.url("peering_service_name", peering_service_name, 'str'),
        "connectionMonitorTestName": _SERIALIZER.url("connection_monitor_test_name", connection_monitor_test_name, 'str'),
...
def build_create_or_update_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ConnectionMonitorTest] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_list_by_peering_service_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Peering/peeringServices/{peeringServiceName}/connectionMonitorTests")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "peeringServiceName": _SERIALIZER.url("peering_service_name", peering_service_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
class ConnectionMonitorTestsOperations:
    ...
    def list_by_peering_service(
        ...
        peering_service_name: str,
        **kwargs: Any
    ) -> Iterable[_models.ConnectionMonitorTestListResult]:
        ...
        :return: An iterator like instance of either ConnectionMonitorTestListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.peering.models.ConnectionMonitorTestListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
