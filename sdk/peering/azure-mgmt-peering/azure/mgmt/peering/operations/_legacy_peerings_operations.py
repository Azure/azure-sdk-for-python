...
def build_list_request(
    subscription_id: str, *, peering_location: str, kind: Union[str, _models.Enum1], **kwargs: Any
) -> HttpRequest:
...
class LegacyPeeringsOperations:
    ...
    @distributed_trace
    def list(
        self, peering_location: str, kind: Union[str, _models.Enum1], **kwargs: Any
    ) -> ItemPaged["_models.Peering"]:
        ...
        cls: ClsType[_models.PeeringListResult] = kwargs.pop("cls", None)
