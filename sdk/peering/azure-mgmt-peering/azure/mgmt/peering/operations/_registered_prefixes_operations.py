...
class RegisteredPrefixesOperations(object):
    ...
    def get(
        ...
        registered_prefix_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.PeeringRegisteredPrefix"
    ...
    def create_or_update(
        ...
        peering_name,  # type: str
        registered_prefix_name,  # type: str
        registered_prefix,  # type: "_models.PeeringRegisteredPrefix"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.PeeringRegisteredPrefix"
    ...
    def list_by_peering(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.PeeringRegisteredPrefixListResult"]
        ...
        :type peering_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either PeeringRegisteredPrefixListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.peering.models.PeeringRegisteredPrefixListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
