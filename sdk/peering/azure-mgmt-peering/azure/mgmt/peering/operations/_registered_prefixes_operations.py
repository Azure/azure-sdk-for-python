...
def build_create_or_update_request(
    ...
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "peeringName": _SERIALIZER.url("peering_name", peering_name, "str", pattern=r"[A-Za-z0-9_.-]{1,63}"),
        "registeredPrefixName": _SERIALIZER.url(
            "registered_prefix_name", registered_prefix_name, "str", pattern=r"[A-Za-z0-9_.-]{1,63}"
        ),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class RegisteredPrefixesOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("PeeringRegisteredPrefix", pipeline_response.http_response)
    ...
    def create_or_update(
        ...
        peering_name: str,
        registered_prefix_name: str,
        registered_prefix: Union[_models.PeeringRegisteredPrefix, IO[bytes]],
        **kwargs: Any
    ) -> _models.PeeringRegisteredPrefix:
        """Creates a new registered prefix with the specified name under the given subscription, resource
        group and peering.
        ...
        :type registered_prefix: ~azure.mgmt.peering.models.PeeringRegisteredPrefix or IO[bytes]
        :return: PeeringRegisteredPrefix or the result of cls(response)
        :rtype: ~azure.mgmt.peering.models.PeeringRegisteredPrefix
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_peering(
    ...
    ) -> ItemPaged["_models.PeeringRegisteredPrefix"]:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.PeeringRegisteredPrefixListResult] = kwargs.pop("cls", None)
