...
def build_create_or_update_request(peer_asn_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    path_format_arguments = {
        "peerAsnName": _SERIALIZER.url("peer_asn_name", peer_asn_name, "str", pattern=r"[A-Za-z0-9_.-]{1,63}"),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class PeerAsnsOperations:
    ...
    def get(self, peer_asn_name: str, **kwargs: Any) -> _models.PeerAsn:
        ...
        deserialized = self._deserialize("PeerAsn", pipeline_response.http_response)
    ...
    @distributed_trace
    def create_or_update(
        self, peer_asn_name: str, peer_asn: Union[_models.PeerAsn, IO[bytes]], **kwargs: Any
    ) -> _models.PeerAsn:
        """Creates a new peer ASN or updates an existing peer ASN with the specified name under the given
        subscription.
        ...
        :type peer_asn: ~azure.mgmt.peering.models.PeerAsn or IO[bytes]
        :return: PeerAsn or the result of cls(response)
        :rtype: ~azure.mgmt.peering.models.PeerAsn
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.PeerAsn"]:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.PeerAsnListResult] = kwargs.pop("cls", None)
