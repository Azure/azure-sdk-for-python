...
class PeeringLocationsOperations(object):
    ...
    def list(
        self,
        kind,  # type: Union[str, "_models.Enum14"]
        direct_peering_type=None,  # type: Optional[Union[str, "_models.Enum15"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["_models.PeeringLocationListResult"]
        ...
        :return: An iterator like instance of either PeeringLocationListResult or the result of cls(response)
