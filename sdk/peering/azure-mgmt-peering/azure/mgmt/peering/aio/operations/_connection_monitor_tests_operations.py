...
from ...operations._connection_monitor_tests_operations import (
...
class ConnectionMonitorTestsOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("ConnectionMonitorTest", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        peering_service_name: str,
        connection_monitor_test_name: str,
        connection_monitor_test: Union[_models.ConnectionMonitorTest, IO[bytes]],
        **kwargs: Any
    ) -> _models.ConnectionMonitorTest:
        """Creates or updates a connection monitor test with the specified name under the given
        subscription, resource group and peering service.
        ...
        :type connection_monitor_test: ~azure.mgmt.peering.models.ConnectionMonitorTest or IO[bytes]
        :return: ConnectionMonitorTest or the result of cls(response)
        :rtype: ~azure.mgmt.peering.models.ConnectionMonitorTest
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_peering_service(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.ConnectionMonitorTestListResult] = kwargs.pop("cls", None)
