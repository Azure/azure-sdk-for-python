...
class PeeringServiceProvidersOperations:
    """PeeringServiceProvidersOperations async operations.
    ...
    def list(
        ...
        **kwargs
        ...
        :return: An iterator like instance of either PeeringServiceProviderListResult or the result of cls(response)
