...
from ...operations._peering_service_locations_operations import build_list_request
...
class PeeringServiceLocationsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :param country: The country of interest, in which the locations are to be present. Default
         value is None.
        :type country: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either PeeringServiceLocationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.peering.models.PeeringServiceLocationListResult]
