...
from ...operations._cdn_peering_prefixes_operations import build_list_request
...
class CdnPeeringPrefixesOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable[_models.CdnPeeringPrefixListResult]:
        """Lists all of the advertised prefixes for the specified peering location.

        :param peering_location: The peering location.
        :type peering_location: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either CdnPeeringPrefixListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.peering.models.CdnPeeringPrefixListResult]
