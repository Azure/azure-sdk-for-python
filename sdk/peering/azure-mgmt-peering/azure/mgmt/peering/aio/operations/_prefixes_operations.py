...
from ...operations._prefixes_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_peering_service_request
    ...
    def list_by_peering_service(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PeeringServicePrefixListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.peering.models.PeeringServicePrefixListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
