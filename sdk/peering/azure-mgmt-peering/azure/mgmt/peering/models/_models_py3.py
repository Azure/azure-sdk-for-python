...
class PeeringService(Resource):
    ...
    def __init__(self, *, location: str, sku=None, peering_service_location: str=None, peering_service_provider: str=None, provider_primary_peering_location: str=None, provider_backup_peering_location: str=None, tags=None, **kwargs) -> None:
...
class PeeringServiceProvider(Resource):
    ...
    def __init__(self, *, service_provider_name: str=None, peering_locations=None, **kwargs) -> None:
