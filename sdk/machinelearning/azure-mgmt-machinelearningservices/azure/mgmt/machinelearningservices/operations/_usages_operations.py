    ...
    def list(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                if self.config.expand_children is not None:
                    query_parameters['expandChildren'] = self._serialize.query("self.config.expand_children", self.config.expand_children, 'str')
