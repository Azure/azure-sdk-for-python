...
class QuotasOperations(object):
    ...
    def update(
            self, location, value=None, location1=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param location1: Region of workspace quota to be updated.
        :type location1: str
        ...
        """
        parameters = models.QuotaUpdateParameters(value=value, location=location1)
