...
class WorkspacesOperations:
    ...
    @distributed_trace
    def resync_keys(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, workspace_name: str, **kwargs: Any
    ) -> None:
    ...
    @distributed_trace
    def list_by_subscription(self, skiptoken: Optional[str] = None, **kwargs: Any) -> ItemPaged["_models.Workspace"]:
