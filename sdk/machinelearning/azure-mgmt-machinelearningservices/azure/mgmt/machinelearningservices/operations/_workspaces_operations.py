...
class WorkspacesOperations(object):
    ...
    def list_by_resource_group(
            self, resource_group_name, skip=None, custom_headers=None, raw=False, **operation_config):
    ...
    def list_by_subscription(
            self, skip=None, custom_headers=None, raw=False, **operation_config):
        """Lists all the available machine learning workspaces under the specified
        subscription.
    ...
    def list_notebook_access_token(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: NotebookAccessTokenResult or ClientRawResponse if raw=true
        :rtype:
         ~azure.mgmt.machinelearningservices.models.NotebookAccessTokenResult
         or ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`MachineLearningServiceErrorException<azure.mgmt.machinelearningservices.models.MachineLearningServiceErrorException>`
        """
        # Construct URL
        url = self.list_notebook_access_token.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str')
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('NotebookAccessTokenResult', response)
        ...
        return deserialized
    list_notebook_access_token.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/listNotebookAccessToken'}
