...
class AKSProperties(Model):
    ...
    :param cluster_purpose: Possible values include: 'FastProd', 'DenseProd',
     'DevTest'
    :type cluster_purpose: str or
     ~azure.mgmt.machinelearningservices.models.enum
    """
...
class Identity(Model):
    ...
    :type user_assigned_identities: dict[str,
     ~azure.mgmt.machinelearningservices.models.IdentityUserAssignedIdentitiesValue]
    """
...
class SslConfiguration(Model):
    ...
    :type cname: str
    :param leaf_domain_label: The leaf domain label name
    :type leaf_domain_label: str
    :param overwrite_existing_domain: Boolean value for overwriting the
    ...
    def __init__(self, **kwargs):
        ...
        self.overwrite_existing_domain = kwargs.get('overwrite_existing_domain', False)
