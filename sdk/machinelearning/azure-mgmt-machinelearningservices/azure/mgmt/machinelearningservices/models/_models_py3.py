...
class ClusterUpdateParameters(Model):
    ...
    def __init__(self, *, scale_settings=None, data_stores_mount_settings=None, custom_script_settings=None, software_update_settings=None, ssh_settings=None, **kwargs) -> None:
