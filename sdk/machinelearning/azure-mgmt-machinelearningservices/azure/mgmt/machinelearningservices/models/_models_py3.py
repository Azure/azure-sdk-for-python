...
class OnPrem(Compute):
    ...
    def __init__(self, *, compute_location: str=None, description: str=None, resource_id: str=None, properties=None, **kwargs) -> None:
        super(OnPrem, self).__init__(compute_location=compute_location, description=description, resource_id=resource_id, **kwargs)
        self.properties = properties
...
class OnPremProperties(Model):
    ...
    def __init__(self, *, address: str=None, user_account_credentials=None, **kwargs) -> None:
