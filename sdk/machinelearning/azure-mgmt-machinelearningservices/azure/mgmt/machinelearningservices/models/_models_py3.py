...
class AKSProperties(Model):
    ...
    def __init__(self, *, cluster_fqdn: str=None, agent_count: int=None, agent_vm_size: str=None, ssl_configuration=None, aks_networking_configuration=None, cluster_purpose=None, **kwargs) -> None:
...
class SslConfiguration(Model):
    ...
    def __init__(self, *, status=None, cert: str=None, key: str=None, cname: str=None, leaf_domain_label: str=None, overwrite_existing_domain: bool=False, **kwargs) -> None:
