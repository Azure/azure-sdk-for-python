...
from ._machine_learning_services_mgmt_client_enums import ComputeProvisioningState
...
from ._machine_learning_services_mgmt_client_enums import WorkspaceProvisioningState
