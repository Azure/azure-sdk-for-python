...
class WorkspaceConnectionsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PaginatedWorkspaceConnectionsList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.PaginatedWorkspaceConnectionsList]
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.machinelearningservices.models.WorkspaceConnection
        :keyword callable cls: A custom type or function that will be passed the direct response
