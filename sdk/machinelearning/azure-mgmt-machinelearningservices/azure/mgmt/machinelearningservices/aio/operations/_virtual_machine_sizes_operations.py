...
class VirtualMachineSizesOperations:
    ...
    async def list(
        self, location: str, compute_type: Optional[str] = None, recommended: Optional[bool] = None, **kwargs: Any
        ...
        :type location: str
        :param compute_type: Type of compute to filter by. Default value is None.
        :type compute_type: str
        :param recommended: Specifies whether to return recommended vm sizes or all vm sizes. Default
         value is None.
