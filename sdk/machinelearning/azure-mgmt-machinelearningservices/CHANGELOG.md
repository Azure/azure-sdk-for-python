...
### Features Added
  ...
  - Added operation group LabelingJobsOperations
  ...
  - Model ComputeInstanceProperties has a new parameter autologger_settings
  ...
  - Model ComputeInstanceProperties has a new parameter idle_time_before_shutdown
  ...
  - Model Workspace has a new parameter scheduled_purge_date
  - Model Workspace has a new parameter service_managed_resources_settings
  - Model Workspace has a new parameter soft_deleted_at
  ...
  - Model WorkspaceUpdateParameters has a new parameter encryption
