...
from ...operations._guest_configuration_assignment_reports_vmss_operations import build_get_request, build_list_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class GuestConfigurationAssignmentReportsVMSSOperations:
    """GuestConfigurationAssignmentReportsVMSSOperations async operations.
    ...
    def list(
        ...
        name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.GuestConfigurationAssignmentReportList"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.guestconfig.models.GuestConfigurationAssignmentReportList]
