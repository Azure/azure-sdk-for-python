...
class GuestConfigurationAssignmentProperties(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        vmss_vm_list: Optional[List["VMSSVMInfo"]] = None,
        **kwargs
    ):
        """
...
class GuestConfigurationNavigation(msrest.serialization.Model):
    ...
    :ivar kind: Kind of the guest configuration. For example:DSC. Possible values include: "DSC".
    ...
    def __init__(
        ...
        *,
        ...
        configuration_protected_parameter: Optional[List["ConfigurationParameter"]] = None,
        **kwargs
    ):
        """
        :keyword kind: Kind of the guest configuration. For example:DSC. Possible values include:
         "DSC".
