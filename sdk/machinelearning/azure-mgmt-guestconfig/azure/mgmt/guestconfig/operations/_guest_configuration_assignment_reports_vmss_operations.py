...
class GuestConfigurationAssignmentReportsVMSSOperations:
    """
    .. warning::
    ...
    def list(
    ...
    ) -> Iterable["_models.GuestConfigurationAssignmentReport"]:
        ...
        :return: An iterator like instance of either GuestConfigurationAssignmentReport or the result
         of cls(response)
        :rtype:
