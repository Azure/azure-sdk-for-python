...
from ...operations._operationalization_clusters_operations import (
    build_check_system_services_updates_available_request,
    ...
    build_update_system_services_request,
)
...
class OperationalizationClustersOperations:
    ...
    async def begin_update_system_services(
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._update_system_services_initial(  # type: ignore
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
    ...
    def list_by_resource_group(
    ...
    ) -> AsyncIterable["_models.OperationalizationCluster"]:
        ...
        :return: An iterator like instance of either OperationalizationCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningcompute.models.OperationalizationCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
