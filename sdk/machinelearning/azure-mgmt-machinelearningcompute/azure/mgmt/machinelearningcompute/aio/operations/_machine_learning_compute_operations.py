...
class MachineLearningComputeOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.machinelearningcompute.aio.MachineLearningComputeManagementClient`'s
    ...
    async def list_available_operations(self, **kwargs: Any) -> _models.AvailableOperations:
