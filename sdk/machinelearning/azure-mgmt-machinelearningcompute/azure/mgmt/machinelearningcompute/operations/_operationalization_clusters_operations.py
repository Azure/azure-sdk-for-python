...
class OperationalizationClustersOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.machinelearningcompute.MachineLearningComputeManagementClient`'s
        :attr:`operationalization_clusters` attribute.
    """
    ...
    def _create_or_update_initial(
        ...
        resource_group_name: str,
        cluster_name: str,
        parameters: Union[_models.OperationalizationCluster, IO],
        **kwargs: Any
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param cluster_name: The name of the cluster. Required.
        :type cluster_name: str
        :param parameters: Parameters supplied to create or update an Operationalization cluster. Is
         either a model type or a IO type. Required.
        :type parameters: ~azure.mgmt.machinelearningcompute.models.OperationalizationCluster or IO
    ...
    @distributed_trace
    def get(self, resource_group_name: str, cluster_name: str, **kwargs: Any) -> _models.OperationalizationCluster:
    ...
    def update(
        ...
        resource_group_name: str,
        cluster_name: str,
        parameters: Union[_models.OperationalizationClusterUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.OperationalizationCluster:
        """The PATCH operation can be used to update only the tags for a cluster. Use PUT operation to
        update other properties.
        ...
        :param cluster_name: The name of the cluster. Required.
        :type cluster_name: str
        :param parameters: The parameters supplied to patch the cluster. Is either a model type or a IO
         type. Required.
        :type parameters:
         ~azure.mgmt.machinelearningcompute.models.OperationalizationClusterUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, cluster_name: str, delete_all: Optional[bool] = None, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_delete(
        ...
        :param cluster_name: The name of the cluster. Required.
        :type cluster_name: str
        :param delete_all: If true, deletes all resources associated with this cluster. Default value
         is None.
    ...
    def _update_system_services_initial(
        ...
        request = build_update_system_services_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_update_system_services(
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._update_system_services_initial(  # type: ignore
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
    ...
    def list_by_resource_group(
    ...
    ) -> Iterable["_models.OperationalizationCluster"]:
        ...
        :type skiptoken: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either OperationalizationCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.machinelearningcompute.models.OperationalizationCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
