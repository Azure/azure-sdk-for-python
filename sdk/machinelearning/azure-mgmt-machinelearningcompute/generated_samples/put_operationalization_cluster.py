...
# USAGE
    python put_operationalization_cluster.py
...
def main():
    ...
    response = client.operationalization_clusters.begin_create_or_update(
            ...
            "properties": {
                ...
                "containerService": {
                    "orchestratorProperties": {
                        "servicePrincipal": {"clientId": "abcdefghijklmnopqrt", "secret": "<secret>"}
                    },
