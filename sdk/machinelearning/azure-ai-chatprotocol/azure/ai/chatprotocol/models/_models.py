...
class ChatChoice(_model_base.Model):
    ...
    session_state: Optional[Any] = rest_field(name="sessionState")
...
class TextChatMessage(ChatMessage, discriminator="text"):
    ...
    kind: Literal[MessageKind.TEXT] = rest_discriminator(name="kind")  # type: ignore
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.kind: Literal[MessageKind.TEXT] = MessageKind.TEXT
