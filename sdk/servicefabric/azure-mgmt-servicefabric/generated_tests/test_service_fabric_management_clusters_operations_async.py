...
class TestServiceFabricManagementClustersOperationsAsync(AzureMgmtRecordedTestCase):
                                ...
                                "applicationDeltaHealthPolicies": {
                                    "str": {
                                        ...
                                        "serviceTypeDeltaHealthPolicies": {
                                            "str": {"maxPercentDeltaUnhealthyServices": 0}
                                        },
                                    }
                                },
                            },
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_clusters_delete(self, resource_group):
        response = await self.client.clusters.delete(
            resource_group_name=resource_group.name,
            cluster_name="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_clusters_list_upgradable_versions(self, resource_group):
        response = await self.client.clusters.list_upgradable_versions(
            resource_group_name=resource_group.name,
            cluster_name="str",
        )
