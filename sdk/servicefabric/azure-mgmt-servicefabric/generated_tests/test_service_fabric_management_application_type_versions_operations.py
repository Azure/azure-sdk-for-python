...
class TestServiceFabricManagementApplicationTypeVersionsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_application_type_versions_list(self, resource_group):
        response = self.client.application_type_versions.list(
            resource_group_name=resource_group.name,
            cluster_name="str",
            application_type_name="str",
        )
