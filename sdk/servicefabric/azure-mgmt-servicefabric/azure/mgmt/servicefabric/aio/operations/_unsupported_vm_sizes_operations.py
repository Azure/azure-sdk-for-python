...
from ...operations._unsupported_vm_sizes_operations import build_get_request, build_list_request
...
class UnsupportedVmSizesOperations:
    ...
    @distributed_trace
    def list(self, location: str, **kwargs: Any) -> AsyncIterable["_models.VMSizeResource"]:
