...
class ManagedClustersOperations(object):
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.servicefabric.models.ManagedClusterListResult]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.servicefabric.models.ManagedCluster
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.servicefabric.models.ManagedCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        cluster_name,  # type: str
        parameters,  # type: "_models.ManagedClusterUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ManagedCluster"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ManagedCluster"]
        ...
        return deserialized
    _update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}'}  # type: ignore
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        if cont_token:
            ...
            return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedClusters/{clusterName}'}  # type: ignore
