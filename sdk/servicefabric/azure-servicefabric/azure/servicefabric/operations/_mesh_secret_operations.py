...
class MeshSecretOperations(object):
    ...
    def get(self, secret_resource_name, custom_headers=None, raw=False, **operation_config):
    ...
    def delete(self, secret_resource_name, custom_headers=None, raw=False, **operation_config):
