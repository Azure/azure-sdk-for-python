...
class MeshNetworkOperations:
    ...
    async def create_or_update(
        ...
        name: str,
        properties: "_models.NetworkResourceProperties",
        **kwargs
    ) -> Optional["_models.NetworkResourceDescription"]:
    ...
    async def get(
        ...
        network_resource_name: str,
        **kwargs
    ) -> "_models.NetworkResourceDescription":
    ...
    async def list(
        self,
        **kwargs
    ) -> "_models.PagedNetworkResourceDescriptionList":
