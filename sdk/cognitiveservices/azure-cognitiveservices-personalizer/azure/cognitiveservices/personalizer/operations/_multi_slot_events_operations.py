...
class MultiSlotEventsOperations(object):
    """MultiSlotEventsOperations operations.
    ...
    def reward(
            self, event_id, reward, custom_headers=None, raw=False, **operation_config):
        ...
        """
        body = models.MultiSlotRewardRequest(reward=reward)
    ...
    reward.metadata = {'url': '/multislot/events/{eventId}/reward'}
    ...
    def activate(
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    activate.metadata = {'url': '/multislot/events/{eventId}/activate'}
