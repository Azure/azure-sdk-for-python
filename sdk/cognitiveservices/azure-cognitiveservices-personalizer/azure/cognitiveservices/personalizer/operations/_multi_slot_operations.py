...
class MultiSlotOperations(object):
    ...
    def rank(
        ...
        :type body:
         ~azure.cognitiveservices.personalizer.models.MultiSlotRankRequest
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: MultiSlotRankResponse or ClientRawResponse if raw=true
        :rtype:
         ~azure.cognitiveservices.personalizer.models.MultiSlotRankResponse or
        ...
        if response.status_code == 201:
            deserialized = self._deserialize('MultiSlotRankResponse', response)
        ...
        return deserialized
    rank.metadata = {'url': '/multislot/rank'}
