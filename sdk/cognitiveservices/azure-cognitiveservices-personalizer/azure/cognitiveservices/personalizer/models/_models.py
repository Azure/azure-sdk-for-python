...
class ApprenticeLearningMetrics(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.number_of_imitated_events = kwargs.get('number_of_imitated_events', None)
...
class ApprenticeModeMetrics(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.last_processed_event_time = kwargs.get('last_processed_event_time', None)
...
class PolicyReferenceContract(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.evaluation_id = kwargs.get('evaluation_id', None)
...
class SlotRequest(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.features = kwargs.get('features', None)
        self.excluded_actions = kwargs.get('excluded_actions', None)
        self.baseline_action = kwargs.get('baseline_action', None)
...
class SlotReward(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.slot_id = kwargs.get('slot_id', None)
        self.value = kwargs.get('value', None)
