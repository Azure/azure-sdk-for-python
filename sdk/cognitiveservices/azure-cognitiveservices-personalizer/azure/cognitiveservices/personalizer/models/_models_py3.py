...
class ServiceConfiguration(Model):
    ...
    def __init__(self, *, reward_wait_time, default_reward: float, reward_aggregation: str, exploration_percentage: float, model_export_frequency, log_retention_days: int, log_mirror_enabled: bool=None, log_mirror_sas_uri: str=None, **kwargs) -> None:
