...
class AnomalyDetectorClientOperationsMixin(object):
    ...
    def detect_entire_series(
        ...
        :type body:
         ~azure.cognitiveservices.anomalydetector.models.DetectRequest
        ...
        :raises:
         :class:`AnomalyDetectorErrorException<azure.cognitiveservices.anomalydetector.models.AnomalyDetectorErrorException>`
        """
        # Construct URL
