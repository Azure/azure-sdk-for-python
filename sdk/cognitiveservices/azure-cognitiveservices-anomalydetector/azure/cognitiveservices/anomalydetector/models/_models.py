...
class APIError(msrest.serialization.Model):
    ...
    :type code: str or ~azure.cognitiveservices.anomalydetector.models.AnomalyDetectorErrorCodes
...
class ChangePointDetectRequest(msrest.serialization.Model):
    ...
    :type granularity: str or ~azure.cognitiveservices.anomalydetector.models.Granularity
