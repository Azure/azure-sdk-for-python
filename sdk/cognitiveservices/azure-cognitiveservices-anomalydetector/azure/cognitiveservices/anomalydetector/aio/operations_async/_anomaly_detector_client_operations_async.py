...
class AnomalyDetectorClientOperationsMixin:
    ...
    async def entire_detect(
        ...
        **kwargs
        ...
        :rtype: ~azure.cognitiveservices.anomalydetector.models.EntireDetectResponse
    ...
    async def last_detect(
        ...
        **kwargs
        ...
        :rtype: ~azure.cognitiveservices.anomalydetector.models.LastDetectResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def change_point_detect(
        ...
        **kwargs
        ...
        :type body: ~azure.cognitiveservices.anomalydetector.models.ChangePointDetectRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ChangePointDetectResponse, or the result of cls(response)
        :rtype: ~azure.cognitiveservices.anomalydetector.models.ChangePointDetectResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
