...
class ContextDTO(Model):
    ...
    :type prompts:
     list[~azure.cognitiveservices.qnamaker.authoring.models.PromptDTO]
    """
...
class CreateKbDTO(Model):
    ...
    :type qna_list:
     list[~azure.cognitiveservices.qnamaker.authoring.models.QnADTO]
    :param urls: List of URLs to be used for extracting Q-A.
    :type urls: list[str]
    :param files: List of files from which to Extract Q-A.
    :type files:
     list[~azure.cognitiveservices.qnamaker.authoring.models.FileDTO]
    """
...
class EndpointSettingsDTO(Model):
    ...
    :type active_learning:
     ~azure.cognitiveservices.qnamaker.authoring.models.EndpointSettingsDTOActiveLearning
    """
...
class Error(Model):
    ...
    :param code: Required. One of a server-defined set of error codes.
     ...
     'ExtractionFailure'
    :type code: str or
     ~azure.cognitiveservices.qnamaker.authoring.models.ErrorCodeType
    ...
    :param details: An array of details about specific errors that led to this
     reported error.
    :type details:
     list[~azure.cognitiveservices.qnamaker.authoring.models.Error]
    :param inner_error: An object containing more specific information than
     the current object about the error.
    :type inner_error:
     ~azure.cognitiveservices.qnamaker.authoring.models.InnerErrorModel
    """
...
class ErrorResponse(Model):
    ...
    :type error:
     ~azure.cognitiveservices.qnamaker.authoring.models.ErrorResponseError
    """
...
class KnowledgebasesDTO(Model):
    ...
    :type knowledgebases:
     list[~azure.cognitiveservices.qnamaker.authoring.models.KnowledgebaseDTO]
    """
...
class Operation(Model):
    ...
    :type operation_state: str or
     ~azure.cognitiveservices.qnamaker.authoring.models.OperationStateType
    ...
    :type error_response:
     ~azure.cognitiveservices.qnamaker.authoring.models.ErrorResponse
    """
...
class PromptDTO(Model):
    ...
    :param qna: QnADTO - Either QnaId or QnADTO needs to be present in a
     PromptDTO object
    :type qna: ~azure.cognitiveservices.qnamaker.authoring.models.PromptDTOQna
...
class QnADTO(Model):
    ...
    :type metadata:
     list[~azure.cognitiveservices.qnamaker.authoring.models.MetadataDTO]
    :param context: Context of a QnA
    :type context:
     ~azure.cognitiveservices.qnamaker.authoring.models.QnADTOContext
    """
...
class UpdateKbContentsDTO(Model):
    ...
    :param qna_list: List of Q-A (UpdateQnaDTO) to be added to the
     knowledgebase.
    :type qna_list:
     list[~azure.cognitiveservices.qnamaker.authoring.models.UpdateQnaDTO]
...
class UpdateKbOperationDTO(Model):
    ...
    :type add:
     ~azure.cognitiveservices.qnamaker.authoring.models.UpdateKbOperationDTOAdd
    :param delete: An instance of DeleteKbContentsDTO for delete Operation
    :type delete:
     ~azure.cognitiveservices.qnamaker.authoring.models.UpdateKbOperationDTODelete
    :param update: An instance of UpdateKbContentsDTO for Update Operation
    :type update:
     ~azure.cognitiveservices.qnamaker.authoring.models.UpdateKbOperationDTOUpdate
    """
...
class UpdateQnaDTO(Model):
    ...
    :type questions:
     ~azure.cognitiveservices.qnamaker.authoring.models.UpdateQnaDTOQuestions
    :param metadata: List of metadata associated with the answer to be updated
    :type metadata:
     ~azure.cognitiveservices.qnamaker.authoring.models.UpdateQnaDTOMetadata
    :param context: Context associated with Qna to be updated.
    :type context:
     ~azure.cognitiveservices.qnamaker.authoring.models.UpdateQnaDTOContext
    """
