...
class Operations(object):
    ...
    def get_details(
        ...
        :rtype: ~azure.cognitiveservices.qnamaker.authoring.models.Operation
         or ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.cognitiveservices.qnamaker.authoring.models.ErrorResponseException>`
        """
        # Construct URL
