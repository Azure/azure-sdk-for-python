...
class QnAMakerClient(SDKClient):
    ...
    :vartype endpoint_settings: azure.cognitiveservices.qnamaker.authoring.operations.EndpointSettingsOperations
    :ivar endpoint_keys: EndpointKeys operations
    :vartype endpoint_keys: azure.cognitiveservices.qnamaker.authoring.operations.EndpointKeysOperations
    :ivar alterations: Alterations operations
    :vartype alterations: azure.cognitiveservices.qnamaker.authoring.operations.AlterationsOperations
    :ivar knowledgebase: Knowledgebase operations
    :vartype knowledgebase: azure.cognitiveservices.qnamaker.authoring.operations.KnowledgebaseOperations
    :ivar operations: Operations operations
    :vartype operations: azure.cognitiveservices.qnamaker.authoring.operations.Operations
