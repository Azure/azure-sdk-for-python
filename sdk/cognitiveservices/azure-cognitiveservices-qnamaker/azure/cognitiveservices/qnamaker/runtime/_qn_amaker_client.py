...
class QnAMakerClient(SDKClient):
    ...
    :vartype runtime: azure.cognitiveservices.qnamaker.runtime.operations.RuntimeOperations
    ...
    def __init__(
        ...
        self.config = QnAMakerClientConfiguration(runtime_endpoint, credentials)
