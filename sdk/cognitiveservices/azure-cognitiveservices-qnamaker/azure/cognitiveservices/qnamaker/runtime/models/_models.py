...
class ContextDTO(Model):
    ...
    :type prompts:
     list[~azure.cognitiveservices.qnamaker.runtime.models.PromptDTO]
    """
...
class Error(Model):
    ...
    :param code: Required. One of a server-defined set of error codes.
     ...
     'ExtractionFailure'
    :type code: str or
     ~azure.cognitiveservices.qnamaker.runtime.models.ErrorCodeType
    ...
    :param details: An array of details about specific errors that led to this
     reported error.
    :type details:
     list[~azure.cognitiveservices.qnamaker.runtime.models.Error]
    :param inner_error: An object containing more specific information than
     the current object about the error.
    :type inner_error:
     ~azure.cognitiveservices.qnamaker.runtime.models.InnerErrorModel
    """
...
class ErrorResponse(Model):
    ...
    :type error:
     ~azure.cognitiveservices.qnamaker.runtime.models.ErrorResponseError
    """
...
class PromptDTO(Model):
    ...
    :param qna: QnADTO - Either QnaId or QnADTO needs to be present in a
     PromptDTO object
    :type qna: ~azure.cognitiveservices.qnamaker.runtime.models.PromptDTOQna
...
class QnADTO(Model):
    ...
    :type metadata:
     list[~azure.cognitiveservices.qnamaker.runtime.models.MetadataDTO]
    :param context: Context of a QnA
    :type context:
     ~azure.cognitiveservices.qnamaker.runtime.models.QnADTOContext
    """
...
class QnASearchResult(Model):
    ...
    :type context:
     ~azure.cognitiveservices.qnamaker.runtime.models.QnASearchResultContext
    """
...
class QnASearchResultList(Model):
    ...
    :type answers:
     list[~azure.cognitiveservices.qnamaker.runtime.models.QnASearchResult]
    """
...
class QueryDTO(Model):
    ...
    :type context:
     ~azure.cognitiveservices.qnamaker.runtime.models.QueryDTOContext
