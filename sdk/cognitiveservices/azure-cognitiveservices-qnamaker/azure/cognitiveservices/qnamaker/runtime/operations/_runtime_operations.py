...
class RuntimeOperations(object):
    ...
    def generate_answer(
        ...
        :type generate_answer_payload:
         ~azure.cognitiveservices.qnamaker.runtime.models.QueryDTO
        ...
        :rtype:
         ~azure.cognitiveservices.qnamaker.runtime.models.QnASearchResultList
         or ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.cognitiveservices.qnamaker.runtime.models.ErrorResponseException>`
        """
        # Construct URL
    ...
    def train(
        ...
        :type feedback_records:
         list[~azure.cognitiveservices.qnamaker.runtime.models.FeedbackRecordDTO]
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
