...
from azure.ai.translator import TranslatorClient, TranslatorCredential, TranslatorCustomEndpoint
...
class TextAnalyticsTest(CognitiveServiceTest):
    ...
    def test_translate_global(self):
        ...
        targetLanguages = ["cs"]
        tra = text_translator.translate(content = traInput, to = targetLanguages)
