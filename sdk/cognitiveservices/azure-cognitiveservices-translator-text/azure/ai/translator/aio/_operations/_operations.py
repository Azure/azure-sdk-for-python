...
from ..._operations._operations import (
    build_translator_break_sentence_request,
    build_translator_detect_request,
    build_translator_dictionary_examples_request,
    build_translator_dictionary_lookup_request,
    build_translator_get_languages_request,
    build_translator_translate_request,
    build_translator_transliterate_request,
)
...
class TranslatorClientOperationsMixin(TranslatorClientMixinABC):
    ...
    async def detect(
        ...
        *,
        ...
        content_type: str = "application/json",
        **kwargs: Any
    ) -> List[_models.DetectedLanguageWithAlternatives]:
        """Detect Languages.
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: list of DetectedLanguageWithAlternatives
        :rtype: list[~azure.ai.translator.models.DetectedLanguageWithAlternatives]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def detect(
        ...
        **kwargs: Any
        ...
        :param content: Array of the text for which values the language detection will be applied. Is
         either a [InputTextElement] type or a IO type. Required.
        :type content: list[~azure.ai.translator.models.InputTextElement] or IO
        :keyword client_trace_id: A client-generated GUID to uniquely identify the request. Default
         value is None.
        :paramtype client_trace_id: str
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[List[_models.DetectedLanguageWithAlternatives]] = kwargs.pop("cls", None)
        ...
        request = build_translator_detect_request(
            client_trace_id=client_trace_id,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
        ...
        deserialized = _deserialize(List[_models.DetectedLanguageWithAlternatives], response.json())
