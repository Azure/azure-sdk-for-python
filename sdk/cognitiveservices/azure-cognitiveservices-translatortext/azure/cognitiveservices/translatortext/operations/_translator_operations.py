...
class TranslatorOperations(object):
    ...
    def break_sentence(
            self, language=None, script=None, x_client_trace_id=None, request_body=None, response_body=None, response_header=None, custom_headers=None, raw=False, **operation_config):
        ...
        if response_header is not None:
            header_parameters['Response Header'] = self._serialize.header("response_header", response_header, 'str')
    ...
    def detect(
            self, x_client_trace_id=None, request_body=None, response_body=None, response_header=None, custom_headers=None, raw=False, **operation_config):
    ...
    def dictionary_lookup(
            self, from_parameter, to, x_client_trace_id=None, request_body=None, response_body=None, response_header=None, custom_headers=None, raw=False, **operation_config):
    ...
    def languages(
            self, scope=None, accept_language=None, x_client_trace_id=None, response_body=None, response_header=None, custom_headers=None, raw=False, **operation_config):
        ...
        **Authentication is not required to get language resources.**
         ...
         * `translation` property
         The value of the `translation` property is a dictionary of (key,
         value) pairs. Each key is a BCP 47 language tag. A key identifies a
         language for which text can be translated to or translated from. The
         ...
         * `dictionary` property
         ...
         pairs. Each key is a BCP 47 language tag. The key identifies a
         language for which alternative translations and back-translations are
         available. The value is a JSON object that describes the source
         ...
         * `code-` Language code identifying the target language.
         ...
         in the version of the API. For the same version of the API, the list
         of available languages may change over time because Microsoft
         Translator continually extends the list of languages supported by its
         services.
         ...
         should consider caching language resources and the corresponding
         entity tag (`ETag`). Then, the client application can periodically
         (for example, once every 24 hours) query the service to fetch the
         latest set of supported languages. Passing the current `ETag` value in
         an `If-None-Match` header field will allow the service to optimize the
    ...
    def translate(
            self, to, from_parameter=None, text_type=None, category=None, profanity_action=None, profanity_marker=None, include_alignment=None, include_sentence_length=None, suggested_from=None, from_script=None, to_script=None, x_client_trace_id=None, request_body=None, response_body=None, custom_headers=None, raw=False, **operation_config):
