...
class CopyRequestCopyConfig(Model):
    ...
    def __init__(self, *, delete_source: bool=False, support_cross_tenant_copy: bool=False, target_model_metadata=None, **kwargs) -> None:
        super(CopyRequestCopyConfig, self).__init__(**kwargs)
        self.delete_source = delete_source
        self.support_cross_tenant_copy = support_cross_tenant_copy
