...
class ReceiptsOperations(object):
    """ReceiptsOperations operations.
    ...
    analyze.metadata = {'url': '/prebuilt/receipt/analyze'}
    ...
    def get_analyze_result(
        ...
        return deserialized
    get_analyze_result.metadata = {'url': '/prebuilt/receipt/analyzeResults/{resultId}'}
