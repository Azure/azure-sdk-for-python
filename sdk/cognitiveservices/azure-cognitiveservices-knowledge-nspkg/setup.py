...
if sys.version_info[0] < 3:
    PACKAGES = ['azure.cognitiveservices.knowledge']

setup(
    name='azure-cognitiveservices-knowledge-nspkg',
    version='3.0.0',
    description='Microsoft Azure Cognitive Services Knowledge Namespace Package [Internal]',
