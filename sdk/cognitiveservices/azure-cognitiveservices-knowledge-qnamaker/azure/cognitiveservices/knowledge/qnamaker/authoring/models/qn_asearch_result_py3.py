...
class QnASearchResult(Model):
    ...
    :type context:
     ~azure.cognitiveservices.knowledge.qnamaker.authoring.models.QnASearchResultContext
    :param answer_span: Answer span object of QnA with respect to user's
     question.
    :type answer_span:
     ~azure.cognitiveservices.knowledge.qnamaker.authoring.models.QnASearchResultAnswerSpan
    """
