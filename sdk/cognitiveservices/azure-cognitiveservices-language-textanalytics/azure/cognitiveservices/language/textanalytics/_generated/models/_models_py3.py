...
class DocumentSentiment(Model):
    ...
    _attribute_map = {
        ...
        'statistics': {'key': 'statistics', 'type': 'DocumentStatistics'},
        'document_scores': {'key': 'documentScores', 'type': 'object'},
...
class EntitiesResult(Model):
    ...
    :type documents: list[~textanalytics.models.DocumentEntities]
    :param errors: Required. Errors by document id.
    :type errors: list[~textanalytics.models.DocumentError]
    :param statistics:
    :type statistics: ~textanalytics.models.RequestStatistics
...
class Entity(Model):
    ...
    def __init__(self, *, text: str, type: str, offset: int, length: int, score: float, sub_type: str=None, **kwargs) -> None:
...
class EntityLinkingResult(Model):
    ...
    :param documents: Required. Response by document
    :type documents: list[~textanalytics.models.DocumentLinkedEntities]
    :param errors: Required. Errors by document id.
    :type errors: list[~textanalytics.models.DocumentError]
    :param statistics:
    :type statistics: ~textanalytics.models.RequestStatistics
...
class KeyPhraseResult(Model):
    ...
    :param documents: Required. Response by document
    :type documents: list[~textanalytics.models.DocumentKeyPhrases]
    :param errors: Required. Errors by document id.
    :type errors: list[~textanalytics.models.DocumentError]
    :param statistics:
    :type statistics: ~textanalytics.models.RequestStatistics
...
class LanguageResult(Model):
    ...
    :param documents: Required. Response by document
    :type documents: list[~textanalytics.models.DocumentLanguage]
    :param errors: Required. Errors by document id.
    :type errors: list[~textanalytics.models.DocumentError]
    :param statistics:
    :type statistics: ~textanalytics.models.RequestStatistics
...
class SentenceSentiment(Model):
    ...
    _attribute_map = {
        'sentiment': {'key': 'sentiment', 'type': 'str'},
        'sentence_scores': {'key': 'sentenceScores', 'type': 'object'},
        'offset': {'key': 'offset', 'type': 'int'},
        'length': {'key': 'length', 'type': 'int'},
        'warnings': {'key': 'warnings', 'type': '[str]'},
    }

    def __init__(self, *, sentiment, sentence_scores, offset: int, length: int, warnings, **kwargs) -> None:
...
class SentimentResponse(Model):
    ...
    :type documents: list[~textanalytics.models.DocumentSentiment]
    :param errors: Required. Errors by document id.
    :type errors: list[~textanalytics.models.DocumentError]
    :param statistics:
    :type statistics: ~textanalytics.models.RequestStatistics
