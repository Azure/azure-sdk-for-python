...
class TextAnalyticsAPIOperationsMixin(object):
    ...
    def entitiesrecognitiongeneral(self, documents, model_version=None, show_stats=None, cls=None, **kwargs):
    ...
    def entitiesrecognitionpii(self, documents, model_version=None, show_stats=None, cls=None, **kwargs):
    ...
    def entitieslinking(self, documents, model_version=None, show_stats=None, cls=None, **kwargs):
