...
class AnalyzeJobStateTasks(Model):
    ...
    def __init__(self, *, completed: int, failed: int, in_progress: int, total: int, details=None, entity_recognition_tasks=None, entity_recognition_pii_tasks=None, entity_linking_tasks=None, key_phrase_extraction_tasks=None, sentiment_analysis_tasks=None, **kwargs) -> None:
...
class TaskState(Model):
    ...
    def __init__(self, *, last_update_date_time, name: str, status, **kwargs) -> None:
...
class AnalyzeJobStateTasksEntityLinkingTasksItem(TaskState):
    ...
    def __init__(self, *, last_update_date_time, name: str, status, results=None, **kwargs) -> None:
...
class AnalyzeJobStateTasksSentimentAnalysisTasksItem(TaskState):
    ...
    def __init__(self, *, last_update_date_time, name: str, status, results=None, **kwargs) -> None:
        super(AnalyzeJobStateTasksSentimentAnalysisTasksItem, self).__init__(last_update_date_time=last_update_date_time, name=name, status=status, **kwargs)
        self.results = results
...
class HealthcareJobState(Model):
    ...
    def __init__(self, *, created_date_time, job_id: str, last_update_date_time, status, display_name: str=None, expiration_date_time=None, results=None, next_link: str=None, **kwargs) -> None:
...
class JobManifestTasks(Model):
    ...
    def __init__(self, *, entity_recognition_tasks=None, entity_recognition_pii_tasks=None, entity_linking_tasks=None, key_phrase_extraction_tasks=None, sentiment_analysis_tasks=None, **kwargs) -> None:
...
class SentimentTaskParameters(Model):
    ...
    def __init__(self, *, model_version: str="latest", opinion_mining: bool=False, string_index_type="TextElements_v8", **kwargs) -> None:
