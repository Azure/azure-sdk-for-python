...
try:
    ...
    from ._models_py3 import AnalyzeJobStateTasksSentimentAnalysisTasksItem
    ...
    from ._models import AnalyzeJobStateTasksSentimentAnalysisTasksItem
    ...
    from ._models import SentimentTask
    from ._models import SentimentTaskParameters
