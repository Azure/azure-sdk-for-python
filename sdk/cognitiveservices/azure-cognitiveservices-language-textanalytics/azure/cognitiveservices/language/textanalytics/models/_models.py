...
class AnalyzeJobStateTasks(Model):
    ...
    :param details:
    :type details:
     list[~azure.cognitiveservices.language.textanalytics.models.TaskState]
    ...
    :type entity_linking_tasks:
     list[~azure.cognitiveservices.language.textanalytics.models.AnalyzeJobStateTasksEntityLinkingTasksItem]
    ...
    :type sentiment_analysis_tasks:
     list[~azure.cognitiveservices.language.textanalytics.models.AnalyzeJobStateTasksSentimentAnalysisTasksItem]
    """
    ...
    _attribute_map = {
        ...
        'sentiment_analysis_tasks': {'key': 'sentimentAnalysisTasks', 'type': '[AnalyzeJobStateTasksSentimentAnalysisTasksItem]'},
    }
...
class AnalyzeJobStateTasksSentimentAnalysisTasksItem(TaskState):
    """AnalyzeJobStateTasksSentimentAnalysisTasksItem.
    ...
    def __init__(self, **kwargs):
        super(AnalyzeJobStateTasksSentimentAnalysisTasksItem, self).__init__(**kwargs)
        self.results = kwargs.get('results', None)
...
class EntityLinkingTask(Model):
    ...
    :param parameters:
    :type parameters:
     ~azure.cognitiveservices.language.textanalytics.models.EntityLinkingTaskParameters
    """
...
class JobManifestTasks(Model):
    ...
    :param entity_linking_tasks:
    :type entity_linking_tasks:
     list[~azure.cognitiveservices.language.textanalytics.models.EntityLinkingTask]
    :param key_phrase_extraction_tasks:
    :type key_phrase_extraction_tasks:
     list[~azure.cognitiveservices.language.textanalytics.models.KeyPhrasesTask]
    :param sentiment_analysis_tasks:
    :type sentiment_analysis_tasks:
     list[~azure.cognitiveservices.language.textanalytics.models.SentimentTask]
    """
...
class SentimentTask(Model):
    """SentimentTask.

    :param parameters:
    :type parameters:
     ~azure.cognitiveservices.language.textanalytics.models.SentimentTaskParameters
    """
...
class SentimentTaskParameters(Model):
    """SentimentTaskParameters.

    :param model_version:  Default value: "latest" .
    :type model_version: str
    :param opinion_mining:  Default value: False .
