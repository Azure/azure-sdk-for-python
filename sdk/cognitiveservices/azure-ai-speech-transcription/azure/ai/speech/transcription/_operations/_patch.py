...
class _TranscriptionClientOperationsMixin(_TranscriptionClientOperationsMixinGenerated):
    ...
    def transcribe(
        ...
        .. admonition:: Example:
            ...
            .. literalinclude:: ../samples/sample_transcribe_audio_file.py
                :start-after: [START transcribe_audio_file]
                :end-before: [END transcribe_audio_file]
                :language: python
                :dedent: 4
                :caption: Transcribe an audio file
        """
