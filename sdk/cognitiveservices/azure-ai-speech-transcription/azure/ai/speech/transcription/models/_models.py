...
class EnhancedModeProperties(_Model):
    ...
    :ivar enabled: Enable enhanced mode for transcription.
...
class TranscribedPhrase(_Model):
    ...
    :ivar words: The words that make up the phrase. Only present if word-level timestamps are
     enabled.
    :vartype words: list[~azure.ai.speech.transcription.models.TranscribedWord]
...
class TranscribeRequestContent(_Model):
    ...
    :vartype options: ~azure.ai.speech.transcription.models.TranscriptionOptions
    ...
    :vartype audio: ~azure.ai.speech.transcription._utils.utils.FileType
    """
...
class TranscriptionOptions(_Model):
    ...
    :vartype phrase_list: ~azure.ai.speech.transcription.models.PhraseListProperties
    """
...
class TranscriptionResult(_Model):
    ...
    :vartype combined_phrases: list[~azure.ai.speech.transcription.models.ChannelCombinedPhrases]
    :ivar phrases: The transcription results segmented into phrases. Required.
    :vartype phrases: list[~azure.ai.speech.transcription.models.TranscribedPhrase]
    """
