...
DESCRIPTION:
    ...
    multiple language detection using the Azure AI Speech Transcription client.
    This is useful for multilingual content.
...
async def sample_transcribe_multiple_languages_async():
    ...
    # [END transcribe_multiple_languages_async]


if __name__ == "__main__":
    asyncio.run(sample_transcribe_multiple_languages_async())
