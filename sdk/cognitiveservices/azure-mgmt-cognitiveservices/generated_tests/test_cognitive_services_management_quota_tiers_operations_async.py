...
class TestCognitiveServicesManagementQuotaTiersOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_quota_tiers_create_or_update(self, resource_group):
        response = await self.client.quota_tiers.create_or_update(
            default="str",
            tier={
                "id": "str",
                "name": "str",
