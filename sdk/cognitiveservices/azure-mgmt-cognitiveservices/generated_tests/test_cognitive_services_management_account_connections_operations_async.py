...
class TestCognitiveServicesManagementAccountConnectionsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_account_connections_get(self, resource_group):
        response = await self.client.account_connections.get(
            resource_group_name=resource_group.name,
            account_name="str",
            connection_name="str",
            api_version="2025-09-01",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_account_connections_create(self, resource_group):
        response = await self.client.account_connections.create(
            resource_group_name=resource_group.name,
            account_name="str",
            connection_name="str",
            api_version="2025-09-01",
