...
class ComputePatch(_Model):
    """Patch model for compute resource updates.

    :ivar tags: Updated tags for the compute resource.
    :vartype tags: dict[str, str]
    :ivar properties: Partial update of compute properties.
    :vartype properties: ~azure.mgmt.cognitiveservices.models.ComputeProperties
    """

    tags: Optional[dict[str, str]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Updated tags for the compute resource."""
    properties: Optional["_models.ComputeProperties"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """Partial update of compute properties."""
...
class ComputeProperties(_Model):
    ...
    errors: Optional[list["_models.RootError"]] = rest_field(visibility=["read"])
