...
from ...operations._outbound_rule_operations import (
...
class OutboundRuleOperations:
    ...
    async def _delete_initial(
        self, resource_group_name: str, account_name: str, managed_network_name: str, rule_name: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
    ...
    async def get(
        ...
        """The GET API for retrieving a single outbound rule of the managed network associated with the
        cognitive services account.
        ...
        :rtype: ~azure.mgmt.cognitiveservices.models.OutboundRuleBasicResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type rule_name: str
        :param body: Required.
        :type body: ~azure.mgmt.cognitiveservices.models.OutboundRuleBasicResource
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cognitiveservices.models.OutboundRuleBasicResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.cognitiveservices.models.OutboundRuleBasicResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either OutboundRuleBasicResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cognitiveservices.models.OutboundRuleBasicResource]
    ...
    def list(
        ...
        """The GET API for retrieving the list of outbound rules of the managed network associated with
        ...
        :return: An iterator like instance of either OutboundRuleBasicResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cognitiveservices.models.OutboundRuleBasicResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
