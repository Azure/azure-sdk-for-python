...
from ...operations._rai_blocklist_items_operations import (
...
class RaiBlocklistItemsOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cognitiveservices.models.RaiBlocklistItem]
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CognitiveServices/accounts/{accountName}/raiBlocklists/{raiBlocklistName}/raiBlocklistItems"
    }
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("RaiBlocklistItem", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CognitiveServices/accounts/{accountName}/raiBlocklists/{raiBlocklistName}/raiBlocklistItems/{raiBlocklistItemName}"
    }
    ...
    async def create_or_update(
        ...
        rai_blocklist_name: str,
        rai_blocklist_item_name: str,
        rai_blocklist_item: Union[_models.RaiBlocklistItem, IO],
        **kwargs: Any
    ) -> _models.RaiBlocklistItem:
        """Update the state of specified blocklist item associated with the Azure OpenAI account.
        ...
        :param rai_blocklist_item: Properties describing the custom blocklist. Is either a
         RaiBlocklistItem type or a IO type. Required.
        :type rai_blocklist_item: ~azure.mgmt.cognitiveservices.models.RaiBlocklistItem or IO
