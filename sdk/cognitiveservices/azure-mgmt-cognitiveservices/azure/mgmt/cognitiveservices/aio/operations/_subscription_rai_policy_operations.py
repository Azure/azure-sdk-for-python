...
from ...operations._subscription_rai_policy_operations import (
...
class SubscriptionRaiPolicyOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`subscription_rai_policy` attribute.
    """
    ...
    async def get(self, rai_policy_name: str, **kwargs: Any) -> _models.RaiPolicy:
    ...
    @overload
    async def create_or_update(
        self, rai_policy_name: str, rai_policy: IO[bytes], *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.RaiPolicy:
        """Update the state of specified Content Filters associated with the subscription.
    ...
    @distributed_trace_async
    async def create_or_update(
        self, rai_policy_name: str, rai_policy: Union[_models.RaiPolicy, IO[bytes]], **kwargs: Any
    ) -> _models.RaiPolicy:
        """Update the state of specified Content Filters associated with the subscription.
    ...
    async def _delete_initial(self, rai_policy_name: str, **kwargs: Any) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace_async
    async def begin_delete(self, rai_policy_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
