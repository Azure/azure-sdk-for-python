...
class DeploymentsOperations:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CognitiveServices/accounts/{accountName}/deployments/{deploymentName}"
    }
    ...
    async def _update_initial(
        ...
        account_name: str,
        deployment_name: str,
        deployment: Union[_models.PatchResourceTagsAndSku, IO],
        **kwargs: Any
    ) -> Optional[_models.Deployment]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.Deployment]] = kwargs.pop("cls", None)
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param deployment_name: The name of the deployment associated with the Cognitive Services
         Account. Required.
        :type deployment_name: str
        :param deployment: The deployment properties. Is either a PatchResourceTagsAndSku type or a IO
         type. Required.
        :type deployment: ~azure.mgmt.cognitiveservices.models.PatchResourceTagsAndSku or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_skus.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CognitiveServices/accounts/{accountName}/deployments/{deploymentName}/skus"
    }
