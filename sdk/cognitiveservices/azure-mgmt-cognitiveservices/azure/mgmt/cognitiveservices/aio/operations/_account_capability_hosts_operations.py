...
from ...operations._account_capability_hosts_operations import (
...
class AccountCapabilityHostsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`account_capability_hosts` attribute.
    """
    ...
    def list(
    ...
    ) -> AsyncItemPaged["_models.CapabilityHost"]:
        """List capabilityHost.
        ...
        :return: An iterator like instance of either CapabilityHost or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cognitiveservices.models.CapabilityHost]
        ...
        cls: ClsType[_models.CapabilityHostResourceArmPaginatedResult] = kwargs.pop("cls", None)
    ...
    async def _delete_initial(
        self, resource_group_name: str, account_name: str, capability_host_name: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
