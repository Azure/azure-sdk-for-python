...
class ComputesOperations:
    ...
    async def _update_initial(
        ...
        account_name: str,
        compute_name: str,
        properties: Union[_models.ComputePatch, JSON, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        account_name: str,
        compute_name: str,
        properties: _models.ComputePatch,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.Compute]:
        ...
        :param compute_name: The name of the compute associated with the Cognitive Services Account.
         Required.
        :type compute_name: str
        :param properties: The compute properties. Required.
        :type properties: ~azure.mgmt.cognitiveservices.models.ComputePatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns Compute. The Compute is compatible with
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param compute_name: The name of the compute associated with the Cognitive Services Account.
         Required.
        :type compute_name: str
        :param properties: The compute properties. Is one of the following types: ComputePatch, JSON,
         IO[bytes] Required.
        :type properties: ~azure.mgmt.cognitiveservices.models.ComputePatch or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns Compute. The Compute is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cognitiveservices.models.Compute]
        :raises ~azure.core.exceptions.HttpResponseError:
