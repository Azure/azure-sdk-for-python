...
from ...operations._outbound_rules_operations import build_post_request
...
class OutboundRulesOperations:
    ...
    async def _post_initial(
        ...
        body: Union[_models.ManagedNetworkSettingsBasicResource, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
    ...
    async def begin_post(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.cognitiveservices.models.ManagedNetworkSettingsBasicResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either OutboundRuleListResult or the result
         of cls(response)
        :rtype:
    ...
    async def begin_post(
        ...
        **kwargs: Any
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("OutboundRuleListResult", pipeline_response.http_response)
            if cls:
