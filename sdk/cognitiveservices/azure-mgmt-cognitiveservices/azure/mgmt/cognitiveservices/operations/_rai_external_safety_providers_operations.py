...
class RaiExternalSafetyProvidersOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.RaiExternalSafetyProviderSchema"]:
        ...
        :return: An iterator like instance of either RaiExternalSafetyProviderSchema or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.cognitiveservices.models.RaiExternalSafetyProviderSchema]
