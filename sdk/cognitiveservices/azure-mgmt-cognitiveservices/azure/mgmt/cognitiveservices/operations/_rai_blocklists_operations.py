...
class RaiBlocklistsOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("RaiBlocklist", pipeline_response)
    ...
    def create_or_update(
        ...
        account_name: str,
        rai_blocklist_name: str,
        rai_blocklist: Union[_models.RaiBlocklist, IO],
        **kwargs: Any
    ) -> _models.RaiBlocklist:
        """Update the state of specified blocklist associated with the Azure OpenAI account.
        ...
        :type rai_blocklist: ~azure.mgmt.cognitiveservices.models.RaiBlocklist or IO
