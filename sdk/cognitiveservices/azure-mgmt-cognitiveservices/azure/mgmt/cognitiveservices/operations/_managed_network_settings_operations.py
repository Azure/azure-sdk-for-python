...
def build_get_request(
    resource_group_name: str, account_name: str, managed_network_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "managedNetworkName": _SERIALIZER.url(
            "managed_network_name", managed_network_name, "str", pattern=r"^[a-zA-Z0-9][a-zA-Z0-9_-]{2,32}$"
        ),
    }
...
class ManagedNetworkSettingsOperations:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.cognitiveservices.models.ManagedNetworkSettingsPropertiesBasicResource
        ...
        deserialized = self._deserialize(
            "ManagedNetworkSettingsPropertiesBasicResource", pipeline_response.http_response
        )
    ...
    def _patch_initial(
        ...
        body: Optional[Union[_models.ManagedNetworkSettingsPropertiesBasicResource, IO[bytes]]] = None,
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_patch(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.cognitiveservices.models.ManagedNetworkSettingsPropertiesBasicResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _put_initial(
        ...
        account_name: str,
        managed_network_name: str,
        body: Union[_models.ManagedNetworkSettingsPropertiesBasicResource, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list(
        ...
        :param account_name: The name of Cognitive Services account. Required.
        :type account_name: str
        :return: An iterator like instance of either ManagedNetworkSettingsPropertiesBasicResource or
         the result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.cognitiveservices.models.ManagedNetworkSettingsPropertiesBasicResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.ManagedNetworkListResult] = kwargs.pop("cls", None)
