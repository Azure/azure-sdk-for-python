...
def build_get_request(safety_provider_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
...
def build_create_or_update_request(safety_provider_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_request(safety_provider_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class RaiExternalSafetyProviderOperations:
    ...
    @distributed_trace
    def get(self, safety_provider_name: str, **kwargs: Any) -> _models.RaiExternalSafetyProviderSchema:
    ...
    def _delete_initial(self, safety_provider_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def begin_delete(self, safety_provider_name: str, **kwargs: Any) -> LROPoller[None]:
