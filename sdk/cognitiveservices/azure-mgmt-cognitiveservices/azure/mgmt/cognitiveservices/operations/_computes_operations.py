...
class ComputesOperations:
    ...
    def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> ItemPaged["_models.Compute"]:
        ...
        :return: An iterator like instance of either Compute or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.cognitiveservices.models.Compute]
        ...
        cls: ClsType[_models.ComputeListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ComputeListResult", pipeline_response)
    ...
    def get(self, resource_group_name: str, account_name: str, compute_name: str, **kwargs: Any) -> _models.Compute:
        ...
        :return: Compute or the result of cls(response)
        ...
        deserialized = self._deserialize("Compute", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        account_name: str,
        compute_name: str,
        compute: Union[_models.Compute, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(compute, (IOBase, bytes)):
            _content = compute
        else:
            _json = self._serialize.body(compute, "Compute")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param compute_name: The name of the compute associated with the Cognitive Services Account.
         Required.
        :type compute_name: str
        :param compute: The compute properties. Required.
        :type compute: ~azure.mgmt.cognitiveservices.models.Compute
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Compute or the result of cls(response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param compute_name: The name of the compute associated with the Cognitive Services Account.
         Required.
        :type compute_name: str
        :param compute: The compute properties. Is either a Compute type or a IO[bytes] type. Required.
        :type compute: ~azure.mgmt.cognitiveservices.models.Compute or IO[bytes]
        :return: An instance of LROPoller that returns either Compute or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.cognitiveservices.models.Compute]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
