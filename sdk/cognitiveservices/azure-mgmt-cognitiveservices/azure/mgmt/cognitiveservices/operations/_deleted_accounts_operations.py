...
class DeletedAccountsOperations(object):
    ...
    def get(
            self, location, resource_group_name, account_name, custom_headers=None, raw=False, **operation_config):
    ...
    def purge(
            self, location, resource_group_name, account_name, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    purge.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.CognitiveServices/locations/{location}/resourceGroups/{resourceGroupName}/deletedAccounts/{accountName}'}
