...
def build_get_request(
    resource_group_name: str, account_name: str, rai_topic_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "raiTopicName": _SERIALIZER.url(
            "rai_topic_name", rai_topic_name, "str", pattern=r"^[a-zA-Z0-9][a-zA-Z0-9_.-]*$"
        ),
    }
...
class RaiTopicsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, account_name: str, rai_topic_name: str, **kwargs: Any) -> _models.RaiTopic:
        ...
        :return: RaiTopic or the result of cls(response)
        ...
        cls: ClsType[_models.RaiTopic] = kwargs.pop("cls", None)

        _request = build_get_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
            rai_topic_name=rai_topic_name,
        ...
        deserialized = self._deserialize("RaiTopic", pipeline_response.http_response)
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type rai_topic: ~azure.mgmt.cognitiveservices.models.RaiTopic
    ...
    def create_or_update(
        ...
        account_name: str,
        rai_topic_name: str,
        rai_topic: Union[_models.RaiTopic, IO[bytes]],
        **kwargs: Any
    ) -> _models.RaiTopic:
        """Create the rai topic associated with the Azure OpenAI account.
        ...
        :param rai_topic: Properties describing the rai topic. Is either a RaiTopic type or a IO[bytes]
         type. Required.
        :type rai_topic: ~azure.mgmt.cognitiveservices.models.RaiTopic or IO[bytes]
        :return: RaiTopic or the result of cls(response)
        :rtype: ~azure.mgmt.cognitiveservices.models.RaiTopic
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _json = None
        _content = None
        if isinstance(rai_topic, (IOBase, bytes)):
            _content = rai_topic
        else:
            _json = self._serialize.body(rai_topic, "RaiTopic")
    ...
    def _delete_initial(
        self, resource_group_name: str, account_name: str, rai_topic_name: str, **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    @distributed_trace
    def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> ItemPaged["_models.RaiTopic"]:
        ...
        :param account_name: The name of Cognitive Services account. Required.
        :type account_name: str
        :return: An iterator like instance of either RaiTopic or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.cognitiveservices.models.RaiTopic]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.RaiTopicResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("RaiTopicResult", pipeline_response)
