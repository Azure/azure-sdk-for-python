...
def build_provision_managed_network_request(
    resource_group_name: str, account_name: str, subscription_id: str, *, json: Optional[JSON] = None, **kwargs: Any
) -> HttpRequest:
...
class ManagedNetworkProvisionsOperations:
    ...
    def _provision_managed_network_initial(
        self, resource_group_name: str, account_name: str, body: Optional[JSON] = None, **kwargs: Any
    ) -> Iterator[bytes]:
    ...
    def begin_provision_managed_network(
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.cognitiveservices.models.ManagedNetworkProvisionStatus]
