...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.CognitiveServices/quotaTiers"
    )
...
def build_get_request(default: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class QuotaTiersOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.QuotaTier"]:
        """Returns all the resources of a particular type belonging to a subscription.

        :return: An iterator like instance of either QuotaTier or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.cognitiveservices.models.QuotaTier]
        ...
        cls: ClsType[_models.QuotaTierListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("QuotaTierListResult", pipeline_response)
    ...
    @distributed_trace
    def get(self, default: str, **kwargs: Any) -> _models.QuotaTier:
    ...
    @distributed_trace
    def update(self, default: str, tier: Union[_models.QuotaTier, IO[bytes]], **kwargs: Any) -> _models.QuotaTier:
        """Updates the Quota Tier resource for a subscription. The only properties that can be updated are
        "tierUpgradePolicy".
