...
def build_delete_request(
    resource_group_name: str, account_name: str, capability_host_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class AccountCapabilityHostsOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> ItemPaged["_models.CapabilityHost"]:
        """List capabilityHost.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.cognitiveservices.models.CapabilityHost]
