...
from ...operations._operations_discovery_operations import build_get_request
...
class OperationsDiscoveryOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`operations_discovery` attribute.
    """
    ...
    async def get(self, **kwargs: Any) -> _models.OperationsDiscoveryCollection:
        """get.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: OperationsDiscoveryCollection or the result of cls(response)
        :rtype: ~azure.mgmt.resourcemover.models.OperationsDiscoveryCollection
