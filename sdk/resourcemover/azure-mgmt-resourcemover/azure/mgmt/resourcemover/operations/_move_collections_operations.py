...
def build_list_move_collections_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class MoveCollectionsOperations:
    ...
    def begin_prepare(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._prepare_initial(  # type: ignore
                resource_group_name=resource_group_name,
                move_collection_name=move_collection_name,
                body=body,
                api_version=api_version,
    ...
    def begin_initiate_move(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._initiate_move_initial(  # type: ignore
                resource_group_name=resource_group_name,
                move_collection_name=move_collection_name,
                body=body,
                api_version=api_version,
    ...
    def begin_discard(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._discard_initial(  # type: ignore
                resource_group_name=resource_group_name,
                move_collection_name=move_collection_name,
                body=body,
                api_version=api_version,
    ...
    def begin_resolve_dependencies(
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._resolve_dependencies_initial(  # type: ignore
                resource_group_name=resource_group_name,
                move_collection_name=move_collection_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
    ...
    def begin_bulk_remove(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._bulk_remove_initial(  # type: ignore
                resource_group_name=resource_group_name,
                move_collection_name=move_collection_name,
                body=body,
                api_version=api_version,
