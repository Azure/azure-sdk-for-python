...
def build_get_request(
    ...
    **kwargs: Any
    ...
    if dependency_level is not None:
        _params["dependencyLevel"] = _SERIALIZER.query("dependency_level", dependency_level, "str")
...
class UnresolvedDependenciesOperations:
    ...
    def get(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.UnresolvedDependency"]:
        ...
        :return: An iterator like instance of either UnresolvedDependency or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.resourcemover.models.UnresolvedDependency]
