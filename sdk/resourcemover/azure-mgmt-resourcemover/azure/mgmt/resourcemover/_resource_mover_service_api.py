...
class ResourceMoverServiceAPI:  # pylint: disable=client-accepts-api-version-keyword
    """A first party Azure service orchestrating the move of Azure resources from one Azure region to
    ...
    :vartype unresolved_dependencies:
     azure.mgmt.resourcemover.operations.UnresolvedDependenciesOperations
    :ivar operations_discovery: OperationsDiscoveryOperations operations
    :vartype operations_discovery:
     azure.mgmt.resourcemover.operations.OperationsDiscoveryOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = ResourceMoverServiceAPIConfiguration(
    ...
    def __enter__(self) -> "ResourceMoverServiceAPI":
