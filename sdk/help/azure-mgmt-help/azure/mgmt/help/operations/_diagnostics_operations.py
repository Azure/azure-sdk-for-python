...
class DiagnosticsOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        """:code:`<p><b>Overview:</b></p>`:code:`<p>Azure Help API programmatically helps you troubleshoot
        Azure issues and provides access to rich and powerful self-help solutions and diagnostics.
        Using the API, you can perform the following operations: <table><tr><td>Solution
        Discovery</td><td>Lists the diagnostics for an Azure issue based on the
        prerequisites.</td></tr><tr><td>Diagnostics</td><td>Create and Get diagnostics for issues with
        Azure resources based on prerequisites (see
        below).</td></tr></table></p>`:code:`<p>`:code:`<b>Prerequisites for Diagnostics:</b>`
        :code:`<br/>` :code:`<br/>` The diagnostics API is called after solutions discovery and returns
        diagnostic info for your Azure issue. :code:`<br/>` :code:`<br/>`You must have :code:`<a
        href="https://learn.microsoft.com/en-us/azure/role-based-access-control/built-in-roles#reader">reader
        access role </a>` at the resource level to create diagnostics. :code:`<br/>` :code:`<br/>`
        ...
        :return: An instance of LROPoller that returns either DiagnosticResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.help.models.DiagnosticResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        :type diagnostic_resource_request: ~azure.mgmt.help.models.DiagnosticResource or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get(self, **kwargs: Any) -> _models.DiagnosticResource:
        ...
        diagnostic info for your Azure issue. :code:`<br/>` :code:`<br/>`You must have :code:`<a
        href="https://learn.microsoft.com/en-us/azure/role-based-access-control/built-in-roles#reader">reader
        access role </a>` at the resource level to get the diagnostics. :code:`<br/>` :code:`<br/>`
        'RequiredParameterSets' from Discovery Solutions API response has to be passed via
        'properties.insights.additionalParameters' as a key-value pairs to Diagnostics Api.
