    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword status: Denotes the status of the diagnostic resource. Known values are: "Failed",
         "MissingInputs", "Running", "Succeeded", and "Timeout".
        :paramtype status: str or ~azure.mgmt.help.models.Status
        :keyword insights: The problems (if any) detected by this insight.
        :paramtype insights: list[~azure.mgmt.help.models.Insight]
        :keyword error: Error definition.
        :paramtype error: ~azure.mgmt.help.models.Error
        """
        super().__init__(**kwargs)
...
class DiagnosticResource(ProxyResource):
    ...
    :vartype provisioning_state: str or ~azure.mgmt.help.models.ProvisioningState
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype insights: list[~azure.mgmt.help.models.DiagnosticInvocation]
        """
        super().__init__(**kwargs)
...
class DiscoveryResponse(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.help.models.SolutionMetadata]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.help.models.SolutionMetadata]
...
class Error(_serialization.Model):
    ...
    def __init__(self, *, details: Optional[List["_models.Error"]] = None, **kwargs: Any) -> None:
        ...
        :keyword details: An array of additional nested error response info objects, as described by
         this contract.
        :paramtype details: list[~azure.mgmt.help.models.Error]
        """
        super().__init__(**kwargs)
        self.code = None
        self.type = None
...
class ErrorResponse(_serialization.Model):
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.help.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword importance_level: Importance level of the insight. Known values are: "Critical",
         "Warning", and "Information".
        :paramtype importance_level: str or ~azure.mgmt.help.models.ImportanceLevel
        """
        super().__init__(**kwargs)
        self.id = id
        self.title = title
...
class Operation(_serialization.Model):
    ...
    def __init__(self, *, display: Optional["_models.OperationDisplay"] = None, **kwargs: Any) -> None:
        ...
        :paramtype display: ~azure.mgmt.help.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name = None
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.help.models.Operation]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~azure.mgmt.help.models.CreatedByType
        ...
        :paramtype last_modified_by_type: str or ~azure.mgmt.help.models.CreatedByType
