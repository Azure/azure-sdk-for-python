...
def main():
    ...
    try:
        color_setting = client.get_configuration_setting(os.environ['API_LEARN_SETTING_COLOR_KEY'])
        color = color_setting.value.upper()
        text_setting = client.get_configuration_setting(os.environ['API_LEARN_SETTING_TEXT_KEY'])
