...
class DeveloperHubServiceClient(
    ...
    :vartype operations: azure.mgmt.devhub.aio.operations.Operations
    :ivar workflow: WorkflowOperations operations
    :vartype workflow: azure.mgmt.devhub.aio.operations.WorkflowOperations
    ...
    async def __aenter__(self) -> "DeveloperHubServiceClient":
