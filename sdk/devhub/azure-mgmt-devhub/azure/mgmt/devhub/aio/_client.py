...
class DevHubClient(_DevHubClientOperationsMixin):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype iac_profiles: azure.mgmt.devhub.aio.operations.IacProfilesOperations
    ...
    :vartype adoo_auth: azure.mgmt.devhub.aio.operations.ADOOAuthOperations
    :ivar template: TemplateOperations operations
    :vartype template: azure.mgmt.devhub.aio.operations.TemplateOperations
    :ivar versioned_template: VersionedTemplateOperations operations
    :vartype versioned_template: azure.mgmt.devhub.aio.operations.VersionedTemplateOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = DevHubClientConfiguration(
