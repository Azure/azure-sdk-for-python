...
class Workflow(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar auth_status: Determines the type of manifests within the repository. Known values are:
     "helm" and "kube".
    :vartype auth_status: str or ~azure.mgmt.devhub.models.ManifestType
    """
    ...
    def __init__(
        ...
        *,
        ...
        auth_status: Optional[Union[str, "_models.ManifestType"]] = None,
        **kwargs
    ):
        """
        :keyword tags: Resource tags.
        ...
        :keyword auth_status: Determines the type of manifests within the repository. Known values are:
         "helm" and "kube".
        :paramtype auth_status: str or ~azure.mgmt.devhub.models.ManifestType
        """
