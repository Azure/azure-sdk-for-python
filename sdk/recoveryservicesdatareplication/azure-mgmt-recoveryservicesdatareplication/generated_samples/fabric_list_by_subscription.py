...
from azure.mgmt.recoveryservicesdatareplication import AzureSiteRecoveryManagementServiceAPI
...
# USAGE
    python fabric_list_by_subscription.py
...
def main():
    ...
    response = client.fabric.list_by_subscription()
