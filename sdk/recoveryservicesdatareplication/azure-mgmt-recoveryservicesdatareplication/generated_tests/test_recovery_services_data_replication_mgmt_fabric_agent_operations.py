...
class TestRecoveryServicesDataReplicationMgmtFabricAgentOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(RecoveryServicesDataReplicationMgmtClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_fabric_agent_get(self, resource_group):
        response = self.client.fabric_agent.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_fabric_agent_begin_create(self, resource_group):
        response = self.client.fabric_agent.begin_create(
            resource_group_name=resource_group.name,
            fabric_name="str",
            fabric_agent_name="str",
            resource={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_fabric_agent_begin_delete(self, resource_group):
        response = self.client.fabric_agent.begin_delete(
            resource_group_name=resource_group.name,
            fabric_name="str",
            fabric_agent_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_fabric_agent_list(self, resource_group):
