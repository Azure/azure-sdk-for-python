...
class TestRecoveryServicesDataReplicationMgmtProtectedItemOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(RecoveryServicesDataReplicationMgmtClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_protected_item_get(self, resource_group):
        response = await self.client.protected_item.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_protected_item_begin_create(self, resource_group):
        response = await (
            await self.client.protected_item.begin_create(
                resource_group_name=resource_group.name,
                vault_name="str",
                protected_item_name="str",
                resource={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_protected_item_begin_update(self, resource_group):
        response = await (
            await self.client.protected_item.begin_update(
                resource_group_name=resource_group.name,
                vault_name="str",
                protected_item_name="str",
                properties={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_protected_item_begin_delete(self, resource_group):
        response = await (
            await self.client.protected_item.begin_delete(
                resource_group_name=resource_group.name,
                vault_name="str",
                protected_item_name="str",
            )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_protected_item_list(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_protected_item_begin_planned_failover(self, resource_group):
        response = await (
            await self.client.protected_item.begin_planned_failover(
                resource_group_name=resource_group.name,
                vault_name="str",
                protected_item_name="str",
