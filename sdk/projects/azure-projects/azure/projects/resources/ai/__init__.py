...
from typing import TYPE_CHECKING, Any, Callable, Dict, Generator, List, Literal, Mapping, Type, TypedDict, Union, Unpack, Optional, overload
...
_DEFAULT_AI_SERVICES_EXTENSIONS: ExtensionResources = {
    'managed_identity_roles': ['Cognitive Services OpenAI Contributor', 'Cognitive Services Contributor', 'Cognitive Services OpenAI User', 'Cognitive Services User'],
    'user_roles': ['Cognitive Services OpenAI Contributor', 'Cognitive Services Contributor', 'Cognitive Services OpenAI User', 'Cognitive Services User']
}
