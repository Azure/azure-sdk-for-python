...
class StorageAccountAzureFilesIdentityBasedAuthentication(TypedDict, total=False):
    ...
    defaultSharePermission: Union[Literal['StorageFileDataSmbShareElevatedContributor', 'None', 'StorageFileDataSmbShareReader', 'StorageFileDataSmbShareContributor'], Parameter]
...
class StorageAccountEncryption(TypedDict, total=False):
    identity: Union[StorageAccountEncryption, Parameter]
    ...
    services: Union[StorageAccountEncryption, Parameter]
...
class StorageAccountEncryptionServices(TypedDict, total=False):
    blob: Union[StorageAccountEncryption, Parameter]
    """The encryption function of the blob storage service."""
    file: Union[StorageAccountEncryption, Parameter]
    """The encryption function of the file storage service."""
    queue: Union[StorageAccountEncryption, Parameter]
    """The encryption function of the queue storage service."""
    table: Union[StorageAccountEncryption, Parameter]
...
class StorageAccountIdentity(TypedDict, total=False):
    type: Union[Literal['None', 'SystemAssigned,UserAssigned', 'UserAssigned', 'SystemAssigned'], Parameter]
    """The identity type."""
...
class StorageAccountResource(TypedDict, total=False):
    ...
    identity: Union[StorageAccountIdentity, Parameter]
    ...
    name: Union[str, Parameter]
    """The resource name"""
    properties: Union[StorageAccountPropertiesCreateParametersOrStorageAccountProperties, Parameter]
...
class StorageAccountSku(TypedDict, total=False):
    name: Union[Literal['PremiumV2_LRS', 'Standard_ZRS', 'PremiumV2_ZRS', 'StandardV2_GZRS', 'Standard_GZRS', 'Standard_GRS', 'Standard_LRS', 'Standard_RAGZRS', 'Standard_RAGRS', 'Premium_ZRS', 'Premium_LRS', 'StandardV2_GRS', 'StandardV2_LRS', 'StandardV2_ZRS'], Parameter]
    """The SKU name. Required for account creation; optional for update. Note that in older versions, SKU name was called accountType."""


class StorageAccountPropertiesCreateParametersOrStorageAccountProperties(TypedDict, total=False):
