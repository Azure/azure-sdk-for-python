...
class ContainerProperties(TypedDict, total=False):
    defaultEncryptionScope: Union[str, Parameter[str]]
    """Default the container to use specified encryption scope for all writes."""
    denyEncryptionScopeOverride: Union[bool, Parameter[bool]]
    """Block override of encryption scope from the container default."""
    enableNfsV3AllSquash: Union[bool, Parameter[bool]]
    """Enable NFSv3 all squash on blob container."""
    enableNfsV3RootSquash: Union[bool, Parameter[bool]]
...
class ContainerResource(TypedDict, total=False):
    ...
    """The resource name."""
    properties: Union[ContainerProperties, Parameter[ContainerProperties]]
