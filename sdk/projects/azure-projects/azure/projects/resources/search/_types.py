...
class SearchServiceIdentity(TypedDict, total=False):
    type: Union[Literal['SystemAssigned, UserAssigned', 'None', 'SystemAssigned', 'UserAssigned'], Parameter]
...
class SearchServiceResource(TypedDict, total=False):
    identity: Union[SearchServiceIdentity, Parameter]
    """The identity of the resource."""
    location: Union[str, Parameter]
    """The geo-location where the resource lives"""
    name: Union[str, Parameter]
    """The resource name"""
    properties: Union[SearchServiceProperties, Parameter]
...
class SearchServiceSku(TypedDict, total=False):
    name: Union[Literal['storage_optimized_l1', 'free', 'storage_optimized_l2', 'basic', 'standard3', 'standard', 'standard2'], Parameter]
