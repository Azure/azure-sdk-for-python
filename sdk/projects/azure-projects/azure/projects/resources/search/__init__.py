...
class SearchServiceKwargs(TypedDict, total=False):
    ...
    roles: Union[Parameter[List[Union[str, 'RoleAssignment']]], List[Union[Parameter[Union[str, 'RoleAssignment']], 'RoleAssignment', Literal['Contributor', 'Owner', 'Reader', 'Role Based Access Control Administrator', 'Search Index Data Contributor', 'Search Index Data Reader', 'Search Service Contributor', 'User Access Administrator']]]]
    """Array of role assignments to create."""
    user_roles: Union[Parameter[List[Union[str, 'RoleAssignment']]], List[Union[Parameter[Union[str, 'RoleAssignment']], 'RoleAssignment', Literal['Contributor', 'Owner', 'Reader', 'Role Based Access Control Administrator', 'Search Index Data Contributor', 'Search Index Data Reader', 'Search Service Contributor', 'User Access Administrator']]]]
...
_DEFAULT_SEARCH_SERVICE_EXTENSIONS: ExtensionResources = {
    'managed_identity_roles': ['Search Index Data Contributor', 'Search Index Data Reader', 'Search Service Contributor'],
...
class SearchService(_ClientResource[SearchServiceResourceType]):
    ...
    def _outputs(self, *, symbol: ResourceSymbol, **kwargs) -> Dict[str, Output]:
        ...
        outputs['endpoint'] = Output(
            f"AZURE_SEARCH_ENDPOINT{self._suffix}",
