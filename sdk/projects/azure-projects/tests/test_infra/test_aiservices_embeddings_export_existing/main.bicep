...
output AZURE_AI_EMBEDDINGS_ID_R string = test_module.outputs.AZURE_AI_EMBEDDINGS_ID_R
output AZURE_AI_EMBEDDINGS_NAME_R string = test_module.outputs.AZURE_AI_EMBEDDINGS_NAME_R
output AZURE_AI_EMBEDDINGS_RESOURCE_GROUP_R string = test_module.outputs.AZURE_AI_EMBEDDINGS_RESOURCE_GROUP_R
output AZURE_AI_EMBEDDINGS_MODEL_NAME_R string = test_module.outputs.AZURE_AI_EMBEDDINGS_MODEL_NAME_R
output AZURE_AI_EMBEDDINGS_MODEL_VERSION_R string = test_module.outputs.AZURE_AI_EMBEDDINGS_MODEL_VERSION_R
output AZURE_AI_EMBEDDINGS_MODEL_FORMAT_R string = test_module.outputs.AZURE_AI_EMBEDDINGS_MODEL_FORMAT_R
output AZURE_AI_EMBEDDINGS_ENDPOINT_R string = test_module.outputs.AZURE_AI_EMBEDDINGS_ENDPOINT_R
