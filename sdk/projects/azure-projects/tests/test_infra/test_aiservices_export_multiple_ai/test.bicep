...
output AZURE_AI_AISERVICES_ID_R1 string = aiservices_account.id
output AZURE_AI_AISERVICES_NAME_R1 string = aiservices_account.name
output AZURE_AI_AISERVICES_RESOURCE_GROUP_R1 string = resourceGroup().name
output AZURE_AI_AISERVICES_ENDPOINT_R1 string = aiservices_account.properties.endpoint
...
resource keyvalue_azureaiaiservicesidr1 'Microsoft.AppConfiguration/configurationStores/keyValues@2024-05-01' = {
  parent: configurationstore
  name: 'AZURE_AI_AISERVICES_ID_R1'
  properties: {
...
resource keyvalue_azureaiaiservicesnamer1 'Microsoft.AppConfiguration/configurationStores/keyValues@2024-05-01' = {
  parent: configurationstore
  name: 'AZURE_AI_AISERVICES_NAME_R1'
  properties: {
...
resource keyvalue_azureaiaiservicesresourcegroupr1 'Microsoft.AppConfiguration/configurationStores/keyValues@2024-05-01' = {
  parent: configurationstore
  name: 'AZURE_AI_AISERVICES_RESOURCE_GROUP_R1'
  properties: {
    value: resourceGroup().name
  }
}
...
resource keyvalue_azureaiaiservicesendpointr1 'Microsoft.AppConfiguration/configurationStores/keyValues@2024-05-01' = {
  parent: configurationstore
  name: 'AZURE_AI_AISERVICES_ENDPOINT_R1'
  properties: {
