...
output AZURE_AI_AISERVICES_ID_R1 string = test_module.outputs.AZURE_AI_AISERVICES_ID_R1
output AZURE_AI_AISERVICES_NAME_R1 string = test_module.outputs.AZURE_AI_AISERVICES_NAME_R1
output AZURE_AI_AISERVICES_RESOURCE_GROUP_R1 string = test_module.outputs.AZURE_AI_AISERVICES_RESOURCE_GROUP_R1
output AZURE_AI_AISERVICES_ENDPOINT_R1 string = test_module.outputs.AZURE_AI_AISERVICES_ENDPOINT_R1
