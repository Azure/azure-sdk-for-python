...
output AZURE_APPCONFIG_ID_FOO string = test_module.outputs.AZURE_APPCONFIG_ID_FOO
output AZURE_APPCONFIG_NAME_FOO string = test_module.outputs.AZURE_APPCONFIG_NAME_FOO
output AZURE_APPCONFIG_RESOURCE_GROUP_FOO string = test_module.outputs.AZURE_APPCONFIG_RESOURCE_GROUP_FOO
output AZURE_APPCONFIG_ENDPOINT_FOO string = test_module.outputs.AZURE_APPCONFIG_ENDPOINT_FOO
