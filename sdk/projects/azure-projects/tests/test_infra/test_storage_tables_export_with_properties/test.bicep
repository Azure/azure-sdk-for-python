...
resource roleassignment_pdulwkqtpbkczpbgmuoo 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid('MicrosoftStoragestorageAccountstableServices', environmentName, storageaccount.name, 'default', 'ServicePrincipal', 'Storage Table Data Contributor')
  properties: {
    principalId: userassignedidentity.properties.principalId
    principalType: 'ServicePrincipal'
    roleDefinitionId: subscriptionResourceId(
...
resource roleassignment_rmorilkwsbkqrzhauhli 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid('MicrosoftStoragestorageAccountstableServices', environmentName, storageaccount.name, 'default', 'User', 'Storage Table Data Contributor')
  properties: {
    principalId: principalId
    principalType: 'User'
    roleDefinitionId: subscriptionResourceId(
