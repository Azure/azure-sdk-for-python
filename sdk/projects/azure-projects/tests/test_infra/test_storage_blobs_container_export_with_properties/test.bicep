...
resource keyvalue_azureblobcontaineridfoo 'Microsoft.AppConfiguration/configurationStores/keyValues@2024-05-01' = {
  parent: configurationstore
  name: 'AZURE_BLOB_CONTAINER_ID_FOO'
  properties: {
...
resource keyvalue_azureblobcontainernamefoo 'Microsoft.AppConfiguration/configurationStores/keyValues@2024-05-01' = {
  parent: configurationstore
  name: 'AZURE_BLOB_CONTAINER_NAME_FOO'
  properties: {
...
resource keyvalue_azureblobcontainerresourcegroupfoo 'Microsoft.AppConfiguration/configurationStores/keyValues@2024-05-01' = {
  parent: configurationstore
  name: 'AZURE_BLOB_CONTAINER_RESOURCE_GROUP_FOO'
  properties: {
    value: resourceGroup().name
  }
}
...
resource keyvalue_azureblobcontainerendpointfoo 'Microsoft.AppConfiguration/configurationStores/keyValues@2024-05-01' = {
  parent: configurationstore
  name: 'AZURE_BLOB_CONTAINER_ENDPOINT_FOO'
  properties: {
