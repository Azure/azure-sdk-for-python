...
output AZURE_AI_EMBEDDINGS_ID_B string = test_module.outputs.AZURE_AI_EMBEDDINGS_ID_B
output AZURE_AI_EMBEDDINGS_NAME_B string = test_module.outputs.AZURE_AI_EMBEDDINGS_NAME_B
output AZURE_AI_EMBEDDINGS_RESOURCE_GROUP_B string = test_module.outputs.AZURE_AI_EMBEDDINGS_RESOURCE_GROUP_B
output AZURE_AI_EMBEDDINGS_MODEL_NAME_B string = test_module.outputs.AZURE_AI_EMBEDDINGS_MODEL_NAME_B
output AZURE_AI_EMBEDDINGS_MODEL_VERSION_B string = test_module.outputs.AZURE_AI_EMBEDDINGS_MODEL_VERSION_B
output AZURE_AI_EMBEDDINGS_MODEL_FORMAT_B string = test_module.outputs.AZURE_AI_EMBEDDINGS_MODEL_FORMAT_B
output AZURE_AI_EMBEDDINGS_ENDPOINT_B string = test_module.outputs.AZURE_AI_EMBEDDINGS_ENDPOINT_B
