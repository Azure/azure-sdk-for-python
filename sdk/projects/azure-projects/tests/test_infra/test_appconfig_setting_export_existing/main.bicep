...
output AZURE_APPCONFIG_ID_CONFIGTEST string = test_module.outputs.AZURE_APPCONFIG_ID_CONFIGTEST
output AZURE_APPCONFIG_NAME_CONFIGTEST string = test_module.outputs.AZURE_APPCONFIG_NAME_CONFIGTEST
output AZURE_APPCONFIG_RESOURCE_GROUP_CONFIGTEST string = test_module.outputs.AZURE_APPCONFIG_RESOURCE_GROUP_CONFIGTEST
output AZURE_APPCONFIG_ENDPOINT_CONFIGTEST string = test_module.outputs.AZURE_APPCONFIG_ENDPOINT_CONFIGTEST
