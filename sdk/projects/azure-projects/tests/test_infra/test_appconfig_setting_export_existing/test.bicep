...
output AZURE_APPCONFIG_ID_CONFIGTEST string = configurationstore_configtest.id
output AZURE_APPCONFIG_NAME_CONFIGTEST string = configurationstore_configtest.name
output AZURE_APPCONFIG_RESOURCE_GROUP_CONFIGTEST string = resourceGroup().name
output AZURE_APPCONFIG_ENDPOINT_CONFIGTEST string = configurationstore_configtest.properties.endpoint
