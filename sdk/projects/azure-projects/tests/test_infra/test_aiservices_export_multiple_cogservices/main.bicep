...
output AZURE_AI_METRICSADVISOR_ID_C string = test_module.outputs.AZURE_AI_METRICSADVISOR_ID_C
output AZURE_AI_METRICSADVISOR_NAME_C string = test_module.outputs.AZURE_AI_METRICSADVISOR_NAME_C
output AZURE_AI_METRICSADVISOR_RESOURCE_GROUP_C string = test_module.outputs.AZURE_AI_METRICSADVISOR_RESOURCE_GROUP_C
output AZURE_AI_METRICSADVISOR_ENDPOINT_C string = test_module.outputs.AZURE_AI_METRICSADVISOR_ENDPOINT_C
