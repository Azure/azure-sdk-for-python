...
output AZURE_KEYVAULT_ID_FOO string = test_module.outputs.AZURE_KEYVAULT_ID_FOO
output AZURE_KEYVAULT_NAME_FOO string = test_module.outputs.AZURE_KEYVAULT_NAME_FOO
output AZURE_KEYVAULT_RESOURCE_GROUP_FOO string = test_module.outputs.AZURE_KEYVAULT_RESOURCE_GROUP_FOO
output AZURE_KEYVAULT_ENDPOINT_FOO string = test_module.outputs.AZURE_KEYVAULT_ENDPOINT_FOO
