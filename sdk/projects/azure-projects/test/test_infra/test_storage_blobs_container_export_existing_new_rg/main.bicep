...
output AZURE_BLOBS_ENDPOINT_STORAGETEST string = test_module.outputs.AZURE_BLOBS_ENDPOINT_STORAGETEST
output AZURE_BLOB_CONTAINER_ID_STORAGETEST_TEST string = test_module.outputs.AZURE_BLOB_CONTAINER_ID_STORAGETEST_TEST
output AZURE_BLOB_CONTAINER_NAME_STORAGETEST_TEST string = test_module.outputs.AZURE_BLOB_CONTAINER_NAME_STORAGETEST_TEST
output AZURE_BLOB_CONTAINER_RESOURCE_GROUP_STORAGETEST_TEST string = test_module.outputs.AZURE_BLOB_CONTAINER_RESOURCE_GROUP_STORAGETEST_TEST
output AZURE_BLOB_CONTAINER_ENDPOINT_STORAGETEST_TEST string = test_module.outputs.AZURE_BLOB_CONTAINER_ENDPOINT_STORAGETEST_TEST
