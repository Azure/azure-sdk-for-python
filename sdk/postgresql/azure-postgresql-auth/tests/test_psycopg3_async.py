...
class TestPsycopg3AsyncEntraConnectionLive:
    ...
    @pytest.mark.asyncio
    async def test_token_caching_behavior_async(self, connection_params, async_credential):
        """Test that credentials are invoked for each connection (async)."""
        # First connection
        async with await AsyncEntraConnection.connect(**connection_params, credential=async_credential) as conn1:
        ...
        # Second connection
        async with await AsyncEntraConnection.connect(**connection_params, credential=async_credential) as conn2:
