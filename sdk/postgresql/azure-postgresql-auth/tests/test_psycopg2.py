...
class TestPsycopg2EntraConnectionLive:
    ...
    def test_token_caching_behavior(self, connection_dsn, credential):
        """Test that credentials are invoked for each connection."""
        # First connection
        with EntraConnection(connection_dsn, credential=credential) as conn1:
        ...
        # Second connection
        with EntraConnection(connection_dsn, credential=credential) as conn2:
