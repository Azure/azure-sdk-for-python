...
class PostgreSQLManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.postgresql.aio.operations.Operations
    :ivar migrations: MigrationsOperations operations
    :vartype migrations: azure.mgmt.postgresql.aio.operations.MigrationsOperations
    :ivar servers: ServersOperations operations
    :vartype servers: azure.mgmt.postgresql.aio.operations.ServersOperations
    :ivar configurations: ConfigurationsOperations operations
    :vartype configurations: azure.mgmt.postgresql.aio.operations.ConfigurationsOperations
    :ivar databases: DatabasesOperations operations
    :vartype databases: azure.mgmt.postgresql.aio.operations.DatabasesOperations
    :ivar firewall_rules: FirewallRulesOperations operations
    :vartype firewall_rules: azure.mgmt.postgresql.aio.operations.FirewallRulesOperations
    :ivar private_endpoint_connections: PrivateEndpointConnectionsOperations operations
    :vartype private_endpoint_connections:
     azure.mgmt.postgresql.aio.operations.PrivateEndpointConnectionsOperations
    :ivar private_link_resources: PrivateLinkResourcesOperations operations
    :vartype private_link_resources:
     azure.mgmt.postgresql.aio.operations.PrivateLinkResourcesOperations
    :ivar virtual_endpoints: VirtualEndpointsOperations operations
    :vartype virtual_endpoints: azure.mgmt.postgresql.aio.operations.VirtualEndpointsOperations
    ...
    :vartype administrators_microsoft_entra:
     azure.mgmt.postgresql.aio.operations.AdministratorsMicrosoftEntraOperations
    :ivar capabilities_by_server: CapabilitiesByServerOperations operations
    :vartype capabilities_by_server:
     azure.mgmt.postgresql.aio.operations.CapabilitiesByServerOperations
    :ivar captured_logs: CapturedLogsOperations operations
    :vartype captured_logs: azure.mgmt.postgresql.aio.operations.CapturedLogsOperations
    :ivar backups_long_term_retention: BackupsLongTermRetentionOperations operations
    :vartype backups_long_term_retention:
     azure.mgmt.postgresql.aio.operations.BackupsLongTermRetentionOperations
    :ivar replicas: ReplicasOperations operations
    :vartype replicas: azure.mgmt.postgresql.aio.operations.ReplicasOperations
    ...
    :vartype advanced_threat_protection_settings:
     azure.mgmt.postgresql.aio.operations.AdvancedThreatProtectionSettingsOperations
    ...
    :vartype server_threat_protection_settings:
     azure.mgmt.postgresql.aio.operations.ServerThreatProtectionSettingsOperations
    ...
    :vartype backups_automatic_and_on_demand:
     azure.mgmt.postgresql.aio.operations.BackupsAutomaticAndOnDemandOperations
    :ivar tuning_options: TuningOptionsOperations operations
    :vartype tuning_options: azure.mgmt.postgresql.aio.operations.TuningOptionsOperations
    :ivar capabilities_by_location: CapabilitiesByLocationOperations operations
    :vartype capabilities_by_location:
     azure.mgmt.postgresql.aio.operations.CapabilitiesByLocationOperations
    :ivar name_availability: NameAvailabilityOperations operations
    :vartype name_availability: azure.mgmt.postgresql.aio.operations.NameAvailabilityOperations
    :ivar private_dns_zone_suffix: PrivateDnsZoneSuffixOperations operations
    :vartype private_dns_zone_suffix:
     azure.mgmt.postgresql.aio.operations.PrivateDnsZoneSuffixOperations
    :ivar quota_usages: QuotaUsagesOperations operations
    :vartype quota_usages: azure.mgmt.postgresql.aio.operations.QuotaUsagesOperations
    :ivar virtual_network_subnet_usage: VirtualNetworkSubnetUsageOperations operations
    :vartype virtual_network_subnet_usage:
     azure.mgmt.postgresql.aio.operations.VirtualNetworkSubnetUsageOperations
