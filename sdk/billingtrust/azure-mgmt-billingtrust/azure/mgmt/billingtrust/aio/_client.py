...
class BillingTrustMgmtClient:
    ...
    :vartype operations: azure.mgmt.billingtrust.aio.operations.Operations
    :ivar assessments: AssessmentsOperations operations
    :vartype assessments: azure.mgmt.billingtrust.aio.operations.AssessmentsOperations
    :ivar rules: RulesOperations operations
    :vartype rules: azure.mgmt.billingtrust.aio.operations.RulesOperations
    ...
    :keyword api_version: The API version to use for this operation. Known values are
     "2026-03-17-preview" and None. Default value is None. If not set, the operation's default API
