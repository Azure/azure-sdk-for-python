"""Internal runtime domain models for response sessions and stream events."""
...
# Backward-compatible alias while implementation migrates to ResponseExecution naming.
ResponseSession = ResponseExecution
