...
class TestClassSplitTypeSafety:
    ...
    def test_both_classes_exported(self) -> None:
        """Task and MultiTurnTask are exported from durable.__all__."""
        import azure.ai.agentserver.core.durable as durable

        assert "Task" in durable.__all__
        assert "MultiTurnTask" in durable.__all__
