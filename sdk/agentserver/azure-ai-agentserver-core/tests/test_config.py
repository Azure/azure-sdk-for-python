...
class TestAgentConfigIsHosted:
    ...
    def test_is_hosted_false_when_env_var_absent(
    ...
    def test_is_hosted_false_when_env_var_empty(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_is_hosted_true_when_env_var_set(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_is_hosted_snapshotted_at_creation(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
