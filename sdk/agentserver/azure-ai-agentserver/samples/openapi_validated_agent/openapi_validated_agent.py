...
incoming requests and outgoing responses are validated automatically.
Invalid requests receive a 400 response before ``invoke`` is called,
and response validation warnings are logged.
