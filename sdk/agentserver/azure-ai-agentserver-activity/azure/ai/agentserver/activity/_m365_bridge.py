...
``CONNECTIONS__*`` mapping or caller-supplied components, synthesizes the per-turn
outbound claims, and binds the request handler that drives the Starlette
...
from ._constants import OutboundAuth
