#!/usr/bin/env python3
"""Rigorous crash-recovery proof for durable-responses-agent-demo.
...
def main():
    ...
    # 1. start a durable streaming run; stop streaming once 1 item is durably done
    b = rs.body("Research topic: the history of lighthouses [crash-proof]",
    ...
    recovered = (markers["recovered_task_active"] > 0
    ...
    verdict = {
        ...
        "reconnect_terminal": terminal, "crash_session": crash.get("session_id"),
        "markers": markers, "worker_instances": worker_instances,
        "taskmanager_instances": taskmgr_instances,
        "restart_proven": restarted, "recovery_proven": recovered,
        "log_lines": txt.count("\n"),
    }
