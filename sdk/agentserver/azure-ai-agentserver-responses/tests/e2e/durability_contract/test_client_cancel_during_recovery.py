...
The responses cancellation contract (``responses-durability-spec.md`` §10)
...
This module closes that gap with real signals only: a durable background
response is crashed (SIGKILL) and restarted so the durable-task primitive
