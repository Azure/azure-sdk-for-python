...
"""Durability-contract conformance suite (Spec 014).

This package contains behavioral tests that exercise every row × applicable
termination path of the documented durability matrix in
``sdk/agentserver/specs/durability-contract.md`` § The matrix.
...
- MUST NOT mock ``_crash_harness`` or fabricate ``DurabilityContext``.
