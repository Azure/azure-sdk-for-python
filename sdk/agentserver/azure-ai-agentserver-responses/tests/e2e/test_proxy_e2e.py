...
async def _emit_multi_output_handler(request: CreateResponse, context: ResponseContext):
...
async def _emit_failed_handler(request: CreateResponse, context: ResponseContext):
