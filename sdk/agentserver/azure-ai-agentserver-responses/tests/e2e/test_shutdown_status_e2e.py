...
async def test_shutdown_durable_background_not_marked_failed() -> None:
    ...
    def _stuck_handler(request: Any, context: Any, cancellation_signal: Any):
        async def _events():
...
async def test_shutdown_grace_period_allows_completion() -> None:
    ...
    def _responsive_handler(request: Any, context: Any, cancellation_signal: Any):
        async def _events():
            stream = ResponseEventStream(
                response_id=context.response_id,
                request=request,
...
async def test_shutdown_durable_responsive_handler_stays_in_progress() -> None:
    ...
    def _checkpoint_handler(request: Any, context: Any, cancellation_signal: Any):
        async def _events():
            stream = ResponseEventStream(
                response_id=context.response_id,
                request=request,
