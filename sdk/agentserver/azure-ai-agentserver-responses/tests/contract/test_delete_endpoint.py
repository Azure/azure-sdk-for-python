...
async def _throwing_bg_handler(request: Any, context: Any):
...
async def _throwing_after_created_bg_handler(request: Any, context: Any):
...
async def _incomplete_bg_handler(request: Any, context: Any):
