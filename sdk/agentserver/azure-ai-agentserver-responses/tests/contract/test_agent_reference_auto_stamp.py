...
async def _handler_with_output(request: Any, context: Any):
...
async def _handler_with_handler_set_agent_ref(request: Any, context: Any):
...
async def _direct_yield_handler(request: Any, context: Any):
