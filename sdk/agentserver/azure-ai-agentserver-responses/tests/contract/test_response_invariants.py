...
async def _output_item_handler(request: Any, context: Any):
...
def test_output_item__agent_reference_stamped_on_item() -> None:
    ...
    async def _handler_with_agent_ref(request: Any, context: Any):
...
async def _queued_then_completed_handler(request: Any, context: Any):
...
def test_background_queued_status_honoured_in_post_response() -> None:
    ...
    async def _queued_waiting_handler(request: Any, context: Any):
