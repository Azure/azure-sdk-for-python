...
class ComparisonFilter(TypedDict, total=False):
    ...
    :vartype type: Literal["eq", "ne", "gt", "gte", "lt", "lte"]
...
class CreateResponse(TypedDict, total=False):
    ...
    :vartype prompt_cache_retention: Literal["in-memory", "24h"]
...
class ImageGenTool(TypedDict, total=False):
    ...
    :vartype size: Literal["1024x1024", "1024x1536", "1536x1024", "auto"]
...
class ItemFieldFunctionShellCall(TypedDict, total=False):
    ...
    :vartype status: LocalShellCallStatus
...
class ItemFieldFunctionShellCallOutput(TypedDict, total=False):
    ...
    :ivar status: The status of the shell call output. One of ``in_progress``, ``completed``, or
     ``incomplete``. Required. Known values are: "in_progress", "completed", and "incomplete".
    :vartype status: LocalShellCallOutputStatusEnum
...
class CompactResponseMethodPublicBody(TypedDict, total=False):
    ...
    :ivar model: Required. Known values are: "gpt-5.2", "gpt-5.2-2025-12-11",
     "gpt-5.2-chat-latest", "gpt-5.2-pro", "gpt-5.2-pro-2025-12-11", "gpt-5.1",
     "gpt-5.1-2025-11-13", "gpt-5.1-codex", "gpt-5.1-mini", "gpt-5.1-chat-latest", "gpt-5",
     "gpt-5-mini", "gpt-5-nano", "gpt-5-2025-08-07", "gpt-5-mini-2025-08-07",
    ...
    """Required. Known values are: \"gpt-5.2\", \"gpt-5.2-2025-12-11\", \"gpt-5.2-chat-latest\",
     ...
     \"o1-preview\", \"o1-preview-2024-09-12\", \"o1-mini\", \"o1-mini-2024-09-12\", \"gpt-4o\",
