...
def _as_dict(obj: _Model | dict[str, Any]) -> dict[str, Any]:
    ...
    :param obj: The model or dictionary to convert.
    :type obj: ~azure.ai.agentserver.responses.models._generated.sdk.models._utils.model_base.Model
        or dict[str, Any]
    :return: A plain dictionary representation of *obj*.
    :rtype: dict[str, Any]
    """
