...
# ---------------------------------------------------------
"""Tests for session ID resolution over WebSocket (invocations_ws protocol)."""
import os
import uuid
...
def test_ws_invoke_with_session_id_in_message():
    """Invoke with session_id in message uses that value."""
...
def test_ws_invoke_uses_env_var():
...
def test_ws_get_invocation_no_session_id(ws_async_storage_client):
...
def test_ws_cancel_invocation_no_session_id(ws_async_storage_client):
