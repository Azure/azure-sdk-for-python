...
def test_ws_get_after_invoke_returns_stored_result(ws_async_storage_client):
...
def test_ws_get_unknown_id_returns_error(ws_async_storage_client):
...
def test_ws_cancel_after_invoke_returns_cancelled(ws_async_storage_client):
...
def test_ws_cancel_unknown_id_returns_error(ws_async_storage_client):
...
def test_ws_get_after_cancel_returns_error(ws_async_storage_client):
...
def test_ws_get_invocation_error_returns_internal_error():
...
def test_ws_cancel_invocation_error_returns_internal_error():
