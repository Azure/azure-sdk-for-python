...
@pytest.mark.asyncio
async def test_get_invocation_returns_501_default(echo_client):
    """GET /invocations/{id} returns 501 when not overridden."""
...
@pytest.mark.asyncio
async def test_cancel_invocation_returns_501_default(echo_client):
    """POST /invocations/{id}/cancel returns 501 when not overridden."""
    inv_id = str(uuid.uuid4())
