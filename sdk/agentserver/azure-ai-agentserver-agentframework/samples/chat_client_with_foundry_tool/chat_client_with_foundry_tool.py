...
that receives a ToolClient and returns a SupportsAgentRun-compatible instance.
This pattern allows the agent to be created dynamically with access to tools from
