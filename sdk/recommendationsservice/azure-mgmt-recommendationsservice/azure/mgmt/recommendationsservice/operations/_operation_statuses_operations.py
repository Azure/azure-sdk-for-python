...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.RecommendationsService/locations/{location}/operationStatuses/{operationId}')
...
class OperationStatusesOperations(object):
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~recommendations_service.models.OperationStatusResult
    ...
    get.metadata = {'url': '/providers/Microsoft.RecommendationsService/locations/{location}/operationStatuses/{operationId}'}  # type: ignore
