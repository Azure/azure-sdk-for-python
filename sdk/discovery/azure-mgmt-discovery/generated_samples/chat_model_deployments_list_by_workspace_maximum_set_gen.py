...
# USAGE
    python chat_model_deployments_list_by_workspace_maximum_set_gen.py
...
def main():
    ...
    response = client.chat_model_deployments.list_by_workspace(
        resource_group_name="rgdiscovery",
        workspace_name="715794cf970dc53142",
    )
