...
class TestDiscoveryMgmtStorageContainersOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_storage_containers_list_by_subscription(self, resource_group):
