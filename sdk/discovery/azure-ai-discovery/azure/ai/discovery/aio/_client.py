...
from ._configuration import BookshelfClientConfiguration, WorkspaceClientConfiguration
...
class WorkspaceClient:
    ...
    def __init__(self, endpoint: str, credential: "AsyncTokenCredential", **kwargs: Any) -> None:
        ...
        self.investigations = InvestigationsOperations(self._client, self._config, self._serialize, self._deserialize)
...
class BookshelfClient:
    ...
    def __init__(self, endpoint: str, credential: "AsyncTokenCredential", **kwargs: Any) -> None:
        _endpoint = "{endpoint}"
        self._config = BookshelfClientConfiguration(endpoint=endpoint, credential=credential, **kwargs)
