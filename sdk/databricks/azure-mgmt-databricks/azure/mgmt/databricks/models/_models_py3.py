...
class WorkspaceCustomParameters(Model):
    ...
    :param aml_workspace_id: The ID of a Azure Machine Learning workspace to
     link with Databricks workspace
    ...
    :param load_balancer_backend_pool_name: Name of the outbound Load Balancer
     Backend Pool for Secure Cluster Connectivity (No Public IP).
    :type load_balancer_backend_pool_name:
     ~azure.mgmt.databricks.models.WorkspaceCustomStringParameter
    :param load_balancer_id: Resource URI of Outbound Load balancer for Secure
     Cluster Connectivity (No Public IP) workspace.
    :type load_balancer_id:
     ~azure.mgmt.databricks.models.WorkspaceCustomStringParameter
    :param nat_gateway_name: Name of the NAT gateway for Secure Cluster
     Connectivity (No Public IP) workspace subnets.
    :type nat_gateway_name:
     ~azure.mgmt.databricks.models.WorkspaceCustomStringParameter
    :param public_ip_name: Name of the Public IP for No Public IP workspace
     with managed vNet.
    :type public_ip_name:
     ~azure.mgmt.databricks.models.WorkspaceCustomStringParameter
    ...
    :param require_infrastructure_encryption: A boolean indicating whether or
     not the DBFS root file system will be enabled with secondary layer of
    ...
    :type storage_account_name:
     ~azure.mgmt.databricks.models.WorkspaceCustomStringParameter
    :param storage_account_sku_name: Storage account SKU name, ex:
     Standard_GRS, Standard_LRS. Refer https://aka.ms/storageskus for valid
     inputs.
    :type storage_account_sku_name:
     ~azure.mgmt.databricks.models.WorkspaceCustomStringParameter
    :param vnet_address_prefix: Address prefix for Managed virtual network.
     Default value for this input is 10.139.
    :type vnet_address_prefix:
     ~azure.mgmt.databricks.models.WorkspaceCustomStringParameter
    :ivar resource_tags: Tags applied to resources under Managed resource
     group. These can be updated by updating tags at workspace level.
