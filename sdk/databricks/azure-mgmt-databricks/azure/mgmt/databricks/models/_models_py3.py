...
class WorkspaceCustomParameters(Model):
    ...
    :param storage_account_sku_name: The SKU which should be used for this
     Storage Account
    :type storage_account_sku_name: str
    ...
    :param aml_workspace_id: The Workspace ID of an Azure Machine Learning
     Workspace
    :type aml_workspace_id: str
    """

    _attribute_map = {
        'custom_virtual_network_id': {'key': 'customVirtualNetworkId', 'type': 'str'},
        'custom_public_subnet_name': {'key': 'customPublicSubnetName', 'type': 'str'},
        'custom_private_subnet_name': {'key': 'customPrivateSubnetName', 'type': 'str'},
        'enable_no_public_ip': {'key': 'enableNoPublicIp', 'type': 'bool'},
        'relay_namespace_name': {'key': 'relayNamespaceName', 'type': 'str'},
        'storage_account_name': {'key': 'storageAccountName', 'type': 'str'},
        'storage_account_sku_name': {'key': 'storageAccountSkuName', 'type': 'str'},
        'vnet_address_prefix': {'key': 'vnetAddressPrefix', 'type': 'str'},
        'resource_tags': {'key': 'resourceTags', 'type': '{str}'},
        'aml_workspace_id': {'key': 'amlWorkspaceId', 'type': 'str'},
    }

    def __init__(self, *, custom_virtual_network_id: str=None, custom_public_subnet_name: str=None, custom_private_subnet_name: str=None, enable_no_public_ip: bool=None, relay_namespace_name: str=None, storage_account_name: str=None, storage_account_sku_name: str=None, vnet_address_prefix: str=None, resource_tags=None, aml_workspace_id: str=None, **kwargs) -> None:
