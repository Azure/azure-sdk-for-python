...
from .operations import Operations, OutboundNetworkDependenciesEndpointsOperations, PrivateEndpointConnectionsOperations, PrivateLinkResourcesOperations, VNetPeeringOperations, WorkspacesOperations
...
class DatabricksClient:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = DatabricksClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
