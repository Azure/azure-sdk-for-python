...
class PrivateLinkResourcesOperations:
    ...
    def list(
        ...
        workspace_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.PrivateLinkResourcesList"]:
        ...
        :return: An iterator like instance of either PrivateLinkResourcesList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.databricks.models.PrivateLinkResourcesList]
