...
def build_list_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.CustomProviders/operations")
...
class Operations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.ResourceProviderOperation"]:
        ...
        :return: An iterator like instance of either ResourceProviderOperation or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.customproviders.models.ResourceProviderOperation]
