...
def build_list_request(
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.CustomProviders/operations')
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either ResourceProviderOperationList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.customproviders.models.ResourceProviderOperationList]
