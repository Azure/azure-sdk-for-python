...
class Operations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.ResourceProviderOperation"]:
        ...
        :return: An iterator like instance of either ResourceProviderOperation or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.customproviders.models.ResourceProviderOperation]
