...
class AssociationsOperations:
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: CustomprovidersConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
        self._serialize: Serializer = input_args.pop(0) if input_args else kwargs.pop("serializer")
        self._deserialize: Deserializer = input_args.pop(0) if input_args else kwargs.pop("deserializer")

    async def _create_or_update_initial(
        self, scope: str, association_name: str, association: Union[_models.Association, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
    ...
    async def begin_create_or_update(
        ...
        :param association: The parameters required to create or update an association. Is either a
         Association type or a IO[bytes] type. Required.
        :type association: ~azure.mgmt.customproviders.models.Association or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Association or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.customproviders.models.Association]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("Association", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
    ...
    async def _delete_initial(self, scope: str, association_name: str, **kwargs: Any) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def list_all(self, scope: str, **kwargs: Any) -> AsyncItemPaged["_models.Association"]:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.AssociationsList] = kwargs.pop("cls", None)
