...
from ...operations._custom_resource_provider_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_update_request
T = TypeVar('T')
...
class CustomResourceProviderOperations:
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ListByCustomRPManifest or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.customproviders.models.ListByCustomRPManifest]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
