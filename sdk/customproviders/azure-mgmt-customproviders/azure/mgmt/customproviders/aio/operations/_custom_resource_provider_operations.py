...
from ...operations._custom_resource_provider_operations import (
...
class CustomResourceProviderOperations:
    ...
    async def _create_or_update_initial(
        ...
        resource_provider: Union[_models.CustomRPManifest, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        ...
        _json = None
        _content = None
        if isinstance(resource_provider, (IOBase, bytes)):
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either CustomRPManifest or the result of
         cls(response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource_provider: The parameters required to create or update a custom resource
         provider definition. Required.
        :type resource_provider: IO[bytes]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource_provider_name: str
        :param resource_provider: The parameters required to create or update a custom resource
         provider definition. Is either a CustomRPManifest type or a IO[bytes] type. Required.
        :type resource_provider: ~azure.mgmt.customproviders.models.CustomRPManifest or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either CustomRPManifest or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.customproviders.models.CustomRPManifest]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.CustomRPManifest] = kwargs.pop("cls", None)
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("CustomRPManifest", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if cont_token:
            return AsyncLROPoller[_models.CustomRPManifest].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.CustomRPManifest](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    async def _delete_initial(
        self, resource_group_name: str, resource_provider_name: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type resource_provider_name: str
        :param patchable_resource: The updatable fields of a custom resource provider. Required.
        :type patchable_resource: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: CustomRPManifest or the result of cls(response)
    ...
    async def update(
        ...
        resource_group_name: str,
        resource_provider_name: str,
        patchable_resource: Union[_models.ResourceProvidersUpdate, IO[bytes]],
        **kwargs: Any
    ) -> _models.CustomRPManifest:
        """Updates an existing custom resource provider. The only value that can be updated via PATCH
        currently is the tags.
        ...
        :param patchable_resource: The updatable fields of a custom resource provider. Is either a
         ResourceProvidersUpdate type or a IO[bytes] type. Required.
        :type patchable_resource: ~azure.mgmt.customproviders.models.ResourceProvidersUpdate or
         IO[bytes]
        :return: CustomRPManifest or the result of cls(response)
        :rtype: ~azure.mgmt.customproviders.models.CustomRPManifest
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        _json = None
        _content = None
        if isinstance(patchable_resource, (IOBase, bytes)):
    ...
    def list_by_resource_group(
    ...
    ) -> AsyncItemPaged["_models.CustomRPManifest"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.customproviders.models.CustomRPManifest]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.ListByCustomRPManifest] = kwargs.pop("cls", None)
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.CustomRPManifest"]:
