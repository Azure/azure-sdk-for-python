...
class CustomResourceProviderOperations:
    ...
    async def _create_or_update_initial(
        ...
        resource_provider: Union[_models.CustomRPManifest, IO],
        **kwargs: Any
    ...
    async def update(
        ...
        resource_group_name: str,
        resource_provider_name: str,
        patchable_resource: Union[_models.ResourceProvidersUpdate, IO],
        **kwargs: Any
    ) -> _models.CustomRPManifest:
        """Updates an existing custom resource provider. The only value that can be updated via PATCH
        currently is the tags.
    ...
    ) -> AsyncIterable["_models.CustomRPManifest"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.CustomRPManifest"]:
