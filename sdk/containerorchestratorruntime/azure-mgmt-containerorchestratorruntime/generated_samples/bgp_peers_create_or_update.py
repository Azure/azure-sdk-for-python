...
# USAGE
    python bgp_peers_create_or_update.py
...
def main():
    ...
    response = client.bgp_peers.begin_create_or_update(
        ...
        resource={"properties": {"myAsn": 64500, "peerAddress": "10.0.0.1", "peerAsn": 64501}},
    ).result()
    print(response)
