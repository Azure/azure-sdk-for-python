...
class AutomationRuleActionType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AutomationRuleConditionType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
