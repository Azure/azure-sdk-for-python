...
class IPGeodataOperations:
    """IPGeodataOperations async operations.
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :param ip_address: IP address (v4 or v6) to be enriched.
        :type ip_address: str
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.EnrichmentIpGeodata"]
        error_map = {
