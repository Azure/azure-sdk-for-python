...
class EntityQueryTemplatesOperations:
    """EntityQueryTemplatesOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.EntityQueryTemplateList"]:
        ...
        :param kind: The entity template query kind we want to fetch. The default value is "Activity".
        :type kind: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either EntityQueryTemplateList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.securityinsight.models.EntityQueryTemplateList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.EntityQueryTemplateList"]
        error_map = {
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :param workspace_name: The name of the workspace.
        :type workspace_name: str
        :param entity_query_template_id: entity query template ID.
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.EntityQueryTemplate"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/entityQueryTemplates/{entityQueryTemplateId}'}  # type: ignore
