...
def build_get_request(
    ...
    sentinel_onboarding_state_name,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/onboardingStates/{sentinelOnboardingStateName}')
...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/onboardingStates')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str', max_length=90, min_length=1),
...
# fmt: on
class SentinelOnboardingStatesOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SentinelOnboardingState"
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SentinelOnboardingState"]
        error_map = {
    ...
    def create(
        ...
        workspace_name,  # type: str
        sentinel_onboarding_state_name,  # type: str
        sentinel_onboarding_state_parameter=None,  # type: Optional["_models.SentinelOnboardingState"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.SentinelOnboardingState"
        ...
        :param sentinel_onboarding_state_name: The Sentinel onboarding state name. Supports - default.
        :type sentinel_onboarding_state_name: str
        :param sentinel_onboarding_state_parameter: The Sentinel onboarding state parameter.
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/onboardingStates/{sentinelOnboardingStateName}'}  # type: ignore
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SentinelOnboardingStatesList"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SentinelOnboardingStatesList"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
