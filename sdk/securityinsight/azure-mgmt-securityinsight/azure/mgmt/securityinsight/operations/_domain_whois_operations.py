...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    domain = kwargs.pop('domain')  # type: str

    api_version = "2021-09-01-preview"
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecurityInsights/enrichment/domain/whois/')
...
# fmt: on
class DomainWhoisOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.EnrichmentDomainWhois"
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.EnrichmentDomainWhois"]
        error_map = {
