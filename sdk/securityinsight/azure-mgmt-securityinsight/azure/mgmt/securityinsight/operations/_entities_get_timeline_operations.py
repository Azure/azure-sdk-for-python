...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/entities/{entityId}/getTimeline')
...
# fmt: on
class EntitiesGetTimelineOperations(object):
    ...
    def list(
        ...
        workspace_name,  # type: str
        entity_id,  # type: str
        parameters,  # type: "_models.EntityTimelineParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.EntityTimelineResponse"
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.EntityTimelineResponse"]
        error_map = {
