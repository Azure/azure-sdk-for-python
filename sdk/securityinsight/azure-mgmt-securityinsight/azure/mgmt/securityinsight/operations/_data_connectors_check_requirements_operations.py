...
# fmt: on
class DataConnectorsCheckRequirementsOperations(object):
    ...
    def post(
        ...
        resource_group_name,  # type: str
        workspace_name,  # type: str
        data_connectors_check_requirements,  # type: "_models.DataConnectorsCheckRequirements"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.DataConnectorRequirementsState"
