...
def build_list_repositories_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/listRepositories')
...
class SourceControlOperations(object):
    ...
    def list_repositories(
        ...
        resource_group_name,  # type: str
        workspace_name,  # type: str
        repo_type,  # type: Union[str, "_models.RepoType"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["_models.RepoList"]
