...
def main():
    ...
    response = client.threat_intelligence_indicator.replace_tags(
        ...
        threat_intelligence_replace_tags={
            ...
            "externalReferences": [
                {"description": "str", "externalId": "str", "hashes": {"str": "str"}, "sourceName": "str", "url": "str"}
            ],
            "friendlyName": "str",
            ...
            "parsedPattern": [{"patternTypeKey": "str", "patternTypeValues": [{"value": "str", "valueType": "str"}]}],
            "pattern": "str",
            "patternType": "str",
            "patternVersion": "str",
            "revoked": bool,
...
# x-ms-original-file: specification/securityinsights/resource-manager/Microsoft.SecurityInsights/SecurityInsights/stable/2025-09-01/examples/threatintelligence/ReplaceTagsThreatIntelligence.json
