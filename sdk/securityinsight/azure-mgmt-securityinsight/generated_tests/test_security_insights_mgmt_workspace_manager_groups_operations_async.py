...
class TestSecurityInsightsMgmtWorkspaceManagerGroupsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_workspace_manager_groups_create_or_update(self, resource_group):
        response = await self.client.workspace_manager_groups.create_or_update(
            ...
            workspace_manager_group={
                ...
                "id": "str",
                "name": "str",
                "properties": {"displayName": "str", "memberResourceNames": ["str"], "description": "str"},
                "systemData": {
