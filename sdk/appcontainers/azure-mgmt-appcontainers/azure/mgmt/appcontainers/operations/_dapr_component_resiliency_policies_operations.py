...
class DaprComponentResiliencyPoliciesOperations:
    """
    .. warning::
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/daprComponents/{componentName}/resiliencyPolicies"
    }
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/daprComponents/{componentName}/resiliencyPolicies/{name}"
    }
    ...
    def create_or_update(
        ...
        component_name: str,
        name: str,
        dapr_component_resiliency_policy_envelope: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.DaprComponentResiliencyPolicy:
        ...
        :param dapr_component_resiliency_policy_envelope: Configuration details of the Dapr Component
         Resiliency Policy. Required.
        :type dapr_component_resiliency_policy_envelope: IO
    ...
    def create_or_update(
        ...
        component_name: str,
        name: str,
        dapr_component_resiliency_policy_envelope: Union[_models.DaprComponentResiliencyPolicy, IO],
        **kwargs: Any
    ) -> _models.DaprComponentResiliencyPolicy:
        """Creates or updates a Dapr component resiliency policy.
        ...
        :type name: str
        :param dapr_component_resiliency_policy_envelope: Configuration details of the Dapr Component
         Resiliency Policy. Is either a DaprComponentResiliencyPolicy type or a IO type. Required.
        :type dapr_component_resiliency_policy_envelope:
         ~azure.mgmt.appcontainers.models.DaprComponentResiliencyPolicy or IO
