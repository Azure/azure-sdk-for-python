...
class DaprSubscriptionsOperations:
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/daprSubscriptions"
    }
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/daprSubscriptions/{name}"
    }
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type name: str
        :param dapr_subscription_envelope: Configuration details of the Dapr subscription. Required.
        :type dapr_subscription_envelope: IO
    ...
    async def create_or_update(
        ...
        environment_name: str,
        name: str,
        dapr_subscription_envelope: Union[_models.DaprSubscription, IO],
        **kwargs: Any
    ) -> _models.DaprSubscription:
        """Creates or updates a Dapr subscription.
        ...
        :param dapr_subscription_envelope: Configuration details of the Dapr subscription. Is either a
         DaprSubscription type or a IO type. Required.
        :type dapr_subscription_envelope: ~azure.mgmt.appcontainers.models.DaprSubscription or IO
