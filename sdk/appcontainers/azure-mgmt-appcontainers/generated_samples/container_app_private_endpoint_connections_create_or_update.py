...
# USAGE
    python container_app_private_endpoint_connections_create_or_update.py
...
def main():
    ...
    response = client.container_app_private_endpoint_connections.begin_create_or_update(
        resource_group_name="examplerg",
        container_app_name="testcontainerapp0",
        private_endpoint_connection_name="test-private-endpoint-connection",
