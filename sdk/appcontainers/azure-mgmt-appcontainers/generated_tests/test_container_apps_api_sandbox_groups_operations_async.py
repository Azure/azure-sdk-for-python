...
class TestContainerAppsAPISandboxGroupsOperationsAsync(AzureMgmtRecordedTestCase):
        ...
        response = await (
            await self.client.sandbox_groups.begin_create_or_update(
                ...
                resource={
                    ...
                    "id": "str",
                    "name": "str",
                    "properties": {"defaultDomain": "str", "environmentId": "str", "provisioningState": "str"},
                    "systemData": {
    ...
    async def test_sandbox_groups_begin_update(self, resource_group):
        response = await (
            await self.client.sandbox_groups.begin_update(
                resource_group_name=resource_group.name,
                sandbox_group_name="str",
                properties={"properties": {"environmentId": "str"}, "tags": {"str": "str"}},
            )
        ).result()  # call '.result()' to poll until service return final result
