...
### Breaking Changes
  ...
  - Method `ContainerGroupsOperations.list` changed return type from `AsyncItemPaged[_models.ListResultContainerGroup]` to `AsyncItemPaged[_models.ContainerGroup]`
  - Method `ContainerGroupsOperations.list_by_resource_group` changed return type from `AsyncItemPaged[_models.ListResultContainerGroup]` to `AsyncItemPaged[_models.ContainerGroup]`
