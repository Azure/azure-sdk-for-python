...
### Features Added
  ...
  - Added model `ContainerGroupPropertiesProperties`
  - Added model `ContainerGroupPropertiesPropertiesInstanceView`
  - Added model `InitContainerPropertiesDefinition`
  - Added model `ListResultContainerGroupPropertiesProperties`
