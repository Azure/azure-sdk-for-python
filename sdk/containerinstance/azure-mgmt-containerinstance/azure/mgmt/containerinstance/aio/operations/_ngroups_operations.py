...
class NGroupsOperations:
    ...
    async def _update_initial(
        self, resource_group_name: str, ngroups_name: str, n_group: Union[_models.NGroupPatch, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
        ...
        if isinstance(n_group, (IOBase, bytes)):
            ...
            _json = self._serialize.body(n_group, "NGroupPatch")
    ...
    async def begin_update(
        ...
        :type n_group: ~azure.mgmt.containerinstance.models.NGroupPatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NGroup or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerinstance.models.NGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
