...
class AiAgentsGroup(TrackedResource):
    ...
    :vartype properties: "AiAgentsGroupProperties"
...
class AiAgentsGroupNetworkProfile(TypedDict, total=False):
...
class AiAgentsGroupProperties(TypedDict, total=False):
    """Properties of an AiAgentsGroup.

    :ivar provisioning_state: The status of the last operation. Known values are: "Succeeded",
     "Failed", "Canceled", "Updating", "Deleting", and "Accepted".
    :vartype provisioning_state: Union[str, "AiAgentsGroupProvisioningState"]
    :ivar network_profile: The network profile of the AiAgentsGroup.
    :vartype network_profile: "AiAgentsGroupNetworkProfile"
    ...
    provisioningState: Union[str, "AiAgentsGroupProvisioningState"]
...
class AiAgentsGroupTagsUpdate(TypedDict, total=False):
