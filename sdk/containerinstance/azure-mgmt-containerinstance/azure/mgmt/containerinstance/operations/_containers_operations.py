...
class ContainersOperations(object):
    ...
    def list_logs(
            self, resource_group_name, container_group_name, container_name, tail=None, timestamps=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param tail: The number of lines to show from the tail of the
         ...
         up to 4mb.
        :type tail: int
        :param timestamps: If true, adds a timestamp at the beginning of every
         line of log output. If not provided, defaults to false.
    ...
    def attach(
            self, resource_group_name, container_group_name, container_name, custom_headers=None, raw=False, **operation_config):
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: ContainerAttachResponse or ClientRawResponse if raw=true
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('ContainerAttachResponse', response)
