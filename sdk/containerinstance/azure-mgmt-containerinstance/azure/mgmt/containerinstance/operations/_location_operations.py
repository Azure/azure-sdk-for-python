...
def build_list_usage_request(location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
...
def build_list_cached_images_request(location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_capabilities_request(location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class LocationOperations:
    ...
    @distributed_trace
    def list_usage(self, location: str, **kwargs: Any) -> Iterable["_models.Usage"]:
    ...
    @distributed_trace
    def list_cached_images(self, location: str, **kwargs: Any) -> Iterable["_models.CachedImages"]:
    ...
    list_cached_images.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.ContainerInstance/locations/{location}/cachedImages"
    }

    @distributed_trace
    def list_capabilities(self, location: str, **kwargs: Any) -> Iterable["_models.Capabilities"]:
    ...
    list_capabilities.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.ContainerInstance/locations/{location}/capabilities"
    }
