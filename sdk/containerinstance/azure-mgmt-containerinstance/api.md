...
namespace azure.mgmt.containerinstance.aio.operations
    ...
    class azure.mgmt.containerinstance.aio.operations.SandboxGroupsOperations:
        ...
        @distributed_trace_async
        @api_version_validation(method_added_on='2026-06-01-preview', params_added_on={'2026-06-01-preview': ['api_version', 'subscription_id', 'resource_group_name', 'sandbox_group_name']}, api_versions_list=['2026-06-01-preview', '2026-07-01'])
        async def begin_delete(
                self, 
                resource_group_name: str, 
                sandbox_group_name: str, 
        ...
        @distributed_trace_async
        @api_version_validation(method_added_on='2026-06-01-preview', params_added_on={'2026-06-01-preview': ['api_version', 'subscription_id', 'resource_group_name', 'sandbox_group_name', 'accept']}, api_versions_list=['2026-06-01-preview', '2026-07-01'])
        async def connect(
                self, 
                resource_group_name: str, 
                sandbox_group_name: str, 
        ...
        @distributed_trace
        @api_version_validation(method_added_on='2026-06-01-preview', params_added_on={'2026-06-01-preview': ['api_version', 'subscription_id', 'resource_group_name', 'accept']}, api_versions_list=['2026-06-01-preview', '2026-07-01'])
        def list_by_resource_group(
                self, 
                resource_group_name: str, 
                **kwargs: Any
        ...
        @distributed_trace
        @api_version_validation(method_added_on='2026-06-01-preview', params_added_on={'2026-06-01-preview': ['api_version', 'subscription_id', 'accept']}, api_versions_list=['2026-06-01-preview', '2026-07-01'])
...
namespace azure.mgmt.containerinstance.models
    ...
    class azure.mgmt.containerinstance.models.SandboxGroup(TrackedResource):
        id: str
    ...
    class azure.mgmt.containerinstance.models.SandboxGroupAccessToken(_Model):
        access_token: str
        endpoint: str
        not_after: datetime
    ...
    class azure.mgmt.containerinstance.models.SandboxGroupNetworkProfile(_Model):
    ...
    class azure.mgmt.containerinstance.models.SandboxGroupProperties(_Model):
        management_resource_group_id: Optional[str]
        network_profile: Optional[SandboxGroupNetworkProfile]
    ...
    class azure.mgmt.containerinstance.models.SandboxGroupProvisioningState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        ACCEPTED = "Accepted"
        CANCELED = "Canceled"
        DELETING = "Deleting"
        FAILED = "Failed"
    ...
    class azure.mgmt.containerinstance.models.SandboxGroupTagsUpdate(_Model):
        identity: Optional[ManagedServiceIdentity]
        tags: Optional[dict[str, str]]
...
namespace azure.mgmt.containerinstance.operations
    ...
    class azure.mgmt.containerinstance.operations.SandboxGroupsOperations:
...
namespace azure.mgmt.containerinstance.types
    ...
    class azure.mgmt.containerinstance.types.SandboxGroup(TrackedResource):
        key "id": str
    ...
    class azure.mgmt.containerinstance.types.SandboxGroupNetworkProfile(TypedDict, total=False):
        subnets: list[SubnetReference]


    class azure.mgmt.containerinstance.types.SandboxGroupProperties(TypedDict, total=False):
        key "managementResourceGroupId": str
        key "networkProfile": ForwardRef('SandboxGroupNetworkProfile', module='types')
        key "provisioningState": Union[str, SandboxGroupProvisioningState]
        management_resource_group_id: str
        network_profile: SandboxGroupNetworkProfile
        provisioning_state: Union[str, SandboxGroupProvisioningState]


    class azure.mgmt.containerinstance.types.SandboxGroupTagsUpdate(TypedDict, total=False):
        key "identity": ForwardRef('ManagedServiceIdentity', module='types')
        identity: ManagedServiceIdentity
        tags: dict[str, str]
