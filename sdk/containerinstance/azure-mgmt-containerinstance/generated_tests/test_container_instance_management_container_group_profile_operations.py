...
class TestContainerInstanceManagementContainerGroupProfileOperations(AzureMgmtRecordedTestCase):
    ...
    def test_get_by_revision_number(self, resource_group):
        response = self.client.container_group_profile.get_by_revision_number(
            resource_group_name=resource_group.name,
            container_group_profile_name="str",
            revision_number="str",
            api_version="2024-05-01-preview",
