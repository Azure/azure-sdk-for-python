...
class AffectedMoveResource(Model):
    ...
    :vartype move_resources:
     list[~azure.mgmt.regionmove.models.AffectedMoveResource]
    """
...
class ResourceSettings(Model):
    ...
    sub-classes are: MoveResourcePropertiesSourceResourceSettings,
    VirtualMachineResourceSettings, AvailabilitySetResourceSettings,
    VirtualNetworkResourceSettings, NetworkInterfaceResourceSettings,
    NetworkSecurityGroupResourceSettings, LoadBalancerResourceSettings,
    SqlServerResourceSettings, SqlElasticPoolResourceSettings,
    SqlDatabaseResourceSettings, ResourceGroupResourceSettings,
...
class CloudError(Model):
    ...
    :type error: ~azure.mgmt.regionmove.models.CloudErrorBody
    """
...
class CloudErrorBody(Model):
    ...
    :type details: list[~azure.mgmt.regionmove.models.CloudErrorBody]
    """
...
class CommitRequest(Model):
    ...
    :param validate_only: Gets or sets the list of resource Id's, by default
     it accepts move resource id's unless the input type is switched via
     moveResourceInputType property.
    :type validate_only: bool
    :param move_resources: Required. Gets or sets the list of move resources
     ARM id's.
    ...
    :type move_resource_input_type: str or
     ~azure.mgmt.regionmove.models.MoveResourceInputType
    """
...
class Identity(Model):
    ...
    :param type: Possible values include: 'None', 'SystemAssigned',
     'UserAssigned'
    :type type: str or ~azure.mgmt.regionmove.models.ResourceIdentityType
...
class JobStatus(Model):
    ...
    :type job_name: str or ~azure.mgmt.regionmove.models.JobName
    ...
    def __init__(self, *, job_name=None, job_progress: str=None, **kwargs) -> None:
...
class LBFrontendIPConfigurationResourceSettings(Model):
    ...
    :param subnet:
    :type subnet: ~azure.mgmt.regionmove.models.SubnetReference
...
class LoadBalancerResourceSettings(ResourceSettings):
    ...
    :type frontend_ip_configurations:
     list[~azure.mgmt.regionmove.models.LBFrontendIPConfigurationResourceSettings]
    :param backend_address_pools: Gets or sets the backend address pools of
     the load balancer.
    :type backend_address_pools:
     list[~azure.mgmt.regionmove.models.LBBackendAddressPoolResourceSettings]
...
class MoveCollection(Model):
    ...
    :param properties:
    :type properties: ~azure.mgmt.regionmove.models.MoveCollectionProperties
    """
...
class MoveCollectionProperties(Model):
    ...
    :type provisioning_state: str or
     ~azure.mgmt.regionmove.models.ProvisioningState
    """
...
class MoveResource(Model):
    ...
    :vartype type: str
    :param properties:
    :type properties: ~azure.mgmt.regionmove.models.MoveResourceProperties
    """
...
class MoveResourceDependency(Model):
    ...
    :type resolution_type: str or ~azure.mgmt.regionmove.models.ResolutionType
    :param dependency_type: Possible values include: 'RequiredForPrepare',
     'RequiredForMove'
    :type dependency_type: str or ~azure.mgmt.regionmove.models.DependencyType
    :param manual_resolution:
    :type manual_resolution:
     ~azure.mgmt.regionmove.models.ManualResolutionProperties
    :param automatic_resolution:
    :type automatic_resolution:
     ~azure.mgmt.regionmove.models.AutomaticResolutionProperties
...
class MoveResourceError(Model):
    ...
    :type properties: ~azure.mgmt.regionmove.models.MoveResourceErrorBody
    """
...
class MoveResourceErrorBody(Model):
    ...
    :type target: str
    :param details: A list of additional details about the error.
    :type details: list[~azure.mgmt.regionmove.models.MoveResourceErrorBody]
    """
...
class MoveResourceFilter(Model):
    ...
    :param properties:
    :type properties:
     ~azure.mgmt.regionmove.models.MoveResourceFilterProperties
    """
...
class MoveResourceProperties(Model):
    ...
    :type resource_settings: ~azure.mgmt.regionmove.models.ResourceSettings
    :ivar source_resource_settings: Gets or sets the source resource settings.
    :vartype source_resource_settings:
     ~azure.mgmt.regionmove.models.MoveResourcePropertiesSourceResourceSettings
    :ivar move_status:
    :vartype move_status:
     ~azure.mgmt.regionmove.models.MoveResourcePropertiesMoveStatus
    :ivar depends_on: Gets or sets the move resource dependencies.
    :vartype depends_on:
     list[~azure.mgmt.regionmove.models.MoveResourceDependency]
    :param depends_on_overrides: Gets or sets the move resource dependencies
     overrides.
    :type depends_on_overrides:
     list[~azure.mgmt.regionmove.models.MoveResourceDependencyOverride]
    :param errors:
    :type errors: ~azure.mgmt.regionmove.models.MoveResourceError
    """
    ...
    _attribute_map = {
        ...
        'source_resource_settings': {'key': 'sourceResourceSettings', 'type': 'MoveResourcePropertiesSourceResourceSettings'},
    ...
    def __init__(self, *, source_id: str, provisioning_state=None, existing_target_id: str=None, resource_settings=None, depends_on_overrides=None, errors=None, **kwargs) -> None:
...
class MoveResourceStatus(Model):
    ...
    :type move_state: str or ~azure.mgmt.regionmove.models.MoveState
    :param job_status:
    :type job_status: ~azure.mgmt.regionmove.models.JobStatus
    :param errors:
    :type errors: ~azure.mgmt.regionmove.models.MoveResourceError
    ...
    def __init__(self, *, move_state=None, job_status=None, errors=None, target_id: str=None, **kwargs) -> None:
...
class MoveResourcePropertiesSourceResourceSettings(ResourceSettings):
    ...
    def __init__(self, *, target_resource_name: str, **kwargs) -> None:
        ...
        self.resource_type = 'MoveResourceProperties_sourceResourceSettings'
...
class NetworkInterfaceResourceSettings(ResourceSettings):
    ...
    :type ip_configurations:
     list[~azure.mgmt.regionmove.models.NicIpConfigurationResourceSettings]
...
class NetworkSecurityGroupResourceSettings(ResourceSettings):
    ...
    :param security_rules: Gets or sets Security rules of network security
     group.
    :type security_rules: list[~azure.mgmt.regionmove.models.NsgSecurityRule]
    """
...
class NicIpConfigurationResourceSettings(Model):
    ...
    :type load_balancer_backend_address_pools:
     list[~azure.mgmt.regionmove.models.LoadBalancerBackendAddressPoolReference]
    """
...
class OperationErrorAdditionalInfo(Model):
    ...
    :vartype info: ~azure.mgmt.regionmove.models.MoveErrorInfo
    """
...
class OperationsDiscovery(Model):
    ...
    :type name: str
    :param display:
    :type display: ~azure.mgmt.regionmove.models.Display
...
class OperationsDiscoveryCollection(Model):
    ...
    :type value: list[~azure.mgmt.regionmove.models.OperationsDiscovery]
...
class OperationStatus(Model):
    ...
    :vartype error: ~azure.mgmt.regionmove.models.OperationStatusError
...
class OperationStatusError(Model):
    ...
    :vartype details: list[~azure.mgmt.regionmove.models.OperationStatusError]
    :ivar additional_info: The additional info.
    :vartype additional_info:
     list[~azure.mgmt.regionmove.models.OperationErrorAdditionalInfo]
    """
...
class SqlDatabaseResourceSettings(ResourceSettings):
    ...
    :type zone_redundant: str or ~azure.mgmt.regionmove.models.ZoneRedundant
    """
...
class UnresolvedDependencyCollection(Model):
    ...
    :type value: list[~azure.mgmt.regionmove.models.UnresolvedDependency]
    :param next_link: Gets or sets the value of  next link.
    :type next_link: str
    """
...
class VirtualMachineResourceSettings(ResourceSettings):
    ...
    :type target_availability_zone: str or
     ~azure.mgmt.regionmove.models.TargetAvailabilityZone
...
class VirtualNetworkResourceSettings(ResourceSettings):
    ...
    :type subnets: list[~azure.mgmt.regionmove.models.SubnetResourceSettings]
    """
