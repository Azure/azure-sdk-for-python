...
class AffectedMoveResource(msrest.serialization.Model):
    ...
    :vartype move_resources: list[~region_move_service_api.models.AffectedMoveResource]
    """
...
class CloudErrorBody(msrest.serialization.Model):
    ...
    :type details: list[~region_move_service_api.models.CloudErrorBody]
    """
...
class CommitRequest(msrest.serialization.Model):
    ...
    :type move_resource_input_type: str or ~region_move_service_api.models.MoveResourceInputType
    """
...
class Identity(msrest.serialization.Model):
    ...
    :param type: The type of identity used for the region move service. Possible values include:
     "None", "SystemAssigned", "UserAssigned".
    :type type: str or ~region_move_service_api.models.ResourceIdentityType
...
class LBFrontendIPConfigurationResourceSettings(msrest.serialization.Model):
    ...
    :type subnet: ~region_move_service_api.models.ProxyResourceReference
...
class LoadBalancerResourceSettings(ResourceSettings):
    ...
    :type frontend_ip_configurations:
     list[~region_move_service_api.models.LBFrontendIPConfigurationResourceSettings]
    :param backend_address_pools: Gets or sets the backend address pools of the load balancer.
    :type backend_address_pools:
     list[~region_move_service_api.models.LBBackendAddressPoolResourceSettings]
...
class MoveCollection(msrest.serialization.Model):
    ...
    :type identity: ~region_move_service_api.models.Identity
    :param properties: Defines the move collection properties.
    :type properties: ~region_move_service_api.models.MoveCollectionProperties
    """
...
class MoveCollectionProperties(msrest.serialization.Model):
    ...
    :vartype provisioning_state: str or ~region_move_service_api.models.ProvisioningState
    """
...
class MoveCollectionResultList(msrest.serialization.Model):
    ...
    :type value: list[~region_move_service_api.models.MoveCollection]
...
class MoveResource(msrest.serialization.Model):
    ...
    :type properties: ~region_move_service_api.models.MoveResourceProperties
    """
...
class MoveResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~region_move_service_api.models.MoveResource]
    :param next_link: Gets the value of  next link.
    :type next_link: str
    """
...
class MoveResourceDependency(msrest.serialization.Model):
    ...
    :param resolution_type: Defines the resolution type. Possible values include: "Manual",
     "Automatic".
    :type resolution_type: str or ~region_move_service_api.models.ResolutionType
    :param dependency_type: Defines the dependency type. Possible values include:
     "RequiredForPrepare", "RequiredForMove".
    :type dependency_type: str or ~region_move_service_api.models.DependencyType
    :param manual_resolution: Defines the properties for manual resolution.
    :type manual_resolution: ~region_move_service_api.models.ManualResolutionProperties
    :param automatic_resolution: Defines the properties for automatic resolution.
    :type automatic_resolution: ~region_move_service_api.models.AutomaticResolutionProperties
...
class MoveResourceError(msrest.serialization.Model):
    ...
    :type properties: ~region_move_service_api.models.MoveResourceErrorBody
    """
...
class MoveResourceFilter(msrest.serialization.Model):
    ...
    :param properties:
    :type properties: ~region_move_service_api.models.MoveResourceFilterProperties
    """
...
class MoveResourceProperties(msrest.serialization.Model):
    ...
    :type resource_settings: ~region_move_service_api.models.ResourceSettings
    :ivar source_resource_settings: Gets or sets the source resource settings.
    :vartype source_resource_settings: ~region_move_service_api.models.ResourceSettings
    :ivar move_status: Defines the move resource status.
    :vartype move_status: ~region_move_service_api.models.MoveResourceStatus
    :ivar depends_on: Gets or sets the move resource dependencies.
    :vartype depends_on: list[~region_move_service_api.models.MoveResourceDependency]
    :param depends_on_overrides: Gets or sets the move resource dependencies overrides.
    :type depends_on_overrides:
     list[~region_move_service_api.models.MoveResourceDependencyOverride]
    :ivar errors: Defines the move resource errors.
    :vartype errors: ~region_move_service_api.models.MoveResourceError
    """
...
class MoveResourcePropertiesSourceResourceSettings(ResourceSettings):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.resource_type = 'MoveResourceProperties-sourceResourceSettings'
...
class NetworkInterfaceResourceSettings(ResourceSettings):
    ...
    :type ip_configurations:
     list[~region_move_service_api.models.NicIpConfigurationResourceSettings]
...
class NetworkSecurityGroupResourceSettings(ResourceSettings):
    ...
    :type security_rules: list[~region_move_service_api.models.NsgSecurityRule]
    """
...
class NicIpConfigurationResourceSettings(msrest.serialization.Model):
    ...
    :type load_balancer_backend_address_pools:
     list[~region_move_service_api.models.ProxyResourceReference]
    """
...
class OperationErrorAdditionalInfo(msrest.serialization.Model):
    ...
    :vartype info: ~region_move_service_api.models.MoveErrorInfo
    """
...
class OperationsDiscovery(msrest.serialization.Model):
    ...
    :param display: Contains the localized display information for this particular operation /
     ...
     (2) complex query filters for the event service; and
     (3) audit history / records for management operations.
    :type display: ~region_move_service_api.models.Display
...
class OperationsDiscoveryCollection(msrest.serialization.Model):
    ...
    :type value: list[~region_move_service_api.models.OperationsDiscovery]
...
class OperationStatus(msrest.serialization.Model):
    ...
    :vartype error: ~region_move_service_api.models.OperationStatusError
...
class OperationStatusError(msrest.serialization.Model):
    ...
    :vartype details: list[~region_move_service_api.models.OperationStatusError]
    :ivar additional_info: The additional info.
    :vartype additional_info: list[~region_move_service_api.models.OperationErrorAdditionalInfo]
    """
...
class SqlDatabaseResourceSettings(ResourceSettings):
    ...
    :param zone_redundant: Defines the zone redundant resource setting. Possible values include:
     "Enable", "Disable".
    :type zone_redundant: str or ~region_move_service_api.models.ZoneRedundant
    """
...
class UnresolvedDependencyCollection(msrest.serialization.Model):
    ...
    :type value: list[~region_move_service_api.models.UnresolvedDependency]
    :param next_link: Gets or sets the value of  next link.
    :type next_link: str
    """
...
class VirtualMachineResourceSettings(ResourceSettings):
    ...
    :param target_availability_zone: Gets or sets the target availability zone. Possible values
     include: "1", "2", "3", "NA".
    :type target_availability_zone: str or ~region_move_service_api.models.TargetAvailabilityZone
...
class VirtualNetworkResourceSettings(ResourceSettings):
    ...
    :type subnets: list[~region_move_service_api.models.SubnetResourceSettings]
    """
