...
class MoveCollectionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`MoveCollection <azure.mgmt.regionmove.models.MoveCollection>` object
    """
...
class MoveResourcePaged(Paged):
    """
    A paging container for iterating over a list of :class:`MoveResource <azure.mgmt.regionmove.models.MoveResource>` object
    """
