...
class MoveCollectionsOperations(object):
    ...
    def create(
        ...
        body=None,  # type: Optional["models.MoveCollection"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MoveCollection"
    ...
    def update(
        ...
        resource_group_name,  # type: str
        move_collection_name,  # type: str
        body=None,  # type: Optional["models.UpdateMoveCollectionRequest"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MoveCollection"
    ...
    def _prepare_initial(
        ...
        resource_group_name,  # type: str
        move_collection_name,  # type: str
        body=None,  # type: Optional["models.PrepareRequest"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.OperationStatus"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.OperationStatus"]]
    ...
    def _initiate_move_initial(
        ...
        resource_group_name,  # type: str
        move_collection_name,  # type: str
        body=None,  # type: Optional["models.ResourceMoveRequest"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.OperationStatus"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.OperationStatus"]]
    ...
    def _commit_initial(
        ...
        resource_group_name,  # type: str
        move_collection_name,  # type: str
        body=None,  # type: Optional["models.CommitRequest"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.OperationStatus"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.OperationStatus"]]
    ...
    def _discard_initial(
        ...
        resource_group_name,  # type: str
        move_collection_name,  # type: str
        body=None,  # type: Optional["models.DiscardRequest"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.OperationStatus"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.OperationStatus"]]
    ...
    def list_move_collections_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.MoveCollectionResultList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~region_move_service_api.models.MoveCollectionResultList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
