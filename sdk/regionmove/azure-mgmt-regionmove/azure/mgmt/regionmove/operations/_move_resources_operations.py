...
class MoveResourcesOperations(object):
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :param body:
        :type body: ~region_move_service_api.models.MoveResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.LROPoller[~region_move_service_api.models.MoveResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~region_move_service_api.models.MoveResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.MoveResource"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
