...
class OperationsDiscoveryOperations(object):
    ...
    def get(
        ...
        :return: OperationsDiscoveryCollection or ClientRawResponse if
         raw=true
        :rtype: ~azure.mgmt.regionmove.models.OperationsDiscoveryCollection or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('OperationsDiscoveryCollection', response)
