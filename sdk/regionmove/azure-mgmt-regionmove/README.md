...
```bash
pip install azure-mgmt-regionmove
...
from azure.mgmt.regionmove import RegionMoveServiceAPI
import os

sub_id = os.getenv("AZURE_SUBSCRIPTION_ID")
client = RegionMoveServiceAPI(credential=DefaultAzureCredential(), subscription_id=sub_id)
```
