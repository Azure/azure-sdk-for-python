...
class MonitorsOperations(object):
    ...
    def list_api_keys(
        ...
        monitor_name: str,
        **kwargs: Any
    ) -> Iterable["_models.DatadogApiKeyListResponse"]:
        ...
        :return: An iterator like instance of either DatadogApiKeyListResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~microsoft_datadog_client.models.DatadogApiKeyListResponse]
    ...
    def list_linked_resources(
        ...
        monitor_name: str,
        **kwargs: Any
    ) -> Iterable["_models.LinkedResourceListResponse"]:
        ...
        :return: An iterator like instance of either LinkedResourceListResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~microsoft_datadog_client.models.LinkedResourceListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_monitored_resources(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either MonitoredResourceListResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~microsoft_datadog_client.models.MonitoredResourceListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(
        self,
        **kwargs: Any
    ) -> Iterable["_models.DatadogMonitorResourceListResponse"]:
        ...
        :return: An iterator like instance of either DatadogMonitorResourceListResponse or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~microsoft_datadog_client.models.DatadogMonitorResourceListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
