...
class MonitoredResourcesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.datadog.models.MonitoredResourcePaged[~azure.mgmt.datadog.models.MonitoredResource]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.MonitoredResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Datadog/monitors/{monitorName}/listMonitoredResources'}
