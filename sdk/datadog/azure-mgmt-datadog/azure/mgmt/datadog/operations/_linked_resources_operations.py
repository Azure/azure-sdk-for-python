...
class LinkedResourcesOperations(object):
    ...
    def list(
        ...
        """List all Azure resources associated to the same Datadog organization as
        the target resource.
        ...
        :rtype:
         ~azure.mgmt.datadog.models.LinkedResourcePaged[~azure.mgmt.datadog.models.LinkedResource]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.LinkedResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Datadog/monitors/{monitorName}/listLinkedResources'}
