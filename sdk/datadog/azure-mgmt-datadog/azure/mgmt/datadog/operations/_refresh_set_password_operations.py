...
class RefreshSetPasswordOperations(object):
    ...
    def get(
        ...
        :return: DatadogSetPasswordLink or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.datadog.models.DatadogSetPasswordLink or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('DatadogSetPasswordLink', response)
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Datadog/monitors/{monitorName}/refreshSetPasswordLink'}
