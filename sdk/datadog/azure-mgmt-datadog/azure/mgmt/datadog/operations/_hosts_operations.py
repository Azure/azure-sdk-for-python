...
class HostsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.datadog.models.DatadogHostPaged[~azure.mgmt.datadog.models.DatadogHost]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.DatadogHostPaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Datadog/monitors/{monitorName}/listHosts'}
