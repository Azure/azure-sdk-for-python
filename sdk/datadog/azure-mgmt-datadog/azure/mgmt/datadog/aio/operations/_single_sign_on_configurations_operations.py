...
from ...operations._single_sign_on_configurations_operations import build_create_or_update_request_initial, build_get_request, build_list_request
T = TypeVar('T')
...
class SingleSignOnConfigurationsOperations:
    ...
    def list(
        ...
        monitor_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.DatadogSingleSignOnResourceListResponse"]:
        ...
        :return: An iterator like instance of either DatadogSingleSignOnResourceListResponse or the
         result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~microsoft_datadog_client.models.DatadogSingleSignOnResourceListResponse]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either DatadogSingleSignOnResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~microsoft_datadog_client.models.DatadogSingleSignOnResource]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
