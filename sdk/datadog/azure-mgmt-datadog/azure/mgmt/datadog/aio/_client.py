...
class MicrosoftDatadogClient:  # pylint: disable=too-many-instance-attributes
    ...
    :ivar datadog_monitor_resources: DatadogMonitorResourcesOperations operations
    :vartype datadog_monitor_resources:
     azure.mgmt.datadog.aio.operations.DatadogMonitorResourcesOperations
    ...
    :vartype monitored_subscriptions:
     azure.mgmt.datadog.aio.operations.MonitoredSubscriptionsOperations
    :ivar saa_soperation_group: SaaSOperationGroupOperations operations
    :vartype saa_soperation_group: azure.mgmt.datadog.aio.operations.SaaSOperationGroupOperations
    ...
    :vartype organizations: azure.mgmt.datadog.aio.operations.OrganizationsOperations
    :ivar single_sign_on_configurations: SingleSignOnConfigurationsOperations operations
    :vartype single_sign_on_configurations:
     azure.mgmt.datadog.aio.operations.SingleSignOnConfigurationsOperations
    :ivar marketplace_agreements: MarketplaceAgreementsOperations operations
    :vartype marketplace_agreements:
     azure.mgmt.datadog.aio.operations.MarketplaceAgreementsOperations
    :ivar creation_supported: CreationSupportedOperations operations
    :vartype creation_supported: azure.mgmt.datadog.aio.operations.CreationSupportedOperations
    ...
    :keyword api_version: The API version to use for this operation. Known values are
     "2025-12-26-preview" and None. Default value is None. If not set, the operation's default API
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.datadog_monitor_resources = DatadogMonitorResourcesOperations(
