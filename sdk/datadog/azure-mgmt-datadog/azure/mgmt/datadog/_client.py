...
class MicrosoftDatadogClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype saa_soperation_group: azure.mgmt.datadog.operations.SaaSOperationGroupOperations
    ...
    :vartype organizations: azure.mgmt.datadog.operations.OrganizationsOperations
