...
from .operations import MarketplaceAgreementsOperations, MonitorsOperations, Operations, SingleSignOnConfigurationsOperations, TagRulesOperations
...
class MicrosoftDatadogClient:
    ...
    :vartype marketplace_agreements:
     microsoft_datadog_client.operations.MarketplaceAgreementsOperations
    ...
    :vartype single_sign_on_configurations:
     microsoft_datadog_client.operations.SingleSignOnConfigurationsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MicrosoftDatadogClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
        ...
        self.single_sign_on_configurations = SingleSignOnConfigurationsOperations(self._client, self._config, self._serialize, self._deserialize)
