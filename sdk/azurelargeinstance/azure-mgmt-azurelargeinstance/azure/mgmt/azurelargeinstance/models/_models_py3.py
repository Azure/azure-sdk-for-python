...
class AzureLargeStorageInstance(TrackedResource):
    """AzureLargeStorageInstance info on Azure (ARM properties and AzureLargeStorageInstance
    properties).
    ...
    :vartype storage_properties: ~azure.mgmt.azurelargeinstance.models.StorageProperties
    """
    ...
    _attribute_map = {
        ...
        "azure_large_storage_instance_unique_identifier": {
            "key": "properties.azureLargeStorageInstanceUniqueIdentifier",
            "type": "str",
        },
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword storage_properties: Specifies the storage properties for the AzureLargeStorage
         instance.
        :paramtype storage_properties: ~azure.mgmt.azurelargeinstance.models.StorageProperties
        """
        super().__init__(tags=tags, location=location, **kwargs)
...
class AzureLargeStorageInstanceListResult(_serialization.Model):
    ...
    :ivar value: The list of AzureLargeStorage instances.
    :vartype value: list[~azure.mgmt.azurelargeinstance.models.AzureLargeStorageInstance]
    :ivar next_link: The URL to get the next set of AzureLargeStorage instances.
    :vartype next_link: str
    """
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.AzureLargeStorageInstance"]] = None,
        next_link: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword value: The list of AzureLargeStorage instances.
        :paramtype value: list[~azure.mgmt.azurelargeinstance.models.AzureLargeStorageInstance]
        :keyword next_link: The URL to get the next set of AzureLargeStorage instances.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
        self.value = value
...
class ForceState(_serialization.Model):
    ...
    :vartype force_state: str or
     ~azure.mgmt.azurelargeinstance.models.AzureLargeInstanceForcePowerState
    """
...
class OperationStatusResult(_serialization.Model):
    ...
    :vartype operations: list[~azure.mgmt.azurelargeinstance.models.OperationStatusResult]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype operations: list[~azure.mgmt.azurelargeinstance.models.OperationStatusResult]
...
class StorageProperties(_serialization.Model):
    ...
    :ivar provisioning_state: State of provisioning of the AzureLargeStorageInstance. Known values
     ...
     "Migrating".
    :vartype provisioning_state: str or ~azure.mgmt.azurelargeinstance.models.ProvisioningState
    ...
    :vartype storage_billing_properties:
     ~azure.mgmt.azurelargeinstance.models.StorageBillingProperties
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword provisioning_state: State of provisioning of the AzureLargeStorageInstance. Known
         values are: "Accepted", "Creating", "Updating", "Failed", "Succeeded", "Deleting", "Canceled",
         and "Migrating".
        :paramtype provisioning_state: str or ~azure.mgmt.azurelargeinstance.models.ProvisioningState
