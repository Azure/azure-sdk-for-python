...
For deeper context on why the library is designed the way it is, see the [architecture decision log](https://github.com/Azure/azure-sdk-for-python/blob/main/sdk/identity/azure-identity/decision.md), a chronological record of key design decisions and the reasoning behind them.
