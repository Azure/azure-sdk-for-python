...
For deeper context on why the library is designed the way it is, see the [architecture decision log](design-decisions.md), a chronological record of key design decisions and the reasoning behind them.
