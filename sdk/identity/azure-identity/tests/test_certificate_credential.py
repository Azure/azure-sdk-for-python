...
def test_request_url():
    ...
    for cert_path, password in ((CERT_PATH, None), (CERT_WITH_PASSWORD_PATH, 'password')):
        cred = CertificateCredential(tenant_id, "client_id", cert_path, password=password, transport=Mock(send=mock_send), authority=authority)
