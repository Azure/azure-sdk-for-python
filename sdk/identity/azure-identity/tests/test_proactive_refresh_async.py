...
from azure.identity.aio._internal.proactive_refresh import ProactiveRefresh

pytestmark = pytest.mark.asyncio


class MockCredential(ProactiveRefresh):
    ...
    async def get_token(self, *_, **__):
        return await self._get_token_impl(*_, **__)
