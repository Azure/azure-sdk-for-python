...
class TestAppService(RecordedTestCase):
    def load_settings(self):
        if is_live():
            ...
            if not (url and SystemEnvironmentVariables.MSI_SECRET in os.environ):
            ...
            env = {
                SystemEnvironmentVariables.IDENTITY_ENDPOINT: PLAYBACK_URL,
                SystemEnvironmentVariables.IDENTITY_HEADER: "redacted",
            }
