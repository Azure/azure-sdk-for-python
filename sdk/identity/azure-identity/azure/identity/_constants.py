...
CERT_VARS = (
    EnvironmentVariables.AZURE_CLIENT_ID,
    EnvironmentVariables.AZURE_CLIENT_CERTIFICATE_PATH,
    EnvironmentVariables.AZURE_TENANT_ID,
)
USERNAME_PASSWORD_VARS = (
    EnvironmentVariables.AZURE_CLIENT_ID,
    EnvironmentVariables.AZURE_USERNAME,
    EnvironmentVariables.AZURE_PASSWORD,
)
WORKLOAD_IDENTITY_VARS = (
    EnvironmentVariables.AZURE_AUTHORITY_HOST,
    EnvironmentVariables.AZURE_TENANT_ID,
    SystemEnvironmentVariables.AZURE_FEDERATED_TOKEN_FILE,
)
