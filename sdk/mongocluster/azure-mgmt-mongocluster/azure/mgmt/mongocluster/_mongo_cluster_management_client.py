...
from ._configuration import MongoClusterManagementClientConfiguration
...
class MongoClusterManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MongoClusterManagementClientConfiguration(
    ...
    def __enter__(self) -> "MongoClusterManagementClient":
