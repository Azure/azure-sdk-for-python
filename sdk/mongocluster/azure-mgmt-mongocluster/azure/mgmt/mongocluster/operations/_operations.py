...
def build_operations_list_request(**kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2025-05-30-preview"))
...
def build_users_get_request(
    resource_group_name: str, mongo_cluster_name: str, user_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_users_list_by_mongo_cluster_request(  # pylint: disable=name-too-long
    resource_group_name: str, mongo_cluster_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/mongoClusters/{mongoClusterName}/users"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "mongoClusterName": _SERIALIZER.url("mongo_cluster_name", mongo_cluster_name, "str"),
...
class MongoClustersOperations:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.MongoCluster"]:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.MongoCluster"]:
...
class UsersOperations:
    ...
    def list_by_mongo_cluster(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.mongocluster.models.User]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
