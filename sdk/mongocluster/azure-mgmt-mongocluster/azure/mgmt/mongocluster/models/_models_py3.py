...
class AdministratorProperties(_serialization.Model):
    ...
    def __init__(self, *, user_name: Optional[str] = None, password: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword user_name: The administrator user name.
        :paramtype user_name: str
        :keyword password: The administrator password.
...
class ComputeProperties(_serialization.Model):
    ...
    def __init__(self, *, tier: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword tier: The compute tier to assign to the cluster, where each tier maps to a
         virtual-core and memory size. Example values: 'M30', 'M40'.
        :paramtype tier: str
        """
        super().__init__(**kwargs)
        self.tier = tier
...
class HighAvailabilityProperties(_serialization.Model):
    ...
    _attribute_map = {
        "target_mode": {"key": "targetMode", "type": "str"},
    }

    def __init__(
        self, *, target_mode: Optional[Union[str, "_models.HighAvailabilityMode"]] = None, **kwargs: Any
    ) -> None:
        """
        :keyword target_mode: The target high availability mode requested for the cluster. Known values
         are: "Disabled", "SameZone", and "ZoneRedundantPreferred".
        :paramtype target_mode: str or ~azure.mgmt.mongocluster.models.HighAvailabilityMode
        """
        super().__init__(**kwargs)
...
class MongoClusterProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    _validation = {
        ...
        "infrastructure_version": {"readonly": True},
    }

    _attribute_map = {
        "create_mode": {"key": "createMode", "type": "str"},
        "restore_parameters": {"key": "restoreParameters", "type": "MongoClusterRestoreParameters"},
        "replica_parameters": {"key": "replicaParameters", "type": "MongoClusterReplicaParameters"},
        "administrator": {"key": "administrator", "type": "AdministratorProperties"},
        "server_version": {"key": "serverVersion", "type": "str"},
        "connection_string": {"key": "connectionString", "type": "str"},
        "provisioning_state": {"key": "provisioningState", "type": "str"},
        "cluster_status": {"key": "clusterStatus", "type": "str"},
        "public_network_access": {"key": "publicNetworkAccess", "type": "str"},
        "high_availability": {"key": "highAvailability", "type": "HighAvailabilityProperties"},
        "storage": {"key": "storage", "type": "StorageProperties"},
        "sharding": {"key": "sharding", "type": "ShardingProperties"},
        "compute": {"key": "compute", "type": "ComputeProperties"},
        "backup": {"key": "backup", "type": "BackupProperties"},
        "private_endpoint_connections": {"key": "privateEndpointConnections", "type": "[PrivateEndpointConnection]"},
        "preview_features": {"key": "previewFeatures", "type": "[str]"},
        "replica": {"key": "replica", "type": "ReplicationProperties"},
        "infrastructure_version": {"key": "infrastructureVersion", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword replica_parameters: The parameters to create a replica mongo cluster.
        :paramtype replica_parameters: ~azure.mgmt.mongocluster.models.MongoClusterReplicaParameters
        :keyword administrator: The local administrator properties for the mongo cluster.
        :paramtype administrator: ~azure.mgmt.mongocluster.models.AdministratorProperties
        ...
        :keyword high_availability: The high availability properties of the mongo cluster.
        :paramtype high_availability: ~azure.mgmt.mongocluster.models.HighAvailabilityProperties
        :keyword storage: The storage properties of the mongo cluster.
        :paramtype storage: ~azure.mgmt.mongocluster.models.StorageProperties
        :keyword sharding: The sharding properties of the mongo cluster.
        :paramtype sharding: ~azure.mgmt.mongocluster.models.ShardingProperties
        :keyword compute: The compute properties of the mongo cluster.
        :paramtype compute: ~azure.mgmt.mongocluster.models.ComputeProperties
        :keyword backup: The backup properties of the mongo cluster.
        :paramtype backup: ~azure.mgmt.mongocluster.models.BackupProperties
        :keyword preview_features: List of private endpoint connections.
        :paramtype preview_features: list[str or ~azure.mgmt.mongocluster.models.PreviewFeature]
        """
        super().__init__(**kwargs)
        self.create_mode = create_mode
        self.restore_parameters = restore_parameters
        self.replica_parameters = replica_parameters
        ...
        self.replica = None
        self.infrastructure_version = None


class MongoClusterReplicaParameters(_serialization.Model):
    ...
    def __init__(self, *, source_resource_id: str, source_location: str, **kwargs: Any) -> None:
        """
        :keyword source_resource_id: The id of the replication source cluster. Required.
        :paramtype source_resource_id: str
        :keyword source_location: The location of the source cluster. Required.
...
class PromoteReplicaRequest(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword promote_option: The promote option to apply to the operation. Required. "Forced"
        :paramtype promote_option: str or ~azure.mgmt.mongocluster.models.PromoteOption
        :keyword mode: The mode to apply to the promote operation. Value is optional and default value
         is 'Switchover'. "Switchover"
        :paramtype mode: str or ~azure.mgmt.mongocluster.models.PromoteMode
        """
        super().__init__(**kwargs)
...
class Replica(ProxyResource):
    ...
    def __init__(self, *, properties: Optional["_models.MongoClusterProperties"] = None, **kwargs: Any) -> None:
        """
        :keyword properties: The resource-specific properties for this resource.
        :paramtype properties: ~azure.mgmt.mongocluster.models.MongoClusterProperties
        """
...
class ReplicaListResult(_serialization.Model):
    ...
    :ivar value: The Replica items on this page. Required.
    :vartype value: list[~azure.mgmt.mongocluster.models.Replica]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.Replica"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: The Replica items on this page. Required.
        :paramtype value: list[~azure.mgmt.mongocluster.models.Replica]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ShardingProperties(_serialization.Model):
    ...
    def __init__(self, *, shard_count: Optional[int] = None, **kwargs: Any) -> None:
        """
        :keyword shard_count: Number of shards to provision on the cluster.
...
class StorageProperties(_serialization.Model):
    ...
    def __init__(self, *, size_gb: Optional[int] = None, **kwargs: Any) -> None:
        """
        :keyword size_gb: The size of the data disk assigned to each server.
