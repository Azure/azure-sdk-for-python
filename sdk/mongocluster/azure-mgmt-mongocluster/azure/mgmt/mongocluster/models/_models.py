...
class FirewallRule(ProxyResource):
    ...
    properties: Optional["_models.FirewallRuleProperties"] = rest_field(visibility=["read", "create"])
...
class MongoCluster(TrackedResource):
    ...
    properties: Optional["_models.MongoClusterProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class PrivateEndpointConnectionProperties(_model_base.Model):
    ...
    :ivar group_ids: The group identifiers for the private endpoint resource.
...
class PrivateEndpointConnectionResource(ProxyResource):
    ...
    properties: Optional["_models.PrivateEndpointConnectionProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
...
class PrivateLinkResource(ProxyResource):
    ...
    properties: Optional["_models.PrivateLinkResourceProperties"] = rest_field(visibility=["read", "create"])
    """The resource-specific properties for this resource."""
