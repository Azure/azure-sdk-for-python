...
class MongoClustersOperations:
    ...
    async def get(self, resource_group_name: str, mongo_cluster_name: str, **kwargs: Any) -> _models.MongoCluster:
        ...
        deserialized = self._deserialize("MongoCluster", pipeline_response.http_response)
    ...
    async def list_connection_strings(
        ...
        deserialized = self._deserialize("ListConnectionStringsResult", pipeline_response.http_response)
    ...
    async def _promote_initial(
        ...
        resource_group_name: str,
        mongo_cluster_name: str,
        body: Union[_models.PromoteReplicaRequest, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "PromoteReplicaRequest")
    ...
    async def begin_promote(
        ...
        **kwargs: Any
        ...
        :param body: The content of the action request. Is either a PromoteReplicaRequest type or a
         IO[bytes] type. Required.
        :type body: ~azure.mgmt.mongocluster.models.PromoteReplicaRequest or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
