...
from ...operations._operations import (
    ...
    build_firewall_rules_list_by_mongo_cluster_request,
    build_mongo_clusters_check_name_availability_request,
    build_mongo_clusters_create_or_update_request,
    build_mongo_clusters_delete_request,
    build_mongo_clusters_get_request,
...
class Operations:
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: MongoClusterMgmtClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
...
class MongoClustersOperations:
    ...
    async def get(self, resource_group_name: str, mongo_cluster_name: str, **kwargs: Any) -> _models.MongoCluster:
        ...
        _request = build_mongo_clusters_get_request(
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _request = build_mongo_clusters_create_or_update_request(
            resource_group_name=resource_group_name,
            mongo_cluster_name=mongo_cluster_name,
            subscription_id=self._config.subscription_id,
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        _request = build_mongo_clusters_update_request(
            resource_group_name=resource_group_name,
            mongo_cluster_name=mongo_cluster_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
    ...
    async def _delete_initial(
        ...
        _request = build_mongo_clusters_delete_request(
            resource_group_name=resource_group_name,
            mongo_cluster_name=mongo_cluster_name,
            subscription_id=self._config.subscription_id,
            api_version=self._config.api_version,
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.MongoCluster"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_mongo_clusters_list_by_resource_group_request(
                    resource_group_name=resource_group_name,
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
                    headers=_headers,
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.MongoCluster"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_mongo_clusters_list_request(
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
                    headers=_headers,
                    params=_params,
    ...
    async def list_connection_strings(
        ...
        :param mongo_cluster_name: The name of the mongo cluster. Required.
        :type mongo_cluster_name: str
        :return: ListConnectionStringsResult. The ListConnectionStringsResult is compatible with
         MutableMapping
        ...
        _request = build_mongo_clusters_list_connection_strings_request(
            resource_group_name=resource_group_name,
            mongo_cluster_name=mongo_cluster_name,
            subscription_id=self._config.subscription_id,
            api_version=self._config.api_version,
    ...
    async def check_name_availability(
        ...
        _request = build_mongo_clusters_check_name_availability_request(
            location=location,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
            api_version=self._config.api_version,
