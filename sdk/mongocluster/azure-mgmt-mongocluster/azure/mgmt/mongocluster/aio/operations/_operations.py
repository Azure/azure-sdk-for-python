...
class MongoClustersOperations:
        ...
        Example:
            .. code-block:: python
                ...
                response == {
                    ...
                    "properties": {
                        "administratorLogin": "str",  # Optional. The administrator's login
                          for the mongo cluster.
                        "administratorLoginPassword": "str",  # Optional. The password of the
                          administrator login.
                        "clusterStatus": "str",  # Optional. The status of the mongo cluster.
                          Known values are: "Ready", "Provisioning", "Updating", "Starting",
                          "Stopping", "Stopped", and "Dropping".
                        "connectionString": "str",  # Optional. The default mongo connection
                          string for the cluster.
                        "createMode": "str",  # Optional. The mode to create a mongo cluster.
                          Known values are: "Default" and "PointInTimeRestore".
                        "earliestRestoreTime": "str",  # Optional. Earliest restore timestamp
                          in UTC ISO8601 format.
                        "nodeGroupSpecs": [
                            {
                                "diskSizeGB": 0,  # Optional. The disk storage size
                                  for the node group in GB. Example values: 128, 256, 512, 1024.
                                "enableHa": bool,  # Optional. Whether high
                                  availability is enabled on the node group.
                                "kind": "str",  # Optional. The node type deployed in
                                  the node group. "Shard"
                                "nodeCount": 0,  # Optional. The number of nodes in
                                  the node group.
                                "sku": "str"  # Optional. The resource sku for the
                                  node group. This defines the size of CPU and memory that is
                        ...
                        "privateEndpointConnections": [
                            {
                                ...
                                "properties": {
                                    ...
                                    "groupIds": [
                                        "str"  # Optional. The group
                                          identifiers for the private endpoint resource.
                                    ],
                                    "privateEndpoint": {
                                    ...
                                    "provisioningState": "str"  # Optional. The
                                      ...
                                      Known values are: "Succeeded", "Failed", "Canceled", "Creating",
                                      and "Deleting".
                                },
                                "systemData": {
                        ...
                        "provisioningState": "str",  # Optional. The provisioning state of
                          the mongo cluster. Known values are: "Succeeded", "Failed", "Canceled",
                          "InProgress", "Updating", and "Dropping".
                        "publicNetworkAccess": "str",  # Optional. Whether or not public
                          endpoint access is allowed for this mongo cluster. Known values are:
                          "Enabled" and "Disabled".
                        "restoreParameters": {
                            "pointInTimeUTC": "2020-02-20 00:00:00",  # Optional. UTC
                              point in time to restore a mongo cluster.
                            "sourceResourceId": "str"  # Optional. Resource ID to locate
                              the source cluster to restore.
                        },
                        "serverVersion": "str"  # Optional. The Mongo DB server version.
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.MongoCluster"]:
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.MongoCluster], deserialized["value"])
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, AsyncList(list_of_elem)
...
class FirewallRulesOperations:
        ...
        Example:
            .. code-block:: python
                ...
                response == {
                    ...
                    "name": "str",  # Optional. The name of the resource.
                    "properties": {
                        "endIpAddress": "str",  # The end IP address of the mongo cluster
                          firewall rule. Must be IPv4 format. Required.
                        "startIpAddress": "str",  # The start IP address of the mongo cluster
                          firewall rule. Must be IPv4 format. Required.
                        "provisioningState": "str"  # Optional. The provisioning state of the
                          firewall rule. Known values are: "Succeeded", "Failed", "Canceled",
                          "InProgress", "Updating", and "Dropping".
                    },
                    "systemData": {
                        "createdAt": "2020-02-20",  # Optional. The type of identity that
    ...
    def list_by_mongo_cluster(
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.FirewallRule], deserialized["value"])
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, AsyncList(list_of_elem)
            ...
            .. code-block:: python
                ...
                response == {
                    ...
                    "properties": {
                        ...
                        "groupIds": [
                            "str"  # Optional. The group identifiers for the private
                              endpoint resource.
                        ],
                        "privateEndpoint": {
                            "id": "str"  # Optional. The resource identifier for private
                              endpoint.
                        },
                        "provisioningState": "str"  # Optional. The provisioning state of the
