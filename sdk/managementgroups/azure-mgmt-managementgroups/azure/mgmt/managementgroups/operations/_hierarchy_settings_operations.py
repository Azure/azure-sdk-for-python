...
class HierarchySettingsOperations:
    ...
    def create_or_update(
        self,
        group_id: str,
        create_tenant_settings_request: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.HierarchySettings:
        ...
        :type group_id: str
        :param create_tenant_settings_request: Tenant level settings request parameter. Required.
        :type create_tenant_settings_request: IO
    ...
    def create_or_update(
        self,
        group_id: str,
        create_tenant_settings_request: Union[_models.CreateOrUpdateSettingsRequest, IO],
        **kwargs: Any
    ) -> _models.HierarchySettings:
        """Creates or updates the hierarchy settings defined at the Management Group level.
        ...
        _json = None
        _content = None
        if isinstance(create_tenant_settings_request, (IO, bytes)):
