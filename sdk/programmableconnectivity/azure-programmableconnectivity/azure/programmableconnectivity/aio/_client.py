...
class ProgrammableConnectivityClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype device_location:
     azure.programmableconnectivity.aio.operations.DeviceLocationOperations
    :ivar device_network: DeviceNetworkOperations operations
    :vartype device_network: azure.programmableconnectivity.aio.operations.DeviceNetworkOperations
    :ivar number_verification: NumberVerificationOperations operations
    :vartype number_verification:
     azure.programmableconnectivity.aio.operations.NumberVerificationOperations
    :ivar sim_swap: SimSwapOperations operations
    :vartype sim_swap: azure.programmableconnectivity.aio.operations.SimSwapOperations
