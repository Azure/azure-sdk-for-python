...
from azure.mgmt.desktopvirtualization import DesktopVirtualizationAPIClient
...
# USAGE
    python application_group_list_by_resource_group.py
...
def main():
    client = DesktopVirtualizationAPIClient(
        credential=DefaultAzureCredential(),
        subscription_id="daefabc0-95b4-48b3-b645-8a753a63c4fa",
    )

    response = client.application_groups.list_by_resource_group(
