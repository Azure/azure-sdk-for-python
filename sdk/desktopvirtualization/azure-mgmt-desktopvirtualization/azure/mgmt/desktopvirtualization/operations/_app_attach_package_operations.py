...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "appAttachPackageName": _SERIALIZER.url(
...
def build_list_by_subscription_request(
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DesktopVirtualization/appAttachPackages"
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class AppAttachPackageOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, app_attach_package_name: str, **kwargs: Any) -> _models.AppAttachPackage:
