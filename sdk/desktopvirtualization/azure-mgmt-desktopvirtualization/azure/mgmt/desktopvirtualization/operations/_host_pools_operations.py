...
def build_retrieve_registration_token_request(  # pylint: disable=name-too-long
    resource_group_name: str, host_pool_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_registration_tokens_request(
    resource_group_name: str, host_pool_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class HostPoolsOperations:
    ...
    def get(self, resource_group_name: str, host_pool_name: str, **kwargs: Any) -> _models.HostPool:
        ...
        deserialized = self._deserialize("HostPool", pipeline_response.http_response)
    ...
    def list_registration_tokens(
        ...
        :param host_pool_name: The name of the host pool within the specified resource group. Required.
        :type host_pool_name: str
        :return: RegistrationTokenList or the result of cls(response)
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.RegistrationTokenList] = kwargs.pop("cls", None)

        _request = build_list_registration_tokens_request(
            resource_group_name=resource_group_name,
            host_pool_name=host_pool_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
        ...
        deserialized = self._deserialize("RegistrationTokenList", pipeline_response.http_response)
