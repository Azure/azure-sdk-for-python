...
class ScalingPlansOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        path_format_arguments = {
            ...
            'scalingPlanName': self._serialize.url("scaling_plan_name", scaling_plan_name, 'str', max_length=64, min_length=3),
        }
    ...
    def create(
        ...
        resource_group_name,  # type: str
        scaling_plan_name,  # type: str
        scaling_plan,  # type: "_models.ScalingPlan"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ScalingPlan"
    ...
    def update(
        ...
        resource_group_name,  # type: str
        scaling_plan_name,  # type: str
        scaling_plan=None,  # type: Optional["_models.ScalingPlanPatch"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ScalingPlan"
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ScalingPlanList"]
        """List scaling plans.
