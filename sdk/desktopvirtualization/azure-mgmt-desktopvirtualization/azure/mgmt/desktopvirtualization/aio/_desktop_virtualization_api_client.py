...
class DesktopVirtualizationAPIClient:    # pylint: disable=too-many-instance-attributes
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2022-02-10-preview". Note that overriding
