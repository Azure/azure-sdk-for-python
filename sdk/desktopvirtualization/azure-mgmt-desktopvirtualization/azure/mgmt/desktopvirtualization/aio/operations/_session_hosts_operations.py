...
from ...operations._session_hosts_operations import build_delete_request, build_get_request, build_list_request, build_update_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class SessionHostsOperations:
    """SessionHostsOperations async operations.
    ...
    def list(
        ...
        host_pool_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.SessionHostList"]:
        """List sessionHosts.
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.desktopvirtualization.models.SessionHostList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-02-10-preview")  # type: str
