...
class StartMenuItemsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.StartMenuItemList"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.desktopvirtualization.models.StartMenuItemList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-02-10-preview")  # type: str

        cls = kwargs.pop('cls', None)  # type: ClsType["_models.StartMenuItemList"]
        error_map = {
