...
from ...operations._app_attach_package_operations import (
...
class AppAttachPackageOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`app_attach_package` attribute.
    """
    ...
    async def get(
        ...
        cls: ClsType[_models.AppAttachPackage] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("AppAttachPackage", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        app_attach_package: _models.AppAttachPackage,
        *,
    ...
    async def create_or_update(
        ...
        resource_group_name: str,
        app_attach_package_name: str,
        app_attach_package: Union[_models.AppAttachPackage, IO[bytes]],
        **kwargs: Any
    ) -> _models.AppAttachPackage:
        """Create or update an App Attach package.
        ...
        :type app_attach_package: ~azure.mgmt.desktopvirtualization.models.AppAttachPackage or
         IO[bytes]
        :return: AppAttachPackage or the result of cls(response)
        :rtype: ~azure.mgmt.desktopvirtualization.models.AppAttachPackage
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        _json = None
        _content = None
        if isinstance(app_attach_package, (IOBase, bytes)):
            _content = app_attach_package
        else:
            _json = self._serialize.body(app_attach_package, "AppAttachPackage")
    ...
    async def update(
        ...
        resource_group_name: str,
        app_attach_package_name: str,
        app_attach_package_patch: Optional[_models.AppAttachPackagePatch] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.AppAttachPackage:
        ...
        :param app_attach_package_patch: Object containing App Attach Package definition. Default value
         is None.
        :type app_attach_package_patch: ~azure.mgmt.desktopvirtualization.models.AppAttachPackagePatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: AppAttachPackage or the result of cls(response)
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param app_attach_package_patch: Object containing App Attach Package definition. Default value
         is None.
        :type app_attach_package_patch: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: AppAttachPackage or the result of cls(response)
    ...
    async def update(
        ...
        resource_group_name: str,
        app_attach_package_name: str,
        app_attach_package_patch: Optional[Union[_models.AppAttachPackagePatch, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.AppAttachPackage:
        """Update an App Attach Package.
        ...
        _json = None
        _content = None
        if isinstance(app_attach_package_patch, (IOBase, bytes)):
            _content = app_attach_package_patch
        else:
            if app_attach_package_patch is not None:
                _json = self._serialize.body(app_attach_package_patch, "AppAttachPackagePatch")
            else:
                _json = None
