...
from ._desktop_virtualization_api_client_enums import ApplicationGroupType
from ._desktop_virtualization_api_client_enums import ApplicationType
from ._desktop_virtualization_api_client_enums import CommandLineSetting
from ._desktop_virtualization_api_client_enums import CreatedByType
from ._desktop_virtualization_api_client_enums import DayOfWeek
from ._desktop_virtualization_api_client_enums import HealthCheckName
from ._desktop_virtualization_api_client_enums import HealthCheckResult
from ._desktop_virtualization_api_client_enums import HostPoolType
from ._desktop_virtualization_api_client_enums import LoadBalancerType
from ._desktop_virtualization_api_client_enums import PersonalDesktopAssignmentType
from ._desktop_virtualization_api_client_enums import PreferredAppGroupType
from ._desktop_virtualization_api_client_enums import RegistrationTokenOperation
from ._desktop_virtualization_api_client_enums import RemoteApplicationType
from ._desktop_virtualization_api_client_enums import SSOSecretType
from ._desktop_virtualization_api_client_enums import ScalingHostPoolType
from ._desktop_virtualization_api_client_enums import ScalingScheduleDaysOfWeekItem
from ._desktop_virtualization_api_client_enums import SessionHostComponentUpdateType
from ._desktop_virtualization_api_client_enums import SessionHostLoadBalancingAlgorithm
from ._desktop_virtualization_api_client_enums import SessionState
from ._desktop_virtualization_api_client_enums import SkuTier
from ._desktop_virtualization_api_client_enums import Status
from ._desktop_virtualization_api_client_enums import StopHostsWhen
from ._desktop_virtualization_api_client_enums import UpdateState
