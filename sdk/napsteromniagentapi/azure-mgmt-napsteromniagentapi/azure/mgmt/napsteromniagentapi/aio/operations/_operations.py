...
from ...operations._operations import (
    ...
    build_organizations_latest_linked_saa_s_request,
    build_organizations_link_saa_s_request,
...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.napsteromniagentapi.aio.NapsterOmniAgentApiMgmtClient`'s
    ...
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.Operation"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.napsteromniagentapi.models.Operation]
...
class OrganizationsOperations:
    ...
    async def get(self, resource_group_name: str, organizationname: str, **kwargs: Any) -> _models.OrganizationResource:
        ...
        :rtype: ~azure.mgmt.napsteromniagentapi.models.OrganizationResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.napsteromniagentapi.models.OrganizationResource
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.napsteromniagentapi.models.OrganizationResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.napsteromniagentapi.models.OrganizationResourceUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns OrganizationResource. The
    ...
    async def _delete_initial(
        self, resource_group_name: str, organizationname: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.napsteromniagentapi.models.OrganizationResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def _link_saa_s_initial(
        ...
        **kwargs: Any
        ...
        _request = build_organizations_link_saa_s_request(
            resource_group_name=resource_group_name,
            organizationname=organizationname,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
    ...
    async def begin_link_saa_s(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.napsteromniagentapi.models.SaaSData
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns OrganizationResource. The
    ...
    async def latest_linked_saa_s(
        ...
        :return: LatestLinkedSaaSResponse. The LatestLinkedSaaSResponse is compatible with
         MutableMapping
        :rtype: ~azure.mgmt.napsteromniagentapi.models.LatestLinkedSaaSResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _request = build_organizations_latest_linked_saa_s_request(
            resource_group_name=resource_group_name,
            organizationname=organizationname,
            subscription_id=self._config.subscription_id,
            api_version=self._config.api_version,
...
class SaaSOperationGroupOperations:
    ...
    async def begin_activate_resource(
        ...
        :type body: ~azure.mgmt.napsteromniagentapi.models.ActivateSaaSParameterRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.napsteromniagentapi.models.SaaSResourceDetailsResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
