...
class NapsterOmniAgentApiMgmtClient:
    ...
    :vartype organizations: azure.mgmt.napsteromniagentapi.aio.operations.OrganizationsOperations
    :ivar saa_soperation_group: SaaSOperationGroupOperations operations
    :vartype saa_soperation_group:
     azure.mgmt.napsteromniagentapi.aio.operations.SaaSOperationGroupOperations
