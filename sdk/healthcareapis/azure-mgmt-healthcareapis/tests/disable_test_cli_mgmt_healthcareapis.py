...
class MgmtHealthcareApisTest(AzureMgmtTestCase):
    ...
    def setUp(self):
        ...
        self.mgmt_client = self.create_mgmt_client(azure.mgmt.healthcareapis.HealthcareApisManagementClient)
    ...
    def test_healthcareapis(self, resource_group):
        ...
        BODY = {
            ...
            "properties": {
                ...
                "cosmos_db_configuration": {"offer_throughput": "1000"},
        ...
        BODY = {"type": "Microsoft.HealthcareApis/services", "name": "serviceName"}
