...
class TestHealthcareApisManagementServicesOperations(AzureMgmtRecordedTestCase):
        ...
        response = self.client.services.begin_create_or_update(
            ...
            service_description={
                ...
                "properties": {
                    ...
                    "authenticationConfiguration": {"audience": "str", "authority": "str", "smartProxyEnabled": bool},
                    "corsConfiguration": {
    ...
    def test_services_begin_update(self, resource_group):
        response = self.client.services.begin_update(
            resource_group_name=resource_group.name,
            resource_name="str",
            service_patch_description={"properties": {"publicNetworkAccess": "str"}, "tags": {"str": "str"}},
        ).result()  # call '.result()' to poll until service return final result
