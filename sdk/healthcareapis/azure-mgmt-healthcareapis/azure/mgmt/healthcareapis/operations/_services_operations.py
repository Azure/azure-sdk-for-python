...
class ServicesOperations:
    ...
    def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.ServicesDescription:
        ...
        deserialized = self._deserialize("ServicesDescription", pipeline_response.http_response)
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.ServicesDescription"]:
    ...
    ) -> ItemPaged["_models.ServicesDescription"]:
    ...
    def check_name_availability(
        ...
        deserialized = self._deserialize("ServicesNameAvailabilityInfo", pipeline_response.http_response)
