...
def build_list_by_iot_connector_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HealthcareApis/workspaces/{workspaceName}/iotconnectors/{iotConnectorName}/fhirdestinations")  # pylint: disable=line-too-long
...
class FhirDestinationsOperations(object):
    ...
    def list_by_iot_connector(
        ...
        iot_connector_name: str,
        **kwargs: Any
    ) -> Iterable["_models.IotFhirDestinationCollection"]:
        ...
        :return: An iterator like instance of either IotFhirDestinationCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.healthcareapis.models.IotFhirDestinationCollection]
