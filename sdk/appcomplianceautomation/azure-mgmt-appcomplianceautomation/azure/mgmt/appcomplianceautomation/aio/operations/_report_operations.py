...
from ...operations._report_operations import (
    ...
    build_fix_request,
    build_get_request,
    build_get_scoping_questions_request,
    build_list_request,
    build_nested_resource_check_name_availability_request,
    build_sync_cert_record_request,
...
class ReportOperations:
    ...
    @overload
    async def nested_resource_check_name_availability(
        self,
        report_name: str,
    ...
    async def _fix_initial(self, report_name: str, **kwargs: Any) -> Optional[_models.ReportFixResult]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def begin_fix(self, report_name: str, **kwargs: Any) -> AsyncLROPoller[_models.ReportFixResult]:
        ...
        :param report_name: Report Name. Required.
        :type report_name: str
        :return: An instance of AsyncLROPoller that returns either ReportFixResult or the result of
         cls(response)
        :rtype:
    ...
    async def begin_sync_cert_record(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either SyncCertRecordResponse or the result
         of cls(response)
        :rtype:
    ...
    async def _verify_initial(self, report_name: str, **kwargs: Any) -> Optional[_models.ReportVerificationResult]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def begin_verify(self, report_name: str, **kwargs: Any) -> AsyncLROPoller[_models.ReportVerificationResult]:
        ...
        :param report_name: Report Name. Required.
        :type report_name: str
        :return: An instance of AsyncLROPoller that returns either ReportVerificationResult or the
