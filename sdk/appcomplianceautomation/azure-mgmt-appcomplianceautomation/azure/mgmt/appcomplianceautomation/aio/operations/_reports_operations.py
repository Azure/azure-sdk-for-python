...
from ...operations._reports_operations import build_list_request
...
class ReportsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.ReportResourceList]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("ReportResourceList", pipeline_response)
    ...
    list.metadata = {"url": "/providers/Microsoft.AppComplianceAutomation/reports"}  # type: ignore
