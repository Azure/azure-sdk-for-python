    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param parameters: Volume Group object. Is either a VolumeGroup type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.elasticsan.models.VolumeGroup or IO[bytes]
        :return: An instance of LROPoller that returns either VolumeGroup or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.elasticsan.models.VolumeGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("VolumeGroup", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Volume Group object. Is either a VolumeGroupUpdate type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.elasticsan.models.VolumeGroupUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either VolumeGroup or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.elasticsan.models.VolumeGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
