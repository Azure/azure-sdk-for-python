...
def build_list_by_elastic_san_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ElasticSan/elasticSans/{elasticSanName}/volumeGroups")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._]*[0-9A-Za-z]$'),
        "elasticSanName": _SERIALIZER.url("elastic_san_name", elastic_san_name, 'str', max_length=24, min_length=3, pattern=r'^[A-Za-z0-9]+((-|_)[a-z0-9A-Z]+)*$'),
    }
...
def build_create_request_initial(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ElasticSan/elasticSans/{elasticSanName}/volumegroups/{volumeGroupName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._]*[0-9A-Za-z]$'),
        "elasticSanName": _SERIALIZER.url("elastic_san_name", elastic_san_name, 'str', max_length=24, min_length=3, pattern=r'^[A-Za-z0-9]+((-|_)[a-z0-9A-Z]+)*$'),
        "volumeGroupName": _SERIALIZER.url("volume_group_name", volume_group_name, 'str', max_length=63, min_length=3, pattern=r'^[A-Za-z0-9]+((-|_)[a-z0-9A-Z]+)*$'),
    }
...
def build_delete_request_initial(
    ...
    volume_group_name: str,
    *,
    force_delete_volumes: Optional[bool] = None,
    **kwargs: Any
) -> HttpRequest:
    api_version = kwargs.pop('api_version', "2021-11-20-preview")  # type: str
    ...
    # Construct headers
    _header_parameters = kwargs.pop("headers", {})  # type: Dict[str, Any]
    if force_delete_volumes is not None:
        _header_parameters['x-ms-delete-volumes'] = _SERIALIZER.header("force_delete_volumes", force_delete_volumes, 'bool')
    _header_parameters['Accept'] = _SERIALIZER.header("accept", accept, 'str')
...
class VolumeGroupsOperations(object):
    ...
    :type models: ~azure.mgmt.elasticsan.models
    ...
    def list_by_elastic_san(
        ...
        **kwargs: Any
        ...
        :param elastic_san_name: The name of the ElasticSan.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.elasticsan.models.VolumeGroupList]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either VolumeGroup or the result of
         cls(response)
    ...
    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_delete_request_initial(
            ...
            volume_group_name=volume_group_name,
            api_version=api_version,
            force_delete_volumes=force_delete_volumes,
    ...
    def begin_delete(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param volume_group_name: The name of the VolumeGroup.
        :type volume_group_name: str
        :param force_delete_volumes: Required if the Volume Group has associated volumes. Default value
         is None.
        :type force_delete_volumes: bool
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
