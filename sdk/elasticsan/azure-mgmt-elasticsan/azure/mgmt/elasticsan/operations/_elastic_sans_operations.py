...
def build_delete_request_initial(
    ...
    **kwargs: Any
    ...
    if force_delete_volume_groups is not None:
        _header_parameters['x-ms-delete-volumegroups'] = _SERIALIZER.header("force_delete_volume_groups", force_delete_volume_groups, 'bool')
    _header_parameters['Accept'] = _SERIALIZER.header("accept", accept, 'str')
...
class ElasticSansOperations(object):
    """ElasticSansOperations operations.
