...
from ...operations._volumes_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_volume_group_request, build_update_request_initial
T = TypeVar('T')
...
class VolumesOperations:
    ...
    def list_by_volume_group(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.elasticsan.models.VolumeList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-11-20-preview")  # type: str
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_volume_group_request(
                    subscription_id=self._config.subscription_id,
                    resource_group_name=resource_group_name,
                    elastic_san_name=elastic_san_name,
                    volume_group_name=volume_group_name,
