...
class SkusOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.elasticsan.models.SkuInformationList]
    ...
    list.metadata = {'url': "/providers/Microsoft.ElasticSan/skus"}  # type: ignore
