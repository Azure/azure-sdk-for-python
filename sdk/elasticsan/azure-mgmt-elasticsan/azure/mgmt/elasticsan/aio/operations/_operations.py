...
class Operations:
    ...
    def list(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.ElasticSanOperationListResult"]:
        """Gets a list of ElasticSan operations.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ElasticSanOperationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.elasticsan.models.ElasticSanOperationListResult]
