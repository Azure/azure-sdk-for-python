...
from ...operations._elastic_sans_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_update_request_initial
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class ElasticSansOperations:
    """ElasticSansOperations async operations.
    ...
    def list_by_subscription(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.ElasticSanList"]:
        """Gets a list of ElasticSans in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ElasticSanList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.elasticsan.models.ElasticSanList]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ElasticSan or the result of
         cls(response)
    ...
    async def _delete_initial(  # pylint: disable=inconsistent-return-statements
        ...
        resource_group_name: str,
        elastic_san_name: str,
        force_delete_volume_groups: Optional[bool] = None,
        **kwargs: Any
    ) -> None:
        ...
        request = build_delete_request_initial(
            ...
            elastic_san_name=elastic_san_name,
            api_version=api_version,
            force_delete_volume_groups=force_delete_volume_groups,
    ...
    async def begin_delete(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param elastic_san_name: The name of the ElasticSan.
        :type elastic_san_name: str
        :param force_delete_volume_groups: Required if the San has associated Volume Groups. Default
         value is None.
        :type force_delete_volume_groups: bool
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :type elastic_san_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ElasticSan, or the result of cls(response)
