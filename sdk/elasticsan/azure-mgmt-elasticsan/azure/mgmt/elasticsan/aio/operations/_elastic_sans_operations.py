...
from ...operations._elastic_sans_operations import (
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param parameters: Elastic San object. Is either a ElasticSan type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.elasticsan.models.ElasticSan or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ElasticSan or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.elasticsan.models.ElasticSan]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("ElasticSan", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Elastic San object. Is either a ElasticSanUpdate type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.elasticsan.models.ElasticSanUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ElasticSan or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.elasticsan.models.ElasticSan]
        :raises ~azure.core.exceptions.HttpResponseError:
