...
class MicrosoftVoiceServices:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype operations: azure.mgmt.voiceservices.aio.operations.Operations
    ...
    :vartype contacts: azure.mgmt.voiceservices.aio.operations.ContactsOperations
    ...
    async def __aenter__(self) -> "MicrosoftVoiceServices":
