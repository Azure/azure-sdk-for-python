...
class CommunicationsGatewayListResult(_serialization.Model):
    ...
    def __init__(self, *, value: List["_models.CommunicationsGateway"], next_link: Optional[str] = None, **kwargs):
        """
...
class ContactListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.voiceservices.models.Contact]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.Contact"], next_link: Optional[str] = None, **kwargs):
        """
        :keyword value: The Contact items on this page. Required.
        :paramtype value: list[~azure.mgmt.voiceservices.models.Contact]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ContactUpdate(_serialization.Model):
...
class PrimaryRegionProperties(_serialization.Model):
    ...
    def __init__(self, *, operator_addresses: List[str], esrp_addresses: Optional[List[str]] = None, **kwargs):
        """
...
class ServiceRegionProperties(_serialization.Model):
    ...
    def __init__(self, *, name: str, primary_region_properties: "_models.PrimaryRegionProperties", **kwargs):
        """
...
class TestLineListResult(_serialization.Model):
    ...
    def __init__(self, *, value: List["_models.TestLine"], next_link: Optional[str] = None, **kwargs):
        """
