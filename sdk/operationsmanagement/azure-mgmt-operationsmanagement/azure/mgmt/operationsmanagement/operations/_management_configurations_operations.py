...
def build_create_or_update_request(
    resource_group_name: str, management_configuration_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "managementConfigurationName": _SERIALIZER.url(
            "management_configuration_name", management_configuration_name, "str"
        ),
    }
...
class ManagementConfigurationsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> _models.ManagementConfigurationPropertiesList:
