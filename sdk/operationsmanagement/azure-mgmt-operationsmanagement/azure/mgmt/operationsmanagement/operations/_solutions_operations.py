...
class SolutionsOperations:
    ...
    def _create_or_update_initial(
        self, resource_group_name: str, solution_name: str, parameters: Union[_models.Solution, IO], **kwargs: Any
    ) -> _models.Solution:
        error_map = {
    ...
    def begin_create_or_update(
        ...
        :param parameters: The parameters required to create OMS Solution. Is either a model type or a
         IO type. Required.
        :type parameters: ~azure.mgmt.operationsmanagement.models.Solution or IO
    ...
    def _update_initial(
        self, resource_group_name: str, solution_name: str, parameters: Union[_models.SolutionPatch, IO], **kwargs: Any
    ) -> _models.Solution:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_update(
        ...
        :param solution_name: User Solution Name. Required.
        :type solution_name: str
        :param parameters: The parameters required to patch a Solution. Is either a model type or a IO
         type. Required.
        :type parameters: ~azure.mgmt.operationsmanagement.models.SolutionPatch or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
