...
class SolutionsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Solution or the result of
         cls(response)
    ...
    @distributed_trace_async
    async def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> _models.SolutionPropertiesList:
    ...
    @distributed_trace_async
    async def list_by_subscription(self, **kwargs: Any) -> _models.SolutionPropertiesList:
        """Retrieves the solution list for the subscription.
