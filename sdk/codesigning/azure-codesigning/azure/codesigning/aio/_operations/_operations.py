...
from ..._operations._operations import (
    build_code_signing_get_code_signing_status_request,
    build_code_signing_get_sign_root_certificate_request,
    build_code_signing_list_sign_ekus_request,
    build_code_signing_sign_request,
)
...
class CodeSigningClientOperationsMixin(CodeSigningClientMixinABC):
    async def _get_code_signing_status_initial(
    ...
    async def begin_get_code_signing_status(
        self, operation_id: str, code_signing_account_name: str, certificate_profile_name: str, **kwargs: Any
    ) -> AsyncLROPoller[None]:
        ...
        if cont_token is None:
            raw_result = await self._get_code_signing_status_initial(
                operation_id=operation_id,
                code_signing_account_name=code_signing_account_name,
                certificate_profile_name=certificate_profile_name,
                cls=lambda x, y, z: x,
    ...
    def list_sign_ekus(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.codesigning.models.ExtendedKeyUsage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def begin_sign(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.CodeSignOperationStatus]:
        ...
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no
         Retry-After header is present.
        :return: An instance of AsyncLROPoller that returns CodeSignOperationStatus. The
         CodeSignOperationStatus is compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.codesigning.models.CodeSignOperationStatus]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
