...
from ._configuration import MicrosoftAzurePlaywrightServiceManagementAPIConfiguration
...
class MicrosoftAzurePlaywrightServiceManagementAPI:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MicrosoftAzurePlaywrightServiceManagementAPIConfiguration(
    ...
    async def __aenter__(self) -> "MicrosoftAzurePlaywrightServiceManagementAPI":
