...
class MicrosoftAzurePlaywrightServiceManagementAPIConfiguration(
    Configuration
):  # pylint: disable=too-many-instance-attributes
    """Configuration for MicrosoftAzurePlaywrightServiceManagementAPI.
    ...
    def __init__(self, credential: "AsyncTokenCredential", subscription_id: str, **kwargs: Any) -> None:
        super(MicrosoftAzurePlaywrightServiceManagementAPIConfiguration, self).__init__(**kwargs)
