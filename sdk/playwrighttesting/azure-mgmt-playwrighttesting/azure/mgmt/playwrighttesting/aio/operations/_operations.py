...
from ...operations._operations import (
    build_account_quotas_get_request,
    build_account_quotas_list_by_account_request,
    ...
    build_quotas_get_request,
    build_quotas_list_by_subscription_request,
)
...
class Operations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.Operation"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.playwrighttesting.models.Operation]
...
class AccountsOperations:
    ...
    async def _create_or_update_initial(
        ...
        account_name: str,
        resource: Union[_models.Account, JSON, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns Account. The Account is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.playwrighttesting.models.Account]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param account_name: Name of account. Required.
        :type account_name: str
        :param resource: Resource create parameters. Is one of the following types: Account, JSON,
         IO[bytes] Required.
        :type resource: ~azure.mgmt.playwrighttesting.models.Account or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns Account. The Account is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.playwrighttesting.models.Account]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def update(
        ...
        resource_group_name: str,
        account_name: str,
        properties: Union[_models.AccountUpdate, JSON, IO[bytes]],
        **kwargs: Any
    ) -> _models.Account:
        """Update a Account.
        ...
        :type properties: ~azure.mgmt.playwrighttesting.models.AccountUpdate or JSON or IO[bytes]
        :return: Account. The Account is compatible with MutableMapping
        :rtype: ~azure.mgmt.playwrighttesting.models.Account
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.Account"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.playwrighttesting.models.Account]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.Account], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, AsyncList(list_of_elem)
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.Account"]:
    ...
    async def check_name_availability(
        ...
        :type body: ~azure.mgmt.playwrighttesting.models.CheckNameAvailabilityRequest or JSON or
         IO[bytes]
        :return: CheckNameAvailabilityResponse. The CheckNameAvailabilityResponse is compatible with
         MutableMapping
        :rtype: ~azure.mgmt.playwrighttesting.models.CheckNameAvailabilityResponse
...
class QuotasOperations:
    ...
    async def get(self, location: str, quota_name: Union[str, _models.QuotaNames], **kwargs: Any) -> _models.Quota:
        ...
        _request = build_quotas_get_request(
            location=location,
    ...
    @distributed_trace
    def list_by_subscription(self, location: str, **kwargs: Any) -> AsyncIterable["_models.Quota"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.playwrighttesting.models.Quota]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_quotas_list_by_subscription_request(
                    location=location,
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
                    headers=_headers,
...
class AccountQuotasOperations:
    ...
    async def get(
        ...
        :type quota_name: str or ~azure.mgmt.playwrighttesting.models.QuotaNames
        :return: AccountQuota. The AccountQuota is compatible with MutableMapping
        ...
        _request = build_account_quotas_get_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
            quota_name=quota_name,
            subscription_id=self._config.subscription_id,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.AccountQuota, response.json())
    ...
    def list_by_account(
        ...
        :param account_name: Name of account. Required.
        :type account_name: str
        :return: An iterator like instance of AccountQuota
        :rtype:
        ...
        cls: ClsType[List[_models.AccountQuota]] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_account_quotas_list_by_account_request(
                    resource_group_name=resource_group_name,
                    account_name=account_name,
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.AccountQuota], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, AsyncList(list_of_elem)
