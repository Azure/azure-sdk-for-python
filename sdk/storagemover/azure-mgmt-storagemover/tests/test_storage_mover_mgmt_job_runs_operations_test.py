...
class TestStorageMoverMgmtJobRunsOperations(AzureMgmtRecordedTestCase):
    ...
    def _provision_parents(self, resource_group_name):
    ...
    def test_get_exist(self, resource_group):
        self._provision_parents(resource_group.name)
