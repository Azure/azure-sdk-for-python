...
class TestStorageMoverMgmtJobDefinitionsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_create_with_weekly_schedule(self, resource_group):
        rg = resource_group.name
        sm_name = "testsm-jdwk"
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_create_with_daily_schedule_and_preserve_permissions(self, resource_group):
        rg = resource_group.name
        sm_name = "testsm-jddl"
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_create_with_onetime_schedule(self, resource_group):
        rg = resource_group.name
        sm_name = "testsm-jdot"
