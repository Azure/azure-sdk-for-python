...
class TestStorageMoverMgmtConnectionsOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_connections_create_or_update(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_connections_get(self, resource_group):
        response = self.client.connections.get(
            resource_group_name=resource_group.name,
            storage_mover_name="str",
            connection_name="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_connections_list(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_connections_begin_delete(self, resource_group):
        response = self.client.connections.begin_delete(
            resource_group_name=resource_group.name,
            storage_mover_name="str",
            connection_name="str",
