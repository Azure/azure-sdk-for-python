...
class AgentProperties(TypedDict, total=False):
    ...
    :ivar agentVersion: The Agent version.
    :vartype agentVersion: str
    :ivar arcResourceId: The fully qualified resource ID of the Hybrid Compute resource for the
     Agent. Required.
    :vartype arcResourceId: str
    :ivar arcVmUuid: The VM UUID of the Hybrid Compute resource for the Agent. Required.
    :vartype arcVmUuid: str
    :ivar agentStatus: The Agent status. Known values are: "Registering", "Offline", "Online",
     "Executing", "RequiresAttention", and "Unregistering".
    :vartype agentStatus: Union[str, "AgentStatus"]
    :ivar lastStatusUpdate: The last updated time of the Agent status.
    :vartype lastStatusUpdate: str
    :ivar localIPAddress: Local IP address reported by the Agent.
    :vartype localIPAddress: str
    :ivar memoryInMB: Available memory reported by the Agent, in MB.
    :vartype memoryInMB: int
    :ivar numberOfCores: Available compute cores reported by the Agent.
    :vartype numberOfCores: int
    :ivar uptimeInSeconds: Uptime of the Agent in seconds.
    :vartype uptimeInSeconds: int
    :ivar timeZone: The agent's local time zone represented in Windows format.
    :vartype timeZone: str
    :ivar uploadLimitSchedule: The WAN-link upload limit schedule that applies to any Job Run the
    ...
    :vartype uploadLimitSchedule: "UploadLimitSchedule"
    :ivar errorDetails:
    :vartype errorDetails: "AgentPropertiesErrorDetails"
    :ivar provisioningState: The provisioning state of this resource. Known values are:
...
class AzureKeyVaultS3WithHmacCredentials(TypedDict, total=False):
    ...
    :ivar accessKeyUri: The Azure Key Vault secret URI which stores the username. Use empty string
     to clean-up existing value.
    :vartype accessKeyUri: str
    :ivar secretKeyUri: The Azure Key Vault secret URI which stores the password. Use empty string
     to clean-up existing value.
    :vartype secretKeyUri: str
...
class AzureKeyVaultSmbCredentials(TypedDict, total=False):
    ...
    :ivar usernameUri: The Azure Key Vault secret URI which stores the username. Use empty string
     to clean-up existing value.
    :vartype usernameUri: str
    :ivar passwordUri: The Azure Key Vault secret URI which stores the password. Use empty string
     to clean-up existing value.
    :vartype passwordUri: str
...
class AzureMultiCloudConnectorEndpointProperties(TypedDict, total=False):  # pylint: disable=name-too-long
    ...
    :vartype description: str
    :ivar endpointKind: The Endpoint resource kind source or target. Known values are: "Source" and
     "Target".
    :vartype endpointKind: Union[str, "EndpointKind"]
    :ivar provisioningState: The provisioning state of this resource. Known values are:
     "Succeeded", "Canceled", "Failed", and "Deleting".
    :vartype provisioningState: Union[str, "ProvisioningState"]
    :ivar multiCloudConnectorId: The Azure Resource ID of the MultiCloud Connector resource.
     Required.
    :vartype multiCloudConnectorId: str
    :ivar awsS3BucketId: The AWS S3 bucket ARM resource Id. Required.
    :vartype awsS3BucketId: str
    :ivar endpointType: The Endpoint resource type. Required. AZURE_MULTI_CLOUD_CONNECTOR.
    :vartype endpointType: Literal[EndpointType.AZURE_MULTI_CLOUD_CONNECTOR]
    """
...
class AzureStorageBlobContainerEndpointProperties(TypedDict, total=False):  # pylint: disable=name-too-long
    ...
    :ivar provisioningState: The provisioning state of this resource. Known values are:
     "Succeeded", "Canceled", "Failed", and "Deleting".
    :vartype provisioningState: Union[str, "ProvisioningState"]
    :ivar storageAccountResourceId: The Azure Resource ID of the storage account that is the target
     destination. Required.
    :vartype storageAccountResourceId: str
    :ivar blobContainerName: The name of the Storage blob container that is the target destination.
     Required.
    :vartype blobContainerName: str
    :ivar endpointType: The Endpoint resource type. Required. AZURE_STORAGE_BLOB_CONTAINER.
    :vartype endpointType: Literal[EndpointType.AZURE_STORAGE_BLOB_CONTAINER]
    :ivar enableCrossTenantTransfer: Opt-in flag enabling this endpoint to be used as one side of a
     cross-tenant data transfer pair. When set to true, RBAC for the endpoint's managed identity is
     granted on the customer's storage account so that authorization can be performed entirely in
     the tenant where this endpoint lives. Defaults to false. Can be updated via PATCH.
    :vartype enableCrossTenantTransfer: bool
    :ivar allowedStorageAccounts: Full ARM resource IDs of partner-tenant storage accounts that are
     allowed to be the other side of a cross-tenant data transfer pair with this endpoint. For a
     ...
     storage account.
    :vartype allowedStorageAccounts: list[str]
    """
...
class AzureStorageBlobContainerEndpointUpdateProperties(TypedDict, total=False):  # pylint: disable=name-too-long
    ...
    :vartype endpointType: Literal[EndpointType.AZURE_STORAGE_BLOB_CONTAINER]
    :ivar enableCrossTenantTransfer: Opt-in flag enabling this endpoint to be used as one side of a
     cross-tenant data transfer pair. Defaults to false.
    :vartype enableCrossTenantTransfer: bool
    :ivar allowedStorageAccounts: Replaces the list of partner-tenant storage account ARM IDs
...
class AzureStorageNfsFileShareEndpointProperties(TypedDict, total=False):  # pylint: disable=name-too-long
    ...
    :ivar provisioningState: The provisioning state of this resource. Known values are:
     "Succeeded", "Canceled", "Failed", and "Deleting".
    :vartype provisioningState: Union[str, "ProvisioningState"]
    :ivar storageAccountResourceId: The Azure Resource ID of the storage account. Required.
    :vartype storageAccountResourceId: str
    :ivar fileShareName: The name of the Azure Storage NFS file share. Required.
    :vartype fileShareName: str
    :ivar endpointType: The Endpoint resource type. Required. AZURE_STORAGE_NFS_FILE_SHARE.
    :vartype endpointType: Literal[EndpointType.AZURE_STORAGE_NFS_FILE_SHARE]
    """
...
class AzureStorageSmbFileShareEndpointProperties(TypedDict, total=False):  # pylint: disable=name-too-long
    ...
    :ivar storageAccountResourceId: The Azure Resource ID of the storage account. Required.
    :vartype storageAccountResourceId: str
    :ivar fileShareName: The name of the Azure Storage file share. Required.
    :vartype fileShareName: str
    :ivar endpointType: The Endpoint resource type. Required. AZURE_STORAGE_SMB_FILE_SHARE.
    :vartype endpointType: Literal[EndpointType.AZURE_STORAGE_SMB_FILE_SHARE]
    :ivar enableCrossTenantTransfer: Opt-in flag enabling this endpoint to be used as one side of a
     cross-tenant data transfer pair. When set to true, RBAC for the endpoint's managed identity is
     granted on the customer's storage account so that authorization can be performed entirely in
     the tenant where this endpoint lives. Defaults to false. Can be updated via PATCH.
...
class ConnectionProperties(TypedDict, total=False):
    ...
    :vartype description: str
    :ivar connectionStatus: The connection status. Known values are: "Approved", "Rejected",
     "Disconnected", "Pending", and "Stale".
    :vartype connectionStatus: Union[str, "ConnectionStatus"]
    :ivar privateLinkServiceId: The PrivateLinkServiceId for the connection. Required.
    :vartype privateLinkServiceId: str
    :ivar privateEndpointName: The PrivateEndpointName associated with the connection.
    :vartype privateEndpointName: str
    :ivar privateEndpointResourceId: The privateEndpoint resource Id.
    :vartype privateEndpointResourceId: str
    :ivar jobList: List of job definitions associated with this connection.
    :vartype jobList: list[str]
    :ivar provisioningState: The provisioning state of this resource. Known values are:
     "Succeeded", "Canceled", "Failed", and "Deleting".
    :vartype provisioningState: Union[str, "ProvisioningState"]
    """
...
class JobDefinitionProperties(TypedDict, total=False):
    ...
    :vartype description: str
    :ivar jobType: The type of the Job. Known values are: "OnPremToCloud", "CloudToCloud", and
     "OnPremToCloudAgentLess".
    :vartype jobType: Union[str, "JobType"]
    :ivar copyMode: Strategy to use for copy. Required. Known values are: "Additive" and "Mirror".
    :vartype copyMode: Union[str, "CopyMode"]
    :ivar sourceName: The name of the source Endpoint. Required.
    :vartype sourceName: str
    :ivar sourceResourceId: Fully qualified resource ID of the source Endpoint.
    :vartype sourceResourceId: str
    :ivar sourceSubpath: The subpath to use when reading from the source Endpoint.
    :vartype sourceSubpath: str
    :ivar targetName: The name of the target Endpoint. Required.
    :vartype targetName: str
    :ivar targetResourceId: Fully qualified resource ID of the target Endpoint.
    :vartype targetResourceId: str
    :ivar targetSubpath: The subpath to use when writing to the target Endpoint.
    :vartype targetSubpath: str
    :ivar latestJobRunName: The name of the Job Run in a non-terminal state, if exists.
    :vartype latestJobRunName: str
    :ivar latestJobRunResourceId: The fully qualified resource ID of the Job Run in a non-terminal
     state, if exists.
    :vartype latestJobRunResourceId: str
    :ivar latestJobRunStatus: The current status of the Job Run in a non-terminal state, if exists.
     Known values are: "Queued", "Started", "Running", "CancelRequested", "Canceling", "Canceled",
     "Failed", "Succeeded", and "PausedByBandwidthManagement".
    :vartype latestJobRunStatus: Union[str, "JobRunStatus"]
    :ivar agentName: Name of the Agent to assign for new Job Runs of this Job Definition.
    :vartype agentName: str
    :ivar agentResourceId: Fully qualified resource id of the Agent to assign for new Job Runs of
     this Job Definition.
    :vartype agentResourceId: str
    :ivar sourceTargetMap: The list of cloud endpoints to migrate.
    :vartype sourceTargetMap: "JobDefinitionPropertiesSourceTargetMap"
    :ivar provisioningState: The provisioning state of this resource. Known values are:
     "Succeeded", "Canceled", "Failed", and "Deleting".
    :vartype provisioningState: Union[str, "ProvisioningState"]
    ...
    :ivar dataIntegrityValidation: The checksum validation mode for the job definition. Known
     values are: "SaveVerifyFileMD5", "SaveFileMD5", and "None".
    :vartype dataIntegrityValidation: Union[str, "DataIntegrityValidation"]
    :ivar preservePermissions: Boolean to preserve permissions or not.
    :vartype preservePermissions: bool
    :ivar isCrossTenantJob: Indicates that this Job Definition is a cross-tenant job where the
    ...
    :vartype isCrossTenantJob: bool
    :ivar crossTenantEndpointTenantId: The Azure AD tenant ID of the cross-tenant source endpoint.
     Required when ``isCrossTenantJob`` is true. Cannot be modified after the Job Definition is
     created.
    :vartype crossTenantEndpointTenantId: str
    :ivar crossTenantEndpointResourceId: Full ARM resource ID of the cross-tenant (foreign)
     endpoint. On the source-tenant copy this is the TARGET endpoint; on the target-tenant copy this
     is the SOURCE endpoint.
    :vartype crossTenantEndpointResourceId: str
    :ivar syncMode: The synchronization mode for the Job Definition.
    :vartype syncMode: str
    :ivar moverSyncedUntil: The last time the mover was synchronized.
    :vartype moverSyncedUntil: str
    """
...
class JobDefinitionUpdateProperties(TypedDict, total=False):
    ...
    :vartype description: str
    :ivar copyMode: Strategy to use for copy. Known values are: "Additive" and "Mirror".
    :vartype copyMode: Union[str, "CopyMode"]
    :ivar agentName: Name of the Agent to assign for new Job Runs of this Job Definition.
    :vartype agentName: str
    :ivar connections: List of connections associated to this job.
    :vartype connections: list[str]
    :ivar dataIntegrityValidation: Data Integrity Validation mode. Known values are:
...
class NfsMountEndpointProperties(TypedDict, total=False):
    ...
    :vartype host: str
    :ivar nfsVersion: The NFS protocol version. Known values are: "NFSauto", "NFSv3", "NFSv4", and
     "NFSv4_1".
    :vartype nfsVersion: Union[str, "NfsVersion"]
    :ivar export: The directory being exported from the server. Required.
    :vartype export: str
    :ivar endpointType: The Endpoint resource type. Required. NFS_MOUNT.
    :vartype endpointType: Literal[EndpointType.NFS_MOUNT]
    :ivar sourceType: Source type to differentiate NFSMount and FSX-SMB endpoints. Default is
     NFSMount. Known values are: "NfsMount" and "FSX-EFS".
    :vartype sourceType: Union[str, "NfsMountSourceType"]
    """
...
class Recurrence(TypedDict, total=False):
    ...
    :ivar startTime: The start time of the schedule recurrence. Full hour and 30-minute intervals
     are supported. Required.
    :vartype startTime: "Time"
    :ivar endTime: The end time of the schedule recurrence. Full hour and 30-minute intervals are
     supported. Required.
    :vartype endTime: "Time"
    """
...
class S3WithHmacEndpointProperties(TypedDict, total=False):
    ...
    :ivar sourceUri: The  URI which points to the source.
    :vartype sourceUri: str
    :ivar sourceType: The source type of S3WithHmac endpoint. Known values are: "MINIO", "IBM",
     "GCS", "ALIBABA", "DELL_EMC", and "OTHER".
    :vartype sourceType: Union[str, "S3WithHmacSourceType"]
    :ivar otherSourceTypeDescription: The description for other source type of S3WithHmac endpoint.
    :vartype otherSourceTypeDescription: str
    :ivar endpointType: The Endpoint resource type. Required. S3_WITH_HMAC.
    :vartype endpointType: Literal[EndpointType.S3_WITH_HMAC]
    """
...
class ScheduleInfo(TypedDict, total=False):
    ...
    :ivar isActive: Whether the schedule is currently active.
    :vartype isActive: bool
    :ivar executionTime: Time of day to execute (hours and minutes).
    :vartype executionTime: "SchedulerTime"
    :ivar startDate: Specific one-time execution date and time.
    :vartype startDate: str
    :ivar daysOfWeek: Days of the week for weekly schedules.
    :vartype daysOfWeek: list[str]
    :ivar daysOfMonth: Days of the month for monthly schedules.
    :vartype daysOfMonth: list[int]
    :ivar cronExpression: Optional CRON expression for advanced scheduling.
    :vartype cronExpression: str
    :ivar endDate: End time of the schedule (in UTC).
    :vartype endDate: str
    :ivar repeatInterval: Repeat interval used for sub-daily schedules.
    :vartype repeatInterval: str
    """
...
class SmbMountEndpointProperties(TypedDict, total=False):
    ...
    :ivar host: The host name or IP address of the server exporting the file system. Required.
    :vartype host: str
    :ivar shareName: The name of the SMB share being exported from the server. Required.
    :vartype shareName: str
    :ivar credentials: The Azure Key Vault secret URIs which store the required credentials to
     access the SMB share.
    :vartype credentials: "AzureKeyVaultSmbCredentials"
    :ivar endpointType: The Endpoint resource type. Required. SMB_MOUNT.
    :vartype endpointType: Literal[EndpointType.SMB_MOUNT]
    :ivar sourceType: Source type to differentiate SMBMount and FSX-SMB endpoints. Default is
     SMBMount. Known values are: "SmbMount" and "FSX-SMB".
    :vartype sourceType: Union[str, "SmbMountSourceType"]
    """
...
class SourceEndpointProperties(TypedDict, total=False):
    ...
    :vartype name: str
    :ivar sourceEndpointResourceId: The fully qualified ARM resource ID of the cloud source
     endpoint to migrate.
    :vartype sourceEndpointResourceId: str
    :ivar awsS3BucketId: The fully qualified ARM resource ID of the AWS S3 bucket to migrate.
    :vartype awsS3BucketId: str
    """
...
class SourceTargetMap(TypedDict, total=False):
    ...
    :ivar sourceEndpoint: Required.
    :vartype sourceEndpoint: "SourceEndpoint"
    :ivar targetEndpoint: Required.
    :vartype targetEndpoint: "TargetEndpoint"
    """
...
class TargetEndpointProperties(TypedDict, total=False):
    ...
    :vartype name: str
    :ivar targetEndpointResourceId: The fully qualified ARM resource ID of the cloud target
     endpoint to migrate.
    :vartype targetEndpointResourceId: str
    :ivar azureStorageAccountResourceId: The fully qualified ARM resource ID of the Azure Storage
     account.
    :vartype azureStorageAccountResourceId: str
    :ivar azureStorageBlobContainerName: The name of the Azure Storage blob container.
    :vartype azureStorageBlobContainerName: str
    """
...
class UploadLimitSchedule(TypedDict, total=False):
    ...
    :ivar weeklyRecurrences: The set of weekly repeating recurrences of the WAN-link upload limit
     schedule.
    :vartype weeklyRecurrences: list["UploadLimitWeeklyRecurrence"]
    """
...
class UploadLimitWeeklyRecurrence(WeeklyRecurrence):
    ...
    :ivar days: The set of days of week for the schedule recurrence. A day must not be specified
     more than once in a recurrence. Required.
    :vartype days: list[Union[str, "DayOfWeek"]]
    :ivar limitInMbps: The WAN-link upload bandwidth (maximum data transfer rate) in megabits per
