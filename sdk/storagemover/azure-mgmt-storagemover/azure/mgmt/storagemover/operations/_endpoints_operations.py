...
class EndpointsOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, storage_mover_name: str, **kwargs: Any) -> Iterable["_models.Endpoint"]:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param endpoint_name: The name of the Endpoint resource. Required.
        :type endpoint_name: str
        :param endpoint: Is either a model type or a IO type. Required.
