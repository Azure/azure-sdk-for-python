...
class StorageMoverMgmtClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.storagemover.aio.operations.Operations
    :ivar storage_movers: StorageMoversOperations operations
    :vartype storage_movers: azure.mgmt.storagemover.aio.operations.StorageMoversOperations
    :ivar agents: AgentsOperations operations
    :vartype agents: azure.mgmt.storagemover.aio.operations.AgentsOperations
    :ivar endpoints: EndpointsOperations operations
    :vartype endpoints: azure.mgmt.storagemover.aio.operations.EndpointsOperations
