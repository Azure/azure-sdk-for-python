...
from ...operations._agents_operations import (
...
class AgentsOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, storage_mover_name: str, **kwargs: Any) -> AsyncIterable["_models.Agent"]:
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("AgentList", pipeline_response)
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageMover/storageMovers/{storageMoverName}/agents"
    }
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageMover/storageMovers/{storageMoverName}/agents/{agentName}"
    }
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param agent_name: The name of the Agent resource. Required.
        :type agent_name: str
        :param agent: Is either a Agent type or a IO type. Required.
        :type agent: ~azure.mgmt.storagemover.models.Agent or IO
    ...
    async def update(
        ...
        storage_mover_name: str,
        agent_name: str,
        agent: Union[_models.AgentUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.Agent:
        """Creates or updates an Agent resource.
        ...
        :param agent_name: The name of the Agent resource. Required.
        :type agent_name: str
        :param agent: Is either a AgentUpdateParameters type or a IO type. Required.
        :type agent: ~azure.mgmt.storagemover.models.AgentUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
