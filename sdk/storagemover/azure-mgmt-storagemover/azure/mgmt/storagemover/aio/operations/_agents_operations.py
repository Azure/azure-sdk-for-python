...
class AgentsOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, storage_mover_name: str, **kwargs: Any) -> AsyncItemPaged["_models.Agent"]:
    ...
    async def get(
        ...
        deserialized = self._deserialize("Agent", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        storage_mover_name: str,
        agent_name: str,
        agent: Union[_models.Agent, IO[bytes]],
        **kwargs: Any
    ) -> _models.Agent:
        """Creates or updates an Agent resource, which references a hybrid compute machine that can run
        jobs.
        ...
        :type agent: ~azure.mgmt.storagemover.models.Agent or IO[bytes]
        :return: Agent or the result of cls(response)
        :rtype: ~azure.mgmt.storagemover.models.Agent
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        storage_mover_name: str,
        agent_name: str,
        agent: Union[_models.AgentUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.Agent:
        """Creates or updates an Agent resource.
        ...
        :type agent: ~azure.mgmt.storagemover.models.AgentUpdateParameters or IO[bytes]
        :return: Agent or the result of cls(response)
        :rtype: ~azure.mgmt.storagemover.models.Agent
        :raises ~azure.core.exceptions.HttpResponseError:
        """
