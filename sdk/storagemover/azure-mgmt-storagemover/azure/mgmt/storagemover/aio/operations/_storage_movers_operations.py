...
from ...operations._storage_movers_operations import (
...
class StorageMoversOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.StorageMover"]:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncItemPaged["_models.StorageMover"]:
    ...
    async def get(self, resource_group_name: str, storage_mover_name: str, **kwargs: Any) -> _models.StorageMover:
        ...
        deserialized = self._deserialize("StorageMover", pipeline_response.http_response)
