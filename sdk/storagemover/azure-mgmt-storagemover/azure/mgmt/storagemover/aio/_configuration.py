...
class StorageMoverClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    """Configuration for StorageMoverClient.
    ...
    def __init__(self, credential: "AsyncTokenCredential", subscription_id: str, **kwargs: Any) -> None:
        super(StorageMoverClientConfiguration, self).__init__(**kwargs)
