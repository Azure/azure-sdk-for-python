...
class StorageMoverClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    """The Azure Storage Mover REST API.

    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.storagemover.operations.Operations
    :ivar storage_movers: StorageMoversOperations operations
    :vartype storage_movers: azure.mgmt.storagemover.operations.StorageMoversOperations
    :ivar agents: AgentsOperations operations
    :vartype agents: azure.mgmt.storagemover.operations.AgentsOperations
    :ivar endpoints: EndpointsOperations operations
    :vartype endpoints: azure.mgmt.storagemover.operations.EndpointsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = StorageMoverClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
    ...
    def __enter__(self) -> "StorageMoverClient":
