...
# USAGE
    python endpoints_update_azure_storage_blob_container_cross_tenant.py
    ...
    response = client.endpoints.update(
        ...
        endpoint={
            "properties": {
                ...
                "description": "Updated cross-tenant source endpoint with refreshed allowed partner storage accounts",
