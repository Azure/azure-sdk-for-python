...
# USAGE
    python job_definitions_get_cross_tenant_mirror.py
...
def main():
    ...
    response = client.job_definitions.get(
        resource_group_name="partner-rg",
        storage_mover_name="partner-storageMover",
        project_name="partner-projectName",
