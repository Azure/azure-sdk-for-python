...
# USAGE
    python videoanalyzeroperationstatusbyidnonterminalstate.py
...
def main():
    ...
    response = client.video_analyzer_operation_statuses.get(
        location_name="westus",
        operation_id="D612C429-2526-49D5-961B-885AE11406FD",
    )
    print(response)
