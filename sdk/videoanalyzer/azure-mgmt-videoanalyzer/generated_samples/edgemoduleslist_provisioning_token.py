...
# USAGE
    python edgemoduleslist_provisioning_token.py
...
def main():
    ...
    response = client.edge_modules.list_provisioning_token(
        resource_group_name="testrg",
        account_name="testaccount2",
        edge_module_name="edgeModule1",
        parameters={"expirationDate": "2023-01-23T11:04:49.0526841-08:00"},
    )
    print(response)
