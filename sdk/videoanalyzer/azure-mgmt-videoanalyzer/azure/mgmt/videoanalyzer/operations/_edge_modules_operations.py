...
def build_get_request(
    resource_group_name: str, account_name: str, edge_module_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class EdgeModulesOperations:
    ...
    def list(
    ...
    ) -> Iterable["_models.EdgeModuleEntity"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.videoanalyzer.models.EdgeModuleEntity]
