...
def build_get_request(
    resource_group_name: str, account_name: str, pipeline_topology_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PipelineTopologiesOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`pipeline_topologies` attribute.
    """
    ...
    def list(
        ...
        top: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable["_models.PipelineTopology"]:
        ...
        :return: An iterator like instance of either PipelineTopology or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.videoanalyzer.models.PipelineTopology]
        ...
        cls: ClsType[_models.PipelineTopologyCollection] = kwargs.pop("cls", None)
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/pipelineTopologies"
    }

    @distributed_trace
    def get(
        self, resource_group_name: str, account_name: str, pipeline_topology_name: str, **kwargs: Any
        ...
        :param account_name: The Azure Video Analyzer account name. Required.
        :type account_name: str
        :param pipeline_topology_name: Pipeline topology unique identifier. Required.
        ...
        cls: ClsType[_models.PipelineTopology] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/pipelineTopologies/{pipelineTopologyName}"
    }
    ...
    def create_or_update(
        ...
        account_name: str,
        pipeline_topology_name: str,
        parameters: Union[_models.PipelineTopology, IO],
        **kwargs: Any
    ) -> _models.PipelineTopology:
        """Creates or updates a pipeline topology.
        ...
        :type parameters: ~azure.mgmt.videoanalyzer.models.PipelineTopology or IO
    ...
    def update(
        ...
        account_name: str,
        pipeline_topology_name: str,
        parameters: Union[_models.PipelineTopologyUpdate, IO],
        **kwargs: Any
    ) -> _models.PipelineTopology:
        """Updates an existing pipeline topology.
        ...
        :type pipeline_topology_name: str
        :param parameters: The request parameters. Is either a model type or a IO type. Required.
        :type parameters: ~azure.mgmt.videoanalyzer.models.PipelineTopologyUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
