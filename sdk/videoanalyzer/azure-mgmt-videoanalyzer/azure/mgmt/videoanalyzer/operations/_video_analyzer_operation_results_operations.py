...
class VideoAnalyzerOperationResultsOperations:
    ...
    def get(self, location_name: str, operation_id: str, **kwargs: Any) -> Optional[_models.VideoAnalyzer]:
        ...
        cls: ClsType[Optional[_models.VideoAnalyzer]] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.Media/locations/{locationName}/videoAnalyzerOperationResults/{operationId}"
    }
