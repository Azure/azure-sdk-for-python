...
class LocationsOperations:
    ...
    @distributed_trace
    def check_name_availability(
        self, location_name: str, parameters: Union[_models.CheckNameAvailabilityRequest, IO], **kwargs: Any
    ) -> _models.CheckNameAvailabilityResponse:
        """Check Name Availability.
        ...
        :type parameters: ~azure.mgmt.videoanalyzer.models.CheckNameAvailabilityRequest or IO
