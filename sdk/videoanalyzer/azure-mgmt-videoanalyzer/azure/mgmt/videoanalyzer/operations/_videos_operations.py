...
def build_get_request(
    resource_group_name: str, account_name: str, video_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "accountName": _SERIALIZER.url("account_name", account_name, "str"),
        "videoName": _SERIALIZER.url("video_name", video_name, "str"),
    }
...
def build_list_content_token_request(
    resource_group_name: str, account_name: str, video_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class VideosOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either VideoEntity or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.videoanalyzer.models.VideoEntity]
        ...
        cls: ClsType[_models.VideoEntityCollection] = kwargs.pop("cls", None)
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/videos"
    }

    @distributed_trace
    def get(self, resource_group_name: str, account_name: str, video_name: str, **kwargs: Any) -> _models.VideoEntity:
        ...
        :param account_name: The Azure Video Analyzer account name. Required.
        :type account_name: str
        :param video_name: The Video name. Required.
        :type video_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: VideoEntity or the result of cls(response)
        :rtype: ~azure.mgmt.videoanalyzer.models.VideoEntity
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.VideoEntity] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/videos/{videoName}"
    }
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.videoanalyzer.models.VideoEntity
    ...
    def create_or_update(
        ...
        account_name: str,
        video_name: str,
        parameters: Union[_models.VideoEntity, IO],
        **kwargs: Any
    ) -> _models.VideoEntity:
        """Creates a new video resource or updates an existing one.
        ...
        :type parameters: ~azure.mgmt.videoanalyzer.models.VideoEntity or IO
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, "VideoEntity")
    ...
    def delete(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, account_name: str, video_name: str, **kwargs: Any
    ) -> None:
    ...
    def list_content_token(
        ...
        :rtype: ~azure.mgmt.videoanalyzer.models.VideoContentToken
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.VideoContentToken] = kwargs.pop("cls", None)

        request = build_list_content_token_request(
            resource_group_name=resource_group_name,
            account_name=account_name,
            video_name=video_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.list_content_token.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    list_content_token.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/videos/{videoName}/listContentToken"
    }
