...
class PrivateLinkResourcesOperations:
    ...
    def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> _models.PrivateLinkResourceListResult:
        ...
        :rtype: ~azure.mgmt.videoanalyzer.models.PrivateLinkResourceListResult
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/privateLinkResources"
    }
    ...
    def get(self, resource_group_name: str, account_name: str, name: str, **kwargs: Any) -> _models.PrivateLinkResource:
        ...
        :param account_name: The Video Analyzer account name. Required.
        :type account_name: str
        :param name: Name of the private link resource (Group ID). Required.
        :type name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PrivateLinkResource or the result of cls(response)
        :rtype: ~azure.mgmt.videoanalyzer.models.PrivateLinkResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/privateLinkResources/{name}"
    }
