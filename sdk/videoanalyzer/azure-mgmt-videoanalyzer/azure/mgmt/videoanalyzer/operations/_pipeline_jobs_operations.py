...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/pipelineJobs")  # pylint: disable=line-too-long
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/pipelineJobs/{pipelineJobName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "accountName": _SERIALIZER.url("account_name", account_name, 'str'),
        "pipelineJobName": _SERIALIZER.url("pipeline_job_name", pipeline_job_name, 'str'),
    }
...
def build_cancel_request_initial(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/pipelineJobs/{pipelineJobName}/cancel")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "accountName": _SERIALIZER.url("account_name", account_name, 'str'),
...
class PipelineJobsOperations(object):
    ...
    def list(
        ...
        top: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable["_models.PipelineJobCollection"]:
        ...
        :return: An iterator like instance of either PipelineJobCollection or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.videoanalyzer.models.PipelineJobCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-11-01-preview")  # type: str

        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PipelineJobCollection"]
        error_map = {
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("PipelineJobCollection", pipeline_response)
    ...
    list.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/pipelineJobs"}  # type: ignore
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :param account_name: The Azure Video Analyzer account name.
        :type account_name: str
        :param pipeline_job_name: The pipeline job name.
        :type pipeline_job_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PipelineJob, or the result of cls(response)
        :rtype: ~azure.mgmt.videoanalyzer.models.PipelineJob
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PipelineJob"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        deserialized = self._deserialize('PipelineJob', pipeline_response)
    ...
    def create_or_update(
        ...
        account_name: str,
        pipeline_job_name: str,
        parameters: "_models.PipelineJob",
        **kwargs: Any
    ) -> "_models.PipelineJob":
        ...
        :type parameters: ~azure.mgmt.videoanalyzer.models.PipelineJob
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PipelineJob, or the result of cls(response)
        :rtype: ~azure.mgmt.videoanalyzer.models.PipelineJob
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        _json = self._serialize.body(parameters, 'PipelineJob')
    ...
    create_or_update.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/pipelineJobs/{pipelineJobName}"}  # type: ignore
    ...
    delete.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/pipelineJobs/{pipelineJobName}"}  # type: ignore
    ...
    def update(
        ...
        account_name: str,
        pipeline_job_name: str,
        parameters: "_models.PipelineJobUpdate",
        **kwargs: Any
    ) -> "_models.PipelineJob":
        ...
        :type pipeline_job_name: str
        :param parameters: The request parameters.
        :type parameters: ~azure.mgmt.videoanalyzer.models.PipelineJobUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PipelineJob, or the result of cls(response)
        :rtype: ~azure.mgmt.videoanalyzer.models.PipelineJob
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        _json = self._serialize.body(parameters, 'PipelineJobUpdate')
