...
def build_get_request(
    resource_group_name: str, account_name: str, pipeline_job_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PipelineJobsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PipelineJob or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.videoanalyzer.models.PipelineJob]
        ...
        cls: ClsType[_models.PipelineJobCollection] = kwargs.pop("cls", None)
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/pipelineJobs"
    }

    @distributed_trace
    def get(
        self, resource_group_name: str, account_name: str, pipeline_job_name: str, **kwargs: Any
    ) -> _models.PipelineJob:
        ...
        :param account_name: The Azure Video Analyzer account name. Required.
        :type account_name: str
        :param pipeline_job_name: The pipeline job name. Required.
        ...
        cls: ClsType[_models.PipelineJob] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/pipelineJobs/{pipelineJobName}"
    }
    ...
    def create_or_update(
        ...
        account_name: str,
        pipeline_job_name: str,
        parameters: Union[_models.PipelineJob, IO],
        **kwargs: Any
    ) -> _models.PipelineJob:
        """Creates or updates a pipeline job.
        ...
        :type parameters: ~azure.mgmt.videoanalyzer.models.PipelineJob or IO
    ...
    def update(
        ...
        account_name: str,
        pipeline_job_name: str,
        parameters: Union[_models.PipelineJobUpdate, IO],
        **kwargs: Any
    ) -> _models.PipelineJob:
        """Updates an existing pipeline job.
        ...
        :type pipeline_job_name: str
        :param parameters: The request parameters. Is either a model type or a IO type. Required.
        :type parameters: ~azure.mgmt.videoanalyzer.models.PipelineJobUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    _cancel_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/pipelineJobs/{pipelineJobName}/cancel"
    }
