...
class VideoCreationProperties(msrest.serialization.Model):
    ...
    :param retention_period: Video retention period indicates how long the video is kept in
     storage. Value must be specified in ISO8601 duration format (i.e. "PT1D" equals 1 day) and can
...
class VideoPublishingOptions(msrest.serialization.Model):
    ...
    :param disable_video_preview_image: When set to 'true' preview images will not be generated.
     This is used, for example, when the topology is used only for low latency video streaming.
     Default is 'false'.  If set to 'false', then "disableArchive" must be set to 'false'.
    :type disable_video_preview_image: str
    """

    _attribute_map = {
        'disable_archive': {'key': 'disableArchive', 'type': 'str'},
        'disable_rtsp_publishing': {'key': 'disableRtspPublishing', 'type': 'str'},
        'disable_video_preview_image': {'key': 'disableVideoPreviewImage', 'type': 'str'},
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.disable_video_preview_image = disable_video_preview_image
