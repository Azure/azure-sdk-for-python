...
class AccessPolicyEccAlgo(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AccessPolicyRsaAlgo(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class EncoderSystemPresetType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class PipelineJobState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """Current state of the pipeline (read-only).
    """
...
class VideoAnalyzerEndpointType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class VideoScaleMode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class VideoType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
