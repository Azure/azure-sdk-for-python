...
from ...operations._edge_modules_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_provisioning_token_request, build_list_request
T = TypeVar('T')
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either EdgeModuleEntityCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.videoanalyzer.models.EdgeModuleEntityCollection]
