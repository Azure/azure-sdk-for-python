...
class PipelineJobsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~video_analyzer.models.PipelineJobCollection]
    ...
    async def delete(self, resource_group_name: str, account_name: str, pipeline_job_name: str, **kwargs: Any) -> None:
