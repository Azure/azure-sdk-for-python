...
from ...operations._videos_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_content_token_request, build_list_request, build_update_request
T = TypeVar('T')
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either VideoEntityCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.videoanalyzer.models.VideoEntityCollection]
