...
from ...operations._live_pipelines_operations import build_activate_request_initial, build_create_or_update_request, build_deactivate_request_initial, build_delete_request, build_get_request, build_list_request, build_update_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class LivePipelinesOperations:
    """LivePipelinesOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.LivePipelineCollection"]:
        ...
        :return: An iterator like instance of either LivePipelineCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.videoanalyzer.models.LivePipelineCollection]
    ...
    async def _activate_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_activate_request_initial(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            account_name=account_name,
            live_pipeline_name=live_pipeline_name,
    ...
    @distributed_trace_async
    async def begin_activate(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        live_pipeline_name: str,
    ...
    @distributed_trace_async
    async def begin_deactivate(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        live_pipeline_name: str,
