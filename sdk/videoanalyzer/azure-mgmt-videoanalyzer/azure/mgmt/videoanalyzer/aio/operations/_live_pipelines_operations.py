...
class LivePipelinesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~video_analyzer.models.LivePipelineCollection]
    ...
    async def delete(self, resource_group_name: str, account_name: str, live_pipeline_name: str, **kwargs: Any) -> None:
