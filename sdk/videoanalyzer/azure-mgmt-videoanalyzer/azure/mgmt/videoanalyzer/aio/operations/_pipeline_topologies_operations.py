...
from ...operations._pipeline_topologies_operations import (
...
class PipelineTopologiesOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.PipelineTopology"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.videoanalyzer.models.PipelineTopology]
