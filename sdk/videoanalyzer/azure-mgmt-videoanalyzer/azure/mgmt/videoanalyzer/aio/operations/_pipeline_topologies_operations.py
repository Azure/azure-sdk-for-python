...
from ...operations._pipeline_topologies_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_request, build_update_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class PipelineTopologiesOperations:
    """PipelineTopologiesOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.PipelineTopologyCollection"]:
        ...
        :return: An iterator like instance of either PipelineTopologyCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.videoanalyzer.models.PipelineTopologyCollection]
