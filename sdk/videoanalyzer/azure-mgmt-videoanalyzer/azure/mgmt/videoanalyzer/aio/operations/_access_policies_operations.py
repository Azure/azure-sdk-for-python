...
class AccessPoliciesOperations:
    ...
    def list(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~video_analyzer.models.AccessPolicyEntityCollection]
    ...
    async def delete(self, resource_group_name: str, account_name: str, access_policy_name: str, **kwargs: Any) -> None:
