...
from ...operations._access_policies_operations import (
...
class AccessPoliciesOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.AccessPolicyEntity"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.videoanalyzer.models.AccessPolicyEntity]
