...
class ManagedOpsClient:
    ...
    :vartype operations: azure.mgmt.managedops.aio.operations.Operations
    :ivar managed_ops: ManagedOpsOperations operations
    :vartype managed_ops: azure.mgmt.managedops.aio.operations.ManagedOpsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.managed_ops = ManagedOpsOperations(self._client, self._config, self._serialize, self._deserialize)
