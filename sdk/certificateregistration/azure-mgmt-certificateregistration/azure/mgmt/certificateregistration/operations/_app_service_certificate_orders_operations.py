...
class AppServiceCertificateOrdersOperations:  # pylint: disable=too-many-public-methods
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type certificate_distinguished_name:
         ~azure.mgmt.certificateregistration.models.AppServiceCertificateOrderPatchResource or IO[bytes]
        :return: AppServiceCertificateOrder or the result of cls(response)
        :rtype: ~azure.mgmt.certificateregistration.models.AppServiceCertificateOrder
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update_certificate(
        ...
        **kwargs: Any
        ...
        :type key_vault_certificate:
         ~azure.mgmt.certificateregistration.models.AppServiceCertificateResource or IO[bytes]
        :return: An instance of LROPoller that returns either AppServiceCertificateResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.certificateregistration.models.AppServiceCertificateResource]
    ...
    def update_certificate(
        ...
        **kwargs: Any
        ...
        :type key_vault_certificate:
         ~azure.mgmt.certificateregistration.models.AppServiceCertificatePatchResource or IO[bytes]
        :return: AppServiceCertificateResource or the result of cls(response)
        :rtype: ~azure.mgmt.certificateregistration.models.AppServiceCertificateResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def reissue(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type reissue_certificate_order_request:
         ~azure.mgmt.certificateregistration.models.ReissueCertificateOrderRequest or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def renew(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type renew_certificate_order_request:
         ~azure.mgmt.certificateregistration.models.RenewCertificateOrderRequest or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def resend_request_emails(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param name_identifier: Email address. Is either a NameIdentifier type or a IO[bytes] type.
         Required.
        :type name_identifier: ~azure.mgmt.certificateregistration.models.NameIdentifier or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def retrieve_site_seal(
        ...
        **kwargs: Any
        ...
        :param site_seal_request: Site seal request. Is either a SiteSealRequest type or a IO[bytes]
         type. Required.
        :type site_seal_request: ~azure.mgmt.certificateregistration.models.SiteSealRequest or
         IO[bytes]
        :return: SiteSeal or the result of cls(response)
        :rtype: ~azure.mgmt.certificateregistration.models.SiteSeal
        :raises ~azure.core.exceptions.HttpResponseError:
