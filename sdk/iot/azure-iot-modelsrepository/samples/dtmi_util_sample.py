...
# license information.
# --------------------------------------------------------------------------
from azure.iot.modelsrepository import dtmi_utils
...
def sample_is_valid_dtmi():
    ...
    dtmi_utils.is_valid_dtmi("dtmi:com:example:Thermostat;1")

    # Returns False - this is NOT a valid DTMI
    dtmi_utils.is_valid_dtmi("dtmi:com:example:Thermostat")
...
def sample_get_model_uri():
    ...
    print(dtmi_utils.get_model_uri(dtmi, repo_uri))
    # Prints: "file:///path/to/repository/dtmi/com/example/thermostat-1.json"
    print(dtmi_utils.get_model_uri(dtmi, repo_uri, expanded=True))
