...
class LongRunningBackupOperations:
    ...
    def _create_initial(
        ...
        server_name: str,
        backup_name: str,
        parameters: Optional[Union[_models.ServerBackupV2, IO[bytes]]] = None,
        **kwargs: Any
    ) -> Iterator[bytes]:
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            if parameters is not None:
                _json = self._serialize.body(parameters, "ServerBackupV2")
            else:
                _json = None
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ServerBackupV2 or the result of
         cls(response)
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type backup_name: str
        :param parameters: The required parameters for creating and exporting backup of the given
         server. Is either a ServerBackupV2 type or a IO[bytes] type. Default value is None.
        :type parameters: ~azure.mgmt.mysqlflexibleservers.models.ServerBackupV2 or IO[bytes]
        :return: An instance of LROPoller that returns either ServerBackupV2 or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mysqlflexibleservers.models.ServerBackupV2]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("ServerBackupV2", pipeline_response.http_response)
            if cls:
