...
def build_read_request(
    ...
    path_format_arguments = {
        ...
        "maintenanceName": _SERIALIZER.url("maintenance_name", maintenance_name, "str", pattern=r"^[a-zA-Z0-9-_]*$"),
    }
...
class MaintenancesOperations:
    ...
    def read(
        ...
        deserialized = self._deserialize("Maintenance", pipeline_response.http_response)
        ...
        **kwargs: Any
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            if parameters is not None:
                _json = self._serialize.body(parameters, "MaintenanceUpdate")
            else:
                _json = None
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.mysqlflexibleservers.models.MaintenanceUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either Maintenance or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mysqlflexibleservers.models.Maintenance]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list(self, resource_group_name: str, server_name: str, **kwargs: Any) -> Iterable["_models.Maintenance"]:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2023-12-30"))
        cls: ClsType[_models.MaintenanceListResult] = kwargs.pop("cls", None)
