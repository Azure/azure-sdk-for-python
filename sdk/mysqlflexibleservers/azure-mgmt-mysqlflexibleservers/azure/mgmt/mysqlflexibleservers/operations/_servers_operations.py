...
class ServersOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_create(
        ...
        :type parameters: ~azure.mgmt.mysqlflexibleservers.models.Server or IO[bytes]
        :return: An instance of LROPoller that returns either Server or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mysqlflexibleservers.models.Server]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.mysqlflexibleservers.models.ServerForUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either Server or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mysqlflexibleservers.models.Server]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_restart(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.mysqlflexibleservers.models.ServerRestartParameter or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_reset_gtid(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.mysqlflexibleservers.models.ServerGtidSetParameter or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_detach_v_net(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.mysqlflexibleservers.models.ServerDetachVNetParameter or
         IO[bytes]
        :return: An instance of LROPoller that returns either Server or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.mysqlflexibleservers.models.Server]
        :raises ~azure.core.exceptions.HttpResponseError:
