...
from ...operations._location_based_capability_set_operations import build_get_request, build_list_request
...
class LocationBasedCapabilitySetOperations:
    ...
    @distributed_trace
    def list(self, location_name: str, **kwargs: Any) -> AsyncIterable["_models.Capability"]:
    ...
    async def get(self, location_name: str, capability_set_name: str = "default", **kwargs: Any) -> _models.Capability:
        """Get capabilities at specified location in a given subscription.
