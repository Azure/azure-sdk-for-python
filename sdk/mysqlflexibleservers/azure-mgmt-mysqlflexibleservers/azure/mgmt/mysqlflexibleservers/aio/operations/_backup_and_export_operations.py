...
class BackupAndExportOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.mysqlflexibleservers.models.BackupAndExportRequest or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either BackupAndExportResponse or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.mysqlflexibleservers.models.BackupAndExportResponse]
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("BackupAndExportResponse", pipeline_response.http_response)
            if cls:
    ...
    async def validate_backup(
        ...
        deserialized = self._deserialize("ValidateBackupResponse", pipeline_response.http_response)
