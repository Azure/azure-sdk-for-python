...
class TestMySQLManagementCheckVirtualNetworkSubnetUsageOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(MySQLManagementClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_check_virtual_network_subnet_usage_execute(self, resource_group):
