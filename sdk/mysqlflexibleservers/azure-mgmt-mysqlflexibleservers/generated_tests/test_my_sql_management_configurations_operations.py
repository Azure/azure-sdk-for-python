...
class TestMySQLManagementConfigurationsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_configurations_begin_batch_update(self, resource_group):
        response = self.client.configurations.begin_batch_update(
            resource_group_name=resource_group.name,
            server_name="str",
            parameters={
