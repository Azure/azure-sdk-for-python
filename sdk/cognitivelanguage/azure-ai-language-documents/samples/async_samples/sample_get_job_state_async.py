...
"""
FILE: sample_get_job_state_async.py

DESCRIPTION:
    This sample shows how to submit an analyze documents job and get its job state asynchronously.

USAGE:
    python sample_get_job_state_async.py
