...
class AnalyzeDocumentsLROPoller(LROPoller[PollingReturnType_co], Generic[PollingReturnType_co]):
    """Custom poller that returns document analysis task results and exposes operation metadata."""
    ...
    def from_continuation_token(
        ...
        **kwargs: Any,
    ) -> "AnalyzeDocumentsLROPoller[PollingReturnType_co]":
...
class _AnalyzeDocumentsClientOperationsMixin(GeneratedAnalyzeDocumentsClientOperationsMixin):
    ...
    def begin_submit_job(  # type: ignore[override]
        ...
        *,
        ...
        polling: Union[bool, PollingMethod[ItemPaged[_models.Tasks]]] = True,
        polling_interval: Optional[int] = None,
        continuation_token: Optional[str] = None,
        cls: ClsType[ItemPaged[_models.Tasks]] = None,
        **kwargs: Any
    ) -> AnalyzeDocumentsLROPoller[ItemPaged[_models.Tasks]]:
        ...
        :return: An instance of AnalyzeDocumentsLROPoller that returns an ItemPaged of Tasks.
        :rtype: ~azure.ai.language.documents.AnalyzeDocumentsLROPoller[
         ~azure.core.paging.ItemPaged[~azure.ai.language.documents.models.Tasks]]
        ...
        def _fetch_state_by_next_link(next_link: str) -> _models.AnalyzeDocumentsJobState:
        ...
        def _build_pager_from_state(state: _models.AnalyzeDocumentsJobState) -> ItemPaged[_models.Tasks]:
            def extract_data(s: _models.AnalyzeDocumentsJobState):
                next_link = s.next_link
                tasks_payload = s.tasks
                return next_link, [tasks_payload]

            def get_next(token: Optional[str]) -> Optional[_models.AnalyzeDocumentsJobState]:
                if token is None:
                    return state
                if not token:
                    return None
        ...
        poller_holder: Dict[str, AnalyzeDocumentsLROPoller[ItemPaged[_models.Tasks]]] = {}

        def get_long_running_output(
            pipeline_response: PipelineResponse[HttpRequest, HttpResponse]
        ) -> ItemPaged[_models.Tasks]:
        ...
        if polling is True:
            polling_method: PollingMethod[ItemPaged[_models.Tasks]] = cast(
                PollingMethod[ItemPaged[_models.Tasks]],
            ...
            polling_method = cast(PollingMethod[ItemPaged[_models.Tasks]], NoPolling())
        else:
            polling_method = cast(PollingMethod[ItemPaged[_models.Tasks]], polling)

        if cont_token is not None:
            lro_from_token = AnalyzeDocumentsLROPoller[ItemPaged[_models.Tasks]].from_continuation_token(
        ...
        lro: AnalyzeDocumentsLROPoller[ItemPaged[_models.Tasks]] = AnalyzeDocumentsLROPoller(
