...
class DocumentLocationKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    """The document location is an Azure Blob Storage container."""
    AZURE_CONTAINER_FOLDER = "AzureContainerFolder"
    """The document location is a folder within an Azure Blob Storage container."""
...
class PiiCategories(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    AZURE_IOT_CONNECTION_STRING = "AzureIoTConnectionString"
...
class PiiCategoriesExtended(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """(Optional) describes the PII categories to return."""
...
class RedactionPolicyKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    """Redact detected entities using a marker-style mask."""
...
class StringIndexType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    `https://aka.ms/documents-analytics-offsets <https://aka.ms/documents-analytics-offsets>`_.
    """
