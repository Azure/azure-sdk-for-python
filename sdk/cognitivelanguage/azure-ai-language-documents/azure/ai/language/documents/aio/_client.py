...
from ._operations import _AnalyzeDocumentsClientOperationsMixin

if TYPE_CHECKING:
    from azure.core.credentials_async import AsyncTokenCredential


class AnalyzeDocumentsClient(_AnalyzeDocumentsClientOperationsMixin):
    """The language service API is a suite of natural language processing (NLP) skills built with
    best-in-class Microsoft machine learning algorithms. The API can be used to analyze
    unstructured text for tasks such as sentiment analysis, key phrase extraction, language
    detection and question answering. Further documentation can be found at
    `Language service overview <https://learn.microsoft.com/azure/cognitive-services/language-service/overview>`_.
    ...
    :keyword api_version: The API version to use for this operation. Known values are
     "2026-05-15-preview". Default value is "2026-05-15-preview". Note that overriding this default
