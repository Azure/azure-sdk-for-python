...
class QuestionAnsweringAuthoringClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    ...
    def __init__(
        ...
        kwargs.setdefault("sdk_moniker", "ai-language-questionanswering-authoring/{}".format(VERSION))
