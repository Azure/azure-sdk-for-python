...
from ._operations import _QuestionAnsweringAuthoringClientOperationsMixin
...
class QuestionAnsweringAuthoringClient(_QuestionAnsweringAuthoringClientOperationsMixin):
