...
class KnowledgebaseAuthoringClientConfiguration(Configuration):
    """Configuration for KnowledgebaseAuthoringClient.
    ...
    def __init__(
        ...
        **kwargs  # type: Any
        ...
        super(KnowledgebaseAuthoringClientConfiguration, self).__init__(**kwargs)
