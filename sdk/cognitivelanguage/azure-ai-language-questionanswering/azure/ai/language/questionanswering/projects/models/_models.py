...
class QnaRecord(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.active_learning_suggestions = kwargs.get('active_learning_suggestions', None)
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype active_learning_suggestions:
         list[~azure.ai.language.questionanswering.projects.models.SuggestedQuestionsCluster]
        """
        super(ImportQnaRecord, self).__init__(**kwargs)
        self.source_display_name = kwargs.get('source_display_name', None)
        self.last_updated_date_time = kwargs.get('last_updated_date_time', None)
        self.id = kwargs.get('id', None)
        self.answer = kwargs.get('answer', None)
...
class QnaSourceMetadata(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.source = kwargs.get('source', None)
        self.source_uri = kwargs['source_uri']
        self.source_kind = kwargs['source_kind']
        self.content_structure_kind = kwargs.get('content_structure_kind', None)
...
class QnaSourceRecord(LastUpdatedDateTimeParameter, QnaSourceMetadata):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype last_updated_date_time: ~datetime.datetime
        """
        super(QnaSourceRecord, self).__init__(**kwargs)
        self.display_name = kwargs.get('display_name', None)
        self.source = kwargs.get('source', None)
        self.source_uri = kwargs['source_uri']
        self.source_kind = kwargs['source_kind']
...
class SuggestedQuestion(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.user_suggested_count = kwargs.get('user_suggested_count', None)
        self.auto_suggested_count = kwargs.get('auto_suggested_count', None)
...
class SuggestedQuestionsCluster(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.cluster_head = kwargs.get('cluster_head', None)
        self.suggested_questions = kwargs.get('suggested_questions', None)
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype content_structure_kind: str or
         ~azure.ai.language.questionanswering.projects.models.SourceContentStructureKind
        """
        super(UpdateQnaSourceRecord, self).__init__(**kwargs)
        self.refresh = kwargs.get('refresh', None)
        self.display_name = kwargs.get('display_name', None)
        self.source = kwargs.get('source', None)
        self.source_uri = kwargs['source_uri']
