...
from ...operations._operations import build_question_answering_runtime_get_answers_from_text_request, build_question_answering_runtime_get_answers_request
T = TypeVar('T')
JSONType = Any
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class QuestionAnsweringRuntimeOperations:
    """QuestionAnsweringRuntimeOperations async operations.
    ...
    async def get_answers(
        self,
        knowledge_base_query_options: JSONType,
        *,
        project_name: str,
        deployment_name: str,
        **kwargs: Any
