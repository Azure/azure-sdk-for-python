...
class QuestionAnsweringAuthoringClientOperationsMixin(MixinABC):  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def begin_update_sources(self, project_name: str, sources: Union[List[JSON], IO], **kwargs: Any) -> LROPoller[JSON]:
        """Updates the sources of a project.
    ...
    @distributed_trace
    def begin_update_qnas(self, project_name: str, qnas: Union[List[JSON], IO], **kwargs: Any) -> LROPoller[JSON]:
        """Updates the QnAs of a project.
