...
class QuestionAnsweringOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~language.questionanswering.aio.QuestionAnsweringClient`'s
    ...
    async def get_answers(
        ...
        **kwargs: Any
        ...
        :type knowledge_base_query_options: ~language.questionanswering.models.AnswersOptions
        ...
        :rtype: ~language.questionanswering.models.AnswersResult
    ...
    async def get_answers(
        ...
        **kwargs: Any
        ...
        :type knowledge_base_query_options: ~language.questionanswering.models.AnswersOptions or JSON
         or IO[bytes]
        :keyword project_name: The name of the project to use. Required.
        :paramtype project_name: str
        :keyword deployment_name: The name of the specific deployment of the project to use. Required.
    ...
    async def get_answers_from_text(
        ...
        **kwargs: Any
        ...
        :type text_query_options: ~language.questionanswering.models.AnswersFromTextOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: AnswersFromTextResult. The AnswersFromTextResult is compatible with MutableMapping
        :rtype: ~language.questionanswering.models.AnswersFromTextResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_answers_from_text(
        ...
        :type text_query_options: ~language.questionanswering.models.AnswersFromTextOptions or JSON or
         IO[bytes]
        :return: AnswersFromTextResult. The AnswersFromTextResult is compatible with MutableMapping
        :rtype: ~language.questionanswering.models.AnswersFromTextResult
        :raises ~azure.core.exceptions.HttpResponseError:
