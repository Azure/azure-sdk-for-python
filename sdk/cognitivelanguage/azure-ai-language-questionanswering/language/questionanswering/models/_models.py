...
class AnswersFromTextOptions(_Model):
    ...
    :vartype text_documents: list[~language.questionanswering.models.TextDocument]
    ...
    :vartype string_index_type: str or ~language.questionanswering.models.StringIndexType
    """
...
class AnswersFromTextResult(_Model):
    ...
    :vartype answers: list[~language.questionanswering.models.TextAnswer]
    """
...
class AnswersOptions(_Model):
    ...
    :vartype answer_context: ~language.questionanswering.models.KnowledgeBaseAnswerContext
    :ivar ranker_kind: Type of ranker to be used. Known values are: "QuestionOnly" and "Default".
    :vartype ranker_kind: str or ~language.questionanswering.models.RankerKind
    :ivar filters: Filter QnAs based on given metadata list and knowledge base sources.
    :vartype filters: ~language.questionanswering.models.QueryFilters
    :ivar short_answer_options: To configure Answer span prediction feature.
    :vartype short_answer_options: ~language.questionanswering.models.ShortAnswerOptions
...
class AnswersResult(_Model):
    ...
    :vartype answers: list[~language.questionanswering.models.KnowledgeBaseAnswer]
    """
...
class Error(_Model):
    ...
    :vartype code: str or ~language.questionanswering.models.ErrorCode
    :ivar message: A human-readable representation of the error. Required.
    :vartype message: str
    :ivar target: The target of the error.
    :vartype target: str
    :ivar details: An array of details about specific errors that led to this reported error.
    :vartype details: list[~language.questionanswering.models.Error]
    :ivar innererror: An object containing more specific information than the current object about
     the error.
    :vartype innererror: ~language.questionanswering.models.InnerErrorModel
    """
...
class ErrorResponse(_Model):
    ...
    :vartype error: ~language.questionanswering.models.Error
    """
...
class InnerErrorModel(_Model):
    ...
    :ivar code: One of a server-defined set of error codes. Required. Known values are:
     ...
     "InvalidCountryHint".
    :vartype code: str or ~language.questionanswering.models.InnerErrorCode
...
class KnowledgeBaseAnswer(_Model):
    ...
    :vartype dialog: ~language.questionanswering.models.KnowledgeBaseAnswerDialog
    :ivar short_answer: Answer span object of QnA with respect to user's question.
    :vartype short_answer: ~language.questionanswering.models.AnswerSpan
    """
...
class KnowledgeBaseAnswerDialog(_Model):
    ...
    :vartype prompts: list[~language.questionanswering.models.KnowledgeBaseAnswerPrompt]
    """
...
class MetadataFilter(_Model):
    ...
    :vartype metadata: list[~language.questionanswering.models.MetadataRecord]
    :ivar logical_operation: Operation used to join metadata filters. Known values are: "AND" and
     "OR".
    :vartype logical_operation: str or ~language.questionanswering.models.LogicalOperationKind
    """
...
class QueryFilters(_Model):
    ...
    :vartype metadata_filter: ~language.questionanswering.models.MetadataFilter
