...
class TestQuestionAnsweringQuestionAnsweringOperations(QuestionAnsweringClientTestBase):
    @QuestionAnsweringPreparer()
    @recorded_by_proxy
    def test_question_answering_get_answers(self, questionanswering_endpoint):
    ...
    @QuestionAnsweringPreparer()
    @recorded_by_proxy
    def test_question_answering_get_answers_from_text(self, questionanswering_endpoint):
        client = self.create_client(endpoint=questionanswering_endpoint)
        response = client.question_answering.get_answers_from_text(
            text_query_options={
                "question": "str",
