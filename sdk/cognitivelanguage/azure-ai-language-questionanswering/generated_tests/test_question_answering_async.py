...
class TestQuestionAnsweringAsync(QuestionAnsweringClientTestBaseAsync):
    @QuestionAnsweringPreparer()
    @recorded_by_proxy_async
    async def test_get_answers(self, questionanswering_endpoint):
    ...
    @QuestionAnsweringPreparer()
    @recorded_by_proxy_async
    async def test_get_answers_from_text(self, questionanswering_endpoint):
        client = self.create_async_client(endpoint=questionanswering_endpoint)
        response = await client.get_answers_from_text(
            text_query_options={
                "question": "str",
