...
class ConversationAnalysisClientOperationsMixin(MixinABC):
    ...
    async def _conversation_analysis_initial(
        self,
        task: _models.AnalyzeConversationJobsInput,
        **kwargs: Any
        ...
        _json = self._serialize.body(task, 'AnalyzeConversationJobsInput')
    ...
    async def begin_conversation_analysis(
        ...
        **kwargs: Any
        ...
        :type task: ~azure.ai.language.conversations.models.AnalyzeConversationJobsInput
