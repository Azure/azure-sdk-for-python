...
from ..._operations._operations import (
    build_analyze_conversation_request,
    build_cancel_conversation_job_request,
    build_conversation_analysis_request,
    build_get_conversation_job_status_request,
)
...
class ConversationAnalysisClientOperationsMixin(MixinABC):
    ...
    async def _cancel_conversation_job_initial(  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace_async
    async def begin_cancel_conversation_job(self, job_id: str, **kwargs: Any) -> AsyncLROPoller[None]:
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._cancel_conversation_job_initial(  # type: ignore
