...
def build_analyze_conversation_request(
    *,
    json: Optional[_models.AnalyzeConversationTask] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_submit_conversation_job_request_initial(
    *,
    json: Optional[_models.AnalyzeConversationJobsInput] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class ConversationAnalysisClientOperationsMixin(MixinABC):
    ...
    def _submit_conversation_job_initial(
        self,
    ...
    @distributed_trace
    def begin_submit_conversation_job(
        self,
        body: _models.AnalyzeConversationJobsInput,
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns AnalyzeConversationJobState
        :rtype:
         ~azure.core.polling.LROPoller[~azure.ai.language.conversations.models.AnalyzeConversationJobState]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        if cont_token is None:
            raw_result = self._submit_conversation_job_initial(  # type: ignore
                body=body,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x,y,z: x,
    ...
    @distributed_trace
    def get_conversation_job_status(
        self,
        job_id: str,
        *,
        show_stats: Optional[bool] = None,
