...
"""
FILE: sample_analyze_text_with_orchestration_app_qna_response.py
...
USAGE:
    python sample_analyze_text_with_orchestration_app_qna_response.py
...
def sample_analyze_text_with_orchestration_app_qna_response():
...
if __name__ == '__main__':
    sample_analyze_text_with_orchestration_app_qna_response()