...
DESCRIPTION:
    This sample demonstrates how to analyze an utterance using a CLU Conversation project (sync),
...
def sample_conv_prediction_options():
    # settings
...
def main():
    sample_conv_prediction_options()
