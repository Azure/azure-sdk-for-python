...
class QnATests(QuestionAnsweringTest):
    ...
    @GlobalQuestionAnsweringAccountPreparer()
    def test_analysis(self, qna_account, qna_key, qna_project):
        client = ConversationAnalysisClient(qna_account, AzureKeyCredential(qna_key))
    ...
    @GlobalQuestionAnsweringAccountPreparer()
    def test_analysis_with_dictparams(self, qna_account, qna_key, qna_project):
        client = ConversationAnalysisClient(qna_account, AzureKeyCredential(qna_key))
        params = {
            "query": "One california maki please.",
            "direct_target": qna_project,
