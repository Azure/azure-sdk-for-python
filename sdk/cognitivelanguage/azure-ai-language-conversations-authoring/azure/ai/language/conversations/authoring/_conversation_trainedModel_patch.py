...
class ConversationAuthoringTrainedModelClient:
    ...
    def begin_evaluate_model(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.ConversationAuthoringEvaluationJobResult]:
    ...
    def get_model_evaluation_results(
        ...
        **kwargs: Any
    ) -> ItemPaged[_models.AnalyzeConversationAuthoringUtteranceEvaluationResult]:
    ...
    def get_model_evaluation_summary(self, **kwargs: Any) -> _models.ConversationAuthoringEvalSummary:
    ...
    def get_trained_model(self, **kwargs: Any) -> _models.ConversationAuthoringProjectTrainedModel:
