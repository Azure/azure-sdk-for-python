...
class _ConversationAuthoringClientOperationsMixin(
    ...
    def list_projects(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.conversations.authoring.models.ProjectMetadata]
...
class ProjectOperations:  # pylint: disable=too-many-public-methods
    ...
    async def _get_copy_project_status(self, project_name: str, job_id: str, **kwargs: Any) -> _models.CopyProjectState:
