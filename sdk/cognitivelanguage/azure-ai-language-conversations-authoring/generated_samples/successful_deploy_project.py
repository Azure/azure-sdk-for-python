...
def main():
    ...
    client.conversation_authoring_deployment.begin_deploy_project(
...
# x-ms-original-file: 2025-05-15-preview/analyzeconversations-authoring/SuccessfulDeployProject.json
