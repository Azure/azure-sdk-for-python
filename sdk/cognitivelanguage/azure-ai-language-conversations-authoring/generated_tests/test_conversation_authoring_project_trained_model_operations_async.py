...
class TestConversationAuthoringProjectTrainedModelOperationsAsync(ConversationAuthoringProjectClientTestBaseAsync):
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy_async
    async def test_trained_model_begin_load_snapshot(self, conversationauthoringproject_endpoint):
        client = self.create_async_client(endpoint=conversationauthoringproject_endpoint)
        response = await (
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy_async
    async def test_trained_model_get_evaluation_status(self, conversationauthoringproject_endpoint):
        client = self.create_async_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy_async
    async def test_trained_model_get_load_snapshot_status(self, conversationauthoringproject_endpoint):
        client = self.create_async_client(endpoint=conversationauthoringproject_endpoint)
