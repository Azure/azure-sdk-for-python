...
class TestConversationAuthoringProjectProjectOperationsOperations(ConversationAuthoringProjectClientTestBase):
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_list_trained_models(self, conversationauthoringproject_endpoint):
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_list_training_jobs(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_list_deployment_resources(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_list_deployments(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_list_exported_models(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_begin_assign_deployment_resources(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_begin_unassign_deployment_resources(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_get_assign_deployment_resources_status(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_get_unassign_deployment_resources_status(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_begin_swap_deployments(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_get_swap_deployments_status(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_get_project(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_get_project_deletion_status(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_begin_export(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_begin_copy_project(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_get_copy_project_status(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_begin_train(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_get_training_status(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_operations_begin_cancel_training_job(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
