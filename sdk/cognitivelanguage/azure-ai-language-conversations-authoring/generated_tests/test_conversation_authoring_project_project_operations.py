...
class TestConversationAuthoringProjectProjectOperations(ConversationAuthoringProjectClientTestBase):
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_get_assign_deployment_resources_status(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_get_unassign_deployment_resources_status(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_get_swap_deployments_status(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_get_project_deletion_status(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_get_export_status(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_get_copy_project_status(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
    ...
    @ConversationAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_project_get_training_status(self, conversationauthoringproject_endpoint):
        client = self.create_client(endpoint=conversationauthoringproject_endpoint)
