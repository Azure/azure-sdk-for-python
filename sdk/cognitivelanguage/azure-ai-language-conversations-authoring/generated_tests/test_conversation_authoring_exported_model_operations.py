...
class TestConversationAuthoringExportedModelOperations(ConversationAuthoringClientTestBase):
    @ConversationAuthoringPreparer()
    @recorded_by_proxy
    def test_exported_model_get_exported_model(self, conversationauthoring_endpoint):
    ...
    @ConversationAuthoringPreparer()
    @recorded_by_proxy
    def test_exported_model_begin_delete_exported_model(self, conversationauthoring_endpoint):
        client = self.create_client(endpoint=conversationauthoring_endpoint)
    ...
    @ConversationAuthoringPreparer()
    @recorded_by_proxy
    def test_exported_model_begin_create_or_update_exported_model(self, conversationauthoring_endpoint):
        client = self.create_client(endpoint=conversationauthoring_endpoint)
    ...
    @ConversationAuthoringPreparer()
    @recorded_by_proxy
    def test_exported_model_get_exported_model_job_status(self, conversationauthoring_endpoint):
        client = self.create_client(endpoint=conversationauthoring_endpoint)
