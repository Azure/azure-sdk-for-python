...
DESCRIPTION:
    This sample demonstrates how to unassign deployment resources from a Text Authoring project.
USAGE:
...
# [START text_authoring_unassign_deployment_resources]
import os
...
# [END text_authoring_unassign_deployment_resources]
