...
# USAGE
    python successful_swap_deployments.py
"""
...
def main():
    ...
    client.text_authoring_project.begin_swap_deployments(
        project_name="LoanAgreements",
        body={"firstDeploymentName": "production", "secondDeploymentName": "staging"},
    ).result()


# x-ms-original-file: 2025-05-15-preview/analyzetext-authoring/SuccessfulSwapDeployments.json
