...
def main():
    ...
    client.text_authoring_deployment.begin_delete_deployment_from_resources(
...
# x-ms-original-file: 2025-05-15-preview/analyzetext-authoring/SuccessfulDeleteDeploymentFromResources.json
