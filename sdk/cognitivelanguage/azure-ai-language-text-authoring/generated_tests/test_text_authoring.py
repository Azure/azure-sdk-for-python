...
class TestTextAuthoring(TextAuthoringClientTestBase):
    ...
    @TextAuthoringPreparer()
    @recorded_by_proxy
    def test_begin_delete_project(self, textauthoring_endpoint):
        client = self.create_client(endpoint=textauthoring_endpoint)
    ...
    @TextAuthoringPreparer()
    @recorded_by_proxy
    def test_begin_export(self, textauthoring_endpoint):
        client = self.create_client(endpoint=textauthoring_endpoint)
    ...
    @TextAuthoringPreparer()
    @recorded_by_proxy
    def test_begin_import_method(self, textauthoring_endpoint):
        client = self.create_client(endpoint=textauthoring_endpoint)
