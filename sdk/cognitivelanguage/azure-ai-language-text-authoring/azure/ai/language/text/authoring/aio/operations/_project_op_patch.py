...
class ProjectOperations(_ProjectOperationsDeploymentsRelated):
    ...
    async def begin_import(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.ai.language.text.authoring.models.ImportProjectState]
    ...
    async def begin_copy_project(
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.ai.language.text.authoring.models.CopyProjectState]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_export(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.ai.language.text.authoring.models.ExportProjectState]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
