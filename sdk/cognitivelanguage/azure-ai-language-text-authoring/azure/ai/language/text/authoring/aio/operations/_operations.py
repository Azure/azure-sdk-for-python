...
class _TextAuthoringClientOperationsMixin(
    ...
    def list_projects(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.language.text.authoring.models.ProjectDetails]
...
class DeploymentOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.ai.language.text.authoring.aio.TextAuthoringProjectClient`'s
...
class TrainedModelOperations:
    ...
    async def _begin_evaluate_model(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.ai.language.text.authoring.models._models.EvaluationJobResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = kwargs.pop("params", {}) or {}
