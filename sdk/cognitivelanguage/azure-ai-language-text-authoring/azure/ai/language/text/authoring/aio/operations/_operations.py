...
from ...operations._operations import (
    build_authoring_get_supported_languages_request,
    build_authoring_get_supported_prebuilt_entities_request,
    ...
    build_text_authoring_project_authorize_project_copy_request,
...
class _AuthoringClientOperationsMixin(
    ...
    def get_supported_prebuilt_entities(self, **kwargs: Any) -> AsyncItemPaged["_models.TextAuthoringPrebuiltEntity"]:
