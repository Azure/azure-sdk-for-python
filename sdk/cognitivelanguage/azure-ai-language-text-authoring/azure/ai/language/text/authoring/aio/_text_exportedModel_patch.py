...
class TextAuthoringExportedModelClientAsync:
    def __init__(
        self,
    ...
    async def begin_create_or_update_exported_model(
        ...
        **kwargs: Any
        ...
        return await self._operations.begin_create_or_update_exported_model(
    ...
    async def begin_delete_exported_model(
        ...
        **kwargs: Any
        ...
        return await self._operations.begin_delete_exported_model(
            project_name=self._project_name,
            exported_model_name=self._exported_model_name,
            **kwargs
        )
    ...
    async def get_exported_model(
        ...
        **kwargs: Any
        ...
        return await self._operations.get_exported_model(
            project_name=self._project_name,
            exported_model_name=self._exported_model_name,
            **kwargs
        )
    ...
    async def get_exported_model_job_status(
        ...
        **kwargs: Any
        ...
        return await self._operations.get_exported_model_job_status(
            project_name=self._project_name,
            exported_model_name=self._exported_model_name,
            job_id=job_id,
            **kwargs
    ...
    async def get_exported_model_manifest(
        ...
        **kwargs: Any
        ...
        return await self._operations.get_exported_model_manifest(
            project_name=self._project_name,
            exported_model_name=self._exported_model_name,
            **kwargs
        )