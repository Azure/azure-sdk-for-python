...
class DeploymentOperations(DeploymentOperationsGenerated):
    ...
    async def begin_delete_deployment(
        ...
        **kwargs: Any,
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.ai.language.text.authoring.models.DeploymentState]
    ...
    async def begin_delete_deployment_from_resources(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.ai.language.text.authoring.models.DeploymentDeleteFromResourcesState]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
