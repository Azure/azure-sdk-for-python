...
class TextAuthoringClientConfiguration:  # pylint: disable=too-many-instance-attributes
...
class TextAuthoringProjectClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for TextAuthoringProjectClient.
