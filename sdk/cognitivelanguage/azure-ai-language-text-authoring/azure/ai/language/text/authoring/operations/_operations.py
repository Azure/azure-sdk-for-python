...
class _TextAuthoringClientOperationsMixin(
    ...
    def list_supported_languages(
        ...
        **kwargs: Any,
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.language.text.authoring.models.SupportedLanguage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_assigned_resource_deployments(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.language.text.authoring.models.AssignedProjectDeploymentsMetadata]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_supported_prebuilt_entities(self, **kwargs: Any) -> ItemPaged["_models.PrebuiltEntity"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.language.text.authoring.models.PrebuiltEntity]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_training_config_versions(
        ...
        **kwargs: Any,
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.language.text.authoring.models.TrainingConfigVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def _get_export_status(self, project_name: str, job_id: str, **kwargs: Any) -> _models._models.ExportProjectState:
        ...
        :rtype: ~azure.ai.language.text.authoring.models._models.ExportProjectState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def _get_import_status(self, project_name: str, job_id: str, **kwargs: Any) -> _models._models.ImportProjectState:
        ...
        :rtype: ~azure.ai.language.text.authoring.models._models.ImportProjectState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class DeploymentOperations:
    ...
    def _begin_deploy_project(
        ...
        **kwargs: Any,
        ...
        :type body: ~azure.ai.language.text.authoring.models._models.CreateDeploymentDetails or JSON or
         IO[bytes]
        :return: An instance of LROPoller that returns None
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _begin_delete_deployment_from_resources(
        ...
        **kwargs: Any,
        ...
        :type body: ~azure.ai.language.text.authoring.models._models.DeleteDeploymentDetails or JSON or
         IO[bytes]
        :return: An instance of LROPoller that returns None
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _get_deployment_delete_from_resources_status(  # pylint: disable=name-too-long
        ...
        :rtype: ~azure.ai.language.text.authoring.models._models.DeploymentDeleteFromResourcesState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def _get_deployment_status(
        ...
        :rtype: ~azure.ai.language.text.authoring.models._models.DeploymentState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class ProjectOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_trained_models(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.language.text.authoring.models.ProjectTrainedModel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_training_jobs(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.language.text.authoring.models.TrainingState]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_deployment_resources(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.language.text.authoring.models.AssignedDeploymentResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_deployments(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.language.text.authoring.models.ProjectDeployment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_exported_models(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.language.text.authoring.models.ExportedTrainedModel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def _begin_assign_deployment_resources(
        ...
        **kwargs: Any,
        ...
        :type body: ~azure.ai.language.text.authoring.models._models.AssignDeploymentResourcesDetails
         or JSON or IO[bytes]
        :return: An instance of LROPoller that returns None
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _begin_unassign_deployment_resources(
        ...
        **kwargs: Any,
        ...
        :type body: ~azure.ai.language.text.authoring.models._models.UnassignDeploymentResourcesDetails
         or JSON or IO[bytes]
        :return: An instance of LROPoller that returns None
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _get_assign_deployment_resources_status(
        ...
        :return: DeploymentResourcesState. The DeploymentResourcesState is compatible with
         MutableMapping
        :rtype: ~azure.ai.language.text.authoring.models._models.DeploymentResourcesState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def _begin_swap_deployments(
        ...
        :type body: ~azure.ai.language.text.authoring.models._models.SwapDeploymentsDetails or JSON or
         IO[bytes]
        :return: An instance of LROPoller that returns None
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _get_swap_deployments_status(
        ...
        :rtype: ~azure.ai.language.text.authoring.models._models.SwapDeploymentsState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def _get_project_deletion_status(self, job_id: str, **kwargs: Any) -> _models._models.ProjectDeletionState:
        ...
        :rtype: ~azure.ai.language.text.authoring.models._models.ProjectDeletionState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def _copy_project_authorization(
        ...
        **kwargs: Any,
        ...
        :rtype: ~azure.ai.language.text.authoring.models._models.CopyProjectDetails
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def _begin_copy_project(
        ...
        :param body: The copy project info. Is one of the following types: CopyProjectDetails, JSON,
         IO[bytes] Required.
        :type body: ~azure.ai.language.text.authoring.models._models.CopyProjectDetails or JSON or
         IO[bytes]
        :return: An instance of LROPoller that returns None
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _get_copy_project_status(
        ...
        :rtype: ~azure.ai.language.text.authoring.models._models.CopyProjectState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def _begin_train(
        ...
        :param body: The training input parameters. Is one of the following types: TrainingJobDetails,
         JSON, IO[bytes] Required.
        :type body: ~azure.ai.language.text.authoring.models._models.TrainingJobDetails or JSON or
         IO[bytes]
    ...
    @distributed_trace
    def _begin_cancel_training_job(
        self, project_name: str, job_id: str, **kwargs: Any
    ) -> LROPoller[_models.TrainingJobResult]:
...
class ExportedModelOperations:
    ...
    def _begin_create_or_update_exported_model(
        ...
        **kwargs: Any,
        ...
        :param body: The exported model info. Is one of the following types: ExportedModelDetails,
         JSON, IO[bytes] Required.
        :type body: ~azure.ai.language.text.authoring.models._models.ExportedModelDetails or JSON or
         IO[bytes]
        :return: An instance of LROPoller that returns None
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _get_exported_model_job_status(
        ...
        :rtype: ~azure.ai.language.text.authoring.models._models.ExportedModelState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def _get_exported_model_manifest(
        self, project_name: str, exported_model_name: str, **kwargs: Any
...
class TrainedModelOperations:
    ...
    def _begin_evaluate_model(
        ...
        **kwargs: Any,
        ...
        :return: An instance of LROPoller that returns EvaluationJobResult. The EvaluationJobResult is
         compatible with MutableMapping
        :rtype:
         ~azure.core.polling.LROPoller[~azure.ai.language.text.authoring.models._models.EvaluationJobResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = kwargs.pop("params", {}) or {}
    ...
    def _get_evaluation_status(
        ...
        :rtype: ~azure.ai.language.text.authoring.models._models.EvaluationState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def _get_load_snapshot_status(
        ...
        :rtype: ~azure.ai.language.text.authoring.models._models.LoadSnapshotState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
