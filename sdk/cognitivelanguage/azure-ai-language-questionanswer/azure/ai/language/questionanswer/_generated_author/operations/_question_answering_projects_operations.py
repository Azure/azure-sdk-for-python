...
class QuestionAnsweringProjectsOperations(object):
    ...
    def create_project(
        self,
        project_name,  # type: str
        body,  # type: "_models.CreateProjectParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ProjectMetadata"
    ...
    def _export_initial(
        self,
        project_name,  # type: str
        body=None,  # type: Optional["_models.ExportJobParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop("cls", None)  # type: ClsType[None]
    ...
    def _import_method_initial(
        self,
        project_name,  # type: str
        body=None,  # type: Optional["_models.ImportJobParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop("cls", None)  # type: ClsType[None]
