...
def build_list_projects_request(**kwargs: Any) -> HttpRequest:
...
def build_create_project_request(
    project_name: str, *, json: Any = None, content: Any = None, **kwargs: Any
) -> HttpRequest:
...
def build_deploy_project_request_initial(project_name: str, deployment_name: str, **kwargs: Any) -> HttpRequest:
...
def build_get_deploy_status_request(project_name: str, deployment_name: str, job_id: str, **kwargs: Any) -> HttpRequest:
