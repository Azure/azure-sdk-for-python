...
from ._knowledgebase_authoring_configuration import KnowledgebaseAuthoringClientConfiguration
...
class KnowledgebaseAuthoringClient(object):
    ...
    def __init__(
        ...
        **kwargs  # type: Any
        ...
        self._config = KnowledgebaseAuthoringClientConfiguration(credential, endpoint, **kwargs)
    ...
    def send_request(
        ...
        **kwargs  # type: Any
        ...
        >>> from azure.ai.language.questionanswering.rest import build_list_projects_request
        >>> request = build_list_projects_request(**kwargs)
    ...
    def __enter__(self):
        # type: () -> KnowledgebaseAuthoringClient
