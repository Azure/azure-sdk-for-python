...
class TextAnswers(msrest.serialization.Model):
    ...
    :type answers: list[~microsoft_cognitive_language_service.models.TextAnswer]
    """
...
class TextQueryParameters(msrest.serialization.Model):
    ...
    :type records: list[~microsoft_cognitive_language_service.models.TextInput]
    ...
    :type string_index_type: str or ~microsoft_cognitive_language_service.models.StringIndexType
    """
