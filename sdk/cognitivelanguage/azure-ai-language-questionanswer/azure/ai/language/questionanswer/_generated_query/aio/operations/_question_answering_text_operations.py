...
from ..._rest import question_answering_text as rest_question_answering_text

T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class QuestionAnsweringTextOperations:
    """QuestionAnsweringTextOperations async operations.
    ...
    async def query(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(text_query_parameters, 'TextQueryParameters')

        request = rest_question_answering_text.build_query_request(
            json=json,
    ...
    query.metadata = {'url': '/:query-text'}  # type: ignore
