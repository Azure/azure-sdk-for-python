...
DESCRIPTION:
    This sample demonstrates how to assign deployment resources to a Text Authoring project (async).
USAGE:
...
# [START text_authoring_assign_deployment_resources_async]
import os
import asyncio
...
async def sample_assign_deployment_resources_async():
    ...
    async with TextAuthoringClient(endpoint, credential=credential) as client:
        ...
        details = AssignDeploymentResourcesDetails(resources_metadata=[resource])
...
# [END text_authoring_assign_deployment_resources_async]
