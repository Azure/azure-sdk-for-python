...
from ...operations._operations import (
    ...
    build_exported_model_get_exported_model_manifest_request,
    ...
    build_text_authoring_get_export_status_request,
    build_text_authoring_get_import_status_request,
    ...
    build_text_authoring_list_supported_prebuilt_entities_request,
...
class _TextAuthoringClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], TextAuthoringClientConfiguration]
):
    ...
    def list_projects(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.textanalytics.authoring.models.ProjectDetails]
    ...
    def list_supported_languages(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.textanalytics.authoring.models.SupportedLanguage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_assigned_resource_deployments(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.textanalytics.authoring.models.AssignedProjectDeploymentsMetadata]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_supported_prebuilt_entities(self, **kwargs: Any) -> AsyncItemPaged["_models.PrebuiltEntity"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.textanalytics.authoring.models.PrebuiltEntity]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_training_config_versions(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.textanalytics.authoring.models.TrainingConfigVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    ) -> _models._models.ExportProjectState:
    ...
    async def _get_import_status(
        self, project_name: str, job_id: str, **kwargs: Any
    ) -> _models._models.ImportProjectState:
...
class DeploymentOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.ai.textanalytics.authoring.aio.TextAuthoringProjectClient`'s
    ...
    @overload
    async def _begin_deploy_project(
        self,
        deployment_name: str,
    ...
    @distributed_trace_async
    async def _begin_delete_deployment(self, deployment_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
    ...
    async def _get_deployment_delete_from_resources_status(  # pylint: disable=name-too-long
...
class ProjectOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_trained_models(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.textanalytics.authoring.models.ProjectTrainedModel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_training_jobs(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.textanalytics.authoring.models.TrainingState]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_deployment_resources(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.textanalytics.authoring.models.AssignedDeploymentResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_deployments(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.textanalytics.authoring.models.ProjectDeployment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_exported_models(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.textanalytics.authoring.models.ExportedTrainedModel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def _get_assign_deployment_resources_status(
    ...
    async def _get_unassign_deployment_resources_status(  # pylint: disable=name-too-long
        self, job_id: str, **kwargs: Any
    ) -> _models._models.DeploymentResourcesState:
    ...
    @overload
    async def _begin_swap_deployments(
    ...
    @distributed_trace_async
    async def _get_swap_deployments_status(self, job_id: str, **kwargs: Any) -> _models._models.SwapDeploymentsState:
    ...
    @distributed_trace_async
    async def _get_project(self, **kwargs: Any) -> _models.ProjectDetails:
        """Gets the details of a project.
    ...
    @distributed_trace_async
    async def _get_project_deletion_status(self, job_id: str, **kwargs: Any) -> _models.ProjectDeletionState:
    ...
    @overload
    async def _begin_import_method(
        self,
    ...
    @distributed_trace_async
    async def _get_export_status(self, job_id: str, **kwargs: Any) -> _models._models.ExportProjectState:
        """Gets the status of an export job. Once job completes, returns the project metadata, and assets.
    ...
    @overload
    async def _copy_project_authorization(
        self,
        *,
    ...
    async def _get_copy_project_status(self, job_id: str, **kwargs: Any) -> _models._models.CopyProjectState:
    ...
    async def _begin_train(
        ...
        :return: An instance of AsyncLROPoller that returns TrainingJobResult. The TrainingJobResult is
         compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.ai.textanalytics.authoring.models.TrainingJobResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace_async
    async def _get_training_status(self, job_id: str, **kwargs: Any) -> _models.TrainingState:
...
class ExportedModelOperations:
    ...
    async def _begin_delete_exported_model(self, exported_model_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
    ...
    async def _get_exported_model_job_status(
    ...
    async def _get_exported_model_manifest(
...
class TrainedModelOperations:
    ...
    @overload
    async def _begin_evaluate_model(
        self,
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models._models.EvaluationJobResult]: ...
    @overload
    async def _begin_evaluate_model(
    ...
    async def _begin_evaluate_model(
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.ai.textanalytics.authoring.models._models.EvaluationJobResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = kwargs.pop("params", {}) or {}
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models._models.EvaluationJobResult].from_continuation_token( # pylint:disable=protected-access
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models._models.EvaluationJobResult]( # pylint:disable=protected-access
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    @distributed_trace_async
    async def _begin_load_snapshot(self, trained_model_label: str, **kwargs: Any) -> AsyncLROPoller[None]:
    ...
    async def _get_evaluation_status(
    ...
    def get_model_evaluation_results(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.textanalytics.authoring.models.DocumentEvalResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace_async
    async def _get_load_snapshot_status(
        self, trained_model_label: str, job_id: str, **kwargs: Any
