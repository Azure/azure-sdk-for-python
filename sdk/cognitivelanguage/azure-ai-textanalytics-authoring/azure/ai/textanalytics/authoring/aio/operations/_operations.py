...
from ...operations._operations import (
    ...
    build_trained_model_list_model_evaluation_results_request,
...
class DeploymentOperations:
    ...
    @distributed_trace_async
    async def _get_deployment_status(self, deployment_name: str, job_id: str, **kwargs: Any) -> _models.DeploymentState:
...
class ProjectOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace_async
    async def _get_swap_deployments_status(self, job_id: str, **kwargs: Any) -> _models.SwapDeploymentsState:
    ...
    @distributed_trace_async
    async def _get_export_status(self, job_id: str, **kwargs: Any) -> _models.ExportProjectState:
        """Gets the status of an export job. Once job completes, returns the project metadata, and assets.
    ...
    async def _get_copy_project_status(self, job_id: str, **kwargs: Any) -> _models.CopyProjectState:
...
class TrainedModelOperations:
    ...
    async def begin_evaluate_model(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.ai.textanalytics.authoring.models.EvaluationJobResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
