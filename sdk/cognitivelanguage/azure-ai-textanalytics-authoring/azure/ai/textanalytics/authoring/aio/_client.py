...
from .operations import (
    ...
    _TextAuthoringClientOperationsMixin,
)
...
class TextAuthoringProjectClient:
    ...
    :vartype deployment: azure.ai.textanalytics.authoring.aio.operations.DeploymentOperations
    :ivar project: ProjectOperations operations
    :vartype project: azure.ai.textanalytics.authoring.aio.operations.ProjectOperations
    :ivar exported_model: ExportedModelOperations operations
    :vartype exported_model:
     azure.ai.textanalytics.authoring.aio.operations.ExportedModelOperations
    :ivar trained_model: TrainedModelOperations operations
    :vartype trained_model: azure.ai.textanalytics.authoring.aio.operations.TrainedModelOperations
    :param endpoint: Supported Cognitive Services endpoint e.g.,
     https://<resource-name>.api.cognitiveservices.azure.com. Required.
    :type endpoint: str
    :param credential: Credential used to authenticate requests to the service. Is either a key
