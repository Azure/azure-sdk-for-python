...
def build_trained_model_list_model_evaluation_results_request(  # pylint: disable=name-too-long
...
class _TextAuthoringClientOperationsMixin(
    ...
    def _get_export_status(self, project_name: str, job_id: str, **kwargs: Any) -> _models.ExportProjectState:
        ...
        :rtype: ~azure.ai.textanalytics.authoring.models.ExportProjectState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def _get_import_status(self, project_name: str, job_id: str, **kwargs: Any) -> _models.ImportProjectState:
        ...
        :rtype: ~azure.ai.textanalytics.authoring.models.ImportProjectState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class DeploymentOperations:
    ...
    def begin_deploy_project(
        ...
        :type body: ~azure.ai.textanalytics.authoring.models.CreateDeploymentDetails or JSON or
         IO[bytes]
        :return: An instance of LROPoller that returns None
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_delete_deployment_from_resources(
        ...
        :type body: ~azure.ai.textanalytics.authoring.models.DeleteDeploymentDetails or JSON or
         IO[bytes]
        :return: An instance of LROPoller that returns None
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _get_deployment_delete_from_resources_status(  # pylint: disable=name-too-long
        ...
        :rtype: ~azure.ai.textanalytics.authoring.models.DeploymentDeleteFromResourcesState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    @distributed_trace
    def _get_deployment_status(self, deployment_name: str, job_id: str, **kwargs: Any) -> _models.DeploymentState:
        ...
        :rtype: ~azure.ai.textanalytics.authoring.models.DeploymentState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class ProjectOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_assign_deployment_resources(
        ...
        :type body: ~azure.ai.textanalytics.authoring.models.AssignDeploymentResourcesDetails or JSON
         or IO[bytes]
        :return: An instance of LROPoller that returns None
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _unassign_deployment_resources_initial(
        self, body: Union[_models.UnassignDeploymentResourcesDetails, JSON, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_unassign_deployment_resources(
        self, body: _models.UnassignDeploymentResourcesDetails, *, content_type: str = "application/json", **kwargs: Any
    ) -> LROPoller[None]:
    ...
    def begin_unassign_deployment_resources(
        ...
        :type body: ~azure.ai.textanalytics.authoring.models.UnassignDeploymentResourcesDetails or JSON
         or IO[bytes]
        :return: An instance of LROPoller that returns None
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _get_assign_deployment_resources_status(self, job_id: str, **kwargs: Any) -> _models.DeploymentResourcesState:
        ...
        :return: DeploymentResourcesState. The DeploymentResourcesState is compatible with
         MutableMapping
        :rtype: ~azure.ai.textanalytics.authoring.models.DeploymentResourcesState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_swap_deployments(
        ...
        :type body: ~azure.ai.textanalytics.authoring.models.SwapDeploymentsDetails or JSON or
         IO[bytes]
        :return: An instance of LROPoller that returns None
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    @distributed_trace
    def _get_swap_deployments_status(self, job_id: str, **kwargs: Any) -> _models.SwapDeploymentsState:
        """Gets the status of an existing swap deployment job.

        :param job_id: The job ID. Required.
        :type job_id: str
        :return: SwapDeploymentsState. The SwapDeploymentsState is compatible with MutableMapping
        :rtype: ~azure.ai.textanalytics.authoring.models.SwapDeploymentsState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def _import_method_initial(
        self, body: Union[_models.ExportedProject, JSON, IO[bytes]], *, format: Optional[str] = None, **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    @distributed_trace
    def _get_export_status(self, job_id: str, **kwargs: Any) -> _models.ExportProjectState:
        """Gets the status of an export job. Once job completes, returns the project metadata, and assets.
    ...
    def _get_copy_project_status(self, job_id: str, **kwargs: Any) -> _models.CopyProjectState:
        ...
        :rtype: ~azure.ai.textanalytics.authoring.models.CopyProjectState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_train(
        ...
        :param body: The training input parameters. Is one of the following types: TrainingJobDetails,
         JSON, IO[bytes] Required.
        :type body: ~azure.ai.textanalytics.authoring.models.TrainingJobDetails or JSON or IO[bytes]
        :return: An instance of LROPoller that returns TrainingJobResult. The TrainingJobResult is
         compatible with MutableMapping
        :rtype:
         ~azure.core.polling.LROPoller[~azure.ai.textanalytics.authoring.models.TrainingJobResult]
...
class ExportedModelOperations:
    ...
    def begin_create_or_update_exported_model(
        ...
        **kwargs: Any,
        ...
        :type body: ~azure.ai.textanalytics.authoring.models.ExportedModelDetails
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns None
    ...
    def begin_create_or_update_exported_model(
        ...
        :param body: The exported model info. Is one of the following types: ExportedModelDetails,
         JSON, IO[bytes] Required.
        :type body: ~azure.ai.textanalytics.authoring.models.ExportedModelDetails or JSON or IO[bytes]
        :return: An instance of LROPoller that returns None
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _get_exported_model_job_status(
        ...
        :rtype: ~azure.ai.textanalytics.authoring.models.ExportedModelState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class TrainedModelOperations:
    ...
    def begin_evaluate_model(
        ...
        **kwargs: Any,
        ...
        :type trained_model_label: str
        :param body: The training input parameters. Required.
        :type body: ~azure.ai.textanalytics.authoring.models.EvaluationDetails
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns EvaluationJobResult. The EvaluationJobResult is
         compatible with MutableMapping
        :rtype:
         ~azure.core.polling.LROPoller[~azure.ai.textanalytics.authoring.models.EvaluationJobResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _get_evaluation_status(self, trained_model_label: str, job_id: str, **kwargs: Any) -> _models.EvaluationState:
        ...
        :rtype: ~azure.ai.textanalytics.authoring.models.EvaluationState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        **kwargs: Any,
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_trained_model_list_model_evaluation_results_request(
                    trained_model_label=trained_model_label,
                    project_name=self._config.project_name,
                    string_index_type=string_index_type,
                    top=top,
    ...
    def _get_load_snapshot_status(
        ...
        :rtype: ~azure.ai.textanalytics.authoring.models.LoadSnapshotState
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
