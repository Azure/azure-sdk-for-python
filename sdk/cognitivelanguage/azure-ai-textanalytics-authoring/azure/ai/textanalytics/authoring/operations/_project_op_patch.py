...
class ProjectOperations(ProjectOperationsGenerated):
    ...
    def begin_import(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.ai.textanalytics.authoring.models.ExportedProject
    ...
    def begin_import(
        ...
        :param body: The project data to import. Is one of the following types: ExportedProject, JSON,
         IO[bytes] Required.
        :type body: ~azure.ai.textanalytics.authoring.models._models.ExportedProject or JSON or
         IO[bytes]
        :keyword format: The format of the project to import. The currently supported formats are json
         and aml formats. If not provided, the default is set to json. Default value is None.
        :paramtype format: str
    ...
    def begin_assign_deployment_resources(
        ...
        :type body: ~azure.ai.textanalytics.authoring.models.AssignDeploymentResourcesDetails
    ...
    def begin_assign_deployment_resources(
        ...
        **kwargs: Any
        ...
        :param body: The new project resources info. Required.
        :type body: ~azure.ai.textanalytics.authoring.models.AssignDeploymentResourcesDetails or JSON or IO[bytes]
        :keyword str content_type: Media type of the request body. Default is "application/json".
        :return: An instance of LROPoller that returns None.
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return super()._begin_assign_deployment_resources(body=body, content_type=content_type, **kwargs)
    ...
    def begin_swap_deployments(
        ...
        :type body: ~azure.ai.textanalytics.authoring.models.SwapDeploymentsDetails
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
        Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns None.
    ...
    def begin_swap_deployments(
        ...
        **kwargs: Any
        ...
        """Swaps two existing deployments with each other.
        :param body: The job object to swap two deployments. Required.
        :type body: ~azure.ai.textanalytics.authoring.models.SwapDeploymentsDetails or JSON or IO[bytes]
        :keyword str content_type: Media type of the request body. Default is "application/json".
        :return: An instance of LROPoller that returns None.
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return super()._begin_swap_deployments(body=body, content_type=content_type, **kwargs)
    ...
    def begin_unassign_deployment_resources(
        ...
        :type body: ~azure.ai.textanalytics.authoring.models.UnassignDeploymentResourcesDetails
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
        Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns None.
    ...
    def begin_unassign_deployment_resources(
        ...
        **kwargs: Any
        ...
        and deletes existing deployments assigned to them.
        :param body: The info for the deployment resources to be deleted. Required.
        :type body: ~azure.ai.textanalytics.authoring.models.UnassignDeploymentResourcesDetails or JSON or IO[bytes]
        :keyword str content_type: Media type of the request body. Default is "application/json".
        :return: An instance of LROPoller that returns None.
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return super()._begin_unassign_deployment_resources(body=body, content_type=content_type, **kwargs)
    ...
    def begin_cancel_training_job(  # pylint: disable=function-redefined
        ...
        """
        return super()._begin_cancel_training_job(job_id=job_id, **kwargs)
    ...
    def begin_copy_project(
        ...
        :type body: ~azure.ai.textanalytics.authoring.models.CopyProjectDetails
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
        Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns None.
    ...
    def begin_copy_project(
        ...
        """Copies an existing project to another Azure resource.
        :param body: The copy project info. Required.
        :type body: ~azure.ai.textanalytics.authoring.models.CopyProjectDetails or JSON or IO[bytes]
        :keyword str content_type: Media type of the request body. Default is "application/json".
        :return: An instance of LROPoller that returns None.
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_train(
        ...
        :type body: ~azure.ai.textanalytics.authoring.models.TrainingJobDetails
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    def begin_export(
        ...
        **kwargs: Any
        ...
        :paramtype string_index_type: str or ~azure.ai.textanalytics.authoring.models.StringIndexType
    ...
    def copy_project_authorization(
        ...
        **kwargs: Any
        ...
        :keyword project_kind: Represents the project kind. Known values are: "Conversation",
         "Orchestration", and "Customtextummarization". Required.
        :paramtype project_kind: str or ~azure.ai.textanalytics.authoring.models.ProjectKind
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        ...
        :rtype: ~azure.ai.textanalytics.authoring.models.CopyProjectDetails
        :raises ~azure.core.exceptions.HttpResponseError:
        """
