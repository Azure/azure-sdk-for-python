...
class TestTextAuthoringProjectExportedModelOperations(TextAuthoringProjectClientTestBase):
    @TextAuthoringProjectPreparer()
    @recorded_by_proxy
    def test_exported_model_get_exported_model(self, textauthoringproject_endpoint):
