...
class TestTextAuthoringProjectTrainedModelOperationsAsync(TextAuthoringProjectClientTestBaseAsync):
    ...
    @TextAuthoringProjectPreparer()
    @recorded_by_proxy_async
    async def test_trained_model_list_model_evaluation_results(self, textauthoringproject_endpoint):
        client = self.create_async_client(endpoint=textauthoringproject_endpoint)
        response = client.trained_model.list_model_evaluation_results(
            trained_model_label="str",
