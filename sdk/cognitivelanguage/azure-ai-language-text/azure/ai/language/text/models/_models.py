...
class AbstractiveSummarizationActionContent(_Model):
    ...
    :vartype summary_length: str or ~azure.ai.language.text.models.SummaryLengthBucket
...
class AbstractiveSummary(_Model):
    ...
    :vartype contexts: list[~azure.ai.language.text.models.SummaryContext]
    """
...
class AbstractiveSummaryActionResult(_Model):
    ...
    :vartype summaries: list[~azure.ai.language.text.models.AbstractiveSummary]
...
class BaseMetadata(_Model):
    ...
    :vartype metadata_kind: str or ~azure.ai.language.text.models.MetadataKind
    """
...
class AgeMetadata(BaseMetadata, discriminator="AgeMetadata"):
    ...
    :vartype metadata_kind: str or ~azure.ai.language.text.models.AGE_METADATA
    :ivar unit: Unit of measure for age. Required. Known values are: "Unspecified", "Year",
     "Month", "Week", and "Day".
    :vartype unit: str or ~azure.ai.language.text.models.AgeUnit
    """
...
class EntityOverlapPolicy(_Model):
    ...
    :vartype policy_kind: str or ~azure.ai.language.text.models.PolicyKind
    """
...
class AllowOverlapEntityPolicyType(EntityOverlapPolicy, discriminator="allowOverlap"):
    ...
    :vartype policy_kind: str or ~azure.ai.language.text.models.ALLOW_OVERLAP
    """
...
class AreaMetadata(BaseMetadata, discriminator="AreaMetadata"):
    ...
    :vartype metadata_kind: str or ~azure.ai.language.text.models.AREA_METADATA
    :ivar unit: Unit of measure for area. Required. Known values are: "Unspecified",
     ...
     and "Acre".
    :vartype unit: str or ~azure.ai.language.text.models.AreaUnit
    """
...
class BaseRedactionPolicy(_Model):
    ...
    :vartype policy_kind: str or ~azure.ai.language.text.models.RedactionPolicyKind
    """
...
class CharacterMaskPolicyType(BaseRedactionPolicy, discriminator="characterMask"):
    ...
    :vartype policy_kind: str or ~azure.ai.language.text.models.CHARACTER_MASK
    :ivar redaction_character: Optional parameter to use a Custom Character to be used for
     ...
     "@", "^", "_", and "~".
    :vartype redaction_character: str or ~azure.ai.language.text.models.RedactionCharacter
    """
...
class ClassificationActionResult(_Model):
    ...
    :vartype class_property: list[~azure.ai.language.text.models.ClassificationResult]
    :ivar detected_language: If 'language' is set to 'auto' for the document in the request this
     field will contain a 2 letter ISO 639-1 representation of the language detected for this
     document.
    :vartype detected_language: ~azure.ai.language.text.models.DetectedLanguage
...
class CurrencyMetadata(BaseMetadata, discriminator="CurrencyMetadata"):
    ...
    :vartype metadata_kind: str or ~azure.ai.language.text.models.CURRENCY_METADATA
...
class DateValue(_Model):
    ...
    :vartype modifier: str or ~azure.ai.language.text.models.TemporalModifier
    """
...
class DetectedLanguage(_Model):
    ...
    :ivar script_name: Identifies the script name of the input document according to the ISO 15924
     ...
     "Tibetan".
    :vartype script_name: str or ~azure.ai.language.text.models.ScriptKind
    :ivar script_iso15924_code: Identifies the script code of the input document according to the
     ...
     "Thaa", "Thai", and "Tibt".
    :vartype script_iso15924_code: str or ~azure.ai.language.text.models.ScriptCode
    """
...
class EntityMaskPolicyType(BaseRedactionPolicy, discriminator="entityMask"):
    ...
    :ivar policy_kind: The entity OverlapPolicy object kind. Required. Redact detected entities
     with entity type.
    :vartype policy_kind: str or ~azure.ai.language.text.models.ENTITY_MASK
    """
...
class EntitySynonyms(_Model):
    ...
    :vartype entity_type: str or ~azure.ai.language.text.models.EntityCategory
    :ivar synonyms: The entity synonyms. Required.
    :vartype synonyms: list[~azure.ai.language.text.models.EntitySynonym]
    """
...
class ExtractiveSummarizationActionContent(_Model):
    ...
    :ivar sort_by: Specifies how to sort the extracted summaries. Known values are: "Offset" and
     "Rank".
    :vartype sort_by: str or ~azure.ai.language.text.models.ExtractiveSummarizationSortingCriteria
...
class HealthcareActionResult(_Model):
    ...
    :ivar fhir_bundle: JSON bundle containing a FHIR compatible object for consumption in other
     ...
     <https://www.hl7.org/fhir/overview.html>`_.
    :vartype fhir_bundle: ~azure.ai.language.text.models.FhirBundle
    :ivar detected_language: If 'language' is set to 'auto' for the document in the request this
     field will contain a 2 letter ISO 639-1 representation of the language detected for this
     document.
    :vartype detected_language: ~azure.ai.language.text.models.DetectedLanguage
...
class HealthcareTaskParameters(_Model):
    ...
    :vartype fhir_version: str or ~azure.ai.language.text.models.FhirVersion
    ...
    :vartype document_type: str or ~azure.ai.language.text.models.HealthcareDocumentType
    """
...
class InformationMetadata(BaseMetadata, discriminator="InformationMetadata"):
    ...
    :vartype metadata_kind: str or ~azure.ai.language.text.models.INFORMATION_METADATA
    ...
    :vartype unit: str or ~azure.ai.language.text.models.InformationUnit
    """
...
class LanguageDetectionResult(_Model):
    ...
    :vartype documents: list[~azure.ai.language.text.models.LanguageDetectionDocumentResult]
    """
...
class LengthMetadata(BaseMetadata, discriminator="LengthMetadata"):
    ...
    :vartype metadata_kind: str or ~azure.ai.language.text.models.LENGTH_METADATA
    ...
    :vartype unit: str or ~azure.ai.language.text.models.LengthUnit
    """
...
class MatchLongestEntityPolicyType(EntityOverlapPolicy, discriminator="matchLongest"):
    ...
    :vartype policy_kind: str or ~azure.ai.language.text.models.MATCH_LONGEST
    """
...
class NoMaskPolicyType(BaseRedactionPolicy, discriminator="noMask"):
    ...
    :ivar policy_kind: The entity RedactionPolicy object kind. Required. Do not redact detected
     entities.
    :vartype policy_kind: str or ~azure.ai.language.text.models.NO_MASK
    """
...
class NumberMetadata(BaseMetadata, discriminator="NumberMetadata"):
    ...
    :vartype metadata_kind: str or ~azure.ai.language.text.models.NUMBER_METADATA
    :ivar number_kind: Kind of the number type. Required. Known values are: "Integer", "Decimal",
     "Power", "Fraction", "Percent", and "Unspecified".
    :vartype number_kind: str or ~azure.ai.language.text.models.NumberKind
...
class NumericRangeMetadata(BaseMetadata, discriminator="NumericRangeMetadata"):
    ...
    :vartype metadata_kind: str or ~azure.ai.language.text.models.NUMERIC_RANGE_METADATA
    ...
    :vartype range_kind: str or ~azure.ai.language.text.models.RangeKind
    ...
    :vartype range_inclusivity: str or ~azure.ai.language.text.models.RangeInclusivity
    """
...
class OrdinalMetadata(BaseMetadata, discriminator="OrdinalMetadata"):
    ...
    :vartype metadata_kind: str or ~azure.ai.language.text.models.ORDINAL_METADATA
    ...
    :vartype relative_to: str or ~azure.ai.language.text.models.RelativeTo
...
class PiiResult(_Model):
    ...
    :vartype model_version: str
    :ivar documents: Response by document. Required.
    :vartype documents: list[~azure.ai.language.text.models.PiiResultWithDetectedLanguage]
    """
...
class SpeedMetadata(BaseMetadata, discriminator="SpeedMetadata"):
    ...
    :vartype metadata_kind: str or ~azure.ai.language.text.models.SPEED_METADATA
    ...
    :vartype unit: str or ~azure.ai.language.text.models.SpeedUnit
    """
...
class TemperatureMetadata(BaseMetadata, discriminator="TemperatureMetadata"):
    ...
    :vartype metadata_kind: str or ~azure.ai.language.text.models.TEMPERATURE_METADATA
    :ivar unit: Unit of measure for temperature. Required. Known values are: "Unspecified",
     "Fahrenheit", "Kelvin", "Rankine", and "Celsius".
    :vartype unit: str or ~azure.ai.language.text.models.TemperatureUnit
    """
...
class TemporalSpanMetadata(BaseMetadata, discriminator="TemporalSpanMetadata"):
    ...
    :vartype metadata_kind: str or ~azure.ai.language.text.models.TEMPORAL_SPAN_METADATA
    :ivar span_values: List of temporal spans detected.
    :vartype span_values: list[~azure.ai.language.text.models.TemporalSpanValues]
    """
...
class VolumeMetadata(BaseMetadata, discriminator="VolumeMetadata"):
    ...
    :vartype metadata_kind: str or ~azure.ai.language.text.models.VOLUME_METADATA
    ...
    :vartype unit: str or ~azure.ai.language.text.models.VolumeUnit
    """
...
class WeightMetadata(BaseMetadata, discriminator="WeightMetadata"):
    ...
    :vartype metadata_kind: str or ~azure.ai.language.text.models.WEIGHT_METADATA
    ...
    :vartype unit: str or ~azure.ai.language.text.models.WeightUnit
    """
