...
"""
FILE: sample_text_abstractive_summarization.py

DESCRIPTION:
    This sample demonstrates how to run an **abstractive summarization** action over text.

USAGE:
    python sample_text_abstractive_summarization.py
...
# [START text_abstractive_summarization]
import os
...
def sample_text_abstractive_summarization():
    # get settings
...
def main():
    sample_text_abstractive_summarization()
