...
class AttestedOperations(object):
    """AttestedOperations operations.
    ...
    def get_document(
            self, nonce=None, custom_headers=None, raw=False, **operation_config):
        """Get Attested Data for the Virtual Machine.

        :param nonce: This is a string of up to 32 random alphanumeric
         characters.
        :type nonce: str
        ...
        :return: AttestedData or ClientRawResponse if raw=true
        :rtype: ~azure.imds.models.AttestedData or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.imds.models.ErrorResponseException>`
        """
        # Construct URL
        url = self.get_document.metadata['url']
        ...
        return deserialized
    get_document.metadata = {'url': '/attested/document'}
