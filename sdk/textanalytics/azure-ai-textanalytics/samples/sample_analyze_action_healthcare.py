...
"""
FILE: sample_analyze_action_healthcare.py
...
USAGE:
    python sample_analyze_action_healthcare.py
...
def sample_analyze_action_healthcare():
...
if __name__ == "__main__":
    sample_analyze_action_healthcare()
