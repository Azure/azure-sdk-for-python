...
"""
FILE: sample_analyze_sentiment_with_aspects_async.py
...
USAGE:
    python sample_analyze_sentiment_with_aspects_async.py
...
class AnalyzeSentimentWithAspectsSampleAsync(object):
    async def analyze_sentiment_with_aspects(self):
        ...
        async with text_analytics_client:
            result = await text_analytics_client.analyze_sentiment(documents, show_aspects=True)
