...
|----------------|-------------|
|[sample_analyze_sentiment_with_aspects.py][sample_analyze_sentiment_with_aspects] and [sample_analyze_sentiment_with_aspects_async.py][sample_analyze_sentiment_with_aspects_async]|Analyze sentiment in documents with granular analysis into individual aspects present in a sentence|
