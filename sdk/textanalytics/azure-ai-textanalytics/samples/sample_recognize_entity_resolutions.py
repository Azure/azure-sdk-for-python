...
"""
FILE: sample_recognize_entity_resolutions.py
...
USAGE:
    python sample_recognize_entity_resolutions.py
...
def sample_recognize_entity_resolutions() -> None:
    import os
    ...
    documents = [
        ...
        "A discount is applied since the internet dropped to 32 mB/s.",

        "He was the first man to walk on the moon on January 31, 1945 at 1:00pm.",

        "The property spans 25 acres and has a 3 mile round-trip hiking trail.",

        "This aircraft carries 200 liters of fuel and can carry 65-80 passengers. "
        "Cruising speed is 100 knots at standard 32°F temperature and pressure",
    ]
    ...
    for document, result in zip(documents, results):
        ...
        for entity in result.entities:
            print(f"...Entity is '{entity.text}' and categorized as '{entity.category}' with subcategory '{entity.subcategory}'.")
            for res in entity.resolutions:
                if res.resolution_kind == ResolutionKind.AGE_RESOLUTION:
                    ...
                    print(f"......Currency resolution has a value of '{res.value}', unit of '{res.unit}', and ISO4217 code of '{res.iso4217}'.")
                elif res.resolution_kind == ResolutionKind.DATE_TIME_RESOLUTION:
                    print(f"......DateTime resolution has a value of '{res.value}', a subkind of '{res.datetime_subkind}', and a timex of '{res.timex}'.")
                    ...
                    print(f"......Numeric range resolution has a kind of '{res.range_kind}', a minimum of '{res.minimum}' and a maximum of '{res.maximum}'.")
                elif res.resolution_kind == ResolutionKind.ORDINAL_RESOLUTION:
                    print(f"......Ordinal resolution has a value of '{res.value}', an offset of '{res.offset}, and is relative to '{res.relative_to}'.")
                    ...
                    print(f"......Temporal span resolution begins on '{res.begin}' and ends on '{res.end}' with duration '{res.duration}'.")
...
if __name__ == '__main__':
    sample_recognize_entity_resolutions()
