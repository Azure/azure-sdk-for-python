...
class TestRecognizeEntities(TextAnalyticsTest):
    ...
    def test_empty_credential_class(self, client):
        with pytest.raises(ClientAuthenticationError):
            response = client.recognize_entities(["This is written in English."])
    ...
    def test_show_stats_and_model_version(self, client):
        ...
        response = client.recognize_entities(docs, show_stats=True, model_version="latest", raw_response_hook=callback)
    ...
    def test_pass_cls(self, client):
        ...
        res = client.recognize_entities(documents=["Test passing cls to endpoint"], cls=callback)
    ...
    def test_default_string_index_type_is_UnicodeCodePoint(self, client):
        ...
        res = client.recognize_entities(documents=["Hello world"], raw_response_hook=callback)
