...
class TestAnalyzeSentiment(AsyncTextAnalyticsTest):
    ...
    async def test_aspect_based_sentiment_analysis(self, client):
        ...
        for sentence in document.sentences:
            for aspect in sentence.aspects:
                ...
                self.assertIsNotNone(1.0, aspect.confidence_scores.positive)
                ...
                self.assertIsNotNone(1.0, sleek_opinion.confidence_scores.positive)
                self.assertEqual(0.0, sleek_opinion.confidence_scores.neutral)
                self.assertIsNotNone(0.0, sleek_opinion.confidence_scores.negative)
                ...
                self.assertIsNotNone(1.0, premium_opinion.confidence_scores.positive)
    ...
    async def test_aspect_based_sentiment_analysis_negated_opinion(self, client):
        ...
        for sentence in document.sentences:
            ...
            self.assertIsNotNone(0.01, food_aspect.confidence_scores.positive)
            ...
            self.assertIsNotNone(0.01, service_aspect.confidence_scores.positive)
            ...
            self.assertIsNotNone(0.01, food_opinion.confidence_scores.positive)
