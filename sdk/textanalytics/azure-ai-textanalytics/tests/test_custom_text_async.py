...
class TestCustomTextAsync(TextAnalyticsTest):
    ...
    async def test_single_label_classify(
        ...
        async with client:
            document_results = await (
                await client.begin_single_label_classify(
                    docs,
    ...
    async def test_single_label_classify_cont_token(
        ...
        async with client:
            initial_poller = await client.begin_single_label_classify(
                docs,
                project_name=textanalytics_single_label_classify_project_name,
                deployment_name=textanalytics_single_label_classify_deployment_name,
                show_stats=True,
    ...
    async def test_multi_label_classify(
        ...
        async with client:
            document_results = await (
                await client.begin_multi_label_classify(
                    docs,
    ...
    async def test_multi_label_classify_cont_token(
        ...
        async with client:
            ...
            poller = await client.begin_multi_label_classify(None, None, None, continuation_token=continuation_token)
