...
class TestRecognizePIIEntities(TextAnalyticsTest):
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_language_kwarg_english(self):
        client = get_async_textanalytics_client()
        def callback(response):
            language_str = "\"language\": \"en\""
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_redacted_text(self):
        client = get_async_textanalytics_client()
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_phi_domain_filter(self):
        client = get_async_textanalytics_client()
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_categories_filter_with_domain_filter(self):
        client = get_async_textanalytics_client()
