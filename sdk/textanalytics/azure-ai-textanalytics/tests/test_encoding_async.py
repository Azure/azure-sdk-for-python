...
from testcase import TextAnalyticsTest, get_async_textanalytics_client
...
class TestEncoding(TextAnalyticsTest):
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_emoji_with_skin_tone_modifier(self):
        client = get_async_textanalytics_client()
        result = await client.recognize_pii_entities(["👩🏻 SSN: 859-98-0987"])
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_emoji_family(self):
        client = get_async_textanalytics_client()
        result = await client.recognize_pii_entities(["👩‍👩‍👧‍👧 SSN: 859-98-0987"])
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_emoji_family_with_skin_tone_modifier(self):
        client = get_async_textanalytics_client()
        result = await client.recognize_pii_entities(["👩🏻‍👩🏽‍👧🏾‍👦🏿 SSN: 859-98-0987"])
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_diacritics_nfc(self):
        client = get_async_textanalytics_client()
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_diacritics_nfd(self):
        client = get_async_textanalytics_client()
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_korean_nfc(self):
        client = get_async_textanalytics_client()
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_korean_nfd(self):
        client = get_async_textanalytics_client()
        result = await client.recognize_pii_entities(["아가 SSN: 859-98-0987"])
        assert result[0].entities[0].offset == 8
