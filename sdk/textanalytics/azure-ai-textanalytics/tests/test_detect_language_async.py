...
class TestDetectLanguage(TextAnalyticsTest):
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_whole_batch_country_hint(self):
        client = get_async_textanalytics_client()
        def callback(resp):
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_whole_batch_dont_use_country_hint(self):
        client = get_async_textanalytics_client()
        def callback(resp):
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_per_item_dont_use_country_hint(self):
        client = get_async_textanalytics_client()
        def callback(resp):
            country_str = "\"countryHint\": \"\""
            country = resp.http_request.body.count(country_str)
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_whole_batch_country_hint_and_obj_input(self):
        client = get_async_textanalytics_client()
        def callback(resp):
            country_str = "\"countryHint\": \"CA\""
            country = resp.http_request.body.count(country_str)
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_whole_batch_country_hint_and_dict_input(self):
        client = get_async_textanalytics_client()
        def callback(resp):
            country_str = "\"countryHint\": \"CA\""
            country = resp.http_request.body.count(country_str)
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_whole_batch_country_hint_and_obj_per_item_hints(self):
        client = get_async_textanalytics_client()
        def callback(resp):
            country_str = "\"countryHint\": \"CA\""
            country = resp.http_request.body.count(country_str)
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_whole_batch_country_hint_and_dict_per_item_hints(self):
        client = get_async_textanalytics_client()
        def callback(resp):
            country_str = "\"countryHint\": \"CA\""
            country = resp.http_request.body.count(country_str)
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_client_passed_default_country_hint(self):
        client = get_async_textanalytics_client(default_country_hint="CA")
        def callback(resp):
            country_str = "\"countryHint\": \"CA\""
            country = resp.http_request.body.count(country_str)
            assert country == 3
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_invalid_country_hint_method(self):
        client = get_async_textanalytics_client()
        docs = [{"id": "1", "text": "hello world"}]
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_invalid_country_hint_docs(self):
        client = get_async_textanalytics_client()
    ...
    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_country_hint_none(self):
        client = get_async_textanalytics_client()
        ...
        # test client default
        new_client = get_async_textanalytics_client(default_country_hint="none")
        result4 = await new_client.detect_language(documents=["this is written in english"], raw_response_hook=callback)

    @TextAnalyticsPreparer()
    @recorded_by_proxy_async
    async def test_country_hint_kwarg(self):
        client = get_async_textanalytics_client()
        def callback(response):
    ...
    async def test_pass_cls(self):
        def callback(pipeline_response, deserialized, _):
            return "cls result"
        text_analytics = get_async_textanalytics_client()
