...
class TestRecognizeLinkedEntities(TextAnalyticsTest):
    ...
    async def test_empty_credential_class(self, client):
        with pytest.raises(ClientAuthenticationError):
            response = await client.recognize_linked_entities(["This is written in English."])
    ...
    async def test_pass_cls(self, client):
        ...
        res = await client.recognize_linked_entities(documents=["Test passing cls to endpoint"], cls=callback)
    ...
    async def test_default_string_index_type_is_UnicodeCodePoint(self, client):
        ...
        res = await client.recognize_linked_entities(documents=["Hello world"], raw_response_hook=callback)
