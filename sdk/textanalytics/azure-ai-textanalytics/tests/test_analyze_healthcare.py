...
class TestHealth(TextAnalyticsTest):
    ...
    @pytest.mark.skip("InternalServerError: https://dev.azure.com/msazure/Cognitive%20Services/_workitems/edit/13227791")
    @TextAnalyticsPreparer()
    ...
    def test_show_stats_and_model_version(self, client):
        ...
        for doc in response:
            ...
            # assert doc.statistics.transaction_count FIXME https://dev.azure.com/msazure/Cognitive%20Services/_workitems/edit/13227791
        assert num_error == 1
    ...
    def test_healthcare_continuation_token(self, client):
        ...
        for doc_idx, result in enumerate(results):
            if doc_idx == 2:
                ...
                assert result.id == document_order[doc_idx]
                # assert result.statistics FIXME https://dev.azure.com/msazure/Cognitive%20Services/_workitems/edit/13227791
