    ...
    async def begin_analyze_actions(  # type: ignore
        ...
        **kwargs: Any,
        ...
        :type actions:
            ...
            RecognizeCustomEntitiesAction or ClassifyDocumentSingleCategoryAction or
            ClassifyDocumentMultiCategoriesAction]
        ...
        .. versionadded:: v3.2-preview
            ...
            *RecognizeCustomEntitiesResult*, *ClassifyDocumentSingleCategoryResult*,
            and *ClassifyDocumentMultiCategoriesResult* result objects
