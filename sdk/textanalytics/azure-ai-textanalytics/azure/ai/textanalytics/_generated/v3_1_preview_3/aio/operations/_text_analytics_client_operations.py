...
class TextAnalyticsClientOperationsMixin:
    ...
    async def begin_analyze(
        ...
        **kwargs
        ...
        if cont_token:
            return AsyncTextAnalyticsLROPoller.from_continuation_token(
            ...
            return AsyncTextAnalyticsLROPoller(self._client, raw_result, get_long_running_output, polling_method)
    ...
    async def begin_health(
        ...
        **kwargs
        ...
        def get_long_running_output(pipeline_response):
            ...
            return AsyncHealthcareItemPaged(
                internal_get_next, extract_data
            )
        path_format_arguments = {
            'Endpoint': self._serialize.url("self._config.endpoint", self._config.endpoint, 'str', skip_quote=True),
