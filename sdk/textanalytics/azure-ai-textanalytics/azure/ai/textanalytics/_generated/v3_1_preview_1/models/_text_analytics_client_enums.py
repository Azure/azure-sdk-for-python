...
class SentenceAspectSentiment(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class SentenceOpinionSentiment(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
