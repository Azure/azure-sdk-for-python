...
def build_analyze_request_initial(
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/analyze')
...
def build_analyze_status_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json, text/json"
    # Construct URL
    url = kwargs.pop("template_url", '/analyze/jobs/{jobId}')
...
def build_health_status_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json, text/json"
    # Construct URL
    url = kwargs.pop("template_url", '/entities/health/jobs/{jobId}')
    path_format_arguments = {
        "jobId": _SERIALIZER.url("job_id", job_id, 'str'),
    }
...
def build_health_request_initial(
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    content_type = kwargs.pop('content_type', None)  # type: Optional[str]
    model_version = kwargs.pop('model_version', None)  # type: Optional[str]
    string_index_type = kwargs.pop('string_index_type', None)  # type: Optional[Union[str, "_models.StringIndexType"]]
    logging_opt_out = kwargs.pop('logging_opt_out', None)  # type: Optional[bool]

    accept = "application/json, text/json"
    # Construct URL
    url = kwargs.pop("template_url", '/entities/health/jobs')

    # Construct parameters
    query_parameters = kwargs.pop("params", {})  # type: Dict[str, Any]
    if model_version is not None:
        query_parameters['model-version'] = _SERIALIZER.query("model_version", model_version, 'str')
    ...
    if logging_opt_out is not None:
        query_parameters['loggingOptOut'] = _SERIALIZER.query("logging_opt_out", logging_opt_out, 'bool')
...
def build_entities_recognition_pii_request(
    **kwargs  # type: Any
    ...
    show_stats = kwargs.pop('show_stats', None)  # type: Optional[bool]
    logging_opt_out = kwargs.pop('logging_opt_out', None)  # type: Optional[bool]
    domain = kwargs.pop('domain', None)  # type: Optional[str]
    string_index_type = kwargs.pop('string_index_type', None)  # type: Optional[Union[str, "_models.StringIndexType"]]
    pii_categories = kwargs.pop('pii_categories', None)  # type: Optional[List[Union[str, "_models.PiiCategory"]]]

    accept = "application/json, text/json"
    # Construct URL
    url = kwargs.pop("template_url", '/entities/recognition/pii')
    ...
    if domain is not None:
        query_parameters['domain'] = _SERIALIZER.query("domain", domain, 'str')
    if string_index_type is not None:
        query_parameters['stringIndexType'] = _SERIALIZER.query("string_index_type", string_index_type, 'str')
    if pii_categories is not None:
        query_parameters['piiCategories'] = _SERIALIZER.query("pii_categories", pii_categories, '[str]', div=',')
...
def build_sentiment_request(
    **kwargs  # type: Any
    ...
    show_stats = kwargs.pop('show_stats', None)  # type: Optional[bool]
    logging_opt_out = kwargs.pop('logging_opt_out', None)  # type: Optional[bool]
    opinion_mining = kwargs.pop('opinion_mining', None)  # type: Optional[bool]
    string_index_type = kwargs.pop('string_index_type', None)  # type: Optional[Union[str, "_models.StringIndexType"]]
    ...
    if opinion_mining is not None:
        query_parameters['opinionMining'] = _SERIALIZER.query("opinion_mining", opinion_mining, 'bool')
    if string_index_type is not None:
        query_parameters['stringIndexType'] = _SERIALIZER.query("string_index_type", string_index_type, 'str')
