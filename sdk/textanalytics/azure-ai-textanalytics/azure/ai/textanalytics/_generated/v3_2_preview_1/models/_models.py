...
class AspectRelation(msrest.serialization.Model):
    ...
    :param relation_type: Required. The type related to the aspect. Possible values include:
     "opinion", "aspect".
    :type relation_type: str or ~azure.ai.textanalytics.v3_2_preview_1.models.AspectRelationType
...
class AsyncJobInput(msrest.serialization.Model):
    """AsyncJobInput.

    All required parameters must be populated in order to send to Azure.

    :param source_url: Required. The container URI where inputs are stored.
    :type source_url: str
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AsyncJobInput, self).__init__(**kwargs)
...
class DocumentLanguage(msrest.serialization.Model):
    ...
    :type detected_languages: list[~azure.ai.textanalytics.v3_2_preview_1.models.DetectedLanguage]
    :param warnings: Required. Warnings encountered while processing document.
    :type warnings: list[~azure.ai.textanalytics.v3_2_preview_1.models.TextAnalyticsWarning]
    :param statistics: if showStats=true was specified in the request this field will contain
     information about the document payload.
...
class HealthcareBatchResult(msrest.serialization.Model):
    ...
    :vartype statistics: ~azure.ai.textanalytics.v3_2_preview_1.models.RequestStatistics
    :ivar documents: The set of successful results.
    :vartype documents:
     list[~azure.ai.textanalytics.v3_2_preview_1.models.HealthcareBatchResultItem]
    :ivar errors: The set of error results.
    :vartype errors: list[~azure.ai.textanalytics.v3_2_preview_1.models.DocumentError]
    ...
    _validation = {
        ...
        'model_version': {'readonly': True},
    }

    _attribute_map = {
        'statistics': {'key': 'statistics', 'type': 'RequestStatistics'},
        'documents': {'key': 'documents', 'type': '[HealthcareBatchResultItem]'},
        'errors': {'key': 'errors', 'type': '[DocumentError]'},
        'model_version': {'key': 'modelVersion', 'type': 'str'},
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(HealthcareBatchResult, self).__init__(**kwargs)
...
class HealthcareBatchResultItem(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(HealthcareBatchResultItem, self).__init__(**kwargs)
...
class HealthJobTaskResponse(msrest.serialization.Model):
    """HealthJobTaskResponse.

    :param value: A wrapper class around a collection of results and errors.
    :type value: ~azure.ai.textanalytics.v3_2_preview_1.models.HealthcareBatchResult
    :param next_link:
    :type next_link: str
    ...
    _attribute_map = {
        'value': {'key': 'value', 'type': 'HealthcareBatchResult'},
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(HealthJobTaskResponse, self).__init__(**kwargs)
...
class JobResponse(msrest.serialization.Model):
    ...
    _validation = {
        ...
        'created_datetime': {'required': True},
        'status': {'required': True},
        'results_location': {'required': True},
    }

    _attribute_map = {
        'job_id': {'key': 'jobId', 'type': 'str'},
        'last_updated_time': {'key': 'lastUpdatedTime', 'type': 'str'},
        'created_datetime': {'key': 'createdDatetime', 'type': 'str'},
        'status': {'key': 'status', 'type': 'str'},
        'results_location': {'key': 'resultsLocation', 'type': 'str'},
    }
...
class SentenceAspect(msrest.serialization.Model):
    ...
    :type sentiment: str or ~azure.ai.textanalytics.v3_2_preview_1.models.SentenceAspectSentiment
    :param confidence_scores: Required. Aspect level sentiment confidence scores for the aspect in
     the sentence.
    :type confidence_scores:
     ~azure.ai.textanalytics.v3_2_preview_1.models.AspectConfidenceScoreLabel
    ...
    :param relations: Required. The array of either opinion or aspect object which is related to
     the aspect.
    :type relations: list[~azure.ai.textanalytics.v3_2_preview_1.models.AspectRelation]
    """
...
class SentenceOpinion(msrest.serialization.Model):
    ...
    :param sentiment: Required. Opinion level sentiment for the aspect in the sentence. Possible
     values include: "positive", "mixed", "negative".
    :type sentiment: str or ~azure.ai.textanalytics.v3_2_preview_1.models.SentenceOpinionSentiment
...
class SentenceSentiment(msrest.serialization.Model):
    ...
    :type aspects: list[~azure.ai.textanalytics.v3_2_preview_1.models.SentenceAspect]
    :param opinions: The array of opinion object for the sentence.
    :type opinions: list[~azure.ai.textanalytics.v3_2_preview_1.models.SentenceOpinion]
    """
