...
try:
    ...
    from ._models_py3 import AsyncJobInput
    ...
    from ._models_py3 import HealthJobTaskResponse
    from ._models_py3 import HealthcareBatchResult
    from ._models_py3 import HealthcareBatchResultItem
    ...
    from ._models import AsyncJobInput  # type: ignore
    ...
    from ._models import HealthJobTaskResponse  # type: ignore
    from ._models import HealthcareBatchResult  # type: ignore
    from ._models import HealthcareBatchResultItem  # type: ignore
