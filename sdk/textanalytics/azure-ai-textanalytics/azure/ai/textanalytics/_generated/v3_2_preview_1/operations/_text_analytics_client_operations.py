...
class TextAnalyticsClientOperationsMixin(object):
    ...
    def _delete_healthcare_job_initial(
        self,
        job_id,  # type: str
        **kwargs  # type: Any
    ):
    ...
    def begin_delete_healthcare_job(
        ...
        **kwargs  # type: Any
        ...
        if cont_token is None:
            raw_result = self._delete_healthcare_job_initial(
                job_id=job_id,
                cls=lambda x,y,z: x,
                **kwargs
            )
    ...
    def _health_initial(
        ...
        source_url,  # type: str
        model_version=None,  # type: Optional[str]
        string_index_type="unicodecodepoint",  # type: Optional[Union[str, "models.Enum0"]]
    ...
    def get_healthcare_results(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.HealthJobTaskResponse"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.textanalytics.v3_2_preview_1.models.HealthJobTaskResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
