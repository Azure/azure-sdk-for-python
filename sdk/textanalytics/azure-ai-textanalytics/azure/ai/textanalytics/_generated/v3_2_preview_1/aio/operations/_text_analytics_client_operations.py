...
class TextAnalyticsClientOperationsMixin:
    ...
    async def begin_cancel_health_job(
        ...
        **kwargs
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._cancel_health_job_initial(
                job_id=job_id,
                cls=lambda x,y,z: x,
                **kwargs
            )
    ...
    async def _health_initial(
        ...
        **kwargs
        ...
        if self._config.string_index_type is not None:
            query_parameters['stringIndexType'] = self._serialize.query("self._config.string_index_type", self._config.string_index_type, 'str')
    ...
    async def entities_recognition_general(
        ...
        show_stats: Optional[bool] = None,
        **kwargs
    ) -> Union["models.EntitiesResult", "models.ErrorResponse"]:
    ...
    async def entities_linking(
        ...
        show_stats: Optional[bool] = None,
        **kwargs
    ) -> Union["models.EntityLinkingResult", "models.ErrorResponse"]:
    ...
    async def key_phrases(
        ...
        show_stats: Optional[bool] = None,
        **kwargs
    ) -> Union["models.KeyPhraseResult", "models.ErrorResponse"]:
        """Key Phrases.
    ...
    async def languages(
        ...
        show_stats: Optional[bool] = None,
        **kwargs
    ) -> Union["models.LanguageResult", "models.ErrorResponse"]:
        """Detect Language.
    ...
    async def sentiment(
        ...
        **kwargs
    ) -> Union["models.SentimentResponse", "models.ErrorResponse"]:
        """Sentiment.
