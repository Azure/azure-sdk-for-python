...
class TextAnalyticsClient(TextAnalyticsClientOperationsMixin, MultiApiClientMixin, _SDKClient):
    ...
    def analyze_text(self):
        """Instance depends on the API version:
           ...
           * 2022-02-01-preview: :class:`AnalyzeTextOperations<azure.ai.textanalytics.v2022_02_01_preview.aio.operations.AnalyzeTextOperations>`
        """
        api_version = self._get_api_version('analyze_text')
        if api_version == '2022-02-01-preview':
            from ..v2022_02_01_preview.aio.operations import AnalyzeTextOperations as OperationClass
        else:
