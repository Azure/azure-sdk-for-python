...
class TextAnalyticsClient(TextAnalyticsClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    href="https://learn.microsoft.com/azure/cognitive-services/language-service/overview">https://learn.microsoft.com/azure/cognitive-services/language-service/overview</a>`.
