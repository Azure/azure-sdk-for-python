...
def prepare_entities_recognition_general(
    *,
    body: Any,
    api_version: TextAnalyticsApiVersions = None,
    ...
    **kwargs: Any
    ...
    :keyword str api_version: (Strongly recommended) REST API's service version to use. Possible values are
    ...
    **New in API version v3.1-preview.1**
    ...
    if not api_version:
        ...
        warnings.warn(
            "You did not specify an API version, so we set it to the default '{}'. "\
            "We strongly recommend you explicitly set the API version in your call to avoid breaking changes between API versions.".format(api_version)
        )
    if api_version == "v3.0":
        from .v3_0 import prepare_entities_recognition_general
        return prepare_entities_recognition_general(
            body=body,
        ...
        from .v3_1_preview_1 import prepare_entities_recognition_general
        return prepare_entities_recognition_general(
            body=body,
            model_version=model_version,
            show_stats=show_stats,
...
def prepare_entities_recognition_pii(
    *,
    body: Any,
    api_version: PiiTextAnalyticsApiVersions = None,
    model_version: Optional[str] = None,
    show_stats: Optional[bool] = None,
    ...
    **kwargs: Any
    ...
    if api_version == "v3.1-preview.1":
        ...
        return prepare_entities_recognition_pii(
            body=body,
            model_version=model_version,
            show_stats=show_stats,
            string_index_type=string_index_type,
...
def prepare_entities_linking(
    ...
    **New in API version v3.1-preview.1**
    ...
    if api_version == "v3.0":
        from .v3_0 import prepare_entities_linking
        return prepare_entities_linking(
            body=body,
            model_version=model_version,
            show_stats=show_stats,
            **kwargs
        ...
        from .v3_1_preview_1 import prepare_entities_linking
        return prepare_entities_linking(
            body=body,
            model_version=model_version,
            show_stats=show_stats,
...
def prepare_key_phrases(
    ...
    **kwargs: Any
    ...
    if api_version == "v3.0":
        ...
        from .v3_1_preview_1 import prepare_key_phrases
        return prepare_key_phrases(
            body=body,
            model_version=model_version,
            show_stats=show_stats,
...
def prepare_languages(
    ...
    **kwargs: Any
    ...
    if api_version == "v3.0":
        ...
        from .v3_1_preview_1 import prepare_languages
        return prepare_languages(
            body=body,
            model_version=model_version,
            show_stats=show_stats,
...
def prepare_sentiment(
    ...
    **New in API version v3.1-preview.1**
    ...
    if api_version == "v3.0":
        from .v3_0 import prepare_sentiment
        return prepare_sentiment(
            body=body,
            model_version=model_version,
            show_stats=show_stats,
            **kwargs
        ...
        from .v3_1_preview_1 import prepare_sentiment
        return prepare_sentiment(
            body=body,
            model_version=model_version,
            show_stats=show_stats,
