...
class TextAnalyticsClient(TextAnalyticsClientBase):
    ...
    def begin_analyze_actions(  # type: ignore
        ...
        **kwargs  # type: Any
    ):  # type: (...) -> LROPoller[ItemPaged[List[Union[RecognizeEntitiesResult, RecognizeLinkedEntitiesResult, RecognizePiiEntitiesResult, ExtractKeyPhrasesResult, AnalyzeSentimentResult]]]]  # pylint: disable=line-too-long
