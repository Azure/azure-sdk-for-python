...
class TestHorizonDBMgmtPrivateEndpointConnectionsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_private_endpoint_connections_begin_approve_or_reject(self, resource_group):
        response = self.client.private_endpoint_connections.begin_approve_or_reject(
            resource_group_name=resource_group.name,
            cluster_name="str",
            private_endpoint_connection_name="str",
            resource={
