...
class TestHorizonDBMgmtPrivateEndpointConnectionsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_private_endpoint_connections_begin_approve_or_reject(self, resource_group):
        response = await (
            await self.client.private_endpoint_connections.begin_approve_or_reject(
                resource_group_name=resource_group.name,
                cluster_name="str",
                private_endpoint_connection_name="str",
                resource={
