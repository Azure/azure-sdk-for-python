...
# USAGE
    python express_route_cross_connection_shut_down_bgp_for_circuit_migration.py
...
def main():
    ...
    response = client.express_route_cross_connections.begin_shut_down_bgp_for_circuit_migration(
