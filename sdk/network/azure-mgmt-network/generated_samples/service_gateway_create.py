...
# USAGE
    python service_gateway_create.py
...
def main():
    ...
    response = client.service_gateways.begin_create_or_update(
...
# x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2025-05-01/examples/ServiceGatewayCreate.json
