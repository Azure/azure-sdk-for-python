...
# USAGE
    python network_manager_connection_subscription_put.py
...
# x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2025-03-01/examples/NetworkManagerConnectionSubscriptionPut.json
