...
# USAGE
    python network_interface_tap_configuration_create.py
...
# x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2024-10-01/examples/NetworkInterfaceTapConfigurationCreate.json
