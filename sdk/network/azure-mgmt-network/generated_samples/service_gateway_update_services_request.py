...
# USAGE
    python service_gateway_update_services_request.py
...
def main():
    ...
    response = client.service_gateways.update_services(
        ...
        parameters={
            ...
            "serviceRequests": [
                ...
                {
                    "isDelete": True,
                    "service": {"name": "Service2", "properties": {"isDefault": False, "serviceType": "Outbound"}},
                },
            ],
        },
    )
