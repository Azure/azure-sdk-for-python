...
# USAGE
    python network_manager_security_user_rule_collection_put.py
...
def main():
    ...
    response = client.security_user_rule_collections.create_or_update(
...
# x-ms-original-file: 2025-09-01/NetworkManagerSecurityUserRuleCollectionPut.json
