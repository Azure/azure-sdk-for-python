...
# USAGE
    python private_endpoint_dns_zone_group_create.py
...
# x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2025-05-01/examples/PrivateEndpointDnsZoneGroupCreate.json
