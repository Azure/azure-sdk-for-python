...
# USAGE
    python virtual_network_peering_create_with_remote_virtual_network_encryption.py
...
# x-ms-original-file: specification/network/resource-manager/Microsoft.Network/Network/stable/2025-05-01/examples/VirtualNetworkPeeringCreateWithRemoteVirtualNetworkEncryption.json
