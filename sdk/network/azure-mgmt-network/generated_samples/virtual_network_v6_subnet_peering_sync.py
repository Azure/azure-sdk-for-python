...
# USAGE
    python virtual_network_v6_subnet_peering_sync.py
...
# x-ms-original-file: specification/network/resource-manager/Microsoft.Network/Network/stable/2025-05-01/examples/VirtualNetworkV6SubnetPeeringSync.json
