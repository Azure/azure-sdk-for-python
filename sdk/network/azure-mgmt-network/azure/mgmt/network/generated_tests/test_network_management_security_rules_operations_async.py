...
class TestNetworkManagementSecurityRulesOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_security_rules_get(self, resource_group):
        response = await self.client.security_rules.get(
            resource_group_name=resource_group.name,
            network_security_group_name="str",
            security_rule_name="str",
            api_version="2024-07-01",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_security_rules_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.security_rules.begin_create_or_update(
                resource_group_name=resource_group.name,
                network_security_group_name="str",
                security_rule_name="str",
