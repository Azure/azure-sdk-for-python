...
from ...operations._resource_navigation_links_operations import build_list_request
T = TypeVar('T')
...
class ResourceNavigationLinksOperations:
    ...
    async def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.ResourceNavigationLinksListResult
