...
class IpAllocationsOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.IpAllocation
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.IpAllocationListResult"]:
        ...
        :return: An iterator like instance of either IpAllocationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_05_01.models.IpAllocationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
