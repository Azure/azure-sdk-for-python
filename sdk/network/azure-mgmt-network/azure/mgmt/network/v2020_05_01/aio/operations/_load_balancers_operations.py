...
from ...operations._load_balancers_operations import (
...
class LoadBalancersOperations:
    ...
    async def _delete_initial(self, resource_group_name: str, load_balancer_name: str, **kwargs: Any) -> None:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.LoadBalancer
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, load_balancer_name: str, parameters: "_models.LoadBalancer", **kwargs: Any
    ) -> "_models.LoadBalancer":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.LoadBalancer"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        ...
        json = self._serialize.body(parameters, "LoadBalancer")
    ...
    async def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.network.v2020_05_01.models.LoadBalancer
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
        ...
        :return: An instance of AsyncLROPoller that returns either LoadBalancer or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_05_01.models.LoadBalancer]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def update_tags(
        self, resource_group_name: str, load_balancer_name: str, parameters: "_models.TagsObject", **kwargs: Any
    ) -> "_models.LoadBalancer":
    ...
    update_tags.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}"}  # type: ignore

    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.LoadBalancerListResult"]:
        ...
        :return: An iterator like instance of either LoadBalancerListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_05_01.models.LoadBalancerListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.LoadBalancerListResult"]:
