...
from ...operations._express_route_ports_locations_operations import build_get_request, build_list_request
...
class ExpressRoutePortsLocationsOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ExpressRoutePortsLocationListResult"]:
        ...
        :return: An iterator like instance of either ExpressRoutePortsLocationListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_05_01.models.ExpressRoutePortsLocationListResult]
