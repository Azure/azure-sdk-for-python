...
class VirtualHubIpConfigurationOperations(object):
    ...
    def get(
            self, resource_group_name, virtual_hub_name, ip_config_name, custom_headers=None, raw=False, **operation_config):
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('HubIpConfiguration', response)
    ...
    def _create_or_update_initial(
            self, resource_group_name, virtual_hub_name, ip_config_name, parameters, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def create_or_update(
            self, resource_group_name, virtual_hub_name, ip_config_name, parameters, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :type parameters:
         ~azure.mgmt.network.v2020_05_01.models.HubIpConfiguration
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of LROPoller that returns HubIpConfiguration or
         ClientRawResponse<HubIpConfiguration> if raw==True
        :rtype:
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualHubs/{virtualHubName}/ipConfigurations/{ipConfigName}'}
    ...
    def delete(
            self, resource_group_name, virtual_hub_name, ip_config_name, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualHubs/{virtualHubName}/ipConfigurations/{ipConfigName}'}
    ...
    def list(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of HubIpConfiguration
        :rtype:
         ~azure.mgmt.network.v2020_05_01.models.HubIpConfigurationPaged[~azure.mgmt.network.v2020_05_01.models.HubIpConfiguration]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.HubIpConfigurationPaged(internal_paging, self._deserialize.dependencies, header_dict)
