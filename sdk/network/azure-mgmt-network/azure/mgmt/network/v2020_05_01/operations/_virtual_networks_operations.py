...
def build_get_bastion_hosts_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/bastionHosts')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'virtualNetworkName': _SERIALIZER.url("virtual_network_name", virtual_network_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
class VirtualNetworksOperations(object):
    ...
    def get_bastion_hosts(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.BastionHostListResult"
