...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/availablePrivateEndpointTypes")  # pylint: disable=line-too-long
...
def build_list_by_resource_group_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/locations/{location}/availablePrivateEndpointTypes")  # pylint: disable=line-too-long
    path_format_arguments = {
        "location": _SERIALIZER.url("location", location, 'str'),
...
class AvailablePrivateEndpointTypesOperations(object):
    ...
    def list(
        ...
        location: str,
        **kwargs: Any
    ) -> Iterable["_models.AvailablePrivateEndpointTypesResult"]:
        ...
        :return: An iterator like instance of either AvailablePrivateEndpointTypesResult or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_05_01.models.AvailablePrivateEndpointTypesResult]
