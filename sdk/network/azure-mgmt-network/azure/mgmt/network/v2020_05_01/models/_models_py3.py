...
class ConnectionMonitorTcpConfiguration(msrest.serialization.Model):
    ...
    def __init__(self, *, port: Optional[int] = None, disable_trace_route: Optional[bool] = None, **kwargs):
...
class EffectiveRoutesParameters(msrest.serialization.Model):
    ...
    def __init__(
        self, *, resource_id: Optional["Resource"] = None, virtual_wan_resource_type: Optional[str] = None, **kwargs
    ):
