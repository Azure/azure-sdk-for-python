...
class P2SVpnServerConfiguration(SubResource):
    ...
    def __init__(self, **kwargs):
        ...
        self.p2_s_vpn_server_config_vpn_client_root_certificates = kwargs.get(
            "p2_s_vpn_server_config_vpn_client_root_certificates", None
        )
        self.p2_s_vpn_server_config_vpn_client_revoked_certificates = kwargs.get(
            "p2_s_vpn_server_config_vpn_client_revoked_certificates", None
        )
        self.p2_s_vpn_server_config_radius_server_root_certificates = kwargs.get(
            "p2_s_vpn_server_config_radius_server_root_certificates", None
        )
        self.p2_s_vpn_server_config_radius_client_root_certificates = kwargs.get(
            "p2_s_vpn_server_config_radius_client_root_certificates", None
        )
...
class VirtualNetworkTap(Resource):
    ...
    def __init__(self, **kwargs):
        ...
        self.resource_guid = None
        self.provisioning_state = None
        self.destination_network_interface_ip_configuration = kwargs.get(
            "destination_network_interface_ip_configuration", None
        )
        self.destination_load_balancer_front_end_ip_configuration = kwargs.get(
            "destination_load_balancer_front_end_ip_configuration", None
        )
