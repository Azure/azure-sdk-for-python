...
def build_check_ip_address_availability_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    ip_address = kwargs.pop('ip_address')  # type: str
...
class VirtualNetworksOperations(object):
    ...
    def list_all(
        ...
        :return: An iterator like instance of either VirtualNetworkListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2018_11_01.models.VirtualNetworkListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_usage(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either VirtualNetworkListUsageResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2018_11_01.models.VirtualNetworkListUsageResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
