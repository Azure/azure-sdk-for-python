...
class ExpressRouteCircuitsOperations(object):
    ...
    def list_routes_table_summary(
        ...
        :return: An instance of LROPoller that returns
         ...
         raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_11_01.models.ExpressRouteCircuitsRoutesTableSummaryListResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.ExpressRouteCircuitsRoutesTableSummaryListResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
