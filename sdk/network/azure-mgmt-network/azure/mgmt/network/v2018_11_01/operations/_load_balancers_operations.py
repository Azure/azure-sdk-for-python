...
class LoadBalancersOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_11_01.models.LoadBalancer or
    ...
    def create_or_update(
        ...
        :param parameters: Parameters supplied to the create or update load
         balancer operation.
        :type parameters: ~azure.mgmt.network.v2018_11_01.models.LoadBalancer
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_11_01.models.LoadBalancer]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_11_01.models.LoadBalancer]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_all(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_11_01.models.LoadBalancerPaged[~azure.mgmt.network.v2018_11_01.models.LoadBalancer]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
