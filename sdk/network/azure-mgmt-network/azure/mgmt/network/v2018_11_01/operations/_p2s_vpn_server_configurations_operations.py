...
class P2sVpnServerConfigurationsOperations(object):
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_11_01.models.P2SVpnServerConfiguration or
    ...
    def list_by_virtual_wan(
        ...
        if raw:
            header_dict = {}
        deserialized = models.P2SVpnServerConfigurationPaged(internal_paging, self._deserialize.dependencies, header_dict)
