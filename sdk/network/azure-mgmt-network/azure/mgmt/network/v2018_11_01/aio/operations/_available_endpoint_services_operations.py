...
from ...operations._available_endpoint_services_operations import build_list_request
...
class AvailableEndpointServicesOperations:
    ...
    def list(self, location: str, **kwargs: Any) -> AsyncIterable["_models.EndpointServicesListResult"]:
        ...
        :return: An iterator like instance of either EndpointServicesListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2018_11_01.models.EndpointServicesListResult]
