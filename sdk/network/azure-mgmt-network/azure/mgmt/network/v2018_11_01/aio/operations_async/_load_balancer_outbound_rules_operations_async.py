...
class LoadBalancerOutboundRulesOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2018_11_01.models.LoadBalancerOutboundRuleListResult]
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2018_11_01.models.OutboundRule
        :raises: ~azure.core.exceptions.HttpResponseError
        """
