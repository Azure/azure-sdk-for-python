...
from ...operations._vpn_gateways_operations import (
...
class VpnGatewaysOperations:
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, gateway_name: str, vpn_gateway_parameters: "_models.VpnGateway", **kwargs: Any
    ) -> "_models.VpnGateway":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.VpnGateway"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    async def _update_tags_initial(
        self, resource_group_name: str, gateway_name: str, vpn_gateway_parameters: "_models.TagsObject", **kwargs: Any
    ) -> "_models.VpnGateway":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.VpnGateway"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    async def _delete_initial(self, resource_group_name: str, gateway_name: str, **kwargs: Any) -> None:
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either ListVpnGatewaysResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2018_11_01.models.ListVpnGatewaysResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ListVpnGatewaysResult"]:
