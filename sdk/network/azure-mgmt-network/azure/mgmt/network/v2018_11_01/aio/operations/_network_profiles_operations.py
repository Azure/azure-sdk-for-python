...
from ...operations._network_profiles_operations import (
...
class NetworkProfilesOperations:
    ...
    async def _delete_initial(self, resource_group_name: str, network_profile_name: str, **kwargs: Any) -> None:
    ...
    async def get(
        ...
        :param resource_group_name: The name of the resource group.
        :type resource_group_name: str
        :param network_profile_name: The name of the PublicIPPrefix.
        :type network_profile_name: str
        :param expand: Expands referenced resources.
        :type expand: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NetworkProfile, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2018_11_01.models.NetworkProfile
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_or_update(
        self, resource_group_name: str, network_profile_name: str, parameters: "_models.NetworkProfile", **kwargs: Any
    ) -> "_models.NetworkProfile":
        ...
        :type parameters: ~azure.mgmt.network.v2018_11_01.models.NetworkProfile
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NetworkProfile, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2018_11_01.models.NetworkProfile
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        json = self._serialize.body(parameters, "NetworkProfile")
    ...
    async def update_tags(
        self, resource_group_name: str, network_profile_name: str, parameters: "_models.TagsObject", **kwargs: Any
    ) -> "_models.NetworkProfile":
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.NetworkProfileListResult"]:
        ...
        :return: An iterator like instance of either NetworkProfileListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2018_11_01.models.NetworkProfileListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.NetworkProfileListResult"]:
