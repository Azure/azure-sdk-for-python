...
class ServiceEndpointPoliciesOperations:
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/serviceEndpointPolicies/{serviceEndpointPolicyName}'}
    ...
    async def _create_or_update_initial(
        ...
        resource_group_name: str,
        service_endpoint_policy_name: str,
        parameters: "models.ServiceEndpointPolicy",
        **kwargs
    ) -> "models.ServiceEndpointPolicy":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ServiceEndpointPolicy"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/serviceEndpointPolicies/{serviceEndpointPolicyName}'}
    ...
    async def create_or_update(
     ...
     operation.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_11_01.models.ServiceEndpointPolicy]
    ...
    def list(
        self,
        **kwargs
    ) -> "models.ServiceEndpointPolicyListResult":
        """Gets all the service endpoint policies in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ServiceEndpointPolicyListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_11_01.models.ServiceEndpointPolicyListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
