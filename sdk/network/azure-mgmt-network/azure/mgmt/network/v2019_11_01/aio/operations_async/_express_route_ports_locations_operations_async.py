...
class ExpressRoutePortsLocationsOperations:
    ...
    def list(
        self,
        **kwargs
    ) -> "models.ExpressRoutePortsLocationListResult":
        """Retrieves all ExpressRoutePort peering locations. Does not return available bandwidths for each location. Available bandwidths can only be obtained when retrieving a specific peering location.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ExpressRoutePortsLocationListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_11_01.models.ExpressRoutePortsLocationListResult
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_11_01.models.ExpressRoutePortsLocation
        :raises: ~azure.core.exceptions.HttpResponseError
        """
