...
from ...operations._network_watchers_operations import build_check_connectivity_request_initial, build_create_or_update_request, build_delete_request_initial, build_get_azure_reachability_report_request_initial, build_get_flow_log_status_request_initial, build_get_network_configuration_diagnostic_request_initial, build_get_next_hop_request_initial, build_get_request, build_get_topology_request, build_get_troubleshooting_request_initial, build_get_troubleshooting_result_request_initial, build_get_vm_security_rules_request_initial, build_list_all_request, build_list_available_providers_request_initial, build_list_request, build_set_flow_log_configuration_request_initial, build_update_tags_request, build_verify_ip_flow_request_initial
T = TypeVar('T')
