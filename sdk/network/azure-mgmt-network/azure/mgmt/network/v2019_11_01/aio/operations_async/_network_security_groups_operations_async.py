...
class NetworkSecurityGroupsOperations:
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityGroups/{networkSecurityGroupName}'}
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_11_01.models.NetworkSecurityGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityGroups/{networkSecurityGroupName}'}
    ...
    async def create_or_update(
     ...
     operation.
        :type parameters: ~azure.mgmt.network.v2019_11_01.models.NetworkSecurityGroup
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns NetworkSecurityGroup
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_11_01.models.NetworkSecurityGroup]
    ...
    async def update_tags(
        ...
        **kwargs
        ...
        return deserialized
    update_tags.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityGroups/{networkSecurityGroupName}'}

    def list_all(
        self,
        **kwargs
    ) -> "models.NetworkSecurityGroupListResult":
        """Gets all network security groups in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NetworkSecurityGroupListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_11_01.models.NetworkSecurityGroupListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
