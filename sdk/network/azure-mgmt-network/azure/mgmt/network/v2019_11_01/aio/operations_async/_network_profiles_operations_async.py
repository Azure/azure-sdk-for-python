...
class NetworkProfilesOperations:
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NetworkProfile or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_11_01.models.NetworkProfile or ~azure.mgmt.network.v2019_11_01.models.NetworkProfile
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.NetworkProfile"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    def list_all(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_11_01.models.NetworkProfileListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
