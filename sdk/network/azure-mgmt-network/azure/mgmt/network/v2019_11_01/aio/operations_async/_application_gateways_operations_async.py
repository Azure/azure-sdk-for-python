...
class ApplicationGatewaysOperations:
    ...
    async def begin_backend_health(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_11_01.models.ApplicationGatewayBackendHealth
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ApplicationGatewayBackendHealth"]
    ...
    application gateway in a resource group.
        ...
        :rtype: ~azure.mgmt.network.v2019_11_01.models.ApplicationGatewayBackendHealthOnDemand
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ApplicationGatewayBackendHealthOnDemand"]
