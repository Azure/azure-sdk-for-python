...
class AzureFirewallFqdnTagsOperations:
    ...
    def list_all(
        self,
        **kwargs
    ) -> "models.AzureFirewallFqdnTagListResult":
        """Gets all the Azure Firewall FQDN Tags in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AzureFirewallFqdnTagListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_11_01.models.AzureFirewallFqdnTagListResult
