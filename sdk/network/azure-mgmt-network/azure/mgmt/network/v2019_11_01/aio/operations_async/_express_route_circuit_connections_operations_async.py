...
class ExpressRouteCircuitConnectionsOperations:
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}/connections/{connectionName}'}
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}/connections/{connectionName}'}
    ...
    async def create_or_update(
     ...
     express route circuit connection operation.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_11_01.models.ExpressRouteCircuitConnection]
    ...
    def list(
        ...
        peering_name: str,
        **kwargs
    ) -> "models.ExpressRouteCircuitConnectionListResult":
        ...
        :type peering_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ExpressRouteCircuitConnectionListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_11_01.models.ExpressRouteCircuitConnectionListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
