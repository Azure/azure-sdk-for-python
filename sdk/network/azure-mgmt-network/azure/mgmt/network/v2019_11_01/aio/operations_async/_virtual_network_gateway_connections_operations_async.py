...
class VirtualNetworkGatewayConnectionsOperations:
    ...
    async def create_or_update(
     ...
     connection operation.
        :type parameters: ~azure.mgmt.network.v2019_11_01.models.VirtualNetworkGatewayConnection
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns VirtualNetworkGatewayConnection
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_11_01.models.VirtualNetworkGatewayConnection]
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_11_01.models.VirtualNetworkGatewayConnection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VirtualNetworkGatewayConnection"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    async def _set_shared_key_initial(
        ...
        **kwargs
        ...
        # Construct URL
        url = self._set_shared_key_initial.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'virtualNetworkGatewayConnectionName': self._serialize.url("virtual_network_gateway_connection_name", virtual_network_gateway_connection_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
        ...
        return deserialized
    _set_shared_key_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/connections/{virtualNetworkGatewayConnectionName}/sharedkey'}
    ...
    async def set_shared_key(
     ...
     Shared key operation throughNetwork resource provider.
        :type parameters: ~azure.mgmt.network.v2019_11_01.models.ConnectionSharedKey
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns ConnectionSharedKey
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_11_01.models.ConnectionSharedKey]
    ...
    async def get_shared_key(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_11_01.models.ConnectionSharedKey
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ConnectionSharedKey"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    def list(
        ...
        resource_group_name: str,
        **kwargs
    ) -> "models.VirtualNetworkGatewayConnectionListResult":
        """The List VirtualNetworkGatewayConnections operation retrieves all the virtual network gateways connections created.

        :param resource_group_name: The name of the resource group.
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: VirtualNetworkGatewayConnectionListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_11_01.models.VirtualNetworkGatewayConnectionListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _reset_shared_key_initial(
        ...
        **kwargs
        ...
        # Construct URL
        url = self._reset_shared_key_initial.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'virtualNetworkGatewayConnectionName': self._serialize.url("virtual_network_gateway_connection_name", virtual_network_gateway_connection_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
        ...
        return deserialized
    _reset_shared_key_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/connections/{virtualNetworkGatewayConnectionName}/sharedkey/reset'}
    ...
    async def reset_shared_key(
     ...
     shared key operation through network resource provider.
        :type parameters: ~azure.mgmt.network.v2019_11_01.models.ConnectionResetSharedKey
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns ConnectionResetSharedKey
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_11_01.models.ConnectionResetSharedKey]
    ...
    async def _start_packet_capture_initial(
        ...
        **kwargs
        ...
        return deserialized
    _start_packet_capture_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/connections/{virtualNetworkGatewayConnectionName}/startPacketCapture'}
    ...
    async def start_packet_capture(
     ...
     capture on gateway connection.
        :type parameters: ~azure.mgmt.network.v2019_11_01.models.VpnPacketCaptureStartParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
    ...
    async def stop_packet_capture(
     ...
     capture on gateway connection.
        :type parameters: ~azure.mgmt.network.v2019_11_01.models.VpnPacketCaptureStopParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
