...
class NetworkManagementClientOperationsMixin(object):
    ...
    def _put_bastion_shareable_link_initial(
        ...
        vms=None,  # type: Optional[List["BastionShareableLink"]]
        **kwargs  # type: Any
    ):
        ...
        # Construct URL
        url = self._put_bastion_shareable_link_initial.metadata['url']
    ...
    def begin_put_bastion_shareable_link(
        ...
        **kwargs  # type: Any
        ...
        :type vms: list[~azure.mgmt.network.v2019_11_01.models.BastionShareableLink]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :return: An instance of LROPoller that returns BastionShareableLinkListResult
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_11_01.models.BastionShareableLinkListResult]
    ...
    def _delete_bastion_shareable_link_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._delete_bastion_shareable_link_initial.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'bastionHostName': self._serialize.url("bastion_host_name", bastion_host_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
    ...
    _delete_bastion_shareable_link_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/bastionHosts/{bastionHostName}/deleteShareableLinks'}
    ...
    def get_bastion_shareable_link(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.network.v2019_11_01.models.BastionShareableLinkListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.BastionShareableLinkListResult"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    def _get_active_sessions_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._get_active_sessions_initial.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'bastionHostName': self._serialize.url("bastion_host_name", bastion_host_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
        ...
        return deserialized
    _get_active_sessions_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/bastionHosts/{bastionHostName}/getActiveSessions'}
    ...
    def begin_get_active_sessions(
        ...
        **kwargs  # type: Any
        ...
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :return: An instance of LROPoller that returns BastionActiveSessionListResult
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_11_01.models.BastionActiveSessionListResult]
    ...
    def disconnect_active_sessions(
        ...
        resource_group_name,  # type: str
        bastion_host_name,  # type: str
        session_ids=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.BastionSessionDeleteResult"
        """Returns the list of currently active sessions on the Bastion.
        ...
        :rtype: ~azure.mgmt.network.v2019_11_01.models.BastionSessionDeleteResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _generatevirtualwanvpnserverconfigurationvpnprofile_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._generatevirtualwanvpnserverconfigurationvpnprofile_initial.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'virtualWANName': self._serialize.url("virtual_wan_name", virtual_wan_name, 'str'),
    ...
    def begin_generatevirtualwanvpnserverconfigurationvpnprofile(
     ...
     which VirtualWan is associated to.
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_generatevirtualwanvpnserverconfigurationvpnprofile.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{virtualWANName}/GenerateVpnProfile'}
