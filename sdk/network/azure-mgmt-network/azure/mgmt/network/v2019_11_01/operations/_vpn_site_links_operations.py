...
class VpnSiteLinksOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.network.v2019_11_01.models.VpnSiteLink
    ...
    def list_by_vpn_site(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ListVpnSiteLinksResult"
        ...
        :type vpn_site_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ListVpnSiteLinksResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_11_01.models.ListVpnSiteLinksResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
