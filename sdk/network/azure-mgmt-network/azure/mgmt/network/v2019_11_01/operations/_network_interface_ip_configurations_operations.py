...
class NetworkInterfaceIPConfigurationsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.NetworkInterfaceIPConfigurationListResult"
        ...
        :return: NetworkInterfaceIPConfigurationListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_11_01.models.NetworkInterfaceIPConfigurationListResult
