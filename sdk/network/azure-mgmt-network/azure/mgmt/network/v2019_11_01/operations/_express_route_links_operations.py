...
class ExpressRouteLinksOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ExpressRouteLinkListResult"
        ...
        :type express_route_port_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ExpressRouteLinkListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_11_01.models.ExpressRouteLinkListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
