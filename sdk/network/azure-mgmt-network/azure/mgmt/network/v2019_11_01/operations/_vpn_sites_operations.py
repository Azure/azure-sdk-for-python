...
class VpnSitesOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}'}

    def _create_or_update_initial(
        self,
        resource_group_name,  # type: str
        vpn_site_name,  # type: str
        vpn_site_parameters,  # type: "models.VpnSite"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.VpnSite"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VpnSite"]
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}'}
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type vpn_site_parameters: ~azure.mgmt.network.v2019_11_01.models.VpnSite
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :return: An instance of LROPoller that returns VpnSite
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_11_01.models.VpnSite]
    ...
    begin_create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}'}

    def update_tags(
        self,
        resource_group_name,  # type: str
        vpn_site_name,  # type: str
        vpn_site_parameters,  # type: "models.TagsObject"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.VpnSite"
        ...
        return deserialized
    update_tags.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}'}
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}'}
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ListVpnSitesResult"
        """Lists all the vpnSites in a resource group.

        :param resource_group_name: The resource group name of the VpnSite.
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ListVpnSitesResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_11_01.models.ListVpnSitesResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
