...
class RouteFilterRulesOperations(object):
    ...
    def begin_create_or_update(
     ...
     rule operation.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_11_01.models.RouteFilterRule]
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeFilters/{routeFilterName}/routeFilterRules/{ruleName}'}
    ...
    def list_by_route_filter(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.RouteFilterRuleListResult"
        ...
        :rtype: ~azure.mgmt.network.v2019_11_01.models.RouteFilterRuleListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
