...
class AvailableEndpointServicesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_11_01.models.EndpointServiceResultPaged[~azure.mgmt.network.v2019_11_01.models.EndpointServiceResult]
        ...
        if raw:
            header_dict = {}
        deserialized = models.EndpointServiceResultPaged(internal_paging, self._deserialize.dependencies, header_dict)
