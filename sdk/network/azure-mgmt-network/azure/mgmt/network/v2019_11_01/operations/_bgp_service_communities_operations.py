...
class BgpServiceCommunitiesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.BgpServiceCommunityListResult"
        """Gets all the available bgp service communities.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: BgpServiceCommunityListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_11_01.models.BgpServiceCommunityListResult
