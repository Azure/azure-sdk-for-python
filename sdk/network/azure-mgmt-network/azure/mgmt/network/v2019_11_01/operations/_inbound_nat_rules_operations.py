...
class InboundNatRulesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_11_01.models.InboundNatRulePaged[~azure.mgmt.network.v2019_11_01.models.InboundNatRule]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2019_11_01.models.InboundNatRule or
    ...
    def create_or_update(
        ...
        :type inbound_nat_rule_parameters:
         ~azure.mgmt.network.v2019_11_01.models.InboundNatRule
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2019_11_01.models.InboundNatRule]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2019_11_01.models.InboundNatRule]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
