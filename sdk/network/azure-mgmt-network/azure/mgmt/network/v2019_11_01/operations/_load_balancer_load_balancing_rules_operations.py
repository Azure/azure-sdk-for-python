...
class LoadBalancerLoadBalancingRulesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_11_01.models.LoadBalancingRulePaged[~azure.mgmt.network.v2019_11_01.models.LoadBalancingRule]
        ...
        if raw:
            header_dict = {}
        deserialized = models.LoadBalancingRulePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2019_11_01.models.LoadBalancingRule or
