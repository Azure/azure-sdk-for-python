...
class PrivateLinkServicesOperations(object):
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateLinkServices/{serviceName}'}
    ...
    begin_delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateLinkServices/{serviceName}'}
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateLinkServices/{serviceName}'}
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateLinkServices/{serviceName}'}
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.PrivateLinkServiceListResult"
        """Gets all private link services in a resource group.

        :param resource_group_name: The name of the resource group.
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PrivateLinkServiceListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_11_01.models.PrivateLinkServiceListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _delete_private_endpoint_connection_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._delete_private_endpoint_connection_initial.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'serviceName': self._serialize.url("service_name", service_name, 'str'),
            'peConnectionName': self._serialize.url("pe_connection_name", pe_connection_name, 'str'),
    ...
    _delete_private_endpoint_connection_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateLinkServices/{serviceName}/privateEndpointConnections/{peConnectionName}'}
    ...
    def begin_delete_private_endpoint_connection(
        ...
        **kwargs  # type: Any
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_delete_private_endpoint_connection.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateLinkServices/{serviceName}/privateEndpointConnections/{peConnectionName}'}
    ...
    def list_private_endpoint_connections(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.network.v2019_11_01.models.PrivateEndpointConnectionListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_auto_approved_private_link_services(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.AutoApprovedPrivateLinkServicesResult"
        """Returns all of the private link service ids that can be linked to a Private Endpoint with auto approved in this subscription in this region.

        :param location: The location of the domain name.
        :type location: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AutoApprovedPrivateLinkServicesResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_11_01.models.AutoApprovedPrivateLinkServicesResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
