...
class NetworkManagementClientOperationsMixin(object):
    ...
    def begin_delete_bastion_shareable_link(
        ...
        **kwargs: Any
        ...
        if api_version == '2019-09-01':
            ...
            from .v2023_02_01.operations import NetworkManagementClientOperationsMixin as OperationClass
        elif api_version == '2023-04-01':
            from .v2023_04_01.operations import NetworkManagementClientOperationsMixin as OperationClass
        elif api_version == '2023-05-01':
            from .v2023_05_01.operations import NetworkManagementClientOperationsMixin as OperationClass
        elif api_version == '2023-06-01':
            from .v2023_06_01.operations import NetworkManagementClientOperationsMixin as OperationClass
        elif api_version == '2023-09-01':
            from .v2023_09_01.operations import NetworkManagementClientOperationsMixin as OperationClass
        elif api_version == '2023-11-01':
            from .v2023_11_01.operations import NetworkManagementClientOperationsMixin as OperationClass
        elif api_version == '2024-01-01':
            from .v2024_01_01.operations import NetworkManagementClientOperationsMixin as OperationClass
        elif api_version == '2024-03-01':
            from .v2024_03_01.operations import NetworkManagementClientOperationsMixin as OperationClass
        else:
    ...
    def begin_delete_bastion_shareable_link_by_token(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        bastion_host_name: str,
        ...
        **kwargs: Any
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return mixin_instance.begin_delete_bastion_shareable_link_by_token(resource_group_name, bastion_host_name, bsl_token_request, **kwargs)

    def begin_generatevirtualwanvpnserverconfigurationvpnprofile(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either VpnProfileResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2024_03_01.models.VpnProfileResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_get_active_sessions(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.core.paging.ItemPaged[~azure.mgmt.network.v2024_03_01.models.BastionActiveSession]]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_put_bastion_shareable_link(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.core.paging.ItemPaged[~azure.mgmt.network.v2024_03_01.models.BastionShareableLink]]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def disconnect_active_sessions(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2024_03_01.models.BastionSessionState]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_bastion_shareable_link(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either BastionShareableLink or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2024_03_01.models.BastionShareableLink]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
