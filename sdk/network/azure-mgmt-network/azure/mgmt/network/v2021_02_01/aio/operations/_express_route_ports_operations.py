...
from ...operations._express_route_ports_operations import build_create_or_update_request_initial, build_delete_request_initial, build_generate_loa_request, build_get_request, build_list_by_resource_group_request, build_list_request, build_update_tags_request
T = TypeVar('T')
...
class ExpressRoutePortsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2021_02_01.models.ExpressRoutePort
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2021_02_01.models.ExpressRoutePort
        :keyword api_version: Api Version. Default value is "2021-02-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either ExpressRoutePort or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_02_01.models.ExpressRoutePort]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-02-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ExpressRoutePortListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.ExpressRoutePortListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-02-01")  # type: str
    ...
    async def generate_loa(
        ...
        **kwargs: Any
        ...
        :type request: ~azure.mgmt.network.v2021_02_01.models.GenerateExpressRoutePortsLOARequest
        :keyword api_version: Api Version. Default value is "2021-02-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: GenerateExpressRoutePortsLOAResult, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2021_02_01.models.GenerateExpressRoutePortsLOAResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        _json = self._serialize.body(request, 'GenerateExpressRoutePortsLOARequest')
