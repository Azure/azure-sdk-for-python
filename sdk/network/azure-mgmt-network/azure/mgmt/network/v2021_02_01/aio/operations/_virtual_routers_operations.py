...
from ...operations._virtual_routers_operations import (
...
class VirtualRoutersOperations:
    ...
    async def _delete_initial(self, resource_group_name: str, virtual_router_name: str, **kwargs: Any) -> None:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2021_02_01.models.VirtualRouter
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, virtual_router_name: str, parameters: "_models.VirtualRouter", **kwargs: Any
    ) -> "_models.VirtualRouter":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.VirtualRouter"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    async def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.network.v2021_02_01.models.VirtualRouter
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
        ...
        :return: An instance of AsyncLROPoller that returns either VirtualRouter or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_02_01.models.VirtualRouter]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either VirtualRouterListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.VirtualRouterListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.VirtualRouterListResult"]:
