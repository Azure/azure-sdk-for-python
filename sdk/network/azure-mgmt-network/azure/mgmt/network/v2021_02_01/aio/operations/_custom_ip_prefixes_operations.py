...
from ...operations._custom_ip_prefixes_operations import (
...
class CustomIPPrefixesOperations:
    ...
    async def _delete_initial(self, resource_group_name: str, custom_ip_prefix_name: str, **kwargs: Any) -> None:
    ...
    async def begin_delete(
        self, resource_group_name: str, custom_ip_prefix_name: str, **kwargs: Any
    ) -> AsyncLROPoller[None]:
    ...
    async def get(
        self, resource_group_name: str, custom_ip_prefix_name: str, expand: Optional[str] = None, **kwargs: Any
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, custom_ip_prefix_name: str, parameters: "_models.CustomIpPrefix", **kwargs: Any
    ) -> "_models.CustomIpPrefix":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.CustomIpPrefix"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    async def begin_create_or_update(
        ...
        :return: An instance of AsyncLROPoller that returns either CustomIpPrefix or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_02_01.models.CustomIpPrefix]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def update_tags(
        self, resource_group_name: str, custom_ip_prefix_name: str, parameters: "_models.TagsObject", **kwargs: Any
    ) -> "_models.CustomIpPrefix":
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.CustomIpPrefixListResult"]:
        ...
        :return: An iterator like instance of either CustomIpPrefixListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.CustomIpPrefixListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.CustomIpPrefixListResult"]:
