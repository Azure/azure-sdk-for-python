...
from ...operations._virtual_network_gateway_nat_rules_operations import (
    build_create_or_update_request_initial,
    build_delete_request_initial,
    build_get_request,
    build_list_by_virtual_network_gateway_request,
)
...
class VirtualNetworkGatewayNatRulesOperations:
    ...
    async def get(
        self, resource_group_name: str, virtual_network_gateway_name: str, nat_rule_name: str, **kwargs: Any
