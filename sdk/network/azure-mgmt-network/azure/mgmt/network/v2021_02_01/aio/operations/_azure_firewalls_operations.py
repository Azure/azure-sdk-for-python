...
from ...operations._azure_firewalls_operations import (
...
class AzureFirewallsOperations:
    ...
    async def _delete_initial(self, resource_group_name: str, azure_firewall_name: str, **kwargs: Any) -> None:
    ...
    async def get(self, resource_group_name: str, azure_firewall_name: str, **kwargs: Any) -> "_models.AzureFirewall":
        ...
        :rtype: ~azure.mgmt.network.v2021_02_01.models.AzureFirewall
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, azure_firewall_name: str, parameters: "_models.AzureFirewall", **kwargs: Any
    ...
    async def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.network.v2021_02_01.models.AzureFirewall
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
        ...
        :return: An instance of AsyncLROPoller that returns either AzureFirewall or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_02_01.models.AzureFirewall]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def _update_tags_initial(
        self, resource_group_name: str, azure_firewall_name: str, parameters: "_models.TagsObject", **kwargs: Any
    ...
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.AzureFirewallListResult"]:
        ...
        :return: An iterator like instance of either AzureFirewallListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.AzureFirewallListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.AzureFirewallListResult"]:
