...
from ...operations._nat_gateways_operations import (
...
class NatGatewaysOperations:
    ...
    async def _delete_initial(self, resource_group_name: str, nat_gateway_name: str, **kwargs: Any) -> None:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2021_02_01.models.NatGateway
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, nat_gateway_name: str, parameters: "_models.NatGateway", **kwargs: Any
    ...
    async def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.network.v2021_02_01.models.NatGateway
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
        ...
        :return: An instance of AsyncLROPoller that returns either NatGateway or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_02_01.models.NatGateway]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def update_tags(
        self, resource_group_name: str, nat_gateway_name: str, parameters: "_models.TagsObject", **kwargs: Any
    ) -> "_models.NatGateway":
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.NatGatewayListResult"]:
        ...
        :return: An iterator like instance of either NatGatewayListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.NatGatewayListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.NatGatewayListResult"]:
