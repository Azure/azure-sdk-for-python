...
class RouteFiltersOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either RouteFilter or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_02_01.models.RouteFilter]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def update_tags(
        self, resource_group_name: str, route_filter_name: str, parameters: "_models.TagsObject", **kwargs: Any
    ) -> "_models.RouteFilter":
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either RouteFilterListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.RouteFilterListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
