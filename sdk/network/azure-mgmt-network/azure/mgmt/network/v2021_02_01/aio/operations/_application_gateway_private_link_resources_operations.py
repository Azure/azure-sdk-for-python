...
from ...operations._application_gateway_private_link_resources_operations import build_list_request
T = TypeVar('T')
...
class ApplicationGatewayPrivateLinkResourcesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.ApplicationGatewayPrivateLinkResourceListResult]
