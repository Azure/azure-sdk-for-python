...
from ...operations._nat_rules_operations import (
...
class NatRulesOperations:
    ...
    async def get(
        self, resource_group_name: str, gateway_name: str, nat_rule_name: str, **kwargs: Any
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(nat_rule_parameters, "VpnGatewayNatRule")
