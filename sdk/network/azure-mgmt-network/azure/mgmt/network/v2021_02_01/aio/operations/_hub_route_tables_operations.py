...
from ...operations._hub_route_tables_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_request
T = TypeVar('T')
...
class HubRouteTablesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type route_table_parameters: ~azure.mgmt.network.v2021_02_01.models.HubRouteTable
        ...
        :return: An instance of AsyncLROPoller that returns either HubRouteTable or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_02_01.models.HubRouteTable]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2021_02_01.models.HubRouteTable
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.HubRouteTable"]
        error_map = {
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListHubRouteTablesResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.ListHubRouteTablesResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
