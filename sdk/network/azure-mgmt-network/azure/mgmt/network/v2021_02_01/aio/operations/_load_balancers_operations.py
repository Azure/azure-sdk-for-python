...
from ...operations._load_balancers_operations import (
    ...
    build_list_request,
    build_swap_public_ip_addresses_request_initial,
...
class LoadBalancersOperations:
    ...
    async def _swap_public_ip_addresses_initial(
        self, location: str, parameters: "_models.LoadBalancerVipSwapRequest", **kwargs: Any
    ) -> None:
        cls = kwargs.pop("cls", None)  # type: ClsType[None]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        ...
        json = self._serialize.body(parameters, "LoadBalancerVipSwapRequest")
