...
from ...operations._load_balancers_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_all_request, build_list_request, build_swap_public_ip_addresses_request_initial, build_update_tags_request
T = TypeVar('T')
...
class LoadBalancersOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2021_02_01.models.LoadBalancer
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2021_02_01.models.LoadBalancer
        :keyword api_version: Api Version. Default value is "2021-02-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either LoadBalancer or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_02_01.models.LoadBalancer]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-02-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_all(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either LoadBalancerListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.LoadBalancerListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-02-01")  # type: str
    ...
    async def _swap_public_ip_addresses_initial(  # pylint: disable=inconsistent-return-statements
        self,
        location: str,
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(parameters, 'LoadBalancerVipSwapRequest')

        request = build_swap_public_ip_addresses_request_initial(
            location=location,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            content_type=content_type,
            json=_json,
            template_url=self._swap_public_ip_addresses_initial.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    @distributed_trace_async
    async def begin_swap_public_ip_addresses(  # pylint: disable=inconsistent-return-statements
        self,
        location: str,
        parameters: "_models.LoadBalancerVipSwapRequest",
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2021_02_01.models.LoadBalancerVipSwapRequest
        :keyword api_version: Api Version. Default value is "2021-02-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
