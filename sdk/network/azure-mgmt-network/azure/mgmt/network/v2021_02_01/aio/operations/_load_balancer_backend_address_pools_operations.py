...
from ...operations._load_balancer_backend_address_pools_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_request
T = TypeVar('T')
...
class LoadBalancerBackendAddressPoolsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.LoadBalancerBackendAddressPoolListResult]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2021_02_01.models.BackendAddressPool
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(parameters, 'BackendAddressPool')
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the create or update load balancer backend address
         pool operation.
        :type parameters: ~azure.mgmt.network.v2021_02_01.models.BackendAddressPool
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either BackendAddressPool or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_02_01.models.BackendAddressPool]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
