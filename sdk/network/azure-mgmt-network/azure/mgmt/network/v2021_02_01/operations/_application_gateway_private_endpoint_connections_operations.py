...
def build_delete_request_initial(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/privateEndpointConnections/{connectionName}")  # pylint: disable=line-too-long
...
def build_list_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/privateEndpointConnections")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "applicationGatewayName": _SERIALIZER.url("application_gateway_name", application_gateway_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
class ApplicationGatewayPrivateEndpointConnectionsOperations(object):
    ...
    def _update_initial(
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(parameters, 'ApplicationGatewayPrivateEndpointConnection')
    ...
    def begin_update(
        ...
        parameters: "_models.ApplicationGatewayPrivateEndpointConnection",
        **kwargs: Any
    ) -> LROPoller["_models.ApplicationGatewayPrivateEndpointConnection"]:
        ...
        :type parameters:
         ~azure.mgmt.network.v2021_02_01.models.ApplicationGatewayPrivateEndpointConnection
        :keyword api_version: Api Version. Default value is "2021-02-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2021_02_01.models.ApplicationGatewayPrivateEndpointConnection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-02-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2021_02_01.models.ApplicationGatewayPrivateEndpointConnection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ApplicationGatewayPrivateEndpointConnection"]
        error_map = {
    ...
    def list(
        ...
        application_gateway_name: str,
        **kwargs: Any
    ) -> Iterable["_models.ApplicationGatewayPrivateEndpointConnectionListResult"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2021_02_01.models.ApplicationGatewayPrivateEndpointConnectionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-02-01")  # type: str
