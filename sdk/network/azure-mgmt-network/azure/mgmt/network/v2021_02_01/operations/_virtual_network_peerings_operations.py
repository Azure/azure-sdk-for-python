...
class VirtualNetworkPeeringsOperations(object):
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        if sync_remote_address_space is not None:
            query_parameters['syncRemoteAddressSpace'] = self._serialize.query("sync_remote_address_space", sync_remote_address_space, 'str')
        query_parameters['api-version'] = self._serialize.query("api_version", api_version, 'str')
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type virtual_network_peering_parameters: ~azure.mgmt.network.v2021_02_01.models.VirtualNetworkPeering
        ...
        :type sync_remote_address_space: str or ~azure.mgmt.network.v2021_02_01.models.SyncRemoteAddressSpace
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2021_02_01.models.VirtualNetworkPeering]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.VirtualNetworkPeering"]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2021_02_01.models.VirtualNetworkPeeringListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
