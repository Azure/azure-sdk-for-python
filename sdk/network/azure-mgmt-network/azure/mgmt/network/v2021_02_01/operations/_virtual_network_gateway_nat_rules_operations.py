...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/natRules/{natRuleName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        ...
        "natRuleName": _SERIALIZER.url("nat_rule_name", nat_rule_name, 'str'),
    }
...
def build_list_by_virtual_network_gateway_request(
    subscription_id: str,
    resource_group_name: str,
    virtual_network_gateway_name: str,
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/natRules")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "virtualNetworkGatewayName": _SERIALIZER.url("virtual_network_gateway_name", virtual_network_gateway_name, 'str'),
...
class VirtualNetworkGatewayNatRulesOperations(object):
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(nat_rule_parameters, 'VirtualNetworkGatewayNatRule')
    ...
    def begin_create_or_update(
        ...
        nat_rule_parameters: "_models.VirtualNetworkGatewayNatRule",
        **kwargs: Any
    ) -> LROPoller["_models.VirtualNetworkGatewayNatRule"]:
        ...
        :return: An instance of LROPoller that returns either VirtualNetworkGatewayNatRule or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2021_02_01.models.VirtualNetworkGatewayNatRule]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-02-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_by_virtual_network_gateway(
        ...
        virtual_network_gateway_name: str,
        **kwargs: Any
    ) -> Iterable["_models.ListVirtualNetworkGatewayNatRulesResult"]:
        ...
        :return: An iterator like instance of either ListVirtualNetworkGatewayNatRulesResult or the
         result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2021_02_01.models.ListVirtualNetworkGatewayNatRulesResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-02-01")  # type: str
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_virtual_network_gateway_request(
                    subscription_id=self._config.subscription_id,
                    resource_group_name=resource_group_name,
                    virtual_network_gateway_name=virtual_network_gateway_name,
                    api_version=api_version,
                    template_url=self.list_by_virtual_network_gateway.metadata['url'],
                )
                request = _convert_request(request)
                request.url = self._client.format_url(request.url)
