...
class P2SVpnServerConfigurationPaged(Paged):
    """
    A paging container for iterating over a list of :class:`P2SVpnServerConfiguration <azure.mgmt.network.v2018_08_01.models.P2SVpnServerConfiguration>` object
    """
