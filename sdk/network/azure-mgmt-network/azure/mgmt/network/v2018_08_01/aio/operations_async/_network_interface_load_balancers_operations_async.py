...
class NetworkInterfaceLoadBalancersOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :return: An iterator like instance of NetworkInterfaceLoadBalancerListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2018_08_01.models.NetworkInterfaceLoadBalancerListResult]
