...
class ExpressRouteCircuitConnectionsOperations:
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2018_08_01.models.ExpressRouteCircuitConnection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_or_update(
     ...
     express route circuit connection operation.
        :type express_route_circuit_connection_parameters: ~azure.mgmt.network.v2018_08_01.models.ExpressRouteCircuitConnection
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
