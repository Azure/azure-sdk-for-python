...
from ...operations._available_delegations_operations import build_list_request
...
class AvailableDelegationsOperations:
    ...
    def list(self, location: str, **kwargs: Any) -> AsyncIterable["_models.AvailableDelegationsResult"]:
        ...
        :return: An iterator like instance of either AvailableDelegationsResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2018_08_01.models.AvailableDelegationsResult]
