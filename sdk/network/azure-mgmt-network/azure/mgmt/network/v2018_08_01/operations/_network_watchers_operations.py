...
class NetworkWatchersOperations(object):
    ...
    def create_or_update(
        ...
        :param parameters: Parameters that define the network watcher
         resource.
        :type parameters:
         ~azure.mgmt.network.v2018_08_01.models.NetworkWatcher
    ...
    def get_topology(
        ...
        :param parameters: Parameters that define the representation of
         topology.
        :type parameters:
         ~azure.mgmt.network.v2018_08_01.models.TopologyParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~azure.mgmt.network.v2018_08_01.models.Topology or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_08_01.models.ErrorResponseException>`
        """
    ...
    def verify_ip_flow(
        ...
        :type parameters:
         ~azure.mgmt.network.v2018_08_01.models.VerificationIPFlowParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_08_01.models.VerificationIPFlowResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_08_01.models.VerificationIPFlowResult]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_08_01.models.ErrorResponseException>`
        """
    ...
    def get_next_hop(
        ...
        :param parameters: Parameters that define the source and destination
         endpoint.
        :type parameters:
         ~azure.mgmt.network.v2018_08_01.models.NextHopParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_08_01.models.NextHopResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_08_01.models.NextHopResult]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_08_01.models.ErrorResponseException>`
        """
    ...
    def get_troubleshooting(
        ...
        :param parameters: Parameters that define the resource to
         troubleshoot.
        :type parameters:
         ~azure.mgmt.network.v2018_08_01.models.TroubleshootingParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
    ...
    def set_flow_log_configuration(
        ...
        :param parameters: Parameters that define the configuration of flow
         log.
        :type parameters:
         ~azure.mgmt.network.v2018_08_01.models.FlowLogInformation
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_08_01.models.FlowLogInformation]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_08_01.models.FlowLogInformation]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_08_01.models.ErrorResponseException>`
        """
    ...
    def check_connectivity(
        ...
        :type parameters:
         ~azure.mgmt.network.v2018_08_01.models.ConnectivityParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_08_01.models.ConnectivityInformation]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_08_01.models.ConnectivityInformation]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_08_01.models.ErrorResponseException>`
        """
    ...
    def get_azure_reachability_report(
        ...
        :param parameters: Parameters that determine Azure reachability report
         configuration.
        :type parameters:
         ~azure.mgmt.network.v2018_08_01.models.AzureReachabilityReportParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_08_01.models.AzureReachabilityReport]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_08_01.models.AzureReachabilityReport]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_08_01.models.ErrorResponseException>`
        """
    ...
    def list_available_providers(
        ...
        :param parameters: Parameters that scope the list of available
         providers.
        :type parameters:
         ~azure.mgmt.network.v2018_08_01.models.AvailableProvidersListParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_08_01.models.AvailableProvidersList]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_08_01.models.AvailableProvidersList]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.network.v2018_08_01.models.ErrorResponseException>`
        """
