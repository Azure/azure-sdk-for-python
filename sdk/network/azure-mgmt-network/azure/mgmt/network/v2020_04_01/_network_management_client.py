...
class NetworkManagementClient(NetworkManagementClientOperationsMixin):
    ...
    :vartype p2_svpn_gateways: azure.mgmt.network.v2020_04_01.operations.P2SVpnGatewaysOperations
    ...
    :vartype virtual_hub_route_table_v2_s: azure.mgmt.network.v2020_04_01.operations.VirtualHubRouteTableV2SOperations
