...
class ExpressRouteCircuitConnectionsOperations:
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}/connections/{connectionName}'}  # type: ignore
    ...
    async def get(
        ...
        connection_name: str,
        **kwargs
    ) -> "models.ExpressRouteCircuitConnection":
        ...
        :rtype: ~azure.mgmt.network.v2020_04_01.models.ExpressRouteCircuitConnection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _create_or_update_initial(
        ...
        peering_name: str,
        connection_name: str,
        express_route_circuit_connection_parameters: "models.ExpressRouteCircuitConnection",
        **kwargs
    ) -> "models.ExpressRouteCircuitConnection":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ExpressRouteCircuitConnection"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
    ...
    async def create_or_update(
     ...
     express route circuit connection operation.
        :type express_route_circuit_connection_parameters: ~azure.mgmt.network.v2020_04_01.models.ExpressRouteCircuitConnection
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}/connections/{connectionName}'}  # type: ignore
    ...
    def list(
        ...
        peering_name: str,
        **kwargs
    ) -> AsyncIterable["models.ExpressRouteCircuitConnectionListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_04_01.models.ExpressRouteCircuitConnectionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
