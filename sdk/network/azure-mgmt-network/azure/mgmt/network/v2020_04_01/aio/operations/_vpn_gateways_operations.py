...
from ...operations._vpn_gateways_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_resource_group_request, build_list_request, build_reset_request_initial, build_update_tags_request
T = TypeVar('T')
...
class VpnGatewaysOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_04_01.models.VpnGateway
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param vpn_gateway_parameters: Parameters supplied to create or Update a virtual wan vpn
         gateway.
        :type vpn_gateway_parameters: ~azure.mgmt.network.v2020_04_01.models.VpnGateway
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either VpnGateway or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_04_01.models.VpnGateway]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :type vpn_gateway_parameters: ~azure.mgmt.network.v2020_04_01.models.TagsObject
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: VpnGateway, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_04_01.models.VpnGateway
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListVpnGatewaysResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_04_01.models.ListVpnGatewaysResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
