...
class VirtualRoutersOperations:
    ...
    async def _create_or_update_initial(
        ...
        resource_group_name: str,
        virtual_router_name: str,
        parameters: "models.VirtualRouter",
        **kwargs
    ) -> "models.VirtualRouter":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VirtualRouter"]
        error_map = {
    ...
    async def begin_create_or_update(
        ...
        parameters: "models.VirtualRouter",
        **kwargs
    ) -> AsyncLROPoller["models.VirtualRouter"]:
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_04_01.models.VirtualRouter]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VirtualRouter"]
    ...
    def list_by_resource_group(
        ...
        resource_group_name: str,
        **kwargs
    ) -> AsyncIterable["models.VirtualRouterListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_04_01.models.VirtualRouterListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
