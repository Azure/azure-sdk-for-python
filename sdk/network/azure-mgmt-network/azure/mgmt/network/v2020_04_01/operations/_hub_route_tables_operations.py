...
def build_create_or_update_request_initial(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualHubs/{virtualHubName}/hubRouteTables/{routeTableName}")  # pylint: disable=line-too-long
...
def build_list_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualHubs/{virtualHubName}/hubRouteTables")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "virtualHubName": _SERIALIZER.url("virtual_hub_name", virtual_hub_name, 'str'),
...
class HubRouteTablesOperations(object):
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(route_table_parameters, 'HubRouteTable')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('HubRouteTable', pipeline_response)
    ...
    _create_or_update_initial.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualHubs/{virtualHubName}/hubRouteTables/{routeTableName}"}  # type: ignore
    ...
    def begin_create_or_update(
        ...
        route_table_parameters: "_models.HubRouteTable",
        **kwargs: Any
    ) -> LROPoller["_models.HubRouteTable"]:
        ...
        :type route_table_parameters: ~azure.mgmt.network.v2020_04_01.models.HubRouteTable
        ...
        :return: An instance of LROPoller that returns either HubRouteTable or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_04_01.models.HubRouteTable]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_04_01.models.HubRouteTable
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.HubRouteTable"]
        error_map = {
    ...
    def list(
        ...
        virtual_hub_name: str,
        **kwargs: Any
    ) -> Iterable["_models.ListHubRouteTablesResult"]:
        ...
        :return: An iterator like instance of either ListHubRouteTablesResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_04_01.models.ListHubRouteTablesResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-04-01")  # type: str
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ListHubRouteTablesResult", pipeline_response)
