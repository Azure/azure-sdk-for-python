...
class VpnSiteLinkConnectionsOperations(object):
    ...
    def get(
            self, resource_group_name, gateway_name, connection_name, link_connection_name, custom_headers=None, raw=False, **operation_config):
        ...
        :return: VpnSiteLinkConnection or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.network.v2020_04_01.models.VpnSiteLinkConnection
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('VpnSiteLinkConnection', response)
