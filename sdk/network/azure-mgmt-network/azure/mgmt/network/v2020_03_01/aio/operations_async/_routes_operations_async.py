...
class RoutesOperations:
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns Route
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_03_01.models.Route]
    ...
    def list(
        ...
        **kwargs
        ...
        :type route_table_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: RouteListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.RouteListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
