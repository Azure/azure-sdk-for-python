...
class NatGatewaysOperations:
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_03_01.models.NatGateway]
    ...
    def list_all(
        self,
        **kwargs
    ) -> "models.NatGatewayListResult":
        """Gets all the Nat Gateways in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NatGatewayListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.NatGatewayListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
