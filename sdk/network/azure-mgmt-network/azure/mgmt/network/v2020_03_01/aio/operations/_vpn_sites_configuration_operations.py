...
from ...operations._vpn_sites_configuration_operations import build_download_request_initial
T = TypeVar('T')
...
class VpnSitesConfigurationOperations:
    ...
    async def begin_download(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        virtual_wan_name: str,
        request: "_models.GetVpnSitesConfigurationRequest",
        **kwargs: Any
        ...
        :type request: ~azure.mgmt.network.v2020_03_01.models.GetVpnSitesConfigurationRequest
