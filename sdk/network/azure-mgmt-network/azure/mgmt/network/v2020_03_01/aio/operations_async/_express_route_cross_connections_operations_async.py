...
class ExpressRouteCrossConnectionsOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :return: ExpressRouteCrossConnectionListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.ExpressRouteCrossConnectionListResult
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCrossConnections/{crossConnectionName}'}
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :type parameters: ~azure.mgmt.network.v2020_03_01.models.ExpressRouteCrossConnection
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns ExpressRouteCrossConnection
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_03_01.models.ExpressRouteCrossConnection]
    ...
    async def _list_arp_table_initial(
        ...
        **kwargs
        ...
        # Construct URL
        url = self._list_arp_table_initial.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'crossConnectionName': self._serialize.url("cross_connection_name", cross_connection_name, 'str'),
        ...
        return deserialized
    _list_arp_table_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCrossConnections/{crossConnectionName}/peerings/{peeringName}/arpTables/{devicePath}'}
    ...
    async def list_arp_table(
        ...
        **kwargs
        ...
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns ExpressRouteCircuitsArpTableListResult
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_03_01.models.ExpressRouteCircuitsArpTableListResult]
    ...
    async def _list_routes_table_summary_initial(
        ...
        **kwargs
        ...
        # Construct URL
        url = self._list_routes_table_summary_initial.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'crossConnectionName': self._serialize.url("cross_connection_name", cross_connection_name, 'str'),
            'peeringName': self._serialize.url("peering_name", peering_name, 'str'),
        ...
        return deserialized
    _list_routes_table_summary_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCrossConnections/{crossConnectionName}/peerings/{peeringName}/routeTablesSummary/{devicePath}'}
    ...
    async def list_routes_table_summary(
        ...
        **kwargs
        ...
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns ExpressRouteCrossConnectionsRoutesTableSummaryListResult
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_03_01.models.ExpressRouteCrossConnectionsRoutesTableSummaryListResult]
    ...
    async def _list_routes_table_initial(
        ...
        **kwargs
        ...
        # Construct URL
        url = self._list_routes_table_initial.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'crossConnectionName': self._serialize.url("cross_connection_name", cross_connection_name, 'str'),
            'peeringName': self._serialize.url("peering_name", peering_name, 'str'),
        ...
        return deserialized
    _list_routes_table_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCrossConnections/{crossConnectionName}/peerings/{peeringName}/routeTables/{devicePath}'}
    ...
    async def list_routes_table(
        ...
        **kwargs
        ...
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns ExpressRouteCircuitsRoutesTableListResult
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_03_01.models.ExpressRouteCircuitsRoutesTableListResult]
