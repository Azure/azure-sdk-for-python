...
class DdosProtectionPlansOperations:
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_03_01.models.DdosProtectionPlan]
    ...
    def list(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DdosProtectionPlanListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.DdosProtectionPlanListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
