...
class LoadBalancerBackendAddressPoolsOperations:
    ...
    def list(
        ...
        **kwargs
    ) -> "models.LoadBalancerBackendAddressPoolListResult":
        ...
        :return: LoadBalancerBackendAddressPoolListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.LoadBalancerBackendAddressPoolListResult
