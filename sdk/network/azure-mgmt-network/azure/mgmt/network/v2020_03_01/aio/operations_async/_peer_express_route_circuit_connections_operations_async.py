...
class PeerExpressRouteCircuitConnectionsOperations:
    ...
    async def get(
        ...
        connection_name: str,
        **kwargs
    ) -> "models.PeerExpressRouteCircuitConnection":
    ...
    def list(
        ...
        peering_name: str,
        **kwargs
    ) -> "models.PeerExpressRouteCircuitConnectionListResult":
        ...
        :type peering_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PeerExpressRouteCircuitConnectionListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.PeerExpressRouteCircuitConnectionListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
