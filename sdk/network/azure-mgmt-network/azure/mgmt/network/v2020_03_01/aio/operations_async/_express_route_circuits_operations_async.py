...
class ExpressRouteCircuitsOperations:
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}'}
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}'}
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns ExpressRouteCircuit
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_03_01.models.ExpressRouteCircuit]
    ...
    async def _list_arp_table_initial(
        ...
        **kwargs
        ...
        return deserialized
    _list_arp_table_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}/arpTables/{devicePath}'}
    ...
    async def _list_routes_table_initial(
        ...
        **kwargs
        ...
        return deserialized
    _list_routes_table_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}/routeTables/{devicePath}'}
    ...
    async def _list_routes_table_summary_initial(
        ...
        **kwargs
        ...
        return deserialized
    _list_routes_table_summary_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}/routeTablesSummary/{devicePath}'}
    ...
    async def list_routes_table_summary(
        ...
        **kwargs
        ...
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns ExpressRouteCircuitsRoutesTableSummaryListResult
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_03_01.models.ExpressRouteCircuitsRoutesTableSummaryListResult]
    ...
    def list(
        ...
        resource_group_name: str,
        **kwargs
    ) -> "models.ExpressRouteCircuitListResult":
        """Gets all the express route circuits in a resource group.

        :param resource_group_name: The name of the resource group.
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ExpressRouteCircuitListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.ExpressRouteCircuitListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
