...
class HubVirtualNetworkConnectionsOperations:
    ...
    def list(
        ...
        virtual_hub_name: str,
        **kwargs
    ) -> "models.ListHubVirtualNetworkConnectionsResult":
        ...
        :type virtual_hub_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ListHubVirtualNetworkConnectionsResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.ListHubVirtualNetworkConnectionsResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
