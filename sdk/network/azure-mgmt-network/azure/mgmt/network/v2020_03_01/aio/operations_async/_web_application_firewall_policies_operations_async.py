...
class WebApplicationFirewallPoliciesOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :return: WebApplicationFirewallPolicyListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.WebApplicationFirewallPolicyListResult
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: WebApplicationFirewallPolicy or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.WebApplicationFirewallPolicy or ~azure.mgmt.network.v2020_03_01.models.WebApplicationFirewallPolicy
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.WebApplicationFirewallPolicy"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/{policyName}'}
