...
class IpAllocationsOperations:
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/IpAllocations/{ipAllocationName}'}
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns IpAllocation
    ...
    def list(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: IpAllocationListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.IpAllocationListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
