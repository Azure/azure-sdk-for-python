...
class VpnServerConfigurationsOperations:
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_03_01.models.VpnServerConfiguration
    ...
    async def create_or_update(
     ...
     VpnServerConfiguration.
        :type vpn_server_configuration_parameters: ~azure.mgmt.network.v2020_03_01.models.VpnServerConfiguration
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnServerConfigurations/{vpnServerConfigurationName}'}  # type: ignore
    ...
    async def update_tags(
        ...
        **kwargs
        ...
        :type vpn_server_configuration_parameters: ~azure.mgmt.network.v2020_03_01.models.TagsObject
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: VpnServerConfiguration, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.VpnServerConfiguration
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def delete(
        ...
        **kwargs
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnServerConfigurations/{vpnServerConfigurationName}'}  # type: ignore
    ...
    def list_by_resource_group(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_03_01.models.ListVpnServerConfigurationsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
