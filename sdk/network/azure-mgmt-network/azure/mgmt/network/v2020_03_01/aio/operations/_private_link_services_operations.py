...
from ...operations._private_link_services_operations import (
    build_check_private_link_service_visibility_by_resource_group_request_initial,
    ...
    build_get_request,
    build_list_auto_approved_private_link_services_by_resource_group_request,
    build_list_auto_approved_private_link_services_request,
    build_list_by_subscription_request,
    build_list_private_endpoint_connections_request,
    build_list_request,
    build_update_private_endpoint_connection_request,
)
...
class PrivateLinkServicesOperations:
    ...
    async def _delete_initial(self, resource_group_name: str, service_name: str, **kwargs: Any) -> None:
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, service_name: str, parameters: "_models.PrivateLinkService", **kwargs: Any
    ) -> "_models.PrivateLinkService":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.PrivateLinkService"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.PrivateLinkServiceListResult"]:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.PrivateLinkServiceListResult"]:
    ...
    async def _check_private_link_service_visibility_initial(
        self, location: str, parameters: "_models.CheckPrivateLinkServiceVisibilityRequest", **kwargs: Any
