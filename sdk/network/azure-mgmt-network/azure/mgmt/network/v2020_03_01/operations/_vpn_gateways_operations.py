...
class VpnGatewaysOperations(object):
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}'}
    ...
    begin_create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}'}
    ...
    def update_tags(
        ...
        **kwargs  # type: Any
        ...
        _vpn_gateway_parameters = models.TagsObject(tags=tags)
        api_version = "2020-03-01"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_vpn_gateway_parameters, 'TagsObject')
        body_content_kwargs['content'] = body_content
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}'}
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ListVpnGatewaysResult"
        """Lists all the VpnGateways in a resource group.

        :param resource_group_name: The resource group name of the VpnGateway.
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ListVpnGatewaysResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.ListVpnGatewaysResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
