...
class FlowLogsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.FlowLogListResult"]
        ...
        :type network_watcher_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of FlowLogListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_03_01.models.FlowLogListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
