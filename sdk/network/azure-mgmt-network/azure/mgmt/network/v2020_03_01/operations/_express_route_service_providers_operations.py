...
class ExpressRouteServiceProvidersOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ExpressRouteServiceProviderListResult"
        """Gets all the available express route service providers.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ExpressRouteServiceProviderListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.ExpressRouteServiceProviderListResult
