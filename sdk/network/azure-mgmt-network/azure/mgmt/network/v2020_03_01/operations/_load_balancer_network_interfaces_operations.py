...
class LoadBalancerNetworkInterfacesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.NetworkInterfaceListResult"
        ...
        :return: NetworkInterfaceListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.NetworkInterfaceListResult
