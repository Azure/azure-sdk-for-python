...
class ApplicationGatewaysOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2020_03_01.models.ApplicationGateway or
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.network.v2020_03_01.models.ApplicationGateway
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_03_01.models.ApplicationGateway]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_03_01.models.ApplicationGateway]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_03_01.models.ApplicationGatewayPaged[~azure.mgmt.network.v2020_03_01.models.ApplicationGateway]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def backend_health(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_03_01.models.ApplicationGatewayBackendHealth]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_03_01.models.ApplicationGatewayBackendHealth]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def _backend_health_on_demand_initial(
            self, resource_group_name, application_gateway_name, probe_request, expand=None, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.backend_health_on_demand.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'applicationGatewayName': self._serialize.url("application_gateway_name", application_gateway_name, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ApplicationGatewayBackendHealthOnDemand', response)
    ...
    def backend_health_on_demand(
            self, resource_group_name, application_gateway_name, probe_request, expand=None, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :type probe_request:
         ~azure.mgmt.network.v2020_03_01.models.ApplicationGatewayOnDemandProbe
        :param expand: Expands BackendAddressPool and BackendHttpSettings
         referenced in backend health.
        :type expand: str
        :param dict custom_headers: headers that will be added to the request
        ...
        :param polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of LROPoller that returns
         ApplicationGatewayBackendHealthOnDemand or
         ClientRawResponse<ApplicationGatewayBackendHealthOnDemand> if
         raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_03_01.models.ApplicationGatewayBackendHealthOnDemand]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_03_01.models.ApplicationGatewayBackendHealthOnDemand]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    backend_health_on_demand.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/getBackendHealthOnDemand'}
    ...
    def list_available_server_variables(
        ...
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2020_03_01.models.ErrorException>`
        """
        # Construct URL
        ...
        return deserialized
    list_available_server_variables.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Network/applicationGatewayAvailableServerVariables'}
    ...
    def list_available_waf_rule_sets(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_03_01.models.ApplicationGatewayAvailableWafRuleSetsResult
    ...
    def list_available_ssl_options(
        ...
        :return: ApplicationGatewayAvailableSslOptions or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.network.v2020_03_01.models.ApplicationGatewayAvailableSslOptions
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list_available_ssl_predefined_policies(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_03_01.models.ApplicationGatewaySslPredefinedPolicyPaged[~azure.mgmt.network.v2020_03_01.models.ApplicationGatewaySslPredefinedPolicy]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
    ...
    def get_ssl_predefined_policy(
        ...
        :return: ApplicationGatewaySslPredefinedPolicy or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.network.v2020_03_01.models.ApplicationGatewaySslPredefinedPolicy
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
