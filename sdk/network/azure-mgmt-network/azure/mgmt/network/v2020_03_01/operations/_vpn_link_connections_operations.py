...
def build_list_by_vpn_connection_request(
    subscription_id: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{connectionName}/vpnLinkConnections")  # pylint: disable=line-too-long
...
class VpnLinkConnectionsOperations(object):
    ...
    def list_by_vpn_connection(
        ...
        connection_name: str,
        **kwargs: Any
    ) -> Iterable["_models.ListVpnSiteLinkConnectionsResult"]:
        ...
        :return: An iterator like instance of either ListVpnSiteLinkConnectionsResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_03_01.models.ListVpnSiteLinkConnectionsResult]
