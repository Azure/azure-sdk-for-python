...
class VpnLinkConnectionsOperations(object):
    ...
    def list_by_vpn_connection(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ListVpnSiteLinkConnectionsResult"
        ...
        :return: ListVpnSiteLinkConnectionsResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.ListVpnSiteLinkConnectionsResult
