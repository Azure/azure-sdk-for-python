...
class ExpressRoutePortsOperations(object):
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/ExpressRoutePorts/{expressRoutePortName}'}
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/ExpressRoutePorts/{expressRoutePortName}'}
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/ExpressRoutePorts/{expressRoutePortName}'}
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ExpressRoutePortListResult"
        """List all the ExpressRoutePort resources in the specified resource group.

        :param resource_group_name: The name of the resource group.
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ExpressRoutePortListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.ExpressRoutePortListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
