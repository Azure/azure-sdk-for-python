...
class ServiceAssociationLinksOperations(object):
    ...
    def list(
        ...
        :return: ServiceAssociationLinksListResult or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.network.v2020_03_01.models.ServiceAssociationLinksListResult
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ServiceAssociationLinksListResult', response)
