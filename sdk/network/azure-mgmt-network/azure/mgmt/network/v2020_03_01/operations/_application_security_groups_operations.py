...
class ApplicationSecurityGroupsOperations(object):
    ...
    begin_delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationSecurityGroups/{applicationSecurityGroupName}'}
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_03_01.models.ApplicationSecurityGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationSecurityGroups/{applicationSecurityGroupName}'}
    ...
    def begin_create_or_update(
     ...
     operation.
        :type parameters: ~azure.mgmt.network.v2020_03_01.models.ApplicationSecurityGroup
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :return: An instance of LROPoller that returns ApplicationSecurityGroup
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_03_01.models.ApplicationSecurityGroup]
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationSecurityGroups/{applicationSecurityGroupName}'}
    ...
    def list_all(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ApplicationSecurityGroupListResult"
        """Gets all application security groups in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ApplicationSecurityGroupListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.ApplicationSecurityGroupListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
