...
class SubnetsOperations(object):
    ...
    def _prepare_network_policies_initial(
        ...
        network_intent_policy_configurations=None,  # type: Optional[List["NetworkIntentPolicyConfiguration"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
    ...
    def begin_prepare_network_policies(
        ...
        **kwargs  # type: Any
        ...
        :type network_intent_policy_configurations: list[~azure.mgmt.network.v2020_03_01.models.NetworkIntentPolicyConfiguration]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
