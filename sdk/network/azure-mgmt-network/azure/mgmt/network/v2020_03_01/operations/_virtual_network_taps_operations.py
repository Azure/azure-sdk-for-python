...
class VirtualNetworkTapsOperations(object):
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.network.v2020_03_01.models.VirtualNetworkTap
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :return: An instance of LROPoller that returns VirtualNetworkTap
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_03_01.models.VirtualNetworkTap]
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkTaps/{tapName}'}
    ...
    def list_all(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.VirtualNetworkTapListResult"
        """Gets all the VirtualNetworkTaps in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: VirtualNetworkTapListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.VirtualNetworkTapListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
