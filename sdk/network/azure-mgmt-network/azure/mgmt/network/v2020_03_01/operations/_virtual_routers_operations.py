...
class VirtualRoutersOperations(object):
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.VirtualRouterListResult"]
        """Lists all Virtual Routers in a resource group.

        :param resource_group_name: The name of the resource group.
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of VirtualRouterListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_03_01.models.VirtualRouterListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
