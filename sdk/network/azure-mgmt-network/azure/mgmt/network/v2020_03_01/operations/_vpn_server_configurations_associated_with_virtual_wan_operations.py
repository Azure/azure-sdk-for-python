...
def build_list_request_initial(
    subscription_id: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{virtualWANName}/vpnServerConfigurations")  # pylint: disable=line-too-long
...
class VpnServerConfigurationsAssociatedWithVirtualWanOperations(object):
    ...
    def begin_list(
        ...
        virtual_wan_name: str,
        **kwargs: Any
    ) -> LROPoller["_models.VpnServerConfigurationsResponse"]:
        ...
        :return: An instance of LROPoller that returns either VpnServerConfigurationsResponse or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_03_01.models.VpnServerConfigurationsResponse]
