...
class VirtualNetworkPeeringsOperations(object):
    ...
    def begin_create_or_update(
     ...
     network peering operation.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_03_01.models.VirtualNetworkPeering]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.VirtualNetworkPeeringListResult"
        ...
        :type virtual_network_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: VirtualNetworkPeeringListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_03_01.models.VirtualNetworkPeeringListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
