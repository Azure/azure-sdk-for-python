...
class NetworkManagementClient(NetworkManagementClientOperationsMixin, SDKClient):
    ...
    :vartype p2s_vpn_gateways: azure.mgmt.network.v2020_03_01.operations.P2sVpnGatewaysOperations
    ...
    :vartype virtual_hub_route_table_v2s: azure.mgmt.network.v2020_03_01.operations.VirtualHubRouteTableV2sOperations
