...
class VirtualNetworkGatewayConnectionsOperations:
    ...
    async def begin_create_or_update(
     ...
     connection operation.
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2015_06_15.models.VirtualNetworkGatewayConnection]
    ...
    connections created.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2015_06_15.models.VirtualNetworkGatewayConnectionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    group through Network resource provider.
     ...
     shared key operation through network resource provider.
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2015_06_15.models.ConnectionResetSharedKey]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
    ...
    group through Network resource provider.
     ...
     Shared key operation throughNetwork resource provider.
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2015_06_15.models.ConnectionSharedKey]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ConnectionSharedKey"]
    ...
    async def get_shared_key(
        ...
        virtual_network_gateway_connection_name: str,
        **kwargs
    ) -> "models.ConnectionSharedKeyResult":
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ConnectionSharedKeyResult"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2015-06-15"
