...
def build_list_arp_table_request(
    resource_group_name,  # type: str
    circuit_name,  # type: str
    subscription_id,  # type: str
    **kwargs  # type: Any
    ...
    accept = "application/json, text/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/arpTable')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'circuitName': _SERIALIZER.url("circuit_name", circuit_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_list_routes_table_request(
    resource_group_name,  # type: str
    circuit_name,  # type: str
    subscription_id,  # type: str
    **kwargs  # type: Any
    ...
    accept = "application/json, text/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/routesTable')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'circuitName': _SERIALIZER.url("circuit_name", circuit_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_arp_table_request(
                    resource_group_name=resource_group_name,
                    circuit_name=circuit_name,
                    subscription_id=self._config.subscription_id,
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_routes_table_request(
                    resource_group_name=resource_group_name,
                    circuit_name=circuit_name,
                    subscription_id=self._config.subscription_id,
        ...
        **kwargs  # type: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_stats_request(
                    resource_group_name=resource_group_name,
                    circuit_name=circuit_name,
                    subscription_id=self._config.subscription_id,
