...
class SingleQueryResultDirection(with_metaclass(CaseInsensitiveEnumMeta, int, Enum)):
...
class SingleQueryResultMode(with_metaclass(CaseInsensitiveEnumMeta, int, Enum)):
...
class SingleQueryResultSeverity(with_metaclass(CaseInsensitiveEnumMeta, int, Enum)):
