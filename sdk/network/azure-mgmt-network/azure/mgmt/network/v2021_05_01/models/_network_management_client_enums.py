...
class OrderByOrder(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class SingleQueryResultDirection(with_metaclass(_CaseInsensitiveEnumMeta, int, Enum)):
...
class SingleQueryResultMode(with_metaclass(_CaseInsensitiveEnumMeta, int, Enum)):
...
class SingleQueryResultSeverity(with_metaclass(_CaseInsensitiveEnumMeta, int, Enum)):
...
class VirtualNetworkEncryptionEnforcement(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
