...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/serviceTagDetails")  # pylint: disable=line-too-long
    ...
    if no_address_prefixes is not None:
        _query_parameters['noAddressPrefixes'] = _SERIALIZER.query("no_address_prefixes", no_address_prefixes, 'bool')
    if tag_name is not None:
        _query_parameters['tagName'] = _SERIALIZER.query("tag_name", tag_name, 'str')
...
class ServiceTagInformationOperations(object):
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :type location: str
        :param no_address_prefixes: Do not return address prefixes for the tag(s). Default value is
         None.
