    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type virtual_hub_route_table_v2_parameters:
         ~azure.mgmt.network.v2021_05_01.models.VirtualHubRouteTableV2
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either VirtualHubRouteTableV2 or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2021_05_01.models.VirtualHubRouteTableV2]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListVirtualHubRouteTableV2SResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2021_05_01.models.ListVirtualHubRouteTableV2SResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
