...
class RoutingIntentOperations(object):
    ...
    def _create_or_update_initial(
        ...
        routing_intent_name,  # type: str
        routing_intent_parameters,  # type: "_models.RoutingIntent"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.RoutingIntent"
        ...
        path_format_arguments = {
            ...
            'routingIntentName': self._serialize.url("routing_intent_name", routing_intent_name, 'str'),
        }
        ...
        body_content = self._serialize.body(routing_intent_parameters, 'RoutingIntent')
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.RoutingIntent"]
        ...
        :return: An instance of LROPoller that returns either RoutingIntent or the result of cls(response)
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ListRoutingIntentResult"]
        ...
        :type virtual_hub_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ListRoutingIntentResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2021_05_01.models.ListRoutingIntentResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
