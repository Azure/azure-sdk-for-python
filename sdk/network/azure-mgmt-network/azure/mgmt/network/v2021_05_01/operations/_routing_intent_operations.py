...
def build_create_or_update_request_initial(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualHubs/{virtualHubName}/routingIntent/{routingIntentName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "virtualHubName": _SERIALIZER.url("virtual_hub_name", virtual_hub_name, 'str'),
        "routingIntentName": _SERIALIZER.url("routing_intent_name", routing_intent_name, 'str'),
    }
...
def build_list_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualHubs/{virtualHubName}/routingIntent")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "virtualHubName": _SERIALIZER.url("virtual_hub_name", virtual_hub_name, 'str'),
...
class RoutingIntentOperations(object):
    ...
    def _create_or_update_initial(
        ...
        virtual_hub_name: str,
        routing_intent_name: str,
        routing_intent_parameters: "_models.RoutingIntent",
        **kwargs: Any
        ...
        _json = self._serialize.body(routing_intent_parameters, 'RoutingIntent')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('RoutingIntent', pipeline_response)
    ...
    _create_or_update_initial.metadata = {'url': "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualHubs/{virtualHubName}/routingIntent/{routingIntentName}"}  # type: ignore
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either RoutingIntent or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2021_05_01.models.RoutingIntent]
        ...
        if cont_token is None:
            raw_result = self._create_or_update_initial(
                ...
                virtual_hub_name=virtual_hub_name,
                routing_intent_name=routing_intent_name,
                routing_intent_parameters=routing_intent_parameters,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x,y,z: x,
                **kwargs
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2021_05_01.models.RoutingIntent
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.RoutingIntent"]
        error_map = {
    ...
    def list(
        ...
        virtual_hub_name: str,
        **kwargs: Any
    ) -> Iterable["_models.ListRoutingIntentResult"]:
        ...
        :return: An iterator like instance of either ListRoutingIntentResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2021_05_01.models.ListRoutingIntentResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-05-01")  # type: str

        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ListRoutingIntentResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ListRoutingIntentResult", pipeline_response)
