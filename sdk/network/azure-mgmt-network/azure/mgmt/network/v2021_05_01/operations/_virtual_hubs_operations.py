...
class VirtualHubsOperations(object):
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2021_05_01.models.ListVirtualHubsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_get_effective_virtual_hub_routes(
        ...
        **kwargs  # type: Any
        ...
        :param effective_routes_parameters: Parameters supplied to get the effective routes for a
         specific resource.
        :type effective_routes_parameters: ~azure.mgmt.network.v2021_05_01.models.EffectiveRoutesParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
