...
from ...operations._routing_intent_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class RoutingIntentOperations:
    """RoutingIntentOperations async operations.
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either RoutingIntent or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_05_01.models.RoutingIntent]
    ...
    def list(
        ...
        virtual_hub_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.ListRoutingIntentResult"]:
        ...
        :return: An iterator like instance of either ListRoutingIntentResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_05_01.models.ListRoutingIntentResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-05-01")  # type: str
