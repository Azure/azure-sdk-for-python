...
class VpnGatewaysOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2021_05_01.models.VpnGateway
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param vpn_gateway_parameters: Parameters supplied to create or Update a virtual wan vpn
         gateway.
        :type vpn_gateway_parameters: ~azure.mgmt.network.v2021_05_01.models.VpnGateway
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_05_01.models.VpnGateway]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :type vpn_gateway_parameters: ~azure.mgmt.network.v2021_05_01.models.TagsObject
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
    ...
    async def begin_start_packet_capture(
        ...
        **kwargs: Any
        ...
        :param parameters: Vpn gateway packet capture parameters supplied to start packet capture on
         vpn gateway.
        :type parameters: ~azure.mgmt.network.v2021_05_01.models.VpnGatewayPacketCaptureStartParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
    ...
    async def begin_stop_packet_capture(
        ...
        **kwargs: Any
        ...
        :param parameters: Vpn gateway packet capture parameters supplied to stop packet capture on vpn
         gateway.
        :type parameters: ~azure.mgmt.network.v2021_05_01.models.VpnGatewayPacketCaptureStopParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_05_01.models.ListVpnGatewaysResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
