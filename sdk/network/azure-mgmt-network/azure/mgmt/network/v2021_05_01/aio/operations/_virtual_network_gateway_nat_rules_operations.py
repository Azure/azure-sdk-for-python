...
from ...operations._virtual_network_gateway_nat_rules_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_virtual_network_gateway_request
T = TypeVar('T')
...
class VirtualNetworkGatewayNatRulesOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2021_05_01.models.VirtualNetworkGatewayNatRule
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type nat_rule_parameters: ~azure.mgmt.network.v2021_05_01.models.VirtualNetworkGatewayNatRule
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_05_01.models.VirtualNetworkGatewayNatRule]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_by_virtual_network_gateway(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListVirtualNetworkGatewayNatRulesResult or the
         result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_05_01.models.ListVirtualNetworkGatewayNatRulesResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
