...
class NatRulesOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2021_05_01.models.VpnGatewayNatRule
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type nat_rule_parameters: ~azure.mgmt.network.v2021_05_01.models.VpnGatewayNatRule
        :keyword api_version: Api Version. Default value is "2021-05-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either VpnGatewayNatRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_05_01.models.VpnGatewayNatRule]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-05-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_by_vpn_gateway(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListVpnGatewayNatRulesResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_05_01.models.ListVpnGatewayNatRulesResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-05-01")  # type: str
