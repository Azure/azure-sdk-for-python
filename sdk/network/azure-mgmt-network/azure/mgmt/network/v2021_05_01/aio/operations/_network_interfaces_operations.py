...
from ...operations._network_interfaces_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_cloud_service_network_interface_request, build_get_effective_route_table_request_initial, build_get_request, build_get_virtual_machine_scale_set_ip_configuration_request, build_get_virtual_machine_scale_set_network_interface_request, build_list_all_request, build_list_cloud_service_network_interfaces_request, build_list_cloud_service_role_instance_network_interfaces_request, build_list_effective_network_security_groups_request_initial, build_list_request, build_list_virtual_machine_scale_set_ip_configurations_request, build_list_virtual_machine_scale_set_network_interfaces_request, build_list_virtual_machine_scale_set_vm_network_interfaces_request, build_update_tags_request
T = TypeVar('T')
...
class NetworkInterfacesOperations:
    ...
    def list_cloud_service_role_instance_network_interfaces(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either NetworkInterfaceListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_05_01.models.NetworkInterfaceListResult]
    ...
    async def get_cloud_service_network_interface(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2021_05_01.models.NetworkInterface
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2021_05_01.models.NetworkInterface
        :keyword api_version: Api Version. Default value is "2021-05-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either NetworkInterface or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_05_01.models.NetworkInterface]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-05-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    async def begin_get_effective_route_table(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_05_01.models.EffectiveRouteListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-05-01")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def begin_list_effective_network_security_groups(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_05_01.models.EffectiveNetworkSecurityGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-05-01")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
