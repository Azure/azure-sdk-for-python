...
from ...operations._vpn_connections_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_vpn_gateway_request, build_start_packet_capture_request_initial, build_stop_packet_capture_request_initial
T = TypeVar('T')
...
class VpnConnectionsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2021_05_01.models.VpnConnection
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type vpn_connection_parameters: ~azure.mgmt.network.v2021_05_01.models.VpnConnection
        :keyword api_version: Api Version. Default value is "2021-05-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either VpnConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_05_01.models.VpnConnection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-05-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    async def begin_start_packet_capture(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.network.v2021_05_01.models.VpnConnectionPacketCaptureStartParameters
        :keyword api_version: Api Version. Default value is "2021-05-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_stop_packet_capture(
        ...
        **kwargs: Any
        ...
        :param parameters: Vpn Connection packet capture parameters supplied to stop packet capture on
         gateway connection. Default value is None.
        :type parameters:
         ~azure.mgmt.network.v2021_05_01.models.VpnConnectionPacketCaptureStopParameters
        :keyword api_version: Api Version. Default value is "2021-05-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_vpn_gateway(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListVpnConnectionsResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_05_01.models.ListVpnConnectionsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-05-01")  # type: str
