...
class VirtualHubBgpConnectionsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_05_01.models.ListVirtualHubBgpConnectionResults]
    ...
    async def begin_list_learned_routes(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_05_01.models.PeerRouteList]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
