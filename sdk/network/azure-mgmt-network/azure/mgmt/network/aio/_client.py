...
class NetworkManagementClient(
    ...
    :vartype vmss_network_interfaces:
     azure.mgmt.network.aio.operations.VmssNetworkInterfacesOperations
    :ivar vmss_public_ip_addresses: VmssPublicIPAddressesOperations operations
    :vartype vmss_public_ip_addresses:
     azure.mgmt.network.aio.operations.VmssPublicIPAddressesOperations
