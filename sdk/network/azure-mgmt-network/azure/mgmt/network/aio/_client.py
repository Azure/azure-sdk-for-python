...
class NetworkManagementClient(NetworkManagementClientOperationsMixin, MultiApiClientMixin, _SDKClient):
    ...
    @property
    @api_version_validation(
        api_versions=['2019-12-01', '2020-03-01', '2020-04-01', '2020-05-01', '2020-06-01', '2020-07-01', '2020-08-01', '2020-11-01', '2021-02-01', '2022-11-01']
    )
    ...
    @property
    @api_version_validation(
        api_versions=['2020-03-01', '2020-04-01', '2020-05-01', '2020-06-01', '2020-07-01', '2020-08-01', '2020-11-01', '2021-02-01', '2022-11-01']
    )
    ...
    @property
    @api_version_validation(
        api_versions=['2021-02-01-preview', '2022-11-01']
    )
