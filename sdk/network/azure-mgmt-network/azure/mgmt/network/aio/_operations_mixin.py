...
class NetworkManagementClientOperationsMixin(object):
    ...
    async def begin_delete_bastion_shareable_link(
        ...
        **kwargs: Any
        ...
        :type bsl_request: ~azure.mgmt.network.v2022_09_01.models.BastionShareableLinkListRequest or IO
        ...
        if api_version == '2019-09-01':
            ...
            from ..v2022_09_01.aio.operations import NetworkManagementClientOperationsMixin as OperationClass
        else:
    ...
    async def begin_generatevirtualwanvpnserverconfigurationvpnprofile(
        ...
        **kwargs: Any
        ...
        :type vpn_client_params: ~azure.mgmt.network.v2022_09_01.models.VirtualWanVpnProfileParameters
         or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        ...
        :return: An instance of AsyncLROPoller that returns either VpnProfileResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2022_09_01.models.VpnProfileResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_get_active_sessions(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2022_09_01.models.BastionActiveSession]]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_put_bastion_shareable_link(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2022_09_01.models.BastionShareableLink]]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def disconnect_active_sessions(
        ...
        **kwargs: Any
        ...
        :param session_ids: The list of sessionids to disconnect. Is either a SessionIds type or a IO
         type. Required.
        :type session_ids: ~azure.mgmt.network.v2022_09_01.models.SessionIds or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2022_09_01.models.BastionSessionState]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def express_route_provider_port(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2022_09_01.models.ExpressRouteProviderPort
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_bastion_shareable_link(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either BastionShareableLink or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2022_09_01.models.BastionShareableLink]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def list_active_connectivity_configurations(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2022_09_01.models.ActiveConnectivityConfigurationsListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def list_active_security_admin_rules(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2022_09_01.models.ActiveSecurityAdminRulesListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def list_network_manager_effective_connectivity_configurations(
        ...
        **kwargs: Any
        ...
        :return: NetworkManagerEffectiveConnectivityConfigurationListResult or the result of
         cls(response)
        :rtype:
         ~azure.mgmt.network.v2022_09_01.models.NetworkManagerEffectiveConnectivityConfigurationListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def list_network_manager_effective_security_admin_rules(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.mgmt.network.v2022_09_01.models.NetworkManagerEffectiveSecurityAdminRulesListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def supported_security_providers(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2022_09_01.models.VirtualWanSecurityProviders
        :raises ~azure.core.exceptions.HttpResponseError:
        """
