...
class NetworkManagementClientOperationsMixin(object):
    async def begin_delete_bastion_shareable_link(
        ...
        **kwargs: Any
        ...
        if api_version == "2019-09-01":
            ...
            raise ValueError(
                "API version {} does not have operation 'begin_delete_bastion_shareable_link'".format(api_version)
            )
        ...
        return await mixin_instance.begin_delete_bastion_shareable_link(
    ...
    async def begin_generatevirtualwanvpnserverconfigurationvpnprofile(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either VpnProfileResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2021_02_01.models.VpnProfileResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        if api_version == "2019-08-01":
            ...
            raise ValueError(
                "API version {} does not have operation 'begin_generatevirtualwanvpnserverconfigurationvpnprofile'".format(
                    api_version
                )
            )
        mixin_instance = OperationClass()
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.begin_generatevirtualwanvpnserverconfigurationvpnprofile(
    ...
    async def begin_get_active_sessions(
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.BastionActiveSessionListResult]]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_put_bastion_shareable_link(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.BastionShareableLinkListResult]]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        if api_version == "2019-09-01":
            ...
            raise ValueError(
                "API version {} does not have operation 'begin_put_bastion_shareable_link'".format(api_version)
            )
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.begin_put_bastion_shareable_link(
            resource_group_name, bastion_host_name, bsl_request, **kwargs
        )
    ...
    def disconnect_active_sessions(
        ...
        :return: An iterator like instance of either BastionSessionDeleteResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.BastionSessionDeleteResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_bastion_shareable_link(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either BastionShareableLinkListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_02_01.models.BastionShareableLinkListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def supported_security_providers(
        ...
        if api_version == "2018-08-01":
            ...
            raise ValueError(
                "API version {} does not have operation 'supported_security_providers'".format(api_version)
            )
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
