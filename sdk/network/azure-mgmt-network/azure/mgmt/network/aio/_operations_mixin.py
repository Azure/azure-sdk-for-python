...
class NetworkManagementClientOperationsMixin(object):
    ...
    async def begin_delete_bastion_shareable_link(
        ...
        **kwargs: Any
        ...
        :type bsl_request: ~azure.mgmt.network.v2024_03_01.models.BastionShareableLinkListRequest or
         IO[bytes]
        ...
        if api_version == '2019-09-01':
            ...
            from ..v2023_02_01.aio.operations import NetworkManagementClientOperationsMixin as OperationClass
        elif api_version == '2023-04-01':
            from ..v2023_04_01.aio.operations import NetworkManagementClientOperationsMixin as OperationClass
        elif api_version == '2023-05-01':
            from ..v2023_05_01.aio.operations import NetworkManagementClientOperationsMixin as OperationClass
        elif api_version == '2023-06-01':
            from ..v2023_06_01.aio.operations import NetworkManagementClientOperationsMixin as OperationClass
        elif api_version == '2023-09-01':
            from ..v2023_09_01.aio.operations import NetworkManagementClientOperationsMixin as OperationClass
        elif api_version == '2023-11-01':
            from ..v2023_11_01.aio.operations import NetworkManagementClientOperationsMixin as OperationClass
        elif api_version == '2024-01-01':
            from ..v2024_01_01.aio.operations import NetworkManagementClientOperationsMixin as OperationClass
        elif api_version == '2024-03-01':
            from ..v2024_03_01.aio.operations import NetworkManagementClientOperationsMixin as OperationClass
        else:
    ...
    async def begin_delete_bastion_shareable_link_by_token(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :type bsl_token_request:
         ~azure.mgmt.network.v2024_03_01.models.BastionShareableLinkTokenListRequest or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        api_version = self._get_api_version('begin_delete_bastion_shareable_link_by_token')
        if api_version == '2023-06-01':
            ...
            raise ValueError("API version {} does not have operation 'begin_delete_bastion_shareable_link_by_token'".format(api_version))
        mixin_instance = OperationClass()
        mixin_instance._client = self._client
        mixin_instance._config = self._config
        mixin_instance._config.api_version = api_version
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.begin_delete_bastion_shareable_link_by_token(resource_group_name, bastion_host_name, bsl_token_request, **kwargs)
    ...
    async def begin_generatevirtualwanvpnserverconfigurationvpnprofile(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :type vpn_client_params: ~azure.mgmt.network.v2024_03_01.models.VirtualWanVpnProfileParameters
         or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either VpnProfileResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2024_03_01.models.VpnProfileResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_get_active_sessions(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2024_03_01.models.BastionActiveSession]]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.begin_get_active_sessions(resource_group_name, bastion_host_name, **kwargs)
    ...
    async def begin_put_bastion_shareable_link(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2024_03_01.models.BastionShareableLink]]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.begin_put_bastion_shareable_link(resource_group_name, bastion_host_name, bsl_request, **kwargs)
    ...
    async def check_dns_name_availability(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2024_03_01.models.DnsNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.check_dns_name_availability(location, domain_name_label=domain_name_label, **kwargs)
    ...
    def disconnect_active_sessions(
        ...
        **kwargs: Any
        ...
        :type session_ids: ~azure.mgmt.network.v2024_03_01.models.SessionIds or IO[bytes]
        :return: An iterator like instance of either BastionSessionState or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2024_03_01.models.BastionSessionState]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def express_route_provider_port(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2024_03_01.models.ExpressRouteProviderPort
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.express_route_provider_port(providerport, **kwargs)
    ...
    def get_bastion_shareable_link(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either BastionShareableLink or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2024_03_01.models.BastionShareableLink]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def list_active_connectivity_configurations(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2024_03_01.models.ActiveConfigurationParameter or
         IO[bytes]
        ...
        :rtype: ~azure.mgmt.network.v2024_03_01.models.ActiveConnectivityConfigurationsListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.list_active_connectivity_configurations(resource_group_name, network_manager_name, parameters, top=top, **kwargs)
    ...
    async def list_active_security_admin_rules(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2024_03_01.models.ActiveSecurityAdminRulesListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.list_active_security_admin_rules(resource_group_name, network_manager_name, parameters, top=top, **kwargs)
    ...
    async def list_network_manager_effective_connectivity_configurations(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to list correct page. Is either a QueryRequestOptions
         type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.network.v2024_03_01.models.QueryRequestOptions or IO[bytes]
        :keyword top: An optional query parameter which specifies the maximum number of records to be
         returned by the server. Default value is None.
        :paramtype top: int
        :return: NetworkManagerEffectiveConnectivityConfigurationListResult or the result of
         cls(response)
        :rtype:
         ~azure.mgmt.network.v2024_03_01.models.NetworkManagerEffectiveConnectivityConfigurationListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.list_network_manager_effective_connectivity_configurations(resource_group_name, virtual_network_name, parameters, top=top, **kwargs)
    ...
    async def list_network_manager_effective_security_admin_rules(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.mgmt.network.v2024_03_01.models.NetworkManagerEffectiveSecurityAdminRulesListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.list_network_manager_effective_security_admin_rules(resource_group_name, virtual_network_name, parameters, top=top, **kwargs)
    ...
    async def supported_security_providers(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2024_03_01.models.VirtualWanSecurityProviders
        :raises ~azure.core.exceptions.HttpResponseError:
        """
