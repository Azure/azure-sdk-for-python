...
class RoutesOperations(object):
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeTables/{routeTableName}/routes/{routeName}'}
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2017_08_01.models.Route or
    ...
    def create_or_update(
        ...
        :param route_parameters: Parameters supplied to the create or update
         route operation.
        :type route_parameters: ~azure.mgmt.network.v2017_08_01.models.Route
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2017_08_01.models.Route]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_08_01.models.Route]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeTables/{routeTableName}/routes/{routeName}'}
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2017_08_01.models.RoutePaged[~azure.mgmt.network.v2017_08_01.models.Route]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
