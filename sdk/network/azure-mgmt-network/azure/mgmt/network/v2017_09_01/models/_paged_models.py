...
class ApplicationGatewayPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ApplicationGateway <azure.mgmt.network.v2017_09_01.models.ApplicationGateway>` object
    """
...
class ApplicationGatewaySslPredefinedPolicyPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ApplicationGatewaySslPredefinedPolicy <azure.mgmt.network.v2017_09_01.models.ApplicationGatewaySslPredefinedPolicy>` object
    """
...
class ExpressRouteServiceProviderPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ExpressRouteServiceProvider <azure.mgmt.network.v2017_09_01.models.ExpressRouteServiceProvider>` object
    """
...
class LoadBalancerPaged(Paged):
    """
    A paging container for iterating over a list of :class:`LoadBalancer <azure.mgmt.network.v2017_09_01.models.LoadBalancer>` object
    """
...
class BackendAddressPoolPaged(Paged):
    """
    A paging container for iterating over a list of :class:`BackendAddressPool <azure.mgmt.network.v2017_09_01.models.BackendAddressPool>` object
    """
...
class FrontendIPConfigurationPaged(Paged):
    """
    A paging container for iterating over a list of :class:`FrontendIPConfiguration <azure.mgmt.network.v2017_09_01.models.FrontendIPConfiguration>` object
    """
...
class InboundNatRulePaged(Paged):
    """
    A paging container for iterating over a list of :class:`InboundNatRule <azure.mgmt.network.v2017_09_01.models.InboundNatRule>` object
    """
...
class LoadBalancingRulePaged(Paged):
    """
    A paging container for iterating over a list of :class:`LoadBalancingRule <azure.mgmt.network.v2017_09_01.models.LoadBalancingRule>` object
    """
...
class NetworkInterfacePaged(Paged):
    """
    A paging container for iterating over a list of :class:`NetworkInterface <azure.mgmt.network.v2017_09_01.models.NetworkInterface>` object
    """
...
class NetworkWatcherPaged(Paged):
    """
    A paging container for iterating over a list of :class:`NetworkWatcher <azure.mgmt.network.v2017_09_01.models.NetworkWatcher>` object
    """
...
class PacketCaptureResultPaged(Paged):
    """
    A paging container for iterating over a list of :class:`PacketCaptureResult <azure.mgmt.network.v2017_09_01.models.PacketCaptureResult>` object
    """
...
class OperationPaged(Paged):
    """
    A paging container for iterating over a list of :class:`Operation <azure.mgmt.network.v2017_09_01.models.Operation>` object
    """
...
class PublicIPAddressPaged(Paged):
    """
    A paging container for iterating over a list of :class:`PublicIPAddress <azure.mgmt.network.v2017_09_01.models.PublicIPAddress>` object
    """
...
class RouteFilterPaged(Paged):
    """
    A paging container for iterating over a list of :class:`RouteFilter <azure.mgmt.network.v2017_09_01.models.RouteFilter>` object
    """
...
class RouteFilterRulePaged(Paged):
    """
    A paging container for iterating over a list of :class:`RouteFilterRule <azure.mgmt.network.v2017_09_01.models.RouteFilterRule>` object
    """
...
class RouteTablePaged(Paged):
    """
    A paging container for iterating over a list of :class:`RouteTable <azure.mgmt.network.v2017_09_01.models.RouteTable>` object
    """
...
class RoutePaged(Paged):
    """
    A paging container for iterating over a list of :class:`Route <azure.mgmt.network.v2017_09_01.models.Route>` object
    """
...
class BgpServiceCommunityPaged(Paged):
    """
    A paging container for iterating over a list of :class:`BgpServiceCommunity <azure.mgmt.network.v2017_09_01.models.BgpServiceCommunity>` object
    """
...
class UsagePaged(Paged):
    """
    A paging container for iterating over a list of :class:`Usage <azure.mgmt.network.v2017_09_01.models.Usage>` object
    """
...
class VirtualNetworkPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualNetwork <azure.mgmt.network.v2017_09_01.models.VirtualNetwork>` object
    """
...
class SubnetPaged(Paged):
    """
    A paging container for iterating over a list of :class:`Subnet <azure.mgmt.network.v2017_09_01.models.Subnet>` object
    """
...
class VirtualNetworkGatewayConnectionListEntityPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualNetworkGatewayConnectionListEntity <azure.mgmt.network.v2017_09_01.models.VirtualNetworkGatewayConnectionListEntity>` object
    """
...
class VirtualNetworkGatewayConnectionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualNetworkGatewayConnection <azure.mgmt.network.v2017_09_01.models.VirtualNetworkGatewayConnection>` object
    """
