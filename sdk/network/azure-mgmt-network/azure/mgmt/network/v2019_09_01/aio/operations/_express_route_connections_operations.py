...
from ...operations._express_route_connections_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_request
T = TypeVar('T')
...
class ExpressRouteConnectionsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type put_express_route_connection_parameters:
         ~azure.mgmt.network.v2019_09_01.models.ExpressRouteConnection
        ...
        :return: An instance of AsyncLROPoller that returns either ExpressRouteConnection or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2019_09_01.models.ExpressRouteConnection]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2019_09_01.models.ExpressRouteConnection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ExpressRouteConnection"]
        error_map = {
    ...
    async def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2019_09_01.models.ExpressRouteConnectionList
        :raises: ~azure.core.exceptions.HttpResponseError
        """
