...
from ...operations._virtual_network_taps_operations import (
...
class VirtualNetworkTapsOperations:
    ...
    async def _delete_initial(self, resource_group_name: str, tap_name: str, **kwargs: Any) -> None:
    ...
    async def get(self, resource_group_name: str, tap_name: str, **kwargs: Any) -> "_models.VirtualNetworkTap":
        ...
        :rtype: ~azure.mgmt.network.v2019_09_01.models.VirtualNetworkTap
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, tap_name: str, parameters: "_models.VirtualNetworkTap", **kwargs: Any
    ...
    async def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.network.v2019_09_01.models.VirtualNetworkTap
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
        ...
        :return: An instance of AsyncLROPoller that returns either VirtualNetworkTap or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2019_09_01.models.VirtualNetworkTap]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def update_tags(
        self, resource_group_name: str, tap_name: str, tap_parameters: "_models.TagsObject", **kwargs: Any
    ) -> "_models.VirtualNetworkTap":
        ...
        :type tap_parameters: ~azure.mgmt.network.v2019_09_01.models.TagsObject
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: VirtualNetworkTap, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_09_01.models.VirtualNetworkTap
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.VirtualNetworkTapListResult"]:
        ...
        :return: An iterator like instance of either VirtualNetworkTapListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_09_01.models.VirtualNetworkTapListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
