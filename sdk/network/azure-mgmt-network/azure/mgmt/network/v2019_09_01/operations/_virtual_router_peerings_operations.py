...
class VirtualRouterPeeringsOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2019_09_01.models.VirtualRouterPeering or
    ...
    def update(
        ...
        :param virtual_router_name: The name of the Virtual Router.
        :type virtual_router_name: str
        :param peering_name: The name of the Virtual Router Peering being
         updated.
        :type peering_name: str
        :param parameters: Parameters supplied to update Virtual Router
         Peering operation.
        :type parameters:
         ~azure.mgmt.network.v2019_09_01.models.VirtualRouterPeering
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        return deserialized
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualRouters/{virtualRouterName}/peerings/{peeringName}'}
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2019_09_01.models.VirtualRouterPeering]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2019_09_01.models.VirtualRouterPeering]]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2019_09_01.models.ErrorException>`
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_09_01.models.VirtualRouterPeeringPaged[~azure.mgmt.network.v2019_09_01.models.VirtualRouterPeering]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2019_09_01.models.ErrorException>`
        """
