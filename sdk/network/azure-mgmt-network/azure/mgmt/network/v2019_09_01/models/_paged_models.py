...
class BastionShareableLinkPaged(Paged):
    """
    A paging container for iterating over a list of :class:`BastionShareableLink <azure.mgmt.network.v2019_09_01.models.BastionShareableLink>` object
    """
...
class BastionSessionStatePaged(Paged):
    """
    A paging container for iterating over a list of :class:`BastionSessionState <azure.mgmt.network.v2019_09_01.models.BastionSessionState>` object
    """
