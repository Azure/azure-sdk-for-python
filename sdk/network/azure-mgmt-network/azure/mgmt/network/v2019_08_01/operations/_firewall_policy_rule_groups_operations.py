    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either FirewallPolicyRuleGroup or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_08_01.models.FirewallPolicyRuleGroup]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
        polling = kwargs.pop('polling', True)  # type: Union[bool, azure.core.polling.PollingMethod]
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either FirewallPolicyRuleGroupListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2019_08_01.models.FirewallPolicyRuleGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
