...
class FirewallPolicyRuleGroupsOperations:
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/firewallPolicies/{firewallPolicyName}/ruleGroups/{ruleGroupName}'}  # type: ignore
    ...
    async def get(
        ...
        rule_group_name: str,
        **kwargs
    ) -> "models.FirewallPolicyRuleGroup":
        ...
        :rtype: ~azure.mgmt.network.v2019_08_01.models.FirewallPolicyRuleGroup
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FirewallPolicyRuleGroup"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2019-08-01"
    ...
    async def _create_or_update_initial(
        ...
        firewall_policy_name: str,
        rule_group_name: str,
        parameters: "models.FirewallPolicyRuleGroup",
        **kwargs
    ) -> "models.FirewallPolicyRuleGroup":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FirewallPolicyRuleGroup"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
    ...
    async def create_or_update(
     ...
     operation.
        :type parameters: ~azure.mgmt.network.v2019_08_01.models.FirewallPolicyRuleGroup
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/firewallPolicies/{firewallPolicyName}/ruleGroups/{ruleGroupName}'}  # type: ignore
    ...
    def list(
        ...
        firewall_policy_name: str,
        **kwargs
    ) -> AsyncIterable["models.FirewallPolicyRuleGroupListResult"]:
        ...
        :type firewall_policy_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of FirewallPolicyRuleGroupListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_08_01.models.FirewallPolicyRuleGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FirewallPolicyRuleGroupListResult"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2019-08-01"
