...
class NatGatewaysOperations:
    ...
    async def begin_create_or_update(
        ...
        :return: An instance of AsyncLROPoller that returns either NatGateway or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2019_08_01.models.NatGateway]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.NatGatewayListResult"]:
        ...
        :return: An iterator like instance of either NatGatewayListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_08_01.models.NatGatewayListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
