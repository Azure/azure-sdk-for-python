...
class LoadBalancerOutboundRulesOperations:
    ...
    def list(
        ...
        **kwargs
    ) -> AsyncIterable["models.LoadBalancerOutboundRuleListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_08_01.models.LoadBalancerOutboundRuleListResult]
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_08_01.models.OutboundRule
        :raises: ~azure.core.exceptions.HttpResponseError
        """
