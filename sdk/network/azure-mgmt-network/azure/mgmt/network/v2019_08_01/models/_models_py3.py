...
class ApplicationGatewayHttpListener(SubResource):
    ...
    def __init__(self, *, id: str=None, frontend_ip_configuration=None, frontend_port=None, protocol=None, host_name: str=None, ssl_certificate=None, require_server_name_indication: bool=None, provisioning_state=None, custom_error_configurations=None, name: str=None, etag: str=None, type: str=None, **kwargs) -> None:
...
class ApplicationGatewayPathRule(SubResource):
    ...
    def __init__(self, *, id: str=None, paths=None, backend_address_pool=None, backend_http_settings=None, redirect_configuration=None, rewrite_rule_set=None, provisioning_state=None, name: str=None, etag: str=None, type: str=None, **kwargs) -> None:
...
class P2SVpnGateway(Resource):
    ...
    def __init__(self, *, id: str=None, location: str=None, tags=None, virtual_hub=None, p2_sconnection_configurations=None, provisioning_state=None, vpn_gateway_scale_unit: int=None, vpn_server_configuration=None, **kwargs) -> None:
...
class VirtualWAN(Resource):
    ...
    def __init__(self, *, id: str=None, location: str=None, tags=None, disable_vpn_encryption: bool=None, allow_branch_to_branch_traffic: bool=None, allow_vnet_to_vnet_traffic: bool=None, office365_local_breakout_category=None, provisioning_state=None, **kwargs) -> None:
