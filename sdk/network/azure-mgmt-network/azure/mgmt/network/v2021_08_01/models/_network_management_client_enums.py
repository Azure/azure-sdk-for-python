...
class ApplicationGatewayLoadDistributionAlgorithm(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ExpressRoutePortAuthorizationUseStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """The authorization use status.
    """
...
class FirewallPolicyIDPSQuerySortOrder(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class FirewallPolicyIDPSSignatureDirection(with_metaclass(CaseInsensitiveEnumMeta, int, Enum)):
...
class FirewallPolicyIDPSSignatureMode(with_metaclass(CaseInsensitiveEnumMeta, int, Enum)):
...
class FirewallPolicyIDPSSignatureSeverity(with_metaclass(CaseInsensitiveEnumMeta, int, Enum)):
...
class HubRoutingPreference(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class LoadBalancerBackendAddressAdminState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class NetworkInterfaceAuxiliaryMode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class VirtualNetworkEncryptionEnforcement(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class VpnPolicyMemberAttributeType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
