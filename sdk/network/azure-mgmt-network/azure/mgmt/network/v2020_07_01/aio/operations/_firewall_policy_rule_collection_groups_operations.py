...
from ...operations._firewall_policy_rule_collection_groups_operations import (
...
class FirewallPolicyRuleCollectionGroupsOperations:
    ...
    async def _delete_initial(
        self, resource_group_name: str, firewall_policy_name: str, rule_collection_group_name: str, **kwargs: Any
    ) -> None:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(parameters, "FirewallPolicyRuleCollectionGroup")
