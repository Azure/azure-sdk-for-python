...
from ...operations._virtual_wans_operations import (
...
class VirtualWansOperations:
    ...
    async def get(self, resource_group_name: str, virtual_wan_name: str, **kwargs: Any) -> "_models.VirtualWAN":
        ...
        :rtype: ~azure.mgmt.network.v2020_07_01.models.VirtualWAN
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, virtual_wan_name: str, wan_parameters: "_models.VirtualWAN", **kwargs: Any
    ) -> "_models.VirtualWAN":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.VirtualWAN"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        ...
        json = self._serialize.body(wan_parameters, "VirtualWAN")
    ...
    async def begin_create_or_update(
        ...
        :type wan_parameters: ~azure.mgmt.network.v2020_07_01.models.VirtualWAN
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either VirtualWAN or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_07_01.models.VirtualWAN]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
    ...
    async def update_tags(
        self, resource_group_name: str, virtual_wan_name: str, wan_parameters: "_models.TagsObject", **kwargs: Any
    ) -> "_models.VirtualWAN":
        ...
        :type wan_parameters: ~azure.mgmt.network.v2020_07_01.models.TagsObject
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: VirtualWAN, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_07_01.models.VirtualWAN
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        json = self._serialize.body(wan_parameters, "TagsObject")
    ...
    async def _delete_initial(self, resource_group_name: str, virtual_wan_name: str, **kwargs: Any) -> None:
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either ListVirtualWANsResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_07_01.models.ListVirtualWANsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ListVirtualWANsResult"]:
