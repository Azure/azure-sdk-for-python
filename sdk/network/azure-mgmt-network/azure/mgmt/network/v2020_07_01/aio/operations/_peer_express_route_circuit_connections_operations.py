...
class PeerExpressRouteCircuitConnectionsOperations:
    ...
    def list(
        ...
        peering_name: str,
        **kwargs
    ) -> AsyncIterable["models.PeerExpressRouteCircuitConnectionListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_07_01.models.PeerExpressRouteCircuitConnectionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
