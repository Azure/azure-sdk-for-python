...
from ...operations._private_dns_zone_groups_operations import (
...
class PrivateDnsZoneGroupsOperations:
    ...
    async def _delete_initial(
        self, resource_group_name: str, private_endpoint_name: str, private_dns_zone_group_name: str, **kwargs: Any
    ) -> None:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(parameters, "PrivateDnsZoneGroup")
