...
class BgpServiceCommunitiesOperations:
    ...
    def list(
        self,
        **kwargs
    ) -> AsyncIterable["models.BgpServiceCommunityListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_07_01.models.BgpServiceCommunityListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.BgpServiceCommunityListResult"]
        error_map = {
