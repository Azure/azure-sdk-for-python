...
from ...operations._bgp_service_communities_operations import build_list_request
...
class BgpServiceCommunitiesOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.BgpServiceCommunityListResult"]:
        ...
        :return: An iterator like instance of either BgpServiceCommunityListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_07_01.models.BgpServiceCommunityListResult]
