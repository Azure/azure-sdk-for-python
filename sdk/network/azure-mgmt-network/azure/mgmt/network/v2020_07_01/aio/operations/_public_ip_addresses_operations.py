...
from ...operations._public_ip_addresses_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_cloud_service_public_ip_address_request, build_get_request, build_get_virtual_machine_scale_set_public_ip_address_request, build_list_all_request, build_list_cloud_service_public_ip_addresses_request, build_list_cloud_service_role_instance_public_ip_addresses_request, build_list_request, build_list_virtual_machine_scale_set_public_ip_addresses_request, build_list_virtual_machine_scale_set_vm_public_ip_addresses_request, build_update_tags_request
T = TypeVar('T')
...
class PublicIPAddressesOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_07_01.models.PublicIPAddress
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2020_07_01.models.PublicIPAddress
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
        ...
        :return: An instance of AsyncLROPoller that returns either PublicIPAddress or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_07_01.models.PublicIPAddress]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
        polling = kwargs.pop('polling', True)  # type: Union[bool, azure.core.polling.AsyncPollingMethod]
    ...
    def list_all(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PublicIPAddressListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_07_01.models.PublicIPAddressListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_cloud_service_public_ip_addresses_request(
                    resource_group_name=resource_group_name,
                    cloud_service_name=cloud_service_name,
                    subscription_id=self._config.subscription_id,
                    template_url=self.list_cloud_service_public_ip_addresses.metadata['url'],
                )
                request = _convert_request(request)
                request.url = self._client.format_url(request.url)
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_cloud_service_role_instance_public_ip_addresses_request(
                    resource_group_name=resource_group_name,
                    cloud_service_name=cloud_service_name,
                    ...
                    ip_configuration_name=ip_configuration_name,
                    subscription_id=self._config.subscription_id,
                    template_url=self.list_cloud_service_role_instance_public_ip_addresses.metadata['url'],
                )
                request = _convert_request(request)
                request.url = self._client.format_url(request.url)
    ...
    async def get_cloud_service_public_ip_address(
        ...
        **kwargs: Any
        ...
        request = build_get_cloud_service_public_ip_address_request(
            resource_group_name=resource_group_name,
            cloud_service_name=cloud_service_name,
            role_instance_name=role_instance_name,
            network_interface_name=network_interface_name,
            ...
            subscription_id=self._config.subscription_id,
            expand=expand,
            template_url=self.get_cloud_service_public_ip_address.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
