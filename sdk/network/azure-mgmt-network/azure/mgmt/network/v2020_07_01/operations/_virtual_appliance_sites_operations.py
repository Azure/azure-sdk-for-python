...
class VirtualApplianceSitesOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.VirtualApplianceSite"
        ...
        :rtype: ~azure.mgmt.network.v2020_07_01.models.VirtualApplianceSite
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _create_or_update_initial(
        ...
        network_virtual_appliance_name,  # type: str
        site_name,  # type: str
        parameters,  # type: "models.VirtualApplianceSite"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.VirtualApplianceSite"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VirtualApplianceSite"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.VirtualApplianceSite"]
        ...
        :param parameters: Parameters supplied to the create or update Network Virtual Appliance Site
         operation.
        :type parameters: ~azure.mgmt.network.v2020_07_01.models.VirtualApplianceSite
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_07_01.models.VirtualApplianceSite]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VirtualApplianceSite"]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.NetworkVirtualApplianceSiteListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_07_01.models.NetworkVirtualApplianceSiteListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
