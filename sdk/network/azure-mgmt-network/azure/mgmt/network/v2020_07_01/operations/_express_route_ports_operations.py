...
class ExpressRoutePortsOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2020_07_01.models.ExpressRoutePort or
    ...
    def create_or_update(
        ...
        :param parameters: Parameters supplied to the create ExpressRoutePort
         operation.
        :type parameters:
         ~azure.mgmt.network.v2020_07_01.models.ExpressRoutePort
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_07_01.models.ExpressRoutePort]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_07_01.models.ExpressRoutePort]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_07_01.models.ExpressRoutePortPaged[~azure.mgmt.network.v2020_07_01.models.ExpressRoutePort]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def generate_loa(
        ...
        :return: GenerateExpressRoutePortsLOAResult or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.network.v2020_07_01.models.GenerateExpressRoutePortsLOAResult
