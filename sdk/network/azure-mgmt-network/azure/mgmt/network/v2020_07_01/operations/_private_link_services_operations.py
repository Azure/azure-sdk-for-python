...
class PrivateLinkServicesOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2020_07_01.models.PrivateLinkService or
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.network.v2020_07_01.models.PrivateLinkService
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_07_01.models.PrivateLinkService]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_07_01.models.PrivateLinkService]]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2020_07_01.models.ErrorException>`
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_07_01.models.PrivateLinkServicePaged[~azure.mgmt.network.v2020_07_01.models.PrivateLinkService]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2020_07_01.models.ErrorException>`
        """
    ...
    def get_private_endpoint_connection(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_07_01.models.PrivateEndpointConnection or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2020_07_01.models.ErrorException>`
        """
    ...
    def update_private_endpoint_connection(
        ...
        :type parameters:
         ~azure.mgmt.network.v2020_07_01.models.PrivateEndpointConnection
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list_private_endpoint_connections(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_07_01.models.PrivateEndpointConnectionPaged[~azure.mgmt.network.v2020_07_01.models.PrivateEndpointConnection]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2020_07_01.models.ErrorException>`
        """
        def prepare_request(next_link=None):
    ...
    def check_private_link_service_visibility(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_07_01.models.PrivateLinkServiceVisibility]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_07_01.models.PrivateLinkServiceVisibility]]
    ...
    def list_auto_approved_private_link_services(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_07_01.models.AutoApprovedPrivateLinkServicePaged[~azure.mgmt.network.v2020_07_01.models.AutoApprovedPrivateLinkService]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
