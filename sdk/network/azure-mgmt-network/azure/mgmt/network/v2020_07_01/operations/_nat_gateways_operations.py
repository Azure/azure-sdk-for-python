...
class NatGatewaysOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2020_07_01.models.NatGateway or
    ...
    def create_or_update(
        ...
        :param parameters: Parameters supplied to the create or update nat
         gateway operation.
        :type parameters: ~azure.mgmt.network.v2020_07_01.models.NatGateway
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_07_01.models.NatGateway]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_07_01.models.NatGateway]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_all(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_07_01.models.NatGatewayPaged[~azure.mgmt.network.v2020_07_01.models.NatGateway]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
