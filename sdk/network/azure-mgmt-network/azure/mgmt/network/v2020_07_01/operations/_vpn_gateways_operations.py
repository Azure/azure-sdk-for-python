...
class VpnGatewaysOperations(object):
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_07_01.models.VpnGateway]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _start_packet_capture_initial(
        ...
        resource_group_name,  # type: str
        gateway_name,  # type: str
        parameters=None,  # type: Optional["models.VpnGatewayPacketCaptureStartParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[str]
    ...
    def _stop_packet_capture_initial(
        ...
        resource_group_name,  # type: str
        gateway_name,  # type: str
        parameters=None,  # type: Optional["models.VpnGatewayPacketCaptureStopParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[str]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional[str]]
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_07_01.models.ListVpnGatewaysResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
