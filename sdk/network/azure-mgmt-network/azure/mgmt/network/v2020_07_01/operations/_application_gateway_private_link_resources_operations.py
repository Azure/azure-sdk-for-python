...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/privateLinkResources")  # pylint: disable=line-too-long
...
class ApplicationGatewayPrivateLinkResourcesOperations(object):
    ...
    def list(
        ...
        application_gateway_name: str,
        **kwargs: Any
    ) -> Iterable["_models.ApplicationGatewayPrivateLinkResourceListResult"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_07_01.models.ApplicationGatewayPrivateLinkResourceListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-07-01")  # type: str

        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ApplicationGatewayPrivateLinkResourceListResult"]
        error_map = {
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ApplicationGatewayPrivateLinkResourceListResult", pipeline_response)
