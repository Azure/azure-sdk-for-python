...
class ApplicationGatewayPrivateLinkResourcesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.ApplicationGatewayPrivateLinkResourceListResult"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ApplicationGatewayPrivateLinkResourceListResult"]
        error_map = {
