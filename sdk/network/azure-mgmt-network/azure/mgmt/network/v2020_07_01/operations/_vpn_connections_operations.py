...
class VpnConnectionsOperations(object):
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.VpnConnection"]
    ...
    def _start_packet_capture_initial(
        ...
        parameters=None,  # type: Optional["models.VpnConnectionPacketCaptureStartParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[str]
    ...
    def begin_start_packet_capture(
        ...
        **kwargs  # type: Any
        ...
        :param parameters: Vpn Connection packet capture parameters supplied to start packet capture on
         gateway connection.
        :type parameters: ~azure.mgmt.network.v2020_07_01.models.VpnConnectionPacketCaptureStartParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
    ...
    def _stop_packet_capture_initial(
        ...
        gateway_name,  # type: str
        vpn_connection_name,  # type: str
        parameters=None,  # type: Optional["models.VpnConnectionPacketCaptureStopParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[str]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional[str]]
    ...
    def begin_stop_packet_capture(
        ...
        **kwargs  # type: Any
        ...
        :param parameters: Vpn Connection packet capture parameters supplied to stop packet capture on
         gateway connection.
        :type parameters: ~azure.mgmt.network.v2020_07_01.models.VpnConnectionPacketCaptureStopParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
    ...
    def list_by_vpn_gateway(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.ListVpnConnectionsResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_07_01.models.ListVpnConnectionsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
