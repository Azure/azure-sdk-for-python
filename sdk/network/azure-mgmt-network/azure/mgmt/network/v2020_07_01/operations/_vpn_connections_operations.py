...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{connectionName}')
...
def build_start_packet_capture_request_initial(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{vpnConnectionName}/startpacketcapture')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'gatewayName': _SERIALIZER.url("gateway_name", gateway_name, 'str'),
        'vpnConnectionName': _SERIALIZER.url("vpn_connection_name", vpn_connection_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
    url = _format_url_section(url, **path_format_arguments)
...
def build_stop_packet_capture_request_initial(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{vpnConnectionName}/stoppacketcapture')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'gatewayName': _SERIALIZER.url("gateway_name", gateway_name, 'str'),
        'vpnConnectionName': _SERIALIZER.url("vpn_connection_name", vpn_connection_name, 'str'),
...
def build_list_by_vpn_gateway_request(
    subscription_id,  # type: str
    resource_group_name,  # type: str
    gateway_name,  # type: str
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections')
    path_format_arguments = {
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'gatewayName': _SERIALIZER.url("gateway_name", gateway_name, 'str'),
...
class VpnConnectionsOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_07_01.models.VpnConnection
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        json = self._serialize.body(vpn_connection_parameters, "VpnConnection")
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type vpn_connection_parameters: ~azure.mgmt.network.v2020_07_01.models.VpnConnection
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either VpnConnection or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_07_01.models.VpnConnection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
    ...
    def _start_packet_capture_initial(
        ...
        gateway_name,  # type: str
        vpn_connection_name,  # type: str
        parameters=None,  # type: Optional["_models.VpnConnectionPacketCaptureStartParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[str]
        ...
        if parameters is not None:
            json = self._serialize.body(parameters, "VpnConnectionPacketCaptureStartParameters")
        else:
            json = None
    ...
    def begin_start_packet_capture(
        ...
        **kwargs  # type: Any
        ...
        :param parameters: Vpn Connection packet capture parameters supplied to start packet capture on
         gateway connection.
        :type parameters:
         ~azure.mgmt.network.v2020_07_01.models.VpnConnectionPacketCaptureStartParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
    ...
    def _stop_packet_capture_initial(
        ...
        gateway_name,  # type: str
        vpn_connection_name,  # type: str
        parameters=None,  # type: Optional["_models.VpnConnectionPacketCaptureStopParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional[str]
        cls = kwargs.pop("cls", None)  # type: ClsType[Optional[str]]
        ...
        if parameters is not None:
            json = self._serialize.body(parameters, "VpnConnectionPacketCaptureStopParameters")
        else:
            json = None
    ...
    def begin_stop_packet_capture(
        ...
        **kwargs  # type: Any
        ...
        :param parameters: Vpn Connection packet capture parameters supplied to stop packet capture on
         gateway connection.
        :type parameters:
         ~azure.mgmt.network.v2020_07_01.models.VpnConnectionPacketCaptureStopParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
    ...
    def list_by_vpn_gateway(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either ListVpnConnectionsResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_07_01.models.ListVpnConnectionsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_vpn_gateway_request(
                    subscription_id=self._config.subscription_id,
                    resource_group_name=resource_group_name,
                    gateway_name=gateway_name,
