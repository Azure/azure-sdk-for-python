...
def build_download_request_initial(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{virtualWANName}/vpnConfiguration')
...
class VpnSitesConfigurationOperations(object):
    ...
    def _download_initial(
        ...
        **kwargs  # type: Any
        ...
        json = self._serialize.body(request, "GetVpnSitesConfigurationRequest")
