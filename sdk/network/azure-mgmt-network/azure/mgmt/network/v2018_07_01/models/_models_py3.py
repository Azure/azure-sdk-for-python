...
class ApplicationGatewayAutoscaleConfiguration(Model):
    ...
    :type bounds:
     ~azure.mgmt.network.v2018_07_01.models.ApplicationGatewayAutoscaleBounds
    """
...
class ApplicationGatewayFirewallRuleGroup(Model):
    ...
    :param rules: Required. The rules of the web application firewall rule
     group.
    :type rules:
     list[~azure.mgmt.network.v2018_07_01.models.ApplicationGatewayFirewallRule]
    """
...
class ApplicationGatewaySku(Model):
    ...
    :type name: str or
     ~azure.mgmt.network.v2018_07_01.models.ApplicationGatewaySkuName
    :param tier: Tier of an application gateway. Possible values include:
     'Standard', 'WAF', 'Standard_v2', 'WAF_v2'
    :type tier: str or
     ~azure.mgmt.network.v2018_07_01.models.ApplicationGatewayTier
...
class ApplicationGatewayUrlPathMap(SubResource):
    ...
    :type path_rules:
     list[~azure.mgmt.network.v2018_07_01.models.ApplicationGatewayPathRule]
    :param provisioning_state: Provisioning state of the backend http settings
     resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
    :type provisioning_state: str
...
class AvailableProvidersListState(Model):
    ...
    :type cities:
     list[~azure.mgmt.network.v2018_07_01.models.AvailableProvidersListCity]
    """
...
class AzureAsyncOperationResult(Model):
    ...
    :type status: str or
     ~azure.mgmt.network.v2018_07_01.models.NetworkOperationStatus
    :param error:
...
class AzureFirewallApplicationRuleCollection(SubResource):
    ...
    :type rules:
     list[~azure.mgmt.network.v2018_07_01.models.AzureFirewallApplicationRule]
    :param provisioning_state: The provisioning state of the resource.
     Possible values include: 'Succeeded', 'Updating', 'Deleting', 'Failed'
    :type provisioning_state: str or
     ~azure.mgmt.network.v2018_07_01.models.ProvisioningState
...
class AzureFirewallRCAction(Model):
    ...
    :type type: str or
     ~azure.mgmt.network.v2018_07_01.models.AzureFirewallRCActionType
    """
...
class ConnectionMonitor(Model):
    ...
    :type destination:
     ~azure.mgmt.network.v2018_07_01.models.ConnectionMonitorDestination
...
class ConnectionMonitorQueryResult(Model):
    ...
    :type states:
     list[~azure.mgmt.network.v2018_07_01.models.ConnectionStateSnapshot]
    """
...
class ConnectionStateSnapshot(Model):
    ...
    :type connection_state: str or
     ~azure.mgmt.network.v2018_07_01.models.ConnectionState
    ...
    :type evaluation_state: str or
     ~azure.mgmt.network.v2018_07_01.models.EvaluationState
    ...
    :vartype hops:
     list[~azure.mgmt.network.v2018_07_01.models.ConnectivityHop]
    """
...
class ConnectivityHop(Model):
    ...
    :vartype issues:
     list[~azure.mgmt.network.v2018_07_01.models.ConnectivityIssue]
    """
...
class ConnectivityInformation(Model):
    ...
    :vartype connection_status: str or
     ~azure.mgmt.network.v2018_07_01.models.ConnectionStatus
...
class ConnectivityParameters(Model):
    ...
    :param destination: Required.
    :type destination:
     ~azure.mgmt.network.v2018_07_01.models.ConnectivityDestination
    ...
    :type protocol_configuration:
     ~azure.mgmt.network.v2018_07_01.models.ProtocolConfiguration
    """
...
class EffectiveNetworkSecurityGroupListResult(Model):
    ...
    :type value:
     list[~azure.mgmt.network.v2018_07_01.models.EffectiveNetworkSecurityGroup]
...
class EffectiveNetworkSecurityRule(Model):
    ...
    :type direction: str or
     ~azure.mgmt.network.v2018_07_01.models.SecurityRuleDirection
    """
...
class EffectiveRoute(Model):
    ...
    :type next_hop_type: str or
     ~azure.mgmt.network.v2018_07_01.models.RouteNextHopType
    """
...
class ExpressRouteCircuit(Resource):
    ...
    :type peerings:
     list[~azure.mgmt.network.v2018_07_01.models.ExpressRouteCircuitPeering]
...
class ExpressRouteCircuitPeering(SubResource):
    ...
    :type peering_type: str or
     ~azure.mgmt.network.v2018_07_01.models.ExpressRoutePeeringType
    :param state: The peering state. Possible values include: 'Disabled',
     'Enabled'
    :type state: str or
     ~azure.mgmt.network.v2018_07_01.models.ExpressRoutePeeringState
...
class ExpressRouteCircuitsArpTableListResult(Model):
    ...
    :type value:
     list[~azure.mgmt.network.v2018_07_01.models.ExpressRouteCircuitArpTable]
...
class ExpressRouteCircuitSku(Model):
    ...
    :type tier: str or
     ~azure.mgmt.network.v2018_07_01.models.ExpressRouteCircuitSkuTier
    ...
    :type family: str or
     ~azure.mgmt.network.v2018_07_01.models.ExpressRouteCircuitSkuFamily
    """
...
class FlowLogInformation(Model):
    ...
    :type retention_policy:
     ~azure.mgmt.network.v2018_07_01.models.RetentionPolicyParameters
...
class Ipv6ExpressRouteCircuitPeeringConfig(Model):
    ...
    :type state: str or
     ~azure.mgmt.network.v2018_07_01.models.ExpressRouteCircuitPeeringState
    """
...
class LoadBalancer(Resource):
    ...
    :type load_balancing_rules:
     list[~azure.mgmt.network.v2018_07_01.models.LoadBalancingRule]
...
class LoadBalancerSku(Model):
    ...
    :param name: Name of a load balancer SKU. Possible values include:
     'Basic', 'Standard'
    :type name: str or
     ~azure.mgmt.network.v2018_07_01.models.LoadBalancerSkuName
    """
...
class NetworkInterface(Resource):
    ...
    :type dns_settings:
     ~azure.mgmt.network.v2018_07_01.models.NetworkInterfaceDnsSettings
...
class NextHopResult(Model):
    ...
    :type next_hop_type: str or
     ~azure.mgmt.network.v2018_07_01.models.NextHopType
...
class OperationPropertiesFormatServiceSpecification(Model):
    ...
    :type log_specifications:
     list[~azure.mgmt.network.v2018_07_01.models.LogSpecification]
    """
...
class PacketCapture(Model):
    ...
    :param filters:
    :type filters:
     list[~azure.mgmt.network.v2018_07_01.models.PacketCaptureFilter]
    """
...
class PacketCaptureQueryStatusResult(Model):
    ...
    :type packet_capture_status: str or
     ~azure.mgmt.network.v2018_07_01.models.PcStatus
    ...
    :type packet_capture_error: list[str or
     ~azure.mgmt.network.v2018_07_01.models.PcError]
    """
...
class Probe(SubResource):
    ...
    :type protocol: str or
     ~azure.mgmt.network.v2018_07_01.models.ProbeProtocol
...
class ProtocolConfiguration(Model):
    ...
    :type http_configuration:
     ~azure.mgmt.network.v2018_07_01.models.HTTPConfiguration
    """
...
class SecurityRule(SubResource):
    ...
    :param protocol: Required. Network protocol this rule applies to. Possible
     ...
     '*'
    :type protocol: str or
     ~azure.mgmt.network.v2018_07_01.models.SecurityRuleProtocol
...
class SecurityRuleAssociations(Model):
    ...
    :type subnet_association:
     ~azure.mgmt.network.v2018_07_01.models.SubnetAssociation
...
class ServiceEndpointPolicyDefinition(SubResource):
    ...
    def __init__(self, *, id: str=None, description: str=None, service: str=None, service_resources=None, provisioning_state: str=None, name: str=None, etag: str=None, **kwargs) -> None:
...
class Topology(Model):
    ...
    :param resources:
    :type resources:
     list[~azure.mgmt.network.v2018_07_01.models.TopologyResource]
    """
...
class TopologyAssociation(Model):
    ...
    :type association_type: str or
     ~azure.mgmt.network.v2018_07_01.models.AssociationType
    """
...
class TopologyResource(Model):
    ...
    :type associations:
     list[~azure.mgmt.network.v2018_07_01.models.TopologyAssociation]
    """
...
class TroubleshootingResult(Model):
    ...
    :type results:
     list[~azure.mgmt.network.v2018_07_01.models.TroubleshootingDetails]
    """
...
class VerificationIPFlowParameters(Model):
    ...
    :param protocol: Required. Protocol to be verified on. Possible values
     include: 'TCP', 'UDP'
    :type protocol: str or
     ~azure.mgmt.network.v2018_07_01.models.IpFlowProtocol
...
class VirtualNetworkGatewayConnection(Resource):
    ...
    :type local_network_gateway2:
     ~azure.mgmt.network.v2018_07_01.models.LocalNetworkGateway
...
class VirtualNetworkUsage(Model):
    ...
    :vartype name:
     ~azure.mgmt.network.v2018_07_01.models.VirtualNetworkUsageName
...
class VpnSite(Resource):
    ...
    :type device_properties:
     ~azure.mgmt.network.v2018_07_01.models.DeviceProperties
