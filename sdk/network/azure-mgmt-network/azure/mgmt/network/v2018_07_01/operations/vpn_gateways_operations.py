...
class VpnGatewaysOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_07_01.models.VpnGateway or
    ...
    def create_or_update(
        ...
        :type vpn_gateway_parameters:
         ~azure.mgmt.network.v2018_07_01.models.VpnGateway
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_07_01.models.VpnGateway]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_07_01.models.VpnGateway]]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2018_07_01.models.ErrorException>`
        """
    ...
    def list_by_resource_group(
        ...
        deserialized = models.VpnGatewayPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.VpnGatewayPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
