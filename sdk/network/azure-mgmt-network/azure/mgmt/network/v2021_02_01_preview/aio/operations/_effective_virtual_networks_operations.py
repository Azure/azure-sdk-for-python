...
from ...operations._effective_virtual_networks_operations import build_list_by_network_group_request, build_list_by_network_manager_request
T = TypeVar('T')
...
class EffectiveVirtualNetworksOperations:
    ...
    async def list_by_network_group(
        ...
        **kwargs: Any
        ...
        request = build_list_by_network_group_request(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            network_manager_name=network_manager_name,
