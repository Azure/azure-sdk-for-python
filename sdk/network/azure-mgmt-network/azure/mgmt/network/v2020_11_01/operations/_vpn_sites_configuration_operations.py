...
def build_download_request_initial(
    subscription_id: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{virtualWANName}/vpnConfiguration")  # pylint: disable=line-too-long
...
class VpnSitesConfigurationOperations(object):
    ...
    def _download_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_download_request_initial(
    ...
    @distributed_trace
    def begin_download(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        virtual_wan_name: str,
        request: "_models.GetVpnSitesConfigurationRequest",
        **kwargs: Any
        ...
        :type request: ~azure.mgmt.network.v2020_11_01.models.GetVpnSitesConfigurationRequest
