...
class LoadBalancerOutboundRulesOperations(object):
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either LoadBalancerOutboundRuleListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_11_01.models.LoadBalancerOutboundRuleListResult]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_11_01.models.OutboundRule
        :raises: ~azure.core.exceptions.HttpResponseError
        """
