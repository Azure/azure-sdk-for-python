...
def build_get_effective_virtual_hub_routes_request_initial(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualHubs/{virtualHubName}/effectiveRoutes')
    path_format_arguments = {
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'virtualHubName': _SERIALIZER.url("virtual_hub_name", virtual_hub_name, 'str'),
...
class VirtualHubsOperations(object):
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        json = self._serialize.body(virtual_hub_parameters, "VirtualHub")
    ...
    def update_tags(
        ...
        **kwargs  # type: Any
        ...
        json = self._serialize.body(virtual_hub_parameters, "TagsObject")
    ...
    def _get_effective_virtual_hub_routes_initial(
        ...
        resource_group_name,  # type: str
        virtual_hub_name,  # type: str
        effective_routes_parameters=None,  # type: Optional["_models.EffectiveRoutesParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop("cls", None)  # type: ClsType[None]
        ...
        if effective_routes_parameters is not None:
            json = self._serialize.body(effective_routes_parameters, "EffectiveRoutesParameters")
        else:
            json = None
