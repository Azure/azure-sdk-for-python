...
class LoadBalancerBackendAddressPoolsOperations(object):
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_11_01.models.LoadBalancerBackendAddressPoolListResult]
    ...
    def begin_create_or_update(
        ...
        parameters: "_models.BackendAddressPool",
        **kwargs: Any
    ) -> LROPoller["_models.BackendAddressPool"]:
        ...
        :return: An instance of LROPoller that returns either BackendAddressPool or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_11_01.models.BackendAddressPool]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
