...
from ...operations._ip_allocations_operations import (
...
class IpAllocationsOperations:
    """IpAllocationsOperations async operations.
    ...
    async def _delete_initial(self, resource_group_name: str, ip_allocation_name: str, **kwargs: Any) -> None:
    ...
    async def begin_delete(
        self, resource_group_name: str, ip_allocation_name: str, **kwargs: Any
    ) -> AsyncLROPoller[None]:
    ...
    async def get(
        self, resource_group_name: str, ip_allocation_name: str, expand: Optional[str] = None, **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_11_01.models.IpAllocation
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, ip_allocation_name: str, parameters: "_models.IpAllocation", **kwargs: Any
    ) -> "_models.IpAllocation":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.IpAllocation"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        ...
        json = self._serialize.body(parameters, "IpAllocation")
    ...
    async def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.network.v2020_11_01.models.IpAllocation
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
        ...
        :return: An instance of AsyncLROPoller that returns either IpAllocation or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_11_01.models.IpAllocation]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def update_tags(
        self, resource_group_name: str, ip_allocation_name: str, parameters: "_models.TagsObject", **kwargs: Any
    ) -> "_models.IpAllocation":
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.IpAllocationListResult"]:
        ...
        :return: An iterator like instance of either IpAllocationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_11_01.models.IpAllocationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
