...
from ...operations._firewall_policies_operations import (
...
class FirewallPoliciesOperations:
    """FirewallPoliciesOperations async operations.
    ...
    async def _delete_initial(self, resource_group_name: str, firewall_policy_name: str, **kwargs: Any) -> None:
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, firewall_policy_name: str, parameters: "_models.FirewallPolicy", **kwargs: Any
    ) -> "_models.FirewallPolicy":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.FirewallPolicy"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    async def begin_create_or_update(
        ...
        :return: An instance of AsyncLROPoller that returns either FirewallPolicy or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_11_01.models.FirewallPolicy]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.FirewallPolicyListResult"]:
        ...
        :return: An iterator like instance of either FirewallPolicyListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_11_01.models.FirewallPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.FirewallPolicyListResult"]:
