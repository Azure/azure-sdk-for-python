...
class SubnetsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_11_01.models.Subnet
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type subnet_parameters: ~azure.mgmt.network.v2020_11_01.models.Subnet
        :keyword api_version: Api Version. Default value is "2020-11-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either Subnet or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_11_01.models.Subnet]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    async def begin_prepare_network_policies(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type prepare_network_policies_request_parameters:
         ~azure.mgmt.network.v2020_11_01.models.PrepareNetworkPoliciesRequest
        :keyword api_version: Api Version. Default value is "2020-11-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_unprepare_network_policies(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type unprepare_network_policies_request_parameters:
         ~azure.mgmt.network.v2020_11_01.models.UnprepareNetworkPoliciesRequest
        :keyword api_version: Api Version. Default value is "2020-11-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_11_01.models.SubnetListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-01")  # type: str
