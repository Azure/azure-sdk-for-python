...
from ...operations._vpn_link_connections_operations import build_get_ike_sas_request_initial, build_list_by_vpn_connection_request, build_reset_connection_request_initial
T = TypeVar('T')
...
class VpnLinkConnectionsOperations:
    ...
    async def _reset_connection_initial(  # pylint: disable=inconsistent-return-statements
        self,
    ...
    async def begin_reset_connection(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        gateway_name: str,
        connection_name: str,
    ...
    def list_by_vpn_connection(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListVpnSiteLinkConnectionsResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_11_01.models.ListVpnSiteLinkConnectionsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-01")  # type: str
