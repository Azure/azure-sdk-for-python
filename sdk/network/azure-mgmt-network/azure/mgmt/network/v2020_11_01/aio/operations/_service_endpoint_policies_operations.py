...
from ...operations._service_endpoint_policies_operations import (
...
class ServiceEndpointPoliciesOperations:
    ...
    async def _delete_initial(self, resource_group_name: str, service_endpoint_policy_name: str, **kwargs: Any) -> None:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ServiceEndpointPolicyListResult"]:
