...
class ExpressRouteCrossConnectionPeeringsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_11_01.models.ExpressRouteCrossConnectionPeeringList]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type peering_parameters:
         ~azure.mgmt.network.v2020_11_01.models.ExpressRouteCrossConnectionPeering
        :keyword api_version: Api Version. Default value is "2020-11-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_11_01.models.ExpressRouteCrossConnectionPeering]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
