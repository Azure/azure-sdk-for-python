...
from ...operations._security_partner_providers_operations import (
...
class SecurityPartnerProvidersOperations:
    ...
    async def _delete_initial(
        self, resource_group_name: str, security_partner_provider_name: str, **kwargs: Any
    ) -> None:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.SecurityPartnerProviderListResult"]:
