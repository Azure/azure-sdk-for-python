...
class VirtualHubBgpConnectionsOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_11_01.models.ListVirtualHubBgpConnectionResults]
    ...
    async def begin_list_learned_routes(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_11_01.models.PeerRouteList]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
