...
from ...operations._virtual_hubs_operations import (
    build_create_or_update_request_initial,
    build_delete_request_initial,
    build_get_effective_virtual_hub_routes_request_initial,
    build_get_request,
...
class VirtualHubsOperations:
    ...
    async def _delete_initial(self, resource_group_name: str, virtual_hub_name: str, **kwargs: Any) -> None:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ListVirtualHubsResult"]:
