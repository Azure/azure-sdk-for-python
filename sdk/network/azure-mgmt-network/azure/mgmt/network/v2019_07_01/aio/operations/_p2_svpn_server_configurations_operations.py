...
class P2SVpnServerConfigurationsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs
        ...
        :type p2_s_vpn_server_configuration_parameters: ~azure.mgmt.network.v2019_07_01.models.P2SVpnServerConfiguration
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2019_07_01.models.P2SVpnServerConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
