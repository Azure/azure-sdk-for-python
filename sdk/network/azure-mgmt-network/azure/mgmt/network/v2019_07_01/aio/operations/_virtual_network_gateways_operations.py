...
from ...operations._virtual_network_gateways_operations import build_create_or_update_request_initial, build_delete_request_initial, build_generate_vpn_profile_request_initial, build_generatevpnclientpackage_request_initial, build_get_advertised_routes_request_initial, build_get_bgp_peer_status_request_initial, build_get_learned_routes_request_initial, build_get_request, build_get_vpn_profile_package_url_request_initial, build_get_vpnclient_connection_health_request_initial, build_get_vpnclient_ipsec_parameters_request_initial, build_list_connections_request, build_list_request, build_reset_request_initial, build_reset_vpn_client_shared_key_request_initial, build_set_vpnclient_ipsec_parameters_request_initial, build_start_packet_capture_request_initial, build_stop_packet_capture_request_initial, build_supported_vpn_devices_request, build_update_tags_request_initial, build_vpn_device_configuration_script_request
T = TypeVar('T')
...
class VirtualNetworkGatewaysOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace_async
    async def begin_reset_vpn_client_shared_key(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        virtual_network_gateway_name: str,
        **kwargs: Any
