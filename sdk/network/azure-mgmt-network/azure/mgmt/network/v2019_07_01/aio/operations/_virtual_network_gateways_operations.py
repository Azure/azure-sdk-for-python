...
from ...operations._virtual_network_gateways_operations import (
    build_create_or_update_request_initial,
    build_delete_request_initial,
    build_generate_vpn_profile_request_initial,
    build_generatevpnclientpackage_request_initial,
    build_get_advertised_routes_request_initial,
    build_get_bgp_peer_status_request_initial,
    build_get_learned_routes_request_initial,
    build_get_request,
    build_get_vpn_profile_package_url_request_initial,
    build_get_vpnclient_connection_health_request_initial,
    build_get_vpnclient_ipsec_parameters_request_initial,
    build_list_connections_request,
    build_list_request,
    build_reset_request_initial,
    build_reset_vpn_client_shared_key_request_initial,
    build_set_vpnclient_ipsec_parameters_request_initial,
    build_start_packet_capture_request_initial,
    build_stop_packet_capture_request_initial,
    build_supported_vpn_devices_request,
    build_update_tags_request_initial,
    build_vpn_device_configuration_script_request,
)
...
class VirtualNetworkGatewaysOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(parameters, "VirtualNetworkGateway")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2019_07_01.models.VirtualNetworkGateway
        ...
        :return: An instance of AsyncLROPoller that returns either VirtualNetworkGateway or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2019_07_01.models.VirtualNetworkGateway]
    ...
    async def _delete_initial(self, resource_group_name: str, virtual_network_gateway_name: str, **kwargs: Any) -> None:
    ...
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.VirtualNetworkGatewayListResult"]:
        ...
        :return: An iterator like instance of either VirtualNetworkGatewayListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_07_01.models.VirtualNetworkGatewayListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_connections(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_07_01.models.VirtualNetworkGatewayListConnectionsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _generatevpnclientpackage_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(parameters, "VpnClientParameters")
    ...
    async def begin_generatevpnclientpackage(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the generate virtual network gateway VPN client
         package operation.
        :type parameters: ~azure.mgmt.network.v2019_07_01.models.VpnClientParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
    ...
    async def begin_get_bgp_peer_status(
        ...
        :return: An instance of AsyncLROPoller that returns either BgpPeerStatusListResult or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2019_07_01.models.BgpPeerStatusListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def begin_get_learned_routes(
        ...
        :return: An instance of AsyncLROPoller that returns either GatewayRouteListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2019_07_01.models.GatewayRouteListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def _set_vpnclient_ipsec_parameters_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(vpnclient_ipsec_params, "VpnClientIPsecParameters")
    ...
    async def begin_set_vpnclient_ipsec_parameters(
        ...
        **kwargs: Any
        ...
        :type vpnclient_ipsec_params: ~azure.mgmt.network.v2019_07_01.models.VpnClientIPsecParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
        ...
        :return: An instance of AsyncLROPoller that returns either VpnClientIPsecParameters or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2019_07_01.models.VpnClientIPsecParameters]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def vpn_device_configuration_script(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2019_07_01.models.VpnDeviceScriptParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: str, or the result of cls(response)
        :rtype: str
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        json = self._serialize.body(parameters, "VpnDeviceScriptParameters")
    ...
    async def begin_get_vpnclient_connection_health(
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2019_07_01.models.VpnClientConnectionHealthDetailListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
