...
from ...operations._load_balancer_frontend_ip_configurations_operations import build_get_request, build_list_request
T = TypeVar('T')
...
class LoadBalancerFrontendIPConfigurationsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_07_01.models.LoadBalancerFrontendIPConfigurationListResult]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2019_07_01.models.FrontendIPConfiguration
        :raises: ~azure.core.exceptions.HttpResponseError
        """
