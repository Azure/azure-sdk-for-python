...
from ...operations._public_ip_prefixes_operations import (
...
class PublicIPPrefixesOperations:
    ...
    async def _delete_initial(self, resource_group_name: str, public_ip_prefix_name: str, **kwargs: Any) -> None:
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, public_ip_prefix_name: str, parameters: "_models.PublicIPPrefix", **kwargs: Any
    ) -> "_models.PublicIPPrefix":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.PublicIPPrefix"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    async def begin_create_or_update(
        ...
        :return: An instance of AsyncLROPoller that returns either PublicIPPrefix or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2019_07_01.models.PublicIPPrefix]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def _update_tags_initial(
        self, resource_group_name: str, public_ip_prefix_name: str, parameters: "_models.TagsObject", **kwargs: Any
    ) -> "_models.PublicIPPrefix":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.PublicIPPrefix"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.PublicIPPrefixListResult"]:
        ...
        :return: An iterator like instance of either PublicIPPrefixListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_07_01.models.PublicIPPrefixListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.PublicIPPrefixListResult"]:
