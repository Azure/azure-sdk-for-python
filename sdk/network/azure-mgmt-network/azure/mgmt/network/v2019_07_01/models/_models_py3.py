...
class ApplicationGateway(Resource):
    ...
    :type provisioning_state: str or ~azure.mgmt.network.v2019_07_01.models.ProvisioningState
...
class BackendAddressPool(SubResource):
    ...
    :ivar outbound_rules: An array of references to outbound rules that use this backend address
     pool.
    :vartype outbound_rules: list[~azure.mgmt.network.v2019_07_01.models.SubResource]
    :param provisioning_state: The provisioning state of the backend address pool resource.
     Possible values include: "Succeeded", "Updating", "Deleting", "Failed".
    :type provisioning_state: str or ~azure.mgmt.network.v2019_07_01.models.ProvisioningState
    """
...
class ConnectivityHop(msrest.serialization.Model):
    ...
    :vartype issues: list[~azure.mgmt.network.v2019_07_01.models.ConnectivityIssue]
    """
...
class ConnectivityInformation(msrest.serialization.Model):
    ...
    :vartype connection_status: str or ~azure.mgmt.network.v2019_07_01.models.ConnectionStatus
...
class DdosProtectionPlan(msrest.serialization.Model):
    ...
    :ivar virtual_networks: The list of virtual networks associated with the DDoS protection plan
     resource. This list is read-only.
    :vartype virtual_networks: list[~azure.mgmt.network.v2019_07_01.models.SubResource]
    """
...
class FirewallPolicy(Resource):
    ...
    :vartype rule_groups: list[~azure.mgmt.network.v2019_07_01.models.SubResource]
...
class FrontendIPConfiguration(SubResource):
    ...
    :vartype inbound_nat_pools: list[~azure.mgmt.network.v2019_07_01.models.SubResource]
...
class ServiceTagsListResult(msrest.serialization.Model):
    ...
    :vartype values: list[~azure.mgmt.network.v2019_07_01.models.ServiceTagInformation]
    """
...
class Subnet(SubResource):
    ...
    :ivar ip_configurations: An array of references to the network interface IP configurations
     using subnet.
    :vartype ip_configurations: list[~azure.mgmt.network.v2019_07_01.models.IPConfiguration]
...
class VirtualNetworkUsage(msrest.serialization.Model):
    ...
    :vartype name: ~azure.mgmt.network.v2019_07_01.models.VirtualNetworkUsageName
...
class WebApplicationFirewallPolicyListResult(msrest.serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.network.v2019_07_01.models.WebApplicationFirewallPolicy]
