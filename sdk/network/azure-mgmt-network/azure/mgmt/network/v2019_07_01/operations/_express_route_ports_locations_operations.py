...
class ExpressRoutePortsLocationsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_07_01.models.ExpressRoutePortsLocationPaged[~azure.mgmt.network.v2019_07_01.models.ExpressRoutePortsLocation]
        ...
        if raw:
            header_dict = {}
        deserialized = models.ExpressRoutePortsLocationPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_07_01.models.ExpressRoutePortsLocation or
