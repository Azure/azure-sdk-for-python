...
def build_delete_request_initial(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateLinkServices/{serviceName}')
...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateLinkServices')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
...
def build_list_by_subscription_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Network/privateLinkServices')
    path_format_arguments = {
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
    url = _format_url_section(url, **path_format_arguments)
...
def build_update_private_endpoint_connection_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateLinkServices/{serviceName}/privateEndpointConnections/{peConnectionName}')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'serviceName': _SERIALIZER.url("service_name", service_name, 'str'),
...
def build_check_private_link_service_visibility_request_initial(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/checkPrivateLinkServiceVisibility')
    path_format_arguments = {
...
def build_check_private_link_service_visibility_by_resource_group_request_initial(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/locations/{location}/checkPrivateLinkServiceVisibility')
    path_format_arguments = {
        'location': _SERIALIZER.url("location", location, 'str'),
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_list_auto_approved_private_link_services_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/autoApprovedPrivateLinkServices')
    path_format_arguments = {
        'location': _SERIALIZER.url("location", location, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
...
def build_list_auto_approved_private_link_services_by_resource_group_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/locations/{location}/autoApprovedPrivateLinkServices')
    path_format_arguments = {
        'location': _SERIALIZER.url("location", location, 'str'),
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
class PrivateLinkServicesOperations(object):
        ...
        **kwargs  # type: Any
        ...
        if cont_token is None:
            raw_result = self._delete_initial(
                resource_group_name=resource_group_name, service_name=service_name, cls=lambda x, y, z: x, **kwargs
            )
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.network.v2019_07_01.models.PrivateLinkService
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        json = self._serialize.body(parameters, "PrivateLinkService")
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.network.v2019_07_01.models.PrivateLinkService
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
        ...
        :return: An instance of LROPoller that returns either PrivateLinkService or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_07_01.models.PrivateLinkService]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, PollingMethod]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either PrivateLinkServiceListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2019_07_01.models.PrivateLinkServiceListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def update_private_endpoint_connection(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.network.v2019_07_01.models.PrivateEndpointConnection
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PrivateEndpointConnection, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_07_01.models.PrivateEndpointConnection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        json = self._serialize.body(parameters, "PrivateEndpointConnection")
    ...
    def _check_private_link_service_visibility_initial(
        ...
        **kwargs  # type: Any
        ...
        json = self._serialize.body(parameters, "CheckPrivateLinkServiceVisibilityRequest")
    ...
    def begin_check_private_link_service_visibility(
        ...
        **kwargs  # type: Any
        ...
        :type parameters:
         ~azure.mgmt.network.v2019_07_01.models.CheckPrivateLinkServiceVisibilityRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_07_01.models.PrivateLinkServiceVisibility]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, PollingMethod]
        ...
        if cont_token is None:
            raw_result = self._check_private_link_service_visibility_initial(
                location=location, parameters=parameters, content_type=content_type, cls=lambda x, y, z: x, **kwargs
            )
    ...
    def list_auto_approved_private_link_services(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either AutoApprovedPrivateLinkServicesResult or the
         result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2019_07_01.models.AutoApprovedPrivateLinkServicesResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
