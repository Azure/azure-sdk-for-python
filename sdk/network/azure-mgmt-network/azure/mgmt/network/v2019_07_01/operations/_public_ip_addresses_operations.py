...
class PublicIPAddressesOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2019_07_01.models.PublicIPAddress or
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.network.v2019_07_01.models.PublicIPAddress
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2019_07_01.models.PublicIPAddress]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2019_07_01.models.PublicIPAddress]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_all(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_07_01.models.PublicIPAddressPaged[~azure.mgmt.network.v2019_07_01.models.PublicIPAddress]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2019-07-01"
