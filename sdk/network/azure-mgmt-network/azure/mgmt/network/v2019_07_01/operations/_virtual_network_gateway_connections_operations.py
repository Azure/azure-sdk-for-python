...
class VirtualNetworkGatewayConnectionsOperations(object):
    ...
    def begin_create_or_update(
     ...
     connection operation.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_07_01.models.VirtualNetworkGatewayConnection]
    ...
    def begin_set_shared_key(
     ...
     Shared key operation throughNetwork resource provider.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_07_01.models.ConnectionSharedKey]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ConnectionSharedKey"]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2019_07_01.models.VirtualNetworkGatewayConnectionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_reset_shared_key(
     ...
     shared key operation through network resource provider.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_07_01.models.ConnectionResetSharedKey]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ConnectionResetSharedKey"]
