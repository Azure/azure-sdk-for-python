...
def build_delete_request_initial(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/firewallPolicies/{firewallPolicyName}/ruleGroups/{ruleGroupName}")  # pylint: disable=line-too-long
...
def build_list_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/firewallPolicies/{firewallPolicyName}/ruleGroups")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "firewallPolicyName": _SERIALIZER.url("firewall_policy_name", firewall_policy_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
class FirewallPolicyRuleGroupsOperations(object):
    ...
    def begin_create_or_update(
        ...
        parameters: "_models.FirewallPolicyRuleGroup",
        **kwargs: Any
    ) -> LROPoller["_models.FirewallPolicyRuleGroup"]:
    ...
    def list(
        ...
        firewall_policy_name: str,
        **kwargs: Any
    ) -> Iterable["_models.FirewallPolicyRuleGroupListResult"]:
