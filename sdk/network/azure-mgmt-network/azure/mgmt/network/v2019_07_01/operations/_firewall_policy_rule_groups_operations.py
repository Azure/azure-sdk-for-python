...
class FirewallPolicyRuleGroupsOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.FirewallPolicyRuleGroup"
    ...
    def _create_or_update_initial(
        ...
        firewall_policy_name,  # type: str
        rule_group_name,  # type: str
        parameters,  # type: "models.FirewallPolicyRuleGroup"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.FirewallPolicyRuleGroup"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FirewallPolicyRuleGroup"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.FirewallPolicyRuleGroup"]
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns either FirewallPolicyRuleGroup or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_07_01.models.FirewallPolicyRuleGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FirewallPolicyRuleGroup"]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.FirewallPolicyRuleGroupListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2019_07_01.models.FirewallPolicyRuleGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
