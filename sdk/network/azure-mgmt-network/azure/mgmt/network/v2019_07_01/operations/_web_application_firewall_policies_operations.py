...
class WebApplicationFirewallPoliciesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_07_01.models.WebApplicationFirewallPolicyPaged[~azure.mgmt.network.v2019_07_01.models.WebApplicationFirewallPolicy]
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_07_01.models.WebApplicationFirewallPolicy or
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.network.v2019_07_01.models.WebApplicationFirewallPolicy
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
