...
class RouteFiltersOperations(object):
    ...
    def begin_create_or_update(
     ...
     operation.
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns RouteFilter
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        route_filter_name,  # type: str
        route_filter_parameters,  # type: "models.PatchRouteFilter"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.RouteFilter"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.RouteFilter"]
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2019_06_01.models.RouteFilterListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
