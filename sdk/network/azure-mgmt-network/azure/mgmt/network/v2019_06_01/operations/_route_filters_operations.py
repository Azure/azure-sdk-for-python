...
class RouteFiltersOperations(object):
    ...
    def delete(
            self, resource_group_name, route_filter_name, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeFilters/{routeFilterName}'}
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2019_06_01.models.RouteFilter or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeFilters/{routeFilterName}'}
    ...
    def create_or_update(
            self, resource_group_name, route_filter_name, route_filter_parameters, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :type route_filter_parameters:
         ~azure.mgmt.network.v2019_06_01.models.RouteFilter
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2019_06_01.models.RouteFilter]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2019_06_01.models.RouteFilter]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeFilters/{routeFilterName}'}
    ...
    def update(
        ...
        :type route_filter_parameters:
         ~azure.mgmt.network.v2019_06_01.models.PatchRouteFilter
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeFilters/{routeFilterName}'}
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_06_01.models.RouteFilterPaged[~azure.mgmt.network.v2019_06_01.models.RouteFilter]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.RouteFilterPaged(internal_paging, self._deserialize.dependencies, header_dict)
