...
class RouteFilterRulesOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2019_06_01.models.RouteFilterRule or
    ...
    def create_or_update(
        ...
        :type route_filter_rule_parameters:
         ~azure.mgmt.network.v2019_06_01.models.RouteFilterRule
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2019_06_01.models.RouteFilterRule]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2019_06_01.models.RouteFilterRule]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def update(
        ...
        :type route_filter_rule_parameters:
         ~azure.mgmt.network.v2019_06_01.models.PatchRouteFilterRule
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
    ...
    def list_by_route_filter(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_06_01.models.RouteFilterRulePaged[~azure.mgmt.network.v2019_06_01.models.RouteFilterRule]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
