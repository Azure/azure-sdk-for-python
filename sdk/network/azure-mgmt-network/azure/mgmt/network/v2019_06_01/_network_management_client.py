...
class NetworkManagementClient(NetworkManagementClientOperationsMixin, SDKClient):
    ...
    :vartype p2s_vpn_server_configurations: azure.mgmt.network.v2019_06_01.operations.P2sVpnServerConfigurationsOperations
    :ivar p2s_vpn_gateways: P2sVpnGateways operations
    :vartype p2s_vpn_gateways: azure.mgmt.network.v2019_06_01.operations.P2sVpnGatewaysOperations
