...
try:
    ...
    from ._models import ListP2SVpnServerConfigurationsResult  # type: ignore
    ...
    from ._models import P2SVpnServerConfigRadiusClientRootCertificate  # type: ignore
    from ._models import P2SVpnServerConfigRadiusServerRootCertificate  # type: ignore
    from ._models import P2SVpnServerConfigVpnClientRevokedCertificate  # type: ignore
    from ._models import P2SVpnServerConfigVpnClientRootCertificate  # type: ignore
    from ._models import P2SVpnServerConfiguration  # type: ignore
