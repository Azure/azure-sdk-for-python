...
from ...operations._firewall_policies_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_all_request, build_list_request, build_update_tags_request
T = TypeVar('T')
...
class FirewallPoliciesOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2019_06_01.models.FirewallPolicy
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def update_tags(
        ...
        resource_group_name: str,
        firewall_policy_name: str,
        firewall_policy_parameters: "_models.TagsObject",
        **kwargs: Any
    ) -> "_models.FirewallPolicy":
        ...
        :type firewall_policy_parameters: ~azure.mgmt.network.v2019_06_01.models.TagsObject
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: FirewallPolicy, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_06_01.models.FirewallPolicy
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        _json = self._serialize.body(firewall_policy_parameters, 'TagsObject')
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2019_06_01.models.FirewallPolicy
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
        ...
        :return: An instance of AsyncLROPoller that returns either FirewallPolicy or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2019_06_01.models.FirewallPolicy]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
        polling = kwargs.pop('polling', True)  # type: Union[bool, azure.core.polling.AsyncPollingMethod]
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either FirewallPolicyListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_06_01.models.FirewallPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
