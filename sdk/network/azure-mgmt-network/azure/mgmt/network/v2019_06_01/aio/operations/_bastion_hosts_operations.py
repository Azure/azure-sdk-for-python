...
from ...operations._bastion_hosts_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_resource_group_request, build_list_request, build_update_tags_request_initial
T = TypeVar('T')
...
class BastionHostsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2019_06_01.models.BastionHost
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
    ...
    async def _update_tags_initial(
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(bastion_host_parameters, 'TagsObject')
    ...
    begin_update_tags.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/bastionHosts/{bastionHostName}'}  # type: ignore
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either BastionHostListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_06_01.models.BastionHostListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
