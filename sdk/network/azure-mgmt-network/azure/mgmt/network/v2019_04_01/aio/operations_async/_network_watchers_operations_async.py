...
class NetworkWatchersOperations:
    ...
    async def begin_verify_ip_flow(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_04_01.models.VerificationIPFlowResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VerificationIPFlowResult"]
    ...
    async def begin_get_next_hop(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_04_01.models.NextHopResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.NextHopResult"]
    ...
    async def begin_get_vm_security_rules(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_04_01.models.SecurityGroupViewResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SecurityGroupViewResult"]
    ...
    async def begin_get_troubleshooting(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_04_01.models.TroubleshootingResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.TroubleshootingResult"]
    ...
    async def begin_set_flow_log_configuration(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_04_01.models.FlowLogInformation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FlowLogInformation"]
    ...
    given endpoint including another VM or an arbitrary remote server.
        ...
        :rtype: ~azure.mgmt.network.v2019_04_01.models.ConnectivityInformation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ConnectivityInformation"]
    ...
    Azure regions.
        ...
        :rtype: ~azure.mgmt.network.v2019_04_01.models.AzureReachabilityReport
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.AzureReachabilityReport"]
    ...
    async def begin_list_available_providers(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_04_01.models.AvailableProvidersList
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.AvailableProvidersList"]
    ...
    async def begin_get_network_configuration_diagnostic(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_04_01.models.NetworkConfigurationDiagnosticResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.NetworkConfigurationDiagnosticResponse"]
