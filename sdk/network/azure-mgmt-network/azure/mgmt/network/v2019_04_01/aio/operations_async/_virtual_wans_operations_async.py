...
class VirtualWansOperations:
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_04_01.models.VirtualWAN
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :type wan_parameters: ~azure.mgmt.network.v2019_04_01.models.VirtualWAN
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{VirtualWANName}'}  # type: ignore
    ...
    async def update_tags(
        ...
        **kwargs
        ...
        :type wan_parameters: ~azure.mgmt.network.v2019_04_01.models.TagsObject
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
    ...
    async def delete(
        ...
        **kwargs
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{VirtualWANName}'}  # type: ignore
    ...
    def list_by_resource_group(
        ...
        **kwargs
        ...
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of ListVirtualWANsResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_04_01.models.ListVirtualWANsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
