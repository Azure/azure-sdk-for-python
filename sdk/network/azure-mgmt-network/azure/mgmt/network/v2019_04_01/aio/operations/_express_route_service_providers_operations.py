...
from ...operations._express_route_service_providers_operations import build_list_request
...
class ExpressRouteServiceProvidersOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ExpressRouteServiceProviderListResult"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_04_01.models.ExpressRouteServiceProviderListResult]
