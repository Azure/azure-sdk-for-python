...
class NetworkProfilesOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2019_04_01.models.NetworkProfile
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_or_update(
        ...
        :type parameters: ~azure.mgmt.network.v2019_04_01.models.NetworkProfile
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NetworkProfile, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_04_01.models.NetworkProfile
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.NetworkProfileListResult"]:
        ...
        :return: An iterator like instance of either NetworkProfileListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_04_01.models.NetworkProfileListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
