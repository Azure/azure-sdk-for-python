...
class NetworkManagementClient(
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.routes = RoutesOperations(self._client, self._config, self._serialize, self._deserialize, "2019-04-01")
        ...
        self.subnets = SubnetsOperations(self._client, self._config, self._serialize, self._deserialize, "2019-04-01")
