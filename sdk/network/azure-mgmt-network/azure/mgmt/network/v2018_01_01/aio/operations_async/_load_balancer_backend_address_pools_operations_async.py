...
class LoadBalancerBackendAddressPoolsOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :return: An iterator like instance of LoadBalancerBackendAddressPoolListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2018_01_01.models.LoadBalancerBackendAddressPoolListResult]
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2018_01_01.models.BackendAddressPool
        :raises: ~azure.core.exceptions.HttpResponseError
        """
