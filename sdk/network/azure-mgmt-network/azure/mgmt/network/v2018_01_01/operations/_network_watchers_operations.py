    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either NetworkWatcherListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2018_01_01.models.NetworkWatcherListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-01-01")  # type: str
    ...
    def begin_verify_ip_flow(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either VerificationIPFlowResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_01_01.models.VerificationIPFlowResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-01-01")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
    ...
    def begin_get_vm_security_rules(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either SecurityGroupViewResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_01_01.models.SecurityGroupViewResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-01-01")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
    ...
    def begin_get_troubleshooting(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either TroubleshootingResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_01_01.models.TroubleshootingResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-01-01")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
    ...
    def begin_set_flow_log_configuration(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either FlowLogInformation or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_01_01.models.FlowLogInformation]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-01-01")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
    ...
    def begin_check_connectivity(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ConnectivityInformation or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_01_01.models.ConnectivityInformation]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-01-01")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
    ...
    def begin_get_azure_reachability_report(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either AzureReachabilityReport or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_01_01.models.AzureReachabilityReport]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-01-01")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
    ...
    def begin_list_available_providers(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either AvailableProvidersList or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_01_01.models.AvailableProvidersList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-01-01")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
