...
class ExpressRouteCircuitsRoutesTableSummaryListResult(Model):
    ...
    :type value:
     list[~azure.mgmt.network.v2018_01_01.models.ExpressRouteCircuitRoutesTableSummary]
    :param next_link: The URL to get the next set of results.
    :type next_link: str
    """
...
class NextHopResult(Model):
    ...
    :type next_hop_type: str or
     ~azure.mgmt.network.v2018_01_01.models.NextHopType
...
class TopologyResource(Model):
    ...
    :type associations:
     list[~azure.mgmt.network.v2018_01_01.models.TopologyAssociation]
    """
