...
class FlowLogInformation(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        "network_watcher_flow_analytics_configuration": {
            "key": "flowAnalyticsConfiguration.networkWatcherFlowAnalyticsConfiguration",
...
class PatchRouteFilterRule(SubResource):
    ...
    :type route_filter_rule_type: str or ~azure.mgmt.network.v2018_01_01.models.RouteFilterRuleType
...
class Usage(msrest.serialization.Model):
    ...
    :param unit: Required. An enum describing the unit of measurement. Possible values include:
     "Count".
    :type unit: str or ~azure.mgmt.network.v2018_01_01.models.UsageUnit
