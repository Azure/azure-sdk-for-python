...
class ServiceTagInformationOperations:
    """ServiceTagInformationOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2021_03_01.models.ServiceTagInformationListResult]
