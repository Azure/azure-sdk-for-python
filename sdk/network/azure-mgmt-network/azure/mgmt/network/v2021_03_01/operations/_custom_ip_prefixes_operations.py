...
class CustomIPPrefixesOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.network.v2021_03_01.models.CustomIpPrefix
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.network.v2021_03_01.models.CustomIpPrefix
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns either CustomIpPrefix or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2021_03_01.models.CustomIpPrefix]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.CustomIpPrefix"]
    ...
    def list_all(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2021_03_01.models.CustomIpPrefixListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
