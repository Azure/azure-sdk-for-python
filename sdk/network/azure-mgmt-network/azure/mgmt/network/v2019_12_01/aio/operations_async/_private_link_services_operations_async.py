...
class PrivateLinkServicesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2019_12_01.models.PrivateLinkService]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PrivateLinkService"]
    ...
    def list(
        ...
        resource_group_name: str,
        **kwargs
    ) -> AsyncIterable["models.PrivateLinkServiceListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_12_01.models.PrivateLinkServiceListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_private_endpoint_connections(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_12_01.models.PrivateEndpointConnectionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _check_private_link_service_visibility_initial(
        ...
        **kwargs
    ) -> Optional["models.PrivateLinkServiceVisibility"]:
    ...
    async def begin_check_private_link_service_visibility(
        ...
        parameters: "models.CheckPrivateLinkServiceVisibilityRequest",
        **kwargs
    ) -> AsyncLROPoller["models.PrivateLinkServiceVisibility"]:
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2019_12_01.models.PrivateLinkServiceVisibility]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
    ...
    approved in this subscription in this region.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_12_01.models.AutoApprovedPrivateLinkServicesResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
