...
class AzureFirewallsOperations:
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/azureFirewalls/{azureFirewallName}'}
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/azureFirewalls/{azureFirewallName}'}
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns AzureFirewall
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_12_01.models.AzureFirewall]
    ...
    def list(
        ...
        resource_group_name: str,
        **kwargs
    ) -> "models.AzureFirewallListResult":
        """Lists all Azure Firewalls in a resource group.

        :param resource_group_name: The name of the resource group.
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AzureFirewallListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.AzureFirewallListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
