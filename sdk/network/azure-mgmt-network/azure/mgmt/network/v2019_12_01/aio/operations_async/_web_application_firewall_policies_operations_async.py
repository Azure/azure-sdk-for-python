...
class WebApplicationFirewallPoliciesOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_12_01.models.WebApplicationFirewallPolicyListResult
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: WebApplicationFirewallPolicy or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.WebApplicationFirewallPolicy or ~azure.mgmt.network.v2019_12_01.models.WebApplicationFirewallPolicy
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.WebApplicationFirewallPolicy"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
