...
class ExpressRouteCircuitPeeringsOperations:
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}'}
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}'}
    ...
    async def create_or_update(
     ...
     peering operation.
        ...
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns ExpressRouteCircuitPeering
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_12_01.models.ExpressRouteCircuitPeering]
    ...
    def list(
        ...
        **kwargs
        ...
        :type circuit_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ExpressRouteCircuitPeeringListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.ExpressRouteCircuitPeeringListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
