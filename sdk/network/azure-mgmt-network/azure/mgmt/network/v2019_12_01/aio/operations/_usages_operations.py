...
class UsagesOperations:
    ...
    def list(self, location: str, **kwargs: Any) -> AsyncIterable["_models.UsagesListResult"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_12_01.models.UsagesListResult]
