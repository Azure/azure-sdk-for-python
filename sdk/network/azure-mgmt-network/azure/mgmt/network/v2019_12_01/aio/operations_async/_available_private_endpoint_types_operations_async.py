...
class AvailablePrivateEndpointTypesOperations:
    ...
    def list(
        ...
        location: str,
        **kwargs
    ) -> "models.AvailablePrivateEndpointTypesResult":
        """Returns all of the resource types that can be linked to a Private Endpoint in this subscription in this region.

        :param location: The location of the domain name.
        :type location: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AvailablePrivateEndpointTypesResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.AvailablePrivateEndpointTypesResult
