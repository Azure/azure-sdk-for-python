...
class VirtualHubRouteTableV2SOperations:
    """VirtualHubRouteTableV2SOperations async operations.
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualHubs/{virtualHubName}/routeTables/{routeTableName}'}
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualHubs/{virtualHubName}/routeTables/{routeTableName}'}
    ...
    def list(
        ...
        virtual_hub_name: str,
        **kwargs
    ) -> "models.ListVirtualHubRouteTableV2SResult":
        ...
        :type virtual_hub_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ListVirtualHubRouteTableV2SResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.ListVirtualHubRouteTableV2SResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
