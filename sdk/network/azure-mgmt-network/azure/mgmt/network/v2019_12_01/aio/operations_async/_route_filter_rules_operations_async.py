...
class RouteFilterRulesOperations:
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeFilters/{routeFilterName}/routeFilterRules/{ruleName}'}
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeFilters/{routeFilterName}/routeFilterRules/{ruleName}'}
    ...
    async def create_or_update(
     ...
     rule operation.
        ...
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :return: An instance of LROPoller that returns RouteFilterRule
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_12_01.models.RouteFilterRule]
    ...
    def list_by_route_filter(
        ...
        **kwargs
        ...
        :type route_filter_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: RouteFilterRuleListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.RouteFilterRuleListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
