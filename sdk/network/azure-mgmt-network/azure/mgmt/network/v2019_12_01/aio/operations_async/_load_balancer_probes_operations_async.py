...
class LoadBalancerProbesOperations:
    ...
    def list(
        ...
        **kwargs
    ) -> "models.LoadBalancerProbeListResult":
        ...
        :return: LoadBalancerProbeListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.LoadBalancerProbeListResult
