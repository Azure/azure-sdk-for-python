...
class VpnServerConfigurationsOperations(object):
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        vpn_server_configuration_name,  # type: str
        vpn_server_configuration_parameters,  # type: "models.VpnServerConfiguration"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.VpnServerConfiguration"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VpnServerConfiguration"]
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnServerConfigurations/{vpnServerConfigurationName}'}
    ...
    begin_create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnServerConfigurations/{vpnServerConfigurationName}'}
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnServerConfigurations/{vpnServerConfigurationName}'}
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ListVpnServerConfigurationsResult"
        """Lists all the vpnServerConfigurations in a resource group.

        :param resource_group_name: The resource group name of the VpnServerConfiguration.
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ListVpnServerConfigurationsResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.ListVpnServerConfigurationsResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
