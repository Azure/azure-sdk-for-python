...
class ExpressRouteCircuitAuthorizationsOperations(object):
    ...
    def begin_create_or_update(
     ...
     circuit authorization operation.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_12_01.models.ExpressRouteCircuitAuthorization]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.AuthorizationListResult"
        ...
        :type circuit_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AuthorizationListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.AuthorizationListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
