...
class PublicIPAddressesOperations(object):
    ...
    def list_all(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.PublicIPAddressListResult"
        """Gets all the public IP addresses in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PublicIPAddressListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.PublicIPAddressListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
