...
class VirtualRouterPeeringsOperations(object):
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualRouters/{virtualRouterName}/peerings/{peeringName}'}
    ...
    begin_delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualRouters/{virtualRouterName}/peerings/{peeringName}'}
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualRouters/{virtualRouterName}/peerings/{peeringName}'}
    ...
    def begin_create_or_update(
     ...
     operation.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_12_01.models.VirtualRouterPeering]
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualRouters/{virtualRouterName}/peerings/{peeringName}'}
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.VirtualRouterPeeringListResult"
        ...
        :type virtual_router_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: VirtualRouterPeeringListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.VirtualRouterPeeringListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
