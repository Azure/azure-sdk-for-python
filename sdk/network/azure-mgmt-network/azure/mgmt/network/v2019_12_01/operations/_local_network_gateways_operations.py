...
class LocalNetworkGatewaysOperations(object):
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/localNetworkGateways/{localNetworkGatewayName}'}
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns LocalNetworkGateway
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_12_01.models.LocalNetworkGateway]
    ...
    begin_create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/localNetworkGateways/{localNetworkGatewayName}'}
    ...
    _delete_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/localNetworkGateways/{localNetworkGatewayName}'}
    ...
    def begin_delete(
        ...
        **kwargs  # type: Any
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/localNetworkGateways/{localNetworkGatewayName}'}
    ...
    def update_tags(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    update_tags.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/localNetworkGateways/{localNetworkGatewayName}'}
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.LocalNetworkGatewayListResult"
        """Gets all the local network gateways in a resource group.

        :param resource_group_name: The name of the resource group.
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: LocalNetworkGatewayListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.LocalNetworkGatewayListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
