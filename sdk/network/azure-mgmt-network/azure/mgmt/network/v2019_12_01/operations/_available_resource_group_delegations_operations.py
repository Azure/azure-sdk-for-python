...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/locations/{location}/availableDelegations")  # pylint: disable=line-too-long
...
class AvailableResourceGroupDelegationsOperations(object):
    ...
    def list(
        ...
        resource_group_name: str,
        **kwargs: Any
    ) -> Iterable["_models.AvailableDelegationsResult"]:
        ...
        :return: An iterator like instance of either AvailableDelegationsResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2019_12_01.models.AvailableDelegationsResult]
