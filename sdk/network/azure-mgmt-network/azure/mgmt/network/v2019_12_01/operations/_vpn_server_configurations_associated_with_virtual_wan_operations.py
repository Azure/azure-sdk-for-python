...
def build_list_request_initial(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{virtualWANName}/vpnServerConfigurations')
...
class VpnServerConfigurationsAssociatedWithVirtualWanOperations(object):
    ...
    def begin_list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.VpnServerConfigurationsResponse"]
