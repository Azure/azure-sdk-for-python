...
class VpnServerConfigurationsAssociatedWithVirtualWanOperations(object):
    ...
    begin_list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{virtualWANName}/vpnServerConfigurations'}
