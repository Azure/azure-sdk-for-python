...
class VpnServerConfigurationsAssociatedWithVirtualWanOperations(object):
    ...
    def begin_list(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns either VpnServerConfigurationsResponse or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_12_01.models.VpnServerConfigurationsResponse]
