...
class ServiceEndpointPoliciesOperations(object):
    ...
    def begin_create_or_update(
     ...
     operation.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_12_01.models.ServiceEndpointPolicy]
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/serviceEndpointPolicies/{serviceEndpointPolicyName}'}
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ServiceEndpointPolicyListResult"
        """Gets all the service endpoint policies in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ServiceEndpointPolicyListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.ServiceEndpointPolicyListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
