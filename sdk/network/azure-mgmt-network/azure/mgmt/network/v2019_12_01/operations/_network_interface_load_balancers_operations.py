...
class NetworkInterfaceLoadBalancersOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.NetworkInterfaceLoadBalancerListResult"
        ...
        :return: NetworkInterfaceLoadBalancerListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.NetworkInterfaceLoadBalancerListResult
