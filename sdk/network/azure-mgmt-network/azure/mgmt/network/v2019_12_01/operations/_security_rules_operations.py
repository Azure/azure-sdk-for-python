...
class SecurityRulesOperations(object):
    ...
    def create_or_update(
        ...
        :type security_rule_parameters:
         ~azure.mgmt.network.v2019_12_01.models.SecurityRule
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2019_12_01.models.SecurityRule]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2019_12_01.models.SecurityRule]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
