...
class LoadBalancerFrontendIPConfigurationsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.LoadBalancerFrontendIPConfigurationListResult"
        ...
        :return: LoadBalancerFrontendIPConfigurationListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.LoadBalancerFrontendIPConfigurationListResult
