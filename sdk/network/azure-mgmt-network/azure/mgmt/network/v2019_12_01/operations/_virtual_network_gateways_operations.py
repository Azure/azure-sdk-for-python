...
class VirtualNetworkGatewaysOperations(object):
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2019_12_01.models.VirtualNetworkGateway]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2019_12_01.models.VirtualNetworkGateway]]
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_12_01.models.VirtualNetworkGatewayPaged[~azure.mgmt.network.v2019_12_01.models.VirtualNetworkGateway]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_connections(
        ...
        :rtype:
         ~azure.mgmt.network.v2019_12_01.models.VirtualNetworkGatewayConnectionListEntityPaged[~azure.mgmt.network.v2019_12_01.models.VirtualNetworkGatewayConnectionListEntity]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
    ...
    def generatevpnclientpackage(
        ...
        :type parameters:
         ~azure.mgmt.network.v2019_12_01.models.VpnClientParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
    ...
    def get_bgp_peer_status(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2019_12_01.models.BgpPeerStatusListResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2019_12_01.models.BgpPeerStatusListResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get_learned_routes(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2019_12_01.models.GatewayRouteListResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2019_12_01.models.GatewayRouteListResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def set_vpnclient_ipsec_parameters(
        ...
        :type vpnclient_ipsec_params:
         ~azure.mgmt.network.v2019_12_01.models.VpnClientIPsecParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2019_12_01.models.VpnClientIPsecParameters]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2019_12_01.models.VpnClientIPsecParameters]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def vpn_device_configuration_script(
        ...
        :param parameters: Parameters supplied to the generate vpn device
         script operation.
        :type parameters:
         ~azure.mgmt.network.v2019_12_01.models.VpnDeviceScriptParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def _start_packet_capture_initial(
            self, resource_group_name, virtual_network_gateway_name, filter_data=None, custom_headers=None, raw=False, **operation_config):
        parameters = None
    ...
    def start_packet_capture(
            self, resource_group_name, virtual_network_gateway_name, filter_data=None, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :rtype: ~msrestazure.azure_operation.AzureOperationPoller[str] or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[str]]
        :raises:
         :class:`ErrorException<azure.mgmt.network.v2019_12_01.models.ErrorException>`
        """
    ...
    def _stop_packet_capture_initial(
            self, resource_group_name, virtual_network_gateway_name, sas_url=None, custom_headers=None, raw=False, **operation_config):
    ...
    def stop_packet_capture(
            self, resource_group_name, virtual_network_gateway_name, sas_url=None, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    def _get_vpnclient_connection_health_initial(
            self, resource_group_name, virtual_network_gateway_name, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.get_vpnclient_connection_health.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'virtualNetworkGatewayName': self._serialize.url("virtual_network_gateway_name", virtual_network_gateway_name, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('VpnClientConnectionHealthDetailListResult', response)
    ...
    def get_vpnclient_connection_health(
            self, resource_group_name, virtual_network_gateway_name, custom_headers=None, raw=False, polling=True, **operation_config):
        """Get VPN client connection health detail per P2S client connection of
        ...
        :param polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of LROPoller that returns
         VpnClientConnectionHealthDetailListResult or
         ClientRawResponse<VpnClientConnectionHealthDetailListResult> if
         raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2019_12_01.models.VpnClientConnectionHealthDetailListResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2019_12_01.models.VpnClientConnectionHealthDetailListResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def _disconnect_virtual_network_gateway_vpn_connections_initial(
            self, resource_group_name, virtual_network_gateway_name, vpn_connection_ids=None, custom_headers=None, raw=False, **operation_config):
        request = models.P2SVpnConnectionRequest(vpn_connection_ids=vpn_connection_ids)

        # Construct URL
        url = self.disconnect_virtual_network_gateway_vpn_connections.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'virtualNetworkGatewayName': self._serialize.url("virtual_network_gateway_name", virtual_network_gateway_name, 'str')
    ...
    def disconnect_virtual_network_gateway_vpn_connections(
            self, resource_group_name, virtual_network_gateway_name, vpn_connection_ids=None, custom_headers=None, raw=False, polling=True, **operation_config):
