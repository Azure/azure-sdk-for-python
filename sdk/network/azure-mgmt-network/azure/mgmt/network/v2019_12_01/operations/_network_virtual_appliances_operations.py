...
class NetworkVirtualAppliancesOperations(object):
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.NetworkVirtualApplianceListResult"
        """Lists all Network Virtual Appliances in a resource group.

        :param resource_group_name: The name of the resource group.
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NetworkVirtualApplianceListResult or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_12_01.models.NetworkVirtualApplianceListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
