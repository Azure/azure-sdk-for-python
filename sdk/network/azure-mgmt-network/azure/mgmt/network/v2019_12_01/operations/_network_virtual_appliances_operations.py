...
class NetworkVirtualAppliancesOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.NetworkVirtualAppliance"
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        network_virtual_appliance_name,  # type: str
        parameters,  # type: "models.NetworkVirtualAppliance"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.NetworkVirtualAppliance"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.NetworkVirtualAppliance"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2019_12_01.models.NetworkVirtualAppliance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.NetworkVirtualAppliance"]
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.NetworkVirtualApplianceListResult"]
        """Lists all Network Virtual Appliances in a resource group.

        :param resource_group_name: The name of the resource group.
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of NetworkVirtualApplianceListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2019_12_01.models.NetworkVirtualApplianceListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
