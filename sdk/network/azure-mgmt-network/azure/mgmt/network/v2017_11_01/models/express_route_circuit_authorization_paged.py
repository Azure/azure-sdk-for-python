...
class ExpressRouteCircuitAuthorizationPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ExpressRouteCircuitAuthorization <azure.mgmt.network.v2017_11_01.models.ExpressRouteCircuitAuthorization>` object
    """
