...
try:
    ...
    from ._models import EndpointService  # type: ignore
    ...
    from ._models import InterfaceEndpoint  # type: ignore
    from ._models import InterfaceEndpointListResult  # type: ignore
