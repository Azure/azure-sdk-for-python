...
class ApplicationGatewayUrlPathMap(SubResource):
    ...
    :type path_rules:
     list[~azure.mgmt.network.v2018_10_01.models.ApplicationGatewayPathRule]
    :param provisioning_state: Provisioning state of the backend http settings
     resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
    :type provisioning_state: str
...
class ExpressRouteCircuitsRoutesTableListResult(Model):
    ...
    :type value:
     list[~azure.mgmt.network.v2018_10_01.models.ExpressRouteCircuitRoutesTable]
    :param next_link: The URL to get the next set of results.
    :type next_link: str
    """
...
class VirtualNetworkUsage(Model):
    ...
    :vartype name:
     ~azure.mgmt.network.v2018_10_01.models.VirtualNetworkUsageName
