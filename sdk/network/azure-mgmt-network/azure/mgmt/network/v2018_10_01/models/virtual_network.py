...
class VirtualNetwork(Resource):
    ...
    :type dhcp_options: ~azure.mgmt.network.v2018_10_01.models.DhcpOptions
    :param subnets: A list of subnets in a Virtual Network.
    :type subnets: list[~azure.mgmt.network.v2018_10_01.models.Subnet]
    :param virtual_network_peerings: A list of peerings in a Virtual Network.
    :type virtual_network_peerings:
     list[~azure.mgmt.network.v2018_10_01.models.VirtualNetworkPeering]
