...
class ApplicationSecurityGroupsOperations(object):
    ...
    def begin_create_or_update(
     ...
     operation.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_10_01.models.ApplicationSecurityGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ApplicationSecurityGroup"]
    ...
    def list_all(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2018_10_01.models.ApplicationSecurityGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
