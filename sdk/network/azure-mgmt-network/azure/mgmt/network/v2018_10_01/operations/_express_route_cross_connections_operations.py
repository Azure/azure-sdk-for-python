...
class ExpressRouteCrossConnectionsOperations(object):
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2018_10_01.models.ExpressRouteCrossConnectionListResult]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ExpressRouteCrossConnection or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_10_01.models.ExpressRouteCrossConnection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-10-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def begin_list_arp_table(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_10_01.models.ExpressRouteCircuitsArpTableListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-10-01")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
    ...
    def begin_list_routes_table_summary(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_10_01.models.ExpressRouteCrossConnectionsRoutesTableSummaryListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-10-01")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
    ...
    def begin_list_routes_table(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_10_01.models.ExpressRouteCircuitsRoutesTableListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-10-01")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
