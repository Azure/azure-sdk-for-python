...
class ExpressRouteCircuitConnectionsOperations(object):
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_10_01.models.ExpressRouteCircuitConnection]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_10_01.models.ExpressRouteCircuitConnection]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
