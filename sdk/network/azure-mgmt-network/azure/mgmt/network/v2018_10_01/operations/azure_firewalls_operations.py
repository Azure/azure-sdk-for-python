...
class AzureFirewallsOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_10_01.models.AzureFirewall or
    ...
    def create_or_update(
        ...
        :param parameters: Parameters supplied to the create or update Azure
         Firewall operation.
        :type parameters: ~azure.mgmt.network.v2018_10_01.models.AzureFirewall
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_10_01.models.AzureFirewall]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_10_01.models.AzureFirewall]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_10_01.models.AzureFirewallPaged[~azure.mgmt.network.v2018_10_01.models.AzureFirewall]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        deserialized = models.AzureFirewallPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.AzureFirewallPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
