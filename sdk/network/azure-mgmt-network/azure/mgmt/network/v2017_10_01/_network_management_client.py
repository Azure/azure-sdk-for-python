...
class NetworkManagementClient(
    ...
    :vartype express_route_circuit_authorizations:
     azure.mgmt.network.v2017_10_01.operations.ExpressRouteCircuitAuthorizationsOperations
    ...
    :vartype express_route_circuit_peerings:
     azure.mgmt.network.v2017_10_01.operations.ExpressRouteCircuitPeeringsOperations
    :ivar express_route_circuits: ExpressRouteCircuitsOperations operations
    :vartype express_route_circuits:
     azure.mgmt.network.v2017_10_01.operations.ExpressRouteCircuitsOperations
    ...
    :vartype express_route_service_providers:
     azure.mgmt.network.v2017_10_01.operations.ExpressRouteServiceProvidersOperations
    ...
    :vartype load_balancer_backend_address_pools:
     azure.mgmt.network.v2017_10_01.operations.LoadBalancerBackendAddressPoolsOperations
    ...
    :vartype load_balancer_frontend_ip_configurations:
     azure.mgmt.network.v2017_10_01.operations.LoadBalancerFrontendIPConfigurationsOperations
    ...
    :vartype load_balancer_load_balancing_rules:
     azure.mgmt.network.v2017_10_01.operations.LoadBalancerLoadBalancingRulesOperations
    ...
    :vartype load_balancer_network_interfaces:
     azure.mgmt.network.v2017_10_01.operations.LoadBalancerNetworkInterfacesOperations
    :ivar load_balancer_probes: LoadBalancerProbesOperations operations
    :vartype load_balancer_probes:
     azure.mgmt.network.v2017_10_01.operations.LoadBalancerProbesOperations
    :ivar network_interfaces: NetworkInterfacesOperations operations
    :vartype network_interfaces:
     azure.mgmt.network.v2017_10_01.operations.NetworkInterfacesOperations
    ...
    :vartype network_interface_ip_configurations:
     azure.mgmt.network.v2017_10_01.operations.NetworkInterfaceIPConfigurationsOperations
    ...
    :vartype network_interface_load_balancers:
     azure.mgmt.network.v2017_10_01.operations.NetworkInterfaceLoadBalancersOperations
    :ivar network_security_groups: NetworkSecurityGroupsOperations operations
    :vartype network_security_groups:
     azure.mgmt.network.v2017_10_01.operations.NetworkSecurityGroupsOperations
    ...
    :vartype default_security_rules:
     azure.mgmt.network.v2017_10_01.operations.DefaultSecurityRulesOperations
    ...
    :vartype connection_monitors:
     azure.mgmt.network.v2017_10_01.operations.ConnectionMonitorsOperations
    ...
    :vartype public_ip_addresses:
     azure.mgmt.network.v2017_10_01.operations.PublicIPAddressesOperations
    ...
    :vartype route_filter_rules:
     azure.mgmt.network.v2017_10_01.operations.RouteFilterRulesOperations
    ...
    :vartype bgp_service_communities:
     azure.mgmt.network.v2017_10_01.operations.BgpServiceCommunitiesOperations
    ...
    :vartype virtual_network_peerings:
     azure.mgmt.network.v2017_10_01.operations.VirtualNetworkPeeringsOperations
    :ivar virtual_network_gateways: VirtualNetworkGatewaysOperations operations
    :vartype virtual_network_gateways:
     azure.mgmt.network.v2017_10_01.operations.VirtualNetworkGatewaysOperations
    ...
    :vartype local_network_gateways:
     azure.mgmt.network.v2017_10_01.operations.LocalNetworkGatewaysOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.routes = RoutesOperations(self._client, self._config, self._serialize, self._deserialize, "2017-10-01")
        self.bgp_service_communities = BgpServiceCommunitiesOperations(
            self._client, self._config, self._serialize, self._deserialize, "2017-10-01"
        )
        self.usages = UsagesOperations(self._client, self._config, self._serialize, self._deserialize, "2017-10-01")
        self.virtual_networks = VirtualNetworksOperations(
            self._client, self._config, self._serialize, self._deserialize, "2017-10-01"
        )
        self.subnets = SubnetsOperations(self._client, self._config, self._serialize, self._deserialize, "2017-10-01")
