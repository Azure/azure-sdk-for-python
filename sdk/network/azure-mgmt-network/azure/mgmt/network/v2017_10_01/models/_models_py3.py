...
class ConnectionMonitorQueryResult(_serialization.Model):
    ...
    def __init__(self, *, states: Optional[List["_models.ConnectionStateSnapshot"]] = None, **kwargs: Any) -> None:
        """
...
class ConnectivityParameters(_serialization.Model):
    ...
    def __init__(
        self, *, source: "_models.ConnectivitySource", destination: "_models.ConnectivityDestination", **kwargs: Any
    ) -> None:
        """
