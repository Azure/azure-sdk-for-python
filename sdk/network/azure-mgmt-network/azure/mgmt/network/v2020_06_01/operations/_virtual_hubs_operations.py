...
class VirtualHubsOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2020_06_01.models.VirtualHub or
    ...
    def create_or_update(
        ...
        :type virtual_hub_parameters:
         ~azure.mgmt.network.v2020_06_01.models.VirtualHub
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_06_01.models.VirtualHub]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_06_01.models.VirtualHub]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_06_01.models.VirtualHubPaged[~azure.mgmt.network.v2020_06_01.models.VirtualHub]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.VirtualHubPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def _get_effective_virtual_hub_routes_initial(
            self, resource_group_name, virtual_hub_name, resource_id=None, virtual_wan_resource_type=None, custom_headers=None, raw=False, **operation_config):
        effective_routes_parameters = None
        if resource_id is not None or virtual_wan_resource_type is not None:
            effective_routes_parameters = models.EffectiveRoutesParameters(resource_id=resource_id, virtual_wan_resource_type=virtual_wan_resource_type)

        # Construct URL
        url = self.get_effective_virtual_hub_routes.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'virtualHubName': self._serialize.url("virtual_hub_name", virtual_hub_name, 'str')
    ...
    def get_effective_virtual_hub_routes(
            self, resource_group_name, virtual_hub_name, resource_id=None, virtual_wan_resource_type=None, custom_headers=None, raw=False, polling=True, **operation_config):
        """Gets the effective routes configured for the Virtual Hub resource or
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    get_effective_virtual_hub_routes.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualHubs/{virtualHubName}/effectiveRoutes'}
