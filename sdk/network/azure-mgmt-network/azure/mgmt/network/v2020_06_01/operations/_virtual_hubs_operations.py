...
class VirtualHubsOperations(object):
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_06_01.models.ListVirtualHubsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _get_effective_virtual_hub_routes_initial(
        ...
        resource_group_name,  # type: str
        virtual_hub_name,  # type: str
        effective_routes_parameters=None,  # type: Optional["models.EffectiveRoutesParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
