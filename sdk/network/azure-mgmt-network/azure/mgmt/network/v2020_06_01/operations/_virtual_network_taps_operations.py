...
class VirtualNetworkTapsOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2020_06_01.models.VirtualNetworkTap or
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.network.v2020_06_01.models.VirtualNetworkTap
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_06_01.models.VirtualNetworkTap]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_06_01.models.VirtualNetworkTap]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_all(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_06_01.models.VirtualNetworkTapPaged[~azure.mgmt.network.v2020_06_01.models.VirtualNetworkTap]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.VirtualNetworkTapPaged(internal_paging, self._deserialize.dependencies, header_dict)
