...
class VirtualNetworkTapsOperations(object):
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        tap_name,  # type: str
        parameters,  # type: "models.VirtualNetworkTap"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.VirtualNetworkTap"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VirtualNetworkTap"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.VirtualNetworkTap"]
    ...
    def list_all(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.VirtualNetworkTapListResult"]
        """Gets all the VirtualNetworkTaps in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either VirtualNetworkTapListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_06_01.models.VirtualNetworkTapListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
