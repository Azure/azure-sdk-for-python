...
class IpAllocationsOperations(object):
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        ip_allocation_name,  # type: str
        parameters,  # type: "models.IpAllocation"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.IpAllocation"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.IpAllocation"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.IpAllocation"]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.IpAllocationListResult"]
        """Gets all IpAllocations in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either IpAllocationListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_06_01.models.IpAllocationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
