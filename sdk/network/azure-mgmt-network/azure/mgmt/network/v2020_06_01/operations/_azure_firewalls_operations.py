...
class AzureFirewallsOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_06_01.models.AzureFirewall
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_06_01.models.AzureFirewall]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.AzureFirewall"]
    ...
    def _update_tags_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["models.AzureFirewall"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.AzureFirewall"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_06_01.models.AzureFirewallListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
