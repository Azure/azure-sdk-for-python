...
class P2sVpnGatewaysOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2020_06_01.models.P2SVpnGateway or
    ...
    def create_or_update(
        ...
        :type p2_svpn_gateway_parameters:
         ~azure.mgmt.network.v2020_06_01.models.P2SVpnGateway
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_06_01.models.P2SVpnGateway]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_06_01.models.P2SVpnGateway]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_06_01.models.P2SVpnGatewayPaged[~azure.mgmt.network.v2020_06_01.models.P2SVpnGateway]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def reset(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    reset.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/p2svpnGateways/{gatewayName}/reset'}
    ...
    def get_p2s_vpn_connection_health_detailed(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_06_01.models.P2SVpnConnectionHealth]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_06_01.models.P2SVpnConnectionHealth]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def _disconnect_p2s_vpn_connections_initial(
            self, resource_group_name, p2s_vpn_gateway_name, vpn_connection_ids=None, custom_headers=None, raw=False, **operation_config):
        request = models.P2SVpnConnectionRequest(vpn_connection_ids=vpn_connection_ids)

        # Construct URL
        url = self.disconnect_p2s_vpn_connections.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'p2sVpnGatewayName': self._serialize.url("p2s_vpn_gateway_name", p2s_vpn_gateway_name, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    def disconnect_p2s_vpn_connections(
            self, resource_group_name, p2s_vpn_gateway_name, vpn_connection_ids=None, custom_headers=None, raw=False, polling=True, **operation_config):
        """Disconnect P2S vpn connections of the virtual wan P2SVpnGateway in the
        specified resource group.

        :param resource_group_name: The name of the resource group.
        :type resource_group_name: str
        :param p2s_vpn_gateway_name: The name of the P2S Vpn Gateway.
        :type p2s_vpn_gateway_name: str
        ...
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        raw_result = self._disconnect_p2s_vpn_connections_initial(
            resource_group_name=resource_group_name,
            p2s_vpn_gateway_name=p2s_vpn_gateway_name,
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    disconnect_p2s_vpn_connections.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/p2svpnGateways/{p2sVpnGatewayName}/disconnectP2sVpnConnections'}
