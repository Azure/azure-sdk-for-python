...
class NetworkInterfacesOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2020_06_01.models.NetworkInterface or
    ...
    def create_or_update(
        ...
        :param parameters: Parameters supplied to the create or update network
         interface operation.
        :type parameters:
         ~azure.mgmt.network.v2020_06_01.models.NetworkInterface
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_06_01.models.NetworkInterface]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_06_01.models.NetworkInterface]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_all(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_06_01.models.NetworkInterfacePaged[~azure.mgmt.network.v2020_06_01.models.NetworkInterface]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2020-06-01"
    ...
    def get_effective_route_table(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_06_01.models.EffectiveRouteListResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_06_01.models.EffectiveRouteListResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_effective_network_security_groups(
        ...
        :return: An instance of LROPoller that returns
         ...
         raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_06_01.models.EffectiveNetworkSecurityGroupListResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_06_01.models.EffectiveNetworkSecurityGroupListResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_virtual_machine_scale_set_ip_configurations(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_06_01.models.NetworkInterfaceIPConfigurationPaged[~azure.mgmt.network.v2020_06_01.models.NetworkInterfaceIPConfiguration]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2018-10-01"
    ...
    def get_virtual_machine_scale_set_ip_configuration(
        ...
        :return: NetworkInterfaceIPConfiguration or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.network.v2020_06_01.models.NetworkInterfaceIPConfiguration
