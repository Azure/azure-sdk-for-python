    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListVirtualHubBgpConnectionResults or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_06_01.models.ListVirtualHubBgpConnectionResults]
    ...
    def begin_list_learned_routes(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either PeerRouteList or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_06_01.models.PeerRouteList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-06-01")  # type: str
