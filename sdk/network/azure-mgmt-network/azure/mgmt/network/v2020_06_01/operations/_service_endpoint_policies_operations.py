...
class ServiceEndpointPoliciesOperations(object):
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/serviceEndpointPolicies/{serviceEndpointPolicyName}'}

    def get(
            self, resource_group_name, service_endpoint_policy_name, expand=None, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~azure.mgmt.network.v2020_06_01.models.ServiceEndpointPolicy
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ServiceEndpointPolicy', response)
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/serviceEndpointPolicies/{serviceEndpointPolicyName}'}


    def _create_or_update_initial(
            self, resource_group_name, service_endpoint_policy_name, parameters, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def create_or_update(
            self, resource_group_name, service_endpoint_policy_name, parameters, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :param service_endpoint_policy_name: The name of the service endpoint
         policy.
        :type service_endpoint_policy_name: str
        :param parameters: Parameters supplied to the create or update service
         endpoint policy operation.
        :type parameters:
         ~azure.mgmt.network.v2020_06_01.models.ServiceEndpointPolicy
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2020_06_01.models.ServiceEndpointPolicy]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2020_06_01.models.ServiceEndpointPolicy]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2020_06_01.models.ServiceEndpointPolicyPaged[~azure.mgmt.network.v2020_06_01.models.ServiceEndpointPolicy]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.ServiceEndpointPolicyPaged(internal_paging, self._deserialize.dependencies, header_dict)
