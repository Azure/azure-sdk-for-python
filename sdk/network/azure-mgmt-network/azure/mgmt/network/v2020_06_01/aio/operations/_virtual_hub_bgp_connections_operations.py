...
from ...operations._virtual_hub_bgp_connections_operations import (
    build_list_advertised_routes_request_initial,
    build_list_learned_routes_request_initial,
    build_list_request,
)
...
class VirtualHubBgpConnectionsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either ListVirtualHubBgpConnectionResults or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_06_01.models.ListVirtualHubBgpConnectionResults]
    ...
    async def _list_learned_routes_initial(
        self, resource_group_name: str, hub_name: str, connection_name: str, **kwargs: Any
    ...
    async def begin_list_learned_routes(
        ...
        :return: An instance of AsyncLROPoller that returns either PeerRouteList or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_06_01.models.PeerRouteList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
