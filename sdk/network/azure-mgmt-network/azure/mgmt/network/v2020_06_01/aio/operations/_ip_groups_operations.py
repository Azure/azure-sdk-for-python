...
class IpGroupsOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2020_06_01.models.IpGroup
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, ip_groups_name: str, parameters: "_models.IpGroup", **kwargs: Any
    ) -> "_models.IpGroup":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.IpGroup"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    async def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.network.v2020_06_01.models.IpGroup
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either IpGroup or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_06_01.models.IpGroup]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
    ...
    async def update_groups(
        self, resource_group_name: str, ip_groups_name: str, parameters: "_models.TagsObject", **kwargs: Any
    ) -> "_models.IpGroup":
    ...
    async def _delete_initial(self, resource_group_name: str, ip_groups_name: str, **kwargs: Any) -> None:
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_06_01.models.IpGroupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.IpGroupListResult"]:
