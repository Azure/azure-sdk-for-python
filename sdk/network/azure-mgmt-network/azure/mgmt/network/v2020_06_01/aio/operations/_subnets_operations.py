...
class SubnetsOperations:
    ...
    async def begin_prepare_network_policies(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type prepare_network_policies_request_parameters:
         ~azure.mgmt.network.v2020_06_01.models.PrepareNetworkPoliciesRequest
        :keyword api_version: Api Version. Default value is "2020-06-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_unprepare_network_policies(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type unprepare_network_policies_request_parameters:
         ~azure.mgmt.network.v2020_06_01.models.UnprepareNetworkPoliciesRequest
        :keyword api_version: Api Version. Default value is "2020-06-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_06_01.models.SubnetListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-06-01")  # type: str
