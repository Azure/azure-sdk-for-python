...
from ...operations._dscp_configuration_operations import (
...
class DscpConfigurationOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(parameters, "DscpConfiguration")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either DscpConfiguration or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_06_01.models.DscpConfiguration]
    ...
    async def _delete_initial(self, resource_group_name: str, dscp_configuration_name: str, **kwargs: Any) -> None:
    ...
    async def begin_delete(
        self, resource_group_name: str, dscp_configuration_name: str, **kwargs: Any
    ) -> AsyncLROPoller[None]:
    ...
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.DscpConfigurationListResult"]:
        """Gets a DSCP Configuration.
        ...
        :return: An iterator like instance of either DscpConfigurationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_06_01.models.DscpConfigurationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.DscpConfigurationListResult"]:
