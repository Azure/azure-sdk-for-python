...
from ...operations._dscp_configuration_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_all_request, build_list_request
T = TypeVar('T')
...
class DscpConfigurationOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(parameters, 'DscpConfiguration')
