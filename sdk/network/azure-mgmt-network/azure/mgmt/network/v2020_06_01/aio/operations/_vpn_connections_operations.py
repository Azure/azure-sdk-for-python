...
class VpnConnectionsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_06_01.models.VpnConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _start_packet_capture_initial(
        ...
        parameters: Optional["models.VpnConnectionPacketCaptureStartParameters"] = None,
        **kwargs
    ) -> Optional[str]:
    ...
    async def _stop_packet_capture_initial(
        ...
        gateway_name: str,
        vpn_connection_name: str,
        parameters: Optional["models.VpnConnectionPacketCaptureStopParameters"] = None,
        **kwargs
    ) -> Optional[str]:
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional[str]]
        error_map = {
    ...
    def list_by_vpn_gateway(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_06_01.models.ListVpnConnectionsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
