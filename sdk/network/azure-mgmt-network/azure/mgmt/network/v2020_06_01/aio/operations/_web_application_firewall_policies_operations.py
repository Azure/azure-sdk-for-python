...
from ...operations._web_application_firewall_policies_operations import (
...
class WebApplicationFirewallPoliciesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_06_01.models.WebApplicationFirewallPolicyListResult]
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.WebApplicationFirewallPolicyListResult"]:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.network.v2020_06_01.models.WebApplicationFirewallPolicy
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2020_06_01.models.WebApplicationFirewallPolicy
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: WebApplicationFirewallPolicy, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_06_01.models.WebApplicationFirewallPolicy
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def _delete_initial(self, resource_group_name: str, policy_name: str, **kwargs: Any) -> None:
