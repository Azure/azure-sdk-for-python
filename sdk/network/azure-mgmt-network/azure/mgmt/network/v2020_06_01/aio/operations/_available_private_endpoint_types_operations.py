...
from ...operations._available_private_endpoint_types_operations import (
...
class AvailablePrivateEndpointTypesOperations:
    ...
    def list(self, location: str, **kwargs: Any) -> AsyncIterable["_models.AvailablePrivateEndpointTypesResult"]:
        ...
        :return: An iterator like instance of either AvailablePrivateEndpointTypesResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_06_01.models.AvailablePrivateEndpointTypesResult]
