...
from ...operations._application_gateway_private_endpoint_connections_operations import (
...
class ApplicationGatewayPrivateEndpointConnectionsOperations:
    ...
    async def _delete_initial(
        self, resource_group_name: str, application_gateway_name: str, connection_name: str, **kwargs: Any
    ) -> None:
