...
from ...operations._virtual_appliance_skus_operations import build_get_request, build_list_request
...
class VirtualApplianceSkusOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.NetworkVirtualApplianceSkuListResult"]:
        ...
        :return: An iterator like instance of either NetworkVirtualApplianceSkuListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_06_01.models.NetworkVirtualApplianceSkuListResult]
    ...
    async def get(self, sku_name: str, **kwargs: Any) -> "_models.NetworkVirtualApplianceSku":
