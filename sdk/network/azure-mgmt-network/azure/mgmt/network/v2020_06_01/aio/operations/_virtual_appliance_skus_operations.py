...
class VirtualApplianceSkusOperations:
    ...
    def list(
        self,
        **kwargs
    ) -> AsyncIterable["models.NetworkVirtualApplianceSkuListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_06_01.models.NetworkVirtualApplianceSkuListResult]
    ...
    async def get(
        ...
        sku_name: str,
        **kwargs
    ) -> "models.NetworkVirtualApplianceSku":
