...
from ...operations._network_management_client_operations import build_check_dns_name_availability_request, build_delete_bastion_shareable_link_request_initial, build_disconnect_active_sessions_request, build_generatevirtualwanvpnserverconfigurationvpnprofile_request_initial, build_get_active_sessions_request_initial, build_get_bastion_shareable_link_request, build_put_bastion_shareable_link_request_initial, build_supported_security_providers_request
T = TypeVar('T')
