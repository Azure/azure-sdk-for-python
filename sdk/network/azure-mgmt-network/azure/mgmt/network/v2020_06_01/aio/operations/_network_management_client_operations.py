...
from ...operations._network_management_client_operations import (
    ...
    build_delete_bastion_shareable_link_request_initial,
    build_disconnect_active_sessions_request,
    build_generatevirtualwanvpnserverconfigurationvpnprofile_request_initial,
    build_get_active_sessions_request_initial,
    build_get_bastion_shareable_link_request,
    build_put_bastion_shareable_link_request_initial,
...
class NetworkManagementClientOperationsMixin:
    async def _put_bastion_shareable_link_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(bsl_request, "BastionShareableLinkListRequest")
    ...
    async def begin_put_bastion_shareable_link(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_06_01.models.BastionShareableLinkListResult]]
    ...
    def get_bastion_shareable_link(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either BastionShareableLinkListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_06_01.models.BastionShareableLinkListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
    ...
    async def begin_get_active_sessions(
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_06_01.models.BastionActiveSessionListResult]]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def disconnect_active_sessions(
        self, resource_group_name: str, bastion_host_name: str, session_ids: "_models.SessionIds", **kwargs: Any
        ...
        :return: An iterator like instance of either BastionSessionDeleteResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_06_01.models.BastionSessionDeleteResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                json = self._serialize.body(session_ids, "SessionIds")
    ...
    async def _generatevirtualwanvpnserverconfigurationvpnprofile_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(vpn_client_params, "VirtualWanVpnProfileParameters")
    ...
    async def begin_generatevirtualwanvpnserverconfigurationvpnprofile(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either VpnProfileResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_06_01.models.VpnProfileResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
