...
class InboundNatRulesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.InboundNatRuleListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2018_04_01.models.InboundNatRuleListResult]
    ...
    def _create_or_update_initial(
        ...
        load_balancer_name,  # type: str
        inbound_nat_rule_name,  # type: str
        inbound_nat_rule_parameters,  # type: "models.InboundNatRule"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.InboundNatRule"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.InboundNatRule"]
    ...
    def begin_create_or_update(
     ...
     rule operation.
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns InboundNatRule
