...
class InboundNatRulesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_04_01.models.InboundNatRulePaged[~azure.mgmt.network.v2018_04_01.models.InboundNatRule]
        ...
        if raw:
            header_dict = {}
        deserialized = models.InboundNatRulePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.network.v2018_04_01.models.InboundNatRule or
