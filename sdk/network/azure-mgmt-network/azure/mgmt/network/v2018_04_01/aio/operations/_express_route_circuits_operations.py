...
from ...operations._express_route_circuits_operations import (
    build_create_or_update_request_initial,
    build_delete_request_initial,
    build_get_peering_stats_request,
    build_get_request,
    build_get_stats_request,
    build_list_all_request,
    build_list_arp_table_request_initial,
    build_list_request,
    build_list_routes_table_request_initial,
    build_list_routes_table_summary_request_initial,
...
class ExpressRouteCircuitsOperations:
    ...
    async def _delete_initial(self, resource_group_name: str, circuit_name: str, **kwargs: Any) -> None:
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, circuit_name: str, parameters: "_models.ExpressRouteCircuit", **kwargs: Any
    ...
    async def begin_create_or_update(
        ...
        :return: An instance of AsyncLROPoller that returns either ExpressRouteCircuit or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2018_04_01.models.ExpressRouteCircuit]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def _update_tags_initial(
        self, resource_group_name: str, circuit_name: str, parameters: "_models.TagsObject", **kwargs: Any
    ) -> "_models.ExpressRouteCircuit":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.ExpressRouteCircuit"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    async def begin_list_arp_table(
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2018_04_01.models.ExpressRouteCircuitsArpTableListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def begin_list_routes_table(
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2018_04_01.models.ExpressRouteCircuitsRoutesTableListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def begin_list_routes_table_summary(
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2018_04_01.models.ExpressRouteCircuitsRoutesTableSummaryListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        polling = kwargs.pop("polling", True)  # type: Union[bool, AsyncPollingMethod]
    ...
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.ExpressRouteCircuitListResult"]:
        ...
        :return: An iterator like instance of either ExpressRouteCircuitListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2018_04_01.models.ExpressRouteCircuitListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.ExpressRouteCircuitListResult"]:
