...
from ...operations._express_route_circuits_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_peering_stats_request, build_get_request, build_get_stats_request, build_list_all_request, build_list_arp_table_request_initial, build_list_request, build_list_routes_table_request_initial, build_list_routes_table_summary_request_initial, build_update_tags_request_initial
T = TypeVar('T')
