...
class ApplicationGatewaySslPolicy(msrest.serialization.Model):
    ...
    def __init__(
        self, *, disabled_ssl_protocols: Optional[List[Union[str, "ApplicationGatewaySslProtocol"]]] = None, **kwargs
    ):
...
class EffectiveRouteListResult(msrest.serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["EffectiveRoute"]] = None, next_link: Optional[str] = None, **kwargs):
...
class VpnClientParameters(msrest.serialization.Model):
    ...
    def __init__(self, *, processor_architecture: Union[str, "ProcessorArchitecture"], **kwargs):
