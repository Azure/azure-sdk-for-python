...
class LoadBalancersOperations(object):
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        load_balancer_name,  # type: str
        parameters,  # type: "models.LoadBalancer"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.LoadBalancer"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.LoadBalancer"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns LoadBalancer
    ...
    def list_all(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.LoadBalancerListResult"]
        """Gets all the load balancers in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of LoadBalancerListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2017_03_01.models.LoadBalancerListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
