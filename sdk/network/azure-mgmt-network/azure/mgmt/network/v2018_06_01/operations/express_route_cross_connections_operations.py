...
class ExpressRouteCrossConnectionsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_06_01.models.ExpressRouteCrossConnectionPaged[~azure.mgmt.network.v2018_06_01.models.ExpressRouteCrossConnection]
        ...
        deserialized = models.ExpressRouteCrossConnectionPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ExpressRouteCrossConnectionPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.network.v2018_06_01.models.ExpressRouteCrossConnection
        :param dict custom_headers: headers that will be added to the request
    ...
    def list_routes_table(
        ...
        :return: An instance of LROPoller that returns
         ...
         raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_06_01.models.ExpressRouteCircuitsRoutesTableListResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_06_01.models.ExpressRouteCircuitsRoutesTableListResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
