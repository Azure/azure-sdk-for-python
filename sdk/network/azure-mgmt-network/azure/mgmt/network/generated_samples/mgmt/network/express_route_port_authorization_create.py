...
# USAGE
    python express_route_port_authorization_create.py
...
def main():
    ...
    response = client.express_route_port_authorizations.begin_create_or_update(
        resource_group_name="rg1",
        express_route_port_name="expressRoutePortName",
        authorization_name="authorizatinName",
        authorization_parameters={"properties": {}},
    ).result()
    print(response)
