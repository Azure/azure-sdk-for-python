...
class VirtualNetworkGatewayConnectionsOperations:
    ...
    async def begin_create_or_update(
     ...
     connection operation.
        :type parameters: ~azure.mgmt.network.v2018_12_01.models.VirtualNetworkGatewayConnection
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2018_12_01.models.VirtualNetworkGatewayConnection]
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2018_12_01.models.VirtualNetworkGatewayConnection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VirtualNetworkGatewayConnection"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
    ...
    group through Network resource provider.
     ...
     Shared key operation throughNetwork resource provider.
        :type parameters: ~azure.mgmt.network.v2018_12_01.models.ConnectionSharedKey
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2018_12_01.models.ConnectionSharedKey]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ConnectionSharedKey"]
    ...
    async def get_shared_key(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2018_12_01.models.ConnectionSharedKey
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ConnectionSharedKey"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
    ...
    connections created.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2018_12_01.models.VirtualNetworkGatewayConnectionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    group through Network resource provider.
     ...
     shared key operation through network resource provider.
        :type parameters: ~azure.mgmt.network.v2018_12_01.models.ConnectionResetSharedKey
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2018_12_01.models.ConnectionResetSharedKey]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
