...
from ...operations._local_network_gateways_operations import (
...
class LocalNetworkGatewaysOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(parameters, "LocalNetworkGateway")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2018_12_01.models.LocalNetworkGateway
        ...
        :return: An instance of AsyncLROPoller that returns either LocalNetworkGateway or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2018_12_01.models.LocalNetworkGateway]
    ...
    async def _delete_initial(self, resource_group_name: str, local_network_gateway_name: str, **kwargs: Any) -> None:
    ...
    async def _update_tags_initial(
        self, resource_group_name: str, local_network_gateway_name: str, parameters: "_models.TagsObject", **kwargs: Any
    ) -> "_models.LocalNetworkGateway":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.LocalNetworkGateway"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.LocalNetworkGatewayListResult"]:
        ...
        :return: An iterator like instance of either LocalNetworkGatewayListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2018_12_01.models.LocalNetworkGatewayListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
