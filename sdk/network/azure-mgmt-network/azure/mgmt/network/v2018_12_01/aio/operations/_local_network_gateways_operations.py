...
from ...operations._local_network_gateways_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_request, build_update_tags_request_initial
T = TypeVar('T')
