...
from ...operations._application_gateways_operations import build_backend_health_request_initial, build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_get_ssl_predefined_policy_request, build_list_all_request, build_list_available_request_headers_request, build_list_available_response_headers_request, build_list_available_server_variables_request, build_list_available_ssl_options_request, build_list_available_ssl_predefined_policies_request, build_list_available_waf_rule_sets_request, build_list_request, build_start_request_initial, build_stop_request_initial, build_update_tags_request_initial
T = TypeVar('T')
