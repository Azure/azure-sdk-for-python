...
class AzureFirewallRCAction(_serialization.Model):
    ...
    :ivar type: The type of action. Known values are: "Allow", "Deny", and "Alert".
    ...
    def __init__(
        ...
        """
        :keyword type: The type of action. Known values are: "Allow", "Deny", and "Alert".
...
class ExpressRouteCircuitSku(_serialization.Model):
    ...
    :ivar tier: The tier of the SKU. Possible values are 'Standard', 'Premium' or 'Local'. Known
     values are: "Standard", "Premium", "Basic", and "Local".
...
class ManagedServiceIdentity(_serialization.Model):
    ...
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.network.v2018_12_01.models.Components1Jq1T4ISchemasManagedserviceidentityPropertiesUserassignedidentitiesAdditionalproperties]  # pylint: disable=line-too-long
    """
