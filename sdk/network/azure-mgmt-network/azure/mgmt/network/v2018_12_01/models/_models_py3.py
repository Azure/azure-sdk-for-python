...
class ExpressRouteCircuitSku(msrest.serialization.Model):
    ...
    :vartype name: str
    :ivar tier: The tier of the SKU. Possible values are 'Standard', 'Premium' or 'Local'. Possible
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype name: str
        :keyword tier: The tier of the SKU. Possible values are 'Standard', 'Premium' or 'Local'.
