...
class NetworkProfilesOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2018_12_01.models.NetworkProfile
        :keyword api_version: Api Version. Default value is "2018-12-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_all(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either NetworkProfileListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2018_12_01.models.NetworkProfileListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-12-01")  # type: str
