...
def build_list_by_subscription_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Network/expressRouteGateways')
...
def build_list_by_resource_group_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteGateways')
    path_format_arguments = {
...
def build_create_or_update_request_initial(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteGateways/{expressRouteGatewayName}')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
...
class ExpressRouteGatewaysOperations(object):
    ...
    def list_by_subscription(
        ...
        :rtype: ~azure.mgmt.network.v2018_12_01.models.ExpressRouteGatewayList
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        express_route_gateway_name,  # type: str
        put_express_route_gateway_parameters,  # type: "_models.ExpressRouteGateway"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ExpressRouteGateway"
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.ExpressRouteGateway"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]

        json = self._serialize.body(put_express_route_gateway_parameters, "ExpressRouteGateway")
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.ExpressRouteGateway"]
        ...
        :return: An instance of LROPoller that returns either ExpressRouteGateway or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_12_01.models.ExpressRouteGateway]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.network.v2018_12_01.models.ExpressRouteGateway
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.ExpressRouteGateway"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
