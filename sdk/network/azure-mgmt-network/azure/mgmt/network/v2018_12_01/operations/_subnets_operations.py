...
class SubnetsOperations(object):
    ...
    def create_or_update(
        ...
        :param subnet_parameters: Parameters supplied to the create or update
         subnet operation.
        :type subnet_parameters: ~azure.mgmt.network.v2018_12_01.models.Subnet
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_12_01.models.Subnet]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_12_01.models.Subnet]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def _prepare_network_policies_initial(
            self, resource_group_name, virtual_network_name, subnet_name, prepare_network_policies_request_parameters, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def prepare_network_policies(
            self, resource_group_name, virtual_network_name, subnet_name, prepare_network_policies_request_parameters, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_12_01.models.SubnetPaged[~azure.mgmt.network.v2018_12_01.models.Subnet]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
