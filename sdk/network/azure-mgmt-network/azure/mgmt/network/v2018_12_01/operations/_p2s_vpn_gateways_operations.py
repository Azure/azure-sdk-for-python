...
class P2sVpnGatewaysOperations(object):
    ...
    def create_or_update(
        ...
        :type p2_svpn_gateway_parameters:
         ~azure.mgmt.network.v2018_12_01.models.P2SVpnGateway
        :param dict custom_headers: headers that will be added to the request
    ...
    def generate_vpn_profile(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_12_01.models.VpnProfileResponse]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_12_01.models.VpnProfileResponse]]
