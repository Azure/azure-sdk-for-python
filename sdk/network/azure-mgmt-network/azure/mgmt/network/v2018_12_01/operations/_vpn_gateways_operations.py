...
class VpnGatewaysOperations(object):
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2018_12_01.models.VpnGateway
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param vpn_gateway_parameters: Parameters supplied to create or Update a virtual wan vpn
         gateway.
        :type vpn_gateway_parameters: ~azure.mgmt.network.v2018_12_01.models.VpnGateway
        :keyword api_version: Api Version. Default value is "2018-12-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2018_12_01.models.VpnGateway]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-12-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :type vpn_gateway_parameters: ~azure.mgmt.network.v2018_12_01.models.TagsObject
        :keyword api_version: Api Version. Default value is "2018-12-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListVpnGatewaysResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2018_12_01.models.ListVpnGatewaysResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-12-01")  # type: str
