...
class NetworkManagementClient(NetworkManagementClientOperationsMixin):
    ...
    :vartype network_interfaces:
         azure.mgmt.network.v2016_09_01.aio.operations.NetworkInterfacesOperations
    :ivar application_gateways: ApplicationGatewaysOperations operations
    :vartype application_gateways:
         azure.mgmt.network.v2016_09_01.aio.operations.ApplicationGatewaysOperations
    ...
    :vartype express_route_circuit_authorizations:
         azure.mgmt.network.v2016_09_01.aio.operations.ExpressRouteCircuitAuthorizationsOperations
    ...
    :vartype express_route_circuit_peerings:
         azure.mgmt.network.v2016_09_01.aio.operations.ExpressRouteCircuitPeeringsOperations
    :ivar express_route_circuits: ExpressRouteCircuitsOperations operations
    :vartype express_route_circuits:
         azure.mgmt.network.v2016_09_01.aio.operations.ExpressRouteCircuitsOperations
    ...
    :vartype express_route_service_providers:
         azure.mgmt.network.v2016_09_01.aio.operations.ExpressRouteServiceProvidersOperations
    ...
    :vartype network_security_groups:
         azure.mgmt.network.v2016_09_01.aio.operations.NetworkSecurityGroupsOperations
    ...
    :vartype network_watchers:
         azure.mgmt.network.v2016_09_01.aio.operations.NetworkWatchersOperations
    :ivar packet_captures: PacketCapturesOperations operations
    :vartype packet_captures:
         azure.mgmt.network.v2016_09_01.aio.operations.PacketCapturesOperations
    :ivar public_ip_addresses: PublicIPAddressesOperations operations
    :vartype public_ip_addresses:
         azure.mgmt.network.v2016_09_01.aio.operations.PublicIPAddressesOperations
    ...
    :vartype virtual_networks:
         azure.mgmt.network.v2016_09_01.aio.operations.VirtualNetworksOperations
    ...
    :vartype virtual_network_peerings:
         azure.mgmt.network.v2016_09_01.aio.operations.VirtualNetworkPeeringsOperations
    :ivar virtual_network_gateways: VirtualNetworkGatewaysOperations operations
    :vartype virtual_network_gateways:
         azure.mgmt.network.v2016_09_01.aio.operations.VirtualNetworkGatewaysOperations
    ...
    :vartype virtual_network_gateway_connections:
         azure.mgmt.network.v2016_09_01.aio.operations.VirtualNetworkGatewayConnectionsOperations
    :ivar local_network_gateways: LocalNetworkGatewaysOperations operations
    :vartype local_network_gateways:
         azure.mgmt.network.v2016_09_01.aio.operations.LocalNetworkGatewaysOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `azure.mgmt.network.v2016_09_01.rest`.
