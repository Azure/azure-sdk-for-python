...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies')
...
def build_list_all_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies')
    path_format_arguments = {
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
    url = _format_url_section(url, **path_format_arguments)
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/{policyName}')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
...
class WebApplicationFirewallPoliciesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_08_01.models.WebApplicationFirewallPolicyListResult]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_08_01.models.WebApplicationFirewallPolicy
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.network.v2020_08_01.models.WebApplicationFirewallPolicy
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: WebApplicationFirewallPolicy, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2020_08_01.models.WebApplicationFirewallPolicy
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        json = self._serialize.body(parameters, "WebApplicationFirewallPolicy")
        ...
        **kwargs  # type: Any
        ...
        if cont_token is None:
            raw_result = self._delete_initial(
                resource_group_name=resource_group_name, policy_name=policy_name, cls=lambda x, y, z: x, **kwargs
            )
