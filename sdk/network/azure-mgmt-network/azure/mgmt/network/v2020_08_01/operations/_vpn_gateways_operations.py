...
def build_start_packet_capture_request_initial(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/startpacketcapture')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'gatewayName': _SERIALIZER.url("gateway_name", gateway_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_stop_packet_capture_request_initial(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/stoppacketcapture')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'gatewayName': _SERIALIZER.url("gateway_name", gateway_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
class VpnGatewaysOperations(object):
    ...
    def _start_packet_capture_initial(
        ...
        **kwargs  # type: Any
        ...
        if parameters is not None:
            json = self._serialize.body(parameters, "VpnGatewayPacketCaptureStartParameters")
        else:
            json = None
    ...
    def _stop_packet_capture_initial(
        ...
        **kwargs  # type: Any
        ...
        if parameters is not None:
            json = self._serialize.body(parameters, "VpnGatewayPacketCaptureStopParameters")
        else:
            json = None
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either ListVpnGatewaysResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_08_01.models.ListVpnGatewaysResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
