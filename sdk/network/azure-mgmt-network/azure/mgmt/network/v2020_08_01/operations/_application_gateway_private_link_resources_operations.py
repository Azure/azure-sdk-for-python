...
class ApplicationGatewayPrivateLinkResourcesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either ApplicationGatewayPrivateLinkResourceListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_08_01.models.ApplicationGatewayPrivateLinkResourceListResult]
