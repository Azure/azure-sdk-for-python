...
def build_delete_request_initial(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/securityPartnerProviders/{securityPartnerProviderName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "securityPartnerProviderName": _SERIALIZER.url("security_partner_provider_name", security_partner_provider_name, 'str'),
...
def build_list_by_resource_group_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/securityPartnerProviders")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
...
def build_list_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Network/securityPartnerProviders")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
    }
...
class SecurityPartnerProvidersOperations(object):
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_08_01.models.SecurityPartnerProvider
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(parameters, 'SecurityPartnerProvider')
    ...
    def begin_create_or_update(
        ...
        parameters: "_models.SecurityPartnerProvider",
        **kwargs: Any
    ) -> LROPoller["_models.SecurityPartnerProvider"]:
        ...
        :param parameters: Parameters supplied to the create or update Security Partner Provider
         operation.
        :type parameters: ~azure.mgmt.network.v2020_08_01.models.SecurityPartnerProvider
        :keyword api_version: Api Version. Default value is "2020-08-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no
         Retry-After header is present.
        :return: An instance of LROPoller that returns either SecurityPartnerProvider or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_08_01.models.SecurityPartnerProvider]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-08-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either SecurityPartnerProviderListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_08_01.models.SecurityPartnerProviderListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-08-01")  # type: str
