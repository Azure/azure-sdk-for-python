...
def build_delete_request_initial(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}')
...
def build_prepare_network_policies_request_initial(
    resource_group_name,  # type: str
    virtual_network_name,  # type: str
    subnet_name,  # type: str
    subscription_id,  # type: str
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}/PrepareNetworkPolicies')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'virtualNetworkName': _SERIALIZER.url("virtual_network_name", virtual_network_name, 'str'),
        'subnetName': _SERIALIZER.url("subnet_name", subnet_name, 'str'),
...
def build_unprepare_network_policies_request_initial(
    resource_group_name,  # type: str
    virtual_network_name,  # type: str
    subnet_name,  # type: str
    subscription_id,  # type: str
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}/UnprepareNetworkPolicies')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'virtualNetworkName': _SERIALIZER.url("virtual_network_name", virtual_network_name, 'str'),
        'subnetName': _SERIALIZER.url("subnet_name", subnet_name, 'str'),
...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets')
    path_format_arguments = {
        'resourceGroupName': _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        'virtualNetworkName': _SERIALIZER.url("virtual_network_name", virtual_network_name, 'str'),
        'subscriptionId': _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
class SubnetsOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_08_01.models.Subnet
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _create_or_update_initial(
        ...
        **kwargs  # type: Any
        ...
        json = self._serialize.body(subnet_parameters, "Subnet")
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.network.v2020_08_01.models.Subnet]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop("content_type", "application/json")  # type: Optional[str]
        polling = kwargs.pop("polling", True)  # type: Union[bool, PollingMethod]
    ...
    def _prepare_network_policies_initial(
        ...
        **kwargs  # type: Any
        ...
        json = self._serialize.body(prepare_network_policies_request_parameters, "PrepareNetworkPoliciesRequest")

        request = build_prepare_network_policies_request_initial(
            resource_group_name=resource_group_name,
            virtual_network_name=virtual_network_name,
            subnet_name=subnet_name,
            subscription_id=self._config.subscription_id,
    ...
    def begin_prepare_network_policies(
        ...
        **kwargs  # type: Any
        ...
        :type prepare_network_policies_request_parameters:
         ~azure.mgmt.network.v2020_08_01.models.PrepareNetworkPoliciesRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
    ...
    def _unprepare_network_policies_initial(
        ...
        **kwargs  # type: Any
        ...
        json = self._serialize.body(unprepare_network_policies_request_parameters, "UnprepareNetworkPoliciesRequest")

        request = build_unprepare_network_policies_request_initial(
            resource_group_name=resource_group_name,
            virtual_network_name=virtual_network_name,
            subnet_name=subnet_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
            json=json,
            template_url=self._unprepare_network_policies_initial.metadata["url"],
        )._to_pipeline_transport_request()
        request.url = self._client.format_url(request.url)
    ...
    def begin_unprepare_network_policies(
        ...
        **kwargs  # type: Any
        ...
        :type unprepare_network_policies_request_parameters:
         ~azure.mgmt.network.v2020_08_01.models.UnprepareNetworkPoliciesRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.network.v2020_08_01.models.SubnetListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
