...
from ...operations._web_categories_operations import build_get_request, build_list_by_subscription_request
...
class WebCategoriesOperations:
    """WebCategoriesOperations async operations.
    ...
    async def get(self, name: str, expand: Optional[str] = None, **kwargs: Any) -> "_models.AzureWebCategory":
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.AzureWebCategoryListResult"]:
        ...
        :return: An iterator like instance of either AzureWebCategoryListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_08_01.models.AzureWebCategoryListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
