...
from ...operations._azure_firewall_fqdn_tags_operations import build_list_all_request
...
class AzureFirewallFqdnTagsOperations:
    ...
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.AzureFirewallFqdnTagListResult"]:
        ...
        :return: An iterator like instance of either AzureFirewallFqdnTagListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_08_01.models.AzureFirewallFqdnTagListResult]
