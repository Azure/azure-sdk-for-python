...
from ...operations._network_interface_load_balancers_operations import build_list_request
T = TypeVar('T')
...
class NetworkInterfaceLoadBalancersOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_08_01.models.NetworkInterfaceLoadBalancerListResult]
