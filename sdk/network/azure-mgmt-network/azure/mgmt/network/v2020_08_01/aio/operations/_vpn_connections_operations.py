...
class VpnConnectionsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2020_08_01.models.VpnConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_start_packet_capture(
        ...
        **kwargs
        ...
        :param parameters: Vpn Connection packet capture parameters supplied to start packet capture on
         gateway connection.
        :type parameters: ~azure.mgmt.network.v2020_08_01.models.VpnConnectionPacketCaptureStartParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
    ...
    async def begin_stop_packet_capture(
        ...
        **kwargs
        ...
        :param parameters: Vpn Connection packet capture parameters supplied to stop packet capture on
         gateway connection.
        :type parameters: ~azure.mgmt.network.v2020_08_01.models.VpnConnectionPacketCaptureStopParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
    ...
    def list_by_vpn_gateway(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_08_01.models.ListVpnConnectionsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
