...
class VpnSiteLinksOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_08_01.models.VpnSiteLink
    ...
    def list_by_vpn_site(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListVpnSiteLinksResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_08_01.models.ListVpnSiteLinksResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-08-01")  # type: str
