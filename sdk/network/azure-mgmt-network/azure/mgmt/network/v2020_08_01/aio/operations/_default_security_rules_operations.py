...
class DefaultSecurityRulesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either SecurityRuleListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2020_08_01.models.SecurityRuleListResult]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.network.v2020_08_01.models.SecurityRule
        :raises: ~azure.core.exceptions.HttpResponseError
        """
