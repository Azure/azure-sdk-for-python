...
class ExpressRoutePortsLocationPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ExpressRoutePortsLocation <azure.mgmt.network.v2019_02_01.models.ExpressRoutePortsLocation>` object
    """
