...
class ExpressRouteCircuitAuthorizationPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ExpressRouteCircuitAuthorization <azure.mgmt.network.v2019_02_01.models.ExpressRouteCircuitAuthorization>` object
    """
...
class ExpressRoutePortPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ExpressRoutePort <azure.mgmt.network.v2019_02_01.models.ExpressRoutePort>` object
    """
...
class LoadBalancingRulePaged(Paged):
    """
    A paging container for iterating over a list of :class:`LoadBalancingRule <azure.mgmt.network.v2019_02_01.models.LoadBalancingRule>` object
    """
...
class NetworkInterfaceTapConfigurationPaged(Paged):
    """
    A paging container for iterating over a list of :class:`NetworkInterfaceTapConfiguration <azure.mgmt.network.v2019_02_01.models.NetworkInterfaceTapConfiguration>` object
    """
...
class RoutePaged(Paged):
    """
    A paging container for iterating over a list of :class:`Route <azure.mgmt.network.v2019_02_01.models.Route>` object
    """
...
class SubnetPaged(Paged):
    """
    A paging container for iterating over a list of :class:`Subnet <azure.mgmt.network.v2019_02_01.models.Subnet>` object
    """
...
class VirtualNetworkGatewayConnectionListEntityPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualNetworkGatewayConnectionListEntity <azure.mgmt.network.v2019_02_01.models.VirtualNetworkGatewayConnectionListEntity>` object
    """
...
class HubVirtualNetworkConnectionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`HubVirtualNetworkConnection <azure.mgmt.network.v2019_02_01.models.HubVirtualNetworkConnection>` object
    """
