...
class ManagedServiceIdentity(_serialization.Model):
    ...
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.network.v2019_02_01.models.Components1Jq1T4ISchemasManagedserviceidentityPropertiesUserassignedidentitiesAdditionalproperties]  # pylint: disable=line-too-long
    """
...
class OutboundRule(SubResource):
    ...
    :ivar protocol: The protocol for the outbound rule in load balancer. Possible values are:
     'Tcp', 'Udp', and 'All'. Known values are: "Tcp", "Udp", and "All".
...
class SecurityRule(SubResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar protocol: Network protocol this rule applies to. Possible values are 'Tcp', 'Udp',
     'Icmp', 'Esp', and '*'. Known values are: "Tcp", "Udp", "Icmp", "Esp", and "*".
