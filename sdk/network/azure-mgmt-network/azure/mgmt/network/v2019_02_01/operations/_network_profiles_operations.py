...
class NetworkProfilesOperations(object):
    ...
    def create_or_update(
        ...
        :param parameters: Parameters supplied to the create or update network
         profile operation.
        :type parameters:
         ~azure.mgmt.network.v2019_02_01.models.NetworkProfile
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2019_02_01.models.NetworkProfile]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2019_02_01.models.NetworkProfile]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
