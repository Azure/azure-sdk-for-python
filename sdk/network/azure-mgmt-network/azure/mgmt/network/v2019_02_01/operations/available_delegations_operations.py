...
class AvailableDelegationsOperations(object):
    ...
    def list(
        ...
        deserialized = models.AvailableDelegationPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.AvailableDelegationPaged(internal_paging, self._deserialize.dependencies, header_dict)
