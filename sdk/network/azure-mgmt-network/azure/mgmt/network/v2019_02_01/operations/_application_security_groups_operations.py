...
class ApplicationSecurityGroupsOperations(object):
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2019_02_01.models.ApplicationSecurityGroup]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2019_02_01.models.ApplicationSecurityGroup]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def update_tags(
            self, resource_group_name, application_security_group_name, tags=None, custom_headers=None, raw=False, polling=True, **operation_config):
