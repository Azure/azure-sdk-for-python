...
from ...operations._express_route_circuit_connections_operations import (
...
class ExpressRouteCircuitConnectionsOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(express_route_circuit_connection_parameters, "ExpressRouteCircuitConnection")
