...
class ApplicationGatewaysOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_02_01.models.ApplicationGatewayListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def backend_health(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2019_02_01.models.ApplicationGatewayBackendHealth
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ApplicationGatewayBackendHealth"]
    ...
    async def _backend_health_on_demand_initial(
        ...
        expand: Optional[str] = None,
        **kwargs
    ) -> "models.ApplicationGatewayBackendHealthOnDemand":
    ...
    async def backend_health_on_demand(
        self,
        resource_group_name: str,
        application_gateway_name: str,
        probe_request: "models.ApplicationGatewayOnDemandProbe",
        ...
        **kwargs
        ...
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: ApplicationGatewayBackendHealthOnDemand, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2019_02_01.models.ApplicationGatewayBackendHealthOnDemand
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ApplicationGatewayBackendHealthOnDemand"]
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    backend_health_on_demand.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/getBackendHealthOnDemand'}  # type: ignore
    ...
    def list_available_ssl_predefined_policies(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_02_01.models.ApplicationGatewayAvailableSslPredefinedPolicies]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
