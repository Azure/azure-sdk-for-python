...
from ...operations._vpn_sites_operations import (
...
class VpnSitesOperations:
    ...
    async def _create_or_update_initial(
        self, resource_group_name: str, vpn_site_name: str, vpn_site_parameters: "_models.VpnSite", **kwargs: Any
    ) -> "_models.VpnSite":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.VpnSite"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    async def _update_tags_initial(
        self, resource_group_name: str, vpn_site_name: str, vpn_site_parameters: "_models.TagsObject", **kwargs: Any
    ) -> "_models.VpnSite":
        cls = kwargs.pop("cls", None)  # type: ClsType["_models.VpnSite"]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    async def _delete_initial(self, resource_group_name: str, vpn_site_name: str, **kwargs: Any) -> None:
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_02_01.models.ListVpnSitesResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ListVpnSitesResult"]:
