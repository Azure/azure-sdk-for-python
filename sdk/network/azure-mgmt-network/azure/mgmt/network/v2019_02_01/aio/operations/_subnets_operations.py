...
from ...operations._subnets_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_request, build_prepare_network_policies_request_initial
T = TypeVar('T')
...
class SubnetsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_02_01.models.SubnetListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2019-02-01")  # type: str
