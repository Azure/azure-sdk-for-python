...
from ...operations._load_balancer_backend_address_pools_operations import build_get_request, build_list_request
T = TypeVar('T')
...
class LoadBalancerBackendAddressPoolsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2019_02_01.models.LoadBalancerBackendAddressPoolListResult]
