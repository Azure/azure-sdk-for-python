...
class NetworkManagementClient(
    ...
    :vartype application_gateways:
     azure.mgmt.network.v2019_02_01.aio.operations.ApplicationGatewaysOperations
    :ivar application_security_groups: ApplicationSecurityGroupsOperations operations
    :vartype application_security_groups:
     azure.mgmt.network.v2019_02_01.aio.operations.ApplicationSecurityGroupsOperations
    :ivar available_delegations: AvailableDelegationsOperations operations
    :vartype available_delegations:
     azure.mgmt.network.v2019_02_01.aio.operations.AvailableDelegationsOperations
    ...
    :vartype express_route_circuit_authorizations:
     azure.mgmt.network.v2019_02_01.aio.operations.ExpressRouteCircuitAuthorizationsOperations
    ...
    :vartype express_route_circuit_peerings:
     azure.mgmt.network.v2019_02_01.aio.operations.ExpressRouteCircuitPeeringsOperations
    ...
    :vartype express_route_circuit_connections:
     azure.mgmt.network.v2019_02_01.aio.operations.ExpressRouteCircuitConnectionsOperations
    ...
    :vartype peer_express_route_circuit_connections:
     azure.mgmt.network.v2019_02_01.aio.operations.PeerExpressRouteCircuitConnectionsOperations
    :ivar express_route_circuits: ExpressRouteCircuitsOperations operations
    :vartype express_route_circuits:
     azure.mgmt.network.v2019_02_01.aio.operations.ExpressRouteCircuitsOperations
    ...
    :vartype express_route_service_providers:
     azure.mgmt.network.v2019_02_01.aio.operations.ExpressRouteServiceProvidersOperations
    ...
    :vartype express_route_cross_connections:
     azure.mgmt.network.v2019_02_01.aio.operations.ExpressRouteCrossConnectionsOperations
    ...
    :vartype load_balancer_backend_address_pools:
     azure.mgmt.network.v2019_02_01.aio.operations.LoadBalancerBackendAddressPoolsOperations
    ...
    :vartype load_balancer_frontend_ip_configurations:
     azure.mgmt.network.v2019_02_01.aio.operations.LoadBalancerFrontendIPConfigurationsOperations
    :ivar inbound_nat_rules: InboundNatRulesOperations operations
    :vartype inbound_nat_rules:
     azure.mgmt.network.v2019_02_01.aio.operations.InboundNatRulesOperations
    ...
    :vartype load_balancer_load_balancing_rules:
     azure.mgmt.network.v2019_02_01.aio.operations.LoadBalancerLoadBalancingRulesOperations
    :ivar load_balancer_outbound_rules: LoadBalancerOutboundRulesOperations operations
    :vartype load_balancer_outbound_rules:
     azure.mgmt.network.v2019_02_01.aio.operations.LoadBalancerOutboundRulesOperations
    ...
    :vartype load_balancer_network_interfaces:
     azure.mgmt.network.v2019_02_01.aio.operations.LoadBalancerNetworkInterfacesOperations
    :ivar load_balancer_probes: LoadBalancerProbesOperations operations
    :vartype load_balancer_probes:
     azure.mgmt.network.v2019_02_01.aio.operations.LoadBalancerProbesOperations
    ...
    :vartype network_interfaces:
     azure.mgmt.network.v2019_02_01.aio.operations.NetworkInterfacesOperations
    ...
    :vartype network_interface_ip_configurations:
     azure.mgmt.network.v2019_02_01.aio.operations.NetworkInterfaceIPConfigurationsOperations
    ...
    :vartype network_interface_load_balancers:
     azure.mgmt.network.v2019_02_01.aio.operations.NetworkInterfaceLoadBalancersOperations
    ...
    :vartype network_interface_tap_configurations:
     azure.mgmt.network.v2019_02_01.aio.operations.NetworkInterfaceTapConfigurationsOperations
    :ivar network_profiles: NetworkProfilesOperations operations
    :vartype network_profiles:
     azure.mgmt.network.v2019_02_01.aio.operations.NetworkProfilesOperations
    :ivar network_security_groups: NetworkSecurityGroupsOperations operations
    :vartype network_security_groups:
     azure.mgmt.network.v2019_02_01.aio.operations.NetworkSecurityGroupsOperations
    ...
    :vartype default_security_rules:
     azure.mgmt.network.v2019_02_01.aio.operations.DefaultSecurityRulesOperations
    :ivar network_watchers: NetworkWatchersOperations operations
    :vartype network_watchers:
     azure.mgmt.network.v2019_02_01.aio.operations.NetworkWatchersOperations
    :ivar packet_captures: PacketCapturesOperations operations
    :vartype packet_captures:
     azure.mgmt.network.v2019_02_01.aio.operations.PacketCapturesOperations
    :ivar connection_monitors: ConnectionMonitorsOperations operations
    :vartype connection_monitors:
     azure.mgmt.network.v2019_02_01.aio.operations.ConnectionMonitorsOperations
    ...
    :vartype public_ip_addresses:
     azure.mgmt.network.v2019_02_01.aio.operations.PublicIPAddressesOperations
    :ivar public_ip_prefixes: PublicIPPrefixesOperations operations
    :vartype public_ip_prefixes:
     azure.mgmt.network.v2019_02_01.aio.operations.PublicIPPrefixesOperations
    ...
    :vartype route_filter_rules:
     azure.mgmt.network.v2019_02_01.aio.operations.RouteFilterRulesOperations
    ...
    :vartype bgp_service_communities:
     azure.mgmt.network.v2019_02_01.aio.operations.BgpServiceCommunitiesOperations
    :ivar service_endpoint_policies: ServiceEndpointPoliciesOperations operations
    :vartype service_endpoint_policies:
     azure.mgmt.network.v2019_02_01.aio.operations.ServiceEndpointPoliciesOperations
    ...
    :vartype service_endpoint_policy_definitions:
     azure.mgmt.network.v2019_02_01.aio.operations.ServiceEndpointPolicyDefinitionsOperations
    :ivar usages: UsagesOperations operations
    :vartype usages: azure.mgmt.network.v2019_02_01.aio.operations.UsagesOperations
    :ivar virtual_networks: VirtualNetworksOperations operations
    :vartype virtual_networks:
     azure.mgmt.network.v2019_02_01.aio.operations.VirtualNetworksOperations
    ...
    :vartype virtual_network_gateway_connections:
     azure.mgmt.network.v2019_02_01.aio.operations.VirtualNetworkGatewayConnectionsOperations
    :ivar local_network_gateways: LocalNetworkGatewaysOperations operations
    :vartype local_network_gateways:
     azure.mgmt.network.v2019_02_01.aio.operations.LocalNetworkGatewaysOperations
    :ivar virtual_network_taps: VirtualNetworkTapsOperations operations
    :vartype virtual_network_taps:
     azure.mgmt.network.v2019_02_01.aio.operations.VirtualNetworkTapsOperations
    ...
    :vartype vpn_sites_configuration:
     azure.mgmt.network.v2019_02_01.aio.operations.VpnSitesConfigurationOperations
    ...
    :vartype hub_virtual_network_connections:
     azure.mgmt.network.v2019_02_01.aio.operations.HubVirtualNetworkConnectionsOperations
    ...
    :vartype vpn_connections:
     azure.mgmt.network.v2019_02_01.aio.operations.VpnConnectionsOperations
    :ivar p2_svpn_server_configurations: P2SVpnServerConfigurationsOperations operations
    :vartype p2_svpn_server_configurations:
     azure.mgmt.network.v2019_02_01.aio.operations.P2SVpnServerConfigurationsOperations
    :ivar p2_svpn_gateways: P2SVpnGatewaysOperations operations
    :vartype p2_svpn_gateways:
     azure.mgmt.network.v2019_02_01.aio.operations.P2SVpnGatewaysOperations
    ...
    :vartype web_application_firewall_policies:
     azure.mgmt.network.v2019_02_01.aio.operations.WebApplicationFirewallPoliciesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.application_gateways = ApplicationGatewaysOperations(
            self._client, self._config, self._serialize, self._deserialize, "2019-02-01"
        )
        ...
        self.operations = Operations(self._client, self._config, self._serialize, self._deserialize, "2019-02-01")
        ...
        self.routes = RoutesOperations(self._client, self._config, self._serialize, self._deserialize, "2019-02-01")
        ...
        self.usages = UsagesOperations(self._client, self._config, self._serialize, self._deserialize, "2019-02-01")
        self.virtual_networks = VirtualNetworksOperations(
            self._client, self._config, self._serialize, self._deserialize, "2019-02-01"
        )
        self.subnets = SubnetsOperations(self._client, self._config, self._serialize, self._deserialize, "2019-02-01")
