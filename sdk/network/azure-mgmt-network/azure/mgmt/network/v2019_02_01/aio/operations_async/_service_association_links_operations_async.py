...
class ServiceAssociationLinksOperations:
    ...
    async def get(
        ...
        subnet_name: str,
        **kwargs
    ) -> "models.ServiceAssociationLinksListResult":
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}/ServiceAssociationLinks'}  # type: ignore
