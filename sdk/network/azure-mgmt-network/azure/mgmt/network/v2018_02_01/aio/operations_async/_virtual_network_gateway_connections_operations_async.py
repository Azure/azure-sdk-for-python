...
class VirtualNetworkGatewayConnectionsOperations:
    ...
    async def begin_update_tags(
     ...
     connection.
        ...
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: VirtualNetworkGatewayConnectionListEntity, or the result of cls(response)
        :rtype: ~azure.mgmt.network.v2018_02_01.models.VirtualNetworkGatewayConnectionListEntity
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VirtualNetworkGatewayConnectionListEntity"]
    ...
    group through Network resource provider.
     ...
     shared key operation through network resource provider.
        ...
        :rtype: ~azure.mgmt.network.v2018_02_01.models.ConnectionResetSharedKey
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ConnectionResetSharedKey"]
