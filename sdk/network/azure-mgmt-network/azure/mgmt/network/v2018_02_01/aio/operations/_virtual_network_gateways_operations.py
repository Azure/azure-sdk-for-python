...
from ...operations._virtual_network_gateways_operations import build_create_or_update_request_initial, build_delete_request_initial, build_generate_vpn_profile_request_initial, build_generatevpnclientpackage_request_initial, build_get_advertised_routes_request_initial, build_get_bgp_peer_status_request_initial, build_get_learned_routes_request_initial, build_get_request, build_get_vpn_profile_package_url_request_initial, build_get_vpnclient_ipsec_parameters_request_initial, build_list_connections_request, build_list_request, build_reset_request_initial, build_set_vpnclient_ipsec_parameters_request_initial, build_supported_vpn_devices_request, build_update_tags_request_initial, build_vpn_device_configuration_script_request
T = TypeVar('T')
...
class VirtualNetworkGatewaysOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2018_02_01.models.VirtualNetworkGateway
        ...
        :return: An instance of AsyncLROPoller that returns either VirtualNetworkGateway or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2018_02_01.models.VirtualNetworkGateway]
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either VirtualNetworkGatewayListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2018_02_01.models.VirtualNetworkGatewayListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-02-01")  # type: str
    ...
    def list_connections(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.network.v2018_02_01.models.VirtualNetworkGatewayListConnectionsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-02-01")  # type: str
    ...
    async def begin_generatevpnclientpackage(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the generate virtual network gateway VPN client
         package operation.
        :type parameters: ~azure.mgmt.network.v2018_02_01.models.VpnClientParameters
        :keyword content_type: Media type of the body sent to the API. Possible values are:
         "application/json" or "text/json". Default value is "application/json".
        :paramtype content_type: str
        :keyword api_version: Api Version. Default value is "2018-02-01". Note that overriding this
    ...
    async def begin_get_bgp_peer_status(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either BgpPeerStatusListResult or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2018_02_01.models.BgpPeerStatusListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-02-01")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def begin_get_learned_routes(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either GatewayRouteListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2018_02_01.models.GatewayRouteListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-02-01")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def begin_set_vpnclient_ipsec_parameters(
        ...
        **kwargs: Any
        ...
        :type vpnclient_ipsec_params: ~azure.mgmt.network.v2018_02_01.models.VpnClientIPsecParameters
        :keyword content_type: Media type of the body sent to the API. Possible values are:
         "application/json" or "text/json". Default value is "application/json".
        :paramtype content_type: str
        :keyword api_version: Api Version. Default value is "2018-02-01". Note that overriding this
        ...
        :return: An instance of AsyncLROPoller that returns either VpnClientIPsecParameters or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.network.v2018_02_01.models.VpnClientIPsecParameters]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-02-01")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
    ...
    async def vpn_device_configuration_script(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.network.v2018_02_01.models.VpnDeviceScriptParameters
        :keyword content_type: Media type of the body sent to the API. Possible values are:
         "application/json" or "text/json". Default value is "application/json".
        :paramtype content_type: str
        :keyword api_version: Api Version. Default value is "2018-02-01". Note that overriding this
