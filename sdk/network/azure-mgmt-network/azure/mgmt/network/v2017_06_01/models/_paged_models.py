...
class InboundNatRulePaged(Paged):
    """
    A paging container for iterating over a list of :class:`InboundNatRule <azure.mgmt.network.v2017_06_01.models.InboundNatRule>` object
    """
...
class LoadBalancingRulePaged(Paged):
    """
    A paging container for iterating over a list of :class:`LoadBalancingRule <azure.mgmt.network.v2017_06_01.models.LoadBalancingRule>` object
    """
...
class NetworkInterfaceIPConfigurationPaged(Paged):
    """
    A paging container for iterating over a list of :class:`NetworkInterfaceIPConfiguration <azure.mgmt.network.v2017_06_01.models.NetworkInterfaceIPConfiguration>` object
    """
...
class BgpServiceCommunityPaged(Paged):
    """
    A paging container for iterating over a list of :class:`BgpServiceCommunity <azure.mgmt.network.v2017_06_01.models.BgpServiceCommunity>` object
    """
...
class UsagePaged(Paged):
    """
    A paging container for iterating over a list of :class:`Usage <azure.mgmt.network.v2017_06_01.models.Usage>` object
    """
...
class VirtualNetworkPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualNetwork <azure.mgmt.network.v2017_06_01.models.VirtualNetwork>` object
    """
...
class VirtualNetworkPeeringPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualNetworkPeering <azure.mgmt.network.v2017_06_01.models.VirtualNetworkPeering>` object
    """
...
class VirtualNetworkGatewayConnectionListEntityPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualNetworkGatewayConnectionListEntity <azure.mgmt.network.v2017_06_01.models.VirtualNetworkGatewayConnectionListEntity>` object
    """
