...
from ...operations._virtual_networks_operations import build_check_ip_address_availability_request, build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_all_request, build_list_request, build_list_usage_request
T = TypeVar('T')
