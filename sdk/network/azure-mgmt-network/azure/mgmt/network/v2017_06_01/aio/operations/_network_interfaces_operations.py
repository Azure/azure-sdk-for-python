...
from ...operations._network_interfaces_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_effective_route_table_request_initial, build_get_request, build_get_virtual_machine_scale_set_network_interface_request, build_list_all_request, build_list_effective_network_security_groups_request_initial, build_list_request, build_list_virtual_machine_scale_set_network_interfaces_request, build_list_virtual_machine_scale_set_vm_network_interfaces_request
T = TypeVar('T')
