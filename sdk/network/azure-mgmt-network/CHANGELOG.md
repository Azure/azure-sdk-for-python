...
### Features Added
  ...
  - Added model `ArmAcceptedLroResponse`
  ...
  - Added model `GeneratevpnclientpackageFinalResult`
  - Added model `GetIkeSasFinalResult`
  - Added model `GetVpnProfilePackageUrlFinalResult`
  ...
  - Added enum `NetworkProvisioningState`
  ...
  - Added model `ProxyResourcewithoutEtag`
  ...
  - Added model `ResourceWithReadOnlyID`
  - Added model `ResourceWithReadOnlyNameAndID`
  - Added model `ResourceWithRequiredLocation`
  - Added model `ResourceWithWritableName`
  ...
  - Added enum `SingletonResource`
  - Added model `StartExpressRouteSiteFailoverSimulationFinalResult`
  - Added model `StartPacketCaptureFinalResult`
  - Added model `StartPacketCaptureFinalResult1`
  - Added model `StartPacketCaptureFinalResult2`
  - Added model `StopExpressRouteSiteFailoverSimulationFinalResult`
  - Added model `StopPacketCaptureFinalResult`
  - Added model `StopPacketCaptureFinalResult1`
  - Added model `StopPacketCaptureFinalResult2`
  ...
  - Added model `VpnConnectionsStartPacketCaptureFinalResult`
  - Added model `VpnConnectionsStopPacketCaptureFinalResult`
...
### Breaking Changes
  ...
  - Model `ServiceGateway` deleted or renamed its instance variable `tags`
  - Model `ServiceGateway` deleted or renamed its instance variable `location`
  ...
  - Deleted or renamed method `NetworkInterfacesOperations.begin_create_or_update`
  - Deleted or renamed method `NetworkInterfacesOperations.begin_delete`
  - Deleted or renamed method `NetworkInterfacesOperations.begin_get_effective_route_table`
  - Deleted or renamed method `NetworkInterfacesOperations.begin_list_effective_network_security_groups`
  - Deleted or renamed method `NetworkInterfacesOperations.get`
  - Deleted or renamed method `NetworkInterfacesOperations.get_cloud_service_network_interface`
  - Deleted or renamed method `NetworkInterfacesOperations.get_virtual_machine_scale_set_network_interface`
  - Deleted or renamed method `NetworkInterfacesOperations.list`
  - Deleted or renamed method `NetworkInterfacesOperations.list_all`
  - Deleted or renamed method `NetworkInterfacesOperations.list_cloud_service_network_interfaces`
  - Deleted or renamed method `NetworkInterfacesOperations.list_cloud_service_role_instance_network_interfaces`
  - Deleted or renamed method `NetworkInterfacesOperations.list_virtual_machine_scale_set_vm_network_interfaces`
  - Deleted or renamed method `NetworkInterfacesOperations.update_tags`
  - Deleted or renamed method `PublicIPAddressesOperations.begin_create_or_update`
  - Deleted or renamed method `PublicIPAddressesOperations.begin_ddos_protection_status`
  - Deleted or renamed method `PublicIPAddressesOperations.begin_delete`
  - Deleted or renamed method `PublicIPAddressesOperations.begin_disassociate_cloud_service_reserved_public_ip`
  - Deleted or renamed method `PublicIPAddressesOperations.begin_reserve_cloud_service_public_ip_address`
  - Deleted or renamed method `PublicIPAddressesOperations.get`
  - Deleted or renamed method `PublicIPAddressesOperations.get_cloud_service_public_ip_address`
  - Deleted or renamed method `PublicIPAddressesOperations.get_virtual_machine_scale_set_public_ip_address`
  - Deleted or renamed method `PublicIPAddressesOperations.list`
  - Deleted or renamed method `PublicIPAddressesOperations.list_all`
  - Deleted or renamed method `PublicIPAddressesOperations.list_cloud_service_public_ip_addresses`
  - Deleted or renamed method `PublicIPAddressesOperations.list_cloud_service_role_instance_public_ip_addresses`
  - Deleted or renamed method `PublicIPAddressesOperations.list_virtual_machine_scale_set_vm_public_ip_addresses`
  - Deleted or renamed method `PublicIPAddressesOperations.update_tags`
