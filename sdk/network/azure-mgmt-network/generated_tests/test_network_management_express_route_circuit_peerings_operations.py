...
class TestNetworkManagementExpressRouteCircuitPeeringsOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_express_route_circuit_peerings_begin_delete(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_express_route_circuit_peerings_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_express_route_circuit_peerings_begin_create_or_update(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_express_route_circuit_peerings_list(self, resource_group):
