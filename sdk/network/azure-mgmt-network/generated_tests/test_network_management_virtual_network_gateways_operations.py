...
class TestNetworkManagementVirtualNetworkGatewaysOperations(AzureMgmtRecordedTestCase):
                        ...
                        "vpnClientRevokedCertificates": [
                            {
                                ...
                                "id": "str",
                                "name": "str",
                                "properties": {"provisioningState": "str", "thumbprint": "str"},
                            }
                        ],
                        "vpnClientRootCertificates": [
                            {
                                "properties": {"publicCertData": "str", "provisioningState": "str"},
                                "etag": "str",
                                "id": "str",
                                "name": "str",
                            }
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_virtual_network_gateways_begin_get_effective_routes(self, resource_group):
        response = self.client.virtual_network_gateways.begin_get_effective_routes(
            resource_group_name=resource_group.name,
            virtual_network_gateway_name="str",
            api_version="2025-09-01",
        ).result()  # call '.result()' to poll until service return final result
