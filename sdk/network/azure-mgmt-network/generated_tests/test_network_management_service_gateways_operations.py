...
class TestNetworkManagementServiceGatewaysOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(NetworkManagementClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_service_gateways_begin_delete(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_service_gateways_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_service_gateways_begin_create_or_update(self, resource_group):
        response = self.client.service_gateways.begin_create_or_update(
            resource_group_name=resource_group.name,
            service_gateway_name="str",
            parameters={
                "location": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_service_gateways_update_tags(self, resource_group):
        response = self.client.service_gateways.update_tags(
            resource_group_name=resource_group.name,
            service_gateway_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_service_gateways_begin_update_address_locations(self, resource_group):
        response = self.client.service_gateways.begin_update_address_locations(
            resource_group_name=resource_group.name,
            service_gateway_name="str",
            parameters={
                "action": "str",
                "addressLocations": [
                    {
                        "addressLocation": "str",
                        "addressUpdateAction": "str",
                        "addresses": [{"address": "str", "services": ["str"]}],
                    }
                ],
            },
            api_version="2025-05-01",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_service_gateways_begin_update_services(self, resource_group):
        response = self.client.service_gateways.begin_update_services(
            resource_group_name=resource_group.name,
            service_gateway_name="str",
            parameters={
                "action": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_service_gateways_get_address_locations(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_service_gateways_get_services(self, resource_group):
