...
class TestNetworkManagementSubnetsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(NetworkManagementClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_subnets_get(self, resource_group):
        response = await self.client.subnets.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_subnets_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.subnets.begin_create_or_update(
                resource_group_name=resource_group.name,
                virtual_network_name="str",
                subnet_name="str",
                subnet_parameters={
                        ...
                        "delegations": [
                            {
                                ...
                                "id": "str",
                                "name": "str",
                                "properties": {"actions": ["str"], "provisioningState": "str", "serviceName": "str"},
                                "type": "str",
                            }
                        ],
                        ...
                        "resourceNavigationLinks": [
                            {
                                ...
                                "id": "str",
                                "name": "str",
                                "properties": {"link": "str", "linkedResourceType": "str", "provisioningState": "str"},
                                "type": "str",
                            }
                        ],
                        "routeTable": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_subnets_begin_unprepare_network_policies(self, resource_group):
        response = await (
            await self.client.subnets.begin_unprepare_network_policies(
                resource_group_name=resource_group.name,
                virtual_network_name="str",
                subnet_name="str",
