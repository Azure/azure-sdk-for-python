...
class TestNetworkManagementAuthenticationPoliciesOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(NetworkManagementClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_authentication_policies_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_authentication_policies_begin_create_or_update(self, resource_group):
        response = self.client.authentication_policies.begin_create_or_update(
            resource_group_name=resource_group.name,
            authentication_policy_name="str",
            resource={
                "etag": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_authentication_policies_update(self, resource_group):
        response = self.client.authentication_policies.update(
            resource_group_name=resource_group.name,
            authentication_policy_name="str",
            parameters={
                "identity": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_authentication_policies_delete(self, resource_group):
