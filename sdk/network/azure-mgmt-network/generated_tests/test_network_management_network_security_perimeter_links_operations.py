...
class TestNetworkManagementNetworkSecurityPerimeterLinksOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_network_security_perimeter_links_create_or_update(self, resource_group):
        response = self.client.network_security_perimeter_links.create_or_update(
            resource_group_name=resource_group.name,
            network_security_perimeter_name="str",
            link_name="str",
            parameters={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_network_security_perimeter_links_begin_delete(self, resource_group):
        response = self.client.network_security_perimeter_links.begin_delete(
            resource_group_name=resource_group.name,
            network_security_perimeter_name="str",
            link_name="str",
            api_version="2024-07-01",
