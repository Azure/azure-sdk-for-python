...
class TestNetworkManagementVirtualNetworksOperations(AzureMgmtRecordedTestCase):
    ...
    def test_virtual_networks_begin_create_or_update(self, resource_group):
        response = self.client.virtual_networks.begin_create_or_update(
            ...
            parameters={
                ...
                "defaultPublicNatGateway": {"id": "str"},
                "dhcpOptions": {"dnsServers": ["str"]},
                "enableDdosProtection": False,
                "enableVmProtection": False,
                "encryption": {"enabled": bool, "enforcement": "str"},
                "etag": "str",
                ...
                "location": "str",
                "name": "str",
                "privateEndpointVNetPolicies": "str",
                "provisioningState": "str",
                "resourceGuid": "str",
                "subnets": [
                    {
