...
class TestNetworkManagementRouteTablesOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_route_tables_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_route_tables_begin_create_or_update(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_route_tables_update_tags(self, resource_group):
        response = self.client.route_tables.update_tags(
            resource_group_name=resource_group.name,
            route_table_name="str",
