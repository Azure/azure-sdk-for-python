...
class TestNetworkManagementScopeConnectionsOperations(AzureMgmtRecordedTestCase):
    ...
    def test_scope_connections_create_or_update(self, resource_group):
        response = self.client.scope_connections.create_or_update(
            ...
            parameters={
                ...
                "id": "str",
                "name": "str",
                "properties": {"connectionState": "str", "description": "str", "resourceId": "str", "tenantId": "str"},
                "systemData": {
