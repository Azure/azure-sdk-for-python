...
class TestNetworkManagementApplicationGatewaysOperations(AzureMgmtRecordedTestCase):
    ...
    def test_application_gateways_begin_create_or_update(self, resource_group):
        response = self.client.application_gateways.begin_create_or_update(
            ...
            parameters={
                ...
                "frontendPorts": [
                    {"etag": "str", "id": "str", "name": "str", "port": 0, "provisioningState": "str", "type": "str"}
                ],
                ...
                "sslProfiles": [
                    {
                        "clientAuthConfiguration": {"verifyClientCertIssuerDN": bool, "verifyClientRevocation": "str"},
                        "etag": "str",
                        "id": "str",
                        "name": "str",
                        "provisioningState": "str",
