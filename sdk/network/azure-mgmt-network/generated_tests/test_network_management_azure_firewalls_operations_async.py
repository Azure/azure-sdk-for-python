...
class TestNetworkManagementAzureFirewallsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(NetworkManagementClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_azure_firewalls_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_azure_firewalls_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.azure_firewalls.begin_create_or_update(
                resource_group_name=resource_group.name,
                azure_firewall_name="str",
                parameters={
                    "etag": "str",
                    ...
                    "name": "str",
                    "properties": {
                        "afcConfiguration": {"serviceEndpoint": "str"},
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_azure_firewalls_begin_update_tags(self, resource_group):
        response = await (
            await self.client.azure_firewalls.begin_update_tags(
                resource_group_name=resource_group.name,
                azure_firewall_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_azure_firewalls_begin_list_learned_prefixes(self, resource_group):
        response = await (
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_azure_firewalls_begin_packet_capture(self, resource_group):
        response = await (
            await self.client.azure_firewalls.begin_packet_capture(
                resource_group_name=resource_group.name,
                azure_firewall_name="str",
                parameters={
                    "durationInSeconds": 0,
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_azure_firewalls_begin_packet_capture_operation(self, resource_group):
        response = await (
            await self.client.azure_firewalls.begin_packet_capture_operation(
                resource_group_name=resource_group.name,
                azure_firewall_name="str",
                parameters={
                    "durationInSeconds": 0,
