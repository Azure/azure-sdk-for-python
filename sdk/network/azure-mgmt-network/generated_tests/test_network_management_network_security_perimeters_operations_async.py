...
class TestNetworkManagementNetworkSecurityPerimetersOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(NetworkManagementClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_network_security_perimeters_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_network_security_perimeters_create_or_update(self, resource_group):
        response = await self.client.network_security_perimeters.create_or_update(
            resource_group_name=resource_group.name,
            network_security_perimeter_name="str",
            parameters={
                "location": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_network_security_perimeters_begin_delete(self, resource_group):
        response = await (
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_network_security_perimeters_patch(self, resource_group):
        response = await self.client.network_security_perimeters.patch(
            resource_group_name=resource_group.name,
            network_security_perimeter_name="str",
