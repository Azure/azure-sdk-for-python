...
class TestNetworkManagementExpressRouteCircuitConnectionsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_express_route_circuit_connections_get(self, resource_group):
        response = self.client.express_route_circuit_connections.get(
            resource_group_name=resource_group.name,
            circuit_name="str",
            peering_name="str",
            connection_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_express_route_circuit_connections_begin_create_or_update(self, resource_group):
        response = self.client.express_route_circuit_connections.begin_create_or_update(
            resource_group_name=resource_group.name,
            circuit_name="str",
            peering_name="str",
            connection_name="str",
