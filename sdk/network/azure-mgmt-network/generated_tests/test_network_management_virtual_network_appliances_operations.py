...
class TestNetworkManagementVirtualNetworkAppliancesOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_virtual_network_appliances_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_virtual_network_appliances_begin_create_or_update(self, resource_group):
        response = self.client.virtual_network_appliances.begin_create_or_update(
            resource_group_name=resource_group.name,
            virtual_network_appliance_name="str",
            parameters={
                "bandwidthInGbps": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_virtual_network_appliances_update_tags(self, resource_group):
        response = self.client.virtual_network_appliances.update_tags(
            resource_group_name=resource_group.name,
            virtual_network_appliance_name="str",
