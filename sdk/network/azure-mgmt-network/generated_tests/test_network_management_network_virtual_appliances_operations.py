...
class TestNetworkManagementNetworkVirtualAppliancesOperations(AzureMgmtRecordedTestCase):
        ...
        response = self.client.network_virtual_appliances.begin_create_or_update(
            ...
            parameters={
                ...
                "properties": {
                    ...
                    "migrationStatus": {"migrationPhase": "str", "migrationPhaseStatus": "str", "migrationType": "str"},
                    "networkProfile": {
                    ...
                    "nvaInterfaceConfigurations": [{"name": "str", "subnet": {"id": "str"}, "type": ["str"]}],
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_network_virtual_appliances_begin_prepare_migration(self, resource_group):
        response = self.client.network_virtual_appliances.begin_prepare_migration(
            resource_group_name=resource_group.name,
            network_virtual_appliance_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_network_virtual_appliances_begin_execute_migration(self, resource_group):
        response = self.client.network_virtual_appliances.begin_execute_migration(
            resource_group_name=resource_group.name,
            network_virtual_appliance_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_network_virtual_appliances_begin_commit_migration(self, resource_group):
        response = self.client.network_virtual_appliances.begin_commit_migration(
            resource_group_name=resource_group.name,
            network_virtual_appliance_name="str",
            body={"properties": {"migrationType": "str"}},
            api_version="2025-09-01",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_network_virtual_appliances_begin_abort_migration(self, resource_group):
