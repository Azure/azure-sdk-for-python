...
class TestNetworkManagementDscpConfigurationOperationsAsync(AzureMgmtRecordedTestCase):
        ...
        response = await (
            await self.client.dscp_configuration.begin_create_or_update(
                ...
                parameters={
                    ...
                    "destinationIpRanges": [{"endIP": "str", "startIP": "str"}],
                    "destinationPortRanges": [{"end": 0, "start": 0}],
                    "etag": "str",
                    "id": "str",
                    "location": "str",
                    "markings": [0],
                    ...
                    "qosDefinitionCollection": [
                        {
                            ...
                            "markings": [0],
                            "protocol": "str",
                            "sourceIpRanges": [{"endIP": "str", "startIP": "str"}],
                            "sourcePortRanges": [{"end": 0, "start": 0}],
                        }
                    ],
                    "resourceGuid": "str",
                    "sourceIpRanges": [{"endIP": "str", "startIP": "str"}],
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_dscp_configuration_begin_delete(self, resource_group):
        response = await (
