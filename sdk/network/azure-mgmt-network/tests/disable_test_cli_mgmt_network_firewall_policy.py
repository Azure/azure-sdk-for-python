...
class TestMgmtNetwork(AzureMgmtRecordedTestCase):
    ...
    def test_network(self, resource_group):
        ...
        BODY = {"tags": {"key1": "value1"}, "location": "West US", "threat_intel_mode": "Alert"}
        ...
        result = self.mgmt_client.firewall_policy_rule_groups.begin_create_or_update(
        ...
        result = self.mgmt_client.firewall_policy_rule_groups.get(
            resource_group_name=RESOURCE_GROUP,
            firewall_policy_name=FIREWALL_POLICY_NAME,
            rule_group_name=RULE_GROUP_NAME,
        )
        ...
        result = self.mgmt_client.firewall_policy_rule_groups.list(
        ...
        result = self.mgmt_client.firewall_policy_rule_groups.begin_delete(
            resource_group_name=RESOURCE_GROUP,
            firewall_policy_name=FIREWALL_POLICY_NAME,
            rule_group_name=RULE_GROUP_NAME,
        )
