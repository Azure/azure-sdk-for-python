...
class PrivateZonesOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either PrivateZoneListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.privatedns.models.PrivateZoneListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
