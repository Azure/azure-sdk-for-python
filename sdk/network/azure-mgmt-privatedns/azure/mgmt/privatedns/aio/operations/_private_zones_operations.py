...
from ...operations._private_zones_operations import (
...
class PrivateZonesOperations:
    ...
    async def _create_or_update_initial(
        ...
        parameters: Union[_models.PrivateZone, IO[bytes]],
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.privatedns.models.PrivateZone or IO[bytes]
        :param if_match: The ETag of the Private DNS zone. Omit this value to always overwrite the
         current zone. Specify the last-seen ETag value to prevent accidentally overwriting any
         concurrent changes. Default value is None.
        :type if_match: str
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("PrivateZone", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
