...
def build_record_sets_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/{recordType}/{relativeRecordSetName}"
...
def build_record_sets_list_by_type_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/{recordType}"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "privateZoneName": _SERIALIZER.url("private_zone_name", private_zone_name, "str"),
...
def build_record_sets_list_request(
    resource_group_name: str,
    private_zone_name: str,
    subscription_id: str,
    *,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/aLL"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "privateZoneName": _SERIALIZER.url("private_zone_name", private_zone_name, "str"),
...
def build_private_zones_get_request(
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "privateZoneName": _SERIALIZER.url("private_zone_name", private_zone_name, "str"),
...
def build_private_zones_create_or_update_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    private_zone_name: str,
    subscription_id: str,
    *,
...
def build_private_zones_update_request(
    resource_group_name: str,
    private_zone_name: str,
    subscription_id: str,
    *,
...
def build_private_zones_delete_request(
    resource_group_name: str,
    private_zone_name: str,
    subscription_id: str,
    *,
...
def build_private_zones_list_by_resource_group_request(  # pylint: disable=name-too-long
...
def build_private_zones_list_request(subscription_id: str, *, top: Optional[int] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/providers/Microsoft.Network/privateDnsZones"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
def build_virtual_network_links_get_request(
    resource_group_name: str,
    private_zone_name: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/virtualNetworkLinks/{virtualNetworkLinkName}"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "privateZoneName": _SERIALIZER.url("private_zone_name", private_zone_name, "str"),
...
def build_virtual_network_links_create_or_update_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    private_zone_name: str,
    virtual_network_link_name: str,
    subscription_id: str,
...
def build_virtual_network_links_update_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    private_zone_name: str,
    virtual_network_link_name: str,
    subscription_id: str,
...
def build_virtual_network_links_delete_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    private_zone_name: str,
    virtual_network_link_name: str,
    subscription_id: str,
...
def build_virtual_network_links_list_request(
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/virtualNetworkLinks"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "privateZoneName": _SERIALIZER.url("private_zone_name", private_zone_name, "str"),
...
class RecordSetsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.privatedns.NetworkClient`'s
...
class PrivateZonesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :keyword match_condition: The match condition to use upon the etag. Default value is None.
        :paramtype match_condition: ~azure.core.MatchConditions
        :return: An instance of LROPoller that returns PrivateZone. The PrivateZone is compatible with
         MutableMapping
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.PrivateZone].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.PrivateZone](
    ...
    @distributed_trace
    def list(self, *, top: Optional[int] = None, **kwargs: Any) -> ItemPaged["_models.PrivateZone"]:
...
class VirtualNetworkLinksOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :keyword match_condition: The match condition to use upon the etag. Default value is None.
        :paramtype match_condition: ~azure.core.MatchConditions
        :return: An instance of LROPoller that returns VirtualNetworkLink. The VirtualNetworkLink is
    ...
    ) -> ItemPaged["_models.VirtualNetworkLink"]:
