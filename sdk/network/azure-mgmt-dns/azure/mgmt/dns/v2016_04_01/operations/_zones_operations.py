...
class ZonesOperations(object):
    ...
    def _delete_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["_models.ZoneDeleteResult"]
    ...
    def begin_delete(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.ZoneDeleteResult"]
        ...
        :return: An instance of LROPoller that returns either ZoneDeleteResult or the result of cls(response)
