...
from ...operations._zones_operations import build_create_or_update_request, build_delete_request_initial, build_get_request, build_list_by_resource_group_request, build_list_request
T = TypeVar('T')
...
class ZonesOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        api_version = kwargs.pop('api_version', "2016-04-01")  # type: str
    ...
    async def begin_delete(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ZoneDeleteResult or the result of
         cls(response)
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ZoneDeleteResult"]
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dns.v2016_04_01.models.ZoneListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2016-04-01")  # type: str
