...
class ZonesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.dns.v2016_04_01.aio.DnsManagementClient`'s
    ...
    async def begin_delete(
        ...
        if cont_token:
            return AsyncLROPoller[_models.ZoneDeleteResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ZoneDeleteResult](
