...
class DnsManagementClient(object):
    ...
    :vartype record_sets: azure.mgmt.dns.v2016_04_01.aio.operations.RecordSetsOperations
    :ivar zones: ZonesOperations operations
    :vartype zones: azure.mgmt.dns.v2016_04_01.aio.operations.ZonesOperations
