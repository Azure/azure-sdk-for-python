...
class ZonesOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.dns.v2018_05_01.models.Zone or IO[bytes]
        :param if_match: The etag of the DNS zone. Omit this value to always overwrite the current
         zone. Specify the last-seen etag value to prevent accidentally overwriting any concurrent
         changes. Default value is None.
        :type if_match: str
    ...
    def update(
        ...
        resource_group_name: str,
        zone_name: str,
        parameters: Union[_models.ZoneUpdate, IO[bytes]],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.Zone:
        """Updates a DNS zone. Does not modify DNS records within the zone.
        ...
        :type parameters: ~azure.mgmt.dns.v2018_05_01.models.ZoneUpdate or IO[bytes]
        :param if_match: The etag of the DNS zone. Omit this value to always overwrite the current
         zone. Specify the last-seen etag value to prevent accidentally overwriting any concurrent
         changes. Default value is None.
        :type if_match: str
