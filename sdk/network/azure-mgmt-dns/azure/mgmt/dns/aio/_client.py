...
class DnsManagementClient:
    ...
    :vartype dnssec_configs: azure.mgmt.dns.aio.operations.DnssecConfigsOperations
    :ivar record_sets: RecordSetsOperations operations
    :vartype record_sets: azure.mgmt.dns.aio.operations.RecordSetsOperations
    :ivar zones: ZonesOperations operations
    :vartype zones: azure.mgmt.dns.aio.operations.ZonesOperations
    :ivar dns_resource_reference: DnsResourceReferenceOperations operations
    :vartype dns_resource_reference: azure.mgmt.dns.aio.operations.DnsResourceReferenceOperations
    ...
    :keyword api_version: The API version to use for this operation. Known values are
     "2023-07-01-preview" and None. Default value is None. If not set, the operation's default API
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.dnssec_configs = DnssecConfigsOperations(self._client, self._config, self._serialize, self._deserialize)
