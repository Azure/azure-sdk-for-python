...
def build_check_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Network/checkFrontDoorNameAvailability')
...
class FrontDoorNameAvailabilityWithSubscriptionOperations(object):
