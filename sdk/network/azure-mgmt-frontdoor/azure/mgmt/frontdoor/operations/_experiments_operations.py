...
class ExperimentsOperations:
    ...
    def _create_or_update_initial(
        ...
        profile_name: str,
        experiment_name: str,
        parameters: Union[_models.Experiment, IO[bytes]],
        **kwargs: Any
    ) -> _models.Experiment:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The Experiment resource. Is either a Experiment type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.frontdoor.models.Experiment or IO[bytes]
        :return: An instance of LROPoller that returns either Experiment or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.frontdoor.models.Experiment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        profile_name: str,
        experiment_name: str,
        parameters: Union[_models.ExperimentUpdateModel, IO[bytes]],
        **kwargs: Any
    ) -> _models.Experiment:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.frontdoor.models.ExperimentUpdateModel or IO[bytes]
        :return: An instance of LROPoller that returns either Experiment or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.frontdoor.models.Experiment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
