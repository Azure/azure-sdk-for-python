...
class ReportsOperations:
    ...
    def get_latency_scorecards(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("LatencyScorecard", pipeline_response.http_response)
    ...
    def get_timeseries(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("Timeseries", pipeline_response.http_response)
