...
class Backend(Model):
    ...
    :type address: str
    :param private_link_resource_id: If this backend is private, provide the
     Private Link resource Id. Populating this optional field indicates that
    ...
    def __init__(self, *, address: str=None, private_link_resource_id: str=None, private_link_approval_message: str=None, http_port: int=None, https_port: int=None, enabled_state=None, priority: int=None, weight: int=None, backend_host_header: str=None, **kwargs) -> None:
