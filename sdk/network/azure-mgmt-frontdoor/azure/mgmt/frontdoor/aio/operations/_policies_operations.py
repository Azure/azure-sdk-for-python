...
class PoliciesOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("WebApplicationFirewallPolicy", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either WebApplicationFirewallPolicy or the
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.frontdoor.models.WebApplicationFirewallPolicy or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either WebApplicationFirewallPolicy or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.frontdoor.models.WebApplicationFirewallPolicy]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.frontdoor.models.TagsObject or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either WebApplicationFirewallPolicy or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.frontdoor.models.WebApplicationFirewallPolicy]
