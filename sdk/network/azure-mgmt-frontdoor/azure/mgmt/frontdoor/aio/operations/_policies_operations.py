...
class PoliciesOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.frontdoor.models.WebApplicationFirewallPolicyList]
    ...
    async def begin_create_or_update(
        ...
        **kwargs
        ...
        :return: An instance of AsyncLROPoller that returns either WebApplicationFirewallPolicy or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.frontdoor.models.WebApplicationFirewallPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
