...
from ...operations._frontend_endpoints_operations import build_disable_https_request_initial, build_enable_https_request_initial, build_get_request, build_list_by_front_door_request
T = TypeVar('T')
...
class FrontendEndpointsOperations:
    ...
    def list_by_front_door(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either FrontendEndpointsListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.frontdoor.models.FrontendEndpointsListResult]
    ...
    async def _enable_https_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_enable_https_request_initial(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            front_door_name=front_door_name,
            frontend_endpoint_name=frontend_endpoint_name,
    ...
    @distributed_trace_async
    async def begin_enable_https(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        front_door_name: str,
        frontend_endpoint_name: str,
    ...
    async def _disable_https_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_disable_https_request_initial(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            front_door_name=front_door_name,
            frontend_endpoint_name=frontend_endpoint_name,
    ...
    @distributed_trace_async
    async def begin_disable_https(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        front_door_name: str,
        frontend_endpoint_name: str,
