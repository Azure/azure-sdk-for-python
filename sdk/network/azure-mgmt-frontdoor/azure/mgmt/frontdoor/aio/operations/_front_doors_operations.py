...
from ...operations._front_doors_operations import (
...
class FrontDoorsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.FrontDoor"]:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.FrontDoor"]:
    ...
    async def _create_or_update_initial(
        ...
        front_door_name: str,
        front_door_parameters: Union[_models.FrontDoor, IO],
        **kwargs: Any
    ) -> _models.FrontDoor:
        error_map = {
            401: ClientAuthenticationError,
