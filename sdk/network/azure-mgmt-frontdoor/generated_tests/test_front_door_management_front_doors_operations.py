...
class TestFrontDoorManagementFrontDoorsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(FrontDoorManagementClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_front_doors_list(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_front_doors_list_by_resource_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_front_doors_get(self, resource_group):
        response = self.client.front_doors.get(
            resource_group_name=resource_group.name,
            front_door_name="str",
            api_version="2025-10-01",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_front_doors_begin_create_or_update(self, resource_group):
        response = self.client.front_doors.begin_create_or_update(
            resource_group_name=resource_group.name,
            front_door_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_front_doors_begin_delete(self, resource_group):
        response = self.client.front_doors.begin_delete(
            resource_group_name=resource_group.name,
            front_door_name="str",
            api_version="2025-10-01",
        ).result()  # call '.result()' to poll until service return final result
