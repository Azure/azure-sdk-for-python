...
# USAGE
    python oracle_subscriptions_update_maximum_set_gen.py
...
def main():
    ...
    response = client.oracle_subscriptions.begin_update(
        properties={
            "plan": {
            ...
            "properties": {"intent": "Retain", "productCode": "kbqzsukkjceoplyalyrdayfj"},
        },
    ).result()
    print(response)
