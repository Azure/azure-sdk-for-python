...
# USAGE
    python golden_gate_connections_list_assigned_deployments_by_parent_maximum_set_gen.py
...
def main():
    ...
    response = client.golden_gate_connections.list_assigned_deployments_by_parent(
