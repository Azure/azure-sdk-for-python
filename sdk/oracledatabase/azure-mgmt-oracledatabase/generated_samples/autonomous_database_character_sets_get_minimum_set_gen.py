...
# USAGE
    python autonomous_database_character_sets_get_minimum_set_gen.py
...
def main():
    ...
    response = client.autonomous_database_character_sets.get(
        location="eastus",
        adbscharsetname="Replace this value with a string matching RegExp .*",
    )
    print(response)
