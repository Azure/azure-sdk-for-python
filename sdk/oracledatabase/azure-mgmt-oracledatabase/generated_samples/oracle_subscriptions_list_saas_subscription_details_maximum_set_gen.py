...
# USAGE
    python oracle_subscriptions_list_saas_subscription_details_maximum_set_gen.py
...
def main():
    ...
    response = client.oracle_subscriptions.begin_list_saas_subscription_details().result()
    print(response)
