...
# USAGE
    python cloud_exadata_infrastructures_get_minimum_set_gen.py
...
def main():
    ...
    response = client.cloud_exadata_infrastructures.get(
...
# x-ms-original-file: 2025-11-01-preview/CloudExadataInfrastructures_Get_MinimumSet_Gen.json
