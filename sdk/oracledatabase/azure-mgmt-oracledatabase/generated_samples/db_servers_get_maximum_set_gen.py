...
# USAGE
    python db_servers_get_maximum_set_gen.py
...
def main():
    ...
    response = client.db_servers.get(
        resource_group_name="rgopenapi",
        cloudexadatainfrastructurename="Replace this value with a string matching RegExp .*",
        dbserverocid="Replace this value with a string matching RegExp .*",
    )
    print(response)


# x-ms-original-file: 2025-11-01-preview/DbServers_Get_MaximumSet_Gen.json
