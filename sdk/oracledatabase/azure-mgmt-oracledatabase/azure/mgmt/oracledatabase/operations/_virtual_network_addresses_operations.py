...
class VirtualNetworkAddressesOperations:
    ...
    ) -> Iterable["_models.VirtualNetworkAddress"]:
    ...
    def get(
        ...
        deserialized = self._deserialize("VirtualNetworkAddress", pipeline_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either VirtualNetworkAddress or the result of
         cls(response)
