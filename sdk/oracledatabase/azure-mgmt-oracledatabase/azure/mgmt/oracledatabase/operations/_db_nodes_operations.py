...
def build_list_by_cloud_vm_cluster_request(
...
class DbNodesOperations:
    ...
    def begin_action(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either DbNode or the result of cls(response)
