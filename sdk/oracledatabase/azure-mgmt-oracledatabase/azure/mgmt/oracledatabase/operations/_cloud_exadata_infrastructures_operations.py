...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Oracle.Database/cloudExadataInfrastructures"
...
def build_add_storage_capacity_request(
    resource_group_name: str, cloudexadatainfrastructurename: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CloudExadataInfrastructuresOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.CloudExadataInfrastructure"]:
        """List CloudExadataInfrastructure resources by subscription ID.

        :return: An iterator like instance of either CloudExadataInfrastructure or the result of
         cls(response)
        :rtype:
        ...
        cls: ClsType[_models.CloudExadataInfrastructureListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("CloudExadataInfrastructureListResult", pipeline_response)
    ...
    ) -> Iterable["_models.CloudExadataInfrastructure"]:
    ...
    def get(
        ...
        :return: CloudExadataInfrastructure or the result of cls(response)
    ...
    def _create_or_update_initial(
        ...
        resource: Union[_models.CloudExadataInfrastructure, IO[bytes]],
        **kwargs: Any
    ) -> _models.CloudExadataInfrastructure:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "CloudExadataInfrastructure")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either CloudExadataInfrastructure or the result
         of cls(response)
        :rtype:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.oracledatabase.models.CloudExadataInfrastructure or IO[bytes]
        :return: An instance of LROPoller that returns either CloudExadataInfrastructure or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.oracledatabase.models.CloudExadataInfrastructure]
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        cloudexadatainfrastructurename: str,
        properties: Union[_models.CloudExadataInfrastructureUpdate, IO[bytes]],
        **kwargs: Any
    ) -> Optional[_models.CloudExadataInfrastructure]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.CloudExadataInfrastructure]] = kwargs.pop("cls", None)
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "CloudExadataInfrastructureUpdate")
    ...
    def _add_storage_capacity_initial(
        ...
        _request = build_add_storage_capacity_request(
            resource_group_name=resource_group_name,
            cloudexadatainfrastructurename=cloudexadatainfrastructurename,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
