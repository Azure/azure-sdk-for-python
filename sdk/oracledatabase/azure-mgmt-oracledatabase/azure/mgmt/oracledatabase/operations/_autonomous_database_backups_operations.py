...
def build_list_by_autonomous_database_request(  # pylint: disable=name-too-long
...
class AutonomousDatabaseBackupsOperations:
    ...
    ) -> Iterable["_models.AutonomousDatabaseBackup"]:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either AutonomousDatabaseBackup or the result of
         cls(response)
        :rtype:
