...
class OracleDatabaseMgmtClient:  # pylint: disable=too-many-instance-attributes,docstring-keyword-should-match-keyword-only
    ...
    :vartype network_anchors: azure.mgmt.oracledatabase.operations.NetworkAnchorsOperations
    :ivar resource_anchors: ResourceAnchorsOperations operations
    :vartype resource_anchors: azure.mgmt.oracledatabase.operations.ResourceAnchorsOperations
    :ivar db_systems: DbSystemsOperations operations
    :vartype db_systems: azure.mgmt.oracledatabase.operations.DbSystemsOperations
    ...
    :vartype database_editions: azure.mgmt.oracledatabase.operations.DatabaseEditionsOperations
    ...
    :vartype database_system_shape_resources:
     azure.mgmt.oracledatabase.operations.DatabaseSystemShapeResourcesOperations
    ...
    :vartype golden_gate_deployments:
     azure.mgmt.oracledatabase.operations.GoldenGateDeploymentsOperations
