...
from ...operations._autonomous_database_versions_operations import build_get_request, build_list_by_location_request
...
class AutonomousDatabaseVersionsOperations:
    ...
    @distributed_trace
    def list_by_location(self, location: str, **kwargs: Any) -> AsyncIterable["_models.AutonomousDbVersion"]:
