...
from ...operations._dns_private_views_operations import build_get_request, build_list_by_location_request
...
class DnsPrivateViewsOperations:
    ...
    @distributed_trace
    def list_by_location(self, location: str, **kwargs: Any) -> AsyncIterable["_models.DnsPrivateView"]:
        """List DnsPrivateView resources by Location.

        :param location: The name of the Azure region. Required.
        :type location: str
        :return: An iterator like instance of either DnsPrivateView or the result of cls(response)
        :rtype:
        ...
        cls: ClsType[_models.DnsPrivateViewListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("DnsPrivateViewListResult", pipeline_response)
    ...
    async def get(self, location: str, dnsprivateviewocid: str, **kwargs: Any) -> _models.DnsPrivateView:
        ...
        :return: DnsPrivateView or the result of cls(response)
        ...
        deserialized = self._deserialize("DnsPrivateView", pipeline_response)
