...
from ...operations._db_servers_operations import build_get_request, build_list_by_cloud_exadata_infrastructure_request
...
class DbServersOperations:
    ...
    def list_by_cloud_exadata_infrastructure(
        ...
        :return: An iterator like instance of either DbServer or the result of cls(response)
        ...
        cls: ClsType[_models.DbServerListResult] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_cloud_exadata_infrastructure_request(
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("DbServerListResult", pipeline_response)
    ...
    async def get(
        ...
        :return: DbServer or the result of cls(response)
        ...
        deserialized = self._deserialize("DbServer", pipeline_response)
