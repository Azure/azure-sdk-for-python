...
from ...operations._db_system_shapes_operations import build_get_request, build_list_by_location_request
...
class DbSystemShapesOperations:
    ...
    @distributed_trace
    def list_by_location(self, location: str, **kwargs: Any) -> AsyncIterable["_models.DbSystemShape"]:
