...
from ...operations._autonomous_database_backups_operations import (
    build_create_or_update_request,
    build_delete_request,
    build_get_request,
    build_list_by_autonomous_database_request,
...
class AutonomousDatabaseBackupsOperations:
    ...
    @distributed_trace
    def list_by_autonomous_database(
        self, resource_group_name: str, autonomousdatabasename: str, **kwargs: Any
    ) -> AsyncIterable["_models.AutonomousDatabaseBackup"]:
        ...
        :return: An iterator like instance of either AutonomousDatabaseBackup or the result of
         cls(response)
        :rtype:
        ...
        cls: ClsType[_models.AutonomousDatabaseBackupListResult] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_autonomous_database_request(
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("AutonomousDatabaseBackupListResult", pipeline_response)
    ...
    async def get(
        ...
        :return: AutonomousDatabaseBackup or the result of cls(response)
    ...
    async def _create_or_update_initial(
        ...
        adbbackupid: str,
        resource: Union[_models.AutonomousDatabaseBackup, IO[bytes]],
        **kwargs: Any
    ) -> _models.AutonomousDatabaseBackup:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "AutonomousDatabaseBackup")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either AutonomousDatabaseBackup or the
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.oracledatabase.models.AutonomousDatabaseBackup or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either AutonomousDatabaseBackup or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.oracledatabase.models.AutonomousDatabaseBackup]
    ...
    async def _update_initial(
        ...
        autonomousdatabasename: str,
        adbbackupid: str,
        properties: Union[_models.AutonomousDatabaseBackupUpdate, IO[bytes]],
        **kwargs: Any
    ) -> Optional[_models.AutonomousDatabaseBackup]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.AutonomousDatabaseBackup]] = kwargs.pop("cls", None)
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "AutonomousDatabaseBackupUpdate")
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.oracledatabase.models.AutonomousDatabaseBackupUpdate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either AutonomousDatabaseBackup or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.oracledatabase.models.AutonomousDatabaseBackup]
