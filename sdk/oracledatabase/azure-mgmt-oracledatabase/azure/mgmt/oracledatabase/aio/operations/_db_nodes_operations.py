...
from ...operations._db_nodes_operations import (
    build_action_request,
    build_get_request,
    build_list_by_cloud_vm_cluster_request,
)
...
class DbNodesOperations:
    ...
    def list_by_cloud_vm_cluster(
        ...
        :return: An iterator like instance of either DbNode or the result of cls(response)
        ...
        cls: ClsType[_models.DbNodeListResult] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_cloud_vm_cluster_request(
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("DbNodeListResult", pipeline_response)
    ...
    async def get(
        ...
        :type dbnodeocid: str
        :return: DbNode or the result of cls(response)
    ...
    async def _action_initial(
        ...
        dbnodeocid: str,
        body: Union[_models.DbNodeAction, IO[bytes]],
        **kwargs: Any
    ) -> Optional[_models.DbNode]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        cls: ClsType[Optional[_models.DbNode]] = kwargs.pop("cls", None)
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "DbNodeAction")
    ...
    async def begin_action(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either DbNode or the result of
         cls(response)
    ...
    async def begin_action(
        ...
        **kwargs: Any
        ...
        :param body: The content of the action request. Is either a DbNodeAction type or a IO[bytes]
         type. Required.
        :type body: ~azure.mgmt.oracledatabase.models.DbNodeAction or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either DbNode or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.oracledatabase.models.DbNode]
        :raises ~azure.core.exceptions.HttpResponseError:
