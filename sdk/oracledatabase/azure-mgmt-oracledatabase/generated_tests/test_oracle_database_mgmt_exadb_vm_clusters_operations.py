...
class TestOracleDatabaseMgmtExadbVmClustersOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(OracleDatabaseMgmtClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_exadb_vm_clusters_list_by_subscription(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_exadb_vm_clusters_begin_create_or_update(self, resource_group):
        response = self.client.exadb_vm_clusters.begin_create_or_update(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_exadb_vm_clusters_get(self, resource_group):
        response = self.client.exadb_vm_clusters.get(
            resource_group_name=resource_group.name,
            exadb_vm_cluster_name="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_exadb_vm_clusters_begin_update(self, resource_group):
        response = self.client.exadb_vm_clusters.begin_update(
            resource_group_name=resource_group.name,
            exadb_vm_cluster_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_exadb_vm_clusters_begin_delete(self, resource_group):
        response = self.client.exadb_vm_clusters.begin_delete(
            resource_group_name=resource_group.name,
            exadb_vm_cluster_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_exadb_vm_clusters_list_by_resource_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_exadb_vm_clusters_begin_remove_vms(self, resource_group):
        response = self.client.exadb_vm_clusters.begin_remove_vms(
            resource_group_name=resource_group.name,
            exadb_vm_cluster_name="str",
