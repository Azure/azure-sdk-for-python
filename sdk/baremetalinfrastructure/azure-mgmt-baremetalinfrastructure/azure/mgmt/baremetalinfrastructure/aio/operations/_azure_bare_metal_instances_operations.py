...
class AzureBareMetalInstancesOperations:
    ...
    _start_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BareMetalInfrastructure/bareMetalInstances/{azureBareMetalInstanceName}/start"
    }
    ...
    async def begin_start(
        ...
        :return: An instance of AsyncLROPoller that returns either OperationStatus or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.baremetalinfrastructure.models.OperationStatus]
    ...
    async def _restart_initial(
        ...
        force_parameter: Optional[Union[_models.ForceState, IO]] = None,
        **kwargs: Any
    ) -> Optional[_models.OperationStatus]:
        error_map = {
            401: ClientAuthenticationError,
    ...
    _restart_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BareMetalInfrastructure/bareMetalInstances/{azureBareMetalInstanceName}/restart"
    }
    ...
    async def begin_restart(
        ...
        **kwargs: Any
        ...
        :type force_parameter: ~azure.mgmt.baremetalinfrastructure.models.ForceState or IO
    ...
    _shutdown_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BareMetalInfrastructure/bareMetalInstances/{azureBareMetalInstanceName}/shutdown"
    }
