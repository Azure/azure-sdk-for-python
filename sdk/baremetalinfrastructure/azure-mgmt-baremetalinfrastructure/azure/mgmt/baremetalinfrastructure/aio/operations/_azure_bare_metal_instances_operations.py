...
class AzureBareMetalInstancesOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.AzureBareMetalInstance"]:
    ...
    ) -> AsyncItemPaged["_models.AzureBareMetalInstance"]:
    ...
    async def get(
        ...
        deserialized = self._deserialize("AzureBareMetalInstance", pipeline_response.http_response)
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type tags_parameter: ~azure.mgmt.baremetalinfrastructure.models.Tags or IO[bytes]
        :return: AzureBareMetalInstance or the result of cls(response)
        :rtype: ~azure.mgmt.baremetalinfrastructure.models.AzureBareMetalInstance
        :raises ~azure.core.exceptions.HttpResponseError:
        """
