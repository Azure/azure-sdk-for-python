...
class BareMetalInfrastructureClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", "2021-08-09")
