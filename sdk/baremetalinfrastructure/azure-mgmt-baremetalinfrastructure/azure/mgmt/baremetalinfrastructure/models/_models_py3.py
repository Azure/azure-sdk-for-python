...
class AzureBareMetalInstance(TrackedResource):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.azure_bare_metal_instance_id: Optional[str] = None
        self.power_state: Optional[Union[str, "_models.AzureBareMetalInstancePowerStateEnum"]] = None
...
class HardwareProfile(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        """ """
        super().__init__(**kwargs)
        self.hardware_type: Optional[Union[str, "_models.AzureBareMetalHardwareTypeNamesEnum"]] = None
        self.azure_bare_metal_instance_size: Optional[Union[str, "_models.AzureBareMetalInstanceSizeNamesEnum"]] = None
