...
class AzureBareMetalInstancesOperations(object):
    ...
    def list_by_subscription(
        ...
        :rtype:
         ~azure.mgmt.baremetalinfrastructure.models.AzureBareMetalInstancePaged[~azure.mgmt.baremetalinfrastructure.models.AzureBareMetalInstance]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.baremetalinfrastructure.models.ErrorResponseException>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.AzureBareMetalInstancePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BareMetalInfrastructure/bareMetalInstances'}
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.baremetalinfrastructure.models.AzureBareMetalInstance or
