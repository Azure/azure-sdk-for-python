...
class SettingsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.SettingsListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.costmanagement.models.SettingsListResult]
    ...
    def create_or_update(
        self,
        setting_name,  # type: str
        parameters,  # type: "_models.Setting"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Setting"
