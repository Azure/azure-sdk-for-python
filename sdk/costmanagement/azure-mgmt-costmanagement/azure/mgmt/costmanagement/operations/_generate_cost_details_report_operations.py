...
class GenerateCostDetailsReportOperations:
    ...
    def begin_create_operation(
        ...
        **kwargs: Any
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("CostDetailsOperationResults", pipeline_response.http_response)
            if cls:
    ...
    def _get_operation_results_initial(self, scope: str, operation_id: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
