...
def build_generate_by_billing_account_request(  # pylint: disable=name-too-long
...
def build_generate_by_billing_profile_request(  # pylint: disable=name-too-long
...
def build_generate_by_reservation_order_id_request(  # pylint: disable=name-too-long
    reservation_order_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_generate_by_savings_plan_order_id_request(  # pylint: disable=name-too-long
    savings_plan_order_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_generate_by_savings_plan_id_request(  # pylint: disable=name-too-long
...
class GenerateBenefitUtilizationSummariesReportOperations:  # pylint: disable=name-too-long
    ...
    def begin_generate_by_billing_account(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.BenefitUtilizationSummariesOperationStatus].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.BenefitUtilizationSummariesOperationStatus](
