...
class BudgetOperations(object):
    ...
    def get(
        ...
        :return: BudgetModel or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.costmanagement.models.BudgetModel or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('BudgetModel', response)
    ...
    def create_or_update(
            self, scope, budget_name, parameters=None, custom_headers=None, raw=False, **operation_config):
        ...
        :type parameters: ~azure.mgmt.costmanagement.models.BudgetModel
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        if parameters is not None:
            body_content = self._serialize.body(parameters, 'BudgetModel')
        else:
            body_content = None
