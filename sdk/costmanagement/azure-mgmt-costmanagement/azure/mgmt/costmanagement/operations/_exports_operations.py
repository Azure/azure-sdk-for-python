...
class ExportsOperations:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        """The operation to create or update an export. You can optionally provide an eTag if desired as a
        form of concurrency control. To obtain the latest eTag for a given export, perform a get
