...
class TestCostManagementForecastOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(CostManagementClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_forecast_usage(self, resource_group):
        response = self.client.forecast.usage(
            scope="str",
            parameters={
                "dataset": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_forecast_external_cloud_provider_usage(self, resource_group):
        response = self.client.forecast.external_cloud_provider_usage(
