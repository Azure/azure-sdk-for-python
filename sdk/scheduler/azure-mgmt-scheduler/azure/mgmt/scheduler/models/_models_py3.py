...
class JobErrorAction(Model):
    ...
    def __init__(self, *, type=None, request=None, queue_message=None, service_bus_queue_message=None, service_bus_topic_message=None, retry_policy=None, **kwargs) -> None:
...
class JobRecurrence(Model):
    ...
    def __init__(self, *, frequency=None, interval: int=None, count: int=None, end_time=None, schedule=None, **kwargs) -> None:
...
class JobRecurrenceSchedule(Model):
    ...
    def __init__(self, *, week_days=None, hours=None, minutes=None, month_days=None, monthly_occurrences=None, **kwargs) -> None:
...
class ServiceBusMessage(Model):
    ...
    def __init__(self, *, authentication=None, brokered_message_properties=None, custom_message_properties=None, message: str=None, namespace: str=None, transport_type=None, **kwargs) -> None:
...
class ServiceBusQueueMessage(ServiceBusMessage):
    ...
    def __init__(self, *, authentication=None, brokered_message_properties=None, custom_message_properties=None, message: str=None, namespace: str=None, transport_type=None, queue_name: str=None, **kwargs) -> None:
