...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Scheduler/jobCollections")
...
def build_get_request(
    resource_group_name: str, job_collection_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class JobCollectionsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`job_collections` attribute.
    """
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.JobCollectionDefinition"]:
        """Gets all job collections under specified subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either JobCollectionDefinition or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.scheduler.models.JobCollectionDefinition]
        ...
        cls: ClsType[_models.JobCollectionListResult] = kwargs.pop("cls", None)
    ...
    ) -> Iterable["_models.JobCollectionDefinition"]:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, job_collection_name: str, **kwargs: Any) -> _models.JobCollectionDefinition:
        ...
        cls: ClsType[_models.JobCollectionDefinition] = kwargs.pop("cls", None)
    ...
    def create_or_update(
        ...
        job_collection: _models.JobCollectionDefinition,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.JobCollectionDefinition:
    ...
    def create_or_update(
        ...
        resource_group_name: str,
        job_collection_name: str,
        job_collection: Union[_models.JobCollectionDefinition, IO],
        **kwargs: Any
    ) -> _models.JobCollectionDefinition:
        """Provisions a new job collection or updates an existing job collection.
        ...
        :param job_collection_name: The job collection name. Required.
        :type job_collection_name: str
        :param job_collection: The job collection definition. Is either a model type or a IO type.
         Required.
        :type job_collection: ~azure.mgmt.scheduler.models.JobCollectionDefinition or IO
        ...
        _json = None
        _content = None
        if isinstance(job_collection, (IO, bytes)):
            _content = job_collection
        else:
            _json = self._serialize.body(job_collection, "JobCollectionDefinition")
    ...
    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, job_collection_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, job_collection_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def begin_enable(self, resource_group_name: str, job_collection_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def begin_disable(self, resource_group_name: str, job_collection_name: str, **kwargs: Any) -> LROPoller[None]:
