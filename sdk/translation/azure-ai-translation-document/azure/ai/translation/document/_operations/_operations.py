...
def build_document_translation_get_supported_formats_request(  # pylint: disable=name-too-long
    *, type: Union[str, _models.FileFormatType], **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class _DocumentTranslationClientOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], DocumentTranslationClientConfiguration]
):

    def _begin_translation_initial(
        self, body: Union[_models.StartTranslationDetails, _types.StartTranslationDetails, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
    ...
    def begin_translation(
        ...
        for each document. The prefix and suffix filter (if supplied) are used to filter folders. The
        prefix is applied to the subpath after the container name. Glossaries / Translation memory can
        be included in the request and are applied by the service when the document is translated. If
        the glossary is invalid or unreachable during translation, an error is indicated in the
        document status. If a file with the same name already exists at the destination, it will be
    ...
    @overload
    def begin_translation(
        self, body: _types.StartTranslationDetails, *, content_type: str = "application/json", **kwargs: Any
    ) -> LROPoller[_models.TranslationStatus]:
        """Submit a document translation request to the Document Translation service.
        ...
        :param body: Translation job submission batch request. Required.
        :type body: ~azure.ai.translation.document.types.StartTranslationDetails
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns TranslationStatus. The TranslationStatus is
    ...
    def begin_translation(
        ...
        :param body: Translation job submission batch request. Is either a StartTranslationDetails type
         or a IO[bytes] type. Required.
        :type body: ~azure.ai.translation.document.models.StartTranslationDetails or
         ~azure.ai.translation.document.types.StartTranslationDetails or IO[bytes]
        :return: An instance of LROPoller that returns TranslationStatus. The TranslationStatus is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.LROPoller[~azure.ai.translation.document.models.TranslationStatus]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_translation_statuses(
        ...
        *,
        ...
        orderby: Optional[list[str]] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.TranslationStatus"]:
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(
                list[_models.TranslationStatus],
    ...
    def get_translation_status(self, translation_id: str, **kwargs: Any) -> _models.TranslationStatus:
        ...
        Returns the status for a document translation request. The status includes the overall request
        status, as well as the status for documents that are being translated as part of that request.
    ...
    def cancel_translation(self, translation_id: str, **kwargs: Any) -> _models.TranslationStatus:
        ...
        Cancel a currently processing or queued translation. A translation will not be cancelled if it
        is already completed or failed or cancelling. A bad request will be returned. All documents
        that have completed translation will not be cancelled and will be charged. All pending
    ...
    def list_document_statuses(
        ...
        *,
        ...
        orderby: Optional[list[str]] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.DocumentStatus"]:
        """Returns the status for all documents in a batch document translation request.

        Returns the status for all documents in a batch document translation request. If the number of
        documents in the response exceeds our paging limit, server-side paging is used. Paginated
        responses indicate a partial result and include a continuation token in the response. The
        absence of a continuation token means that no additional pages are available. top, skip and
        maxpagesize query parameters can be used to specify a number of results to return and an offset
        for the collection. top indicates the total number of records the user wants to be returned
        across all pages. skip indicates the number of records to skip from the list of document status
        held by the server based on the sorting method specified.  By default, we sort by descending
        start time. maxpagesize is the maximum items returned in a page. If more items are requested
        via top (or top is not specified and there are more items to be returned), @nextLink will
        contain the link to the next page. orderby query parameter can be used to sort the returned
        list (ex "orderby=createdDateTimeUtc asc" or "orderby=createdDateTimeUtc desc"). The default
        sorting is descending by createdDateTimeUtc. Some query parameters can be used to filter the
        returned list (ex: "status=Succeeded,Cancelled") will only return succeeded and cancelled
        documents. createdDateTimeUtcStart and createdDateTimeUtcEnd can be used combined or separately
        to specify a range of datetime to filter the returned list by. The supported filtering query
        parameters are (status, ids, createdDateTimeUtcStart, createdDateTimeUtcEnd). When both top and
        skip are included, the server should first apply skip and then top on the collection. Note: If
        the server can't honor top and/or skip, the server must return an error to the client informing
        about it instead of just ignoring the query options. This reduces the risk of the client making
        assumptions about the data returned.
    ...
    def _get_supported_formats(
        self, *, type: Union[str, _models.FileFormatType], **kwargs: Any
    ) -> _models._models.SupportedFileFormats:
        """Returns a list of supported document formats.

        The list of supported formats supported by the Document Translation service. The list includes
        the common file extension, as well as the content-type if using the upload API.
...
class _SingleDocumentTranslationClientOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], SingleDocumentTranslationClientConfiguration]
):
    ...
    def translate(
        self,
        body: _types.DocumentTranslateContent,
        *,
        target_language: str,
        source_language: Optional[str] = None,
        category: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        :param body: Document Translate Request Content. Required.
        :type body: ~azure.ai.translation.document.types.DocumentTranslateContent
        :keyword target_language: Specifies the language of the output document.
         The target language must be one of the supported languages included in the translation scope.
         For example if you want to translate the document in German language, then use
         targetLanguage=de. Required.
    ...
    def translate(
        self,
        body: Union[_models.DocumentTranslateContent, _types.DocumentTranslateContent],
        *,
        target_language: str,
        source_language: Optional[str] = None,
        category: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        :param body: Document Translate Request Content. Is one of the following types:
         DocumentTranslateContent Required.
        :type body: ~azure.ai.translation.document.models.DocumentTranslateContent or
