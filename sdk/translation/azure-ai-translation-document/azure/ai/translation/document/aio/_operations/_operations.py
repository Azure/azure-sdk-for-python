...
class _DocumentTranslationClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], DocumentTranslationClientConfiguration]
):
    ...
    def list_translation_statuses(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.TranslationStatus"]:
    ...
    def list_document_statuses(
        ...
        *,
        ...
        orderby: Optional[list[str]] = None,
        **kwargs: Any
    ) -> AsyncItemPaged["_models.DocumentStatus"]:
...
class _SingleDocumentTranslationClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], SingleDocumentTranslationClientConfiguration]
):
