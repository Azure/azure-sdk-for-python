...
class DocumentTranslationClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for DocumentTranslationClient.
...
class SingleDocumentTranslationClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    """Configuration for SingleDocumentTranslationClient.
