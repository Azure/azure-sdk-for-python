...
from ._operations import _DocumentTranslationClientOperationsMixin, _SingleDocumentTranslationClientOperationsMixin
...
class DocumentTranslationClient(_DocumentTranslationClientOperationsMixin):
