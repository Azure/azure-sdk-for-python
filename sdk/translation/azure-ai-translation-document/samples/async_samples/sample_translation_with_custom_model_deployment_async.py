...
"""
FILE: sample_translation_with_custom_model_deployment_async.py

DESCRIPTION:
    This sample demonstrates how to route a document translation request through a custom
    translation model by specifying the model's deployment name. After the operation completes,
...
USAGE:
    python sample_translation_with_custom_model_deployment_async.py
...
async def sample_translation_with_custom_model_deployment_async():
    import os
...
async def main():
    await sample_translation_with_custom_model_deployment_async()
