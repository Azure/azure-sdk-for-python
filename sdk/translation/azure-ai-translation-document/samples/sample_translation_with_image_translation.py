...
"""
FILE: sample_translation_with_image_translation.py
...
USAGE:
    python sample_translation_with_image_translation.py
...
def sample_translation_with_image_translation():
    import os
...
if __name__ == "__main__":
    sample_translation_with_image_translation()
