...
class TestListTranslations(DocumentTranslationTest):
    ...
    def test_list_translations(self, client):
        ...
        # list translations
        submitted_translations = list(client.list_translations())
    ...
    def test_list_translations_with_pagination(self, client):
        ...
        # list translations
        submitted_translations_pages = client.list_translations(results_per_page=results_per_page).by_page()
    ...
    def test_list_translations_with_skip(self, client):
        ...
        # assert
        all_translations = list(client.list_translations())
        translations_with_skip = list(client.list_translations(skip=skip))
    ...
    def test_list_translations_filter_by_status(self, client):
        ...
        statuses = ["Cancelled"]
        submitted_translations = list(client.list_translations(statuses=statuses))
    ...
    def test_list_translations_filter_by_ids(self, client):
        ...
        # list translations
        submitted_translations = list(client.list_translations(translation_ids=translation_ids))
        self.assertIsNotNone(submitted_translations)
    ...
    def test_list_translations_filter_by_created_after(self, client):
        ...
        # list translations
        submitted_translations = list(client.list_translations(created_after=start))
        self.assertIsNotNone(submitted_translations)
    ...
    def test_list_translations_filter_by_created_before(self, client):
        ...
        # list translations
        submitted_translations = list(client.list_translations(created_before=end))
        self.assertIsNotNone(submitted_translations)
    ...
    def test_list_translations_order_by_creation_time_asc(self, client):
        ...
        # list translations
        submitted_translations = list(client.list_translations(order_by=["createdDateTimeUtc asc"]))
        self.assertIsNotNone(submitted_translations)
    ...
    def test_list_translations_order_by_creation_time_desc(self, client):
        ...
        # list translations
        submitted_translations = list(client.list_translations(order_by=["createdDateTimeUtc desc"]))
        self.assertIsNotNone(submitted_translations)
    ...
    def test_list_translations_mixed_filters(self, client):
        ...
        cancelled_translation_ids = self._begin_multiple_translations(client, operations_count, wait=False, docs_per_operation=docs_per_operation)
        ...
        # list translations
        submitted_translations = client.list_translations(
            # filters
            statuses=statuses,
            created_after=start,
            created_before=end,
