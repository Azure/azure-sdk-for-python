...
class TranslationPerfStressTest(PerfStressTest):
    ...
    async def create_source_container(self):
        ...
        async with container_client:
            ...
            return self.storage_endpoint + self.source_container_name
    ...
    async def create_target_container(self):
        ...
        async with container_client:
            await container_client.create_container()
        return self.storage_endpoint + self.target_container_name
    ...
    async def global_cleanup(self):
        ...
        blob_service_client = BlobServiceClient(self.storage_endpoint, DefaultAzureCredential())
