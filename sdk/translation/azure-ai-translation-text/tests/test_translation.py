...
class TestTranslation(TextTranslationTest):
    ...
    def test_autodetect(self, **kwargs):      
        ...
        response = client.translate(content = input_text_elements, to = target_languages)
    ...
    def test_no_translate_tag(self, **kwargs):      
        ...
        response = client.translate(content = input_text_elements, to = target_languages, from_parameter = source_language, text_type=TextType.HTML) 
    ...
    def test_transliteration(self, **kwargs):      
        ...
        response = client.translate(content = input_text_elements, to = target_languages, from_parameter = source_language, from_script = "Latn", to_script = "Latn") 
    ...
    def test_multiple_input(self, **kwargs):      
        ...
        target_languages = ["cs"]
        input_text_elements = [ InputTextItem(text = "This is a test."), InputTextItem(text = "Esto es una prueba."), InputTextItem(text = "Dies ist ein Test.") ]
        response = client.translate(content = input_text_elements, to = target_languages) 
    ...
    def test_different_texttypes(self, **kwargs):      
        ...
        response = client.translate(content = input_text_elements, to = target_languages, text_type=TextType.HTML) 
    ...
    def test_profanity(self, **kwargs):      
        ...
        response = client.translate(content = input_text_elements, to = target_languages, profanity_action = ProfanityAction.MARKED, profanity_marker = ProfanityMarker.ASTERISK)
    ...
    def test_alignment(self, **kwargs):      
        ...
        response = client.translate(content = input_text_elements, to = target_languages, include_alignment = True)
