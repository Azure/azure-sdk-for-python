...
class TestTranslation(TextTranslationTest):
    ...
    @recorded_by_proxy
    async def async_test_translate(self, **kwargs):
    ...
    @TextTranslationPreparer()
    @recorded_by_proxy
    async def async_test_autodetect(self, **kwargs):
        endpoint = kwargs.get("text_translation_endpoint")
        apikey = kwargs.get("text_translation_apikey")
        region = kwargs.get("text_translation_region")
        client = self.create_async_client(endpoint, apikey, region)
    ...
    @TextTranslationPreparer()
    @recorded_by_proxy
    async def async_test_no_translate_tag(self, **kwargs):
        endpoint = kwargs.get("text_translation_endpoint")
        apikey = kwargs.get("text_translation_apikey")
        region = kwargs.get("text_translation_region")
        client = self.create_async_client(endpoint, apikey, region)
    ...
    @TextTranslationPreparer()
    @recorded_by_proxy
    async def async_test_dictionary_tag(self, **kwargs):
        endpoint = kwargs.get("text_translation_endpoint")
        apikey = kwargs.get("text_translation_apikey")
        region = kwargs.get("text_translation_region")
        client = self.create_async_client(endpoint, apikey, region)
    ...
    @TextTranslationPreparer()
    @recorded_by_proxy
    async def async_test_transliteration(self, **kwargs):
        endpoint = kwargs.get("text_translation_endpoint")
        apikey = kwargs.get("text_translation_apikey")
        region = kwargs.get("text_translation_region")
        client = self.create_async_client(endpoint, apikey, region)
    ...
    @TextTranslationPreparer()
    @recorded_by_proxy
    async def async_test_from_to_latin(self, **kwargs):
        endpoint = kwargs.get("text_translation_endpoint")
        apikey = kwargs.get("text_translation_apikey")
        region = kwargs.get("text_translation_region")
        client = self.create_async_client(endpoint, apikey, region)
        ...
        response = await client.translate(content=input_text_elements,
                                    to=target_languages,
                                    from_parameter=source_language,
                                    from_script="Latn",
                                    to_script="Latn")
    ...
    @TextTranslationPreparer()
    @recorded_by_proxy
    async def async_test_multiple_input(self, **kwargs):
        endpoint = kwargs.get("text_translation_endpoint")
        apikey = kwargs.get("text_translation_apikey")
        region = kwargs.get("text_translation_region")
        client = self.create_async_client(endpoint, apikey, region)
    ...
    @TextTranslationPreparer()
    @recorded_by_proxy
    async def async_test_multiple_target_languages(self, **kwargs):
        endpoint = kwargs.get("text_translation_endpoint")
        apikey = kwargs.get("text_translation_apikey")
        region = kwargs.get("text_translation_region")
        client = self.create_async_client(endpoint, apikey, region)
    ...
    @TextTranslationPreparer()
    @recorded_by_proxy
    async def async_test_different_texttypes(self, **kwargs):
        endpoint = kwargs.get("text_translation_endpoint")
        apikey = kwargs.get("text_translation_apikey")
        region = kwargs.get("text_translation_region")
        client = self.create_async_client(endpoint, apikey, region)
    ...
    @TextTranslationPreparer()
    @recorded_by_proxy
    async def async_test_profanity(self, **kwargs):
        endpoint = kwargs.get("text_translation_endpoint")
        apikey = kwargs.get("text_translation_apikey")
        region = kwargs.get("text_translation_region")
        client = self.create_async_client(endpoint, apikey, region)
    ...
    @TextTranslationPreparer()
    @recorded_by_proxy
    async def async_test_alignment(self, **kwargs):
        endpoint = kwargs.get("text_translation_endpoint")
        apikey = kwargs.get("text_translation_apikey")
        region = kwargs.get("text_translation_region")
        client = self.create_async_client(endpoint, apikey, region)
    ...
    @TextTranslationPreparer()
    @recorded_by_proxy
    async def async_test_sentence_length(self, **kwargs):
        endpoint = kwargs.get("text_translation_endpoint")
        apikey = kwargs.get("text_translation_apikey")
        region = kwargs.get("text_translation_region")
        client = self.create_async_client(endpoint, apikey, region)
    ...
    @TextTranslationPreparer()
    @recorded_by_proxy
    async def async_test_custom_endpoint(self, **kwargs):
    ...
    @TextTranslationPreparer()
    @recorded_by_proxy
    async def async_test_token(self, **kwargs):
        endpoint = kwargs.get("text_translation_endpoint")
        apikey = kwargs.get("text_translation_apikey")
        region = kwargs.get("text_translation_region")
