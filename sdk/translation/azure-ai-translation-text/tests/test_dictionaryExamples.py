...
class TestDictionaryExamples(TextTranslationTest):
    ...
    def test_single_input_element(self, **kwargs):      
        ...
        response = client.lookup_dictionary_examples(content = input_text_elements, from_parameter = source_language, to = target_language)
    ...
    def test_multiple_input_elements(self, **kwargs):      
        ...
        source_language = "en"
        target_language = "es"
        input_text_elements = [ DictionaryExampleTextItem(text = "fly", translation = "volar"), DictionaryExampleTextItem(text = "beef", translation = "came") ]
