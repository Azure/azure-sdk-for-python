...
class TestTranslationAsync(TextTranslationTest):
    ...
    def test_translate(self, **kwargs):
        async def test_translate_async(**kwargs):
        ...
        asyncio.run(test_translate_async(**kwargs))
    ...
    def test_no_translate_tag(self, **kwargs):
        async def test_no_translate_tag_async(**kwargs):
            endpoint = kwargs.get("text_translation_endpoint")
            apikey = kwargs.get("text_translation_apikey")
            region = kwargs.get("text_translation_region")
            client = self.create_async_client(endpoint, apikey, region)
        ...
        asyncio.run(test_no_translate_tag_async(**kwargs))

    @TextTranslationPreparer()
    @recorded_by_proxy
    def test_dictionary_tag(self, **kwargs):
        async def test_dictionary_tag_async(**kwargs):
            endpoint = kwargs.get("text_translation_endpoint")
            apikey = kwargs.get("text_translation_apikey")
            region = kwargs.get("text_translation_region")
            client = self.create_async_client(endpoint, apikey, region)
        ...
        asyncio.run(test_dictionary_tag_async(**kwargs))
    ...
    def test_from_to_latin(self, **kwargs):
        async def test_from_to_latin_async(**kwargs):
            endpoint = kwargs.get("text_translation_endpoint")
            apikey = kwargs.get("text_translation_apikey")
            region = kwargs.get("text_translation_region")
            client = self.create_async_client(endpoint, apikey, region)
        ...
        asyncio.run(test_from_to_latin_async(**kwargs))

    @TextTranslationPreparer()
    @recorded_by_proxy
    def test_multiple_input(self, **kwargs):    
        async def test_multiple_input_async(**kwargs):
            endpoint = kwargs.get("text_translation_endpoint")
            apikey = kwargs.get("text_translation_apikey")
            region = kwargs.get("text_translation_region")
            client = self.create_async_client(endpoint, apikey, region)
        ...
        asyncio.run(test_multiple_input_async(**kwargs))
   
    @TextTranslationPreparer()
    @recorded_by_proxy
    def test_multiple_target_languages(self, **kwargs):
        async def test_multiple_target_languages_async(**kwargs):
            endpoint = kwargs.get("text_translation_endpoint")
            apikey = kwargs.get("text_translation_apikey")
            region = kwargs.get("text_translation_region")
            client = self.create_async_client(endpoint, apikey, region)
        ...
        asyncio.run(test_multiple_target_languages_async(**kwargs))

    @TextTranslationPreparer()
    @recorded_by_proxy
    def test_different_texttypes(self, **kwargs):
        async def test_different_texttypes_async(**kwargs):
            endpoint = kwargs.get("text_translation_endpoint")
            apikey = kwargs.get("text_translation_apikey")
            region = kwargs.get("text_translation_region")
            client = self.create_async_client(endpoint, apikey, region)
            ...
            assert response[0].detected_language.language == "en"
            assert response[0].detected_language.score == 1    
        asyncio.run(test_different_texttypes_async(**kwargs))

    @TextTranslationPreparer()
    @recorded_by_proxy
    def test_profanity(self, **kwargs):
        async def test_profanity_async(**kwargs):
            endpoint = kwargs.get("text_translation_endpoint")
            apikey = kwargs.get("text_translation_apikey")
            region = kwargs.get("text_translation_region")
            client = self.create_async_client(endpoint, apikey, region)
        ...
        asyncio.run(test_profanity_async(**kwargs))        

    @TextTranslationPreparer()
    @recorded_by_proxy
    def test_alignment(self, **kwargs):
        async def test_alignment_async(**kwargs):
            endpoint = kwargs.get("text_translation_endpoint")
            apikey = kwargs.get("text_translation_apikey")
            region = kwargs.get("text_translation_region")
            client = self.create_async_client(endpoint, apikey, region)
        ...
        asyncio.run(test_alignment_async(**kwargs))

    @TextTranslationPreparer()
    @recorded_by_proxy
    def test_sentence_length(self, **kwargs):
        async def test_sentence_length_async(**kwargs):
            endpoint = kwargs.get("text_translation_endpoint")
            apikey = kwargs.get("text_translation_apikey")
            region = kwargs.get("text_translation_region")
            client = self.create_async_client(endpoint, apikey, region)
        ...
        asyncio.run(test_sentence_length_async(**kwargs))

    @TextTranslationPreparer()
    @recorded_by_proxy
    def test_custom_endpoint(self, **kwargs):
        async def test_custom_endpoint_async(**kwargs):
            ...
            assert response[0].detected_language.language == "en"
            assert response[0].detected_language.score == 1
        asyncio.run(test_custom_endpoint_async(**kwargs))

    @pytest.mark.live_test_only
    @TextTranslationPreparer()
    @recorded_by_proxy
    def test_token(self, **kwargs):
        async def test_token_async(**kwargs):        
            endpoint = kwargs.get("text_translation_endpoint")
            apikey = kwargs.get("text_translation_apikey")
            region = kwargs.get("text_translation_region")
            ...
            assert response[0].detected_language.language == "en"
            assert response[0].detected_language.score == 1
        asyncio.run(test_token_async(**kwargs))
