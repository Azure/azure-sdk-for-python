...
class _TextTranslationClientOperationsMixin(
    ClientMixinABC[ClientSession, TextTranslationClientConfiguration]
):
    ...
    async def get_supported_languages(
        ...
        **kwargs: Any
        ...
        """
        return await self._get_generated_operations().get_supported_languages(
    ...
    async def translate(  # pyright: ignore[reportIncompatibleMethodOverride]
        ...
        **kwargs: Any
        ...
        result = await self._get_generated_operations().translate(
    ...
    async def transliterate(  # pyright: ignore[reportIncompatibleMethodOverride]
        ...
        **kwargs: Any
        ...
        result = await self._get_generated_operations().transliterate(
            body=request_body,
            language=language,
