    ...
    def translate(
        ...
        **kwargs: Any
        ...
        :keyword text_type: Defines whether the text being translated is plain text or HTML text. Any
         ...
         complete element. Possible values are: plain (default) or html. Default value is None.
        :paramtype text_type: str
        ...
        :keyword profanity_action: Specifies how profanities should be treated in translations.
         Possible values are: NoAction (default), Marked or Deleted. Default value is None.
        :paramtype profanity_action: str
        :keyword profanity_marker: Specifies how profanities should be marked in translations.
         Possible values are: Asterisk (default) or Tag. Default value is None.
        :paramtype profanity_marker: str
