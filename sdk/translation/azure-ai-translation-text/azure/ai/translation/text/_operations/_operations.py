...
def build_text_translation_get_supported_languages_request(  # pylint: disable=name-too-long
    ...
    **kwargs: Any
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "3.0"))
...
def build_text_translation_find_sentence_boundaries_request(  # pylint: disable=name-too-long
    *,
    client_trace_id: Optional[str] = None,
