...
<!-- SNIPPET: create_text_client_with_endpoint -->
```python
...
<!-- SNIPPET: get_text_translation_languages -->
```python
try:
...
<!-- SNIPPET: get_text_translation_languages_scope -->
```python
try:
    scope = "translation"
...
<!-- SNIPPET: get_text_translation_languages_culture -->
```python
try:
    accept_language = "es"
