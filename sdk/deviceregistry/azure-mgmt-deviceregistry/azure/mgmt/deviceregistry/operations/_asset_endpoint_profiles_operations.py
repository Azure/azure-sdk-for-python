...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DeviceRegistry/assetEndpointProfiles"
...
class AssetEndpointProfilesOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.AssetEndpointProfile"]:
        ...
        :return: An iterator like instance of either AssetEndpointProfile or the result of
         cls(response)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("AssetEndpointProfileListResult", pipeline_response)
    ...
    def get(
        ...
        :return: AssetEndpointProfile or the result of cls(response)
        ...
        deserialized = self._deserialize("AssetEndpointProfile", pipeline_response)
    ...
    def _create_or_replace_initial(
        ...
        **kwargs: Any
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "AssetEndpointProfile")
    ...
    def begin_create_or_replace(
        ...
        **kwargs: Any
        ...
        :param asset_endpoint_profile_name: Asset Endpoint Profile name parameter. Required.
        :type asset_endpoint_profile_name: str
        :param resource: Resource create parameters. Is either a AssetEndpointProfile type or a
         IO[bytes] type. Required.
        :type resource: ~azure.mgmt.deviceregistry.models.AssetEndpointProfile or IO[bytes]
        :return: An instance of LROPoller that returns either AssetEndpointProfile or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.deviceregistry.models.AssetEndpointProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.AssetEndpointProfile]] = kwargs.pop("cls", None)
