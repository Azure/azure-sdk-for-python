...
def build_get_request(resource_group_name: str, asset_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(resource_group_name: str, asset_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_request(resource_group_name: str, asset_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class AssetsOperations:
    ...
    def get(self, resource_group_name: str, asset_name: str, **kwargs: Any) -> _models.Asset:
        ...
        deserialized = self._deserialize("Asset", pipeline_response.http_response)
    ...
    def begin_create_or_replace(
        ...
        :param asset_name: Asset name parameter. Required.
        :type asset_name: str
        :param resource: Resource create parameters. Is either a Asset type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.deviceregistry.models.Asset or IO[bytes]
        :return: An instance of LROPoller that returns either Asset or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.deviceregistry.models.Asset]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
