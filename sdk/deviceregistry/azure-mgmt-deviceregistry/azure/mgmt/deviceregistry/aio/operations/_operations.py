...
from ...operations._operations import (
    ...
    build_discovered_asset_endpoint_profiles_get_request,
    build_discovered_asset_endpoint_profiles_list_by_resource_group_request,
    build_discovered_asset_endpoint_profiles_list_by_subscription_request,
    build_discovered_asset_endpoint_profiles_update_request,
    build_discovered_assets_create_or_replace_request,
    build_discovered_assets_delete_request,
    build_discovered_assets_get_request,
    build_discovered_assets_list_by_resource_group_request,
    build_discovered_assets_list_by_subscription_request,
    build_discovered_assets_update_request,
...
class DiscoveredAssetsOperations:
    ...
    async def get(self, resource_group_name: str, discovered_asset_name: str, **kwargs: Any) -> _models.DiscoveredAsset:
    ...
    async def begin_create_or_replace(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.DiscoveredAsset]:
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns DiscoveredAsset. The DiscoveredAsset is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.deviceregistry.models.DiscoveredAsset]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_replace(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.DiscoveredAsset].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.DiscoveredAsset](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    def list_by_resource_group(
        self, resource_group_name: str, **kwargs: Any
    ) -> AsyncIterable["_models.DiscoveredAsset"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.deviceregistry.models.DiscoveredAsset]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.DiscoveredAsset"]:
    ...
    async def begin_create_or_replace(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns DiscoveredAssetEndpointProfile. The
...
class SchemaRegistriesOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.SchemaRegistry"]:
