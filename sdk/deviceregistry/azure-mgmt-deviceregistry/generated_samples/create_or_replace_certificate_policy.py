...
# USAGE
    python create_or_replace_certificate_policy.py
...
def main():
    ...
    response = client.certificate_policies.begin_create_or_replace(
        resource_group_name="rgdeviceregistry",
        namespace_name="mynamespace",
        certificate_authority_name="myrootca",
        certificate_policy_name="mycertificatepolicy",
        resource={"location": "East US 2", "properties": {"certificate": {"validityPeriodInDays": 30}}},
    ).result()
    print(response)
