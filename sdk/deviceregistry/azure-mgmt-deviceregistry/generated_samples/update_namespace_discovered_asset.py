...
# USAGE
    python update_namespace_discovered_asset.py
...
def main():
    ...
    response = client.namespace_discovered_assets.begin_update(
        resource_group_name="myResourceGroup",
        namespace_name="my-namespace-1",
        discovered_asset_name="my-discoveredasset-1",
        properties={"properties": {"documentationUri": "https://www.example.com/manual-2"}},
    ).result()
    print(response)
