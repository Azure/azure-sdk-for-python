...
# USAGE
    python update_certificate_policy.py
...
def main():
    ...
    response = client.certificate_policies.begin_update(
        resource_group_name="rgdeviceregistry",
        namespace_name="mynamespace",
        certificate_authority_name="myrootca",
        certificate_policy_name="mycertificatepolicy",
        properties={"properties": {"certificate": {"validityPeriodInDays": 60}}, "tags": {"environment": "production"}},
    ).result()
    print(response)
