...
# USAGE
    python create_or_replace_credentials.py
...
def main():
    ...
    response = client.credentials.begin_create_or_update(
        resource_group_name="rgdeviceregistry",
        namespace_name="mynamespace",
        resource={"location": "East US 2", "properties": {}, "tags": {"key7121": "mtdjqipusqaqhdvekrknyjeo"}},
    ).result()
    print(response)
