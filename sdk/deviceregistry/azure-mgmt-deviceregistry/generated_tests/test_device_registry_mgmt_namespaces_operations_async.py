...
class TestDeviceRegistryMgmtNamespacesOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_namespaces_begin_create_or_replace(self, resource_group):
        response = await (
            await self.client.namespaces.begin_create_or_replace(
                resource_group_name=resource_group.name,
                namespace_name="str",
                resource={
                    "location": "str",
                    ...
                    "properties": {
                        "messaging": {
                            "endpoints": {"str": {"address": "str", "endpointType": "str", "resourceId": "str"}}
                        },
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_namespaces_begin_migrate(self, resource_group):
        response = await (
            await self.client.namespaces.begin_migrate(
                resource_group_name=resource_group.name,
                namespace_name="str",
