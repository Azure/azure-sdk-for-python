...
class DeviceUpdateClient:  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :vartype operations: azure.mgmt.deviceregistrysoftwareupdate.operations.Operations
    :ivar update_instances: UpdateInstancesOperations operations
    :vartype update_instances:
     azure.mgmt.deviceregistrysoftwareupdate.operations.UpdateInstancesOperations
