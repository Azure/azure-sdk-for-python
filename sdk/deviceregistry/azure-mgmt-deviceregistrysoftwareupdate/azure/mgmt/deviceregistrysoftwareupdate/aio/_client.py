...
class DeviceRegistrySoftwareUpdateMgmtClient:  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :vartype operations: azure.mgmt.deviceregistrysoftwareupdate.aio.operations.Operations
    :ivar update_instances: UpdateInstancesOperations operations
    :vartype update_instances:
     azure.mgmt.deviceregistrysoftwareupdate.aio.operations.UpdateInstancesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.update_instances = UpdateInstancesOperations(
