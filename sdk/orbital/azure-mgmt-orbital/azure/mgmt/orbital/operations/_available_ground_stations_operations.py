...
def build_list_by_capability_request(
    subscription_id: str, *, capability: Union[str, _models.CapabilityParameter] = "EarthObservation", **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Orbital/availableGroundStations"
    )
    ...
    _params["capability"] = _SERIALIZER.query("capability", capability, "str")
...
def build_get_request(ground_station_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "groundStationName": _SERIALIZER.url("ground_station_name", ground_station_name, "str"),
    }
...
class AvailableGroundStationsOperations:
    ...
    def list_by_capability(
    ...
    ) -> Iterable["_models.AvailableGroundStation"]:
        ...
        :return: An iterator like instance of either AvailableGroundStation or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.orbital.models.AvailableGroundStation]
    ...
    @distributed_trace
    def get(self, ground_station_name: str, **kwargs: Any) -> _models.AvailableGroundStation:
