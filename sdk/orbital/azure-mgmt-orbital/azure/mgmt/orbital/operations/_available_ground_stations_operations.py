...
class AvailableGroundStationsOperations(object):
    ...
    def list_by_capability(
        self,
        capability="EarthObservation",  # type: Union[str, "_models.Enum6"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["_models.AvailableGroundStationListResult"]
        """Returns list of available ground stations.

        :param capability: Ground Station Capability.
        :type capability: str or ~azure_orbital.models.Enum6
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either AvailableGroundStationListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure_orbital.models.AvailableGroundStationListResult]
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_by_capability.metadata['url']  # type: ignore
                ...
                query_parameters['capability'] = self._serialize.query("capability", capability, 'str')
    ...
    def get(
        self,
        ground_station_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.AvailableGroundStation"
        ...
        :rtype: ~azure_orbital.models.AvailableGroundStation
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
            'groundStationName': self._serialize.url("ground_station_name", ground_station_name, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
