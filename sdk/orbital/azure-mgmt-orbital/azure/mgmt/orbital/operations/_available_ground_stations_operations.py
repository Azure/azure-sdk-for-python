...
def build_list_by_capability_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Orbital/availableGroundStations")
    ...
    _query_parameters['capability'] = _SERIALIZER.query("capability", capability, 'str')
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Orbital/availableGroundStations/{groundStationName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
...
class AvailableGroundStationsOperations(object):
    ...
    def list_by_capability(
        ...
        capability: Union[str, "_models.CapabilityParameter"] = "EarthObservation",
        **kwargs: Any
    ) -> Iterable["_models.AvailableGroundStationListResult"]:
        ...
        :return: An iterator like instance of either AvailableGroundStationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.orbital.models.AvailableGroundStationListResult]
