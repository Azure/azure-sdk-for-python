...
def build_get_request(
    resource_group_name: str, contact_profile_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class ContactProfilesOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, contact_profile_name: str, **kwargs: Any) -> _models.ContactProfile:
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, contact_profile_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    def list_by_subscription(
    ...
    ) -> Iterable["_models.ContactProfile"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.orbital.models.ContactProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
