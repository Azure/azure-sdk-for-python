...
from ...operations._contact_profiles_operations import (
...
class ContactProfilesOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`contact_profiles` attribute.
    """
    ...
    async def get(self, resource_group_name: str, contact_profile_name: str, **kwargs: Any) -> _models.ContactProfile:
        ...
        :return: ContactProfile or the result of cls(response)
        :rtype: ~azure.mgmt.orbital.models.ContactProfile
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Orbital/contactProfiles/{contactProfileName}"
    }
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _parameters = _models.ContactProfile(
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param minimum_viable_contact_duration: Minimum viable contact duration in ISO 8601 format.
         Used for listing the available contacts with a spacecraft at a given ground station. Default
         value is None.
        ...
        :param auto_tracking_configuration: Auto-tracking configuration. Known values are: "disabled",
         "xBand", and "sBand". Default value is None.
        :type auto_tracking_configuration: str or ~azure.mgmt.orbital.models.AutoTrackingConfiguration
        :param event_hub_uri: ARM resource identifier of the Event Hub used for telemetry. Requires
        ...
        :return: An instance of AsyncLROPoller that returns either ContactProfile or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.orbital.models.ContactProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, contact_profile_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def _update_tags_initial(
        ...
        **kwargs: Any
    ) -> Optional[_models.ContactProfile]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        cls: ClsType[Optional[_models.ContactProfile]] = kwargs.pop("cls", None)
    ...
    async def begin_update_tags(
        ...
        **kwargs: Any
        ...
        :param contact_profile_name: Contact Profile name. Required.
        :type contact_profile_name: str
        :param parameters: Parameters supplied to update contact profile tags. Required.
    ...
    def list_by_subscription(
    ...
    ) -> AsyncIterable["_models.ContactProfile"]:
        ...
        :type skiptoken: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ContactProfile or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.orbital.models.ContactProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("ContactProfileListResult", pipeline_response)
    ...
    list_by_subscription.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.Orbital/contactProfiles"
    }
