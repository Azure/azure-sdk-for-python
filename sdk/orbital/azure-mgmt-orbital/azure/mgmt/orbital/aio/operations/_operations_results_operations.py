...
class OperationsResultsOperations:
    ...
    async def _get_initial(self, location: str, operation_id: str, **kwargs: Any) -> Optional[_models.OperationResult]:
        error_map = {
    ...
    async def begin_get(
        ...
        :return: An instance of AsyncLROPoller that returns either OperationResult or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.orbital.models.OperationResult]
