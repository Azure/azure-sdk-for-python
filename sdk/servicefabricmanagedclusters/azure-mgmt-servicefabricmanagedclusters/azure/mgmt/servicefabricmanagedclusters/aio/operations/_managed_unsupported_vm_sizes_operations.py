...
class ManagedUnsupportedVMSizesOperations:
    ...
    def list(self, location: str, **kwargs: Any) -> AsyncIterable["_models.ManagedVMSize"]:
        ...
        :return: An iterator like instance of either ManagedVMSize or the result of cls(response)
        :rtype:
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.ServiceFabric/locations/{location}/managedUnsupportedVMSizes"
    }
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.ServiceFabric/locations/{location}/managedUnsupportedVMSizes/{vmSize}"
    }
