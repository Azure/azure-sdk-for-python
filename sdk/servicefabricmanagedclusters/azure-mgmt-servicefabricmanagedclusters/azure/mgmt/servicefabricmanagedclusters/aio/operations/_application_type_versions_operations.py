...
class ApplicationTypeVersionsOperations:
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~service_fabric_managed_clusters_management_client.models.ApplicationTypeVersionResource
    ...
    async def begin_create_or_update(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~service_fabric_managed_clusters_management_client.models.ApplicationTypeVersionResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        **kwargs
        ...
        :type parameters: ~service_fabric_managed_clusters_management_client.models.ApplicationTypeVersionUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ApplicationTypeVersionResource, or the result of cls(response)
        :rtype: ~service_fabric_managed_clusters_management_client.models.ApplicationTypeVersionResource
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'ApplicationTypeVersionUpdateParameters')
        body_content_kwargs['content'] = body_content
    ...
    def list_by_application_types(
        ...
        **kwargs
        ...
        :type application_type_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ApplicationTypeVersionResourceList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~service_fabric_managed_clusters_management_client.models.ApplicationTypeVersionResourceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_by_application_types.metadata['url']  # type: ignore
                path_format_arguments = {
                    'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
                    'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
                    'clusterName': self._serialize.url("cluster_name", cluster_name, 'str'),
