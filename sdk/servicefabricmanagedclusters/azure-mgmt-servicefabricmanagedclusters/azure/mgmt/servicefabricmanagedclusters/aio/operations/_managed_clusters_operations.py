...
class ManagedClustersOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The cluster resource. Is either a ManagedCluster type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.servicefabricmanagedclusters.models.ManagedCluster or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ManagedCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.servicefabricmanagedclusters.models.ManagedCluster]
    ...
    async def update(
        ...
        resource_group_name: str,
        cluster_name: str,
        parameters: Union[_models.ManagedClusterUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.ManagedCluster:
        """Updates the tags of of a Service Fabric managed cluster resource.
        ...
        :type parameters:
         ~azure.mgmt.servicefabricmanagedclusters.models.ManagedClusterUpdateParameters or IO[bytes]
        :return: ManagedCluster or the result of cls(response)
        :rtype: ~azure.mgmt.servicefabricmanagedclusters.models.ManagedCluster
        :raises ~azure.core.exceptions.HttpResponseError:
        """
