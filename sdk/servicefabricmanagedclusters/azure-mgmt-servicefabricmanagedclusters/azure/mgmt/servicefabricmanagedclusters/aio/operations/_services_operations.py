...
from ...operations._services_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_applications_request, build_update_request
T = TypeVar('T')
...
class ServicesOperations:
    ...
    def list_by_applications(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicefabricmanagedclusters.models.ServiceResourceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-02-01-preview")  # type: str
