...
class ServiceFabricManagedClustersManagementClient(SDKClient):
    """Service Fabric Managed Clusters Management Client

    :ivar config: Configuration for client.
    :vartype config: ServiceFabricManagedClustersManagementClientConfiguration
    ...
    :vartype application_types: azure.mgmt.servicefabricmanagedclusters.operations.ApplicationTypesOperations
    :ivar application_type_versions: ApplicationTypeVersions operations
    :vartype application_type_versions: azure.mgmt.servicefabricmanagedclusters.operations.ApplicationTypeVersionsOperations
    :ivar applications: Applications operations
    :vartype applications: azure.mgmt.servicefabricmanagedclusters.operations.ApplicationsOperations
    ...
    :vartype managed_clusters: azure.mgmt.servicefabricmanagedclusters.operations.ManagedClustersOperations
    ...
    def __init__(
        ...
        self.config = ServiceFabricManagedClustersManagementClientConfiguration(credentials, subscription_id, base_url)
        super(ServiceFabricManagedClustersManagementClient, self).__init__(self.config.credentials, self.config)
