...
class ApplicationsOperations(object):
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.servicefabricmanagedclusters.models.ApplicationResource or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedclusters/{clusterName}/applications/{applicationName}'}
    ...
    def create(
        ...
        :type parameters:
         ~azure.mgmt.servicefabricmanagedclusters.models.ApplicationResource
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.servicefabricmanagedclusters.models.ApplicationResource]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.servicefabricmanagedclusters.models.ApplicationResource]]
        :raises:
         :class:`ErrorModelException<azure.mgmt.servicefabricmanagedclusters.models.ErrorModelException>`
        """
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedclusters/{clusterName}/applications/{applicationName}'}

    def update(
            self, resource_group_name, cluster_name, application_name, tags=None, custom_headers=None, raw=False, **operation_config):
        ...
        :raises:
         :class:`ErrorModelException<azure.mgmt.servicefabricmanagedclusters.models.ErrorModelException>`
        """
        parameters = models.ApplicationUpdateParameters(tags=tags)
        ...
        return deserialized
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedclusters/{clusterName}/applications/{applicationName}'}
    ...
    def delete(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedclusters/{clusterName}/applications/{applicationName}'}
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.servicefabricmanagedclusters.models.ApplicationResourcePaged[~azure.mgmt.servicefabricmanagedclusters.models.ApplicationResource]
        :raises:
         :class:`ErrorModelException<azure.mgmt.servicefabricmanagedclusters.models.ErrorModelException>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.ApplicationResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedclusters/{clusterName}/applications'}
