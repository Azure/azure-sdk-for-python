...
class ApplicationsOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~service_fabric_managed_clusters_management_client.models.ApplicationResource
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~service_fabric_managed_clusters_management_client.models.ApplicationResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        cluster_name,  # type: str
        application_name,  # type: str
        parameters,  # type: "_models.ApplicationUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ApplicationResource"
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ApplicationResourceList"]
        ...
        :type cluster_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ApplicationResourceList or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~service_fabric_managed_clusters_management_client.models.ApplicationResourceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
