...
class ServicesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The service resource. Is either a ServiceResource type or a IO[bytes] type.
         Required.
        :type parameters: ~azure.mgmt.servicefabricmanagedclusters.models.ServiceResource or IO[bytes]
        :return: An instance of LROPoller that returns either ServiceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.servicefabricmanagedclusters.models.ServiceResource]
    ...
    def update(
        ...
        application_name: str,
        service_name: str,
        parameters: Union[_models.ServiceUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.ServiceResource:
        """Updates the tags of a service resource of a given managed cluster.
    ...
    def list_by_applications(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_applications_request(
                    resource_group_name=resource_group_name,
                    cluster_name=cluster_name,
                    application_name=application_name,
                    subscription_id=self._config.subscription_id,
