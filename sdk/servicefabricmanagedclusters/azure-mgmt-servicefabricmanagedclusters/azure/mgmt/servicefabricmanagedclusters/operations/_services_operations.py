...
class ServicesOperations(object):
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.servicefabricmanagedclusters.models.ServiceResource or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedclusters/{clusterName}/applications/{applicationName}/services/{serviceName}'}
    ...
    def create(
        ...
        :type parameters:
         ~azure.mgmt.servicefabricmanagedclusters.models.ServiceResource
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.servicefabricmanagedclusters.models.ServiceResource]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.servicefabricmanagedclusters.models.ServiceResource]]
        :raises:
         :class:`ErrorModelException<azure.mgmt.servicefabricmanagedclusters.models.ErrorModelException>`
        """
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedclusters/{clusterName}/applications/{applicationName}/services/{serviceName}'}

    def update(
            self, resource_group_name, cluster_name, application_name, service_name, tags=None, custom_headers=None, raw=False, **operation_config):
        ...
        :raises:
         :class:`ErrorModelException<azure.mgmt.servicefabricmanagedclusters.models.ErrorModelException>`
        """
        parameters = models.ServiceUpdateParameters(tags=tags)
        ...
        return deserialized
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedclusters/{clusterName}/applications/{applicationName}/services/{serviceName}'}
    ...
    def delete(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedclusters/{clusterName}/applications/{applicationName}/services/{serviceName}'}
    ...
    def list_by_applications(
        ...
        in the Service Fabric managed application resource.
        ...
        :rtype:
         ~azure.mgmt.servicefabricmanagedclusters.models.ServiceResourcePaged[~azure.mgmt.servicefabricmanagedclusters.models.ServiceResource]
        :raises:
         :class:`ErrorModelException<azure.mgmt.servicefabricmanagedclusters.models.ErrorModelException>`
        """
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.list_by_applications.metadata['url']
                path_format_arguments = {
                    'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
                    'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
                    'clusterName': self._serialize.url("cluster_name", cluster_name, 'str'),
        ...
        return deserialized
    list_by_applications.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/managedclusters/{clusterName}/applications/{applicationName}/services'}
