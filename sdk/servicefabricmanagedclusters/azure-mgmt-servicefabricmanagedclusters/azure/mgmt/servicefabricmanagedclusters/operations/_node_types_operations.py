...
class NodeTypesOperations(object):
    ...
    def list_by_managed_clusters(
        ...
        :rtype:
         ~azure.mgmt.servicefabricmanagedclusters.models.NodeTypePaged[~azure.mgmt.servicefabricmanagedclusters.models.NodeType]
        :raises:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.servicefabricmanagedclusters.models.NodeType or
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.servicefabricmanagedclusters.models.NodeType
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.servicefabricmanagedclusters.models.NodeType]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.servicefabricmanagedclusters.models.NodeType]]
        :raises:
         :class:`ErrorModelException<azure.mgmt.servicefabricmanagedclusters.models.ErrorModelException>`
        """
    ...
    def update(
            self, resource_group_name, cluster_name, node_type_name, tags=None, custom_headers=None, raw=False, **operation_config):
        ...
        :raises:
         :class:`ErrorModelException<azure.mgmt.servicefabricmanagedclusters.models.ErrorModelException>`
        """
        parameters = models.NodeTypeUpdateParameters(tags=tags)
