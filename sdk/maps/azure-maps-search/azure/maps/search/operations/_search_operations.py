...
class SearchOperations(object):
    ...
    def get_search_polygon(
        ...
        **Applies to**\ : S1 pricing tier.
        ...
        query_parameters['geometries'] = self._serialize.query("geometries", geometries, '[str]', div=',')
    ...
    def get_search_fuzzy(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SearchCommonResponse"
        """**Free Form Search**
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :type format: str or ~azure.maps.search.models.TextFormat
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SearchCommonResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        deserialized = self._deserialize('SearchCommonResponse', pipeline_response)
    ...
    def get_search_poi_category_tree_preview(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SearchPoiCategoryTreeResponse"
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.SearchPoiCategoryTreeResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        deserialized = self._deserialize('SearchPoiCategoryTreeResponse', pipeline_response)
    ...
    def post_search_fuzzy_batch_sync(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.SearchFuzzyBatchResponse"
        ...
        *
        ...
        # Construct URL
        url = self.post_search_fuzzy_batch_sync.metadata['url']  # type: ignore
        path_format_arguments = {
            'geography': self._serialize.url("self._config.geography", self._config.geography, 'str'),
            'format': self._serialize.url("format", format, 'str'),
        }
        ...
        return deserialized
    post_search_fuzzy_batch_sync.metadata = {'url': '/search/fuzzy/batch/sync/{format}'}  # type: ignore
    ...
    def _post_search_fuzzy_batch_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["_models.SearchFuzzyBatchResponse"]
    ...
    def begin_post_search_fuzzy_batch(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.SearchFuzzyBatchResponse"]
        """**Search Fuzzy Batch API**
    ...
    def _get_search_fuzzy_batch_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._get_search_fuzzy_batch_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'geography': self._serialize.url("self._config.geography", self._config.geography, 'str'),
            'format': self._serialize.url("format", format, 'str'),
        }
    ...
    def begin_get_search_fuzzy_batch(
        self,
        format,  # type: str
        **kwargs  # type: Any
    ):
        ...
        *
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._get_search_fuzzy_batch_initial(
                format=format,
                cls=lambda x,y,z: x,
                **kwargs
            )
    ...
    def post_search_address_batch_sync(
        self,
        format,  # type: Union[str, "_models.ResponseFormat"]
        search_address_batch_request_body,  # type: "_models.BatchRequestBody"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.SearchAddressBatchResponse"
    ...
    def _post_search_address_batch_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["_models.SearchAddressBatchResponse"]
    ...
    def begin_post_search_address_batch(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.SearchAddressBatchResponse"]
        """**Search Address Batch API**
    ...
    def post_search_address_reverse_batch_sync(
        self,
        format,  # type: Union[str, "_models.ResponseFormat"]
        search_address_reverse_batch_request_body,  # type: "_models.BatchRequestBody"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.SearchAddressReverseBatchResponse"
    ...
    def _post_search_address_reverse_batch_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["_models.SearchAddressReverseBatchResponse"]
    ...
    def begin_post_search_address_reverse_batch(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.SearchAddressReverseBatchResponse"]
        """**Search Address Reverse Batch API**
    ...
    def _get_search_address_reverse_batch_initial(
        self,
        format,  # type: str
        **kwargs  # type: Any
    ):
        ...
        # Construct URL
        url = self._get_search_address_reverse_batch_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'geography': self._serialize.url("self._config.geography", self._config.geography, 'str'),
            'format': self._serialize.url("format", format, 'str'),
        }
        ...
        return deserialized
    _get_search_address_reverse_batch_initial.metadata = {'url': '/search/address/reverse/batch/{format}'}  # type: ignore

    def begin_get_search_address_reverse_batch(
        self,
        format,  # type: str
        **kwargs  # type: Any
    ):
        ...
        *
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._get_search_address_reverse_batch_initial(
                format=format,
                cls=lambda x,y,z: x,
                **kwargs
            )
