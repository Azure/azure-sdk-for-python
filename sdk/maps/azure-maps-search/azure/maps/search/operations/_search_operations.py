...
class SearchOperations(object):
    ...
    def get_polygon(
        ...
        **Applies to**\ : S1 pricing tier.
        ...
        # Construct URL
        url = self.get_polygon.metadata['url']  # type: ignore
        ...
        return deserialized
    get_polygon.metadata = {'url': '/search/polygon/{format}'}  # type: ignore
    ...
    def fuzzy_search(
        ...
        idx_set=None,  # type: Optional[List[Union[str, "models.SearchIndexes"]]]
        ...
        **Applies to**\ : S0 and S1 pricing tiers.
        ...
        :type idx_set: list[str or ~azure.maps.search.models.SearchIndexes]
    ...
    def fuzzy_search_batch_sync(
        self,
        search_fuzzy_batch_request_body,  # type: "models.BatchRequest"
        format="json",  # type: Union[str, "models.JsonFormat"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.SearchAddressBatchProcessResult"
        ...
        *
        ...
        :type search_fuzzy_batch_request_body: ~azure.maps.search.models.BatchRequest
        :param format: Desired format of the response. Only ``json`` format is supported.
        :type format: str or ~azure.maps.search.models.JsonFormat
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SearchAddressBatchProcessResult, or the result of cls(response)
        :rtype: ~azure.maps.search.models.SearchAddressBatchProcessResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SearchAddressBatchProcessResult"]
        error_map = {
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(search_fuzzy_batch_request_body, 'BatchRequest')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
        ...
        deserialized = self._deserialize('SearchAddressBatchProcessResult', pipeline_response)
    ...
    def _fuzzy_search_batch_initial(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["models.SearchAddressBatchProcessResult"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.SearchAddressBatchProcessResult"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def begin_fuzzy_search_batch(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.SearchAddressBatchProcessResult"]
        """**Search Fuzzy Batch API**
        ...
        *
        ...
        :return: An instance of LROPoller that returns either SearchAddressBatchProcessResult or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.maps.search.models.SearchAddressBatchProcessResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def search_address_batch_sync(
        self,
        search_address_batch_request_body,  # type: "models.BatchRequest"
        format="json",  # type: Union[str, "models.JsonFormat"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.SearchAddressBatchProcessResult"
        ...
        *
        ...
        :type search_address_batch_request_body: ~azure.maps.search.models.BatchRequest
        :param format: Desired format of the response. Only ``json`` format is supported.
        :type format: str or ~azure.maps.search.models.JsonFormat
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SearchAddressBatchProcessResult, or the result of cls(response)
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(search_address_batch_request_body, 'BatchRequest')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    def reverse_search_address_batch_sync(
        self,
        search_address_reverse_batch_request_body,  # type: "models.BatchRequest"
        format="json",  # type: Union[str, "models.JsonFormat"]
        **kwargs  # type: Any
    ):
        ...
        *
        ...
        :param search_address_reverse_batch_request_body: The list of reverse geocoding
         ...
         least 1 query.
        :type search_address_reverse_batch_request_body: ~azure.maps.search.models.BatchRequest
        :param format: Desired format of the response. Only ``json`` format is supported.
        :type format: str or ~azure.maps.search.models.JsonFormat
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(search_address_reverse_batch_request_body, 'BatchRequest')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
