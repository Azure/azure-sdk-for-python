...
class DataSources(msrest.serialization.Model):
    ...
    :param geometry: Information about the geometric shape of the result. Only present if type ==
     Geography.
    :type geometry: ~azure.maps.search.models.Geometry
    """

    _attribute_map = {
        'geometry': {'key': 'geometry', 'type': 'Geometry'},
    }
...
class Geometry(msrest.serialization.Model):
...
class SearchAddressBatchProcessResult(BatchResult):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SearchAddressBatchProcessResult, self).__init__(**kwargs)
        self.batch_items = None
...
class SearchAddressResultItem(msrest.serialization.Model):
    ...
    :vartype viewport: ~azure.maps.search.models.Viewport
    ...
    _attribute_map = {
        ...
        'address': {'key': 'address', 'type': 'Address'},
        'position': {'key': 'position', 'type': 'LatLongPairAbbreviated'},
        'viewport': {'key': 'viewport', 'type': 'Viewport'},
