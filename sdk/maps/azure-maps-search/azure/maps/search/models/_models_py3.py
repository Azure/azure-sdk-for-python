...
class SearchAddressReverseBatchItemResponse(ErrorResponse, SearchAddressReverseResponse):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SearchAddressReverseBatchItemResponse, self).__init__(error=error, **kwargs)
        self.summary = None
        self.addresses = None
        self.error = error
...
class SearchCommonResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        position: Optional["CoordinatesPairAbbreviated"] = None,
        **kwargs
    ):
...
class SearchCommonSummaryGeoBias(CoordinatesPairAbbreviated):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SearchCommonSummaryGeoBias, self).__init__(lat=lat, lon=lon, **kwargs)
...
class SearchFuzzyBatchItemResponse(ErrorResponse, SearchCommonResponse):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SearchFuzzyBatchItemResponse, self).__init__(error=error, **kwargs)
        self.summary = None
        self.results = None
        self.error = error
...
class SearchResultAddressRanges(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        from_property: Optional["CoordinatesPairAbbreviated"] = None,
        to: Optional["CoordinatesPairAbbreviated"] = None,
        **kwargs
    ):
...
class SearchResultViewport(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        top_left_point: Optional["CoordinatesPairAbbreviated"] = None,
        btm_right_point: Optional["CoordinatesPairAbbreviated"] = None,
        **kwargs
    ):
