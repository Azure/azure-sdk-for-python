...
try:
    ...
    from ._models_py3 import Geometry
    ...
    from ._models_py3 import SearchAddressBatchProcessResult
    ...
    from ._models import Geometry  # type: ignore
    ...
    from ._models import SearchAddressBatchProcessResult  # type: ignore
