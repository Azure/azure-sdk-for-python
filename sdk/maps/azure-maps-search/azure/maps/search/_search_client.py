...
class MapsSearchClient(MapsSearchClientBase):
    ...
    def fuzzy_search(
        ...
        **kwargs: Any
        ...
        result = self._search_client.fuzzy_search(
            query,
            lat=coordinates[0],
            lon=coordinates[1],
    ...
    def search_structured_address(
        ...
        **kwargs: Any
        ...
        :paramtype entity_type:
            str or ~azure.maps.search.models.GeographicEntityType
        :keyword localized_map_view:
            The View parameter (also called the "user region" parameter) allows you to show the
    ...
    def fuzzy_search_batch(
        ...
        **kwargs: Any
        ...
        batch_response = self._search_client.fuzzy_search_batch_sync(
    ...
    def begin_fuzzy_search_batch(
        ...
        **kwargs
        ...
        :return:
            The results of search batch request.
        :rtype:
            ~azure.core.polling.LROPoller[~azure.maps.search.models.SearchAddressBatchResult]
        :raises:
            ~azure.core.exceptions.HttpResponseError:
        """
        batch_items = [{"query": f"?query={query}"} for query in search_queries] if search_queries else []
    ...
    @distributed_trace
    def reverse_search_address_batch(
        self,
        search_queries: List[str],
        **kwargs: Any
    ) -> ReverseSearchAddressBatchProcessResult:
    ...
    def begin_reverse_search_address_batch(
        ...
        search_queries: List[str],
        **kwargs: Any
    ) -> LROPoller[ReverseSearchAddressBatchProcessResult]:
