...
class SearchClient(object):
    ...
    def list_polygons(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "PolygonResult"
        """**Get Polygon**
        <https://docs.microsoft.com/en-us/rest/api/maps/search/get-search-polygon>`_.
    ...
    def fuzzy_search(
        ...
        **kwargs  # type: Any
        ...
        """**Free Form Search**
        <https://docs.microsoft.com/en-us/rest/api/maps/search/get-search-fuzzy>`_.
        ...
        return self._search_client.fuzzy_search(
            ...
            lat=kwargs.pop("language", None),
            lon=kwargs.pop("language", None),
            radius_in_meters=kwargs.pop("language", None),
            top_left=kwargs.pop("language", None),
            btm_right=kwargs.pop("language", None),
            language=kwargs.pop("language", None),
            extended_postal_codes_for=kwargs.pop("language", None),
            min_fuzzy_level=kwargs.pop("language", None),
            max_fuzzy_level=kwargs.pop("language", None),
            index_filter=kwargs.pop("language", None),
            brand_filter=kwargs.pop("language", None),
            electric_vehicle_connector_filter=kwargs.pop("language", None),
            entity_type=kwargs.pop("language", None),
            localized_map_view=kwargs.pop("language", None),
            operating_hours=kwargs.pop("language", None),
            **kwargs  # type: Any
        )
