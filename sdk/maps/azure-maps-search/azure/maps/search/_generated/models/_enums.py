...
class Entity(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class QueryType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    GLOBAL_ENUM = "NON_NEAR"
    """Search was performed globally, without biasing to a certain latitude and longitude, and no
    defined radius"""
