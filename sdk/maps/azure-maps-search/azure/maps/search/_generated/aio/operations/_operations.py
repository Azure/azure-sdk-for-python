...
from ...operations._operations import (
    build_search_fuzzy_search_batch_request,
    build_search_fuzzy_search_batch_sync_request,
    build_search_fuzzy_search_request,
    build_search_get_fuzzy_search_batch_request,
    build_search_get_point_of_interest_category_tree_request,
    build_search_get_reverse_search_address_batch_request,
    build_search_get_search_address_batch_request,
    build_search_list_polygons_request,
    build_search_reverse_search_address_batch_request,
    build_search_reverse_search_address_batch_sync_request,
    build_search_reverse_search_address_request,
    build_search_reverse_search_cross_street_address_request,
    build_search_search_address_batch_request,
    build_search_search_address_batch_sync_request,
    build_search_search_address_request,
    build_search_search_along_route_request,
    build_search_search_inside_geometry_request,
    build_search_search_nearby_point_of_interest_request,
    build_search_search_point_of_interest_category_request,
    build_search_search_point_of_interest_request,
    build_search_search_structured_address_request,
)
...
class SearchOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_fuzzy_search_batch(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.SearchAddressBatchResult]:
        """**Search Fuzzy Batch API**
    ...
    async def begin_fuzzy_search_batch(
        ...
        *
        ...
        if cont_token:
            return AsyncLROPoller[_models.SearchAddressBatchResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.SearchAddressBatchResult](
    ...
    async def begin_reverse_search_address_batch(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.ReverseSearchAddressBatchResult]:
        """**Search Address Reverse Batch API**
        ...
        *
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns ReverseSearchAddressBatchResult
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.maps.search.models.ReverseSearchAddressBatchResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_reverse_search_address_batch(
        ...
        *
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.ReverseSearchAddressBatchResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ReverseSearchAddressBatchResult](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    async def _get_reverse_search_address_batch_initial(  # pylint: disable=name-too-long
        self, batch_id: str, **kwargs: Any
    ) -> Optional[_models.ReverseSearchAddressBatchResult]:
        error_map = {
            401: ClientAuthenticationError,
