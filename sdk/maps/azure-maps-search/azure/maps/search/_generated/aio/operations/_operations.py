...
class SearchOperations:
    ...
    async def get_geocoding(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("GeocodingResponse", pipeline_response)
    ...
    @distributed_trace_async
    async def get_geocoding_batch(
        self, geocoding_batch_request_body: Union[_models.GeocodingBatchRequestBody, IO[bytes]], **kwargs: Any
    ) -> _models.GeocodingBatchResponse:
        """Use to send a batch of queries to the `Geocoding </rest/api/maps/search/get-geocoding>`_ API in
        a single request.
        ...
        *
        ...
        if isinstance(geocoding_batch_request_body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(geocoding_batch_request_body, "GeocodingBatchRequestBody")
        ...
        deserialized = self._deserialize("GeocodingBatchResponse", pipeline_response)
    ...
    async def get_reverse_geocoding_batch(
        ...
        *
        ...
        if isinstance(reverse_geocoding_batch_request_body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(reverse_geocoding_batch_request_body, "ReverseGeocodingBatchRequestBody")
