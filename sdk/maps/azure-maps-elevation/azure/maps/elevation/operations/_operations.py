...
def build_elevation_get_data_for_points_request(
    format: str = "json",
    *,
    points: List[str],
    ...
    **kwargs: Any
    ...
    _params['points'] = _SERIALIZER.query("points", points, '[str]', div='|')
...
def build_elevation_post_data_for_points_request(
    format: str = "json",
    *,
...
def build_elevation_get_data_for_polyline_request(
    format: str = "json",
    *,
    lines: List[str],
    client_id: Optional[str] = None,
    ...
    **kwargs: Any
    ...
    # Construct parameters
    _params['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
    _params['lines'] = _SERIALIZER.query("lines", lines, '[str]', skip_quote=True, div='|')
    if samples is not None:
        _params['samples'] = _SERIALIZER.query("samples", samples, 'int', maximum=2000, minimum=2)
...
def build_elevation_post_data_for_polyline_request(
    format: str = "json",
    *,
    json: Optional[List[JSON]] = None,
    content: Any = None,
...
def build_elevation_get_data_for_bounding_box_request(
    format: str = "json",
    *,
    bounds: List[float],
    rows: int,
    ...
    **kwargs: Any
    ...
    _params['rows'] = _SERIALIZER.query("rows", rows, 'int', maximum=1000, minimum=2)
    _params['columns'] = _SERIALIZER.query("columns", columns, 'int', maximum=1000, minimum=2)
...
class ElevationOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.maps.elevation.ElevationClient`'s
