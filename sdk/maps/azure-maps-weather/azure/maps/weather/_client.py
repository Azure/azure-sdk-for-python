...
class MapsWeatherClient(WeatherOperations):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype weather: azure.maps.weather.operations.WeatherOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MapsWeatherClientConfiguration(credential=credential, client_id=client_id, **kwargs)
