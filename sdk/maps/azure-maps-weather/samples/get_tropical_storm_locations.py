...
def get_tropical_storm_locations():
    ...
    try:
        result = maps_weather_client.get_tropical_storm_locations(year=2021, basin_id="NP", government_storm_id=2)
