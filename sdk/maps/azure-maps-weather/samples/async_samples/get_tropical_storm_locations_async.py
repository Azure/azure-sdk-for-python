...
async def get_tropical_storm_locations():
    ...
    try:
        async with maps_weather_client:
            result = await maps_weather_client.get_tropical_storm_locations(
...
if __name__ == "__main__":
    asyncio.run(get_tropical_storm_locations())
