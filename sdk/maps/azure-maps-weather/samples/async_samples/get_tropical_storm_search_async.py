...
async def get_tropical_storm_search():
    ...
    try:
        async with maps_weather_client:
            result = await maps_weather_client.get_tropical_storm_search(year=2022)
...
if __name__ == "__main__":
    asyncio.run(get_tropical_storm_search())
