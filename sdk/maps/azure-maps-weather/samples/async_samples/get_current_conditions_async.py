...
"""
FILE: get_current_conditions_async.py
DESCRIPTION:
    This API returns current weather conditions.
USAGE:
    python get_current_conditions_async.py
...
async def get_current_conditions():
    ...
    try:
        async with maps_weather_client:
            result = await maps_weather_client.get_current_conditions(coordinates=[25.0338053, 121.5640089])
...
if __name__ == "__main__":
    asyncio.run(get_current_conditions())
