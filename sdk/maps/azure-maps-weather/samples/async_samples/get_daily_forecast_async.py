...
async def get_daily_forecast():
    ...
    try:
        async with maps_weather_client:
            result = await maps_weather_client.get_daily_forecast(coordinates=[25.0338053, 121.5640089])
...
if __name__ == "__main__":
    asyncio.run(get_daily_forecast())
