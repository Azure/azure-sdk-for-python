...
async def get_tropical_storm_active():
    ...
    try:
        async with maps_weather_client:
            result = await maps_weather_client.get_tropical_storm_active()
...
if __name__ == "__main__":
    asyncio.run(get_tropical_storm_active())
