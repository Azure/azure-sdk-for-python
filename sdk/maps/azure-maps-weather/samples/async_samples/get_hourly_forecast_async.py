...
async def get_hourly_forecast():
    ...
    try:
        async with maps_weather_client:
            result = await maps_weather_client.get_hourly_forecast(coordinates=[25.0338053, 121.5640089])
