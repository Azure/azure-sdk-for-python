...
"""
FILE: get_air_quality_hourly_forecasts_async.py
DESCRIPTION:
...
USAGE:
    python get_air_quality_hourly_forecasts_async.py
...
async def get_air_quality_hourly_forecasts():
    ...
    try:
        async with maps_weather_client:
            result = await maps_weather_client.get_air_quality_hourly_forecasts(coordinates=[25.0338053, 121.5640089])
...
if __name__ == "__main__":
    asyncio.run(get_air_quality_hourly_forecasts())
