...
def get_quarter_day_forecast():
    ...
    try:
        result = maps_weather_client.get_quarter_day_forecast(coordinates=[25.0338053, 121.5640089])
        print(result)
