...
def main():
    ...
    client.operation_result.get(
        location="eastus",
        operation_id="01234567-89ab-4def-0123-456789abcdef",
    )


# x-ms-original-file: specification/maps/resource-manager/Microsoft.Maps/Maps/preview/2025-10-01-preview/examples/GetOperationResult.json
