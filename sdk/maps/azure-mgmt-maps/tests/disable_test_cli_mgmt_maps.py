...
class MgmtMapsManagementClientTest(AzureMgmtTestCase):
    ...
    def setUp(self):
        ...
        self.mgmt_client = self.create_mgmt_client(azure.mgmt.maps.MapsManagementClient)
    ...
    def test_maps(self, resource_group):
        ...
        # CreateAccount[put]
        BODY = {"location": "global", "sku": {"name": "S0"}, "tags": {"test": "true"}}
