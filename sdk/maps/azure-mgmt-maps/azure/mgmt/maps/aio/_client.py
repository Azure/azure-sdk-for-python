...
class AzureMapsManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype operation_result: azure.mgmt.maps.aio.operations.OperationResultOperations
    :ivar operation_status: OperationStatusOperations operations
    :vartype operation_status: azure.mgmt.maps.aio.operations.OperationStatusOperations
    ...
    :keyword api_version: The API version to use for this operation. Known values are
     "2025-10-01-preview". Default value is "2025-10-01-preview". Note that overriding this default
