...
from ._base_client import TimezoneClientBase
JSON = MutableMapping[str, Any]  # pylint: disable=unsubscriptable-object


class AzureTimezoneClient(TimezoneClientBase):
    ...
    def get_timezone_by_id(
        ...
        """
        result = self._timezone_client.get_timezone_by_id(
            format,
    ...
    def get_timezone_by_coordinates(
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        result = self._timezone_client.get_timezone_by_coordinates(
            format,
    ...
    def get_windows_timezone_ids(self, format: str = "json", **kwargs: Any) -> List[JSON]:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        result = self._timezone_client.get_windows_timezone_ids(
            format,
            **kwargs
        )
    ...
    def get_iana_timezone_ids(self, format: str = "json", **kwargs: Any) -> List[JSON]:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        result = self._timezone_client.get_iana_timezone_ids(
            format,
            **kwargs
        )
    ...
    def get_iana_version(self, format: str = "json", **kwargs: Any) -> JSON:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        result = self._timezone_client.get_iana_version(
            format,
            **kwargs
        )
    ...
    def convert_windows_timezone_to_iana(
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        result = self._timezone_client.convert_windows_timezone_to_iana(
            format,
