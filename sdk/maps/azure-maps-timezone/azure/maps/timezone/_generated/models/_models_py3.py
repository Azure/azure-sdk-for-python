...
class CountryRecord(_serialization.Model):
    """A country record.
...
class ErrorResponse(_serialization.Model):
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs):
        ...
        :paramtype error: ~azure.maps.timezone.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error


class IanaId(_serialization.Model):
    """IanaId.
...
class ReferenceTime(_serialization.Model):
...
class RepresentativePoint(_serialization.Model):
...
class TimeTransition(_serialization.Model):
    """TimeTransition.
...
class TimezoneIanaVersionResult(_serialization.Model):
...
class TimezoneId(_serialization.Model):
    """TimezoneId.
    ...
    def __init__(self, *, names: Optional["_models.TimezoneNames"] = None, **kwargs):
        """
        :keyword names: Timezone names object.
        :paramtype names: ~azure.maps.timezone.models.TimezoneNames
        """
        super().__init__(**kwargs)
        self.id = None
        self.aliases = None
...
class TimezoneNames(_serialization.Model):
...
class TimezoneResult(_serialization.Model):
...
class TimezoneWindows(_serialization.Model):
    """TimezoneWindows.
    ...
    def __init__(self, *, iana_ids: Optional[List[str]] = None, **kwargs):
        """
        :keyword iana_ids: IanaIds array.
        :paramtype iana_ids: list[str]
        """
        super().__init__(**kwargs)
