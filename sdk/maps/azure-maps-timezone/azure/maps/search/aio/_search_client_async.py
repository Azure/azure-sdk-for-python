...
class AzureMapsSearchClient(AsyncMapsSearchClientBase):
    ...
    async def get_geocoding_batch(self, geocoding_batch_request_body: Union[JSON, IO[bytes]], **kwargs: Any) -> JSON:
        ...
        *
        ...
        result = await self._search_client.get_geocoding_batch(
            geocoding_batch_request_body=geocoding_batch_request_body,
            **kwargs
        )
        return result
    ...
    async def get_reverse_geocoding_batch(
        ...
        *
        ...
        result = await self._search_client.get_reverse_geocoding_batch(
            reverse_geocoding_batch_request_body=reverse_geocoding_batch_request_body,
            **kwargs
        )
        return result
