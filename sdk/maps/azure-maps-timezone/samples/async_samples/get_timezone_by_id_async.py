...
async def get_timezone_by_id_async():
    ...
    try:
        async with timezone_client:
            result = await timezone_client.get_timezone_by_id(timezone_id="sr-Latn-RS")
            print(result)
...
if __name__ == "__main__":
    asyncio.run(get_timezone_by_id_async())
