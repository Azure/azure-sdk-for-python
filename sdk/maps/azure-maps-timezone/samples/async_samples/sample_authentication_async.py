...
async def authentication_maps_service_client_with_subscription_key_credential_async():
    ...
    # [END create_maps_timezone_service_client_with_key_async]

    iana_id = "America/New_York"
    async with maps_timezone_client:
        result = await maps_timezone_client.get_timezone_by_id(iana_id)
...
async def authentication_maps_service_client_with_aad_credential_async():
    ...
    iana_id = "America/New_York"
    async with maps_timezone_client, credential:
        result = await maps_timezone_client.get_timezone_by_id(iana_id)
