...
class AliasOperations:
    ...
    def list(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.AliasListResponse"]:
        """**Applies to:** see pricing `tiers <https://aka.ms/AzureMapsPricingTier>`_.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.maps.creator.models.AliasListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
