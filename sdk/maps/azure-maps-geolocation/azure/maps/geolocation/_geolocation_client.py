...
class GeolocationClient(object):
    """Azure Maps Geolocation REST APIs.

    :ivar geolocation: GeolocationOperations operations
    :vartype geolocation: azure.maps.geolocation.operations.GeolocationOperations
    ...
    :type geography: str or ~azure.maps.geolocation.models.Geography
    """
    ...
    def __init__(
        ...
        **kwargs  # type: Any
        ...
        self._config = GeolocationClientConfiguration(credential, x_ms_client_id, geography, **kwargs)
