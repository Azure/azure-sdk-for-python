...
class MapsGeolocationClient(_MapsGeolocationClientOperationsMixin):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        _endpoint = "{endpoint}"
        self._config = MapsGeolocationClientConfiguration(credential=credential, client_id=client_id, **kwargs)
