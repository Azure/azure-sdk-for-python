...
class TrafficOperations:
    ...
    async def get_traffic_flow_tile(
        self,
        format: Union[str, "models.TileFormat"],
        style: Union[str, "models.TrafficFlowTileStyle"],
        zoom: int,
    ...
    async def get_traffic_flow_segment(
        self,
        style: Union[str, "models.TrafficFlowSegmentStyle"],
        zoom: int,
        coordinates: List[float],
        format: Union[str, "models.ResponseFormat"] = "json",
        unit: Optional[Union[str, "models.SpeedUnit"]] = None,
        thickness: Optional[int] = None,
        open_lr: Optional[bool] = None,
        **kwargs
    ) -> "models.TrafficFlowSegmentData":
    ...
    async def get_traffic_incident_tile(
        self,
        format: Union[str, "models.TileFormat"],
        style: Union[str, "models.TrafficIncidentTileStyle"],
        zoom: int,
        tile_index: "models.TileIndex",
    ...
    async def get_traffic_incident_detail(
        self,
        style: Union[str, "models.IncidentDetailStyle"],
        boundingbox: List[float],
        bounding_zoom: int,
        trafficmodelid: str,
        format: Union[str, "models.ResponseFormat"] = "json",
        language: Optional[str] = None,
        projection: Optional[Union[str, "models.ProjectionStandard"]] = None,
        geometries: Optional[Union[str, "models.IncidentGeometryType"]] = None,
        expand_cluster: Optional[bool] = None,
        original_position: Optional[bool] = None,
        **kwargs
    ) -> "models.TrafficIncidentDetail":
    ...
    async def get_traffic_incident_viewport(
        ...
        boundingbox: List[float],
        boundingzoom: int,
        overviewbox: List[float],
        overviewzoom: int,
        format: Union[str, "models.ResponseFormat"] = "json",
        copyright: Optional[bool] = True,
        **kwargs
    ) -> "models.TrafficIncidentViewport":
