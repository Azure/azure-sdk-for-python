...
class TrafficClientConfiguration(Configuration):
    """Configuration for TrafficClient.
    ...
    :type geography: str or ~azure.maps.traffic.models.Geography
    """
    ...
    def __init__(
        ...
        **kwargs  # type: Any
        ...
        super(TrafficClientConfiguration, self).__init__(**kwargs)
