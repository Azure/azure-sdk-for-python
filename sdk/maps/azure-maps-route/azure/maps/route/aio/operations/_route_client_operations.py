...
class RouteClientOperationsMixin:
    ...
    async def _request_route_matrix_initial(
        ...
        **kwargs
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.RouteMatrixResult"]]
        error_map = {
        ...
        # Construct URL
        url = self._request_route_matrix_initial.metadata['url']  # type: ignore
        ...
        if compute_travel_time is not None:
            query_parameters['computeTravelTimeFor'] = self._serialize.query("compute_travel_time", compute_travel_time, 'str')
        if filter_section_type is not None:
            query_parameters['sectionType'] = self._serialize.query("filter_section_type", filter_section_type, 'str')
        ...
        if incline_level is not None:
            query_parameters['hilliness'] = self._serialize.query("incline_level", incline_level, 'str')
        ...
        if use_traffic_data is not None:
            query_parameters['traffic'] = self._serialize.query("use_traffic_data", use_traffic_data, 'bool')
        ...
        body_content = self._serialize.body(route_matrix_query, 'RouteMatrixQuery')
        ...
        return deserialized
    _request_route_matrix_initial.metadata = {'url': '/route/matrix/{format}'}  # type: ignore
    ...
    async def begin_request_route_matrix(
        ...
        **kwargs
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType["models.RouteMatrixResult"]
    ...
    begin_request_route_matrix.metadata = {'url': '/route/matrix/{format}'}  # type: ignore
    ...
    async def _get_route_matrix_initial(
        ...
        **kwargs
        ...
        path_format_arguments = {
            'format': self._serialize.url("matrix_id", matrix_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    async def request_route_matrix_sync(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.request_route_matrix_sync.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    request_route_matrix_sync.metadata = {'url': '/route/matrix/sync/{format}'}  # type: ignore
    ...
    async def get_route_directions(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.RouteDirections"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        query_parameters = {}  # type: Dict[str, Any]
        query_parameters['api-version'] = self._serialize.query("api_version", api_version, 'str')
        query_parameters['query'] = self._serialize.query("route_points", route_points, 'str')
        ...
        if compute_best_waypoint_order is not None:
            query_parameters['computeBestOrder'] = self._serialize.query("compute_best_waypoint_order", compute_best_waypoint_order, 'bool')
        if route_representation_for_best_order is not None:
            query_parameters['routeRepresentation'] = self._serialize.query("route_representation_for_best_order", route_representation_for_best_order, 'str')
        if compute_travel_time is not None:
            query_parameters['computeTravelTimeFor'] = self._serialize.query("compute_travel_time", compute_travel_time, 'str')
        ...
        if is_commercial_vehicle is not None:
            query_parameters['vehicleCommercial'] = self._serialize.query("is_commercial_vehicle", is_commercial_vehicle, 'bool')
        if windingness is not None:
            query_parameters['windingness'] = self._serialize.query("windingness", windingness, 'str')
        if incline_level is not None:
            query_parameters['hilliness'] = self._serialize.query("incline_level", incline_level, 'str')
        ...
        if constant_speed_consumption_in_liters_per_hundred_km is not None:
            query_parameters['constantSpeedConsumptionInLitersPerHundredkm'] = self._serialize.query("constant_speed_consumption_in_liters_per_hundred_km", constant_speed_consumption_in_liters_per_hundred_km, 'str')
        ...
        if fuel_energy_density_in_megajoules_per_liter is not None:
            query_parameters['fuelEnergyDensityInMJoulesPerLiter'] = self._serialize.query("fuel_energy_density_in_megajoules_per_liter", fuel_energy_density_in_megajoules_per_liter, 'float')
        if acceleration_efficiency is not None:
            query_parameters['accelerationEfficiency'] = self._serialize.query("acceleration_efficiency", acceleration_efficiency, 'float', maximum=1, minimum=0)
        if deceleration_efficiency is not None:
            query_parameters['decelerationEfficiency'] = self._serialize.query("deceleration_efficiency", deceleration_efficiency, 'float', maximum=1, minimum=0)
        if uphill_efficiency is not None:
            query_parameters['uphillEfficiency'] = self._serialize.query("uphill_efficiency", uphill_efficiency, 'float', maximum=1, minimum=0)
        if downhill_efficiency is not None:
            query_parameters['downhillEfficiency'] = self._serialize.query("downhill_efficiency", downhill_efficiency, 'float', maximum=1, minimum=0)
        if constant_speed_consumption_in_kw_h_per_hundred_km is not None:
            query_parameters['constantSpeedConsumptionInkWhPerHundredkm'] = self._serialize.query("constant_speed_consumption_in_kw_h_per_hundred_km", constant_speed_consumption_in_kw_h_per_hundred_km, 'str')
        if current_charge_in_kw_h is not None:
            query_parameters['currentChargeInkWh'] = self._serialize.query("current_charge_in_kw_h", current_charge_in_kw_h, 'float')
        if max_charge_in_kw_h is not None:
            query_parameters['maxChargeInkWh'] = self._serialize.query("max_charge_in_kw_h", max_charge_in_kw_h, 'float')
        if auxiliary_power_in_kw is not None:
            query_parameters['auxiliaryPowerInkW'] = self._serialize.query("auxiliary_power_in_kw", auxiliary_power_in_kw, 'float')
    ...
    async def get_route_directions_with_additional_parameters(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_route_directions_with_additional_parameters.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(route_direction_parameters, 'RouteDirectionParameters')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
        ...
        return deserialized
    get_route_directions_with_additional_parameters.metadata = {'url': '/route/directions/{format}'}  # type: ignore
    ...
    async def get_route_range(
        ...
        **Applies to**\ : S1 pricing tier.
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.RouteRangeResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        if energy_budget_in_kw_h is not None:
            query_parameters['energyBudgetInkWh'] = self._serialize.query("energy_budget_in_kw_h", energy_budget_in_kw_h, 'float')
    ...
    async def _request_route_directions_batch_initial(
        ...
        **kwargs
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.RouteDirectionsBatchResult"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        # Construct URL
        url = self._request_route_directions_batch_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(route_directions_batch_queries, 'BatchRequest')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
        ...
        return deserialized
    _request_route_directions_batch_initial.metadata = {'url': '/route/directions/batch/{format}'}  # type: ignore
    ...
    async def begin_request_route_directions_batch(
        ...
        *
        ...
        """
        polling = kwargs.pop('polling', False)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.RouteDirectionsBatchResult"]
        lro_delay = kwargs.pop(
            'polling_interval',
            self._config.polling_interval
        )
        ...
        if cont_token:
            ...
            return AsyncLROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_request_route_directions_batch.metadata = {'url': '/route/directions/batch/{format}'}  # type: ignore
    ...
    async def request_route_directions_batch_sync(
        ...
        *
        ...
        # Construct URL
        url = self.request_route_directions_batch_sync.metadata['url']  # type: ignore
        path_format_arguments = {
            'format': self._serialize.url("format", format, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    request_route_directions_batch_sync.metadata = {'url': '/route/directions/batch/sync/{format}'}  # type: ignore
