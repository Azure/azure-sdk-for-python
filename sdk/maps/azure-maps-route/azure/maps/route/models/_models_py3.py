...
class BatchRequest(msrest.serialization.Model):
    ...
    :type batch_items: list[~azure.maps.route.models.BatchRequestItem]
    """
...
class EffectiveSetting(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(EffectiveSetting, self).__init__(**kwargs)
        self.key = None
        self.value = None
...
class RouteDirectionParameters(msrest.serialization.Model):
     ...
     * The reference route may contain traffic incidents of type _ROAD\ *CLOSURE*\ , which are
       ...
       Please refer to `Supporting Points <https://docs.microsoft.com/azure/azure-maps/how-to-use-
     best-practices-for-routing#calculate-and-bias-alternative-routes-using-supporting-points>`_ for
     details.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RouteDirectionParameters, self).__init__(**kwargs)
...
class RouteDirections(msrest.serialization.Model):
    ...
    :type report: ~azure.maps.route.models.RouteReport
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RouteDirections, self).__init__(**kwargs)
...
class RouteDirectionsBatchItemResponse(ErrorResponse, RouteDirections):
...
class RouteDirectionsBatchResult(BatchResult):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RouteDirectionsBatchResult, self).__init__(**kwargs)
        self.batch_items = None


class RouteGuidance(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RouteGuidance, self).__init__(**kwargs)
        self.instructions = None
        self.instruction_groups = None


class RouteInstruction(msrest.serialization.Model):
    ...
    :type point: ~azure.maps.route.models.LatLongPair
    ...
    def __init__(
        self,
        *,
        point: Optional["LatLongPair"] = None,
        instruction_type: Optional[Union[str, "GuidanceInstructionType"]] = None,
        **kwargs
    ):
        super(RouteInstruction, self).__init__(**kwargs)
...
class RouteInstructionGroup(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RouteInstructionGroup, self).__init__(**kwargs)
...
class RouteLeg(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RouteLeg, self).__init__(**kwargs)
        self.summary = None
        self.points = None


class RouteLegSummary(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RouteLegSummary, self).__init__(**kwargs)
...
class RouteMatrix(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RouteMatrix, self).__init__(**kwargs)
        self.status_code = None
        self.response = None


class RouteMatrixQuery(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RouteMatrixQuery, self).__init__(**kwargs)
...
class RouteRange(msrest.serialization.Model):
    ...
    :type center: ~azure.maps.route.models.LatLongPair
    ...
    def __init__(
        self,
        *,
        center: Optional["LatLongPair"] = None,
        **kwargs
    ):
...
class RouteRangeResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RouteRangeResult, self).__init__(**kwargs)
        self.format_version = None
        self.reachable_range = reachable_range
        self.report = report


class RouteReport(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RouteReport, self).__init__(**kwargs)
        self.effective_settings = None


class RouteSection(msrest.serialization.Model):
    ...
    :ivar section_type: Section types of the reported route response. Possible values include:
     "CAR_TRAIN", "COUNTRY", "FERRY", "MOTORWAY", "PEDESTRIAN", "TOLL_ROAD", "TOLL_VIGNETTE",
     "TRAFFIC", "TRAVEL_MODE", "TUNNEL", "CARPOOL", "URBAN".
    ...
    :ivar travel_mode: Travel mode for the calculated route. The value will be set to ``other`` if
     the requested mode of transport is not possible in this section. Possible values include:
     "car", "truck", "taxi", "bus", "van", "motorcycle", "bicycle", "pedestrian", "other".
    ...
    :ivar simple_category: Type of the incident. Can currently be JAM, ROAD_WORK, ROAD_CLOSURE, or
     OTHER. See "tec" for detailed information. Possible values include: "JAM", "ROAD_WORK",
     "ROAD_CLOSURE", "OTHER".
    ...
    :param tec: Details of the traffic event, using definitions in the `TPEG2-TEC
     ...
     elements.
    :type tec: ~azure.maps.route.models.RouteSectionTec
    """
    ...
    def __init__(
        self,
        *,
        tec: Optional["RouteSectionTec"] = None,
        **kwargs
    ):
        super(RouteSection, self).__init__(**kwargs)
...
class RouteSectionTec(msrest.serialization.Model):
    ...
    :type causes: list[~azure.maps.route.models.RouteSectionTecCause]
    """
    ...
    def __init__(
        self,
        *,
        causes: Optional[List["RouteSectionTecCause"]] = None,
        **kwargs
    ):
        super(RouteSectionTec, self).__init__(**kwargs)
        self.effect_code = None
        self.causes = causes


class RouteSectionTecCause(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RouteSectionTecCause, self).__init__(**kwargs)
        self.main_cause_code = None
        self.sub_cause_code = None


class RouteSummary(msrest.serialization.Model):
    """Summary object.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RouteSummary, self).__init__(**kwargs)
        self.length_in_meters = None
        self.travel_time_in_seconds = None
        self.traffic_delay_in_seconds = None
        self.departure_time = None
