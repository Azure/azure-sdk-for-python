...
class WidgetSuite(_Model):
    ...
    :ivar widget_id: The Fake Widget ID. Required.
    :vartype widget_id: int
    """
    ...
    widget_id: int = rest_field(name="widgetId", visibility=["read", "create", "update", "delete", "query"])
    """The Fake Widget ID. Required."""
