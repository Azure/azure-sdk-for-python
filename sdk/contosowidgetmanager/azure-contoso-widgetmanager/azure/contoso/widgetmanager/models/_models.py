...
class FakedSharedModel(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """Faked shared model.
...
class WidgetSuite(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """A widget.
