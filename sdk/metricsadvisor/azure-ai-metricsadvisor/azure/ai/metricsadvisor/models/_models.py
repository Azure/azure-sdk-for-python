...
class AzureApplicationInsightsDataFeedSource(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype query: str
        """
        super(AzureApplicationInsightsDataFeedSource, self).__init__(**kwargs)
...
class AzureBlobDataFeedSource(msrest.serialization.Model):
    ...
    def __init__(self, *, container: str, blob_template: str, connection_string: Optional[str] = None, **kwargs):
        ...
        """
        super(AzureBlobDataFeedSource, self).__init__(**kwargs)
...
class AzureCosmosDbDataFeedSource(msrest.serialization.Model):
    ...
    def __init__(
        ...
        """
        super(AzureCosmosDbDataFeedSource, self).__init__(**kwargs)
        self.connection_string = connection_string
...
class AzureDataExplorerDataFeedSource(msrest.serialization.Model):
    ...
    def __init__(self, *, query: str, connection_string: Optional[str] = None, **kwargs):
        ...
        :paramtype query: str
        """
        super(AzureDataExplorerDataFeedSource, self).__init__(**kwargs)
        self.connection_string = connection_string
        self.query = query
...
class AzureDataLakeStorageGen2DataFeedSource(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super(AzureDataLakeStorageGen2DataFeedSource, self).__init__(**kwargs)
...
class AzureEventHubsDataFeedSource(msrest.serialization.Model):
    ...
    def __init__(self, *, consumer_group: str, connection_string: Optional[str] = None, **kwargs):
        ...
        """
        super(AzureEventHubsDataFeedSource, self).__init__(**kwargs)
        self.connection_string = connection_string
...
class AzureLogAnalyticsDataFeedSource(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype query: str
        """
        super(AzureLogAnalyticsDataFeedSource, self).__init__(**kwargs)
...
class AzureTableDataFeedSource(msrest.serialization.Model):
    ...
    def __init__(self, *, table: str, query: str, connection_string: Optional[str] = None, **kwargs):
        ...
        :paramtype query: str
        """
        super(AzureTableDataFeedSource, self).__init__(**kwargs)
        self.connection_string = connection_string
        self.table = table
        self.query = query
...
class DataFeed(msrest.serialization.Model):
    ...
    :vartype id: str
    :ivar name: Required. data feed name.
    :vartype name: str
    ...
    :vartype data_source_parameter: any
    """
    ...
    def __init__(
        ...
        *,
        ...
        fill_missing_point_type: Optional[Union[str, "_models.DatasourceMissingDataPointFillType"]] = "SmartFilling",
        ...
        data_source_parameter: Optional[Any] = None,
        **kwargs
    ):
        """
        :keyword name: Required. data feed name.
        :paramtype name: str
        ...
        :paramtype data_source_parameter: any
        """
...
class DataFeedDimension(msrest.serialization.Model):
    ...
    :ivar name: Required. dimension name.
    :vartype name: str
    ...
    def __init__(self, *, name: str, display_name: Optional[str] = None, **kwargs):
        """
        :keyword name: Required. dimension name.
        :paramtype name: str
...
class DataFeedMetric(msrest.serialization.Model):
    ...
    :ivar id: metric id.
    :vartype id: str
    :ivar name: Required. metric name.
    :vartype name: str
    ...
    def __init__(self, *, name: str, display_name: Optional[str] = None, description: Optional[str] = None, **kwargs):
        """
        :keyword name: Required. metric name.
        :paramtype name: str
...
class NotificationHook(msrest.serialization.Model):
    ...
    :ivar hook_type: Required. hook type.Constant filled by server.
...
class InfluxDbDataFeedSource(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype query: str
        """
        super(InfluxDbDataFeedSource, self).__init__(**kwargs)
        self.connection_string = connection_string
        self.database = database
...
class MetricBoundaryCondition(msrest.serialization.Model):
    ...
    :vartype upper: float
    :ivar direction: Required. value filter direction.
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword direction: Required. value filter direction.
...
class MongoDbDataFeedSource(msrest.serialization.Model):
    ...
    def __init__(
        ...
        """
        super(MongoDbDataFeedSource, self).__init__(**kwargs)
        self.connection_string = connection_string
        self.database = database
