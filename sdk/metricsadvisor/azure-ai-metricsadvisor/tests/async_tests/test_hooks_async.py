    ...
    async def test_create_email_hook(self):
        ...
        async with self.admin_client:
            try:
                ...
                email_hook = await self.admin_client.get_hook(hook_id)
                ...
                await self.admin_client.delete_hook(hook_id)

                with self.assertRaises(ResourceNotFoundError):
                    await self.admin_client.get_hook(hook_id)
    ...
    async def test_create_web_hook(self):
        ...
        async with self.admin_client:
            try:
                ...
                web_hook = await self.admin_client.get_hook(hook_id)
