...
class TestMetricsAdvisorAdministrationClient(TestMetricsAdvisorClientBase):
    ...
    @MetricsAdvisorPreparer()
    @recorded_by_proxy
    def test_list_data_feeds(self, client, **kwargs):
    ...
    @MetricsAdvisorPreparer()
    @recorded_by_proxy
    def test_list_data_feeds_with_data_feed_name(self, client, **kwargs):
    ...
    @MetricsAdvisorPreparer()
    @recorded_by_proxy
    def test_list_data_feeds_with_skip(self, client, **kwargs):
    ...
    @MetricsAdvisorPreparer()
    @recorded_by_proxy
    def test_list_data_feeds_with_status(self, client, **kwargs):
    ...
    @MetricsAdvisorPreparer()
    @recorded_by_proxy
    def test_list_data_feeds_with_source_type(self, client, **kwargs):
    ...
    @MetricsAdvisorPreparer()
    @recorded_by_proxy
    def test_list_data_feeds_with_granularity_type(self, client, **kwargs):
