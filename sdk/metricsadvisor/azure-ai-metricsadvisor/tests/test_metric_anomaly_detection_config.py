...
class TestMetricsAdvisorAdministrationClient(TestMetricsAdvisorAdministrationClientBase):
    ...
    def test_create_ad_config_whole_series_detection(self):
        ...
        try:
            ...
            self.admin_client.delete_metric_anomaly_detection_configuration(config.id)

            with self.assertRaises(ResourceNotFoundError):
                self.admin_client.get_metric_anomaly_detection_configuration(config.id)
        finally:
    ...
    def test_list_metric_anomaly_detection_configs(self):
