...
"""
FILE: sample_anomaly_detection_configuration_async.py
...
USAGE:
    python sample_anomaly_detection_configuration_async.py
...
async def sample_create_detection_config_async():
    ...
    async with client:
        detection_config = await client.create_metric_anomaly_detection_configuration(anomaly_detection_configuration)

        return detection_config
    # [END create_anomaly_detection_config_async]


async def sample_get_detection_config_async(detection_config_id):
    # [START get_anomaly_detection_config_async]
    from azure.ai.metricsadvisor import MetricsAdvisorKeyCredential
    from azure.ai.metricsadvisor.aio import MetricsAdvisorAdministrationClient
    ...
    async with client:
        config = await client.get_metric_anomaly_detection_configuration(detection_config_id)
    ...
    # [END get_anomaly_detection_config_async]
...
async def sample_list_detection_configs_async():
    ...
    # [END list_anomaly_detection_configs_async]


async def sample_update_detection_config_async(detection_config):
    # [START update_anomaly_detection_config_async]
    from azure.ai.metricsadvisor import MetricsAdvisorKeyCredential
    from azure.ai.metricsadvisor.aio import MetricsAdvisorAdministrationClient
    from azure.ai.metricsadvisor.models import (
    ...
    async with client:
        updated = await client.update_metric_anomaly_detection_configuration(
            detection_config,
    ...
    # [END update_anomaly_detection_config_async]


async def sample_delete_detection_config_async(detection_config_id):
    # [START delete_anomaly_detection_config_async]
    ...
    async with client:
        await client.delete_metric_anomaly_detection_configuration(detection_config_id)

        try:
            await client.get_metric_anomaly_detection_configuration(detection_config_id)
        except ResourceNotFoundError:
            print("Detection configuration successfully deleted.")
    # [END delete_anomaly_detection_config_async]
