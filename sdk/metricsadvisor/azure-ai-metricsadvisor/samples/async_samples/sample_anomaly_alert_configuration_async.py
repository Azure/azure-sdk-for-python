...
"""
FILE: sample_anomaly_alert_configuration_async.py
...
USAGE:
    python sample_anomaly_alert_configuration_async.py
...
async def sample_create_alert_config_async():
    ...
    async with client:
        ...
        return alert_config
    # [END create_anomaly_alert_config_async]


async def sample_get_alert_config_async(alert_config_id):
    # [START get_anomaly_alert_config_async]
    from azure.ai.metricsadvisor import MetricsAdvisorKeyCredential
    from azure.ai.metricsadvisor.aio import MetricsAdvisorAdministrationClient
    ...
    async with client:
        config = await client.get_anomaly_alert_configuration(alert_config_id)
    ...
    # [END get_anomaly_alert_config_async]


async def sample_list_alert_configs_async():
    # [START list_anomaly_alert_configs_async]
    from azure.ai.metricsadvisor import MetricsAdvisorKeyCredential
    from azure.ai.metricsadvisor.aio import MetricsAdvisorAdministrationClient
    ...
    # [END list_anomaly_alert_configs_async]


async def sample_list_alerts_for_alert_config_async(alert_config_id):
    ...
    # [END list_alerts_for_alert_config_async]
...
async def sample_update_alert_config_async(alert_config):
    ...
    # [END update_anomaly_alert_config_async]


async def sample_delete_alert_config_async(alert_config_id):
    # [START delete_anomaly_alert_config_async]
    ...
    async with client:
        await client.delete_anomaly_alert_configuration(alert_config_id)

        try:
            await client.get_anomaly_alert_configuration(alert_config_id)
        except ResourceNotFoundError:
            print("Alert configuration successfully deleted.")
    # [END delete_anomaly_alert_config_async]
