...
"""
FILE: sample_anomaly_detection_configuration.py
...
USAGE:
    python sample_anomaly_detection_configuration.py
...
def sample_create_detection_config():
    # [START create_anomaly_detection_config]
    ...
    detection_config = client.create_metric_anomaly_detection_configuration(anomaly_detection_configuration)

    return detection_config
    # [END create_anomaly_detection_config]


def sample_get_detection_config(detection_config_id):
    # [START get_anomaly_detection_config]
    from azure.ai.metricsadvisor import MetricsAdvisorKeyCredential, MetricsAdvisorAdministrationClient
    ...
    # [END get_anomaly_detection_config]


def sample_list_detection_configs():
    # [START list_anomaly_detection_configs]
    from azure.ai.metricsadvisor import MetricsAdvisorKeyCredential, MetricsAdvisorAdministrationClient
    ...
    # [END list_anomaly_detection_configs]


def sample_update_detection_config(detection_config):
    # [START update_anomaly_detection_config]
    from azure.ai.metricsadvisor import MetricsAdvisorKeyCredential, MetricsAdvisorAdministrationClient
    from azure.ai.metricsadvisor.models import (
    ...
    # [END update_anomaly_detection_config]


def sample_delete_detection_config(detection_config_id):
    # [START delete_anomaly_detection_config]
    ...
    # [END delete_anomaly_detection_config]
