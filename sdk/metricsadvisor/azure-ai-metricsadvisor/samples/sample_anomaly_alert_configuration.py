...
"""
FILE: sample_anomaly_alert_configuration.py
...
USAGE:
    python sample_anomaly_alert_configuration.py
...
def sample_get_alert_config(alert_config_id):
    ...
    # [END get_anomaly_alert_config]


def sample_list_alert_configs():
    # [START list_anomaly_alert_configs]
    from azure.ai.metricsadvisor import MetricsAdvisorKeyCredential, MetricsAdvisorAdministrationClient
    ...
    # [END list_anomaly_alert_configs]


def sample_list_alerts_for_alert_config(alert_config_id):
    # [START list_alerts_for_alert_config]
    import datetime
    ...
    # [END list_alerts_for_alert_config]
...
def sample_update_alert_config(alert_config):
    # [START update_anomaly_alert_config]
    from azure.ai.metricsadvisor import MetricsAdvisorKeyCredential, MetricsAdvisorAdministrationClient
    from azure.ai.metricsadvisor.models import (
        MetricAlertConfiguration,
        MetricAnomalyAlertScope,
    ...
    # [END update_anomaly_alert_config]
...
def sample_delete_alert_config(alert_config_id):
    ...
    # [END delete_anomaly_alert_config]
