...
class TargetsOperations:
    """TargetsOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.TargetListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~microsoft_azure_chaos.models.TargetListResult]
