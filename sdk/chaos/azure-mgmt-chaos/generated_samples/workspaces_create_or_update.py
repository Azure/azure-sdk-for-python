...
# USAGE
    python workspaces_create_or_update.py
...
def main():
    ...
    response = client.workspaces.begin_create_or_update(
        ...
        resource={
            ...
            "location": "westus2",
            "properties": {
                "scopes": ["/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/exampleResourceGroup"]
            },
            "tags": {"department": "engineering", "environment": "production", "project": "chaos-testing"},
        },
    ).result()
    print(response)
