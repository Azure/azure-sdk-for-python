...
def main():
    ...
    response = client.experiments.get(
...
# x-ms-original-file: specification/chaos/resource-manager/Microsoft.Chaos/stable/2025-01-01/examples/Experiments_Get.json
