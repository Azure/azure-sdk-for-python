...
namespace azure.mgmt.chaos.models
    ...
    class azure.mgmt.chaos.models.ActionStatus(Model):
        action_id: str
        action_name: str
        end_time: datetime
        start_time: datetime
        status: str
        targets: list[ExperimentExecutionActionTargetDetailsProperties]
    ...
    class azure.mgmt.chaos.models.BranchStatus(Model):
    ...
    class azure.mgmt.chaos.models.CapabilityListResult(Model):
        next_link: str
    ...
    class azure.mgmt.chaos.models.CapabilityType(ProxyResource):
        azure_rbac_actions: list[str]
        azure_rbac_data_actions: list[str]
        description: str
        display_name: str
        id: str
        kind: str
        ...
        parameters_schema: str
        publisher: str
        required_azure_role_definition_ids: list[str]
        runtime_properties: CapabilityTypePropertiesRuntimeProperties
        system_data: SystemData
        target_type: str
        type: str
        urn: str
    ...
    class azure.mgmt.chaos.models.CapabilityTypeListResult(Model):
        next_link: str
    ...
    class azure.mgmt.chaos.models.CapabilityTypePropertiesRuntimeProperties(Model):
        kind: str
    ...
    class azure.mgmt.chaos.models.ChaosExperimentAction(Model):
        name: str
        type: Union[str, ExperimentActionType]
    ...
    class azure.mgmt.chaos.models.ChaosExperimentBranch(Model):
    ...
    class azure.mgmt.chaos.models.ChaosExperimentStep(Model):
    ...
    class azure.mgmt.chaos.models.ChaosTargetFilter(Model):
    ...
    class azure.mgmt.chaos.models.ChaosTargetListSelector(ChaosTargetSelector):
    ...
    class azure.mgmt.chaos.models.ChaosTargetQuerySelector(ChaosTargetSelector):
        filter: ChaosTargetFilter
        id: str
        query_string: str
    ...
    class azure.mgmt.chaos.models.ChaosTargetSelector(Model):
        filter: ChaosTargetFilter
        id: str
        type: Union[str, SelectorType]
    ...
    class azure.mgmt.chaos.models.ChaosTargetSimpleFilter(ChaosTargetFilter):
    ...
    class azure.mgmt.chaos.models.ChaosTargetSimpleFilterParameters(Model):
        zones: list[str]
    ...
    class azure.mgmt.chaos.models.ContinuousAction(ChaosExperimentAction):
        duration: timedelta
        name: str
    ...
    class azure.mgmt.chaos.models.DelayAction(ChaosExperimentAction):
        duration: timedelta
        name: str
        type: Union[str, ExperimentActionType]
    ...
    class azure.mgmt.chaos.models.DiscreteAction(ChaosExperimentAction):
        name: str
        parameters: list[KeyValuePair]
        selector_id: str
        type: Union[str, ExperimentActionType]
    ...
    class azure.mgmt.chaos.models.ErrorAdditionalInfo(Model):
        info: JSON
        type: str
    ...
    class azure.mgmt.chaos.models.ErrorDetail(Model):
    ...
    class azure.mgmt.chaos.models.ErrorResponse(Model):
        error: ErrorDetail
    ...
    class azure.mgmt.chaos.models.ExperimentExecutionActionTargetDetailsError(Model):
        code: str
        message: str
    ...
    class azure.mgmt.chaos.models.ExperimentExecutionActionTargetDetailsProperties(Model):
        error: ExperimentExecutionActionTargetDetailsError
        status: str
        target: str
        target_completed_time: datetime
        target_failed_time: datetime
    ...
    class azure.mgmt.chaos.models.ExperimentExecutionDetails(Model):
        id: str
        name: str
    ...
    class azure.mgmt.chaos.models.ExperimentExecutionDetailsProperties(Model):
        failure_reason: str
        last_action_at: datetime
        run_information: ExperimentExecutionDetailsPropertiesRunInformation
        started_at: datetime
        status: str
        stopped_at: datetime
    ...
    class azure.mgmt.chaos.models.ExperimentExecutionDetailsPropertiesRunInformation(Model):
    ...
    class azure.mgmt.chaos.models.ExperimentExecutionListResult(Model):
        next_link: str
        value: list[ExperimentExecution]
    ...
    class azure.mgmt.chaos.models.ExperimentListResult(Model):
        next_link: str
    ...
    class azure.mgmt.chaos.models.ExperimentUpdate(Model):
        identity: ManagedServiceIdentity
        tags: dict[str, str]
    ...
    class azure.mgmt.chaos.models.KeyValuePair(Model):
        key: str
        value: str
    ...
    class azure.mgmt.chaos.models.ManagedServiceIdentity(Model):
        principal_id: str
        tenant_id: str
    ...
    class azure.mgmt.chaos.models.Operation(Model):
    ...
    class azure.mgmt.chaos.models.OperationDisplay(Model):
        description: str
        operation: str
        provider: str
        resource: str
    ...
    class azure.mgmt.chaos.models.OperationListResult(Model):
        next_link: str
    ...
    class azure.mgmt.chaos.models.OperationStatusResult(Model):
        end_time: datetime
        error: ErrorDetail
        id: str
        name: str
    ...
    class azure.mgmt.chaos.models.Resource(Model):
        id: str
        name: str
        system_data: SystemData
        type: str
    ...
    class azure.mgmt.chaos.models.StepStatus(Model):
    ...
    class azure.mgmt.chaos.models.SystemData(Model):
        created_at: datetime
        created_by: str
    ...
    class azure.mgmt.chaos.models.TargetListResult(Model):
        next_link: str
        value: list[Target]
    ...
    class azure.mgmt.chaos.models.TargetReference(Model):
        id: str
    ...
    class azure.mgmt.chaos.models.TargetTypeListResult(Model):
        next_link: str
        value: list[TargetType]
    ...
    class azure.mgmt.chaos.models.UserAssignedIdentity(Model):
        client_id: str
        principal_id: str
