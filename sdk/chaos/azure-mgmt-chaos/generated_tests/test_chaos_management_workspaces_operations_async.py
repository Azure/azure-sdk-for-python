...
class TestChaosManagementWorkspacesOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_workspaces_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.workspaces.begin_create_or_update(
                ...
                resource={
                    "location": "str",
                    "properties": {"scopes": ["str"], "communicationEndpoint": "str", "provisioningState": "str"},
                    "id": "str",
                    "identity": {
                        "type": "str",
                        "principalId": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_workspaces_list_all(self, resource_group):
        response = self.client.workspaces.list_all()
        result = [r async for r in response]
        # please add some check logic here by yourself
        # ...
