...
class GuestUsagesOperations(object):
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type resource_patch:
         ~$(python-base-namespace).v2020_05_01_preview.models.GuestUsagesResourcePatch
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: GuestUsagesResource, or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2020_05_01_preview.models.GuestUsagesResource
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either GuestUsagesResourceList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2020_05_01_preview.models.GuestUsagesResourceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
