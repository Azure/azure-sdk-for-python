...
class B2CResourceSKUTier(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class TypeValue(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """The type of the B2C tenant resource.
    """

    #: The resource type for Azure AD B2C tenant resource.
    MICROSOFT_AZURE_ACTIVE_DIRECTORY_B2_C_DIRECTORIES = "Microsoft.AzureActiveDirectory/b2cDirectories"
