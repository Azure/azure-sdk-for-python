...
from ...operations._operations import build_get_async_status_request, build_list_request
T = TypeVar('T')
...
class Operations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.OperationListResult]
