    ...
    def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type check_name_availability_request_body:
         ~$(python-base-namespace).v2019_01_01_preview.models.CheckNameAvailabilityRequestBody
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either B2CTenantResourceList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~$(python-base-namespace).v2019_01_01_preview.models.B2CTenantResourceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type update_tenant_request_body:
         ~$(python-base-namespace).v2019_01_01_preview.models.B2CTenantUpdateRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: B2CTenantResource, or the result of cls(response)
        :rtype: ~$(python-base-namespace).v2019_01_01_preview.models.B2CTenantResource
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type create_tenant_request_body:
         ~$(python-base-namespace).v2019_01_01_preview.models.CreateTenantRequestBody
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either B2CTenantResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~$(python-base-namespace).v2019_01_01_preview.models.B2CTenantResource]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
