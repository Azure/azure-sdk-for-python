...
class AsyncOperationStatus(msrest.serialization.Model):
    ...
    :vartype status: str or
     ~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.StatusType
    ...
    :vartype error:
     ~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.AsyncOperationStatusError
    :ivar billing_config: The billing configuration for the tenant.
    :vartype billing_config:
     ~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.B2CTenantResourcePropertiesBillingConfig
...
class B2CResourceSKU(msrest.serialization.Model):
    ...
    :ivar name: The name of the SKU for the tenant. Possible values include: "Standard",
     "PremiumP1", "PremiumP2".
    :vartype name: str or
     ~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.B2CResourceSKUName
...
class B2CTenantResource(msrest.serialization.Model):
    ...
    :vartype sku: ~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.B2CResourceSKU
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype sku: ~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.B2CResourceSKU
...
class B2CTenantResourceList(msrest.serialization.Model):
    ...
    :vartype value:
     list[~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.B2CTenantResource]
    """
...
class B2CTenantResourcePropertiesBillingConfig(msrest.serialization.Model):
    ...
    :vartype billing_type: str or
     ~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.BillingType
...
class CreateTenantRequestBody(msrest.serialization.Model):
    ...
    :vartype properties:
     ~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.CreateTenantRequestBodyProperties
    :ivar sku: Required. SKU properties of the Azure AD B2C tenant. Learn more about Azure AD B2C
     billing at `aka.ms/b2cBilling <https://aka.ms/b2cBilling>`_.
    :vartype sku: ~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.B2CResourceSKU
    :ivar tags: A set of tags. Resource Tags.
...
class ErrorResponse(msrest.serialization.Model):
    ...
    :vartype details:
     list[~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.ErrorResponse]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.ErrorAdditionalInfo]
    """
...
class NameAvailabilityResponse(msrest.serialization.Model):
    ...
    :vartype reason: str or
     ~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.NameAvailabilityReasonType
    """
...
class Operation(msrest.serialization.Model):
    ...
    :vartype display:
     ~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.OperationDisplay
    """
...
class OperationListResult(msrest.serialization.Model):
    ...
    :ivar value: List of cpim service operations supported by the Microsoft.AzureActiveDirectory
     resource provider.
    :vartype value:
     list[~azure.mgmt.azureadexternalidentities.v2019_01_01_preview.models.Operation]
    """
