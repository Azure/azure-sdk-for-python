...
# --------------------------------------------------------------------------
# pylint: disable=line-too-long,useless-suppression,too-many-lines,protected-access,broad-except,no-member,comparison-with-callable
...
def _deserialize_with_callable(
    ...
    try:
        ...
        if isinstance(value, ET.Element):
            ...
            if (
                deserializer
                and deserializer in _DESERIALIZE_MAPPING_WITHFORMAT.values()
            ):
                return deserializer(value.text) if value.text else None
        ...
        if isinstance(deserializer, CaseInsensitiveEnumMeta):
            try:
                return deserializer(
                    value.text if isinstance(value, ET.Element) else value
                )
            except ValueError:
