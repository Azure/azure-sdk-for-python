...
# --------------------------------------------------------------------------
# pylint: disable=protected-access,broad-except,no-member,comparison-with-callable
    ...
    if _is_model(o):
        ...
        for k, v in o.items():
            ...
            if prop_meta.get("unwrapped", False):
                ...
                if prop_meta.get("ns"):
                    ET.register_namespace(prop_meta.get("prefix"), prop_meta.get("ns"))  # pyright: ignore  # fmt: skip
                    xml_name = "{" + prop_meta.get("ns") + "}" + xml_name  # pyright: ignore  # fmt: skip
