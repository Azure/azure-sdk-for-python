...
# --------------------------------------------------------------------------
# pylint: disable=line-too-long,useless-suppression,too-many-lines,protected-access,inconsistent-return-statements,unnecessary-lambda-assignment
...
class Model:
    ...
    def _flatten_subtype(cls, key, objects):
        ...
        for valuetype in cls._subtype_map[key].values():
            result |= objects[valuetype]._flatten_subtype(
                key, objects
