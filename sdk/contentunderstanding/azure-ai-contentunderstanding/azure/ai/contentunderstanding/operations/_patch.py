...
from ..models import PersonDirectoryFace, FindSimilarFacesResult, IdentifyPersonResult

class PersonDirectoriesOperations(PersonDirectoriesOperationsGenerated):
    """Extended PersonDirectoriesOperations with improved add_face, find_similar_faces, and identify_person method overloads."""
    ...
    def identify_person(
        ...
        **kwargs: Any
        ...
        """Identify person using image URL.
        
        :param person_directory_id: The person directory ID
        :type person_directory_id: str
        :param url: Image URL
        :type url: str
        :param max_person_candidates: Maximum number of person candidates to return (up to 10)
        :type max_person_candidates: int
        :return: IdentifyPersonResult
    ...
    def identify_person(
        ...
        **kwargs: Any
        ...
        """Identify person using image data.
    ...
    @distributed_trace
    def identify_person(self, person_directory_id: str, *args, **kwargs) -> IdentifyPersonResult:
        """Identify person with improved overloads.
        
        This method accepts either:
        - A string URL as the second argument: identify_person(dir_id, "http://...")
        - Base64-encoded image data as bytes as the second argument: identify_person(dir_id, bytes_data)
        - Original keyword arguments: identify_person(person_directory_id=..., face_source=..., max_person_candidates=...)
        ...
        # Fall back to original method behavior
        return super().identify_person(person_directory_id=person_directory_id, **kwargs)