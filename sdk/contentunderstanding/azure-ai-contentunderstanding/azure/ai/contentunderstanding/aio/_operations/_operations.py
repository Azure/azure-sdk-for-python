...
# --------------------------------------------------------------------------
#
# MANUAL CUSTOMIZATIONS APPLIED - Search for "EMITTER-FIX" to find all changes
#
...
from ..._operations._operations import (
    ...
    build_content_understanding_copy_request,
    build_content_understanding_create_or_replace_request,
    build_content_understanding_delete_request,
    ...
    build_content_understanding_get_request,
    ...
    build_content_understanding_list_request,
    build_content_understanding_update_defaults_request,
    build_content_understanding_update_request,
)
...
class _ContentUnderstandingClientOperationsMixin(
    ...
    async def _analyze_binary_initial(
        ...
        *,
        ...
        # EMITTER-FIX: content_type default value missing (TypeSpec specifies "application/octet-stream")
        ...
        **kwargs: Any
        ...
        # EMITTER-FIX: Use parameter instead of kwargs.pop
        # content_type: str = kwargs.pop("content_type")  # Original (broken)
        cls: ClsType[AsyncIterator[bytes]] = kwargs.pop("cls", None)
