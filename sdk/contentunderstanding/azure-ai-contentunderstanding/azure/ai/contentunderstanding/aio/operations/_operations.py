...
class ContentAnalyzersOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.ai.contentunderstanding.aio.ContentUnderstandingClient`'s
...
class PersonDirectoriesOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.PersonDirectory"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.contentunderstanding.models.PersonDirectory]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_persons(self, person_directory_id: str, **kwargs: Any) -> AsyncItemPaged["_models.PersonDirectoryPerson"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.contentunderstanding.models.PersonDirectoryPerson]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_faces(self, person_directory_id: str, **kwargs: Any) -> AsyncItemPaged["_models.PersonDirectoryFace"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.contentunderstanding.models.PersonDirectoryFace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class ContentClassifiersOperations:
    ...
    async def begin_create_or_replace(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns ContentClassifier. The ContentClassifier is
         compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.ai.contentunderstanding.models.ContentClassifier]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.ContentClassifier"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.contentunderstanding.models.ContentClassifier]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def begin_classify(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns ClassifyResult. The ClassifyResult is
         compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.ai.contentunderstanding.models.ClassifyResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
