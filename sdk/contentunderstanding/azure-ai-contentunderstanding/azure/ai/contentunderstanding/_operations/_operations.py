...
def build_content_understanding_analyze_request(  # pylint: disable=name-too-long
    ...
    **kwargs: Any
    ...
    if allow_input_truncation is not None:
        _params["allowInputTruncation"] = _SERIALIZER.query("allow_input_truncation", allow_input_truncation, "bool")
...
def build_content_understanding_analyze_inline_request(  # pylint: disable=name-too-long
    analyzer_id: str,
    *,
    string_encoding: str,
    processing_location: Optional[Union[str, _models.ProcessingLocation]] = None,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/analyzers/{analyzerId}:analyzeInline"
    path_format_arguments = {
        "analyzerId": _SERIALIZER.url("analyzer_id", analyzer_id, "str"),
    }
...
def build_content_understanding_analyze_binary_inline_request(  # pylint: disable=name-too-long
    analyzer_id: str,
    *,
    string_encoding: str,
    content_range: Optional[str] = None,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/analyzers/{analyzerId}:analyzeBinaryInline"
    path_format_arguments = {
        "analyzerId": _SERIALIZER.url("analyzer_id", analyzer_id, "str"),
    }
...
def build_content_understanding_list_analyzers_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class _ContentUnderstandingClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], ContentUnderstandingClientConfiguration]
):

    @api_version_validation(
        params_added_on={"2026-06-01-preview": ["allow_input_truncation"]},
        api_versions_list=["2025-11-01", "2026-06-01-preview"],
    )
    def _analyze_initial(
        self,
        analyzer_id: str,
        body: Union[JSON, _types.AnalyzeRequest, IO[bytes]] = _Unset,
        *,
        string_encoding: str,
    ...
    def begin_analyze(
        ...
        **kwargs: Any
        ...
        :keyword allow_input_truncation: Overrides the analyzer's allowInputTruncation setting for this
         request. When omitted, the analyzer's configured value applies. Default value is None.
    ...
    def begin_analyze(
        ...
        **kwargs: Any
        ...
        :type analyzer_id: str
        :param body: Required.
        :type body: ~azure.ai.contentunderstanding.types.AnalyzeRequest
        :keyword string_encoding:   The string encoding format for content spans in the response.
           Possible values are 'codePoint', 'utf16', and ``utf8``.  Default is ``codePoint``.").
         Required.
        :paramtype string_encoding: str
    ...
    def begin_analyze(
        ...
        **kwargs: Any
        ...
        :param analyzer_id: The unique identifier of the analyzer. Required.
        :type analyzer_id: str
        :param body: Is one of the following types: JSON, AnalyzeRequest, IO[bytes] Required.
        :type body: JSON or ~azure.ai.contentunderstanding.types.AnalyzeRequest or IO[bytes]
        :keyword string_encoding:   The string encoding format for content spans in the response.
           Possible values are 'codePoint', 'utf16', and ``utf8``.  Default is ``codePoint``.").
         Required.
        :paramtype string_encoding: str
    ...
    def analyze_inline(
        ...
        **kwargs: Any
        ...
        """Extract content and fields from input. The analysis result is embedded inline in the JSON
        response body (HTTP 200) without creating a long-running operation — no polling or separate
        result retrieval is needed. Intended for lightweight analysis scenarios (e.g., document
        analyzers without field extraction, small page counts). The result is not persisted on the
        server. See service documentation for current constraints.
        ...
        :keyword model_deployments: Specify the default mapping of model names to LLM/embedding
         ...
         is None.
        :paramtype model_deployments: dict[str, str]
        :return: ContentAnalyzerInlineResponse. The ContentAnalyzerInlineResponse is compatible with
         MutableMapping
    ...
    def analyze_inline(
        self,
        analyzer_id: str,
        body: _types.AnalyzeInlineRequest,
        *,
        string_encoding: str,
        processing_location: Optional[Union[str, _models.ProcessingLocation]] = None,
        allow_input_truncation: Optional[bool] = None,
        ...
        **kwargs: Any
        ...
        :type analyzer_id: str
        :param body: Required.
        :type body: ~azure.ai.contentunderstanding.types.AnalyzeInlineRequest
        :keyword string_encoding:   The string encoding format for content spans in the response.
           Possible values are 'codePoint', 'utf16', and ``utf8``.  Default is ``codePoint``.").
         Required.
        :paramtype string_encoding: str
    ...
    def analyze_inline(
        self,
        analyzer_id: str,
        body: Union[JSON, _types.AnalyzeInlineRequest, IO[bytes]] = _Unset,
        *,
        string_encoding: str,
        inputs: list[_models.AnalysisInput] = _Unset,
        processing_location: Optional[Union[str, _models.ProcessingLocation]] = None,
        ...
        **kwargs: Any
        ...
        :param analyzer_id: The unique identifier of the analyzer. Required.
        :type analyzer_id: str
        :param body: Is one of the following types: JSON, AnalyzeInlineRequest, IO[bytes] Required.
        :type body: JSON or ~azure.ai.contentunderstanding.types.AnalyzeInlineRequest or IO[bytes]
        :keyword string_encoding:   The string encoding format for content spans in the response.
           Possible values are 'codePoint', 'utf16', and ``utf8``.  Default is ``codePoint``.").
         Required.
        :paramtype string_encoding: str
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.ContentAnalyzerInlineResponse] = kwargs.pop("cls", None)
        ...
        _request = build_content_understanding_analyze_inline_request(
            analyzer_id=analyzer_id,
            string_encoding=string_encoding,
            processing_location=processing_location,
            allow_input_truncation=allow_input_truncation,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.ContentAnalyzerInlineResponse, response.json())
    ...
    def analyze_binary_inline(
        ...
        **kwargs: Any
        ...
        """Extract content and fields from binary input. The analysis result is embedded inline in the
        JSON response body (HTTP 200) without creating a long-running operation — no polling or
        separate result retrieval is needed. Intended for lightweight analysis scenarios (e.g.,
        document analyzers without field extraction, small page counts). The result is not persisted on
        the server. See service documentation for current constraints.
        ...
        _request = build_content_understanding_analyze_binary_inline_request(
            analyzer_id=analyzer_id,
            string_encoding=string_encoding,
            content_range=content_range,
            processing_location=processing_location,
    ...
    def _copy_analyzer_initial(
        self,
        analyzer_id: str,
        body: Union[JSON, _types.CopyAnalyzerRequest, IO[bytes]] = _Unset,
        *,
    ...
    def begin_copy_analyzer(
        self,
        analyzer_id: str,
        body: _types.CopyAnalyzerRequest,
        *,
        allow_replace: Optional[bool] = None,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :type analyzer_id: str
        :param body: Required.
        :type body: ~azure.ai.contentunderstanding.types.CopyAnalyzerRequest
        :keyword allow_replace: Allow the operation to replace an existing resource. Default value is
         None.
        :paramtype allow_replace: bool
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
    ...
    def begin_copy_analyzer(
        ...
        **kwargs: Any
        ...
        :param analyzer_id: The unique identifier of the analyzer. Required.
        :type analyzer_id: str
        :param body: Is one of the following types: JSON, CopyAnalyzerRequest, IO[bytes] Required.
        :type body: JSON or ~azure.ai.contentunderstanding.types.CopyAnalyzerRequest or IO[bytes]
        :keyword source_analyzer_id: Source analyzer ID. Required.
        :paramtype source_analyzer_id: str
        :keyword allow_replace: Allow the operation to replace an existing resource. Default value is
         None.
    ...
    def _create_analyzer_initial(
        self,
        analyzer_id: str,
        resource: Union[_models.ContentAnalyzer, _types.ContentAnalyzer, IO[bytes]],
        *,
        allow_replace: Optional[bool] = None,
        **kwargs: Any
    ) -> Iterator[bytes]:
    ...
    def begin_create_analyzer(
        self,
        analyzer_id: str,
        resource: _types.ContentAnalyzer,
        *,
        allow_replace: Optional[bool] = None,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :type analyzer_id: str
        :param resource: The resource instance. Required.
        :type resource: ~azure.ai.contentunderstanding.types.ContentAnalyzer
        :keyword allow_replace: Allow the operation to replace an existing resource. Default value is
         None.
        :paramtype allow_replace: bool
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
    ...
    def begin_create_analyzer(
        ...
        **kwargs: Any
        ...
        :param analyzer_id: The unique identifier of the analyzer. Required.
        :type analyzer_id: str
        :param resource: The resource instance. Is either a ContentAnalyzer type or a IO[bytes] type.
         Required.
        :type resource: ~azure.ai.contentunderstanding.models.ContentAnalyzer or
         ~azure.ai.contentunderstanding.types.ContentAnalyzer or IO[bytes]
        :keyword allow_replace: Allow the operation to replace an existing resource. Default value is
         None.
        :paramtype allow_replace: bool
        :return: An instance of LROPoller that returns ContentAnalyzer. The ContentAnalyzer is
    ...
    def grant_copy_authorization(
        self,
        analyzer_id: str,
        body: _types.GrantCopyAuthorizationRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.CopyAuthorization:
        ...
        :type analyzer_id: str
        :param body: Required.
        :type body: ~azure.ai.contentunderstanding.types.GrantCopyAuthorizationRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: CopyAuthorization. The CopyAuthorization is compatible with MutableMapping
    ...
    def grant_copy_authorization(
        self,
        analyzer_id: str,
        body: Union[JSON, _types.GrantCopyAuthorizationRequest, IO[bytes]] = _Unset,
        *,
        ...
        **kwargs: Any
        ...
        :param analyzer_id: The unique identifier of the analyzer. Required.
        :type analyzer_id: str
        :param body: Is one of the following types: JSON, GrantCopyAuthorizationRequest, IO[bytes]
         Required.
        :type body: JSON or ~azure.ai.contentunderstanding.types.GrantCopyAuthorizationRequest or
         IO[bytes]
        :keyword target_azure_resource_id: Azure resource ID of the target analyzer location. Required.
        :paramtype target_azure_resource_id: str
        :keyword target_region: Azure region of the target analyzer location.  Defaults to current
    ...
    @overload
    def update_defaults(
        self, body: _types.UpdateDefaultsRequest, *, content_type: str = "application/merge-patch+json", **kwargs: Any
    ) -> _models.ContentUnderstandingDefaults:
        """Update default settings for this Content Understanding resource.

        :param body: Required.
        :type body: ~azure.ai.contentunderstanding.types.UpdateDefaultsRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/merge-patch+json".
        :paramtype content_type: str
        :return: ContentUnderstandingDefaults. The ContentUnderstandingDefaults is compatible with
    ...
    def update_defaults(
        self,
        body: Union[JSON, _types.UpdateDefaultsRequest, IO[bytes]] = _Unset,
        *,
        model_deployments: Optional[_models.RecordMergePatchUpdate] = None,
        **kwargs: Any
    ) -> _models.ContentUnderstandingDefaults:
        ...
        :param body: Is one of the following types: JSON, UpdateDefaultsRequest, IO[bytes] Required.
        :type body: JSON or ~azure.ai.contentunderstanding.types.UpdateDefaultsRequest or IO[bytes]
        :keyword model_deployments: Specify the default mapping of model names to LLM/embedding
         deployments in Microsoft Foundry. For details and current semantics, see
         `https://aka.ms/cudoc-quickstart-rest <https://aka.ms/cudoc-quickstart-rest>`_. Default value
         is None.
