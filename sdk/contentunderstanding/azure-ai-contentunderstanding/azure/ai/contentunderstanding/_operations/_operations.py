...
def build_content_understanding_analyze_binary_request(  # pylint: disable=name-too-long
    ...
    **kwargs: Any
    ...
    # EMITTER-FIX: Add fallback default for content_type (TypeSpec specifies "application/octet-stream")
    content_type: str = kwargs.pop("content_type", "application/octet-stream")
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2025-11-01"))
    accept = _headers.pop("Accept", "application/json")
