...
def patch_sdk():
    ...
    # Wrap begin_analyze to return custom LROPoller and set string_encoding
    def begin_analyze_wrapped(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.ai.contentunderstanding.operations.AnalyzeLROPoller[~azure.ai.contentunderstanding.models.AnalyzeResult]
    ...
    def begin_analyze_binary_wrapped(
        ...
        **kwargs: Any
        ...
        # Always use codePoint encoding for Python (matches Python's string indexing)
        kwargs["string_encoding"] = "codePoint"
        poller = original_begin_analyze_binary(
            self,
            analyzer_id,
            binary_input,
            processing_location=processing_location,
