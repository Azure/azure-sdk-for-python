...
from ._enums import AnalysisContentKind, ChunkingStrategyKind, ContentFieldType, DocumentFigureKind, KnowledgeSourceKind
...
class AnalysisContent(_Model):
    ...
    :ivar metadata: Metadata extracted from the input as string key/value pairs, such as author,
     title, creation date, or media properties. Keys and values are strings. Only keys with
     extracted values are present.
    ...
    """Metadata extracted from the input as string key/value pairs, such as author, title, creation
     date, or media properties. Keys and values are strings. Only keys with extracted values are
     present."""
...
class AnalysisInput(_Model):
    ...
    content_range: Optional[str] = rest_field(name="range", visibility=["read", "create", "update", "delete", "query"])
...
class AnalysisResult(_Model):
    ...
    :ivar infos: Additional diagnostic information about the analysis.
    :vartype infos: list[~azure.core.ODataV4Format]
    ...
    infos: Optional[list[ODataV4Format]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    ...
    contents: list["_models.AnalysisContent"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    ...
    def __init__(
        ...
        *,
        ...
        infos: Optional[list[ODataV4Format]] = None,
...
class ChunkingStrategy(_Model):
    """Strategy for chunking document content. The ``kind`` property serves as the discriminator.

    You probably want to use the sub-classes and not this class directly. Known sub-classes are:
    SemanticChunkingStrategy

    :ivar kind: The chunking strategy kind. Required. "semantic"
    :vartype kind: str or ~azure.ai.contentunderstanding.models.ChunkingStrategyKind
    """

    __mapping__: dict[str, _Model] = {}
    kind: str = rest_discriminator(name="kind", visibility=["read", "create", "update", "delete", "query"])
    """The chunking strategy kind. Required. \"semantic\""""
...
class ContentAnalyzerAnalyzeOperationStatus(_Model):
    ...
    result: Optional["_models.AnalysisResult"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class ContentAnalyzerConfig(_Model):
    ...
    :vartype workflow: str or ~azure.ai.contentunderstanding.models.ContentAnalyzerWorkflow
    ...
    :vartype chunking_strategy: ~azure.ai.contentunderstanding.models.ChunkingStrategy
    """
    ...
    workflow: Optional[Union[str, "_models.ContentAnalyzerWorkflow"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """Workflow used for content analysis. Known values are: \"default\" and \"agentic\"."""
    allow_input_truncation: Optional[bool] = rest_field(
        name="allowInputTruncation", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    allow_in_page_segments: Optional[bool] = rest_field(
        name="allowInPageSegments", visibility=["read", "create", "update", "delete", "query"]
    )
    """Enable sub-page segmentation. When true, segments may cover a portion of a page instead of full
     pages."""
    chunking_strategy: Optional["_models.ChunkingStrategy"] = rest_field(
        name="chunkingStrategy", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        ...
        workflow: Optional[Union[str, "_models.ContentAnalyzerWorkflow"]] = None,
        allow_input_truncation: Optional[bool] = None,
        allow_in_page_segments: Optional[bool] = None,
        chunking_strategy: Optional["_models.ChunkingStrategy"] = None,
    ) -> None: ...
...
class ContentAnalyzerInlineResponse(_Model):
    """Provides inline response details for analyze operations.

    :ivar status: The status of the inline analyze request. Required. Known values are:
     "NotStarted", "Running", "Succeeded", "Failed", and "Canceled".
    :vartype status: str or ~azure.ai.contentunderstanding.models.OperationState
    :ivar result: The result of the inline analyze request. Required.
    :vartype result: ~azure.ai.contentunderstanding.models.AnalysisResult
    :ivar usage: Usage details of the inline analyze request.
    :vartype usage: ~azure.ai.contentunderstanding.models.UsageDetails
    """
    ...
    """The status of the inline analyze request. Required. Known values are: \"NotStarted\",
     \"Running\", \"Succeeded\", \"Failed\", and \"Canceled\"."""
    result: "_models.AnalysisResult" = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The result of the inline analyze request. Required."""
    usage: Optional["_models.UsageDetails"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class DocumentChunk(_Model):
    ...
    :ivar spans: List of spans defining the chunk's position(s) in the markdown content. Required.
    :vartype spans: list[~azure.ai.contentunderstanding.models.ContentSpan]
    :ivar source: Encoded source expression describing the visual bounding polygons of the chunk's
     content on the page. Derived from the union of layout objects (paragraphs, tables, figures)
     that compose the chunk.
    :vartype source: str
    """

    spans: list["_models.ContentSpan"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """List of spans defining the chunk's position(s) in the markdown content. Required."""
    source: Optional[str] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Encoded source expression describing the visual bounding polygons of the chunk's content on the
     page. Derived from the union of layout objects (paragraphs, tables, figures) that compose the
     chunk."""
    ...
    def __init__(
        self,
        *,
        spans: list["_models.ContentSpan"],
        source: Optional[str] = None,
    ) -> None: ...
...
class DocumentContent(AnalysisContent, discriminator="document"):
    ...
    :ivar signatures: List of signatures in the document.  Only if enableLayout and returnDetails
     are true.
    :vartype signatures: list[~azure.ai.contentunderstanding.models.DocumentSignature]
    ...
    :ivar chunks: List of document chunks.  Only if chunkingStrategy is configured on the analyzer.
    :vartype chunks: list[~azure.ai.contentunderstanding.models.DocumentChunk]
    """
    ...
    signatures: Optional[list["_models.DocumentSignature"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    """List of detected content segments.  Only if enableSegment is true."""
    chunks: Optional[list["_models.DocumentChunk"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
...
class DocumentContentSegment(_Model):
    ...
    :vartype end_page_number: int
    :ivar confidence: Confidence of the segmentation and category classification.
    :vartype confidence: float
    :ivar source: Encoded source that identifies the position of the segment in the content. Can be
     used as the 'range' input to route this segment to a sub-analyzer.
    :vartype source: str
    """
    ...
    source: Optional[str] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Encoded source that identifies the position of the segment in the content. Can be used as the
     'range' input to route this segment to a sub-analyzer."""
...
class DocumentSignature(_Model):
    """Signature detected in a document.

    :ivar id: Signature identifier. Required.
    :vartype id: str
    :ivar source: Encoded source that identifies the position of the signature in the content.
    :vartype source: str
    :ivar span: Span of the signature in the markdown content.
    :vartype span: ~azure.ai.contentunderstanding.models.ContentSpan
    :ivar elements: Child elements of the signature, such as paragraphs containing text within the
     signature region.
    :vartype elements: list[str]
    :ivar role: Semantic role of the signature. Known values are: "pageHeader", "pageFooter",
     "pageNumber", "title", "sectionHeading", "footnote", and "formulaBlock".
    :vartype role: str or ~azure.ai.contentunderstanding.models.SemanticRole
    """

    id: str = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Signature identifier. Required."""
    source: Optional[str] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Encoded source that identifies the position of the signature in the content."""
    span: Optional["_models.ContentSpan"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Span of the signature in the markdown content."""
    elements: Optional[list[str]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Child elements of the signature, such as paragraphs containing text within the signature
     region."""
    role: Optional[Union[str, "_models.SemanticRole"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """Semantic role of the signature. Known values are: \"pageHeader\", \"pageFooter\",
     \"pageNumber\", \"title\", \"sectionHeading\", \"footnote\", and \"formulaBlock\"."""
...
class SemanticChunkingStrategy(ChunkingStrategy, discriminator="semantic"):
    ...
    :vartype kind: str or ~azure.ai.contentunderstanding.models.SEMANTIC
    ...
    kind: Literal[ChunkingStrategyKind.SEMANTIC] = rest_discriminator(name="kind", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.kind = ChunkingStrategyKind.SEMANTIC  # type: ignore
...
class UsageDetails(_Model):
    ...
    :ivar document_pages_minimal_inline: The number of document pages processed at the minimal
     level by an inline analyze operation. For documents without explicit pages (ex. txt, html),
     every 3000 UTF-16 characters is counted as one page.
    :vartype document_pages_minimal_inline: int
    :ivar document_pages_basic_inline: The number of document pages processed at the basic level by
     an inline analyze operation. For documents without explicit pages (ex. txt, html), every 3000
     UTF-16 characters is counted as one page.
    :vartype document_pages_basic_inline: int
    :ivar document_pages_standard_inline: The number of document pages processed at the standard
     level by an inline analyze operation. For documents without explicit pages (ex. txt, html),
     every 3000 UTF-16 characters is counted as one page.
    :vartype document_pages_standard_inline: int
    ...
    :ivar advanced_contextualization_tokens: The number of advanced contextualization tokens
     consumed for preparing context, generating confidence scores, source grounding, and output
     formatting.
    :vartype advanced_contextualization_tokens: int
    ...
    """The number of document pages processed at the standard level. For documents without explicit
     pages (ex. txt, html), every 3000 UTF-16 characters is counted as one page."""
    document_pages_minimal_inline: Optional[int] = rest_field(
        name="documentPagesMinimalInline", visibility=["read", "create", "update", "delete", "query"]
    )
    """The number of document pages processed at the minimal level by an inline analyze operation. For
     documents without explicit pages (ex. txt, html), every 3000 UTF-16 characters is counted as
     one page."""
    document_pages_basic_inline: Optional[int] = rest_field(
        name="documentPagesBasicInline", visibility=["read", "create", "update", "delete", "query"]
    )
    """The number of document pages processed at the basic level by an inline analyze operation. For
     documents without explicit pages (ex. txt, html), every 3000 UTF-16 characters is counted as
     one page."""
    document_pages_standard_inline: Optional[int] = rest_field(
        name="documentPagesStandardInline", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    advanced_contextualization_tokens: Optional[int] = rest_field(
        name="advancedContextualizationTokens", visibility=["read", "create", "update", "delete", "query"]
    )
    """The number of advanced contextualization tokens consumed for preparing context, generating
     confidence scores, source grounding, and output formatting."""
    ...
    def __init__(
        ...
        *,
        ...
        document_pages_minimal_inline: Optional[int] = None,
        document_pages_basic_inline: Optional[int] = None,
        document_pages_standard_inline: Optional[int] = None,
        audio_hours: Optional[float] = None,
        video_hours: Optional[float] = None,
        contextualization_tokens: Optional[int] = None,
        advanced_contextualization_tokens: Optional[int] = None,
