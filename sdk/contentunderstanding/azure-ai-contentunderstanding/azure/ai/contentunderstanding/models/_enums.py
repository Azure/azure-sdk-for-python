...
class ChunkingStrategyKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class ContentAnalyzerWorkflow(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Workflow used for document analysis."""

    DEFAULT = "default"
    """Default analysis workflow. The service selects standard or advanced contextualization as
    appropriate for the analyzer."""
    AGENTIC = "agentic"
    """Agentic analysis workflow using iterative reasoning with integrated tool calling for enhanced
