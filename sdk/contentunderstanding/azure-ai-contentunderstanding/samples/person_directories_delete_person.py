...
async def main():
    ...
    async with ContentUnderstandingClient(endpoint=endpoint, credential=credential) as client:
        ...
        await client.person_directories.delete_person(person_directory_id=person_directory_id, person_id=person_id)
        ...
        try:
            await client.person_directories.get_person(person_directory_id=person_directory_id, person_id=person_id)
