...
# --------------------------------------------------------------------------
"""
FILE: sample_classify_in_page_segments.py
...
USAGE:
    python sample_classify_in_page_segments.py
...
def main() -> None:
    ...
    create_poller = client.begin_create_analyzer(analyzer_id=analyzer_id, resource=classifier)
