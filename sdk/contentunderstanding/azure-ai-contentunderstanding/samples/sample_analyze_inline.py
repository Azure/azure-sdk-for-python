...
DESCRIPTION:
    ...
    ``sample_analyze_binary_inline.py``. For the LRO pattern, see ``sample_analyze_url.py`` and
...
USAGE:
    python sample_analyze_inline.py
...
def main() -> None:
    ...
    inline_response: ContentAnalyzerInlineResponse = client.analyze_inline(
