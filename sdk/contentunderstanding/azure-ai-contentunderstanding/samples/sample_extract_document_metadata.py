...
# --------------------------------------------------------------------------
"""
FILE: sample_extract_document_metadata.py
...
USAGE:
    python sample_extract_document_metadata.py
...
def print_metadata(client: ContentUnderstandingClient, file_path: str) -> None:
...
def main() -> None:
    ...
    print_metadata(client, "sample_files/sample_metadata.pdf")
    # [END extract_pdf_metadata]

    # [START extract_docx_metadata]
    print_metadata(client, "sample_files/sample_metadata.docx")
