...
# --------------------------------------------------------------------------
"""
FILE: sample_analyze_binary_inline.py
...
DESCRIPTION:
    ...
    see ``sample_analyze_inline.py``. For the LRO pattern, see ``sample_analyze_binary.py``.
...
USAGE:
    python sample_analyze_binary_inline.py
...
def main() -> None:
    ...
    inline_response: ContentAnalyzerInlineResponse = client.analyze_binary_inline(
    ...
    within_limit: ContentAnalyzerInlineResponse = client.analyze_binary_inline(
        analyzer_id="prebuilt-layout",
