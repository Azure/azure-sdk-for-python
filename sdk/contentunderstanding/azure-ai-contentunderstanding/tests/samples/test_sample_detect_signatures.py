...
# --------------------------------------------------------------------------
"""
TEST FILE: test_sample_detect_signatures.py

DESCRIPTION:
    These tests validate the sample_detect_signatures.py sample code.

USAGE:
    pytest test_sample_detect_signatures.py
"""
...
class TestSampleDetectSignatures(ContentUnderstandingClientTestBase):
    """Tests for sample_detect_signatures.py"""

    @ContentUnderstandingPreparer()
    @recorded_by_proxy
    def test_sample_detect_signatures(self, **kwargs) -> None:
