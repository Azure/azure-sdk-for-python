...
"""
TEST FILE: test_sample_analyze_binary_inline.py

DESCRIPTION:
    Tests for the analyze_binary_inline (inline binary analysis) operation.
    Validates sample_analyze_binary_inline.py.

USAGE:
    pytest test_sample_analyze_binary_inline.py
"""
...
class TestSampleAnalyzeBinaryInline(ContentUnderstandingClientTestBase):
    """Tests for sample_analyze_binary_inline.py"""

    @ContentUnderstandingPreparer()
    @recorded_by_proxy
    def test_sample_analyze_binary_inline(self, contentunderstanding_endpoint: str) -> None:
        """Test inline analysis of a document from binary data."""
        ...
        # analyze_binary_inline returns ContentAnalyzerInlineResponse — unwrap .result
        inline_response = client.analyze_binary_inline(
        ...
        print("\n[SUCCESS] All test_sample_analyze_binary_inline assertions passed")

    @ContentUnderstandingPreparer()
    @recorded_by_proxy
    def test_sample_analyze_binary_inline_five_page_limit(self, contentunderstanding_endpoint: str) -> None:
        ...
        within_limit = client.analyze_binary_inline(
            analyzer_id="prebuilt-layout",
        ...
        print("\n[SUCCESS] All test_sample_analyze_binary_inline_five_page_limit assertions passed")
