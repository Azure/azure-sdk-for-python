...
"""
TEST FILE: test_sample_grant_copy_auth_async.py
...
class TestSampleGrantCopyAuthAsync(ContentUnderstandingClientTestBaseAsync):
    """Tests for sample_grant_copy_auth.py (async version)"""

    @ContentUnderstandingPreparer()
    @recorded_by_proxy_async
    async def test_sample_grant_copy_auth_async(self, azure_content_understanding_endpoint: str, **kwargs) -> None:
        ...
        try:
            ...
            # Create clients
            source_client = self.create_async_client(endpoint=azure_content_understanding_endpoint)
            ...
            assert source_analyzer.description == "Source analyzer for cross-resource copying", "Description should match"
            ...
            source_result = await source_client.get_analyzer(analyzer_id=source_analyzer_id)
            ...
            copy_result = await copy_poller.result()
            ...
            print("\n[SUCCESS] All test_sample_grant_copy_auth_async assertions passed")
            ...
            try:
                if source_analyzer_id and source_client:
                    await source_client.delete_analyzer(analyzer_id=source_analyzer_id)  # type: ignore[attr-defined]
            ...
            try:
                if target_analyzer_id and target_client:
                    await target_client.delete_analyzer(analyzer_id=target_analyzer_id)  # type: ignore[attr-defined]
            ...
            try:
                ...
                if target_client and target_client != source_client:
