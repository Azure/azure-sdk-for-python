...
# --------------------------------------------------------------------------
"""
TEST FILE: test_sample_extract_document_metadata_async.py

DESCRIPTION:
    These tests validate the sample_extract_document_metadata_async.py sample code.

USAGE:
    pytest test_sample_extract_document_metadata_async.py
"""
...
class TestSampleExtractDocumentMetadataAsync(ContentUnderstandingClientTestBaseAsync):
    """Tests for sample_extract_document_metadata.py (async version)"""

    @ContentUnderstandingPreparer()
    @recorded_by_proxy_async
    async def test_extract_pdf_metadata_async(self, **kwargs) -> None:
    ...
    @ContentUnderstandingPreparer()
    @recorded_by_proxy_async
    async def test_extract_docx_metadata_async(self, **kwargs) -> None:
        contentunderstanding_endpoint = kwargs.pop("contentunderstanding_endpoint")
        client = self.create_preview_async_client(
            endpoint=contentunderstanding_endpoint
        )
