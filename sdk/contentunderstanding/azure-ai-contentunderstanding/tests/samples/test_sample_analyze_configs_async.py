...
"""
TEST FILE: test_sample_analyze_configs_async.py
...
class TestSampleAnalyzeConfigsAsync(ContentUnderstandingClientTestBaseAsync):
    """Tests for sample_analyze_configs.py (async version)"""

    @ContentUnderstandingPreparer()
    @recorded_by_proxy_async
    async def test_sample_analyze_configs_async(self, contentunderstanding_endpoint: str) -> None:
