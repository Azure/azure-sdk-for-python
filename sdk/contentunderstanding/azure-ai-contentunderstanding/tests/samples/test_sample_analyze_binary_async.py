...
DESCRIPTION:
    These tests validate the sample_analyze_binary_async.py sample code.
...
class TestSampleAnalyzeBinaryAsync(ContentUnderstandingClientTestBaseAsync):
    ...
    async def test_sample_analyze_binary_async(self, azure_content_understanding_endpoint: str) -> None:
