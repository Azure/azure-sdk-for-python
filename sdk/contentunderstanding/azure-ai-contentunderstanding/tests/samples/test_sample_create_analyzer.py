...
class TestSampleCreateAnalyzer(ContentUnderstandingClientTestBase):
    ...
    @recorded_by_proxy
    def test_sample_create_analyzer(self, azure_content_understanding_endpoint: str) -> None:
        ...
        # Create the analyzer
        try:
            poller = client.begin_create_analyzer(analyzer_id=analyzer_id, resource=custom_analyzer)
