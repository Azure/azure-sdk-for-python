...
# --------------------------------------------------------------------------
"""
TEST FILE: test_sample_classify_in_page_segments_async.py

DESCRIPTION:
    These tests validate the sample_classify_in_page_segments_async.py sample code.

USAGE:
    pytest test_sample_classify_in_page_segments_async.py
"""
...
class TestSampleClassifyInPageSegmentsAsync(ContentUnderstandingClientTestBaseAsync):
    """Tests for sample_classify_in_page_segments.py (async version)"""

    @ContentUnderstandingPreparer()
    @recorded_by_proxy_async
    async def test_sample_classify_in_page_segments_async(
        self, **kwargs
    ) -> Dict[str, str]:
