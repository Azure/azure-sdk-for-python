...
# USAGE
    python update_workspace_setting_example.py
...
def main():
    ...
    response = client.workspace_settings.update(
...
# x-ms-original-file: specification/security/resource-manager/Microsoft.Security/Security/preview/2017-08-01-preview/examples/WorkspaceSettings/UpdateWorkspaceSetting_example.json
