...
# USAGE
    python put_security_connector_governance_rule_example.py
...
# x-ms-original-file: specification/security/resource-manager/Microsoft.Security/Security/preview/2022-01-01-preview/examples/GovernanceRules/PutSecurityConnectorGovernanceRule_example.json
