...
# USAGE
    python put_application_example.py
...
def main():
    ...
    response = client.application.create_or_update(
...
# x-ms-original-file: specification/security/resource-manager/Microsoft.Security/Security/preview/2022-07-01-preview/examples/Applications/PutApplication_example.json
