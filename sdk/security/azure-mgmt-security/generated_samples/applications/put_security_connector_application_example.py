...
# USAGE
    python put_security_connector_application_example.py
...
def main():
    ...
    response = client.security_connector_application.create_or_update(
        ...
        application={
            "properties": {
                "conditionSets": [{"conditions": [{"operator": "contains", "property": "$.Id", "value": "-prod-"}]}],
