...
# USAGE
    python get_sub_assessment_example.py
...
def main():
    ...
    response = client.sub_assessments.get(
        ...
        assessment_name="1195afff-c881-495e-9bc5-1486211ae03f",
        sub_assessment_name="95f7da9c-a2a4-1322-0758-fcd24ef09b85",
    )
    print(response)
