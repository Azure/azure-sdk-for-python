...
# USAGE
    python post_io_tsecurity_solutions_security_aggregated_alert_dismiss.py
...
def main():
    ...
    client.iot_security_solutions_analytics_aggregated_alert.dismiss(
        resource_group_name="IoTEdgeResources",
        solution_name="default",
        aggregated_alert_name="IoT_Bruteforce_Fail/2019-02-02/dismiss",
    )
