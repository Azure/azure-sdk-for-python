...
# USAGE
    python update_azure_dev_ops_repos_example.py
...
def main():
    ...
    response = client.azure_dev_ops_repos.begin_update(
...
# x-ms-original-file: specification/security/resource-manager/Microsoft.Security/Security/preview/2025-11-01-preview/examples/SecurityConnectorsDevOps/UpdateAzureDevOpsRepos_example.json
