...
from .operations import ServerVulnerabilityAssessmentsSettingsOperations
...
class SecurityCenter:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype server_vulnerability_assessments_settings:
     azure.mgmt.security.v2023_05_01.operations.ServerVulnerabilityAssessmentsSettingsOperations
