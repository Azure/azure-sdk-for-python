...
def build_create_or_update_request(
    ...
    solution_name: str,
    *,
    json: Optional[_models.IoTSecuritySolutionModel] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_update_request(
    ...
    solution_name: str,
    *,
    json: Optional[_models.UpdateIotSecuritySolutionData] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either IoTSecuritySolutionsList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.security.v2019_08_01.models.IoTSecuritySolutionsList]
