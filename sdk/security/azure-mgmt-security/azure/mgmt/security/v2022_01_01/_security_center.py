...
class SecurityCenter:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype alerts: azure.mgmt.security.v2022_01_01.operations.AlertsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.alerts = AlertsOperations(self._client, self._config, self._serialize, self._deserialize, "2022-01-01")
