...
class Scan(Resource):
    ...
    def __init__(
        self,
        *,
        properties: Optional["_models.ScanProperties"] = None,
        **kwargs
    ):
        """
...
class ScanProperties(msrest.serialization.Model):
    ...
    :ivar state: The scan status. Known values are: "Failed", "FailedToRun", "InProgress",
     "Passed".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword trigger_type: The scan trigger type. Known values are: "OnDemand", "Recurring".
        :paramtype trigger_type: str or ~azure.mgmt.security.v2020_07_01_preview.models.ScanTriggerType
        :keyword state: The scan status. Known values are: "Failed", "FailedToRun", "InProgress",
         "Passed".
...
class ScanResults(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.ScanResult"]] = None,
        **kwargs
    ):
        """
...
class Scans(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.Scan"]] = None,
        **kwargs
    ):
        """
