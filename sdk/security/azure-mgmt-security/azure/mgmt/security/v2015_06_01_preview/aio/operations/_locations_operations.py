...
class LocationsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.AscLocation"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.v2015_06_01_preview.models.AscLocation]
    ...
    list.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.Security/locations"}  # type: ignore

    @distributed_trace_async
    async def get(self, asc_location: str, **kwargs: Any) -> _models.AscLocation:
    ...
    get.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.Security/locations/{ascLocation}"}  # type: ignore
