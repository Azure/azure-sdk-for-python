...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Security/regulatoryComplianceStandards/{regulatoryComplianceStandardName}/regulatoryComplianceControls")  # pylint: disable=line-too-long
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Security/regulatoryComplianceStandards/{regulatoryComplianceStandardName}/regulatoryComplianceControls/{regulatoryComplianceControlName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', pattern=r'^[0-9A-Fa-f]{8}-([0-9A-Fa-f]{4}-){3}[0-9A-Fa-f]{12}$'),
        "regulatoryComplianceStandardName": _SERIALIZER.url("regulatory_compliance_standard_name", regulatory_compliance_standard_name, 'str'),
        "regulatoryComplianceControlName": _SERIALIZER.url("regulatory_compliance_control_name", regulatory_compliance_control_name, 'str'),
    }
...
class RegulatoryComplianceControlsOperations:
    ...
    def list(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable[_models.RegulatoryComplianceControlList]:
        ...
        :return: An iterator like instance of either RegulatoryComplianceControlList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.security.v2019_01_01_preview.models.RegulatoryComplianceControlList]
