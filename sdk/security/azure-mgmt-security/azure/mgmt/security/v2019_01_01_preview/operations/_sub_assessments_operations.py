...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.Security/assessments/{assessmentName}/subAssessments")
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, 'str', skip_quote=True),
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.Security/assessments/{assessmentName}/subAssessments/{subAssessmentName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, 'str', skip_quote=True),
        "assessmentName": _SERIALIZER.url("assessment_name", assessment_name, 'str'),
...
class SubAssessmentsOperations:
    ...
    def list_all(
        ...
        scope: str,
        **kwargs: Any
    ) -> Iterable[_models.SecuritySubAssessmentList]:
        ...
        :return: An iterator like instance of either SecuritySubAssessmentList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.security.v2019_01_01_preview.models.SecuritySubAssessmentList]
