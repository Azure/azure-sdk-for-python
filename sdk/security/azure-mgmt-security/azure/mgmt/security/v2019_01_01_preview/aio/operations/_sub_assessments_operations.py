...
from ...operations._sub_assessments_operations import build_get_request, build_list_all_request, build_list_request
...
class SubAssessmentsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`sub_assessments` attribute.
    """
    ...
    @distributed_trace
    def list_all(self, scope: str, **kwargs: Any) -> AsyncIterable["_models.SecuritySubAssessment"]:
        ...
        :return: An iterator like instance of either SecuritySubAssessment or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.v2019_01_01_preview.models.SecuritySubAssessment]
        ...
        cls: ClsType[_models.SecuritySubAssessmentList] = kwargs.pop("cls", None)
    ...
    @distributed_trace
    def list(self, scope: str, assessment_name: str, **kwargs: Any) -> AsyncIterable["_models.SecuritySubAssessment"]:
    ...
    async def get(
        self, scope: str, assessment_name: str, sub_assessment_name: str, **kwargs: Any
        ...
        :rtype: ~azure.mgmt.security.v2019_01_01_preview.models.SecuritySubAssessment
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.SecuritySubAssessment] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/{scope}/providers/Microsoft.Security/assessments/{assessmentName}/subAssessments/{subAssessmentName}"
    }
