...
class HealthReportsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.security.v2023_05_01_preview.aio.SecurityCenter`'s
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> AsyncIterable["_models.HealthReport"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.v2023_05_01_preview.models.HealthReport]
    ...
    async def get(self, resource_id: str, health_report_name: str, **kwargs: Any) -> _models.HealthReport:
        ...
        :rtype: ~azure.mgmt.security.v2023_05_01_preview.models.HealthReport
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
