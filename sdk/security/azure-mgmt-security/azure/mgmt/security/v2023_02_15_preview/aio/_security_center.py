...
from .operations import SensitivitySettingsOperations
...
class SecurityCenter:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype sensitivity_settings:
     azure.mgmt.security.v2023_02_15_preview.aio.operations.SensitivitySettingsOperations
    ...
    def __init__(
        ...
        self.sensitivity_settings = SensitivitySettingsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2023-02-15-preview"
        )
