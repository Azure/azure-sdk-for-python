...
def build_create_or_update_request(
    ...
    connector_name: str,
    *,
    json: Optional[_models.ConnectorSetting] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class ConnectorsOperations:
    ...
    def list(
        self,
        **kwargs: Any
    ) -> Iterable[_models.ConnectorSettingList]:
        """Cloud accounts connectors of a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ConnectorSettingList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.security.v2020_01_01_preview.models.ConnectorSettingList]
