...
def build_get_in_subscription_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Security/assessmentMetadata/{assessmentMetadataName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "assessmentMetadataName": _SERIALIZER.url("assessment_metadata_name", assessment_metadata_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', pattern=r'^[0-9A-Fa-f]{8}-([0-9A-Fa-f]{4}-){3}[0-9A-Fa-f]{12}$'),
    }
...
def build_create_in_subscription_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.SecurityAssessmentMetadata] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class AssessmentsMetadataOperations:
    ...
    def list(
        self,
        **kwargs: Any
    ) -> Iterable[_models.SecurityAssessmentMetadataList]:
        """Get metadata information on all assessment types.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either SecurityAssessmentMetadataList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.security.v2020_01_01.models.SecurityAssessmentMetadataList]
