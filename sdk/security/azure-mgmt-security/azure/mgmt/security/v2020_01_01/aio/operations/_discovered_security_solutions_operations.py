...
from ...operations._discovered_security_solutions_operations import (
    build_get_request,
...
class DiscoveredSecuritySolutionsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`discovered_security_solutions` attribute.
    """
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.DiscoveredSecuritySolution"]:
        ...
        :return: An iterator like instance of either DiscoveredSecuritySolution or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.v2020_01_01.models.DiscoveredSecuritySolution]
    ...
    ) -> AsyncIterable["_models.DiscoveredSecuritySolution"]:
    ...
    list_by_home_region.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.Security/locations/{ascLocation}/discoveredSecuritySolutions"
    }

    @distributed_trace_async
    async def get(
        self, resource_group_name: str, asc_location: str, discovered_security_solution_name: str, **kwargs: Any
        ...
        :param asc_location: The location where ASC stores the data of the subscription. can be
         retrieved from Get locations. Required.
        :type asc_location: str
        :param discovered_security_solution_name: Name of a discovered security solution. Required.
        :type discovered_security_solution_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DiscoveredSecuritySolution or the result of cls(response)
        :rtype: ~azure.mgmt.security.v2020_01_01.models.DiscoveredSecuritySolution
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_get_request(
            ...
            asc_location=asc_location,
            discovered_security_solution_name=discovered_security_solution_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
