...
class AutoProvisioningSettingList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.AutoProvisioningSetting"]] = None,
        **kwargs
    ):
        """
...
class ComplianceList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.Compliance"]] = None,
        **kwargs
    ):
        """
...
class InformationProtectionPolicyList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.InformationProtectionPolicy"]] = None,
        **kwargs
    ):
        """
...
class SecurityContact(Resource):
    ...
    :ivar alert_notifications: Whether to send security alerts notifications to the security
     contact. Known values are: "On", "Off".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword alerts_to_admins: Whether to send security alerts notifications to subscription
         admins. Known values are: "On", "Off".
...
class WorkspaceSettingList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: List["_models.WorkspaceSetting"],
        **kwargs
    ):
        """
