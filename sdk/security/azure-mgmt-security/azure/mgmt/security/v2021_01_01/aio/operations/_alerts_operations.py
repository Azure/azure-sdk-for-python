...
class AlertsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.v2021_01_01.models.AlertList]
    ...
    @distributed_trace_async
    async def begin_simulate(  # pylint: disable=inconsistent-return-statements
        self,
        asc_location: str,
        alert_simulator_request_body: _models.AlertSimulatorRequestBody,
        **kwargs: Any
