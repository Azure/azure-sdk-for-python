...
class Alert(Resource):
    ...
    :ivar severity: The risk level of the threat that was detected. Learn more:
     ...
     Known values are: "Informational", "Low", "Medium", "High".
    ...
    :ivar status: The life cycle status of the alert. Known values are: "Active", "Resolved",
     "Dismissed".
...
class AlertList(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.Alert"]] = None,
        **kwargs
    ):
        """
...
class AlertSimulatorRequestProperties(msrest.serialization.Model):
    ...
    :ivar additional_properties: Unmatched properties from the message are deserialized to this
     collection.
    :vartype additional_properties: dict[str, any]
    :ivar kind: Required. The kind of alert simulation.Constant filled by server. Known values are:
     "Bundles".
...
class ResourceIdentifier(msrest.serialization.Model):
    ...
    :ivar type: Required. There can be multiple identifiers of different type per alert, this field
     specify the identifier type.Constant filled by server. Known values are: "AzureResource",
     "LogAnalytics".
