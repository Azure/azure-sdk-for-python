...
from .operations import SecurityOperatorsOperations
...
class SecurityCenter:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype security_operators:
     azure.mgmt.security.v2023_01_01_preview.operations.SecurityOperatorsOperations
