...
class AzureDevOpsProjectsOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.v2024_04_01.models.AzureDevOpsProject]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either AzureDevOpsProject or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.security.v2024_04_01.models.AzureDevOpsProject]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
