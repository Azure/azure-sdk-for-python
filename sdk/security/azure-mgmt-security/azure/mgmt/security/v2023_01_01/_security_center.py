...
class SecurityCenter:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype pricings: azure.mgmt.security.v2023_01_01.operations.PricingsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.pricings = PricingsOperations(self._client, self._config, self._serialize, self._deserialize, "2023-01-01")
