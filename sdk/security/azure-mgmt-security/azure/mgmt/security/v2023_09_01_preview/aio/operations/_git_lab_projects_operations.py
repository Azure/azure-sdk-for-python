...
from ...operations._git_lab_projects_operations import build_get_request, build_list_request
...
class GitLabProjectsOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.GitLabProject"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.v2023_09_01_preview.models.GitLabProject]
