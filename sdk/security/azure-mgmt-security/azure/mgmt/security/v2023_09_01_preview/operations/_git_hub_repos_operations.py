...
def build_list_request(
    resource_group_name: str, security_connector_name: str, owner_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class GitHubReposOperations:
    ...
    def list(
    ...
    ) -> Iterable["_models.GitHubRepository"]:
        ...
        :type owner_name: str
        :return: An iterator like instance of either GitHubRepository or the result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.security.v2023_09_01_preview.models.GitHubRepository]
        ...
        cls: ClsType[_models.GitHubRepositoryListResponse] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("GitHubRepositoryListResponse", pipeline_response)
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, security_connector_name: str, owner_name: str, repo_name: str, **kwargs: Any
    ) -> _models.GitHubRepository:
        ...
        :type repo_name: str
        :return: GitHubRepository or the result of cls(response)
        :rtype: ~azure.mgmt.security.v2023_09_01_preview.models.GitHubRepository
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.GitHubRepository] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("GitHubRepository", pipeline_response)
