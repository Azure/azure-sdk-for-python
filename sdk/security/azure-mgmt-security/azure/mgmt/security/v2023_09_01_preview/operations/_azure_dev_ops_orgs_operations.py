...
class AzureDevOpsOrgsOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.security.v2023_09_01_preview.models.AzureDevOpsOrg]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either AzureDevOpsOrg or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.security.v2023_09_01_preview.models.AzureDevOpsOrg]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
