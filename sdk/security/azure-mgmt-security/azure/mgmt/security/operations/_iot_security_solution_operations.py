...
class IotSecuritySolutionOperations:
    ...
    def list_by_subscription(
    ...
    ) -> ItemPaged["_models.IoTSecuritySolutionModel"]:
        ...
        :return: An iterator like instance of either IoTSecuritySolutionModel or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.IoTSecuritySolutionModel]
    ...
    def get(self, resource_group_name: str, solution_name: str, **kwargs: Any) -> _models.IoTSecuritySolutionModel:
        ...
        deserialized = self._deserialize("IoTSecuritySolutionModel", pipeline_response.http_response)
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type iot_security_solution_data: ~azure.mgmt.security.models.IoTSecuritySolutionModel or
         IO[bytes]
        :return: IoTSecuritySolutionModel or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.IoTSecuritySolutionModel
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type update_iot_security_solution_data:
         ~azure.mgmt.security.models.UpdateIotSecuritySolutionData or IO[bytes]
        :return: IoTSecuritySolutionModel or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.IoTSecuritySolutionModel
        :raises ~azure.core.exceptions.HttpResponseError:
        """
