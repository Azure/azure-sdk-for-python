...
def build_get_request(
    setting_name: Union[str, _models.SettingNameAutoGenerated], subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class SettingsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.Setting"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.Setting]
    ...
    @distributed_trace
    def get(self, setting_name: Union[str, _models.SettingNameAutoGenerated], **kwargs: Any) -> _models.Setting:
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type setting: ~azure.mgmt.security.models.Setting or IO[bytes]
        :return: Setting or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.Setting
        :raises ~azure.core.exceptions.HttpResponseError:
        """
