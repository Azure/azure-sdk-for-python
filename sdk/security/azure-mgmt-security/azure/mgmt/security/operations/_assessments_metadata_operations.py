...
class AssessmentsMetadataOperations(object):
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SecurityAssessmentMetadataPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_by_subscription(
        ...
        return deserialized
    list_by_subscription.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Security/assessmentMetadata'}
    ...
    def get_in_subscription(
        ...
        """
        # Construct URL
        url = self.get_in_subscription.metadata['url']
        path_format_arguments = {
            'assessmentMetadataName': self._serialize.url("assessment_metadata_name", assessment_metadata_name, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str', pattern=r'^[0-9A-Fa-f]{8}-([0-9A-Fa-f]{4}-){3}[0-9A-Fa-f]{12}$')
        }
        ...
        return deserialized
    get_in_subscription.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Security/assessmentMetadata/{assessmentMetadataName}'}
    ...
    def create_in_subscription(
        ...
        return deserialized
    create_in_subscription.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Security/assessmentMetadata/{assessmentMetadataName}'}
    ...
    def delete_in_subscription(
        ...
        """
        # Construct URL
        url = self.delete_in_subscription.metadata['url']
        path_format_arguments = {
            'assessmentMetadataName': self._serialize.url("assessment_metadata_name", assessment_metadata_name, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str', pattern=r'^[0-9A-Fa-f]{8}-([0-9A-Fa-f]{4}-){3}[0-9A-Fa-f]{12}$')
        }
        ...
        if raw:
            ...
            return client_raw_response
    delete_in_subscription.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Security/assessmentMetadata/{assessmentMetadataName}'}
