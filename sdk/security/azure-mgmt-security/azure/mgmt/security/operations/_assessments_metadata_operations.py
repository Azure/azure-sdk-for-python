...
def build_list_request(**kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2025-05-04"))
...
class AssessmentsMetadataOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.SecurityAssessmentMetadataResponse"]:
        """Get metadata information on all assessment types.

        :return: An iterator like instance of either SecurityAssessmentMetadataResponse or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.SecurityAssessmentMetadataResponse]
        ...
        def get_next(next_link=None):
            ...
            if response.status_code not in [200]:
                ...
                error = self._deserialize.failsafe_deserialize(
                    _models.CloudErrorAutoGenerated11,
                    pipeline_response,
                )
    ...
    def get(self, assessment_metadata_name: str, **kwargs: Any) -> _models.SecurityAssessmentMetadataResponse:
        ...
        deserialized = self._deserialize("SecurityAssessmentMetadataResponse", pipeline_response.http_response)
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.SecurityAssessmentMetadataResponse"]:
    ...
    def create_in_subscription(
        ...
        **kwargs: Any
        ...
        :type assessment_metadata: ~azure.mgmt.security.models.SecurityAssessmentMetadataResponse or
         IO[bytes]
        :return: SecurityAssessmentMetadataResponse or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.SecurityAssessmentMetadataResponse
        :raises ~azure.core.exceptions.HttpResponseError:
