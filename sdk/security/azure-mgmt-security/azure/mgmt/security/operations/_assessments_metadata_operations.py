...
def build_list_request(
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Security/assessmentMetadata')
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Security/assessmentMetadata/{assessmentMetadataName}')
...
def build_list_by_subscription_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Security/assessmentMetadata')
    path_format_arguments = {
...
def build_get_in_subscription_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Security/assessmentMetadata/{assessmentMetadataName}')
    path_format_arguments = {
        "assessmentMetadataName": _SERIALIZER.url("assessment_metadata_name", assessment_metadata_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', pattern=r'^[0-9A-Fa-f]{8}-([0-9A-Fa-f]{4}-){3}[0-9A-Fa-f]{12}$'),
    }
...
class AssessmentsMetadataOperations(object):
    ...
    def list(
        self,
        **kwargs: Any
    ) -> Iterable["_models.SecurityAssessmentMetadataResponseList"]:
        """Get metadata information on all assessment types.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either SecurityAssessmentMetadataResponseList or the
         result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.SecurityAssessmentMetadataResponseList]
