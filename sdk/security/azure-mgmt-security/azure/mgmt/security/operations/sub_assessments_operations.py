...
class SubAssessmentsOperations(object):
    ...
    def list(
        ...
        deserialized = models.SecuritySubAssessmentPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.SecuritySubAssessmentPaged(internal_paging, self._deserialize.dependencies, header_dict)
