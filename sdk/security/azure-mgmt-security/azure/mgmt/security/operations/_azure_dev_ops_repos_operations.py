...
class AzureDevOpsReposOperations:
    ...
    def list(
    ...
    ) -> ItemPaged["_models.AzureDevOpsRepository"]:
        ...
        :return: An iterator like instance of either AzureDevOpsRepository or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.AzureDevOpsRepository]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.security.models.AzureDevOpsRepository
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("AzureDevOpsRepository", pipeline_response.http_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type azure_dev_ops_repository: ~azure.mgmt.security.models.AzureDevOpsRepository
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either AzureDevOpsRepository or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.security.models.AzureDevOpsRepository]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type azure_dev_ops_repository: ~azure.mgmt.security.models.AzureDevOpsRepository or IO[bytes]
        :return: An instance of LROPoller that returns either AzureDevOpsRepository or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.security.models.AzureDevOpsRepository]
        :raises ~azure.core.exceptions.HttpResponseError:
