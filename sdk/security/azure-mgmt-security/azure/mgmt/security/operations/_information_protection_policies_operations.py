...
class InformationProtectionPoliciesOperations:
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> ItemPaged["_models.InformationProtectionPolicy"]:
        ...
        :return: An iterator like instance of either InformationProtectionPolicy or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.InformationProtectionPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
