...
class SoftwareInventoriesOperations:
    ...
    def list_by_extended_resource(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.Software]
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.Software"]:
    ...
    def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("Software", pipeline_response.http_response)
