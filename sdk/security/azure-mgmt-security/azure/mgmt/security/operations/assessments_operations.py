...
class AssessmentsOperations(object):
    ...
    def list(
        ...
        deserialized = models.SecurityAssessmentPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.SecurityAssessmentPaged(internal_paging, self._deserialize.dependencies, header_dict)
