...
class PrivateEndpointConnectionsOperations:
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.security.models.PrivateEndpointConnection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        This operation is typically used to approve or reject pending private endpoint connections.
        ...
        :param private_link_parameters: Parameter group. Required.
        :type private_link_parameters: ~azure.mgmt.security.models.PrivateLinkParameters
        :param private_endpoint_connection: The private endpoint connection resource. Required.
        :type private_endpoint_connection: ~azure.mgmt.security.models.PrivateEndpointConnection
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either PrivateEndpointConnection or the result
         of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.security.models.PrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param private_link_parameters: Parameter group. Required.
        :type private_link_parameters: ~azure.mgmt.security.models.PrivateLinkParameters
        :param private_endpoint_connection: The private endpoint connection resource. Is either a
         PrivateEndpointConnection type or a IO[bytes] type. Required.
        :type private_endpoint_connection: ~azure.mgmt.security.models.PrivateEndpointConnection or
         IO[bytes]
        :return: An instance of LROPoller that returns either PrivateEndpointConnection or the result
         of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.security.models.PrivateEndpointConnection]
