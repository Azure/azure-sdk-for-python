...
class SubAssessmentsOperations:
    ...
    @distributed_trace
    def list_all(self, scope: str, **kwargs: Any) -> ItemPaged["_models.SecuritySubAssessment"]:
        ...
        :return: An iterator like instance of either SecuritySubAssessment or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.SecuritySubAssessment]
    ...
    @distributed_trace
    def list(self, scope: str, assessment_name: str, **kwargs: Any) -> ItemPaged["_models.SecuritySubAssessment"]:
