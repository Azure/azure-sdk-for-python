...
class LocationsOperations(object):
    ...
    def list(
        ...
        :return: An iterator like instance of AscLocation
        :rtype:
         ~azure.mgmt.security.models.AscLocationPaged[~azure.mgmt.security.models.AscLocation]
        ...
        if raw:
            header_dict = {}
        deserialized = models.AscLocationPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('AscLocation', response)
