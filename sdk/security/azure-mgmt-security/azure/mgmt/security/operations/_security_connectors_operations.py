...
class SecurityConnectorsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.SecurityConnector"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.SecurityConnector]
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.SecurityConnector"]:
    ...
    def get(self, resource_group_name: str, security_connector_name: str, **kwargs: Any) -> _models.SecurityConnector:
        ...
        deserialized = self._deserialize("SecurityConnector", pipeline_response.http_response)
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type security_connector: ~azure.mgmt.security.models.SecurityConnector or IO[bytes]
        :return: SecurityConnector or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.SecurityConnector
        :raises ~azure.core.exceptions.HttpResponseError:
        """
