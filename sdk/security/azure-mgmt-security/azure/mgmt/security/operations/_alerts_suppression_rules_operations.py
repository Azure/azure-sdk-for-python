...
class AlertsSuppressionRulesOperations:
    ...
    @distributed_trace
    def list(self, alert_type: Optional[str] = None, **kwargs: Any) -> ItemPaged["_models.AlertsSuppressionRule"]:
        ...
        :return: An iterator like instance of either AlertsSuppressionRule or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.AlertsSuppressionRule]
