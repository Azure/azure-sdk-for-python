...
def build_get_request(
    security_contact_name: Union[str, _models.SecurityContactName], subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class SecurityContactsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.SecurityContact"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.SecurityContact]
    ...
    @distributed_trace
    def get(
        self, security_contact_name: Union[str, _models.SecurityContactName], **kwargs: Any
    ) -> _models.SecurityContact:
        """Get Default Security contact configurations for the subscription.

        :param security_contact_name: Name of the security contact object. "default" Required.
        :type security_contact_name: str or ~azure.mgmt.security.models.SecurityContactName
        ...
        deserialized = self._deserialize("SecurityContact", pipeline_response.http_response)
    ...
    def create(
        self,
        security_contact_name: Union[str, _models.SecurityContactName],
    ...
    def create(
        self,
        security_contact_name: Union[str, _models.SecurityContactName],
        security_contact: Union[_models.SecurityContact, IO[bytes]],
        **kwargs: Any
    ) -> _models.SecurityContact:
        """Create security contact configurations for the subscription.
        ...
        :type security_contact: ~azure.mgmt.security.models.SecurityContact or IO[bytes]
        :return: SecurityContact or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.SecurityContact
        :raises ~azure.core.exceptions.HttpResponseError:
        """
