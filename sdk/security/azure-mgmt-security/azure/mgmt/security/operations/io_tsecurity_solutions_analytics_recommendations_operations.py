...
class IoTSecuritySolutionsAnalyticsRecommendationsOperations(object):
    ...
    def list(
        ...
        deserialized = models.IoTSecurityAggregatedRecommendationPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.IoTSecurityAggregatedRecommendationPaged(internal_paging, self._deserialize.dependencies, header_dict)
