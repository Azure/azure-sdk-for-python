...
class GovernanceRulesOperations:
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> ItemPaged["_models.GovernanceRule"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.GovernanceRule]
        ...
        def get_next(next_link=None):
            ...
            if response.status_code not in [200]:
                ...
                error = self._deserialize.failsafe_deserialize(
                    _models.CloudErrorAutoGenerated4,
                    pipeline_response,
                )
    ...
    def _delete_initial(self, scope: str, rule_id: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def _execute_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2022-01-01-preview"))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        content_type = content_type if execute_governance_rule_params else None
        cls: ClsType[Iterator[bytes]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json" if execute_governance_rule_params else None
        _json = None
        _content = None
