...
class IotSecuritySolutionAnalyticsOperations:
    ...
    def list(
        ...
        deserialized = self._deserialize("IoTSecuritySolutionAnalyticsModelList", pipeline_response.http_response)
    ...
    def get(
        ...
        deserialized = self._deserialize("IoTSecuritySolutionAnalyticsModel", pipeline_response.http_response)
