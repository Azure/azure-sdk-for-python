...
class AssessmentsOperations:
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> ItemPaged["_models.SecurityAssessmentResponse"]:
        ...
        :return: An iterator like instance of either SecurityAssessmentResponse or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.SecurityAssessmentResponse]
