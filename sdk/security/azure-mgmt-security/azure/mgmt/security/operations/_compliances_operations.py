...
def build_get_request(scope: str, compliance_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CompliancesOperations:
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> ItemPaged["_models.Compliance"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.Compliance]
    ...
    @distributed_trace
    def get(self, scope: str, compliance_name: str, **kwargs: Any) -> _models.Compliance:
        ...
        deserialized = self._deserialize("Compliance", pipeline_response.http_response)
