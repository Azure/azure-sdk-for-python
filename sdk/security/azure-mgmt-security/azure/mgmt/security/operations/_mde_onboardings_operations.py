...
class MdeOnboardingsOperations:
    ...
    def list(self, **kwargs: Any) -> _models.MdeOnboardingDataList:
        ...
        if response.status_code not in [200]:
            ...
            error = self._deserialize.failsafe_deserialize(
                _models.CloudErrorAutoGenerated3,
                pipeline_response,
            )
            raise HttpResponseError(response=response, model=error, error_format=ARMErrorFormat)

        deserialized = self._deserialize("MdeOnboardingDataList", pipeline_response.http_response)
    ...
    def get(self, **kwargs: Any) -> _models.MdeOnboardingData:
        ...
        deserialized = self._deserialize("MdeOnboardingData", pipeline_response.http_response)
