...
class DiscoveredSecuritySolutionsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.DiscoveredSecuritySolution"]:
        """Gets a list of discovered Security Solutions for the subscription.

        :return: An iterator like instance of either DiscoveredSecuritySolution or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.DiscoveredSecuritySolution]
    ...
    @distributed_trace
    def list_by_home_region(self, asc_location: str, **kwargs: Any) -> ItemPaged["_models.DiscoveredSecuritySolution"]:
