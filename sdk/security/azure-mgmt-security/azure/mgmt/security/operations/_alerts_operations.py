...
class AlertsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.Alert"]:
        """List all the alerts that are associated with the subscription.

        :return: An iterator like instance of either Alert or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.Alert]
        ...
        def get_next(next_link=None):
            ...
            if response.status_code not in [200]:
                ...
                error = self._deserialize.failsafe_deserialize(
                    _models.CloudErrorAutoGenerated16,
                    pipeline_response,
                )
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.Alert"]:
    ...
    @distributed_trace
    def list_subscription_level_by_region(self, asc_location: str, **kwargs: Any) -> ItemPaged["_models.Alert"]:
