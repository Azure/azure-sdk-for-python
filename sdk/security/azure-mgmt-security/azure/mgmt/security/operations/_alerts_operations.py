...
class AlertsOperations(object):
    ...
    def update_subscription_level_alert_state(
        ...
        if raw:
            ...
            return client_raw_response
    update_subscription_level_alert_state.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Security/locations/{ascLocation}/alerts/{alertName}/dismiss'}

    def update_subscription_level_alert_state1(
            self, alert_name, custom_headers=None, raw=False, **operation_config):
        """Update the alert's state.
        ...
        """
        # Construct URL
        url = self.update_subscription_level_alert_state1.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str', pattern=r'^[0-9A-Fa-f]{8}-([0-9A-Fa-f]{4}-){3}[0-9A-Fa-f]{12}$'),
            'ascLocation': self._serialize.url("self.config.asc_location", self.config.asc_location, 'str'),
            'alertName': self._serialize.url("alert_name", alert_name, 'str')
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    update_subscription_level_alert_state1.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Security/locations/{ascLocation}/alerts/{alertName}/reactivate'}
    ...
    def update_resource_group_level_alert_state(
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    update_resource_group_level_alert_state.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/locations/{ascLocation}/alerts/{alertName}/dismiss'}

    def update_resource_group_level_alert_state1(
            self, alert_name, resource_group_name, custom_headers=None, raw=False, **operation_config):
        """Update the alert's state.
        ...
        """
        # Construct URL
        url = self.update_resource_group_level_alert_state1.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str', pattern=r'^[0-9A-Fa-f]{8}-([0-9A-Fa-f]{4}-){3}[0-9A-Fa-f]{12}$'),
            'ascLocation': self._serialize.url("self.config.asc_location", self.config.asc_location, 'str'),
            'alertName': self._serialize.url("alert_name", alert_name, 'str'),
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    update_resource_group_level_alert_state1.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/locations/{ascLocation}/alerts/{alertName}/reactivate'}
