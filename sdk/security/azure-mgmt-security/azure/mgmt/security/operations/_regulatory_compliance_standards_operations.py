...
class RegulatoryComplianceStandardsOperations:
    ...
    @distributed_trace
    def list(self, filter: Optional[str] = None, **kwargs: Any) -> ItemPaged["_models.RegulatoryComplianceStandard"]:
        ...
        :return: An iterator like instance of either RegulatoryComplianceStandard or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.RegulatoryComplianceStandard]
