...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/iotSecuritySolutions/{solutionName}/analyticsModels/default/aggregatedRecommendations/{aggregatedRecommendationName}')
    path_format_arguments = {
        ...
        "aggregatedRecommendationName": _SERIALIZER.url("aggregated_recommendation_name", aggregated_recommendation_name, 'str'),
    }
...
def build_list_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/iotSecuritySolutions/{solutionName}/analyticsModels/default/aggregatedRecommendations')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', pattern=r'^[0-9A-Fa-f]{8}-([0-9A-Fa-f]{4}-){3}[0-9A-Fa-f]{12}$'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        "solutionName": _SERIALIZER.url("solution_name", solution_name, 'str'),
...
class IotSecuritySolutionsAnalyticsRecommendationOperations(object):
    ...
    def list(
        ...
        top: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable["_models.IoTSecurityAggregatedRecommendationList"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.IoTSecurityAggregatedRecommendationList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
