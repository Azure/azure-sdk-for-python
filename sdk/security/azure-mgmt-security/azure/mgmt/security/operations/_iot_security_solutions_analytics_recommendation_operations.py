...
class IotSecuritySolutionsAnalyticsRecommendationOperations(object):
    ...
    def get(
        ...
        :return: IoTSecurityAggregatedRecommendation or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.security.models.IoTSecurityAggregatedRecommendation or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('IoTSecurityAggregatedRecommendation', response)
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/iotSecuritySolutions/{solutionName}/analyticsModels/default/aggregatedRecommendations/{aggregatedRecommendationName}'}
