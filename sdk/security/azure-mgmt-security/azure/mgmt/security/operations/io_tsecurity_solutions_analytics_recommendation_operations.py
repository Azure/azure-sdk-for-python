...
class IoTSecuritySolutionsAnalyticsRecommendationOperations(object):
    ...
    def get(
            self, resource_group_name, solution_name, aggregated_recommendation_name, top=None, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype:
         ~azure.mgmt.security.models.IoTSecurityAggregatedRecommendation[None]
        ...
        deserialized = models.IoTSecurityAggregatedRecommendation(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.IoTSecurityAggregatedRecommendation(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response

        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/iotSecuritySolutions/{solutionName}/Analytics/AggregatedRecommendation/{aggregatedRecommendationName}'}
