...
class RegulatoryComplianceStandardsOperations(object):
    ...
    def list(
        ...
        :return: An iterator like instance of RegulatoryComplianceStandard
        :rtype:
         ~azure.mgmt.security.models.RegulatoryComplianceStandardPaged[~azure.mgmt.security.models.RegulatoryComplianceStandard]
        ...
        deserialized = models.RegulatoryComplianceStandardPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.RegulatoryComplianceStandardPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
            self, regulatory_compliance_standard_name, custom_headers=None, raw=False, **operation_config):
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: RegulatoryComplianceStandard or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.security.models.RegulatoryComplianceStandard or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('RegulatoryComplianceStandard', response)
