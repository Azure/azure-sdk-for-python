...
class SecurityConnectorApplicationOperations:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.security.models.Application
        ...
        if response.status_code not in [200]:
            ...
            error = self._deserialize.failsafe_deserialize(
                _models.CloudErrorAutoGenerated5,
                pipeline_response,
            )
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type application: ~azure.mgmt.security.models.Application
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type application: ~azure.mgmt.security.models.Application or IO[bytes]
        :return: Application or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.Application
        :raises ~azure.core.exceptions.HttpResponseError:
        """
