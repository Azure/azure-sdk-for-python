...
class TasksOperations:
    ...
    @distributed_trace
    def list(self, filter: Optional[str] = None, **kwargs: Any) -> ItemPaged["_models.SecurityTask"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.SecurityTask]
    ...
    ) -> ItemPaged["_models.SecurityTask"]:
        """Recommended tasks that will help improve the security of the subscription proactively.
    ...
    def get_subscription_level_task(self, asc_location: str, task_name: str, **kwargs: Any) -> _models.SecurityTask:
        ...
        deserialized = self._deserialize("SecurityTask", pipeline_response.http_response)
