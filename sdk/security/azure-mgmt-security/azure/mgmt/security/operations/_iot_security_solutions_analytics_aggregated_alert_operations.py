...
class IotSecuritySolutionsAnalyticsAggregatedAlertOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.IoTSecurityAggregatedAlertList"]
        ...
        :return: An iterator like instance of either IoTSecurityAggregatedAlertList or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.IoTSecurityAggregatedAlertList]
    ...
    def get(
        ...
        resource_group_name,  # type: str
        solution_name,  # type: str
        aggregated_alert_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.IoTSecurityAggregatedAlert"
