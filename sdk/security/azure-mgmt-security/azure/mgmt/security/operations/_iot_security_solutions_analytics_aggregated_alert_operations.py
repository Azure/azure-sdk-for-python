...
def build_get_request(
    resource_group_name: str, solution_name: str, aggregated_alert_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class IotSecuritySolutionsAnalyticsAggregatedAlertOperations:  # pylint: disable=name-too-long
    ...
    def list(
    ...
    ) -> ItemPaged["_models.IoTSecurityAggregatedAlert"]:
        ...
        :return: An iterator like instance of either IoTSecurityAggregatedAlert or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.IoTSecurityAggregatedAlert]
