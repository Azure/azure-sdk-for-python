...
class JitNetworkAccessPoliciesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.JitNetworkAccessPolicy"]:
        """Policies for protecting resources using Just-in-Time access control.

        :return: An iterator like instance of either JitNetworkAccessPolicy or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.JitNetworkAccessPolicy]
    ...
    @distributed_trace
    def list_by_region(self, asc_location: str, **kwargs: Any) -> ItemPaged["_models.JitNetworkAccessPolicy"]:
    ...
    ) -> ItemPaged["_models.JitNetworkAccessPolicy"]:
        """Policies for protecting resources using Just-in-Time access control for the subscription,
        location.
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.security.models.JitNetworkAccessPolicy or IO[bytes]
        :return: JitNetworkAccessPolicy or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.JitNetworkAccessPolicy
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def initiate(
        ...
        **kwargs: Any
        ...
        :param body: Is either a JitNetworkAccessPolicyInitiateRequest type or a IO[bytes] type.
         Required.
        :type body: ~azure.mgmt.security.models.JitNetworkAccessPolicyInitiateRequest or IO[bytes]
        :return: JitNetworkAccessRequest or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.JitNetworkAccessRequest
        :raises ~azure.core.exceptions.HttpResponseError:
        """
