...
class AutomationsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.Automation"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.Automation]
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.Automation"]:
