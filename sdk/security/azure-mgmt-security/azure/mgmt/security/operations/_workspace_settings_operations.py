...
class WorkspaceSettingsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> ItemPaged["_models.WorkspaceSetting"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.WorkspaceSetting]
        ...
        def get_next(next_link=None):
            ...
            if response.status_code not in [200]:
                ...
                error = self._deserialize.failsafe_deserialize(
                    _models.CloudErrorAutoGenerated,
                    pipeline_response,
                )
    ...
    def get(self, workspace_setting_name: str, **kwargs: Any) -> _models.WorkspaceSetting:
        ...
        deserialized = self._deserialize("WorkspaceSetting", pipeline_response.http_response)
    ...
    def create(
        ...
        :type workspace_setting: ~azure.mgmt.security.models.WorkspaceSetting or IO[bytes]
        :return: WorkspaceSetting or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.WorkspaceSetting
        :raises ~azure.core.exceptions.HttpResponseError:
        """
