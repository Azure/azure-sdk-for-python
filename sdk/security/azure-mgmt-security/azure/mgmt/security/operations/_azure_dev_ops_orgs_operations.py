...
def build_get_request(
    resource_group_name: str, security_connector_name: str, org_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class AzureDevOpsOrgsOperations:
    ...
    def list(
        self, resource_group_name: str, security_connector_name: str, **kwargs: Any
    ) -> ItemPaged["_models.AzureDevOpsOrg"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.security.models.AzureDevOpsOrg]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either AzureDevOpsOrg or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.security.models.AzureDevOpsOrg]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.AzureDevOpsOrg].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.AzureDevOpsOrg](
