...
class AzureDevOpsProjectsOperations:
    ...
    def list(
    ...
    ) -> AsyncItemPaged["_models.AzureDevOpsProject"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.AzureDevOpsProject]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.security.models.AzureDevOpsProject
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("AzureDevOpsProject", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type azure_dev_ops_project: ~azure.mgmt.security.models.AzureDevOpsProject
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either AzureDevOpsProject or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.security.models.AzureDevOpsProject]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type azure_dev_ops_project: ~azure.mgmt.security.models.AzureDevOpsProject or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either AzureDevOpsProject or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.security.models.AzureDevOpsProject]
        :raises ~azure.core.exceptions.HttpResponseError:
