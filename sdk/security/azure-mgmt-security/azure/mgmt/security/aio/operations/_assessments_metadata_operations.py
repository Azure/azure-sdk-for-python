...
class AssessmentsMetadataOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.SecurityAssessmentMetadataResponse"]:
        """Get metadata information on all assessment types.

        :return: An iterator like instance of either SecurityAssessmentMetadataResponse or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.SecurityAssessmentMetadataResponse]
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.SecurityAssessmentMetadataResponse"]:
    ...
    @distributed_trace_async
    async def delete_in_subscription(self, assessment_metadata_name: str, **kwargs: Any) -> None:
