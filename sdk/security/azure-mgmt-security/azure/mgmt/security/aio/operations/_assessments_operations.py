...
class AssessmentsOperations:
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> AsyncItemPaged["_models.SecurityAssessmentResponse"]:
        ...
        :return: An iterator like instance of either SecurityAssessmentResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.SecurityAssessmentResponse]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("SecurityAssessmentResponse", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type assessment: ~azure.mgmt.security.models.SecurityAssessment or IO[bytes]
        :return: SecurityAssessmentResponse or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.SecurityAssessmentResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def delete(self, resource_id: str, assessment_name: str, **kwargs: Any) -> None:
