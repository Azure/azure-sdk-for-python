...
class OperationStatusesOperations:
    ...
    async def get(self, location: str, operation_id: str, **kwargs: Any) -> _models.OperationStatusResultAutoGenerated:
        ...
        :return: OperationStatusResultAutoGenerated or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.OperationStatusResultAutoGenerated
        ...
        cls: ClsType[_models.OperationStatusResultAutoGenerated] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("OperationStatusResultAutoGenerated", pipeline_response.http_response)
