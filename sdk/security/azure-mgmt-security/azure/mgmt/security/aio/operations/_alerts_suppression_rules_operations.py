...
class AlertsSuppressionRulesOperations:
    ...
    @distributed_trace
    def list(self, alert_type: Optional[str] = None, **kwargs: Any) -> AsyncItemPaged["_models.AlertsSuppressionRule"]:
        ...
        :return: An iterator like instance of either AlertsSuppressionRule or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.AlertsSuppressionRule]
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type alerts_suppression_rule: ~azure.mgmt.security.models.AlertsSuppressionRule or IO[bytes]
        :return: AlertsSuppressionRule or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.AlertsSuppressionRule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def delete(self, alerts_suppression_rule_name: str, **kwargs: Any) -> None:
