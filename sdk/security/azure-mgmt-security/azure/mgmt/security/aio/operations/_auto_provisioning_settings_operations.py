...
class AutoProvisioningSettingsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.AutoProvisioningSetting"]:
        """Exposes the auto provisioning settings of the subscriptions.

        :return: An iterator like instance of either AutoProvisioningSetting or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.AutoProvisioningSetting]
