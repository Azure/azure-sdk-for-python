...
class CustomRecommendationsOperations:
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> AsyncItemPaged["_models.CustomRecommendation"]:
        ...
        :return: An iterator like instance of either CustomRecommendation or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.CustomRecommendation]
