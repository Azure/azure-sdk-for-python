...
class LocationsOperations:
    ...
    def list(
        self,
        **kwargs
    ) -> AsyncIterable["models.AscLocationList"]:
        ...
        :return: An iterator like instance of either AscLocationList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.AscLocationList]
