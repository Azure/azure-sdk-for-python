...
class AutomationsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.Automation"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.Automation]
        ...
        async def get_next(next_link=None):
            ...
            if response.status_code not in [200]:
                ...
                error = self._deserialize.failsafe_deserialize(
                    _models.CloudErrorAutoGenerated9,
                    pipeline_response,
                )
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncItemPaged["_models.Automation"]:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param automation: The security automation resource. Is either a Automation type or a IO[bytes]
         type. Required.
        :type automation: ~azure.mgmt.security.models.Automation or IO[bytes]
        :return: Automation or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.Automation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def update(
        ...
        resource_group_name: str,
        automation_name: str,
        automation: _models.AutomationUpdateModel,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.Automation:
        ...
        :param automation_name: The security automation name. Required.
        :type automation_name: str
        :param automation: The update model of security automation resource. Required.
        :type automation: ~azure.mgmt.security.models.AutomationUpdateModel
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Automation or the result of cls(response)
    ...
    async def update(
        ...
        resource_group_name: str,
        automation_name: str,
        automation: Union[_models.AutomationUpdateModel, IO[bytes]],
        **kwargs: Any
    ) -> _models.Automation:
        """Updates a security automation.
        ...
        :param automation_name: The security automation name. Required.
        :type automation_name: str
        :param automation: The update model of security automation resource. Is either a
         AutomationUpdateModel type or a IO[bytes] type. Required.
        :type automation: ~azure.mgmt.security.models.AutomationUpdateModel or IO[bytes]
        :return: Automation or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.Automation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(automation, (IOBase, bytes)):
            ...
            _json = self._serialize.body(automation, "AutomationUpdateModel")
