...
class JitNetworkAccessPoliciesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.JitNetworkAccessPolicy"]:
        """Policies for protecting resources using Just-in-Time access control.

        :return: An iterator like instance of either JitNetworkAccessPolicy or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.JitNetworkAccessPolicy]
    ...
    @distributed_trace
    def list_by_region(self, asc_location: str, **kwargs: Any) -> AsyncItemPaged["_models.JitNetworkAccessPolicy"]:
    ...
    ) -> AsyncItemPaged["_models.JitNetworkAccessPolicy"]:
        """Policies for protecting resources using Just-in-Time access control for the subscription,
        location.
