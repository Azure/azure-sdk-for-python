...
from ...operations._security_operators_operations import (
...
class SecurityOperatorsOperations:
    ...
    async def list(self, pricing_name: str, **kwargs: Any) -> _models.SecurityOperatorList:
    ...
    @distributed_trace_async
    async def get(self, pricing_name: str, security_operator_name: str, **kwargs: Any) -> _models.SecurityOperator:
    ...
    @distributed_trace_async
    async def delete(self, pricing_name: str, security_operator_name: str, **kwargs: Any) -> None:
