...
class AzureDevOpsReposOperations:
    ...
    def list(
    ...
    ) -> AsyncItemPaged["_models.AzureDevOpsRepository"]:
        ...
        :return: An iterator like instance of either AzureDevOpsRepository or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.AzureDevOpsRepository]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either AzureDevOpsRepository or the result
         of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.security.models.AzureDevOpsRepository]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
