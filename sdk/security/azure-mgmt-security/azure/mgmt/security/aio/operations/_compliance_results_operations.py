...
class ComplianceResultsOperations:
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> AsyncItemPaged["_models.ComplianceResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.ComplianceResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

        api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2017-08-01"))
        ...
        async def get_next(next_link=None):
            ...
            if response.status_code not in [200]:
                ...
                error = self._deserialize.failsafe_deserialize(
                    _models.CloudErrorAutoGenerated12,
                    pipeline_response,
                )
    ...
    async def get(self, resource_id: str, compliance_result_name: str, **kwargs: Any) -> _models.ComplianceResult:
        ...
        deserialized = self._deserialize("ComplianceResult", pipeline_response.http_response)
