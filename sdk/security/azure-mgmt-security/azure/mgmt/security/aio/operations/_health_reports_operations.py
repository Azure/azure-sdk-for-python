...
from ...operations._health_reports_operations import build_get_request, build_list_request
...
class HealthReportsOperations:
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> AsyncItemPaged["_models.HealthReport"]:
        ...
        :type scope: str
        :return: An iterator like instance of either HealthReport or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.HealthReport]
        ...
        cls: ClsType[_models.HealthReportsList] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("HealthReportsList", pipeline_response)
    ...
    async def get(self, resource_id: str, health_report_name: str, **kwargs: Any) -> _models.HealthReport:
        ...
        :rtype: ~azure.mgmt.security.models.HealthReport
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("HealthReport", pipeline_response.http_response)
