...
class SecurityConnectorsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.SecurityConnector"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.SecurityConnector]
    ...
    ) -> AsyncItemPaged["_models.SecurityConnector"]:
