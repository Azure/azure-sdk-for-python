...
class GitLabGroupsOperations:
    ...
    def list(
        self, resource_group_name: str, security_connector_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.GitLabGroup"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.GitLabGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.security.models.GitLabGroup
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("GitLabGroup", pipeline_response.http_response)
