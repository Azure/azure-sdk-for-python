...
class TasksOperations:
    ...
    @distributed_trace
    def list(self, filter: Optional[str] = None, **kwargs: Any) -> AsyncItemPaged["_models.SecurityTask"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.SecurityTask]
    ...
    ) -> AsyncItemPaged["_models.SecurityTask"]:
        """Recommended tasks that will help improve the security of the subscription proactively.
