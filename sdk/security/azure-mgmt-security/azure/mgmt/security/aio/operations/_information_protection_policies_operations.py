...
class InformationProtectionPoliciesOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("InformationProtectionPolicy", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type information_protection_policy: ~azure.mgmt.security.models.InformationProtectionPolicy or
         IO[bytes]
        :return: InformationProtectionPolicy or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.InformationProtectionPolicy
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> AsyncItemPaged["_models.InformationProtectionPolicy"]:
        ...
        :return: An iterator like instance of either InformationProtectionPolicy or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.InformationProtectionPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
