...
class DefenderForStorageOperations:
    ...
    @distributed_trace
    def list(self, resource_id: str, **kwargs: Any) -> AsyncItemPaged["_models.DefenderForStorageSetting"]:
        ...
        :return: An iterator like instance of either DefenderForStorageSetting or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.DefenderForStorageSetting]
