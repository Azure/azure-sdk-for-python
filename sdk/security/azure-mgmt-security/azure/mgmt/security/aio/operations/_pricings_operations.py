...
class PricingsOperations:
    ...
    async def get(self, scope_id: str, pricing_name: str, **kwargs: Any) -> _models.Pricing:
        ...
        if response.status_code not in [200]:
            ...
            error = self._deserialize.failsafe_deserialize(
                _models.CloudErrorAutoGenerated18,
                pipeline_response,
            )
    ...
    async def update(
        ...
        :type pricing: ~azure.mgmt.security.models.Pricing or IO[bytes]
        :return: Pricing or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.Pricing
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def delete(self, scope_id: str, pricing_name: str, **kwargs: Any) -> None:
        """Deletes a provided Microsoft Defender for Cloud pricing configuration in a specific resource.
        Valid only for resource scope (Supported resources are: 'VirtualMachines, VMSS, ARC Machines,
        and Containers').
