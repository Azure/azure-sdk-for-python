...
class SettingsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.Setting"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.Setting]
    ...
    async def get(self, setting_name: Union[str, _models.SettingNameAutoGenerated], **kwargs: Any) -> _models.Setting:
