...
class DeviceSecurityGroupsOperations:
    ...
    @distributed_trace
    def list(self, resource_id: str, **kwargs: Any) -> AsyncItemPaged["_models.DeviceSecurityGroup"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.DeviceSecurityGroup]
        ...
        async def get_next(next_link=None):
            ...
            if response.status_code not in [200]:
                ...
                error = self._deserialize.failsafe_deserialize(
                    _models.CloudErrorAutoGenerated14,
                    pipeline_response,
                )
    ...
    async def get(
        ...
        deserialized = self._deserialize("DeviceSecurityGroup", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type device_security_group: ~azure.mgmt.security.models.DeviceSecurityGroup or IO[bytes]
        :return: DeviceSecurityGroup or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.DeviceSecurityGroup
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace_async
    async def delete(self, resource_id: str, device_security_group_name: str, **kwargs: Any) -> None:
