...
class RegulatoryComplianceControlsOperations:
    ...
    def list(
    ...
    ) -> AsyncItemPaged["_models.RegulatoryComplianceControl"]:
        ...
        :return: An iterator like instance of either RegulatoryComplianceControl or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.RegulatoryComplianceControl]
    ...
    async def get(
        ...
        deserialized = self._deserialize("RegulatoryComplianceControl", pipeline_response.http_response)
