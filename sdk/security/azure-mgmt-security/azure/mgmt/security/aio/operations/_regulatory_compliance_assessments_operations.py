...
from ...operations._regulatory_compliance_assessments_operations import build_get_request, build_list_request
...
class RegulatoryComplianceAssessmentsOperations:  # pylint: disable=name-too-long
    """
    .. warning::
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.RegulatoryComplianceAssessment"]:
        ...
        :return: An iterator like instance of either RegulatoryComplianceAssessment or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.RegulatoryComplianceAssessment]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("RegulatoryComplianceAssessment", pipeline_response.http_response)
