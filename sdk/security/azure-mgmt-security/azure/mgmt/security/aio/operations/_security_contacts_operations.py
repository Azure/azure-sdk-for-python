...
class SecurityContactsOperations:
    ...
    def list(
        self,
        **kwargs
    ) -> AsyncIterable["models.SecurityContactList"]:
        """Security contact configurations for the subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either SecurityContactList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.SecurityContactList]
