...
from ...operations._custom_assessment_automations_operations import (
...
class CustomAssessmentAutomationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`custom_assessment_automations` attribute.
    """
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type custom_assessment_automation_body:
         ~azure.mgmt.security.models.CustomAssessmentAutomationRequest or IO[bytes]
        :return: CustomAssessmentAutomation or the result of cls(response)
        :rtype: ~azure.mgmt.security.models.CustomAssessmentAutomation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _json = None
        _content = None
        if isinstance(custom_assessment_automation_body, (IOBase, bytes)):
            _content = custom_assessment_automation_body
        else:
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, custom_assessment_automation_name: str, **kwargs: Any) -> None:
    ...
    def list_by_resource_group(
    ...
    ) -> AsyncItemPaged["_models.CustomAssessmentAutomation"]:
        ...
        :return: An iterator like instance of either CustomAssessmentAutomation or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.CustomAssessmentAutomation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.CustomAssessmentAutomation"]:
