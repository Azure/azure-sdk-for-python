...
class CompliancesOperations:
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> AsyncItemPaged["_models.Compliance"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.Compliance]
