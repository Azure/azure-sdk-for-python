...
class IotSecuritySolutionsAnalyticsRecommendationOperations:  # pylint: disable=name-too-long
    ...
    def list(
    ...
    ) -> AsyncItemPaged["_models.IoTSecurityAggregatedRecommendation"]:
        ...
        :return: An iterator like instance of either IoTSecurityAggregatedRecommendation or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.IoTSecurityAggregatedRecommendation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
