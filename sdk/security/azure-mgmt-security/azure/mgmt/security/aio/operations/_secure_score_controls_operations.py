...
class SecureScoreControlsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`secure_score_controls` attribute.
    """
    ...
    def list_by_secure_score(
    ...
    ) -> AsyncItemPaged["_models.SecureScoreControlDetails"]:
        ...
        :param expand: OData expand. Optional. "definition" Default value is None.
        :type expand: str or ~azure.mgmt.security.models.ExpandControlsEnum
        :return: An iterator like instance of either SecureScoreControlDetails or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.SecureScoreControlDetails]
        ...
        cls: ClsType[_models.SecureScoreControlList] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_secure_score_request(
