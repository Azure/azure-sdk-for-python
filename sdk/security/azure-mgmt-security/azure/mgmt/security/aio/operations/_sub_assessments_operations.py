...
class SubAssessmentsOperations:
    ...
    @distributed_trace
    def list_all(self, scope: str, **kwargs: Any) -> AsyncItemPaged["_models.SecuritySubAssessment"]:
        ...
        :return: An iterator like instance of either SecuritySubAssessment or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.SecuritySubAssessment]
    ...
    @distributed_trace
    def list(self, scope: str, assessment_name: str, **kwargs: Any) -> AsyncItemPaged["_models.SecuritySubAssessment"]:
    ...
    async def get(
        ...
        deserialized = self._deserialize("SecuritySubAssessment", pipeline_response.http_response)
