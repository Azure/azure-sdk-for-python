...
class SoftwareInventoriesOperations:
    ...
    def list_by_extended_resource(
    ...
    ) -> AsyncItemPaged["_models.Software"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.security.models.Software]
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.Software"]:
