...
from .operations import APICollectionsOperations
...
class SecurityCenter:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype api_collections:
     azure.mgmt.security.v2023_11_15.aio.operations.APICollectionsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.api_collections = APICollectionsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2023-11-15"
        )
