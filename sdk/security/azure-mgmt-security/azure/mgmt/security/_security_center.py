...
class SecurityCenter(MultiApiClientMixin, _SDKClient):
    ...
    def ingestion_settings(self):
        """Instance depends on the API version:
           ...
           * 2021-01-15-preview: :class:`IngestionSettingsOperations<azure.mgmt.security.v2021_01_15_preview.operations.IngestionSettingsOperations>`
        """
        api_version = self._get_api_version('ingestion_settings')
        if api_version == '2021-01-15-preview':
            from .v2021_01_15_preview.operations import IngestionSettingsOperations as OperationClass
        else:
