...
class JitNetworkAccessRequestPort(_Model):
    ...
    :vartype status: str or ~azure.mgmt.security.models.StatusEnum
    ...
    status: Union[str, "_models.StatusEnum"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    ...
    def __init__(
        ...
        *,
        number: int,
        end_time_utc: datetime.datetime,
        status: Union[str, "_models.StatusEnum"],
...
class OperationResultAutoGenerated(_Model):
    ...
    :vartype status: str or ~azure.mgmt.security.models.OperationResultStatus
    """
