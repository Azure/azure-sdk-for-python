...
class CustomAlertRule(Model):
    ...
    def __init__(self, *, is_enabled: bool, **kwargs) -> None:
...
class ThresholdCustomAlertRule(CustomAlertRule):
    ...
    def __init__(self, *, is_enabled: bool, min_threshold: int, max_threshold: int, **kwargs) -> None:
...
class AlertsSuppressionRule(Resource):
    ...
    def __init__(self, *, alert_type: str, reason: str, state, expiration_date_utc=None, comment: str=None, suppression_alerts_scope=None, **kwargs) -> None:
...
class AssessmentStatus(Model):
    ...
    def __init__(self, *, code, cause: str=None, description: str=None, **kwargs) -> None:
...
class DenylistCustomAlertRule(ListCustomAlertRule):
    ...
    def __init__(self, *, is_enabled: bool, denylist_values, **kwargs) -> None:
...
class InformationType(Model):
    ...
    def __init__(self, *, display_name: str=None, description: str=None, order: int=None, recommended_label_id: str=None, enabled: bool=None, custom: bool=None, keywords=None, **kwargs) -> None:
...
class IoTSecuritySolutionModel(Model):
    ...
    def __init__(self, *, display_name: str, iot_hubs, tags=None, location: str=None, workspace: str=None, status="Enabled", export=None, disabled_data_sources=None, user_defined_resources=None, recommendations_configuration=None, unmasked_ip_logging_status="Disabled", **kwargs) -> None:
...
class ScopeElement(Model):
    ...
    def __init__(self, *, additional_properties=None, field: str=None, **kwargs) -> None:
...
class SecureScoreControlDefinitionSource(Model):
    ...
    def __init__(self, *, source_type=None, **kwargs) -> None:
...
class SecureScoreControlDetails(Resource):
    ...
    def __init__(self, *, definition=None, **kwargs) -> None:
...
class SecurityAssessment(Resource):
    ...
    def __init__(self, *, resource_details, status, additional_data=None, links=None, metadata=None, partners_data=None, **kwargs) -> None:
...
class SecurityAssessmentMetadata(Resource):
    ...
    def __init__(self, *, display_name: str, severity, assessment_type, description: str=None, remediation_description: str=None, category=None, user_impact=None, implementation_effort=None, threats=None, preview: bool=None, partner_data=None, **kwargs) -> None:
...
class SecurityAssessmentMetadataPartnerData(Model):
    ...
    def __init__(self, *, partner_name: str, secret: str, product_name: str=None, **kwargs) -> None:
...
class SecurityAssessmentPartnerData(Model):
    ...
    def __init__(self, *, partner_name: str, secret: str, **kwargs) -> None:
...
class SensitivityLabel(Model):
    ...
    def __init__(self, *, display_name: str=None, description: str=None, rank=None, order: int=None, enabled: bool=None, **kwargs) -> None:
...
class VmRecommendation(Model):
    ...
    def __init__(self, *, configuration_status=None, recommendation_action=None, resource_id: str=None, enforcement_support=None, **kwargs) -> None:
