...
class Setting(SettingResource):
    ...
    def __init__(self, *, additional_properties=None, **kwargs) -> None:
        super(Setting, self).__init__(additional_properties=additional_properties, **kwargs)
        self.kind = 'Setting'
...
class DataExportSettings(Setting):
    ...
    def __init__(self, *, enabled: bool, additional_properties=None, **kwargs) -> None:
        super(DataExportSettings, self).__init__(additional_properties=additional_properties, **kwargs)
