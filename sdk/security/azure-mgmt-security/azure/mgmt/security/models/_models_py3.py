...
class InformationType(Model):
    ...
    def __init__(self, *, display_name: str=None, description: str=None, order: float=None, recommended_label_id: str=None, enabled: bool=None, custom: bool=None, keywords=None, **kwargs) -> None:
...
class SensitivityLabel(Model):
    ...
    def __init__(self, *, display_name: str=None, description: str=None, rank=None, order: float=None, enabled: bool=None, **kwargs) -> None:
