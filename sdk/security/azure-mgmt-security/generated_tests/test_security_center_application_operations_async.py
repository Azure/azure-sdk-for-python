...
class TestSecurityCenterApplicationOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_application_create_or_update(self, resource_group):
        response = await self.client.application.create_or_update(
            application_id="str",
            application={
                "conditionSets": [{}],
                "description": "str",
