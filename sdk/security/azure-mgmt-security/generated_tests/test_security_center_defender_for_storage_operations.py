...
class TestSecurityCenterDefenderForStorageOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_defender_for_storage_create(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_defender_for_storage_start_malware_scan(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_defender_for_storage_cancel_malware_scan(self, resource_group):
        response = self.client.defender_for_storage.cancel_malware_scan(
            resource_id="str",
            setting_name="str",
            scan_id="str",
            api_version="2025-02-01-preview",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_defender_for_storage_get_malware_scan(self, resource_group):
        response = self.client.defender_for_storage.get_malware_scan(
            resource_id="str",
            setting_name="str",
            scan_id="str",
            api_version="2025-02-01-preview",
