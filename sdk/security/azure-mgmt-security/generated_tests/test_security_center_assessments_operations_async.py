...
class TestSecurityCenterAssessmentsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_assessments_create_or_update(self, resource_group):
        response = await self.client.assessments.create_or_update(
            resource_id="str",
            assessment_name="str",
            assessment={
