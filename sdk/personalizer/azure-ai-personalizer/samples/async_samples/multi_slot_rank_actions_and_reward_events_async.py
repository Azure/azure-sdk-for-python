...
async def main():
    ...
    request = {"slots": slots, "actions": actions, "contextFeatures": context_features}
    ...
    await client.reward_multi_slot(rank_response.get("eventId"), {"reward": [{"slotId": "Main Article", "value": 1.0}]})
