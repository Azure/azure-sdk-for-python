...
class PersonalizerAdministrationClient:
    ...
    def export_model(self, *, signed: bool = False, **kwargs: Any) -> Iterator[bytes]:
        ...
        """
        return self._client.model.get(signed=signed, **kwargs)
    ...
    def import_model(self, body: IO, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return self._client.model.import_model(body, **kwargs)
    ...
    def get_log_properties(self, **kwargs: Any) -> JSON:
        ...
        """
        return self._client.log.get_properties(**kwargs)
    ...
    def delete_logs(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return self._client.log.delete(**kwargs)
    ...
    def get_policy(self, **kwargs: Any) -> JSON:
        ...
        """
        return self._client.policy.get(**kwargs)
    ...
    def update_policy(self, policy: Union[JSON, IO], **kwargs: Any) -> JSON:
        ...
        """
        return self._client.policy.update(policy, **kwargs)
    ...
    def reset_policy(self, **kwargs: Any) -> JSON:
        ...
        """
        return self._client.policy.reset(**kwargs)
    ...
    def get_service_configuration(self, **kwargs: Any) -> JSON:
        ...
        """
        return self._client.service_configuration.get(**kwargs)
    ...
    def update_service_configuration(self, config: Union[JSON, IO], **kwargs: Any) -> JSON:
        ...
        """
        return self._client.service_configuration.update(config, **kwargs)
    ...
    def create_evaluation(  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return self._client.evaluations.create(evaluation_id, evaluation, **kwargs)
    ...
    def get_evaluation(
        ...
        **kwargs: Any
        ...
        """
        return self._client.evaluations.get(
            evaluation_id,
    ...
    def delete_evaluation(self, evaluation_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """Offline Evaluation.
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return self._client.evaluations.delete(evaluation_id, **kwargs)
    ...
    def create_feature_importance(  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return self._client.feature_importances.create(feature_importance_id, feature_importance, **kwargs)
    ...
    def get_feature_importance(self, feature_importance_id: str, **kwargs: Any) -> JSON:
        ...
        """
        return self._client.feature_importances.get(feature_importance_id, **kwargs)
    ...
    def delete_feature_importance(  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return self._client.feature_importances.delete(feature_importance_id, **kwargs)
...
class PersonalizerClient:
    ...
    def rank(self, rank_request: Union[JSON, IO], **kwargs: Any) -> JSON:
        ...
        """
        return self._client.rank(rank_request, **kwargs)
    ...
    def reward(  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return self._client.events.reward(event_id, reward, **kwargs)
    ...
    def activate(self, event_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return self._client.events.activate(event_id, **kwargs)
    ...
    def rank_multi_slot(self, body: Union[JSON, IO], **kwargs: Any) -> JSON:
        ...
        """
        return self._client.multi_slot.rank(body, **kwargs)
    ...
    def reward_multi_slot(  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return self._client.multi_slot_events.reward(event_id, body, **kwargs)

    def activate_multi_slot(self, event_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
