...
class EvaluationOperations:
    """EvaluationOperations async operations.
    ...
    async def apply(
        self,
        body: "_models.PolicyReferenceContract",
        **kwargs: Any
    ) -> None:
        ...
        :param body:
        :type body: ~personalizerv11_preview1.models.PolicyReferenceContract
    ...
    apply.metadata = {'url': '/configurations/applyFromEvaluation'}  # type: ignore
