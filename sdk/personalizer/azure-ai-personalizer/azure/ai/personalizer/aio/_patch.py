...
class PersonalizerAdministrationClient:
    ...
    async def get_model(self, *, signed: bool = False, **kwargs: Any) -> AsyncIterator[bytes]:
        ...
        """
        return await self._client.model.get(signed=signed, **kwargs)
    ...
    async def import_model(self, body: IO, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return await self._client.model.import_model(body, **kwargs)
    ...
    async def get_log_properties(self, **kwargs: Any) -> JSON:
        ...
        """
        return await self._client.log.get_properties(**kwargs)
    ...
    async def delete_logs(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return await self._client.log.delete(**kwargs)
    ...
    async def get_policy(self, **kwargs: Any) -> JSON:
        ...
        """
        return await self._client.policy.get(**kwargs)
    ...
    async def update_policy(self, policy: Union[JSON, IO], **kwargs: Any) -> JSON:
        ...
        """
        return await self._client.policy.update(policy, **kwargs)
    ...
    async def reset_policy(self, **kwargs: Any) -> JSON:
        ...
        """
        return await self._client.policy.reset(**kwargs)
    ...
    async def get_service_configuration(self, **kwargs: Any) -> JSON:
        ...
        """
        return await self._client.service_configuration.get(**kwargs)
    ...
    async def update_service_configuration(self, config: Union[JSON, IO], **kwargs: Any) -> JSON:
        ...
        """
        return await self._client.service_configuration.update(config, **kwargs)
    ...
    async def create_evaluation(  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        await self._client.evaluations.create(evaluation_id, evaluation, **kwargs)
    ...
    async def get_evaluation(
        ...
        **kwargs: Any
        ...
        """
        return await self._client.evaluations.get(
            evaluation_id,
    ...
    def list_evaluations(
        ...
        """
        return self._client.evaluations.list(filter_expression=filter_expression, top=top, skip=skip, **kwargs)

    async def delete_evaluation(self, evaluation_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """Offline Evaluation.
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        await self._client.evaluations.delete(evaluation_id, **kwargs)
    ...
    async def create_feature_importance(  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        await self._client.feature_importances.create(feature_importance_id, feature_importance, **kwargs)
    ...
    async def get_feature_importance(self, feature_importance_id: str, **kwargs: Any) -> JSON:
        ...
        """
        return await self._client.feature_importances.get(feature_importance_id, **kwargs)

    def list_feature_importance(
            self, *, top: Optional[int] = None, skip: int = 0, **kwargs: Any) -> AsyncIterable[JSON]:
        ...
        """
        return self._client.feature_importances.list(top=top, skip=skip, **kwargs)
    ...
    async def delete(  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        await self._client.feature_importances.delete(feature_importance_id, **kwargs)
...
class PersonalizerClient:
    ...
    async def rank(self, rank_request: Union[JSON, IO], **kwargs: Any) -> JSON:
        """Rank.
            ...
            """
        return await self._client.rank(rank_request, **kwargs)
    ...
    async def reward(  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return await self._client.events.reward(event_id, reward, **kwargs)
    ...
    async def activate(self, event_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return await self._client.events.activate(event_id, **kwargs)
    ...
    async def rank_multi_slot(self, body: Union[JSON, IO], **kwargs: Any) -> JSON:
        ...
        """
        return await self._client.multi_slot.rank(body, **kwargs)
    ...
    async def reward_multi_slot(  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return await self._client.multi_slot_events.reward(event_id, body, **kwargs)

    async def activate_multi_slot(self, event_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return await self._client.multi_slot_events.activate(event_id, **kwargs)
