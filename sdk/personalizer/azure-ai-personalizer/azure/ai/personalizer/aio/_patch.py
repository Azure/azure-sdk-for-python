...
class PersonalizerAdministrationClient:  # pylint: disable=too-many-public-methods
        ...
        **kwargs: Any
        ...
        self._client = PersonalizerClientGenerated(
            ...
            authentication_policy=kwargs.pop(
                "authentication_policy", _authentication_policy(credential, **kwargs)
            ),
            **kwargs
        )
    ...
    def list_evaluations(
        ...
        **kwargs: Any
        ...
        """
        return self._client.list_evaluations(
            filter_expression=filter_expression, top=top, skip=skip, **kwargs
        )
    ...
    async def create_feature_importance(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        """
        await self._client.create_feature_importance(
            feature_importance_id, feature_importance, **kwargs
        )
    ...
    async def get_feature_importance(
        ...
        """
        return await self._client.get_feature_importance(
            feature_importance_id, **kwargs
        )
