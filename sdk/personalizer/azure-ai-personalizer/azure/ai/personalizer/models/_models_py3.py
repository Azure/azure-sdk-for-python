...
class ApprenticeLearningMetrics(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        number_of_imitated_events: int,
        sum_of_imitated_rewards: float,
        **kwargs
    ):
...
class ApprenticeModeMetrics(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        last_processed_event_time: datetime.datetime,
        number_of_events: int,
        sum_of_rewards: float,
        number_of_imitated_events: int,
        sum_of_imitated_rewards: float,
        last_batch_metrics: Optional["ApprenticeLearningMetrics"] = None,
        **kwargs
    ):
...
class Evaluation(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        policy_results: Optional[List["PolicyResult"]] = None,
        feature_importance: Optional[List[List[str]]] = None,
        evaluation_type: Optional[Union[str, "EvaluationType"]] = None,
        optimal_policy: Optional[str] = None,
...
class EvaluationContract(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        enable_offline_experimentation: Optional[bool] = None,
        **kwargs
    ):
...
class MultiSlotRankRequest(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        actions: List["RankableAction"],
        slots: List["SlotRequest"],
        context_features: Optional[List[Any]] = None,
        event_id: Optional[str] = None,
        defer_activation: Optional[bool] = False,
        **kwargs
    ):
...
class PersonalizerError(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        code: Union[str, "PersonalizerErrorCode"],
        message: str,
        target: Optional[str] = None,
        details: Optional[List["PersonalizerError"]] = None,
        inner_error: Optional["InternalError"] = None,
        **kwargs
    ):
...
class PolicyResultSummary(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        non_zero_probability: Optional[float] = None,
        **kwargs
    ):
...
class ServiceConfiguration(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        reward_wait_time: datetime.timedelta,
        default_reward: float,
        reward_aggregation: str,
        exploration_percentage: float,
        model_export_frequency: datetime.timedelta,
        log_retention_days: int,
        log_mirror_enabled: Optional[bool] = None,
        log_mirror_sas_uri: Optional[str] = None,
        last_configuration_edit_date: Optional[datetime.datetime] = None,
        learning_mode: Optional[Union[str, "LearningMode"]] = None,
        latest_apprentice_mode_metrics: Optional["ApprenticeModeMetrics"] = None,
        is_auto_optimization_enabled: Optional[bool] = None,
        auto_optimization_frequency: Optional[datetime.timedelta] = None,
        auto_optimization_start_date: Optional[datetime.datetime] = None,
        **kwargs
    ):
...
class ServiceStatus(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        api_status_message: Optional[str] = None,
        **kwargs
    ):
