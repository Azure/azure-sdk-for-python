...
from .operations import SparkBatchOperations, SparkSessionOperations
...
class SparkClient:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        _base_url = '{endpoint}'
        self._config = SparkClientConfiguration(credential=credential, endpoint=endpoint, spark_pool_name=spark_pool_name, livy_api_version=livy_api_version, **kwargs)
