...
from ...operations._workspace_managed_sql_server_recoverable_sql_pools_operations import build_get_request, build_list_request
T = TypeVar('T')
...
class WorkspaceManagedSqlServerRecoverableSqlPoolsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either RecoverableSqlPoolListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.synapse.models.RecoverableSqlPoolListResult]
