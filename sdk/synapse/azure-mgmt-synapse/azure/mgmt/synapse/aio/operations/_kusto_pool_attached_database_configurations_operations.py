...
class KustoPoolAttachedDatabaseConfigurationsOperations:
    ...
    def list_by_kusto_pool(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.synapse.models.AttachedDatabaseConfigurationListResult]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.synapse.models.AttachedDatabaseConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
