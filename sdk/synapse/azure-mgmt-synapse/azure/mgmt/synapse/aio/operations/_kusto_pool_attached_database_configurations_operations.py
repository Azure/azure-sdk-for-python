...
from ...operations._kusto_pool_attached_database_configurations_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_kusto_pool_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class KustoPoolAttachedDatabaseConfigurationsOperations:
    """KustoPoolAttachedDatabaseConfigurationsOperations async operations.
    ...
    def list_by_kusto_pool(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.synapse.models.AttachedDatabaseConfigurationListResult]
