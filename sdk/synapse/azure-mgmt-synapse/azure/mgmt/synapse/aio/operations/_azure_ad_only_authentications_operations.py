...
from ...operations._azure_ad_only_authentications_operations import (
...
class AzureADOnlyAuthenticationsOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.AzureADOnlyAuthentication"]:
        ...
        :return: An iterator like instance of either AzureADOnlyAuthentication or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.synapse.models.AzureADOnlyAuthentication]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
