...
from ...operations._azure_ad_only_authentications_operations import build_create_request_initial, build_get_request, build_list_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class AzureADOnlyAuthenticationsOperations:
    """AzureADOnlyAuthenticationsOperations async operations.
    ...
    async def begin_create(
        ...
        azure_ad_only_authentication_info: "_models.AzureADOnlyAuthentication",
        **kwargs: Any
    ) -> AsyncLROPoller["_models.AzureADOnlyAuthentication"]:
        ...
        :return: An instance of AsyncLROPoller that returns either AzureADOnlyAuthentication or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.synapse.models.AzureADOnlyAuthentication]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-06-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list(
        ...
        workspace_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.AzureADOnlyAuthenticationListResult"]:
        ...
        :return: An iterator like instance of either AzureADOnlyAuthenticationListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.synapse.models.AzureADOnlyAuthenticationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-06-01")  # type: str
