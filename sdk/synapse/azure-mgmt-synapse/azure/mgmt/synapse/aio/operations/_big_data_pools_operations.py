...
from ...operations._big_data_pools_operations import (
...
class BigDataPoolsOperations:
    ...
    def list_by_workspace(
    ...
    ) -> AsyncIterable["_models.BigDataPoolResourceInfo"]:
        ...
        :return: An iterator like instance of either BigDataPoolResourceInfo or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.synapse.models.BigDataPoolResourceInfo]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
