...
class WorkspaceManagedSqlServerSecurityAlertPolicyOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :type security_alert_policy_name: str or ~azure.mgmt.synapse.models.SecurityAlertPolicyNameAutoGenerated
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.synapse.models.ServerSecurityAlertPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
