...
class WorkspaceManagedSqlServerExtendedBlobAuditingPoliciesOperations(object):
    ...
    def get(
        ...
        :return: ExtendedServerBlobAuditingPolicy or ClientRawResponse if
         raw=true
        :rtype: ~azure.mgmt.synapse.models.ExtendedServerBlobAuditingPolicy or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/extendedAuditingSettings/{blobAuditingPolicyName}'}
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.synapse.models.ExtendedServerBlobAuditingPolicy
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.synapse.models.ExtendedServerBlobAuditingPolicy]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.synapse.models.ExtendedServerBlobAuditingPolicy]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/extendedAuditingSettings/{blobAuditingPolicyName}'}
    ...
    def list_by_workspace(
        ...
        :rtype:
         ~azure.mgmt.synapse.models.ExtendedServerBlobAuditingPolicyPaged[~azure.mgmt.synapse.models.ExtendedServerBlobAuditingPolicy]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
