...
class WorkspaceManagedSqlServerExtendedBlobAuditingPoliciesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.synapse.models.ExtendedServerBlobAuditingPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_workspace(
    ...
    ) -> Iterable["_models.ExtendedServerBlobAuditingPolicy"]:
        ...
        :return: An iterator like instance of either ExtendedServerBlobAuditingPolicy or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.synapse.models.ExtendedServerBlobAuditingPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
