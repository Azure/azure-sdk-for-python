...
class SqlPoolSecurityAlertPoliciesOperations(object):
    ...
    def list(
        ...
        :return: An iterator like instance of SqlPoolSecurityAlertPolicy
        :rtype:
         ~azure.mgmt.synapse.models.SqlPoolSecurityAlertPolicyPaged[~azure.mgmt.synapse.models.SqlPoolSecurityAlertPolicy]
        ...
        if raw:
            header_dict = {}
        deserialized = models.SqlPoolSecurityAlertPolicyPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: SqlPoolSecurityAlertPolicy or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.synapse.models.SqlPoolSecurityAlertPolicy or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SqlPoolSecurityAlertPolicy', response)
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/securityAlertPolicies/{securityAlertPolicyName}'}
    ...
    def create_or_update(
        ...
        :type parameters:
         ~azure.mgmt.synapse.models.SqlPoolSecurityAlertPolicy
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        return deserialized
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/securityAlertPolicies/{securityAlertPolicyName}'}
