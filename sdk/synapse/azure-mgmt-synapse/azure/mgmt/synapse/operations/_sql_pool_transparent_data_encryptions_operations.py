...
class SqlPoolTransparentDataEncryptionsOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :param transparent_data_encryption_name: The name of the transparent data encryption
         configuration.
        :type transparent_data_encryption_name: str or ~azure.mgmt.synapse.models.TransparentDataEncryptionName
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.TransparentDataEncryptionListResult"]
        ...
        :type sql_pool_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either TransparentDataEncryptionListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.synapse.models.TransparentDataEncryptionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
