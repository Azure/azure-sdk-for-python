...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/libraries/{libraryName}")  # pylint: disable=line-too-long
...
class LibraryOperations(object):
    ...
    def get(
        ...
        **kwargs: Any
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.LibraryResource"]
        error_map = {
