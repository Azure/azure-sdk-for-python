...
class ExtendedSqlPoolBlobAuditingPoliciesOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.ExtendedSqlPoolBlobAuditingPolicy"
    ...
    def create_or_update(
        ...
        workspace_name,  # type: str
        sql_pool_name,  # type: str
        parameters,  # type: "_models.ExtendedSqlPoolBlobAuditingPolicy"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ExtendedSqlPoolBlobAuditingPolicy"
    ...
    def list_by_sql_pool(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ExtendedSqlPoolBlobAuditingPolicyListResult"]
        ...
        :type sql_pool_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ExtendedSqlPoolBlobAuditingPolicyListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.synapse.models.ExtendedSqlPoolBlobAuditingPolicyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
