...
class RestorableDroppedSqlPoolsOperations(object):
    ...
    def get(
        ...
        restorable_dropped_sql_pool_id,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.RestorableDroppedSqlPool"
    ...
    def list_by_workspace(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.RestorableDroppedSqlPoolListResult"]
        ...
        :type workspace_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either RestorableDroppedSqlPoolListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.synapse.models.RestorableDroppedSqlPoolListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
