...
def build_check_name_availability_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/kustoPools/{kustoPoolName}/databases/{databaseName}/checkPrincipalAssignmentNameAvailability")  # pylint: disable=line-too-long
...
def build_list_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/kustoPools/{kustoPoolName}/databases/{databaseName}/principalAssignments")  # pylint: disable=line-too-long
    path_format_arguments = {
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str'),
        "kustoPoolName": _SERIALIZER.url("kusto_pool_name", kusto_pool_name, 'str'),
        "databaseName": _SERIALIZER.url("database_name", database_name, 'str'),
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/kustoPools/{kustoPoolName}/databases/{databaseName}/principalAssignments/{principalAssignmentName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, 'str'),
        "kustoPoolName": _SERIALIZER.url("kusto_pool_name", kusto_pool_name, 'str'),
        "databaseName": _SERIALIZER.url("database_name", database_name, 'str'),
...
class KustoPoolDatabasePrincipalAssignmentsOperations(object):
    ...
    def list(
        ...
        resource_group_name: str,
        **kwargs: Any
    ) -> Iterable["_models.DatabasePrincipalAssignmentListResult"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.synapse.models.DatabasePrincipalAssignmentListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-06-01-preview")  # type: str
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either DatabasePrincipalAssignment or the result
         of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.synapse.models.DatabasePrincipalAssignment]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-06-01-preview")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
