...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/operations")  # pylint: disable=line-too-long
...
class SqlPoolOperationsOperations(object):
    ...
    def list(
        ...
        sql_pool_name: str,
        **kwargs: Any
    ) -> Iterable["_models.SqlPoolBlobAuditingPolicySqlPoolOperationListResult"]:
        ...
        :return: An iterator like instance of either
         SqlPoolBlobAuditingPolicySqlPoolOperationListResult or the result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.synapse.models.SqlPoolBlobAuditingPolicySqlPoolOperationListResult]
