...
class IntegrationRuntimeNodeIpAddressOperations(object):
    ...
    def get(
        ...
        :return: IntegrationRuntimeNodeIpAddress or ClientRawResponse if
         raw=true
        :rtype: ~azure.mgmt.synapse.models.IntegrationRuntimeNodeIpAddress or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/integrationRuntimes/{integrationRuntimeName}/nodes/{nodeName}/ipAddress'}
