...
class PrivateEndpointConnectionsPrivateLinkHubOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.PrivateEndpointConnectionForPrivateLinkHubResourceCollectionResponse"]
        ...
        :return: An iterator like instance of either PrivateEndpointConnectionForPrivateLinkHubResourceCollectionResponse or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.synapse.models.PrivateEndpointConnectionForPrivateLinkHubResourceCollectionResponse]
