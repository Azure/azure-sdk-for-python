...
def build_list_by_kusto_pool_request(
    resource_group_name: str, workspace_name: str, kusto_pool_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class KustoPoolDatabasesOperations:
    ...
    def list_by_kusto_pool(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.synapse.models.Database]
