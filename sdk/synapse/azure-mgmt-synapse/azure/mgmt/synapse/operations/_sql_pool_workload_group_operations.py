...
class SqlPoolWorkloadGroupOperations(object):
    ...
    def get(
            self, resource_group_name, workspace_name, sql_pool_name, workload_group_name, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~azure.mgmt.synapse.models.WorkloadGroup or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/workloadGroups/{workloadGroupName}'}


    def _create_or_update_initial(
            self, resource_group_name, workspace_name, sql_pool_name, workload_group_name, parameters, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def create_or_update(
            self, resource_group_name, workspace_name, sql_pool_name, workload_group_name, parameters, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/workloadGroups/{workloadGroupName}'}
    ...
    def delete(
            self, resource_group_name, workspace_name, sql_pool_name, workload_group_name, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/workloadGroups/{workloadGroupName}'}
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.synapse.models.WorkloadGroupPaged[~azure.mgmt.synapse.models.WorkloadGroup]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
