...
class AzureADOnlyAuthenticationsOperations(object):
    ...
    def get(
        ...
        azure_ad_only_authentication_name,  # type: Union[str, "_models.AzureADOnlyAuthenticationName"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.AzureADOnlyAuthentication"
        """Get Azure Active Directory Only Authentication property.

        Gets a Azure Active Directory Only Authentication property for the workspace.

        :param resource_group_name: The name of the resource group. The name is case insensitive.
        :type resource_group_name: str
        :param workspace_name: The name of the workspace.
        :type workspace_name: str
        :param azure_ad_only_authentication_name: name of the property.
        :type azure_ad_only_authentication_name: str or ~azure.mgmt.synapse.models.AzureADOnlyAuthenticationName
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.AzureADOnlyAuthentication"]
        error_map = {
        ...
        path_format_arguments = {
            ...
            'azureADOnlyAuthenticationName': self._serialize.url("azure_ad_only_authentication_name", azure_ad_only_authentication_name, 'str'),
        }
    ...
    def _create_initial(
        ...
        workspace_name,  # type: str
        azure_ad_only_authentication_name,  # type: Union[str, "_models.AzureADOnlyAuthenticationName"]
        azure_ad_only_authentication_info,  # type: "_models.AzureADOnlyAuthentication"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.AzureADOnlyAuthentication"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.AzureADOnlyAuthentication"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        body_content = self._serialize.body(azure_ad_only_authentication_info, 'AzureADOnlyAuthentication')
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.AzureADOnlyAuthentication"]
        """Create or Update Azure Active Directory Only Authentication property.

        Create or Update a Azure Active Directory Only Authentication property for the workspace.
        ...
        :return: An instance of LROPoller that returns either AzureADOnlyAuthentication or the result of cls(response)
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.AzureADOnlyAuthenticationListResult"]
        """Gets a list of Azure Active Directory Only Authentication property.

        Gets a list of Azure Active Directory Only Authentication properties for a workspace.
        ...
        :type workspace_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either AzureADOnlyAuthenticationListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.synapse.models.AzureADOnlyAuthenticationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.AzureADOnlyAuthenticationListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
