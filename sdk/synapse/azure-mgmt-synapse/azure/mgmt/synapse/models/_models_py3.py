...
class AzureADOnlyAuthentication(ProxyResource):
    ...
    :ivar state: Azure Active Directory Only Authentication configuration state. Possible values
     include: "Consistent", "InConsistent", "Updating".
    :vartype state: str or ~azure.mgmt.synapse.models.AuthenticationState
...
class AzureADOnlyAuthenticationListResult(msrest.serialization.Model):
    """A list of Azure Active Directory only authentications.
