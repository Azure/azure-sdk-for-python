...
# USAGE
    python kusto_pool_data_connection_validation.py
...
def main():
    ...
    response = client.kusto_pool_data_connections.begin_data_connection_validation(
        resource_group_name="kustorptest",
        workspace_name="kustorptest",
        kusto_pool_name="kustoclusterrptest4",
        database_name="KustoDatabase8",
        parameters={"dataConnectionName": "DataConnections8", "properties": {"kind": "EventHub"}},
    ).result()
    print(response)
