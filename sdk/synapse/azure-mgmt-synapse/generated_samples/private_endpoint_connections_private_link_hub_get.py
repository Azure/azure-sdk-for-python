...
# USAGE
    python private_endpoint_connections_private_link_hub_get.py
...
def main():
    ...
    response = client.private_endpoint_connections_private_link_hub.get(
        resource_group_name="gh-res-grp",
        private_link_hub_name="pe0",
        private_endpoint_connection_name="pe0-f3ed30f5-338c-4855-a542-24a403694ad2",
    )
    print(response)
