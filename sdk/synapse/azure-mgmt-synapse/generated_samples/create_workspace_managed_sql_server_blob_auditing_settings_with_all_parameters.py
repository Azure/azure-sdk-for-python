...
# USAGE
    python create_workspace_managed_sql_server_blob_auditing_settings_with_all_parameters.py
...
def main():
    ...
    response = client.workspace_managed_sql_server_blob_auditing_policies.begin_create_or_update(
