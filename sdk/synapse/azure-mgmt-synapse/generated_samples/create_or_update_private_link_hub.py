...
# USAGE
    python create_or_update_private_link_hub.py
...
def main():
    ...
    response = client.private_link_hubs.create_or_update(
        resource_group_name="resourceGroup1",
        private_link_hub_name="privateLinkHub1",
        private_link_hub_info={"location": "East US", "properties": {}, "tags": {"key": "value"}},
    )
    print(response)
