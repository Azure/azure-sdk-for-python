...
# USAGE
    python create_or_update_sql_pool_security_alert_with_all_parameters.py
...
def main():
    ...
    response = client.sql_pool_security_alert_policies.create_or_update(
        resource_group_name="securityalert-4799",
        workspace_name="securityalert-6440",
