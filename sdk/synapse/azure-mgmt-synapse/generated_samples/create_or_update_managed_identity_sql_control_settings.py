...
# USAGE
    python create_or_update_managed_identity_sql_control_settings.py
...
def main():
    ...
    response = client.workspace_managed_identity_sql_control_settings.begin_create_or_update(
