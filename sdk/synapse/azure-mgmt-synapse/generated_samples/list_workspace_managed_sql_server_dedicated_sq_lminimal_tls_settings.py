...
# USAGE
    python list_workspace_managed_sql_server_dedicated_sq_lminimal_tls_settings.py
...
def main():
    ...
    response = client.workspace_managed_sql_server_dedicated_sql_minimal_tls_settings.list(
