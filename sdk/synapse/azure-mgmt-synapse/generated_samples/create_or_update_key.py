...
# USAGE
    python create_or_update_key.py
...
def main():
    ...
    response = client.keys.create_or_update(
        resource_group_name="ExampleResourceGroup",
        workspace_name="ExampleWorkspace",
        key_name="somekey",
        key_properties={"properties": {"isActiveCMK": True, "keyVaultUrl": "https://vault.azure.net/keys/somesecret"}},
    )
    print(response)
