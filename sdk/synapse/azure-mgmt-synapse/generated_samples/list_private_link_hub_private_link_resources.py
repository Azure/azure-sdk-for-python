...
# USAGE
    python list_private_link_hub_private_link_resources.py
...
def main():
    ...
    response = client.private_link_hub_private_link_resources.list(
        resource_group_name="ExampleResourceGroup",
        private_link_hub_name="ExamplePrivateLinkHub",
    )
