...
# USAGE
    python kusto_pool_attached_database_configurations_list_by_kusto_pool.py
...
def main():
    ...
    response = client.kusto_pool_attached_database_configurations.list_by_kusto_pool(
