...
class VnetClient:
    ...
    :vartype managed_private_endpoints:
     azure.synapse.managedprivateendpoints.aio.operations.ManagedPrivateEndpointsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        _base_url = '{endpoint}'
        self._config = VnetClientConfiguration(credential=credential, endpoint=endpoint, **kwargs)
