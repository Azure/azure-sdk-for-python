...
from ..rest import notebook as rest_notebook
...
class NotebookOperations(object):
    ...
    def get_notebooks_by_workspace(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = rest_notebook.build_get_notebooks_by_workspace_request(
                    template_url=self.get_notebooks_by_workspace.metadata["url"], **kwargs
                )._internal_request
    ...
    def get_notebook_summary_by_work_space(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = rest_notebook.build_get_notebook_summary_by_work_space_request(
                    template_url=self.get_notebook_summary_by_work_space.metadata["url"], **kwargs
                )._internal_request
                path_format_arguments = {
                    "endpoint": self._serialize.url(
                        "self._config.endpoint", self._config.endpoint, "str", skip_quote=True
    ...
    def _create_or_update_notebook_initial(
        ...
        **kwargs  # type: Any
        ...
        json = self._serialize.body(notebook, "object")

        request = rest_notebook.build_create_or_update_notebook_request_initial(
        ...
        **kwargs  # type: Any
        ...
        if cont_token is None:
            raw_result = self._create_or_update_notebook_initial(
                notebook_name=notebook_name, notebook=notebook, cls=lambda x, y, z: x, **kwargs
            )
    ...
    def get_notebook(
        ...
        **kwargs  # type: Any
        ...
        request = rest_notebook.build_get_notebook_request(
            notebook_name=notebook_name,
    ...
    def _delete_notebook_initial(
        ...
        **kwargs  # type: Any
        ...
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        request = rest_notebook.build_delete_notebook_request_initial(
            notebook_name=notebook_name, template_url=self._delete_notebook_initial.metadata["url"], **kwargs
        )._internal_request
        path_format_arguments = {
            "endpoint": self._serialize.url("self._config.endpoint", self._config.endpoint, "str", skip_quote=True),
        }
    ...
    def begin_delete_notebook(
        ...
        **kwargs  # type: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._delete_notebook_initial(notebook_name=notebook_name, cls=lambda x, y, z: x, **kwargs)
    ...
    def _rename_notebook_initial(
        ...
        **kwargs  # type: Any
        ...
        request = rest_notebook.build_rename_notebook_request_initial(
            notebook_name=notebook_name,
            json=json,
            content_type=content_type,
    ...
    def begin_rename_notebook(
        ...
        **kwargs  # type: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._rename_notebook_initial(notebook_name=notebook_name, cls=lambda x, y, z: x, **kwargs)
