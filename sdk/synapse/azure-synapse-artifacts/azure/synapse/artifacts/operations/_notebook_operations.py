...
class NotebookOperations:
    ...
    @distributed_trace
    def get_notebooks_by_workspace(self, **kwargs: Any) -> Iterable["_models.NotebookResourceAutoGenerated"]:
        """Lists Notebooks.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either NotebookResourceAutoGenerated or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.synapse.artifacts.models.NotebookResourceAutoGenerated]
    ...
    @distributed_trace
    def get_notebook_summary_by_work_space(self, **kwargs: Any) -> Iterable["_models.NotebookResourceAutoGenerated"]:
    ...
    def _create_or_update_notebook_initial(
        self,
        notebook_name: str,
        notebook: Union[_models.NotebookResourceAutoGenerated, IO],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> Optional[_models.NotebookResourceAutoGenerated]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2020-12-01"))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.NotebookResourceAutoGenerated]] = kwargs.pop("cls", None)
        ...
        if isinstance(notebook, (IOBase, bytes)):
            ...
            _json = self._serialize.body(notebook, "NotebookResourceAutoGenerated")
        ...
        if response.status_code == 200:
            deserialized = self._deserialize("NotebookResourceAutoGenerated", pipeline_response)
    ...
    def begin_create_or_update_notebook(
        self,
        notebook_name: str,
        notebook: _models.NotebookResourceAutoGenerated,
        if_match: Optional[str] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.NotebookResourceAutoGenerated]:
        ...
        :type notebook: ~azure.synapse.artifacts.models.NotebookResourceAutoGenerated
        ...
        :return: An instance of LROPoller that returns either NotebookResourceAutoGenerated or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.synapse.artifacts.models.NotebookResourceAutoGenerated]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update_notebook(
        ...
        **kwargs: Any
        ...
        :param notebook_name: The notebook name. Required.
        :type notebook_name: str
        :param notebook: Note book resource definition. Is either a NotebookResourceAutoGenerated type
         or a IO type. Required.
        :type notebook: ~azure.synapse.artifacts.models.NotebookResourceAutoGenerated or IO
        :param if_match: ETag of the Note book entity.  Should only be specified for update, for which
         it should match existing entity or can be * for unconditional update. Default value is None.
        :type if_match: str
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2020-12-01"))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.NotebookResourceAutoGenerated] = kwargs.pop("cls", None)
    ...
    def get_notebook(
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NotebookResourceAutoGenerated or None or the result of cls(response)
        :rtype: ~azure.synapse.artifacts.models.NotebookResourceAutoGenerated or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
