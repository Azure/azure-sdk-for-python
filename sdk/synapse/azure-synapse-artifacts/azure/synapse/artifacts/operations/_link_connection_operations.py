...
def build_list_link_connections_by_workspace_request(**kwargs: Any) -> HttpRequest:
...
def build_create_or_update_link_connection_request(link_connection_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_link_connection_request(link_connection_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_link_connection_request(link_connection_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class LinkConnectionOperations:
    ...
    @distributed_trace
    def list_link_connections_by_workspace(self, **kwargs: Any) -> Iterable["_models.LinkConnectionResource"]:
    ...
    @distributed_trace
    def get_link_connection(self, link_connection_name: str, **kwargs: Any) -> _models.LinkConnectionResource:
