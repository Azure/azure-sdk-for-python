...
def build_update_landing_zone_credential_request(link_connection_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class LinkConnectionOperations:
    ...
    def create_or_update(
        ...
        :param link_connection_name: The link connection name. Required.
        :type link_connection_name: str
        :param link_connection: Link connection resource definition. Is either a model type or a IO
         type. Required.
        ...
        _json = None
        _content = None
        if isinstance(link_connection, (IO, bytes)):
    ...
    def query_table_status(
        ...
        **kwargs: Any
        ...
        :param link_connection_name: The link connection name. Required.
        :type link_connection_name: str
        :param query_table_status_request: Query table status request. Is either a model type or a IO
         type. Required.
        ...
        _json = None
        _content = None
        if isinstance(query_table_status_request, (IO, bytes)):
