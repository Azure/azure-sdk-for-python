...
class LibraryOperations(object):
    ...
    def begin_flush(
        ...
        **kwargs  # type: Any
        ...
        if cont_token is None:
            raw_result = self._flush_initial(library_name=library_name, cls=lambda x, y, z: x, **kwargs)
    ...
    def begin_delete(
        ...
        **kwargs  # type: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._delete_initial(library_name=library_name, cls=lambda x, y, z: x, **kwargs)
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._create_initial(library_name=library_name, cls=lambda x, y, z: x, **kwargs)
