...
class LibraryOperations(object):
    ...
    def _create_or_append_initial(
        self,
        library_name,  # type: str
        comp=None,  # type: Optional[str]
        x_ms_blob_condition_appendpos=None,  # type: Optional[int]
        content=None,  # type: Optional[IO]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.LibraryResourceInfo"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.LibraryResourceInfo"]]
    ...
    def begin_create_or_append(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.LibraryResourceInfo"]
        """Creates a library with the library name. Use query param 'comp=appendblock' to append the data
        to the library resource created using the create operation.

        :param library_name: file name to upload. Minimum length of the filename should be 1 excluding
         the extension length.
        :type library_name: str
        :param comp: If this param is specified with value appendblock, the api will append the data
         chunk provided in body to the library created.
        :type comp: str
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._create_or_append_initial(
                library_name=library_name,
                comp=comp,
        ...
        if cont_token:
            ...
            return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_create_or_append.metadata = {'url': '/libraries/{libraryName}'}  # type: ignore
