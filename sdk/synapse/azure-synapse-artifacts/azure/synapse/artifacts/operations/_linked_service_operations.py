...
def build_get_linked_services_by_workspace_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
...
def build_create_or_update_linked_service_request(  # pylint: disable=name-too-long
    linked_service_name: str, *, if_match: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_linked_service_request(linked_service_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_rename_linked_service_request(linked_service_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class LinkedServiceOperations:
    ...
    @distributed_trace
    def get_linked_services_by_workspace(self, **kwargs: Any) -> Iterable["_models.LinkedServiceResource"]:
        """Lists linked services.

        :return: An iterator like instance of either LinkedServiceResource or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.synapse.artifacts.models.LinkedServiceResource]
    ...
    def begin_create_or_update_linked_service(
        ...
        :param properties: Properties of linked service. Required.
        ...
        if cont_token:
            return LROPoller[_models.LinkedServiceResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.LinkedServiceResource](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    @distributed_trace
    def get_linked_service(
        self, linked_service_name: str, if_none_match: Optional[str] = None, **kwargs: Any
    ...
    def _delete_linked_service_initial(self, linked_service_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def begin_delete_linked_service(self, linked_service_name: str, **kwargs: Any) -> LROPoller[None]:
