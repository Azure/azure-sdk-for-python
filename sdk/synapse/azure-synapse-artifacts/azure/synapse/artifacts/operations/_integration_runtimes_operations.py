...
def build_list_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/integrationRuntimes")
...
def build_get_request(integration_runtime_name: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/integrationRuntimes/{integrationRuntimeName}")
...
class IntegrationRuntimesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> _models.IntegrationRuntimeListResponse:
        ...
        deserialized = self._deserialize("IntegrationRuntimeListResponse", pipeline_response.http_response)
    ...
    @distributed_trace
    def get(self, integration_runtime_name: str, **kwargs: Any) -> _models.IntegrationRuntimeResource:
