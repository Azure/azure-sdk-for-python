...
def build_create_or_update_dataset_request_initial(
    dataset_name: str,
    *,
    json: Optional[_models.DatasetResource] = None,
    content: Any = None,
...
class DatasetOperations:
    ...
    @distributed_trace
    def begin_delete_dataset(  # pylint: disable=inconsistent-return-statements
        self,
        dataset_name: str,
        **kwargs: Any
    ) -> LROPoller[None]:
    ...
    @distributed_trace
    def begin_rename_dataset(  # pylint: disable=inconsistent-return-statements
        self,
        dataset_name: str,
        new_name: Optional[str] = None,
        **kwargs: Any
