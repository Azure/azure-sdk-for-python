...
from ..rest import dataset as rest_dataset
...
class DatasetOperations(object):
    ...
    def get_datasets_by_workspace(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = rest_dataset.build_get_datasets_by_workspace_request(
                    template_url=self.get_datasets_by_workspace.metadata["url"], **kwargs
                )._internal_request
    ...
    def _create_or_update_dataset_initial(
        ...
        **kwargs  # type: Any
        ...
        properties = kwargs.pop("properties")  # type: "_models.Dataset"
        if_match = kwargs.pop("if_match", None)  # type: Optional[str]

        _dataset = _models.DatasetResource(properties=properties)
        json = self._serialize.body(_dataset, "object")

        request = rest_dataset.build_create_or_update_dataset_request_initial(
    ...
    def begin_create_or_update_dataset(
        ...
        **kwargs  # type: Any
        ...
        :paramtype properties: ~azure.synapse.artifacts.models.Dataset
        ...
        if cont_token is None:
            raw_result = self._create_or_update_dataset_initial(
                dataset_name=dataset_name, cls=lambda x, y, z: x, **kwargs
            )
    ...
    def get_dataset(
        ...
        **kwargs  # type: Any
        ...
        request = rest_dataset.build_get_dataset_request(
            dataset_name=dataset_name,
    ...
    def _delete_dataset_initial(
        ...
        **kwargs  # type: Any
        ...
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        request = rest_dataset.build_delete_dataset_request_initial(
            dataset_name=dataset_name, template_url=self._delete_dataset_initial.metadata["url"], **kwargs
        )._internal_request
        path_format_arguments = {
            "endpoint": self._serialize.url("self._config.endpoint", self._config.endpoint, "str", skip_quote=True),
        }
    ...
    def begin_delete_dataset(
        ...
        **kwargs  # type: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._delete_dataset_initial(dataset_name=dataset_name, cls=lambda x, y, z: x, **kwargs)
    ...
    def _rename_dataset_initial(
        ...
        **kwargs  # type: Any
        ...
        request = rest_dataset.build_rename_dataset_request_initial(
            dataset_name=dataset_name,
            json=json,
            content_type=content_type,
    ...
    def begin_rename_dataset(
        ...
        **kwargs  # type: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._rename_dataset_initial(dataset_name=dataset_name, cls=lambda x, y, z: x, **kwargs)
