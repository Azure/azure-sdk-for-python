...
class SparkJobDefinitionsOperations(object):
    ...
    _rename_initial.metadata = {'url': '/sparkJobDefinitions/{sparkJobDefinitionName}/rename'}  # type: ignore
    ...
    begin_rename.metadata = {'url': '/sparkJobDefinitions/{sparkJobDefinitionName}/rename'}  # type: ignore
