...
class SqlScriptsOperations(object):
    """SqlScriptsOperations operations.
    ...
    _rename_initial.metadata = {'url': '/sqlScripts/{sqlScriptName}/rename'}  # type: ignore
    ...
    begin_rename.metadata = {'url': '/sqlScripts/{sqlScriptName}/rename'}  # type: ignore
