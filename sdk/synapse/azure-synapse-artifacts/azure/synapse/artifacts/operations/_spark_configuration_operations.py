...
def build_create_or_update_spark_configuration_request_initial(
    ...
    *,
    json: Optional[_models.SparkConfigurationResource] = None,
    content: Any = None,
...
class SparkConfigurationOperations:
    ...
    def begin_create_or_update_spark_configuration(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._create_or_update_spark_configuration_initial(  # type: ignore
                spark_configuration_name=spark_configuration_name,
    ...
    @distributed_trace
    def begin_delete_spark_configuration(  # pylint: disable=inconsistent-return-statements
        self,
        spark_configuration_name: str,
        **kwargs: Any
    ) -> LROPoller[None]:
    ...
    @distributed_trace
    def begin_rename_spark_configuration(  # pylint: disable=inconsistent-return-statements
        self,
        spark_configuration_name: str,
        new_name: Optional[str] = None,
        **kwargs: Any
