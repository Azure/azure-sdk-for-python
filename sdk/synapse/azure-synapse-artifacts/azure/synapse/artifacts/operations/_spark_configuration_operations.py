...
class SparkConfigurationOperations(object):
    ...
    def get_spark_configurations_by_workspace(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.synapse.artifacts.models.SparkConfigurationListResponse]
    ...
    def begin_create_or_update_spark_configuration(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns either SparkConfigurationResource or the result of cls(response)
