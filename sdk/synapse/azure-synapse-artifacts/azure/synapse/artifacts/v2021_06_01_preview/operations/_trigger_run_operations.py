...
class TriggerRunOperations(object):
    ...
    def query_trigger_runs_by_workspace(
        ...
        **kwargs  # type: Any
        ...
        :type filter_parameters: ~azure.synapse.artifacts.v2021_06_01_preview.models.RunFilterParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: TriggerRunsQueryResponse, or the result of cls(response)
        :rtype: ~azure.synapse.artifacts.v2021_06_01_preview.models.TriggerRunsQueryResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
