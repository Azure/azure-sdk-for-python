...
class KqlScriptsOperations:
    """KqlScriptsOperations async operations.
    ...
    def get_all(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either KqlScriptsResourceCollectionResponse or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.synapse.artifacts.v2021_06_01_preview.models.KqlScriptsResourceCollectionResponse]
