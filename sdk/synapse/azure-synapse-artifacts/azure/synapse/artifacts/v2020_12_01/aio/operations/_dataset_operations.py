...
class DatasetOperations:
    ...
    def get_datasets_by_workspace(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.synapse.artifacts.v2020_12_01.models.DatasetListResponse]
    ...
    async def begin_create_or_update_dataset(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.synapse.artifacts.v2020_12_01.models.Dataset
        ...
        :return: An instance of AsyncLROPoller that returns either DatasetResource or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.synapse.artifacts.v2020_12_01.models.DatasetResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_dataset(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.synapse.artifacts.v2020_12_01.models.DatasetResource or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.DatasetResource"]]
        error_map = {
    ...
    async def begin_delete_dataset(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._delete_dataset_initial(
                dataset_name=dataset_name,
                cls=lambda x,y,z: x,
                **kwargs
            )
    ...
    async def begin_rename_dataset(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._rename_dataset_initial(
                dataset_name=dataset_name,
                new_name=new_name,
                cls=lambda x,y,z: x,
                **kwargs
