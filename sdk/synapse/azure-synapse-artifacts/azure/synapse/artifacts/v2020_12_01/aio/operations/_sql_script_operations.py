...
class SqlScriptOperations:
    ...
    def get_sql_scripts_by_workspace(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.SqlScriptsListResponse"]:
        """Lists sql scripts.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either SqlScriptsListResponse or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.synapse.artifacts.v2020_12_01.models.SqlScriptsListResponse]
    ...
    async def begin_create_or_update_sql_script(
        ...
        **kwargs: Any
        ...
        :type sql_script: ~azure.synapse.artifacts.v2020_12_01.models.SqlScriptResource
        ...
        :return: An instance of AsyncLROPoller that returns either SqlScriptResource or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.synapse.artifacts.v2020_12_01.models.SqlScriptResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_sql_script(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.synapse.artifacts.v2020_12_01.models.SqlScriptResource or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.SqlScriptResource"]]
        error_map = {
    ...
    async def _delete_sql_script_initial(
        ...
        **kwargs: Any
        ...
        # Construct URL
        url = self._delete_sql_script_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'endpoint': self._serialize.url("self._config.endpoint", self._config.endpoint, 'str', skip_quote=True),
            'sqlScriptName': self._serialize.url("sql_script_name", sql_script_name, 'str'),
        }
    ...
    async def begin_delete_sql_script(
        self,
        sql_script_name: str,
        **kwargs: Any
    ) -> AsyncLROPoller[None]:
