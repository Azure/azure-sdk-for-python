...
class DataFlowDebugSessionOperations:
    ...
    async def _create_data_flow_debug_session_initial(
        self, request: "_models.CreateDataFlowDebugSessionRequest", **kwargs: Any
    ...
    async def begin_create_data_flow_debug_session(
        ...
        if cont_token is None:
            raw_result = await self._create_data_flow_debug_session_initial(
                request=request, cls=lambda x, y, z: x, **kwargs
            )
    ...
    async def add_data_flow(
        self, request: "_models.DataFlowDebugPackage", **kwargs: Any
    ...
    async def delete_data_flow_debug_session(
        self, request: "_models.DeleteDataFlowDebugSessionRequest", **kwargs: Any
    ) -> None:
    ...
    async def _execute_command_initial(
        self, request: "_models.DataFlowDebugCommandRequest", **kwargs: Any
    ...
    async def begin_execute_command(
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._execute_command_initial(request=request, cls=lambda x, y, z: x, **kwargs)
