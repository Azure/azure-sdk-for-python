...
class DataFlowOperations:
    ...
    async def begin_create_or_update_data_flow(
        ...
        if cont_token is None:
            raw_result = await self._create_or_update_data_flow_initial(
                data_flow_name=data_flow_name, properties=properties, if_match=if_match, cls=lambda x, y, z: x, **kwargs
            )
    ...
    async def _delete_data_flow_initial(self, data_flow_name: str, **kwargs: Any) -> None:
    ...
    async def begin_rename_data_flow(
        ...
        if cont_token is None:
            raw_result = await self._rename_data_flow_initial(
                data_flow_name=data_flow_name, new_name=new_name, cls=lambda x, y, z: x, **kwargs
            )
    ...
    def get_data_flows_by_workspace(self, **kwargs: Any) -> AsyncIterable["_models.DataFlowListResponse"]:
        """Lists data flows.
