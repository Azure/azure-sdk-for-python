...
class LinkedServicesOperations:
    ...
    async def _rename_initial(
        ...
        **kwargs
        ...
        _request = models.ArtifactRenameRequest(new_name=new_name)
    ...
    _rename_initial.metadata = {'url': '/linkedservices/{linkedServiceName}/rename'}  # type: ignore
    ...
    begin_rename.metadata = {'url': '/linkedservices/{linkedServiceName}/rename'}  # type: ignore
