...
class LinkConnectionOperations:
    ...
    @distributed_trace
    def list_link_connections_by_workspace(self, **kwargs: Any) -> AsyncIterable["_models.LinkConnectionResource"]:
    ...
    @distributed_trace_async
    async def get_link_connection(self, link_connection_name: str, **kwargs: Any) -> _models.LinkConnectionResource:
    ...
    @distributed_trace_async
    async def delete_link_connection(  # pylint: disable=inconsistent-return-statements
