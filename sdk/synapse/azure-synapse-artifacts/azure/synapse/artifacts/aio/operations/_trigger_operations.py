...
class TriggerOperations:
    ...
    def get_triggers_by_workspace(self, **kwargs: Any) -> AsyncIterable["_models.TriggerListResponse"]:
        """Lists triggers.
    ...
    async def begin_create_or_update_trigger(
        ...
        if cont_token is None:
            raw_result = await self._create_or_update_trigger_initial(
                trigger_name=trigger_name, properties=properties, if_match=if_match, cls=lambda x, y, z: x, **kwargs
            )
    ...
    async def _delete_trigger_initial(self, trigger_name: str, **kwargs: Any) -> None:
    ...
    async def begin_delete_trigger(self, trigger_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._delete_trigger_initial(trigger_name=trigger_name, cls=lambda x, y, z: x, **kwargs)
    ...
    async def _start_trigger_initial(self, trigger_name: str, **kwargs: Any) -> None:
        cls = kwargs.pop("cls", None)  # type: ClsType[None]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    async def begin_start_trigger(self, trigger_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._start_trigger_initial(trigger_name=trigger_name, cls=lambda x, y, z: x, **kwargs)
    ...
    async def _stop_trigger_initial(self, trigger_name: str, **kwargs: Any) -> None:
        cls = kwargs.pop("cls", None)  # type: ClsType[None]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
    ...
    async def begin_stop_trigger(self, trigger_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._stop_trigger_initial(trigger_name=trigger_name, cls=lambda x, y, z: x, **kwargs)
