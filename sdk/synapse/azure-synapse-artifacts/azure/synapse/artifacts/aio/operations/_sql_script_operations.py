...
from ...operations._sql_script_operations import build_create_or_update_sql_script_request_initial, build_delete_sql_script_request_initial, build_get_sql_script_request, build_get_sql_scripts_by_workspace_request, build_rename_sql_script_request_initial
T = TypeVar('T')
...
class SqlScriptOperations:
    ...
    async def begin_create_or_update_sql_script(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._create_or_update_sql_script_initial(  # type: ignore
                sql_script_name=sql_script_name,
    ...
    @distributed_trace_async
    async def begin_delete_sql_script(  # pylint: disable=inconsistent-return-statements
        self,
        sql_script_name: str,
        **kwargs: Any
    ) -> AsyncLROPoller[None]:
    ...
    @distributed_trace_async
    async def begin_rename_sql_script(  # pylint: disable=inconsistent-return-statements
        self,
        sql_script_name: str,
        new_name: Optional[str] = None,
        **kwargs: Any
