...
from ...operations._credential_operations import (
...
class CredentialOperations:
    ...
    @distributed_trace
    def list_by_workspace(self, **kwargs: Any) -> AsyncIterable["_models.ManagedIdentityCredentialResource"]:
        """Lists credentials.
        ...
        :return: An iterator like instance of either ManagedIdentityCredentialResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.synapse.artifacts.models.ManagedIdentityCredentialResource]
    ...
    async def begin_create_or_update(
        ...
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> AsyncLROPoller[_models.ManagedIdentityCredentialResource]:
        ...
        :return: An instance of AsyncLROPoller that returns either ManagedIdentityCredentialResource or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.synapse.artifacts.models.ManagedIdentityCredentialResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace_async
    async def get(
        self, credential_name: str, if_none_match: Optional[str] = None, **kwargs: Any
    ) -> Optional[_models.ManagedIdentityCredentialResource]:
        """Gets a credential.
        ...
        :rtype: ~azure.synapse.artifacts.models.ManagedIdentityCredentialResource or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, credential_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    @distributed_trace_async
    async def begin_delete(self, credential_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
