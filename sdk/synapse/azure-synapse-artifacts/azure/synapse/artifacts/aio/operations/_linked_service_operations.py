...
class LinkedServiceOperations:
    ...
    def get_linked_services_by_workspace(self, **kwargs: Any) -> AsyncIterable["_models.LinkedServiceListResponse"]:
    ...
    async def _delete_linked_service_initial(self, linked_service_name: str, **kwargs: Any) -> None:
    ...
    async def begin_rename_linked_service(
        ...
        if cont_token is None:
            raw_result = await self._rename_linked_service_initial(
                linked_service_name=linked_service_name, new_name=new_name, cls=lambda x, y, z: x, **kwargs
            )
