...
from ...rest import operation_result as rest_operation_result
...
class OperationResultOperations:
    ...
    async def get(self, operation_id: str, **kwargs: Any) -> None:
        ...
        request = rest_operation_result.build_get_request(
    ...
    get.metadata = {"url": "/operationResults/{operationId}"}  # type: ignore
