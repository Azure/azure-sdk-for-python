...
class NotebookOperations:
    ...
    @distributed_trace
    def get_notebooks_by_workspace(self, **kwargs: Any) -> AsyncIterable["_models.NotebookResourceAutoGenerated"]:
        """Lists Notebooks.
        ...
        :return: An iterator like instance of either NotebookResourceAutoGenerated or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.synapse.artifacts.models.NotebookResourceAutoGenerated]
    ...
    def get_notebook_summary_by_work_space(
        self, **kwargs: Any
    ) -> AsyncIterable["_models.NotebookResourceAutoGenerated"]:
    ...
    async def begin_create_or_update_notebook(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.NotebookResourceAutoGenerated]:
        ...
        :return: An instance of AsyncLROPoller that returns either NotebookResourceAutoGenerated or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.synapse.artifacts.models.NotebookResourceAutoGenerated]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
