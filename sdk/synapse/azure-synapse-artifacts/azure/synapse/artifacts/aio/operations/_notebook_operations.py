...
class NotebookOperations:
    ...
    def get_notebooks_by_workspace(self, **kwargs: Any) -> AsyncIterable["_models.NotebookListResponse"]:
        """Lists Notebooks.
    ...
    def get_notebook_summary_by_work_space(self, **kwargs: Any) -> AsyncIterable["_models.NotebookListResponse"]:
    ...
    async def _create_or_update_notebook_initial(
        self, notebook_name: str, notebook: "_models.NotebookResource", *, if_match: Optional[str] = None, **kwargs: Any
    ...
    async def begin_create_or_update_notebook(
        ...
        if cont_token is None:
            raw_result = await self._create_or_update_notebook_initial(
                notebook_name=notebook_name, notebook=notebook, if_match=if_match, cls=lambda x, y, z: x, **kwargs
            )
    ...
    async def _delete_notebook_initial(self, notebook_name: str, **kwargs: Any) -> None:
    ...
    async def begin_delete_notebook(self, notebook_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
        ...
        if cont_token is None:
            raw_result = await self._delete_notebook_initial(
                notebook_name=notebook_name, cls=lambda x, y, z: x, **kwargs
            )
    ...
    async def begin_rename_notebook(
        ...
        if cont_token is None:
            raw_result = await self._rename_notebook_initial(
                notebook_name=notebook_name, new_name=new_name, cls=lambda x, y, z: x, **kwargs
            )
