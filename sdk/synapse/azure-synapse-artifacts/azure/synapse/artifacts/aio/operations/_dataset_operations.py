...
class DatasetOperations:
    ...
    def get_datasets_by_workspace(self, **kwargs: Any) -> AsyncIterable["_models.DatasetListResponse"]:
        """Lists datasets.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either DatasetListResponse or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.synapse.artifacts.models.DatasetListResponse]
    ...
    async def begin_create_or_update_dataset(
        ...
        if cont_token is None:
            raw_result = await self._create_or_update_dataset_initial(
                dataset_name=dataset_name, properties=properties, if_match=if_match, cls=lambda x, y, z: x, **kwargs
            )
    ...
    async def _delete_dataset_initial(self, dataset_name: str, **kwargs: Any) -> None:
    ...
    async def begin_delete_dataset(self, dataset_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._delete_dataset_initial(dataset_name=dataset_name, cls=lambda x, y, z: x, **kwargs)
    ...
    async def begin_rename_dataset(
        ...
        if cont_token is None:
            raw_result = await self._rename_dataset_initial(
                dataset_name=dataset_name, new_name=new_name, cls=lambda x, y, z: x, **kwargs
            )
