...
class DatasetOperations:
    ...
    async def begin_create_or_update_dataset(
        ...
        if cont_token:
            return AsyncLROPoller[_models.DatasetResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.DatasetResource](
    ...
    async def _delete_dataset_initial(self, dataset_name: str, **kwargs: Any) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
