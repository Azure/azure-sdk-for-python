...
class DatasetOperations:
    ...
    async def begin_create_or_update_dataset(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._create_or_update_dataset_initial(  # type: ignore
                dataset_name=dataset_name,
    ...
    @distributed_trace_async
    async def begin_delete_dataset(  # pylint: disable=inconsistent-return-statements
        self,
        dataset_name: str,
        **kwargs: Any
    ) -> AsyncLROPoller[None]:
    ...
    @distributed_trace_async
    async def begin_rename_dataset(  # pylint: disable=inconsistent-return-statements
        self,
        dataset_name: str,
        new_name: Optional[str] = None,
        **kwargs: Any
