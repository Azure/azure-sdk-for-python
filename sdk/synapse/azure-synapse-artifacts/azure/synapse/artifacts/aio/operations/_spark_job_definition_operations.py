...
from ...rest import spark_job_definition as rest_spark_job_definition
...
class SparkJobDefinitionOperations:
    ...
    def get_spark_job_definitions_by_workspace(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = rest_spark_job_definition.build_get_spark_job_definitions_by_workspace_request(
                    template_url=self.get_spark_job_definitions_by_workspace.metadata["url"], **kwargs
                )._internal_request
    ...
    async def _create_or_update_spark_job_definition_initial(
        ...
        **kwargs: Any
        ...
        json = self._serialize.body(_spark_job_definition, "object")

        request = rest_spark_job_definition.build_create_or_update_spark_job_definition_request_initial(
    ...
    async def begin_create_or_update_spark_job_definition(
        ...
        **kwargs: Any
        ...
        :keyword properties: Properties of spark job definition.
        :paramtype properties: ~azure.synapse.artifacts.models.SparkJobDefinition
    ...
    async def get_spark_job_definition(
        ...
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        request = rest_spark_job_definition.build_get_spark_job_definition_request(
            spark_job_definition_name=spark_job_definition_name,
    ...
    async def _delete_spark_job_definition_initial(self, spark_job_definition_name: str, **kwargs: Any) -> None:
        cls = kwargs.pop("cls", None)  # type: ClsType[None]
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        request = rest_spark_job_definition.build_delete_spark_job_definition_request_initial(
            spark_job_definition_name=spark_job_definition_name,
    ...
    async def begin_delete_spark_job_definition(
        ...
        if cont_token is None:
            raw_result = await self._delete_spark_job_definition_initial(
                spark_job_definition_name=spark_job_definition_name, cls=lambda x, y, z: x, **kwargs
            )
    ...
    async def _execute_spark_job_definition_initial(
        ...
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}))
        request = rest_spark_job_definition.build_execute_spark_job_definition_request_initial(
            spark_job_definition_name=spark_job_definition_name,
    ...
    async def _rename_spark_job_definition_initial(
        ...
        request = rest_spark_job_definition.build_rename_spark_job_definition_request_initial(
            spark_job_definition_name=spark_job_definition_name,
            json=json,
            content_type=content_type,
    ...
    async def begin_rename_spark_job_definition(
        ...
        if cont_token is None:
            raw_result = await self._rename_spark_job_definition_initial(
                spark_job_definition_name=spark_job_definition_name, new_name=new_name, cls=lambda x, y, z: x, **kwargs
            )
    ...
    async def _debug_spark_job_definition_initial(
        ...
        json = self._serialize.body(_spark_job_definition_azure_resource, "object")

        request = rest_spark_job_definition.build_debug_spark_job_definition_request_initial(
            json=json,
            content_type=content_type,
