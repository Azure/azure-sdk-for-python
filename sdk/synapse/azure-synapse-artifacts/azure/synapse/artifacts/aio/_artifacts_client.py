...
from azure.synapse.artifacts.core.rest import AsyncHttpResponse, HttpRequest, _AsyncStreamContextManager
...
class ArtifactsClient(object):
    ...
    async def send_request(self, request: HttpRequest, **kwargs: Any) -> AsyncHttpResponse:
        ...
        :rtype: ~azure.synapse.artifacts.core.rest.AsyncHttpResponse
        """
