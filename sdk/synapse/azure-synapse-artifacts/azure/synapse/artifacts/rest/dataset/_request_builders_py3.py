...
def build_create_or_update_dataset_request_initial(
    dataset_name: str, *, json: Any = None, content: Any = None, if_match: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
...
def build_delete_dataset_request_initial(dataset_name: str, **kwargs: Any) -> HttpRequest:
    """Deletes a dataset.
...
def build_rename_dataset_request_initial(
    dataset_name: str, *, json: Any = None, content: Any = None, **kwargs: Any
) -> HttpRequest:
    """Renames a dataset.
