...
def build_create_or_update_pipeline_request_initial(
    pipeline_name: str, *, json: Any = None, content: Any = None, if_match: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
...
def build_delete_pipeline_request_initial(pipeline_name: str, **kwargs: Any) -> HttpRequest:
    """Deletes a pipeline.
...
def build_rename_pipeline_request_initial(
    pipeline_name: str, *, json: Any = None, content: Any = None, **kwargs: Any
) -> HttpRequest:
    """Renames a pipeline.
...
def build_create_pipeline_run_request(
    ...
    **kwargs: Any
    ...
    if reference_pipeline_run_id is not None:
        query_parameters["referencePipelineRunId"] = _SERIALIZER.query(
