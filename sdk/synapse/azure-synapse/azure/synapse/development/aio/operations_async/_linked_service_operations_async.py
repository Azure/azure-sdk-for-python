...
class LinkedServiceOperations:
    ...
    :type models: ~azure.synapse.development.models
    ...
    def get_linked_services_by_workspace(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.synapse.development.models.LinkedServiceListResponse]
    ...
    async def create_or_update_linked_service(
        ...
        **kwargs
        ...
        :type properties: ~azure.synapse.development.models.LinkedService
        ...
        :rtype: ~azure.synapse.development.models.LinkedServiceResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_linked_service(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: LinkedServiceResource, or the result of cls(response)
        :rtype: ~azure.synapse.development.models.LinkedServiceResource or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.LinkedServiceResource"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
