...
class DataFlowDebugSessionOperations:
    ...
    async def create_data_flow_debug_session(
        self,
        request: "models.CreateDataFlowDebugSessionRequest",
        **kwargs
    ) -> "models.CreateDataFlowDebugSessionResponse":
        ...
        :rtype: ~azure.synapse.development.models.CreateDataFlowDebugSessionResponse
    ...
    create_data_flow_debug_session.metadata = {'url': '/createDataFlowDebugSession'}  # type: ignore
    ...
    def query_data_flow_debug_sessions_by_workspace(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.synapse.development.models.QueryDataFlowDebugSessionsResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def execute_command(
        ...
        **kwargs
        ...
        :rtype: ~azure.synapse.development.models.DataFlowDebugCommandResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', False)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DataFlowDebugCommandResponse"]
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    execute_command.metadata = {'url': '/executeDataFlowDebugCommand'}  # type: ignore
