...
class TriggerOperations:
    ...
    def get_triggers_by_workspace(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.synapse.development.models.TriggerListResponse]
    ...
    async def subscribe_trigger_to_events(
        self,
        trigger_name: str,
        **kwargs
    ) -> "models.TriggerSubscriptionOperationStatus":
    ...
    subscribe_trigger_to_events.metadata = {'url': '/triggers/{triggerName}/subscribeToEvents'}  # type: ignore
    ...
    async def unsubscribe_trigger_from_events(
        self,
        trigger_name: str,
        **kwargs
    ) -> "models.TriggerSubscriptionOperationStatus":
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    unsubscribe_trigger_from_events.metadata = {'url': '/triggers/{triggerName}/unsubscribeFromEvents'}  # type: ignore
    ...
    async def start_trigger(
        ...
        **kwargs
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    start_trigger.metadata = {'url': '/triggers/{triggerName}/start'}  # type: ignore
    ...
    async def stop_trigger(
        ...
        **kwargs
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    stop_trigger.metadata = {'url': '/triggers/{triggerName}/stop'}  # type: ignore
