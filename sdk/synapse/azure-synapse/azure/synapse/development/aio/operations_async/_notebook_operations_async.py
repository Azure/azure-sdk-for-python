...
class NotebookOperations:
    ...
    def get_notebooks_by_workspace(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.synapse.development.models.NotebookListResponse]
    ...
    async def create_or_update_notebook(
        ...
        **kwargs
        ...
        :rtype: ~azure.synapse.development.models.NotebookResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_notebook(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NotebookResource, or the result of cls(response)
        :rtype: ~azure.synapse.development.models.NotebookResource or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.NotebookResource"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
