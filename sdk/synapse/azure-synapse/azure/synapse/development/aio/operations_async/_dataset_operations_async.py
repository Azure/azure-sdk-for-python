...
class DatasetOperations:
    ...
    def get_datasets_by_workspace(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.synapse.development.models.DatasetListResponse]
    ...
    async def create_or_update_dataset(
        ...
        **kwargs
        ...
        :rtype: ~azure.synapse.development.models.DatasetResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_dataset(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DatasetResource, or the result of cls(response)
        :rtype: ~azure.synapse.development.models.DatasetResource or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DatasetResource"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
