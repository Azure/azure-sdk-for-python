...
class SparkJobDefinitionOperations:
    ...
    def get_spark_job_definitions_by_workspace(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.synapse.development.models.SparkJobDefinitionsListResponse]
    ...
    async def create_or_update_spark_job_definition(
        ...
        **kwargs
        ...
        :rtype: ~azure.synapse.development.models.SparkJobDefinitionResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_spark_job_definition(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SparkJobDefinitionResource, or the result of cls(response)
        :rtype: ~azure.synapse.development.models.SparkJobDefinitionResource or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SparkJobDefinitionResource"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
    ...
    async def execute_spark_job_definition(
        self,
        spark_job_definition_name: str,
        **kwargs
    ) -> "models.SparkBatchJob":
        ...
        :rtype: ~azure.synapse.development.models.SparkBatchJob
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    execute_spark_job_definition.metadata = {'url': '/sparkJobDefinitions/{sparkJobDefinitionName}/execute'}  # type: ignore
    ...
    async def debug_spark_job_definition(
        self,
        properties: "models.SparkJobDefinition",
        **kwargs
    ) -> "models.SparkBatchJob":
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    debug_spark_job_definition.metadata = {'url': '/debugSparkJobDefinition'}  # type: ignore
