...
from ._configuration_async import DevelopmentClientConfiguration
...
class DevelopmentClient(object):
    ...
    :vartype linked_service: azure.synapse.development.aio.operations_async.LinkedServiceOperations
    :ivar dataset: DatasetOperations operations
    :vartype dataset: azure.synapse.development.aio.operations_async.DatasetOperations
    :ivar pipeline: PipelineOperations operations
    :vartype pipeline: azure.synapse.development.aio.operations_async.PipelineOperations
    :ivar pipeline_run: PipelineRunOperations operations
    :vartype pipeline_run: azure.synapse.development.aio.operations_async.PipelineRunOperations
    :ivar trigger: TriggerOperations operations
    :vartype trigger: azure.synapse.development.aio.operations_async.TriggerOperations
    :ivar trigger_run: TriggerRunOperations operations
    :vartype trigger_run: azure.synapse.development.aio.operations_async.TriggerRunOperations
    :ivar data_flow: DataFlowOperations operations
    :vartype data_flow: azure.synapse.development.aio.operations_async.DataFlowOperations
    :ivar data_flow_debug_session: DataFlowDebugSessionOperations operations
    :vartype data_flow_debug_session: azure.synapse.development.aio.operations_async.DataFlowDebugSessionOperations
    :ivar sql_script: SqlScriptOperations operations
    :vartype sql_script: azure.synapse.development.aio.operations_async.SqlScriptOperations
    :ivar spark_job_definition: SparkJobDefinitionOperations operations
    :vartype spark_job_definition: azure.synapse.development.aio.operations_async.SparkJobDefinitionOperations
    :ivar notebook: NotebookOperations operations
    :vartype notebook: azure.synapse.development.aio.operations_async.NotebookOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        base_url = '{endpoint}'
        self._config = DevelopmentClientConfiguration(credential, endpoint, **kwargs)
    ...
    async def __aenter__(self) -> "DevelopmentClient":
