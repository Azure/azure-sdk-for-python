...
class SqlScriptOperations(object):
    ...
    def get_sql_scripts_by_workspace(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.synapse.development.models.SqlScriptsListResponse]
    ...
    def create_or_update_sql_script(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.synapse.development.models.SqlScriptResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_sql_script(
        ...
        **kwargs  # type: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SqlScriptResource, or the result of cls(response)
        :rtype: ~azure.synapse.development.models.SqlScriptResource or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SqlScriptResource"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
