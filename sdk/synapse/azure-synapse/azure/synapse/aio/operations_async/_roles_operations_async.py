...
class RolesOperations:
    ...
    def list_roles(
        ...
        **kwargs
        ...
        :rtype: ~azure.synapse.models.RolesListResponse
        ...
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.list_roles.metadata['url']
    ...
    list_roles.metadata = {'url': '/rbac/roles'}
    ...
    async def get_role_by_id(
        ...
        **kwargs
        ...
        :rtype: ~azure.synapse.models.SynapseRole
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        # Construct URL
        url = self.get_role_by_id.metadata['url']
        path_format_arguments = {
            'SynapseDnsSuffix': self._serialize.url("self._config.synapse_dns_suffix", self._config.synapse_dns_suffix, 'str', skip_quote=True),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str', skip_quote=True),
        ...
        return deserialized
    get_role_by_id.metadata = {'url': '/rbac/roles/{roleId}'}
