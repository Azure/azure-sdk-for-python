...
class SparkJobDefinitionsOperations:
    ...
    def list_by_workspace(
        ...
        workspace_name: str,
        **kwargs
    ) -> "models.SparkJobDefinitionsListResponse":
    ...
    execute.metadata = {'url': '/sparkJobDefinitions/{sparkJobDefinitionName}/execute'}

    async def _debug_initial(
        self,
        workspace_name: str,
        properties: "models.SparkJobDefinition",
        **kwargs
    ...
    async def debug(
        ...
        **kwargs
        ...
        polling = kwargs.pop('polling', False)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ExtendedLivyBatchResponse"]
        raw_result = await self._debug_initial(
            workspace_name=workspace_name,
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    debug.metadata = {'url': '/debugSparkJobDefinition'}
