...
class PipelineRunsOperations:
    ...
    async def query_by_workspace(
        ...
        **kwargs
        ...
        :rtype: ~azure.synapse.models.PipelineRunsQueryResponse
        ...
        return deserialized
    query_by_workspace.metadata = {'url': '/queryPipelineRuns'}
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.synapse.models.PipelineRun
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        return deserialized
    get.metadata = {'url': '/pipelineruns/{runId}'}
    ...
    cancel.metadata = {'url': '/pipelineruns/{runId}/cancel'}
