...
from .operations_async import RolesOperations
...
class SynapseClient(object):
    ...
    :vartype roles: azure.synapse.aio.operations_async.RolesOperations
    :ivar role_assignments: RoleAssignmentsOperations operations
    :vartype role_assignments: azure.synapse.aio.operations_async.RoleAssignmentsOperations
