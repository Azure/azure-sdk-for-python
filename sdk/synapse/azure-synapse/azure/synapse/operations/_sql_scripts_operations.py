...
class SqlScriptsOperations(object):
    ...
    def list_by_workspace(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.SqlScriptsListResponse"
        """Lists sql scripts.

        :param workspace_name: The name of the workspace to execute operations on.
        :type workspace_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SqlScriptsListResponse or the result of cls(response)
        :rtype: ~azure.synapse.models.SqlScriptsListResponse
    ...
    list_by_workspace.metadata = {'url': '/sqlScripts'}
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.synapse.models.SqlScriptResource
        ...
        return deserialized
    create_or_update.metadata = {'url': '/sqlScripts/{sqlScriptName}'}
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SqlScriptResource or the result of cls(response)
        :rtype: ~azure.synapse.models.SqlScriptResource or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SqlScriptResource"]
        error_map = kwargs.pop('error_map', {})
        ...
        return deserialized
    get.metadata = {'url': '/sqlScripts/{sqlScriptName}'}
    ...
    delete.metadata = {'url': '/sqlScripts/{sqlScriptName}'}
