...
from ...operations._role_assignments_operations import build_check_principal_access_request, build_create_role_assignment_request, build_delete_role_assignment_by_id_request, build_get_role_assignment_by_id_request, build_list_role_assignments_request
T = TypeVar('T')
...
class RoleAssignmentsOperations:
    ...
    def list_role_assignments(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.RoleAssignmentDetailsList"]:
        ...
        :return: An iterator like instance of either RoleAssignmentDetailsList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.synapse.accesscontrol.models.RoleAssignmentDetailsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-12-01")  # type: str
