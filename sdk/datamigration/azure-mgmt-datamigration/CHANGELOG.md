...
### Features Added
  ...
  - Model `DatabaseMigrationCosmosDbMongo` added property `properties`
  - Model `ResourceSkuRestrictions` added property `values_property`

### Breaking Changes

  - Model `DatabaseMigrationCosmosDbMongo` deleted or renamed its instance variable `kind`
  - Model `DatabaseMigrationCosmosDbMongo` deleted or renamed its instance variable `scope`
  - Model `DatabaseMigrationCosmosDbMongo` deleted or renamed its instance variable `provisioning_state`
  - Model `DatabaseMigrationCosmosDbMongo` deleted or renamed its instance variable `migration_status`
  - Model `DatabaseMigrationCosmosDbMongo` deleted or renamed its instance variable `started_on`
  - Model `DatabaseMigrationCosmosDbMongo` deleted or renamed its instance variable `ended_on`
  - Model `DatabaseMigrationCosmosDbMongo` deleted or renamed its instance variable `migration_service`
  - Model `DatabaseMigrationCosmosDbMongo` deleted or renamed its instance variable `migration_operation_id`
  - Model `DatabaseMigrationCosmosDbMongo` deleted or renamed its instance variable `migration_failure_error`
  - Model `DatabaseMigrationCosmosDbMongo` deleted or renamed its instance variable `provisioning_error`
  - Model `DatabaseMigrationCosmosDbMongo` deleted or renamed its instance variable `source_mongo_connection`
  - Model `DatabaseMigrationCosmosDbMongo` deleted or renamed its instance variable `target_mongo_connection`
  - Model `DatabaseMigrationCosmosDbMongo` deleted or renamed its instance variable `collection_list`
  - Model `ResourceSkuRestrictions` deleted or renamed its instance variable `values`
  - Deleted or renamed model `DataItemMigrationSummaryResult`
  - Deleted or renamed model `DataMigrationError`
  - Deleted or renamed model `DataMigrationProjectMetadata`
  - Deleted or renamed model `DataMigrationResultCode`
  - Deleted or renamed model `DataMigrationServiceList`
  - Deleted or renamed model `Database`
  - Deleted or renamed model `DatabaseFileInput`
  - Deleted or renamed model `DatabaseObjectName`
  - Deleted or renamed model `DatabaseSummaryResult`
  - Deleted or renamed model `ErrorType`
  - Deleted or renamed model `FileList`
  - Deleted or renamed model `GetProjectDetailsNonSqlTaskInput`
  - Deleted or renamed model `MigrateSqlServerDatabaseInput`
  - Deleted or renamed model `MigrationTableMetadata`
  - Deleted or renamed model `MigrationValidationDatabaseLevelResult`
  - Deleted or renamed model `NonSqlDataMigrationTable`
  - Deleted or renamed model `NonSqlDataMigrationTableResult`
  - Deleted or renamed model `NonSqlMigrationTaskInput`
  - Deleted or renamed model `NonSqlMigrationTaskOutput`
  - Deleted or renamed model `ProjectList`
  - Deleted or renamed model `ProxyResourceAutoGenerated`
  - Deleted or renamed model `QuotaList`
  - Deleted or renamed model `ResourceAutoGenerated`
  - Deleted or renamed model `ResourceSkusResult`
  - Deleted or renamed model `ServiceOperation`
  - Deleted or renamed model `ServiceOperationDisplay`
  - Deleted or renamed model `ServiceOperationList`
  - Deleted or renamed model `ServiceSkuList`
  - Deleted or renamed model `StartMigrationScenarioServerRoleResult`
  - Deleted or renamed model `SystemDataAutoGenerated`
  - Deleted or renamed model `TaskList`
  ...
  - Method `DatabaseMigrationsSqlDbOperations.get` changed its parameter `migration_operation_id` from `positional_or_keyword` to `keyword_only`
  - Method `DatabaseMigrationsSqlDbOperations.get` changed its parameter `expand` from `positional_or_keyword` to `keyword_only`
  ...
  - Method `DatabaseMigrationsSqlMiOperations.get` changed its parameter `migration_operation_id` from `positional_or_keyword` to `keyword_only`
  - Method `DatabaseMigrationsSqlMiOperations.get` changed its parameter `expand` from `positional_or_keyword` to `keyword_only`
  ...
  - Method `DatabaseMigrationsSqlVmOperations.get` changed its parameter `migration_operation_id` from `positional_or_keyword` to `keyword_only`
  - Method `DatabaseMigrationsSqlVmOperations.get` changed its parameter `expand` from `positional_or_keyword` to `keyword_only`
