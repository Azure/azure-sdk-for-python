...
class Operations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ServiceOperationList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datamigration.models.ServiceOperationList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ServiceOperationList"]
        error_map = {
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('ServiceOperationList', pipeline_response)
