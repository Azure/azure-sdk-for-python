...
class ResourceSkusOperations:
    ...
    def list_skus(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datamigration.models.ResourceSkusResult]
    ...
    list_skus.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.DataMigration/skus'}  # type: ignore
