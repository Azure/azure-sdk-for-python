...
def build_list_request(location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DataMigration/locations/{location}/usages"
    )
...
class UsagesOperations:
    ...
    @distributed_trace
    def list(self, location: str, **kwargs: Any) -> ItemPaged["_models.Quota"]:
