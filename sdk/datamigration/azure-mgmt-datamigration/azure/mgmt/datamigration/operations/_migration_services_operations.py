...
class MigrationServicesOperations:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.MigrationService"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.MigrationService"]:
    ...
    ) -> ItemPaged["_models.DatabaseMigrationBase"]:
