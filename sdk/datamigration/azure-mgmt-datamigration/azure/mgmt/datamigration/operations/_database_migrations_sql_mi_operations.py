...
def build_get_request(
    ...
    **kwargs: Any
    ...
    if migration_operation_id is not None:
        _params["migrationOperationId"] = _SERIALIZER.query("migration_operation_id", migration_operation_id, "str")
...
def build_create_or_update_request(
    resource_group_name: str, managed_instance_name: str, target_db_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
