...
class Operations(object):
    ...
    def list(
        ...
        :return: An iterator like instance of ServiceOperation
        :rtype:
         ~azure.mgmt.datamigration.models.ServiceOperationPaged[~azure.mgmt.datamigration.models.ServiceOperation]
        :raises:
        ...
        deserialized = models.ServiceOperationPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ServiceOperationPaged(internal_paging, self._deserialize.dependencies, header_dict)
