...
def main():
    ...
    response = client.files.update(
        ...
        parameters={"properties": {"filePath": "DmsSdkFilePath/DmsSdkFile.sql"}},
    )
    print(response)


# x-ms-original-file: specification/datamigration/resource-manager/Microsoft.DataMigration/DataMigration/preview/2025-09-01-preview/examples/Files_Update.json
