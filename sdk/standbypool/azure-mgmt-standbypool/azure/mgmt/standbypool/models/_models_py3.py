...
class ContainerGroupInstanceCountSummary(_serialization.Model):
    ...
    _attribute_map = {
        ...
        "instance_counts_by_state": {"key": "instanceCountsByState", "type": "[PoolContainerGroupStateCount]"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword zone: The zone that the provided counts are in. It will not have a value if zones are
         not enabled.
        :paramtype zone: int
        :keyword instance_counts_by_state: The count of pooled container groups in each state for the
         given zone. Required.
...
class PoolContainerGroupStateCount(_serialization.Model):
    ...
    def __init__(self, *, state: Union[str, "_models.PoolContainerGroupState"], count: int, **kwargs: Any) -> None:
        """
        :keyword state: The state that the pooled container groups count is for. Required. Known values
         are: "Running", "Creating", and "Deleting".
        :paramtype state: str or ~azure.mgmt.standbypool.models.PoolContainerGroupState
        :keyword count: The count of pooled container groups in the given state. Required.
        :paramtype count: int
        """
        super().__init__(**kwargs)
        self.state = state
...
class PoolStatus(_serialization.Model):
...
class PoolVirtualMachineStateCount(_serialization.Model):
    ...
    def __init__(self, *, state: Union[str, "_models.PoolVirtualMachineState"], count: int, **kwargs: Any) -> None:
        """
        :keyword state: The state that the pooled virtual machines count is for. Required. Known values
         are: "Running", "Creating", "Starting", "Deleting", "Deallocated", "Deallocating",
         "Hibernated", and "Hibernating".
        :paramtype state: str or ~azure.mgmt.standbypool.models.PoolVirtualMachineState
        :keyword count: The count of pooled virtual machines in the given state. Required.
        :paramtype count: int
        """
        super().__init__(**kwargs)
        self.state = state
...
class StandbyContainerGroupPoolForecastValues(_serialization.Model):
    ...
    _validation = {
        "instances_requested_count": {"required": True, "readonly": True},
    }

    _attribute_map = {
        "instances_requested_count": {"key": "instancesRequestedCount", "type": "[int]"},
    }

    def __init__(self, **kwargs: Any) -> None:
        """ """
        super().__init__(**kwargs)
        self.instances_requested_count = None


class StandbyContainerGroupPoolPrediction(_serialization.Model):
    ...
    _validation = {
        "forecast_values": {"required": True, "readonly": True},
        "forecast_start_time": {"required": True, "readonly": True},
        "forecast_info": {"required": True, "readonly": True},
    }

    _attribute_map = {
        "forecast_values": {"key": "forecastValues", "type": "StandbyContainerGroupPoolForecastValues"},
        "forecast_start_time": {"key": "forecastStartTime", "type": "iso-8601"},
        "forecast_info": {"key": "forecastInfo", "type": "str"},
    }
...
class StandbyContainerGroupPoolResourceProperties(_serialization.Model):  # pylint: disable=name-too-long
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword zones: Specifies zones of standby container group pools.
...
class StandbyContainerGroupPoolRuntimeViewResourceProperties(_serialization.Model):  # pylint: disable=name-too-long
    ...
    _attribute_map = {
        ...
        "status": {"key": "status", "type": "PoolStatus"},
        "provisioning_state": {"key": "provisioningState", "type": "str"},
        "prediction": {"key": "prediction", "type": "StandbyContainerGroupPoolPrediction"},
    }
...
class StandbyVirtualMachinePoolForecastValues(_serialization.Model):
    """Displays the forecast information of the standby pool.
...
class StandbyVirtualMachinePoolPrediction(_serialization.Model):
    """Displays prediction information of the standby pool.
    ...
    _attribute_map = {
        "forecast_values": {"key": "forecastValues", "type": "StandbyVirtualMachinePoolForecastValues"},
        "forecast_start_time": {"key": "forecastStartTime", "type": "iso-8601"},
        "forecast_info": {"key": "forecastInfo", "type": "str"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype elasticity_profile:
         ~azure.mgmt.standbypool.models.StandbyVirtualMachinePoolElasticityProfile
        :keyword virtual_machine_state: Specifies the desired state of virtual machines in the pool.
         Known values are: "Running", "Deallocated", and "Hibernated".
        :paramtype virtual_machine_state: str or ~azure.mgmt.standbypool.models.VirtualMachineState
        :keyword attached_virtual_machine_scale_set_id: Specifies the fully qualified resource ID of a
         virtual machine scale set the pool is attached to.
        :paramtype attached_virtual_machine_scale_set_id: str
...
class StandbyVirtualMachinePoolRuntimeViewResourceProperties(_serialization.Model):  # pylint: disable=name-too-long
    ...
    _attribute_map = {
        ...
        "status": {"key": "status", "type": "PoolStatus"},
        "provisioning_state": {"key": "provisioningState", "type": "str"},
        "prediction": {"key": "prediction", "type": "StandbyVirtualMachinePoolPrediction"},
    }
...
class VirtualMachineInstanceCountSummary(_serialization.Model):
    ...
    _attribute_map = {
        "zone": {"key": "zone", "type": "int"},
        "instance_counts_by_state": {"key": "instanceCountsByState", "type": "[PoolVirtualMachineStateCount]"},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword zone: The zone that the provided counts are in. It will not have a value if zones are
         not enabled on the attached VMSS.
        :paramtype zone: int
        :keyword instance_counts_by_state: The count of pooled virtual machines in each state for the
         given zone. Required.
        :paramtype instance_counts_by_state:
         list[~azure.mgmt.standbypool.models.PoolVirtualMachineStateCount]
        """
