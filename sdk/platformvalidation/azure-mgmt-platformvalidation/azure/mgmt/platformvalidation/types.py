...
class ValidationTestFailureDetails(TypedDict, total=False):
    """Detailed information about test failure.

    :ivar errorCode: Error code categorizing the type of failure.
    :vartype errorCode: str
    :ivar errorMessage: Human-readable error message describing the failure.
    :vartype errorMessage: str
    :ivar details: Detailed information about the failure.
    :vartype details: str
    :ivar diagnosticInfo: Additional diagnostic information.
    :vartype diagnosticInfo: str
    :ivar recommendedActions: Suggested remediation steps for the customer.
    :vartype recommendedActions: list[str]
    """
...
class ValidationTestPassDetails(TypedDict, total=False):
    """Detailed information about test pass.

    :ivar resultCode: Result code categorizing the type of pass.
    :vartype resultCode: str
    :ivar testName: test name which passed.
    :vartype testName: str
    :ivar resultDetails: Detailed information about the passed test.
...
class ValidationTestRun(ProxyResource):
    ...
    :vartype systemData: "SystemData"
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: "ValidationTestRunProperties"
    """
...
class ValidationTestRunProperties(TypedDict, total=False):
    ...
    :vartype status: Union[str, "ValidationTestRunStatus"]
    :ivar error: Error details. Populated when status is Error.
    :vartype error: "ErrorDetail"
    :ivar provisioningState: The state of the test run. Known values are: "Succeeded", "Failed",
     "Canceled", and "Running".
    :vartype provisioningState: Union[str, "ValidationTestRunProvisioningState"]
    :ivar startedAt: The start time of the test run.
    :vartype startedAt: str
    :ivar completedAt: The completion time of the test run.
    :vartype completedAt: str
    :ivar reportedAt: The time at which the test run result was reported.
    :vartype reportedAt: str
    :ivar testId: The name of the validation test (ValidationTest resource name, not an ARM
     resource ID) in the validation test catalog.
    :vartype testId: str
    :ivar testCategoryIds: The names of the validation test categories (ValidationTestCategory
     resource names, not ARM resource IDs) associated with this test run.
    :vartype testCategoryIds: list[str]
    :ivar inputsJson: Validation test run inputs json, conforming to the input contract declared by
    ...
    :vartype inputsJson: str
    :ivar passDetails: Detailed pass information when the test passes.
    :vartype passDetails: list["ValidationTestPassDetails"]
    :ivar failureDetails: Detailed failure information when the test fails.
    :vartype failureDetails: list["ValidationTestFailureDetails"]
    """
