...
class TestPlatformValidationCloudValidationsOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_cloud_validations_get(self, resource_group):
        response = self.client.cloud_validations.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_cloud_validations_begin_create_or_update(self, resource_group):
        response = self.client.cloud_validations.begin_create_or_update(
            resource_group_name=resource_group.name,
            cloud_validation_name="str",
            resource={
                "location": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_cloud_validations_begin_update(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_cloud_validations_begin_delete(self, resource_group):
        response = self.client.cloud_validations.begin_delete(
            resource_group_name=resource_group.name,
            cloud_validation_name="str",
        ).result()  # call '.result()' to poll until service return final result
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_cloud_validations_list_by_resource_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_cloud_validations_list_by_subscription(self, resource_group):
