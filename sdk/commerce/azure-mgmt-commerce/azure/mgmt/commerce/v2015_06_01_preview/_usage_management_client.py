...
class UsageManagementClient(object):
    ...
    :vartype usage_aggregates: azure.mgmt.commerce.v2015_06_01_preview.operations.UsageAggregatesOperations
    :ivar rate_card: RateCardOperations operations
    :vartype rate_card: azure.mgmt.commerce.v2015_06_01_preview.operations.RateCardOperations
