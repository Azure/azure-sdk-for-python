...
class UsageManagementClient:
    ...
    :vartype usage_aggregates:
     azure.mgmt.commerce.v2015_06_01_preview.aio.operations.UsageAggregatesOperations
    :ivar rate_card: RateCardOperations operations
    :vartype rate_card: azure.mgmt.commerce.v2015_06_01_preview.aio.operations.RateCardOperations
    :param credential: Credential needed for the client to connect to Azure.
    :type credential: ~azure.core.credentials_async.AsyncTokenCredential
    :param subscription_id: It uniquely identifies Microsoft Azure subscription. The subscription
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = UsageManagementClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
        ...
        self.usage_aggregates = UsageAggregatesOperations(self._client, self._config, self._serialize, self._deserialize)
