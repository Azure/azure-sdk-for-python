...
class LineStringType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class MultiLineStringType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class MultiPointType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class MultiPolygonType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class PointType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
