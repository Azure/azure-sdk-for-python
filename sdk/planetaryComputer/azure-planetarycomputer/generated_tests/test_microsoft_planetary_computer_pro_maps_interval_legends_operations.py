...
class TestMicrosoftPlanetaryComputerProMapsIntervalLegendsOperations(MicrosoftPlanetaryComputerProClientTestBase):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_maps_interval_legends_get_by_classmap_name(self, microsoftplanetarycomputerpro_endpoint):
