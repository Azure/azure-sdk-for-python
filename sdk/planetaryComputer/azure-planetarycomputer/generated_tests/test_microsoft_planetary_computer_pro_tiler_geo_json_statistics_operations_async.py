...
class TestMicrosoftPlanetaryComputerProTilerGeoJsonStatisticsOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_tiler_geo_json_statistics_get_all(self, microsoftplanetarycomputerpro_endpoint):
