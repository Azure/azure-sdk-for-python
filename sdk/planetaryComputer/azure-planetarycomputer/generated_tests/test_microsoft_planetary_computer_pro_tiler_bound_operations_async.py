...
class TestMicrosoftPlanetaryComputerProTilerBoundOperationsAsync(MicrosoftPlanetaryComputerProClientTestBaseAsync):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_tiler_bound_get_all(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=microsoftplanetarycomputerpro_endpoint)
        response = await client.tiler_bound.get_all(
            collection_id="str",
            item_id="str",
        )
