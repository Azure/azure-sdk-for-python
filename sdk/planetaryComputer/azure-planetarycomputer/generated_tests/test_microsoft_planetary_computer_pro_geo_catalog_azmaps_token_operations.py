...
class TestMicrosoftPlanetaryComputerProGeoCatalogAzmapsTokenOperations(MicrosoftPlanetaryComputerProClientTestBase):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_geo_catalog_azmaps_token_get(self, microsoftplanetarycomputerpro_endpoint):
