...
class TestMicrosoftPlanetaryComputerProMapsClassmapLegendsOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_maps_classmap_legends_get(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=microsoftplanetarycomputerpro_endpoint)
        response = await client.maps_classmap_legends.get(
            classmap_name="str",
        )
