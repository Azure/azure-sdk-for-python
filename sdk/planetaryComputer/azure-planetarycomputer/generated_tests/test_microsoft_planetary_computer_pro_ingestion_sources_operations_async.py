...
class TestMicrosoftPlanetaryComputerProIngestionSourcesOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_ingestion_sources_list_all(self, microsoftplanetarycomputerpro_endpoint):
    ...
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_ingestion_sources_get(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=microsoftplanetarycomputerpro_endpoint)
    ...
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_ingestion_sources_create(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=microsoftplanetarycomputerpro_endpoint)
    ...
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_ingestion_sources_create_or_replace(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=microsoftplanetarycomputerpro_endpoint)
    ...
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_ingestion_sources_delete(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=microsoftplanetarycomputerpro_endpoint)
    ...
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_ingestion_sources_list_managed_identities(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=microsoftplanetarycomputerpro_endpoint)
