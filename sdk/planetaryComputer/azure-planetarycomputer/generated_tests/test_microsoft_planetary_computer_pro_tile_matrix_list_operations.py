...
class TestMicrosoftPlanetaryComputerProTileMatrixListOperations(MicrosoftPlanetaryComputerProClientTestBase):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_tile_matrix_list_get(self, microsoftplanetarycomputerpro_endpoint):
