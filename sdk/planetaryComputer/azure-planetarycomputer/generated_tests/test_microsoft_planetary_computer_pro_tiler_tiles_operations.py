...
class TestMicrosoftPlanetaryComputerProTilerTilesOperations(MicrosoftPlanetaryComputerProClientTestBase):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_tiler_tiles_get_zxy_scalex_format(self, microsoftplanetarycomputerpro_endpoint):
