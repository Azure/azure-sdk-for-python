...
class TestMicrosoftPlanetaryComputerProTilerTileMatrixSetsOperations(MicrosoftPlanetaryComputerProClientTestBase):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_tiler_tile_matrix_sets_get_zxy_scalex_format(self, microsoftplanetarycomputerpro_endpoint):
