...
class TestMicrosoftPlanetaryComputerProMapsLegendsOperationsAsync(MicrosoftPlanetaryComputerProClientTestBaseAsync):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_maps_legends_get(self, microsoftplanetarycomputerpro_endpoint):
