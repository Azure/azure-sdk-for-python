...
class TestMicrosoftPlanetaryComputerProTilerPointsOperationsAsync(MicrosoftPlanetaryComputerProClientTestBaseAsync):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_tiler_points_get_lon_lat(self, microsoftplanetarycomputerpro_endpoint):
