...
class TestMicrosoftPlanetaryComputerProMosaicsTileMatrixSetsTileJsonOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_mosaics_tile_matrix_sets_tile_json_get(self, microsoftplanetarycomputerpro_endpoint):
