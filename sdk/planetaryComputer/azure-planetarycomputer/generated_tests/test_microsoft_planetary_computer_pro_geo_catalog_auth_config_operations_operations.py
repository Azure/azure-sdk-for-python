...
class TestMicrosoftPlanetaryComputerProGeoCatalogAuthConfigOperationsOperations(
    MicrosoftPlanetaryComputerProClientTestBase
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_geo_catalog_auth_config_operations_get(self, microsoftplanetarycomputerpro_endpoint):
