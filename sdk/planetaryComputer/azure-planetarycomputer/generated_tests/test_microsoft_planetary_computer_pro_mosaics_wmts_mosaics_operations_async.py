...
class TestMicrosoftPlanetaryComputerProMosaicsWmtsMosaicsOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_mosaics_wmts_mosaics_get_capabilities_xml(self, microsoftplanetarycomputerpro_endpoint):
