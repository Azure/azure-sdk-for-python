...
class TestMicrosoftPlanetaryComputerProTilerPointsOperations(MicrosoftPlanetaryComputerProClientTestBase):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_tiler_points_get_lon_lat(self, microsoftplanetarycomputerpro_endpoint):
