...
class TestMicrosoftPlanetaryComputerProTilerInfoGeoJsonOperationsOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_tiler_info_geo_json_operations_get(self, microsoftplanetarycomputerpro_endpoint):
