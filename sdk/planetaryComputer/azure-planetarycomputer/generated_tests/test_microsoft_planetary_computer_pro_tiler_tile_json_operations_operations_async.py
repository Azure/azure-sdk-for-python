...
class TestMicrosoftPlanetaryComputerProTilerTileJsonOperationsOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_tiler_tile_json_operations_get(self, microsoftplanetarycomputerpro_endpoint):
