...
class TestMicrosoftPlanetaryComputerProTilerWmtsTileMatrixSetsOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_tiler_wmts_tile_matrix_sets_get_capabilities_xml(self, microsoftplanetarycomputerpro_endpoint):
