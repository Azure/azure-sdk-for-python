...
class TestMicrosoftPlanetaryComputerProStacCollectionRenderOptionsOperations(
    MicrosoftPlanetaryComputerProClientTestBase
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_stac_collection_render_options_get_all(self, microsoftplanetarycomputerpro_endpoint):
    ...
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_stac_collection_render_options_create(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_client(endpoint=microsoftplanetarycomputerpro_endpoint)
    ...
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_stac_collection_render_options_get(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_client(endpoint=microsoftplanetarycomputerpro_endpoint)
    ...
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_stac_collection_render_options_create_or_replace(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_client(endpoint=microsoftplanetarycomputerpro_endpoint)
    ...
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_stac_collection_render_options_delete(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_client(endpoint=microsoftplanetarycomputerpro_endpoint)
