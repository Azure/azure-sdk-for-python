...
class TestMicrosoftPlanetaryComputerProTilerTileMatrixSetsOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_tiler_tile_matrix_sets_get_zxy_scalex_format(self, microsoftplanetarycomputerpro_endpoint):
