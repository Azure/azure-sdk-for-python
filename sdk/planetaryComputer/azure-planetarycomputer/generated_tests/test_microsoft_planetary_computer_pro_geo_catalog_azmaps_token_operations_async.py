...
class TestMicrosoftPlanetaryComputerProGeoCatalogAzmapsTokenOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_geo_catalog_azmaps_token_get(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=microsoftplanetarycomputerpro_endpoint)
        response = await client.geo_catalog_azmaps_token.get()
