...
class TestMicrosoftPlanetaryComputerProTilerBoundOperations(MicrosoftPlanetaryComputerProClientTestBase):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_tiler_bound_get_all(self, microsoftplanetarycomputerpro_endpoint):
