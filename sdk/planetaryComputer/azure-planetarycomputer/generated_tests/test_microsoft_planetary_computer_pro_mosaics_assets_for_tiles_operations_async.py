...
class TestMicrosoftPlanetaryComputerProMosaicsAssetsForTilesOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_mosaics_assets_for_tiles_get_zxy_assets(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=microsoftplanetarycomputerpro_endpoint)
        response = await client.mosaics_assets_for_tiles.get_zxy_assets(
            search_id="str",
            z="str",
            x="str",
            y="str",
