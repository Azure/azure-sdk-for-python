...
class TestMicrosoftPlanetaryComputerProMosaicsRegisterSearchOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_mosaics_register_search_register(self, microsoftplanetarycomputerpro_endpoint):
