...
class TestMicrosoftPlanetaryComputerProStacCollectionConfigOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_stac_collection_config_get(self, microsoftplanetarycomputerpro_endpoint):
