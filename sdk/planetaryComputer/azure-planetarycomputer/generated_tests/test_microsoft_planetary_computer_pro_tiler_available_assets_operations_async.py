...
class TestMicrosoftPlanetaryComputerProTilerAvailableAssetsOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_tiler_available_assets_get_all(self, microsoftplanetarycomputerpro_endpoint):
