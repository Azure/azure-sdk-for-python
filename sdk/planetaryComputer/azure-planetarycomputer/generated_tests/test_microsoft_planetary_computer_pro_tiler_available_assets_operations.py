...
class TestMicrosoftPlanetaryComputerProTilerAvailableAssetsOperations(MicrosoftPlanetaryComputerProClientTestBase):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_tiler_available_assets_get_all(self, microsoftplanetarycomputerpro_endpoint):
