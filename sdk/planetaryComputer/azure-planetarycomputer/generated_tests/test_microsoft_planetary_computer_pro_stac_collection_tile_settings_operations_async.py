...
class TestMicrosoftPlanetaryComputerProStacCollectionTileSettingsOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_stac_collection_tile_settings_get_all(self, microsoftplanetarycomputerpro_endpoint):
    ...
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_stac_collection_tile_settings_replace(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=microsoftplanetarycomputerpro_endpoint)
        response = await client.stac_collection_tile_settings.replace(
            collection_id="str",
