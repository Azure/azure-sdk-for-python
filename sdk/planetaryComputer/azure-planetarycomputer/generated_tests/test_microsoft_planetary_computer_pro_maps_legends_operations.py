...
class TestMicrosoftPlanetaryComputerProMapsLegendsOperations(MicrosoftPlanetaryComputerProClientTestBase):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_maps_legends_get(self, microsoftplanetarycomputerpro_endpoint):
