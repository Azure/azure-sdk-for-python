...
class TestPlanetaryComputerIngestionSourcesOperations(PlanetaryComputerClientTestBase):
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy
    def test_ingestion_sources_create_or_replace(self, planetarycomputer_endpoint):
        client = self.create_client(endpoint=planetarycomputer_endpoint)
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy
    def test_ingestion_sources_delete(self, planetarycomputer_endpoint):
        client = self.create_client(endpoint=planetarycomputer_endpoint)
        response = client.ingestion_sources.delete(
            id="str",
        )
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy
    def test_ingestion_sources_list_managed_identities(self, planetarycomputer_endpoint):
        client = self.create_client(endpoint=planetarycomputer_endpoint)
        response = client.ingestion_sources.list_managed_identities()
