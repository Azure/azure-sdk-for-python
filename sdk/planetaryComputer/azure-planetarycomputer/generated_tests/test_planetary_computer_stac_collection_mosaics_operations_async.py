...
class TestPlanetaryComputerStacCollectionMosaicsOperationsAsync(PlanetaryComputerClientTestBaseAsync):
    @PlanetaryComputerPreparer()
    @recorded_by_proxy_async
    async def test_stac_collection_mosaics_get_all(self, planetarycomputer_endpoint):
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy_async
    async def test_stac_collection_mosaics_add(self, planetarycomputer_endpoint):
        client = self.create_async_client(endpoint=planetarycomputer_endpoint)
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy_async
    async def test_stac_collection_mosaics_get(self, planetarycomputer_endpoint):
        client = self.create_async_client(endpoint=planetarycomputer_endpoint)
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy_async
    async def test_stac_collection_mosaics_create_or_replace(self, planetarycomputer_endpoint):
        client = self.create_async_client(endpoint=planetarycomputer_endpoint)
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy_async
    async def test_stac_collection_mosaics_delete(self, planetarycomputer_endpoint):
        client = self.create_async_client(endpoint=planetarycomputer_endpoint)
