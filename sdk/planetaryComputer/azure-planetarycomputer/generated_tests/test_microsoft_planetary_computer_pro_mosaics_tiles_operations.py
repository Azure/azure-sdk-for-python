...
class TestMicrosoftPlanetaryComputerProMosaicsTilesOperations(MicrosoftPlanetaryComputerProClientTestBase):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_mosaics_tiles_get_zxy_scalex_format(self, microsoftplanetarycomputerpro_endpoint):
