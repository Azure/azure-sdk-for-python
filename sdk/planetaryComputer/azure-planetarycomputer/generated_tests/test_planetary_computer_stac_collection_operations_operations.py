...
class TestPlanetaryComputerStacCollectionOperationsOperations(PlanetaryComputerClientTestBase):
    @PlanetaryComputerPreparer()
    @recorded_by_proxy
    def test_stac_collection_operations_get_all(self, planetarycomputer_endpoint):
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy
    def test_stac_collection_operations_begin_create(self, planetarycomputer_endpoint):
        client = self.create_client(endpoint=planetarycomputer_endpoint)
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy
    def test_stac_collection_operations_get(self, planetarycomputer_endpoint):
        client = self.create_client(endpoint=planetarycomputer_endpoint)
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy
    def test_stac_collection_operations_begin_create_or_replace(self, planetarycomputer_endpoint):
        client = self.create_client(endpoint=planetarycomputer_endpoint)
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy
    def test_stac_collection_operations_begin_delete(self, planetarycomputer_endpoint):
        client = self.create_client(endpoint=planetarycomputer_endpoint)
