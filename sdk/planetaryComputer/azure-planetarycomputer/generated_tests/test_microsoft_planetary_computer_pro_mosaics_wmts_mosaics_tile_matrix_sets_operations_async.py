...
class TestMicrosoftPlanetaryComputerProMosaicsWmtsMosaicsTileMatrixSetsOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_mosaics_wmts_mosaics_tile_matrix_sets_get_capabilities_xml(
