...
class TestMicrosoftPlanetaryComputerProMosaicsAssetsForTileMatrixSetsOperations(
    MicrosoftPlanetaryComputerProClientTestBase
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy
    def test_mosaics_assets_for_tile_matrix_sets_get_zxy_assets(self, microsoftplanetarycomputerpro_endpoint):
