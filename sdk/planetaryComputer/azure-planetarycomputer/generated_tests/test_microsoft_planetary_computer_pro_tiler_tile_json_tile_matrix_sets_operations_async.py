...
class TestMicrosoftPlanetaryComputerProTilerTileJsonTileMatrixSetsOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_tiler_tile_json_tile_matrix_sets_get(self, microsoftplanetarycomputerpro_endpoint):
