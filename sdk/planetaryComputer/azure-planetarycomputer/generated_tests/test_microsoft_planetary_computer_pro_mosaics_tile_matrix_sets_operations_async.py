...
class TestMicrosoftPlanetaryComputerProMosaicsTileMatrixSetsOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_mosaics_tile_matrix_sets_get_zxy_scalex_format(self, microsoftplanetarycomputerpro_endpoint):
