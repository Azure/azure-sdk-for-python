...
class TestMicrosoftPlanetaryComputerProMosaicsAssetsForPointsOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_mosaics_assets_for_points_get_lon_lat_assets(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=microsoftplanetarycomputerpro_endpoint)
        response = await client.mosaics_assets_for_points.get_lon_lat_assets(
            search_id="str",
            lon="str",
            lat="str",
        )
