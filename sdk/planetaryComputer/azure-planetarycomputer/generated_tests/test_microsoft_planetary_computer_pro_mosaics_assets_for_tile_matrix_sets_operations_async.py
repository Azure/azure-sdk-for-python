...
class TestMicrosoftPlanetaryComputerProMosaicsAssetsForTileMatrixSetsOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_mosaics_assets_for_tile_matrix_sets_get_zxy_assets(self, microsoftplanetarycomputerpro_endpoint):
