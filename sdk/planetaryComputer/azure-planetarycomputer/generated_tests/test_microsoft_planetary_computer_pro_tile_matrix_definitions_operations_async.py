...
class TestMicrosoftPlanetaryComputerProTileMatrixDefinitionsOperationsAsync(
    MicrosoftPlanetaryComputerProClientTestBaseAsync
):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_tile_matrix_definitions_get(self, microsoftplanetarycomputerpro_endpoint):
