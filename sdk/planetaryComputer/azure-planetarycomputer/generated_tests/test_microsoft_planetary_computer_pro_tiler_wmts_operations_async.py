...
class TestMicrosoftPlanetaryComputerProTilerWmtsOperationsAsync(MicrosoftPlanetaryComputerProClientTestBaseAsync):
    @MicrosoftPlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_tiler_wmts_get_capabilities_xml(self, microsoftplanetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=microsoftplanetarycomputerpro_endpoint)
        response = await client.tiler_wmts.get_capabilities_xml(
            collection_id="str",
            item_id="str",
        )
