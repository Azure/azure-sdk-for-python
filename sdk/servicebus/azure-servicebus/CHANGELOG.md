...
- Updated the legacy uAMQP transport deprecation warning to state that support will be removed in a future major release rather than the current 7.15.0 release.
