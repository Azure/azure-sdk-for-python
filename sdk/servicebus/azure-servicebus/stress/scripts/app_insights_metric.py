...
class AzureMonitorMetric(AbstractMonitorMetric):
    def __init__(self, test_name, test_description=None):
        ...
        messages_measure_desc = (
            "The number of messages handled by " + self.desc if self.desc else None
        )
        ...
        self.messages_measure = measure_module.MeasureInt(
            messages_measure_name, messages_measure_desc, "messages"
        )
