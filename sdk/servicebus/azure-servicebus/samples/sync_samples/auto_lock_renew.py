...
def renew_lock_on_message_received_from_non_sessionful_entity():
    ...
    with servicebus_client:
        ...
        renewer = AutoLockRenewer(timeout=100)

        with servicebus_client.get_queue_receiver(queue_name=QUEUE_NAME, prefetch_count=10, auto_lock_renew=renewer) as receiver:
...
def renew_lock_with_lock_renewal_failure_callback():
    ...
    with servicebus_client:
        ...
        with AutoLockRenewer(timeout=90, on_lock_renew_failure=on_lock_renew_failure_callback) as renewer:
