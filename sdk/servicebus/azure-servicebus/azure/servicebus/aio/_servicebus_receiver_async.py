...
from .._servicebus_receiver import ServiceBusSession as BaseSession
...
class ServiceBusReceiver(collections.abc.AsyncIterator, BaseHandlerAsync, ReceiverMixin):
    ...
    async def peek(self, message_count=1, sequence_number=0):
        ...
        self._populate_message_properties(message) #TODO: kibrantn: this wasn't here before.  missing? (add unit test that would have caught it if so)
...
class ServiceBusReceiver(ServiceBusReceiver, SessionReceiverMixin):
    """The ServiceBusReceiver class defines a high level interface for
    receiving messages from the Azure Service Bus Queue or Topic Subscription.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        #TODO: kibrantn: have this just take self?
        self._session = ServiceBusSession(self._session_id, self, self._config.encoding)

    #TODO: kibrantn: This is only here for the adjusted docstring.  any better way to do that?
    @classmethod
    def from_connection_string(
        cls,
        conn_str: str,
