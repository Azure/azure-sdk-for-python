    ...
    **Please use the `get_<queue/subscription>_receiver` method of ~azure.servicebus.ServiceBusClient to create a
    ...
    def _iter_contextual_wrapper(self, max_wait_time=None):
        ...
        while True:
            ...
            if max_wait_time:
                original_timeout = self._amqp_transport.get_receive_timeout(self._handler)
                self._amqp_transport.set_receive_timeout(
                    self._handler, max_wait_time * self._amqp_transport.TIMEOUT_FACTOR
                )
            try:
                ...
                if original_timeout:
                    try:
                        self._amqp_transport.set_receive_timeout(
                            self._handler, original_timeout
                        )
