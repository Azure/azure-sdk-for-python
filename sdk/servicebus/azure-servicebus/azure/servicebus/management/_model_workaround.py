...
MODEL_CLASS_ATTRIBUTES: Dict[Type["Model"], Tuple[str, ...]] = {
    ...
    FalseFilter: ("type", "sql_expression", "compatibility_level", "parameters", "requires_preprocessing"),
    KeyValue: ("key", "value"),
    ...
    SqlFilter: ("type", "sql_expression", "compatibility_level", "parameters", "requires_preprocessing"),
    SqlRuleAction: ("type", "sql_expression", "compatibility_level", "parameters", "requires_preprocessing"),
    SubscriptionDescription: ("lock_duration", "requires_session", "default_message_time_to_live", "dead_lettering_on_message_expiration", "dead_lettering_on_filter_evaluation_exceptions", "message_count", "max_delivery_count", "enable_batched_operations", "status", "forward_to", "created_at", "updated_at", "accessed_at", "message_count_details", "forward_dead_lettered_messages_to", "auto_delete_on_idle", "entity_availability_status", "user_metadata"),
    ...
    TrueFilter: ("type", "sql_expression", "compatibility_level", "parameters", "requires_preprocessing"),
}
