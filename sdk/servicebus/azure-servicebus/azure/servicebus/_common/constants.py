...
MGMT_RESPONSE_RULE_RULES = b'rules'
MGMT_RESPONSE_RULE_RULE_DESCRIPTION = b'rule-description'
...
MGMT_REQUEST_RULE_NAME = 'rule-name'
MGMT_REQUEST_RULE_DESCRIPTION = 'rule-description'
MGMT_REQUEST_RULE_SQL_FILTER = 'sql-filter'
MGMT_REQUEST_RULE_CORRELATION_FILTER = 'correlation-filter'
MGMT_REQUEST_RULE_SQL_RULE_ACTION = 'sql-rule-action'
MGMT_REQUEST_RULE_EXPRESSION = 'expression'
MGMT_REQUEST_CORRELATION_FILTER_CORRELATION_ID = 'correlation-id'
MGMT_REQUEST_CORRELATION_FILTER_MESSAGE_ID = 'message-id'
MGMT_REQUEST_CORRELATION_FILTER_TO = 'to'
MGMT_REQUEST_CORRELATION_FILTER_REPLY_TO = 'reply-to'
MGMT_REQUEST_CORRELATION_FILTER_LABEL = 'label'
MGMT_REQUEST_CORRELATION_FILTER_SESSION_ID = 'session-id'
MGMT_REQUEST_CORRELATION_FILTER_REPLY_TO_SESSION_ID = 'reply-to-session-id'
MGMT_REQUEST_CORRELATION_FILTER_CONTENT_TYPE = 'content-type'
MGMT_REQUEST_CORRELATION_FILTER_USER_PROPERTIES = 'properties'
MGMT_REQUEST_GET_RULES_TOP = 'top'
MGMT_REQUEST_GET_RULES_SKIP = 'skip'
MGMT_REQUEST_RULE_TRUE_FILTER = '1=1'
MGMT_REQUEST_RULE_FALSE_FILTER = '1=0'

MAX_32BIT_INTEGER = pow(2, 31) - 1

RULE_FILTER_TYPE_SQL_FILTER = 0x000001370000006
RULE_FILTER_TYPE_CORRELATION_FILTER = 0x000001370000009
RULE_FILTER_TYPE_TRUE_FILTER = 0x000001370000007
RULE_FILTER_TYPE_FALSE_FILTER = 0x000001370000008
