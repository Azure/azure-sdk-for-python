...
MGMT_REQUEST_ADD_RULE = VENDOR + b":add-rule"
MGMT_REQUEST_REMOVE_RULE = VENDOR + b":remove-rule"
MGMT_REQUEST_GET_RULES = VENDOR + b":enumerate-rules"
MGMT_REQUEST_RULE_NAME = "rule-name"
MGMT_REQUEST_SQL_RULE_FILTER = "sql-filter"
MGMT_REQUEST_RULE_DESCRIPTION = "rule-description"
MGMT_REQUEST_EXPRESSION = "expression"
MGMT_REQUEST_CORRELATION_ID = "correlation-id"
MGMT_REQUEST_TO = "to"
MGMT_REQUEST_REPLY_TO = "reply-to"
MGMT_REQUEST_LABEL = "label"
MGMT_REQUEST_REPLY_TO_SESSION_ID = "reply-to-session-id"
MGMT_REQUEST_CONTENT_TYPE = "content-type"
MGMT_REQUEST_CORRELATION_FILTER_PROPERTIES = "properties"
MGMT_REQUEST_CORRELATION_FILTER = "correlation-filter"
MGMT_REQUEST_SQL_RULE_ACTION = "sql-rule-action"
MGMT_REQUEST_TOP = "top"
MGMT_REQUEST_SKIP = "skip"
MGMT_REQUEST_STATUS_CODE = "statusCode"
MGMT_REQUEST_LEGACY_STATUS_CODE = "status-code"
MGMT_REQUEST_RULES = "rules"
