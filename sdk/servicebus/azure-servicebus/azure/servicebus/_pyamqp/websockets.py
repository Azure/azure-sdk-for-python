...
class WebSocket:
    """
    A synchronous WebSocket client implementation that provides a simple interface for sending and receiving data.
    ...
    :keyword dict[bytes, bytes] headers: A dictionary of HTTP headers to send during the WebSocket handshake.
    :keyword dict[str, Union[str, int]] http_proxy: A dictionary of HTTP proxy configuration - host, port, username, password.
    :keyword list[bytes] subprotocols: A list of supported subprotocols
    :keyword float timeout: The timeout value for the WebSocket connection to perform send and receive operations.
...
class AsyncWebSocket:
    """
      An async WebSocket client implementation that provides a simple interface for sending and receiving data.
