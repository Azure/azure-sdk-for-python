...
class TestServiceBusAdministrationClientQueueAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_async_mgmt_queue_list_basic(self, service_bus_connection_str,
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_list_with_special_chars(self, service_bus_connection_str):
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_list_with_parameters(self, service_bus_connection_str):
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_list_with_negative_credential(self, service_bus_fully_qualified_namespace, service_bus_sas_policy,
                                                        service_bus_sas_key):
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_list_with_negative_parameters(self, service_bus_connection_str):
        pytest.skip("start_idx and max_count are currently removed, they might come back in the future.")
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_delete_basic(self, service_bus_connection_str):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_queues(mgmt_service)
        await mgmt_service.create_queue("test_queue")
        queues = await async_pageable_to_list(mgmt_service.list_queues())
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_delete_one_and_check_not_existing(self, service_bus_connection_str):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_queues(mgmt_service)
        for i in range(10):
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_delete_negtive(self, service_bus_connection_str):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_queues(mgmt_service)
        await mgmt_service.create_queue("test_queue")
        queues = await async_pageable_to_list(mgmt_service.list_queues())
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_create_by_name(self, service_bus_connection_str, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_queues(mgmt_service)
        queue_name = "eidk"
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_create_with_invalid_name(self, service_bus_connection_str, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_create_with_queue_description(self, service_bus_connection_str, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_queues(mgmt_service)
        queue_name = "dkldf"
        queue_name_2 = "vjiqjx"
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_premium_create_with_queue_description(self, service_bus_connection_str,
                                                                  **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_queues(mgmt_service)
        queue_name = "dkldf"
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_create_duplicate(self, service_bus_connection_str, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_queues(mgmt_service)
        queue_name = "eriodk"
        await mgmt_service.create_queue(queue_name)
    ...
    async def test_async_mgmt_queue_update_success(self, **kwargs):
        service_bus_connection_str, service_bus_fully_qualified_namespace = kwargs.pop('service_bus_connection_str'), kwargs.pop('service_bus_fully_qualified_namespace')
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_queues(mgmt_service)
        queue_name = "ewuidfj"
        topic_name = "dkfjaks"
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_update_invalid(self, service_bus_connection_str, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_queues(mgmt_service)
        queue_name = "vbmfm"
        queue_description = await mgmt_service.create_queue(queue_name)
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_list_runtime_properties_basic(self, service_bus_connection_str):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_queues(mgmt_service)
        queues = await async_pageable_to_list(mgmt_service.list_queues())
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_list_runtime_prop_w_neg_params(self, service_bus_connection_str):
        pytest.skip("start_idx and max_count are currently removed, they might come back in the future.")
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_list_runtime_prop_w_param(self, service_bus_connection_str):
        pytest.skip("start_idx and max_count are currently removed, they might come back in the future.")
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_get_runtime_properties_basic(self, service_bus_connection_str):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_queues(mgmt_service)
        await mgmt_service.create_queue("test_queue")
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_get_runtime_properties_negative(self, service_bus_connection_str):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        with pytest.raises(TypeError):
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_mgmt_queue_async_update_dict_success(self, service_bus_connection_str, service_bus_fully_qualified_namespace, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_queues(mgmt_service)
        queue_name = "fjruid"
        queue_description = await mgmt_service.create_queue(queue_name)
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_mgmt_queue_async_update_dict_error(self, service_bus_connection_str, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_queues(mgmt_service)
        queue_name = "fjruid"
        queue_description = await mgmt_service.create_queue(queue_name)
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_queue_basic_v2017_04(self, service_bus_connection_str,
                                                        service_bus_fully_qualified_namespace, service_bus_sas_key,
