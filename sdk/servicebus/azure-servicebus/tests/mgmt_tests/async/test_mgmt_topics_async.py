...
class TestServiceBusAdministrationClientTopicAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_async_mgmt_topic_create_by_name(self, service_bus_connection_str, **kwargs):
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_topic_create_with_topic_description(self, service_bus_connection_str, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_topics(mgmt_service)
        topic_name = "iweidk"
        topic_name_2 = "dkozq"
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_topic_premium_create_with_topic_description(self, service_bus_connection_str, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_topics(mgmt_service)
        topic_name = "iweidk"
        topic_name_2 = "dkozq"
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_topic_create_duplicate(self, service_bus_connection_str, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_topics(mgmt_service)
        topic_name = "dqkodq"
        try:
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_topic_update_success(self, service_bus_connection_str, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_topics(mgmt_service)
        topic_name = "fjrui"
        try:
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_topic_update_invalid(self, service_bus_connection_str, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_topics(mgmt_service)
        topic_name = "dfjfj"
        try:
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_topic_delete(self, service_bus_connection_str):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_topics(mgmt_service)
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_topic_list(self, service_bus_connection_str, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_topics(mgmt_service)
        topics = await async_pageable_to_list(mgmt_service.list_topics())
        assert len(topics) == 0
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_topic_list_runtime_properties(self, service_bus_connection_str, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_topics(mgmt_service)
        topics = await async_pageable_to_list(mgmt_service.list_topics())
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_topic_get_runtime_properties_basic(self, service_bus_connection_str):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_topics(mgmt_service)
        await mgmt_service.create_topic("test_topic")
        try:
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_mgmt_topic_async_update_dict_success(self, service_bus_connection_str, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_topics(mgmt_service)
        topic_name = "fjruid"
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_mgmt_topic_async_update_dict_error(self, service_bus_connection_str, **kwargs):
        mgmt_service = ServiceBusAdministrationClient.from_connection_string(service_bus_connection_str)
        await clear_topics(mgmt_service)
        topic_name = "fjruid"
        try:
    ...
    @ServiceBusPreparer()
    @recorded_by_proxy_async
    async def test_async_mgmt_topic_basic_v2017_04(self, service_bus_connection_str, service_bus_fully_qualified_namespace,
                                    service_bus_sas_key, service_bus_sas_policy):
        ...
        #     credential=ServiceBusSharedKeyCredential(service_bus_sas_key, service_bus_sas_policy),
