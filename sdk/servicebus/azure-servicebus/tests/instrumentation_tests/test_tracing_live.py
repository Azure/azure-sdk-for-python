...
class ServiceBusTracingTestBase:
    """Base class containing shared verification methods for ServiceBus tracing tests."""
...
class TestServiceBusTracing(ServiceBusTracingTestBase):
