...
class TestServiceBusQueue(AzureMgmtRecordedTestCase):
    ...
    def test_message_deleted(self, uamqp_transport, *, servicebus_namespace_connection_string=None, servicebus_queue=None, **kwargs):
        with ServiceBusClient.from_connection_string(
            ...
            with receiver:
                number_deleted_messages = receiver.delete_messages(max_message_count=10, enqueued_time_older_than_utc=datetime.utcnow())
    ...
    def test_message_deleted_maximum(self, uamqp_transport, *, servicebus_namespace_connection_string=None, servicebus_queue=None, **kwargs):
        with ServiceBusClient.from_connection_string(
            ...
            number_deleted_messages = 0
            with receiver:
                number_deleted_messages = receiver.delete_messages(max_message_count=4000, enqueued_time_older_than_utc=datetime.utcnow())
