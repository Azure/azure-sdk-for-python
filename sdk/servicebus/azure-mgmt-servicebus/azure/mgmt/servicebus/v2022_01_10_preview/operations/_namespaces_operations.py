...
class NamespacesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.SBNamespace"]:
        """Gets all the available namespaces within the subscription, irrespective of the resource groups.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either SBNamespace or the result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.servicebus.v2022_01_10_preview.models.SBNamespace]
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.SBNamespace"]:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2022_01_10_preview.models.SBNamespace
        ...
        :return: An instance of LROPoller that returns either SBNamespace or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.servicebus.v2022_01_10_preview.models.SBNamespace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.servicebus.v2022_01_10_preview.models.SBNamespace or IO
    ...
    def get(self, resource_group_name: str, namespace_name: str, **kwargs: Any) -> _models.SBNamespace:
        ...
        :rtype: ~azure.mgmt.servicebus.v2022_01_10_preview.models.SBNamespace
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2022_01_10_preview.models.SBNamespaceUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SBNamespace or None or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2022_01_10_preview.models.SBNamespace or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param namespace_name: The namespace name. Required.
        :type namespace_name: str
        :param parameters: Parameters supplied to update a namespace resource. Is either a model type
         or a IO type. Required.
        :type parameters: ~azure.mgmt.servicebus.v2022_01_10_preview.models.SBNamespaceUpdateParameters
         or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
    ...
    def create_or_update_network_rule_set(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2022_01_10_preview.models.NetworkRuleSet
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NetworkRuleSet or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2022_01_10_preview.models.NetworkRuleSet
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def create_or_update_network_rule_set(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2022_01_10_preview.models.NetworkRuleSet or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_network_rule_sets(
        self, resource_group_name: str, namespace_name: str, **kwargs: Any
    ) -> Iterable["_models.NetworkRuleSet"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.servicebus.v2022_01_10_preview.models.NetworkRuleSet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_authorization_rules(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.servicebus.v2022_01_10_preview.models.SBAuthorizationRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def check_name_availability(
        ...
        :type parameters: ~azure.mgmt.servicebus.v2022_01_10_preview.models.CheckNameAvailability
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CheckNameAvailabilityResult or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2022_01_10_preview.models.CheckNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def check_name_availability(
        ...
        :type parameters: ~azure.mgmt.servicebus.v2022_01_10_preview.models.CheckNameAvailability or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
