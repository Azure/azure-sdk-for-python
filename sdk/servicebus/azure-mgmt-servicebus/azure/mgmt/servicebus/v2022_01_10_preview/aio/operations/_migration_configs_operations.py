...
class MigrationConfigsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either MigrationConfigProperties or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicebus.v2022_01_10_preview.models.MigrationConfigProperties]
    ...
    async def begin_create_and_start_migration(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.servicebus.v2022_01_10_preview.models.MigrationConfigProperties]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
