...
class NamespacesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.SBNamespace"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicebus.models.SBNamespace]
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncItemPaged["_models.SBNamespace"]:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.models.SBNamespace or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either SBNamespace or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.servicebus.models.SBNamespace]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.models.SBNamespaceUpdateParameters or IO[bytes]
        :return: SBNamespace or None or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.models.SBNamespace or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_or_update_network_rule_set(
        ...
        **kwargs: Any
        ...
        :param parameters: The Namespace IpFilterRule. Is either a NetworkRuleSet type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.servicebus.models.NetworkRuleSet or IO[bytes]
        :return: NetworkRuleSet or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.models.NetworkRuleSet
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_network_rule_sets(
        self, resource_group_name: str, namespace_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.NetworkRuleSet"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicebus.models.NetworkRuleSet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
