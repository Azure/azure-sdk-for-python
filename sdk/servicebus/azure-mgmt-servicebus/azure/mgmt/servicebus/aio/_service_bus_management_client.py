...
class ServiceBusManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super(ServiceBusManagementClient, self).__init__(api_version=api_version, profile=profile)
    ...
    def disaster_recovery_configs(self):
        ...
        * 2022-10-01-preview: :class:`DisasterRecoveryConfigsOperations<azure.mgmt.servicebus.v2022_10_01_preview.aio.operations.DisasterRecoveryConfigsOperations>`
        ...
        if api_version == "2017-04-01":
            ...
            raise ValueError(
                "API version {} does not have operation group 'disaster_recovery_configs'".format(api_version)
            )
    ...
    def premium_messaging_regions(self):
        ...
        * 2018-01-01-preview: :class:`PremiumMessagingRegionsOperations<azure.mgmt.servicebus.v2018_01_01_preview.aio.operations.PremiumMessagingRegionsOperations>`
        ...
        if api_version == "2017-04-01":
            ...
            raise ValueError(
                "API version {} does not have operation group 'premium_messaging_regions'".format(api_version)
            )
        self._config.api_version = api_version
        return OperationClass(
            self._client,
