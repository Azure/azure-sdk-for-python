...
class MigrationConfigsOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicebus.v2017_04_01.models.MigrationConfigListResult]
    ...
    async def begin_create_and_start_migration(
        ...
        **kwargs
        ...
        :return: An instance of AsyncLROPoller that returns either MigrationConfigProperties or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.servicebus.v2017_04_01.models.MigrationConfigProperties]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
