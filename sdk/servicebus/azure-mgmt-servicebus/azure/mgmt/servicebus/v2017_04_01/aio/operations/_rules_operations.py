...
class RulesOperations:
    ...
    def list_by_subscriptions(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicebus.v2017_04_01.models.Rule]
    ...
    list_by_subscriptions.metadata = {
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2017_04_01.models.Rule
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Rule or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2017_04_01.models.Rule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_or_update(
        ...
        subscription_name: str,
        rule_name: str,
        parameters: Union[_models.Rule, IO],
        **kwargs: Any
    ) -> _models.Rule:
        """Creates a new rule and updates an existing rule.
        ...
        :param rule_name: The rule name. Required.
        :type rule_name: str
        :param parameters: Parameters supplied to create a rule. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.servicebus.v2017_04_01.models.Rule or IO
