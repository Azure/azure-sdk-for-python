...
class PremiumMessagingRegionsOperations:
    """PremiumMessagingRegionsOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicebus.v2017_04_01.models.PremiumMessagingRegionsListResult]
