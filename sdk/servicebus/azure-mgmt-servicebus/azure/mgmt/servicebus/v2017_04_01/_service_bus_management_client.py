...
class ServiceBusManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.queues = QueuesOperations(self._client, self._config, self._serialize, self._deserialize, "2017-04-01")
        self.topics = TopicsOperations(self._client, self._config, self._serialize, self._deserialize, "2017-04-01")
        ...
        self.rules = RulesOperations(self._client, self._config, self._serialize, self._deserialize, "2017-04-01")
