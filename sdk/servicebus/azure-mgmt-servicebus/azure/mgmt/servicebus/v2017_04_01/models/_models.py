...
class ArmDisasterRecoveryListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.servicebus.v2017_04_01.models.ArmDisasterRecovery]
...
class CaptureDescription(msrest.serialization.Model):
    ...
    :type encoding: str or ~azure.mgmt.servicebus.v2017_04_01.models.EncodingCaptureDescription
    ...
    :param destination: Properties of Destination where capture will be stored. (Storage Account,
     Blob Names).
    :type destination: ~azure.mgmt.servicebus.v2017_04_01.models.Destination
    """
...
class CheckNameAvailabilityResult(msrest.serialization.Model):
    ...
    :type reason: str or ~azure.mgmt.servicebus.v2017_04_01.models.UnavailableReason
    """
...
class ErrorResponse(msrest.serialization.Model):
    ...
    :type error: ~azure.mgmt.servicebus.v2017_04_01.models.ErrorResponseError
    """
...
class Eventhub(Resource):
    ...
    :type status: str or ~azure.mgmt.servicebus.v2017_04_01.models.EntityStatus
    :param capture_description: Properties of capture description.
    :type capture_description: ~azure.mgmt.servicebus.v2017_04_01.models.CaptureDescription
    """
...
class EventHubListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.servicebus.v2017_04_01.models.Eventhub]
    :ivar next_link: Link to the next set of results. Not empty if Value contains incomplete list
     of EventHubs.
    :vartype next_link: str
    """
...
class MigrationConfigListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.servicebus.v2017_04_01.models.MigrationConfigProperties]
    :ivar next_link: Link to the next set of results. Not empty if Value contains incomplete list
...
class NetworkRuleSet(Resource):
    ...
    :param default_action: Default Action for Network Rule Set. Possible values include: "Allow",
     "Deny".
    :type default_action: str or ~azure.mgmt.servicebus.v2017_04_01.models.DefaultAction
    ...
    :type ip_rules: list[~azure.mgmt.servicebus.v2017_04_01.models.NWRuleSetIpRules]
    """
...
class NetworkRuleSetListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.servicebus.v2017_04_01.models.NetworkRuleSet]
...
class NWRuleSetIpRules(msrest.serialization.Model):
    ...
    :type action: str or ~azure.mgmt.servicebus.v2017_04_01.models.NetworkRuleIPAction
    """
...
class NWRuleSetVirtualNetworkRules(msrest.serialization.Model):
    ...
    :type subnet: ~azure.mgmt.servicebus.v2017_04_01.models.Subnet
...
class Operation(msrest.serialization.Model):
    ...
    :type display: ~azure.mgmt.servicebus.v2017_04_01.models.OperationDisplay
    """
...
class PremiumMessagingRegions(ResourceNamespacePatch):
    ...
    :type tags: dict[str, str]
    :param properties:
    :type properties: ~azure.mgmt.servicebus.v2017_04_01.models.PremiumMessagingRegionsProperties
    """
...
class PremiumMessagingRegionsListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.servicebus.v2017_04_01.models.PremiumMessagingRegions]
    :ivar next_link: Link to the next set of results. Not empty if Value contains incomplete list
...
class RegenerateAccessKeyParameters(msrest.serialization.Model):
    ...
    :param key_type: Required. The access key to regenerate. Possible values include: "PrimaryKey",
     "SecondaryKey".
    :type key_type: str or ~azure.mgmt.servicebus.v2017_04_01.models.KeyType
...
class Rule(Resource):
    ...
    :type action: ~azure.mgmt.servicebus.v2017_04_01.models.Action
    ...
    :type filter_type: str or ~azure.mgmt.servicebus.v2017_04_01.models.FilterType
    :param sql_filter: Properties of sqlFilter.
    :type sql_filter: ~azure.mgmt.servicebus.v2017_04_01.models.SqlFilter
    :param correlation_filter: Properties of correlationFilter.
    :type correlation_filter: ~azure.mgmt.servicebus.v2017_04_01.models.CorrelationFilter
    """
...
class RuleListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.servicebus.v2017_04_01.models.Rule]
    :param next_link: Link to the next set of results. Not empty if Value contains incomplete list
     of rules.
    :type next_link: str
    """
...
class SBAuthorizationRule(Resource):
    ...
    :type rights: list[str or ~azure.mgmt.servicebus.v2017_04_01.models.AccessRights]
    """
...
class SBAuthorizationRuleListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.servicebus.v2017_04_01.models.SBAuthorizationRule]
    :param next_link: Link to the next set of results. Not empty if Value contains incomplete list
...
class SBNamespace(TrackedResource):
    ...
    :type sku: ~azure.mgmt.servicebus.v2017_04_01.models.SBSku
...
class SBNamespaceListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.servicebus.v2017_04_01.models.SBNamespace]
    :param next_link: Link to the next set of results. Not empty if Value contains incomplete list
     of Namespaces.
    :type next_link: str
    """
...
class SBNamespaceMigrate(msrest.serialization.Model):
    ...
    :type target_namespace_type: str or ~azure.mgmt.servicebus.v2017_04_01.models.NameSpaceType
    """
...
class SBQueueListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.servicebus.v2017_04_01.models.SBQueue]
    :param next_link: Link to the next set of results. Not empty if Value contains incomplete list
     of queues.
    :type next_link: str
    """
...
class SBSku(msrest.serialization.Model):
    ...
    :param name: Required. Name of this SKU. Possible values include: "Basic", "Standard",
     "Premium".
    :type name: str or ~azure.mgmt.servicebus.v2017_04_01.models.SkuName
    :param tier: The billing tier of this particular SKU. Possible values include: "Basic",
     "Standard", "Premium".
    :type tier: str or ~azure.mgmt.servicebus.v2017_04_01.models.SkuTier
...
class SBSubscriptionListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.servicebus.v2017_04_01.models.SBSubscription]
    :param next_link: Link to the next set of results. Not empty if Value contains incomplete list
     of subscriptions.
    :type next_link: str
    """
...
class SBTopicListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.servicebus.v2017_04_01.models.SBTopic]
    :param next_link: Link to the next set of results. Not empty if Value contains incomplete list
     of topics.
    :type next_link: str
    """
