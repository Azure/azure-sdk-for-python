...
class DisasterRecoveryConfigsOperations:
    ...
    def check_name_availability(
        ...
        resource_group_name: str,
        namespace_name: str,
        parameters: Union[_models.CheckNameAvailability, IO],
        **kwargs: Any
    ) -> _models.CheckNameAvailabilityResult:
        """Check the give namespace name availability.
        ...
        :type parameters: ~azure.mgmt.servicebus.v2021_06_01_preview.models.CheckNameAvailability or IO
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.servicebus.v2021_06_01_preview.models.ArmDisasterRecovery]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2021_06_01_preview.models.ArmDisasterRecovery or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def fail_over(  # pylint: disable=inconsistent-return-statements
        ...
        namespace_name: str,
        alias: str,
        parameters: Optional[Union[_models.FailoverProperties, IO]] = None,
        **kwargs: Any
    ) -> None:
        """Invokes GEO DR failover and reconfigure the alias to point to the secondary namespace.
        ...
        :type alias: str
        :param parameters: Parameters required to create an Alias(Disaster Recovery configuration). Is
         either a FailoverProperties type or a IO type. Default value is None.
        :type parameters: ~azure.mgmt.servicebus.v2021_06_01_preview.models.FailoverProperties or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_authorization_rules(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.servicebus.v2021_06_01_preview.models.SBAuthorizationRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
