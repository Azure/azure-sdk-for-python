...
class DisasterRecoveryConfigsOperations:
    ...
    def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2021_06_01_preview.models.CheckNameAvailability or
         IO[bytes]
        :return: CheckNameAvailabilityResult or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2021_06_01_preview.models.CheckNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2021_06_01_preview.models.ArmDisasterRecovery or
         IO[bytes]
        :return: ArmDisasterRecovery or None or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2021_06_01_preview.models.ArmDisasterRecovery or None
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def fail_over(  # pylint: disable=inconsistent-return-statements
        ...
        namespace_name: str,
        alias: str,
        parameters: Optional[Union[_models.FailoverProperties, IO[bytes]]] = None,
        **kwargs: Any
    ) -> None:
        """Invokes GEO DR failover and reconfigure the alias to point to the secondary namespace.
        ...
        :type alias: str
        :param parameters: Parameters required to create an Alias(Disaster Recovery configuration). Is
         either a FailoverProperties type or a IO[bytes] type. Default value is None.
        :type parameters: ~azure.mgmt.servicebus.v2021_06_01_preview.models.FailoverProperties or
         IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
