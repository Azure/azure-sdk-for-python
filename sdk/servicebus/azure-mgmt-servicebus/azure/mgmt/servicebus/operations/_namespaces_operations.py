...
class NamespacesOperations(object):
    ...
    def list_network_rule_sets(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: NetworkRuleSetListResult or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.servicebus.models.NetworkRuleSetListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.mgmt.servicebus.models.ErrorResponseException>`
        """
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('NetworkRuleSetListResult', response)
