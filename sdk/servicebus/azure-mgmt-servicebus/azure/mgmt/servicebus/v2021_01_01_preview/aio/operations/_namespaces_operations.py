...
class NamespacesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2021_01_01_preview.models.SBNamespace or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either SBNamespace or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.servicebus.v2021_01_01_preview.models.SBNamespace]
    ...
    async def create_or_update_network_rule_set(
        ...
        **kwargs: Any
        ...
        :param parameters: The Namespace IpFilterRule. Is either a NetworkRuleSet type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.servicebus.v2021_01_01_preview.models.NetworkRuleSet or IO[bytes]
        :return: NetworkRuleSet or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2021_01_01_preview.models.NetworkRuleSet
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def check_name_availability(
        ...
        :type parameters: ~azure.mgmt.servicebus.v2021_01_01_preview.models.CheckNameAvailability or
         IO[bytes]
        :return: CheckNameAvailabilityResult or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2021_01_01_preview.models.CheckNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
