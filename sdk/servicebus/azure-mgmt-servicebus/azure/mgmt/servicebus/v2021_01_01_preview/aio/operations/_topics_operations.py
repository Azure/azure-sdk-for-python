...
class TopicsOperations:
    ...
    def list_authorization_rules(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicebus.v2021_01_01_preview.models.SBAuthorizationRule]
    ...
    async def create_or_update_authorization_rule(
        ...
        **kwargs: Any
        ...
        :param parameters: The shared access authorization rule. Is either a model type or a IO type.
         Required.
        :type parameters: ~azure.mgmt.servicebus.v2021_01_01_preview.models.SBAuthorizationRule or IO
    ...
    async def regenerate_keys(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.servicebus.v2021_01_01_preview.models.RegenerateAccessKeyParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def regenerate_keys(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.servicebus.v2021_01_01_preview.models.RegenerateAccessKeyParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_namespace(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicebus.v2021_01_01_preview.models.SBTopic]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2021_01_01_preview.models.SBTopic
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SBTopic or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2021_01_01_preview.models.SBTopic
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_or_update(
        ...
        namespace_name: str,
        topic_name: str,
        parameters: Union[_models.SBTopic, IO],
        **kwargs: Any
    ) -> _models.SBTopic:
        """Creates a topic in the specified namespace.
        ...
        :param topic_name: The topic name. Required.
        :type topic_name: str
        :param parameters: Parameters supplied to create a topic resource. Is either a model type or a
         IO type. Required.
        :type parameters: ~azure.mgmt.servicebus.v2021_01_01_preview.models.SBTopic or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
