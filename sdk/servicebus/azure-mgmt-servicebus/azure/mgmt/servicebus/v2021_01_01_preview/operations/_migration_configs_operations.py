...
class MigrationConfigsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either MigrationConfigListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.servicebus.v2021_01_01_preview.models.MigrationConfigListResult]
    ...
    def _create_and_start_migration_initial(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._create_and_start_migration_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'namespaceName': self._serialize.url("namespace_name", namespace_name, 'str', max_length=50, min_length=6),
    ...
    def begin_create_and_start_migration(
        ...
        **kwargs  # type: Any
        ...
        :type config_name: str or ~azure.mgmt.servicebus.v2021_01_01_preview.models.MigrationConfigurationName
        ...
        :return: An instance of LROPoller that returns either MigrationConfigProperties or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.servicebus.v2021_01_01_preview.models.MigrationConfigProperties]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def revert(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.revert.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'namespaceName': self._serialize.url("namespace_name", namespace_name, 'str', max_length=50, min_length=6),
            'configName': self._serialize.url("config_name", config_name, 'str'),
