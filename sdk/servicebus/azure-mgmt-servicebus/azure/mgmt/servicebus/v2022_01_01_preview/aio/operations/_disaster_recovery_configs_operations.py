...
class DisasterRecoveryConfigsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2022_01_01_preview.models.ArmDisasterRecovery or
         IO[bytes]
        :return: ArmDisasterRecovery or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2022_01_01_preview.models.ArmDisasterRecovery
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def fail_over(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2022_01_01_preview.models.FailoverProperties or
         IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2022_01_01_preview.models.CheckNameAvailability or
         IO[bytes]
        :return: CheckNameAvailabilityResult or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2022_01_01_preview.models.CheckNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
