...
class ArmDisasterRecovery(Resource):
    ...
    :vartype role: str or
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.RoleDisasterRecovery
    """
...
class CaptureDescription(Model):
    ...
    :type destination:
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.Destination
    """
...
class CheckNameAvailabilityResult(Model):
    ...
    :type reason: str or
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.UnavailableReason
    """
...
class Encryption(Model):
    ...
    :type key_source: str or
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.KeySource
    """
...
class ErrorResponse(Model):
    ...
    :type error:
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.ErrorResponseError
    """
...
class ErrorResponseError(Model):
    ...
    :vartype details:
     list[~azure.mgmt.servicebus.v2018_01_01_preview.models.ErrorResponse]
...
class Eventhub(Resource):
    ...
    :param status: Enumerates the possible values for the status of a Event
     ...
     'Unknown'
    :type status: str or
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.EntityStatus
...
class Identity(Model):
    ...
    :type type: str or
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.IdentityType
    """
...
class IpFilterRule(Resource):
    ...
    :param action: The IP Filter Action. Possible values include: 'Accept',
     'Reject'
    :type action: str or
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.IPAction
...
class NetworkRuleSet(Resource):
    ...
    :type ip_rules:
     list[~azure.mgmt.servicebus.v2018_01_01_preview.models.NWRuleSetIpRules]
    """
...
class NWRuleSetIpRules(Model):
    ...
    :param action: The IP Filter Action. Possible values include: 'Allow'.
     Default value: "Allow" .
    :type action: str or
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.NetworkRuleIPAction
    """
...
class Operation(Model):
    ...
    :type display:
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.OperationDisplay
    """
...
class PrivateEndpointConnection(Resource):
    ...
    :type private_endpoint:
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.PrivateEndpoint
...
class PrivateLinkResourcesListResult(Model):
    ...
    :type value:
     list[~azure.mgmt.servicebus.v2018_01_01_preview.models.PrivateLinkResource]
...
class Rule(Resource):
    ...
    :type filter_type: str or
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.FilterType
    :param sql_filter: Properties of sqlFilter
    :type sql_filter:
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.SqlFilter
...
class SBNamespace(TrackedResource):
    ...
    :type encryption:
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.Encryption
    """
...
class SBNamespaceUpdateParameters(ResourceNamespacePatch):
    ...
    def __init__(self, *, location: str=None, tags=None, sku=None, zone_redundant: bool=None, encryption=None, identity=None, **kwargs) -> None:
...
class SBQueue(Resource):
    ...
    :vartype count_details:
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.MessageCountDetails
...
class SBSku(Model):
    ...
    :param name: Required. Name of this SKU. Possible values include: 'Basic',
     'Standard', 'Premium'
    :type name: str or
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.SkuName
    :param tier: The billing tier of this particular SKU. Possible values
     include: 'Basic', 'Standard', 'Premium'
    :type tier: str or
     ~azure.mgmt.servicebus.v2018_01_01_preview.models.SkuTier
