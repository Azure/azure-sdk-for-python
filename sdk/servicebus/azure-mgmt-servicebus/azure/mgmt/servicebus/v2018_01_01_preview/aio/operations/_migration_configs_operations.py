    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either MigrationConfigListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicebus.v2018_01_01_preview.models.MigrationConfigListResult]
    ...
    async def begin_create_and_start_migration(
        ...
        **kwargs: Any
        ...
        :type config_name: str or
         ~azure.mgmt.servicebus.v2018_01_01_preview.models.MigrationConfigurationName
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.servicebus.v2018_01_01_preview.models.MigrationConfigProperties]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
