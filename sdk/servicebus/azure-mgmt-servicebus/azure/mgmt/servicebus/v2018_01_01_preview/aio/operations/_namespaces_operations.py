    ...
    def list_ip_filter_rules(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either IpFilterRuleListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicebus.v2018_01_01_preview.models.IpFilterRuleListResult]
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either SBNamespaceListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicebus.v2018_01_01_preview.models.SBNamespaceListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-01-01-preview")  # type: str
    ...
    def list_virtual_network_rules(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either VirtualNetworkRuleListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicebus.v2018_01_01_preview.models.VirtualNetworkRuleListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-01-01-preview")  # type: str
    ...
    def list_network_rule_sets(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either NetworkRuleSetListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicebus.v2018_01_01_preview.models.NetworkRuleSetListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2018-01-01-preview")  # type: str
