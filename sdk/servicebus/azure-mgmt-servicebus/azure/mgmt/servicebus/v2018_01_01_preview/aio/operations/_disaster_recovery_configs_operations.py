...
class DisasterRecoveryConfigsOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicebus.v2018_01_01_preview.models.ArmDisasterRecovery]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters required to create an Alias(Disaster Recovery configuration).
         Required.
        :type parameters: ~azure.mgmt.servicebus.v2018_01_01_preview.models.ArmDisasterRecovery
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ArmDisasterRecovery or None or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2018_01_01_preview.models.ArmDisasterRecovery or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2018_01_01_preview.models.ArmDisasterRecovery or
         IO[bytes]
        :return: ArmDisasterRecovery or None or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2018_01_01_preview.models.ArmDisasterRecovery or None
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.servicebus.v2018_01_01_preview.models.ArmDisasterRecovery
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def fail_over(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2018_01_01_preview.models.FailoverProperties
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    async def fail_over(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.servicebus.v2018_01_01_preview.models.FailoverProperties or
         IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
