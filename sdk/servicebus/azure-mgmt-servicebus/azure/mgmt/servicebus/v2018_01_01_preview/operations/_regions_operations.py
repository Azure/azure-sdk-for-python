...
def build_list_by_sku_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ServiceBus/sku/{sku}/regions")
...
class RegionsOperations(object):
    ...
    def list_by_sku(
        ...
        sku: str,
        **kwargs: Any
    ) -> Iterable["_models.PremiumMessagingRegionsListResult"]:
        ...
        :return: An iterator like instance of either PremiumMessagingRegionsListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.servicebus.v2018_01_01_preview.models.PremiumMessagingRegionsListResult]
