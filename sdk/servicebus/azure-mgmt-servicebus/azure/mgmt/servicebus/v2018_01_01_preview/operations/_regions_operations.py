...
class RegionsOperations(object):
    ...
    def list_by_sku(
        ...
        :rtype:
         ~azure.mgmt.servicebus.v2018_01_01_preview.models.PremiumMessagingRegionsPaged[~azure.mgmt.servicebus.v2018_01_01_preview.models.PremiumMessagingRegions]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.PremiumMessagingRegionsPaged(internal_paging, self._deserialize.dependencies, header_dict)
