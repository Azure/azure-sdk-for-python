...
class SubscriptionsOperations(object):
    ...
    def list_by_topic(
        ...
        :rtype:
         ~azure.mgmt.servicebus.v2018_01_01_preview.models.SBSubscriptionPaged[~azure.mgmt.servicebus.v2018_01_01_preview.models.SBSubscription]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.SBSubscriptionPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def create_or_update(
        ...
        :param parameters: Parameters supplied to create a subscription
         resource.
        :type parameters:
         ~azure.mgmt.servicebus.v2018_01_01_preview.models.SBSubscription
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype:
         ~azure.mgmt.servicebus.v2018_01_01_preview.models.SBSubscription or
