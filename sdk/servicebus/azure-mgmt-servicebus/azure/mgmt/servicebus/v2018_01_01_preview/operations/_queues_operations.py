...
class QueuesOperations(object):
    ...
    def list_by_namespace(
        ...
        :rtype:
         ~azure.mgmt.servicebus.v2018_01_01_preview.models.SBQueuePaged[~azure.mgmt.servicebus.v2018_01_01_preview.models.SBQueue]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.servicebus.v2018_01_01_preview.models.ErrorResponseException>`
        """
        def prepare_request(next_link=None):
        ...
        if raw:
            header_dict = {}
        deserialized = models.SBQueuePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def create_or_update(
        ...
        :param parameters: Parameters supplied to create or update a queue
         resource.
        :type parameters:
         ~azure.mgmt.servicebus.v2018_01_01_preview.models.SBQueue
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~azure.mgmt.servicebus.v2018_01_01_preview.models.SBQueue or
