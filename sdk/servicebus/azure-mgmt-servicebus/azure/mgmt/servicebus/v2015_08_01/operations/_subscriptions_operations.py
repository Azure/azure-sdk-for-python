...
class SubscriptionsOperations(object):
    ...
    def list_all(
        ...
        :return: An iterator like instance of SubscriptionResource
        :rtype:
         ~azure.mgmt.servicebus.v2015_08_01.models.SubscriptionResourcePaged[~azure.mgmt.servicebus.v2015_08_01.models.SubscriptionResource]
        ...
        if raw:
            header_dict = {}
        deserialized = models.SubscriptionResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list_all.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/topics/{topicName}/subscriptions'}
    ...
    def create_or_update(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: SubscriptionResource or ClientRawResponse if raw=true
