...
class NamespacesOperations:
    ...
    def check_name_availability(
        ...
        :type parameters: ~azure.mgmt.servicebus.v2015_08_01.models.CheckNameAvailability or IO[bytes]
        :return: CheckNameAvailabilityResult or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2015_08_01.models.CheckNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        resource_group_name: str,
        namespace_name: str,
        parameters: Union[_models.NamespaceUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> Optional[_models.NamespaceResource]:
        """Updates a service namespace. Once created, this namespace's resource manifest is immutable.
        This operation is idempotent.
        ...
        :type parameters: ~azure.mgmt.servicebus.v2015_08_01.models.NamespaceUpdateParameters or
         IO[bytes]
        :return: NamespaceResource or None or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2015_08_01.models.NamespaceResource or None
        :raises ~azure.core.exceptions.HttpResponseError:
