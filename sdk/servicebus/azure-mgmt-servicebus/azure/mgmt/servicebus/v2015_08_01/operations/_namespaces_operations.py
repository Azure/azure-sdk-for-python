...
def build_check_name_availability_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ServiceBus/CheckNameAvailability"
    )
...
class NamespacesOperations:
    ...
    def check_name_availability(
        ...
        :type parameters: ~azure.mgmt.servicebus.v2015_08_01.models.CheckNameAvailability or IO
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.NamespaceResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.servicebus.v2015_08_01.models.NamespaceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.NamespaceResource"]:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either NamespaceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.servicebus.v2015_08_01.models.NamespaceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        resource_group_name: str,
        namespace_name: str,
        parameters: Union[_models.NamespaceUpdateParameters, IO],
        **kwargs: Any
    ) -> Optional[_models.NamespaceResource]:
        """Updates a service namespace. Once created, this namespace's resource manifest is immutable.
        This operation is idempotent.
        ...
        :param parameters: Parameters supplied to update a namespace resource. Is either a
         NamespaceUpdateParameters type or a IO type. Required.
        :type parameters: ~azure.mgmt.servicebus.v2015_08_01.models.NamespaceUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
