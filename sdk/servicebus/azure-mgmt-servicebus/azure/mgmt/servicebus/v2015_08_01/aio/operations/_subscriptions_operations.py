...
class SubscriptionsOperations:
    ...
    def list_all(
    ...
    ) -> AsyncIterable["_models.SubscriptionResource"]:
        ...
        :type topic_name: str
        :return: An iterator like instance of either SubscriptionResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.servicebus.v2015_08_01.models.SubscriptionResource]
    ...
    async def create_or_update(
        ...
        topic_name: str,
        subscription_name: str,
        parameters: Union[_models.SubscriptionCreateOrUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.SubscriptionResource:
        """Creates a topic subscription.
        ...
        :type parameters:
         ~azure.mgmt.servicebus.v2015_08_01.models.SubscriptionCreateOrUpdateParameters or IO[bytes]
        :return: SubscriptionResource or the result of cls(response)
        :rtype: ~azure.mgmt.servicebus.v2015_08_01.models.SubscriptionResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        deserialized = self._deserialize("SubscriptionResource", pipeline_response.http_response)
