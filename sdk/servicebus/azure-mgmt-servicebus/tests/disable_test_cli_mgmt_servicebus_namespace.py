...
class TestMgmtServiceBus(AzureMgmtRecordedTestCase):
    ...
    def setup_method(self, method):
        self.mgmt_client = self.create_mgmt_client(azure.mgmt.servicebus.ServiceBusManagementClient)
        self.mgmt_client2017 = self.create_mgmt_client(
            azure.mgmt.servicebus.ServiceBusManagementClient, api_version="2017-04-01"
        )
    ...
    def test_namespace(self, resource_group):
        ...
        result = self.mgmt_client.namespaces.begin_create_or_update(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, parameters=BODY
        )
        ...
        result = self.mgmt_client.namespaces.create_or_update_authorization_rule(
        ...
        result = self.mgmt_client.namespaces.create_or_update_network_rule_set(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, parameters=BODY
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.namespaces.get_authorization_rule(
            resource_group_name=RESOURCE_GROUP,
            namespace_name=NAMESPACE_NAME,
            authorization_rule_name=AUTHORIZATION_RULE_NAME,
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.namespaces.get_network_rule_set(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME
        )

        # --------------------------------------------------------------------------
        # /Namespaces/get/NameSpaceAuthorizationRuleListAll[get]
        # --------------------------------------------------------------------------
        result = self.mgmt_client.namespaces.list_authorization_rules(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.event_hubs.list_by_namespace(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME
        )
        ...
        result = self.mgmt_client.namespaces.regenerate_keys(
            resource_group_name=RESOURCE_GROUP,
            namespace_name=NAMESPACE_NAME,
            authorization_rule_name=AUTHORIZATION_RULE_NAME,
            parameters=BODY,
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.namespaces.list_keys(
            resource_group_name=RESOURCE_GROUP,
            namespace_name=NAMESPACE_NAME,
            authorization_rule_name=AUTHORIZATION_RULE_NAME,
        )
        ...
        # --------------------------------------------------------------------------
        BODY = {"target_namespace_type": "EventHub"}
        ...
        # --------------------------------------------------------------------------
        BODY = {"location": AZURE_LOCATION, "tags": {"tag3": "value3", "tag4": "value4"}}
        result = self.mgmt_client.namespaces.update(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, parameters=BODY
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.namespaces.delete_authorization_rule(
            resource_group_name=RESOURCE_GROUP,
            namespace_name=NAMESPACE_NAME,
            authorization_rule_name=AUTHORIZATION_RULE_NAME,
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.namespaces.begin_delete(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME
        )
        try:
    ...
    def test_migration_configs(self, resource_group):
        ...
        result = self.mgmt_client.namespaces.begin_create_or_update(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME_PRIMARY, parameters=BODY
        )
        ...
        # --------------------------------------------------------------------------
        BODY = {"target_namespace": second_namespace.id, "post_migration_name": POST_MIGRATION_NAME}
        result = self.mgmt_client.migration_configs.begin_create_and_start_migration(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, config_name=CONFIG_NAME, parameters=BODY
        )
        result = result.result()
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.migration_configs.list(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME
        )
        ...
        # --------------------------------------------------------------------------
        BODY = {"target_namespace_type": "EventHub"}
        result = self.mgmt_client.namespaces.migrate(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, parameters=BODY
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.migration_configs.revert(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, config_name=CONFIG_NAME
        )

        # --------------------------------------------------------------------------
        # /MigrationConfigs/post/MigrationConfigurationsCompleteMigration[post]
        # --------------------------------------------------------------------------
        result = self.mgmt_client.migration_configs.complete_migration(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, config_name=CONFIG_NAME
        )
        ...
        # --------------------------------------------------------------------------
        migration = self.mgmt_client.migration_configs.get(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, config_name=CONFIG_NAME
        )
        if self.is_live:
            count = 0
        ...
        # --------------------------------------------------------------------------
        try:
            result = self.mgmt_client.migration_configs.delete(
                resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, config_name=CONFIG_NAME
            )
        except HttpResponseError as e:
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.namespaces.begin_delete(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME_PRIMARY
        )
        try:
            result = result.result()
        except HttpResponseError as e:
    ...
    def test_disaster_recovery_configs(self, resource_group):
        ...
        result = self.mgmt_client2017.disaster_recovery_configs.check_name_availability(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, parameters=BODY
        )
        ...
        result = self.mgmt_client2017.disaster_recovery_configs.create_or_update(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, alias=ALIAS, parameters=BODY
        )

        # --------------------------------------------------------------------------
        # /DisasterRecoveryConfigs/get/SBAliasGet[get]
        # --------------------------------------------------------------------------
        dr_config = self.mgmt_client2017.disaster_recovery_configs.get(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, alias=ALIAS
        )
        if self.is_live:
            count = 0
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client2017.disaster_recovery_configs.get_authorization_rule(
            resource_group_name=RESOURCE_GROUP,
            namespace_name=NAMESPACE_NAME,
            alias=ALIAS,
            authorization_rule_name=AUTHORIZATION_RULE_NAME,
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client2017.disaster_recovery_configs.list_authorization_rules(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, alias=ALIAS
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client2017.disaster_recovery_configs.list(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client2017.disaster_recovery_configs.list_keys(
            resource_group_name=RESOURCE_GROUP,
            namespace_name=NAMESPACE_NAME,
            alias=ALIAS,
            authorization_rule_name=AUTHORIZATION_RULE_NAME,
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client2017.disaster_recovery_configs.break_pairing(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, alias=ALIAS
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client2017.disaster_recovery_configs.fail_over(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME_PRIMARY, alias=ALIAS
        )
        ...
        while count < 10:
            try:
                result = self.mgmt_client2017.disaster_recovery_configs.delete(
                    resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, alias=ALIAS
                )
            except HttpResponseError as e:
                time.sleep(30)
