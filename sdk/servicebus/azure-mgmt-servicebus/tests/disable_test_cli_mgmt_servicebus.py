...
class MgmtServiceBusTest(AzureMgmtTestCase):
    ...
    def test_servicebus(self, resource_group):
        ...
        result = self.mgmt_client.namespaces.begin_create_or_update(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME_SECOND, parameters=BODY
        )
        ...
        # --------------------------------------------------------------------------
        BODY = {"enable_express": True}
        result = self.mgmt_client.topics.create_or_update(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, topic_name=TOPIC_NAME, parameters=BODY
        )
        ...
        # --------------------------------------------------------------------------
        BODY = {"enable_batched_operations": True}
        result = self.mgmt_client.subscriptions.create_or_update(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, topic_name=TOPIC_NAME, parameters=BODY
        )
        ...
        # --------------------------------------------------------------------------
        BODY = {"rights": ["Listen", "Send"]}
        result = self.mgmt_client.topics.create_or_update_authorization_rule(
            resource_group_name=RESOURCE_GROUP,
            namespace_name=NAMESPACE_NAME,
        ...
        # --------------------------------------------------------------------------
        BODY = {"filter_type": "CorrelationFilter", "correlation_filter": {"properties": {"topic_hint": "Crop"}}}
        result = self.mgmt_client.rules.create_or_update(
            resource_group_name=RESOURCE_GROUP,
            namespace_name=NAMESPACE_NAME,
            topic_name=TOPIC_NAME,
            rule_name=RULE_NAME,
        ...
        # --------------------------------------------------------------------------
        BODY = {"filter_type": "SqlFilter", "sql_filter": {"sql_expression": "myproperty=test"}}
        result = self.mgmt_client.rules.create_or_update(
            resource_group_name=RESOURCE_GROUP,
            namespace_name=NAMESPACE_NAME,
            topic_name=TOPIC_NAME,
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.rules.get(
            resource_group_name=RESOURCE_GROUP,
            namespace_name=NAMESPACE_NAME,
            topic_name=TOPIC_NAME,
            rule_name=RULE_NAME,
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.topics.get_authorization_rule(
            resource_group_name=RESOURCE_GROUP,
            namespace_name=NAMESPACE_NAME,
            topic_name=TOPIC_NAME,
            authorization_rule_name=AUTHORIZATION_RULE_NAME,
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.rules.list_by_subscriptions(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, topic_name=TOPIC_NAME
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.subscriptions.list_by_topic(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, topic_name=TOPIC_NAME
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.topics.list_authorization_rules(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, topic_name=TOPIC_NAME
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.disaster_recovery_configs.list(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.topics.list_by_namespace(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.namespaces.list_network_rule_sets(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME
        )
        ...
        result = self.mgmt_client.topics.regenerate_keys(
            resource_group_name=RESOURCE_GROUP,
            namespace_name=NAMESPACE_NAME,
            topic_name=TOPIC_NAME,
            authorization_rule_name=AUTHORIZATION_RULE_NAME,
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.topics.list_keys(
            resource_group_name=RESOURCE_GROUP,
            namespace_name=NAMESPACE_NAME,
            topic_name=TOPIC_NAME,
            authorization_rule_name=AUTHORIZATION_RULE_NAME,
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.rules.delete(
            resource_group_name=RESOURCE_GROUP,
            namespace_name=NAMESPACE_NAME,
            topic_name=TOPIC_NAME,
            rule_name=RULE_NAME,
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.topics.delete_authorization_rule(
            resource_group_name=RESOURCE_GROUP,
            namespace_name=NAMESPACE_NAME,
            topic_name=TOPIC_NAME,
            authorization_rule_name=AUTHORIZATION_RULE_NAME,
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.subscriptions.delete(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, topic_name=TOPIC_NAME
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.topics.delete(
            resource_group_name=RESOURCE_GROUP, namespace_name=NAMESPACE_NAME, topic_name=TOPIC_NAME
        )
