...
class Analysis:
    ...
    def narrow(self, lines: Container[TLineNo]) -> Analysis:
        ...
        if self.has_arcs:
            _arc_possibilities_set = {(a, b) for a, b in self._arc_possibilities_set if a in lines or b in lines}
            _arcs_executed_set = {(a, b) for a, b in self._arcs_executed_set if a in lines or b in lines}
    ...
    def arcs_missing(self) -> list[TArc]:
        ...
        missing = (
            ...
            if p not in self.arcs_executed and p[0] not in self.no_branch and p[1] not in self.excluded
        )
    ...
    def arcs_unpredicted(self) -> list[TArc]:
        ...
        unpredicted = (
            e for e in self.arcs_executed if e not in self.arc_possibilities and e[0] != e[1] and (e[0] > 0 or e[1] > 0)
        )
