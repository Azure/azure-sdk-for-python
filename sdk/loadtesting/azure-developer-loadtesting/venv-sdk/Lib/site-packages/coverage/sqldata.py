    ...
    def update(
        ...
        with self._connect() as con:
            ...
            if arcs:
                ...
                arc_rows = (
                    (file_ids[file], context_ids[context], fromno, tono) for file, context, fromno, tono in arcs
                )
            ...
            if lines:
                ...
                con.executemany_void(
                    "insert or replace into line_bits " + "(file_id, context_id, numbits) values (?, ?, ?)",
                    [(file_ids[file], context_ids[context], numbits) for (file, context), numbits in lines.items()],
                )
