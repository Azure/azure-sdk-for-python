...
class Markup(str):
    ...
    def __new__(cls, base: t.Any = "", encoding: t.Optional[str] = None, errors: str = "strict") -> "te.Self":
    ...
    def split(self, sep: t.Optional[str] = None, maxsplit: int = -1) -> t.List["te.Self"]:  # type: ignore[override]
        return [self.__class__(v) for v in super().split(sep, maxsplit)]

    split.__doc__ = str.split.__doc__

    def rsplit(self, sep: t.Optional[str] = None, maxsplit: int = -1) -> t.List["te.Self"]:  # type: ignore[override]
        return [self.__class__(v) for v in super().rsplit(sep, maxsplit)]

    rsplit.__doc__ = str.rsplit.__doc__

    def splitlines(self, keepends: bool = False) -> t.List["te.Self"]:  # type: ignore[override]
    ...
    def format_map(self, map: t.Mapping[str, t.Any]) -> "te.Self":  # type: ignore[override]
        formatter = EscapeFormatter(self.escape)
