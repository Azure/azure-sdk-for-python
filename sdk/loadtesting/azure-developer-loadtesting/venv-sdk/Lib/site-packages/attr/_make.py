...
def _transform_attrs(cls, these, auto_attribs, kw_only, collect_by_mro, field_transformer):
    ...
    *collect_by_mro* is True, collect them in the correct MRO order, otherwise
    ...
    own_attrs = [
        Attribute.from_counting_attr(name=attr_name, ca=ca, type=anns.get(attr_name)) for attr_name, ca in ca_list
    ]
...
class _ClassBuilder:
        ...
        if frozen:
            ...
            for a in attrs:
                ...
                if has_validator and has_converter:
                    break
            if (
                (on_setattr == _ng_default_on_setattr and not (has_validator or has_converter))
    ...
    def _add_method_dunders(self, method):
        ...
        with contextlib.suppress(AttributeError):
            method.__doc__ = "Method generated by attrs for class " f"{self._cls.__qualname__}."
...
def _attrs_to_init_script(
    ...
    if kw_only_args:
        ...
        pre_init_args += ", " if pre_init_args else ""  # handle only kwargs and no regular args
