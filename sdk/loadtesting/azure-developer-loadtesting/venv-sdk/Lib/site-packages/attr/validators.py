...
def provides(interface):
    ...
    warnings.warn(
        "attrs's zope-interface support is deprecated and will be removed in, " "or after, April 2024.",
        DeprecationWarning,
        stacklevel=2,
    )
...
class _NotValidator:
    ...
    def __repr__(self):
        return ("<not_ validator wrapping {what!r}, capturing {exc_types!r}>").format(
            what=self.validator,
            exc_types=self.exc_types,
        )
