...
def CheckLoaderModule(dll_name):
    ...
    try:
        ...
        same = src_stat[stat.ST_SIZE] == dest_stat[stat.ST_SIZE] and src_stat[stat.ST_MTIME] == dest_stat[stat.ST_MTIME]
    if not same:
...
def HandleCommandLine(
    ...
    parser.add_option(
        ...
        "--server",
        action="store",
        help="Specifies the IIS server to install/uninstall on." " Default is '%s/1'" % (_IIS_OBJECT,),
    )
