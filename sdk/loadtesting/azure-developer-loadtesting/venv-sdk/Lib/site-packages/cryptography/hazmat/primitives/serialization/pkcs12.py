...
class PKCS12Certificate:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return self.certificate == other.certificate and self.friendly_name == other.friendly_name

    def __hash__(self) -> int:
        return hash((self.certificate, self.friendly_name))

    def __repr__(self) -> str:
        return "<PKCS12Certificate({}, friendly_name={!r})>".format(self.certificate, self.friendly_name)
