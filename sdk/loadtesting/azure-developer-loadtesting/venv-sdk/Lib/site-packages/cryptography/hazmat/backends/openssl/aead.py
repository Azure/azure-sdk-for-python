...
def _encrypt(
    ...
    return _evp_cipher_encrypt(backend, cipher, nonce, data, associated_data, tag_length)
...
def _decrypt(
    ...
    return _evp_cipher_decrypt(backend, cipher, nonce, data, associated_data, tag_length)
