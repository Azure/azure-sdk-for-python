...
def get_unused_port_socket(host: str, family: socket.AddressFamily = socket.AF_INET) -> socket.socket:
...
class BaseTestServer(ABC):
    ...
    def __init__(
        ...
        *,
        ...
        socket_factory: Callable[[str, int, socket.AddressFamily], socket.socket] = get_port_socket,
        **kwargs: Any,
    ) -> None:
        self._loop = loop
