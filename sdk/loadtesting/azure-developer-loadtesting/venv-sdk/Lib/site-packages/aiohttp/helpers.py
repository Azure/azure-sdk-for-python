...
DEBUG = sys.flags.dev_mode or (not sys.flags.ignore_environment and bool(os.environ.get("PYTHONASYNCIODEBUG")))
...
def netrc_from_env() -> Optional[netrc.netrc]:
    ...
    if netrc_env is not None:
        ...
        try:
            ...
            client_logger.debug(
                "Could not resolve home directory when " "trying to look for .netrc file: %s",
                e,
            )
            return None
