...
class TypeVar(metaclass=_TypeVarLikeMeta):
    ...
    def __new__(
        cls, name, *constraints, bound=None, covariant=False, contravariant=False, default=_marker, infer_variance=False
    ):
...
if hasattr(typing, "ParamSpec"):
    ...
    class ParamSpec(metaclass=_TypeVarLikeMeta):
        ...
        def __new__(
            cls, name, *, bound=None, covariant=False, contravariant=False, infer_variance=False, default=_marker
        ):
            if hasattr(typing, "TypeAliasType"):
...
# 3.8-3.9
    ...
    class ParamSpec(list, _DefaultMixin):
        ...
        def __init__(
            self, name, *, bound=None, covariant=False, contravariant=False, infer_variance=False, default=_marker
        ):
            super().__init__([self])
            self.__name__ = name
