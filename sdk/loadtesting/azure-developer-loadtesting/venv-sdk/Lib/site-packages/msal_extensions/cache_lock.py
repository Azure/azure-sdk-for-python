...
class CrossPlatLock(object):
    ...
    def __init__(self, lockfile_path):
        ...
        open_kwargs = {"buffering": 0} if Version(portalocker.__version__) >= Version("1.4.0") else {}
    ...
    def _try_to_create_lock_file(self):
        ...
        while timeout_end > current_time():
            try:
                ...
                logger.debug("Process %d found existing lock file, will retry after %f second", pid, check_interval)
