...
class LibSecretAgent(object):
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        self._schema = Secret.Schema.new(
            ...
            {k: (attribute_types or {}).get(k, Secret.SchemaAttributeType.STRING) for k in self._attributes},
        )

    def save(self, data):
        """Store data. Returns a boolean of whether operation was successful."""
        return Secret.password_store_sync(self._schema, self._attributes, self._collection, self._label, data, None)
