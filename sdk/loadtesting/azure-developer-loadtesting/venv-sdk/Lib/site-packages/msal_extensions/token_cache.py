...
class PersistedTokenCache(msal.SerializableTokenCache):
    ...
    def __init__(self, persistence, lock_location=None):
        ...
        self._lock_location = (
            os.path.expanduser(lock_location) if lock_location else persistence.get_location() + ".lockfile"
        )
    ...
    def modify(self, credential_type, old_entry, new_key_value_pairs=None):
        with CrossPlatLock(self._lock_location):
            ...
            super(PersistedTokenCache, self).modify(credential_type, old_entry, new_key_value_pairs=new_key_value_pairs)
