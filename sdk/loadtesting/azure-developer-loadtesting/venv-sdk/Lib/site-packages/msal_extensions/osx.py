...
class KeychainError(OSError):
    ...
    def __init__(self, exit_status):
        ...
        self.message = "{} see https://opensource.apple.com/source/CarbonHeaders/CarbonHeaders-18.1/MacErrors.h".format(  # pylint: disable=consider-using-f-string,line-too-long
            self.exit_status
        )
...
_SECURITY_KEYCHAIN_ITEM_MODIFY_ATTRIBUTES_AND_DATA = _SECURITY.SecKeychainItemModifyAttributesAndData
    ...
    def set_generic_password(self, service, account_name, value):
        ...
        if not find_exit_status:
            ...
            add_exit_status = _SECURITY_KEYCHAIN_ADD_GENERIC_PASSWORD(
                self._ref, len(service), service, len(account_name), account_name, len(value), value, None
            )
