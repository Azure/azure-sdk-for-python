...
class AssertionCreator(object):
    def create_normal_assertion(
        self, audience, issuer, subject, expires_at=None, expires_in=600, issued_at=None, assertion_id=None, **kwargs
    ):
    ...
    def create_regenerative_assertion(self, audience, issuer, subject=None, expires_in=600, **kwargs):
...
class JwtAssertionCreator(AssertionCreator):
    def __init__(self, key, algorithm, sha1_thumbprint=None, headers=None):
        ...
        if sha1_thumbprint:  # https://tools.ietf.org/html/rfc7515#section-4.1.7
            self.headers["x5t"] = base64.urlsafe_b64encode(binascii.a2b_hex(sha1_thumbprint)).decode()
