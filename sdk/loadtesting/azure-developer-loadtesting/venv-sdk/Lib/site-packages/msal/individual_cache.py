...
class _ExpiringMapping(MutableMapping):
    ...
    def __init__(self, mapping=None, capacity=None, expires_in=None, lock=None, *args, **kwargs):
    ...
    def _validate_key(self, key):
        if key == self._INDEX:
            raise ValueError("key {} is a reserved keyword in {}".format(key, self.__class__.__name__))
