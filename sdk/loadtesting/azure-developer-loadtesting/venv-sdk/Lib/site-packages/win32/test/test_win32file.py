...
class TestDirectoryChanges(unittest.TestCase):
    ...
    def _watcherThread(self, dn, dh, changes):
        ...
        while 1:
            try:
                print("waiting", dh)
                changes = win32file.ReadDirectoryChangesW(dh, 8192, False, flags)  # sub-tree
                print("got", changes)
            except:
                raise
    ...
    def _watcherThreadOverlapped(self, dn, dh, changes):
        ...
        overlapped.hEvent = win32event.CreateEvent(None, 0, 0, None)
        while 1:
            win32file.ReadDirectoryChangesW(dh, buf, False, flags, overlapped)  # sub-tree
...
class TestWSAEnumNetworkEvents(unittest.TestCase):
    ...
    def test_functional(self):
        ...
        win32file.WSAEventSelect(
            client,
            client_event,
            win32file.FD_CONNECT | win32file.FD_READ | win32file.FD_WRITE | win32file.FD_CLOSE,
        )
