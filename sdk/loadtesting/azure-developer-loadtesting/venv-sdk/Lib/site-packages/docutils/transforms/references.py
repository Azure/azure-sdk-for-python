    ...
    def visit_reference(self, node):
        ...
        if id is None:
            for resolver_function in self.unknown_reference_resolvers:
                ...
                if getattr(self.document.settings, "use_bibtex", False) and isinstance(node, nodes.citation_reference):
                ...
                if refname in self.document.nameids:
                    ...
                    msg = self.document.reporter.error(f'Unknown target name: "{node["refname"]}".', base_node=node)
                msgid = self.document.set_id(msg)
