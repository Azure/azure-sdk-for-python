...
class CustomRole:
    ...
    def __call__(self, role, rawtext, text, lineno, inliner, options=None, content=None):
        ...
        return self.base_role(
            role, rawtext, text, lineno, inliner, options=opts, content=supplied_content + delimiter + content
        )
...
def code_role(role, rawtext, text, lineno, inliner, options=None, content=None):
    ...
    try:
        tokens = Lexer(nodes.unescape(text, True), language, inliner.document.settings.syntax_highlight)
