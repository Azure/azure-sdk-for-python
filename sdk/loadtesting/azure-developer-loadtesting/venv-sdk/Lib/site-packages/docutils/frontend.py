...
def validate_boolean(setting, value=None, option_parser=None, config_parser=None, config_section=None):
...
def validate_nonnegative_int(setting, value=None, option_parser=None, config_parser=None, config_section=None):
    # All arguments except `value` are ignored
    # (kept for compatibility with "optparse" module).
    # If there is only one positional argument, it is interpreted as `value`.
    if value is None:
...
def validate_threshold(setting, value=None, option_parser=None, config_parser=None, config_section=None):
    # All arguments except `value` are ignored
    # (kept for compatibility with "optparse" module).
    # If there is only one positional argument, it is interpreted as `value`.
    if value is None:
...
def validate_comma_separated_list(setting, value=None, option_parser=None, config_parser=None, config_section=None):
...
def validate_math_output(setting, value=None, option_parser=None, config_parser=None, config_section=None):
    ...
    if format == "mathml":
        ...
        if converter not in tex2mathml_converters:
            raise LookupError(
                f'MathML converter "{options}" not supported,\n' f"    choose from {tex2mathml_converters}."
            )
        options = converter
    return [format, options]


def validate_url_trailing_slash(setting, value=None, option_parser=None, config_parser=None, config_section=None):
    # All arguments except `value` are ignored
    # (kept for compatibility with "optparse" module).
    # If there is only one positional argument, it is interpreted as `value`.
    if value is None:
...
def validate_dependency_file(setting, value=None, option_parser=None, config_parser=None, config_section=None):
    # All arguments except `value` are ignored
    # (kept for compatibility with "optparse" module).
    # If there is only one positional argument, it is interpreted as `value`.
    if value is None:
...
def validate_smartquotes_locales(setting, value=None, option_parser=None, config_parser=None, config_section=None):
...
def make_one_path_absolute(base_path, path):
    # deprecated, will be removed
    warnings.warn(
        "frontend.make_one_path_absolute() will be removed " "in Docutils 0.23.", DeprecationWarning, stacklevel=2
    )
...
class Values(optparse.Values):
    ...
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "frontend.Values class will be removed " "in Docutils 0.21 or later.", DeprecationWarning, stacklevel=2
        )
...
class Option(optparse.Option):
    ...
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "The frontend.Option class will be removed " "in Docutils 0.21 or later.", DeprecationWarning, stacklevel=2
        )
        super().__init__(*args, **kwargs)
...
class OptionParser(optparse.OptionParser, docutils.SettingsSpec):
    ...
    default_error_encoding = getattr(sys.stderr, "encoding", None) or io._locale_encoding or "ascii"  # noqa
    ...
    settings_spec = (
        ...
        (
            ...
            ("Specify the document title as metadata.", ["--title"], {"metavar": "<title>"}),
            (
            ...
            (
                ...
                ["--footnote-backlinks"],
                {"action": "store_true", "default": True, "validator": validate_boolean},
            ),
            (
            ...
            (
                ...
                ["--section-numbering"],
                {"action": "store_true", "dest": "sectnum_xform", "default": True, "validator": validate_boolean},
            ),
            (
            ...
            (
                ...
                "for error output.  Default: %s:%s." % (default_error_encoding, default_error_encoding_error_handler),
                ["--error-encoding", "-e"],
                {
    ...
    def __init__(self, components=(), defaults=None, read_config_files=False, *args, **kwargs):
        ...
        warnings.warn(
            "The frontend.OptionParser class will be replaced "
        ...
        super().__init__(
            option_class=Option, add_help_option=None, formatter=optparse.TitledHelpFormatter(width=78), *args, **kwargs
        )
        if not self.version:
    ...
    def get_config_file_settings(self, config_file):
        ...
        make_paths_absolute(settings.__dict__, self.relative_path_settings, os.path.dirname(config_file))
    ...
    def set_defaults_from_dict(self, defaults):
        # deprecated, will be removed
        warnings.warn(
            "OptionParser.set_defaults_from_dict() will be removed "
...
"""
    ...
    def read(self, filenames, option_parser=None):
        ...
        if option_parser is not None:
            warnings.warn(
                "frontend.ConfigParser.read(): parameter "
    ...
    def get_section(self, section):
        ...
        """
        warnings.warn(
            "frontend.OptionParser.get_section() " "will be removed in Docutils 0.21 or later.",
            DeprecationWarning,
            stacklevel=2,
        )
        try:
