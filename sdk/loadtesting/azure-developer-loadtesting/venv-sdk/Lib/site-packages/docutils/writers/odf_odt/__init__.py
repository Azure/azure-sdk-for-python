    ...
    settings_spec = (
        ...
        (
            ...
            (
                ...
                {"default": None, "metavar": "<int>", "validator": frontend.validate_nonnegative_int},
            ),
            (
            ...
            (
                ...
                ["--generate-list-toc"],
                {"action": "store_false", "dest": "generate_oowriter_toc", "validator": frontend.validate_boolean},
            ),
            (
            ...
            for node in n2_nodes:
                ...
                if family == "paragraph" or family == "graphic":
                    ...
                    if language_code is not None:
                        n3.attrib["{urn:oasis:names:tc:opendocument:xmlns:" "xsl-fo-compatible:1.0}language"] = (
                            language_code
                        )
                        n3.attrib["{urn:oasis:names:tc:opendocument:xmlns:" "style:1.0}language-complex"] = (
                            language_code
                        )
                        updated = True
                        modified_nodes.add(n3)
                    if region_code is not None:
                        n3.attrib["{urn:oasis:names:tc:opendocument:xmlns:" "xsl-fo-compatible:1.0}country"] = (
                            region_code
                        )
        ...
        if source in self.image_dict:
            ...
            if uri_parts.scheme in ("", "file"):
                ...
                try:
                    ...
                    self.document.reporter.warning(f'Cannot open image URL "{source}". {err}')
                    return
