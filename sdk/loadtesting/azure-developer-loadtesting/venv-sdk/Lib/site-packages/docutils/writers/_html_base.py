...
class HTMLTranslator(nodes.NodeVisitor):
    ...
    def prepare_svg(self, node, imagedata, size_declaration):
        ...
        # SVG namespace
        svg_ns = {"": "http://www.w3.org/2000/svg", "xlink": "http://www.w3.org/1999/xlink"}
        ...
        if size_declaration:  # append to style, replacing width & height
            ...
            declarations = [d for d in declarations if d and not d.startswith("width") and not d.startswith("height")]
