...
class Table:
    ...
    def get_opening(self, width=r"\linewidth"):
        ...
        if align and latex_type not in ("longtable", "longtable*"):
            opening = [r"\noindent\makebox[\linewidth]%s{%%" % (align,), r"\begin{%s}" % (latex_type,)]
        else:
    ...
    def get_caption(self):
        ...
        warnings.warn(
            "`writers.latex2e.Table.get_caption()` is obsolete" " and will be removed in Docutils 0.22.",
            DeprecationWarning,
            stacklevel=2,
        )
...
class LaTeXTranslator(nodes.NodeVisitor):
    ...
    def __init__(self, document, babel_class=Babel):
        ...
        # Document parts
        self.head_prefix = [r"\documentclass[%s]{%s}" % (self.documentoptions, settings.documentclass)]
    ...
    def depart_table(self, node):
        ...
        if not self.active_table.caption:
            self.out.extend(self.ids_to_labels(node, set_anchor=len(self.table_stack) != 1, newline=True))
