...
class HTMLTranslator(_html_base.HTMLTranslator):
    ...
    def visit_authors(self, node):
        ...
        for subnode in node:
            self.meta.append('<meta name="author" content=' f'"{self.attval(subnode.astext())}" />\n')
    ...
    def visit_copyright(self, node):
        ...
        self.meta.append('<meta name="dcterms.rights" ' f'content="{self.attval(node.astext())}" />\n')
    ...
    def visit_date(self, node):
        ...
        self.meta.append('<meta name="dcterms.date" ' f'content="{self.attval(node.astext())}" />\n')
    ...
    def section_title_tags(self, node):
        ...
        if ids and getattr(self.settings, "section_self_link", None) and not isinstance(node.parent, nodes.document):
            self_link = '<a class="self-link" title="link to this section"' f' href="#{ids[0]}"></a>'
