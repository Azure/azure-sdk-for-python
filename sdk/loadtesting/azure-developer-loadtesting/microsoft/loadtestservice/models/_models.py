...
from ....customizations import _model_base
from ....customizations._model_base import rest_discriminator, rest_field
...
class CertificateMetadata(_model_base.Model):
    ...
    :vartype type: str or ~customizations.models.CertificateType
...
class FunctionFlexConsumptionTargetResourceConfigurations(
    ...
    :vartype kind: str or ~customizations.models.FUNCTIONS_FLEX_CONSUMPTION
    ...
    :vartype configurations: dict[str,
     ~customizations.models.FunctionFlexConsumptionResourceConfiguration]
    """
...
class LoadTestConfiguration(_model_base.Model):
    ...
    :vartype optional_load_test_config: ~customizations.models.OptionalLoadTestConfiguration
    :ivar regional_load_test_config: Region distribution configuration for the load test.
    :vartype regional_load_test_config: list[~customizations.models.RegionalConfiguration]
    """
...
class MetricAvailability(_model_base.Model):
    ...
    :vartype time_grain: str or ~customizations.models.TimeGrain
    """
...
class MetricDefinition(_model_base.Model):
    ...
    :vartype dimensions: list[~customizations.models.NameAndDescription]
    ...
    :vartype primary_aggregation_type: str or ~customizations.models.Aggregation
    ...
    :vartype unit: str or ~customizations.models.MetricUnit
    :ivar metric_availabilities: Metric availability specifies the time grain (aggregation interval
     or
     frequency).
    :vartype metric_availabilities: list[~customizations.models.MetricAvailability]
    """
...
class MetricDefinitionCollection(_model_base.Model):
    ...
    :vartype value: list[~customizations.models.MetricDefinition]
    """
...
class MetricNamespaceCollection(_model_base.Model):
    ...
    :vartype value: list[~customizations.models.MetricNamespace]
    """
...
class MetricRequestPayload(_model_base.Model):
    ...
    :vartype filters: list[~customizations.models.DimensionFilter]
    """
...
class PassFailCriteria(_model_base.Model):
    ...
    :vartype pass_fail_metrics: dict[str, ~customizations.models.PassFailMetric]
    :ivar pass_fail_server_metrics: Map of id and pass fail server metrics { id  : pass fail
     metrics }.
    :vartype pass_fail_server_metrics: dict[str, ~customizations.models.PassFailServerMetric]
    """
...
class PassFailMetric(_model_base.Model):
    ...
    :vartype client_metric: str or ~customizations.models.PFMetrics
    ...
    :vartype aggregate: str or ~customizations.models.PassFailAggregationFunction
    ...
    :ivar action: Action taken after the threshold is met. Default is ‘continue’. Known values are:
     "continue" and "stop".
    :vartype action: str or ~customizations.models.PassFailAction
    ...
    :ivar result: Outcome of the test run. Known values are: "passed", "undetermined", and
     "failed".
    :vartype result: str or ~customizations.models.PassFailResult
    """
...
class Secret(_model_base.Model):
    ...
    :vartype type: str or ~customizations.models.SecretType
    """
...
class Test(_model_base.Model):
    ...
    :vartype pass_fail_criteria: ~customizations.models.PassFailCriteria
    ...
    :vartype auto_stop_criteria: ~customizations.models.AutoStopCriteria
    :ivar secrets: Secrets can be stored in an Azure Key Vault or any other secret store. If the
     ...
     SECRET_VALUE.
    :vartype secrets: dict[str, ~customizations.models.Secret]
    :ivar certificate: Certificates metadata.
    :vartype certificate: ~customizations.models.CertificateMetadata
    ...
    :vartype load_test_configuration: ~customizations.models.LoadTestConfiguration
    ...
    :vartype input_artifacts: ~customizations.models.TestInputArtifacts
    ...
    :vartype kind: str or ~customizations.models.TestKind
    ...
    :vartype metrics_reference_identity_type: str or ~customizations.models.ManagedIdentityType
    ...
    :ivar engine_built_in_identity_type: Type of the managed identity built in load test engines.
     Known values are: "SystemAssigned" and "UserAssigned".
    :vartype engine_built_in_identity_type: str or ~customizations.models.ManagedIdentityType
...
class TestAppComponents(_model_base.Model):
    ...
    :vartype components: dict[str, ~customizations.models.AppComponent]
...
class TestFileInfo(_model_base.Model):
    ...
    :vartype file_type: str or ~customizations.models.FileType
    ...
    :vartype validation_status: str or ~customizations.models.FileValidationStatus
...
class TestInputArtifacts(_model_base.Model):
    ...
    :vartype config_file_info: ~customizations.models.TestFileInfo
    :ivar test_script_file_info: The test script file for the test run.
    :vartype test_script_file_info: ~customizations.models.TestFileInfo
    :ivar user_prop_file_info: The user properties file.
    :vartype user_prop_file_info: ~customizations.models.TestFileInfo
    :ivar input_artifacts_zip_file_info: The zip file with all input artifacts.
    :vartype input_artifacts_zip_file_info: ~customizations.models.TestFileInfo
    :ivar url_test_config_file_info: The config json file for url based test.
    :vartype url_test_config_file_info: ~customizations.models.TestFileInfo
    :ivar additional_file_info: Additional supported files for the test run.
    :vartype additional_file_info: list[~customizations.models.TestFileInfo]
    """
...
class TestProfile(_model_base.Model):
    ...
    :ivar target_resource_configurations: Configurations of the target resource on which testing
     would be done.
    :vartype target_resource_configurations: ~customizations.models.TargetResourceConfigurations
    :ivar created_date_time: The creation datetime(RFC 3339 literal format).
    :vartype created_date_time: ~datetime.datetime
    :ivar created_by: The user that created.
    :vartype created_by: str
...
class TestProfileRun(_model_base.Model):
    ...
    :vartype error_details: list[~customizations.models.ErrorDetails]
    ...
    :vartype test_run_details: dict[str, ~customizations.models.TestRunDetail]
    :ivar recommendations: Recommendations provided based on a successful test profile run.
    :vartype recommendations: list[~customizations.models.TestProfileRunRecommendation]
    :ivar created_date_time: The creation datetime(RFC 3339 literal format).
    :vartype created_date_time: ~datetime.datetime
    :ivar created_by: The user that created.
    :vartype created_by: str
...
class TestProfileRunRecommendation(_model_base.Model):
    ...
    :vartype category: str or ~customizations.models.RecommendationCategory
...
class TestRun(_model_base.Model):
    ...
    :vartype test_run_statistics: dict[str, ~customizations.models.TestRunStatistics]
    ...
    :vartype regional_statistics: dict[str, ~customizations.models.TestRunStatistics]
    :ivar load_test_configuration: The load test configuration.
    :vartype load_test_configuration: ~customizations.models.LoadTestConfiguration
    :ivar test_artifacts: Collection of test run artifacts.
    :vartype test_artifacts: ~customizations.models.TestRunArtifacts
    ...
    :vartype test_result: str or ~customizations.models.PassFailTestResult
    ...
    :ivar status: The test run status. Known values are: "ACCEPTED", "NOTSTARTED", "PROVISIONING",
     ...
     "VALIDATION_FAILURE".
    :vartype status: str or ~customizations.models.TestRunStatus
    ...
    :ivar request_data_level: Request data collection level for test run. Known values are: "NONE"
     and "ERRORS".
    :vartype request_data_level: str or ~customizations.models.RequestDataLevel
    ...
    :vartype created_by_type: str or ~customizations.models.CreatedByType
    :ivar created_date_time: The creation datetime(RFC 3339 literal format).
    :vartype created_date_time: ~datetime.datetime
    :ivar created_by: The user that created.
    :vartype created_by: str
...
class TestRunArtifacts(_model_base.Model):
    ...
    :vartype input_artifacts: ~customizations.models.TestRunInputArtifacts
    :ivar output_artifacts: The output artifacts for the test run.
    :vartype output_artifacts: ~customizations.models.TestRunOutputArtifacts
    """
...
class TestRunInputArtifacts(_model_base.Model):
    ...
    :ivar config_file_info: The load test YAML file that contains the the test configuration.
    :vartype config_file_info: ~customizations.models.TestRunFileInfo
    :ivar test_script_file_info: The test script file for the test run.
    :vartype test_script_file_info: ~customizations.models.TestRunFileInfo
    :ivar user_prop_file_info: The user properties file.
    :vartype user_prop_file_info: ~customizations.models.TestRunFileInfo
    :ivar input_artifacts_zip_file_info: The zip file for all input artifacts.
    :vartype input_artifacts_zip_file_info: ~customizations.models.TestRunFileInfo
    :ivar url_test_config_file_info: The config json file for url based test.
    :vartype url_test_config_file_info: ~customizations.models.TestRunFileInfo
    :ivar additional_file_info: Additional supported files for the test run.
    :vartype additional_file_info: list[~customizations.models.TestRunFileInfo]
    """
...
class TestRunOutputArtifacts(_model_base.Model):
    ...
    :vartype result_file_info: ~customizations.models.TestRunFileInfo
    :ivar logs_file_info: The test run report with metrics.
    :vartype logs_file_info: ~customizations.models.TestRunFileInfo
    :ivar artifacts_container_info: The container for test run artifacts.
    :vartype artifacts_container_info: ~customizations.models.ArtifactsContainerInfo
    :ivar report_file_info: The report file for the test run.
    :vartype report_file_info: ~customizations.models.TestRunFileInfo
    """
...
class TestRunServerMetricsConfiguration(_model_base.Model):
    ...
    :ivar metrics: Azure resource metrics collection {metric id : metrics object} (Refer :
     ...
     <https://learn.microsoft.com/en-us/rest/api/monitor/metric-definitions/list#metricdefinition>`_
     for metric id).
    :vartype metrics: dict[str, ~customizations.models.ResourceMetric]
    :ivar created_date_time: The creation datetime(RFC 3339 literal format).
    :vartype created_date_time: ~datetime.datetime
    :ivar created_by: The user that created.
    :vartype created_by: str
...
class TimeSeriesElement(_model_base.Model):
    ...
    :vartype data: list[~customizations.models.MetricValue]
    :ivar dimension_values: The dimension values.
    :vartype dimension_values: list[~customizations.models.DimensionValue]
    """
