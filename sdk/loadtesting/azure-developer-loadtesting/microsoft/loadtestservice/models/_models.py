...
from ....customizations._utils.model_base import Model as _Model, rest_discriminator, rest_field
...
class CertificateMetadata(_Model):
    ...
    :vartype type: str or ~microsoft.loadtestservice.models.CertificateType
...
class FunctionFlexConsumptionTargetResourceConfigurations(
    ...
    :vartype kind: str or ~microsoft.loadtestservice.models.FUNCTIONS_FLEX_CONSUMPTION
    ...
    :vartype configurations: dict[str,
     ~microsoft.loadtestservice.models.FunctionFlexConsumptionResourceConfiguration]
    """
...
class LoadTestConfiguration(_Model):
    ...
    :vartype optional_load_test_config:
     ~microsoft.loadtestservice.models.OptionalLoadTestConfiguration
    :ivar regional_load_test_config: Region distribution configuration for the load test.
    :vartype regional_load_test_config:
     list[~microsoft.loadtestservice.models.RegionalConfiguration]
    """
...
class MetricAvailability(_Model):
    ...
    :vartype time_grain: str or ~microsoft.loadtestservice.models.TimeGrain
    """
...
class MetricDefinition(_Model):
    ...
    :vartype dimensions: list[~microsoft.loadtestservice.models.NameAndDescription]
    ...
    :vartype primary_aggregation_type: str or ~microsoft.loadtestservice.models.Aggregation
    ...
    :vartype unit: str or ~microsoft.loadtestservice.models.MetricUnit
    :ivar metric_availabilities: Metric availability specifies the time grain (aggregation interval
     or
     frequency).
    :vartype metric_availabilities: list[~microsoft.loadtestservice.models.MetricAvailability]
    """
...
class MetricDefinitionCollection(_Model):
    ...
    :vartype value: list[~microsoft.loadtestservice.models.MetricDefinition]
    """
...
class MetricNamespaceCollection(_Model):
    ...
    :vartype value: list[~microsoft.loadtestservice.models.MetricNamespace]
    """
...
class MetricRequestPayload(_Model):
    ...
    :vartype filters: list[~microsoft.loadtestservice.models.DimensionFilter]
    """
...
class Metrics(_Model):
    ...
    :ivar value: The TimeSeriesElement items on this page. Required.
    :vartype value: list[~microsoft.loadtestservice.models.TimeSeriesElement]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """

    value: list["_models.TimeSeriesElement"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The TimeSeriesElement items on this page. Required."""
    ...
    def __init__(
        self,
        *,
        value: list["_models.TimeSeriesElement"],
...
class PassFailCriteria(_Model):
    ...
    :vartype pass_fail_metrics: dict[str, ~microsoft.loadtestservice.models.PassFailMetric]
    ...
    :vartype pass_fail_server_metrics: dict[str,
     ~microsoft.loadtestservice.models.PassFailServerMetric]
    """
...
class PassFailMetric(_Model):
    ...
    :vartype client_metric: str or ~microsoft.loadtestservice.models.PFMetrics
    ...
    :vartype aggregate: str or ~microsoft.loadtestservice.models.PassFailAggregationFunction
    ...
    :ivar action: Action taken after the threshold is met. Default is ‘continue’. Known values are:
     "continue" and "stop".
    :vartype action: str or ~microsoft.loadtestservice.models.PassFailAction
    ...
    :ivar result: Outcome of the test run. Known values are: "passed", "undetermined", and
     "failed".
    :vartype result: str or ~microsoft.loadtestservice.models.PassFailResult
    """
...
class Secret(_Model):
    ...
    :vartype type: str or ~microsoft.loadtestservice.models.SecretType
    """
...
class Test(_Model):
    ...
    :vartype pass_fail_criteria: ~microsoft.loadtestservice.models.PassFailCriteria
    ...
    :vartype auto_stop_criteria: ~microsoft.loadtestservice.models.AutoStopCriteria
    :ivar secrets: Secrets can be stored in an Azure Key Vault or any other secret store. If the
     ...
     SECRET_VALUE.
    :vartype secrets: dict[str, ~microsoft.loadtestservice.models.Secret]
    :ivar certificate: Certificates metadata.
    :vartype certificate: ~microsoft.loadtestservice.models.CertificateMetadata
    ...
    :vartype load_test_configuration: ~microsoft.loadtestservice.models.LoadTestConfiguration
    ...
    :vartype input_artifacts: ~microsoft.loadtestservice.models.TestInputArtifacts
    ...
    :vartype kind: str or ~microsoft.loadtestservice.models.TestKind
    ...
    :vartype metrics_reference_identity_type: str or
     ~microsoft.loadtestservice.models.ManagedIdentityType
...
class TestAppComponents(_Model):
    ...
    :vartype components: dict[str, ~microsoft.loadtestservice.models.AppComponent]
...
class TestFileInfo(_Model):
    ...
    :vartype file_type: str or ~microsoft.loadtestservice.models.FileType
    ...
    :vartype validation_status: str or ~microsoft.loadtestservice.models.FileValidationStatus
...
class TestInputArtifacts(_Model):
    ...
    :vartype config_file_info: ~microsoft.loadtestservice.models.TestFileInfo
    :ivar test_script_file_info: The test script file for the test run.
    :vartype test_script_file_info: ~microsoft.loadtestservice.models.TestFileInfo
    :ivar user_prop_file_info: The user properties file.
    :vartype user_prop_file_info: ~microsoft.loadtestservice.models.TestFileInfo
    :ivar input_artifacts_zip_file_info: The zip file with all input artifacts.
    :vartype input_artifacts_zip_file_info: ~microsoft.loadtestservice.models.TestFileInfo
    :ivar url_test_config_file_info: The config json file for url based test.
    :vartype url_test_config_file_info: ~microsoft.loadtestservice.models.TestFileInfo
    :ivar additional_file_info: Additional supported files for the test run.
    :vartype additional_file_info: list[~microsoft.loadtestservice.models.TestFileInfo]
    """
...
class TestProfileRun(_Model):
    ...
    :vartype error_details: list[~microsoft.loadtestservice.models.ErrorDetails]
    ...
    :vartype test_run_details: dict[str, ~microsoft.loadtestservice.models.TestRunDetail]
    :ivar recommendations: Recommendations provided based on a successful test profile run.
    :vartype recommendations: list[~microsoft.loadtestservice.models.TestProfileRunRecommendation]
    :ivar created_date_time: The creation datetime(RFC 3339 literal format).
    :vartype created_date_time: ~datetime.datetime
    :ivar created_by: The user that created.
    :vartype created_by: str
...
class TestProfileRunRecommendation(_Model):
    ...
    :vartype category: str or ~microsoft.loadtestservice.models.RecommendationCategory
...
class TestRun(_Model):
    ...
    :vartype test_run_statistics: dict[str, ~microsoft.loadtestservice.models.TestRunStatistics]
    ...
    :vartype regional_statistics: dict[str, ~microsoft.loadtestservice.models.TestRunStatistics]
    :ivar load_test_configuration: The load test configuration.
    :vartype load_test_configuration: ~microsoft.loadtestservice.models.LoadTestConfiguration
    :ivar test_artifacts: Collection of test run artifacts.
    :vartype test_artifacts: ~microsoft.loadtestservice.models.TestRunArtifacts
    ...
    :vartype test_result: str or ~microsoft.loadtestservice.models.PassFailTestResult
    ...
    :ivar status: The test run status. Known values are: "ACCEPTED", "NOTSTARTED", "PROVISIONING",
     ...
     "VALIDATION_FAILURE".
    :vartype status: str or ~microsoft.loadtestservice.models.TestRunStatus
    ...
    :ivar request_data_level: Request data collection level for test run. Known values are: "NONE"
     and "ERRORS".
    :vartype request_data_level: str or ~microsoft.loadtestservice.models.RequestDataLevel
    ...
    :vartype created_by_type: str or ~microsoft.loadtestservice.models.CreatedByType
    :ivar created_date_time: The creation datetime(RFC 3339 literal format).
    :vartype created_date_time: ~datetime.datetime
    :ivar created_by: The user that created.
    :vartype created_by: str
...
class TestRunArtifacts(_Model):
    ...
    :vartype input_artifacts: ~microsoft.loadtestservice.models.TestRunInputArtifacts
    :ivar output_artifacts: The output artifacts for the test run.
    :vartype output_artifacts: ~microsoft.loadtestservice.models.TestRunOutputArtifacts
    """
...
class TestRunInputArtifacts(_Model):
    ...
    :ivar config_file_info: The load test YAML file that contains the the test configuration.
    :vartype config_file_info: ~microsoft.loadtestservice.models.TestRunFileInfo
    :ivar test_script_file_info: The test script file for the test run.
    :vartype test_script_file_info: ~microsoft.loadtestservice.models.TestRunFileInfo
    :ivar user_prop_file_info: The user properties file.
    :vartype user_prop_file_info: ~microsoft.loadtestservice.models.TestRunFileInfo
    :ivar input_artifacts_zip_file_info: The zip file for all input artifacts.
    :vartype input_artifacts_zip_file_info: ~microsoft.loadtestservice.models.TestRunFileInfo
    :ivar url_test_config_file_info: The config json file for url based test.
    :vartype url_test_config_file_info: ~microsoft.loadtestservice.models.TestRunFileInfo
    :ivar additional_file_info: Additional supported files for the test run.
    :vartype additional_file_info: list[~microsoft.loadtestservice.models.TestRunFileInfo]
    """
...
class TestRunOutputArtifacts(_Model):
    ...
    :vartype result_file_info: ~microsoft.loadtestservice.models.TestRunFileInfo
    :ivar logs_file_info: The test run report with metrics.
    :vartype logs_file_info: ~microsoft.loadtestservice.models.TestRunFileInfo
    :ivar artifacts_container_info: The container for test run artifacts.
    :vartype artifacts_container_info: ~microsoft.loadtestservice.models.ArtifactsContainerInfo
    :ivar report_file_info: The report file for the test run.
    :vartype report_file_info: ~microsoft.loadtestservice.models.TestRunFileInfo
    """
...
class TestRunServerMetricsConfiguration(_Model):
    ...
    :ivar metrics: Azure resource metrics collection {metric id : metrics object} (Refer :
     ...
     <https://learn.microsoft.com/en-us/rest/api/monitor/metric-definitions/list#metricdefinition>`_
     for metric id).
    :vartype metrics: dict[str, ~microsoft.loadtestservice.models.ResourceMetric]
    :ivar created_date_time: The creation datetime(RFC 3339 literal format).
    :vartype created_date_time: ~datetime.datetime
    :ivar created_by: The user that created.
    :vartype created_by: str
...
class TimeSeriesElement(_Model):
    ...
    :vartype data: list[~microsoft.loadtestservice.models.MetricValue]
    :ivar dimension_values: The dimension values.
    :vartype dimension_values: list[~microsoft.loadtestservice.models.DimensionValue]
    """
