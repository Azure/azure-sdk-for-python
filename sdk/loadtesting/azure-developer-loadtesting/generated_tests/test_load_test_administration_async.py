...
class TestLoadTestAdministrationAsync(LoadTestAdministrationClientTestBaseAsync):
    ...
    @LoadTestAdministrationPreparer()
    @recorded_by_proxy_async
    async def test_create_or_update_trigger(self, loadtestadministration_endpoint):
        client = self.create_async_client(endpoint=loadtestadministration_endpoint)
        response = await client.create_or_update_trigger(
            trigger_id="str",
            body={
                "displayName": "str",
    ...
    @LoadTestAdministrationPreparer()
    @recorded_by_proxy_async
    async def test_delete_trigger(self, loadtestadministration_endpoint):
        client = self.create_async_client(endpoint=loadtestadministration_endpoint)
    ...
    @LoadTestAdministrationPreparer()
    @recorded_by_proxy_async
    async def test_get_trigger(self, loadtestadministration_endpoint):
        client = self.create_async_client(endpoint=loadtestadministration_endpoint)
    ...
    @LoadTestAdministrationPreparer()
    @recorded_by_proxy_async
    async def test_list_triggers(self, loadtestadministration_endpoint):
        client = self.create_async_client(endpoint=loadtestadministration_endpoint)
    ...
    @LoadTestAdministrationPreparer()
    @recorded_by_proxy_async
    async def test_create_or_update_notification_rule(self, loadtestadministration_endpoint):
        client = self.create_async_client(endpoint=loadtestadministration_endpoint)
        response = await client.create_or_update_notification_rule(
    ...
    @LoadTestAdministrationPreparer()
    @recorded_by_proxy_async
    async def test_delete_notification_rule(self, loadtestadministration_endpoint):
        client = self.create_async_client(endpoint=loadtestadministration_endpoint)
    ...
    @LoadTestAdministrationPreparer()
    @recorded_by_proxy_async
    async def test_get_notification_rule(self, loadtestadministration_endpoint):
        client = self.create_async_client(endpoint=loadtestadministration_endpoint)
        response = await client.get_notification_rule(
            notification_rule_id="str",
        )
    ...
    @LoadTestAdministrationPreparer()
    @recorded_by_proxy_async
    async def test_list_notification_rules(self, loadtestadministration_endpoint):
        client = self.create_async_client(endpoint=loadtestadministration_endpoint)
    ...
    @LoadTestAdministrationPreparer()
    @recorded_by_proxy_async
    async def test_begin_clone_test(self, loadtestadministration_endpoint):
        client = self.create_async_client(endpoint=loadtestadministration_endpoint)
        response = await (
            await client.begin_clone_test(
                test_id="str",
    ...
    @LoadTestAdministrationPreparer()
    @recorded_by_proxy_async
    async def test_begin_generate_test_plan_recommendations(self, loadtestadministration_endpoint):
        client = self.create_async_client(endpoint=loadtestadministration_endpoint)
        response = await (
            await client.begin_generate_test_plan_recommendations(
                test_id="str",
            )
        ).result()  # call '.result()' to poll until service return final result
    ...
    @LoadTestAdministrationPreparer()
    @recorded_by_proxy_async
    async def test_get_operation_status(self, loadtestadministration_endpoint):
        client = self.create_async_client(endpoint=loadtestadministration_endpoint)
