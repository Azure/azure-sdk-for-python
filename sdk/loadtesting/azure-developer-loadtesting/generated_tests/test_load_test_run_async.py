...
class TestLoadTestRunAsync(LoadTestRunClientTestBaseAsync):
    ...
    @LoadTestRunPreparer()
    @recorded_by_proxy_async
    async def test_get_latest_test_run_insights(self, loadtestrun_endpoint):
        client = self.create_async_client(endpoint=loadtestrun_endpoint)
        response = await client.get_latest_test_run_insights(
            test_run_id="str",
        )
    ...
    @LoadTestRunPreparer()
    @recorded_by_proxy_async
    async def test_begin_generate_test_run_insights(self, loadtestrun_endpoint):
        client = self.create_async_client(endpoint=loadtestrun_endpoint)
        response = await (
            await client.begin_generate_test_run_insights(
                test_run_id="str",
            )
