...
class TestTestProfileRunClient(LoadtestingAsyncTest):
    ...
    async def setup_test_profile(self, endpoint, test_profile_id, target_resource_id, test_id):
        ...
        await validation_poller.result(6000)

    async def setup_test_profile_run(self,endpoint, test_profile_id, test_profile_run_id, target_resource_id, test_id):
        await self.setup_test_profile(endpoint, test_profile_id, target_resource_id, test_id)
        ...
        await run_poller.result(10800)

    @LoadtestingPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_test_profile_run_poller (self,loadtesting_endpoint,loadtesting_test_profile_id, loadtesting_test_profile_run_id, loadtesting_target_resource_id,loadtesting_test_id):
        set_bodiless_matcher()

        await self.setup_test_profile(loadtesting_endpoint,loadtesting_test_profile_id,loadtesting_target_resource_id,loadtesting_test_id)
        ...
        result = await run_poller.result(10800)
        assert result is not None
    ...
    @LoadtestingPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_list_test_profile_runs(self,loadtesting_endpoint, loadtesting_test_profile_id,loadtesting_test_profile_run_id,loadtesting_target_resource_id,loadtesting_test_id):
        set_bodiless_matcher()

        await self.setup_test_profile_run(loadtesting_endpoint, loadtesting_test_profile_id,loadtesting_test_profile_run_id,loadtesting_target_resource_id,loadtesting_test_id)
    ...
    @LoadtestingPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_delete_test_profile_run(self,loadtesting_endpoint, loadtesting_test_profile_id,loadtesting_test_profile_run_id,loadtesting_target_resource_id,loadtesting_test_id):
        set_bodiless_matcher()
    ...
    @LoadtestingPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_stop_test_profile_run(self,loadtesting_endpoint,loadtesting_test_profile_run_id,loadtesting_target_resource_id,loadtesting_test_id):
        set_bodiless_matcher()

        await self.setup_test_profile(loadtesting_endpoint,"my-new-test-profile-from-pytest-abc",loadtesting_target_resource_id,loadtesting_test_id)
        run_client = self.create_run_client(loadtesting_endpoint)
