...
class TestTestProfileAdministrationClient(LoadtestingTest):
    ...
    def setup_create_test_profile(self,endpoint,testId, targetResourceId):
        ...
        client = self.create_test_profile_client(endpoint)
    ...
    @recorded_by_proxy
    def test_create_or_update_test_profile(self,loadtesting_endpoint, loadtesting_test_profile_id, loadtesting_test_id, loadtesting_target_resource_id):
        set_bodiless_matcher()

        client = self.create_test_profile_client(loadtesting_endpoint)
