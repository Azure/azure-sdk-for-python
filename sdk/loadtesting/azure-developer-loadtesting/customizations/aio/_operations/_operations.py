...
class LoadTestAdministrationClientOperationsMixin(  # pylint: disable=name-too-long
    ...
    def list_test_files(
        self, test_id: str, **kwargs: Any
    ) -> AsyncIterable["_microsoft_loadtestservice_models5.TestFileInfo"]:
        """Get all test files.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~customizations.models.TestFileInfo]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_tests(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_microsoft_loadtestservice_models5.Test"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~customizations.models.Test]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_test_profiles(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_microsoft_loadtestservice_models5.TestProfile"]:
        """List test profiles.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~customizations.models.TestProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class LoadTestRunClientOperationsMixin(LoadTestRunClientMixinABC):
    ...
    def list_metrics(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_microsoft_loadtestservice_models5.TimeSeriesElement"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~customizations.models.TimeSeriesElement]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_test_runs(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_microsoft_loadtestservice_models5.TestRun"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~customizations.models.TestRun]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_test_profile_runs(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_microsoft_loadtestservice_models5.TestProfileRun"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~customizations.models.TestProfileRun]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
