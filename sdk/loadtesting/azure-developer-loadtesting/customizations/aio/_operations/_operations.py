...
class _LoadTestRunClientOperationsMixin(
    ...
    async def list_metrics(
        ...
        **kwargs: Any
    ) -> _microsoft_loadtestservice_models5.Metrics:
    ...
    async def list_metrics(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_microsoft_loadtestservice_models5.Metrics] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_microsoft_loadtestservice_models5.Metrics, response.json())
