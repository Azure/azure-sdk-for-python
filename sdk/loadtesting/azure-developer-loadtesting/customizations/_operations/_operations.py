...
class _LoadTestRunClientOperationsMixin(
    ...
    def list_metrics(
        ...
        **kwargs: Any
    ) -> _microsoft_loadtestservice_models4.Metrics:
        ...
        :paramtype content_type: str
        :return: Metrics. The Metrics is compatible with MutableMapping
        :rtype: ~microsoft.loadtestservice.models.Metrics
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_metrics(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_microsoft_loadtestservice_models4.Metrics] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_microsoft_loadtestservice_models4.Metrics, response.json())
