...
from ..._operations._operations import (
    ...
    build_load_test_run_test_run_request,
)
...
class LoadTestRunClientOperationsMixin(LoadTestRunClientMixinABC):
    ...
    async def begin_test_run(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns TestRun. The TestRun is compatible with
         MutableMapping
    ...
    @distributed_trace_async
    async def list_metric_namespaces(self, test_run_id: str, **kwargs: Any) -> _models.MetricNamespaceCollection:
