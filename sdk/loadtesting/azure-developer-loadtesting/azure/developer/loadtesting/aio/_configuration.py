...
class TestProfileAdministrationClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    """Configuration for TestProfileAdministrationClient.
...
class TestProfileRunClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    """Configuration for TestProfileRunClient.
