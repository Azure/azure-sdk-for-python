...
class TestProfileAdministrationClient(
    TestProfileAdministrationClientOperationsMixin
):  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(self, endpoint: str, credential: "TokenCredential", **kwargs: Any) -> None:
        _endpoint = "https://{endpoint}"
        self._config = TestProfileAdministrationClientConfiguration(endpoint=endpoint, credential=credential, **kwargs)
        _policies = kwargs.pop("policies", None)
        if _policies is None:
            _policies = [
                policies.RequestIdPolicy(**kwargs),
    ...
    def __enter__(self) -> "TestProfileAdministrationClient":
        self._client.__enter__()
        return self
...
class TestProfileRunClient(TestProfileRunClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(self, endpoint: str, credential: "TokenCredential", **kwargs: Any) -> None:
        _endpoint = "https://{endpoint}"
        self._config = TestProfileRunClientConfiguration(endpoint=endpoint, credential=credential, **kwargs)
        _policies = kwargs.pop("policies", None)
        if _policies is None:
            _policies = [
                policies.RequestIdPolicy(**kwargs),
    ...
    def __enter__(self) -> "TestProfileRunClient":
        self._client.__enter__()
        return self
