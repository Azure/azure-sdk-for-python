...
def build_load_test_administration_generate_test_plan_recommendations_request(  # pylint: disable=name-too-long
    test_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/tests/{testId}:generateTestPlanRecommendations"
    path_format_arguments = {
        "testId": _SERIALIZER.url("test_id", test_id, "str"),
    }
...
def build_load_test_run_get_latest_test_run_insights_request(  # pylint: disable=name-too-long
    test_run_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/test-runs/{testRunId}/insights/latest"
    path_format_arguments = {
        "testRunId": _SERIALIZER.url("test_run_id", test_run_id, "str"),
    }
...
def build_load_test_run_generate_test_run_insights_request(  # pylint: disable=name-too-long
    test_run_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/test-runs/{testRunId}/insights:generate"
    path_format_arguments = {
        "testRunId": _SERIALIZER.url("test_run_id", test_run_id, "str"),
    }
...
class _LoadTestAdministrationClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def list_test_files(self, test_id: str, **kwargs: Any) -> ItemPaged["_models.TestFileInfo"]:
        """Get all test files.
    ...
    def list_notification_rules(
        ...
        *,
        ...
        last_modified_end_time: Optional[datetime.datetime] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.NotificationRule"]:
        """Resource list operation template.
    ...
    def _generate_test_plan_recommendations_initial(  # pylint: disable=name-too-long
    ...
    def begin_generate_test_plan_recommendations(self, test_id: str, **kwargs: Any) -> LROPoller[_models.Test]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._generate_test_plan_recommendations_initial(
...
class _LoadTestRunClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ...
    def list_test_profile_runs(
        ...
        *,
        ...
        statuses: Optional[list[str]] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.TestProfileRun"]:
    ...
    def get_latest_test_run_insights(self, test_run_id: str, **kwargs: Any) -> _models.TestRunInsights:
    ...
    def _generate_test_run_insights_initial(self, test_run_id: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def begin_generate_test_run_insights(self, test_run_id: str, **kwargs: Any) -> LROPoller[None]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._generate_test_run_insights_initial(
