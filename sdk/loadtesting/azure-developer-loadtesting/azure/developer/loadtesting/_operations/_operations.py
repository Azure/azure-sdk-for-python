...
class LoadTestAdministrationClientOperationsMixin(  # pylint: disable=name-too-long
    ...
    @distributed_trace
    def get_test_file(self, test_id: str, file_name: str, **kwargs: Any) -> _models.GetTestFileResponse:
        # pylint: disable=line-too-long
...
class LoadTestRunClientOperationsMixin(LoadTestRunClientMixinABC):
    ...
    @distributed_trace
    def get_test_run_file(self, test_run_id: str, file_name: str, **kwargs: Any) -> _models.GetTestRunFileResponse:
        # pylint: disable=line-too-long
