...
from customizations import LoadTestAdministrationClient
...
# USAGE
    python create_or_update_test_server_metrics_config.py
...
def main():
    ...
    response = client.create_or_update_server_metrics_config(
        test_id="edc6e529-d009-4b99-b763-ca492e3a2823",
        body={
            "metrics": {
...
# x-ms-original-file: 2024-12-01-preview/CreateOrUpdateTestServerMetricsConfig.json
