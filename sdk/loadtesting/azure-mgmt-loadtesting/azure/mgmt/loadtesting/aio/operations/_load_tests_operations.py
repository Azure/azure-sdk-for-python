...
from ...operations._load_tests_operations import (
...
class LoadTestsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.LoadTestResource"]:
        ...
        cls: ClsType[_models.LoadTestResourcePageList] = kwargs.pop("cls", None)
    ...
    list_by_subscription.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.LoadTestService/loadTests"
    }
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LoadTestService/loadTests"
    }

    @distributed_trace_async
    async def get(self, resource_group_name: str, load_test_name: str, **kwargs: Any) -> _models.LoadTestResource:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LoadTestService/loadTests/{loadTestName}"
    }
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either LoadTestResource or the result of
         cls(response)
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.LoadTestResource]] = kwargs.pop("cls", None)
    ...
    @distributed_trace_async
    async def begin_delete(self, resource_group_name: str, load_test_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
    ...
    list_outbound_network_dependencies_endpoints.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LoadTestService/loadTests/{loadTestName}/outboundNetworkDependenciesEndpoints"
    }
