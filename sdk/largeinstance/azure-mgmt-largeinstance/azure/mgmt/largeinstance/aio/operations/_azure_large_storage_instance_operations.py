...
from ...operations._azure_large_storage_instance_operations import (
    build_get_request,
...
class AzureLargeStorageInstanceOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.AzureLargeStorageInstance"]:
        ...
        :return: An iterator like instance of either AzureLargeStorageInstance or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.largeinstance.models.AzureLargeStorageInstance]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.largeinstance.models.AzureLargeStorageInstance
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.largeinstance.models.AzureLargeStorageInstanceTagsUpdate
    ...
    async def update(
        ...
        resource_group_name: str,
        azure_large_storage_instance_name: str,
        properties: Union[_models.AzureLargeStorageInstanceTagsUpdate, IO[bytes]],
        **kwargs: Any
    ) -> _models.AzureLargeStorageInstance:
        """Patches the Tags field of a Azure Large Storage Instance for the specified
        subscription, resource group, and instance name.
        ...
        :type properties: ~azure.mgmt.largeinstance.models.AzureLargeStorageInstanceTagsUpdate or
         IO[bytes]
        :return: AzureLargeStorageInstance or the result of cls(response)
        :rtype: ~azure.mgmt.largeinstance.models.AzureLargeStorageInstance
        :raises ~azure.core.exceptions.HttpResponseError:
