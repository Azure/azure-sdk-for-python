...
class CapacityAdministration(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class CapacityOverageProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :vartype state: str or ~azure.mgmt.fabric.models.CapacityOverageState
    :ivar threshold_capacity_unit_hours: 24-hour rolling threshold for capacity overage. Reaching
     this threshold results in capacity throttling.
    :vartype threshold_capacity_unit_hours: int
    """

    state: Optional[Union[str, "_models.CapacityOverageState"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """The capacity overage state for the Fabric capacity resource. Known values are: \"Disabled\" and
     \"Enabled\"."""
    threshold_capacity_unit_hours: Optional[int] = rest_field(
        name="thresholdCapacityUnitHours", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        state: Optional[Union[str, "_models.CapacityOverageState"]] = None,
        threshold_capacity_unit_hours: Optional[int] = None,
    ) -> None: ...
...
class FabricCapacity(TrackedResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class FabricCapacityProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class FabricCapacityUpdate(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class FabricCapacityUpdateProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class Quota(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class QuotaName(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The Quota Names.
...
class RpSku(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class RpSkuDetailsForExistingResource(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class RpSkuDetailsForNewResource(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The SKU details.
