...
class FabricCapacity(TrackedResource):
    ...
    sku: "_models.RpSku" = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class FabricCapacityUpdate(_model_base.Model):
    ...
    sku: Optional["_models.RpSku"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The SKU details."""
    tags: Optional[Dict[str, str]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Resource tags."""
...
class Quota(_model_base.Model):
    ...
    :vartype name: ~azure.mgmt.fabric.models.QuotaName
...
class RpSku(_model_base.Model):
    ...
    tier: Union[str, "_models.RpSkuTier"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
