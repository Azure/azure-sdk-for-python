...
class FabricMgmtClient:
    ...
    :vartype fabric_capacities: azure.mgmt.fabric.aio.operations.FabricCapacitiesOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.fabric.aio.operations.Operations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.fabric_capacities = FabricCapacitiesOperations(
