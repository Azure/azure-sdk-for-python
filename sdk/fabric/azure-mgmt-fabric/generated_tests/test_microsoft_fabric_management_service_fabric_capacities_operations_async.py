...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.fabric.aio import MicrosoftFabricManagementService
...
class TestMicrosoftFabricManagementServiceFabricCapacitiesOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(MicrosoftFabricManagementService, is_async=True)
