...
class StorageTableEntityTest(TableTestCase):
    ...
    async def _create_query_table(self, entity_count):
        ...
        for i in range(1, entity_count + 1):
            ...
            await client.create_entity(table_entity_properties=entity)
    ...
    async def _insert_random_entity(self, pk=None, rk=None):
        ...
        e = await self.table.create_entity(table_entity_properties=entity, response_hook=lambda e, h: h['etag'])
        etag = e['etag']
        return entity, etag
    ...
    async def test_insert_entity_dictionary(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            resp = await self.table.create_entity(table_entity_properties=entity)
    ...
    async def test_insert_entity_with_hook(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            # Act
            resp = await self.table.create_entity(table_entity_properties=entity, response_hook=lambda e, h: (e, h))
    ...
    # @pytest.mark.skip("pending")
    @GlobalStorageAccountPreparer()
    async def test_insert_entity_with_full_metadata(self, resource_group, location, storage_account, storage_account_key):
        # Arrange
        await self._set_up(storage_account, storage_account_key)
        try:
            entity = self._create_random_entity_dict()
    ...
    async def test_insert_entity_conflict(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            with self.assertRaises(ResourceExistsError):
                ...
                await self.table.create_entity(table_entity_properties=entity)
    ...
    async def test_insert_entity_with_large_int32_value_throws(self, resource_group, location, storage_account,
        ...
        try:
            ...
            with self.assertRaises(TypeError):
                await self.table.create_entity(table_entity_properties=dict32)
    ...
    async def test_insert_entity_with_large_int64_value_throws(self, resource_group, location, storage_account,
        ...
        try:
            ...
            # Assert
            with self.assertRaises(TypeError):
                await self.table.create_entity(table_entity_properties=dict64)
    ...
    # @pytest.mark.skip("pending")
    @GlobalStorageAccountPreparer()
    async def test_insert_entity_too_many_properties(self, resource_group, location, storage_account, storage_account_key):
        # Arrange
        await self._set_up(storage_account, storage_account_key)
        if 'cosmos' in self.table.url:
    ...
    # @pytest.mark.skip("pending")
    @GlobalStorageAccountPreparer()
    async def test_insert_entity_property_name_too_long(self, resource_group, location, storage_account, storage_account_key):
        # Arrange
        await self._set_up(storage_account, storage_account_key)
        if 'cosmos' in self.table.url:
    ...
    async def test_get_entity(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            # Act
            resp = await self.table.query_entities_with_partition_and_row_key(partition_key=entity['PartitionKey'],
    ...
    async def test_get_entity_with_hook(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            # Act
            # resp, headers
            resp = await self.table.query_entities_with_partition_and_row_key(
    ...
    async def test_get_entity_not_existing(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            with self.assertRaises(ResourceNotFoundError):
                await self.table.query_entities_with_partition_and_row_key(partition_key=entity.PartitionKey,
                                                                     row_key=entity.RowKey)
    ...
    # @pytest.mark.skip("pending")
    @GlobalStorageAccountPreparer()
    async def test_get_entity_with_special_doubles(self, resource_group, location, storage_account, storage_account_key):
        # Arrange
        await self._set_up(storage_account, storage_account_key)
        try:
            entity = self._create_random_base_entity_dict()
    ...
    async def test_update_entity(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            resp = await self.table.update_entity(mode=UpdateMode.replace, table_entity_properties=sent_entity, response_hook=lambda e, h: h)

            # Assert
            #  self.assertTrue(resp)
            received_entity = await self.table.query_entities_with_partition_and_row_key(partition_key=entity.PartitionKey,
                                                                                   row_key=entity.RowKey)
    ...
    async def test_update_entity_with_if_matches(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            # Assert
            # self.assertTrue(resp)
            received_entity = await self.table.query_entities_with_partition_and_row_key(entity.PartitionKey, entity.RowKey)
            self._assert_updated_entity(received_entity)
        finally:
            await self._tear_down()
    ...
    # @pytest.mark.skip("pending")
    @GlobalStorageAccountPreparer()
    async def test_update_entity_with_if_doesnt_match(self, resource_group, location, storage_account, storage_account_key):
        # Arrange
        await self._set_up(storage_account, storage_account_key)
        try:
            entity, _ = await self._insert_random_entity()
    ...
    async def test_insert_or_merge_entity_with_non_existing_entity(self, resource_group, location, storage_account,
        ...
        try:
            ...
            # Assert
            self.assertIsNone(resp)
            received_entity = await self.table.query_entities_with_partition_and_row_key(entity['PartitionKey'],
                                                                                   entity['RowKey'])
            self._assert_updated_entity(received_entity)
        finally:
            await self._tear_down()
    ...
    # @pytest.mark.skip("pending")
    @GlobalStorageAccountPreparer()
    async def test_merge_entity_with_if_doesnt_match(self, resource_group, location, storage_account, storage_account_key):
        # Arrange
        await self._set_up(storage_account, storage_account_key)
        try:
            entity, _ = await self._insert_random_entity()
    ...
    async def test_delete_entity(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            self.assertIsNone(resp)
            with self.assertRaises(ResourceNotFoundError):
                await self.table.query_entities_with_partition_and_row_key(entity.PartitionKey, entity.RowKey)
        finally:
            await self._tear_down()
    ...
    # @pytest.mark.skip("pending")
    @GlobalStorageAccountPreparer()
    async def test_delete_entity_with_if_doesnt_match(self, resource_group, location, storage_account, storage_account_key):
        # Arrange
        await self._set_up(storage_account, storage_account_key)
        try:
            entity, _ = await self._insert_random_entity()
    ...
    async def test_unicode_property_value(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            # Act
            await self.table.create_entity(table_entity_properties=entity1)
            await self.table.create_entity(table_entity_properties=entity2)
            entities = []
            async for e in self.table.query_entities(query_options=QueryOptions(filter="PartitionKey eq '{}'".format(entity['PartitionKey']))):
                entities.append(e)
    ...
    # @pytest.mark.skip("pending")
    @GlobalStorageAccountPreparer()
    async def test_empty_and_spaces_property_value(self, resource_group, location, storage_account, storage_account_key):
        # Arrange
        await self._set_up(storage_account, storage_account_key)
        try:
            entity = self._create_random_base_entity_dict()
            ...
            # Act
            await self.table.create_entity(table_entity_properties=entity)
            resp = await self.table.query_entities_with_partition_and_row_key(entity['PartitionKey'], entity['RowKey'])
    ...
    async def test_query_entities_full_metadata(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            # Act
            entities = []
            async for t in table.query_entities(headers={'accept': 'application/json;odata=fullmetadata'}):
                entities.append(t)
    ...
    async def test_query_entities_no_metadata(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            # Act
            entities = []
            async for t in table.query_entities(headers={'accept': 'application/json;odata=nometadata'}):
                entities.append(t)
    ...
    async def test_query_entities_with_select(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            # Act
            entities = []
            async for t in table.query_entities(query_options=QueryOptions(select="age, sex")):
                entities.append(t)
    ...
    async def test_query_entities_with_top(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            # Act
            entities = []
            async for t in next(table.query_entities(query_options=QueryOptions(top=2)).by_page()):
                entities.append(t)
    ...
    # @pytest.mark.skip("pending")
    @GlobalStorageAccountPreparer()
    async def test_query_entities_with_top_and_next(self, resource_group, location, storage_account, storage_account_key):
        # Arrange
        await self._set_up(storage_account, storage_account_key)
        try:
            ...
            # Act
            resp1 = await table.query_entities(query_options=QueryOptions(top=2)).by_page()
            next(resp1)
            resp2 = await table.query_entities(query_options=QueryOptions(top=2)).by_page(
                continuation_token=resp1.continuation_token)
            next(resp2)
            resp3 = await table.query_entities(query_options=QueryOptions(top=2)).by_page(
    ...
    async def test_sas_add(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            entity = self._create_random_entity_dict()
            await table.create_entity(table_entity_properties=entity)
    ...
    async def test_sas_add_inside_range(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            # Assert
            resp = await self.table.query_entities_with_partition_and_row_key('test', 'test1')
            self._assert_default_entity(resp)
        finally:
            await self._tear_down()
    ...
    async def test_sas_update(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            await table.update_entity(table_entity_properties=updated_entity)
    ...
    async def test_sas_signed_identifier(self, resource_group, location, storage_account, storage_account_key):
        ...
        try:
            ...
            table = await service.get_table_client(table=self.table_name)
            entities = []
            async for t in table.query_entities(
                query_options=QueryOptions(filter="PartitionKey eq '{}'".format(entity.PartitionKey))):
                entities.append(t)
