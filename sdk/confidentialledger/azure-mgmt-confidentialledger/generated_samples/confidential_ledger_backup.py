...
# USAGE
    python confidential_ledger_backup.py
...
def main():
    ...
    response = client.ledger.begin_backup(
...
# x-ms-original-file: specification/confidentialledger/resource-manager/Microsoft.ConfidentialLedger/preview/2025-06-10-preview/examples/ConfidentialLedger_Backup.json
