...
class TestConfidentialLedgerMgmtLedgerOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_ledger_begin_files_export(self, resource_group):
        response = self.client.ledger.begin_files_export(
            resource_group_name=resource_group.name,
            ledger_name="str",
