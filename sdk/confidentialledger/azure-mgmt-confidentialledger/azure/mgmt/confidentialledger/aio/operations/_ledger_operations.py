...
class LedgerOperations:
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~microsoft.confidentialledger.models.ConfidentialLedger
    ...
    async def begin_create(
        ...
        **kwargs
        ...
        :type confidential_ledger: ~microsoft.confidentialledger.models.ConfidentialLedger
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: Pass in True if you'd like the AsyncARMPolling polling method,
         False for no polling, or your own initialized polling object for a personal polling strategy.
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~microsoft.confidentialledger.models.ConfidentialLedger]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ConfidentialLedger"]
    ...
    def list_by_resource_group(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~microsoft.confidentialledger.models.ConfidentialLedgerList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
