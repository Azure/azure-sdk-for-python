...
class Operations:
    ...
    :type models: ~microsoft.confidentialledger.models
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~microsoft.confidentialledger.models.ResourceProviderOperationList]
