...
class LedgerOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.ConfidentialLedger"
    ...
    def _create_initial(
        ...
        resource_group_name,  # type: str
        ledger_name,  # type: str
        confidential_ledger,  # type: "_models.ConfidentialLedger"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.ConfidentialLedger"]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.ConfidentialLedger"]
        ...
        :rtype: ~azure.core.polling.LROPoller[~microsoft.confidentialledger.models.ConfidentialLedger]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ConfidentialLedger"]
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ConfidentialLedgerList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~microsoft.confidentialledger.models.ConfidentialLedgerList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
