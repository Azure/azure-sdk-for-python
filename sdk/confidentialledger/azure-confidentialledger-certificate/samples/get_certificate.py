...
def main():
    ...
    # ConfidentialLedgerClient from the azure-confidentialledger package. Here, we write it to
    # a temporary file so that is is cleaned up automatically when the program exits.
