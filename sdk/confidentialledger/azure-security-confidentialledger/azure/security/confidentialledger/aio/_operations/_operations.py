...
class ConfidentialLedgerServiceOperationsMixin(MixinABC):
    @distributed_trace_async
    async def list_collections(self, *, api_version: str, **kwargs: Any) -> List[_models.CollectionModel]:
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[List[_models.CollectionModel]]
    ...
    @distributed_trace
    def list_ledger_entries(self, *, api_version: str, **kwargs: Any) -> AsyncIterable["_models.LedgerEntry"]:
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models._models.PagedLedgerEntries]
    ...
    async def create_ledger_entry(  # pylint: disable=inconsistent-return-statements
        self,
        body: Union[_models.ConfidentialLedgerCreateLedgerEntryRequest, JSON],
        *,
        api_version: str,
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body:
         ~azure.security.confidentialledger.models.ConfidentialLedgerCreateLedgerEntryRequest or JSON
        :keyword api_version: The API version to use for this operation. Required.
        :paramtype api_version: str
    ...
    async def create_ledger_entry(  # pylint: disable=inconsistent-return-statements
        self,
        body: Union[_models.ConfidentialLedgerCreateLedgerEntryRequest, JSON, IO],
        *,
        api_version: str,
        collection_id: Optional[str] = None,
        **kwargs: Any
        ...
        :type body:
         ~azure.security.confidentialledger.models.ConfidentialLedgerCreateLedgerEntryRequest or JSON or
         IO
        :keyword api_version: The API version to use for this operation. Required.
        :paramtype api_version: str
        :keyword collection_id: The collection id. Default value is None.
    ...
    @distributed_trace_async
    async def get_receipt(self, transaction_id: str, *, api_version: str, **kwargs: Any) -> _models.TransactionReceipt:
    ...
    @distributed_trace_async
    async def get_user(self, user_id: str, *, api_version: str, **kwargs: Any) -> _models.LedgerUser:
        """Gets a user.
    ...
    async def create_or_update_user(
        ...
        **kwargs: Any
    ) -> Union[_models.ResourceOkResponse, _models.ResourceCreatedResponse]:
        ...
        :paramtype content_type: str
        :return: ResourceOkResponse or ResourceCreatedResponse. The ResourceOkResponse is compatible
         with MutableMapping
        :rtype: ~azure.security.confidentialledger.models.ResourceOkResponse or
         ~azure.security.confidentialledger.models.ResourceCreatedResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create_or_update_user(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[Union[_models.ResourceOkResponse, _models.ResourceCreatedResponse]]
        ...
        if response.status_code == 200:
            deserialized = _deserialize(_models.ResourceOkResponse, response.json())

        if response.status_code == 201:
            deserialized = _deserialize(_models.ResourceCreatedResponse, response.json())
