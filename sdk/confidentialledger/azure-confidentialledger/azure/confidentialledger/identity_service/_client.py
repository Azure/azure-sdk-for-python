...
class ConfidentialLedgerIdentityServiceClient:
    ...
    :vartype confidential_ledger_identity_service:
     azure.confidentialledger.identity_service.operations.ConfidentialLedgerIdentityServiceOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = ConfidentialLedgerIdentityServiceClientConfiguration(identity_service_uri=identity_service_uri, credential=credential, **kwargs)
