...
class ConfidentialLedgerClientOperationsMixin(ConfidentialLedgerClientMixinABC):
    ...
    def create_ledger_entry(
        ...
        :param entry: Ledger entry. Is either a JSON type or a IO type. Required.
    ...
    def create_or_update_user(self, user_id: str, user_details: Union[JSON, IO], **kwargs: Any) -> JSON:
        ...
        :param user_id: The user id, either an AAD object ID or certificate fingerprint. Required.
        :type user_id: str
        :param user_details: Details about a Confidential Ledger user. Is either a JSON type or a IO
         type. Required.
