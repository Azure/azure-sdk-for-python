...
def build_certificate_get_ledger_identity_request(  # pylint: disable=name-too-long
...
class CertificateClientOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], CertificateClientConfiguration]
):
