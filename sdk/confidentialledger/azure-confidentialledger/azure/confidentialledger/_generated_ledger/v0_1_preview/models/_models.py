...
class ConfidentialLedgerEnclaves(msrest.serialization.Model):
    ...
    :type enclave_quotes: dict[str,
     ~azure.confidentialledger._generated_ledger.v0_1_preview.models.EnclaveQuote]
    """
...
class ConfidentialLedgerError(msrest.serialization.Model):
    ...
    :vartype error:
     ~azure.confidentialledger._generated_ledger.v0_1_preview.models.ConfidentialLedgerErrorBody
    """
...
class Consortium(msrest.serialization.Model):
    ...
    :type members:
     list[~azure.confidentialledger._generated_ledger.v0_1_preview.models.ConsortiumMember]
    """
...
class LedgerQueryResult(msrest.serialization.Model):
    ...
    :type state: str or
     ~azure.confidentialledger._generated_ledger.v0_1_preview.models.ConfidentialLedgerQueryState
    :param entry: The ledger entry found as a result of the query. This is only available if the
     query is in Ready state.
    :type entry: ~azure.confidentialledger._generated_ledger.v0_1_preview.models.LedgerEntry
    """
...
class LedgerUser(msrest.serialization.Model):
    ...
    :type assigned_role: str or
     ~azure.confidentialledger._generated_ledger.v0_1_preview.models.ConfidentialLedgerUserRoleName
...
class PagedLedgerEntries(msrest.serialization.Model):
    ...
    :type entries:
     list[~azure.confidentialledger._generated_ledger.v0_1_preview.models.LedgerEntry]
    """
...
class ReceiptContents(msrest.serialization.Model):
    ...
    :type proof:
     list[~azure.confidentialledger._generated_ledger.v0_1_preview.models.MerkleProofElement]
...
class TransactionReceipt(msrest.serialization.Model):
    ...
    :type receipt: ~azure.confidentialledger._generated_ledger.v0_1_preview.models.ReceiptContents
    :param state: Required. State of a ledger query. Possible values include: "Loading", "Ready".
    :type state: str or
     ~azure.confidentialledger._generated_ledger.v0_1_preview.models.ConfidentialLedgerQueryState
...
class TransactionStatus(msrest.serialization.Model):
    ...
    :param state: Required. Represents the state of the transaction. Possible values include:
     "Committed", "Pending".
    :type state: str or
     ~azure.confidentialledger._generated_ledger.v0_1_preview.models.TransactionState
    :param transaction_id: Required. A unique identifier for the state of the ledger. If returned
     as part of a LedgerEntry, it indicates the state from which the entry was read.
    :type transaction_id: str
    """
