...
class ConfidentialLedgerClientOperationsMixin:
    async def get_constitution(
        self, ledger_base_url: str, **kwargs
    ...
    async def get_ledger_entry_for_transaction_id(
        self,
        ledger_base_url: str,
        transaction_id: str,
        sub_ledger_id: Optional[str] = None,
    ...
    async def get_receipt(
        self, ledger_base_url: str, transaction_id: str, **kwargs
    ...
    async def get_current_ledger_entry(
        self, ledger_base_url: str, sub_ledger_id: Optional[str] = None, **kwargs
    ) -> "_models.LedgerEntry":
    ...
    async def delete_user(self, ledger_base_url: str, user_id: str, **kwargs) -> None:
    ...
    async def get_user(
        self, ledger_base_url: str, user_id: str, **kwargs
    ) -> "_models.LedgerUser":
        """Gets a user.
