...
class ConfidentialLedgerClientOperationsMixin(object):
    async def delete_user(self, ledger_base_url: str, user_id: str, **kwargs) -> None:
        ...
        return await mixin_instance.delete_user(ledger_base_url, user_id, **kwargs)
    ...
    async def get_consortium_members(
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.get_consortium_members(ledger_base_url, **kwargs)
    ...
    async def get_constitution(
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.get_constitution(ledger_base_url, **kwargs)
    ...
    async def get_current_ledger_entry(
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.get_current_ledger_entry(
    ...
    async def get_enclave_quotes(
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.get_enclave_quotes(ledger_base_url, **kwargs)
    ...
    async def get_ledger_entry_for_transaction_id(
        ...
        **kwargs
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.get_ledger_entry_for_transaction_id(
    ...
    async def get_receipt(
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.get_receipt(
    ...
    async def get_transaction_status(
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.get_transaction_status(
            ledger_base_url, transaction_id, **kwargs
        )
    ...
    async def get_user(
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.get_user(ledger_base_url, user_id, **kwargs)
    ...
    async def patch_user(
        ...
        **kwargs
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.patch_user(
    ...
    async def post_ledger_entry(
        ...
        **kwargs
        ...
        mixin_instance._serialize.client_side_validation = False
        mixin_instance._deserialize = Deserializer(self._models_dict(api_version))
        return await mixin_instance.post_ledger_entry(
