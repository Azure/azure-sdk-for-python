...
from ._operations_mixin import ConfidentialLedgerClientOperationsMixin
...
class ConfidentialLedgerClient(
    ConfidentialLedgerClientOperationsMixin, MultiApiClientMixin, _SDKClient
):
    ...
    DEFAULT_API_VERSION = "0.1-preview"
    _PROFILE_TAG = "azure.confidentialledger.ConfidentialLedgerClient"
    ...
    def models(cls, api_version=DEFAULT_API_VERSION):
        ...
        * 0.1-preview: :mod:`v0_1_preview.models<azure.confidentialledger.v0_1_preview.models>`
        """
        if api_version == "0.1-preview":
            from ..v0_1_preview import models
