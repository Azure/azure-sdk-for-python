...
class TestConfidentialLedgerClient(ConfidentialLedgerTestCase):
    ...
    def test_user_defined_role(self, confidentialledger_endpoint, confidentialledger_id):
        ...
        client.create_user_defined_role({"roles": [{"roleName": role_name, "roleActions": ["/content/read"]}]})
        time.sleep(3)
        ...
        client.update_user_defined_role({"roles": [{"roleName": role_name, "roleActions": ["/content/write", "/content/read"]}]})
        time.sleep(3)
