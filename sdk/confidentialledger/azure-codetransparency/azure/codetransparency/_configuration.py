...
class CodeTransparencyClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, endpoint: str, credential: TokenCredential, **kwargs: Any) -> None:
        ...
        self.credential_scopes = kwargs.pop("credential_scopes", ["https://confidentialledger.azure.com/.default"])
        kwargs.setdefault("sdk_moniker", "codetransparency/{}".format(__version__))
