...
class _CodeTransparencyClientOperationsMixin(
    ...
    @distributed_trace_async
    async def get_public_keys(self, **kwargs: Any) -> Union[_models.JwksDocument, AsyncIterator[bytes]]:
        """Get the public keys used by the service to sign receipts, mentioned in IETF SCITT draft as part
        of jwks_uri implementation.

        :return: JwksDocument or AsyncIterator[bytes]. The JwksDocument is compatible with
         MutableMapping
        :rtype: ~azure.codetransparency.models.JwksDocument or AsyncIterator[bytes]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[Union[_models.JwksDocument, AsyncIterator[bytes]]] = kwargs.pop("cls", None)
