...
def build_code_transparency_create_entry_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class _CodeTransparencyClientOperationsMixin(
    ...
    @distributed_trace
    def get_public_keys(self, **kwargs: Any) -> Union[_models.JwksDocument, Iterator[bytes]]:
        """Get the public keys used by the service to sign receipts, mentioned in IETF SCITT draft as part
        of jwks_uri implementation.

        :return: JwksDocument or Iterator[bytes]. The JwksDocument is compatible with MutableMapping
        :rtype: ~azure.codetransparency.models.JwksDocument or Iterator[bytes]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[Union[_models.JwksDocument, Iterator[bytes]]] = kwargs.pop("cls", None)
