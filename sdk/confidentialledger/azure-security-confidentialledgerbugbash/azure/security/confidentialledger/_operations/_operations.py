...
def build_confidential_ledger_list_ledger_entries_request(*, api_version: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ConfidentialLedgerClientOperationsMixin(ConfidentialLedgerClientMixinABC):
    ...
    def list_ledger_entries(self, **kwargs: Any) -> Iterable["_models.LedgerEntry"]:
        ...
        :return: An iterator like instance of LedgerEntry. The LedgerEntry is compatible with
         MutableMapping
        :rtype: ~azure.core.paging.ItemPaged[~azure.security.confidentialledger.models.LedgerEntry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
