...
from .._vendor import ConfidentialLedgerBugBashClientMixinABC, _format_url_section
...
def build_confidential_ledger_bug_bash_list_collections_request(*, api_version: str, **kwargs: Any) -> HttpRequest:
...
def build_confidential_ledger_bug_bash_get_enclave_quotes_request(*, api_version: str, **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_confidential_ledger_bug_bash_get_constitution_request(*, api_version: str, **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_confidential_ledger_bug_bash_get_consortium_members_request(
...
def build_confidential_ledger_bug_bash_list_ledger_entries_request(*, api_version: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_confidential_ledger_bug_bash_create_ledger_entry_request(
...
def build_confidential_ledger_bug_bash_get_ledger_entry_request(
...
def build_confidential_ledger_bug_bash_get_receipt_request(
...
def build_confidential_ledger_bug_bash_get_transaction_status_request(
    transaction_id: str, *, api_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_confidential_ledger_bug_bash_get_current_ledger_entry_request(
    *, api_version: str, collection_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/app/transactions:getCurrentLedgerEntry"
...
def build_confidential_ledger_bug_bash_delete_user_request(
    user_id: str, *, api_version: str, **kwargs: Any
) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_confidential_ledger_bug_bash_get_user_request(
    user_id: str, *, api_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_confidential_ledger_bug_bash_create_or_update_user_request(
    user_id: str, *, api_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ConfidentialLedgerBugBashClientOperationsMixin(ConfidentialLedgerBugBashClientMixinABC):
    @distributed_trace
    def list_collections(self, **kwargs: Any) -> List[_models.CollectionModel]:
    ...
    @distributed_trace
    def get_enclave_quotes(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace
    def get_constitution(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace
    def get_consortium_members(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace
    def list_ledger_entries(self, **kwargs: Any) -> Iterable["_models.LedgerEntry"]:
        ...
        :return: An iterator like instance of LedgerEntry. The LedgerEntry is compatible with
         MutableMapping
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.security.confidentialledgerbugbash.models.LedgerEntry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @overload
    def create_ledger_entry(  # pylint: disable=inconsistent-return-statements
        self,
