...
from ..._operations._operations import (
    build_confidential_ledger_bug_bash_create_ledger_entry_request,
    build_confidential_ledger_bug_bash_create_or_update_user_request,
    build_confidential_ledger_bug_bash_delete_user_request,
    build_confidential_ledger_bug_bash_get_consortium_members_request,
    build_confidential_ledger_bug_bash_get_constitution_request,
    build_confidential_ledger_bug_bash_get_current_ledger_entry_request,
    build_confidential_ledger_bug_bash_get_enclave_quotes_request,
    build_confidential_ledger_bug_bash_get_ledger_entry_request,
    build_confidential_ledger_bug_bash_get_receipt_request,
    build_confidential_ledger_bug_bash_get_transaction_status_request,
    build_confidential_ledger_bug_bash_get_user_request,
    build_confidential_ledger_bug_bash_list_collections_request,
    build_confidential_ledger_bug_bash_list_ledger_entries_request,
)
from .._vendor import ConfidentialLedgerBugBashClientMixinABC
...
class ConfidentialLedgerBugBashClientOperationsMixin(ConfidentialLedgerBugBashClientMixinABC):
    ...
    async def list_collections(self, **kwargs: Any) -> List[_models.CollectionModel]:
        ...
        :rtype: list[~azure.security.confidentialledgerbugbash.models.CollectionModel]
        ...
        request = build_confidential_ledger_bug_bash_list_collections_request(
    ...
    async def get_enclave_quotes(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        request = build_confidential_ledger_bug_bash_get_enclave_quotes_request(
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
        )
    ...
    async def get_constitution(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        request = build_confidential_ledger_bug_bash_get_constitution_request(
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
        )
    ...
    async def get_consortium_members(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        request = build_confidential_ledger_bug_bash_get_consortium_members_request(
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
        )
    ...
    def list_ledger_entries(self, **kwargs: Any) -> AsyncIterable["_models.LedgerEntry"]:
        ...
        :return: An iterator like instance of LedgerEntry. The LedgerEntry is compatible with
         MutableMapping
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.security.confidentialledgerbugbash.models.LedgerEntry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_confidential_ledger_bug_bash_list_ledger_entries_request(
                    api_version=self._config.api_version,
                    headers=_headers,
                    params=_params,
                )
    ...
    async def create_ledger_entry(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~azure.security.confidentialledgerbugbash.models.LedgerEntry or JSON
    ...
    async def create_ledger_entry(  # pylint: disable=inconsistent-return-statements
        ...
        :type body: ~azure.security.confidentialledgerbugbash.models.LedgerEntry or JSON or IO
        :keyword collection_id: The collection id. Default value is None.
        :paramtype collection_id: str
        ...
        request = build_confidential_ledger_bug_bash_create_ledger_entry_request(
            api_version=self._config.api_version,
    ...
    async def get_ledger_entry(
        ...
        :rtype: ~azure.security.confidentialledgerbugbash.models.LedgerEntry
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_confidential_ledger_bug_bash_get_ledger_entry_request(
    ...
    async def get_receipt(self, transaction_id: str, **kwargs: Any) -> _models.TransactionReceipt:
        ...
        :rtype: ~azure.security.confidentialledgerbugbash.models.TransactionReceipt
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_confidential_ledger_bug_bash_get_receipt_request(
            transaction_id=transaction_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    async def get_transaction_status(self, transaction_id: str, **kwargs: Any) -> _models.TransactionStatus:
        ...
        :rtype: ~azure.security.confidentialledgerbugbash.models.TransactionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_confidential_ledger_bug_bash_get_transaction_status_request(
            transaction_id=transaction_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    async def get_current_ledger_entry(
        ...
        request = build_confidential_ledger_bug_bash_get_current_ledger_entry_request(
            api_version=self._config.api_version,
            collection_id=collection_id,
            headers=_headers,
            params=_params,
    ...
    async def delete_user(self, user_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        request = build_confidential_ledger_bug_bash_delete_user_request(
            user_id=user_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    async def get_user(self, user_id: str, **kwargs: Any) -> _models.LedgerUser:
        ...
        :rtype: ~azure.security.confidentialledgerbugbash.models.LedgerUser
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_confidential_ledger_bug_bash_get_user_request(
            user_id=user_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    async def create_or_update_user(
        ...
        **kwargs: Any
        ...
        :type user_id: str
        :param body: Required.
        :type body: ~azure.security.confidentialledgerbugbash.models.LedgerUser or JSON
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
    ...
    async def create_or_update_user(
        ...
        :type user_id: str
        :param body: Is either a model type or a IO type. Required.
        :type body: ~azure.security.confidentialledgerbugbash.models.LedgerUser or JSON or IO
        ...
        request = build_confidential_ledger_bug_bash_create_or_update_user_request(
            user_id=user_id,
            api_version=self._config.api_version,
            content_type=content_type,
            content=_content,
