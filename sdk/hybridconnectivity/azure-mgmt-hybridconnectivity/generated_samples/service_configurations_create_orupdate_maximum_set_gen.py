...
# USAGE
    python service_configurations_create_orupdate_maximum_set_gen.py
...
def main():
    ...
    response = client.service_configurations.create_orupdate(
        ...
        endpoint_name="djevinbielhfx",
        service_configuration_name="inlnklujw",
        service_configuration_resource={
            "properties": {
                "port": 22,
                "resourceId": "/subscriptions/f5bcc1d9-23af-4ae9-aca1-041d0f593a63/resourceGroups/hybridRG/providers/Microsoft.HybridCompute/machines/testMachine",
                "serviceName": "SSH",
            }
        },
    )
