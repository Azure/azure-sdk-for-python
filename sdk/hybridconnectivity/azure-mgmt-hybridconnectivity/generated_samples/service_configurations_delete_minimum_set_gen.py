...
# USAGE
    python service_configurations_delete_minimum_set_gen.py
...
def main():
    ...
    client.service_configurations.delete(
        ...
        endpoint_name="ykrzxbnhnszoikyge",
        service_configuration_name="qwaxkaulnvwsspqjblxrlxtlyfr",
    )
