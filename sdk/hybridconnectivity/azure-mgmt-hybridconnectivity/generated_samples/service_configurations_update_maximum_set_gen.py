...
# USAGE
    python service_configurations_update_maximum_set_gen.py
...
def main():
    ...
    response = client.service_configurations.update(
        ...
        endpoint_name="bsbpgdlspjhyjgpoxxsoptu",
        service_configuration_name="dcdbyycehygofsazwxadc",
        service_configuration_resource={"properties": {"port": 22}},
    )
    print(response)
