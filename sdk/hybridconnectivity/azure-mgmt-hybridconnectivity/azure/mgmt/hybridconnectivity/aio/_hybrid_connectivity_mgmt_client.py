...
class HybridConnectivityMgmtClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype solution_configurations:
     azure.mgmt.hybridconnectivity.aio.operations.SolutionConfigurationsOperations
    :ivar inventory: InventoryOperations operations
    :vartype inventory: azure.mgmt.hybridconnectivity.aio.operations.InventoryOperations
    ...
    :vartype solution_types: azure.mgmt.hybridconnectivity.aio.operations.SolutionTypesOperations
    ...
    :vartype service_configurations:
     azure.mgmt.hybridconnectivity.aio.operations.ServiceConfigurationsOperations
