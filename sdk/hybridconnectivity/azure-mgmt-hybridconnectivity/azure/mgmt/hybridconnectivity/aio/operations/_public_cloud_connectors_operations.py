...
from ...operations._public_cloud_connectors_operations import (
    build_create_or_update_request,
    build_delete_request,
    build_get_request,
    build_list_by_resource_group_request,
    build_list_by_subscription_request,
    build_test_permissions_request,
...
class PublicCloudConnectorsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.PublicCloudConnector"]:
        ...
        :return: An iterator like instance of either PublicCloudConnector or the result of
         cls(response)
        :rtype:
        ...
        cls: ClsType[_models.PublicCloudConnectorListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("PublicCloudConnectorListResult", pipeline_response)
    ...
    async def get(
        ...
        :return: PublicCloudConnector or the result of cls(response)
        ...
        deserialized = self._deserialize("PublicCloudConnector", pipeline_response.http_response)
    ...
    async def _create_or_update_initial(
        ...
        resource: Union[_models.PublicCloudConnector, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "PublicCloudConnector")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either PublicCloudConnector or the result
         of cls(response)
        :rtype:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param public_cloud_connector: Represent public cloud connectors resource. Required.
        :type public_cloud_connector: str
        :param resource: Resource create parameters. Is either a PublicCloudConnector type or a
         IO[bytes] type. Required.
        :type resource: ~azure.mgmt.hybridconnectivity.models.PublicCloudConnector or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either PublicCloudConnector or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.hybridconnectivity.models.PublicCloudConnector]
    ...
    async def update(
        ...
        resource_group_name: str,
        public_cloud_connector: str,
        properties: Union[_models.PublicCloudConnectorUpdate, IO[bytes]],
        **kwargs: Any
    ) -> _models.PublicCloudConnector:
        """Update a PublicCloudConnector.
        ...
        :param properties: The resource properties to be updated. Is either a
         PublicCloudConnectorUpdate type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.hybridconnectivity.models.PublicCloudConnectorUpdate or IO[bytes]
        :return: PublicCloudConnector or the result of cls(response)
        :rtype: ~azure.mgmt.hybridconnectivity.models.PublicCloudConnector
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "PublicCloudConnectorUpdate")
    ...
    async def _test_permissions_initial(
        ...
        _request = build_test_permissions_request(
            resource_group_name=resource_group_name,
            public_cloud_connector=public_cloud_connector,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
