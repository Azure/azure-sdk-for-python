...
def build_list_credentials_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/{resourceUri}/providers/Microsoft.HybridConnectivity/endpoints/{endpointName}/listCredentials")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceUri": _SERIALIZER.url("resource_uri", resource_uri, 'str', skip_quote=True),
        "endpointName": _SERIALIZER.url("endpoint_name", endpoint_name, 'str', skip_quote=True),
    }
    ...
    if expiresin is not None:
        _query_parameters['expiresin'] = _SERIALIZER.query("expiresin", expiresin, 'long', maximum=10800, minimum=600)
...
def build_list_managed_proxy_details_request(
    resource_uri: str,
    endpoint_name: str,
    *,
    json: JSONType = None,
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/{resourceUri}/providers/Microsoft.HybridConnectivity/endpoints/{endpointName}/listManagedProxyDetails")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceUri": _SERIALIZER.url("resource_uri", resource_uri, 'str', skip_quote=True),
        "endpointName": _SERIALIZER.url("endpoint_name", endpoint_name, 'str', skip_quote=True),
    }
...
class EndpointsOperations(object):
    ...
    def list(
        ...
        resource_uri: str,
        **kwargs: Any
    ) -> Iterable["_models.EndpointsList"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.hybridconnectivity.models.EndpointsList]
