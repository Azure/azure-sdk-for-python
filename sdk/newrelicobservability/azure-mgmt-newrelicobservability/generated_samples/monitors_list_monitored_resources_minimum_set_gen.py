...
# USAGE
    python monitors_list_monitored_resources_minimum_set_gen.py
...
# x-ms-original-file: specification/newrelic/resource-manager/NewRelic.Observability/stable/2024-03-01/examples/Monitors_ListMonitoredResources_MinimumSet_Gen.json
