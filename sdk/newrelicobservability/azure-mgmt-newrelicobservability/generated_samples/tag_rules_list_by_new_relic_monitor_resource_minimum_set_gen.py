...
# USAGE
    python tag_rules_list_by_new_relic_monitor_resource_minimum_set_gen.py
...
# x-ms-original-file: specification/newrelic/resource-manager/NewRelic.Observability/stable/2024-03-01/examples/TagRules_ListByNewRelicMonitorResource_MinimumSet_Gen.json
