...
class NewRelicObservabilityMgmtClient:  # pylint: disable=too-many-instance-attributes,docstring-keyword-should-match-keyword-only
    """NewRelicObservabilityMgmtClient.

    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.newrelicobservability.operations.Operations
    ...
    :vartype monitors: azure.mgmt.newrelicobservability.operations.MonitorsOperations
    ...
    :vartype accounts: azure.mgmt.newrelicobservability.operations.AccountsOperations
    ...
    :vartype saa_s: azure.mgmt.newrelicobservability.operations.SaaSOperations
