...
class NewRelicObservabilityMgmtClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.newrelicobservability.aio.operations.Operations
    :ivar accounts: AccountsOperations operations
    :vartype accounts: azure.mgmt.newrelicobservability.aio.operations.AccountsOperations
    :ivar monitors: MonitorsOperations operations
    :vartype monitors: azure.mgmt.newrelicobservability.aio.operations.MonitorsOperations
    ...
    :ivar saa_s: SaaSOperations operations
    :vartype saa_s: azure.mgmt.newrelicobservability.aio.operations.SaaSOperations
    ...
    :vartype monitored_subscriptions:
     azure.mgmt.newrelicobservability.aio.operations.MonitoredSubscriptionsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.saa_s = SaaSOperations(self._client, self._config, self._serialize, self._deserialize)
