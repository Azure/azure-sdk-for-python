...
from ...operations._monitors_operations import (
    ...
    build_get_request,
    build_latest_linked_saa_s_request,
    build_link_saa_s_request,
...
class MonitorsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def latest_linked_saa_s(
        ...
        :type monitor_name: str
        :return: LatestLinkedSaaSResponse or the result of cls(response)
        ...
        _request = build_latest_linked_saa_s_request(
            resource_group_name=resource_group_name,
            monitor_name=monitor_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
        ...
        deserialized = self._deserialize("LatestLinkedSaaSResponse", pipeline_response.http_response)
    ...
    async def _link_saa_s_initial(
        self, resource_group_name: str, monitor_name: str, body: Union[_models.SaaSData, IO[bytes]], **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "SaaSData")

        _request = build_link_saa_s_request(
            resource_group_name=resource_group_name,
            monitor_name=monitor_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    async def begin_link_saa_s(
        ...
        :type body: ~azure.mgmt.newrelicobservability.models.SaaSData or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NewRelicMonitorResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.newrelicobservability.models.NewRelicMonitorResource]
