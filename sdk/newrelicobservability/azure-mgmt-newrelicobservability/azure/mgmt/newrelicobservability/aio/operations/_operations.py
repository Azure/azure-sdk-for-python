...
from ...operations._operations import (
    ...
    build_monitored_subscriptions_create_or_update_request,
    ...
    build_monitors_create_or_update_request,
    build_monitors_delete_request,
    build_monitors_get_metric_rules_request,
    build_monitors_get_metric_status_request,
    build_monitors_get_request,
    build_monitors_latest_linked_saa_s_request,
    build_monitors_link_saa_s_request,
    build_monitors_list_app_services_request,
    build_monitors_list_by_resource_group_request,
    build_monitors_list_by_subscription_request,
    ...
    build_monitors_refresh_ingestion_key_request,
    build_monitors_resubscribe_request,
    build_monitors_switch_billing_request,
    build_monitors_update_request,
    build_monitors_vm_host_payload_request,
    build_operations_list_request,
    build_organizations_list_request,
    build_plans_list_request,
    build_saa_s_activate_resource_request,
    build_tag_rules_create_or_update_request,
    build_tag_rules_delete_request,
    build_tag_rules_get_request,
    build_tag_rules_list_by_new_relic_monitor_resource_request,
    build_tag_rules_update_request,
)
...
class TagRulesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns TagRule. The TagRule is compatible with
         MutableMapping
...
class MonitoredSubscriptionsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.newrelicobservability.models.MonitoredSubscriptionProperties]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.newrelicobservability.models.MonitoredSubscriptionProperties]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class MonitorsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns NewRelicMonitorResource. The
    ...
    ) -> AsyncItemPaged["_models.NewRelicMonitorResource"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.NewRelicMonitorResource"]:
    ...
    def list_app_services(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncItemPaged["_models.AppServiceInfo"]:
...
class ConnectedPartnerResourcesOperations:
    ...
    ) -> AsyncItemPaged["_models.ConnectedPartnerResourcesListFormat"]:
