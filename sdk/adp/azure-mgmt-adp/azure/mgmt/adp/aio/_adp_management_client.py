...
class AdpManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def accounts(self):
        """Instance depends on the API version:
           ...
           * 2021-02-01-preview: :class:`AccountsOperations<azure.mgmt.adp.v2021_02_01_preview.aio.operations.AccountsOperations>`
        """
        ...
        if api_version == '2020-07-01-preview':
            ...
            from ..v2021_02_01_preview.aio.operations import AccountsOperations as OperationClass
        else:
    ...
    def data_pools(self):
        """Instance depends on the API version:
           ...
           * 2021-02-01-preview: :class:`DataPoolsOperations<azure.mgmt.adp.v2021_02_01_preview.aio.operations.DataPoolsOperations>`
        """
        ...
        if api_version == '2020-07-01-preview':
            ...
            from ..v2021_02_01_preview.aio.operations import DataPoolsOperations as OperationClass
        else:
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2021-02-01-preview: :class:`Operations<azure.mgmt.adp.v2021_02_01_preview.aio.operations.Operations>`
        """
