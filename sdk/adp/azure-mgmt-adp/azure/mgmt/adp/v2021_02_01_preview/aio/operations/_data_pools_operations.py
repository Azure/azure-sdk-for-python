...
class DataPoolsOperations:
    ...
    def list(
        ...
        account_name: str,
        **kwargs
    ) -> AsyncIterable["_models.DataPoolList"]:
    ...
    async def _update_initial(
        ...
        account_name: str,
        data_pool_name: str,
        parameters: Optional["_models.DataPoolPatch"] = None,
        **kwargs
    ) -> "_models.DataPool":
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.DataPool"]
        error_map = {
    ...
    async def begin_update(
        ...
        parameters: Optional["_models.DataPoolPatch"] = None,
        **kwargs
    ) -> AsyncLROPoller["_models.DataPool"]:
    ...
    async def _create_or_update_initial(
        ...
        account_name: str,
        data_pool_name: str,
        parameters: Optional["_models.DataPool"] = None,
        **kwargs
    ) -> "_models.DataPool":
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.DataPool"]
        error_map = {
