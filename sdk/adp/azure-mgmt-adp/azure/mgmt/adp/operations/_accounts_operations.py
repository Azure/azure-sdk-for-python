...
class AccountsOperations(object):
    ...
    def check_name_availability(
        self,
        parameters,  # type: "_models.AccountCheckNameAvailabilityParameters"
        **kwargs  # type: Any
    ):
        ...
        :type parameters: ~adp_management_client.models.AccountCheckNameAvailabilityParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CheckNameAvailabilityResult, or the result of cls(response)
        :rtype: ~adp_management_client.models.CheckNameAvailabilityResult
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.AccountList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~adp_management_client.models.AccountList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.AutonomousDevelopmentPlatform/accounts'}  # type: ignore
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~adp_management_client.models.Account
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        account_name,  # type: str
        parameters=None,  # type: Optional["_models.AccountPatch"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Account"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.Account"]
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.Account"]
        ...
        :type parameters: ~adp_management_client.models.AccountPatch
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.LROPoller[~adp_management_client.models.Account]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        account_name,  # type: str
        parameters=None,  # type: Optional["_models.Account"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Account"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.Account"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~adp_management_client.models.Account
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
