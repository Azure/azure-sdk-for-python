...
class DataPoolsOperations(object):
    ...
    :type models: ~adp_management_client.models
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.DataPoolList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~adp_management_client.models.DataPoolList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.DataPoolList"]
        error_map = {
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize('DataPoolList', pipeline_response)
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AutonomousDevelopmentPlatform/accounts/{accountName}/dataPools'}  # type: ignore
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~adp_management_client.models.DataPool
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.DataPool"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def _update_initial(
        ...
        account_name,  # type: str
        data_pool_name,  # type: str
        parameters=None,  # type: Optional["_models.DataPoolPatch"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.DataPool"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.DataPool"]
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.DataPool"]
        ...
        :type parameters: ~adp_management_client.models.DataPoolPatch
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.LROPoller[~adp_management_client.models.DataPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _create_or_update_initial(
        ...
        account_name,  # type: str
        data_pool_name,  # type: str
        parameters=None,  # type: Optional["_models.DataPool"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.DataPool"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.DataPool"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type data_pool_name: str
        :param parameters: The parameters to provide for the Data Pool.
        :type parameters: ~adp_management_client.models.DataPool
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
    ...
    def begin_delete(
        ...
        **kwargs  # type: Any
        ...
        if cont_token:
            ...
            return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AutonomousDevelopmentPlatform/accounts/{accountName}/dataPools/{dataPoolName}'}  # type: ignore
