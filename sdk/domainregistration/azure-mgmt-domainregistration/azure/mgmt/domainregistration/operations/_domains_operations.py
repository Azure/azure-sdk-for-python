...
class DomainsOperations:
    ...
    def begin_create_or_update(
        ...
        :param domain: Domain registration information. Is either a Domain type or a IO[bytes] type.
         Required.
        :type domain: ~azure.mgmt.domainregistration.models.Domain or IO[bytes]
        :return: An instance of LROPoller that returns either Domain or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.domainregistration.models.Domain]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type domain: ~azure.mgmt.domainregistration.models.DomainPatchResource or IO[bytes]
        :return: Domain or the result of cls(response)
        :rtype: ~azure.mgmt.domainregistration.models.Domain
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def create_or_update_ownership_identifier(
        ...
        **kwargs: Any
        ...
        :type domain_ownership_identifier:
         ~azure.mgmt.domainregistration.models.DomainOwnershipIdentifier or IO[bytes]
        :return: DomainOwnershipIdentifier or the result of cls(response)
        :rtype: ~azure.mgmt.domainregistration.models.DomainOwnershipIdentifier
        :raises ~azure.core.exceptions.HttpResponseError:
        """
