...
class TestDomainRegistrationMgmtDomainRegistrationProviderOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(DomainRegistrationMgmtClient)
