...
class IotHubResourceOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type iot_hub_description: ~azure.mgmt.iothub.models.IotHubDescription or IO[bytes]
        :param if_match: ETag of the IoT Hub. Do not specify for creating a brand new IoT Hub. Required
         to update an existing IoT Hub. Default value is None.
        :type if_match: str
        :return: An instance of LROPoller that returns either IotHubDescription or the result of
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type iot_hub_tags: ~azure.mgmt.iothub.models.TagsResource or IO[bytes]
        :return: An instance of LROPoller that returns either IotHubDescription or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.iothub.models.IotHubDescription]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def check_name_availability(
        ...
        :type operation_inputs: ~azure.mgmt.iothub.models.OperationInputs or IO[bytes]
        :return: IotHubNameAvailabilityInfo or the result of cls(response)
        :rtype: ~azure.mgmt.iothub.models.IotHubNameAvailabilityInfo
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def test_all_routes(
        ...
        **kwargs: Any
        ...
        :param input: Input for testing all routes. Is either a TestAllRoutesInput type or a IO[bytes]
         type. Required.
        :type input: ~azure.mgmt.iothub.models.TestAllRoutesInput or IO[bytes]
        :return: TestAllRoutesResult or the result of cls(response)
        :rtype: ~azure.mgmt.iothub.models.TestAllRoutesResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def test_route(
        ...
        **kwargs: Any
        ...
        :param input: Route that needs to be tested. Is either a TestRouteInput type or a IO[bytes]
         type. Required.
        :type input: ~azure.mgmt.iothub.models.TestRouteInput or IO[bytes]
        :return: TestRouteResult or the result of cls(response)
        :rtype: ~azure.mgmt.iothub.models.TestRouteResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def export_devices(
        ...
        **kwargs: Any
        ...
        :type export_devices_parameters: ~azure.mgmt.iothub.models.ExportDevicesRequest or IO[bytes]
        :return: JobResponse or the result of cls(response)
        :rtype: ~azure.mgmt.iothub.models.JobResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def import_devices(
        ...
        **kwargs: Any
        ...
        :type import_devices_parameters: ~azure.mgmt.iothub.models.ImportDevicesRequest or IO[bytes]
        :return: JobResponse or the result of cls(response)
        :rtype: ~azure.mgmt.iothub.models.JobResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
