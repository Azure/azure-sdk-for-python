...
class CertificatesOperations(object):
    ...
    :ivar api_version: The version of the API. Constant value: "2021-03-03-preview".
    """
    ...
    def create_or_update(
            self, resource_group_name, resource_name, certificate_name, if_match=None, properties=None, custom_headers=None, raw=False, **operation_config):
        ...
        :raises:
         :class:`ErrorDetailsException<azure.mgmt.iothub.models.ErrorDetailsException>`
        """
        certificate_description = models.CertificateDescription(properties=properties)
