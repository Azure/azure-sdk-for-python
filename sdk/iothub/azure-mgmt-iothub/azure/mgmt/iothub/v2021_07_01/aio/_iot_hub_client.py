...
class IotHubClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype iot_hub_resource:
     azure.mgmt.iothub.v2021_07_01.aio.operations.IotHubResourceOperations
    :ivar resource_provider_common: ResourceProviderCommonOperations operations
    :vartype resource_provider_common:
     azure.mgmt.iothub.v2021_07_01.aio.operations.ResourceProviderCommonOperations
    ...
    :vartype private_link_resources:
     azure.mgmt.iothub.v2021_07_01.aio.operations.PrivateLinkResourcesOperations
    :ivar private_endpoint_connections: PrivateEndpointConnectionsOperations operations
    :vartype private_endpoint_connections:
     azure.mgmt.iothub.v2021_07_01.aio.operations.PrivateEndpointConnectionsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.iot_hub = IotHubOperations(self._client, self._config, self._serialize, self._deserialize, "2021-07-01")
