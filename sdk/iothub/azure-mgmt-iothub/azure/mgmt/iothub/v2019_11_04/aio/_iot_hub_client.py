...
class IotHubClient(object):
    ...
    :vartype iot_hub_resource: azure.mgmt.iothub.v2019_11_04.aio.operations.IotHubResourceOperations
    :ivar resource_provider_common: ResourceProviderCommonOperations operations
    :vartype resource_provider_common: azure.mgmt.iothub.v2019_11_04.aio.operations.ResourceProviderCommonOperations
