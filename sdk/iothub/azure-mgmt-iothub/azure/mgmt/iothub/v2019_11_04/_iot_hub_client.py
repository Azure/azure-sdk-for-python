...
class IotHubClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype resource_provider_common:
     azure.mgmt.iothub.v2019_11_04.operations.ResourceProviderCommonOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.operations = Operations(self._client, self._config, self._serialize, self._deserialize, "2019-11-04")
        self.iot_hub_resource = IotHubResourceOperations(
            self._client, self._config, self._serialize, self._deserialize, "2019-11-04"
        )
        ...
        self.iot_hub = IotHubOperations(self._client, self._config, self._serialize, self._deserialize, "2019-11-04")
