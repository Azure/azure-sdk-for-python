...
class IotHubClient(object):
    ...
    :vartype iot_hub_resource: azure.mgmt.iothub.v2018_04_01.aio.operations.IotHubResourceOperations
    :ivar resource_provider_common: ResourceProviderCommonOperations operations
    :vartype resource_provider_common: azure.mgmt.iothub.v2018_04_01.aio.operations.ResourceProviderCommonOperations
