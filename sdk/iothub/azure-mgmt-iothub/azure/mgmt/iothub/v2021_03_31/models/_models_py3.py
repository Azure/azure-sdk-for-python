...
class ExportDevicesRequest(Model):
    ...
    def __init__(self, *, export_blob_container_uri: str, exclude_keys: bool, export_blob_name: str=None, authentication_type=None, identity=None, include_configurations: bool=None, configurations_blob_name: str=None, **kwargs) -> None:
