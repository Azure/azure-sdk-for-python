...
class IotHubResourceOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.iothub.v2023_06_30.aio.IotHubClient`'s
    ...
    async def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.IotHubDescription:
        ...
        :rtype: ~azure.mgmt.iothub.v2023_06_30.models.IotHubDescription
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._api_version or "2023-06-30"))
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type iot_hub_description: ~azure.mgmt.iothub.v2023_06_30.models.IotHubDescription
        ...
        :return: An instance of AsyncLROPoller that returns either IotHubDescription or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.iothub.v2023_06_30.models.IotHubDescription]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type iot_hub_description: ~azure.mgmt.iothub.v2023_06_30.models.IotHubDescription or IO[bytes]
        :param if_match: ETag of the IoT Hub. Do not specify for creating a brand new IoT Hub. Required
         to update an existing IoT Hub. Default value is None.
        :type if_match: str
        :return: An instance of AsyncLROPoller that returns either IotHubDescription or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type iot_hub_tags: ~azure.mgmt.iothub.v2023_06_30.models.TagsResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either IotHubDescription or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type iot_hub_tags: ~azure.mgmt.iothub.v2023_06_30.models.TagsResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either IotHubDescription or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.iothub.v2023_06_30.models.IotHubDescription]
    ...
    async def begin_delete(
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.iothub.v2023_06_30.models.IotHubDescription] or
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.iothub.v2023_06_30.models.ErrorDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.IotHubDescription"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.iothub.v2023_06_30.models.IotHubDescription]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_stats(
        ...
        :rtype: ~azure.mgmt.iothub.v2023_06_30.models.RegistryStatistics
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def get_valid_skus(
        ...
        :return: An iterator like instance of either IotHubSkuDescription or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.iothub.v2023_06_30.models.IotHubSkuDescription]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_event_hub_consumer_groups(
        ...
        :return: An iterator like instance of either EventHubConsumerGroupInfo or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.iothub.v2023_06_30.models.EventHubConsumerGroupInfo]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_event_hub_consumer_group(
        ...
        :rtype: ~azure.mgmt.iothub.v2023_06_30.models.EventHubConsumerGroupInfo
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def create_event_hub_consumer_group(
        ...
        **kwargs: Any
        ...
        :type consumer_group_body:
         ~azure.mgmt.iothub.v2023_06_30.models.EventHubConsumerGroupBodyDescription
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: EventHubConsumerGroupInfo or the result of cls(response)
    ...
    async def create_event_hub_consumer_group(
        ...
        **kwargs: Any
        ...
        :type consumer_group_body:
         ~azure.mgmt.iothub.v2023_06_30.models.EventHubConsumerGroupBodyDescription or IO[bytes]
        :return: EventHubConsumerGroupInfo or the result of cls(response)
        :rtype: ~azure.mgmt.iothub.v2023_06_30.models.EventHubConsumerGroupInfo
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_jobs(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.iothub.v2023_06_30.models.JobResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_job(
        ...
        :rtype: ~azure.mgmt.iothub.v2023_06_30.models.JobResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def get_quota_metrics(
        ...
        :return: An iterator like instance of either IotHubQuotaMetricInfo or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.iothub.v2023_06_30.models.IotHubQuotaMetricInfo]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get_endpoint_health(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.iothub.v2023_06_30.models.EndpointHealthData]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def check_name_availability(
        ...
        :type operation_inputs: ~azure.mgmt.iothub.v2023_06_30.models.OperationInputs
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: IotHubNameAvailabilityInfo or the result of cls(response)
        :rtype: ~azure.mgmt.iothub.v2023_06_30.models.IotHubNameAvailabilityInfo
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def check_name_availability(
        ...
        :type operation_inputs: ~azure.mgmt.iothub.v2023_06_30.models.OperationInputs or IO[bytes]
        :return: IotHubNameAvailabilityInfo or the result of cls(response)
        :rtype: ~azure.mgmt.iothub.v2023_06_30.models.IotHubNameAvailabilityInfo
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def test_all_routes(
        ...
        **kwargs: Any
        ...
        :type input: ~azure.mgmt.iothub.v2023_06_30.models.TestAllRoutesInput
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: TestAllRoutesResult or the result of cls(response)
        :rtype: ~azure.mgmt.iothub.v2023_06_30.models.TestAllRoutesResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def test_all_routes(
        ...
        **kwargs: Any
        ...
        :param input: Input for testing all routes. Is either a TestAllRoutesInput type or a IO[bytes]
         type. Required.
        :type input: ~azure.mgmt.iothub.v2023_06_30.models.TestAllRoutesInput or IO[bytes]
        :return: TestAllRoutesResult or the result of cls(response)
        :rtype: ~azure.mgmt.iothub.v2023_06_30.models.TestAllRoutesResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def test_route(
        ...
        **kwargs: Any
        ...
        :type input: ~azure.mgmt.iothub.v2023_06_30.models.TestRouteInput
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: TestRouteResult or the result of cls(response)
        :rtype: ~azure.mgmt.iothub.v2023_06_30.models.TestRouteResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def test_route(
        ...
        **kwargs: Any
        ...
        :param input: Route that needs to be tested. Is either a TestRouteInput type or a IO[bytes]
         type. Required.
        :type input: ~azure.mgmt.iothub.v2023_06_30.models.TestRouteInput or IO[bytes]
        :return: TestRouteResult or the result of cls(response)
        :rtype: ~azure.mgmt.iothub.v2023_06_30.models.TestRouteResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_keys(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.iothub.v2023_06_30.models.SharedAccessSignatureAuthorizationRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_keys_for_key_name(
        ...
        :rtype: ~azure.mgmt.iothub.v2023_06_30.models.SharedAccessSignatureAuthorizationRule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def export_devices(
        ...
        **kwargs: Any
        ...
        :param export_devices_parameters: The parameters that specify the export devices operation.
         Required.
        :type export_devices_parameters: ~azure.mgmt.iothub.v2023_06_30.models.ExportDevicesRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: JobResponse or the result of cls(response)
    ...
    async def export_devices(
        ...
        **kwargs: Any
        ...
        :type export_devices_parameters: ~azure.mgmt.iothub.v2023_06_30.models.ExportDevicesRequest or
         IO[bytes]
        :return: JobResponse or the result of cls(response)
        :rtype: ~azure.mgmt.iothub.v2023_06_30.models.JobResponse
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def import_devices(
        ...
        **kwargs: Any
        ...
        :param import_devices_parameters: The parameters that specify the import devices operation.
         Required.
        :type import_devices_parameters: ~azure.mgmt.iothub.v2023_06_30.models.ImportDevicesRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: JobResponse or the result of cls(response)
    ...
    async def import_devices(
        ...
        **kwargs: Any
        ...
        :type import_devices_parameters: ~azure.mgmt.iothub.v2023_06_30.models.ImportDevicesRequest or
         IO[bytes]
        :return: JobResponse or the result of cls(response)
        :rtype: ~azure.mgmt.iothub.v2023_06_30.models.JobResponse
        :raises ~azure.core.exceptions.HttpResponseError:
