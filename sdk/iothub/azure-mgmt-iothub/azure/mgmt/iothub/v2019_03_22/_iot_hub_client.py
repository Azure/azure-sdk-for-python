...
from .operations import CertificatesOperations, IotHubOperations, IotHubResourceOperations, Operations, ResourceProviderCommonOperations
...
class IotHubClient:
    ...
    :vartype operations: azure.mgmt.iothub.v2019_03_22.operations.Operations
    :ivar iot_hub_resource: IotHubResourceOperations operations
    :vartype iot_hub_resource: azure.mgmt.iothub.v2019_03_22.operations.IotHubResourceOperations
    :ivar resource_provider_common: ResourceProviderCommonOperations operations
    :vartype resource_provider_common:
     azure.mgmt.iothub.v2019_03_22.operations.ResourceProviderCommonOperations
    :ivar certificates: CertificatesOperations operations
    :vartype certificates: azure.mgmt.iothub.v2019_03_22.operations.CertificatesOperations
    :ivar iot_hub: IotHubOperations operations
    :vartype iot_hub: azure.mgmt.iothub.v2019_03_22.operations.IotHubOperations
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2019-03-22". Note that overriding this
