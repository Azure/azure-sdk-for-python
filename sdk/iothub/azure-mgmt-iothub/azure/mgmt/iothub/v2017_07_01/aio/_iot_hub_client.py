...
class IotHubClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype operations: azure.mgmt.iothub.v2017_07_01.aio.operations.Operations
    :ivar iot_hub_resource: IotHubResourceOperations operations
    :vartype iot_hub_resource:
     azure.mgmt.iothub.v2017_07_01.aio.operations.IotHubResourceOperations
    :ivar certificates: CertificatesOperations operations
    :vartype certificates: azure.mgmt.iothub.v2017_07_01.aio.operations.CertificatesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.operations = Operations(self._client, self._config, self._serialize, self._deserialize, "2017-07-01")
