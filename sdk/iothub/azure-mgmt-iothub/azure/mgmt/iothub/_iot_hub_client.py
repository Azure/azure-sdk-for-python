...
class IotHubClient(MultiApiClientMixin, SDKClient):
    ...
    def models(cls, api_version=DEFAULT_API_VERSION):
        """Module depends on the API version:
           ...
           * 2021-03-03-preview: :mod:`v2021_03_01_preview.models<azure.mgmt.iothub.v2021_03_01_preview.models>`
        """
    ...
    def certificates(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`CertificatesOperations<azure.mgmt.iothub.v2021_03_01_preview.operations.CertificatesOperations>`
        """
        ...
        if api_version == '2017-07-01':
            ...
            from .v2021_03_01_preview.operations import CertificatesOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
    ...
    def iot_hub(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`IotHubOperations<azure.mgmt.iothub.v2021_03_01_preview.operations.IotHubOperations>`
        """
        ...
        if api_version == '2019-03-22':
            ...
            from .v2021_03_01_preview.operations import IotHubOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def iot_hub_resource(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`IotHubResourceOperations<azure.mgmt.iothub.v2021_03_01_preview.operations.IotHubResourceOperations>`
        """
        ...
        if api_version == '2016-02-03':
            ...
            from .v2021_03_01_preview.operations import IotHubResourceOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`Operations<azure.mgmt.iothub.v2021_03_01_preview.operations.Operations>`
        """
    ...
    def private_endpoint_connections(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`PrivateEndpointConnectionsOperations<azure.mgmt.iothub.v2021_03_01_preview.operations.PrivateEndpointConnectionsOperations>`
        """
        ...
        if api_version == '2020-03-01':
            ...
            from .v2021_03_01_preview.operations import PrivateEndpointConnectionsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def private_link_resources(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`PrivateLinkResourcesOperations<azure.mgmt.iothub.v2021_03_01_preview.operations.PrivateLinkResourcesOperations>`
        """
        api_version = self._get_api_version('private_link_resources')
        if api_version == '2020-03-01':
            from .v2020_03_01.operations import PrivateLinkResourcesOperations as OperationClass
        elif api_version == '2021-03-03-preview':
            from .v2021_03_01_preview.operations import PrivateLinkResourcesOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
    ...
    def resource_provider_common(self):
        """Instance depends on the API version:
           ...
           * 2021-03-03-preview: :class:`ResourceProviderCommonOperations<azure.mgmt.iothub.v2021_03_01_preview.operations.ResourceProviderCommonOperations>`
        """
        ...
        if api_version == '2018-04-01':
            ...
            from .v2021_03_01_preview.operations import ResourceProviderCommonOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {} is not available".format(api_version))
        return OperationClass(self._client, self.config, Serializer(self._models_dict(api_version)), Deserializer(self._models_dict(api_version)))
