...
class IotHubResourceOperations(object):  # pylint: disable=too-many-public-methods
    ...
    def begin_delete(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.iothub.v2021_07_02.models.IotHubDescription
         or ~azure.mgmt.iothub.v2021_07_02.models.ErrorDetails]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-07-02")  # type: str
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either IotHubDescriptionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.iothub.v2021_07_02.models.IotHubDescriptionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-07-02")  # type: str
    ...
    def get_valid_skus(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either IotHubSkuDescriptionListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.iothub.v2021_07_02.models.IotHubSkuDescriptionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-07-02")  # type: str
    ...
    def list_event_hub_consumer_groups(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either EventHubConsumerGroupsListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.iothub.v2021_07_02.models.EventHubConsumerGroupsListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-07-02")  # type: str
    ...
    def list_jobs(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either JobResponseListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.iothub.v2021_07_02.models.JobResponseListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-07-02")  # type: str
    ...
    def get_quota_metrics(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either IotHubQuotaMetricInfoListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.iothub.v2021_07_02.models.IotHubQuotaMetricInfoListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-07-02")  # type: str
    ...
    def get_endpoint_health(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either EndpointHealthDataListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.iothub.v2021_07_02.models.EndpointHealthDataListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-07-02")  # type: str
    ...
    def list_keys(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.iothub.v2021_07_02.models.SharedAccessSignatureAuthorizationRuleListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-07-02")  # type: str
