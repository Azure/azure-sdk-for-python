...
class IotHubClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    :keyword api_version: Api Version. Default value is "2021-07-02". Note that overriding this
    ...
    def __init__(self, credential: "TokenCredential", subscription_id: str, **kwargs: Any) -> None:
        ...
        api_version = kwargs.pop("api_version", "2021-07-02")  # type: Literal["2021-07-02"]
