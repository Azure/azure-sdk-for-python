...
class IotHubClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.operations = Operations(self._client, self._config, self._serialize, self._deserialize, "2021-07-02")
        self.iot_hub_resource = IotHubResourceOperations(
            self._client, self._config, self._serialize, self._deserialize, "2021-07-02"
        )
        ...
        self.iot_hub = IotHubOperations(self._client, self._config, self._serialize, self._deserialize, "2021-07-02")
