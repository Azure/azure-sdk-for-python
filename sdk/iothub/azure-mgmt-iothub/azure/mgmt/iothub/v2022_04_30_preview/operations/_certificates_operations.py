...
class CertificatesOperations:
    ...
    def list_by_iot_hub(
        ...
        :rtype: ~azure.mgmt.iothub.v2022_04_30_preview.models.CertificateListDescription
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.iothub.v2022_04_30_preview.models.CertificateDescription
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type certificate_description:
         ~azure.mgmt.iothub.v2022_04_30_preview.models.CertificateDescription
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param certificate_description: The certificate body. Is either a model type or a IO type.
         Required.
        :type certificate_description:
         ~azure.mgmt.iothub.v2022_04_30_preview.models.CertificateDescription or IO
        :param if_match: ETag of the Certificate. Do not specify for creating a brand new certificate.
         Required to update an existing certificate. Default value is None.
        :type if_match: str
    ...
    def generate_verification_code(
        ...
        :rtype: ~azure.mgmt.iothub.v2022_04_30_preview.models.CertificateWithNonceDescription
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop("error_map", {}) or {})
    ...
    def verify(
        ...
        **kwargs: Any
        ...
        :type certificate_verification_body:
         ~azure.mgmt.iothub.v2022_04_30_preview.models.CertificateVerificationDescription
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def verify(
        ...
        **kwargs: Any
        ...
        :param certificate_verification_body: The name of the certificate. Is either a model type or a
         IO type. Required.
        :type certificate_verification_body:
         ~azure.mgmt.iothub.v2022_04_30_preview.models.CertificateVerificationDescription or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
