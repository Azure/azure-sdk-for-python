...
class IotHubClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    :keyword api_version: Api Version. Default value is "2017-01-19". Note that overriding this
    ...
    def __init__(self, credential: "AsyncTokenCredential", subscription_id: str, **kwargs: Any) -> None:
        ...
        api_version = kwargs.pop("api_version", "2017-01-19")  # type: Literal["2017-01-19"]
