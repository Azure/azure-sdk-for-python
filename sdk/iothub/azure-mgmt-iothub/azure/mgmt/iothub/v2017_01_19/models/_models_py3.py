...
class FallbackRouteProperties(Model):
    ...
    :ivar source: Required. The source to which the routing rule is to be
     applied to. e.g. DeviceMessages. Default value: "DeviceMessages" .
    :vartype source: str
...
class RoutingEndpoints(Model):
    ...
    def __init__(self, *, service_bus_queues=None, service_bus_topics=None, event_hubs=None, **kwargs) -> None:
...
class RoutingEventHubProperties(Model):
    ...
    :param name: Required. The name of the event hub endpoint. The name can
...
class RoutingServiceBusQueueEndpointProperties(Model):
    ...
    :param connection_string: Required. The connection string of the service
     bus queue endpoint.
    :type connection_string: str
    :param name: Required. The name of the service bus queue endpoint. The
     name can only include alphanumeric characters, periods, underscores,
     hyphens and has a maximum length of 64 characters. The following names are
...
class RoutingServiceBusTopicEndpointProperties(Model):
    ...
    :param connection_string: Required. The connection string of the service
     bus topic endpoint.
    :type connection_string: str
    :param name: Required. The name of the service bus topic endpoint. The
     name can only include alphanumeric characters, periods, underscores,
     hyphens and has a maximum length of 64 characters. The following names are
     reserved;  events, operationsMonitoringEvents, fileNotifications,
     $default. Endpoint names must be unique across endpoint types.  The name
