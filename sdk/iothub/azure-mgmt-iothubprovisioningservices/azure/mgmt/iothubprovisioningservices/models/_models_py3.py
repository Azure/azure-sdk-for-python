...
class ArmIdentity(Model):
    ...
    def __init__(self, *, identity_type: str=None, user_assigned_identities=None, **kwargs) -> None:
...
class EncryptionPropertiesDescription(Model):
    ...
    def __init__(self, *, key_source: str=None, key_vault_properties=None, identity=None, **kwargs) -> None:
...
class IotDpsPropertiesDescription(Model):
    ...
    def __init__(self, *, state=None, encryption=None, public_network_access=None, ip_filter_rules=None, private_endpoint_connections=None, provisioning_state: str=None, iot_hubs=None, allocation_policy=None, authorization_policies=None, **kwargs) -> None:
...
class ProvisioningServiceDescription(Resource):
    ...
    def __init__(self, *, location: str, properties, sku, tags=None, etag: str=None, identity=None, **kwargs) -> None:
