...
class ArmIdentity(Model):
    ...
    :param identity_type: Identity type. Only allowed values are
     SystemAssigned and UserAssigned. Comma separated if both for ex:
     SystemAssigned,UserAssigned.
    :type identity_type: str
    :param user_assigned_identities: The set of UserAssigned identities
     associated with the IoT DPS resource.
    :type user_assigned_identities: dict[str,
     ~azure.mgmt.iothubprovisioningservices.models.ArmUserIdentity]
    """
...
class EncryptionKeyIdentity(Model):
    ...
    def __init__(self, **kwargs):
        super(EncryptionKeyIdentity, self).__init__(**kwargs)
...
class EncryptionPropertiesDescription(Model):
    ...
    :param key_source: The source of the encryption key. Typically,
     Microsoft.KeyVault
    :type key_source: str
    :param key_vault_properties: The properties of the encryption key
     configured in KeyVault.
    :type key_vault_properties:
     list[~azure.mgmt.iothubprovisioningservices.models.KeyVaultKeyProperties]
    :param identity: The identity used to access the encryption key in
     KeyVault.
    :type identity:
     ~azure.mgmt.iothubprovisioningservices.models.EncryptionKeyIdentity
    """

    _attribute_map = {
        'key_source': {'key': 'keySource', 'type': 'str'},
        'key_vault_properties': {'key': 'keyVaultProperties', 'type': '[KeyVaultKeyProperties]'},
        'identity': {'key': 'identity', 'type': 'EncryptionKeyIdentity'},
    }
...
class IotDpsPropertiesDescription(Model):
    ...
    :param encryption: The encryption properties for the IoT DPS instance.
    :type encryption:
     ~azure.mgmt.iothubprovisioningservices.models.EncryptionPropertiesDescription
...
class ProvisioningServiceDescription(Resource):
    ...
    :type identity: ~azure.mgmt.iothubprovisioningservices.models.ArmIdentity
    """
