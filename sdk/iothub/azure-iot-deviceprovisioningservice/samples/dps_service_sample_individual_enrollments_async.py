...
class EnrollmentSamples(object):
    ...
    async def get_enrollment_sample_async(self):
        ...
        await dps_service_client.individual_enrollment.get(id=self.tpm_emrollment_id)
    ...
    async def delete_enrollments_sample_async(self):
        ...
        await dps_service_client.individual_enrollment.delete(id=self.tpm_emrollment_id)
