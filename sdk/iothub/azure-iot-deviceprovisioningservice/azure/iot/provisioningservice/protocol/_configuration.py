...
class ProvisioningServiceClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, credential: "TokenCredential", **kwargs: Any) -> None:
        super(ProvisioningServiceClientConfiguration, self).__init__(**kwargs)
        ...
        kwargs.setdefault("sdk_moniker", "provisioningserviceclient/{}".format(VERSION))
