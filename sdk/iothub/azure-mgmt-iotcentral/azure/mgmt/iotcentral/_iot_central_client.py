...
from .operations import AppsOperations, Operations, PrivateEndpointConnectionsOperations, PrivateLinksOperations
...
class IotCentralClient:
    ...
    :vartype private_links: azure.mgmt.iotcentral.operations.PrivateLinksOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = IotCentralClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
