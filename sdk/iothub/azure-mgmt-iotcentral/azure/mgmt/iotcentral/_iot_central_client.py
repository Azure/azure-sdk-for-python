...
from .operations import AppsOperations, Operations
...
class IotCentralClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __enter__(self) -> "IotCentralClient":
