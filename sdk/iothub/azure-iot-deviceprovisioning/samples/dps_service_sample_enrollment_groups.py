...
class EnrollmentGroupSamples(object):
    ...
    def get_enrollment_group_attestation_sample(self):
        ...
        dps_service_client.enrollment_group.get_attestation_mechanism(id=self.x509_enrollment_group_id)

        dps_service_client.enrollment_group.get_attestation_mechanism(id=self.symmetric_enrollment_group_id)
    ...
    def update_enrollment_group_sample(self):
        ...
        sym_enrollment = dps_service_client.enrollment_group.get(id=self.symmetric_enrollment_group_id)
    ...
    def bulk_enrollment_group_operations_sample(self):
        ...
        dps_service_client.enrollment_group.run_bulk_operation(bulk_operation=bulk_operation)
    ...
    def delete_enrollment_groups_sample(self):
        ...
        dps_service_client.enrollment_group.delete(id=self.symmetric_enrollment_group_id)
