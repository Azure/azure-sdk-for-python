...
class TestCosmosdbForPostgresqlMgmtFirewallRulesOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_firewall_rules_list_by_cluster(self, resource_group):
        response = self.client.firewall_rules.list_by_cluster(
            resource_group_name=resource_group.name,
            cluster_name="str",
        )
