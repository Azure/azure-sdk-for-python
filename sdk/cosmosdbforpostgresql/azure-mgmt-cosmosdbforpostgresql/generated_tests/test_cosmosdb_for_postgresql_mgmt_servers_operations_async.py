...
class TestCosmosdbForPostgresqlMgmtServersOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_servers_list_by_cluster(self, resource_group):
        response = self.client.servers.list_by_cluster(
            resource_group_name=resource_group.name,
            cluster_name="str",
        )
