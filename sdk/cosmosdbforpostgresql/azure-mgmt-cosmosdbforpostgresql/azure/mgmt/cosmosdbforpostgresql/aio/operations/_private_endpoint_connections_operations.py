...
class PrivateEndpointConnectionsOperations:
    ...
    list_by_cluster.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/serverGroupsv2/{clusterName}/privateEndpointConnections"
    }
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/serverGroupsv2/{clusterName}/privateEndpointConnections/{privateEndpointConnectionName}"
    }
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param private_endpoint_connection_name: The name of the private endpoint connection associated
         with the cluster. Required.
        :type private_endpoint_connection_name: str
        :param parameters: The required parameters for approving a private endpoint connection. Is
         either a PrivateEndpointConnection type or a IO type. Required.
        :type parameters: ~azure.mgmt.cosmosdbforpostgresql.models.PrivateEndpointConnection or IO
