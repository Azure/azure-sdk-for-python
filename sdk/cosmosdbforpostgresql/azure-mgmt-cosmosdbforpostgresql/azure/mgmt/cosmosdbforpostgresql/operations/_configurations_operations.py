...
def build_list_by_server_request(
    ...
    path_format_arguments = {
        ...
        "clusterName": _SERIALIZER.url(
            ...
            max_length=40,
            min_length=3,
            pattern=r"^(?![0-9]+$)(?!-)[a-z0-9-]{3,40}(?<!-)$",
        ),
        "serverName": _SERIALIZER.url(
            "server_name", server_name, "str", max_length=90, min_length=1, pattern=r"^[-\w\._]+$"
        ),
    }
...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "configurationName": _SERIALIZER.url(
            "configuration_name", configuration_name, "str", max_length=90, min_length=1, pattern=r"^[-\w\._]+$"
        ),
    }
...
def build_get_coordinator_request(
    resource_group_name: str, cluster_name: str, configuration_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_on_coordinator_request(
    resource_group_name: str, cluster_name: str, configuration_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_on_node_request(
    resource_group_name: str, cluster_name: str, configuration_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ConfigurationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.cosmosdbforpostgresql.CosmosDBForPostgreSQL`'s
    ...
    def list_by_server(
    ...
    ) -> Iterable["_models.ServerConfiguration"]:
        ...
        cls: ClsType[_models.ServerConfigurationListResult] = kwargs.pop("cls", None)
    ...
    def list_by_cluster(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.ClusterConfigurationListResult] = kwargs.pop("cls", None)
    ...
    def begin_update_on_coordinator(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ServerConfiguration or the result of
         cls(response)
        :rtype:
