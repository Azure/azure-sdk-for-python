...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.artifactsigning.aio import ArtifactSigningMgmtClient
...
class TestArtifactSigningMgmtCodeSigningAccountsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(ArtifactSigningMgmtClient, is_async=True)
