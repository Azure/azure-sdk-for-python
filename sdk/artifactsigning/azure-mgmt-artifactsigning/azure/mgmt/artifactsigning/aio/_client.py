...
class ArtifactSigningMgmtClient:
    """Code Signing resource provider api.

    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.artifactsigning.aio.operations.Operations
    :ivar code_signing_accounts: CodeSigningAccountsOperations operations
    :vartype code_signing_accounts:
     azure.mgmt.artifactsigning.aio.operations.CodeSigningAccountsOperations
    :ivar certificate_profiles: CertificateProfilesOperations operations
    :vartype certificate_profiles:
     azure.mgmt.artifactsigning.aio.operations.CertificateProfilesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = ArtifactSigningMgmtClientConfiguration(
