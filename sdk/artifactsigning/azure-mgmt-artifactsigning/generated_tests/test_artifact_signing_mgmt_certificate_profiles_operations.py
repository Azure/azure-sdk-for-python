...
class TestArtifactSigningMgmtCertificateProfilesOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(ArtifactSigningMgmtClient)
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_certificate_profiles_revoke_certificates(self, resource_group):
        response = self.client.certificate_profiles.revoke_certificates(
            resource_group_name=resource_group.name,
            account_name="str",
            profile_name="str",
            body={
