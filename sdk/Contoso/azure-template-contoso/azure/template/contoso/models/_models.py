...
class CustomPageWidget(_model_base.Model):
    ...
    :vartype value: list[~azure.template.contoso.models.Widget]
...
class Error(_model_base.Model):
    ...
    :ivar details: An array of details about specific errors that led to this reported error.
     Required.
    :vartype details: list[~azure.template.contoso.models.Error]
    :ivar innererror: An object containing more specific information than the current object about
     the error.
    :vartype innererror: ~azure.template.contoso.models.InnerError
    """
...
class OperationStatusError(_model_base.Model):
    ...
    :vartype status: str or ~azure.template.contoso.models.OperationState
    :ivar error: Error object that describes the error when status is "Failed".
    :vartype error: ~azure.template.contoso.models.Error
    """
...
class WidgetWidgetError(_model_base.Model):
    ...
    :vartype result: ~azure.template.contoso.models.Widget
