...
class MonitorInstancesSummaryOperations(object):
    """MonitorInstancesSummaryOperations operations.
    ...
    def list(
            self, select=None, filter=None, apply=None, orderby=None, expand=None, top=None, skiptoken=None, custom_headers=None, raw=False, **operation_config):
        ...
        :return: An iterator like instance of MonitorInstance
        :rtype:
         ~azure.mgmt.workloadmonitor.models.MonitorInstancePaged[~azure.mgmt.workloadmonitor.models.MonitorInstance]
        :raises:
        ...
        deserialized = models.MonitorInstancePaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.MonitorInstancePaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response

        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.WorkloadMonitor/monitorInstancesSummary'}
