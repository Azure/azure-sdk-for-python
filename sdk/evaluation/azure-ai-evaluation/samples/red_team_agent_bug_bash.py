...
async def main():
    ...
    examples_to_run = [
        ...
        # "example13_pyrit_prompt_chat_target",
    ]
    ...
    for example in examples_to_run:
        ...
        elif example == "example13_pyrit_prompt_chat_target":
            result = await example13_pyrit_prompt_chat_target(agent)
...
async def example3_direct_model_testing(agent: RedTeamAgent):
    ...
    azure_openai_config = {
        "azure_endpoint": "https://your-deployment.openai.azure.com/",  # Replace with your endpoint (see Target URI in Azure AI Foundry)
        "azure_deployment": "your-deployment-name",  # Replace with your deployment name
        "api_key": "your_azure_openai_api_key"  # Replace with your API key
    }
    ...
    print("Note: For this example to work, you need to provide valid API keys and endpoints")
    print("This example is currently commented out in the actual execution")
    
    # Uncomment to run the actual scan:
