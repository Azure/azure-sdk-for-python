...
This is same as Step 1 in [Build & Release Process](https://eng.ms/docs/cloud-ai-platform/ai-platform/ai-platform-ml-platform/project-vienna-services/azure-machine-learning-runbook/operational/assets/registry/azureml/sop/adding-assets-to-builtin-registry/build-and-release-process) provided by asset team. 
...
This is a Step 2 in [Build & Release Process](https://eng.ms/docs/cloud-ai-platform/ai-platform/ai-platform-ml-platform/project-vienna-services/azure-machine-learning-runbook/operational/assets/registry/azureml/sop/adding-assets-to-builtin-registry/build-and-release-process) provided by asset team. 
...
Please get the approval from Asset Team and merge the PR.

## Step 7: Build & Release the pipeline
Please follow steps 4 & 5 in [Build & Release Process](https://eng.ms/docs/cloud-ai-platform/ai-platform/ai-platform-ml-platform/project-vienna-services/azure-machine-learning-runbook/operational/assets/registry/azureml/sop/adding-assets-to-builtin-registry/build-and-release-process) provided by asset team. 

This will deploy evaluator assets in azureml-dev, azureml-staging and azureml registries. 
You can choose to first deploy in dev and test it INT region and process with other registries. 
