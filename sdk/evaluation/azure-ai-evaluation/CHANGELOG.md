...
- Added support for AOAI evaluation via 4 new 'grader' classes, which serve as wrappers around AOAI grader configurations. These new grader objects can be inputted in the main `evaluate` method as if they were normal callable evaluators. The new classes are:
