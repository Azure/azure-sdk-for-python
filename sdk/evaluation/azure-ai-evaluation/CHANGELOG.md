...
- Parameters `query_response_generating_prompty_kwargs` and `user_simulator_prompty_kwargs` have been renamed to `_options_query_response_generating_prompty` and `_options_user_simulator_prompty` in the Simulator's __call__ method.
