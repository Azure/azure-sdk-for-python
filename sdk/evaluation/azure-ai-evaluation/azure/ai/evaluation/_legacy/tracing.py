...
try:
    ...
    from azure.ai.evaluation._batch_engine._openai_injector import inject_openai_api as _inject, recover_openai_api as _recover
    from azure.ai.evaluation._batch_engine.deprecated._trace import start_trace as _start_trace
