...
class ScenarioOrchestrator:
    ...
    def get_attack_results_by_strategy(self) -> Dict[str, List[AttackResult]]:
        ...
        Returns the ScenarioResult.attack_results dict directly. Keys are
        ``atomic_attack_name`` values which correspond to FoundryStrategy
        values (e.g. ``"baseline"``, ``"crescendo"``, ``"multi_turn"``,
        ``"base64"``).
        ...
        return self._scenario_result.attack_results
