...
class DatasetsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> _models.DatasetVersionPage:
        """List the latest version of each DatasetVersion.

        :return: DatasetVersionPage. The DatasetVersionPage is compatible with MutableMapping
        :rtype: ~azure.ai.projects.models.DatasetVersionPage
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.DatasetVersionPage] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.DatasetVersionPage, response.json())
...
class IndexesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> _models.IndexPage:
        """List the latest version of each Index.

        :return: IndexPage. The IndexPage is compatible with MutableMapping
        :rtype: ~azure.ai.projects.models.IndexPage
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.IndexPage] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.IndexPage, response.json())
