...
class GeneratedRAIClient:
    ...
    async def get_attack_objectives(self, risk_type: Optional[str] = None, risk_category: Optional[str] = None, application_scenario: str = None, strategy: Optional[str] = None) -> Dict:
