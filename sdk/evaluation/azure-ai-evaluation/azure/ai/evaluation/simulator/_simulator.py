...
class Simulator:
    ...
    async def __call__(
        ...
        *,
        ...
        _options_query_response_generating_prompty: Dict[str, Any] = {},
        _options_user_simulator_prompty: Dict[str, Any] = {},
        ...
        **kwargs,
        ...
        :keyword _options_query_response_generating_prompty: Additional keyword arguments for the query response generating prompty.
        :paramtype _options_query_response_generating_prompty: Dict[str, Any]
        :keyword _options_user_simulator_prompty: Additional keyword arguments for the user simulator prompty.
        :paramtype _options_user_simulator_prompty: Dict[str, Any]
        ...
        if conversation_turns:
            return await self._simulate_with_predefined_turns(
                ...
                _options_user_simulator_prompty=_options_user_simulator_prompty,
        ...
        *,
        ...
        while len(current_simulation) < max_conversation_turns:
            user_response_content = await user_flow(
                ...
                **_options_user_simulator_prompty,
            )
    ...
    def _load_query_generation_flow(
        ...
        *,
        ...
        :keyword prompty_model_config: The configuration for the prompty model.
        :paramtype prompty_model_config: Dict[str, Any]
        :keyword _options_query_response_generating_prompty: Additional keyword arguments for the flow.
        :paramtype _options_query_response_generating_prompty: Dict[str, Any]
