...
def _validate_columns_for_evaluators(
    ...
    if missing_inputs_per_evaluator:
        ...
        msg += "- Ensure that the data contains all required inputs.\n"
        if target is not None:
            msg += "- Verify that the target function is generating the necessary columns for the evaluators.\n"
...
def _evaluate(  # pylint: disable=too-many-locals,too-many-statements
    ...
    **kwargs,
    ...
    _validate_columns_for_evaluators(input_data_df, evaluators, target, column_mapping)
