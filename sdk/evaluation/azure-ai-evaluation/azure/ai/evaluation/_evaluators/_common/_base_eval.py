...
class EvaluatorBase(ABC, Generic[T_EvalValue]):
    ...
    def _derive_conversation_converter(self) -> Callable[[Dict], List[DerivedEvalInput]]:
        ...
        include_gtruth = "ground_truth" in self._singleton_inputs
...
class AsyncEvaluatorBase:
    ...
    async def __call__(self, *, query=None, response=None, context=None, conversation=None, ground_truth=None, **kwargs):
        if conversation is not None:
