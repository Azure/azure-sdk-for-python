...
class TestTargetFailureHandling:
    ...
    def test_temp_file_creation_handles_nan_values(self, mock_isna, mock_json_dumps, sample_dataframe_with_target_outputs):
    ...
    @patch('azure.ai.evaluation._evaluate._evaluate._apply_target_to_data')
    @patch('azure.ai.evaluation._evaluate._evaluate._validate_and_load_data')
    def test_preprocess_data_no_temp_file_without_target(self, mock_load_data, mock_apply_target, mock_validate_columns):
