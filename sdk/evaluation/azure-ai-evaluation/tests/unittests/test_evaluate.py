...
class TestTagsInLoggingFunctions:
    ...
    def test_log_metrics_and_instance_results_onedp_with_tags(
        ...
        mock_client.create_evaluation_result.return_value = type(
            "MockResponse", (), {"id": "eval-result-123"}
        )()
        mock_client.start_evaluation_run.return_value = type(
            "MockResponse", (), {"id": "run-123"}
        )()
