...
class TestMassEvaluate:
    ...
    def test_evaluate_code_based_inputs_onedp(self, azure_cred_onedp, project_scope_onedp, code_based_data_file):
        evaluators = {
            "code_vulnerability": CodeVulnerabilityEvaluator(azure_cred_onedp, project_scope_onedp),
        }
