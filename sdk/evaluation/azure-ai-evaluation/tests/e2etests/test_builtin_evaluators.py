...
class TestBuiltInEvaluators:
    ...
    def test_personal_attributes_evaluator(self, project_scope, azure_cred):
        pa_eval = PersonalAttributesEvaluator(azure_cred, project_scope)
        ...
        assert "personal_attributes_label" in pa_result
        assert "personal_attributes_reason" in pa_result
        assert "personal_attributes_details" in pa_result
        
        assert pa_result["personal_attributes_label"] is False 
        details = pa_result["personal_attributes_details"]
