...
setup(
    ...
    python_requires=">=3.8",
    install_requires=[
        "promptflow-devkit @ git+https://github.com/microsoft/promptflow/tree/main/src/promptflow-devkit#egg=promptflow-devkit",
        "promptflow-core @ git+https://github.com/microsoft/promptflow/tree/main/src/promptflow-core#egg=promptflow-core",
        "pyjwt>=2.8.0",
