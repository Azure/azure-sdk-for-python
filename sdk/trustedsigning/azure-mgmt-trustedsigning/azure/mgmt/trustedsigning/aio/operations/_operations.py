...
class CodeSigningAccountsOperations:
    ...
    ) -> AsyncItemPaged["_models.CodeSigningAccount"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.CodeSigningAccount"]:
...
class CertificateProfilesOperations:
    ...
    ) -> AsyncItemPaged["_models.CertificateProfile"]:
