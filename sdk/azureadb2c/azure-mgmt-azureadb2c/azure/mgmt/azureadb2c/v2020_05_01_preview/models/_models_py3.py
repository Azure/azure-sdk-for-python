...
class CloudError(Model):
    ...
    :param error:
    :type error:
     ~azure.mgmt.azureadb2c.v2020_05_01_preview.models.ErrorResponse
    """
...
class ErrorResponse(Model):
    ...
    :vartype details:
     list[~azure.mgmt.azureadb2c.v2020_05_01_preview.models.ErrorResponse]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.azureadb2c.v2020_05_01_preview.models.ErrorAdditionalInfo]
    """
...
class GuestUsagesResource(Model):
    ...
    :param tenant_id: An identifier for the tenant for which the resource is
     being created
    :type tenant_id: str
    """
    ...
    def __init__(self, *, location: str=None, tags=None, tenant_id: str=None, **kwargs) -> None:
...
class GuestUsagesResourcePatch(Model):
...
class Operation(Model):
    ...
    :type display:
     ~azure.mgmt.azureadb2c.v2020_05_01_preview.models.OperationDisplay
    """
