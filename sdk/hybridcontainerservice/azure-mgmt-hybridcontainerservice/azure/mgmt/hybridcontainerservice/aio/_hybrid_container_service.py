...
from ._configuration import HybridContainerServiceConfiguration
...
class HybridContainerService:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = HybridContainerServiceConfiguration(
    ...
    async def __aenter__(self) -> "HybridContainerService":
