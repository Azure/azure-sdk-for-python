...
from ._models_py3 import KubernetesVersionProfilePropertiesAutoGenerated
...
from ._models_py3 import VmSkuProfilePropertiesAutoGenerated
...
__all__ = [
    ...
    "KubernetesVersionProfilePropertiesAutoGenerated",
