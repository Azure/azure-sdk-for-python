...
def build_get_request(
    resource_group_name: str, provisioned_clusters_name: str, agent_pool_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "provisionedClustersName": _SERIALIZER.url(
            "provisioned_clusters_name", provisioned_clusters_name, "str", max_length=64, min_length=3
        ),
        "agentPoolName": _SERIALIZER.url("agent_pool_name", agent_pool_name, "str", max_length=64, min_length=3),
    }
...
def build_list_by_provisioned_cluster_request(
    resource_group_name: str, provisioned_clusters_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class AgentPoolOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.hybridcontainerservice.HybridContainerService`'s
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, provisioned_clusters_name: str, agent_pool_name: str, **kwargs: Any
    ) -> _models.AgentPool:
        ...
        :param provisioned_clusters_name: Parameter for the name of the provisioned cluster. Required.
        :type provisioned_clusters_name: str
    ...
    get.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridContainerService/provisionedClusters/{provisionedClustersName}/agentPools/{agentPoolName}"}  # type: ignore
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(agent_pool, (IO, bytes)):
            _content = agent_pool
        else:
    ...
    _create_or_update_initial.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridContainerService/provisionedClusters/{provisionedClustersName}/agentPools/{agentPoolName}"}  # type: ignore
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param agent_pool_name: Parameter for the name of the agent pool in the provisioned cluster.
         Required.
        :type agent_pool_name: str
        :param agent_pool: Is either a model type or a IO type. Required.
    ...
    begin_create_or_update.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridContainerService/provisionedClusters/{provisionedClustersName}/agentPools/{agentPoolName}"}  # type: ignore
    ...
    delete.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridContainerService/provisionedClusters/{provisionedClustersName}/agentPools/{agentPoolName}"}  # type: ignore
    ...
    update.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridContainerService/provisionedClusters/{provisionedClustersName}/agentPools/{agentPoolName}"}  # type: ignore

    @distributed_trace
    def list_by_provisioned_cluster(
        self, resource_group_name: str, provisioned_clusters_name: str, **kwargs: Any
    ...
    list_by_provisioned_cluster.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridContainerService/provisionedClusters/{provisionedClustersName}/agentPools"}  # type: ignore
