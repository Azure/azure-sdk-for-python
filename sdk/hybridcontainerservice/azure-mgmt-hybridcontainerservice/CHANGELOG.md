...
### Features Added
  ...
  - Model AgentPool has a new parameter enable_auto_scaling
  - Model AgentPool has a new parameter kubernetes_version
  - Model AgentPool has a new parameter max_count
  - Model AgentPool has a new parameter max_pods
  - Model AgentPool has a new parameter min_count
