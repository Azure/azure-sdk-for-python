...
class TestClassifiersAsync(AsyncDocumentIntelligenceTest):
    ...
    async def test_build_classifier(self, client, documentintelligence_training_data_classifier, **kwargs):
    ...
    @DocumentModelAdministrationClientPreparer()
    @recorded_by_proxy_async
    async def test_build_classifier_file_list(self, client, documentintelligence_training_data_classifier, **kwargs):
        set_bodiless_matcher()
        recorded_variables = kwargs.pop("variables", {})
        recorded_variables.setdefault("classifier_id", str(uuid.uuid4()))
