...
from ..._operations._operations import (
    ...
    build_document_intelligence_get_analyze_result_png_request,
...
class _DocumentIntelligenceClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], DocumentIntelligenceClientConfiguration]
):
    ...
    async def _analyze_document_initial(
        ...
        **kwargs: Any
        ...
        if response.status_code not in [202]:
            ...
            error = _failsafe_deserialize(_models.DocumentIntelligenceErrorResponse, response)
    ...
    async def get_analyze_result_pdf(
        self, model_id: str, result_id: str, *, api_version: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
    ...
    @distributed_trace_async
    async def get_analyze_result_png(
        self, model_id: str, result_id: str, *, api_version: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
        ...
        _request = build_document_intelligence_get_analyze_result_png_request(
            model_id=model_id,
            result_id=result_id,
            api_version=api_version,
            headers=_headers,
    ...
    async def get_analyze_result_figure(
        self, model_id: str, result_id: str, figure_id: str, *, api_version: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
    ...
    @distributed_trace_async
    async def delete_analyze_result(self, model_id: str, result_id: str, *, api_version: str, **kwargs: Any) -> None:
    ...
    def list_analyze_batch_results(
        self, model_id: str, *, api_version: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.AnalyzeBatchOperation"]:
...
class _DocumentIntelligenceAdministrationClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ClientMixinABC[
        AsyncPipelineClient[HttpRequest, AsyncHttpResponse], DocumentIntelligenceAdministrationClientConfiguration
    ]
):

    async def _build_document_model_initial(
        self, body: Union[_models.BuildDocumentModelRequest, JSON, IO[bytes]], *, api_version: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_build_document_model(
        self,
        body: _models.BuildDocumentModelRequest,
        *,
        api_version: str,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    @overload
    async def begin_build_document_model(
        self, body: JSON, *, api_version: str, content_type: str = "application/json", **kwargs: Any
    ) -> AsyncLROPoller[_models.DocumentModelDetails]:
        """Builds a custom document analysis model.
    ...
    @overload
    async def begin_build_document_model(
        self, body: IO[bytes], *, api_version: str, content_type: str = "application/json", **kwargs: Any
    ) -> AsyncLROPoller[_models.DocumentModelDetails]:
        """Builds a custom document analysis model.
    ...
    async def _compose_model_initial(
        self, body: Union[_models.ComposeDocumentModelRequest, JSON, IO[bytes]], *, api_version: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_compose_model(
        self,
        body: _models.ComposeDocumentModelRequest,
        *,
        api_version: str,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    async def authorize_model_copy(
        self,
        body: _models.AuthorizeCopyRequest,
        *,
        api_version: str,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    @distributed_trace_async
    async def authorize_model_copy(
        self, body: Union[_models.AuthorizeCopyRequest, JSON, IO[bytes]], *, api_version: str, **kwargs: Any
    ) -> _models.ModelCopyAuthorization:
        """Generates authorization to copy a document model to this location with
        specified modelId and optional description.
    ...
    async def _copy_model_to_initial(
        self,
        model_id: str,
        body: Union[_models.ModelCopyAuthorization, JSON, IO[bytes]],
        *,
        api_version: str,
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
    ...
    @overload
    async def begin_copy_model_to(
        self, model_id: str, body: JSON, *, api_version: str, content_type: str = "application/json", **kwargs: Any
    ) -> AsyncLROPoller[_models.DocumentModelDetails]:
        """Copies document model to the target resource, region, and modelId.
    ...
    @overload
    async def begin_copy_model_to(
        self, model_id: str, body: IO[bytes], *, api_version: str, content_type: str = "application/json", **kwargs: Any
    ) -> AsyncLROPoller[_models.DocumentModelDetails]:
        """Copies document model to the target resource, region, and modelId.
    ...
    @distributed_trace_async
    async def get_model(self, model_id: str, *, api_version: str, **kwargs: Any) -> _models.DocumentModelDetails:
    ...
    @distributed_trace
    def list_models(self, *, api_version: str, **kwargs: Any) -> AsyncItemPaged["_models.DocumentModelDetails"]:
    ...
    @distributed_trace_async
    async def delete_model(self, model_id: str, *, api_version: str, **kwargs: Any) -> None:
    ...
    ) -> _models.DocumentIntelligenceResourceDetails:
    ...
    def list_operations(
        self, *, api_version: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.DocumentIntelligenceOperationDetails"]:
    ...
    async def _build_classifier_initial(
        self, body: Union[_models.BuildDocumentClassifierRequest, JSON, IO[bytes]], *, api_version: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_build_classifier(
        self,
        body: _models.BuildDocumentClassifierRequest,
        *,
        api_version: str,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    async def authorize_classifier_copy(
        self,
        body: _models.AuthorizeClassifierCopyRequest,
        *,
        api_version: str,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    @distributed_trace_async
    async def authorize_classifier_copy(
        self, body: Union[_models.AuthorizeClassifierCopyRequest, JSON, IO[bytes]], *, api_version: str, **kwargs: Any
    ) -> _models.ClassifierCopyAuthorization:
        """Generates authorization to copy a document classifier to this location with
        specified classifierId and optional description.
    ...
    @overload
    async def begin_copy_classifier_to(
        self, classifier_id: str, body: JSON, *, api_version: str, content_type: str = "application/json", **kwargs: Any
    ) -> AsyncLROPoller[_models.DocumentClassifierDetails]:
        """Copies document classifier to the target resource, region, and classifierId.
    ...
    async def get_classifier(
        self, classifier_id: str, *, api_version: str, **kwargs: Any
    ...
    def list_classifiers(
        self, *, api_version: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.DocumentClassifierDetails"]:
    ...
    @distributed_trace_async
    async def delete_classifier(self, classifier_id: str, *, api_version: str, **kwargs: Any) -> None:
