...
class _DocumentIntelligenceClientOperationsMixin(
    ...
    @api_version_validation(
        ...
        params_added_on={"2025-09-01": ["api_version", "model_id", "result_id", "accept"]},
        api_versions_list=["2025-09-01"],
    )
    async def get_analyze_result_png(self, model_id: str, result_id: str, **kwargs: Any) -> AsyncIterator[bytes]:
...
class _DocumentIntelligenceAdministrationClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def list_models(self, **kwargs: Any) -> AsyncItemPaged["_models.DocumentModelDetails"]:
    ...
    @distributed_trace
    def list_operations(self, **kwargs: Any) -> AsyncItemPaged["_models.DocumentIntelligenceOperationDetails"]:
