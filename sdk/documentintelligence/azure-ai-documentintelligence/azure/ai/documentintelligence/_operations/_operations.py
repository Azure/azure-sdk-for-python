...
def build_document_intelligence_get_analyze_result_pdf_request(  # pylint: disable=name-too-long
    model_id: str, result_id: str, *, api_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_document_intelligence_get_analyze_result_png_request(  # pylint: disable=name-too-long
    model_id: str, result_id: str, *, api_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/documentModels/{modelId}/analyzeResults/{resultId}/png"
    path_format_arguments = {
        "modelId": _SERIALIZER.url("model_id", model_id, "str"),
        "resultId": _SERIALIZER.url("result_id", result_id, "str"),
    }
...
def build_document_intelligence_get_analyze_result_figure_request(  # pylint: disable=name-too-long
    model_id: str, result_id: str, figure_id: str, *, api_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_document_intelligence_list_analyze_batch_results_request(  # pylint: disable=name-too-long
    model_id: str, *, api_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_document_intelligence_administration_copy_classifier_to_request(  # pylint: disable=name-too-long
    classifier_id: str, *, api_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class _DocumentIntelligenceClientOperationsMixin(
    ...
    ) -> ItemPaged["_models.AnalyzeBatchOperation"]:
...
class _DocumentIntelligenceAdministrationClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def get_model(self, model_id: str, *, api_version: str, **kwargs: Any) -> _models.DocumentModelDetails:
    ...
    @distributed_trace
    def list_models(self, *, api_version: str, **kwargs: Any) -> ItemPaged["_models.DocumentModelDetails"]:
    ...
    @distributed_trace
    def get_resource_details(self, *, api_version: str, **kwargs: Any) -> _models.DocumentIntelligenceResourceDetails:
    ...
    ) -> ItemPaged["_models.DocumentIntelligenceOperationDetails"]:
    ...
    @distributed_trace
    def list_classifiers(self, *, api_version: str, **kwargs: Any) -> ItemPaged["_models.DocumentClassifierDetails"]:
