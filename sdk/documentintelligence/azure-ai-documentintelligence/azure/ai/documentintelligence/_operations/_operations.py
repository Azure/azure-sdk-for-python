...
class _DocumentIntelligenceClientOperationsMixin(
    ...
    def get_analyze_result_png(self, model_id: str, result_id: str, **kwargs: Any) -> Iterator[bytes]:
    ...
    @distributed_trace
    def list_analyze_batch_results(self, model_id: str, **kwargs: Any) -> ItemPaged["_models.AnalyzeBatchOperation"]:
...
class _DocumentIntelligenceAdministrationClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def list_models(self, **kwargs: Any) -> ItemPaged["_models.DocumentModelDetails"]:
    ...
    @distributed_trace
    def list_operations(self, **kwargs: Any) -> ItemPaged["_models.DocumentIntelligenceOperationDetails"]:
