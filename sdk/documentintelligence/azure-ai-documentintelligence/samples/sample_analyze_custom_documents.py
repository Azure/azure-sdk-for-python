...
def analyze_custom_documents(custom_model_id):
    ...
    # combined by DOCUMENTINTELLIGENCE_STORAGE_ADVANCE_CONTAINER_SAS_URL and DOCUMENTINTELLIGENCE_STORAGE_PREFIX, 
...
if __name__ == "__main__":
    ...
    try:
        ...
        model_id = None
        if os.getenv("DOCUMENTINTELLIGENCE_STORAGE_ADVANCE_CONTAINER_SAS_URL") and not os.getenv("CUSTOM_BUILT_MODEL_ID"):
            import uuid
            from azure.core.credentials import AzureKeyCredential
            ...
            blob_container_sas_url = os.getenv("DOCUMENTINTELLIGENCE_STORAGE_ADVANCE_CONTAINER_SAS_URL")
