...
from ...operations._labs_operations import build_list_request
T = TypeVar('T')
...
class LabsOperations:
    ...
    list.metadata = {'url': "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/providers/Microsoft.Education/labs"}  # type: ignore
