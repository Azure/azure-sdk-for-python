...
from ...operations._approve_operations import build_invite_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class ApproveOperations:
    """ApproveOperations async operations.
    ...
    async def invite(  # pylint: disable=inconsistent-return-statements
        self,
