...
from ...operations._student_labs_operations import build_get_request, build_list_all_request
...
class StudentLabsOperations:
    ...
    @distributed_trace
    def list_all(self, **kwargs: Any) -> AsyncIterable["_models.StudentLabDetails"]:
        """Get a list of all labs associated with the caller of the API.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either StudentLabDetails or the result of cls(response)
        ...
        cls: ClsType[_models.StudentLabListResult] = kwargs.pop("cls", None)
    ...
    list_all.metadata = {"url": "/providers/Microsoft.Education/studentLabs"}
    ...
    get.metadata = {"url": "/providers/Microsoft.Education/studentLabs/{studentLabName}"}
