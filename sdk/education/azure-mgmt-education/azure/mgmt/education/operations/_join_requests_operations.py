...
class JoinRequestsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.education.models.JoinRequestDetails]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("JoinRequestDetails", pipeline_response.http_response)
