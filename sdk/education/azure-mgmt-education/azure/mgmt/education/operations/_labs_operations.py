...
def build_create_or_update_request(
    ...
    invoice_section_name: str,
    *,
    json: Optional[_models.LabDetails] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_generate_invite_code_request(
    ...
    invoice_section_name: str,
    *,
    json: Optional[_models.InviteCodeGenerateRequest] = None,
    content: Any = None,
    ...
    **kwargs: Any
    ...
    if only_update_student_count_parameter is not None:
        _params['onlyUpdateStudentCountParameter'] = _SERIALIZER.query("only_update_student_count_parameter", only_update_student_count_parameter, 'bool')
    _params['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
