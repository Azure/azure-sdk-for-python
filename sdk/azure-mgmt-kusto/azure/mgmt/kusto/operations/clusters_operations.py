...
class ClustersOperations(object):
    ...
    def detach_follower_databases(
        ...
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        follower_database_to_remove = models.FollowerDatabaseRequest(cluster_resource_id=cluster_resource_id, database_name=database_name)
        ...
        def internal_paging(next_link=None, raw=False):
            ...
            # Construct body
            body_content = self._serialize.body(follower_database_to_remove, 'FollowerDatabaseRequest')
