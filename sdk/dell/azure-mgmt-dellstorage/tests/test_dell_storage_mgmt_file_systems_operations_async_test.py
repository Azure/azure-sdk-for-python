...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.dellstorage.aio import DellStorageMgmtClient
...
class TestDellStorageMgmtFileSystemsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(DellStorageMgmtClient, is_async=True)
