...
from .operations import AdvisorManagementClientOperationsMixin, ConfigurationsOperations, Operations, RecommendationMetadataOperations, RecommendationsOperations, SuppressionsOperations

if TYPE_CHECKING:
    # pylint: disable=unused-import,ungrouped-imports
    from azure.core.credentials_async import AsyncTokenCredential

class AdvisorManagementClient(AdvisorManagementClientOperationsMixin):
    """REST APIs for Azure Advisor.

    :ivar recommendation_metadata: RecommendationMetadataOperations operations
    :vartype recommendation_metadata:
     azure.mgmt.advisor.aio.operations.RecommendationMetadataOperations
    :ivar configurations: ConfigurationsOperations operations
    :vartype configurations: azure.mgmt.advisor.aio.operations.ConfigurationsOperations
    :ivar recommendations: RecommendationsOperations operations
    :vartype recommendations: azure.mgmt.advisor.aio.operations.RecommendationsOperations
