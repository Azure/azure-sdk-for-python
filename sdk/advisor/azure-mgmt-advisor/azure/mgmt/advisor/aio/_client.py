...
from .operations import (
    ...
    WorkloadsOperations,
    _AdvisorManagementClientOperationsMixin,
...
class AdvisorManagementClient(_AdvisorManagementClientOperationsMixin):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype assessments: azure.mgmt.advisor.aio.operations.AssessmentsOperations
    :ivar resiliency_reviews: resiliencyReviewsOperations operations
    :vartype resiliency_reviews: azure.mgmt.advisor.aio.operations.resiliencyReviewsOperations
    ...
    :vartype assessment_types: azure.mgmt.advisor.aio.operations.AssessmentTypesOperations
    :ivar workloads: WorkloadsOperations operations
    :vartype workloads: azure.mgmt.advisor.aio.operations.WorkloadsOperations
