...
from ...operations._configurations_operations import build_create_in_resource_group_request, build_create_in_subscription_request, build_list_by_resource_group_request, build_list_by_subscription_request
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ConfigurationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.advisor.models.ConfigurationListResult]
