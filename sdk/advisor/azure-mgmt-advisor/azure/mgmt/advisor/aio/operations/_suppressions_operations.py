...
class SuppressionsOperations:
    ...
    async def get(
        ...
        name: str,
        **kwargs
    ) -> Union["_models.SuppressionContract", "_models.ArmErrorResponse"]:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.advisor.models.SuppressionContractListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
