...
def build_list_request(
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Advisor/operations")
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either OperationEntityListResult or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.advisor.models.OperationEntityListResult]
