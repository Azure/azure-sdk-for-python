...
USAGE:
    ```python sample_farm_hierarchy.py```
...
def main():
    ...
    try:
        ...
        raise SystemExit(
            "Please set the 'FARMBEATS_ENDPOINT' env variable to your FarmBeats endpoint.")
    ...
    # Run the samples
    FarmHierarchySample.run(client)
