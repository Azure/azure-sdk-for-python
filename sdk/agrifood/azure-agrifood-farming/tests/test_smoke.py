...
class TestFarmBeatsSmoke(FarmBeatsTestCase):
    ...
    def test_boundary(self, **kwargs):
        ...
        party = client.parties.create_or_update(party_id=party_id, party=party_request)
        ...
        assert boundary == client.boundaries.get(party_id=party_id, boundary_id=boundary_id)
