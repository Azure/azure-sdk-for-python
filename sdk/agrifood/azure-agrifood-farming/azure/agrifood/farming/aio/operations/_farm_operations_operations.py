...
class FarmOperationsOperations:
    ...
    async def _create_data_ingestion_job_initial(
        self,
        job_id: str,
        body: Optional["_models.FarmOperationDataIngestionJob"] = None,
        **kwargs
    ...
    async def begin_create_data_ingestion_job(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.agrifood.farming.models.FarmOperationDataIngestionJob]
