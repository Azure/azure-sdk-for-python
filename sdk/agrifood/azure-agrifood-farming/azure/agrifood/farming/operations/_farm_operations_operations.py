...
class FarmOperationsOperations(object):
    ...
    def _create_data_ingestion_job_initial(
        self,
        job_id,  # type: str
        body=None,  # type: Optional["_models.FarmOperationDataIngestionJob"]
        **kwargs  # type: Any
    ):
        ...
        if body is not None:
            body_content = self._serialize.body(body, 'FarmOperationDataIngestionJob')
        else:
            body_content = None
    ...
    def begin_create_data_ingestion_job(
        ...
        **kwargs  # type: Any
        ...
        :type body: ~azure.agrifood.farming.models.FarmOperationDataIngestionJob
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.agrifood.farming.models.FarmOperationDataIngestionJob]
    ...
    def get_data_ingestion_job_details(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.agrifood.farming.models.FarmOperationDataIngestionJob
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.FarmOperationDataIngestionJob"]
        error_map = {
