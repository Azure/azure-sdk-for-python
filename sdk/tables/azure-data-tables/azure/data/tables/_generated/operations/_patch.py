...
from ._operations import (
    TableOperations as TableOperationsGenerated,
...
__all__: List[str] = ["TableOperations"]  # Add all objects you want publicly available to users at this package level
