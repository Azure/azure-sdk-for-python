...
def build_table_set_access_policy_request(table: str, *, timeout: Optional[int] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class TableOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.data.tables.AzureTableClient`'s
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: AzureTableClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def query(
        ...
        *,
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.TableProperties"]:
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(
                list[_models.TableProperties],
                deserialized.get("value", []),
            )
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return pipeline_response.http_response.headers.get("x-ms-continuation-NextTableName") or None, iter(
                list_of_elem
            )
...
class ServiceOperations:
    ...
    def get_user_delegation_key(
        ...
        """Gets a key that can be used to sign a user delegation SAS (shared access signature) for the
        Table service. Available in version 2025-07-05 and later.

        :param key_info: The key info for the user delegation key. Required.
