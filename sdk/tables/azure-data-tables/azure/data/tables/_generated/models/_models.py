...
class KeyInfo(_Model):
    """The key info for creating a user delegation key.

    :ivar start: The start time for the user delegation SAS, in ISO date format. Required.
    :vartype start: str
    :ivar expiry: The expiration time of the user delegation SAS, in ISO date format. Required.
    :vartype expiry: str
    ...
    """The start time for the user delegation SAS, in ISO date format. Required."""
    expiry: str = rest_field(
        visibility=["read", "create", "update", "delete", "query"],
        xml={"attribute": False, "name": "Expiry", "text": False, "unwrapped": False},
    )
    """The expiration time of the user delegation SAS, in ISO date format. Required."""
...
class UserDelegationKey(_Model):
    ...
    :ivar signed_tid: A GUID that represents the Microsoft Entra tenant that the user is from.
     Required.
    ...
    :ivar signed_service: The service that the user delegation key can be used for. Required.
    ...
    :ivar signed_delegated_user_tid: A GUID that represents the Microsoft Entra tenant of the
     delegated user.
    ...
    """A GUID that represents the Microsoft Entra tenant that the user is from. Required."""
    ...
    """The service that the user delegation key can be used for. Required."""
    ...
    """A GUID that represents the Microsoft Entra tenant of the delegated user."""
