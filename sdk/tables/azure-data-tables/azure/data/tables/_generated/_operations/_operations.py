...
def build_table_service_get_service_properties_request(  # pylint: disable=name-too-long
...
def build_table_service_set_service_properties_request(  # pylint: disable=name-too-long
    *, timeout: Optional[int] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_table_service_get_service_stats_request(  # pylint: disable=name-too-long
    *, timeout: Optional[int] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_table_service_query_request(
    *,
...
def build_table_create_table_request(
    *,
    format: Optional[Union[str, _models.OdataMetadataFormat]] = None,
...
def build_table_delete_table_request(table: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_table_get_entity_request(
    table: str,
    partition_key: str,
    row_key: str,
    *,
...
def build_table_get_table_access_policy_request(  # pylint: disable=name-too-long
    table: str, *, timeout: Optional[int] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_table_set_table_access_policy_request(  # pylint: disable=name-too-long
    table: str, *, timeout: Optional[int] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class _TableServiceClientOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], TableServiceClientConfiguration]
):

    @distributed_trace
    def get_service_properties(self, *, timeout: Optional[int] = None, **kwargs: Any) -> _models.TableServiceProperties:
    ...
    @distributed_trace
    def set_service_properties(  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace
    def get_service_stats(self, *, timeout: Optional[int] = None, **kwargs: Any) -> _models.TableServiceStats:
...
class _TableClientOperationsMixin(ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], TableClientConfiguration]):
    ...
    @distributed_trace
    def delete_table(self, table: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace
    def _update_entity(  # pylint: disable=inconsistent-return-statements
        self,
        table: str,
        partition_key: str,
        row_key: str,
    ...
    @distributed_trace
    def _merge_entity(  # pylint: disable=inconsistent-return-statements
        self,
        table: str,
        partition_key: str,
        row_key: str,
    ...
    @distributed_trace
    def set_table_access_policy(  # pylint: disable=inconsistent-return-statements
