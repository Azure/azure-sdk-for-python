...
class TablesClient:
    ...
    :vartype table: azure.data.tables._generated.operations.TableOperations
    :ivar service: ServiceOperations operations
    :vartype service: azure.data.tables._generated.operations.ServiceOperations
    ...
    def __init__(self, url: str, credential: Union[AzureKeyCredential, "TokenCredential"], **kwargs: Any) -> None:
        _endpoint = "{url}"
