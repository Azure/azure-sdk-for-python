...
from ..._operations._operations import (
    build_table_create_table_request,
    build_table_delete_entity_request,
    build_table_delete_table_request,
    build_table_get_entity_request,
    build_table_get_table_access_policy_request,
    build_table_insert_entity_request,
    build_table_merge_entity_request,
    build_table_query_entities_request,
    build_table_service_get_service_properties_request,
    build_table_service_get_service_stats_request,
    build_table_service_query_request,
    build_table_service_set_service_properties_request,
    build_table_set_table_access_policy_request,
...
class _TableServiceClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], TableServiceClientConfiguration]
):
    ...
    async def get_service_properties(
        ...
        _request = build_table_service_get_service_properties_request(
            timeout=timeout,
    ...
    async def set_service_properties(
        ...
        _request = build_table_service_set_service_properties_request(
            timeout=timeout,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
    ...
    @distributed_trace_async
    async def get_service_stats(self, *, timeout: Optional[int] = None, **kwargs: Any) -> _models.TableServiceStats:
        ...
        _request = build_table_service_get_service_stats_request(
            timeout=timeout,
            content_type=content_type,
            api_version=self._config.api_version,
            headers=_headers,
    ...
    async def _query(
        ...
        **kwargs: Any
    ) -> _models._models.TablesPagedResult:
        ...
        :return: TablesPagedResult. The TablesPagedResult is compatible with MutableMapping
        :rtype: ~azure.data.tables._generated.models._models.TablesPagedResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models._models.TablesPagedResult] = kwargs.pop("cls", None)

        _request = build_table_service_query_request(
            format=format,
            top=top,
            select=select,
            filter=filter,
        ...
        if _stream:
            ...
            deserialized = _deserialize(
                _models._models.TablesPagedResult, response.text()  # pylint: disable=protected-access
            )
...
class _TableClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], TableClientConfiguration]
):

    @overload
    async def create_table(
        self,
        table_properties: _models.TableItem,
        *,
        ...
        **kwargs: Any
        ...
        :type table_properties: ~azure.data.tables._generated.models.TableItem
    ...
    async def create_table(
        self,
        table_properties: Union[_models.TableItem, JSON, IO[bytes]],
        *,
        format: Optional[Union[str, _models.OdataMetadataFormat]] = None,
        echo_table: Optional[Union[str, _models.ResponseFormat]] = None,
        **kwargs: Any
        ...
        :param table_properties: The table properties to create. Is one of the following types:
         TableItem, JSON, IO[bytes] Required.
        :type table_properties: ~azure.data.tables._generated.models.TableItem or JSON or IO[bytes]
        :keyword format: Specifies the metadata format for the response. Known values are:
         "application/json;odata=nometadata", "application/json;odata=minimalmetadata", and
         "application/json;odata=fullmetadata". Default value is None.
        :paramtype format: str or ~azure.data.tables._generated.models.OdataMetadataFormat
        ...
        _request = build_table_create_table_request(
            format=format,
        ...
        if response.status_code == 201:
            ...
            if _stream:
                ...
                deserialized = _deserialize(_models.TableResponse, response.text())
    ...
    @distributed_trace_async
    async def delete_table(self, table: str, **kwargs: Any) -> None:
        ...
        _request = build_table_delete_table_request(
            table=table,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    async def _query_entities(
        ...
        **kwargs: Any
    ) -> _models._models.TableEntitiesPagedResult:
        ...
        :return: TableEntitiesPagedResult. The TableEntitiesPagedResult is compatible with
         MutableMapping
        :rtype: ~azure.data.tables._generated.models._models.TableEntitiesPagedResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models._models.TableEntitiesPagedResult] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(
                _models._models.TableEntitiesPagedResult, response.text()  # pylint: disable=protected-access
            )
    ...
    async def get_entity(
        ...
        **kwargs: Any
        ...
        _request = build_table_get_entity_request(
            table=table,
        ...
        if _stream:
            ...
            deserialized = _deserialize(dict[str, Any], response.text())
    ...
    async def get_table_access_policy(
        ...
        _request = build_table_get_table_access_policy_request(
            table=table,
            timeout=timeout,
            content_type=content_type,
            api_version=self._config.api_version,
    ...
    async def set_table_access_policy(
        ...
        _request = build_table_set_table_access_policy_request(
            table=table,
            timeout=timeout,
            content_type=content_type,
            api_version=self._config.api_version,
