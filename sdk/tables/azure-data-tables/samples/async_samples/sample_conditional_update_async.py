...
class ConditionalUpdateSamples(object):
    ...
    async def conditional_update_basic(self):
        async with TableClient.from_connection_string(
            ...
            metadata1 = await table_client.create_entity(asdict(self.entity1))
            print("Entity:")
    ...
    async def conditional_update_with_a_target_field(self):
        async with TableClient.from_connection_string(
            ...
            await table_client.create_table()
            await table_client.create_entity(asdict(self.entity1))
            ...
            try:
                await table_client.create_entity(asdict(self.entity2))
