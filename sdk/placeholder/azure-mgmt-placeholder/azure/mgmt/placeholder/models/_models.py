...
class Artifact(ProxyResource):
    ...
    :vartype properties: ~azure.mgmt.placeholder.models.ArtifactProperties
    """
...
class DisconnectedOperation(TrackedResource):
    ...
    :vartype location: str
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.placeholder.models.DisconnectedOperationProperties
    """
...
class DisconnectedOperationDeploymentManifest(_Model):
    ...
    :vartype billing_model: str or ~azure.mgmt.placeholder.models.BillingModel
    :ivar connection_intent: The connection intent. Required. Known values are: "Connected" and
     "Disconnected".
    :vartype connection_intent: str or ~azure.mgmt.placeholder.models.ConnectionIntent
...
class DisconnectedOperationProperties(_Model):
    ...
    :ivar connection_status: The connection status. Known values are: "Connected" and
     "Disconnected".
    :vartype connection_status: str or ~azure.mgmt.placeholder.models.ConnectionStatus
    :ivar registration_status: The registration intent. Known values are: "Registered" and
     "Unregistered".
    :vartype registration_status: str or ~azure.mgmt.placeholder.models.RegistrationStatus
...
class DisconnectedOperationUpdate(_Model):
    ...
    :vartype tags: dict[str, str]
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.placeholder.models.DisconnectedOperationUpdateProperties
    """
...
class Image(ProxyResource):
    ...
    :vartype system_data: ~azure.mgmt.placeholder.models.SystemData
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.placeholder.models.ImageProperties
    """
...
class ImageDownloadResult(_Model):
    ...
    :vartype release_type: str or ~azure.mgmt.placeholder.models.ReleaseType
