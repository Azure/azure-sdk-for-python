...
class EdgeClient:
    ...
    :vartype disconnected_operations:
     azure.mgmt.placeholder.operations.DisconnectedOperationsOperations
    :ivar images: ImagesOperations operations
    :vartype images: azure.mgmt.placeholder.operations.ImagesOperations
    :ivar artifacts: ArtifactsOperations operations
    :vartype artifacts: azure.mgmt.placeholder.operations.ArtifactsOperations
