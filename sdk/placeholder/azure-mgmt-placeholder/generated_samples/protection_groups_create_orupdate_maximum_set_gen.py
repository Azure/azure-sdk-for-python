...
# USAGE
    python protection_groups_create_orupdate_maximum_set_gen.py
...
def main():
    ...
    response = client.protection_groups.begin_create_orupdate(
            ...
            "properties": {
                ...
                "resources": {
                    ...
                    "matchRules": {
                        "matchType": "all",
                        "rules": [
                            {"operator": "contains", "property": "resourceGroup", "value": "dgkmghsgmrbaatklarukbx"}
                        ],
                    },
                },
            }
