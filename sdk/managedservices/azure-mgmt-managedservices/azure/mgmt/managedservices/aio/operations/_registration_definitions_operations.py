...
class RegistrationDefinitionsOperations:
    ...
    @distributed_trace_async
    async def delete(self, registration_definition_id: str, scope: str, **kwargs: Any) -> None:
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> AsyncItemPaged["_models.RegistrationDefinition"]:
