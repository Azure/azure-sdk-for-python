...
class Authorization(Model):
    ...
    :param principal_id_display_name: Principal Id display name of the
     security group/service principal/user that would be assigned permissions
     to the projected subscription
    :type principal_id_display_name: str
    :param role_assignment_type: The role assignment type to specify whether
     to use just in time (JIT) eligible delegation or permanent delegation
     (Default: Permanent). Possible values include: 'Permanent', 'Eligible'
    :type role_assignment_type: str or
     ~azure.mgmt.managedservices.models.RoleAssignmentType
    :param just_in_time_access_policy: The just in time access policy.
    :type just_in_time_access_policy:
     ~azure.mgmt.managedservices.models.AuthorizationJustInTimeAccessPolicy
    """
    ...
    _attribute_map = {
        ...
        'role_assignment_type': {'key': 'roleAssignmentType', 'type': 'str'},
        'just_in_time_access_policy': {'key': 'justInTimeAccessPolicy', 'type': 'AuthorizationJustInTimeAccessPolicy'},
    }

    def __init__(self, *, principal_id: str, role_definition_id: str, principal_id_display_name: str=None, role_assignment_type=None, just_in_time_access_policy=None, **kwargs) -> None:
        super(Authorization, self).__init__(**kwargs)
        self.principal_id = principal_id
        self.role_definition_id = role_definition_id
        self.principal_id_display_name = principal_id_display_name
        self.role_assignment_type = role_assignment_type
        self.just_in_time_access_policy = just_in_time_access_policy


class AuthorizationJustInTimeAccessPolicy(Model):
    """The just in time access policy.

    :param maximum_activation_duration: The maximum just in time activation
     duration (Default: PT8H).
    :type maximum_activation_duration: str
    :param multi_factor_auth_provider: The multi factor authentication
     provider to use for just in time activated permissions. Possible values
     include: 'Azure', 'None'
    ...
    _attribute_map = {
        'maximum_activation_duration': {'key': 'maximumActivationDuration', 'type': 'str'},
        'multi_factor_auth_provider': {'key': 'multiFactorAuthProvider', 'type': 'str'},
    }

    def __init__(self, *, maximum_activation_duration: str=None, multi_factor_auth_provider=None, **kwargs) -> None:
        super(AuthorizationJustInTimeAccessPolicy, self).__init__(**kwargs)
...
class MarketplaceRegistrationDefinition(Model):
    """Marketplace registration definition.
...
class MarketplaceRegistrationDefinitionProperties(Model):
    ...
    :param description: Description of the marketplace registration
     definition.
    ...
    :param registration_definition_name: Name of the marketplace registration
     definition.
    ...
    :ivar provisioning_state: Current state of the marketplace registration
    ...
    :param offer_display_name: The display name of the offer.
    :type offer_display_name: str
    :param publisher_display_name: The display name of the publisher.
    :type publisher_display_name: str
    :param plan_display_name: The display name of the plan.
    ...
    def __init__(self, *, authorizations, managed_by_tenant_id: str, description: str=None, registration_definition_name: str=None, offer_display_name: str=None, publisher_display_name: str=None, plan_display_name: str=None, **kwargs) -> None:
...
class RegistrationDefinitionProperties(Model):
    ...
    def __init__(self, *, authorizations, managed_by_tenant_id: str, description: str=None, registration_definition_name: str=None, **kwargs) -> None:
