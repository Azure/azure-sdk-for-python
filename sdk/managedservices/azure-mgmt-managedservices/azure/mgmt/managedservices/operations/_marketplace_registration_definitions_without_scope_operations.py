...
def build_list_request(*, filter: Optional[str] = None, **kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2020-02-01-preview"))
...
class MarketplaceRegistrationDefinitionsWithoutScopeOperations:  # pylint: disable=name-too-long
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: ManagedServicesClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def list(
    ...
    ) -> ItemPaged["_models.MarketplaceRegistrationDefinition"]:
        ...
        :param filter: The filter query parameter to filter marketplace registration definitions by
         plan identifier, publisher, version etc. Default value is None.
        :type filter: str
