...
class RegistrationAssignmentsOperations(object):
    ...
    def get(
        self,
        scope,  # type: str
        registration_assignment_id,  # type: str
        expand_registration_definition=None,  # type: Optional[bool]
        **kwargs  # type: Any
    ):
    ...
    def _create_or_update_initial(
        ...
        scope,  # type: str
        registration_assignment_id,  # type: str
        request_body,  # type: "_models.RegistrationAssignment"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.RegistrationAssignment"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.RegistrationAssignment"]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.managedservices.models.RegistrationAssignmentList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
