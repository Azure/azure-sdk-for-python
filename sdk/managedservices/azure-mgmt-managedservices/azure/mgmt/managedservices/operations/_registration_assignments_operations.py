...
def build_list_request(
    scope: str, *, expand_registration_definition: Optional[bool] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class RegistrationAssignmentsOperations:
    ...
    @distributed_trace
    def list(
        self, scope: str, expand_registration_definition: Optional[bool] = None, **kwargs: Any
    ) -> ItemPaged["_models.RegistrationAssignment"]:
