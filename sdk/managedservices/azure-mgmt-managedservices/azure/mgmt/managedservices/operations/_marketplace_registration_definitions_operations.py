...
def build_list_request(scope: str, *, filter: Optional[str] = None, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.ManagedServices/marketplaceRegistrationDefinitions")
...
def build_get_request(scope: str, marketplace_identifier: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class MarketplaceRegistrationDefinitionsOperations:  # pylint: disable=name-too-long
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`marketplace_registration_definitions` attribute.
    """
