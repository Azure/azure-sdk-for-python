...
# USAGE
    python put_registration_assignment.py
...
def main():
    ...
    response = client.registration_assignments.begin_create_or_update(
...
# x-ms-original-file: specification/managedservices/resource-manager/Microsoft.ManagedServices/ManagedServices/preview/2020-02-01-preview/examples/PutRegistrationAssignment.json
