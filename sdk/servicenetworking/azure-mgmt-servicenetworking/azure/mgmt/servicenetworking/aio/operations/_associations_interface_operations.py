...
class AssociationsInterfaceOperations:
    ...
    async def _create_or_update_initial(
        ...
        resource: Union[_models.Association, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a Association type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.servicenetworking.models.Association or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Association or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.servicenetworking.models.Association]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def update(
        ...
        traffic_controller_name: str,
        association_name: str,
        properties: Union[_models.AssociationUpdate, IO[bytes]],
        **kwargs: Any
    ) -> _models.Association:
        """Update a Association.
        ...
        :type properties: ~azure.mgmt.servicenetworking.models.AssociationUpdate or IO[bytes]
        :return: Association or the result of cls(response)
        :rtype: ~azure.mgmt.servicenetworking.models.Association
        :raises ~azure.core.exceptions.HttpResponseError:
        """
