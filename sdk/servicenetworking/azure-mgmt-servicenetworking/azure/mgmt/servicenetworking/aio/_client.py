...
class ServiceNetworkingMgmtClient:
    ...
    :vartype associations_interface:
     azure.mgmt.servicenetworking.aio.operations.AssociationsInterfaceOperations
    :ivar frontends_interface: FrontendsInterfaceOperations operations
    :vartype frontends_interface:
     azure.mgmt.servicenetworking.aio.operations.FrontendsInterfaceOperations
    :ivar security_policies_interface: SecurityPoliciesInterfaceOperations operations
    :vartype security_policies_interface:
     azure.mgmt.servicenetworking.aio.operations.SecurityPoliciesInterfaceOperations
