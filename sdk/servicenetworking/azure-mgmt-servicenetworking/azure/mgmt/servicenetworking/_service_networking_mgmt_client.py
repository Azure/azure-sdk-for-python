...
class ServiceNetworkingMgmtClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :ivar frontends_interface: FrontendsInterfaceOperations operations
    :vartype frontends_interface:
     azure.mgmt.servicenetworking.operations.FrontendsInterfaceOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.frontends_interface = FrontendsInterfaceOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
    ...
    def __enter__(self) -> "ServiceNetworkingMgmtClient":
