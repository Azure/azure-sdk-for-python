...
# USAGE
    python private_endpoint_connection_put.py
...
def main():
    ...
    response = client.private_endpoint_connections_interface.begin_update(
        resource_group_name="rg1",
        traffic_controller_name="tc1",
        private_endpoint_connection_name="pec1",
        resource={
            "properties": {
                "privateLinkServiceConnectionState": {"description": "Approved by admin", "status": "Approved"}
            }
        },
    ).result()
    print(response)
