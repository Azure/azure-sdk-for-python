...
def add_sanitizers(test_proxy):
    containerregistry_subscription_id = os.environ.get("CONTAINERREGISTRY_SUBSCRIPTION_ID", "00000000-0000-0000-0000-000000000000")
    containerregistry_tenant_id = os.environ.get("CONTAINERREGISTRY_TENANT_ID", "00000000-0000-0000-0000-000000000000")
    containerregistry_client_id = os.environ.get("CONTAINERREGISTRY_CLIENT_ID", "00000000-0000-0000-0000-000000000000")
    containerregistry_client_secret = os.environ.get("CONTAINERREGISTRY_CLIENT_SECRET", "00000000-0000-0000-0000-000000000000")
