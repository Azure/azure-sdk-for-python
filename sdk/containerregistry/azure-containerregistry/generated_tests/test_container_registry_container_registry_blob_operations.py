...
class TestContainerRegistryContainerRegistryBlobOperations(ContainerRegistryTestBase):
    ...
    @ContainerRegistryPreparer()
    @recorded_by_proxy
    def test_container_registry_blob_check_blob_exists(self, containerregistry_endpoint):
        client = self.create_client(endpoint=containerregistry_endpoint)
    ...
    @ContainerRegistryPreparer()
    @recorded_by_proxy
    def test_container_registry_blob_delete_blob(self, containerregistry_endpoint):
        client = self.create_client(endpoint=containerregistry_endpoint)
        response = client.container_registry_blob.delete_blob(
            name="str",
            digest="str",
        )
    ...
    @ContainerRegistryPreparer()
    @recorded_by_proxy
    def test_container_registry_blob_mount_blob(self, containerregistry_endpoint):
        client = self.create_client(endpoint=containerregistry_endpoint)
        response = client.container_registry_blob.mount_blob(
            name="str",
            from_parameter="str",
            mount="str",
        )
    ...
    @ContainerRegistryPreparer()
    @recorded_by_proxy
    def test_container_registry_blob_start_upload(self, containerregistry_endpoint):
        client = self.create_client(endpoint=containerregistry_endpoint)
        response = client.container_registry_blob.start_upload(
            name="str",
        )
    ...
    @ContainerRegistryPreparer()
    @recorded_by_proxy
    def test_container_registry_blob_get_chunk(self, containerregistry_endpoint):
        client = self.create_client(endpoint=containerregistry_endpoint)
        response = client.container_registry_blob.get_chunk(
            name="str",
            digest="str",
            range="str",
        )
    ...
    @ContainerRegistryPreparer()
    @recorded_by_proxy
    def test_container_registry_blob_check_chunk_exists(self, containerregistry_endpoint):
        client = self.create_client(endpoint=containerregistry_endpoint)
        response = client.container_registry_blob.check_chunk_exists(
            name="str",
            digest="str",
            range="str",
        )
