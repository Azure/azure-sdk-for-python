...
class ContainerRegistryConfiguration:  # pylint: disable=too-many-instance-attributes
    ...
    :keyword api_version: The API version to use for this operation. Default value is "2021-07-01".
    ...
    def __init__(
        ...
        self.credential_scopes = kwargs.pop(
            "credential_scopes", ["https://containerregistry.azure.net/.default"]
        )
