...
class ContainerRegistry:
    ...
    :vartype container_registry: azure.containerregistry.aio.operations.ContainerRegistryOperations
    :ivar container_registry_blob: ContainerRegistryBlobOperations operations
    :vartype container_registry_blob:
     azure.containerregistry.aio.operations.ContainerRegistryBlobOperations
    ...
    def __init__(self, endpoint: str, credential: "AsyncTokenCredential", **kwargs: Any) -> None:
        _endpoint = "{endpoint}"
        self._config = ContainerRegistryConfiguration(endpoint=endpoint, credential=credential, **kwargs)
