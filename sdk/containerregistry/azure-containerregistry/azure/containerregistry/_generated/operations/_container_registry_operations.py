...
def build_get_repositories_request(
    **kwargs  # type: Any
    ...
    if last is not None:
        _query_parameters['last'] = _SERIALIZER.query("last", last, 'str')
    if n is not None:
        _query_parameters['n'] = _SERIALIZER.query("n", n, 'int')
...
def build_get_tags_request(
    ...
    **kwargs  # type: Any
    ...
    if digest is not None:
        _query_parameters['digest'] = _SERIALIZER.query("digest", digest, 'str')
    _query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
