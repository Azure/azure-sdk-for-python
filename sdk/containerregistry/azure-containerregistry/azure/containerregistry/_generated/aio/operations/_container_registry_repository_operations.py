...
class ContainerRegistryRepositoryOperations:
    ...
    def get_tags(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.containerregistry.models.TagList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_manifests(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.containerregistry.models.AcrManifests]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_manifest_attributes(
        self,
        name: str,
        digest: str,
        **kwargs
