...
class BlobOperations:
    ...
    async def get(
        ...
        **kwargs
        ...
        return deserialized
    get.metadata = {'url': '/v2/{name}/blobs/{digest}'}  # type: ignore
    ...
    check.metadata = {'url': '/v2/{name}/blobs/{digest}'}  # type: ignore
    ...
    async def delete(
        ...
        **kwargs
        ...
        return deserialized
    delete.metadata = {'url': '/v2/{name}/blobs/{digest}'}  # type: ignore
    ...
    async def mount(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.mount.metadata['url']  # type: ignore
        path_format_arguments = {
            'url': self._serialize.url("self._config.url", self._config.url, 'str', skip_quote=True),
            'name': self._serialize.url("name", name, 'str'),
        }
    ...
    mount.metadata = {'url': '/v2/{name}/blobs/uploads/'}  # type: ignore
    ...
    get_status.metadata = {'url': '/{nextBlobUuidLink}'}  # type: ignore
    ...
    upload.metadata = {'url': '/{nextBlobUuidLink}'}  # type: ignore

    async def end_upload(
        self,
        digest: str,
        location: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.end_upload.metadata['url']  # type: ignore
        path_format_arguments = {
            'url': self._serialize.url("self._config.url", self._config.url, 'str', skip_quote=True),
            'nextBlobUuidLink': self._serialize.url("location", location, 'str', skip_quote=True),
        }
    ...
    end_upload.metadata = {'url': '/{nextBlobUuidLink}'}  # type: ignore
    ...
    async def check_chunk(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.check_chunk.metadata['url']  # type: ignore
        path_format_arguments = {
            'url': self._serialize.url("self._config.url", self._config.url, 'str', skip_quote=True),
            'name': self._serialize.url("name", name, 'str'),
            'digest': self._serialize.url("digest", digest, 'str'),
    ...
    check_chunk.metadata = {'url': '/v2/{name}/blobs/{digest}'}  # type: ignore
