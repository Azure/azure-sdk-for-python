...
class ManifestWrapper(Manifest):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype config: ~container_registry.models.OciDescriptor
    :ivar layers: (V2, OCI) List of V2 image layer information.
    :vartype layers: list[~container_registry.models.OciDescriptor]
    :ivar annotations: (OCI, OCIIndex) Additional metadata.
    :vartype annotations: ~container_registry.models.OciAnnotations
    ...
    _attribute_map = {
        ...
        "media_type": {"key": "mediaType", "type": "str"},
        "manifests": {"key": "manifests", "type": "[ManifestListAttributes]"},
        "config": {"key": "config", "type": "OciDescriptor"},
        "layers": {"key": "layers", "type": "[OciDescriptor]"},
        "annotations": {"key": "annotations", "type": "OciAnnotations"},
        "architecture": {"key": "architecture", "type": "str"},
    ...
    def __init__(
        ...
        *,
        ...
        media_type: Optional[str] = None,
        manifests: Optional[List["_models.ManifestListAttributes"]] = None,
        config: Optional["_models.OciDescriptor"] = None,
        layers: Optional[List["_models.OciDescriptor"]] = None,
        annotations: Optional["_models.OciAnnotations"] = None,
        ...
        **kwargs: Any
        ...
        :paramtype config: ~container_registry.models.OciDescriptor
        :keyword layers: (V2, OCI) List of V2 image layer information.
        :paramtype layers: list[~container_registry.models.OciDescriptor]
        :keyword annotations: (OCI, OCIIndex) Additional metadata.
        :paramtype annotations: ~container_registry.models.OciAnnotations
...
class OciAnnotations(_serialization.Model):  # pylint: disable=too-many-instance-attributes
...
class OciDescriptor(_serialization.Model):
    """Docker V2 image layer descriptor including config and layers.

    :ivar media_type: Layer media type.
    :vartype media_type: str
    :ivar size_in_bytes: Layer size.
    ...
    _attribute_map = {
        "media_type": {"key": "mediaType", "type": "str"},
        "size_in_bytes": {"key": "size", "type": "int"},
        "digest": {"key": "digest", "type": "str"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype media_type: str
        :keyword size_in_bytes: Layer size.
...
class OciImageManifest(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword annotations: Additional information provided through arbitrary metadata.
        :paramtype annotations: ~container_registry.models.OciAnnotations
        :keyword schema_version: Schema version. Required.
        :paramtype schema_version: int
        """
        super().__init__(**kwargs)
        self.config = config
