...
class AcrManifests(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword registry_login_server: Registry login server.
...
class ArtifactManifestProperties(msrest.serialization.Model):
    ...
    :ivar quarantine_state: Quarantine state.
    :vartype quarantine_state: str
    :ivar quarantine_details: Quarantine details.
    :vartype quarantine_details: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword quarantine_state: Quarantine state.
        :paramtype quarantine_state: str
        :keyword quarantine_details: Quarantine details.
        :paramtype quarantine_details: str
        """
...
class ContainerRepositoryProperties(msrest.serialization.Model):
    ...
    :ivar can_read: Read enabled.
    :vartype can_read: bool
    :ivar teleport_enabled: Enables Teleport functionality on new images in the repository
     improving Container startup performance.
    :vartype teleport_enabled: bool
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword can_read: Read enabled.
        :paramtype can_read: bool
        :keyword teleport_enabled: Enables Teleport functionality on new images in the repository
         improving Container startup performance.
        :paramtype teleport_enabled: bool
        """
...
class ManifestAttributesManifest(msrest.serialization.Model):
    ...
    :ivar quarantine_tag: Quarantine tag name.
    :vartype quarantine_tag: str
    """
    ...
    def __init__(
        self,
        *,
        references: Optional[List["ArtifactManifestPlatform"]] = None,
        ...
        **kwargs
        ...
        :keyword quarantine_tag: Quarantine tag name.
        :paramtype quarantine_tag: str
        """
...
class Paths108HwamOauth2ExchangePostRequestbodyContentApplicationXWwwFormUrlencodedSchema(msrest.serialization.Model):
    ...
    :ivar grant_type: Can take a value of access_token. Has constant value: "access_token".
...
class PathsV3R3RxOauth2TokenPostRequestbodyContentApplicationXWwwFormUrlencodedSchema(msrest.serialization.Model):
    ...
    :ivar grant_type: Required. Grant type is expected to be refresh_token. Possible values
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword grant_type: Required. Grant type is expected to be refresh_token. Possible values
         include: "refresh_token", "password".
...
class TagList(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword registry_login_server: Required. Registry login server.
        :paramtype registry_login_server: str
