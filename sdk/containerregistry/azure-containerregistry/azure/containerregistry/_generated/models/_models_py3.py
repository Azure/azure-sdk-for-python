...
class ArtifactManifestProperties(msrest.serialization.Model):
    ...
    :param architecture: CPU architecture. Possible values include: "386", "amd64", "arm", "arm64",
     "mips", "mipsle", "mips64", "mips64le", "ppc64", "ppc64le", "riscv64", "s390x", "wasm". Default
     value: "none".
    :type architecture: str or ~container_registry.models.ArtifactArchitecture
    :param operating_system: Operating system. Possible values include: "aix", "android", "darwin",
     "dragonfly", "freebsd", "illumos", "ios", "js", "linux", "netbsd", "openbsd", "plan9",
     "solaris", "windows".
    :type operating_system: str or ~container_registry.models.ArtifactOperatingSystem
    ...
    def __init__(
        ...
        *,
        ...
        architecture: Optional[Union[str, "ArtifactArchitecture"]] = "none",
        operating_system: Optional[Union[str, "ArtifactOperatingSystem"]] = None,
        ...
        **kwargs
        ...
        self.tags = tags
        self.writeable_properties = writeable_properties
...
class ArtifactTagProperties(msrest.serialization.Model):
    ...
    :type name: str
    :param digest: Required. Tag digest.
    :type digest: str
    ...
    def __init__(
        ...
        *,
        ...
        writeable_properties: "ContentProperties",
        **kwargs
    ):
...
class DeleteRepositoryResult(msrest.serialization.Model):
    ...
    :param deleted_manifests: SHA of the deleted image.
    :type deleted_manifests: list[str]
    ...
    def __init__(
        self,
        *,
        deleted_manifests: Optional[List[str]] = None,
...
class ManifestChangeableAttributes(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        list_enabled: Optional[bool] = None,
...
class RepositoryProperties(msrest.serialization.Model):
    ...
    :type last_updated_on: ~datetime.datetime
    :param manifest_count: Required. Number of the manifests.
