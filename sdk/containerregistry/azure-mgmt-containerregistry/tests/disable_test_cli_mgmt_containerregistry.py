    ...
    def test_containerregistry(self, resource_group):
        ...
        BODY = {
            ...
            "step": {
                ...
                "no_cache": False,
                "arguments": [
                    {"name": "mytestargument", "value": "mytestvalue", "is_secret": False},
                    {"name": "mysecrettestargument", "value": "mysecrettestvalue", "is_secret": True},
                ],
            },
            "trigger": {
                "timer_triggers": [{"name": "myTimerTrigger", "schedule": "30 9 * * 1-5"}],
                "source_triggers": [
                    {
                        ...
                        "source_repository": {
                            ...
                            "branch": "master",
                            "source_control_auth_properties": {"token_type": "PAT", "token": "xxxxx"},
                        },
                        "source_trigger_events": ["commit"],
                    }
                ],
                "base_image_trigger": {"name": "myBaseImageTrigger", "base_image_trigger_type": "Runtime"},
            },
        }
        ...
        BODY = {
            "location": AZURE_LOCATION,
            "identity": {"type": "SystemAssigned, UserAssigned", "user_assigned_identities": {}},
            "tags": {"testkey": "value"},
            "status": "Enabled",
            "platform": {"os": "Linux", "architecture": "amd64"},
            "agent_configuration": {"cpu": "2"},
        ...
        BODY = {
            ...
            "custom_headers": {"authorization": "Basic 000000000000000000000000000000000000000000000000000"},
            "status": "enabled",
            "scope": "myRepository",
            "actions": ["push"],
        }
        result = self.mgmt_client.webhooks.begin_create(
            resource_group_name=RESOURCE_GROUP,
            registry_name=REGISTRY_NAME,
            webhook_name=WEBHOOK_NAME,
            webhook_create_parameters=BODY,
        )
        result = result.result()
        ...
        result = self.mgmt_client.scope_maps.begin_create(
            resource_group_name=RESOURCE_GROUP,
            registry_name=REGISTRY_NAME,
        ...
        result = self.mgmt_client.agent_pools.begin_create(
            resource_group_name=RESOURCE_GROUP,
            registry_name=REGISTRY_NAME,
        ...
        result = self.mgmt_client.replications.begin_create(
            resource_group_name=RESOURCE_GROUP,
            registry_name=REGISTRY_NAME,
        ...
        result = self.mgmt_client.pipeline_runs.begin_create(
            resource_group_name=RESOURCE_GROUP,
            registry_name=REGISTRY_NAME,
            pipeline_run_name=PIPELINE_RUN_NAME,
            pipeline_run_create_parameters=BODY,
        )
        result = result.result()
        ...
        result = self.mgmt_client.private_endpoint_connections.begin_create_or_update(
            ...
            private_endpoint_connection=BODY,
        )
        result = result.result()
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.private_endpoint_connections.get(
            resource_group_name=RESOURCE_GROUP,
            registry_name=REGISTRY_NAME,
            private_endpoint_connection_name=PRIVATE_ENDPOINT_CONNECTION_NAME,
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.pipeline_runs.get(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, pipeline_run_name=PIPELINE_RUN_NAME
        )

        # --------------------------------------------------------------------------
        # /Replications/get/ReplicationGet[get]
        # --------------------------------------------------------------------------
        result = self.mgmt_client.replications.get(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, replication_name=REPLICATION_NAME
        )

        # --------------------------------------------------------------------------
        # /AgentPools/get/AgentPools_Get[get]
        # --------------------------------------------------------------------------
        result = self.mgmt_client.agent_pools.get(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, agent_pool_name=AGENT_POOL_NAME
        )

        # --------------------------------------------------------------------------
        # /ScopeMaps/get/ScopeMapGet[get]
        # --------------------------------------------------------------------------
        result = self.mgmt_client.scope_maps.get(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, scope_map_name=SCOPE_MAP_NAME
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.webhooks.get(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, webhook_name=WEBHOOK_NAME
        )

        # --------------------------------------------------------------------------
        # /PrivateEndpointConnections/get/PrivateEndpointConnectionList[get]
        # --------------------------------------------------------------------------
        result = self.mgmt_client.private_endpoint_connections.list(
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.registries.list_private_link_resources(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.registries.list_usages(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.agent_pools.get_queue_status(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, agent_pool_name=AGENT_POOL_NAME
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.webhooks.get_callback_config(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, webhook_name=WEBHOOK_NAME
        )
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.webhooks.list_events(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, webhook_name=WEBHOOK_NAME
        )
        ...
        # --------------------------------------------------------------------------
        BODY = {"tags": {"key": "value"}}
        result = self.mgmt_client.replications.begin_update(
            resource_group_name=RESOURCE_GROUP,
            registry_name=REGISTRY_NAME,
            replication_name=REPLICATION_NAME,
            replication_update_parameters=BODY,
        )
        result = result.result()
        ...
        # --------------------------------------------------------------------------
        BODY = {"count": "1"}
        result = self.mgmt_client.agent_pools.begin_update(
            resource_group_name=RESOURCE_GROUP,
            registry_name=REGISTRY_NAME,
            agent_pool_name=AGENT_POOL_NAME,
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.webhooks.ping(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, webhook_name=WEBHOOK_NAME
        )
        ...
        result = self.mgmt_client.scope_maps.begin_update(
            resource_group_name=RESOURCE_GROUP,
            registry_name=REGISTRY_NAME,
            scope_map_name=SCOPE_MAP_NAME,
        ...
        result = self.mgmt_client.webhooks.begin_update(
            resource_group_name=RESOURCE_GROUP,
            registry_name=REGISTRY_NAME,
            webhook_name=WEBHOOK_NAME,
            webhook_update_parameters=BODY,
        )
        result = result.result()
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.registries.get_build_source_upload_url(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME
        )
        ...
        BODY = {
            "tags": {"testkey": "value"},
            "status": "Enabled",
            "agent_configuration": {"cpu": "3"},
            "step": {"type": "Docker", "image_names": ["azurerest:testtag1"], "docker_file_path": "src/DockerFile"},
            "trigger": {
                "source_triggers": [
                    {
                        "name": "mySourceTrigger",
            ...
            "credentials": {
                "custom_registries": {
                    "myregistry.azurecr.io": {
                        "user_name": {"type": "Opaque", "value": "username"},
                        "password": {
                            "type": "Vaultsecret",
        ...
        BODY = {
            ...
            "credentials": {"custom_registries": {"myregistry.azurecr.io": {"identity": "[system]"}}},
        }
        # result = self.mgmt_client.tasks.begin_update(resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, task_name=TASK_NAME, task_update_parameters=BODY)
        # result = result.result()
        ...
        # --------------------------------------------------------------------------
        BODY = {"name": "password"}
        result = self.mgmt_client.registries.regenerate_credential(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, regenerate_credential_parameters=BODY
        )
        ...
        result = self.mgmt_client.registries.begin_generate_credentials(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, generate_credentials_parameters=BODY
        )
        result = result.result()
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.registries.list_credentials(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME
        )
        ...
        BODY = {
            ...
            "target_tags": ["targetRepository:targetTag"],
            "untagged_target_repositories": ["targetRepository1"],
            "mode": "Force",
        }
        result = self.mgmt_client.registries.begin_import_image(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, parameters=BODY
        )
        result = result.result()
        ...
        result = self.mgmt_client.registries.begin_schedule_run(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, run_request=BODY
        )
        result = result.result()
        ...
        BODY = {
            ...
            "credentials": {
                "source_registry": {"login_mode": "Default"},
                "custom_registries": {
                    "myregistry.azurecr.io": {
                        "user_name": {"type": "Opaque", "value": "reg1"},
                        "password": {"type": "Opaque", "value": "***"},
                    }
                },
            },
            ...
            "credentials": {
                ...
                "custom_registries": {
                    ...
                    "myregistry2.azurecr.io": {
                        "user_name": {"type": "Opaque", "value": "reg2"},
                        "password": {"type": "Opaque", "value": "***"},
                    },
                },
            },
        ...
        # --------------------------------------------------------------------------
        BODY = {
            "source": {"registry_uri": "registry.hub.docker.com", "source_image": "library/hello-world"},
            "target_tags": ["targetRepository:targetTag"],
            "untagged_target_repositories": ["targetRepository1"],
            "mode": "Force",
        }
        ...
        BODY = {
            ...
            "override_task_step_properties": {
                ...
                "values": [
                    {"name": "mytestname", "value": "mytestvalue", "is_secret": False},
                    {"name": "mysecrettestname", "value": "mysecrettestvalue", "is_secret": True},
                ],
        ...
        result = self.mgmt_client.registries.begin_update(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, registry_update_parameters=BODY
        )
        result = result.result()
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.pipeline_runs.begin_delete(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, pipeline_run_name=PIPELINE_RUN_NAME
        )
        result = result.result()
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.replications.begin_delete(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, replication_name=REPLICATION_NAME
        )
        result = result.result()
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.agent_pools.begin_delete(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, agent_pool_name=AGENT_POOL_NAME
        )
        result = result.result()
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.scope_maps.begin_delete(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, scope_map_name=SCOPE_MAP_NAME
        )
        result = result.result()
        ...
        # --------------------------------------------------------------------------
        result = self.mgmt_client.webhooks.begin_delete(
            resource_group_name=RESOURCE_GROUP, registry_name=REGISTRY_NAME, webhook_name=WEBHOOK_NAME
        )
        result = result.result()
