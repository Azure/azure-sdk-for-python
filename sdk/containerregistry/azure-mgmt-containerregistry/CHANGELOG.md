...
### Features Added
  ...
  - Model `CacheRuleUpdateParameters` added property `identity`
  - Model `ConnectedRegistryProperties` added property `registry_sync_result`
  ...
  - Model `RegistryProperties` added property `regional_endpoints`
  - Model `RegistryProperties` added property `regional_endpoint_host_names`
  - Model `RegistryProperties` added property `endpoint_protocol`
  - Model `RegistryProperties` added property `metadata_search`
  - Model `RegistryProperties` added property `auto_generated_domain_name_label_scope`
  - Model `RegistryPropertiesUpdateParameters` added property `regional_endpoints`
  - Model `RegistryPropertiesUpdateParameters` added property `endpoint_protocol`
  - Model `RegistryPropertiesUpdateParameters` added property `metadata_search`
  - Added model `Archive`
  ...
  - Operation group `ConnectedRegistriesOperations` added method `resync`
