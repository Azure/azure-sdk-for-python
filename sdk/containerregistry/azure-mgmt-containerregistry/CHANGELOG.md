...
### Features Added
  ...
  - Model `CacheRule` added property `identity`
  ...
  - Added model `ArchiveVersionProperties`
  ...
  - Added enum `EndpointProtocol`
  - Added model `ExportPipeline`
  - Added model `ExportPipelineProperties`
  - Added model `ExportPipelineTargetProperties`
  - Added model `ImportPipeline`
  - Added model `ImportPipelineProperties`
  ...
  - Added model `PipelineRunProperties`
...
### Breaking Changes
  ...
  - Deleted or renamed client operation group `ContainerRegistryManagementClient.agent_pools`
  - Deleted or renamed client operation group `ContainerRegistryManagementClient.runs`
  - Deleted or renamed client operation group `ContainerRegistryManagementClient.task_runs`
  - Deleted or renamed client operation group `ContainerRegistryManagementClient.tasks`
