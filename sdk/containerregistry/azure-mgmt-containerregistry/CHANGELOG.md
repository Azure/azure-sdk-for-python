...
### Features Added
  ...
  - Added enum `Variant`
  - Model `RegistriesOperations` added method `get_build_source_upload_url`
  - Model `RegistriesOperations` added method `schedule_run`
  - Added model `AgentPoolsOperations`
  ...
  - Added model `RunsOperations`
  - Added model `TaskRunsOperations`
