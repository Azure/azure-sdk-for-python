...
class TestContainerRegistryRegistriesOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_registries_begin_create(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_registries_begin_update(self, resource_group):
        response = self.client.registries.begin_update(
            resource_group_name=resource_group.name,
            registry_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_registries_begin_import_image(self, resource_group):
        response = self.client.registries.begin_import_image(
            resource_group_name=resource_group.name,
            registry_name="str",
            parameters={
                "source": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_registries_list_usages(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_registries_list_credentials(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_registries_regenerate_credential(self, resource_group):
        response = self.client.registries.regenerate_credential(
            resource_group_name=resource_group.name,
            registry_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_registries_begin_generate_credentials(self, resource_group):
        response = self.client.registries.begin_generate_credentials(
            resource_group_name=resource_group.name,
            registry_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_registries_get_private_link_resource(self, resource_group):
        response = self.client.registries.get_private_link_resource(
            resource_group_name=resource_group.name,
            registry_name="str",
            group_name="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_registries_list_private_link_resources(self, resource_group):
