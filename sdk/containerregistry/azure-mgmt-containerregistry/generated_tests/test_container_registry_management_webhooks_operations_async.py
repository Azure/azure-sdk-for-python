...
class TestContainerRegistryManagementWebhooksOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_webhooks_begin_create(self, resource_group):
        response = await (
            await self.client.webhooks.begin_create(
                resource_group_name=resource_group.name,
                registry_name="str",
                webhook_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_webhooks_begin_delete(self, resource_group):
        response = await (
            await self.client.webhooks.begin_delete(
                resource_group_name=resource_group.name,
                registry_name="str",
                webhook_name="str",
                api_version="2025-04-01",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_webhooks_begin_update(self, resource_group):
        response = await (
            await self.client.webhooks.begin_update(
                resource_group_name=resource_group.name,
                registry_name="str",
                webhook_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_webhooks_ping(self, resource_group):
        response = await self.client.webhooks.ping(
            resource_group_name=resource_group.name,
            registry_name="str",
            webhook_name="str",
            api_version="2025-04-01",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_webhooks_list_events(self, resource_group):
