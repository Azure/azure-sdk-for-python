...
class WebhooksOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2021_08_01_preview.models.WebhookListResult]
    ...
    def _create_initial(
        ...
        registry_name,  # type: str
        webhook_name,  # type: str
        webhook_create_parameters,  # type: "_models.WebhookCreateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Webhook"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.Webhook"]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.Webhook"]
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2021_08_01_preview.models.Webhook]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        registry_name,  # type: str
        webhook_name,  # type: str
        webhook_update_parameters,  # type: "_models.WebhookUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Webhook"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.Webhook"]
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        :type webhook_update_parameters: ~azure.mgmt.containerregistry.v2021_08_01_preview.models.WebhookUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
    ...
    def list_events(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.EventListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2021_08_01_preview.models.EventListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
