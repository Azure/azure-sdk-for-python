...
class TokensOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.TokenListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2021_08_01_preview.models.TokenListResult]
    ...
    def _create_initial(
        ...
        registry_name,  # type: str
        token_name,  # type: str
        token_create_parameters,  # type: "_models.Token"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Token"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.Token"]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2021_08_01_preview.models.Token]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        registry_name,  # type: str
        token_name,  # type: str
        token_update_parameters,  # type: "_models.TokenUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Token"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.Token"]
