...
class AzureADAuthenticationAsArmPolicy(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        status: Optional[Union[str, "AzureADAuthenticationAsArmPolicyStatus"]] = "enabled",
        **kwargs
    ):
        """
        ...
        :paramtype status: str or
         ~azure.mgmt.containerregistry.v2022_02_01_preview.models.AzureADAuthenticationAsArmPolicyStatus
        """
        super(AzureADAuthenticationAsArmPolicy, self).__init__(**kwargs)
        self.status = status
...
class Policies(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        azure_ad_authentication_as_arm_policy: Optional["AzureADAuthenticationAsArmPolicy"] = None,
