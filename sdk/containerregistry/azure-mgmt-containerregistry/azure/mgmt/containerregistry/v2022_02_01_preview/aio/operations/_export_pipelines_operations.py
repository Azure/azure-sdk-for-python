...
class ExportPipelinesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2022_02_01_preview.models.ExportPipeline]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2022_02_01_preview.models.ExportPipeline
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type export_pipeline_create_parameters:
         ~azure.mgmt.containerregistry.v2022_02_01_preview.models.ExportPipeline
        ...
        :return: An instance of AsyncLROPoller that returns either ExportPipeline or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2022_02_01_preview.models.ExportPipeline]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type export_pipeline_create_parameters:
         ~azure.mgmt.containerregistry.v2022_02_01_preview.models.ExportPipeline or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ExportPipeline or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2022_02_01_preview.models.ExportPipeline]
