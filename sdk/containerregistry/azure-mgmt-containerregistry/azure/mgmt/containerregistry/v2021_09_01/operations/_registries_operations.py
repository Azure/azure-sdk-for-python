...
class RegistriesOperations:
    ...
    def begin_import_image(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerregistry.v2021_09_01.models.ImportImageParameters or
         IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def check_name_availability(
        ...
        :type registry_name_check_request:
         ~azure.mgmt.containerregistry.v2021_09_01.models.RegistryNameCheckRequest or IO[bytes]
        :return: RegistryNameStatus or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2021_09_01.models.RegistryNameStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.Registry"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2021_09_01.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2021_09_01.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        :type registry: ~azure.mgmt.containerregistry.v2021_09_01.models.Registry or IO[bytes]
        :return: An instance of LROPoller that returns either Registry or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2021_09_01.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type registry_update_parameters:
         ~azure.mgmt.containerregistry.v2021_09_01.models.RegistryUpdateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either Registry or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2021_09_01.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_private_link_resources(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2021_09_01.models.PrivateLinkResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def regenerate_credential(
        ...
        **kwargs: Any
        ...
        :type regenerate_credential_parameters:
         ~azure.mgmt.containerregistry.v2021_09_01.models.RegenerateCredentialParameters or IO[bytes]
        :return: RegistryListCredentialsResult or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2021_09_01.models.RegistryListCredentialsResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
