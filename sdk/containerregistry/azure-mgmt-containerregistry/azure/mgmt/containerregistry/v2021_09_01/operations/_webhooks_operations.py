...
class WebhooksOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.Webhook"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2021_09_01.models.Webhook]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2021_09_01.models.Webhook]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type webhook_create_parameters:
         ~azure.mgmt.containerregistry.v2021_09_01.models.WebhookCreateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either Webhook or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2021_09_01.models.Webhook]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type webhook_update_parameters:
         ~azure.mgmt.containerregistry.v2021_09_01.models.WebhookUpdateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either Webhook or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2021_09_01.models.Webhook]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_events(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2021_09_01.models.Event]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
