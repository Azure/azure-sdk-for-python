...
from ...operations._credential_sets_operations import (
...
class CredentialSetsOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.CredentialSet"]:
        ...
        :return: An iterator like instance of either CredentialSet or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2023_01_01_preview.models.CredentialSet]
        ...
        cls: ClsType[_models.CredentialSetListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("CredentialSetListResult", pipeline_response)
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/credentialSets"
    }
    ...
    async def get(
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CredentialSet or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2023_01_01_preview.models.CredentialSet
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("CredentialSet", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/credentialSets/{credentialSetName}"
    }
    ...
    async def _create_initial(
        ...
        credential_set_create_parameters: Union[_models.CredentialSet, IO],
        **kwargs: Any
    ) -> _models.CredentialSet:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type credential_set_create_parameters:
         ~azure.mgmt.containerregistry.v2023_01_01_preview.models.CredentialSet
        ...
        :return: An instance of AsyncLROPoller that returns either CredentialSet or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_01_01_preview.models.CredentialSet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _update_initial(
        ...
        registry_name: str,
        credential_set_name: str,
        credential_set_update_parameters: Union[_models.CredentialSetUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.CredentialSet:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type credential_set_update_parameters:
         ~azure.mgmt.containerregistry.v2023_01_01_preview.models.CredentialSetUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
