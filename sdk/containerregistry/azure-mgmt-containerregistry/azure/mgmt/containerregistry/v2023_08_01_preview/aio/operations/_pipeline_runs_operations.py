...
class PipelineRunsOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> AsyncIterable["_models.PipelineRun"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2023_08_01_preview.models.PipelineRun]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2023_08_01_preview.models.PipelineRun
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type pipeline_run_create_parameters:
         ~azure.mgmt.containerregistry.v2023_08_01_preview.models.PipelineRun
        ...
        :return: An instance of AsyncLROPoller that returns either PipelineRun or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_08_01_preview.models.PipelineRun]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type pipeline_run_create_parameters:
         ~azure.mgmt.containerregistry.v2023_08_01_preview.models.PipelineRun or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either PipelineRun or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_08_01_preview.models.PipelineRun]
