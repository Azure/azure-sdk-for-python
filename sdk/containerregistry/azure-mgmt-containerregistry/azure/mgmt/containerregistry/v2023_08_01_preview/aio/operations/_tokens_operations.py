...
class TokensOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> AsyncIterable["_models.Token"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2023_08_01_preview.models.Token]
    ...
    async def get(self, resource_group_name: str, registry_name: str, token_name: str, **kwargs: Any) -> _models.Token:
        ...
        :rtype: ~azure.mgmt.containerregistry.v2023_08_01_preview.models.Token
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type token_create_parameters: ~azure.mgmt.containerregistry.v2023_08_01_preview.models.Token
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either Token or the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_08_01_preview.models.Token]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type token_update_parameters:
         ~azure.mgmt.containerregistry.v2023_08_01_preview.models.TokenUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either Token or the result of cls(response)
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type token_update_parameters:
         ~azure.mgmt.containerregistry.v2023_08_01_preview.models.TokenUpdateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Token or the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_08_01_preview.models.Token]
        :raises ~azure.core.exceptions.HttpResponseError:
