...
class TokensOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.Token"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2023_08_01_preview.models.Token]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2023_08_01_preview.models.Token]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
