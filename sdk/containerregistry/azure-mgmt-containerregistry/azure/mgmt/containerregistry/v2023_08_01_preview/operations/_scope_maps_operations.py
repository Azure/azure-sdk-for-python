...
class ScopeMapsOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.ScopeMap"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2023_08_01_preview.models.ScopeMap]
    ...
    def get(self, resource_group_name: str, registry_name: str, scope_map_name: str, **kwargs: Any) -> _models.ScopeMap:
        ...
        :rtype: ~azure.mgmt.containerregistry.v2023_08_01_preview.models.ScopeMap
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/scopeMaps/{scopeMapName}"
    }
    ...
    def _create_initial(
        ...
        registry_name: str,
        scope_map_name: str,
        scope_map_create_parameters: Union[_models.ScopeMap, IO],
        **kwargs: Any
    ) -> _models.ScopeMap:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type scope_map_create_parameters:
         ~azure.mgmt.containerregistry.v2023_08_01_preview.models.ScopeMap
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2023_08_01_preview.models.ScopeMap]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type scope_map_create_parameters:
         ~azure.mgmt.containerregistry.v2023_08_01_preview.models.ScopeMap or IO
    ...
    def _update_initial(
        ...
        registry_name: str,
        scope_map_name: str,
        scope_map_update_parameters: Union[_models.ScopeMapUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.ScopeMap:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type scope_map_update_parameters:
         ~azure.mgmt.containerregistry.v2023_08_01_preview.models.ScopeMapUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type scope_map_update_parameters:
         ~azure.mgmt.containerregistry.v2023_08_01_preview.models.ScopeMapUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
