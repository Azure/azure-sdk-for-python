...
class CredentialSetsOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.CredentialSet"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2023_08_01_preview.models.CredentialSet]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either CredentialSet or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2023_08_01_preview.models.CredentialSet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
