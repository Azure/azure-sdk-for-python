...
class TokensOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2019_05_01_preview.models.Token]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type token_update_parameters:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.TokenUpdateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Token or the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2019_05_01_preview.models.Token]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> AsyncIterable["_models.Token"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2019_05_01_preview.models.Token]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
