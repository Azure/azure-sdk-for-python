...
class TokensOperations(object):
    ...
    def _create_initial(
        ...
        registry_name,  # type: str
        token_name,  # type: str
        token_create_parameters,  # type: "models.Token"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Token"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Token"]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2019_05_01_preview.models.Token]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        registry_name,  # type: str
        token_name,  # type: str
        token_update_parameters,  # type: "models.TokenUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Token"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Token"]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2019_05_01_preview.models.TokenListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
