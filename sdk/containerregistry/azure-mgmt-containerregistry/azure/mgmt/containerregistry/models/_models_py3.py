...
class AgentPool(TrackedResource):
    ...
    :vartype os: str or ~azure.mgmt.containerregistry.models.OS
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype os: str or ~azure.mgmt.containerregistry.models.OS
...
class AgentPoolListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.containerregistry.models.AgentPool]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.containerregistry.models.AgentPool]
...
class AuthInfo(_serialization.Model):
    ...
    :vartype token_type: str or ~azure.mgmt.containerregistry.models.TokenType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype token_type: str or ~azure.mgmt.containerregistry.models.TokenType
...
class BaseImageDependency(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.containerregistry.models.BaseImageDependencyType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The type of the base image dependency. Known values are: "BuildTime" and
         "RunTime".
        :paramtype type: str or ~azure.mgmt.containerregistry.models.BaseImageDependencyType
...
class BaseImageTrigger(_serialization.Model):
    ...
    :vartype base_image_trigger_type: str or
     ~azure.mgmt.containerregistry.models.BaseImageTriggerType
    ...
    :vartype update_trigger_payload_type: str or
     ~azure.mgmt.containerregistry.models.UpdateTriggerPayloadType
...
class Credentials(_serialization.Model):
    ...
    :vartype source_registry: ~azure.mgmt.containerregistry.models.SourceRegistryCredentials
    ...
    :vartype custom_registries: dict[str,
     ~azure.mgmt.containerregistry.models.CustomRegistryCredentials]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword source_registry: Describes the credential parameters for accessing the source
         registry.
        :paramtype source_registry: ~azure.mgmt.containerregistry.models.SourceRegistryCredentials
...
class CustomRegistryCredentials(_serialization.Model):
    ...
    :vartype user_name: ~azure.mgmt.containerregistry.models.SecretObject
    :ivar password: The password for logging into the custom registry. The password is a secret
     object that allows multiple ways of providing the value for it.
    :vartype password: ~azure.mgmt.containerregistry.models.SecretObject
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype user_name: ~azure.mgmt.containerregistry.models.SecretObject
        :keyword password: The password for logging into the custom registry. The password is a secret
         object that allows multiple ways of providing the value for it.
        :paramtype password: ~azure.mgmt.containerregistry.models.SecretObject
...
class DockerBuildRequest(RunRequest):
    ...
    :vartype arguments: list[~azure.mgmt.containerregistry.models.Argument]
    :ivar timeout: Run timeout in seconds.
    :vartype timeout: int
    :ivar platform: The platform properties against which the run has to happen. Required.
    :vartype platform: ~azure.mgmt.containerregistry.models.PlatformProperties
    :ivar agent_configuration: The machine configuration of the run agent.
    :vartype agent_configuration: ~azure.mgmt.containerregistry.models.AgentProperties
    ...
    :ivar credentials: The properties that describes a set of credentials that will be used when
     this run is invoked.
    :vartype credentials: ~azure.mgmt.containerregistry.models.Credentials
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype arguments: list[~azure.mgmt.containerregistry.models.Argument]
        ...
        :paramtype agent_configuration: ~azure.mgmt.containerregistry.models.AgentProperties
        ...
        :keyword credentials: The properties that describes a set of credentials that will be used when
         this run is invoked.
        :paramtype credentials: ~azure.mgmt.containerregistry.models.Credentials
        """
        super().__init__(
...
class TaskStepProperties(_serialization.Model):
    ...
    :ivar type: The type of the step. Required. Known values are: "Docker", "FileTask", and
     "EncodedTask".
    :vartype type: str or ~azure.mgmt.containerregistry.models.StepType
    :ivar base_image_dependencies: List of base image dependencies for a step.
    :vartype base_image_dependencies:
     list[~azure.mgmt.containerregistry.models.BaseImageDependency]
...
class EncodedTaskRunRequest(RunRequest):
    ...
    :vartype values: list[~azure.mgmt.containerregistry.models.SetValue]
    :ivar timeout: Run timeout in seconds.
    :vartype timeout: int
    :ivar platform: The platform properties against which the run has to happen. Required.
    :vartype platform: ~azure.mgmt.containerregistry.models.PlatformProperties
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype values: list[~azure.mgmt.containerregistry.models.SetValue]
        :keyword timeout: Run timeout in seconds.
        :paramtype timeout: int
        :keyword platform: The platform properties against which the run has to happen. Required.
        :paramtype platform: ~azure.mgmt.containerregistry.models.PlatformProperties
...
class ImageUpdateTrigger(_serialization.Model):
    ...
    :vartype images: list[~azure.mgmt.containerregistry.models.ImageDescriptor]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype images: list[~azure.mgmt.containerregistry.models.ImageDescriptor]
        """
        super().__init__(**kwargs)
        self.id = id
        self.timestamp = timestamp
...
class PlatformProperties(_serialization.Model):
    ...
    :ivar architecture: The OS architecture. Known values are: "amd64", "x86", "386", "arm", and
     "arm64".
    :vartype architecture: str or ~azure.mgmt.containerregistry.models.Architecture
    :ivar variant: Variant of the CPU. Known values are: "v6", "v7", and "v8".
    :vartype variant: str or ~azure.mgmt.containerregistry.models.Variant
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword architecture: The OS architecture. Known values are: "amd64", "x86", "386", "arm", and
         "arm64".
        :paramtype architecture: str or ~azure.mgmt.containerregistry.models.Architecture
        :keyword variant: Variant of the CPU. Known values are: "v6", "v7", and "v8".
        :paramtype variant: str or ~azure.mgmt.containerregistry.models.Variant
        """
        super().__init__(**kwargs)
        self.os = os
...
class Run(ProxyResource):
    ...
    :vartype output_images: list[~azure.mgmt.containerregistry.models.ImageDescriptor]
    ...
    :vartype image_update_trigger: ~azure.mgmt.containerregistry.models.ImageUpdateTrigger
    :ivar source_trigger: The source trigger that caused the run.
    :vartype source_trigger: ~azure.mgmt.containerregistry.models.SourceTriggerDescriptor
    :ivar timer_trigger: The timer trigger that caused the run.
    :vartype timer_trigger: ~azure.mgmt.containerregistry.models.TimerTriggerDescriptor
    ...
    :vartype log_artifact: ~azure.mgmt.containerregistry.models.ImageDescriptor
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :keyword output_images: The list of all images that were generated from the run. This is
         applicable if the run generates base image dependencies.
        :paramtype output_images: list[~azure.mgmt.containerregistry.models.ImageDescriptor]
        ...
        :paramtype image_update_trigger: ~azure.mgmt.containerregistry.models.ImageUpdateTrigger
        :keyword source_trigger: The source trigger that caused the run.
        :paramtype source_trigger: ~azure.mgmt.containerregistry.models.SourceTriggerDescriptor
        :keyword timer_trigger: The timer trigger that caused the run.
        :paramtype timer_trigger: ~azure.mgmt.containerregistry.models.TimerTriggerDescriptor
        ...
        :keyword provisioning_state: The provisioning state of a run. Known values are: "Creating",
         "Updating", "Deleting", "Succeeded", "Failed", and "Canceled".
        :paramtype provisioning_state: str or ~azure.mgmt.containerregistry.models.ProvisioningState
...
class RunListResult(_serialization.Model):
    ...
    def __init__(
        ...
        """
        :keyword value: The collection value.
        :paramtype value: list[~azure.mgmt.containerregistry.models.Run]
        :keyword next_link: The URI that can be used to request the next set of paged results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class SecretObject(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.containerregistry.models.SecretObjectType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The type of the secret object which determines how the value of the secret
         object has to be
         interpreted. Known values are: "Opaque" and "Vaultsecret".
        :paramtype type: str or ~azure.mgmt.containerregistry.models.SecretObjectType
        """
        super().__init__(**kwargs)
        self.value = value
        self.type = type
...
class SourceProperties(_serialization.Model):
    ...
    :vartype source_control_type: str or ~azure.mgmt.containerregistry.models.SourceControlType
    ...
    :vartype source_control_auth_properties: ~azure.mgmt.containerregistry.models.AuthInfo
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword source_control_type: The type of source control service. Required. Known values are:
         "Github" and "VisualStudioTeamService".
        :paramtype source_control_type: str or ~azure.mgmt.containerregistry.models.SourceControlType
        ...
        :keyword source_control_auth_properties: The authorization properties for accessing the source
         code repository and to set up
         webhooks for notifications.
        :paramtype source_control_auth_properties: ~azure.mgmt.containerregistry.models.AuthInfo
        """
        super().__init__(**kwargs)
...
class SourceRegistryCredentials(_serialization.Model):
    ...
    :vartype login_mode: str or ~azure.mgmt.containerregistry.models.SourceRegistryLoginMode
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword login_mode: The authentication mode which determines the source registry login scope.
         ...
         will be generated using the given scope. These credentials will be used to login to
         the source registry during the run. Known values are: "None" and "Default".
        :paramtype login_mode: str or ~azure.mgmt.containerregistry.models.SourceRegistryLoginMode
        """
        super().__init__(**kwargs)
        self.identity = identity
...
class SourceTrigger(_serialization.Model):
    ...
    :vartype source_repository: ~azure.mgmt.containerregistry.models.SourceProperties
    ...
    :vartype source_trigger_events: list[str or
     ~azure.mgmt.containerregistry.models.SourceTriggerEvent]
    :ivar status: The current status of trigger. Known values are: "Disabled" and "Enabled".
    :vartype status: str or ~azure.mgmt.containerregistry.models.TriggerStatus
    :ivar name: The name of the trigger. Required.
    :vartype name: str
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword source_repository: The properties that describes the source(code) for the task.
         Required.
        :paramtype source_repository: ~azure.mgmt.containerregistry.models.SourceProperties
...
class SourceTriggerUpdateParameters(_serialization.Model):
    ...
    :vartype source_repository: ~azure.mgmt.containerregistry.models.SourceUpdateParameters
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword source_repository: The properties that describes the source(code) for the task.
        :paramtype source_repository: ~azure.mgmt.containerregistry.models.SourceUpdateParameters
...
class SourceUpdateParameters(_serialization.Model):
    ...
    :vartype source_control_auth_properties:
     ~azure.mgmt.containerregistry.models.AuthInfoUpdateParameters
    """
...
class Task(TrackedResource):
    ...
    :vartype status: str or ~azure.mgmt.containerregistry.models.TaskStatus
    ...
    :vartype step: ~azure.mgmt.containerregistry.models.TaskStepProperties
    :ivar trigger: The properties that describe all triggers for the task.
    :vartype trigger: ~azure.mgmt.containerregistry.models.TriggerProperties
    :ivar credentials: The properties that describes a set of credentials that will be used when
     this run is invoked.
    :vartype credentials: ~azure.mgmt.containerregistry.models.Credentials
    :ivar log_template: The template that describes the repository and tag information for run log
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype status: str or ~azure.mgmt.containerregistry.models.TaskStatus
        ...
        :paramtype step: ~azure.mgmt.containerregistry.models.TaskStepProperties
        :keyword trigger: The properties that describe all triggers for the task.
        :paramtype trigger: ~azure.mgmt.containerregistry.models.TriggerProperties
        :keyword credentials: The properties that describes a set of credentials that will be used when
         this run is invoked.
        :paramtype credentials: ~azure.mgmt.containerregistry.models.Credentials
        :keyword log_template: The template that describes the repository and tag information for run
...
class TaskListResult(_serialization.Model):
    ...
    :ivar value: The collection value.
    :vartype value: list[~azure.mgmt.containerregistry.models.Task]
    :ivar next_link: The URI that can be used to request the next set of paged results.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        """
        :keyword value: The collection value.
        :paramtype value: list[~azure.mgmt.containerregistry.models.Task]
        :keyword next_link: The URI that can be used to request the next set of paged results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class TaskRun(ProxyResource):
    ...
    :vartype run_request: ~azure.mgmt.containerregistry.models.RunRequest
    :ivar run_result: The result of this task run.
    :vartype run_result: ~azure.mgmt.containerregistry.models.Run
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype run_request: ~azure.mgmt.containerregistry.models.RunRequest
...
class TaskRunListResult(_serialization.Model):
    ...
    :ivar value: The collection value.
    :vartype value: list[~azure.mgmt.containerregistry.models.TaskRun]
    :ivar next_link: The URI that can be used to request the next set of paged results.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        """
        :keyword value: The collection value.
        :paramtype value: list[~azure.mgmt.containerregistry.models.TaskRun]
        :keyword next_link: The URI that can be used to request the next set of paged results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class TaskRunRequest(RunRequest):
    ...
    :vartype override_task_step_properties:
     ~azure.mgmt.containerregistry.models.OverrideTaskStepProperties
    """
...
class TaskUpdateParameters(_serialization.Model):
    ...
    :vartype status: str or ~azure.mgmt.containerregistry.models.TaskStatus
    :ivar platform: The platform properties against which the run has to happen.
    :vartype platform: ~azure.mgmt.containerregistry.models.PlatformUpdateParameters
    :ivar agent_configuration: The machine configuration of the run agent.
    :vartype agent_configuration: ~azure.mgmt.containerregistry.models.AgentProperties
    :ivar agent_pool_name: The dedicated agent pool for the task.
    :vartype agent_pool_name: str
    ...
    :vartype step: ~azure.mgmt.containerregistry.models.TaskStepUpdateParameters
    :ivar trigger: The properties for updating trigger properties.
    :vartype trigger: ~azure.mgmt.containerregistry.models.TriggerUpdateParameters
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype status: str or ~azure.mgmt.containerregistry.models.TaskStatus
        :keyword platform: The platform properties against which the run has to happen.
        :paramtype platform: ~azure.mgmt.containerregistry.models.PlatformUpdateParameters
        :keyword agent_configuration: The machine configuration of the run agent.
        :paramtype agent_configuration: ~azure.mgmt.containerregistry.models.AgentProperties
        :keyword agent_pool_name: The dedicated agent pool for the task.
        :paramtype agent_pool_name: str
        ...
        :paramtype step: ~azure.mgmt.containerregistry.models.TaskStepUpdateParameters
        :keyword trigger: The properties for updating trigger properties.
        :paramtype trigger: ~azure.mgmt.containerregistry.models.TriggerUpdateParameters
...
class TriggerProperties(_serialization.Model):
    ...
    :vartype timer_triggers: list[~azure.mgmt.containerregistry.models.TimerTrigger]
    :ivar source_triggers: The collection of triggers based on source code repository.
    :vartype source_triggers: list[~azure.mgmt.containerregistry.models.SourceTrigger]
    :ivar base_image_trigger: The trigger based on base image dependencies.
    :vartype base_image_trigger: ~azure.mgmt.containerregistry.models.BaseImageTrigger
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype timer_triggers: list[~azure.mgmt.containerregistry.models.TimerTrigger]
        :keyword source_triggers: The collection of triggers based on source code repository.
        :paramtype source_triggers: list[~azure.mgmt.containerregistry.models.SourceTrigger]
        :keyword base_image_trigger: The trigger based on base image dependencies.
        :paramtype base_image_trigger: ~azure.mgmt.containerregistry.models.BaseImageTrigger
        """
        super().__init__(**kwargs)
...
class TriggerUpdateParameters(_serialization.Model):
    ...
    :vartype timer_triggers:
     list[~azure.mgmt.containerregistry.models.TimerTriggerUpdateParameters]
    :ivar source_triggers: The collection of triggers based on source code repository.
    :vartype source_triggers:
     list[~azure.mgmt.containerregistry.models.SourceTriggerUpdateParameters]
    :ivar base_image_trigger: The trigger based on base image dependencies.
    :vartype base_image_trigger:
     ~azure.mgmt.containerregistry.models.BaseImageTriggerUpdateParameters
    """
