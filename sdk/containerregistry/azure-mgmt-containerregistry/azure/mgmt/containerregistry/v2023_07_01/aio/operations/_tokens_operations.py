...
class TokensOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param token_create_parameters: The parameters for creating a token. Is either a Token type or
         a IO type. Required.
        :type token_create_parameters: ~azure.mgmt.containerregistry.v2023_07_01.models.Token or IO
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type token_update_parameters:
         ~azure.mgmt.containerregistry.v2023_07_01.models.TokenUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
