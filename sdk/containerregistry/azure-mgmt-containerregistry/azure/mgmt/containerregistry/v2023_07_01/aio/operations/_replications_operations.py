...
class ReplicationsOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> AsyncIterable["_models.Replication"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2023_07_01.models.Replication]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2023_07_01.models.Replication
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type replication: ~azure.mgmt.containerregistry.v2023_07_01.models.Replication
        ...
        :return: An instance of AsyncLROPoller that returns either Replication or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_07_01.models.Replication]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type replication: ~azure.mgmt.containerregistry.v2023_07_01.models.Replication or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Replication or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_07_01.models.Replication]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type replication_update_parameters:
         ~azure.mgmt.containerregistry.v2023_07_01.models.ReplicationUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either Replication or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type replication_update_parameters:
         ~azure.mgmt.containerregistry.v2023_07_01.models.ReplicationUpdateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Replication or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_07_01.models.Replication]
