...
class CredentialSetsOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type credential_set_create_parameters:
         ~azure.mgmt.containerregistry.v2023_07_01.models.CredentialSet or IO
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type credential_set_update_parameters:
         ~azure.mgmt.containerregistry.v2023_07_01.models.CredentialSetUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
