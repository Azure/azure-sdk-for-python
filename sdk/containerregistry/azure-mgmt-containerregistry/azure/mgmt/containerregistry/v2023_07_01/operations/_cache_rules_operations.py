...
class CacheRulesOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.CacheRule"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2023_07_01.models.CacheRule]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2023_07_01.models.CacheRule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type cache_rule_create_parameters: ~azure.mgmt.containerregistry.v2023_07_01.models.CacheRule
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either CacheRule or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2023_07_01.models.CacheRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type cache_rule_update_parameters:
         ~azure.mgmt.containerregistry.v2023_07_01.models.CacheRuleUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either CacheRule or the result of cls(response)
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type cache_rule_update_parameters:
         ~azure.mgmt.containerregistry.v2023_07_01.models.CacheRuleUpdateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either CacheRule or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2023_07_01.models.CacheRule]
        :raises ~azure.core.exceptions.HttpResponseError:
