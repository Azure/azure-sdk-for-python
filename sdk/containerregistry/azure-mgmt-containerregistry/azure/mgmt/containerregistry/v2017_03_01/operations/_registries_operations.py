...
class RegistriesOperations:
    ...
    def check_name_availability(
        ...
        :type registry_name_check_request:
         ~azure.mgmt.containerregistry.v2017_03_01.models.RegistryNameCheckRequest or IO[bytes]
        :return: RegistryNameStatus or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2017_03_01.models.RegistryNameStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _create_initial(
        ...
        registry_name: str,
        registry_create_parameters: Union[_models.RegistryCreateParameters, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(registry_create_parameters, (IOBase, bytes)):
            _content = registry_create_parameters
        else:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2017_03_01.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        resource_group_name: str,
        registry_name: str,
        registry_create_parameters: IO[bytes],
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.Registry]:
        ...
        :type registry_name: str
        :param registry_create_parameters: The parameters for creating a container registry. Required.
        :type registry_create_parameters: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Registry or the result of cls(response)
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param registry_create_parameters: The parameters for creating a container registry. Is either
         a RegistryCreateParameters type or a IO[bytes] type. Required.
        :type registry_create_parameters:
         ~azure.mgmt.containerregistry.v2017_03_01.models.RegistryCreateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either Registry or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2017_03_01.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type registry_update_parameters:
         ~azure.mgmt.containerregistry.v2017_03_01.models.RegistryUpdateParameters or IO[bytes]
        :return: Registry or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2017_03_01.models.Registry
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Registry"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2017_03_01.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def regenerate_credential(
        ...
        **kwargs: Any
        ...
        :type regenerate_credential_parameters:
         ~azure.mgmt.containerregistry.v2017_03_01.models.RegenerateCredentialParameters or IO[bytes]
        :return: RegistryListCredentialsResult or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2017_03_01.models.RegistryListCredentialsResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
