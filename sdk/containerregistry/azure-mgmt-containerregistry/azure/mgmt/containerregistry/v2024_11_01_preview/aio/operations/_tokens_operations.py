...
class TokensOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> AsyncIterable["_models.Token"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2024_11_01_preview.models.Token]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2024_11_01_preview.models.Token]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
