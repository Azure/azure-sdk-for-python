...
class ImportPipelinesOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.ImportPipeline"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2024_11_01_preview.models.ImportPipeline]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2024_11_01_preview.models.ImportPipeline
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type import_pipeline_create_parameters:
         ~azure.mgmt.containerregistry.v2024_11_01_preview.models.ImportPipeline
        ...
        :return: An instance of LROPoller that returns either ImportPipeline or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2024_11_01_preview.models.ImportPipeline]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type import_pipeline_create_parameters:
         ~azure.mgmt.containerregistry.v2024_11_01_preview.models.ImportPipeline or IO[bytes]
        :return: An instance of LROPoller that returns either ImportPipeline or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2024_11_01_preview.models.ImportPipeline]
