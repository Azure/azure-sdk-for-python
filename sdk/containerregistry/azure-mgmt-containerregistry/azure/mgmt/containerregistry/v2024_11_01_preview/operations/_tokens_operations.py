...
class TokensOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerregistry.v2024_11_01_preview.ContainerRegistryManagementClient`'s
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.Token"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2024_11_01_preview.models.Token]
    ...
    def get(self, resource_group_name: str, registry_name: str, token_name: str, **kwargs: Any) -> _models.Token:
        ...
        :rtype: ~azure.mgmt.containerregistry.v2024_11_01_preview.models.Token
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type token_create_parameters: ~azure.mgmt.containerregistry.v2024_11_01_preview.models.Token
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Token or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2024_11_01_preview.models.Token]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type token_update_parameters:
         ~azure.mgmt.containerregistry.v2024_11_01_preview.models.TokenUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Token or the result of cls(response)
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type token_update_parameters:
         ~azure.mgmt.containerregistry.v2024_11_01_preview.models.TokenUpdateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either Token or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2024_11_01_preview.models.Token]
        :raises ~azure.core.exceptions.HttpResponseError:
