...
class TasksOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerregistry.v2019_04_01.ContainerRegistryManagementClient`'s
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.Task"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2019_04_01.models.Task]
    ...
    def _create_initial(
        ...
        registry_name: str,
        task_name: str,
        task_create_parameters: Union[_models.Task, IO],
        **kwargs: Any
    ) -> _models.Task:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(task_create_parameters, (IO, bytes)):
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type task_name: str
        :param task_create_parameters: The parameters for creating a task. Required.
        :type task_create_parameters: IO
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param task_create_parameters: The parameters for creating a task. Is either a model type or a
         IO type. Required.
        :type task_create_parameters: ~azure.mgmt.containerregistry.v2019_04_01.models.Task or IO
    ...
    def _update_initial(
        ...
        registry_name: str,
        task_name: str,
        task_update_parameters: Union[_models.TaskUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.Task:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(task_update_parameters, (IO, bytes)):
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type task_name: str
        :param task_update_parameters: The parameters for updating a task. Required.
        :type task_update_parameters: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param task_update_parameters: The parameters for updating a task. Is either a model type or a
         IO type. Required.
        :type task_update_parameters:
         ~azure.mgmt.containerregistry.v2019_04_01.models.TaskUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
