...
class RegistriesOperations:
    ...
    async def begin_import_image(
        ...
        **kwargs
        ...
        :param parameters: The parameters specifying the image to copy and the source container
         registry.
        :type parameters: ~azure.mgmt.containerregistry.v2019_04_01.models.ImportImageParameters
    ...
    async def check_name_availability(
        ...
        **kwargs
        ...
        :param registry_name_check_request: The object containing information for the availability
         request.
        :type registry_name_check_request: ~azure.mgmt.containerregistry.v2019_04_01.models.RegistryNameCheckRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: RegistryNameStatus, or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2019_04_01.models.RegistryNameStatus
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.containerregistry.v2019_04_01.models.Registry
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_create(
        ...
        **kwargs
        ...
        :type registry: ~azure.mgmt.containerregistry.v2019_04_01.models.Registry
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2019_04_01.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Registry"]
    ...
    async def begin_update(
        ...
        **kwargs
        ...
        :type registry_update_parameters: ~azure.mgmt.containerregistry.v2019_04_01.models.RegistryUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
    ...
    def list_by_resource_group(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2019_04_01.models.RegistryListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def list_credentials(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.containerregistry.v2019_04_01.models.RegistryListCredentialsResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def regenerate_credential(
        ...
        **kwargs
        ...
        :type regenerate_credential_parameters: ~azure.mgmt.containerregistry.v2019_04_01.models.RegenerateCredentialParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: RegistryListCredentialsResult, or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2019_04_01.models.RegistryListCredentialsResult
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    async def list_usages(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.containerregistry.v2019_04_01.models.RegistryUsageListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def list_policies(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.containerregistry.v2019_04_01.models.RegistryPolicies
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_update_policies(
        ...
        **kwargs
        ...
        :param registry_policies_update_parameters: The parameters for updating policies of a container
         registry.
        :type registry_policies_update_parameters: ~azure.mgmt.containerregistry.v2019_04_01.models.RegistryPolicies
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2019_04_01.models.RegistryPolicies]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.RegistryPolicies"]
    ...
    async def begin_schedule_run(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2019_04_01.models.Run]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
