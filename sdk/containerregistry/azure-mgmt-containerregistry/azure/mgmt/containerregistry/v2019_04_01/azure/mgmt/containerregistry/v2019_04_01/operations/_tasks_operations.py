...
class TasksOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2019_04_01.models.TaskListResult]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2019_04_01.models.Task]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
