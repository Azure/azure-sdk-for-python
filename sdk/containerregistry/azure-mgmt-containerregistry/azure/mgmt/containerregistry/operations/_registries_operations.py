...
def build_schedule_run_request(
    resource_group_name: str, registry_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class RegistriesOperations:  # pylint: disable=too-many-public-methods
    """
    .. warning::
        **DO NOT** instantiate this class directly.

        Instead, you should access the following operations through
        :class:`~azure.mgmt.containerregistry.ContainerRegistryManagementClient`'s
    ...
    def regenerate_credential(
        ...
        **kwargs: Any
        ...
        :type regenerate_credential_parameters:
         ~azure.mgmt.containerregistry.models.RegenerateCredentialParameters or IO[bytes]
        :return: RegistryListCredentialsResult or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.models.RegistryListCredentialsResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_build_source_upload_url(
        ...
        :rtype: ~azure.mgmt.containerregistry.models.SourceUploadDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def schedule_run(
        ...
        **kwargs: Any
        ...
        :param registry_name: The name of the container registry. Required.
        :type registry_name: str
        :param run_request: The request body. Required.
        :type run_request: ~azure.mgmt.containerregistry.models.RunRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Run or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.models.Run
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def schedule_run(
        ...
        **kwargs: Any
        ...
        :param registry_name: The name of the container registry. Required.
        :type registry_name: str
        :param run_request: The request body. Is either a RunRequest type or a IO[bytes] type.
         Required.
        :type run_request: ~azure.mgmt.containerregistry.models.RunRequest or IO[bytes]
        :return: Run or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.models.Run
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _json = None
        _content = None
        if isinstance(run_request, (IOBase, bytes)):
