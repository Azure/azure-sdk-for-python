...
class AgentPoolsOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> ItemPaged["_models.AgentPool"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.models.AgentPool]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.models.AgentPool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
