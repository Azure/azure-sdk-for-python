...
class TasksOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> ItemPaged["_models.Task"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.models.Task]
