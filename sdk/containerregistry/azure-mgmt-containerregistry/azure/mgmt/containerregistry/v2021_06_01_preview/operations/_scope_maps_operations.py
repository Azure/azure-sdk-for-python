...
class ScopeMapsOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type scope_map_create_parameters:
         ~azure.mgmt.containerregistry.v2021_06_01_preview.models.ScopeMap or IO[bytes]
        :return: An instance of LROPoller that returns either ScopeMap or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2021_06_01_preview.models.ScopeMap]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type scope_map_update_parameters:
         ~azure.mgmt.containerregistry.v2021_06_01_preview.models.ScopeMapUpdateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either ScopeMap or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2021_06_01_preview.models.ScopeMap]
        :raises ~azure.core.exceptions.HttpResponseError:
