...
class RegistriesOperations(object):
    ...
    def begin_import_image(
        ...
        **kwargs: Any
        ...
        :param parameters: The parameters specifying the image to copy and the source container
         registry.
        :type parameters:
         ~azure.mgmt.containerregistry.v2021_06_01_preview.models.ImportImageParameters
    ...
    def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type registry_name_check_request:
         ~azure.mgmt.containerregistry.v2021_06_01_preview.models.RegistryNameCheckRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: RegistryNameStatus, or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2021_06_01_preview.models.RegistryNameStatus
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.containerregistry.v2021_06_01_preview.models.Registry
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type registry: ~azure.mgmt.containerregistry.v2021_06_01_preview.models.Registry
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2021_06_01_preview.models.Registry]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
        polling = kwargs.pop('polling', True)  # type: Union[bool, azure.core.polling.PollingMethod]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type registry_update_parameters:
         ~azure.mgmt.containerregistry.v2021_06_01_preview.models.RegistryUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2021_06_01_preview.models.RegistryListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_credentials(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.containerregistry.v2021_06_01_preview.models.RegistryListCredentialsResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def regenerate_credential(
        ...
        **kwargs: Any
        ...
        :type regenerate_credential_parameters:
         ~azure.mgmt.containerregistry.v2021_06_01_preview.models.RegenerateCredentialParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: RegistryListCredentialsResult, or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2021_06_01_preview.models.RegistryListCredentialsResult
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_usages(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.containerregistry.v2021_06_01_preview.models.RegistryUsageListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_private_link_resources(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PrivateLinkResourceListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2021_06_01_preview.models.PrivateLinkResourceListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_generate_credentials(
        ...
        **kwargs: Any
        ...
        :type generate_credentials_parameters:
         ~azure.mgmt.containerregistry.v2021_06_01_preview.models.GenerateCredentialsParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
        ...
        :return: An instance of LROPoller that returns either GenerateCredentialsResult or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2021_06_01_preview.models.GenerateCredentialsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
        polling = kwargs.pop('polling', True)  # type: Union[bool, azure.core.polling.PollingMethod]
