...
class RegistriesOperations:
    ...
    def begin_import_image(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.containerregistry.v2021_06_01_preview.models.ImportImageParameters or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def check_name_availability(
        ...
        :type registry_name_check_request:
         ~azure.mgmt.containerregistry.v2021_06_01_preview.models.RegistryNameCheckRequest or IO[bytes]
        :return: RegistryNameStatus or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2021_06_01_preview.models.RegistryNameStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        :type registry: ~azure.mgmt.containerregistry.v2021_06_01_preview.models.Registry or IO[bytes]
        :return: An instance of LROPoller that returns either Registry or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2021_06_01_preview.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type registry_update_parameters:
         ~azure.mgmt.containerregistry.v2021_06_01_preview.models.RegistryUpdateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either Registry or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2021_06_01_preview.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Registry"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2021_06_01_preview.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def regenerate_credential(
        ...
        **kwargs: Any
        ...
        :type regenerate_credential_parameters:
         ~azure.mgmt.containerregistry.v2021_06_01_preview.models.RegenerateCredentialParameters or
         IO[bytes]
        :return: RegistryListCredentialsResult or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2021_06_01_preview.models.RegistryListCredentialsResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_private_link_resources(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2021_06_01_preview.models.PrivateLinkResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_generate_credentials(
        ...
        **kwargs: Any
        ...
        :type generate_credentials_parameters:
         ~azure.mgmt.containerregistry.v2021_06_01_preview.models.GenerateCredentialsParameters or
         IO[bytes]
        :return: An instance of LROPoller that returns either GenerateCredentialsResult or the result
         of cls(response)
        :rtype:
