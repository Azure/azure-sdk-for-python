...
class ReplicationsOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type replication: ~azure.mgmt.containerregistry.v2021_06_01_preview.models.Replication or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Replication or the result of
         cls(response)
        :rtype:
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type replication_update_parameters:
         ~azure.mgmt.containerregistry.v2021_06_01_preview.models.ReplicationUpdateParameters or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Replication or the result of
         cls(response)
        :rtype:
