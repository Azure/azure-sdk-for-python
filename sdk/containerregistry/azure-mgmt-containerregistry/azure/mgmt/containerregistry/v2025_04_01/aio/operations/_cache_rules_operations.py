...
class CacheRulesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerregistry.v2025_04_01.aio.ContainerRegistryManagementClient`'s
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> AsyncIterable["_models.CacheRule"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2025_04_01.models.CacheRule]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2025_04_01.models.CacheRule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type cache_rule_create_parameters: ~azure.mgmt.containerregistry.v2025_04_01.models.CacheRule
        ...
        :return: An instance of AsyncLROPoller that returns either CacheRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2025_04_01.models.CacheRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type cache_rule_update_parameters:
         ~azure.mgmt.containerregistry.v2025_04_01.models.CacheRuleUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either CacheRule or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type cache_rule_update_parameters:
         ~azure.mgmt.containerregistry.v2025_04_01.models.CacheRuleUpdateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either CacheRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2025_04_01.models.CacheRule]
