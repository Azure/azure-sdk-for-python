...
class ConnectedRegistriesOperations:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2025_04_01.models.ConnectedRegistry
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type connected_registry_create_parameters:
         ~azure.mgmt.containerregistry.v2025_04_01.models.ConnectedRegistry
        ...
        :return: An instance of LROPoller that returns either ConnectedRegistry or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2025_04_01.models.ConnectedRegistry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type connected_registry_create_parameters:
         ~azure.mgmt.containerregistry.v2025_04_01.models.ConnectedRegistry or IO[bytes]
        :return: An instance of LROPoller that returns either ConnectedRegistry or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2025_04_01.models.ConnectedRegistry]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type connected_registry_update_parameters:
         ~azure.mgmt.containerregistry.v2025_04_01.models.ConnectedRegistryUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either ConnectedRegistry or the result of
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type connected_registry_update_parameters:
         ~azure.mgmt.containerregistry.v2025_04_01.models.ConnectedRegistryUpdateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either ConnectedRegistry or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2025_04_01.models.ConnectedRegistry]
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2025_04_01.models.ConnectedRegistry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
