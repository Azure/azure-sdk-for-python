...
class ScopeMapsOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type scope_map_create_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.ScopeMap or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ScopeMap or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_11_01_preview.models.ScopeMap]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type scope_map_update_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.ScopeMapUpdateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ScopeMap or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_11_01_preview.models.ScopeMap]
