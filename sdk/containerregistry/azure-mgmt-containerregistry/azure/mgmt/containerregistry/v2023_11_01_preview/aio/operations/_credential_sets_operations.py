...
class CredentialSetsOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2023_11_01_preview.models.CredentialSet]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2023_11_01_preview.models.CredentialSet
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type credential_set_create_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.CredentialSet
        ...
        :return: An instance of AsyncLROPoller that returns either CredentialSet or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_11_01_preview.models.CredentialSet]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type credential_set_create_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.CredentialSet or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either CredentialSet or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_11_01_preview.models.CredentialSet]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type credential_set_update_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.CredentialSetUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either CredentialSet or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type credential_set_update_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.CredentialSetUpdateParameters or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either CredentialSet or the result of
         cls(response)
        :rtype:
