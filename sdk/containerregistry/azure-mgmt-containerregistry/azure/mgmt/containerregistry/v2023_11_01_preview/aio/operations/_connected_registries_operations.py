...
from ...operations._connected_registries_operations import (
...
class ConnectedRegistriesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerregistry.v2023_11_01_preview.aio.ContainerRegistryManagementClient`'s
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.ConnectedRegistry"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2023_11_01_preview.models.ConnectedRegistry]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2023_11_01_preview.models.ConnectedRegistry
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type connected_registry_create_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.ConnectedRegistry
        ...
        :return: An instance of AsyncLROPoller that returns either ConnectedRegistry or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_11_01_preview.models.ConnectedRegistry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type connected_registry_create_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.ConnectedRegistry or IO
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type connected_registry_update_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.ConnectedRegistryUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type connected_registry_update_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.ConnectedRegistryUpdateParameters or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
    ...
    async def _deactivate_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, registry_name: str, connected_registry_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_deactivate(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._deactivate_initial(  # type: ignore
                resource_group_name=resource_group_name,
                registry_name=registry_name,
                connected_registry_name=connected_registry_name,
                api_version=api_version,
