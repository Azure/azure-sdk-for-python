...
class CacheRulesOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type cache_rule_create_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.CacheRule or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either CacheRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_11_01_preview.models.CacheRule]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type cache_rule_update_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.CacheRuleUpdateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either CacheRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_11_01_preview.models.CacheRule]
