...
class ExportPipelinesOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.ExportPipeline"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2023_11_01_preview.models.ExportPipeline]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2023_11_01_preview.models.ExportPipeline
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type export_pipeline_create_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.ExportPipeline
        ...
        :return: An instance of LROPoller that returns either ExportPipeline or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2023_11_01_preview.models.ExportPipeline]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type export_pipeline_create_parameters:
         ~azure.mgmt.containerregistry.v2023_11_01_preview.models.ExportPipeline or IO
