...
class ScopeMapsOperations(object):
    ...
    def _create_initial(
        ...
        registry_name,  # type: str
        scope_map_name,  # type: str
        scope_map_create_parameters,  # type: "_models.ScopeMap"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ScopeMap"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ScopeMap"]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.ScopeMap"]
        ...
        :type scope_map_create_parameters: ~azure.mgmt.containerregistry.v2020_11_01_preview.models.ScopeMap
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2020_11_01_preview.models.ScopeMap]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        registry_name,  # type: str
        scope_map_name,  # type: str
        scope_map_update_parameters,  # type: "_models.ScopeMapUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ScopeMap"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ScopeMap"]
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        :type scope_map_update_parameters: ~azure.mgmt.containerregistry.v2020_11_01_preview.models.ScopeMapUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ScopeMapListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2020_11_01_preview.models.ScopeMapListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
