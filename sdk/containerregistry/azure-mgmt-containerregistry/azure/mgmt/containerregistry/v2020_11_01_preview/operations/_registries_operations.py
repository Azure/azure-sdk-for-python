...
class RegistriesOperations(object):
    ...
    def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type registry_name_check_request:
         ~azure.mgmt.containerregistry.v2020_11_01_preview.models.RegistryNameCheckRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2020_11_01_preview.models.Registry]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-01-preview")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2020_11_01_preview.models.RegistryListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-01-preview")  # type: str
    ...
    def regenerate_credential(
        ...
        **kwargs: Any
        ...
        :type regenerate_credential_parameters:
         ~azure.mgmt.containerregistry.v2020_11_01_preview.models.RegenerateCredentialParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: RegistryListCredentialsResult, or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2020_11_01_preview.models.RegistryListCredentialsResult
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_private_link_resources(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PrivateLinkResourceListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2020_11_01_preview.models.PrivateLinkResourceListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-01-preview")  # type: str
    ...
    def begin_generate_credentials(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either GenerateCredentialsResult or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2020_11_01_preview.models.GenerateCredentialsResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2020-11-01-preview")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
