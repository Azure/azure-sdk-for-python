...
class PipelineRunsOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type pipeline_run_create_parameters:
         ~azure.mgmt.containerregistry.v2020_11_01_preview.models.PipelineRun or IO
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.PipelineRun"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2020_11_01_preview.models.PipelineRun]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
