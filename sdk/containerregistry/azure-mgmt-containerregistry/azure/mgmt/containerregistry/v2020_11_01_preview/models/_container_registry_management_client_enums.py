...
class ActivationStatus(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class AuditLogStatus(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class ConnectedRegistryMode(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class TlsStatus(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class ZoneRedundancy(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
