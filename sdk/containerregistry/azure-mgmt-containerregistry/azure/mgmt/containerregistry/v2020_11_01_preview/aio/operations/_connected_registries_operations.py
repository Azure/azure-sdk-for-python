...
class ConnectedRegistriesOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type connected_registry_create_parameters:
         ~azure.mgmt.containerregistry.v2020_11_01_preview.models.ConnectedRegistry or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ConnectedRegistry or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2020_11_01_preview.models.ConnectedRegistry]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type connected_registry_update_parameters:
         ~azure.mgmt.containerregistry.v2020_11_01_preview.models.ConnectedRegistryUpdateParameters or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ConnectedRegistry or the result of
         cls(response)
        :rtype:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2020_11_01_preview.models.ConnectedRegistry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
