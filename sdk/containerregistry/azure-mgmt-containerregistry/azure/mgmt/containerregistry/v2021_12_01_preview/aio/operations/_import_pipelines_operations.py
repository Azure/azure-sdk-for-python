...
class ImportPipelinesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2021_12_01_preview.models.ImportPipeline]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type import_pipeline_create_parameters:
         ~azure.mgmt.containerregistry.v2021_12_01_preview.models.ImportPipeline or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ImportPipeline or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2021_12_01_preview.models.ImportPipeline]
