...
class RunsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerregistry.v2018_09_01.aio.ContainerRegistryManagementClient`'s
        :attr:`runs` attribute.
    """
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2018_09_01.models.Run]
    ...
    async def get(self, resource_group_name: str, registry_name: str, run_id: str, **kwargs: Any) -> _models.Run:
        ...
        :rtype: ~azure.mgmt.containerregistry.v2018_09_01.models.Run
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type run_update_parameters:
         ~azure.mgmt.containerregistry.v2018_09_01.models.RunUpdateParameters
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type run_update_parameters:
         ~azure.mgmt.containerregistry.v2018_09_01.models.RunUpdateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Run or the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2018_09_01.models.Run]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return AsyncLROPoller[_models.Run].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.Run](
    ...
    async def get_log_sas_url(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2018_09_01.models.RunGetLogResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
