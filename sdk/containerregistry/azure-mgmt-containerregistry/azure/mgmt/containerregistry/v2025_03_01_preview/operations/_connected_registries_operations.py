...
class ConnectedRegistriesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2025_03_01_preview.models.ConnectedRegistry]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2025_03_01_preview.models.ConnectedRegistry
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type connected_registry_create_parameters:
         ~azure.mgmt.containerregistry.v2025_03_01_preview.models.ConnectedRegistry
        ...
        :return: An instance of LROPoller that returns either ConnectedRegistry or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2025_03_01_preview.models.ConnectedRegistry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type connected_registry_create_parameters:
         ~azure.mgmt.containerregistry.v2025_03_01_preview.models.ConnectedRegistry or IO[bytes]
        :return: An instance of LROPoller that returns either ConnectedRegistry or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2025_03_01_preview.models.ConnectedRegistry]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type connected_registry_update_parameters:
         ~azure.mgmt.containerregistry.v2025_03_01_preview.models.ConnectedRegistryUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either ConnectedRegistry or the result of
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type connected_registry_update_parameters:
         ~azure.mgmt.containerregistry.v2025_03_01_preview.models.ConnectedRegistryUpdateParameters or
         IO[bytes]
        :return: An instance of LROPoller that returns either ConnectedRegistry or the result of
         cls(response)
        :rtype:
