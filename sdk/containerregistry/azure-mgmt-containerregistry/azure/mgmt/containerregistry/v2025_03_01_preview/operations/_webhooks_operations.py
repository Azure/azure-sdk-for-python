...
class WebhooksOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.Webhook"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2025_03_01_preview.models.Webhook]
    ...
    def get(self, resource_group_name: str, registry_name: str, webhook_name: str, **kwargs: Any) -> _models.Webhook:
        ...
        :rtype: ~azure.mgmt.containerregistry.v2025_03_01_preview.models.Webhook
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type webhook_create_parameters:
         ~azure.mgmt.containerregistry.v2025_03_01_preview.models.WebhookCreateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Webhook or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2025_03_01_preview.models.Webhook]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type webhook_create_parameters:
         ~azure.mgmt.containerregistry.v2025_03_01_preview.models.WebhookCreateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either Webhook or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2025_03_01_preview.models.Webhook]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type webhook_update_parameters:
         ~azure.mgmt.containerregistry.v2025_03_01_preview.models.WebhookUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Webhook or the result of cls(response)
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type webhook_update_parameters:
         ~azure.mgmt.containerregistry.v2025_03_01_preview.models.WebhookUpdateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either Webhook or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2025_03_01_preview.models.Webhook]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def ping(self, resource_group_name: str, registry_name: str, webhook_name: str, **kwargs: Any) -> _models.EventInfo:
        ...
        :rtype: ~azure.mgmt.containerregistry.v2025_03_01_preview.models.EventInfo
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_events(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2025_03_01_preview.models.Event]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get_callback_config(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2025_03_01_preview.models.CallbackConfig
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
