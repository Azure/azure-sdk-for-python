...
class ContainerRegistryManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype archives:
     azure.mgmt.containerregistry.v2025_03_01_preview.operations.ArchivesOperations
    :ivar archive_versions: ArchiveVersionsOperations operations
    :vartype archive_versions:
     azure.mgmt.containerregistry.v2025_03_01_preview.operations.ArchiveVersionsOperations
    :ivar cache_rules: CacheRulesOperations operations
    :vartype cache_rules:
     azure.mgmt.containerregistry.v2025_03_01_preview.operations.CacheRulesOperations
    :ivar connected_registries: ConnectedRegistriesOperations operations
    :vartype connected_registries:
     azure.mgmt.containerregistry.v2025_03_01_preview.operations.ConnectedRegistriesOperations
    :ivar credential_sets: CredentialSetsOperations operations
    :vartype credential_sets:
     azure.mgmt.containerregistry.v2025_03_01_preview.operations.CredentialSetsOperations
    :ivar export_pipelines: ExportPipelinesOperations operations
    :vartype export_pipelines:
     azure.mgmt.containerregistry.v2025_03_01_preview.operations.ExportPipelinesOperations
    :ivar registries: RegistriesOperations operations
    :vartype registries:
     azure.mgmt.containerregistry.v2025_03_01_preview.operations.RegistriesOperations
    :ivar import_pipelines: ImportPipelinesOperations operations
    :vartype import_pipelines:
     azure.mgmt.containerregistry.v2025_03_01_preview.operations.ImportPipelinesOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.containerregistry.v2025_03_01_preview.operations.Operations
    :ivar pipeline_runs: PipelineRunsOperations operations
    :vartype pipeline_runs:
     azure.mgmt.containerregistry.v2025_03_01_preview.operations.PipelineRunsOperations
    :ivar private_endpoint_connections: PrivateEndpointConnectionsOperations operations
    :vartype private_endpoint_connections:
     azure.mgmt.containerregistry.v2025_03_01_preview.operations.PrivateEndpointConnectionsOperations
    :ivar replications: ReplicationsOperations operations
    :vartype replications:
     azure.mgmt.containerregistry.v2025_03_01_preview.operations.ReplicationsOperations
    :ivar scope_maps: ScopeMapsOperations operations
    :vartype scope_maps:
     azure.mgmt.containerregistry.v2025_03_01_preview.operations.ScopeMapsOperations
    :ivar tokens: TokensOperations operations
    :vartype tokens: azure.mgmt.containerregistry.v2025_03_01_preview.operations.TokensOperations
    :ivar webhooks: WebhooksOperations operations
    :vartype webhooks:
     azure.mgmt.containerregistry.v2025_03_01_preview.operations.WebhooksOperations
    :ivar agent_pools: AgentPoolsOperations operations
    :vartype agent_pools:
     azure.mgmt.containerregistry.v2025_03_01_preview.operations.AgentPoolsOperations
    :ivar runs: RunsOperations operations
    :vartype runs: azure.mgmt.containerregistry.v2025_03_01_preview.operations.RunsOperations
    :ivar task_runs: TaskRunsOperations operations
    :vartype task_runs:
     azure.mgmt.containerregistry.v2025_03_01_preview.operations.TaskRunsOperations
    :ivar tasks: TasksOperations operations
    :vartype tasks: azure.mgmt.containerregistry.v2025_03_01_preview.operations.TasksOperations
    ...
    def __init__(
        ...
        self.archives = ArchivesOperations(
            self._client, self._config, self._serialize, self._deserialize, "2025-03-01-preview"
        )
        ...
        self.runs = RunsOperations(self._client, self._config, self._serialize, self._deserialize, "2025-03-01-preview")
