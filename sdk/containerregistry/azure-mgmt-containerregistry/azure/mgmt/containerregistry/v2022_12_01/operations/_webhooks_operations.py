...
class WebhooksOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type webhook_create_parameters:
         ~azure.mgmt.containerregistry.v2022_12_01.models.WebhookCreateParameters or IO
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param webhook_update_parameters: The parameters for updating a webhook. Is either a model type
         or a IO type. Required.
        :type webhook_update_parameters:
         ~azure.mgmt.containerregistry.v2022_12_01.models.WebhookUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
