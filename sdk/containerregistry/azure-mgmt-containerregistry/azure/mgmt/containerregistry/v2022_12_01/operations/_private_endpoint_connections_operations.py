...
class PrivateEndpointConnectionsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either PrivateEndpointConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2022_12_01.models.PrivateEndpointConnection]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2022_12_01.models.PrivateEndpointConnection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type private_endpoint_connection:
         ~azure.mgmt.containerregistry.v2022_12_01.models.PrivateEndpointConnection
        ...
        :return: An instance of LROPoller that returns either PrivateEndpointConnection or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2022_12_01.models.PrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type private_endpoint_connection:
         ~azure.mgmt.containerregistry.v2022_12_01.models.PrivateEndpointConnection or IO[bytes]
        :return: An instance of LROPoller that returns either PrivateEndpointConnection or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2022_12_01.models.PrivateEndpointConnection]
