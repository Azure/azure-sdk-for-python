...
class ReplicationsOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.Replication"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2022_12_01.models.Replication]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2022_12_01.models.Replication
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type replication: ~azure.mgmt.containerregistry.v2022_12_01.models.Replication
        ...
        :return: An instance of LROPoller that returns either Replication or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2022_12_01.models.Replication]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type replication: ~azure.mgmt.containerregistry.v2022_12_01.models.Replication or IO[bytes]
        :return: An instance of LROPoller that returns either Replication or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2022_12_01.models.Replication]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type replication_update_parameters:
         ~azure.mgmt.containerregistry.v2022_12_01.models.ReplicationUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Replication or the result of
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type replication_update_parameters:
         ~azure.mgmt.containerregistry.v2022_12_01.models.ReplicationUpdateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either Replication or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2022_12_01.models.Replication]
