...
from .operations import AgentPoolsOperations, RegistriesOperations, RunsOperations, TaskRunsOperations, TasksOperations
...
class ContainerRegistryManagementClient:
    ...
    :vartype agent_pools:
     azure.mgmt.containerregistry.v2019_06_01_preview.operations.AgentPoolsOperations
    :ivar registries: RegistriesOperations operations
    :vartype registries:
     azure.mgmt.containerregistry.v2019_06_01_preview.operations.RegistriesOperations
    ...
    :vartype task_runs:
     azure.mgmt.containerregistry.v2019_06_01_preview.operations.TaskRunsOperations
    ...
    def __init__(
        ...
        self.agent_pools = AgentPoolsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2019-06-01-preview"
        )
        self.registries = RegistriesOperations(
            self._client, self._config, self._serialize, self._deserialize, "2019-06-01-preview"
        )
        self.runs = RunsOperations(self._client, self._config, self._serialize, self._deserialize, "2019-06-01-preview")
