...
from ...operations._agent_pools_operations import build_create_request_initial, build_delete_request_initial, build_get_queue_status_request, build_get_request, build_list_request, build_update_request_initial
T = TypeVar('T')
...
class AgentPoolsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2019_06_01_preview.models.AgentPoolListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2019-06-01-preview")  # type: str
