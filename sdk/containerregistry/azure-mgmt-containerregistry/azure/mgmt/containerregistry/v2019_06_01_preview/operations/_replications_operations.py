...
class ReplicationsOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.containerregistry.v2019_06_01_preview.models.Replication
    ...
    def _create_initial(
        ...
        registry_name,  # type: str
        replication_name,  # type: str
        replication,  # type: "models.Replication"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Replication"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Replication"]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.Replication"]
        ...
        :type replication: ~azure.mgmt.containerregistry.v2019_06_01_preview.models.Replication
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2019_06_01_preview.models.Replication]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        registry_name,  # type: str
        replication_name,  # type: str
        replication_update_parameters,  # type: "models.ReplicationUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Replication"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Replication"]
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        :type replication_update_parameters: ~azure.mgmt.containerregistry.v2019_06_01_preview.models.ReplicationUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2019_06_01_preview.models.ReplicationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
