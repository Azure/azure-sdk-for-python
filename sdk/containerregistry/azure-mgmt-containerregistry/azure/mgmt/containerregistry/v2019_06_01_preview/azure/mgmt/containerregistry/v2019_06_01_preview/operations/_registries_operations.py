...
class RegistriesOperations(object):
    ...
    def begin_import_image(
        ...
        **kwargs  # type: Any
        ...
        :param parameters: The parameters specifying the image to copy and the source container
         registry.
        :type parameters: ~azure.mgmt.containerregistry.v2019_06_01_preview.models.ImportImageParameters
    ...
    def check_name_availability(
        ...
        **kwargs  # type: Any
        ...
        :param registry_name_check_request: The object containing information for the availability
         request.
        :type registry_name_check_request: ~azure.mgmt.containerregistry.v2019_06_01_preview.models.RegistryNameCheckRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: RegistryNameStatus, or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2019_06_01_preview.models.RegistryNameStatus
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.containerregistry.v2019_06_01_preview.models.Registry
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :type registry: ~azure.mgmt.containerregistry.v2019_06_01_preview.models.Registry
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2019_06_01_preview.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', False)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Registry"]
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        :type registry_update_parameters: ~azure.mgmt.containerregistry.v2019_06_01_preview.models.RegistryUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2019_06_01_preview.models.RegistryListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_credentials(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.containerregistry.v2019_06_01_preview.models.RegistryListCredentialsResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def regenerate_credential(
        ...
        **kwargs  # type: Any
        ...
        :type regenerate_credential_parameters: ~azure.mgmt.containerregistry.v2019_06_01_preview.models.RegenerateCredentialParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: RegistryListCredentialsResult, or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2019_06_01_preview.models.RegistryListCredentialsResult
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_usages(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.containerregistry.v2019_06_01_preview.models.RegistryUsageListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_generate_credentials(
        ...
        **kwargs  # type: Any
        ...
        :type generate_credentials_parameters: ~azure.mgmt.containerregistry.v2019_06_01_preview.models.GenerateCredentialsParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2019_06_01_preview.models.GenerateCredentialsResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', False)  # type: Union[bool, PollingMethod]
