...
def build_get_request(
    resource_group_name: str, registry_name: str, build_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class BuildsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2018_02_01_preview.models.Build]
    ...
    @distributed_trace
    def get(self, resource_group_name: str, registry_name: str, build_id: str, **kwargs: Any) -> _models.Build:
