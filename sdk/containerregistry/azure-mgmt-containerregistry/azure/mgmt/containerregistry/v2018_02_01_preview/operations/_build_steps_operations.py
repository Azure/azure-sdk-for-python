...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "stepName": _SERIALIZER.url(
            "step_name", step_name, "str", max_length=50, min_length=5, pattern=r"^[a-zA-Z0-9]*$"
        ),
    }
...
class BuildStepsOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2018_02_01_preview.models.BuildStep]
    ...
    def list_build_arguments(
        self, resource_group_name: str, registry_name: str, build_task_name: str, step_name: str, **kwargs: Any
    ) -> Iterable["_models.BuildArgument"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2018_02_01_preview.models.BuildArgument]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
