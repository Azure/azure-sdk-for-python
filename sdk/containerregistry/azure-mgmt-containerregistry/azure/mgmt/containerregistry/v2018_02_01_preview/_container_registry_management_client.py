...
class ContainerRegistryManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype build_steps:
     azure.mgmt.containerregistry.v2018_02_01_preview.operations.BuildStepsOperations
    :ivar build_tasks: BuildTasksOperations operations
    :vartype build_tasks:
     azure.mgmt.containerregistry.v2018_02_01_preview.operations.BuildTasksOperations
    :ivar registries: RegistriesOperations operations
    :vartype registries:
     azure.mgmt.containerregistry.v2018_02_01_preview.operations.RegistriesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.builds = BuildsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2018-02-01-preview"
        )
