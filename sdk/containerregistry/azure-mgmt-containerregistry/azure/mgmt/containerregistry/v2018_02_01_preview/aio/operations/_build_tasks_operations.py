...
from ...operations._build_tasks_operations import (
    build_create_request,
    build_delete_request,
    build_get_request,
    build_list_request,
    build_list_source_repository_properties_request,
...
class BuildTasksOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.BuildTask"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2018_02_01_preview.models.BuildTask]
    ...
    async def _create_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(build_task_create_parameters, (IO, bytes)):
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(build_task_update_parameters, (IO, bytes)):
