...
from ...operations._build_steps_operations import (
    build_create_request,
    build_delete_request,
    build_get_request,
    build_list_build_arguments_request,
    build_list_request,
...
class BuildStepsOperations:
    ...
    ) -> AsyncIterable["_models.BuildStep"]:
    ...
    async def get(
        self, resource_group_name: str, registry_name: str, build_task_name: str, step_name: str, **kwargs: Any
    ) -> _models.BuildStep:
    ...
    async def _create_initial(
        ...
        build_task_name: str,
        step_name: str,
        build_step_create_parameters: Union[_models.BuildStep, IO],
        **kwargs: Any
    ) -> _models.BuildStep:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(build_step_create_parameters, (IO, bytes)):
    ...
    async def begin_create(
        ...
        build_task_name: str,
        step_name: str,
        build_step_create_parameters: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.BuildStep]:
    ...
    async def _update_initial(
        ...
        build_task_name: str,
        step_name: str,
        build_step_update_parameters: Union[_models.BuildStepUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.BuildStep:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(build_step_update_parameters, (IO, bytes)):
    ...
    async def begin_update(
        ...
        build_task_name: str,
        step_name: str,
        build_step_update_parameters: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.BuildStep]:
    ...
    def list_build_arguments(
        self, resource_group_name: str, registry_name: str, build_task_name: str, step_name: str, **kwargs: Any
    ) -> AsyncIterable["_models.BuildArgument"]:
