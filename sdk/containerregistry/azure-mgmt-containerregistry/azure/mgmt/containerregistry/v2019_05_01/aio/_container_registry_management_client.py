...
class ContainerRegistryManagementClient:
    ...
    :vartype registries:
     azure.mgmt.containerregistry.v2019_05_01.aio.operations.RegistriesOperations
    ...
    :vartype replications:
     azure.mgmt.containerregistry.v2019_05_01.aio.operations.ReplicationsOperations
    ...
    def __init__(
        ...
        self.webhooks = WebhooksOperations(self._client, self._config, self._serialize, self._deserialize, "2019-05-01")
