...
class ReplicationsOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param replication: The parameters for creating a replication. Is either a Replication type or
         a IO type. Required.
        :type replication: ~azure.mgmt.containerregistry.v2019_05_01.models.Replication or IO
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type replication_update_parameters:
         ~azure.mgmt.containerregistry.v2019_05_01.models.ReplicationUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
