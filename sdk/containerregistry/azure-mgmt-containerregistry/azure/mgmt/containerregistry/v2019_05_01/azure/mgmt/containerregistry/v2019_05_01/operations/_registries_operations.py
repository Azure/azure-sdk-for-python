...
class RegistriesOperations(object):
    ...
    def check_name_availability(
        ...
        **kwargs  # type: Any
        ...
        :param registry_name_check_request: The object containing information for the availability
         request.
        :type registry_name_check_request: ~azure.mgmt.containerregistry.v2019_05_01.models.RegistryNameCheckRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2019_05_01.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', False)  # type: Union[bool, PollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Registry"]
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        :type registry_update_parameters: ~azure.mgmt.containerregistry.v2019_05_01.models.RegistryUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2019_05_01.models.RegistryListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def regenerate_credential(
        ...
        **kwargs  # type: Any
        ...
        :type regenerate_credential_parameters: ~azure.mgmt.containerregistry.v2019_05_01.models.RegenerateCredentialParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: RegistryListCredentialsResult, or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2019_05_01.models.RegistryListCredentialsResult
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def begin_schedule_run(
        ...
        **kwargs  # type: Any
        ...
        :type run_request: ~azure.mgmt.containerregistry.v2019_05_01.models.RunRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
    ...
    def get_build_source_upload_url(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.containerregistry.v2019_05_01.models.SourceUploadDefinition
        :raises: ~azure.core.exceptions.HttpResponseError
        """
