...
class EventListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.containerregistry.v2017_10_01.models.Event]
...
class EventRequestMessage(msrest.serialization.Model):
    ...
    :type content: ~azure.mgmt.containerregistry.v2017_10_01.models.EventContent
...
class ImportImageParameters(msrest.serialization.Model):
    ...
    :type source: ~azure.mgmt.containerregistry.v2017_10_01.models.ImportSource
    ...
    :type mode: str or ~azure.mgmt.containerregistry.v2017_10_01.models.ImportMode
    """
...
class ImportSource(msrest.serialization.Model):
    ...
    :type credentials: ~azure.mgmt.containerregistry.v2017_10_01.models.ImportSourceCredentials
...
class IPRule(msrest.serialization.Model):
    ...
    :type action: str or ~azure.mgmt.containerregistry.v2017_10_01.models.Action
...
class NetworkRuleSet(msrest.serialization.Model):
    ...
    :type default_action: str or ~azure.mgmt.containerregistry.v2017_10_01.models.DefaultAction
    ...
    :type ip_rules: list[~azure.mgmt.containerregistry.v2017_10_01.models.IPRule]
    """
...
class OperationDefinition(msrest.serialization.Model):
    ...
    :type display: ~azure.mgmt.containerregistry.v2017_10_01.models.OperationDisplayDefinition
...
class OperationListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.containerregistry.v2017_10_01.models.OperationDefinition]
...
class QuarantinePolicy(msrest.serialization.Model):
    ...
    :type status: str or ~azure.mgmt.containerregistry.v2017_10_01.models.PolicyStatus
    """
...
class RegenerateCredentialParameters(msrest.serialization.Model):
    ...
    :type name: str or ~azure.mgmt.containerregistry.v2017_10_01.models.PasswordName
    """
...
class Registry(Resource):
    ...
    :type network_rule_set: ~azure.mgmt.containerregistry.v2017_10_01.models.NetworkRuleSet
    """
...
class RegistryListCredentialsResult(msrest.serialization.Model):
    ...
    :type passwords: list[~azure.mgmt.containerregistry.v2017_10_01.models.RegistryPassword]
    """
...
class RegistryListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.containerregistry.v2017_10_01.models.Registry]
...
class RegistryPolicies(msrest.serialization.Model):
    ...
    :type quarantine_policy: ~azure.mgmt.containerregistry.v2017_10_01.models.QuarantinePolicy
    :param trust_policy: An object that represents content trust policy for a container registry.
    :type trust_policy: ~azure.mgmt.containerregistry.v2017_10_01.models.TrustPolicy
    """
...
class RegistryUsage(msrest.serialization.Model):
    ...
    :type unit: str or ~azure.mgmt.containerregistry.v2017_10_01.models.RegistryUsageUnit
    """
...
class RegistryUsageListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.containerregistry.v2017_10_01.models.RegistryUsage]
    """
...
class ReplicationListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.containerregistry.v2017_10_01.models.Replication]
...
class Sku(msrest.serialization.Model):
    ...
    :type name: str or ~azure.mgmt.containerregistry.v2017_10_01.models.SkuName
...
class TrustPolicy(msrest.serialization.Model):
    ...
    :type type: str or ~azure.mgmt.containerregistry.v2017_10_01.models.TrustPolicyType
    :param status: The value that indicates whether the policy is enabled or not. Possible values
     include: "enabled", "disabled".
    :type status: str or ~azure.mgmt.containerregistry.v2017_10_01.models.PolicyStatus
    """
...
class Webhook(Resource):
    ...
    :param status: The status of the webhook at the time the operation was called. Possible values
     include: "enabled", "disabled".
    :type status: str or ~azure.mgmt.containerregistry.v2017_10_01.models.WebhookStatus
    ...
    :type actions: list[str or ~azure.mgmt.containerregistry.v2017_10_01.models.WebhookAction]
...
class WebhookListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.containerregistry.v2017_10_01.models.Webhook]
