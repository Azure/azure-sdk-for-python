...
class ContainerRegistryManagementClient(object):
    ...
    :vartype registries: azure.mgmt.containerregistry.v2017_10_01.aio.operations_async.RegistriesOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.containerregistry.v2017_10_01.aio.operations_async.Operations
    :ivar replications: ReplicationsOperations operations
    :vartype replications: azure.mgmt.containerregistry.v2017_10_01.aio.operations_async.ReplicationsOperations
    :ivar webhooks: WebhooksOperations operations
    :vartype webhooks: azure.mgmt.containerregistry.v2017_10_01.aio.operations_async.WebhooksOperations
