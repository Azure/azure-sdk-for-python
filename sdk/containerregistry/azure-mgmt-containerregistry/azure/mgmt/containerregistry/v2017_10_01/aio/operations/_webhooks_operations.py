...
class WebhooksOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type webhook_create_parameters:
         ~azure.mgmt.containerregistry.v2017_10_01.models.WebhookCreateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Webhook or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2017_10_01.models.Webhook]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type webhook_update_parameters:
         ~azure.mgmt.containerregistry.v2017_10_01.models.WebhookUpdateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Webhook or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2017_10_01.models.Webhook]
