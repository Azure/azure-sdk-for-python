...
def build_import_image_request(
    ...
    api_version: Literal["2017-10-01"] = kwargs.pop("api_version", _params.pop("api-version", "2017-10-01"))
...
class RegistriesOperations:
    ...
    def begin_import_image(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerregistry.v2017_10_01.models.ImportImageParameters or IO
    ...
    def check_name_availability(
        ...
        :type registry_name_check_request:
         ~azure.mgmt.containerregistry.v2017_10_01.models.RegistryNameCheckRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_create(
        ...
        :param registry: The parameters for creating a container registry. Is either a Registry type or
         a IO type. Required.
        :type registry: ~azure.mgmt.containerregistry.v2017_10_01.models.Registry or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type registry_update_parameters:
         ~azure.mgmt.containerregistry.v2017_10_01.models.RegistryUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def regenerate_credential(
        ...
        **kwargs: Any
        ...
        :param regenerate_credential_parameters: Specifies name of the password which should be
         ...
         type. Required.
        :type regenerate_credential_parameters:
         ~azure.mgmt.containerregistry.v2017_10_01.models.RegenerateCredentialParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def _update_policies_initial(
        ...
        resource_group_name: str,
        registry_name: str,
        registry_policies_update_parameters: Union[_models.RegistryPolicies, IO],
        **kwargs: Any
        ...
        api_version: Literal["2017-10-01"] = kwargs.pop("api_version", _params.pop("api-version", "2017-10-01"))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.RegistryPolicies]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json"
        _json = None
        _content = None
        if isinstance(registry_policies_update_parameters, (IO, bytes)):
        ...
        request = build_update_policies_request(
            resource_group_name=resource_group_name,
            registry_name=registry_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    _update_policies_initial.metadata = {
    ...
    def begin_update_policies(
        ...
        resource_group_name: str,
        registry_name: str,
        registry_policies_update_parameters: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.RegistryPolicies]:
        ...
        :param registry_policies_update_parameters: The parameters for updating policies of a container
         registry. Required.
        :type registry_policies_update_parameters: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update_policies(
        ...
        **kwargs: Any
        ...
        :type registry_name: str
        :param registry_policies_update_parameters: The parameters for updating policies of a container
         registry. Is either a RegistryPolicies type or a IO type. Required.
        :type registry_policies_update_parameters:
         ~azure.mgmt.containerregistry.v2017_10_01.models.RegistryPolicies or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    begin_update_policies.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/updatePolicies"
    }
