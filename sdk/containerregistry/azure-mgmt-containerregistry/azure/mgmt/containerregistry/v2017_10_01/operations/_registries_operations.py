...
class RegistriesOperations(object):
    ...
    def list_by_resource_group(
        ...
        if raw:
            header_dict = {}
        deserialized = models.RegistryPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def list_policies(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2017_10_01.models.RegistryPolicies or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
