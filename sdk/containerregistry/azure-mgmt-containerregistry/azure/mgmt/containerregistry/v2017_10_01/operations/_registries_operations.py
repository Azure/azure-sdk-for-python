...
def build_update_policies_request(
    resource_group_name: str, registry_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class RegistriesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerregistry.v2017_10_01.ContainerRegistryManagementClient`'s
    ...
    def begin_import_image(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerregistry.v2017_10_01.models.ImportImageParameters or
         IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def check_name_availability(
        ...
        :type registry_name_check_request:
         ~azure.mgmt.containerregistry.v2017_10_01.models.RegistryNameCheckRequest or IO[bytes]
        :return: RegistryNameStatus or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2017_10_01.models.RegistryNameStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        :type registry: ~azure.mgmt.containerregistry.v2017_10_01.models.Registry or IO[bytes]
        :return: An instance of LROPoller that returns either Registry or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2017_10_01.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type registry_update_parameters:
         ~azure.mgmt.containerregistry.v2017_10_01.models.RegistryUpdateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either Registry or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2017_10_01.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Registry"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2017_10_01.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def regenerate_credential(
        ...
        **kwargs: Any
        ...
        :type regenerate_credential_parameters:
         ~azure.mgmt.containerregistry.v2017_10_01.models.RegenerateCredentialParameters or IO[bytes]
        :return: RegistryListCredentialsResult or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2017_10_01.models.RegistryListCredentialsResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def list_policies(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> _models.RegistryPolicies:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._api_version or "2017-10-01"))
        cls: ClsType[_models.RegistryPolicies] = kwargs.pop("cls", None)

        _request = build_list_policies_request(
            resource_group_name=resource_group_name,
            registry_name=registry_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
        ...
        deserialized = self._deserialize("RegistryPolicies", pipeline_response.http_response)
    ...
    def _update_policies_initial(
        ...
        resource_group_name: str,
        registry_name: str,
        registry_policies_update_parameters: Union[_models.RegistryPolicies, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(registry_policies_update_parameters, (IOBase, bytes)):
            _content = registry_policies_update_parameters
        else:
            _json = self._serialize.body(registry_policies_update_parameters, "RegistryPolicies")

        _request = build_update_policies_request(
            resource_group_name=resource_group_name,
            registry_name=registry_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_update_policies(
        ...
        resource_group_name: str,
        registry_name: str,
        registry_policies_update_parameters: IO[bytes],
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.RegistryPolicies]:
        ...
        :param registry_policies_update_parameters: The parameters for updating policies of a container
         registry. Required.
        :type registry_policies_update_parameters: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either RegistryPolicies or the result of
    ...
    def begin_update_policies(
        ...
        **kwargs: Any
        ...
        :type registry_name: str
        :param registry_policies_update_parameters: The parameters for updating policies of a container
         registry. Is either a RegistryPolicies type or a IO[bytes] type. Required.
        :type registry_policies_update_parameters:
         ~azure.mgmt.containerregistry.v2017_10_01.models.RegistryPolicies or IO[bytes]
        :return: An instance of LROPoller that returns either RegistryPolicies or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2017_10_01.models.RegistryPolicies]
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.RegistryPolicies].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.RegistryPolicies](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
