...
class ArchivesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2023_06_06_preview.models.Archive]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2023_06_06_preview.models.Archive
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Archive or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_06_06_preview.models.Archive]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type archive_create_parameters:
         ~azure.mgmt.containerregistry.v2023_06_06_preview.models.Archive or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Archive or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_06_06_preview.models.Archive]
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type archive_update_parameters:
         ~azure.mgmt.containerregistry.v2023_06_06_preview.models.ArchiveUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Archive or the result of cls(response)
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type archive_update_parameters:
         ~azure.mgmt.containerregistry.v2023_06_06_preview.models.ArchiveUpdateParameters or IO[bytes]
        :return: Archive or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2023_06_06_preview.models.Archive
        :raises ~azure.core.exceptions.HttpResponseError:
        """
