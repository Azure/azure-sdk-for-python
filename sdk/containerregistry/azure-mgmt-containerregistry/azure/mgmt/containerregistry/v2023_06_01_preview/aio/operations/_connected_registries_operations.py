...
class ConnectedRegistriesOperations:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2023_06_06_preview.models.ConnectedRegistry]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2023_06_06_preview.models.ConnectedRegistry
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type connected_registry_create_parameters:
         ~azure.mgmt.containerregistry.v2023_06_06_preview.models.ConnectedRegistry
        ...
        :return: An instance of AsyncLROPoller that returns either ConnectedRegistry or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_06_06_preview.models.ConnectedRegistry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type connected_registry_create_parameters:
         ~azure.mgmt.containerregistry.v2023_06_06_preview.models.ConnectedRegistry or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ConnectedRegistry or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2023_06_06_preview.models.ConnectedRegistry]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type connected_registry_update_parameters:
         ~azure.mgmt.containerregistry.v2023_06_06_preview.models.ConnectedRegistryUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either ConnectedRegistry or the result of
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type connected_registry_update_parameters:
         ~azure.mgmt.containerregistry.v2023_06_06_preview.models.ConnectedRegistryUpdateParameters or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ConnectedRegistry or the result of
         cls(response)
        :rtype:
