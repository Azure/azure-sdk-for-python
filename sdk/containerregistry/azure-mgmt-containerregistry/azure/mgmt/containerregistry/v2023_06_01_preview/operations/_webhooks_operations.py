...
class WebhooksOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type webhook_create_parameters:
         ~azure.mgmt.containerregistry.v2023_06_06_preview.models.WebhookCreateParameters or IO
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type webhook_update_parameters:
         ~azure.mgmt.containerregistry.v2023_06_06_preview.models.WebhookUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
