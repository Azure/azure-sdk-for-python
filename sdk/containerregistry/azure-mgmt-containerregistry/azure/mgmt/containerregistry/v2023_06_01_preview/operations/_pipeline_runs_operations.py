...
class PipelineRunsOperations:
    ...
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.PipelineRun"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2023_06_06_preview.models.PipelineRun]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2023_06_06_preview.models.PipelineRun
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type pipeline_run_create_parameters:
         ~azure.mgmt.containerregistry.v2023_06_06_preview.models.PipelineRun
        ...
        :return: An instance of LROPoller that returns either PipelineRun or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2023_06_06_preview.models.PipelineRun]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type pipeline_run_create_parameters:
         ~azure.mgmt.containerregistry.v2023_06_06_preview.models.PipelineRun or IO[bytes]
        :return: An instance of LROPoller that returns either PipelineRun or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2023_06_06_preview.models.PipelineRun]
