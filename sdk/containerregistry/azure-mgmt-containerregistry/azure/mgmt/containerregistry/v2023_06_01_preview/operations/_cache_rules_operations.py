...
class CacheRulesOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.CacheRule"]:
        ...
        :return: An iterator like instance of either CacheRule or the result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2023_06_06_preview.models.CacheRule]
        ...
        cls: ClsType[_models.CacheRulesListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("CacheRulesListResult", pipeline_response)
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/cacheRules"
    }
    ...
    def get(
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CacheRule or the result of cls(response)
        :rtype: ~azure.mgmt.containerregistry.v2023_06_06_preview.models.CacheRule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("CacheRule", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/cacheRules/{cacheRuleName}"
    }
    ...
    def _create_initial(
        ...
        registry_name: str,
        cache_rule_name: str,
        cache_rule_create_parameters: Union[_models.CacheRule, IO],
        **kwargs: Any
    ) -> _models.CacheRule:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type cache_rule_create_parameters:
         ~azure.mgmt.containerregistry.v2023_06_06_preview.models.CacheRule
        ...
        :return: An instance of LROPoller that returns either CacheRule or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2023_06_06_preview.models.CacheRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type cache_rule_create_parameters:
         ~azure.mgmt.containerregistry.v2023_06_06_preview.models.CacheRule or IO
    ...
    def _update_initial(
        ...
        registry_name: str,
        cache_rule_name: str,
        cache_rule_update_parameters: Union[_models.CacheRuleUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.CacheRule:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type cache_rule_update_parameters:
         ~azure.mgmt.containerregistry.v2023_06_06_preview.models.CacheRuleUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type cache_rule_update_parameters:
         ~azure.mgmt.containerregistry.v2023_06_06_preview.models.CacheRuleUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
