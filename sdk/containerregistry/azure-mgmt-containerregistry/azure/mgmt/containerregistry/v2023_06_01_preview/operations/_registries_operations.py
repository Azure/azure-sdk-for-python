...
class RegistriesOperations:
    ...
    def list(self, **kwargs: Any) -> Iterable["_models.Registry"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2023_06_06_preview.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2023_06_06_preview.models.Registry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_private_link_resources(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2023_06_06_preview.models.PrivateLinkResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_generate_credentials(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either GenerateCredentialsResult or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.containerregistry.v2023_06_06_preview.models.GenerateCredentialsResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
