...
def build_get_request(
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2019-12-01-preview"))
...
class ExportPipelinesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.containerregistry.v2019_12_01_preview.ContainerRegistryManagementClient`'s
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/exportPipelines/{exportPipelineName}"
    }
    ...
    def _create_initial(
        ...
        export_pipeline_create_parameters: Union[_models.ExportPipeline, IO],
        **kwargs: Any
    ) -> _models.ExportPipeline:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type export_pipeline_create_parameters:
         ~azure.mgmt.containerregistry.v2019_12_01_preview.models.ExportPipeline or IO
    ...
    @distributed_trace
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> Iterable["_models.ExportPipeline"]:
        ...
        :type registry_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ExportPipeline or the result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.containerregistry.v2019_12_01_preview.models.ExportPipeline]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        cls: ClsType[_models.ExportPipelineListResult] = kwargs.pop("cls", None)
