...
class ImportPipelinesOperations:
    ...
    async def _create_initial(
        ...
        **kwargs
        ...
        body_content = self._serialize.body(import_pipeline_create_parameters, 'ImportPipeline')
    ...
    async def begin_create(
        ...
        import_pipeline_create_parameters: "models.ImportPipeline",
        **kwargs
    ) -> AsyncLROPoller["models.ImportPipeline"]:
        ...
        :return: An instance of AsyncLROPoller that returns either ImportPipeline or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.containerregistry.v2019_12_01_preview.models.ImportPipeline]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        registry_name: str,
        **kwargs
    ) -> AsyncIterable["models.ImportPipelineListResult"]:
        ...
        :type registry_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ImportPipelineListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerregistry.v2019_12_01_preview.models.ImportPipelineListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
