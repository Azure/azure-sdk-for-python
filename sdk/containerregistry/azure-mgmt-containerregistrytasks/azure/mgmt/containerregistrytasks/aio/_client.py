...
class ContainerRegistryTasksMgmtClient:
    ...
    :vartype agent_pools: azure.mgmt.containerregistrytasks.aio.operations.AgentPoolsOperations
    :ivar runs: RunsOperations operations
    :vartype runs: azure.mgmt.containerregistrytasks.aio.operations.RunsOperations
    :ivar task_runs: TaskRunsOperations operations
    :vartype task_runs: azure.mgmt.containerregistrytasks.aio.operations.TaskRunsOperations
    :ivar tasks: TasksOperations operations
    :vartype tasks: azure.mgmt.containerregistrytasks.aio.operations.TasksOperations
    :ivar registries: RegistriesOperations operations
    :vartype registries: azure.mgmt.containerregistrytasks.aio.operations.RegistriesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = ContainerRegistryTasksMgmtClientConfiguration(
