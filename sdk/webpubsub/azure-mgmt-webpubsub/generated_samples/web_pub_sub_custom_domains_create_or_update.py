...
# USAGE
    python web_pub_sub_custom_domains_create_or_update.py
...
def main():
    ...
    response = client.web_pub_sub_custom_domains.begin_create_or_update(
...
# x-ms-original-file: 2025-12-01-preview/WebPubSubCustomDomains_CreateOrUpdate.json
