...
class EventHandlerTemplate(Model):
    ...
    def __init__(self, *, url_template: str, user_event_pattern: str=None, system_event_pattern: str=None, auth=None, **kwargs) -> None:
...
class WebPubSubResource(TrackedResource):
    ...
    def __init__(self, *, location: str=None, tags=None, sku=None, tls=None, features=None, event_handler=None, network_ac_ls=None, public_network_access: str="Enabled", identity=None, **kwargs) -> None:
