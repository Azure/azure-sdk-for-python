...
class ErrorDetail(Model):
    ...
    :vartype additional_info:
     list[~azure.mgmt.webpubsub.models.ErrorAdditionalInfo]
    """
...
class EventHandlerSettings(Model):
    """The settings for event handler in webpubsub service.

    :param items: Get or set the EventHandler items. The key is the hub name
     and the value is the corresponding EventHandlerTemplate.
    :type items: dict[str,
     list[~azure.mgmt.webpubsub.models.EventHandlerTemplate]]
    """
...
class EventHandlerTemplate(Model):
    """EventHandler template item settings.

    All required parameters must be populated in order to send to Azure.

    :param url_template: Required. Gets or sets the EventHandler URL template.
     You can use a predefined parameter {hub} and {event} inside the template,
     the value of the EventHandler URL is dynamically calculated when the
    ...
    :param user_event_pattern: Gets or sets the matching pattern for event
     names.
    ...
    :param auth: Gets or sets the auth settings for an event handler. If not
     set, no auth is used.
    ...
    def __init__(self, **kwargs):
        ...
        self.system_event_pattern = kwargs.get('system_event_pattern', None)
...
class NetworkACL(Model):
    ...
    :type allow: list[str or
     ~azure.mgmt.webpubsub.models.WebPubSubRequestType]
...
class OperationProperties(Model):
    ...
    :type service_specification:
     ~azure.mgmt.webpubsub.models.ServiceSpecification
    """
...
class PrivateEndpointConnection(ProxyResource):
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.webpubsub.models.ProvisioningState
...
class PrivateLinkServiceConnectionState(Model):
    ...
    :type status: str or
     ~azure.mgmt.webpubsub.models.PrivateLinkServiceConnectionStatus
...
class ServiceSpecification(Model):
    ...
    :type log_specifications:
     list[~azure.mgmt.webpubsub.models.LogSpecification]
    """
...
class ShareablePrivateLinkResourceType(Model):
    ...
    :param properties: Describes the properties of a resource type that has
     been onboarded to private link service
    :type properties:
     ~azure.mgmt.webpubsub.models.ShareablePrivateLinkResourceProperties
    """
...
class SharedPrivateLinkResource(ProxyResource):
    ...
    :vartype status: str or
     ~azure.mgmt.webpubsub.models.SharedPrivateLinkResourceStatus
    """
...
class SignalRServiceUsage(Model):
...
class SignalRServiceUsageName(Model):
...
class SystemData(Model):
    ...
    :type last_modified_by_type: str or
     ~azure.mgmt.webpubsub.models.CreatedByType
...
class WebPubSubNetworkACLs(Model):
    ...
    :type private_endpoints:
     list[~azure.mgmt.webpubsub.models.PrivateEndpointACL]
    """
...
class WebPubSubResource(TrackedResource):
    ...
    :param public_network_access: Enable or disable public network access.
     Default to "Enabled".
     When it's Enabled, network ACLs still apply.
     When it's Disabled, public network access is always disabled no matter
     what you set in network ACLs. Default value: "Enabled" .
