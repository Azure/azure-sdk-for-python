...
class WebPubSubHubsOperations:
    ...
    def get(self, hub_name: str, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.WebPubSubHub:
        ...
        deserialized = self._deserialize("WebPubSubHub", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        resource_name: str,
        parameters: Union[_models.WebPubSubHub, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either WebPubSubHub or the result of
         cls(response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.webpubsub.models.WebPubSubHub or IO[bytes]
        :return: An instance of LROPoller that returns either WebPubSubHub or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.webpubsub.models.WebPubSubHub]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.WebPubSubHub].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.WebPubSubHub](
