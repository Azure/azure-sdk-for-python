...
class WebPubSubHubsOperations(object):
    """WebPubSubHubsOperations operations.
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.WebPubSubHubList"]
        """List hub settings.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.webpubsub.models.WebPubSubHubList]
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        resource_name,  # type: str
        parameters,  # type: "_models.WebPubSubHub"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.WebPubSubHub"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.WebPubSubHub"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.WebPubSubHub"]
        ...
        :return: An instance of LROPoller that returns either WebPubSubHub or the result of cls(response)
