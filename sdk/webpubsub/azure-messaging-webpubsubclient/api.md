...
namespace azure.messaging.webpubsubclient.models
    ...
    class azure.messaging.webpubsubclient.models.InvocationError(AzureError):
        error_detail: InvokeResponseError
        invocation_id: str
        message: str
    ...
    class azure.messaging.webpubsubclient.models.InvokeEventResult:
        data: Any
        ...
        def __init__(
                ...
                *, 
                data: Any = ..., 
                data_type: Optional[WebPubSubDataType] = ...
            ) -> None: ...


    class azure.messaging.webpubsubclient.models.InvokeResponseError:
        message: str
        name: str
