...
def add_sanitizers(test_proxy):
    webpubsubchatservice_subscription_id = os.environ.get(
        "WEBPUBSUBCHATSERVICE_SUBSCRIPTION_ID", "00000000-0000-0000-0000-000000000000"
    )
    webpubsubchatservice_tenant_id = os.environ.get(
        "WEBPUBSUBCHATSERVICE_TENANT_ID", "00000000-0000-0000-0000-000000000000"
    )
    webpubsubchatservice_client_id = os.environ.get(
        "WEBPUBSUBCHATSERVICE_CLIENT_ID", "00000000-0000-0000-0000-000000000000"
    )
    webpubsubchatservice_client_secret = os.environ.get(
