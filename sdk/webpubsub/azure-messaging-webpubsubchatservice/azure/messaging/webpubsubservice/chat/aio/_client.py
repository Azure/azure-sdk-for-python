...
from ._operations import _WebPubSubChatServiceClientOperationsMixin
...
class WebPubSubChatServiceClient(_WebPubSubChatServiceClientOperationsMixin):
    ...
    def __init__(self, endpoint: str, credential: "AsyncTokenCredential", hub: str, **kwargs: Any) -> None:
        _endpoint = "{endpoint}"
        self._config = WebPubSubChatServiceClientConfiguration(
            endpoint=endpoint, credential=credential, hub=hub, **kwargs
        )
