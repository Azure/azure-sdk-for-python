...
from typing import Any, Callable, Dict, IO, Iterable, List, Optional, TypeVar, cast
import urllib.parse
...
def build_web_pub_sub_service_list_connections_in_group_request(  # pylint: disable=name-too-long
    ...
    **kwargs: Any
    ...
    if maxpagesize is not None:
        _params["maxpagesize"] = _SERIALIZER.query("maxpagesize", maxpagesize, "int", maximum=200, minimum=1)
    if top is not None:
        _params["top"] = _SERIALIZER.query("top", top, "int", maximum=2147483647, minimum=1)
...
class WebPubSubServiceClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ClientMixinABC[PipelineClient, WebPubSubServiceClientConfiguration]
):
    ...
    def get_client_access_token(
        ...
        **kwargs: Any
        ...
        :keyword client_protocol: The type of client. Case-insensitive. If not set, it's "Default". For
         Web PubSub for Socket.IO, only the default value is supported. For Web PubSub, the valid values
         are 'Default' and 'MQTT'. Known values are: "Default" and "MQTT". Default value is "Default".
        :paramtype client_protocol: str
        :return: JSON object
        :rtype: JSON
        :raises ~azure.core.exceptions.HttpResponseError:
