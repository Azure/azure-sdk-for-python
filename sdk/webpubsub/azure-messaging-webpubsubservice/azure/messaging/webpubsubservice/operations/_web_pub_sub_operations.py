...
class WebPubSubOperations(object):
    ...
    def grant_permission(
        ...
        :param connection_id: Target connection Id.
        :type connection_id: str
        :param target_name: The meaning of the target depends on the specific
         permission. For joinLeaveGroup and sendToGroup, targetName is a
         required parameter standing for the group name.
