...
class TestGeneratedApiCoverageAsync(WebpubsubAsyncTest):
    ...
    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_send_to_all_json(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
    ...
    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_send_to_all_text(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
        await client.send_to_all(message="hello", content_type="text/plain")

    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_send_to_all_binary(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
        await client.send_to_all(message=b"hello", content_type="application/octet-stream")

    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_send_to_group_json(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
    ...
    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_send_to_group_text(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
        await client.send_to_group(group="group1", message="hello", content_type="text/plain")

    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_send_to_group_binary(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
        await client.send_to_group(group="group1", message=b"hello", content_type="application/octet-stream")

    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_send_to_user_json(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
    ...
    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_send_to_user_text(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
        await client.send_to_user(user_id="user1", message="hello", content_type="text/plain")

    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_send_to_user_binary(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
        await client.send_to_user(user_id="user1", message=b"hello", content_type="application/octet-stream")

    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_send_to_connection_with_fake_connection_id(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
    ...
    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_close_connection_with_fake_connection_id(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
        await client.close_connection(connection_id="fake-connection-id", reason="test")

    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_add_connection_to_group_not_found(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
    ...
    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_grant_permission_not_found(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
        with pytest.raises(ResourceNotFoundError):
    ...
    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_revoke_permission_with_fake_connection_id(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
    ...
    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_add_user_to_group_not_found(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
        with pytest.raises(ResourceNotFoundError):
    ...
    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_check_permission(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
    ...
    @WebpubsubPowerShellPreparer()
    @recorded_by_proxy_async
    async def test_list_connections_in_group(self, webpubsub_endpoint):
        client = self.create_client(endpoint=webpubsub_endpoint, hub="apicoverage")
