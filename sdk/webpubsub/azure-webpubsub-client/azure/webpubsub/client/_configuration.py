...
class WebPubSubClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    """Configuration for WebPubSubClient.
    ...
    def __init__(self, endpoint: str, credential: "TokenCredential", **kwargs: Any) -> None:
        super(WebPubSubClientConfiguration, self).__init__(**kwargs)
        ...
        kwargs.setdefault("sdk_moniker", "webpubsub-client/{}".format(VERSION))
