...
namespace azure.mgmt.qumulo.aio.operations
    ...
    class azure.mgmt.qumulo.aio.operations.FileSystemsOperations:
        ...
        def list_by_resource_group(
                ...
                resource_group_name: str, 
                **kwargs: Any
            ) -> AsyncIterable[FileSystemResource]: ...

        @distributed_trace
        def list_by_subscription(self, **kwargs: Any) -> AsyncIterable[FileSystemResource]: ...
...
namespace azure.mgmt.qumulo.models
    ...
    class azure.mgmt.qumulo.models.ErrorAdditionalInfo(Model):
        info: JSON
        type: str
    ...
    class azure.mgmt.qumulo.models.ErrorDetail(Model):
    ...
    class azure.mgmt.qumulo.models.ErrorResponse(Model):
        error: ErrorDetail
    ...
    class azure.mgmt.qumulo.models.FileSystemResourceListResult(Model):
        next_link: str
        value: list[FileSystemResource]
    ...
    class azure.mgmt.qumulo.models.FileSystemResourceUpdate(Model):
        identity: ManagedServiceIdentity
    ...
    class azure.mgmt.qumulo.models.FileSystemResourceUpdateProperties(Model):
        delegated_subnet_id: str
        marketplace_details: MarketplaceDetails
        user_details: UserDetails
    ...
    class azure.mgmt.qumulo.models.ManagedServiceIdentity(Model):
        principal_id: str
        tenant_id: str
    ...
    class azure.mgmt.qumulo.models.MarketplaceDetails(Model):
    ...
    class azure.mgmt.qumulo.models.Operation(Model):
    ...
    class azure.mgmt.qumulo.models.OperationDisplay(Model):
        description: str
        operation: str
        provider: str
        resource: str
    ...
    class azure.mgmt.qumulo.models.OperationListResult(Model):
        next_link: str
    ...
    class azure.mgmt.qumulo.models.Resource(Model):
        id: str
        name: str
        system_data: SystemData
        type: str
    ...
    class azure.mgmt.qumulo.models.SystemData(Model):
        created_at: datetime
        created_by: str
    ...
    class azure.mgmt.qumulo.models.UserAssignedIdentity(Model):
        client_id: str
        principal_id: str
    ...
    class azure.mgmt.qumulo.models.UserDetails(Model):
        email: str
...
namespace azure.mgmt.qumulo.operations
    ...
    class azure.mgmt.qumulo.operations.FileSystemsOperations:
        ...
        def list_by_resource_group(
                ...
                resource_group_name: str, 
                **kwargs: Any
            ) -> Iterable[FileSystemResource]: ...

        @distributed_trace
        def list_by_subscription(self, **kwargs: Any) -> Iterable[FileSystemResource]: ...
