...
class BackupsOperations:
    ...
    async def begin_create(
        self, resource_group_name: str, server_name: str, backup_name: str, **kwargs: Any
    ) -> AsyncLROPoller[_models.ServerBackup]:
        ...
        :return: An instance of AsyncLROPoller that returns either ServerBackup or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.postgresqlflexibleservers.models.ServerBackup]
        ...
        if cont_token:
            return AsyncLROPoller[_models.ServerBackup].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ServerBackup](
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.postgresqlflexibleservers.models.ServerBackup
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_by_server(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.postgresqlflexibleservers.models.ServerBackup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
