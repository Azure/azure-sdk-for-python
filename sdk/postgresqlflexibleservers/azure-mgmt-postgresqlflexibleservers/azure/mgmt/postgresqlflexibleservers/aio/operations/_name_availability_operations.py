...
from ...operations._name_availability_operations import build_check_globally_request, build_check_with_location_request
...
class NameAvailabilityOperations:
    ...
    async def check_globally(
        ...
        :param parameters: Parameters required to check if a given name is valid and available to
         assign it to a new server or to use it as the base name of a new pair of virtual endpoints.
         Required.
        :type parameters: ~azure.mgmt.postgresqlflexibleservers.models.CheckNameAvailabilityRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: NameAvailabilityModel or the result of cls(response)
    ...
    async def check_globally(
        ...
        :param parameters: Parameters required to check if a given name is valid and available to
         assign it to a new server or to use it as the base name of a new pair of virtual endpoints. Is
        ...
        _request = build_check_globally_request(
        ...
        deserialized = self._deserialize("NameAvailabilityModel", pipeline_response.http_response)
    ...
    @distributed_trace_async
    async def check_with_location(
        self, location_name: str, parameters: Union[_models.CheckNameAvailabilityRequest, IO[bytes]], **kwargs: Any
    ) -> _models.NameAvailabilityModel:
        """Check the availability of name for resource.
        ...
        _request = build_check_with_location_request(
