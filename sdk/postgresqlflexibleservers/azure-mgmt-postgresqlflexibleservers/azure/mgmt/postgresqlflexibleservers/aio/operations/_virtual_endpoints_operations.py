...
from ...operations._virtual_endpoints_operations import (
...
class VirtualEndpointsOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either VirtualEndpoint or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.postgresqlflexibleservers.models.VirtualEndpoint]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.VirtualEndpoint].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.VirtualEndpoint](
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "VirtualEndpointResourceForPatch")
