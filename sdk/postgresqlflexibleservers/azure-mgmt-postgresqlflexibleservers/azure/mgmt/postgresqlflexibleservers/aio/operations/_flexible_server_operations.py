...
class FlexibleServerOperations:
    ...
    async def trigger_ltr_pre_backup(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.postgresqlflexibleservers.models.LtrPreBackupRequest or IO[bytes]
        :return: LtrPreBackupResponse or the result of cls(response)
        :rtype: ~azure.mgmt.postgresqlflexibleservers.models.LtrPreBackupResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        deserialized = self._deserialize("LtrPreBackupResponse", pipeline_response.http_response)
    ...
    async def begin_start_ltr_backup(
        ...
        **kwargs: Any
        ...
        :type server_name: str
        :param parameters: Request body for operation. Required.
        :type parameters: ~azure.mgmt.postgresqlflexibleservers.models.LtrBackupRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either LtrBackupResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.postgresqlflexibleservers.models.LtrBackupResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_start_ltr_backup(
        ...
        **kwargs: Any
        ...
        :param parameters: Request body for operation. Is either a LtrBackupRequest type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.postgresqlflexibleservers.models.LtrBackupRequest or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either LtrBackupResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.postgresqlflexibleservers.models.LtrBackupResponse]
        ...
        def get_long_running_output(pipeline_response):
            ...
            deserialized = self._deserialize("LtrBackupResponse", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, response_headers)  # type: ignore
            return deserialized
