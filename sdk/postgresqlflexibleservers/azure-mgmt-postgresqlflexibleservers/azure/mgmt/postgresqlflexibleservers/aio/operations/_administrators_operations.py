...
class AdministratorsOperations:
    ...
    async def _create_initial(
        ...
        server_name: str,
        object_id: str,
        parameters: Union[_models.ActiveDirectoryAdministratorAdd, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type object_id: str
        :param parameters: The required parameters for adding an Microsoft Entra Administrator for a
         server. Required.
        :type parameters: ~azure.mgmt.postgresqlflexibleservers.models.ActiveDirectoryAdministratorAdd
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.postgresqlflexibleservers.models.ActiveDirectoryAdministrator]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type object_id: str
        :param parameters: The required parameters for adding an Microsoft Entra Administrator for a
         server. Is either a ActiveDirectoryAdministratorAdd type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.postgresqlflexibleservers.models.ActiveDirectoryAdministratorAdd
         or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ActiveDirectoryAdministrator or the
         result of cls(response)
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.ActiveDirectoryAdministrator] = kwargs.pop("cls", None)
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("ActiveDirectoryAdministrator", pipeline_response.http_response)
            if cls:
        ...
        if cont_token:
            return AsyncLROPoller[_models.ActiveDirectoryAdministrator].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ActiveDirectoryAdministrator](
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.postgresqlflexibleservers.models.ActiveDirectoryAdministrator
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_by_server(
        ...
        :return: An iterator like instance of either ActiveDirectoryAdministrator or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.postgresqlflexibleservers.models.ActiveDirectoryAdministrator]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
