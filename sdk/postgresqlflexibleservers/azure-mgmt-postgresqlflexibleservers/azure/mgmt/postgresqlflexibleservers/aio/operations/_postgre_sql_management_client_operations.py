...
class PostgreSQLManagementClientOperationsMixin(  # pylint: disable=name-too-long
    ClientMixinABC[AsyncPipelineClient, PostgreSQLManagementClientConfiguration]
):
    ...
    async def check_migration_name_availability(
        ...
        **kwargs: Any
        ...
        :param parameters: The required parameters for checking if a migration name is available.
         Required.
        :type parameters:
         ~azure.mgmt.postgresqlflexibleservers.models.MigrationNameAvailabilityResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: MigrationNameAvailabilityResource or the result of cls(response)
        :rtype: ~azure.mgmt.postgresqlflexibleservers.models.MigrationNameAvailabilityResource
    ...
    async def check_migration_name_availability(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.postgresqlflexibleservers.models.MigrationNameAvailabilityResource or IO[bytes]
        :return: MigrationNameAvailabilityResource or the result of cls(response)
        :rtype: ~azure.mgmt.postgresqlflexibleservers.models.MigrationNameAvailabilityResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
