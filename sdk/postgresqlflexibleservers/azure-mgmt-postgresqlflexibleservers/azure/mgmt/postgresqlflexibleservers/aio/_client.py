...
class PostgreSQLManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype maintenance_events:
     azure.mgmt.postgresqlflexibleservers.aio.operations.MaintenanceEventsOperations
    ...
    :vartype major_version_upgrade_precheck:
     azure.mgmt.postgresqlflexibleservers.aio.operations.MajorVersionUpgradePrecheckOperations
