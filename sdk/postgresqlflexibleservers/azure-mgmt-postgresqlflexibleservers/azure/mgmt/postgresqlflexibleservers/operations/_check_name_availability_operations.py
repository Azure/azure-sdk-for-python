...
class CheckNameAvailabilityOperations:
    ...
    def execute(
        ...
        **kwargs: Any
        ...
        :type name_availability_request:
         ~azure.mgmt.postgresqlflexibleservers.models.CheckNameAvailabilityRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: NameAvailability or the result of cls(response)
        :rtype: ~azure.mgmt.postgresqlflexibleservers.models.NameAvailability
    ...
    def execute(
        ...
        :type name_availability_request:
         ~azure.mgmt.postgresqlflexibleservers.models.CheckNameAvailabilityRequest or IO[bytes]
        :return: NameAvailability or the result of cls(response)
        :rtype: ~azure.mgmt.postgresqlflexibleservers.models.NameAvailability
        :raises ~azure.core.exceptions.HttpResponseError:
        """
