...
class AdministratorsOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.postgresqlflexibleservers.models.ActiveDirectoryAdministrator]
    ...
    def list_by_server(
        ...
        :return: An iterator like instance of either ActiveDirectoryAdministrator or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.postgresqlflexibleservers.models.ActiveDirectoryAdministrator]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
