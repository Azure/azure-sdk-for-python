...
class BackupsOperations:
    ...
    def begin_create(
        self, resource_group_name: str, server_name: str, backup_name: str, **kwargs: Any
    ) -> LROPoller[_models.ServerBackup]:
        ...
        :return: An instance of LROPoller that returns either ServerBackup or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.postgresqlflexibleservers.models.ServerBackup]
        ...
        if cont_token:
            return LROPoller[_models.ServerBackup].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ServerBackup](
    ...
    def list_by_server(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.postgresqlflexibleservers.models.ServerBackup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
