...
def build_create_request(
    subscription_id: str, resource_group_name: str, target_db_server_name: str, migration_name: str, **kwargs: Any
) -> HttpRequest:
...
class MigrationsOperations:
    ...
    def list_by_target_server(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.postgresqlflexibleservers.models.MigrationResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
