...
class AdministratorsMicrosoftEntraOperations:
    ...
    def _create_or_update_initial(
        ...
        server_name: str,
        object_id: str,
        parameters: Union[_models.AdministratorMicrosoftEntraAdd, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "AdministratorMicrosoftEntraAdd")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either AdministratorMicrosoftEntra or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.postgresqlflexibleservers.models.AdministratorMicrosoftEntra]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("AdministratorMicrosoftEntra", pipeline_response.http_response)
            if cls:
    ...
    def get(
        ...
        :param object_id: Object identifier of the Microsoft Entra principal. Required.
        :type object_id: str
        :return: AdministratorMicrosoftEntra or the result of cls(response)
        :rtype: ~azure.mgmt.postgresqlflexibleservers.models.AdministratorMicrosoftEntra
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_by_server(
        ...
        :param server_name: The name of the server. Required.
        :type server_name: str
        :return: An iterator like instance of either AdministratorMicrosoftEntra or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.postgresqlflexibleservers.models.AdministratorMicrosoftEntra]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.AdministratorMicrosoftEntraList] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("AdministratorMicrosoftEntraList", pipeline_response)
