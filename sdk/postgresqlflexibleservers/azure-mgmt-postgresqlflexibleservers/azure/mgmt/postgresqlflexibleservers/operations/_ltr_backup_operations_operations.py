...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "backupName": _SERIALIZER.url("backup_name", backup_name, "str", pattern=r"^[a-zA-Z0-9]+(-[a-zA-Z0-9]+)*"),
    }
...
class LtrBackupOperationsOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`ltr_backup_operations` attribute.
    """
    ...
    def get(
        ...
        :return: LtrServerBackupOperation or the result of cls(response)
        :rtype: ~azure.mgmt.postgresqlflexibleservers.models.LtrServerBackupOperation
        ...
        cls: ClsType[_models.LtrServerBackupOperation] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("LtrServerBackupOperation", pipeline_response.http_response)
    ...
    def list_by_server(
    ...
    ) -> Iterable["_models.LtrServerBackupOperation"]:
        ...
        :param server_name: The name of the server. Required.
        :type server_name: str
        :return: An iterator like instance of either LtrServerBackupOperation or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.postgresqlflexibleservers.models.LtrServerBackupOperation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.LtrServerBackupOperationList] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("LtrServerBackupOperationList", pipeline_response)
