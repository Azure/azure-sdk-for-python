...
class CapturedLogsOperations:
    ...
    def list_by_server(
        ...
        :return: An iterator like instance of either CapturedLog or the result of cls(response)
        ...
        cls: ClsType[_models.CapturedLogList] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("CapturedLogList", pipeline_response)
