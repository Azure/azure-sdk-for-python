    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "privateEndpointConnectionName": _SERIALIZER.url(
            ...
            private_endpoint_connection_name,
            "str",
            pattern=r"^[a-zA-Z][a-zA-Z0-9-]*\.[a-fA-F0-9\-]+$",
        ),
    }
...
class PrivateEndpointConnectionOperations:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The required parameters for updating private endpoint connection. Required.
        :type parameters: ~azure.mgmt.postgresqlflexibleservers.models.PrivateEndpointConnection
        ...
        :return: An instance of LROPoller that returns either PrivateEndpointConnection or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.postgresqlflexibleservers.models.PrivateEndpointConnection]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param private_endpoint_connection_name: The name of the private endpoint connection. Required.
        :type private_endpoint_connection_name: str
        :param parameters: The required parameters for updating private endpoint connection. Is either
