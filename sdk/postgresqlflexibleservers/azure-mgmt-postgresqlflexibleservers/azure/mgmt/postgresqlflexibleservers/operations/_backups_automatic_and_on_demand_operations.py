...
def build_create_request(
    ...
    path_format_arguments = {
        ...
        "backupName": _SERIALIZER.url(
            "backup_name", backup_name, "str", max_length=128, min_length=1, pattern=r"^[-\w\._]+$"
        ),
    }
...
class BackupsAutomaticAndOnDemandOperations:
    ...
    def begin_create(
        ...
        :return: An instance of LROPoller that returns either BackupAutomaticAndOnDemand or the result
         of cls(response)
        :rtype:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("BackupAutomaticAndOnDemand", pipeline_response.http_response)
            if cls:
    ...
    def get(
        ...
        :param backup_name: Name of the backup. Required.
        :type backup_name: str
        :return: BackupAutomaticAndOnDemand or the result of cls(response)
    ...
    def list_by_server(
        ...
        :param server_name: The name of the server. Required.
        :type server_name: str
        :return: An iterator like instance of either BackupAutomaticAndOnDemand or the result of
         cls(response)
        :rtype:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.BackupAutomaticAndOnDemandList] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("BackupAutomaticAndOnDemandList", pipeline_response)
