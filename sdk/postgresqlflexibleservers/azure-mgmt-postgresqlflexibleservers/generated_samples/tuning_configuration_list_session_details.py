...
# USAGE
    python tuning_configuration_list_session_details.py
...
def main():
    ...
    response = client.tuning_configuration.list_session_details(
        resource_group_name="testrg",
        server_name="testserver",
        tuning_option="configuration",
        session_id="oooooooo-oooo-oooo-oooo-oooooooooooo",
    )
