...
def build_get_request(
    resource_group_name: str, project_name: str, private_link_resource_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "privateLinkResourceName": _SERIALIZER.url(
            "private_link_resource_name", private_link_resource_name, "str", pattern=r"^[^<>&:\?/#]{1,260}$"
        ),
    }
...
class PrivateLinkResourceOperationsOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`private_link_resource_operations` attribute.
    """
    ...
    def list_by_assessment_project(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.migrationassessment.models.PrivateLinkResource]
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, project_name: str, private_link_resource_name: str, **kwargs: Any
        ...
        :param project_name: Assessment Project Name. Required.
        :type project_name: str
        :param private_link_resource_name: Private link resource ARM name. Required.
        :type private_link_resource_name: str
        :return: PrivateLinkResource or the result of cls(response)
        :rtype: ~azure.mgmt.migrationassessment.models.PrivateLinkResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
