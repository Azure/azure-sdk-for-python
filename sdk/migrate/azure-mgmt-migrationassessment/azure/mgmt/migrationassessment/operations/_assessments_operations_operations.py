...
def build_list_by_group_request(
    resource_group_name: str, project_name: str, group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class AssessmentsOperationsOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`assessments_operations` attribute.
    """
    ...
    def list_by_group(
        ...
        :type group_name: str
        :return: An iterator like instance of either Assessment or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.migrationassessment.models.Assessment]
        ...
        cls: ClsType[_models.AssessmentListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("AssessmentListResult", pipeline_response)
    ...
    def get(
        ...
        :param group_name: Group ARM name. Required.
        :type group_name: str
        :param assessment_name: Machine Assessment ARM name. Required.
        :type assessment_name: str
        :return: Assessment or the result of cls(response)
        :rtype: ~azure.mgmt.migrationassessment.models.Assessment
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("Assessment", pipeline_response.http_response)
    ...
    def _create_initial(
        ...
        group_name: str,
        assessment_name: str,
        resource: Union[_models.Assessment, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "Assessment")
    ...
    def begin_create(
        ...
        group_name: str,
        assessment_name: str,
        resource: _models.Assessment,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.Assessment]:
        """Create a Assessment.
        ...
        :type resource: ~azure.mgmt.migrationassessment.models.Assessment
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Assessment or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.migrationassessment.models.Assessment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a Assessment type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.migrationassessment.models.Assessment or IO[bytes]
        :return: An instance of LROPoller that returns either Assessment or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.migrationassessment.models.Assessment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if cont_token:
            return LROPoller[_models.Assessment].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.Assessment](
    ...
    def begin_download_url(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either DownloadUrl or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.migrationassessment.models.DownloadUrl]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
