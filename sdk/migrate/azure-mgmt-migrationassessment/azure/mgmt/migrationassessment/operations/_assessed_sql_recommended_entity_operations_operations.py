...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "groupName": _SERIALIZER.url("group_name", group_name, "str", pattern=r"^[^<>&:\?/#]{1,260}$"),
        "assessmentName": _SERIALIZER.url("assessment_name", assessment_name, "str", pattern=r"^[^<>&:\?/#]{1,260}$"),
        "recommendedAssessedEntityName": _SERIALIZER.url(
            "recommended_assessed_entity_name", recommended_assessed_entity_name, "str", pattern=r"^[^<>&:\?/#]{1,260}$"
        ),
    }
...
class AssessedSqlRecommendedEntityOperationsOperations:  # pylint: disable=name-too-long
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`assessed_sql_recommended_entity_operations` attribute.
    """
    ...
    def list_by_sql_assessment_v2(
        ...
        total_record_count: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable["_models.AssessedSqlRecommendedEntity"]:
        ...
        :return: An iterator like instance of either AssessedSqlRecommendedEntity or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.migrationassessment.models.AssessedSqlRecommendedEntity]
        ...
        cls: ClsType[_models.AssessedSqlRecommendedEntityListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("AssessedSqlRecommendedEntityListResult", pipeline_response)
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :param assessment_name: SQL Assessment arm name. Required.
        :type assessment_name: str
        :param recommended_assessed_entity_name: Sql assessment Assessed Recommended Entity ARM name.
         Required.
        :type recommended_assessed_entity_name: str
        :return: AssessedSqlRecommendedEntity or the result of cls(response)
        :rtype: ~azure.mgmt.migrationassessment.models.AssessedSqlRecommendedEntity
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.AssessedSqlRecommendedEntity] = kwargs.pop("cls", None)
        ...
        _request = build_get_request(
            ...
            group_name=group_name,
            assessment_name=assessment_name,
            recommended_assessed_entity_name=recommended_assessed_entity_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            headers=_headers,
            params=_params,
        ...
        deserialized = self._deserialize("AssessedSqlRecommendedEntity", pipeline_response.http_response)
