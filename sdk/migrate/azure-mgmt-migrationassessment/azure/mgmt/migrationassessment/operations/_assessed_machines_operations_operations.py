...
def build_list_by_assessment_request(
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "groupName": _SERIALIZER.url("group_name", group_name, "str", pattern=r"^[^<>&:\?/#]{1,260}$"),
        "assessmentName": _SERIALIZER.url("assessment_name", assessment_name, "str", pattern=r"^[^<>&:\?/#]{1,260}$"),
        "assessedMachineName": _SERIALIZER.url(
            "assessed_machine_name", assessed_machine_name, "str", pattern=r"^[^<>&:\?/#]{1,260}$"
        ),
    }
...
class AssessedMachinesOperationsOperations:
    ...
    def list_by_assessment(
        ...
        total_record_count: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable["_models.AssessedMachine"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.migrationassessment.models.AssessedMachine]
