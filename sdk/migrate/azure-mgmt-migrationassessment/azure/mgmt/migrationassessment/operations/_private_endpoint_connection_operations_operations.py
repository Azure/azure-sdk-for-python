    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "privateEndpointConnectionName": _SERIALIZER.url(
            "private_endpoint_connection_name", private_endpoint_connection_name, "str", pattern=r"^[^<>&:\?/#]{1,260}$"
        ),
    }
...
class PrivateEndpointConnectionOperationsOperations:  # pylint: disable=name-too-long
    ...
    def list_by_assessment_project(
        ...
        :return: An iterator like instance of either PrivateEndpointConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.migrationassessment.models.PrivateEndpointConnection]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either PrivateEndpointConnection or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.migrationassessment.models.PrivateEndpointConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
