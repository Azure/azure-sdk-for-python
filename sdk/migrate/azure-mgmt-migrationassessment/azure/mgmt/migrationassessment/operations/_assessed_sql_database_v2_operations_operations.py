...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "groupName": _SERIALIZER.url("group_name", group_name, "str", pattern=r"^[^<>&:\?/#]{1,260}$"),
        "assessmentName": _SERIALIZER.url("assessment_name", assessment_name, "str", pattern=r"^[^<>&:\?/#]{1,260}$"),
        "assessedSqlDatabaseName": _SERIALIZER.url(
            "assessed_sql_database_name", assessed_sql_database_name, "str", pattern=r"^[^<>&:\?/#]{1,260}$"
        ),
    }
...
class AssessedSqlDatabaseV2OperationsOperations:  # pylint: disable=name-too-long
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`assessed_sql_database_v2_operations` attribute.
    """
    ...
    def list_by_sql_assessment_v2(
        ...
        total_record_count: Optional[int] = None,
        **kwargs: Any
    ) -> Iterable["_models.AssessedSqlDatabaseV2"]:
        ...
        :return: An iterator like instance of either AssessedSqlDatabaseV2 or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.migrationassessment.models.AssessedSqlDatabaseV2]
        ...
        cls: ClsType[_models.AssessedSqlDatabaseV2ListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("AssessedSqlDatabaseV2ListResult", pipeline_response)
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :param assessment_name: SQL Assessment arm name. Required.
        :type assessment_name: str
        :param assessed_sql_database_name: Sql assessment Assessed Databases ARM name. Required.
        :type assessed_sql_database_name: str
        :return: AssessedSqlDatabaseV2 or the result of cls(response)
        :rtype: ~azure.mgmt.migrationassessment.models.AssessedSqlDatabaseV2
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.AssessedSqlDatabaseV2] = kwargs.pop("cls", None)
        ...
        _request = build_get_request(
            ...
            group_name=group_name,
            assessment_name=assessment_name,
            assessed_sql_database_name=assessed_sql_database_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            headers=_headers,
            params=_params,
        ...
        deserialized = self._deserialize("AssessedSqlDatabaseV2", pipeline_response.http_response)
