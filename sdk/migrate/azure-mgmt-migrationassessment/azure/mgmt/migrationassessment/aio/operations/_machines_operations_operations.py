...
from ...operations._machines_operations_operations import build_get_request, build_list_by_assessment_project_request
...
class MachinesOperationsOperations:
    ...
    def list_by_assessment_project(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.migrationassessment.models.Machine]
    ...
    async def get(
        self, resource_group_name: str, project_name: str, machine_name: str, **kwargs: Any
    ) -> _models.Machine:
        """Get a Machine.
