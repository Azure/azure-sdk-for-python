...
from ...operations._assessed_sql_machines_operations_operations import (
    build_get_request,
    build_list_by_sql_assessment_v2_request,
)
...
class AssessedSqlMachinesOperationsOperations:
    ...
    def list_by_sql_assessment_v2(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.AssessedSqlMachine"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.migrationassessment.models.AssessedSqlMachine]
