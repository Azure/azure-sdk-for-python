...
class TestMigrationAssessmentMgmtAssessmentsOperationsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(MigrationAssessmentMgmtClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_assessments_operations_list_by_group(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_assessments_operations_get(self, resource_group):
        response = self.client.assessments_operations.get(
            resource_group_name=resource_group.name,
            project_name="str",
            group_name="str",
            assessment_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_assessments_operations_begin_create(self, resource_group):
        response = self.client.assessments_operations.begin_create(
            resource_group_name=resource_group.name,
            project_name="str",
            group_name="str",
            assessment_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_assessments_operations_delete(self, resource_group):
        response = self.client.assessments_operations.delete(
            resource_group_name=resource_group.name,
            project_name="str",
            group_name="str",
            assessment_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_assessments_operations_begin_download_url(self, resource_group):
        response = self.client.assessments_operations.begin_download_url(
            resource_group_name=resource_group.name,
            project_name="str",
            group_name="str",
            assessment_name="str",
