...
# USAGE
    python sql_assessment_v2_summary_operations_list_by_sql_assessment_v2_maximum_set_gen.py
...
def main():
    ...
    response = client.sql_assessment_v2_summary_operations.list_by_sql_assessment_v2(
