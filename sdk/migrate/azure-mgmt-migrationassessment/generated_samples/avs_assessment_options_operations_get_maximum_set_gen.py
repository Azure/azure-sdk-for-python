...
# USAGE
    python avs_assessment_options_operations_get_maximum_set_gen.py
...
def main():
    ...
    response = client.avs_assessment_options_operations.get(
        resource_group_name="ayagrawrg",
        project_name="app18700project",
        avs_assessment_options_name="default",
    )
    print(response)
