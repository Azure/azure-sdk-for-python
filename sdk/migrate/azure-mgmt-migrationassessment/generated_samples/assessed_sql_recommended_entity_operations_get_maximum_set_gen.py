...
# USAGE
    python assessed_sql_recommended_entity_operations_get_maximum_set_gen.py
...
def main():
    ...
    response = client.assessed_sql_recommended_entity_operations.get(
        resource_group_name="rgmigrate",
        project_name="fci-test6904project",
        group_name="test_fci_hadr",
        assessment_name="test_swagger_1",
        recommended_assessed_entity_name="cc64c9dc-b38e-435d-85ad-d509df5d92c6",
    )
    print(response)
