...
# USAGE
    python vmware_collectors_operations_list_by_assessment_project_maximum_set_gen.py
...
def main():
    ...
    response = client.vmware_collectors_operations.list_by_assessment_project(
