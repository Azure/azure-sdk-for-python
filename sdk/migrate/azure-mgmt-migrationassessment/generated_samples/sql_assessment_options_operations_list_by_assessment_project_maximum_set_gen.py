...
# USAGE
    python sql_assessment_options_operations_list_by_assessment_project_maximum_set_gen.py
...
def main():
    ...
    response = client.sql_assessment_options_operations.list_by_assessment_project(
