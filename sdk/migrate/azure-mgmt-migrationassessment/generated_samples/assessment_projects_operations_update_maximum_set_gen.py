...
# USAGE
    python assessment_projects_operations_update_maximum_set_gen.py
...
def main():
    ...
    response = client.assessment_projects_operations.begin_update(
        ...
        properties={
            "properties": {
                ...
                "customerWorkspaceId": None,
                "customerWorkspaceLocation": None,
                "projectStatus": "Active",
                "provisioningState": "Succeeded",
                "publicNetworkAccess": "Disabled",
            },
            "tags": {"Migrate Project": "sakanwar-PE-SEA"},
        },
    ).result()
    print(response)
