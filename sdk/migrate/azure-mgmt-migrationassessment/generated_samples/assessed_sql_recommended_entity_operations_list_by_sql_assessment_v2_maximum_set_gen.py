...
# USAGE
    python assessed_sql_recommended_entity_operations_list_by_sql_assessment_v2_maximum_set_gen.py
...
def main():
    ...
    response = client.assessed_sql_recommended_entity_operations.list_by_sql_assessment_v2(
