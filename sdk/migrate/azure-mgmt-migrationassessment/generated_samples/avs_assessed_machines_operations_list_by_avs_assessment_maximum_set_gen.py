...
# USAGE
    python avs_assessed_machines_operations_list_by_avs_assessment_maximum_set_gen.py
...
def main():
    ...
    response = client.avs_assessed_machines_operations.list_by_avs_assessment(
