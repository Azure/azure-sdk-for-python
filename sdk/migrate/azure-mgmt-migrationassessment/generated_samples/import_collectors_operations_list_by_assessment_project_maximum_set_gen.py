...
# USAGE
    python import_collectors_operations_list_by_assessment_project_maximum_set_gen.py
...
def main():
    ...
    response = client.import_collectors_operations.list_by_assessment_project(
