...
# USAGE
    python assessed_sql_database_v2_operations_get_maximum_set_gen.py
...
def main():
    ...
    response = client.assessed_sql_database_v2_operations.get(
        resource_group_name="rgmigrate",
        project_name="fci-test6904project",
        group_name="test_fci_hadr",
        assessment_name="test_swagger_1",
        assessed_sql_database_name="858eb860-9e07-417c-91b6-bca1bffb3bf5",
    )
    print(response)
