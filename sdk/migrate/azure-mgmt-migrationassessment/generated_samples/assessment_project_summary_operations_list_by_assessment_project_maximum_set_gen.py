...
# USAGE
    python assessment_project_summary_operations_list_by_assessment_project_maximum_set_gen.py
...
def main():
    ...
    response = client.assessment_project_summary_operations.list_by_assessment_project(
        resource_group_name="piyushapp1",
        project_name="PiyushApp15328project",
    )
