...
# USAGE
    python groups_operations_create_maximum_set_gen.py
...
def main():
    ...
    response = client.groups_operations.begin_create(
        resource_group_name="ayagrawrg",
        project_name="app18700project",
        group_name="kuchatur-test",
        resource={"properties": {"groupStatus": "Completed", "groupType": "Default", "provisioningState": "Succeeded"}},
    ).result()
    print(response)
