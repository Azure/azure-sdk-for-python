...
class EdgeOperatorClient:  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :vartype operations: azure.mgmt.edgeoperator.aio.operations.Operations
    :ivar system_readiness_operations: SystemReadinessOperationsOperations operations
    :vartype system_readiness_operations:
     azure.mgmt.edgeoperator.aio.operations.SystemReadinessOperationsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.system_readiness_operations = SystemReadinessOperationsOperations(
