...
class PrivateLinkServicesOperations:
    ...
    @distributed_trace
    def list_by_resource_group(self, **kwargs: Any) -> List[_models.TenantResource]:
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.PowerBI/privateLinkServicesForPowerBI"
    }
