...
def build_list_by_resource_request(
    resource_group_name: str, azure_resource_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
def build_get_request(
    subscription_id: str, resource_group_name: str, azure_resource_name: str, private_endpoint_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PrivateEndpointConnectionsOperations:
    ...
    def list_by_resource(
        ...
        :return: An iterator like instance of either PrivateEndpointConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.powerbiprivatelinks.models.PrivateEndpointConnection]
    ...
    @distributed_trace
    def get(self, **kwargs: Any) -> _models.PrivateEndpointConnection:
