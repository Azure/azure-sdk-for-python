...
class PrivateLinkResourcesOperations:
    ...
    @distributed_trace
    def list_by_resource(self, **kwargs: Any) -> Iterable["_models.PrivateLinkResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.powerbiprivatelinks.models.PrivateLinkResource]
    ...
    @distributed_trace
    def get(self, private_link_resource_name: str, **kwargs: Any) -> _models.PrivateLinkResource:
