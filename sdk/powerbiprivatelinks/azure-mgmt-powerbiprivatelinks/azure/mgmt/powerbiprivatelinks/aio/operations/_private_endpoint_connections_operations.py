...
class PrivateEndpointConnectionsOperations:
    ...
    def list_by_resource(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.powerbiprivatelinks.models.PrivateEndpointConnectionListResult]
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                ...
                path_format_arguments = {
                    ...
                    'azureResourceName': self._serialize.url("azure_resource_name", azure_resource_name, 'str'),
                }
    ...
    list_by_resource.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.PowerBI/privateLinkServicesForPowerBI/{azureResourceName}/privateEndpointConnections'}  # type: ignore
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type private_endpoint_connection: ~azure.mgmt.powerbiprivatelinks.models.PrivateEndpointConnection
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PrivateEndpointConnection, or the result of cls(response)
        :rtype: ~azure.mgmt.powerbiprivatelinks.models.PrivateEndpointConnection
        :raises: ~azure.core.exceptions.HttpResponseError
