...
class GroupsRPAPIsConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for GroupsRPAPIs.
    ...
    def __init__(
        ...
        kwargs.setdefault("sdk_moniker", "mgmt-management/{}".format(VERSION))
