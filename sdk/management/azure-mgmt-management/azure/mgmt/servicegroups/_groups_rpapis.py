...
from .operations import ServiceGroupsOperations, _GroupsRPAPIsOperationsMixin
...
class GroupsRPAPIs(_GroupsRPAPIsOperationsMixin):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = GroupsRPAPIsConfiguration(
