...
class AccessCondition(Model):
    ...
    Updates_get_file, Updates_get_operation.
...
class AccountOptions(Model):
    ...
    def __init__(self, *, instance_id: str, **kwargs) -> None:
...
class Deployment(Model):
    ...
    :type deployment_type: str or ~azure.deviceupdate.models.DeploymentType
    ...
    :type device_group_type: str or ~azure.deviceupdate.models.DeviceGroupType
    ...
    :type update_id: ~azure.deviceupdate.models.UpdateId
    :param is_canceled: Boolean flag indicating whether the deployment was
     canceled.
    ...
    def __init__(self, *, deployment_id: str, deployment_type, start_date_time, device_group_type, device_group_definition, update_id, device_class_id: str=None, is_canceled: bool=None, is_retried: bool=None, is_completed: bool=None, **kwargs) -> None:
...
class DeploymentDeviceState(Model):
    ...
    :type device_state: str or
     ~azure.deviceupdate.models.DeviceDeploymentState
    """
    ...
    def __init__(self, *, device_id: str, retry_count: int, moved_on_to_new_deployment: bool, device_state, **kwargs) -> None:
...
class DeploymentDeviceStatesFilter(Model):
    """Deployment device state filter.

    :param device_id: Device Identifier.
    :type device_id: str
    :param device_state: The deployment device state. Possible values include:
     'NotStarted', 'Incompatible', 'AlreadyInDeployment', 'Canceled',
     'InProgress', 'Failed', 'Succeeded'
    :type device_state: str or ~azure.deviceupdate.models.DeviceState
    """
    ...
    def __init__(self, *, device_id: str=None, device_state=None, **kwargs) -> None:
...
class DeploymentStatus(Model):
    ...
    :type deployment_state: str or ~azure.deviceupdate.models.DeploymentState
    ...
    :param devices_canceled_count: Gets or sets the number of devices which
     have had their deployment canceled.
    ...
    def __init__(self, *, deployment_state, total_devices: int=None, devices_incompatible_count: int=None, devices_in_progress_count: int=None, devices_completed_failed_count: int=None, devices_completed_succeeded_count: int=None, devices_canceled_count: int=None, **kwargs) -> None:
...
class Device(Model):
    ...
    :type last_attempted_update_id: ~azure.deviceupdate.models.UpdateId
    ...
    :type installed_update_id: ~azure.deviceupdate.models.UpdateId
    ...
    :param last_deployment_id: The deployment identifier for the last
    ...
    def __init__(self, *, device_id: str, device_class_id: str, manufacturer: str, model: str, on_latest_update: bool, group_id: str=None, last_attempted_update_id=None, deployment_status=None, installed_update_id=None, last_deployment_id: str=None, **kwargs) -> None:
...
class DeviceClass(Model):
    ...
    :type best_compatible_update_id: ~azure.deviceupdate.models.UpdateId
    """
...
class File(Model):
    ...
    :param file_id: Required. File identity, generated by server at import
     time.
    :type file_id: str
...
class FileImportMetadata(Model):
    ...
    :param filename: Required. Update file name as specified inside import
     manifest.
    :type filename: str
    :param url: Required. Azure Blob location from which the update file can
     be downloaded by Device Update for IoT Hub. This is typically a read-only
     SAS-protected blob URL with an expiration set to at least 4 hours.
    :type url: str
    """
...
class Group(Model):
    ...
    def __init__(self, *, group_id: str, tags, created_date_time: str, device_count: int=None, **kwargs) -> None:
...
class ImportManifestMetadata(Model):
    """Metadata describing the import manifest, a document which describes the
    files and other metadata about an update version.

    All required parameters must be populated in order to send to Azure.

    :param url: Required. Azure Blob location from which the import manifest
     can be downloaded by Device Update for IoT Hub. This is typically a
     read-only SAS-protected blob URL with an expiration set to at least 4
     hours.
    :type url: str
    :param size_in_bytes: Required. File size in number of bytes.
    :type size_in_bytes: long
    :param hashes: Required. A JSON object containing the hash(es) of the
     file. At least SHA256 hash is required. This object can be thought of as a
     set of key-value pairs where the key is the hash algorithm, and the value
     is the hash of the file calculated using that algorithm.
    :type hashes: dict[str, str]
    """
...
class ImportUpdateInput(Model):
    ...
    :type import_manifest: ~azure.deviceupdate.models.ImportManifestMetadata
    :param files: Required. One or more update file properties like filename
     and source URL.
    :type files: list[~azure.deviceupdate.models.FileImportMetadata]
    """
...
class InnerError(Model):
    ...
    :param code: Required. A more specific error code than what was provided
    ...
    :type inner_error: ~azure.deviceupdate.models.InnerError
    """
    ...
    def __init__(self, *, code: str, message: str=None, error_detail: str=None, inner_error=None, **kwargs) -> None:
...
class Operation(Model):
    ...
    :type status: str or ~azure.deviceupdate.models.OperationStatus
    :param update_id: The identity of update being imported or deleted. For
     import, this property will only be populated after import manifest is
     processed successfully.
    :type update_id: ~azure.deviceupdate.models.UpdateId
    :param resource_location: Location of the imported update when operation
     is successful.
    :type resource_location: str
    :param error: Operation error encountered, if any.
    :type error: ~azure.deviceupdate.models.Error
    :param trace_id: Operation correlation identity that can used by Microsoft
     Support for troubleshooting.
    :type trace_id: str
    :param last_action_date_time: Required. Date and time in UTC when the
     operation status was last updated.
    :type last_action_date_time: datetime
    :param created_date_time: Required. Date and time in UTC when the
...
class OperationFilter(Model):
    ...
    :param status: Operation status filter. Possible values include:
     'Running', 'NotStarted'
    :type status: str or ~azure.deviceupdate.models.OperationFilterStatus
    """
...
class PageableListOfDeploymentDeviceStates(Model):
    ...
    :type value: list[~azure.deviceupdate.models.DeploymentDeviceState]
...
class PageableListOfDeployments(Model):
    """The list of deployments.

    :param value: The collection of pageable items.
    :type value: list[~azure.deviceupdate.models.Deployment]
    :param next_link: The link to the next page of items.
    :type next_link: str
    """
...
class PageableListOfDeviceClasses(Model):
    """The list of device classes.

    :param value: The collection of pageable items.
    :type value: list[~azure.deviceupdate.models.DeviceClass]
    :param next_link: The link to the next page of items.
    :type next_link: str
    """
...
class PageableListOfDevices(Model):
    """The list of devices.

    :param value: The collection of pageable items.
    :type value: list[~azure.deviceupdate.models.Device]
    :param next_link: The link to the next page of items.
    :type next_link: str
    """
...
class PageableListOfDeviceTags(Model):
    """The list of device tags.

    :param value: The collection of pageable items.
    :type value: list[~azure.deviceupdate.models.DeviceTag]
    :param next_link: The link to the next page of items.
    :type next_link: str
    """
...
class PageableListOfGroups(Model):
    """The list of groups.

    :param value: The collection of pageable items.
    :type value: list[~azure.deviceupdate.models.Group]
    :param next_link: The link to the next page of items.
    :type next_link: str
    """
...
class PageableListOfOperations(Model):
    """The list of operations with server paging support.

    :param value: The collection of pageable items.
    :type value: list[~azure.deviceupdate.models.Operation]
    :param next_link: The link to the next page of items.
    :type next_link: str
    """
...
class PageableListOfStrings(Model):
...
class PageableListOfUpdatableDevices(Model):
    ...
    :param value: The collection of pageable items.
    :type value: list[~azure.deviceupdate.models.UpdatableDevices]
    :param next_link: The link to the next page of items.
    :type next_link: str
    """
...
class PageableListOfUpdateIds(Model):
    """The list of update identities.

    :param value: The collection of pageable items.
    :type value: list[~azure.deviceupdate.models.UpdateId]
    :param next_link: The link to the next page of items.
    :type next_link: str
    """
...
class UpdatableDevices(Model):
    """Update identifier and the number of devices for which the update is
    applicable.
...
class Update(Model):
    ...
    :param installed_criteria: Required. String interpreted by Device Update
     client to determine if the update is installed on the device.
    :type installed_criteria: str
    :param compatibility: Required. List of update compatibility information.
    :type compatibility: list[~azure.deviceupdate.models.Compatibility]
    :param manifest_version: Required. Schema version of manifest used to
     import the update.
    :type manifest_version: str
    :param imported_date_time: Required. Date and time in UTC when the update
     was imported.
    :type imported_date_time: datetime
    :param created_date_time: Required. Date and time in UTC when the update
     was created.
    :type created_date_time: datetime
    ...
    def __init__(self, *, update_id, update_type: str, installed_criteria: str, compatibility, manifest_version: str, imported_date_time, created_date_time, etag: str=None, **kwargs) -> None:
