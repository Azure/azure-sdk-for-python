...
from .._vendor import AzureArcVMwareManagementServiceAPIMixinABC, _convert_request, _format_url_section
...
def build_create_request(resource_group_name: str, host_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

    api_version: Literal["2022-07-15-preview"] = kwargs.pop(
        "api_version", _params.pop("api-version", "2022-07-15-preview")
    )
...
def build_get_request(resource_group_name: str, host_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(resource_group_name: str, host_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ConnectedVMwarevSphere/hosts"
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class HostsOperations:
    ...
    def _create_initial(
        self, resource_group_name: str, host_name: str, body: Optional[Union[_models.Host, IO]] = None, **kwargs: Any
    ) -> _models.Host:
        error_map = {
    ...
    _create_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedVMwarevSphere/hosts/{hostName}"
    }
    ...
    def begin_create(
        ...
        :type body: ~azure.mgmt.connectedvmware.models.Host or IO
    ...
    @distributed_trace
    def get(self, resource_group_name: str, host_name: str, **kwargs: Any) -> _models.Host:
        """Gets a host.
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.Host"]:
        """Implements GET hosts in a subscription.

        List of hosts in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either Host or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.connectedvmware.models.Host]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        cls: ClsType[_models.HostsList] = kwargs.pop("cls", None)
    ...
    list.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.ConnectedVMwarevSphere/hosts"}

    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Host"]:
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedVMwarevSphere/hosts"
    }
