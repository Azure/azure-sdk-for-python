...
from ...operations._resource_pools_operations import (
...
from .._vendor import AzureArcVMwareManagementServiceAPIMixinABC
...
class ResourcePoolsOperations:
    ...
    async def _create_initial(
        ...
        body: Optional[Union[_models.ResourcePool, IO]] = None,
        **kwargs: Any
        ...
        cls: ClsType[_models.ResourcePool] = kwargs.pop("cls", None)
        ...
        if isinstance(body, (IO, bytes)):
            ...
            if body is not None:
                _json = self._serialize.body(body, "ResourcePool")
            else:
                _json = None
    ...
    _create_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedVMwarevSphere/resourcePools/{resourcePoolName}"
    }
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ResourcePool or the result of
         cls(response)
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.connectedvmware.models.ResourcePool or IO
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, resource_pool_name: str, **kwargs: Any) -> _models.ResourcePool:
        """Gets a resourcePool.
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.ResourcePool"]:
        """Implements GET resourcePools in a subscription.

        List of resourcePools in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ResourcePool or the result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.connectedvmware.models.ResourcePool]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        cls: ClsType[_models.ResourcePoolsList] = kwargs.pop("cls", None)
    ...
    list.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.ConnectedVMwarevSphere/resourcePools"}

    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.ResourcePool"]:
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedVMwarevSphere/resourcePools"
    }
