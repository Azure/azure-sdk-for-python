...
from ...operations._hosts_operations import (
...
class HostsOperations:
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, host_name: str, **kwargs: Any) -> _models.Host:
        """Gets a host.
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.Host"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.connectedvmware.models.Host]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.Host"]:
