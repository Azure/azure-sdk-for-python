...
from ...operations._vcenters_operations import (
...
class VCentersOperations:
    ...
    async def _create_initial(
        ...
        vcenter_name: str,
        body: Optional[Union[_models.VCenter, IO]] = None,
        **kwargs: Any
    ) -> _models.VCenter:
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, vcenter_name: str, **kwargs: Any) -> _models.VCenter:
        """Gets a vCenter.
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.VCenter"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.connectedvmware.models.VCenter]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.VCenter"]:
