...
class MachineExtensionsOperations:
    ...
    _create_or_update_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedVMwarevSphere/virtualMachines/{virtualMachineName}/extensions/{extensionName}"
    }
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param virtual_machine_name: The name of the machine where the extension should be created or
         updated. Required.
    ...
    async def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, virtual_machine_name: str, extension_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_delete(
        ...
        :param resource_group_name: The Resource Group Name. Required.
        :type resource_group_name: str
        :param virtual_machine_name: The name of the machine where the extension should be deleted.
         Required.
        :type virtual_machine_name: str
        :param extension_name: The name of the machine extension. Required.
        :type extension_name: str
    ...
    async def get(
        ...
        :param resource_group_name: The Resource Group Name. Required.
        :type resource_group_name: str
        :param virtual_machine_name: The name of the machine containing the extension. Required.
        :type virtual_machine_name: str
        :param extension_name: The name of the machine extension. Required.
        :type extension_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @distributed_trace
    def list(
        self, resource_group_name: str, virtual_machine_name: str, expand: Optional[str] = None, **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.connectedvmware.models.MachineExtension]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedVMwarevSphere/virtualMachines/{virtualMachineName}/extensions"
    }
