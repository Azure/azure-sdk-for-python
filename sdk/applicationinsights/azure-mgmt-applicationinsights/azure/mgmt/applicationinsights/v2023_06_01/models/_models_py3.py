...
class ManagedServiceIdentity(_serialization.Model):
    ...
    :vartype type: str or
     ~azure.mgmt.applicationinsights.v2023_06_01.models.ManagedServiceIdentityType
    :ivar user_assigned_identities: The set of user assigned identities associated with the
     resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form:
     '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}.  # pylint: disable=line-too-long
     The dictionary values can be empty objects ({}) in requests.
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.applicationinsights.v2023_06_01.models.UserAssignedIdentity]
    """
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or
     ~azure.mgmt.applicationinsights.v2023_06_01.models.CreatedByType
...
class WorkbookResource(TrackedResource):
    ...
    :vartype identity: ~azure.mgmt.applicationinsights.v2023_06_01.models.WorkbookResourceIdentity
    :ivar kind: The kind of workbook. Only valid value is shared. "shared"
    :vartype kind: str or ~azure.mgmt.applicationinsights.v2023_06_01.models.WorkbookSharedTypeKind
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype identity:
         ~azure.mgmt.applicationinsights.v2023_06_01.models.WorkbookResourceIdentity
        :keyword kind: The kind of workbook. Only valid value is shared. "shared"
        :paramtype kind: str or
         ~azure.mgmt.applicationinsights.v2023_06_01.models.WorkbookSharedTypeKind
...
class Workbook(WorkbookResource):
    ...
    :vartype system_data: ~azure.mgmt.applicationinsights.v2023_06_01.models.SystemData
...
class WorkbookError(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.applicationinsights.v2023_06_01.models.WorkbookErrorDefinition
    """
    ...
    def __init__(self, *, error: Optional["_models.WorkbookErrorDefinition"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.applicationinsights.v2023_06_01.models.WorkbookErrorDefinition
        """
        super().__init__(**kwargs)
        self.error = error
...
class WorkbookErrorDefinition(_serialization.Model):
    ...
    :vartype innererror: ~azure.mgmt.applicationinsights.v2023_06_01.models.WorkbookInnerErrorTrace
    """
...
class WorkbooksListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.applicationinsights.v2023_06_01.models.Workbook]
    :ivar next_link:
...
class WorkbookUpdateParameters(_serialization.Model):
    ...
    :ivar kind: The kind of workbook. Only valid value is shared. "shared"
    :vartype kind: str or
     ~azure.mgmt.applicationinsights.v2023_06_01.models.WorkbookUpdateSharedTypeKind
    :ivar tags: Resource tags.
    :vartype tags: dict[str, str]
    :ivar display_name: The user-defined name (display name) of the workbook.
    :vartype display_name: str
