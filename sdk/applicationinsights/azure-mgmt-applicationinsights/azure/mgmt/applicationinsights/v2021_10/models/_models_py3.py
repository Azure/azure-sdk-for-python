...
class ManagedServiceIdentity(msrest.serialization.Model):
    ...
    :vartype type: str or
     ~azure.mgmt.applicationinsights.v2021_10.models.ManagedServiceIdentityType
    :ivar user_assigned_identities: The set of user assigned identities associated with the
     resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form:
     '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}.
     The dictionary values can be empty objects ({}) in requests.
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.applicationinsights.v2021_10.models.UserAssignedIdentity]
    """
...
class SystemData(msrest.serialization.Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.applicationinsights.v2021_10.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or
     ~azure.mgmt.applicationinsights.v2021_10.models.CreatedByType
...
class WorkbookResource(TrackedResource):
    ...
    :vartype identity: ~azure.mgmt.applicationinsights.v2021_10.models.WorkbookResourceIdentity
    :ivar kind: The kind of workbook. Choices are user and shared. Possible values include: "user",
     "shared".
    :vartype kind: str or ~azure.mgmt.applicationinsights.v2021_10.models.Kind
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype identity: ~azure.mgmt.applicationinsights.v2021_10.models.WorkbookResourceIdentity
        :keyword kind: The kind of workbook. Choices are user and shared. Possible values include:
         "user", "shared".
        :paramtype kind: str or ~azure.mgmt.applicationinsights.v2021_10.models.Kind
...
class Workbook(WorkbookResource):
    ...
    :vartype system_data: ~azure.mgmt.applicationinsights.v2021_10.models.SystemData
...
class WorkbookError(msrest.serialization.Model):
    ...
    :vartype error: ~azure.mgmt.applicationinsights.v2021_10.models.WorkbookErrorDefinition
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype error: ~azure.mgmt.applicationinsights.v2021_10.models.WorkbookErrorDefinition
        """
...
class WorkbooksListResult(msrest.serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.applicationinsights.v2021_10.models.Workbook]
    :ivar next_link:
...
class WorkbookUpdateParameters(msrest.serialization.Model):
    ...
    :ivar kind: The kind of workbook. Choices are user and shared. Possible values include: "user",
     "shared".
    :vartype kind: str or ~azure.mgmt.applicationinsights.v2021_10.models.SharedTypeKind
    :ivar tags: A set of tags. Resource tags.
    :vartype tags: dict[str, str]
    :ivar display_name: The user-defined name (display name) of the workbook.
    :vartype display_name: str
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword kind: The kind of workbook. Choices are user and shared. Possible values include:
         "user", "shared".
        :paramtype kind: str or ~azure.mgmt.applicationinsights.v2021_10.models.SharedTypeKind
        :keyword tags: A set of tags. Resource tags.
        :paramtype tags: dict[str, str]
        :keyword display_name: The user-defined name (display name) of the workbook.
        :paramtype display_name: str
