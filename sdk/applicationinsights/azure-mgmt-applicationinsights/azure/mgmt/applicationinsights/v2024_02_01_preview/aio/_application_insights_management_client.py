...
from .operations import DeletedWorkbooksOperations
...
class ApplicationInsightsManagementClient:
    ...
    :vartype deleted_workbooks:
     azure.mgmt.applicationinsights.v2024_02_01_preview.aio.operations.DeletedWorkbooksOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.deleted_workbooks = DeletedWorkbooksOperations(
            self._client, self._config, self._serialize, self._deserialize, "2024-02-01-preview"
        )
