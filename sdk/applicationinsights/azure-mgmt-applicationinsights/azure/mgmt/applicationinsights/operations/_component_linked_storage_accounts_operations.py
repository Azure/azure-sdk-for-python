...
class ComponentLinkedStorageAccountsOperations:
    ...
    def create_and_update(
        ...
        **kwargs: Any
        ...
        :type linked_storage_accounts_properties:
         ~azure.mgmt.applicationinsights.models.ComponentLinkedStorageAccounts or IO[bytes]
        :return: ComponentLinkedStorageAccounts or the result of cls(response)
        :rtype: ~azure.mgmt.applicationinsights.models.ComponentLinkedStorageAccounts
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type linked_storage_accounts_properties:
         ~azure.mgmt.applicationinsights.models.ComponentLinkedStorageAccountsPatch or IO[bytes]
        :return: ComponentLinkedStorageAccounts or the result of cls(response)
        :rtype: ~azure.mgmt.applicationinsights.models.ComponentLinkedStorageAccounts
        :raises ~azure.core.exceptions.HttpResponseError:
        """
