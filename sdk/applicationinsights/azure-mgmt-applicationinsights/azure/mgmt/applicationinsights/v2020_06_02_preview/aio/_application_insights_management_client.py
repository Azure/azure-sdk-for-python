...
class ApplicationInsightsManagementClient(object):
    ...
    :vartype operations: azure.mgmt.applicationinsights.v2020_06_02_preview.aio.operations.Operations
    :ivar live_token: LiveTokenOperations operations
    :vartype live_token: azure.mgmt.applicationinsights.v2020_06_02_preview.aio.operations.LiveTokenOperations
