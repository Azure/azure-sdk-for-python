...
class ApplicationInsightsManagementClient:
    ...
    :vartype operations: azure.mgmt.applicationinsights.v2018_06_17_preview.operations.Operations
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2018-06-17-preview". Note that overriding
