...
class WorkbooksOperations:
    ...
    def list_by_resource_group(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.applicationinsights.v2018_06_17_preview.models.WorkbooksListResult]
    ...
    async def update(
        ...
        **kwargs
        ...
        :param workbook_update_parameters: Properties that need to be specified to create a new
         workbook.
        :type workbook_update_parameters: ~azure.mgmt.applicationinsights.v2018_06_17_preview.models.WorkbookUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Workbook, or the result of cls(response)
        :rtype: ~azure.mgmt.applicationinsights.v2018_06_17_preview.models.Workbook
        :raises: ~azure.core.exceptions.HttpResponseError
