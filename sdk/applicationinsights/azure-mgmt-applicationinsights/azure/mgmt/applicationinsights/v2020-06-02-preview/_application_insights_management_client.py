...
class ApplicationInsightsManagementClient(object):
    ...
    :vartype operations: azure.mgmt.applicationinsights.v2020-06-02-preview.operations.Operations
    :ivar live_token: LiveTokenOperations operations
    :vartype live_token: azure.mgmt.applicationinsights.v2020-06-02-preview.operations.LiveTokenOperations
