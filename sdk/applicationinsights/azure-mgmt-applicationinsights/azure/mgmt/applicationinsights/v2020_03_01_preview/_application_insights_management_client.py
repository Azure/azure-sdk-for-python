...
class ApplicationInsightsManagementClient:
    ...
    :vartype component_linked_storage_accounts:
     azure.mgmt.applicationinsights.v2020_03_01_preview.operations.ComponentLinkedStorageAccountsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.component_linked_storage_accounts = ComponentLinkedStorageAccountsOperations(self._client, self._config, self._serialize, self._deserialize)
