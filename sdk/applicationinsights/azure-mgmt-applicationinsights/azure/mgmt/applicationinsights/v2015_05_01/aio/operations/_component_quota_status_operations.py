...
class ComponentQuotaStatusOperations:
    """ComponentQuotaStatusOperations async operations.
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.applicationinsights.v2015_05_01.models.ApplicationInsightsComponentQuotaStatus
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ApplicationInsightsComponentQuotaStatus"]
        error_map = {
