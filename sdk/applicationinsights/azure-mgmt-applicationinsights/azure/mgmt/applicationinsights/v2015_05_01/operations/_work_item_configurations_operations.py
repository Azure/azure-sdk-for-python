...
class WorkItemConfigurationsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.WorkItemConfigurationsListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.applicationinsights.v2015_05_01.models.WorkItemConfigurationsListResult]
    ...
    def create(
        ...
        resource_group_name,  # type: str
        resource_name,  # type: str
        work_item_configuration_properties,  # type: "_models.WorkItemCreateConfiguration"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.WorkItemConfiguration"
