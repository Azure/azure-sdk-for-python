...
class WebTestLocationsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ApplicationInsightsWebTestLocationsListResult"]
        ...
        :return: An iterator like instance of either ApplicationInsightsWebTestLocationsListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.applicationinsights.v2015_05_01.models.ApplicationInsightsWebTestLocationsListResult]
