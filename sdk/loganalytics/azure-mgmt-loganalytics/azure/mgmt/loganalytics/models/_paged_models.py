...
class PrivateLinkResourcePaged(Paged):
    """
    A paging container for iterating over a list of :class:`PrivateLinkResource <azure.mgmt.loganalytics.models.PrivateLinkResource>` object
    """
...
class PrivateEndpointConnectionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`PrivateEndpointConnection <azure.mgmt.loganalytics.models.PrivateEndpointConnection>` object
    """
