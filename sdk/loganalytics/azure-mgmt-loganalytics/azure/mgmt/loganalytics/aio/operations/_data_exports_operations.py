...
from ...operations._data_exports_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_workspace_request
T = TypeVar('T')
    ...
    def list_by_workspace(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DataExportListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.loganalytics.models.DataExportListResult]
