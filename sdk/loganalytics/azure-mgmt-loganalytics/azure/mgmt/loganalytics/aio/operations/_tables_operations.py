...
from ...operations._tables_operations import build_delete_request_initial, build_get_request, build_list_by_workspace_request, build_update_request_initial, build_upsert_request_initial
T = TypeVar('T')
...
class TablesOperations:
    ...
    async def _upsert_initial(
        ...
        **kwargs: Any
        ...
        request = build_upsert_request_initial(
            subscription_id=self._config.subscription_id,
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            ...
            json=_json,
            template_url=self._upsert_initial.metadata['url'],
        )
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
    ...
    _upsert_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/tables/{tableName}'}  # type: ignore


    @distributed_trace_async
    async def begin_upsert(
        self,
        resource_group_name: str,
        workspace_name: str,
        table_name: str,
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._upsert_initial(
                resource_group_name=resource_group_name,
                workspace_name=workspace_name,
                table_name=table_name,
    ...
    begin_upsert.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/tables/{tableName}'}  # type: ignore
