...
class PrivateLinkResourcesOperations(object):
    ...
    def list_by_workspace(
        ...
        """Gets the private link resources that need to be created for a Log
        Analytics Workspace.
        ...
        :rtype:
         ~azure.mgmt.loganalytics.models.PrivateLinkResourcePaged[~azure.mgmt.loganalytics.models.PrivateLinkResource]
        ...
        return deserialized
    list_by_workspace.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/privateLinkResources'}

    def get(
            self, resource_group_name, workspace_name, group_name, custom_headers=None, raw=False, **operation_config):
        """Gets the private link resources that need to be created for a Log
        Analytics Workspace.
        ...
        :rtype: ~azure.mgmt.loganalytics.models.PrivateLinkResource or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/privateLinkResources/{groupName}'}
