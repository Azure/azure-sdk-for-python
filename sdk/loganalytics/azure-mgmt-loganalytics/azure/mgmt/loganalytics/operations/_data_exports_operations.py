...
class DataExportsOperations(object):
    ...
    def list_by_workspace(
        ...
        :rtype:
         ~azure.mgmt.loganalytics.models.DataExportPaged[~azure.mgmt.loganalytics.models.DataExport]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.DataExportPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
            self, resource_group_name, workspace_name, data_export_name, custom_headers=None, raw=False, **operation_config):
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/dataExports/{dataExportName}'}
    ...
    def delete(
        ...
        if raw:
            ...
            return client_raw_response
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/dataExports/{dataExportName}'}
