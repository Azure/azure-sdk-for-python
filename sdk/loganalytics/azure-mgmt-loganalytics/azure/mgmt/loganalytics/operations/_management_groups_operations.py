...
class ManagementGroupsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.WorkspaceListManagementGroupsResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.loganalytics.models.WorkspaceListManagementGroupsResult]
