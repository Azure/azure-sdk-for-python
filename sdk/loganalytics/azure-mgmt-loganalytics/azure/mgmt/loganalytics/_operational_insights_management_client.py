...
class OperationalInsightsManagementClient(OperationalInsightsManagementClientOperationsMixin, SDKClient):
    ...
    :vartype private_link_resources: azure.mgmt.loganalytics.operations.PrivateLinkResourcesOperations
    :ivar private_endpoint_connections: PrivateEndpointConnections operations
    :vartype private_endpoint_connections: azure.mgmt.loganalytics.operations.PrivateEndpointConnectionsOperations
