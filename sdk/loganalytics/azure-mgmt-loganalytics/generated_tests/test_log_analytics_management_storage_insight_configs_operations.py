...
class TestLogAnalyticsManagementStorageInsightConfigsOperations(AzureMgmtRecordedTestCase):
    ...
    def test_create_or_update(self, resource_group):
        response = self.client.storage_insight_configs.create_or_update(
            ...
            parameters={
                ...
                "id": "str",
                "name": "str",
                "status": {"state": "str", "description": "str"},
                "storageAccount": {"id": "str", "key": "str"},
                "tables": ["str"],
                "tags": {"str": "str"},
                "type": "str",
            },
