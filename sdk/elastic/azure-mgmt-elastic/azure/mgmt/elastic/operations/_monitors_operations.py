...
class MonitorsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ElasticMonitorResourceListResponse"]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.ElasticMonitorResource"
    ...
    def _create_initial(
        ...
        resource_group_name,  # type: str
        monitor_name,  # type: str
        body=None,  # type: Optional["_models.ElasticMonitorResource"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ElasticMonitorResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ElasticMonitorResource"]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.ElasticMonitorResource"]
    ...
    def update(
        ...
        resource_group_name,  # type: str
        monitor_name,  # type: str
        body=None,  # type: Optional["_models.ElasticMonitorResourceUpdateParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ElasticMonitorResource"
