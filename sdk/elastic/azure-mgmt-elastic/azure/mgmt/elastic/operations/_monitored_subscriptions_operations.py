...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "monitorName": _SERIALIZER.url("monitor_name", monitor_name, "str", pattern=r"^.*$"),
        "configurationName": _SERIALIZER.url("configuration_name", configuration_name, "str", pattern=r"^.*$"),
    }
    ...
    def begin_createor_update(
        ...
        **kwargs: Any
        ...
        :param body: Is either a MonitoredSubscriptionProperties type or a IO[bytes] type. Default
         value is None.
        :type body: ~azure.mgmt.elastic.models.MonitoredSubscriptionProperties or IO[bytes]
        :return: An instance of LROPoller that returns either MonitoredSubscriptionProperties or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.elastic.models.MonitoredSubscriptionProperties]
