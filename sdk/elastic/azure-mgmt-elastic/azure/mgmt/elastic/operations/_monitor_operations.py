...
class MonitorOperations:
    ...
    def _upgrade_initial(
        ...
        monitor_name: str,
        body: Optional[Union[_models.ElasticMonitorUpgrade, IO[bytes]]] = None,
        **kwargs: Any
    ) -> Iterator[bytes]:
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            if body is not None:
                _json = self._serialize.body(body, "ElasticMonitorUpgrade")
            else:
                _json = None
    ...
    def begin_upgrade(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.elastic.models.ElasticMonitorUpgrade or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
