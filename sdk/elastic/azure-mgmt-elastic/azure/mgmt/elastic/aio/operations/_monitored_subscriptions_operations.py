...
class MonitoredSubscriptionsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either MonitoredSubscriptionProperties or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.elastic.models.MonitoredSubscriptionProperties]
    ...
    async def begin_createor_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.elastic.models.MonitoredSubscriptionProperties]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
