...
from azure.mgmt.networkanalytics import MicrosoftNetworkAnalytics
...
# USAGE
    python data_products_generate_storage_account_sas_token_minimum_set_gen.py
...
def main():
    client = MicrosoftNetworkAnalytics(
        credential=DefaultAzureCredential(),
        subscription_id="00000000-0000-0000-0000-00000000000",
    )

    response = client.data_products.generate_storage_account_sas_token(
        resource_group_name="aoiresourceGroupName",
        data_product_name="dataproduct01",
        body={
            "expiryTimeStamp": "2023-08-24T05:35:17.051Z",
            "ipAddress": "1.1.1.1",
            "startTimeStamp": "2023-08-24T05:35:17.051Z",
        },
    )
    print(response)
