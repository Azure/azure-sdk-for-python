...
from ...operations._data_products_operations import (
    build_add_user_role_request,
    build_create_request,
    build_delete_request,
    build_generate_storage_account_sas_token_request,
    build_get_request,
    build_list_by_resource_group_request,
    build_list_by_subscription_request,
    build_list_roles_assignments_request,
    build_remove_user_role_request,
...
class DataProductsOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either DataProduct or the result of
         cls(response)
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.DataProduct]] = kwargs.pop("cls", None)
    ...
    async def list_roles_assignments(
        self, resource_group_name: str, data_product_name: str, body: JSON, **kwargs: Any
