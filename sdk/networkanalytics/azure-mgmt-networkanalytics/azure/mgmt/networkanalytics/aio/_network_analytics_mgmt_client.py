...
class NetworkAnalyticsMgmtClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype operations: azure.mgmt.networkanalytics.aio.operations.Operations
    :ivar data_products: DataProductsOperations operations
    :vartype data_products: azure.mgmt.networkanalytics.aio.operations.DataProductsOperations
    :ivar data_products_catalogs: DataProductsCatalogsOperations operations
    :vartype data_products_catalogs:
     azure.mgmt.networkanalytics.aio.operations.DataProductsCatalogsOperations
    :ivar data_types: DataTypesOperations operations
    :vartype data_types: azure.mgmt.networkanalytics.aio.operations.DataTypesOperations
    ...
    async def __aenter__(self) -> "NetworkAnalyticsMgmtClient":
