...
from ._configuration import MicrosoftNetworkAnalyticsConfiguration
...
class MicrosoftNetworkAnalytics:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MicrosoftNetworkAnalyticsConfiguration(
    ...
    def __enter__(self) -> "MicrosoftNetworkAnalytics":
