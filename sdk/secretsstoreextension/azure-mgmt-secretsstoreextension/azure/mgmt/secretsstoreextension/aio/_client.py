...
class SecretsStoreExtensionMgmtClient:
    ...
    :vartype operations: azure.mgmt.secretsstoreextension.aio.operations.Operations
    ...
    :vartype azure_key_vault_secret_provider_classes:
     azure.mgmt.secretsstoreextension.aio.operations.AzureKeyVaultSecretProviderClassesOperations
    :ivar secret_syncs: SecretSyncsOperations operations
    :vartype secret_syncs: azure.mgmt.secretsstoreextension.aio.operations.SecretSyncsOperations
