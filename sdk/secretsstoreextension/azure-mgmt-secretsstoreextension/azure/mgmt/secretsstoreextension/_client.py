...
class SecretsStoreExtensionMgmtClient:
    """Microsoft.SecretSyncController resource provider.

    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.secretsstoreextension.operations.Operations
    ...
    :vartype azure_key_vault_secret_provider_classes:
     azure.mgmt.secretsstoreextension.operations.AzureKeyVaultSecretProviderClassesOperations
    :ivar secret_syncs: SecretSyncsOperations operations
    :vartype secret_syncs: azure.mgmt.secretsstoreextension.operations.SecretSyncsOperations
    ...
    :keyword api_version: The API version to use for this operation. Default value is
     "2024-08-21-preview". Note that overriding this default value may result in unsupported
     behavior.
