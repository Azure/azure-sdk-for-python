...
class TestEnclaveMgmtApprovalOperationsAsync(AzureMgmtRecordedTestCase):
            ...
            await self.client.approval.begin_create_or_update(
                ...
                resource={
                    ...
                    "properties": {
                        ...
                        "approvedByEntraIds": ["str"],
                        "approvers": [
                            {
                                "approverEntraId": "str",
                                "lastUpdatedAt": "2020-02-20 00:00:00",
                                "actionPerformed": "str",
                                "mandatoryApprovalGroupMembershipIds": ["str"],
                            }
                        ],
                        "approversApprovedCount": 0,
                        "createdAt": "2020-02-20 00:00:00",
                        "grandparentResourceId": "str",
                        "mandatoryApprovers": [{"approverEntraId": "str"}],
                        "mandatoryApproversApprovedCount": 0,
