...
# USAGE
    python enclave_connection_update.py
...
def main():
    ...
    response = client.enclave_connection.begin_update(
        resource_group_name="rgopenapi",
        enclave_connection_name="TestMyEnclaveConnection",
        properties={"properties": {"sourceCidr": "10.0.0.0/24"}, "tags": {"sampletag": "samplevalue"}},
    ).result()
    print(response)
