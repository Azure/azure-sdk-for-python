...
class ApprovalPatchModel(_Model):
    ...
    :vartype properties: ~azure.mgmt.enclave.models.ApprovalPatchProperties
    """
...
class ApprovalPatchProperties(_Model):
    ...
    :vartype approvers: list[~azure.mgmt.enclave.models.Approver]
    ...
    :vartype request_metadata: ~azure.mgmt.enclave.models.RequestMetadataUpdatableProperties
    """
...
class ApprovalProperties(_Model):
    ...
    :vartype provisioning_state: str or ~azure.mgmt.enclave.models.ProvisioningState
    :ivar parent_resource_id: Parameter for optimizing query results.
    :vartype parent_resource_id: str
    :ivar grandparent_resource_id: Parameter for optimizing query results.
    :vartype grandparent_resource_id: str
    ...
    :vartype mandatory_approvers: list[~azure.mgmt.enclave.models.MandatoryApprover]
    ...
    :ivar request_metadata: Request metadata for the approval request. Required.
    :vartype request_metadata: ~azure.mgmt.enclave.models.RequestMetadata
    """
    ...
    mandatory_approvers: Optional[list["_models.MandatoryApprover"]] = rest_field(
        name="mandatoryApprovers", visibility=["read"]
    )
    """List of mandatory approvers for the approval request."""
    minimum_approvers_required: Optional[int] = rest_field(name="minimumApproversRequired", visibility=["read"])
    """Minimum number of approvers required for the approval request."""
    approvers_approved_count: Optional[int] = rest_field(name="approversApprovedCount", visibility=["read"])
    """Current count of minimum approvers required."""
    mandatory_approvers_approved_count: Optional[int] = rest_field(
        name="mandatoryApproversApprovedCount", visibility=["read"]
    )
    """Current count of mandatory approvers that have approved."""
    approved_by_entra_ids: Optional[list[str]] = rest_field(name="approvedByEntraIds", visibility=["read"])
...
class Resource(_Model):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.enclave.models.SystemData
    """
...
class ApprovalResource(ExtensionResource):
    ...
    :vartype properties: ~azure.mgmt.enclave.models.ApprovalProperties
    """
...
class ApprovalSettingConfiguration(_Model):
    ...
    :ivar approval_policy: Approval policy (Required or NotRequired). Known values are: "Required"
     and "NotRequired".
    :vartype approval_policy: str or ~azure.mgmt.enclave.models.ApprovalPolicy
    ...
    approval_policy: Optional[Union[str, "_models.ApprovalPolicy"]] = rest_field(
        name="approvalPolicy", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    minimum_approvers_required: Optional[int] = rest_field(
        name="minimumApproversRequired", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        approval_policy: Optional[Union[str, "_models.ApprovalPolicy"]] = None,
...
class ApprovalSettings(_Model):
    ...
    :vartype community_endpoint_update: ~azure.mgmt.enclave.models.ApprovalSettingConfiguration
    :ivar enclave_endpoint_update: Approval configuration for enclave endpoint updates.
    :vartype enclave_endpoint_update: ~azure.mgmt.enclave.models.ApprovalSettingConfiguration
    :ivar enclave_creation: Approval configuration for enclave creation.
    :vartype enclave_creation: ~azure.mgmt.enclave.models.ApprovalSettingConfiguration
    :ivar connection_creation: Approval configuration for connection creation.
    :vartype connection_creation: ~azure.mgmt.enclave.models.ApprovalSettingConfiguration
    :ivar connection_update: Approval configuration for connection updates.
    :vartype connection_update: ~azure.mgmt.enclave.models.ApprovalSettingConfiguration
    :ivar community_maintenance_mode: Approval configuration for community maintenance mode.
    :vartype community_maintenance_mode: ~azure.mgmt.enclave.models.ApprovalSettingConfiguration
    :ivar enclave_maintenance_mode: Approval configuration for enclave maintenance mode.
    :vartype enclave_maintenance_mode: ~azure.mgmt.enclave.models.ApprovalSettingConfiguration
    """

    community_endpoint_update: Optional["_models.ApprovalSettingConfiguration"] = rest_field(
        name="communityEndpointUpdate", visibility=["read", "create", "update", "delete", "query"]
    )
    """Approval configuration for community endpoint updates."""
    enclave_endpoint_update: Optional["_models.ApprovalSettingConfiguration"] = rest_field(
        name="enclaveEndpointUpdate", visibility=["read", "create", "update", "delete", "query"]
    )
    """Approval configuration for enclave endpoint updates."""
    enclave_creation: Optional["_models.ApprovalSettingConfiguration"] = rest_field(
        name="enclaveCreation", visibility=["read", "create", "update", "delete", "query"]
    )
    """Approval configuration for enclave creation."""
    connection_creation: Optional["_models.ApprovalSettingConfiguration"] = rest_field(
        name="connectionCreation", visibility=["read", "create", "update", "delete", "query"]
    )
    """Approval configuration for connection creation."""
    connection_update: Optional["_models.ApprovalSettingConfiguration"] = rest_field(
        name="connectionUpdate", visibility=["read", "create", "update", "delete", "query"]
    )
    """Approval configuration for connection updates."""
    community_maintenance_mode: Optional["_models.ApprovalSettingConfiguration"] = rest_field(
        name="communityMaintenanceMode", visibility=["read", "create", "update", "delete", "query"]
    )
    """Approval configuration for community maintenance mode."""
    enclave_maintenance_mode: Optional["_models.ApprovalSettingConfiguration"] = rest_field(
        name="enclaveMaintenanceMode", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        community_endpoint_update: Optional["_models.ApprovalSettingConfiguration"] = None,
        enclave_endpoint_update: Optional["_models.ApprovalSettingConfiguration"] = None,
        enclave_creation: Optional["_models.ApprovalSettingConfiguration"] = None,
        connection_creation: Optional["_models.ApprovalSettingConfiguration"] = None,
        connection_update: Optional["_models.ApprovalSettingConfiguration"] = None,
        community_maintenance_mode: Optional["_models.ApprovalSettingConfiguration"] = None,
        enclave_maintenance_mode: Optional["_models.ApprovalSettingConfiguration"] = None,
    ) -> None: ...
...
class Approver(_Model):
    ...
    :ivar action_performed: Action Performed by approver. Known values are: "Approved" and
     "Rejected".
    :vartype action_performed: str or ~azure.mgmt.enclave.models.ActionPerformed
    ...
    mandatory_approval_group_membership_ids: Optional[list[str]] = rest_field(
        name="mandatoryApprovalGroupMembershipIds", visibility=["read"]
    )
...
class CheckAddressSpaceAvailabilityRequest(_Model):
    ...
    :vartype enclave_virtual_network: ~azure.mgmt.enclave.models.EnclaveVirtualNetworkModel
    """
...
class CommunityEndpointDestinationRule(_Model):
    ...
    :vartype destination_type: str or ~azure.mgmt.enclave.models.DestinationType
    :ivar protocols: Protocols. Options specified by Endpoint Protocol Enum.
    :vartype protocols: list[str or ~azure.mgmt.enclave.models.CommunityEndpointProtocol]
...
class CommunityEndpointPatchModel(_Model):
    ...
    :vartype properties: ~azure.mgmt.enclave.models.CommunityEndpointPatchProperties
...
class CommunityEndpointPatchProperties(_Model):
    ...
    :vartype rule_collection: list[~azure.mgmt.enclave.models.CommunityEndpointDestinationRule]
    :ivar update_mode: Whether update mode is automatic or manual. Known values are: "Automatic"
     and "Manual".
    :vartype update_mode: str or ~azure.mgmt.enclave.models.UpdateMode
    """
    ...
    update_mode: Optional[Union[str, "_models.UpdateMode"]] = rest_field(
...
class CommunityEndpointResource(TrackedResource):
    ...
    :vartype location: str
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.enclave.models.CommunityEndpointProperties
    """
...
class CommunityPatchModel(_Model):
    ...
    :vartype properties: ~azure.mgmt.enclave.models.CommunityPatchProperties
    :ivar tags: Resource tags.
    :vartype tags: dict[str, str]
    :ivar identity: The managed service identities assigned to this resource.
    :vartype identity: ~azure.mgmt.enclave.models.ManagedServiceIdentity
    """
...
class CommunityPatchProperties(_Model):
    ...
    :vartype governed_service_list: list[~azure.mgmt.enclave.models.GovernedServiceItem]
    ...
    :vartype community_role_assignments: list[~azure.mgmt.enclave.models.RoleAssignmentItem]
    ...
    :vartype firewall_sku: str or ~azure.mgmt.enclave.models.FirewallSKU
    :ivar granular_approval_settings: Granular approval requirements for various actions on the
     community's resources.
    :vartype granular_approval_settings: ~azure.mgmt.enclave.models.ApprovalSettingsPatchProperties
    :ivar maintenance_mode_configuration: Maintenance Mode configuration.
    :vartype maintenance_mode_configuration:
     ~azure.mgmt.enclave.models.MaintenanceModeConfigurationPatchModel
    :ivar monitoring_settings: Community Monitoring Settings for diagnostic and virtual network
     flow logs.
    :vartype monitoring_settings: ~azure.mgmt.enclave.models.MonitoringSettingsPatchModel
    ...
    granular_approval_settings: Optional["_models.ApprovalSettingsPatchProperties"] = rest_field(
    ...
    monitoring_settings: Optional["_models.MonitoringSettingsPatchModel"] = rest_field(
    ...
    address_spaces: Optional[list[str]] = rest_field(
        name="addressSpaces", visibility=["read", "create", "update", "delete", "query"]
    )
    """Address spaces list."""
    ...
    def __init__(
        ...
        *,
        ...
        granular_approval_settings: Optional["_models.ApprovalSettingsPatchProperties"] = None,
        maintenance_mode_configuration: Optional["_models.MaintenanceModeConfigurationPatchModel"] = None,
        monitoring_settings: Optional["_models.MonitoringSettingsPatchModel"] = None,
...
class CommunityProperties(_Model):
    ...
    :vartype managed_on_behalf_of_configuration:
     ~azure.mgmt.enclave.models.ManagedOnBehalfOfConfiguration
    :ivar governed_service_list: List of services governed by a community.
    :vartype governed_service_list: list[~azure.mgmt.enclave.models.GovernedServiceItem]
    :ivar policy_override: Policy override setting for the community. Specifies whether to apply
     enclave-specific policies or disable policy enforcement. Is one of the following types:
    ...
    :ivar granular_approval_settings: Granular approval requirements for various actions on the
     community's resources.
    :vartype granular_approval_settings: ~azure.mgmt.enclave.models.ApprovalSettings
    :ivar maintenance_mode_configuration: Maintenance Mode configuration.
    :vartype maintenance_mode_configuration:
     ~azure.mgmt.enclave.models.MaintenanceModeConfigurationModel
    :ivar dedicated_hub_list: DedicatedHub List.
    :vartype dedicated_hub_list: list[~azure.mgmt.enclave.models.DedicatedHubResource]
    :ivar monitoring_settings: Community Monitoring Settings for diagnostic and virtual network
     flow logs.
    :vartype monitoring_settings: ~azure.mgmt.enclave.models.MonitoringSettingsModel
    :ivar address_spaces: Address spaces list.
    :vartype address_spaces: list[str]
    """
    ...
    """SKU of the community's Azure Firewall (Basic, Standard, Premium). Standard is the default.
     Known values are: \"Basic\", \"Standard\", and \"Premium\"."""
    granular_approval_settings: Optional["_models.ApprovalSettings"] = rest_field(
        name="approvalSettings", visibility=["read", "create", "update", "delete", "query"]
    )
    """Granular approval requirements for various actions on the community's resources."""
    ...
    """Maintenance Mode configuration."""
    dedicated_hub_list: Optional[list["_models.DedicatedHubResource"]] = rest_field(
        name="dedicatedHubList", visibility=["read"]
    )
    """DedicatedHub List."""
    monitoring_settings: Optional["_models.MonitoringSettingsModel"] = rest_field(
        name="monitoringSettings", visibility=["read", "create", "update", "delete", "query"]
    )
    """Community Monitoring Settings for diagnostic and virtual network flow logs."""
    address_spaces: Optional[list[str]] = rest_field(
    ...
    def __init__(
        ...
        *,
        ...
        community_role_assignments: Optional[list["_models.RoleAssignmentItem"]] = None,
        firewall_sku: Optional[Union[str, "_models.FirewallSKU"]] = None,
        granular_approval_settings: Optional["_models.ApprovalSettings"] = None,
        maintenance_mode_configuration: Optional["_models.MaintenanceModeConfigurationModel"] = None,
        monitoring_settings: Optional["_models.MonitoringSettingsModel"] = None,
        address_spaces: Optional[list[str]] = None,
    ) -> None: ...
...
class CommunityResource(TrackedResource):
    ...
    :vartype location: str
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.enclave.models.CommunityProperties
    :ivar identity: The managed service identities assigned to this resource.
    :vartype identity: ~azure.mgmt.enclave.models.ManagedServiceIdentity
    """
...
class DedicatedHubPatchModel(_Model):
    ...
    :vartype properties: ~azure.mgmt.enclave.models.DedicatedHubPatchProperties
    :ivar tags: Resource tags.
    :vartype tags: dict[str, str]
    """

    properties: Optional["_models.DedicatedHubPatchProperties"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        properties: Optional["_models.DedicatedHubPatchProperties"] = None,
        tags: Optional[dict[str, str]] = None,
    ) -> None: ...
...
class DedicatedHubPatchProperties(_Model):
    ...
    :vartype designation: str or ~azure.mgmt.enclave.models.Designation
    """

    designation: Optional[Union[str, "_models.Designation"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        designation: Optional[Union[str, "_models.Designation"]] = None,
    ) -> None: ...
...
class DedicatedHubProperties(_Model):
    ...
    v_hub_resource_id: Optional[str] = rest_field(name="vHubResourceId", visibility=["read"])
    """Virtual Hub Resource ID."""
    firewall_resource_id: Optional[str] = rest_field(name="firewallResourceId", visibility=["read"])
    """Firewall Resource ID."""
    firewall_policy_resource_id: Optional[str] = rest_field(name="firewallPolicyResourceId", visibility=["read"])
...
class DedicatedHubResource(TrackedResource):
    ...
    :vartype location: str
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.enclave.models.DedicatedHubProperties
    """

    properties: Optional["_models.DedicatedHubProperties"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """The resource-specific properties for this resource."""
    ...
    def __init__(
        ...
        *,
        location: str,
        tags: Optional[dict[str, str]] = None,
        properties: Optional["_models.DedicatedHubProperties"] = None,
    ) -> None: ...
...
class EnclaveConnectionPatchModel(_Model):
    ...
    :vartype properties: ~azure.mgmt.enclave.models.EnclaveConnectionPatchProperties
    :ivar tags: Resource tags.
    :vartype tags: dict[str, str]
    """
...
class EnclaveConnectionProperties(_Model):
    ...
    :vartype state: str or ~azure.mgmt.enclave.models.EnclaveConnectionState
    ...
    update_mode: Optional[Union[str, "_models.UpdateMode"]] = rest_field(name="updateMode", visibility=["read"])
...
class EnclaveConnectionResource(TrackedResource):
    ...
    :vartype location: str
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.enclave.models.EnclaveConnectionProperties
    """
...
class EnclaveDefaultSettingsModel(_Model):
    ...
    :vartype diagnostic_destination: str or ~azure.mgmt.enclave.models.DiagnosticDestination
    """
...
class EnclaveEndpointDestinationRule(_Model):
    ...
    :ivar protocols: Protocols. Options specified by Endpoint Protocol Enum.
    :vartype protocols: list[str or ~azure.mgmt.enclave.models.EnclaveEndpointProtocol]
    :ivar endpoint_rule_name: Endpoint Rule Name.
    :vartype endpoint_rule_name: str
    :ivar destination: Destination address. Can include multiple CIDR/IP Addresses or fqdn tags or
     fqdns (for community endpoint) separated by commas.
...
class EnclaveEndpointPatchModel(_Model):
    ...
    :vartype properties: ~azure.mgmt.enclave.models.EnclaveEndpointPatchProperties
    :ivar tags: Resource tags.
    :vartype tags: dict[str, str]
    """
...
class EnclaveEndpointPatchProperties(_Model):
    ...
    :vartype rule_collection: list[~azure.mgmt.enclave.models.EnclaveEndpointDestinationRule]
    :ivar update_mode: Whether update mode is automatic or manual. Known values are: "Automatic"
     and "Manual".
    :vartype update_mode: str or ~azure.mgmt.enclave.models.UpdateMode
    """
...
class EnclaveEndpointResource(TrackedResource):
    ...
    :vartype location: str
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.enclave.models.EnclaveEndpointProperties
    """
...
class EnclaveResource(TrackedResource):
    ...
    :vartype location: str
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.enclave.models.VirtualEnclaveProperties
    :ivar identity: The managed service identities assigned to this resource.
    :vartype identity: ~azure.mgmt.enclave.models.ManagedServiceIdentity
    """
...
class EnclaveVirtualNetworkModel(_Model):
    ...
    :vartype subnet_configurations: list[~azure.mgmt.enclave.models.SubnetConfiguration]
...
class ErrorDetail(_Model):
    ...
    :vartype details: list[~azure.mgmt.enclave.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.enclave.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_Model):
    ...
    :vartype error: ~azure.mgmt.enclave.models.ErrorDetail
    """
...
class GovernedServiceItem(_Model):
    ...
    :ivar service_id: Service ID. Required. Known values are: "AKS", "AppService",
     ...
     "Storage".
    :vartype service_id: str or ~azure.mgmt.enclave.models.ServiceIdentifier
...
class MaintenanceModeConfigurationModel(_Model):
    ...
    :vartype principals: list[~azure.mgmt.enclave.models.Principal]
...
class ManagedOnBehalfOfConfiguration(_Model):
    ...
    :vartype mobo_broker_resources: list[~azure.mgmt.enclave.models.MoboBrokerResource]
    """
...
class ManagedServiceIdentity(_Model):
    ...
    :vartype type: str or ~azure.mgmt.enclave.models.ManagedServiceIdentityType
    :ivar user_assigned_identities: The identities assigned to this resource by the user.
    :vartype user_assigned_identities: dict[str, ~azure.mgmt.enclave.models.UserAssignedIdentity]
    """
...
class MonitoringDestination(_Model):
    ...
    :vartype destination_type: str or ~azure.mgmt.enclave.models.MonitoringDestinationType
    ...
    destination_type: Union[str, "_models.MonitoringDestinationType"] = rest_field(
        name="destinationType", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    custom_workspace_resource_id: Optional[str] = rest_field(
        name="customWorkspaceResourceId", visibility=["read", "create", "update", "delete", "query"]
    )
    """Log analytics workspace resource ID for custom workspace."""
    diagnostic_settings_name: Optional[str] = rest_field(
        name="diagnosticSettingsName", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        destination_type: Union[str, "_models.MonitoringDestinationType"],
        custom_workspace_resource_id: Optional[str] = None,
...
class MonitoringSettingsModel(_Model):
    ...
    :ivar diagnostic_destinations: Log Analytics workspace destinations where diagnostic logs will
     be stored.
    :vartype diagnostic_destinations: list[~azure.mgmt.enclave.models.MonitoringDestination]
    :ivar flow_log_destination: Log Analytics workspace destination where virtual network flow logs
     will be stored.
    :vartype flow_log_destination: ~azure.mgmt.enclave.models.MonitoringDestination
    """

    diagnostic_destinations: Optional[list["_models.MonitoringDestination"]] = rest_field(
        name="diagnosticDestinations", visibility=["read", "create", "update", "delete", "query"]
    )
    """Log Analytics workspace destinations where diagnostic logs will be stored."""
    flow_log_destination: Optional["_models.MonitoringDestination"] = rest_field(
        name="flowLogDestination", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        diagnostic_destinations: Optional[list["_models.MonitoringDestination"]] = None,
        flow_log_destination: Optional["_models.MonitoringDestination"] = None,
    ) -> None: ...
...
class MonitoringSettingsPatchModel(_Model):
    ...
    :ivar diagnostic_destinations: Log Analytics workspace destinations where diagnostic logs will
     be stored.
    :vartype diagnostic_destinations:
     list[~azure.mgmt.enclave.models.MonitoringDestinationPatchModel]
    :ivar flow_log_destination: Log Analytics workspace destination where virtual network flow logs
     will be stored.
    :vartype flow_log_destination: ~azure.mgmt.enclave.models.MonitoringDestinationPatchModel
    """

    diagnostic_destinations: Optional[list["_models.MonitoringDestinationPatchModel"]] = rest_field(
        name="diagnosticDestinations", visibility=["read", "create", "update", "delete", "query"]
    )
    """Log Analytics workspace destinations where diagnostic logs will be stored."""
    flow_log_destination: Optional["_models.MonitoringDestinationPatchModel"] = rest_field(
        name="flowLogDestination", visibility=["read", "create", "update", "delete", "query"]
    )
    """Log Analytics workspace destination where virtual network flow logs will be stored."""
    ...
    def __init__(
        self,
        *,
        diagnostic_destinations: Optional[list["_models.MonitoringDestinationPatchModel"]] = None,
        flow_log_destination: Optional["_models.MonitoringDestinationPatchModel"] = None,
    ) -> None: ...
...
class Operation(_Model):
    ...
    :vartype display: ~azure.mgmt.enclave.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.enclave.models.Origin
    :ivar action_type: Extensible enum. Indicates the action type. "Internal" refers to actions
     that are for internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.enclave.models.ActionType
    """
...
class RequestMetadata(_Model):
    ...
    :vartype approval_status: str or ~azure.mgmt.enclave.models.ApprovalStatus
    """
...
class SystemData(_Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.enclave.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or ~azure.mgmt.enclave.models.CreatedByType
...
class TransitHubPatchModel(_Model):
    ...
    :vartype properties: ~azure.mgmt.enclave.models.TransitHubPatchProperties
    :ivar tags: Resource tags.
    :vartype tags: dict[str, str]
    """
...
class TransitHubPatchProperties(_Model):
    ...
    :vartype state: str or ~azure.mgmt.enclave.models.TransitHubState
    :ivar transit_option: The TransitOption of the transitHub.
    :vartype transit_option: ~azure.mgmt.enclave.models.TransitOption
    :ivar security_provider: Specifies the security provider for the transit hub. Known values are:
     "None" and "AzureFirewall".
    :vartype security_provider: str or ~azure.mgmt.enclave.models.SecurityProvider
    """
    ...
    security_provider: Optional[Union[str, "_models.SecurityProvider"]] = rest_field(
        name="securityProvider", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        ...
        security_provider: Optional[Union[str, "_models.SecurityProvider"]] = None,
    ) -> None: ...
...
class TransitHubResource(TrackedResource):
    ...
    :vartype location: str
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.enclave.models.TransitHubProperties
    """
...
class TransitOption(_Model):
    ...
    :vartype type: str or ~azure.mgmt.enclave.models.TransitOptionType
    :ivar params: Transit Option Params.
    :vartype params: ~azure.mgmt.enclave.models.TransitOptionParams
    """
...
class VirtualEnclavePatchModel(_Model):
    ...
    :vartype properties: ~azure.mgmt.enclave.models.VirtualEnclavePatchProperties
    :ivar identity: The managed service identities assigned to this resource.
    :vartype identity: ~azure.mgmt.enclave.models.ManagedServiceIdentity
    :ivar tags: Resource tags.
    :vartype tags: dict[str, str]
...
class VirtualEnclavePatchProperties(_Model):
    ...
    :vartype workload_resource_visibility: str or ~azure.mgmt.enclave.models.ResourceVisibilityMode
    ...
    :vartype rbac_inheritance: str or ~azure.mgmt.enclave.models.RbacInheritanceMode
    :ivar enclave_role_assignments: Enclave role assignments.
    :vartype enclave_role_assignments: list[~azure.mgmt.enclave.models.RoleAssignmentItem]
    :ivar workload_role_assignments: Workload role assignments.
    :vartype workload_role_assignments: list[~azure.mgmt.enclave.models.RoleAssignmentItem]
    :ivar governed_service_list: Enclave specific policies.
    :vartype governed_service_list: list[~azure.mgmt.enclave.models.GovernedServiceItem]
    :ivar enclave_default_settings: Enclave default settings.
    :vartype enclave_default_settings: ~azure.mgmt.enclave.models.EnclaveDefaultSettingsPatchModel
    :ivar maintenance_mode_configuration: Maintenance Mode configuration.
    :vartype maintenance_mode_configuration:
     ~azure.mgmt.enclave.models.MaintenanceModeConfigurationPatchModel
    ...
    :vartype approval_settings:
     ~azure.mgmt.enclave.models.VirtualEnclaveApprovalSettingsPatchProperties
    ...
    workload_resource_visibility: Optional[Union[str, "_models.ResourceVisibilityMode"]] = rest_field(
        name="workloadResourceVisibility", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    rbac_inheritance: Optional[Union[str, "_models.RbacInheritanceMode"]] = rest_field(
        name="rbacInheritance", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    """Maintenance Mode configuration."""
    dedicated_hub_resource_id: Optional[str] = rest_field(
        name="dedicatedHubResourceId", visibility=["read", "create", "update", "delete", "query"]
    )
    """DedicatedHub Resource ID."""
    approval_settings: Optional["_models.VirtualEnclaveApprovalSettingsPatchProperties"] = rest_field(
        name="approvalSettings", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        ...
        workload_resource_visibility: Optional[Union[str, "_models.ResourceVisibilityMode"]] = None,
        rbac_inheritance: Optional[Union[str, "_models.RbacInheritanceMode"]] = None,
        ...
        maintenance_mode_configuration: Optional["_models.MaintenanceModeConfigurationPatchModel"] = None,
        dedicated_hub_resource_id: Optional[str] = None,
        approval_settings: Optional["_models.VirtualEnclaveApprovalSettingsPatchProperties"] = None,
        monitoring_settings: Optional["_models.MonitoringSettingsPatchModel"] = None,
    ) -> None: ...
...
class VirtualEnclaveProperties(_Model):
    ...
    :vartype enclave_address_spaces: ~azure.mgmt.enclave.models.EnclaveAddressSpacesModel
    :ivar community_resource_id: Community Resource Id. Required.
    :vartype community_resource_id: str
    ...
    :vartype governed_service_list: list[~azure.mgmt.enclave.models.GovernedServiceItem]
    :ivar enclave_default_settings: Enclave default settings.
    :vartype enclave_default_settings: ~azure.mgmt.enclave.models.EnclaveDefaultSettingsModel
    :ivar maintenance_mode_configuration: Maintenance Mode configuration.
    :vartype maintenance_mode_configuration:
     ~azure.mgmt.enclave.models.MaintenanceModeConfigurationModel
    :ivar dedicated_hub_resource_id: DedicatedHub Resource ID.
    :vartype dedicated_hub_resource_id: str
    :ivar approval_settings: Approval requirements for various actions on the enclave's resources.
    :vartype approval_settings: ~azure.mgmt.enclave.models.VirtualEnclaveApprovalSettings
    :ivar monitoring_settings: Virtual Enclave Monitoring Settings for diagnostic and virtual
     network flow logs.
    :vartype monitoring_settings: ~azure.mgmt.enclave.models.MonitoringSettingsModel
    """
    ...
    """DedicatedHub Resource ID."""
    approval_settings: Optional["_models.VirtualEnclaveApprovalSettings"] = rest_field(
        name="approvalSettings", visibility=["read", "create", "update", "delete", "query"]
    )
    """Approval requirements for various actions on the enclave's resources."""
    monitoring_settings: Optional["_models.MonitoringSettingsModel"] = rest_field(
    ...
    def __init__(
        ...
        *,
        ...
        maintenance_mode_configuration: Optional["_models.MaintenanceModeConfigurationModel"] = None,
        dedicated_hub_resource_id: Optional[str] = None,
        approval_settings: Optional["_models.VirtualEnclaveApprovalSettings"] = None,
        monitoring_settings: Optional["_models.MonitoringSettingsModel"] = None,
    ) -> None: ...
...
class WorkloadPatchModel(_Model):
    ...
    :vartype properties: ~azure.mgmt.enclave.models.WorkloadPatchProperties
    :ivar tags: Resource tags.
    :vartype tags: dict[str, str]
    """
...
class WorkloadResource(TrackedResource):
    ...
    :vartype location: str
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.enclave.models.WorkloadProperties
    """
