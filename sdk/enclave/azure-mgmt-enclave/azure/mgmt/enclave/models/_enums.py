...
class Designation(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class MonitoringDestinationType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class RbacInheritanceMode(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class ResourceVisibilityMode(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class SecurityProvider(str, Enum, metaclass=CaseInsensitiveEnumMeta):
