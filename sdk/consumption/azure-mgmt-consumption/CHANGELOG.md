...
### Features Added
  ...
  - Model `ChargeSummary` added property `e_tag`
  ...
  - Model `LegacyChargeSummary` added property `e_tag`
  ...
  - Model `ModernChargeSummary` added property `e_tag`
...
### Breaking Changes
  ...
  - Model `ChargeSummary` deleted or renamed its instance variable `etag`
...
### Other Changes
  ...
  - Deleted model `DownloadProperties`/`LegacyReservationTransaction`/`ReservationTransactionResource`/`ResourceAttributes` which actually were not used by SDK users
