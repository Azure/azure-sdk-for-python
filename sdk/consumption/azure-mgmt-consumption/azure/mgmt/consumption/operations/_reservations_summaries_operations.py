...
def build_list_by_reservation_order_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Capacity/reservationorders/{reservationOrderId}/providers/Microsoft.Consumption/reservationSummaries")  # pylint: disable=line-too-long
    ...
    _query_parameters['grain'] = _SERIALIZER.query("grain", grain, 'str')
...
def build_list_by_reservation_order_and_reservation_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Capacity/reservationorders/{reservationOrderId}/reservations/{reservationId}/providers/Microsoft.Consumption/reservationSummaries")  # pylint: disable=line-too-long
    path_format_arguments = {
        "reservationOrderId": _SERIALIZER.url("reservation_order_id", reservation_order_id, 'str'),
...
def build_list_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.Consumption/reservationSummaries")
    path_format_arguments = {
    ...
    if start_date is not None:
        _query_parameters['startDate'] = _SERIALIZER.query("start_date", start_date, 'str')
    if end_date is not None:
        _query_parameters['endDate'] = _SERIALIZER.query("end_date", end_date, 'str')
    if filter is not None:
        _query_parameters['$filter'] = _SERIALIZER.query("filter", filter, 'str')
    if reservation_id is not None:
        _query_parameters['reservationId'] = _SERIALIZER.query("reservation_id", reservation_id, 'str')
    if reservation_order_id is not None:
        _query_parameters['reservationOrderId'] = _SERIALIZER.query("reservation_order_id", reservation_order_id, 'str')
    _query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
