...
def build_list_by_reservation_order_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    grain = kwargs.pop('grain')  # type: Union[str, "_models.Datagrain"]
    filter = kwargs.pop('filter', None)  # type: Optional[str]

    api_version = "2021-10-01"
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Capacity/reservationorders/{reservationOrderId}/providers/Microsoft.Consumption/reservationSummaries')
    ...
    query_parameters['grain'] = _SERIALIZER.query("grain", grain, 'str')
...
def build_list_by_reservation_order_and_reservation_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/providers/Microsoft.Capacity/reservationorders/{reservationOrderId}/reservations/{reservationId}/providers/Microsoft.Consumption/reservationSummaries')
    path_format_arguments = {
        "reservationOrderId": _SERIALIZER.url("reservation_order_id", reservation_order_id, 'str'),
...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    grain = kwargs.pop('grain')  # type: Union[str, "_models.Datagrain"]
    start_date = kwargs.pop('start_date', None)  # type: Optional[str]
    end_date = kwargs.pop('end_date', None)  # type: Optional[str]
    filter = kwargs.pop('filter', None)  # type: Optional[str]
    reservation_id = kwargs.pop('reservation_id', None)  # type: Optional[str]
    reservation_order_id = kwargs.pop('reservation_order_id', None)  # type: Optional[str]

    api_version = "2021-10-01"
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/{scope}/providers/Microsoft.Consumption/reservationSummaries')
    path_format_arguments = {
    ...
    if reservation_id is not None:
        query_parameters['reservationId'] = _SERIALIZER.query("reservation_id", reservation_id, 'str')
    if reservation_order_id is not None:
        query_parameters['reservationOrderId'] = _SERIALIZER.query("reservation_order_id", reservation_order_id, 'str')
    query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
...
class ReservationsSummariesOperations(object):
    ...
    def list_by_reservation_order(
        self,
        reservation_order_id,  # type: str
        grain,  # type: Union[str, "_models.Datagrain"]
        filter=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["_models.ReservationSummariesListResult"]
        ...
        :return: An iterator like instance of either ReservationSummariesListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.consumption.models.ReservationSummariesListResult]
