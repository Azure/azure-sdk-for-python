...
class ReservationsSummariesOperations(object):
    ...
    def list(
            self, scope, grain, start_date=None, end_date=None, filter=None, reservation_id=None, reservation_order_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param grain: Can be daily or monthly. Possible values include:
         'DailyGrain', 'MonthlyGrain'
        :type grain: str or ~azure.mgmt.consumption.models.Datagrain
        :param start_date: Start date. Only applicable when querying with
         billing profile
        :type start_date: str
        :param end_date: End date. Only applicable when querying with billing
         profile
        :type end_date: str
        :param filter: Required only for daily grain. The properties/UsageDate
         for start date and end date. The filter supports 'le' and  'ge'. Not
         applicable when querying with billing profile
        :type filter: str
        :param reservation_id: Reservation Id GUID. Only valid if
         reservationOrderId is also provided. Filter to a specific reservation
        :type reservation_id: str
        :param reservation_order_id: Reservation Order Id GUID. Required if
         reservationId is provided. Filter to a specific reservation order
        :type reservation_order_id: str
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
