...
class ReservationsDetailsOperations(object):
    ...
    def list_by_reservation_order(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.ReservationDetailsListResult"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.consumption.models.ReservationDetailsListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ReservationDetailsListResult"]
        error_map = {
