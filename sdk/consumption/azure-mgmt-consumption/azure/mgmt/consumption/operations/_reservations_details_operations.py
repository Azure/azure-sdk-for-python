...
class ReservationsDetailsOperations(object):
    ...
    def list(
            self, scope, start_date=None, end_date=None, filter=None, reservation_id=None, reservation_order_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param filter: Filter reservation details by date range. The
         properties/UsageDate for start date and end date. The filter supports
         'le' and  'ge'. Not applicable when querying with billing profile
        :type filter: str
