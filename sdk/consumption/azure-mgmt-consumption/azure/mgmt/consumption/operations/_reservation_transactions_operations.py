...
class ReservationTransactionsOperations(object):
    ...
    def list(
        ...
        :param filter: Filter reservation transactions by date range. The
         properties/EventDate for start date and end date. The filter supports
         'le' and  'ge'
        :type filter: str
    ...
    def list_by_billing_profile(
            self, billing_account_id, billing_profile_id, filter=None, custom_headers=None, raw=False, **operation_config):
        """List of transactions for reserved instances on billing account scope.
        ...
        :rtype:
         ~azure.mgmt.consumption.models.ModernReservationTransactionPaged[~azure.mgmt.consumption.models.ModernReservationTransaction]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.consumption.models.ErrorResponseException>`
        """
        def prepare_request(next_link=None):
        ...
        if raw:
            header_dict = {}
        deserialized = models.ModernReservationTransactionPaged(internal_paging, self._deserialize.dependencies, header_dict)
