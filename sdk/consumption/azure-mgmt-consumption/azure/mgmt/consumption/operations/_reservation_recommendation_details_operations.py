...
class ReservationRecommendationDetailsOperations(object):
    ...
    def get(
            self, scope, scope1, region, term, look_back_period, product, custom_headers=None, raw=False, **operation_config):
        ...
        :type scope: str
        :param scope1: Scope of the reservation. Possible values include:
         'Single', 'Shared'
        :type scope1: str or ~azure.mgmt.consumption.models.Scope12
        ...
        :raises:
         :class:`HighCasedErrorResponseException<azure.mgmt.consumption.models.HighCasedErrorResponseException>`
        """
        # Construct URL
        ...
        if response.status_code not in [200, 204]:
            raise models.HighCasedErrorResponseException(self._deserialize, response)
