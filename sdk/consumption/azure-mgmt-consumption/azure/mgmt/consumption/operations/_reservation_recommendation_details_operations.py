...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.Consumption/reservationRecommendationDetails")
    ...
    _query_parameters['region'] = _SERIALIZER.query("region", region, 'str')
    _query_parameters['term'] = _SERIALIZER.query("term", term, 'str')
    _query_parameters['lookBackPeriod'] = _SERIALIZER.query("look_back_period", look_back_period, 'str')
    _query_parameters['product'] = _SERIALIZER.query("product", product, 'str')
