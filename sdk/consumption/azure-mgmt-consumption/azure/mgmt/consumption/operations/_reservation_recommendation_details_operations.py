...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    region = kwargs.pop('region')  # type: str
    term = kwargs.pop('term')  # type: Union[str, "_models.Term"]
    look_back_period = kwargs.pop('look_back_period')  # type: Union[str, "_models.LookBackPeriod"]
    product = kwargs.pop('product')  # type: str
