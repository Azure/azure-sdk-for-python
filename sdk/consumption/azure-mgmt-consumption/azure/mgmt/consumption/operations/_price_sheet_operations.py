...
def build_download_by_billing_account_period_request(  # pylint: disable=name-too-long
...
class PriceSheetOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("PriceSheetResult", pipeline_response.http_response)
