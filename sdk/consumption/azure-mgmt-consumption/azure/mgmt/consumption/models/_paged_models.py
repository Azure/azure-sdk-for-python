...
class ModernReservationTransactionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ModernReservationTransaction <azure.mgmt.consumption.models.ModernReservationTransaction>` object
    """

    _attribute_map = {
        'next_link': {'key': 'nextLink', 'type': 'str'},
        'current_page': {'key': 'value', 'type': '[ModernReservationTransaction]'}
    }

    def __init__(self, *args, **kwargs):

        super(ModernReservationTransactionPaged, self).__init__(*args, **kwargs)
