...
class Budget(ProxyResource):
    ...
    :param e_tag: eTag of the resource. To handle concurrent update scenario,
     ...
     latest version or not.
    :type e_tag: str
    :ivar category: Required. The category of the budget, whether the budget
     tracks cost or usage. Default value: "Cost" .
    ...
    :param time_grain: Required. The time covered by a budget. Tracking of the
     amount will be reset based on the time grain. BillingMonth,
    ...
    :param time_period: Required. Has start and end date of the budget. The
     ...
     date should not be more than twelve months. Past start date should  be
    ...
    :param filter: May be used to filter budgets by user-specified dimensions
     and/or tags.
    ...
    :ivar forecast_spend: The forecasted cost which is being tracked for a
     budget.
    ...
    def __init__(self, *, amount, time_grain, time_period, e_tag: str=None, filter=None, notifications=None, **kwargs) -> None:
...
class BudgetComparisonExpression(Model):
    ...
    _validation = {
        ...
        'values': {'required': True, 'min_items': 0},
    }
...
class BudgetFilter(Model):
    ...
    def __init__(self, *, and_property=None, not_property=None, dimensions=None, tags=None, **kwargs) -> None:
...
class Forecast(Resource):
    ...
    :param grain: The granularity of forecast. Please note that Yearly is not
     currently supported in this API. The API will provide responses in the
     Monthly grain if Yearly is selected. To get yearly grain data, please use
     our newer Forecast API. Possible values include: 'Daily', 'Monthly',
     'Yearly'
...
class ForecastSpend(Model):
    """The forecasted cost which is being tracked for a budget.

    Variables are only populated by the server, and will be ignored when
    sending a request.

    :ivar amount: The forecasted cost for the total time period which is being
     tracked by the budget. This value is only provided if the budget contains
     a forecast alert type.
    :vartype amount: decimal.Decimal
    :ivar unit: The unit of measure for the budget amount.
    :vartype unit: str
    """
...
class HighCasedErrorDetails(Model):
    """The details of the error.
...
class HighCasedErrorResponse(Model):
    """Error response indicates that the service is not able to process the
    incoming request. The reason is provided in the error message.
    Some Error responses:
    * 429 TooManyRequests - Request is throttled. Retry after waiting for the
...
class HighCasedErrorResponseException(HttpOperationError):
    """Server responsed with exception of type: 'HighCasedErrorResponse'.
    ...
    def __init__(self, deserialize, response, *args):
        ...
        super(HighCasedErrorResponseException, self).__init__(deserialize, response, 'HighCasedErrorResponse', *args)
...
class ReservationTransactionResource(Model):
    """The Resource model definition.
...
class ReservationTransaction(ReservationTransactionResource):
    ...
    :ivar billing_frequency: The billing frequency, which can be either
...
class LegacyUsageDetail(UsageDetail):
    ...
    :ivar resource_id: Unique identifier of the Azure Resource Manager usage
     detail resource.
...
class ModernReservationRecommendation(ReservationRecommendation):
    ...
    :param kind: Required. Constant filled by server.
    :type kind: str
    :ivar modern_reservation_recommendation_location: Resource Location.
    :vartype modern_reservation_recommendation_location: str
    :ivar look_back_period: The number of days of usage to look back for
     recommendation.
    ...
    _validation = {
        ...
        'sku': {'readonly': True},
        'kind': {'required': True},
        'modern_reservation_recommendation_location': {'readonly': True},
        'look_back_period': {'readonly': True},
        'instance_flexibility_ratio': {'readonly': True},
        'instance_flexibility_group': {'readonly': True},
        'normalized_size': {'readonly': True},
    ...
    _attribute_map = {
        ...
        'sku': {'key': 'sku', 'type': 'str'},
        'kind': {'key': 'kind', 'type': 'str'},
        'modern_reservation_recommendation_location': {'key': 'properties.location', 'type': 'str'},
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.modern_reservation_recommendation_location = None
        self.look_back_period = None
        self.instance_flexibility_ratio = None
        self.instance_flexibility_group = None
        self.normalized_size = None
...
class ModernUsageDetail(UsageDetail):
    ...
    :ivar product_identifier: Identifier for the product that has accrued
    ...
    :ivar pay_gprice: Retail price for the resource.
    :vartype pay_gprice: decimal.Decimal
    """
    ...
    _attribute_map = {
        ...
        'pay_gprice': {'key': 'properties.payGPrice', 'type': 'decimal'},
    }
...
class Notification(Model):
    ...
    :param contact_emails: Required. Email addresses to send the budget
     notification to when the threshold is exceeded. Must have at least one
     contact email or contact group specified at the Subscription or Resource
    ...
    :param contact_groups: Action groups to send the budget notification to
     when the threshold is exceeded. Must be provided as a fully qualified
     Azure resource id. Only supported at Subscription or Resource Group
     scopes.
    :type contact_groups: list[str]
    :param threshold_type: The type of threshold. Possible values include:
     'Actual'. Default value: "Actual" .
    ...
    def __init__(self, *, enabled: bool, operator, threshold, contact_emails, contact_roles=None, contact_groups=None, threshold_type="Actual", **kwargs) -> None:
...
class ReservationRecommendationDetailsCalculatedSavingsProperties(Model):
    ...
    :ivar overage_cost: The difference between total reservation cost and
     reservation cost.
    :vartype overage_cost: float
    :ivar quantity: The quantity for calculated savings.
    :vartype quantity: float
    :ivar reservation_cost: The exact cost of the estimated usage using
     reservation.
    ...
    :param reserved_unit_count: The number of reserved units used to calculate
     savings. Always 1 for virtual machines.
    :type reserved_unit_count: float
    :ivar savings: The amount saved by purchasing the recommended quantity of
     reservation.
    ...
    def __init__(self, *, reserved_unit_count: float=None, **kwargs) -> None:
...
class ReservationRecommendationDetailsModel(Resource):
    ...
    :type sku: str
    :ivar currency: An ISO 4217 currency code identifier for the costs and
     savings
    :vartype currency: str
    ...
    :vartype scope: str
    :ivar usage: Historical usage details used to calculate the estimated
     savings.
    :vartype usage:
     ~azure.mgmt.consumption.models.ReservationRecommendationDetailsUsageProperties
    """
    ...
    def __init__(self, *, location: str=None, sku: str=None, **kwargs) -> None:
...
class ReservationRecommendationDetailsResourceProperties(Model):
    """Details of the resource.

    Variables are only populated by the server, and will be ignored when
    sending a request.

    :ivar applied_scopes: List of subscriptions for which the reservation is
     applied.
...
class ReservationRecommendationDetailsSavingsProperties(Model):
    ...
    :ivar look_back_period: Number of days of usage to look back used for
    ...
    :ivar reservation_order_term: Term period of the reservation, ex: P1Y or
     P3Y.
    ...
    def __init__(self, *, calculated_savings=None, **kwargs) -> None:
...
class ReservationRecommendationDetailsUsageProperties(Model):
    """Details about historical usage data that has been used for computing the
    recommendation.

    Variables are only populated by the server, and will be ignored when
    sending a request.

    :ivar first_consumption_date: The first usage date used for looking back
     for computing the recommendation.
    :vartype first_consumption_date: str
    :ivar last_consumption_date: The last usage date used for looking back for
     computing the recommendation.
    :vartype last_consumption_date: str
    :ivar look_back_unit_type: What the usage data values represent ex:
     virtual machine instance.
    :vartype look_back_unit_type: str
    :ivar usage_data: The breakdown of historical resource usage.  The values
     are in the order of usage between the firstConsumptionDate and the
     lastConsumptionDate.
    :vartype usage_data: list[float]
    :ivar usage_grain: The grain of the values represented in the usage data
     ex: hourly.
