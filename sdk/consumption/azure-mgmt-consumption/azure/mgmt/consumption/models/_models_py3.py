...
class Budget(ProxyResource):
    ...
    :param filter: May be used to filter budgets by resource group, resource,
     or meter.
...
class Notification(Model):
    ...
    def __init__(self, *, enabled: bool, operator, threshold, contact_emails, contact_roles=None, contact_groups=None, threshold_type=None, **kwargs) -> None:
