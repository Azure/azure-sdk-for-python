...
class TestQuotaMgmtGroupQuotaLimitsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(QuotaMgmtClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_group_quota_limits_list(self, resource_group):
        response = self.client.group_quota_limits.list(
