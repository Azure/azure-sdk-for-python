...
# USAGE
    python get_machine_learning_services_usages.py
...
# x-ms-original-file: specification/quota/resource-manager/Microsoft.Quota/stable/2025-09-01/examples/getMachineLearningServicesUsages.json
