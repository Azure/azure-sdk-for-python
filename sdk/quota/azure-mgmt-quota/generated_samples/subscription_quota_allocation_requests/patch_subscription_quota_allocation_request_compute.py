...
# USAGE
    python patch_subscription_quota_allocation_request_compute.py
...
def main():
    ...
    response = client.group_quota_subscription_allocation_request.begin_update(
...
# x-ms-original-file: specification/quota/resource-manager/Microsoft.Quota/stable/2025-09-01/examples/SubscriptionQuotaAllocationRequests/PatchSubscriptionQuotaAllocationRequest-Compute.json
