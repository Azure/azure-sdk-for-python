...
class QuotaResourceProvidersOperations(object):
    ...
    def list(
        ...
        :return: ResourceProvidersList or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.quota.models.ResourceProvidersList or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ResourceProvidersList', response)
        ...
        return deserialized
    list.metadata = {'url': '/providers/Microsoft.Quota/quotaLimitProviders'}
