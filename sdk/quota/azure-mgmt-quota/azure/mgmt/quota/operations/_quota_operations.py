...
def build_get_request(resource_name: str, scope: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.Quota/quotas/{resourceName}")
...
def build_create_or_update_request(resource_name: str, scope: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(resource_name: str, scope: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_request(scope: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.Quota/quotas")
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
    }
...
class QuotaOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either CurrentQuotaLimitBase or the result of
         cls(response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type create_quota_request: ~azure.mgmt.quota.models.CurrentQuotaLimitBase or IO[bytes]
        :return: An instance of LROPoller that returns either CurrentQuotaLimitBase or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.quota.models.CurrentQuotaLimitBase]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> Iterable["_models.CurrentQuotaLimitBase"]:
        # pylint: disable=line-too-long
