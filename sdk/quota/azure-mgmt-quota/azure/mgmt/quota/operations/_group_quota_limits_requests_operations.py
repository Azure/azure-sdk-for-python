...
def build_get_request(
    mg_id: str, resource_provider_scope: str, group_quota_name: str, request_id_parameter: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class GroupQuotaLimitsRequestsOperations:
    ...
    def list(
        ...
        history is maintained for 1 year.
    ...
    list.metadata = {
        "url": "/providers/Microsoft.Management/managementGroups/{mgId}/{resourceProviderScope}/providers/Microsoft.Quota/groupQuotas/{groupQuotaName}/groupQuotaRequests"
    }

    @distributed_trace
    def get(
        self, mg_id: str, resource_provider_scope: str, group_quota_name: str, request_id_parameter: str, **kwargs: Any
    ...
    get.metadata = {
        "url": "/providers/Microsoft.Management/managementGroups/{mgId}/{resourceProviderScope}/providers/Microsoft.Quota/groupQuotas/{groupQuotaName}/groupQuotaRequests/{requestId}"
    }
