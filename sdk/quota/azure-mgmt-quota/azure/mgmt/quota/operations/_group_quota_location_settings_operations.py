...
class GroupQuotaLocationSettingsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.GroupQuotasEnforcementResponse]:
        ...
        :return: An instance of LROPoller that returns either GroupQuotasEnforcementResponse or An
         instance of LROPoller that returns either LROResponse or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.quota.models.GroupQuotasEnforcementResponse]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.GroupQuotasEnforcementResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.GroupQuotasEnforcementResponse](
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either GroupQuotasEnforcementResponse or the
    ...
    def list(
    ...
    ) -> Iterable["_models.GroupQuotasEnforcementResponse"]:
        ...
        :return: An iterator like instance of either GroupQuotasEnforcementResponse or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.quota.models.GroupQuotasEnforcementResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
