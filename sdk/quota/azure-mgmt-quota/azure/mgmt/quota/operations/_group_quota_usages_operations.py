...
class GroupQuotaUsagesOperations:
    ...
    def list(
    ...
    ) -> Iterable["_models.ResourceUsages"]:
        ...
        :type location: str
        :return: An iterator like instance of either ResourceUsages or the result of cls(response)
        ...
        cls: ClsType[_models.ResourceUsageList] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ResourceUsageList", pipeline_response)
