...
def build_create_or_update_request(mg_id: str, group_quota_name: str, **kwargs: Any) -> HttpRequest:
...
def build_update_request(mg_id: str, group_quota_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_request(mg_id: str, group_quota_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_request(mg_id: str, group_quota_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_request(mg_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/providers/Microsoft.Management/managementGroups/{mgId}/providers/Microsoft.Quota/groupQuotas"
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "mgId": _SERIALIZER.url("mg_id", mg_id, "str", max_length=63, min_length=3),
    }
...
class GroupQuotasOperations:
    ...
    def _create_or_update_initial(
        ...
        group_quota_put_request_body: Optional[Union[_models.GroupQuotasEntity, IO]] = None,
        **kwargs: Any
    ) -> _models.GroupQuotasEntity:
        error_map = {
    ...
    _create_or_update_initial.metadata = {
        "url": "/providers/Microsoft.Management/managementGroups/{mgId}/providers/Microsoft.Quota/groupQuotas/{groupQuotaName}"
    }
    ...
    def begin_create_or_update(
        ...
        mg_id: str,
        group_quota_name: str,
        group_quota_put_request_body: Optional[IO] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.GroupQuotasEntity]:
        ...
        :param group_quota_put_request_body: The GroupQuota body details for creation or update of a
         GroupQuota entity. Default value is None.
        :type group_quota_put_request_body: IO
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type group_quota_name: str
        :param group_quota_put_request_body: The GroupQuota body details for creation or update of a
         GroupQuota entity. Is either a GroupQuotasEntity type or a IO type. Default value is None.
        :type group_quota_put_request_body: ~azure.mgmt.quota.models.GroupQuotasEntity or IO
    ...
    def _update_initial(
        ...
        mg_id: str,
        group_quota_name: str,
        group_quotas_patch_request_body: Optional[Union[_models.GroupQuotasEntity, IO]] = None,
        **kwargs: Any
        ...
        if isinstance(group_quotas_patch_request_body, (IOBase, bytes)):
            ...
            if group_quotas_patch_request_body is not None:
                _json = self._serialize.body(group_quotas_patch_request_body, "GroupQuotasEntity")
            else:
                _json = None
    ...
    def begin_update(
        ...
        mg_id: str,
        group_quota_name: str,
        group_quotas_patch_request_body: Optional[_models.GroupQuotasEntity] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.GroupQuotasEntity]:
        ...
        :type group_quotas_patch_request_body: ~azure.mgmt.quota.models.GroupQuotasEntity
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        mg_id: str,
        group_quota_name: str,
        group_quotas_patch_request_body: Optional[IO] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.GroupQuotasEntity]:
        ...
        :type group_quota_name: str
        :param group_quotas_patch_request_body: The  GroupQuotas Patch Request. Default value is None.
        :type group_quotas_patch_request_body: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param group_quotas_patch_request_body: The  GroupQuotas Patch Request. Is either a
         GroupQuotasEntity type or a IO type. Default value is None.
        :type group_quotas_patch_request_body: ~azure.mgmt.quota.models.GroupQuotasEntity or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @distributed_trace
    def get(self, mg_id: str, group_quota_name: str, **kwargs: Any) -> _models.GroupQuotasEntity:
    ...
    @distributed_trace
    def list(self, mg_id: str, **kwargs: Any) -> Iterable["_models.GroupQuotasEntity"]:
    ...
    list.metadata = {
        "url": "/providers/Microsoft.Management/managementGroups/{mgId}/providers/Microsoft.Quota/groupQuotas"
    }
