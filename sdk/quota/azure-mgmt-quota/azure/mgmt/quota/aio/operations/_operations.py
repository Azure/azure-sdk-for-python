...
from ...operations._operations import (
    ...
    build_group_quota_limits_request_list_request,
    build_group_quota_limits_request_update_request,
    build_group_quota_location_settings_create_or_update_request,
    build_group_quota_location_settings_get_request,
    build_group_quota_location_settings_update_request,
    build_group_quota_subscription_allocation_list_request,
    build_group_quota_subscription_allocation_request_get_request,
    build_group_quota_subscription_allocation_request_list_request,
    build_group_quota_subscription_allocation_request_update_request,
    build_group_quota_subscription_requests_get_request,
    build_group_quota_subscription_requests_list_request,
    build_group_quota_subscriptions_create_or_update_request,
    build_group_quota_subscriptions_delete_request,
    build_group_quota_subscriptions_get_request,
    build_group_quota_subscriptions_list_request,
    build_group_quota_subscriptions_update_request,
    build_group_quota_usages_list_request,
    build_group_quotas_create_or_update_request,
    build_group_quotas_delete_request,
...
class GroupQuotasOperations:
    ...
    @distributed_trace_async
    async def get(self, management_group_id: str, group_quota_name: str, **kwargs: Any) -> _models.GroupQuotasEntity:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.GroupQuotasEntity].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.GroupQuotasEntity](
    ...
    @distributed_trace
    def list(self, management_group_id: str, **kwargs: Any) -> AsyncItemPaged["_models.GroupQuotasEntity"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.quota.models.GroupQuotasEntity]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class GroupQuotaLimitsRequestOperations:
    ...
    def list(
        ...
        *,
        filter: str,
        **kwargs: Any
    ) -> AsyncItemPaged["_models.SubmittedResourceRequestStatus"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.quota.models.SubmittedResourceRequestStatus]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.GroupQuotaLimitList].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.GroupQuotaLimitList](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
...
class GroupQuotaUsagesOperations:
    ...
    def list(
    ...
    ) -> AsyncItemPaged["_models.ResourceUsages"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.quota.models.ResourceUsages]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class GroupQuotaSubscriptionsOperations:
    ...
    async def begin_create_or_update(
        self, management_group_id: str, group_quota_name: str, **kwargs: Any
    ) -> AsyncLROPoller[_models.GroupQuotaSubscriptionId]:
        ...
        :param group_quota_name: The GroupQuota name. The name should be unique for the provided
         context tenantId/MgId. Required.
        :type group_quota_name: str
        :return: An instance of AsyncLROPoller that returns GroupQuotaSubscriptionId. The
         GroupQuotaSubscriptionId is compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.quota.models.GroupQuotaSubscriptionId]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.GroupQuotaSubscriptionId].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.GroupQuotaSubscriptionId](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    def list(
        self, management_group_id: str, group_quota_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.GroupQuotaSubscriptionId"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.quota.models.GroupQuotaSubscriptionId]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class GroupQuotaSubscriptionRequestsOperations:
    ...
    def list(
        self, management_group_id: str, group_quota_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.GroupQuotaSubscriptionRequestStatus"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.quota.models.GroupQuotaSubscriptionRequestStatus]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class QuotaOperations:
    ...
    @distributed_trace
    def list(self, scope: str, **kwargs: Any) -> AsyncItemPaged["_models.CurrentQuotaLimitBase"]:
