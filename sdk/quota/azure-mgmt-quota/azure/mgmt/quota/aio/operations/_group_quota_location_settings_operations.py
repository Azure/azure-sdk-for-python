...
class GroupQuotaLocationSettingsOperations:
    ...
    async def _create_or_update_initial(
        ...
        location: str,
        location_settings: Optional[Union[_models.GroupQuotasEnforcementStatus, IO[bytes]]] = None,
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        ...
        if isinstance(location_settings, (IOBase, bytes)):
            ...
            if location_settings is not None:
                _json = self._serialize.body(location_settings, "GroupQuotasEnforcementStatus")
            else:
                _json = None
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either GroupQuotasEnforcementStatus or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.quota.models.GroupQuotasEnforcementStatus]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param location_settings: The GroupQuota body details for creation or update of a GroupQuota
         ...
         None.
        :type location_settings: ~azure.mgmt.quota.models.GroupQuotasEnforcementStatus or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either GroupQuotasEnforcementStatus or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.quota.models.GroupQuotasEnforcementStatus]
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("GroupQuotasEnforcementStatus", pipeline_response.http_response)
            if cls:
        ...
        if cont_token:
            return AsyncLROPoller[_models.GroupQuotasEnforcementStatus].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.GroupQuotasEnforcementStatus](
    ...
    async def get(
        ...
        :param location: The name of the Azure region. Required.
        :type location: str
        :return: GroupQuotasEnforcementStatus or the result of cls(response)
