...
from ...operations._group_quota_limits_requests_operations import build_get_request, build_list_request
...
class GroupQuotaLimitsRequestsOperations:
    ...
    ) -> AsyncIterable["_models.SubmittedResourceRequestStatus"]:
