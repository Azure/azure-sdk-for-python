...
from ...operations._group_quotas_operations import (
...
class GroupQuotasOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either GroupQuotasEntity or An instance of
         AsyncLROPoller that returns either LROResponse or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.quota.models.GroupQuotasEntity] or
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either GroupQuotasEntity or the result of
         cls(response)
    ...
    @distributed_trace
    def list(self, management_group_id: str, **kwargs: Any) -> AsyncIterable["_models.GroupQuotasEntity"]:
