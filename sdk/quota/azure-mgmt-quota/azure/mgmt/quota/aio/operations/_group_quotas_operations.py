...
class GroupQuotasOperations:
    ...
    @distributed_trace_async
    async def get(self, mg_id: str, group_quota_name: str, **kwargs: Any) -> _models.GroupQuotasEntity:
    ...
    @distributed_trace
    def list(self, mg_id: str, **kwargs: Any) -> AsyncIterable["_models.GroupQuotasEntity"]:
