...
from ...operations._group_quota_limits_operations import build_get_request, build_list_request
...
class GroupQuotaLimitsOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.GroupQuotaLimit"]:
        """Gets the GroupQuotaLimits for all the resources for the specified location in $filter=location
        eq {location}.

        Gets the GroupQuotaLimits for the all resource for a specific  resourceProvider and $filter
        passed.
        The $filter=location eq {location} is required to location specific resources groupQuota.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.quota.models.GroupQuotaLimit]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
