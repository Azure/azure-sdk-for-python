...
class QuotaOperationOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.OperationResponse"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.quota.models.OperationResponse]
    ...
    list.metadata = {"url": "/providers/Microsoft.Quota/operations"}
