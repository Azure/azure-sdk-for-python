...
from ...operations._group_quota_subscriptions_operations import (
...
class GroupQuotaSubscriptionsOperations:
    ...
    async def begin_create_or_update(
        ...
        :return: An instance of AsyncLROPoller that returns either GroupQuotaSubscriptionId or An
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.quota.models.GroupQuotaSubscriptionId]
         or ~azure.core.polling.AsyncLROPoller[~azure.mgmt.quota.models.LROResponse]
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("GroupQuotaSubscriptionId", pipeline_response.http_response)
            if cls:
    ...
    async def begin_update(
        ...
        :param group_quota_name: The GroupQuota name. The name should be unique for the provided
         context tenantId/MgId. Required.
        :type group_quota_name: str
        :return: An instance of AsyncLROPoller that returns either GroupQuotaSubscriptionId or the
    ...
    def list(
        self, management_group_id: str, group_quota_name: str, **kwargs: Any
    ) -> AsyncIterable["_models.GroupQuotaSubscriptionId"]:
