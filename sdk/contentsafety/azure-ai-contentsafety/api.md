...
namespace azure.ai.contentsafety
    ...
    class azure.ai.contentsafety.ContentSafetyClient(_ContentSafetyClientOperationsMixin): implements ContextManager 
        ...
        @overload
        def unified_moderate(
                self, 
                options: UnifiedModerateOptions, 
                *, 
                content_type: str = "application/json", 
                **kwargs: Any
...
namespace azure.ai.contentsafety.models
    ...
    class azure.ai.contentsafety.models.AcsApproval(_Model):
        type: str
    ...
    class azure.ai.contentsafety.models.AcsDecision(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        ALLOW = "allow"
        DENY = "deny"
        TRANSFORM = "transform"


    class azure.ai.contentsafety.models.AcsEvidence(_Model):
    ...
    class azure.ai.contentsafety.models.AcsHarmDetail(_Model):
        detected: bool
        id: str
    ...
    class azure.ai.contentsafety.models.AcsHarmResult(_Model):
        blocked: bool
        details: Optional[list[AcsHarmDetail]]
        detected: bool
    ...
    class azure.ai.contentsafety.models.AcsTransform(_Model):
        path: str
        value: str
    ...
    class azure.ai.contentsafety.models.AcsVerdict(_Model):
        approval: Optional[AcsApproval]
        decision: Union[str, AcsDecision]
        evidence: Optional[list[AcsEvidence]]
        harm_results: Optional[dict[str, AcsHarmResult]]
        message: Optional[str]
        reason: Optional[str]
        transform: Optional[AcsTransform]
    ...
    class azure.ai.contentsafety.models.UnifiedModerateContext(_Model):
    ...
    class azure.ai.contentsafety.models.UnifiedModerateOptions(_Model):
        content: str
        context: Optional[UnifiedModerateContext]
        policy_id: Optional[str]
        source: Union[str, UnifiedModerateSource]
        target_resource_id: Optional[str]
        tool_arguments: Optional[str]
        tool_call_id: Optional[str]
        tool_duration_ms: Optional[float]
        tool_name: Optional[str]
        tool_result_is_error: Optional[bool]
    ...
    class azure.ai.contentsafety.models.UnifiedModerateResult(_Model):
        acs_verdict: AcsVerdict
        content: Optional[str]
        reason: Optional[str]
        verdict: Union[str, UnifiedModerateVerdict]
    ...
    class azure.ai.contentsafety.models.UnifiedModerateSource(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        INPUT = "input"
        OUTPUT = "output"
    ...
    class azure.ai.contentsafety.models.UnifiedModerateVerdict(str, Enum, metaclass=CaseInsensitiveEnumMeta):
        ALLOWED = "allowed"
        BLOCKED = "blocked"
...
namespace azure.ai.contentsafety.types
    ...
    class azure.ai.contentsafety.types.AddOrUpdateTextBlocklistItemsOptions(TypedDict, total=False):
        ...
        blocklistItems: list[TextBlocklistItem]
    ...
    class azure.ai.contentsafety.types.UnifiedModerateContext(TypedDict, total=False):
        key "agentId": str
    ...
    class azure.ai.contentsafety.types.UnifiedModerateOptions(TypedDict, total=False):
        key "content": Required[str]
        key "context": ForwardRef('UnifiedModerateContext', module='types')
        key "policyId": str
        key "source": Required[Union[str, UnifiedModerateSource]]
        key "targetResourceId": str
        key "toolArguments": str
        key "toolCallId": str
        key "toolDurationMs": float
        key "toolName": str
        key "toolResultIsError": bool
        content: str
