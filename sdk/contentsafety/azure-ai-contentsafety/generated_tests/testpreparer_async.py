...
# --------------------------------------------------------------------------
from azure.ai.contentsafety.aio import BlocklistClient, ContentProvenanceClient, ContentSafetyClient
...
class ContentProvenanceClientTestBaseAsync(AzureRecordedTestCase):

    def create_async_client(self, endpoint):
        credential = self.get_credential(ContentProvenanceClient, is_async=True)
        return self.create_client_from_credential(
