...
def build_content_safety_unified_moderate_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class _ContentSafetyClientOperationsMixin(
    ...
    @api_version_validation(
        ...
        api_versions_list=["2024-09-01", "2026-09-01-preview"],
    )
    def detect_text_protected_material(
        self,
        options: Union[
    ...
    def unified_moderate(
        self, options: _models.UnifiedModerateOptions, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.UnifiedModerateResult:
        """Unified Moderate.

        A synchronous API that evaluates input, output, a proposed tool call, or a completed tool
        result against an applicable Agent Control Specification policy and returns the enforced
        content and policy verdict.

        :param options: The unified moderation request. Required.
        :type options: ~azure.ai.contentsafety.models.UnifiedModerateOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: UnifiedModerateResult. The UnifiedModerateResult is compatible with MutableMapping
        :rtype: ~azure.ai.contentsafety.models.UnifiedModerateResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """

    @overload
    def unified_moderate(
        self, options: _types.UnifiedModerateOptions, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.UnifiedModerateResult:
        """Unified Moderate.
        ...
        :param options: The unified moderation request. Required.
        :type options: ~azure.ai.contentsafety.types.UnifiedModerateOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: UnifiedModerateResult. The UnifiedModerateResult is compatible with MutableMapping
    ...
    @distributed_trace
    def unified_moderate(
        self, options: Union[_models.UnifiedModerateOptions, _types.UnifiedModerateOptions, IO[bytes]], **kwargs: Any
    ) -> _models.UnifiedModerateResult:
        """Unified Moderate.
        ...
        :param options: The unified moderation request. Is either a UnifiedModerateOptions type or a
         IO[bytes] type. Required.
        :type options: ~azure.ai.contentsafety.models.UnifiedModerateOptions or
         ~azure.ai.contentsafety.types.UnifiedModerateOptions or IO[bytes]
        :return: UnifiedModerateResult. The UnifiedModerateResult is compatible with MutableMapping
        :rtype: ~azure.ai.contentsafety.models.UnifiedModerateResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.UnifiedModerateResult] = kwargs.pop("cls", None)
        ...
        _request = build_content_safety_unified_moderate_request(
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
            headers=_headers,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.UnifiedModerateResult, response.json())
