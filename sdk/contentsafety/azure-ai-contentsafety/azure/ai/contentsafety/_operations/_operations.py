...
class BlocklistClientOperationsMixin(BlocklistClientMixinABC):
    ...
    def list_text_blocklist_items(
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models.TextBlocklistItem], deserialized.get("value", []))
            if cls:
    ...
    def list_text_blocklists(self, **kwargs: Any) -> Iterable["_models.TextBlocklist"]:
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.TextBlocklist], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, iter(list_of_elem)
