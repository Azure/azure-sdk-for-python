...
def add_sanitizers(test_proxy):
    content_safety_endpoint = os.environ.get("CONTENT_SAFETY_KEY", "00000000000000000000000000000000")
    ...
    add_general_regex_sanitizer(regex=content_safety_endpoint, value="https://fake_cs_resource.cognitiveservices.azure.com/")