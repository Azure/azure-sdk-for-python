...
class VoiceAgentsClient:
    ...
    :ivar voice_agents: VoiceAgentsOperations operations
    :vartype voice_agents: azure.ai.voiceagents.operations.VoiceAgentsOperations
    ...
    def __init__(self, endpoint: str, credential: "TokenCredential", **kwargs: Any) -> None:
        _endpoint = "{endpoint}"
        self._config = VoiceAgentsClientConfiguration(endpoint=endpoint, credential=credential, **kwargs)
        ...
        self.voice_agents = VoiceAgentsOperations(self._client, self._config, self._serialize, self._deserialize)
