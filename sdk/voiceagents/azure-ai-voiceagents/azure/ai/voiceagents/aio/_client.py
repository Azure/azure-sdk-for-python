...
class VoiceAgentsClient:  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :vartype voice_agent_web_socket:
     azure.ai.voiceagents.aio.operations.VoiceAgentWebSocketOperations
    :ivar agent_endpoint_conversations: AgentEndpointConversationsOperations operations
    :vartype agent_endpoint_conversations:
     azure.ai.voiceagents.aio.operations.AgentEndpointConversationsOperations
    :ivar voice_agents: VoiceAgentsOperations operations
    :vartype voice_agents: azure.ai.voiceagents.aio.operations.VoiceAgentsOperations
