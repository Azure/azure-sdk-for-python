...
import json
from typing import Any, Callable, IO, Iterator, Literal, Optional, TYPE_CHECKING, TypeVar, Union, overload
...
def build_agent_endpoint_conversations_get_agent_conversation_request(  # pylint: disable=name-too-long
    ...
    conversation_id: str,
    *,
    foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_voice_agents_create_voice_agent_request(  # pylint: disable=name-too-long
    *, foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_voice_agents_list_voice_agents_request(  # pylint: disable=name-too-long
    *,
    foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None,
    limit: Optional[int] = None,
    order: Optional[Union[str, _models.PageOrder]] = None,
...
def build_voice_agents_get_voice_agent_request(  # pylint: disable=name-too-long
    agent_name: str,
    *,
    foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None,
    **kwargs: Any
...
def build_voice_agents_update_voice_agent_request(  # pylint: disable=name-too-long
    agent_name: str,
    *,
    foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None,
    **kwargs: Any
...
def build_voice_agents_delete_voice_agent_request(  # pylint: disable=name-too-long
    agent_name: str,
    *,
    foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None,
    **kwargs: Any
...
def build_voice_agents_enable_voice_agent_request(  # pylint: disable=name-too-long
    agent_name: str,
    *,
    foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None,
    **kwargs: Any
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "v1"))
    # Construct URL
    _url = "/voice_agents/{agent_name}:enable"
    path_format_arguments = {
        "agent_name": _SERIALIZER.url("agent_name", agent_name, "str"),
    }
...
def build_voice_agents_disable_voice_agent_request(  # pylint: disable=name-too-long
    agent_name: str,
    *,
    foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None,
    **kwargs: Any
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "v1"))
    # Construct URL
    _url = "/voice_agents/{agent_name}:disable"
    path_format_arguments = {
        "agent_name": _SERIALIZER.url("agent_name", agent_name, "str"),
    }
...
def build_voice_agents_generate_voice_agent_request(  # pylint: disable=name-too-long
    *, foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_voice_agents_create_voice_agent_version_request(  # pylint: disable=name-too-long
    agent_name: str,
    *,
    foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/voice_agents/{agent_name}/versions"
    path_format_arguments = {
        "agent_name": _SERIALIZER.url("agent_name", agent_name, "str"),
    }
...
def build_voice_agents_list_voice_agent_versions_request(  # pylint: disable=name-too-long
    agent_name: str,
    *,
    foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None,
    limit: Optional[int] = None,
...
def build_voice_agents_get_voice_agent_version_request(  # pylint: disable=name-too-long
    agent_name: str,
    agent_version: str,
    *,
    foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/voice_agents/{agent_name}/versions/{agent_version}"
    path_format_arguments = {
        "agent_name": _SERIALIZER.url("agent_name", agent_name, "str"),
...
def build_voice_agents_delete_voice_agent_version_request(  # pylint: disable=name-too-long
    agent_name: str,
    agent_version: str,
    *,
    foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None,
...
class AgentEndpointConversationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.ai.voiceagents.VoiceAgentsClient`'s
    ...
    def get_agent_conversation(
        ...
        **kwargs: Any
        ...
        :keyword foundry_features: A feature flag opt-in required when using preview operations or
         modifying persisted preview resources. VOICE_AGENTS_V1_PREVIEW. Default value is None.
    ...
    def delete_agent_conversation(
        ...
        *,
        foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None,
        **kwargs: Any
    ) -> _models.VoiceDeletedConversation:
        ...
        :keyword foundry_features: A feature flag opt-in required when using preview operations or
         modifying persisted preview resources. VOICE_AGENTS_V1_PREVIEW. Default value is None.
        :paramtype foundry_features: str or ~azure.ai.voiceagents.models.VOICE_AGENTS_V1_PREVIEW
        :return: VoiceDeletedConversation. The VoiceDeletedConversation is compatible with
         MutableMapping
        :rtype: ~azure.ai.voiceagents.models.VoiceDeletedConversation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.VoiceDeletedConversation] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.VoiceDeletedConversation, response.json())
    ...
    def list_agent_conversation_responses(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.voiceagents.models.VoiceResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def list_agent_conversation_response_items(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.voiceagents.models.VoiceSystemMessageItem or
    ...
    def get_agent_conversation_item(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.ai.voiceagents.models.VoiceSystemMessageItem or
         ~azure.ai.voiceagents.models.VoiceUserMessageItem or
         ~azure.ai.voiceagents.models.VoiceAssistantMessageItem or
         ~azure.ai.voiceagents.models.VoiceFunctionCallItem or
         ~azure.ai.voiceagents.models.VoiceFunctionCallOutputItem or
    ...
    def get_agent_conversation_item_audio(
        ...
        **kwargs: Any
        ...
        ``blob_path``, a direct path into the customer's own storage (no SAS) that the customer
    ...
    def get_agent_conversation_item_audio_content(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        directly from customer storage using the ``blob_path`` returned by the item's ``/audio``
    ...
    def get_agent_conversation_audio(
        ...
        **kwargs: Any
        ...
        for BYOS the response additionally includes ``blob_path``, a direct path into the customer's
        own storage (no SAS) that the customer downloads with their own credentials. The recording is
        built once from the per-turn segments after the session ends; a request against an in-progress
        session returns ``409``. Requires the conversation to have persisted audio (``store = true``);
    ...
    def get_agent_conversation_audio_content(
        ...
        **kwargs: Any
        ...
        service (no SAS URL). This route serves Foundry-managed storage only. For
        bring-your-own-storage (BYOS) recordings the bytes are not proxied — the caller must download
        directly from customer storage using the ``blob_path`` returned by the metadata route — so this
...
class VoiceAgentsOperations:
    ...
    @distributed_trace
    def create_voice_agent(  # pylint: disable=too-many-locals
        self,
    ...
    def list_voice_agents(
        ...
        *,
        ...
        before: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.VoiceAgentObject"]:
        """List voice agents.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.voiceagents.models.VoiceAgentObject]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def delete_voice_agent(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.ai.voiceagents.models.DeleteAgentResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    @distributed_trace
    def enable_voice_agent(  # pylint: disable=inconsistent-return-statements
        self,
        agent_name: str,
        *,
        foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None,
    ...
    @distributed_trace
    def disable_voice_agent(  # pylint: disable=inconsistent-return-statements
        self,
        agent_name: str,
        *,
        foundry_features: Optional[Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW]] = None,
    ...
    def generate_voice_agent(
        ...
        **kwargs: Any
        ...
        :paramtype tools: list[~azure.ai.voiceagents.models.FunctionTool or
    ...
    @distributed_trace
    def generate_voice_agent(  # pylint: disable=too-many-locals
        self,
    ...
    def list_voice_agent_versions(
        ...
        *,
        ...
        include_drafts: Optional[bool] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.VoiceAgentVersionObject"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.voiceagents.models.VoiceAgentVersionObject]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    def delete_voice_agent_version(
        ...
        **kwargs: Any
        ...
        :return: DeleteAgentVersionResponse. The DeleteAgentVersionResponse is compatible with
         MutableMapping
        :rtype: ~azure.ai.voiceagents.models.DeleteAgentVersionResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
