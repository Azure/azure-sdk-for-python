...
def build_voice_agents_create_voice_agent_request(  # pylint: disable=name-too-long
    *, foundry_features: Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW], **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_voice_agents_get_voice_agent_request(  # pylint: disable=name-too-long
    agent_name: str, *, foundry_features: Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW], **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class VoiceAgentWebSocketOperations:  # pylint: disable=docstring-missing-param
    ...
    def connect_voice_agent(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        websocket`` headers. The optional ``realtime`` subprotocol is the only accepted subprotocol
        value.
        ...
        :paramtype websocket_subprotocol: str or
         ~azure.ai.voiceagents.models.VoiceAgentWebSocketSubprotocol
...
class AgentEndpointConversationsOperations:  # pylint: disable=docstring-missing-param
    ...
    def list_agent_conversation_response_items(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.voiceagents.models.VoiceConversationItem]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class VoiceAgentsOperations:  # pylint: disable=docstring-missing-param
    ...
    @distributed_trace
    def delete_voice_agent(  # pylint: disable=inconsistent-return-statements
        self,
        agent_name: str,
        *,
        foundry_features: Literal[AgentDefinitionOptInKeys.VOICE_AGENTS_V1_PREVIEW],
    ...
    @distributed_trace
    def delete_voice_agent_version(  # pylint: disable=inconsistent-return-statements
        self,
        agent_name: str,
        agent_version: str,
        *,
