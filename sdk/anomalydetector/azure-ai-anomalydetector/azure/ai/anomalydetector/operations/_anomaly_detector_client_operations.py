...
class AnomalyDetectorClientOperationsMixin(object):
    ...
    def train_multivariate_model(
            self, model_request, custom_headers=None, raw=False, **operation_config):
    ...
    def detect_anomaly(
            self, detection_request, model_id, custom_headers=None, raw=False, **operation_config):
        ...
        :type detection_request:
         ~azure.ai.anomalydetector.models.DetectionRequest
        :param model_id: Model identifier.
        :type model_id: str
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
    ...
    def export_model(
            self, model_id, custom_headers=None, raw=False, callback=None, **operation_config):
