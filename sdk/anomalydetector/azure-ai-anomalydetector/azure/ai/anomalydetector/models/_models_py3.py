...
class AlignPolicy(Model):
    ...
    def __init__(self, *, align_mode=None, fill_na_method=None, padding_value: int=None, **kwargs) -> None:
...
class AnomalyContributor(Model):
    ...
    def __init__(self, *, contribution_score: float=None, variable: str=None, **kwargs) -> None:
...
class AnomalyValue(Model):
    ...
    def __init__(self, *, is_anomaly: bool, severity: float, contributors=None, score: float=None, **kwargs) -> None:
...
class DetectRequest(Model):
    ...
    def __init__(self, *, series, granularity=None, custom_interval: int=None, period: int=None, max_anomaly_ratio: float=None, sensitivity: int=None, **kwargs) -> None:
...
class VariableState(Model):
    ...
    def __init__(self, *, variable: str=None, filled_na_ratio: float=None, effective_count: int=None, start_time=None, end_time=None, errors=None, **kwargs) -> None:
