...
class BuildServiceBuilderOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type builder_resource: ~azure.mgmt.appplatform.v2022_04_01.models.BuilderResource or IO[bytes]
        :return: An instance of LROPoller that returns either BuilderResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2022_04_01.models.BuilderResource]
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2022_04_01.models.BuilderResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
