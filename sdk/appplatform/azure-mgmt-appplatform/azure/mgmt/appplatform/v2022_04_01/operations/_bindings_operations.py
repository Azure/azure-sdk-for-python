...
class BindingsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.appplatform.v2022_04_01.AppPlatformManagementClient`'s
    ...
    def get(
        ...
        deserialized = self._deserialize("BindingResource", pipeline_response.http_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type binding_resource: ~azure.mgmt.appplatform.v2022_04_01.models.BindingResource or IO[bytes]
        :return: An instance of LROPoller that returns either BindingResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2022_04_01.models.BindingResource]
        ...
        if cont_token:
            return LROPoller[_models.BindingResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.BindingResource](
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2022_04_01.models.BindingResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
