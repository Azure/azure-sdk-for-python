...
class BuildServiceAgentPoolOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either BuildServiceAgentPoolResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2022_04_01.models.BuildServiceAgentPoolResource]
    ...
    def get(
        ...
        deserialized = self._deserialize("BuildServiceAgentPoolResource", pipeline_response.http_response)
    ...
    def begin_update_put(
        ...
        **kwargs: Any
        ...
        :type agent_pool_resource:
         ~azure.mgmt.appplatform.v2022_04_01.models.BuildServiceAgentPoolResource or IO[bytes]
        :return: An instance of LROPoller that returns either BuildServiceAgentPoolResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2022_04_01.models.BuildServiceAgentPoolResource]
