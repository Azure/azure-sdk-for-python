...
class AppPlatformManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.services = ServicesOperations(self._client, self._config, self._serialize, self._deserialize, "2022-04-01")
        ...
        self.apps = AppsOperations(self._client, self._config, self._serialize, self._deserialize, "2022-04-01")
        self.bindings = BindingsOperations(self._client, self._config, self._serialize, self._deserialize, "2022-04-01")
        ...
        self.skus = SkusOperations(self._client, self._config, self._serialize, self._deserialize, "2022-04-01")
