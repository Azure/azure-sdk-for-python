...
class CustomDomainsOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2022_11_01_preview.models.CustomDomainResource
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type domain_resource: ~azure.mgmt.appplatform.v2022_11_01_preview.models.CustomDomainResource
        ...
        :return: An instance of AsyncLROPoller that returns either CustomDomainResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2022_11_01_preview.models.CustomDomainResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        :return: An iterator like instance of either CustomDomainResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2022_11_01_preview.models.CustomDomainResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
