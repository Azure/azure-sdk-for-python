...
class ConfigServersOperations:
    ...
    async def get(self, resource_group_name: str, service_name: str, **kwargs: Any) -> _models.ConfigServerResource:
        ...
        :rtype: ~azure.mgmt.appplatform.v2022_11_01_preview.models.ConfigServerResource
    ...
    async def begin_update_put(
        ...
        **kwargs: Any
        ...
        :type config_server_resource:
         ~azure.mgmt.appplatform.v2022_11_01_preview.models.ConfigServerResource
        ...
        :return: An instance of AsyncLROPoller that returns either ConfigServerResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2022_11_01_preview.models.ConfigServerResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update_put(
        ...
        **kwargs: Any
        ...
        :type config_server_resource:
         ~azure.mgmt.appplatform.v2022_11_01_preview.models.ConfigServerResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ConfigServerResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2022_11_01_preview.models.ConfigServerResource]
    ...
    async def begin_validate(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2022_11_01_preview.models.ConfigServerSettingsValidateResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_validate(
        ...
        **kwargs: Any
        ...
        :type config_server_settings:
         ~azure.mgmt.appplatform.v2022_11_01_preview.models.ConfigServerSettings or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ConfigServerSettingsValidateResult
         or the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2022_11_01_preview.models.ConfigServerSettingsValidateResult]
