...
class ApiPortalsOperations:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2022_11_01_preview.models.ApiPortalResource
        ...
        deserialized = self._deserialize("ApiPortalResource", pipeline_response.http_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type api_portal_resource: ~azure.mgmt.appplatform.v2022_11_01_preview.models.ApiPortalResource
        ...
        :return: An instance of LROPoller that returns either ApiPortalResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2022_11_01_preview.models.ApiPortalResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.ApiPortalResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ApiPortalResource](
    ...
    def list(self, resource_group_name: str, service_name: str, **kwargs: Any) -> Iterable["_models.ApiPortalResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2022_11_01_preview.models.ApiPortalResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def validate_domain(
        ...
        **kwargs: Any
        ...
        :type validate_payload:
         ~azure.mgmt.appplatform.v2022_11_01_preview.models.CustomDomainValidatePayload
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: CustomDomainValidateResult or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2022_11_01_preview.models.CustomDomainValidateResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def validate_domain(
        ...
        **kwargs: Any
        ...
        :type validate_payload:
         ~azure.mgmt.appplatform.v2022_11_01_preview.models.CustomDomainValidatePayload or IO[bytes]
        :return: CustomDomainValidateResult or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2022_11_01_preview.models.CustomDomainValidateResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
