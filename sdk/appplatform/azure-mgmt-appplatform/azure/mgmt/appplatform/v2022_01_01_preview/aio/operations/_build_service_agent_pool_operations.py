...
class BuildServiceAgentPoolOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2022_01_01_preview.models.BuildServiceAgentPoolResourceCollection]
    ...
    async def _update_put_initial(
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(pool_size, 'BuildServiceAgentPoolSizeProperties')
