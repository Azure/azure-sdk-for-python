...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/storages/{storageName}')
...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/storages')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "serviceName": _SERIALIZER.url("service_name", service_name, 'str'),
...
class StoragesOperations(object):
    ...
    def _create_or_update_initial(
        ...
        service_name,  # type: str
        storage_name,  # type: str
        storage_resource,  # type: "_models.StorageResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.StorageResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.StorageResource"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.StorageResource"]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.StorageResourceCollection"]
        ...
        :return: An iterator like instance of either StorageResourceCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2022_01_01_preview.models.StorageResourceCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
