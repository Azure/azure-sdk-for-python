...
class ApplicationLiveViewsOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("ApplicationLiveViewResource", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type application_live_view_resource:
         ~azure.mgmt.appplatform.v2023_09_01_preview.models.ApplicationLiveViewResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ApplicationLiveViewResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_09_01_preview.models.ApplicationLiveViewResource]
