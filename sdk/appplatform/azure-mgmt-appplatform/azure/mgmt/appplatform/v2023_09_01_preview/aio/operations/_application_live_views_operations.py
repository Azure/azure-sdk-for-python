...
from ...operations._application_live_views_operations import (
...
class ApplicationLiveViewsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either ApplicationLiveViewResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2023_09_01_preview.models.ApplicationLiveViewResource]
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/applicationLiveViews"
    }
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_09_01_preview.models.ApplicationLiveViewResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/applicationLiveViews/{applicationLiveViewName}"
    }
    ...
    async def _create_or_update_initial(
        ...
        application_live_view_resource: Union[_models.ApplicationLiveViewResource, IO],
        **kwargs: Any
    ) -> _models.ApplicationLiveViewResource:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_09_01_preview.models.ApplicationLiveViewResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        service_name: str,
        application_live_view_name: str,
        application_live_view_resource: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.ApplicationLiveViewResource]:
        ...
        :type application_live_view_name: str
        :param application_live_view_resource: Parameters for the update operation. Required.
        :type application_live_view_resource: IO
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type application_live_view_resource:
         ~azure.mgmt.appplatform.v2023_09_01_preview.models.ApplicationLiveViewResource or IO
