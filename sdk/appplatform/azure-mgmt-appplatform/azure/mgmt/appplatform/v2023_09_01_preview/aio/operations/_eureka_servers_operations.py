...
class EurekaServersOperations:
    ...
    async def begin_update_put(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either EurekaServerResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_09_01_preview.models.EurekaServerResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update_put(
        ...
        **kwargs: Any
        ...
        :type eureka_server_resource:
         ~azure.mgmt.appplatform.v2023_09_01_preview.models.EurekaServerResource or IO
