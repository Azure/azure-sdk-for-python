...
class ServiceRegistriesOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_09_01_preview.models.ServiceRegistryResource
    ...
    async def begin_create_or_update(
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_09_01_preview.models.ServiceRegistryResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list(
        ...
        :return: An iterator like instance of either ServiceRegistryResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2023_09_01_preview.models.ServiceRegistryResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
