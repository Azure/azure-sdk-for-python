...
class ConfigServersOperations:
    ...
    async def begin_update_put(
        ...
        **kwargs: Any
        ...
        :type config_server_resource:
         ~azure.mgmt.appplatform.v2023_09_01_preview.models.ConfigServerResource or IO
    ...
    async def begin_validate(
        ...
        **kwargs: Any
        ...
        :type config_server_settings:
         ~azure.mgmt.appplatform.v2023_09_01_preview.models.ConfigServerSettings or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
