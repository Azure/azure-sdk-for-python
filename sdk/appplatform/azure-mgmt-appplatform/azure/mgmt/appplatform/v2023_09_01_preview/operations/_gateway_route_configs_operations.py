...
class GatewayRouteConfigsOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("GatewayRouteConfigResource", pipeline_response.http_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gateway_route_config_resource:
         ~azure.mgmt.appplatform.v2023_09_01_preview.models.GatewayRouteConfigResource or IO[bytes]
        :return: An instance of LROPoller that returns either GatewayRouteConfigResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_09_01_preview.models.GatewayRouteConfigResource]
