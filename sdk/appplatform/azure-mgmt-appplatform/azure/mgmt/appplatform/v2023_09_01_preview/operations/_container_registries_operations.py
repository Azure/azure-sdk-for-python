...
def build_get_request(
    resource_group_name: str, service_name: str, container_registry_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "serviceName": _SERIALIZER.url("service_name", service_name, "str", pattern=r"^[a-z][a-z0-9-]*[a-z0-9]$"),
        "containerRegistryName": _SERIALIZER.url(
            "container_registry_name", container_registry_name, "str", pattern=r"^[a-z][a-z0-9-]*[a-z0-9]$"
        ),
    }
...
class ContainerRegistriesOperations:
    ...
    def list(
    ...
    ) -> Iterable["_models.ContainerRegistryResource"]:
        ...
        :return: An iterator like instance of either ContainerRegistryResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_09_01_preview.models.ContainerRegistryResource]
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/containerRegistries"
    }
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_09_01_preview.models.ContainerRegistryResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/containerRegistries/{containerRegistryName}"
    }
    ...
    def _create_or_update_initial(
        ...
        container_registry_resource: Union[_models.ContainerRegistryResource, IO],
        **kwargs: Any
    ) -> _models.ContainerRegistryResource:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.ContainerRegistryResource]:
        ...
        :return: An instance of LROPoller that returns either ContainerRegistryResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_09_01_preview.models.ContainerRegistryResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        service_name: str,
        container_registry_name: str,
        container_registry_resource: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.ContainerRegistryResource]:
        ...
        :type container_registry_name: str
        :param container_registry_resource: Parameters for the create or update operation. Required.
        :type container_registry_resource: IO
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param container_registry_resource: Parameters for the create or update operation. Is either a
         ContainerRegistryResource type or a IO type. Required.
        :type container_registry_resource:
         ~azure.mgmt.appplatform.v2023_09_01_preview.models.ContainerRegistryResource or IO
    ...
    def _validate_initial(
        ...
        service_name: str,
        container_registry_name: str,
        container_registry_properties: Union[_models.ContainerRegistryProperties, IO],
        **kwargs: Any
    ...
    _validate_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/containerRegistries/{containerRegistryName}/validate"
    }
    ...
    def begin_validate(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.ContainerRegistryValidateResult]:
        ...
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no
         Retry-After header is present.
        :return: An instance of LROPoller that returns either ContainerRegistryValidateResult or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_09_01_preview.models.ContainerRegistryValidateResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_validate(
        ...
        service_name: str,
        container_registry_name: str,
        container_registry_properties: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.ContainerRegistryValidateResult]:
        ...
        :type container_registry_name: str
        :param container_registry_properties: Parameters for the validate operation. Required.
        :type container_registry_properties: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_validate(
        ...
        **kwargs: Any
        ...
        :param container_registry_properties: Parameters for the validate operation. Is either a
         ContainerRegistryProperties type or a IO type. Required.
        :type container_registry_properties:
         ~azure.mgmt.appplatform.v2023_09_01_preview.models.ContainerRegistryProperties or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
