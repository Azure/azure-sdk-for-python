...
class CustomizedAcceleratorsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either CustomizedAcceleratorResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.models.CustomizedAcceleratorResource]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type customized_accelerator_resource:
         ~azure.mgmt.appplatform.models.CustomizedAcceleratorResource
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.CustomizedAcceleratorResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type customized_accelerator_resource:
         ~azure.mgmt.appplatform.models.CustomizedAcceleratorResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either CustomizedAcceleratorResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.CustomizedAcceleratorResource]
    ...
    async def begin_validate(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.appplatform.models.CustomizedAcceleratorProperties
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.CustomizedAcceleratorValidateResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_validate(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.appplatform.models.CustomizedAcceleratorProperties or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either CustomizedAcceleratorValidateResult
         or the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.CustomizedAcceleratorValidateResult]
