...
class ConfigServersOperations:
    ...
    async def begin_update_put(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ConfigServerResource or the result
         of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.ConfigServerResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_validate(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.ConfigServerSettingsValidateResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
