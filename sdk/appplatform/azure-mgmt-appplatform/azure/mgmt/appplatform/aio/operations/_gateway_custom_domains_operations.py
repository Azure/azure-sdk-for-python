...
class GatewayCustomDomainsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.GatewayCustomDomainResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gateway_custom_domain_resource:
         ~azure.mgmt.appplatform.models.GatewayCustomDomainResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either GatewayCustomDomainResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.GatewayCustomDomainResource]
    ...
    def list(
        ...
        :return: An iterator like instance of either GatewayCustomDomainResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.models.GatewayCustomDomainResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
