...
class AppsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either AppResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.AppResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type app_resource: ~azure.mgmt.appplatform.models.AppResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either AppResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.AppResource]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list(self, resource_group_name: str, service_name: str, **kwargs: Any) -> AsyncIterable["_models.AppResource"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.models.AppResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_set_active_deployments(
        ...
        **kwargs: Any
        ...
        :type active_deployment_collection: ~azure.mgmt.appplatform.models.ActiveDeploymentCollection
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either AppResource or the result of
    ...
    async def validate_domain(
        ...
        **kwargs: Any
        ...
        :type validate_payload: ~azure.mgmt.appplatform.models.CustomDomainValidatePayload
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    async def validate_domain(
        ...
        **kwargs: Any
        ...
        :type validate_payload: ~azure.mgmt.appplatform.models.CustomDomainValidatePayload or IO[bytes]
        :return: CustomDomainValidateResult or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.models.CustomDomainValidateResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
