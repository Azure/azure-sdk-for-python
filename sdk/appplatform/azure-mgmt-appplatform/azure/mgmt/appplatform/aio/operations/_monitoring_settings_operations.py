...
class MonitoringSettingsOperations:
    ...
    async def begin_update_put(
        ...
        **kwargs: Any
        ...
        :type monitoring_setting_resource: ~azure.mgmt.appplatform.models.MonitoringSettingResource
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.MonitoringSettingResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update_put(
        ...
        **kwargs: Any
        ...
        :type monitoring_setting_resource: ~azure.mgmt.appplatform.models.MonitoringSettingResource or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either MonitoringSettingResource or the
         result of cls(response)
        :rtype:
