...
class ApplicationLiveViewsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either ApplicationLiveViewResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.models.ApplicationLiveViewResource]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.ApplicationLiveViewResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
