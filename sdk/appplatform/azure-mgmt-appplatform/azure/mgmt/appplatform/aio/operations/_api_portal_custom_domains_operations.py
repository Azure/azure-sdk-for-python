...
class ApiPortalCustomDomainsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.ApiPortalCustomDomainResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type api_portal_custom_domain_resource:
         ~azure.mgmt.appplatform.models.ApiPortalCustomDomainResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ApiPortalCustomDomainResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.ApiPortalCustomDomainResource]
    ...
    def list(
        ...
        :return: An iterator like instance of either ApiPortalCustomDomainResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.models.ApiPortalCustomDomainResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
