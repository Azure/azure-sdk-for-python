...
class ConfigurationServicesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type configuration_service_resource:
         ~azure.mgmt.appplatform.models.ConfigurationServiceResource
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.ConfigurationServiceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type configuration_service_resource:
         ~azure.mgmt.appplatform.models.ConfigurationServiceResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ConfigurationServiceResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.ConfigurationServiceResource]
    ...
    def list(
        ...
        :return: An iterator like instance of either ConfigurationServiceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.models.ConfigurationServiceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_validate(
        ...
        **kwargs: Any
        ...
        :type settings: ~azure.mgmt.appplatform.models.ConfigurationServiceSettings
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.ConfigurationServiceSettingsValidateResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_validate(
        ...
        **kwargs: Any
        ...
        :type settings: ~azure.mgmt.appplatform.models.ConfigurationServiceSettings or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either
         ConfigurationServiceSettingsValidateResult or the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.models.ConfigurationServiceSettingsValidateResult]
