...
class BuildServiceAgentPoolOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either BuildServiceAgentPoolResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_12_01.models.BuildServiceAgentPoolResource]
    ...
    def begin_update_put(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_12_01.models.BuildServiceAgentPoolResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
