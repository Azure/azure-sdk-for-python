...
from ...operations._bindings_operations import (
...
class BindingsOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_05_01_preview.models.BindingResource
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type binding_resource: ~azure.mgmt.appplatform.v2024_05_01_preview.models.BindingResource
        ...
        :return: An instance of AsyncLROPoller that returns either BindingResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_05_01_preview.models.BindingResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type binding_resource: ~azure.mgmt.appplatform.v2024_05_01_preview.models.BindingResource or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either BindingResource or the result of
         cls(response)
        :rtype:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2024_05_01_preview.models.BindingResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
