...
class ApplicationAcceleratorsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either ApplicationAcceleratorResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2024_05_01_preview.models.ApplicationAcceleratorResource]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_05_01_preview.models.ApplicationAcceleratorResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type application_accelerator_resource:
         ~azure.mgmt.appplatform.v2024_05_01_preview.models.ApplicationAcceleratorResource
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_05_01_preview.models.ApplicationAcceleratorResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type application_accelerator_resource:
         ~azure.mgmt.appplatform.v2024_05_01_preview.models.ApplicationAcceleratorResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ApplicationAcceleratorResource or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_05_01_preview.models.ApplicationAcceleratorResource]
