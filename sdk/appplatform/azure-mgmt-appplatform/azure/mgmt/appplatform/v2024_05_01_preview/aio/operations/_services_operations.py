...
from ...operations._services_operations import (
    ...
    build_disable_apm_globally_request,
    build_disable_test_endpoint_request,
    build_enable_apm_globally_request,
    build_enable_test_endpoint_request,
    build_flush_vnet_dns_setting_request,
    build_get_request,
...
class ServicesOperations:  # pylint: disable=too-many-public-methods
    ...
    async def get(self, resource_group_name: str, service_name: str, **kwargs: Any) -> _models.ServiceResource:
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_05_01_preview.models.ServiceResource
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.appplatform.v2024_05_01_preview.models.ServiceResource
        ...
        :return: An instance of AsyncLROPoller that returns either ServiceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_05_01_preview.models.ServiceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.appplatform.v2024_05_01_preview.models.ServiceResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ServiceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_05_01_preview.models.ServiceResource]
    ...
    async def list_test_keys(self, resource_group_name: str, service_name: str, **kwargs: Any) -> _models.TestKeys:
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_05_01_preview.models.TestKeys
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def regenerate_test_key(
        ...
        **kwargs: Any
        ...
        :type regenerate_test_key_request:
         ~azure.mgmt.appplatform.v2024_05_01_preview.models.RegenerateTestKeyRequestPayload
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: TestKeys or the result of cls(response)
    ...
    async def regenerate_test_key(
        ...
        **kwargs: Any
        ...
        :type regenerate_test_key_request:
         ~azure.mgmt.appplatform.v2024_05_01_preview.models.RegenerateTestKeyRequestPayload or IO[bytes]
        :return: TestKeys or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2024_05_01_preview.models.TestKeys
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_flush_vnet_dns_setting(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._flush_vnet_dns_setting_initial(
                resource_group_name=resource_group_name,
                service_name=service_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
    ...
    def list_supported_apm_types(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2024_05_01_preview.models.SupportedApmType]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def list_globally_enabled_apms(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_05_01_preview.models.GloballyEnabledApms
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("GloballyEnabledApms", pipeline_response.http_response)
    ...
    async def begin_enable_apm_globally(
        ...
        **kwargs: Any
        ...
        :type apm: ~azure.mgmt.appplatform.v2024_05_01_preview.models.ApmReference
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
    ...
    async def begin_enable_apm_globally(
        ...
        :param apm: The target APM for the enable operation. Is either a ApmReference type or a
         IO[bytes] type. Required.
        :type apm: ~azure.mgmt.appplatform.v2024_05_01_preview.models.ApmReference or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._enable_apm_globally_initial(
                resource_group_name=resource_group_name,
                service_name=service_name,
                apm=apm,
                api_version=api_version,
    ...
    async def begin_disable_apm_globally(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._disable_apm_globally_initial(
                resource_group_name=resource_group_name,
                service_name=service_name,
                apm=apm,
                api_version=api_version,
    ...
    async def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type availability_parameters:
         ~azure.mgmt.appplatform.v2024_05_01_preview.models.NameAvailabilityParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: NameAvailability or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2024_05_01_preview.models.NameAvailability
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type availability_parameters:
         ~azure.mgmt.appplatform.v2024_05_01_preview.models.NameAvailabilityParameters or IO[bytes]
        :return: NameAvailability or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2024_05_01_preview.models.NameAvailability
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.ServiceResource"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2024_05_01_preview.models.ServiceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_supported_server_versions(
        ...
        :return: An iterator like instance of either SupportedServerVersion or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2024_05_01_preview.models.SupportedServerVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
