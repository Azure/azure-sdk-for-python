...
class ContainerRegistriesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.appplatform.v2024_05_01_preview.AppPlatformManagementClient`'s
    ...
    def list(
        ...
        :return: An iterator like instance of either ContainerRegistryResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2024_05_01_preview.models.ContainerRegistryResource]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_05_01_preview.models.ContainerRegistryResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("ContainerRegistryResource", pipeline_response.http_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ContainerRegistryResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2024_05_01_preview.models.ContainerRegistryResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type container_registry_resource:
         ~azure.mgmt.appplatform.v2024_05_01_preview.models.ContainerRegistryResource or IO[bytes]
        :return: An instance of LROPoller that returns either ContainerRegistryResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2024_05_01_preview.models.ContainerRegistryResource]
        ...
        if cont_token:
            return LROPoller[_models.ContainerRegistryResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ContainerRegistryResource](
    ...
    def begin_validate(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2024_05_01_preview.models.ContainerRegistryValidateResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_validate(
        ...
        **kwargs: Any
        ...
        :type container_registry_properties:
         ~azure.mgmt.appplatform.v2024_05_01_preview.models.ContainerRegistryProperties or IO[bytes]
        :return: An instance of LROPoller that returns either ContainerRegistryValidateResult or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2024_05_01_preview.models.ContainerRegistryValidateResult]
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("ContainerRegistryValidateResult", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.ContainerRegistryValidateResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ContainerRegistryValidateResult](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
