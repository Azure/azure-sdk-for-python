...
from ...operations._apms_operations import (
    build_create_or_update_request,
    build_delete_request,
    build_get_request,
    build_list_request,
    build_list_secret_keys_request,
)
...
class ApmsOperations:
    ...
    def list(self, resource_group_name: str, service_name: str, **kwargs: Any) -> AsyncIterable["_models.ApmResource"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2023_11_01_preview.models.ApmResource]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_11_01_preview.models.ApmResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type apm_resource: ~azure.mgmt.appplatform.v2023_11_01_preview.models.ApmResource
        ...
        :return: An instance of AsyncLROPoller that returns either ApmResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_11_01_preview.models.ApmResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type apm_resource: ~azure.mgmt.appplatform.v2023_11_01_preview.models.ApmResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ApmResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_11_01_preview.models.ApmResource]
    ...
    async def list_secret_keys(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_11_01_preview.models.ApmSecretKeys
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
