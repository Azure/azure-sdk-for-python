...
class ContainerRegistriesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type container_registry_resource:
         ~azure.mgmt.appplatform.v2023_11_01_preview.models.ContainerRegistryResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ContainerRegistryResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_11_01_preview.models.ContainerRegistryResource]
    ...
    async def begin_validate(
        ...
        **kwargs: Any
        ...
        :type container_registry_properties:
         ~azure.mgmt.appplatform.v2023_11_01_preview.models.ContainerRegistryProperties or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ContainerRegistryValidateResult or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_11_01_preview.models.ContainerRegistryValidateResult]
