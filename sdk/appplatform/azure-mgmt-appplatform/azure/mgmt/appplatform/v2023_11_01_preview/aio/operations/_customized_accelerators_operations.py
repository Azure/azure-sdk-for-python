...
class CustomizedAcceleratorsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type customized_accelerator_resource:
         ~azure.mgmt.appplatform.v2023_11_01_preview.models.CustomizedAcceleratorResource or IO
    ...
    async def validate(
        ...
        **kwargs: Any
        ...
        :type properties:
         ~azure.mgmt.appplatform.v2023_11_01_preview.models.CustomizedAcceleratorProperties or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
