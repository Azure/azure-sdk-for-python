...
class ServicesOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ServiceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_11_01_preview.models.ServiceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        :type resource: ~azure.mgmt.appplatform.v2023_11_01_preview.models.ServiceResource or IO
    ...
    def regenerate_test_key(
        ...
        **kwargs: Any
        ...
        :type regenerate_test_key_request:
         ~azure.mgmt.appplatform.v2023_11_01_preview.models.RegenerateTestKeyRequestPayload or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_supported_apm_types(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_11_01_preview.models.SupportedApmType]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_enable_apm_globally(
        ...
        :param apm: The target APM for the enable operation. Is either a ApmReference type or a IO
         type. Required.
        :type apm: ~azure.mgmt.appplatform.v2023_11_01_preview.models.ApmReference or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def check_name_availability(
        ...
        :type availability_parameters:
         ~azure.mgmt.appplatform.v2023_11_01_preview.models.NameAvailabilityParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ServiceResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_11_01_preview.models.ServiceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_supported_server_versions(
        ...
        :return: An iterator like instance of either SupportedServerVersion or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_11_01_preview.models.SupportedServerVersion]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
