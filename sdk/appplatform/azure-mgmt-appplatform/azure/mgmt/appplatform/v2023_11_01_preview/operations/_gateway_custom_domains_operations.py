...
class GatewayCustomDomainsOperations:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_11_01_preview.models.GatewayCustomDomainResource
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either GatewayCustomDomainResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_11_01_preview.models.GatewayCustomDomainResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gateway_custom_domain_resource:
         ~azure.mgmt.appplatform.v2023_11_01_preview.models.GatewayCustomDomainResource or IO[bytes]
        :return: An instance of LROPoller that returns either GatewayCustomDomainResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_11_01_preview.models.GatewayCustomDomainResource]
    ...
    def list(
        ...
        :return: An iterator like instance of either GatewayCustomDomainResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_11_01_preview.models.GatewayCustomDomainResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
