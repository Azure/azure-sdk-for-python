...
class AppsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type app_resource: ~azure.mgmt.appplatform.v2023_11_01_preview.models.AppResource or IO
    ...
    def begin_set_active_deployments(
        ...
        **kwargs: Any
        ...
        :type active_deployment_collection:
         ~azure.mgmt.appplatform.v2023_11_01_preview.models.ActiveDeploymentCollection or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
