...
class ConfigurationServicesOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("ConfigurationServiceResource", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type configuration_service_resource:
         ~azure.mgmt.appplatform.v2023_03_01_preview.models.ConfigurationServiceResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ConfigurationServiceResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_03_01_preview.models.ConfigurationServiceResource]
        ...
        **kwargs: Any
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize(
                "ConfigurationServiceSettingsValidateResult", pipeline_response.http_response
            )
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
