...
class PredefinedAcceleratorsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either PredefinedAcceleratorResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2023_07_01_preview.models.PredefinedAcceleratorResource]
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_07_01_preview.models.PredefinedAcceleratorResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("PredefinedAcceleratorResource", pipeline_response.http_response)
