...
def build_get_request(
    resource_group_name: str, service_name: str, app_name: str, domain_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class CustomDomainsOperations:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_07_01_preview.models.CustomDomainResource
        ...
        deserialized = self._deserialize("CustomDomainResource", pipeline_response.http_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type domain_resource: ~azure.mgmt.appplatform.v2023_07_01_preview.models.CustomDomainResource
        ...
        :return: An instance of LROPoller that returns either CustomDomainResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_07_01_preview.models.CustomDomainResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        :return: An iterator like instance of either CustomDomainResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_07_01_preview.models.CustomDomainResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
