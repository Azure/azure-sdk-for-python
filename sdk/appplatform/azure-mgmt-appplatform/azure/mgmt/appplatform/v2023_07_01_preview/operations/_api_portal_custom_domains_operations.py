...
class ApiPortalCustomDomainsOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("ApiPortalCustomDomainResource", pipeline_response.http_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type api_portal_custom_domain_resource:
         ~azure.mgmt.appplatform.v2023_07_01_preview.models.ApiPortalCustomDomainResource or IO[bytes]
        :return: An instance of LROPoller that returns either ApiPortalCustomDomainResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_07_01_preview.models.ApiPortalCustomDomainResource]
        ...
        if cont_token:
            return LROPoller[_models.ApiPortalCustomDomainResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ApiPortalCustomDomainResource](
