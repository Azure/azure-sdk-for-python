...
class ContainerRegistriesOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either ContainerRegistryResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_07_01_preview.models.ContainerRegistryResource]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_07_01_preview.models.ContainerRegistryResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ContainerRegistryResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_07_01_preview.models.ContainerRegistryResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type container_registry_resource:
         ~azure.mgmt.appplatform.v2023_07_01_preview.models.ContainerRegistryResource or IO[bytes]
        :return: An instance of LROPoller that returns either ContainerRegistryResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_07_01_preview.models.ContainerRegistryResource]
    ...
    def begin_validate(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_07_01_preview.models.ContainerRegistryValidateResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_validate(
        ...
        **kwargs: Any
        ...
        :type container_registry_properties:
         ~azure.mgmt.appplatform.v2023_07_01_preview.models.ContainerRegistryProperties or IO[bytes]
        :return: An instance of LROPoller that returns either ContainerRegistryValidateResult or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_07_01_preview.models.ContainerRegistryValidateResult]
