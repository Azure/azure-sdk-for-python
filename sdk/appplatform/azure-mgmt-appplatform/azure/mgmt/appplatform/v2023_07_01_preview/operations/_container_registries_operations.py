...
class ContainerRegistriesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type container_registry_resource:
         ~azure.mgmt.appplatform.v2023_07_01_preview.models.ContainerRegistryResource or IO
    ...
    def begin_validate(
        ...
        **kwargs: Any
        ...
        :type container_registry_properties:
         ~azure.mgmt.appplatform.v2023_07_01_preview.models.ContainerRegistryProperties or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
