...
def build_get_request(
    resource_group_name: str, service_name: str, apm_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "serviceName": _SERIALIZER.url("service_name", service_name, "str", pattern=r"^[a-z][a-z0-9-]*[a-z0-9]$"),
        "apmName": _SERIALIZER.url("apm_name", apm_name, "str", pattern=r"^[a-z][a-z0-9-]*[a-z0-9]$"),
    }
...
def build_list_secret_keys_request(
    resource_group_name: str, service_name: str, apm_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ApmsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.appplatform.v2023_07_01_preview.AppPlatformManagementClient`'s
        :attr:`apms` attribute.
    """
    ...
    @distributed_trace
    def list(self, resource_group_name: str, service_name: str, **kwargs: Any) -> Iterable["_models.ApmResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_07_01_preview.models.ApmResource]
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/apms"
    }

    @distributed_trace
    def get(self, resource_group_name: str, service_name: str, apm_name: str, **kwargs: Any) -> _models.ApmResource:
        """Get the APM by name.
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_07_01_preview.models.ApmResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/apms/{apmName}"
    }
    ...
    def _create_or_update_initial(
        ...
        service_name: str,
        apm_name: str,
        apm_resource: Union[_models.ApmResource, IO],
        **kwargs: Any
    ) -> _models.ApmResource:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type apm_resource: ~azure.mgmt.appplatform.v2023_07_01_preview.models.ApmResource
        ...
        :return: An instance of LROPoller that returns either ApmResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_07_01_preview.models.ApmResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type apm_resource: ~azure.mgmt.appplatform.v2023_07_01_preview.models.ApmResource or IO
    ...
    def list_secret_keys(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_07_01_preview.models.ApmSecretKeys
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_list_secret_keys_request(
            resource_group_name=resource_group_name,
            service_name=service_name,
            apm_name=apm_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.list_secret_keys.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    list_secret_keys.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/apms/{apmName}/listSecretKeys"
    }
