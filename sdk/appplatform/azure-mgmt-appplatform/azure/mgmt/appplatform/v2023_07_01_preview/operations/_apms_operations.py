...
class ApmsOperations:
    ...
    def get(self, resource_group_name: str, service_name: str, apm_name: str, **kwargs: Any) -> _models.ApmResource:
        ...
        deserialized = self._deserialize("ApmResource", pipeline_response.http_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type apm_resource: ~azure.mgmt.appplatform.v2023_07_01_preview.models.ApmResource or IO[bytes]
        :return: An instance of LROPoller that returns either ApmResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_07_01_preview.models.ApmResource]
        ...
        if cont_token:
            return LROPoller[_models.ApmResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ApmResource](
    ...
    def list_secret_keys(
        ...
        deserialized = self._deserialize("ApmSecretKeys", pipeline_response.http_response)
