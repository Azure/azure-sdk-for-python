...
class BuildServiceBuilderOperations:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_05_01_preview.models.BuilderResource
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type builder_resource: ~azure.mgmt.appplatform.v2023_05_01_preview.models.BuilderResource
        ...
        :return: An instance of LROPoller that returns either BuilderResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_05_01_preview.models.BuilderResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type builder_resource: ~azure.mgmt.appplatform.v2023_05_01_preview.models.BuilderResource or
         IO[bytes]
        :return: An instance of LROPoller that returns either BuilderResource or the result of
         cls(response)
        :rtype:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_05_01_preview.models.BuilderResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_deployments(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_05_01_preview.models.DeploymentList
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
