...
class BuildpackBindingOperations:
    ...
    def list_for_cluster(
        ...
        :return: An iterator like instance of either BuildpackBindingResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_05_01_preview.models.BuildpackBindingResource]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either BuildpackBindingResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_05_01_preview.models.BuildpackBindingResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
