...
from ...operations._apps_operations import (
    ...
    build_list_request,
    build_set_active_deployments_request,
...
class AppsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_05_01_preview.models.AppResource
        ...
        deserialized = self._deserialize("AppResource", pipeline_response.http_response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type app_resource: ~azure.mgmt.appplatform.v2023_05_01_preview.models.AppResource
        ...
        :return: An instance of AsyncLROPoller that returns either AppResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_05_01_preview.models.AppResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type app_resource: ~azure.mgmt.appplatform.v2023_05_01_preview.models.AppResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either AppResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_05_01_preview.models.AppResource]
    ...
    def list(self, resource_group_name: str, service_name: str, **kwargs: Any) -> AsyncIterable["_models.AppResource"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2023_05_01_preview.models.AppResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_resource_upload_url(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_05_01_preview.models.ResourceUploadDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_set_active_deployments(
        ...
        **kwargs: Any
        ...
        :type active_deployment_collection:
         ~azure.mgmt.appplatform.v2023_05_01_preview.models.ActiveDeploymentCollection
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either AppResource or the result of
    ...
    async def begin_set_active_deployments(
        ...
        **kwargs: Any
        ...
        :type active_deployment_collection:
         ~azure.mgmt.appplatform.v2023_05_01_preview.models.ActiveDeploymentCollection or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either AppResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_05_01_preview.models.AppResource]
    ...
    async def validate_domain(
        ...
        **kwargs: Any
        ...
        :type validate_payload:
         ~azure.mgmt.appplatform.v2023_05_01_preview.models.CustomDomainValidatePayload
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: CustomDomainValidateResult or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2023_05_01_preview.models.CustomDomainValidateResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def validate_domain(
        ...
        **kwargs: Any
        ...
        :type validate_payload:
         ~azure.mgmt.appplatform.v2023_05_01_preview.models.CustomDomainValidatePayload or IO[bytes]
        :return: CustomDomainValidateResult or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2023_05_01_preview.models.CustomDomainValidateResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
