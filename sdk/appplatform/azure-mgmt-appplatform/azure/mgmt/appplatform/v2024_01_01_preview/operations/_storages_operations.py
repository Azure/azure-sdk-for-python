...
class StoragesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either StorageResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.StorageResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(self, resource_group_name: str, service_name: str, **kwargs: Any) -> Iterable["_models.StorageResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2024_01_01_preview.models.StorageResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
