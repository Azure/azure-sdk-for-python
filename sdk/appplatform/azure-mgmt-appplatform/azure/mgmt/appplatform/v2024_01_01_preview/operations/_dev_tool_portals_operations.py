...
class DevToolPortalsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either DevToolPortalResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2024_01_01_preview.models.DevToolPortalResource]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either DevToolPortalResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.DevToolPortalResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
