...
class ApplicationAcceleratorsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either ApplicationAcceleratorResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2024_01_01_preview.models.ApplicationAcceleratorResource]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.ApplicationAcceleratorResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        deserialized = self._deserialize("ApplicationAcceleratorResource", pipeline_response.http_response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type application_accelerator_resource:
         ~azure.mgmt.appplatform.v2024_01_01_preview.models.ApplicationAcceleratorResource
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.ApplicationAcceleratorResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type application_accelerator_resource:
         ~azure.mgmt.appplatform.v2024_01_01_preview.models.ApplicationAcceleratorResource or IO[bytes]
        :return: An instance of LROPoller that returns either ApplicationAcceleratorResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.ApplicationAcceleratorResource]
        ...
        if cont_token:
            return LROPoller[_models.ApplicationAcceleratorResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ApplicationAcceleratorResource](
