...
class ApmsOperations:
    ...
    def list(self, resource_group_name: str, service_name: str, **kwargs: Any) -> Iterable["_models.ApmResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2024_01_01_preview.models.ApmResource]
    ...
    def get(self, resource_group_name: str, service_name: str, apm_name: str, **kwargs: Any) -> _models.ApmResource:
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.ApmResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type apm_resource: ~azure.mgmt.appplatform.v2024_01_01_preview.models.ApmResource
        ...
        :return: An instance of LROPoller that returns either ApmResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.ApmResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type apm_resource: ~azure.mgmt.appplatform.v2024_01_01_preview.models.ApmResource or IO[bytes]
        :return: An instance of LROPoller that returns either ApmResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.ApmResource]
    ...
    def list_secret_keys(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.ApmSecretKeys
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
