...
class DeploymentsOperations:  # pylint: disable=too-many-public-methods
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.DeploymentResource
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type deployment_resource:
         ~azure.mgmt.appplatform.v2024_01_01_preview.models.DeploymentResource
        ...
        :return: An instance of AsyncLROPoller that returns either DeploymentResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.DeploymentResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type deployment_resource:
         ~azure.mgmt.appplatform.v2024_01_01_preview.models.DeploymentResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either DeploymentResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.DeploymentResource]
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2024_01_01_preview.models.DeploymentResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_enable_remote_debugging(
        ...
        **kwargs: Any
        ...
        :type remote_debugging_payload:
         ~azure.mgmt.appplatform.v2024_01_01_preview.models.RemoteDebuggingPayload
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either RemoteDebugging or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.RemoteDebugging]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_enable_remote_debugging(
        ...
        **kwargs: Any
        ...
        :type remote_debugging_payload:
         ~azure.mgmt.appplatform.v2024_01_01_preview.models.RemoteDebuggingPayload or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either RemoteDebugging or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.RemoteDebugging]
    ...
    async def get_remote_debugging_config(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.RemoteDebugging
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def get_log_file_url(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.LogFileUrlResponse or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_generate_heap_dump(
        ...
        **kwargs: Any
        ...
        :type diagnostic_parameters:
         ~azure.mgmt.appplatform.v2024_01_01_preview.models.DiagnosticParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
    ...
    async def begin_generate_heap_dump(
        ...
        **kwargs: Any
        ...
        :type diagnostic_parameters:
         ~azure.mgmt.appplatform.v2024_01_01_preview.models.DiagnosticParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
