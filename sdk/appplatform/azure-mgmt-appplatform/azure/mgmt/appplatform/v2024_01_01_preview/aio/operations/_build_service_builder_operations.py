...
class BuildServiceBuilderOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.BuilderResource
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type builder_resource: ~azure.mgmt.appplatform.v2024_01_01_preview.models.BuilderResource
        ...
        :return: An instance of AsyncLROPoller that returns either BuilderResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.BuilderResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type builder_resource: ~azure.mgmt.appplatform.v2024_01_01_preview.models.BuilderResource or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either BuilderResource or the result of
         cls(response)
        :rtype:
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2024_01_01_preview.models.BuilderResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def list_deployments(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.DeploymentList
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
