...
class GatewayRouteConfigsOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.GatewayRouteConfigResource
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gateway_route_config_resource:
         ~azure.mgmt.appplatform.v2024_01_01_preview.models.GatewayRouteConfigResource
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.GatewayRouteConfigResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gateway_route_config_resource:
         ~azure.mgmt.appplatform.v2024_01_01_preview.models.GatewayRouteConfigResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either GatewayRouteConfigResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.GatewayRouteConfigResource]
    ...
    def list(
        ...
        :return: An iterator like instance of either GatewayRouteConfigResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2024_01_01_preview.models.GatewayRouteConfigResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
