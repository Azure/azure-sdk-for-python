...
class BuildServiceOperations:
    ...
    def list_build_services(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2024_01_01_preview.models.BuildService]
    ...
    async def get_build_service(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.BuildService
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type build_service: ~azure.mgmt.appplatform.v2024_01_01_preview.models.BuildService
        ...
        :return: An instance of AsyncLROPoller that returns either BuildService or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.BuildService]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type build_service: ~azure.mgmt.appplatform.v2024_01_01_preview.models.BuildService or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either BuildService or the result of
         cls(response)
        :rtype:
    ...
    def list_builds(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2024_01_01_preview.models.Build]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_build(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.Build
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update_build(
        ...
        **kwargs: Any
        ...
        :type build: ~azure.mgmt.appplatform.v2024_01_01_preview.models.Build
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Build or the result of cls(response)
    ...
    async def create_or_update_build(
        ...
        **kwargs: Any
        ...
        :param build: Parameters for the create or update operation. Is either a Build type or a
         IO[bytes] type. Required.
        :type build: ~azure.mgmt.appplatform.v2024_01_01_preview.models.Build or IO[bytes]
        :return: Build or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.Build
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_build_results(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2024_01_01_preview.models.BuildResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_build_result(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.BuildResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def get_build_result_log(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.BuildResultLog
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def get_resource_upload_url(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.ResourceUploadDefinition
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def list_supported_buildpacks(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.SupportedBuildpacksCollection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def get_supported_buildpack(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.SupportedBuildpackResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def list_supported_stacks(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.SupportedStacksCollection
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def get_supported_stack(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.SupportedStackResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
