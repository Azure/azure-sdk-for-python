...
class ApplicationLiveViewsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either ApplicationLiveViewResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2024_01_01_preview.models.ApplicationLiveViewResource]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2024_01_01_preview.models.ApplicationLiveViewResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.ApplicationLiveViewResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type application_live_view_resource:
         ~azure.mgmt.appplatform.v2024_01_01_preview.models.ApplicationLiveViewResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ApplicationLiveViewResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2024_01_01_preview.models.ApplicationLiveViewResource]
