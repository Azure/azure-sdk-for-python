...
class MonitoringSettingsOperations(object):
    ...
    def update_put(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.appplatform.v2020_11_01_preview.models.MonitoringSettingResource]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.appplatform.v2020_11_01_preview.models.MonitoringSettingResource]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
