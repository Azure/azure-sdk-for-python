...
class ServicesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.appplatform.v2021_09_01_preview.models.ServiceResource or IO[bytes]
        :return: An instance of LROPoller that returns either ServiceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2021_09_01_preview.models.ServiceResource]
    ...
    def regenerate_test_key(
        ...
        **kwargs: Any
        ...
        :type regenerate_test_key_request:
         ~azure.mgmt.appplatform.v2021_09_01_preview.models.RegenerateTestKeyRequestPayload or IO[bytes]
        :return: TestKeys or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2021_09_01_preview.models.TestKeys
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type availability_parameters:
         ~azure.mgmt.appplatform.v2021_09_01_preview.models.NameAvailabilityParameters or IO[bytes]
        :return: NameAvailability or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2021_09_01_preview.models.NameAvailability
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ServiceResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2021_09_01_preview.models.ServiceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
