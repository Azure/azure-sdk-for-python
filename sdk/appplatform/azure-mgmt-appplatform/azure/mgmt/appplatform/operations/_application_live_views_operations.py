...
class ApplicationLiveViewsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either ApplicationLiveViewResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.models.ApplicationLiveViewResource]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ApplicationLiveViewResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.models.ApplicationLiveViewResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type application_live_view_resource:
         ~azure.mgmt.appplatform.models.ApplicationLiveViewResource or IO[bytes]
        :return: An instance of LROPoller that returns either ApplicationLiveViewResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.models.ApplicationLiveViewResource]
