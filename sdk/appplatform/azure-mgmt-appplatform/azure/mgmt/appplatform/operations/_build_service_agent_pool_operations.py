...
class BuildServiceAgentPoolOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either BuildServiceAgentPoolResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.models.BuildServiceAgentPoolResource]
    ...
    def begin_update_put(
        ...
        **kwargs: Any
        ...
        :type agent_pool_resource: ~azure.mgmt.appplatform.models.BuildServiceAgentPoolResource
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.models.BuildServiceAgentPoolResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update_put(
        ...
        **kwargs: Any
        ...
        :type agent_pool_resource: ~azure.mgmt.appplatform.models.BuildServiceAgentPoolResource or
         IO[bytes]
        :return: An instance of LROPoller that returns either BuildServiceAgentPoolResource or the
         result of cls(response)
        :rtype:
