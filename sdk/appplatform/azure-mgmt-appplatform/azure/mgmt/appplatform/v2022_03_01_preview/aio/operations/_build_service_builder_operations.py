...
class BuildServiceBuilderOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type builder_resource: ~azure.mgmt.appplatform.v2022_03_01_preview.models.BuilderResource or
         IO
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2022_03_01_preview.models.BuilderResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
