...
from ...operations._gateway_route_configs_operations import (
...
class GatewayRouteConfigsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type gateway_route_config_resource:
         ~azure.mgmt.appplatform.v2022_03_01_preview.models.GatewayRouteConfigResource or IO
    ...
    def list(
        ...
        :return: An iterator like instance of either GatewayRouteConfigResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2022_03_01_preview.models.GatewayRouteConfigResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
