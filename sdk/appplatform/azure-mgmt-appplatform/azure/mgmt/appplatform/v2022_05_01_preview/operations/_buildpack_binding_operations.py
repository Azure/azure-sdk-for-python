...
class BuildpackBindingOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type buildpack_binding:
         ~azure.mgmt.appplatform.v2022_05_01_preview.models.BuildpackBindingResource or IO[bytes]
        :return: An instance of LROPoller that returns either BuildpackBindingResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2022_05_01_preview.models.BuildpackBindingResource]
    ...
    def list(
        ...
        :return: An iterator like instance of either BuildpackBindingResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2022_05_01_preview.models.BuildpackBindingResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
