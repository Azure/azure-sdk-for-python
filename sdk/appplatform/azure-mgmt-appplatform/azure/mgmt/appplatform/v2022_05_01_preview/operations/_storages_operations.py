...
class StoragesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type storage_resource: ~azure.mgmt.appplatform.v2022_05_01_preview.models.StorageResource or
         IO
    ...
    def list(self, resource_group_name: str, service_name: str, **kwargs: Any) -> Iterable["_models.StorageResource"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2022_05_01_preview.models.StorageResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
