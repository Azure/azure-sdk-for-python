...
class CertificateResourceProvisioningState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class CustomDomainResourceProvisioningState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class HTTPSchemeType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ProbeActionType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
