...
class ServicesOperations:
    ...
    async def get(self, resource_group_name: str, service_name: str, **kwargs: Any) -> _models.ServiceResource:
        ...
        :rtype: ~azure.mgmt.appplatform.v2022_05_01_preview.models.ServiceResource
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.appplatform.v2022_05_01_preview.models.ServiceResource
        ...
        :return: An instance of AsyncLROPoller that returns either ServiceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2022_05_01_preview.models.ServiceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.appplatform.v2022_05_01_preview.models.ServiceResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ServiceResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2022_05_01_preview.models.ServiceResource]
    ...
    async def list_test_keys(self, resource_group_name: str, service_name: str, **kwargs: Any) -> _models.TestKeys:
        ...
        :rtype: ~azure.mgmt.appplatform.v2022_05_01_preview.models.TestKeys
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def regenerate_test_key(
        ...
        **kwargs: Any
        ...
        :type regenerate_test_key_request:
         ~azure.mgmt.appplatform.v2022_05_01_preview.models.RegenerateTestKeyRequestPayload
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: TestKeys or the result of cls(response)
    ...
    async def regenerate_test_key(
        ...
        **kwargs: Any
        ...
        :type regenerate_test_key_request:
         ~azure.mgmt.appplatform.v2022_05_01_preview.models.RegenerateTestKeyRequestPayload or IO[bytes]
        :return: TestKeys or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2022_05_01_preview.models.TestKeys
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type availability_parameters:
         ~azure.mgmt.appplatform.v2022_05_01_preview.models.NameAvailabilityParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: NameAvailability or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2022_05_01_preview.models.NameAvailability
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type availability_parameters:
         ~azure.mgmt.appplatform.v2022_05_01_preview.models.NameAvailabilityParameters or IO[bytes]
        :return: NameAvailability or the result of cls(response)
        :rtype: ~azure.mgmt.appplatform.v2022_05_01_preview.models.NameAvailability
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.ServiceResource"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2022_05_01_preview.models.ServiceResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
