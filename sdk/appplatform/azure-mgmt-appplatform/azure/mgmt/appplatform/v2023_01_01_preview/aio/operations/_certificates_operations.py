...
class CertificatesOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_01_01_preview.models.CertificateResource
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type certificate_resource:
         ~azure.mgmt.appplatform.v2023_01_01_preview.models.CertificateResource
        ...
        :return: An instance of AsyncLROPoller that returns either CertificateResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_01_01_preview.models.CertificateResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type certificate_resource:
         ~azure.mgmt.appplatform.v2023_01_01_preview.models.CertificateResource or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either CertificateResource or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appplatform.v2023_01_01_preview.models.CertificateResource]
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2023_01_01_preview.models.CertificateResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
