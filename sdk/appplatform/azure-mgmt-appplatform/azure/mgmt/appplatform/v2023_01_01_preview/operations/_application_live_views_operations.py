...
class ApplicationLiveViewsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either ApplicationLiveViewResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2023_01_01_preview.models.ApplicationLiveViewResource]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.appplatform.v2023_01_01_preview.models.ApplicationLiveViewResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(application_live_view_resource, (IO, bytes)):
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ApplicationLiveViewResource or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2023_01_01_preview.models.ApplicationLiveViewResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
