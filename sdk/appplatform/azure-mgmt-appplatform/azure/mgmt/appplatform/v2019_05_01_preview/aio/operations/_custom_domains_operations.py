...
from ...operations._custom_domains_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_request, build_patch_request, build_validate_request
T = TypeVar('T')
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either CustomDomainResourceCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2019_05_01_preview.models.CustomDomainResourceCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def validate(
        ...
        **kwargs: Any
        ...
        :type validate_payload:
         ~azure.mgmt.appplatform.v2019_05_01_preview.models.CustomDomainValidatePayload
        :keyword callable cls: A custom type or function that will be passed the direct response
