...
class TestAppPlatformManagementCustomDomainsOperations(AzureMgmtRecordedTestCase):
    ...
    def test_begin_create_or_update(self, resource_group):
        response = self.client.custom_domains.begin_create_or_update(
            ...
            domain_resource={
                "id": "str",
                "name": "str",
                "properties": {"appName": "str", "certName": "str", "provisioningState": "str", "thumbprint": "str"},
                "systemData": {
