...
# USAGE
    python application_live_views_create_or_update.py
...
def main():
    ...
    response = client.application_live_views.begin_create_or_update(
        resource_group_name="myResourceGroup",
        service_name="myservice",
        application_live_view_name="default",
        application_live_view_resource={"properties": {}},
    ).result()
    print(response)
