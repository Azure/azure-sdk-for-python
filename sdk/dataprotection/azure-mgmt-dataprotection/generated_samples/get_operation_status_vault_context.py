...
def main():
    ...
    response = client.operation_status_backup_vault_context.get(
...
# x-ms-original-file: specification/dataprotection/resource-manager/Microsoft.DataProtection/stable/2025-07-01/examples/GetOperationStatusVaultContext.json
