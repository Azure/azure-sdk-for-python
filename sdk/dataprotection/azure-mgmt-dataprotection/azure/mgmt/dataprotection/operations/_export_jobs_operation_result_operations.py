...
class ExportJobsOperationResultOperations(object):
    ...
    def get(
        ...
        :return: ExportJobsResult or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.dataprotection.models.ExportJobsResult or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ExportJobsResult', response)
