...
class BackupInstancesOperations:  # pylint: disable=too-many-public-methods
    ...
    def begin_adhoc_backup(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._adhoc_backup_initial(  # type: ignore
                resource_group_name=resource_group_name,
                vault_name=vault_name,
                backup_instance_name=backup_instance_name,
                parameters=parameters,
    ...
    def begin_validate_for_backup(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._validate_for_backup_initial(  # type: ignore
                resource_group_name=resource_group_name,
                vault_name=vault_name,
                parameters=parameters,
                api_version=api_version,
    ...
    def begin_trigger_restore(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._trigger_restore_initial(  # type: ignore
                resource_group_name=resource_group_name,
                vault_name=vault_name,
                backup_instance_name=backup_instance_name,
                parameters=parameters,
    ...
    def begin_validate_for_restore(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._validate_for_restore_initial(  # type: ignore
                resource_group_name=resource_group_name,
                vault_name=vault_name,
                backup_instance_name=backup_instance_name,
                parameters=parameters,
