...
class BackupInstancesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.BackupInstanceResourceList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.dataprotection.models.BackupInstanceResourceList]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.BackupInstanceResource"
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        backup_instance_name,  # type: str
        parameters,  # type: "_models.BackupInstanceResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.BackupInstanceResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.BackupInstanceResource"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.BackupInstanceResource"]
        ...
        :return: An instance of LROPoller that returns either BackupInstanceResource or the result of cls(response)
    ...
    def _adhoc_backup_initial(
        ...
        resource_group_name,  # type: str
        backup_instance_name,  # type: str
        parameters,  # type: "_models.TriggerBackupRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.OperationJobExtendedInfo"]
    ...
    def begin_adhoc_backup(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.OperationJobExtendedInfo"]
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns either OperationJobExtendedInfo or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.dataprotection.models.OperationJobExtendedInfo]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
    ...
    def _validate_for_backup_initial(
        ...
        vault_name,  # type: str
        resource_group_name,  # type: str
        parameters,  # type: "_models.ValidateForBackupRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.OperationJobExtendedInfo"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.OperationJobExtendedInfo"]]
    ...
    def _trigger_rehydrate_initial(
        ...
        vault_name,  # type: str
        backup_instance_name,  # type: str
        parameters,  # type: "_models.AzureBackupRehydrationRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
        ...
        # Construct URL
        url = self._trigger_rehydrate_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'vaultName': self._serialize.url("vault_name", vault_name, 'str'),
    ...
    def _trigger_restore_initial(
        ...
        resource_group_name,  # type: str
        backup_instance_name,  # type: str
        parameters,  # type: "_models.AzureBackupRestoreRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.OperationJobExtendedInfo"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.OperationJobExtendedInfo"]]
    ...
    def _validate_for_restore_initial(
        ...
        resource_group_name,  # type: str
        backup_instance_name,  # type: str
        parameters,  # type: "_models.ValidateRestoreRequestObject"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.OperationJobExtendedInfo"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.OperationJobExtendedInfo"]]
