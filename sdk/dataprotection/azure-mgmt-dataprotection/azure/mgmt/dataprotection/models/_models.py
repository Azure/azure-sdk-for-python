...
class AdHocBackupRuleOptions(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.trigger_option = kwargs.get('trigger_option', None)
...
class AdhocBasedTriggerContext(TriggerContext):
    ...
    def __init__(self, **kwargs):
        ...
        self.tagging_criteria = kwargs.get('tagging_criteria', None)
...
class AzureBackupFindRestorableTimeRangesRequest(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.source_data_store_type = kwargs.get('source_data_store_type', None)
...
class AzureBackupJob(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.backup_instance_friendly_name = kwargs.get('backup_instance_friendly_name', None)
        self.backup_instance_id = None
        self.data_source_id = kwargs.get('data_source_id', None)
        self.data_source_location = kwargs.get('data_source_location', None)
        ...
        self.operation_category = kwargs.get('operation_category', None)
        self.policy_id = None
        self.policy_name = None
        self.progress_enabled = kwargs.get('progress_enabled', None)
        self.progress_url = None
        self.restore_type = None
        self.source_resource_group = kwargs.get('source_resource_group', None)
...
class AzureBackupRestoreRequest(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.restore_target_info = kwargs.get('restore_target_info', None)
        self.source_data_store_type = kwargs.get('source_data_store_type', None)
        self.object_type = None
...
class DataStoreParameters(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.data_store_type = kwargs.get('data_store_type', None)
        self.object_type = None
...
class AzureRetentionRule(BasePolicyRule):
    ...
    def __init__(self, **kwargs):
        ...
        self.lifecycles = kwargs.get('lifecycles', None)
...
class BackupInstance(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.friendly_name = kwargs.get('friendly_name', None)
        self.data_source_info = kwargs.get('data_source_info', None)
        self.data_source_set_info = kwargs.get('data_source_set_info', None)
        self.policy_info = kwargs.get('policy_info', None)
...
class BaseBackupPolicy(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.datasource_types = kwargs.get('datasource_types', None)
        self.object_type = None
...
class BackupSchedule(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.repeating_time_intervals = kwargs.get('repeating_time_intervals', None)
...
class BackupVault(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.provisioning_state = None
        self.storage_settings = kwargs.get('storage_settings', None)
...
class ItemLevelRestoreTargetInfo(RestoreTargetInfoBase):
    ...
    def __init__(self, **kwargs):
        ...
        self.restore_criteria = kwargs.get('restore_criteria', None)
        self.datasource_info = kwargs.get('datasource_info', None)
...
class SourceLifeCycle(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.source_data_store = kwargs.get('source_data_store', None)
...
class TaggingCriteria(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.is_default = kwargs.get('is_default', None)
        self.tagging_priority = kwargs.get('tagging_priority', None)
        self.tag_info = kwargs.get('tag_info', None)
...
class TargetCopySetting(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.copy_after = kwargs.get('copy_after', None)
        self.data_store = kwargs.get('data_store', None)
...
class TargetDetails(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.restore_target_location_type = kwargs.get('restore_target_location_type', None)
...
class TriggerBackupRequest(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.backup_rule_options = kwargs.get('backup_rule_options', None)
...
class ValidateForBackupRequest(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.backup_instance = kwargs.get('backup_instance', None)
...
class ValidateRestoreRequestObject(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.restore_request_object = kwargs.get('restore_request_object', None)
