...
class AutoHealSettings(msrest.serialization.Model):
    """AutoHealSettings.

    :ivar auto_heal_status: Possible values include: "Off", "On".
    :vartype auto_heal_status: str or ~azure.mgmt.dataprotection.models.AutoHealStatus
    """

    _attribute_map = {
        'auto_heal_status': {'key': 'autoHealStatus', 'type': 'str'},
    }

    def __init__(
        self,
        *,
        auto_heal_status: Optional[Union[str, "AutoHealStatus"]] = None,
        **kwargs
    ):
        """
        :keyword auto_heal_status: Possible values include: "Off", "On".
        :paramtype auto_heal_status: str or ~azure.mgmt.dataprotection.models.AutoHealStatus
        """
        super(AutoHealSettings, self).__init__(**kwargs)
        self.auto_heal_status = auto_heal_status
