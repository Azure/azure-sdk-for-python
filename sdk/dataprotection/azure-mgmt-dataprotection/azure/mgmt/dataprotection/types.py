...
class ResumeProtectionRequest(TypedDict, total=False):
    """Request body of Resume protection when MSI is to be changed.

    :ivar objectType: Type of Datasource object, used to initialize the right inherited type.
     Required. "ResumeProtectionRequest"
    :vartype objectType: Union[str, "ResumeProtectionRequestObjectType"]
    :ivar identityDetails: identity details of the MSI.
    :vartype identityDetails: "IdentityDetails"
    """

    objectType: Required[Union[str, "ResumeProtectionRequestObjectType"]]
    """Type of Datasource object, used to initialize the right inherited type. Required.
