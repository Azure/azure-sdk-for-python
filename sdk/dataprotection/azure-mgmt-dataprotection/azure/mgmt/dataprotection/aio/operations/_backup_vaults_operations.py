...
from ...operations._backup_vaults_operations import build_check_name_availability_request, build_create_or_update_request_initial, build_delete_request, build_get_in_resource_group_request, build_get_in_subscription_request, build_get_request, build_update_request_initial
T = TypeVar('T')
...
class BackupVaultsOperations:
    ...
    def get_in_subscription(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.BackupVaultResourceList"]:
        ...
        :return: An iterator like instance of either BackupVaultResourceList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dataprotection.models.BackupVaultResourceList]
