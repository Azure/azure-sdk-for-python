...
class RecoveryPointsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.AzureBackupRecoveryPointResourceList"]:
        ...
        :return: An iterator like instance of either AzureBackupRecoveryPointResourceList or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dataprotection.models.AzureBackupRecoveryPointResourceList]
