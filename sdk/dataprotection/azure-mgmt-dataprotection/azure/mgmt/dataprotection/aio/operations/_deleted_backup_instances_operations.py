...
class DeletedBackupInstancesOperations:
    ...
    def list(
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.DeletedBackupInstanceResourceList]
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("DeletedBackupInstanceResourceList", pipeline_response)
    ...
    list.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/deletedBackupInstances"}  # type: ignore
    ...
    async def get(
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DeletedBackupInstanceResource or the result of cls(response)
        ...
        api_version = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))  # type: str
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.DeletedBackupInstanceResource]
    ...
    get.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/deletedBackupInstances/{backupInstanceName}"}  # type: ignore
    ...
    _undelete_initial.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/deletedBackupInstances/{backupInstanceName}/undelete"}  # type: ignore
