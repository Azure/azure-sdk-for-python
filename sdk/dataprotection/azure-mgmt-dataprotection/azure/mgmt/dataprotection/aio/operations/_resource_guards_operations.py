...
class ResourceGuardsOperations:
    ...
    def get_resources_in_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ResourceGuardResourceList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dataprotection.models.ResourceGuardResourceList]
    ...
    def get_disable_soft_delete_requests_objects(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dataprotection.models.DppBaseResourceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-03-31-preview")  # type: str
