...
class BackupPoliciesOperations:
    ...
    def list(
        ...
        vault_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.BaseBackupPolicyResourceList"]:
        ...
        :return: An iterator like instance of either BaseBackupPolicyResourceList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dataprotection.models.BaseBackupPolicyResourceList]
