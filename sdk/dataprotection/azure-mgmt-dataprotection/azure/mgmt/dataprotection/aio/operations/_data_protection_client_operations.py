...
from ...operations._data_protection_client_operations import (
    ...
    build_dpp_resource_guard_proxy_put_request,
...
class DataProtectionClientOperationsMixin(MixinABC):
    ...
    async def dpp_resource_guard_proxy_get(
    ...
    @overload
    async def dpp_resource_guard_proxy_put(
        self,
    ...
    @distributed_trace_async
    async def dpp_resource_guard_proxy_delete(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, vault_name: str, resource_guard_proxy_name: str, **kwargs: Any
    ) -> None:
    ...
    @overload
    async def dpp_resource_guard_proxy_unlock_delete(
        self,
        resource_group_name: str,
        vault_name: str,
        resource_guard_proxy_name: str,
