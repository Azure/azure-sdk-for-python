...
class QuotasOperations(object):
    ...
    def list_by_vm_family(
        ...
        def internal_paging(next_link=None, raw=False):
            ...
            if not next_link:
                # Construct URL
                url = self.list_by_vm_family.metadata['url']
                path_format_arguments = {
                    'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
                    'location': self._serialize.url("location", location, 'str', pattern=r'^[-\w\._]+$')
                }
        ...
        deserialized = models.ResourceQuotaPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ResourceQuotaPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
