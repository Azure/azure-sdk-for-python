...
from ...operations._transaction_nodes_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_api_keys_request, build_list_regenerate_api_keys_request, build_list_request, build_update_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class TransactionNodesOperations:
    """TransactionNodesOperations async operations.
    ...
    async def begin_create(
        ...
        transaction_node: Optional["_models.TransactionNode"] = None,
        **kwargs: Any
    ) -> AsyncLROPoller["_models.TransactionNode"]:
        ...
        :return: An instance of AsyncLROPoller that returns either TransactionNode or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~blockchain_management_client.models.TransactionNode]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list(
        ...
        resource_group_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.TransactionNodeCollection"]:
        ...
        :return: An iterator like instance of either TransactionNodeCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~blockchain_management_client.models.TransactionNodeCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    @distributed_trace_async
    async def list_regenerate_api_keys(
        self,
        blockchain_member_name: str,
        transaction_node_name: str,
        resource_group_name: str,
