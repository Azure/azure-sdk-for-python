...
class SkusOperations(object):
    ...
    def list(
        ...
        :return: ResourceTypeSkuCollection or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.blockchain.models.ResourceTypeSkuCollection or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ResourceTypeSkuCollection', response)
