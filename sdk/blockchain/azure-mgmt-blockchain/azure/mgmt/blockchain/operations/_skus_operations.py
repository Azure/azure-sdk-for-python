...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Blockchain/skus')
...
class SkusOperations(object):
    ...
    def list(
        self,
        **kwargs: Any
    ) -> "_models.ResourceTypeSkuCollection":
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ResourceTypeSkuCollection"]
        error_map = {
