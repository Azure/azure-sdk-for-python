...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Blockchain/blockchainMembers/{blockchainMemberName}/transactionNodes/{transactionNodeName}')
...
def build_list_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Blockchain/blockchainMembers/{blockchainMemberName}/transactionNodes')
    path_format_arguments = {
        "blockchainMemberName": _SERIALIZER.url("blockchain_member_name", blockchain_member_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
...
def build_list_api_keys_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Blockchain/blockchainMembers/{blockchainMemberName}/transactionNodes/{transactionNodeName}/listApiKeys')
    path_format_arguments = {
        "blockchainMemberName": _SERIALIZER.url("blockchain_member_name", blockchain_member_name, 'str'),
        "transactionNodeName": _SERIALIZER.url("transaction_node_name", transaction_node_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
def build_list_regenerate_api_keys_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Blockchain/blockchainMembers/{blockchainMemberName}/transactionNodes/{transactionNodeName}/regenerateApiKeys')
    path_format_arguments = {
        "blockchainMemberName": _SERIALIZER.url("blockchain_member_name", blockchain_member_name, 'str'),
        "transactionNodeName": _SERIALIZER.url("transaction_node_name", transaction_node_name, 'str'),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
...
class TransactionNodesOperations(object):
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type transaction_node: ~blockchain_management_client.models.TransactionNode
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type resource_group_name: str
        :param transaction_node: Payload to create the transaction node.
        :type transaction_node: ~blockchain_management_client.models.TransactionNodeUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: TransactionNode, or the result of cls(response)
        :rtype: ~blockchain_management_client.models.TransactionNode
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list(
        ...
        resource_group_name: str,
        **kwargs: Any
    ) -> Iterable["_models.TransactionNodeCollection"]:
        ...
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either TransactionNodeCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~blockchain_management_client.models.TransactionNodeCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_regenerate_api_keys(
        ...
        **kwargs: Any
        ...
        :type api_key: ~blockchain_management_client.models.ApiKey
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ApiKeyCollection, or the result of cls(response)
        :rtype: ~blockchain_management_client.models.ApiKeyCollection
        :raises: ~azure.core.exceptions.HttpResponseError
