...
from ...operations._delegated_subnet_service_operations import build_delete_details_request_initial, build_get_details_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_patch_details_request_initial, build_put_details_request_initial
T = TypeVar('T')
...
class DelegatedSubnetServiceOperations:
    ...
    @distributed_trace_async
    async def begin_delete_details(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        resource_name: str,
        force_delete: Optional[bool] = None,
    ...
    def list_by_subscription(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.DelegatedSubnets"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.dnc.models.DelegatedSubnets]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-03-15")  # type: str
