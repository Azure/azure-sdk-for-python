...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.SignalRService/locations/{location}/usages')
...
class UsagesOperations(object):
    ...
    def list(
        ...
        location: str,
        **kwargs: Any
    ) -> Iterable["_models.SignalRUsageList"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.signalr.models.SignalRUsageList]
