...
class UsagesOperations:
    ...
    @distributed_trace
    def list(self, location: str, **kwargs: Any) -> Iterable["_models.SignalRUsage"]:
        """List resource usage quotas by location.

        :param location: the location like "eastus". Required.
        :type location: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either SignalRUsage or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.signalr.models.SignalRUsage]
        ...
        cls: ClsType[_models.SignalRUsageList] = kwargs.pop("cls", None)
