...
from ...operations._signal_rcustom_domains_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class SignalRCustomDomainsOperations:
    """SignalRCustomDomainsOperations async operations.
    ...
    def list(
        ...
        resource_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.CustomDomainList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.signalr.models.CustomDomainList]
