...
class SignalROperations:
    """SignalROperations async operations.
    ...
    async def check_name_availability(
        self,
        location: str,
        parameters: Optional["_models.NameAvailabilityParameters"] = None,
        **kwargs
    ...
    def list_by_subscription(
        self,
        **kwargs
    ) -> AsyncIterable["_models.SignalRResourceList"]:
        """Handles requests to list all resources in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either SignalRResourceList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.signalr.models.SignalRResourceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_regenerate_key(
        ...
        **kwargs
        ...
        :return: An instance of AsyncLROPoller that returns either SignalRKeys or the result of cls(response)
    ...
    async def _create_or_update_initial(
        ...
        resource_group_name: str,
        resource_name: str,
        parameters: Optional["_models.SignalRResource"] = None,
        **kwargs
    ...
    async def begin_create_or_update(
        ...
        **kwargs
        ...
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of AsyncLROPoller that returns either SignalRResource or the result of cls(response)
