...
class AzureSphereMgmtClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes,name-too-long
    ...
    def __init__(self, credential: "TokenCredential", api_version: str, **kwargs: Any) -> None:
        ...
        kwargs.setdefault("sdk_moniker", "AzureSphereMgmtClient/{}".format(VERSION))
