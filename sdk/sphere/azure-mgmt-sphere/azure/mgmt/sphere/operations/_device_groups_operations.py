...
class DeviceGroupsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a DeviceGroup type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.sphere.models.DeviceGroup or IO[bytes]
        :return: An instance of LROPoller that returns either DeviceGroup or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sphere.models.DeviceGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.sphere.models.DeviceGroupUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either DeviceGroup or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sphere.models.DeviceGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _claim_devices_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        _request = build_claim_devices_request(
            resource_group_name=resource_group_name,
            catalog_name=catalog_name,
            product_name=product_name,
            device_group_name=device_group_name,
    ...
    def begin_claim_devices(
        ...
        **kwargs: Any
        ...
        :type claim_devices_request: ~azure.mgmt.sphere.models.ClaimDevicesRequest or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
