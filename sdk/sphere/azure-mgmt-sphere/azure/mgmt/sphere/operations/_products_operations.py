...
class ProductsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a Product type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.sphere.models.Product or IO[bytes]
        :return: An instance of LROPoller that returns either Product or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sphere.models.Product]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.sphere.models.ProductUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either Product or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.sphere.models.Product]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def generate_default_device_groups(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_generate_default_device_groups_request(
                    resource_group_name=resource_group_name,
                    catalog_name=catalog_name,
                    product_name=product_name,
                    subscription_id=self._config.subscription_id,
