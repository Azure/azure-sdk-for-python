...
class AzureSphereMgmtClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.sphere.aio.operations.Operations
    :ivar catalogs: CatalogsOperations operations
    :vartype catalogs: azure.mgmt.sphere.aio.operations.CatalogsOperations
    :ivar certificates: CertificatesOperations operations
    :vartype certificates: azure.mgmt.sphere.aio.operations.CertificatesOperations
    :ivar images: ImagesOperations operations
    :vartype images: azure.mgmt.sphere.aio.operations.ImagesOperations
    :ivar products: ProductsOperations operations
    :vartype products: azure.mgmt.sphere.aio.operations.ProductsOperations
    :ivar device_groups: DeviceGroupsOperations operations
    :vartype device_groups: azure.mgmt.sphere.aio.operations.DeviceGroupsOperations
    :ivar deployments: DeploymentsOperations operations
    :vartype deployments: azure.mgmt.sphere.aio.operations.DeploymentsOperations
    :ivar devices: DevicesOperations operations
    :vartype devices: azure.mgmt.sphere.aio.operations.DevicesOperations
    ...
    async def __aenter__(self) -> "AzureSphereMgmtClient":
