...
class AzureSphereMgmtClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.sphere.operations.Operations
    :ivar catalogs: CatalogsOperations operations
    :vartype catalogs: azure.mgmt.sphere.operations.CatalogsOperations
    :ivar certificates: CertificatesOperations operations
    :vartype certificates: azure.mgmt.sphere.operations.CertificatesOperations
    :ivar images: ImagesOperations operations
    :vartype images: azure.mgmt.sphere.operations.ImagesOperations
    :ivar products: ProductsOperations operations
    :vartype products: azure.mgmt.sphere.operations.ProductsOperations
    :ivar device_groups: DeviceGroupsOperations operations
    :vartype device_groups: azure.mgmt.sphere.operations.DeviceGroupsOperations
