...
# USAGE
    python post_generate_device_capability_image.py
...
def main():
    ...
    response = client.devices.begin_generate_capability_image(
        ...
        generate_device_capability_request={"capabilities": ["ApplicationDevelopment"]},
    ).result()
    print(response)
