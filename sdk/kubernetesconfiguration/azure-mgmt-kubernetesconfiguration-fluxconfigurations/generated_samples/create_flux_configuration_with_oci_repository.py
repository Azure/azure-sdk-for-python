...
# USAGE
    python create_flux_configuration_with_oci_repository.py
...
# x-ms-original-file: specification/kubernetesconfiguration/resource-manager/Microsoft.KubernetesConfiguration/fluxConfigurations/stable/2024-11-01/examples/CreateFluxConfigurationWithOCIRepository.json
