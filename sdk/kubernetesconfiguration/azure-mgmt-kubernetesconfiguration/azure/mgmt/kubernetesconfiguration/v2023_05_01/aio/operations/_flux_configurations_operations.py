...
from ...operations._flux_configurations_operations import (
...
class FluxConfigurationsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.kubernetesconfiguration.v2023_05_01.models.FluxConfiguration
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type flux_configuration:
         ~azure.mgmt.kubernetesconfiguration.v2023_05_01.models.FluxConfiguration
        ...
        :return: An instance of AsyncLROPoller that returns either FluxConfiguration or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.kubernetesconfiguration.v2023_05_01.models.FluxConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type flux_configuration:
         ~azure.mgmt.kubernetesconfiguration.v2023_05_01.models.FluxConfiguration or IO
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type flux_configuration_patch:
         ~azure.mgmt.kubernetesconfiguration.v2023_05_01.models.FluxConfigurationPatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type flux_configuration_patch:
         ~azure.mgmt.kubernetesconfiguration.v2023_05_01.models.FluxConfigurationPatch or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.FluxConfiguration"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.kubernetesconfiguration.v2023_05_01.models.FluxConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
