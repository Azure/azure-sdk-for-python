...
class PrivateLinkScopesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.KubernetesConfigurationPrivateLinkScope"]:
        """Gets a list of all Azure Arc PrivateLinkScopes within a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either KubernetesConfigurationPrivateLinkScope or the
         result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.kubernetesconfiguration.v2022_04_02_preview.models.KubernetesConfigurationPrivateLinkScope]
        ...
        cls: ClsType[_models.KubernetesConfigurationPrivateLinkScopeListResult] = kwargs.pop("cls", None)
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.KubernetesConfiguration/privateLinkScopes"
    }

    @distributed_trace
    def list_by_resource_group(
        self, resource_group_name: str, **kwargs: Any
    ) -> AsyncIterable["_models.KubernetesConfigurationPrivateLinkScope"]:
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.KubernetesConfiguration/privateLinkScopes"
    }
    ...
    _delete_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.KubernetesConfiguration/privateLinkScopes/{scopeName}"
    }
    ...
    async def create_or_update(
        ...
        resource_group_name: str,
        scope_name: str,
        parameters: Union[_models.KubernetesConfigurationPrivateLinkScope, IO],
        **kwargs: Any
    ) -> _models.KubernetesConfigurationPrivateLinkScope:
        """Creates (or updates) a Azure Arc PrivateLinkScope. Note: You cannot specify a different value
        for InstrumentationKey nor AppId in the Put operation.
        ...
        :type scope_name: str
        :param parameters: Properties that need to be specified to create or update a Azure Arc for
         Servers and Clusters PrivateLinkScope. Is either a KubernetesConfigurationPrivateLinkScope type
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :type private_link_scope_tags:
         ~azure.mgmt.kubernetesconfiguration.v2022_04_02_preview.models.TagsResource or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
