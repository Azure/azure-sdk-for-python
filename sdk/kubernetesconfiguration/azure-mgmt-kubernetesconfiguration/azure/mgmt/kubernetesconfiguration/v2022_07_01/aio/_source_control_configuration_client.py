...
class SourceControlConfigurationClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype extensions:
     azure.mgmt.kubernetesconfiguration.v2022_07_01.aio.operations.ExtensionsOperations
    :ivar operation_status: OperationStatusOperations operations
    :vartype operation_status:
     azure.mgmt.kubernetesconfiguration.v2022_07_01.aio.operations.OperationStatusOperations
    :ivar flux_configurations: FluxConfigurationsOperations operations
    :vartype flux_configurations:
     azure.mgmt.kubernetesconfiguration.v2022_07_01.aio.operations.FluxConfigurationsOperations
    :ivar flux_config_operation_status: FluxConfigOperationStatusOperations operations
    :vartype flux_config_operation_status:
     azure.mgmt.kubernetesconfiguration.v2022_07_01.aio.operations.FluxConfigOperationStatusOperations
    :ivar source_control_configurations: SourceControlConfigurationsOperations operations
    :vartype source_control_configurations:
     azure.mgmt.kubernetesconfiguration.v2022_07_01.aio.operations.SourceControlConfigurationsOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.kubernetesconfiguration.v2022_07_01.aio.operations.Operations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.extensions = ExtensionsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2022-07-01"
        )
        ...
        self.operations = Operations(self._client, self._config, self._serialize, self._deserialize, "2022-07-01")
