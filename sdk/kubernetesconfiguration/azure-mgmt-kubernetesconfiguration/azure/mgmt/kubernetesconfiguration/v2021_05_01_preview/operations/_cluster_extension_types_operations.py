...
def build_list_request(
    ...
    **kwargs: Any
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{clusterRp}/connectedClusters/{clusterName}/providers/Microsoft.KubernetesConfiguration/extensionTypes",
...
class ClusterExtensionTypesOperations:
    ...
    @distributed_trace
    def list(
        self, resource_group_name: str, cluster_rp: Union[str, _models.Enum0], cluster_name: str, **kwargs: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.kubernetesconfiguration.v2021_05_01_preview.models.ExtensionType]
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{clusterRp}/connectedClusters/{clusterName}/providers/Microsoft.KubernetesConfiguration/extensionTypes"
    }
