...
class TestKubernetesConfigurationExtensionsMgmtExtensionsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(KubernetesConfigurationExtensionsMgmtClient)
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_extensions_list(self, resource_group):
