...
class PrivateLinkScopesOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("KubernetesConfigurationPrivateLinkScope", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        resource_group_name: str,
        scope_name: str,
        parameters: Union[_models.KubernetesConfigurationPrivateLinkScope, IO[bytes]],
        **kwargs: Any
    ) -> _models.KubernetesConfigurationPrivateLinkScope:
        """Creates (or updates) a Azure Arc PrivateLinkScope. Note: You cannot specify a different value
        for InstrumentationKey nor AppId in the Put operation.
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :type private_link_scope_tags:
         ~azure.mgmt.kubernetesconfiguration.privatelinkscopes.models.TagsResource or IO[bytes]
        :return: KubernetesConfigurationPrivateLinkScope or the result of cls(response)
        :rtype:
         ~azure.mgmt.kubernetesconfiguration.privatelinkscopes.models.KubernetesConfigurationPrivateLinkScope
        :raises ~azure.core.exceptions.HttpResponseError:
