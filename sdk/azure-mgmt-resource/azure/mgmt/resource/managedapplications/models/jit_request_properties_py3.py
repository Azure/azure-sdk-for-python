...
class JitRequestProperties(Model):
    ...
    def __init__(self, *, application_resource_id: str, jit_authorization_policies, jit_scheduling_policy, publisher_tenant_id: str=None, created_by=None, updated_by=None, **kwargs) -> None:
