...
class JitRequestDefinition(Resource):
    ...
    def __init__(self, *, application_resource_id: str, jit_authorization_policies, jit_scheduling_policy, location: str=None, tags=None, publisher_tenant_id: str=None, created_by=None, updated_by=None, **kwargs) -> None:
        super(JitRequestDefinition, self).__init__(location=location, tags=tags, **kwargs)
        self.application_resource_id = application_resource_id
        self.publisher_tenant_id = publisher_tenant_id
