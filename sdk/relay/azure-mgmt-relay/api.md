...
namespace azure.mgmt.relay
    ...
    class azure.mgmt.relay.RelayClient: implements ContextManager 
...
namespace azure.mgmt.relay.aio
    ...
    class azure.mgmt.relay.aio.RelayClient: implements AsyncContextManager 
        hybrid_connections: HybridConnectionsOperations
        namespaces: NamespacesOperations
        operations: Operations
        private_endpoint_connections: PrivateEndpointConnectionsOperations
...
namespace azure.mgmt.relay.models
    ...
    class azure.mgmt.relay.models.ArmResource(_Model):
        id: Optional[str]
        name: Optional[str]
    ...
    class azure.mgmt.relay.models.ProxyResource(ArmResource):
        id: str
        name: str
        system_data: SystemData
        type: str
    ...
    class azure.mgmt.relay.models.ResourceNamespacePatch(ArmResource):
        id: str
        name: str
        system_data: SystemData
        tags: Optional[dict[str, str]]
    ...
    class azure.mgmt.relay.models.TrackedResource(ArmResource):
        id: str
        location: str
        name: str
        system_data: SystemData
...
namespace azure.mgmt.relay.types
    ...
    class azure.mgmt.relay.types.ArmResource(TypedDict, total=False):
        key "id": str
        key "name": str
    ...
    class azure.mgmt.relay.types.ProxyResource(ArmResource):
        key "id": str
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
    ...
    class azure.mgmt.relay.types.ResourceNamespacePatch(ArmResource):
        key "id": str
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
        key "type": str
    ...
    class azure.mgmt.relay.types.TrackedResource(ArmResource):
        key "id": str
        key "location": Required[str]
        key "name": str
        key "systemData": ForwardRef('SystemData', module='types')
