...
class NamespacesOperations:
    ...
    def check_name_availability(
        ...
        :param parameters: Parameters to check availability of the specified namespace name. Is either
         a CheckNameAvailability type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.relay.models.CheckNameAvailability or IO[bytes]
        :return: CheckNameAvailabilityResult or the result of cls(response)
        :rtype: ~azure.mgmt.relay.models.CheckNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(self, **kwargs: Any) -> ItemPaged["_models.RelayNamespace"]:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.RelayNamespaceListResult] = kwargs.pop("cls", None)
    ...
    def _create_or_update_initial(
        ...
        namespace_name: str,
        parameters: Union[_models.RelayNamespace, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.relay.models.RelayNamespace or IO[bytes]
        :return: An instance of LROPoller that returns either RelayNamespace or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.relay.models.RelayNamespace]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("RelayNamespace", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
    ...
    def update(
        ...
        resource_group_name: str,
        namespace_name: str,
        parameters: Union[_models.RelayUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.RelayNamespace:
        """Creates or updates a namespace. Once created, this namespace's resource manifest is immutable.
        This operation is idempotent.
        ...
        :type parameters: ~azure.mgmt.relay.models.RelayUpdateParameters or IO[bytes]
        :return: RelayNamespace or the result of cls(response)
        :rtype: ~azure.mgmt.relay.models.RelayNamespace
        :raises ~azure.core.exceptions.HttpResponseError:
        """
