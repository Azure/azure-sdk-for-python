...
from .operations import HybridConnectionsOperations, NamespacesOperations, Operations, PrivateEndpointConnectionsOperations, PrivateLinkResourcesOperations, WCFRelaysOperations
...
class RelayAPI:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = RelayAPIConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
        ...
        self.hybrid_connections = HybridConnectionsOperations(self._client, self._config, self._serialize, self._deserialize)
