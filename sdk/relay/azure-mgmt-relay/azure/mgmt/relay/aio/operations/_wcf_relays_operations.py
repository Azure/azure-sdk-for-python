...
class WCFRelaysOperations:
    ...
    def list_by_namespace(
    ...
    ) -> AsyncItemPaged["_models.WcfRelay"]:
        ...
        cls: ClsType[_models.WcfRelaysListResult] = kwargs.pop("cls", None)
    ...
    async def create_or_update(
        ...
        namespace_name: str,
        relay_name: str,
        parameters: Union[_models.WcfRelay, IO[bytes]],
        **kwargs: Any
    ) -> _models.WcfRelay:
        """Creates or updates a WCF relay. This operation is idempotent.
        ...
        :type parameters: ~azure.mgmt.relay.models.WcfRelay or IO[bytes]
        :return: WcfRelay or the result of cls(response)
        :rtype: ~azure.mgmt.relay.models.WcfRelay
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        deserialized = self._deserialize("WcfRelay", pipeline_response.http_response)
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, namespace_name: str, relay_name: str, **kwargs: Any) -> None:
        """Deletes a WCF relay.
