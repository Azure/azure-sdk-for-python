...
# USAGE
    python relay_name_space_authorization_rule_regenrate_key.py
...
# x-ms-original-file: specification/relay/resource-manager/Microsoft.Relay/Relay/stable/2017-04-01/examples/NameSpaces/RelayNameSpaceAuthorizationRuleRegenrateKey.json
