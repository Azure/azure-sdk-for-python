...
# USAGE
    python relay_name_space_autorization_rule_get.py
...
# x-ms-original-file: specification/relay/resource-manager/Microsoft.Relay/Relay/stable/2017-04-01/examples/NameSpaces/RelayNameSpaceAutorizationRuleGet.json
