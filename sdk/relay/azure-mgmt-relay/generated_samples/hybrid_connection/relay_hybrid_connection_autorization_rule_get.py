...
# USAGE
    python relay_hybrid_connection_autorization_rule_get.py
...
# x-ms-original-file: specification/relay/resource-manager/Microsoft.Relay/Relay/stable/2017-04-01/examples/HybridConnection/RelayHybridConnectionAutorizationRuleGet.json
