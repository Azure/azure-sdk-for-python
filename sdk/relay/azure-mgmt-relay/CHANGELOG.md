...
### Features Added
  ...
  - Model `NamespacesOperations` added method `create_or_update_network_rule_set`
  - Model `NamespacesOperations` added method `get_network_rule_set`
