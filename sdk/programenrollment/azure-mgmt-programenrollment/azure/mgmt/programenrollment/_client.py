...
class ProgramEnrollmentMgmtClient:
    ...
    :vartype operations: azure.mgmt.programenrollment.operations.Operations
    :ivar edu_enrollments: EduEnrollmentsOperations operations
    :vartype edu_enrollments: azure.mgmt.programenrollment.operations.EduEnrollmentsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.edu_enrollments = EduEnrollmentsOperations(self._client, self._config, self._serialize, self._deserialize)
