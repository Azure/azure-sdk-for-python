...
class Operations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.customerlockbox.models.OperationPaged[~azure.mgmt.customerlockbox.models.Operation]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.customerlockbox.models.ErrorResponseException>`
        """
        ...
        return deserialized
    list.metadata = {'url': '/providers/Microsoft.CustomerLockbox/operations'}
