...
class UpdatesOperations:
    ...
    def put(
        ...
        cluster_name: str,
        update_name: str,
        update_properties: Union[_models.Update, IO[bytes]],
        **kwargs: Any
    ) -> _models.Update:
        """Put specified Update.
        ...
        :type update_properties: ~azure.mgmt.azurestackhci.models.Update or IO[bytes]
        :return: Update or the result of cls(response)
        :rtype: ~azure.mgmt.azurestackhci.models.Update
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        deserialized = self._deserialize("Update", pipeline_response.http_response)
