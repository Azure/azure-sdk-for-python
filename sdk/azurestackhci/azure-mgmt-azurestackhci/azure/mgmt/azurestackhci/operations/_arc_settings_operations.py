...
def build_consent_and_install_default_extensions_request(  # pylint: disable=name-too-long
    resource_group_name: str, cluster_name: str, arc_setting_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_initialize_disable_process_request(
    resource_group_name: str, cluster_name: str, arc_setting_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ArcSettingsOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("ArcSetting", pipeline_response.http_response)
    ...
    def create(
        ...
        cluster_name: str,
        arc_setting_name: str,
        arc_setting: Union[_models.ArcSetting, IO[bytes]],
        **kwargs: Any
    ) -> _models.ArcSetting:
        """Create ArcSetting for HCI cluster.
        ...
        :type arc_setting: ~azure.mgmt.azurestackhci.models.ArcSetting or IO[bytes]
        :return: ArcSetting or the result of cls(response)
        :rtype: ~azure.mgmt.azurestackhci.models.ArcSetting
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update(
        ...
        cluster_name: str,
        arc_setting_name: str,
        arc_setting: Union[_models.ArcSettingsPatch, IO[bytes]],
        **kwargs: Any
    ) -> _models.ArcSetting:
        """Update ArcSettings for HCI cluster.
        ...
        :type arc_setting: ~azure.mgmt.azurestackhci.models.ArcSettingsPatch or IO[bytes]
        :return: ArcSetting or the result of cls(response)
        :rtype: ~azure.mgmt.azurestackhci.models.ArcSetting
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def generate_password(
        ...
        _request = build_generate_password_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            arc_setting_name=arc_setting_name,
            subscription_id=self._config.subscription_id,
        ...
        deserialized = self._deserialize("PasswordCredential", pipeline_response.http_response)
    ...
    def begin_create_identity(
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("ArcIdentityResponse", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
    ...
    def consent_and_install_default_extensions(
        ...
        _request = build_consent_and_install_default_extensions_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            arc_setting_name=arc_setting_name,
            subscription_id=self._config.subscription_id,
    ...
    def _initialize_disable_process_initial(
        ...
        _request = build_initialize_disable_process_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            arc_setting_name=arc_setting_name,
            subscription_id=self._config.subscription_id,
