...
class NetworkInterfacesOperations:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/networkInterfaces/{networkInterfaceName}"
    }
    ...
    def _create_or_update_initial(
        ...
        network_interfaces: Union[_models.NetworkInterfaces, IO],
        **kwargs: Any
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        network_interface_name: str,
        network_interfaces: Union[_models.NetworkInterfacesUpdateRequest, IO],
        **kwargs: Any
    ) -> Optional[_models.NetworkInterfaces]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
