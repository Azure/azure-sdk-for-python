...
def build_deployment_settings_get_request(
    resource_group_name: str, cluster_name: str, deployment_settings_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_edge_device_jobs_list_by_edge_device_request(  # pylint: disable=name-too-long
    resource_uri: str, edge_device_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_edge_devices_get_request(resource_uri: str, edge_device_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_edge_devices_delete_request(resource_uri: str, edge_device_name: str, **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_edge_devices_validate_request(resource_uri: str, edge_device_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_security_settings_get_request(
    resource_group_name: str, cluster_name: str, security_settings_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class EdgeDevicesOperations:
    ...
    @distributed_trace
    def get(self, resource_uri: str, edge_device_name: str, **kwargs: Any) -> _models.EdgeDevice:
        """Get a EdgeDevice.
    ...
    def _delete_initial(self, resource_uri: str, edge_device_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def begin_delete(self, resource_uri: str, edge_device_name: str, **kwargs: Any) -> LROPoller[None]:
        """Delete a EdgeDevice.
