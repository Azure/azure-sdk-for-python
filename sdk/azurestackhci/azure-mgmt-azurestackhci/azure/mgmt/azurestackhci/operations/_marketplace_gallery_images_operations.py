...
class MarketplaceGalleryImagesOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.MarketplaceGalleryImages"]:
    ...
    @distributed_trace
    def list_all(self, **kwargs: Any) -> ItemPaged["_models.MarketplaceGalleryImages"]:
