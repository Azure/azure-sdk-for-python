...
from ...operations._extensions_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_arc_setting_request, build_update_request_initial
T = TypeVar('T')
...
class ExtensionsOperations:
    ...
    def list_by_arc_setting(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.ExtensionList"]:
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.Extension"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
