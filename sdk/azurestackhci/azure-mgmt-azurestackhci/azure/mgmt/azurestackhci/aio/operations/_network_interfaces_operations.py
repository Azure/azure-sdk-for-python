...
class NetworkInterfacesOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> AsyncItemPaged["_models.NetworkInterfaces"]:
    ...
    @distributed_trace
    def list_all(self, **kwargs: Any) -> AsyncItemPaged["_models.NetworkInterfaces"]:
