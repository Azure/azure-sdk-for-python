...
class UpdateSummariesOperations:
    ...
    async def put(
        ...
        resource_group_name: str,
        cluster_name: str,
        update_location_properties: Union[_models.UpdateSummaries, IO[bytes]],
        **kwargs: Any
    ) -> _models.UpdateSummaries:
        """Put Update summaries under the HCI cluster.
        ...
        :type update_location_properties: ~azure.mgmt.azurestackhci.models.UpdateSummaries or IO[bytes]
        :return: UpdateSummaries or the result of cls(response)
        :rtype: ~azure.mgmt.azurestackhci.models.UpdateSummaries
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        deserialized = self._deserialize("UpdateSummaries", pipeline_response.http_response)
