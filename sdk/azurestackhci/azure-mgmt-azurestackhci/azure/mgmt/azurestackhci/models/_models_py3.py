...
class AdapterPropertyOverridesAutoGenerated(_serialization.Model):
    """The AdapterPropertyOverrides of a cluster.
...
class ErrorDetailAutoGenerated(_serialization.Model):
    ...
    :vartype target: str
    :ivar details: The error details.
    :vartype details: list[~azure.mgmt.azurestackhci.models.ErrorDetailAutoGenerated]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.azurestackhci.models.ErrorAdditionalInfo]
    """
...
class ErrorResponseAutoGenerated(_serialization.Model):
    ...
    :ivar error: The error object.
    :vartype error: ~azure.mgmt.azurestackhci.models.ErrorDetailAutoGenerated
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetailAutoGenerated"] = None, **kwargs: Any) -> None:
        """
        :keyword error: The error object.
        :paramtype error: ~azure.mgmt.azurestackhci.models.ErrorDetailAutoGenerated
        """
        super().__init__(**kwargs)
        self.error = error
...
class Extension(ProxyResourceAutoGenerated):  # pylint: disable=too-many-instance-attributes
...
class ExtensionAutoGenerated(_serialization.Model):
    ...
    :vartype error_details: list[~azure.mgmt.azurestackhci.models.ErrorDetailAutoGenerated2]
    ...
    _attribute_map = {
        ...
        "error_details": {"key": "errorDetails", "type": "[ErrorDetailAutoGenerated2]"},
...
class ExtensionProfile(_serialization.Model):
    ...
    :vartype extensions: list[~azure.mgmt.azurestackhci.models.ExtensionAutoGenerated]
    """
    ...
    _attribute_map = {
        "extensions": {"key": "extensions", "type": "[ExtensionAutoGenerated]"},
    }
...
class HciNetworkProfile(_serialization.Model):
    ...
    :ivar host_network: HostNetwork config to deploy AzureStackHCI Cluster.
    :vartype host_network: ~azure.mgmt.azurestackhci.models.HostNetworkAutoGenerated
    """
    ...
    _attribute_map = {
        ...
        "host_network": {"key": "hostNetwork", "type": "HostNetworkAutoGenerated"},
    }
...
class HostNetworkAutoGenerated(_serialization.Model):
    """The HostNetwork of a cluster.
    ...
    :ivar intents: The network intents assigned to the network reference pattern used for the
     deployment. Each intent will define its own name, traffic type, adapter names, and overrides as
     recommended by your OEM.
    :vartype intents: list[~azure.mgmt.azurestackhci.models.IntentsAutoGenerated]
    :ivar storage_networks: List of StorageNetworks config to deploy AzureStackHCI Cluster.
    :vartype storage_networks: list[~azure.mgmt.azurestackhci.models.StorageNetworksAutoGenerated]
    :ivar storage_connectivity_switchless: Defines how the storage adapters between nodes are
     connected either switch or switch less.
    :vartype storage_connectivity_switchless: bool
    :ivar enable_storage_auto_ip: Optional parameter required only for 3 Nodes Switchless
    ...
    _attribute_map = {
        "intents": {"key": "intents", "type": "[IntentsAutoGenerated]"},
        "storage_networks": {"key": "storageNetworks", "type": "[StorageNetworksAutoGenerated]"},
        "storage_connectivity_switchless": {"key": "storageConnectivitySwitchless", "type": "bool"},
        "enable_storage_auto_ip": {"key": "enableStorageAutoIp", "type": "bool"},
    }
...
class IntentsAutoGenerated(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    """The Intents of a cluster.
    ...
    :ivar virtual_switch_configuration_overrides: Set virtualSwitch ConfigurationOverrides for
     cluster.
    :vartype virtual_switch_configuration_overrides:
     ~azure.mgmt.azurestackhci.models.VirtualSwitchConfigurationOverridesAutoGenerated
    :ivar override_qos_policy: This parameter should only be modified based on your OEM guidance.
     Do not modify this parameter without OEM validation.
    :vartype override_qos_policy: bool
    :ivar qos_policy_overrides: Set QoS PolicyOverrides for cluster.
    ...
    :vartype adapter_property_overrides:
     ~azure.mgmt.azurestackhci.models.AdapterPropertyOverridesAutoGenerated
    """
    ...
    _attribute_map = {
        ...
        "virtual_switch_configuration_overrides": {
            "key": "virtualSwitchConfigurationOverrides",
            "type": "VirtualSwitchConfigurationOverridesAutoGenerated",
        },
        "override_qos_policy": {"key": "overrideQosPolicy", "type": "bool"},
        "qos_policy_overrides": {"key": "qosPolicyOverrides", "type": "QosPolicyOverrides"},
        "override_adapter_property": {"key": "overrideAdapterProperty", "type": "bool"},
        "adapter_property_overrides": {
            ...
            "type": "AdapterPropertyOverridesAutoGenerated",
        },
    }
...
class Offer(ProxyResourceAutoGenerated):
    """Offer details.
...
class Publisher(ProxyResourceAutoGenerated):
    """Publisher details.
...
class Sku(ProxyResourceAutoGenerated):
    """Sku details.
...
class StorageAdapterIPInfo(_serialization.Model):
...
class StorageAdapterIPInfoAutoGenerated(_serialization.Model):
    """The StorageAdapter physical nodes of a cluster.
...
class StorageNetworks(_serialization.Model):
    ...
    :ivar storage_adapter_ip_info: List of Storage adapter physical nodes config to deploy
     AzureStackHCI Cluster.
    :vartype storage_adapter_ip_info: list[~azure.mgmt.azurestackhci.models.StorageAdapterIPInfo]
    """
    ...
    _attribute_map = {
        ...
        "vlan_id": {"key": "vlanId", "type": "str"},
        "storage_adapter_ip_info": {"key": "storageAdapterIPInfo", "type": "[StorageAdapterIPInfo]"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        storage_adapter_ip_info: Optional[List["_models.StorageAdapterIPInfo"]] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :keyword storage_adapter_ip_info: List of Storage adapter physical nodes config to deploy
         AzureStackHCI Cluster.
        :paramtype storage_adapter_ip_info: list[~azure.mgmt.azurestackhci.models.StorageAdapterIPInfo]
        """
        super().__init__(**kwargs)
        self.name = name
...
class StorageNetworksAutoGenerated(_serialization.Model):
    """The StorageNetworks of a cluster.
    ...
    :vartype storage_adapter_ip_info:
     list[~azure.mgmt.azurestackhci.models.StorageAdapterIPInfoAutoGenerated]
    """
    ...
    _attribute_map = {
        ...
        "storage_adapter_ip_info": {"key": "storageAdapterIPInfo", "type": "[StorageAdapterIPInfoAutoGenerated]"},
    }
...
class Update(ProxyResourceAutoGenerated):  # pylint: disable=too-many-instance-attributes
    """Update details.
...
class UpdateRun(ProxyResourceAutoGenerated):  # pylint: disable=too-many-instance-attributes
...
class UpdateSummaries(ProxyResourceAutoGenerated):  # pylint: disable=too-many-instance-attributes
...
class VirtualSwitchConfigurationOverridesAutoGenerated(_serialization.Model):  # pylint: disable=name-too-long
    """The VirtualSwitchConfigurationOverrides of a cluster.
