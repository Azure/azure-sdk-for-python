...
# USAGE
    python validate_ownership_vouchers_by_resource_group.py
...
def main():
    ...
    response = client.ownership_vouchers.validate(
        resource_group_name="ArcInstance-rg",
        location="westus",
        validation_request={
            "ownershipVoucherDetails": [
                {"ownerKeyType": "MicrosoftManaged", "ownershipVoucher": "Device Model Ownership content"}
            ]
        },
    )
    print(response)
