...
# USAGE
    python edge_machines_create_or_update.py
...
def main():
    ...
    response = client.edge_machines.begin_create_or_update(
...
# x-ms-original-file: 2026-05-01-preview/EdgeMachines_CreateOrUpdate.json
