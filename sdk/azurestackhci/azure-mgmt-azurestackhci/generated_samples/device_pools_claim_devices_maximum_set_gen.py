...
# USAGE
    python device_pools_claim_devices_maximum_set_gen.py
...
def main():
    ...
    client.device_pools.begin_claim_devices(
        resource_group_name="ArcInstance-rg",
        device_pool_name="ptfebvgxxqllx",
        body={
            "claimedBy": "/subscriptions/fd3c3665-1729-4b7b-9a38-238e83b0f98b/resourceGroups/ArcInstance-rg/providers/Microsoft.AzureStackHCI/clusters/cluster1",
            "devices": [
