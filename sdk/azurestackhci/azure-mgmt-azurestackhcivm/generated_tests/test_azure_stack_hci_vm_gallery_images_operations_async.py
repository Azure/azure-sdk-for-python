...
class TestAzureStackHCIVmGalleryImagesOperationsAsync(AzureMgmtRecordedTestCase):
            ...
            await self.client.gallery_images.begin_create_or_update(
                ...
                resource={
                    ...
                    "properties": {
                        ...
                        "vmImageRepositoryCredentials": {"password": "str", "username": "str"},
                    },
                    "systemData": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_gallery_images_list_by_resource_group(self, resource_group):
