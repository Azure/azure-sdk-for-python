...
class TestAzureStackHCIVmMarketplaceGalleryImagesOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(AzureStackHCIVmClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_marketplace_gallery_images_list_by_resource_group(self, resource_group):
        response = self.client.marketplace_gallery_images.list_by_resource_group(
