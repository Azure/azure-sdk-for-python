...
class TestAzureStackHCIVmMarketplaceGalleryImagesOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(AzureStackHCIVmClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_marketplace_gallery_images_list_by_resource_group(self, resource_group):
