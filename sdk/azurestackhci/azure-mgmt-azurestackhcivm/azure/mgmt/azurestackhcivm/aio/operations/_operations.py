...
from ...operations._operations import (
    build_attestation_statuses_get_request,
    build_gallery_images_create_or_update_request,
    build_gallery_images_delete_request,
    build_gallery_images_get_request,
    build_gallery_images_list_all_request,
    build_gallery_images_list_by_resource_group_request,
    ...
    build_hybrid_identity_metadata_get_request,
    build_hybrid_identity_metadata_list_by_virtual_machine_instance_request,
    build_logical_networks_create_or_update_request,
    build_logical_networks_delete_request,
    build_logical_networks_get_request,
    build_logical_networks_list_all_request,
    build_logical_networks_list_by_resource_group_request,
    build_logical_networks_update_request,
    build_marketplace_gallery_images_create_or_update_request,
    build_marketplace_gallery_images_delete_request,
    build_marketplace_gallery_images_get_request,
    build_marketplace_gallery_images_list_all_request,
    build_marketplace_gallery_images_list_by_resource_group_request,
    build_marketplace_gallery_images_update_request,
    ...
    build_network_interfaces_list_by_resource_group_request,
    ...
    build_network_security_groups_list_by_resource_group_request,
    ...
    build_security_rules_list_by_network_security_group_request,
    ...
    build_storage_containers_list_all_request,
    build_storage_containers_list_by_resource_group_request,
    build_storage_containers_update_request,
    build_virtual_hard_disks_create_or_update_request,
    build_virtual_hard_disks_delete_request,
    build_virtual_hard_disks_get_request,
    build_virtual_hard_disks_list_all_request,
    build_virtual_hard_disks_list_by_resource_group_request,
    build_virtual_hard_disks_update_request,
    build_virtual_hard_disks_upload_request,
    ...
    build_virtual_machine_instances_pause_request,
    build_virtual_machine_instances_restart_request,
    build_virtual_machine_instances_save_request,
...
class GalleryImagesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.azurestackhcivm.aio.AzureStackHCIVmClient`'s
    ...
    async def get(self, resource_group_name: str, gallery_image_name: str, **kwargs: Any) -> _models.GalleryImage:
        ...
        :rtype: ~azure.mgmt.azurestackhcivm.models.GalleryImage
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.GalleryImage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncItemPaged["_models.GalleryImage"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestackhcivm.models.GalleryImage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_gallery_images_list_by_resource_group_request(
                    resource_group_name=resource_group_name,
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
                    headers=_headers,
    ...
    @distributed_trace
    def list_all(self, **kwargs: Any) -> AsyncItemPaged["_models.GalleryImage"]:
...
class LogicalNetworksOperations:
    ...
    async def get(self, resource_group_name: str, logical_network_name: str, **kwargs: Any) -> _models.LogicalNetwork:
        ...
        _request = build_logical_networks_get_request(
            resource_group_name=resource_group_name,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.LogicalNetwork, response.json())
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _request = build_logical_networks_create_or_update_request(
            resource_group_name=resource_group_name,
            logical_network_name=logical_network_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns LogicalNetwork. The LogicalNetwork is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.LogicalNetwork]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        _request = build_logical_networks_update_request(
            resource_group_name=resource_group_name,
            logical_network_name=logical_network_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
    ...
    async def _delete_initial(
        ...
        _request = build_logical_networks_delete_request(
            resource_group_name=resource_group_name,
            logical_network_name=logical_network_name,
            subscription_id=self._config.subscription_id,
            api_version=self._config.api_version,
    ...
    def list_by_resource_group(
    ...
    ) -> AsyncItemPaged["_models.LogicalNetwork"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestackhcivm.models.LogicalNetwork]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_logical_networks_list_by_resource_group_request(
                    resource_group_name=resource_group_name,
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
                    headers=_headers,
    ...
    @distributed_trace
    def list_all(self, **kwargs: Any) -> AsyncItemPaged["_models.LogicalNetwork"]:
...
class MarketplaceGalleryImagesOperations:
    ...
    async def get(
        ...
        _request = build_marketplace_gallery_images_get_request(
            resource_group_name=resource_group_name,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.MarketplaceGalleryImage, response.json())
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _request = build_marketplace_gallery_images_create_or_update_request(
            resource_group_name=resource_group_name,
            marketplace_gallery_image_name=marketplace_gallery_image_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns MarketplaceGalleryImage. The
         MarketplaceGalleryImage is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.MarketplaceGalleryImage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        _request = build_marketplace_gallery_images_update_request(
            resource_group_name=resource_group_name,
            marketplace_gallery_image_name=marketplace_gallery_image_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
    ...
    async def _delete_initial(
        ...
        _request = build_marketplace_gallery_images_delete_request(
            resource_group_name=resource_group_name,
            marketplace_gallery_image_name=marketplace_gallery_image_name,
            subscription_id=self._config.subscription_id,
            api_version=self._config.api_version,
    ...
    def list_by_resource_group(
        self, resource_group_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.MarketplaceGalleryImage"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestackhcivm.models.MarketplaceGalleryImage]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_marketplace_gallery_images_list_by_resource_group_request(
                    resource_group_name=resource_group_name,
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
                    headers=_headers,
    ...
    @distributed_trace
    def list_all(self, **kwargs: Any) -> AsyncItemPaged["_models.MarketplaceGalleryImage"]:
...
class NetworkInterfacesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns NetworkInterface. The NetworkInterface is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.NetworkInterface]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_update(
        ...
        resource_group_name: str,
        network_interface_name: str,
        properties: _models.NetworkInterfacesUpdateRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.NetworkInterface]:
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestackhcivm.models.NetworkInterface]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_network_interfaces_list_by_resource_group_request(
                    resource_group_name=resource_group_name,
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
                    headers=_headers,
...
class NetworkSecurityGroupsOperations:
    ...
    async def get(
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.NetworkSecurityGroup, response.json())
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.NetworkSecurityGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_resource_group(
        self, resource_group_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.NetworkSecurityGroup"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestackhcivm.models.NetworkSecurityGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_network_security_groups_list_by_resource_group_request(
                    resource_group_name=resource_group_name,
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
                    headers=_headers,
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.NetworkSecurityGroup], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, AsyncList(list_of_elem)
...
class SecurityRulesOperations:
    ...
    async def get(
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.SecurityRule, response.json())
    ...
    async def _create_or_update_initial(
        ...
        resource: Union[_models.SecurityRule, JSON, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type security_rule_name: str
        :param resource: Resource create parameters. Required.
        :type resource: ~azure.mgmt.azurestackhcivm.models.SecurityRule
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns SecurityRule. The SecurityRule is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.SecurityRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param security_rule_name: Name of the security rule. Required.
        :type security_rule_name: str
        :param resource: Resource create parameters. Is one of the following types: SecurityRule, JSON,
         IO[bytes] Required.
        :type resource: ~azure.mgmt.azurestackhcivm.models.SecurityRule or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns SecurityRule. The SecurityRule is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.SecurityRule]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_network_security_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestackhcivm.models.SecurityRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_security_rules_list_by_network_security_group_request(
                    resource_group_name=resource_group_name,
                    network_security_group_name=network_security_group_name,
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.SecurityRule], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, AsyncList(list_of_elem)
...
class StorageContainersOperations:
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.azurestackhcivm.models.StorageContainer
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type storage_container_name: str
        :param resource: Resource create parameters. Required.
        :type resource: ~azure.mgmt.azurestackhcivm.models.StorageContainer
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns StorageContainer. The StorageContainer is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.StorageContainer]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is one of the following types: StorageContainer,
         JSON, IO[bytes] Required.
        :type resource: ~azure.mgmt.azurestackhcivm.models.StorageContainer or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns StorageContainer. The StorageContainer is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.StorageContainer]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        storage_container_name: str,
        properties: Union[_models.StorageContainerTagsUpdate, JSON, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type storage_container_name: str
        :param properties: The resource properties to be updated. Required.
        :type properties: ~azure.mgmt.azurestackhcivm.models.StorageContainerTagsUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns StorageContainer. The StorageContainer is
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type storage_container_name: str
        :param properties: The resource properties to be updated. Is one of the following types:
         StorageContainerTagsUpdate, JSON, IO[bytes] Required.
        :type properties: ~azure.mgmt.azurestackhcivm.models.StorageContainerTagsUpdate or JSON or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns StorageContainer. The StorageContainer is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.StorageContainer]
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestackhcivm.models.StorageContainer]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.StorageContainer], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, AsyncList(list_of_elem)
    ...
    @distributed_trace
    def list_all(self, **kwargs: Any) -> AsyncItemPaged["_models.StorageContainer"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_storage_containers_list_all_request(
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
                    headers=_headers,
                    params=_params,
...
class VirtualHardDisksOperations:
    ...
    async def get(
        ...
        :return: VirtualHardDisk. The VirtualHardDisk is compatible with MutableMapping
        :rtype: ~azure.mgmt.azurestackhcivm.models.VirtualHardDisk
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _request = build_virtual_hard_disks_get_request(
            resource_group_name=resource_group_name,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.VirtualHardDisk, response.json())
    ...
    async def _create_or_update_initial(
        ...
        resource: Union[_models.VirtualHardDisk, JSON, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _request = build_virtual_hard_disks_create_or_update_request(
            resource_group_name=resource_group_name,
            virtual_hard_disk_name=virtual_hard_disk_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type virtual_hard_disk_name: str
        :param resource: Resource create parameters. Required.
        :type resource: ~azure.mgmt.azurestackhcivm.models.VirtualHardDisk
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns VirtualHardDisk. The VirtualHardDisk is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.VirtualHardDisk]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param virtual_hard_disk_name: Name of the virtual hard disk. Required.
        :type virtual_hard_disk_name: str
        :param resource: Resource create parameters. Is one of the following types: VirtualHardDisk,
         JSON, IO[bytes] Required.
        :type resource: ~azure.mgmt.azurestackhcivm.models.VirtualHardDisk or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns VirtualHardDisk. The VirtualHardDisk is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.VirtualHardDisk]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        virtual_hard_disk_name: str,
        properties: Union[_models.VirtualHardDisksUpdateRequest, JSON, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _request = build_virtual_hard_disks_update_request(
            resource_group_name=resource_group_name,
            virtual_hard_disk_name=virtual_hard_disk_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
    ...
    async def begin_update(
        ...
        resource_group_name: str,
        virtual_hard_disk_name: str,
        properties: _models.VirtualHardDisksUpdateRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.VirtualHardDisk]:
        ...
        :type virtual_hard_disk_name: str
        :param properties: The resource properties to be updated. Required.
        :type properties: ~azure.mgmt.azurestackhcivm.models.VirtualHardDisksUpdateRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns VirtualHardDisk. The VirtualHardDisk is
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type virtual_hard_disk_name: str
        :param properties: The resource properties to be updated. Is one of the following types:
         VirtualHardDisksUpdateRequest, JSON, IO[bytes] Required.
        :type properties: ~azure.mgmt.azurestackhcivm.models.VirtualHardDisksUpdateRequest or JSON or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns VirtualHardDisk. The VirtualHardDisk is
         compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.VirtualHardDisk]
    ...
    async def _delete_initial(
        ...
        _request = build_virtual_hard_disks_delete_request(
            resource_group_name=resource_group_name,
            virtual_hard_disk_name=virtual_hard_disk_name,
            subscription_id=self._config.subscription_id,
            api_version=self._config.api_version,
    ...
    def list_by_resource_group(
        self, resource_group_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.VirtualHardDisk"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestackhcivm.models.VirtualHardDisk]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[List[_models.VirtualHardDisk]] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_virtual_hard_disks_list_by_resource_group_request(
                    resource_group_name=resource_group_name,
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
                    headers=_headers,
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.VirtualHardDisk], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, AsyncList(list_of_elem)
    ...
    @distributed_trace
    def list_all(self, **kwargs: Any) -> AsyncItemPaged["_models.VirtualHardDisk"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_virtual_hard_disks_list_all_request(
                    subscription_id=self._config.subscription_id,
                    api_version=self._config.api_version,
                    headers=_headers,
                    params=_params,
    ...
    async def _upload_initial(
        ...
        resource_group_name: str,
        virtual_hard_disk_name: str,
        body: Union[_models.VirtualHardDiskUploadRequest, JSON, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _request = build_virtual_hard_disks_upload_request(
            resource_group_name=resource_group_name,
            virtual_hard_disk_name=virtual_hard_disk_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
    ...
    async def begin_upload(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.azurestackhcivm.models.VirtualHardDiskUploadRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns VirtualHardDiskUploadResponse. The
         VirtualHardDiskUploadResponse is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.VirtualHardDiskUploadResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_upload(
        ...
        **kwargs: Any
        ...
        :param body: The content of the action request. Is one of the following types:
         VirtualHardDiskUploadRequest, JSON, IO[bytes] Required.
        :type body: ~azure.mgmt.azurestackhcivm.models.VirtualHardDiskUploadRequest or JSON or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns VirtualHardDiskUploadResponse. The
         VirtualHardDiskUploadResponse is compatible with MutableMapping
        :rtype:
        ...
        def get_long_running_output(pipeline_response):
            ...
            deserialized = _deserialize(_models.VirtualHardDiskUploadResponse, response.json())
            if cls:
                return cls(pipeline_response, deserialized, response_headers)  # type: ignore
            return deserialized
...
class VirtualMachineInstancesOperations:
    ...
    async def get(self, resource_uri: str, **kwargs: Any) -> _models.VirtualMachineInstance:
        ...
        :rtype: ~azure.mgmt.azurestackhcivm.models.VirtualMachineInstance
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource_uri: str
        :param resource: Resource create parameters. Required.
        :type resource: ~azure.mgmt.azurestackhcivm.models.VirtualMachineInstance
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.VirtualMachineInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        :type resource: ~azure.mgmt.azurestackhcivm.models.VirtualMachineInstance or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns VirtualMachineInstance. The
         VirtualMachineInstance is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.VirtualMachineInstance]
    ...
    async def _update_initial(
        self,
        resource_uri: str,
        properties: Union[_models.VirtualMachineInstanceUpdateRequest, JSON, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type resource_uri: str
        :param properties: The resource properties to be updated. Required.
        :type properties: ~azure.mgmt.azurestackhcivm.models.VirtualMachineInstanceUpdateRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns VirtualMachineInstance. The
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type resource_uri: str
        :param properties: The resource properties to be updated. Is one of the following types:
         VirtualMachineInstanceUpdateRequest, JSON, IO[bytes] Required.
        :type properties: ~azure.mgmt.azurestackhcivm.models.VirtualMachineInstanceUpdateRequest or
         JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns VirtualMachineInstance. The
         VirtualMachineInstance is compatible with MutableMapping
        :rtype:
    ...
    def list(self, resource_uri: str, **kwargs: Any) -> AsyncItemPaged["_models.VirtualMachineInstance"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestackhcivm.models.VirtualMachineInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def _pause_initial(self, resource_uri: str, **kwargs: Any) -> AsyncIterator[bytes]:
        ...
        _request = build_virtual_machine_instances_pause_request(
            resource_uri=resource_uri,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    async def _save_initial(self, resource_uri: str, **kwargs: Any) -> AsyncIterator[bytes]:
        ...
        _request = build_virtual_machine_instances_save_request(
            resource_uri=resource_uri,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
...
class HybridIdentityMetadataOperations:
    ...
    async def get(self, resource_uri: str, **kwargs: Any) -> _models.HybridIdentityMetadata:
        ...
        :param resource_uri: The fully qualified Azure Resource manager identifier of the resource.
         Required.
        :type resource_uri: str
        :return: HybridIdentityMetadata. The HybridIdentityMetadata is compatible with MutableMapping
        :rtype: ~azure.mgmt.azurestackhcivm.models.HybridIdentityMetadata
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _request = build_hybrid_identity_metadata_get_request(
            resource_uri=resource_uri,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.HybridIdentityMetadata, response.json())
    ...
    def list_by_virtual_machine_instance(
    ...
    ) -> AsyncItemPaged["_models.HybridIdentityMetadata"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestackhcivm.models.HybridIdentityMetadata]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[List[_models.HybridIdentityMetadata]] = kwargs.pop("cls", None)
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_hybrid_identity_metadata_list_by_virtual_machine_instance_request(
                    resource_uri=resource_uri,
                    api_version=self._config.api_version,
                    headers=_headers,
                    params=_params,
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.HybridIdentityMetadata], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, AsyncList(list_of_elem)
...
class AttestationStatusesOperations:
    ...
    async def get(self, resource_uri: str, **kwargs: Any) -> _models.AttestationStatus:
        ...
        :param resource_uri: The fully qualified Azure Resource manager identifier of the resource.
         Required.
        :type resource_uri: str
        :return: AttestationStatus. The AttestationStatus is compatible with MutableMapping
        :rtype: ~azure.mgmt.azurestackhcivm.models.AttestationStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _request = build_attestation_statuses_get_request(
            resource_uri=resource_uri,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.AttestationStatus, response.json())
...
class GuestAgentsOperations:
    ...
    async def get(self, resource_uri: str, **kwargs: Any) -> _models.GuestAgent:
        ...
        :rtype: ~azure.mgmt.azurestackhcivm.models.GuestAgent
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_create(
        ...
        :type resource_uri: str
        :param resource: Resource create parameters. Required.
        :type resource: ~azure.mgmt.azurestackhcivm.models.GuestAgent
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns GuestAgent. The GuestAgent is compatible
         with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.GuestAgent]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        :param resource: Resource create parameters. Is one of the following types: GuestAgent, JSON,
         IO[bytes] Required.
        :type resource: ~azure.mgmt.azurestackhcivm.models.GuestAgent or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns GuestAgent. The GuestAgent is compatible
         with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azurestackhcivm.models.GuestAgent]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list_by_virtual_machine_instance(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azurestackhcivm.models.GuestAgent]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
