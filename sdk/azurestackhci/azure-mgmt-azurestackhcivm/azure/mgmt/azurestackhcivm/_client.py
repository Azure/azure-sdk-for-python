...
class AzureStackHCIVmClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype gallery_images: azure.mgmt.azurestackhcivm.operations.GalleryImagesOperations
    :ivar logical_networks: LogicalNetworksOperations operations
    :vartype logical_networks: azure.mgmt.azurestackhcivm.operations.LogicalNetworksOperations
    :ivar marketplace_gallery_images: MarketplaceGalleryImagesOperations operations
    :vartype marketplace_gallery_images:
     azure.mgmt.azurestackhcivm.operations.MarketplaceGalleryImagesOperations
    :ivar network_interfaces: NetworkInterfacesOperations operations
    :vartype network_interfaces: azure.mgmt.azurestackhcivm.operations.NetworkInterfacesOperations
    :ivar network_security_groups: NetworkSecurityGroupsOperations operations
    :vartype network_security_groups:
     azure.mgmt.azurestackhcivm.operations.NetworkSecurityGroupsOperations
    :ivar security_rules: SecurityRulesOperations operations
    :vartype security_rules: azure.mgmt.azurestackhcivm.operations.SecurityRulesOperations
    :ivar storage_containers: StorageContainersOperations operations
    :vartype storage_containers: azure.mgmt.azurestackhcivm.operations.StorageContainersOperations
    :ivar virtual_hard_disks: VirtualHardDisksOperations operations
    :vartype virtual_hard_disks: azure.mgmt.azurestackhcivm.operations.VirtualHardDisksOperations
    :ivar virtual_machine_instances: VirtualMachineInstancesOperations operations
    :vartype virtual_machine_instances:
     azure.mgmt.azurestackhcivm.operations.VirtualMachineInstancesOperations
    :ivar hybrid_identity_metadata: HybridIdentityMetadataOperations operations
    :vartype hybrid_identity_metadata:
     azure.mgmt.azurestackhcivm.operations.HybridIdentityMetadataOperations
    :ivar attestation_statuses: AttestationStatusesOperations operations
    :vartype attestation_statuses:
     azure.mgmt.azurestackhcivm.operations.AttestationStatusesOperations
    :ivar guest_agents: GuestAgentsOperations operations
    :vartype guest_agents: azure.mgmt.azurestackhcivm.operations.GuestAgentsOperations
