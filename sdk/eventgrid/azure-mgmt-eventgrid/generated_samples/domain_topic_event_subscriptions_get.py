...
# USAGE
    python domain_topic_event_subscriptions_get.py
...
# x-ms-original-file: specification/eventgrid/resource-manager/Microsoft.EventGrid/preview/2025-04-01-preview/examples/DomainTopicEventSubscriptions_Get.json
