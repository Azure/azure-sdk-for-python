...
class EventChannelProvisioningState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class ParentType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """ParentType."""
...
class PartnerRegistrationVisibilityState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class PartnerTopicReadinessState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
