...
class EventChannel(Resource):  # pylint: disable=too-many-instance-attributes
    """Event Channel.
    ...
    :ivar provisioning_state: Provisioning state of the event channel. Known values are:
    ...
    :ivar partner_topic_readiness_state: The readiness state of the corresponding partner topic.
     Known values are: "NotActivatedByUserYet", "ActivatedByUser", "DeactivatedByUser", and
     "DeletedByUser".
    ...
    def __init__(
        self,
        *,
        source: Optional["_models.EventChannelSource"] = None,
        destination: Optional["_models.EventChannelDestination"] = None,
        expiration_time_if_not_activated_utc: Optional[datetime.datetime] = None,
        filter: Optional["_models.EventChannelFilter"] = None,  # pylint: disable=redefined-builtin
...
class EventChannelDestination(_serialization.Model):
...
class EventChannelFilter(_serialization.Model):
    ...
    def __init__(
        self,
        *,
        enable_advanced_filtering_on_arrays: bool = False,
...
class EventChannelsListResult(_serialization.Model):
    ...
    def __init__(
        self, *, value: Optional[List["_models.EventChannel"]] = None, next_link: Optional[str] = None, **kwargs
    ):
        """
...
class EventChannelSource(_serialization.Model):
...
class PartnerDestination(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        *,
        ...
        expiration_time_if_not_activated_utc: Optional[datetime.datetime] = None,
        provisioning_state: Optional[Union[str, "_models.PartnerDestinationProvisioningState"]] = None,
        ...
        **kwargs
        ...
        :keyword expiration_time_if_not_activated_utc: Expiration time of the partner destination. If
         ...
         the partner destination and corresponding channel are deleted.
        :paramtype expiration_time_if_not_activated_utc: ~datetime.datetime
        :keyword provisioning_state: Provisioning state of the partner destination. Known values are:
         "Creating", "Updating", "Deleting", "Succeeded", "Canceled", and "Failed".
        :paramtype provisioning_state: str or
         ~azure.mgmt.eventgrid.models.PartnerDestinationProvisioningState
...
class PartnerDestinationsListResult(_serialization.Model):
    ...
    def __init__(
        self, *, value: Optional[List["_models.PartnerDestination"]] = None, next_link: Optional[str] = None, **kwargs
    ):
        """
...
class PartnerRegistration(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar visibility_state: Visibility state of the partner registration. Known values are:
     "Hidden", "PublicPreview", and "GenerallyAvailable".
    ...
    def __init__(
        ...
        *,
        ...
        visibility_state: Optional[Union[str, "_models.PartnerRegistrationVisibilityState"]] = None,
        ...
        **kwargs
        ...
        :keyword visibility_state: Visibility state of the partner registration. Known values are:
         "Hidden", "PublicPreview", and "GenerallyAvailable".
...
class ResourceSku(_serialization.Model):
    ...
    def __init__(self, *, name: Union[str, "_models.Sku"] = "Basic", **kwargs):
        """
