...
def build_get_request(
    resource_group_name: str, system_topic_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

    api_version: Literal["2022-06-15"] = kwargs.pop("api_version", _params.pop("api-version", "2022-06-15"))
...
def build_list_by_subscription_request(
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.EventGrid/systemTopics")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class SystemTopicsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, system_topic_name: str, **kwargs: Any) -> _models.SystemTopic:
        """Get a system topic.
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/systemTopics/{systemTopicName}"
    }
    ...
    def _create_or_update_initial(
        ...
        system_topic_info: Union[_models.SystemTopic, IO],
        **kwargs: Any
    ) -> _models.SystemTopic:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(system_topic_info, (IO, bytes)):
            _content = system_topic_info
        else:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param system_topic_name: Name of the system topic. Required.
        :type system_topic_name: str
        :param system_topic_info: System Topic information. Is either a model type or a IO type.
         Required.
        :type system_topic_info: ~azure.mgmt.eventgrid.models.SystemTopic or IO
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        system_topic_name: str,
        system_topic_update_parameters: Union[_models.SystemTopicUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.SystemTopic:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(system_topic_update_parameters, (IO, bytes)):
            _content = system_topic_update_parameters
        else:
    ...
    def begin_update(
        ...
        resource_group_name: str,
        system_topic_name: str,
        system_topic_update_parameters: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.SystemTopic]:
        ...
        :type system_topic_name: str
        :param system_topic_update_parameters: SystemTopic update information. Required.
        :type system_topic_update_parameters: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param system_topic_name: Name of the system topic. Required.
        :type system_topic_name: str
        :param system_topic_update_parameters: SystemTopic update information. Is either a model type
    ...
    def list_by_subscription(
        ...
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either SystemTopic or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.eventgrid.models.SystemTopic]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    list_by_subscription.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.EventGrid/systemTopics"
    }
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/systemTopics"
    }
