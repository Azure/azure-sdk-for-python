...
class SystemTopicsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type system_topic_name: str
        :param system_topic_info: System Topic information. Required.
        :type system_topic_info: IO[bytes]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param system_topic_info: System Topic information. Is either a SystemTopic type or a IO[bytes]
         type. Required.
        :type system_topic_info: ~azure.mgmt.eventgrid.models.SystemTopic or IO[bytes]
        :return: An instance of LROPoller that returns either SystemTopic or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.eventgrid.models.SystemTopic]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.SystemTopic].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.SystemTopic](
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type system_topic_name: str
        :param system_topic_update_parameters: SystemTopic update information. Required.
        :type system_topic_update_parameters: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either SystemTopic or the result of
