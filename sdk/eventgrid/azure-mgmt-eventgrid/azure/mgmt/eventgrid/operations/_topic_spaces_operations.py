...
class TopicSpacesOperations:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/namespaces/{namespaceName}/topicSpaces/{topicSpaceName}"
    }
    ...
    def _create_or_update_initial(
        ...
        topic_space_info: Union[_models.TopicSpace, IO],
        **kwargs: Any
    ) -> _models.TopicSpace:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(topic_space_info, (IOBase, bytes)):
            ...
            _json = self._serialize.body(topic_space_info, "TopicSpace")
    ...
    def begin_create_or_update(
        ...
        namespace_name: str,
        topic_space_name: str,
        topic_space_info: _models.TopicSpace,
        *,
        ...
        **kwargs: Any
        ...
        :type topic_space_info: ~azure.mgmt.eventgrid.models.TopicSpace
        ...
        :return: An instance of LROPoller that returns either TopicSpace or the result of cls(response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param topic_space_name: The topic space name. Required.
        :type topic_space_name: str
        :param topic_space_info: Topic space information. Is either a TopicSpace type or a IO type.
         Required.
        :type topic_space_info: ~azure.mgmt.eventgrid.models.TopicSpace or IO
    ...
    def list_by_namespace(
        ...
        **kwargs: Any
        ...
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either TopicSpace or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.eventgrid.models.TopicSpace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("TopicSpacesListResult", pipeline_response)
    ...
    list_by_namespace.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/namespaces/{namespaceName}/topicSpaces"
    }
