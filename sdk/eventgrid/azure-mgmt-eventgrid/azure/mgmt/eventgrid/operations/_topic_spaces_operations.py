    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param topic_space_info: Topic space information. Is either a TopicSpace type or a IO[bytes]
         type. Required.
        :type topic_space_info: ~azure.mgmt.eventgrid.models.TopicSpace or IO[bytes]
        :return: An instance of LROPoller that returns either TopicSpace or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.eventgrid.models.TopicSpace]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if cont_token:
            return LROPoller[_models.TopicSpace].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.TopicSpace](
