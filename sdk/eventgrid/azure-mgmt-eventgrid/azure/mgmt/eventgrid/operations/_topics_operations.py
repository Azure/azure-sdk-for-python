...
def build_get_request(resource_group_name: str, topic_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
...
def build_create_or_update_request(
    resource_group_name: str, topic_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(resource_group_name: str, topic_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class TopicsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, topic_name: str, **kwargs: Any) -> _models.Topic:
        """Get a topic.
    ...
    def begin_create_or_update(
        ...
        if cont_token:
            return LROPoller[_models.Topic].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.Topic](
    ...
    def list_by_subscription(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.eventgrid.models.Topic]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_regenerate_key(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.TopicSharedAccessKeys].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.TopicSharedAccessKeys](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
