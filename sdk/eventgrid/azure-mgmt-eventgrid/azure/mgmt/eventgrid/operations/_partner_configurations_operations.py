...
def build_get_request(resource_group_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
...
def build_create_or_update_request(resource_group_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_request(resource_group_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_by_subscription_request(
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.EventGrid/partnerConfigurations"
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
def build_authorize_partner_request(resource_group_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_unauthorize_partner_request(resource_group_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PartnerConfigurationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`partner_configurations` attribute.
    """
    ...
    @distributed_trace
    def get(self, resource_group_name: str, **kwargs: Any) -> _models.PartnerConfiguration:
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(partner_configuration_info, (IO, bytes)):
            _content = partner_configuration_info
        else:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource_group_name: The name of the resource group within the user's subscription.
         Required.
        :type resource_group_name: str
        :param partner_configuration_info: Partner configuration information. Is either a model type or
         a IO type. Required.
    ...
    def _update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(partner_configuration_update_parameters, (IO, bytes)):
            _content = partner_configuration_update_parameters
        else:
    ...
    def list_by_resource_group(
        self, resource_group_name: str, **kwargs: Any
    ) -> Iterable["_models.PartnerConfiguration"]:
        ...
        :return: An iterator like instance of either PartnerConfiguration or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.eventgrid.models.PartnerConfiguration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def authorize_partner(
        ...
        :param resource_group_name: The name of the resource group within the user's subscription.
         Required.
        :type resource_group_name: str
        :param partner_info: The information of the partner to be authorized. Is either a model type or
         a IO type. Required.
        ...
        _json = None
        _content = None
        if isinstance(partner_info, (IO, bytes)):
            _content = partner_info
        else:
    ...
    def unauthorize_partner(
        ...
        :param resource_group_name: The name of the resource group within the user's subscription.
         Required.
        :type resource_group_name: str
        :param partner_info: The information of the partner to be unauthorized. Is either a model type
