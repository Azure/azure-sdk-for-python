...
class PartnerConfigurationsOperations:
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(partner_configuration_info, (IOBase, bytes)):
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.PartnerConfiguration].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.PartnerConfiguration](
    ...
    def _update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(partner_configuration_update_parameters, (IOBase, bytes)):
    ...
    ) -> ItemPaged["_models.PartnerConfiguration"]:
    ...
    def authorize_partner(
        ...
        _json = None
        _content = None
        if isinstance(partner_info, (IOBase, bytes)):
