...
def build_get_request(
    resource_group_name: str, partner_topic_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class PartnerTopicsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, partner_topic_name: str, **kwargs: Any) -> _models.PartnerTopic:
        """Get a partner topic.
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param partner_topic_name: Name of the partner topic. Required.
        :type partner_topic_name: str
        :param partner_topic_info: Partner Topic information. Is either a model type or a IO type.
         Required.
        ...
        _json = None
        _content = None
        if isinstance(partner_topic_info, (IO, bytes)):
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :param partner_topic_name: Name of the partner topic. Required.
        :type partner_topic_name: str
        :param partner_topic_update_parameters: PartnerTopic update information. Is either a model type
        ...
        _json = None
        _content = None
        if isinstance(partner_topic_update_parameters, (IO, bytes)):
