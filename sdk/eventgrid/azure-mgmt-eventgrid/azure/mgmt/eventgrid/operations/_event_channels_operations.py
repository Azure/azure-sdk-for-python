...
def build_get_request(
    resource_group_name: str, partner_namespace_name: str, event_channel_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class EventChannelsOperations:
    ...
    def list_by_partner_namespace(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.eventgrid.models.EventChannel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
