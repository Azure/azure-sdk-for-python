    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param client_group_info: Client group information. Is either a ClientGroup type or a IO[bytes]
         type. Required.
        :type client_group_info: ~azure.mgmt.eventgrid.models.ClientGroup or IO[bytes]
        :return: An instance of LROPoller that returns either ClientGroup or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.eventgrid.models.ClientGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.ClientGroup].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ClientGroup](
