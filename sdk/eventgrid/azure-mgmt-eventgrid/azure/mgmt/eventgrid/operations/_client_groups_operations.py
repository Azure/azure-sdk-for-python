...
class ClientGroupsOperations:
    ...
    def get(
        ...
        :return: ClientGroup or the result of cls(response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/namespaces/{namespaceName}/clientGroups/{clientGroupName}"
    }
    ...
    def _create_or_update_initial(
        ...
        client_group_info: Union[_models.ClientGroup, IO],
        **kwargs: Any
    ) -> _models.ClientGroup:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(client_group_info, (IOBase, bytes)):
            ...
            _json = self._serialize.body(client_group_info, "ClientGroup")
    ...
    def begin_create_or_update(
        ...
        namespace_name: str,
        client_group_name: str,
        client_group_info: _models.ClientGroup,
        *,
        ...
        **kwargs: Any
        ...
        :type client_group_info: ~azure.mgmt.eventgrid.models.ClientGroup
        ...
        :return: An instance of LROPoller that returns either ClientGroup or the result of
         cls(response)
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param client_group_name: The client group name. Required.
        :type client_group_name: str
        :param client_group_info: Client group information. Is either a ClientGroup type or a IO type.
         Required.
        :type client_group_info: ~azure.mgmt.eventgrid.models.ClientGroup or IO
    ...
    def list_by_namespace(
        ...
        **kwargs: Any
        ...
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ClientGroup or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.eventgrid.models.ClientGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ClientGroupsListResult", pipeline_response)
    ...
    list_by_namespace.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/namespaces/{namespaceName}/clientGroups"
    }
