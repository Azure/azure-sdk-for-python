...
class NamespacesOperations:
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/namespaces/{namespaceName}"
    }

    async def _create_or_update_initial(
        self, resource_group_name: str, namespace_name: str, namespace_info: Union[_models.Namespace, IO], **kwargs: Any
    ) -> _models.Namespace:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_create_or_update(
        ...
        :param namespace_name: Name of the namespace. Required.
        :type namespace_name: str
        :param namespace_info: Namespace information. Is either a Namespace type or a IO type.
         Required.
        :type namespace_info: ~azure.mgmt.eventgrid.models.Namespace or IO
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        namespace_name: str,
        namespace_update_parameters: Union[_models.NamespaceUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.Namespace:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        resource_group_name: str,
        namespace_name: str,
        namespace_update_parameters: IO,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models.Namespace]:
        ...
        :type namespace_name: str
        :param namespace_update_parameters: Namespace update information. Required.
        :type namespace_update_parameters: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type namespace_update_parameters: ~azure.mgmt.eventgrid.models.NamespaceUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_by_subscription.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.EventGrid/namespaces"}
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/namespaces"
    }
    ...
    list_shared_access_keys.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/namespaces/{namespaceName}/listKeys"
    }
    ...
    async def _regenerate_key_initial(
        ...
        resource_group_name: str,
        namespace_name: str,
        regenerate_key_request: Union[_models.NamespaceRegenerateKeyRequest, IO],
        **kwargs: Any
    ...
    _regenerate_key_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/namespaces/{namespaceName}/regenerateKey"
    }
    ...
    async def begin_regenerate_key(
        ...
        **kwargs: Any
        ...
        :param regenerate_key_request: Request body to regenerate key. Is either a
         NamespaceRegenerateKeyRequest type or a IO type. Required.
        :type regenerate_key_request: ~azure.mgmt.eventgrid.models.NamespaceRegenerateKeyRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
