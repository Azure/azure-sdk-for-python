...
class ClientsOperations:
    ...
    async def get(
        ...
        :return: Client or the result of cls(response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/namespaces/{namespaceName}/clients/{clientName}"
    }
    ...
    async def _create_or_update_initial(
        ...
        namespace_name: str,
        client_name: str,
        client_info: Union[_models.Client, IO],
        **kwargs: Any
    ) -> _models.Client:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _json = None
        _content = None
        if isinstance(client_info, (IOBase, bytes)):
            _content = client_info
        else:
            _json = self._serialize.body(client_info, "Client")
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param namespace_name: Name of the namespace. Required.
        :type namespace_name: str
        :param client_name: The client name. Required.
        :type client_name: str
        :param client_info: Client information. Required.
        :type client_info: ~azure.mgmt.eventgrid.models.Client
        ...
        :return: An instance of AsyncLROPoller that returns either Client or the result of
         cls(response)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param client_name: The client name. Required.
        :type client_name: str
        :param client_info: Client information. Is either a Client type or a IO type. Required.
        :type client_info: ~azure.mgmt.eventgrid.models.Client or IO
    ...
    def list_by_namespace(
        ...
        **kwargs: Any
        ...
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either Client or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.eventgrid.models.Client]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("ClientsListResult", pipeline_response)
    ...
    list_by_namespace.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/namespaces/{namespaceName}/clients"
    }
