...
class ClientsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type client_info: ~azure.mgmt.eventgrid.models.Client or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Client or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.eventgrid.models.Client]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return AsyncLROPoller[_models.Client].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.Client](
