...
class TopicTypesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.TopicTypeInfo"]:
        """List topic types.
    ...
    @distributed_trace
    def list_event_types(self, topic_type_name: str, **kwargs: Any) -> AsyncItemPaged["_models.EventType"]:
        """List event types.
