...
class PartnerNamespacesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either PartnerNamespace or the result of cls(response)
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.eventgrid.models.PartnerNamespacesListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
