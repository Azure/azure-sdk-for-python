...
from ...operations._event_subscriptions_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_full_url_request, build_get_request, build_list_by_domain_topic_request, build_list_by_resource_request, build_list_global_by_resource_group_for_topic_type_request, build_list_global_by_resource_group_request, build_list_global_by_subscription_for_topic_type_request, build_list_global_by_subscription_request, build_list_regional_by_resource_group_for_topic_type_request, build_list_regional_by_resource_group_request, build_list_regional_by_subscription_for_topic_type_request, build_list_regional_by_subscription_request, build_update_request_initial
T = TypeVar('T')
