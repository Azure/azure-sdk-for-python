...
class PartnerRegistrationsOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(partner_registration_info, (IOBase, bytes)):
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(partner_registration_update_parameters, (IOBase, bytes)):
    ...
    ) -> AsyncItemPaged["_models.PartnerRegistration"]:
