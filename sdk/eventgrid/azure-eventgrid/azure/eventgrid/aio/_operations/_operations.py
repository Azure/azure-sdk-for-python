...
class EventGridPublisherClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], EventGridPublisherClientConfiguration]
):
...
class EventGridConsumerClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], EventGridConsumerClientConfiguration]
):
