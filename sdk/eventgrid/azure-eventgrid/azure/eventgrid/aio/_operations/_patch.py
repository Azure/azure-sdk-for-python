...
class EventGridClientOperationsMixin(OperationsMixin):
    ...
    async def publish_cloud_events(self, topic_name: str, body: Union[List[CloudEvent], CloudEvent], **kwargs) -> PublishResult:
        ...
        if isinstance(body, CloudEvent):
            ...
            publish_result = await self._publish_cloud_event(topic_name, internal_body, **kwargs)
        else:
            ...
            publish_result = await self._publish_cloud_events(topic_name, internal_body_list, **kwargs)
