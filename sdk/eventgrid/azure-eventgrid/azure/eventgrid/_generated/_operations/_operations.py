...
def build_event_grid_publisher_publish_cloud_event_events_request(  # pylint: disable=name-too-long
    *, json: List[_models.CloudEvent], aeg_channel_name: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    if aeg_channel_name is not None:
        _headers["aeg-channel-name"] = _SERIALIZER.header("aeg_channel_name", aeg_channel_name, "str")
    if content_type is not None:
        _headers["Content-Type"] = _SERIALIZER.header("content_type", content_type, "str")
...
def build_event_grid_publisher_publish_custom_event_events_request(  # pylint: disable=name-too-long
    **kwargs: Any,
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class EventGridPublisherClientOperationsMixin(EventGridPublisherClientMixinABC):
    ...
    def publish_event_grid_events(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_event_grid_publisher_publish_event_grid_events_request(
    ...
    def publish_cloud_event_events(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any,
        ...
        _request = build_event_grid_publisher_publish_cloud_event_events_request(
    ...
    def publish_custom_event_events(  # pylint: disable=inconsistent-return-statements
        ...
        _request = build_event_grid_publisher_publish_custom_event_events_request(
            content_type=content_type,
            api_version=self._config.api_version,
            json=_json,
            content=_content,
