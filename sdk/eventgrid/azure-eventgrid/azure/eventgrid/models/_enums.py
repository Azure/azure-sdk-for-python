...
class AcsCallEndedByKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class AcsCallParticipantKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class AcsChatRetentionPolicyKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class AcsChatThreadDeletedReasonType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class AcsRecordingChannelType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class AcsRecordingContentType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class AcsRecordingFormatType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class StorageBlobAccessTier(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class StorageLifecycleCompletionStatus(str, Enum, metaclass=CaseInsensitiveEnumMeta):
