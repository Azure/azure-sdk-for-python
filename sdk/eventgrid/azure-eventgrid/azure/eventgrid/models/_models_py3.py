...
class StorageDirectoryDeletedEventData(Model):
    ...
    def __init__(self, *, api: str=None, client_request_id: str=None, request_id: str=None, url: str=None, recursive: str=None, sequencer: str=None, identity: str=None, storage_diagnostics=None, **kwargs) -> None:
