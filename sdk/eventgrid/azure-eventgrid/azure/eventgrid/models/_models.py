...
class ACSChatMemberAddedToThreadWithUserEventData(ACSChatThreadEventBaseProperties):
    ...
    :type member: ~azure.eventgrid.models.ACSChatThreadMemberProperties
    """
    ...
    _attribute_map = {
        ...
        'member': {'key': 'member', 'type': 'ACSChatThreadMemberProperties'},
    }
...
class ACSChatMessageEventBaseProperties(ACSChatEventBaseProperties):
    ...
    :type message_id: str
    :param collapse_id: The collapse id is used to identify the message
     threads
    ...
    def __init__(self, **kwargs):
        ...
        self.collapse_id = kwargs.get('collapse_id', None)
...
class ACSChatThreadCreatedWithUserEventData(ACSChatThreadEventBaseProperties):
    ...
    def __init__(self, **kwargs):
        ...
        self.thread_type = kwargs.get('thread_type', None)
