...
class AcsChatRetentionPolicy(_Model):
    ...
    kind: Optional[Union[str, "_models.AcsChatRetentionPolicyKind"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """The chat retention policy kind. Known values are: \"none\" and \"threadCreationDate\"."""
    delete_thread_after_days: Optional[int] = rest_field(
        name="deleteThreadAfterDays", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        kind: Optional[Union[str, "_models.AcsChatRetentionPolicyKind"]] = None,
        delete_thread_after_days: Optional[int] = None,
    ) -> None: ...
...
class AcsChatThreadCreatedEventData(AcsChatThreadEventInThreadBaseProperties):
    ...
    :vartype retention_policy: ~azure.eventgrid.models.AcsChatRetentionPolicy
    """
    ...
    retention_policy: Optional["_models.AcsChatRetentionPolicy"] = rest_field(
    ...
    def __init__(
        ...
        *,
        ...
        transaction_id: Optional[str] = None,
        version: Optional[int] = None,
        retention_policy: Optional["_models.AcsChatRetentionPolicy"] = None,
    ) -> None: ...
...
class AcsChatThreadDeletedEventData(AcsChatThreadEventInThreadBaseProperties):
    ...
    reason: Optional[Union[str, "_models.AcsChatThreadDeletedReasonType"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        ...
        transaction_id: Optional[str] = None,
        version: Optional[int] = None,
        reason: Optional[Union[str, "_models.AcsChatThreadDeletedReasonType"]] = None,
    ) -> None: ...
...
class AcsEmailEngagementTrackingReportReceivedEventData(_Model):  # pylint: disable=name-too-long
    ...
    engagement: Union[str, "_models.AcsUserEngagement"] = rest_field(
        name="engagementType", visibility=["read", "create", "update", "delete", "query"]
    )
...
class AcsIncomingCallCustomContext(_Model):
    ...
    sip_headers: dict[str, str] = rest_field(name="sipHeaders", visibility=["read"])
    """Sip Headers for incoming call. Required."""
    voip_headers: dict[str, str] = rest_field(name="voipHeaders", visibility=["read"])
...
class AcsIncomingCallEventData(_Model):
    ...
    :vartype on_behalf_of: ~azure.eventgrid.models.CommunicationIdentifierModel
    :ivar correlation_id: CorrelationId (CallId).
    :vartype correlation_id: str
    """

    to_communication_identifier: "_models.CommunicationIdentifierModel" = rest_field(
        name="to", visibility=["read", "create", "update", "delete", "query"]
    )
    """The communication identifier of the target user. Required."""
    ...
    on_behalf_of: Optional["_models.CommunicationIdentifierModel"] = rest_field(
        name="onBehalfOf", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        ...
        on_behalf_of: Optional["_models.CommunicationIdentifierModel"] = None,
...
class AcsMessageContext(_Model):
    ...
    message_id: Optional[str] = rest_field(name="id", visibility=["read", "create", "update", "delete", "query"])
...
class AcsMessageDeliveryStatusUpdatedEventData(AcsMessageEventData):
    ...
    :vartype message_id: str
    :ivar to_bsu_id: Optional. The BSUID of the recipient.
    :vartype to_bsu_id: str
    ...
    message_id: Optional[str] = rest_field(name="messageId", visibility=["read", "create", "update", "delete", "query"])
    """The message id."""
    to_bsu_id: Optional[str] = rest_field(name="toBSUID", visibility=["read", "create", "update", "delete", "query"])
...
class AcsMessageInteractiveButtonReplyContent(_Model):
    ...
    button_id: Optional[str] = rest_field(name="id", visibility=["read", "create", "update", "delete", "query"])
...
class AcsMessageInteractiveListReplyContent(_Model):
    ...
    list_item_id: Optional[str] = rest_field(name="id", visibility=["read", "create", "update", "delete", "query"])
...
class AcsMessageMediaContent(_Model):
    ...
    media_id: str = rest_field(name="id", visibility=["read", "create", "update", "delete", "query"])
...
class AcsMessageReceivedEventData(AcsMessageEventData):
    ...
    :vartype message_id: str
    :ivar from_bsu_id: Optional. The BSUID of the sender.
    :vartype from_bsu_id: str
    ...
    from_bsu_id: Optional[str] = rest_field(
        name="fromBSUID", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    media_content: Optional["_models.AcsMessageMediaContent"] = rest_field(
        name="media", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    interactive_content: Optional["_models.AcsMessageInteractiveContent"] = rest_field(
        name="interactive", visibility=["read", "create", "update", "delete", "query"]
    )
...
class AcsRouterJobEventData(AcsRouterEventData):
    ...
    labels: dict[str, str] = rest_field(visibility=["read"])
    """Router Job events Labels. Required."""
    tags: dict[str, str] = rest_field(visibility=["read"])
...
class AcsRouterWorkerOfferAcceptedEventData(AcsRouterWorkerEventData):
    ...
    worker_labels: dict[str, str] = rest_field(name="workerLabels", visibility=["read"])
    """Router Worker Offer Accepted Worker Labels. Required."""
    worker_tags: dict[str, str] = rest_field(name="workerTags", visibility=["read"])
    """Router Worker Offer Accepted Worker Tags. Required."""
    job_labels: dict[str, str] = rest_field(name="jobLabels", visibility=["read"])
    """Router Worker Offer Accepted Job Labels. Required."""
    job_tags: dict[str, str] = rest_field(name="jobTags", visibility=["read"])
...
class AcsRouterWorkerSelector(_Model):
    ...
    label_value: Any = rest_field(name="value", visibility=["read", "create", "update", "delete", "query"])
...
class ApiManagementExpiredGatewayTokenProperties(_Model):  # pylint: disable=name-too-long
    ...
    expires_on: datetime.datetime = rest_field(
        name="expiredAtUtc", visibility=["read", "create", "update", "delete", "query"], format="rfc3339"
    )
...
class ApiManagementGatewayTokenExpiredEventData(_Model):  # pylint: disable=name-too-long
    ...
    gateway: "_models.ApiManagementGatewayProperties" = rest_field(
        name="gatewayInfo", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    token: "_models.ApiManagementExpiredGatewayTokenProperties" = rest_field(
        name="tokenInfo", visibility=["read", "create", "update", "delete", "query"]
    )
...
class AvsScriptExecutionFinishedEventData(AvsScriptExecutionEventData):
    ...
    named_outputs: dict[str, str] = rest_field(name="namedOutputs", visibility=["read"])
...
class DeviceTelemetryEventProperties(_Model):
    ...
    system_properties: dict[str, str] = rest_field(name="systemProperties", visibility=["read"])
...
class EventGridMQTTClientCreatedOrUpdatedEventData(EventGridMQTTClientEventData):  # pylint: disable=name-too-long
    ...
    """Time the client resource is last updated based on the provider's UTC time. If the client
     ...
     Required."""
    attributes: dict[str, str] = rest_field(visibility=["read"])
...
class HealthcareFhirResourceCreatedEventData(_Model):
    ...
    fhir_service_host_name: str = rest_field(
        name="resourceFhirAccount", visibility=["read", "create", "update", "delete", "query"]
    )
    """Domain name of FHIR account for this resource. Required."""
    fhir_resource_id: str = rest_field(
        name="resourceFhirId", visibility=["read", "create", "update", "delete", "query"]
    )
    """Id of HL7 FHIR resource. Required."""
    fhir_resource_version_id: int = rest_field(
        name="resourceVersionId", visibility=["read", "create", "update", "delete", "query"]
    )
...
class ResourceActionCancelEventData(_Model):
    ...
    claims: dict[str, str] = rest_field(visibility=["read"])
...
class ResourceAuthorization(_Model):
    ...
    evidence: dict[str, str] = rest_field(visibility=["read"])
...
class ResourceNotificationsResourceUpdatedEventData(_Model):  # pylint: disable=name-too-long
    ...
    resource_details: "_models.ResourceNotificationsResourceUpdatedDetails" = rest_field(
        name="resourceInfo", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    operational_details: "_models.ResourceNotificationsOperationalDetails" = rest_field(
        name="operationalInfo", visibility=["read", "create", "update", "delete", "query"]
    )
