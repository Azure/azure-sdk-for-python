...
def build_event_grid_publish_cloud_event_request(topic_name: str, **kwargs: Any) -> HttpRequest:
...
def build_event_grid_publish_cloud_events_request(topic_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_event_grid_receive_cloud_events_request(
    ...
    *,
    ...
    max_wait_time: Optional[datetime.timedelta] = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    if max_wait_time is not None:
        _params["maxWaitTime"] = _SERIALIZER.query("max_wait_time", max_wait_time, "duration")
...
class EventGridClientOperationsMixin(EventGridClientMixinABC):
    ...
    def publish_cloud_event(  # pylint: disable=inconsistent-return-statements
        self, topic_name: str, event: _models.CloudEvent, **kwargs: Any
    ) -> None:
    ...
    def publish_cloud_events(  # pylint: disable=inconsistent-return-statements
        self, topic_name: str, events: List[_models.CloudEvent], **kwargs: Any
    ) -> None:
    ...
    def receive_cloud_events(
        ...
        **kwargs: Any
        ...
        :paramtype max_wait_time: ~datetime.timedelta
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
         will have to context manage the returned stream.
    ...
    def reject_cloud_events(
        self, topic_name: str, event_subscription_name: str, lock_tokens: _models.RejectOptions, **kwargs: Any
