...
def build_event_grid_publisher_publish_cloud_events_request(  # pylint: disable=name-too-long
    *, channel_name: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
...
class EventGridPublisherClientOperationsMixin(EventGridPublisherClientMixinABC):
    ...
    @overload
    def _publish_event_grid_events(  # pylint: disable=inconsistent-return-statements
    ...
    @overload
    def _publish_custom_events(  # pylint: disable=inconsistent-return-statements
