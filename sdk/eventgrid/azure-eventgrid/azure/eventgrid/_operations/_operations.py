...
class EventGridPublisherClientOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], EventGridPublisherClientConfiguration]
):
...
class EventGridConsumerClientOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], EventGridConsumerClientConfiguration]
):
