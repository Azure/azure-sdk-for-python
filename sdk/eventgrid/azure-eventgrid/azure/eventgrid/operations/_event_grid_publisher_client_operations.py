...
class EventGridPublisherClientOperationsMixin(object):
    ...
    def _publish_event_grid_events(
        self,
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._publish_event_grid_events.metadata['url']  # type: ignore
    ...
    _publish_event_grid_events.metadata = {'url': '/api/events'}  # type: ignore

    def _publish_cloud_event_events(
        self,
        topic_hostname,  # type: str
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self._publish_cloud_event_events.metadata['url']  # type: ignore
        path_format_arguments = {
            'topicHostname': self._serialize.url("topic_hostname", topic_hostname, 'str', skip_quote=True),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    _publish_cloud_event_events.metadata = {'url': '/api/events'}  # type: ignore

    def create_batch(self, **kwargs):
        # type:(Any) -> models.EventBatch
    ...
    def publish_event_batch(self, event_batch, **kwargs):
        # type: (Union[models.EventBatch, List[models.EventData]], Any) -> None
