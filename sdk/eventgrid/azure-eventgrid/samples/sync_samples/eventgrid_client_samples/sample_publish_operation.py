...
try:
    ...
    client.send(topic_name=TOPIC_NAME, body=cloud_event_dict)
except HttpResponseError:
    raise

# Publish a list of CloudEvents as dict
try:
    client.send(topic_name=TOPIC_NAME, body=[cloud_event_dict, cloud_event_dict])
except HttpResponseError:
    raise
...
try:
    ...
    client.send(topic_name=TOPIC_NAME, body=cloud_event)
except HttpResponseError:
    raise
