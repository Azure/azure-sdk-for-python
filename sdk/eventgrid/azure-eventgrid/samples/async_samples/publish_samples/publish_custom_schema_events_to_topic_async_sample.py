...
# --------------------------------------------------------------------------
"""
FILE: publish_custom_schema_events_to_topic_async_sample.py
DESCRIPTION:
    These samples demonstrate creating a list of Custom Events and sending them as a list asynchronously.
USAGE:
    python publish_custom_schema_events_to_topic_async_sample.py
