...
async def run():
    async with client:
        ...
        try:
            ...
            await clientpublish(topic_name=TOPIC_NAME, body=cloud_event_dict, binary_mode=True)
            ...
            await clientpublish(topic_name=TOPIC_NAME, body=cloud_event, binary_mode=True)
