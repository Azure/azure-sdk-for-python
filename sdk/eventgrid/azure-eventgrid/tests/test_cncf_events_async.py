...
class TestEventGridPublisherClientCncf(AzureRecordedTestCase):
    ...
    @pytest.mark.asyncio
    async def test_send_cncf_data_dict_async(self, variables, eventgrid_cloud_event_topic_endpoint):
    ...
    @recorded_by_proxy_async
    @pytest.mark.asyncio
    async def test_send_cncf_data_base64_using_data_async(self, variables, eventgrid_cloud_event_topic_endpoint):
        client = self.create_eg_publisher_client(eventgrid_cloud_event_topic_endpoint)
        attributes = {
            "type": "com.example.sampletype1",
            "source": "https://example.com/event-producer",
    ...
    @recorded_by_proxy_async
    @pytest.mark.asyncio
    async def test_send_cncf_data_none_async(self, variables, eventgrid_cloud_event_topic_endpoint):
        client = self.create_eg_publisher_client(eventgrid_cloud_event_topic_endpoint)
        attributes = {
            "type": "com.example.sampletype1",
            "source": "https://example.com/event-producer",
    ...
    @recorded_by_proxy_async
    @pytest.mark.asyncio
    async def test_send_cncf_data_str_async(self, variables, eventgrid_cloud_event_topic_endpoint):
        client = self.create_eg_publisher_client(eventgrid_cloud_event_topic_endpoint)
        attributes = {
            "type": "com.example.sampletype1",
            "source": "https://example.com/event-producer",
    ...
    @recorded_by_proxy_async
    @pytest.mark.asyncio
    async def test_send_cncf_data_as_list_async(self, variables, eventgrid_cloud_event_topic_endpoint):
        client = self.create_eg_publisher_client(eventgrid_cloud_event_topic_endpoint)
        attributes = {
            "type": "com.example.sampletype1",
            "source": "https://example.com/event-producer",
    ...
    @recorded_by_proxy_async
    @pytest.mark.asyncio
    async def test_send_cncf_data_with_extensions_async(self, variables, eventgrid_cloud_event_topic_endpoint):
        client = self.create_eg_publisher_client(eventgrid_cloud_event_topic_endpoint)
        attributes = {
            "type": "com.example.sampletype1",
            "source": "https://example.com/event-producer",
