...
class TestEventGridPublisherClientCncf(AzureRecordedTestCase):
    ...
    @EventGridPreparer()
    @recorded_by_proxy
    def test_send_cncf_data_dict(self, variables, eventgrid_cloud_event_topic_endpoint):
    ...
    @EventGridPreparer()
    @recorded_by_proxy
    def test_send_cncf_data_base64_using_data(self, variables, eventgrid_cloud_event_topic_endpoint):
        client = self.create_eg_publisher_client(eventgrid_cloud_event_topic_endpoint)
        attributes = {
            "type": "com.example.sampletype1",
            "source": "https://example.com/event-producer",
    ...
    @EventGridPreparer()
    @recorded_by_proxy
    def test_send_cncf_data_none(self, variables, eventgrid_cloud_event_topic_endpoint):
        client = self.create_eg_publisher_client(eventgrid_cloud_event_topic_endpoint)
        attributes = {
            "type": "com.example.sampletype1",
            "source": "https://example.com/event-producer",
    ...
    @EventGridPreparer()
    @recorded_by_proxy
    def test_send_cncf_data_str(self, variables, eventgrid_cloud_event_topic_endpoint):
        client = self.create_eg_publisher_client(eventgrid_cloud_event_topic_endpoint)
        attributes = {
            "type": "com.example.sampletype1",
            "source": "https://example.com/event-producer",
    ...
    @EventGridPreparer()
    @recorded_by_proxy
    def test_send_cncf_data_as_list(self, variables, eventgrid_cloud_event_topic_endpoint):
        client = self.create_eg_publisher_client(eventgrid_cloud_event_topic_endpoint)
        attributes = {
            "type": "com.example.sampletype1",
            "source": "https://example.com/event-producer",
    ...
    @EventGridPreparer()
    @recorded_by_proxy
    def test_send_cncf_data_with_extensions(self, variables, eventgrid_cloud_event_topic_endpoint):
        client = self.create_eg_publisher_client(eventgrid_cloud_event_topic_endpoint)
        attributes = {
            "type": "com.example.sampletype1",
            "source": "https://example.com/event-producer",
