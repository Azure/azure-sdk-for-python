...
class TestEventGridPublisherClientExceptionsAsync(AzureRecordedTestCase):
    ...
    @pytest.mark.asyncio
    async def test_raise_on_auth_error_async(self, variables, eventgrid_topic_endpoint):
    ...
    @recorded_by_proxy_async
    @pytest.mark.asyncio
    async def test_raise_on_bad_resource_async(self, variables, eventgrid_topic_key):
    ...
    @recorded_by_proxy_async
    @pytest.mark.asyncio
    async def test_raise_on_large_payload_async(self, variables, eventgrid_topic_endpoint):
