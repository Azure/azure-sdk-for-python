...
class AcknowledgeResult(_model_base.Model):
    ...
    :vartype failed_lock_tokens: list[~azure.eventgrid.http.models.FailedLockToken]
...
class Error(_model_base.Model):
    ...
    :vartype details: list[~azure.eventgrid.http.models.Error]
    :ivar innererror: An object containing more specific information than the current object about
     the error.
    :vartype innererror: ~azure.eventgrid.http.models.InnerError
    """
...
class FailedLockToken(_model_base.Model):
    ...
    :ivar error: Error information of the failed operation result for the lock token in the
     request. Required.
    :vartype error: ~azure.eventgrid.http.models.Error
    """
...
class ReceiveDetails(_model_base.Model):
    ...
    :vartype broker_properties: ~azure.eventgrid.http.models.BrokerProperties
    :ivar event: Cloud Event details. Required.
    :vartype event: ~azure.eventgrid.http.models.CloudEvent
    """
...
class ReceiveResult(_model_base.Model):
    ...
    :vartype value: list[~azure.eventgrid.http.models.ReceiveDetails]
    """
