...
class EventGridClientOperationsMixin(EventGridClientMixinABC):
    ...
    async def _publish_cloud_event(  # pylint: disable=protected-access
        ...
        :type event: ~azure.eventgrid.http.models.CloudEvent
        :return: PublishResult. The PublishResult is compatible with MutableMapping
        :rtype: ~azure.eventgrid.http.models.PublishResult
    ...
    async def _publish_cloud_events(  # pylint: disable=protected-access
        ...
        :type events: list[~azure.eventgrid.http.models.CloudEvent]
        :return: PublishResult. The PublishResult is compatible with MutableMapping
        :rtype: ~azure.eventgrid.http.models.PublishResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _receive_cloud_events(  # pylint: disable=protected-access
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.eventgrid.http.models.ReceiveResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def acknowledge_cloud_events(
        ...
        **kwargs: Any
        ...
        :type acknowledge_options: ~azure.eventgrid.http.models.AcknowledgeOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: AcknowledgeResult. The AcknowledgeResult is compatible with MutableMapping
        :rtype: ~azure.eventgrid.http.models.AcknowledgeResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def acknowledge_cloud_events(
        ...
        **kwargs: Any
        ...
        :type acknowledge_options: ~azure.eventgrid.http.models.AcknowledgeOptions or JSON or IO[bytes]
        :return: AcknowledgeResult. The AcknowledgeResult is compatible with MutableMapping
        :rtype: ~azure.eventgrid.http.models.AcknowledgeResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def release_cloud_events(
        ...
        **kwargs: Any
        ...
        :type release_options: ~azure.eventgrid.http.models.ReleaseOptions
        ...
        :paramtype release_delay_in_seconds: int or ~azure.eventgrid.http.models.ReleaseDelay
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ReleaseResult. The ReleaseResult is compatible with MutableMapping
        :rtype: ~azure.eventgrid.http.models.ReleaseResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def release_cloud_events(
        ...
        **kwargs: Any
        ...
        :param release_options: ReleaseOptions. Is one of the following types: ReleaseOptions, JSON,
         IO[bytes] Required.
        :type release_options: ~azure.eventgrid.http.models.ReleaseOptions or JSON or IO[bytes]
        :keyword release_delay_in_seconds: Release cloud events with the specified delay in seconds.
         Known values are: 0, 10, 60, 600, and 3600. Default value is None.
        :paramtype release_delay_in_seconds: int or ~azure.eventgrid.http.models.ReleaseDelay
        :return: ReleaseResult. The ReleaseResult is compatible with MutableMapping
    ...
    async def reject_cloud_events(
        ...
        **kwargs: Any
        ...
        :type reject_options: ~azure.eventgrid.http.models.RejectOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: RejectResult. The RejectResult is compatible with MutableMapping
        :rtype: ~azure.eventgrid.http.models.RejectResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def reject_cloud_events(
        ...
        **kwargs: Any
        ...
        :param reject_options: RejectOptions. Is one of the following types: RejectOptions, JSON,
         IO[bytes] Required.
        :type reject_options: ~azure.eventgrid.http.models.RejectOptions or JSON or IO[bytes]
        :return: RejectResult. The RejectResult is compatible with MutableMapping
        :rtype: ~azure.eventgrid.http.models.RejectResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def renew_cloud_event_locks(
        ...
        **kwargs: Any
        ...
        :type renew_lock_options: ~azure.eventgrid.http.models.RenewLockOptions
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: RenewCloudEventLocksResult. The RenewCloudEventLocksResult is compatible with
         MutableMapping
        :rtype: ~azure.eventgrid.http.models.RenewCloudEventLocksResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def renew_cloud_event_locks(
        ...
        **kwargs: Any
        ...
        :type renew_lock_options: ~azure.eventgrid.http.models.RenewLockOptions or JSON or IO[bytes]
        :return: RenewCloudEventLocksResult. The RenewCloudEventLocksResult is compatible with
         MutableMapping
        :rtype: ~azure.eventgrid.http.models.RenewCloudEventLocksResult
        :raises ~azure.core.exceptions.HttpResponseError:
