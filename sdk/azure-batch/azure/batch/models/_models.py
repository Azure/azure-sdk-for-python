...
class AccountListSupportedImagesResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.batch.models.ImageInformation]
...
class ApplicationListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.batch.models.ApplicationSummary]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class CertificateListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.batch.models.Certificate]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class CloudJob(msrest.serialization.Model):
    ...
    :type common_environment_settings: list[~azure.batch.models.EnvironmentSetting]
...
class CloudJobListPreparationAndReleaseTaskStatusResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.batch.models.JobPreparationAndReleaseTaskExecutionInformation]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class CloudJobListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.batch.models.CloudJob]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class CloudJobScheduleListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.batch.models.CloudJobSchedule]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class CloudPool(msrest.serialization.Model):
    ...
    :type cloud_service_configuration: ~azure.batch.models.CloudServiceConfiguration
    :param virtual_machine_configuration: This property and cloudServiceConfiguration are mutually
     exclusive and one of the properties must be specified.
    :type virtual_machine_configuration: ~azure.batch.models.VirtualMachineConfiguration
    ...
    :type certificate_references: list[~azure.batch.models.CertificateReference]
    ...
    :type application_package_references: list[~azure.batch.models.ApplicationPackageReference]
    ...
    :param max_tasks_per_node: The default value is 1. The maximum value is the smaller of 4 times
...
class CloudPoolListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.batch.models.CloudPool]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class CloudTask(msrest.serialization.Model):
    ...
    :param authentication_token_settings: If this property is set, the Batch service provides the
     ...
     Job.
    :type authentication_token_settings: ~azure.batch.models.AuthenticationTokenSettings
    """
...
class CloudTaskListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.batch.models.CloudTask]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class ComputeNode(msrest.serialization.Model):
    ...
    :type endpoint_configuration: ~azure.batch.models.ComputeNodeEndpointConfiguration
...
class ComputeNodeListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.batch.models.ComputeNode]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class ImageInformation(msrest.serialization.Model):
    ...
    :param image_reference: Required. A reference to an Azure Virtual Machines Marketplace Image or
     a custom Azure Virtual Machine Image. To get the list of all Azure Marketplace Image references
...
class ImageReference(msrest.serialization.Model):
    ...
    :param virtual_machine_image_id: This property is mutually exclusive with other ImageReference
     properties. For Virtual Machine Image it must be in the same region and subscription as the
     Azure Batch account. The Shared Image Gallery Image must have replicas in the same region as
     the Azure Batch account. For information about the firewall settings for the Batch Compute Node
     agent to communicate with the Batch service see https://docs.microsoft.com/en-
     us/azure/batch/batch-api-basics#virtual-network-vnet-and-firewall-configuration.
...
class InboundNATPool(msrest.serialization.Model):
    ...
    :param network_security_group_rules: The maximum number of rules that can be specified across
     ...
     code 400.
    :type network_security_group_rules: list[~azure.batch.models.NetworkSecurityGroupRule]
    """
...
class JobPreparationAndReleaseTaskExecutionInformation(msrest.serialization.Model):
    ...
    :type job_release_task_execution_info: ~azure.batch.models.JobReleaseTaskExecutionInformation
    """
...
class JobPreparationTaskExecutionInformation(msrest.serialization.Model):
    ...
    :type container_info: ~azure.batch.models.TaskContainerExecutionInformation
...
class MountConfiguration(msrest.serialization.Model):
    ...
    :param azure_file_share_configuration: This property is mutually exclusive with all other
     properties.
    :type azure_file_share_configuration: ~azure.batch.models.AzureFileShareConfiguration
    """
...
class NetworkConfiguration(msrest.serialization.Model):
    ...
    :param dynamic_v_net_assignment_scope: The scope of dynamic vnet assignment. Possible values
     include: "none", "job".
    :type dynamic_v_net_assignment_scope: str or ~azure.batch.models.DynamicVNetAssignmentScope
    :param endpoint_configuration: Pool endpoint configuration is only supported on Pools with the
     virtualMachineConfiguration property.
    :type endpoint_configuration: ~azure.batch.models.PoolEndpointConfiguration
    ...
    :type public_ip_address_configuration: ~azure.batch.models.PublicIPAddressConfiguration
    """
...
class NodeFileListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.batch.models.NodeFile]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class NodeRebootParameter(msrest.serialization.Model):
    ...
    :type node_reboot_option: str or ~azure.batch.models.ComputeNodeRebootOption
    """
...
class NodeReimageParameter(msrest.serialization.Model):
    ...
    :param node_reimage_option: The default value is requeue. Possible values include: "requeue",
     "terminate", "taskcompletion", "retaineddata".
    :type node_reimage_option: str or ~azure.batch.models.ComputeNodeReimageOption
    """
...
class NodeRemoveParameter(msrest.serialization.Model):
    ...
    :type node_deallocation_option: str or ~azure.batch.models.ComputeNodeDeallocationOption
    """
...
class OutputFileUploadOptions(msrest.serialization.Model):
    ...
    :type upload_condition: str or ~azure.batch.models.OutputFileUploadCondition
    """
...
class PoolListUsageMetricsResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.batch.models.PoolUsageMetrics]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class PoolNodeCountsListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.batch.models.PoolNodeCounts]
    :param odata_next_link: The URL to get the next set of results.
    :type odata_next_link: str
    """
...
class PublicIPAddressConfiguration(msrest.serialization.Model):
    ...
    :param ip_address_ids: The number of IPs specified here limits the maximum size of the Pool -
     50 dedicated nodes or 20 low-priority nodes can be allocated for each public IP. For example, a
     pool needing 150 dedicated VMs would need at least 3 public IPs specified. Each element of this
...
class TaskContainerSettings(msrest.serialization.Model):
    ...
    :type working_directory: str or ~azure.batch.models.ContainerWorkingDirectory
    """
...
class UserAccount(msrest.serialization.Model):
    ...
    :param windows_user_configuration: This property can only be specified if the user is on a
     ...
     options.
    :type windows_user_configuration: ~azure.batch.models.WindowsUserConfiguration
    """
...
class VirtualMachineConfiguration(msrest.serialization.Model):
    ...
    :type disk_encryption_configuration: ~azure.batch.models.DiskEncryptionConfiguration
    """
