...
class DependencyOfRelationship(ExtensionResource):
    ...
    :vartype properties: ~azure.mgmt.relationships.models.DependencyOfRelationshipProperties
    """

    properties: Optional["_models.DependencyOfRelationshipProperties"] = rest_field(
    ...
    def __init__(
        self,
        *,
        properties: Optional["_models.DependencyOfRelationshipProperties"] = None,
    ) -> None: ...
...
class ErrorDetail(_Model):
    ...
    :vartype details: list[~azure.mgmt.relationships.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.relationships.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_Model):
    ...
    :vartype error: ~azure.mgmt.relationships.models.ErrorDetail
    """
...
class Operation(_Model):
    ...
    :vartype display: ~azure.mgmt.relationships.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.relationships.models.Origin
    :ivar action_type: Extensible enum. Indicates the action type. "Internal" refers to actions
     that are for internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.relationships.models.ActionType
    """
...
class RelationshipMetadata(_Model):
    """Provides information about the relationship properties.

    :ivar source_type: The type of the relationship source resource. Required.
    :vartype source_type: str
    :ivar target_type: The type of the relationship target resource. Required.
    :vartype target_type: str
    """

    source_type: str = rest_field(name="sourceType", visibility=["read"])
    """The type of the relationship source resource. Required."""
    target_type: str = rest_field(name="targetType", visibility=["read"])
    """The type of the relationship target resource. Required."""


class RelationshipOriginInformation(_Model):
    """Provides information about the origin of a relationship.

    :ivar relationship_origin_type: Identifies the origin type of the relationship. Required. Known
     values are: "ServiceExplicitlyCreated", "SystemDiscoveredByRule", "UserExplicitlyCreated", and
     "UserDiscoveredByRule".
    :vartype relationship_origin_type: str or ~azure.mgmt.relationships.models.RelationshipOrigins
    :ivar discovery_engine: The name of the discovery engine that created the relationship.
    :vartype discovery_engine: str
    """

    relationship_origin_type: Union[str, "_models.RelationshipOrigins"] = rest_field(
        name="relationshipOriginType", visibility=["read"]
    )
    """Identifies the origin type of the relationship. Required. Known values are:
     ...
     \"UserDiscoveredByRule\"."""
    discovery_engine: Optional[str] = rest_field(name="discoveryEngine", visibility=["read"])
...
class SystemData(_Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.relationships.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or ~azure.mgmt.relationships.models.CreatedByType
