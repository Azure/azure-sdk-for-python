...
from ...operations._operations import (
    ...
    build_dependency_of_relationships_by_service_group_create_or_update_request,
    build_dependency_of_relationships_by_service_group_delete_request,
    build_dependency_of_relationships_by_service_group_get_request,
    build_dependency_of_relationships_by_service_group_list_request,
...
class Operations:  # pylint: disable=docstring-missing-param
    ...
    def list(self, **kwargs: Any) -> AsyncItemPaged["_models.Operation"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.relationships.models.Operation]
...
class DependencyOfRelationshipsOperations:  # pylint: disable=docstring-missing-param
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.relationships.models.DependencyOfRelationship]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.DependencyOfRelationship].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.DependencyOfRelationship](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    @distributed_trace_async
    async def get(self, resource_uri: str, name: str, **kwargs: Any) -> _models.DependencyOfRelationship:
    ...
    async def _delete_initial(self, resource_uri: str, name: str, **kwargs: Any) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace_async
    async def begin_delete(self, resource_uri: str, name: str, **kwargs: Any) -> AsyncLROPoller[None]:
...
class DependencyOfRelationshipsByServiceGroupOperations:  # pylint: disable=docstring-missing-param,name-too-long
    ...
    async def get(self, service_group_name: str, name: str, **kwargs: Any) -> _models.DependencyOfRelationship:
        """Get a DependencyOfRelationship.
    ...
    async def _delete_initial(self, service_group_name: str, name: str, **kwargs: Any) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    async def begin_delete(self, service_group_name: str, name: str, **kwargs: Any) -> AsyncLROPoller[None]:
        """Delete a DependencyOfRelationship.
    ...
    def list(self, service_group_name: str, **kwargs: Any) -> AsyncItemPaged["_models.DependencyOfRelationship"]:
...
class ServiceGroupMemberRelationshipsOperations:  # pylint: disable=docstring-missing-param,name-too-long
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.relationships.models.ServiceGroupMemberRelationship]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.ServiceGroupMemberRelationship].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.ServiceGroupMemberRelationship](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    @distributed_trace_async
    async def get(self, resource_uri: str, name: str, **kwargs: Any) -> _models.ServiceGroupMemberRelationship:
