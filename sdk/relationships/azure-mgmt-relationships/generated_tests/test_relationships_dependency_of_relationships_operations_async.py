...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.relationships.aio import RelationshipsClient
...
class TestRelationshipsDependencyOfRelationshipsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(RelationshipsClient, is_async=True)
