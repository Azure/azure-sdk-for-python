...
namespace azure.mgmt.relationships.aio.operations
    ...
    class azure.mgmt.relationships.aio.operations.DependencyOfRelationshipsByServiceGroupOperations:
        ...
        @api_version_validation(method_added_on='2026-03-01-preview', params_added_on={'2026-03-01-preview': ['api_version', 'service_group_name', 'name']}, api_versions_list=['2026-03-01-preview'])
        ...
        @distributed_trace_async
        @api_version_validation(method_added_on='2026-03-01-preview', params_added_on={'2026-03-01-preview': ['api_version', 'service_group_name', 'name', 'accept']}, api_versions_list=['2026-03-01-preview'])
        async def get(
                self, 
                service_group_name: str, 
                name: str, 
        ...
        @distributed_trace
        @api_version_validation(method_added_on='2026-03-01-preview', params_added_on={'2026-03-01-preview': ['api_version', 'service_group_name', 'accept']}, api_versions_list=['2026-03-01-preview'])
        def list(
                self, 
                service_group_name: str, 
                **kwargs: Any
