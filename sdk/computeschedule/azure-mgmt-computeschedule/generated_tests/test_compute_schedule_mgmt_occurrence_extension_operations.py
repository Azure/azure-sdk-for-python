...
class TestComputeScheduleMgmtOccurrenceExtensionOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(ComputeScheduleMgmtClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_occurrence_extension_list_occurrence_by_vms(self, resource_group):
