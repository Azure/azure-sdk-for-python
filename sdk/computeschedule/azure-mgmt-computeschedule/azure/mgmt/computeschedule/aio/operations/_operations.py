...
class ScheduledActionsOperations:  # pylint: disable=too-many-public-methods
    ...
    @api_version_validation(
        ...
        api_versions_list=["2025-05-01", "2025-04-15-preview", "2026-01-01-preview", "2026-03-01-preview"],
    )
    async def virtual_machines_execute_create(
    ...
    @api_version_validation(
        ...
        api_versions_list=["2025-04-15-preview", "2026-01-01-preview", "2026-03-01-preview"],
    )
