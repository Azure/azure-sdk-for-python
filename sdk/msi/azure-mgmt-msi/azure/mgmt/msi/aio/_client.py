...
class ManagedIdentityClient:
    ...
    :vartype operations: azure.mgmt.msi.aio.operations.Operations
    :ivar system_assigned_identities: SystemAssignedIdentitiesOperations operations
    :vartype system_assigned_identities:
     azure.mgmt.msi.aio.operations.SystemAssignedIdentitiesOperations
    ...
    :vartype federated_identity_credentials:
     azure.mgmt.msi.aio.operations.FederatedIdentityCredentialsOperations
    :ivar user_assigned_identities: UserAssignedIdentitiesOperations operations
    :vartype user_assigned_identities:
     azure.mgmt.msi.aio.operations.UserAssignedIdentitiesOperations
    ...
    :keyword api_version: The API version to use for this operation. Known values are
     "2025-05-31-preview". Default value is "2025-05-31-preview". Note that overriding this default
