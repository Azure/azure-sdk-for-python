...
class TestManagedIdentityUserAssignedIdentitiesOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(ManagedIdentityClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_user_assigned_identities_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_user_assigned_identities_create_or_update(self, resource_group):
        response = self.client.user_assigned_identities.create_or_update(
            resource_group_name=resource_group.name,
            resource_name="str",
            parameters={
                "location": "str",
                ...
                "name": "str",
                "properties": {
                    "assignmentRestrictions": {"providers": ["str"]},
                    "clientId": "str",
                    "isolationScope": "str",
                    "principalId": "str",
                    "tenantId": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_user_assigned_identities_update(self, resource_group):
        response = self.client.user_assigned_identities.update(
            resource_group_name=resource_group.name,
            resource_name="str",
            parameters={
                "id": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_user_assigned_identities_delete(self, resource_group):
