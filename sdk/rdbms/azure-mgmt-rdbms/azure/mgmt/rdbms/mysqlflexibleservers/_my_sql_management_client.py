...
class MySQLManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype servers: azure.mgmt.rdbms.mysqlflexibleservers.operations.ServersOperations
    :ivar replicas: ReplicasOperations operations
    :vartype replicas: azure.mgmt.rdbms.mysqlflexibleservers.operations.ReplicasOperations
    :ivar backups: BackupsOperations operations
    :vartype backups: azure.mgmt.rdbms.mysqlflexibleservers.operations.BackupsOperations
    :ivar firewall_rules: FirewallRulesOperations operations
    :vartype firewall_rules:
     azure.mgmt.rdbms.mysqlflexibleservers.operations.FirewallRulesOperations
    :ivar databases: DatabasesOperations operations
    :vartype databases: azure.mgmt.rdbms.mysqlflexibleservers.operations.DatabasesOperations
    :ivar configurations: ConfigurationsOperations operations
    :vartype configurations:
     azure.mgmt.rdbms.mysqlflexibleservers.operations.ConfigurationsOperations
    :ivar location_based_capabilities: LocationBasedCapabilitiesOperations operations
    :vartype location_based_capabilities:
     azure.mgmt.rdbms.mysqlflexibleservers.operations.LocationBasedCapabilitiesOperations
    ...
    :vartype check_virtual_network_subnet_usage:
     azure.mgmt.rdbms.mysqlflexibleservers.operations.CheckVirtualNetworkSubnetUsageOperations
    :ivar check_name_availability: CheckNameAvailabilityOperations operations
    :vartype check_name_availability:
     azure.mgmt.rdbms.mysqlflexibleservers.operations.CheckNameAvailabilityOperations
    ...
    :vartype check_name_availability_without_location:
     azure.mgmt.rdbms.mysqlflexibleservers.operations.CheckNameAvailabilityWithoutLocationOperations
    :ivar get_private_dns_zone_suffix: GetPrivateDnsZoneSuffixOperations operations
    :vartype get_private_dns_zone_suffix:
     azure.mgmt.rdbms.mysqlflexibleservers.operations.GetPrivateDnsZoneSuffixOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.rdbms.mysqlflexibleservers.operations.Operations
