...
class ConfigurationsOperations:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either Configuration or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.mysqlflexibleservers.models.Configuration]
    ...
    def begin_batch_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either ConfigurationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.mysqlflexibleservers.models.ConfigurationListResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_by_server(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.mysqlflexibleservers.models.Configuration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
