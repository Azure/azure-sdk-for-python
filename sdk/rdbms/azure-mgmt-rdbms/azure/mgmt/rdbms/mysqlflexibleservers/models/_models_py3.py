...
class Backup(_serialization.Model):
    ...
    :vartype geo_redundant_backup: str or
     ~azure.mgmt.rdbms.mysqlflexibleservers.models.EnableStatusEnum
...
class CapabilitiesListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.CapabilityProperties]
    ...
    def __init__(self, **kwargs: Any) -> None:
        """ """
        super().__init__(**kwargs)
        self.value: Optional[list["_models.CapabilityProperties"]] = None
...
class CapabilityProperties(_serialization.Model):
    ...
    :vartype supported_flexible_server_editions:
     list[~azure.mgmt.rdbms.mysqlflexibleservers.models.ServerEditionCapability]
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.supported_ha_mode: Optional[list[str]] = None
        self.supported_geo_backup_regions: Optional[list[str]] = None
        self.supported_flexible_server_editions: Optional[list["_models.ServerEditionCapability"]] = None
...
class Configuration(ProxyResource):
    ...
    :vartype system_data: ~azure.mgmt.rdbms.mysqlflexibleservers.models.SystemData
    ...
    :ivar source: Source of the configuration. Known values are: "system-default" and
     "user-override".
    :vartype source: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.ConfigurationSource
    :ivar is_read_only: If is the configuration read only. Known values are: "True" and "False".
    :vartype is_read_only: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.IsReadOnly
    ...
    :vartype is_config_pending_restart: str or
     ~azure.mgmt.rdbms.mysqlflexibleservers.models.IsConfigPendingRestart
    :ivar is_dynamic_config: If is the configuration dynamic. Known values are: "True" and "False".
    :vartype is_dynamic_config: str or
     ~azure.mgmt.rdbms.mysqlflexibleservers.models.IsDynamicConfig
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword source: Source of the configuration. Known values are: "system-default" and
         "user-override".
        :paramtype source: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.ConfigurationSource
        """
        super().__init__(**kwargs)
        ...
        self.source = source
        self.is_read_only: Optional[Union[str, "_models.IsReadOnly"]] = None
        self.is_config_pending_restart: Optional[Union[str, "_models.IsConfigPendingRestart"]] = None
        self.is_dynamic_config: Optional[Union[str, "_models.IsDynamicConfig"]] = None
...
class ConfigurationListForBatchUpdate(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.ConfigurationForBatchUpdate]
    """
    ...
    def __init__(self, *, value: Optional[list["_models.ConfigurationForBatchUpdate"]] = None, **kwargs: Any) -> None:
        """
        :keyword value: The list of server configurations.
        :paramtype value:
         list[~azure.mgmt.rdbms.mysqlflexibleservers.models.ConfigurationForBatchUpdate]
        """
        super().__init__(**kwargs)
        self.value = value
...
class ConfigurationListResult(_serialization.Model):
    ...
    :ivar value: The list of server configurations.
    :vartype value: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.Configuration]
    ...
    def __init__(
        ...
        """
        :keyword value: The list of server configurations.
        :paramtype value: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.Configuration]
...
class DatabaseListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.Database]
    :ivar next_link: The link used to get the next page of operations.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.Database]
        :keyword next_link: The link used to get the next page of operations.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class DataEncryption(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.DataEncryptionType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The key type, AzureKeyVault for enable cmk, SystemManaged for disable cmk. Known
         values are: "AzureKeyVault" and "SystemManaged".
        :paramtype type: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.DataEncryptionType
        """
        super().__init__(**kwargs)
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.ErrorResponse]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.rdbms.mysqlflexibleservers.models.ErrorAdditionalInfo]
    """
...
class FirewallRuleListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.FirewallRule]
    :ivar next_link: The link used to get the next page of operations.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.FirewallRule]
        :keyword next_link: The link used to get the next page of operations.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class HighAvailability(_serialization.Model):
    ...
    :ivar mode: High availability mode for a server. Known values are: "Disabled", "ZoneRedundant",
     and "SameZone".
    :vartype mode: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.HighAvailabilityMode
    ...
    :vartype state: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.HighAvailabilityState
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype mode: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.HighAvailabilityMode
...
class Network(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        super().__init__(**kwargs)
        self.public_network_access: Optional[Union[str, "_models.EnableStatusEnum"]] = None
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.rdbms.mysqlflexibleservers.models.OperationDisplay
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype display: ~azure.mgmt.rdbms.mysqlflexibleservers.models.OperationDisplay
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.Operation]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.Operation]
...
class Server(TrackedResource):
    ...
    :vartype identity: ~azure.mgmt.rdbms.mysqlflexibleservers.models.Identity
    :ivar sku: The SKU (pricing tier) of the server.
    :vartype sku: ~azure.mgmt.rdbms.mysqlflexibleservers.models.Sku
    :ivar system_data: The system metadata relating to this resource.
    :vartype system_data: ~azure.mgmt.rdbms.mysqlflexibleservers.models.SystemData
    ...
    :vartype version: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.ServerVersion
    ...
    :vartype create_mode: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.CreateMode
    ...
    :ivar replication_role: The replication role. Known values are: "None", "Source", and
     "Replica".
    :vartype replication_role: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.ReplicationRole
    ...
    :vartype data_encryption: ~azure.mgmt.rdbms.mysqlflexibleservers.models.DataEncryption
    :ivar state: The state of a server. Known values are: "Ready", "Dropping", "Disabled",
     "Starting", "Stopping", "Stopped", and "Updating".
    :vartype state: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.ServerState
    ...
    :vartype storage: ~azure.mgmt.rdbms.mysqlflexibleservers.models.Storage
    :ivar backup: Backup related properties of a server.
    :vartype backup: ~azure.mgmt.rdbms.mysqlflexibleservers.models.Backup
    :ivar high_availability: High availability related properties of a server.
    :vartype high_availability: ~azure.mgmt.rdbms.mysqlflexibleservers.models.HighAvailability
    :ivar network: Network related properties of a server.
    :vartype network: ~azure.mgmt.rdbms.mysqlflexibleservers.models.Network
    :ivar maintenance_window: Maintenance window of a server.
    :vartype maintenance_window: ~azure.mgmt.rdbms.mysqlflexibleservers.models.MaintenanceWindow
    """
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :paramtype identity: ~azure.mgmt.rdbms.mysqlflexibleservers.models.Identity
        :keyword sku: The SKU (pricing tier) of the server.
        :paramtype sku: ~azure.mgmt.rdbms.mysqlflexibleservers.models.Sku
        ...
        :paramtype version: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.ServerVersion
        ...
        :keyword create_mode: The mode to create a new MySQL server. Known values are: "Default",
         "PointInTimeRestore", "Replica", and "GeoRestore".
        :paramtype create_mode: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.CreateMode
        ...
        :paramtype replication_role: str or
         ~azure.mgmt.rdbms.mysqlflexibleservers.models.ReplicationRole
        :keyword data_encryption: The Data Encryption for CMK.
        :paramtype data_encryption: ~azure.mgmt.rdbms.mysqlflexibleservers.models.DataEncryption
        :keyword storage: Storage related properties of a server.
        :paramtype storage: ~azure.mgmt.rdbms.mysqlflexibleservers.models.Storage
        :keyword backup: Backup related properties of a server.
        :paramtype backup: ~azure.mgmt.rdbms.mysqlflexibleservers.models.Backup
        :keyword high_availability: High availability related properties of a server.
        :paramtype high_availability: ~azure.mgmt.rdbms.mysqlflexibleservers.models.HighAvailability
        :keyword network: Network related properties of a server.
        :paramtype network: ~azure.mgmt.rdbms.mysqlflexibleservers.models.Network
        :keyword maintenance_window: Maintenance window of a server.
        :paramtype maintenance_window: ~azure.mgmt.rdbms.mysqlflexibleservers.models.MaintenanceWindow
        """
...
class ServerBackupListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.ServerBackup]
    :ivar next_link: The link used to get the next page of operations.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.ServerBackup]
        :keyword next_link: The link used to get the next page of operations.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ServerEditionCapability(_serialization.Model):
    ...
    :vartype supported_storage_editions:
     list[~azure.mgmt.rdbms.mysqlflexibleservers.models.StorageEditionCapability]
    :ivar supported_server_versions: A list of supported server versions.
    :vartype supported_server_versions:
     list[~azure.mgmt.rdbms.mysqlflexibleservers.models.ServerVersionCapability]
    """
...
class ServerListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.Server]
    :ivar next_link: The link used to get the next page of operations.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.Server]
        :keyword next_link: The link used to get the next page of operations.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ServerVersionCapability(_serialization.Model):
    ...
    :vartype supported_skus: list[~azure.mgmt.rdbms.mysqlflexibleservers.models.SkuCapability]
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        super().__init__(**kwargs)
        self.name: Optional[str] = None
        self.supported_skus: Optional[list["_models.SkuCapability"]] = None
...
class Sku(_serialization.Model):
    ...
    :vartype tier: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.SkuTier
    """
    ...
    def __init__(self, *, name: str, tier: Union[str, "_models.SkuTier"], **kwargs: Any) -> None:
        ...
        :keyword tier: The tier of the particular SKU, e.g. GeneralPurpose. Required. Known values are:
         "Burstable", "GeneralPurpose", and "MemoryOptimized".
        :paramtype tier: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.SkuTier
        """
        super().__init__(**kwargs)
        self.name = name
        self.tier = tier
...
class SkuCapability(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.supported_memory_per_v_core_mb: Optional[int] = None
...
class Storage(_serialization.Model):
    ...
    :vartype auto_grow: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.EnableStatusEnum
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword auto_grow: Enable Storage Auto Grow or not. Known values are: "Enabled" and
         "Disabled".
        :paramtype auto_grow: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.EnableStatusEnum
        """
        super().__init__(**kwargs)
        self.storage_size_gb = storage_size_gb
        self.iops = iops
        self.auto_grow = auto_grow
        self.storage_sku: Optional[str] = None
...
class StorageEditionCapability(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        super().__init__(**kwargs)
        self.name: Optional[str] = None
        self.min_storage_size: Optional[int] = None
        self.max_storage_size: Optional[int] = None
        self.min_backup_retention_days: Optional[int] = None
        self.max_backup_retention_days: Optional[int] = None
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or
     ~azure.mgmt.rdbms.mysqlflexibleservers.models.CreatedByType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~azure.mgmt.rdbms.mysqlflexibleservers.models.CreatedByType
...
class VirtualNetworkSubnetUsageResult(_serialization.Model):
    ...
    :vartype delegated_subnets_usage:
     list[~azure.mgmt.rdbms.mysqlflexibleservers.models.DelegatedSubnetUsage]
    """
