...
from ...operations._location_based_capabilities_operations import build_list_request
...
class LocationBasedCapabilitiesOperations:
    ...
    def list(self, location_name: str, **kwargs: Any) -> AsyncItemPaged["_models.CapabilityProperties"]:
        ...
        :return: An iterator like instance of either CapabilityProperties or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.mysqlflexibleservers.models.CapabilityProperties]
