...
class CheckVirtualNetworkSubnetUsageOperations:
    ...
    async def execute(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.rdbms.mysqlflexibleservers.models.VirtualNetworkSubnetUsageParameter
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: VirtualNetworkSubnetUsageResult or the result of cls(response)
        :rtype: ~azure.mgmt.rdbms.mysqlflexibleservers.models.VirtualNetworkSubnetUsageResult
    ...
    async def execute(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.rdbms.mysqlflexibleservers.models.VirtualNetworkSubnetUsageParameter or IO[bytes]
        :return: VirtualNetworkSubnetUsageResult or the result of cls(response)
        :rtype: ~azure.mgmt.rdbms.mysqlflexibleservers.models.VirtualNetworkSubnetUsageResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
