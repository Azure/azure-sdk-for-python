...
class MySQLManagementClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype servers: azure.mgmt.rdbms.mysqlflexibleservers.aio.operations.ServersOperations
    :ivar replicas: ReplicasOperations operations
    :vartype replicas: azure.mgmt.rdbms.mysqlflexibleservers.aio.operations.ReplicasOperations
    :ivar backups: BackupsOperations operations
    :vartype backups: azure.mgmt.rdbms.mysqlflexibleservers.aio.operations.BackupsOperations
    :ivar firewall_rules: FirewallRulesOperations operations
    :vartype firewall_rules:
     azure.mgmt.rdbms.mysqlflexibleservers.aio.operations.FirewallRulesOperations
    :ivar databases: DatabasesOperations operations
    :vartype databases: azure.mgmt.rdbms.mysqlflexibleservers.aio.operations.DatabasesOperations
    :ivar configurations: ConfigurationsOperations operations
    :vartype configurations:
     azure.mgmt.rdbms.mysqlflexibleservers.aio.operations.ConfigurationsOperations
    :ivar location_based_capabilities: LocationBasedCapabilitiesOperations operations
    :vartype location_based_capabilities:
     azure.mgmt.rdbms.mysqlflexibleservers.aio.operations.LocationBasedCapabilitiesOperations
    ...
    :vartype check_virtual_network_subnet_usage:
     azure.mgmt.rdbms.mysqlflexibleservers.aio.operations.CheckVirtualNetworkSubnetUsageOperations
    :ivar check_name_availability: CheckNameAvailabilityOperations operations
    :vartype check_name_availability:
     azure.mgmt.rdbms.mysqlflexibleservers.aio.operations.CheckNameAvailabilityOperations
    ...
    :vartype check_name_availability_without_location:
     azure.mgmt.rdbms.mysqlflexibleservers.aio.operations.CheckNameAvailabilityWithoutLocationOperations
    :ivar get_private_dns_zone_suffix: GetPrivateDnsZoneSuffixOperations operations
    :vartype get_private_dns_zone_suffix:
     azure.mgmt.rdbms.mysqlflexibleservers.aio.operations.GetPrivateDnsZoneSuffixOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.rdbms.mysqlflexibleservers.aio.operations.Operations
