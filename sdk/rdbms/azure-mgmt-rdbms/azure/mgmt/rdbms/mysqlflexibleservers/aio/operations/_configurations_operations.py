...
class ConfigurationsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.rdbms.mysqlflexibleservers.aio.MySQLManagementClient`'s
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.mysqlflexibleservers.models.Configuration
        ...
        :return: An instance of AsyncLROPoller that returns either Configuration or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.rdbms.mysqlflexibleservers.models.Configuration]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.mysqlflexibleservers.models.Configuration or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Configuration or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.rdbms.mysqlflexibleservers.models.Configuration]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.rdbms.mysqlflexibleservers.models.Configuration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def _batch_update_initial(
        ...
        **kwargs: Any
        ...
        _request = build_batch_update_request(
            resource_group_name=resource_group_name,
            server_name=server_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    async def begin_batch_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.mysqlflexibleservers.models.ConfigurationListForBatchUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.rdbms.mysqlflexibleservers.models.ConfigurationListResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_batch_update(
        ...
        **kwargs: Any
        ...
        :param server_name: The name of the server. Required.
        :type server_name: str
        :param parameters: The parameters for updating a list of server configuration. Is either a
    ...
    def list_by_server(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.mysqlflexibleservers.models.Configuration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
