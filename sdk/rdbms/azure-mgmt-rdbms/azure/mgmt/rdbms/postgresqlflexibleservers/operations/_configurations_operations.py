...
class ConfigurationsOperations:
    ...
    def list_by_server(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Configuration]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Configuration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Configuration
        ...
        :return: An instance of LROPoller that returns either Configuration or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Configuration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Configuration or IO[bytes]
        :return: An instance of LROPoller that returns either Configuration or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Configuration]
