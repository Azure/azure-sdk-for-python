...
class VirtualNetworkSubnetUsageOperations:
    ...
    def execute(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.rdbms.postgresqlflexibleservers.models.VirtualNetworkSubnetUsageParameter
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: VirtualNetworkSubnetUsageResult or the result of cls(response)
        :rtype: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.VirtualNetworkSubnetUsageResult
    ...
    def execute(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.rdbms.postgresqlflexibleservers.models.VirtualNetworkSubnetUsageParameter or
         IO[bytes]
        :return: VirtualNetworkSubnetUsageResult or the result of cls(response)
        :rtype: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.VirtualNetworkSubnetUsageResult
        :raises ~azure.core.exceptions.HttpResponseError:
