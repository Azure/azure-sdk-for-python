...
class ServersOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Server
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Server or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Server]
    ...
    def begin_create(
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Server or IO[bytes]
        :return: An instance of LROPoller that returns either Server or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Server]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.ServerForUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Server or the result of cls(response)
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.ServerForUpdate or
         IO[bytes]
        :return: An instance of LROPoller that returns either Server or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Server]
    ...
    def get(self, resource_group_name: str, server_name: str, **kwargs: Any) -> _models.Server:
        ...
        :rtype: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Server
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.Server"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Server]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def begin_restart(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.RestartParameter
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either None or the result of cls(response)
    ...
    def begin_restart(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.RestartParameter or
         IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
