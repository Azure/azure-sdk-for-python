...
class DatabasesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.rdbms.postgresqlflexibleservers.PostgreSQLManagementClient`'s
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Database
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either Database or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Database]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Database or IO[bytes]
        :return: An instance of LROPoller that returns either Database or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Database]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def get(self, resource_group_name: str, server_name: str, database_name: str, **kwargs: Any) -> _models.Database:
        ...
        :rtype: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Database
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def list_by_server(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Database]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
