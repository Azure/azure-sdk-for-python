...
class Backup(_serialization.Model):
    ...
    :vartype geo_redundant_backup: str or
     ~azure.mgmt.rdbms.postgresqlflexibleservers.models.GeoRedundantBackupEnum
...
class CapabilitiesListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.CapabilityProperties]
...
class CapabilityProperties(_serialization.Model):
    ...
    :vartype supported_flexible_server_editions:
     list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.FlexibleServerEditionCapability]
    :ivar supported_hyperscale_node_editions:
    :vartype supported_hyperscale_node_editions:
     list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.HyperscaleNodeEditionCapability]
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.geo_backup_supported: Optional[bool] = None
        self.zone_redundant_ha_supported: Optional[bool] = None
        self.zone_redundant_ha_and_geo_backup_supported: Optional[bool] = None
        self.supported_flexible_server_editions: Optional[list["_models.FlexibleServerEditionCapability"]] = None
        self.supported_hyperscale_node_editions: Optional[list["_models.HyperscaleNodeEditionCapability"]] = None
...
class Configuration(ProxyResource):
    ...
    :vartype system_data: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.SystemData
    ...
    :vartype data_type: str or
     ~azure.mgmt.rdbms.postgresqlflexibleservers.models.ConfigurationDataType
...
class ConfigurationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Configuration]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Configuration]
...
class DatabaseListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Database]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Database]
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.ErrorResponse]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.ErrorAdditionalInfo]
    """
...
class FirewallRuleListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.FirewallRule]
    :ivar next_link: The link used to get the next page of operations.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.FirewallRule]
        :keyword next_link: The link used to get the next page of operations.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class FlexibleServerEditionCapability(_serialization.Model):
    ...
    :vartype supported_storage_editions:
     list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.StorageEditionCapability]
    ...
    :vartype supported_server_versions:
     list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.ServerVersionCapability]
    :ivar status: The status.
    :vartype status: str
    """
...
class HighAvailability(_serialization.Model):
    ...
    :ivar mode: The HA mode for the server. Known values are: "Disabled" and "ZoneRedundant".
    :vartype mode: str or ~azure.mgmt.rdbms.postgresqlflexibleservers.models.HighAvailabilityMode
    ...
    :vartype state: str or ~azure.mgmt.rdbms.postgresqlflexibleservers.models.ServerHAState
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword mode: The HA mode for the server. Known values are: "Disabled" and "ZoneRedundant".
        :paramtype mode: str or ~azure.mgmt.rdbms.postgresqlflexibleservers.models.HighAvailabilityMode
...
class HyperscaleNodeEditionCapability(_serialization.Model):
    ...
    :vartype supported_node_types:
     list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.NodeTypeCapability]
    :ivar status: The status.
    :vartype status: str
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.supported_storage_editions: Optional[list["_models.StorageEditionCapability"]] = None
        self.supported_server_versions: Optional[list["_models.ServerVersionCapability"]] = None
        self.supported_node_types: Optional[list["_models.NodeTypeCapability"]] = None
        self.status: Optional[str] = None
...
class NameAvailability(_serialization.Model):
    ...
    :vartype reason: str or ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Reason
    """
...
class Network(_serialization.Model):
    ...
    :vartype public_network_access: str or
     ~azure.mgmt.rdbms.postgresqlflexibleservers.models.ServerPublicNetworkAccessState
    ...
    def __init__(
        ...
        """
        super().__init__(**kwargs)
        self.public_network_access: Optional[Union[str, "_models.ServerPublicNetworkAccessState"]] = None
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.OperationDisplay
    :ivar is_data_action: Indicates whether the operation is a data action.
    :vartype is_data_action: bool
    :ivar origin: The intended executor of the operation. Known values are: "NotSpecified", "user",
     and "system".
    :vartype origin: str or ~azure.mgmt.rdbms.postgresqlflexibleservers.models.OperationOrigin
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Operation]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Operation]
...
class RestartParameter(_serialization.Model):
    ...
    :vartype failover_mode: str or ~azure.mgmt.rdbms.postgresqlflexibleservers.models.FailoverMode
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype failover_mode: str or
         ~azure.mgmt.rdbms.postgresqlflexibleservers.models.FailoverMode
        """
        super().__init__(**kwargs)
...
class Server(TrackedResource):
    ...
    :vartype sku: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Sku
    :ivar system_data: The system metadata relating to this resource.
    :vartype system_data: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.SystemData
    ...
    :vartype version: str or ~azure.mgmt.rdbms.postgresqlflexibleservers.models.ServerVersion
    ...
    :vartype state: str or ~azure.mgmt.rdbms.postgresqlflexibleservers.models.ServerState
    ...
    :vartype storage: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Storage
    :ivar backup: Backup properties of a server.
    :vartype backup: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Backup
    :ivar network: Network properties of a server.
    :vartype network: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Network
    :ivar high_availability: High availability properties of a server.
    :vartype high_availability: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.HighAvailability
    :ivar maintenance_window: Maintenance window properties of a server.
    :vartype maintenance_window:
     ~azure.mgmt.rdbms.postgresqlflexibleservers.models.MaintenanceWindow
    ...
    :vartype create_mode: str or ~azure.mgmt.rdbms.postgresqlflexibleservers.models.CreateMode
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype sku: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Sku
        ...
        :paramtype version: str or ~azure.mgmt.rdbms.postgresqlflexibleservers.models.ServerVersion
        :keyword storage: Storage properties of a server.
        :paramtype storage: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Storage
        :keyword backup: Backup properties of a server.
        :paramtype backup: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Backup
        :keyword network: Network properties of a server.
        :paramtype network: ~azure.mgmt.rdbms.postgresqlflexibleservers.models.Network
        :keyword high_availability: High availability properties of a server.
        :paramtype high_availability:
         ~azure.mgmt.rdbms.postgresqlflexibleservers.models.HighAvailability
        ...
        :keyword create_mode: The mode to create a new PostgreSQL server. Known values are: "Default",
         "Create", "Update", and "PointInTimeRestore".
        :paramtype create_mode: str or ~azure.mgmt.rdbms.postgresqlflexibleservers.models.CreateMode
        """
...
class ServerForUpdate(_serialization.Model):
    ...
    :vartype create_mode: str or
     ~azure.mgmt.rdbms.postgresqlflexibleservers.models.CreateModeForUpdate
    """
...
class ServerListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Server]
    :ivar next_link: The link used to get the next page of operations.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Server]
        :keyword next_link: The link used to get the next page of operations.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ServerVersionCapability(_serialization.Model):
    ...
    :vartype supported_vcores:
     list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.VcoreCapability]
    :ivar status: The status.
    :vartype status: str
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        super().__init__(**kwargs)
        self.name: Optional[str] = None
        self.supported_vcores: Optional[list["_models.VcoreCapability"]] = None
        self.status: Optional[str] = None
...
class Sku(_serialization.Model):
    ...
    :vartype tier: str or ~azure.mgmt.rdbms.postgresqlflexibleservers.models.SkuTier
    """
    ...
    def __init__(self, *, name: str, tier: Union[str, "_models.SkuTier"], **kwargs: Any) -> None:
        ...
        :keyword tier: The tier of the particular SKU, e.g. Burstable. Required. Known values are:
         "Burstable", "GeneralPurpose", and "MemoryOptimized".
        :paramtype tier: str or ~azure.mgmt.rdbms.postgresqlflexibleservers.models.SkuTier
        """
        super().__init__(**kwargs)
        self.name = name
        self.tier = tier
...
class StorageEditionCapability(_serialization.Model):
    ...
    :vartype supported_storage_mb:
     list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.StorageMBCapability]
    :ivar status: The status.
    :vartype status: str
    """
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or
     ~azure.mgmt.rdbms.postgresqlflexibleservers.models.CreatedByType
...
class VirtualNetworkSubnetUsageResult(_serialization.Model):
    ...
    :vartype delegated_subnets_usage:
     list[~azure.mgmt.rdbms.postgresqlflexibleservers.models.DelegatedSubnetUsage]
    """
