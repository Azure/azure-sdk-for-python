...
class ConfigurationsOperations:
    ...
    def list_by_server(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Configuration]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Configuration or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.rdbms.postgresqlflexibleservers.models.Configuration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
