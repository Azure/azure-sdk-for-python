...
class LocationBasedCapabilitiesOperations:
    ...
    @distributed_trace
    def execute(self, location_name: str, **kwargs: Any) -> AsyncItemPaged["_models.CapabilityProperties"]:
        ...
        :return: An iterator like instance of either CapabilityProperties or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresqlflexibleservers.models.CapabilityProperties]
