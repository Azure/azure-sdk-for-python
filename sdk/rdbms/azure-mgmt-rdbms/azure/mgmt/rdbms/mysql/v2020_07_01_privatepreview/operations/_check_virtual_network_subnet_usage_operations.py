...
class CheckVirtualNetworkSubnetUsageOperations(object):
    ...
    def execute(
        ...
        parameters,  # type: "models.VirtualNetworkSubnetUsageParameter"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.VirtualNetworkSubnetUsageResult"
        """Get virtual network subnet usage for a given vNet resource id.

        :param location_name: The name of the location.
        :type location_name: str
        :param parameters: The required parameters for creating or updating a server.
        :type parameters: ~azure.mgmt.rdbms.mysql.v2020_07_01_privatepreview.models.VirtualNetworkSubnetUsageParameter
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: VirtualNetworkSubnetUsageResult, or the result of cls(response)
        :rtype: ~azure.mgmt.rdbms.mysql.v2020_07_01_privatepreview.models.VirtualNetworkSubnetUsageResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VirtualNetworkSubnetUsageResult"]
        error_map = {
