...
class VirtualNetworkRulesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The requested virtual Network Rule Resource state. Is either a model type or
         a IO type. Required.
        :type parameters: ~azure.mgmt.rdbms.mysql.models.VirtualNetworkRule or IO
    ...
    def list_by_server(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.mysql.models.VirtualNetworkRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
