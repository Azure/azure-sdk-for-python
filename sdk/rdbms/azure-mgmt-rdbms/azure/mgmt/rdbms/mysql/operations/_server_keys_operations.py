...
class ServerKeysOperations:
    ...
    def list(self, resource_group_name: str, server_name: str, **kwargs: Any) -> Iterable["_models.ServerKey"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.mysql.models.ServerKey]
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/keys/{keyName}"
    }
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The requested MySQL Server key resource state. Is either a ServerKey type or
         a IO type. Required.
        :type parameters: ~azure.mgmt.rdbms.mysql.models.ServerKey or IO
