...
class _MySQLManagementClientOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], MySQLManagementClientConfiguration]
):
    ...
    def _create_recommended_action_session_initial(  # pylint: disable=name-too-long
