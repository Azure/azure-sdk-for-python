...
class ServersOperations(object):
    ...
    def start(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    start.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/start'}
    ...
    def stop(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    stop.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/stop'}


    def _upgrade_initial(
            self, resource_group_name, server_name, target_server_version=None, custom_headers=None, raw=False, **operation_config):
        parameters = models.ServerUpgradeParameters(target_server_version=target_server_version)
    ...
    def upgrade(
            self, resource_group_name, server_name, target_server_version=None, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    upgrade.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/upgrade'}
