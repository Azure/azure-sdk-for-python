...
class PrivateLinkResourcesOperations(object):
    ...
    def list_by_server(
        ...
        :rtype:
         ~azure.mgmt.rdbms.mysql.models.PrivateLinkResourcePaged[~azure.mgmt.rdbms.mysql.models.PrivateLinkResource]
        ...
        return deserialized
    list_by_server.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/privateLinkResources'}

    def get(
            self, resource_group_name, server_name, group_name, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~azure.mgmt.rdbms.mysql.models.PrivateLinkResource or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/privateLinkResources/{groupName}'}
