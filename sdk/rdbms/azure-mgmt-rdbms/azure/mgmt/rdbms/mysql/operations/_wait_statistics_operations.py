...
def build_get_request(
    resource_group_name: str, server_name: str, wait_statistics_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class WaitStatisticsOperations:
    ...
    def list_by_server(
        ...
        **kwargs: Any
    ) -> ItemPaged["_models.WaitStatistic"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.mysql.models.WaitStatistic]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
