...
class TopQueryStatisticsOperations(object):
    ...
    def list_by_server(
        ...
        resource_group_name,  # type: str
        server_name,  # type: str
        parameters,  # type: "_models.TopQueryStatisticsInput"
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["_models.TopQueryStatisticsResultList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.mysql.models.TopQueryStatisticsResultList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
