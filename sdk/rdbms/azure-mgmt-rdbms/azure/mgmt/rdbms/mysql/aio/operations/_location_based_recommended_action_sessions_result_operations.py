...
class LocationBasedRecommendedActionSessionsResultOperations:
    """LocationBasedRecommendedActionSessionsResultOperations async operations.
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.mysql.models.RecommendationActionsResultListor ~azure.mgmt.rdbms.mysql.models.RecommendationActionsResultList]
