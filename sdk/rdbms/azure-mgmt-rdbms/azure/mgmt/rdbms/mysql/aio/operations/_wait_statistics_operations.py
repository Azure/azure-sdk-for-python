...
class WaitStatisticsOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("WaitStatistic", pipeline_response.http_response)
    ...
    def list_by_server(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.WaitStatistic"]:
    ...
    def list_by_server(
        ...
        resource_group_name: str,
        server_name: str,
        parameters: Union[_models.WaitStatisticsInput, IO[bytes]],
        **kwargs: Any
    ) -> AsyncItemPaged["_models.WaitStatistic"]:
        """Retrieve wait statistics for specified aggregation window.
        ...
        :type parameters: ~azure.mgmt.rdbms.mysql.models.WaitStatisticsInput or IO[bytes]
        :return: An iterator like instance of either WaitStatistic or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.mysql.models.WaitStatistic]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
