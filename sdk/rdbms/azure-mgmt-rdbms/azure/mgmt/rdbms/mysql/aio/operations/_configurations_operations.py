...
class ConfigurationsOperations:
    ...
    async def _create_or_update_initial(
        ...
        parameters: Union[_models.Configuration, IO],
        **kwargs: Any
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.mysql.models.Configuration or IO
    ...
    def list_by_server(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.mysql.models.Configuration]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
