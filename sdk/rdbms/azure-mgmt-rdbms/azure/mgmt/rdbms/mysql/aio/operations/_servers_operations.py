...
class ServersOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.mysql.models.ServerForCreate or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Server or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.rdbms.mysql.models.Server]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.mysql.models.ServerUpdateParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Server or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.rdbms.mysql.models.Server]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _upgrade_initial(  # pylint: disable=inconsistent-return-statements
        ...
        resource_group_name: str,
        server_name: str,
        parameters: Union[_models.ServerUpgradeParameters, IO[bytes]],
        **kwargs: Any
    ) -> None:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def begin_upgrade(
        ...
        **kwargs: Any
        ...
        :type server_name: str
        :param parameters: The required parameters for updating a server. Is either a
         ServerUpgradeParameters type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.rdbms.mysql.models.ServerUpgradeParameters or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
