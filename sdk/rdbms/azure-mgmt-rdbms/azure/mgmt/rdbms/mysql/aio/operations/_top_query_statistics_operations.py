...
class TopQueryStatisticsOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("QueryStatistic", pipeline_response.http_response)
    ...
    def list_by_server(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.QueryStatistic"]:
    ...
    def list_by_server(
        ...
        resource_group_name: str,
        server_name: str,
        parameters: Union[_models.TopQueryStatisticsInput, IO[bytes]],
        **kwargs: Any
    ) -> AsyncItemPaged["_models.QueryStatistic"]:
        """Retrieve the Query-Store top queries for specified metric and aggregation.
        ...
        :type parameters: ~azure.mgmt.rdbms.mysql.models.TopQueryStatisticsInput or IO[bytes]
        :return: An iterator like instance of either QueryStatistic or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.mysql.models.QueryStatistic]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
