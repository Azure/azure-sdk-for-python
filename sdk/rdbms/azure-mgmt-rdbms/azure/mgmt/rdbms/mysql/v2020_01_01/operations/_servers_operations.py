...
class ServersOperations(object):
    ...
    def _create_initial(
        ...
        parameters,  # type: "models.ServerForCreate"
        **kwargs  # type: Any
    ):
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.mysql.v2020_01_01.models.ServerForCreate
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.mysql.v2020_01_01.models.Server]
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        server_name,  # type: str
        parameters,  # type: "models.ServerUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["models.Server"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["models.Server"]]
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.mysql.v2020_01_01.models.ServerUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.mgmt.rdbms.mysql.v2020_01_01.models.Server
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Server"]
        error_map = {
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.mysql.v2020_01_01.models.ServerListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def begin_restart(
        ...
        **kwargs  # type: Any
        ...
        if cont_token:
            ...
            return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_restart.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBForMySQL/servers/{serverName}/restart'}  # type: ignore
    ...
    _start_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/start'}  # type: ignore
    ...
    def _upgrade_initial(
        ...
        resource_group_name,  # type: str
        server_name,  # type: str
        parameters,  # type: "models.ServerUpgradeParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'ServerUpgradeParameters')
        body_content_kwargs['content'] = body_content
    ...
    def begin_upgrade(
        ...
        **kwargs  # type: Any
        ...
        :type server_name: str
        :param parameters: The required parameters for updating a server.
        :type parameters: ~azure.mgmt.rdbms.mysql.v2020_01_01.models.ServerUpgradeParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
