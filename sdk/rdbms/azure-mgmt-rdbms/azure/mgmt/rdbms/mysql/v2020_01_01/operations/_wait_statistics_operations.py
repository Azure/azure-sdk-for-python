...
class WaitStatisticsOperations(object):
    ...
    def get(
        ...
        wait_statistics_id,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.WaitStatistic"
        ...
        :rtype: ~azure.mgmt.rdbms.mysql.v2020_01_01.models.WaitStatistic
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.WaitStatistic"]
        error_map = {
    ...
    def list_by_server(
        ...
        resource_group_name,  # type: str
        server_name,  # type: str
        parameters,  # type: "models.WaitStatisticsInput"
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.WaitStatisticsResultList"]
        ...
        :type parameters: ~azure.mgmt.rdbms.mysql.v2020_01_01.models.WaitStatisticsInput
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either WaitStatisticsResultList or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.mysql.v2020_01_01.models.WaitStatisticsResultList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.WaitStatisticsResultList"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
