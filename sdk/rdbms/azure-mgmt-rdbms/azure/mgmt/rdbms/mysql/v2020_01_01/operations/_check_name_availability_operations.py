    ...
    def execute(
        ...
        **kwargs  # type: Any
        ...
        :param name_availability_request: The required parameters for checking if resource name is
         available.
        :type name_availability_request: ~azure.mgmt.rdbms.mysql.v2020_01_01.models.NameAvailabilityRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NameAvailability, or the result of cls(response)
        :rtype: ~azure.mgmt.rdbms.mysql.v2020_01_01.models.NameAvailability
