...
class LocationBasedPerformanceTierOperations:
    """LocationBasedPerformanceTierOperations async operations.
    ...
    def list(
        ...
        location_name: str,
        **kwargs
    ) -> AsyncIterable["models.PerformanceTierListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.mysql.v2020_01_01.models.PerformanceTierListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PerformanceTierListResult"]
        error_map = {
