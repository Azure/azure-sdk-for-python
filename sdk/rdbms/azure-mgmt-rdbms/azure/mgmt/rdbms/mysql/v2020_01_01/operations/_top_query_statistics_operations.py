...
class TopQueryStatisticsOperations(object):
    ...
    def get(
        ...
        query_statistic_id,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.QueryStatistic"
        ...
        :rtype: ~azure.mgmt.rdbms.mysql.v2020_01_01.models.QueryStatistic
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.QueryStatistic"]
        error_map = {
    ...
    def list_by_server(
        ...
        resource_group_name,  # type: str
        server_name,  # type: str
        parameters,  # type: "models.TopQueryStatisticsInput"
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.TopQueryStatisticsResultList"]
        ...
        :type parameters: ~azure.mgmt.rdbms.mysql.v2020_01_01.models.TopQueryStatisticsInput
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either TopQueryStatisticsResultList or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.mysql.v2020_01_01.models.TopQueryStatisticsResultList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.TopQueryStatisticsResultList"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
