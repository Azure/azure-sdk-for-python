...
class WaitStatisticsOperations:
    ...
    def list_by_server(
        ...
        **kwargs
    ) -> AsyncIterable["models.WaitStatisticsResultList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.mysql.v2020_01_01.models.WaitStatisticsResultList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
