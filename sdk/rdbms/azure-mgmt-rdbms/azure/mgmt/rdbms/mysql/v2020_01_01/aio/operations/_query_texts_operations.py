...
class QueryTextsOperations:
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.rdbms.mysql.v2020_01_01.models.QueryText
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.QueryText"]
        error_map = {
    ...
    def list_by_server(
        ...
        query_ids: List[str],
        **kwargs
    ) -> AsyncIterable["models.QueryTextsResultList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.mysql.v2020_01_01.models.QueryTextsResultList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.QueryTextsResultList"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    list_by_server.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/queryTexts'}  # type: ignore
