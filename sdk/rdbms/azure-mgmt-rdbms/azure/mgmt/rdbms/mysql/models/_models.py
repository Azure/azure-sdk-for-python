...
class ConfigurationListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.rdbms.mysql.models.Configuration]
    """
...
class DatabaseListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.rdbms.mysql.models.Database]
    """
...
class FirewallRuleListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.rdbms.mysql.models.FirewallRule]
    """
...
class LogFileListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.rdbms.mysql.models.LogFile]
    """
...
class PerformanceTierListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.rdbms.mysql.models.PerformanceTierProperties]
    """
...
class PrivateEndpointConnection(Resource):
    ...
    :type private_endpoint: ~azure.mgmt.rdbms.mysql.models.PrivateEndpointProperty
...
class QueryPerformanceInsightResetDataResult(msrest.serialization.Model):
    ...
    :param status: Indicates result of the operation. Possible values include: "Succeeded",
     "Failed".
    :type status: str or ~azure.mgmt.rdbms.mysql.models.QueryPerformanceInsightResetDataResultState
...
class Server(TrackedResource):
    ...
    :type ssl_enforcement: str or ~azure.mgmt.rdbms.mysql.models.SslEnforcementEnum
    ...
    :type minimal_tls_version: str or ~azure.mgmt.rdbms.mysql.models.MinimalTlsVersionEnum
    ...
    :type user_visible_state: str or ~azure.mgmt.rdbms.mysql.models.ServerState
...
class ServerAdministratorResourceListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.rdbms.mysql.models.ServerAdministratorResource]
    """
...
class ServerPrivateLinkServiceConnectionStateProperty(msrest.serialization.Model):
    ...
    :type status: str or ~azure.mgmt.rdbms.mysql.models.PrivateLinkServiceConnectionStateStatus
    :param description: Required. The private link service connection description.
    :type description: str
...
class ServerSecurityAlertPolicy(Resource):
    ...
    :type state: str or ~azure.mgmt.rdbms.mysql.models.ServerSecurityAlertPolicyState
...
class StorageProfile(msrest.serialization.Model):
    ...
    :param geo_redundant_backup: Enable Geo-redundant or not for server backup. Possible values
     include: "Enabled", "Disabled".
    :type geo_redundant_backup: str or ~azure.mgmt.rdbms.mysql.models.GeoRedundantBackup
    ...
    :param storage_autogrow: Enable Storage Auto Grow. Possible values include: "Enabled",
     "Disabled".
    :type storage_autogrow: str or ~azure.mgmt.rdbms.mysql.models.StorageAutogrow
    """
