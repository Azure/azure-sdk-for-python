...
class ServersOperations(object):
    ...
    def list_by_resource_group(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.mysql_flexibleservers.models.ServerListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _restart_initial(
        ...
        resource_group_name,  # type: str
        server_name,  # type: str
        parameters,  # type: "_models.ServerRestartParameter"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'ServerRestartParameter')
        body_content_kwargs['content'] = body_content
