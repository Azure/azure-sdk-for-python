...
class ConfigurationsOperations(object):
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.mysql_flexibleservers.models.Configuration]
    ...
    def _batch_update_initial(
        ...
        resource_group_name,  # type: str
        server_name,  # type: str
        parameters,  # type: "_models.ConfigurationListForBatchUpdate"
        **kwargs  # type: Any
    ):
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'ConfigurationListForBatchUpdate')
        body_content_kwargs['content'] = body_content
    ...
    def begin_batch_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.mysql_flexibleservers.models.ConfigurationListForBatchUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.mysql_flexibleservers.models.ConfigurationListResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, PollingMethod]
    ...
    def list_by_server(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.mysql_flexibleservers.models.ConfigurationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ConfigurationListResult"]
        error_map = {
