...
class CheckNameAvailabilityOperations:
    ...
    @distributed_trace
    def execute(
        self, location_name: str, name_availability_request: Union[_models.NameAvailabilityRequest, IO], **kwargs: Any
    ) -> _models.NameAvailability:
        """Check the availability of name for server.
    ...
    execute.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.DBforMySQL/locations/{locationName}/checkNameAvailability"
    }
