...
class BackupsOperations(object):
    ...
    def list_by_server(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ServerBackupListResult"]
        """List all the backups for a given server.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.mysql_flexibleservers.models.ServerBackupListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
