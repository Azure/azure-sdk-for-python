...
class AdvancedThreatProtectionSettingsOperations:  # pylint: disable=name-too-long
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.rdbms.mysql_flexibleservers.models.AdvancedThreatProtectionForUpdate
    ...
    def list(
        ...
        :return: An iterator like instance of either AdvancedThreatProtection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.mysql_flexibleservers.models.AdvancedThreatProtection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
