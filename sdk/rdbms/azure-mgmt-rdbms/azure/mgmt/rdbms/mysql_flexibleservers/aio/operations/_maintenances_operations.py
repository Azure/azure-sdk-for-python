...
from ...operations._maintenances_operations import build_list_request, build_read_request, build_update_request
...
class MaintenancesOperations:
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        cls: ClsType[Optional[_models.Maintenance]] = kwargs.pop("cls", None)
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The required parameters for update maintenance on a server. Default value is
         None.
        :type parameters: ~azure.mgmt.rdbms.mysql_flexibleservers.models.MaintenanceUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either Maintenance or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.rdbms.mysql_flexibleservers.models.Maintenance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def list(self, resource_group_name: str, server_name: str, **kwargs: Any) -> AsyncIterable["_models.Maintenance"]:
        """List maintenances.
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.mysql_flexibleservers.models.Maintenance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
