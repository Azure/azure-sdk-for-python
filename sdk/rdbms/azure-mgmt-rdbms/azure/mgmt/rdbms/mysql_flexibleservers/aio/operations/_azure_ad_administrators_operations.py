...
class AzureADAdministratorsOperations:
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        cls: ClsType[Optional[_models.AzureADAdministrator]] = kwargs.pop("cls", None)
    ...
    def list_by_server(
        ...
        :return: An iterator like instance of either AzureADAdministrator or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.mysql_flexibleservers.models.AzureADAdministrator]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
