...
from ...operations._azure_ad_administrators_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_server_request
T = TypeVar('T')
...
class AzureADAdministratorsOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param administrator_name: The name of the Azure AD Administrator.
        ...
        :return: An instance of AsyncLROPoller that returns either AzureADAdministrator or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.rdbms.mysql_flexibleservers.models.AzureADAdministrator]
    ...
    def list_by_server(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either AdministratorListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.mysql_flexibleservers.models.AdministratorListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
