...
from ...operations._firewall_rules_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_server_group_request
T = TypeVar('T')
    ...
    def list_by_server_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either FirewallRuleListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresqlhsc.models.FirewallRuleListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
