...
from ...operations._configurations_operations import build_get_request, build_list_by_server_group_request, build_list_by_server_request, build_update_request_initial
T = TypeVar('T')
...
class ConfigurationsOperations:
    ...
    def list_by_server(
        ...
        server_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.ServerConfigurationListResult"]:
        ...
        :return: An iterator like instance of either ServerConfigurationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresqlhsc.models.ServerConfigurationListResult]
    ...
    def list_by_server_group(
        ...
        server_group_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.ServerGroupConfigurationListResult"]:
        ...
        :return: An iterator like instance of either ServerGroupConfigurationListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresqlhsc.models.ServerGroupConfigurationListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_update(
        ...
        parameters: "_models.ServerGroupConfiguration",
        **kwargs: Any
    ) -> AsyncLROPoller["_models.ServerGroupConfiguration"]:
        ...
        :return: An instance of AsyncLROPoller that returns either ServerGroupConfiguration or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.rdbms.postgresqlhsc.models.ServerGroupConfiguration]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
