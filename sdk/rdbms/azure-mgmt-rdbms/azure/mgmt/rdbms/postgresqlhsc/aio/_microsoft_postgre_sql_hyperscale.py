...
class MicrosoftPostgreSQLHyperscale:  # pylint: disable=client-accepts-api-version-keyword
    """The Microsoft Azure management API provides create, read, update, and delete functionality for
    Azure PostgreSQL Hyperscale (Citus) resources including server groups, servers, databases,
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MicrosoftPostgreSQLHyperscaleConfiguration(
