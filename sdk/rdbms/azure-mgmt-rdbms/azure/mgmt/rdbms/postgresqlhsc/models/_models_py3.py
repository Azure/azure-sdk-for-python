...
class FirewallRule(ProxyResource):
    ...
    :ivar start_ip_address: The start IP address of the server group firewall rule. Must be IPv4
     format. Required.
    :vartype start_ip_address: str
    :ivar end_ip_address: The end IP address of the server group firewall rule. Must be IPv4
     format. Required.
    ...
    def __init__(self, *, start_ip_address: str, end_ip_address: str, **kwargs):
        """
        :keyword start_ip_address: The start IP address of the server group firewall rule. Must be IPv4
         format. Required.
        :paramtype start_ip_address: str
        :keyword end_ip_address: The end IP address of the server group firewall rule. Must be IPv4
         format. Required.
...
class ServerGroup(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar system_data: The system metadata relating to this resource.
    :vartype system_data: ~azure.mgmt.rdbms.postgresqlhsc.models.SystemData
    :ivar create_mode: The mode to create a new server group. Known values are: "Default",
     "PointInTimeRestore", and "ReadReplica".
    ...
    :ivar postgresql_version: The PostgreSQL version of server group. Known values are: "11" and
     "12".
    :vartype postgresql_version: str or ~azure.mgmt.rdbms.postgresqlhsc.models.PostgreSQLVersion
    :ivar citus_version: The Citus version of server group. Known values are: "8.3", "9.0", "9.1",
     "9.2", "9.3", "9.4", and "9.5".
    ...
    :ivar state: A state of a server group that is visible to user. Known values are: "Ready",
     "Dropping", "Disabled", "Starting", "Stopping", "Stopped", "Updating", and "Provisioning".
    ...
    :ivar resource_provider_type: The resource provider type of server group. Known values are:
     "Meru" and "Marlin".
    ...
    _attribute_map = {
        ...
        "delegated_subnet_arguments": {
            "key": "properties.delegatedSubnetArguments",
            "type": "ServerGroupPropertiesDelegatedSubnetArguments",
        },
        "private_dns_zone_arguments": {
            "key": "properties.privateDnsZoneArguments",
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        postgresql_version: Optional[Union[str, "_models.PostgreSQLVersion"]] = None,
        citus_version: Optional[Union[str, "_models.CitusVersion"]] = None,
        enable_mx: Optional[bool] = None,
        enable_zfs: Optional[bool] = None,
        enable_shards_on_coordinator: Optional[bool] = None,
        server_role_groups: Optional[List["_models.ServerRoleGroup"]] = None,
        maintenance_window: Optional["_models.MaintenanceWindow"] = None,
        availability_zone: Optional[str] = None,
        standby_availability_zone: Optional[str] = None,
        delegated_subnet_arguments: Optional["_models.ServerGroupPropertiesDelegatedSubnetArguments"] = None,
        private_dns_zone_arguments: Optional["_models.ServerGroupPropertiesPrivateDnsZoneArguments"] = None,
        ...
        **kwargs
        ...
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
        :keyword create_mode: The mode to create a new server group. Known values are: "Default",
         "PointInTimeRestore", and "ReadReplica".
        ...
        :keyword postgresql_version: The PostgreSQL version of server group. Known values are: "11" and
         "12".
        :paramtype postgresql_version: str or ~azure.mgmt.rdbms.postgresqlhsc.models.PostgreSQLVersion
        :keyword citus_version: The Citus version of server group. Known values are: "8.3", "9.0",
...
class ServerGroupConfigurationListResult(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.ServerGroupConfiguration"]] = None, **kwargs):
        """
...
class ServerGroupForUpdate(_serialization.Model):  # pylint: disable=too-many-instance-attributes
...
class ServerGroupListResult(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.ServerGroup"]] = None, **kwargs):
        """
...
class ServerGroupPropertiesDelegatedSubnetArguments(_serialization.Model):
    ...
    def __init__(self, *, subnet_arm_resource_id: Optional[str] = None, **kwargs):
        """
...
class ServerGroupPropertiesPrivateDnsZoneArguments(_serialization.Model):
    ...
    def __init__(self, *, private_dns_zone_arm_resource_id: Optional[str] = None, **kwargs):
        """
...
class ServerGroupServer(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar system_data: The system metadata relating to this resource.
    :vartype system_data: ~azure.mgmt.rdbms.postgresqlhsc.models.SystemData
    :ivar server_edition: The edition of a server (default: GeneralPurpose). Known values are:
    ...
    :ivar role: The role of server in the server group. Known values are: "Coordinator" and
     "Worker".
    ...
    :ivar state: A state of a server that is visible to user. Known values are: "Ready",
     "Dropping", "Disabled", "Starting", "Stopping", "Stopped", "Updating", and "Provisioning".
    :vartype state: str or ~azure.mgmt.rdbms.postgresqlhsc.models.ServerState
    :ivar ha_state: A state of a server group that is visible to user for HA feature. Known values
     are: "NotEnabled", "CreatingStandby", "ReplicatingData", "FailingOver", "Healthy",
     "RemovingStandby", and "NotSync".
    ...
    :vartype administrator_login: str
    :ivar postgresql_version: The PostgreSQL version of server. Known values are: "11" and "12".
    :vartype postgresql_version: str or ~azure.mgmt.rdbms.postgresqlhsc.models.PostgreSQLVersion
    :ivar citus_version: The Citus version of server. Known values are: "8.3", "9.0", "9.1", "9.2",
     "9.3", "9.4", and "9.5".
    :vartype citus_version: str or ~azure.mgmt.rdbms.postgresqlhsc.models.CitusVersion
    :ivar availability_zone: Availability Zone information of the server group.
    :vartype availability_zone: str
    ...
    def __init__(
        self,
        *,
        server_edition: Optional[Union[str, "_models.ServerEdition"]] = None,
        ...
        **kwargs
        ...
        """
        :keyword server_edition: The edition of a server (default: GeneralPurpose). Known values are:
         "GeneralPurpose" and "MemoryOptimized".
        ...
        :keyword role: The role of server in the server group. Known values are: "Coordinator" and
         "Worker".
        ...
        :paramtype administrator_login: str
        :keyword postgresql_version: The PostgreSQL version of server. Known values are: "11" and "12".
        :paramtype postgresql_version: str or ~azure.mgmt.rdbms.postgresqlhsc.models.PostgreSQLVersion
        :keyword citus_version: The Citus version of server. Known values are: "8.3", "9.0", "9.1",
         "9.2", "9.3", "9.4", and "9.5".
        :paramtype citus_version: str or ~azure.mgmt.rdbms.postgresqlhsc.models.CitusVersion
        :keyword availability_zone: Availability Zone information of the server group.
        :paramtype availability_zone: str
...
class ServerGroupServerListResult(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.ServerGroupServer"]] = None, **kwargs):
        """
...
class ServerGroupServerProperties(ServerProperties):  # pylint: disable=too-many-instance-attributes
...
class ServerRoleGroup(ServerProperties):
    ...
    :vartype name: str
    :ivar role: The role of servers in the server role group. Known values are: "Coordinator" and
     "Worker".
    :vartype role: str or ~azure.mgmt.rdbms.postgresqlhsc.models.ServerRole
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype name: str
        :keyword role: The role of servers in the server role group. Known values are: "Coordinator"
         and "Worker".
        :paramtype role: str or ~azure.mgmt.rdbms.postgresqlhsc.models.ServerRole
