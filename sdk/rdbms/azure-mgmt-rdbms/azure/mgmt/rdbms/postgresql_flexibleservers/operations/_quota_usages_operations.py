...
class QuotaUsagesOperations:
    ...
    @distributed_trace
    def list(self, location_name: str, **kwargs: Any) -> Iterable["_models.QuotaUsage"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresql_flexibleservers.models.QuotaUsage]
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.DBforPostgreSQL/locations/{locationName}/resourceType/flexibleServers/usages"
    }
