...
class PrivateEndpointConnectionOperations:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresql_flexibleservers.models.PrivateEndpointConnection
        ...
        :return: An instance of LROPoller that returns either PrivateEndpointConnection or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresql_flexibleservers.models.PrivateEndpointConnection]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The required parameters for updating private endpoint connection. Is either
         a PrivateEndpointConnection type or a IO type. Required.
        :type parameters: ~azure.mgmt.rdbms.postgresql_flexibleservers.models.PrivateEndpointConnection
         or IO
