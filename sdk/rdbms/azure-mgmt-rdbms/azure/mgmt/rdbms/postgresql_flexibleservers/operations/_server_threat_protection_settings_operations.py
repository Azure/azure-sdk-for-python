...
class ServerThreatProtectionSettingsOperations:
    ...
    def list_by_server(
        ...
        :return: An iterator like instance of either ServerThreatProtectionSettingsModel or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresql_flexibleservers.models.ServerThreatProtectionSettingsModel]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresql_flexibleservers.models.ServerThreatProtectionSettingsModel]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
