...
def build_execute_request(
    ...
    location_name: str,
    *,
    json: Optional[_models.VirtualNetworkSubnetUsageParameter] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DBforPostgreSQL/locations/{locationName}/checkVirtualNetworkSubnetUsage")  # pylint: disable=line-too-long
