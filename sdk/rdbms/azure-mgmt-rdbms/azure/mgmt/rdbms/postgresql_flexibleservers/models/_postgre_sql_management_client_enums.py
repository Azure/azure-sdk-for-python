...
class ReplicaLinkState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Gets the link state of a replica server. This property is returned only for replicas api call.
...
class ReplicationPromoteMode(str, Enum, metaclass=CaseInsensitiveEnumMeta):
