...
class Replica(_serialization.Model):
    ...
    :ivar link_state: Gets the link state of a replica server. This property is returned only for
     replicas api call. Supported values are Active, Catchup, Provisioning, Updating, Broken,
     Reconfiguring. Known values are: "Active", "Catchup", "Provisioning", "Updating", "Broken", and
     "Reconfiguring".
    :vartype link_state: str or
     ~azure.mgmt.rdbms.postgresql_flexibleservers.models.ReplicaLinkState
    :ivar promote_mode: Sets the promote mode for a replica server. This is a write only property.
     Known values are: "standalone" and "siteswap".
    :vartype promote_mode: str or
     ~azure.mgmt.rdbms.postgresql_flexibleservers.models.ReplicationPromoteMode
    ...
    _attribute_map = {
        ...
        "link_state": {"key": "linkState", "type": "str"},
    ...
    def __init__(
        ...
        *,
        ...
        promote_mode: Optional[Union[str, "_models.ReplicationPromoteMode"]] = None,
        ...
        **kwargs: Any
        ...
        :keyword promote_mode: Sets the promote mode for a replica server. This is a write only
         property. Known values are: "standalone" and "siteswap".
