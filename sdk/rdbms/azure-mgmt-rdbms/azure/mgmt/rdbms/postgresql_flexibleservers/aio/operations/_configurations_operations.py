...
from ...operations._configurations_operations import build_get_request, build_list_by_server_request, build_put_request_initial, build_update_request_initial
T = TypeVar('T')
    ...
    def list_by_server(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ConfigurationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresql_flexibleservers.models.ConfigurationListResult]
