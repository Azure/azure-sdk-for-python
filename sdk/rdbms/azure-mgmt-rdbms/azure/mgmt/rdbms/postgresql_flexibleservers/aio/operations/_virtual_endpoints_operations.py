...
class VirtualEndpointsOperations:
    ...
    async def _create_initial(
        ...
        parameters: Union[_models.VirtualEndpointResource, IO],
        **kwargs: Any
    ) -> Optional[_models.VirtualEndpointResource]:
        error_map = {
        ...
        cls: ClsType[Optional[_models.VirtualEndpointResource]] = kwargs.pop("cls", None)
        ...
        if response.status_code == 200:
            deserialized = self._deserialize("VirtualEndpointResource", pipeline_response)
    ...
    _create_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{serverName}/virtualendpoints/{virtualEndpointName}"
    }
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param parameters: The required parameters for creating or updating virtual endpoints.
         Required.
        :type parameters: ~azure.mgmt.rdbms.postgresql_flexibleservers.models.VirtualEndpointResource
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.rdbms.postgresql_flexibleservers.models.VirtualEndpointResource]
    ...
    async def _update_initial(
        ...
        server_name: str,
        virtual_endpoint_name: str,
        parameters: Union[_models.VirtualEndpointResourceForPatch, IO],
        **kwargs: Any
    ) -> Optional[_models.VirtualEndpointResource]:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.rdbms.postgresql_flexibleservers.models.VirtualEndpointResourceForPatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters:
         ~azure.mgmt.rdbms.postgresql_flexibleservers.models.VirtualEndpointResourceForPatch or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.rdbms.postgresql_flexibleservers.models.VirtualEndpointResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def list_by_server(
        ...
        :return: An iterator like instance of either VirtualEndpointResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresql_flexibleservers.models.VirtualEndpointResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    list_by_server.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{serverName}/virtualendpoints"
    }
