...
class PostgreSQLManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype administrators:
     azure.mgmt.rdbms.postgresql_flexibleservers.aio.operations.AdministratorsOperations
    ...
    :vartype check_name_availability_with_location:
     azure.mgmt.rdbms.postgresql_flexibleservers.aio.operations.CheckNameAvailabilityWithLocationOperations
