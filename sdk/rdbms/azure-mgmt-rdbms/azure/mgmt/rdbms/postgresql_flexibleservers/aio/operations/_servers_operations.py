...
class ServersOperations:
    ...
    async def begin_create(
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresql_flexibleservers.models.Server or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Server or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.rdbms.postgresql_flexibleservers.models.Server]
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresql_flexibleservers.models.ServerForUpdate or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either Server or the result of
         cls(response)
        :rtype:
    ...
    async def begin_restart(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresql_flexibleservers.models.RestartParameter or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
