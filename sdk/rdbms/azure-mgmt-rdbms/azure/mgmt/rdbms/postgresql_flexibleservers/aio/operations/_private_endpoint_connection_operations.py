...
from ...operations._private_endpoint_connection_operations import build_delete_request, build_update_request
...
class PrivateEndpointConnectionOperations:
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.rdbms.postgresql_flexibleservers.models.PrivateEndpointConnection]
