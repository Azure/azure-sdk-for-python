...
def build_list_update_configurations_request_initial(
    subscription_id: str,
    resource_group_name: str,
    server_name: str,
    *,
    json: Optional[_models.ConfigurationListResult] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/updateConfigurations")  # pylint: disable=line-too-long
    ...
    def begin_list_update_configurations(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._list_update_configurations_initial(  # type: ignore
                resource_group_name=resource_group_name,
                server_name=server_name,
                value=value,
                api_version=api_version,
