...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/performanceTiers")  # pylint: disable=line-too-long
...
class ServerBasedPerformanceTierOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`server_based_performance_tier` attribute.
    """
    ...
    def list(
        ...
        server_name: str,
        **kwargs: Any
    ) -> Iterable[_models.PerformanceTierListResult]:
        ...
        :return: An iterator like instance of either PerformanceTierListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresql.models.PerformanceTierListResult]
