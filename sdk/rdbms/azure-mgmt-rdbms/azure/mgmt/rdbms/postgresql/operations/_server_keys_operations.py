...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/keys")  # pylint: disable=line-too-long
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/keys/{keyName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
        "serverName": _SERIALIZER.url("server_name", server_name, 'str'),
...
def build_create_or_update_request_initial(
    ...
    resource_group_name: str,
    *,
    json: Optional[_models.ServerKey] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class ServerKeysOperations:
    ...
    def list(
        ...
        server_name: str,
        **kwargs: Any
    ) -> Iterable[_models.ServerKeyListResult]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresql.models.ServerKeyListResult]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :param server_name: The name of the server.
        :type server_name: str
        :param key_name: The name of the PostgreSQL Server key to be retrieved.
        :type key_name: str
        :keyword api_version: Api Version. Default value is "2020-01-01". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
