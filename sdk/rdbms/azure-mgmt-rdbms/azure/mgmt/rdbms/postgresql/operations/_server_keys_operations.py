...
def build_create_or_update_request(
    server_name: str, key_name: str, resource_group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ServerKeysOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, server_name: str, **kwargs: Any) -> Iterable["_models.ServerKey"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresql.models.ServerKey]
    ...
    def get(self, resource_group_name: str, server_name: str, key_name: str, **kwargs: Any) -> _models.ServerKey:
        ...
        :param server_name: The name of the server. Required.
        :type server_name: str
        :param key_name: The name of the PostgreSQL Server key to be retrieved. Required.
        :type key_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ServerKey or the result of cls(response)
        :rtype: ~azure.mgmt.rdbms.postgresql.models.ServerKey
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/keys/{keyName}"
    }
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param server_name: The name of the server. Required.
        :type server_name: str
        :param key_name: The name of the PostgreSQL Server key to be operated on (updated or created).
         Required.
        :type key_name: str
        :param resource_group_name: The name of the resource group. The name is case insensitive.
         Required.
        :type resource_group_name: str
        :param parameters: The requested PostgreSQL Server key resource state. Required.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresql.models.ServerKey]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def begin_delete(self, server_name: str, key_name: str, resource_group_name: str, **kwargs: Any) -> LROPoller[None]:
        """Deletes the PostgreSQL Server key with the given name.

        :param server_name: The name of the server. Required.
        :type server_name: str
        :param key_name: The name of the PostgreSQL Server key to be deleted. Required.
        :type key_name: str
        :param resource_group_name: The name of the resource group. The name is case insensitive.
         Required.
        :type resource_group_name: str
