...
class ServerKeysOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, server_name: str, **kwargs: Any) -> ItemPaged["_models.ServerKey"]:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresql.models.ServerKey or IO[bytes]
        :return: An instance of LROPoller that returns either ServerKey or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresql.models.ServerKey]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
