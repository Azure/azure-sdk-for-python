...
from ...operations._location_based_performance_tier_operations import build_list_request
...
class LocationBasedPerformanceTierOperations:
    ...
    @distributed_trace
    def list(self, location_name: str, **kwargs: Any) -> AsyncItemPaged["_models.PerformanceTierProperties"]:
        ...
        :return: An iterator like instance of either PerformanceTierProperties or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresql.models.PerformanceTierProperties]
