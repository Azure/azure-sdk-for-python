...
class ServersOperations:
    ...
    async def begin_create(
        ...
        **kwargs
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresql.models.Server
    ...
    async def begin_update(
        ...
        **kwargs
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresql.models.ServerForUpdate
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: Pass in True if you'd like the AsyncARMPolling polling method,
         False for no polling, or your own initialized polling object for a personal polling strategy.
    ...
    def list_by_resource_group(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresql.models.ServerListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
