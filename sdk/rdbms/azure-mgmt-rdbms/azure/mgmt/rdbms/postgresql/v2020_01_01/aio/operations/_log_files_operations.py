...
class LogFilesOperations:
    ...
    def list_by_server(
        ...
        server_name: str,
        **kwargs
    ) -> AsyncIterable["models.LogFileListResult"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.rdbms.postgresql.v2020_01_01.models.LogFileListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.LogFileListResult"]
        error_map = {
