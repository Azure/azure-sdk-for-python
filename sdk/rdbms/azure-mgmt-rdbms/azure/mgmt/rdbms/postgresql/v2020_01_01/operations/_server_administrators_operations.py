...
class ServerAdministratorsOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ServerAdministratorResource"
        ...
        :rtype: ~azure.mgmt.rdbms.postgresql.v2020_01_01.models.ServerAdministratorResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ServerAdministratorResource"]
        error_map = {
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        server_name,  # type: str
        properties,  # type: "models.ServerAdministratorResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.ServerAdministratorResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ServerAdministratorResource"]
        ...
        body_content = self._serialize.body(properties, 'ServerAdministratorResource')
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["models.ServerAdministratorResource"]
        ...
        :param properties: The required parameters for creating or updating an AAD server
         administrator.
        :type properties: ~azure.mgmt.rdbms.postgresql.v2020_01_01.models.ServerAdministratorResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.postgresql.v2020_01_01.models.ServerAdministratorResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.ServerAdministratorResourceListResult"]
        ...
        :type server_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ServerAdministratorResourceListResult or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.postgresql.v2020_01_01.models.ServerAdministratorResourceListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ServerAdministratorResourceListResult"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
