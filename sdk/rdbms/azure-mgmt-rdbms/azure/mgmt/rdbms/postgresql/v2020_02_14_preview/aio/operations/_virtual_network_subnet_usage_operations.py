...
class VirtualNetworkSubnetUsageOperations:
    ...
    async def execute(
        ...
        **kwargs
        ...
        :type parameters: ~azure.mgmt.rdbms.postgresql.v2020_02_14_preview.models.VirtualNetworkSubnetUsageParameter
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: VirtualNetworkSubnetUsageResult, or the result of cls(response)
        :rtype: ~azure.mgmt.rdbms.postgresql.v2020_02_14_preview.models.VirtualNetworkSubnetUsageResult
