...
class QueryTextPaged(Paged):
    """
    A paging container for iterating over a list of :class:`QueryText <azure.mgmt.rdbms.mariadb.models.QueryText>` object
    """
...
class QueryStatisticPaged(Paged):
    """
    A paging container for iterating over a list of :class:`QueryStatistic <azure.mgmt.rdbms.mariadb.models.QueryStatistic>` object
    """
...
class WaitStatisticPaged(Paged):
    """
    A paging container for iterating over a list of :class:`WaitStatistic <azure.mgmt.rdbms.mariadb.models.WaitStatistic>` object
    """
...
class AdvisorPaged(Paged):
    """
    A paging container for iterating over a list of :class:`Advisor <azure.mgmt.rdbms.mariadb.models.Advisor>` object
    """
...
class RecommendationActionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`RecommendationAction <azure.mgmt.rdbms.mariadb.models.RecommendationAction>` object
    """
...
class PrivateEndpointConnectionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`PrivateEndpointConnection <azure.mgmt.rdbms.mariadb.models.PrivateEndpointConnection>` object
    """
...
class PrivateLinkResourcePaged(Paged):
    """
    A paging container for iterating over a list of :class:`PrivateLinkResource <azure.mgmt.rdbms.mariadb.models.PrivateLinkResource>` object
    """
