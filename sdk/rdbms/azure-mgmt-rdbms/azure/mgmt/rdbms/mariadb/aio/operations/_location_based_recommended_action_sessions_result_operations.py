...
class LocationBasedRecommendedActionSessionsResultOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~maria_db_management_client.models.RecommendationActionsResultListor ~maria_db_management_client.models.RecommendationActionsResultList]
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.DBforMariaDB/locations/{locationName}/recommendedActionSessionsOperationResults/{operationId}'}  # type: ignore
