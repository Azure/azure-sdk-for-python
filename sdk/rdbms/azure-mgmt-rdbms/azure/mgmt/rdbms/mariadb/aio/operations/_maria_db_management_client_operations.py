...
class _MariaDBManagementClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], MariaDBManagementClientConfiguration]
):
    ...
    async def reset_query_performance_insight_data(
        ...
        deserialized = self._deserialize("QueryPerformanceInsightResetDataResult", pipeline_response.http_response)
    ...
    async def _create_recommended_action_session_initial(  # pylint: disable=name-too-long
