...
class LocationBasedRecommendedActionSessionsResultOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~maria_db_management_client.models.RecommendationActionsResultListor ~maria_db_management_client.models.RecommendationActionsResultList]
