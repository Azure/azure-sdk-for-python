...
from .._vendor import MariaDBManagementClientMixinABC, _convert_request, _format_url_section
...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DBforMariaDB/servers")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
    }
...
def build_start_request(resource_group_name: str, server_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_stop_request(resource_group_name: str, server_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ServersOperations:
    ...
    def _create_initial(
        self, resource_group_name: str, server_name: str, parameters: Union[_models.ServerForCreate, IO], **kwargs: Any
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "ServerForCreate")
    ...
    def begin_create(
        ...
        :param parameters: The required parameters for creating or updating a server. Is either a
         ServerForCreate type or a IO type. Required.
        :type parameters: ~azure.mgmt.rdbms.mariadb.models.ServerForCreate or IO
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        server_name: str,
        parameters: Union[_models.ServerUpdateParameters, IO],
        **kwargs: Any
    ) -> Optional[_models.Server]:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "ServerUpdateParameters")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param parameters: The required parameters for updating a server. Is either a
         ServerUpdateParameters type or a IO type. Required.
        :type parameters: ~azure.mgmt.rdbms.mariadb.models.ServerUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.Server"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.rdbms.mariadb.models.Server]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMariaDB/servers"
    }
    ...
    _restart_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMariaDB/servers/{serverName}/restart"
    }

    @distributed_trace
    def begin_restart(self, resource_group_name: str, server_name: str, **kwargs: Any) -> LROPoller[None]:
        """Restarts a server.
    ...
    _start_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMariaDB/servers/{serverName}/start"
    }
    ...
    _stop_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMariaDB/servers/{serverName}/stop"
    }
