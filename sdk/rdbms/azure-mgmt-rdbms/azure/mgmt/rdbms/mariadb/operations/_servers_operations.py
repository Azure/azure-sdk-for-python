...
class ServersOperations:
    ...
    def _create_initial(
        ...
        server_name: str,
        parameters: Union[_models.ServerForCreate, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.mariadb.models.ServerForCreate or IO[bytes]
        :return: An instance of LROPoller that returns either Server or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.mariadb.models.Server]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        server_name: str,
        parameters: Union[_models.ServerUpdateParameters, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.rdbms.mariadb.models.ServerUpdateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either Server or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.rdbms.mariadb.models.Server]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _restart_initial(self, resource_group_name: str, server_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
