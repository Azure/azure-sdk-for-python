...
# USAGE
    python long_term_retention_backup.py
...
def main():
    ...
    response = client.flexible_server.begin_start_ltr_backup(
        resource_group_name="rgLongTermRetention",
        server_name="pgsqlltrtestserver",
        parameters={"backupSettings": {"backupName": "backup1"}, "targetDetails": {"sasUriList": ["sasuri"]}},
    ).result()
    print(response)
