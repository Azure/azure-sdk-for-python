...
# USAGE
    python create_or_update_vault_with_customer_managed_keys.py
...
# x-ms-original-file: specification/recoveryservices/resource-manager/Microsoft.RecoveryServices/preview/2022-09-30-preview/examples/PUTVault_WithCMK.json
