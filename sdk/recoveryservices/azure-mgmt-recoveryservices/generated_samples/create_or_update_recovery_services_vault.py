...
# USAGE
    python create_or_update_recovery_services_vault.py
...
# x-ms-original-file: specification/recoveryservices/resource-manager/Microsoft.RecoveryServices/preview/2022-09-30-preview/examples/PUTVault.json
