...
# USAGE
    python gets_replication_usages_of_vault.py
...
# x-ms-original-file: specification/recoveryservices/resource-manager/Microsoft.RecoveryServices/preview/2022-09-30-preview/examples/ListReplicationUsages.json
