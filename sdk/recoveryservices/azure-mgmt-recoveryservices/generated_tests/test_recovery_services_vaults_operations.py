...
class TestRecoveryServicesVaultsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_vaults_begin_update(self, resource_group):
        response = self.client.vaults.begin_update(
            resource_group_name=resource_group.name,
            vault_name="str",
            vault={
                "etag": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_vaults_begin_delete(self, resource_group):
        response = self.client.vaults.begin_delete(
            resource_group_name=resource_group.name,
            vault_name="str",
        ).result()  # call '.result()' to poll until service return final result
