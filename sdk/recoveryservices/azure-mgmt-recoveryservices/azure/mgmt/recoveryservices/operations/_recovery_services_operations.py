...
class RecoveryServicesOperations:
    ...
    def capabilities(
        ...
        content_type = kwargs.pop("content_type", _headers.pop("Content-Type", None))  # type: Optional[str]
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.CapabilitiesResponse]
    ...
    capabilities.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.RecoveryServices/locations/{location}/capabilities"}  # type: ignore
