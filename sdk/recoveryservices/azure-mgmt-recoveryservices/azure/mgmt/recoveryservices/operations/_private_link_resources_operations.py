...
class PrivateLinkResourcesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.recoveryservices.models.PrivateLinkResourcePaged[~azure.mgmt.recoveryservices.models.PrivateLinkResource]
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/privateLinkResources'}

    def get(
            self, resource_group_name, vault_name, private_link_resource_name, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~azure.mgmt.recoveryservices.models.PrivateLinkResource or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/privateLinkResources/{privateLinkResourceName}'}
