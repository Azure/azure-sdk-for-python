...
from ._operations import DeletedVaultsOperations  # type: ignore
from ._operations import PrivateLinkResourcesOperations  # type: ignore
from ._operations import VaultCertificatesOperations  # type: ignore
from ._operations import RegisteredIdentitiesOperations  # type: ignore
from ._operations import ReplicationUsagesOperations  # type: ignore
from ._operations import UsagesOperations  # type: ignore
from ._operations import VaultExtendedInfoOperations  # type: ignore
from ._operations import RecoveryServicesOperations  # type: ignore
