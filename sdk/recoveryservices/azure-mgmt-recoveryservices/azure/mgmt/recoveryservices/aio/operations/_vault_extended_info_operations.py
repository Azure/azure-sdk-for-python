...
from ...operations._vault_extended_info_operations import (
...
class VaultExtendedInfoOperations:
    ...
    async def get(self, resource_group_name: str, vault_name: str, **kwargs: Any) -> _models.VaultExtendedInfoResource:
        ...
        )  # type: Literal["2022-09-30-preview"]
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param vault_name: The name of the recovery services vault. Required.
        :type vault_name: str
        :param resource_extended_info_details: Details of ResourceExtendedInfo. Is either a model type
        ...
        _json = None
        _content = None
        if isinstance(resource_extended_info_details, (IO, bytes)):
