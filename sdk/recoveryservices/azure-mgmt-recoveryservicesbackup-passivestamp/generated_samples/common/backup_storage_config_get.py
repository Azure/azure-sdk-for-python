...
def main():
    ...
    response = client.backup_resource_storage_configs.get(
...
# x-ms-original-file: specification/recoveryservicesbackup/resource-manager/Microsoft.RecoveryServices/stable/2021-11-15/examples/Common/BackupStorageConfig_Get.json
