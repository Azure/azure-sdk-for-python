...
class ProtectionContainerOperationResultsOperations(object):
    ...
    def get(
            self, vault_name, resource_group_name, fabric_name, container_name, operation_id, custom_headers=None, raw=False, **operation_config):
        ...
        :param container_name: Container name whose information should be
         fetched.
        ...
        return deserialized
    get.metadata = {'url': '/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}/operationResults/{operationId}'}
