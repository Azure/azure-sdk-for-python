...
def build_list_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}/protectedItems/{protectedItemName}/recoveryPointsRecommendedForMove')
...
class RecoveryPointsRecommendedForMoveOperations(object):
    ...
    def list(
        ...
        container_name,  # type: str
        protected_item_name,  # type: str
        parameters,  # type: "_models.ListRecoveryPointsRecommendedForMoveRequest"
        **kwargs  # type: Any
    ):
        ...
        :return: An iterator like instance of either RecoveryPointResourceList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.recoveryservicesbackup.models.RecoveryPointResourceList]
