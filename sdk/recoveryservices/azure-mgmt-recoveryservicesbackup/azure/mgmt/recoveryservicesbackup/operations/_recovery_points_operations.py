...
class RecoveryPointsOperations(object):
    ...
    def get_access_token(
        ...
        :type protected_item_name: str
        :param recovery_point_id: RecoveryPointId
        :type recovery_point_id: str
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
    ...
    def crr(
        ...
        return deserialized
    crr.metadata = {'url': '/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}/protectedItems/{protectedItemName}/recoveryPoints/'}
