...
def build_item_level_recovery_connections_list_instant_item_recovery_operation_result_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    vault_name: str,
    fabric_name: str,
    container_name: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}/protectedItems/{protectedItemName}/recoveryPoints/{recoveryPointId}/listInstantItemRecoveryOperationResult"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "vaultName": _SERIALIZER.url("vault_name", vault_name, "str"),
...
def build_recovery_services_backup_bms_prepare_data_move_request(  # pylint: disable=name-too-long
    vault_name: str, resource_group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_recovery_services_backup_bms_trigger_data_move_request(  # pylint: disable=name-too-long
    vault_name: str, resource_group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_recovery_services_backup_get_operation_status_request(  # pylint: disable=name-too-long
    vault_name: str, resource_group_name: str, operation_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_recovery_services_backup_move_recovery_point_request(  # pylint: disable=name-too-long
    vault_name: str,
    resource_group_name: str,
    fabric_name: str,
    container_name: str,
