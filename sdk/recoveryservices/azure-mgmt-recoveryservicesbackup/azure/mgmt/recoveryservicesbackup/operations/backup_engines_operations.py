...
class BackupEnginesOperations(object):
    ...
    def list(
        ...
        deserialized = models.BackupEngineBaseResourcePaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.BackupEngineBaseResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)
