...
def build_get_request(
    resource_group_name: str, vault_name: str, job_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class JobDetailsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, vault_name: str, job_name: str, **kwargs: Any) -> _models.JobResource:
