...
def build_get_request(
    resource_group_name: str, vault_name: str, policy_name: str, operation_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
class ProtectionPolicyOperationResultsOperations:  # pylint: disable=name-too-long
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, vault_name: str, policy_name: str, operation_id: str, **kwargs: Any
