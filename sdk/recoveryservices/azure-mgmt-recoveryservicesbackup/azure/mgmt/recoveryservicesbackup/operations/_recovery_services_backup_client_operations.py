...
class _RecoveryServicesBackupClientOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], RecoveryServicesBackupClientConfiguration]
):
    ...
    def begin_bms_prepare_data_move(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.recoveryservicesbackup.models.PrepareDataMoveRequest or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_bms_trigger_data_move(
        ...
        **kwargs: Any
        ...
        :param parameters: Trigger data move request. Is either a TriggerDataMoveRequest type or a
         IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.recoveryservicesbackup.models.TriggerDataMoveRequest or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
