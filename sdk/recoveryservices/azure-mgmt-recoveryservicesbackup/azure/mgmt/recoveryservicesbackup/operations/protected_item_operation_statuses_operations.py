...
class ProtectedItemOperationStatusesOperations(object):
    ...
    def get(
        ...
        :param operation_id: OperationID represents the operation whose status
         needs to be fetched.
        ...
        return deserialized
    get.metadata = {'url': '/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectionContainers/{containerName}/protectedItems/{protectedItemName}/operationsStatus/{operationId}'}
