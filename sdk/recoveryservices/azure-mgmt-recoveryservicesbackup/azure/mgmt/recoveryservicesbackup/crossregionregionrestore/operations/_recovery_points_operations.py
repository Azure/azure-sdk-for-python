...
class RecoveryPointsOperations(object):
    ...
    :type models: ~azure.mgmt.recoveryservicesbackup.crossregionregionrestore.models
    ...
    def get_access_token(
        ...
        **kwargs  # type: Any
        ...
        :type parameters:
         ~azure.mgmt.recoveryservicesbackup.crossregionregionrestore.models.AADPropertiesResource
        :keyword api_version: Api Version. The default value is "2018-12-20". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CrrAccessTokenResource, or the result of cls(response)
        :rtype:
         ~azure.mgmt.recoveryservicesbackup.crossregionregionrestore.models.CrrAccessTokenResource or
         None
