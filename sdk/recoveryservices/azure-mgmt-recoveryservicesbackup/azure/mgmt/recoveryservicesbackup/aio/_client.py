...
class RecoveryServicesBackupClient(
    ...
    :vartype backup_resource_storage_configs_non_crr:
     azure.mgmt.recoveryservicesbackup.aio.operations.BackupResourceStorageConfigsNonCRROperations
    ...
    :vartype bms_prepare_data_move_operation_result:
     azure.mgmt.recoveryservicesbackup.aio.operations.BMSPrepareDataMoveOperationResultOperations
    :ivar backup_resource_vault_configs: BackupResourceVaultConfigsOperations operations
    :vartype backup_resource_vault_configs:
     azure.mgmt.recoveryservicesbackup.aio.operations.BackupResourceVaultConfigsOperations
    ...
    :vartype backup_resource_encryption_configs:
     azure.mgmt.recoveryservicesbackup.aio.operations.BackupResourceEncryptionConfigsOperations
    :ivar protected_items: ProtectedItemsOperations operations
    :vartype protected_items:
     azure.mgmt.recoveryservicesbackup.aio.operations.ProtectedItemsOperations
    ...
    :vartype configure_source_scan:
     azure.mgmt.recoveryservicesbackup.aio.operations.ConfigureSourceScanOperations
    ...
    :vartype recovery_points_recommended_for_move:
     azure.mgmt.recoveryservicesbackup.aio.operations.RecoveryPointsRecommendedForMoveOperations
    ...
    :vartype protected_item_operation_statuses:
     azure.mgmt.recoveryservicesbackup.aio.operations.ProtectedItemOperationStatusesOperations
    ...
    :vartype protected_item_operation_results:
     azure.mgmt.recoveryservicesbackup.aio.operations.ProtectedItemOperationResultsOperations
    :ivar protection_containers: ProtectionContainersOperations operations
    :vartype protection_containers:
     azure.mgmt.recoveryservicesbackup.aio.operations.ProtectionContainersOperations
    :ivar backup_workload_items: BackupWorkloadItemsOperations operations
    :vartype backup_workload_items:
     azure.mgmt.recoveryservicesbackup.aio.operations.BackupWorkloadItemsOperations
    ...
    :vartype protection_container_operation_results:
     azure.mgmt.recoveryservicesbackup.aio.operations.ProtectionContainerOperationResultsOperations
    :ivar recovery_points: RecoveryPointsOperations operations
    :vartype recovery_points:
     azure.mgmt.recoveryservicesbackup.aio.operations.RecoveryPointsOperations
    ...
    :vartype item_level_recovery_connections:
     azure.mgmt.recoveryservicesbackup.aio.operations.ItemLevelRecoveryConnectionsOperations
    :ivar protection_policies: ProtectionPoliciesOperations operations
    :vartype protection_policies:
     azure.mgmt.recoveryservicesbackup.aio.operations.ProtectionPoliciesOperations
    :ivar backup_policies: BackupPoliciesOperations operations
    :vartype backup_policies:
     azure.mgmt.recoveryservicesbackup.aio.operations.BackupPoliciesOperations
    ...
    :vartype protection_policy_operation_results:
     azure.mgmt.recoveryservicesbackup.aio.operations.ProtectionPolicyOperationResultsOperations
    ...
    :vartype protection_policy_operation_statuses:
     azure.mgmt.recoveryservicesbackup.aio.operations.ProtectionPolicyOperationStatusesOperations
    ...
    :vartype feature_support:
     azure.mgmt.recoveryservicesbackup.aio.operations.FeatureSupportOperations
    :ivar backup_protection_intent: BackupProtectionIntentOperations operations
    :vartype backup_protection_intent:
     azure.mgmt.recoveryservicesbackup.aio.operations.BackupProtectionIntentOperations
    :ivar backup_usage_summaries: BackupUsageSummariesOperations operations
    :vartype backup_usage_summaries:
     azure.mgmt.recoveryservicesbackup.aio.operations.BackupUsageSummariesOperations
    ...
    :vartype backup_protected_items:
     azure.mgmt.recoveryservicesbackup.aio.operations.BackupProtectedItemsOperations
    :ivar validate_operation: ValidateOperationOperations operations
    :vartype validate_operation:
     azure.mgmt.recoveryservicesbackup.aio.operations.ValidateOperationOperations
    :ivar validate_operation_results: ValidateOperationResultsOperations operations
    :vartype validate_operation_results:
     azure.mgmt.recoveryservicesbackup.aio.operations.ValidateOperationResultsOperations
    :ivar validate_operation_statuses: ValidateOperationStatusesOperations operations
    :vartype validate_operation_statuses:
     azure.mgmt.recoveryservicesbackup.aio.operations.ValidateOperationStatusesOperations
    ...
    :vartype fetch_tiering_cost:
     azure.mgmt.recoveryservicesbackup.aio.operations.FetchTieringCostOperations
    ...
    :vartype get_tiering_cost_operation_result:
     azure.mgmt.recoveryservicesbackup.aio.operations.GetTieringCostOperationResultOperations
    :ivar tiering_cost_operation_status: TieringCostOperationStatusOperations operations
    :vartype tiering_cost_operation_status:
     azure.mgmt.recoveryservicesbackup.aio.operations.TieringCostOperationStatusOperations
    :ivar protection_intent: ProtectionIntentOperations operations
    :vartype protection_intent:
     azure.mgmt.recoveryservicesbackup.aio.operations.ProtectionIntentOperations
    :ivar private_endpoint_connection: PrivateEndpointConnectionOperations operations
    :vartype private_endpoint_connection:
     azure.mgmt.recoveryservicesbackup.aio.operations.PrivateEndpointConnectionOperations
    :ivar private_endpoint: PrivateEndpointOperations operations
    :vartype private_endpoint:
     azure.mgmt.recoveryservicesbackup.aio.operations.PrivateEndpointOperations
