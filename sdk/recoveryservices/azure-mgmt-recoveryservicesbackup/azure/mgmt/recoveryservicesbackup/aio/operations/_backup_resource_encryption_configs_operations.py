...
class BackupResourceEncryptionConfigsOperations:
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.recoveryservicesbackup.models.BackupResourceEncryptionConfigResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        body_content = self._serialize.body(parameters, 'BackupResourceEncryptionConfigResource')
