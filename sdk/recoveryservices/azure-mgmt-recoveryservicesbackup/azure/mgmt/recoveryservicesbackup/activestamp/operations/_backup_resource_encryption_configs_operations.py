...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupEncryptionConfigs/backupResourceEncryptionConfig')
...
class BackupResourceEncryptionConfigsOperations(object):
    ...
    def update(
        ...
        vault_name,  # type: str
        resource_group_name,  # type: str
        parameters,  # type: "_models.BackupResourceEncryptionConfigResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
