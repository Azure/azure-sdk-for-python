...
def build_validate_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/Subscriptions/{subscriptionId}/providers/Microsoft.RecoveryServices/locations/{azureRegion}/backupValidateFeatures')
...
class FeatureSupportOperations(object):
    ...
    def validate(
        self,
        azure_region,  # type: str
        parameters,  # type: "_models.FeatureSupportRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.AzureVMResourceFeatureSupportResponse"
