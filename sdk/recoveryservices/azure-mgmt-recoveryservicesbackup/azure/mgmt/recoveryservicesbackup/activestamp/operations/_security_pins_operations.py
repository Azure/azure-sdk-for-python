...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupSecurityPIN')
...
class SecurityPINsOperations(object):
    ...
    def get(
        ...
        vault_name,  # type: str
        resource_group_name,  # type: str
        parameters=None,  # type: Optional["_models.SecurityPinBase"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.TokenInformation"
