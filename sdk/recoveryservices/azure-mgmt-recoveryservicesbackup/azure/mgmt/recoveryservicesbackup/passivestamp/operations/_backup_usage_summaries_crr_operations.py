...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupUsageSummaries")  # pylint: disable=line-too-long
...
class BackupUsageSummariesCRROperations(object):
    ...
    def list(
        ...
        skip_token: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.BackupManagementUsageList"]:
        ...
        :return: An iterator like instance of either BackupManagementUsageList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.recoveryservicesbackup.passivestamp.models.BackupManagementUsageList]
