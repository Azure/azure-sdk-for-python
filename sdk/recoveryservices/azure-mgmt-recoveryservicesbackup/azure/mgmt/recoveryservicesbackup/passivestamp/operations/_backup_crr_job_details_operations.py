...
def build_get_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.CrrJobRequest] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.RecoveryServices/locations/{azureRegion}/backupCrrJob")  # pylint: disable=line-too-long
