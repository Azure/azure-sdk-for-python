...
class RecoveryServicesBackupClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long,docstring-keyword-should-match-keyword-only
    ...
    :keyword api_version: The API version to use for this operation. Known values are "2026-07-01"
     and None. Default value is "2026-07-01". Note that overriding this default value may result in
