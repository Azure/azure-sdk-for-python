...
### Features Added
  ...
  - Added model `ExistingRecoveryRecoveryResourceGroup`
  - Added model `InMageAzureV2SwitchProviderProviderInput`
  ...
  - Added model `SwitchProviderProviderSpecificInput`
...
### Breaking Changes
  ...
  - Deleted or renamed model `ExistingRecoveryResourceGroup`
  - Deleted or renamed model `FabricCollection`
  - Deleted or renamed model `FabricQueryParameter`
  - Deleted or renamed model `InMageAzureV2SwitchProviderInput`
  ...
  - Deleted or renamed model `SwitchProviderSpecificInput`
