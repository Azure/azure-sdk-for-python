...
### Breaking Changes
  ...
  - Method `AlertCollection.__init__` removed default value `None` from its parameter `value`
  - Method `ApplianceCollection.__init__` removed default value `None` from its parameter `value`
  - Method `ClusterRecoveryPointCollection.__init__` removed default value `None` from its parameter `value`
  - Method `EventCollection.__init__` removed default value `None` from its parameter `value`
  - Method `FabricCollection.__init__` removed default value `None` from its parameter `value`
  - Method `JobCollection.__init__` removed default value `None` from its parameter `value`
  - Method `LogicalNetworkCollection.__init__` removed default value `None` from its parameter `value`
  - Method `MigrationItemCollection.__init__` removed default value `None` from its parameter `value`
  - Method `MigrationRecoveryPointCollection.__init__` removed default value `None` from its parameter `value`
  - Method `NetworkCollection.__init__` removed default value `None` from its parameter `value`
  - Method `NetworkMappingCollection.__init__` removed default value `None` from its parameter `value`
  - Method `OperationsDiscoveryCollection.__init__` removed default value `None` from its parameter `value`
  - Method `PolicyCollection.__init__` removed default value `None` from its parameter `value`
  - Method `ProtectableItemCollection.__init__` removed default value `None` from its parameter `value`
  - Method `ProtectionContainerCollection.__init__` removed default value `None` from its parameter `value`
  - Method `ProtectionContainerMappingCollection.__init__` removed default value `None` from its parameter `value`
  - Method `RecoveryPlanCollection.__init__` removed default value `None` from its parameter `value`
  - Method `RecoveryPointCollection.__init__` removed default value `None` from its parameter `value`
  - Method `RecoveryServicesProviderCollection.__init__` removed default value `None` from its parameter `value`
  - Method `ReplicationProtectedItemCollection.__init__` removed default value `None` from its parameter `value`
  - Method `ReplicationProtectionClusterCollection.__init__` removed default value `None` from its parameter `value`
  - Method `ReplicationProtectionIntentCollection.__init__` removed default value `None` from its parameter `value`
  - Model `Resource` deleted or renamed its instance variable `location`
  - Method `StorageClassificationCollection.__init__` removed default value `None` from its parameter `value`
  - Method `StorageClassificationMappingCollection.__init__` removed default value `None` from its parameter `value`
  - Method `TargetComputeSizeCollection.__init__` removed default value `None` from its parameter `value`
  - Method `VCenterCollection.__init__` removed default value `None` from its parameter `value`
  - Method `VaultSettingCollection.__init__` removed default value `None` from its parameter `value`
