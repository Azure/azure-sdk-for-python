...
class Operations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either OperationsDiscoveryCollection or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.OperationsDiscoveryCollection]
