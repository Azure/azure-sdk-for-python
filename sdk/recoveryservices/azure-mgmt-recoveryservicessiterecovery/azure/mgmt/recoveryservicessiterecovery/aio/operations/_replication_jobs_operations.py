...
class ReplicationJobsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`replication_jobs` attribute.
    """
    ...
    async def _resume_initial(
        ...
        _json = None
        _content = None
        if isinstance(resume_job_params, (IO, bytes)):
            _content = resume_job_params
        else:
    ...
    async def begin_resume(
        ...
        :param job_name: Job identifier. Required.
        :type job_name: str
        :param resume_job_params: Resume rob comments. Is either a model type or a IO type. Required.
    ...
    async def _export_initial(
        ...
        _json = None
        _content = None
        if isinstance(job_query_parameter, (IO, bytes)):
            _content = job_query_parameter
        else:
    ...
    async def begin_export(
        ...
        :param job_query_parameter: job query filter. Is either a model type or a IO type. Required.
