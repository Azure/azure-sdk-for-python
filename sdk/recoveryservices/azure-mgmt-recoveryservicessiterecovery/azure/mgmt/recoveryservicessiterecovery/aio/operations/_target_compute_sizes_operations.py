...
class TargetComputeSizesOperations:
    """TargetComputeSizesOperations async operations.
    ...
    def list_by_replication_protected_items(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.TargetComputeSizeCollection"]:
        ...
        :return: An iterator like instance of either TargetComputeSizeCollection or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.TargetComputeSizeCollection]
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_by_replication_protected_items.metadata['url']  # type: ignore
