...
from ...operations._replication_storage_classification_mappings_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_replication_storage_classifications_request, build_list_request
T = TypeVar('T')
...
class ReplicationStorageClassificationMappingsOperations:
    ...
    def list_by_replication_storage_classifications(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either StorageClassificationMappingCollection or the
         result of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.StorageClassificationMappingCollection]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type pairing_input:
         ~azure.mgmt.recoveryservicessiterecovery.models.StorageClassificationMappingInput
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either StorageClassificationMapping or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.recoveryservicessiterecovery.models.StorageClassificationMapping]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-03-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
