...
from ...operations._replication_storage_classification_mappings_operations import (
    ...
    build_get_request,
    build_list_by_replication_storage_classifications_request,
    build_list_request,
)
...
class ReplicationStorageClassificationMappingsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`replication_storage_classification_mappings` attribute.
    """
    ...
    def list_by_replication_storage_classifications(
        ...
        :return: An iterator like instance of either StorageClassificationMapping or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.StorageClassificationMapping]
    ...
    async def _create_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(pairing_input, (IOBase, bytes)):
            _content = pairing_input
        else:
