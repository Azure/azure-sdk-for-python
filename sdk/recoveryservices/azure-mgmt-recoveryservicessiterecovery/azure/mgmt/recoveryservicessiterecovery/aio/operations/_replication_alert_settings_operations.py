...
from ...operations._replication_alert_settings_operations import build_create_request, build_get_request, build_list_request
T = TypeVar('T')
...
class ReplicationAlertSettingsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.AlertCollection]
