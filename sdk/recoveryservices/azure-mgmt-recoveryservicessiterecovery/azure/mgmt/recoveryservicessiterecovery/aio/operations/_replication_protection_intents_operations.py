...
class ReplicationProtectionIntentsOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.ReplicationProtectionIntent"]:
        ...
        :return: An iterator like instance of either ReplicationProtectionIntent or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.ReplicationProtectionIntent]
