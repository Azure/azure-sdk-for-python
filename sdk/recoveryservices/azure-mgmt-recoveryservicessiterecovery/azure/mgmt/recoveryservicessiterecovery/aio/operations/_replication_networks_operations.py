...
from ...operations._replication_networks_operations import build_get_request, build_list_by_replication_fabrics_request, build_list_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class ReplicationNetworksOperations:
    """ReplicationNetworksOperations async operations.
    ...
    def list_by_replication_fabrics(
        ...
        fabric_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.NetworkCollection"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.NetworkCollection]
