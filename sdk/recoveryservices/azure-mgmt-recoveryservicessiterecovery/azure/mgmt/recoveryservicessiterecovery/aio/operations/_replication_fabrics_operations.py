...
from ...operations._replication_fabrics_operations import build_check_consistency_request_initial, build_create_request_initial, build_delete_request_initial, build_get_request, build_list_request, build_migrate_to_aad_request_initial, build_purge_request_initial, build_reassociate_gateway_request_initial, build_renew_certificate_request_initial
T = TypeVar('T')
...
class ReplicationFabricsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.FabricCollection]
    ...
    @distributed_trace_async
    async def begin_migrate_to_aad(  # pylint: disable=inconsistent-return-statements
        self,
        fabric_name: str,
        **kwargs: Any
    ) -> AsyncLROPoller[None]:
