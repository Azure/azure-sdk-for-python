...
class ReplicationvCentersOperations:
    """ReplicationvCentersOperations async operations.
    ...
    def list_by_replication_fabrics(
        ...
        fabric_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.VCenterCollection"]:
        ...
        :return: An iterator like instance of either VCenterCollection or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.VCenterCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.VCenterCollection"]
        error_map = {
    ...
    list_by_replication_fabrics.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationvCenters'}  # type: ignore
    ...
    async def _create_initial(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.VCenter"]]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        body_content = self._serialize.body(add_v_center_request, 'AddVCenterRequest')
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.recoveryservicessiterecovery.models.VCenter]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    begin_create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationvCenters/{vcenterName}'}  # type: ignore
    ...
    async def begin_delete(
        ...
        **kwargs: Any
        ...
        if cont_token:
            ...
            return AsyncLROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationvCenters/{vcenterName}'}  # type: ignore
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(update_v_center_request, 'UpdateVCenterRequest')
        body_content_kwargs['content'] = body_content
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type update_v_center_request: ~azure.mgmt.recoveryservicessiterecovery.models.UpdateVCenterRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
        ...
        if cont_token:
            ...
            return AsyncLROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationvCenters/{vcenterName}'}  # type: ignore
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationvCenters'}  # type: ignore
