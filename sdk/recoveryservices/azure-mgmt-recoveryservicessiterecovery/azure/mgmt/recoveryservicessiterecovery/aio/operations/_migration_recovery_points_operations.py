...
class MigrationRecoveryPointsOperations:
    ...
    def list_by_replication_migration_items(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either MigrationRecoveryPointCollection or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.MigrationRecoveryPointCollection]
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_by_replication_migration_items.metadata['url']  # type: ignore
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        path_format_arguments = {
            ...
            'protectionContainerName': self._serialize.url("protection_container_name", protection_container_name, 'str'),
            'migrationItemName': self._serialize.url("migration_item_name", migration_item_name, 'str'),
            'migrationRecoveryPointName': self._serialize.url("migration_recovery_point_name", migration_recovery_point_name, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
