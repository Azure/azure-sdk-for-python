...
class ReplicationPoliciesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`replication_policies` attribute.
    """
    ...
    @distributed_trace
    def list(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> AsyncItemPaged["_models.Policy"]:
    ...
    async def get(
        self, resource_group_name: str, resource_name: str, policy_name: str, **kwargs: Any
    ) -> _models.Policy:
    ...
    async def _create_initial(
        ...
        resource_name: str,
        policy_name: str,
        input: Union[_models.CreatePolicyInput, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def _update_initial(
        ...
        resource_name: str,
        policy_name: str,
        input: Union[_models.UpdatePolicyInput, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
