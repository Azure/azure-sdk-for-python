...
from ...operations._replication_recovery_services_providers_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_replication_fabrics_request, build_list_request, build_purge_request_initial, build_refresh_provider_request_initial
T = TypeVar('T')
...
class ReplicationRecoveryServicesProvidersOperations:
    ...
    def list_by_replication_fabrics(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either RecoveryServicesProviderCollection or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.RecoveryServicesProviderCollection]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.recoveryservicessiterecovery.models.RecoveryServicesProvider]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2022-03-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    async def _refresh_provider_initial(
        ...
        **kwargs: Any
        ...
        request = build_refresh_provider_request_initial(
            resource_name=self._config.resource_name,
            resource_group_name=self._config.resource_group_name,
            subscription_id=self._config.subscription_id,
            fabric_name=fabric_name,
