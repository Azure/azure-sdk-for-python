...
def build_reinstall_mobility_service_request(
    resource_group_name: str,
    resource_name: str,
    fabric_name: str,
    protection_container_name: str,
    ...
    **kwargs: Any
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectedItems/{replicatedProtectedItemName}/reinstallMobilityService",
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url(
        ...
        "protectionContainerName": _SERIALIZER.url(
            "protection_container_name", protection_container_name, "str", pattern=r".*"
        ),
        "replicatedProtectedItemName": _SERIALIZER.url(
...
class ReplicationProtectedItemsOperations:  # pylint: disable=too-many-public-methods
    ...
    def list_by_replication_protection_containers(  # pylint: disable=name-too-long
        ...
        protection_container_name: str,
        **kwargs: Any
    ) -> ItemPaged["_models.ReplicationProtectedItem"]:
    ...
    def _reinstall_mobility_service_initial(
        self,
        resource_group_name: str,
        resource_name: str,
        fabric_name: str,
    ...
    def begin_reinstall_mobility_service(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._reinstall_mobility_service_initial(
                resource_group_name=resource_group_name,
                resource_name=resource_name,
                fabric_name=fabric_name,
                protection_container_name=protection_container_name,
