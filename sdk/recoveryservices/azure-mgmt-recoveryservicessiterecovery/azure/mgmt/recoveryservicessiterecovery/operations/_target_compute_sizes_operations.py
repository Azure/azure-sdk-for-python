...
class TargetComputeSizesOperations(object):
    ...
    def list_by_replication_protected_items(
        ...
        replicated_protected_item_name: str,
        **kwargs: Any
    ) -> Iterable["_models.TargetComputeSizeCollection"]:
        ...
        :return: An iterator like instance of either TargetComputeSizeCollection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.TargetComputeSizeCollection]
