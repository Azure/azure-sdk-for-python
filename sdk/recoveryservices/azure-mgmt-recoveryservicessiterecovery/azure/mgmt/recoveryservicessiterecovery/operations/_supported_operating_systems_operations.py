...
def build_get_request(
    ...
    **kwargs: Any
    ...
    if instance_type is not None:
        _params["instanceType"] = _SERIALIZER.query("instance_type", instance_type, "str")
...
class SupportedOperatingSystemsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`supported_operating_systems` attribute.
    """
    ...
    @distributed_trace
    def get(self, instance_type: Optional[str] = None, **kwargs: Any) -> _models.SupportedOperatingSystems:
