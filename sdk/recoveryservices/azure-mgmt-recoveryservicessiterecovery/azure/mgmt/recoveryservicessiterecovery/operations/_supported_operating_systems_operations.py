...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationSupportedOperatingSystems")  # pylint: disable=line-too-long
    ...
    if instance_type is not None:
        _query_parameters['instanceType'] = _SERIALIZER.query("instance_type", instance_type, 'str')
