...
class ReplicationProtectionIntentsOperations(object):
    ...
    def list(
        ...
        take_token=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["_models.ReplicationProtectionIntentCollection"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.ReplicationProtectionIntentCollection]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.ReplicationProtectionIntent"
    ...
    def create(
        self,
        intent_object_name,  # type: str
        input,  # type: "_models.CreateProtectionIntentInput"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ReplicationProtectionIntent"
