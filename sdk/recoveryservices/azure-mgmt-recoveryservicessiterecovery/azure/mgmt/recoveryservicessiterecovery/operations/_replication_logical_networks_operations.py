...
class ReplicationLogicalNetworksOperations(object):
    ...
    def list_by_replication_fabrics(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.LogicalNetworkCollection"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.LogicalNetworkCollection]
    ...
    def get(
        self,
        fabric_name,  # type: str
        logical_network_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.LogicalNetwork"
