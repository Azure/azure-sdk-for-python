...
class ReplicationPoliciesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.PolicyCollection"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.PolicyCollection]
    ...
    def _create_initial(
        self,
        policy_name,  # type: str
        input,  # type: "_models.CreatePolicyInput"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.Policy"]
    ...
    def _update_initial(
        self,
        policy_name,  # type: str
        input,  # type: "_models.UpdatePolicyInput"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.Policy"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.Policy"]]
