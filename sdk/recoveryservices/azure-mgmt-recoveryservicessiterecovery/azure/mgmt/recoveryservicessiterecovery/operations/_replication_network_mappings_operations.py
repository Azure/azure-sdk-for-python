...
class ReplicationNetworkMappingsOperations(object):
    ...
    def list_by_replication_networks(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.NetworkMappingCollection"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.NetworkMappingCollection]
    ...
    def get(
        ...
        fabric_name,  # type: str
        network_name,  # type: str
        network_mapping_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.NetworkMapping"
    ...
    def _create_initial(
        ...
        network_name,  # type: str
        network_mapping_name,  # type: str
        input,  # type: "_models.CreateNetworkMappingInput"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.NetworkMapping"]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.NetworkMapping"]
        ...
        :return: An instance of LROPoller that returns either NetworkMapping or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.recoveryservicessiterecovery.models.NetworkMapping]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        network_name,  # type: str
        network_mapping_name,  # type: str
        input,  # type: "_models.UpdateNetworkMappingInput"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.NetworkMapping"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.NetworkMapping"]]
