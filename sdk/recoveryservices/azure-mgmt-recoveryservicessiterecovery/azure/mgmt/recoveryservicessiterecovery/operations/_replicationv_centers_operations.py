...
class ReplicationvCentersOperations(object):
    ...
    def list_by_replication_fabrics(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.VCenterCollection"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.VCenterCollection]
    ...
    def _create_initial(
        ...
        fabric_name,  # type: str
        vcenter_name,  # type: str
        add_v_center_request,  # type: "_models.AddVCenterRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.VCenter"]
    ...
    def _update_initial(
        ...
        fabric_name,  # type: str
        vcenter_name,  # type: str
        update_v_center_request,  # type: "_models.UpdateVCenterRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.VCenter"]
        cls = kwargs.pop('cls', None)  # type: ClsType[Optional["_models.VCenter"]]
