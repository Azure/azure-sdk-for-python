...
def build_get_request(
    resource_group_name: str, resource_name: str, vault_setting_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ReplicationVaultSettingOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`replication_vault_setting` attribute.
    """
    ...
    @distributed_trace
    def list(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> ItemPaged["_models.VaultSetting"]:
