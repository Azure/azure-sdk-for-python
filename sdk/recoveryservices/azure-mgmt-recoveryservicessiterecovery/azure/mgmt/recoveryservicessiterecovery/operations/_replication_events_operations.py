...
def build_get_request(
    resource_group_name: str, resource_name: str, event_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ReplicationEventsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, resource_name: str, event_name: str, **kwargs: Any) -> _models.Event:
