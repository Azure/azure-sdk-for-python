...
class MigrationRecoveryPointsOperations(object):
    ...
    def list_by_replication_migration_items(
        ...
        migration_item_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["_models.MigrationRecoveryPointCollection"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.recoveryservicessiterecovery.models.MigrationRecoveryPointCollection]
    ...
    def get(
        ...
        protection_container_name,  # type: str
        migration_item_name,  # type: str
        migration_recovery_point_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.MigrationRecoveryPoint"
