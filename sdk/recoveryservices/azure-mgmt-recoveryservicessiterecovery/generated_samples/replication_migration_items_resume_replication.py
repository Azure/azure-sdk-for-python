...
# USAGE
    python replication_migration_items_resume_replication.py
...
def main():
    ...
    response = client.replication_migration_items.begin_resume_replication(
...
# x-ms-original-file: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/SiteRecovery/stable/2026-01-01/examples/ReplicationMigrationItems_ResumeReplication.json
