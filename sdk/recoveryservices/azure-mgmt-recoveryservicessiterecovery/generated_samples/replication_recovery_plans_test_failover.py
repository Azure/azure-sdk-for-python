...
# USAGE
    python replication_recovery_plans_test_failover.py
...
def main():
    ...
    response = client.replication_recovery_plans.begin_test_failover(
...
# x-ms-original-file: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/SiteRecovery/stable/2026-01-01/examples/ReplicationRecoveryPlans_TestFailover.json
