...
# USAGE
    python replication_protected_items_test_failover.py
...
def main():
    ...
    response = client.replication_protected_items.begin_test_failover(
...
# x-ms-original-file: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/SiteRecovery/stable/2026-01-01/examples/ReplicationProtectedItems_TestFailover.json
