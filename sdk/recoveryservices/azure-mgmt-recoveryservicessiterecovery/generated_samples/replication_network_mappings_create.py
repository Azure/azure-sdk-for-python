...
# USAGE
    python replication_network_mappings_create.py
...
def main():
    ...
    response = client.replication_network_mappings.begin_create(
...
# x-ms-original-file: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/SiteRecovery/stable/2026-01-01/examples/ReplicationNetworkMappings_Create.json
