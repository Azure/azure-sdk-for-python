...
# USAGE
    python replication_protected_items_switch_provider.py
...
def main():
    ...
    response = client.replication_protected_items.begin_switch_provider(
...
# x-ms-original-file: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/SiteRecovery/stable/2026-01-01/examples/ReplicationProtectedItems_SwitchProvider.json
