...
# USAGE
    python replication_protected_items_apply_recovery_point.py
...
def main():
    ...
    response = client.replication_protected_items.begin_apply_recovery_point(
...
# x-ms-original-file: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/SiteRecovery/stable/2026-01-01/examples/ReplicationProtectedItems_ApplyRecoveryPoint.json
