...
# USAGE
    python replication_storage_classification_mappings_create.py
...
def main():
    ...
    response = client.replication_storage_classification_mappings.begin_create(
...
# x-ms-original-file: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/SiteRecovery/stable/2026-01-01/examples/ReplicationStorageClassificationMappings_Create.json
