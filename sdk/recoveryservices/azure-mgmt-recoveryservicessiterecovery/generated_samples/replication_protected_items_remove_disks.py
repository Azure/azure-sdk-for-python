...
# USAGE
    python replication_protected_items_remove_disks.py
...
def main():
    ...
    response = client.replication_protected_items.begin_remove_disks(
...
# x-ms-original-file: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/SiteRecovery/stable/2026-01-01/examples/ReplicationProtectedItems_RemoveDisks.json
