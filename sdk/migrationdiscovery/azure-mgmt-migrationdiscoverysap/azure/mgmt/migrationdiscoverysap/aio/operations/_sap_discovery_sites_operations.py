...
from ...operations._sap_discovery_sites_operations import (
    build_create_request,
    build_delete_request,
    build_get_request,
    build_import_entities_request,
...
class SapDiscoverySitesOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.SAPDiscoverySite"]:
        ...
        :return: An iterator like instance of either SAPDiscoverySite or the result of cls(response)
        :rtype:
        ...
        cls: ClsType[_models.SAPDiscoverySiteListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("SAPDiscoverySiteListResult", pipeline_response)
    ...
    list_by_subscription.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.Workloads/sapDiscoverySites"
    }
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/sapDiscoverySites"
    }
    ...
    async def get(
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SAPDiscoverySite or the result of cls(response)
        ...
        deserialized = self._deserialize("SAPDiscoverySite", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/sapDiscoverySites/{sapDiscoverySiteName}"
    }
    ...
    async def _create_initial(
        ...
        resource: Union[_models.SAPDiscoverySite, IO],
        **kwargs: Any
    ) -> _models.SAPDiscoverySite:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "SAPDiscoverySite")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either SAPDiscoverySite or the result of
         cls(response)
        :rtype:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param sap_discovery_site_name: The name of the discovery site resource for SAP Migration.
         Required.
        :type sap_discovery_site_name: str
        :param resource: Resource create parameters. Is either a SAPDiscoverySite type or a IO type.
         Required.
        :type resource: ~azure.mgmt.migrationdiscoverysap.models.SAPDiscoverySite or IO
    ...
    async def update(
        ...
        resource_group_name: str,
        sap_discovery_site_name: str,
        properties: Union[_models.SAPDiscoverySiteTagsUpdate, IO],
        **kwargs: Any
    ) -> _models.SAPDiscoverySite:
        """Updates a SAP Migration discovery site resource.
        ...
        :type properties: ~azure.mgmt.migrationdiscoverysap.models.SAPDiscoverySiteTagsUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "SAPDiscoverySiteTagsUpdate")
    ...
    async def _import_entities_initial(
        ...
        request = build_import_entities_request(
            resource_group_name=resource_group_name,
            sap_discovery_site_name=sap_discovery_site_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self._import_entities_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _import_entities_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/sapDiscoverySites/{sapDiscoverySiteName}/importEntities"
    }
    ...
    begin_import_entities.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/sapDiscoverySites/{sapDiscoverySiteName}/importEntities"
    }
