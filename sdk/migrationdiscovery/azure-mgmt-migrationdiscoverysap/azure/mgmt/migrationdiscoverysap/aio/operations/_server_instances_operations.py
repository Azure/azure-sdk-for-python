...
from ...operations._server_instances_operations import (
...
class ServerInstancesOperations:
    ...
    def list_by_sap_instance(
        ...
        :return: An iterator like instance of either ServerInstance or the result of cls(response)
        :rtype:
        ...
        cls: ClsType[_models.ServerInstanceListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("ServerInstanceListResult", pipeline_response)
    ...
    list_by_sap_instance.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/sapDiscoverySites/{sapDiscoverySiteName}/sapInstances/{sapInstanceName}/serverInstances"
    }
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ServerInstance or the result of cls(response)
        ...
        deserialized = self._deserialize("ServerInstance", pipeline_response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/sapDiscoverySites/{sapDiscoverySiteName}/sapInstances/{sapInstanceName}/serverInstances/{serverInstanceName}"
    }
    ...
    async def _create_initial(
        ...
        sap_instance_name: str,
        server_instance_name: str,
        resource: Union[_models.ServerInstance, IO],
        **kwargs: Any
    ) -> _models.ServerInstance:
        error_map = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "ServerInstance")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        """Creates the Server Instance resource. :code:`<br>`:code:`<br>`;This will be used by service
        ...
        :return: An instance of AsyncLROPoller that returns either ServerInstance or the result of
         cls(response)
        :rtype:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param server_instance_name: The name of the Server instance resource for SAP Migration.
         Required.
        :type server_instance_name: str
        :param resource: Resource create parameters. Is either a ServerInstance type or a IO type.
         Required.
        :type resource: ~azure.mgmt.migrationdiscoverysap.models.ServerInstance or IO
    ...
    async def update(
        ...
        sap_instance_name: str,
        server_instance_name: str,
        properties: Union[_models.UpdateServerInstanceRequest, IO],
        **kwargs: Any
    ) -> _models.ServerInstance:
        """Updates the Server Instance resource. This operation on a resource by end user will return a
        Bad Request error.
        ...
        :type properties: ~azure.mgmt.migrationdiscoverysap.models.UpdateServerInstanceRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "UpdateServerInstanceRequest")
    ...
    async def begin_delete(
        ...
        **kwargs: Any
        ...
        """Deletes the Server Instance resource. :code:`<br>`:code:`<br>`;This will be used by service
        only. Delete operation on this resource by end user will return a Bad Request error. You can
        delete the parent resource, which is the SAP Migration discovery site resource, using the
