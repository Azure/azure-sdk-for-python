...
# USAGE
    python sap_discovery_sites_create.py
...
def main():
    ...
    response = client.sap_discovery_sites.begin_create(
        resource_group_name="test-rg",
        sap_discovery_site_name="SampleSite",
        resource={
            "location": "eastus",
            "properties": {"masterSiteId": "MasterSiteIdResourceId", "migrateProjectId": "MigrateProjectId"},
