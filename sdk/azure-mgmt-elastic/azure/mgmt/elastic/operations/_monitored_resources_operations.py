...
class MonitoredResourcesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.elastic.models.MonitoredResourcePaged[~azure.mgmt.elastic.models.MonitoredResource]
        :raises:
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Elastic/monitors/{monitorName}/listMonitoredResources'}
