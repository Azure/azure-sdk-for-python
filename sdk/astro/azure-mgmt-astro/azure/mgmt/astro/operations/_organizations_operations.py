...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Astronomer.Astro/organizations")
...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "organizationName": _SERIALIZER.url(
            "organization_name",
            organization_name,
            "str",
            max_length=50,
...
class OrganizationsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.OrganizationResource"]:
        ...
        :return: An iterator like instance of either OrganizationResource or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.astro.models.OrganizationResource]
    ...
    list_by_subscription.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Astronomer.Astro/organizations"}
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Astronomer.Astro/organizations"
    }
    ...
    def get(self, resource_group_name: str, organization_name: str, **kwargs: Any) -> _models.OrganizationResource:
        ...
        :rtype: ~azure.mgmt.astro.models.OrganizationResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Astronomer.Astro/organizations/{organizationName}"
    }
    ...
    def _create_or_update_initial(
        ...
        resource: Union[_models.OrganizationResource, IO],
        **kwargs: Any
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "OrganizationResource")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.astro.models.OrganizationResource
        ...
        :return: An instance of LROPoller that returns either OrganizationResource or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.astro.models.OrganizationResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param organization_name: Name of the Organizations resource. Required.
        :type organization_name: str
        :param resource: Resource create parameters. Is either a OrganizationResource type or a IO
         type. Required.
        :type resource: ~azure.mgmt.astro.models.OrganizationResource or IO
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        organization_name: str,
        properties: Union[_models.OrganizationResourceUpdate, IO],
        **kwargs: Any
    ) -> Optional[_models.OrganizationResource]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.OrganizationResource]] = kwargs.pop("cls", None)
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "OrganizationResourceUpdate")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.astro.models.OrganizationResourceUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.astro.models.OrganizationResourceUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
