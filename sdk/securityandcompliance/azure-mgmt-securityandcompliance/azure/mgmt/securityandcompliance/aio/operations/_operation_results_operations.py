...
class OperationResultsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.securityandcompliance.models.OperationResultsDescription
    ...
    get.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.SecurityAndCompliance/locations/{locationName}/operationresults/{operationResultId}'}  # type: ignore
