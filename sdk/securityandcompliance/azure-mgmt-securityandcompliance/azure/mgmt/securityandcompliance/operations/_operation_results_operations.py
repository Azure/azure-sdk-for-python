...
class OperationResultsOperations(object):
    ...
    def get(
        ...
        :return: OperationResultsDescription or ClientRawResponse if raw=true
        :rtype:
         ~azure.mgmt.securityandcompliance.models.OperationResultsDescription
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.SecurityAndCompliance/locations/{locationName}/operationresults/{operationResultId}'}
