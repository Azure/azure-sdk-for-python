...
class PrivateEndpointConnectionsForEDMOperations(object):
    ...
    def list_by_service(
        ...
        :rtype:
         ~azure.mgmt.securityandcompliance.models.PrivateEndpointConnectionPaged[~azure.mgmt.securityandcompliance.models.PrivateEndpointConnection]
        :raises:
        ...
        return deserialized
    list_by_service.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecurityAndCompliance/privateLinkServicesForEDMUpload/{resourceName}/privateEndpointConnections'}
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.securityandcompliance.models.PrivateEndpointConnection or
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecurityAndCompliance/privateLinkServicesForEDMUpload/{resourceName}/privateEndpointConnections/{privateEndpointConnectionName}'}
    ...
    def create_or_update(
        ...
        :type properties:
         ~azure.mgmt.securityandcompliance.models.PrivateEndpointConnection
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.securityandcompliance.models.PrivateEndpointConnection]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.securityandcompliance.models.PrivateEndpointConnection]]
        :raises:
         :class:`ErrorDetailsException<azure.mgmt.securityandcompliance.models.ErrorDetailsException>`
        """
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecurityAndCompliance/privateLinkServicesForEDMUpload/{resourceName}/privateEndpointConnections/{privateEndpointConnectionName}'}
    ...
    def delete(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecurityAndCompliance/privateLinkServicesForEDMUpload/{resourceName}/privateEndpointConnections/{privateEndpointConnectionName}'}
