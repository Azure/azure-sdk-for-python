...
from azure.mgmt.azuresphere import AzureSphereManagementClient

"""
# PREREQUISITES
    pip install azure-identity
    pip install azure-mgmt-azuresphere
# USAGE
    python post_count_devices_device_group.py
...
def main():
    client = AzureSphereManagementClient(
        credential=DefaultAzureCredential(),
        subscription_id="00000000-0000-0000-0000-000000000000",
    )

    response = client.device_groups.count_devices(
