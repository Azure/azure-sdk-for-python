...
class ProductsOperations:
    ...
    def list_by_catalog(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.azuresphere.models.Product]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Product or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azuresphere.models.Product]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
