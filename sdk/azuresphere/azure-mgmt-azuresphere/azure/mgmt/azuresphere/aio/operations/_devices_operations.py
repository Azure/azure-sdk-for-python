...
from ...operations._devices_operations import (
    ...
    build_generate_capability_image_request,
    build_get_request,
...
class DevicesOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Device or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azuresphere.models.Device]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_generate_capability_image(
        ...
        **kwargs: Any
        ...
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no
         Retry-After header is present.
        :return: An instance of AsyncLROPoller that returns either SignedCapabilityImageResponse or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.azuresphere.models.SignedCapabilityImageResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
