...
class Resource(_serialization.Model):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.azuresphere.models.SystemData
    """
...
class Catalog(TrackedResource):
    ...
    :vartype provisioning_state: str or ~azure.mgmt.azuresphere.models.ProvisioningState
    """
...
class CatalogListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.azuresphere.models.Catalog]
    ...
    def __init__(self, *, value: List["_models.Catalog"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.azuresphere.models.Catalog]
...
class Certificate(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar status: The certificate status. Known values are: "Active", "Inactive", "Expired", and
     "Revoked".
    :vartype status: str or ~azure.mgmt.azuresphere.models.CertificateStatus
...
class CertificateListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.azuresphere.models.Certificate]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.Certificate"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.azuresphere.models.Certificate]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class Deployment(ProxyResource):
    ...
    :vartype deployed_images: list[~azure.mgmt.azuresphere.models.Image]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype deployed_images: list[~azure.mgmt.azuresphere.models.Image]
        """
        super().__init__(**kwargs)
...
class DeploymentListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.azuresphere.models.Deployment]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.Deployment"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.azuresphere.models.Deployment]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class DeviceGroup(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar os_feed_type: Operating system feed type of the device group. Known values are: "Retail"
     and "RetailEval".
    :vartype os_feed_type: str or ~azure.mgmt.azuresphere.models.OSFeedType
    :ivar update_policy: Update policy of the device group. Known values are: "UpdateAll" and
     "No3rdPartyAppUpdates".
    :vartype update_policy: str or ~azure.mgmt.azuresphere.models.UpdatePolicy
    ...
    :vartype allow_crash_dumps_collection: str or
     ~azure.mgmt.azuresphere.models.AllowCrashDumpCollection
    :ivar regional_data_boundary: Regional data boundary for the device group. Known values are:
     "None" and "EU".
    :vartype regional_data_boundary: str or ~azure.mgmt.azuresphere.models.RegionalDataBoundary
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype os_feed_type: str or ~azure.mgmt.azuresphere.models.OSFeedType
        :keyword update_policy: Update policy of the device group. Known values are: "UpdateAll" and
         "No3rdPartyAppUpdates".
        :paramtype update_policy: str or ~azure.mgmt.azuresphere.models.UpdatePolicy
        ...
        :keyword regional_data_boundary: Regional data boundary for the device group. Known values are:
         "None" and "EU".
        :paramtype regional_data_boundary: str or ~azure.mgmt.azuresphere.models.RegionalDataBoundary
        """
        super().__init__(**kwargs)
...
class DeviceGroupListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.azuresphere.models.DeviceGroup]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.DeviceGroup"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.azuresphere.models.DeviceGroup]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class DeviceListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.azuresphere.models.Device]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.Device"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.azuresphere.models.Device]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.azuresphere.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.azuresphere.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.azuresphere.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.azuresphere.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class GenerateCapabilityImageRequest(_serialization.Model):
    ...
    :vartype capabilities: list[str or ~azure.mgmt.azuresphere.models.CapabilityType]
    """
    ...
    def __init__(self, *, capabilities: List[Union[str, "_models.CapabilityType"]], **kwargs: Any) -> None:
        ...
        :paramtype capabilities: list[str or ~azure.mgmt.azuresphere.models.CapabilityType]
        """
        super().__init__(**kwargs)
...
class Image(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype image_type: str or ~azure.mgmt.azuresphere.models.ImageType
    :ivar provisioning_state: The status of the last operation. Known values are: "Succeeded",
     "Failed", "Canceled", "Provisioning", "Updating", "Deleting", and "Accepted".
    :vartype provisioning_state: str or ~azure.mgmt.azuresphere.models.ProvisioningState
    """
...
class ImageListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.azuresphere.models.Image]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.Image"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.azuresphere.models.Image]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.azuresphere.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.azuresphere.models.Origin
    :ivar action_type: Enum. Indicates the action type. "Internal" refers to actions that are for
     internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.azuresphere.models.ActionType
    """
    ...
    def __init__(self, *, display: Optional["_models.OperationDisplay"] = None, **kwargs: Any) -> None:
        ...
        :paramtype display: ~azure.mgmt.azuresphere.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name = None
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.azuresphere.models.Operation]
...
class PagedDeviceInsight(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.azuresphere.models.DeviceInsight]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.DeviceInsight"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.azuresphere.models.DeviceInsight]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ProductListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.azuresphere.models.Product]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.Product"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.azuresphere.models.Product]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.azuresphere.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or ~azure.mgmt.azuresphere.models.CreatedByType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~azure.mgmt.azuresphere.models.CreatedByType
        ...
        :paramtype last_modified_by_type: str or ~azure.mgmt.azuresphere.models.CreatedByType
