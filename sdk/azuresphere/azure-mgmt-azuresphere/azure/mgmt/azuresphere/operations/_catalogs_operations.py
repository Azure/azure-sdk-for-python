...
class CatalogsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.Catalog"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.azuresphere.models.Catalog]
    ...
    def get(self, resource_group_name: str, catalog_name: str, **kwargs: Any) -> _models.Catalog:
        ...
        :rtype: ~azure.mgmt.azuresphere.models.Catalog
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.azuresphere.models.Catalog
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.azuresphere.models.Catalog]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        :type resource: ~azure.mgmt.azuresphere.models.Catalog or IO
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.azuresphere.models.CatalogUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update(
        ...
        :param properties: The resource properties to be updated. Is either a CatalogUpdate type or a
         IO type. Required.
        :type properties: ~azure.mgmt.azuresphere.models.CatalogUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_deployments(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.azuresphere.models.Deployment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_device_groups(
        ...
        **kwargs: Any
        ...
        :type list_device_groups_request: ~azure.mgmt.azuresphere.models.ListDeviceGroupsRequest
        :param filter: Filter the result list using the given expression. Default value is None.
        :type filter: str
        :param top: The number of result items to return. Default value is None.
        :type top: int
    ...
    def list_device_groups(
        ...
        **kwargs: Any
        ...
        :type list_device_groups_request: ~azure.mgmt.azuresphere.models.ListDeviceGroupsRequest or IO
        :param filter: Filter the result list using the given expression. Default value is None.
        :type filter: str
        :param top: The number of result items to return. Default value is None.
        :type top: int
        ...
        _json = None
        _content = None
        if isinstance(list_device_groups_request, (IO, bytes)):
    ...
    def list_device_insights(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.azuresphere.models.DeviceInsight]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
