...
def build_claim_devices_request(
    resource_group_name: str,
    catalog_name: str,
    product_name: str,
    device_group_name: str,
...
class DeviceGroupsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.azuresphere.AzureSphereManagementClient`'s
    ...
    def list_by_product(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.azuresphere.models.DeviceGroup]
    ...
    list_by_product.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureSphere/catalogs/{catalogName}/products/{productName}/deviceGroups"
    }
    ...
    def get(
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DeviceGroup or the result of cls(response)
        :rtype: ~azure.mgmt.azuresphere.models.DeviceGroup
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureSphere/catalogs/{catalogName}/products/{productName}/deviceGroups/{deviceGroupName}"
    }
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.azuresphere.models.DeviceGroup
        ...
        :return: An instance of LROPoller that returns either DeviceGroup or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.azuresphere.models.DeviceGroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param resource: Resource create parameters. Is either a DeviceGroup type or a IO type.
         Required.
        :type resource: ~azure.mgmt.azuresphere.models.DeviceGroup or IO
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.azuresphere.models.DeviceGroupUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param properties: The resource properties to be updated. Is either a DeviceGroupUpdate type or
         a IO type. Required.
        :type properties: ~azure.mgmt.azuresphere.models.DeviceGroupUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def _claim_devices_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(claim_devices_request, (IO, bytes)):
        ...
        request = build_claim_devices_request(
            ...
            json=_json,
            content=_content,
            template_url=self._claim_devices_initial.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    _claim_devices_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureSphere/catalogs/{catalogName}/products/{productName}/deviceGroups/{deviceGroupName}/claimDevices"
    }
    ...
    def begin_claim_devices(
        ...
        **kwargs: Any
        ...
        :type claim_devices_request: ~azure.mgmt.azuresphere.models.ClaimDevicesRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_claim_devices(
        ...
        **kwargs: Any
        ...
        :type claim_devices_request: ~azure.mgmt.azuresphere.models.ClaimDevicesRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def count_devices(
        ...
        :rtype: ~azure.mgmt.azuresphere.models.CountDeviceResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    count_devices.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureSphere/catalogs/{catalogName}/products/{productName}/deviceGroups/{deviceGroupName}/countDevices"
    }
