...
def build_retrieve_proof_of_possession_nonce_request(  # pylint: disable=name-too-long
    resource_group_name: str, catalog_name: str, serial_number: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CertificatesOperations:
    ...
    def list_by_catalog(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.azuresphere.models.Certificate]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.azuresphere.models.Certificate
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def retrieve_cert_chain(
        ...
        :rtype: ~azure.mgmt.azuresphere.models.CertificateChainResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def retrieve_proof_of_possession_nonce(
        ...
        **kwargs: Any
        ...
        :type proof_of_possession_nonce_request:
         ~azure.mgmt.azuresphere.models.ProofOfPossessionNonceRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ProofOfPossessionNonceResponse or the result of cls(response)
        :rtype: ~azure.mgmt.azuresphere.models.ProofOfPossessionNonceResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def retrieve_proof_of_possession_nonce(
        ...
        **kwargs: Any
        ...
        :type proof_of_possession_nonce_request:
         ~azure.mgmt.azuresphere.models.ProofOfPossessionNonceRequest or IO
        ...
        _json = None
        _content = None
        if isinstance(proof_of_possession_nonce_request, (IO, bytes)):
