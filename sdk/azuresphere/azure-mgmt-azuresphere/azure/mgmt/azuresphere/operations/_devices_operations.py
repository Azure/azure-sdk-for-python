...
class DevicesOperations:
    ...
    def list_by_device_group(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.azuresphere.models.Device]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.azuresphere.models.Device
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.azuresphere.models.Device
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.azuresphere.models.Device]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.azuresphere.models.Device or IO
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.azuresphere.models.DeviceUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param properties: The resource properties to be updated. Is either a DeviceUpdate type or a IO
         type. Required.
        :type properties: ~azure.mgmt.azuresphere.models.DeviceUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def _generate_capability_image_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(generate_device_capability_request, (IO, bytes)):
    ...
    def begin_generate_capability_image(
        ...
        **kwargs: Any
        ...
        :type generate_device_capability_request:
         ~azure.mgmt.azuresphere.models.GenerateCapabilityImageRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.azuresphere.models.SignedCapabilityImageResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_generate_capability_image(
        ...
        **kwargs: Any
        ...
        :type generate_device_capability_request:
         ~azure.mgmt.azuresphere.models.GenerateCapabilityImageRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
