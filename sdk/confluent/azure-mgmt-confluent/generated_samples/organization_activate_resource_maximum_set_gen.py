...
# USAGE
    python organization_activate_resource_maximum_set_gen.py
...
def main():
    ...
    response = client.organization.begin_activate_resource(
        body={"publisherId": "confluent", "saasGuid": "a1b2c3d4-e5f6-4a5b-8c9d-0e1f2a3b4c5d"},
    ).result()
    print(response)
