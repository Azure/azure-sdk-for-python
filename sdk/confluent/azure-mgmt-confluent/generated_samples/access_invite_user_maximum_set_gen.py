...
# USAGE
    python access_invite_user_maximum_set_gen.py
...
def main():
    ...
    response = client.access.invite_user(
        ...
        organization_name="aqwpihgldcvqwq",
        body={
            "email": "jtborwwroz",
            "invitedUserDetails": {"auth_type": "yaokrbtlql", "invitedEmail": "ozfkzouvjbvndqpyoxqbwtpzeiip"},
