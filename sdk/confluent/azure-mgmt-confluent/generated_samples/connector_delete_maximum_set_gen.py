...
# USAGE
    python connector_delete_maximum_set_gen.py
...
def main():
    ...
    client.connector.begin_delete(
        ...
        organization_name="xqspbodq",
        environment_id="aabxehocioujmjjkgegijsmntw",
        cluster_id="seivpzvrbyhjfmqb",
        connector_name="qznabwwh",
    ).result()
