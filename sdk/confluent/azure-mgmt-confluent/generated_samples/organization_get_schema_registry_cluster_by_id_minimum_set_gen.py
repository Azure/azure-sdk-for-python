...
# USAGE
    python organization_get_schema_registry_cluster_by_id_minimum_set_gen.py
...
def main():
    ...
    response = client.organization.get_schema_registry_cluster_by_id(
        ...
        organization_name="vcen",
        environment_id="zsbdbdljcfrnxxafcchr",
        cluster_id="ivjcqxutsnlylxo",
    )
    print(response)
