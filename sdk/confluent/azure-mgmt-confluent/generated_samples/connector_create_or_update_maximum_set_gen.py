...
# USAGE
    python connector_create_or_update_maximum_set_gen.py
...
def main():
    ...
    response = client.connector.create_or_update(
        ...
        organization_name="cppyvn",
        environment_id="tteibyyztawsguofmfn",
        cluster_id="bfokzevhjixs",
        connector_name="fczksqy",
    )
    print(response)
