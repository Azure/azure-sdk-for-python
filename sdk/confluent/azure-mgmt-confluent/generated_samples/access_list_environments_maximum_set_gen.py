...
# USAGE
    python access_list_environments_maximum_set_gen.py
...
def main():
    ...
    response = client.access.list_environments(
        resource_group_name="rgconfluent",
        organization_name="rnbjtcdqddweb",
        body={"searchFilters": {"key8083": "ft"}},
    )
    print(response)
