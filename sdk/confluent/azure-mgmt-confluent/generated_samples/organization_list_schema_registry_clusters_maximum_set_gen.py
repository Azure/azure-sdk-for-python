...
# USAGE
    python organization_list_schema_registry_clusters_maximum_set_gen.py
...
def main():
    ...
    response = client.organization.list_schema_registry_clusters(
        resource_group_name="rgconfluent",
        organization_name="vkzifcygqhoewuixdmmg",
        environment_id="psxriyxxbjnctgeohah",
    )
