...
# USAGE
    python organization_get_cluster_api_key_maximum_set_gen.py
...
def main():
    ...
    response = client.organization.get_cluster_api_key(
        resource_group_name="rgconfluent",
        organization_name="puauqgrwsfgmolfhazfjcavnj",
        api_key_id="xxsquwnsllkkzuyzlhdxdl",
    )
    print(response)
