...
class MarketplaceAgreementsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.confluent.models.ConfluentAgreementResourcePaged[~azure.mgmt.confluent.models.ConfluentAgreementResource]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.ConfluentAgreementResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def create(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: ConfluentAgreementResource or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.confluent.models.ConfluentAgreementResource or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ConfluentAgreementResource', response)
