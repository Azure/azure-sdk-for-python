...
def build_create_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Confluent/agreements/default"
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class MarketplaceAgreementsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> Iterable["_models.ConfluentAgreementResource"]:
    ...
    def create(
        ...
        :param body: Confluent Marketplace Agreement resource. Is either a model type or a IO type.
