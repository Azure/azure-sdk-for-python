...
class TestConfluentManagementOrganizationOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_organization_begin_link_saa_s(self, resource_group):
        response = await (
            await self.client.organization.begin_link_saa_s(
                resource_group_name=resource_group.name,
                organization_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_organization_latest_linked_saa_s(self, resource_group):
        response = await self.client.organization.latest_linked_saa_s(
            resource_group_name=resource_group.name,
            organization_name="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_organization_begin_activate_resource(self, resource_group):
        response = await (
            await self.client.organization.begin_activate_resource(
