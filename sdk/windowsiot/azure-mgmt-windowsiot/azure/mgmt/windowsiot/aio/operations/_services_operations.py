...
from ...operations._services_operations import build_check_device_service_name_availability_request, build_create_or_update_request, build_delete_request, build_get_request, build_list_by_resource_group_request, build_list_request, build_update_request
T = TypeVar('T')
...
class ServicesOperations:
    ...
    def list_by_resource_group(
        ...
        resource_group_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.DeviceServiceDescriptionListResult"]:
        ...
        :return: An iterator like instance of either DeviceServiceDescriptionListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.windowsiot.models.DeviceServiceDescriptionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
