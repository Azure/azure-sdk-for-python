...
# USAGE
    python discovery_rules_list_by_health_model.py
...
def main():
    ...
    response = client.discovery_rules.list_by_health_model(
...
# x-ms-original-file: 2026-10-01-preview/DiscoveryRules_ListByHealthModel.json
