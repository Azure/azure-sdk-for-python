...
class TestCloudHealthMgmtAuthenticationSettingsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(CloudHealthMgmtClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_authentication_settings_get(self, resource_group):
        response = self.client.authentication_settings.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_authentication_settings_list_by_health_model(self, resource_group):
