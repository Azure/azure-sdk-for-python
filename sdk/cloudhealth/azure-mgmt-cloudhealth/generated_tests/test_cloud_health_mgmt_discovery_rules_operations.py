...
class TestCloudHealthMgmtDiscoveryRulesOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(CloudHealthMgmtClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_discovery_rules_get(self, resource_group):
        response = self.client.discovery_rules.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_discovery_rules_list_by_health_model(self, resource_group):
