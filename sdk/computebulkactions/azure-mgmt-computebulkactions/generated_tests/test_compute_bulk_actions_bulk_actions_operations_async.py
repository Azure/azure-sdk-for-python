...
class TestComputeBulkActionsBulkActionsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_bulk_actions_get(self, resource_group):
        response = await self.client.bulk_actions.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_bulk_actions_get_operation_status(self, resource_group):
        response = await self.client.bulk_actions.get_operation_status(
            location="str",
            id="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_bulk_actions_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.bulk_actions.begin_create_or_update(
                resource_group_name=resource_group.name,
                location="str",
                name="str",
                resource={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_bulk_actions_begin_delete(self, resource_group):
        response = await (
            await self.client.bulk_actions.begin_delete(
                resource_group_name=resource_group.name,
                location="str",
                name="str",
            )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_bulk_actions_begin_cancel(self, resource_group):
        response = await (
            await self.client.bulk_actions.begin_cancel(
                resource_group_name=resource_group.name,
                location="str",
                name="str",
            )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_bulk_actions_list_virtual_machines(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_bulk_actions_virtual_machines_execute_deallocate(self, resource_group):
        response = await self.client.bulk_actions.virtual_machines_execute_deallocate(
            location="str",
            request_body={
                "correlationid": "str",
                "executionParameters": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_bulk_actions_virtual_machines_execute_hibernate(self, resource_group):
        response = await self.client.bulk_actions.virtual_machines_execute_hibernate(
            location="str",
            request_body={
                "correlationid": "str",
                "executionParameters": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_bulk_actions_virtual_machines_execute_start(self, resource_group):
        response = await self.client.bulk_actions.virtual_machines_execute_start(
            location="str",
            request_body={
                "correlationid": "str",
                "executionParameters": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_bulk_actions_virtual_machines_execute_create(self, resource_group):
        response = await self.client.bulk_actions.virtual_machines_execute_create(
            location="str",
            request_body={
                "executionParameters": {
                    "optimizationPreference": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_bulk_actions_virtual_machines_execute_delete(self, resource_group):
        response = await self.client.bulk_actions.virtual_machines_execute_delete(
            location="str",
            request_body={
                "correlationid": "str",
                "executionParameters": {
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_bulk_actions_virtual_machines_get_operation_status(self, resource_group):
        response = await self.client.bulk_actions.virtual_machines_get_operation_status(
            location="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_bulk_actions_virtual_machines_cancel_operations(self, resource_group):
        response = await self.client.bulk_actions.virtual_machines_cancel_operations(
            location="str",
            request_body={"correlationid": "str", "operationIds": ["str"]},
        )
