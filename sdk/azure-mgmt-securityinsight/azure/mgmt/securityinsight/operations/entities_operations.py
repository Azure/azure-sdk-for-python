...
class EntitiesOperations(object):
    ...
    def expand(
            self, resource_group_name, operational_insights_resource_provider, workspace_name, entity_id, parameters, custom_headers=None, raw=False, **operation_config):
        """Expands an entity.
        ...
        :param entity_id: entity ID
        :type entity_id: str
        :param parameters: The parameters required to execute an expand
         operation on the given entity.
        :type parameters:
         ~azure.mgmt.securityinsight.models.EntityExpandParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: EntityExpandResponse or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.securityinsight.models.EntityExpandResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'EntityExpandParameters')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('EntityExpandResponse', response)
        ...
        return deserialized
    expand.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{operationalInsightsResourceProvider}/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/entities/{entityId}/expand'}
