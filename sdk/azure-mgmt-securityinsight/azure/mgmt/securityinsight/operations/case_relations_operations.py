...
class CaseRelationsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.securityinsight.models.CaseRelationPaged[~azure.mgmt.securityinsight.models.CaseRelation]
        ...
        deserialized = models.CaseRelationPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.CaseRelationPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get_relation(
        ...
        :rtype: ~azure.mgmt.securityinsight.models.CaseRelation or
