...
class AlertRulesOperations(object):
    ...
    def get(
            self, resource_group_name, workspace_name, rule_id, custom_headers=None, raw=False, **operation_config):
        """Gets the alert rule.
    ...
    def create_or_update(
            self, resource_group_name, workspace_name, rule_id, alert_rule, custom_headers=None, raw=False, **operation_config):
    ...
    def get_action(
            self, resource_group_name, workspace_name, rule_id, action_id, custom_headers=None, raw=False, **operation_config):
    ...
    def create_or_update_action(
            self, resource_group_name, workspace_name, rule_id, action_id, action, custom_headers=None, raw=False, **operation_config):
