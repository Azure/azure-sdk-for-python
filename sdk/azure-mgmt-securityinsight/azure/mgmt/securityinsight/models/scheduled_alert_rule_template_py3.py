...
class ScheduledAlertRuleTemplate(AlertRuleTemplate):
    ...
    def __init__(self, *, display_name: str, description: str, status, required_data_connectors, alert_rules_created_by_template_count: int, severity, query: str, query_frequency, query_period, trigger_operator, trigger_threshold: int, etag: str=None, tactics=None, **kwargs) -> None:
