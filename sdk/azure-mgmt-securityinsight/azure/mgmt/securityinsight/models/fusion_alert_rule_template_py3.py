...
class FusionAlertRuleTemplate(AlertRuleTemplate):
    ...
    def __init__(self, *, display_name: str, description: str, status, alert_rules_created_by_template_count: int, etag: str=None, tactics=None, required_data_connectors=None, severity=None, **kwargs) -> None:
