...
class AzureTrafficCollector:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.network_function = NetworkFunctionOperations(self._client, self._config, self._serialize, self._deserialize)
        self.azure_traffic_collectors_by_subscription = AzureTrafficCollectorsBySubscriptionOperations(self._client, self._config, self._serialize, self._deserialize)
        self.azure_traffic_collectors_by_resource_group = AzureTrafficCollectorsByResourceGroupOperations(self._client, self._config, self._serialize, self._deserialize)
        self.azure_traffic_collectors = AzureTrafficCollectorsOperations(self._client, self._config, self._serialize, self._deserialize)
        self.collector_policies = CollectorPoliciesOperations(self._client, self._config, self._serialize, self._deserialize)
