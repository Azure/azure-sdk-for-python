...
class CollectorPoliciesOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("CollectorPolicy", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        azure_traffic_collector_name: str,
        collector_policy_name: str,
        parameters: Union[_models.CollectorPolicy, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "CollectorPolicy")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param collector_policy_name: Collector Policy Name. Required.
        :type collector_policy_name: str
        :param parameters: The parameters to provide for the created Collector Policy. Is either a
         CollectorPolicy type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.networkfunction.models.CollectorPolicy or IO[bytes]
        :return: An instance of LROPoller that returns either CollectorPolicy or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.networkfunction.models.CollectorPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def update_tags(
        ...
        **kwargs: Any
        ...
        :param collector_policy_name: Collector Policy Name. Required.
        :type collector_policy_name: str
        :param parameters: The resource properties to be updated. Is either a TagsObject type or a
