...
class CollectorPoliciesOperations:
    ...
    def list(
    ...
    ) -> Iterable["_models.CollectorPolicy"]:
        ...
        :return: An iterator like instance of either CollectorPolicy or the result of cls(response)
        ...
        cls: ClsType[_models.CollectorPolicyListResult] = kwargs.pop("cls", None)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkFunction/azureTrafficCollectors/{azureTrafficCollectorName}/collectorPolicies/{collectorPolicyName}"
    }
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        _parameters = _models.CollectorPolicy(
            emission_policies=emission_policies, ingestion_policy=ingestion_policy, location=location, tags=tags
        )
    ...
    def update_tags(
        ...
        **kwargs: Any
        ...
        :param collector_policy_name: Collector Policy Name. Required.
        :type collector_policy_name: str
        :param parameters: Parameters supplied to update Collector Policy tags. Required.
    ...
    def update_tags(
        ...
        **kwargs: Any
        ...
        :param collector_policy_name: Collector Policy Name. Required.
        :type collector_policy_name: str
        :param parameters: Parameters supplied to update Collector Policy tags. Is either a model type
