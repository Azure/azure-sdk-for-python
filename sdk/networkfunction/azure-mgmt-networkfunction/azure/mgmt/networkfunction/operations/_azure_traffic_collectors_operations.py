...
class AzureTrafficCollectorsOperations:
    ...
    def _create_or_update_initial(
        ...
        parameters: Union[_models.AzureTrafficCollector, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "AzureTrafficCollector")
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param azure_traffic_collector_name: Azure Traffic Collector name. Required.
        :type azure_traffic_collector_name: str
        :param parameters: The parameters to provide for the created Azure Traffic Collector. Is either
         a AzureTrafficCollector type or a IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.networkfunction.models.AzureTrafficCollector or IO[bytes]
        :return: An instance of LROPoller that returns either AzureTrafficCollector or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.networkfunction.models.AzureTrafficCollector]
        :raises ~azure.core.exceptions.HttpResponseError:
