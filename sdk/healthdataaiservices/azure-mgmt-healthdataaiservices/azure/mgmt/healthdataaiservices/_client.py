...
class HealthDataAIServicesMgmtClient:
    ...
    :keyword api_version: The API version to use for this operation. Known values are "2024-09-20"
     and None. Default value is "2024-09-20". Note that overriding this default value may result in
