...
class DeidService(TrackedResource):
    ...
    :vartype sku: ~azure.mgmt.healthdataaiservices.models.DeidServiceSku
    """
    ...
    sku: Optional["_models.DeidServiceSku"] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    ...
    def __init__(
        ...
        *,
        ...
        sku: Optional["_models.DeidServiceSku"] = None,
    ) -> None: ...
...
class DeidServiceSku(_Model):
    """The SKU for the DeidService resource.

    :ivar name: The name of the SKU. Ex - Free, Basic, Standard. Required. Known values are:
     "Free", "Basic", and "Standard".
    :vartype name: str or ~azure.mgmt.healthdataaiservices.models.DeidServiceSkuName
    :ivar tier: The SKU tier. This is based on the SKU name. Known values are: "Free", "Basic",
    ...
    name: Union[str, "_models.DeidServiceSkuName"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """The name of the SKU. Ex - Free, Basic, Standard. Required. Known values are: \"Free\",
     \"Basic\", and \"Standard\"."""
    tier: Optional[Union[str, "_models.SkuTier"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """The SKU tier. This is based on the SKU name. Known values are: \"Free\", \"Basic\",
     \"Standard\", and \"Premium\"."""
    ...
    def __init__(
        self,
        *,
        name: Union[str, "_models.DeidServiceSkuName"],
