...
class DeidentificationClient(DeidentificationClientGenerated):
    ...
    @distributed_trace
    def list_jobs(self, **kwargs: Any) -> AsyncItemPaged[DeidentificationJob]:
        """
        List de-identification jobs.

        :return: An iterator like instance of DeidentificationJob
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.health.deidentification.models.DeidentificationJob]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        return super()._list_jobs_internal(continuation_token_parameter=None, **kwargs)

    @distributed_trace
    def list_job_documents(self, job_name: str, **kwargs: Any) -> AsyncItemPaged[DeidentificationDocumentDetails]:
        """
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.health.deidentification.models.DocumentDetails]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
