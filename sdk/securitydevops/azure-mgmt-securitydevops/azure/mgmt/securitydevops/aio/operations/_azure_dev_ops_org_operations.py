...
from ...operations._azure_dev_ops_org_operations import (
...
class AzureDevOpsOrgOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.AzureDevOpsOrg"]:
        """list.
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.securitydevops.models.AzureDevOpsOrg]
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecurityDevOps/azureDevOpsConnectors/{azureDevOpsConnectorName}/orgs/{azureDevOpsOrgName}"
    }
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either AzureDevOpsOrg or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.securitydevops.models.AzureDevOpsOrg]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
