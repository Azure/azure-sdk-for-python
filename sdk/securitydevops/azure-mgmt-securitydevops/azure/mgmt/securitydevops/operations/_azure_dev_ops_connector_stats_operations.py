...
class AzureDevOpsConnectorStatsOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`azure_dev_ops_connector_stats` attribute.
    """
    ...
    def get(
    ...
    ) -> _models.AzureDevOpsConnectorStatsListResponse:
        ...
        :return: AzureDevOpsConnectorStatsListResponse or the result of cls(response)
        :rtype: ~azure.mgmt.securitydevops.models.AzureDevOpsConnectorStatsListResponse
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.AzureDevOpsConnectorStatsListResponse]
        ...
        deserialized = self._deserialize("AzureDevOpsConnectorStatsListResponse", pipeline_response)
    ...
    get.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecurityDevOps/azureDevOpsConnectors/{azureDevOpsConnectorName}/stats"}  # type: ignore
