...
# USAGE
    python azure_dev_ops_project_create_or_update.py
...
def main():
    ...
    response = client.azure_dev_ops_project.begin_create_or_update(
        ...
        azure_dev_ops_project={"properties": {"autoDiscovery": "Disabled"}},
    ).result()
    print(response)
