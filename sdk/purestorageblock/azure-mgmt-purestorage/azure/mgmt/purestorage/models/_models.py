...
class Alert(_Model):
    ...
    :vartype level: str or ~azure.mgmt.purestorage.models.AlertLevel
...
class AvsConnection(_Model):
    ...
    :vartype service_initialization_handle:
     ~azure.mgmt.purestorage.models.ServiceInitializationHandle
    """
...
class Resource(_Model):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.purestorage.models.SystemData
    """
...
class AvsStorageContainer(ProxyResource):
    ...
    :vartype properties: ~azure.mgmt.purestorage.models.AvsStorageContainerProperties
    """
...
class AvsStorageContainerProperties(_Model):
    ...
    :vartype space: ~azure.mgmt.purestorage.models.Space
...
class AvsStorageContainerVolume(ProxyResource):
    ...
    :vartype system_data: ~azure.mgmt.purestorage.models.SystemData
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.purestorage.models.VolumeProperties
    """
...
class AvsStorageContainerVolumeUpdate(_Model):
    ...
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.purestorage.models.AvsStorageContainerVolumeUpdateProperties
    """
...
class AvsStorageContainerVolumeUpdateProperties(_Model):  # pylint: disable=name-too-long
    ...
    :vartype soft_deletion: ~azure.mgmt.purestorage.models.SoftDeletion
    """
...
class AvsVm(ProxyResource):
    ...
    :vartype system_data: ~azure.mgmt.purestorage.models.SystemData
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.purestorage.models.AvsVmProperties
    """
...
class AvsVmDetails(_Model):
    ...
    :vartype vm_type: str or ~azure.mgmt.purestorage.models.VmType
...
class AvsVmProperties(_Model):
    ...
    :ivar volume_container_type: Specify which control plane handles the lifecycle of the volume
     container. "avs"
    :vartype volume_container_type: str or ~azure.mgmt.purestorage.models.VolumeContainerType
    :ivar avs: AVS VM details.
    :vartype avs: ~azure.mgmt.purestorage.models.AvsVmDetails
    ...
    :ivar provisioning_state: Provisioning state of the resource. Known values are: "Succeeded",
     "Failed", and "Canceled".
    :vartype provisioning_state: str or ~azure.mgmt.purestorage.models.ResourceProvisioningState
    """
...
class AvsVmUpdate(_Model):
    ...
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.purestorage.models.AvsVmUpdateProperties
    """
...
class AvsVmVolumeUpdate(_Model):
    ...
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.purestorage.models.AvsVmVolumeUpdateProperties
    """
...
class BillingUsageProperty(_Model):
    ...
    :vartype severity: str or ~azure.mgmt.purestorage.models.UsageSeverity
    ...
    :vartype sub_properties: list[~azure.mgmt.purestorage.models.BillingUsageProperty]
    """
...
class CompanyDetails(_Model):
    ...
    :vartype address: ~azure.mgmt.purestorage.models.Address
    """
...
class ErrorDetail(_Model):
    ...
    :vartype details: list[~azure.mgmt.purestorage.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.purestorage.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_Model):
    ...
    :vartype error: ~azure.mgmt.purestorage.models.ErrorDetail
    """
...
class HealthDetails(_Model):
    ...
    :vartype bandwidth_usage: ~azure.mgmt.purestorage.models.BandwidthUsage
    :ivar iops_usage: IOPS usage metrics. Required.
    :vartype iops_usage: ~azure.mgmt.purestorage.models.IopsUsage
...
class LimitDetails(_Model):
    ...
    :vartype storage_pool: ~azure.mgmt.purestorage.models.StoragePoolLimits
    :ivar volume: Limits used for volume resources. Required.
    :vartype volume: ~azure.mgmt.purestorage.models.VolumeLimits
    :ivar protection_policy: internal. Required.
    :vartype protection_policy: ~azure.mgmt.purestorage.models.ProtectionPolicyLimits
    :ivar performance_policy: internal. Required.
    :vartype performance_policy: ~azure.mgmt.purestorage.models.PerformancePolicyLimits
    """
...
class ManagedServiceIdentity(_Model):
    ...
    :vartype type: str or ~azure.mgmt.purestorage.models.ManagedServiceIdentityType
    :ivar user_assigned_identities: The identities assigned to this resource by the user.
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.purestorage.models.UserAssignedIdentity]
    """
...
class MarketplaceDetails(_Model):
    ...
    :vartype subscription_status: str or
     ~azure.mgmt.purestorage.models.MarketplaceSubscriptionStatus
    :ivar offer_details: Offer details of the marketplace subscription. Required.
    :vartype offer_details: ~azure.mgmt.purestorage.models.OfferDetails
    """
...
class Operation(_Model):
    ...
    :vartype display: ~azure.mgmt.purestorage.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.purestorage.models.Origin
    :ivar action_type: Extensible enum. Indicates the action type. "Internal" refers to actions
     that are for internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.purestorage.models.ActionType
    """
...
class PerformancePolicyLimits(_Model):
    ...
    :vartype iops_limit: ~azure.mgmt.purestorage.models.RangeLimits
    :ivar bandwidth_limit: internal. Required.
    :vartype bandwidth_limit: ~azure.mgmt.purestorage.models.RangeLimits
    """
...
class ProtectionPolicyLimits(_Model):
    ...
    :vartype frequency: ~azure.mgmt.purestorage.models.RangeLimits
    :ivar retention: internal. Required.
    :vartype retention: ~azure.mgmt.purestorage.models.RangeLimits
    """
...
class Reservation(TrackedResource):
    ...
    :vartype location: str
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.purestorage.models.ReservationPropertiesBaseResourceProperties
    """
...
class ReservationBillingUsageReport(_Model):
    ...
    :vartype billing_usage_properties: list[~azure.mgmt.purestorage.models.BillingUsageProperty]
...
class ReservationPropertiesBaseResourceProperties(_Model):  # pylint: disable=name-too-long
    ...
    :vartype marketplace: ~azure.mgmt.purestorage.models.MarketplaceDetails
    :ivar user: User details. Required.
    :vartype user: ~azure.mgmt.purestorage.models.UserDetails
    :ivar provisioning_state: Provisioning state of the resource. Known values are: "Succeeded",
     "Failed", "Canceled", "Deleting", and "Accepted".
    :vartype provisioning_state: str or ~azure.mgmt.purestorage.models.ProvisioningState
    """
...
class ReservationUpdate(_Model):
    ...
    :vartype tags: dict[str, str]
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.purestorage.models.ReservationUpdateProperties
    """
...
class StoragePool(TrackedResource):
    ...
    :vartype location: str
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.purestorage.models.StoragePoolProperties
    :ivar identity: The managed service identities assigned to this resource.
    :vartype identity: ~azure.mgmt.purestorage.models.ManagedServiceIdentity
    """
...
class StoragePoolFinalizeAvsConnectionPost(_Model):
    ...
    :vartype service_initialization_data: ~azure.mgmt.purestorage.models.ServiceInitializationInfo
    """
...
class StoragePoolHealthInfo(_Model):
    ...
    :vartype health: ~azure.mgmt.purestorage.models.HealthDetails
    :ivar alerts: List of health alerts. Required.
    :vartype alerts: list[~azure.mgmt.purestorage.models.Alert]
    """
...
class StoragePoolLimits(_Model):
    ...
    :ivar provisioned_bandwidth_mb_per_sec: Allowed provisioned bandwidth range for a storage pool,
     in MB/s. Required.
    :vartype provisioned_bandwidth_mb_per_sec: ~azure.mgmt.purestorage.models.RangeLimits
    :ivar provisioned_iops: Allowed provisioned IOPS range for a storage pool, as a number of
     operations. Required.
    :vartype provisioned_iops: ~azure.mgmt.purestorage.models.RangeLimits
...
class StoragePoolProperties(_Model):
    ...
    :vartype vnet_injection: ~azure.mgmt.purestorage.models.VnetInjection
    ...
    :vartype avs: ~azure.mgmt.purestorage.models.AzureVmwareService
    :ivar provisioning_state: Provisioning state of the resource. Known values are: "Succeeded",
     "Failed", "Canceled", "Deleting", and "Accepted".
    :vartype provisioning_state: str or ~azure.mgmt.purestorage.models.ProvisioningState
...
class StoragePoolUpdate(_Model):
    ...
    :vartype tags: dict[str, str]
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.purestorage.models.StoragePoolUpdateProperties
    """
...
class SystemData(_Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.purestorage.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or ~azure.mgmt.purestorage.models.CreatedByType
...
class UserDetails(_Model):
    ...
    :vartype company_details: ~azure.mgmt.purestorage.models.CompanyDetails
    """
...
class VolumeLimits(_Model):
    ...
    :vartype provisioned_size: ~azure.mgmt.purestorage.models.RangeLimits
    """
...
class VolumeProperties(_Model):
    ...
    :vartype volume_type: str or ~azure.mgmt.purestorage.models.VolumeType
    :ivar avs: AVS-specific volume information.
    :vartype avs: ~azure.mgmt.purestorage.models.AvsDiskDetails
    :ivar provisioning_state: Provisioning state of the resource. Known values are: "Succeeded",
     "Failed", and "Canceled".
    :vartype provisioning_state: str or ~azure.mgmt.purestorage.models.ResourceProvisioningState
    """
