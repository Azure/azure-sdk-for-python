...
# USAGE
    python volume_group_snapshots_list_snapshots_maximum_set_gen.py
...
def main():
    ...
    response = client.volume_group_snapshots.list_snapshots(
        resource_group_name="rgpurestorage",
        storage_pool_name="storagepool-01",
        volume_group_name="volumegroup-01",
        properties={"filter": "substringof('snapshot', name)", "orderby": "name asc", "skip": 0, "top": 10},
    )
    print(response)
