...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "routePolicyName": _SERIALIZER.url(
            "route_policy_name", route_policy_name, "str", pattern=r"^[a-zA-Z]{1}[a-zA-Z0-9-_]{2,127}$"
        ),
    }
...
class RoutePoliciesOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.RoutePolicy"]:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.RoutePolicy"]:
    ...
    def _delete_initial(self, resource_group_name: str, route_policy_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
