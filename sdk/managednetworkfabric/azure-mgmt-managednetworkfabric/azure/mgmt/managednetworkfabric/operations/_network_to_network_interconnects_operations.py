...
def build_update_bfd_administrative_state_request(  # pylint: disable=name-too-long
    resource_group_name: str,
    network_fabric_name: str,
    network_to_network_interconnect_name: str,
    subscription_id: str,
...
class NetworkToNetworkInterconnectsOperations:
    ...
    ) -> ItemPaged["_models.NetworkToNetworkInterconnect"]:
    ...
    def _update_bfd_administrative_state_initial(
        self,
        resource_group_name: str,
        network_fabric_name: str,
        network_to_network_interconnect_name: str,
    ...
    @overload
    def begin_update_bfd_administrative_state(
        self,
        resource_group_name: str,
        network_fabric_name: str,
        network_to_network_interconnect_name: str,
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.NniBfdAdministrativeStateResponse]:
        """Updates the Admin State.
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either NniBfdAdministrativeStateResponse or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.NniBfdAdministrativeStateResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update_bfd_administrative_state(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._update_bfd_administrative_state_initial(
                resource_group_name=resource_group_name,
                network_fabric_name=network_fabric_name,
                network_to_network_interconnect_name=network_to_network_interconnect_name,
                body=body,
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.NniBfdAdministrativeStateResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.NniBfdAdministrativeStateResponse](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
