...
def build_create_request(
    resource_group_name: str, internet_gateway_rule_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "internetGatewayRuleName": _SERIALIZER.url("internet_gateway_rule_name", internet_gateway_rule_name, "str"),
    }
...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ManagedNetworkFabric/internetGatewayRules"
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class InternetGatewayRulesOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.InternetGatewayRule]:
        ...
        :return: An instance of LROPoller that returns either InternetGatewayRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.InternetGatewayRule]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.InternetGatewayRule].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.InternetGatewayRule](
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, internet_gateway_rule_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    def list_by_resource_group(
    ...
    ) -> ItemPaged["_models.InternetGatewayRule"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.managednetworkfabric.models.InternetGatewayRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.InternetGatewayRule"]:
