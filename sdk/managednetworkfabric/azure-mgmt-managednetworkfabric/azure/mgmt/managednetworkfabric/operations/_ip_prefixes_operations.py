...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "ipPrefixName": _SERIALIZER.url(
            "ip_prefix_name", ip_prefix_name, "str", pattern=r"^[a-zA-Z]{1}[a-zA-Z0-9-_]{2,127}$"
        ),
    }
...
class IpPrefixesOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.IpPrefix"]:
        ...
        cls: ClsType[_models.IpPrefixListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("IpPrefixListResult", pipeline_response)
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.IpPrefix"]:
    ...
    def get(self, resource_group_name: str, ip_prefix_name: str, **kwargs: Any) -> _models.IpPrefix:
        ...
        deserialized = self._deserialize("IpPrefix", pipeline_response.http_response)
    ...
    def _create_initial(
        self, resource_group_name: str, ip_prefix_name: str, resource: Union[_models.IpPrefix, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "IpPrefix")
    ...
    def begin_create(
        ...
        :param ip_prefix_name: Name of the IP Prefix. Required.
        :type ip_prefix_name: str
        :param resource: Request payload. Is either a IpPrefix type or a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.IpPrefix or IO[bytes]
        :return: An instance of LROPoller that returns either IpPrefix or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.IpPrefix]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        ip_prefix_name: str,
        properties: Union[_models.IpPrefixPatch, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "IpPrefixPatch")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param ip_prefix_name: Name of the IP Prefix. Required.
        :type ip_prefix_name: str
        :param properties: IP Prefix properties to update. Is either a IpPrefixPatch type or a
         IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.IpPrefixPatch or IO[bytes]
        :return: An instance of LROPoller that returns either IpPrefix or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.IpPrefix]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _delete_initial(self, resource_group_name: str, ip_prefix_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
