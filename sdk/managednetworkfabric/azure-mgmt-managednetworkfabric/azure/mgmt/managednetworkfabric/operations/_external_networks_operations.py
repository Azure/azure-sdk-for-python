...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "externalNetworkName": _SERIALIZER.url(
            "external_network_name", external_network_name, "str", pattern=r"^[a-zA-Z]{1}[a-zA-Z0-9-_]{2,127}$"
        ),
    }
...
class ExternalNetworksOperations:
    ...
    def begin_update_bfd_administrative_state(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.ExternalNetworkBfdAdministrativeStateResponse]:
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.ExternalNetworkBfdAdministrativeStateResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update_bfd_administrative_state(
        ...
        **kwargs: Any
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.ExternalNetworkBfdAdministrativeStateResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ExternalNetworkBfdAdministrativeStateResponse](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
