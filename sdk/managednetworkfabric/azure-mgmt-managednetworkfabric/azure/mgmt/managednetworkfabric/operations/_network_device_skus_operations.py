...
def build_get_request(network_device_sku_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "networkDeviceSkuName": _SERIALIZER.url(
            "network_device_sku_name", network_device_sku_name, "str", pattern=r"^[a-zA-Z]{1}[a-zA-Z0-9-_]{2,127}$"
        ),
    }
...
class NetworkDeviceSkusOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.NetworkDeviceSku"]:
        ...
        cls: ClsType[_models.NetworkDeviceSkuListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("NetworkDeviceSkuListResult", pipeline_response)
    ...
    def get(self, network_device_sku_name: str, **kwargs: Any) -> _models.NetworkDeviceSku:
        ...
        deserialized = self._deserialize("NetworkDeviceSku", pipeline_response.http_response)
