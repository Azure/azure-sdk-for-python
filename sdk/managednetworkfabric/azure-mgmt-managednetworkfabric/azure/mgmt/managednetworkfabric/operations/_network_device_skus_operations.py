...
class NetworkDeviceSkusOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.managednetworkfabric.AzureNetworkFabricManagementServiceAPI`'s
    ...
    def get(self, network_device_sku_name: str, **kwargs: Any) -> _models.NetworkDeviceSku:
        ...
        deserialized = self._deserialize("NetworkDeviceSku", pipeline_response)
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.NetworkDeviceSku"]:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.NetworkDeviceSkusListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("NetworkDeviceSkusListResult", pipeline_response)
    ...
    list_by_subscription.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.ManagedNetworkFabric/networkDeviceSkus"
    }
