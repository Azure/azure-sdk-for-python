...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "l3IsolationDomainName": _SERIALIZER.url(
            "l3_isolation_domain_name", l3_isolation_domain_name, "str", pattern=r"^[a-zA-Z]{1}[a-zA-Z0-9-_]{2,127}$"
        ),
    }
...
class L3IsolationDomainsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.L3IsolationDomain"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.managednetworkfabric.models.L3IsolationDomain]
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.L3IsolationDomain"]:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, l3_isolation_domain_name: str, **kwargs: Any) -> _models.L3IsolationDomain:
    ...
    def begin_create(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.L3IsolationDomain]:
        ...
        :return: An instance of LROPoller that returns either L3IsolationDomain or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.L3IsolationDomain]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.L3IsolationDomain].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.L3IsolationDomain](
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, l3_isolation_domain_name: str, **kwargs: Any) -> LROPoller[None]:
