...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "internalNetworkName": _SERIALIZER.url(
            "internal_network_name", internal_network_name, "str", pattern=r"^[a-zA-Z]{1}[a-zA-Z0-9-_]{2,127}$"
        ),
    }
...
class InternalNetworksOperations:
    ...
    def list_by_l3_isolation_domain(
    ...
    ) -> ItemPaged["_models.InternalNetwork"]:
        ...
        cls: ClsType[_models.InternalNetworkListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("InternalNetworkListResult", pipeline_response)
    ...
    def get(
        ...
        deserialized = self._deserialize("InternalNetwork", pipeline_response.http_response)
    ...
    def _create_initial(
        ...
        l3_isolation_domain_name: str,
        internal_network_name: str,
        resource: Union[_models.InternalNetwork, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "InternalNetwork")
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param internal_network_name: Name of the Internal Network. Required.
        :type internal_network_name: str
        :param resource: Request payload. Is either a InternalNetwork type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.InternalNetwork or IO[bytes]
        :return: An instance of LROPoller that returns either InternalNetwork or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.InternalNetwork]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        l3_isolation_domain_name: str,
        internal_network_name: str,
        properties: Union[_models.InternalNetworkPatch, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "InternalNetworkPatch")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param internal_network_name: Name of the Internal Network. Required.
        :type internal_network_name: str
        :param properties: InternalNetwork properties to update. Only annotations are supported. Is
         either a InternalNetworkPatch type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.InternalNetworkPatch or IO[bytes]
        :return: An instance of LROPoller that returns either InternalNetwork or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.InternalNetwork]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_bfd_administrative_state_initial(
        ...
        l3_isolation_domain_name: str,
        internal_network_name: str,
        body: Union[_models.InternalNetworkBfdAdministrativeStateRequest, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "InternalNetworkBfdAdministrativeStateRequest")
    ...
    def begin_update_bfd_administrative_state(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.InternalNetworkBfdAdministrativeStateResponse]:
        ...
        :return: An instance of LROPoller that returns either
         InternalNetworkBfdAdministrativeStateResponse or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.InternalNetworkBfdAdministrativeStateResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update_bfd_administrative_state(
        ...
        **kwargs: Any
        ...
        :param internal_network_name: Name of the Internal Network. Required.
        :type internal_network_name: str
        :param body: Request payload. Is either a InternalNetworkBfdAdministrativeStateRequest type or
         a IO[bytes] type. Required.
        :type body:
         ~azure.mgmt.managednetworkfabric.models.InternalNetworkBfdAdministrativeStateRequest or
         IO[bytes]
        :return: An instance of LROPoller that returns either
         InternalNetworkBfdAdministrativeStateResponse or the result of cls(response)
        :rtype:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize(
                "InternalNetworkBfdAdministrativeStateResponse", pipeline_response.http_response
            )
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.InternalNetworkBfdAdministrativeStateResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.InternalNetworkBfdAdministrativeStateResponse](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    def _update_bgp_administrative_state_initial(
        ...
        l3_isolation_domain_name: str,
        internal_network_name: str,
        body: Union[_models.InternalNetworkBgpAdministrativeStateRequest, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "InternalNetworkBgpAdministrativeStateRequest")
    ...
    def begin_update_bgp_administrative_state(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.InternalNetworkBgpAdministrativeStateResponse]:
        ...
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either
         InternalNetworkBgpAdministrativeStateResponse or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.InternalNetworkBgpAdministrativeStateResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update_bgp_administrative_state(
        ...
        **kwargs: Any
        ...
        :param internal_network_name: Name of the Internal Network. Required.
        :type internal_network_name: str
        :param body: Request payload. Is either a InternalNetworkBgpAdministrativeStateRequest type or
         a IO[bytes] type. Required.
        :type body:
         ~azure.mgmt.managednetworkfabric.models.InternalNetworkBgpAdministrativeStateRequest or
         IO[bytes]
        :return: An instance of LROPoller that returns either
         InternalNetworkBgpAdministrativeStateResponse or the result of cls(response)
        :rtype:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize(
                "InternalNetworkBgpAdministrativeStateResponse", pipeline_response.http_response
            )
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.InternalNetworkBgpAdministrativeStateResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.InternalNetworkBgpAdministrativeStateResponse](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
