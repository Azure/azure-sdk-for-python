...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "accessControlListName": _SERIALIZER.url(
            "access_control_list_name", access_control_list_name, "str", pattern=r"^[a-zA-Z]{1}[a-zA-Z0-9-_]{2,127}$"
        ),
    }
...
class AccessControlListsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.AccessControlList"]:
        ...
        cls: ClsType[_models.AccessControlListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("AccessControlListResult", pipeline_response)
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.AccessControlList"]:
    ...
    def get(self, resource_group_name: str, access_control_list_name: str, **kwargs: Any) -> _models.AccessControlList:
        ...
        deserialized = self._deserialize("AccessControlList", pipeline_response.http_response)
    ...
    def _create_initial(
        ...
        resource: Union[_models.AccessControlList, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "AccessControlList")
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param access_control_list_name: Name of the Access Control List. Required.
        :type access_control_list_name: str
        :param resource: Request payload. Is either a AccessControlList type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.AccessControlList or IO[bytes]
        :return: An instance of LROPoller that returns either AccessControlList or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.AccessControlList]
        ...
        if cont_token:
            return LROPoller[_models.AccessControlList].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.AccessControlList](
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        access_control_list_name: str,
        properties: Union[_models.AccessControlListPatch, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "AccessControlListPatch")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param access_control_list_name: Name of the Access Control List. Required.
        :type access_control_list_name: str
        :param properties: Access Control List properties to update. Is either a AccessControlListPatch
         type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.AccessControlListPatch or IO[bytes]
        :return: An instance of LROPoller that returns either AccessControlList or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.AccessControlList]
