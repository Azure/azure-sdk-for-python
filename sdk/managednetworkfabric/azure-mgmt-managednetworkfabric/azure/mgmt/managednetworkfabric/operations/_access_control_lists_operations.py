...
class AccessControlListsOperations:
    ...
    def _create_initial(
        ...
        body: Union[_models.AccessControlList, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param access_control_list_name: Name of the Access Control List. Required.
        :type access_control_list_name: str
        :param body: Request payload. Is either a AccessControlList type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.AccessControlList or IO[bytes]
        :return: An instance of LROPoller that returns either AccessControlList or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.AccessControlList]
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        access_control_list_name: str,
        body: Union[_models.AccessControlListPatch, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.managednetworkfabric.models.AccessControlListPatch or IO[bytes]
        :return: An instance of LROPoller that returns either AccessControlList or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.AccessControlList]
