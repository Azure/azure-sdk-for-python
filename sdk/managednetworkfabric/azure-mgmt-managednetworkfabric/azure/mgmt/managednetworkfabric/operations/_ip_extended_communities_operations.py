...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "ipExtendedCommunityName": _SERIALIZER.url(
            "ip_extended_community_name",
            ip_extended_community_name,
            "str",
            pattern=r"^[a-zA-Z]{1}[a-zA-Z0-9-_]{2,127}$",
        ),
    }
...
class IpExtendedCommunitiesOperations:
    ...
    def get(
        ...
        deserialized = self._deserialize("IpExtendedCommunity", pipeline_response.http_response)
    ...
    def _create_initial(
        ...
        resource: Union[_models.IpExtendedCommunity, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "IpExtendedCommunity")
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param ip_extended_community_name: Name of the IP Extended Community. Required.
        :type ip_extended_community_name: str
        :param resource: Request payload. Is either a IpExtendedCommunity type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.IpExtendedCommunity or IO[bytes]
        :return: An instance of LROPoller that returns either IpExtendedCommunity or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.IpExtendedCommunity]
        ...
        if cont_token:
            return LROPoller[_models.IpExtendedCommunity].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.IpExtendedCommunity](
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        ip_extended_community_name: str,
        properties: Union[_models.IpExtendedCommunityPatch, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "IpExtendedCommunityPatch")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param ip_extended_community_name: Name of the IP Extended Community. Required.
        :type ip_extended_community_name: str
        :param properties: IP Extended Community properties to update. Is either a
         IpExtendedCommunityPatch type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.IpExtendedCommunityPatch or IO[bytes]
        :return: An instance of LROPoller that returns either IpExtendedCommunity or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.IpExtendedCommunity]
