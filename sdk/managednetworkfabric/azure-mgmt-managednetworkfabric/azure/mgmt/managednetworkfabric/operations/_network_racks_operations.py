...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "networkRackName": _SERIALIZER.url(
            "network_rack_name", network_rack_name, "str", pattern=r"^[a-zA-Z]{1}[a-zA-Z0-9-_]{2,127}$"
        ),
    }
...
class NetworkRacksOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.NetworkRack"]:
        ...
        cls: ClsType[_models.NetworkRackListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("NetworkRackListResult", pipeline_response)
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.NetworkRack"]:
    ...
    def get(self, resource_group_name: str, network_rack_name: str, **kwargs: Any) -> _models.NetworkRack:
        ...
        deserialized = self._deserialize("NetworkRack", pipeline_response.http_response)
    ...
    def _create_initial(
        ...
        resource: Union[_models.NetworkRack, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "NetworkRack")
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param network_rack_name: Name of the Network Rack. Required.
        :type network_rack_name: str
        :param resource: Request payload. Is either a NetworkRack type or a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.NetworkRack or IO[bytes]
        :return: An instance of LROPoller that returns either NetworkRack or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.NetworkRack]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        network_rack_name: str,
        properties: Union[_models.NetworkRackPatch, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "NetworkRackPatch")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param network_rack_name: Name of the Network Rack. Required.
        :type network_rack_name: str
        :param properties: Network Rack properties to update. Is either a NetworkRackPatch type or a
         IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.NetworkRackPatch or IO[bytes]
        :return: An instance of LROPoller that returns either NetworkRack or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.NetworkRack]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _delete_initial(self, resource_group_name: str, network_rack_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
