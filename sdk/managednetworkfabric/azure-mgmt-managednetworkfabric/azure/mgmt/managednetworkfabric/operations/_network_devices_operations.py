...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "networkDeviceName": _SERIALIZER.url(
            "network_device_name", network_device_name, "str", pattern=r"^[a-zA-Z]{1}[a-zA-Z0-9-_]{2,127}$"
        ),
    }
...
def build_run_ro_command_request(
    resource_group_name: str, network_device_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_run_rw_command_request(
    resource_group_name: str, network_device_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class NetworkDevicesOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.NetworkDevice"]:
        ...
        cls: ClsType[_models.NetworkDeviceListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("NetworkDeviceListResult", pipeline_response)
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.NetworkDevice"]:
    ...
    def get(self, resource_group_name: str, network_device_name: str, **kwargs: Any) -> _models.NetworkDevice:
        ...
        deserialized = self._deserialize("NetworkDevice", pipeline_response.http_response)
    ...
    def _create_initial(
        ...
        resource: Union[_models.NetworkDevice, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "NetworkDevice")
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param network_device_name: Name of the Network Device. Required.
        :type network_device_name: str
        :param resource: Request payload. Is either a NetworkDevice type or a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.NetworkDevice or IO[bytes]
        :return: An instance of LROPoller that returns either NetworkDevice or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.NetworkDevice]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.NetworkDevice].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.NetworkDevice](
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        network_device_name: str,
        properties: Union[_models.NetworkDevicePatchParameters, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "NetworkDevicePatchParameters")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param network_device_name: Name of the Network Device. Required.
        :type network_device_name: str
        :param properties: Network Device properties to update. Is either a
         NetworkDevicePatchParameters type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.NetworkDevicePatchParameters or
         IO[bytes]
        :return: An instance of LROPoller that returns either NetworkDevice or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.NetworkDevice]
    ...
    def _delete_initial(self, resource_group_name: str, network_device_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def _reboot_initial(
        ...
        resource_group_name: str,
        network_device_name: str,
        body: Union[_models.RebootProperties, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_reboot(
        ...
        **kwargs: Any
        ...
        :param network_device_name: Name of the Network Device. Required.
        :type network_device_name: str
        :param body: Request payload. Is either a RebootProperties type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.RebootProperties or IO[bytes]
        :return: An instance of LROPoller that returns either CommonPostActionResponseForStateUpdate or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.CommonPostActionResponseForStateUpdate]
    ...
    def _run_ro_command_initial(
        self,
        resource_group_name: str,
        network_device_name: str,
        body: Union[_models.DeviceRoCommand, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "DeviceRoCommand")

        _request = build_run_ro_command_request(
            resource_group_name=resource_group_name,
            network_device_name=network_device_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_run_ro_command(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.CommonPostActionResponseForDeviceROCommandsOperationStatusResult]:
        ...
        :return: An instance of LROPoller that returns either
         CommonPostActionResponseForDeviceROCommandsOperationStatusResult or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.CommonPostActionResponseForDeviceROCommandsOperationStatusResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_run_ro_command(
        ...
        **kwargs: Any
        ...
        :param network_device_name: Name of the Network Device. Required.
        :type network_device_name: str
        :param body: Request the command. Is either a DeviceRoCommand type or a IO[bytes] type.
         Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.DeviceRoCommand or IO[bytes]
        :return: An instance of LROPoller that returns either
         CommonPostActionResponseForDeviceROCommandsOperationStatusResult or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.CommonPostActionResponseForDeviceROCommandsOperationStatusResult]
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._run_ro_command_initial(
                resource_group_name=resource_group_name,
                network_device_name=network_device_name,
                body=body,
                api_version=api_version,
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize(
                "CommonPostActionResponseForDeviceROCommandsOperationStatusResult", pipeline_response.http_response
            )
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        return LROPoller[_models.CommonPostActionResponseForDeviceROCommandsOperationStatusResult](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    def _run_rw_command_initial(
        self,
        resource_group_name: str,
        network_device_name: str,
        body: Union[_models.DeviceRwCommand, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "DeviceRwCommand")

        _request = build_run_rw_command_request(
            resource_group_name=resource_group_name,
            network_device_name=network_device_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_run_rw_command(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.CommonPostActionResponseForDeviceRWCommands]:
        ...
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either
         CommonPostActionResponseForDeviceRWCommands or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.CommonPostActionResponseForDeviceRWCommands]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_run_rw_command(
        ...
        **kwargs: Any
        ...
        :param network_device_name: Name of the Network Device. Required.
        :type network_device_name: str
        :param body: Request the command. Is either a DeviceRwCommand type or a IO[bytes] type.
         Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.DeviceRwCommand or IO[bytes]
        :return: An instance of LROPoller that returns either
         CommonPostActionResponseForDeviceRWCommands or the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.CommonPostActionResponseForDeviceRWCommands]
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._run_rw_command_initial(
                resource_group_name=resource_group_name,
                network_device_name=network_device_name,
                body=body,
                api_version=api_version,
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize(
                "CommonPostActionResponseForDeviceRWCommands", pipeline_response.http_response
            )
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.CommonPostActionResponseForDeviceRWCommands].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.CommonPostActionResponseForDeviceRWCommands](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    def _update_administrative_state_initial(
        ...
        resource_group_name: str,
        network_device_name: str,
        body: Union[_models.UpdateDeviceAdministrativeState, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_update_administrative_state(
        ...
        **kwargs: Any
        ...
        :param network_device_name: Name of the Network Device. Required.
        :type network_device_name: str
        :param body: Request payload. Is either a UpdateDeviceAdministrativeState type or a IO[bytes]
         type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.UpdateDeviceAdministrativeState or
         IO[bytes]
        :return: An instance of LROPoller that returns either CommonPostActionResponseForStateUpdate or
         the result of cls(response)
        :rtype:
    ...
    def _upgrade_initial(
        ...
        resource_group_name: str,
        network_device_name: str,
        body: Union[_models.UpdateVersion, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_upgrade(
        ...
        **kwargs: Any
        ...
        :param network_device_name: Name of the Network Device. Required.
        :type network_device_name: str
        :param body: Request payload. Is either a UpdateVersion type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.UpdateVersion or IO[bytes]
        :return: An instance of LROPoller that returns either CommonPostActionResponseForStateUpdate or
         the result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.CommonPostActionResponseForStateUpdate]
