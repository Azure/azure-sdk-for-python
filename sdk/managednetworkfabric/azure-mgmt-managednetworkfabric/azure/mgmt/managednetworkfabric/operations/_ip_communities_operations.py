...
class IpCommunitiesOperations:
    ...
    def _create_initial(
        ...
        body: Union[_models.IpCommunity, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param ip_community_name: Name of the IP Community. Required.
        :type ip_community_name: str
        :param body: Request payload. Is either a IpCommunity type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.IpCommunity or IO[bytes]
        :return: An instance of LROPoller that returns either IpCommunity or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.IpCommunity]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        ip_community_name: str,
        body: Union[_models.IpCommunityPatch, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param ip_community_name: Name of the IP Community. Required.
        :type ip_community_name: str
        :param body: IP Community properties to update. Is either a IpCommunityPatch type or a
         IO[bytes] type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.IpCommunityPatch or IO[bytes]
        :return: An instance of LROPoller that returns either IpCommunity or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.IpCommunity]
        :raises ~azure.core.exceptions.HttpResponseError:
