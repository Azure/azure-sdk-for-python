...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "ipCommunityName": _SERIALIZER.url(
            "ip_community_name", ip_community_name, "str", pattern=r"^[a-zA-Z]{1}[a-zA-Z0-9-_]{2,127}$"
        ),
    }
...
class IpCommunitiesOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.IpCommunity"]:
        ...
        cls: ClsType[_models.IpCommunityListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("IpCommunityListResult", pipeline_response)
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.IpCommunity"]:
    ...
    def get(self, resource_group_name: str, ip_community_name: str, **kwargs: Any) -> _models.IpCommunity:
        ...
        deserialized = self._deserialize("IpCommunity", pipeline_response.http_response)
    ...
    def _create_initial(
        ...
        resource: Union[_models.IpCommunity, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "IpCommunity")
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param ip_community_name: Name of the IP Community. Required.
        :type ip_community_name: str
        :param resource: Request payload. Is either a IpCommunity type or a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.IpCommunity or IO[bytes]
        :return: An instance of LROPoller that returns either IpCommunity or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.IpCommunity]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.IpCommunity].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.IpCommunity](
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        ip_community_name: str,
        properties: Union[_models.IpCommunityPatch, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "IpCommunityPatch")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param ip_community_name: Name of the IP Community. Required.
        :type ip_community_name: str
        :param properties: IP Community properties to update. Is either a IpCommunityPatch type or a
         IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.IpCommunityPatch or IO[bytes]
        :return: An instance of LROPoller that returns either IpCommunity or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.IpCommunity]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def _delete_initial(self, resource_group_name: str, ip_community_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
