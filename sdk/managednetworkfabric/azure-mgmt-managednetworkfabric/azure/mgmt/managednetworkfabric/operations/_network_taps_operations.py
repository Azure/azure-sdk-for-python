...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ManagedNetworkFabric/networkTaps"
    )
...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "networkTapName": _SERIALIZER.url(
            "network_tap_name", network_tap_name, "str", pattern=r"^[a-zA-Z]{1}[a-zA-Z0-9-_]{2,127}$"
        ),
    }
...
class NetworkTapsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.NetworkTap"]:
        ...
        cls: ClsType[_models.NetworkTapListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("NetworkTapListResult", pipeline_response)
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.NetworkTap"]:
    ...
    def get(self, resource_group_name: str, network_tap_name: str, **kwargs: Any) -> _models.NetworkTap:
        ...
        deserialized = self._deserialize("NetworkTap", pipeline_response.http_response)
    ...
    def _create_initial(
        ...
        resource: Union[_models.NetworkTap, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "NetworkTap")
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param network_tap_name: Name of the Network Tap. Required.
        :type network_tap_name: str
        :param resource: Request payload. Is either a NetworkTap type or a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.NetworkTap or IO[bytes]
        :return: An instance of LROPoller that returns either NetworkTap or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.NetworkTap]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        network_tap_name: str,
        properties: Union[_models.NetworkTapPatch, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "NetworkTapPatch")
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param network_tap_name: Name of the Network Tap. Required.
        :type network_tap_name: str
        :param properties: Network Tap properties to update. Is either a NetworkTapPatch type or a
         IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.NetworkTapPatch or IO[bytes]
        :return: An instance of LROPoller that returns either NetworkTap or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.NetworkTap]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def _delete_initial(self, resource_group_name: str, network_tap_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def _resync_initial(self, resource_group_name: str, network_tap_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
