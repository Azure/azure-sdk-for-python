...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "networkFabricName": _SERIALIZER.url(
            "network_fabric_name", network_fabric_name, "str", pattern=r"^[a-zA-Z]{1}[a-zA-Z0-9-_]{2,127}$"
        ),
    }
...
def build_arm_configuration_diff_request(
    resource_group_name: str, network_fabric_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_commit_batch_status_request(
    resource_group_name: str, network_fabric_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_discard_commit_batch_request(
    resource_group_name: str, network_fabric_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_infra_management_bfd_configuration_request(  # pylint: disable=name-too-long
    resource_group_name: str, network_fabric_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_workload_management_bfd_configuration_request(  # pylint: disable=name-too-long
    resource_group_name: str, network_fabric_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_view_device_configuration_request(
    resource_group_name: str, network_fabric_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class NetworkFabricsOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.NetworkFabric"]:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.NetworkFabric"]:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.NetworkFabric].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.NetworkFabric](
    ...
    def _delete_initial(self, resource_group_name: str, network_fabric_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def _arm_configuration_diff_initial(
    ...
    @distributed_trace
    def begin_arm_configuration_diff(
        self, resource_group_name: str, network_fabric_name: str, **kwargs: Any
    ) -> LROPoller[_models.ArmConfigurationDiffResponse]:
        ...
        :param network_fabric_name: Name of the Network Fabric. Required.
        :type network_fabric_name: str
        :return: An instance of LROPoller that returns either ArmConfigurationDiffResponse or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.ArmConfigurationDiffResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._arm_configuration_diff_initial(
                resource_group_name=resource_group_name,
                network_fabric_name=network_fabric_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.ArmConfigurationDiffResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ArmConfigurationDiffResponse](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    def _commit_batch_status_initial(
        self,
        resource_group_name: str,
        network_fabric_name: str,
    ...
    def begin_commit_batch_status(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.CommitBatchStatusResponse]:
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either CommitBatchStatusResponse or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.CommitBatchStatusResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_commit_batch_status(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._commit_batch_status_initial(
                resource_group_name=resource_group_name,
                network_fabric_name=network_fabric_name,
                body=body,
                api_version=api_version,
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.CommitBatchStatusResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.CommitBatchStatusResponse](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    def _discard_commit_batch_initial(
        self,
        resource_group_name: str,
        network_fabric_name: str,
    ...
    @overload
    def begin_discard_commit_batch(
        self,
        resource_group_name: str,
        network_fabric_name: str,
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.DiscardCommitBatchResponse]:
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either DiscardCommitBatchResponse or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.DiscardCommitBatchResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_discard_commit_batch(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._discard_commit_batch_initial(
                resource_group_name=resource_group_name,
                network_fabric_name=network_fabric_name,
                body=body,
                api_version=api_version,
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.DiscardCommitBatchResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.DiscardCommitBatchResponse](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    def begin_lock_fabric(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._lock_fabric_initial(
                resource_group_name=resource_group_name,
                network_fabric_name=network_fabric_name,
                body=body,
                api_version=api_version,
    ...
    def _provision_initial(self, resource_group_name: str, network_fabric_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def _update_infra_management_bfd_configuration_initial(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        network_fabric_name: str,
    ...
    @overload
    def begin_update_infra_management_bfd_configuration(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        network_fabric_name: str,
    ...
    def _update_workload_management_bfd_configuration_initial(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        network_fabric_name: str,
        body: Union[_models.UpdateAdministrativeState, IO[bytes]],
    ...
    @overload
    def begin_update_workload_management_bfd_configuration(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        network_fabric_name: str,
        body: _models.UpdateAdministrativeState,
    ...
    def _view_device_configuration_initial(
        self, resource_group_name: str, network_fabric_name: str, **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    @distributed_trace
    def begin_view_device_configuration(
        self, resource_group_name: str, network_fabric_name: str, **kwargs: Any
    ) -> LROPoller[_models.ViewDeviceConfigurationResponse]:
        ...
        :param network_fabric_name: Name of the Network Fabric. Required.
        :type network_fabric_name: str
        :return: An instance of LROPoller that returns either ViewDeviceConfigurationResponse or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.ViewDeviceConfigurationResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._view_device_configuration_initial(
                resource_group_name=resource_group_name,
                network_fabric_name=network_fabric_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.ViewDeviceConfigurationResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.ViewDeviceConfigurationResponse](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
