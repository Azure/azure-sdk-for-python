...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "l2IsolationDomainName": _SERIALIZER.url(
            "l2_isolation_domain_name", l2_isolation_domain_name, "str", pattern=r"^[a-zA-Z]{1}[a-zA-Z0-9-_]{2,127}$"
        ),
    }
...
class L2IsolationDomainsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.L2IsolationDomain"]:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.L2IsolationDomain"]:
