...
from ._configuration import AzureNetworkFabricManagementServiceAPIConfiguration
...
class AzureNetworkFabricManagementServiceAPI:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = AzureNetworkFabricManagementServiceAPIConfiguration(
    ...
    def __enter__(self) -> "AzureNetworkFabricManagementServiceAPI":
