...
class AclType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    """AclType Management."""
    CONTROL_PLANE_ACL = "ControlPlaneAcl"
...
class AdministrativeState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    ENABLED_DEGRADED = "EnabledDegraded"
...
class CommitConfigurationPolicy(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Indicates Commit configuration staging policy. Supported policy is StageCEConfiguration, which
    indicates to prepare the configuration for the CE device type.
    """

    STAGE_CE_CONFIGURATION = "StageCEConfiguration"
    """CommitConfigurationPolicy-StageCEConfiguration."""


class CommitStage(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Commit stage Action to be performed."""

    START = "Start"
    """CommitStage-Start indicates to prepare the device configuration for the devices which is
    decided by policy type."""
    CONTINUE = "Continue"
    """CommitStage-Continue indicates to push the configuration to the devices provided. Either CE1 or
    CE2 is allowed."""
    ROLLBACK = "Rollback"
    """CommitStage-Rollback indicates to revert to the previous configuration for the devices to which
    configuration is pushed as part of staging."""
...
class ConfigurationState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    PENDING_ADMINISTRATIVE_UPDATE = "PendingAdministrativeUpdate"
...
class ControlPlaneAclActionType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class ControlPlaneAclPortMatchType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class ControlPlaneAclTtlMatchType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class QosConfigurationState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class SynchronizationStatus(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Synchronization status of a secret or certificate for a device (Network Device or Terminal
    Server). Whether the device has been configured with the latest version of the secret or
    certificate.
    """
    ...
    While in this state, the secret archive reference may not match the secret configured on the
    device."""
