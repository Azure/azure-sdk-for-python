...
class ArmConfigurationDiffResponse(CommonErrorResponse):
...
class CommitBatchStatusResponse(CommonErrorResponse):
...
class CommonPostActionResponseForDeviceRWCommands(CommonErrorResponse):  # pylint: disable=name-too-long
...
class DiscardCommitBatchResponse(CommonErrorResponse):
...
class ExternalNetworkBfdAdministrativeStateResponse(CommonErrorResponse):  # pylint: disable=name-too-long
...
class InternalNetworkBfdAdministrativeStateResponse(CommonErrorResponse):  # pylint: disable=name-too-long
...
class InternalNetworkBgpAdministrativeStateResponse(CommonErrorResponse):  # pylint: disable=name-too-long
...
class NetworkInterfacePatch(_Model):
    ...
    __flattened_items = ["annotation", "description", "additional_description"]
...
class NniBfdAdministrativeStateResponse(CommonErrorResponse):
...
class ViewDeviceConfigurationResponse(CommonErrorResponse):
