...
class AzureNetworkFabricManagementServiceAPIConfiguration(
    Configuration
):  # pylint: disable=too-many-instance-attributes
    """Configuration for AzureNetworkFabricManagementServiceAPI.
    ...
    def __init__(self, credential: "AsyncTokenCredential", subscription_id: str, **kwargs: Any) -> None:
        super(AzureNetworkFabricManagementServiceAPIConfiguration, self).__init__(**kwargs)
