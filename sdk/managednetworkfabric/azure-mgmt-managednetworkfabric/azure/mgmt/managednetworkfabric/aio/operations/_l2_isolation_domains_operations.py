...
class L2IsolationDomainsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.L2IsolationDomain"]:
        ...
        cls: ClsType[_models.L2IsolationDomainListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("L2IsolationDomainListResult", pipeline_response)
    ...
    async def get(
        ...
        deserialized = self._deserialize("L2IsolationDomain", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        resource: Union[_models.L2IsolationDomain, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "L2IsolationDomain")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param l2_isolation_domain_name: Name of the L2 Isolation Domain. Required.
        :type l2_isolation_domain_name: str
        :param resource: Request payload. Is either a L2IsolationDomain type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.L2IsolationDomain or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either L2IsolationDomain or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.L2IsolationDomain]
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        l2_isolation_domain_name: str,
        properties: Union[_models.L2IsolationDomainPatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "L2IsolationDomainPatch")
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param properties: API to update certain properties of the L2 Isolation Domain resource.. Is
         either a L2IsolationDomainPatch type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.L2IsolationDomainPatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either L2IsolationDomain or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.L2IsolationDomain]
