...
class NetworkTapRulesOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.NetworkTapRule"]:
        ...
        cls: ClsType[_models.NetworkTapRuleListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("NetworkTapRuleListResult", pipeline_response)
    ...
    async def get(self, resource_group_name: str, network_tap_rule_name: str, **kwargs: Any) -> _models.NetworkTapRule:
        ...
        deserialized = self._deserialize("NetworkTapRule", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        resource: Union[_models.NetworkTapRule, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "NetworkTapRule")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param network_tap_rule_name: Name of the Network Tap Rule. Required.
        :type network_tap_rule_name: str
        :param resource: Request payload. Is either a NetworkTapRule type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.NetworkTapRule or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkTapRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.NetworkTapRule]
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        network_tap_rule_name: str,
        properties: Union[_models.NetworkTapRulePatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "NetworkTapRulePatch")
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param network_tap_rule_name: Name of the Network Tap Rule. Required.
        :type network_tap_rule_name: str
        :param properties: Network Tap Rule properties to update. Is either a NetworkTapRulePatch type
         or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.NetworkTapRulePatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkTapRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.NetworkTapRule]
