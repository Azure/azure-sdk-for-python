...
class NetworkTapRulesOperations:
    ...
    async def _create_initial(
        ...
        body: Union[_models.NetworkTapRule, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param network_tap_rule_name: Name of the Network Tap Rule. Required.
        :type network_tap_rule_name: str
        :param body: Request payload. Is either a NetworkTapRule type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.NetworkTapRule or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkTapRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.NetworkTapRule]
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        network_tap_rule_name: str,
        body: Union[_models.NetworkTapRulePatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.managednetworkfabric.models.NetworkTapRulePatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkTapRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.NetworkTapRule]
