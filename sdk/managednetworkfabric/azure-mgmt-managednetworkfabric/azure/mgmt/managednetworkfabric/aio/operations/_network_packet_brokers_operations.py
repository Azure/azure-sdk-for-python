...
class NetworkPacketBrokersOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.NetworkPacketBroker"]:
        ...
        cls: ClsType[_models.NetworkPacketBrokerListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("NetworkPacketBrokerListResult", pipeline_response)
    ...
    async def get(
        ...
        deserialized = self._deserialize("NetworkPacketBroker", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        resource: Union[_models.NetworkPacketBroker, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "NetworkPacketBroker")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param network_packet_broker_name: Name of the Network Packet Broker. Required.
        :type network_packet_broker_name: str
        :param resource: Request payload. Is either a NetworkPacketBroker type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.NetworkPacketBroker or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkPacketBroker or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.NetworkPacketBroker]
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        network_packet_broker_name: str,
        properties: Union[_models.NetworkPacketBrokerPatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "NetworkPacketBrokerPatch")
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param network_packet_broker_name: Name of the Network Packet Broker. Required.
        :type network_packet_broker_name: str
        :param properties: Network Packet Broker properties to update. Is either a
         NetworkPacketBrokerPatch type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.NetworkPacketBrokerPatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkPacketBroker or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.NetworkPacketBroker]
