...
class InternetGatewayRulesOperations:
    ...
    async def _create_initial(
        ...
        body: Union[_models.InternetGatewayRule, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param internet_gateway_rule_name: Name of the Internet Gateway rule. Required.
        :type internet_gateway_rule_name: str
        :param body: Request payload. Is either a InternetGatewayRule type or a IO[bytes] type.
         Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.InternetGatewayRule or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either InternetGatewayRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.InternetGatewayRule]
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        internet_gateway_rule_name: str,
        body: Union[_models.InternetGatewayRulePatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.managednetworkfabric.models.InternetGatewayRulePatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either InternetGatewayRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.InternetGatewayRule]
