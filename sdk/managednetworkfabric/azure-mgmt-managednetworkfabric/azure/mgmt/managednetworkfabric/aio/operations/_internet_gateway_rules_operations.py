...
class InternetGatewayRulesOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.InternetGatewayRule"]:
        ...
        cls: ClsType[_models.InternetGatewayRuleListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("InternetGatewayRuleListResult", pipeline_response)
    ...
    async def get(
        ...
        deserialized = self._deserialize("InternetGatewayRule", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        resource: Union[_models.InternetGatewayRule, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "InternetGatewayRule")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param internet_gateway_rule_name: Name of the Internet Gateway rule. Required.
        :type internet_gateway_rule_name: str
        :param resource: Request payload. Is either a InternetGatewayRule type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.InternetGatewayRule or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either InternetGatewayRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.InternetGatewayRule]
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        internet_gateway_rule_name: str,
        properties: Union[_models.InternetGatewayRulePatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "InternetGatewayRulePatch")
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param internet_gateway_rule_name: Name of the Internet Gateway rule. Required.
        :type internet_gateway_rule_name: str
        :param properties: Internet Gateway Rule properties to update. Is either a
         InternetGatewayRulePatch type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.InternetGatewayRulePatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either InternetGatewayRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.InternetGatewayRule]
