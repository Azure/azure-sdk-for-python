...
from ...operations._network_fabric_skus_operations import build_get_request, build_list_by_subscription_request
...
class NetworkFabricSkusOperations:
    ...
    async def get(self, network_fabric_sku_name: str, **kwargs: Any) -> _models.NetworkFabricSku:
        ...
        deserialized = self._deserialize("NetworkFabricSku", pipeline_response)
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.NetworkFabricSku"]:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.NetworkFabricSkusListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("NetworkFabricSkusListResult", pipeline_response)
    ...
    list_by_subscription.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.ManagedNetworkFabric/networkFabricSkus"
    }
