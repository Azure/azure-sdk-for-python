...
class NetworkFabricControllersOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.NetworkFabricController"]:
        ...
        cls: ClsType[_models.NetworkFabricControllerListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("NetworkFabricControllerListResult", pipeline_response)
    ...
    async def get(
        ...
        deserialized = self._deserialize("NetworkFabricController", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        resource: Union[_models.NetworkFabricController, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "NetworkFabricController")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param network_fabric_controller_name: Name of the Network Fabric Controller. Required.
        :type network_fabric_controller_name: str
        :param resource: Request payload. Is either a NetworkFabricController type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.NetworkFabricController or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkFabricController or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.NetworkFabricController]
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        network_fabric_controller_name: str,
        properties: Union[_models.NetworkFabricControllerPatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "NetworkFabricControllerPatch")
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param network_fabric_controller_name: Name of the Network Fabric Controller. Required.
        :type network_fabric_controller_name: str
        :param properties: Network Fabric Controller properties to update. Is either a
         NetworkFabricControllerPatch type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.NetworkFabricControllerPatch or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkFabricController or the
         result of cls(response)
        :rtype:
