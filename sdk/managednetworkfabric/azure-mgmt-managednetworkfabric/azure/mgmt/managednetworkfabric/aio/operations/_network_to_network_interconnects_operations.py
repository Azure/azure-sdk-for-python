...
from ...operations._network_to_network_interconnects_operations import (
    ...
    build_update_bfd_administrative_state_request,
...
class NetworkToNetworkInterconnectsOperations:
    ...
    def list_by_network_fabric(
        ...
        cls: ClsType[_models.NetworkToNetworkInterconnectListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("NetworkToNetworkInterconnectListResult", pipeline_response)
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("NetworkToNetworkInterconnect", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        network_fabric_name: str,
        network_to_network_interconnect_name: str,
        resource: Union[_models.NetworkToNetworkInterconnect, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "NetworkToNetworkInterconnect")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param network_to_network_interconnect_name: Name of the Network to Network Interconnect.
         Required.
        :type network_to_network_interconnect_name: str
        :param resource: Request payload. Is either a NetworkToNetworkInterconnect type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.NetworkToNetworkInterconnect or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkToNetworkInterconnect or the
         result of cls(response)
        :rtype:
    ...
    async def _update_initial(
        ...
        network_fabric_name: str,
        network_to_network_interconnect_name: str,
        properties: Union[_models.NetworkToNetworkInterconnectPatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "NetworkToNetworkInterconnectPatch")
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param network_to_network_interconnect_name: Name of the Network to Network Interconnect.
         Required.
        :type network_to_network_interconnect_name: str
        :param properties: Network to Network Interconnect properties to update. Is either a
    ...
    async def _update_bfd_administrative_state_initial(
        ...
        network_fabric_name: str,
        network_to_network_interconnect_name: str,
        body: Union[_models.NniBfdAdministrativeStateRequest, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "NniBfdAdministrativeStateRequest")

        _request = build_update_bfd_administrative_state_request(
            resource_group_name=resource_group_name,
            network_fabric_name=network_fabric_name,
            network_to_network_interconnect_name=network_to_network_interconnect_name,
            subscription_id=self._config.subscription_id,
    ...
    async def begin_update_bfd_administrative_state(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either NniBfdAdministrativeStateResponse or
    ...
    async def begin_update_bfd_administrative_state(
        ...
        **kwargs: Any
        ...
        :param network_to_network_interconnect_name: Name of the Network to Network Interconnect.
         Required.
        :type network_to_network_interconnect_name: str
        :param body: Request payload. Is either a NniBfdAdministrativeStateRequest type or a IO[bytes]
         type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.NniBfdAdministrativeStateRequest or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NniBfdAdministrativeStateResponse or
         the result of cls(response)
        :rtype:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("NniBfdAdministrativeStateResponse", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
