...
class ExternalNetworksOperations:
    ...
    def list_by_l3_isolation_domain(
        ...
        cls: ClsType[_models.ExternalNetworkListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("ExternalNetworkListResult", pipeline_response)
    ...
    async def get(
        ...
        deserialized = self._deserialize("ExternalNetwork", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        resource: Union[_models.ExternalNetwork, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "ExternalNetwork")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either ExternalNetwork or the result of
         cls(response)
        :rtype:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param external_network_name: Name of the External Network. Required.
        :type external_network_name: str
        :param resource: Request payload. Is either a ExternalNetwork type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.ExternalNetwork or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ExternalNetwork or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.ExternalNetwork]
    ...
    async def _update_initial(
        ...
        l3_isolation_domain_name: str,
        external_network_name: str,
        properties: Union[_models.ExternalNetworkPatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "ExternalNetworkPatch")
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param external_network_name: Name of the External Network. Required.
        :type external_network_name: str
        :param properties: ExternalNetwork properties to update. Only annotations are supported. Is
         either a ExternalNetworkPatch type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.ExternalNetworkPatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either ExternalNetwork or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.ExternalNetwork]
    ...
    async def _update_bfd_administrative_state_initial(
        ...
        l3_isolation_domain_name: str,
        external_network_name: str,
        body: Union[_models.ExternalNetworkBfdAdministrativeStateRequest, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "ExternalNetworkBfdAdministrativeStateRequest")
    ...
    async def begin_update_bfd_administrative_state(
        ...
        **kwargs: Any
        ...
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns either
         ExternalNetworkBfdAdministrativeStateResponse or the result of cls(response)
        :rtype:
    ...
    async def begin_update_bfd_administrative_state(
        ...
        **kwargs: Any
        ...
        :param external_network_name: Name of the External Network. Required.
        :type external_network_name: str
        :param body: Request payload. Is either a ExternalNetworkBfdAdministrativeStateRequest type or
         a IO[bytes] type. Required.
        :type body:
         ~azure.mgmt.managednetworkfabric.models.ExternalNetworkBfdAdministrativeStateRequest or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either
         ExternalNetworkBfdAdministrativeStateResponse or the result of cls(response)
        :rtype:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize(
                "ExternalNetworkBfdAdministrativeStateResponse", pipeline_response.http_response
            )
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
