...
class RoutePoliciesOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.RoutePolicy"]:
        ...
        cls: ClsType[_models.RoutePolicyListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("RoutePolicyListResult", pipeline_response)
    ...
    async def get(self, resource_group_name: str, route_policy_name: str, **kwargs: Any) -> _models.RoutePolicy:
        ...
        deserialized = self._deserialize("RoutePolicy", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        resource: Union[_models.RoutePolicy, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "RoutePolicy")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param route_policy_name: Name of the Route Policy. Required.
        :type route_policy_name: str
        :param resource: Request payload. Is either a RoutePolicy type or a IO[bytes] type. Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.RoutePolicy or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either RoutePolicy or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.RoutePolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        route_policy_name: str,
        properties: Union[_models.RoutePolicyPatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "RoutePolicyPatch")
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param route_policy_name: Name of the Route Policy. Required.
        :type route_policy_name: str
        :param properties: Route Policy properties to update. Is either a RoutePolicyPatch type or a
         IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.RoutePolicyPatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either RoutePolicy or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.RoutePolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
