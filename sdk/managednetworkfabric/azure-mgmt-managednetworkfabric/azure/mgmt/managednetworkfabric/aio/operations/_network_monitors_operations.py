...
from ...operations._network_monitors_operations import (
...
class NetworkMonitorsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.NetworkMonitor"]:
        ...
        :return: An iterator like instance of either NetworkMonitor or the result of cls(response)
        :rtype:
        ...
        cls: ClsType[_models.NetworkMonitorListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("NetworkMonitorListResult", pipeline_response)
    ...
    async def get(self, resource_group_name: str, network_monitor_name: str, **kwargs: Any) -> _models.NetworkMonitor:
        ...
        :return: NetworkMonitor or the result of cls(response)
        ...
        deserialized = self._deserialize("NetworkMonitor", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        resource: Union[_models.NetworkMonitor, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "NetworkMonitor")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either NetworkMonitor or the result of
         cls(response)
        :rtype:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param network_monitor_name: Name of the Network Monitor. Required.
        :type network_monitor_name: str
        :param resource: Resource create parameters. Is either a NetworkMonitor type or a IO[bytes]
         type. Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.NetworkMonitor or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkMonitor or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.NetworkMonitor]
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        network_monitor_name: str,
        properties: Union[_models.NetworkMonitorPatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "NetworkMonitorPatch")
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param network_monitor_name: Name of the Network Monitor. Required.
        :type network_monitor_name: str
        :param properties: The resource properties to be updated. Is either a NetworkMonitorPatch type
         or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.NetworkMonitorPatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkMonitor or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.NetworkMonitor]
