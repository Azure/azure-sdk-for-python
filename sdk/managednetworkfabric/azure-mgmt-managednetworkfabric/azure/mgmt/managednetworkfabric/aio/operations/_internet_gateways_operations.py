...
class InternetGatewaysOperations:
    ...
    async def _create_initial(
        ...
        body: Union[_models.InternetGateway, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param internet_gateway_name: Name of the Internet Gateway. Required.
        :type internet_gateway_name: str
        :param body: Request payload. Is either a InternetGateway type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.InternetGateway or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either InternetGateway or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.InternetGateway]
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        internet_gateway_name: str,
        body: Union[_models.InternetGatewayPatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param body: API to update certain properties of the L2 Isolation Domain resource.. Is either a
         InternetGatewayPatch type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.InternetGatewayPatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either InternetGateway or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.InternetGateway]
