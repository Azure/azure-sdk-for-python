...
class InternetGatewaysOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.InternetGateway"]:
        ...
        cls: ClsType[_models.InternetGatewayListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("InternetGatewayListResult", pipeline_response)
    ...
    async def get(self, resource_group_name: str, internet_gateway_name: str, **kwargs: Any) -> _models.InternetGateway:
        ...
        deserialized = self._deserialize("InternetGateway", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        resource: Union[_models.InternetGateway, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "InternetGateway")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param internet_gateway_name: Name of the Internet Gateway. Required.
        :type internet_gateway_name: str
        :param resource: Request payload. Is either a InternetGateway type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.InternetGateway or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either InternetGateway or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.InternetGateway]
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        internet_gateway_name: str,
        properties: Union[_models.InternetGatewayPatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "InternetGatewayPatch")
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param internet_gateway_name: Name of the Internet Gateway. Required.
        :type internet_gateway_name: str
        :param properties: API to update certain properties of the InternetGateway resource.. Is either
         a InternetGatewayPatch type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.InternetGatewayPatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either InternetGateway or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.InternetGateway]
