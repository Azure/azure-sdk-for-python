...
class L3IsolationDomainsOperations:
    ...
    async def _create_initial(
        ...
        body: Union[_models.L3IsolationDomain, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param l3_isolation_domain_name: Name of the L3 Isolation Domain. Required.
        :type l3_isolation_domain_name: str
        :param body: Request payload. Is either a L3IsolationDomain type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.L3IsolationDomain or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either L3IsolationDomain or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.L3IsolationDomain]
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        l3_isolation_domain_name: str,
        body: Union[_models.L3IsolationDomainPatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param body: API to update certain properties of the L3 Isolation Domain resource. Is either a
         L3IsolationDomainPatch type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.L3IsolationDomainPatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either L3IsolationDomain or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.L3IsolationDomain]
