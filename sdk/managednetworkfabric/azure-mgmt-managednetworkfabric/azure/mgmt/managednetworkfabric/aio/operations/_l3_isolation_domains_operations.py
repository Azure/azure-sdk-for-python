...
class L3IsolationDomainsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncItemPaged["_models.L3IsolationDomain"]:
        ...
        cls: ClsType[_models.L3IsolationDomainListResult] = kwargs.pop("cls", None)
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize("L3IsolationDomainListResult", pipeline_response)
    ...
    async def get(
        ...
        deserialized = self._deserialize("L3IsolationDomain", pipeline_response.http_response)
    ...
    async def _create_initial(
        ...
        resource: Union[_models.L3IsolationDomain, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "L3IsolationDomain")
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param l3_isolation_domain_name: Name of the L3 Isolation Domain. Required.
        :type l3_isolation_domain_name: str
        :param resource: Request payload. Is either a L3IsolationDomain type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.L3IsolationDomain or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either L3IsolationDomain or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.L3IsolationDomain]
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        l3_isolation_domain_name: str,
        properties: Union[_models.L3IsolationDomainPatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "L3IsolationDomainPatch")
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param l3_isolation_domain_name: Name of the L3 Isolation Domain. Required.
        :type l3_isolation_domain_name: str
        :param properties: API to update certain properties of the L3 Isolation Domain resource. Is
         either a L3IsolationDomainPatch type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.L3IsolationDomainPatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either L3IsolationDomain or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.L3IsolationDomain]
