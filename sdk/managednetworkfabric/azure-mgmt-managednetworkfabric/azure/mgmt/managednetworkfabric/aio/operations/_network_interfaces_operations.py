...
class NetworkInterfacesOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param network_interface_name: Name of the Network Interface. Required.
        :type network_interface_name: str
        :param resource: Request payload. Is either a NetworkInterface type or a IO[bytes] type.
         Required.
        :type resource: ~azure.mgmt.managednetworkfabric.models.NetworkInterface or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkInterface or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.NetworkInterface]
    ...
    async def _update_initial(
        ...
        network_device_name: str,
        network_interface_name: str,
        properties: Union[_models.NetworkInterfacePatch, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "NetworkInterfacePatch")
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param network_interface_name: Name of the Network Interface. Required.
        :type network_interface_name: str
        :param properties: NetworkInterface properties to update. Only tags are supported. Is either a
         NetworkInterfacePatch type or a IO[bytes] type. Required.
        :type properties: ~azure.mgmt.managednetworkfabric.models.NetworkInterfacePatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either NetworkInterface or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.NetworkInterface]
