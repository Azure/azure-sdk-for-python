...
class ManagedNetworkFabricClient:  # pylint: disable=too-many-instance-attributes
    ...
    :ivar network_bootstrap_devices: NetworkBootstrapDevicesOperations operations
    :vartype network_bootstrap_devices:
     azure.mgmt.managednetworkfabric.operations.NetworkBootstrapDevicesOperations
    :ivar network_bootstrap_interfaces: NetworkBootstrapInterfacesOperations operations
    :vartype network_bootstrap_interfaces:
     azure.mgmt.managednetworkfabric.operations.NetworkBootstrapInterfacesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.network_bootstrap_devices = NetworkBootstrapDevicesOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
        self.network_bootstrap_interfaces = NetworkBootstrapInterfacesOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
