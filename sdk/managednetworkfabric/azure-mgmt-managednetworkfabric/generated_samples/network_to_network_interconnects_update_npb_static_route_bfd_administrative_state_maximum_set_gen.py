...
# USAGE
    python network_to_network_interconnects_update_npb_static_route_bfd_administrative_state_maximum_set_gen.py
...
def main():
    ...
    response = client.network_to_network_interconnects.begin_update_npb_static_route_bfd_administrative_state(
