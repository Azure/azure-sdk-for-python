...
# USAGE
    python network_fabric_controllers_enable_workload_management_network_maximum_set_gen.py
...
def main():
    ...
    client.network_fabric_controllers.begin_enable_workload_management_network(
