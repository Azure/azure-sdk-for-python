...
# USAGE
    python network_devices_update_administrative_state_maximum_set_gen.py
...
def main():
    ...
    response = client.network_devices.begin_update_administrative_state(
        resource_group_name="example-rg",
        network_device_name="example-device",
        body={"resourceIds": [""], "state": "RMA"},
    ).result()
    print(response)
