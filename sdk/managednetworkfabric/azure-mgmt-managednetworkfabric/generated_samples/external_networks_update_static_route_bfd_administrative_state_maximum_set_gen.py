...
# USAGE
    python external_networks_update_static_route_bfd_administrative_state_maximum_set_gen.py
...
def main():
    ...
    response = client.external_networks.begin_update_static_route_bfd_administrative_state(
