...
# USAGE
    python internet_gateway_rules_list_by_resource_group_maximum_set_gen.py
...
def main():
    ...
    response = client.internet_gateway_rules.list_by_resource_group(
        resource_group_name="example-internetGatewayRule",
    )
