...
# USAGE
    python l3_isolation_domains_update_option_badministrative_state_maximum_set_gen.py
...
def main():
    ...
    client.l3_isolation_domains.begin_update_option_b_administrative_state(
