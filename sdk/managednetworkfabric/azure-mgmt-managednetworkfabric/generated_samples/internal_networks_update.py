...
# USAGE
    python internal_networks_update.py
        ...
        properties={
            "properties": {
                ...
                "bgpConfiguration": {
                    ...
                    "bmpConfiguration": {"bmpConfigurationState": "Enabled", "neighborIpExclusions": ["10.0.0.10"]},
                ...
                "nativeIpv4PrefixLimit": {
                    "prefixLimits": [{"idleTimeExpiry": 20, "maximumRoutes": 24, "threshold": 6}]
                },
                ...
                "staticRouteConfiguration": {
                    ...
                    "ipv6Routes": [{"nextHop": ["10.0.0.1"], "prefix": "jffgck"}],
                },
            }
        },
    ).result()
...
# x-ms-original-file: specification/managednetworkfabric/resource-manager/Microsoft.ManagedNetworkFabric/preview/2024-06-15-preview/examples/InternalNetworks_Update.json
