...
# USAGE
    python l3_isolation_domains_clear_neighbor_table_maximum_set_gen.py
...
def main():
    ...
    client.l3_isolation_domains.begin_clear_neighbor_table(
        resource_group_name="resourceGroupName",
        l3_isolation_domain_name="example-l3domain",
        body={"resourceIds": ["wnaxqikneofcni"]},
    ).result()
