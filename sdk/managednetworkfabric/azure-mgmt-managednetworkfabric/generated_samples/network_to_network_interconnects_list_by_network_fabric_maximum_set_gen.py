...
# USAGE
    python network_to_network_interconnects_list_by_network_fabric_maximum_set_gen.py
...
def main():
    ...
    response = client.network_to_network_interconnects.list_by_network_fabric(
