...
# USAGE
    python internal_networks_update_bfd_for_static_route_administrative_state_maximum_set_gen.py
...
def main():
    ...
    client.internal_networks.begin_update_bfd_for_static_route_administrative_state(
