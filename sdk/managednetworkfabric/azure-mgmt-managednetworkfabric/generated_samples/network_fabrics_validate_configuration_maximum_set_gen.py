...
# USAGE
    python network_fabrics_validate_configuration_maximum_set_gen.py
...
def main():
    ...
    response = client.network_fabrics.begin_validate_configuration(
        resource_group_name="example-rg",
        network_fabric_name="example-fabric",
        body={"validateAction": "Cabling"},
    ).result()
    print(response)
