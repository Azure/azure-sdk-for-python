...
# USAGE
    python l2_isolation_domains_clear_neighbor_table_maximum_set_gen.py
...
def main():
    ...
    client.l2_isolation_domains.begin_clear_neighbor_table(
        resource_group_name="rgL2IsolationDomains",
        l2_isolation_domain_name="oz",
        body={
            "resourceIds": [
