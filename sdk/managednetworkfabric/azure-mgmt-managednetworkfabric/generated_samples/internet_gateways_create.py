...
# USAGE
    python internet_gateways_create.py
...
def main():
    ...
    response = client.internet_gateways.begin_create(
...
# x-ms-original-file: specification/managednetworkfabric/resource-manager/Microsoft.ManagedNetworkFabric/preview/2024-06-15-preview/examples/InternetGateways_Create.json
