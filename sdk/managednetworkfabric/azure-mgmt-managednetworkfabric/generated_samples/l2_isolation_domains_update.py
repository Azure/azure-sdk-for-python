...
# USAGE
    python l2_isolation_domains_update.py
...
def main():
    ...
    response = client.l2_isolation_domains.begin_update(
...
# x-ms-original-file: specification/managednetworkfabric/resource-manager/Microsoft.ManagedNetworkFabric/preview/2024-06-15-preview/examples/L2IsolationDomains_Update.json
