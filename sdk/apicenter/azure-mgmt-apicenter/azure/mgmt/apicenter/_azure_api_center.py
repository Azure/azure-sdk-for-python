...
from ._configuration import AzureAPICenterConfiguration
...
class AzureAPICenter:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = AzureAPICenterConfiguration(
    ...
    def __enter__(self) -> "AzureAPICenter":
