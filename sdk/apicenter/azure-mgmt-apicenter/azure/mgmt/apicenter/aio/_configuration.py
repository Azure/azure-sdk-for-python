...
class AzureAPICenterConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    """Configuration for AzureAPICenter.
    ...
    def __init__(
        self, credential: "AsyncTokenCredential", service_name: str, subscription_id: str, **kwargs: Any
    ) -> None:
        super(AzureAPICenterConfiguration, self).__init__(**kwargs)
