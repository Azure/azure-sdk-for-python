...
from ...operations._metadata_schemas_operations import (
...
class MetadataSchemasOperations:
    ...
    ) -> AsyncIterable["_models.MetadataSchema"]:
    ...
    async def get(self, resource_group_name: str, service_name: str, **kwargs: Any) -> _models.MetadataSchema:
        """Get metadata schema.
