...
def build_get_request(
    resource_group_name: str, service_name: str, metadata_schema_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class MetadataSchemasOperations:
    ...
    def list(
    ...
    ) -> Iterable["_models.MetadataSchema"]:
        ...
        cls: ClsType[_models.MetadataSchemaListResult] = kwargs.pop("cls", None)
    ...
    @distributed_trace
    def head(self, resource_group_name: str, service_name: str, metadata_schema_name: str, **kwargs: Any) -> bool:
