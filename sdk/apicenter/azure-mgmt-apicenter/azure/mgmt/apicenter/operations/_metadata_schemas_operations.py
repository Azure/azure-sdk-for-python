...
def build_get_request(
    resource_group_name: str, service_name: str, subscription_id: str, metadata_schema_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "serviceName": _SERIALIZER.url("service_name", service_name, "str", max_length=90, min_length=1),
        "metadataSchemaName": _SERIALIZER.url(
            "metadata_schema_name", metadata_schema_name, "str", max_length=90, min_length=1
        ),
    }
...
class MetadataSchemasOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`metadata_schemas` attribute.
    """
    ...
    @distributed_trace
    def list(self, resource_group_name: str, service_name: str, **kwargs: Any) -> Iterable["_models.MetadataSchema"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.apicenter.models.MetadataSchema]
        ...
        cls: ClsType[_models.MetadataSchemaCollection] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("MetadataSchemaCollection", pipeline_response)
    ...
    @distributed_trace
    def get(self, resource_group_name: str, service_name: str, **kwargs: Any) -> _models.MetadataSchema:
        """Get metadata schema.
        ...
        request = build_get_request(
            ...
            service_name=service_name,
            subscription_id=self._config.subscription_id,
            metadata_schema_name=self._config.metadata_schema_name,
            api_version=api_version,
    ...
    def create_or_update(
        ...
        service_name: str,
        payload: _models.MetadataSchema,
        *,
        ...
        **kwargs: Any
        ...
        :param service_name: The name of Azure API Center service. Required.
        :type service_name: str
        :param payload: Metadata schema entity. Required.
        :type payload: ~azure.mgmt.apicenter.models.MetadataSchema
    ...
    @distributed_trace
    def create_or_update(
        self, resource_group_name: str, service_name: str, payload: Union[_models.MetadataSchema, IO], **kwargs: Any
    ) -> _models.MetadataSchema:
        """Create or update metadata schema.
        ...
        :param service_name: The name of Azure API Center service. Required.
        :type service_name: str
        :param payload: Metadata schema entity. Is either a MetadataSchema type or a IO type. Required.
        :type payload: ~azure.mgmt.apicenter.models.MetadataSchema or IO
        ...
        if isinstance(payload, (IOBase, bytes)):
            ...
            _json = self._serialize.body(payload, "MetadataSchema")
