...
def build_create_or_update_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "serviceName": _SERIALIZER.url("service_name", service_name, "str", max_length=90, min_length=1),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, "str", max_length=90, min_length=1),
        "environmentName": _SERIALIZER.url("environment_name", environment_name, "str", max_length=90, min_length=1),
    }
...
class EnvironmentsOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, service_name: str, **kwargs: Any) -> Iterable["_models.Environment"]:
        """List environments.
        ...
        cls: ClsType[_models.EnvironmentCollection] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("EnvironmentCollection", pipeline_response)
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param service_name: The name of Azure API Center service. Required.
        :type service_name: str
        :param payload: Environment entity. Required.
        :type payload: ~azure.mgmt.apicenter.models.Environment
    ...
    @distributed_trace
    def create_or_update(
        self, resource_group_name: str, service_name: str, payload: Union[_models.Environment, IO], **kwargs: Any
    ) -> _models.Environment:
        """Create or update environment.
        ...
        :param service_name: The name of Azure API Center service. Required.
        :type service_name: str
        :param payload: Environment entity. Is either a Environment type or a IO type. Required.
        :type payload: ~azure.mgmt.apicenter.models.Environment or IO
        ...
        if isinstance(payload, (IOBase, bytes)):
            ...
            _json = self._serialize.body(payload, "Environment")
    ...
    @distributed_trace
    def get(self, resource_group_name: str, service_name: str, **kwargs: Any) -> _models.Environment:
        """Get environment.
