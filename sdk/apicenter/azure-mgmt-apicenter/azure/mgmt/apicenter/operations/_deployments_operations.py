...
def build_list_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "serviceName": _SERIALIZER.url("service_name", service_name, "str", max_length=90, min_length=1),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, "str", max_length=90, min_length=1),
        "apiName": _SERIALIZER.url("api_name", api_name, "str", max_length=90, min_length=1),
    }
...
def build_delete_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, "str", max_length=90, min_length=1),
        "apiName": _SERIALIZER.url("api_name", api_name, "str", max_length=90, min_length=1),
        "deploymentName": _SERIALIZER.url("deployment_name", deployment_name, "str", max_length=90, min_length=1),
    }
...
class DeploymentsOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, service_name: str, **kwargs: Any) -> Iterable["_models.Deployment"]:
        """List deployments.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.apicenter.models.Deployment]
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiCenter/services/{serviceName}/workspaces/{workspaceName}/apis/{apiName}/deployments"
    }
    ...
    delete.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiCenter/services/{serviceName}/workspaces/{workspaceName}/apis/{apiName}/deployments/{deploymentName}"
    }

    @distributed_trace
    def get(self, resource_group_name: str, service_name: str, **kwargs: Any) -> _models.Deployment:
        """Get API deployment.
        ...
        :rtype: ~azure.mgmt.apicenter.models.Deployment
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param service_name: The name of Azure API Center service. Required.
        :type service_name: str
        :param payload: API deployment entity. Required.
        :type payload: ~azure.mgmt.apicenter.models.Deployment
    ...
    @distributed_trace
    def create_or_update(
        self, resource_group_name: str, service_name: str, payload: Union[_models.Deployment, IO], **kwargs: Any
    ) -> _models.Deployment:
        """Create or update API deployment.
        ...
        :param service_name: The name of Azure API Center service. Required.
        :type service_name: str
        :param payload: API deployment entity. Is either a Deployment type or a IO type. Required.
        :type payload: ~azure.mgmt.apicenter.models.Deployment or IO
        ...
        if isinstance(payload, (IOBase, bytes)):
            ...
            _json = self._serialize.body(payload, "Deployment")
    ...
    @distributed_trace
    def head(self, resource_group_name: str, service_name: str, **kwargs: Any) -> bool:
