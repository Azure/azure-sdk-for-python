...
from ...operations._integration_account_schemas_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_content_callback_url_request, build_list_request
T = TypeVar('T')
...
class IntegrationAccountSchemasOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.IntegrationAccountSchemaListResult"]:
        ...
        :return: An iterator like instance of either IntegrationAccountSchemaListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.logic.models.IntegrationAccountSchemaListResult]
