...
from ...operations._integration_account_assemblies_operations import (
...
class IntegrationAccountAssembliesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`integration_account_assemblies` attribute.
    """
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.AssemblyDefinition"]:
        ...
        :return: An iterator like instance of either AssemblyDefinition or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.logic.models.AssemblyDefinition]
        ...
        cls: ClsType[_models.AssemblyCollection] = kwargs.pop("cls", None)
    ...
    async def get(
        self, resource_group_name: str, integration_account_name: str, assembly_artifact_name: str, **kwargs: Any
        ...
        :param integration_account_name: The integration account name. Required.
        :type integration_account_name: str
        :param assembly_artifact_name: The assembly artifact name. Required.
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.AssemblyDefinition] = kwargs.pop("cls", None)
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param assembly_artifact_name: The assembly artifact name. Required.
        :type assembly_artifact_name: str
        :param assembly_artifact: The assembly artifact. Required.
    ...
    async def create_or_update(
        ...
        integration_account_name: str,
        assembly_artifact_name: str,
        assembly_artifact: Union[_models.AssemblyDefinition, IO],
        **kwargs: Any
    ) -> _models.AssemblyDefinition:
        """Create or update an assembly for an integration account.
        ...
        :param assembly_artifact_name: The assembly artifact name. Required.
        :type assembly_artifact_name: str
        :param assembly_artifact: The assembly artifact. Is either a AssemblyDefinition type or a IO
         type. Required.
        :type assembly_artifact: ~azure.mgmt.logic.models.AssemblyDefinition or IO
        ...
        _json = None
        _content = None
        if isinstance(assembly_artifact, (IOBase, bytes)):
            _content = assembly_artifact
        else:
            _json = self._serialize.body(assembly_artifact, "AssemblyDefinition")
    ...
    list_content_callback_url.metadata = {
