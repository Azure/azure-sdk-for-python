...
class IntegrationServiceEnvironmentManagedApiOperationsOperations:
    """IntegrationServiceEnvironmentManagedApiOperationsOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ApiOperationListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.logic.models.ApiOperationListResult]
