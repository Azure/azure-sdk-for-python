...
class WorkflowTriggerHistoriesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either WorkflowTriggerHistory or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.logic.models.WorkflowTriggerHistory]
    ...
    async def get(
        self, resource_group_name: str, workflow_name: str, trigger_name: str, history_name: str, **kwargs: Any
    ...
    @distributed_trace_async
    async def resubmit(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, workflow_name: str, trigger_name: str, history_name: str, **kwargs: Any
    ) -> None:
