...
class IntegrationAccountBatchConfigurationsOperations:
    ...
    def list(
        ...
        cls: ClsType[_models.BatchConfigurationCollection] = kwargs.pop("cls", None)
    ...
    async def get(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.BatchConfiguration] = kwargs.pop("cls", None)
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param batch_configuration_name: The batch configuration name. Required.
        :type batch_configuration_name: str
        :param batch_configuration: The batch configuration. Is either a BatchConfiguration type or a
         IO type. Required.
        ...
        _json = None
        _content = None
        if isinstance(batch_configuration, (IOBase, bytes)):
