...
from ...operations._workflow_versions_operations import build_get_request, build_list_request
...
class WorkflowVersionsOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.WorkflowVersion"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.logic.models.WorkflowVersion]
