...
from ...operations._integration_service_environment_managed_apis_operations import build_delete_request_initial, build_get_request, build_list_request, build_put_request_initial
T = TypeVar('T')
...
class IntegrationServiceEnvironmentManagedApisOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.IntegrationServiceEnvironmentManagedApiListResult"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.logic.models.IntegrationServiceEnvironmentManagedApiListResult]
