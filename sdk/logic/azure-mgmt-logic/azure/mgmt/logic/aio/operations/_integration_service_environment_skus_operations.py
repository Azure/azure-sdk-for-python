...
class IntegrationServiceEnvironmentSkusOperations:
    """IntegrationServiceEnvironmentSkusOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.IntegrationServiceEnvironmentSkuList"]:
        ...
        :return: An iterator like instance of either IntegrationServiceEnvironmentSkuList or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.logic.models.IntegrationServiceEnvironmentSkuList]
