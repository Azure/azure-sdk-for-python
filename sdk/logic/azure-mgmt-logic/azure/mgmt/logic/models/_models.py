...
class ApiResourceMetadata(Model):
    ...
    :param provisioning_state: The provisioning state. Possible values
     ...
     'Unregistered', 'Completed', 'Renewing', 'Pending', 'Waiting',
     'InProgress'
...
class AS2SecuritySettings(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.override_group_signing_certificate = kwargs.get('override_group_signing_certificate', None)
        ...
        self.enable_nrr_for_inbound_encoded_messages = kwargs.get('enable_nrr_for_inbound_encoded_messages', None)
        self.enable_nrr_for_inbound_decoded_messages = kwargs.get('enable_nrr_for_inbound_decoded_messages', None)
        self.enable_nrr_for_outbound_mdn = kwargs.get('enable_nrr_for_outbound_mdn', None)
        self.enable_nrr_for_outbound_encoded_messages = kwargs.get('enable_nrr_for_outbound_encoded_messages', None)
        self.enable_nrr_for_outbound_decoded_messages = kwargs.get('enable_nrr_for_outbound_decoded_messages', None)
        self.enable_nrr_for_inbound_mdn = kwargs.get('enable_nrr_for_inbound_mdn', None)
...
class FlowAccessControlConfiguration(Model):
    """The access control configuration.

    :param triggers: The access control configuration for invoking workflow
     triggers.
    :type triggers:
     ~azure.mgmt.logic.models.FlowAccessControlConfigurationPolicy
    :param contents: The access control configuration for accessing workflow
     run contents.
    :type contents:
     ~azure.mgmt.logic.models.FlowAccessControlConfigurationPolicy
    ...
    :type actions:
     ~azure.mgmt.logic.models.FlowAccessControlConfigurationPolicy
    :param workflow_management: The access control configuration for workflow
     management.
...
class FlowAccessControlConfigurationPolicy(Model):
    """The access control configuration policy.

    :param allowed_caller_ip_addresses: The allowed caller IP address ranges.
    :type allowed_caller_ip_addresses:
     list[~azure.mgmt.logic.models.IpAddressRange]
    :param open_authentication_policies: The authentication policies for
     workflow.
...
class IntegrationServiceEnvironmenEncryptionConfiguration(Model):
...
class IntegrationServiceEnvironmenEncryptionKeyReference(Model):
    ...
    :type key_name: str
    :param key_version: Gets the version of the key specified in the keyName
     property.
...
class OpenAuthenticationAccessPolicies(Model):
    """AuthenticationPolicy of type Open.

    :param policies: Open authentication policies.
    :type policies: dict[str,
     ~azure.mgmt.logic.models.OpenAuthenticationAccessPolicy]
    """
...
class OpenAuthenticationAccessPolicy(Model):
    ...
    :vartype type: str or
     ~azure.mgmt.logic.models.OpenAuthenticationProviderType
...
class OpenAuthenticationPolicyClaim(Model):
...
class Workflow(Resource):
    ...
    :type access_control:
     ~azure.mgmt.logic.models.FlowAccessControlConfiguration
    :ivar sku: The sku.
