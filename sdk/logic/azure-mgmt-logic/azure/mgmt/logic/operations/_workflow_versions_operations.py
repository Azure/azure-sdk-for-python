...
def build_list_request(
    resource_group_name: str, workflow_name: str, subscription_id: str, *, top: Optional[int] = None, **kwargs: Any
) -> HttpRequest:
...
def build_get_request(
    resource_group_name: str, workflow_name: str, version_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class WorkflowVersionsOperations:
    ...
    @distributed_trace
    def list(
        self, resource_group_name: str, workflow_name: str, top: Optional[int] = None, **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.logic.models.WorkflowVersion]
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, workflow_name: str, version_id: str, **kwargs: Any
