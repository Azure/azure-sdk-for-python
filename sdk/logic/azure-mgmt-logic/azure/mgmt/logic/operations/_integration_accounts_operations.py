...
def build_get_request(
    resource_group_name: str, integration_account_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class IntegrationAccountsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, top: Optional[int] = None, **kwargs: Any) -> Iterable["_models.IntegrationAccount"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.logic.models.IntegrationAccount]
        ...
        cls: ClsType[_models.IntegrationAccountListResult] = kwargs.pop("cls", None)
    ...
    ) -> Iterable["_models.IntegrationAccount"]:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, integration_account_name: str, **kwargs: Any) -> _models.IntegrationAccount:
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.IntegrationAccount] = kwargs.pop("cls", None)
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param integration_account_name: The integration account name. Required.
        :type integration_account_name: str
        :param integration_account: The integration account. Is either a IntegrationAccount type or a
         IO type. Required.
        ...
        _json = None
        _content = None
        if isinstance(integration_account, (IOBase, bytes)):
    ...
    def list_callback_url(
        ...
        **kwargs: Any
        ...
        :param integration_account_name: The integration account name. Required.
        :type integration_account_name: str
        :param parameters: The callback URL parameters. Is either a GetCallbackUrlParameters type or a
         IO type. Required.
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.CallbackUrl] = kwargs.pop("cls", None)
    ...
    def list_key_vault_keys(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.logic.models.KeyVaultKey]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_key_vault_keys(
        ...
        **kwargs: Any
        ...
        :param integration_account_name: The integration account name. Required.
        :type integration_account_name: str
        :param list_key_vault_keys: The key vault parameters. Is either a ListKeyVaultKeysDefinition
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.KeyVaultKeyCollection] = kwargs.pop("cls", None)
        ...
        _json = None
        _content = None
        if isinstance(list_key_vault_keys, (IOBase, bytes)):
    ...
    def log_tracking_events(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param integration_account_name: The integration account name. Required.
        :type integration_account_name: str
        :param log_tracking_events: The callback URL parameters. Is either a TrackingEventsDefinition
         type or a IO type. Required.
        ...
        _json = None
        _content = None
        if isinstance(log_tracking_events, (IOBase, bytes)):
    ...
    def regenerate_access_key(
        ...
        **kwargs: Any
        ...
        :param integration_account_name: The integration account name. Required.
        :type integration_account_name: str
        :param regenerate_access_key: The access key type. Is either a RegenerateActionParameter type
        ...
        _json = None
        _content = None
        if isinstance(regenerate_access_key, (IOBase, bytes)):
