...
class WorkflowsOperations(object):
    ...
    def _move_initial(
            self, resource_group_name, workflow_name, id=None, custom_headers=None, raw=False, **operation_config):
        move1 = models.WorkflowReference(id=id)
        ...
        # Construct body
        body_content = self._serialize.body(move1, 'WorkflowReference')
    ...
    def move(
            self, resource_group_name, workflow_name, id=None, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    def validate_by_location(
            self, resource_group_name, location, workflow_name, validate, custom_headers=None, raw=False, **operation_config):
