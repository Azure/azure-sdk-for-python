...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/integrationAccounts/{integrationAccountName}/batchConfigurations")  # pylint: disable=line-too-long
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/integrationAccounts/{integrationAccountName}/batchConfigurations/{batchConfigurationName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "integrationAccountName": _SERIALIZER.url("integration_account_name", integration_account_name, 'str'),
        "batchConfigurationName": _SERIALIZER.url("batch_configuration_name", batch_configuration_name, 'str'),
    }
...
class IntegrationAccountBatchConfigurationsOperations(object):
    ...
    def list(
        ...
        integration_account_name: str,
        **kwargs: Any
    ) -> Iterable["_models.BatchConfigurationCollection"]:
        ...
        :return: An iterator like instance of either BatchConfigurationCollection or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.logic.models.BatchConfigurationCollection]
