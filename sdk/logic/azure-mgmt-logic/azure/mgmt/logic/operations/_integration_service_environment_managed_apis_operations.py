...
class IntegrationServiceEnvironmentManagedApisOperations:
    ...
    def list(
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.IntegrationServiceEnvironmentManagedApiListResult]
    ...
    def get(
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.IntegrationServiceEnvironmentManagedApi]
    ...
    def _put_initial(
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(integration_service_environment_managed_api, (IO, bytes)):
