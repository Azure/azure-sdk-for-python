...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Logic/integrationServiceEnvironments/{integrationServiceEnvironmentName}/managedApis")  # pylint: disable=line-too-long
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Logic/integrationServiceEnvironments/{integrationServiceEnvironmentName}/managedApis/{apiName}")  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroup": _SERIALIZER.url("resource_group", resource_group, 'str'),
        "integrationServiceEnvironmentName": _SERIALIZER.url("integration_service_environment_name", integration_service_environment_name, 'str'),
...
def build_put_request_initial(
    ...
    api_name: str,
    *,
    json: Optional[_models.IntegrationServiceEnvironmentManagedApi] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class IntegrationServiceEnvironmentManagedApisOperations:
    ...
    def list(
        ...
        integration_service_environment_name: str,
        **kwargs: Any
    ) -> Iterable[_models.IntegrationServiceEnvironmentManagedApiListResult]:
        ...
        :return: An iterator like instance of either IntegrationServiceEnvironmentManagedApiListResult
         or the result of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.logic.models.IntegrationServiceEnvironmentManagedApiListResult]
    ...
    def _put_initial(
        ...
        **kwargs: Any
        ...
        _json = self._serialize.body(integration_service_environment_managed_api, 'IntegrationServiceEnvironmentManagedApi')
