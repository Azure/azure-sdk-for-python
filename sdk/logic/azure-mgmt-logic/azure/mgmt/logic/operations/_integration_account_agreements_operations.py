...
def build_get_request(
    resource_group_name: str, integration_account_name: str, agreement_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class IntegrationAccountAgreementsOperations:
    ...
    def list(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.IntegrationAccountAgreement"]:
        ...
        :return: An iterator like instance of either IntegrationAccountAgreement or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.logic.models.IntegrationAccountAgreement]
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param agreement_name: The integration account agreement name. Required.
        :type agreement_name: str
        :param agreement: The integration account agreement. Is either a IntegrationAccountAgreement
        ...
        _json = None
        _content = None
        if isinstance(agreement, (IOBase, bytes)):
            _content = agreement
        else:
    ...
    def list_content_callback_url(
        ...
        **kwargs: Any
        ...
        :param agreement_name: The integration account agreement name. Required.
        :type agreement_name: str
        :param list_content_callback_url: Is either a GetCallbackUrlParameters type or a IO type.
         Required.
    ...
    list_content_callback_url.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/integrationAccounts/{integrationAccountName}/agreements/{agreementName}/listContentCallbackUrl"
    }
