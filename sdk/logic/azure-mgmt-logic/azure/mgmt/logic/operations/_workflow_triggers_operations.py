...
def build_get_request(
    resource_group_name: str, workflow_name: str, trigger_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class WorkflowTriggersOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.logic.models.WorkflowTrigger]
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, workflow_name: str, trigger_name: str, **kwargs: Any
    ...
    def set_state(  # pylint: disable=inconsistent-return-statements
        ...
        workflow_name: str,
        trigger_name: str,
        set_state: Union[_models.SetTriggerStateActionDefinition, IO],
        **kwargs: Any
    ) -> None:
        """Sets the state of a workflow trigger.
        ...
        :param trigger_name: The workflow trigger name. Required.
        :type trigger_name: str
        :param set_state: The workflow trigger state. Is either a SetTriggerStateActionDefinition type
         or a IO type. Required.
        :type set_state: ~azure.mgmt.logic.models.SetTriggerStateActionDefinition or IO
        ...
        _json = None
        _content = None
        if isinstance(set_state, (IOBase, bytes)):
            _content = set_state
        else:
