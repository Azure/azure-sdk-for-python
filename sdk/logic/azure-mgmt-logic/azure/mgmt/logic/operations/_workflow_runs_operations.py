...
def build_get_request(
    resource_group_name: str, workflow_name: str, run_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class WorkflowRunsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.logic.models.WorkflowRun]
    ...
    @distributed_trace
    def get(self, resource_group_name: str, workflow_name: str, run_name: str, **kwargs: Any) -> _models.WorkflowRun:
        """Gets a workflow run.
    ...
    def cancel(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, workflow_name: str, run_name: str, **kwargs: Any
    ) -> None:
