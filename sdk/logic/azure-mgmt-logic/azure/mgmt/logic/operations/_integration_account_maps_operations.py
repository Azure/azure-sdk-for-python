...
class IntegrationAccountMapsOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.IntegrationAccountMapListResult] = kwargs.pop("cls", None)
    ...
    def get(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.IntegrationAccountMap] = kwargs.pop("cls", None)
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :param map_name: The integration account map name. Required.
        :type map_name: str
        :param map: The integration account map. Is either a IntegrationAccountMap type or a IO type.
         Required.
        ...
        _json = None
        _content = None
        if isinstance(map, (IOBase, bytes)):
            _content = map
        else:
    ...
    list_content_callback_url.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/integrationAccounts/{integrationAccountName}/maps/{mapName}/listContentCallbackUrl"
    }
