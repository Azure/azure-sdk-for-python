...
# USAGE
    python integration_service_environments_managed_apis_put.py
...
def main():
    ...
    response = client.integration_service_environment_managed_apis.begin_put(
        ...
        integration_service_environment_managed_api={
            ...
            "properties": {"deploymentParameters": None},
        },
    ).result()
    print(response)
