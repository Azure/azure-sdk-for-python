...
# USAGE
    python integration_accounts_list_callback_url.py
...
def main():
    ...
    response = client.integration_accounts.list_callback_url(
        resource_group_name="testResourceGroup",
        integration_account_name="testIntegrationAccount",
        parameters={"keyType": "Primary", "notAfter": "2017-03-05T08:00:00Z"},
    )
    print(response)
