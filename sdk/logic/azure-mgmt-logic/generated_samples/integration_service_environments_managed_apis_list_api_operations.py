...
# USAGE
    python integration_service_environments_managed_apis_list_api_operations.py
...
def main():
    client = LogicManagementClient(
        ...
        subscription_id="80d4fe69-c95b-4dd2-a938-9250f1c8ab03",
    )

    response = client.integration_service_environment_managed_api_operations.list(
