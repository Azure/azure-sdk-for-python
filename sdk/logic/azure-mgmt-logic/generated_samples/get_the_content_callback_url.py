...
# USAGE
    python get_the_content_callback_url.py
...
def main():
    ...
    response = client.integration_account_schemas.list_content_callback_url(
        resource_group_name="testResourceGroup",
        integration_account_name="testIntegrationAccount",
        schema_name="testSchema",
        list_content_callback_url={"keyType": "Primary", "notAfter": "2018-04-19T16:00:00Z"},
    )
    print(response)
