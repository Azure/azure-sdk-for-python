...
class ClinicalMatchingClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    """Configuration for ClinicalMatchingClient.
    ...
    def __init__(self, endpoint: str, credential: AzureKeyCredential, **kwargs: Any) -> None:
        super(ClinicalMatchingClientConfiguration, self).__init__(**kwargs)
        ...
        kwargs.setdefault("sdk_moniker", "healthinsights-clinicalmatching/{}".format(VERSION))
