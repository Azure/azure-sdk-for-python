...
DESCRIPTION:
The sample_critical_result_inference_async module processes a sample radiology document with the Radiology Insights service.
...
class HealthInsightsSamples:
    async def radiology_insights_async(self) -> None:
        ...
        patient_info = models.PatientInfo(
            sex=models.PatientSex.FEMALE, birth_date=birth_date
        )
        # Create author
