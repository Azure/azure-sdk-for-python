...
from ..._operations._operations import (
    build_radiology_insights_begin_custom_inference_request,
    build_radiology_insights_infer_radiology_insights_request,
)
...
class _RadiologyInsightsClientOperationsMixin(
    ...
    async def _begin_custom_inference_initial(
        self,
    ...
    @overload
    async def begin_custom_inference(
        self,
        *,
        ...
        custom_model_ids: Optional[List[str]] = None,
        **kwargs: Any
    ) -> AsyncLROPoller[_models.RadiologyInsightsCustomInferenceResult]:
        ...
        :return: An instance of AsyncLROPoller that returns RadiologyInsightsCustomInferenceResult. The
         RadiologyInsightsCustomInferenceResult is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.healthinsights.radiologyinsights.models.RadiologyInsightsCustomInferenceResult]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_custom_inference(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._begin_custom_inference_initial(
                body=body,
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.RadiologyInsightsCustomInferenceResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.RadiologyInsightsCustomInferenceResult](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
