...
from ..._operations._operations import (
    build_radiology_insights_infer_from_custom_model_id_request,
...
class _RadiologyInsightsClientOperationsMixin(
    ...
    async def _infer_from_custom_model_id_initial(
        self,
    ...
    async def begin_infer_from_custom_model_id(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._infer_from_custom_model_id_initial(
                body=body,
