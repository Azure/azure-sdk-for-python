...
class RadiologyInsightsClientOperationsMixin(RadiologyInsightsClientMixinABC):
    async def _infer_radiology_insights_initial(
        ...
        *,
        expand: Optional[Union[str, _models.ExpandQueryParamsType]] = None,
        **kwargs: Any
    ) -> JSON:
        error_map = {
    ...
    async def begin_infer_radiology_insights(
        ...
        **kwargs: Any
        ...
        :keyword expand: A comma separated list of related properties to be included in line with the
         job. "jobData" Default value is None.
        :paramtype expand: str or ~azure.healthinsights.radiologyinsights.models.ExpandQueryParamsType
