...
class RadiologyInsightsClientOperationsMixin(RadiologyInsightsClientMixinABC):
    ...
    async def begin_infer_radiology_insights(
    ...
    ) -> AsyncLROPoller[_models.HealthInsightsOperationStatusRadiologyInsightsInferenceResultError]:
        ...
        :return: An instance of AsyncLROPoller that returns
         ...
         MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.healthinsights.radiologyinsights.models.HealthInsightsOperationStatusRadiologyInsightsInferenceResultError]
    ...
    async def begin_infer_radiology_insights(
        ...
        return AsyncLROPoller[_models.HealthInsightsOperationStatusRadiologyInsightsInferenceResultError](
