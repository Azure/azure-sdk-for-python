...
class OperationResultsOperations:
    ...
    async def get(self, operation_result_id: str, **kwargs: Any) -> Optional[_models.OperationResult]:
        """Get an azure operation result.

        Returns an azure operation result.

        :param operation_result_id: The operation result ID / name. Required.
        :type operation_result_id: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: OperationResult or None or the result of cls(response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/providers/Microsoft.LabServices/operationResults/{operationResultId}"
    }
