...
from ...operations._users_operations import (
...
class UsersOperations:
    ...
    def list_by_lab(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.labservices.models.User]
        ...
        cls: ClsType[_models.PagedUsers] = kwargs.pop("cls", None)
    ...
    list_by_lab.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LabServices/labs/{labName}/users"
    }

    @distributed_trace_async
    async def get(self, resource_group_name: str, lab_name: str, user_name: str, **kwargs: Any) -> _models.User:
        """Get a lab user.
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LabServices/labs/{labName}/users/{userName}"
    }

    async def _create_or_update_initial(
        self, resource_group_name: str, lab_name: str, user_name: str, body: Union[_models.User, IO], **kwargs: Any
    ) -> _models.User:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def begin_create_or_update(
        ...
        :type body: ~azure.mgmt.labservices.models.User or IO
    ...
    async def _update_initial(
        ...
        lab_name: str,
        user_name: str,
        body: Union[_models.UserUpdate, IO],
        **kwargs: Any
    ) -> _models.User:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type user_name: str
        :param body: The request body. Is either a model type or a IO type. Required.
        :type body: ~azure.mgmt.labservices.models.UserUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, lab_name: str, user_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    async def _invite_initial(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        lab_name: str,
        user_name: str,
        body: Union[_models.InviteBody, IO],
        **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    _invite_initial.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LabServices/labs/{labName}/users/{userName}/invite"
    }
    ...
    async def begin_invite(
        ...
        **kwargs: Any
        ...
        :type user_name: str
        :param body: The request body. Is either a model type or a IO type. Required.
        :type body: ~azure.mgmt.labservices.models.InviteBody or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._invite_initial(  # type: ignore
                resource_group_name=resource_group_name,
                lab_name=lab_name,
                user_name=user_name,
                body=body,
