...
class SchedulesOperations:
    ...
    def list_by_lab(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.labservices.models.Schedule]
        ...
        cls: ClsType[_models.PagedSchedules] = kwargs.pop("cls", None)
    ...
    list_by_lab.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LabServices/labs/{labName}/schedules"
    }

    @distributed_trace_async
    async def get(self, resource_group_name: str, lab_name: str, schedule_name: str, **kwargs: Any) -> _models.Schedule:
        """Get a lab Schedule.
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.LabServices/labs/{labName}/schedules/{scheduleName}"
    }
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.labservices.models.Schedule or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type schedule_name: str
        :param body: The request body. Is either a model type or a IO type. Required.
        :type body: ~azure.mgmt.labservices.models.ScheduleUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, lab_name: str, schedule_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
