...
from ...operations._schedules_operations import build_create_or_update_request, build_delete_request_initial, build_get_request, build_list_by_lab_request, build_update_request
T = TypeVar('T')
...
class SchedulesOperations:
    ...
    def list_by_lab(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.PagedSchedules"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.labservices.models.PagedSchedules]
