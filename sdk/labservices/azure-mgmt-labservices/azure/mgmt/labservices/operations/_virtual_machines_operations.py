...
def build_list_by_lab_request(
    resource_group_name: str, lab_name: str, subscription_id: str, *, filter: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
...
def build_get_request(
    resource_group_name: str, lab_name: str, virtual_machine_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class VirtualMachinesOperations:
    ...
    def list_by_lab(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.labservices.models.VirtualMachine]
    ...
    def begin_reset_password(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._reset_password_initial(  # type: ignore
                resource_group_name=resource_group_name,
                lab_name=lab_name,
                virtual_machine_name=virtual_machine_name,
                body=body,
