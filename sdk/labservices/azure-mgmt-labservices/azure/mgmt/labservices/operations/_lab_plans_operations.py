...
def build_list_by_subscription_request(
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.LabServices/labPlans")
...
def build_get_request(resource_group_name: str, lab_plan_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_create_or_update_request(
    resource_group_name: str, lab_plan_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class LabPlansOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, filter: Optional[str] = None, **kwargs: Any) -> Iterable["_models.LabPlan"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.labservices.models.LabPlan]
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.LabPlan"]:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, lab_plan_name: str, **kwargs: Any) -> _models.LabPlan:
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, lab_plan_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    def _save_image_initial(  # pylint: disable=inconsistent-return-statements
    ...
    def begin_save_image(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._save_image_initial(  # type: ignore
                resource_group_name=resource_group_name,
                lab_plan_name=lab_plan_name,
                body=body,
                api_version=api_version,
