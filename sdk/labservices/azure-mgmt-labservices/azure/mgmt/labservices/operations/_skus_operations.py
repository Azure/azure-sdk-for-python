...
def build_list_request(subscription_id: str, *, filter: Optional[str] = None, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.LabServices/skus")
...
class SkusOperations:
    ...
    @distributed_trace
    def list(self, filter: Optional[str] = None, **kwargs: Any) -> Iterable["_models.LabServicesSku"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.labservices.models.LabServicesSku]
