...
class ProviderOperations(object):
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.OperationMetadataPaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list.metadata = {'url': '/providers/Microsoft.LabServices/operations'}
