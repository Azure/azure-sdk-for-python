...
def build_get_request(
    resource_group_name: str, lab_name: str, user_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "labName": _SERIALIZER.url("lab_name", lab_name, "str", max_length=100, min_length=1),
        "userName": _SERIALIZER.url(
            "user_name", user_name, "str", max_length=100, min_length=1, pattern=r"^[-\w\\._\\(\\)]+$"
        ),
    }
...
class UsersOperations:
    ...
    def list_by_lab(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.labservices.models.User]
    ...
    @distributed_trace
    def get(self, resource_group_name: str, lab_name: str, user_name: str, **kwargs: Any) -> _models.User:
        """Get a lab user.
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, lab_name: str, user_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    def begin_invite(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._invite_initial(  # type: ignore
                resource_group_name=resource_group_name,
                lab_name=lab_name,
                user_name=user_name,
                body=body,
