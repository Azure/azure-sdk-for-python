...
class AzureAppConfigurationClientOperationsMixin(  # pylint: disable=too-many-public-methods,name-too-long
    ...
    async def begin_create_snapshot(
        ...
        :keyword sync_token: Used to guarantee real-time consistency between requests. Default value is
         None.
        :paramtype sync_token: str
        :return: An instance of AsyncLROPoller that returns Error. The Error is compatible with
         MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.appconfiguration.models.Error]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_snapshot(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return AsyncLROPoller[_models.Error].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.Error](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    @overload
    async def _update_snapshot(  # pylint: disable=protected-access
        self,
        name: str,
