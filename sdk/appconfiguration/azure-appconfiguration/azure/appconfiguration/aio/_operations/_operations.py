...
class AzureAppConfigurationClientOperationsMixin(  # pylint: disable=too-many-public-methods,name-too-long
    ...
    def get_keys(
        ...
        **kwargs: Any
        ...
        async def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models.Key], deserialized.get("items", []))
            if cls:
    ...
    def get_key_values(
        ...
        **kwargs: Any
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.KeyValue], deserialized.get("items", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("@nextLink") or None, AsyncList(list_of_elem)
    ...
    def get_snapshots(
        ...
        **kwargs: Any
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.Snapshot], deserialized.get("items", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("@nextLink") or None, AsyncList(list_of_elem)
    ...
    def get_labels(
        ...
        **kwargs: Any
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.Label], deserialized.get("items", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("@nextLink") or None, AsyncList(list_of_elem)
