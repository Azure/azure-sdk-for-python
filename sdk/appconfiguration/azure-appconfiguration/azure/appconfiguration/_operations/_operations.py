...
def build_azure_app_configuration_check_snapshots_request(  # pylint: disable=name-too-long
    *, api_version: str, sync_token: Optional[str] = None, after: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_azure_app_configuration_get_operation_details_request(  # pylint: disable=name-too-long
    *, api_version: str, snapshot: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_azure_app_configuration_create_snapshot_request(  # pylint: disable=name-too-long
    name: str, *, api_version: str, sync_token: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class _AzureAppConfigurationClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def get_operation_details(self, *, api_version: str, snapshot: str, **kwargs: Any) -> _models.OperationDetails:
