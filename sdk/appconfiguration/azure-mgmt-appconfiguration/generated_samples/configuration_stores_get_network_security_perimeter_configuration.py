...
# USAGE
    python configuration_stores_get_network_security_perimeter_configuration.py
...
def main():
    ...
    response = client.network_security_perimeter_configurations.get(
        ...
        network_security_perimeter_configuration_name="804a12bb-1349-4228-81be-8fe888aae04e.myAssociationName",
    )
    print(response)
