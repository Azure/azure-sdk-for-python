...
from ...operations._private_endpoint_connections_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_configuration_store_request
T = TypeVar('T')
    ...
    def list_by_configuration_store(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PrivateEndpointConnectionListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appconfiguration.v2022_05_01.models.PrivateEndpointConnectionListResult]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type private_endpoint_connection:
         ~azure.mgmt.appconfiguration.v2022_05_01.models.PrivateEndpointConnection
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appconfiguration.v2022_05_01.models.PrivateEndpointConnection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
