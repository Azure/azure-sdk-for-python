...
class ConfigurationStoreProperties(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'encryption': {'key': 'encryption', 'type': 'EncryptionProperties'},
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ConfigurationStoreProperties, self).__init__(**kwargs)
        self.provisioning_state = None
        self.creation_date = None
        self.endpoint = None
        self.encryption = encryption
...
class ConfigurationStorePropertiesUpdateParameters(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ConfigurationStorePropertiesUpdateParameters, self).__init__(**kwargs)
        self.encryption = encryption
