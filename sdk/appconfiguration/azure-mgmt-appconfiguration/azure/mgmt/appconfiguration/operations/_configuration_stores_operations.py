...
class ConfigurationStoresOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ConfigurationStoreListResult"]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.ConfigurationStore"
    ...
    def _create_initial(
        ...
        resource_group_name,  # type: str
        config_store_name,  # type: str
        config_store_creation_parameters,  # type: "_models.ConfigurationStore"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ConfigurationStore"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ConfigurationStore"]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.ConfigurationStore"]
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        config_store_name,  # type: str
        config_store_update_parameters,  # type: "_models.ConfigurationStoreUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ConfigurationStore"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ConfigurationStore"]
    ...
    def list_keys(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ApiKeyListResult"]
    ...
    def regenerate_key(
        ...
        resource_group_name,  # type: str
        config_store_name,  # type: str
        regenerate_key_parameters,  # type: "_models.RegenerateKeyParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ApiKey"
