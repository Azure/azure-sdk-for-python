...
class KeyValuesOperations(object):
    ...
    def list_by_configuration_store(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~app_configuration_management_client.models.KeyValueListResult]
    ...
    def create_or_update(
        ...
        config_store_name,  # type: str
        key_value_name,  # type: str
        key_value_parameters=None,  # type: Optional["_models.KeyValue"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.KeyValue"
        """Creates a key-value.
