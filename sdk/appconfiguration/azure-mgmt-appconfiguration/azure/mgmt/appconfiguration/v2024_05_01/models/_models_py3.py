...
class ApiKeyListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.appconfiguration.v2024_05_01.models.ApiKey]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.appconfiguration.v2024_05_01.models.ApiKey]
...
class CheckNameAvailabilityParameters(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.appconfiguration.v2024_05_01.models.ConfigurationResourceType
    """
    ...
    def __init__(self, *, name: str, type: Union[str, "_models.ConfigurationResourceType"], **kwargs: Any) -> None:
        ...
        :paramtype type: str or
         ~azure.mgmt.appconfiguration.v2024_05_01.models.ConfigurationResourceType
        """
        super().__init__(**kwargs)
        self.name = name
        self.type = type
...
class ConfigurationStore(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype identity: ~azure.mgmt.appconfiguration.v2024_05_01.models.ResourceIdentity
    :ivar sku: The sku of the configuration store. Required.
    :vartype sku: ~azure.mgmt.appconfiguration.v2024_05_01.models.Sku
    :ivar system_data: Resource system metadata.
    :vartype system_data: ~azure.mgmt.appconfiguration.v2024_05_01.models.SystemData
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.appconfiguration.v2024_05_01.models.ProvisioningState
    ...
    :vartype encryption: ~azure.mgmt.appconfiguration.v2024_05_01.models.EncryptionProperties
    :ivar private_endpoint_connections: The list of private endpoint connections that are set up
     for this resource.
    :vartype private_endpoint_connections:
     list[~azure.mgmt.appconfiguration.v2024_05_01.models.PrivateEndpointConnectionReference]
    ...
    :vartype public_network_access: str or
     ~azure.mgmt.appconfiguration.v2024_05_01.models.PublicNetworkAccess
    ...
    :vartype data_plane_proxy:
     ~azure.mgmt.appconfiguration.v2024_05_01.models.DataPlaneProxyProperties
    :ivar create_mode: Indicates whether the configuration store need to be recovered. Known values
     are: "Recover" and "Default".
    :vartype create_mode: str or ~azure.mgmt.appconfiguration.v2024_05_01.models.CreateMode
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype identity: ~azure.mgmt.appconfiguration.v2024_05_01.models.ResourceIdentity
        :keyword sku: The sku of the configuration store. Required.
        :paramtype sku: ~azure.mgmt.appconfiguration.v2024_05_01.models.Sku
        :keyword encryption: The encryption settings of the configuration store.
        :paramtype encryption: ~azure.mgmt.appconfiguration.v2024_05_01.models.EncryptionProperties
...
class ConfigurationStoreListResult(_serialization.Model):
    ...
    :ivar value: The collection value.
    :vartype value: list[~azure.mgmt.appconfiguration.v2024_05_01.models.ConfigurationStore]
    :ivar next_link: The URI that can be used to request the next set of paged results.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword value: The collection value.
        :paramtype value: list[~azure.mgmt.appconfiguration.v2024_05_01.models.ConfigurationStore]
        :keyword next_link: The URI that can be used to request the next set of paged results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class DataPlaneProxyProperties(_serialization.Model):
    ...
    :vartype authentication_mode: str or
     ~azure.mgmt.appconfiguration.v2024_05_01.models.AuthenticationMode
    ...
    :vartype private_link_delegation: str or
     ~azure.mgmt.appconfiguration.v2024_05_01.models.PrivateLinkDelegation
    """
...
class DeletedConfigurationStoreListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.appconfiguration.v2024_05_01.models.DeletedConfigurationStore]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value:
         list[~azure.mgmt.appconfiguration.v2024_05_01.models.DeletedConfigurationStore]
...
class EncryptionProperties(_serialization.Model):
    ...
    :vartype key_vault_properties:
     ~azure.mgmt.appconfiguration.v2024_05_01.models.KeyVaultProperties
    """
...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.appconfiguration.v2024_05_01.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.mgmt.appconfiguration.v2024_05_01.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.appconfiguration.v2024_05_01.models.ErrorDetails
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetails"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.appconfiguration.v2024_05_01.models.ErrorDetails
        """
        super().__init__(**kwargs)
        self.error = error
...
class ErrorResponseAutoGenerated(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.appconfiguration.v2024_05_01.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.appconfiguration.v2024_05_01.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class KeyValueListResult(_serialization.Model):
    ...
    :ivar value: The collection value.
    :vartype value: list[~azure.mgmt.appconfiguration.v2024_05_01.models.KeyValue]
    :ivar next_link: The URI that can be used to request the next set of paged results.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        """
        :keyword value: The collection value.
        :paramtype value: list[~azure.mgmt.appconfiguration.v2024_05_01.models.KeyValue]
        :keyword next_link: The URI that can be used to request the next set of paged results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class MetricSpecification(_serialization.Model):
    ...
    :vartype dimensions: list[~azure.mgmt.appconfiguration.v2024_05_01.models.MetricDimension]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype dimensions: list[~azure.mgmt.appconfiguration.v2024_05_01.models.MetricDimension]
...
class OperationDefinition(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.appconfiguration.v2024_05_01.models.OperationDefinitionDisplay
    :ivar origin: Origin of the operation.
    :vartype origin: str
    :ivar properties: Properties of the operation.
    :vartype properties: ~azure.mgmt.appconfiguration.v2024_05_01.models.OperationProperties
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype display: ~azure.mgmt.appconfiguration.v2024_05_01.models.OperationDefinitionDisplay
        :keyword origin: Origin of the operation.
        :paramtype origin: str
        :keyword properties: Properties of the operation.
        :paramtype properties: ~azure.mgmt.appconfiguration.v2024_05_01.models.OperationProperties
        """
        super().__init__(**kwargs)
        self.name = name
...
class OperationDefinitionListResult(_serialization.Model):
    ...
    :ivar value: The collection value.
    :vartype value: list[~azure.mgmt.appconfiguration.v2024_05_01.models.OperationDefinition]
    :ivar next_link: The URI that can be used to request the next set of paged results.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword value: The collection value.
        :paramtype value: list[~azure.mgmt.appconfiguration.v2024_05_01.models.OperationDefinition]
        :keyword next_link: The URI that can be used to request the next set of paged results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class OperationProperties(_serialization.Model):
    ...
    :vartype service_specification:
     ~azure.mgmt.appconfiguration.v2024_05_01.models.ServiceSpecification
    """
...
class PrivateEndpointConnection(_serialization.Model):
    ...
    :vartype private_endpoint: ~azure.mgmt.appconfiguration.v2024_05_01.models.PrivateEndpoint
    :ivar private_link_service_connection_state: A collection of information about the state of the
     connection between service consumer and provider.
    :vartype private_link_service_connection_state:
     ~azure.mgmt.appconfiguration.v2024_05_01.models.PrivateLinkServiceConnectionState
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype private_endpoint: ~azure.mgmt.appconfiguration.v2024_05_01.models.PrivateEndpoint
...
class PrivateEndpointConnectionListResult(_serialization.Model):
    ...
    :ivar value: The collection value.
    :vartype value: list[~azure.mgmt.appconfiguration.v2024_05_01.models.PrivateEndpointConnection]
    :ivar next_link: The URI that can be used to request the next set of paged results.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword value: The collection value.
        :paramtype value:
         list[~azure.mgmt.appconfiguration.v2024_05_01.models.PrivateEndpointConnection]
        :keyword next_link: The URI that can be used to request the next set of paged results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class PrivateLinkResourceListResult(_serialization.Model):
    ...
    :ivar value: The collection value.
    :vartype value: list[~azure.mgmt.appconfiguration.v2024_05_01.models.PrivateLinkResource]
    :ivar next_link: The URI that can be used to request the next set of paged results.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword value: The collection value.
        :paramtype value: list[~azure.mgmt.appconfiguration.v2024_05_01.models.PrivateLinkResource]
        :keyword next_link: The URI that can be used to request the next set of paged results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class PrivateLinkServiceConnectionState(_serialization.Model):
    ...
    :vartype status: str or ~azure.mgmt.appconfiguration.v2024_05_01.models.ConnectionStatus
    ...
    :vartype actions_required: str or
     ~azure.mgmt.appconfiguration.v2024_05_01.models.ActionsRequired
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword status: The private link service connection status. Known values are: "Pending",
         "Approved", "Rejected", and "Disconnected".
        :paramtype status: str or ~azure.mgmt.appconfiguration.v2024_05_01.models.ConnectionStatus
...
class Replica(_serialization.Model):
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.appconfiguration.v2024_05_01.models.ReplicaProvisioningState
    """
...
class ReplicaListResult(_serialization.Model):
    ...
    :ivar value: The collection value.
    :vartype value: list[~azure.mgmt.appconfiguration.v2024_05_01.models.Replica]
    :ivar next_link: The URI that can be used to request the next set of paged results.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        """
        :keyword value: The collection value.
        :paramtype value: list[~azure.mgmt.appconfiguration.v2024_05_01.models.Replica]
        :keyword next_link: The URI that can be used to request the next set of paged results.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class ResourceIdentity(_serialization.Model):
    ...
    :vartype type: str or ~azure.mgmt.appconfiguration.v2024_05_01.models.IdentityType
    ...
    :vartype user_assigned_identities: dict[str,
     ~azure.mgmt.appconfiguration.v2024_05_01.models.UserIdentity]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype type: str or ~azure.mgmt.appconfiguration.v2024_05_01.models.IdentityType
...
class ServiceSpecification(_serialization.Model):
    ...
    :vartype log_specifications:
     list[~azure.mgmt.appconfiguration.v2024_05_01.models.LogSpecification]
    :ivar metric_specifications: Specifications of the Metrics for Azure Monitoring.
    :vartype metric_specifications:
     list[~azure.mgmt.appconfiguration.v2024_05_01.models.MetricSpecification]
    """
...
class Snapshot(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar status: The current status of the snapshot. Known values are: "Provisioning", "Ready",
     "Archived", and "Failed".
    :vartype status: str or ~azure.mgmt.appconfiguration.v2024_05_01.models.SnapshotStatus
    :ivar filters: A list of filters used to filter the key-values included in the snapshot.
    :vartype filters: list[~azure.mgmt.appconfiguration.v2024_05_01.models.KeyValueFilter]
    ...
    :vartype composition_type: str or
     ~azure.mgmt.appconfiguration.v2024_05_01.models.CompositionType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype filters: list[~azure.mgmt.appconfiguration.v2024_05_01.models.KeyValueFilter]
        ...
        :paramtype composition_type: str or
         ~azure.mgmt.appconfiguration.v2024_05_01.models.CompositionType
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.appconfiguration.v2024_05_01.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or
     ~azure.mgmt.appconfiguration.v2024_05_01.models.CreatedByType
