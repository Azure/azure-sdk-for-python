...
class ReplicasOperations:
    ...
    def list_by_configuration_store(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appconfiguration.v2024_05_01.models.Replica]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Replica or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appconfiguration.v2024_05_01.models.Replica]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
