...
class ConfigurationStoresOperations:
    ...
    def list(self, skip_token: Optional[str] = None, **kwargs: Any) -> Iterable["_models.ConfigurationStore"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appconfiguration.v2024_05_01.models.ConfigurationStore]
    ...
    ) -> Iterable["_models.ConfigurationStore"]:
    ...
    def get(self, resource_group_name: str, config_store_name: str, **kwargs: Any) -> _models.ConfigurationStore:
        ...
        :rtype: ~azure.mgmt.appconfiguration.v2024_05_01.models.ConfigurationStore
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type config_store_creation_parameters:
         ~azure.mgmt.appconfiguration.v2024_05_01.models.ConfigurationStore
        ...
        :return: An instance of LROPoller that returns either ConfigurationStore or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appconfiguration.v2024_05_01.models.ConfigurationStore]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type config_store_creation_parameters:
         ~azure.mgmt.appconfiguration.v2024_05_01.models.ConfigurationStore or IO[bytes]
        :return: An instance of LROPoller that returns either ConfigurationStore or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appconfiguration.v2024_05_01.models.ConfigurationStore]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type config_store_update_parameters:
         ~azure.mgmt.appconfiguration.v2024_05_01.models.ConfigurationStoreUpdateParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either ConfigurationStore or the result of
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type config_store_update_parameters:
         ~azure.mgmt.appconfiguration.v2024_05_01.models.ConfigurationStoreUpdateParameters or IO[bytes]
        :return: An instance of LROPoller that returns either ConfigurationStore or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.appconfiguration.v2024_05_01.models.ConfigurationStore]
    ...
    def list_keys(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.appconfiguration.v2024_05_01.models.ApiKey]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def regenerate_key(
        ...
        **kwargs: Any
        ...
        :type regenerate_key_parameters:
         ~azure.mgmt.appconfiguration.v2024_05_01.models.RegenerateKeyParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiKey or the result of cls(response)
        :rtype: ~azure.mgmt.appconfiguration.v2024_05_01.models.ApiKey
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def regenerate_key(
        ...
        **kwargs: Any
        ...
        :type regenerate_key_parameters:
         ~azure.mgmt.appconfiguration.v2024_05_01.models.RegenerateKeyParameters or IO[bytes]
        :return: ApiKey or the result of cls(response)
        :rtype: ~azure.mgmt.appconfiguration.v2024_05_01.models.ApiKey
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list_deleted(self, **kwargs: Any) -> Iterable["_models.DeletedConfigurationStore"]:
        ...
        :return: An iterator like instance of either DeletedConfigurationStore or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.appconfiguration.v2024_05_01.models.DeletedConfigurationStore]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get_deleted(self, location: str, config_store_name: str, **kwargs: Any) -> _models.DeletedConfigurationStore:
        ...
        :rtype: ~azure.mgmt.appconfiguration.v2024_05_01.models.DeletedConfigurationStore
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
