...
class ConfigurationStoresOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ConfigurationStoreListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appconfiguration.v2022_03_01_preview.models.ConfigurationStoreListResult]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type config_store_creation_parameters:
         ~azure.mgmt.appconfiguration.v2022_03_01_preview.models.ConfigurationStore
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either ConfigurationStore or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.appconfiguration.v2022_03_01_preview.models.ConfigurationStore]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type config_store_update_parameters:
         ~azure.mgmt.appconfiguration.v2022_03_01_preview.models.ConfigurationStoreUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
    ...
    def list_keys(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appconfiguration.v2022_03_01_preview.models.ApiKeyListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def regenerate_key(
        ...
        **kwargs: Any
        ...
        :type regenerate_key_parameters:
         ~azure.mgmt.appconfiguration.v2022_03_01_preview.models.RegenerateKeyParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_deleted(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DeletedConfigurationStoreListResult or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appconfiguration.v2022_03_01_preview.models.DeletedConfigurationStoreListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
