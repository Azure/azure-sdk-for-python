...
### Breaking Changes
  ...
  - Model `ConfigurationStoreUpdateParameters` deleted or renamed its instance variable `encryption`
  - Model `ConfigurationStoreUpdateParameters` deleted or renamed its instance variable `disable_local_auth`
  - Model `ConfigurationStoreUpdateParameters` deleted or renamed its instance variable `public_network_access`
  - Model `ConfigurationStoreUpdateParameters` deleted or renamed its instance variable `enable_purge_protection`
  - Model `ConfigurationStoreUpdateParameters` deleted or renamed its instance variable `data_plane_proxy`
  - Model `ConfigurationStoreUpdateParameters` deleted or renamed its instance variable `default_key_value_revision_retention_period_in_seconds`
  - Model `PrivateEndpointConnectionReference` deleted or renamed its instance variable `provisioning_state`
  - Model `PrivateEndpointConnectionReference` deleted or renamed its instance variable `private_endpoint`
  - Model `PrivateEndpointConnectionReference` deleted or renamed its instance variable `private_link_service_connection_state`
...
### Breaking Changes
  ...
  - Deleted or renamed client `AppConfigurationManagementClient`
  - Model `ConfigurationStoreUpdateParameters` deleted or renamed its instance variable `encryption`
  - Model `ConfigurationStoreUpdateParameters` deleted or renamed its instance variable `disable_local_auth`
  - Model `ConfigurationStoreUpdateParameters` deleted or renamed its instance variable `public_network_access`
  - Model `ConfigurationStoreUpdateParameters` deleted or renamed its instance variable `enable_purge_protection`
