...
"""
FILE: sample_put_feature_flag_with_send_request.py

DESCRIPTION:
    This sample creates or updates the App Configuration feature flag named
    "Alpha" with empty properties by using AppConfigurationManagementClient.send_request.

USAGE:
    python sample_put_feature_flag_with_send_request.py
    ...
    with AppConfigurationManagementClient(
        ...
        request = HttpRequest(
            ...
            url=(
                ...
                f"{config_store_name}/featureFlags/Alpha11"
            ),
