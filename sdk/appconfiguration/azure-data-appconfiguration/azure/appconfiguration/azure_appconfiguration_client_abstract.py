...
class AzureAppConfigurationClientAbstract(object):
    ...
    def list_configuration_settings(
        ...
        """
        labels = AzureAppConfigurationClientAbstract.escape_and_tolist(labels)
        keys = AzureAppConfigurationClientAbstract.escape_and_tolist(keys)
    ...
    def set_configuration_setting(self, configuration_setting, **kwargs):
        ...
        if etag:
            custom_headers["if-match"] = AzureAppConfigurationClientAbstract.quote_etag(
                etag
            )
        return self._impl.create_or_update_configuration_setting(
            configuration_setting=configuration_setting,
    ...
    def escape_reserved(value):
        ...
        if value is None:
            ...
            if isinstance(value, list):
                return [
                    AzureAppConfigurationClientAbstract.escape_reserved(s) for s in value
                ]
            else:
    ...
    def escape_and_tolist(value):
        if value is not None:
            if isinstance(value, str):
                value = [value]
            value = AzureAppConfigurationClientAbstract.escape_reserved(value)
        return value
