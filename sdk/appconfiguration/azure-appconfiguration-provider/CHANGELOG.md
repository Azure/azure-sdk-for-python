...
- Added minimum up time. This is the minimum amount of time the proivder will try to be up before throwing an error. This is to prevent quick restart loops.
