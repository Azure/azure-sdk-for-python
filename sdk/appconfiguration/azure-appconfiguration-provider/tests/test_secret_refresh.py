...
class TestSecretRefresh(AppConfigTestCase, unittest.TestCase):
    ...
    @recorded_by_proxy
    @app_config_decorator_aad
    def test_no_secret_refresh_without_timer(self, appconfiguration_endpoint_string, appconfiguration_keyvault_secret_url, appconfiguration_keyvault_secret_url2):
    ...
    @recorded_by_proxy
    @app_config_decorator_aad
    def test_secret_refresh_interval_parameter(self, appconfiguration_endpoint_string, appconfiguration_keyvault_secret_url, appconfiguration_keyvault_secret_url2):
