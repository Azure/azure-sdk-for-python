...
AppConfigProviderPreparer = functools.partial(
    ...
    appconfiguration_endpoint_geo_string="https://fake-endpoint-geo.azconfig.io",
...
def app_config_decorator_aad(func, **kwargs):
    ...
    def wrapper(*args, **kwargs):
        ...
        appconfiguration_endpoint_geo_string = kwargs.pop("appconfiguration_endpoint_geo_string")
        kwargs['appconfiguration_endpoint_geo_string'] = appconfiguration_endpoint_geo_string
