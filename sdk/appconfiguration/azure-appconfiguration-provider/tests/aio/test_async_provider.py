...
class TestAppConfigurationProvider(AppConfigTestCase):
    ...
    async def test_provider_creation(self, appconfiguration_endpoint_string, appconfiguration_keyvault_secret_url):
    ...
    @AppConfigProviderPreparer()
    @recorded_by_proxy_async
    async def test_configuration_mapper(self, appconfiguration_endpoint_string, appconfiguration_keyvault_secret_url):
