...
# USAGE
    python payment_hsm_cluster_private_endpoint_connection_list_by_payment_hsm_cluster_maximum_set_gen.py
...
def main():
    ...
    response = client.payment_hsm_cluster_private_endpoint_connections.list_by_payment_hsm_cluster(
