...
from ...operations._cloud_hsm_cluster_private_endpoint_connections_operations import (
...
class CloudHsmClusterPrivateEndpointConnectionsOperations:
    """
    .. warning::
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.hardwaresecuritymodules.models.PrivateEndpointConnection or IO
    ...
    create.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/cloudHsmClusters/{cloudHsmClusterName}/privateEndpointConnections/{peConnectionName}"
    }
