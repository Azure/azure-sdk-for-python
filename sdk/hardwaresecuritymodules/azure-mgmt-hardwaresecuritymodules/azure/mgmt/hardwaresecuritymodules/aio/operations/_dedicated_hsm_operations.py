...
from ...operations._dedicated_hsm_operations import (
...
class DedicatedHsmOperations:
    ...
    ) -> AsyncIterable["_models.DedicatedHsm"]:
    ...
    @distributed_trace
    def list_by_subscription(self, top: Optional[int] = None, **kwargs: Any) -> AsyncIterable["_models.DedicatedHsm"]:
        """The List operation gets information about the dedicated HSMs associated with the subscription.
