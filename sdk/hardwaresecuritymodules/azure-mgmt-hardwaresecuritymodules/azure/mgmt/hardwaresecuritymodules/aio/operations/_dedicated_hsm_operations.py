...
from ...operations._dedicated_hsm_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_list_outbound_network_dependencies_endpoints_request, build_update_request_initial
T = TypeVar('T')
...
class DedicatedHsmOperations:
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either DedicatedHsm or the result of
         cls(response)
        :rtype:
    ...
    def list_by_resource_group(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.DedicatedHsmListResult"]:
        ...
        :return: An iterator like instance of either DedicatedHsmListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hardwaresecuritymodules.models.DedicatedHsmListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-11-30")  # type: str
    ...
    def list_outbound_network_dependencies_endpoints(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hardwaresecuritymodules.models.OutboundEnvironmentEndpointCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-11-30")  # type: str
