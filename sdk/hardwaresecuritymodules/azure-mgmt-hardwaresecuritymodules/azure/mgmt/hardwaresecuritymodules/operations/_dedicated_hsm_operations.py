...
def build_list_by_subscription_request(
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.HardwareSecurityModules/dedicatedHSMs"
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class DedicatedHsmOperations:
    ...
    def _create_or_update_initial(
        self, resource_group_name: str, name: str, parameters: Union[_models.DedicatedHsm, IO], **kwargs: Any
    ...
    def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.hardwaresecuritymodules.models.DedicatedHsm or IO
    ...
    def list_by_resource_group(
        ...
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either DedicatedHsm or the result of cls(response)
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2021-11-30"))
        cls: ClsType[_models.DedicatedHsmListResult] = kwargs.pop("cls", None)
    ...
    @distributed_trace
    def list_by_subscription(self, top: Optional[int] = None, **kwargs: Any) -> Iterable["_models.DedicatedHsm"]:
        """The List operation gets information about the dedicated HSMs associated with the subscription.
    ...
    list_outbound_network_dependencies_endpoints.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/dedicatedHSMs/{name}/outboundNetworkDependenciesEndpoints"
    }
