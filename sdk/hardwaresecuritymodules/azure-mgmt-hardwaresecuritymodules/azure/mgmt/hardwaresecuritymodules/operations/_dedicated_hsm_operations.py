...
class DedicatedHsmOperations:
    ...
    def _create_or_update_initial(
        self, resource_group_name: str, name: str, parameters: Union[_models.DedicatedHsm, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
    ...
    def begin_create_or_update(
        ...
        :type parameters: ~azure.mgmt.hardwaresecuritymodules.models.DedicatedHsm or IO[bytes]
        :return: An instance of LROPoller that returns either DedicatedHsm or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.hardwaresecuritymodules.models.DedicatedHsm]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("DedicatedHsm", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
