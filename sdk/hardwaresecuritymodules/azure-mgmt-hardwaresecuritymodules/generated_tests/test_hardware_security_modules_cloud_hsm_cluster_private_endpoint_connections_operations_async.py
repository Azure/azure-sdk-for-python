...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.hardwaresecuritymodules.aio import HardwareSecurityModulesClient
...
class TestHardwareSecurityModulesCloudHsmClusterPrivateEndpointConnectionsOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(HardwareSecurityModulesClient, is_async=True)
