...
class TestBaseAccountUsageOperations:
    """TestBaseAccountUsageOperations async operations.
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~restap_ifor_test_base.models.TestBaseAccountUsageDataList]
