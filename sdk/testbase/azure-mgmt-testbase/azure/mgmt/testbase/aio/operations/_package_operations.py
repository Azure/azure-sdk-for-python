...
class PackageOperations:
    """PackageOperations async operations.
    ...
    async def _create_initial(
        ...
        package_name: str,
        parameters: "_models.PackageResource",
        **kwargs
    ) -> "_models.PackageResource":
    ...
    async def begin_create(
        ...
        parameters: "_models.PackageResource",
        **kwargs
    ) -> AsyncLROPoller["_models.PackageResource"]:
        ...
        :type parameters: ~restap_ifor_test_base.models.PackageResource
        ...
        :return: An instance of AsyncLROPoller that returns either PackageResource or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~restap_ifor_test_base.models.PackageResource]
    ...
    async def _update_initial(
        ...
        **kwargs
    ) -> Optional["_models.PackageResource"]:
    ...
    async def begin_update(
        ...
        **kwargs
        ...
        :type parameters: ~restap_ifor_test_base.models.PackageUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: Pass in True if you'd like the AsyncARMPolling polling method,
         False for no polling, or your own initialized polling object for a personal polling strategy.
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~restap_ifor_test_base.models.PackageResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.PackageResource"]
        error_map = {
    ...
    async def _hard_delete_initial(
        self,
        resource_group_name: str,
        test_base_account_name: str,
        package_name: str,
    ...
    async def begin_hard_delete(
        ...
        **kwargs
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._hard_delete_initial(
                resource_group_name=resource_group_name,
                test_base_account_name=test_base_account_name,
                package_name=package_name,
                cls=lambda x,y,z: x,
