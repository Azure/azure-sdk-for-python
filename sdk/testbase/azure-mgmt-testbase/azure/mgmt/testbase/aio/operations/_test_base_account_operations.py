...
class TestBaseAccountOperations:
    """TestBaseAccountOperations async operations.
    ...
    async def begin_create(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~restap_ifor_test_base.models.TestBaseAccountResource]
