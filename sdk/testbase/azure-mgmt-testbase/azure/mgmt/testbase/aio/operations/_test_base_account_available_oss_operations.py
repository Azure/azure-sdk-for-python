...
class TestBaseAccountAvailableOSsOperations:
    """TestBaseAccountAvailableOSsOperations async operations.
    ...
    def list(
        ...
        **kwargs
    ) -> AsyncIterable["_models.AvailableOSListResult"]:
        ...
        :type os_update_type: str or ~restap_ifor_test_base.models.OsUpdateType
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either AvailableOSListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~restap_ifor_test_base.models.AvailableOSListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.AvailableOSListResult"]
        error_map = {
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('AvailableOSListResult', pipeline_response)
