...
class TestBaseAccountsOperations:
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either TestBaseAccountListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.testbase.models.TestBaseAccountListResult]
    ...
    @distributed_trace_async
    async def begin_offboard(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        test_base_account_name: str,
        **kwargs: Any
