...
class TestBaseAccountsOperations:
    """TestBaseAccountsOperations async operations.
    ...
    def list_by_subscription(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either TestBaseAccountListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~test_base.models.TestBaseAccountListResult]
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                ...
                if get_deleted is not None:
                    query_parameters['getDeleted'] = self._serialize.query("get_deleted", get_deleted, 'bool')
    ...
    async def _create_initial(
        ...
        **kwargs: Any
        ...
        if restore is not None:
            query_parameters['restore'] = self._serialize.query("restore", restore, 'bool')
        query_parameters['api-version'] = self._serialize.query("api_version", api_version, 'str')
        ...
        body_content = self._serialize.body(parameters, 'TestBaseAccountResource')
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~test_base.models.TestBaseAccountResource
        ...
        :return: An instance of AsyncLROPoller that returns either TestBaseAccountResource or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~test_base.models.TestBaseAccountResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'TestBaseAccountUpdateParameters')
        body_content_kwargs['content'] = body_content
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~test_base.models.TestBaseAccountUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be AsyncARMPolling.
         Pass in False for this operation to not poll, or pass in your own initialized polling object for a personal polling strategy.
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~test_base.models.TestBaseAccountResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.TestBaseAccountResource"]
        error_map = {
    ...
    async def _offboard_initial(
        ...
        **kwargs: Any
        ...
        # Construct URL
        url = self._offboard_initial.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'testBaseAccountName': self._serialize.url("test_base_account_name", test_base_account_name, 'str'),
    ...
    async def begin_offboard(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._offboard_initial(
                resource_group_name=resource_group_name,
                test_base_account_name=test_base_account_name,
                cls=lambda x,y,z: x,
                **kwargs
    ...
    async def get_file_upload_url(
        ...
        **kwargs: Any
        ...
        :type parameters: ~test_base.models.GetFileUploadURLParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: FileUploadURLResponse, or the result of cls(response)
        :rtype: ~test_base.models.FileUploadURLResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        ...
        # Construct URL
        url = self.get_file_upload_url.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'testBaseAccountName': self._serialize.url("test_base_account_name", test_base_account_name, 'str'),
    ...
    async def check_package_name_availability(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to the Test Base Package CheckNameAvailability
         operation.
        :type parameters: ~test_base.models.PackageCheckNameAvailabilityParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CheckNameAvailabilityResult, or the result of cls(response)
        :rtype: ~test_base.models.CheckNameAvailabilityResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
