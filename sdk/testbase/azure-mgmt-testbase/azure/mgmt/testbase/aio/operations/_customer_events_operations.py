...
from ...operations._customer_events_operations import build_create_request_initial, build_delete_request_initial, build_get_request, build_list_by_test_base_account_request
T = TypeVar('T')
...
class CustomerEventsOperations:
    ...
    def list_by_test_base_account(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either CustomerEventListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.testbase.models.CustomerEventListResult]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either CustomerEventResource or the result
         of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.testbase.models.CustomerEventResource]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
