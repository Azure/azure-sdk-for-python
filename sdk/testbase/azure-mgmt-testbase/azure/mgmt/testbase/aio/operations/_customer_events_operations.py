...
from ...operations._customer_events_operations import (
...
class CustomerEventsOperations:
    ...
    def list_by_test_base_account(
    ...
    ) -> AsyncIterable["_models.CustomerEventResource"]:
        ...
        :return: An iterator like instance of either CustomerEventResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.testbase.models.CustomerEventResource]
