...
from ...operations._favorite_processes_operations import (
...
class FavoriteProcessesOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.FavoriteProcessResource"]:
        ...
        :return: An iterator like instance of either FavoriteProcessResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.testbase.models.FavoriteProcessResource]
