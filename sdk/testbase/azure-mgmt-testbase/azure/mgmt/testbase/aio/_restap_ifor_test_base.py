...
class RESTAPIForTestBase(RESTAPIForTestBaseOperationsMixin):
    ...
    :vartype skus: restap_ifor_test_base.aio.operations.SKUsOperations
    :ivar test_base_accounts: TestBaseAccountsOperations operations
    :vartype test_base_accounts: restap_ifor_test_base.aio.operations.TestBaseAccountsOperations
    :ivar test_base_account: TestBaseAccountOperations operations
    :vartype test_base_account: restap_ifor_test_base.aio.operations.TestBaseAccountOperations
    :ivar test_base_account_usage: TestBaseAccountUsageOperations operations
    :vartype test_base_account_usage: restap_ifor_test_base.aio.operations.TestBaseAccountUsageOperations
    :ivar test_base_account_available_oss: TestBaseAccountAvailableOSsOperations operations
    :vartype test_base_account_available_oss: restap_ifor_test_base.aio.operations.TestBaseAccountAvailableOSsOperations
    :ivar test_base_account_available_os: TestBaseAccountAvailableOSOperations operations
    :vartype test_base_account_available_os: restap_ifor_test_base.aio.operations.TestBaseAccountAvailableOSOperations
    :ivar test_base_account_flighting_rings: TestBaseAccountFlightingRingsOperations operations
    :vartype test_base_account_flighting_rings: restap_ifor_test_base.aio.operations.TestBaseAccountFlightingRingsOperations
    :ivar test_base_account_flighting_ring: TestBaseAccountFlightingRingOperations operations
    :vartype test_base_account_flighting_ring: restap_ifor_test_base.aio.operations.TestBaseAccountFlightingRingOperations
    :ivar test_base_account_test_types: TestBaseAccountTestTypesOperations operations
    :vartype test_base_account_test_types: restap_ifor_test_base.aio.operations.TestBaseAccountTestTypesOperations
    :ivar test_base_account_test_type: TestBaseAccountTestTypeOperations operations
    :vartype test_base_account_test_type: restap_ifor_test_base.aio.operations.TestBaseAccountTestTypeOperations
    :ivar packages: PackagesOperations operations
    :vartype packages: restap_ifor_test_base.aio.operations.PackagesOperations
    :ivar package: PackageOperations operations
    :vartype package: restap_ifor_test_base.aio.operations.PackageOperations
    :ivar test_summaries: TestSummariesOperations operations
    :vartype test_summaries: restap_ifor_test_base.aio.operations.TestSummariesOperations
    :ivar test_summary: TestSummaryOperations operations
    :vartype test_summary: restap_ifor_test_base.aio.operations.TestSummaryOperations
    :ivar test_results: TestResultsOperations operations
    :vartype test_results: restap_ifor_test_base.aio.operations.TestResultsOperations
    :ivar test_result: TestResultOperations operations
    :vartype test_result: restap_ifor_test_base.aio.operations.TestResultOperations
    :ivar os_updates: OSUpdatesOperations operations
    :vartype os_updates: restap_ifor_test_base.aio.operations.OSUpdatesOperations
    :ivar os_update: OSUpdateOperations operations
    :vartype os_update: restap_ifor_test_base.aio.operations.OSUpdateOperations
    :ivar favorite_processes: FavoriteProcessesOperations operations
    :vartype favorite_processes: restap_ifor_test_base.aio.operations.FavoriteProcessesOperations
    :ivar favorite_process: FavoriteProcessOperations operations
    :vartype favorite_process: restap_ifor_test_base.aio.operations.FavoriteProcessOperations
    :ivar analysis_results: AnalysisResultsOperations operations
    :vartype analysis_results: restap_ifor_test_base.aio.operations.AnalysisResultsOperations
    :ivar analysis_result: AnalysisResultOperations operations
    :vartype analysis_result: restap_ifor_test_base.aio.operations.AnalysisResultOperations
    :ivar operations: Operations operations
    :vartype operations: restap_ifor_test_base.aio.operations.Operations
    ...
    async def __aenter__(self) -> "RESTAPIForTestBase":
