...
class AnalysisResultName(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AnalysisResultType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AnalysisStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """The analysis status.
    """
...
class Grade(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """The grade of a test.
    """
...
class OsUpdateType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):

    SECURITY_UPDATE = "SecurityUpdate"
    FEATURE_UPDATE = "FeatureUpdate"

class PackageStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class TestAnalysisStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class TestStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class TestType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """The test type.
    """
...
class ValidationRunStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
