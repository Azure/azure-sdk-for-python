...
def build_get_request(
    resource_group_name: str, test_base_account_name: str, test_summary_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class TestSummariesOperations:
    ...
    def list(
    ...
    ) -> Iterable["_models.TestSummaryResource"]:
        ...
        :return: An iterator like instance of either TestSummaryResource or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.testbase.models.TestSummaryResource]
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, test_base_account_name: str, test_summary_name: str, **kwargs: Any
        ...
        :param test_base_account_name: The resource name of the Test Base Account. Required.
        :type test_base_account_name: str
        :param test_summary_name: The name of the Test Summary. Required.
