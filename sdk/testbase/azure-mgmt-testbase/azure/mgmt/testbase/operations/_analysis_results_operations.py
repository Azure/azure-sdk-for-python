...
class AnalysisResultsOperations:
    ...
    def list(
        ...
        analysis_result_type: Union[str, _models.AnalysisResultType],
        **kwargs: Any
    ) -> Iterable["_models.AnalysisResultSingletonResource"]:
        ...
        :param analysis_result_type: The type of the Analysis Result of a Test Result. Known values
        ...
        :return: An iterator like instance of either AnalysisResultSingletonResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.testbase.models.AnalysisResultSingletonResource]
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :param test_result_name: The Test Result Name. It equals to TestResult-{TestResultId} string.
         Required.
        :type test_result_name: str
        :param analysis_result_name: The name of the Analysis Result of a Test Result. Known values
