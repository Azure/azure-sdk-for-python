...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "testBaseAccountName": _SERIALIZER.url("test_base_account_name", test_base_account_name, "str"),
        "flightingRingResourceName": _SERIALIZER.url(
            "flighting_ring_resource_name", flighting_ring_resource_name, "str"
        ),
    }
...
class FlightingRingsOperations:
    ...
    def list(
    ...
    ) -> Iterable["_models.FlightingRingResource"]:
        ...
        :return: An iterator like instance of either FlightingRingResource or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.testbase.models.FlightingRingResource]
