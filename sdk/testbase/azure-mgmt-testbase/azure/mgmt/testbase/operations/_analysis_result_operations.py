...
class AnalysisResultOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :type analysis_result_name: str or ~restap_ifor_test_base.models.AnalysisResultName
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AnalysisResultSingletonResource, or the result of cls(response)
        :rtype: ~restap_ifor_test_base.models.AnalysisResultSingletonResource
