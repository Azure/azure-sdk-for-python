...
class PackagesOperations:
    ...
    def list_by_test_base_account(
    ...
    ) -> Iterable["_models.PackageResource"]:
        ...
        :return: An iterator like instance of either PackageResource or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.testbase.models.PackageResource]
    ...
    def _create_initial(
        ...
        package_name: str,
        parameters: Union[_models.PackageResource, IO],
        **kwargs: Any
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param parameters: Parameters supplied to create a Test Base Package. Required.
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param package_name: The resource name of the Test Base Package. Required.
        :type package_name: str
        :param parameters: Parameters supplied to create a Test Base Package. Is either a model type or
         a IO type. Required.
        :type parameters: ~azure.mgmt.testbase.models.PackageResource or IO
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param package_name: The resource name of the Test Base Package. Required.
        :type package_name: str
        :param parameters: Parameters supplied to update a Test Base Package. Required.
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param package_name: The resource name of the Test Base Package. Required.
        :type package_name: str
        :param parameters: Parameters supplied to update a Test Base Package. Is either a model type or
         a IO type. Required.
        :type parameters: ~azure.mgmt.testbase.models.PackageUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def _hard_delete_initial(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_hard_delete_request(
            resource_group_name=resource_group_name,
            test_base_account_name=test_base_account_name,
            package_name=package_name,
            subscription_id=self._config.subscription_id,
    ...
    def run_test(  # pylint: disable=inconsistent-return-statements
        ...
        test_base_account_name: str,
        package_name: str,
        parameters: Optional[Union[_models.PackageRunTestParameters, IO]] = None,
        **kwargs: Any
    ) -> None:
        """Trigger a test run on the package.
        ...
        :param package_name: The resource name of the Test Base Package. Required.
        :type package_name: str
        :param parameters: The parameters supplied to the Test Base Package to start a Test Run. Is
         either a model type or a IO type. Default value is None.
        :type parameters: ~azure.mgmt.testbase.models.PackageRunTestParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
