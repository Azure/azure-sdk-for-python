...
def build_list_by_subscription_request(
    subscription_id: str, *, get_deleted: Optional[bool] = None, **kwargs: Any
) -> HttpRequest:
...
def build_list_by_resource_group_request(
    resource_group_name: str, subscription_id: str, *, get_deleted: Optional[bool] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class TestBaseAccountsOperations:
    ...
    def list_by_subscription(
    ...
    ) -> Iterable["_models.TestBaseAccountResource"]:
        ...
        :return: An iterator like instance of either TestBaseAccountResource or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.testbase.models.TestBaseAccountResource]
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, test_base_account_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    @distributed_trace
    def begin_offboard(self, resource_group_name: str, test_base_account_name: str, **kwargs: Any) -> LROPoller[None]:
