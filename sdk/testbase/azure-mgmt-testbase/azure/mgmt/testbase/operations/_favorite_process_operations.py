...
class FavoriteProcessOperations(object):
    """FavoriteProcessOperations operations.
    ...
    def create(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~restap_ifor_test_base.models.FavoriteProcessResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: FavoriteProcessResource, or the result of cls(response)
        :rtype: ~restap_ifor_test_base.models.FavoriteProcessResource
