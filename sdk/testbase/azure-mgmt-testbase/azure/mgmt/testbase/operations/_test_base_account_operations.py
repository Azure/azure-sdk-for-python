...
class TestBaseAccountOperations(object):
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~restap_ifor_test_base.models.TestBaseAccountResource
        ...
        :return: An instance of LROPoller that returns either TestBaseAccountResource or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~restap_ifor_test_base.models.TestBaseAccountResource]
    ...
    def begin_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~restap_ifor_test_base.models.TestBaseAccountUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: Pass in True if you'd like the ARMPolling polling method,
         False for no polling, or your own initialized polling object for a personal polling strategy.
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~restap_ifor_test_base.models.TestBaseAccountResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.TestBaseAccountResource"]
        error_map = {
