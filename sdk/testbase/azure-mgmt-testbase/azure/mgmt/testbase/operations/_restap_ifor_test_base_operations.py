...
class RESTAPIForTestBaseOperationsMixin(object):

    def test_base_account_get_file_upload_url(
        self,
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.FileUploadURLResponse"
    ...
    def test_result_get_download_url(
        self,
        resource_group_name,  # type: str
        test_base_account_name,  # type: str
        package_name,  # type: str
    ...
    def test_result_get_video_download_url(
        self,
        resource_group_name,  # type: str
        test_base_account_name,  # type: str
        package_name,  # type: str
