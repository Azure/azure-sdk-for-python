...
def build_list_by_test_base_account_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/customerEvents')
...
def build_create_request_initial(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/customerEvents/{customerEventName}')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str'),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
        "testBaseAccountName": _SERIALIZER.url("test_base_account_name", test_base_account_name, 'str'),
...
class CustomerEventsOperations(object):
    ...
    def list_by_test_base_account(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.CustomerEventListResult"]
    ...
    def _create_initial(
        ...
        test_base_account_name,  # type: str
        customer_event_name,  # type: str
        parameters,  # type: "_models.CustomerEventResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.CustomerEventResource"
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.CustomerEventResource"]
