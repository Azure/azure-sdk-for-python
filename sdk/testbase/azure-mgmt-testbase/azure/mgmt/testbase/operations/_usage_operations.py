...
class UsageOperations:
    ...
    @distributed_trace
    def list(
        self, resource_group_name: str, test_base_account_name: str, filter: Optional[str] = None, **kwargs: Any
    ) -> Iterable["_models.TestBaseAccountUsageData"]:
        ...
        :return: An iterator like instance of either TestBaseAccountUsageData or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.testbase.models.TestBaseAccountUsageData]
