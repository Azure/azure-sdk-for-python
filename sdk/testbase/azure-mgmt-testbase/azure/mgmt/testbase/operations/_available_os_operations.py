...
class AvailableOSOperations:
    ...
    def list(
        ...
        os_update_type: Union[str, _models.OsUpdateType],
        **kwargs: Any
    ) -> Iterable["_models.AvailableOSResource"]:
        ...
        :return: An iterator like instance of either AvailableOSResource or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.testbase.models.AvailableOSResource]
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, test_base_account_name: str, available_os_resource_name: str, **kwargs: Any
        ...
        :param test_base_account_name: The resource name of the Test Base Account. Required.
        :type test_base_account_name: str
        :param available_os_resource_name: The resource name of an Available OS. Required.
        :type available_os_resource_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AvailableOSResource or the result of cls(response)
        :rtype: ~azure.mgmt.testbase.models.AvailableOSResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
