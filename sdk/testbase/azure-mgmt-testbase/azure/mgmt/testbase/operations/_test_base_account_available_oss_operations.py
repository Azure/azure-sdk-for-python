...
class TestBaseAccountAvailableOSsOperations(object):
    """TestBaseAccountAvailableOSsOperations operations.
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~restap_ifor_test_base.models.AvailableOSListResult]
