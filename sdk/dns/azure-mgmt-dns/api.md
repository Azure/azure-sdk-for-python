...
namespace azure.mgmt.dns.types
    ...
    class azure.mgmt.dns.types.CloudError(TypedDict, total=False):
        key "error": ForwardRef('CloudErrorBody', module='types')
        error: CloudErrorBody


    class azure.mgmt.dns.types.CloudErrorBody(TypedDict, total=False):
        key "code": str
        key "message": str
        key "target": str
        code: str
    ...
    class azure.mgmt.dns.types.DnsResourceReference(TypedDict, total=False):
        key "targetResource": ForwardRef('SubResource', module='types')
        dnsResources: list[SubResource]
    ...
    class azure.mgmt.dns.types.DnsResourceReferenceResult(TypedDict, total=False):
        key "properties": ForwardRef('DnsResourceReferenceResultProperties', module='types')
        properties: DnsResourceReferenceResultProperties


    class azure.mgmt.dns.types.DnsResourceReferenceResultProperties(TypedDict, total=False):
        dnsResourceReferences: list[DnsResourceReference]
        dns_resource_references: list[DnsResourceReference]


    class azure.mgmt.dns.types.DnssecConfig(ProxyResource):
        key "etag": str
        key "id": str
        key "name": str
        key "properties": ForwardRef('DnssecProperties', module='types')
    ...
    class azure.mgmt.dns.types.DnssecProperties(TypedDict, total=False):
