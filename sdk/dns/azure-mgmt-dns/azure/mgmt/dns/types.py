...
class DnsResourceReference(TypedDict, total=False):
    """Represents a single Azure resource and its referencing DNS records.

    :ivar dns_resources: A list of dns Records.
    :vartype dns_resources: list["SubResource"]
...
class DnsResourceReferenceResult(TypedDict, total=False):
    ...
    :vartype properties: "DnsResourceReferenceResultProperties"
    """
...
class DnsResourceReferenceResultProperties(TypedDict, total=False):
    """The result of dns resource reference request. Returns a list of dns resource references for
    each of the azure resource in the request.
    ...
    :vartype dns_resource_references: list["DnsResourceReference"]
    """
...
class DnssecConfig(ProxyResource):
    ...
    :vartype properties: "DnssecProperties"
...
class DnssecProperties(TypedDict, total=False):
