...
class DataBoxEdgeManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype operations:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.Operations
    :ivar available_skus: AvailableSkusOperations operations
    :vartype available_skus:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.AvailableSkusOperations
    :ivar devices: DevicesOperations operations
    :vartype devices:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.DevicesOperations
    :ivar alerts: AlertsOperations operations
    :vartype alerts:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.AlertsOperations
    :ivar bandwidth_schedules: BandwidthSchedulesOperations operations
    :vartype bandwidth_schedules:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.BandwidthSchedulesOperations
    :ivar jobs: JobsOperations operations
    :vartype jobs:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.JobsOperations
    :ivar nodes: NodesOperations operations
    :vartype nodes:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.NodesOperations
    :ivar operations_status: OperationsStatusOperations operations
    :vartype operations_status:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.OperationsStatusOperations
    :ivar orders: OrdersOperations operations
    :vartype orders:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.OrdersOperations
    :ivar roles: RolesOperations operations
    :vartype roles:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.RolesOperations
    :ivar shares: SharesOperations operations
    :vartype shares:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.SharesOperations
    :ivar storage_account_credentials: StorageAccountCredentialsOperations operations
    :vartype storage_account_credentials:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.StorageAccountCredentialsOperations
    :ivar storage_accounts: StorageAccountsOperations operations
    :vartype storage_accounts:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.StorageAccountsOperations
    :ivar containers: ContainersOperations operations
    :vartype containers:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.ContainersOperations
    :ivar triggers: TriggersOperations operations
    :vartype triggers:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.TriggersOperations
    :ivar users: UsersOperations operations
    :vartype users:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.UsersOperations
    :ivar skus: SkusOperations operations
    :vartype skus:
     azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.aio.operations.SkusOperations
