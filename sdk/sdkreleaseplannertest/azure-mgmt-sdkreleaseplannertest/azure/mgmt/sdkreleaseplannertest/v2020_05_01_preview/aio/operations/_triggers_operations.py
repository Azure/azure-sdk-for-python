...
class TriggersOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.models.Trigger]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either Trigger or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sdkreleaseplannertest.v2020_05_01_preview.models.Trigger]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
