...
class TriggersOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sdkreleaseplannertest.v2019_07_01.models.Trigger]
    ...
    async def get(self, device_name: str, name: str, resource_group_name: str, **kwargs: Any) -> _models.Trigger:
        ...
        :rtype: ~azure.mgmt.sdkreleaseplannertest.v2019_07_01.models.Trigger
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type trigger: ~azure.mgmt.sdkreleaseplannertest.v2019_07_01.models.Trigger
        ...
        :return: An instance of AsyncLROPoller that returns either Trigger or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sdkreleaseplannertest.v2019_07_01.models.Trigger]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        :param resource_group_name: The resource group name. Required.
        :type resource_group_name: str
        :param trigger: The trigger. Is either a model type or a IO type. Required.
        :type trigger: ~azure.mgmt.sdkreleaseplannertest.v2019_07_01.models.Trigger or IO
