...
class StorageAccountCredentialsOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        :return: An iterator like instance of either StorageAccountCredential or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.sdkreleaseplannertest.v2019_03_01.models.StorageAccountCredential]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either StorageAccountCredential or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.sdkreleaseplannertest.v2019_03_01.models.StorageAccountCredential]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
