...
from ...operations._alerts_operations import build_get_request, build_list_by_data_box_edge_device_request
...
class AlertsOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sdkreleaseplannertest.v2019_03_01.models.Alert]
    ...
    async def get(self, device_name: str, name: str, resource_group_name: str, **kwargs: Any) -> _models.Alert:
        ...
        :rtype: ~azure.mgmt.sdkreleaseplannertest.v2019_03_01.models.Alert
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
