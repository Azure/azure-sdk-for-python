...
class SkusOperations:
    ...
    @distributed_trace
    def list(self, filter: Optional[str] = None, **kwargs: Any) -> AsyncIterable["_models.ResourceTypeSku"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sdkreleaseplannertest.v2019_08_01.models.ResourceTypeSku]
