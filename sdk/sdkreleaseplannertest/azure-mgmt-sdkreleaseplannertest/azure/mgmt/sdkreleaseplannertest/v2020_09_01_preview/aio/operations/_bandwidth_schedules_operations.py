...
class BandwidthSchedulesOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sdkreleaseplannertest.v2020_09_01_preview.models.BandwidthSchedule]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either BandwidthSchedule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sdkreleaseplannertest.v2020_09_01_preview.models.BandwidthSchedule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
