...
class UsersOperations:
    ...
    def list_by_data_box_edge_device(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.sdkreleaseplannertest.v2021_02_01.models.User]
    ...
    list_by_data_box_edge_device.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/users"
    }
    ...
    async def get(self, device_name: str, name: str, resource_group_name: str, **kwargs: Any) -> _models.User:
        ...
        :rtype: ~azure.mgmt.sdkreleaseplannertest.v2021_02_01.models.User
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/users/{name}"
    }

    async def _create_or_update_initial(
        self, device_name: str, name: str, resource_group_name: str, user: Union[_models.User, IO], **kwargs: Any
        ...
        cls: ClsType[Optional[_models.User]] = kwargs.pop("cls", None)
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type user: ~azure.mgmt.sdkreleaseplannertest.v2021_02_01.models.User
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.sdkreleaseplannertest.v2021_02_01.models.User]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        :param resource_group_name: The resource group name. Required.
        :type resource_group_name: str
        :param user: The user details. Is either a model type or a IO type. Required.
        :type user: ~azure.mgmt.sdkreleaseplannertest.v2021_02_01.models.User or IO
