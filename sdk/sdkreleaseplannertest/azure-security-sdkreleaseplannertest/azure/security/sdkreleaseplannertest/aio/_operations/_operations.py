...
from ..._operations._operations import (
    build_sdk_release_planner_test_create_ledger_entry_request,
    build_sdk_release_planner_test_create_or_update_user_request,
    build_sdk_release_planner_test_delete_user_request,
    build_sdk_release_planner_test_get_consortium_members_request,
    build_sdk_release_planner_test_get_constitution_request,
    build_sdk_release_planner_test_get_current_ledger_entry_request,
    build_sdk_release_planner_test_get_enclave_quotes_request,
    build_sdk_release_planner_test_get_ledger_entry_request,
    build_sdk_release_planner_test_get_receipt_request,
    build_sdk_release_planner_test_get_transaction_status_request,
    build_sdk_release_planner_test_get_user_request,
    build_sdk_release_planner_test_list_collections_request,
    build_sdk_release_planner_test_list_ledger_entries_request,
)
from .._vendor import SDKReleasePlannerTestClientMixinABC
...
class SDKReleasePlannerTestClientOperationsMixin(SDKReleasePlannerTestClientMixinABC):
    ...
    def list_ledger_entries(self, **kwargs: Any) -> AsyncIterable["_models.LedgerEntry"]:
        ...
        :return: An iterator like instance of LedgerEntry. The LedgerEntry is compatible with
         MutableMapping
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.security.sdkreleaseplannertest.models.LedgerEntry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
