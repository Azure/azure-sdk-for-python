...
class SDKReleasePlannerTestClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    """Configuration for SDKReleasePlannerTestClient.
    ...
    def __init__(self, ledger_uri: str, credential: "AsyncTokenCredential", api_version: str, **kwargs: Any) -> None:
        super(SDKReleasePlannerTestClientConfiguration, self).__init__(**kwargs)
        ...
        kwargs.setdefault("sdk_moniker", "security-sdkreleaseplannertest/{}".format(VERSION))
