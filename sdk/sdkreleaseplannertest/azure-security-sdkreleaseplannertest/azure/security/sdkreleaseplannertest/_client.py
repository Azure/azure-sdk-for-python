...
class SDKReleasePlannerTestClient(
    SDKReleasePlannerTestClientOperationsMixin
):  # pylint: disable=client-accepts-api-version-keyword
    """SDKReleasePlannerTestClient.
    ...
    def __init__(self, ledger_uri: str, credential: "TokenCredential", api_version: str, **kwargs: Any) -> None:
        _endpoint = "{ledgerUri}"
        self._config = SDKReleasePlannerTestClientConfiguration(
    ...
    def __enter__(self) -> "SDKReleasePlannerTestClient":
