...
from .._vendor import SDKReleasePlannerTestClientMixinABC, _format_url_section
...
def build_sdk_release_planner_test_list_collections_request(*, api_version: str, **kwargs: Any) -> HttpRequest:
...
def build_sdk_release_planner_test_get_enclave_quotes_request(*, api_version: str, **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_sdk_release_planner_test_get_constitution_request(*, api_version: str, **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_sdk_release_planner_test_get_consortium_members_request(*, api_version: str, **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_sdk_release_planner_test_list_ledger_entries_request(*, api_version: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_sdk_release_planner_test_create_ledger_entry_request(
...
def build_sdk_release_planner_test_get_ledger_entry_request(
...
def build_sdk_release_planner_test_get_receipt_request(
...
def build_sdk_release_planner_test_get_transaction_status_request(
    transaction_id: str, *, api_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_sdk_release_planner_test_get_current_ledger_entry_request(
    *, api_version: str, collection_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_sdk_release_planner_test_delete_user_request(user_id: str, *, api_version: str, **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_sdk_release_planner_test_get_user_request(user_id: str, *, api_version: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_sdk_release_planner_test_create_or_update_user_request(
...
class SDKReleasePlannerTestClientOperationsMixin(SDKReleasePlannerTestClientMixinABC):
    @distributed_trace
    def list_collections(self, **kwargs: Any) -> List[_models.CollectionModel]:
        ...
        :rtype: list[~azure.security.sdkreleaseplannertest.models.CollectionModel]
        ...
        request = build_sdk_release_planner_test_list_collections_request(
    ...
    def get_enclave_quotes(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        request = build_sdk_release_planner_test_get_enclave_quotes_request(
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
        )
    ...
    def get_constitution(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        request = build_sdk_release_planner_test_get_constitution_request(
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
        )
    ...
    def get_consortium_members(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        request = build_sdk_release_planner_test_get_consortium_members_request(
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
        )
    ...
    def list_ledger_entries(self, **kwargs: Any) -> Iterable["_models.LedgerEntry"]:
        ...
        :return: An iterator like instance of LedgerEntry. The LedgerEntry is compatible with
         MutableMapping
        :rtype: ~azure.core.paging.ItemPaged[~azure.security.sdkreleaseplannertest.models.LedgerEntry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_sdk_release_planner_test_list_ledger_entries_request(
                    api_version=self._config.api_version,
                    headers=_headers,
                    params=_params,
                )
    ...
    def create_ledger_entry(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~azure.security.sdkreleaseplannertest.models.LedgerEntry
    ...
    @overload
    def create_ledger_entry(  # pylint: disable=inconsistent-return-statements
        self, body: JSON, *, collection_id: Optional[str] = None, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """Writes a ledger entry.
    ...
    def create_ledger_entry(  # pylint: disable=inconsistent-return-statements
        ...
        :type body: ~azure.security.sdkreleaseplannertest.models.LedgerEntry or JSON or IO
        :keyword collection_id: The collection id. Default value is None.
        :paramtype collection_id: str
        ...
        request = build_sdk_release_planner_test_create_ledger_entry_request(
            api_version=self._config.api_version,
    ...
    def get_ledger_entry(
        ...
        :rtype: ~azure.security.sdkreleaseplannertest.models.LedgerEntry
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_sdk_release_planner_test_get_ledger_entry_request(
    ...
    def get_receipt(self, transaction_id: str, **kwargs: Any) -> _models.TransactionReceipt:
        ...
        :rtype: ~azure.security.sdkreleaseplannertest.models.TransactionReceipt
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_sdk_release_planner_test_get_receipt_request(
            transaction_id=transaction_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    def get_transaction_status(self, transaction_id: str, **kwargs: Any) -> _models.TransactionStatus:
        ...
        :rtype: ~azure.security.sdkreleaseplannertest.models.TransactionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_sdk_release_planner_test_get_transaction_status_request(
            transaction_id=transaction_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    def get_current_ledger_entry(self, *, collection_id: Optional[str] = None, **kwargs: Any) -> _models.LedgerEntry:
        ...
        request = build_sdk_release_planner_test_get_current_ledger_entry_request(
            api_version=self._config.api_version,
            collection_id=collection_id,
            headers=_headers,
            params=_params,
    ...
    def delete_user(self, user_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        ...
        request = build_sdk_release_planner_test_delete_user_request(
            user_id=user_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    def get_user(self, user_id: str, **kwargs: Any) -> _models.LedgerUser:
        ...
        :rtype: ~azure.security.sdkreleaseplannertest.models.LedgerUser
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_sdk_release_planner_test_get_user_request(
            user_id=user_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
    ...
    def create_or_update_user(
        ...
        **kwargs: Any
        ...
        :type user_id: str
        :param body: Required.
        :type body: ~azure.security.sdkreleaseplannertest.models.LedgerUser
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
    ...
    @overload
    def create_or_update_user(
        self, user_id: str, body: JSON, *, content_type: str = "application/merge-patch+json", **kwargs: Any
    ) -> _models.LedgerUser:
        """Adds a user or updates a user's fields.
    ...
    def create_or_update_user(
        ...
        :type user_id: str
        :param body: Is one of the following types: model, JSON, IO Required.
        :type body: ~azure.security.sdkreleaseplannertest.models.LedgerUser or JSON or IO
        ...
        request = build_sdk_release_planner_test_create_or_update_user_request(
            user_id=user_id,
            api_version=self._config.api_version,
            content_type=content_type,
            content=_content,
