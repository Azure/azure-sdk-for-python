...
class TestServiceGroupsMgmtServiceGroupsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(ServiceGroupsMgmtClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_service_groups_get(self, resource_group):
        response = self.client.service_groups.get(
