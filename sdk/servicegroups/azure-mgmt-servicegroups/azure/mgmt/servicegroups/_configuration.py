...
class ManagementClientConfiguration:  # pylint: disable=too-many-instance-attributes
    ...
    :keyword api_version: The API version to use for this operation. Known values are
     "2024-02-01-preview" and None. Default value is "2024-02-01-preview". Note that overriding this
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        kwargs.setdefault("sdk_moniker", "mgmt-servicegroups/{}".format(VERSION))
