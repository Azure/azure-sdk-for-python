...
# USAGE
    python macc_and_milestone_end_date_update.py
...
def main():
    ...
    response = client.maccs.begin_update(
        ...
        body={
            "properties": {
                "endAt": "2029-05-01T23:59:59Z",
                "milestones": [
                    {"endAt": "2027-05-31T23:59:59Z", "milestoneId": "11111111-1111-1111-1111-111111111111"},
                    {"endAt": "2028-05-31T23:59:59Z", "milestoneId": "22222222-2222-2222-2222-222222222222"},
                ],
            }
        },
    ).result()
