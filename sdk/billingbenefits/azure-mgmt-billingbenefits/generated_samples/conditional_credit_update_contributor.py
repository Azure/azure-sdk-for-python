...
# USAGE
    python conditional_credit_update_contributor.py
...
def main():
    ...
    response = client.conditional_credits.begin_update(
        resource_group_name="resource_group_name_02",
        conditional_credit_name="conditionalCreditContributor_20250801",
        body={
            "properties": {"displayName": "Updated Contributor Conditional Credit 20250801"},
