...
class BillingBenefitsRP:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :ivar savings_plans_in_order: SavingsPlansInOrderOperations operations
    :vartype savings_plans_in_order:
     azure.mgmt.billingbenefits.operations.SavingsPlansInOrderOperations
    :ivar savings_plans: SavingsPlansOperations operations
    :vartype savings_plans: azure.mgmt.billingbenefits.operations.SavingsPlansOperations
    ...
    :ivar savings_plan_update: SavingsPlanUpdateOperations operations
    :vartype savings_plan_update: azure.mgmt.billingbenefits.operations.SavingsPlanUpdateOperations
    :ivar savings_plan_purchase: SavingsPlanPurchaseOperations operations
    :vartype savings_plan_purchase:
     azure.mgmt.billingbenefits.operations.SavingsPlanPurchaseOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.savings_plans_in_order = SavingsPlansInOrderOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
        ...
        self.savings_plan_update = SavingsPlanUpdateOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
        self.savings_plan_purchase = SavingsPlanPurchaseOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
