...
class SavingsPlanOperations:
    ...
    def get(self, savings_plan_order_id: str, savings_plan_id: str, **kwargs: Any) -> _models.SavingsPlanModel:
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.SavingsPlanModel]
    ...
    get.metadata = {"url": "/providers/Microsoft.BillingBenefits/savingsPlanOrders/{savingsPlanOrderId}/savingsPlans/{savingsPlanId}"}  # type: ignore
    ...
    def update(
        ...
        **kwargs: Any
        ...
        content_type = kwargs.pop("content_type", _headers.pop("Content-Type", None))  # type: Optional[str]
        cls = kwargs.pop("cls", None)  # type: ClsType[Optional[_models.SavingsPlanModel]]
    ...
    update.metadata = {"url": "/providers/Microsoft.BillingBenefits/savingsPlanOrders/{savingsPlanOrderId}/savingsPlans/{savingsPlanId}"}  # type: ignore
