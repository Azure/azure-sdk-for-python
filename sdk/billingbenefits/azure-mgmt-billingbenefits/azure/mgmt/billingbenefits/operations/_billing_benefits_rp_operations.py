...
def build_validate_purchase_request(**kwargs: Any) -> HttpRequest:
...
class _BillingBenefitsRPOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], BillingBenefitsRPConfiguration]
):
