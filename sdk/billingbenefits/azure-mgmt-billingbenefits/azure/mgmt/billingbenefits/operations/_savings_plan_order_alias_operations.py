...
def build_create_request(savings_plan_order_alias_name: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/providers/Microsoft.BillingBenefits/savingsPlanOrderAliases/{savingsPlanOrderAliasName}"
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "savingsPlanOrderAliasName": _SERIALIZER.url(
            "savings_plan_order_alias_name", savings_plan_order_alias_name, "str", pattern=r"^[a-zA-Z0-9_\-\.]+$"
        ),
    }
...
def build_get_request(savings_plan_order_alias_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class SavingsPlanOrderAliasOperations:
    ...
    def _create_initial(
        ...
        content_type = kwargs.pop("content_type", _headers.pop("Content-Type", None))  # type: Optional[str]
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.SavingsPlanOrderAliasModel]
    ...
    _create_initial.metadata = {"url": "/providers/Microsoft.BillingBenefits/savingsPlanOrderAliases/{savingsPlanOrderAliasName}"}  # type: ignore
    ...
    begin_create.metadata = {"url": "/providers/Microsoft.BillingBenefits/savingsPlanOrderAliases/{savingsPlanOrderAliasName}"}  # type: ignore
    ...
    get.metadata = {"url": "/providers/Microsoft.BillingBenefits/savingsPlanOrderAliases/{savingsPlanOrderAliasName}"}  # type: ignore
