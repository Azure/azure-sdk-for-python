...
def build_validate_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.BillingBenefits/validate")
...
class SavingsPlanPurchaseOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`savings_plan_purchase` attribute.
    """
    ...
    def validate(
        ...
        content_type = kwargs.pop("content_type", _headers.pop("Content-Type", None))  # type: Optional[str]
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.SavingsPlanValidateResponse]
    ...
    validate.metadata = {"url": "/providers/Microsoft.BillingBenefits/validate"}  # type: ignore
