...
class PurchaseRequest(_serialization.Model):
    ...
    :ivar term: Represent SavingsPlan term in ISO 8601 format. Known values are: "P1Y" and "P3Y".
    :vartype term: str or ~azure.mgmt.billingbenefits.models.SavingsPlanTerm
    ...
    :ivar renew: Setting this to true will automatically purchase a new savings plan on the
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword term: Represent SavingsPlan term in ISO 8601 format. Known values are: "P1Y" and
         "P3Y".
        :paramtype term: str or ~azure.mgmt.billingbenefits.models.SavingsPlanTerm
        ...
        :keyword renew: Setting this to true will automatically purchase a new savings plan on the
         expiration date time.
...
class ReservationOrderAliasRequest(Resource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar reserved_resource_type: The type of the resource that is being reserved. Known values
     are: "ComputeSavingsPlan", "VirtualMachines", "SqlDatabases", "SuseLinux", "CosmosDb",
     "RedHat", "SqlDataWarehouse", "VMwareCloudSimple", "RedHatOsa", "Databricks", "AppService",
...
class SavingsPlanModel(Resource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype renew_properties:
     ~azure.mgmt.billingbenefits.models.SavingsPlanModelPropertiesRenewProperties
    """
    ...
    _attribute_map = {
        ...
        "renew_properties": {"key": "properties.renewProperties", "type": "SavingsPlanModelPropertiesRenewProperties"},
    }
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        renew: bool = False,
        renew_properties: Optional["_models.SavingsPlanModelPropertiesRenewProperties"] = None,
        **kwargs
    ):
        """
...
class SavingsPlanModelPropertiesRenewProperties(_serialization.Model):
