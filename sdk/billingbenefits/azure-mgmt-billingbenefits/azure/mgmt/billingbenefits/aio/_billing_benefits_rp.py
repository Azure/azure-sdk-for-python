...
class BillingBenefitsRP:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype savings_plans_in_order:
     azure.mgmt.billingbenefits.aio.operations.SavingsPlansInOrderOperations
    :ivar savings_plans: SavingsPlansOperations operations
    :vartype savings_plans: azure.mgmt.billingbenefits.aio.operations.SavingsPlansOperations
    ...
    :vartype savings_plan_update:
     azure.mgmt.billingbenefits.aio.operations.SavingsPlanUpdateOperations
    :ivar savings_plan_purchase: SavingsPlanPurchaseOperations operations
    :vartype savings_plan_purchase:
     azure.mgmt.billingbenefits.aio.operations.SavingsPlanPurchaseOperations
