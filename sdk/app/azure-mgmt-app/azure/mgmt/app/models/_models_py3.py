...
class Apple(msrest.serialization.Model):
    ...
    :ivar state: :code:`<code>Disabled</code>` if the Apple provider should not be enabled despite
     the set registration; otherwise, :code:`<code>Enabled</code>`. Possible values include:
     "Enabled", "Disabled".
    :vartype state: str or ~container_apps_api_client.models.IdentityProviderState
    ...
    def __init__(
        self,
        *,
        state: Optional[Union[str, "IdentityProviderState"]] = None,
        registration: Optional["AppleRegistration"] = None,
        login: Optional["LoginScopes"] = None,
        **kwargs
    ):
        """
        :keyword state: :code:`<code>Disabled</code>` if the Apple provider should not be enabled
         despite the set registration; otherwise, :code:`<code>Enabled</code>`. Possible values include:
         "Enabled", "Disabled".
        :paramtype state: str or ~container_apps_api_client.models.IdentityProviderState
...
class AppleRegistration(msrest.serialization.Model):
    ...
    :ivar client_secret_ref_name: The app secret ref name that contains the client secret.
    :vartype client_secret_ref_name: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword client_secret_ref_name: The app secret ref name that contains the client secret.
        :paramtype client_secret_ref_name: str
        """
        super(AppleRegistration, self).__init__(**kwargs)
        self.client_id = client_id
        self.client_secret_ref_name = client_secret_ref_name
...
class AppRegistration(msrest.serialization.Model):
    ...
    :vartype app_id: str
    :ivar app_secret_ref_name: The app secret ref name that contains the app secret.
    :vartype app_secret_ref_name: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword app_secret_ref_name: The app secret ref name that contains the app secret.
        :paramtype app_secret_ref_name: str
        """
        super(AppRegistration, self).__init__(**kwargs)
        self.app_id = app_id
        self.app_secret_ref_name = app_secret_ref_name
...
class AuthConfig(ProxyResource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~container_apps_api_client.models.SystemData
    :ivar state: :code:`<code>Enabled</code>` if the Authentication / Authorization feature is
     enabled for the current app; otherwise, :code:`<code>Disabled</code>`. Possible values include:
     "Enabled", "Disabled".
    :vartype state: str or ~container_apps_api_client.models.EasyAuthState
    :ivar global_validation: The configuration settings that determines the validation flow of
     users using ContainerApp Authentication/Authorization.
    ...
    :ivar login: The configuration settings of the login flow of users using ContainerApp
    ...
    def __init__(
        self,
        *,
        state: Optional[Union[str, "EasyAuthState"]] = None,
        ...
        **kwargs
        ...
        """
        :keyword state: :code:`<code>Enabled</code>` if the Authentication / Authorization feature is
         enabled for the current app; otherwise, :code:`<code>Disabled</code>`. Possible values include:
         "Enabled", "Disabled".
        :paramtype state: str or ~container_apps_api_client.models.EasyAuthState
        ...
        :keyword identity_providers: The configuration settings of each of the identity providers used
         to configure ContainerApp Authentication/Authorization.
...
class AuthConfigCollection(msrest.serialization.Model):
...
class AzureActiveDirectory(msrest.serialization.Model):
    ...
    :ivar state: :code:`<code>Disabled</code>` if the Azure Active Directory provider should not be
     enabled despite the set registration; otherwise, :code:`<code>Enabled</code>`. Possible values
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword state: :code:`<code>Disabled</code>` if the Azure Active Directory provider should not
         be enabled despite the set registration; otherwise, :code:`<code>Enabled</code>`. Possible
...
class AzureActiveDirectoryLogin(msrest.serialization.Model):
    ...
    :ivar disable_www_authenticate: :code:`<code>true</code>` if the www-authenticate provider
     should be omitted from the request; otherwise, :code:`<code>false</code>`. Possible values
     include: "True", "False".
    :vartype disable_www_authenticate: str or
     ~container_apps_api_client.models.DisableWwwAuthenticateMode
    """
    ...
    def __init__(
        ...
        *,
        ...
        disable_www_authenticate: Optional[Union[str, "DisableWwwAuthenticateMode"]] = None,
        **kwargs
    ):
        """
        ...
        :keyword disable_www_authenticate: :code:`<code>true</code>` if the www-authenticate provider
         should be omitted from the request; otherwise, :code:`<code>false</code>`. Possible values
         include: "True", "False".
        :paramtype disable_www_authenticate: str or
         ~container_apps_api_client.models.DisableWwwAuthenticateMode
        """
...
class AzureActiveDirectoryRegistration(msrest.serialization.Model):
    ...
    :vartype client_id: str
    :ivar client_secret_ref_name: The app secret ref name that contains the client secret of the
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword client_id: The Client ID of this relying party application, known as the client_id.
         ...
         More information on OpenID Connect: http://openid.net/specs/openid-connect-core-1_0.html.
        :paramtype client_id: str
        :keyword client_secret_ref_name: The app secret ref name that contains the client secret of the
         relying party application.
        :paramtype client_secret_ref_name: str
...
class AzureCredentials(msrest.serialization.Model):
...
class AzureFileProperties(msrest.serialization.Model):
...
class AzureStaticWebApp(msrest.serialization.Model):
    """The configuration settings of the Azure Static Web Apps provider.

    :ivar state: :code:`<code>Disabled</code>` if the Azure Static Web Apps provider should not be
     enabled despite the set registration; otherwise, :code:`<code>Enabled</code>`. Possible values
     include: "Enabled", "Disabled".
    :vartype state: str or ~container_apps_api_client.models.IdentityProviderState
    :ivar registration: The configuration settings of the Azure Static Web Apps registration.
    :vartype registration: ~container_apps_api_client.models.AzureStaticWebAppRegistration
    """
    ...
    def __init__(
        ...
        *,
        state: Optional[Union[str, "IdentityProviderState"]] = None,
        registration: Optional["AzureStaticWebAppRegistration"] = None,
        **kwargs
    ):
        """
        :keyword state: :code:`<code>Disabled</code>` if the Azure Static Web Apps provider should not
         be enabled despite the set registration; otherwise, :code:`<code>Enabled</code>`. Possible
         values include: "Enabled", "Disabled".
        :paramtype state: str or ~container_apps_api_client.models.IdentityProviderState
        :keyword registration: The configuration settings of the Azure Static Web Apps registration.
        :paramtype registration: ~container_apps_api_client.models.AzureStaticWebAppRegistration
        """
...
class AzureStaticWebAppRegistration(msrest.serialization.Model):
...
class ContainerAppProbe(msrest.serialization.Model):
    ...
    :vartype termination_grace_period_seconds: long
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype termination_grace_period_seconds: long
...
class ContainerAppProbeHttpGet(msrest.serialization.Model):
...
class ContainerAppProbeHttpGetHttpHeadersItem(msrest.serialization.Model):
    """HTTPHeader describes a custom header to be used in HTTP probes.

    All required parameters must be populated in order to send to Azure.

    :ivar name: Required. The header field name.
    :vartype name: str
    :ivar value: Required. The header field value.
    :vartype value: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype name: str
        :keyword value: Required. The header field value.
        :paramtype value: str
        """
...
class ContainerAppProbeTcpSocket(msrest.serialization.Model):
    ...
    :vartype host: str
    :ivar port: Required. Number or name of the port to access on the container. Number must be in
     the range 1 to 65535. Name must be an IANA_SVC_NAME.
    :vartype port: int
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype host: str
        :keyword port: Required. Number or name of the port to access on the container. Number must be
         in the range 1 to 65535. Name must be an IANA_SVC_NAME.
        :paramtype port: int
        """
...
class ContainerAppSecret(msrest.serialization.Model):
...
class ContainerResources(msrest.serialization.Model):
...
class CustomOpenIdConnectProvider(msrest.serialization.Model):
    ...
    :ivar state: :code:`<code>Disabled</code>` if the custom Open ID Connect provider should not be
     enabled despite the set registration; otherwise, :code:`<code>Enabled</code>`. Possible values
     include: "Enabled", "Disabled".
    :vartype state: str or ~container_apps_api_client.models.IdentityProviderState
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword state: :code:`<code>Disabled</code>` if the custom Open ID Connect provider should not
         be enabled despite the set registration; otherwise, :code:`<code>Enabled</code>`. Possible
         values include: "Enabled", "Disabled".
        :paramtype state: str or ~container_apps_api_client.models.IdentityProviderState
...
class CustomScaleRule(msrest.serialization.Model):
...
class Dapr(msrest.serialization.Model):
...
class Facebook(msrest.serialization.Model):
    ...
    :ivar state: :code:`<code>Disabled</code>` if the Facebook provider should not be enabled
     despite the set registration; otherwise, :code:`<code>Enabled</code>`. Possible values include:
     "Enabled", "Disabled".
    :vartype state: str or ~container_apps_api_client.models.IdentityProviderState
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword state: :code:`<code>Disabled</code>` if the Facebook provider should not be enabled
         despite the set registration; otherwise, :code:`<code>Enabled</code>`. Possible values include:
         "Enabled", "Disabled".
        :paramtype state: str or ~container_apps_api_client.models.IdentityProviderState
...
class GitHub(msrest.serialization.Model):
    ...
    :ivar state: :code:`<code>Disabled</code>` if the GitHub provider should not be enabled despite
     the set registration; otherwise, :code:`<code>Enabled</code>`. Possible values include:
     "Enabled", "Disabled".
    :vartype state: str or ~container_apps_api_client.models.IdentityProviderState
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword state: :code:`<code>Disabled</code>` if the GitHub provider should not be enabled
         despite the set registration; otherwise, :code:`<code>Enabled</code>`. Possible values include:
         "Enabled", "Disabled".
        :paramtype state: str or ~container_apps_api_client.models.IdentityProviderState
...
class GlobalValidation(msrest.serialization.Model):
    ...
    :vartype unauthenticated_client_action: str or
     ~container_apps_api_client.models.UnauthenticatedClientAction
...
class Google(msrest.serialization.Model):
    ...
    :ivar state: :code:`<code>Disabled</code>` if the Google provider should not be enabled despite
     the set registration; otherwise, :code:`<code>Enabled</code>`. Possible values include:
     "Enabled", "Disabled".
    :vartype state: str or ~container_apps_api_client.models.IdentityProviderState
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword state: :code:`<code>Disabled</code>` if the Google provider should not be enabled
         despite the set registration; otherwise, :code:`<code>Enabled</code>`. Possible values include:
         "Enabled", "Disabled".
        :paramtype state: str or ~container_apps_api_client.models.IdentityProviderState
...
class HttpScaleRule(msrest.serialization.Model):
    """Container App container Custom scaling rule.
...
class HttpSettings(msrest.serialization.Model):
    ...
    :ivar require_https: :code:`<code>false</code>` if the authentication/authorization responses
     not having the HTTPS scheme are permissible; otherwise, :code:`<code>true</code>`. Possible
     values include: "True", "False".
    :vartype require_https: str or ~container_apps_api_client.models.RequireHttpsMode
    :ivar route: The configuration settings of the paths HTTP requests.
    :vartype route: ~container_apps_api_client.models.HttpSettingsRoute
    """
    ...
    def __init__(
        self,
        *,
        require_https: Optional[Union[str, "RequireHttpsMode"]] = None,
        route: Optional["HttpSettingsRoute"] = None,
        **kwargs
    ):
        """
        ...
        :paramtype require_https: str or ~container_apps_api_client.models.RequireHttpsMode
        :keyword route: The configuration settings of the paths HTTP requests.
        :paramtype route: ~container_apps_api_client.models.HttpSettingsRoute
        """
...
class HttpSettingsRoute(msrest.serialization.Model):
...
class IdentityProviders(msrest.serialization.Model):
    ...
    :ivar legacy_microsoft_account: The configuration settings of the legacy Microsoft Account
     provider.
    :vartype legacy_microsoft_account: ~container_apps_api_client.models.LegacyMicrosoftAccount
    ...
    :ivar azure_static_web_app: The configuration settings of the Azure Static Web Apps provider.
    :vartype azure_static_web_app: ~container_apps_api_client.models.AzureStaticWebApp
    ...
    def __init__(
        ...
        *,
        ...
        azure_static_web_app: Optional["AzureStaticWebApp"] = None,
        ...
        **kwargs
        ...
        :keyword legacy_microsoft_account: The configuration settings of the legacy Microsoft Account
         provider.
        :paramtype legacy_microsoft_account: ~container_apps_api_client.models.LegacyMicrosoftAccount
        ...
        :keyword azure_static_web_app: The configuration settings of the Azure Static Web Apps
         provider.
        :paramtype azure_static_web_app: ~container_apps_api_client.models.AzureStaticWebApp
        ...
        self.apple = apple
        self.azure_static_web_app = azure_static_web_app
        self.custom_open_id_connect_providers = custom_open_id_connect_providers


class Ingress(msrest.serialization.Model):
...
class LegacyMicrosoftAccount(msrest.serialization.Model):
    ...
    :ivar state: :code:`<code>Disabled</code>` if the legacy Microsoft Account provider should not
     be enabled despite the set registration; otherwise, :code:`<code>Enabled</code>`. Possible
     values include: "Enabled", "Disabled".
    :vartype state: str or ~container_apps_api_client.models.IdentityProviderState
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword state: :code:`<code>Disabled</code>` if the legacy Microsoft Account provider should
         not be enabled despite the set registration; otherwise, :code:`<code>Enabled</code>`. Possible
         values include: "Enabled", "Disabled".
        :paramtype state: str or ~container_apps_api_client.models.IdentityProviderState
...
class Login(msrest.serialization.Model):
    ...
    :ivar route: The route that specify the endpoint used for login and logout requests.
    :vartype route: ~container_apps_api_client.models.LoginRoute
    :ivar preserve_url_fragments_for_logins: :code:`<code>True</code>` if the fragments from the
     ...
     Possible values include: "True", "False".
    :vartype preserve_url_fragments_for_logins: str or
     ~container_apps_api_client.models.PreserveUrlFragmentsForLoginsMode
    ...
    def __init__(
        ...
        *,
        ...
        preserve_url_fragments_for_logins: Optional[Union[str, "PreserveUrlFragmentsForLoginsMode"]] = None,
        allowed_external_redirect_urls: Optional[List[str]] = None,
        **kwargs
    ):
        """
        :keyword route: The route that specify the endpoint used for login and logout requests.
        :paramtype route: ~container_apps_api_client.models.LoginRoute
        :keyword preserve_url_fragments_for_logins: :code:`<code>True</code>` if the fragments from the
         request are preserved after the login request is made; otherwise, :code:`<code>False</code>`.
         Possible values include: "True", "False".
        :paramtype preserve_url_fragments_for_logins: str or
         ~container_apps_api_client.models.PreserveUrlFragmentsForLoginsMode
...
class LoginRoute(msrest.serialization.Model):
...
class ManagedEnvironmentStorageProperties(msrest.serialization.Model):
    """Storage properties.
...
class ManagedEnvironmentStoragesCollection(msrest.serialization.Model):
...
class OpenIdConnectClientCredential(msrest.serialization.Model):
    ...
    :ivar client_secret_ref_name: The app setting that contains the client secret for the custom
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword client_secret_ref_name: The app setting that contains the client secret for the custom
         Open ID Connect provider.
        :paramtype client_secret_ref_name: str
        """
...
class QueueScaleRule(msrest.serialization.Model):
...
class RegistryCredentials(msrest.serialization.Model):
...
class ReplicaCollection(msrest.serialization.Model):
...
class ReplicaContainer(msrest.serialization.Model):
...
class RevisionCollection(msrest.serialization.Model):
...
class Scale(msrest.serialization.Model):
...
class ScaleRuleAuth(msrest.serialization.Model):
...
class Twitter(msrest.serialization.Model):
    ...
    :ivar state: :code:`<code>Disabled</code>` if the Twitter provider should not be enabled
     despite the set registration; otherwise, :code:`<code>Enabled</code>`. Possible values include:
     "Enabled", "Disabled".
    :vartype state: str or ~container_apps_api_client.models.IdentityProviderState
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword state: :code:`<code>Disabled</code>` if the Twitter provider should not be enabled
         despite the set registration; otherwise, :code:`<code>Enabled</code>`. Possible values include:
         "Enabled", "Disabled".
        :paramtype state: str or ~container_apps_api_client.models.IdentityProviderState
...
class TwitterRegistration(msrest.serialization.Model):
    ...
    :ivar consumer_secret_ref_name: The app secret ref name that contains the OAuth 1.0a consumer
     secret of the Twitter
     application used for sign-in.
    :vartype consumer_secret_ref_name: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword consumer_secret_ref_name: The app secret ref name that contains the OAuth 1.0a
         consumer secret of the Twitter
         application used for sign-in.
        :paramtype consumer_secret_ref_name: str
        """
        super(TwitterRegistration, self).__init__(**kwargs)
        self.consumer_key = consumer_key
        self.consumer_secret_ref_name = consumer_secret_ref_name
