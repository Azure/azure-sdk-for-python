...
class CertificatesOperations:
    ...
    @distributed_trace
    def list(
        self, resource_group_name: str, managed_environment_name: str, **kwargs: Any
    ...
    async def get(
        self, resource_group_name: str, managed_environment_name: str, name: str, **kwargs: Any
    ) -> "_models.Certificate":
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, managed_environment_name: str, name: str, **kwargs: Any) -> None:
