...
def build_get_request(subscription_id: str, resource_group_name: str, name: str, **kwargs: Any) -> HttpRequest:
    api_version = "2022-01-01-preview"
    accept = "application/json"
    # Construct URL
    url = kwargs.pop(
...
def build_delete_request_initial(
    subscription_id: str, resource_group_name: str, name: str, **kwargs: Any
) -> HttpRequest:
    api_version = "2022-01-01-preview"
    accept = "application/json"
    # Construct URL
...
def build_list_secrets_request(subscription_id: str, resource_group_name: str, name: str, **kwargs: Any) -> HttpRequest:
    api_version = "2022-01-01-preview"
    accept = "application/json"
    # Construct URL
    url = kwargs.pop(
...
class ContainerAppsOperations(object):
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.ContainerAppCollection"]:
    ...
    def _create_or_update_initial(
        self, resource_group_name: str, name: str, container_app_envelope: "_models.ContainerApp", **kwargs: Any
    ...
    def begin_delete(self, resource_group_name: str, name: str, **kwargs: Any) -> LROPoller[None]:
        ...
        if cont_token is None:
            raw_result = self._delete_initial(
                resource_group_name=resource_group_name, name=name, cls=lambda x, y, z: x, **kwargs
            )
        kwargs.pop("error_map", None)
    ...
    @distributed_trace
    def update(
        self, resource_group_name: str, name: str, container_app_envelope: "_models.ContainerAppPatch", **kwargs: Any
    ) -> "_models.ContainerApp":
    ...
    @distributed_trace
    def list_secrets(self, resource_group_name: str, name: str, **kwargs: Any) -> "_models.SecretsCollection":
