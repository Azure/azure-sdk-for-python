...
def build_list_by_container_app_request(
    subscription_id: str, resource_group_name: str, container_app_name: str, **kwargs: Any
) -> HttpRequest:
...
def build_get_request(
    subscription_id: str, resource_group_name: str, container_app_name: str, name: str, **kwargs: Any
) -> HttpRequest:
    api_version = "2022-01-01-preview"
    accept = "application/json"
    # Construct URL
...
class ContainerAppsAuthConfigsOperations(object):
    ...
    @distributed_trace
    def get(self, resource_group_name: str, container_app_name: str, name: str, **kwargs: Any) -> "_models.AuthConfig":
    ...
    @distributed_trace
    def delete(self, resource_group_name: str, container_app_name: str, name: str, **kwargs: Any) -> None:
