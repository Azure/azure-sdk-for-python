...
class MgmtStorageTest(AzureMgmtTestCase):
    ...
    def test_storage(self, resource_group):
        ...
        STORAGE_ACCOUNT_NAME = "storageaccountxxyyzzcccd"  # TODO: need change a random name, if need run live test again.
        DEST_STORAGE_ACCOUNT_NAME = "storageaccountxxyyzznncccd"
