...
class TestStorageManagementStorageAccountsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_storage_accounts_update(self, resource_group):
        response = self.client.storage_accounts.update(
            resource_group_name=resource_group.name,
            account_name="str",
            parameters={
                "accessTier": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_storage_accounts_list_account_sas(self, resource_group):
        response = self.client.storage_accounts.list_account_sas(
            resource_group_name=resource_group.name,
            account_name="str",
            parameters={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_storage_accounts_list_service_sas(self, resource_group):
        response = self.client.storage_accounts.list_service_sas(
            resource_group_name=resource_group.name,
            account_name="str",
            parameters={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_storage_accounts_begin_restore_blob_ranges(self, resource_group):
        response = self.client.storage_accounts.begin_restore_blob_ranges(
            resource_group_name=resource_group.name,
            account_name="str",
            parameters={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_storage_accounts_revoke_user_delegation_keys(self, resource_group):
