...
class FileSharesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2021_01_01.models.FileShareItems]
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :param expand: Optional, used to create a snapshot. Default value is None.
