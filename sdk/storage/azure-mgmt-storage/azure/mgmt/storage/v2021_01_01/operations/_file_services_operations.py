...
def build_set_service_properties_request(
    ...
    account_name: str,
    file_services_name: Union[str, _models.Enum30],
    subscription_id: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class FileServicesOperations:
    ...
    def set_service_properties(
        ...
        **kwargs: Any
        ...
        :type file_services_name: str or ~azure.mgmt.storage.v2021_01_01.models.Enum30
    ...
    def set_service_properties(
        ...
        **kwargs: Any
        ...
        :param parameters: The properties of file services in storage accounts, including CORS
         ...
         type. Required.
        :type parameters: ~azure.mgmt.storage.v2021_01_01.models.FileServiceProperties or IO[bytes]
        :return: FileServiceProperties or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_01_01.models.FileServiceProperties
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_service_properties(
        self, resource_group_name: str, account_name: str, file_services_name: Union[str, _models.Enum30], **kwargs: Any
    ) -> _models.FileServiceProperties:
