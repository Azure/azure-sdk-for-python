...
def build_get_management_policies_request(
    resource_group_name: str,
    account_name: str,
    subscription_id: str,
...
def build_create_or_update_management_policies_request(
    ...
    management_policy_name: Union[str, "_models.ManagementPolicyName"],
    *,
    json: Optional[_models.ManagementPoliciesRulesSetParameter] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_delete_management_policies_request(
    resource_group_name: str,
    account_name: str,
    subscription_id: str,
    management_policy_name: Union[str, "_models.ManagementPolicyName"],
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either StorageAccount or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.storage.v2018_03_01_preview.models.StorageAccount]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either StorageAccountListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2018_03_01_preview.models.StorageAccountListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
