...
class StorageAccountsOperations(object):
    ...
    def get_management_policies(self, resource_group_name, account_name, cls=None, **kwargs):
        ...
        :param callable cls: A custom type or function that will be passed the
         direct response
        :return: StorageAccountManagementPolicies or the result of
         cls(response)
        :rtype:
    ...
    def create_or_update_management_policies(self, resource_group_name, account_name, policy=None, cls=None, **kwargs):
    ...
    def delete_management_policies(self, resource_group_name, account_name, cls=None, **kwargs):
