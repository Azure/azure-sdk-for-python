...
class StorageAccountsOperations(object):
    ...
    def check_name_availability(
        ...
        **kwargs  # type: Any
        ...
        :param account_name: The name of the storage account within the specified resource group.
         ...
         case letters only.
        :type account_name: ~azure.mgmt.storage.v2018_03_01_preview.models.StorageAccountCheckNameAvailabilityParameters
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.storage.v2018_03_01_preview.models.StorageAccount]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def regenerate_key(
        ...
        **kwargs  # type: Any
        ...
        :type regenerate_key: ~azure.mgmt.storage.v2018_03_01_preview.models.StorageAccountRegenerateKeyParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: StorageAccountListKeysResult, or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2018_03_01_preview.models.StorageAccountListKeysResult
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_account_sas(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2018_03_01_preview.models.AccountSasParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_service_sas(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2018_03_01_preview.models.ServiceSasParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_management_policies(
        ...
        **kwargs  # type: Any
        ...
        :param management_policy_name: The name of the Storage Account Management Policy. It should
         always be 'default'.
        :type management_policy_name: str or ~azure.mgmt.storage.v2018_03_01_preview.models.ManagementPolicyName
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        # Construct URL
        url = self.get_management_policies.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'accountName': self._serialize.url("account_name", account_name, 'str', max_length=24, min_length=3),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
        ...
        return deserialized
    get_management_policies.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/managementPolicies/{managementPolicyName}'}  # type: ignore
    ...
    def create_or_update_management_policies(
        ...
        **kwargs  # type: Any
        ...
        :type properties: ~azure.mgmt.storage.v2018_03_01_preview.models.ManagementPoliciesRulesSetParameter
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: StorageAccountManagementPolicies, or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2018_03_01_preview.models.StorageAccountManagementPolicies
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        # Construct URL
        url = self.create_or_update_management_policies.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'accountName': self._serialize.url("account_name", account_name, 'str', max_length=24, min_length=3),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
        ...
        return deserialized
    create_or_update_management_policies.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/managementPolicies/{managementPolicyName}'}  # type: ignore
    ...
    def delete_management_policies(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.delete_management_policies.metadata['url']  # type: ignore
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'accountName': self._serialize.url("account_name", account_name, 'str', max_length=24, min_length=3),
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
    ...
    delete_management_policies.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/managementPolicies/{managementPolicyName}'}  # type: ignore
