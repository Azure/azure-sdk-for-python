...
class StorageAccountsOperations:
    ...
    update request is issued with the exact same set of properties, the request will succeed.
     ...
     case letters only.
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.storage.v2018_03_01_preview.models.StorageAccount]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    returned; use the ListKeys operation for this.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2018_03_01_preview.models.StorageAccountListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def delete_management_policies(
        self,
        resource_group_name: str,
        account_name: str,
        **kwargs
