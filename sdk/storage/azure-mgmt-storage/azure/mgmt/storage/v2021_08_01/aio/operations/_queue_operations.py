...
class QueueOperations:
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type queue: ~azure.mgmt.storage.v2021_08_01.models.StorageQueue or IO
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2021_08_01.models.ListQueue]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
