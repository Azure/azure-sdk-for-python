...
class LocalUsersOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> Iterable["_models.LocalUser"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2021_08_01.models.LocalUser]
    ...
    def create_or_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.storage.v2021_08_01.models.LocalUser or IO[bytes]
        :return: LocalUser or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_08_01.models.LocalUser
        :raises ~azure.core.exceptions.HttpResponseError:
        """
