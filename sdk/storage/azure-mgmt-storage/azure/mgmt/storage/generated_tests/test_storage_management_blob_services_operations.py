...
class TestStorageManagementBlobServicesOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(StorageManagementClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_blob_services_list(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_blob_services_set_service_properties(self, resource_group):
        response = self.client.blob_services.set_service_properties(
            resource_group_name=resource_group.name,
            account_name="str",
            parameters={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_blob_services_get_service_properties(self, resource_group):
