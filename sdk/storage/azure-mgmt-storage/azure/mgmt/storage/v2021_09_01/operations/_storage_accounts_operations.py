...
def build_hierarchical_namespace_migration_request_initial(
    resource_group_name: str,
    account_name: str,
    subscription_id: str,
    *,
    ...
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/hnsonmigration")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        "accountName": _SERIALIZER.url("account_name", account_name, 'str', max_length=24, min_length=3),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
    ...
    _query_parameters = kwargs.pop("params", {})  # type: Dict[str, Any]
    _query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
    _query_parameters['requestType'] = _SERIALIZER.query("request_type", request_type, 'str')
...
def build_abort_hierarchical_namespace_migration_request_initial(
    resource_group_name: str,
    account_name: str,
    subscription_id: str,
    **kwargs: Any
    ...
    accept = "application/json"
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/aborthnsonmigration")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        "accountName": _SERIALIZER.url("account_name", account_name, 'str', max_length=24, min_length=3),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
...
class StorageAccountsOperations(object):  # pylint: disable=too-many-public-methods
    ...
    def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type account_name:
         ~azure.mgmt.storage.v2021_09_01.models.StorageAccountCheckNameAvailabilityParameters
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_09_01.models.StorageAccountCreateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either StorageAccount or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.storage.v2021_09_01.models.StorageAccount]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-09-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_09_01.models.StorageAccountUpdateParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: StorageAccount, or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_09_01.models.StorageAccount
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either StorageAccountListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2021_09_01.models.StorageAccountListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-09-01")  # type: str
    ...
    def regenerate_key(
        ...
        **kwargs: Any
        ...
        :param regenerate_key: Specifies name of the key which should be regenerated -- key1, key2,
         kerb1, kerb2.
        :type regenerate_key:
         ~azure.mgmt.storage.v2021_09_01.models.StorageAccountRegenerateKeyParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: StorageAccountListKeysResult, or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_09_01.models.StorageAccountListKeysResult
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list_account_sas(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_09_01.models.AccountSasParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_service_sas(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_09_01.models.ServiceSasParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def _hierarchical_namespace_migration_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_hierarchical_namespace_migration_request_initial(
            resource_group_name=resource_group_name,
            account_name=account_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    @distributed_trace
    def begin_hierarchical_namespace_migration(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        request_type: str,
    ...
    def _abort_hierarchical_namespace_migration_initial(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_abort_hierarchical_namespace_migration_request_initial(
            resource_group_name=resource_group_name,
            account_name=account_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    @distributed_trace
    def begin_abort_hierarchical_namespace_migration(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        account_name: str,
        **kwargs: Any
    ...
    def begin_restore_blob_ranges(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_09_01.models.BlobRestoreParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be ARMPolling. Pass in False for this
         operation to not poll, or pass in your own initialized polling object for a personal polling
        ...
        :return: An instance of LROPoller that returns either BlobRestoreStatus or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.storage.v2021_09_01.models.BlobRestoreStatus]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        api_version = kwargs.pop('api_version', "2021-09-01")  # type: str
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
