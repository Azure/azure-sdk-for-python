...
class ActiveDirectoryPropertiesAccountType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class AllowedCopyScope(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class DnsEndpointType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class SkuConversionStatus(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
