...
class FileSharesOperations:
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type file_share: ~azure.mgmt.storage.v2021_09_01.models.FileShare or IO[bytes]
        :param expand: Optional, used to expand the properties within share's properties. Valid values
         are: snapshots. Should be passed as a string with delimiter ','. Default value is None.
        :type expand: str
        :return: FileShare or the result of cls(response)
    ...
    async def restore(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type deleted_share: ~azure.mgmt.storage.v2021_09_01.models.DeletedShare or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def lease(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_09_01.models.LeaseShareRequest or IO[bytes]
        :return: LeaseShareResponse or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_09_01.models.LeaseShareResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
