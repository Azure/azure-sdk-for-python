...
class FileSharesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2021_09_01.models.FileShareItem]
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type file_share: ~azure.mgmt.storage.v2021_09_01.models.FileShare
        :param expand: Optional, used to expand the properties within share's properties. Valid values
        ...
        :rtype: ~azure.mgmt.storage.v2021_09_01.models.FileShare
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :param file_share: Properties of the file share to create. Is either a model type or a IO type.
         Required.
        :type file_share: ~azure.mgmt.storage.v2021_09_01.models.FileShare or IO
        :param expand: Optional, used to expand the properties within share's properties. Valid values
         are: snapshots. Should be passed as a string with delimiter ','. Default value is None.
        :type expand: str
    ...
    async def restore(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type deleted_share: ~azure.mgmt.storage.v2021_09_01.models.DeletedShare
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def restore(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type deleted_share: ~azure.mgmt.storage.v2021_09_01.models.DeletedShare or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def lease(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_09_01.models.LeaseShareRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def lease(
        ...
        **kwargs: Any
        ...
        :param x_ms_snapshot: Optional. Specify the snapshot time to lease a snapshot. Default value is
         None.
        :type x_ms_snapshot: str
        :param parameters: Lease Share request body. Is either a model type or a IO type. Default value
         is None.
        :type parameters: ~azure.mgmt.storage.v2021_09_01.models.LeaseShareRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
