...
class EncryptionScopesOperations:
    ...
    async def put(
        ...
        **kwargs: Any
        ...
        :type encryption_scope: ~azure.mgmt.storage.v2021_09_01.models.EncryptionScope or IO[bytes]
        :return: EncryptionScope or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_09_01.models.EncryptionScope
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2021_09_01.models.EncryptionScope]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
