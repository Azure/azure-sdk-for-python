...
class ObjectReplicationPoliciesOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either ObjectReplicationPolicy or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2021_09_01.models.ObjectReplicationPolicy]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.storage.v2021_09_01.models.ObjectReplicationPolicy
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.storage.v2021_09_01.models.ObjectReplicationPolicy
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param properties: The object replication policy set to a storage account. A unique policy ID
         ...
         Required.
        :type properties: ~azure.mgmt.storage.v2021_09_01.models.ObjectReplicationPolicy or IO[bytes]
        :return: ObjectReplicationPolicy or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_09_01.models.ObjectReplicationPolicy
        :raises ~azure.core.exceptions.HttpResponseError:
        """
