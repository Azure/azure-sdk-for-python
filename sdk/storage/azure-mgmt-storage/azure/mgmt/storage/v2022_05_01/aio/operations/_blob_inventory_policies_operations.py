...
class BlobInventoryPoliciesOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.storage.v2022_05_01.models.BlobInventoryPolicy
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: BlobInventoryPolicy, or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2022_05_01.models.BlobInventoryPolicy
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ListBlobInventoryPolicy or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2022_05_01.models.ListBlobInventoryPolicy]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
