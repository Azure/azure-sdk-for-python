...
class TableOperations:
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2022_05_01.models.Table or IO
    ...
    def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> AsyncIterable["_models.Table"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2022_05_01.models.Table]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
