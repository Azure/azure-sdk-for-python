...
def build_lease_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.LeaseShareRequest] = None,
    content: Any = None,
    x_ms_snapshot: Optional[str] = None,
    **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/fileServices/default/shares/{shareName}/lease")  # pylint: disable=line-too-long
    path_format_arguments = {
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
        "accountName": _SERIALIZER.url("account_name", account_name, 'str', max_length=24, min_length=3),
        "shareName": _SERIALIZER.url("share_name", share_name, 'str', max_length=63, min_length=3),
...
class FileSharesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2022_05_01.models.FileShareItems]
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :type file_share: ~azure.mgmt.storage.v2022_05_01.models.FileShare
        :param expand: Optional, used to expand the properties within share's properties. Valid values
        ...
        :rtype: ~azure.mgmt.storage.v2022_05_01.models.FileShare
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
    ...
    def restore(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type share_name: str
        :param deleted_share:
        :type deleted_share: ~azure.mgmt.storage.v2022_05_01.models.DeletedShare
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def lease(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2022_05_01.models.LeaseShareRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: LeaseShareResponse, or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2022_05_01.models.LeaseShareResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
