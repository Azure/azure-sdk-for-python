...
class StorageManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype storage_accounts:
     azure.mgmt.storage.v2018_02_01.aio.operations.StorageAccountsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.operations = Operations(self._client, self._config, self._serialize, self._deserialize, "2018-02-01")
        self.skus = SkusOperations(self._client, self._config, self._serialize, self._deserialize, "2018-02-01")
        self.storage_accounts = StorageAccountsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2018-02-01"
        )
        self.usage = UsageOperations(self._client, self._config, self._serialize, self._deserialize, "2018-02-01")
