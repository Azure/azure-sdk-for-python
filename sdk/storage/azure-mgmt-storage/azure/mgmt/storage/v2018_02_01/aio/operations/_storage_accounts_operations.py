...
class StorageAccountsOperations:
    ...
    async def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type account_name:
         ~azure.mgmt.storage.v2018_02_01.models.StorageAccountCheckNameAvailabilityParameters
    ...
    async def check_name_availability(
        ...
        :type account_name:
         ~azure.mgmt.storage.v2018_02_01.models.StorageAccountCheckNameAvailabilityParameters or
         IO[bytes]
        :return: CheckNameAvailabilityResult or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2018_02_01.models.CheckNameAvailabilityResult
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either StorageAccount or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.storage.v2018_02_01.models.StorageAccount]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2018_02_01.models.StorageAccountCreateParameters or
         IO[bytes]
        :return: An instance of AsyncLROPoller that returns either StorageAccount or the result of
         cls(response)
        :rtype:
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2018_02_01.models.StorageAccountUpdateParameters or
         IO[bytes]
        :return: StorageAccount or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2018_02_01.models.StorageAccount
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.StorageAccount"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2018_02_01.models.StorageAccount]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def regenerate_key(
        ...
        **kwargs: Any
        ...
        :param regenerate_key: Specifies name of the key which should be regenerated -- key1 or key2.
         Required.
        :type regenerate_key:
         ~azure.mgmt.storage.v2018_02_01.models.StorageAccountRegenerateKeyParameters
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: StorageAccountListKeysResult or the result of cls(response)
    ...
    async def regenerate_key(
        ...
        **kwargs: Any
        ...
        :type regenerate_key:
         ~azure.mgmt.storage.v2018_02_01.models.StorageAccountRegenerateKeyParameters or IO[bytes]
        :return: StorageAccountListKeysResult or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2018_02_01.models.StorageAccountListKeysResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def list_account_sas(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2018_02_01.models.AccountSasParameters or IO[bytes]
        :return: ListAccountSasResponse or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2018_02_01.models.ListAccountSasResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def list_service_sas(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2018_02_01.models.ServiceSasParameters or IO[bytes]
        :return: ListServiceSasResponse or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2018_02_01.models.ListServiceSasResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
