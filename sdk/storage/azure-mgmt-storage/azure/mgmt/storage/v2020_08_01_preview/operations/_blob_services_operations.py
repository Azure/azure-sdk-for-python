...
class BlobServicesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.storage.v2020_08_01_preview.models.BlobServicePropertiesPaged[~azure.mgmt.storage.v2020_08_01_preview.models.BlobServiceProperties]
    ...
    def set_service_properties(
        ...
        :type parameters:
         ~azure.mgmt.storage.v2020_08_01_preview.models.BlobServiceProperties
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
