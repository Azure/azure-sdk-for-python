...
class BlobInventoryPoliciesOperations(object):
    ...
    def get(
        ...
        blob_inventory_policy_name,  # type: Union[str, "_models.BlobInventoryPolicyName"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.BlobInventoryPolicy"
        ...
        :type blob_inventory_policy_name: str or ~azure.mgmt.storage.v2020_08_01_preview.models.BlobInventoryPolicyName
    ...
    def create_or_update(
        ...
        account_name,  # type: str
        blob_inventory_policy_name,  # type: Union[str, "_models.BlobInventoryPolicyName"]
        properties,  # type: "_models.BlobInventoryPolicy"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.BlobInventoryPolicy"
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ListBlobInventoryPolicy"]
        """Gets the blob inventory policy associated with the specified storage account.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2020_08_01_preview.models.ListBlobInventoryPolicy]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
