...
class BlobInventoryPoliciesOperations(object):
    ...
    def get(
        ...
        blob_inventory_policy_name,  # type: Union[str, "models.BlobInventoryPolicyName"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.BlobInventoryPolicy"
    ...
    def create_or_update(
        ...
        account_name,  # type: str
        blob_inventory_policy_name,  # type: Union[str, "models.BlobInventoryPolicyName"]
        properties,  # type: "models.BlobInventoryPolicy"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.BlobInventoryPolicy"
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.ListBlobInventoryPolicy"]
        """Gets the blob inventory policy associated with the specified storage account.
