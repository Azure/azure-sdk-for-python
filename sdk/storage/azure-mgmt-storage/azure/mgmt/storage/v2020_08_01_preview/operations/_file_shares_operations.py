...
def build_get_request(
    ...
    **kwargs: Any
    ...
    if x_ms_snapshot is not None:
        _header_parameters['x-ms-snapshot'] = _SERIALIZER.header("x_ms_snapshot", x_ms_snapshot, 'str')
    _header_parameters['Accept'] = _SERIALIZER.header("accept", accept, 'str')
...
class FileSharesOperations(object):
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :type filter: str
        :param expand: Optional, used to expand the properties within share's properties. Default value
         is None.
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2020_08_01_preview.models.FileShareItems]
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :param expand: Optional, used to create a snapshot. Possible values are "snapshots" or None.
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :param share_name: The name of the file share within the specified storage account. File share
         ...
         or number.
        :type share_name: str
        :param expand: Optional, used to expand the properties within share's properties. Possible
         values are "stats" or None. Default value is "stats".
        :type expand: str
