...
class FileSharesOperations(object):
    ...
    def list(
            self, resource_group_name, account_name, maxpagesize=None, filter=None, expand=None, custom_headers=None, raw=False, **operation_config):
        """Lists all shares.
        ...
        :type filter: str
        :param expand: Optional, used to expand the properties within share's
         properties. Possible values include: 'deleted', 'snapshots'
        :type expand: str or
         ~azure.mgmt.storage.v2020_08_01_preview.models.ListSharesExpand
        ...
        :rtype:
         ~azure.mgmt.storage.v2020_08_01_preview.models.FileShareItemPaged[~azure.mgmt.storage.v2020_08_01_preview.models.FileShareItem]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                if expand is not None:
                    query_parameters['$expand'] = self._serialize.query("expand", expand, 'ListSharesExpand')
    ...
    def create(
            self, resource_group_name, account_name, share_name, file_share, expand=None, custom_headers=None, raw=False, **operation_config):
        ...
        :type file_share:
         ~azure.mgmt.storage.v2020_08_01_preview.models.FileShare
        :param expand: Optional, used to create a snapshot. Possible values
         include: 'snapshots'
        :type expand: str or
         ~azure.mgmt.storage.v2020_08_01_preview.models.PutSharesExpand
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~azure.mgmt.storage.v2020_08_01_preview.models.FileShare or
        ...
        query_parameters = {}
        if expand is not None:
            query_parameters['$expand'] = self._serialize.query("expand", expand, 'PutSharesExpand')
        query_parameters['api-version'] = self._serialize.query("self.api_version", self.api_version, 'str', min_length=1)
    ...
    def get(
            self, resource_group_name, account_name, share_name, expand=None, x_ms_snapshot=None, custom_headers=None, raw=False, **operation_config):
        ...
        :type share_name: str
        :param expand: Optional, used to expand the properties within share's
         properties. Possible values include: 'stats'
        :type expand: str or
         ~azure.mgmt.storage.v2020_08_01_preview.models.GetShareExpand
        :param x_ms_snapshot: Optional, used to retrieve properties of a
         snapshot.
        ...
        query_parameters['api-version'] = self._serialize.query("self.api_version", self.api_version, 'str', min_length=1)
        if expand is not None:
            query_parameters['$expand'] = self._serialize.query("expand", expand, 'GetShareExpand')
    ...
    def delete(
            self, resource_group_name, account_name, share_name, x_ms_snapshot=None, custom_headers=None, raw=False, **operation_config):
    ...
    def restore(
            self, resource_group_name, account_name, share_name, deleted_share_name, deleted_share_version, custom_headers=None, raw=False, **operation_config):
        """Restore a file share within a valid retention days if share soft delete
        is enabled.
        ...
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        deleted_share = models.DeletedShare(deleted_share_name=deleted_share_name, deleted_share_version=deleted_share_version)
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    restore.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/fileServices/default/shares/{shareName}/restore'}
