...
class BlobInventoryPolicyDefinition(_serialization.Model):
    ...
    :ivar filters: An object that defines the filter set. Required.
    ...
    def __init__(self, *, filters: "_models.BlobInventoryPolicyFilter", **kwargs: Any) -> None:
        """
        :keyword filters: An object that defines the filter set. Required.
...
class BlobInventoryPolicyFilter(_serialization.Model):
    ...
    :ivar blob_types: An array of predefined enum values. Valid values include blockBlob,
     appendBlob, pageBlob. Hns accounts does not support pageBlobs. Required.
...
class BlobInventoryPolicyRule(_serialization.Model):
    ...
    def __init__(
        self, *, enabled: bool, name: str, definition: "_models.BlobInventoryPolicyDefinition", **kwargs: Any
    ) -> None:
        """
...
class SmbSetting(_serialization.Model):
    ...
    def __init__(self, *, multichannel: Optional["_models.Multichannel"] = None, **kwargs: Any) -> None:
        """
