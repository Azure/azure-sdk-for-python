...
class StorageAccountsOperations:
    ...
    update request is issued with the exact same set of properties, the request will succeed.
     ...
     case letters only.
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.storage.v2020_08_01_preview.models.StorageAccount]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    returned; use the ListKeys operation for this.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2020_08_01_preview.models.StorageAccountListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_restore_blob_ranges(
        ...
        parameters: "models.BlobRestoreParameters",
        **kwargs
    ) -> AsyncLROPoller["models.BlobRestoreStatus"]:
     ...
     case letters only.
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.storage.v2020_08_01_preview.models.BlobRestoreStatus]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.BlobRestoreStatus"]
