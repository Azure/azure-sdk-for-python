...
class ObjectReplicationPoliciesOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either ObjectReplicationPolicy or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2020_08_01_preview.models.ObjectReplicationPolicy]
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.storage.v2020_08_01_preview.models.ObjectReplicationPolicy or IO
