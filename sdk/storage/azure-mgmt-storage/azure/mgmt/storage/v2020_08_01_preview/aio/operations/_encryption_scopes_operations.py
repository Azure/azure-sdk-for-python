...
class EncryptionScopesOperations:
    ...
    async def put(
        ...
        **kwargs: Any
        ...
        :type encryption_scope: ~azure.mgmt.storage.v2020_08_01_preview.models.EncryptionScope or IO
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2020_08_01_preview.models.EncryptionScope]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
