...
class FileSharesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2023_01_01.models.FileShareItem]
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :type file_share: ~azure.mgmt.storage.v2023_01_01.models.FileShare
        :param expand: Optional, used to expand the properties within share's properties. Valid values
        ...
        :rtype: ~azure.mgmt.storage.v2023_01_01.models.FileShare
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :type file_share: ~azure.mgmt.storage.v2023_01_01.models.FileShare or IO[bytes]
        :param expand: Optional, used to expand the properties within share's properties. Valid values
         are: snapshots. Should be passed as a string with delimiter ','. Default value is None.
        :type expand: str
        :return: FileShare or the result of cls(response)
    ...
    def restore(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type deleted_share: ~azure.mgmt.storage.v2023_01_01.models.DeletedShare
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None or the result of cls(response)
    ...
    def restore(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type deleted_share: ~azure.mgmt.storage.v2023_01_01.models.DeletedShare or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def lease(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2023_01_01.models.LeaseShareRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: LeaseShareResponse or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2023_01_01.models.LeaseShareResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def lease(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2023_01_01.models.LeaseShareRequest or IO[bytes]
        :return: LeaseShareResponse or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2023_01_01.models.LeaseShareResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
