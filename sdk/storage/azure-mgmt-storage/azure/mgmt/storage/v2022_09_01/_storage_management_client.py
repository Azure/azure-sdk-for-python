...
class StorageManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype operations: azure.mgmt.storage.v2022_09_01.operations.Operations
    :ivar skus: SkusOperations operations
    :vartype skus: azure.mgmt.storage.v2022_09_01.operations.SkusOperations
    :ivar storage_accounts: StorageAccountsOperations operations
    :vartype storage_accounts: azure.mgmt.storage.v2022_09_01.operations.StorageAccountsOperations
    :ivar deleted_accounts: DeletedAccountsOperations operations
    :vartype deleted_accounts: azure.mgmt.storage.v2022_09_01.operations.DeletedAccountsOperations
    :ivar usages: UsagesOperations operations
    :vartype usages: azure.mgmt.storage.v2022_09_01.operations.UsagesOperations
    :ivar management_policies: ManagementPoliciesOperations operations
    :vartype management_policies:
     azure.mgmt.storage.v2022_09_01.operations.ManagementPoliciesOperations
    :ivar blob_inventory_policies: BlobInventoryPoliciesOperations operations
    :vartype blob_inventory_policies:
     azure.mgmt.storage.v2022_09_01.operations.BlobInventoryPoliciesOperations
    ...
    :vartype object_replication_policies:
     azure.mgmt.storage.v2022_09_01.operations.ObjectReplicationPoliciesOperations
    :ivar local_users: LocalUsersOperations operations
    :vartype local_users: azure.mgmt.storage.v2022_09_01.operations.LocalUsersOperations
    :ivar encryption_scopes: EncryptionScopesOperations operations
    :vartype encryption_scopes:
     azure.mgmt.storage.v2022_09_01.operations.EncryptionScopesOperations
    :ivar blob_services: BlobServicesOperations operations
    :vartype blob_services: azure.mgmt.storage.v2022_09_01.operations.BlobServicesOperations
    :ivar blob_containers: BlobContainersOperations operations
    :vartype blob_containers: azure.mgmt.storage.v2022_09_01.operations.BlobContainersOperations
    :ivar file_services: FileServicesOperations operations
    :vartype file_services: azure.mgmt.storage.v2022_09_01.operations.FileServicesOperations
    ...
    :vartype queue_services: azure.mgmt.storage.v2022_09_01.operations.QueueServicesOperations
    ...
    :vartype table: azure.mgmt.storage.v2022_09_01.operations.TableOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.skus = SkusOperations(self._client, self._config, self._serialize, self._deserialize, "2022-09-01")
        ...
        self.usages = UsagesOperations(self._client, self._config, self._serialize, self._deserialize, "2022-09-01")
        ...
        self.queue = QueueOperations(self._client, self._config, self._serialize, self._deserialize, "2022-09-01")
