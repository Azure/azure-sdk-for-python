...
def build_set_service_properties_request(
    ...
    api_version = kwargs.pop("api_version", _params.pop("api-version", "2022-09-01"))  # type: Literal["2022-09-01"]
    blob_services_name = kwargs.pop("blob_services_name", "default")  # type: Literal["default"]
...
class BlobServicesOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either BlobServiceProperties or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2022_09_01.models.BlobServiceProperties]
    ...
    def set_service_properties(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2022_09_01.models.BlobServiceProperties
        ...
        :rtype: ~azure.mgmt.storage.v2022_09_01.models.BlobServiceProperties
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def set_service_properties(
        ...
        **kwargs: Any
        ...
        :param parameters: The properties of a storage account’s Blob service, including properties for
         ...
         IO type. Required.
        :type parameters: ~azure.mgmt.storage.v2022_09_01.models.BlobServiceProperties or IO
        :keyword blob_services_name: The name of the blob Service within the specified storage account.
         Blob Service Name must be 'default'. Default value is "default". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype blob_services_name: str
