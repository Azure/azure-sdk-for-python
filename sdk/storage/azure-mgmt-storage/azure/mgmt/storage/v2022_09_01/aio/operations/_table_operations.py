...
class TableOperations:
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2022_09_01.models.Table
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Table or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2022_09_01.models.Table
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :param table_name: A table name must be unique within a storage account and must be between 3
         ...
         with a numeric character. Required.
        :type table_name: str
        :param parameters: The parameters to provide to create a table. Is either a model type or a IO
         type. Default value is None.
        :type parameters: ~azure.mgmt.storage.v2022_09_01.models.Table or IO
    ...
    def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> AsyncIterable["_models.Table"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2022_09_01.models.Table]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
