...
class LocalUsersOperations:
    ...
    def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> AsyncIterable["_models.LocalUser"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2022_09_01.models.LocalUser]
    ...
    async def get(self, resource_group_name: str, account_name: str, username: str, **kwargs: Any) -> _models.LocalUser:
        ...
        :rtype: ~azure.mgmt.storage.v2022_09_01.models.LocalUser
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.storage.v2022_09_01.models.LocalUser
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.storage.v2022_09_01.models.LocalUser or IO[bytes]
        :return: LocalUser or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2022_09_01.models.LocalUser
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def list_keys(
        ...
        :rtype: ~azure.mgmt.storage.v2022_09_01.models.LocalUserKeys
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
    ...
    async def regenerate_password(
        ...
        :rtype: ~azure.mgmt.storage.v2022_09_01.models.LocalUserRegeneratePasswordResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
