...
class AccountImmutabilityPolicyProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class AccountSasParameters(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class AccountUsage(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ActiveDirectoryProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class AdvancedPlatformMetricsRule(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :vartype properties: ~azure.mgmt.storage.models.AdvancedPlatformMetricsRuleProperties
    """

    properties: Optional["_models.AdvancedPlatformMetricsRuleProperties"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        properties: Optional["_models.AdvancedPlatformMetricsRuleProperties"] = None,
    ) -> None: ...
...
class AdvancedPlatformMetricsRuleConfig(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """Configuration for the advanced platform metrics rule.

    :ivar filter_type: The type of filter applied to the rule. Possible values include:
    ...
    :vartype filter_type: str or ~azure.mgmt.storage.models.AdvancedPlatformMetricsFilterType
    :ivar filter_values: The values for the filter applied to the rule. If filter type is
    ...
    filter_type: Optional[Union[str, "_models.AdvancedPlatformMetricsFilterType"]] = rest_field(
    ...
    filter_values: Optional[list[str]] = rest_field(
        name="filterValues", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        filter_type: Optional[Union[str, "_models.AdvancedPlatformMetricsFilterType"]] = None,
...
class AdvancedPlatformMetricsRuleProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """An object that defines the advanced platform metrics rule.

    :ivar rule_type: Indicates the type of the advanced platform metrics rule. Possible values
     include: ContainerLevelCapacityMetrics. "ContainerLevelCapacityMetrics"
    :vartype rule_type: str or ~azure.mgmt.storage.models.AdvancedPlatformMetricsRuleType
    ...
    :vartype metrics_emitted: list[str or ~azure.mgmt.storage.models.MetricsEmitted]
    :ivar rule_config: Configuration for the advanced platform metrics rule. Required.
    :vartype rule_config: ~azure.mgmt.storage.models.AdvancedPlatformMetricsRuleConfig
    """

    rule_type: Optional[Union[str, "_models.AdvancedPlatformMetricsRuleType"]] = rest_field(
        name="ruleType", visibility=["read"]
    )
    ...
    """The metrics emitted by the rule. Metrics are mapped according to the rule type from
     ...
     {ContainerUsedSize, ContainerBlobCount}."""
    rule_config: "_models.AdvancedPlatformMetricsRuleConfig" = rest_field(
        name="ruleConfig", visibility=["read", "create", "update", "delete", "query"]
    )
...
class AzureFilesIdentityBasedAuthentication(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class BlobInventoryCreationTime(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class BlobInventoryPolicy(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class BlobInventoryPolicyDefinition(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class BlobInventoryPolicyFilter(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class BlobInventoryPolicyProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class BlobInventoryPolicyRule(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class BlobInventoryPolicySchema(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class BlobRestoreParameters(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class BlobRestoreRange(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """Blob range.
...
class BlobServiceProperties(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class BlobServicePropertiesProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The properties of a storage account’s Blob service.
...
class ChangeFeed(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The blob service properties for change feed events.
...
class TrackedResourceUpdate(ResourceAutoGenerated):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ConnectorUpdate(TrackedResourceUpdate):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """A Connector is a tracked ARM resource modeled as a sub-resource of a Storage Account.
    ...
    :vartype properties: ~azure.mgmt.storage.models.StorageConnectorPropertiesUpdate
    """

    properties: Optional["_models.StorageConnectorPropertiesUpdate"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        tags: Optional[dict[str, str]] = None,
        properties: Optional["_models.StorageConnectorPropertiesUpdate"] = None,
    ) -> None: ...
...
class ContextCache(TrackedResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ContextCacheContainer(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :vartype system_data: ~azure.mgmt.storage.models.SystemData
    :ivar properties: The resource-specific properties for this resource. Required.
    :vartype properties: ~azure.mgmt.storage.models.ContextCacheContainerProperties
    """

    properties: "_models.ContextCacheContainerProperties" = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """The resource-specific properties for this resource. Required."""
    ...
    def __init__(
        self,
        *,
        properties: "_models.ContextCacheContainerProperties",
    ) -> None: ...
...
class ContextCacheContainerProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """Details of a container within a Context Cache.

    :ivar description: Container description.
    :vartype description: str
    :ivar model_name: The model name associated with this container (e.g., gpt-4, claude-3).
     Required.
    :vartype model_name: str
    :ivar provider: The AI provider associated with this container. Required. "OpenAI"
    :vartype provider: str or ~azure.mgmt.storage.models.AiProvider
    :ivar time_to_live: The Time to Live (TTL) in days (1–30) for this container. Blobs in the
     container that have not been accessed within this number of days will be automatically deleted.
     If not specified at creation time, it defaults to 1 day.
    :vartype time_to_live: int
    :ivar provisioning_state: The status of the last operation. Known values are: "Succeeded",
     "Failed", "Canceled", "Creating", "Updating", "Deleting", and "Accepted".
    :vartype provisioning_state: str or ~azure.mgmt.storage.models.ContextCacheProvisioningState
    """

    description: Optional[str] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Container description."""
    model_name: str = rest_field(name="modelName", visibility=["read", "create"])
    """The model name associated with this container (e.g., gpt-4, claude-3). Required."""
    provider: Union[str, "_models.AiProvider"] = rest_field(visibility=["read", "create"])
    """The AI provider associated with this container. Required. \"OpenAI\""""
    time_to_live: Optional[int] = rest_field(
        name="timeToLive", visibility=["read", "create", "update", "delete", "query"]
    )
    """The Time to Live (TTL) in days (1–30) for this container. Blobs in the container that have not
     been accessed within this number of days will be automatically deleted. If not specified at
     creation time, it defaults to 1 day."""
    provisioning_state: Optional[Union[str, "_models.ContextCacheProvisioningState"]] = rest_field(
        name="provisioningState", visibility=["read"]
    )
    """The status of the last operation. Known values are: \"Succeeded\", \"Failed\", \"Canceled\",
     \"Creating\", \"Updating\", \"Deleting\", and \"Accepted\"."""
    ...
    def __init__(
        ...
        *,
        model_name: str,
        provider: Union[str, "_models.AiProvider"],
...
class ContextCacheContainerPropertiesUpdate(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    """The Time to Live (TTL) in days (1–30) for this container. Blobs in the container that have not
     been accessed within this number of days will be automatically deleted."""
...
class ContextCacheContainerUpdate(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The type used for update operations of the Context Cache Container.

    :ivar properties: The updatable properties of the Context Cache Container.
    :vartype properties: ~azure.mgmt.storage.models.ContextCacheContainerPropertiesUpdate
    """

    properties: Optional["_models.ContextCacheContainerPropertiesUpdate"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        properties: Optional["_models.ContextCacheContainerPropertiesUpdate"] = None,
    ) -> None: ...
...
class ContextCacheProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """Details of the Context Cache.

    :ivar account_kind: The kind of account determining storage topology. Required. Known values
     are: "Regional", "DataZone", and "Global".
    :vartype account_kind: str or ~azure.mgmt.storage.models.ContextCacheAccountKind
    :ivar description: Account description.
    :vartype description: str
    :ivar provisioning_state: The status of the last operation. Known values are: "Succeeded",
     "Failed", "Canceled", "Creating", "Updating", "Deleting", and "Accepted".
    :vartype provisioning_state: str or ~azure.mgmt.storage.models.ContextCacheProvisioningState
    :ivar encryption: Encryption settings for the account.
    :vartype encryption: ~azure.mgmt.storage.models.StorageAccountEncryption
    """

    account_kind: Union[str, "_models.ContextCacheAccountKind"] = rest_field(
        name="accountKind", visibility=["read", "create"]
    )
    """The kind of account determining storage topology. Required. Known values are: \"Regional\",
     \"DataZone\", and \"Global\"."""
    description: Optional[str] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Account description."""
    provisioning_state: Optional[Union[str, "_models.ContextCacheProvisioningState"]] = rest_field(
    ...
    """The status of the last operation. Known values are: \"Succeeded\", \"Failed\", \"Canceled\",
     \"Creating\", \"Updating\", \"Deleting\", and \"Accepted\"."""
    encryption: Optional["_models.StorageAccountEncryption"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        account_kind: Union[str, "_models.ContextCacheAccountKind"],
        description: Optional[str] = None,
        encryption: Optional["_models.StorageAccountEncryption"] = None,
    ) -> None: ...
...
class ContextCachePropertiesUpdate(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ContextCacheUpdate(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    properties: Optional["_models.ContextCachePropertiesUpdate"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
...
class CorsRules(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class CustomerManagedKeyEncryption(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :vartype key_encryption_key_identity: ~azure.mgmt.storage.models.KeyEncryptionKeyIdentity
...
class DataShare(TrackedResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageConnectorConnection(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class DataShareConnection(
    StorageConnectorConnection, discriminator="DataShare"
    ...
    type: Literal[StorageConnectorConnectionType.DATA_SHARE] = rest_discriminator(name="type", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
...
class StorageConnectorSource(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class DataShareSource(
    StorageConnectorSource, discriminator="DataShare"
):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    type: Literal[StorageConnectorSourceType.DATA_SHARE] = rest_discriminator(name="type", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
...
class StorageConnectorSourceUpdate(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The storage connector backing data source information.
...
class DataShareSourceUpdate(
    StorageConnectorSourceUpdate, discriminator="DataShare"
):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The properties of data share source.

    :ivar type: Discriminator value for DataShare. Required. Source type - DataShare.
    :vartype type: str or ~azure.mgmt.storage.models.DATA_SHARE
    :ivar auth_properties: Details for how to authenticate to the backing data store.
    :vartype auth_properties: ~azure.mgmt.storage.models.StorageConnectorAuthPropertiesUpdate
    """

    type: Literal[StorageConnectorSourceType.DATA_SHARE] = rest_discriminator(name="type", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
    """Discriminator value for DataShare. Required. Source type - DataShare."""
    auth_properties: Optional["_models.StorageConnectorAuthPropertiesUpdate"] = rest_field(
        name="authProperties", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        self,
        *,
        auth_properties: Optional["_models.StorageConnectorAuthPropertiesUpdate"] = None,
    ) -> None: ...
...
class DataShareUpdate(TrackedResourceUpdate):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """A DataShare is a tracked ARM resource modeled as a sub-resource of a Storage Account.
    ...
    :vartype properties: ~azure.mgmt.storage.models.StorageDataSharePropertiesUpdate
    """

    properties: Optional["_models.StorageDataSharePropertiesUpdate"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        tags: Optional[dict[str, str]] = None,
        properties: Optional["_models.StorageDataSharePropertiesUpdate"] = None,
    ) -> None: ...
...
class DateAfterCreation(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class DateAfterModification(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class DeletedAccount(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class DeletedShare(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class DualStackEndpointPreference(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class EncryptionInTransit(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class EncryptionScopeKeyVaultProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class EncryptionScopeProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """Properties of the encryption scope.
...
class EncryptionService(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class EncryptionServices(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class Endpoints(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ExecutionTarget(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ExecutionTrigger(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ExecutionTriggerUpdate(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class FileServiceProperties(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class FileServicePropertiesProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The properties of File services in storage account.
...
class FileServiceUsage(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class FileShare(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class FileShareItem(AzureEntityResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class FileShareLimits(_Model):
    ...
    :ivar max_provisioned_bandwidth_mi_b_per_sec: The maximum provisioned bandwidth limit in
     mebibytes per second for a file share in the storage account.
    :vartype max_provisioned_bandwidth_mi_b_per_sec: int
    :ivar guardrail_io_scalar: The IO scalar used for guardrail calculations for a file share in
     the storage account.
    :vartype guardrail_io_scalar: float
    :ivar guardrail_bandwidth_scalar: The bandwidth scalar used for guardrail calculations for a
     file share in the storage account.
    :vartype guardrail_bandwidth_scalar: float
    """
    ...
    """The maximum provisioned bandwidth limit in mebibytes per second for a file share in the storage
     account."""
    guardrail_io_scalar: Optional[float] = rest_field(name="guardrailIOScalar", visibility=["read"])
    """The IO scalar used for guardrail calculations for a file share in the storage account."""
    guardrail_bandwidth_scalar: Optional[float] = rest_field(name="guardrailBandwidthScalar", visibility=["read"])
    """The bandwidth scalar used for guardrail calculations for a file share in the storage account."""


class FileShareProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class FileSharePropertiesFileSharePaidBursting(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """File Share Paid Bursting properties.
...
class GeoPriorityReplicationStatus(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ImmutabilityPolicy(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ImmutabilityPolicyProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ImmutabilityPolicyProperty(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The properties of an ImmutabilityPolicy of a blob container.
...
class ImmutableStorageAccount(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ImmutableStorageWithVersioning(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class KeyCreationTime(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class KeyEncryptionKeyIdentity(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :vartype identity_type: str or ~azure.mgmt.storage.models.KeyEncryptionKeyIdentityType
...
class KeyPolicy(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class LastAccessTimeTrackingPolicy(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class LeaseContainerRequest(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class LeaseContainerResponse(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class LeaseShareRequest(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class LeaseShareResponse(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class LegalHold(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class LegalHoldProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The LegalHold property of a blob container.
...
class ListContainerItem(AzureEntityResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ListQueue(ResourceAutoGenerated):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """ListQueue.
...
class ListQueueProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """ListQueueProperties.
...
class LocalUser(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class LocalUserKeys(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class LocalUserProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageConnectorAuthProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ManagedIdentityAuthProperties(
    StorageConnectorAuthProperties, discriminator="ManagedIdentity"
):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    type: Literal[StorageConnectorAuthType.MANAGED_IDENTITY] = rest_discriminator(name="type", visibility=["read", "create", "update", "delete", "query"])  # type: ignore
...
class StorageConnectorAuthPropertiesUpdate(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The authentication properties of the backing data source.
...
class ManagedIdentityAuthPropertiesUpdate(
    StorageConnectorAuthPropertiesUpdate, discriminator="ManagedIdentity"
):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The managed identity auth properties for dataShare connection.
...
class ManagementPolicyAction(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ManagementPolicyBaseBlob(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ManagementPolicyDefinition(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ManagementPolicyFilter(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ManagementPolicyProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ManagementPolicyRule(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ManagementPolicySchema(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ManagementPolicySnapShot(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ManagementPolicyVersion(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class Multichannel(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class NfsSetting(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ObjectReplicationPolicy(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ObjectReplicationPolicyFilter(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ObjectReplicationPolicyProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ObjectReplicationPolicyPropertiesMetrics(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """Optional. The object replication policy metrics feature options.
...
class ObjectReplicationPolicyPropertiesPriorityReplication(
    _Model
):  # pylint: disable=name-too-long,docstring-keyword-should-match-keyword-only
    """Optional. The object replication policy priority replication feature options.
...
class ObjectReplicationPolicyPropertiesTagsReplication(
    _Model
):  # pylint: disable=name-too-long,docstring-keyword-should-match-keyword-only
    """Optional. The object replication policy tags replication feature options.
...
class ObjectReplicationPolicyRule(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class PermissionScope(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """PermissionScope.
...
class PrivateLinkResource(ResourceAutoGenerated):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ProtectedAppendWritesHistory(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class QueueProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """QueueProperties.
...
class QueueServiceProperties(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class QueueServicePropertiesProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The properties of a storage account’s Queue service.
...
class ResourceAccessRule(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class RestorePolicyProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The blob service properties for blob restore policy.
...
class RoutingPreference(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class SasPolicy(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :ivar require_user_bound_user_delegation_sas: Indicates whether user delegation SAS (shared
     access signature) tokens are required to be bound to a specific user. The default
     interpretation is false for this property.
    :vartype require_user_bound_user_delegation_sas: bool
    :ivar require_user_bound_user_delegation_sas_action: The action to perform when a user
     delegation SAS (shared access signature) token is not bound to a user as required by
     requireUserBoundUserDelegationSas. Known values are: "None", "Log", and "Block".
    :vartype require_user_bound_user_delegation_sas_action: str or
     ~azure.mgmt.storage.models.PolicyViolationAction
    """
    ...
    require_user_bound_user_delegation_sas: Optional[bool] = rest_field(
        name="requireUserBoundUserDelegationSas", visibility=["read", "create", "update", "delete", "query"]
    )
    """Indicates whether user delegation SAS (shared access signature) tokens are required to be bound
     to a specific user. The default interpretation is false for this property."""
    require_user_bound_user_delegation_sas_action: Optional[Union[str, "_models.PolicyViolationAction"]] = rest_field(
        name="requireUserBoundUserDelegationSasAction", visibility=["read", "create", "update", "delete", "query"]
    )
    """The action to perform when a user delegation SAS (shared access signature) token is not bound
     to a user as required by requireUserBoundUserDelegationSas. Known values are: \"None\",
     \"Log\", and \"Block\"."""
    ...
    def __init__(
        ...
        *,
        ...
        require_user_bound_user_delegation_sas: Optional[bool] = None,
        require_user_bound_user_delegation_sas_action: Optional[Union[str, "_models.PolicyViolationAction"]] = None,
    ) -> None: ...
...
class ServiceSasParameters(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class ServiceSharedKeyAccessProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class SmbOAuthSettings(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class SmbSetting(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """Setting for SMB protocol.
...
class StorageAccount(TrackedResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    __flattened_items = [
        ...
        "allow_cross_tenant_delegation_sas",
    ]
...
class StorageAccountCreateParameters(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageAccountEncryption(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :ivar infrastructure_encryption: Values are enabled and disabled. Known values are: "enabled"
     and "disabled".
    :vartype infrastructure_encryption: str or ~azure.mgmt.storage.models.InfrastructureEncryption
    ...
    :vartype customer_managed_key_encryption:
     ~azure.mgmt.storage.models.CustomerManagedKeyEncryption
    """
...
class StorageAccountIpv6Endpoints(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageAccountMigration(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageAccountMigrationProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageAccountProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :ivar allow_cross_tenant_delegation_sas: Allow or disallow cross AAD tenant user delegation SAS
     (shared access signature). The default interpretation is false for this property.
    :vartype allow_cross_tenant_delegation_sas: bool
    """
    ...
    allow_cross_tenant_delegation_sas: Optional[bool] = rest_field(
        name="allowCrossTenantDelegationSas", visibility=["read", "create", "update", "delete", "query"]
    )
    """Allow or disallow cross AAD tenant user delegation SAS (shared access signature). The default
     interpretation is false for this property."""
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        allow_cross_tenant_delegation_sas: Optional[bool] = None,
    ) -> None: ...
...
class StorageAccountPropertiesCreateParameters(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The parameters used to create the storage account.
...
class StorageAccountPropertiesUpdateParameters(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageAccountRegenerateKeyParameters(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageAccountSharedKeyAccessProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageAccountSkuConversionStatus(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageAccountUpdateParameters(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageConnectorProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageConnectorPropertiesUpdate(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The storage connector properties.
    ...
    :ivar source: Information about how to communicate with and authenticate to the backing data
     store.
    :vartype source: ~azure.mgmt.storage.models.StorageConnectorSourceUpdate
    """
    ...
    test_connection: Optional[bool] = rest_field(name="testConnection", visibility=["create", "update"])
    """Test connection to backing data source before creating the storage connector."""
    source: Optional["_models.StorageConnectorSourceUpdate"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        ...
        description: Optional[str] = None,
        test_connection: Optional[bool] = None,
        source: Optional["_models.StorageConnectorSourceUpdate"] = None,
    ) -> None: ...
...
class StorageDataCollaborationPolicyProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageDataShareAccessPolicy(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageDataShareAsset(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageDataShareProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageDataSharePropertiesUpdate(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The storage datashare properties.
    ...
    description: Optional[str] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Arbitrary description of this Data Share. Max 250 characters."""
    access_policies: Optional[list["_models.StorageDataShareAccessPolicy"]] = rest_field(
        name="accessPolicies", visibility=["read", "create", "update", "delete", "query"]
    )
    """List of access policies that specify the permission allowed to a managed identity. For Create -
     This property is required and cannot be null. If no access policies are provided at creation
    ...
    assets: Optional[list["_models.StorageDataShareAsset"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """List of assets that specify the properties of the shared resources. For Create - This property
     is required and cannot be null. If no assets are provided at creation time, specify an empty
    ...
    def __init__(
        ...
        *,
        description: Optional[str] = None,
        access_policies: Optional[list["_models.StorageDataShareAccessPolicy"]] = None,
        assets: Optional[list["_models.StorageDataShareAsset"]] = None,
    ) -> None: ...
...
class StorageQueue(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageTaskAssignment(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageTaskAssignmentExecutionContext(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageTaskAssignmentProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """Properties of the storage task assignment.
...
class StorageTaskAssignmentReport(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageTaskAssignmentUpdateParameters(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageTaskAssignmentUpdateProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class StorageTaskAssignmentUpdateReport(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The storage task assignment report.
...
class StorageTaskReportInstance(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class TableAccessPolicy(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class TableServiceProperties(ProxyResource):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class TableServicePropertiesProperties(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The properties of a storage account’s Table service.
...
class TableSignedIdentifier(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class TagFilter(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class TestConnectionResponse(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class TestExistingConnectionRequest(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class TriggerParameters(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
...
class TriggerParametersUpdate(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """The trigger parameters update for the storage task assignment execution.
...
class UpdateHistoryProperty(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
