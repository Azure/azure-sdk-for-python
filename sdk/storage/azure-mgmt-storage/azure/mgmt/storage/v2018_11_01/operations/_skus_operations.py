...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.Storage/skus')
...
class SkusOperations(object):
    ...
    def list(
        self,
        **kwargs: Any
    ) -> Iterable["_models.StorageSkuListResult"]:
        ...
        :return: An iterator like instance of either StorageSkuListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2018_11_01.models.StorageSkuListResult]
