...
class StorageManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype storage_accounts:
     azure.mgmt.storage.v2018_11_01.aio.operations.StorageAccountsOperations
    ...
    :vartype management_policies:
     azure.mgmt.storage.v2018_11_01.aio.operations.ManagementPoliciesOperations
    ...
    :vartype blob_containers:
     azure.mgmt.storage.v2018_11_01.aio.operations.BlobContainersOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.skus = SkusOperations(self._client, self._config, self._serialize, self._deserialize, "2018-11-01")
