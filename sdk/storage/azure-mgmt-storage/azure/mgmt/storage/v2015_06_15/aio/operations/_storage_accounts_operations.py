...
class StorageAccountsOperations:
    ...
    async def check_name_availability(
        ...
        :param account_name: The name of the storage account within the specified resource group.
         ...
         type. Required.
        :type account_name:
         ~azure.mgmt.storage.v2015_06_15.models.StorageAccountCheckNameAvailabilityParameters or IO
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2015_06_15.models.StorageAccountCreateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json',
         'text/json'. Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2015_06_15.models.StorageAccountUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json',
         'text/json'. Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.StorageAccount"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2015_06_15.models.StorageAccount]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
