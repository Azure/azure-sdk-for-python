...
class BlobContainersOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2021_06_01.models.ListContainerItem]
    ...
    async def set_legal_hold(
        ...
        **kwargs: Any
        ...
        :type legal_hold: ~azure.mgmt.storage.v2021_06_01.models.LegalHold
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def create_or_update_immutability_policy(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_06_01.models.ImmutabilityPolicy
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    async def create_or_update_immutability_policy(
        ...
        **kwargs: Any
        ...
        immutability_policy_name = kwargs.pop("immutability_policy_name", "default")  # type: Literal["default"]
        api_version = kwargs.pop("api_version", _params.pop("api-version", "2021-06-01"))  # type: Literal["2021-06-01"]
        content_type = kwargs.pop("content_type", _headers.pop("Content-Type", None))  # type: Optional[str]
    ...
    async def lease(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_06_01.models.LeaseContainerRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
