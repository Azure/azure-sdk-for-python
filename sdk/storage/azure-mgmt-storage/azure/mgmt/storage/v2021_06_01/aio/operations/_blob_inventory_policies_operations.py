...
class BlobInventoryPoliciesOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.storage.v2021_06_01.models.BlobInventoryPolicy or IO[bytes]
        :return: BlobInventoryPolicy or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_06_01.models.BlobInventoryPolicy
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2021_06_01.models.BlobInventoryPolicy]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
