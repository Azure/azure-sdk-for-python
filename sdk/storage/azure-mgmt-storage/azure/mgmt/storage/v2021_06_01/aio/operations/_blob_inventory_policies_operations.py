...
class BlobInventoryPoliciesOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :type blob_inventory_policy_name: str or ~azure.mgmt.storage.v2021_06_01.models.BlobInventoryPolicyName
        ...
        path_format_arguments = {
            ...
            'blobInventoryPolicyName': self._serialize.url("blob_inventory_policy_name", blob_inventory_policy_name, 'str'),
        }
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :type account_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ListBlobInventoryPolicy or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2021_06_01.models.ListBlobInventoryPolicy]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
