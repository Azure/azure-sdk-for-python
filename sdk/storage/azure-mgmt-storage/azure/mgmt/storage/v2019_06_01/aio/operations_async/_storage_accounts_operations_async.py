...
class StorageAccountsOperations:
    ...
    async def restore_blob_ranges(
     ...
     case letters only.
        ...
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: BlobRestoreStatus, or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2019_06_01.models.BlobRestoreStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.BlobRestoreStatus"]
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    restore_blob_ranges.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/restoreBlobRanges'}  # type: ignore
