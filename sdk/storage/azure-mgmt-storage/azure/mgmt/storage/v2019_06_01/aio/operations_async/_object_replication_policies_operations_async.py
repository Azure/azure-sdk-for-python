...
class ObjectReplicationPoliciesOperations:
    ...
    def list(
        ...
        account_name: str,
        **kwargs
    ) -> "models.ObjectReplicationPolicies":
     ...
     case letters only.
        ...
        :return: ObjectReplicationPolicies or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2019_06_01.models.ObjectReplicationPolicies
