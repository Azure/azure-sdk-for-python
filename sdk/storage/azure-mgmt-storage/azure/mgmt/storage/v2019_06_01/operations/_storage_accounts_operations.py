...
class StorageAccountsOperations(object):
    ...
    def check_name_availability(
        ...
        :rtype:
         ~azure.mgmt.storage.v2019_06_01.models.CheckNameAvailabilityResult or
    ...
    def create(
        ...
        :type parameters:
         ~azure.mgmt.storage.v2019_06_01.models.StorageAccountCreateParameters
        :param dict custom_headers: headers that will be added to the request
    ...
    def get_properties(
        ...
        :type expand: str or
         ~azure.mgmt.storage.v2019_06_01.models.StorageAccountExpand
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def update(
        ...
        :type parameters:
         ~azure.mgmt.storage.v2019_06_01.models.StorageAccountUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.storage.v2019_06_01.models.StorageAccountPaged[~azure.mgmt.storage.v2019_06_01.models.StorageAccount]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_keys(
        ...
        :type expand: str or
         ~azure.mgmt.storage.v2019_06_01.models.ListKeyExpand
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list_account_sas(
        ...
        :type parameters:
         ~azure.mgmt.storage.v2019_06_01.models.AccountSasParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list_service_sas(
        ...
        :param parameters: The parameters to provide to list service SAS
         credentials.
        :type parameters:
         ~azure.mgmt.storage.v2019_06_01.models.ServiceSasParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def restore_blob_ranges(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.storage.v2019_06_01.models.BlobRestoreStatus]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.storage.v2019_06_01.models.BlobRestoreStatus]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
