...
def build_set_service_properties_request(
    ...
    account_name: str,
    blob_services_name: Union[str, _models.Enum31],
    subscription_id: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class BlobServicesOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either BlobServiceProperties or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2021_02_01.models.BlobServiceProperties]
    ...
    def set_service_properties(
        ...
        **kwargs: Any
        ...
        :type blob_services_name: str or ~azure.mgmt.storage.v2021_02_01.models.Enum31
    ...
    def set_service_properties(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_02_01.models.BlobServiceProperties or IO[bytes]
        :return: BlobServiceProperties or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_02_01.models.BlobServiceProperties
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_service_properties(
        self, resource_group_name: str, account_name: str, blob_services_name: Union[str, _models.Enum31], **kwargs: Any
    ) -> _models.BlobServiceProperties:
