...
class StorageAccountsOperations:
    ...
    def check_name_availability(
        ...
        :param account_name: The name of the storage account within the specified resource group.
         ...
         type. Required.
        :type account_name:
         ~azure.mgmt.storage.v2021_02_01.models.StorageAccountCheckNameAvailabilityParameters or IO
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_02_01.models.StorageAccountCreateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_02_01.models.StorageAccountUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def regenerate_key(
        ...
        **kwargs: Any
        ...
        :type regenerate_key:
         ~azure.mgmt.storage.v2021_02_01.models.StorageAccountRegenerateKeyParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_account_sas(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_02_01.models.AccountSasParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_service_sas(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_02_01.models.ServiceSasParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def begin_restore_blob_ranges(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_02_01.models.BlobRestoreParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
