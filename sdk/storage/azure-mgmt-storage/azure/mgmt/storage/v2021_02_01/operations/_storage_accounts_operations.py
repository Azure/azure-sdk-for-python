...
def build_check_name_availability_request(
    subscription_id: str,
    *,
    json: Optional[_models.StorageAccountCheckNameAvailabilityParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
...
def build_create_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.StorageAccountCreateParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_update_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.StorageAccountUpdateParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_regenerate_key_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.StorageAccountRegenerateKeyParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_list_account_sas_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.AccountSasParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_list_service_sas_request(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.ServiceSasParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_restore_blob_ranges_request_initial(
    ...
    subscription_id: str,
    *,
    json: Optional[_models.BlobRestoreParameters] = None,
    content: Any = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
