...
def build_set_service_properties_request(
    ...
    account_name: str,
    table_service_name: Union[str, _models.Enum31],
    subscription_id: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class TableServicesOperations:
    ...
    def set_service_properties(
        ...
        **kwargs: Any
        ...
        :type table_service_name: str or ~azure.mgmt.storage.v2021_02_01.models.Enum31
    ...
    def set_service_properties(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_02_01.models.TableServiceProperties or IO[bytes]
        :return: TableServiceProperties or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_02_01.models.TableServiceProperties
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_service_properties(
        self, resource_group_name: str, account_name: str, table_service_name: Union[str, _models.Enum31], **kwargs: Any
    ) -> _models.TableServiceProperties:
