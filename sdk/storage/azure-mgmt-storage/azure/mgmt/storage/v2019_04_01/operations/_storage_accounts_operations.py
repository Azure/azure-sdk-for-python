...
class StorageAccountsOperations(object):
    ...
    def check_name_availability(self, name, cls=None, **kwargs):
        ...
        :rtype:
         ~azure.mgmt.storage.v2019_04_01.models.CheckNameAvailabilityResult
    ...
    def create(
        ...
        :type parameters:
         ~azure.mgmt.storage.v2019_04_01.models.StorageAccountCreateParameters
        :param callable cls: A custom type or function that will be passed the
         direct response
    ...
    def get_properties(self, resource_group_name, account_name, expand=None, cls=None, **kwargs):
        ...
        :type expand: str or
         ~azure.mgmt.storage.v2019_04_01.models.StorageAccountExpand
        :param callable cls: A custom type or function that will be passed the
         direct response
    ...
    def update(self, resource_group_name, account_name, parameters, cls=None, **kwargs):
        ...
        :type parameters:
         ~azure.mgmt.storage.v2019_04_01.models.StorageAccountUpdateParameters
        :param callable cls: A custom type or function that will be passed the
         direct response
        :return: StorageAccount or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2019_04_01.models.StorageAccount
    ...
    def list(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2019_04_01.models.StorageAccount]
        :raises: :class:`ARMError<azure.mgmt.core.ARMError>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def list_keys(self, resource_group_name, account_name, expand=None, cls=None, **kwargs):
        ...
        :rtype:
         ~azure.mgmt.storage.v2019_04_01.models.StorageAccountListKeysResult
        :raises: :class:`ARMError<azure.mgmt.core.ARMError>`
        """
        error_map = kwargs.pop('error_map', None)
        # Construct URL
    ...
    def list_account_sas(self, resource_group_name, account_name, parameters, cls=None, **kwargs):
        ...
        :type parameters:
         ~azure.mgmt.storage.v2019_04_01.models.AccountSasParameters
        :param callable cls: A custom type or function that will be passed the
         direct response
    ...
    def list_service_sas(self, resource_group_name, account_name, parameters, cls=None, **kwargs):
        ...
        :param parameters: The parameters to provide to list service SAS
         credentials.
        :type parameters:
         ~azure.mgmt.storage.v2019_04_01.models.ServiceSasParameters
        :param callable cls: A custom type or function that will be passed the
         direct response
    ...
    def revoke_user_delegation_keys(self, resource_group_name, account_name, cls=None, **kwargs):
