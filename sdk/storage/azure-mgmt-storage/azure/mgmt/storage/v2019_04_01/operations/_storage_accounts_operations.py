...
class StorageAccountsOperations:
    ...
    def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type account_name:
         ~azure.mgmt.storage.v2019_04_01.models.StorageAccountCheckNameAvailabilityParameters
    ...
    def get_properties(
        ...
        **kwargs: Any
        ...
        :param expand: May be used to expand the properties within account's properties. By default,
         ...
         Known values are "geoReplicationStats" or None. Default value is "geoReplicationStats".
        :type expand: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either StorageAccountListResult or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2019_04_01.models.StorageAccountListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def regenerate_key(
        ...
        **kwargs: Any
        ...
        :param regenerate_key: Specifies name of the key which should be regenerated -- key1, key2,
         kerb1, kerb2.
        :type regenerate_key:
         ~azure.mgmt.storage.v2019_04_01.models.StorageAccountRegenerateKeyParameters
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: StorageAccountListKeysResult, or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2019_04_01.models.StorageAccountListKeysResult
        :raises: ~azure.core.exceptions.HttpResponseError
