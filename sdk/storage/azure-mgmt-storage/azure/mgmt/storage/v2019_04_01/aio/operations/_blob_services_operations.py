...
class BlobServicesOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either BlobServiceProperties or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2019_04_01.models.BlobServiceProperties]
    ...
    async def set_service_properties(
        ...
        account_name: str,
        blob_services_name: Union[str, _models.Enum16],
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2019_04_01.models.BlobServiceProperties
    ...
    async def set_service_properties(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2019_04_01.models.BlobServiceProperties or IO[bytes]
        :return: BlobServiceProperties or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2019_04_01.models.BlobServiceProperties
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get_service_properties(
        self, resource_group_name: str, account_name: str, blob_services_name: Union[str, _models.Enum16], **kwargs: Any
    ) -> _models.BlobServiceProperties:
