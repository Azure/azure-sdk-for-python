...
try:
    ...
    from .date_after_modification_py3 import DateAfterModification
    from .management_policy_base_blob_py3 import ManagementPolicyBaseBlob
    from .date_after_creation_py3 import DateAfterCreation
    from .management_policy_snap_shot_py3 import ManagementPolicySnapShot
    from .management_policy_action_py3 import ManagementPolicyAction
    from .management_policy_filter_py3 import ManagementPolicyFilter
    from .management_policy_definition_py3 import ManagementPolicyDefinition
    from .management_policy_rule_py3 import ManagementPolicyRule
    from .management_policy_schema_py3 import ManagementPolicySchema
    from .management_policy_py3 import ManagementPolicy
    ...
    from .date_after_modification import DateAfterModification
    from .management_policy_base_blob import ManagementPolicyBaseBlob
    from .date_after_creation import DateAfterCreation
    from .management_policy_snap_shot import ManagementPolicySnapShot
    from .management_policy_action import ManagementPolicyAction
    from .management_policy_filter import ManagementPolicyFilter
    from .management_policy_definition import ManagementPolicyDefinition
    from .management_policy_rule import ManagementPolicyRule
    from .management_policy_schema import ManagementPolicySchema
