...
class StorageAccountsOperations:
    ...
    async def check_name_availability(
        ...
        :param account_name: The name of the storage account within the specified resource group.
         ...
         type. Required.
        :type account_name:
         ~azure.mgmt.storage.v2016_01_01.models.StorageAccountCheckNameAvailabilityParameters or IO
        ...
        api_version: Literal["2016-01-01"] = kwargs.pop("api_version", _params.pop("api-version", "2016-01-01"))
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2016_01_01.models.StorageAccountCreateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json',
         'text/json'. Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2016_01_01.models.StorageAccountUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json',
         'text/json'. Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
