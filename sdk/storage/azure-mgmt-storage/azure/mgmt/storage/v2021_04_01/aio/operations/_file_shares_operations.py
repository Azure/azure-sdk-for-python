...
class FileSharesOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2021_04_01.models.FileShareItems]
    ...
    async def lease(
        ...
        **kwargs
        ...
        if parameters is not None:
            body_content = self._serialize.body(parameters, 'LeaseShareRequest')
        else:
            body_content = None
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
