...
class QueueOperations:
    ...
    def create(
        ...
        **kwargs: Any
        ...
        :type queue: ~azure.mgmt.storage.v2021_04_01.models.StorageQueue or IO[bytes]
        :return: StorageQueue or the result of cls(response)
        :rtype: ~azure.mgmt.storage.v2021_04_01.models.StorageQueue
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storage.v2021_04_01.models.ListQueue]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
