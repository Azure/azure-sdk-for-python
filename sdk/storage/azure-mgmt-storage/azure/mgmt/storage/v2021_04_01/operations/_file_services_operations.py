...
class FileServicesOperations:
    ...
    def set_service_properties(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2021_04_01.models.FileServiceProperties
    ...
    def get_service_properties(
        self, resource_group_name: str, account_name: str, file_services_name: Union[str, _models.Enum35], **kwargs: Any
    ) -> _models.FileServiceProperties:
