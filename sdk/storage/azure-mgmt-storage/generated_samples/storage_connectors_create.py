...
# USAGE
    python storage_connectors_create.py
...
def main():
    ...
    response = client.connectors.begin_create(
...
# x-ms-original-file: 2026-06-01/StorageConnectorCRUD/StorageConnectors_Create.json
