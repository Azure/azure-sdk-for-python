...
# USAGE
    python advanced_platform_metrics_rules_create_or_update_container_list.py
...
def main():
    ...
    response = client.advanced_platform_metrics.create_or_update(
        resource_group_name="res6977",
        account_name="sto2527",
        advanced_platform_metrics_rule_type="ContainerLevelCapacityMetrics",
        resource={
            "properties": {
                "enabled": True,
                "ruleConfig": {
