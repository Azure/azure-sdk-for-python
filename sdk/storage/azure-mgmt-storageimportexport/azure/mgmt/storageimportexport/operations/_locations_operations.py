...
class LocationsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.storageimportexport.models.LocationPaged[~azure.mgmt.storageimportexport.models.Location]
        :raises:
    ...
    def get(
        ...
        :param location_name: The name of the location. For example, West US
         or westus.
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: Location or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.storageimportexport.models.Location or
