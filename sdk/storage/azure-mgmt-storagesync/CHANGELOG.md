...
### Features Added
  ...
  - Operation group `CloudEndpointsOperations` added method `restore_heartbeat`
  - Operation group `RegisteredServersOperations` added method `begin_update`

### Breaking Changes

  - This version introduces new hybrid models which have dual dictionary and model nature. Please follow https://aka.ms/azsdk/python/migrate/hybrid-models for migration.
  - Client `MicrosoftStorageSync` renamed to `StorageSyncClient`
  ...
  - Method `CloudEndpointsOperations.restoreheartbeat` renamed to `CloudEndpointsOperations.restore_heartbeat`
  - Deleted operation group `MicrosoftStorageSyncOperationsMixin`
