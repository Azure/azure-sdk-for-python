...
from ...operations._operations import (
    ...
    build_storage_sync_location_operation_status_request,
...
class Operations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.storagesync.aio.StorageSyncClient`'s
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: StorageSyncClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
...
class _StorageSyncClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], StorageSyncClientConfiguration]
):
    ...
    async def location_operation_status(
        ...
        _request = build_storage_sync_location_operation_status_request(
            location_name=location_name,
            operation_id=operation_id,
            subscription_id=self._config.subscription_id,
            api_version=self._config.api_version,
