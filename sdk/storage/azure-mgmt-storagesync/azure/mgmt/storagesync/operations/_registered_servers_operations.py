...
class RegisteredServersOperations(object):
    ...
    def list_by_storage_sync_service(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.RegisteredServerArray"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storagesync.models.RegisteredServerArray]
    ...
    def _create_initial(
        ...
        storage_sync_service_name,  # type: str
        server_id,  # type: str
        parameters,  # type: "_models.RegisteredServerCreateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.RegisteredServer"]
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.RegisteredServer"]
    ...
    def _trigger_rollover_initial(
        ...
        storage_sync_service_name,  # type: str
        server_id,  # type: str
        parameters,  # type: "_models.TriggerRolloverRequest"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
