...
class TestStorageSyncMgmtCloudEndpointsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_cloud_endpoints_restore_heartbeat(self, resource_group):
        response = await self.client.cloud_endpoints.restore_heartbeat(
            resource_group_name=resource_group.name,
            storage_sync_service_name="str",
            sync_group_name="str",
            cloud_endpoint_name="str",
