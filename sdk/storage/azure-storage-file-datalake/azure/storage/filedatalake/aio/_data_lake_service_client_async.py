...
class DataLakeServiceClient(AsyncStorageAccountHostsMixin, DataLakeServiceClientBase):
    ...
    async def rename_file_system(self, name, new_name, **kwargs):
        ...
        :rtype: ~azure.storage.filedatalake.FileSystemClient
        """
        await self._blob_service_client.rename_container(name, new_name, **kwargs)   # pylint: disable=protected-access
