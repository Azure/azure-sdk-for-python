...
def build_path_create_request(  # pylint: disable=too-many-locals,too-many-statements,too-many-branches
    ...
    **kwargs: Any
    ...
    if content_type is not None:
        _headers["x-ms-content-type"] = _SERIALIZER.header("content_type", content_type, "str")
...
def build_path_update_request(  # pylint: disable=too-many-locals,too-many-statements,too-many-branches
    ...
    **kwargs: Any
    ...
    if max_records is not None:
        _params["maxRecords"] = _SERIALIZER.query("max_records", max_records, "int")
    if continuation is not None:
        _params["continuation"] = _SERIALIZER.query("continuation", continuation, "str")
    if mode is not None:
        _params["mode"] = _SERIALIZER.query("mode", mode, "str")
...
def build_path_lease_request(
    ...
    **kwargs: Any
    ...
    if lease_duration is not None:
        _headers["x-ms-lease-duration"] = _SERIALIZER.header("lease_duration", lease_duration, "int")
    if lease_break_period is not None:
        _headers["x-ms-lease-break-period"] = _SERIALIZER.header("lease_break_period", lease_break_period, "int")
    if lease_id is not None:
        _headers["x-ms-lease-id"] = _SERIALIZER.header("lease_id", lease_id, "str")
    if proposed_lease_id is not None:
        _headers["x-ms-proposed-lease-id"] = _SERIALIZER.header("proposed_lease_id", proposed_lease_id, "str")
...
class ServiceOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.storage.filedatalake._generated.DataLakeClient`'s
