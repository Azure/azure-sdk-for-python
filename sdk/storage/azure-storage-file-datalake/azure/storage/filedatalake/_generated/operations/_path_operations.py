...
def build_create_request(
    ...
    **kwargs  # type: Any
    ...
    path_format_arguments = {
        "filesystem": _SERIALIZER.url("file_system", file_system, 'str', max_length=63, min_length=3, pattern=r'^[$a-z0-9](?!.*--)[-a-z0-9]{1,61}[a-z0-9]$'),
    ...
    def create(
        ...
        **kwargs  # type: Any
        ...
        request = build_create_request(
            file_system=self._config.file_system,
