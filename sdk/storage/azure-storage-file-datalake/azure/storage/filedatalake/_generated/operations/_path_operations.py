...
def build_create_request(
    **kwargs  # type: Any
    ...
    if mode is not None:
        query_parameters['mode'] = _SERIALIZER.query("mode", mode, 'str')
    ...
    if content_type_parameter is not None:
        header_parameters['x-ms-content-type'] = _SERIALIZER.header("content_type_parameter", content_type_parameter, 'str')
    ...
    if permissions is not None:
        header_parameters['x-ms-permissions'] = _SERIALIZER.header("permissions", permissions, 'str')
    if umask is not None:
        header_parameters['x-ms-umask'] = _SERIALIZER.header("umask", umask, 'str')
...
def build_update_request(
    **kwargs  # type: Any
    ...
    if max_records is not None:
        query_parameters['maxRecords'] = _SERIALIZER.query("max_records", max_records, 'int', minimum=1)
    if continuation is not None:
        query_parameters['continuation'] = _SERIALIZER.query("continuation", continuation, 'str')
    query_parameters['mode'] = _SERIALIZER.query("mode", mode, 'str')
    if force_flag is not None:
        query_parameters['forceFlag'] = _SERIALIZER.query("force_flag", force_flag, 'bool')
    if position is not None:
        query_parameters['position'] = _SERIALIZER.query("position", position, 'long')
    if retain_uncommitted_data is not None:
        query_parameters['retainUncommittedData'] = _SERIALIZER.query("retain_uncommitted_data", retain_uncommitted_data, 'bool')
    if close is not None:
        query_parameters['close'] = _SERIALIZER.query("close", close, 'bool')
    ...
    if content_length is not None:
        header_parameters['Content-Length'] = _SERIALIZER.header("content_length", content_length, 'long', minimum=0)
    if content_md5 is not None:
        header_parameters['x-ms-content-md5'] = _SERIALIZER.header("content_md5", content_md5, 'bytearray')
    if lease_id is not None:
        header_parameters['x-ms-lease-id'] = _SERIALIZER.header("lease_id", lease_id, 'str')
    if cache_control is not None:
        header_parameters['x-ms-cache-control'] = _SERIALIZER.header("cache_control", cache_control, 'str')
    ...
    if permissions is not None:
        header_parameters['x-ms-permissions'] = _SERIALIZER.header("permissions", permissions, 'str')
    if acl is not None:
        header_parameters['x-ms-acl'] = _SERIALIZER.header("acl", acl, 'str')
    if if_match is not None:
        header_parameters['If-Match'] = _SERIALIZER.header("if_match", if_match, 'str')
    if if_none_match is not None:
        header_parameters['If-None-Match'] = _SERIALIZER.header("if_none_match", if_none_match, 'str')
...
def build_lease_request(
    **kwargs  # type: Any
    ...
    if request_id_parameter is not None:
        header_parameters['x-ms-client-request-id'] = _SERIALIZER.header("request_id_parameter", request_id_parameter, 'str')
    header_parameters['x-ms-version'] = _SERIALIZER.header("version", version, 'str')
    header_parameters['x-ms-lease-action'] = _SERIALIZER.header("x_ms_lease_action", x_ms_lease_action, 'str')
    if x_ms_lease_duration is not None:
        header_parameters['x-ms-lease-duration'] = _SERIALIZER.header("x_ms_lease_duration", x_ms_lease_duration, 'int')
    if x_ms_lease_break_period is not None:
        header_parameters['x-ms-lease-break-period'] = _SERIALIZER.header("x_ms_lease_break_period", x_ms_lease_break_period, 'int')
    if lease_id is not None:
        header_parameters['x-ms-lease-id'] = _SERIALIZER.header("lease_id", lease_id, 'str')
...
def build_read_request(
    **kwargs  # type: Any
    ...
    if x_ms_range_get_content_md5 is not None:
        header_parameters['x-ms-range-get-content-md5'] = _SERIALIZER.header("x_ms_range_get_content_md5", x_ms_range_get_content_md5, 'bool')
    if if_match is not None:
        header_parameters['If-Match'] = _SERIALIZER.header("if_match", if_match, 'str')
    if if_none_match is not None:
        header_parameters['If-None-Match'] = _SERIALIZER.header("if_none_match", if_none_match, 'str')
...
def build_append_data_request(
    **kwargs  # type: Any
    ...
    if transactional_content_hash is not None:
        header_parameters['Content-MD5'] = _SERIALIZER.header("transactional_content_hash", transactional_content_hash, 'bytearray')
...
def build_undelete_request(
    **kwargs  # type: Any
    ...
    if undelete_source is not None:
        header_parameters['x-ms-undelete-source'] = _SERIALIZER.header("undelete_source", undelete_source, 'str')
    header_parameters['x-ms-version'] = _SERIALIZER.header("version", version, 'str')
    if request_id_parameter is not None:
        header_parameters['x-ms-client-request-id'] = _SERIALIZER.header("request_id_parameter", request_id_parameter, 'str')
    header_parameters['Accept'] = _SERIALIZER.header("accept", accept, 'str')
...
class PathOperations(object):
    ...
    def lease(
        ...
        **kwargs  # type: Any
        ...
        _url = self._client.format_url(self.lease.metadata['url'], **path_format_arguments)
    ...
    def read(
        ...
        **kwargs  # type: Any
        ...
        _url = self._client.format_url(self.read.metadata['url'], **path_format_arguments)
    ...
    def set_access_control(
        ...
        **kwargs  # type: Any
        ...
        _url = self._client.format_url(self.set_access_control.metadata['url'], **path_format_arguments)
    ...
    def set_access_control_recursive(
        ...
        **kwargs  # type: Any
        ...
        _url = self._client.format_url(self.set_access_control_recursive.metadata['url'], **path_format_arguments)
    ...
    def flush_data(
        ...
        **kwargs  # type: Any
        ...
        _url = self._client.format_url(self.flush_data.metadata['url'], **path_format_arguments)
    ...
    def append_data(
        ...
        **kwargs  # type: Any
        ...
        _url = self._client.format_url(self.append_data.metadata['url'], **path_format_arguments)
    ...
    def set_expiry(
        ...
        **kwargs  # type: Any
        ...
        _url = self._client.format_url(self.set_expiry.metadata['url'], **path_format_arguments)
    ...
    def undelete(
        ...
        **kwargs  # type: Any
        ...
        _url = self._client.format_url(self.undelete.metadata['url'], **path_format_arguments)
