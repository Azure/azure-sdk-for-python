...
class PathOperations:
    ...
    @distributed_trace_async
    async def lease(  # pylint: disable=too-many-locals
        self,
        filesystem: str,
        path: str,
        *,
    ...
    @distributed_trace_async
    async def read(  # pylint: disable=too-many-locals
        self,
        filesystem: str,
        path: str,
        *,
    ...
    @distributed_trace_async
    async def set_access_control(  # pylint: disable=too-many-locals
        self,
        filesystem: str,
        path: str,
        *,
