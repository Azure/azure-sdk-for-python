...
class FileSystemClient(StorageAccountHostsMixin):
    ...
    def create_file_system(self, metadata: Optional[Dict[str, str]]=..., **kwargs: Any) -> None: ...
    ...
    def create_directory(self, directory: Union[DirectoryProperties, str], content_settings: Optional[ContentSettings]=..., metadata: Optional[Dict[str, str]]=..., **kwargs: Any) -> Dict[str, Union[str, datetime]]: ...
    def delete_directory(self, directory: Union[DirectoryProperties, str], **kwargs: Any) -> None: ...
    def create_file(self, file: Union[FileProperties, str], **kwargs: Any) -> Dict[str, Union[str, datetime]]: ...
    def delete_file(self, file: Union[FileProperties, str], lease: Optional[Union[DataLakeLeaseClient, str]]=..., **kwargs: Any) -> None: ...
    def get_directory_client(self, directory: Union[DirectoryProperties, str]) -> DataLakeDirectoryClient: ...
    def get_file_client(self, directory: Union[DirectoryProperties, str], file: Union[FileProperties, str]) -> DataLakeFileClient: ...
