...
class DirectoryTest(StorageTestCase):
    ...
    @DataLakePreparer()
    async def test_create_file_owner_with_directory_client_async(self, datalake_storage_account_name,
        ...
        await directory_client.create_file(file='file1', owner=test_string)
        file_client = directory_client.get_file_client('file1')
    ...
    @DataLakePreparer()
    async def test_create_file_group_with_directory_client_async(self, datalake_storage_account_name,
                                                                 datalake_storage_account_key):
        await self._setUp(datalake_storage_account_name, datalake_storage_account_key)
        test_string = str(uuid.uuid4())
        # Arrange
        ...
        # Create a file using the directory client
        await directory_client.create_file(file='file1', group=test_string)
        file_client = directory_client.get_file_client('file1')
    ...
    @DataLakePreparer()
    async def test_create_file_acl_with_directory_client_async(self, datalake_storage_account_name,
                                                               datalake_storage_account_key):
        await self._setUp(datalake_storage_account_name, datalake_storage_account_key)
        ...
        # Create a file using the directory client
        await directory_client.create_file(file='file1', acl=test_string)
        file_client = directory_client.get_file_client('file1')
    ...
    @DataLakePreparer()
    async def test_create_file_proposed_lease_id_with_directory_client_async(self, datalake_storage_account_name,
                                                                             datalake_storage_account_key):
        await self._setUp(datalake_storage_account_name, datalake_storage_account_key)
        test_string = str(uuid.uuid4())
        test_duration = 15
        ...
        # Create a file using the directory client
        await directory_client.create_file(file='file1', lease_id=test_string, lease_duration=test_duration)
        file_client = directory_client.get_file_client('file1')
    ...
    @DataLakePreparer()
    async def test_create_directory_proposed_lease_id_with_directory_client_async(self, datalake_storage_account_name,
                                                                                  datalake_storage_account_key):
        await self._setUp(datalake_storage_account_name, datalake_storage_account_key)
        test_string = str(uuid.uuid4())
        test_duration = 15
    ...
    @DataLakePreparer()
    async def test_create_sub_directory_proposed_lease_id_with_directory_client_async(self,
    ...
    @DataLakePreparer()
    async def test_create_file_relative_expiry_with_directory_client_async(self, datalake_storage_account_name,
                                                                           datalake_storage_account_key):
        await self._setUp(datalake_storage_account_name, datalake_storage_account_key)
        ...
        # Create a file using the directory client
        await directory_client.create_file(file='file1', expiry_options="RelativeToNow", expires_on=test_expiry_time)
        file_client = directory_client.get_file_client('file1')
    ...
    @DataLakePreparer()
    async def test_create_file_absolute_expiry_with_directory_client_async(self, datalake_storage_account_name,
                                                                           datalake_storage_account_key):
        await self._setUp(datalake_storage_account_name, datalake_storage_account_key)
        ...
        # Create a file using the directory client
        await directory_client.create_file(file='file1', expiry_options="Absolute", expires_on=test_expiry_time)
        file_client = directory_client.get_file_client('file1')
