...
- Added `managed_disk_diff` parameter to the `BlobClient.get_page_ranges` API which returns the list of valid page ranges diff between a snapshot and managed disk or another snapshot.
