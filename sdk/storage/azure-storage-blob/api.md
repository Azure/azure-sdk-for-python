...
namespace azure.storage.blob
    ...
    class azure.storage.blob.AccessPolicy(_BackCompatMixin):
    ...
    class azure.storage.blob.ArrowDialect(_BackCompatMixin):
        name: Optional[str]
    ...
    class azure.storage.blob.BlobAnalyticsLogging(_BackCompatMixin):
        delete: bool = False
        read: bool = False
    ...
    class azure.storage.blob.BlobPrefix(ItemPaged[BlobProperties], DictMixin):
        command: Callable
        container: str
...
", 
    ...
    class azure.storage.blob.CorsRule(_BackCompatMixin):
        allowed_headers: str
        allowed_methods: str
        allowed_origins: str
        exposed_headers: str
    ...
    class azure.storage.blob.Metrics(_BackCompatMixin):
        enabled: bool = False
    ...
    class azure.storage.blob.RetentionPolicy(_BackCompatMixin):
        days: Optional[int]
        enabled: bool = False
    ...
    class azure.storage.blob.SignedIdentifier:
    ...
    class azure.storage.blob.StaticWebsite(_BackCompatMixin):
