...
class TestStorageBlockBlobAsync(AsyncStorageRecordedTestCase):
    ...
    @BlobPreparer()
    @recorded_by_proxy_async
    async def test_upload_blob_uds(self, **kwargs):
        storage_account_name = kwargs.pop("storage_account_name")
        variables = kwargs.pop("variables", {})
        ...
        await identity_blob.upload_blob(data)

        return variables

    @BlobPreparer()
    @recorded_by_proxy_async
    async def test_upload_blob_from_url_uds(self, **kwargs):
        storage_account_name = kwargs.pop("storage_account_name")
        variables = kwargs.pop("variables", {})
        ...
        await dst_blob.upload_blob_from_url(src_blob.url)
