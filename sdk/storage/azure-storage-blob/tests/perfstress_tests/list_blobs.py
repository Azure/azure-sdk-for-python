...
class ListBlobsTest(_ContainerTest):
    ...
    async def global_setup(self):
        ...
        pending = (asyncio.ensure_future(self.async_container_client.upload_blob("listtest" + str(i), data=b""))
    ...
    def add_arguments(parser):
        ...
        parser.add_argument('-c', '--count', nargs='?', type=int,
                            help='Number of blobs to list. Defaults to 100', default=100)
        parser.add_argument('--name-only', action='store_true',
                            help='True to use list_blob_names, False to use list_blobs. Default is False.', default=False)
