...
class StoragePageBlobTest(StorageTestCase):
    ...
    @GlobalStorageAccountPreparer()
    def test_upload_sparse_page_blob(self, resource_group, location, storage_account, storage_account_key):
        ...
        with open(FILE_PATH, 'rb') as stream:
            ...
            blob_client.upload_blob(wrapped_stream, blob_type=BlobType.PageBlob, length=7168, overwrite=True)
            if os.name == 'posix':
