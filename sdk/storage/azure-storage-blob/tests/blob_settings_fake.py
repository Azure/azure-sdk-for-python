...
STORAGE_ACCOUNT_KEY = os.getenv('STORAGE_ACCOUNT_KEY', STORAGE_ACCOUNT_FAKE_KEY)
BLOB_STORAGE_ACCOUNT_NAME = os.getenv('BLOB_STORAGE_ACCOUNT_NAME', "blobstoragename")
BLOB_STORAGE_ACCOUNT_KEY = os.getenv('BLOB_STORAGE_ACCOUNT_KEY', STORAGE_ACCOUNT_FAKE_KEY)
REMOTE_STORAGE_ACCOUNT_NAME = os.getenv('REMOTE_STORAGE_ACCOUNT_NAME', "storagename")
REMOTE_STORAGE_ACCOUNT_KEY = os.getenv('REMOTE_STORAGE_ACCOUNT_KEY', STORAGE_ACCOUNT_FAKE_KEY)
PREMIUM_STORAGE_ACCOUNT_NAME = os.getenv('PREMIUM_STORAGE_ACCOUNT_NAME', "premiumstoragename")
PREMIUM_STORAGE_ACCOUNT_KEY = os.getenv('PREMIUM_STORAGE_ACCOUNT_KEY', STORAGE_ACCOUNT_FAKE_KEY)
