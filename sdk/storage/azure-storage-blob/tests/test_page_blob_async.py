...
class StoragePageBlobTestAsync(AsyncStorageTestCase):
    ...
    async def test_get_page_managed_disk_diff(self, resource_group, location, storage_account, storage_account_key):
        ...
        # Act
        ranges1, cleared1 = await blob.get_page_ranges(managed_disk_diff=snapshot_blob1.url + '&' + sas_token1)
        ranges2, cleared2 = await blob.get_page_ranges(managed_disk_diff=snapshot_blob2.url + '&' + sas_token2)
