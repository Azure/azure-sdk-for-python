...
os.environ["SECONDARY_STORAGE_ACCOUNT_NAME"] = (
    os.environ.get("SECONDARY_STORAGE_ACCOUNT_NAME", None)
    or SECONDARY_STORAGE_ACCOUNT_NAME
)
os.environ["SECONDARY_STORAGE_ACCOUNT_KEY"] = (
    os.environ.get("SECONDARY_STORAGE_ACCOUNT_KEY", None)
    or SECONDARY_STORAGE_ACCOUNT_KEY
)
os.environ["BLOB_STORAGE_ACCOUNT_NAME"] = (
    os.environ.get("BLOB_STORAGE_ACCOUNT_NAME", None) or BLOB_STORAGE_ACCOUNT_NAME
)
os.environ["BLOB_STORAGE_ACCOUNT_KEY"] = (
    os.environ.get("BLOB_STORAGE_ACCOUNT_KEY", None) or BLOB_STORAGE_ACCOUNT_KEY
)
os.environ["VERSIONED_STORAGE_ACCOUNT_NAME"] = (
    os.environ.get("VERSIONED_STORAGE_ACCOUNT_NAME", None)
    or VERSIONED_STORAGE_ACCOUNT_NAME
)
os.environ["VERSIONED_STORAGE_ACCOUNT_KEY"] = (
    os.environ.get("VERSIONED_STORAGE_ACCOUNT_KEY", None)
    or VERSIONED_STORAGE_ACCOUNT_KEY
)
os.environ["PREMIUM_STORAGE_ACCOUNT_NAME"] = (
    os.environ.get("PREMIUM_STORAGE_ACCOUNT_NAME", None) or PREMIUM_STORAGE_ACCOUNT_NAME
)
...
os.environ["SOFT_DELETE_STORAGE_ACCOUNT_NAME"] = (
    ...
    or SOFT_DELETE_STORAGE_ACCOUNT_NAME
)
os.environ["SOFT_DELETE_STORAGE_ACCOUNT_KEY"] = (
    os.environ.get("SOFT_DELETE_STORAGE_ACCOUNT_KEY", None)
    or SOFT_DELETE_STORAGE_ACCOUNT_KEY
)
os.environ["STORAGE_RESOURCE_GROUP_NAME"] = (
    os.environ.get("STORAGE_RESOURCE_GROUP_NAME", None) or STORAGE_RESOURCE_GROUP_NAME
)
