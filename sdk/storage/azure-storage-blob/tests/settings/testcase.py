...
# license information.
# --------------------------------------------------------------------------
# pylint: disable=wildcard-import,unused-wildcard-import,used-before-assignment,unused-import
...
try:
    ...
    pass  # StringIO not needed for Python 3
...
os.environ["VERSIONED_STORAGE_ACCOUNT_NAME"] = (
    os.environ.get("VERSIONED_STORAGE_ACCOUNT_NAME", None) or VERSIONED_STORAGE_ACCOUNT_NAME
)
os.environ["VERSIONED_STORAGE_ACCOUNT_KEY"] = (
    os.environ.get("VERSIONED_STORAGE_ACCOUNT_KEY", None) or VERSIONED_STORAGE_ACCOUNT_KEY
)
...
os.environ["SOFT_DELETE_STORAGE_ACCOUNT_NAME"] = (
    os.environ.get("SOFT_DELETE_STORAGE_ACCOUNT_NAME", None) or SOFT_DELETE_STORAGE_ACCOUNT_NAME
)
