...
class TestStorageBlockBlob(StorageRecordedTestCase):
    ...
    def test_put_block_with_immutability_policy(self, **kwargs):
        ...
        put_block_list_resp = blob.commit_block_list(
            block_list,
    ...
    def test_put_block_list_invalid_block_id(self, **kwargs):
        ...
        try:
            ...
            pytest.fail("Expected HttpResponseError")
    ...
    @BlobPreparer()
    @recorded_by_proxy
    def test_create_from_bytes_blob_unicode_encoded(self, **kwargs):
        storage_account_name = kwargs.pop("storage_account_name")
        storage_account_key = kwargs.pop("storage_account_key")
    ...
    @BlobPreparer()
    @recorded_by_proxy
    def test_upload_blob_copy_source_error_and_status_code(self, **kwargs):
        storage_account_name = kwargs.pop("storage_account_name")
        storage_account_key = kwargs.pop("storage_account_key")
    ...
    @BlobPreparer()
    @recorded_by_proxy
    def test_smart_access_tier(self, **kwargs):
        storage_account_name = kwargs.pop("storage_account_name")
        storage_account_key = kwargs.pop("storage_account_key")
        ...
        blob2.set_standard_blob_tier(standard_blob_tier=StandardBlobTier.SMART)
        props = blob2.get_blob_properties()
        assert props.blob_tier == StandardBlobTier.SMART
        assert props.smart_access_tier is not None
