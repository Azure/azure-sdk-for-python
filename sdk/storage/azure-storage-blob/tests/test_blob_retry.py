...
class StorageBlobRetryTest(StorageTestCase):
    ...
    @ResourceGroupPreparer()
    @StorageAccountPreparer(name_prefix='pyacrstorage')
    def test_retry_put_block_with_non_seekable_stream(self, resource_group, location, storage_account, storage_account_key):
        if not self.is_live:
            return
    ...
    @ResourceGroupPreparer()
    @StorageAccountPreparer(name_prefix='pyacrstorage')
    def test_retry_put_block_with_non_seekable_stream_fail(self, resource_group, location, storage_account, storage_account_key):
        if not self.is_live:
            return
