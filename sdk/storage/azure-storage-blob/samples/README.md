...
* [forecasting_in_vs_code_with_blob.py](https://github.com/Azure/azure-sdk-for-python/tree/master/sdk/storage/azure-storage-blob/samples/forecasting_in_vs_code_with_blob.py) - An end-to-end sample and writeup on leveraging blobs as part of an Azure data infrastructure.
