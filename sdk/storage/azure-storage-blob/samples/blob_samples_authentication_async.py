...
class AuthSamplesAsync(object):
    ...
    async def auth_connection_string_async(self):
        ...
        _blob_service_client = BlobServiceClient.from_connection_string(self.connection_string)
    ...
    async def auth_shared_key_async(self):
        ...
        from azure.storage.blob.aio import BlobServiceClient
        _blob_service_client = BlobServiceClient(account_url=self.url, credential=self.shared_access_key)
    ...
    async def auth_default_azure_credential(self):
        ...
        _account_info = await blob_service_client.get_service_properties()
