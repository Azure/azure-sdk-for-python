...
class BlobServiceClient(StorageAccountHostsMixin, StorageEncryptionMixin):
    ...
    def find_blobs_by_tags(self, filter_expression: str, **kwargs: Any) -> ItemPaged["FilteredBlob"]:
        ...
        return ItemPaged(command, results_per_page=results_per_page, page_iterator_class=FilteredBlobPaged)
    ...
    def delete_container(
        ...
        **kwargs: Any,
        ...
        kwargs.setdefault("merge_span", True)
        timeout = kwargs.pop("timeout", None)
        container_client.delete_container(lease=lease, timeout=timeout, **kwargs)
