...
class BlobSharedAccessSignature(SharedAccessSignature):
    ...
    def generate_blob(
        ...
        **kwargs: Any
        ...
        :type permission: Optional[Union["BlobSasPermissions", str]]
        :param expiry:
        ...
        :type expiry: Optional[Union["datetime", str]]
        :param start:
            ...
            be UTC.
        :type start: Optional[Union["datetime", str]]
...
def generate_account_sas(
    ...
    **kwargs: Any
    ...
    :type resource_types: Union[ResourceTypes, str]
    :param permission:
        The permissions associated with the shared access signature. The
        user is restricted to operations allowed by the permissions.
    :type permission: Union[AccountSasPermissions, str]
    :param expiry:
        The time at which the shared access signature becomes invalid.
...
def generate_container_sas(
    ...
    **kwargs: Any
    ...
    :type user_delegation_key: Optional[~azure.storage.blob.UserDelegationKey]
    :param permission:
        The permissions associated with the shared access signature. The
        user is restricted to operations allowed by the permissions.
        Permissions must be ordered racwdxyltfmei.
        ...
        which contains this field. This field must be omitted if it has been
        specified in an associated stored access policy.
    :type permission: Optional[Union[~azure.storage.blob.ContainerSasPermissions, str]]
    :param expiry:
        The time at which the shared access signature becomes invalid.
        Required unless an id is given referencing a stored access policy
        which contains this field. This field must be omitted if it has
...
def generate_blob_sas(
    ...
    **kwargs: Any
    ...
    :param permission:
        ...
        which contains this field. This field must be omitted if it has been
        specified in an associated stored access policy.
    :type permission: Optional[Union[str, ~azure.storage.blob.BlobSasPermissions]]
    :param expiry:
        The time at which the shared access signature becomes invalid.
        Required unless an id is given referencing a stored access policy
        which contains this field. This field must be omitted if it has
