...
class ArrowConfiguration(_Model):
    ...
    :vartype schema: ~azure.storage.blob._generated.models.ArrowField
    """
...
class BlobItemInternal(_Model):
    ...
    :vartype metadata: ~azure.storage.blob._generated.models.BlobMetadata
    :ivar blob_tags: The tags of the blob.
    :vartype blob_tags: ~azure.storage.blob._generated.models.BlobTags
    :ivar object_replication_metadata: The object replication metadata of the blob.
    :vartype object_replication_metadata:
     ~azure.storage.blob._generated.models.ObjectReplicationMetadata
...
class BlockList(_Model):
    ...
    :vartype committed_blocks: ~azure.storage.blob._generated.models.Block
    :ivar uncommitted_blocks: The list of uncommitted blocks.
    :vartype uncommitted_blocks: ~azure.storage.blob._generated.models.Block
    """
...
class ContainerItem(_Model):
    ...
    :vartype properties: ~azure.storage.blob._generated.models.ContainerProperties
...
class Logging(_Model):
    ...
    :vartype retention_policy: ~azure.storage.blob._generated.models.RetentionPolicy
    """
...
class QueryFormat(_Model):
    ...
    :vartype json_text_configuration: ~azure.storage.blob._generated.models.JsonTextConfiguration
    :ivar arrow_configuration: The Apache Arrow configuration.
    :vartype arrow_configuration: ~azure.storage.blob._generated.models.ArrowConfiguration
    :ivar parquet_text_configuration: The Parquet configuration.
    :vartype parquet_text_configuration: ~azure.storage.blob._generated.models.ParquetConfiguration
    """
...
class QueryRequest(_Model):
    ...
    :vartype output_serialization: ~azure.storage.blob._generated.models.QuerySerialization
    """
...
class QuerySerialization(_Model):
    ...
    :vartype format: ~azure.storage.blob._generated.models.QueryFormat
    """
...
class SignedIdentifier(_Model):
    ...
    :vartype access_policy: ~azure.storage.blob._generated.models.AccessPolicy
    """
...
class StorageServiceProperties(_Model):
    ...
    :vartype hour_metrics: ~azure.storage.blob._generated.models.Metrics
    :ivar minute_metrics: The minute metrics properties.
    :vartype minute_metrics: ~azure.storage.blob._generated.models.Metrics
    :ivar cors: The CORS properties.
    :vartype cors: ~azure.storage.blob._generated.models.CorsRule
    ...
    :vartype delete_retention_policy: ~azure.storage.blob._generated.models.RetentionPolicy
    :ivar static_website: The static website properties.
    :vartype static_website: ~azure.storage.blob._generated.models.StaticWebsite
    """
