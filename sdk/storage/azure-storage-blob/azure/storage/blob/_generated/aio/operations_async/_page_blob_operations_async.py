...
class PageBlobOperations:
    ...
    async def create(
        ...
        tier: Optional[Union[str, "models.PremiumPageBlobAccessTier"]] = None,
        metadata: Optional[str] = None,
        encryption_algorithm: Optional[str] = "AES256",
        blob_sequence_number: Optional[int] = 0,
        request_id_parameter: Optional[str] = None,
        blob_http_headers: Optional["models.BlobHTTPHeaders"] = None,
        lease_access_conditions: Optional["models.LeaseAccessConditions"] = None,
        cpk_info: Optional["models.CpkInfo"] = None,
        cpk_scope_info: Optional["models.CpkScopeInfo"] = None,
    ...
    async def upload_pages(
        ...
        cpk_info: Optional["models.CpkInfo"] = None,
        cpk_scope_info: Optional["models.CpkScopeInfo"] = None,
        sequence_number_access_conditions: Optional["models.SequenceNumberAccessConditions"] = None,
        modified_access_conditions: Optional["models.ModifiedAccessConditions"] = None,
        **kwargs
    ) -> None:
    ...
    async def get_page_ranges(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PageList"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    async def update_sequence_number(
        self,
        sequence_number_action: Union[str, "models.SequenceNumberActionType"],
        timeout: Optional[int] = None,
        blob_sequence_number: Optional[int] = 0,
        request_id_parameter: Optional[str] = None,
        lease_access_conditions: Optional["models.LeaseAccessConditions"] = None,
