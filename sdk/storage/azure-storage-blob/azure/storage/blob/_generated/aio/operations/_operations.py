...
from ...operations._operations import (
    ...
    build_container_create_session_request,
    ...
    build_container_list_blob_flat_segment_apache_arrow_request,
    build_container_list_blob_flat_segment_request,
    build_container_list_blob_hierarchy_segment_apache_arrow_request,
...
class ServiceOperations:  # pylint: disable=docstring-missing-param
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: BlobClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    async def get_user_delegation_key(
        ...
        :rtype: ~azure.storage.blob._generated.models.UserDelegationKey
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def submit_batch(
        ...
        :rtype: ~azure.storage.blob._generated.models.SubmitBatchRequest
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
...
class ContainerOperations:  # pylint: disable=docstring-missing-param,too-many-public-methods
    ...
    async def get_access_policy(
        ...
        :rtype: ~azure.storage.blob._generated.models.SignedIdentifiers
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_blob_flat_segment(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.storage.blob._generated.models.ListBlobsResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def list_blob_flat_segment_apache_arrow(
        self,
        *,
        prefix: Optional[str] = None,
        marker: Optional[str] = None,
    ...
    async def list_blob_hierarchy_segment_apache_arrow(
        self,
        *,
        delimiter: str,
        prefix: Optional[str] = None,
...
class BlobOperations:  # pylint: disable=docstring-missing-param,too-many-public-methods
    ...
    async def get_layout(  # pylint: disable=too-many-locals
        self,
        *,
        snapshot: Optional[str] = None,
        version_id: Optional[str] = None,
...
class PageBlobOperations:  # pylint: disable=docstring-missing-param
    ...
    async def get_page_ranges(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.storage.blob._generated.models.PageList
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
