...
class ContainerOperations:
    ...
    async def create(
        ...
        access: Optional[Union[str, "models.PublicAccessType"]] = None,
        request_id_parameter: Optional[str] = None,
        container_cpk_scope_info: Optional["models.ContainerCpkScopeInfo"] = None,
        **kwargs
    ) -> None:
    ...
    async def get_properties(
        ...
        timeout: Optional[int] = None,
        request_id_parameter: Optional[str] = None,
        lease_access_conditions: Optional["models.LeaseAccessConditions"] = None,
        **kwargs
    ) -> None:
    ...
    async def delete(
        ...
        request_id_parameter: Optional[str] = None,
        lease_access_conditions: Optional["models.LeaseAccessConditions"] = None,
        modified_access_conditions: Optional["models.ModifiedAccessConditions"] = None,
        **kwargs
    ) -> None:
    ...
    async def set_access_policy(
        ...
        access: Optional[Union[str, "models.PublicAccessType"]] = None,
        request_id_parameter: Optional[str] = None,
        container_acl: Optional[List["SignedIdentifier"]] = None,
        lease_access_conditions: Optional["models.LeaseAccessConditions"] = None,
        modified_access_conditions: Optional["models.ModifiedAccessConditions"] = None,
        **kwargs
    ) -> None:
    ...
    async def list_blob_flat_segment(
        ...
        include: Optional[List[Union[str, "ListBlobsIncludeItem"]]] = None,
        timeout: Optional[int] = None,
        request_id_parameter: Optional[str] = None,
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ListBlobsFlatSegmentResponse"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
        restype = "container"
        comp = "list"
    ...
    async def list_blob_hierarchy_segment(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ListBlobsHierarchySegmentResponse"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
        restype = "container"
        comp = "list"
