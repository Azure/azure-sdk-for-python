...
class AppendBlobOperations:
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :keyword blob_type: Specifies the type of blob to create: block blob, page blob, or append
         blob. The default value is "AppendBlob". Note that overriding this default value may result in
    ...
    async def append_block(
        ...
        **kwargs: Any
        ...
        :param modified_access_conditions: Parameter group.
        :type modified_access_conditions: ~azure.storage.blob.models.ModifiedAccessConditions
        :keyword comp: comp. The default value is "appendblock". Note that overriding this default
    ...
    async def seal(
        ...
        **kwargs: Any
        ...
        :type append_position_access_conditions:
         ~azure.storage.blob.models.AppendPositionAccessConditions
        :keyword comp: comp. The default value is "seal". Note that overriding this default value may
