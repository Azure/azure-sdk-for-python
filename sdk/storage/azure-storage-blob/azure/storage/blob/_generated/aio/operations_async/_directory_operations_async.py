...
class DirectoryOperations:
    ...
    async def create(
        ...
        directory_http_headers: Optional["models.DirectoryHttpHeaders"] = None,
        ...
        **kwargs
        ...
        if response.status_code not in [201]:
            ...
            error = self._deserialize(models.DataLakeStorageError, response)
    ...
    async def rename(
        ...
        path_rename_mode: Optional[Union[str, "models.PathRenameMode"]] = None,
        directory_properties: Optional[str] = None,
        posix_permissions: Optional[str] = None,
        posix_umask: Optional[str] = None,
        ...
        lease_access_conditions: Optional["models.LeaseAccessConditions"] = None,
        modified_access_conditions: Optional["models.ModifiedAccessConditions"] = None,
        source_modified_access_conditions: Optional["models.SourceModifiedAccessConditions"] = None,
        **kwargs
    ) -> None:
        ...
        :param source_lease_id: A lease ID for the source path. If specified, the source path must have
         an active lease and the leaase ID must match.
