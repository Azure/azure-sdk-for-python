...
class BlobClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype service: azure.storage.blobs.operations.ServiceOperations
    ...
    :vartype blob: azure.storage.blobs.operations.BlobOperations
    :ivar append_blob: AppendBlobOperations operations
    :vartype append_blob: azure.storage.blobs.operations.AppendBlobOperations
    :ivar block_blob: BlockBlobOperations operations
    :vartype block_blob: azure.storage.blobs.operations.BlockBlobOperations
    :ivar page_blob: PageBlobOperations operations
    :vartype page_blob: azure.storage.blobs.operations.PageBlobOperations
