...
class BlobClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype service: azure.storage.blobs.aio.operations.ServiceOperations
    ...
    :vartype blob: azure.storage.blobs.aio.operations.BlobOperations
    :ivar append_blob: AppendBlobOperations operations
    :vartype append_blob: azure.storage.blobs.aio.operations.AppendBlobOperations
    :ivar block_blob: BlockBlobOperations operations
    :vartype block_blob: azure.storage.blobs.aio.operations.BlockBlobOperations
    :ivar page_blob: PageBlobOperations operations
    :vartype page_blob: azure.storage.blobs.aio.operations.PageBlobOperations
