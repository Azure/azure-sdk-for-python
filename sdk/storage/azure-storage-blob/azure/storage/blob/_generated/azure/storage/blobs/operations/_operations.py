...
def build_service_get_account_info_request(*, timeout: Optional[int] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_container_get_properties_request(
    *, timeout: Optional[int] = None, lease_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_container_restore_request(
    *,
...
def build_container_rename_request(
    *, source_container_name: str, source_lease_id: Optional[str] = None, timeout: Optional[int] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_blob_undelete_request(*, timeout: Optional[int] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_blob_set_expiry_request(
    ...
    **kwargs: Any
    ...
    if expires_on is not None:
        _headers["x-ms-expiry-time"] = _SERIALIZER.header("expires_on", expires_on, "rfc-1123")
...
def build_blob_delete_immutability_policy_request(  # pylint: disable=name-too-long
    *, timeout: Optional[int] = None, snapshot: Optional[str] = None, version_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_blob_start_copy_from_url_request(  # pylint: disable=too-many-locals
    *,
    copy_source: str,
    timeout: Optional[int] = None,
    metadata: Optional[dict[str, str]] = None,
...
def build_blob_copy_from_url_request(  # pylint: disable=too-many-locals
    *,
    copy_source: str,
    timeout: Optional[int] = None,
    metadata: Optional[dict[str, str]] = None,
    ...
    **kwargs: Any
    ...
    _headers["x-ms-requires-sync"] = _SERIALIZER.header("requires_sync", requires_sync, "str")
    if_match = prep_if_match(etag, match_condition)
    if if_match is not None:
        _headers["If-Match"] = _SERIALIZER.header("if_match", if_match, "str")
    if_none_match = prep_if_none_match(etag, match_condition)
...
def build_blob_abort_copy_from_url_request(
    *, copy_id: str, timeout: Optional[int] = None, lease_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_blob_get_account_info_request(*, timeout: Optional[int] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_append_blob_append_block_request(  # pylint: disable=too-many-locals
    *,
    content_length: int,
    timeout: Optional[int] = None,
    transactional_content_md5: Optional[bytes] = None,
...
def build_append_blob_append_block_from_url_request(  # pylint: disable=name-too-long,too-many-locals,too-many-statements,too-many-branches
    *,
    source_url: str,
    content_length: int,
...
def build_block_blob_commit_block_list_request(  # pylint: disable=name-too-long,too-many-locals
    *,
    timeout: Optional[int] = None,
    blob_cache_control: Optional[str] = None,
    blob_content_type: Optional[str] = None,
...
def build_block_blob_query_request(
    *,
    snapshot: Optional[str] = None,
    timeout: Optional[int] = None,
    lease_id: Optional[str] = None,
...
def build_page_blob_create_request(  # pylint: disable=too-many-locals
    ...
    **kwargs: Any
    ...
    if if_tags is not None:
        _headers["x-ms-if-tags"] = _SERIALIZER.header("if_tags", if_tags, "str")
    _headers["x-ms-blob-content-length"] = _SERIALIZER.header("size", size, "int")
...
def build_page_blob_upload_pages_request(  # pylint: disable=too-many-locals
    *,
    content_length: int,
    range: str,
    transactional_content_md5: Optional[bytes] = None,
...
def build_page_blob_upload_pages_from_url_request(  # pylint: disable=name-too-long,too-many-locals
    *,
    source_url: str,
    source_range: str,
    content_length: int,
...
class ServiceOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.storage.blobs.BlobClient`'s
    ...
    @distributed_trace
    def get_statistics(self, *, timeout: Optional[int] = None, **kwargs: Any) -> _models.StorageServiceStats:
...
class BlobOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def get_properties(  # pylint: disable=too-many-locals
        self,
        *,
        snapshot: Optional[str] = None,
        version_id: Optional[str] = None,
    ...
    @distributed_trace
    def set_metadata(  # pylint: disable=inconsistent-return-statements,too-many-locals
        self,
        *,
        timeout: Optional[int] = None,
        metadata: Optional[dict[str, str]] = None,
    ...
    @distributed_trace
    def create_snapshot(  # pylint: disable=inconsistent-return-statements,too-many-locals
        self,
        *,
        timeout: Optional[int] = None,
        metadata: Optional[dict[str, str]] = None,
...
class PageBlobOperations:
    ...
    @distributed_trace
    def clear_pages(  # pylint: disable=inconsistent-return-statements,too-many-locals
        self,
        *,
        range: str,
        timeout: Optional[int] = None,
    ...
    @distributed_trace
    def get_page_ranges(  # pylint: disable=too-many-locals
        self,
        *,
        snapshot: Optional[str] = None,
        timeout: Optional[int] = None,
    ...
    @distributed_trace
    def get_page_ranges_diff(  # pylint: disable=too-many-locals
        self,
        *,
        snapshot: Optional[str] = None,
        timeout: Optional[int] = None,
    ...
    @distributed_trace
    def resize(  # pylint: disable=inconsistent-return-statements,too-many-locals
        self,
        *,
        size: int,
        timeout: Optional[int] = None,
