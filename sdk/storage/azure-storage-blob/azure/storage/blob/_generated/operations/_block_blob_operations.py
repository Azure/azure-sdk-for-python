...
class BlockBlobOperations(object):
    ...
    def upload(
        ...
        tier=None,  # type: Optional[Union[str, "models.AccessTierOptional"]]
    ...
    def commit_block_list(
        self,
        blocks,  # type: "models.BlockLookupList"
        timeout=None,  # type: Optional[int]
        transactional_content_md5=None,  # type: Optional[bytearray]
        transactional_content_crc64=None,  # type: Optional[bytearray]
        metadata=None,  # type: Optional[str]
    ...
    def get_block_list(
        ...
        list_type="committed",  # type: Union[str, "models.BlockListType"]
        timeout=None,  # type: Optional[int]
        request_id_parameter=None,  # type: Optional[str]
        lease_access_conditions=None,  # type: Optional["models.LeaseAccessConditions"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.BlockList"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.BlockList"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
