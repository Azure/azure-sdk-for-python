...
class PageBlobOperations(object):
    ...
    def create(
        ...
        tier=None,  # type: Optional[Union[str, "models.PremiumPageBlobAccessTier"]]
    ...
    def upload_pages(
        ...
        cpk_info=None,  # type: Optional["models.CpkInfo"]
        cpk_scope_info=None,  # type: Optional["models.CpkScopeInfo"]
        sequence_number_access_conditions=None,  # type: Optional["models.SequenceNumberAccessConditions"]
        modified_access_conditions=None,  # type: Optional["models.ModifiedAccessConditions"]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
    ...
    def update_sequence_number(
        self,
        sequence_number_action,  # type: Union[str, "models.SequenceNumberActionType"]
        timeout=None,  # type: Optional[int]
        blob_sequence_number=0,  # type: Optional[int]
        request_id_parameter=None,  # type: Optional[str]
        lease_access_conditions=None,  # type: Optional["models.LeaseAccessConditions"]
