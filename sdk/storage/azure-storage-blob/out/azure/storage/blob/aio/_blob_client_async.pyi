...
class BlobClient(AsyncStorageAccountHostsMixin, BlobClientBase):
    ...
    async def get_managed_disk_page_range_diff(self, offset: Optional[int]=..., length: Optional[int]=..., prev_snapshot_url: Optional[int]=..., **kwargs: Any) -> Tuple[List[Dict[str, int]], List[Dict[str, int]]]: ...
