...
class BlobOperations:
    ...
    def set_metadata(self, timeout: Optional[Any] = ..., metadata: Optional[Any] = ..., request_id: Optional[Any] = ..., lease_access_conditions: Optional[Any] = ..., cpk_info: Optional[Any] = ..., cpk_scope_info: Optional[Any] = ..., modified_access_conditions: Optional[Any] = ..., cls: Optional[Any] = ..., **kwargs: Any): ...
    ...
    def create_snapshot(self, timeout: Optional[Any] = ..., metadata: Optional[Any] = ..., request_id: Optional[Any] = ..., cpk_info: Optional[Any] = ..., cpk_scope_info: Optional[Any] = ..., modified_access_conditions: Optional[Any] = ..., lease_access_conditions: Optional[Any] = ..., cls: Optional[Any] = ..., **kwargs: Any): ...
    ...
    def copy_from_url(self, copy_source: Any, timeout: Optional[Any] = ..., metadata: Optional[Any] = ..., tier: Optional[Any] = ..., request_id: Optional[Any] = ..., source_content_md5: Optional[Any] = ..., source_modified_access_conditions: Optional[Any] = ..., modified_access_conditions: Optional[Any] = ..., lease_access_conditions: Optional[Any] = ..., cls: Optional[Any] = ..., **kwargs: Any): ...
