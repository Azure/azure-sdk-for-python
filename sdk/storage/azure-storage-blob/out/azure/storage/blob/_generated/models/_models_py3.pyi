...
class ContainerProperties(Model):
    ...
    has_legal_hold: Any = ...
    def __init__(self, last_modified: Any, etag: str, *, lease_status: Any=..., lease_state: Any=..., lease_duration: Any=..., public_access: Any=..., has_immutability_policy: bool=..., has_legal_hold: bool=..., **kwargs: Any) -> None: ...
