...
from ._models import ContentSettings, CopyFileSmbInfo, FileProperties, Handle, HandlesPaged, NTFSAttributes, ShareProperties
from ._parser import _datetime_to_str, _get_file_permission
from ._serialize import get_access_conditions, get_source_conditions, validate_copy_mode
...
class ShareFileClient(StorageAccountHostsMixin):
    ...
    def start_copy_from_url(self, source_url: str, file_permission_copy_mode: Optional[str]=..., file_permission: Optional[str]=..., file_permission_key: Optional[str]=..., copy_file_smb_info: Any=..., **kwargs: Any) -> Any: ...
