# Stubs for azure.storage.fileshare._shared.request_handlers (Python 3)
#
...
def throw_exception_if_contains_header(request_headers: Any, header: Any, operation_name: Any, request_version: Any) -> None: ...
