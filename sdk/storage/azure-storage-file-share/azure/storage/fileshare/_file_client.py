...
from typing import Any, AnyStr, Callable, cast, Dict, IO, Iterable, List, Literal, Optional, Tuple, Union, TYPE_CHECKING
...
class ShareFileClient(StorageAccountHostsMixin):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._query_str, credential = self._format_query_string(sas_token, credential, share_snapshot=self.snapshot)
    ...
    def rename_file(self, new_name: str, **kwargs: Any) -> "ShareFileClient":
        ...
        new_file_client = ShareFileClient(
            ...
            self.share_name,
            new_file_path,
            credential=new_file_sas or self.credential,
    ...
    def set_http_headers(
        ...
        **kwargs: Any,
        ...
        try:
            return cast(
                Dict[str, Any],
                self._client.file.set_http_headers(
    ...
    def set_file_metadata(self, metadata: Optional[Dict[str, Any]] = None, **kwargs: Any) -> Dict[str, Any]:
        ...
        try:
            return cast(
                Dict[str, Any],
                self._client.file.set_metadata(
                    timeout=timeout,
                    cls=return_response_headers,
                    headers=headers,
                    metadata=metadata,
    ...
    def close_all_handles(self, **kwargs: Any) -> Dict[str, int]:
        ...
        return {"closed_handles_count": total_closed, "failed_handles_count": total_failed}
    ...
    def create_symlink(
        ...
        **kwargs: Any,
        ...
        try:
            return cast(
                Dict[str, Any],
                self._client.file.create_symbolic_link(
                    link_text=target,
                    metadata=metadata,
                    file_creation_time=file_creation_time,
                    file_last_write_time=file_last_write_time,
