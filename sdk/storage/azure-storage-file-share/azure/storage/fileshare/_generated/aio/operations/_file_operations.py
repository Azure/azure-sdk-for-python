...
class FileOperations:
    ...
    async def create(
        ...
        file_http_headers: Optional["models.FileHTTPHeaders"] = None,
    ...
    async def upload_range(
        ...
        optionalbody: IO,
        timeout: Optional[int] = None,
        file_range_write: Union[str, "models.FileRangeWriteType"] = "update",
    ...
    async def get_range_list(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ShareFileRangeList"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def start_copy(
        ...
        file_permission: Optional[str] = "inherit",
        file_permission_key: Optional[str] = None,
        copy_file_smb_info: Optional["models.CopyFileSmbInfo"] = None,
        lease_access_conditions: Optional["models.LeaseAccessConditions"] = None,
        **kwargs
    ) -> None:
