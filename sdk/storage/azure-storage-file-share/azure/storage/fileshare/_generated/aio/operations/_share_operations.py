...
class ShareOperations:
    ...
    async def delete(
        ...
        sharesnapshot: Optional[str] = None,
        timeout: Optional[int] = None,
        delete_snapshots: Optional[str] = "include",
        lease_access_conditions: Optional["models.LeaseAccessConditions"] = None,
        **kwargs
    ) -> None:
    ...
    async def get_permission(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SharePermission"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    async def set_quota(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.set_quota.metadata['url']  # type: ignore
        path_format_arguments = {
            'url': self._serialize.url("self._config.url", self._config.url, 'str', skip_quote=True),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    set_quota.metadata = {'url': '/{shareName}'}  # type: ignore
    ...
    async def set_access_policy(
        self,
        timeout: Optional[int] = None,
        share_acl: Optional[List["models.SignedIdentifier"]] = None,
        lease_access_conditions: Optional["models.LeaseAccessConditions"] = None,
        **kwargs
    ) -> None:
    ...
    async def get_statistics(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ShareStats"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
