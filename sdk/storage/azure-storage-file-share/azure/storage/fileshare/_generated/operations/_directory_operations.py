...
def build_list_files_and_directories_segment_request(
    ...
    **kwargs  # type: Any
    ...
    timeout = kwargs.pop('timeout', _params.pop('timeout', None))  # type: Optional[int]
    include = kwargs.pop('include', _params.pop('include', None))  # type: Optional[List[Union[str, "_models.ListFilesIncludeType"]]]
    include_extended_info = kwargs.pop('include_extended_info', _headers.pop('x-ms-file-extended-info', None))  # type: Optional[bool]
    accept = _headers.pop('Accept', "application/xml")
...
def build_list_handles_request(
    ...
    **kwargs  # type: Any
    ...
    timeout = kwargs.pop('timeout', _params.pop('timeout', None))  # type: Optional[int]
    sharesnapshot = kwargs.pop('sharesnapshot', _params.pop('sharesnapshot', None))  # type: Optional[str]
    recursive = kwargs.pop('recursive', _headers.pop('x-ms-recursive', None))  # type: Optional[bool]
    accept = _headers.pop('Accept', "application/xml")
