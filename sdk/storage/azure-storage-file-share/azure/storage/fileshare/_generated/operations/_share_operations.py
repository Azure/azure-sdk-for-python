...
def build_create_request(
    ...
    **kwargs  # type: Any
    ...
    quota = kwargs.pop('quota', _headers.pop('x-ms-share-quota', None))  # type: Optional[int]
    access_tier = kwargs.pop('access_tier', _headers.pop('x-ms-access-tier', None))  # type: Optional[Union[str, "_models.ShareAccessTier"]]
    enabled_protocols = kwargs.pop('enabled_protocols', _headers.pop('x-ms-enabled-protocols', None))  # type: Optional[str]
    root_squash = kwargs.pop('root_squash', _headers.pop('x-ms-root-squash', None))  # type: Optional[Union[str, "_models.ShareRootSquash"]]
...
def build_delete_request(
    ...
    **kwargs  # type: Any
    ...
    sharesnapshot = kwargs.pop('sharesnapshot', _params.pop('sharesnapshot', None))  # type: Optional[str]
    timeout = kwargs.pop('timeout', _params.pop('timeout', None))  # type: Optional[int]
    delete_snapshots = kwargs.pop('delete_snapshots', _headers.pop('x-ms-delete-snapshots', None))  # type: Optional[Union[str, "_models.DeleteSnapshotsOptionType"]]
    lease_id = kwargs.pop('lease_id', _headers.pop('x-ms-lease-id', None))  # type: Optional[str]
    accept = _headers.pop('Accept', "application/xml")
...
def build_restore_request(
    ...
    **kwargs  # type: Any
    ...
    timeout = kwargs.pop('timeout', _params.pop('timeout', None))  # type: Optional[int]
    request_id_parameter = kwargs.pop('request_id_parameter', _headers.pop('x-ms-client-request-id', None))  # type: Optional[str]
    deleted_share_name = kwargs.pop('deleted_share_name', _headers.pop('x-ms-deleted-share-name', None))  # type: Optional[str]
    deleted_share_version = kwargs.pop('deleted_share_version', _headers.pop('x-ms-deleted-share-version', None))  # type: Optional[str]
    accept = _headers.pop('Accept', "application/xml")
    ...
    if deleted_share_version is not None:
        _headers['x-ms-deleted-share-version'] = _SERIALIZER.header("deleted_share_version", deleted_share_version, 'str')
    _headers['Accept'] = _SERIALIZER.header("accept", accept, 'str')
...
class ShareOperations(object):
    ...
    def create_permission(  # pylint: disable=inconsistent-return-statements
        self,
        share_permission,  # type: Union[_models.SharePermission, IO]
        timeout=None,  # type: Optional[int]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
