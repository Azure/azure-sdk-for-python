...
class ListSharesResponse(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        'marker': {'key': 'Marker', 'type': 'str'},
        'max_results': {'key': 'MaxResults', 'type': 'int'},
        'share_items': {'key': 'ShareItems', 'type': '[ShareItem]', 'xml': {'name': 'Shares', 'wrapped': True, 'itemsName': 'Share'}},
        'next_marker': {'key': 'NextMarker', 'type': 'str'},
    }
    _xml_map = {
        'name': 'EnumerationResults'
    ...
    def __init__(
        ...
        *,
        ...
        marker: Optional[str] = None,
        max_results: Optional[int] = None,
        share_items: Optional[List["ShareItem"]] = None,
        **kwargs
    ):
...
class ShareItem(msrest.serialization.Model):
