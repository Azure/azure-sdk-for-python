...
def _parse_datetime(value):
    ...
    if isinstance(value, _datetime_module.datetime):
        return value
    try:
        return Deserializer.deserialize_rfc(value)
...
class ShareProperties(DictMixin):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.last_modified = _parse_datetime(kwargs.get("Last-Modified"))  # type: ignore [assignment]
...
class DirectoryProperties(DictMixin):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.metadata = kwargs.get("metadata")  # type: ignore [assignment]
        self.change_time = (
            _parse_datetime(kwargs.get("x-ms-file-change-time"))
            if (kwargs.get("x-ms-file-change-time") is not None)
            else None
        )
        self.creation_time = (
            _parse_datetime(kwargs.get("x-ms-file-creation-time"))
            if (kwargs.get("x-ms-file-creation-time") is not None)
            else None
        )
        self.last_write_time = (
            _parse_datetime(kwargs.get("x-ms-file-last-write-time"))
