...
class Handle(DictMixin):
    ...
    def _from_generated(cls, generated):
        ...
        handle.path = urllib.parse.unquote(generated.path.content) if generated.path.encoded else generated.path.content
...
class DirectoryProperties(DictMixin):
    ...
    def _from_generated(cls, generated):
        props = cls()
        props.name = urllib.parse.unquote(generated.name.content) if generated.name.encoded else generated.name.content
