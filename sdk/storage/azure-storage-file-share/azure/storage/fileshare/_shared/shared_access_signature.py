...
class SharedAccessSignature(object):
    ...
    def generate_account(
        self, services, resource_types, permission, expiry, start=None, ip=None, protocol=None, sts_hook=None
    ) -> str:
        """
...
class _SharedAccessHelper(object):
    ...
    def add_account_signature(self, account_name, account_key):
        ...
        self._add_query(QueryStringConstants.SIGNED_SIGNATURE, sign_string(account_key, self.string_to_sign))
