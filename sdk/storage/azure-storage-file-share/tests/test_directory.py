...
class TestStorageDirectory(StorageRecordedTestCase):
    ...
    def test_rename_directory_file_permission(self, **kwargs):
        ...
        # Act
        new_directory = source_directory.rename_directory('dir2', file_permission=TEST_FILE_PERMISSIONS_IN_SDDL)
    ...
    def test_rename_directory_preserve_permission(self, **kwargs):
        ...
        source_directory = share_client.create_directory('dir1', file_permission=TEST_FILE_PERMISSIONS_IN_SDDL)
