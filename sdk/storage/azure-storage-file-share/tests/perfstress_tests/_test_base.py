...
class _ServiceTest(PerfStressTest):
    ...
    def __init__(self, arguments):
        ...
        self.service_client = SyncShareServiceClient.from_connection_string(conn_str=connection_string, **kwargs)
        self.async_service_client = AsyncShareServiceClient.from_connection_string(conn_str=connection_string, **kwargs)
