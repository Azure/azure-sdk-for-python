...
### Other Changes
  ...
  - Deleted model `ResourceSkusResult`/`StorageTargetsResult`/`UsageModelsResult`/`UserAssignedIdentitiesValueAutoGenerated` which actually were not used by SDK users
