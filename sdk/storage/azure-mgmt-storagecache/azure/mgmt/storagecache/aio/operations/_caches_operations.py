...
class CachesOperations:  # pylint: disable=too-many-public-methods
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storagecache.models.CachesListResult]
    ...
    @distributed_trace_async
    async def begin_debug_info(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        cache_name: str,
        **kwargs: Any
    ...
    @distributed_trace_async
    async def begin_start_priming_job(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        cache_name: str,
        primingjob: Optional["_models.PrimingJob"] = None,
    ...
    @distributed_trace_async
    async def begin_stop_priming_job(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        cache_name: str,
        priming_job_id: Optional["_models.PrimingJobIdParameter"] = None,
    ...
    @distributed_trace_async
    async def begin_pause_priming_job(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        cache_name: str,
        priming_job_id: Optional["_models.PrimingJobIdParameter"] = None,
    ...
    @distributed_trace_async
    async def begin_resume_priming_job(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        cache_name: str,
        priming_job_id: Optional["_models.PrimingJobIdParameter"] = None,
    ...
    @distributed_trace_async
    async def begin_upgrade_firmware(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        cache_name: str,
        **kwargs: Any
    ...
    @distributed_trace_async
    async def begin_space_allocation(  # pylint: disable=inconsistent-return-statements
        self,
        resource_group_name: str,
        cache_name: str,
        space_allocation: Optional[List["_models.StorageTargetSpaceAllocation"]] = None,
