...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.StorageCache/locations/{location}/usages")  # pylint: disable=line-too-long
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either ResourceUsagesListResult or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.storagecache.models.ResourceUsagesListResult]
