...
class StorageTargetsOperations(object):
    ...
    def list_by_cache(
        ...
        :rtype:
         ~azure.mgmt.storagecache.models.StorageTargetPaged[~azure.mgmt.storagecache.models.StorageTarget]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
                # Construct URL
                url = self.list_by_cache.metadata['url']
        ...
        if raw:
            header_dict = {}
        deserialized = models.StorageTargetPaged(internal_paging, self._deserialize.dependencies, header_dict)

        return deserialized
    list_by_cache.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StorageCache/caches/{cacheName}/storageTargets'}
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StorageCache/caches/{cacheName}/storageTargets/{storageTargetName}'}
    ...
    def create(
        ...
        :param polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of LROPoller that returns StorageTarget or
         ClientRawResponse<StorageTarget> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.storagecache.models.StorageTarget]
         or
