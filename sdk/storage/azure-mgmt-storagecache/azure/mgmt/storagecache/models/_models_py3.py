...
class AmlFilesystem(TrackedResource):
    ...
    :ivar current_storage_capacity_tib: The current storage capacity of the AML file system, in
     TiB. This reflects the actual capacity including any expansions.
    :vartype current_storage_capacity_tib: float
    ...
    _validation = {
        ...
        "system_data": {"readonly": True},
        "location": {"required": True},
        "current_storage_capacity_tib": {"readonly": True},
    ...
    _attribute_map = {
        ...
        "current_storage_capacity_tib": {"key": "properties.currentStorageCapacityTiB", "type": "float"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.current_storage_capacity_tib: Optional[float] = None
