...
from azure.storage.queue._shared.request_handlers import (
    validate_and_format_range_headers,
)
from azure.storage.queue._shared.uploads import (
    BlockBlobChunkUploader,
    _remove_parallel_access_conditions,
    _update_append_position,
    _update_etag,
)
from azure.storage.queue._shared.uploads_async import (
