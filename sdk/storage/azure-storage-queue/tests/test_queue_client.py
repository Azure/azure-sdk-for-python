...
class TestStorageQueueClient(StorageRecordedTestCase):  # pylint: disable=too-many-public-methods
    def setUp(self):
    ...
    def test_user_agent_custom(self, **kwargs):
        ...
        service.get_service_properties(raw_response_hook=callback_v2, user_agent="TestApp/v2.0")
    ...
    @QueuePreparer()
    def test_create_queue_client_with_complete_queue_url(self, **kwargs):
        storage_account_name = kwargs.pop("storage_account_name")
        storage_account_key = kwargs.pop("storage_account_key")
    ...
    def test_error_with_malformed_conn_str(self):
        ...
        for conn_str in [
            ...
            for service_type in SERVICES.items():
                # Act
                with pytest.raises(ValueError) as e:
                    _service = service_type[0].from_connection_string(conn_str, queue_name="test")
