# Stubs for azure.storage.queue._shared.models (Python 3)
#
...
class ResourceTypes:
    ...
    container: Any = ...
    object: Any = ...
    def __init__(self, service: bool = ..., container: bool = ..., object: bool = ..., _str: Optional[Any] = ...) -> None: ...
    def __or__(self, other: Any): ...
    def __add__(self, other: Any): ...

class AccountPermissions:
    READ: AccountPermissions = ...
    WRITE: AccountPermissions = ...
    DELETE: AccountPermissions = ...
    LIST: AccountPermissions = ...
    ADD: AccountPermissions = ...
    CREATE: AccountPermissions = ...
    UPDATE: AccountPermissions = ...
    PROCESS: AccountPermissions = ...
    read: Any = ...
    write: Any = ...
    delete: Any = ...
    list: Any = ...
    ...
    update: Any = ...
    process: Any = ...
    def __init__(self, read: bool = ..., write: bool = ..., delete: bool = ..., list: bool = ..., add: bool = ..., create: bool = ..., update: bool = ..., process: bool = ..., _str: Optional[Any] = ...) -> None: ...
    def __or__(self, other: Any): ...
    def __add__(self, other: Any): ...
...
class Services:
    ...
    queue: Any = ...
    file: Any = ...
    def __init__(self, blob: bool = ..., queue: bool = ..., file: bool = ..., _str: Optional[Any] = ...) -> None: ...
    def __or__(self, other: Any): ...
    def __add__(self, other: Any): ...
