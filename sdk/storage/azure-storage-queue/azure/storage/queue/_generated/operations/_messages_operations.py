...
def build_dequeue_request(
    ...
    **kwargs  # type: Any
    ...
    number_of_messages = kwargs.pop('number_of_messages', _params.pop('numofmessages', None))  # type: Optional[int]
    visibilitytimeout = kwargs.pop('visibilitytimeout', _params.pop('visibilitytimeout', None))  # type: Optional[int]
...
def build_enqueue_request(
    ...
    **kwargs  # type: Any
    ...
    version = kwargs.pop('version', _headers.pop('x-ms-version', "2018-03-28"))  # type: str
    visibilitytimeout = kwargs.pop('visibilitytimeout', _params.pop('visibilitytimeout', None))  # type: Optional[int]
    message_time_to_live = kwargs.pop('message_time_to_live', _params.pop('messagettl', None))  # type: Optional[int]
    timeout = kwargs.pop('timeout', _params.pop('timeout', None))  # type: Optional[int]
    request_id_parameter = kwargs.pop('request_id_parameter', _headers.pop('x-ms-client-request-id', None))  # type: Optional[str]
    accept = _headers.pop('Accept', "application/xml")
