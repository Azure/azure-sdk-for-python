...
def build_dequeue_request(
    **kwargs  # type: Any
    ...
    if number_of_messages is not None:
        query_parameters['numofmessages'] = _SERIALIZER.query("number_of_messages", number_of_messages, 'int', minimum=1)
...
def build_enqueue_request(
    **kwargs  # type: Any
    ...
    if message_time_to_live is not None:
        query_parameters['messagettl'] = _SERIALIZER.query("message_time_to_live", message_time_to_live, 'int', minimum=-1)
    if timeout is not None:
        query_parameters['timeout'] = _SERIALIZER.query("timeout", timeout, 'int', minimum=0)
...
def build_peek_request(
    **kwargs  # type: Any
    ...
    # Construct parameters
    query_parameters = kwargs.pop("params", {})  # type: Dict[str, Any]
    query_parameters['peekonly'] = _SERIALIZER.query("peekonly", peekonly, 'str')
    if number_of_messages is not None:
        query_parameters['numofmessages'] = _SERIALIZER.query("number_of_messages", number_of_messages, 'int', minimum=1)
    if timeout is not None:
        query_parameters['timeout'] = _SERIALIZER.query("timeout", timeout, 'int', minimum=0)
...
class MessagesOperations(object):
    ...
    def dequeue(
        ...
        **kwargs  # type: Any
        ...
        _url = self._client.format_url(self.dequeue.metadata['url'], **path_format_arguments)
    ...
    def clear(
        ...
        **kwargs  # type: Any
        ...
        _url = self._client.format_url(self.clear.metadata['url'], **path_format_arguments)
    ...
    def enqueue(
        ...
        **kwargs  # type: Any
        ...
        _url = self._client.format_url(self.enqueue.metadata['url'], **path_format_arguments)
    ...
    def peek(
        ...
        **kwargs  # type: Any
        ...
        _url = self._client.format_url(self.peek.metadata['url'], **path_format_arguments)
