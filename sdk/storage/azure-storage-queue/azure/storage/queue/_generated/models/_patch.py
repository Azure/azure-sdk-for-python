...
# ``is_xml_model``/``enable_additional_properties_sending``/
# ``__eq__``/``__ne__``/``__str__``. Re-adding them
...
# TODO: Can we eliminate the need for this by changing the CLI's ``todict``?
# ---------------------------------------------------------------------------
