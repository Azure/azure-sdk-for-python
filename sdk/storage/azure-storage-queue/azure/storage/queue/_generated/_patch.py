...
class QueuesClient(_QueuesClient):
    ...
    def __init__(self, url: str, credential: "TokenCredential" = None, **kwargs: Any) -> None:
        ...
        if _pipeline is not None:
            ...
            self._client: PipelineClient = PipelineClient(base_url=_endpoint, pipeline=_pipeline)
