...
class QueueServiceClient(  # type: ignore [misc]
    ...
    @distributed_trace_async
    async def create_queue(self, name: str, metadata: Optional[Dict[str, str]] = None, **kwargs: Any) -> QueueClient:
    ...
    @distributed_trace_async
    async def delete_queue(self, queue: Union["QueueProperties", str], **kwargs: Any) -> None:
