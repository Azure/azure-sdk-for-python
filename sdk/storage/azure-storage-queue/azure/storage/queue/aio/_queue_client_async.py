...
class QueueClient(  # type: ignore [misc]
    ...
    async def create_queue(self, *, metadata: Optional[Dict[str, str]] = None, **kwargs: Any) -> None:
    ...
    @distributed_trace_async
    async def set_queue_metadata(self, metadata: Optional[Dict[str, str]] = None, **kwargs: Any) -> Dict[str, Any]:
    ...
    @distributed_trace_async
    async def set_queue_access_policy(self, signed_identifiers: Dict[str, AccessPolicy], **kwargs: Any) -> None:
    ...
    async def receive_message(
        self, *, visibility_timeout: Optional[int] = None, **kwargs: Any
    ...
    @distributed_trace_async
    async def peek_messages(self, max_messages: Optional[int] = None, **kwargs: Any) -> List[QueueMessage]:
    ...
    async def delete_message(
        self, message: Union[str, QueueMessage], pop_receipt: Optional[str] = None, **kwargs: Any
    ) -> None:
