...
class QueueClient(StorageAccountHostsMixin, StorageEncryptionMixin):
    ...
    @distributed_trace
    def create_queue(self, *, metadata: Optional[Dict[str, str]] = None, **kwargs: Any) -> None:
    ...
    @distributed_trace
    def set_queue_metadata(self, metadata: Optional[Dict[str, str]] = None, **kwargs: Any) -> Dict[str, Any]:
    ...
    @distributed_trace
    def set_queue_access_policy(self, signed_identifiers: Dict[str, AccessPolicy], **kwargs: Any) -> None:
    ...
    @distributed_trace
    def receive_message(self, *, visibility_timeout: Optional[int] = None, **kwargs: Any) -> Optional[QueueMessage]:
    ...
    @distributed_trace
    def peek_messages(self, max_messages: Optional[int] = None, **kwargs: Any) -> List[QueueMessage]:
