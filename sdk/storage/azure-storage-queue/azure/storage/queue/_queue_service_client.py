...
class QueueServiceClient(StorageAccountHostsMixin, StorageEncryptionMixin):
    ...
    @distributed_trace
    def list_queues(
        self, name_starts_with: Optional[str] = None, include_metadata: Optional[bool] = False, **kwargs: Any
    ...
    @distributed_trace
    def create_queue(self, name: str, metadata: Optional[Dict[str, str]] = None, **kwargs: Any) -> QueueClient:
    ...
    @distributed_trace
    def delete_queue(self, queue: Union["QueueProperties", str], **kwargs: Any) -> None:
