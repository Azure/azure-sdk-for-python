# Stubs for azure.storage.file._shared.uploads_async (Python 3)
#
...
async def upload_data_chunks(service: Optional[Any] = ..., uploader_class: Optional[Any] = ..., total_size: Optional[Any] = ..., chunk_size: Optional[Any] = ..., max_connections: Optional[Any] = ..., stream: Optional[Any] = ..., encryption_options: Optional[Any] = ..., **kwargs: Any): ...
async def upload_substream_blocks(service: Optional[Any] = ..., uploader_class: Optional[Any] = ..., total_size: Optional[Any] = ..., chunk_size: Optional[Any] = ..., max_connections: Optional[Any] = ..., stream: Optional[Any] = ..., **kwargs: Any): ...
