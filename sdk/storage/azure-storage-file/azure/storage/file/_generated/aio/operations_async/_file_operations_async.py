...
class FileOperations:
    ...
    async def create(self, file_content_length, timeout=None, metadata=None, file_http_headers=None, *, cls=None, **kwargs):
        ...
        :type file_http_headers: ~file.models.FileHTTPHeaders
    ...
    async def set_http_headers(self, timeout=None, file_content_length=None, file_http_headers=None, *, cls=None, **kwargs):
    ...
    async def upload_range(self, range, content_length, file_range_write="update", optionalbody=None, timeout=None, content_md5=None, *, cls=None, **kwargs):
        ...
        :type file_range_write: str or ~file.models.FileRangeWriteType
