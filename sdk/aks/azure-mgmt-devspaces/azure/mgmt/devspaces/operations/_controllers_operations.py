...
def build_get_request(resource_group_name: str, name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "name": _SERIALIZER.url(
            "name", name, "str", max_length=63, min_length=1, pattern=r"^[a-zA-Z0-9]([_-]*[a-zA-Z0-9])*$"
        ),
    }
...
def build_list_connection_details_request(
...
class ControllersOperations:
    ...
    def _create_initial(
        self, resource_group_name: str, name: str, controller: Union[_models.Controller, IO], **kwargs: Any
    ) -> _models.Controller:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
        ...
        _json = None
        _content = None
        if isinstance(controller, (IO, bytes)):
            _content = controller
        else:
    ...
    def begin_create(
        ...
        :param name: Name of the resource. Required.
        :type name: str
        :param controller: Controller create parameters. Is either a model type or a IO type. Required.
    ...
    def update(
        ...
        resource_group_name: str,
        name: str,
        controller_update_parameters: _models.ControllerUpdateParameters,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.Controller:
    ...
    def update(
        ...
        resource_group_name: str,
        name: str,
        controller_update_parameters: Union[_models.ControllerUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.Controller:
        """Updates an Azure Dev Spaces Controller.
        ...
        _json = None
        _content = None
        if isinstance(controller_update_parameters, (IO, bytes)):
    ...
    def list_connection_details(
        ...
        resource_group_name: str,
        name: str,
        list_connection_details_parameters: _models.ListConnectionDetailsParameters,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.ControllerConnectionDetailsList:
    ...
    def list_connection_details(
        ...
        resource_group_name: str,
        name: str,
        list_connection_details_parameters: Union[_models.ListConnectionDetailsParameters, IO],
        **kwargs: Any
    ) -> _models.ControllerConnectionDetailsList:
        """Lists connection details for an Azure Dev Spaces Controller.
        ...
        :type name: str
        :param list_connection_details_parameters: Parameters for listing connection details of Azure
         Dev Spaces Controller. Is either a model type or a IO type. Required.
        :type list_connection_details_parameters:
        ...
        _json = None
        _content = None
        if isinstance(list_connection_details_parameters, (IO, bytes)):
        ...
        request = build_list_connection_details_request(
            resource_group_name=resource_group_name,
            name=name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            ...
            json=_json,
            content=_content,
            template_url=self.list_connection_details.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    list_connection_details.metadata = {
