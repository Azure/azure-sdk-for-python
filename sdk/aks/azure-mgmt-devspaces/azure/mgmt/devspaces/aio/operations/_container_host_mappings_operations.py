...
class ContainerHostMappingsOperations:
    ...
    async def get_container_host_mapping(
        ...
        **kwargs: Any
        ...
        :type container_host_mapping: ~dev_spaces_management_client.models.ContainerHostMapping
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ContainerHostMapping, or the result of cls(response)
        :rtype: ~dev_spaces_management_client.models.ContainerHostMapping or None
        ...
        # Construct URL
        url = self.get_container_host_mapping.metadata['url']  # type: ignore
