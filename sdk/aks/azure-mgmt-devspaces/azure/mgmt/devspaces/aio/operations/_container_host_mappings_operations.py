...
class ContainerHostMappingsOperations:
    ...
    async def get_container_host_mapping(
        ...
        **kwargs: Any
        ...
        :param location: Location of the container host. Required.
        :type location: str
        :param container_host_mapping: Is either a ContainerHostMapping type or a IO type. Required.
        ...
        cls: ClsType[Optional[_models.ContainerHostMapping]] = kwargs.pop("cls", None)

        content_type = content_type or "application/json"
        _json = None
        _content = None
        if isinstance(container_host_mapping, (IOBase, bytes)):
    ...
    get_container_host_mapping.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevSpaces/locations/{location}/checkContainerHostMapping"
    }
