...
class HarvestDataOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        request = rest_harvest_data.build_get_request(
            farmer_id=farmer_id,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        if harvest_data is not None:
            json_body = harvest_data
        else:
            json_body = None


        request = rest_harvest_data.build_create_or_update_request(
            farmer_id=farmer_id,
            harvest_data_id=harvest_data_id,
            json_body=json_body,
    ...
    async def delete(
        ...
        **kwargs: Any
        ...
        request = rest_harvest_data.build_delete_request(
            farmer_id=farmer_id,
            harvest_data_id=harvest_data_id,
