...
class OAuthConfigsOperations(object):
    """OAuthConfigsOperations operations.
    ...
    def get_o_auth_transient_config(
        ...
        **kwargs  # type: Any
        ...
        :type body: ~azure.farmbeats.models.OAuthConfigQuery
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: OAuthConfig, or the result of cls(response)
        :rtype: ~azure.farmbeats.models.OAuthConfig
