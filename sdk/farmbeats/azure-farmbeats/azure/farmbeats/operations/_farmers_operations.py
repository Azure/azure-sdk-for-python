...
class FarmersOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        request = rest_farmers.build_get_request(
            farmer_id=farmer_id,
    ...
    def delete(
        ...
        **kwargs  # type: Any
        ...
        request = rest_farmers.build_delete_request(
            farmer_id=farmer_id,
    ...
    def get_cascade_delete_job_details(
        ...
        **kwargs  # type: Any
        ...
        request = rest_farmers.build_get_cascade_delete_job_details_request(
            job_id=job_id,
    ...
    _create_cascade_delete_jo_initial.metadata = {'url': '/farmers/cascade-delete/{jobId}'}  # type: ignore
