...
def build_list_by_farmer_id_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/farmers/{farmerId}/farms')
...
def build_list_request(
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/farms')
...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/farmers/{farmerId}/farms/{farmId}')
    path_format_arguments = {
        'farmerId': _SERIALIZER.url("farmer_id", farmer_id, 'str'),
...
def build_create_or_update_request(
    ...
    **kwargs  # type: Any
    ...
    :param farm_id: Id of the farm resource.
    :type farm_id: str
    :keyword json: Farm resource payload to create or update.
    :paramtype json: Any
    :keyword content: Farm resource payload to create or update.
...
def build_get_cascade_delete_job_details_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/farms/cascade-delete/{jobId}')
    path_format_arguments = {
...
def build_create_cascade_delete_job_request_initial(
    ...
    **kwargs  # type: Any
    ...
    query_parameters['farmId'] = _SERIALIZER.query("farm_id", farm_id, 'str')
    query_parameters['api-version'] = _SERIALIZER.query("api_version", api_version, 'str')
