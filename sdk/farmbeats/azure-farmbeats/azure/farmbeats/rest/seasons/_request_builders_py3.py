...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/seasons')

    # Construct parameters
    query_parameters = kwargs.pop("params", {})  # type: Dict[str, Any]
    if min_start_date_time is not None:
        query_parameters['minStartDateTime'] = _SERIALIZER.query("min_start_date_time", min_start_date_time, 'iso-8601')
    if max_start_date_time is not None:
        query_parameters['maxStartDateTime'] = _SERIALIZER.query("max_start_date_time", max_start_date_time, 'iso-8601')
    if min_end_date_time is not None:
        query_parameters['minEndDateTime'] = _SERIALIZER.query("min_end_date_time", min_end_date_time, 'iso-8601')
    if max_end_date_time is not None:
        query_parameters['maxEndDateTime'] = _SERIALIZER.query("max_end_date_time", max_end_date_time, 'iso-8601')
    if years is not None:
        query_parameters['years'] = [_SERIALIZER.query("years", q, 'int') if q is not None else '' for q in years]
    if ids is not None:
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/seasons/{seasonId}')
...
def build_create_or_update_request(
    ...
    **kwargs: Any
    ...
    :type season_id: str
    :keyword json: Season resource payload to create or update.
    :paramtype json: Any
    :keyword content: Season resource payload to create or update.
