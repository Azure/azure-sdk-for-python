...
try:
    ...
    from ._request_builders_py3 import build_search_by_farmer_id_request
    ...
    from ._request_builders_py3 import build_get_overlap_request
except (SyntaxError, ImportError):
    from ._request_builders import build_list_by_farmer_id_request  # type: ignore
    from ._request_builders import build_search_by_farmer_id_request  # type: ignore
    ...
    from ._request_builders import build_get_overlap_request  # type: ignore

__all__ = [
    'build_list_by_farmer_id_request',
    'build_search_by_farmer_id_request',
    'build_list_request',
