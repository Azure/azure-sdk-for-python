...
USAGE:
    ...
    3) ID_OF_MODEL_TRAINED_WITH_LABELS - the ID of your custom model trained with labels
        -OR-
       CONTAINER_SAS_URL_WITH_LABELS_V2 - The shared access signature (SAS) Url of your Azure Blob Storage container with
    ...
    4) ID_OF_MODEL_TRAINED_WITHOUT_LABELS - the ID of your custom model trained without labels
        -OR-
       CONTAINER_SAS_URL_WITHOUT_LABELS_V2 - The shared access signature (SAS) Url of your Azure Blob Storage container with
...
class DifferentiateOutputModelsTrainedWithAndWithoutLabelsSampleAsync:
