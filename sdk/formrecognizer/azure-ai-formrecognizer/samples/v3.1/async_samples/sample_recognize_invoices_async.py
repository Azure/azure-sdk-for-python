    ...
    async def recognize_invoice(self):
        ...
        async with FormRecognizerClient(
            ...
            for idx, invoice in enumerate(invoices):
                ...
                if vendor_address:
                    print(
                        "Vendor Address: {} has confidence: {}".format(vendor_address.value, vendor_address.confidence)
                    )
                ...
                if purchase_order:
                    print(
                        "Purchase Order: {} has confidence: {}".format(purchase_order.value, purchase_order.confidence)
                    )
