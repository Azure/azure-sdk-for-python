...
"""
FILE: sample_recognize_custom_forms_from_url_with_unsupervised_model_async.py
...
DESCRIPTION:
    ...
    sample_recognize_custom_forms_with_supervised_model.py.
    To learn how to train your own unsupervised model, look at sample TODO
USAGE:
    python sample_recognize_custom_forms_from_url_with_unsupervised_model_async.py
...
class RecognizeCustomFormsFromURLWithUnsupervisedModelSampleAsync(object):

    endpoint = os.environ["AZURE_FORM_RECOGNIZER_ENDPOINT"]
    key = os.environ["AZURE_FORM_RECOGNIZER_KEY"]
    unsupervised_model_id = os.environ["CUSTOM_TRAINED_UNSUPERVISED_MODEL_ID"]

    async def recognize_custom_forms_from_url_with_unsupervised_model(self):
...
async def main():
    sample = RecognizeCustomFormsFromURLWithUnsupervisedModelSampleAsync()
    await sample.recognize_custom_forms_from_url_with_unsupervised_model()
