...
"""
FILE: sample_recognize_custom_forms_from_url_with_supervised_model.py
...
DESCRIPTION:
    ...
    sample_recognize_custom_forms_from_url_with_unsupervised_model.py.
    To learn how to train your own supervised model, look at sample TODO
USAGE:
    python sample_recognize_custom_forms_from_url_with_supervised_model.py
...
class RecognizeCustomFormsFromURLWithSupervisedModelSample(object):

    endpoint = os.environ["AZURE_FORM_RECOGNIZER_ENDPOINT"]
    key = os.environ["AZURE_FORM_RECOGNIZER_KEY"]
    supervised_model_id = os.environ["CUSTOM_TRAINED_SUPERVISED_MODEL_ID"]

    def recognize_custom_forms_from_url_with_supervised_model(self):
...
if __name__ == '__main__':
    sample = RecognizeCustomFormsFromURLWithSupervisedModelSample()
    sample.recognize_custom_forms_from_url_with_supervised_model()
