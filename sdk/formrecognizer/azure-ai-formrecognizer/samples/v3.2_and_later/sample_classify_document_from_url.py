...
"""
FILE: sample_classify_document_from_url.py
...
USAGE:
    python sample_classify_document_from_url.py
...
def classify_document_from_url(classifier_id):
    # [START classify_document_from_url]
    ...
    poller = document_analysis_client.begin_classify_document_from_url(classifier_id, document_url=url)
    ...
    # [END classify_document_from_url]
