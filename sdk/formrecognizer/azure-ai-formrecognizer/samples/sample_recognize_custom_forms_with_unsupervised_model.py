...
"""
FILE: sample_recognize_custom_forms_with_unsupervised_model.py
...
USAGE:
    python sample_recognize_custom_forms_with_unsupervised_model.py
...
class RecognizeCustomFormsWithUnsupervisedModelSample(object):

    endpoint = os.environ["AZURE_FORM_RECOGNIZER_ENDPOINT"]
    key = os.environ["AZURE_FORM_RECOGNIZER_KEY"]
    unsupervised_model_id = os.environ["CUSTOM_TRAINED_UNSUPERVISED_MODEL_ID"]

    def recognize_custom_forms_with_unsupervised_model(self):
...
if __name__ == '__main__':
    sample = RecognizeCustomFormsWithUnsupervisedModelSample()
    sample.recognize_custom_forms_with_unsupervised_model()
