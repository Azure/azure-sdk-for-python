...
class DocumentModelAdministrationClient(FormRecognizerClientBaseAsync):
    ...
    async def begin_build_document_model(
        ...
        return await _client_op_path.begin_build_model(  # type: ignore
    ...
    async def begin_compose_document_model(
        ...
        if self._api_version == DocumentAnalysisApiVersion.V2023_02_28_PREVIEW:
            _client_op_path = _client_op_path.document_models
        return await _client_op_path.begin_compose_model(  # type: ignore
    ...
    async def get_copy_authorization(self, **kwargs: Any) -> TargetAuthorization:
        ...
        if self._api_version == DocumentAnalysisApiVersion.V2023_02_28_PREVIEW:
            _client_op_path = _client_op_path.document_models
        response = await _client_op_path.authorize_model_copy(
    ...
    async def begin_copy_document_model_to(
        ...
        if self._api_version == DocumentAnalysisApiVersion.V2023_02_28_PREVIEW:
            _client_op_path = _client_op_path.document_models
        return await _client_op_path.begin_copy_model_to(  # type: ignore
            model_id=model_id,
    ...
    async def delete_document_model(self, model_id: str, **kwargs: Any) -> None:
        ...
        if self._api_version == DocumentAnalysisApiVersion.V2023_02_28_PREVIEW:
            _client_op_path = _client_op_path.document_models
        return await _client_op_path.delete_model(model_id=model_id, **kwargs)
    ...
    def list_document_models(self, **kwargs: Any) -> AsyncItemPaged[DocumentModelSummary]:
        ...
        if self._api_version == DocumentAnalysisApiVersion.V2023_02_28_PREVIEW:
            _client_op_path = _client_op_path.document_models
        return _client_op_path.list_models(  # type: ignore
            cls=kwargs.pop(
                "cls",
    ...
    async def get_resource_details(self, **kwargs: Any) -> ResourceDetails:
        ...
        _client_op_path = self._client
        if self._api_version == DocumentAnalysisApiVersion.V2023_02_28_PREVIEW:
            _client_op_path = _client_op_path.miscellaneous
        response = await _client_op_path.get_resource_info(**kwargs)
    ...
    async def get_document_model(self, model_id: str, **kwargs: Any) -> DocumentModelDetails:
        ...
        if self._api_version == DocumentAnalysisApiVersion.V2023_02_28_PREVIEW:
            _client_op_path = _client_op_path.document_models
        response = await _client_op_path.get_model(model_id=model_id, **kwargs)
    ...
    def list_operations(self, **kwargs: Any) -> AsyncItemPaged[OperationSummary]:
        ...
        if self._api_version == DocumentAnalysisApiVersion.V2023_02_28_PREVIEW:
            _client_op_path = _client_op_path.miscellaneous
        return _client_op_path.list_operations(  # type: ignore
            cls=kwargs.pop(
                "cls",
    ...
    async def get_operation(self, operation_id: str, **kwargs: Any) -> OperationDetails:
        ...
        return OperationDetails._from_generated(
            await _client_op_path.get_operation(operation_id, **kwargs),
