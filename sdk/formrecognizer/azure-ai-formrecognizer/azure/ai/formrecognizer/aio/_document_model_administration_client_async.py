...
class DocumentModelAdministrationClient(FormRecognizerClientBaseAsync):
    ...
    async def begin_build_document_model(
        ...
        return await self._client.document_models.begin_build_model(  # type: ignore
    ...
    async def begin_compose_document_model(
        ...
        return await self._client.document_models.begin_compose_model(  # type: ignore
    ...
    async def get_copy_authorization(self, **kwargs: Any) -> TargetAuthorization:
        ...
        response = await self._client.document_models.authorize_model_copy(
    ...
    async def begin_copy_document_model_to(
        ...
        return await self._client.document_models.begin_copy_model_to(  # type: ignore
            model_id=model_id,
    ...
    async def delete_document_model(self, model_id: str, **kwargs: Any) -> None:
        ...
        return await self._client.document_models.delete_model(model_id=model_id, **kwargs)
    ...
    async def get_resource_details(self, **kwargs: Any) -> ResourceDetails:
        ...
        response = await self._client.miscellaneous.get_resource_info(**kwargs)
    ...
    async def get_document_model(self, model_id: str, **kwargs: Any) -> DocumentModelDetails:
        ...
        response = await self._client.document_models.get_model(model_id=model_id, **kwargs)
    ...
    async def get_operation(self, operation_id: str, **kwargs: Any) -> OperationDetails:
        ...
        return OperationDetails._from_generated(
            await self._client.miscellaneous.get_operation(operation_id, **kwargs),
