...
from azure.core.polling.base_polling import _FAILED
...
class AsyncTrainingPolling(AsyncLROBasePolling):

    def __init__(
        self, timeout=30, lro_algorithms=None, lro_options=None, **operation_config
    ):
        super(AsyncTrainingPolling, self).__init__(timeout, lro_algorithms, lro_options, **operation_config)
