...
def build_build_classifier_request_initial(
    *, json: Optional[_models.BuildDocumentClassifierRequest] = None, content: Any = None, **kwargs: Any
) -> HttpRequest:
...
def build_list_classifiers_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_classifier_request(classifier_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_classifier_request(classifier_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_classify_result_request(classifier_id: str, result_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DocumentClassifiersOperations:
    ...
    @distributed_trace
    def list_classifiers(self, **kwargs: Any) -> Iterable[_models.GetDocumentClassifiersResponse]:
