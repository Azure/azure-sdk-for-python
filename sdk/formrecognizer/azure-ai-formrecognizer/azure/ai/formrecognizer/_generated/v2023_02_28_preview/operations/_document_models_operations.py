...
def build_analyze_document_request_initial(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        "modelId": _SERIALIZER.url("model_id", model_id, 'str', max_length=64, min_length=0, pattern=r'^[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63}$'),
    }
...
class DocumentModelsOperations:
    ...
    def begin_analyze_document(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type features: list[str or
         ~azure.ai.formrecognizer.v2023_02_28_preview.models.DocumentAnalysisFeature]
        :param query_fields: List of additional fields to extract.  Ex. "NumberOfGuests,StoreNumber".
         Default value is None.
        :type query_fields: list[str]
        :param analyze_request: Analyze request parameters. Default value is None.
        :type analyze_request: IO or str or
         ~azure.ai.formrecognizer.v2023_02_28_preview.models.AnalyzeDocumentRequest
    ...
    def begin_build_model(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type build_request:
         ~azure.ai.formrecognizer.v2023_02_28_preview.models.BuildDocumentModelRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be LROBasePolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
    ...
    def begin_compose_model(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type compose_request:
         ~azure.ai.formrecognizer.v2023_02_28_preview.models.ComposeDocumentModelRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be LROBasePolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
    ...
    def authorize_model_copy(
        ...
        **kwargs: Any
        ...
        :type authorize_copy_request:
         ~azure.ai.formrecognizer.v2023_02_28_preview.models.AuthorizeCopyRequest
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CopyAuthorization, or the result of cls(response)
        :rtype: ~azure.ai.formrecognizer.v2023_02_28_preview.models.CopyAuthorization
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
    ...
    def begin_copy_model_to(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type copy_to_request: ~azure.ai.formrecognizer.v2023_02_28_preview.models.CopyAuthorization
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword str continuation_token: A continuation token to restart a poller from a saved state.
        :keyword polling: By default, your polling method will be LROBasePolling. Pass in False for
         this operation to not poll, or pass in your own initialized polling object for a personal
    ...
    def list_models(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either GetDocumentModelsResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.formrecognizer.v2023_02_28_preview.models.GetDocumentModelsResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def get_model(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.ai.formrecognizer.v2023_02_28_preview.models.DocumentModelDetails
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
