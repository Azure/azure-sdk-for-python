...
def build_analyze_document_request_initial(
    ...
    **kwargs: Any
    ...
    if custom_fields is not None:
        _params['customFields'] = _SERIALIZER.query("custom_fields", custom_fields, '[str]', div=',')
...
def build_build_document_classifier_request_initial(
    *,
...
def build_get_document_classifiers_request(
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_document_classifier_request(
    classifier_id: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    path_format_arguments = {
        "classifierId": _SERIALIZER.url("classifier_id", classifier_id, 'str', pattern=r'^[a-zA-Z0-9][a-zA-Z0-9._~-]{1,63}$'),
    }
...
def build_delete_document_classifier_request(
    classifier_id: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_get_classify_document_result_request(
    classifier_id: str,
    result_id: str,
    **kwargs: Any
) -> HttpRequest:
...
class FormRecognizerClientOperationsMixin(MixinABC):  # pylint: disable=too-many-public-methods
    ...
    def _build_document_classifier_initial(  # pylint: disable=inconsistent-return-statements
        self,
    ...
    def begin_build_document_classifier(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._build_document_classifier_initial(  # type: ignore
                build_request=build_request,
                api_version=api_version,
                content_type=content_type,
                cls=lambda x,y,z: x,
