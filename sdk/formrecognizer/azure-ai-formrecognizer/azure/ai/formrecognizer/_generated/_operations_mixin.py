    ...
    def authorize_copy_document_model(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2022-01-30-preview':
            from .v2022_01_30_preview.operations import FormRecognizerClientOperationsMixin as OperationClass
        else:
    ...
    def begin_analyze_layout_async(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            return mixin_instance.begin_analyze_layout_async(kwargs.get("pages", None), kwargs.get("language", None), kwargs.get("reading_order", None), file_stream, **kwargs)
    ...
    def begin_analyze_receipt_async(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            return mixin_instance.begin_analyze_receipt_async(include_text_details, kwargs.get("locale", None), kwargs.get("pages", None), file_stream, **kwargs)
    ...
    def begin_analyze_with_custom_model(
        ...
        **kwargs  # type: Any
        ...
        if api_version == '2.0':
            ...
            return mixin_instance.begin_analyze_with_custom_model(model_id, include_text_details, kwargs.get("pages", None), file_stream, **kwargs)
