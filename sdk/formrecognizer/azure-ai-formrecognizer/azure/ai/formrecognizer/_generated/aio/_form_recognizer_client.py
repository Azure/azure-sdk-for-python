...
class FormRecognizerClient(FormRecognizerClientOperationsMixin, MultiApiClientMixin, _SDKClient):
    ...
    LATEST_PROFILE = ProfileDefinition({
        _PROFILE_TAG: {
            ...
            'delete_document_model': '2022-06-30-preview',
            'get_analyze_document_result': '2022-06-30-preview',
            'get_document_model': '2022-06-30-preview',
            'get_document_models': '2022-06-30-preview',
            'get_operation': '2022-06-30-preview',
            'get_operations': '2022-06-30-preview',
            'get_resource_details': '2022-06-30-preview',
