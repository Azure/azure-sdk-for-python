...
class FormRecognizerClientOperationsMixin(object):
    ...
    async def authorize_copy_document_model(
        ...
        **kwargs: Any
        ...
        if api_version == '2022-01-30-preview':
            from ..v2022_01_30_preview.aio.operations import FormRecognizerClientOperationsMixin as OperationClass
        else:
    ...
    async def begin_analyze_layout_async(
        ...
        **kwargs: Any
        ...
        if api_version == '2.0':
            ...
            return await mixin_instance.begin_analyze_layout_async(kwargs.get("pages", None), kwargs.get("language", None), kwargs.get("reading_order", None), file_stream, **kwargs)
    ...
    async def begin_analyze_receipt_async(
        ...
        **kwargs: Any
        ...
        if api_version == '2.0':
            ...
            return await mixin_instance.begin_analyze_receipt_async(include_text_details, kwargs.get("locale", None), kwargs.get("pages", None), file_stream, **kwargs)
    ...
    async def begin_analyze_with_custom_model(
        ...
        **kwargs: Any
        ...
        if api_version == '2.0':
            ...
            return await mixin_instance.begin_analyze_with_custom_model(model_id, include_text_details, kwargs.get("pages", None), file_stream, **kwargs)
    ...
    def get_models(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.formrecognizer.v2022_01_30_preview.models.GetModelsResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_operations(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either GetOperationsResponse or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.ai.formrecognizer.v2022_01_30_preview.models.GetOperationsResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
