...
class TestDACClassifyDocument(FormRecognizerTest):
    ...
    @recorded_by_proxy
    def test_classify_document(self, client, formrecognizer_classifier_container_sas_url, **kwargs):
        da_client = client.get_document_analysis_client()

        poller = client.begin_build_document_classifier(blob_container_url=formrecognizer_classifier_container_sas_url)
