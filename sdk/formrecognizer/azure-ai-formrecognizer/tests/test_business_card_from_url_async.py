...
class TestBusinessCardFromUrlAsync(AsyncFormRecognizerTest):
    ...
    async def test_business_card_locale_default(self, client):
        ...
        async with client:
            poller = await client.begin_recognize_business_cards_from_url(self.business_card_url_jpg, cls=_get_locale_in_call)
            await poller.wait()
    ...
    async def test_business_card_locale_specified(self, client):
        ...
        async with client:
            poller = await client.begin_recognize_business_cards_from_url(self.business_card_url_jpg, locale="en-IN", cls=_get_locale_in_call)
            await poller.wait()
