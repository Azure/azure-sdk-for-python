...
FormRecognizerPreparer = functools.partial(
    ...
    formrecognizer_label_table_variable_rows_storage_container_sas_url="container_sas_url",
    formrecognizer_label_table_fixed_rows_storage_container_sas_url="container_sas_url",
