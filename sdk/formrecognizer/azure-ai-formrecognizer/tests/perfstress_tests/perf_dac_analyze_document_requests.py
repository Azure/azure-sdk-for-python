...
class AnalyzeDocumentRequestPreparation(PerfStressTest):
    ...
    def run_sync(self):
        ...
        poller = self.service_client.begin_analyze_document("prebuilt-document", self.document_jpg)
        assert poller

    async def run_async(self):
        """The asynchronous perf test."""
        poller = await self.async_service_client.begin_analyze_document("prebuilt-document", self.document_jpg)
        assert poller
