...
def classifier_document_type_details(blob_source):
    ...
    model_repr = f"ClassifierDocumentTypeDetails(source={blob_source[1]})"
...
def classifier_document_type_details_file_list(blob_file_list_source):
    ...
    model_repr = f"ClassifierDocumentTypeDetails(source={blob_file_list_source[1]})"
...
@pytest.fixture
def document_classifier_details(classifier_document_type_details, classifier_document_type_details_file_list):
