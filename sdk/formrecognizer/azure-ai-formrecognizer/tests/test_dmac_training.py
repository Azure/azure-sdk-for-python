...
class TestDMACTraining(FormRecognizerTest):
    ...
    @recorded_by_proxy
    def test_build_model_polling_interval(self, formrecognizer_storage_container_sas_url, **kwargs):
        ...
        poller = client.begin_build_document_model(
            blob_container_url=formrecognizer_storage_container_sas_url, build_mode="template", polling_interval=6
        )
        poller.wait()
        assert poller._polling_method._timeout == 6
        poller2 = client.begin_build_document_model(
            blob_container_url=formrecognizer_storage_container_sas_url, build_mode="template"
        )
        poller2.wait()
    ...
    @FormRecognizerPreparer()
    @recorded_by_proxy
    def test_build_model_encoded_url(self):
        client = get_dma_client()
    ...
    @FormRecognizerPreparer()
    @recorded_by_proxy
    def test_build_model(self, formrecognizer_storage_container_sas_url, **kwargs):
        client = get_dma_client()
        set_bodiless_matcher()
    ...
    @FormRecognizerPreparer()
    @recorded_by_proxy
    def test_build_model_neural(self, formrecognizer_storage_container_sas_url, **kwargs):
        client = get_dma_client()
        set_bodiless_matcher()
        model_id = str(uuid.uuid4())
        poller = client.begin_build_document_model(
    ...
    @FormRecognizerPreparer()
    @recorded_by_proxy
    def test_build_model_multipage(self, formrecognizer_multipage_storage_container_sas_url, **kwargs):
        client = get_dma_client()
        set_bodiless_matcher()
    ...
    @FormRecognizerPreparer()
    @recorded_by_proxy
    def test_build_model_nested_schema(self, formrecognizer_table_variable_rows_container_sas_url, **kwargs):
        client = get_dma_client()
        set_bodiless_matcher()
    ...
    @FormRecognizerPreparer()
    @recorded_by_proxy
    def test_build_model_transform(self, formrecognizer_storage_container_sas_url, **kwargs):
        client = get_dma_client()
        set_bodiless_matcher()
        ...
        poller = client.begin_build_document_model(
            "template", blob_container_url=formrecognizer_storage_container_sas_url, cls=callback
        )
        model = poller.result()
    ...
    @FormRecognizerPreparer()
    @recorded_by_proxy
    def test_build_model_multipage_transform(self, formrecognizer_multipage_storage_container_sas_url, **kwargs):
        client = get_dma_client()
        set_bodiless_matcher()
        ...
        poller = client.begin_build_document_model(
            "template", blob_container_url=formrecognizer_multipage_storage_container_sas_url, cls=callback
        )
        model = poller.result()
    ...
    @FormRecognizerPreparer()
    @recorded_by_proxy
    def test_build_model_nested_schema_transform(self, formrecognizer_table_variable_rows_container_sas_url, **kwargs):
        client = get_dma_client()
        set_bodiless_matcher()
        ...
        poller = client.begin_build_document_model(
            "template", blob_container_url=formrecognizer_table_variable_rows_container_sas_url, cls=callback
        )
        model = poller.result()
    ...
    @FormRecognizerPreparer()
    @recorded_by_proxy
    def test_build_model_azure_blob_path_filter(self, formrecognizer_storage_container_sas_url, **kwargs):
        client = get_dma_client()
        set_bodiless_matcher()
        with pytest.raises(HttpResponseError) as e:
            poller = client.begin_build_document_model(
                "template", blob_container_url=formrecognizer_storage_container_sas_url, prefix="testfolder"
            )
            model = poller.result()
    ...
    @FormRecognizerPreparer()
    @recorded_by_proxy
    def test_build_model_poller_metadata(self, formrecognizer_storage_container_sas_url, **kwargs):
        client = get_dma_client()
        set_bodiless_matcher()
        poller = client.begin_build_document_model(
            "template", blob_container_url=formrecognizer_storage_container_sas_url
    ...
    @FormRecognizerPreparer()
    @recorded_by_proxy
    def test_build_model_file_list_source(self, formrecognizer_selection_mark_storage_container_sas_url, **kwargs):
        client = get_dma_client()
        set_bodiless_matcher()
        poller = client.begin_build_document_model(
            build_mode="template",
