...
class AnalyzeOperationResult(msrest.serialization.Model):
    ...
    :param status: Required. Status of the queued operation. Possible values include: 'notStarted',
    ...
    :param analyze_result: Analyze operation result.
...
class DataTableCell(msrest.serialization.Model):
    ...
    :type text: str
    :param bounding_box: Required. Quadrangle bounding box, with coordinates specified relative to
     the top-left of the original image. The eight numbers represent the four points, clockwise from
     the top-left corner relative to the text orientation. For image, the (x, y) coordinates are
     measured in pixels. For PDF, the (x, y) coordinates are measured in inches.
...
class FieldValue(msrest.serialization.Model):
    ...
    :param type: Required. Semantic data type of the field value. Possible values include:
     'string', 'date', 'time', 'phoneNumber', 'number', 'integer', 'array', 'object'.
    ...
    :type text: str
    :param bounding_box: Quadrangle bounding box, with coordinates specified relative to the top-
     left of the original image. The eight numbers represent the four points, clockwise from the
     top-left corner relative to the text orientation. For image, the (x, y) coordinates are
     measured in pixels. For PDF, the (x, y) coordinates are measured in inches.
    :type bounding_box: list[float]
...
class KeyValuePair(msrest.serialization.Model):
    ...
    :type label: str
    :param key: Required. Information about the extracted key or value in a key-value pair.
    :type key: ~azure.ai.formrecognizer.models.KeyValueElement
    :param value: Required. Information about the extracted key or value in a key-value pair.
...
class ReadResult(msrest.serialization.Model):
    ...
    :param language: Language code. Possible values include: 'en', 'es'.
