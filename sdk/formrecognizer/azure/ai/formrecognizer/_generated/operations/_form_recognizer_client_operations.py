...
class FormRecognizerClientOperationsMixin(object):
    ...
    def train_custom_model_async(
        ...
        **kwargs  # type: Any
        ...
        :type train_request: ~azure.cognitiveservices.language.formrecognizer.models.TrainRequest
    ...
    def get_custom_model(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.cognitiveservices.language.formrecognizer.models.Model
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def analyze_with_custom_model(
        ...
        **kwargs  # type: Any
        ...
        :type file_stream: str, ~azure.cognitiveservices.language.formrecognizer.models.SourcePath
    ...
    def get_analyze_form_result(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.cognitiveservices.language.formrecognizer.models.AnalyzeOperationResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_custom_models(
        ...
        **kwargs  # type: Any
        ...
        :type op: str or ~azure.cognitiveservices.language.formrecognizer.models.Enum1
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Models or the result of cls(response)
        :rtype: ~azure.cognitiveservices.language.formrecognizer.models.Models
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_custom_models(
        ...
        **kwargs  # type: Any
        ...
        :param op: Specify whether to return summary or full list of models.
        :type op: str or ~azure.cognitiveservices.language.formrecognizer.models.Enum2
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Models or the result of cls(response)
        :rtype: ~azure.cognitiveservices.language.formrecognizer.models.Models
        :raises: ~azure.core.exceptions.HttpResponseError
