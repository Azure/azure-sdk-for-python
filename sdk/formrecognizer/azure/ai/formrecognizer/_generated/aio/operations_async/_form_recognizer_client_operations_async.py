...
class FormRecognizerClientOperationsMixin:
    ...
    def get_custom_models(
        self,
        op: Optional[Union[str, "models.Enum0"]] = "full",
        **kwargs
    ) -> "models.Models":
        ...
        :type op: str or ~azure.ai.formrecognizer.models.Enum0
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        """
        cls: ClsType["models.Models"] = kwargs.pop('cls', None)
        error_map = kwargs.pop('error_map', {})
    ...
    async def get_custom_model(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls: ClsType["models.Model"] = kwargs.pop('cls', None)
        error_map = kwargs.pop('error_map', {})
    ...
    async def analyze_with_custom_model(
        ...
        **kwargs
        ...
        if header_parameters['Content-Type'] in ['application/pdf', 'image/jpeg', 'image/png', 'image/tiff']:
            __body_content_kwargs['stream_content'] = file_stream
    ...
    async def get_analyze_form_result(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls: ClsType["models.AnalyzeOperationResult"] = kwargs.pop('cls', None)
        error_map = kwargs.pop('error_map', {})
