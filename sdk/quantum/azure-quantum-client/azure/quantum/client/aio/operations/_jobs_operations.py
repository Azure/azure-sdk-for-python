...
class JobsOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~quantum_client.models.JobDetailsList]
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~quantum_client.models.JobDetails
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create(
        ...
        **kwargs
        ...
        :type job: ~quantum_client.models.JobDetails
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: JobDetails, or the result of cls(response)
        :rtype: ~quantum_client.models.JobDetails
        :raises: ~azure.core.exceptions.HttpResponseError
