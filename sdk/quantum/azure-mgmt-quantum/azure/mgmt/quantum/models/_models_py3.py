...
class ErrorDetail(Model):
    ...
    :vartype additional_info:
     list[~azure.mgmt.quantum.models.ErrorAdditionalInfo]
    """
...
class ProviderProperties(Model):
    ...
    :type managed_application:
     ~azure.mgmt.quantum.models.ProviderPropertiesManagedApplication
    ...
    :param pricing_dimensions: The list of pricing dimensions from the
     provider.
    :type pricing_dimensions:
     list[~azure.mgmt.quantum.models.PricingDimension]
    """
...
class QuantumWorkspace(TrackedResource):
    ...
    :vartype provisioning_state: str or
     ~azure.mgmt.quantum.models.ProvisioningStatus
    ...
    def __init__(self, *, location: str, tags=None, providers=None, storage_account: str=None, identity=None, **kwargs) -> None:
