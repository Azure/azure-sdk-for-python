...
class OfferingsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.quantum.models.ProviderDescriptionPaged[~azure.mgmt.quantum.models.ProviderDescription]
        :raises:
        ...
        if raw:
            header_dict = {}
        deserialized = models.ProviderDescriptionPaged(internal_paging, self._deserialize.dependencies, header_dict)
