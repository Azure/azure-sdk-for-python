...
class WorkspacesOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.quantum.models.QuantumWorkspace or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.mgmt.quantum.models.ErrorResponseException>`
        """
        # Construct URL
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.quantum.models.QuantumWorkspace]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.quantum.models.QuantumWorkspace]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.quantum.models.ErrorResponseException>`
        """
    ...
    def update_tags(
        ...
        :raises:
         :class:`ErrorResponseException<azure.mgmt.quantum.models.ErrorResponseException>`
        """
        workspace_tags = models.TagsObject(tags=tags)
    ...
    def list_by_subscription(
        ...
        :rtype:
         ~azure.mgmt.quantum.models.QuantumWorkspacePaged[~azure.mgmt.quantum.models.QuantumWorkspace]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.quantum.models.ErrorResponseException>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.QuantumWorkspacePaged(internal_paging, self._deserialize.dependencies, header_dict)
