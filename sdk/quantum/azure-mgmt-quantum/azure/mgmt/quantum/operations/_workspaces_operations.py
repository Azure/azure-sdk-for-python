...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Quantum/workspaces")
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class WorkspacesOperations:
    ...
    def get(self, resource_group_name: str, workspace_name: str, **kwargs: Any) -> _models.QuantumWorkspace:
        ...
        :return: QuantumWorkspace or the result of cls(response)
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Quantum/workspaces/{workspaceName}"
    }
    ...
    def _create_or_update_initial(
        ...
        workspace_name: str,
        quantum_workspace: Union[_models.QuantumWorkspace, IO],
        **kwargs: Any
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param workspace_name: The name of the quantum workspace resource. Required.
        :type workspace_name: str
        :param quantum_workspace: Workspace details. Is either a QuantumWorkspace type or a IO type.
         Required.
        :type quantum_workspace: ~azure.mgmt.quantum.models.QuantumWorkspace or IO
    ...
    def update_tags(
        ...
        resource_group_name: str,
        workspace_name: str,
        workspace_tags: Union[_models.TagsObject, IO],
        **kwargs: Any
    ) -> _models.QuantumWorkspace:
        """Updates an existing workspace's tags.
        ...
        :param workspace_name: The name of the quantum workspace resource. Required.
        :type workspace_name: str
        :param workspace_tags: Parameters supplied to update tags. Is either a TagsObject type or a IO
         type. Required.
        :type workspace_tags: ~azure.mgmt.quantum.models.TagsObject or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_by_resource_group.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Quantum/workspaces"
    }
