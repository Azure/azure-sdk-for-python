...
def create_collection(client: PlanetaryComputerProClient, collection_id):
    ...
    get_all_collections_response = client.stac.get_collections()
...
def update_collection(client: PlanetaryComputerProClient, collection_id):
    ...
    client.stac.replace_collection(collection_id=collection_id, body=collection)
...
def manage_render_options(client: PlanetaryComputerProClient, collection_id):
    ...
    stac_collection_mosaics_get_all_response = client.stac.get_render_options(collection_id=collection_id)
    ...
    # List render options
    client.stac.get_render_options(collection_id=collection_id)
...
def manage_mosaics(client: PlanetaryComputerProClient, collection_id):
    ...
    stac_collection_mosaics_get_all_response = client.stac.get_mosaics(collection_id=collection_id)
