...
class TestPlanetaryComputerStacSpecification(PlanetaryComputerProClientTestBase):
    ...
    @recorded_by_proxy
    def test_01_get_conformance_classes(self, planetarycomputer_endpoint):
        ...
        conformance = client.stac.get_conformance_classes()
    ...
    def test_13_replace_stac_item(self, planetarycomputer_endpoint, planetarycomputer_collection_id):
        ...
        # Replace the item
        logger.info(f"Replacing item {item_id} using begin_replace_item...")
        ...
        logger.info(f"Replaced item {item_id}")
        ...
        if original_platform is not None:
            ...
            stac_item_dict["properties"].pop("platform", None)
        restore_item = StacItem(stac_item_dict)
        restore_poller = client.stac.begin_replace_item(
