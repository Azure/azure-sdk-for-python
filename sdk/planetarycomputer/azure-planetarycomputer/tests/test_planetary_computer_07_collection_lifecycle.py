...
class TestPlanetaryComputerCollectionLifecycle(PlanetaryComputerProClientTestBase):
    ...
    def test_01_begin_create_collection(self, planetarycomputer_endpoint):
        ...
        try:
            existing_collection = client.stac.get_collection(collection_id=test_collection_id)
        ...
        create_poller = client.stac.begin_create_collection(body=collection_data, polling=True)
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy
    def test_02_replace_collection(self, planetarycomputer_endpoint):
        """
        Test updating a collection using replace.
        """
        test_logger.info("=" * 80)
        test_logger.info("TEST: test_02_replace_collection")
        test_logger.info("=" * 80)
        ...
        test_logger.info(f"Calling: replace_collection(collection_id='{test_collection_id}', body=collection)")
        updated_collection = client.stac.replace_collection(collection_id=test_collection_id, body=collection)
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy
    def test_04_create_collection_asset(self, planetarycomputer_endpoint, planetarycomputer_collection_id):
        """
        ...
        try:
            ...
            client.stac.delete_collection_asset(collection_id=planetarycomputer_collection_id, asset_id="test-asset")
    ...
    def test_05_replace_collection_asset(self, planetarycomputer_endpoint, planetarycomputer_collection_id):
        ...
        test_logger.info(
            f"Calling: replace_collection_asset(collection_id='{planetarycomputer_collection_id}', asset_id='test-asset', body={{...}})"
        )
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy
    def test_06_delete_collection_asset(self, planetarycomputer_endpoint, planetarycomputer_collection_id):
        """
