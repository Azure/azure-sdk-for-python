...
class TestPlanetaryComputerMapLegendsAsync(PlanetaryComputerProClientTestBaseAsync):
    ...
    async def test_02_get_interval_legend(self, planetarycomputer_endpoint):
        ...
        response = await client.data.get_interval_legend(classmap_name=ColorMapNames.MODIS64_A1)
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy_async
    async def test_04_get_legend_with_different_colormap(self, planetarycomputer_endpoint):
        """
