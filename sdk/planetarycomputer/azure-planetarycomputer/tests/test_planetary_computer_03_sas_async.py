...
class TestPlanetaryComputerSasAsync(PlanetaryComputerProClientTestBaseAsync):
    ...
    async def test_01_get_token_with_default_duration(self, planetarycomputer_endpoint, planetarycomputer_collection_id):
        ...
        response = await client.shared_access_signature.get_token(collection_id=planetarycomputer_collection_id)
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy_async
    async def test_03_get_sign_with_collection_thumbnail(self, planetarycomputer_endpoint, planetarycomputer_collection_id):
    ...
    async def test_04_signed_href_can_download_asset(self, planetarycomputer_endpoint, planetarycomputer_collection_id):
        ...
        sign_response = await client.shared_access_signature.get_sign(href=thumbnail_href)
