...
class TestPlanetaryComputerStacCollectionAsync(PlanetaryComputerProClientTestBaseAsync):
    """Test suite for STAC Collection operations."""

    @PlanetaryComputerPreparer()
    @recorded_by_proxy_async
    async def test_01_list_collections(self, planetarycomputer_endpoint):
        """
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy_async
    async def test_05_get_render_options(self, planetarycomputer_endpoint, planetarycomputer_collection_id):
        """
        ...
        response = await client.stac.get_render_options(collection_id=planetarycomputer_collection_id)
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy_async
    async def test_07_get_mosaics(self, planetarycomputer_endpoint, planetarycomputer_collection_id):
        """
        ...
        response = await client.stac.get_mosaics(collection_id=planetarycomputer_collection_id)
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy_async
    async def test_09_get_queryables(self, planetarycomputer_endpoint):
        """
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy_async
    async def test_10a_create_thumbnail_asset(self, planetarycomputer_endpoint, planetarycomputer_collection_id):
        """
    ...
    async def test_11_get_collection_thumbnail(self, planetarycomputer_endpoint, planetarycomputer_collection_id):
        ...
        thumbnail_bytes = b"".join([chunk async for chunk in response])
