...
class TestPlanetaryComputerTilerOperationsAsync(PlanetaryComputerClientTestBaseAsync):
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy_async
    async def test_tiler_get_geo_json_statistics(self, planetarycomputer_endpoint):
        client = self.create_async_client(endpoint=planetarycomputer_endpoint)
        response = await client.tiler.get_geo_json_statistics(
            collection_id="str",
            item_id="str",
            body={"geometry": "geometry", "type": "str", "properties": {"str": {}}},
        )
    ...
    @PlanetaryComputerPreparer()
    @recorded_by_proxy_async
    async def test_tiler_get_assets_info(self, planetarycomputer_endpoint):
        client = self.create_async_client(endpoint=planetarycomputer_endpoint)
        response = await client.tiler.get_assets_info(
            collection_id="str",
            item_id="str",
        )
