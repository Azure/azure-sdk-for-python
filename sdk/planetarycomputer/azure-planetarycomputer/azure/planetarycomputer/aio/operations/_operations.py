# pylint: disable=line-too-long,useless-suppression,too-many-lines,too-many-locals
# coding=utf-8
# --------------------------------------------------------------------------
...
# --------------------------------------------------------------------------
from collections.abc import from collections.abc import MutableMapping  # pylint: disable=import-error
...
class StacOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace_async
    async def get_collection_queryables(self, collection_id: str, **kwargs: Any) -> dict[str, Any]:
