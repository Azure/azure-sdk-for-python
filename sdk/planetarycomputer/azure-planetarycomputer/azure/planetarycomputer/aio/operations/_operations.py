...
class TilerOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace_async
    async def get_preview(self, collection_id: str, item_id: str, **kwargs: Any) -> AsyncIterator[bytes]:
        """Preview.
    ...
    async def get_preview_with_format(
        self, collection_id: str, item_id: str, format: str, **kwargs: Any
    ) -> AsyncIterator[bytes]:
        """Preview.
    ...
    @distributed_trace_async
    async def list_statistics(self, collection_id: str, item_id: str, **kwargs: Any) -> _models.StatisticsResponse:
        """Statistics.
    ...
    async def get_mosaics_tile_json(
        self, search_id: str, tile_matrix_set_id: str, **kwargs: Any
    ) -> _models.TileJsonMetaData:
        """TileJson Tilematrixsetid As Path.
