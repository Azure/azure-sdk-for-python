...
class ColorMapNames(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    MODIS_10A1 = "modis-10A1"
    """MODIS 10A1 colormap."""
    MODIS_10A2 = "modis-10A2"
    """MODIS 10A2 colormap."""
    MODIS_13A1_Q1 = "modis-13A1|Q1"
    """MODIS 13A1|Q1 colormap."""
    MODIS_14A1_A2 = "modis-14A1|A2"
    """MODIS 14A1|A2 colormap."""
    MODIS_15A2H_A3H = "modis-15A2H|A3H"
    """MODIS 15A2H|A3H colormap."""
    MODIS_16A3GF_ET = "modis-16A3GF-ET"
    """MODIS 16A3GF-ET colormap."""
    MODIS_16A3GF_PET = "modis-16A3GF-PET"
    """MODIS 16A3GF-PET colormap."""
    MODIS_17A2H_A2HGF = "modis-17A2H|A2HGF"
    """MODIS 17A2H|A2HGF colormap."""
    MODIS_17A3HGF = "modis-17A3HGF"
    """MODIS 17A3HGF colormap."""
    MODIS_64A1 = "modis-64A1"
    """MODIS 64A1 colormap."""
...
class IngestionType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    """Static STAC Catalog."""
    STAC_GEOPARQUET = "StacGeoparquet"
...
class SelMethod(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class TileMatrixSetId(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    Standard identifier for a coordinate reference system and tiling scheme used for serving map
    tiles.
    """
...
class WarpKernelResampling(str, Enum, metaclass=CaseInsensitiveEnumMeta):
