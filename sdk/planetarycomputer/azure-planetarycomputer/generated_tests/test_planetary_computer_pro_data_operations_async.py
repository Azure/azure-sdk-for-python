...
class TestPlanetaryComputerProDataOperationsAsync(PlanetaryComputerProClientTestBaseAsync):
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_tile_matrix_definitions(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_tile_matrix_definitions(
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_class_map_legend(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_interval_legend(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_legend(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_legend(
            color_map_name="str",
        )
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_register_mosaics_search(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.register_mosaics_search(
            body={
                "bbox": [0.0],
                "collections": ["str"],
                "datetime": "str",
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_tileset_metadata(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_tile(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_tile_by_format(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_tile_by_format(
            collection_id="str",
            item_id="str",
            tile_matrix_set_id="str",
            z=0.0,
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_tile_by_scale(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_tile_by_scale(
            collection_id="str",
            item_id="str",
            tile_matrix_set_id="str",
            z=0.0,
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_tile_by_scale_and_format(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_tile_no_tms(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_tile_no_tms(
            collection_id="str",
            item_id="str",
            z=0.0,
            x=0.0,
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_tile_no_tms_by_format(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_tile_no_tms_by_format(
            collection_id="str",
            item_id="str",
            z=0.0,
            x=0.0,
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_tile_no_tms_by_scale(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_tile_no_tms_by_scale(
            collection_id="str",
            item_id="str",
            z=0.0,
            x=0.0,
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_tile_no_tms_by_scale_and_format(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_tile_no_tms_by_scale_and_format(
            collection_id="str",
            item_id="str",
            z=0.0,
            x=0.0,
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_item_bounds(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_item_info(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_item_info_geo_json(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_item_asset_statistics(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_item_tile_json(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_item_wmts_capabilities(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_item_point(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_item_preview(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_item_preview_with_format(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_item_bbox_crop(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_item_bbox_crop_with_dimensions(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_tileset_metadata(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_tile_by_scale_and_format(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_tile(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_collection_tile(
            collection_id="str",
            tile_matrix_set_id="str",
            z=0.0,
            x=0.0,
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_tile_by_format(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_collection_tile_by_format(
            collection_id="str",
            tile_matrix_set_id="str",
            z=0.0,
            x=0.0,
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_tile_by_scale(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_collection_tile_by_scale(
            collection_id="str",
            tile_matrix_set_id="str",
            z=0.0,
            x=0.0,
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_tile_no_tms_by_scale_and_format(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_collection_tile_no_tms_by_scale_and_format(
            collection_id="str",
            z=0.0,
            x=0.0,
            y=0.0,
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_tile_no_tms(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_collection_tile_no_tms(
            collection_id="str",
            z=0.0,
            x=0.0,
            y=0.0,
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_tile_no_tms_by_format(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_collection_tile_no_tms_by_format(
            collection_id="str",
            z=0.0,
            x=0.0,
            y=0.0,
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_tile_no_tms_by_scale(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_collection_tile_no_tms_by_scale(
            collection_id="str",
            z=0.0,
            x=0.0,
            y=0.0,
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_tile_json(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_wmts_capabilities(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_assets_for_tile(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_assets_for_tile_no_tms(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
        response = await client.data.get_collection_assets_for_tile_no_tms(
            collection_id="str",
            z=0.0,
            x=0.0,
            y=0.0,
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_assets_for_bbox(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_info(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_bbox_crop(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_bbox_crop_with_dimensions(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_point(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
    ...
    @PlanetaryComputerProPreparer()
    @recorded_by_proxy_async
    async def test_data_get_collection_point_assets(self, planetarycomputerpro_endpoint):
        client = self.create_async_client(endpoint=planetarycomputerpro_endpoint)
