...
class TestStac(StacClientTestBase):
    @StacPreparer()
    @recorded_by_proxy
    def test_get_features(self, stac_endpoint):
    ...
    @StacPreparer()
    @recorded_by_proxy
    def test_get_collections(self, stac_endpoint):
        client = self.create_client(endpoint=stac_endpoint)
    ...
    @StacPreparer()
    @recorded_by_proxy
    def test_get_search(self, stac_endpoint):
        client = self.create_client(endpoint=stac_endpoint)
    ...
    @StacPreparer()
    @recorded_by_proxy
    def test_search_post(self, stac_endpoint):
        client = self.create_client(endpoint=stac_endpoint)
    ...
    @StacPreparer()
    @recorded_by_proxy
    def test_get_stac_landing_pages(self, stac_endpoint):
        client = self.create_client(endpoint=stac_endpoint)
    ...
    @StacPreparer()
    @recorded_by_proxy
    def test_get_stac_conformance_class(self, stac_endpoint):
        client = self.create_client(endpoint=stac_endpoint)
        response = client.get_stac_conformance_class()
