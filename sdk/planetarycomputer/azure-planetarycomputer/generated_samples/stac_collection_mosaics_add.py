...
# USAGE
    python stac_collection_mosaics_add.py
...
def main():
    ...
    response = client.stac.add_mosaic(
        ...
        body={"cql": [], "id": "test-mosaic-1", "name": "Test Most recent available"},
    )
    print(response)


# x-ms-original-file: 2026-04-15/StacCollectionMosaics_Add.json
