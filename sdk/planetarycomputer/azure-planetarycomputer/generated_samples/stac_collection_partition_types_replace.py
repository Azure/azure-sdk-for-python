...
# USAGE
    python stac_collection_partition_types_replace.py
...
def main():
    ...
    client.stac.replace_partition_type(
        collection_id="test-partition-type-collection",
        body={"scheme": "year"},
    )


# x-ms-original-file: 2026-04-15/StacCollectionPartitionTypes_Replace.json
