...
# USAGE
    python mosaic_items_bbox_with_dimensions_get_cropped_to_bounding_box_width_by_height.py
...
# x-ms-original-file: 2026-04-15/MosaicItemsBboxWithDimensions_GetCroppedToBoundingBoxWidthByHeight.json
