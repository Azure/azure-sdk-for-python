...
# USAGE
    python mosaic_searches_assets_for_tile_matrix_sets_get_zxy_assets.py
...
# x-ms-original-file: 2026-04-15/MosaicSearchesAssetsForTileMatrixSets_GetZxyAssets.json
