...
# USAGE
    python mosaic_searches_feature_geo_json_width_by_height_crop_width_by_height_format.py
...
# x-ms-original-file: 2026-04-15/MosaicSearchesFeatureGeoJsonWidthByHeight_CropWidthByHeightFormat.json
