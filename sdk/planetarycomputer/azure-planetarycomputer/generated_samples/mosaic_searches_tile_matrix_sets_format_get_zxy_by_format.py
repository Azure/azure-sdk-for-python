...
# USAGE
    python mosaic_searches_tile_matrix_sets_format_get_zxy_by_format.py
...
# x-ms-original-file: 2026-04-15/MosaicSearchesTileMatrixSetsFormat_GetZxyByFormat.json
