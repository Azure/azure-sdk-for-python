...
# USAGE
    python mosaic_collections_wmts_tile_matrix_sets_get_capabilities_xml.py
...
# x-ms-original-file: 2026-04-15/MosaicCollectionsWmtsTileMatrixSets_GetCapabilitiesXml.json
