...
# USAGE
    python mosaic_collections_tile_matrix_sets_get_zxy_scale_by_format.py
...
# x-ms-original-file: 2026-04-15/MosaicCollectionsTileMatrixSets_GetZxyScaleByFormat.json
