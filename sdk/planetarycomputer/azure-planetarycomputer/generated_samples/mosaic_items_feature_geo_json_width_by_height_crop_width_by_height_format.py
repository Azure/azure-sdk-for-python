...
# USAGE
    python mosaic_items_feature_geo_json_width_by_height_crop_width_by_height_format.py
...
# x-ms-original-file: 2026-04-15/MosaicItemsFeatureGeoJsonWidthByHeight_CropWidthByHeightFormat.json
