...
class Screen(Model):
    ...
    :type classification:
     ~azure.cognitiveservices.contentmoderator.models.Classification
    ...
    :type pii: ~azure.cognitiveservices.contentmoderator.models.PII
    :param language: Language of the input text content.
    :type language: str
    :param terms:
    :type terms:
     list[~azure.cognitiveservices.contentmoderator.models.DetectedTerms]
