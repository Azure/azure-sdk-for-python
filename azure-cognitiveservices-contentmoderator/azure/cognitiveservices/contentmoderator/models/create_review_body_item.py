...
class CreateReviewBodyItem(Model):
    ...
    :type type: str or ~azure.cognitiveservices.contentmoderator.models.enum
    ...
    :type metadata:
     list[~azure.cognitiveservices.contentmoderator.models.CreateReviewBodyItemMetadataItem]
    """
