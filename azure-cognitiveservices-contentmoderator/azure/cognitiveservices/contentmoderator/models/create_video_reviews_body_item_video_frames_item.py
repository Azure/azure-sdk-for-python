...
class CreateVideoReviewsBodyItemVideoFramesItem(Model):
    ...
    :type reviewer_result_tags:
     list[~azure.cognitiveservices.contentmoderator.models.CreateVideoReviewsBodyItemVideoFramesItemReviewerResultTagsItem]
    :param metadata: Optional metadata details.
    :type metadata:
     list[~azure.cognitiveservices.contentmoderator.models.CreateVideoReviewsBodyItemVideoFramesItemMetadataItem]
    """
