...
class VideoFrameBodyItem(Model):
    ...
    :type reviewer_result_tags:
     list[~azure.cognitiveservices.contentmoderator.models.VideoFrameBodyItemReviewerResultTagsItem]
    :param metadata: Optional metadata details.
    :type metadata:
     list[~azure.cognitiveservices.contentmoderator.models.VideoFrameBodyItemMetadataItem]
    """
