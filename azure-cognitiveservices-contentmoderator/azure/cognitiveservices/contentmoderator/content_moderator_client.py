...
class ContentModeratorClientConfiguration(Configuration):
    ...
    :type base_url: str or
     ~azure.cognitiveservices.contentmoderator.models.AzureRegionBaseUrl
    ...
    def __init__(
        ...
        self.add_user_agent('azure-cognitiveservices-contentmoderator/{}'.format(VERSION))
...
class ContentModeratorClient(object):
    ...
    * Southeast Asia - southeastasia.api.cognitive.microsoft.com .
    ...
    :vartype image_moderation: azure.cognitiveservices.contentmoderator.operations.ImageModerationOperations
    :ivar text_moderation: TextModeration operations
    :vartype text_moderation: azure.cognitiveservices.contentmoderator.operations.TextModerationOperations
    :ivar list_management_image_lists: ListManagementImageLists operations
    :vartype list_management_image_lists: azure.cognitiveservices.contentmoderator.operations.ListManagementImageListsOperations
    :ivar list_management_term_lists: ListManagementTermLists operations
    :vartype list_management_term_lists: azure.cognitiveservices.contentmoderator.operations.ListManagementTermListsOperations
    :ivar list_management_image: ListManagementImage operations
    :vartype list_management_image: azure.cognitiveservices.contentmoderator.operations.ListManagementImageOperations
    :ivar list_management_term: ListManagementTerm operations
    :vartype list_management_term: azure.cognitiveservices.contentmoderator.operations.ListManagementTermOperations
    :ivar reviews: Reviews operations
    :vartype reviews: azure.cognitiveservices.contentmoderator.operations.ReviewsOperations
