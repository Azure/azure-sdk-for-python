...
class ComponentsSummaryOperations(object):
    """ComponentsSummaryOperations operations.
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.workloadmonitor.models.ComponentPaged[~azure.mgmt.workloadmonitor.models.Component]
        :raises:
        ...
        deserialized = models.ComponentPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ComponentPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response

        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.WorkloadMonitor/componentsSummary'}
