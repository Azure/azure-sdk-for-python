...
class ComponentsOperations(object):
    ...
    def list_by_resource(
        ...
        return deserialized
    list_by_resource.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceNamespace}/{resourceType}/{resourceName}/providers/Microsoft.WorkloadMonitor/components'}

    def get(
            self, resource_group_name, resource_namespace, resource_type, resource_name, component_id, select=None, expand=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: Component or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.workloadmonitor.models.Component or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('Component', response)
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceNamespace}/{resourceType}/{resourceName}/providers/Microsoft.WorkloadMonitor/components/{componentId}'}
