...
class DocumentDbCollectionDataset(Dataset):
    ...
    def __init__(self, linked_service_name, collection_name, description=None, structure=None, parameters=None):
        super(DocumentDbCollectionDataset, self).__init__(description=description, structure=structure, linked_service_name=linked_service_name, parameters=parameters)
