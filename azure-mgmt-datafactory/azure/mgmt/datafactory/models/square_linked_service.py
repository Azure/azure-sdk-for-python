...
class SquareLinkedService(LinkedService):
    ...
    def __init__(self, host, client_id, redirect_uri, connect_via=None, description=None, client_secret=None, use_encrypted_endpoints=None, use_host_verification=None, use_peer_verification=None, encrypted_credential=None):
        super(SquareLinkedService, self).__init__(connect_via=connect_via, description=description)
        self.host = host
