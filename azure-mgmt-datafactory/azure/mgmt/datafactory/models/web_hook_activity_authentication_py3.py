...
class WebHookActivityAuthentication(Model):
    """WebHook activity authentication properties.

    All required parameters must be populated in order to send to Azure.

    :param type: Required. WebHook activity authentication
    ...
    :param username: WebHook activity authentication user name for basic
     authentication.
    :type username: str
    ...
    def __init__(self, *, type: str, pfx=None, username: str=None, password=None, resource: str=None, **kwargs) -> None:
        super(WebHookActivityAuthentication, self).__init__(**kwargs)
        self.type = type
        self.pfx = pfx
