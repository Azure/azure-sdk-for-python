...
class AzureTableSource(CopySource):
    ...
    def __init__(self, source_retry_count=None, source_retry_wait=None, azure_table_source_query=None, azure_table_source_ignore_table_not_found=None):
        super(AzureTableSource, self).__init__(source_retry_count=source_retry_count, source_retry_wait=source_retry_wait)
