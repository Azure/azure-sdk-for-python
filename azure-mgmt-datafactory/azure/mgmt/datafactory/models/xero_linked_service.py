...
class XeroLinkedService(LinkedService):
    ...
    def __init__(self, host, connect_via=None, description=None, consumer_key=None, private_key=None, use_encrypted_endpoints=None, use_host_verification=None, use_peer_verification=None, encrypted_credential=None):
        super(XeroLinkedService, self).__init__(connect_via=connect_via, description=description)
        self.host = host
