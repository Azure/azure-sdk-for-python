...
class LinkedService(Model):
    ...
    sub-classes are: ResponsysLinkedService, AzureDatabricksLinkedService,
    ...
    GoogleAdWordsLinkedService, EloquaLinkedService, DrillLinkedService,
    ...
    SftpServerLinkedService, FtpServerLinkedService, RestServiceLinkedService,
    ...
    OracleServiceCloudLinkedService, OracleLinkedService,
    FileServerLinkedService, HDInsightLinkedService, DynamicsAXLinkedService,
