...
class HubspotLinkedService(LinkedService):
    ...
    def __init__(self, client_id, connect_via=None, description=None, client_secret=None, access_token=None, refresh_token=None, use_encrypted_endpoints=None, use_host_verification=None, use_peer_verification=None, encrypted_credential=None):
        super(HubspotLinkedService, self).__init__(connect_via=connect_via, description=description)
