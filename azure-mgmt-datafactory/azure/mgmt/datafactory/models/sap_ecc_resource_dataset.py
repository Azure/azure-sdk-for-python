...
class SapEccResourceDataset(Dataset):
    ...
    def __init__(self, linked_service_name, path, additional_properties=None, description=None, structure=None, parameters=None):
        super(SapEccResourceDataset, self).__init__(additional_properties=additional_properties, description=description, structure=structure, linked_service_name=linked_service_name, parameters=parameters)
        self.path = path
