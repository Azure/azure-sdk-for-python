...
class JiraLinkedService(LinkedService):
    ...
    def __init__(self, host, username, connect_via=None, description=None, port=None, password=None, use_encrypted_endpoints=None, use_host_verification=None, use_peer_verification=None, encrypted_credential=None):
        super(JiraLinkedService, self).__init__(connect_via=connect_via, description=description)
        self.host = host
        self.port = port
