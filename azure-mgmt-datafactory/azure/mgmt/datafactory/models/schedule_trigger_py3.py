...
class ScheduleTrigger(MultiplePipelineTrigger):
    ...
    def __init__(self, *, recurrence, additional_properties=None, description: str=None, pipelines=None, **kwargs) -> None:
        super(ScheduleTrigger, self).__init__(additional_properties=additional_properties, description=description, pipelines=pipelines, **kwargs)
