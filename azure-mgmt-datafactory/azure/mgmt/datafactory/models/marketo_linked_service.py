...
class MarketoLinkedService(LinkedService):
    ...
    def __init__(self, endpoint, client_id, connect_via=None, description=None, client_secret=None, use_encrypted_endpoints=None, use_host_verification=None, use_peer_verification=None, encrypted_credential=None):
        super(MarketoLinkedService, self).__init__(connect_via=connect_via, description=description)
