...
class ZohoLinkedService(LinkedService):
    ...
    def __init__(self, endpoint, connect_via=None, description=None, access_token=None, use_encrypted_endpoints=None, use_host_verification=None, use_peer_verification=None, encrypted_credential=None):
        super(ZohoLinkedService, self).__init__(connect_via=connect_via, description=description)
