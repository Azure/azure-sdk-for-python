...
class SqlServerStoredProcedureActivity(ExecutionActivity):
    ...
    def __init__(self, *, name: str, stored_procedure_name, description: str=None, depends_on=None, user_properties=None, linked_service_name=None, policy=None, stored_procedure_parameters=None, **kwargs) -> None:
        super(SqlServerStoredProcedureActivity, self).__init__(name=name, description=description, depends_on=depends_on, user_properties=user_properties, linked_service_name=linked_service_name, policy=policy, **kwargs)
