...
class ImpalaLinkedService(LinkedService):
    ...
    def __init__(self, host, authentication_type, connect_via=None, description=None, port=None, username=None, password=None, enable_ssl=None, trusted_cert_path=None, use_system_trust_store=None, allow_host_name_cn_mismatch=None, allow_self_signed_server_cert=None, encrypted_credential=None):
        super(ImpalaLinkedService, self).__init__(connect_via=connect_via, description=description)
        self.host = host
        self.port = port
