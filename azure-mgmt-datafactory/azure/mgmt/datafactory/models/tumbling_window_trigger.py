...
class TumblingWindowTrigger(Trigger):
    ...
    def __init__(self, pipeline, additional_properties=None, description=None, frequency=None, interval=None, start_time=None, end_time=None, delay=None, max_concurrency=None, retry_policy=None):
