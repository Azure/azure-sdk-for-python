...
class TumblingWindowTrigger(Trigger):
    ...
    _validation = {
        ...
        'max_concurrency': {'maximum': 50, 'minimum': 1},
    }
    ...
    def __init__(self, pipeline, description=None, frequency=None, interval=None, start_time=None, end_time=None, delay=None, max_concurrency=None, retry_policy=None):
        super(TumblingWindowTrigger, self).__init__(description=description)
