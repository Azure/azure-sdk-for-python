...
class Dataset(Model):
    ...
    EloquaObjectDataset, DrillTableDataset, CouchbaseTableDataset,
    ConcurObjectDataset, AzurePostgreSqlTableDataset, AmazonMWSObjectDataset,
    HttpDataset, AzureSearchIndexDataset, WebTableDataset, RestServiceDataset,
    SqlServerTableDataset, SapOpenHubTableDataset, SapEccResourceDataset,
