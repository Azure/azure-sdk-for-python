...
class Dataset(Model):
    ...
    sub-classes are: ResponsysObjectDataset,
    ...
    MariaDBTableDataset, MagentoObjectDataset, JiraObjectDataset,
    ImpalaObjectDataset, HubspotObjectDataset, HiveObjectDataset,
    HBaseObjectDataset, GreenplumTableDataset, GoogleBigQueryObjectDataset,
    GoogleAdWordsObjectDataset, EloquaObjectDataset, DrillTableDataset,
    CouchbaseTableDataset, ConcurObjectDataset, AzurePostgreSqlTableDataset,
    AmazonMWSObjectDataset, RestServiceDataset, HttpDataset,
    ...
    OracleServiceCloudObjectDataset, OracleTableDataset, ODataResourceDataset,
    MongoDbCollectionDataset, FileShareDataset, AzureDataLakeStoreDataset,
    DynamicsAXResourceDataset, DynamicsEntityDataset,
