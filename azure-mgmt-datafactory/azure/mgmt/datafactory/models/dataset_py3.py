...
class Dataset(Model):
    ...
    sub-classes are: SapOpenHubTableDataset, ResponsysObjectDataset,
    ...
    HttpDataset, AzureSearchIndexDataset, WebTableDataset,
    SqlServerTableDataset, SapEccResourceDataset,
