...
class ConcurLinkedService(LinkedService):
    ...
    def __init__(self, client_id, username, connect_via=None, description=None, password=None, use_encrypted_endpoints=None, use_host_verification=None, use_peer_verification=None, encrypted_credential=None):
        super(ConcurLinkedService, self).__init__(connect_via=connect_via, description=description)
