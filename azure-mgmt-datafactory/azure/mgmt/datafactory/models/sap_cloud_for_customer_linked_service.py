...
class SapCloudForCustomerLinkedService(LinkedService):
    ...
    def __init__(self, url, connect_via=None, description=None, username=None, password=None, encrypted_credential=None):
        super(SapCloudForCustomerLinkedService, self).__init__(connect_via=connect_via, description=description)
        self.url = url
