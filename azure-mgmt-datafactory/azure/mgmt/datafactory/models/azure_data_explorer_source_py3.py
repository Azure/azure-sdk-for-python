...
class AzureDataExplorerSource(CopySource):
    ...
    def __init__(self, *, query, additional_properties=None, source_retry_count=None, source_retry_wait=None, no_truncation=None, query_timeout=None, **kwargs) -> None:
        super(AzureDataExplorerSource, self).__init__(additional_properties=additional_properties, source_retry_count=source_retry_count, source_retry_wait=source_retry_wait, **kwargs)
        self.query = query
