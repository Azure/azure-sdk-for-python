...
class IntegrationRuntimesOperations(object):
    ...
    def create_linked_integration_runtime(
            self, resource_group_name, factory_name, integration_runtime_name, create_linked_integration_runtime_request, custom_headers=None, raw=False, **operation_config):
        ...
        :param integration_runtime_name: The integration runtime name.
        :type integration_runtime_name: str
        :param create_linked_integration_runtime_request: The linked
    ...
    def enable_integration_runtime_interactive_query(
        ...
        # Construct URL
        url = self.enable_integration_runtime_interactive_query.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'factoryName': self._serialize.url("factory_name", factory_name, 'str', max_length=63, min_length=3, pattern=r'^[A-Za-z0-9]+(?:-[A-Za-z0-9]+)*$'),
        ...
        # Construct body
        body_content = self._serialize.body(enable_interactive_query_for_integration_runtime_request, 'EnableInteractiveQueryForIntegrationRuntimeRequest')
    ...
    def disable_integration_runtime_interactive_query(
        ...
        """
        # Construct URL
        url = self.disable_integration_runtime_interactive_query.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'factoryName': self._serialize.url("factory_name", factory_name, 'str', max_length=63, min_length=3, pattern=r'^[A-Za-z0-9]+(?:-[A-Za-z0-9]+)*$'),
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    disable_integration_runtime_interactive_query.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/integrationRuntimes/{integrationRuntimeName}/disableInteractiveQuery'}
