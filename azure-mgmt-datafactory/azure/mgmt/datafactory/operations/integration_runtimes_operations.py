...
class IntegrationRuntimesOperations(object):
    ...
    def remove_links(
            self, resource_group_name, factory_name, integration_runtime_name, factory_name1, custom_headers=None, raw=False, **operation_config):
        ...
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        linked_integration_runtime_request = models.LinkedIntegrationRuntimeRequest(factory_name=factory_name1)
