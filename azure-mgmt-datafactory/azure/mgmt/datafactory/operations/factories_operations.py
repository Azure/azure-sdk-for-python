...
class FactoriesOperations(object):
    ...
    def configure_repo(
        ...
        return deserialized
    configure_repo.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/configureRepo'}
