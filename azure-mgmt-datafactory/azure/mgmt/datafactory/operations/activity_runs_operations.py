...
class ActivityRunsOperations(object):
    ...
    def list_by_pipeline_run(
        ...
        def internal_paging(next_link=None, raw=False):
            ...
            if not next_link:
                # Construct URL
                url = '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/pipelineruns/{runId}/activityruns'
