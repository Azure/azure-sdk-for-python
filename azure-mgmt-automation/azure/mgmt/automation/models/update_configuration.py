...
class UpdateConfiguration(Model):
    ...
    :param operating_system: operating system of target machines. Possible
    ...
    def __init__(self, operating_system, windows=None, linux=None, duration=None, azure_virtual_machines=None, non_azure_computer_names=None):
