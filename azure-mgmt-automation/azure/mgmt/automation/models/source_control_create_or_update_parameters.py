...
class SourceControlCreateOrUpdateParameters(Model):
    ...
    def __init__(self, repo_url=None, branch=None, folder_path=None, auto_sync=None, publish_runbook=None, source_type=None, security_token=None, description=None):
        super(SourceControlCreateOrUpdateParameters, self).__init__()
