...
class DscCompilationJobCreateParameters(Model):
    ...
    def __init__(self, *, configuration, parameters=None, new_node_configuration_build_version_required: bool=None, name: str=None, location: str=None, tags=None, **kwargs) -> None:
