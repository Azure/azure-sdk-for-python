...
class DscReportError(Model):
    ...
    def __init__(self, error_source=None, resource_id=None, error_code=None, error_message=None, locale=None, error_details=None):
        super(DscReportError, self).__init__()
