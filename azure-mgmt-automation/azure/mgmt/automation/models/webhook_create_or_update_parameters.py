...
class WebhookCreateOrUpdateParameters(Model):
    ...
    def __init__(self, name, is_enabled=None, uri=None, expiry_time=None, parameters=None, runbook=None, run_on=None):
        super(WebhookCreateOrUpdateParameters, self).__init__()
        self.name = name
