...
class ScheduleCreateOrUpdateParameters(Model):
    ...
    :param frequency: Possible values include: 'OneTime', 'Day', 'Hour',
     'Week', 'Month'
    ...
    def __init__(self, name, start_time, frequency, description=None, expiry_time=None, interval=None, time_zone=None, advanced_schedule=None):
        super(ScheduleCreateOrUpdateParameters, self).__init__()
        self.name = name
