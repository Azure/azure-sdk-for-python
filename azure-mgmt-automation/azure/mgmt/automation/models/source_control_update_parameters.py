...
class SourceControlUpdateParameters(Model):
    ...
    def __init__(self, branch=None, folder_path=None, auto_sync=None, publish_runbook=None, security_token=None, description=None):
        super(SourceControlUpdateParameters, self).__init__()
        self.branch = branch
