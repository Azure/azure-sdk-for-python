...
class RunbookUpdateParameters(Model):
    ...
    def __init__(self, description=None, log_verbose=None, log_progress=None, log_activity_trace=None, name=None, location=None, tags=None):
        super(RunbookUpdateParameters, self).__init__()
