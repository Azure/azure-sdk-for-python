...
class DscReportResource(Model):
    ...
    def __init__(self, resource_id=None, source_info=None, depends_on=None, module_name=None, module_version=None, resource_name=None, error=None, status=None, duration_in_seconds=None, start_date=None):
        super(DscReportResource, self).__init__()
