...
class DscMetaConfiguration(Model):
    ...
    def __init__(self, configuration_mode_frequency_mins=None, reboot_node_if_needed=None, configuration_mode=None, action_after_reboot=None, certificate_id=None, refresh_frequency_mins=None, allow_module_overwrite=None):
        super(DscMetaConfiguration, self).__init__()
