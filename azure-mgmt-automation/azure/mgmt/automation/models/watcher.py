...
class Watcher(TrackedResource):
    ...
    :param status: Gets the current status of the watcher.
    :type status: str
    ...
    :param last_modified_by: Details of the user who last modified the
     watcher.
    ...
    def __init__(self, tags=None, location=None, execution_frequency_in_seconds=None, script_name=None, script_parameters=None, script_run_on=None, status=None, creation_time=None, last_modified_time=None, last_modified_by=None, description=None, etag=None):
        super(Watcher, self).__init__(tags=tags, location=location)
