...
class Watcher(TrackedResource):
    ...
    def __init__(self, tags=None, location=None, execution_frequency_in_seconds=None, script_name=None, script_parameters=None, script_run_on=None, description=None, etag=None):
