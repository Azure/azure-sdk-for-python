...
class NodeCountInformationOperations(object):
    ...
    def get(
            self, resource_group_name, automation_account_name, count_type, custom_headers=None, raw=False, **operation_config):
        ...
        :param count_type: The type of counts to retrieve. Possible values
        ...
        :return: NodeCounts or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.automation.models.NodeCounts or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('NodeCounts', response)
