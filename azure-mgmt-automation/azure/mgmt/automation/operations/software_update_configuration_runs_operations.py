...
class SoftwareUpdateConfigurationRunsOperations(object):
    ...
    def get_by_id(
            self, automation_account_name, software_update_configuration_run_id, client_request_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SoftwareUpdateConfigurationRun', response)
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/softwareUpdateConfigurationRuns'}
