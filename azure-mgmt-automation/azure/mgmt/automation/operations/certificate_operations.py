...
class CertificateOperations(object):
    ...
    def list_by_automation_account(
        ...
        :rtype:
         ~azure.mgmt.automation.models.CertificatePaged[~azure.mgmt.automation.models.Certificate]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.automation.models.ErrorResponseException>`
        """
        ...
        return deserialized
    list_by_automation_account.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/certificates'}
