...
class IotHubClientConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, subscription_id, api_version='2016-02-03', base_url=None):
...
class IotHubClient(object):
    ...
    def __init__(
        ...
        self.config = IotHubClientConfiguration(credentials, subscription_id, api_version, base_url)
