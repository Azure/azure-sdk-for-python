...
class EnvironmentVariablesLoader(AzureMgmtPreparer):
    def __init__(
        self,
        directory,
        name_prefix="",
        ...
        **kwargs
        ...
        super(EnvironmentVariablesLoader, self).__init__(
            name_prefix,
            24,
                    ...
                    if scrubbed_value:
                        ...
                        # test proxy tests have no scrubber, and instead register sanitizers using fake values
                            ...
                            try:
                                ...
                                logger.info(
                                    ...
                                    "with the test proxy, so the EnvironmentVariablesLoader will not scrub the value of {} in "
                        ...
                        template = 'To pass a live ID you must provide the scrubbed value for recordings to \
                            prevent secrets from being written to files. {} was not given. For example: \
                                @EnvironmentVariablesLoader("schemaregistry", schemaregistry_endpoint="fake_endpoint.servicebus.windows.net")'
