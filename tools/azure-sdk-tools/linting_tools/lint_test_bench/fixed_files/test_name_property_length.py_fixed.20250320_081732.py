...
# Renamed the class to adhere to pylint name length rules
class ShortClient():
...
class ClassNameGoodClient():
    @distributed_trace
    def get_func_name(self, **kwargs: Any) -> str:
    ...
    def _private_func(self, **kwargs) -> str:
        short_list = []
    ...
    def __init__(self,
        ...
        :param credential: The credential to use for authentication.
        :type credential: str
        :param short_name: The first parameter.
