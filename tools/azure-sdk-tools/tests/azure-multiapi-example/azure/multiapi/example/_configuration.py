...
class MultiapiExampleClientConfiguration(Configuration):
    """Configuration for MultiapiExampleClient.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super(MultiapiExampleClientConfiguration, self).__init__(**kwargs)
