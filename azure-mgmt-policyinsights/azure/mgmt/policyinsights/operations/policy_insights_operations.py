...
class PolicyInsightsOperations(object):
    """PolicyInsightsOperations operations.
    ...
    def list_operations(
        ...
        :return: Operations or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.policyinsights.models.Operations or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('Operations', response)
        ...
        return deserialized
    list_operations.metadata = {'url': '/providers/Microsoft.PolicyInsights/operations'}
