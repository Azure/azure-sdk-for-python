...
class NotificationHubsOperations(object):
    ...
    def check_availability(
        ...
        return deserialized
    check_availability.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/checkNotificationHubAvailability'}
