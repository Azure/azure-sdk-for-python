...
class SharedAccessAuthorizationRuleCreateOrUpdateParameters(Resource):
    ...
    def __init__(self, *, location: str, properties, tags=None, sku=None, **kwargs) -> None:
        super(SharedAccessAuthorizationRuleCreateOrUpdateParameters, self).__init__(location=location, tags=tags, sku=sku, **kwargs)
