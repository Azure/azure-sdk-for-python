...
class BillingProfilePricesheetOperations(object):
    ...
    def _download_initial(
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('PricesheetDownloadResponse', response)
            header_dict = {
                'Location': 'str',
                'Retry-After': 'str',
    ...
    def download(
            self, billing_account_id, billing_profile_id, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :return: An instance of LROPoller that returns
         PricesheetDownloadResponse or
         ClientRawResponse<PricesheetDownloadResponse> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.consumption.models.PricesheetDownloadResponse]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.consumption.models.PricesheetDownloadResponse]]
        :raises:
    ...
    download.metadata = {'url': '/providers/Microsoft.Consumption/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}/pricesheet/default/download'}
