...
class ChargesByEnrollmentAccountOperations(object):
    """ChargesByEnrollmentAccountOperations operations.
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/enrollmentAccounts/{enrollmentAccountId}/providers/Microsoft.Consumption/charges'}
