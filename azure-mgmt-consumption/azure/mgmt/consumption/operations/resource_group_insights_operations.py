...
class ResourceGroupInsightsOperations(object):
    """ResourceGroupInsightsOperations operations.
    ...
    def post(
        ...
        return deserialized
    post.metadata = {'url': '/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Consumption/Insights'}
