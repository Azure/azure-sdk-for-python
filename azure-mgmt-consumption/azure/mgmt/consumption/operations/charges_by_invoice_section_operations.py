...
class ChargesByInvoiceSectionOperations(object):
    ...
    def list(
            self, billing_account_id, invoice_section_id, start_date, end_date, apply=None, custom_headers=None, raw=False, **operation_config):
        ...
        :return: ChargesListByInvoiceSection or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.consumption.models.ChargesListByInvoiceSection or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ChargesListByInvoiceSection', response)
        ...
        return deserialized
    list.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/invoiceSections/{invoiceSectionId}/providers/Microsoft.Consumption/charges'}
