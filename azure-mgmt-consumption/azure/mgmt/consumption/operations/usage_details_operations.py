...
class UsageDetailsOperations(object):
    ...
    def list_by_for_billing_period_by_management_group(
            self, billing_period_name, expand=None, filter=None, skiptoken=None, top=None, query_options=None, custom_headers=None, raw=False, **operation_config):
        ...
        def internal_paging(next_link=None, raw=False):
            ...
            if not next_link:
                # Construct URL
                url = self.list_by_for_billing_period_by_management_group.metadata['url']
                path_format_arguments = {
        ...
        return deserialized
    list_by_for_billing_period_by_management_group.metadata = {'url': '/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}/providers/Microsoft.Consumption/usageDetails'}
