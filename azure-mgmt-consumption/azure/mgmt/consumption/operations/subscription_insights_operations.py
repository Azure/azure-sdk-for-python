...
class SubscriptionInsightsOperations(object):
    """SubscriptionInsightsOperations operations.
    ...
    def post(
        ...
        return deserialized
    post.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Consumption/Insights'}
