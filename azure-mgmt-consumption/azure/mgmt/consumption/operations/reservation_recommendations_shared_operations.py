...
class ReservationRecommendationsSharedOperations(object):
    ...
    def list_by_billing_profile(
        ...
        :return: An iterator like instance of ReservationRecommendationsShared
        :rtype:
         ~azure.mgmt.consumption.models.ReservationRecommendationsSharedPaged[~azure.mgmt.consumption.models.ReservationRecommendationsShared]
        :raises:
        ...
        deserialized = models.ReservationRecommendationsSharedPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ReservationRecommendationsSharedPaged(internal_paging, self._deserialize.dependencies, header_dict)
