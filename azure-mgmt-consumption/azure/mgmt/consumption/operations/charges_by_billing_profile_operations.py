...
class ChargesByBillingProfileOperations(object):
    ...
    def list(
        ...
        :return: ChargesListByBillingProfile or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.consumption.models.ChargesListByBillingProfile or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ChargesListByBillingProfile', response)
        ...
        return deserialized
    list.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}/providers/Microsoft.Consumption/charges'}
