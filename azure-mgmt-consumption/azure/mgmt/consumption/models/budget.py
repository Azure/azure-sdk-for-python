...
class Budget(ProxyResource):
    ...
    :type category: str or ~consumption.models.CategoryType
    ...
    :param time_grain: The time covered by a budget. Tracking of the amount
     ...
     'Quarterly', 'Annually'
    :type time_grain: str or ~consumption.models.TimeGrainType
