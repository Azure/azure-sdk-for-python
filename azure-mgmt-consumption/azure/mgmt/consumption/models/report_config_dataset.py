...
class ReportConfigDataset(Model):
    ...
    :param granularity: The granularity of rows in the report. Possible values
     include: 'Daily'
    :type granularity: str or ~azure.mgmt.consumption.models.GranularityType
    :param configuration: Has configuration information for the data in the
     ...
     provided.
    :type configuration:
     ~azure.mgmt.consumption.models.ReportConfigDatasetConfiguration
    ...
    :type aggregation: dict[str,
     ~azure.mgmt.consumption.models.ReportConfigAggregation]
    :param grouping: Array of group by expression to use in the report. Report
     can have upto 2 group by clauses.
    :type grouping: list[~azure.mgmt.consumption.models.ReportConfigGrouping]
    :param filter: Has filter expression to use in the report.
    :type filter: ~azure.mgmt.consumption.models.ReportConfigFilter
    """
    ...
    def __init__(self, granularity=None, configuration=None, aggregation=None, grouping=None, filter=None):
        super(ReportConfigDataset, self).__init__()
