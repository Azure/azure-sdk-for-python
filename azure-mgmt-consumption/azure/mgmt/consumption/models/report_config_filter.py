...
class ReportConfigFilter(Model):
    ...
    :param and_property: The logical "AND" expression. Must have atleast 2
     items.
    :type and_property:
     list[~azure.mgmt.consumption.models.ReportConfigFilter]
    :param or_property: The logical "OR" expression. Must have atleast 2
     items.
    :type or_property: list[~azure.mgmt.consumption.models.ReportConfigFilter]
    :param not_property: The logical "NOT" expression.
    :type not_property: ~azure.mgmt.consumption.models.ReportConfigFilter
    :param dimension: Has comparison expression for a dimension
    :type dimension:
     ~azure.mgmt.consumption.models.ReportConfigComparisonExpression
    :param tag: Has comparison expression for a tag
    :type tag: ~azure.mgmt.consumption.models.ReportConfigComparisonExpression
    """
    ...
    def __init__(self, and_property=None, or_property=None, not_property=None, dimension=None, tag=None):
        super(ReportConfigFilter, self).__init__()
