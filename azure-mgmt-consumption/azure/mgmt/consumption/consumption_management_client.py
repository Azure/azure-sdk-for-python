...
class ConsumptionManagementClient(object):
    ...
    :vartype usage_details: consumption.operations.UsageDetailsOperations
    :ivar marketplaces: Marketplaces operations
    :vartype marketplaces: consumption.operations.MarketplacesOperations
    :ivar reservations_summaries: ReservationsSummaries operations
    :vartype reservations_summaries: consumption.operations.ReservationsSummariesOperations
    :ivar reservations_details: ReservationsDetails operations
    :vartype reservations_details: consumption.operations.ReservationsDetailsOperations
    :ivar budgets: Budgets operations
    :vartype budgets: consumption.operations.BudgetsOperations
    :ivar operations: Operations operations
    :vartype operations: consumption.operations.Operations
    :ivar price_sheet: PriceSheet operations
    :vartype price_sheet: consumption.operations.PriceSheetOperations
