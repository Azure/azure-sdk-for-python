...
class ConsumptionManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, subscription_id, resource_group_name, budget_name, billing_period_name, reservation_order_id, reservation_id, base_url=None):
        ...
        if reservation_order_id is None:
            raise ValueError("Parameter 'reservation_order_id' must not be None.")
        if reservation_id is None:
            raise ValueError("Parameter 'reservation_id' must not be None.")
        if not base_url:
...
class ConsumptionManagementClient(object):
    ...
    def __init__(
        ...
        self.config = ConsumptionManagementClientConfiguration(credentials, subscription_id, resource_group_name, budget_name, billing_period_name, reservation_order_id, reservation_id, base_url)
