...
class AzureConfigurationClientTestBase(AzureMgmtTestCase):
    def __init__(self, method_name, client_class):
        super(AzureConfigurationClientTestBase, self).__init__(method_name)
    ...
    def setUp(self):
        super(AzureConfigurationClientTestBase, self).setUp()
    ...
    def tearDown(self):
        super(AzureConfigurationClientTestBase, self).tearDown()
