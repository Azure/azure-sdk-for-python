...
class ServerPropertiesForRestore(ServerPropertiesForCreate):
    ...
    def __init__(self, *, source_server_id: str, restore_point_in_time, storage_mb: int=None, version=None, ssl_enforcement=None, **kwargs) -> None:
        super(ServerPropertiesForRestore, self).__init__(storage_mb=storage_mb, version=version, ssl_enforcement=ssl_enforcement, **kwargs)
