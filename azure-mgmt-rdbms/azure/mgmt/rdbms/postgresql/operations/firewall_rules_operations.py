...
class FirewallRulesOperations(object):
    ...
    def create_or_update(
        ...
        :return:
         ...
         instance that returns :class:`FirewallRule
         <azure.mgmt.rdbms.postgresql.models.FirewallRule>` or
    ...
    def list_by_server(
        ...
        :return: An iterator like instance of :class:`FirewallRule
         <azure.mgmt.rdbms.postgresql.models.FirewallRule>`
        :rtype: :class:`FirewallRulePaged
         <azure.mgmt.rdbms.postgresql.models.FirewallRulePaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
