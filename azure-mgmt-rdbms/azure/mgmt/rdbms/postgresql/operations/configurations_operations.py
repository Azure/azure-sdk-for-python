...
class ConfigurationsOperations(object):
    ...
    def create_or_update(
        ...
        :return:
         ...
         <azure.mgmt.rdbms.postgresql.models.Configuration>` or
    ...
    def list_by_server(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of :class:`Configuration
         <azure.mgmt.rdbms.postgresql.models.Configuration>`
        :rtype: :class:`ConfigurationPaged
         <azure.mgmt.rdbms.postgresql.models.ConfigurationPaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
