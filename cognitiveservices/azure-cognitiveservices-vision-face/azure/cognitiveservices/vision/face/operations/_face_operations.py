...
class FaceOperations(object):
    ...
    def find_similar(
        self,
        face_id,  # type: str
        face_list_id=None,  # type: Optional[str]
        large_face_list_id=None,  # type: Optional[str]
        face_ids=None,  # type: Optional[List[str]]
        max_num_of_candidates_returned=20,  # type: Optional[int]
        mode="matchPerson",  # type: Optional[Union[str, "_models.FindSimilarMatchMode"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> List["_models.SimilarFace"]
    ...
    def group(
        self,
        face_ids,  # type: List[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.GroupResult"
    ...
    def identify(
        self,
        face_ids,  # type: List[str]
        person_group_id=None,  # type: Optional[str]
        large_person_group_id=None,  # type: Optional[str]
        max_num_of_candidates_returned=1,  # type: Optional[int]
        confidence_threshold=None,  # type: Optional[float]
        **kwargs  # type: Any
    ):
        # type: (...) -> List["_models.IdentifyResult"]
    ...
    def detect_with_url(
        self,
        url,  # type: str
        return_face_id=True,  # type: Optional[bool]
        return_face_landmarks=False,  # type: Optional[bool]
        return_face_attributes=None,  # type: Optional[List[Union[str, "_models.FaceAttributeType"]]]
        ...
        face_id_time_to_live=86400,  # type: Optional[int]
        **kwargs  # type: Any
    ):
        # type: (...) -> List["_models.DetectedFace"]
