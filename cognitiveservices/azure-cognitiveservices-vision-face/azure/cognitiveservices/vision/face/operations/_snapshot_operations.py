...
class SnapshotOperations(object):
    ...
    def take(
        self,
        type,  # type: Union[str, "_models.SnapshotObjectType"]
        object_id,  # type: str
        apply_scope,  # type: List[str]
    ...
    def list(
        self,
        type=None,  # type: Optional[Union[str, "_models.SnapshotObjectType"]]
        apply_scope=None,  # type: Optional[List[str]]
        **kwargs  # type: Any
    ):
