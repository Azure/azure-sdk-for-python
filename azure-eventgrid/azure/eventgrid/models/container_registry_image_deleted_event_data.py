...
class ContainerRegistryImageDeletedEventData(EventContent):
    ...
    def __init__(self, id=None, timestamp=None, action=None, target=None, request=None, actor=None, source=None):
        super(ContainerRegistryImageDeletedEventData, self).__init__(id=id, timestamp=timestamp, action=action, target=target, request=request, actor=actor, source=source)
