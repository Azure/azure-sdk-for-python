...
class IotHubDeviceDeletedEventData(Model):
    ...
    :type twin: ~azure.eventgrid.models.IotHubDeviceDeletedEventDataTwin
    """
    ...
    _attribute_map = {
        ...
        'twin': {'key': 'twin', 'type': 'IotHubDeviceDeletedEventDataTwin'},
    }

    def __init__(self, device_id=None, hub_name=None, op_type=None, operation_timestamp=None, twin=None):
        super(IotHubDeviceDeletedEventData, self).__init__()
