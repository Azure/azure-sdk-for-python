...
class IotHubDeviceDeletedEventDataTwin(Model):
    ...
    :type properties:
     ~azure.eventgrid.models.IotHubDeviceDeletedEventDataTwinProperties
    ...
    :type x509_thumbprint:
     ~azure.eventgrid.models.IotHubDeviceDeletedEventDataTwinX509Thumbprint
    """
    ...
    _attribute_map = {
        ...
        'properties': {'key': 'properties', 'type': 'IotHubDeviceDeletedEventDataTwinProperties'},
        'status': {'key': 'status', 'type': 'str'},
        'status_update_time': {'key': 'statusUpdateTime', 'type': 'str'},
        'version': {'key': 'version', 'type': 'float'},
        'x509_thumbprint': {'key': 'x509Thumbprint', 'type': 'IotHubDeviceDeletedEventDataTwinX509Thumbprint'},
    }
    ...
    def __init__(self, authentication_type=None, cloud_to_device_message_count=None, connection_state=None, device_id=None, etag=None, last_activity_time=None, properties=None, status=None, status_update_time=None, version=None, x509_thumbprint=None):
        super(IotHubDeviceDeletedEventDataTwin, self).__init__()
