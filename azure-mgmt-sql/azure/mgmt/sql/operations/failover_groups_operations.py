...
class FailoverGroupsOperations(object):
    ...
    def get(
        ...
        :rtype: :class:`FailoverGroupResource
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('FailoverGroupResource', response)
    ...
    def create_or_update(
        ...
        :rtype:
         ...
         instance that returns :class:`FailoverGroupResource
         <azure.mgmt.sql.models.FailoverGroupResource>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        ...
        # Construct body
        body_content = self._serialize.body(self.config.failover_group, 'FailoverGroupResource')
    ...
    def list_by_server(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :rtype: :class:`FailoverGroupResourceList
         <azure.mgmt.sql.models.FailoverGroupResourceList>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('FailoverGroupResourceList', response)
    ...
    def failover(
            self, resource_group_name, server_name, failover_group_name, custom_headers=None, raw=False, **operation_config):
        """Sets which server is primary by failing over from the current primary
        server.
    ...
    def force_failover_allow_data_loss(
            self, resource_group_name, server_name, failover_group_name, custom_headers=None, raw=False, **operation_config):
        """Sets which server is primary by failing over from the current primary
        server. This operation might result in data loss.
