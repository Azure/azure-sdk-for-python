...
class ServerDnsAliasesOperations(object):
    ...
    def list_by_server(
        ...
        deserialized = models.ServerDnsAliasPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ServerDnsAliasPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
