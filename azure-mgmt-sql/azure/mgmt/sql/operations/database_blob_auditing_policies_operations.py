...
class DatabaseBlobAuditingPoliciesOperations(object):
    ...
    def create_or_update(
            self, resource_group_name, server_name, database_name, database_blob_auditing_policy, custom_headers=None, raw=False, **operation_config):
        ...
        :type database_name: str
        :param database_blob_auditing_policy: The name of the database blob
         auditing policy.
        :type database_blob_auditing_policy:
        ...
        # Construct body
        body_content = self._serialize.body(database_blob_auditing_policy, 'DatabaseBlobAuditingPolicy')
