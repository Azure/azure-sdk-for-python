...
class JobExecutionsOperations(object):
    ...
    def list_by_agent(
            self, resource_group_name, server_name, job_agent_name, skip=None, custom_headers=None, raw=False, **operation_config):
    ...
    def create(
        ...
        :param bool raw: returns the direct response alongside the
         deserialized response
        :return: An instance of AzureOperationPoller that returns JobExecution
    ...
    def list_by_job(
            self, resource_group_name, server_name, job_agent_name, job_name, skip=None, custom_headers=None, raw=False, **operation_config):
