...
class DatabaseThreatDetectionPoliciesOperations(object):
    ...
    def create_or_update(
            self, resource_group_name, server_name, database_name, database_security_alert_policy, custom_headers=None, raw=False, **operation_config):
        ...
        :param database_name: The name of the database for which database
         Threat Detection policy is defined.
        :type database_name: str
        :param database_security_alert_policy: The database Threat Detection
         policy.
        :type database_security_alert_policy:
        ...
        # Construct body
        body_content = self._serialize.body(database_security_alert_policy, 'DatabaseSecurityAlertPolicy')
