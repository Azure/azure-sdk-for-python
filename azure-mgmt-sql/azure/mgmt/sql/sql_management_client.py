...
from .operations.transparent_data_encryption_configurations_operations import TransparentDataEncryptionConfigurationsOperations
...
class SqlManagementClient(object):
    ...
    :ivar transparent_data_encryption_configurations: TransparentDataEncryptionConfigurations operations
    :vartype transparent_data_encryption_configurations: azure.mgmt.sql.operations.TransparentDataEncryptionConfigurationsOperations
    ...
    def __init__(
        ...
        self.service_tier_advisors = ServiceTierAdvisorsOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.transparent_data_encryption_configurations = TransparentDataEncryptionConfigurationsOperations(
            self._client, self.config, self._serialize, self._deserialize)
