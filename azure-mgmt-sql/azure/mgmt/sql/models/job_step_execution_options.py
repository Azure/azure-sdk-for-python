...
class JobStepExecutionOptions(Model):
    ...
    def __init__(self, timeout_seconds=43200, retry_attempts=10, initial_retry_interval_seconds=1, maximum_retry_interval_seconds=120, retry_interval_backoff_multiplier=2):
        super(JobStepExecutionOptions, self).__init__()
