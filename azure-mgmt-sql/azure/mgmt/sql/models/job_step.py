...
class JobStep(ProxyResource):
    ...
    :type step_id: int
    :param target_group: The resource ID of the target group that the job step
     will be executed on.
    :type target_group: str
    :param credential: The resource ID of the job credential that will be used
    ...
    def __init__(self, target_group, credential, action, step_id=None, output=None, execution_options=None):
