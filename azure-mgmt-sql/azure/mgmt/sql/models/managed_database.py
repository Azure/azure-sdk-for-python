...
class ManagedDatabase(TrackedResource):
    ...
    def __init__(self, location, tags=None, collation=None, catalog_collation=None, create_mode=None, restore_point_in_time=None, source_database_id=None, storage_container_uri=None, storage_container_sas_token=None):
        super(ManagedDatabase, self).__init__(tags=tags, location=location)
