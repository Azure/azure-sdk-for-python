...
class Database(TrackedResource):
    ...
    def __init__(self, *, location: str, tags=None, collation: str=None, create_mode=None, source_database_id: str=None, source_database_deletion_date=None, restore_point_in_time=None, recovery_services_recovery_point_resource_id: str=None, edition=None, max_size_bytes: str=None, requested_service_objective_id: str=None, requested_service_objective_name=None, elastic_pool_name: str=None, read_scale=None, sample_name=None, zone_redundant: bool=None, **kwargs) -> None:
