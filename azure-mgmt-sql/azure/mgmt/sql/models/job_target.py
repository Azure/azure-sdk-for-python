...
class JobTarget(Model):
    ...
    :param type: The target type. Possible values include: 'TargetGroup',
    ...
    def __init__(self, type, membership_type="Include", server_name=None, database_name=None, elastic_pool_name=None, shard_map_name=None, refresh_credential=None):
        super(JobTarget, self).__init__()
