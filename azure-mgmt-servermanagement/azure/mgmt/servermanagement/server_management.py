...
class ServerManagementConfiguration(AzureConfiguration):
    ...
    def __init__(
        ...
        self.add_user_agent('azure-mgmt-servermanagement/{}'.format(VERSION))
...
class ServerManagement(SDKClient):
    ...
    :vartype gateway: azure.mgmt.servermanagement.operations.GatewayOperations
    :ivar node: Node operations
    :vartype node: azure.mgmt.servermanagement.operations.NodeOperations
    :ivar session: Session operations
    :vartype session: azure.mgmt.servermanagement.operations.SessionOperations
    :ivar power_shell: PowerShell operations
    :vartype power_shell: azure.mgmt.servermanagement.operations.PowerShellOperations
