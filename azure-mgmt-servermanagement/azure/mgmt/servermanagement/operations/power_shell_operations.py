...
class PowerShellOperations(object):
    ...
    def create_session(
        ...
        :rtype:
         ...
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.servermanagement.models.PowerShellSessionResource]]
        :raises:
         :class:`ErrorException<azure.mgmt.servermanagement.models.ErrorException>`
        """
    ...
    def update_command(
        ...
        :rtype:
         ...
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.servermanagement.models.PowerShellCommandResults]]
        :raises:
         :class:`ErrorException<azure.mgmt.servermanagement.models.ErrorException>`
        """
