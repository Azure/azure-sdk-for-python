...
class GatewayOperations(object):
    ...
    def create(
        ...
        :rtype:
         ...
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.servermanagement.models.GatewayResource]]
        :raises:
    ...
    def get_profile(
        ...
        :rtype:
         ...
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.servermanagement.models.GatewayProfile]]
        :raises:
         :class:`ErrorException<azure.mgmt.servermanagement.models.ErrorException>`
        """
