...
class ValidationMethod(str, Enum):
    ...
    email = "email"  #: Issuer will validate requests via email.
    dns_txt_token = "dns-txt-token"  #: Issuer will validate requests via a DNS text token.
    http_token = "http-token"  #: Issuer will validate requests via an HTTP token.
