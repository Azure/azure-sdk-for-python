...
class KeyVaultClient(object):
    ...
    def get_deleted_keys(
        ...
        Retrieves a list of the keys in the Key Vault as JSON Web Key
        structures that contain the public part of a deleted key. The Get
        Deleted Keys operation is applicable for soft-delete enabled vaults. It
        requires the keys/list permission to be enabled on this vault. While
        the operation can be invoked on any vault, it will return an error if
    ...
    def get_deleted_key(
        ...
        vaults. It requires the keys/list permission to be enabled on this
        vault. While the operation can be invoked on any vault, it will return
    ...
    def purge_deleted_key(
        ...
        vaults. It requires the keys/purge permission to be enabled on this
        vault. While the operation can be invoked on any vault, it will return
        an error if invoked on a non soft-delete enabled vault.
    ...
    def recover_deleted_key(
        ...
        be enabled on this vault. An attempt to recover an non-deleted key will
        return an error. Consider this the inverse of the delete operation on
