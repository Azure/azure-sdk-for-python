...
class ReservationOperations(object):
    ...
    def split(
        ...
        :type body: :class:`SplitRequest <reservations.models.SplitRequest>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :return:
         :class:`AzureOperationPoller<msrestazure.azure_operation.AzureOperationPoller>`
         instance that returns list of :class:`ReservationResponse
         <reservations.models.ReservationResponse>` or
    ...
    def merge(
        ...
        :param reservation_order_id: Order Id of the reservation
        :type reservation_order_id: str
        :param body: Information needed for commercial request for a
         reservation
        :type body: :class:`MergeRequest <reservations.models.MergeRequest>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :return:
    ...
    def list(
        ...
        :return: An iterator like instance of :class:`ReservationResponse
         <reservations.models.ReservationResponse>`
        :rtype: :class:`ReservationResponsePaged
         <reservations.models.ReservationResponsePaged>`
        :raises: :class:`ErrorException<reservations.models.ErrorException>`
        """
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: :class:`ReservationResponse
         <reservations.models.ReservationResponse>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype: :class:`ReservationResponse
         <reservations.models.ReservationResponse>` or
    ...
    def update(
        ...
        :type parameters: :class:`Patch <reservations.models.Patch>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :return:
         :class:`AzureOperationPoller<msrestazure.azure_operation.AzureOperationPoller>`
         instance that returns :class:`ReservationResponse
         <reservations.models.ReservationResponse>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype:
