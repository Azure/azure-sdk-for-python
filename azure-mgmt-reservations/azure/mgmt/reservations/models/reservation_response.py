...
class ReservationResponse(Model):
    ...
    :type location: str or :class:`enum <reservations.models.enum>`
    :param etag:
    :type etag: int
    ...
    :type kind: str or :class:`Kind <reservations.models.Kind>`
    :param sku:
    :type sku: :class:`SkuName <reservations.models.SkuName>`
    :param properties:
    :type properties: :class:`ReservationProperties
    ...
    def __init__(self, location=None, etag=None, kind=None, sku=None, properties=None):
