...
class ReservationOrderResponse(Model):
    ...
    def __init__(self, etag=None, display_name=None, request_date_time=None, created_date_time=None, expiry_date=None, original_quantity=None, term=None, provisioning_state=None, reservations=None):
        super(ReservationOrderResponse, self).__init__()
        self.etag = etag
        self.id = None
        self.name = None
