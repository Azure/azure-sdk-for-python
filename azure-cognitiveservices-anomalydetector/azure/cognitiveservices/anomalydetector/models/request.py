...
class Request(Model):
    ...
    :param series: Time series data points. Points should be sorted by
     timestamp in ascending order to match the anomaly detection result. If the
     data is not sorted correctly or there is duplicated timestamp, the API
    ...
    :param granularity: Can only be one of yearly, monthly, weekly, daily,
     hourly or minutely. Granularity is used for verify whether input series is
     valid. Possible values include: 'yearly', 'monthly', 'weekly', 'daily',
     'hourly', 'minutely'
    ...
    def __init__(self, series, granularity, custom_interval=None, period=None, max_anomaly_ratio=None, sensitivity=None):
