...
class LastDetectResponse(Model):
    ...
    def __init__(self, period, suggested_window, expected_value, upper_margin, lower_margin, is_anomaly, is_negative_anomaly, is_positive_anomaly):
        super(LastDetectResponse, self).__init__()
        self.period = period
