...
class DocumentDBConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, subscription_id, api_version='2015-04-08', accept_language='en-US', long_running_operation_retry_timeout=30, generate_client_request_id=True, base_url=None, filepath=None):
        ...
        super(DocumentDBConfiguration, self).__init__(base_url, filepath)
...
class DocumentDB(object):
    ...
    def __init__(
        ...
        self.config = DocumentDBConfiguration(credentials, subscription_id, api_version, accept_language, long_running_operation_retry_timeout, generate_client_request_id, base_url, filepath)
