...
class LanguageExampleSuccessDictionaryLanguageCodeTranslationsItem(Model):
    ...
    def __init__(self, *, name: str=None, native_name: str=None, dir: str=None, code: str=None, **kwargs) -> None:
        super(LanguageExampleSuccessDictionaryLanguageCodeTranslationsItem, self).__init__(**kwargs)
        self.name = name
