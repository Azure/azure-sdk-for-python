...
class SubscriptionFactoryOperations(object):
    ...
    def _customer_create_subscription_initial(
            self, billing_account_name, customer_name, body, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.customer_create_subscription.metadata['url']
        path_format_arguments = {
            'billingAccountName': self._serialize.url("billing_account_name", billing_account_name, 'str'),
        ...
        # Construct body
        body_content = self._serialize.body(body, 'CustomerSubscriptionCreationParameters')
    ...
    def customer_create_subscription(
        ...
        :param billing_account_name: The name of the commerce root billing
         account.
        :type billing_account_name: str
        :param customer_name: The customer for which the subscription is to be
         created.
        :type customer_name: str
        :param body: The subscription creation parameters.
        :type body:
         ~azure.mgmt.subscription.models.CustomerSubscriptionCreationParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :raises:
         :class:`ErrorResponseException<azure.mgmt.subscription.models.ErrorResponseException>`
        """
        raw_result = self._customer_create_subscription_initial(
            billing_account_name=billing_account_name,
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    customer_create_subscription.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/customers/{customerName}/providers/Microsoft.Subscription/createSubscription'}
