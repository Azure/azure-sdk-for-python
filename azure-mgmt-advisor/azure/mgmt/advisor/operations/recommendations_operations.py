...
class RecommendationsOperations(object):
    ...
    def get_generate_recommendations_status(
        ...
        """
        # Construct URL
        url = self.get_generate_recommendations_status.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    get_generate_recommendations_status.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/generateRecommendations/{operationId}'}
