...
class RecommendationMetadataOperations(object):
    ...
    def list(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: MetadataEntityListResult or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.advisor.models.MetadataEntityListResult or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('MetadataEntityListResult', response)
