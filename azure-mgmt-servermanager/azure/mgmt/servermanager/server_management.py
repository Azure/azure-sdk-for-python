...
class ServerManagementConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, subscription_id, api_version='2016-07-01-preview', base_url=None):
...
class ServerManagement(object):
    ...
    :vartype gateway: .operations.GatewayOperations
    :ivar node: Node operations
    :vartype node: .operations.NodeOperations
    :ivar session: Session operations
    :vartype session: .operations.SessionOperations
    :ivar power_shell: PowerShell operations
    :vartype power_shell: .operations.PowerShellOperations
    ...
    def __init__(
        ...
        self.config = ServerManagementConfiguration(credentials, subscription_id, api_version, base_url)
