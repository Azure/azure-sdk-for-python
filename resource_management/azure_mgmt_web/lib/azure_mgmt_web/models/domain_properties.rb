  ...
  module Models
    ...
    class DomainProperties
      ...
      def validate
        ...
        @domain_not_renewable_reasons.each{ |e| e.validate if e.respond_to?(:validate) } unless @domain_not_renewable_reasons.nil?
      end
      ...
      def self.serialize_object(object)
        ...
        serialized_property = object.domain_not_renewable_reasons
        output_object['domainNotRenewableReasons'] = serialized_property unless serialized_property.nil?
      ...
      # @return [DomainProperties] Deserialized object.
      #
      def self.deserialize_object(object)
        return if object.nil?
        output_object = DomainProperties.new
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element4|
            unless element4.nil?
              element4 = HostName.deserialize_object(element4)
            end
        ...
        deserialized_property = object['domainNotRenewableReasons']
        output_object.domain_not_renewable_reasons = deserialized_property
