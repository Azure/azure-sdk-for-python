  ...
  module Models
    ...
    class HostingEnvironmentProperties
      ...
      def validate
        ...
        @cluster_settings.each{ |e| e.validate if e.respond_to?(:validate) } unless @cluster_settings.nil?
      end
      ...
      def self.serialize_object(object)
        ...
        serialized_property = object.cluster_settings
        unless serialized_property.nil?
          serializedArray = []
          serialized_property.each do |element4|
            unless element4.nil?
              element4 = NameValuePair.serialize_object(element4)
            end
            serializedArray.push(element4)
          end
          serialized_property = serializedArray
        end
        output_object['clusterSettings'] = serialized_property unless serialized_property.nil?
      ...
      def self.deserialize_object(object)
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element5|
            unless element5.nil?
              element5 = WorkerPool.deserialize_object(element5)
            end
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element6|
            unless element6.nil?
              element6 = VirtualIPMapping.deserialize_object(element6)
            end
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element7|
            unless element7.nil?
              element7 = StampCapacity.deserialize_object(element7)
            end
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element8|
            unless element8.nil?
              element8 = NetworkAccessControlEntry.deserialize_object(element8)
            end
        ...
        deserialized_property = object['clusterSettings']
        unless deserialized_property.nil?
          deserialized_array = []
        ...
        output_object.cluster_settings = deserialized_property
