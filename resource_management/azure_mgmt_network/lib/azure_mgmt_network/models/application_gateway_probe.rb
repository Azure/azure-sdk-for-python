    ...
    class ApplicationGatewayProbe < MsRestAzure::SubResource
      ...
      def self.serialize_object(object)
        ...
        unless serialized_property.nil?
          serialized_property = ApplicationGatewayProbePropertiesFormat.serialize_object(serialized_property)
        end
      ...
      # @return [ApplicationGatewayProbe] Deserialized object.
      #
      def self.deserialize_object(object)
        return if object.nil?
        output_object = ApplicationGatewayProbe.new
        ...
        unless deserialized_property.nil?
          deserialized_property = ApplicationGatewayProbePropertiesFormat.deserialize_object(deserialized_property)
        end
