    ...
    class ApplicationGatewayBackendAddressPool < MsRestAzure::SubResource
      ...
      def self.serialize_object(object)
        ...
        unless serialized_property.nil?
          serialized_property = ApplicationGatewayBackendAddressPoolPropertiesFormat.serialize_object(serialized_property)
        end
      ...
      def self.deserialize_object(object)
        ...
        unless deserialized_property.nil?
          deserialized_property = ApplicationGatewayBackendAddressPoolPropertiesFormat.deserialize_object(deserialized_property)
        end
