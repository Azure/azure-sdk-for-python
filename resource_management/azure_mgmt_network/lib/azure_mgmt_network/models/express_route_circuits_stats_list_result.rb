...
module Azure::ARM::Network
  module Models
    ...
    class ExpressRouteCircuitsStatsListResult
      ...
      def self.serialize_object(object)
        ...
        unless serialized_property.nil?
          ...
          serialized_property.each do |element|
            unless element.nil?
              element = ExpressRouteCircuitStats.serialize_object(element)
            end
      ...
      # @return [ExpressRouteCircuitsStatsListResult] Deserialized object.
      #
      def self.deserialize_object(object)
        return if object.nil?
        output_object = ExpressRouteCircuitsStatsListResult.new
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element1|
            unless element1.nil?
              element1 = ExpressRouteCircuitStats.deserialize_object(element1)
            end
