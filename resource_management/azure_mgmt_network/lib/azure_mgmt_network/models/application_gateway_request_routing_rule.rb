    ...
    class ApplicationGatewayRequestRoutingRule < MsRestAzure::SubResource
      ...
      def self.serialize_object(object)
        ...
        unless serialized_property.nil?
          serialized_property = ApplicationGatewayRequestRoutingRulePropertiesFormat.serialize_object(serialized_property)
        end
      ...
      # @return [ApplicationGatewayRequestRoutingRule] Deserialized object.
      #
      def self.deserialize_object(object)
        return if object.nil?
        output_object = ApplicationGatewayRequestRoutingRule.new
        ...
        unless deserialized_property.nil?
          deserialized_property = ApplicationGatewayRequestRoutingRulePropertiesFormat.deserialize_object(deserialized_property)
        end
