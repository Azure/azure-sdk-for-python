  ...
  module Models
    ...
    class ExpressRouteCircuitsRoutesTableSummaryListResult
      ...
      def self.serialize_object(object)
        ...
        unless serialized_property.nil?
          ...
          serialized_property.each do |element|
            unless element.nil?
              element = ExpressRouteCircuitRoutesTableSummary.serialize_object(element)
            end
      ...
      def self.deserialize_object(object)
        ...
        output_object = ExpressRouteCircuitsRoutesTableSummaryListResult.new
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element1|
            unless element1.nil?
              element1 = ExpressRouteCircuitRoutesTableSummary.deserialize_object(element1)
            end
