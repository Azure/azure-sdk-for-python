...
module Azure::ARM::Network
  module Models
    ...
    class ExpressRouteCircuitsArpTableListResult
      ...
      def self.serialize_object(object)
        ...
        unless serialized_property.nil?
          ...
          serialized_property.each do |element|
            unless element.nil?
              element = ExpressRouteCircuitArpTable.serialize_object(element)
            end
      ...
      # @return [ExpressRouteCircuitsArpTableListResult] Deserialized object.
      #
      def self.deserialize_object(object)
        return if object.nil?
        output_object = ExpressRouteCircuitsArpTableListResult.new
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element1|
            unless element1.nil?
              element1 = ExpressRouteCircuitArpTable.deserialize_object(element1)
            end
