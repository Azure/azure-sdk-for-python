      ...
      def self.serialize_object(object)
        ...
        unless serialized_property.nil?
          ...
          serialized_property.each do |element|
            unless element.nil?
              element = ApplicationGatewayBackendAddressPool.serialize_object(element)
            end
        ...
        unless serialized_property.nil?
          ...
          serialized_property.each do |element2|
            unless element2.nil?
              element2 = InboundNatRule.serialize_object(element2)
            end
        ...
        serialized_property = object.private_ipaddress_version
        output_object['privateIPAddressVersion'] = serialized_property unless serialized_property.nil?
      ...
      def self.deserialize_object(object)
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element3|
            unless element3.nil?
              element3 = ApplicationGatewayBackendAddressPool.deserialize_object(element3)
            end
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element4|
            unless element4.nil?
              element4 = BackendAddressPool.deserialize_object(element4)
            end
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element5|
            unless element5.nil?
              element5 = InboundNatRule.deserialize_object(element5)
            end
        ...
        deserialized_property = object['privateIPAddressVersion']
        if (!deserialized_property.nil? && !deserialized_property.empty?)
        ...
        output_object.private_ipaddress_version = deserialized_property
