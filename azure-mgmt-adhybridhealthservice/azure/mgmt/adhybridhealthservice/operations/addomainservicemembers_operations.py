...
class AddomainservicemembersOperations(object):
    ...
    def get_service_members_v2(
        ...
        :return: AddsServiceMembers or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.adhybridhealthservice.models.AddsServiceMembers or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        url = self.get_service_members_v2.metadata['url']
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('AddsServiceMembers', response)
        ...
        return deserialized
    get_service_members_v2.metadata = {'url': '/providers/Microsoft.ADHybridHealthService/addsservices/{serviceName}/addomainservicemembers'}
