...
class AlertsOperations(object):
    ...
    def list_adds_alerts(
        ...
        def internal_paging(next_link=None, raw=False):
            ...
            if not next_link:
                # Construct URL
                url = self.list_adds_alerts.metadata['url']
        ...
        return deserialized
    list_adds_alerts.metadata = {'url': '/providers/Microsoft.ADHybridHealthService/addsservices/{serviceName}/alerts'}
