...
class ReplicationsummaryOperations(object):
    """ReplicationsummaryOperations operations.
    ...
    def get_replication_summaryv2(
        ...
        """
        # Construct URL
        url = self.get_replication_summaryv2.metadata['url']
        ...
        return deserialized
    get_replication_summaryv2.metadata = {'url': '/providers/Microsoft.ADHybridHealthService/addsservices/{serviceName}/replicationsummary'}
