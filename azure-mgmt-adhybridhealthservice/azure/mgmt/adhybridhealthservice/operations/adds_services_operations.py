...
class AddsServicesOperations(object):
    ...
    def get_user_preference(
        ...
        """
        # Construct URL
        url = self.get_user_preference.metadata['url']
        path_format_arguments = {
            'serviceName': self._serialize.url("service_name", service_name, 'str'),
        ...
        return deserialized
    get_user_preference.metadata = {'url': '/providers/Microsoft.ADHybridHealthService/addsservices/{serviceName}/features/{featureName}/userpreference'}
    ...
    def delete_user_preference(
        ...
        """
        # Construct URL
        url = self.delete_user_preference.metadata['url']
        path_format_arguments = {
            'serviceName': self._serialize.url("service_name", service_name, 'str'),
            'featureName': self._serialize.url("feature_name", feature_name, 'str')
        }
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    delete_user_preference.metadata = {'url': '/providers/Microsoft.ADHybridHealthService/addsservices/{serviceName}/features/{featureName}/userpreference'}
    ...
    def add_user_preference(
        ...
        # Construct URL
        url = self.add_user_preference.metadata['url']
        path_format_arguments = {
            'serviceName': self._serialize.url("service_name", service_name, 'str'),
            'featureName': self._serialize.url("feature_name", feature_name, 'str')
        }
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    add_user_preference.metadata = {'url': '/providers/Microsoft.ADHybridHealthService/addsservices/{serviceName}/features/{featureName}/userpreference'}
