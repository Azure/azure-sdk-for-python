...
class CreateImageList(Model):
    ...
    :type metadata:
     ~azure.cognitiveservices.vision.contentmoderator.models.CreateImageListMetadata
    """
    ...
    _attribute_map = {
        ...
        'metadata': {'key': 'metadata', 'type': 'CreateImageListMetadata'},
    }
