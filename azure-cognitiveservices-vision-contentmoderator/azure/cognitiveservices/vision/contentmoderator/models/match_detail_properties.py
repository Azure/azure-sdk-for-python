...
class MatchDetailProperties(Model):
    """The match detail.
    ...
    :type tags:
     list[~azure.cognitiveservices.vision.contentmoderator.models.MatchDetailTag]
    ...
    _attribute_map = {
        ...
        'match_id': {'key': 'matchId', 'type': 'str'},
        'source': {'key': 'source', 'type': 'str'},
        'tags': {'key': 'tags', 'type': '[MatchDetailTag]'},
