...
class CreateTermList(Model):
    ...
    :type metadata:
     ~azure.cognitiveservices.vision.contentmoderator.models.CreateTermListMetadata
    """
    ...
    _attribute_map = {
        ...
        'metadata': {'key': 'metadata', 'type': 'CreateTermListMetadata'},
    }
