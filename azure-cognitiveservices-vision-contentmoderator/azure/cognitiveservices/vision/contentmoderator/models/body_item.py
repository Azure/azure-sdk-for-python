...
class BodyItem(Model):
    ...
    :type metadata:
     list[~azure.cognitiveservices.vision.contentmoderator.models.BodyItemMetadataItem]
    """
    ...
    _attribute_map = {
        ...
        'metadata': {'key': 'Metadata', 'type': '[BodyItemMetadataItem]'},
    }

    def __init__(self, type=None, content=None, content_id=None, callback_endpoint=None, metadata=None):
        self.type = type
