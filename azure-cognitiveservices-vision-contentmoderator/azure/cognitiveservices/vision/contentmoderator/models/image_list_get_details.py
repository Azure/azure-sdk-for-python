...
class ImageListGetDetails(Model):
    ...
    :type metadata:
     ~azure.cognitiveservices.vision.contentmoderator.models.ImageListGetDetailsMetadata
    """
    ...
    _attribute_map = {
        ...
        'metadata': {'key': 'metadata', 'type': 'ImageListGetDetailsMetadata'},
    }
