...
class OperationalizationClusterCredentials(Model):
    ...
    def __init__(self, *, storage_account=None, container_registry=None, container_service=None, app_insights=None, service_auth_configuration=None, ssl_configuration=None, **kwargs) -> None:
