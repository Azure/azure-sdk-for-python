...
class AutoScaleConfiguration(Model):
    ...
    def __init__(self, *, status="Disabled", min_replicas: int=1, max_replicas: int=100, target_utilization: float=None, refresh_period_in_seconds: int=None, **kwargs) -> None:
