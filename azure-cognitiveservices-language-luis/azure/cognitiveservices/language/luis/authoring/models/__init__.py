...
try:
    ...
    from .version_setting_object_py3 import VersionSettingObject
    from .version_setting_update_object_py3 import VersionSettingUpdateObject
    ...
    from .version_setting_object import VersionSettingObject
    from .version_setting_update_object import VersionSettingUpdateObject
