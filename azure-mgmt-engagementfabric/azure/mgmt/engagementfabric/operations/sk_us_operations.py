...
class SKUsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.engagementfabric.models.SkuDescriptionPaged[~azure.mgmt.engagementfabric.models.SkuDescription]
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.EngagementFabric/skus'}
