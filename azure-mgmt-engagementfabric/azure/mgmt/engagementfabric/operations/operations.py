...
class Operations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.engagementfabric.models.OperationPaged[~azure.mgmt.engagementfabric.models.Operation]
        ...
        return deserialized
    list.metadata = {'url': '/providers/Microsoft.EngagementFabric/operations'}
