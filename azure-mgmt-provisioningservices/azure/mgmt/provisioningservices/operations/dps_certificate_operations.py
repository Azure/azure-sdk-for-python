...
class DpsCertificateOperations(object):
    ...
    def create_or_update(
            self, resource_group_name, provisioning_service_name, certificate_name, certificate=None, custom_headers=None, raw=False, **operation_config):
    ...
    def generate_verification_code(
            self, certificate_name, resource_group_name, provisioning_service_name, certificatename=None, certificateraw_bytes=None, certificateis_verified=None, certificatepurpose=None, certificatecreated=None, certificatelast_updated=None, certificatehas_private_key=None, certificatenonce=None, custom_headers=None, raw=False, **operation_config):
