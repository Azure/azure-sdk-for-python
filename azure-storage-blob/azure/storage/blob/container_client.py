...
class ContainerClient(object):
    ...
    def delete_container(self, lease=None, if_modified_since=None, if_unmodified_since=None,
    ...
    def set_container_acl(self, signed_identifiers=None, public_access=None, lease=None,
