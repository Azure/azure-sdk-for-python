...
class ServiceAssociationLinkOperations(object):
    ...
    :ivar api_version: Client API version. Constant value: "2019-01-01".
    """
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}/providers/Microsoft.ContainerInstance/serviceAssociationLinks/default'}
