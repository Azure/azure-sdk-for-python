...
class DiscriminatedClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype envelope: typetest.discriminatedunion.aio.operations.EnvelopeOperations
    :ivar no_envelope: NoEnvelopeOperations operations
    :vartype no_envelope: typetest.discriminatedunion.aio.operations.NoEnvelopeOperations
