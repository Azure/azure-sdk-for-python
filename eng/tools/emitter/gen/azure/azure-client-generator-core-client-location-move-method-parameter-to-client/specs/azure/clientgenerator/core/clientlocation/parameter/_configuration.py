...
class MoveMethodParameterToClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for MoveMethodParameterToClient.
    ...
    def __init__(self, storage_account: str, endpoint: str = "http://localhost:3000", **kwargs: Any) -> None:
        ...
        kwargs.setdefault("sdk_moniker", "specs-azure-clientgenerator-core-clientlocation-parameter/{}".format(VERSION))
