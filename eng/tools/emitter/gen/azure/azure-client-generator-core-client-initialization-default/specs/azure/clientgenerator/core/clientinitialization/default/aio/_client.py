...
from ._operations import (
    ...
    _QueryParamClientOperationsMixin,
)
...
class QueryParamClient(_QueryParamClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        _endpoint = "{endpoint}"
        self._config = QueryParamClientConfiguration(blob_name=blob_name, endpoint=endpoint, **kwargs)
