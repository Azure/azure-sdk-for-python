...
class DocumentationOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~specs.azure.clientgenerator.core.clientdoc.aio.ClientDocClient`'s
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: ClientDocClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
        self._serialize: Serializer = input_args.pop(0) if input_args else kwargs.pop("serializer")
        self._deserialize: Deserializer = input_args.pop(0) if input_args else kwargs.pop("deserializer")

    @overload
    async def harvest(
        self, body: _models.Plant, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.Plant:
        """Retrieves a plant from the garden by submitting its name.

        :param body: Required.
        :type body: ~specs.azure.clientgenerator.core.clientdoc.models.Plant
    ...
    @overload
    async def harvest(self, body: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> _models.Plant:
        """Retrieves a plant from the garden by submitting its name.
    ...
    async def harvest(self, body: Union[_models.Plant, JSON, IO[bytes]], **kwargs: Any) -> _models.Plant:
        ...
        cls: ClsType[_models.Plant] = kwargs.pop("cls", None)
        ...
        _request = build_documentation_harvest_request(
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.Plant, response.json())
