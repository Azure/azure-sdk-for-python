...
class MoveToExistingSubClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype admin_operations:
     specs.azure.clientgenerator.core.clientlocation.subclient.operations.AdminOperationsOperations
    :ivar user_operations: UserOperationsOperations operations
    :vartype user_operations:
     specs.azure.clientgenerator.core.clientlocation.subclient.operations.UserOperationsOperations
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        _endpoint = "{endpoint}"
        self._config = MoveToExistingSubClientConfiguration(endpoint=endpoint, **kwargs)
