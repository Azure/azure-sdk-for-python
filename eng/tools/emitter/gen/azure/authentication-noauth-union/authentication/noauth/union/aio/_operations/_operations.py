...
from ..._operations._operations import build_union_valid_no_auth_request, build_union_valid_token_request
...
class _UnionClientOperationsMixin(
    ...
    async def valid_no_auth(self, **kwargs: Any) -> None:
        ...
        _request = build_union_valid_no_auth_request(
            headers=_headers,
            params=_params,
        )
