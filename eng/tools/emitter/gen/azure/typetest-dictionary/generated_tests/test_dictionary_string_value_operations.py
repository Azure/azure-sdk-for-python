...
class TestDictionaryStringValueOperations(DictionaryClientTestBase):
    @DictionaryPreparer()
    @recorded_by_proxy
    def test_string_value_get(self, dictionary_endpoint):
    ...
    @DictionaryPreparer()
    @recorded_by_proxy
    def test_string_value_put(self, dictionary_endpoint):
        client = self.create_client(endpoint=dictionary_endpoint)
