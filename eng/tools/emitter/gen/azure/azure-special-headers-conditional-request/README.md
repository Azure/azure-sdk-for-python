# Azure Specialheaders Conditionalrequest client library for Python
...
```bash
python -m pip install azure-specialheaders-conditionalrequest
```
...
- An existing Azure Specialheaders Conditionalrequest instance.
