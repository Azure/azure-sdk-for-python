...
class TestConditionalRequestAsync(ConditionalRequestClientTestBaseAsync):
    ...
    @ConditionalRequestPreparer()
    @recorded_by_proxy_async
    async def test_post_custom_if_match(self, conditionalrequest_endpoint):
        client = self.create_async_client(endpoint=conditionalrequest_endpoint)
        response = await client.post_custom_if_match()
    ...
    @ConditionalRequestPreparer()
    @recorded_by_proxy_async
    async def test_post_custom_if_none_match(self, conditionalrequest_endpoint):
        client = self.create_async_client(endpoint=conditionalrequest_endpoint)
        response = await client.post_custom_if_none_match()
