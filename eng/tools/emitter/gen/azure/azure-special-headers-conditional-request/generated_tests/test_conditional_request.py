...
class TestConditionalRequest(ConditionalRequestClientTestBase):
    ...
    @ConditionalRequestPreparer()
    @recorded_by_proxy
    def test_post_custom_if_match(self, conditionalrequest_endpoint):
        client = self.create_client(endpoint=conditionalrequest_endpoint)
        response = client.post_custom_if_match()
    ...
    @ConditionalRequestPreparer()
    @recorded_by_proxy
    def test_post_custom_if_none_match(self, conditionalrequest_endpoint):
        client = self.create_client(endpoint=conditionalrequest_endpoint)
        response = client.post_custom_if_none_match()
