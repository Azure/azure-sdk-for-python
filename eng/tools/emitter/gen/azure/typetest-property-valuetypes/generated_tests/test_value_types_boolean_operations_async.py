...
class TestValueTypesBooleanOperationsAsync(ValueTypesClientTestBaseAsync):
    @ValueTypesPreparer()
    @recorded_by_proxy_async
    async def test_boolean_get(self, valuetypes_endpoint):
    ...
    @ValueTypesPreparer()
    @recorded_by_proxy_async
    async def test_boolean_put(self, valuetypes_endpoint):
        client = self.create_async_client(endpoint=valuetypes_endpoint)
