...
from ..._operations._operations import build_pageable_list_without_continuation_request
...
class _PageableClientOperationsMixin(
    ...
    def list_without_continuation(self, **kwargs: Any) -> AsyncItemPaged["_models2.Pet"]:
