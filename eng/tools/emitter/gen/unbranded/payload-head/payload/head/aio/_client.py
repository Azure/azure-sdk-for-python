...
from ._operations import _HeadClientOperationsMixin
...
class HeadClient(_HeadClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        _endpoint = "{endpoint}"
        self._config = HeadClientConfiguration(endpoint=endpoint, **kwargs)
