...
# --------------------------------------------------------------------------
"""
Proxy decorators for httpx-based clients (e.g., OpenAI SDK).

These decorators monkeypatch httpx transport classes to redirect requests through the test proxy,
enabling recording and playback for clients that use httpx instead of Azure Core's transport layer.
"""
import logging
