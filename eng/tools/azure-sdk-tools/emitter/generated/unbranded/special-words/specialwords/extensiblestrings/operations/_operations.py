...
class ExtensibleStringsOperations:
    ...
    def put_extensible_string_value(
        self, body: Union[str, _models1.ExtensibleString], **kwargs: Any
    ) -> Union[str, _models1.ExtensibleString]:
        ...
        cls: ClsType[Union[str, _models1.ExtensibleString]] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(Union[str, _models1.ExtensibleString], response.json())
