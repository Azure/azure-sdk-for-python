...
class ModelPropertiesOperations:  # pylint: disable=docstring-missing-param
    ...
    @overload
    def same_as_model(
        self, body: _types_models1.SameAsModel, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """same_as_model.
    ...
    def same_as_model(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models1.SameAsModel, _types_models1.SameAsModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """same_as_model.
    ...
    @overload
    def dict_methods(
        self, body: _types_models1.DictMethods, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """dict_methods.
    ...
    def dict_methods(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models1.DictMethods, _types_models1.DictMethods, IO[bytes]], **kwargs: Any
    ) -> None:
        """dict_methods.
    ...
    @overload
    def with_list(
        self, body: _types_models1.ModelWithList, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """with_list.
    ...
    def with_list(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models1.ModelWithList, _types_models1.ModelWithList, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_list.
