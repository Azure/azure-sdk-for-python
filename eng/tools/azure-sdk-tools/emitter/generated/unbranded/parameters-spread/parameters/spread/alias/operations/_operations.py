...
class AliasOperations:  # pylint: disable=docstring-missing-param
    ...
    def spread_as_request_body(
        self, body: _types_models1.SpreadAsRequestBodyRequest, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """spread_as_request_body.
    ...
    def spread_as_request_body(  # pylint: disable=inconsistent-return-statements
        self,
        body: Union[JSON, _types_models1.SpreadAsRequestBodyRequest, IO[bytes]] = _Unset,
        *,
        name: str = _Unset,
        **kwargs: Any
    ) -> None:
    ...
    def spread_parameter_with_inner_model(
        self,
        id: str,
        body: _types_models2.SpreadParameterWithInnerModelRequest,
        *,
    ...
    def spread_parameter_with_inner_model(  # pylint: disable=inconsistent-return-statements
        self,
        id: str,
        body: Union[JSON, _types_models2.SpreadParameterWithInnerModelRequest, IO[bytes]] = _Unset,
        *,
        x_ms_test_header: str,
        name: str = _Unset,
        **kwargs: Any
    ...
    def spread_as_request_parameter(
        self,
        id: str,
        body: _types_models2.SpreadAsRequestParameterRequest,
        *,
        x_ms_test_header: str,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    def spread_as_request_parameter(  # pylint: disable=inconsistent-return-statements
        self,
        id: str,
        body: Union[JSON, _types_models2.SpreadAsRequestParameterRequest, IO[bytes]] = _Unset,
        *,
        x_ms_test_header: str,
        name: str = _Unset,
        **kwargs: Any
    ...
    def spread_with_multiple_parameters(
        self,
        id: str,
        body: _types_models2.SpreadWithMultipleParametersRequest,
        *,
        x_ms_test_header: str,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    def spread_with_multiple_parameters(  # pylint: disable=inconsistent-return-statements
        self,
        id: str,
        body: Union[JSON, _types_models2.SpreadWithMultipleParametersRequest, IO[bytes]] = _Unset,
        *,
        x_ms_test_header: str,
    ...
    def spread_parameter_with_inner_alias(
        self,
        id: str,
        body: _types_models2.SpreadParameterWithInnerAliasRequest,
        *,
        x_ms_test_header: str,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    def spread_parameter_with_inner_alias(  # pylint: disable=inconsistent-return-statements
        self,
        id: str,
        body: Union[JSON, _types_models2.SpreadParameterWithInnerAliasRequest, IO[bytes]] = _Unset,
        *,
        x_ms_test_header: str,
        name: str = _Unset,
        age: int = _Unset,
