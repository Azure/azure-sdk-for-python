...
class ModelValueOperations:
    ...
    @overload
    async def put(
        self, body: dict[str, types.InnerModel], *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """put.
    ...
    async def put(
        self, body: Union[dict[str, _models.InnerModel], dict[str, types.InnerModel], IO[bytes]], **kwargs: Any
    ) -> None:
        """put.
