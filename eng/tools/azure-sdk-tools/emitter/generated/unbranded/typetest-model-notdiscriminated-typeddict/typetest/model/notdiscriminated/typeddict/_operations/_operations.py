...
class _NotDiscriminatedClientOperationsMixin(
    ...
    def post_valid(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~typetest.model.notdiscriminated.typeddict.models.Siamese or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    def put_valid(self, input: Union[_models.Siamese, JSON, IO[bytes]], **kwargs: Any) -> _models.Siamese:
        """put_valid.
