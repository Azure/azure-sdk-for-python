...
def build_not_discriminated_post_valid_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
...
def build_not_discriminated_get_valid_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_not_discriminated_put_valid_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class _NotDiscriminatedClientOperationsMixin(
    ...
    def post_valid(self, input: _models.Siamese, *, content_type: str = "application/json", **kwargs: Any) -> None:
        ...
        :type input: ~typetest.model.notdiscriminated.typeddict.models.Siamese
    ...
    def post_valid(self, input: types.Siamese, *, content_type: str = "application/json", **kwargs: Any) -> None:
        ...
        :param input: Required.
        :type input: ~typetest.model.notdiscriminated.typeddict.types.Siamese
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    def post_valid(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~typetest.model.notdiscriminated.typeddict.models.Siamese or
         ~typetest.model.notdiscriminated.typeddict.types.Siamese or IO[bytes]
        :return: None
        :rtype: None
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    def get_valid(self, **kwargs: Any) -> _models.Siamese:
        ...
        :rtype: ~typetest.model.notdiscriminated.typeddict.models.Siamese
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    @overload
    def put_valid(self, input: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> _models.Siamese:
        """put_valid.
