...
class _RecursiveClientOperationsMixin(
    ...
    async def put(self, input: _models.Extension, *, content_type: str = "application/json", **kwargs: Any) -> None:
        ...
        :type input: ~generation.subdir._generated.models.Extension
    ...
    @overload
    async def put(self, input: types.Extension, *, content_type: str = "application/json", **kwargs: Any) -> None:
        """put.

        :param input: Required.
        :type input: ~generation.subdir._generated.types.Extension
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    async def put(self, input: Union[_models.Extension, types.Extension, IO[bytes]], **kwargs: Any) -> None:
        """put.

        :param input: Is either a Extension type or a IO[bytes] type. Required.
        :type input: ~generation.subdir._generated.models.Extension or
         ~generation.subdir._generated.types.Extension or IO[bytes]
        :return: None
        :rtype: None
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    async def get(self, **kwargs: Any) -> _models.Extension:
        """get.
