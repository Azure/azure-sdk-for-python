...
class PropertyOperations:
    ...
    async def safeint_as_string(
        self, value: Union[_models2.SafeintAsStringProperty, types.SafeintAsStringProperty, IO[bytes]], **kwargs: Any
    ) -> _models2.SafeintAsStringProperty:
        """safeint_as_string.
    ...
    async def uint32_as_string_optional(
        self, value: Union[_models2.Uint32AsStringProperty, types.Uint32AsStringProperty, IO[bytes]], **kwargs: Any
    ) -> _models2.Uint32AsStringProperty:
        """uint32_as_string_optional.
    ...
    async def uint8_as_string(
        self, value: Union[_models2.Uint8AsStringProperty, types.Uint8AsStringProperty, IO[bytes]], **kwargs: Any
    ) -> _models2.Uint8AsStringProperty:
        """uint8_as_string.
