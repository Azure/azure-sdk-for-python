...
from ...operations._operations import (
    build_protocol_id_request,
    build_protocol_invalid_id_request,
    build_protocol_invalid_retry_request,
    build_protocol_reconnect_request,
    build_protocol_retry_request,
)
...
class ProtocolOperations:  # pylint: disable=docstring-missing-param
    """
    .. warning::
    ...
    async def id(self, **kwargs: Any) -> AsyncStream[_models2.Info]:
        ...
        _request = build_protocol_id_request(
            headers=_headers,
            params=_params,
        )
    ...
    async def invalid_id(self, **kwargs: Any) -> AsyncStream[_models2.Info]:
        ...
        _request = build_protocol_invalid_id_request(
            headers=_headers,
            params=_params,
        )
        path_format_arguments = {
    ...
    async def retry(self, **kwargs: Any) -> AsyncStream[_models2.Info]:
        ...
        _request = build_protocol_retry_request(
            headers=_headers,
            params=_params,
        )
        path_format_arguments = {
    ...
    async def invalid_retry(self, **kwargs: Any) -> AsyncStream[_models2.Info]:
        ...
        _request = build_protocol_invalid_retry_request(
            headers=_headers,
            params=_params,
        )
        path_format_arguments = {
    ...
    async def reconnect(self, **kwargs: Any) -> AsyncStream[_models2.Info]:
        ...
        _request = build_protocol_reconnect_request(
            headers=_headers,
            params=_params,
        )
        path_format_arguments = {
