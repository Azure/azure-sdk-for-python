...
class PropertyOperations:  # pylint: disable=docstring-missing-param
    ...
    @overload
    async def send(
        self, body: _models2.JsonEncodedNameModel, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """send.
    ...
    @overload
    async def send(
        self, body: _types_models2.JsonEncodedNameModel, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """send.
    ...
    async def send(
        self, body: Union[_models2.JsonEncodedNameModel, _types_models2.JsonEncodedNameModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """send.
    ...
    async def get(self, **kwargs: Any) -> _models2.JsonEncodedNameModel:
        """get.
