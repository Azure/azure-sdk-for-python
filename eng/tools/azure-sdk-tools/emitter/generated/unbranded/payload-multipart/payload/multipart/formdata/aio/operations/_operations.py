...
class FormDataOperations:  # pylint: disable=docstring-missing-param
    ...
    @overload
    async def basic(self, body: _types_models3.MultiPartRequest, **kwargs: Any) -> None:
        """Test content-type: multipart/form-data.
    ...
    async def basic(
        self, body: Union[_models3.MultiPartRequest, _types_models3.MultiPartRequest], **kwargs: Any
    ) -> None:
        """Test content-type: multipart/form-data.
    ...
    @overload
    async def with_wire_name(self, body: _types_models3.MultiPartRequestWithWireName, **kwargs: Any) -> None:
        """Test content-type: multipart/form-data with wire names.
    ...
    async def with_wire_name(
        self,
        body: Union[_models3.MultiPartRequestWithWireName, _types_models3.MultiPartRequestWithWireName],
        **kwargs: Any
    ) -> None:
        """Test content-type: multipart/form-data with wire names.
    ...
    @overload
    async def optional_parts(self, body: _types_models3.MultiPartOptionalRequest, **kwargs: Any) -> None:
        """Test content-type: multipart/form-data with optional parts.
    ...
    async def optional_parts(
        self, body: Union[_models3.MultiPartOptionalRequest, _types_models3.MultiPartOptionalRequest], **kwargs: Any
    ) -> None:
        """Test content-type: multipart/form-data with optional parts.
    ...
    @overload
    async def file_array_and_basic(self, body: _types_models3.ComplexPartsRequest, **kwargs: Any) -> None:
        """Test content-type: multipart/form-data for mixed scenarios.
    ...
    async def file_array_and_basic(
        self, body: Union[_models3.ComplexPartsRequest, _types_models3.ComplexPartsRequest], **kwargs: Any
    ) -> None:
        """Test content-type: multipart/form-data for mixed scenarios.
    ...
    @overload
    async def json_part(self, body: _types_models3.JsonPartRequest, **kwargs: Any) -> None:
        """Test content-type: multipart/form-data for scenario contains json part and binary part.
    ...
    async def json_part(
        self, body: Union[_models3.JsonPartRequest, _types_models3.JsonPartRequest], **kwargs: Any
    ) -> None:
        """Test content-type: multipart/form-data for scenario contains json part and binary part.
    ...
    @overload
    async def binary_array_parts(self, body: _types_models3.BinaryArrayPartsRequest, **kwargs: Any) -> None:
        """Test content-type: multipart/form-data for scenario contains multi binary parts.
    ...
    async def binary_array_parts(
        self, body: Union[_models3.BinaryArrayPartsRequest, _types_models3.BinaryArrayPartsRequest], **kwargs: Any
    ) -> None:
        """Test content-type: multipart/form-data for scenario contains multi binary parts.
    ...
    @overload
    async def multi_binary_parts(self, body: _types_models3.MultiBinaryPartsRequest, **kwargs: Any) -> None:
        """Test content-type: multipart/form-data for scenario contains multi binary parts.
    ...
    async def multi_binary_parts(
        self, body: Union[_models3.MultiBinaryPartsRequest, _types_models3.MultiBinaryPartsRequest], **kwargs: Any
    ) -> None:
        """Test content-type: multipart/form-data for scenario contains multi binary parts.
    ...
    @overload
    async def check_file_name_and_content_type(self, body: _types_models3.MultiPartRequest, **kwargs: Any) -> None:
        """Test content-type: multipart/form-data.
    ...
    @overload
    async def anonymous_model(self, body: _types_models2.AnonymousModelRequest, **kwargs: Any) -> None:
        """Test content-type: multipart/form-data.
    ...
    async def anonymous_model(
        self, body: Union[_models2.AnonymousModelRequest, _types_models2.AnonymousModelRequest], **kwargs: Any
    ) -> None:
        """Test content-type: multipart/form-data.
