...
class BooleanClient:  # pylint: disable=client-accepts-api-version-keyword
    """Test for encode decorator on boolean.

    :ivar property: PropertyOperations operations
    :vartype property: encode.boolean.aio.operations.PropertyOperations
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        _endpoint = "{endpoint}"
        self._config = BooleanClientConfiguration(endpoint=endpoint, **kwargs)
