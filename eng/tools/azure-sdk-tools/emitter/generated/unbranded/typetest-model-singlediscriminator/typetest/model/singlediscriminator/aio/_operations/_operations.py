...
class _SingleDiscriminatorClientOperationsMixin(
    ...
    async def get_no_subtypes_model(self, **kwargs: Any) -> _models.Fish:
        ...
        :rtype: ~typetest.model.singlediscriminator.models.Fish
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def put_no_subtypes_model(
        ...
        :param input: Required.
        :type input: ~typetest.model.singlediscriminator.models.Fish
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    async def put_no_subtypes_model(self, input: Union[_models.Fish, JSON, IO[bytes]], **kwargs: Any) -> None:
        """put_no_subtypes_model.
