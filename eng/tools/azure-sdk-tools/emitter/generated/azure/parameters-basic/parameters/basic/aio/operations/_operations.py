...
class ExplicitBodyOperations:
    ...
    @overload
    async def simple(self, body: types.User, *, content_type: str = "application/json", **kwargs: Any) -> None:
        """simple.
    ...
    async def simple(self, body: Union[_models.User, types.User, IO[bytes]], **kwargs: Any) -> None:
        """simple.
