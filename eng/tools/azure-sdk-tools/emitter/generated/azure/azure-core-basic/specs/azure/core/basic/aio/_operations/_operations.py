...
class _BasicClientOperationsMixin(
    ...
    @overload
    async def create_or_update(
        self, id: int, resource: types.User, *, content_type: str = "application/merge-patch+json", **kwargs: Any
    ) -> _models.User:
        """Adds a user or updates a user's fields.
    ...
    async def create_or_update(
        self, id: int, resource: Union[_models.User, types.User, IO[bytes]], **kwargs: Any
    ) -> _models.User:
        """Adds a user or updates a user's fields.
    ...
    @overload
    async def create_or_replace(
        self, id: int, resource: types.User, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.User:
        """Adds a user or replaces a user's fields.
