...
class ModelsOperations:  # pylint: disable=too-many-public-methods
    ...
    def with_and(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.AndModel, types.AndModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_and.
    ...
    def with_as(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.AsModel, types.AsModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_as.
    ...
    def with_assert(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.AssertModel, types.AssertModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_assert.
    ...
    def with_async(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.AsyncModel, types.AsyncModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_async.
    ...
    def with_await(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.AwaitModel, types.AwaitModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_await.
    ...
    def with_break(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.BreakModel, types.BreakModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_break.
    ...
    def with_class(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.ClassModel, types.ClassModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_class.
    ...
    def with_def(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.DefModel, types.DefModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_def.
    ...
    def with_del(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.DelModel, types.DelModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_del.
    ...
    def with_elif(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.ElifModel, types.ElifModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_elif.
    ...
    def with_else(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.ElseModel, types.ElseModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_else.
    ...
    def with_except(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.ExceptModel, types.ExceptModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_except.
    ...
    def with_exec(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.ExecModel, types.ExecModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_exec.
    ...
    def with_for(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.ForModel, types.ForModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_for.
    ...
    def with_from(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.FromModel, types.FromModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_from.
    ...
    def with_global(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.GlobalModel, types.GlobalModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_global.
    ...
    def with_if(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.IfModel, types.IfModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_if.
    ...
    def with_import(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.ImportModel, types.ImportModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_import.
    ...
    def with_in(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.InModel, types.InModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_in.
    ...
    def with_is(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.IsModel, types.IsModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_is.
    ...
    def with_lambda(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.LambdaModel, types.LambdaModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_lambda.
    ...
    def with_not(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.NotModel, types.NotModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_not.
    ...
    def with_or(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.OrModel, types.OrModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_or.
    ...
    def with_pass(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.PassModel, types.PassModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_pass.
    ...
    def with_raise(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.RaiseModel, types.RaiseModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_raise.
    ...
    def with_return(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.ReturnModel, types.ReturnModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_return.
    ...
    def with_try(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.TryModel, types.TryModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_try.
    ...
    def with_while(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.WhileModel, types.WhileModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_while.
    ...
    def with_with(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.WithModel, types.WithModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_with.
    ...
    def with_yield(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.YieldModel, types.YieldModel, IO[bytes]], **kwargs: Any
    ) -> None:
        """with_yield.
...
class ModelPropertiesOperations:
    ...
    def dict_methods(  # pylint: disable=inconsistent-return-statements
        self, body: Union[_models.DictMethods, types.DictMethods, IO[bytes]], **kwargs: Any
    ) -> None:
        """dict_methods.
