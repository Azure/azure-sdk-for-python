...
from ..._operations._operations import build_deserialize_empty_string_as_null_get_request
...
class _DeserializeEmptyStringAsNullClientOperationsMixin(
    ...
    async def get(self, **kwargs: Any) -> _models.ResponseModel:
        """get.
        ...
        cls: ClsType[_models.ResponseModel] = kwargs.pop("cls", None)

        _request = build_deserialize_empty_string_as_null_get_request(
            headers=_headers,
            params=_params,
        )
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.ResponseModel, response.json())
