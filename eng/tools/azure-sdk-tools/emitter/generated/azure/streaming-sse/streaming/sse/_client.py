...
class SseClient:  # pylint: disable=client-accepts-api-version-keyword
    """Test of server-sent events (SSE) streaming.

    :ivar unnamed: UnnamedOperations operations
    :vartype unnamed: streaming.sse.operations.UnnamedOperations
    :ivar named: NamedOperations operations
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        _endpoint = "{endpoint}"
        self._config = SseClientConfiguration(endpoint=endpoint, **kwargs)
