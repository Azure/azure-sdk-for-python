...
def build_single_discriminator_get_no_subtypes_model_request(  # pylint: disable=name-too-long
    **kwargs: Any,
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/type/model/inheritance/single-discriminator/no-subtypes/model"
...
def build_single_discriminator_put_no_subtypes_model_request(  # pylint: disable=name-too-long
    **kwargs: Any,
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class _SingleDiscriminatorClientOperationsMixin(
    ...
    def get_model(self, **kwargs: Any) -> _models.Bird:
        ...
        :rtype: ~typetest.model.singlediscriminator.typeddict.models.Bird
    ...
    def put_model(self, input: _models.Bird, *, content_type: str = "application/json", **kwargs: Any) -> None:
        ...
        :type input: ~typetest.model.singlediscriminator.typeddict.models.Bird
    ...
    def put_model(self, input: _types.Bird, *, content_type: str = "application/json", **kwargs: Any) -> None:
        ...
        :param input: Required.
        :type input: ~typetest.model.singlediscriminator.typeddict.types.Bird
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    def put_model(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~typetest.model.singlediscriminator.typeddict.models.Bird or
         ~typetest.model.singlediscriminator.typeddict.types.Bird or IO[bytes]
        :return: None
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def get_legacy_model(self, **kwargs: Any) -> _models.Dinosaur:
        ...
        :rtype: ~typetest.model.singlediscriminator.typeddict.models.Dinosaur
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    @distributed_trace
    def get_no_subtypes_model(self, **kwargs: Any) -> _models.Fish:
        """get_no_subtypes_model.

        :return: Fish. The Fish is compatible with MutableMapping
        :rtype: ~typetest.model.singlediscriminator.typeddict.models.Fish
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        _request = build_single_discriminator_get_no_subtypes_model_request(
            headers=_headers,
            params=_params,
        )
        path_format_arguments = {
    ...
    def put_no_subtypes_model(
        ...
        :param input: Required.
        :type input: ~typetest.model.singlediscriminator.typeddict.models.Fish
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    def put_no_subtypes_model(
        ...
        :param input: Required.
        :type input: ~typetest.model.singlediscriminator.typeddict.types.Fish
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    @overload
    def put_no_subtypes_model(self, input: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> None:
        """put_no_subtypes_model.
    ...
    def put_no_subtypes_model(  # pylint: disable=inconsistent-return-statements
        ...
        :type input: ~typetest.model.singlediscriminator.typeddict.models.Fish or
         ~typetest.model.singlediscriminator.typeddict.types.Fish or IO[bytes]
        :return: None
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        _request = build_single_discriminator_put_no_subtypes_model_request(
            content_type=content_type,
            content=_content,
            headers=_headers,
            params=_params,
