...
class _UsageClientOperationsMixin(ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], UsageClientConfiguration]):
    ...
    def input(  # pylint: disable=inconsistent-return-statements
        self, input: Union[types.InputRecord, JSON, IO[bytes]], **kwargs: Any
    ) -> None:
        """input.

        :param input: Is one of the following types: InputRecord, JSON, IO[bytes] Required.
        :type input: ~typetest.model.usage.typeddictonly.types.InputRecord or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    @distributed_trace
    def input_and_output(
        self, body: Union[types.InputOutputRecord, JSON, IO[bytes]], **kwargs: Any
    ) -> types.InputOutputRecord:
        """input_and_output.

        :param body: Is one of the following types: InputOutputRecord, JSON, IO[bytes] Required.
        :type body: ~typetest.model.usage.typeddictonly.types.InputOutputRecord or JSON or IO[bytes]
        :return: InputOutputRecord. The InputOutputRecord is compatible with MutableMapping
        :rtype: ~typetest.model.usage.typeddictonly.types.InputOutputRecord
        :raises ~azure.core.exceptions.HttpResponseError:
        """
