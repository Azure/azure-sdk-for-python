...
class _TraitsClientOperationsMixin(
    ...
    @overload
    def repeatable_action(
        self, id: int, body: types.UserActionParam, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.UserActionResponse:
        """Test for repeatable requests.
    ...
    @distributed_trace
    def repeatable_action(
        self, id: int, body: Union[_models.UserActionParam, types.UserActionParam, IO[bytes]], **kwargs: Any
    ) -> _models.UserActionResponse:
        """Test for repeatable requests.
