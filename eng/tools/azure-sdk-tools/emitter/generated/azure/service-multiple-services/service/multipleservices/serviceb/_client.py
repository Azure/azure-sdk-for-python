...
from .subnamespace.operations import SubNamespaceOperations
...
class ServiceBClient:
    ...
    :vartype sub_namespace: service.multipleservices.servicea.operations.SubNamespaceOperations
    :ivar operations: Operations operations
    :vartype operations: service.multipleservices.servicea.operations.Operations
