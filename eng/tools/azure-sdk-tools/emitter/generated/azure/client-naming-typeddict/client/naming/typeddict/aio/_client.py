...
class NamingClient(_NamingClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype property: client.naming.typeddict.aio.operations.PropertyOperations
    :ivar header: HeaderOperations operations
    :vartype header: client.naming.typeddict.aio.operations.HeaderOperations
    :ivar model_client: ModelClientOperations operations
    :vartype model_client: client.naming.typeddict.aio.operations.ModelClientOperations
    :ivar union_enum: UnionEnumOperations operations
    :vartype union_enum: client.naming.typeddict.aio.operations.UnionEnumOperations
