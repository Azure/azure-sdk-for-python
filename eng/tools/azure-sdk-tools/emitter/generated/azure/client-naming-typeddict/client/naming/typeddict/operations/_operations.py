...
class PropertyOperations:
    ...
    def client(  # pylint: disable=inconsistent-return-statements
        ...
        :type body: ~client.naming.typeddict.models.ClientNameModel or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def language(  # pylint: disable=inconsistent-return-statements
        ...
        :type body: ~client.naming.typeddict.models.LanguageClientNameModel or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def compatible_with_encoded_name(  # pylint: disable=inconsistent-return-statements
        ...
        :param body: Is one of the following types: ClientNameAndJsonEncodedNameModel, JSON, IO[bytes]
         Required.
        :type body: ~client.naming.typeddict.models.ClientNameAndJsonEncodedNameModel or JSON or
         IO[bytes]
        :return: None
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
...
class ModelClientOperations:
    ...
    def client(  # pylint: disable=inconsistent-return-statements
        ...
        :type body: ~client.naming.typeddict.models.ClientModel or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def language(  # pylint: disable=inconsistent-return-statements
        ...
        :type body: ~client.naming.typeddict.models.PythonModel or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
