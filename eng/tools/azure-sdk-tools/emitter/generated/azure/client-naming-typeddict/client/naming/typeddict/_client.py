...
class NamingClient(_NamingClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype property: client.naming.typeddict.operations.PropertyOperations
    :ivar header: HeaderOperations operations
    :vartype header: client.naming.typeddict.operations.HeaderOperations
    :ivar model_client: ModelClientOperations operations
    :vartype model_client: client.naming.typeddict.operations.ModelClientOperations
    :ivar union_enum: UnionEnumOperations operations
    :vartype union_enum: client.naming.typeddict.operations.UnionEnumOperations
