...
from ..._operations._operations import (
    ...
    build_query_param_delete_standalone_request,
    build_query_param_get_standalone_request,
    build_query_param_with_query_request,
)
...
class _HeaderParamClientOperationsMixin(
    ...
    @overload
    async def with_body(self, body: types.Input, *, content_type: str = "application/json", **kwargs: Any) -> None:
        """with_body.
    ...
    @distributed_trace_async
    async def with_body(self, body: Union[_models.Input, types.Input, IO[bytes]], **kwargs: Any) -> None:
        """with_body.
...
class _MixedParamsClientOperationsMixin(
    ...
    @overload
    async def with_body(
        self, body: types.WithBodyRequest, *, region: str, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """with_body.
    ...
    @distributed_trace_async
    async def with_body(
        self, body: Union[_models.WithBodyRequest, types.WithBodyRequest, IO[bytes]], *, region: str, **kwargs: Any
    ) -> None:
        """with_body.
...
class _QueryParamClientOperationsMixin(
    ClientMixinABC[AsyncPipelineClient[HttpRequest, AsyncHttpResponse], QueryParamClientConfiguration]
):
