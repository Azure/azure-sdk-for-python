...
class TestOperationTemplatesLroPagingOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(OperationTemplatesClient)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_lro_paging_begin_post_paging_lro(self, resource_group):
        response = self.client.lro_paging.begin_post_paging_lro(
