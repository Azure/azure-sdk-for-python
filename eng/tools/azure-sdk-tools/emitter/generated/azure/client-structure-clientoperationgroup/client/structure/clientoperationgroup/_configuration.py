...
class FirstClientConfiguration:  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, endpoint: str, client: Union[str, _models.ClientType], **kwargs: Any) -> None:
        ...
        self.client = client
        kwargs.setdefault("sdk_moniker", "client-structure-clientoperationgroup/{}".format(VERSION))
...
class SecondClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for SecondClient.
