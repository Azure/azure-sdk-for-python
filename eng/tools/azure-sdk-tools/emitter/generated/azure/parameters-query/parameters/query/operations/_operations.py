...
def build_special_char_dollar_sign_request(*, filter: str, **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class SpecialCharOperations:
    ...
    @distributed_trace
    def dollar_sign(self, *, filter: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """dollar_sign.
        ...
        _request = build_special_char_dollar_sign_request(
            filter=filter,
            headers=_headers,
            params=_params,
        )
