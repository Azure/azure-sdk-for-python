...
from ...operations._operations import build_constant_post_request, build_special_char_dollar_sign_request
...
class SpecialCharOperations:
    ...
    @distributed_trace_async
    async def dollar_sign(self, *, filter: str, **kwargs: Any) -> None:
        """dollar_sign.
