...
class ServiceGroupExtensionResource(ExtensionResource):
    ...
    :vartype properties: "ServiceGroupExtensionResourceProperties"
    """
...
class ServiceGroupExtensionResourceProperties(TypedDict, total=False):
