...
def build_arm_resource_identifiers_get_request(  # pylint: disable=name-too-long
    resource_group_name: str, arm_resource_identifier_resource_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.CommonProperties/armResourceIdentifierResources/{armResourceIdentifierResourceName}"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "armResourceIdentifierResourceName": _SERIALIZER.url(
            "arm_resource_identifier_resource_name", arm_resource_identifier_resource_name, "str"
        ),
    }
...
def build_arm_resource_identifiers_create_or_replace_request(  # pylint: disable=name-too-long
    resource_group_name: str, arm_resource_identifier_resource_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ArmResourceIdentifiersOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~azure.resourcemanager.commonproperties.CommonPropertiesClient`'s
        :attr:`arm_resource_identifiers` attribute.
    """
    ...
    @distributed_trace
    def get(
        self, resource_group_name: str, arm_resource_identifier_resource_name: str, **kwargs: Any
        ...
        cls: ClsType[_models.ArmResourceIdentifierResource] = kwargs.pop("cls", None)

        _request = build_arm_resource_identifiers_get_request(
            resource_group_name=resource_group_name,
            arm_resource_identifier_resource_name=arm_resource_identifier_resource_name,
            subscription_id=self._config.subscription_id,
            api_version=self._config.api_version,
            headers=_headers,
            params=_params,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.ArmResourceIdentifierResource, response.json())
    ...
    def create_or_replace(
        ...
        resource: _models.ArmResourceIdentifierResource,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.ArmResourceIdentifierResource:
    ...
    def create_or_replace(
        ...
        **kwargs: Any
        ...
        _request = build_arm_resource_identifiers_create_or_replace_request(
            resource_group_name=resource_group_name,
            arm_resource_identifier_resource_name=arm_resource_identifier_resource_name,
            subscription_id=self._config.subscription_id,
            content_type=content_type,
