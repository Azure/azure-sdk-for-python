...
class EnumValueOperations:
    ...
    @overload
    async def send(
        self, body: _models2.EndpointConfig, *, content_type: str = "application/json", **kwargs: Any
    ...
    async def send(
        ...
        cls: ClsType[_models2.EndpointConfig] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models2.EndpointConfig, response.json())
