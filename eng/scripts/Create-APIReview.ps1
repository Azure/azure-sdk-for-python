...
$packages = @{}
if (Test-Path "Function:Find-python-Artifacts-For-Apireview")
{
    $packages = Find-python-Artifacts-For-Apireview $ArtifactPath $PackageName
}
else
{
    Write-Host "Function Find-python-Artifacts-For-Apireview is not found"
    exit(1)
}
