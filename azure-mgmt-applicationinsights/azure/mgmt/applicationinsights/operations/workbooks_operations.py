...
class WorkbooksOperations(object):
    ...
    def list_by_resource_group(
        ...
        deserialized = models.WorkbookPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.WorkbookPaged(internal_paging, self._deserialize.dependencies, header_dict)
