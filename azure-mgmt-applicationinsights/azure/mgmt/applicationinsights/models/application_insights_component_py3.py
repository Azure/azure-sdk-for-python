...
class ApplicationInsightsComponent(Resource):
    ...
    def __init__(self, *, kind: str, location: str=None, tags=None, application_type="web", flow_type="Bluefield", request_source="rest", hockey_app_id: str=None, sampling_percentage: float=None, **kwargs) -> None:
