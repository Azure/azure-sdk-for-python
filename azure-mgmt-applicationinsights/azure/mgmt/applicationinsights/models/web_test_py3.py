...
class WebTest(Resource):
    ...
    def __init__(self, *, synthetic_monitor_id: str, web_test_name: str, locations, location: str=None, tags=None, kind="ping", description: str=None, enabled: bool=None, frequency: int=300, timeout: int=30, web_test_kind="ping", retry_enabled: bool=None, configuration=None, **kwargs) -> None:
