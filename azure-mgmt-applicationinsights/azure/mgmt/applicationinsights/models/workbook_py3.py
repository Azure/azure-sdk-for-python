...
class Workbook(Resource):
    ...
    def __init__(self, *, location: str, workbook_name: str, serialized_data: str, workbook_id: str, category: str, user_id: str, tags=None, kind=None, version: str=None, shared_type_kind="shared", workbook_tags=None, source_resource_id: str=None, **kwargs) -> None:
