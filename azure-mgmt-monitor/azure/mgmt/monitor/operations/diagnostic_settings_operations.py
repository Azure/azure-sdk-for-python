...
class DiagnosticSettingsOperations(object):
    ...
    def get(
        ...
        :return: :class:`DiagnosticSettingsResource
         <azure.mgmt.monitor.models.DiagnosticSettingsResource>` or
    ...
    def list(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: :class:`DiagnosticSettingsResourceCollection
         <azure.mgmt.monitor.models.DiagnosticSettingsResourceCollection>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype: :class:`DiagnosticSettingsResourceCollection
         <azure.mgmt.monitor.models.DiagnosticSettingsResourceCollection>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
        :raises:
         :class:`ErrorResponseException<azure.mgmt.monitor.models.ErrorResponseException>`
