...
class MetricBaselinesOperations(object):
    ...
    def list(
        ...
        :return: MetricBaselinesResponse or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.monitor.models.MetricBaselinesResponse or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('MetricBaselinesResponse', response)
