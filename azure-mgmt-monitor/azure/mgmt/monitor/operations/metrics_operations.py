...
class MetricsOperations(object):
    ...
    def batch(
        ...
        **operation_config
        ...
        """**Lists the metric values for a list of resources**.

        :param resource_uris: List of the identifiers of the resources. Max of 25
        :type resource_uris: list of str
        :param timespan: The timespan of the query. It is a string with the
         following format 'startDateTime_ISO/endDateTime_ISO'.
        :type timespan: str
        :param interval: The interval (i.e. timegrain) of the query.
        ...
        content = resource_uris

        # Construct and send request
        request = self._client.get(url, query_parameters, header_parameters, content)
        response = self._client.send(request, stream=False, **operation_config)
    ...
    batch.metadata = {"url": "/providers/microsoft.insights/metricbatch"}
