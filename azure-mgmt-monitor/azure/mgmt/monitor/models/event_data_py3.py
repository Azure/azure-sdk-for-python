...
class EventData(Model):
    ...
    def __init__(self, *, level, event_timestamp, submission_timestamp, authorization=None, claims=None, caller: str=None, description: str=None, id: str=None, event_data_id: str=None, correlation_id: str=None, event_name=None, category=None, http_request=None, resource_group_name: str=None, resource_provider_name=None, resource_id: str=None, resource_type=None, operation_id: str=None, operation_name=None, properties=None, status=None, sub_status=None, subscription_id: str=None, tenant_id: str=None, **kwargs) -> None:
