...
export namespace Intl {
  ...
  interface DateTimeFormat extends globalThis.Intl.DateTimeFormat {
    /**
  ...
  interface DateTimeFormatOptions extends Omit<globalThis.Intl.DateTimeFormatOptions, 'timeZone' | 'calendar'> {
