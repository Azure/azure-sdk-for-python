...
class ManagementGroupsAPIConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, group_id, base_url=None):
...
class ManagementGroupsAPI(object):
    ...
    :vartype management_groups: azure.mgmt.resource.subscriptions.v2017_08_31.operations.ManagementGroupsOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.resource.subscriptions.v2017_08_31.operations.Operations
    ...
    def __init__(
        ...
        self.config = ManagementGroupsAPIConfiguration(credentials, group_id, base_url)
