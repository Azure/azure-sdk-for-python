...
class ManagementGroupsOperations(object):
    ...
    :ivar api_version: Version of the API to be used with the client request. The current version is 2017-08-31-preview. Constant value: "2017-08-31-preview".
    """
    ...
    def __init__(self, client, config, serializer, deserializer):
        ...
        self.api_version = "2017-08-31-preview"
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.resource.subscriptions.v2017_08_31.models.ManagementGroupInfoPaged[~azure.mgmt.resource.subscriptions.v2017_08_31.models.ManagementGroupInfo]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.resource.subscriptions.v2017_08_31.models.ErrorResponseException>`
        """
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: ManagementGroupWithHierarchy or ClientRawResponse if raw=true
        :rtype:
         ~azure.mgmt.resource.subscriptions.v2017_08_31.models.ManagementGroupWithHierarchy
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ManagementGroupWithHierarchy', response)
