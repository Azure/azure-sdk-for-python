...
class PolicyClient(SDKClient):
    ...
    :vartype policy_assignments: azure.mgmt.resource.policy.v2018_05_01.operations.PolicyAssignmentsOperations
    :ivar policy_definitions: PolicyDefinitions operations
    :vartype policy_definitions: azure.mgmt.resource.policy.v2018_05_01.operations.PolicyDefinitionsOperations
    :ivar policy_set_definitions: PolicySetDefinitions operations
    :vartype policy_set_definitions: azure.mgmt.resource.policy.v2018_05_01.operations.PolicySetDefinitionsOperations
    ...
    def __init__(
        ...
        self.config = PolicyClientConfiguration(credentials, base_url)
