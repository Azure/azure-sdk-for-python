...
class PolicyAssignmentsOperations(object):
        ...
        def internal_paging(next_link=None, raw=False):
            ...
            if not next_link:
                ...
                path_format_arguments = {
                    ...
                    'parentResourcePath': self._serialize.url("parent_resource_path", parent_resource_path, 'str'),
    ...
    def delete(
            self, scope, policy_assignment_name, custom_headers={}, raw=False, **operation_config):
        """
    ...
    def delete_by_id(
            self, policy_assignment_id, custom_headers={}, raw=False, **operation_config):
        """
        Delete policy assignment.
    ...
    def list_for_scope(
        ...
        def internal_paging(next_link=None, raw=False):
            ...
            if not next_link:
                # Construct URL
                url = '/{scope}/providers/Microsoft.Authorization/policyAssignments'
                path_format_arguments = {
                    'scope': self._serialize.url("scope", scope, 'str', skip_quote=True),
                    'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
                }
