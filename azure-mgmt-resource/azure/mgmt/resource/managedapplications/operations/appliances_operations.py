...
class AppliancesOperations(object):
    ...
    def list_by_resource_group(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :rtype: :class:`ApplianceListResult
         <azure.mgmt.resource.managedapplications.models.ApplianceListResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises:
         :class:`ErrorResponseException<azure.mgmt.resource.managedapplications.models.ErrorResponseException>`
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ApplianceListResult', response)
