...
class GenericResource(Resource):
    ...
    :type plan: :class:`Plan <azure.mgmt.resource.v20160901.models.Plan>`
    ...
    :type sku: :class:`Sku <azure.mgmt.resource.v20160901.models.Sku>`
    :param identity: The identity of the resource.
    :type identity: :class:`Identity
     <azure.mgmt.resource.v20160901.models.Identity>`
    """
