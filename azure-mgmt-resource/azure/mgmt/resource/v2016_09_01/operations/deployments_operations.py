...
class DeploymentsOperations(object):
    ...
    def create_or_update(
        ...
        :rtype:
         ...
         <azure.mgmt.resource.v20160901.models.DeploymentExtended>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def validate(
        ...
        :rtype: :class:`DeploymentValidateResult
         <azure.mgmt.resource.v20160901.models.DeploymentValidateResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def export_template(
        ...
        :rtype: :class:`DeploymentExportResult
         <azure.mgmt.resource.v20160901.models.DeploymentExportResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype: :class:`DeploymentExtendedPaged
         <azure.mgmt.resource.v20160901.models.DeploymentExtendedPaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
