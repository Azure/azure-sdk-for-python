...
class ResourceGroupsOperations(object):
    ...
    def list_resources(
        ...
        :rtype: :class:`GenericResourcePaged
         <azure.mgmt.resource.v20160901.models.GenericResourcePaged>`
    ...
    def create_or_update(
        ...
        :type parameters: :class:`ResourceGroup
         <azure.mgmt.resource.v20160901.models.ResourceGroup>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def export_template(
        ...
        :rtype: :class:`ResourceGroupExportResult
         <azure.mgmt.resource.v20160901.models.ResourceGroupExportResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype: :class:`ResourceGroupPaged
         <azure.mgmt.resource.v20160901.models.ResourceGroupPaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def internal_paging(next_link=None, raw=False):
