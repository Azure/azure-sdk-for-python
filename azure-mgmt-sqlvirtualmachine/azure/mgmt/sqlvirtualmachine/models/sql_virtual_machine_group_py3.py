...
class SqlVirtualMachineGroup(TrackedResource):
    ...
    def __init__(self, *, location: str, tags=None, sql_image_offer: str=None, sql_image_sku=None, wsfc_domain_profile=None, domainless_profile=None, **kwargs) -> None:
        ...
        self.domainless_profile = domainless_profile
