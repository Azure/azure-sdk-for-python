...
class SearchManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, subscription_id, api_version='2015-08-19', base_url=None):
...
class SearchManagementClient(object):
    ...
    def __init__(
        ...
        self.config = SearchManagementClientConfiguration(credentials, subscription_id, api_version, base_url)
