...
class AzureMLWebServicesManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, subscription_id, api_version='2016-05-01-preview', base_url=None):
...
class AzureMLWebServicesManagementClient(object):
    ...
    def __init__(
        ...
        self.config = AzureMLWebServicesManagementClientConfiguration(credentials, subscription_id, api_version, base_url)
