...
class AzureMLWebServicesManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, subscription_id, api_version='2016-05-01-preview', accept_language='en-US', long_running_operation_retry_timeout=30, generate_client_request_id=True, base_url=None, filepath=None):
        ...
        super(AzureMLWebServicesManagementClientConfiguration, self).__init__(base_url, filepath)
...
class AzureMLWebServicesManagementClient(object):
    ...
    :vartype web_services: .operations.WebServicesOperations
    ...
    def __init__(
        ...
        self.config = AzureMLWebServicesManagementClientConfiguration(credentials, subscription_id, api_version, accept_language, long_running_operation_retry_timeout, generate_client_request_id, base_url, filepath)
