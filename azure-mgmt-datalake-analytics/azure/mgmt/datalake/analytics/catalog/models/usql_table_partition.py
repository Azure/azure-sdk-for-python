...
class USqlTablePartition(CatalogItem):
    ...
    :param name: Gets or sets the name of the table partition.
    :type name: str
    :param index_id: Gets or sets the index ID for this partition.
    :type index_id: int
    :param label: Gets or sets the list of labels associated with this
     partition.
    ...
    def __init__(self, compute_account_name=None, version=None, database_name=None, schema_name=None, name=None, index_id=None, label=None):
