...
class USqlDatabase(CatalogItem):
    ...
    def __init__(self, *, compute_account_name: str=None, version: str=None, name: str=None, **kwargs) -> None:
        super(USqlDatabase, self).__init__(compute_account_name=compute_account_name, version=version, **kwargs)
        self.name = name
