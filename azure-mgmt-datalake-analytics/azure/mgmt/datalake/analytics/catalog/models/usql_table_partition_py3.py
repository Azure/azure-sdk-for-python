...
class USqlTablePartition(CatalogItem):
    ...
    def __init__(self, *, compute_account_name: str=None, version: str=None, database_name: str=None, schema_name: str=None, name: str=None, parent_name=None, index_id: int=None, label=None, create_date=None, **kwargs) -> None:
        super(USqlTablePartition, self).__init__(compute_account_name=compute_account_name, version=version, **kwargs)
