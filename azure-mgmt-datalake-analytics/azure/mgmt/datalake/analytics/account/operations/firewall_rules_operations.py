...
class FirewallRulesOperations(object):
    ...
    def create_or_update(
            self, firewall_rule_name, start_ip_address, end_ip_address, custom_headers=None, raw=False, **operation_config):
    ...
    def get(
            self, firewall_rule_name, custom_headers=None, raw=False, **operation_config):
    ...
    def update(
            self, firewall_rule_name, start_ip_address=None, end_ip_address=None, custom_headers=None, raw=False, **operation_config):
