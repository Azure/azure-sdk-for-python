...
class ComputePoliciesOperations(object):
    ...
    def create_or_update(
            self, compute_policy_name, parameters, custom_headers=None, raw=False, **operation_config):
    ...
    def get(
            self, compute_policy_name, custom_headers=None, raw=False, **operation_config):
    ...
    def update(
            self, compute_policy_name, parameters=None, custom_headers=None, raw=False, **operation_config):
