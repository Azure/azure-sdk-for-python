...
from .operations.compute_policy_operations import ComputePolicyOperations
...
class DataLakeAnalyticsAccountManagementClient(object):
    ...
    :ivar compute_policy: ComputePolicy operations
    :vartype compute_policy: azure.mgmt.datalake.analytics.account.operations.ComputePolicyOperations
    ...
    def __init__(
        ...
        self.compute_policy = ComputePolicyOperations(
