...
class DataLakeAnalyticsAccountManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
        ...
        super(DataLakeAnalyticsAccountManagementClientConfiguration, self).__init__(base_url, filepath)
...
class DataLakeAnalyticsAccountManagementClient(object):
    ...
    :type config: DataLakeAnalyticsAccountManagementClientConfiguration
