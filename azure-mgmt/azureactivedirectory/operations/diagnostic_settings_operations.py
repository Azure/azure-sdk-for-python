...
class DiagnosticSettingsOperations(object):
    ...
    def list(
        ...
        :return: DiagnosticSettingsResourceCollection or ClientRawResponse if
         raw=true
        :rtype: ~microsoft.aadiam.models.DiagnosticSettingsResourceCollection
         or ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<microsoft.aadiam.models.ErrorResponseException>`
        """
        # Construct URL
        ...
        return deserialized
    list.metadata = {'url': '/providers/microsoft.aadiam/diagnosticSettings'}
    ...
    def get(
        ...
        :rtype: ~microsoft.aadiam.models.DiagnosticSettingsResource or
        ...
        return deserialized
    get.metadata = {'url': '/providers/microsoft.aadiam/diagnosticSettings/{name}'}
    ...
    def create_or_update(
        ...
        :type parameters: ~microsoft.aadiam.models.DiagnosticSettingsResource
        :param name: The name of the diagnostic setting.
        :type name: str
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
        ...
        return deserialized
    create_or_update.metadata = {'url': '/providers/microsoft.aadiam/diagnosticSettings/{name}'}
    ...
    def delete(
        ...
        if raw:
            ...
            return client_raw_response
    delete.metadata = {'url': '/providers/microsoft.aadiam/diagnosticSettings/{name}'}
