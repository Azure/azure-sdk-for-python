...
from azure.keyvault.generated.models import \
    (CertificatePolicy, KeyProperties, SecretProperties, IssuerParameters,
     ...
     AdministrationDetails, Contact, Contacts, KeyVaultError)
...
# TODO: Should be AzureTestCase... not Mgmt
class KeyVaultKeyTest(AzureMgmtTestCase):
...
# TODO: Should be AzureTestCase... not Mgmt
class KeyVaultSecretTest(AzureMgmtTestCase):
    ...
    def test_secret_list_versions(self):
        ...
        self.create_many_secret_versions()
        self.list_secret_versions()

# TODO: Should be AzureTestCase... not Mgmt
class KeyVaultCertificateTest(AzureMgmtTestCase):
    ...
    def test_certificate_crud_operations(self):
        ...
        def get_certificate_returns_not_found(self):
            try:
        ...
        self.get_certificate_returns_not_found()
