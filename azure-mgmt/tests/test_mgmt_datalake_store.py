...
class MgmtDataLakeStoreTest(AzureMgmtTestCase):
    ...
    def test_adls_accounts(self):
        ...
        params_create = azure.mgmt.datalake.store.account.models.DataLakeStoreAccount(
            ...
            identity = azure.mgmt.datalake.store.account.models.EncryptionIdentity(
                type = azure.mgmt.datalake.store.account.models.EncryptionIdentityType.system_assigned
            ),
            properties = azure.mgmt.datalake.store.account.models.DataLakeStoreAccountProperties(
                encryption_config = azure.mgmt.datalake.store.account.models.EncryptionConfig(
                    type = azure.mgmt.datalake.store.account.models.EncryptionConfigType.service_managed
                ),
                encryption_state = azure.mgmt.datalake.store.account.models.EncryptionState.enabled
            ),
            tags={
                'tag1': 'value1'
            }
        ...
        params_create_no_encryption = azure.mgmt.datalake.store.account.models.DataLakeStoreAccount(
        ...
        # self.assertEqual(azure.mgmt.datalake.store.account.models.DataLakeStoreAccountStatus.succeeded, adls_account.properties.provisioning_state)
        ...
        # self.assertEqual(azure.mgmt.datalake.store.account.models.EncryptionState.enabled, adls_account.properties.encryption_state)
        self.assertEqual(azure.mgmt.datalake.store.account.models.EncryptionIdentityType.system_assigned, adls_account.identity.type)
        ...
        self.assertEqual(azure.mgmt.datalake.store.account.models.DataLakeStoreAccountStatus.succeeded, adls_account_no_encryption.properties.provisioning_state)
        ...
        self.assertTrue(adls_account_no_encryption.properties.encryption_state == None or azure.mgmt.datalake.store.account.models.EncryptionState.disabled == adls_account_no_encryption.properties.encryption_state)
