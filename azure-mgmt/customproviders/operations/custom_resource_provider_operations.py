...
class CustomResourceProviderOperations(object):
    ...
    def create_or_update(
        ...
        :type resource_provider:
         ~microsoft.customproviders.models.CustomRPManifest
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~microsoft.customproviders.models.CustomRPManifest]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~microsoft.customproviders.models.CustomRPManifest]]
        :raises:
         :class:`ErrorResponseException<microsoft.customproviders.models.ErrorResponseException>`
        """
    ...
    def get(
        ...
        :rtype: ~microsoft.customproviders.models.CustomRPManifest or
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~microsoft.customproviders.models.CustomRPManifestPaged[~microsoft.customproviders.models.CustomRPManifest]
        :raises:
         :class:`ErrorResponseException<microsoft.customproviders.models.ErrorResponseException>`
        """
        ...
        deserialized = models.CustomRPManifestPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.CustomRPManifestPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
