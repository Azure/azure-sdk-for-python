...
module Azure::ARM::MobileEngagement
  module Models
    ...
    #
    class AppCollectionListResult

      include MsRestAzure

      # @return [Array<AppCollection>] The list of AppCollections and their
      # properties.
      attr_accessor :value
      ...
      #
      # @return [AppCollectionListResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for AppCollectionListResult class as Ruby Hash.
