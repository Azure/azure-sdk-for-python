...
class Workspace(Resource):
    ...
    :param batch_ai_workspace: ARM id of the Batch AI workspace associated
     with this workspace. This cannot be changed once the workspace has been
     created
    :type batch_ai_workspace: str
    ...
    _attribute_map = {
        ...
        'batch_ai_workspace': {'key': 'properties.batchAIWorkspace', 'type': 'str'},
    ...
    def __init__(self, *, location: str=None, tags=None, description: str=None, friendly_name: str=None, batch_ai_workspace: str=None, key_vault: str=None, application_insights: str=None, container_registry: str=None, storage_account: str=None, discovery_url: str=None, **kwargs) -> None:
        super(Workspace, self).__init__(location=location, tags=tags, **kwargs)
        self.workspace_id = None
        self.description = description
        self.friendly_name = friendly_name
        self.creation_time = None
        self.batch_ai_workspace = batch_ai_workspace
