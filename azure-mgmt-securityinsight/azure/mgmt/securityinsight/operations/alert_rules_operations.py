...
class AlertRulesOperations(object):
    ...
    def create(
            self, resource_group_name, operational_insights_resource_provider, workspace_name, rule_id, query=None, period=None, custom_headers=None, raw=False, **operation_config):
        ...
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        alert_rule = models.AlertRule(query=query, period=period)
