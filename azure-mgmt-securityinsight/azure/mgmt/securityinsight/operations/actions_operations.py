...
class ActionsOperations(object):
        ...
        def internal_paging(next_link=None, raw=False):
            ...
            if not next_link:
                ...
                path_format_arguments = {
                    ...
                    'ruleId': self._serialize.url("rule_id", rule_id, 'str', pattern=r'^[0-9A-Fa-f]{8}-([0-9A-Fa-f]{4}-){3}[0-9A-Fa-f]{12}$')
                }
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{operationalInsightsResourceProvider}/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/actions'}
