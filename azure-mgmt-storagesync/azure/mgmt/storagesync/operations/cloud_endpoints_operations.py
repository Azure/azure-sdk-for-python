...
class CloudEndpointsOperations(object):
    ...
    def list_by_sync_group(
        ...
        deserialized = models.CloudEndpointPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.CloudEndpointPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
