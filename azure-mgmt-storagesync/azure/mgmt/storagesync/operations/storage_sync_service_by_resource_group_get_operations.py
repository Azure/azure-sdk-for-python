...
class StorageSyncServiceByResourceGroupGetOperations(object):
    """StorageSyncServiceByResourceGroupGetOperations operations.
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices'}
