...
class PoolOperations(object):
    ...
    def add(
        ...
        # Construct body
        body_content = self._serialize.body(pool, 'Pool')
    ...
    def list(
        ...
        :rtype: ~azure.batch.models.PoolPaged[~azure.batch.models.Pool]
        :raises:
         :class:`BatchErrorException<azure.batch.models.BatchErrorException>`
        """
        filter = None
    ...
    def get(
        ...
        :rtype: ~azure.batch.models.Pool or ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<azure.batch.models.BatchErrorException>`
        """
        select = None
    ...
    def patch(
        ...
        :type pool_patch_parameter: ~azure.batch.models.PoolUpdate
        ...
        # Construct body
        body_content = self._serialize.body(pool_patch_parameter, 'PoolUpdate')
    ...
    def update_properties(
        ...
        # Construct body
        body_content = self._serialize.body(pool_update_properties_parameter, 'Pool')
