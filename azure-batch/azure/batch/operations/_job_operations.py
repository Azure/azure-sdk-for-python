...
class JobOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.batch.models.Job or ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<azure.batch.models.BatchErrorException>`
        """
        select = None
    ...
    def patch(
        ...
        :type job_patch_parameter: ~azure.batch.models.JobUpdate
        ...
        # Construct body
        body_content = self._serialize.body(job_patch_parameter, 'JobUpdate')
    ...
    def update(
        ...
        :type job_update_parameter: ~azure.batch.models.Job
        ...
        # Construct body
        body_content = self._serialize.body(job_update_parameter, 'Job')
    ...
    def add(
        ...
        :type job: ~azure.batch.models.Job
        ...
        # Construct body
        body_content = self._serialize.body(job, 'Job')
    ...
    def list(
        ...
        :rtype: ~azure.batch.models.JobPaged[~azure.batch.models.Job]
        :raises:
         :class:`BatchErrorException<azure.batch.models.BatchErrorException>`
        """
        filter = None
