...
class ComputeNodeOperations(object):
    ...
    def reboot(
            self, pool_id, node_id, node_reboot_parameter=None, compute_node_reboot_options=None, custom_headers={}, raw=False, **operation_config):
        """
        ...
        :type node_reboot_parameter: :class:`NodeRebootParameter
         <batchserviceclient.models.NodeRebootParameter>`
    ...
    def reimage(
            self, pool_id, node_id, node_reimage_parameter=None, compute_node_reimage_options=None, custom_headers={}, raw=False, **operation_config):
        """
        ...
        :type node_reimage_parameter: :class:`NodeReimageParameter
         <batchserviceclient.models.NodeReimageParameter>`
    ...
    def disable_scheduling(
            self, pool_id, node_id, node_disable_scheduling_parameter=None, compute_node_disable_scheduling_options=None, custom_headers={}, raw=False, **operation_config):
        """
        ...
        :type node_disable_scheduling_parameter:
         ...
         <batchserviceclient.models.NodeDisableSchedulingParameter>`
