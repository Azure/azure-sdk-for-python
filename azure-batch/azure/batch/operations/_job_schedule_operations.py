...
class JobScheduleOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.batch.models.JobSchedule or
    ...
    def patch(
        ...
        :type job_schedule_patch_parameter:
         ~azure.batch.models.JobScheduleUpdate
        ...
        # Construct body
        body_content = self._serialize.body(job_schedule_patch_parameter, 'JobScheduleUpdate')
    ...
    def update(
        ...
        :type job_schedule_update_parameter: ~azure.batch.models.JobSchedule
        ...
        # Construct body
        body_content = self._serialize.body(job_schedule_update_parameter, 'JobSchedule')
    ...
    def add(
        ...
        :type cloud_job_schedule: ~azure.batch.models.JobSchedule
        ...
        # Construct body
        body_content = self._serialize.body(cloud_job_schedule, 'JobSchedule')
    ...
    def list(
        ...
        :rtype:
         ~azure.batch.models.JobSchedulePaged[~azure.batch.models.JobSchedule]
        :raises:
         :class:`BatchErrorException<azure.batch.models.BatchErrorException>`
        """
        filter = None
