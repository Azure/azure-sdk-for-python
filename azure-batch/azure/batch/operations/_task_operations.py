...
class TaskOperations(object):
    ...
    def add(
        ...
        :type task: ~azure.batch.models.Task
        ...
        # Construct body
        body_content = self._serialize.body(task, 'Task')
    ...
    def list(
        ...
        :rtype: ~azure.batch.models.TaskPaged[~azure.batch.models.Task]
        :raises:
         :class:`BatchErrorException<azure.batch.models.BatchErrorException>`
        """
        filter = None
    ...
    def get(
        ...
        :rtype: ~azure.batch.models.Task or ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`BatchErrorException<azure.batch.models.BatchErrorException>`
        """
        select = None
    ...
    def update(
        ...
        :type task_update_parameter: ~azure.batch.models.Task
        ...
        # Construct body
        body_content = self._serialize.body(task_update_parameter, 'Task')
