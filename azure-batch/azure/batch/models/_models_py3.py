...
class Job(Model):
    ...
    :ivar url:
    :vartype url: str
    :ivar e_tag: This is an opaque string. You can use it to detect whether
    ...
    :vartype e_tag: str
    :ivar last_modified: This is the last time at which the Job level data,
    ...
    :ivar state_transition_time:
    :vartype state_transition_time: datetime
    :ivar previous_state: The previous state of the Job. This property is not
    ...
    :ivar previous_state_transition_time: This property is not set if the Job
     is in its initial Active state.
    :vartype previous_state_transition_time: datetime
    ...
    :ivar stats: Resource usage statistics for the entire lifetime of the Job.
...
class JobSchedule(Model):
    ...
    :ivar e_tag: This is an opaque string. You can use it to detect whether
     ...
     in the meantime.
    :vartype e_tag: str
    :ivar last_modified: This is the last time at which the schedule level
    ...
    :ivar creation_time:
    :vartype creation_time: datetime
    :ivar state: The current state of the Job Schedule. Possible values
     include: 'active', 'completed', 'disabled', 'terminating', 'deleting'
    :vartype state: str or ~azure.batch.models.JobScheduleState
    :ivar state_transition_time:
    :vartype state_transition_time: datetime
    :ivar previous_state: The previous state of the Job Schedule. This
    ...
    :ivar previous_state_transition_time: This property is not present if the
    ...
    :ivar execution_info: Information about Jobs that have been and will be
     run under this schedule.
    :vartype execution_info:
     ~azure.batch.models.JobScheduleExecutionInformation
    :param metadata: The Batch service does not assign any meaning to
     metadata; it is solely for the use of user code.
    :type metadata: list[~azure.batch.models.MetadataItem]
    :ivar stats: The lifetime resource usage statistics for the Job Schedule.
    ...
    def __init__(self, *, id: str=None, display_name: str=None, schedule=None, job_specification=None, metadata=None, **kwargs) -> None:
...
class Pool(Model):
    ...
    :ivar creation_time:
    :vartype creation_time: datetime
    :ivar state: Possible values include: 'active', 'deleting'
    ...
    :type resize_timeout: timedelta
    :ivar resize_errors: This property is set only if one or more errors
    ...
    :ivar current_dedicated_nodes: The number of dedicated Compute Nodes
     currently in the Pool.
    :vartype current_dedicated_nodes: int
    :ivar current_low_priority_nodes: The number of Spot/Low-priority Compute
    ...
    :param metadata:
    :type metadata: list[~azure.batch.models.MetadataItem]
    :ivar stats: Utilization and resource usage statistics for the entire
    ...
    :ivar identity: The identity of the Batch pool, if configured. The list of
     user identities associated with the Batch pool. The user identity
...
class Task(Model):
    ...
    :ivar state: The current state of the Task. Possible values include:
     'active', 'preparing', 'running', 'completed'
    :vartype state: str or ~azure.batch.models.TaskState
    :ivar state_transition_time:
    :vartype state_transition_time: datetime
    :ivar previous_state: The previous state of the Task. This property is not
     set if the Task is in its initial Active state. Possible values include:
     'active', 'preparing', 'running', 'completed'
    :vartype previous_state: str or ~azure.batch.models.TaskState
    :ivar previous_state_transition_time: This property is not set if the Task
     is in its initial Active state.
    :vartype previous_state_transition_time: datetime
    ...
    def __init__(self, *, id: str=None, display_name: str=None, exit_conditions=None, command_line: str=None, container_settings=None, resource_files=None, output_files=None, environment_settings=None, affinity_info=None, constraints=None, required_slots: int=None, user_identity=None, multi_instance_settings=None, depends_on=None, application_package_references=None, authentication_token_settings=None, **kwargs) -> None:
...
class TaskAddCollectionParameter(Model):
    ...
    :param value: Required. The total serialized size of this collection must
     ...
     Tasks.
    :type value: list[~azure.batch.models.Task]
    """
