...
class FileGetFromComputeNodeOptions(Model):
    ...
    :param ocp_range: Specifies the byte range to be retrieved. The default
     is to retrieve the entire file.  The format is startRange-endRange.
    :type ocp_range: str
    ...
    def __init__(self, timeout=30, client_request_id=None, return_client_request_id=None, ocp_date=None, ocp_range=None, if_modified_since=None, if_unmodified_since=None, **kwargs):
