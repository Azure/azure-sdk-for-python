...
class CloudTask(Model):
    ...
    :param resource_files: A list of files that the Batch service will
     ...
     size for the list of resource files.  When this is exceeded, the task
     cannot be added and the response error code will be RequestEntityTooLarge.
     If this occurs the recommended solution is to use an ApplicationPackage.
