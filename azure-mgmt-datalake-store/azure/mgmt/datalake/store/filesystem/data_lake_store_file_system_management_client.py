...
from .operations.file_system_operations import FileSystemOperations
from . import models


class DataLakeStoreFileSystemManagementClientConfiguration(AzureConfiguration):
    """Configuration for DataLakeStoreFileSystemManagementClient
