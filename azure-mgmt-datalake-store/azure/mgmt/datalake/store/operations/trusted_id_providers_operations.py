...
class TrustedIdProvidersOperations(object):
    ...
    def create_or_update(
            self, trusted_id_provider_name, id_provider, custom_headers=None, raw=False, **operation_config):
    ...
    def get(
            self, trusted_id_provider_name, custom_headers=None, raw=False, **operation_config):
    ...
    def update(
            self, trusted_id_provider_name, id_provider=None, custom_headers=None, raw=False, **operation_config):
