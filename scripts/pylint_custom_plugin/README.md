...
|----------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|
| missing-dependency-version-check-1 or 2            | Make sure your dependencies in the setup.py file include a < version if >= version used. Example: 'aiohttp>=3.0,<4.0' or "azure-core<2.0.0,>=1.0.0b3"                | You can't disable it. :(                                                                 | None
