...
| docstring-admonition-needs-newline                 | Add an extra newline after the .. admonition:: Example: statement. There should be a newline of whitespace before the literalinclude statement.                      | # pylint:disable=docstring-admonition-needs-newline                                      | No guideline, just helps our docs get built correctly for microsoft docs.                     |