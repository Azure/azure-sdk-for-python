...
import os
print(os.path.abspath(os.path.join(os.path.normpath(os.getcwd()), '../scripts/pylint_custom_plugin')))
print(os.path.commonprefix([os.getcwd(), 'azure-sdk-for-python/scripts/pylint_custom_plugin']))