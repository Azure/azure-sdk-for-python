...
namespace azure.mgmt.computefleet.aio.operations
    ...
    class azure.mgmt.computefleet.aio.operations.FleetsOperations:
        ...
        @distributed_trace
        @api_version_validation(method_added_on='2026-04-01-preview', params_added_on={'2026-04-01-preview': ['api_version', 'subscription_id', 'resource_group_name', 'name', 'filter', 'skiptoken', 'accept']}, api_versions_list=['2026-04-01-preview'])
