...
class AppsOperations(object):
    ...
    def template(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: AppTemplate or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.iotcentral.models.AppTemplate or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorDetailsException<azure.mgmt.iotcentral.models.ErrorDetailsException>`
        """
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('AppTemplate', response)
        ...
        return deserialized
    template.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.IoTCentral/applicationTemplates/{applicationTemplateId}'}
    ...
    def list_templates(
        ...
        return deserialized
    list_templates.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.IoTCentral/applicationTemplates'}
