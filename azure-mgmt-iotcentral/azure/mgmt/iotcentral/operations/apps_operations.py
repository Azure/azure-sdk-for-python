...
class AppsOperations(object):
    ...
    def templates(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: AppTemplates or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.iotcentral.models.AppTemplates or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorDetailsException<azure.mgmt.iotcentral.models.ErrorDetailsException>`
        """
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('AppTemplates', response)
