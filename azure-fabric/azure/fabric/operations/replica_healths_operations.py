...
class ReplicaHealthsOperations(object):
    """ReplicaHealthsOperations operations.
    ...
    def get(
            self, partition_id, replica_id, events_health_state_filter=None, custom_headers=None, raw=False, **operation_config):
        """Get replica healths.
        ...
        :rtype: :class:`ReplicaHealth <azure.fabric.models.ReplicaHealth>`
    ...
    def send(
            self, partition_id, replica_id, replica_health_report, custom_headers=None, raw=False, **operation_config):
        ...
        :type replica_health_report: :class:`ReplicaHealthReport
         <azure.fabric.models.ReplicaHealthReport>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        # Construct body
        body_content = self._serialize.body(replica_health_report, 'ReplicaHealthReport')
