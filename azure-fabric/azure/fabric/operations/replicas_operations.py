...
class ReplicasOperations(object):
    ...
    def list(
        ...
        :rtype: :class:`ReplicaList <azure.fabric.models.ReplicaList>`
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ReplicaList', response)
    ...
    def get(
            self, partition_id, replica_id, custom_headers=None, raw=False, **operation_config):
        """Get replicas.
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :rtype: :class:`Replica <azure.fabric.models.Replica>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises:
         :class:`ErrorModelException<azure.fabric.models.ErrorModelException>`
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('Replica', response)
