...
class ServiceDescriptionsOperations(object):
    """ServiceDescriptionsOperations operations.
    ...
    def get(
        ...
        :rtype: :class:`ServiceDescription
         <azure.fabric.models.ServiceDescription>`
        ...
        """
        # Construct URL
        url = '/Services/{serviceName}/$/GetDescription'
