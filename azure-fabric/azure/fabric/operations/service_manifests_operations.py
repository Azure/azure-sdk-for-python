...
class ServiceManifestsOperations(object):
    """ServiceManifestsOperations operations.
    ...
    def get(
            self, application_type_name, application_type_version, service_manifest_name, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: :class:`ServiceManifest <azure.fabric.models.ServiceManifest>`
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ServiceManifest', response)
