...
class ServiceTypesOperations(object):
    """ServiceTypesOperations operations.
    ...
    def get(
        ...
        :rtype: list of :class:`ServiceType <azure.fabric.models.ServiceType>`
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('[ServiceType]', response)
