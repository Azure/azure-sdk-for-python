...
class ServiceHealthsOperations(object):
    ...
    def get(
        ...
        :rtype: :class:`ServiceHealth <azure.fabric.models.ServiceHealth>`
        ...
        """
        # Construct URL
        url = '/Services/{serviceName}/$/GetHealth'
    ...
    def send(
            self, service_name, service_health_report, custom_headers=None, raw=False, **operation_config):
        """Send service healths.

        :param service_name: The name of the service
        :type service_name: str
        :param service_health_report: The report of the service health
        :type service_health_report: :class:`ServiceHealthReport
         <azure.fabric.models.ServiceHealthReport>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        """
        # Construct URL
        url = '/Services/{serviceName}/$/ReportHealth'
        path_format_arguments = {
            'serviceName': self._serialize.url("service_name", service_name, 'str', skip_quote=True)
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        # Construct body
        body_content = self._serialize.body(service_health_report, 'ServiceHealthReport')
