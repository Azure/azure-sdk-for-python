...
class DeployedApplicationsHealthEvaluation(HealthEvaluation):
    ...
    def __init__(self, description=None, aggregated_health_state=None, unhealthy_evaluations=None, total_count=None, max_percent_unhealthy_deployed_applications=None):
        super(DeployedApplicationsHealthEvaluation, self).__init__(description=description, aggregated_health_state=aggregated_health_state)
