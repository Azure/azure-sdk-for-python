...
class StatelessCreateServiceDescription(CreateServiceDescription):
    ...
    def __init__(self, application_name=None, service_name=None, service_type_name=None, partition_description=None, placement_constraints=None, correlation_scheme=None, service_load_metrics=None, service_placement_policies=None, flags=None, instance_count=None):
        super(StatelessCreateServiceDescription, self).__init__(application_name=application_name, service_name=service_name, service_type_name=service_type_name, partition_description=partition_description, placement_constraints=placement_constraints, correlation_scheme=correlation_scheme, service_load_metrics=service_load_metrics, service_placement_policies=service_placement_policies, flags=flags)
