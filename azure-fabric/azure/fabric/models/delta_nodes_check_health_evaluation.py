...
class DeltaNodesCheckHealthEvaluation(HealthEvaluation):
    ...
    :param max_percent_delta_unhealthy_nodes:
    ...
    def __init__(self, description=None, aggregated_health_state=None, unhealthy_evaluations=None, baseline_error_count=None, baseline_total_count=None, total_count=None, max_percent_delta_unhealthy_nodes=None):
        super(DeltaNodesCheckHealthEvaluation, self).__init__(description=description, aggregated_health_state=aggregated_health_state)
