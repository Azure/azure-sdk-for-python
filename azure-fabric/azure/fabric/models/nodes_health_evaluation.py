...
class NodesHealthEvaluation(HealthEvaluation):
    ...
    def __init__(self, description=None, aggregated_health_state=None, unhealthy_evaluations=None, total_count=None, max_percent_unhealthy_nodes=None):
        super(NodesHealthEvaluation, self).__init__(description=description, aggregated_health_state=aggregated_health_state)
