...
class Application(Model):
    ...
    :type status: str
    :param parameters:
    :type parameters: list of :class:`ApplicationParametersItem
     <azure.fabric.models.ApplicationParametersItem>`
    ...
    _attribute_map = {
        ...
        'parameters': {'key': 'Parameters', 'type': '[ApplicationParametersItem]'},
