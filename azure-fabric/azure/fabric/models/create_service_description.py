...
class CreateServiceDescription(Model):
    ...
    _subtype_map = {
        'service_kind': {'Stateless': 'StatelessCreateServiceDescription', 'Stateful': 'StatefulCreateServiceDescription'}
    }

    def __init__(self, application_name=None, service_name=None, service_type_name=None, partition_description=None, placement_constraints=None, correlation_scheme=None, service_load_metrics=None, service_placement_policies=None, flags=None):
