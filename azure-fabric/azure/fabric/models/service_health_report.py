...
class ServiceHealthReport(HealthReport):
    ...
    def __init__(self, source_id=None, property=None, health_state=None, description=None, time_to_live_in_milli_seconds=None, sequence_number=None, remove_when_expired=None):
        super(ServiceHealthReport, self).__init__(source_id=source_id, property=property, health_state=health_state, description=description, time_to_live_in_milli_seconds=time_to_live_in_milli_seconds, sequence_number=sequence_number, remove_when_expired=remove_when_expired)
