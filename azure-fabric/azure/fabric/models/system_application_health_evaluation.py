...
class SystemApplicationHealthEvaluation(HealthEvaluation):
    ...
    def __init__(self, description=None, aggregated_health_state=None, unhealthy_evaluations=None):
        super(SystemApplicationHealthEvaluation, self).__init__(description=description, aggregated_health_state=aggregated_health_state)
