...
class TopicResource(Resource):
    ...
    def __init__(self, location=None, auto_delete_on_idle=None, entity_availability_status=None, default_message_time_to_live=None, duplicate_detection_history_time_window=None, enable_batched_operations=None, enable_express=None, enable_partitioning=None, enable_subscription_partitioning=None, filtering_messages_before_publishing=None, is_anonymous_accessible=None, is_express=None, max_size_in_megabytes=None, requires_duplicate_detection=None, status=None, support_ordering=None):
        super(TopicResource, self).__init__(location=location)
