...
class AlertsSummaryBySeverityAndMonitorConditionSev3(AlertsSummaryByMonitorCondition):
    ...
    def __init__(self, *, fired: int=None, resolved: int=None, **kwargs) -> None:
        super(AlertsSummaryBySeverityAndMonitorConditionSev3, self).__init__(fired=fired, resolved=resolved, **kwargs)
