...
class AlertsSummaryPropertiesSummaryBySeveritySev2(AlertsSummaryByState):
    ...
    def __init__(self, *, new: int=None, acknowledged: int=None, closed: int=None, **kwargs) -> None:
        super(AlertsSummaryPropertiesSummaryBySeveritySev2, self).__init__(new=new, acknowledged=acknowledged, closed=closed, **kwargs)
