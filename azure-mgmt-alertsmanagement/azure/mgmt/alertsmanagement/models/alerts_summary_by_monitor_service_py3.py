...
class AlertsSummaryByMonitorService(Model):
    ...
    def __init__(self, *, platform: int=None, application_insights: int=None, log_analytics: int=None, zabbix: int=None, scom: int=None, nagios: int=None, infrastructure_insights: int=None, activity_log_administrative: int=None, activity_log_security: int=None, activity_log_recommendation: int=None, activity_log_policy: int=None, activity_log_autoscale: int=None, service_health: int=None, smart_detector: int=None, **kwargs) -> None:
        ...
        self.scom = scom
        self.nagios = nagios
        self.infrastructure_insights = infrastructure_insights
        self.activity_log_administrative = activity_log_administrative
        self.activity_log_security = activity_log_security
        self.activity_log_recommendation = activity_log_recommendation
        self.activity_log_policy = activity_log_policy
        self.activity_log_autoscale = activity_log_autoscale
