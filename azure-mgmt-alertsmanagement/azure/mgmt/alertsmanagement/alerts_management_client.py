...
class AlertsManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, subscription_id, api_version1=None, monitor_service1=None, base_url=None):
...
class AlertsManagementClient(SDKClient):
    ...
    def __init__(
        ...
        self.config = AlertsManagementClientConfiguration(credentials, subscription_id, api_version1, monitor_service1, base_url)
