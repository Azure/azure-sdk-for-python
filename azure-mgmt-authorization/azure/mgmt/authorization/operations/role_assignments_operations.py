...
class RoleAssignmentsOperations(object):
    ...
    def create(
            self, scope, role_assignment_name, parameters, custom_headers={}, raw=False, **operation_config):
        """
        ...
        :type parameters: :class:`RoleAssignmentCreateParameters
         <authorizationmanagementclient.models.RoleAssignmentCreateParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def create_by_id(
            self, role_assignment_id, parameters, custom_headers={}, raw=False, **operation_config):
        """
