...
class ClassicAdministratorsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.authorization.v2015_07_01.models.ClassicAdministratorPaged[~azure.mgmt.authorization.v2015_07_01.models.ClassicAdministrator]
        ...
        deserialized = models.ClassicAdministratorPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ClassicAdministratorPaged(internal_paging, self._deserialize.dependencies, header_dict)
