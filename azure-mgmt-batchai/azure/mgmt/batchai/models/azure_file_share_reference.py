...
class AzureFileShareReference(Model):
    ...
    :param credentials_info: Information of the Azure File credentials.
    ...
    :param relative_mount_path: Specifies the relative path on the compute
     ...
     will be mounted under $AZ_LEARNING_MOUNT_ROOT location.
    ...
    def __init__(self, account_name, azure_file_url, credentials_info, relative_mount_path, file_mode="0777", directory_mode="0777"):
