...
class ClusterUpdate(Resource):
    ...
    def __init__(self, *, tags=None, location: str=None, sku=None, trusted_external_tenants=None, intelligent_autoscale=None, **kwargs) -> None:
        ...
        self.intelligent_autoscale = intelligent_autoscale
