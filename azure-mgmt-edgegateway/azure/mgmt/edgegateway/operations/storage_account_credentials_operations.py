...
class StorageAccountCredentialsOperations(object):
    ...
    def list_by_data_box_edge_device(
        ...
        deserialized = models.StorageAccountCredentialPaged(internal_paging, self._deserialize.dependencies)
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.edgegateway.models.StorageAccountCredential or
