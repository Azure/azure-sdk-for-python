...
class RolesOperations(object):
    ...
    def list_by_data_box_edge_device(
        ...
        deserialized = models.RolePaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.RolePaged(internal_paging, self._deserialize.dependencies, header_dict)
