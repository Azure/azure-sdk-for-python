...
class OrdersOperations(object):
    ...
    def list_by_data_box_edge_device(
        ...
        deserialized = models.OrderPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.OrderPaged(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.edgegateway.models.Order or
