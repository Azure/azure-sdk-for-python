...
class ApplicationOperations(object):
    ...
    def get(
        ...
        :return: :class:`ApplicationResource
         <azure.mgmt.servicefabric.models.ApplicationResource>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype: :class:`ApplicationResource
         <azure.mgmt.servicefabric.models.ApplicationResource>` or
    ...
    def patch(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: :class:`ApplicationResourceUpdate
         <azure.mgmt.servicefabric.models.ApplicationResourceUpdate>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype: :class:`ApplicationResourceUpdate
         <azure.mgmt.servicefabric.models.ApplicationResourceUpdate>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
        :raises:
         :class:`ErrorModelException<azure.mgmt.servicefabric.models.ErrorModelException>`
    ...
    def list(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: :class:`ApplicationResourceList
         <azure.mgmt.servicefabric.models.ApplicationResourceList>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype: :class:`ApplicationResourceList
         <azure.mgmt.servicefabric.models.ApplicationResourceList>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
        :raises:
         :class:`ErrorModelException<azure.mgmt.servicefabric.models.ErrorModelException>`
