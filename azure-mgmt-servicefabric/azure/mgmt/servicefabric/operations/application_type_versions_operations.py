...
class ApplicationTypeVersionsOperations(object):
    ...
    def _create_initial(
            self, resource_group_name, cluster_name, application_type_name, version, app_package_url, location=None, custom_headers=None, raw=False, **operation_config):
    ...
    def create(
            self, resource_group_name, cluster_name, application_type_name, version, app_package_url, location=None, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :rtype:
         ...
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.servicefabric.models.ApplicationTypeVersionResource]]
        :raises:
         :class:`ErrorModelException<azure.mgmt.servicefabric.models.ErrorModelException>`
        """
