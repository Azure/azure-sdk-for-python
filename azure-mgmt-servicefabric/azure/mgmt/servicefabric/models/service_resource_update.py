...
class ServiceResourceUpdate(ProxyResource):
    ...
    _attribute_map = {
        ...
        'service_resource_type': {'key': 'properties.serviceResourceType', 'type': 'str'},
    }

    def __init__(self, location, service_resource_type, placement_constraints=None, correlation_scheme=None, service_load_metrics=None, service_placement_policies=None, default_move_cost=None):
