...
class ClusterHealthPolicy(Model):
    ...
    :type application_health_policies:
     list[~azure.mgmt.servicefabric.models.ApplicationHealthPolicyMapItem]
    """
    ...
    _attribute_map = {
        ...
        'application_health_policies': {'key': 'applicationHealthPolicies', 'type': '[ApplicationHealthPolicyMapItem]'},
    }

    def __init__(self, max_percent_unhealthy_nodes=0, max_percent_unhealthy_applications=0, application_health_policies=None):
