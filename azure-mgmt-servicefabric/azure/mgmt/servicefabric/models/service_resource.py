...
class ServiceResource(ProxyResource):
    ...
    def __init__(self, location, service_resource_type, placement_constraints=None, correlation_scheme=None, service_load_metrics=None, service_placement_policies=None, default_move_cost=None, service_kind=None, service_type_name=None, partition_description=None):
