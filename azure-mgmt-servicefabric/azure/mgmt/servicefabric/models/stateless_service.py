...
class StatelessService(ServiceProperties):
    ...
    def __init__(self, placement_constraints=None, correlation_scheme=None, service_load_metrics=None, service_placement_policies=None, default_move_cost=None, service_kind=None, service_type_name=None, partition_description=None, instance_count=None):
        super(StatelessService, self).__init__(placement_constraints=placement_constraints, correlation_scheme=correlation_scheme, service_load_metrics=service_load_metrics, service_placement_policies=service_placement_policies, default_move_cost=default_move_cost, service_kind=service_kind, service_type_name=service_type_name, partition_description=partition_description)
        self.instance_count = instance_count
        self.service_resource_type = 'StatelessService'
