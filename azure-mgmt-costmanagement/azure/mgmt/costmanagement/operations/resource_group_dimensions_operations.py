...
class ResourceGroupDimensionsOperations(object):
    """ResourceGroupDimensionsOperations operations.
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CostManagement/dimensions'}
