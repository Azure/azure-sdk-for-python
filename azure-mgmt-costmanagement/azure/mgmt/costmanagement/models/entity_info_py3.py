...
class EntityInfo(Model):
    ...
    :param parent: Parent.
    :type parent: ~azure.mgmt.costmanagement.models.EntityParentGroupInfo
    :param permissions: Permissions. Possible values include: 'noaccess',
     'view', 'edit', 'delete'
    :type permissions: str or ~azure.mgmt.costmanagement.models.enum
    :param inherited_permissions: Inherited Permissions. Possible values
     include: 'noaccess', 'view', 'edit', 'delete'
    :type inherited_permissions: str or ~azure.mgmt.costmanagement.models.enum
