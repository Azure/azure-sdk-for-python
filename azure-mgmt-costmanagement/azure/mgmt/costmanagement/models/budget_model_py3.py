...
class BudgetModel(ProxyResource):
    ...
    def __init__(self, *, category, amount, time_grain, time_period, e_tag: str=None, filter=None, notifications=None, **kwargs) -> None:
        super(BudgetModel, self).__init__(e_tag=e_tag, **kwargs)
