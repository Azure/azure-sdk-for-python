...
class DevTestLabsClientConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, subscription_id, api_version='2016-05-15', base_url=None):
...
class DevTestLabsClient(object):
    ...
    def __init__(
        ...
        self.config = DevTestLabsClientConfiguration(credentials, subscription_id, api_version, base_url)
