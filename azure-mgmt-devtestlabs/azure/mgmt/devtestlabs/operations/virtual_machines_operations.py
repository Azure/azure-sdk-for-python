...
class VirtualMachinesOperations(object):
    ...
    def list(
        ...
        :return: An iterator like instance of :class:`LabVirtualMachine
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: :class:`LabVirtualMachine
         <azure.mgmt.devtestlabs.models.LabVirtualMachine>` or
    ...
    def list_applicable_schedules(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: :class:`ApplicableSchedule
         <azure.mgmt.devtestlabs.models.ApplicableSchedule>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
