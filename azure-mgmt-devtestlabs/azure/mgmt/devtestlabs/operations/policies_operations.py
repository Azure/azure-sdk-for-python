...
class PoliciesOperations(object):
    ...
    def list(
        ...
        :return: An iterator like instance of :class:`Policy
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: :class:`Policy <azure.mgmt.devtestlabs.models.Policy>` or
         :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>` if
         raw=true
        :rtype: :class:`Policy <azure.mgmt.devtestlabs.models.Policy>` or
