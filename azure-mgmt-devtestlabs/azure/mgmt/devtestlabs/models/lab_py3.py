...
class Lab(Resource):
    ...
    def __init__(self, *, location: str=None, tags=None, lab_storage_type=None, premium_data_disks=None, provisioning_state: str=None, unique_identifier: str=None, **kwargs) -> None:
