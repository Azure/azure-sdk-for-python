...
class SchemasOperations(object):
    ...
    def list_by_integration_accounts(
        ...
        :return: An iterator like instance of :class:`IntegrationAccountSchema
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: :class:`IntegrationAccountSchema
         <azure.mgmt.logic.models.IntegrationAccountSchema>` or
