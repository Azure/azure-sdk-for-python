...
class IntegrationAccountBatchConfigurationsOperations(object):
    ...
    def list(
        ...
        :return: BatchConfigurationCollection or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.logic.models.BatchConfigurationCollection or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('BatchConfigurationCollection', response)
