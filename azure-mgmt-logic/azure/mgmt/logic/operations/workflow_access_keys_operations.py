...
class WorkflowAccessKeysOperations(object):
    ...
    def regenerate_secret_key(
            self, resource_group_name, workflow_name, access_key_name, parameters, custom_headers={}, raw=False, **operation_config):
        """
        ...
        :type parameters: :class:`RegenerateSecretKeyParameters
         <logicmanagementclient.models.RegenerateSecretKeyParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
