...
class IntegrationAccountsOperations(object):
    ...
    def list_key_vault_keys(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: KeyVaultKeyCollection or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.logic.models.KeyVaultKeyCollection or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('KeyVaultKeyCollection', response)
