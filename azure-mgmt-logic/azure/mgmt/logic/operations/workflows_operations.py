...
class WorkflowsOperations(object):
    ...
    def run(
            self, resource_group_name, workflow_name, parameters, custom_headers={}, raw=False, **operation_config):
        """
        Runs a workflow.
        ...
        :type parameters: :class:`RunWorkflowParameters
         <logicmanagementclient.models.RunWorkflowParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
