...
class StatefulServiceTypeDescription(ServiceTypeDescription):
    ...
    def __init__(self, *, is_stateful: bool=None, service_type_name: str=None, placement_constraints: str=None, service_placement_policies=None, extensions=None, has_persisted_state: bool=None, **kwargs) -> None:
        super(StatefulServiceTypeDescription, self).__init__(is_stateful=is_stateful, service_type_name=service_type_name, placement_constraints=placement_constraints, service_placement_policies=service_placement_policies, extensions=extensions, **kwargs)
