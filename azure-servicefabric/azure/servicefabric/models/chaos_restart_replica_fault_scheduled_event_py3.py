...
class ChaosRestartReplicaFaultScheduledEvent(ReplicaEvent):
    ...
    def __init__(self, *, event_instance_id: str, time_stamp, partition_id: str, replica_id: int, fault_group_id: str, fault_id: str, service_uri: str, has_correlated_events: bool=None, **kwargs) -> None:
        super(ChaosRestartReplicaFaultScheduledEvent, self).__init__(event_instance_id=event_instance_id, time_stamp=time_stamp, has_correlated_events=has_correlated_events, partition_id=partition_id, replica_id=replica_id, **kwargs)
        self.fault_group_id = fault_group_id
        self.fault_id = fault_id
        self.service_uri = service_uri
        self.kind = 'ChaosRestartReplicaFaultScheduled'
