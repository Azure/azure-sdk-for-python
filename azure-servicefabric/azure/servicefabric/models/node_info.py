...
class NodeInfo(Model):
    ...
    :param node_status: The status of the node. Possible values include:
     ...
     'Removed'
    :type node_status: str or ~servicefabric.models.NodeStatus
    ...
    :type id: ~servicefabric.models.NodeId
    ...
    :type node_deactivation_info: ~servicefabric.models.NodeDeactivationInfo
