...
class ComposeDeploymentUpgradeProgressInfo(Model):
    ...
    :type upgrade_state: str or
     ~servicefabric.models.ComposeDeploymentUpgradeState
    ...
    :type monitoring_policy: ~servicefabric.models.MonitoringPolicyDescription
    ...
    :type upgrade_domain_progress_at_failure:
     ~servicefabric.models.FailureUpgradeDomainProgressInfo
