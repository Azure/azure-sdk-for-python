...
class ApplicationInfo(Model):
    ...
    :param status: The status of the application.
     ...
     'Deleting', 'Failed'
    :type status: str or ~servicefabric.models.ApplicationStatus
    ...
    :type parameters: list[~servicefabric.models.ApplicationParameter]
    ...
    :type application_definition_kind: str or
     ~servicefabric.models.ApplicationDefinitionKind
    """
