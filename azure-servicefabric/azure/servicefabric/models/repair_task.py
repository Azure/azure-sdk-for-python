...
class RepairTask(Model):
    ...
    :param state: The workflow state of the repair task. Valid initial states
     ...
     'Completed'
    :type state: str or ~servicefabric.models.State
    ...
    :param target: The target object determines what actions the system will
     ...
     of the repair.
     May be set when the repair task is created, and is immutable once set.
    :type target: ~servicefabric.models.RepairTargetDescriptionBase
    ...
    :type impact: ~servicefabric.models.RepairImpactDescriptionBase
    ...
    :type result_status: str or ~servicefabric.models.ResultStatus
    ...
    :param history: An object that contains timestamps of the repair task's
     ...
     modified.
    :type history: ~servicefabric.models.RepairTaskHistory
    ...
    :type preparing_health_check_state: str or
     ~servicefabric.models.RepairTaskHealthCheckState
