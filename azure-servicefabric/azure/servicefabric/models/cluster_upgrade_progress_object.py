...
class ClusterUpgradeProgressObject(Model):
    ...
    :type upgrade_domains: list[~servicefabric.models.UpgradeDomainInfo]
    ...
    :type rolling_upgrade_mode: str or ~servicefabric.models.UpgradeMode
    :param upgrade_description: Represents a ServiceFabric cluster upgrade
    :type upgrade_description:
     ~servicefabric.models.ClusterUpgradeDescriptionObject
    ...
    :type current_upgrade_domain_progress:
     ~servicefabric.models.CurrentUpgradeDomainProgressInfo
    ...
    :type failure_reason: str or ~servicefabric.models.FailureReason
    ...
    :type upgrade_domain_progress_at_failure:
     ~servicefabric.models.FailedUpgradeDomainProgressObject
    """
