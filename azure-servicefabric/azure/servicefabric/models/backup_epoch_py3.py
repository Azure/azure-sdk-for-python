...
class BackupEpoch(Model):
    ...
    :param data_loss_number: The current data loss number of this Epoch. The
    ...
    def __init__(self, *, configuration_number: str=None, data_loss_number: str=None, **kwargs) -> None:
