...
class ExternalStoreProvisionApplicationTypeDescription(ProvisionApplicationTypeDescriptionBase):
    ...
    def __init__(self, *, async_property: bool, application_package_download_uri: str=None, application_type_name: str=None, application_type_version: str=None, **kwargs) -> None:
