...
class ApplicationTypeInfo(Model):
    ...
    :type default_parameter_list:
     list[~servicefabric.models.ApplicationParameter]
    ...
    :type status: str or ~servicefabric.models.ApplicationTypeStatus
    ...
    :type application_type_definition_kind: str or
     ~servicefabric.models.ApplicationTypeDefinitionKind
    """
