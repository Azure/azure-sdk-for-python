...
class SignalRManagementClientConfiguration(AzureConfiguration):
    ...
    :param resource_group_name: The name of the resource group that contains
     the resource. You can obtain this value from the Azure Resource Manager
     API or the portal.
    ...
    def __init__(
            self, credentials, subscription_id, resource_group_name, resource_name, base_url=None):
...
class SignalRManagementClient(object):
    ...
    def __init__(
        ...
        self.config = SignalRManagementClientConfiguration(credentials, subscription_id, resource_group_name, resource_name, base_url)
