...
class SignalRResourceResponse(Model):
    ...
    def __init__(self, *, location: str=None, tags=None, sku=None, provisioning_state: str=None, status: str=None, is_suspended: bool=None, external_ip: str=None, fqdn: str=None, public_port: int=None, server_port: int=None, **kwargs) -> None:
