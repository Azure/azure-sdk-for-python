...
class SignalROperations(object):
    ...
    def _switch_features_initial(
            self, resource_group_name, resource_name, features, custom_headers=None, raw=False, **operation_config):
        parameters = None
        if features is not None:
            parameters = models.SignalRFeaturesParameters(features=features)

        # Construct URL
        url = self.switch_features.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'resourceName': self._serialize.url("resource_name", resource_name, 'str')
        ...
        # Construct body
        if parameters is not None:
            body_content = self._serialize.body(parameters, 'SignalRFeaturesParameters')
        else:
            body_content = None
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SignalRFeatureList', response)
    ...
    def switch_features(
            self, resource_group_name, resource_name, features, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :param polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of LROPoller that returns SignalRFeatureList or
         ClientRawResponse<SignalRFeatureList> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.signalr.models.SignalRFeatureList]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.signalr.models.SignalRFeatureList]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        raw_result = self._switch_features_initial(
            resource_group_name=resource_group_name,
            resource_name=resource_name,
            features=features,
            custom_headers=custom_headers,
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    switch_features.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/SignalR/{resourceName}/switchFeatures'}
    ...
    def list_features(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: SignalRFeatureList or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.signalr.models.SignalRFeatureList or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        url = self.list_features.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'resourceName': self._serialize.url("resource_name", resource_name, 'str')
        ...
        return deserialized
    list_features.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/SignalR/{resourceName}/listFeatures'}
