...
Note that the `pylint` environment is intended to run against the **earliest supported python version**. This means that users must have `python 3.7` installed on their machine to run this check locally.
