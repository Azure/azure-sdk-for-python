...
2. Execute following command: `tox -e mypy -c ../../../eng/tox/tox.ini --root .`
...
1. Go to root of the package
2. Execute following command: `tox -e pyright -c ../../../eng/tox/tox.ini --root .`
...
1. Go to root of the package
2. Execute following command: `tox -e verifytypes -c ../../../eng/tox/tox.ini --root .`
...
1. Go to root of the package.
2. Execute following command: `tox -e pylint -c ../../../eng/tox/tox.ini --root .`
...
2. Execute command: `tox -e bandit -c ../../../eng/tox/tox.ini --root .`
...
1. Go to package root folder on a command line
2. Run following command
   `tox -e sdist -c ../../../eng/tox/tox.ini --root .`
...
2. Run command `tox –e latestdependency –c ../../../tox/tox.ini --root .`
...
1. Go to package root. For e.g azure-storage-blob or azure-identity
2. Run following command
`tox –e mindependency –c ../../../tox/tox.ini --root .`
