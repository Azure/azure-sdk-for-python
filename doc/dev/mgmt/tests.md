...
3. The `create_mgmt_client()` helper method of `AzureMgmtRecordedTestCase` creates a client object using fake credentials during playback or credentials from environment variables in live mode. You should use it for any clients you create.
