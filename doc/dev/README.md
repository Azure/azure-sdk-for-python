...
- [Changelog](https://github.com/Azure/azure-sdk-for-python/blob/main/doc/dev/changelog.md) : How to document package changes using Chronus (for packages with `pyproject.toml`)
