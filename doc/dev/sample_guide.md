...
- [azpysdk](../../doc/tool_usage_guide.md): run `azpysdk sphinx .` in the package directory.
...
- To use [azpysdk](../../doc/tool_usage_guide.md), run `azpysdk samples .` in the package directory.
