...
Chronus reads the package version from the Python package metadata and writes changelog entries into the `CHANGELOG.md` file during the release process. You do not need to manually edit `CHANGELOG.md` for your changes — Chronus handles this when the release is prepared.
