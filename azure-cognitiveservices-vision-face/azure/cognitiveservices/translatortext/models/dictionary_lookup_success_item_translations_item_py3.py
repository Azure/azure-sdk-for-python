...
class DictionaryLookupSuccessItemTranslationsItem(Model):
    ...
    :type back_translations:
     list[~azure.cognitiveservices.translatortext.models.DictionaryLookupSuccessItemTranslationsItemBackTranslationsItem]
    """
    ...
    _attribute_map = {
        ...
        'back_translations': {'key': 'backTranslations', 'type': '[DictionaryLookupSuccessItemTranslationsItemBackTranslationsItem]'},
    }
    ...
    def __init__(self, *, normalized_target: str=None, display_target: str=None, pos_tag: str=None, confidence: float=None, prefix_word: str=None, back_translations=None, **kwargs) -> None:
        super(DictionaryLookupSuccessItemTranslationsItem, self).__init__(**kwargs)
