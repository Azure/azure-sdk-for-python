...
from .operations.large_face_list_face_operations import LargeFaceListFaceOperations
from . import models
...
class FaceClient(SDKClient):
    ...
    :ivar large_face_list_face: LargeFaceListFace operations
    :vartype large_face_list_face: azure.cognitiveservices.vision.face.operations.LargeFaceListFaceOperations
    ...
    def __init__(
        ...
        self.large_face_list = LargeFaceListOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.large_face_list_face = LargeFaceListFaceOperations(
            self._client, self.config, self._serialize, self._deserialize)
