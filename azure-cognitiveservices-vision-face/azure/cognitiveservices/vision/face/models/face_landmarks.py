...
class FaceLandmarks(Model):
    ...
    :param pupil_left:
    :type pupil_left: ~azure.cognitiveservices.vision.face.models.Position
    :param pupil_right:
    :type pupil_right: ~azure.cognitiveservices.vision.face.models.Position
    :param nose_tip:
    :type nose_tip: ~azure.cognitiveservices.vision.face.models.Position
    :param mouth_left:
    :type mouth_left: ~azure.cognitiveservices.vision.face.models.Position
    :param mouth_right:
    :type mouth_right: ~azure.cognitiveservices.vision.face.models.Position
    :param eyebrow_left_outer:
    :type eyebrow_left_outer:
     ~azure.cognitiveservices.vision.face.models.Position
    :param eyebrow_left_inner:
    :type eyebrow_left_inner:
     ~azure.cognitiveservices.vision.face.models.Position
    :param eye_left_outer:
    :type eye_left_outer: ~azure.cognitiveservices.vision.face.models.Position
    :param eye_left_top:
    :type eye_left_top: ~azure.cognitiveservices.vision.face.models.Position
    :param eye_left_bottom:
    :type eye_left_bottom:
     ~azure.cognitiveservices.vision.face.models.Position
    :param eye_left_inner:
    :type eye_left_inner: ~azure.cognitiveservices.vision.face.models.Position
    ...
    :type eye_right_inner:
     ~azure.cognitiveservices.vision.face.models.Position
    :param eye_right_top:
    :type eye_right_top: ~azure.cognitiveservices.vision.face.models.Position
    ...
    :type nose_root_left: ~azure.cognitiveservices.vision.face.models.Position
    ...
    :type nose_right_alar_out_tip:
     ~azure.cognitiveservices.vision.face.models.Position
    :param upper_lip_top:
    :type upper_lip_top: ~azure.cognitiveservices.vision.face.models.Position
    :param upper_lip_bottom:
    :type upper_lip_bottom:
     ~azure.cognitiveservices.vision.face.models.Position
    :param under_lip_top:
    :type under_lip_top: ~azure.cognitiveservices.vision.face.models.Position
    ...
    _attribute_map = {
        'pupil_left': {'key': 'pupilLeft', 'type': 'Position'},
        'pupil_right': {'key': 'pupilRight', 'type': 'Position'},
        'nose_tip': {'key': 'noseTip', 'type': 'Position'},
        'mouth_left': {'key': 'mouthLeft', 'type': 'Position'},
        'mouth_right': {'key': 'mouthRight', 'type': 'Position'},
        'eyebrow_left_outer': {'key': 'eyebrowLeftOuter', 'type': 'Position'},
        'eyebrow_left_inner': {'key': 'eyebrowLeftInner', 'type': 'Position'},
        'eye_left_outer': {'key': 'eyeLeftOuter', 'type': 'Position'},
        'eye_left_top': {'key': 'eyeLeftTop', 'type': 'Position'},
        'eye_left_bottom': {'key': 'eyeLeftBottom', 'type': 'Position'},
        'eye_left_inner': {'key': 'eyeLeftInner', 'type': 'Position'},
        'eyebrow_right_inner': {'key': 'eyebrowRightInner', 'type': 'Position'},
        'eyebrow_right_outer': {'key': 'eyebrowRightOuter', 'type': 'Position'},
        'eye_right_inner': {'key': 'eyeRightInner', 'type': 'Position'},
        'eye_right_top': {'key': 'eyeRightTop', 'type': 'Position'},
        'eye_right_bottom': {'key': 'eyeRightBottom', 'type': 'Position'},
        'eye_right_outer': {'key': 'eyeRightOuter', 'type': 'Position'},
        'nose_root_left': {'key': 'noseRootLeft', 'type': 'Position'},
        'nose_root_right': {'key': 'noseRootRight', 'type': 'Position'},
        'nose_left_alar_top': {'key': 'noseLeftAlarTop', 'type': 'Position'},
        'nose_right_alar_top': {'key': 'noseRightAlarTop', 'type': 'Position'},
        'nose_left_alar_out_tip': {'key': 'noseLeftAlarOutTip', 'type': 'Position'},
        'nose_right_alar_out_tip': {'key': 'noseRightAlarOutTip', 'type': 'Position'},
        'upper_lip_top': {'key': 'upperLipTop', 'type': 'Position'},
        'upper_lip_bottom': {'key': 'upperLipBottom', 'type': 'Position'},
        'under_lip_top': {'key': 'underLipTop', 'type': 'Position'},
        'under_lip_bottom': {'key': 'underLipBottom', 'type': 'Position'},
    }
