...
class BaselinesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.monitor.models.SingleMetricBaselinePaged[~azure.mgmt.monitor.models.SingleMetricBaseline]
        :raises:
        ...
        deserialized = models.SingleMetricBaselinePaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.SingleMetricBaselinePaged(internal_paging, self._deserialize.dependencies, header_dict)
