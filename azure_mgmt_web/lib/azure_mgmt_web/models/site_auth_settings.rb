  ...
  module Models
    ...
    class SiteAuthSettings
      ...
      def self.serialize_object(object)
        ...
        serialized_property = object.token_refresh_extension_hours
        output_object['tokenRefreshExtensionHours'] = serialized_property unless serialized_property.nil?
      ...
      def self.deserialize_object(object)
        ...
        deserialized_property = object['tokenRefreshExtensionHours']
        deserialized_property = Float(deserialized_property) unless deserialized_property.to_s.empty?
        output_object.token_refresh_extension_hours = deserialized_property
