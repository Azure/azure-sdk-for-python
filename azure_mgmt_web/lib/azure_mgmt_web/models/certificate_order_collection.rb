...
module Azure::ARM::Web
  module Models
    ...
    class CertificateOrderCollection
      ...
      def self.serialize_object(object)
        ...
        unless serialized_property.nil?
          ...
          serialized_property.each do |element|
            unless element.nil?
              element = CertificateOrder.serialize_object(element)
            end
      ...
      # @return [CertificateOrderCollection] Deserialized object.
      #
      def self.deserialize_object(object)
        return if object.nil?
        output_object = CertificateOrderCollection.new
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element1|
            unless element1.nil?
              element1 = CertificateOrder.deserialize_object(element1)
            end
