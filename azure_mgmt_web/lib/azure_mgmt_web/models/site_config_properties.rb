  ...
  module Models
    ...
    class SiteConfigProperties
      ...
      def validate
        ...
        @ip_security_restrictions.each{ |e| e.validate if e.respond_to?(:validate) } unless @ip_security_restrictions.nil?
      end
      ...
      def self.serialize_object(object)
        ...
        serialized_property = object.ip_security_restrictions
        unless serialized_property.nil?
          serializedArray = []
          serialized_property.each do |element6|
            unless element6.nil?
              element6 = IpSecurityRestriction.serialize_object(element6)
            end
            serializedArray.push(element6)
          end
          serialized_property = serializedArray
        end
        output_object['ipSecurityRestrictions'] = serialized_property unless serialized_property.nil?
      ...
      def self.deserialize_object(object)
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element9|
            unless element9.nil?
              element9 = NameValuePair.deserialize_object(element9)
            end
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element10|
            unless element10.nil?
              element10 = ConnStringInfo.deserialize_object(element10)
            end
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element11|
            unless element11.nil?
              element11 = HandlerMapping.deserialize_object(element11)
            end
        ...
        unless deserialized_property.nil?
          ...
          deserialized_property.each do |element12|
            unless element12.nil?
              element12 = VirtualApplication.deserialize_object(element12)
            end
        ...
        deserialized_property = object['ipSecurityRestrictions']
        unless deserialized_property.nil?
          deserialized_array = []
          deserialized_property.each do |element13|
            unless element13.nil?
              element13 = IpSecurityRestriction.deserialize_object(element13)
            end
            deserialized_array.push(element13)
          end
          deserialized_property = deserialized_array
        end
        output_object.ip_security_restrictions = deserialized_property
