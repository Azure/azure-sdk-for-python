...
module Azure::ARM::Web
  module Models
    ...
    class DomainRegistrationInput < MsRestAzure::Resource
      ...
      attr_accessor :domain_registration_input_name
      ...
      #
      # Mapper for DomainRegistrationInput class as Ruby Hash.
      # This will be used for serialization/deserialization.
      #
      def self.mapper()
        {
          required: false,
          serialized_name: 'DomainRegistrationInput',
          type: {
            name: 'Composite',
            class_name: 'DomainRegistrationInput',
            model_properties: {
              id: {
                required: false,
                serialized_name: 'id',
              ...
              domain_registration_input_name: {
                required: false,
