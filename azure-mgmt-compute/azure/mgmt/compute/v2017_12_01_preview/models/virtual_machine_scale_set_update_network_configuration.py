...
class VirtualMachineScaleSetUpdateNetworkConfiguration(SubResource):
    ...
    :param dns_settings: The dns settings to be applied on the network
     interfaces.
    :type dns_settings:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineScaleSetNetworkConfigurationDnsSettings
    :param ip_configurations: The virtual machine scale set IP Configuration.
    :type ip_configurations:
     list[~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineScaleSetUpdateIPConfiguration]
    """
