...
class OSDisk(Model):
    ...
    :type encryption_settings:
     ~azure.mgmt.compute.v2017_12_01_preview.models.DiskEncryptionSettings
    :param name: The disk name.
    :type name: str
    :param vhd: The virtual hard disk.
    :type vhd: ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualHardDisk
    :param image: The source user image virtual hard disk. The virtual hard
     ...
     exist.
    :type image:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualHardDisk
    ...
    :type managed_disk:
     ~azure.mgmt.compute.v2017_12_01_preview.models.ManagedDiskParameters
    """
