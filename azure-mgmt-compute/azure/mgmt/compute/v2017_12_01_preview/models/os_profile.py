...
class OSProfile(Model):
    ...
    :type windows_configuration:
     ~azure.mgmt.compute.v2017_12_01_preview.models.WindowsConfiguration
    ...
    :type linux_configuration:
     ~azure.mgmt.compute.v2017_12_01_preview.models.LinuxConfiguration
    :param secrets: Specifies set of certificates that should be installed
     onto the virtual machine.
    :type secrets:
     list[~azure.mgmt.compute.v2017_12_01_preview.models.VaultSecretGroup]
    """
