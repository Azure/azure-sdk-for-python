...
class ResourceSku(Model):
    ...
    :vartype capacity:
     ~azure.mgmt.compute.v2017_12_01_preview.models.ResourceSkuCapacity
    ...
    :vartype location_info:
     list[~azure.mgmt.compute.v2017_12_01_preview.models.ResourceSkuLocationInfo]
    ...
    :vartype costs:
     list[~azure.mgmt.compute.v2017_12_01_preview.models.ResourceSkuCosts]
    :ivar capabilities: A name value pair to describe the capability.
    :vartype capabilities:
     list[~azure.mgmt.compute.v2017_12_01_preview.models.ResourceSkuCapabilities]
    ...
    :vartype restrictions:
     list[~azure.mgmt.compute.v2017_12_01_preview.models.ResourceSkuRestrictions]
    """
