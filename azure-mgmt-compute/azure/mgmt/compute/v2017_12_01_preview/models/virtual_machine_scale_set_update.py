...
class VirtualMachineScaleSetUpdate(UpdateResource):
    ...
    :type upgrade_policy:
     ~azure.mgmt.compute.v2017_12_01_preview.models.UpgradePolicy
    :param virtual_machine_profile: The virtual machine profile.
    :type virtual_machine_profile:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineScaleSetUpdateVMProfile
    ...
    :param identity: The identity of the virtual machine scale set, if
     configured.
    :type identity:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineScaleSetIdentity
    """
