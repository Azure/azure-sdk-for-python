...
class VirtualMachineScaleSetExtensionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachineScaleSetExtension <azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineScaleSetExtension>` object
    """
