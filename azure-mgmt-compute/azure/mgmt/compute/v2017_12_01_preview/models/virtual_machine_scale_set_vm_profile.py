...
class VirtualMachineScaleSetVMProfile(Model):
    ...
    :type os_profile:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineScaleSetOSProfile
    :param storage_profile: Specifies the storage settings for the virtual
     machine disks.
    :type storage_profile:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineScaleSetStorageProfile
    :param network_profile: Specifies properties of the network interfaces of
     the virtual machines in the scale set.
    :type network_profile:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineScaleSetNetworkProfile
    ...
    :type extension_profile:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineScaleSetExtensionProfile
