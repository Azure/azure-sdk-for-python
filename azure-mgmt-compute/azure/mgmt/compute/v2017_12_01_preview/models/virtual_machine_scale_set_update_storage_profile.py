...
class VirtualMachineScaleSetUpdateStorageProfile(Model):
    ...
    :type image_reference:
     ~azure.mgmt.compute.v2017_12_01_preview.models.ImageReference
    :param os_disk: The OS disk.
    :type os_disk:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineScaleSetUpdateOSDisk
    :param data_disks: The data disks.
    :type data_disks:
     list[~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineScaleSetDataDisk]
    """
