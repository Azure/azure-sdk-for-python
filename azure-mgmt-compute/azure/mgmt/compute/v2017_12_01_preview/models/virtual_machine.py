...
class VirtualMachine(Resource):
    ...
    :vartype resources:
     list[~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineExtension]
    :param identity: The identity of the virtual machine, if configured.
    :type identity:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineIdentity
