...
class VirtualMachineImage(VirtualMachineImageResource):
    ...
    :param plan:
    :type plan: ~azure.mgmt.compute.v2017_12_01_preview.models.PurchasePlan
    :param os_disk_image:
    :type os_disk_image:
     ~azure.mgmt.compute.v2017_12_01_preview.models.OSDiskImage
    :param data_disk_images:
    :type data_disk_images:
     list[~azure.mgmt.compute.v2017_12_01_preview.models.DataDiskImage]
    """
