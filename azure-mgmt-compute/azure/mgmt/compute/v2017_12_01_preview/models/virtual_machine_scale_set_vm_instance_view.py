...
class VirtualMachineScaleSetVMInstanceView(Model):
    ...
    :type vm_agent:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineAgentInstanceView
    :param disks: The disks information.
    :type disks:
     list[~azure.mgmt.compute.v2017_12_01_preview.models.DiskInstanceView]
    :param extensions: The extensions information.
    :type extensions:
     list[~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineExtensionInstanceView]
    :ivar vm_health: The health status for the VM.
    :vartype vm_health:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineHealthStatus
    ...
    :type boot_diagnostics:
     ~azure.mgmt.compute.v2017_12_01_preview.models.BootDiagnosticsInstanceView
