...
class VirtualMachineScaleSetUpdateIPConfiguration(SubResource):
    ...
    :type public_ip_address_configuration:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineScaleSetUpdatePublicIPAddressConfiguration
    ...
    :type private_ip_address_version: str or
     ~azure.mgmt.compute.v2017_12_01_preview.models.IPVersion
    ...
    :type application_gateway_backend_address_pools:
     list[~azure.mgmt.compute.v2017_12_01_preview.models.SubResource]
