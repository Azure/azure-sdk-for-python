...
class VirtualMachineScaleSetUpdateVMProfile(Model):
    ...
    :type os_profile:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineScaleSetUpdateOSProfile
    :param storage_profile: The virtual machine scale set storage profile.
    :type storage_profile:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineScaleSetUpdateStorageProfile
    :param network_profile: The virtual machine scale set network profile.
    :type network_profile:
     ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineScaleSetUpdateNetworkProfile
