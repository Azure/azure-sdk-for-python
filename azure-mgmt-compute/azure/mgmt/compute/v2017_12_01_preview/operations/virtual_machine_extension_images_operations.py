...
class VirtualMachineExtensionImagesOperations(object):
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineExtensionImage
    ...
    def list_types(
        ...
        :rtype:
         list[~azure.mgmt.compute.v2017_12_01_preview.models.VirtualMachineExtensionImage]
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
