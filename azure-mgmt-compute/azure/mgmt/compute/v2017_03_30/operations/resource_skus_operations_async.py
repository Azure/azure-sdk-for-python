...
from .. import models
from .resource_skus_operations import ResourceSkusOperations as _ResourceSkusOperations


class ResourceSkusOperations(_ResourceSkusOperations):
    ...
    def list(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ResourceSkuPaged(
