...
class VirtualMachinesOperations(_VirtualMachinesOperations):
    ...
    async def get_extensions_async(
        ...
        :return: VirtualMachineExtensionsListResult or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.compute.v2017_03_30.models.VirtualMachineExtensionsListResult
    ...
    async def capture_async(
        ...
        :rtype:
         ~~azure.mgmt.compute.v2017_03_30.models.VirtualMachineCaptureResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2017_03_30.models.VirtualMachineCaptureResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def create_or_update_async(
        ...
        :rtype: ~~azure.mgmt.compute.v2017_03_30.models.VirtualMachine or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2017_03_30.models.VirtualMachine]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def instance_view_async(
        ...
        """
        # Construct URL
        url = self.instance_view_async.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'vmName': self._serialize.url("vm_name", vm_name, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
        ...
        return deserialized
    instance_view_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/instanceView'}
    ...
    async def perform_maintenance_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    perform_maintenance_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/performMaintenance'}
    ...
    async def run_command_async(
        ...
        :rtype: ~~azure.mgmt.compute.v2017_03_30.models.RunCommandResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2017_03_30.models.RunCommandResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    run_command_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/runCommand'}
