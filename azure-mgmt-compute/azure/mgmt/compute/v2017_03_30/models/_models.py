...
class AdditionalUnattendContent(Model):
    ...
    :type pass_name: str or ~azure.mgmt.compute.v2017_03_30.models.PassNames
...
class InstanceViewStatus(Model):
    ...
    :param level: The level code. Possible values include: 'Info', 'Warning',
     'Error'
    :type level: str or
     ~azure.mgmt.compute.v2017_03_30.models.StatusLevelTypes
...
class RunCommandDocument(RunCommandDocumentBase):
    ...
    :type parameters:
     list[~azure.mgmt.compute.v2017_03_30.models.RunCommandParameterDefinition]
    """
...
class SshConfiguration(Model):
    ...
    :param public_keys: The list of SSH public keys used to authenticate with
     linux based VMs.
    :type public_keys:
     list[~azure.mgmt.compute.v2017_03_30.models.SshPublicKey]
    """
...
class VaultSecretGroup(Model):
    ...
    :type vault_certificates:
     list[~azure.mgmt.compute.v2017_03_30.models.VaultCertificate]
    """
...
class VirtualMachineScaleSetExtensionProfile(Model):
    ...
    :param extensions: The virtual machine scale set child extension
     resources.
    :type extensions:
     list[~azure.mgmt.compute.v2017_03_30.models.VirtualMachineScaleSetExtension]
    """
...
class VirtualMachineScaleSetSku(Model):
    ...
    :ivar capacity: Specifies the number of virtual machines in the scale set.
    :vartype capacity:
     ~azure.mgmt.compute.v2017_03_30.models.VirtualMachineScaleSetSkuCapacity
    """
...
class WinRMConfiguration(Model):
    ...
    :type listeners:
     list[~azure.mgmt.compute.v2017_03_30.models.WinRMListener]
    """
