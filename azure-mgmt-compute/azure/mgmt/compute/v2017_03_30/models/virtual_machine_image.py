...
class VirtualMachineImage(VirtualMachineImageResource):
    ...
    :type plan: :class:`PurchasePlan
     <azure.mgmt.compute.compute.v2017_03_30.models.PurchasePlan>`
    :param os_disk_image:
    :type os_disk_image: :class:`OSDiskImage
     <azure.mgmt.compute.compute.v2017_03_30.models.OSDiskImage>`
    :param data_disk_images:
    :type data_disk_images: list of :class:`DataDiskImage
     <azure.mgmt.compute.compute.v2017_03_30.models.DataDiskImage>`
    """
