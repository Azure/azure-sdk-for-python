...
try:
    ...
    from .virtual_machine_scale_set_vm_network_profile_configuration_py3 import VirtualMachineScaleSetVMNetworkProfileConfiguration
    from .virtual_machine_scale_set_vm_protection_policy_py3 import VirtualMachineScaleSetVMProtectionPolicy
    ...
    from .virtual_machine_scale_set_vm_network_profile_configuration import VirtualMachineScaleSetVMNetworkProfileConfiguration
    from .virtual_machine_scale_set_vm_protection_policy import VirtualMachineScaleSetVMProtectionPolicy
    ...
    from .vm_scale_set_convert_to_single_placement_group_input import VMScaleSetConvertToSinglePlacementGroupInput
