...
class GalleryImagesOperations:
    ...
    async def create_or_update(
        ...
        :return: An instance of GalleryImage or
         ClientRawResponse<GalleryImage> if raw==True
        :rtype: ~~azure.mgmt.compute.v2018_06_01.models.GalleryImage or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2018_06_01.models.GalleryImage]
    ...
    def list_by_gallery(
        ...
        if raw:
            header_dict = {}
        deserialized = models.GalleryImagePaged(
