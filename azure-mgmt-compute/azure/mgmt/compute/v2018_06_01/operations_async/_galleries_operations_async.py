...
class GalleriesOperations:
    ...
    async def create_or_update(
        ...
        :return: An instance of Gallery or ClientRawResponse<Gallery> if
         raw==True
        :rtype: ~~azure.mgmt.compute.v2018_06_01.models.Gallery or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2018_06_01.models.Gallery]
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}'}
    ...
    def list_by_resource_group(
        ...
        if raw:
            header_dict = {}
        deserialized = models.GalleryPaged(
