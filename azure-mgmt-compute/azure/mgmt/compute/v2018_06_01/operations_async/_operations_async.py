...
class Operations:
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.compute.v2018_06_01.models.ComputeOperationValuePaged[~azure.mgmt.compute.v2018_06_01.models.ComputeOperationValue]
        ...
        if raw:
            header_dict = {}
        deserialized = models.ComputeOperationValuePaged(
