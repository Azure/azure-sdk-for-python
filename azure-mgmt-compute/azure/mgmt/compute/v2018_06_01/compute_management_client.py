...
class ComputeManagementClient(SDKClient):
    ...
    :vartype virtual_machine_extensions: azure.mgmt.compute.v2018_06_01.operations.VirtualMachineExtensionsOperations
    ...
    :vartype virtual_machine_scale_set_extensions: azure.mgmt.compute.v2018_06_01.operations.VirtualMachineScaleSetExtensionsOperations
    :ivar virtual_machine_scale_set_rolling_upgrades: VirtualMachineScaleSetRollingUpgrades operations
    :vartype virtual_machine_scale_set_rolling_upgrades: azure.mgmt.compute.v2018_06_01.operations.VirtualMachineScaleSetRollingUpgradesOperations
