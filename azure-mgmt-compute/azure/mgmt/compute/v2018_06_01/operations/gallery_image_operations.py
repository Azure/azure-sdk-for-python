...
class GalleryImageOperations(object):
    ...
    def list_gallery_images_in_gallery(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: GalleryImageList or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.compute.v2018_06_01.models.GalleryImageList or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('GalleryImageList', response)
