...
class AvailabilitySetsOperations(_AvailabilitySetsOperations):
    ...
    async def update_async(
        ...
        return deserialized
    update_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}'}
