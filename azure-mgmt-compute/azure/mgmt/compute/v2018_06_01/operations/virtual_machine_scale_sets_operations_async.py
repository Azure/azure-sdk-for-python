...
class VirtualMachineScaleSetsOperations(_VirtualMachineScaleSetsOperations):
    ...
    async def create_or_update_async(
        ...
        :rtype: ~~azure.mgmt.compute.v2018_06_01.models.VirtualMachineScaleSet
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2018_06_01.models.VirtualMachineScaleSet]
    ...
    async def update_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}'}
    ...
    def get_os_upgrade_history(
        ...
        if raw:
            header_dict = {}
        deserialized = models.UpgradeOperationHistoricalStatusInfoPaged(
            internal_paging, self._deserialize.dependencies, header_dict, async_command=internal_paging_async)
    ...
    async def redeploy_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    redeploy_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/redeploy'}
    ...
    async def perform_maintenance_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    perform_maintenance_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/performMaintenance'}
    ...
    async def force_recovery_service_fabric_platform_update_domain_walk_async(
        ...
        """
        # Construct URL
        url = self.force_recovery_service_fabric_platform_update_domain_walk_async.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'vmScaleSetName': self._serialize.url("vm_scale_set_name", vm_scale_set_name, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
        ...
        return deserialized
    force_recovery_service_fabric_platform_update_domain_walk_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/forceRecoveryServiceFabricPlatformUpdateDomainWalk'}
