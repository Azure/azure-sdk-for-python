...
class VirtualMachineExtensionsOperations(_VirtualMachineExtensionsOperations):
    ...
    async def create_or_update_async(
        ...
        :type extension_parameters:
         ~azure.mgmt.compute.v2018_06_01.models.VirtualMachineExtension
        ...
        :rtype:
         ~~azure.mgmt.compute.v2018_06_01.models.VirtualMachineExtension or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2018_06_01.models.VirtualMachineExtension]
    ...
    async def _update_initial_async(
            self, resource_group_name, vm_name, vm_extension_name, extension_parameters, *, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    async def update_async(
        ...
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        raw_result = await self._update_initial_async(
            resource_group_name=resource_group_name,
            vm_name=vm_name,
            vm_extension_name=vm_extension_name,
            extension_parameters=extension_parameters,
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/extensions/{vmExtensionName}'}
    ...
    async def list_async(
        ...
        return deserialized
    list_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/extensions'}
