...
from .. import models
from .gallery_image_versions_operations import GalleryImageVersionsOperations as _GalleryImageVersionsOperations


class GalleryImageVersionsOperations(_GalleryImageVersionsOperations):
    ...
    async def create_or_update_async(
        ...
        :return: An instance of GalleryImageVersion or
         ClientRawResponse<GalleryImageVersion> if raw==True
        :rtype: ~~azure.mgmt.compute.v2018_06_01.models.GalleryImageVersion or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2018_06_01.models.GalleryImageVersion]
    ...
    create_or_update_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/images/{galleryImageName}/versions/{galleryImageVersionName}'}
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/images/{galleryImageName}/versions/{galleryImageVersionName}'}
    ...
    async def delete_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/images/{galleryImageName}/versions/{galleryImageVersionName}'}
    ...
    def list_by_gallery_image(
        ...
        if raw:
            header_dict = {}
        deserialized = models.GalleryImageVersionPaged(
