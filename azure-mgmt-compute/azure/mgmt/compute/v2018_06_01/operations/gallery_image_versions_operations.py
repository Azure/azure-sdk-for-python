...
class GalleryImageVersionsOperations(object):
    ...
    def list_gallery_image_versions_in_gallery_image(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: GalleryImageVersionList or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.compute.v2018_06_01.models.GalleryImageVersionList
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('GalleryImageVersionList', response)
