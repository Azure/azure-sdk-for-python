...
class ComputeOperationValuePaged(Paged):
    """
    A paging container for iterating over a list of :class:`ComputeOperationValue <azure.mgmt.compute.v2018_06_01.models.ComputeOperationValue>` object
    """
...
class VirtualMachinePaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachine <azure.mgmt.compute.v2018_06_01.models.VirtualMachine>` object
    """
...
class ImagePaged(Paged):
    """
    A paging container for iterating over a list of :class:`Image <azure.mgmt.compute.v2018_06_01.models.Image>` object
    """
...
class VirtualMachineScaleSetPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachineScaleSet <azure.mgmt.compute.v2018_06_01.models.VirtualMachineScaleSet>` object
    """
...
class VirtualMachineScaleSetSkuPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachineScaleSetSku <azure.mgmt.compute.v2018_06_01.models.VirtualMachineScaleSetSku>` object
    """
...
class UpgradeOperationHistoricalStatusInfoPaged(Paged):
    """
    A paging container for iterating over a list of :class:`UpgradeOperationHistoricalStatusInfo <azure.mgmt.compute.v2018_06_01.models.UpgradeOperationHistoricalStatusInfo>` object
    """
...
class VirtualMachineScaleSetExtensionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachineScaleSetExtension <azure.mgmt.compute.v2018_06_01.models.VirtualMachineScaleSetExtension>` object
    """
...
class VirtualMachineScaleSetVMPaged(Paged):
    """
    A paging container for iterating over a list of :class:`VirtualMachineScaleSetVM <azure.mgmt.compute.v2018_06_01.models.VirtualMachineScaleSetVM>` object
    """
...
class GalleryImageVersionPaged(Paged):
    """
    A paging container for iterating over a list of :class:`GalleryImageVersion <azure.mgmt.compute.v2018_06_01.models.GalleryImageVersion>` object
    """
...
class DiskPaged(Paged):
    """
    A paging container for iterating over a list of :class:`Disk <azure.mgmt.compute.v2018_06_01.models.Disk>` object
    """
...
class SnapshotPaged(Paged):
    """
    A paging container for iterating over a list of :class:`Snapshot <azure.mgmt.compute.v2018_06_01.models.Snapshot>` object
    """
