...
class SnapshotsOperations:
    ...
    async def create_or_update(
        ...
        :return: An instance of Snapshot or ClientRawResponse<Snapshot> if
         raw==True
        :rtype: ~~azure.mgmt.compute.v2016_04_30_preview.models.Snapshot or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2016_04_30_preview.models.Snapshot]
    ...
    def list_by_resource_group(
        ...
        if raw:
            header_dict = {}
        deserialized = models.SnapshotPaged(
    ...
    async def grant_access(
        ...
        :return: An instance of AccessUri or ClientRawResponse<AccessUri> if
         raw==True
        :rtype: ~~azure.mgmt.compute.v2016_04_30_preview.models.AccessUri or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2016_04_30_preview.models.AccessUri]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
