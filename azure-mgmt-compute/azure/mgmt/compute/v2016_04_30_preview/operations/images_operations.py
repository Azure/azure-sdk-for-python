...
class ImagesOperations(object):
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2016_04_30_preview.models.Image]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2016_04_30_preview.models.Image]]
    ...
    def list_by_resource_group(
        ...
        if raw:
            header_dict = {}
        deserialized = models.ImagePaged(internal_paging, self._deserialize.dependencies, header_dict)
