...
class VirtualMachineScaleSetsOperations(object):
    ...
    def get_os_upgrade_history(
        ...
        :rtype:
         ~azure.mgmt.compute.v2017_12_01.models.VirtualMachineScaleSetOSUpgradeHistoryPaged[~azure.mgmt.compute.v2017_12_01.models.VirtualMachineScaleSetOSUpgradeHistory]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def internal_paging(next_link=None, raw=False):
        ...
        # Deserialize response
        deserialized = models.VirtualMachineScaleSetOSUpgradeHistoryPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.VirtualMachineScaleSetOSUpgradeHistoryPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
