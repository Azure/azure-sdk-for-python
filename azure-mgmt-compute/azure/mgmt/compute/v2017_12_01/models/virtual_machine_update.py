...
class VirtualMachineUpdate(UpdateResource):
    ...
    def __init__(self, tags=None, plan=None, hardware_profile=None, storage_profile=None, os_profile=None, network_profile=None, diagnostics_profile=None, availability_set=None, license_type=None, identity=None, zones=None):
        super(VirtualMachineUpdate, self).__init__(tags=tags)
        self.plan = plan
