...
class VirtualMachineScaleSetVMProfile(Model):
    ...
    :type os_profile: :class:`VirtualMachineScaleSetOSProfile
     <azure.mgmt.compute.compute.v20160430preview.models.VirtualMachineScaleSetOSProfile>`
    ...
    :type storage_profile: :class:`VirtualMachineScaleSetStorageProfile
     <azure.mgmt.compute.compute.v20160430preview.models.VirtualMachineScaleSetStorageProfile>`
    ...
    :type network_profile: :class:`VirtualMachineScaleSetNetworkProfile
     <azure.mgmt.compute.compute.v20160430preview.models.VirtualMachineScaleSetNetworkProfile>`
    ...
    :type extension_profile: :class:`VirtualMachineScaleSetExtensionProfile
     <azure.mgmt.compute.compute.v20160430preview.models.VirtualMachineScaleSetExtensionProfile>`
    """
