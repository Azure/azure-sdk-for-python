...
class VirtualMachineScaleSetInstanceView(Model):
    ...
    :vartype virtual_machine:
     ...
     <azure.mgmt.compute.compute.v20160430preview.models.VirtualMachineScaleSetInstanceViewStatusesSummary>`
    :ivar extensions: The extensions information.
    :vartype extensions: list of
     :class:`VirtualMachineScaleSetVMExtensionsSummary
     <azure.mgmt.compute.compute.v20160430preview.models.VirtualMachineScaleSetVMExtensionsSummary>`
