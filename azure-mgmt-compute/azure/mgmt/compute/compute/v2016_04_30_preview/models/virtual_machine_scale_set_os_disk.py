...
class VirtualMachineScaleSetOSDisk(Model):
    ...
    :type caching: str or :class:`CachingTypes
     <azure.mgmt.compute.compute.v20160430preview.models.CachingTypes>`
    :param create_option: The create option. Possible values include:
     'fromImage', 'empty', 'attach'
    :type create_option: str or :class:`DiskCreateOptionTypes
     <azure.mgmt.compute.compute.v20160430preview.models.DiskCreateOptionTypes>`
    :param os_type: The Operating System type. Possible values include:
     'Windows', 'Linux'
    :type os_type: str or :class:`OperatingSystemTypes
     <azure.mgmt.compute.compute.v20160430preview.models.OperatingSystemTypes>`
    ...
    :type image: :class:`VirtualHardDisk
     <azure.mgmt.compute.compute.v20160430preview.models.VirtualHardDisk>`
    ...
    :type managed_disk: :class:`VirtualMachineScaleSetManagedDiskParameters
     <azure.mgmt.compute.compute.v20160430preview.models.VirtualMachineScaleSetManagedDiskParameters>`
    """
