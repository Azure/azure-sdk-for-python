...
class VirtualMachineScaleSet(Resource):
    ...
    :type sku: :class:`Sku <azure.mgmt.compute.compute.v20150615.models.Sku>`
    :param upgrade_policy: The upgrade policy.
    :type upgrade_policy: :class:`UpgradePolicy
     <azure.mgmt.compute.compute.v20150615.models.UpgradePolicy>`
    ...
    :type virtual_machine_profile: :class:`VirtualMachineScaleSetVMProfile
     <azure.mgmt.compute.compute.v20150615.models.VirtualMachineScaleSetVMProfile>`
