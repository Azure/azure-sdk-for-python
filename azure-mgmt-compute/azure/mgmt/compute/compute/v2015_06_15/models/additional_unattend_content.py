...
class AdditionalUnattendContent(Model):
    ...
    :type pass_name: str or :class:`PassNames
     <azure.mgmt.compute.compute.v20150615.models.PassNames>`
    ...
    :type component_name: str or :class:`ComponentNames
     <azure.mgmt.compute.compute.v20150615.models.ComponentNames>`
    ...
    :type setting_name: str or :class:`SettingNames
     <azure.mgmt.compute.compute.v20150615.models.SettingNames>`
