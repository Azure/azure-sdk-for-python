...
class ImagesOperations(_ImagesOperations):
    ...
    async def create_or_update_async(
        ...
        :rtype: ~~azure.mgmt.compute.v2018_04_01.models.Image or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2018_04_01.models.Image]
    ...
    async def update_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/images/{imageName}'}
