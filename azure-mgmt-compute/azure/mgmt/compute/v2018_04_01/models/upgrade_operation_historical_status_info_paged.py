...
class UpgradeOperationHistoricalStatusInfoPaged(Paged):
    """
    A paging container for iterating over a list of :class:`UpgradeOperationHistoricalStatusInfo <azure.mgmt.compute.v2018_04_01.models.UpgradeOperationHistoricalStatusInfo>` object
    """
