...
class VirtualMachinesOperations:
    ...
    async def capture(
        ...
        :param parameters: Parameters supplied to the Capture Virtual Machine
         operation.
        :type parameters:
         ~azure.mgmt.compute.v2018_04_01.models.VirtualMachineCaptureParameters
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~~azure.mgmt.compute.v2018_04_01.models.VirtualMachineCaptureResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2018_04_01.models.VirtualMachineCaptureResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if polling is True: polling_method = AsyncARMPolling(lro_delay, lro_options={'final-state-via': 'location'}, **operation_config)
    ...
    async def create_or_update(
        ...
        :rtype: ~~azure.mgmt.compute.v2018_04_01.models.VirtualMachine or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2018_04_01.models.VirtualMachine]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def update(
        ...
        :param parameters: Parameters supplied to the Update Virtual Machine
         operation.
        :type parameters:
         ~azure.mgmt.compute.v2018_04_01.models.VirtualMachineUpdate
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
    ...
    async def instance_view(
        ...
        :rtype:
         ~azure.mgmt.compute.v2018_04_01.models.VirtualMachineInstanceView or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list_available_sizes(
        ...
        :rtype:
         ~azure.mgmt.compute.v2018_04_01.models.VirtualMachineSizePaged[~azure.mgmt.compute.v2018_04_01.models.VirtualMachineSize]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
    ...
    async def run_command(
        ...
        :param polling: True for AsyncARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :return: An instance of RunCommandResult or
         ClientRawResponse<RunCommandResult> if raw==True
        :rtype: ~~azure.mgmt.compute.v2018_04_01.models.RunCommandResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2018_04_01.models.RunCommandResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
