...
class VirtualMachineScaleSetsOperations(object):
    ...
    def deallocate(
            self, resource_group_name, vm_scale_set_name, vm_instance_ids=None, custom_headers={}, raw=False, **operation_config):
        """
        ...
        :param vm_instance_ids: The list of virtual machine scale set
         instance IDs.
        :type vm_instance_ids: :class:`VirtualMachineScaleSetVMInstanceIDs
         <computemanagementclient.models.VirtualMachineScaleSetVMInstanceIDs>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
    ...
    def delete(
            self, resource_group_name, vm_scale_set_name, custom_headers={}, raw=False, **operation_config):
        """
    ...
    def delete_instances(
            self, resource_group_name, vm_scale_set_name, vm_instance_ids, custom_headers={}, raw=False, **operation_config):
        """
        ...
        :param vm_instance_ids: The list of virtual machine scale set
         instance IDs.
        :type vm_instance_ids:
         :class:`VirtualMachineScaleSetVMInstanceRequiredIDs
         <computemanagementclient.models.VirtualMachineScaleSetVMInstanceRequiredIDs>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
    ...
    def list_all(
        ...
        Machine Scale Sets. Do this till nextLink is not null to fetch all
        the Virtual Machine Scale Sets.
    ...
    def restart(
            self, resource_group_name, vm_scale_set_name, vm_instance_ids=None, custom_headers={}, raw=False, **operation_config):
        """
        The operation to restart virtual machines in a virtual machine scale
        set.
    ...
    def reimage(
            self, resource_group_name, vm_scale_set_name, custom_headers={}, raw=False, **operation_config):
        """
        The operation to re-image virtual machines in a virtual machine scale
        set.
