...
class VirtualMachineScaleSetVMsOperations(object):
    ...
    def get(
        ...
        :rtype: :class:`VirtualMachineScaleSetVM
         <azure.mgmt.compute.v20150615.models.VirtualMachineScaleSetVM>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get_instance_view(
        ...
        :rtype: :class:`VirtualMachineScaleSetVMInstanceView
         <azure.mgmt.compute.v20150615.models.VirtualMachineScaleSetVMInstanceView>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype: :class:`VirtualMachineScaleSetVMPaged
         <azure.mgmt.compute.v20150615.models.VirtualMachineScaleSetVMPaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
