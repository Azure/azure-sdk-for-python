...
class VirtualMachineExtensionsOperations(_VirtualMachineExtensionsOperations):
    ...
    async def create_or_update_async(
        ...
        :rtype:
         ...
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2015_06_15.models.VirtualMachineExtension]
    ...
    async def delete_async(
        ...
        :rtype:
         ...
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2015_06_15.models.OperationStatusResponse]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
