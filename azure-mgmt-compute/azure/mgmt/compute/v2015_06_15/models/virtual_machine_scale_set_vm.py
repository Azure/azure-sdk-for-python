...
class VirtualMachineScaleSetVM(Resource):
    ...
    :param plan: The purchase plan when deploying virtual machine from VM
     Marketplace images.
    :type plan: :class:`Plan <azure.mgmt.compute.v20150615.models.Plan>`
