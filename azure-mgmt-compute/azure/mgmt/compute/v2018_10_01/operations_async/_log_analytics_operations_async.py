...
class LogAnalyticsOperations:
    ...
    async def export_request_rate_by_interval(
        ...
        :return: An instance of LogAnalyticsOperationResult or
         ClientRawResponse<LogAnalyticsOperationResult> if raw==True
        :rtype:
         ~~azure.mgmt.compute.v2018_10_01.models.LogAnalyticsOperationResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2018_10_01.models.LogAnalyticsOperationResult]
