...
class VirtualMachinesOperations:
    ...
    async def capture(
        ...
        :param parameters: Parameters supplied to the Capture Virtual Machine
         operation.
        :type parameters:
         ~azure.mgmt.compute.v2018_10_01.models.VirtualMachineCaptureParameters
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~~azure.mgmt.compute.v2018_10_01.models.VirtualMachineCaptureResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2018_10_01.models.VirtualMachineCaptureResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def create_or_update(
        ...
        :param parameters: Parameters supplied to the Create Virtual Machine
         operation.
        :type parameters:
         ~azure.mgmt.compute.v2018_10_01.models.VirtualMachine
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
        ...
        :rtype: ~~azure.mgmt.compute.v2018_10_01.models.VirtualMachine or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2018_10_01.models.VirtualMachine]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    async def update(
        ...
        :param parameters: Parameters supplied to the Update Virtual Machine
         operation.
        :type parameters:
         ~azure.mgmt.compute.v2018_10_01.models.VirtualMachineUpdate
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for AsyncARMPolling, False for no polling, or a
    ...
    async def instance_view(
        ...
        :rtype:
         ~azure.mgmt.compute.v2018_10_01.models.VirtualMachineInstanceView or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    async def run_command(
        ...
        :rtype: ~~azure.mgmt.compute.v2018_10_01.models.RunCommandResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2018_10_01.models.RunCommandResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
