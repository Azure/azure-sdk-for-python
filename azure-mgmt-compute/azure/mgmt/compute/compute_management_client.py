...
class ComputeManagementClient(object):
    ...
    def models(cls, api_version='2016-04-30-preview'):
        if api_version =='2016-04-30-preview':
            from .compute.v2016_04_30_preview import models
            return models
        elif api_version =='2015-06-15':
            from .compute.v2015_06_15 import models
            return models
        else:
    ...
    def availability_sets(self):
        if self.api_version =='2016-04-30-preview':
            from .compute.v2016_04_30_preview.operations import AvailabilitySetsOperations as OperationClass
        elif self.api_version =='2015-06-15':
            from .compute.v2015_06_15.operations import AvailabilitySetsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {{}} is not available".format(api_version))
    ...
    def virtual_machine_extension_images(self):
        if self.api_version =='2016-04-30-preview':
            from .compute.v2016_04_30_preview.operations import VirtualMachineExtensionImagesOperations as OperationClass
        elif self.api_version =='2015-06-15':
            from .compute.v2015_06_15.operations import VirtualMachineExtensionImagesOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {{}} is not available".format(api_version))
        return OperationClass(self._client, self.config, self._serialize, self._deserialize)
    ...
    def virtual_machine_extensions(self):
        if self.api_version =='2016-04-30-preview':
            from .compute.v2016_04_30_preview.operations import VirtualMachineExtensionsOperations as OperationClass
        elif self.api_version =='2015-06-15':
            from .compute.v2015_06_15.operations import VirtualMachineExtensionsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {{}} is not available".format(api_version))
        return OperationClass(self._client, self.config, self._serialize, self._deserialize)
    ...
    def virtual_machine_images(self):
        if self.api_version =='2016-04-30-preview':
            from .compute.v2016_04_30_preview.operations import VirtualMachineImagesOperations as OperationClass
        elif self.api_version =='2015-06-15':
            from .compute.v2015_06_15.operations import VirtualMachineImagesOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {{}} is not available".format(api_version))
        return OperationClass(self._client, self.config, self._serialize, self._deserialize)
    ...
    def usage(self):
        if self.api_version =='2016-04-30-preview':
            from .compute.v2016_04_30_preview.operations import UsageOperations as OperationClass
        elif self.api_version =='2015-06-15':
            from .compute.v2015_06_15.operations import UsageOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {{}} is not available".format(api_version))
        return OperationClass(self._client, self.config, self._serialize, self._deserialize)
    ...
    def virtual_machine_sizes(self):
        if self.api_version =='2016-04-30-preview':
            from .compute.v2016_04_30_preview.operations import VirtualMachineSizesOperations as OperationClass
        elif self.api_version =='2015-06-15':
            from .compute.v2015_06_15.operations import VirtualMachineSizesOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {{}} is not available".format(api_version))
        return OperationClass(self._client, self.config, self._serialize, self._deserialize)
    ...
    def images(self):
        if self.api_version =='2016-04-30-preview':
            from .compute.v2016_04_30_preview.operations import ImagesOperations as OperationClass
        elif self.api_version =='2015-06-15':
            from .compute.v2015_06_15.operations import ImagesOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {{}} is not available".format(api_version))
        return OperationClass(self._client, self.config, self._serialize, self._deserialize)
    ...
    def virtual_machines(self):
        if self.api_version =='2016-04-30-preview':
            from .compute.v2016_04_30_preview.operations import VirtualMachinesOperations as OperationClass
        elif self.api_version =='2015-06-15':
            from .compute.v2015_06_15.operations import VirtualMachinesOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {{}} is not available".format(api_version))
        return OperationClass(self._client, self.config, self._serialize, self._deserialize)
    ...
    def virtual_machine_scale_sets(self):
        if self.api_version =='2016-04-30-preview':
            from .compute.v2016_04_30_preview.operations import VirtualMachineScaleSetsOperations as OperationClass
        elif self.api_version =='2015-06-15':
            from .compute.v2015_06_15.operations import VirtualMachineScaleSetsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {{}} is not available".format(api_version))
        return OperationClass(self._client, self.config, self._serialize, self._deserialize)
    ...
    def virtual_machine_scale_set_vms(self):
        if self.api_version =='2016-04-30-preview':
            from .compute.v2016_04_30_preview.operations import VirtualMachineScaleSetVMsOperations as OperationClass
        elif self.api_version =='2015-06-15':
            from .compute.v2015_06_15.operations import VirtualMachineScaleSetVMsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {{}} is not available".format(api_version))
        return OperationClass(self._client, self.config, self._serialize, self._deserialize)
    ...
    def disks(self):
        if self.api_version =='2016-04-30-preview':
            from .compute.v2016_04_30_preview.operations import DisksOperations as OperationClass
        elif self.api_version =='2015-06-15':
            from .compute.v2015_06_15.operations import DisksOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {{}} is not available".format(api_version))
        return OperationClass(self._client, self.config, self._serialize, self._deserialize)
    ...
    def snapshots(self):
        if self.api_version =='2016-04-30-preview':
            from .compute.v2016_04_30_preview.operations import SnapshotsOperations as OperationClass
        elif self.api_version =='2015-06-15':
            from .compute.v2015_06_15.operations import SnapshotsOperations as OperationClass
        else:
            raise NotImplementedError("APIVersion {{}} is not available".format(api_version))
        return OperationClass(self._client, self.config, self._serialize, self._deserialize)
