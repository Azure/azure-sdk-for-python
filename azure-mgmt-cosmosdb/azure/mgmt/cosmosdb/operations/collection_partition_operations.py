...
class CollectionPartitionOperations(object):
    ...
    def list_usages(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: PartitionUsagesResult or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.cosmosdb.models.PartitionUsagesResult or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('PartitionUsagesResult', response)
