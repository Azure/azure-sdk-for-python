...
class CognitiveServicesManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, subscription_id, api_version='2016-02-01-preview', base_url=None):
...
class CognitiveServicesManagementClient(object):
    ...
    def __init__(
        ...
        self.config = CognitiveServicesManagementClientConfiguration(credentials, subscription_id, api_version, base_url)
